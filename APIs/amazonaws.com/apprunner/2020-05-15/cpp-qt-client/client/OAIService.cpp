...
void OAIService::setServiceName(const QString &service_name) {
    m_service_name = service_name;
    m_service_name_isSet = true;
}

bool OAIService::is_service_name_Set() const{
    return m_service_name_isSet;
}

bool OAIService::is_service_name_Valid() const{
...
QString OAIService::getServiceArn() const {
    return m_service_arn;
}
void OAIService::setServiceArn(const QString &service_arn) {
    m_service_arn = service_arn;
    m_service_arn_isSet = true;
}

bool OAIService::is_service_arn_Set() const{
    return m_service_arn_isSet;
}

bool OAIService::is_service_arn_Valid() const{
    return m_service_arn_isValid;
}

QString OAIService::getServiceUrl() const {
    return m_service_url;
}
void OAIService::setServiceUrl(const QString &service_url) {
    m_service_url = service_url;
    m_service_url_isSet = true;
}

bool OAIService::is_service_url_Set() const{
    return m_service_url_isSet;
}

bool OAIService::is_service_url_Valid() const{
...
QDateTime OAIService::getUpdatedAt() const {
    return m_updated_at;
}
void OAIService::setUpdatedAt(const QDateTime &updated_at) {
...
QDateTime OAIService::getDeletedAt() const {
    return m_deleted_at;
}
void OAIService::setDeletedAt(const QDateTime &deleted_at) {
    m_deleted_at = deleted_at;
    m_deleted_at_isSet = true;
}

bool OAIService::is_deleted_at_Set() const{
    return m_deleted_at_isSet;
}

bool OAIService::is_deleted_at_Valid() const{
...
OAIService_SourceConfiguration OAIService::getSourceConfiguration() const {
    return m_source_configuration;
}
void OAIService::setSourceConfiguration(const OAIService_SourceConfiguration &source_configuration) {
    m_source_configuration = source_configuration;
    m_source_configuration_isSet = true;
}

bool OAIService::is_source_configuration_Set() const{
    return m_source_configuration_isSet;
}

bool OAIService::is_source_configuration_Valid() const{
    return m_source_configuration_isValid;
}

OAIService_InstanceConfiguration OAIService::getInstanceConfiguration() const {
    return m_instance_configuration;
}
void OAIService::setInstanceConfiguration(const OAIService_InstanceConfiguration &instance_configuration) {
    m_instance_configuration = instance_configuration;
    m_instance_configuration_isSet = true;
}

bool OAIService::is_instance_configuration_Set() const{
    return m_instance_configuration_isSet;
}

bool OAIService::is_instance_configuration_Valid() const{
    return m_instance_configuration_isValid;
}

OAIService_EncryptionConfiguration OAIService::getEncryptionConfiguration() const {
    return m_encryption_configuration;
}
void OAIService::setEncryptionConfiguration(const OAIService_EncryptionConfiguration &encryption_configuration) {
    m_encryption_configuration = encryption_configuration;
    m_encryption_configuration_isSet = true;
}

bool OAIService::is_encryption_configuration_Set() const{
    return m_encryption_configuration_isSet;
}

bool OAIService::is_encryption_configuration_Valid() const{
    return m_encryption_configuration_isValid;
}

OAIService_HealthCheckConfiguration OAIService::getHealthCheckConfiguration() const {
    return m_health_check_configuration;
}
void OAIService::setHealthCheckConfiguration(const OAIService_HealthCheckConfiguration &health_check_configuration) {
    m_health_check_configuration = health_check_configuration;
    m_health_check_configuration_isSet = true;
}

bool OAIService::is_health_check_configuration_Set() const{
    return m_health_check_configuration_isSet;
}

bool OAIService::is_health_check_configuration_Valid() const{
    return m_health_check_configuration_isValid;
}

OAIService_AutoScalingConfigurationSummary OAIService::getAutoScalingConfigurationSummary() const {
    return m_auto_scaling_configuration_summary;
}
void OAIService::setAutoScalingConfigurationSummary(const OAIService_AutoScalingConfigurationSummary &auto_scaling_configuration_summary) {
    m_auto_scaling_configuration_summary = auto_scaling_configuration_summary;
    m_auto_scaling_configuration_summary_isSet = true;
}

bool OAIService::is_auto_scaling_configuration_summary_Set() const{
    return m_auto_scaling_configuration_summary_isSet;
}

bool OAIService::is_auto_scaling_configuration_summary_Valid() const{
    return m_auto_scaling_configuration_summary_isValid;
}

OAIService_NetworkConfiguration OAIService::getNetworkConfiguration() const {
    return m_network_configuration;
}
void OAIService::setNetworkConfiguration(const OAIService_NetworkConfiguration &network_configuration) {
    m_network_configuration = network_configuration;
    m_network_configuration_isSet = true;
}

bool OAIService::is_network_configuration_Set() const{
    return m_network_configuration_isSet;
}

bool OAIService::is_network_configuration_Valid() const{
    return m_network_configuration_isValid;
}

OAIService_ObservabilityConfiguration OAIService::getObservabilityConfiguration() const {
    return m_observability_configuration;
}
void OAIService::setObservabilityConfiguration(const OAIService_ObservabilityConfiguration &observability_configuration) {
    m_observability_configuration = observability_configuration;
    m_observability_configuration_isSet = true;
}

bool OAIService::is_observability_configuration_Set() const{
    return m_observability_configuration_isSet;
}

bool OAIService::is_observability_configuration_Valid() const{
