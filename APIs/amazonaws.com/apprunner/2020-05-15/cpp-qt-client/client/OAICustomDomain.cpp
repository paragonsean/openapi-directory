...
QString OAICustomDomain::getDomainName() const {
    return m_domain_name;
}
void OAICustomDomain::setDomainName(const QString &domain_name) {
    m_domain_name = domain_name;
    m_domain_name_isSet = true;
}

bool OAICustomDomain::is_domain_name_Set() const{
    return m_domain_name_isSet;
}

bool OAICustomDomain::is_domain_name_Valid() const{
    return m_domain_name_isValid;
}

bool OAICustomDomain::getEnableWwwSubdomain() const {
    return m_enable_www_subdomain;
}
void OAICustomDomain::setEnableWwwSubdomain(const bool &enable_www_subdomain) {
    m_enable_www_subdomain = enable_www_subdomain;
    m_enable_www_subdomain_isSet = true;
}

bool OAICustomDomain::is_enable_www_subdomain_Set() const{
    return m_enable_www_subdomain_isSet;
}

bool OAICustomDomain::is_enable_www_subdomain_Valid() const{
    return m_enable_www_subdomain_isValid;
}

QList OAICustomDomain::getCertificateValidationRecords() const {
    return m_certificate_validation_records;
}
void OAICustomDomain::setCertificateValidationRecords(const QList &certificate_validation_records) {
    m_certificate_validation_records = certificate_validation_records;
    m_certificate_validation_records_isSet = true;
}

bool OAICustomDomain::is_certificate_validation_records_Set() const{
    return m_certificate_validation_records_isSet;
}

bool OAICustomDomain::is_certificate_validation_records_Valid() const{
    return m_certificate_validation_records_isValid;
}

OAICustomDomainAssociationStatus OAICustomDomain::getStatus() const {
    return m_status;
}
void OAICustomDomain::setStatus(const OAICustomDomainAssociationStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICustomDomain::is_status_Set() const{
    return m_status_isSet;
}

bool OAICustomDomain::is_status_Valid() const{
