...
/*
 * OAICreateConnectionResponse_Connection.h
 *
 * 
 */

#ifndef OAICreateConnectionResponse_Connection_H
#define OAICreateConnectionResponse_Connection_H
...
class OAICreateConnectionResponse_Connection : public OAIObject {
public:
    OAICreateConnectionResponse_Connection();
    OAICreateConnectionResponse_Connection(QString json);
    ~OAICreateConnectionResponse_Connection() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateConnectionResponse_Connection)

#endif // OAICreateConnectionResponse_Connection_H
