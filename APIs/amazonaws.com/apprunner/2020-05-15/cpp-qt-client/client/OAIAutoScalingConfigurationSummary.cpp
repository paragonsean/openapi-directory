...
#include "OAIAutoScalingConfigurationSummary.h"
...
OAIAutoScalingConfigurationSummary::OAIAutoScalingConfigurationSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAutoScalingConfigurationSummary::OAIAutoScalingConfigurationSummary() {
    this->initializeModel();
}

OAIAutoScalingConfigurationSummary::~OAIAutoScalingConfigurationSummary() {}

void OAIAutoScalingConfigurationSummary::initializeModel() {
...
void OAIAutoScalingConfigurationSummary::fromJson(QString jsonString) {
...
void OAIAutoScalingConfigurationSummary::fromJsonObject(QJsonObject json) {
...
QString OAIAutoScalingConfigurationSummary::asJson() const {
...
QJsonObject OAIAutoScalingConfigurationSummary::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAutoScalingConfigurationSummary::getAutoScalingConfigurationArn() const {
    return m_auto_scaling_configuration_arn;
}
void OAIAutoScalingConfigurationSummary::setAutoScalingConfigurationArn(const QString &auto_scaling_configuration_arn) {
    m_auto_scaling_configuration_arn = auto_scaling_configuration_arn;
    m_auto_scaling_configuration_arn_isSet = true;
}

bool OAIAutoScalingConfigurationSummary::is_auto_scaling_configuration_arn_Set() const{
    return m_auto_scaling_configuration_arn_isSet;
}

bool OAIAutoScalingConfigurationSummary::is_auto_scaling_configuration_arn_Valid() const{
    return m_auto_scaling_configuration_arn_isValid;
}

QString OAIAutoScalingConfigurationSummary::getAutoScalingConfigurationName() const {
    return m_auto_scaling_configuration_name;
}
void OAIAutoScalingConfigurationSummary::setAutoScalingConfigurationName(const QString &auto_scaling_configuration_name) {
    m_auto_scaling_configuration_name = auto_scaling_configuration_name;
    m_auto_scaling_configuration_name_isSet = true;
}

bool OAIAutoScalingConfigurationSummary::is_auto_scaling_configuration_name_Set() const{
    return m_auto_scaling_configuration_name_isSet;
}

bool OAIAutoScalingConfigurationSummary::is_auto_scaling_configuration_name_Valid() const{
    return m_auto_scaling_configuration_name_isValid;
}

qint32 OAIAutoScalingConfigurationSummary::getAutoScalingConfigurationRevision() const {
    return m_auto_scaling_configuration_revision;
}
void OAIAutoScalingConfigurationSummary::setAutoScalingConfigurationRevision(const qint32 &auto_scaling_configuration_revision) {
...
bool OAIAutoScalingConfigurationSummary::is_auto_scaling_configuration_revision_Set() const{
    return m_auto_scaling_configuration_revision_isSet;
}

bool OAIAutoScalingConfigurationSummary::is_auto_scaling_configuration_revision_Valid() const{
    return m_auto_scaling_configuration_revision_isValid;
}

bool OAIAutoScalingConfigurationSummary::isSet() const {
...
bool OAIAutoScalingConfigurationSummary::isValid() const {
