...
/*
 * OAIPauseServiceRequest.h
 *
 * 
 */

#ifndef OAIPauseServiceRequest_H
#define OAIPauseServiceRequest_H
...
class OAIPauseServiceRequest : public OAIObject {
public:
    OAIPauseServiceRequest();
    OAIPauseServiceRequest(QString json);
    ~OAIPauseServiceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPauseServiceRequest)

#endif // OAIPauseServiceRequest_H
