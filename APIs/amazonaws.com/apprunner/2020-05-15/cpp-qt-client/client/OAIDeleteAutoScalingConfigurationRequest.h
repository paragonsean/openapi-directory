...
/*
 * OAIDeleteAutoScalingConfigurationRequest.h
 *
 * 
 */

#ifndef OAIDeleteAutoScalingConfigurationRequest_H
#define OAIDeleteAutoScalingConfigurationRequest_H
...
class OAIDeleteAutoScalingConfigurationRequest : public OAIObject {
public:
    OAIDeleteAutoScalingConfigurationRequest();
    OAIDeleteAutoScalingConfigurationRequest(QString json);
    ~OAIDeleteAutoScalingConfigurationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteAutoScalingConfigurationRequest)

#endif // OAIDeleteAutoScalingConfigurationRequest_H
