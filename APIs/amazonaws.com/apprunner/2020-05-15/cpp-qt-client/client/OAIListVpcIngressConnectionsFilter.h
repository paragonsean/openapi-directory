...
/*
 * OAIListVpcIngressConnectionsFilter.h
 *
...
#ifndef OAIListVpcIngressConnectionsFilter_H
#define OAIListVpcIngressConnectionsFilter_H
...
class OAIListVpcIngressConnectionsFilter : public OAIObject {
public:
    OAIListVpcIngressConnectionsFilter();
    OAIListVpcIngressConnectionsFilter(QString json);
    ~OAIListVpcIngressConnectionsFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListVpcIngressConnectionsFilter)

#endif // OAIListVpcIngressConnectionsFilter_H
