...
OAISourceConfiguration_CodeRepository OAISourceConfiguration::getCodeRepository() const {
    return m_code_repository;
}
void OAISourceConfiguration::setCodeRepository(const OAISourceConfiguration_CodeRepository &code_repository) {
    m_code_repository = code_repository;
    m_code_repository_isSet = true;
}

bool OAISourceConfiguration::is_code_repository_Set() const{
    return m_code_repository_isSet;
}

bool OAISourceConfiguration::is_code_repository_Valid() const{
    return m_code_repository_isValid;
}

OAISourceConfiguration_ImageRepository OAISourceConfiguration::getImageRepository() const {
    return m_image_repository;
}
void OAISourceConfiguration::setImageRepository(const OAISourceConfiguration_ImageRepository &image_repository) {
    m_image_repository = image_repository;
    m_image_repository_isSet = true;
}

bool OAISourceConfiguration::is_image_repository_Set() const{
    return m_image_repository_isSet;
}

bool OAISourceConfiguration::is_image_repository_Valid() const{
    return m_image_repository_isValid;
}

bool OAISourceConfiguration::getAutoDeploymentsEnabled() const {
    return m_auto_deployments_enabled;
}
void OAISourceConfiguration::setAutoDeploymentsEnabled(const bool &auto_deployments_enabled) {
    m_auto_deployments_enabled = auto_deployments_enabled;
    m_auto_deployments_enabled_isSet = true;
}

bool OAISourceConfiguration::is_auto_deployments_enabled_Set() const{
    return m_auto_deployments_enabled_isSet;
}

bool OAISourceConfiguration::is_auto_deployments_enabled_Valid() const{
    return m_auto_deployments_enabled_isValid;
}

OAISourceConfiguration_AuthenticationConfiguration OAISourceConfiguration::getAuthenticationConfiguration() const {
    return m_authentication_configuration;
}
void OAISourceConfiguration::setAuthenticationConfiguration(const OAISourceConfiguration_AuthenticationConfiguration &authentication_configuration) {
    m_authentication_configuration = authentication_configuration;
    m_authentication_configuration_isSet = true;
}

bool OAISourceConfiguration::is_authentication_configuration_Set() const{
    return m_authentication_configuration_isSet;
}

bool OAISourceConfiguration::is_authentication_configuration_Valid() const{
