...
/*
 * OAIDescribeServiceRequest.h
 *
 * 
 */

#ifndef OAIDescribeServiceRequest_H
#define OAIDescribeServiceRequest_H
...
class OAIDescribeServiceRequest : public OAIObject {
public:
    OAIDescribeServiceRequest();
    OAIDescribeServiceRequest(QString json);
    ~OAIDescribeServiceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeServiceRequest)

#endif // OAIDescribeServiceRequest_H
