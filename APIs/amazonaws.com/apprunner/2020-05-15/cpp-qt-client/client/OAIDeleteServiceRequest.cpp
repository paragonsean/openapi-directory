...
QString OAIDeleteServiceRequest::getServiceArn() const {
    return m_service_arn;
}
void OAIDeleteServiceRequest::setServiceArn(const QString &service_arn) {
    m_service_arn = service_arn;
    m_service_arn_isSet = true;
}

bool OAIDeleteServiceRequest::is_service_arn_Set() const{
    return m_service_arn_isSet;
}

bool OAIDeleteServiceRequest::is_service_arn_Valid() const{
