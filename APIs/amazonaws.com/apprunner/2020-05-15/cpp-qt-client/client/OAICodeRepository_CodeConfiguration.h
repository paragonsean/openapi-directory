...
/*
 * OAICodeRepository_CodeConfiguration.h
 *
 * 
 */

#ifndef OAICodeRepository_CodeConfiguration_H
#define OAICodeRepository_CodeConfiguration_H
...
class OAICodeRepository_CodeConfiguration : public OAIObject {
public:
    OAICodeRepository_CodeConfiguration();
    OAICodeRepository_CodeConfiguration(QString json);
    ~OAICodeRepository_CodeConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodeRepository_CodeConfiguration)

#endif // OAICodeRepository_CodeConfiguration_H
