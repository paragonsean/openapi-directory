...
#ifndef OAIAutoScalingConfiguration_H
#define OAIAutoScalingConfiguration_H
...
class OAIAutoScalingConfiguration : public OAIObject {
public:
    OAIAutoScalingConfiguration();
    OAIAutoScalingConfiguration(QString json);
    ~OAIAutoScalingConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutoScalingConfiguration)

#endif // OAIAutoScalingConfiguration_H
