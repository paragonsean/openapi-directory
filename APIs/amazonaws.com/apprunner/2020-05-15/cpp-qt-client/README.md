...
class Example : public QObject {
    Q_OBJECT
    QString create();
    OAIAssociateCustomDomainRequest create();
    QString create();
    QString create();
    QString create();
    QString create();
...
QString Example::create(){
    QString obj;
OAIAssociateCustomDomainRequest Example::create(){
    OAIAssociateCustomDomainRequest obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::associateCustomDomainSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::associateCustomDomainSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAIAssociateCustomDomainRequest oai_associate_custom_domain_request = create(); // OAIAssociateCustomDomainRequest | 
      ...
      apiInstance.associateCustomDomain(x_amz_targetoai_associate_custom_domain_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
