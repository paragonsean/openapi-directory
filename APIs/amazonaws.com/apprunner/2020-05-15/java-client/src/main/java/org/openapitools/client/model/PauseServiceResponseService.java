...
public class PauseServiceResponseService {
  ...
  public PauseServiceResponseService() {
  }

  public PauseServiceResponseService serviceName(String serviceName) {
  ...
  public PauseServiceResponseService serviceId(String serviceId) {
  ...
  public PauseServiceResponseService serviceArn(String serviceArn) {
  ...
  public PauseServiceResponseService serviceUrl(String serviceUrl) {
  ...
  public PauseServiceResponseService createdAt(OffsetDateTime createdAt) {
  ...
  public PauseServiceResponseService updatedAt(OffsetDateTime updatedAt) {
  ...
  public PauseServiceResponseService deletedAt(OffsetDateTime deletedAt) {
  ...
  public PauseServiceResponseService status(ServiceStatus status) {
    this.status = status;
    return this;
  }
  ...
  public PauseServiceResponseService sourceConfiguration(ServiceSourceConfiguration sourceConfiguration) {
  ...
  public PauseServiceResponseService instanceConfiguration(ServiceInstanceConfiguration instanceConfiguration) {
  ...
  public PauseServiceResponseService encryptionConfiguration(ServiceEncryptionConfiguration encryptionConfiguration) {
  ...
  public PauseServiceResponseService healthCheckConfiguration(ServiceHealthCheckConfiguration healthCheckConfiguration) {
  ...
  public PauseServiceResponseService autoScalingConfigurationSummary(ServiceAutoScalingConfigurationSummary autoScalingConfigurationSummary) {
  ...
  public PauseServiceResponseService networkConfiguration(ServiceNetworkConfiguration networkConfiguration) {
  ...
  public PauseServiceResponseService observabilityConfiguration(ServiceObservabilityConfiguration observabilityConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    PauseServiceResponseService pauseServiceResponseService = (PauseServiceResponseService) o;
    return Objects.equals(this.serviceName, pauseServiceResponseService.serviceName) &&
        Objects.equals(this.serviceId, pauseServiceResponseService.serviceId) &&
        Objects.equals(this.serviceArn, pauseServiceResponseService.serviceArn) &&
        Objects.equals(this.serviceUrl, pauseServiceResponseService.serviceUrl) &&
        Objects.equals(this.createdAt, pauseServiceResponseService.createdAt) &&
        Objects.equals(this.updatedAt, pauseServiceResponseService.updatedAt) &&
        Objects.equals(this.deletedAt, pauseServiceResponseService.deletedAt) &&
        Objects.equals(this.status, pauseServiceResponseService.status) &&
        Objects.equals(this.sourceConfiguration, pauseServiceResponseService.sourceConfiguration) &&
        Objects.equals(this.instanceConfiguration, pauseServiceResponseService.instanceConfiguration) &&
        Objects.equals(this.encryptionConfiguration, pauseServiceResponseService.encryptionConfiguration) &&
        Objects.equals(this.healthCheckConfiguration, pauseServiceResponseService.healthCheckConfiguration) &&
        Objects.equals(this.autoScalingConfigurationSummary, pauseServiceResponseService.autoScalingConfigurationSummary) &&
        Objects.equals(this.networkConfiguration, pauseServiceResponseService.networkConfiguration) &&
        Objects.equals(this.observabilityConfiguration, pauseServiceResponseService.observabilityConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class PauseServiceResponseService {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PauseServiceResponseService
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PauseServiceResponseService.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PauseServiceResponseService is not found in the empty JSON string", PauseServiceResponseService.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PauseServiceResponseService.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PauseServiceResponseService` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PauseServiceResponseService.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PauseServiceResponseService.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PauseServiceResponseService' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PauseServiceResponseService> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PauseServiceResponseService.class));

       return (TypeAdapter<T>) new TypeAdapter<PauseServiceResponseService>() {
           @Override
           public void write(JsonWriter out, PauseServiceResponseService value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PauseServiceResponseService read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PauseServiceResponseService given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PauseServiceResponseService
   * @throws IOException if the JSON string is invalid with respect to PauseServiceResponseService
   */
  public static PauseServiceResponseService fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PauseServiceResponseService.class);
  }

  /**
   * Convert an instance of PauseServiceResponseService to an JSON string
   *
   * @return JSON string
   */
