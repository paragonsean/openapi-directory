...
public class ResumeServiceResponseService {
  ...
  public ResumeServiceResponseService() {
  }

  public ResumeServiceResponseService serviceName(String serviceName) {
  ...
  public ResumeServiceResponseService serviceId(String serviceId) {
  ...
  public ResumeServiceResponseService serviceArn(String serviceArn) {
  ...
  public ResumeServiceResponseService serviceUrl(String serviceUrl) {
  ...
  public ResumeServiceResponseService createdAt(OffsetDateTime createdAt) {
  ...
  public ResumeServiceResponseService updatedAt(OffsetDateTime updatedAt) {
  ...
  public ResumeServiceResponseService deletedAt(OffsetDateTime deletedAt) {
  ...
  public ResumeServiceResponseService status(ServiceStatus status) {
    this.status = status;
    return this;
  }
  ...
  public ResumeServiceResponseService sourceConfiguration(ServiceSourceConfiguration sourceConfiguration) {
  ...
  public ResumeServiceResponseService instanceConfiguration(ServiceInstanceConfiguration instanceConfiguration) {
  ...
  public ResumeServiceResponseService encryptionConfiguration(ServiceEncryptionConfiguration encryptionConfiguration) {
  ...
  public ResumeServiceResponseService healthCheckConfiguration(ServiceHealthCheckConfiguration healthCheckConfiguration) {
  ...
  public ResumeServiceResponseService autoScalingConfigurationSummary(ServiceAutoScalingConfigurationSummary autoScalingConfigurationSummary) {
  ...
  public ResumeServiceResponseService networkConfiguration(ServiceNetworkConfiguration networkConfiguration) {
  ...
  public ResumeServiceResponseService observabilityConfiguration(ServiceObservabilityConfiguration observabilityConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    ResumeServiceResponseService resumeServiceResponseService = (ResumeServiceResponseService) o;
    return Objects.equals(this.serviceName, resumeServiceResponseService.serviceName) &&
        Objects.equals(this.serviceId, resumeServiceResponseService.serviceId) &&
        Objects.equals(this.serviceArn, resumeServiceResponseService.serviceArn) &&
        Objects.equals(this.serviceUrl, resumeServiceResponseService.serviceUrl) &&
        Objects.equals(this.createdAt, resumeServiceResponseService.createdAt) &&
        Objects.equals(this.updatedAt, resumeServiceResponseService.updatedAt) &&
        Objects.equals(this.deletedAt, resumeServiceResponseService.deletedAt) &&
        Objects.equals(this.status, resumeServiceResponseService.status) &&
        Objects.equals(this.sourceConfiguration, resumeServiceResponseService.sourceConfiguration) &&
        Objects.equals(this.instanceConfiguration, resumeServiceResponseService.instanceConfiguration) &&
        Objects.equals(this.encryptionConfiguration, resumeServiceResponseService.encryptionConfiguration) &&
        Objects.equals(this.healthCheckConfiguration, resumeServiceResponseService.healthCheckConfiguration) &&
        Objects.equals(this.autoScalingConfigurationSummary, resumeServiceResponseService.autoScalingConfigurationSummary) &&
        Objects.equals(this.networkConfiguration, resumeServiceResponseService.networkConfiguration) &&
        Objects.equals(this.observabilityConfiguration, resumeServiceResponseService.observabilityConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResumeServiceResponseService {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResumeServiceResponseService
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResumeServiceResponseService.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResumeServiceResponseService is not found in the empty JSON string", ResumeServiceResponseService.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResumeServiceResponseService.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResumeServiceResponseService` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResumeServiceResponseService.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResumeServiceResponseService.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResumeServiceResponseService' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResumeServiceResponseService> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResumeServiceResponseService.class));

       return (TypeAdapter<T>) new TypeAdapter<ResumeServiceResponseService>() {
           @Override
           public void write(JsonWriter out, ResumeServiceResponseService value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResumeServiceResponseService read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResumeServiceResponseService given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResumeServiceResponseService
   * @throws IOException if the JSON string is invalid with respect to ResumeServiceResponseService
   */
  public static ResumeServiceResponseService fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResumeServiceResponseService.class);
  }

  /**
   * Convert an instance of ResumeServiceResponseService to an JSON string
   *
   * @return JSON string
   */
