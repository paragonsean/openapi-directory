...
public class ObservabilityConfiguration {
  ...
  public ObservabilityConfiguration observabilityConfigurationArn(String observabilityConfigurationArn) {
  ...
  public ObservabilityConfiguration observabilityConfigurationName(String observabilityConfigurationName) {
  ...
  public ObservabilityConfiguration traceConfiguration(ObservabilityConfigurationTraceConfiguration traceConfiguration) {
  ...
  public ObservabilityConfiguration observabilityConfigurationRevision(Integer observabilityConfigurationRevision) {
  ...
  public ObservabilityConfiguration latest(Boolean latest) {
    this.latest = latest;
    return this;
  }
  ...
  public ObservabilityConfiguration status(ObservabilityConfigurationStatus status) {
    this.status = status;
    return this;
  }
  ...
  public ObservabilityConfiguration createdAt(OffsetDateTime createdAt) {
  ...
  public ObservabilityConfiguration deletedAt(OffsetDateTime deletedAt) {
  ...
  public boolean equals(Object o) {
    ...
    ObservabilityConfiguration observabilityConfiguration = (ObservabilityConfiguration) o;
    return Objects.equals(this.observabilityConfigurationArn, observabilityConfiguration.observabilityConfigurationArn) &&
        Objects.equals(this.observabilityConfigurationName, observabilityConfiguration.observabilityConfigurationName) &&
        Objects.equals(this.traceConfiguration, observabilityConfiguration.traceConfiguration) &&
        Objects.equals(this.observabilityConfigurationRevision, observabilityConfiguration.observabilityConfigurationRevision) &&
        Objects.equals(this.latest, observabilityConfiguration.latest) &&
        Objects.equals(this.status, observabilityConfiguration.status) &&
        Objects.equals(this.createdAt, observabilityConfiguration.createdAt) &&
        Objects.equals(this.deletedAt, observabilityConfiguration.deletedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class ObservabilityConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ObservabilityConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ObservabilityConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ObservabilityConfiguration is not found in the empty JSON string", ObservabilityConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ObservabilityConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ObservabilityConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ObservabilityConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ObservabilityConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ObservabilityConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ObservabilityConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<ObservabilityConfiguration>() {
           @Override
           public void write(JsonWriter out, ObservabilityConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ObservabilityConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ObservabilityConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ObservabilityConfiguration
   * @throws IOException if the JSON string is invalid with respect to ObservabilityConfiguration
   */
  public static ObservabilityConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ObservabilityConfiguration.class);
  }

  /**
   * Convert an instance of ObservabilityConfiguration to an JSON string
   *
   * @return JSON string
   */
