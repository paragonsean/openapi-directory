...
public class DeleteVpcConnectorResponseVpcConnector {
  ...
  public DeleteVpcConnectorResponseVpcConnector() {
  }

  public DeleteVpcConnectorResponseVpcConnector vpcConnectorName(String vpcConnectorName) {
  ...
  public DeleteVpcConnectorResponseVpcConnector vpcConnectorArn(String vpcConnectorArn) {
  ...
  public DeleteVpcConnectorResponseVpcConnector vpcConnectorRevision(Integer vpcConnectorRevision) {
  ...
  public DeleteVpcConnectorResponseVpcConnector subnets(List subnets) {
  ...
  public DeleteVpcConnectorResponseVpcConnector securityGroups(List securityGroups) {
  ...
  public DeleteVpcConnectorResponseVpcConnector status(VpcConnectorStatus status) {
    this.status = status;
    return this;
  }
  ...
  public DeleteVpcConnectorResponseVpcConnector createdAt(OffsetDateTime createdAt) {
  ...
  public DeleteVpcConnectorResponseVpcConnector deletedAt(OffsetDateTime deletedAt) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteVpcConnectorResponseVpcConnector deleteVpcConnectorResponseVpcConnector = (DeleteVpcConnectorResponseVpcConnector) o;
    return Objects.equals(this.vpcConnectorName, deleteVpcConnectorResponseVpcConnector.vpcConnectorName) &&
        Objects.equals(this.vpcConnectorArn, deleteVpcConnectorResponseVpcConnector.vpcConnectorArn) &&
        Objects.equals(this.vpcConnectorRevision, deleteVpcConnectorResponseVpcConnector.vpcConnectorRevision) &&
        Objects.equals(this.subnets, deleteVpcConnectorResponseVpcConnector.subnets) &&
        Objects.equals(this.securityGroups, deleteVpcConnectorResponseVpcConnector.securityGroups) &&
        Objects.equals(this.status, deleteVpcConnectorResponseVpcConnector.status) &&
        Objects.equals(this.createdAt, deleteVpcConnectorResponseVpcConnector.createdAt) &&
        Objects.equals(this.deletedAt, deleteVpcConnectorResponseVpcConnector.deletedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteVpcConnectorResponseVpcConnector {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteVpcConnectorResponseVpcConnector
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteVpcConnectorResponseVpcConnector.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteVpcConnectorResponseVpcConnector is not found in the empty JSON string", DeleteVpcConnectorResponseVpcConnector.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteVpcConnectorResponseVpcConnector.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteVpcConnectorResponseVpcConnector` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteVpcConnectorResponseVpcConnector.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteVpcConnectorResponseVpcConnector' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteVpcConnectorResponseVpcConnector> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteVpcConnectorResponseVpcConnector.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteVpcConnectorResponseVpcConnector>() {
           @Override
           public void write(JsonWriter out, DeleteVpcConnectorResponseVpcConnector value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteVpcConnectorResponseVpcConnector read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteVpcConnectorResponseVpcConnector given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteVpcConnectorResponseVpcConnector
   * @throws IOException if the JSON string is invalid with respect to DeleteVpcConnectorResponseVpcConnector
   */
  public static DeleteVpcConnectorResponseVpcConnector fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteVpcConnectorResponseVpcConnector.class);
  }

  /**
   * Convert an instance of DeleteVpcConnectorResponseVpcConnector to an JSON string
   *
   * @return JSON string
   */
