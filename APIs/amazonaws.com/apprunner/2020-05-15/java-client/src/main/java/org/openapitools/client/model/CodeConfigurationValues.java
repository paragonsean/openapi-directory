...
public class CodeConfigurationValues {
  ...
  public CodeConfigurationValues runtime(Runtime runtime) {
  ...
  public CodeConfigurationValues buildCommand(String buildCommand) {
  ...
  public CodeConfigurationValues startCommand(String startCommand) {
  ...
  public CodeConfigurationValues port(String port) {
    this.port = port;
    return this;
  }
  ...
  public CodeConfigurationValues runtimeEnvironmentVariables(Map runtimeEnvironmentVariables) {
  ...
  public CodeConfigurationValues runtimeEnvironmentSecrets(Map runtimeEnvironmentSecrets) {
  ...
  public boolean equals(Object o) {
    ...
    CodeConfigurationValues codeConfigurationValues = (CodeConfigurationValues) o;
    return Objects.equals(this.runtime, codeConfigurationValues.runtime) &&
        Objects.equals(this.buildCommand, codeConfigurationValues.buildCommand) &&
        Objects.equals(this.startCommand, codeConfigurationValues.startCommand) &&
        Objects.equals(this.port, codeConfigurationValues.port) &&
        Objects.equals(this.runtimeEnvironmentVariables, codeConfigurationValues.runtimeEnvironmentVariables) &&
        Objects.equals(this.runtimeEnvironmentSecrets, codeConfigurationValues.runtimeEnvironmentSecrets);
  }
  ...
  public String toString() {
    ...
    sb.append("class CodeConfigurationValues {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CodeConfigurationValues
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CodeConfigurationValues.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CodeConfigurationValues is not found in the empty JSON string", CodeConfigurationValues.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CodeConfigurationValues.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CodeConfigurationValues` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CodeConfigurationValues.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CodeConfigurationValues.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CodeConfigurationValues' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CodeConfigurationValues> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CodeConfigurationValues.class));

       return (TypeAdapter<T>) new TypeAdapter<CodeConfigurationValues>() {
           @Override
           public void write(JsonWriter out, CodeConfigurationValues value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CodeConfigurationValues read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CodeConfigurationValues given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CodeConfigurationValues
   * @throws IOException if the JSON string is invalid with respect to CodeConfigurationValues
   */
  public static CodeConfigurationValues fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CodeConfigurationValues.class);
  }

  /**
   * Convert an instance of CodeConfigurationValues to an JSON string
   *
   * @return JSON string
   */
