...
/**
 * Model tests for ConnectionSummary
 */
public class ConnectionSummaryTest {
    private final ConnectionSummary model = new ConnectionSummary();
