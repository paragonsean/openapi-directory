...
/**
 * The UpdateImageGenerationConfigurationInputImageGenerationConfiguration model module.
 * @module model/UpdateImageGenerationConfigurationInputImageGenerationConfiguration
 * @version 2017-09-30
 */
class UpdateImageGenerationConfigurationInputImageGenerationConfiguration {
    /**
     * Constructs a new <code>UpdateImageGenerationConfigurationInputImageGenerationConfiguration</code>.
     * @alias module:model/UpdateImageGenerationConfigurationInputImageGenerationConfiguration
    ...
    constructor(status, imageSelectorType, destinationConfig, samplingInterval, format) { 
        ...
        UpdateImageGenerationConfigurationInputImageGenerationConfiguration.initialize(this, status, imageSelectorType, destinationConfig, samplingInterval, format);
    }
    ...
    /**
     * Constructs a <code>UpdateImageGenerationConfigurationInputImageGenerationConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateImageGenerationConfigurationInputImageGenerationConfiguration} obj Optional instance to populate.
     * @return {module:model/UpdateImageGenerationConfigurationInputImageGenerationConfiguration} The populated <code>UpdateImageGenerationConfigurationInputImageGenerationConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateImageGenerationConfigurationInputImageGenerationConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateImageGenerationConfigurationInputImageGenerationConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateImageGenerationConfigurationInputImageGenerationConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateImageGenerationConfigurationInputImageGenerationConfiguration.RequiredProperties) {
...
UpdateImageGenerationConfigurationInputImageGenerationConfiguration.RequiredProperties = ["Status", "ImageSelectorType", "DestinationConfig", "SamplingInterval", "Format"];

/**
 * @member {module:model/ConfigurationStatus} Status
 */
UpdateImageGenerationConfigurationInputImageGenerationConfiguration.prototype['Status'] = undefined;

/**
 * @member {module:model/ImageSelectorType} ImageSelectorType
 */
UpdateImageGenerationConfigurationInputImageGenerationConfiguration.prototype['ImageSelectorType'] = undefined;
 ...
 */
UpdateImageGenerationConfigurationInputImageGenerationConfiguration.prototype['DestinationConfig'] = undefined;

/**
 * @member {Number} SamplingInterval
 */
UpdateImageGenerationConfigurationInputImageGenerationConfiguration.prototype['SamplingInterval'] = undefined;

/**
 * @member {module:model/Format} Format
 */
UpdateImageGenerationConfigurationInputImageGenerationConfiguration.prototype['Format'] = undefined;

/**
 * @member {Object} FormatConfig
 */
UpdateImageGenerationConfigurationInputImageGenerationConfiguration.prototype['FormatConfig'] = undefined;

/**
 * @member {Number} WidthPixels
 */
UpdateImageGenerationConfigurationInputImageGenerationConfiguration.prototype['WidthPixels'] = undefined;

/**
 * @member {Number} HeightPixels
 */
UpdateImageGenerationConfigurationInputImageGenerationConfiguration.prototype['HeightPixels'] = undefined;
...
export default UpdateImageGenerationConfigurationInputImageGenerationConfiguration;
