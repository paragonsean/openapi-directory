...
/**
 * The DescribeImageGenerationConfigurationOutputImageGenerationConfiguration model module.
 * @module model/DescribeImageGenerationConfigurationOutputImageGenerationConfiguration
 * @version 2017-09-30
 */
class DescribeImageGenerationConfigurationOutputImageGenerationConfiguration {
    /**
     * Constructs a new <code>DescribeImageGenerationConfigurationOutputImageGenerationConfiguration</code>.
     * @alias module:model/DescribeImageGenerationConfigurationOutputImageGenerationConfiguration
     * @implements module:model/ImageGenerationConfiguration
    ...
    constructor(status, imageSelectorType, destinationConfig, samplingInterval, format) { 
        ...
        DescribeImageGenerationConfigurationOutputImageGenerationConfiguration.initialize(this, status, imageSelectorType, destinationConfig, samplingInterval, format);
    }
    ...
    /**
     * Constructs a <code>DescribeImageGenerationConfigurationOutputImageGenerationConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeImageGenerationConfigurationOutputImageGenerationConfiguration} obj Optional instance to populate.
     * @return {module:model/DescribeImageGenerationConfigurationOutputImageGenerationConfiguration} The populated <code>DescribeImageGenerationConfigurationOutputImageGenerationConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeImageGenerationConfigurationOutputImageGenerationConfiguration();
            ImageGenerationConfiguration.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeImageGenerationConfigurationOutputImageGenerationConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeImageGenerationConfigurationOutputImageGenerationConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeImageGenerationConfigurationOutputImageGenerationConfiguration.RequiredProperties) {
...
DescribeImageGenerationConfigurationOutputImageGenerationConfiguration.RequiredProperties = ["Status", "ImageSelectorType", "DestinationConfig", "SamplingInterval", "Format"];

/**
 * @member {module:model/ConfigurationStatus} Status
 */
DescribeImageGenerationConfigurationOutputImageGenerationConfiguration.prototype['Status'] = undefined;

/**
 * @member {module:model/ImageSelectorType} ImageSelectorType
 */
DescribeImageGenerationConfigurationOutputImageGenerationConfiguration.prototype['ImageSelectorType'] = undefined;
 ...
 */
DescribeImageGenerationConfigurationOutputImageGenerationConfiguration.prototype['DestinationConfig'] = undefined;

/**
 * @member {Number} SamplingInterval
 */
DescribeImageGenerationConfigurationOutputImageGenerationConfiguration.prototype['SamplingInterval'] = undefined;

/**
 * @member {module:model/Format} Format
 */
DescribeImageGenerationConfigurationOutputImageGenerationConfiguration.prototype['Format'] = undefined;

/**
 * @member {Object} FormatConfig
 */
DescribeImageGenerationConfigurationOutputImageGenerationConfiguration.prototype['FormatConfig'] = undefined;

/**
 * @member {Number} WidthPixels
 */
DescribeImageGenerationConfigurationOutputImageGenerationConfiguration.prototype['WidthPixels'] = undefined;

/**
 * @member {Number} HeightPixels
 */
DescribeImageGenerationConfigurationOutputImageGenerationConfiguration.prototype['HeightPixels'] = undefined;


// Implement ImageGenerationConfiguration interface:
/**
 * @member {module:model/ConfigurationStatus} Status
 */
...
export default DescribeImageGenerationConfigurationOutputImageGenerationConfiguration;
