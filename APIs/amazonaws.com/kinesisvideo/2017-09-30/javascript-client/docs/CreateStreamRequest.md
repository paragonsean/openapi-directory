# AmazonKinesisVideoStreams.CreateStreamRequest
...
**dataRetentionInHours** | **Number** | &lt;p&gt;The number of hours that you want to retain the data in the stream. Kinesis Video Streams retains the data in a data store that is associated with the stream.&lt;/p&gt; &lt;p&gt;The default value is 0, indicating that the stream does not persist data.&lt;/p&gt; &lt;p&gt;When the &lt;code&gt;DataRetentionInHours&lt;/code&gt; value is 0, consumers can still consume the fragments that remain in the service host buffer, which has a retention time limit of 5 minutes and a retention memory limit of 200 MB. Fragments are removed from the buffer when either limit is reached.&lt;/p&gt; | [optional] 
**tags** | **{String: String}** | A list of tags to associate with the specified stream. Each tag is a key-value pair (the value is optional). | [optional] 
