...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKinesisVideoStreams.CreateStreamInput();
  });
  ...
  describe('CreateStreamInput', function() {
    it('should create an instance of CreateStreamInput', function() {
      // uncomment below and update the code to test CreateStreamInput
      //var instance = new AmazonKinesisVideoStreams.CreateStreamInput();
      //expect(instance).to.be.a(AmazonKinesisVideoStreams.CreateStreamInput);
    });
