...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKinesisVideoStreams.UpdateStreamRequest();
  });
  ...
  describe('UpdateStreamRequest', function() {
    it('should create an instance of UpdateStreamRequest', function() {
      // uncomment below and update the code to test UpdateStreamRequest
      //var instance = new AmazonKinesisVideoStreams.UpdateStreamRequest();
      //expect(instance).to.be.a(AmazonKinesisVideoStreams.UpdateStreamRequest);
    });
