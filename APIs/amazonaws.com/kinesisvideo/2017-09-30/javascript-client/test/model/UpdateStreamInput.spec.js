...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKinesisVideoStreams.UpdateStreamInput();
  });
  ...
  describe('UpdateStreamInput', function() {
    it('should create an instance of UpdateStreamInput', function() {
      // uncomment below and update the code to test UpdateStreamInput
      //var instance = new AmazonKinesisVideoStreams.UpdateStreamInput();
      //expect(instance).to.be.a(AmazonKinesisVideoStreams.UpdateStreamInput);
    });
