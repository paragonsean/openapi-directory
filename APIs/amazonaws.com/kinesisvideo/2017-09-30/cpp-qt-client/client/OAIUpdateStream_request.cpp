...
OAIUpdateStream_request::OAIUpdateStream_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateStream_request::OAIUpdateStream_request() {
    this->initializeModel();
}

OAIUpdateStream_request::~OAIUpdateStream_request() {}

void OAIUpdateStream_request::initializeModel() {
...
void OAIUpdateStream_request::fromJson(QString jsonString) {
...
void OAIUpdateStream_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateStream_request::asJson() const {
...
QJsonObject OAIUpdateStream_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateStream_request::getStreamName() const {
    return m_stream_name;
}
void OAIUpdateStream_request::setStreamName(const QString &stream_name) {
    m_stream_name = stream_name;
    m_stream_name_isSet = true;
}

bool OAIUpdateStream_request::is_stream_name_Set() const{
    return m_stream_name_isSet;
}

bool OAIUpdateStream_request::is_stream_name_Valid() const{
    return m_stream_name_isValid;
}

QString OAIUpdateStream_request::getStreamArn() const {
    return m_stream_arn;
}
void OAIUpdateStream_request::setStreamArn(const QString &stream_arn) {
    m_stream_arn = stream_arn;
    m_stream_arn_isSet = true;
}

bool OAIUpdateStream_request::is_stream_arn_Set() const{
    return m_stream_arn_isSet;
}

bool OAIUpdateStream_request::is_stream_arn_Valid() const{
    return m_stream_arn_isValid;
}

QString OAIUpdateStream_request::getCurrentVersion() const {
    return m_current_version;
}
void OAIUpdateStream_request::setCurrentVersion(const QString &current_version) {
    m_current_version = current_version;
    m_current_version_isSet = true;
}

bool OAIUpdateStream_request::is_current_version_Set() const{
    return m_current_version_isSet;
}

bool OAIUpdateStream_request::is_current_version_Valid() const{
    return m_current_version_isValid;
}

QString OAIUpdateStream_request::getDeviceName() const {
    return m_device_name;
}
void OAIUpdateStream_request::setDeviceName(const QString &device_name) {
    m_device_name = device_name;
    m_device_name_isSet = true;
}

bool OAIUpdateStream_request::is_device_name_Set() const{
    return m_device_name_isSet;
}

bool OAIUpdateStream_request::is_device_name_Valid() const{
    return m_device_name_isValid;
}

QString OAIUpdateStream_request::getMediaType() const {
    return m_media_type;
}
void OAIUpdateStream_request::setMediaType(const QString &media_type) {
    m_media_type = media_type;
    m_media_type_isSet = true;
}

bool OAIUpdateStream_request::is_media_type_Set() const{
    return m_media_type_isSet;
}

bool OAIUpdateStream_request::is_media_type_Valid() const{
    return m_media_type_isValid;
}

bool OAIUpdateStream_request::isSet() const {
...
bool OAIUpdateStream_request::isValid() const {
