...
/*
 * OAIDeleteEdgeConfigurationInput.h
 *
 * 
 */

#ifndef OAIDeleteEdgeConfigurationInput_H
#define OAIDeleteEdgeConfigurationInput_H
...
class OAIDeleteEdgeConfigurationInput : public OAIObject {
public:
    OAIDeleteEdgeConfigurationInput();
    OAIDeleteEdgeConfigurationInput(QString json);
    ~OAIDeleteEdgeConfigurationInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteEdgeConfigurationInput)

#endif // OAIDeleteEdgeConfigurationInput_H
