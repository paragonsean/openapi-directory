...
/*
 * OAIDeleteStream_request.h
 *
 * 
 */

#ifndef OAIDeleteStream_request_H
#define OAIDeleteStream_request_H
...
class OAIDeleteStream_request : public OAIObject {
public:
    OAIDeleteStream_request();
    OAIDeleteStream_request(QString json);
    ~OAIDeleteStream_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteStream_request)

#endif // OAIDeleteStream_request_H
