...
/*
 * OAICreateStreamInput.h
 *
 * 
 */

#ifndef OAICreateStreamInput_H
#define OAICreateStreamInput_H
...
class OAICreateStreamInput : public OAIObject {
public:
    OAICreateStreamInput();
    OAICreateStreamInput(QString json);
    ~OAICreateStreamInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateStreamInput)

#endif // OAICreateStreamInput_H
