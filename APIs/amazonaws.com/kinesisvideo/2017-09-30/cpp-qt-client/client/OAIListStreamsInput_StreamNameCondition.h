...
/*
 * OAIListStreamsInput_StreamNameCondition.h
 *
 * 
 */

#ifndef OAIListStreamsInput_StreamNameCondition_H
#define OAIListStreamsInput_StreamNameCondition_H
...
class OAIListStreamsInput_StreamNameCondition : public OAIObject {
public:
    OAIListStreamsInput_StreamNameCondition();
    OAIListStreamsInput_StreamNameCondition(QString json);
    ~OAIListStreamsInput_StreamNameCondition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListStreamsInput_StreamNameCondition)

#endif // OAIListStreamsInput_StreamNameCondition_H
