...
/*
 * OAIUpdateStreamInput.h
 *
 * 
 */

#ifndef OAIUpdateStreamInput_H
#define OAIUpdateStreamInput_H
...
class OAIUpdateStreamInput : public OAIObject {
public:
    OAIUpdateStreamInput();
    OAIUpdateStreamInput(QString json);
    ~OAIUpdateStreamInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateStreamInput)

#endif // OAIUpdateStreamInput_H
