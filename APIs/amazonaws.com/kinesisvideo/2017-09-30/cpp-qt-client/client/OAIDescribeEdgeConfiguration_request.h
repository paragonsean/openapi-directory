...
/*
 * OAIDescribeEdgeConfiguration_request.h
 *
 * 
 */

#ifndef OAIDescribeEdgeConfiguration_request_H
#define OAIDescribeEdgeConfiguration_request_H
...
class OAIDescribeEdgeConfiguration_request : public OAIObject {
public:
    OAIDescribeEdgeConfiguration_request();
    OAIDescribeEdgeConfiguration_request(QString json);
    ~OAIDescribeEdgeConfiguration_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEdgeConfiguration_request)

#endif // OAIDescribeEdgeConfiguration_request_H
