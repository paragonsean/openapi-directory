...
/*
 * OAIUploaderConfig_ScheduleConfig.h
 *
 * 
 */

#ifndef OAIUploaderConfig_ScheduleConfig_H
#define OAIUploaderConfig_ScheduleConfig_H
...
class OAIUploaderConfig_ScheduleConfig : public OAIObject {
public:
    OAIUploaderConfig_ScheduleConfig();
    OAIUploaderConfig_ScheduleConfig(QString json);
    ~OAIUploaderConfig_ScheduleConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUploaderConfig_ScheduleConfig)

#endif // OAIUploaderConfig_ScheduleConfig_H
