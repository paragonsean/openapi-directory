...
/*
 * OAIDeleteStreamInput.h
 *
 * 
 */

#ifndef OAIDeleteStreamInput_H
#define OAIDeleteStreamInput_H
...
class OAIDeleteStreamInput : public OAIObject {
public:
    OAIDeleteStreamInput();
    OAIDeleteStreamInput(QString json);
    ~OAIDeleteStreamInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteStreamInput)

#endif // OAIDeleteStreamInput_H
