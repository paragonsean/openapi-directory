...
/*
 * OAIDeleteSignalingChannelInput.h
 *
 * 
 */

#ifndef OAIDeleteSignalingChannelInput_H
#define OAIDeleteSignalingChannelInput_H
...
class OAIDeleteSignalingChannelInput : public OAIObject {
public:
    OAIDeleteSignalingChannelInput();
    OAIDeleteSignalingChannelInput(QString json);
    ~OAIDeleteSignalingChannelInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteSignalingChannelInput)

#endif // OAIDeleteSignalingChannelInput_H
