...
#include "OAILastUploaderStatus.h"
...
OAILastUploaderStatus::OAILastUploaderStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILastUploaderStatus::OAILastUploaderStatus() {
    this->initializeModel();
}

OAILastUploaderStatus::~OAILastUploaderStatus() {}

void OAILastUploaderStatus::initializeModel() {
...
void OAILastUploaderStatus::fromJson(QString jsonString) {
...
void OAILastUploaderStatus::fromJsonObject(QJsonObject json) {
...
QString OAILastUploaderStatus::asJson() const {
...
QJsonObject OAILastUploaderStatus::asJsonObject() const {
    QJsonObject obj;
...
QString OAILastUploaderStatus::getJobStatusDetails() const {
    return m_job_status_details;
}
void OAILastUploaderStatus::setJobStatusDetails(const QString &job_status_details) {
    m_job_status_details = job_status_details;
    m_job_status_details_isSet = true;
}

bool OAILastUploaderStatus::is_job_status_details_Set() const{
    return m_job_status_details_isSet;
}

bool OAILastUploaderStatus::is_job_status_details_Valid() const{
    return m_job_status_details_isValid;
}

QDateTime OAILastUploaderStatus::getLastCollectedTime() const {
    return m_last_collected_time;
}
void OAILastUploaderStatus::setLastCollectedTime(const QDateTime &last_collected_time) {
    m_last_collected_time = last_collected_time;
    m_last_collected_time_isSet = true;
}

bool OAILastUploaderStatus::is_last_collected_time_Set() const{
    return m_last_collected_time_isSet;
}

bool OAILastUploaderStatus::is_last_collected_time_Valid() const{
    return m_last_collected_time_isValid;
}

QDateTime OAILastUploaderStatus::getLastUpdatedTime() const {
    return m_last_updated_time;
}
void OAILastUploaderStatus::setLastUpdatedTime(const QDateTime &last_updated_time) {
    m_last_updated_time = last_updated_time;
    m_last_updated_time_isSet = true;
}

bool OAILastUploaderStatus::is_last_updated_time_Set() const{
    return m_last_updated_time_isSet;
}

bool OAILastUploaderStatus::is_last_updated_time_Valid() const{
    return m_last_updated_time_isValid;
}

OAIUploaderStatus OAILastUploaderStatus::getUploaderStatus() const {
    return m_uploader_status;
}
void OAILastUploaderStatus::setUploaderStatus(const OAIUploaderStatus &uploader_status) {
    m_uploader_status = uploader_status;
    m_uploader_status_isSet = true;
}

bool OAILastUploaderStatus::is_uploader_status_Set() const{
    return m_uploader_status_isSet;
}

bool OAILastUploaderStatus::is_uploader_status_Valid() const{
    return m_uploader_status_isValid;
}

bool OAILastUploaderStatus::isSet() const {
...
bool OAILastUploaderStatus::isValid() const {
