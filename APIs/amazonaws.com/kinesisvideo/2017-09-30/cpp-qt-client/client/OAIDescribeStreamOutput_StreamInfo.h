...
/*
 * OAIDescribeStreamOutput_StreamInfo.h
 *
 * 
 */

#ifndef OAIDescribeStreamOutput_StreamInfo_H
#define OAIDescribeStreamOutput_StreamInfo_H
...
class OAIDescribeStreamOutput_StreamInfo : public OAIObject {
public:
    OAIDescribeStreamOutput_StreamInfo();
    OAIDescribeStreamOutput_StreamInfo(QString json);
    ~OAIDescribeStreamOutput_StreamInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeStreamOutput_StreamInfo)

#endif // OAIDescribeStreamOutput_StreamInfo_H
