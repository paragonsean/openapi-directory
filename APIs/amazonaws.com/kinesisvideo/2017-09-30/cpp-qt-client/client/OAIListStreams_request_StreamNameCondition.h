...
/*
 * OAIListStreams_request_StreamNameCondition.h
 *
...
#ifndef OAIListStreams_request_StreamNameCondition_H
#define OAIListStreams_request_StreamNameCondition_H
...
class OAIListStreams_request_StreamNameCondition : public OAIObject {
public:
    OAIListStreams_request_StreamNameCondition();
    OAIListStreams_request_StreamNameCondition(QString json);
    ~OAIListStreams_request_StreamNameCondition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListStreams_request_StreamNameCondition)

#endif // OAIListStreams_request_StreamNameCondition_H
