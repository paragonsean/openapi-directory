...
/*
 * OAIDeleteSignalingChannel_request.h
 *
 * 
 */

#ifndef OAIDeleteSignalingChannel_request_H
#define OAIDeleteSignalingChannel_request_H
...
class OAIDeleteSignalingChannel_request : public OAIObject {
public:
    OAIDeleteSignalingChannel_request();
    OAIDeleteSignalingChannel_request(QString json);
    ~OAIDeleteSignalingChannel_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteSignalingChannel_request)

#endif // OAIDeleteSignalingChannel_request_H
