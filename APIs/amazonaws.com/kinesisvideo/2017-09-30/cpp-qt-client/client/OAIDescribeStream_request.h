...
/*
 * OAIDescribeStream_request.h
 *
 * 
 */

#ifndef OAIDescribeStream_request_H
#define OAIDescribeStream_request_H
...
class OAIDescribeStream_request : public OAIObject {
public:
    OAIDescribeStream_request();
    OAIDescribeStream_request(QString json);
    ~OAIDescribeStream_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeStream_request)

#endif // OAIDescribeStream_request_H
