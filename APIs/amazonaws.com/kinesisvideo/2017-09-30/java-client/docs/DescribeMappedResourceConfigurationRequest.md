...
|**streamARN** | **String** | The Amazon Resource Name (ARN) of the stream. |  [optional] |
|**maxResults** | **Integer** | The maximum number of results to return in the response. |  [optional] |
|**nextToken** | **String** | The token to provide in your next request, to get another batch of results. |  [optional] |
