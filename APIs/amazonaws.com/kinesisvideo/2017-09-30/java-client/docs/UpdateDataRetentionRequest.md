...
|**operation** | [**OperationEnum**](#OperationEnum) | Indicates whether you want to increase or decrease the retention period. |  |
|**dataRetentionChangeInHours** | **Integer** | The retention period, in hours. The value you specify replaces the current value. The maximum value for this parameter is 87600 (ten years). |  |
