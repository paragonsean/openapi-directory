...
class DescribeEdgeConfigurationRequest(Model):
    ...
    def __init__(self, stream_name: str=None, stream_arn: str=None):
        """DescribeEdgeConfigurationRequest - a model defined in OpenAPI

        :param stream_name: The stream_name of this DescribeEdgeConfigurationRequest.
        :param stream_arn: The stream_arn of this DescribeEdgeConfigurationRequest.
        """
        self.openapi_types = {
            'stream_name': str,
            'stream_arn': str
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DescribeEdgeConfigurationRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DescribeEdgeConfiguration_request of this DescribeEdgeConfigurationRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def stream_name(self):
        """Gets the stream_name of this DescribeEdgeConfigurationRequest.
        ...
        :return: The stream_name of this DescribeEdgeConfigurationRequest.
        :rtype: str
        """
    ...
    def stream_name(self, stream_name):
        """Sets the stream_name of this DescribeEdgeConfigurationRequest.
    ...
    @property
    def stream_arn(self):
        """Gets the stream_arn of this DescribeEdgeConfigurationRequest.

        The Amazon Resource Name (ARN) of the stream. Specify either the <code>StreamName</code>or the <code>StreamARN</code>.

        :return: The stream_arn of this DescribeEdgeConfigurationRequest.
        :rtype: str
        """
    ...
    def stream_arn(self, stream_arn):
        """Sets the stream_arn of this DescribeEdgeConfigurationRequest.
