...
class DescribeEdgeConfigurationOutputEdgeConfig(Model):
    ...
    def __init__(self, hub_device_arn: str=None, recorder_config: StartEdgeConfigurationUpdateRequestEdgeConfigRecorderConfig=None, uploader_config: StartEdgeConfigurationUpdateRequestEdgeConfigUploaderConfig=None, deletion_config: StartEdgeConfigurationUpdateRequestEdgeConfigDeletionConfig=None):
        """DescribeEdgeConfigurationOutputEdgeConfig - a model defined in OpenAPI

        :param hub_device_arn: The hub_device_arn of this DescribeEdgeConfigurationOutputEdgeConfig.
        :param recorder_config: The recorder_config of this DescribeEdgeConfigurationOutputEdgeConfig.
        :param uploader_config: The uploader_config of this DescribeEdgeConfigurationOutputEdgeConfig.
        :param deletion_config: The deletion_config of this DescribeEdgeConfigurationOutputEdgeConfig.
        """
        self.openapi_types = {
            'hub_device_arn': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DescribeEdgeConfigurationOutputEdgeConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DescribeEdgeConfigurationOutput_EdgeConfig of this DescribeEdgeConfigurationOutputEdgeConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def hub_device_arn(self):
        """Gets the hub_device_arn of this DescribeEdgeConfigurationOutputEdgeConfig.


        :return: The hub_device_arn of this DescribeEdgeConfigurationOutputEdgeConfig.
        :rtype: str
        """
    ...
    def hub_device_arn(self, hub_device_arn):
        """Sets the hub_device_arn of this DescribeEdgeConfigurationOutputEdgeConfig.
    ...
    def recorder_config(self):
        """Gets the recorder_config of this DescribeEdgeConfigurationOutputEdgeConfig.


        :return: The recorder_config of this DescribeEdgeConfigurationOutputEdgeConfig.
    ...
    def recorder_config(self, recorder_config):
        """Sets the recorder_config of this DescribeEdgeConfigurationOutputEdgeConfig.
    ...
    def uploader_config(self):
        """Gets the uploader_config of this DescribeEdgeConfigurationOutputEdgeConfig.


        :return: The uploader_config of this DescribeEdgeConfigurationOutputEdgeConfig.
    ...
    def uploader_config(self, uploader_config):
        """Sets the uploader_config of this DescribeEdgeConfigurationOutputEdgeConfig.
    ...
    def deletion_config(self):
        """Gets the deletion_config of this DescribeEdgeConfigurationOutputEdgeConfig.


        :return: The deletion_config of this DescribeEdgeConfigurationOutputEdgeConfig.
    ...
    def deletion_config(self, deletion_config):
        """Sets the deletion_config of this DescribeEdgeConfigurationOutputEdgeConfig.
