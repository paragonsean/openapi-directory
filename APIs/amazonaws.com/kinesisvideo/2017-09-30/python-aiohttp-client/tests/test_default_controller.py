...
async def test_create_signaling_channel(client):
    """Test case for create_signaling_channel

    
    """
    body = openapi_server.CreateSignalingChannelRequest()
    headers = { 
...
async def test_create_stream(client):
    ...
    """
    body = openapi_server.CreateStreamRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_delete_edge_configuration(client):
    """Test case for delete_edge_configuration

    
    """
    body = openapi_server.DeleteEdgeConfigurationRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_delete_signaling_channel(client):
    """Test case for delete_signaling_channel

    
    """
    body = openapi_server.DeleteSignalingChannelRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_delete_stream(client):
    ...
    """
    body = openapi_server.DeleteStreamRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_describe_edge_configuration(client):
    """Test case for describe_edge_configuration

    
    """
    body = openapi_server.DescribeEdgeConfigurationRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_describe_image_generation_configuration(client):
    """Test case for describe_image_generation_configuration

    
    """
    body = openapi_server.DescribeImageGenerationConfigurationRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_describe_mapped_resource_configuration(client):
    """Test case for describe_mapped_resource_configuration

    
    """
    body = openapi_server.DescribeMappedResourceConfigurationRequest()
...
async def test_describe_media_storage_configuration(client):
    """Test case for describe_media_storage_configuration

    
    """
    body = openapi_server.DescribeMediaStorageConfigurationRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_describe_notification_configuration(client):
    """Test case for describe_notification_configuration

    
    """
    body = openapi_server.DescribeNotificationConfigurationRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_describe_signaling_channel(client):
    """Test case for describe_signaling_channel

    
    """
    body = openapi_server.DescribeSignalingChannelRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_describe_stream(client):
    """Test case for describe_stream

    
    """
    body = openapi_server.DescribeStreamRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_get_data_endpoint(client):
    """Test case for get_data_endpoint

    
    """
    body = openapi_server.GetDataEndpointRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_get_signaling_channel_endpoint(client):
    """Test case for get_signaling_channel_endpoint

    
    """
    body = openapi_server.GetSignalingChannelEndpointRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_list_edge_agent_configurations(client):
    """Test case for list_edge_agent_configurations

    
    """
    body = openapi_server.ListEdgeAgentConfigurationsRequest()
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_signaling_channels(client):
    """Test case for list_signaling_channels

    
    """
    body = openapi_server.ListSignalingChannelsRequest()
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_streams(client):
    ...
    """
    body = openapi_server.ListStreamsRequest()
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_tags_for_stream(client):
    """Test case for list_tags_for_stream

    
    """
    body = openapi_server.ListTagsForStreamRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_start_edge_configuration_update(client):
    """Test case for start_edge_configuration_update

    
    """
    body = openapi_server.StartEdgeConfigurationUpdateRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_tag_stream(client):
    """Test case for tag_stream

    
    """
    body = openapi_server.TagStreamRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_untag_stream(client):
    """Test case for untag_stream

    
    """
    body = openapi_server.UntagStreamRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_data_retention(client):
    """Test case for update_data_retention

    
    """
    body = openapi_server.UpdateDataRetentionRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_image_generation_configuration(client):
    """Test case for update_image_generation_configuration

    
    """
    body = openapi_server.UpdateImageGenerationConfigurationRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_media_storage_configuration(client):
    """Test case for update_media_storage_configuration

    
    """
    body = openapi_server.UpdateMediaStorageConfigurationRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_notification_configuration(client):
    """Test case for update_notification_configuration

    
    """
    body = openapi_server.UpdateNotificationConfigurationRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_signaling_channel(client):
    """Test case for update_signaling_channel

    
    """
    body = openapi_server.UpdateSignalingChannelRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_stream(client):
    ...
    """
    body = openapi_server.UpdateStreamRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
