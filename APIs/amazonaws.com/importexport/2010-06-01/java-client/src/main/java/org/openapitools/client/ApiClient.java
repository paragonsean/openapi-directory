...
public class ApiClient {
    ...
    private String basePath = "http://importexport.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2010-06-01/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://importexport.amazonaws.com
