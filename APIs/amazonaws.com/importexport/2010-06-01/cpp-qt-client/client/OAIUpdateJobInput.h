...
#ifndef OAIUpdateJobInput_H
#define OAIUpdateJobInput_H
...
class OAIUpdateJobInput : public OAIObject {
public:
    OAIUpdateJobInput();
    OAIUpdateJobInput(QString json);
    ~OAIUpdateJobInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateJobInput)

#endif // OAIUpdateJobInput_H
