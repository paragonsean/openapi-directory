...
OAICapacityLimits OAIUpdateAccountSettingsRequest::getCapacityLimits() const {
    return m_capacity_limits;
}
void OAIUpdateAccountSettingsRequest::setCapacityLimits(const OAICapacityLimits &capacity_limits) {
    m_capacity_limits = capacity_limits;
    m_capacity_limits_isSet = true;
}

bool OAIUpdateAccountSettingsRequest::is_capacity_limits_Set() const{
    return m_capacity_limits_isSet;
}

bool OAIUpdateAccountSettingsRequest::is_capacity_limits_Valid() const{
