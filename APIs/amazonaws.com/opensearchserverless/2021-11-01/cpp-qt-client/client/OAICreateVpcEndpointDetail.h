...
#ifndef OAICreateVpcEndpointDetail_H
#define OAICreateVpcEndpointDetail_H
...
class OAICreateVpcEndpointDetail : public OAIObject {
public:
    OAICreateVpcEndpointDetail();
    OAICreateVpcEndpointDetail(QString json);
    ~OAICreateVpcEndpointDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateVpcEndpointDetail)

#endif // OAICreateVpcEndpointDetail_H
