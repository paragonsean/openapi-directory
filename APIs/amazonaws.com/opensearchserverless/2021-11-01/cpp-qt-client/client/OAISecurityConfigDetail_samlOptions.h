...
/*
 * OAISecurityConfigDetail_samlOptions.h
 *
 * 
 */

#ifndef OAISecurityConfigDetail_samlOptions_H
#define OAISecurityConfigDetail_samlOptions_H
...
class OAISecurityConfigDetail_samlOptions : public OAIObject {
public:
    OAISecurityConfigDetail_samlOptions();
    OAISecurityConfigDetail_samlOptions(QString json);
    ~OAISecurityConfigDetail_samlOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISecurityConfigDetail_samlOptions)

#endif // OAISecurityConfigDetail_samlOptions_H
