...
/*
 * OAIUpdateSecurityConfigRequest_samlOptions.h
 *
 * 
 */

#ifndef OAIUpdateSecurityConfigRequest_samlOptions_H
#define OAIUpdateSecurityConfigRequest_samlOptions_H
...
class OAIUpdateSecurityConfigRequest_samlOptions : public OAIObject {
public:
    OAIUpdateSecurityConfigRequest_samlOptions();
    OAIUpdateSecurityConfigRequest_samlOptions(QString json);
    ~OAIUpdateSecurityConfigRequest_samlOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSecurityConfigRequest_samlOptions)

#endif // OAIUpdateSecurityConfigRequest_samlOptions_H
