...
/*
 * OAISecurityConfigDetail.h
 *
 * Details about a security configuration for OpenSearch Serverless. 
 */

#ifndef OAISecurityConfigDetail_H
#define OAISecurityConfigDetail_H
...
class OAISecurityConfigDetail : public OAIObject {
public:
    OAISecurityConfigDetail();
    OAISecurityConfigDetail(QString json);
    ~OAISecurityConfigDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISecurityConfigDetail)

#endif // OAISecurityConfigDetail_H
