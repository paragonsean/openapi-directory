...
/*
 * OAIVpcEndpointErrorDetail.h
 *
 * Error information for a failed &lt;code&gt;BatchGetVpcEndpoint&lt;/code&gt; request.
 */

#ifndef OAIVpcEndpointErrorDetail_H
#define OAIVpcEndpointErrorDetail_H
...
class OAIVpcEndpointErrorDetail : public OAIObject {
public:
    OAIVpcEndpointErrorDetail();
    OAIVpcEndpointErrorDetail(QString json);
    ~OAIVpcEndpointErrorDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVpcEndpointErrorDetail)

#endif // OAIVpcEndpointErrorDetail_H
