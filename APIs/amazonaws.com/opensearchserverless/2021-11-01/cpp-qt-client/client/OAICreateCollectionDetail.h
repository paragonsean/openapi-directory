...
/*
 * OAICreateCollectionDetail.h
 *
 * Details about the created OpenSearch Serverless collection.
 */

#ifndef OAICreateCollectionDetail_H
#define OAICreateCollectionDetail_H
...
class OAICreateCollectionDetail : public OAIObject {
public:
    OAICreateCollectionDetail();
    OAICreateCollectionDetail(QString json);
    ~OAICreateCollectionDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCollectionDetail)

#endif // OAICreateCollectionDetail_H
