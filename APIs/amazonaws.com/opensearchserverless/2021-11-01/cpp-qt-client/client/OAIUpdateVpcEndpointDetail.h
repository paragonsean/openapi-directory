...
/*
 * OAIUpdateVpcEndpointDetail.h
 *
 * Update details for an OpenSearch Serverless-managed interface endpoint.
 */

#ifndef OAIUpdateVpcEndpointDetail_H
#define OAIUpdateVpcEndpointDetail_H
...
class OAIUpdateVpcEndpointDetail : public OAIObject {
public:
    OAIUpdateVpcEndpointDetail();
    OAIUpdateVpcEndpointDetail(QString json);
    ~OAIUpdateVpcEndpointDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateVpcEndpointDetail)

#endif // OAIUpdateVpcEndpointDetail_H
