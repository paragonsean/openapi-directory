...
/*
 * OAISecurityConfigSummary.h
 *
 * A summary of a security configuration for OpenSearch Serverless.
 */

#ifndef OAISecurityConfigSummary_H
#define OAISecurityConfigSummary_H
...
class OAISecurityConfigSummary : public OAIObject {
public:
    OAISecurityConfigSummary();
    OAISecurityConfigSummary(QString json);
    ~OAISecurityConfigSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISecurityConfigSummary)

#endif // OAISecurityConfigSummary_H
