...
/*
 * OAICreateSecurityConfigRequest_samlOptions.h
 *
 * 
 */

#ifndef OAICreateSecurityConfigRequest_samlOptions_H
#define OAICreateSecurityConfigRequest_samlOptions_H
...
class OAICreateSecurityConfigRequest_samlOptions : public OAIObject {
public:
    OAICreateSecurityConfigRequest_samlOptions();
    OAICreateSecurityConfigRequest_samlOptions(QString json);
    ~OAICreateSecurityConfigRequest_samlOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSecurityConfigRequest_samlOptions)

#endif // OAICreateSecurityConfigRequest_samlOptions_H
