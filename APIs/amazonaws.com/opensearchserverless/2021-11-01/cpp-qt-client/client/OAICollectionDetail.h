...
#ifndef OAICollectionDetail_H
#define OAICollectionDetail_H
...
class OAICollectionDetail : public OAIObject {
public:
    OAICollectionDetail();
    OAICollectionDetail(QString json);
    ~OAICollectionDetail() override;
    ...
    QString getDashboardEndpoint() const;
    void setDashboardEndpoint(const QString &dashboard_endpoint);
    bool is_dashboard_endpoint_Set() const;
    bool is_dashboard_endpoint_Valid() const;
...
private:
    ...
    QString m_dashboard_endpoint;
    bool m_dashboard_endpoint_isSet;
    bool m_dashboard_endpoint_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICollectionDetail)

#endif // OAICollectionDetail_H
