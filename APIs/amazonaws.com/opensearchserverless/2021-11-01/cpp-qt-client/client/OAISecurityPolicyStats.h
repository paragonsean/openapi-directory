...
/*
 * OAISecurityPolicyStats.h
 *
 * Statistics for an OpenSearch Serverless security policy.
 */

#ifndef OAISecurityPolicyStats_H
#define OAISecurityPolicyStats_H
...
class OAISecurityPolicyStats : public OAIObject {
public:
    OAISecurityPolicyStats();
    OAISecurityPolicyStats(QString json);
    ~OAISecurityPolicyStats() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISecurityPolicyStats)

#endif // OAISecurityPolicyStats_H
