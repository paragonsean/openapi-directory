...
public class DeleteCollectionRequest {
  ...
  public DeleteCollectionRequest clientToken(String clientToken) {
  ...
  public DeleteCollectionRequest id(String id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.clientToken, deleteCollectionRequest.clientToken) &&
        Objects.equals(this.id, deleteCollectionRequest.id);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteCollectionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteCollectionRequest is not found in the empty JSON string", DeleteCollectionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteCollectionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteCollectionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteCollectionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteCollectionRequest' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<DeleteCollectionRequest>() {
           @Override
           public void write(JsonWriter out, DeleteCollectionRequest value) throws IOException {
