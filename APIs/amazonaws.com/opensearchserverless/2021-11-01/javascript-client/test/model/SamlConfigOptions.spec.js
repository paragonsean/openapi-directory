...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenSearchServiceServerless.SamlConfigOptions();
  });
  ...
  describe('SamlConfigOptions', function() {
    it('should create an instance of SamlConfigOptions', function() {
      // uncomment below and update the code to test SamlConfigOptions
      //var instance = new OpenSearchServiceServerless.SamlConfigOptions();
      //expect(instance).to.be.a(OpenSearchServiceServerless.SamlConfigOptions);
    });
