...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenSearchServiceServerless.UpdateVpcEndpointResponseUpdateVpcEndpointDetail();
  });
  ...
  describe('UpdateVpcEndpointResponseUpdateVpcEndpointDetail', function() {
    it('should create an instance of UpdateVpcEndpointResponseUpdateVpcEndpointDetail', function() {
      // uncomment below and update the code to test UpdateVpcEndpointResponseUpdateVpcEndpointDetail
      //var instance = new OpenSearchServiceServerless.UpdateVpcEndpointResponseUpdateVpcEndpointDetail();
      //expect(instance).to.be.a(OpenSearchServiceServerless.UpdateVpcEndpointResponseUpdateVpcEndpointDetail);
    });
