...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenSearchServiceServerless.ListSecurityPoliciesRequest();
  });
  ...
  describe('ListSecurityPoliciesRequest', function() {
    it('should create an instance of ListSecurityPoliciesRequest', function() {
      // uncomment below and update the code to test ListSecurityPoliciesRequest
      //var instance = new OpenSearchServiceServerless.ListSecurityPoliciesRequest();
      //expect(instance).to.be.a(OpenSearchServiceServerless.ListSecurityPoliciesRequest);
    });
