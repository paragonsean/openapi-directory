...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenSearchServiceServerless.CreateVpcEndpointRequest();
  });
  ...
  describe('CreateVpcEndpointRequest', function() {
    it('should create an instance of CreateVpcEndpointRequest', function() {
      // uncomment below and update the code to test CreateVpcEndpointRequest
      //var instance = new OpenSearchServiceServerless.CreateVpcEndpointRequest();
      //expect(instance).to.be.a(OpenSearchServiceServerless.CreateVpcEndpointRequest);
    });
