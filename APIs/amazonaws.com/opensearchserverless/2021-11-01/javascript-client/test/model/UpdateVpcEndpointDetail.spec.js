...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenSearchServiceServerless.UpdateVpcEndpointDetail();
  });
  ...
  describe('UpdateVpcEndpointDetail', function() {
    it('should create an instance of UpdateVpcEndpointDetail', function() {
      // uncomment below and update the code to test UpdateVpcEndpointDetail
      //var instance = new OpenSearchServiceServerless.UpdateVpcEndpointDetail();
      //expect(instance).to.be.a(OpenSearchServiceServerless.UpdateVpcEndpointDetail);
    });
