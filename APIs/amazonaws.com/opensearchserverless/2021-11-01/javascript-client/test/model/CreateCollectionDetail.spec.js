...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenSearchServiceServerless.CreateCollectionDetail();
  });
  ...
  describe('CreateCollectionDetail', function() {
    it('should create an instance of CreateCollectionDetail', function() {
      // uncomment below and update the code to test CreateCollectionDetail
      //var instance = new OpenSearchServiceServerless.CreateCollectionDetail();
      //expect(instance).to.be.a(OpenSearchServiceServerless.CreateCollectionDetail);
    });
