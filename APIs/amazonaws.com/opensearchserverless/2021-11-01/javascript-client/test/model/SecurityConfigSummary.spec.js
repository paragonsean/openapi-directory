...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenSearchServiceServerless.SecurityConfigSummary();
  });
  ...
  describe('SecurityConfigSummary', function() {
    it('should create an instance of SecurityConfigSummary', function() {
      // uncomment below and update the code to test SecurityConfigSummary
      //var instance = new OpenSearchServiceServerless.SecurityConfigSummary();
      //expect(instance).to.be.a(OpenSearchServiceServerless.SecurityConfigSummary);
    });
