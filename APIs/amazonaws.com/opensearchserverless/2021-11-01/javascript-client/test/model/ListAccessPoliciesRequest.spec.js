...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenSearchServiceServerless.ListAccessPoliciesRequest();
  });
  ...
  describe('ListAccessPoliciesRequest', function() {
    it('should create an instance of ListAccessPoliciesRequest', function() {
      // uncomment below and update the code to test ListAccessPoliciesRequest
      //var instance = new OpenSearchServiceServerless.ListAccessPoliciesRequest();
      //expect(instance).to.be.a(OpenSearchServiceServerless.ListAccessPoliciesRequest);
    });
