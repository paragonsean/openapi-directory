...
class UpdateCollectionRequest {
    ...
    constructor(id) { 
        ...
        UpdateCollectionRequest.initialize(this, id);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateCollectionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateCollectionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateCollectionRequest.RequiredProperties) {
...
UpdateCollectionRequest.RequiredProperties = ["id"];

/**
 * @member {String} clientToken
 */
UpdateCollectionRequest.prototype['clientToken'] = undefined;

/**
 * @member {String} description
 */
UpdateCollectionRequest.prototype['description'] = undefined;

/**
 * @member {String} id
 */
UpdateCollectionRequest.prototype['id'] = undefined;
