# AmazonSageMakerRuntime.DefaultApi
...
> InvokeEndpointOutput invokeEndpoint(endpointName, invokeEndpointRequest, opts)
...
```javascript
import AmazonSageMakerRuntime from 'amazon_sage_maker_runtime';
let defaultClient = AmazonSageMakerRuntime.ApiClient.instance;
...
let apiInstance = new AmazonSageMakerRuntime.DefaultApi();
let endpointName = "endpointName_example"; // String | The name of the endpoint that you specified when you created the endpoint using the <a href=\"https://docs.aws.amazon.com/sagemaker/latest/dg/API_CreateEndpoint.html\">CreateEndpoint</a> API. 
let invokeEndpointRequest = new AmazonSageMakerRuntime.InvokeEndpointRequest(); // InvokeEndpointRequest | 
let opts = {
...
apiInstance.invokeEndpoint(endpointName, invokeEndpointRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> InvokeEndpointAsyncOutput invokeEndpointAsync(endpointName, xAmznSageMakerInputLocation, opts)
...
let apiInstance = new AmazonSageMakerRuntime.DefaultApi();
let endpointName = "endpointName_example"; // String | The name of the endpoint that you specified when you created the endpoint using the <a href=\"https://docs.aws.amazon.com/sagemaker/latest/APIReference/API_CreateEndpoint.html\"> <code>CreateEndpoint</code> </a> API.
let xAmznSageMakerInputLocation = "xAmznSageMakerInputLocation_example"; // String | The Amazon S3 URI where the inference request payload is stored.
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
  ...
  'xAmzSignature': "xAmzSignature_example", // String | 
  'xAmzSignedHeaders': "xAmzSignedHeaders_example", // String | 
  'xAmznSageMakerContentType': "xAmznSageMakerContentType_example", // String | The MIME type of the input data in the request body.
  'xAmznSageMakerAccept': "xAmznSageMakerAccept_example", // String | The desired MIME type of the inference in the response.
  ...
  'xAmznSageMakerInferenceId': "xAmznSageMakerInferenceId_example", // String | The identifier for the inference request. Amazon SageMaker will generate an identifier for you if none is specified. 
  'xAmznSageMakerRequestTTLSeconds': 56, // Number | Maximum age in seconds a request can be in the queue before it is marked as expired. The default is 6 hours, or 21,600 seconds.
  'xAmznSageMakerInvocationTimeoutSeconds': 56 // Number | Maximum amount of time in seconds a request can be processed before it is marked as expired. The default is 15 minutes, or 900 seconds.
};
apiInstance.invokeEndpointAsync(endpointName, xAmznSageMakerInputLocation, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **xAmznSageMakerRequestTTLSeconds** | **Number**| Maximum age in seconds a request can be in the queue before it is marked as expired. The default is 6 hours, or 21,600 seconds. | [optional] 
 **xAmznSageMakerInvocationTimeoutSeconds** | **Number**| Maximum amount of time in seconds a request can be processed before it is marked as expired. The default is 15 minutes, or 900 seconds. | [optional] 
