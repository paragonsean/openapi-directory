...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsComprehendMedical.SNOMEDCTAttribute();
  });
  ...
  describe('SNOMEDCTAttribute', function() {
    it('should create an instance of SNOMEDCTAttribute', function() {
      // uncomment below and update the code to test SNOMEDCTAttribute
      //var instance = new AwsComprehendMedical.SNOMEDCTAttribute();
      //expect(instance).to.be.a(AwsComprehendMedical.SNOMEDCTAttribute);
    });
