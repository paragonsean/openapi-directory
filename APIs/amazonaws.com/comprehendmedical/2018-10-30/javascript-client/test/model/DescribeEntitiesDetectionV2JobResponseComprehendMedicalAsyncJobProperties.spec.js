...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsComprehendMedical.DescribeEntitiesDetectionV2JobResponseComprehendMedicalAsyncJobProperties();
  });
  ...
  describe('DescribeEntitiesDetectionV2JobResponseComprehendMedicalAsyncJobProperties', function() {
    it('should create an instance of DescribeEntitiesDetectionV2JobResponseComprehendMedicalAsyncJobProperties', function() {
      // uncomment below and update the code to test DescribeEntitiesDetectionV2JobResponseComprehendMedicalAsyncJobProperties
      //var instance = new AwsComprehendMedical.DescribeEntitiesDetectionV2JobResponseComprehendMedicalAsyncJobProperties();
      //expect(instance).to.be.a(AwsComprehendMedical.DescribeEntitiesDetectionV2JobResponseComprehendMedicalAsyncJobProperties);
    });
