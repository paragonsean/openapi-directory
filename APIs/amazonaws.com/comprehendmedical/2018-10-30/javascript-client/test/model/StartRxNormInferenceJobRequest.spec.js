...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsComprehendMedical.StartRxNormInferenceJobRequest();
  });
  ...
  describe('StartRxNormInferenceJobRequest', function() {
    it('should create an instance of StartRxNormInferenceJobRequest', function() {
      // uncomment below and update the code to test StartRxNormInferenceJobRequest
      //var instance = new AwsComprehendMedical.StartRxNormInferenceJobRequest();
      //expect(instance).to.be.a(AwsComprehendMedical.StartRxNormInferenceJobRequest);
    });
