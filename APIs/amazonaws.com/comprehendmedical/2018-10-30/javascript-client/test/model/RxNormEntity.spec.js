...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsComprehendMedical.RxNormEntity();
  });
  ...
  describe('RxNormEntity', function() {
    it('should create an instance of RxNormEntity', function() {
      // uncomment below and update the code to test RxNormEntity
      //var instance = new AwsComprehendMedical.RxNormEntity();
      //expect(instance).to.be.a(AwsComprehendMedical.RxNormEntity);
    });
    ...
    it('should have the property rxNormConcepts (base name: "RxNormConcepts")', function() {
      // uncomment below and update the code to test the property rxNormConcepts
      //var instance = new AwsComprehendMedical.RxNormEntity();
      //expect(instance).to.be();
    });
