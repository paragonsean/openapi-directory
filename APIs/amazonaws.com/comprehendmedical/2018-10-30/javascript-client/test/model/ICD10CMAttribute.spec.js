...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsComprehendMedical.ICD10CMAttribute();
  });
  ...
  describe('ICD10CMAttribute', function() {
    it('should create an instance of ICD10CMAttribute', function() {
      // uncomment below and update the code to test ICD10CMAttribute
      //var instance = new AwsComprehendMedical.ICD10CMAttribute();
      //expect(instance).to.be.a(AwsComprehendMedical.ICD10CMAttribute);
    });
