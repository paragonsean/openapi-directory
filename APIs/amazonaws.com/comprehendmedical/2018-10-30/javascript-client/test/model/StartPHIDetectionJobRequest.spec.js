...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsComprehendMedical.StartPHIDetectionJobRequest();
  });
  ...
  describe('StartPHIDetectionJobRequest', function() {
    it('should create an instance of StartPHIDetectionJobRequest', function() {
      // uncomment below and update the code to test StartPHIDetectionJobRequest
      //var instance = new AwsComprehendMedical.StartPHIDetectionJobRequest();
      //expect(instance).to.be.a(AwsComprehendMedical.StartPHIDetectionJobRequest);
    });
