...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsComprehendMedical.StartICD10CMInferenceJobRequest();
  });
  ...
  describe('StartICD10CMInferenceJobRequest', function() {
    it('should create an instance of StartICD10CMInferenceJobRequest', function() {
      // uncomment below and update the code to test StartICD10CMInferenceJobRequest
      //var instance = new AwsComprehendMedical.StartICD10CMInferenceJobRequest();
      //expect(instance).to.be.a(AwsComprehendMedical.StartICD10CMInferenceJobRequest);
    });
