...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsComprehendMedical.RxNormAttribute();
  });
  ...
  describe('RxNormAttribute', function() {
    it('should create an instance of RxNormAttribute', function() {
      // uncomment below and update the code to test RxNormAttribute
      //var instance = new AwsComprehendMedical.RxNormAttribute();
      //expect(instance).to.be.a(AwsComprehendMedical.RxNormAttribute);
    });
