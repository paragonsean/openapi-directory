...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsComprehendMedical.InferRxNormResponse();
  });
  ...
  describe('InferRxNormResponse', function() {
    it('should create an instance of InferRxNormResponse', function() {
      // uncomment below and update the code to test InferRxNormResponse
      //var instance = new AwsComprehendMedical.InferRxNormResponse();
      //expect(instance).to.be.a(AwsComprehendMedical.InferRxNormResponse);
    });
