...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsComprehendMedical.InferICD10CMResponse();
  });
  ...
  describe('InferICD10CMResponse', function() {
    it('should create an instance of InferICD10CMResponse', function() {
      // uncomment below and update the code to test InferICD10CMResponse
      //var instance = new AwsComprehendMedical.InferICD10CMResponse();
      //expect(instance).to.be.a(AwsComprehendMedical.InferICD10CMResponse);
    });
