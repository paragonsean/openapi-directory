...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsComprehendMedical.StartEntitiesDetectionV2JobRequest();
  });
  ...
  describe('StartEntitiesDetectionV2JobRequest', function() {
    it('should create an instance of StartEntitiesDetectionV2JobRequest', function() {
      // uncomment below and update the code to test StartEntitiesDetectionV2JobRequest
      //var instance = new AwsComprehendMedical.StartEntitiesDetectionV2JobRequest();
      //expect(instance).to.be.a(AwsComprehendMedical.StartEntitiesDetectionV2JobRequest);
    });
