...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsComprehendMedical.InferSNOMEDCTResponse();
  });
  ...
  describe('InferSNOMEDCTResponse', function() {
    it('should create an instance of InferSNOMEDCTResponse', function() {
      // uncomment below and update the code to test InferSNOMEDCTResponse
      //var instance = new AwsComprehendMedical.InferSNOMEDCTResponse();
      //expect(instance).to.be.a(AwsComprehendMedical.InferSNOMEDCTResponse);
    });
    ...
    it('should have the property sNOMEDCTDetails (base name: "SNOMEDCTDetails")', function() {
      // uncomment below and update the code to test the property sNOMEDCTDetails
      //var instance = new AwsComprehendMedical.InferSNOMEDCTResponse();
      //expect(instance).to.be();
    });
