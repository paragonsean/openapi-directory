...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsComprehendMedical.DetectPHIResponse();
  });
  ...
  describe('DetectPHIResponse', function() {
    it('should create an instance of DetectPHIResponse', function() {
      // uncomment below and update the code to test DetectPHIResponse
      //var instance = new AwsComprehendMedical.DetectPHIResponse();
      //expect(instance).to.be.a(AwsComprehendMedical.DetectPHIResponse);
    });
