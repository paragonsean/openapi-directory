...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsComprehendMedical.SNOMEDCTEntity();
  });
  ...
  describe('SNOMEDCTEntity', function() {
    it('should create an instance of SNOMEDCTEntity', function() {
      // uncomment below and update the code to test SNOMEDCTEntity
      //var instance = new AwsComprehendMedical.SNOMEDCTEntity();
      //expect(instance).to.be.a(AwsComprehendMedical.SNOMEDCTEntity);
    });
    ...
    it('should have the property sNOMEDCTConcepts (base name: "SNOMEDCTConcepts")', function() {
      // uncomment below and update the code to test the property sNOMEDCTConcepts
      //var instance = new AwsComprehendMedical.SNOMEDCTEntity();
      //expect(instance).to.be();
    });
