...
/**
 * The StartICD10CMInferenceJobRequest model module.
 * @module model/StartICD10CMInferenceJobRequest
 * @version 2018-10-30
 */
class StartICD10CMInferenceJobRequest {
    /**
     * Constructs a new <code>StartICD10CMInferenceJobRequest</code>.
     * @alias module:model/StartICD10CMInferenceJobRequest
    ...
    constructor(inputDataConfig, outputDataConfig, dataAccessRoleArn, languageCode) { 
        ...
        StartICD10CMInferenceJobRequest.initialize(this, inputDataConfig, outputDataConfig, dataAccessRoleArn, languageCode);
    }
    ...
    /**
     * Constructs a <code>StartICD10CMInferenceJobRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartICD10CMInferenceJobRequest} obj Optional instance to populate.
     * @return {module:model/StartICD10CMInferenceJobRequest} The populated <code>StartICD10CMInferenceJobRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartICD10CMInferenceJobRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>StartICD10CMInferenceJobRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartICD10CMInferenceJobRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartICD10CMInferenceJobRequest.RequiredProperties) {
...
StartICD10CMInferenceJobRequest.RequiredProperties = ["InputDataConfig", "OutputDataConfig", "DataAccessRoleArn", "LanguageCode"];

/**
 * @member {module:model/StartICD10CMInferenceJobRequestInputDataConfig} InputDataConfig
 */
StartICD10CMInferenceJobRequest.prototype['InputDataConfig'] = undefined;

/**
 * @member {module:model/StartICD10CMInferenceJobRequestOutputDataConfig} OutputDataConfig
 */
StartICD10CMInferenceJobRequest.prototype['OutputDataConfig'] = undefined;

/**
 * @member {String} DataAccessRoleArn
 */
StartICD10CMInferenceJobRequest.prototype['DataAccessRoleArn'] = undefined;

/**
 * @member {String} JobName
 */
StartICD10CMInferenceJobRequest.prototype['JobName'] = undefined;

/**
 * @member {String} ClientRequestToken
 */
StartICD10CMInferenceJobRequest.prototype['ClientRequestToken'] = undefined;

/**
 * @member {String} KMSKey
 */
StartICD10CMInferenceJobRequest.prototype['KMSKey'] = undefined;

/**
 * @member {module:model/LanguageCode} LanguageCode
 */
StartICD10CMInferenceJobRequest.prototype['LanguageCode'] = undefined;
...
export default StartICD10CMInferenceJobRequest;
