...
/*
 * OAIListPHIDetectionJobsRequest.h
 *
 * 
 */

#ifndef OAIListPHIDetectionJobsRequest_H
#define OAIListPHIDetectionJobsRequest_H
...
class OAIListPHIDetectionJobsRequest : public OAIObject {
public:
    OAIListPHIDetectionJobsRequest();
    OAIListPHIDetectionJobsRequest(QString json);
    ~OAIListPHIDetectionJobsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPHIDetectionJobsRequest)

#endif // OAIListPHIDetectionJobsRequest_H
