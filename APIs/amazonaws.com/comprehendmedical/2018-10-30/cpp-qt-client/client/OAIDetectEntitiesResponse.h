...
/*
 * OAIDetectEntitiesResponse.h
 *
 * 
 */

#ifndef OAIDetectEntitiesResponse_H
#define OAIDetectEntitiesResponse_H
...
class OAIDetectEntitiesResponse : public OAIObject {
public:
    OAIDetectEntitiesResponse();
    OAIDetectEntitiesResponse(QString json);
    ~OAIDetectEntitiesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectEntitiesResponse)

#endif // OAIDetectEntitiesResponse_H
