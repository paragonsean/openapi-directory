...
/*
 * OAIStartSNOMEDCTInferenceJobRequest.h
 *
 * 
 */

#ifndef OAIStartSNOMEDCTInferenceJobRequest_H
#define OAIStartSNOMEDCTInferenceJobRequest_H
...
namespace OpenAPI {
class OAIInputDataConfig;
class OAIOutputDataConfig;

class OAIStartSNOMEDCTInferenceJobRequest : public OAIObject {
public:
    OAIStartSNOMEDCTInferenceJobRequest();
    OAIStartSNOMEDCTInferenceJobRequest(QString json);
    ~OAIStartSNOMEDCTInferenceJobRequest() override;
    ...
    OAIInputDataConfig getInputDataConfig() const;
    void setInputDataConfig(const OAIInputDataConfig &input_data_config);
    bool is_input_data_config_Set() const;
    bool is_input_data_config_Valid() const;

    OAIOutputDataConfig getOutputDataConfig() const;
    void setOutputDataConfig(const OAIOutputDataConfig &output_data_config);
...
private:
    ...
    OAIInputDataConfig m_input_data_config;
    bool m_input_data_config_isSet;
    bool m_input_data_config_isValid;

    OAIOutputDataConfig m_output_data_config;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartSNOMEDCTInferenceJobRequest)

#endif // OAIStartSNOMEDCTInferenceJobRequest_H
