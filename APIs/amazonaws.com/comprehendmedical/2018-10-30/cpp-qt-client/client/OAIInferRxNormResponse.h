...
/*
 * OAIInferRxNormResponse.h
 *
 * 
 */

#ifndef OAIInferRxNormResponse_H
#define OAIInferRxNormResponse_H
...
class OAIInferRxNormResponse : public OAIObject {
public:
    OAIInferRxNormResponse();
    OAIInferRxNormResponse(QString json);
    ~OAIInferRxNormResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInferRxNormResponse)

#endif // OAIInferRxNormResponse_H
