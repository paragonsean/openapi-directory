...
/*
 * OAIDetectPHIResponse.h
 *
 * 
 */

#ifndef OAIDetectPHIResponse_H
#define OAIDetectPHIResponse_H
...
class OAIDetectPHIResponse : public OAIObject {
public:
    OAIDetectPHIResponse();
    OAIDetectPHIResponse(QString json);
    ~OAIDetectPHIResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectPHIResponse)

#endif // OAIDetectPHIResponse_H
