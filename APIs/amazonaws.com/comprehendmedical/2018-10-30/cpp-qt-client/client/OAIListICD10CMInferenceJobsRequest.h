...
/*
 * OAIListICD10CMInferenceJobsRequest.h
 *
 * 
 */

#ifndef OAIListICD10CMInferenceJobsRequest_H
#define OAIListICD10CMInferenceJobsRequest_H
...
class OAIListICD10CMInferenceJobsRequest : public OAIObject {
public:
    OAIListICD10CMInferenceJobsRequest();
    OAIListICD10CMInferenceJobsRequest(QString json);
    ~OAIListICD10CMInferenceJobsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListICD10CMInferenceJobsRequest)

#endif // OAIListICD10CMInferenceJobsRequest_H
