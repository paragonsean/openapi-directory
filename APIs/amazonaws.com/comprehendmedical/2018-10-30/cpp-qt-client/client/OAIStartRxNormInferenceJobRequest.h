...
/*
 * OAIStartRxNormInferenceJobRequest.h
 *
 * 
 */

#ifndef OAIStartRxNormInferenceJobRequest_H
#define OAIStartRxNormInferenceJobRequest_H
...
class OAIStartRxNormInferenceJobRequest : public OAIObject {
public:
    OAIStartRxNormInferenceJobRequest();
    OAIStartRxNormInferenceJobRequest(QString json);
    ~OAIStartRxNormInferenceJobRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartRxNormInferenceJobRequest)

#endif // OAIStartRxNormInferenceJobRequest_H
