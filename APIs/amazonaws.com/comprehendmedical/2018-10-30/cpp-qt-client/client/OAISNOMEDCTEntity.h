...
#ifndef OAISNOMEDCTEntity_H
#define OAISNOMEDCTEntity_H
...
class OAISNOMEDCTEntity : public OAIObject {
public:
    OAISNOMEDCTEntity();
    OAISNOMEDCTEntity(QString json);
    ~OAISNOMEDCTEntity() override;
    ...
    OAISNOMEDCTEntityType getType() const;
    void setType(const OAISNOMEDCTEntityType &type);
...
Q_DECLARE_METATYPE(OpenAPI::OAISNOMEDCTEntity)

#endif // OAISNOMEDCTEntity_H
