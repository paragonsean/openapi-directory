...
/*
 * OAIListRxNormInferenceJobsRequest.h
 *
 * 
 */

#ifndef OAIListRxNormInferenceJobsRequest_H
#define OAIListRxNormInferenceJobsRequest_H
...
class OAIListRxNormInferenceJobsRequest : public OAIObject {
public:
    OAIListRxNormInferenceJobsRequest();
    OAIListRxNormInferenceJobsRequest(QString json);
    ~OAIListRxNormInferenceJobsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListRxNormInferenceJobsRequest)

#endif // OAIListRxNormInferenceJobsRequest_H
