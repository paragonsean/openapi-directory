...
/*
 * OAIStartEntitiesDetectionV2JobRequest.h
 *
 * 
 */

#ifndef OAIStartEntitiesDetectionV2JobRequest_H
#define OAIStartEntitiesDetectionV2JobRequest_H
...
namespace OpenAPI {
class OAIStartEntitiesDetectionV2JobRequest_InputDataConfig;
class OAIStartEntitiesDetectionV2JobRequest_OutputDataConfig;

class OAIStartEntitiesDetectionV2JobRequest : public OAIObject {
public:
    OAIStartEntitiesDetectionV2JobRequest();
    OAIStartEntitiesDetectionV2JobRequest(QString json);
    ~OAIStartEntitiesDetectionV2JobRequest() override;
    ...
    OAIStartEntitiesDetectionV2JobRequest_InputDataConfig getInputDataConfig() const;
    void setInputDataConfig(const OAIStartEntitiesDetectionV2JobRequest_InputDataConfig &input_data_config);
    bool is_input_data_config_Set() const;
    bool is_input_data_config_Valid() const;

    OAIStartEntitiesDetectionV2JobRequest_OutputDataConfig getOutputDataConfig() const;
    void setOutputDataConfig(const OAIStartEntitiesDetectionV2JobRequest_OutputDataConfig &output_data_config);
...
private:
    ...
    OAIStartEntitiesDetectionV2JobRequest_InputDataConfig m_input_data_config;
    bool m_input_data_config_isSet;
    bool m_input_data_config_isValid;

    OAIStartEntitiesDetectionV2JobRequest_OutputDataConfig m_output_data_config;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartEntitiesDetectionV2JobRequest)

#endif // OAIStartEntitiesDetectionV2JobRequest_H
