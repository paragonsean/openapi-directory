...
OAIDetectEntitiesResponse::OAIDetectEntitiesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectEntitiesResponse::OAIDetectEntitiesResponse() {
    this->initializeModel();
}

OAIDetectEntitiesResponse::~OAIDetectEntitiesResponse() {}

void OAIDetectEntitiesResponse::initializeModel() {
...
void OAIDetectEntitiesResponse::fromJson(QString jsonString) {
...
void OAIDetectEntitiesResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDetectEntitiesResponse::asJson() const {
...
QJsonObject OAIDetectEntitiesResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_entities.isSet()) {
...
QList OAIDetectEntitiesResponse::getEntities() const {
    return m_entities;
}
void OAIDetectEntitiesResponse::setEntities(const QList &entities) {
    m_entities = entities;
    m_entities_isSet = true;
}

bool OAIDetectEntitiesResponse::is_entities_Set() const{
    return m_entities_isSet;
}

bool OAIDetectEntitiesResponse::is_entities_Valid() const{
    return m_entities_isValid;
}

QList OAIDetectEntitiesResponse::getUnmappedAttributes() const {
    return m_unmapped_attributes;
}
void OAIDetectEntitiesResponse::setUnmappedAttributes(const QList &unmapped_attributes) {
    m_unmapped_attributes = unmapped_attributes;
    m_unmapped_attributes_isSet = true;
}

bool OAIDetectEntitiesResponse::is_unmapped_attributes_Set() const{
    return m_unmapped_attributes_isSet;
}

bool OAIDetectEntitiesResponse::is_unmapped_attributes_Valid() const{
    return m_unmapped_attributes_isValid;
}

QString OAIDetectEntitiesResponse::getPaginationToken() const {
    return m_pagination_token;
}
void OAIDetectEntitiesResponse::setPaginationToken(const QString &pagination_token) {
    m_pagination_token = pagination_token;
    m_pagination_token_isSet = true;
}

bool OAIDetectEntitiesResponse::is_pagination_token_Set() const{
    return m_pagination_token_isSet;
}

bool OAIDetectEntitiesResponse::is_pagination_token_Valid() const{
    return m_pagination_token_isValid;
}

QString OAIDetectEntitiesResponse::getModelVersion() const {
    return m_model_version;
}
void OAIDetectEntitiesResponse::setModelVersion(const QString &model_version) {
    m_model_version = model_version;
    m_model_version_isSet = true;
}

bool OAIDetectEntitiesResponse::is_model_version_Set() const{
    return m_model_version_isSet;
}

bool OAIDetectEntitiesResponse::is_model_version_Valid() const{
    return m_model_version_isValid;
}

bool OAIDetectEntitiesResponse::isSet() const {
...
bool OAIDetectEntitiesResponse::isValid() const {
