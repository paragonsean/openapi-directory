...
/*
 * OAIStartICD10CMInferenceJobRequest.h
 *
 * 
 */

#ifndef OAIStartICD10CMInferenceJobRequest_H
#define OAIStartICD10CMInferenceJobRequest_H
...
class OAIStartICD10CMInferenceJobRequest : public OAIObject {
public:
    OAIStartICD10CMInferenceJobRequest();
    OAIStartICD10CMInferenceJobRequest(QString json);
    ~OAIStartICD10CMInferenceJobRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartICD10CMInferenceJobRequest)

#endif // OAIStartICD10CMInferenceJobRequest_H
