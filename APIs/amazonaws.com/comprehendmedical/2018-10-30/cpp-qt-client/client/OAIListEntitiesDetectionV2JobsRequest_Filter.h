...
/*
 * OAIListEntitiesDetectionV2JobsRequest_Filter.h
 *
 * 
 */

#ifndef OAIListEntitiesDetectionV2JobsRequest_Filter_H
#define OAIListEntitiesDetectionV2JobsRequest_Filter_H
...
class OAIListEntitiesDetectionV2JobsRequest_Filter : public OAIObject {
public:
    OAIListEntitiesDetectionV2JobsRequest_Filter();
    OAIListEntitiesDetectionV2JobsRequest_Filter(QString json);
    ~OAIListEntitiesDetectionV2JobsRequest_Filter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListEntitiesDetectionV2JobsRequest_Filter)

#endif // OAIListEntitiesDetectionV2JobsRequest_Filter_H
