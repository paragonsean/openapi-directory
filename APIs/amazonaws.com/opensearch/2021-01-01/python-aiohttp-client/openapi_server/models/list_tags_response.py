...
class ListTagsResponse(Model):
    ...
    def __init__(self, tag_list: List=None):
        ...
        :param tag_list: The tag_list of this ListTagsResponse.
        """
        self.openapi_types = {
            'tag_list': List
        }
    ...
    @property
    def tag_list(self):
        """Gets the tag_list of this ListTagsResponse.


        :return: The tag_list of this ListTagsResponse.
        :rtype: List
        """
    ...
    def tag_list(self, tag_list):
        """Sets the tag_list of this ListTagsResponse.
