...
/**
 * The DeleteDomainResponseDomainStatus model module.
 * @module model/DeleteDomainResponseDomainStatus
 * @version 2021-01-01
 */
class DeleteDomainResponseDomainStatus {
    /**
     * Constructs a new <code>DeleteDomainResponseDomainStatus</code>.
     * @alias module:model/DeleteDomainResponseDomainStatus
    ...
    constructor(domainId, domainName, ARN, clusterConfig) { 
        ...
        DeleteDomainResponseDomainStatus.initialize(this, domainId, domainName, ARN, clusterConfig);
    }
    ...
    /**
     * Constructs a <code>DeleteDomainResponseDomainStatus</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteDomainResponseDomainStatus} obj Optional instance to populate.
     * @return {module:model/DeleteDomainResponseDomainStatus} The populated <code>DeleteDomainResponseDomainStatus</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteDomainResponseDomainStatus();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteDomainResponseDomainStatus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteDomainResponseDomainStatus</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteDomainResponseDomainStatus.RequiredProperties) {
...
DeleteDomainResponseDomainStatus.RequiredProperties = ["DomainId", "DomainName", "ARN", "ClusterConfig"];

/**
 * @member {String} DomainId
 */
DeleteDomainResponseDomainStatus.prototype['DomainId'] = undefined;

/**
 * @member {String} DomainName
 */
DeleteDomainResponseDomainStatus.prototype['DomainName'] = undefined;

/**
 * @member {String} ARN
 */
DeleteDomainResponseDomainStatus.prototype['ARN'] = undefined;

/**
 * @member {Boolean} Created
 */
DeleteDomainResponseDomainStatus.prototype['Created'] = undefined;

/**
 * @member {Boolean} Deleted
 */
DeleteDomainResponseDomainStatus.prototype['Deleted'] = undefined;

/**
 * @member {String} Endpoint
 */
DeleteDomainResponseDomainStatus.prototype['Endpoint'] = undefined;

/**
 * @member {Object} Endpoints
 */
DeleteDomainResponseDomainStatus.prototype['Endpoints'] = undefined;

/**
 * @member {Boolean} Processing
 */
DeleteDomainResponseDomainStatus.prototype['Processing'] = undefined;

/**
 * @member {Boolean} UpgradeProcessing
 */
DeleteDomainResponseDomainStatus.prototype['UpgradeProcessing'] = undefined;

/**
 * @member {String} EngineVersion
 */
DeleteDomainResponseDomainStatus.prototype['EngineVersion'] = undefined;

/**
 * @member {module:model/DomainStatusClusterConfig} ClusterConfig
 */
DeleteDomainResponseDomainStatus.prototype['ClusterConfig'] = undefined;

/**
 * @member {module:model/DomainStatusEBSOptions} EBSOptions
 */
DeleteDomainResponseDomainStatus.prototype['EBSOptions'] = undefined;

/**
 * @member {String} AccessPolicies
 */
DeleteDomainResponseDomainStatus.prototype['AccessPolicies'] = undefined;

/**
 * @member {module:model/DomainStatusSnapshotOptions} SnapshotOptions
 */
DeleteDomainResponseDomainStatus.prototype['SnapshotOptions'] = undefined;

/**
 * @member {module:model/DomainStatusVPCOptions} VPCOptions
 */
DeleteDomainResponseDomainStatus.prototype['VPCOptions'] = undefined;

/**
 * @member {module:model/DomainStatusCognitoOptions} CognitoOptions
 */
DeleteDomainResponseDomainStatus.prototype['CognitoOptions'] = undefined;

/**
 * @member {module:model/DomainStatusEncryptionAtRestOptions} EncryptionAtRestOptions
 */
DeleteDomainResponseDomainStatus.prototype['EncryptionAtRestOptions'] = undefined;

/**
 * @member {module:model/DomainStatusNodeToNodeEncryptionOptions} NodeToNodeEncryptionOptions
 */
DeleteDomainResponseDomainStatus.prototype['NodeToNodeEncryptionOptions'] = undefined;

/**
 * @member {Object} AdvancedOptions
 */
DeleteDomainResponseDomainStatus.prototype['AdvancedOptions'] = undefined;

/**
 * @member {Object} LogPublishingOptions
 */
DeleteDomainResponseDomainStatus.prototype['LogPublishingOptions'] = undefined;

/**
 * @member {module:model/DomainStatusServiceSoftwareOptions} ServiceSoftwareOptions
 */
DeleteDomainResponseDomainStatus.prototype['ServiceSoftwareOptions'] = undefined;

/**
 * @member {module:model/CreateDomainRequestDomainEndpointOptions} DomainEndpointOptions
 */
DeleteDomainResponseDomainStatus.prototype['DomainEndpointOptions'] = undefined;

/**
 * @member {module:model/DomainStatusAdvancedSecurityOptions} AdvancedSecurityOptions
 */
DeleteDomainResponseDomainStatus.prototype['AdvancedSecurityOptions'] = undefined;

/**
 * @member {module:model/DomainStatusAutoTuneOptions} AutoTuneOptions
 */
DeleteDomainResponseDomainStatus.prototype['AutoTuneOptions'] = undefined;

/**
 * @member {module:model/DomainStatusChangeProgressDetails} ChangeProgressDetails
 */
DeleteDomainResponseDomainStatus.prototype['ChangeProgressDetails'] = undefined;

/**
 * @member {module:model/DomainStatusOffPeakWindowOptions} OffPeakWindowOptions
 */
DeleteDomainResponseDomainStatus.prototype['OffPeakWindowOptions'] = undefined;

/**
 * @member {module:model/DomainStatusSoftwareUpdateOptions} SoftwareUpdateOptions
 */
DeleteDomainResponseDomainStatus.prototype['SoftwareUpdateOptions'] = undefined;
...
export default DeleteDomainResponseDomainStatus;
