...
/**
 * The CreateDomainResponseDomainStatus model module.
 * @module model/CreateDomainResponseDomainStatus
 * @version 2021-01-01
 */
class CreateDomainResponseDomainStatus {
    /**
     * Constructs a new <code>CreateDomainResponseDomainStatus</code>.
     * @alias module:model/CreateDomainResponseDomainStatus
    ...
    constructor(domainId, domainName, ARN, clusterConfig) { 
        ...
        CreateDomainResponseDomainStatus.initialize(this, domainId, domainName, ARN, clusterConfig);
    }
    ...
    /**
     * Constructs a <code>CreateDomainResponseDomainStatus</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateDomainResponseDomainStatus} obj Optional instance to populate.
     * @return {module:model/CreateDomainResponseDomainStatus} The populated <code>CreateDomainResponseDomainStatus</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateDomainResponseDomainStatus();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateDomainResponseDomainStatus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateDomainResponseDomainStatus</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateDomainResponseDomainStatus.RequiredProperties) {
...
CreateDomainResponseDomainStatus.RequiredProperties = ["DomainId", "DomainName", "ARN", "ClusterConfig"];

/**
 * @member {String} DomainId
 */
CreateDomainResponseDomainStatus.prototype['DomainId'] = undefined;

/**
 * @member {String} DomainName
 */
CreateDomainResponseDomainStatus.prototype['DomainName'] = undefined;

/**
 * @member {String} ARN
 */
CreateDomainResponseDomainStatus.prototype['ARN'] = undefined;

/**
 * @member {Boolean} Created
 */
CreateDomainResponseDomainStatus.prototype['Created'] = undefined;

/**
 * @member {Boolean} Deleted
 */
CreateDomainResponseDomainStatus.prototype['Deleted'] = undefined;

/**
 * @member {String} Endpoint
 */
CreateDomainResponseDomainStatus.prototype['Endpoint'] = undefined;

/**
 * @member {Object} Endpoints
 */
CreateDomainResponseDomainStatus.prototype['Endpoints'] = undefined;

/**
 * @member {Boolean} Processing
 */
CreateDomainResponseDomainStatus.prototype['Processing'] = undefined;

/**
 * @member {Boolean} UpgradeProcessing
 */
CreateDomainResponseDomainStatus.prototype['UpgradeProcessing'] = undefined;

/**
 * @member {String} EngineVersion
 */
CreateDomainResponseDomainStatus.prototype['EngineVersion'] = undefined;

/**
 * @member {module:model/DomainStatusClusterConfig} ClusterConfig
 */
CreateDomainResponseDomainStatus.prototype['ClusterConfig'] = undefined;

/**
 * @member {module:model/DomainStatusEBSOptions} EBSOptions
 */
CreateDomainResponseDomainStatus.prototype['EBSOptions'] = undefined;

/**
 * @member {String} AccessPolicies
 */
CreateDomainResponseDomainStatus.prototype['AccessPolicies'] = undefined;

/**
 * @member {module:model/DomainStatusSnapshotOptions} SnapshotOptions
 */
CreateDomainResponseDomainStatus.prototype['SnapshotOptions'] = undefined;

/**
 * @member {module:model/DomainStatusVPCOptions} VPCOptions
 */
CreateDomainResponseDomainStatus.prototype['VPCOptions'] = undefined;

/**
 * @member {module:model/DomainStatusCognitoOptions} CognitoOptions
 */
CreateDomainResponseDomainStatus.prototype['CognitoOptions'] = undefined;

/**
 * @member {module:model/DomainStatusEncryptionAtRestOptions} EncryptionAtRestOptions
 */
CreateDomainResponseDomainStatus.prototype['EncryptionAtRestOptions'] = undefined;

/**
 * @member {module:model/DomainStatusNodeToNodeEncryptionOptions} NodeToNodeEncryptionOptions
 */
CreateDomainResponseDomainStatus.prototype['NodeToNodeEncryptionOptions'] = undefined;

/**
 * @member {Object} AdvancedOptions
 */
CreateDomainResponseDomainStatus.prototype['AdvancedOptions'] = undefined;

/**
 * @member {Object} LogPublishingOptions
 */
CreateDomainResponseDomainStatus.prototype['LogPublishingOptions'] = undefined;

/**
 * @member {module:model/DomainStatusServiceSoftwareOptions} ServiceSoftwareOptions
 */
CreateDomainResponseDomainStatus.prototype['ServiceSoftwareOptions'] = undefined;

/**
 * @member {module:model/CreateDomainRequestDomainEndpointOptions} DomainEndpointOptions
 */
CreateDomainResponseDomainStatus.prototype['DomainEndpointOptions'] = undefined;

/**
 * @member {module:model/DomainStatusAdvancedSecurityOptions} AdvancedSecurityOptions
 */
CreateDomainResponseDomainStatus.prototype['AdvancedSecurityOptions'] = undefined;

/**
 * @member {module:model/DomainStatusAutoTuneOptions} AutoTuneOptions
 */
CreateDomainResponseDomainStatus.prototype['AutoTuneOptions'] = undefined;

/**
 * @member {module:model/DomainStatusChangeProgressDetails} ChangeProgressDetails
 */
CreateDomainResponseDomainStatus.prototype['ChangeProgressDetails'] = undefined;

/**
 * @member {module:model/DomainStatusOffPeakWindowOptions} OffPeakWindowOptions
 */
CreateDomainResponseDomainStatus.prototype['OffPeakWindowOptions'] = undefined;

/**
 * @member {module:model/DomainStatusSoftwareUpdateOptions} SoftwareUpdateOptions
 */
CreateDomainResponseDomainStatus.prototype['SoftwareUpdateOptions'] = undefined;
...
export default CreateDomainResponseDomainStatus;
