...
/**
 * The UpdateDomainConfigRequestClusterConfig model module.
 * @module model/UpdateDomainConfigRequestClusterConfig
 * @version 2021-01-01
 */
class UpdateDomainConfigRequestClusterConfig {
    /**
     * Constructs a new <code>UpdateDomainConfigRequestClusterConfig</code>.
     * @alias module:model/UpdateDomainConfigRequestClusterConfig
     * @implements module:model/ClusterConfig
     */
    constructor() { 
        ClusterConfig.initialize(this);
        UpdateDomainConfigRequestClusterConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateDomainConfigRequestClusterConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateDomainConfigRequestClusterConfig} obj Optional instance to populate.
     * @return {module:model/UpdateDomainConfigRequestClusterConfig} The populated <code>UpdateDomainConfigRequestClusterConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateDomainConfigRequestClusterConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateDomainConfigRequestClusterConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateDomainConfigRequestClusterConfig</code>.
     */
 ...
 */
UpdateDomainConfigRequestClusterConfig.prototype['InstanceType'] = undefined;

/**
 * @member {Number} InstanceCount
 */
UpdateDomainConfigRequestClusterConfig.prototype['InstanceCount'] = undefined;

/**
 * @member {Boolean} DedicatedMasterEnabled
 */
UpdateDomainConfigRequestClusterConfig.prototype['DedicatedMasterEnabled'] = undefined;

/**
 * @member {Boolean} ZoneAwarenessEnabled
 */
UpdateDomainConfigRequestClusterConfig.prototype['ZoneAwarenessEnabled'] = undefined;

/**
 * @member {module:model/CreateDomainRequestClusterConfigZoneAwarenessConfig} ZoneAwarenessConfig
 */
UpdateDomainConfigRequestClusterConfig.prototype['ZoneAwarenessConfig'] = undefined;

/**
 * @member {module:model/OpenSearchPartitionInstanceType} DedicatedMasterType
 */
UpdateDomainConfigRequestClusterConfig.prototype['DedicatedMasterType'] = undefined;

/**
 * @member {Number} DedicatedMasterCount
 */
UpdateDomainConfigRequestClusterConfig.prototype['DedicatedMasterCount'] = undefined;

/**
 * @member {Boolean} WarmEnabled
 */
UpdateDomainConfigRequestClusterConfig.prototype['WarmEnabled'] = undefined;

/**
 * @member {module:model/OpenSearchWarmPartitionInstanceType} WarmType
 */
UpdateDomainConfigRequestClusterConfig.prototype['WarmType'] = undefined;

/**
 * @member {Number} WarmCount
 */
UpdateDomainConfigRequestClusterConfig.prototype['WarmCount'] = undefined;

/**
 * @member {module:model/CreateDomainRequestClusterConfigColdStorageOptions} ColdStorageOptions
 */
UpdateDomainConfigRequestClusterConfig.prototype['ColdStorageOptions'] = undefined;

/**
 * @member {Boolean} MultiAZWithStandbyEnabled
 */
UpdateDomainConfigRequestClusterConfig.prototype['MultiAZWithStandbyEnabled'] = undefined;
...
export default UpdateDomainConfigRequestClusterConfig;
