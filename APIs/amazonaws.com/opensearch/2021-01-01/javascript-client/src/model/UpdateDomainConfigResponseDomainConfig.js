...
/**
 * The UpdateDomainConfigResponseDomainConfig model module.
 * @module model/UpdateDomainConfigResponseDomainConfig
 * @version 2021-01-01
 */
class UpdateDomainConfigResponseDomainConfig {
    /**
     * Constructs a new <code>UpdateDomainConfigResponseDomainConfig</code>.
     * @alias module:model/UpdateDomainConfigResponseDomainConfig
     * @implements module:model/DomainConfig
     */
    constructor() { 
        DomainConfig.initialize(this);
        UpdateDomainConfigResponseDomainConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateDomainConfigResponseDomainConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateDomainConfigResponseDomainConfig} obj Optional instance to populate.
     * @return {module:model/UpdateDomainConfigResponseDomainConfig} The populated <code>UpdateDomainConfigResponseDomainConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateDomainConfigResponseDomainConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateDomainConfigResponseDomainConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateDomainConfigResponseDomainConfig</code>.
     */
 ...
 */
UpdateDomainConfigResponseDomainConfig.prototype['EngineVersion'] = undefined;

/**
 * @member {module:model/DomainConfigClusterConfig} ClusterConfig
 */
UpdateDomainConfigResponseDomainConfig.prototype['ClusterConfig'] = undefined;

/**
 * @member {module:model/DomainConfigEBSOptions} EBSOptions
 */
UpdateDomainConfigResponseDomainConfig.prototype['EBSOptions'] = undefined;

/**
 * @member {module:model/DomainConfigAccessPolicies} AccessPolicies
 */
UpdateDomainConfigResponseDomainConfig.prototype['AccessPolicies'] = undefined;

/**
 * @member {module:model/DomainConfigSnapshotOptions} SnapshotOptions
 */
UpdateDomainConfigResponseDomainConfig.prototype['SnapshotOptions'] = undefined;

/**
 * @member {module:model/DomainConfigVPCOptions} VPCOptions
 */
UpdateDomainConfigResponseDomainConfig.prototype['VPCOptions'] = undefined;

/**
 * @member {module:model/DomainConfigCognitoOptions} CognitoOptions
 */
UpdateDomainConfigResponseDomainConfig.prototype['CognitoOptions'] = undefined;

/**
 * @member {module:model/DomainConfigEncryptionAtRestOptions} EncryptionAtRestOptions
 */
UpdateDomainConfigResponseDomainConfig.prototype['EncryptionAtRestOptions'] = undefined;

/**
 * @member {module:model/DomainConfigNodeToNodeEncryptionOptions} NodeToNodeEncryptionOptions
 */
UpdateDomainConfigResponseDomainConfig.prototype['NodeToNodeEncryptionOptions'] = undefined;

/**
 * @member {module:model/DomainConfigAdvancedOptions} AdvancedOptions
 */
UpdateDomainConfigResponseDomainConfig.prototype['AdvancedOptions'] = undefined;

/**
 * @member {module:model/DomainConfigLogPublishingOptions} LogPublishingOptions
 */
UpdateDomainConfigResponseDomainConfig.prototype['LogPublishingOptions'] = undefined;

/**
 * @member {module:model/DomainConfigDomainEndpointOptions} DomainEndpointOptions
 */
UpdateDomainConfigResponseDomainConfig.prototype['DomainEndpointOptions'] = undefined;

/**
 * @member {module:model/DomainConfigAdvancedSecurityOptions} AdvancedSecurityOptions
 */
UpdateDomainConfigResponseDomainConfig.prototype['AdvancedSecurityOptions'] = undefined;

/**
 * @member {module:model/DomainConfigAutoTuneOptions} AutoTuneOptions
 */
UpdateDomainConfigResponseDomainConfig.prototype['AutoTuneOptions'] = undefined;

/**
 * @member {module:model/DomainConfigChangeProgressDetails} ChangeProgressDetails
 */
UpdateDomainConfigResponseDomainConfig.prototype['ChangeProgressDetails'] = undefined;

/**
 * @member {module:model/DomainConfigOffPeakWindowOptions} OffPeakWindowOptions
 */
UpdateDomainConfigResponseDomainConfig.prototype['OffPeakWindowOptions'] = undefined;

/**
 * @member {module:model/DomainConfigSoftwareUpdateOptions} SoftwareUpdateOptions
 */
UpdateDomainConfigResponseDomainConfig.prototype['SoftwareUpdateOptions'] = undefined;
...
export default UpdateDomainConfigResponseDomainConfig;
