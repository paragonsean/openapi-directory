...
/**
 * The DissociatePackageResponseDomainPackageDetails model module.
 * @module model/DissociatePackageResponseDomainPackageDetails
 * @version 2021-01-01
 */
class DissociatePackageResponseDomainPackageDetails {
    /**
     * Constructs a new <code>DissociatePackageResponseDomainPackageDetails</code>.
     * @alias module:model/DissociatePackageResponseDomainPackageDetails
     * @implements module:model/DomainPackageDetails
     */
    constructor() { 
        DomainPackageDetails.initialize(this);
        DissociatePackageResponseDomainPackageDetails.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DissociatePackageResponseDomainPackageDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DissociatePackageResponseDomainPackageDetails} obj Optional instance to populate.
     * @return {module:model/DissociatePackageResponseDomainPackageDetails} The populated <code>DissociatePackageResponseDomainPackageDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DissociatePackageResponseDomainPackageDetails();
    ...
    /**
     * Validates the JSON data with respect to <code>DissociatePackageResponseDomainPackageDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DissociatePackageResponseDomainPackageDetails</code>.
     */
 ...
 */
DissociatePackageResponseDomainPackageDetails.prototype['PackageID'] = undefined;

/**
 * @member {String} PackageName
 */
DissociatePackageResponseDomainPackageDetails.prototype['PackageName'] = undefined;

/**
 * @member {module:model/PackageType} PackageType
 */
DissociatePackageResponseDomainPackageDetails.prototype['PackageType'] = undefined;

/**
 * @member {Date} LastUpdated
 */
DissociatePackageResponseDomainPackageDetails.prototype['LastUpdated'] = undefined;

/**
 * @member {String} DomainName
 */
DissociatePackageResponseDomainPackageDetails.prototype['DomainName'] = undefined;

/**
 * @member {module:model/DomainPackageStatus} DomainPackageStatus
 */
DissociatePackageResponseDomainPackageDetails.prototype['DomainPackageStatus'] = undefined;

/**
 * @member {String} PackageVersion
 */
DissociatePackageResponseDomainPackageDetails.prototype['PackageVersion'] = undefined;

/**
 * @member {String} ReferencePath
 */
DissociatePackageResponseDomainPackageDetails.prototype['ReferencePath'] = undefined;

/**
 * @member {module:model/DomainPackageDetailsErrorDetails} ErrorDetails
 */
DissociatePackageResponseDomainPackageDetails.prototype['ErrorDetails'] = undefined;
...
export default DissociatePackageResponseDomainPackageDetails;
