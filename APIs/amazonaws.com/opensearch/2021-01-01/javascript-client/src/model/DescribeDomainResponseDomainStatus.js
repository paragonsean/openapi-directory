...
/**
 * The DescribeDomainResponseDomainStatus model module.
 * @module model/DescribeDomainResponseDomainStatus
 * @version 2021-01-01
 */
class DescribeDomainResponseDomainStatus {
    /**
     * Constructs a new <code>DescribeDomainResponseDomainStatus</code>.
     * @alias module:model/DescribeDomainResponseDomainStatus
    ...
    constructor(domainId, domainName, ARN, clusterConfig) { 
        ...
        DescribeDomainResponseDomainStatus.initialize(this, domainId, domainName, ARN, clusterConfig);
    }
    ...
    /**
     * Constructs a <code>DescribeDomainResponseDomainStatus</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeDomainResponseDomainStatus} obj Optional instance to populate.
     * @return {module:model/DescribeDomainResponseDomainStatus} The populated <code>DescribeDomainResponseDomainStatus</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeDomainResponseDomainStatus();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeDomainResponseDomainStatus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeDomainResponseDomainStatus</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeDomainResponseDomainStatus.RequiredProperties) {
...
DescribeDomainResponseDomainStatus.RequiredProperties = ["DomainId", "DomainName", "ARN", "ClusterConfig"];

/**
 * @member {String} DomainId
 */
DescribeDomainResponseDomainStatus.prototype['DomainId'] = undefined;

/**
 * @member {String} DomainName
 */
DescribeDomainResponseDomainStatus.prototype['DomainName'] = undefined;

/**
 * @member {String} ARN
 */
DescribeDomainResponseDomainStatus.prototype['ARN'] = undefined;

/**
 * @member {Boolean} Created
 */
DescribeDomainResponseDomainStatus.prototype['Created'] = undefined;

/**
 * @member {Boolean} Deleted
 */
DescribeDomainResponseDomainStatus.prototype['Deleted'] = undefined;

/**
 * @member {String} Endpoint
 */
DescribeDomainResponseDomainStatus.prototype['Endpoint'] = undefined;

/**
 * @member {Object} Endpoints
 */
DescribeDomainResponseDomainStatus.prototype['Endpoints'] = undefined;

/**
 * @member {Boolean} Processing
 */
DescribeDomainResponseDomainStatus.prototype['Processing'] = undefined;

/**
 * @member {Boolean} UpgradeProcessing
 */
DescribeDomainResponseDomainStatus.prototype['UpgradeProcessing'] = undefined;

/**
 * @member {String} EngineVersion
 */
DescribeDomainResponseDomainStatus.prototype['EngineVersion'] = undefined;

/**
 * @member {module:model/DomainStatusClusterConfig} ClusterConfig
 */
DescribeDomainResponseDomainStatus.prototype['ClusterConfig'] = undefined;

/**
 * @member {module:model/DomainStatusEBSOptions} EBSOptions
 */
DescribeDomainResponseDomainStatus.prototype['EBSOptions'] = undefined;

/**
 * @member {String} AccessPolicies
 */
DescribeDomainResponseDomainStatus.prototype['AccessPolicies'] = undefined;

/**
 * @member {module:model/DomainStatusSnapshotOptions} SnapshotOptions
 */
DescribeDomainResponseDomainStatus.prototype['SnapshotOptions'] = undefined;

/**
 * @member {module:model/DomainStatusVPCOptions} VPCOptions
 */
DescribeDomainResponseDomainStatus.prototype['VPCOptions'] = undefined;

/**
 * @member {module:model/DomainStatusCognitoOptions} CognitoOptions
 */
DescribeDomainResponseDomainStatus.prototype['CognitoOptions'] = undefined;

/**
 * @member {module:model/DomainStatusEncryptionAtRestOptions} EncryptionAtRestOptions
 */
DescribeDomainResponseDomainStatus.prototype['EncryptionAtRestOptions'] = undefined;

/**
 * @member {module:model/DomainStatusNodeToNodeEncryptionOptions} NodeToNodeEncryptionOptions
 */
DescribeDomainResponseDomainStatus.prototype['NodeToNodeEncryptionOptions'] = undefined;

/**
 * @member {Object} AdvancedOptions
 */
DescribeDomainResponseDomainStatus.prototype['AdvancedOptions'] = undefined;

/**
 * @member {Object} LogPublishingOptions
 */
DescribeDomainResponseDomainStatus.prototype['LogPublishingOptions'] = undefined;

/**
 * @member {module:model/DomainStatusServiceSoftwareOptions} ServiceSoftwareOptions
 */
DescribeDomainResponseDomainStatus.prototype['ServiceSoftwareOptions'] = undefined;

/**
 * @member {module:model/CreateDomainRequestDomainEndpointOptions} DomainEndpointOptions
 */
DescribeDomainResponseDomainStatus.prototype['DomainEndpointOptions'] = undefined;

/**
 * @member {module:model/DomainStatusAdvancedSecurityOptions} AdvancedSecurityOptions
 */
DescribeDomainResponseDomainStatus.prototype['AdvancedSecurityOptions'] = undefined;

/**
 * @member {module:model/DomainStatusAutoTuneOptions} AutoTuneOptions
 */
DescribeDomainResponseDomainStatus.prototype['AutoTuneOptions'] = undefined;

/**
 * @member {module:model/DomainStatusChangeProgressDetails} ChangeProgressDetails
 */
DescribeDomainResponseDomainStatus.prototype['ChangeProgressDetails'] = undefined;

/**
 * @member {module:model/DomainStatusOffPeakWindowOptions} OffPeakWindowOptions
 */
DescribeDomainResponseDomainStatus.prototype['OffPeakWindowOptions'] = undefined;

/**
 * @member {module:model/DomainStatusSoftwareUpdateOptions} SoftwareUpdateOptions
 */
DescribeDomainResponseDomainStatus.prototype['SoftwareUpdateOptions'] = undefined;
...
export default DescribeDomainResponseDomainStatus;
