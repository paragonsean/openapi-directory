...
/**
 * The DomainStatusClusterConfig model module.
 * @module model/DomainStatusClusterConfig
 * @version 2021-01-01
 */
class DomainStatusClusterConfig {
    /**
     * Constructs a new <code>DomainStatusClusterConfig</code>.
     * @alias module:model/DomainStatusClusterConfig
     * @implements module:model/ClusterConfig
     */
    constructor() { 
        ClusterConfig.initialize(this);
        DomainStatusClusterConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DomainStatusClusterConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DomainStatusClusterConfig} obj Optional instance to populate.
     * @return {module:model/DomainStatusClusterConfig} The populated <code>DomainStatusClusterConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DomainStatusClusterConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>DomainStatusClusterConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DomainStatusClusterConfig</code>.
     */
 ...
 */
DomainStatusClusterConfig.prototype['InstanceType'] = undefined;

/**
 * @member {Number} InstanceCount
 */
DomainStatusClusterConfig.prototype['InstanceCount'] = undefined;

/**
 * @member {Boolean} DedicatedMasterEnabled
 */
DomainStatusClusterConfig.prototype['DedicatedMasterEnabled'] = undefined;

/**
 * @member {Boolean} ZoneAwarenessEnabled
 */
DomainStatusClusterConfig.prototype['ZoneAwarenessEnabled'] = undefined;

/**
 * @member {module:model/CreateDomainRequestClusterConfigZoneAwarenessConfig} ZoneAwarenessConfig
 */
DomainStatusClusterConfig.prototype['ZoneAwarenessConfig'] = undefined;

/**
 * @member {module:model/OpenSearchPartitionInstanceType} DedicatedMasterType
 */
DomainStatusClusterConfig.prototype['DedicatedMasterType'] = undefined;

/**
 * @member {Number} DedicatedMasterCount
 */
DomainStatusClusterConfig.prototype['DedicatedMasterCount'] = undefined;

/**
 * @member {Boolean} WarmEnabled
 */
DomainStatusClusterConfig.prototype['WarmEnabled'] = undefined;

/**
 * @member {module:model/OpenSearchWarmPartitionInstanceType} WarmType
 */
DomainStatusClusterConfig.prototype['WarmType'] = undefined;

/**
 * @member {Number} WarmCount
 */
DomainStatusClusterConfig.prototype['WarmCount'] = undefined;

/**
 * @member {module:model/CreateDomainRequestClusterConfigColdStorageOptions} ColdStorageOptions
 */
DomainStatusClusterConfig.prototype['ColdStorageOptions'] = undefined;

/**
 * @member {Boolean} MultiAZWithStandbyEnabled
 */
DomainStatusClusterConfig.prototype['MultiAZWithStandbyEnabled'] = undefined;
...
export default DomainStatusClusterConfig;
