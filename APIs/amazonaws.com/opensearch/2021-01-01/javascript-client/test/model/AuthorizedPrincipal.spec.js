...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.AuthorizedPrincipal();
  });
  ...
  describe('AuthorizedPrincipal', function() {
    it('should create an instance of AuthorizedPrincipal', function() {
      ...
      //var instance = new AmazonOpenSearchService.AuthorizedPrincipal();
      //expect(instance).to.be.a(AmazonOpenSearchService.AuthorizedPrincipal);
    });
