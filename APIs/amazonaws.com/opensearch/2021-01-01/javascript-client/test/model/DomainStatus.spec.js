...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.DomainStatus();
  });
  ...
  describe('DomainStatus', function() {
    it('should create an instance of DomainStatus', function() {
      ...
      //var instance = new AmazonOpenSearchService.DomainStatus();
      //expect(instance).to.be.a(AmazonOpenSearchService.DomainStatus);
    });
