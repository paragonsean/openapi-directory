...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.DescribeOutboundConnectionsRequest();
  });
  ...
  describe('DescribeOutboundConnectionsRequest', function() {
    it('should create an instance of DescribeOutboundConnectionsRequest', function() {
      // uncomment below and update the code to test DescribeOutboundConnectionsRequest
      //var instance = new AmazonOpenSearchService.DescribeOutboundConnectionsRequest();
      //expect(instance).to.be.a(AmazonOpenSearchService.DescribeOutboundConnectionsRequest);
    });
