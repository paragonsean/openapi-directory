...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.PackageDetails();
  });
  ...
  describe('PackageDetails', function() {
    it('should create an instance of PackageDetails', function() {
      ...
      //var instance = new AmazonOpenSearchService.PackageDetails();
      //expect(instance).to.be.a(AmazonOpenSearchService.PackageDetails);
    });
