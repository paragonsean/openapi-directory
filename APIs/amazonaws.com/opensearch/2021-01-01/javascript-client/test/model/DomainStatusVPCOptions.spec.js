...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.DomainStatusVPCOptions();
  });
  ...
  describe('DomainStatusVPCOptions', function() {
    it('should create an instance of DomainStatusVPCOptions', function() {
      // uncomment below and update the code to test DomainStatusVPCOptions
      //var instance = new AmazonOpenSearchService.DomainStatusVPCOptions();
      //expect(instance).to.be.a(AmazonOpenSearchService.DomainStatusVPCOptions);
    });
