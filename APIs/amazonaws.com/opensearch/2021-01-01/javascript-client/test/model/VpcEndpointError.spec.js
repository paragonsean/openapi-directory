...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.VpcEndpointError();
  });
  ...
  describe('VpcEndpointError', function() {
    it('should create an instance of VpcEndpointError', function() {
      // uncomment below and update the code to test VpcEndpointError
      //var instance = new AmazonOpenSearchService.VpcEndpointError();
      //expect(instance).to.be.a(AmazonOpenSearchService.VpcEndpointError);
    });
