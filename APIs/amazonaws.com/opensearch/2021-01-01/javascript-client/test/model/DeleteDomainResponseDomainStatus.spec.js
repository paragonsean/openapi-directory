...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.DeleteDomainResponseDomainStatus();
  });
  ...
  describe('DeleteDomainResponseDomainStatus', function() {
    it('should create an instance of DeleteDomainResponseDomainStatus', function() {
      // uncomment below and update the code to test DeleteDomainResponseDomainStatus
      //var instance = new AmazonOpenSearchService.DeleteDomainResponseDomainStatus();
      //expect(instance).to.be.a(AmazonOpenSearchService.DeleteDomainResponseDomainStatus);
    });
