...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.DescribeInboundConnectionsRequest();
  });
  ...
  describe('DescribeInboundConnectionsRequest', function() {
    it('should create an instance of DescribeInboundConnectionsRequest', function() {
      // uncomment below and update the code to test DescribeInboundConnectionsRequest
      //var instance = new AmazonOpenSearchService.DescribeInboundConnectionsRequest();
      //expect(instance).to.be.a(AmazonOpenSearchService.DescribeInboundConnectionsRequest);
    });
