...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.VpcEndpoint();
  });
  ...
  describe('VpcEndpoint', function() {
    it('should create an instance of VpcEndpoint', function() {
      ...
      //var instance = new AmazonOpenSearchService.VpcEndpoint();
      //expect(instance).to.be.a(AmazonOpenSearchService.VpcEndpoint);
    });
