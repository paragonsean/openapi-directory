...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.EBSOptions();
  });
  ...
  describe('EBSOptions', function() {
    it('should create an instance of EBSOptions', function() {
      ...
      //var instance = new AmazonOpenSearchService.EBSOptions();
      //expect(instance).to.be.a(AmazonOpenSearchService.EBSOptions);
    });
