...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.DescribePackagesRequest();
  });
  ...
  describe('DescribePackagesRequest', function() {
    it('should create an instance of DescribePackagesRequest', function() {
      // uncomment below and update the code to test DescribePackagesRequest
      //var instance = new AmazonOpenSearchService.DescribePackagesRequest();
      //expect(instance).to.be.a(AmazonOpenSearchService.DescribePackagesRequest);
    });
