...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.CreatePackageResponsePackageDetails();
  });
  ...
  describe('CreatePackageResponsePackageDetails', function() {
    it('should create an instance of CreatePackageResponsePackageDetails', function() {
      // uncomment below and update the code to test CreatePackageResponsePackageDetails
      //var instance = new AmazonOpenSearchService.CreatePackageResponsePackageDetails();
      //expect(instance).to.be.a(AmazonOpenSearchService.CreatePackageResponsePackageDetails);
    });
