...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.AddTagsRequest();
  });
  ...
  describe('AddTagsRequest', function() {
    it('should create an instance of AddTagsRequest', function() {
      // uncomment below and update the code to test AddTagsRequest
      //var instance = new AmazonOpenSearchService.AddTagsRequest();
      //expect(instance).to.be.a(AmazonOpenSearchService.AddTagsRequest);
    });
