...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.DomainStatusEBSOptions();
  });
  ...
  describe('DomainStatusEBSOptions', function() {
    it('should create an instance of DomainStatusEBSOptions', function() {
      // uncomment below and update the code to test DomainStatusEBSOptions
      //var instance = new AmazonOpenSearchService.DomainStatusEBSOptions();
      //expect(instance).to.be.a(AmazonOpenSearchService.DomainStatusEBSOptions);
    });
