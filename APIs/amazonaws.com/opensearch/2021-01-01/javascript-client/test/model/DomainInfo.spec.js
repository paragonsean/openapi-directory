...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.DomainInfo();
  });
  ...
  describe('DomainInfo', function() {
    it('should create an instance of DomainInfo', function() {
      ...
      //var instance = new AmazonOpenSearchService.DomainInfo();
      //expect(instance).to.be.a(AmazonOpenSearchService.DomainInfo);
    });
