...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.WindowStartTime();
  });
  ...
  describe('WindowStartTime', function() {
    it('should create an instance of WindowStartTime', function() {
      // uncomment below and update the code to test WindowStartTime
      //var instance = new AmazonOpenSearchService.WindowStartTime();
      //expect(instance).to.be.a(AmazonOpenSearchService.WindowStartTime);
    });
