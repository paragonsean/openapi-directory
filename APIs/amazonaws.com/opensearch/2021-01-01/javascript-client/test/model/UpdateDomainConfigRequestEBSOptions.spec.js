...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.UpdateDomainConfigRequestEBSOptions();
  });
  ...
  describe('UpdateDomainConfigRequestEBSOptions', function() {
    it('should create an instance of UpdateDomainConfigRequestEBSOptions', function() {
      // uncomment below and update the code to test UpdateDomainConfigRequestEBSOptions
      //var instance = new AmazonOpenSearchService.UpdateDomainConfigRequestEBSOptions();
      //expect(instance).to.be.a(AmazonOpenSearchService.UpdateDomainConfigRequestEBSOptions);
    });
