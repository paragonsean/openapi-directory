...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.CreateDomainRequest();
  });
  ...
  describe('CreateDomainRequest', function() {
    it('should create an instance of CreateDomainRequest', function() {
      ...
      //var instance = new AmazonOpenSearchService.CreateDomainRequest();
      //expect(instance).to.be.a(AmazonOpenSearchService.CreateDomainRequest);
    });
