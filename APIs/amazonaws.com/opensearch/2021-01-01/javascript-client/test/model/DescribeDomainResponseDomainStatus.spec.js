...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.DescribeDomainResponseDomainStatus();
  });
  ...
  describe('DescribeDomainResponseDomainStatus', function() {
    it('should create an instance of DescribeDomainResponseDomainStatus', function() {
      // uncomment below and update the code to test DescribeDomainResponseDomainStatus
      //var instance = new AmazonOpenSearchService.DescribeDomainResponseDomainStatus();
      //expect(instance).to.be.a(AmazonOpenSearchService.DescribeDomainResponseDomainStatus);
    });
