...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.UpgradeDomainResponse();
  });
  ...
  describe('UpgradeDomainResponse', function() {
    it('should create an instance of UpgradeDomainResponse', function() {
      // uncomment below and update the code to test UpgradeDomainResponse
      //var instance = new AmazonOpenSearchService.UpgradeDomainResponse();
      //expect(instance).to.be.a(AmazonOpenSearchService.UpgradeDomainResponse);
    });
