...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.DomainConfig();
  });
  ...
  describe('DomainConfig', function() {
    it('should create an instance of DomainConfig', function() {
      ...
      //var instance = new AmazonOpenSearchService.DomainConfig();
      //expect(instance).to.be.a(AmazonOpenSearchService.DomainConfig);
    });
