...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.DomainNodesStatus();
  });
  ...
  describe('DomainNodesStatus', function() {
    it('should create an instance of DomainNodesStatus', function() {
      // uncomment below and update the code to test DomainNodesStatus
      //var instance = new AmazonOpenSearchService.DomainNodesStatus();
      //expect(instance).to.be.a(AmazonOpenSearchService.DomainNodesStatus);
    });
    ...
    it('should have the property storageVolumeType (base name: "StorageVolumeType")', function() {
      // uncomment below and update the code to test the property storageVolumeType
      //var instance = new AmazonOpenSearchService.DomainNodesStatus();
      //expect(instance).to.be();
    });
