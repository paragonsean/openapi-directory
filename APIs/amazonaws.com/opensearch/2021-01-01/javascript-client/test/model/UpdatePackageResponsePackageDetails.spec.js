...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.UpdatePackageResponsePackageDetails();
  });
  ...
  describe('UpdatePackageResponsePackageDetails', function() {
    it('should create an instance of UpdatePackageResponsePackageDetails', function() {
      // uncomment below and update the code to test UpdatePackageResponsePackageDetails
      //var instance = new AmazonOpenSearchService.UpdatePackageResponsePackageDetails();
      //expect(instance).to.be.a(AmazonOpenSearchService.UpdatePackageResponsePackageDetails);
    });
