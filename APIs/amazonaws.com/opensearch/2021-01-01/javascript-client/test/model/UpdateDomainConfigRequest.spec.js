...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.UpdateDomainConfigRequest();
  });
  ...
  describe('UpdateDomainConfigRequest', function() {
    it('should create an instance of UpdateDomainConfigRequest', function() {
      // uncomment below and update the code to test UpdateDomainConfigRequest
      //var instance = new AmazonOpenSearchService.UpdateDomainConfigRequest();
      //expect(instance).to.be.a(AmazonOpenSearchService.UpdateDomainConfigRequest);
    });
    ...
    it('should have the property dryRunMode (base name: "DryRunMode")', function() {
      // uncomment below and update the code to test the property dryRunMode
      //var instance = new AmazonOpenSearchService.UpdateDomainConfigRequest();
      //expect(instance).to.be();
    });
