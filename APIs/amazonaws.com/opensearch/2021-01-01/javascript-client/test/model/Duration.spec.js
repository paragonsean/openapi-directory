...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.Duration();
  });
  ...
  describe('Duration', function() {
    it('should create an instance of Duration', function() {
      ...
      //var instance = new AmazonOpenSearchService.Duration();
      //expect(instance).to.be.a(AmazonOpenSearchService.Duration);
    });
