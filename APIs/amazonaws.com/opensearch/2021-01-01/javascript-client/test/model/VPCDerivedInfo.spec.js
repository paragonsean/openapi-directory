...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.VPCDerivedInfo();
  });
  ...
  describe('VPCDerivedInfo', function() {
    it('should create an instance of VPCDerivedInfo', function() {
      // uncomment below and update the code to test VPCDerivedInfo
      //var instance = new AmazonOpenSearchService.VPCDerivedInfo();
      //expect(instance).to.be.a(AmazonOpenSearchService.VPCDerivedInfo);
    });
