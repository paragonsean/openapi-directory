...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.VPCDerivedInfoStatusOptions();
  });
  ...
  describe('VPCDerivedInfoStatusOptions', function() {
    it('should create an instance of VPCDerivedInfoStatusOptions', function() {
      // uncomment below and update the code to test VPCDerivedInfoStatusOptions
      //var instance = new AmazonOpenSearchService.VPCDerivedInfoStatusOptions();
      //expect(instance).to.be.a(AmazonOpenSearchService.VPCDerivedInfoStatusOptions);
    });
