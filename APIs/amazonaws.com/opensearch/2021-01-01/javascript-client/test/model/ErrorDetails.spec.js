...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.ErrorDetails();
  });
  ...
  describe('ErrorDetails', function() {
    it('should create an instance of ErrorDetails', function() {
      ...
      //var instance = new AmazonOpenSearchService.ErrorDetails();
      //expect(instance).to.be.a(AmazonOpenSearchService.ErrorDetails);
    });
