...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.DeletePackageResponsePackageDetails();
  });
  ...
  describe('DeletePackageResponsePackageDetails', function() {
    it('should create an instance of DeletePackageResponsePackageDetails', function() {
      // uncomment below and update the code to test DeletePackageResponsePackageDetails
      //var instance = new AmazonOpenSearchService.DeletePackageResponsePackageDetails();
      //expect(instance).to.be.a(AmazonOpenSearchService.DeletePackageResponsePackageDetails);
    });
