...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.CreateDomainResponseDomainStatus();
  });
  ...
  describe('CreateDomainResponseDomainStatus', function() {
    it('should create an instance of CreateDomainResponseDomainStatus', function() {
      // uncomment below and update the code to test CreateDomainResponseDomainStatus
      //var instance = new AmazonOpenSearchService.CreateDomainResponseDomainStatus();
      //expect(instance).to.be.a(AmazonOpenSearchService.CreateDomainResponseDomainStatus);
    });
