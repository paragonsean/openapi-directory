...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.DescribeDryRunProgressResponseDryRunConfig();
  });
  ...
  describe('DescribeDryRunProgressResponseDryRunConfig', function() {
    it('should create an instance of DescribeDryRunProgressResponseDryRunConfig', function() {
      // uncomment below and update the code to test DescribeDryRunProgressResponseDryRunConfig
      //var instance = new AmazonOpenSearchService.DescribeDryRunProgressResponseDryRunConfig();
      //expect(instance).to.be.a(AmazonOpenSearchService.DescribeDryRunProgressResponseDryRunConfig);
    });
