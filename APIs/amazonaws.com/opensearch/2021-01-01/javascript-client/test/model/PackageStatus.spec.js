...
(function(root, factory) {
  ...
  describe('PackageStatus', function() {
    it('should create an instance of PackageStatus', function() {
      // uncomment below and update the code to test PackageStatus
      //var instance = new AmazonOpenSearchService.PackageStatus();
      //expect(instance).to.be.a(AmazonOpenSearchService.PackageStatus);
    });
