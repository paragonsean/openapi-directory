...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonOpenSearchService.DescribeDomainConfigResponseDomainConfig();
  });
  ...
  describe('DescribeDomainConfigResponseDomainConfig', function() {
    it('should create an instance of DescribeDomainConfigResponseDomainConfig', function() {
      // uncomment below and update the code to test DescribeDomainConfigResponseDomainConfig
      //var instance = new AmazonOpenSearchService.DescribeDomainConfigResponseDomainConfig();
      //expect(instance).to.be.a(AmazonOpenSearchService.DescribeDomainConfigResponseDomainConfig);
    });
