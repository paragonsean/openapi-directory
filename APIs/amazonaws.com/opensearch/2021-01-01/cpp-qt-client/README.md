...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::acceptInboundConnectionSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::acceptInboundConnectionSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString connection_id = create(); // QString | The ID of the inbound connection to accept.
      ...
      apiInstance.acceptInboundConnection(connection_idx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
