...
#ifndef OAIInboundConnection_H
#define OAIInboundConnection_H
...
class OAIInboundConnection : public OAIObject {
public:
    OAIInboundConnection();
    OAIInboundConnection(QString json);
    ~OAIInboundConnection() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInboundConnection)

#endif // OAIInboundConnection_H
