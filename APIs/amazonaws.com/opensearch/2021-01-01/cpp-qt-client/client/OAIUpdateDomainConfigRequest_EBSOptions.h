...
/*
 * OAIUpdateDomainConfigRequest_EBSOptions.h
 *
 * 
 */

#ifndef OAIUpdateDomainConfigRequest_EBSOptions_H
#define OAIUpdateDomainConfigRequest_EBSOptions_H
...
class OAIUpdateDomainConfigRequest_EBSOptions : public OAIObject {
public:
    OAIUpdateDomainConfigRequest_EBSOptions();
    OAIUpdateDomainConfigRequest_EBSOptions(QString json);
    ~OAIUpdateDomainConfigRequest_EBSOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDomainConfigRequest_EBSOptions)

#endif // OAIUpdateDomainConfigRequest_EBSOptions_H
