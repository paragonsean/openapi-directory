...
OAICreateDomainResponse_DomainStatus OAICreateDomainResponse::getDomainStatus() const {
    return m_domain_status;
}
void OAICreateDomainResponse::setDomainStatus(const OAICreateDomainResponse_DomainStatus &domain_status) {
