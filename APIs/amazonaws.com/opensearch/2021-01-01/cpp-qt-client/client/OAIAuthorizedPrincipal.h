...
#ifndef OAIAuthorizedPrincipal_H
#define OAIAuthorizedPrincipal_H
...
class OAIAuthorizedPrincipal : public OAIObject {
public:
    OAIAuthorizedPrincipal();
    OAIAuthorizedPrincipal(QString json);
    ~OAIAuthorizedPrincipal() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAuthorizedPrincipal)

#endif // OAIAuthorizedPrincipal_H
