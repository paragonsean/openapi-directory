...
OAICreateDomainRequest_DomainEndpointOptions::OAICreateDomainRequest_DomainEndpointOptions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateDomainRequest_DomainEndpointOptions::OAICreateDomainRequest_DomainEndpointOptions() {
    this->initializeModel();
}

OAICreateDomainRequest_DomainEndpointOptions::~OAICreateDomainRequest_DomainEndpointOptions() {}

void OAICreateDomainRequest_DomainEndpointOptions::initializeModel() {
...
void OAICreateDomainRequest_DomainEndpointOptions::fromJson(QString jsonString) {
...
void OAICreateDomainRequest_DomainEndpointOptions::fromJsonObject(QJsonObject json) {
...
QString OAICreateDomainRequest_DomainEndpointOptions::asJson() const {
...
QJsonObject OAICreateDomainRequest_DomainEndpointOptions::asJsonObject() const {
    QJsonObject obj;
...
bool OAICreateDomainRequest_DomainEndpointOptions::getEnforceHttps() const {
    return m_enforce_https;
}
void OAICreateDomainRequest_DomainEndpointOptions::setEnforceHttps(const bool &enforce_https) {
    m_enforce_https = enforce_https;
    m_enforce_https_isSet = true;
}

bool OAICreateDomainRequest_DomainEndpointOptions::is_enforce_https_Set() const{
    return m_enforce_https_isSet;
}

bool OAICreateDomainRequest_DomainEndpointOptions::is_enforce_https_Valid() const{
    return m_enforce_https_isValid;
}

OAITLSSecurityPolicy OAICreateDomainRequest_DomainEndpointOptions::getTlsSecurityPolicy() const {
    return m_tls_security_policy;
}
void OAICreateDomainRequest_DomainEndpointOptions::setTlsSecurityPolicy(const OAITLSSecurityPolicy &tls_security_policy) {
    m_tls_security_policy = tls_security_policy;
    m_tls_security_policy_isSet = true;
}

bool OAICreateDomainRequest_DomainEndpointOptions::is_tls_security_policy_Set() const{
    return m_tls_security_policy_isSet;
}

bool OAICreateDomainRequest_DomainEndpointOptions::is_tls_security_policy_Valid() const{
    return m_tls_security_policy_isValid;
}

bool OAICreateDomainRequest_DomainEndpointOptions::getCustomEndpointEnabled() const {
    return m_custom_endpoint_enabled;
}
void OAICreateDomainRequest_DomainEndpointOptions::setCustomEndpointEnabled(const bool &custom_endpoint_enabled) {
    m_custom_endpoint_enabled = custom_endpoint_enabled;
    m_custom_endpoint_enabled_isSet = true;
}

bool OAICreateDomainRequest_DomainEndpointOptions::is_custom_endpoint_enabled_Set() const{
    return m_custom_endpoint_enabled_isSet;
}

bool OAICreateDomainRequest_DomainEndpointOptions::is_custom_endpoint_enabled_Valid() const{
    return m_custom_endpoint_enabled_isValid;
}

QString OAICreateDomainRequest_DomainEndpointOptions::getCustomEndpoint() const {
    return m_custom_endpoint;
}
void OAICreateDomainRequest_DomainEndpointOptions::setCustomEndpoint(const QString &custom_endpoint) {
    m_custom_endpoint = custom_endpoint;
    m_custom_endpoint_isSet = true;
}

bool OAICreateDomainRequest_DomainEndpointOptions::is_custom_endpoint_Set() const{
    return m_custom_endpoint_isSet;
}

bool OAICreateDomainRequest_DomainEndpointOptions::is_custom_endpoint_Valid() const{
    return m_custom_endpoint_isValid;
}

QString OAICreateDomainRequest_DomainEndpointOptions::getCustomEndpointCertificateArn() const {
    return m_custom_endpoint_certificate_arn;
}
void OAICreateDomainRequest_DomainEndpointOptions::setCustomEndpointCertificateArn(const QString &custom_endpoint_certificate_arn) {
    m_custom_endpoint_certificate_arn = custom_endpoint_certificate_arn;
    m_custom_endpoint_certificate_arn_isSet = true;
}

bool OAICreateDomainRequest_DomainEndpointOptions::is_custom_endpoint_certificate_arn_Set() const{
    return m_custom_endpoint_certificate_arn_isSet;
}

bool OAICreateDomainRequest_DomainEndpointOptions::is_custom_endpoint_certificate_arn_Valid() const{
    return m_custom_endpoint_certificate_arn_isValid;
}

bool OAICreateDomainRequest_DomainEndpointOptions::isSet() const {
...
bool OAICreateDomainRequest_DomainEndpointOptions::isValid() const {
