...
/*
 * OAIVersionStatus_Status.h
 *
 * 
 */

#ifndef OAIVersionStatus_Status_H
#define OAIVersionStatus_Status_H
...
class OAIVersionStatus_Status : public OAIObject {
public:
    OAIVersionStatus_Status();
    OAIVersionStatus_Status(QString json);
    ~OAIVersionStatus_Status() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVersionStatus_Status)

#endif // OAIVersionStatus_Status_H
