...
/*
 * OAIDomainStatus_EBSOptions.h
 *
 * 
 */

#ifndef OAIDomainStatus_EBSOptions_H
#define OAIDomainStatus_EBSOptions_H
...
class OAIDomainStatus_EBSOptions : public OAIObject {
public:
    OAIDomainStatus_EBSOptions();
    OAIDomainStatus_EBSOptions(QString json);
    ~OAIDomainStatus_EBSOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDomainStatus_EBSOptions)

#endif // OAIDomainStatus_EBSOptions_H
