...
OAIOpenSearchPartitionInstanceType OAIClusterConfig::getInstanceType() const {
    return m_instance_type;
}
void OAIClusterConfig::setInstanceType(const OAIOpenSearchPartitionInstanceType &instance_type) {
    m_instance_type = instance_type;
    m_instance_type_isSet = true;
}

bool OAIClusterConfig::is_instance_type_Set() const{
    return m_instance_type_isSet;
}

bool OAIClusterConfig::is_instance_type_Valid() const{
    return m_instance_type_isValid;
}

qint32 OAIClusterConfig::getInstanceCount() const {
    return m_instance_count;
}
void OAIClusterConfig::setInstanceCount(const qint32 &instance_count) {
    m_instance_count = instance_count;
    m_instance_count_isSet = true;
}

bool OAIClusterConfig::is_instance_count_Set() const{
    return m_instance_count_isSet;
}

bool OAIClusterConfig::is_instance_count_Valid() const{
    return m_instance_count_isValid;
}

bool OAIClusterConfig::getDedicatedMasterEnabled() const {
    return m_dedicated_master_enabled;
}
void OAIClusterConfig::setDedicatedMasterEnabled(const bool &dedicated_master_enabled) {
    m_dedicated_master_enabled = dedicated_master_enabled;
    m_dedicated_master_enabled_isSet = true;
}

bool OAIClusterConfig::is_dedicated_master_enabled_Set() const{
    return m_dedicated_master_enabled_isSet;
}

bool OAIClusterConfig::is_dedicated_master_enabled_Valid() const{
    return m_dedicated_master_enabled_isValid;
}

bool OAIClusterConfig::getZoneAwarenessEnabled() const {
    return m_zone_awareness_enabled;
}
void OAIClusterConfig::setZoneAwarenessEnabled(const bool &zone_awareness_enabled) {
    m_zone_awareness_enabled = zone_awareness_enabled;
    m_zone_awareness_enabled_isSet = true;
}

bool OAIClusterConfig::is_zone_awareness_enabled_Set() const{
    return m_zone_awareness_enabled_isSet;
}

bool OAIClusterConfig::is_zone_awareness_enabled_Valid() const{
    return m_zone_awareness_enabled_isValid;
}

OAICreateDomain_request_ClusterConfig_ZoneAwarenessConfig OAIClusterConfig::getZoneAwarenessConfig() const {
    return m_zone_awareness_config;
}
void OAIClusterConfig::setZoneAwarenessConfig(const OAICreateDomain_request_ClusterConfig_ZoneAwarenessConfig &zone_awareness_config) {
    m_zone_awareness_config = zone_awareness_config;
    m_zone_awareness_config_isSet = true;
}

bool OAIClusterConfig::is_zone_awareness_config_Set() const{
    return m_zone_awareness_config_isSet;
}

bool OAIClusterConfig::is_zone_awareness_config_Valid() const{
    return m_zone_awareness_config_isValid;
}

OAIOpenSearchPartitionInstanceType OAIClusterConfig::getDedicatedMasterType() const {
    return m_dedicated_master_type;
}
void OAIClusterConfig::setDedicatedMasterType(const OAIOpenSearchPartitionInstanceType &dedicated_master_type) {
    m_dedicated_master_type = dedicated_master_type;
    m_dedicated_master_type_isSet = true;
}

bool OAIClusterConfig::is_dedicated_master_type_Set() const{
    return m_dedicated_master_type_isSet;
}

bool OAIClusterConfig::is_dedicated_master_type_Valid() const{
    return m_dedicated_master_type_isValid;
}

qint32 OAIClusterConfig::getDedicatedMasterCount() const {
    return m_dedicated_master_count;
}
void OAIClusterConfig::setDedicatedMasterCount(const qint32 &dedicated_master_count) {
    m_dedicated_master_count = dedicated_master_count;
    m_dedicated_master_count_isSet = true;
}

bool OAIClusterConfig::is_dedicated_master_count_Set() const{
    return m_dedicated_master_count_isSet;
}

bool OAIClusterConfig::is_dedicated_master_count_Valid() const{
    return m_dedicated_master_count_isValid;
}

bool OAIClusterConfig::getWarmEnabled() const {
    return m_warm_enabled;
}
void OAIClusterConfig::setWarmEnabled(const bool &warm_enabled) {
    m_warm_enabled = warm_enabled;
    m_warm_enabled_isSet = true;
}

bool OAIClusterConfig::is_warm_enabled_Set() const{
    return m_warm_enabled_isSet;
}

bool OAIClusterConfig::is_warm_enabled_Valid() const{
    return m_warm_enabled_isValid;
}

OAIOpenSearchWarmPartitionInstanceType OAIClusterConfig::getWarmType() const {
    return m_warm_type;
}
void OAIClusterConfig::setWarmType(const OAIOpenSearchWarmPartitionInstanceType &warm_type) {
    m_warm_type = warm_type;
    m_warm_type_isSet = true;
}

bool OAIClusterConfig::is_warm_type_Set() const{
    return m_warm_type_isSet;
}

bool OAIClusterConfig::is_warm_type_Valid() const{
    return m_warm_type_isValid;
}

qint32 OAIClusterConfig::getWarmCount() const {
    return m_warm_count;
}
void OAIClusterConfig::setWarmCount(const qint32 &warm_count) {
    m_warm_count = warm_count;
    m_warm_count_isSet = true;
}

bool OAIClusterConfig::is_warm_count_Set() const{
    return m_warm_count_isSet;
}

bool OAIClusterConfig::is_warm_count_Valid() const{
    return m_warm_count_isValid;
}

OAICreateDomain_request_ClusterConfig_ColdStorageOptions OAIClusterConfig::getColdStorageOptions() const {
    return m_cold_storage_options;
}
void OAIClusterConfig::setColdStorageOptions(const OAICreateDomain_request_ClusterConfig_ColdStorageOptions &cold_storage_options) {
    m_cold_storage_options = cold_storage_options;
    m_cold_storage_options_isSet = true;
}

bool OAIClusterConfig::is_cold_storage_options_Set() const{
    return m_cold_storage_options_isSet;
}

bool OAIClusterConfig::is_cold_storage_options_Valid() const{
    return m_cold_storage_options_isValid;
}

bool OAIClusterConfig::getMultiAzWithStandbyEnabled() const {
    return m_multi_az_with_standby_enabled;
}
void OAIClusterConfig::setMultiAzWithStandbyEnabled(const bool &multi_az_with_standby_enabled) {
    m_multi_az_with_standby_enabled = multi_az_with_standby_enabled;
    m_multi_az_with_standby_enabled_isSet = true;
}

bool OAIClusterConfig::is_multi_az_with_standby_enabled_Set() const{
    return m_multi_az_with_standby_enabled_isSet;
}

bool OAIClusterConfig::is_multi_az_with_standby_enabled_Valid() const{
