...
/*
 * OAIDeleteInboundConnectionResponse_Connection.h
 *
 * 
 */

#ifndef OAIDeleteInboundConnectionResponse_Connection_H
#define OAIDeleteInboundConnectionResponse_Connection_H
...
class OAIInboundConnection_ConnectionStatus;

class OAIDeleteInboundConnectionResponse_Connection : public OAIObject {
public:
    OAIDeleteInboundConnectionResponse_Connection();
    OAIDeleteInboundConnectionResponse_Connection(QString json);
    ~OAIDeleteInboundConnectionResponse_Connection() override;
    ...
    OAIInboundConnection_ConnectionStatus getConnectionStatus() const;
    void setConnectionStatus(const OAIInboundConnection_ConnectionStatus &connection_status);
...
private:
    ...
    OAIInboundConnection_ConnectionStatus m_connection_status;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteInboundConnectionResponse_Connection)

#endif // OAIDeleteInboundConnectionResponse_Connection_H
