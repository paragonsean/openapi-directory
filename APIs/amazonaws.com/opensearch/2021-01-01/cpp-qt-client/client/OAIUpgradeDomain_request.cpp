...
OAIUpgradeDomain_request::OAIUpgradeDomain_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpgradeDomain_request::OAIUpgradeDomain_request() {
    this->initializeModel();
}

OAIUpgradeDomain_request::~OAIUpgradeDomain_request() {}

void OAIUpgradeDomain_request::initializeModel() {
...
void OAIUpgradeDomain_request::fromJson(QString jsonString) {
...
void OAIUpgradeDomain_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpgradeDomain_request::asJson() const {
...
QJsonObject OAIUpgradeDomain_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpgradeDomain_request::getDomainName() const {
    return m_domain_name;
}
void OAIUpgradeDomain_request::setDomainName(const QString &domain_name) {
    m_domain_name = domain_name;
    m_domain_name_isSet = true;
}

bool OAIUpgradeDomain_request::is_domain_name_Set() const{
    return m_domain_name_isSet;
}

bool OAIUpgradeDomain_request::is_domain_name_Valid() const{
    return m_domain_name_isValid;
}

QString OAIUpgradeDomain_request::getTargetVersion() const {
    return m_target_version;
}
void OAIUpgradeDomain_request::setTargetVersion(const QString &target_version) {
    m_target_version = target_version;
    m_target_version_isSet = true;
}

bool OAIUpgradeDomain_request::is_target_version_Set() const{
    return m_target_version_isSet;
}

bool OAIUpgradeDomain_request::is_target_version_Valid() const{
    return m_target_version_isValid;
}

bool OAIUpgradeDomain_request::isPerformCheckOnly() const {
    return m_perform_check_only;
}
void OAIUpgradeDomain_request::setPerformCheckOnly(const bool &perform_check_only) {
    m_perform_check_only = perform_check_only;
    m_perform_check_only_isSet = true;
}

bool OAIUpgradeDomain_request::is_perform_check_only_Set() const{
    return m_perform_check_only_isSet;
}

bool OAIUpgradeDomain_request::is_perform_check_only_Valid() const{
    return m_perform_check_only_isValid;
}

QMap<QString, QString> OAIUpgradeDomain_request::getAdvancedOptions() const {
    return m_advanced_options;
}
void OAIUpgradeDomain_request::setAdvancedOptions(const QMap<QString, QString> &advanced_options) {
    m_advanced_options = advanced_options;
    m_advanced_options_isSet = true;
}

bool OAIUpgradeDomain_request::is_advanced_options_Set() const{
    return m_advanced_options_isSet;
}

bool OAIUpgradeDomain_request::is_advanced_options_Valid() const{
    return m_advanced_options_isValid;
}

bool OAIUpgradeDomain_request::isSet() const {
...
bool OAIUpgradeDomain_request::isValid() const {
