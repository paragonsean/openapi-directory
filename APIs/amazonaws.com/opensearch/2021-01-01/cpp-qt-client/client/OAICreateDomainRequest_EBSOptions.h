...
/*
 * OAICreateDomainRequest_EBSOptions.h
 *
 * 
 */

#ifndef OAICreateDomainRequest_EBSOptions_H
#define OAICreateDomainRequest_EBSOptions_H
...
class OAICreateDomainRequest_EBSOptions : public OAIObject {
public:
    OAICreateDomainRequest_EBSOptions();
    OAICreateDomainRequest_EBSOptions(QString json);
    ~OAICreateDomainRequest_EBSOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDomainRequest_EBSOptions)

#endif // OAICreateDomainRequest_EBSOptions_H
