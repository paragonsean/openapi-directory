...
/*
 * OAIOffPeakWindowOptionsStatus_Status.h
 *
 * 
 */

#ifndef OAIOffPeakWindowOptionsStatus_Status_H
#define OAIOffPeakWindowOptionsStatus_Status_H
...
class OAIOffPeakWindowOptionsStatus_Status : public OAIObject {
public:
    OAIOffPeakWindowOptionsStatus_Status();
    OAIOffPeakWindowOptionsStatus_Status(QString json);
    ~OAIOffPeakWindowOptionsStatus_Status() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOffPeakWindowOptionsStatus_Status)

#endif // OAIOffPeakWindowOptionsStatus_Status_H
