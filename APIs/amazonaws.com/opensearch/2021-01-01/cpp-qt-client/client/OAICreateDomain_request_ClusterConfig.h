...
/*
 * OAICreateDomain_request_ClusterConfig.h
 *
...
#ifndef OAICreateDomain_request_ClusterConfig_H
#define OAICreateDomain_request_ClusterConfig_H
...
class OAICreateDomain_request_ClusterConfig : public OAIObject {
public:
    OAICreateDomain_request_ClusterConfig();
    OAICreateDomain_request_ClusterConfig(QString json);
    ~OAICreateDomain_request_ClusterConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDomain_request_ClusterConfig)

#endif // OAICreateDomain_request_ClusterConfig_H
