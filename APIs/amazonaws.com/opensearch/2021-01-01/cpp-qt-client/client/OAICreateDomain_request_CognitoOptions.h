...
/*
 * OAICreateDomain_request_CognitoOptions.h
 *
...
#ifndef OAICreateDomain_request_CognitoOptions_H
#define OAICreateDomain_request_CognitoOptions_H
...
class OAICreateDomain_request_CognitoOptions : public OAIObject {
public:
    OAICreateDomain_request_CognitoOptions();
    OAICreateDomain_request_CognitoOptions(QString json);
    ~OAICreateDomain_request_CognitoOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDomain_request_CognitoOptions)

#endif // OAICreateDomain_request_CognitoOptions_H
