...
/*
 * OAIPurchaseReservedInstanceOfferingResponse.h
 *
 * Represents the output of a &lt;code&gt;PurchaseReservedInstanceOffering&lt;/code&gt; operation.
 */

#ifndef OAIPurchaseReservedInstanceOfferingResponse_H
#define OAIPurchaseReservedInstanceOfferingResponse_H
...
class OAIPurchaseReservedInstanceOfferingResponse : public OAIObject {
public:
    OAIPurchaseReservedInstanceOfferingResponse();
    OAIPurchaseReservedInstanceOfferingResponse(QString json);
    ~OAIPurchaseReservedInstanceOfferingResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPurchaseReservedInstanceOfferingResponse)

#endif // OAIPurchaseReservedInstanceOfferingResponse_H
