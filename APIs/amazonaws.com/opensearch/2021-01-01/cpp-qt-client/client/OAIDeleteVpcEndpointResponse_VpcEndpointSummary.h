...
/*
 * OAIDeleteVpcEndpointResponse_VpcEndpointSummary.h
 *
 * 
 */

#ifndef OAIDeleteVpcEndpointResponse_VpcEndpointSummary_H
#define OAIDeleteVpcEndpointResponse_VpcEndpointSummary_H
...
class OAIDeleteVpcEndpointResponse_VpcEndpointSummary : public OAIObject {
public:
    OAIDeleteVpcEndpointResponse_VpcEndpointSummary();
    OAIDeleteVpcEndpointResponse_VpcEndpointSummary(QString json);
    ~OAIDeleteVpcEndpointResponse_VpcEndpointSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteVpcEndpointResponse_VpcEndpointSummary)

#endif // OAIDeleteVpcEndpointResponse_VpcEndpointSummary_H
