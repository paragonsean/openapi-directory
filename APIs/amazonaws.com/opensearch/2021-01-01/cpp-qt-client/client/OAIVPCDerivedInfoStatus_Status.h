...
/*
 * OAIVPCDerivedInfoStatus_Status.h
 *
 * 
 */

#ifndef OAIVPCDerivedInfoStatus_Status_H
#define OAIVPCDerivedInfoStatus_Status_H
...
class OAIVPCDerivedInfoStatus_Status : public OAIObject {
public:
    OAIVPCDerivedInfoStatus_Status();
    OAIVPCDerivedInfoStatus_Status(QString json);
    ~OAIVPCDerivedInfoStatus_Status() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVPCDerivedInfoStatus_Status)

#endif // OAIVPCDerivedInfoStatus_Status_H
