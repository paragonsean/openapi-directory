...
/*
 * OAICreateDomainResponse_DomainStatus.h
 *
 * 
 */

#ifndef OAICreateDomainResponse_DomainStatus_H
#define OAICreateDomainResponse_DomainStatus_H
...
class OAICreateDomainResponse_DomainStatus : public OAIObject {
public:
    OAICreateDomainResponse_DomainStatus();
    OAICreateDomainResponse_DomainStatus(QString json);
    ~OAICreateDomainResponse_DomainStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDomainResponse_DomainStatus)

#endif // OAICreateDomainResponse_DomainStatus_H
