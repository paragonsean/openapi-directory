...
OAIDomainStatus_ServiceSoftwareOptions::OAIDomainStatus_ServiceSoftwareOptions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDomainStatus_ServiceSoftwareOptions::OAIDomainStatus_ServiceSoftwareOptions() {
    this->initializeModel();
}

OAIDomainStatus_ServiceSoftwareOptions::~OAIDomainStatus_ServiceSoftwareOptions() {}

void OAIDomainStatus_ServiceSoftwareOptions::initializeModel() {
...
void OAIDomainStatus_ServiceSoftwareOptions::fromJson(QString jsonString) {
...
void OAIDomainStatus_ServiceSoftwareOptions::fromJsonObject(QJsonObject json) {
...
QString OAIDomainStatus_ServiceSoftwareOptions::asJson() const {
...
QJsonObject OAIDomainStatus_ServiceSoftwareOptions::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDomainStatus_ServiceSoftwareOptions::getCurrentVersion() const {
    return m_current_version;
}
void OAIDomainStatus_ServiceSoftwareOptions::setCurrentVersion(const QString &current_version) {
    m_current_version = current_version;
    m_current_version_isSet = true;
}

bool OAIDomainStatus_ServiceSoftwareOptions::is_current_version_Set() const{
    return m_current_version_isSet;
}

bool OAIDomainStatus_ServiceSoftwareOptions::is_current_version_Valid() const{
    return m_current_version_isValid;
}

QString OAIDomainStatus_ServiceSoftwareOptions::getNewVersion() const {
    return m_new_version;
}
void OAIDomainStatus_ServiceSoftwareOptions::setNewVersion(const QString &new_version) {
    m_new_version = new_version;
    m_new_version_isSet = true;
}

bool OAIDomainStatus_ServiceSoftwareOptions::is_new_version_Set() const{
    return m_new_version_isSet;
}

bool OAIDomainStatus_ServiceSoftwareOptions::is_new_version_Valid() const{
    return m_new_version_isValid;
}

bool OAIDomainStatus_ServiceSoftwareOptions::getUpdateAvailable() const {
    return m_update_available;
}
void OAIDomainStatus_ServiceSoftwareOptions::setUpdateAvailable(const bool &update_available) {
    m_update_available = update_available;
    m_update_available_isSet = true;
}

bool OAIDomainStatus_ServiceSoftwareOptions::is_update_available_Set() const{
    return m_update_available_isSet;
}

bool OAIDomainStatus_ServiceSoftwareOptions::is_update_available_Valid() const{
    return m_update_available_isValid;
}

bool OAIDomainStatus_ServiceSoftwareOptions::getCancellable() const {
    return m_cancellable;
}
void OAIDomainStatus_ServiceSoftwareOptions::setCancellable(const bool &cancellable) {
    m_cancellable = cancellable;
    m_cancellable_isSet = true;
}

bool OAIDomainStatus_ServiceSoftwareOptions::is_cancellable_Set() const{
    return m_cancellable_isSet;
}

bool OAIDomainStatus_ServiceSoftwareOptions::is_cancellable_Valid() const{
    return m_cancellable_isValid;
}

OAIDeploymentStatus OAIDomainStatus_ServiceSoftwareOptions::getUpdateStatus() const {
    return m_update_status;
}
void OAIDomainStatus_ServiceSoftwareOptions::setUpdateStatus(const OAIDeploymentStatus &update_status) {
    m_update_status = update_status;
    m_update_status_isSet = true;
}

bool OAIDomainStatus_ServiceSoftwareOptions::is_update_status_Set() const{
    return m_update_status_isSet;
}

bool OAIDomainStatus_ServiceSoftwareOptions::is_update_status_Valid() const{
    return m_update_status_isValid;
}

QString OAIDomainStatus_ServiceSoftwareOptions::getDescription() const {
    return m_description;
}
void OAIDomainStatus_ServiceSoftwareOptions::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIDomainStatus_ServiceSoftwareOptions::is_description_Set() const{
    return m_description_isSet;
}

bool OAIDomainStatus_ServiceSoftwareOptions::is_description_Valid() const{
    return m_description_isValid;
}

QDateTime OAIDomainStatus_ServiceSoftwareOptions::getAutomatedUpdateDate() const {
    return m_automated_update_date;
}
void OAIDomainStatus_ServiceSoftwareOptions::setAutomatedUpdateDate(const QDateTime &automated_update_date) {
    m_automated_update_date = automated_update_date;
    m_automated_update_date_isSet = true;
}

bool OAIDomainStatus_ServiceSoftwareOptions::is_automated_update_date_Set() const{
    return m_automated_update_date_isSet;
}

bool OAIDomainStatus_ServiceSoftwareOptions::is_automated_update_date_Valid() const{
    return m_automated_update_date_isValid;
}

bool OAIDomainStatus_ServiceSoftwareOptions::getOptionalDeployment() const {
    return m_optional_deployment;
}
void OAIDomainStatus_ServiceSoftwareOptions::setOptionalDeployment(const bool &optional_deployment) {
    m_optional_deployment = optional_deployment;
    m_optional_deployment_isSet = true;
}

bool OAIDomainStatus_ServiceSoftwareOptions::is_optional_deployment_Set() const{
    return m_optional_deployment_isSet;
}

bool OAIDomainStatus_ServiceSoftwareOptions::is_optional_deployment_Valid() const{
    return m_optional_deployment_isValid;
}

bool OAIDomainStatus_ServiceSoftwareOptions::isSet() const {
...
bool OAIDomainStatus_ServiceSoftwareOptions::isValid() const {
