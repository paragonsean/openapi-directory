...
/*
 * OAIPurchaseReservedInstanceOffering_request.h
 *
 * 
 */

#ifndef OAIPurchaseReservedInstanceOffering_request_H
#define OAIPurchaseReservedInstanceOffering_request_H
...
class OAIPurchaseReservedInstanceOffering_request : public OAIObject {
public:
    OAIPurchaseReservedInstanceOffering_request();
    OAIPurchaseReservedInstanceOffering_request(QString json);
    ~OAIPurchaseReservedInstanceOffering_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPurchaseReservedInstanceOffering_request)

#endif // OAIPurchaseReservedInstanceOffering_request_H
