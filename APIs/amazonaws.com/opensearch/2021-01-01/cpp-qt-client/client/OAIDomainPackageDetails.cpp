...
#include "OAIDomainPackageDetails.h"
...
OAIDomainPackageDetails::OAIDomainPackageDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDomainPackageDetails::OAIDomainPackageDetails() {
    this->initializeModel();
}

OAIDomainPackageDetails::~OAIDomainPackageDetails() {}

void OAIDomainPackageDetails::initializeModel() {
...
void OAIDomainPackageDetails::fromJson(QString jsonString) {
...
void OAIDomainPackageDetails::fromJsonObject(QJsonObject json) {
...
QString OAIDomainPackageDetails::asJson() const {
...
QJsonObject OAIDomainPackageDetails::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDomainPackageDetails::getPackageId() const {
    return m_package_id;
}
void OAIDomainPackageDetails::setPackageId(const QString &package_id) {
    m_package_id = package_id;
    m_package_id_isSet = true;
}

bool OAIDomainPackageDetails::is_package_id_Set() const{
    return m_package_id_isSet;
}

bool OAIDomainPackageDetails::is_package_id_Valid() const{
    return m_package_id_isValid;
}

QString OAIDomainPackageDetails::getPackageName() const {
    return m_package_name;
}
void OAIDomainPackageDetails::setPackageName(const QString &package_name) {
    m_package_name = package_name;
    m_package_name_isSet = true;
}

bool OAIDomainPackageDetails::is_package_name_Set() const{
    return m_package_name_isSet;
}

bool OAIDomainPackageDetails::is_package_name_Valid() const{
    return m_package_name_isValid;
}

OAIPackageType OAIDomainPackageDetails::getPackageType() const {
    return m_package_type;
}
void OAIDomainPackageDetails::setPackageType(const OAIPackageType &package_type) {
    m_package_type = package_type;
    m_package_type_isSet = true;
}

bool OAIDomainPackageDetails::is_package_type_Set() const{
    return m_package_type_isSet;
}

bool OAIDomainPackageDetails::is_package_type_Valid() const{
    return m_package_type_isValid;
}

QDateTime OAIDomainPackageDetails::getLastUpdated() const {
    return m_last_updated;
}
void OAIDomainPackageDetails::setLastUpdated(const QDateTime &last_updated) {
    m_last_updated = last_updated;
    m_last_updated_isSet = true;
}

bool OAIDomainPackageDetails::is_last_updated_Set() const{
    return m_last_updated_isSet;
}

bool OAIDomainPackageDetails::is_last_updated_Valid() const{
    return m_last_updated_isValid;
}

QString OAIDomainPackageDetails::getDomainName() const {
    return m_domain_name;
}
void OAIDomainPackageDetails::setDomainName(const QString &domain_name) {
    m_domain_name = domain_name;
    m_domain_name_isSet = true;
}

bool OAIDomainPackageDetails::is_domain_name_Set() const{
    return m_domain_name_isSet;
}

bool OAIDomainPackageDetails::is_domain_name_Valid() const{
    return m_domain_name_isValid;
}

OAIDomainPackageStatus OAIDomainPackageDetails::getDomainPackageStatus() const {
    return m_domain_package_status;
}
void OAIDomainPackageDetails::setDomainPackageStatus(const OAIDomainPackageStatus &domain_package_status) {
    m_domain_package_status = domain_package_status;
    m_domain_package_status_isSet = true;
}

bool OAIDomainPackageDetails::is_domain_package_status_Set() const{
    return m_domain_package_status_isSet;
}

bool OAIDomainPackageDetails::is_domain_package_status_Valid() const{
    return m_domain_package_status_isValid;
}

QString OAIDomainPackageDetails::getPackageVersion() const {
    return m_package_version;
}
void OAIDomainPackageDetails::setPackageVersion(const QString &package_version) {
    m_package_version = package_version;
    m_package_version_isSet = true;
}

bool OAIDomainPackageDetails::is_package_version_Set() const{
    return m_package_version_isSet;
}

bool OAIDomainPackageDetails::is_package_version_Valid() const{
    return m_package_version_isValid;
}

QString OAIDomainPackageDetails::getReferencePath() const {
    return m_reference_path;
}
void OAIDomainPackageDetails::setReferencePath(const QString &reference_path) {
    m_reference_path = reference_path;
    m_reference_path_isSet = true;
}

bool OAIDomainPackageDetails::is_reference_path_Set() const{
    return m_reference_path_isSet;
}

bool OAIDomainPackageDetails::is_reference_path_Valid() const{
    return m_reference_path_isValid;
}

OAIDomainPackageDetails_ErrorDetails OAIDomainPackageDetails::getErrorDetails() const {
    return m_error_details;
}
void OAIDomainPackageDetails::setErrorDetails(const OAIDomainPackageDetails_ErrorDetails &error_details) {
    m_error_details = error_details;
    m_error_details_isSet = true;
}

bool OAIDomainPackageDetails::is_error_details_Set() const{
    return m_error_details_isSet;
}

bool OAIDomainPackageDetails::is_error_details_Valid() const{
    return m_error_details_isValid;
}

bool OAIDomainPackageDetails::isSet() const {
...
bool OAIDomainPackageDetails::isValid() const {
