...
/*
 * OAICreateDomain_request_EBSOptions.h
 *
 * Container for the parameters required to enable EBS-based storage for an OpenSearch Service domain.
 */

#ifndef OAICreateDomain_request_EBSOptions_H
#define OAICreateDomain_request_EBSOptions_H
...
class OAICreateDomain_request_EBSOptions : public OAIObject {
public:
    OAICreateDomain_request_EBSOptions();
    OAICreateDomain_request_EBSOptions(QString json);
    ~OAICreateDomain_request_EBSOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDomain_request_EBSOptions)

#endif // OAICreateDomain_request_EBSOptions_H
