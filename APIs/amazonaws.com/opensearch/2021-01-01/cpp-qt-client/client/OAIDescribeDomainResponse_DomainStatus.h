...
/*
 * OAIDescribeDomainResponse_DomainStatus.h
 *
 * 
 */

#ifndef OAIDescribeDomainResponse_DomainStatus_H
#define OAIDescribeDomainResponse_DomainStatus_H
...
class OAIDescribeDomainResponse_DomainStatus : public OAIObject {
public:
    OAIDescribeDomainResponse_DomainStatus();
    OAIDescribeDomainResponse_DomainStatus(QString json);
    ~OAIDescribeDomainResponse_DomainStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeDomainResponse_DomainStatus)

#endif // OAIDescribeDomainResponse_DomainStatus_H
