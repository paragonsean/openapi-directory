...
/*
 * OAIEBSOptionsStatus_Status.h
 *
 * 
 */

#ifndef OAIEBSOptionsStatus_Status_H
#define OAIEBSOptionsStatus_Status_H
...
class OAIEBSOptionsStatus_Status : public OAIObject {
public:
    OAIEBSOptionsStatus_Status();
    OAIEBSOptionsStatus_Status(QString json);
    ~OAIEBSOptionsStatus_Status() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEBSOptionsStatus_Status)

#endif // OAIEBSOptionsStatus_Status_H
