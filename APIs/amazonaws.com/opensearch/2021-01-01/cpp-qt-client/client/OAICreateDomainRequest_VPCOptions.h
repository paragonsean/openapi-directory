...
/*
 * OAICreateDomainRequest_VPCOptions.h
 *
 * 
 */

#ifndef OAICreateDomainRequest_VPCOptions_H
#define OAICreateDomainRequest_VPCOptions_H
...
class OAICreateDomainRequest_VPCOptions : public OAIObject {
public:
    OAICreateDomainRequest_VPCOptions();
    OAICreateDomainRequest_VPCOptions(QString json);
    ~OAICreateDomainRequest_VPCOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDomainRequest_VPCOptions)

#endif // OAICreateDomainRequest_VPCOptions_H
