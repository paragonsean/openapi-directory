...
/*
 * OAIDomainStatus_ClusterConfig.h
 *
 * 
 */

#ifndef OAIDomainStatus_ClusterConfig_H
#define OAIDomainStatus_ClusterConfig_H
...
class OAIDomainStatus_ClusterConfig : public OAIObject {
public:
    OAIDomainStatus_ClusterConfig();
    OAIDomainStatus_ClusterConfig(QString json);
    ~OAIDomainStatus_ClusterConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDomainStatus_ClusterConfig)

#endif // OAIDomainStatus_ClusterConfig_H
