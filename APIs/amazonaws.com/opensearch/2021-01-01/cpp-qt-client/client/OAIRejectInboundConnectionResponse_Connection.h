...
/*
 * OAIRejectInboundConnectionResponse_Connection.h
 *
 * 
 */

#ifndef OAIRejectInboundConnectionResponse_Connection_H
#define OAIRejectInboundConnectionResponse_Connection_H
...
class OAIRejectInboundConnectionResponse_Connection : public OAIObject {
public:
    OAIRejectInboundConnectionResponse_Connection();
    OAIRejectInboundConnectionResponse_Connection(QString json);
    ~OAIRejectInboundConnectionResponse_Connection() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRejectInboundConnectionResponse_Connection)

#endif // OAIRejectInboundConnectionResponse_Connection_H
