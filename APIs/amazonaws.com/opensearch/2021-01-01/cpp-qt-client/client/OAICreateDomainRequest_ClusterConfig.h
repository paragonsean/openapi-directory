...
/*
 * OAICreateDomainRequest_ClusterConfig.h
 *
 * 
 */

#ifndef OAICreateDomainRequest_ClusterConfig_H
#define OAICreateDomainRequest_ClusterConfig_H
...
class OAICreateDomainRequest_ClusterConfig : public OAIObject {
public:
    OAICreateDomainRequest_ClusterConfig();
    OAICreateDomainRequest_ClusterConfig(QString json);
    ~OAICreateDomainRequest_ClusterConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDomainRequest_ClusterConfig)

#endif // OAICreateDomainRequest_ClusterConfig_H
