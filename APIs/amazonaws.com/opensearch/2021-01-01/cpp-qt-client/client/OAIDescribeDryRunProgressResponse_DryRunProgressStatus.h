...
/*
 * OAIDescribeDryRunProgressResponse_DryRunProgressStatus.h
 *
 * 
 */

#ifndef OAIDescribeDryRunProgressResponse_DryRunProgressStatus_H
#define OAIDescribeDryRunProgressResponse_DryRunProgressStatus_H
...
class OAIDescribeDryRunProgressResponse_DryRunProgressStatus : public OAIObject {
public:
    OAIDescribeDryRunProgressResponse_DryRunProgressStatus();
    OAIDescribeDryRunProgressResponse_DryRunProgressStatus(QString json);
    ~OAIDescribeDryRunProgressResponse_DryRunProgressStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeDryRunProgressResponse_DryRunProgressStatus)

#endif // OAIDescribeDryRunProgressResponse_DryRunProgressStatus_H
