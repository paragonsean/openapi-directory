...
/*
 * OAIAWSDomainInformation.h
 *
 * Information about an Amazon OpenSearch Service domain.
 */

#ifndef OAIAWSDomainInformation_H
#define OAIAWSDomainInformation_H
...
class OAIAWSDomainInformation : public OAIObject {
public:
    OAIAWSDomainInformation();
    OAIAWSDomainInformation(QString json);
    ~OAIAWSDomainInformation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAWSDomainInformation)

#endif // OAIAWSDomainInformation_H
