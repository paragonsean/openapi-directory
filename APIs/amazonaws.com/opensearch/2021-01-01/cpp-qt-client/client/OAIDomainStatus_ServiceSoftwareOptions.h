...
/*
 * OAIDomainStatus_ServiceSoftwareOptions.h
 *
 * 
 */

#ifndef OAIDomainStatus_ServiceSoftwareOptions_H
#define OAIDomainStatus_ServiceSoftwareOptions_H
...
class OAIDomainStatus_ServiceSoftwareOptions : public OAIObject {
public:
    OAIDomainStatus_ServiceSoftwareOptions();
    OAIDomainStatus_ServiceSoftwareOptions(QString json);
    ~OAIDomainStatus_ServiceSoftwareOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDomainStatus_ServiceSoftwareOptions)

#endif // OAIDomainStatus_ServiceSoftwareOptions_H
