...
/*
 * OAISnapshotOptionsStatus_Status.h
 *
 * 
 */

#ifndef OAISnapshotOptionsStatus_Status_H
#define OAISnapshotOptionsStatus_Status_H
...
class OAISnapshotOptionsStatus_Status : public OAIObject {
public:
    OAISnapshotOptionsStatus_Status();
    OAISnapshotOptionsStatus_Status(QString json);
    ~OAISnapshotOptionsStatus_Status() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISnapshotOptionsStatus_Status)

#endif // OAISnapshotOptionsStatus_Status_H
