...
/*
 * OAIUpdateDomainConfigRequest_ClusterConfig.h
 *
 * 
 */

#ifndef OAIUpdateDomainConfigRequest_ClusterConfig_H
#define OAIUpdateDomainConfigRequest_ClusterConfig_H
...
class OAIUpdateDomainConfigRequest_ClusterConfig : public OAIObject {
public:
    OAIUpdateDomainConfigRequest_ClusterConfig();
    OAIUpdateDomainConfigRequest_ClusterConfig(QString json);
    ~OAIUpdateDomainConfigRequest_ClusterConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDomainConfigRequest_ClusterConfig)

#endif // OAIUpdateDomainConfigRequest_ClusterConfig_H
