...
/*
 * OAIClusterConfigStatus_Status.h
 *
 * 
 */

#ifndef OAIClusterConfigStatus_Status_H
#define OAIClusterConfigStatus_Status_H
...
class OAIClusterConfigStatus_Status : public OAIObject {
public:
    OAIClusterConfigStatus_Status();
    OAIClusterConfigStatus_Status(QString json);
    ~OAIClusterConfigStatus_Status() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClusterConfigStatus_Status)

#endif // OAIClusterConfigStatus_Status_H
