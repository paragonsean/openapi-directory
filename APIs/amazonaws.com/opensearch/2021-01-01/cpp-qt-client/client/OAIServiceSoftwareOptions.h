...
#ifndef OAIServiceSoftwareOptions_H
#define OAIServiceSoftwareOptions_H
...
class OAIServiceSoftwareOptions : public OAIObject {
public:
    OAIServiceSoftwareOptions();
    OAIServiceSoftwareOptions(QString json);
    ~OAIServiceSoftwareOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServiceSoftwareOptions)

#endif // OAIServiceSoftwareOptions_H
