...
OAIDomainConfig_EngineVersion OAIDomainConfig::getEngineVersion() const {
    return m_engine_version;
}
void OAIDomainConfig::setEngineVersion(const OAIDomainConfig_EngineVersion &engine_version) {
    m_engine_version = engine_version;
    m_engine_version_isSet = true;
}

bool OAIDomainConfig::is_engine_version_Set() const{
    return m_engine_version_isSet;
}

bool OAIDomainConfig::is_engine_version_Valid() const{
    return m_engine_version_isValid;
}

OAIDomainConfig_ClusterConfig OAIDomainConfig::getClusterConfig() const {
    return m_cluster_config;
}
void OAIDomainConfig::setClusterConfig(const OAIDomainConfig_ClusterConfig &cluster_config) {
    m_cluster_config = cluster_config;
    m_cluster_config_isSet = true;
}

bool OAIDomainConfig::is_cluster_config_Set() const{
    return m_cluster_config_isSet;
}

bool OAIDomainConfig::is_cluster_config_Valid() const{
    return m_cluster_config_isValid;
}

OAIDomainConfig_EBSOptions OAIDomainConfig::getEbsOptions() const {
    return m_ebs_options;
}
void OAIDomainConfig::setEbsOptions(const OAIDomainConfig_EBSOptions &ebs_options) {
    m_ebs_options = ebs_options;
    m_ebs_options_isSet = true;
}

bool OAIDomainConfig::is_ebs_options_Set() const{
    return m_ebs_options_isSet;
}

bool OAIDomainConfig::is_ebs_options_Valid() const{
    return m_ebs_options_isValid;
}

OAIDomainConfig_AccessPolicies OAIDomainConfig::getAccessPolicies() const {
    return m_access_policies;
}
void OAIDomainConfig::setAccessPolicies(const OAIDomainConfig_AccessPolicies &access_policies) {
    m_access_policies = access_policies;
    m_access_policies_isSet = true;
}

bool OAIDomainConfig::is_access_policies_Set() const{
    return m_access_policies_isSet;
}

bool OAIDomainConfig::is_access_policies_Valid() const{
    return m_access_policies_isValid;
}

OAIDomainConfig_SnapshotOptions OAIDomainConfig::getSnapshotOptions() const {
    return m_snapshot_options;
}
void OAIDomainConfig::setSnapshotOptions(const OAIDomainConfig_SnapshotOptions &snapshot_options) {
    m_snapshot_options = snapshot_options;
    m_snapshot_options_isSet = true;
}

bool OAIDomainConfig::is_snapshot_options_Set() const{
    return m_snapshot_options_isSet;
}

bool OAIDomainConfig::is_snapshot_options_Valid() const{
    return m_snapshot_options_isValid;
}

OAIDomainConfig_VPCOptions OAIDomainConfig::getVpcOptions() const {
    return m_vpc_options;
}
void OAIDomainConfig::setVpcOptions(const OAIDomainConfig_VPCOptions &vpc_options) {
    m_vpc_options = vpc_options;
    m_vpc_options_isSet = true;
}

bool OAIDomainConfig::is_vpc_options_Set() const{
    return m_vpc_options_isSet;
}

bool OAIDomainConfig::is_vpc_options_Valid() const{
    return m_vpc_options_isValid;
}

OAIDomainConfig_CognitoOptions OAIDomainConfig::getCognitoOptions() const {
    return m_cognito_options;
}
void OAIDomainConfig::setCognitoOptions(const OAIDomainConfig_CognitoOptions &cognito_options) {
    m_cognito_options = cognito_options;
    m_cognito_options_isSet = true;
}

bool OAIDomainConfig::is_cognito_options_Set() const{
    return m_cognito_options_isSet;
}

bool OAIDomainConfig::is_cognito_options_Valid() const{
    return m_cognito_options_isValid;
}

OAIDomainConfig_EncryptionAtRestOptions OAIDomainConfig::getEncryptionAtRestOptions() const {
    return m_encryption_at_rest_options;
}
void OAIDomainConfig::setEncryptionAtRestOptions(const OAIDomainConfig_EncryptionAtRestOptions &encryption_at_rest_options) {
    m_encryption_at_rest_options = encryption_at_rest_options;
    m_encryption_at_rest_options_isSet = true;
}

bool OAIDomainConfig::is_encryption_at_rest_options_Set() const{
    return m_encryption_at_rest_options_isSet;
}

bool OAIDomainConfig::is_encryption_at_rest_options_Valid() const{
    return m_encryption_at_rest_options_isValid;
}

OAIDomainConfig_NodeToNodeEncryptionOptions OAIDomainConfig::getNodeToNodeEncryptionOptions() const {
    return m_node_to_node_encryption_options;
}
void OAIDomainConfig::setNodeToNodeEncryptionOptions(const OAIDomainConfig_NodeToNodeEncryptionOptions &node_to_node_encryption_options) {
    m_node_to_node_encryption_options = node_to_node_encryption_options;
    m_node_to_node_encryption_options_isSet = true;
}

bool OAIDomainConfig::is_node_to_node_encryption_options_Set() const{
    return m_node_to_node_encryption_options_isSet;
}

bool OAIDomainConfig::is_node_to_node_encryption_options_Valid() const{
    return m_node_to_node_encryption_options_isValid;
}

OAIDomainConfig_AdvancedOptions OAIDomainConfig::getAdvancedOptions() const {
    return m_advanced_options;
}
void OAIDomainConfig::setAdvancedOptions(const OAIDomainConfig_AdvancedOptions &advanced_options) {
    m_advanced_options = advanced_options;
    m_advanced_options_isSet = true;
}

bool OAIDomainConfig::is_advanced_options_Set() const{
    return m_advanced_options_isSet;
}

bool OAIDomainConfig::is_advanced_options_Valid() const{
    return m_advanced_options_isValid;
}

OAIDomainConfig_LogPublishingOptions OAIDomainConfig::getLogPublishingOptions() const {
    return m_log_publishing_options;
}
void OAIDomainConfig::setLogPublishingOptions(const OAIDomainConfig_LogPublishingOptions &log_publishing_options) {
    m_log_publishing_options = log_publishing_options;
    m_log_publishing_options_isSet = true;
}

bool OAIDomainConfig::is_log_publishing_options_Set() const{
    return m_log_publishing_options_isSet;
}

bool OAIDomainConfig::is_log_publishing_options_Valid() const{
    return m_log_publishing_options_isValid;
}

OAIDomainConfig_DomainEndpointOptions OAIDomainConfig::getDomainEndpointOptions() const {
    return m_domain_endpoint_options;
}
void OAIDomainConfig::setDomainEndpointOptions(const OAIDomainConfig_DomainEndpointOptions &domain_endpoint_options) {
    m_domain_endpoint_options = domain_endpoint_options;
    m_domain_endpoint_options_isSet = true;
}

bool OAIDomainConfig::is_domain_endpoint_options_Set() const{
    return m_domain_endpoint_options_isSet;
}

bool OAIDomainConfig::is_domain_endpoint_options_Valid() const{
    return m_domain_endpoint_options_isValid;
}

OAIDomainConfig_AdvancedSecurityOptions OAIDomainConfig::getAdvancedSecurityOptions() const {
    return m_advanced_security_options;
}
void OAIDomainConfig::setAdvancedSecurityOptions(const OAIDomainConfig_AdvancedSecurityOptions &advanced_security_options) {
    m_advanced_security_options = advanced_security_options;
    m_advanced_security_options_isSet = true;
}

bool OAIDomainConfig::is_advanced_security_options_Set() const{
    return m_advanced_security_options_isSet;
}

bool OAIDomainConfig::is_advanced_security_options_Valid() const{
    return m_advanced_security_options_isValid;
}

OAIDomainConfig_AutoTuneOptions OAIDomainConfig::getAutoTuneOptions() const {
    return m_auto_tune_options;
}
void OAIDomainConfig::setAutoTuneOptions(const OAIDomainConfig_AutoTuneOptions &auto_tune_options) {
    m_auto_tune_options = auto_tune_options;
    m_auto_tune_options_isSet = true;
}

bool OAIDomainConfig::is_auto_tune_options_Set() const{
    return m_auto_tune_options_isSet;
}

bool OAIDomainConfig::is_auto_tune_options_Valid() const{
    return m_auto_tune_options_isValid;
}

OAIDomainConfig_ChangeProgressDetails OAIDomainConfig::getChangeProgressDetails() const {
    return m_change_progress_details;
}
void OAIDomainConfig::setChangeProgressDetails(const OAIDomainConfig_ChangeProgressDetails &change_progress_details) {
    m_change_progress_details = change_progress_details;
    m_change_progress_details_isSet = true;
}

bool OAIDomainConfig::is_change_progress_details_Set() const{
    return m_change_progress_details_isSet;
}

bool OAIDomainConfig::is_change_progress_details_Valid() const{
    return m_change_progress_details_isValid;
}

OAIDomainConfig_OffPeakWindowOptions OAIDomainConfig::getOffPeakWindowOptions() const {
    return m_off_peak_window_options;
}
void OAIDomainConfig::setOffPeakWindowOptions(const OAIDomainConfig_OffPeakWindowOptions &off_peak_window_options) {
    m_off_peak_window_options = off_peak_window_options;
    m_off_peak_window_options_isSet = true;
}

bool OAIDomainConfig::is_off_peak_window_options_Set() const{
    return m_off_peak_window_options_isSet;
}

bool OAIDomainConfig::is_off_peak_window_options_Valid() const{
    return m_off_peak_window_options_isValid;
}

OAIDomainConfig_SoftwareUpdateOptions OAIDomainConfig::getSoftwareUpdateOptions() const {
    return m_software_update_options;
}
void OAIDomainConfig::setSoftwareUpdateOptions(const OAIDomainConfig_SoftwareUpdateOptions &software_update_options) {
    m_software_update_options = software_update_options;
    m_software_update_options_isSet = true;
}

bool OAIDomainConfig::is_software_update_options_Set() const{
    return m_software_update_options_isSet;
}

bool OAIDomainConfig::is_software_update_options_Valid() const{
