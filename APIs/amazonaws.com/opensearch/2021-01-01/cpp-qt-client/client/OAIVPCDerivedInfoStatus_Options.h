...
/*
 * OAIVPCDerivedInfoStatus_Options.h
 *
 * 
 */

#ifndef OAIVPCDerivedInfoStatus_Options_H
#define OAIVPCDerivedInfoStatus_Options_H
...
class OAIVPCDerivedInfoStatus_Options : public OAIObject {
public:
    OAIVPCDerivedInfoStatus_Options();
    OAIVPCDerivedInfoStatus_Options(QString json);
    ~OAIVPCDerivedInfoStatus_Options() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVPCDerivedInfoStatus_Options)

#endif // OAIVPCDerivedInfoStatus_Options_H
