...
/*
 * OAIAdvancedOptionsStatus_Status.h
 *
 * 
 */

#ifndef OAIAdvancedOptionsStatus_Status_H
#define OAIAdvancedOptionsStatus_Status_H
...
class OAIAdvancedOptionsStatus_Status : public OAIObject {
public:
    OAIAdvancedOptionsStatus_Status();
    OAIAdvancedOptionsStatus_Status(QString json);
    ~OAIAdvancedOptionsStatus_Status() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdvancedOptionsStatus_Status)

#endif // OAIAdvancedOptionsStatus_Status_H
