...
QString OAICreateDomain_request::getDomainName() const {
    return m_domain_name;
}
void OAICreateDomain_request::setDomainName(const QString &domain_name) {
    m_domain_name = domain_name;
    m_domain_name_isSet = true;
}

bool OAICreateDomain_request::is_domain_name_Set() const{
    return m_domain_name_isSet;
}

bool OAICreateDomain_request::is_domain_name_Valid() const{
    return m_domain_name_isValid;
}

QString OAICreateDomain_request::getEngineVersion() const {
    return m_engine_version;
}
void OAICreateDomain_request::setEngineVersion(const QString &engine_version) {
    m_engine_version = engine_version;
    m_engine_version_isSet = true;
}

bool OAICreateDomain_request::is_engine_version_Set() const{
    return m_engine_version_isSet;
}

bool OAICreateDomain_request::is_engine_version_Valid() const{
    return m_engine_version_isValid;
}

OAICreateDomain_request_ClusterConfig OAICreateDomain_request::getClusterConfig() const {
    return m_cluster_config;
}
void OAICreateDomain_request::setClusterConfig(const OAICreateDomain_request_ClusterConfig &cluster_config) {
    m_cluster_config = cluster_config;
    m_cluster_config_isSet = true;
}

bool OAICreateDomain_request::is_cluster_config_Set() const{
    return m_cluster_config_isSet;
}

bool OAICreateDomain_request::is_cluster_config_Valid() const{
    return m_cluster_config_isValid;
}

OAICreateDomain_request_EBSOptions OAICreateDomain_request::getEbsOptions() const {
    return m_ebs_options;
}
void OAICreateDomain_request::setEbsOptions(const OAICreateDomain_request_EBSOptions &ebs_options) {
    m_ebs_options = ebs_options;
    m_ebs_options_isSet = true;
}

bool OAICreateDomain_request::is_ebs_options_Set() const{
    return m_ebs_options_isSet;
}

bool OAICreateDomain_request::is_ebs_options_Valid() const{
    return m_ebs_options_isValid;
}

QString OAICreateDomain_request::getAccessPolicies() const {
    return m_access_policies;
}
void OAICreateDomain_request::setAccessPolicies(const QString &access_policies) {
    m_access_policies = access_policies;
    m_access_policies_isSet = true;
}

bool OAICreateDomain_request::is_access_policies_Set() const{
    return m_access_policies_isSet;
}

bool OAICreateDomain_request::is_access_policies_Valid() const{
    return m_access_policies_isValid;
}

OAICreateDomain_request_SnapshotOptions OAICreateDomain_request::getSnapshotOptions() const {
    return m_snapshot_options;
}
void OAICreateDomain_request::setSnapshotOptions(const OAICreateDomain_request_SnapshotOptions &snapshot_options) {
    m_snapshot_options = snapshot_options;
    m_snapshot_options_isSet = true;
}

bool OAICreateDomain_request::is_snapshot_options_Set() const{
    return m_snapshot_options_isSet;
}

bool OAICreateDomain_request::is_snapshot_options_Valid() const{
    return m_snapshot_options_isValid;
}

OAICreateDomain_request_VPCOptions OAICreateDomain_request::getVpcOptions() const {
    return m_vpc_options;
}
void OAICreateDomain_request::setVpcOptions(const OAICreateDomain_request_VPCOptions &vpc_options) {
    m_vpc_options = vpc_options;
    m_vpc_options_isSet = true;
}

bool OAICreateDomain_request::is_vpc_options_Set() const{
    return m_vpc_options_isSet;
}

bool OAICreateDomain_request::is_vpc_options_Valid() const{
    return m_vpc_options_isValid;
}

OAICreateDomain_request_CognitoOptions OAICreateDomain_request::getCognitoOptions() const {
    return m_cognito_options;
}
void OAICreateDomain_request::setCognitoOptions(const OAICreateDomain_request_CognitoOptions &cognito_options) {
    m_cognito_options = cognito_options;
    m_cognito_options_isSet = true;
}

bool OAICreateDomain_request::is_cognito_options_Set() const{
    return m_cognito_options_isSet;
}

bool OAICreateDomain_request::is_cognito_options_Valid() const{
    return m_cognito_options_isValid;
}

OAICreateDomain_request_EncryptionAtRestOptions OAICreateDomain_request::getEncryptionAtRestOptions() const {
    return m_encryption_at_rest_options;
}
void OAICreateDomain_request::setEncryptionAtRestOptions(const OAICreateDomain_request_EncryptionAtRestOptions &encryption_at_rest_options) {
    m_encryption_at_rest_options = encryption_at_rest_options;
    m_encryption_at_rest_options_isSet = true;
}

bool OAICreateDomain_request::is_encryption_at_rest_options_Set() const{
    return m_encryption_at_rest_options_isSet;
}

bool OAICreateDomain_request::is_encryption_at_rest_options_Valid() const{
    return m_encryption_at_rest_options_isValid;
}

OAICreateDomain_request_NodeToNodeEncryptionOptions OAICreateDomain_request::getNodeToNodeEncryptionOptions() const {
    return m_node_to_node_encryption_options;
}
void OAICreateDomain_request::setNodeToNodeEncryptionOptions(const OAICreateDomain_request_NodeToNodeEncryptionOptions &node_to_node_encryption_options) {
    m_node_to_node_encryption_options = node_to_node_encryption_options;
    m_node_to_node_encryption_options_isSet = true;
}

bool OAICreateDomain_request::is_node_to_node_encryption_options_Set() const{
    return m_node_to_node_encryption_options_isSet;
}

bool OAICreateDomain_request::is_node_to_node_encryption_options_Valid() const{
    return m_node_to_node_encryption_options_isValid;
}

QMap<QString, QString> OAICreateDomain_request::getAdvancedOptions() const {
    return m_advanced_options;
}
void OAICreateDomain_request::setAdvancedOptions(const QMap<QString, QString> &advanced_options) {
    m_advanced_options = advanced_options;
    m_advanced_options_isSet = true;
}

bool OAICreateDomain_request::is_advanced_options_Set() const{
    return m_advanced_options_isSet;
}

bool OAICreateDomain_request::is_advanced_options_Valid() const{
    return m_advanced_options_isValid;
}

QMap<QString, OAILogPublishingOption> OAICreateDomain_request::getLogPublishingOptions() const {
    return m_log_publishing_options;
}
void OAICreateDomain_request::setLogPublishingOptions(const QMap<QString, OAILogPublishingOption> &log_publishing_options) {
    m_log_publishing_options = log_publishing_options;
    m_log_publishing_options_isSet = true;
}

bool OAICreateDomain_request::is_log_publishing_options_Set() const{
    return m_log_publishing_options_isSet;
}

bool OAICreateDomain_request::is_log_publishing_options_Valid() const{
    return m_log_publishing_options_isValid;
}

OAICreateDomain_request_DomainEndpointOptions OAICreateDomain_request::getDomainEndpointOptions() const {
    return m_domain_endpoint_options;
}
void OAICreateDomain_request::setDomainEndpointOptions(const OAICreateDomain_request_DomainEndpointOptions &domain_endpoint_options) {
    m_domain_endpoint_options = domain_endpoint_options;
    m_domain_endpoint_options_isSet = true;
}

bool OAICreateDomain_request::is_domain_endpoint_options_Set() const{
    return m_domain_endpoint_options_isSet;
}

bool OAICreateDomain_request::is_domain_endpoint_options_Valid() const{
    return m_domain_endpoint_options_isValid;
}

OAICreateDomain_request_AdvancedSecurityOptions OAICreateDomain_request::getAdvancedSecurityOptions() const {
    return m_advanced_security_options;
}
void OAICreateDomain_request::setAdvancedSecurityOptions(const OAICreateDomain_request_AdvancedSecurityOptions &advanced_security_options) {
    m_advanced_security_options = advanced_security_options;
    m_advanced_security_options_isSet = true;
}

bool OAICreateDomain_request::is_advanced_security_options_Set() const{
    return m_advanced_security_options_isSet;
}

bool OAICreateDomain_request::is_advanced_security_options_Valid() const{
    return m_advanced_security_options_isValid;
}

QList<OAITag> OAICreateDomain_request::getTagList() const {
    return m_tag_list;
}
void OAICreateDomain_request::setTagList(const QList<OAITag> &tag_list) {
    m_tag_list = tag_list;
    m_tag_list_isSet = true;
}

bool OAICreateDomain_request::is_tag_list_Set() const{
    return m_tag_list_isSet;
}

bool OAICreateDomain_request::is_tag_list_Valid() const{
    return m_tag_list_isValid;
}

OAICreateDomain_request_AutoTuneOptions OAICreateDomain_request::getAutoTuneOptions() const {
    return m_auto_tune_options;
}
void OAICreateDomain_request::setAutoTuneOptions(const OAICreateDomain_request_AutoTuneOptions &auto_tune_options) {
    m_auto_tune_options = auto_tune_options;
    m_auto_tune_options_isSet = true;
}

bool OAICreateDomain_request::is_auto_tune_options_Set() const{
    return m_auto_tune_options_isSet;
}

bool OAICreateDomain_request::is_auto_tune_options_Valid() const{
    return m_auto_tune_options_isValid;
}

OAICreateDomain_request_OffPeakWindowOptions OAICreateDomain_request::getOffPeakWindowOptions() const {
    return m_off_peak_window_options;
}
void OAICreateDomain_request::setOffPeakWindowOptions(const OAICreateDomain_request_OffPeakWindowOptions &off_peak_window_options) {
    m_off_peak_window_options = off_peak_window_options;
    m_off_peak_window_options_isSet = true;
}

bool OAICreateDomain_request::is_off_peak_window_options_Set() const{
    return m_off_peak_window_options_isSet;
}

bool OAICreateDomain_request::is_off_peak_window_options_Valid() const{
    return m_off_peak_window_options_isValid;
}

OAICreateDomain_request_SoftwareUpdateOptions OAICreateDomain_request::getSoftwareUpdateOptions() const {
    return m_software_update_options;
}
void OAICreateDomain_request::setSoftwareUpdateOptions(const OAICreateDomain_request_SoftwareUpdateOptions &software_update_options) {
    m_software_update_options = software_update_options;
    m_software_update_options_isSet = true;
}

bool OAICreateDomain_request::is_software_update_options_Set() const{
    return m_software_update_options_isSet;
}

bool OAICreateDomain_request::is_software_update_options_Valid() const{
