...
/*
 * OAISoftwareUpdateOptionsStatus_Status.h
 *
 * 
 */

#ifndef OAISoftwareUpdateOptionsStatus_Status_H
#define OAISoftwareUpdateOptionsStatus_Status_H
...
class OAISoftwareUpdateOptionsStatus_Status : public OAIObject {
public:
    OAISoftwareUpdateOptionsStatus_Status();
    OAISoftwareUpdateOptionsStatus_Status(QString json);
    ~OAISoftwareUpdateOptionsStatus_Status() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISoftwareUpdateOptionsStatus_Status)

#endif // OAISoftwareUpdateOptionsStatus_Status_H
