...
/*
 * OAIAccessPoliciesStatus_Status.h
 *
 * 
 */

#ifndef OAIAccessPoliciesStatus_Status_H
#define OAIAccessPoliciesStatus_Status_H
...
class OAIAccessPoliciesStatus_Status : public OAIObject {
public:
    OAIAccessPoliciesStatus_Status();
    OAIAccessPoliciesStatus_Status(QString json);
    ~OAIAccessPoliciesStatus_Status() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccessPoliciesStatus_Status)

#endif // OAIAccessPoliciesStatus_Status_H
