...
/*
 * OAIDeleteDomainResponse_DomainStatus.h
 *
 * 
 */

#ifndef OAIDeleteDomainResponse_DomainStatus_H
#define OAIDeleteDomainResponse_DomainStatus_H
...
class OAIDeleteDomainResponse_DomainStatus : public OAIObject {
public:
    OAIDeleteDomainResponse_DomainStatus();
    OAIDeleteDomainResponse_DomainStatus(QString json);
    ~OAIDeleteDomainResponse_DomainStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteDomainResponse_DomainStatus)

#endif // OAIDeleteDomainResponse_DomainStatus_H
