...
/*
 * OAICreateDomainRequest_CognitoOptions.h
 *
 * 
 */

#ifndef OAICreateDomainRequest_CognitoOptions_H
#define OAICreateDomainRequest_CognitoOptions_H
...
class OAICreateDomainRequest_CognitoOptions : public OAIObject {
public:
    OAICreateDomainRequest_CognitoOptions();
    OAICreateDomainRequest_CognitoOptions(QString json);
    ~OAICreateDomainRequest_CognitoOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDomainRequest_CognitoOptions)

#endif // OAICreateDomainRequest_CognitoOptions_H
