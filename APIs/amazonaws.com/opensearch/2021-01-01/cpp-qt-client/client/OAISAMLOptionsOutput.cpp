...
#include "OAISAMLOptionsOutput.h"
...
OAISAMLOptionsOutput::OAISAMLOptionsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISAMLOptionsOutput::OAISAMLOptionsOutput() {
    this->initializeModel();
}

OAISAMLOptionsOutput::~OAISAMLOptionsOutput() {}

void OAISAMLOptionsOutput::initializeModel() {
...
void OAISAMLOptionsOutput::fromJson(QString jsonString) {
...
void OAISAMLOptionsOutput::fromJsonObject(QJsonObject json) {
...
QString OAISAMLOptionsOutput::asJson() const {
...
QJsonObject OAISAMLOptionsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAISAMLOptionsOutput::getEnabled() const {
    return m_enabled;
}
void OAISAMLOptionsOutput::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAISAMLOptionsOutput::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAISAMLOptionsOutput::is_enabled_Valid() const{
    return m_enabled_isValid;
}

OAISAMLOptionsOutput_Idp OAISAMLOptionsOutput::getIdp() const {
    return m_idp;
}
void OAISAMLOptionsOutput::setIdp(const OAISAMLOptionsOutput_Idp &idp) {
    m_idp = idp;
    m_idp_isSet = true;
}

bool OAISAMLOptionsOutput::is_idp_Set() const{
    return m_idp_isSet;
}

bool OAISAMLOptionsOutput::is_idp_Valid() const{
    return m_idp_isValid;
}

QString OAISAMLOptionsOutput::getSubjectKey() const {
    return m_subject_key;
}
void OAISAMLOptionsOutput::setSubjectKey(const QString &subject_key) {
    m_subject_key = subject_key;
    m_subject_key_isSet = true;
}

bool OAISAMLOptionsOutput::is_subject_key_Set() const{
    return m_subject_key_isSet;
}

bool OAISAMLOptionsOutput::is_subject_key_Valid() const{
    return m_subject_key_isValid;
}

QString OAISAMLOptionsOutput::getRolesKey() const {
    return m_roles_key;
}
void OAISAMLOptionsOutput::setRolesKey(const QString &roles_key) {
    m_roles_key = roles_key;
    m_roles_key_isSet = true;
}

bool OAISAMLOptionsOutput::is_roles_key_Set() const{
    return m_roles_key_isSet;
}

bool OAISAMLOptionsOutput::is_roles_key_Valid() const{
    return m_roles_key_isValid;
}

qint32 OAISAMLOptionsOutput::getSessionTimeoutMinutes() const {
    return m_session_timeout_minutes;
}
void OAISAMLOptionsOutput::setSessionTimeoutMinutes(const qint32 &session_timeout_minutes) {
    m_session_timeout_minutes = session_timeout_minutes;
    m_session_timeout_minutes_isSet = true;
}

bool OAISAMLOptionsOutput::is_session_timeout_minutes_Set() const{
    return m_session_timeout_minutes_isSet;
}

bool OAISAMLOptionsOutput::is_session_timeout_minutes_Valid() const{
    return m_session_timeout_minutes_isValid;
}

bool OAISAMLOptionsOutput::isSet() const {
...
bool OAISAMLOptionsOutput::isValid() const {
