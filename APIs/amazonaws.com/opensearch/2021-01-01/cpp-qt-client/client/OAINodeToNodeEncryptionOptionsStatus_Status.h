...
/*
 * OAINodeToNodeEncryptionOptionsStatus_Status.h
 *
 * 
 */

#ifndef OAINodeToNodeEncryptionOptionsStatus_Status_H
#define OAINodeToNodeEncryptionOptionsStatus_Status_H
...
class OAINodeToNodeEncryptionOptionsStatus_Status : public OAIObject {
public:
    OAINodeToNodeEncryptionOptionsStatus_Status();
    OAINodeToNodeEncryptionOptionsStatus_Status(QString json);
    ~OAINodeToNodeEncryptionOptionsStatus_Status() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINodeToNodeEncryptionOptionsStatus_Status)

#endif // OAINodeToNodeEncryptionOptionsStatus_Status_H
