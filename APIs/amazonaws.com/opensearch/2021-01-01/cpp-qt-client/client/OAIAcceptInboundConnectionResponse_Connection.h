...
/*
 * OAIAcceptInboundConnectionResponse_Connection.h
 *
 * 
 */

#ifndef OAIAcceptInboundConnectionResponse_Connection_H
#define OAIAcceptInboundConnectionResponse_Connection_H
...
class OAIAcceptInboundConnectionResponse_Connection : public OAIObject {
public:
    OAIAcceptInboundConnectionResponse_Connection();
    OAIAcceptInboundConnectionResponse_Connection(QString json);
    ~OAIAcceptInboundConnectionResponse_Connection() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAcceptInboundConnectionResponse_Connection)

#endif // OAIAcceptInboundConnectionResponse_Connection_H
