...
#ifndef OAIPackageSource_H
#define OAIPackageSource_H
...
class OAIPackageSource : public OAIObject {
public:
    OAIPackageSource();
    OAIPackageSource(QString json);
    ~OAIPackageSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPackageSource)

#endif // OAIPackageSource_H
