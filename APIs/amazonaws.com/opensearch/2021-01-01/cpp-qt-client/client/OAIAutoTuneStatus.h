...
#ifndef OAIAutoTuneStatus_H
#define OAIAutoTuneStatus_H
...
class OAIAutoTuneStatus : public OAIObject {
public:
    OAIAutoTuneStatus();
    OAIAutoTuneStatus(QString json);
    ~OAIAutoTuneStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutoTuneStatus)

#endif // OAIAutoTuneStatus_H
