...
/*
 * OAICognitoOptionsStatus_Status.h
 *
 * 
 */

#ifndef OAICognitoOptionsStatus_Status_H
#define OAICognitoOptionsStatus_Status_H
...
class OAICognitoOptionsStatus_Status : public OAIObject {
public:
    OAICognitoOptionsStatus_Status();
    OAICognitoOptionsStatus_Status(QString json);
    ~OAICognitoOptionsStatus_Status() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICognitoOptionsStatus_Status)

#endif // OAICognitoOptionsStatus_Status_H
