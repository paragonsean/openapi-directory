...
/*
 * OAIDryRunProgressStatus.h
 *
 * Information about the progress of a pre-upgrade dry run analysis.
 */

#ifndef OAIDryRunProgressStatus_H
#define OAIDryRunProgressStatus_H
...
class OAIDryRunProgressStatus : public OAIObject {
public:
    OAIDryRunProgressStatus();
    OAIDryRunProgressStatus(QString json);
    ~OAIDryRunProgressStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDryRunProgressStatus)

#endif // OAIDryRunProgressStatus_H
