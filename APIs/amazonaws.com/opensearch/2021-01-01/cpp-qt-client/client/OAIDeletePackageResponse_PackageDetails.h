...
/*
 * OAIDeletePackageResponse_PackageDetails.h
 *
 * 
 */

#ifndef OAIDeletePackageResponse_PackageDetails_H
#define OAIDeletePackageResponse_PackageDetails_H
...
class OAIDeletePackageResponse_PackageDetails : public OAIObject {
public:
    OAIDeletePackageResponse_PackageDetails();
    OAIDeletePackageResponse_PackageDetails(QString json);
    ~OAIDeletePackageResponse_PackageDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeletePackageResponse_PackageDetails)

#endif // OAIDeletePackageResponse_PackageDetails_H
