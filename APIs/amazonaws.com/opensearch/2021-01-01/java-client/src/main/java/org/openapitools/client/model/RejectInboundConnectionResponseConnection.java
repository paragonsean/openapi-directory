...
public class RejectInboundConnectionResponseConnection {
  ...
  public RejectInboundConnectionResponseConnection() {
  }

  public RejectInboundConnectionResponseConnection localDomainInfo(CreateOutboundConnectionResponseLocalDomainInfo localDomainInfo) {
  ...
  public RejectInboundConnectionResponseConnection remoteDomainInfo(CreateOutboundConnectionResponseRemoteDomainInfo remoteDomainInfo) {
  ...
  public RejectInboundConnectionResponseConnection connectionId(String connectionId) {
  ...
  public RejectInboundConnectionResponseConnection connectionStatus(InboundConnectionConnectionStatus connectionStatus) {
  ...
  public RejectInboundConnectionResponseConnection connectionMode(ConnectionMode connectionMode) {
  ...
  public boolean equals(Object o) {
    ...
    RejectInboundConnectionResponseConnection rejectInboundConnectionResponseConnection = (RejectInboundConnectionResponseConnection) o;
    return Objects.equals(this.localDomainInfo, rejectInboundConnectionResponseConnection.localDomainInfo) &&
        Objects.equals(this.remoteDomainInfo, rejectInboundConnectionResponseConnection.remoteDomainInfo) &&
        Objects.equals(this.connectionId, rejectInboundConnectionResponseConnection.connectionId) &&
        Objects.equals(this.connectionStatus, rejectInboundConnectionResponseConnection.connectionStatus) &&
        Objects.equals(this.connectionMode, rejectInboundConnectionResponseConnection.connectionMode);
  }
  ...
  public String toString() {
    ...
    sb.append("class RejectInboundConnectionResponseConnection {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RejectInboundConnectionResponseConnection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RejectInboundConnectionResponseConnection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RejectInboundConnectionResponseConnection is not found in the empty JSON string", RejectInboundConnectionResponseConnection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RejectInboundConnectionResponseConnection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RejectInboundConnectionResponseConnection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RejectInboundConnectionResponseConnection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RejectInboundConnectionResponseConnection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RejectInboundConnectionResponseConnection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RejectInboundConnectionResponseConnection.class));

       return (TypeAdapter<T>) new TypeAdapter<RejectInboundConnectionResponseConnection>() {
           @Override
           public void write(JsonWriter out, RejectInboundConnectionResponseConnection value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RejectInboundConnectionResponseConnection read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RejectInboundConnectionResponseConnection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RejectInboundConnectionResponseConnection
   * @throws IOException if the JSON string is invalid with respect to RejectInboundConnectionResponseConnection
   */
  public static RejectInboundConnectionResponseConnection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RejectInboundConnectionResponseConnection.class);
  }

  /**
   * Convert an instance of RejectInboundConnectionResponseConnection to an JSON string
   *
   * @return JSON string
   */
