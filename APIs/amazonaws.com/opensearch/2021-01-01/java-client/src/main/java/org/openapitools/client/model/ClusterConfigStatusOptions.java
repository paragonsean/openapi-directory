...
public class ClusterConfigStatusOptions {
  ...
  public ClusterConfigStatusOptions() {
  }

  public ClusterConfigStatusOptions instanceType(OpenSearchPartitionInstanceType instanceType) {
  ...
  public ClusterConfigStatusOptions instanceCount(Integer instanceCount) {
  ...
  public ClusterConfigStatusOptions dedicatedMasterEnabled(Boolean dedicatedMasterEnabled) {
  ...
  public ClusterConfigStatusOptions zoneAwarenessEnabled(Boolean zoneAwarenessEnabled) {
  ...
  public ClusterConfigStatusOptions zoneAwarenessConfig(CreateDomainRequestClusterConfigZoneAwarenessConfig zoneAwarenessConfig) {
  ...
  public ClusterConfigStatusOptions dedicatedMasterType(OpenSearchPartitionInstanceType dedicatedMasterType) {
  ...
  public ClusterConfigStatusOptions dedicatedMasterCount(Integer dedicatedMasterCount) {
  ...
  public ClusterConfigStatusOptions warmEnabled(Boolean warmEnabled) {
  ...
  public ClusterConfigStatusOptions warmType(OpenSearchWarmPartitionInstanceType warmType) {
  ...
  public ClusterConfigStatusOptions warmCount(Integer warmCount) {
  ...
  public ClusterConfigStatusOptions coldStorageOptions(CreateDomainRequestClusterConfigColdStorageOptions coldStorageOptions) {
  ...
  public ClusterConfigStatusOptions multiAZWithStandbyEnabled(Boolean multiAZWithStandbyEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    ClusterConfigStatusOptions clusterConfigStatusOptions = (ClusterConfigStatusOptions) o;
    return Objects.equals(this.instanceType, clusterConfigStatusOptions.instanceType) &&
        Objects.equals(this.instanceCount, clusterConfigStatusOptions.instanceCount) &&
        Objects.equals(this.dedicatedMasterEnabled, clusterConfigStatusOptions.dedicatedMasterEnabled) &&
        Objects.equals(this.zoneAwarenessEnabled, clusterConfigStatusOptions.zoneAwarenessEnabled) &&
        Objects.equals(this.zoneAwarenessConfig, clusterConfigStatusOptions.zoneAwarenessConfig) &&
        Objects.equals(this.dedicatedMasterType, clusterConfigStatusOptions.dedicatedMasterType) &&
        Objects.equals(this.dedicatedMasterCount, clusterConfigStatusOptions.dedicatedMasterCount) &&
        Objects.equals(this.warmEnabled, clusterConfigStatusOptions.warmEnabled) &&
        Objects.equals(this.warmType, clusterConfigStatusOptions.warmType) &&
        Objects.equals(this.warmCount, clusterConfigStatusOptions.warmCount) &&
        Objects.equals(this.coldStorageOptions, clusterConfigStatusOptions.coldStorageOptions) &&
        Objects.equals(this.multiAZWithStandbyEnabled, clusterConfigStatusOptions.multiAZWithStandbyEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClusterConfigStatusOptions {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClusterConfigStatusOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClusterConfigStatusOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClusterConfigStatusOptions is not found in the empty JSON string", ClusterConfigStatusOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClusterConfigStatusOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ClusterConfigStatusOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClusterConfigStatusOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClusterConfigStatusOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClusterConfigStatusOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClusterConfigStatusOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<ClusterConfigStatusOptions>() {
           @Override
           public void write(JsonWriter out, ClusterConfigStatusOptions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ClusterConfigStatusOptions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ClusterConfigStatusOptions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ClusterConfigStatusOptions
   * @throws IOException if the JSON string is invalid with respect to ClusterConfigStatusOptions
   */
  public static ClusterConfigStatusOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClusterConfigStatusOptions.class);
  }

  /**
   * Convert an instance of ClusterConfigStatusOptions to an JSON string
   *
   * @return JSON string
   */
