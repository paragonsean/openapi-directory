...
public class CreateDomainResponseDomainStatus {
  ...
  public CreateDomainResponseDomainStatus() {
  }

  public CreateDomainResponseDomainStatus domainId(String domainId) {
  ...
  public CreateDomainResponseDomainStatus domainName(String domainName) {
  ...
  public CreateDomainResponseDomainStatus ARN(String ARN) {
    this.ARN = ARN;
    return this;
  }
  ...
  public CreateDomainResponseDomainStatus created(Boolean created) {
  ...
  public CreateDomainResponseDomainStatus deleted(Boolean deleted) {
  ...
  public CreateDomainResponseDomainStatus endpoint(String endpoint) {
  ...
  public CreateDomainResponseDomainStatus endpoints(Map endpoints) {
  ...
  public CreateDomainResponseDomainStatus processing(Boolean processing) {
  ...
  public CreateDomainResponseDomainStatus upgradeProcessing(Boolean upgradeProcessing) {
  ...
  public CreateDomainResponseDomainStatus engineVersion(String engineVersion) {
  ...
  public CreateDomainResponseDomainStatus clusterConfig(DomainStatusClusterConfig clusterConfig) {
  ...
  public CreateDomainResponseDomainStatus ebSOptions(DomainStatusEBSOptions ebSOptions) {
  ...
  public CreateDomainResponseDomainStatus accessPolicies(String accessPolicies) {
  ...
  public CreateDomainResponseDomainStatus snapshotOptions(DomainStatusSnapshotOptions snapshotOptions) {
  ...
  public CreateDomainResponseDomainStatus vpCOptions(DomainStatusVPCOptions vpCOptions) {
  ...
  public CreateDomainResponseDomainStatus cognitoOptions(DomainStatusCognitoOptions cognitoOptions) {
  ...
  public CreateDomainResponseDomainStatus encryptionAtRestOptions(DomainStatusEncryptionAtRestOptions encryptionAtRestOptions) {
  ...
  public CreateDomainResponseDomainStatus nodeToNodeEncryptionOptions(DomainStatusNodeToNodeEncryptionOptions nodeToNodeEncryptionOptions) {
  ...
  public CreateDomainResponseDomainStatus advancedOptions(Map advancedOptions) {
  ...
  public CreateDomainResponseDomainStatus logPublishingOptions(Map logPublishingOptions) {
  ...
  public CreateDomainResponseDomainStatus serviceSoftwareOptions(DomainStatusServiceSoftwareOptions serviceSoftwareOptions) {
  ...
  public CreateDomainResponseDomainStatus domainEndpointOptions(CreateDomainRequestDomainEndpointOptions domainEndpointOptions) {
  ...
  public CreateDomainResponseDomainStatus advancedSecurityOptions(DomainStatusAdvancedSecurityOptions advancedSecurityOptions) {
  ...
  public CreateDomainResponseDomainStatus autoTuneOptions(DomainStatusAutoTuneOptions autoTuneOptions) {
  ...
  public CreateDomainResponseDomainStatus changeProgressDetails(DomainStatusChangeProgressDetails changeProgressDetails) {
  ...
  public CreateDomainResponseDomainStatus offPeakWindowOptions(DomainStatusOffPeakWindowOptions offPeakWindowOptions) {
  ...
  public CreateDomainResponseDomainStatus softwareUpdateOptions(DomainStatusSoftwareUpdateOptions softwareUpdateOptions) {
  ...
  public boolean equals(Object o) {
    ...
    CreateDomainResponseDomainStatus createDomainResponseDomainStatus = (CreateDomainResponseDomainStatus) o;
    return Objects.equals(this.domainId, createDomainResponseDomainStatus.domainId) &&
        Objects.equals(this.domainName, createDomainResponseDomainStatus.domainName) &&
        Objects.equals(this.ARN, createDomainResponseDomainStatus.ARN) &&
        Objects.equals(this.created, createDomainResponseDomainStatus.created) &&
        Objects.equals(this.deleted, createDomainResponseDomainStatus.deleted) &&
        Objects.equals(this.endpoint, createDomainResponseDomainStatus.endpoint) &&
        Objects.equals(this.endpoints, createDomainResponseDomainStatus.endpoints) &&
        Objects.equals(this.processing, createDomainResponseDomainStatus.processing) &&
        Objects.equals(this.upgradeProcessing, createDomainResponseDomainStatus.upgradeProcessing) &&
        Objects.equals(this.engineVersion, createDomainResponseDomainStatus.engineVersion) &&
        Objects.equals(this.clusterConfig, createDomainResponseDomainStatus.clusterConfig) &&
        Objects.equals(this.ebSOptions, createDomainResponseDomainStatus.ebSOptions) &&
        Objects.equals(this.accessPolicies, createDomainResponseDomainStatus.accessPolicies) &&
        Objects.equals(this.snapshotOptions, createDomainResponseDomainStatus.snapshotOptions) &&
        Objects.equals(this.vpCOptions, createDomainResponseDomainStatus.vpCOptions) &&
        Objects.equals(this.cognitoOptions, createDomainResponseDomainStatus.cognitoOptions) &&
        Objects.equals(this.encryptionAtRestOptions, createDomainResponseDomainStatus.encryptionAtRestOptions) &&
        Objects.equals(this.nodeToNodeEncryptionOptions, createDomainResponseDomainStatus.nodeToNodeEncryptionOptions) &&
        Objects.equals(this.advancedOptions, createDomainResponseDomainStatus.advancedOptions) &&
        Objects.equals(this.logPublishingOptions, createDomainResponseDomainStatus.logPublishingOptions) &&
        Objects.equals(this.serviceSoftwareOptions, createDomainResponseDomainStatus.serviceSoftwareOptions) &&
        Objects.equals(this.domainEndpointOptions, createDomainResponseDomainStatus.domainEndpointOptions) &&
        Objects.equals(this.advancedSecurityOptions, createDomainResponseDomainStatus.advancedSecurityOptions) &&
        Objects.equals(this.autoTuneOptions, createDomainResponseDomainStatus.autoTuneOptions) &&
        Objects.equals(this.changeProgressDetails, createDomainResponseDomainStatus.changeProgressDetails) &&
        Objects.equals(this.offPeakWindowOptions, createDomainResponseDomainStatus.offPeakWindowOptions) &&
        Objects.equals(this.softwareUpdateOptions, createDomainResponseDomainStatus.softwareUpdateOptions);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateDomainResponseDomainStatus {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateDomainResponseDomainStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateDomainResponseDomainStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateDomainResponseDomainStatus is not found in the empty JSON string", CreateDomainResponseDomainStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateDomainResponseDomainStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateDomainResponseDomainStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateDomainResponseDomainStatus.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateDomainResponseDomainStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateDomainResponseDomainStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateDomainResponseDomainStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateDomainResponseDomainStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateDomainResponseDomainStatus>() {
           @Override
           public void write(JsonWriter out, CreateDomainResponseDomainStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateDomainResponseDomainStatus read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateDomainResponseDomainStatus given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateDomainResponseDomainStatus
   * @throws IOException if the JSON string is invalid with respect to CreateDomainResponseDomainStatus
   */
  public static CreateDomainResponseDomainStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateDomainResponseDomainStatus.class);
  }

  /**
   * Convert an instance of CreateDomainResponseDomainStatus to an JSON string
   *
   * @return JSON string
   */
