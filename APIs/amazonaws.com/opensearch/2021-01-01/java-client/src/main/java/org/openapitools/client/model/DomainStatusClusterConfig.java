...
public class DomainStatusClusterConfig {
  ...
  public DomainStatusClusterConfig() {
  }

  public DomainStatusClusterConfig instanceType(OpenSearchPartitionInstanceType instanceType) {
  ...
  public DomainStatusClusterConfig instanceCount(Integer instanceCount) {
  ...
  public DomainStatusClusterConfig dedicatedMasterEnabled(Boolean dedicatedMasterEnabled) {
  ...
  public DomainStatusClusterConfig zoneAwarenessEnabled(Boolean zoneAwarenessEnabled) {
  ...
  public DomainStatusClusterConfig zoneAwarenessConfig(CreateDomainRequestClusterConfigZoneAwarenessConfig zoneAwarenessConfig) {
  ...
  public DomainStatusClusterConfig dedicatedMasterType(OpenSearchPartitionInstanceType dedicatedMasterType) {
  ...
  public DomainStatusClusterConfig dedicatedMasterCount(Integer dedicatedMasterCount) {
  ...
  public DomainStatusClusterConfig warmEnabled(Boolean warmEnabled) {
  ...
  public DomainStatusClusterConfig warmType(OpenSearchWarmPartitionInstanceType warmType) {
  ...
  public DomainStatusClusterConfig warmCount(Integer warmCount) {
  ...
  public DomainStatusClusterConfig coldStorageOptions(CreateDomainRequestClusterConfigColdStorageOptions coldStorageOptions) {
  ...
  public DomainStatusClusterConfig multiAZWithStandbyEnabled(Boolean multiAZWithStandbyEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    DomainStatusClusterConfig domainStatusClusterConfig = (DomainStatusClusterConfig) o;
    return Objects.equals(this.instanceType, domainStatusClusterConfig.instanceType) &&
        Objects.equals(this.instanceCount, domainStatusClusterConfig.instanceCount) &&
        Objects.equals(this.dedicatedMasterEnabled, domainStatusClusterConfig.dedicatedMasterEnabled) &&
        Objects.equals(this.zoneAwarenessEnabled, domainStatusClusterConfig.zoneAwarenessEnabled) &&
        Objects.equals(this.zoneAwarenessConfig, domainStatusClusterConfig.zoneAwarenessConfig) &&
        Objects.equals(this.dedicatedMasterType, domainStatusClusterConfig.dedicatedMasterType) &&
        Objects.equals(this.dedicatedMasterCount, domainStatusClusterConfig.dedicatedMasterCount) &&
        Objects.equals(this.warmEnabled, domainStatusClusterConfig.warmEnabled) &&
        Objects.equals(this.warmType, domainStatusClusterConfig.warmType) &&
        Objects.equals(this.warmCount, domainStatusClusterConfig.warmCount) &&
        Objects.equals(this.coldStorageOptions, domainStatusClusterConfig.coldStorageOptions) &&
        Objects.equals(this.multiAZWithStandbyEnabled, domainStatusClusterConfig.multiAZWithStandbyEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class DomainStatusClusterConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DomainStatusClusterConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DomainStatusClusterConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DomainStatusClusterConfig is not found in the empty JSON string", DomainStatusClusterConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DomainStatusClusterConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DomainStatusClusterConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DomainStatusClusterConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DomainStatusClusterConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DomainStatusClusterConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DomainStatusClusterConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<DomainStatusClusterConfig>() {
           @Override
           public void write(JsonWriter out, DomainStatusClusterConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DomainStatusClusterConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DomainStatusClusterConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DomainStatusClusterConfig
   * @throws IOException if the JSON string is invalid with respect to DomainStatusClusterConfig
   */
  public static DomainStatusClusterConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DomainStatusClusterConfig.class);
  }

  /**
   * Convert an instance of DomainStatusClusterConfig to an JSON string
   *
   * @return JSON string
   */
