...
public class ReservedInstance {
  ...
  public static final String SERIALIZED_NAME_BILLING_SUBSCRIPTION_ID = "BillingSubscriptionId";
  @SerializedName(SERIALIZED_NAME_BILLING_SUBSCRIPTION_ID)
  private Integer billingSubscriptionId;
  ...
  public ReservedInstance reservationName(String reservationName) {
  ...
  public ReservedInstance reservedInstanceId(String reservedInstanceId) {
  ...
  public ReservedInstance billingSubscriptionId(Integer billingSubscriptionId) {
    this.billingSubscriptionId = billingSubscriptionId;
    return this;
  }

  /**
   * Get billingSubscriptionId
   * @return billingSubscriptionId
   */
  @javax.annotation.Nullable
  public Integer getBillingSubscriptionId() {
    return billingSubscriptionId;
  }

  public void setBillingSubscriptionId(Integer billingSubscriptionId) {
    this.billingSubscriptionId = billingSubscriptionId;
  }


  public ReservedInstance reservedInstanceOfferingId(String reservedInstanceOfferingId) {
  ...
  public ReservedInstance instanceType(OpenSearchPartitionInstanceType instanceType) {
  ...
  public ReservedInstance startTime(OffsetDateTime startTime) {
  ...
  public ReservedInstance duration(Integer duration) {
  ...
  public ReservedInstance fixedPrice(Double fixedPrice) {
  ...
  public ReservedInstance usagePrice(Double usagePrice) {
  ...
  public ReservedInstance currencyCode(String currencyCode) {
  ...
  public ReservedInstance instanceCount(Integer instanceCount) {
  ...
  public ReservedInstance state(String state) {
    this.state = state;
    return this;
  }
  ...
  public ReservedInstance paymentOption(ReservedInstancePaymentOption paymentOption) {
  ...
  public ReservedInstance recurringCharges(List recurringCharges) {
  ...
  public boolean equals(Object o) {
    ...
    ReservedInstance reservedInstance = (ReservedInstance) o;
    return Objects.equals(this.reservationName, reservedInstance.reservationName) &&
        Objects.equals(this.reservedInstanceId, reservedInstance.reservedInstanceId) &&
        Objects.equals(this.billingSubscriptionId, reservedInstance.billingSubscriptionId) &&
        Objects.equals(this.reservedInstanceOfferingId, reservedInstance.reservedInstanceOfferingId) &&
        Objects.equals(this.instanceType, reservedInstance.instanceType) &&
        Objects.equals(this.startTime, reservedInstance.startTime) &&
        Objects.equals(this.duration, reservedInstance.duration) &&
        Objects.equals(this.fixedPrice, reservedInstance.fixedPrice) &&
        Objects.equals(this.usagePrice, reservedInstance.usagePrice) &&
        Objects.equals(this.currencyCode, reservedInstance.currencyCode) &&
        Objects.equals(this.instanceCount, reservedInstance.instanceCount) &&
        Objects.equals(this.state, reservedInstance.state) &&
        Objects.equals(this.paymentOption, reservedInstance.paymentOption) &&
        Objects.equals(this.recurringCharges, reservedInstance.recurringCharges);
  }

  @Override
  public int hashCode() {
    return Objects.hash(reservationName, reservedInstanceId, billingSubscriptionId, reservedInstanceOfferingId, instanceType, startTime, duration, fixedPrice, usagePrice, currencyCode, instanceCount, state, paymentOption, recurringCharges);
  }
  ...
  public String toString() {
    ...
    sb.append("    billingSubscriptionId: ").append(toIndentedString(billingSubscriptionId)).append("\n");
  ...
  static {
    ...
    openapiFields.add("BillingSubscriptionId");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReservedInstance
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReservedInstance.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReservedInstance is not found in the empty JSON string", ReservedInstance.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReservedInstance.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReservedInstance` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("BillingSubscriptionId") != null && !jsonObj.get("BillingSubscriptionId").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("BillingSubscriptionId"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReservedInstance.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReservedInstance' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReservedInstance> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReservedInstance.class));

       return (TypeAdapter<T>) new TypeAdapter<ReservedInstance>() {
           @Override
           public void write(JsonWriter out, ReservedInstance value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReservedInstance read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReservedInstance given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReservedInstance
   * @throws IOException if the JSON string is invalid with respect to ReservedInstance
   */
  public static ReservedInstance fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReservedInstance.class);
  }

  /**
   * Convert an instance of ReservedInstance to an JSON string
   *
   * @return JSON string
   */
