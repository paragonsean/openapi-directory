...
public class DescribeDomainResponseDomainStatus {
  ...
  private DomainStatusEncryptionAtRestOptions encryptionAtRestOptions;
  ...
  private DomainStatusNodeToNodeEncryptionOptions nodeToNodeEncryptionOptions;
  ...
  private DomainStatusServiceSoftwareOptions serviceSoftwareOptions;
  ...
  private DomainStatusAdvancedSecurityOptions advancedSecurityOptions;
  ...
  private DomainStatusAutoTuneOptions autoTuneOptions;
  ...
  private DomainStatusChangeProgressDetails changeProgressDetails;
  ...
  private DomainStatusOffPeakWindowOptions offPeakWindowOptions;
  ...
  private DomainStatusSoftwareUpdateOptions softwareUpdateOptions;

  public DescribeDomainResponseDomainStatus() {
  }

  public DescribeDomainResponseDomainStatus domainId(String domainId) {
  ...
  public DescribeDomainResponseDomainStatus domainName(String domainName) {
  ...
  public DescribeDomainResponseDomainStatus ARN(String ARN) {
    this.ARN = ARN;
    return this;
  }
  ...
  public DescribeDomainResponseDomainStatus created(Boolean created) {
  ...
  public DescribeDomainResponseDomainStatus deleted(Boolean deleted) {
  ...
  public DescribeDomainResponseDomainStatus endpoint(String endpoint) {
  ...
  public DescribeDomainResponseDomainStatus endpoints(Map endpoints) {
  ...
  public DescribeDomainResponseDomainStatus processing(Boolean processing) {
  ...
  public DescribeDomainResponseDomainStatus upgradeProcessing(Boolean upgradeProcessing) {
  ...
  public DescribeDomainResponseDomainStatus engineVersion(String engineVersion) {
  ...
  public DescribeDomainResponseDomainStatus clusterConfig(DomainStatusClusterConfig clusterConfig) {
   ...
   */
  @javax.annotation.Nonnull
  public DomainStatusClusterConfig getClusterConfig() {
    return clusterConfig;
  }

  public void setClusterConfig(DomainStatusClusterConfig clusterConfig) {
    this.clusterConfig = clusterConfig;
  }


  public DescribeDomainResponseDomainStatus ebSOptions(DomainStatusEBSOptions ebSOptions) {
   ...
   */
  @javax.annotation.Nullable
  public DomainStatusEBSOptions getEbSOptions() {
    return ebSOptions;
  }

  public void setEbSOptions(DomainStatusEBSOptions ebSOptions) {
    this.ebSOptions = ebSOptions;
  }


  public DescribeDomainResponseDomainStatus accessPolicies(String accessPolicies) {
  ...
  public DescribeDomainResponseDomainStatus snapshotOptions(DomainStatusSnapshotOptions snapshotOptions) {
   ...
   */
  @javax.annotation.Nullable
  public DomainStatusSnapshotOptions getSnapshotOptions() {
    return snapshotOptions;
  }

  public void setSnapshotOptions(DomainStatusSnapshotOptions snapshotOptions) {
    this.snapshotOptions = snapshotOptions;
  }


  public DescribeDomainResponseDomainStatus vpCOptions(DomainStatusVPCOptions vpCOptions) {
   ...
   */
  @javax.annotation.Nullable
  public DomainStatusVPCOptions getVpCOptions() {
    return vpCOptions;
  }

  public void setVpCOptions(DomainStatusVPCOptions vpCOptions) {
    this.vpCOptions = vpCOptions;
  }


  public DescribeDomainResponseDomainStatus cognitoOptions(DomainStatusCognitoOptions cognitoOptions) {
   ...
   */
  @javax.annotation.Nullable
  public DomainStatusCognitoOptions getCognitoOptions() {
    return cognitoOptions;
  }

  public void setCognitoOptions(DomainStatusCognitoOptions cognitoOptions) {
    this.cognitoOptions = cognitoOptions;
  }


  public DescribeDomainResponseDomainStatus encryptionAtRestOptions(DomainStatusEncryptionAtRestOptions encryptionAtRestOptions) {
   ...
   */
  @javax.annotation.Nullable
  public DomainStatusEncryptionAtRestOptions getEncryptionAtRestOptions() {
    return encryptionAtRestOptions;
  }

  public void setEncryptionAtRestOptions(DomainStatusEncryptionAtRestOptions encryptionAtRestOptions) {
    this.encryptionAtRestOptions = encryptionAtRestOptions;
  }


  public DescribeDomainResponseDomainStatus nodeToNodeEncryptionOptions(DomainStatusNodeToNodeEncryptionOptions nodeToNodeEncryptionOptions) {
   ...
   */
  @javax.annotation.Nullable
  public DomainStatusNodeToNodeEncryptionOptions getNodeToNodeEncryptionOptions() {
    return nodeToNodeEncryptionOptions;
  }

  public void setNodeToNodeEncryptionOptions(DomainStatusNodeToNodeEncryptionOptions nodeToNodeEncryptionOptions) {
    this.nodeToNodeEncryptionOptions = nodeToNodeEncryptionOptions;
  }


  public DescribeDomainResponseDomainStatus advancedOptions(Map advancedOptions) {
  ...
  public DescribeDomainResponseDomainStatus logPublishingOptions(Map logPublishingOptions) {
  ...
  public DescribeDomainResponseDomainStatus serviceSoftwareOptions(DomainStatusServiceSoftwareOptions serviceSoftwareOptions) {
   ...
   */
  @javax.annotation.Nullable
  public DomainStatusServiceSoftwareOptions getServiceSoftwareOptions() {
    return serviceSoftwareOptions;
  }

  public void setServiceSoftwareOptions(DomainStatusServiceSoftwareOptions serviceSoftwareOptions) {
    this.serviceSoftwareOptions = serviceSoftwareOptions;
  }


  public DescribeDomainResponseDomainStatus domainEndpointOptions(CreateDomainRequestDomainEndpointOptions domainEndpointOptions) {
  ...
  public DescribeDomainResponseDomainStatus advancedSecurityOptions(DomainStatusAdvancedSecurityOptions advancedSecurityOptions) {
   ...
   */
  @javax.annotation.Nullable
  public DomainStatusAdvancedSecurityOptions getAdvancedSecurityOptions() {
    return advancedSecurityOptions;
  }

  public void setAdvancedSecurityOptions(DomainStatusAdvancedSecurityOptions advancedSecurityOptions) {
    this.advancedSecurityOptions = advancedSecurityOptions;
  }


  public DescribeDomainResponseDomainStatus autoTuneOptions(DomainStatusAutoTuneOptions autoTuneOptions) {
   ...
   */
  @javax.annotation.Nullable
  public DomainStatusAutoTuneOptions getAutoTuneOptions() {
    return autoTuneOptions;
  }

  public void setAutoTuneOptions(DomainStatusAutoTuneOptions autoTuneOptions) {
    this.autoTuneOptions = autoTuneOptions;
  }


  public DescribeDomainResponseDomainStatus changeProgressDetails(DomainStatusChangeProgressDetails changeProgressDetails) {
   ...
   */
  @javax.annotation.Nullable
  public DomainStatusChangeProgressDetails getChangeProgressDetails() {
    return changeProgressDetails;
  }

  public void setChangeProgressDetails(DomainStatusChangeProgressDetails changeProgressDetails) {
    this.changeProgressDetails = changeProgressDetails;
  }


  public DescribeDomainResponseDomainStatus offPeakWindowOptions(DomainStatusOffPeakWindowOptions offPeakWindowOptions) {
   ...
   */
  @javax.annotation.Nullable
  public DomainStatusOffPeakWindowOptions getOffPeakWindowOptions() {
    return offPeakWindowOptions;
  }

  public void setOffPeakWindowOptions(DomainStatusOffPeakWindowOptions offPeakWindowOptions) {
    this.offPeakWindowOptions = offPeakWindowOptions;
  }


  public DescribeDomainResponseDomainStatus softwareUpdateOptions(DomainStatusSoftwareUpdateOptions softwareUpdateOptions) {
   ...
   */
  @javax.annotation.Nullable
  public DomainStatusSoftwareUpdateOptions getSoftwareUpdateOptions() {
    return softwareUpdateOptions;
  }

  public void setSoftwareUpdateOptions(DomainStatusSoftwareUpdateOptions softwareUpdateOptions) {
    this.softwareUpdateOptions = softwareUpdateOptions;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeDomainResponseDomainStatus describeDomainResponseDomainStatus = (DescribeDomainResponseDomainStatus) o;
    return Objects.equals(this.domainId, describeDomainResponseDomainStatus.domainId) &&
        Objects.equals(this.domainName, describeDomainResponseDomainStatus.domainName) &&
        Objects.equals(this.ARN, describeDomainResponseDomainStatus.ARN) &&
        Objects.equals(this.created, describeDomainResponseDomainStatus.created) &&
        Objects.equals(this.deleted, describeDomainResponseDomainStatus.deleted) &&
        Objects.equals(this.endpoint, describeDomainResponseDomainStatus.endpoint) &&
        Objects.equals(this.endpoints, describeDomainResponseDomainStatus.endpoints) &&
        Objects.equals(this.processing, describeDomainResponseDomainStatus.processing) &&
        Objects.equals(this.upgradeProcessing, describeDomainResponseDomainStatus.upgradeProcessing) &&
        Objects.equals(this.engineVersion, describeDomainResponseDomainStatus.engineVersion) &&
        Objects.equals(this.clusterConfig, describeDomainResponseDomainStatus.clusterConfig) &&
        Objects.equals(this.ebSOptions, describeDomainResponseDomainStatus.ebSOptions) &&
        Objects.equals(this.accessPolicies, describeDomainResponseDomainStatus.accessPolicies) &&
        Objects.equals(this.snapshotOptions, describeDomainResponseDomainStatus.snapshotOptions) &&
        Objects.equals(this.vpCOptions, describeDomainResponseDomainStatus.vpCOptions) &&
        Objects.equals(this.cognitoOptions, describeDomainResponseDomainStatus.cognitoOptions) &&
        Objects.equals(this.encryptionAtRestOptions, describeDomainResponseDomainStatus.encryptionAtRestOptions) &&
        Objects.equals(this.nodeToNodeEncryptionOptions, describeDomainResponseDomainStatus.nodeToNodeEncryptionOptions) &&
        Objects.equals(this.advancedOptions, describeDomainResponseDomainStatus.advancedOptions) &&
        Objects.equals(this.logPublishingOptions, describeDomainResponseDomainStatus.logPublishingOptions) &&
        Objects.equals(this.serviceSoftwareOptions, describeDomainResponseDomainStatus.serviceSoftwareOptions) &&
        Objects.equals(this.domainEndpointOptions, describeDomainResponseDomainStatus.domainEndpointOptions) &&
        Objects.equals(this.advancedSecurityOptions, describeDomainResponseDomainStatus.advancedSecurityOptions) &&
        Objects.equals(this.autoTuneOptions, describeDomainResponseDomainStatus.autoTuneOptions) &&
        Objects.equals(this.changeProgressDetails, describeDomainResponseDomainStatus.changeProgressDetails) &&
        Objects.equals(this.offPeakWindowOptions, describeDomainResponseDomainStatus.offPeakWindowOptions) &&
        Objects.equals(this.softwareUpdateOptions, describeDomainResponseDomainStatus.softwareUpdateOptions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domainId, domainName, ARN, created, deleted, endpoint, endpoints, processing, upgradeProcessing, engineVersion, clusterConfig, ebSOptions, accessPolicies, snapshotOptions, vpCOptions, cognitoOptions, encryptionAtRestOptions, nodeToNodeEncryptionOptions, advancedOptions, logPublishingOptions, serviceSoftwareOptions, domainEndpointOptions, advancedSecurityOptions, autoTuneOptions, changeProgressDetails, offPeakWindowOptions, softwareUpdateOptions);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeDomainResponseDomainStatus {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeDomainResponseDomainStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeDomainResponseDomainStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeDomainResponseDomainStatus is not found in the empty JSON string", DescribeDomainResponseDomainStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeDomainResponseDomainStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeDomainResponseDomainStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeDomainResponseDomainStatus.openapiRequiredFields) {
      ...
      // validate the required field `ClusterConfig`
      DomainStatusClusterConfig.validateJsonElement(jsonObj.get("ClusterConfig"));
      // validate the optional field `EBSOptions`
      if (jsonObj.get("EBSOptions") != null && !jsonObj.get("EBSOptions").isJsonNull()) {
        DomainStatusEBSOptions.validateJsonElement(jsonObj.get("EBSOptions"));
      }
      ...
      if (jsonObj.get("EncryptionAtRestOptions") != null && !jsonObj.get("EncryptionAtRestOptions").isJsonNull()) {
        DomainStatusEncryptionAtRestOptions.validateJsonElement(jsonObj.get("EncryptionAtRestOptions"));
      }
      ...
      if (jsonObj.get("NodeToNodeEncryptionOptions") != null && !jsonObj.get("NodeToNodeEncryptionOptions").isJsonNull()) {
        DomainStatusNodeToNodeEncryptionOptions.validateJsonElement(jsonObj.get("NodeToNodeEncryptionOptions"));
      }
      ...
      if (jsonObj.get("ServiceSoftwareOptions") != null && !jsonObj.get("ServiceSoftwareOptions").isJsonNull()) {
        DomainStatusServiceSoftwareOptions.validateJsonElement(jsonObj.get("ServiceSoftwareOptions"));
      }
      ...
      if (jsonObj.get("AdvancedSecurityOptions") != null && !jsonObj.get("AdvancedSecurityOptions").isJsonNull()) {
        DomainStatusAdvancedSecurityOptions.validateJsonElement(jsonObj.get("AdvancedSecurityOptions"));
      }
      // validate the optional field `AutoTuneOptions`
      if (jsonObj.get("AutoTuneOptions") != null && !jsonObj.get("AutoTuneOptions").isJsonNull()) {
        DomainStatusAutoTuneOptions.validateJsonElement(jsonObj.get("AutoTuneOptions"));
      }
      ...
      if (jsonObj.get("ChangeProgressDetails") != null && !jsonObj.get("ChangeProgressDetails").isJsonNull()) {
        DomainStatusChangeProgressDetails.validateJsonElement(jsonObj.get("ChangeProgressDetails"));
      }
      ...
      if (jsonObj.get("OffPeakWindowOptions") != null && !jsonObj.get("OffPeakWindowOptions").isJsonNull()) {
        DomainStatusOffPeakWindowOptions.validateJsonElement(jsonObj.get("OffPeakWindowOptions"));
      }
      ...
      if (jsonObj.get("SoftwareUpdateOptions") != null && !jsonObj.get("SoftwareUpdateOptions").isJsonNull()) {
        DomainStatusSoftwareUpdateOptions.validateJsonElement(jsonObj.get("SoftwareUpdateOptions"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeDomainResponseDomainStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeDomainResponseDomainStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeDomainResponseDomainStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeDomainResponseDomainStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeDomainResponseDomainStatus>() {
           @Override
           public void write(JsonWriter out, DescribeDomainResponseDomainStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeDomainResponseDomainStatus read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeDomainResponseDomainStatus given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeDomainResponseDomainStatus
   * @throws IOException if the JSON string is invalid with respect to DescribeDomainResponseDomainStatus
   */
  public static DescribeDomainResponseDomainStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeDomainResponseDomainStatus.class);
  }

  /**
   * Convert an instance of DescribeDomainResponseDomainStatus to an JSON string
   *
   * @return JSON string
   */
