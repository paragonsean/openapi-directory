...
public class InboundConnection {
  ...
  public InboundConnection localDomainInfo(CreateOutboundConnectionResponseLocalDomainInfo localDomainInfo) {
  ...
  public InboundConnection remoteDomainInfo(CreateOutboundConnectionResponseRemoteDomainInfo remoteDomainInfo) {
  ...
  public InboundConnection connectionId(String connectionId) {
  ...
  public InboundConnection connectionStatus(InboundConnectionConnectionStatus connectionStatus) {
  ...
  public InboundConnection connectionMode(ConnectionMode connectionMode) {
  ...
  public boolean equals(Object o) {
    ...
    InboundConnection inboundConnection = (InboundConnection) o;
    return Objects.equals(this.localDomainInfo, inboundConnection.localDomainInfo) &&
        Objects.equals(this.remoteDomainInfo, inboundConnection.remoteDomainInfo) &&
        Objects.equals(this.connectionId, inboundConnection.connectionId) &&
        Objects.equals(this.connectionStatus, inboundConnection.connectionStatus) &&
        Objects.equals(this.connectionMode, inboundConnection.connectionMode);
  }
  ...
  public String toString() {
    ...
    sb.append("class InboundConnection {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InboundConnection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InboundConnection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InboundConnection is not found in the empty JSON string", InboundConnection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InboundConnection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InboundConnection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InboundConnection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InboundConnection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InboundConnection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InboundConnection.class));

       return (TypeAdapter<T>) new TypeAdapter<InboundConnection>() {
           @Override
           public void write(JsonWriter out, InboundConnection value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InboundConnection read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InboundConnection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InboundConnection
   * @throws IOException if the JSON string is invalid with respect to InboundConnection
   */
  public static InboundConnection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InboundConnection.class);
  }

  /**
   * Convert an instance of InboundConnection to an JSON string
   *
   * @return JSON string
   */
