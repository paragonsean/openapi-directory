...
public class CreateDomainRequestClusterConfig {
  ...
  public CreateDomainRequestClusterConfig() {
  }

  public CreateDomainRequestClusterConfig instanceType(OpenSearchPartitionInstanceType instanceType) {
  ...
  public CreateDomainRequestClusterConfig instanceCount(Integer instanceCount) {
  ...
  public CreateDomainRequestClusterConfig dedicatedMasterEnabled(Boolean dedicatedMasterEnabled) {
  ...
  public CreateDomainRequestClusterConfig zoneAwarenessEnabled(Boolean zoneAwarenessEnabled) {
  ...
  public CreateDomainRequestClusterConfig zoneAwarenessConfig(CreateDomainRequestClusterConfigZoneAwarenessConfig zoneAwarenessConfig) {
  ...
  public CreateDomainRequestClusterConfig dedicatedMasterType(OpenSearchPartitionInstanceType dedicatedMasterType) {
  ...
  public CreateDomainRequestClusterConfig dedicatedMasterCount(Integer dedicatedMasterCount) {
  ...
  public CreateDomainRequestClusterConfig warmEnabled(Boolean warmEnabled) {
  ...
  public CreateDomainRequestClusterConfig warmType(OpenSearchWarmPartitionInstanceType warmType) {
  ...
  public CreateDomainRequestClusterConfig warmCount(Integer warmCount) {
  ...
  public CreateDomainRequestClusterConfig coldStorageOptions(CreateDomainRequestClusterConfigColdStorageOptions coldStorageOptions) {
  ...
  public CreateDomainRequestClusterConfig multiAZWithStandbyEnabled(Boolean multiAZWithStandbyEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    CreateDomainRequestClusterConfig createDomainRequestClusterConfig = (CreateDomainRequestClusterConfig) o;
    return Objects.equals(this.instanceType, createDomainRequestClusterConfig.instanceType) &&
        Objects.equals(this.instanceCount, createDomainRequestClusterConfig.instanceCount) &&
        Objects.equals(this.dedicatedMasterEnabled, createDomainRequestClusterConfig.dedicatedMasterEnabled) &&
        Objects.equals(this.zoneAwarenessEnabled, createDomainRequestClusterConfig.zoneAwarenessEnabled) &&
        Objects.equals(this.zoneAwarenessConfig, createDomainRequestClusterConfig.zoneAwarenessConfig) &&
        Objects.equals(this.dedicatedMasterType, createDomainRequestClusterConfig.dedicatedMasterType) &&
        Objects.equals(this.dedicatedMasterCount, createDomainRequestClusterConfig.dedicatedMasterCount) &&
        Objects.equals(this.warmEnabled, createDomainRequestClusterConfig.warmEnabled) &&
        Objects.equals(this.warmType, createDomainRequestClusterConfig.warmType) &&
        Objects.equals(this.warmCount, createDomainRequestClusterConfig.warmCount) &&
        Objects.equals(this.coldStorageOptions, createDomainRequestClusterConfig.coldStorageOptions) &&
        Objects.equals(this.multiAZWithStandbyEnabled, createDomainRequestClusterConfig.multiAZWithStandbyEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateDomainRequestClusterConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateDomainRequestClusterConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateDomainRequestClusterConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateDomainRequestClusterConfig is not found in the empty JSON string", CreateDomainRequestClusterConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateDomainRequestClusterConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateDomainRequestClusterConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateDomainRequestClusterConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateDomainRequestClusterConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateDomainRequestClusterConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateDomainRequestClusterConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateDomainRequestClusterConfig>() {
           @Override
           public void write(JsonWriter out, CreateDomainRequestClusterConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateDomainRequestClusterConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateDomainRequestClusterConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateDomainRequestClusterConfig
   * @throws IOException if the JSON string is invalid with respect to CreateDomainRequestClusterConfig
   */
  public static CreateDomainRequestClusterConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateDomainRequestClusterConfig.class);
  }

  /**
   * Convert an instance of CreateDomainRequestClusterConfig to an JSON string
   *
   * @return JSON string
   */
