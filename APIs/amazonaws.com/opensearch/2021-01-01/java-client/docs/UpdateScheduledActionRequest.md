...
|**desiredStartTime** | **Integer** | The time to implement the change, in Coordinated Universal Time (UTC). Only specify this parameter if you set &lt;code&gt;ScheduleAt&lt;/code&gt; to &lt;code&gt;TIMESTAMP&lt;/code&gt;. |  [optional] |
