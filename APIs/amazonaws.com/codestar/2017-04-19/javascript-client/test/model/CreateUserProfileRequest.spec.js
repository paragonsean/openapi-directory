...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.CreateUserProfileRequest();
  });
  ...
  describe('CreateUserProfileRequest', function() {
    it('should create an instance of CreateUserProfileRequest', function() {
      // uncomment below and update the code to test CreateUserProfileRequest
      //var instance = new AwsCodeStar.CreateUserProfileRequest();
      //expect(instance).to.be.a(AwsCodeStar.CreateUserProfileRequest);
    });
