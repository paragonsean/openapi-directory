...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.CreateProjectResult();
  });
  ...
  describe('CreateProjectResult', function() {
    it('should create an instance of CreateProjectResult', function() {
      // uncomment below and update the code to test CreateProjectResult
      //var instance = new AwsCodeStar.CreateProjectResult();
      //expect(instance).to.be.a(AwsCodeStar.CreateProjectResult);
    });
