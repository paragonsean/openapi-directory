...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.CodeDestinationGitHub();
  });
  ...
  describe('CodeDestinationGitHub', function() {
    it('should create an instance of CodeDestinationGitHub', function() {
      // uncomment below and update the code to test CodeDestinationGitHub
      //var instance = new AwsCodeStar.CodeDestinationGitHub();
      //expect(instance).to.be.a(AwsCodeStar.CodeDestinationGitHub);
    });
