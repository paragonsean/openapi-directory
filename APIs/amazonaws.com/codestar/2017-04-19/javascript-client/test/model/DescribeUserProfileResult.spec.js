...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.DescribeUserProfileResult();
  });
  ...
  describe('DescribeUserProfileResult', function() {
    it('should create an instance of DescribeUserProfileResult', function() {
      // uncomment below and update the code to test DescribeUserProfileResult
      //var instance = new AwsCodeStar.DescribeUserProfileResult();
      //expect(instance).to.be.a(AwsCodeStar.DescribeUserProfileResult);
    });
