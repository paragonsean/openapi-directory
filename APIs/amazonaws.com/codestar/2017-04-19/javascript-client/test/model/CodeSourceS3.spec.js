...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.CodeSourceS3();
  });
  ...
  describe('CodeSourceS3', function() {
    it('should create an instance of CodeSourceS3', function() {
      // uncomment below and update the code to test CodeSourceS3
      //var instance = new AwsCodeStar.CodeSourceS3();
      //expect(instance).to.be.a(AwsCodeStar.CodeSourceS3);
    });
