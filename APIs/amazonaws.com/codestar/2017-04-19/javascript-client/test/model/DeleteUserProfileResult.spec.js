...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.DeleteUserProfileResult();
  });
  ...
  describe('DeleteUserProfileResult', function() {
    it('should create an instance of DeleteUserProfileResult', function() {
      // uncomment below and update the code to test DeleteUserProfileResult
      //var instance = new AwsCodeStar.DeleteUserProfileResult();
      //expect(instance).to.be.a(AwsCodeStar.DeleteUserProfileResult);
    });
