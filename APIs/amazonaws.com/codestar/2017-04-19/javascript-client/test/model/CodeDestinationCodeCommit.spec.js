...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.CodeDestinationCodeCommit();
  });
  ...
  describe('CodeDestinationCodeCommit', function() {
    it('should create an instance of CodeDestinationCodeCommit', function() {
      // uncomment below and update the code to test CodeDestinationCodeCommit
      //var instance = new AwsCodeStar.CodeDestinationCodeCommit();
      //expect(instance).to.be.a(AwsCodeStar.CodeDestinationCodeCommit);
    });
