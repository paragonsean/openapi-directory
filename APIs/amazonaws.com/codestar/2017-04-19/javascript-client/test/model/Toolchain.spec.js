...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.Toolchain();
  });
  ...
  describe('Toolchain', function() {
    it('should create an instance of Toolchain', function() {
      // uncomment below and update the code to test Toolchain
      //var instance = new AwsCodeStar.Toolchain();
      //expect(instance).to.be.a(AwsCodeStar.Toolchain);
    });
