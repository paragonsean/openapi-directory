...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.DeleteProjectRequest();
  });
  ...
  describe('DeleteProjectRequest', function() {
    it('should create an instance of DeleteProjectRequest', function() {
      // uncomment below and update the code to test DeleteProjectRequest
      //var instance = new AwsCodeStar.DeleteProjectRequest();
      //expect(instance).to.be.a(AwsCodeStar.DeleteProjectRequest);
    });
    ...
    it('should have the property deleteStack (base name: "deleteStack")', function() {
      // uncomment below and update the code to test the property deleteStack
      //var instance = new AwsCodeStar.DeleteProjectRequest();
      //expect(instance).to.be();
    });
