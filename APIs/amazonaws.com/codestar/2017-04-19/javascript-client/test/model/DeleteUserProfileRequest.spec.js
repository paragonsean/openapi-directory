...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.DeleteUserProfileRequest();
  });
  ...
  describe('DeleteUserProfileRequest', function() {
    it('should create an instance of DeleteUserProfileRequest', function() {
      ...
      //var instance = new AwsCodeStar.DeleteUserProfileRequest();
      //expect(instance).to.be.a(AwsCodeStar.DeleteUserProfileRequest);
    });
