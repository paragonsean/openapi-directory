...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.DescribeProjectResult();
  });
  ...
  describe('DescribeProjectResult', function() {
    it('should create an instance of DescribeProjectResult', function() {
      // uncomment below and update the code to test DescribeProjectResult
      //var instance = new AwsCodeStar.DescribeProjectResult();
      //expect(instance).to.be.a(AwsCodeStar.DescribeProjectResult);
    });
    ...
    it('should have the property projectTemplateId (base name: "projectTemplateId")', function() {
      // uncomment below and update the code to test the property projectTemplateId
      //var instance = new AwsCodeStar.DescribeProjectResult();
      //expect(instance).to.be();
    });
