...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.UntagProjectRequest();
  });
  ...
  describe('UntagProjectRequest', function() {
    it('should create an instance of UntagProjectRequest', function() {
      // uncomment below and update the code to test UntagProjectRequest
      //var instance = new AwsCodeStar.UntagProjectRequest();
      //expect(instance).to.be.a(AwsCodeStar.UntagProjectRequest);
    });
