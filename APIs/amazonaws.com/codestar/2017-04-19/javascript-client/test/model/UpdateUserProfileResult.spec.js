...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.UpdateUserProfileResult();
  });
  ...
  describe('UpdateUserProfileResult', function() {
    it('should create an instance of UpdateUserProfileResult', function() {
      // uncomment below and update the code to test UpdateUserProfileResult
      //var instance = new AwsCodeStar.UpdateUserProfileResult();
      //expect(instance).to.be.a(AwsCodeStar.UpdateUserProfileResult);
    });
