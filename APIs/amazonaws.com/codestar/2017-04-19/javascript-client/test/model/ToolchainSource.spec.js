...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.ToolchainSource();
  });
  ...
  describe('ToolchainSource', function() {
    it('should create an instance of ToolchainSource', function() {
      // uncomment below and update the code to test ToolchainSource
      //var instance = new AwsCodeStar.ToolchainSource();
      //expect(instance).to.be.a(AwsCodeStar.ToolchainSource);
    });
