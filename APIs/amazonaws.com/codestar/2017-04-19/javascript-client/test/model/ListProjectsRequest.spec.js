...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.ListProjectsRequest();
  });
  ...
  describe('ListProjectsRequest', function() {
    it('should create an instance of ListProjectsRequest', function() {
      // uncomment below and update the code to test ListProjectsRequest
      //var instance = new AwsCodeStar.ListProjectsRequest();
      //expect(instance).to.be.a(AwsCodeStar.ListProjectsRequest);
    });
