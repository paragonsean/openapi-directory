...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.UserProfileSummary();
  });
  ...
  describe('UserProfileSummary', function() {
    it('should create an instance of UserProfileSummary', function() {
      // uncomment below and update the code to test UserProfileSummary
      //var instance = new AwsCodeStar.UserProfileSummary();
      //expect(instance).to.be.a(AwsCodeStar.UserProfileSummary);
    });
