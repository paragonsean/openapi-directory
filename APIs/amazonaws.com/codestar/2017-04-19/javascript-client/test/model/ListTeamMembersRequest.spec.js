...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.ListTeamMembersRequest();
  });
  ...
  describe('ListTeamMembersRequest', function() {
    it('should create an instance of ListTeamMembersRequest', function() {
      // uncomment below and update the code to test ListTeamMembersRequest
      //var instance = new AwsCodeStar.ListTeamMembersRequest();
      //expect(instance).to.be.a(AwsCodeStar.ListTeamMembersRequest);
    });
