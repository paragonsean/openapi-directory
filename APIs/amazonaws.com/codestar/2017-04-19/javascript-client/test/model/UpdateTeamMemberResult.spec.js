...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.UpdateTeamMemberResult();
  });
  ...
  describe('UpdateTeamMemberResult', function() {
    it('should create an instance of UpdateTeamMemberResult', function() {
      // uncomment below and update the code to test UpdateTeamMemberResult
      //var instance = new AwsCodeStar.UpdateTeamMemberResult();
      //expect(instance).to.be.a(AwsCodeStar.UpdateTeamMemberResult);
    });
    ...
    it('should have the property remoteAccessAllowed (base name: "remoteAccessAllowed")', function() {
      // uncomment below and update the code to test the property remoteAccessAllowed
      //var instance = new AwsCodeStar.UpdateTeamMemberResult();
      //expect(instance).to.be();
    });
