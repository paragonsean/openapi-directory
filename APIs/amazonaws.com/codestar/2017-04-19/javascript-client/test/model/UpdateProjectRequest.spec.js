...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.UpdateProjectRequest();
  });
  ...
  describe('UpdateProjectRequest', function() {
    it('should create an instance of UpdateProjectRequest', function() {
      ...
      //var instance = new AwsCodeStar.UpdateProjectRequest();
      //expect(instance).to.be.a(AwsCodeStar.UpdateProjectRequest);
    });
