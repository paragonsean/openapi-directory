...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.AssociateTeamMemberResult();
  });
  ...
  describe('AssociateTeamMemberResult', function() {
    it('should create an instance of AssociateTeamMemberResult', function() {
      // uncomment below and update the code to test AssociateTeamMemberResult
      //var instance = new AwsCodeStar.AssociateTeamMemberResult();
      //expect(instance).to.be.a(AwsCodeStar.AssociateTeamMemberResult);
    });
