...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.AssociateTeamMemberRequest();
  });
  ...
  describe('AssociateTeamMemberRequest', function() {
    it('should create an instance of AssociateTeamMemberRequest', function() {
      // uncomment below and update the code to test AssociateTeamMemberRequest
      //var instance = new AwsCodeStar.AssociateTeamMemberRequest();
      //expect(instance).to.be.a(AwsCodeStar.AssociateTeamMemberRequest);
    });
