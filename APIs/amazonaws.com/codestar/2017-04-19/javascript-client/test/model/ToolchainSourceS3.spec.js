...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.ToolchainSourceS3();
  });
  ...
  describe('ToolchainSourceS3', function() {
    it('should create an instance of ToolchainSourceS3', function() {
      // uncomment below and update the code to test ToolchainSourceS3
      //var instance = new AwsCodeStar.ToolchainSourceS3();
      //expect(instance).to.be.a(AwsCodeStar.ToolchainSourceS3);
    });
