...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.TagProjectResult();
  });
  ...
  describe('TagProjectResult', function() {
    it('should create an instance of TagProjectResult', function() {
      // uncomment below and update the code to test TagProjectResult
      //var instance = new AwsCodeStar.TagProjectResult();
      //expect(instance).to.be.a(AwsCodeStar.TagProjectResult);
    });
