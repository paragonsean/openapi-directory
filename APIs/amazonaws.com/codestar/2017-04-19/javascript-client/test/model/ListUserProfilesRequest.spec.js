...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.ListUserProfilesRequest();
  });
  ...
  describe('ListUserProfilesRequest', function() {
    it('should create an instance of ListUserProfilesRequest', function() {
      // uncomment below and update the code to test ListUserProfilesRequest
      //var instance = new AwsCodeStar.ListUserProfilesRequest();
      //expect(instance).to.be.a(AwsCodeStar.ListUserProfilesRequest);
    });
