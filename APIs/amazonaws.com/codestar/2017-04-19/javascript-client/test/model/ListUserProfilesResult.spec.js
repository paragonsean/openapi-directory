...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.ListUserProfilesResult();
  });
  ...
  describe('ListUserProfilesResult', function() {
    it('should create an instance of ListUserProfilesResult', function() {
      // uncomment below and update the code to test ListUserProfilesResult
      //var instance = new AwsCodeStar.ListUserProfilesResult();
      //expect(instance).to.be.a(AwsCodeStar.ListUserProfilesResult);
    });
