...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.CodeSource();
  });
  ...
  describe('CodeSource', function() {
    it('should create an instance of CodeSource', function() {
      // uncomment below and update the code to test CodeSource
      //var instance = new AwsCodeStar.CodeSource();
      //expect(instance).to.be.a(AwsCodeStar.CodeSource);
    });
