...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.DescribeUserProfileRequest();
  });
  ...
  describe('DescribeUserProfileRequest', function() {
    it('should create an instance of DescribeUserProfileRequest', function() {
      ...
      //var instance = new AwsCodeStar.DescribeUserProfileRequest();
      //expect(instance).to.be.a(AwsCodeStar.DescribeUserProfileRequest);
    });
