...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.DisassociateTeamMemberRequest();
  });
  ...
  describe('DisassociateTeamMemberRequest', function() {
    it('should create an instance of DisassociateTeamMemberRequest', function() {
      // uncomment below and update the code to test DisassociateTeamMemberRequest
      //var instance = new AwsCodeStar.DisassociateTeamMemberRequest();
      //expect(instance).to.be.a(AwsCodeStar.DisassociateTeamMemberRequest);
    });
