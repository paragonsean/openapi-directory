...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.ListTagsForProjectResult();
  });
  ...
  describe('ListTagsForProjectResult', function() {
    it('should create an instance of ListTagsForProjectResult', function() {
      // uncomment below and update the code to test ListTagsForProjectResult
      //var instance = new AwsCodeStar.ListTagsForProjectResult();
      //expect(instance).to.be.a(AwsCodeStar.ListTagsForProjectResult);
    });
