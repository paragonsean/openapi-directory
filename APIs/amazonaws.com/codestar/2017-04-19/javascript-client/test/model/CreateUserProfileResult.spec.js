...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.CreateUserProfileResult();
  });
  ...
  describe('CreateUserProfileResult', function() {
    it('should create an instance of CreateUserProfileResult', function() {
      // uncomment below and update the code to test CreateUserProfileResult
      //var instance = new AwsCodeStar.CreateUserProfileResult();
      //expect(instance).to.be.a(AwsCodeStar.CreateUserProfileResult);
    });
