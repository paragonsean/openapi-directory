...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.ListTeamMembersResult();
  });
  ...
  describe('ListTeamMembersResult', function() {
    it('should create an instance of ListTeamMembersResult', function() {
      // uncomment below and update the code to test ListTeamMembersResult
      //var instance = new AwsCodeStar.ListTeamMembersResult();
      //expect(instance).to.be.a(AwsCodeStar.ListTeamMembersResult);
    });
