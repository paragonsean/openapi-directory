...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.ListResourcesRequest();
  });
  ...
  describe('ListResourcesRequest', function() {
    it('should create an instance of ListResourcesRequest', function() {
      ...
      //var instance = new AwsCodeStar.ListResourcesRequest();
      //expect(instance).to.be.a(AwsCodeStar.ListResourcesRequest);
    });
