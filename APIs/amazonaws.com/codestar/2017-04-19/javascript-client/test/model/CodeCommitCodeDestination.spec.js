...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.CodeCommitCodeDestination();
  });
  ...
  describe('CodeCommitCodeDestination', function() {
    it('should create an instance of CodeCommitCodeDestination', function() {
      // uncomment below and update the code to test CodeCommitCodeDestination
      //var instance = new AwsCodeStar.CodeCommitCodeDestination();
      //expect(instance).to.be.a(AwsCodeStar.CodeCommitCodeDestination);
    });
