...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.GitHubCodeDestination();
  });
  ...
  describe('GitHubCodeDestination', function() {
    it('should create an instance of GitHubCodeDestination', function() {
      // uncomment below and update the code to test GitHubCodeDestination
      //var instance = new AwsCodeStar.GitHubCodeDestination();
      //expect(instance).to.be.a(AwsCodeStar.GitHubCodeDestination);
    });
    ...
    it('should have the property privateRepository (base name: "privateRepository")', function() {
      // uncomment below and update the code to test the property privateRepository
      //var instance = new AwsCodeStar.GitHubCodeDestination();
      //expect(instance).to.be();
    });

    it('should have the property issuesEnabled (base name: "issuesEnabled")', function() {
