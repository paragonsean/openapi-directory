...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.ListResourcesResult();
  });
  ...
  describe('ListResourcesResult', function() {
    it('should create an instance of ListResourcesResult', function() {
      // uncomment below and update the code to test ListResourcesResult
      //var instance = new AwsCodeStar.ListResourcesResult();
      //expect(instance).to.be.a(AwsCodeStar.ListResourcesResult);
    });
