...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.CreateProjectRequest();
  });
  ...
  describe('CreateProjectRequest', function() {
    it('should create an instance of CreateProjectRequest', function() {
      ...
      //var instance = new AwsCodeStar.CreateProjectRequest();
      //expect(instance).to.be.a(AwsCodeStar.CreateProjectRequest);
    });
    ...
    it('should have the property toolchain (base name: "toolchain")', function() {
      // uncomment below and update the code to test the property toolchain
      //var instance = new AwsCodeStar.CreateProjectRequest();
      //expect(instance).to.be();
    });
