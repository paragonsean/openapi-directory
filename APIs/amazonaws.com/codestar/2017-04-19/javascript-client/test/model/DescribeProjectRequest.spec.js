...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.DescribeProjectRequest();
  });
  ...
  describe('DescribeProjectRequest', function() {
    it('should create an instance of DescribeProjectRequest', function() {
      // uncomment below and update the code to test DescribeProjectRequest
      //var instance = new AwsCodeStar.DescribeProjectRequest();
      //expect(instance).to.be.a(AwsCodeStar.DescribeProjectRequest);
    });
