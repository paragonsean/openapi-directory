...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.CodeDestination();
  });
  ...
  describe('CodeDestination', function() {
    it('should create an instance of CodeDestination', function() {
      // uncomment below and update the code to test CodeDestination
      //var instance = new AwsCodeStar.CodeDestination();
      //expect(instance).to.be.a(AwsCodeStar.CodeDestination);
    });
