...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.TagProjectRequest();
  });
  ...
  describe('TagProjectRequest', function() {
    it('should create an instance of TagProjectRequest', function() {
      // uncomment below and update the code to test TagProjectRequest
      //var instance = new AwsCodeStar.TagProjectRequest();
      //expect(instance).to.be.a(AwsCodeStar.TagProjectRequest);
    });
