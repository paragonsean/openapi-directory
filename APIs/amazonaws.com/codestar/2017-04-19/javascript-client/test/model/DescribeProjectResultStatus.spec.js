...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.DescribeProjectResultStatus();
  });
  ...
  describe('DescribeProjectResultStatus', function() {
    it('should create an instance of DescribeProjectResultStatus', function() {
      // uncomment below and update the code to test DescribeProjectResultStatus
      //var instance = new AwsCodeStar.DescribeProjectResultStatus();
      //expect(instance).to.be.a(AwsCodeStar.DescribeProjectResultStatus);
    });
