...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.ListTagsForProjectRequest();
  });
  ...
  describe('ListTagsForProjectRequest', function() {
    it('should create an instance of ListTagsForProjectRequest', function() {
      // uncomment below and update the code to test ListTagsForProjectRequest
      //var instance = new AwsCodeStar.ListTagsForProjectRequest();
      //expect(instance).to.be.a(AwsCodeStar.ListTagsForProjectRequest);
    });
