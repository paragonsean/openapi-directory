...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeStar.CreateProjectRequestToolchain();
  });
  ...
  describe('CreateProjectRequestToolchain', function() {
    it('should create an instance of CreateProjectRequestToolchain', function() {
      // uncomment below and update the code to test CreateProjectRequestToolchain
      //var instance = new AwsCodeStar.CreateProjectRequestToolchain();
      //expect(instance).to.be.a(AwsCodeStar.CreateProjectRequestToolchain);
    });
    ...
    it('should have the property stackParameters (base name: "stackParameters")', function() {
      // uncomment below and update the code to test the property stackParameters
      //var instance = new AwsCodeStar.CreateProjectRequestToolchain();
      //expect(instance).to.be();
    });
