...
/**
 * The ListUserProfilesResult model module.
 * @module model/ListUserProfilesResult
 * @version 2017-04-19
 */
class ListUserProfilesResult {
    /**
     * Constructs a new <code>ListUserProfilesResult</code>.
     * @alias module:model/ListUserProfilesResult
     * @param userProfiles {Array} 
     */
    constructor(userProfiles) { 
        
        ListUserProfilesResult.initialize(this, userProfiles);
    }
     ...
     */
    static initialize(obj, userProfiles) { 
        obj['userProfiles'] = userProfiles;
    }

    /**
     * Constructs a <code>ListUserProfilesResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListUserProfilesResult} obj Optional instance to populate.
     * @return {module:model/ListUserProfilesResult} The populated <code>ListUserProfilesResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListUserProfilesResult();
    ...
    /**
     * Validates the JSON data with respect to <code>ListUserProfilesResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListUserProfilesResult</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListUserProfilesResult.RequiredProperties) {
...
ListUserProfilesResult.RequiredProperties = ["userProfiles"];

/**
 * @member {Array} userProfiles
 */
ListUserProfilesResult.prototype['userProfiles'] = undefined;

/**
 * @member {String} nextToken
 */
ListUserProfilesResult.prototype['nextToken'] = undefined;
...
export default ListUserProfilesResult;
