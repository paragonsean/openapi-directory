...
/**
 * The CreateUserProfileResult model module.
 * @module model/CreateUserProfileResult
 * @version 2017-04-19
 */
class CreateUserProfileResult {
    /**
     * Constructs a new <code>CreateUserProfileResult</code>.
     * @alias module:model/CreateUserProfileResult
     * @param userArn {String} 
     */
    constructor(userArn) { 
        
        CreateUserProfileResult.initialize(this, userArn);
    }
    ...
    /**
     * Constructs a <code>CreateUserProfileResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateUserProfileResult} obj Optional instance to populate.
     * @return {module:model/CreateUserProfileResult} The populated <code>CreateUserProfileResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateUserProfileResult();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateUserProfileResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateUserProfileResult</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateUserProfileResult.RequiredProperties) {
...
CreateUserProfileResult.RequiredProperties = ["userArn"];

/**
 * @member {String} userArn
 */
CreateUserProfileResult.prototype['userArn'] = undefined;

/**
 * @member {String} displayName
 */
CreateUserProfileResult.prototype['displayName'] = undefined;

/**
 * @member {String} emailAddress
 */
CreateUserProfileResult.prototype['emailAddress'] = undefined;

/**
 * @member {String} sshPublicKey
 */
CreateUserProfileResult.prototype['sshPublicKey'] = undefined;

/**
 * @member {Date} createdTimestamp
 */
CreateUserProfileResult.prototype['createdTimestamp'] = undefined;

/**
 * @member {Date} lastModifiedTimestamp
 */
CreateUserProfileResult.prototype['lastModifiedTimestamp'] = undefined;
...
export default CreateUserProfileResult;
