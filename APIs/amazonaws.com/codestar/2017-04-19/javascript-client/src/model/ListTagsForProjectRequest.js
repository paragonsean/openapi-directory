...
/**
 * The ListTagsForProjectRequest model module.
 * @module model/ListTagsForProjectRequest
 * @version 2017-04-19
 */
class ListTagsForProjectRequest {
    /**
     * Constructs a new <code>ListTagsForProjectRequest</code>.
     * @alias module:model/ListTagsForProjectRequest
     * @param id {String} 
     */
    constructor(id) { 
        
        ListTagsForProjectRequest.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>ListTagsForProjectRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListTagsForProjectRequest} obj Optional instance to populate.
     * @return {module:model/ListTagsForProjectRequest} The populated <code>ListTagsForProjectRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListTagsForProjectRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListTagsForProjectRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTagsForProjectRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListTagsForProjectRequest.RequiredProperties) {
...
ListTagsForProjectRequest.RequiredProperties = ["id"];

/**
 * @member {String} id
 */
ListTagsForProjectRequest.prototype['id'] = undefined;

/**
 * @member {String} nextToken
 */
ListTagsForProjectRequest.prototype['nextToken'] = undefined;

/**
 * @member {Number} maxResults
 */
ListTagsForProjectRequest.prototype['maxResults'] = undefined;
...
export default ListTagsForProjectRequest;
