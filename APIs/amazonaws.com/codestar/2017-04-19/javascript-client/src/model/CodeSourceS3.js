...
/**
 * The CodeSourceS3 model module.
 * @module model/CodeSourceS3
 * @version 2017-04-19
 */
class CodeSourceS3 {
    /**
     * Constructs a new <code>CodeSourceS3</code>.
     * @alias module:model/CodeSourceS3
     * @implements module:model/S3Location
     */
    constructor() { 
        S3Location.initialize(this);
        CodeSourceS3.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CodeSourceS3</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CodeSourceS3} obj Optional instance to populate.
     * @return {module:model/CodeSourceS3} The populated <code>CodeSourceS3</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CodeSourceS3();
    ...
    /**
     * Validates the JSON data with respect to <code>CodeSourceS3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CodeSourceS3</code>.
     */
 ...
 */
CodeSourceS3.prototype['bucketName'] = undefined;

/**
 * @member {String} bucketKey
 */
CodeSourceS3.prototype['bucketKey'] = undefined;
