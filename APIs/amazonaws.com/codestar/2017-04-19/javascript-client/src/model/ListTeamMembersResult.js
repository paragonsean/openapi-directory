...
/**
 * The ListTeamMembersResult model module.
 * @module model/ListTeamMembersResult
 * @version 2017-04-19
 */
class ListTeamMembersResult {
    /**
     * Constructs a new <code>ListTeamMembersResult</code>.
     * @alias module:model/ListTeamMembersResult
     * @param teamMembers {Array} 
     */
    constructor(teamMembers) { 
        
        ListTeamMembersResult.initialize(this, teamMembers);
    }
    ...
    /**
     * Constructs a <code>ListTeamMembersResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListTeamMembersResult} obj Optional instance to populate.
     * @return {module:model/ListTeamMembersResult} The populated <code>ListTeamMembersResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListTeamMembersResult();

            if (data.hasOwnProperty('teamMembers')) {
                obj['teamMembers'] = ApiClient.convertToType(data['teamMembers'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListTeamMembersResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTeamMembersResult</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListTeamMembersResult.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `teamMembers`
        if (data['teamMembers']) { // data not null
          Array.validateJSON(data['teamMembers']);
        }
...
ListTeamMembersResult.RequiredProperties = ["teamMembers"];

/**
 * @member {Array} teamMembers
 */
ListTeamMembersResult.prototype['teamMembers'] = undefined;

/**
 * @member {String} nextToken
 */
ListTeamMembersResult.prototype['nextToken'] = undefined;
...
export default ListTeamMembersResult;
