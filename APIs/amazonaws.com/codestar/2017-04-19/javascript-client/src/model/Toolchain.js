...
/**
 * The Toolchain model module.
 * @module model/Toolchain
 * @version 2017-04-19
 */
class Toolchain {
    /**
     * Constructs a new <code>Toolchain</code>.
     * The toolchain template file provided with the project request. AWS CodeStar uses the template to provision the toolchain stack in AWS CloudFormation.
     * @alias module:model/Toolchain
    ...
    /**
     * Constructs a <code>Toolchain</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Toolchain} obj Optional instance to populate.
     * @return {module:model/Toolchain} The populated <code>Toolchain</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Toolchain();
    ...
    /**
     * Validates the JSON data with respect to <code>Toolchain</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Toolchain</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Toolchain.RequiredProperties) {
...
Toolchain.RequiredProperties = ["source"];
