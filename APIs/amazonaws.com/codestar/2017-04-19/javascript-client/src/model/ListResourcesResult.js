...
/**
 * The ListResourcesResult model module.
 * @module model/ListResourcesResult
 * @version 2017-04-19
 */
class ListResourcesResult {
    /**
     * Constructs a new <code>ListResourcesResult</code>.
     * @alias module:model/ListResourcesResult
     */
    constructor() { 
        
        ListResourcesResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListResourcesResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListResourcesResult} obj Optional instance to populate.
     * @return {module:model/ListResourcesResult} The populated <code>ListResourcesResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListResourcesResult();
    ...
    /**
     * Validates the JSON data with respect to <code>ListResourcesResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListResourcesResult</code>.
     */
 ...
 */
ListResourcesResult.prototype['resources'] = undefined;

/**
 * @member {String} nextToken
 */
ListResourcesResult.prototype['nextToken'] = undefined;
...
export default ListResourcesResult;
