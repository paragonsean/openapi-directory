...
/**
 * The TagProjectResult model module.
 * @module model/TagProjectResult
 * @version 2017-04-19
 */
class TagProjectResult {
    /**
     * Constructs a new <code>TagProjectResult</code>.
     * @alias module:model/TagProjectResult
     */
    constructor() { 
        
        TagProjectResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TagProjectResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TagProjectResult} obj Optional instance to populate.
     * @return {module:model/TagProjectResult} The populated <code>TagProjectResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TagProjectResult();
    ...
    /**
     * Validates the JSON data with respect to <code>TagProjectResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TagProjectResult</code>.
     */
 ...
 * @member {Object} tags
 */
TagProjectResult.prototype['tags'] = undefined;
...
export default TagProjectResult;
