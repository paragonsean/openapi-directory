...
import CodeSourceS3 from './CodeSourceS3';

/**
 * The CodeSource model module.
 * @module model/CodeSource
 * @version 2017-04-19
 */
class CodeSource {
    /**
     * Constructs a new <code>CodeSource</code>.
     * @alias module:model/CodeSource
     * @implements module:model/CodeSource
     * @param s3 {module:model/CodeSourceS3} 
     */
    constructor(s3) { 
        CodeSource.initialize(this, s3);
        CodeSource.initialize(this, s3);
    }
    ...
    /**
     * Constructs a <code>CodeSource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CodeSource} obj Optional instance to populate.
     * @return {module:model/CodeSource} The populated <code>CodeSource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CodeSource();
            CodeSource.constructFromObject(data, obj);

            if (data.hasOwnProperty('s3')) {
                obj['s3'] = CodeSourceS3.constructFromObject(data['s3']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CodeSource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CodeSource</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CodeSource.RequiredProperties) {
        ...
        if (data['s3']) { // data not null
          CodeSourceS3.validateJSON(data['s3']);
        }
...
CodeSource.RequiredProperties = ["s3"];

/**
 * @member {module:model/CodeSourceS3} s3
 */
CodeSource.prototype['s3'] = undefined;


// Implement CodeSource interface:
/**
 * @member {module:model/CodeSourceS3} s3
 */
CodeSource.prototype['s3'] = undefined;
