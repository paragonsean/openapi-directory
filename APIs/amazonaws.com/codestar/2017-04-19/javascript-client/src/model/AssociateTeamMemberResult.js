...
/**
 * The AssociateTeamMemberResult model module.
 * @module model/AssociateTeamMemberResult
 * @version 2017-04-19
 */
class AssociateTeamMemberResult {
    /**
     * Constructs a new <code>AssociateTeamMemberResult</code>.
     * @alias module:model/AssociateTeamMemberResult
     */
    constructor() { 
        
        AssociateTeamMemberResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AssociateTeamMemberResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssociateTeamMemberResult} obj Optional instance to populate.
     * @return {module:model/AssociateTeamMemberResult} The populated <code>AssociateTeamMemberResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssociateTeamMemberResult();
    ...
    /**
     * Validates the JSON data with respect to <code>AssociateTeamMemberResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssociateTeamMemberResult</code>.
     */
 ...
 */
AssociateTeamMemberResult.prototype['clientRequestToken'] = undefined;
...
export default AssociateTeamMemberResult;
