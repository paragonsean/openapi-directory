...
class TeamMember {
     ...
     */
    constructor(userArn, projectRole) { 
        
        TeamMember.initialize(this, userArn, projectRole);
    }
     ...
     */
    static initialize(obj, userArn, projectRole) { 
        obj['userArn'] = userArn;
...
TeamMember.RequiredProperties = ["userArn", "projectRole"];

/**
 * @member {String} userArn
 */
TeamMember.prototype['userArn'] = undefined;

/**
 * @member {String} projectRole
 */
TeamMember.prototype['projectRole'] = undefined;

/**
 * @member {Boolean} remoteAccessAllowed
 */
TeamMember.prototype['remoteAccessAllowed'] = undefined;
