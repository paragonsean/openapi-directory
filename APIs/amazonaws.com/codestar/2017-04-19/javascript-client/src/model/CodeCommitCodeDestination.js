...
/**
 * The CodeCommitCodeDestination model module.
 * @module model/CodeCommitCodeDestination
 * @version 2017-04-19
 */
class CodeCommitCodeDestination {
    /**
     * Constructs a new <code>CodeCommitCodeDestination</code>.
     * Information about the AWS CodeCommit repository to be created in AWS CodeStar. This is where the source code files provided with the project request will be uploaded after project creation.
     * @alias module:model/CodeCommitCodeDestination
     * @param name {String} 
     */
    constructor(name) { 
    ...
    /**
     * Constructs a <code>CodeCommitCodeDestination</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CodeCommitCodeDestination} obj Optional instance to populate.
     * @return {module:model/CodeCommitCodeDestination} The populated <code>CodeCommitCodeDestination</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CodeCommitCodeDestination();
    ...
    /**
     * Validates the JSON data with respect to <code>CodeCommitCodeDestination</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CodeCommitCodeDestination</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CodeCommitCodeDestination.RequiredProperties) {
...
CodeCommitCodeDestination.RequiredProperties = ["name"];
...
export default CodeCommitCodeDestination;
