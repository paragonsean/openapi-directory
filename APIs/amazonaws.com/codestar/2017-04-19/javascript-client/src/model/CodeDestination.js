...
import CodeDestinationCodeCommit from './CodeDestinationCodeCommit';
import CodeDestinationGitHub from './CodeDestinationGitHub';

/**
 * The CodeDestination model module.
 * @module model/CodeDestination
 * @version 2017-04-19
 */
class CodeDestination {
    /**
     * Constructs a new <code>CodeDestination</code>.
     * @alias module:model/CodeDestination
     * @implements module:model/CodeDestination
     */
    constructor() { 
        CodeDestination.initialize(this);
        CodeDestination.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CodeDestination</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CodeDestination} obj Optional instance to populate.
     * @return {module:model/CodeDestination} The populated <code>CodeDestination</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CodeDestination();
            CodeDestination.constructFromObject(data, obj);

            if (data.hasOwnProperty('codeCommit')) {
                obj['codeCommit'] = CodeDestinationCodeCommit.constructFromObject(data['codeCommit']);
            }
            if (data.hasOwnProperty('gitHub')) {
                obj['gitHub'] = CodeDestinationGitHub.constructFromObject(data['gitHub']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CodeDestination</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CodeDestination</code>.
     */
    static validateJSON(data) {
        // validate the optional field `codeCommit`
        if (data['codeCommit']) { // data not null
          CodeDestinationCodeCommit.validateJSON(data['codeCommit']);
        }
        // validate the optional field `gitHub`
        if (data['gitHub']) { // data not null
          CodeDestinationGitHub.validateJSON(data['gitHub']);
        }
...
/**
 * @member {module:model/CodeDestinationCodeCommit} codeCommit
 */
CodeDestination.prototype['codeCommit'] = undefined;

/**
 * @member {module:model/CodeDestinationGitHub} gitHub
 */
CodeDestination.prototype['gitHub'] = undefined;


// Implement CodeDestination interface:
/**
 * @member {module:model/CodeDestinationCodeCommit} codeCommit
 */
CodeDestination.prototype['codeCommit'] = undefined;
...
export default CodeDestination;
