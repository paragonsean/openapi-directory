...
/**
 * The UntagProjectRequest model module.
 * @module model/UntagProjectRequest
 * @version 2017-04-19
 */
class UntagProjectRequest {
    /**
     * Constructs a new <code>UntagProjectRequest</code>.
     * @alias module:model/UntagProjectRequest
     * @param id {String} 
     * @param tags {Array} 
     */
    constructor(id, tags) { 
        
        UntagProjectRequest.initialize(this, id, tags);
    }
    ...
    /**
     * Constructs a <code>UntagProjectRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UntagProjectRequest} obj Optional instance to populate.
     * @return {module:model/UntagProjectRequest} The populated <code>UntagProjectRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UntagProjectRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UntagProjectRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UntagProjectRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UntagProjectRequest.RequiredProperties) {
...
UntagProjectRequest.RequiredProperties = ["id", "tags"];

/**
 * @member {String} id
 */
UntagProjectRequest.prototype['id'] = undefined;

/**
 * @member {Array} tags
 */
UntagProjectRequest.prototype['tags'] = undefined;
...
export default UntagProjectRequest;
