...
/**
 * The ToolchainSourceS3 model module.
 * @module model/ToolchainSourceS3
 * @version 2017-04-19
 */
class ToolchainSourceS3 {
    /**
     * Constructs a new <code>ToolchainSourceS3</code>.
     * @alias module:model/ToolchainSourceS3
     * @implements module:model/S3Location
     */
    constructor() { 
        S3Location.initialize(this);
        ToolchainSourceS3.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ToolchainSourceS3</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ToolchainSourceS3} obj Optional instance to populate.
     * @return {module:model/ToolchainSourceS3} The populated <code>ToolchainSourceS3</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ToolchainSourceS3();
    ...
    /**
     * Validates the JSON data with respect to <code>ToolchainSourceS3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ToolchainSourceS3</code>.
     */
 ...
 */
ToolchainSourceS3.prototype['bucketName'] = undefined;

/**
 * @member {String} bucketKey
 */
ToolchainSourceS3.prototype['bucketKey'] = undefined;
...
export default ToolchainSourceS3;
