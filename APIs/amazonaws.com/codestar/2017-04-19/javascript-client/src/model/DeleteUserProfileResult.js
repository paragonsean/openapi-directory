...
/**
 * The DeleteUserProfileResult model module.
 * @module model/DeleteUserProfileResult
 * @version 2017-04-19
 */
class DeleteUserProfileResult {
    /**
     * Constructs a new <code>DeleteUserProfileResult</code>.
     * @alias module:model/DeleteUserProfileResult
     * @param userArn {String} 
     */
    constructor(userArn) { 
        
        DeleteUserProfileResult.initialize(this, userArn);
    }
    ...
    /**
     * Constructs a <code>DeleteUserProfileResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteUserProfileResult} obj Optional instance to populate.
     * @return {module:model/DeleteUserProfileResult} The populated <code>DeleteUserProfileResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteUserProfileResult();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteUserProfileResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteUserProfileResult</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteUserProfileResult.RequiredProperties) {
...
DeleteUserProfileResult.RequiredProperties = ["userArn"];

/**
 * @member {String} userArn
 */
DeleteUserProfileResult.prototype['userArn'] = undefined;
...
export default DeleteUserProfileResult;
