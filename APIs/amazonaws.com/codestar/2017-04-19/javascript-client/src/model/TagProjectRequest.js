...
/**
 * The TagProjectRequest model module.
 * @module model/TagProjectRequest
 * @version 2017-04-19
 */
class TagProjectRequest {
    /**
     * Constructs a new <code>TagProjectRequest</code>.
     * @alias module:model/TagProjectRequest
     * @param id {String} 
     * @param tags {Object} 
     */
    constructor(id, tags) { 
        
        TagProjectRequest.initialize(this, id, tags);
    }
     ...
     */
    static initialize(obj, id, tags) { 
        obj['id'] = id;
        obj['tags'] = tags;
    }

    /**
     * Constructs a <code>TagProjectRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TagProjectRequest} obj Optional instance to populate.
     * @return {module:model/TagProjectRequest} The populated <code>TagProjectRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TagProjectRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>TagProjectRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TagProjectRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TagProjectRequest.RequiredProperties) {
...
TagProjectRequest.RequiredProperties = ["id", "tags"];

/**
 * @member {String} id
 */
TagProjectRequest.prototype['id'] = undefined;

/**
 * @member {Object} tags
 */
TagProjectRequest.prototype['tags'] = undefined;
...
export default TagProjectRequest;
