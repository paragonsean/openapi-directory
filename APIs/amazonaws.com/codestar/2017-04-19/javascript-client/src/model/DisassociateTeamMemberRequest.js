...
/**
 * The DisassociateTeamMemberRequest model module.
 * @module model/DisassociateTeamMemberRequest
 * @version 2017-04-19
 */
class DisassociateTeamMemberRequest {
    /**
     * Constructs a new <code>DisassociateTeamMemberRequest</code>.
     * @alias module:model/DisassociateTeamMemberRequest
     * @param projectId {String} 
     * @param userArn {String} 
     */
    constructor(projectId, userArn) { 
        
        DisassociateTeamMemberRequest.initialize(this, projectId, userArn);
    }
     ...
     */
    static initialize(obj, projectId, userArn) { 
        obj['projectId'] = projectId;
        obj['userArn'] = userArn;
    }

    /**
     * Constructs a <code>DisassociateTeamMemberRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisassociateTeamMemberRequest} obj Optional instance to populate.
     * @return {module:model/DisassociateTeamMemberRequest} The populated <code>DisassociateTeamMemberRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisassociateTeamMemberRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DisassociateTeamMemberRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisassociateTeamMemberRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DisassociateTeamMemberRequest.RequiredProperties) {
...
DisassociateTeamMemberRequest.RequiredProperties = ["projectId", "userArn"];

/**
 * @member {String} projectId
 */
DisassociateTeamMemberRequest.prototype['projectId'] = undefined;

/**
 * @member {String} userArn
 */
DisassociateTeamMemberRequest.prototype['userArn'] = undefined;
...
export default DisassociateTeamMemberRequest;
