...
class DescribeUserProfileRequest {
    ...
    constructor(userArn) { 
        ...
        DescribeUserProfileRequest.initialize(this, userArn);
    }
...
DescribeUserProfileRequest.RequiredProperties = ["userArn"];

/**
 * @member {String} userArn
 */
DescribeUserProfileRequest.prototype['userArn'] = undefined;
