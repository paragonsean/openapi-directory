...
/**
 * The ListTagsForProjectResult model module.
 * @module model/ListTagsForProjectResult
 * @version 2017-04-19
 */
class ListTagsForProjectResult {
    /**
     * Constructs a new <code>ListTagsForProjectResult</code>.
     * @alias module:model/ListTagsForProjectResult
     */
    constructor() { 
        
        ListTagsForProjectResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListTagsForProjectResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListTagsForProjectResult} obj Optional instance to populate.
     * @return {module:model/ListTagsForProjectResult} The populated <code>ListTagsForProjectResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListTagsForProjectResult();
    ...
    /**
     * Validates the JSON data with respect to <code>ListTagsForProjectResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTagsForProjectResult</code>.
     */
 ...
 * @member {Object} tags
 */
ListTagsForProjectResult.prototype['tags'] = undefined;

/**
 * @member {String} nextToken
 */
ListTagsForProjectResult.prototype['nextToken'] = undefined;
...
export default ListTagsForProjectResult;
