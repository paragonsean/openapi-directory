...
OAICodeSource_s3::OAICodeSource_s3(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICodeSource_s3::OAICodeSource_s3() {
    this->initializeModel();
}

OAICodeSource_s3::~OAICodeSource_s3() {}

void OAICodeSource_s3::initializeModel() {
...
void OAICodeSource_s3::fromJson(QString jsonString) {
...
void OAICodeSource_s3::fromJsonObject(QJsonObject json) {
...
QString OAICodeSource_s3::asJson() const {
...
QJsonObject OAICodeSource_s3::asJsonObject() const {
    QJsonObject obj;
...
QString OAICodeSource_s3::getBucketName() const {
    return m_bucket_name;
}
void OAICodeSource_s3::setBucketName(const QString &bucket_name) {
    m_bucket_name = bucket_name;
    m_bucket_name_isSet = true;
}

bool OAICodeSource_s3::is_bucket_name_Set() const{
    return m_bucket_name_isSet;
}

bool OAICodeSource_s3::is_bucket_name_Valid() const{
    return m_bucket_name_isValid;
}

QString OAICodeSource_s3::getBucketKey() const {
    return m_bucket_key;
}
void OAICodeSource_s3::setBucketKey(const QString &bucket_key) {
    m_bucket_key = bucket_key;
    m_bucket_key_isSet = true;
}

bool OAICodeSource_s3::is_bucket_key_Set() const{
    return m_bucket_key_isSet;
}

bool OAICodeSource_s3::is_bucket_key_Valid() const{
    return m_bucket_key_isValid;
}

bool OAICodeSource_s3::isSet() const {
...
bool OAICodeSource_s3::isValid() const {
