...
/*
 * OAIDeleteUserProfileResult.h
 *
 * 
 */

#ifndef OAIDeleteUserProfileResult_H
#define OAIDeleteUserProfileResult_H
...
class OAIDeleteUserProfileResult : public OAIObject {
public:
    OAIDeleteUserProfileResult();
    OAIDeleteUserProfileResult(QString json);
    ~OAIDeleteUserProfileResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteUserProfileResult)

#endif // OAIDeleteUserProfileResult_H
