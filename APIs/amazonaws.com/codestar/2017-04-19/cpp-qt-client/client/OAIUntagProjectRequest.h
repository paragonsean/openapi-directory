...
/*
 * OAIUntagProjectRequest.h
 *
 * 
 */

#ifndef OAIUntagProjectRequest_H
#define OAIUntagProjectRequest_H
...
class OAIUntagProjectRequest : public OAIObject {
public:
    OAIUntagProjectRequest();
    OAIUntagProjectRequest(QString json);
    ~OAIUntagProjectRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUntagProjectRequest)

#endif // OAIUntagProjectRequest_H
