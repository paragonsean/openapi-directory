...
/*
 * OAIListUserProfilesRequest.h
 *
 * 
 */

#ifndef OAIListUserProfilesRequest_H
#define OAIListUserProfilesRequest_H
...
class OAIListUserProfilesRequest : public OAIObject {
public:
    OAIListUserProfilesRequest();
    OAIListUserProfilesRequest(QString json);
    ~OAIListUserProfilesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListUserProfilesRequest)

#endif // OAIListUserProfilesRequest_H
