...
OAIListTeamMembersRequest::OAIListTeamMembersRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListTeamMembersRequest::OAIListTeamMembersRequest() {
    this->initializeModel();
}

OAIListTeamMembersRequest::~OAIListTeamMembersRequest() {}

void OAIListTeamMembersRequest::initializeModel() {
...
void OAIListTeamMembersRequest::fromJson(QString jsonString) {
...
void OAIListTeamMembersRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListTeamMembersRequest::asJson() const {
...
QJsonObject OAIListTeamMembersRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListTeamMembersRequest::getProjectId() const {
    return m_project_id;
}
void OAIListTeamMembersRequest::setProjectId(const QString &project_id) {
    m_project_id = project_id;
    m_project_id_isSet = true;
}

bool OAIListTeamMembersRequest::is_project_id_Set() const{
    return m_project_id_isSet;
}

bool OAIListTeamMembersRequest::is_project_id_Valid() const{
    return m_project_id_isValid;
}

QString OAIListTeamMembersRequest::getNextToken() const {
    return m_next_token;
}
void OAIListTeamMembersRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListTeamMembersRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListTeamMembersRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListTeamMembersRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListTeamMembersRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListTeamMembersRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListTeamMembersRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListTeamMembersRequest::isSet() const {
...
bool OAIListTeamMembersRequest::isValid() const {
