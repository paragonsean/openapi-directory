...
/*
 * OAITagProjectResult.h
 *
 * 
 */

#ifndef OAITagProjectResult_H
#define OAITagProjectResult_H
...
class OAITagProjectResult : public OAIObject {
public:
    OAITagProjectResult();
    OAITagProjectResult(QString json);
    ~OAITagProjectResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITagProjectResult)

#endif // OAITagProjectResult_H
