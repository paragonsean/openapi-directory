...
#ifndef OAICode_source_H
#define OAICode_source_H
...
class OAICode_source : public OAIObject {
public:
    OAICode_source();
    OAICode_source(QString json);
    ~OAICode_source() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICode_source)

#endif // OAICode_source_H
