...
OAIUpdateTeamMemberResult::OAIUpdateTeamMemberResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateTeamMemberResult::OAIUpdateTeamMemberResult() {
    this->initializeModel();
}

OAIUpdateTeamMemberResult::~OAIUpdateTeamMemberResult() {}

void OAIUpdateTeamMemberResult::initializeModel() {
...
void OAIUpdateTeamMemberResult::fromJson(QString jsonString) {
...
void OAIUpdateTeamMemberResult::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateTeamMemberResult::asJson() const {
...
QJsonObject OAIUpdateTeamMemberResult::asJsonObject() const {
    QJsonObject obj;
    if (m_user_arn_isSet) {
...
QString OAIUpdateTeamMemberResult::getUserArn() const {
    return m_user_arn;
}
void OAIUpdateTeamMemberResult::setUserArn(const QString &user_arn) {
    m_user_arn = user_arn;
    m_user_arn_isSet = true;
}

bool OAIUpdateTeamMemberResult::is_user_arn_Set() const{
    return m_user_arn_isSet;
}

bool OAIUpdateTeamMemberResult::is_user_arn_Valid() const{
    return m_user_arn_isValid;
}

QString OAIUpdateTeamMemberResult::getProjectRole() const {
    return m_project_role;
}
void OAIUpdateTeamMemberResult::setProjectRole(const QString &project_role) {
    m_project_role = project_role;
    m_project_role_isSet = true;
}

bool OAIUpdateTeamMemberResult::is_project_role_Set() const{
    return m_project_role_isSet;
}

bool OAIUpdateTeamMemberResult::is_project_role_Valid() const{
    return m_project_role_isValid;
}

bool OAIUpdateTeamMemberResult::getRemoteAccessAllowed() const {
    return m_remote_access_allowed;
}
void OAIUpdateTeamMemberResult::setRemoteAccessAllowed(const bool &remote_access_allowed) {
    m_remote_access_allowed = remote_access_allowed;
    m_remote_access_allowed_isSet = true;
}

bool OAIUpdateTeamMemberResult::is_remote_access_allowed_Set() const{
    return m_remote_access_allowed_isSet;
}

bool OAIUpdateTeamMemberResult::is_remote_access_allowed_Valid() const{
    return m_remote_access_allowed_isValid;
}

bool OAIUpdateTeamMemberResult::isSet() const {
...
bool OAIUpdateTeamMemberResult::isValid() const {
