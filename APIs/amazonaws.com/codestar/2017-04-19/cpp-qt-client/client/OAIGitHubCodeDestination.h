...
/*
 * OAIGitHubCodeDestination.h
 *
 * Information about the GitHub repository to be created in AWS CodeStar. This is where the source code files provided with the project request will be uploaded after project creation.
 */

#ifndef OAIGitHubCodeDestination_H
#define OAIGitHubCodeDestination_H
...
class OAIGitHubCodeDestination : public OAIObject {
public:
    OAIGitHubCodeDestination();
    OAIGitHubCodeDestination(QString json);
    ~OAIGitHubCodeDestination() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGitHubCodeDestination)

#endif // OAIGitHubCodeDestination_H
