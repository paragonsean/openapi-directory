...
/*
 * OAICreateUserProfileResult.h
 *
 * 
 */

#ifndef OAICreateUserProfileResult_H
#define OAICreateUserProfileResult_H
...
class OAICreateUserProfileResult : public OAIObject {
public:
    OAICreateUserProfileResult();
    OAICreateUserProfileResult(QString json);
    ~OAICreateUserProfileResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUserProfileResult)

#endif // OAICreateUserProfileResult_H
