...
QString OAIDescribeUserProfileRequest::getUserArn() const {
    return m_user_arn;
}
void OAIDescribeUserProfileRequest::setUserArn(const QString &user_arn) {
    m_user_arn = user_arn;
    m_user_arn_isSet = true;
}

bool OAIDescribeUserProfileRequest::is_user_arn_Set() const{
    return m_user_arn_isSet;
}

bool OAIDescribeUserProfileRequest::is_user_arn_Valid() const{
