...
QString OAICreateProjectResult::getId() const {
    return m_id;
}
void OAICreateProjectResult::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICreateProjectResult::is_id_Set() const{
    return m_id_isSet;
}

bool OAICreateProjectResult::is_id_Valid() const{
    return m_id_isValid;
}

QString OAICreateProjectResult::getArn() const {
    return m_arn;
}
void OAICreateProjectResult::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAICreateProjectResult::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAICreateProjectResult::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAICreateProjectResult::getClientRequestToken() const {
    return m_client_request_token;
}
void OAICreateProjectResult::setClientRequestToken(const QString &client_request_token) {
    m_client_request_token = client_request_token;
    m_client_request_token_isSet = true;
}

bool OAICreateProjectResult::is_client_request_token_Set() const{
    return m_client_request_token_isSet;
}

bool OAICreateProjectResult::is_client_request_token_Valid() const{
    return m_client_request_token_isValid;
}

QString OAICreateProjectResult::getProjectTemplateId() const {
    return m_project_template_id;
}
void OAICreateProjectResult::setProjectTemplateId(const QString &project_template_id) {
    m_project_template_id = project_template_id;
    m_project_template_id_isSet = true;
}

bool OAICreateProjectResult::is_project_template_id_Set() const{
    return m_project_template_id_isSet;
}

bool OAICreateProjectResult::is_project_template_id_Valid() const{
