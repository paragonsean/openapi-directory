...
/*
 * OAIDescribeProjectResult_status.h
 *
 * 
 */

#ifndef OAIDescribeProjectResult_status_H
#define OAIDescribeProjectResult_status_H
...
class OAIDescribeProjectResult_status : public OAIObject {
public:
    OAIDescribeProjectResult_status();
    OAIDescribeProjectResult_status(QString json);
    ~OAIDescribeProjectResult_status() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeProjectResult_status)

#endif // OAIDescribeProjectResult_status_H
