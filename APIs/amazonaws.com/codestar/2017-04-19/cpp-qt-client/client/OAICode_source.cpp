...
OAICode_source::OAICode_source(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICode_source::OAICode_source() {
    this->initializeModel();
}

OAICode_source::~OAICode_source() {}

void OAICode_source::initializeModel() {

    m_s3_isSet = false;
    m_s3_isValid = false;
}

void OAICode_source::fromJson(QString jsonString) {
...
QJsonObject OAICode_source::asJsonObject() const {
    QJsonObject obj;
    if (m_s3.isSet()) {
...
OAICodeSource_s3 OAICode_source::getS3() const {
    return m_s3;
}
void OAICode_source::setS3(const OAICodeSource_s3 &s3) {
    m_s3 = s3;
    m_s3_isSet = true;
}

bool OAICode_source::is_s3_Set() const{
    return m_s3_isSet;
}

bool OAICode_source::is_s3_Valid() const{
    return m_s3_isValid;
}

bool OAICode_source::isSet() const {
...
bool OAICode_source::isValid() const {
