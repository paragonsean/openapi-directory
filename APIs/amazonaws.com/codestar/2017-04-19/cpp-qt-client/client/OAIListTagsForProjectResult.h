...
/*
 * OAIListTagsForProjectResult.h
 *
 * 
 */

#ifndef OAIListTagsForProjectResult_H
#define OAIListTagsForProjectResult_H
...
class OAIListTagsForProjectResult : public OAIObject {
public:
    OAIListTagsForProjectResult();
    OAIListTagsForProjectResult(QString json);
    ~OAIListTagsForProjectResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListTagsForProjectResult)

#endif // OAIListTagsForProjectResult_H
