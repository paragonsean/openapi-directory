...
/*
 * OAIToolchainSource_s3.h
 *
 * 
 */

#ifndef OAIToolchainSource_s3_H
#define OAIToolchainSource_s3_H
...
class OAIToolchainSource_s3 : public OAIObject {
public:
    OAIToolchainSource_s3();
    OAIToolchainSource_s3(QString json);
    ~OAIToolchainSource_s3() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIToolchainSource_s3)

#endif // OAIToolchainSource_s3_H
