...
/*
 * OAIListTeamMembersRequest.h
 *
 * 
 */

#ifndef OAIListTeamMembersRequest_H
#define OAIListTeamMembersRequest_H
...
class OAIListTeamMembersRequest : public OAIObject {
public:
    OAIListTeamMembersRequest();
    OAIListTeamMembersRequest(QString json);
    ~OAIListTeamMembersRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListTeamMembersRequest)

#endif // OAIListTeamMembersRequest_H
