...
OAIDeleteUserProfileResult::OAIDeleteUserProfileResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteUserProfileResult::OAIDeleteUserProfileResult() {
    this->initializeModel();
}

OAIDeleteUserProfileResult::~OAIDeleteUserProfileResult() {}

void OAIDeleteUserProfileResult::initializeModel() {

    m_user_arn_isSet = false;
    m_user_arn_isValid = false;
}

void OAIDeleteUserProfileResult::fromJson(QString jsonString) {
...
void OAIDeleteUserProfileResult::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteUserProfileResult::asJson() const {
...
QJsonObject OAIDeleteUserProfileResult::asJsonObject() const {
    QJsonObject obj;
    if (m_user_arn_isSet) {
...
QString OAIDeleteUserProfileResult::getUserArn() const {
    return m_user_arn;
}
void OAIDeleteUserProfileResult::setUserArn(const QString &user_arn) {
    m_user_arn = user_arn;
    m_user_arn_isSet = true;
}

bool OAIDeleteUserProfileResult::is_user_arn_Set() const{
    return m_user_arn_isSet;
}

bool OAIDeleteUserProfileResult::is_user_arn_Valid() const{
    return m_user_arn_isValid;
}

bool OAIDeleteUserProfileResult::isSet() const {
...
bool OAIDeleteUserProfileResult::isValid() const {
