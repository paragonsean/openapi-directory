...
QString OAIDeleteUserProfileRequest::getUserArn() const {
    return m_user_arn;
}
void OAIDeleteUserProfileRequest::setUserArn(const QString &user_arn) {
    m_user_arn = user_arn;
    m_user_arn_isSet = true;
}

bool OAIDeleteUserProfileRequest::is_user_arn_Set() const{
    return m_user_arn_isSet;
}

bool OAIDeleteUserProfileRequest::is_user_arn_Valid() const{
