...
/*
 * OAIListTeamMembersResult.h
 *
 * 
 */

#ifndef OAIListTeamMembersResult_H
#define OAIListTeamMembersResult_H
...
class OAIListTeamMembersResult : public OAIObject {
public:
    OAIListTeamMembersResult();
    OAIListTeamMembersResult(QString json);
    ~OAIListTeamMembersResult() override;
    ...
    QList getTeamMembers() const;
    void setTeamMembers(const QList &team_members);
...
Q_DECLARE_METATYPE(OpenAPI::OAIListTeamMembersResult)

#endif // OAIListTeamMembersResult_H
