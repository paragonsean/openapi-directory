...
/*
 * OAIDescribeProjectRequest.h
 *
 * 
 */

#ifndef OAIDescribeProjectRequest_H
#define OAIDescribeProjectRequest_H
...
class OAIDescribeProjectRequest : public OAIObject {
public:
    OAIDescribeProjectRequest();
    OAIDescribeProjectRequest(QString json);
    ~OAIDescribeProjectRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeProjectRequest)

#endif // OAIDescribeProjectRequest_H
