...
/*
 * OAIListProjectsRequest.h
 *
 * 
 */

#ifndef OAIListProjectsRequest_H
#define OAIListProjectsRequest_H
...
class OAIListProjectsRequest : public OAIObject {
public:
    OAIListProjectsRequest();
    OAIListProjectsRequest(QString json);
    ~OAIListProjectsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListProjectsRequest)

#endif // OAIListProjectsRequest_H
