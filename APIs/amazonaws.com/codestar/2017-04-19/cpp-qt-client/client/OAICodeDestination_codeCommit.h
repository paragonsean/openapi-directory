...
/*
 * OAICodeDestination_codeCommit.h
 *
 * 
 */

#ifndef OAICodeDestination_codeCommit_H
#define OAICodeDestination_codeCommit_H
...
class OAICodeDestination_codeCommit : public OAIObject {
public:
    OAICodeDestination_codeCommit();
    OAICodeDestination_codeCommit(QString json);
    ~OAICodeDestination_codeCommit() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodeDestination_codeCommit)

#endif // OAICodeDestination_codeCommit_H
