...
OAIListTagsForProjectResult::OAIListTagsForProjectResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListTagsForProjectResult::OAIListTagsForProjectResult() {
    this->initializeModel();
}

OAIListTagsForProjectResult::~OAIListTagsForProjectResult() {}

void OAIListTagsForProjectResult::initializeModel() {
...
void OAIListTagsForProjectResult::fromJson(QString jsonString) {
...
void OAIListTagsForProjectResult::fromJsonObject(QJsonObject json) {
...
QString OAIListTagsForProjectResult::asJson() const {
...
QJsonObject OAIListTagsForProjectResult::asJsonObject() const {
    QJsonObject obj;
    if (m_tags.isSet()) {
...
QMap OAIListTagsForProjectResult::getTags() const {
    return m_tags;
}
void OAIListTagsForProjectResult::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIListTagsForProjectResult::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIListTagsForProjectResult::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAIListTagsForProjectResult::getNextToken() const {
    return m_next_token;
}
void OAIListTagsForProjectResult::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListTagsForProjectResult::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListTagsForProjectResult::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListTagsForProjectResult::isSet() const {
...
bool OAIListTagsForProjectResult::isValid() const {
