...
/*
 * OAICode_destination.h
 *
 * 
 */

#ifndef OAICode_destination_H
#define OAICode_destination_H

#include <QJsonObject>

#include "OAICodeDestination_codeCommit.h"
...
namespace OpenAPI {
class OAICodeDestination_codeCommit;
class OAICodeDestination_gitHub;

class OAICode_destination : public OAIObject {
public:
    OAICode_destination();
    OAICode_destination(QString json);
    ~OAICode_destination() override;
    ...
    OAICodeDestination_codeCommit getCodeCommit() const;
    void setCodeCommit(const OAICodeDestination_codeCommit &code_commit);
    bool is_code_commit_Set() const;
    bool is_code_commit_Valid() const;

    OAICodeDestination_gitHub getGitHub() const;
    void setGitHub(const OAICodeDestination_gitHub &git_hub);
    bool is_git_hub_Set() const;
    bool is_git_hub_Valid() const;
...
private:
    ...
    OAICodeDestination_codeCommit m_code_commit;
    bool m_code_commit_isSet;
    bool m_code_commit_isValid;

    OAICodeDestination_gitHub m_git_hub;
    bool m_git_hub_isSet;
    bool m_git_hub_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICode_destination)

#endif // OAICode_destination_H
