...
OAIUpdateUserProfileResult::OAIUpdateUserProfileResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateUserProfileResult::OAIUpdateUserProfileResult() {
    this->initializeModel();
}

OAIUpdateUserProfileResult::~OAIUpdateUserProfileResult() {}

void OAIUpdateUserProfileResult::initializeModel() {
...
void OAIUpdateUserProfileResult::fromJson(QString jsonString) {
...
void OAIUpdateUserProfileResult::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateUserProfileResult::asJson() const {
...
QJsonObject OAIUpdateUserProfileResult::asJsonObject() const {
    QJsonObject obj;
    if (m_user_arn_isSet) {
...
QString OAIUpdateUserProfileResult::getUserArn() const {
    return m_user_arn;
}
void OAIUpdateUserProfileResult::setUserArn(const QString &user_arn) {
    m_user_arn = user_arn;
    m_user_arn_isSet = true;
}

bool OAIUpdateUserProfileResult::is_user_arn_Set() const{
    return m_user_arn_isSet;
}

bool OAIUpdateUserProfileResult::is_user_arn_Valid() const{
    return m_user_arn_isValid;
}

QString OAIUpdateUserProfileResult::getDisplayName() const {
    return m_display_name;
}
void OAIUpdateUserProfileResult::setDisplayName(const QString &display_name) {
    m_display_name = display_name;
    m_display_name_isSet = true;
}

bool OAIUpdateUserProfileResult::is_display_name_Set() const{
    return m_display_name_isSet;
}

bool OAIUpdateUserProfileResult::is_display_name_Valid() const{
    return m_display_name_isValid;
}

QString OAIUpdateUserProfileResult::getEmailAddress() const {
    return m_email_address;
}
void OAIUpdateUserProfileResult::setEmailAddress(const QString &email_address) {
    m_email_address = email_address;
    m_email_address_isSet = true;
}

bool OAIUpdateUserProfileResult::is_email_address_Set() const{
    return m_email_address_isSet;
}

bool OAIUpdateUserProfileResult::is_email_address_Valid() const{
    return m_email_address_isValid;
}

QString OAIUpdateUserProfileResult::getSshPublicKey() const {
    return m_ssh_public_key;
}
void OAIUpdateUserProfileResult::setSshPublicKey(const QString &ssh_public_key) {
    m_ssh_public_key = ssh_public_key;
    m_ssh_public_key_isSet = true;
}

bool OAIUpdateUserProfileResult::is_ssh_public_key_Set() const{
    return m_ssh_public_key_isSet;
}

bool OAIUpdateUserProfileResult::is_ssh_public_key_Valid() const{
    return m_ssh_public_key_isValid;
}

QDateTime OAIUpdateUserProfileResult::getCreatedTimestamp() const {
    return m_created_timestamp;
}
void OAIUpdateUserProfileResult::setCreatedTimestamp(const QDateTime &created_timestamp) {
    m_created_timestamp = created_timestamp;
    m_created_timestamp_isSet = true;
}

bool OAIUpdateUserProfileResult::is_created_timestamp_Set() const{
    return m_created_timestamp_isSet;
}

bool OAIUpdateUserProfileResult::is_created_timestamp_Valid() const{
    return m_created_timestamp_isValid;
}

QDateTime OAIUpdateUserProfileResult::getLastModifiedTimestamp() const {
    return m_last_modified_timestamp;
}
void OAIUpdateUserProfileResult::setLastModifiedTimestamp(const QDateTime &last_modified_timestamp) {
    m_last_modified_timestamp = last_modified_timestamp;
    m_last_modified_timestamp_isSet = true;
}

bool OAIUpdateUserProfileResult::is_last_modified_timestamp_Set() const{
    return m_last_modified_timestamp_isSet;
}

bool OAIUpdateUserProfileResult::is_last_modified_timestamp_Valid() const{
    return m_last_modified_timestamp_isValid;
}

bool OAIUpdateUserProfileResult::isSet() const {
...
bool OAIUpdateUserProfileResult::isValid() const {
