...
/*
 * OAIAssociateTeamMemberResult.h
 *
 * 
 */

#ifndef OAIAssociateTeamMemberResult_H
#define OAIAssociateTeamMemberResult_H
...
class OAIAssociateTeamMemberResult : public OAIObject {
public:
    OAIAssociateTeamMemberResult();
    OAIAssociateTeamMemberResult(QString json);
    ~OAIAssociateTeamMemberResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateTeamMemberResult)

#endif // OAIAssociateTeamMemberResult_H
