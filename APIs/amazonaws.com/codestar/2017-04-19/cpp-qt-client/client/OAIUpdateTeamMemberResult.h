...
/*
 * OAIUpdateTeamMemberResult.h
 *
 * 
 */

#ifndef OAIUpdateTeamMemberResult_H
#define OAIUpdateTeamMemberResult_H
...
class OAIUpdateTeamMemberResult : public OAIObject {
public:
    OAIUpdateTeamMemberResult();
    OAIUpdateTeamMemberResult(QString json);
    ~OAIUpdateTeamMemberResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateTeamMemberResult)

#endif // OAIUpdateTeamMemberResult_H
