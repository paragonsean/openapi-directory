...
#include "OAICode_source.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAICode_source;
class OAICode_destination;
...
public:
    ...
    OAICode_source getSource() const;
    void setSource(const OAICode_source &source);
    bool is_source_Set() const;
    bool is_source_Valid() const;

    OAICode_destination getDestination() const;
    void setDestination(const OAICode_destination &destination);
...
private:
    ...
    OAICode_source m_source;
    bool m_source_isSet;
    bool m_source_isValid;

    OAICode_destination m_destination;
