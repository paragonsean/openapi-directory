...
/*
 * OAIToolchain_source.h
 *
 * 
 */

#ifndef OAIToolchain_source_H
#define OAIToolchain_source_H
...
namespace OpenAPI {
class OAIToolchainSource_s3;

class OAIToolchain_source : public OAIObject {
public:
    OAIToolchain_source();
    OAIToolchain_source(QString json);
    ~OAIToolchain_source() override;
    ...
    OAIToolchainSource_s3 getS3() const;
    void setS3(const OAIToolchainSource_s3 &s3);
...
Q_DECLARE_METATYPE(OpenAPI::OAIToolchain_source)

#endif // OAIToolchain_source_H
