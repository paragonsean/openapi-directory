...
/*
 * OAITagProjectRequest.h
 *
 * 
 */

#ifndef OAITagProjectRequest_H
#define OAITagProjectRequest_H
...
class OAITagProjectRequest : public OAIObject {
public:
    OAITagProjectRequest();
    OAITagProjectRequest(QString json);
    ~OAITagProjectRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITagProjectRequest)

#endif // OAITagProjectRequest_H
