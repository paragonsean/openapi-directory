...
#include "OAICodeDestination_gitHub.h"
...
OAICodeDestination_gitHub::OAICodeDestination_gitHub(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICodeDestination_gitHub::OAICodeDestination_gitHub() {
    this->initializeModel();
}

OAICodeDestination_gitHub::~OAICodeDestination_gitHub() {}

void OAICodeDestination_gitHub::initializeModel() {
...
void OAICodeDestination_gitHub::fromJson(QString jsonString) {
...
void OAICodeDestination_gitHub::fromJsonObject(QJsonObject json) {
...
QString OAICodeDestination_gitHub::asJson() const {
...
QJsonObject OAICodeDestination_gitHub::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAICodeDestination_gitHub::getName() const {
    return m_name;
}
void OAICodeDestination_gitHub::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICodeDestination_gitHub::is_name_Set() const{
    return m_name_isSet;
}

bool OAICodeDestination_gitHub::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICodeDestination_gitHub::getDescription() const {
    return m_description;
}
void OAICodeDestination_gitHub::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICodeDestination_gitHub::is_description_Set() const{
    return m_description_isSet;
}

bool OAICodeDestination_gitHub::is_description_Valid() const{
    return m_description_isValid;
}

QString OAICodeDestination_gitHub::getType() const {
    return m_type;
}
void OAICodeDestination_gitHub::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICodeDestination_gitHub::is_type_Set() const{
    return m_type_isSet;
}

bool OAICodeDestination_gitHub::is_type_Valid() const{
    return m_type_isValid;
}

QString OAICodeDestination_gitHub::getOwner() const {
    return m_owner;
}
void OAICodeDestination_gitHub::setOwner(const QString &owner) {
    m_owner = owner;
    m_owner_isSet = true;
}

bool OAICodeDestination_gitHub::is_owner_Set() const{
    return m_owner_isSet;
}

bool OAICodeDestination_gitHub::is_owner_Valid() const{
    return m_owner_isValid;
}

bool OAICodeDestination_gitHub::getPrivateRepository() const {
    return m_private_repository;
}
void OAICodeDestination_gitHub::setPrivateRepository(const bool &private_repository) {
    m_private_repository = private_repository;
    m_private_repository_isSet = true;
}

bool OAICodeDestination_gitHub::is_private_repository_Set() const{
    return m_private_repository_isSet;
}

bool OAICodeDestination_gitHub::is_private_repository_Valid() const{
    return m_private_repository_isValid;
}

bool OAICodeDestination_gitHub::getIssuesEnabled() const {
    return m_issues_enabled;
}
void OAICodeDestination_gitHub::setIssuesEnabled(const bool &issues_enabled) {
    m_issues_enabled = issues_enabled;
    m_issues_enabled_isSet = true;
}

bool OAICodeDestination_gitHub::is_issues_enabled_Set() const{
    return m_issues_enabled_isSet;
}

bool OAICodeDestination_gitHub::is_issues_enabled_Valid() const{
    return m_issues_enabled_isValid;
}

QString OAICodeDestination_gitHub::getToken() const {
    return m_token;
}
void OAICodeDestination_gitHub::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAICodeDestination_gitHub::is_token_Set() const{
    return m_token_isSet;
}

bool OAICodeDestination_gitHub::is_token_Valid() const{
    return m_token_isValid;
}

bool OAICodeDestination_gitHub::isSet() const {
...
bool OAICodeDestination_gitHub::isValid() const {
