...
/*
 * OAICodeCommitCodeDestination.h
 *
 * Information about the AWS CodeCommit repository to be created in AWS CodeStar. This is where the source code files provided with the project request will be uploaded after project creation.
 */

#ifndef OAICodeCommitCodeDestination_H
#define OAICodeCommitCodeDestination_H
...
class OAICodeCommitCodeDestination : public OAIObject {
public:
    OAICodeCommitCodeDestination();
    OAICodeCommitCodeDestination(QString json);
    ~OAICodeCommitCodeDestination() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodeCommitCodeDestination)

#endif // OAICodeCommitCodeDestination_H
