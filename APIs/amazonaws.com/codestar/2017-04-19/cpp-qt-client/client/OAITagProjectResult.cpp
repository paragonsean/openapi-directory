...
OAITagProjectResult::OAITagProjectResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITagProjectResult::OAITagProjectResult() {
    this->initializeModel();
}

OAITagProjectResult::~OAITagProjectResult() {}

void OAITagProjectResult::initializeModel() {

    m_tags_isSet = false;
    m_tags_isValid = false;
}

void OAITagProjectResult::fromJson(QString jsonString) {
...
void OAITagProjectResult::fromJsonObject(QJsonObject json) {

    m_tags_isValid = ::OpenAPI::fromJsonValue(m_tags, json[QString("tags")]);
    m_tags_isSet = !json[QString("tags")].isNull() && m_tags_isValid;
}

QString OAITagProjectResult::asJson() const {
...
QJsonObject OAITagProjectResult::asJsonObject() const {
    QJsonObject obj;
    if (m_tags.isSet()) {
...
QMap OAITagProjectResult::getTags() const {
    return m_tags;
}
void OAITagProjectResult::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAITagProjectResult::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAITagProjectResult::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAITagProjectResult::isSet() const {
...
bool OAITagProjectResult::isValid() const {
