...
OAIUntagProjectRequest::OAIUntagProjectRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUntagProjectRequest::OAIUntagProjectRequest() {
    this->initializeModel();
}

OAIUntagProjectRequest::~OAIUntagProjectRequest() {}

void OAIUntagProjectRequest::initializeModel() {
...
void OAIUntagProjectRequest::fromJson(QString jsonString) {
...
void OAIUntagProjectRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUntagProjectRequest::asJson() const {
...
QJsonObject OAIUntagProjectRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIUntagProjectRequest::getId() const {
    return m_id;
}
void OAIUntagProjectRequest::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIUntagProjectRequest::is_id_Set() const{
    return m_id_isSet;
}

bool OAIUntagProjectRequest::is_id_Valid() const{
    return m_id_isValid;
}

QList OAIUntagProjectRequest::getTags() const {
    return m_tags;
}
void OAIUntagProjectRequest::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIUntagProjectRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIUntagProjectRequest::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIUntagProjectRequest::isSet() const {
...
bool OAIUntagProjectRequest::isValid() const {
