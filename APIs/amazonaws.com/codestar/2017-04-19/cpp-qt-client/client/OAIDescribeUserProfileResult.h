...
/*
 * OAIDescribeUserProfileResult.h
 *
 * 
 */

#ifndef OAIDescribeUserProfileResult_H
#define OAIDescribeUserProfileResult_H
...
class OAIDescribeUserProfileResult : public OAIObject {
public:
    OAIDescribeUserProfileResult();
    OAIDescribeUserProfileResult(QString json);
    ~OAIDescribeUserProfileResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeUserProfileResult)

#endif // OAIDescribeUserProfileResult_H
