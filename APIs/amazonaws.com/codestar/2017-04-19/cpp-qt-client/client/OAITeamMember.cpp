...
QString OAITeamMember::getUserArn() const {
    return m_user_arn;
}
void OAITeamMember::setUserArn(const QString &user_arn) {
    m_user_arn = user_arn;
    m_user_arn_isSet = true;
}

bool OAITeamMember::is_user_arn_Set() const{
    return m_user_arn_isSet;
}

bool OAITeamMember::is_user_arn_Valid() const{
    return m_user_arn_isValid;
}

QString OAITeamMember::getProjectRole() const {
    return m_project_role;
}
void OAITeamMember::setProjectRole(const QString &project_role) {
    m_project_role = project_role;
    m_project_role_isSet = true;
}

bool OAITeamMember::is_project_role_Set() const{
    return m_project_role_isSet;
}

bool OAITeamMember::is_project_role_Valid() const{
    return m_project_role_isValid;
}

bool OAITeamMember::getRemoteAccessAllowed() const {
    return m_remote_access_allowed;
}
void OAITeamMember::setRemoteAccessAllowed(const bool &remote_access_allowed) {
    m_remote_access_allowed = remote_access_allowed;
    m_remote_access_allowed_isSet = true;
}

bool OAITeamMember::is_remote_access_allowed_Set() const{
    return m_remote_access_allowed_isSet;
}

bool OAITeamMember::is_remote_access_allowed_Valid() const{
...
bool OAITeamMember::isValid() const {
    ...
    return m_user_arn_isValid && m_project_role_isValid && true;
}
