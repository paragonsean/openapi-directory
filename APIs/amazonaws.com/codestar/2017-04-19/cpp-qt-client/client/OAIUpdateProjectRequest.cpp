...
QString OAIUpdateProjectRequest::getId() const {
    return m_id;
}
void OAIUpdateProjectRequest::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIUpdateProjectRequest::is_id_Set() const{
    return m_id_isSet;
}

bool OAIUpdateProjectRequest::is_id_Valid() const{
    return m_id_isValid;
}
