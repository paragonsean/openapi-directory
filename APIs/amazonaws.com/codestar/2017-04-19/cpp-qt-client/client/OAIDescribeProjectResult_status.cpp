...
OAIDescribeProjectResult_status::OAIDescribeProjectResult_status(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeProjectResult_status::OAIDescribeProjectResult_status() {
    this->initializeModel();
}

OAIDescribeProjectResult_status::~OAIDescribeProjectResult_status() {}

void OAIDescribeProjectResult_status::initializeModel() {
...
void OAIDescribeProjectResult_status::fromJson(QString jsonString) {
...
void OAIDescribeProjectResult_status::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeProjectResult_status::asJson() const {
...
QJsonObject OAIDescribeProjectResult_status::asJsonObject() const {
    QJsonObject obj;
    if (m_state_isSet) {
...
QString OAIDescribeProjectResult_status::getState() const {
    return m_state;
}
void OAIDescribeProjectResult_status::setState(const QString &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIDescribeProjectResult_status::is_state_Set() const{
    return m_state_isSet;
}

bool OAIDescribeProjectResult_status::is_state_Valid() const{
    return m_state_isValid;
}

QString OAIDescribeProjectResult_status::getReason() const {
    return m_reason;
}
void OAIDescribeProjectResult_status::setReason(const QString &reason) {
    m_reason = reason;
    m_reason_isSet = true;
}

bool OAIDescribeProjectResult_status::is_reason_Set() const{
    return m_reason_isSet;
}

bool OAIDescribeProjectResult_status::is_reason_Valid() const{
    return m_reason_isValid;
}

bool OAIDescribeProjectResult_status::isSet() const {
...
bool OAIDescribeProjectResult_status::isValid() const {
