...
/*
 * OAICodeDestination.h
 *
 * The repository to be created in AWS CodeStar. Valid values are AWS CodeCommit or GitHub. After AWS CodeStar provisions the new repository, the source code files provided with the project request are placed in the repository.
 */

#ifndef OAICodeDestination_H
#define OAICodeDestination_H
...
class OAICodeDestination : public OAIObject {
public:
    OAICodeDestination();
    OAICodeDestination(QString json);
    ~OAICodeDestination() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodeDestination)

#endif // OAICodeDestination_H
