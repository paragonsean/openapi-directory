...
OAICodeDestination_codeCommit::OAICodeDestination_codeCommit(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICodeDestination_codeCommit::OAICodeDestination_codeCommit() {
    this->initializeModel();
}

OAICodeDestination_codeCommit::~OAICodeDestination_codeCommit() {}

void OAICodeDestination_codeCommit::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;
}

void OAICodeDestination_codeCommit::fromJson(QString jsonString) {
...
void OAICodeDestination_codeCommit::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("name")]);
    m_name_isSet = !json[QString("name")].isNull() && m_name_isValid;
}

QString OAICodeDestination_codeCommit::asJson() const {
...
QJsonObject OAICodeDestination_codeCommit::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAICodeDestination_codeCommit::getName() const {
    return m_name;
}
void OAICodeDestination_codeCommit::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICodeDestination_codeCommit::is_name_Set() const{
    return m_name_isSet;
}

bool OAICodeDestination_codeCommit::is_name_Valid() const{
    return m_name_isValid;
}

bool OAICodeDestination_codeCommit::isSet() const {
...
bool OAICodeDestination_codeCommit::isValid() const {
