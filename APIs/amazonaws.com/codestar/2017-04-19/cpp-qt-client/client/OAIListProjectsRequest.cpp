...
OAIListProjectsRequest::OAIListProjectsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListProjectsRequest::OAIListProjectsRequest() {
    this->initializeModel();
}

OAIListProjectsRequest::~OAIListProjectsRequest() {}

void OAIListProjectsRequest::initializeModel() {
...
void OAIListProjectsRequest::fromJson(QString jsonString) {
...
void OAIListProjectsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListProjectsRequest::asJson() const {
...
QJsonObject OAIListProjectsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListProjectsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListProjectsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListProjectsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListProjectsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListProjectsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListProjectsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListProjectsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListProjectsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListProjectsRequest::isSet() const {
...
bool OAIListProjectsRequest::isValid() const {
