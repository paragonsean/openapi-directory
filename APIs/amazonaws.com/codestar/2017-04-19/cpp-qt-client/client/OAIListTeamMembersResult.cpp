...
OAIListTeamMembersResult::OAIListTeamMembersResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListTeamMembersResult::OAIListTeamMembersResult() {
    this->initializeModel();
}

OAIListTeamMembersResult::~OAIListTeamMembersResult() {}

void OAIListTeamMembersResult::initializeModel() {
...
void OAIListTeamMembersResult::fromJson(QString jsonString) {
...
void OAIListTeamMembersResult::fromJsonObject(QJsonObject json) {
...
QString OAIListTeamMembersResult::asJson() const {
...
QJsonObject OAIListTeamMembersResult::asJsonObject() const {
    QJsonObject obj;
    if (m_team_members.isSet()) {
...
QList OAIListTeamMembersResult::getTeamMembers() const {
    return m_team_members;
}
void OAIListTeamMembersResult::setTeamMembers(const QList &team_members) {
    m_team_members = team_members;
    m_team_members_isSet = true;
}

bool OAIListTeamMembersResult::is_team_members_Set() const{
    return m_team_members_isSet;
}

bool OAIListTeamMembersResult::is_team_members_Valid() const{
    return m_team_members_isValid;
}

QString OAIListTeamMembersResult::getNextToken() const {
    return m_next_token;
}
void OAIListTeamMembersResult::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListTeamMembersResult::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListTeamMembersResult::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListTeamMembersResult::isSet() const {
...
bool OAIListTeamMembersResult::isValid() const {
