...
/*
 * OAIDisassociateTeamMemberRequest.h
 *
 * 
 */

#ifndef OAIDisassociateTeamMemberRequest_H
#define OAIDisassociateTeamMemberRequest_H
...
class OAIDisassociateTeamMemberRequest : public OAIObject {
public:
    OAIDisassociateTeamMemberRequest();
    OAIDisassociateTeamMemberRequest(QString json);
    ~OAIDisassociateTeamMemberRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateTeamMemberRequest)

#endif // OAIDisassociateTeamMemberRequest_H
