...
/*
 * OAIUpdateUserProfileResult.h
 *
 * 
 */

#ifndef OAIUpdateUserProfileResult_H
#define OAIUpdateUserProfileResult_H
...
class OAIUpdateUserProfileResult : public OAIObject {
public:
    OAIUpdateUserProfileResult();
    OAIUpdateUserProfileResult(QString json);
    ~OAIUpdateUserProfileResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateUserProfileResult)

#endif // OAIUpdateUserProfileResult_H
