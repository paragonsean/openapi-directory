...
/*
 * OAIToolchainSource.h
 *
 * The Amazon S3 location where the toolchain template file provided with the project request is stored. AWS CodeStar retrieves the file during project creation.
 */

#ifndef OAIToolchainSource_H
#define OAIToolchainSource_H
...
class OAIToolchainSource : public OAIObject {
public:
    OAIToolchainSource();
    OAIToolchainSource(QString json);
    ~OAIToolchainSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIToolchainSource)

#endif // OAIToolchainSource_H
