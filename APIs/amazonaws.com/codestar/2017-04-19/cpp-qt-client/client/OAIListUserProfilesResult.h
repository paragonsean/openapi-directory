...
/*
 * OAIListUserProfilesResult.h
 *
 * 
 */

#ifndef OAIListUserProfilesResult_H
#define OAIListUserProfilesResult_H
...
class OAIListUserProfilesResult : public OAIObject {
public:
    OAIListUserProfilesResult();
    OAIListUserProfilesResult(QString json);
    ~OAIListUserProfilesResult() override;
    ...
    QList getUserProfiles() const;
    void setUserProfiles(const QList &user_profiles);
    bool is_user_profiles_Set() const;
    bool is_user_profiles_Valid() const;
...
private:
    ...
    QList m_user_profiles;
    bool m_user_profiles_isSet;
    bool m_user_profiles_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListUserProfilesResult)

#endif // OAIListUserProfilesResult_H
