...
#ifndef OAICodeSource_s3_H
#define OAICodeSource_s3_H
...
class OAICodeSource_s3 : public OAIObject {
public:
    OAICodeSource_s3();
    OAICodeSource_s3(QString json);
    ~OAICodeSource_s3() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodeSource_s3)

#endif // OAICodeSource_s3_H
