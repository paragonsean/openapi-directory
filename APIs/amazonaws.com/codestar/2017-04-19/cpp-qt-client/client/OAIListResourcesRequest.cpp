...
QString OAIListResourcesRequest::getProjectId() const {
    return m_project_id;
}
void OAIListResourcesRequest::setProjectId(const QString &project_id) {
    m_project_id = project_id;
    m_project_id_isSet = true;
}

bool OAIListResourcesRequest::is_project_id_Set() const{
    return m_project_id_isSet;
}

bool OAIListResourcesRequest::is_project_id_Valid() const{
