...
QString OAIUpdateUserProfileRequest::getUserArn() const {
    return m_user_arn;
}
void OAIUpdateUserProfileRequest::setUserArn(const QString &user_arn) {
    m_user_arn = user_arn;
    m_user_arn_isSet = true;
}

bool OAIUpdateUserProfileRequest::is_user_arn_Set() const{
    return m_user_arn_isSet;
}

bool OAIUpdateUserProfileRequest::is_user_arn_Valid() const{
    return m_user_arn_isValid;
}

QString OAIUpdateUserProfileRequest::getDisplayName() const {
    return m_display_name;
}
void OAIUpdateUserProfileRequest::setDisplayName(const QString &display_name) {
    m_display_name = display_name;
    m_display_name_isSet = true;
}

bool OAIUpdateUserProfileRequest::is_display_name_Set() const{
    return m_display_name_isSet;
}

bool OAIUpdateUserProfileRequest::is_display_name_Valid() const{
    return m_display_name_isValid;
}

QString OAIUpdateUserProfileRequest::getEmailAddress() const {
    return m_email_address;
}
void OAIUpdateUserProfileRequest::setEmailAddress(const QString &email_address) {
    m_email_address = email_address;
    m_email_address_isSet = true;
}

bool OAIUpdateUserProfileRequest::is_email_address_Set() const{
    return m_email_address_isSet;
}

bool OAIUpdateUserProfileRequest::is_email_address_Valid() const{
    return m_email_address_isValid;
}

QString OAIUpdateUserProfileRequest::getSshPublicKey() const {
    return m_ssh_public_key;
}
void OAIUpdateUserProfileRequest::setSshPublicKey(const QString &ssh_public_key) {
    m_ssh_public_key = ssh_public_key;
    m_ssh_public_key_isSet = true;
}

bool OAIUpdateUserProfileRequest::is_ssh_public_key_Set() const{
    return m_ssh_public_key_isSet;
}

bool OAIUpdateUserProfileRequest::is_ssh_public_key_Valid() const{
