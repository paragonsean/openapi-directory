...
#ifndef OAIToolchain_H
#define OAIToolchain_H
...
class OAIToolchain : public OAIObject {
public:
    OAIToolchain();
    OAIToolchain(QString json);
    ~OAIToolchain() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIToolchain)

#endif // OAIToolchain_H
