...
/**
 * Model tests for ListResourcesResult
 */
public class ListResourcesResultTest {
    private final ListResourcesResult model = new ListResourcesResult();
