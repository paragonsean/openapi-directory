...
public class ListProjectsRequest {
  ...
  public ListProjectsRequest nextToken(String nextToken) {
  ...
  public ListProjectsRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nextToken, listProjectsRequest.nextToken) &&
        Objects.equals(this.maxResults, listProjectsRequest.maxResults);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListProjectsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListProjectsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListProjectsRequest is not found in the empty JSON string", ListProjectsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListProjectsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListProjectsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListProjectsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListProjectsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListProjectsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListProjectsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListProjectsRequest>() {
           @Override
           public void write(JsonWriter out, ListProjectsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListProjectsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListProjectsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListProjectsRequest
   * @throws IOException if the JSON string is invalid with respect to ListProjectsRequest
   */
  public static ListProjectsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListProjectsRequest.class);
  }

  /**
   * Convert an instance of ListProjectsRequest to an JSON string
   *
   * @return JSON string
   */
