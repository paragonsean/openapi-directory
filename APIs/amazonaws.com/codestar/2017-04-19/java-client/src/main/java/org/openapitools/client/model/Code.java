...
public class Code {
  ...
  public Code source(CodeSource source) {
    this.source = source;
    return this;
  }
  ...
  public Code destination(CodeDestination destination) {
  ...
  public boolean equals(Object o) {
    ...
    Code code = (Code) o;
    return Objects.equals(this.source, code.source) &&
        Objects.equals(this.destination, code.destination);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      CodeSource.validateJsonElement(jsonObj.get("source"));
      // validate the required field `destination`
      CodeDestination.validateJsonElement(jsonObj.get("destination"));
  }
