...
public class AssociateTeamMemberResult {
  ...
  public AssociateTeamMemberResult clientRequestToken(String clientRequestToken) {
  ...
  public boolean equals(Object o) {
    ...
    AssociateTeamMemberResult associateTeamMemberResult = (AssociateTeamMemberResult) o;
    return Objects.equals(this.clientRequestToken, associateTeamMemberResult.clientRequestToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientRequestToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AssociateTeamMemberResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssociateTeamMemberResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssociateTeamMemberResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssociateTeamMemberResult is not found in the empty JSON string", AssociateTeamMemberResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssociateTeamMemberResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssociateTeamMemberResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssociateTeamMemberResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssociateTeamMemberResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssociateTeamMemberResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssociateTeamMemberResult.class));

       return (TypeAdapter<T>) new TypeAdapter<AssociateTeamMemberResult>() {
           @Override
           public void write(JsonWriter out, AssociateTeamMemberResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssociateTeamMemberResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssociateTeamMemberResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssociateTeamMemberResult
   * @throws IOException if the JSON string is invalid with respect to AssociateTeamMemberResult
   */
  public static AssociateTeamMemberResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssociateTeamMemberResult.class);
  }

  /**
   * Convert an instance of AssociateTeamMemberResult to an JSON string
   *
   * @return JSON string
   */
