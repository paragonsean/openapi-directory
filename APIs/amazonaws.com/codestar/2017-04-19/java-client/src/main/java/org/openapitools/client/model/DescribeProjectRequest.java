...
public class DescribeProjectRequest {
  ...
  public DescribeProjectRequest id(String id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, describeProjectRequest.id);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeProjectRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeProjectRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeProjectRequest is not found in the empty JSON string", DescribeProjectRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeProjectRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeProjectRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeProjectRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeProjectRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeProjectRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeProjectRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeProjectRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeProjectRequest>() {
           @Override
           public void write(JsonWriter out, DescribeProjectRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeProjectRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeProjectRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeProjectRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeProjectRequest
   */
  public static DescribeProjectRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeProjectRequest.class);
  }

  /**
   * Convert an instance of DescribeProjectRequest to an JSON string
   *
   * @return JSON string
   */
