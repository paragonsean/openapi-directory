...
public class UserProfileSummary {
  ...
  public UserProfileSummary userArn(String userArn) {
  ...
  public UserProfileSummary displayName(String displayName) {
  ...
  public UserProfileSummary emailAddress(String emailAddress) {
  ...
  public UserProfileSummary sshPublicKey(String sshPublicKey) {
  ...
  public boolean equals(Object o) {
    ...
    UserProfileSummary userProfileSummary = (UserProfileSummary) o;
    return Objects.equals(this.userArn, userProfileSummary.userArn) &&
        Objects.equals(this.displayName, userProfileSummary.displayName) &&
        Objects.equals(this.emailAddress, userProfileSummary.emailAddress) &&
        Objects.equals(this.sshPublicKey, userProfileSummary.sshPublicKey);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserProfileSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserProfileSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserProfileSummary is not found in the empty JSON string", UserProfileSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserProfileSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserProfileSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserProfileSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserProfileSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserProfileSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserProfileSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<UserProfileSummary>() {
           @Override
           public void write(JsonWriter out, UserProfileSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserProfileSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UserProfileSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserProfileSummary
   * @throws IOException if the JSON string is invalid with respect to UserProfileSummary
   */
  public static UserProfileSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserProfileSummary.class);
  }

  /**
   * Convert an instance of UserProfileSummary to an JSON string
   *
   * @return JSON string
   */
