...
public class TagProjectRequest {
  ...
  public TagProjectRequest() {
  }

  public TagProjectRequest id(String id) {
    this.id = id;
    return this;
  }
  ...
  public TagProjectRequest tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TagProjectRequest tagProjectRequest = (TagProjectRequest) o;
    return Objects.equals(this.id, tagProjectRequest.id) &&
        Objects.equals(this.tags, tagProjectRequest.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class TagProjectRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TagProjectRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TagProjectRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TagProjectRequest is not found in the empty JSON string", TagProjectRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TagProjectRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TagProjectRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TagProjectRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TagProjectRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TagProjectRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TagProjectRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TagProjectRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TagProjectRequest>() {
           @Override
           public void write(JsonWriter out, TagProjectRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TagProjectRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TagProjectRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TagProjectRequest
   * @throws IOException if the JSON string is invalid with respect to TagProjectRequest
   */
  public static TagProjectRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TagProjectRequest.class);
  }

  /**
   * Convert an instance of TagProjectRequest to an JSON string
   *
   * @return JSON string
   */
