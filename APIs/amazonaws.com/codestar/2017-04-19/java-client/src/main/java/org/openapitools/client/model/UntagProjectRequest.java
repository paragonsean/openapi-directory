...
public class UntagProjectRequest {
  ...
  public UntagProjectRequest() {
  }

  public UntagProjectRequest id(String id) {
    this.id = id;
    return this;
  }
  ...
  public UntagProjectRequest tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UntagProjectRequest untagProjectRequest = (UntagProjectRequest) o;
    return Objects.equals(this.id, untagProjectRequest.id) &&
        Objects.equals(this.tags, untagProjectRequest.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class UntagProjectRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UntagProjectRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UntagProjectRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UntagProjectRequest is not found in the empty JSON string", UntagProjectRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UntagProjectRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UntagProjectRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UntagProjectRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UntagProjectRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UntagProjectRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UntagProjectRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UntagProjectRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UntagProjectRequest>() {
           @Override
           public void write(JsonWriter out, UntagProjectRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UntagProjectRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UntagProjectRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UntagProjectRequest
   * @throws IOException if the JSON string is invalid with respect to UntagProjectRequest
   */
  public static UntagProjectRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UntagProjectRequest.class);
  }

  /**
   * Convert an instance of UntagProjectRequest to an JSON string
   *
   * @return JSON string
   */
