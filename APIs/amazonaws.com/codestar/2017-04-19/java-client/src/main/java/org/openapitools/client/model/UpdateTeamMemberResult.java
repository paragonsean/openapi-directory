...
public class UpdateTeamMemberResult {
  ...
  public UpdateTeamMemberResult userArn(String userArn) {
  ...
  public UpdateTeamMemberResult projectRole(String projectRole) {
  ...
  public UpdateTeamMemberResult remoteAccessAllowed(Boolean remoteAccessAllowed) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateTeamMemberResult updateTeamMemberResult = (UpdateTeamMemberResult) o;
    return Objects.equals(this.userArn, updateTeamMemberResult.userArn) &&
        Objects.equals(this.projectRole, updateTeamMemberResult.projectRole) &&
        Objects.equals(this.remoteAccessAllowed, updateTeamMemberResult.remoteAccessAllowed);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateTeamMemberResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateTeamMemberResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateTeamMemberResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateTeamMemberResult is not found in the empty JSON string", UpdateTeamMemberResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateTeamMemberResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateTeamMemberResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateTeamMemberResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateTeamMemberResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateTeamMemberResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateTeamMemberResult.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateTeamMemberResult>() {
           @Override
           public void write(JsonWriter out, UpdateTeamMemberResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateTeamMemberResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateTeamMemberResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateTeamMemberResult
   * @throws IOException if the JSON string is invalid with respect to UpdateTeamMemberResult
   */
  public static UpdateTeamMemberResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateTeamMemberResult.class);
  }

  /**
   * Convert an instance of UpdateTeamMemberResult to an JSON string
   *
   * @return JSON string
   */
