...
public class UpdateUserProfileResult {
  ...
  public UpdateUserProfileResult userArn(String userArn) {
  ...
  public UpdateUserProfileResult displayName(String displayName) {
  ...
  public UpdateUserProfileResult emailAddress(String emailAddress) {
  ...
  public UpdateUserProfileResult sshPublicKey(String sshPublicKey) {
  ...
  public UpdateUserProfileResult createdTimestamp(OffsetDateTime createdTimestamp) {
  ...
  public UpdateUserProfileResult lastModifiedTimestamp(OffsetDateTime lastModifiedTimestamp) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateUserProfileResult updateUserProfileResult = (UpdateUserProfileResult) o;
    return Objects.equals(this.userArn, updateUserProfileResult.userArn) &&
        Objects.equals(this.displayName, updateUserProfileResult.displayName) &&
        Objects.equals(this.emailAddress, updateUserProfileResult.emailAddress) &&
        Objects.equals(this.sshPublicKey, updateUserProfileResult.sshPublicKey) &&
        Objects.equals(this.createdTimestamp, updateUserProfileResult.createdTimestamp) &&
        Objects.equals(this.lastModifiedTimestamp, updateUserProfileResult.lastModifiedTimestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateUserProfileResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateUserProfileResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateUserProfileResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateUserProfileResult is not found in the empty JSON string", UpdateUserProfileResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateUserProfileResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateUserProfileResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateUserProfileResult.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateUserProfileResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateUserProfileResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateUserProfileResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateUserProfileResult.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateUserProfileResult>() {
           @Override
           public void write(JsonWriter out, UpdateUserProfileResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateUserProfileResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateUserProfileResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateUserProfileResult
   * @throws IOException if the JSON string is invalid with respect to UpdateUserProfileResult
   */
  public static UpdateUserProfileResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateUserProfileResult.class);
  }

  /**
   * Convert an instance of UpdateUserProfileResult to an JSON string
   *
   * @return JSON string
   */
