...
/**
 * Model tests for GetDocumentRequest
 */
public class GetDocumentRequestTest {
    private final GetDocumentRequest model = new GetDocumentRequest();
