...
public class Runbook {
  ...
  public Runbook documentName(String documentName) {
  ...
  public Runbook documentVersion(String documentVersion) {
  ...
  public Runbook parameters(Map parameters) {
  ...
  public Runbook targetParameterName(String targetParameterName) {
  ...
  public Runbook targets(List targets) {
  ...
  public Runbook targetMaps(List targetMaps) {
  ...
  public Runbook maxConcurrency(String maxConcurrency) {
  ...
  public Runbook maxErrors(String maxErrors) {
  ...
  public Runbook targetLocations(List targetLocations) {
  ...
  public boolean equals(Object o) {
    ...
    Runbook runbook = (Runbook) o;
    return Objects.equals(this.documentName, runbook.documentName) &&
        Objects.equals(this.documentVersion, runbook.documentVersion) &&
        Objects.equals(this.parameters, runbook.parameters) &&
        Objects.equals(this.targetParameterName, runbook.targetParameterName) &&
        Objects.equals(this.targets, runbook.targets) &&
        Objects.equals(this.targetMaps, runbook.targetMaps) &&
        Objects.equals(this.maxConcurrency, runbook.maxConcurrency) &&
        Objects.equals(this.maxErrors, runbook.maxErrors) &&
        Objects.equals(this.targetLocations, runbook.targetLocations);
  }

  @Override
  public int hashCode() {
    return Objects.hash(documentName, documentVersion, parameters, targetParameterName, targets, targetMaps, maxConcurrency, maxErrors, targetLocations);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Runbook {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Runbook
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Runbook.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Runbook is not found in the empty JSON string", Runbook.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Runbook.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Runbook` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Runbook.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Runbook.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Runbook' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Runbook> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Runbook.class));

       return (TypeAdapter<T>) new TypeAdapter<Runbook>() {
           @Override
           public void write(JsonWriter out, Runbook value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Runbook read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Runbook given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Runbook
   * @throws IOException if the JSON string is invalid with respect to Runbook
   */
  public static Runbook fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Runbook.class);
  }

  /**
   * Convert an instance of Runbook to an JSON string
   *
   * @return JSON string
   */
