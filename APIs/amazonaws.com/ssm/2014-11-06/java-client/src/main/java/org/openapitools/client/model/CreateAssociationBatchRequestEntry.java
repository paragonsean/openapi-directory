...
public class CreateAssociationBatchRequestEntry {
  ...
  public CreateAssociationBatchRequestEntry name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateAssociationBatchRequestEntry instanceId(String instanceId) {
  ...
  public CreateAssociationBatchRequestEntry parameters(Map parameters) {
  ...
  public CreateAssociationBatchRequestEntry automationTargetParameterName(String automationTargetParameterName) {
  ...
  public CreateAssociationBatchRequestEntry documentVersion(String documentVersion) {
  ...
  public CreateAssociationBatchRequestEntry targets(List targets) {
  ...
  public CreateAssociationBatchRequestEntry scheduleExpression(String scheduleExpression) {
  ...
  public CreateAssociationBatchRequestEntry outputLocation(UpdateAssociationRequestOutputLocation outputLocation) {
  ...
  public CreateAssociationBatchRequestEntry associationName(String associationName) {
  ...
  public CreateAssociationBatchRequestEntry maxErrors(String maxErrors) {
  ...
  public CreateAssociationBatchRequestEntry maxConcurrency(String maxConcurrency) {
  ...
  public CreateAssociationBatchRequestEntry complianceSeverity(AssociationComplianceSeverity complianceSeverity) {
  ...
  public CreateAssociationBatchRequestEntry syncCompliance(AssociationSyncCompliance syncCompliance) {
  ...
  public CreateAssociationBatchRequestEntry applyOnlyAtCronInterval(Boolean applyOnlyAtCronInterval) {
  ...
  public CreateAssociationBatchRequestEntry calendarNames(List calendarNames) {
  ...
  public CreateAssociationBatchRequestEntry targetLocations(List targetLocations) {
  ...
  public CreateAssociationBatchRequestEntry scheduleOffset(Integer scheduleOffset) {
  ...
  public CreateAssociationBatchRequestEntry targetMaps(List targetMaps) {
  ...
  public CreateAssociationBatchRequestEntry alarmConfiguration(AlarmConfiguration alarmConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    CreateAssociationBatchRequestEntry createAssociationBatchRequestEntry = (CreateAssociationBatchRequestEntry) o;
    return Objects.equals(this.name, createAssociationBatchRequestEntry.name) &&
        Objects.equals(this.instanceId, createAssociationBatchRequestEntry.instanceId) &&
        Objects.equals(this.parameters, createAssociationBatchRequestEntry.parameters) &&
        Objects.equals(this.automationTargetParameterName, createAssociationBatchRequestEntry.automationTargetParameterName) &&
        Objects.equals(this.documentVersion, createAssociationBatchRequestEntry.documentVersion) &&
        Objects.equals(this.targets, createAssociationBatchRequestEntry.targets) &&
        Objects.equals(this.scheduleExpression, createAssociationBatchRequestEntry.scheduleExpression) &&
        Objects.equals(this.outputLocation, createAssociationBatchRequestEntry.outputLocation) &&
        Objects.equals(this.associationName, createAssociationBatchRequestEntry.associationName) &&
        Objects.equals(this.maxErrors, createAssociationBatchRequestEntry.maxErrors) &&
        Objects.equals(this.maxConcurrency, createAssociationBatchRequestEntry.maxConcurrency) &&
        Objects.equals(this.complianceSeverity, createAssociationBatchRequestEntry.complianceSeverity) &&
        Objects.equals(this.syncCompliance, createAssociationBatchRequestEntry.syncCompliance) &&
        Objects.equals(this.applyOnlyAtCronInterval, createAssociationBatchRequestEntry.applyOnlyAtCronInterval) &&
        Objects.equals(this.calendarNames, createAssociationBatchRequestEntry.calendarNames) &&
        Objects.equals(this.targetLocations, createAssociationBatchRequestEntry.targetLocations) &&
        Objects.equals(this.scheduleOffset, createAssociationBatchRequestEntry.scheduleOffset) &&
        Objects.equals(this.targetMaps, createAssociationBatchRequestEntry.targetMaps) &&
        Objects.equals(this.alarmConfiguration, createAssociationBatchRequestEntry.alarmConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateAssociationBatchRequestEntry {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateAssociationBatchRequestEntry
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAssociationBatchRequestEntry.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateAssociationBatchRequestEntry is not found in the empty JSON string", CreateAssociationBatchRequestEntry.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateAssociationBatchRequestEntry.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateAssociationBatchRequestEntry` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateAssociationBatchRequestEntry.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAssociationBatchRequestEntry.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAssociationBatchRequestEntry' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAssociationBatchRequestEntry> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAssociationBatchRequestEntry.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAssociationBatchRequestEntry>() {
           @Override
           public void write(JsonWriter out, CreateAssociationBatchRequestEntry value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateAssociationBatchRequestEntry read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateAssociationBatchRequestEntry given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateAssociationBatchRequestEntry
   * @throws IOException if the JSON string is invalid with respect to CreateAssociationBatchRequestEntry
   */
  public static CreateAssociationBatchRequestEntry fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAssociationBatchRequestEntry.class);
  }

  /**
   * Convert an instance of CreateAssociationBatchRequestEntry to an JSON string
   *
   * @return JSON string
   */
