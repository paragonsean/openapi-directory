...
public class CompliantSummarySeveritySummary {
  ...
  public CompliantSummarySeveritySummary() {
  }

  public CompliantSummarySeveritySummary criticalCount(Integer criticalCount) {
  ...
  public CompliantSummarySeveritySummary highCount(Integer highCount) {
  ...
  public CompliantSummarySeveritySummary mediumCount(Integer mediumCount) {
  ...
  public CompliantSummarySeveritySummary lowCount(Integer lowCount) {
  ...
  public CompliantSummarySeveritySummary informationalCount(Integer informationalCount) {
  ...
  public CompliantSummarySeveritySummary unspecifiedCount(Integer unspecifiedCount) {
  ...
  public boolean equals(Object o) {
    ...
    CompliantSummarySeveritySummary compliantSummarySeveritySummary = (CompliantSummarySeveritySummary) o;
    return Objects.equals(this.criticalCount, compliantSummarySeveritySummary.criticalCount) &&
        Objects.equals(this.highCount, compliantSummarySeveritySummary.highCount) &&
        Objects.equals(this.mediumCount, compliantSummarySeveritySummary.mediumCount) &&
        Objects.equals(this.lowCount, compliantSummarySeveritySummary.lowCount) &&
        Objects.equals(this.informationalCount, compliantSummarySeveritySummary.informationalCount) &&
        Objects.equals(this.unspecifiedCount, compliantSummarySeveritySummary.unspecifiedCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class CompliantSummarySeveritySummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CompliantSummarySeveritySummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CompliantSummarySeveritySummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CompliantSummarySeveritySummary is not found in the empty JSON string", CompliantSummarySeveritySummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CompliantSummarySeveritySummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CompliantSummarySeveritySummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompliantSummarySeveritySummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompliantSummarySeveritySummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompliantSummarySeveritySummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompliantSummarySeveritySummary.class));

       return (TypeAdapter<T>) new TypeAdapter<CompliantSummarySeveritySummary>() {
           @Override
           public void write(JsonWriter out, CompliantSummarySeveritySummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CompliantSummarySeveritySummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CompliantSummarySeveritySummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CompliantSummarySeveritySummary
   * @throws IOException if the JSON string is invalid with respect to CompliantSummarySeveritySummary
   */
  public static CompliantSummarySeveritySummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompliantSummarySeveritySummary.class);
  }

  /**
   * Convert an instance of CompliantSummarySeveritySummary to an JSON string
   *
   * @return JSON string
   */
