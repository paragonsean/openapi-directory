...
/**
 * CreateAssociationResultAssociationDescription
 */
...
public class CreateAssociationResultAssociationDescription {
  ...
  public CreateAssociationResultAssociationDescription() {
  }

  public CreateAssociationResultAssociationDescription name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateAssociationResultAssociationDescription instanceId(String instanceId) {
  ...
  public CreateAssociationResultAssociationDescription associationVersion(String associationVersion) {
  ...
  public CreateAssociationResultAssociationDescription date(OffsetDateTime date) {
    this.date = date;
    return this;
  }
  ...
  public CreateAssociationResultAssociationDescription lastUpdateAssociationDate(OffsetDateTime lastUpdateAssociationDate) {
  ...
  public CreateAssociationResultAssociationDescription status(UpdateAssociationStatusRequestAssociationStatus status) {
    this.status = status;
    return this;
  }
  ...
  public CreateAssociationResultAssociationDescription overview(AssociationOverview overview) {
  ...
  public CreateAssociationResultAssociationDescription documentVersion(String documentVersion) {
  ...
  public CreateAssociationResultAssociationDescription automationTargetParameterName(String automationTargetParameterName) {
  ...
  public CreateAssociationResultAssociationDescription parameters(Map parameters) {
  ...
  public CreateAssociationResultAssociationDescription associationId(String associationId) {
  ...
  public CreateAssociationResultAssociationDescription targets(List targets) {
  ...
  public CreateAssociationResultAssociationDescription scheduleExpression(String scheduleExpression) {
  ...
  public CreateAssociationResultAssociationDescription outputLocation(AssociationDescriptionOutputLocation outputLocation) {
  ...
  public CreateAssociationResultAssociationDescription lastExecutionDate(OffsetDateTime lastExecutionDate) {
  ...
  public CreateAssociationResultAssociationDescription lastSuccessfulExecutionDate(OffsetDateTime lastSuccessfulExecutionDate) {
  ...
  public CreateAssociationResultAssociationDescription associationName(String associationName) {
  ...
  public CreateAssociationResultAssociationDescription maxErrors(String maxErrors) {
  ...
  public CreateAssociationResultAssociationDescription maxConcurrency(String maxConcurrency) {
  ...
  public CreateAssociationResultAssociationDescription complianceSeverity(AssociationComplianceSeverity complianceSeverity) {
  ...
  public CreateAssociationResultAssociationDescription syncCompliance(AssociationSyncCompliance syncCompliance) {
  ...
  public CreateAssociationResultAssociationDescription applyOnlyAtCronInterval(Boolean applyOnlyAtCronInterval) {
  ...
  public CreateAssociationResultAssociationDescription calendarNames(List calendarNames) {
  ...
  public CreateAssociationResultAssociationDescription targetLocations(List targetLocations) {
  ...
  public CreateAssociationResultAssociationDescription scheduleOffset(Integer scheduleOffset) {
  ...
  public CreateAssociationResultAssociationDescription targetMaps(List targetMaps) {
  ...
  public CreateAssociationResultAssociationDescription alarmConfiguration(AlarmConfiguration alarmConfiguration) {
  ...
  public CreateAssociationResultAssociationDescription triggeredAlarms(List triggeredAlarms) {
  ...
  public boolean equals(Object o) {
    ...
    CreateAssociationResultAssociationDescription createAssociationResultAssociationDescription = (CreateAssociationResultAssociationDescription) o;
    return Objects.equals(this.name, createAssociationResultAssociationDescription.name) &&
        Objects.equals(this.instanceId, createAssociationResultAssociationDescription.instanceId) &&
        Objects.equals(this.associationVersion, createAssociationResultAssociationDescription.associationVersion) &&
        Objects.equals(this.date, createAssociationResultAssociationDescription.date) &&
        Objects.equals(this.lastUpdateAssociationDate, createAssociationResultAssociationDescription.lastUpdateAssociationDate) &&
        Objects.equals(this.status, createAssociationResultAssociationDescription.status) &&
        Objects.equals(this.overview, createAssociationResultAssociationDescription.overview) &&
        Objects.equals(this.documentVersion, createAssociationResultAssociationDescription.documentVersion) &&
        Objects.equals(this.automationTargetParameterName, createAssociationResultAssociationDescription.automationTargetParameterName) &&
        Objects.equals(this.parameters, createAssociationResultAssociationDescription.parameters) &&
        Objects.equals(this.associationId, createAssociationResultAssociationDescription.associationId) &&
        Objects.equals(this.targets, createAssociationResultAssociationDescription.targets) &&
        Objects.equals(this.scheduleExpression, createAssociationResultAssociationDescription.scheduleExpression) &&
        Objects.equals(this.outputLocation, createAssociationResultAssociationDescription.outputLocation) &&
        Objects.equals(this.lastExecutionDate, createAssociationResultAssociationDescription.lastExecutionDate) &&
        Objects.equals(this.lastSuccessfulExecutionDate, createAssociationResultAssociationDescription.lastSuccessfulExecutionDate) &&
        Objects.equals(this.associationName, createAssociationResultAssociationDescription.associationName) &&
        Objects.equals(this.maxErrors, createAssociationResultAssociationDescription.maxErrors) &&
        Objects.equals(this.maxConcurrency, createAssociationResultAssociationDescription.maxConcurrency) &&
        Objects.equals(this.complianceSeverity, createAssociationResultAssociationDescription.complianceSeverity) &&
        Objects.equals(this.syncCompliance, createAssociationResultAssociationDescription.syncCompliance) &&
        Objects.equals(this.applyOnlyAtCronInterval, createAssociationResultAssociationDescription.applyOnlyAtCronInterval) &&
        Objects.equals(this.calendarNames, createAssociationResultAssociationDescription.calendarNames) &&
        Objects.equals(this.targetLocations, createAssociationResultAssociationDescription.targetLocations) &&
        Objects.equals(this.scheduleOffset, createAssociationResultAssociationDescription.scheduleOffset) &&
        Objects.equals(this.targetMaps, createAssociationResultAssociationDescription.targetMaps) &&
        Objects.equals(this.alarmConfiguration, createAssociationResultAssociationDescription.alarmConfiguration) &&
        Objects.equals(this.triggeredAlarms, createAssociationResultAssociationDescription.triggeredAlarms);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateAssociationResultAssociationDescription {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateAssociationResultAssociationDescription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAssociationResultAssociationDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateAssociationResultAssociationDescription is not found in the empty JSON string", CreateAssociationResultAssociationDescription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateAssociationResultAssociationDescription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateAssociationResultAssociationDescription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAssociationResultAssociationDescription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAssociationResultAssociationDescription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAssociationResultAssociationDescription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAssociationResultAssociationDescription.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAssociationResultAssociationDescription>() {
           @Override
           public void write(JsonWriter out, CreateAssociationResultAssociationDescription value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateAssociationResultAssociationDescription read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateAssociationResultAssociationDescription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateAssociationResultAssociationDescription
   * @throws IOException if the JSON string is invalid with respect to CreateAssociationResultAssociationDescription
   */
  public static CreateAssociationResultAssociationDescription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAssociationResultAssociationDescription.class);
  }

  /**
   * Convert an instance of CreateAssociationResultAssociationDescription to an JSON string
   *
   * @return JSON string
   */
