...
public class PatchBaselineIdentity {
  ...
  public PatchBaselineIdentity baselineId(String baselineId) {
  ...
  public PatchBaselineIdentity baselineName(String baselineName) {
  ...
  public PatchBaselineIdentity operatingSystem(OperatingSystem operatingSystem) {
  ...
  public PatchBaselineIdentity baselineDescription(String baselineDescription) {
  ...
  public PatchBaselineIdentity defaultBaseline(Boolean defaultBaseline) {
  ...
  public boolean equals(Object o) {
    ...
    PatchBaselineIdentity patchBaselineIdentity = (PatchBaselineIdentity) o;
    return Objects.equals(this.baselineId, patchBaselineIdentity.baselineId) &&
        Objects.equals(this.baselineName, patchBaselineIdentity.baselineName) &&
        Objects.equals(this.operatingSystem, patchBaselineIdentity.operatingSystem) &&
        Objects.equals(this.baselineDescription, patchBaselineIdentity.baselineDescription) &&
        Objects.equals(this.defaultBaseline, patchBaselineIdentity.defaultBaseline);
  }
  ...
  public String toString() {
    ...
    sb.append("class PatchBaselineIdentity {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PatchBaselineIdentity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PatchBaselineIdentity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PatchBaselineIdentity is not found in the empty JSON string", PatchBaselineIdentity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PatchBaselineIdentity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PatchBaselineIdentity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PatchBaselineIdentity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PatchBaselineIdentity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PatchBaselineIdentity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PatchBaselineIdentity.class));

       return (TypeAdapter<T>) new TypeAdapter<PatchBaselineIdentity>() {
           @Override
           public void write(JsonWriter out, PatchBaselineIdentity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PatchBaselineIdentity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PatchBaselineIdentity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PatchBaselineIdentity
   * @throws IOException if the JSON string is invalid with respect to PatchBaselineIdentity
   */
  public static PatchBaselineIdentity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PatchBaselineIdentity.class);
  }

  /**
   * Convert an instance of PatchBaselineIdentity to an JSON string
   *
   * @return JSON string
   */
