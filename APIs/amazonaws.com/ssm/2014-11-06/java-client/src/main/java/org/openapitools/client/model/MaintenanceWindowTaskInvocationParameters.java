...
public class MaintenanceWindowTaskInvocationParameters {
  ...
  public MaintenanceWindowTaskInvocationParameters runCommand(MaintenanceWindowTaskInvocationParametersRunCommand runCommand) {
  ...
  public MaintenanceWindowTaskInvocationParameters automation(MaintenanceWindowTaskInvocationParametersAutomation automation) {
  ...
  public MaintenanceWindowTaskInvocationParameters stepFunctions(MaintenanceWindowTaskInvocationParametersStepFunctions stepFunctions) {
  ...
  public MaintenanceWindowTaskInvocationParameters lambda(MaintenanceWindowTaskInvocationParametersLambda lambda) {
    this.lambda = lambda;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MaintenanceWindowTaskInvocationParameters maintenanceWindowTaskInvocationParameters = (MaintenanceWindowTaskInvocationParameters) o;
    return Objects.equals(this.runCommand, maintenanceWindowTaskInvocationParameters.runCommand) &&
        Objects.equals(this.automation, maintenanceWindowTaskInvocationParameters.automation) &&
        Objects.equals(this.stepFunctions, maintenanceWindowTaskInvocationParameters.stepFunctions) &&
        Objects.equals(this.lambda, maintenanceWindowTaskInvocationParameters.lambda);
  }
  ...
  public String toString() {
    ...
    sb.append("class MaintenanceWindowTaskInvocationParameters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MaintenanceWindowTaskInvocationParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MaintenanceWindowTaskInvocationParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MaintenanceWindowTaskInvocationParameters is not found in the empty JSON string", MaintenanceWindowTaskInvocationParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MaintenanceWindowTaskInvocationParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MaintenanceWindowTaskInvocationParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MaintenanceWindowTaskInvocationParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MaintenanceWindowTaskInvocationParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MaintenanceWindowTaskInvocationParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MaintenanceWindowTaskInvocationParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<MaintenanceWindowTaskInvocationParameters>() {
           @Override
           public void write(JsonWriter out, MaintenanceWindowTaskInvocationParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MaintenanceWindowTaskInvocationParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MaintenanceWindowTaskInvocationParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MaintenanceWindowTaskInvocationParameters
   * @throws IOException if the JSON string is invalid with respect to MaintenanceWindowTaskInvocationParameters
   */
  public static MaintenanceWindowTaskInvocationParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MaintenanceWindowTaskInvocationParameters.class);
  }

  /**
   * Convert an instance of MaintenanceWindowTaskInvocationParameters to an JSON string
   *
   * @return JSON string
   */
