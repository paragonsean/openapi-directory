...
public class BaselineOverride {
  ...
  public BaselineOverride operatingSystem(OperatingSystem operatingSystem) {
  ...
  public BaselineOverride globalFilters(PatchFilterGroup globalFilters) {
  ...
  public BaselineOverride approvalRules(PatchRuleGroup approvalRules) {
  ...
  public BaselineOverride approvedPatches(List approvedPatches) {
  ...
  public BaselineOverride approvedPatchesComplianceLevel(PatchComplianceLevel approvedPatchesComplianceLevel) {
  ...
  public BaselineOverride rejectedPatches(List rejectedPatches) {
  ...
  public BaselineOverride rejectedPatchesAction(PatchAction rejectedPatchesAction) {
  ...
  public BaselineOverride approvedPatchesEnableNonSecurity(Boolean approvedPatchesEnableNonSecurity) {
  ...
  public BaselineOverride sources(List sources) {
  ...
  public boolean equals(Object o) {
    ...
    BaselineOverride baselineOverride = (BaselineOverride) o;
    return Objects.equals(this.operatingSystem, baselineOverride.operatingSystem) &&
        Objects.equals(this.globalFilters, baselineOverride.globalFilters) &&
        Objects.equals(this.approvalRules, baselineOverride.approvalRules) &&
        Objects.equals(this.approvedPatches, baselineOverride.approvedPatches) &&
        Objects.equals(this.approvedPatchesComplianceLevel, baselineOverride.approvedPatchesComplianceLevel) &&
        Objects.equals(this.rejectedPatches, baselineOverride.rejectedPatches) &&
        Objects.equals(this.rejectedPatchesAction, baselineOverride.rejectedPatchesAction) &&
        Objects.equals(this.approvedPatchesEnableNonSecurity, baselineOverride.approvedPatchesEnableNonSecurity) &&
        Objects.equals(this.sources, baselineOverride.sources);
  }
  ...
  public String toString() {
    ...
    sb.append("class BaselineOverride {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BaselineOverride
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BaselineOverride.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BaselineOverride is not found in the empty JSON string", BaselineOverride.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BaselineOverride.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BaselineOverride` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BaselineOverride.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BaselineOverride' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BaselineOverride> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BaselineOverride.class));

       return (TypeAdapter<T>) new TypeAdapter<BaselineOverride>() {
           @Override
           public void write(JsonWriter out, BaselineOverride value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BaselineOverride read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BaselineOverride given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BaselineOverride
   * @throws IOException if the JSON string is invalid with respect to BaselineOverride
   */
  public static BaselineOverride fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BaselineOverride.class);
  }

  /**
   * Convert an instance of BaselineOverride to an JSON string
   *
   * @return JSON string
   */
