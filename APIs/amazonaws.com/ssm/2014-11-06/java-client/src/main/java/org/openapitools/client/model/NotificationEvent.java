 ...
 */
@JsonAdapter(NotificationEvent.Adapter.class)
public enum NotificationEvent {
  ...
  public static class Adapter extends TypeAdapter<NotificationEvent> {
    @Override
    public void write(final JsonWriter jsonWriter, final NotificationEvent enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public NotificationEvent read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return NotificationEvent.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    NotificationEvent.fromValue(value);
  }
}
