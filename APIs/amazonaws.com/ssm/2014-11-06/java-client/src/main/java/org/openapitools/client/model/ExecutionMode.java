 ...
 */
@JsonAdapter(ExecutionMode.Adapter.class)
public enum ExecutionMode {
  ...
  public static class Adapter extends TypeAdapter<ExecutionMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final ExecutionMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ExecutionMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ExecutionMode.fromValue(value);
    }
  }
