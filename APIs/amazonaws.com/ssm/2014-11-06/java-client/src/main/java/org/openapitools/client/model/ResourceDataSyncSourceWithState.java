...
public class ResourceDataSyncSourceWithState {
  ...
  public ResourceDataSyncSourceWithState sourceType(String sourceType) {
  ...
  public ResourceDataSyncSourceWithState awsOrganizationsSource(ResourceDataSyncSourceWithStateAwsOrganizationsSource awsOrganizationsSource) {
  ...
  public ResourceDataSyncSourceWithState sourceRegions(List sourceRegions) {
  ...
  public ResourceDataSyncSourceWithState includeFutureRegions(Boolean includeFutureRegions) {
  ...
  public ResourceDataSyncSourceWithState state(String state) {
    this.state = state;
    return this;
  }
  ...
  public ResourceDataSyncSourceWithState enableAllOpsDataSources(Boolean enableAllOpsDataSources) {
  ...
  public boolean equals(Object o) {
    ...
    ResourceDataSyncSourceWithState resourceDataSyncSourceWithState = (ResourceDataSyncSourceWithState) o;
    return Objects.equals(this.sourceType, resourceDataSyncSourceWithState.sourceType) &&
        Objects.equals(this.awsOrganizationsSource, resourceDataSyncSourceWithState.awsOrganizationsSource) &&
        Objects.equals(this.sourceRegions, resourceDataSyncSourceWithState.sourceRegions) &&
        Objects.equals(this.includeFutureRegions, resourceDataSyncSourceWithState.includeFutureRegions) &&
        Objects.equals(this.state, resourceDataSyncSourceWithState.state) &&
        Objects.equals(this.enableAllOpsDataSources, resourceDataSyncSourceWithState.enableAllOpsDataSources);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResourceDataSyncSourceWithState {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResourceDataSyncSourceWithState
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceDataSyncSourceWithState.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceDataSyncSourceWithState is not found in the empty JSON string", ResourceDataSyncSourceWithState.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResourceDataSyncSourceWithState.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceDataSyncSourceWithState` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceDataSyncSourceWithState.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceDataSyncSourceWithState' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceDataSyncSourceWithState> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceDataSyncSourceWithState.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceDataSyncSourceWithState>() {
           @Override
           public void write(JsonWriter out, ResourceDataSyncSourceWithState value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceDataSyncSourceWithState read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResourceDataSyncSourceWithState given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResourceDataSyncSourceWithState
   * @throws IOException if the JSON string is invalid with respect to ResourceDataSyncSourceWithState
   */
  public static ResourceDataSyncSourceWithState fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceDataSyncSourceWithState.class);
  }

  /**
   * Convert an instance of ResourceDataSyncSourceWithState to an JSON string
   *
   * @return JSON string
   */
