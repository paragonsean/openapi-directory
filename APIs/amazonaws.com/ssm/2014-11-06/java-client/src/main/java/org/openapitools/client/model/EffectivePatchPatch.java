...
public class EffectivePatchPatch {
  ...
  public EffectivePatchPatch() {
  }

  public EffectivePatchPatch id(String id) {
    this.id = id;
    return this;
  }
  ...
  public EffectivePatchPatch releaseDate(OffsetDateTime releaseDate) {
  ...
  public EffectivePatchPatch title(String title) {
    this.title = title;
    return this;
  }
  ...
  public EffectivePatchPatch description(String description) {
  ...
  public EffectivePatchPatch contentUrl(String contentUrl) {
  ...
  public EffectivePatchPatch vendor(String vendor) {
    this.vendor = vendor;
    return this;
  }
  ...
  public EffectivePatchPatch productFamily(String productFamily) {
  ...
  public EffectivePatchPatch product(String product) {
  ...
  public EffectivePatchPatch classification(String classification) {
  ...
  public EffectivePatchPatch msrcSeverity(String msrcSeverity) {
  ...
  public EffectivePatchPatch kbNumber(String kbNumber) {
  ...
  public EffectivePatchPatch msrcNumber(String msrcNumber) {
  ...
  public EffectivePatchPatch language(String language) {
  ...
  public EffectivePatchPatch advisoryIds(List advisoryIds) {
  ...
  public EffectivePatchPatch bugzillaIds(List bugzillaIds) {
  ...
  public EffectivePatchPatch cvEIds(List cvEIds) {
    this.cvEIds = cvEIds;
    return this;
  }
  ...
  public EffectivePatchPatch name(String name) {
    this.name = name;
    return this;
  }
  ...
  public EffectivePatchPatch epoch(Integer epoch) {
    this.epoch = epoch;
    return this;
  }
  ...
  public EffectivePatchPatch version(String version) {
  ...
  public EffectivePatchPatch release(String release) {
  ...
  public EffectivePatchPatch arch(String arch) {
    this.arch = arch;
    return this;
  }
  ...
  public EffectivePatchPatch severity(String severity) {
  ...
  public EffectivePatchPatch repository(String repository) {
  ...
  public boolean equals(Object o) {
    ...
    EffectivePatchPatch effectivePatchPatch = (EffectivePatchPatch) o;
    return Objects.equals(this.id, effectivePatchPatch.id) &&
        Objects.equals(this.releaseDate, effectivePatchPatch.releaseDate) &&
        Objects.equals(this.title, effectivePatchPatch.title) &&
        Objects.equals(this.description, effectivePatchPatch.description) &&
        Objects.equals(this.contentUrl, effectivePatchPatch.contentUrl) &&
        Objects.equals(this.vendor, effectivePatchPatch.vendor) &&
        Objects.equals(this.productFamily, effectivePatchPatch.productFamily) &&
        Objects.equals(this.product, effectivePatchPatch.product) &&
        Objects.equals(this.classification, effectivePatchPatch.classification) &&
        Objects.equals(this.msrcSeverity, effectivePatchPatch.msrcSeverity) &&
        Objects.equals(this.kbNumber, effectivePatchPatch.kbNumber) &&
        Objects.equals(this.msrcNumber, effectivePatchPatch.msrcNumber) &&
        Objects.equals(this.language, effectivePatchPatch.language) &&
        Objects.equals(this.advisoryIds, effectivePatchPatch.advisoryIds) &&
        Objects.equals(this.bugzillaIds, effectivePatchPatch.bugzillaIds) &&
        Objects.equals(this.cvEIds, effectivePatchPatch.cvEIds) &&
        Objects.equals(this.name, effectivePatchPatch.name) &&
        Objects.equals(this.epoch, effectivePatchPatch.epoch) &&
        Objects.equals(this.version, effectivePatchPatch.version) &&
        Objects.equals(this.release, effectivePatchPatch.release) &&
        Objects.equals(this.arch, effectivePatchPatch.arch) &&
        Objects.equals(this.severity, effectivePatchPatch.severity) &&
        Objects.equals(this.repository, effectivePatchPatch.repository);
  }
  ...
  public String toString() {
    ...
    sb.append("class EffectivePatchPatch {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EffectivePatchPatch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EffectivePatchPatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EffectivePatchPatch is not found in the empty JSON string", EffectivePatchPatch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EffectivePatchPatch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EffectivePatchPatch` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EffectivePatchPatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EffectivePatchPatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EffectivePatchPatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EffectivePatchPatch.class));

       return (TypeAdapter<T>) new TypeAdapter<EffectivePatchPatch>() {
           @Override
           public void write(JsonWriter out, EffectivePatchPatch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EffectivePatchPatch read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EffectivePatchPatch given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EffectivePatchPatch
   * @throws IOException if the JSON string is invalid with respect to EffectivePatchPatch
   */
  public static EffectivePatchPatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EffectivePatchPatch.class);
  }

  /**
   * Convert an instance of EffectivePatchPatch to an JSON string
   *
   * @return JSON string
   */
