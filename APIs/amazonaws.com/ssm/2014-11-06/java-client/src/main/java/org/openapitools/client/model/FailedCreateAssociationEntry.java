...
import org.openapitools.client.model.UpdateAssociationRequestOutputLocation;
...
public class FailedCreateAssociationEntry {
  ...
  private UpdateAssociationRequestOutputLocation outputLocation;
  ...
  public FailedCreateAssociationEntry() {
  }

  public FailedCreateAssociationEntry name(String name) {
    this.name = name;
    return this;
  }
  ...
  public FailedCreateAssociationEntry instanceId(String instanceId) {
  ...
  public FailedCreateAssociationEntry parameters(Map parameters) {
  ...
  public FailedCreateAssociationEntry automationTargetParameterName(String automationTargetParameterName) {
  ...
  public FailedCreateAssociationEntry documentVersion(String documentVersion) {
  ...
  public FailedCreateAssociationEntry targets(List targets) {
  ...
  public FailedCreateAssociationEntry scheduleExpression(String scheduleExpression) {
  ...
  public FailedCreateAssociationEntry outputLocation(UpdateAssociationRequestOutputLocation outputLocation) {
   ...
   */
  @javax.annotation.Nullable
  public UpdateAssociationRequestOutputLocation getOutputLocation() {
    return outputLocation;
  }

  public void setOutputLocation(UpdateAssociationRequestOutputLocation outputLocation) {
    this.outputLocation = outputLocation;
  }


  public FailedCreateAssociationEntry associationName(String associationName) {
  ...
  public FailedCreateAssociationEntry maxErrors(String maxErrors) {
  ...
  public FailedCreateAssociationEntry maxConcurrency(String maxConcurrency) {
  ...
  public FailedCreateAssociationEntry complianceSeverity(AssociationComplianceSeverity complianceSeverity) {
  ...
  public FailedCreateAssociationEntry syncCompliance(AssociationSyncCompliance syncCompliance) {
  ...
  public FailedCreateAssociationEntry applyOnlyAtCronInterval(Boolean applyOnlyAtCronInterval) {
  ...
  public FailedCreateAssociationEntry calendarNames(List calendarNames) {
  ...
  public FailedCreateAssociationEntry targetLocations(List targetLocations) {
  ...
  public FailedCreateAssociationEntry scheduleOffset(Integer scheduleOffset) {
  ...
  public FailedCreateAssociationEntry targetMaps(List targetMaps) {
  ...
  public FailedCreateAssociationEntry alarmConfiguration(AlarmConfiguration alarmConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    FailedCreateAssociationEntry failedCreateAssociationEntry = (FailedCreateAssociationEntry) o;
    return Objects.equals(this.name, failedCreateAssociationEntry.name) &&
        Objects.equals(this.instanceId, failedCreateAssociationEntry.instanceId) &&
        Objects.equals(this.parameters, failedCreateAssociationEntry.parameters) &&
        Objects.equals(this.automationTargetParameterName, failedCreateAssociationEntry.automationTargetParameterName) &&
        Objects.equals(this.documentVersion, failedCreateAssociationEntry.documentVersion) &&
        Objects.equals(this.targets, failedCreateAssociationEntry.targets) &&
        Objects.equals(this.scheduleExpression, failedCreateAssociationEntry.scheduleExpression) &&
        Objects.equals(this.outputLocation, failedCreateAssociationEntry.outputLocation) &&
        Objects.equals(this.associationName, failedCreateAssociationEntry.associationName) &&
        Objects.equals(this.maxErrors, failedCreateAssociationEntry.maxErrors) &&
        Objects.equals(this.maxConcurrency, failedCreateAssociationEntry.maxConcurrency) &&
        Objects.equals(this.complianceSeverity, failedCreateAssociationEntry.complianceSeverity) &&
        Objects.equals(this.syncCompliance, failedCreateAssociationEntry.syncCompliance) &&
        Objects.equals(this.applyOnlyAtCronInterval, failedCreateAssociationEntry.applyOnlyAtCronInterval) &&
        Objects.equals(this.calendarNames, failedCreateAssociationEntry.calendarNames) &&
        Objects.equals(this.targetLocations, failedCreateAssociationEntry.targetLocations) &&
        Objects.equals(this.scheduleOffset, failedCreateAssociationEntry.scheduleOffset) &&
        Objects.equals(this.targetMaps, failedCreateAssociationEntry.targetMaps) &&
        Objects.equals(this.alarmConfiguration, failedCreateAssociationEntry.alarmConfiguration);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, instanceId, parameters, automationTargetParameterName, documentVersion, targets, scheduleExpression, outputLocation, associationName, maxErrors, maxConcurrency, complianceSeverity, syncCompliance, applyOnlyAtCronInterval, calendarNames, targetLocations, scheduleOffset, targetMaps, alarmConfiguration);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FailedCreateAssociationEntry {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FailedCreateAssociationEntry
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FailedCreateAssociationEntry.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FailedCreateAssociationEntry is not found in the empty JSON string", FailedCreateAssociationEntry.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FailedCreateAssociationEntry.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FailedCreateAssociationEntry` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FailedCreateAssociationEntry.openapiRequiredFields) {
      ...
      if (jsonObj.get("OutputLocation") != null && !jsonObj.get("OutputLocation").isJsonNull()) {
        UpdateAssociationRequestOutputLocation.validateJsonElement(jsonObj.get("OutputLocation"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FailedCreateAssociationEntry.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FailedCreateAssociationEntry' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FailedCreateAssociationEntry> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FailedCreateAssociationEntry.class));

       return (TypeAdapter<T>) new TypeAdapter<FailedCreateAssociationEntry>() {
           @Override
           public void write(JsonWriter out, FailedCreateAssociationEntry value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FailedCreateAssociationEntry read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FailedCreateAssociationEntry given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FailedCreateAssociationEntry
   * @throws IOException if the JSON string is invalid with respect to FailedCreateAssociationEntry
   */
  public static FailedCreateAssociationEntry fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FailedCreateAssociationEntry.class);
  }

  /**
   * Convert an instance of FailedCreateAssociationEntry to an JSON string
   *
   * @return JSON string
   */
