...
public class ResourceDataSyncS3Destination {
  ...
  public ResourceDataSyncS3Destination bucketName(String bucketName) {
  ...
  public ResourceDataSyncS3Destination prefix(String prefix) {
    this.prefix = prefix;
    return this;
  }
  ...
  public ResourceDataSyncS3Destination syncFormat(ResourceDataSyncS3Format syncFormat) {
  ...
  public ResourceDataSyncS3Destination region(String region) {
    this.region = region;
    return this;
  }
  ...
  public ResourceDataSyncS3Destination awSKMSKeyARN(String awSKMSKeyARN) {
  ...
  public ResourceDataSyncS3Destination destinationDataSharing(ResourceDataSyncS3DestinationDestinationDataSharing destinationDataSharing) {
  ...
  public boolean equals(Object o) {
    ...
    ResourceDataSyncS3Destination resourceDataSyncS3Destination = (ResourceDataSyncS3Destination) o;
    return Objects.equals(this.bucketName, resourceDataSyncS3Destination.bucketName) &&
        Objects.equals(this.prefix, resourceDataSyncS3Destination.prefix) &&
        Objects.equals(this.syncFormat, resourceDataSyncS3Destination.syncFormat) &&
        Objects.equals(this.region, resourceDataSyncS3Destination.region) &&
        Objects.equals(this.awSKMSKeyARN, resourceDataSyncS3Destination.awSKMSKeyARN) &&
        Objects.equals(this.destinationDataSharing, resourceDataSyncS3Destination.destinationDataSharing);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResourceDataSyncS3Destination {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResourceDataSyncS3Destination
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceDataSyncS3Destination.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceDataSyncS3Destination is not found in the empty JSON string", ResourceDataSyncS3Destination.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResourceDataSyncS3Destination.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceDataSyncS3Destination` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceDataSyncS3Destination.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceDataSyncS3Destination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceDataSyncS3Destination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceDataSyncS3Destination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceDataSyncS3Destination.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceDataSyncS3Destination>() {
           @Override
           public void write(JsonWriter out, ResourceDataSyncS3Destination value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceDataSyncS3Destination read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResourceDataSyncS3Destination given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResourceDataSyncS3Destination
   * @throws IOException if the JSON string is invalid with respect to ResourceDataSyncS3Destination
   */
  public static ResourceDataSyncS3Destination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceDataSyncS3Destination.class);
  }

  /**
   * Convert an instance of ResourceDataSyncS3Destination to an JSON string
   *
   * @return JSON string
   */
