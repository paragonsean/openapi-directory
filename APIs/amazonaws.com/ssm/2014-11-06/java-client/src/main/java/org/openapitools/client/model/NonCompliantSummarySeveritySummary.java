...
/**
 * NonCompliantSummarySeveritySummary
 */
...
public class NonCompliantSummarySeveritySummary {
  ...
  public NonCompliantSummarySeveritySummary() {
  }

  public NonCompliantSummarySeveritySummary criticalCount(Integer criticalCount) {
  ...
  public NonCompliantSummarySeveritySummary highCount(Integer highCount) {
  ...
  public NonCompliantSummarySeveritySummary mediumCount(Integer mediumCount) {
  ...
  public NonCompliantSummarySeveritySummary lowCount(Integer lowCount) {
  ...
  public NonCompliantSummarySeveritySummary informationalCount(Integer informationalCount) {
  ...
  public NonCompliantSummarySeveritySummary unspecifiedCount(Integer unspecifiedCount) {
  ...
  public boolean equals(Object o) {
    ...
    NonCompliantSummarySeveritySummary nonCompliantSummarySeveritySummary = (NonCompliantSummarySeveritySummary) o;
    return Objects.equals(this.criticalCount, nonCompliantSummarySeveritySummary.criticalCount) &&
        Objects.equals(this.highCount, nonCompliantSummarySeveritySummary.highCount) &&
        Objects.equals(this.mediumCount, nonCompliantSummarySeveritySummary.mediumCount) &&
        Objects.equals(this.lowCount, nonCompliantSummarySeveritySummary.lowCount) &&
        Objects.equals(this.informationalCount, nonCompliantSummarySeveritySummary.informationalCount) &&
        Objects.equals(this.unspecifiedCount, nonCompliantSummarySeveritySummary.unspecifiedCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class NonCompliantSummarySeveritySummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NonCompliantSummarySeveritySummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NonCompliantSummarySeveritySummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NonCompliantSummarySeveritySummary is not found in the empty JSON string", NonCompliantSummarySeveritySummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NonCompliantSummarySeveritySummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NonCompliantSummarySeveritySummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NonCompliantSummarySeveritySummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NonCompliantSummarySeveritySummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NonCompliantSummarySeveritySummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NonCompliantSummarySeveritySummary.class));

       return (TypeAdapter<T>) new TypeAdapter<NonCompliantSummarySeveritySummary>() {
           @Override
           public void write(JsonWriter out, NonCompliantSummarySeveritySummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NonCompliantSummarySeveritySummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NonCompliantSummarySeveritySummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NonCompliantSummarySeveritySummary
   * @throws IOException if the JSON string is invalid with respect to NonCompliantSummarySeveritySummary
   */
  public static NonCompliantSummarySeveritySummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NonCompliantSummarySeveritySummary.class);
  }

  /**
   * Convert an instance of NonCompliantSummarySeveritySummary to an JSON string
   *
   * @return JSON string
   */
