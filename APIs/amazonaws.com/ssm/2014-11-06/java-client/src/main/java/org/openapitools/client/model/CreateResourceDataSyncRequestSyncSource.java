...
/**
 * CreateResourceDataSyncRequestSyncSource
 */
...
public class CreateResourceDataSyncRequestSyncSource {
  ...
  public CreateResourceDataSyncRequestSyncSource() {
  }

  public CreateResourceDataSyncRequestSyncSource sourceType(String sourceType) {
  ...
  public CreateResourceDataSyncRequestSyncSource awsOrganizationsSource(ResourceDataSyncSourceAwsOrganizationsSource awsOrganizationsSource) {
  ...
  public CreateResourceDataSyncRequestSyncSource sourceRegions(List sourceRegions) {
  ...
  public CreateResourceDataSyncRequestSyncSource includeFutureRegions(Boolean includeFutureRegions) {
  ...
  public CreateResourceDataSyncRequestSyncSource enableAllOpsDataSources(Boolean enableAllOpsDataSources) {
  ...
  public boolean equals(Object o) {
    ...
    CreateResourceDataSyncRequestSyncSource createResourceDataSyncRequestSyncSource = (CreateResourceDataSyncRequestSyncSource) o;
    return Objects.equals(this.sourceType, createResourceDataSyncRequestSyncSource.sourceType) &&
        Objects.equals(this.awsOrganizationsSource, createResourceDataSyncRequestSyncSource.awsOrganizationsSource) &&
        Objects.equals(this.sourceRegions, createResourceDataSyncRequestSyncSource.sourceRegions) &&
        Objects.equals(this.includeFutureRegions, createResourceDataSyncRequestSyncSource.includeFutureRegions) &&
        Objects.equals(this.enableAllOpsDataSources, createResourceDataSyncRequestSyncSource.enableAllOpsDataSources);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateResourceDataSyncRequestSyncSource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateResourceDataSyncRequestSyncSource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateResourceDataSyncRequestSyncSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateResourceDataSyncRequestSyncSource is not found in the empty JSON string", CreateResourceDataSyncRequestSyncSource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateResourceDataSyncRequestSyncSource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateResourceDataSyncRequestSyncSource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateResourceDataSyncRequestSyncSource.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateResourceDataSyncRequestSyncSource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateResourceDataSyncRequestSyncSource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateResourceDataSyncRequestSyncSource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateResourceDataSyncRequestSyncSource.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateResourceDataSyncRequestSyncSource>() {
           @Override
           public void write(JsonWriter out, CreateResourceDataSyncRequestSyncSource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateResourceDataSyncRequestSyncSource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateResourceDataSyncRequestSyncSource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateResourceDataSyncRequestSyncSource
   * @throws IOException if the JSON string is invalid with respect to CreateResourceDataSyncRequestSyncSource
   */
  public static CreateResourceDataSyncRequestSyncSource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateResourceDataSyncRequestSyncSource.class);
  }

  /**
   * Convert an instance of CreateResourceDataSyncRequestSyncSource to an JSON string
   *
   * @return JSON string
   */
