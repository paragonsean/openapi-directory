 ...
 */
@JsonAdapter(PingStatus.Adapter.class)
public enum PingStatus {
  ...
  public static PingStatus fromValue(String value) {
    for (PingStatus b : PingStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<PingStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final PingStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PingStatus read(final JsonReader jsonReader) throws IOException {
