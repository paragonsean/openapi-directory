...
class NotificationConfig(Model):
    ...
    def __init__(self, notification_arn: str=None, notification_events: List=None, notification_type: NotificationType=None):
        ...
        :param notification_arn: The notification_arn of this NotificationConfig.
        :param notification_events: The notification_events of this NotificationConfig.
    ...
    def notification_arn(self):
        """Gets the notification_arn of this NotificationConfig.


        :return: The notification_arn of this NotificationConfig.
        :rtype: str
        """
    ...
    def notification_arn(self, notification_arn):
        """Sets the notification_arn of this NotificationConfig.
    ...
    def notification_events(self):
        """Gets the notification_events of this NotificationConfig.


        :return: The notification_events of this NotificationConfig.
        :rtype: List
        """
    ...
    def notification_events(self, notification_events):
        """Sets the notification_events of this NotificationConfig.
