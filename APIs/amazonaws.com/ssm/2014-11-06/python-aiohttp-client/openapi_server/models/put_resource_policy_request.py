...
class PutResourcePolicyRequest(Model):
    ...
    def __init__(self, resource_arn: str=None, policy: str=None, policy_id: str=None, policy_hash: str=None):
        ...
        :param policy_id: The policy_id of this PutResourcePolicyRequest.
        :param policy_hash: The policy_hash of this PutResourcePolicyRequest.
        """
        self.openapi_types = {
            'resource_arn': str,
            'policy': str,
    ...
    @property
    def policy_id(self):
        """Gets the policy_id of this PutResourcePolicyRequest.


        :return: The policy_id of this PutResourcePolicyRequest.
        :rtype: str
        """
    ...
    def policy_id(self, policy_id):
        """Sets the policy_id of this PutResourcePolicyRequest.
    ...
    def policy_hash(self):
        """Gets the policy_hash of this PutResourcePolicyRequest.


        :return: The policy_hash of this PutResourcePolicyRequest.
        :rtype: str
        """
    ...
    def policy_hash(self, policy_hash):
        """Sets the policy_hash of this PutResourcePolicyRequest.
