...
class GetMaintenanceWindowTaskResultTaskInvocationParameters(Model):
    ...
    def __init__(self, run_command: MaintenanceWindowTaskInvocationParametersRunCommand=None, automation: MaintenanceWindowTaskInvocationParametersAutomation=None, step_functions: MaintenanceWindowTaskInvocationParametersStepFunctions=None, _lambda: MaintenanceWindowTaskInvocationParametersLambda=None):
        """GetMaintenanceWindowTaskResultTaskInvocationParameters - a model defined in OpenAPI

        :param run_command: The run_command of this GetMaintenanceWindowTaskResultTaskInvocationParameters.
        :param automation: The automation of this GetMaintenanceWindowTaskResultTaskInvocationParameters.
        :param step_functions: The step_functions of this GetMaintenanceWindowTaskResultTaskInvocationParameters.
        :param _lambda: The _lambda of this GetMaintenanceWindowTaskResultTaskInvocationParameters.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetMaintenanceWindowTaskResultTaskInvocationParameters':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GetMaintenanceWindowTaskResult_TaskInvocationParameters of this GetMaintenanceWindowTaskResultTaskInvocationParameters.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def run_command(self):
        """Gets the run_command of this GetMaintenanceWindowTaskResultTaskInvocationParameters.


        :return: The run_command of this GetMaintenanceWindowTaskResultTaskInvocationParameters.
    ...
    def run_command(self, run_command):
        """Sets the run_command of this GetMaintenanceWindowTaskResultTaskInvocationParameters.
    ...
    @property
    def automation(self):
        """Gets the automation of this GetMaintenanceWindowTaskResultTaskInvocationParameters.


        :return: The automation of this GetMaintenanceWindowTaskResultTaskInvocationParameters.
    ...
    def automation(self, automation):
        """Sets the automation of this GetMaintenanceWindowTaskResultTaskInvocationParameters.
    ...
    def step_functions(self):
        """Gets the step_functions of this GetMaintenanceWindowTaskResultTaskInvocationParameters.


        :return: The step_functions of this GetMaintenanceWindowTaskResultTaskInvocationParameters.
    ...
    def step_functions(self, step_functions):
        """Sets the step_functions of this GetMaintenanceWindowTaskResultTaskInvocationParameters.
    ...
    @property
    def _lambda(self):
        """Gets the _lambda of this GetMaintenanceWindowTaskResultTaskInvocationParameters.


        :return: The _lambda of this GetMaintenanceWindowTaskResultTaskInvocationParameters.
    ...
    def _lambda(self, _lambda):
        """Sets the _lambda of this GetMaintenanceWindowTaskResultTaskInvocationParameters.
