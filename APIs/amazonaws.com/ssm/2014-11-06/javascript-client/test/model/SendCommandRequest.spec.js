...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.SendCommandRequest();
  });
  ...
  describe('SendCommandRequest', function() {
    it('should create an instance of SendCommandRequest', function() {
      ...
      //var instance = new AmazonSimpleSystemsManagerSsm.SendCommandRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.SendCommandRequest);
    });
    ...
    it('should have the property documentHash (base name: "DocumentHash")', function() {
      // uncomment below and update the code to test the property documentHash
      //var instance = new AmazonSimpleSystemsManagerSsm.SendCommandRequest();
      //expect(instance).to.be();
    });

    it('should have the property documentHashType (base name: "DocumentHashType")', function() {
      // uncomment below and update the code to test the property documentHashType
      //var instance = new AmazonSimpleSystemsManagerSsm.SendCommandRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property outputS3Region (base name: "OutputS3Region")', function() {
      // uncomment below and update the code to test the property outputS3Region
      //var instance = new AmazonSimpleSystemsManagerSsm.SendCommandRequest();
      //expect(instance).to.be();
    });
