...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.Alarm();
  });
  ...
  describe('Alarm', function() {
    it('should create an instance of Alarm', function() {
      ...
      //var instance = new AmazonSimpleSystemsManagerSsm.Alarm();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.Alarm);
    });
