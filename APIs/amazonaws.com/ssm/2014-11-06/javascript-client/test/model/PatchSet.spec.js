...
(function(root, factory) {
  ...
  describe('PatchSet', function() {
    it('should create an instance of PatchSet', function() {
      // uncomment below and update the code to test PatchSet
      //var instance = new AmazonSimpleSystemsManagerSsm.PatchSet();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.PatchSet);
    });
