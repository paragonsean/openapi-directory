...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ServiceSetting();
  });
  ...
  describe('ServiceSetting', function() {
    it('should create an instance of ServiceSetting', function() {
      // uncomment below and update the code to test ServiceSetting
      //var instance = new AmazonSimpleSystemsManagerSsm.ServiceSetting();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ServiceSetting);
    });
