...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ListAssociationVersionsRequest();
  });
  ...
  describe('ListAssociationVersionsRequest', function() {
    it('should create an instance of ListAssociationVersionsRequest', function() {
      // uncomment below and update the code to test ListAssociationVersionsRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.ListAssociationVersionsRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ListAssociationVersionsRequest);
    });
