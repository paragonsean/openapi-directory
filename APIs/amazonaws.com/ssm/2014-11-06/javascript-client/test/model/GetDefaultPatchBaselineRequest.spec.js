...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.GetDefaultPatchBaselineRequest();
  });
  ...
  describe('GetDefaultPatchBaselineRequest', function() {
    it('should create an instance of GetDefaultPatchBaselineRequest', function() {
      // uncomment below and update the code to test GetDefaultPatchBaselineRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.GetDefaultPatchBaselineRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.GetDefaultPatchBaselineRequest);
    });
