...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.GetCommandInvocationRequest();
  });
  ...
  describe('GetCommandInvocationRequest', function() {
    it('should create an instance of GetCommandInvocationRequest', function() {
      // uncomment below and update the code to test GetCommandInvocationRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.GetCommandInvocationRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.GetCommandInvocationRequest);
    });
