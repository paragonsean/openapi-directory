...
(function(root, factory) {
  ...
  describe('SignalType', function() {
    it('should create an instance of SignalType', function() {
      // uncomment below and update the code to test SignalType
      //var instance = new AmazonSimpleSystemsManagerSsm.SignalType();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.SignalType);
    });
