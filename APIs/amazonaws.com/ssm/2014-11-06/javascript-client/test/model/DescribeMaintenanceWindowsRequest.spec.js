...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeMaintenanceWindowsRequest();
  });
  ...
  describe('DescribeMaintenanceWindowsRequest', function() {
    it('should create an instance of DescribeMaintenanceWindowsRequest', function() {
      // uncomment below and update the code to test DescribeMaintenanceWindowsRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeMaintenanceWindowsRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeMaintenanceWindowsRequest);
    });
