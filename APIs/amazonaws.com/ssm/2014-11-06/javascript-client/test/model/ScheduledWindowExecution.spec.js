...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ScheduledWindowExecution();
  });
  ...
  describe('ScheduledWindowExecution', function() {
    it('should create an instance of ScheduledWindowExecution', function() {
      // uncomment below and update the code to test ScheduledWindowExecution
      //var instance = new AmazonSimpleSystemsManagerSsm.ScheduledWindowExecution();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ScheduledWindowExecution);
    });
