...
(function(root, factory) {
  ...
  describe('AutomationType', function() {
    it('should create an instance of AutomationType', function() {
      // uncomment below and update the code to test AutomationType
      //var instance = new AmazonSimpleSystemsManagerSsm.AutomationType();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.AutomationType);
    });
