...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.InstanceAssociation();
  });
  ...
  describe('InstanceAssociation', function() {
    it('should create an instance of InstanceAssociation', function() {
      // uncomment below and update the code to test InstanceAssociation
      //var instance = new AmazonSimpleSystemsManagerSsm.InstanceAssociation();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.InstanceAssociation);
    });
