...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.GetServiceSettingRequest();
  });
  ...
  describe('GetServiceSettingRequest', function() {
    it('should create an instance of GetServiceSettingRequest', function() {
      // uncomment below and update the code to test GetServiceSettingRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.GetServiceSettingRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.GetServiceSettingRequest);
    });
