...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ListResourceDataSyncRequest();
  });
  ...
  describe('ListResourceDataSyncRequest', function() {
    it('should create an instance of ListResourceDataSyncRequest', function() {
      // uncomment below and update the code to test ListResourceDataSyncRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.ListResourceDataSyncRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ListResourceDataSyncRequest);
    });
