...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ResetServiceSettingResultServiceSetting();
  });
  ...
  describe('ResetServiceSettingResultServiceSetting', function() {
    it('should create an instance of ResetServiceSettingResultServiceSetting', function() {
      // uncomment below and update the code to test ResetServiceSettingResultServiceSetting
      //var instance = new AmazonSimpleSystemsManagerSsm.ResetServiceSettingResultServiceSetting();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ResetServiceSettingResultServiceSetting);
    });
