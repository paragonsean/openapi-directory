...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.OpsItemIdentity();
  });
  ...
  describe('OpsItemIdentity', function() {
    it('should create an instance of OpsItemIdentity', function() {
      // uncomment below and update the code to test OpsItemIdentity
      //var instance = new AmazonSimpleSystemsManagerSsm.OpsItemIdentity();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.OpsItemIdentity);
    });
