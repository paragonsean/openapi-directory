...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeInstancePatchStatesForPatchGroupRequest();
  });
  ...
  describe('DescribeInstancePatchStatesForPatchGroupRequest', function() {
    it('should create an instance of DescribeInstancePatchStatesForPatchGroupRequest', function() {
      // uncomment below and update the code to test DescribeInstancePatchStatesForPatchGroupRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeInstancePatchStatesForPatchGroupRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeInstancePatchStatesForPatchGroupRequest);
    });
