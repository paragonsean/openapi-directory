...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.MetadataValue();
  });
  ...
  describe('MetadataValue', function() {
    it('should create an instance of MetadataValue', function() {
      // uncomment below and update the code to test MetadataValue
      //var instance = new AmazonSimpleSystemsManagerSsm.MetadataValue();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.MetadataValue);
    });
