...
(function(root, factory) {
  ...
  describe('OpsItemFilterKey', function() {
    it('should create an instance of OpsItemFilterKey', function() {
      // uncomment below and update the code to test OpsItemFilterKey
      //var instance = new AmazonSimpleSystemsManagerSsm.OpsItemFilterKey();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.OpsItemFilterKey);
    });
