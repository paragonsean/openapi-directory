...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeMaintenanceWindowExecutionsRequest();
  });
  ...
  describe('DescribeMaintenanceWindowExecutionsRequest', function() {
    it('should create an instance of DescribeMaintenanceWindowExecutionsRequest', function() {
      // uncomment below and update the code to test DescribeMaintenanceWindowExecutionsRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeMaintenanceWindowExecutionsRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeMaintenanceWindowExecutionsRequest);
    });
