...
(function(root, factory) {
  ...
  describe('CommandFilterKey', function() {
    it('should create an instance of CommandFilterKey', function() {
      // uncomment below and update the code to test CommandFilterKey
      //var instance = new AmazonSimpleSystemsManagerSsm.CommandFilterKey();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.CommandFilterKey);
    });
