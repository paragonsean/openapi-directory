...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.MaintenanceWindowIdentityForTarget();
  });
  ...
  describe('MaintenanceWindowIdentityForTarget', function() {
    it('should create an instance of MaintenanceWindowIdentityForTarget', function() {
      // uncomment below and update the code to test MaintenanceWindowIdentityForTarget
      //var instance = new AmazonSimpleSystemsManagerSsm.MaintenanceWindowIdentityForTarget();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.MaintenanceWindowIdentityForTarget);
    });
