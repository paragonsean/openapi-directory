...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeSessionsResponse();
  });
  ...
  describe('DescribeSessionsResponse', function() {
    it('should create an instance of DescribeSessionsResponse', function() {
      // uncomment below and update the code to test DescribeSessionsResponse
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeSessionsResponse();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeSessionsResponse);
    });
