...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.AssociateOpsItemRelatedItemRequest();
  });
  ...
  describe('AssociateOpsItemRelatedItemRequest', function() {
    it('should create an instance of AssociateOpsItemRelatedItemRequest', function() {
      // uncomment below and update the code to test AssociateOpsItemRelatedItemRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.AssociateOpsItemRelatedItemRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.AssociateOpsItemRelatedItemRequest);
    });
