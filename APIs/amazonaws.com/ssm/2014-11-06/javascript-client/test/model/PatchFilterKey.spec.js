...
(function(root, factory) {
  ...
  describe('PatchFilterKey', function() {
    it('should create an instance of PatchFilterKey', function() {
      // uncomment below and update the code to test PatchFilterKey
      //var instance = new AmazonSimpleSystemsManagerSsm.PatchFilterKey();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.PatchFilterKey);
    });
