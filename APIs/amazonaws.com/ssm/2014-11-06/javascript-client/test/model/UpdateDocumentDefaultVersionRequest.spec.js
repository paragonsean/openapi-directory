...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.UpdateDocumentDefaultVersionRequest();
  });
  ...
  describe('UpdateDocumentDefaultVersionRequest', function() {
    it('should create an instance of UpdateDocumentDefaultVersionRequest', function() {
      // uncomment below and update the code to test UpdateDocumentDefaultVersionRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.UpdateDocumentDefaultVersionRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.UpdateDocumentDefaultVersionRequest);
    });
