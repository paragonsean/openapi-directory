...
(function(root, factory) {
  ...
  describe('OpsItemStatus', function() {
    it('should create an instance of OpsItemStatus', function() {
      // uncomment below and update the code to test OpsItemStatus
      //var instance = new AmazonSimpleSystemsManagerSsm.OpsItemStatus();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.OpsItemStatus);
    });
