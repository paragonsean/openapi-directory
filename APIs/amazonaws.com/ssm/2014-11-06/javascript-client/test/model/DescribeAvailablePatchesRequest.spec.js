...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeAvailablePatchesRequest();
  });
  ...
  describe('DescribeAvailablePatchesRequest', function() {
    it('should create an instance of DescribeAvailablePatchesRequest', function() {
      // uncomment below and update the code to test DescribeAvailablePatchesRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeAvailablePatchesRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeAvailablePatchesRequest);
    });
