...
(function(root, factory) {
  ...
  describe('PatchComplianceLevel', function() {
    it('should create an instance of PatchComplianceLevel', function() {
      // uncomment below and update the code to test PatchComplianceLevel
      //var instance = new AmazonSimpleSystemsManagerSsm.PatchComplianceLevel();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.PatchComplianceLevel);
    });
