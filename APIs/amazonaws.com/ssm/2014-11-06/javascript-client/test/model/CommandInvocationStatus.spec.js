...
(function(root, factory) {
  ...
  describe('CommandInvocationStatus', function() {
    it('should create an instance of CommandInvocationStatus', function() {
      // uncomment below and update the code to test CommandInvocationStatus
      //var instance = new AmazonSimpleSystemsManagerSsm.CommandInvocationStatus();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.CommandInvocationStatus);
    });
