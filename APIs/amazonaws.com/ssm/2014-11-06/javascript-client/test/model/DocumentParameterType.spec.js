...
(function(root, factory) {
  ...
  describe('DocumentParameterType', function() {
    it('should create an instance of DocumentParameterType', function() {
      // uncomment below and update the code to test DocumentParameterType
      //var instance = new AmazonSimpleSystemsManagerSsm.DocumentParameterType();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DocumentParameterType);
    });
