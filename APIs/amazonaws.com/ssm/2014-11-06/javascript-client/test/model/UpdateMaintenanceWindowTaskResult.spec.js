...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.UpdateMaintenanceWindowTaskResult();
  });
  ...
  describe('UpdateMaintenanceWindowTaskResult', function() {
    it('should create an instance of UpdateMaintenanceWindowTaskResult', function() {
      // uncomment below and update the code to test UpdateMaintenanceWindowTaskResult
      //var instance = new AmazonSimpleSystemsManagerSsm.UpdateMaintenanceWindowTaskResult();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.UpdateMaintenanceWindowTaskResult);
    });
    ...
    it('should have the property taskInvocationParameters (base name: "TaskInvocationParameters")', function() {
      // uncomment below and update the code to test the property taskInvocationParameters
      //var instance = new AmazonSimpleSystemsManagerSsm.UpdateMaintenanceWindowTaskResult();
      //expect(instance).to.be();
    });
