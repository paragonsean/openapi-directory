...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.OpsAggregator();
  });
  ...
  describe('OpsAggregator', function() {
    it('should create an instance of OpsAggregator', function() {
      // uncomment below and update the code to test OpsAggregator
      //var instance = new AmazonSimpleSystemsManagerSsm.OpsAggregator();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.OpsAggregator);
    });
