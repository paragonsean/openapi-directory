...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.GetOpsSummaryResult();
  });
  ...
  describe('GetOpsSummaryResult', function() {
    it('should create an instance of GetOpsSummaryResult', function() {
      // uncomment below and update the code to test GetOpsSummaryResult
      //var instance = new AmazonSimpleSystemsManagerSsm.GetOpsSummaryResult();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.GetOpsSummaryResult);
    });
