...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ListDocumentsRequest();
  });
  ...
  describe('ListDocumentsRequest', function() {
    it('should create an instance of ListDocumentsRequest', function() {
      // uncomment below and update the code to test ListDocumentsRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.ListDocumentsRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ListDocumentsRequest);
    });

    it('should have the property documentFilterList (base name: "DocumentFilterList")', function() {
      // uncomment below and update the code to test the property documentFilterList
      //var instance = new AmazonSimpleSystemsManagerSsm.ListDocumentsRequest();
