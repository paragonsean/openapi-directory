...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.TerminateSessionRequest();
  });
  ...
  describe('TerminateSessionRequest', function() {
    it('should create an instance of TerminateSessionRequest', function() {
      // uncomment below and update the code to test TerminateSessionRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.TerminateSessionRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.TerminateSessionRequest);
    });
