...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.GetParameterHistoryResult();
  });
  ...
  describe('GetParameterHistoryResult', function() {
    it('should create an instance of GetParameterHistoryResult', function() {
      // uncomment below and update the code to test GetParameterHistoryResult
      //var instance = new AmazonSimpleSystemsManagerSsm.GetParameterHistoryResult();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.GetParameterHistoryResult);
    });
