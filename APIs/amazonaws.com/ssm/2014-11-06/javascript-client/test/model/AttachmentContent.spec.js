...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.AttachmentContent();
  });
  ...
  describe('AttachmentContent', function() {
    it('should create an instance of AttachmentContent', function() {
      // uncomment below and update the code to test AttachmentContent
      //var instance = new AmazonSimpleSystemsManagerSsm.AttachmentContent();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.AttachmentContent);
    });
