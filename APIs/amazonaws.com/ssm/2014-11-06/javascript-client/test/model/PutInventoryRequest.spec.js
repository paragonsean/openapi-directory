...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.PutInventoryRequest();
  });
  ...
  describe('PutInventoryRequest', function() {
    it('should create an instance of PutInventoryRequest', function() {
      // uncomment below and update the code to test PutInventoryRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.PutInventoryRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.PutInventoryRequest);
    });
