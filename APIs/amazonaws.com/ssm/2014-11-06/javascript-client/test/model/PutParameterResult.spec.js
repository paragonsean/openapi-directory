...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.PutParameterResult();
  });
  ...
  describe('PutParameterResult', function() {
    it('should create an instance of PutParameterResult', function() {
      // uncomment below and update the code to test PutParameterResult
      //var instance = new AmazonSimpleSystemsManagerSsm.PutParameterResult();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.PutParameterResult);
    });
