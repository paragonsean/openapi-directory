...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ListCommandInvocationsRequest();
  });
  ...
  describe('ListCommandInvocationsRequest', function() {
    it('should create an instance of ListCommandInvocationsRequest', function() {
      // uncomment below and update the code to test ListCommandInvocationsRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.ListCommandInvocationsRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ListCommandInvocationsRequest);
    });
