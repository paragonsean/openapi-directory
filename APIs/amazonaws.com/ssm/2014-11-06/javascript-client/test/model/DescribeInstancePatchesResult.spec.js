...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeInstancePatchesResult();
  });
  ...
  describe('DescribeInstancePatchesResult', function() {
    it('should create an instance of DescribeInstancePatchesResult', function() {
      // uncomment below and update the code to test DescribeInstancePatchesResult
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeInstancePatchesResult();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeInstancePatchesResult);
    });
