...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DocumentIdentifier();
  });
  ...
  describe('DocumentIdentifier', function() {
    it('should create an instance of DocumentIdentifier', function() {
      // uncomment below and update the code to test DocumentIdentifier
      //var instance = new AmazonSimpleSystemsManagerSsm.DocumentIdentifier();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DocumentIdentifier);
    });
