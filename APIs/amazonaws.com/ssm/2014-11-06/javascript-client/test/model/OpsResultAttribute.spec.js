...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.OpsResultAttribute();
  });
  ...
  describe('OpsResultAttribute', function() {
    it('should create an instance of OpsResultAttribute', function() {
      // uncomment below and update the code to test OpsResultAttribute
      //var instance = new AmazonSimpleSystemsManagerSsm.OpsResultAttribute();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.OpsResultAttribute);
    });
