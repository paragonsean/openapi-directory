...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.Runbook();
  });
  ...
  describe('Runbook', function() {
    it('should create an instance of Runbook', function() {
      // uncomment below and update the code to test Runbook
      //var instance = new AmazonSimpleSystemsManagerSsm.Runbook();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.Runbook);
    });
