...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribePatchGroupsResult();
  });
  ...
  describe('DescribePatchGroupsResult', function() {
    it('should create an instance of DescribePatchGroupsResult', function() {
      // uncomment below and update the code to test DescribePatchGroupsResult
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribePatchGroupsResult();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribePatchGroupsResult);
    });
