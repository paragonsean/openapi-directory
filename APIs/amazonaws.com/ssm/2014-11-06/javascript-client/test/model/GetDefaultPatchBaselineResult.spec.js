...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.GetDefaultPatchBaselineResult();
  });
  ...
  describe('GetDefaultPatchBaselineResult', function() {
    it('should create an instance of GetDefaultPatchBaselineResult', function() {
      // uncomment below and update the code to test GetDefaultPatchBaselineResult
      //var instance = new AmazonSimpleSystemsManagerSsm.GetDefaultPatchBaselineResult();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.GetDefaultPatchBaselineResult);
    });
