...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.StartChangeRequestExecutionRequest();
  });
  ...
  describe('StartChangeRequestExecutionRequest', function() {
    it('should create an instance of StartChangeRequestExecutionRequest', function() {
      // uncomment below and update the code to test StartChangeRequestExecutionRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.StartChangeRequestExecutionRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.StartChangeRequestExecutionRequest);
    });
    ...
    it('should have the property autoApprove (base name: "AutoApprove")', function() {
    ...
    it('should have the property changeDetails (base name: "ChangeDetails")', function() {
      // uncomment below and update the code to test the property changeDetails
      //var instance = new AmazonSimpleSystemsManagerSsm.StartChangeRequestExecutionRequest();
      //expect(instance).to.be();
    });
