...
(function(root, factory) {
  ...
  describe('PingStatus', function() {
    it('should create an instance of PingStatus', function() {
      // uncomment below and update the code to test PingStatus
      //var instance = new AmazonSimpleSystemsManagerSsm.PingStatus();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.PingStatus);
    });
