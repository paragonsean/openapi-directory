...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeInstanceInformationRequest();
  });
  ...
  describe('DescribeInstanceInformationRequest', function() {
    it('should create an instance of DescribeInstanceInformationRequest', function() {
      // uncomment below and update the code to test DescribeInstanceInformationRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeInstanceInformationRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeInstanceInformationRequest);
    });

    it('should have the property instanceInformationFilterList (base name: "InstanceInformationFilterList")', function() {
      // uncomment below and update the code to test the property instanceInformationFilterList
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeInstanceInformationRequest();
