...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ParameterHistory();
  });
  ...
  describe('ParameterHistory', function() {
    it('should create an instance of ParameterHistory', function() {
      // uncomment below and update the code to test ParameterHistory
      //var instance = new AmazonSimpleSystemsManagerSsm.ParameterHistory();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ParameterHistory);
    });
