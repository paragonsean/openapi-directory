...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeMaintenanceWindowTasksRequest();
  });
  ...
  describe('DescribeMaintenanceWindowTasksRequest', function() {
    it('should create an instance of DescribeMaintenanceWindowTasksRequest', function() {
      // uncomment below and update the code to test DescribeMaintenanceWindowTasksRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeMaintenanceWindowTasksRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeMaintenanceWindowTasksRequest);
    });
