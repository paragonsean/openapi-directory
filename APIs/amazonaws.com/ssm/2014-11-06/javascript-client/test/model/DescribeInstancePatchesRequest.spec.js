...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeInstancePatchesRequest();
  });
  ...
  describe('DescribeInstancePatchesRequest', function() {
    it('should create an instance of DescribeInstancePatchesRequest', function() {
      // uncomment below and update the code to test DescribeInstancePatchesRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeInstancePatchesRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeInstancePatchesRequest);
    });
