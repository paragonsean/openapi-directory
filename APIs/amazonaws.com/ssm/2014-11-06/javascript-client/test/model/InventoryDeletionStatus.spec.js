...
(function(root, factory) {
  ...
  describe('InventoryDeletionStatus', function() {
    it('should create an instance of InventoryDeletionStatus', function() {
      // uncomment below and update the code to test InventoryDeletionStatus
      //var instance = new AmazonSimpleSystemsManagerSsm.InventoryDeletionStatus();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.InventoryDeletionStatus);
    });
