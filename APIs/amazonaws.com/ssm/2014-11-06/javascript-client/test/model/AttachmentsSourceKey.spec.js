...
(function(root, factory) {
  ...
  describe('AttachmentsSourceKey', function() {
    it('should create an instance of AttachmentsSourceKey', function() {
      // uncomment below and update the code to test AttachmentsSourceKey
      //var instance = new AmazonSimpleSystemsManagerSsm.AttachmentsSourceKey();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.AttachmentsSourceKey);
    });
