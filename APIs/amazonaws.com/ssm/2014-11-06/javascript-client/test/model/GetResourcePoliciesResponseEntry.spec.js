...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.GetResourcePoliciesResponseEntry();
  });
  ...
  describe('GetResourcePoliciesResponseEntry', function() {
    it('should create an instance of GetResourcePoliciesResponseEntry', function() {
      // uncomment below and update the code to test GetResourcePoliciesResponseEntry
      //var instance = new AmazonSimpleSystemsManagerSsm.GetResourcePoliciesResponseEntry();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.GetResourcePoliciesResponseEntry);
    });
    ...
    it('should have the property policyHash (base name: "PolicyHash")', function() {
      // uncomment below and update the code to test the property policyHash
      //var instance = new AmazonSimpleSystemsManagerSsm.GetResourcePoliciesResponseEntry();
      //expect(instance).to.be();
    });
