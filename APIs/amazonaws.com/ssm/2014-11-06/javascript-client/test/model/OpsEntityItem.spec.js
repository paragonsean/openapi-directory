...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.OpsEntityItem();
  });
  ...
  describe('OpsEntityItem', function() {
    it('should create an instance of OpsEntityItem', function() {
      // uncomment below and update the code to test OpsEntityItem
      //var instance = new AmazonSimpleSystemsManagerSsm.OpsEntityItem();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.OpsEntityItem);
    });
