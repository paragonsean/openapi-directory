...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeMaintenanceWindowScheduleRequest();
  });
  ...
  describe('DescribeMaintenanceWindowScheduleRequest', function() {
    it('should create an instance of DescribeMaintenanceWindowScheduleRequest', function() {
      // uncomment below and update the code to test DescribeMaintenanceWindowScheduleRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeMaintenanceWindowScheduleRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeMaintenanceWindowScheduleRequest);
    });
