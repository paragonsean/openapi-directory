...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ListInventoryEntriesResult();
  });
  ...
  describe('ListInventoryEntriesResult', function() {
    it('should create an instance of ListInventoryEntriesResult', function() {
      // uncomment below and update the code to test ListInventoryEntriesResult
      //var instance = new AmazonSimpleSystemsManagerSsm.ListInventoryEntriesResult();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ListInventoryEntriesResult);
    });
