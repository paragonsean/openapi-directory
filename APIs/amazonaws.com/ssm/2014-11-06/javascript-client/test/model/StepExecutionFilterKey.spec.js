...
(function(root, factory) {
  ...
  describe('StepExecutionFilterKey', function() {
    it('should create an instance of StepExecutionFilterKey', function() {
      // uncomment below and update the code to test StepExecutionFilterKey
      //var instance = new AmazonSimpleSystemsManagerSsm.StepExecutionFilterKey();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.StepExecutionFilterKey);
    });
