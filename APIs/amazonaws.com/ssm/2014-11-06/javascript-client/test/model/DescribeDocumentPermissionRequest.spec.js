...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeDocumentPermissionRequest();
  });
  ...
  describe('DescribeDocumentPermissionRequest', function() {
    it('should create an instance of DescribeDocumentPermissionRequest', function() {
      // uncomment below and update the code to test DescribeDocumentPermissionRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeDocumentPermissionRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeDocumentPermissionRequest);
    });
