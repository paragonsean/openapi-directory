...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeMaintenanceWindowExecutionTaskInvocationsRequest();
  });
  ...
  describe('DescribeMaintenanceWindowExecutionTaskInvocationsRequest', function() {
    it('should create an instance of DescribeMaintenanceWindowExecutionTaskInvocationsRequest', function() {
      // uncomment below and update the code to test DescribeMaintenanceWindowExecutionTaskInvocationsRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeMaintenanceWindowExecutionTaskInvocationsRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeMaintenanceWindowExecutionTaskInvocationsRequest);
    });
