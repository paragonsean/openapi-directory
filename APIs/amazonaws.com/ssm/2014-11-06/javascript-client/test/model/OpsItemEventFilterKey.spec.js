...
(function(root, factory) {
  ...
  describe('OpsItemEventFilterKey', function() {
    it('should create an instance of OpsItemEventFilterKey', function() {
      // uncomment below and update the code to test OpsItemEventFilterKey
      //var instance = new AmazonSimpleSystemsManagerSsm.OpsItemEventFilterKey();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.OpsItemEventFilterKey);
    });
