...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.InventoryItemAttribute();
  });
  ...
  describe('InventoryItemAttribute', function() {
    it('should create an instance of InventoryItemAttribute', function() {
      // uncomment below and update the code to test InventoryItemAttribute
      //var instance = new AmazonSimpleSystemsManagerSsm.InventoryItemAttribute();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.InventoryItemAttribute);
    });
