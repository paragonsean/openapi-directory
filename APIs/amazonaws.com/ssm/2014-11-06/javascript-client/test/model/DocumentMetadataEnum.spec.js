...
(function(root, factory) {
  ...
  describe('DocumentMetadataEnum', function() {
    it('should create an instance of DocumentMetadataEnum', function() {
      // uncomment below and update the code to test DocumentMetadataEnum
      //var instance = new AmazonSimpleSystemsManagerSsm.DocumentMetadataEnum();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DocumentMetadataEnum);
    });
