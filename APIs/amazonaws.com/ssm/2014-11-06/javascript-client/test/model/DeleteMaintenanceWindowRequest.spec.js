...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DeleteMaintenanceWindowRequest();
  });
  ...
  describe('DeleteMaintenanceWindowRequest', function() {
    it('should create an instance of DeleteMaintenanceWindowRequest', function() {
      // uncomment below and update the code to test DeleteMaintenanceWindowRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DeleteMaintenanceWindowRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DeleteMaintenanceWindowRequest);
    });
