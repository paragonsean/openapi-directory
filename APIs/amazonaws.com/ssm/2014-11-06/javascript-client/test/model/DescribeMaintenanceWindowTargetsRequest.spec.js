...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeMaintenanceWindowTargetsRequest();
  });
  ...
  describe('DescribeMaintenanceWindowTargetsRequest', function() {
    it('should create an instance of DescribeMaintenanceWindowTargetsRequest', function() {
      // uncomment below and update the code to test DescribeMaintenanceWindowTargetsRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeMaintenanceWindowTargetsRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeMaintenanceWindowTargetsRequest);
    });
