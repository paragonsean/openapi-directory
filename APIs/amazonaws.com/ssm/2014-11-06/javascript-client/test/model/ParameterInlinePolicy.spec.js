...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ParameterInlinePolicy();
  });
  ...
  describe('ParameterInlinePolicy', function() {
    it('should create an instance of ParameterInlinePolicy', function() {
      // uncomment below and update the code to test ParameterInlinePolicy
      //var instance = new AmazonSimpleSystemsManagerSsm.ParameterInlinePolicy();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ParameterInlinePolicy);
    });
