...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.GetMaintenanceWindowExecutionTaskInvocationResult();
  });
  ...
  describe('GetMaintenanceWindowExecutionTaskInvocationResult', function() {
    it('should create an instance of GetMaintenanceWindowExecutionTaskInvocationResult', function() {
      // uncomment below and update the code to test GetMaintenanceWindowExecutionTaskInvocationResult
      //var instance = new AmazonSimpleSystemsManagerSsm.GetMaintenanceWindowExecutionTaskInvocationResult();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.GetMaintenanceWindowExecutionTaskInvocationResult);
    });
