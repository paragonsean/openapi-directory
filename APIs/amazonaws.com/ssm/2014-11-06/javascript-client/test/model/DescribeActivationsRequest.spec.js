...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeActivationsRequest();
  });
  ...
  describe('DescribeActivationsRequest', function() {
    it('should create an instance of DescribeActivationsRequest', function() {
      // uncomment below and update the code to test DescribeActivationsRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeActivationsRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeActivationsRequest);
    });
