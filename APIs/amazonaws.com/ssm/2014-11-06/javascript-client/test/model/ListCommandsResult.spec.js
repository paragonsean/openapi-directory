...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ListCommandsResult();
  });
  ...
  describe('ListCommandsResult', function() {
    it('should create an instance of ListCommandsResult', function() {
      // uncomment below and update the code to test ListCommandsResult
      //var instance = new AmazonSimpleSystemsManagerSsm.ListCommandsResult();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ListCommandsResult);
    });
