...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.PutComplianceItemsRequestExecutionSummary();
  });
  ...
  describe('PutComplianceItemsRequestExecutionSummary', function() {
    it('should create an instance of PutComplianceItemsRequestExecutionSummary', function() {
      // uncomment below and update the code to test PutComplianceItemsRequestExecutionSummary
      //var instance = new AmazonSimpleSystemsManagerSsm.PutComplianceItemsRequestExecutionSummary();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.PutComplianceItemsRequestExecutionSummary);
    });
