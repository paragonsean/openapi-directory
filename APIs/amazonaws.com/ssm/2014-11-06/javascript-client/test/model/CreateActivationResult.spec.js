...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.CreateActivationResult();
  });
  ...
  describe('CreateActivationResult', function() {
    it('should create an instance of CreateActivationResult', function() {
      // uncomment below and update the code to test CreateActivationResult
      //var instance = new AmazonSimpleSystemsManagerSsm.CreateActivationResult();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.CreateActivationResult);
    });
