...
(function(root, factory) {
  ...
  describe('PatchOperationType', function() {
    it('should create an instance of PatchOperationType', function() {
      // uncomment below and update the code to test PatchOperationType
      //var instance = new AmazonSimpleSystemsManagerSsm.PatchOperationType();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.PatchOperationType);
    });
