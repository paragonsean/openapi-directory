...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.InventoryResultItem();
  });
  ...
  describe('InventoryResultItem', function() {
    it('should create an instance of InventoryResultItem', function() {
      // uncomment below and update the code to test InventoryResultItem
      //var instance = new AmazonSimpleSystemsManagerSsm.InventoryResultItem();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.InventoryResultItem);
    });
