...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DocumentVersionInfo();
  });
  ...
  describe('DocumentVersionInfo', function() {
    it('should create an instance of DocumentVersionInfo', function() {
      // uncomment below and update the code to test DocumentVersionInfo
      //var instance = new AmazonSimpleSystemsManagerSsm.DocumentVersionInfo();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DocumentVersionInfo);
    });
