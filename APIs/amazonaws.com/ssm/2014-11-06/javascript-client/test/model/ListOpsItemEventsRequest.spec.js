...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ListOpsItemEventsRequest();
  });
  ...
  describe('ListOpsItemEventsRequest', function() {
    it('should create an instance of ListOpsItemEventsRequest', function() {
      // uncomment below and update the code to test ListOpsItemEventsRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.ListOpsItemEventsRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ListOpsItemEventsRequest);
    });
