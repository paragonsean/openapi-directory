...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DeregisterManagedInstanceRequest();
  });
  ...
  describe('DeregisterManagedInstanceRequest', function() {
    it('should create an instance of DeregisterManagedInstanceRequest', function() {
      // uncomment below and update the code to test DeregisterManagedInstanceRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DeregisterManagedInstanceRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DeregisterManagedInstanceRequest);
    });
