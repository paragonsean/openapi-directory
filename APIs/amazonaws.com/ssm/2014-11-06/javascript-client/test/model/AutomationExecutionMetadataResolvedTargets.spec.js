...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.AutomationExecutionMetadataResolvedTargets();
  });
  ...
  describe('AutomationExecutionMetadataResolvedTargets', function() {
    it('should create an instance of AutomationExecutionMetadataResolvedTargets', function() {
      // uncomment below and update the code to test AutomationExecutionMetadataResolvedTargets
      //var instance = new AmazonSimpleSystemsManagerSsm.AutomationExecutionMetadataResolvedTargets();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.AutomationExecutionMetadataResolvedTargets);
    });
