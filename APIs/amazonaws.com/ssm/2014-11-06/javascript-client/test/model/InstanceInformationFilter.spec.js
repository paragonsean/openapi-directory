...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.InstanceInformationFilter();
  });
  ...
  describe('InstanceInformationFilter', function() {
    it('should create an instance of InstanceInformationFilter', function() {
      // uncomment below and update the code to test InstanceInformationFilter
      //var instance = new AmazonSimpleSystemsManagerSsm.InstanceInformationFilter();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.InstanceInformationFilter);
    });
