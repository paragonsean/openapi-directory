...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.GetParameterHistoryRequest();
  });
  ...
  describe('GetParameterHistoryRequest', function() {
    it('should create an instance of GetParameterHistoryRequest', function() {
      // uncomment below and update the code to test GetParameterHistoryRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.GetParameterHistoryRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.GetParameterHistoryRequest);
    });
