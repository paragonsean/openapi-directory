...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DeleteMaintenanceWindowResult();
  });
  ...
  describe('DeleteMaintenanceWindowResult', function() {
    it('should create an instance of DeleteMaintenanceWindowResult', function() {
      // uncomment below and update the code to test DeleteMaintenanceWindowResult
      //var instance = new AmazonSimpleSystemsManagerSsm.DeleteMaintenanceWindowResult();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DeleteMaintenanceWindowResult);
    });
