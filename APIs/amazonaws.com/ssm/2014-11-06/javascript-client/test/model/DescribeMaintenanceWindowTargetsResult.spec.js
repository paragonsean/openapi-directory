...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeMaintenanceWindowTargetsResult();
  });
  ...
  describe('DescribeMaintenanceWindowTargetsResult', function() {
    it('should create an instance of DescribeMaintenanceWindowTargetsResult', function() {
      // uncomment below and update the code to test DescribeMaintenanceWindowTargetsResult
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeMaintenanceWindowTargetsResult();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeMaintenanceWindowTargetsResult);
    });
