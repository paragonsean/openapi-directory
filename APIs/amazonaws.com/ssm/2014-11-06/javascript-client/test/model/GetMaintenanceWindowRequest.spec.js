...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.GetMaintenanceWindowRequest();
  });
  ...
  describe('GetMaintenanceWindowRequest', function() {
    it('should create an instance of GetMaintenanceWindowRequest', function() {
      // uncomment below and update the code to test GetMaintenanceWindowRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.GetMaintenanceWindowRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.GetMaintenanceWindowRequest);
    });
