...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.AssociationStatus();
  });
  ...
  describe('AssociationStatus', function() {
    it('should create an instance of AssociationStatus', function() {
      // uncomment below and update the code to test AssociationStatus
      //var instance = new AmazonSimpleSystemsManagerSsm.AssociationStatus();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.AssociationStatus);
    });
