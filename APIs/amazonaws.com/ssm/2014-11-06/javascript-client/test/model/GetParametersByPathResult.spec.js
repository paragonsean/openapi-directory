...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.GetParametersByPathResult();
  });
  ...
  describe('GetParametersByPathResult', function() {
    it('should create an instance of GetParametersByPathResult', function() {
      // uncomment below and update the code to test GetParametersByPathResult
      //var instance = new AmazonSimpleSystemsManagerSsm.GetParametersByPathResult();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.GetParametersByPathResult);
    });
