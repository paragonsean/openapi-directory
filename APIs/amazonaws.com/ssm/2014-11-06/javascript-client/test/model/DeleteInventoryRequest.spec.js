...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DeleteInventoryRequest();
  });
  ...
  describe('DeleteInventoryRequest', function() {
    it('should create an instance of DeleteInventoryRequest', function() {
      // uncomment below and update the code to test DeleteInventoryRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DeleteInventoryRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DeleteInventoryRequest);
    });
    ...
    it('should have the property schemaDeleteOption (base name: "SchemaDeleteOption")', function() {
      // uncomment below and update the code to test the property schemaDeleteOption
      //var instance = new AmazonSimpleSystemsManagerSsm.DeleteInventoryRequest();
      //expect(instance).to.be();
    });
