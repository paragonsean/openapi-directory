...
(function(root, factory) {
  ...
  describe('ComplianceSeverity', function() {
    it('should create an instance of ComplianceSeverity', function() {
      // uncomment below and update the code to test ComplianceSeverity
      //var instance = new AmazonSimpleSystemsManagerSsm.ComplianceSeverity();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ComplianceSeverity);
    });
