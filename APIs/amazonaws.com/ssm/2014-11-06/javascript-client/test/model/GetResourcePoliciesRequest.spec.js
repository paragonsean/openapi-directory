...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.GetResourcePoliciesRequest();
  });
  ...
  describe('GetResourcePoliciesRequest', function() {
    it('should create an instance of GetResourcePoliciesRequest', function() {
      // uncomment below and update the code to test GetResourcePoliciesRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.GetResourcePoliciesRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.GetResourcePoliciesRequest);
    });
