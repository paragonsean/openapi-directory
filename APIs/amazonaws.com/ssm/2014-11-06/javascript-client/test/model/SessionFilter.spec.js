...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.SessionFilter();
  });
  ...
  describe('SessionFilter', function() {
    it('should create an instance of SessionFilter', function() {
      // uncomment below and update the code to test SessionFilter
      //var instance = new AmazonSimpleSystemsManagerSsm.SessionFilter();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.SessionFilter);
    });
