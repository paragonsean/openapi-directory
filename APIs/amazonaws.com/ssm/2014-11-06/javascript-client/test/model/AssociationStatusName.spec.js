...
(function(root, factory) {
  ...
  describe('AssociationStatusName', function() {
    it('should create an instance of AssociationStatusName', function() {
      // uncomment below and update the code to test AssociationStatusName
      //var instance = new AmazonSimpleSystemsManagerSsm.AssociationStatusName();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.AssociationStatusName);
    });
