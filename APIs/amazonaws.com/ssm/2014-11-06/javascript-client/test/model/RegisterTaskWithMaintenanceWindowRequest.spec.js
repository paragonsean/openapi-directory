...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.RegisterTaskWithMaintenanceWindowRequest();
  });
  ...
  describe('RegisterTaskWithMaintenanceWindowRequest', function() {
    it('should create an instance of RegisterTaskWithMaintenanceWindowRequest', function() {
      // uncomment below and update the code to test RegisterTaskWithMaintenanceWindowRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.RegisterTaskWithMaintenanceWindowRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.RegisterTaskWithMaintenanceWindowRequest);
    });
