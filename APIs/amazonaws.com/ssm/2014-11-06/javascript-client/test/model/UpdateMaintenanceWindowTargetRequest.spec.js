...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.UpdateMaintenanceWindowTargetRequest();
  });
  ...
  describe('UpdateMaintenanceWindowTargetRequest', function() {
    it('should create an instance of UpdateMaintenanceWindowTargetRequest', function() {
      // uncomment below and update the code to test UpdateMaintenanceWindowTargetRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.UpdateMaintenanceWindowTargetRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.UpdateMaintenanceWindowTargetRequest);
    });
