...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.RemoveTagsFromResourceRequest();
  });
  ...
  describe('RemoveTagsFromResourceRequest', function() {
    it('should create an instance of RemoveTagsFromResourceRequest', function() {
      // uncomment below and update the code to test RemoveTagsFromResourceRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.RemoveTagsFromResourceRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.RemoveTagsFromResourceRequest);
    });
