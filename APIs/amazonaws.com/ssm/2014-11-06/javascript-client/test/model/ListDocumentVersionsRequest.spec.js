...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ListDocumentVersionsRequest();
  });
  ...
  describe('ListDocumentVersionsRequest', function() {
    it('should create an instance of ListDocumentVersionsRequest', function() {
      // uncomment below and update the code to test ListDocumentVersionsRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.ListDocumentVersionsRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ListDocumentVersionsRequest);
    });
