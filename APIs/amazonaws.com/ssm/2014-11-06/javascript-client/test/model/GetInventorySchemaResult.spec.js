...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.GetInventorySchemaResult();
  });
  ...
  describe('GetInventorySchemaResult', function() {
    it('should create an instance of GetInventorySchemaResult', function() {
      // uncomment below and update the code to test GetInventorySchemaResult
      //var instance = new AmazonSimpleSystemsManagerSsm.GetInventorySchemaResult();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.GetInventorySchemaResult);
    });
