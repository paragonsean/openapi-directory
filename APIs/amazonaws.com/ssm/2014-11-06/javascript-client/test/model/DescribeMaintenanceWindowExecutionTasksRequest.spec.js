...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeMaintenanceWindowExecutionTasksRequest();
  });
  ...
  describe('DescribeMaintenanceWindowExecutionTasksRequest', function() {
    it('should create an instance of DescribeMaintenanceWindowExecutionTasksRequest', function() {
      // uncomment below and update the code to test DescribeMaintenanceWindowExecutionTasksRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeMaintenanceWindowExecutionTasksRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeMaintenanceWindowExecutionTasksRequest);
    });
