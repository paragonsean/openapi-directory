...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DocumentReviewerResponseSource();
  });
  ...
  describe('DocumentReviewerResponseSource', function() {
    it('should create an instance of DocumentReviewerResponseSource', function() {
      // uncomment below and update the code to test DocumentReviewerResponseSource
      //var instance = new AmazonSimpleSystemsManagerSsm.DocumentReviewerResponseSource();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DocumentReviewerResponseSource);
    });
