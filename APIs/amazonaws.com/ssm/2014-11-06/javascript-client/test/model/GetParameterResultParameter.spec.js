...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.GetParameterResultParameter();
  });
  ...
  describe('GetParameterResultParameter', function() {
    it('should create an instance of GetParameterResultParameter', function() {
      // uncomment below and update the code to test GetParameterResultParameter
      //var instance = new AmazonSimpleSystemsManagerSsm.GetParameterResultParameter();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.GetParameterResultParameter);
    });
    ...
    it('should have the property sourceResult (base name: "SourceResult")', function() {
      // uncomment below and update the code to test the property sourceResult
      //var instance = new AmazonSimpleSystemsManagerSsm.GetParameterResultParameter();
      //expect(instance).to.be();
    });
