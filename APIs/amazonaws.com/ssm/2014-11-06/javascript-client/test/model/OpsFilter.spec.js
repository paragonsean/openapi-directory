...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.OpsFilter();
  });
  ...
  describe('OpsFilter', function() {
    it('should create an instance of OpsFilter', function() {
      // uncomment below and update the code to test OpsFilter
      //var instance = new AmazonSimpleSystemsManagerSsm.OpsFilter();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.OpsFilter);
    });
