...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.SendCommandResultCommand();
  });
  ...
  describe('SendCommandResultCommand', function() {
    it('should create an instance of SendCommandResultCommand', function() {
      // uncomment below and update the code to test SendCommandResultCommand
      //var instance = new AmazonSimpleSystemsManagerSsm.SendCommandResultCommand();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.SendCommandResultCommand);
    });
    ...
    it('should have the property deliveryTimedOutCount (base name: "DeliveryTimedOutCount")', function() {
      // uncomment below and update the code to test the property deliveryTimedOutCount
      //var instance = new AmazonSimpleSystemsManagerSsm.SendCommandResultCommand();
      //expect(instance).to.be();
    });
