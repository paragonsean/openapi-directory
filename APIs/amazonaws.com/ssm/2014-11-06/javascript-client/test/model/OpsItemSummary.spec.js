...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.OpsItemSummary();
  });
  ...
  describe('OpsItemSummary', function() {
    it('should create an instance of OpsItemSummary', function() {
      // uncomment below and update the code to test OpsItemSummary
      //var instance = new AmazonSimpleSystemsManagerSsm.OpsItemSummary();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.OpsItemSummary);
    });
