...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.OpsItemFilter();
  });
  ...
  describe('OpsItemFilter', function() {
    it('should create an instance of OpsItemFilter', function() {
      // uncomment below and update the code to test OpsItemFilter
      //var instance = new AmazonSimpleSystemsManagerSsm.OpsItemFilter();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.OpsItemFilter);
    });
