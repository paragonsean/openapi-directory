...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ParameterStringFilter();
  });
  ...
  describe('ParameterStringFilter', function() {
    it('should create an instance of ParameterStringFilter', function() {
      // uncomment below and update the code to test ParameterStringFilter
      //var instance = new AmazonSimpleSystemsManagerSsm.ParameterStringFilter();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ParameterStringFilter);
    });
