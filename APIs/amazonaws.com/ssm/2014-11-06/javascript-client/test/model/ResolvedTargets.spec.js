...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ResolvedTargets();
  });
  ...
  describe('ResolvedTargets', function() {
    it('should create an instance of ResolvedTargets', function() {
      // uncomment below and update the code to test ResolvedTargets
      //var instance = new AmazonSimpleSystemsManagerSsm.ResolvedTargets();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ResolvedTargets);
    });
