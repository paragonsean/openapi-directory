...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ResumeSessionRequest();
  });
  ...
  describe('ResumeSessionRequest', function() {
    it('should create an instance of ResumeSessionRequest', function() {
      // uncomment below and update the code to test ResumeSessionRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.ResumeSessionRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ResumeSessionRequest);
    });
