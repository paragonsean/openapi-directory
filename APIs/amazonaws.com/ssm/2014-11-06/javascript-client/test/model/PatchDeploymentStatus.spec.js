...
(function(root, factory) {
  ...
  describe('PatchDeploymentStatus', function() {
    it('should create an instance of PatchDeploymentStatus', function() {
      // uncomment below and update the code to test PatchDeploymentStatus
      //var instance = new AmazonSimpleSystemsManagerSsm.PatchDeploymentStatus();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.PatchDeploymentStatus);
    });
