...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ListOpsItemRelatedItemsResponse();
  });
  ...
  describe('ListOpsItemRelatedItemsResponse', function() {
    it('should create an instance of ListOpsItemRelatedItemsResponse', function() {
      // uncomment below and update the code to test ListOpsItemRelatedItemsResponse
      //var instance = new AmazonSimpleSystemsManagerSsm.ListOpsItemRelatedItemsResponse();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ListOpsItemRelatedItemsResponse);
    });
