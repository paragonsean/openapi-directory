...
(function(root, factory) {
  ...
  describe('DocumentFilterKey', function() {
    it('should create an instance of DocumentFilterKey', function() {
      // uncomment below and update the code to test DocumentFilterKey
      //var instance = new AmazonSimpleSystemsManagerSsm.DocumentFilterKey();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DocumentFilterKey);
    });
