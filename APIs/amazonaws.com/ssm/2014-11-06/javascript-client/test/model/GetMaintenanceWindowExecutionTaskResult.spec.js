...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.GetMaintenanceWindowExecutionTaskResult();
  });
  ...
  describe('GetMaintenanceWindowExecutionTaskResult', function() {
    it('should create an instance of GetMaintenanceWindowExecutionTaskResult', function() {
      // uncomment below and update the code to test GetMaintenanceWindowExecutionTaskResult
      //var instance = new AmazonSimpleSystemsManagerSsm.GetMaintenanceWindowExecutionTaskResult();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.GetMaintenanceWindowExecutionTaskResult);
    });
