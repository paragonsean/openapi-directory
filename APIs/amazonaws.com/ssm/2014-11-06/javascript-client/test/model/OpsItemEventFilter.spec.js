...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.OpsItemEventFilter();
  });
  ...
  describe('OpsItemEventFilter', function() {
    it('should create an instance of OpsItemEventFilter', function() {
      // uncomment below and update the code to test OpsItemEventFilter
      //var instance = new AmazonSimpleSystemsManagerSsm.OpsItemEventFilter();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.OpsItemEventFilter);
    });
