...
(function(root, factory) {
  ...
  describe('DocumentPermissionType', function() {
    it('should create an instance of DocumentPermissionType', function() {
      // uncomment below and update the code to test DocumentPermissionType
      //var instance = new AmazonSimpleSystemsManagerSsm.DocumentPermissionType();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DocumentPermissionType);
    });
