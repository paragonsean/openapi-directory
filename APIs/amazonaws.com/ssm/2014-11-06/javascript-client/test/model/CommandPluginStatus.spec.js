...
(function(root, factory) {
  ...
  describe('CommandPluginStatus', function() {
    it('should create an instance of CommandPluginStatus', function() {
      // uncomment below and update the code to test CommandPluginStatus
      //var instance = new AmazonSimpleSystemsManagerSsm.CommandPluginStatus();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.CommandPluginStatus);
    });
