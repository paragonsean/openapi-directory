...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeInventoryDeletionsRequest();
  });
  ...
  describe('DescribeInventoryDeletionsRequest', function() {
    it('should create an instance of DescribeInventoryDeletionsRequest', function() {
      // uncomment below and update the code to test DescribeInventoryDeletionsRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeInventoryDeletionsRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeInventoryDeletionsRequest);
    });
