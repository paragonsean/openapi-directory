...
(function(root, factory) {
  ...
  describe('ParameterTier', function() {
    it('should create an instance of ParameterTier', function() {
      // uncomment below and update the code to test ParameterTier
      //var instance = new AmazonSimpleSystemsManagerSsm.ParameterTier();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ParameterTier);
    });
