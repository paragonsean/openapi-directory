...
(function(root, factory) {
  ...
  describe('OpsItemDataType', function() {
    it('should create an instance of OpsItemDataType', function() {
      // uncomment below and update the code to test OpsItemDataType
      //var instance = new AmazonSimpleSystemsManagerSsm.OpsItemDataType();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.OpsItemDataType);
    });
