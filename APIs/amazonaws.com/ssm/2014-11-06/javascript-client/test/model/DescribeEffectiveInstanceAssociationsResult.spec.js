...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeEffectiveInstanceAssociationsResult();
  });
  ...
  describe('DescribeEffectiveInstanceAssociationsResult', function() {
    it('should create an instance of DescribeEffectiveInstanceAssociationsResult', function() {
      // uncomment below and update the code to test DescribeEffectiveInstanceAssociationsResult
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeEffectiveInstanceAssociationsResult();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeEffectiveInstanceAssociationsResult);
    });
