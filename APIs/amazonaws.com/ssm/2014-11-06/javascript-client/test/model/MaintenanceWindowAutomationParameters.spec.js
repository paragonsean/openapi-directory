...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.MaintenanceWindowAutomationParameters();
  });
  ...
  describe('MaintenanceWindowAutomationParameters', function() {
    it('should create an instance of MaintenanceWindowAutomationParameters', function() {
      // uncomment below and update the code to test MaintenanceWindowAutomationParameters
      //var instance = new AmazonSimpleSystemsManagerSsm.MaintenanceWindowAutomationParameters();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.MaintenanceWindowAutomationParameters);
    });
