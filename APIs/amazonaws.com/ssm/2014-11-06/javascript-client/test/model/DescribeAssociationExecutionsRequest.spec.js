...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeAssociationExecutionsRequest();
  });
  ...
  describe('DescribeAssociationExecutionsRequest', function() {
    it('should create an instance of DescribeAssociationExecutionsRequest', function() {
      // uncomment below and update the code to test DescribeAssociationExecutionsRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeAssociationExecutionsRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeAssociationExecutionsRequest);
    });
