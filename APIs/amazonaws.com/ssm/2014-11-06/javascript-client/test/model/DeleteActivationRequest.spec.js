...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DeleteActivationRequest();
  });
  ...
  describe('DeleteActivationRequest', function() {
    it('should create an instance of DeleteActivationRequest', function() {
      // uncomment below and update the code to test DeleteActivationRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DeleteActivationRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DeleteActivationRequest);
    });
