...
(function(root, factory) {
  ...
  describe('OpsItemFilterOperator', function() {
    it('should create an instance of OpsItemFilterOperator', function() {
      // uncomment below and update the code to test OpsItemFilterOperator
      //var instance = new AmazonSimpleSystemsManagerSsm.OpsItemFilterOperator();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.OpsItemFilterOperator);
    });
