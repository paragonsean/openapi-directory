...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ListResourceComplianceSummariesRequest();
  });
  ...
  describe('ListResourceComplianceSummariesRequest', function() {
    it('should create an instance of ListResourceComplianceSummariesRequest', function() {
      // uncomment below and update the code to test ListResourceComplianceSummariesRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.ListResourceComplianceSummariesRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ListResourceComplianceSummariesRequest);
    });
