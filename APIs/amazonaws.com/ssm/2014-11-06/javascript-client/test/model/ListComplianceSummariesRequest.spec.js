...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ListComplianceSummariesRequest();
  });
  ...
  describe('ListComplianceSummariesRequest', function() {
    it('should create an instance of ListComplianceSummariesRequest', function() {
      // uncomment below and update the code to test ListComplianceSummariesRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.ListComplianceSummariesRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ListComplianceSummariesRequest);
    });
