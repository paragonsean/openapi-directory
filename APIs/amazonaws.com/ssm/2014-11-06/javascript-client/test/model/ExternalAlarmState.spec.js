...
(function(root, factory) {
  ...
  describe('ExternalAlarmState', function() {
    it('should create an instance of ExternalAlarmState', function() {
      // uncomment below and update the code to test ExternalAlarmState
      //var instance = new AmazonSimpleSystemsManagerSsm.ExternalAlarmState();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ExternalAlarmState);
    });
