...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeDocumentRequest();
  });
  ...
  describe('DescribeDocumentRequest', function() {
    it('should create an instance of DescribeDocumentRequest', function() {
      // uncomment below and update the code to test DescribeDocumentRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeDocumentRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeDocumentRequest);
    });
