...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.OpsItemRelatedItemSummary();
  });
  ...
  describe('OpsItemRelatedItemSummary', function() {
    it('should create an instance of OpsItemRelatedItemSummary', function() {
      // uncomment below and update the code to test OpsItemRelatedItemSummary
      //var instance = new AmazonSimpleSystemsManagerSsm.OpsItemRelatedItemSummary();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.OpsItemRelatedItemSummary);
    });
