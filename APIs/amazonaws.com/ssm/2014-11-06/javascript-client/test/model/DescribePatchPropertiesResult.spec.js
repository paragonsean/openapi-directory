...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribePatchPropertiesResult();
  });
  ...
  describe('DescribePatchPropertiesResult', function() {
    it('should create an instance of DescribePatchPropertiesResult', function() {
      // uncomment below and update the code to test DescribePatchPropertiesResult
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribePatchPropertiesResult();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribePatchPropertiesResult);
    });
