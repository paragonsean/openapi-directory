...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeAutomationExecutionsRequest();
  });
  ...
  describe('DescribeAutomationExecutionsRequest', function() {
    it('should create an instance of DescribeAutomationExecutionsRequest', function() {
      // uncomment below and update the code to test DescribeAutomationExecutionsRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeAutomationExecutionsRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeAutomationExecutionsRequest);
    });
