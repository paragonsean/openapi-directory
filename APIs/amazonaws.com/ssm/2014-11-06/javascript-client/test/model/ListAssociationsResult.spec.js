...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ListAssociationsResult();
  });
  ...
  describe('ListAssociationsResult', function() {
    it('should create an instance of ListAssociationsResult', function() {
      // uncomment below and update the code to test ListAssociationsResult
      //var instance = new AmazonSimpleSystemsManagerSsm.ListAssociationsResult();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ListAssociationsResult);
    });
