...
(function(root, factory) {
  ...
  describe('CalendarState', function() {
    it('should create an instance of CalendarState', function() {
      // uncomment below and update the code to test CalendarState
      //var instance = new AmazonSimpleSystemsManagerSsm.CalendarState();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.CalendarState);
    });
