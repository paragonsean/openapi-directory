...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.PatchSource();
  });
  ...
  describe('PatchSource', function() {
    it('should create an instance of PatchSource', function() {
      // uncomment below and update the code to test PatchSource
      //var instance = new AmazonSimpleSystemsManagerSsm.PatchSource();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.PatchSource);
    });
