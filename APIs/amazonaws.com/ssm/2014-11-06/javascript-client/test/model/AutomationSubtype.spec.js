...
(function(root, factory) {
  ...
  describe('AutomationSubtype', function() {
    it('should create an instance of AutomationSubtype', function() {
      // uncomment below and update the code to test AutomationSubtype
      //var instance = new AmazonSimpleSystemsManagerSsm.AutomationSubtype();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.AutomationSubtype);
    });
