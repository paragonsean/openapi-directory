...
(function(root, factory) {
  ...
  describe('PatchProperty', function() {
    it('should create an instance of PatchProperty', function() {
      // uncomment below and update the code to test PatchProperty
      //var instance = new AmazonSimpleSystemsManagerSsm.PatchProperty();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.PatchProperty);
    });
