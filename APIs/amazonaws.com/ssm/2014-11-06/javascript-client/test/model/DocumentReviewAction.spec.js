...
(function(root, factory) {
  ...
  describe('DocumentReviewAction', function() {
    it('should create an instance of DocumentReviewAction', function() {
      // uncomment below and update the code to test DocumentReviewAction
      //var instance = new AmazonSimpleSystemsManagerSsm.DocumentReviewAction();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DocumentReviewAction);
    });
