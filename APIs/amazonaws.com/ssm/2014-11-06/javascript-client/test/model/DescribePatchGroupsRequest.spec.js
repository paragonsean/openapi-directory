...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribePatchGroupsRequest();
  });
  ...
  describe('DescribePatchGroupsRequest', function() {
    it('should create an instance of DescribePatchGroupsRequest', function() {
      // uncomment below and update the code to test DescribePatchGroupsRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribePatchGroupsRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribePatchGroupsRequest);
    });
