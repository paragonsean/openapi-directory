...
(function(root, factory) {
  ...
  describe('DocumentHashType', function() {
    it('should create an instance of DocumentHashType', function() {
      // uncomment below and update the code to test DocumentHashType
      //var instance = new AmazonSimpleSystemsManagerSsm.DocumentHashType();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DocumentHashType);
    });
