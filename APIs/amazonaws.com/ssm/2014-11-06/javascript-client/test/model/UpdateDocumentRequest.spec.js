...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.UpdateDocumentRequest();
  });
  ...
  describe('UpdateDocumentRequest', function() {
    it('should create an instance of UpdateDocumentRequest', function() {
      ...
      //var instance = new AmazonSimpleSystemsManagerSsm.UpdateDocumentRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.UpdateDocumentRequest);
    });
