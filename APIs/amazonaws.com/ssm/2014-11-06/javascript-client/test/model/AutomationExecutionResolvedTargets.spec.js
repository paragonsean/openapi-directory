...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.AutomationExecutionResolvedTargets();
  });
  ...
  describe('AutomationExecutionResolvedTargets', function() {
    it('should create an instance of AutomationExecutionResolvedTargets', function() {
      // uncomment below and update the code to test AutomationExecutionResolvedTargets
      //var instance = new AmazonSimpleSystemsManagerSsm.AutomationExecutionResolvedTargets();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.AutomationExecutionResolvedTargets);
    });
