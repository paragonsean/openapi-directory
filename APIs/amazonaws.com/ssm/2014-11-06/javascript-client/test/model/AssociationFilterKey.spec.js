...
(function(root, factory) {
  ...
  describe('AssociationFilterKey', function() {
    it('should create an instance of AssociationFilterKey', function() {
      // uncomment below and update the code to test AssociationFilterKey
      //var instance = new AmazonSimpleSystemsManagerSsm.AssociationFilterKey();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.AssociationFilterKey);
    });
