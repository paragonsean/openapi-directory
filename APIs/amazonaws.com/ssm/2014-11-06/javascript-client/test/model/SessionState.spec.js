...
(function(root, factory) {
  ...
  describe('SessionState', function() {
    it('should create an instance of SessionState', function() {
      // uncomment below and update the code to test SessionState
      //var instance = new AmazonSimpleSystemsManagerSsm.SessionState();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.SessionState);
    });
