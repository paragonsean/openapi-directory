...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ResultAttribute();
  });
  ...
  describe('ResultAttribute', function() {
    it('should create an instance of ResultAttribute', function() {
      // uncomment below and update the code to test ResultAttribute
      //var instance = new AmazonSimpleSystemsManagerSsm.ResultAttribute();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ResultAttribute);
    });
