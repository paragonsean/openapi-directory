...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ResourceComplianceSummaryItemExecutionSummary();
  });
  ...
  describe('ResourceComplianceSummaryItemExecutionSummary', function() {
    it('should create an instance of ResourceComplianceSummaryItemExecutionSummary', function() {
      // uncomment below and update the code to test ResourceComplianceSummaryItemExecutionSummary
      //var instance = new AmazonSimpleSystemsManagerSsm.ResourceComplianceSummaryItemExecutionSummary();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ResourceComplianceSummaryItemExecutionSummary);
    });
