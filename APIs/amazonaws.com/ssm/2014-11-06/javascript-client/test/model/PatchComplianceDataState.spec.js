...
(function(root, factory) {
  ...
  describe('PatchComplianceDataState', function() {
    it('should create an instance of PatchComplianceDataState', function() {
      // uncomment below and update the code to test PatchComplianceDataState
      //var instance = new AmazonSimpleSystemsManagerSsm.PatchComplianceDataState();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.PatchComplianceDataState);
    });
