...
(function(root, factory) {
  ...
  describe('ResourceTypeForTagging', function() {
    it('should create an instance of ResourceTypeForTagging', function() {
      // uncomment below and update the code to test ResourceTypeForTagging
      //var instance = new AmazonSimpleSystemsManagerSsm.ResourceTypeForTagging();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ResourceTypeForTagging);
    });
