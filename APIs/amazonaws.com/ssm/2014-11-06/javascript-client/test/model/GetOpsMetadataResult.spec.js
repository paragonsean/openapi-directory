...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.GetOpsMetadataResult();
  });
  ...
  describe('GetOpsMetadataResult', function() {
    it('should create an instance of GetOpsMetadataResult', function() {
      // uncomment below and update the code to test GetOpsMetadataResult
      //var instance = new AmazonSimpleSystemsManagerSsm.GetOpsMetadataResult();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.GetOpsMetadataResult);
    });
