...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ListCommandsRequest();
  });
  ...
  describe('ListCommandsRequest', function() {
    it('should create an instance of ListCommandsRequest', function() {
      // uncomment below and update the code to test ListCommandsRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.ListCommandsRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ListCommandsRequest);
    });
