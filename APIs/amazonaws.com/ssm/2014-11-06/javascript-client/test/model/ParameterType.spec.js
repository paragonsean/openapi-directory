...
(function(root, factory) {
  ...
  describe('ParameterType', function() {
    it('should create an instance of ParameterType', function() {
      // uncomment below and update the code to test ParameterType
      //var instance = new AmazonSimpleSystemsManagerSsm.ParameterType();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ParameterType);
    });
