...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribePatchBaselinesRequest();
  });
  ...
  describe('DescribePatchBaselinesRequest', function() {
    it('should create an instance of DescribePatchBaselinesRequest', function() {
      // uncomment below and update the code to test DescribePatchBaselinesRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribePatchBaselinesRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribePatchBaselinesRequest);
    });
