...
(function(root, factory) {
  ...
  describe('AttachmentHashType', function() {
    it('should create an instance of AttachmentHashType', function() {
      // uncomment below and update the code to test AttachmentHashType
      //var instance = new AmazonSimpleSystemsManagerSsm.AttachmentHashType();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.AttachmentHashType);
    });
