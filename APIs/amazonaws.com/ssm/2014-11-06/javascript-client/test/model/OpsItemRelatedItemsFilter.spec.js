...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.OpsItemRelatedItemsFilter();
  });
  ...
  describe('OpsItemRelatedItemsFilter', function() {
    it('should create an instance of OpsItemRelatedItemsFilter', function() {
      // uncomment below and update the code to test OpsItemRelatedItemsFilter
      //var instance = new AmazonSimpleSystemsManagerSsm.OpsItemRelatedItemsFilter();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.OpsItemRelatedItemsFilter);
    });
