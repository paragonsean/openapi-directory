...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeEffectivePatchesForPatchBaselineRequest();
  });
  ...
  describe('DescribeEffectivePatchesForPatchBaselineRequest', function() {
    it('should create an instance of DescribeEffectivePatchesForPatchBaselineRequest', function() {
      // uncomment below and update the code to test DescribeEffectivePatchesForPatchBaselineRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeEffectivePatchesForPatchBaselineRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeEffectivePatchesForPatchBaselineRequest);
    });
