...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ListDocumentMetadataHistoryRequest();
  });
  ...
  describe('ListDocumentMetadataHistoryRequest', function() {
    it('should create an instance of ListDocumentMetadataHistoryRequest', function() {
      // uncomment below and update the code to test ListDocumentMetadataHistoryRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.ListDocumentMetadataHistoryRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ListDocumentMetadataHistoryRequest);
    });
