...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ComplianceItemExecutionSummary();
  });
  ...
  describe('ComplianceItemExecutionSummary', function() {
    it('should create an instance of ComplianceItemExecutionSummary', function() {
      // uncomment below and update the code to test ComplianceItemExecutionSummary
      //var instance = new AmazonSimpleSystemsManagerSsm.ComplianceItemExecutionSummary();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ComplianceItemExecutionSummary);
    });
