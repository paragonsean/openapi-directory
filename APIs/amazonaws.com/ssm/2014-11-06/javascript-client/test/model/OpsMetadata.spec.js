...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.OpsMetadata();
  });
  ...
  describe('OpsMetadata', function() {
    it('should create an instance of OpsMetadata', function() {
      // uncomment below and update the code to test OpsMetadata
      //var instance = new AmazonSimpleSystemsManagerSsm.OpsMetadata();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.OpsMetadata);
    });
