...
(function(root, factory) {
  ...
  describe('DocumentReviewCommentType', function() {
    it('should create an instance of DocumentReviewCommentType', function() {
      // uncomment below and update the code to test DocumentReviewCommentType
      //var instance = new AmazonSimpleSystemsManagerSsm.DocumentReviewCommentType();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DocumentReviewCommentType);
    });
