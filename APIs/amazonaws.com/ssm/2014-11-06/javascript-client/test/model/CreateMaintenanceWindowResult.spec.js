...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.CreateMaintenanceWindowResult();
  });
  ...
  describe('CreateMaintenanceWindowResult', function() {
    it('should create an instance of CreateMaintenanceWindowResult', function() {
      // uncomment below and update the code to test CreateMaintenanceWindowResult
      //var instance = new AmazonSimpleSystemsManagerSsm.CreateMaintenanceWindowResult();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.CreateMaintenanceWindowResult);
    });
