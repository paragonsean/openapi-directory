...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ListOpsItemRelatedItemsRequest();
  });
  ...
  describe('ListOpsItemRelatedItemsRequest', function() {
    it('should create an instance of ListOpsItemRelatedItemsRequest', function() {
      // uncomment below and update the code to test ListOpsItemRelatedItemsRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.ListOpsItemRelatedItemsRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ListOpsItemRelatedItemsRequest);
    });
