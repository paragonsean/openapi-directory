...
(function(root, factory) {
  ...
  describe('ExecutionMode', function() {
    it('should create an instance of ExecutionMode', function() {
      // uncomment below and update the code to test ExecutionMode
      //var instance = new AmazonSimpleSystemsManagerSsm.ExecutionMode();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ExecutionMode);
    });
