...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.Tag();
  });
  ...
  describe('Tag', function() {
    it('should create an instance of Tag', function() {
      ...
      //var instance = new AmazonSimpleSystemsManagerSsm.Tag();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.Tag);
    });
