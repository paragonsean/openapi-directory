...
(function(root, factory) {
  ...
  describe('DocumentStatus', function() {
    it('should create an instance of DocumentStatus', function() {
      // uncomment below and update the code to test DocumentStatus
      //var instance = new AmazonSimpleSystemsManagerSsm.DocumentStatus();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DocumentStatus);
    });
