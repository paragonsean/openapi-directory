...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.GetInventoryResult();
  });
  ...
  describe('GetInventoryResult', function() {
    it('should create an instance of GetInventoryResult', function() {
      // uncomment below and update the code to test GetInventoryResult
      //var instance = new AmazonSimpleSystemsManagerSsm.GetInventoryResult();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.GetInventoryResult);
    });
