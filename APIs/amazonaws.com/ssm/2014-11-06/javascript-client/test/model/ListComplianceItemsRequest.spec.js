...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ListComplianceItemsRequest();
  });
  ...
  describe('ListComplianceItemsRequest', function() {
    it('should create an instance of ListComplianceItemsRequest', function() {
      // uncomment below and update the code to test ListComplianceItemsRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.ListComplianceItemsRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ListComplianceItemsRequest);
    });
