...
(function(root, factory) {
  ...
  describe('AutomationExecutionStatus', function() {
    it('should create an instance of AutomationExecutionStatus', function() {
      // uncomment below and update the code to test AutomationExecutionStatus
      //var instance = new AmazonSimpleSystemsManagerSsm.AutomationExecutionStatus();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.AutomationExecutionStatus);
    });
