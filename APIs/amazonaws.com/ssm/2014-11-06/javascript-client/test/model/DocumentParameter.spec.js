...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DocumentParameter();
  });
  ...
  describe('DocumentParameter', function() {
    it('should create an instance of DocumentParameter', function() {
      // uncomment below and update the code to test DocumentParameter
      //var instance = new AmazonSimpleSystemsManagerSsm.DocumentParameter();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DocumentParameter);
    });
