...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ListInventoryEntriesRequest();
  });
  ...
  describe('ListInventoryEntriesRequest', function() {
    it('should create an instance of ListInventoryEntriesRequest', function() {
      // uncomment below and update the code to test ListInventoryEntriesRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.ListInventoryEntriesRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ListInventoryEntriesRequest);
    });
