...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribePatchPropertiesRequest();
  });
  ...
  describe('DescribePatchPropertiesRequest', function() {
    it('should create an instance of DescribePatchPropertiesRequest', function() {
      // uncomment below and update the code to test DescribePatchPropertiesRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribePatchPropertiesRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribePatchPropertiesRequest);
    });
    ...
    it('should have the property patchSet (base name: "PatchSet")', function() {
      // uncomment below and update the code to test the property patchSet
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribePatchPropertiesRequest();
      //expect(instance).to.be();
    });
