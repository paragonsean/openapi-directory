...
(function(root, factory) {
  ...
  describe('OpsFilterOperatorType', function() {
    it('should create an instance of OpsFilterOperatorType', function() {
      // uncomment below and update the code to test OpsFilterOperatorType
      //var instance = new AmazonSimpleSystemsManagerSsm.OpsFilterOperatorType();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.OpsFilterOperatorType);
    });
