...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeAvailablePatchesResult();
  });
  ...
  describe('DescribeAvailablePatchesResult', function() {
    it('should create an instance of DescribeAvailablePatchesResult', function() {
      // uncomment below and update the code to test DescribeAvailablePatchesResult
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeAvailablePatchesResult();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeAvailablePatchesResult);
    });
