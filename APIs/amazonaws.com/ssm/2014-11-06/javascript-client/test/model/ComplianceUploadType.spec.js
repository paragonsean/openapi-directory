...
(function(root, factory) {
  ...
  describe('ComplianceUploadType', function() {
    it('should create an instance of ComplianceUploadType', function() {
      // uncomment below and update the code to test ComplianceUploadType
      //var instance = new AmazonSimpleSystemsManagerSsm.ComplianceUploadType();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ComplianceUploadType);
    });
