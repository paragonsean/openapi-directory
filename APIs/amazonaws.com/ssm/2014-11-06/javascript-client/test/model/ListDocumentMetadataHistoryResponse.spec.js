...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ListDocumentMetadataHistoryResponse();
  });
  ...
  describe('ListDocumentMetadataHistoryResponse', function() {
    it('should create an instance of ListDocumentMetadataHistoryResponse', function() {
      // uncomment below and update the code to test ListDocumentMetadataHistoryResponse
      //var instance = new AmazonSimpleSystemsManagerSsm.ListDocumentMetadataHistoryResponse();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ListDocumentMetadataHistoryResponse);
    });
