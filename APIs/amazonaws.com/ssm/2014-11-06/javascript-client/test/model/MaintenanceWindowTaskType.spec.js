...
(function(root, factory) {
  ...
  describe('MaintenanceWindowTaskType', function() {
    it('should create an instance of MaintenanceWindowTaskType', function() {
      // uncomment below and update the code to test MaintenanceWindowTaskType
      //var instance = new AmazonSimpleSystemsManagerSsm.MaintenanceWindowTaskType();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.MaintenanceWindowTaskType);
    });
