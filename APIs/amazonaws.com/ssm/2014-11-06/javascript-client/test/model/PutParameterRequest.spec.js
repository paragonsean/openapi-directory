...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.PutParameterRequest();
  });
  ...
  describe('PutParameterRequest', function() {
    it('should create an instance of PutParameterRequest', function() {
      // uncomment below and update the code to test PutParameterRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.PutParameterRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.PutParameterRequest);
    });
