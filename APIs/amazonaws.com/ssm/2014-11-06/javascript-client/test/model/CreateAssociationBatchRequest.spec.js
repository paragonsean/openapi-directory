...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.CreateAssociationBatchRequest();
  });
  ...
  describe('CreateAssociationBatchRequest', function() {
    it('should create an instance of CreateAssociationBatchRequest', function() {
      // uncomment below and update the code to test CreateAssociationBatchRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.CreateAssociationBatchRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.CreateAssociationBatchRequest);
    });
