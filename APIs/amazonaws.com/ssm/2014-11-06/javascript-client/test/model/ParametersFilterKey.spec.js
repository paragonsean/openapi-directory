...
(function(root, factory) {
  ...
  describe('ParametersFilterKey', function() {
    it('should create an instance of ParametersFilterKey', function() {
      // uncomment below and update the code to test ParametersFilterKey
      //var instance = new AmazonSimpleSystemsManagerSsm.ParametersFilterKey();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ParametersFilterKey);
    });
