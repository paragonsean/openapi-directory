...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeSessionsRequest();
  });
  ...
  describe('DescribeSessionsRequest', function() {
    it('should create an instance of DescribeSessionsRequest', function() {
      // uncomment below and update the code to test DescribeSessionsRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeSessionsRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeSessionsRequest);
    });
