...
(function(root, factory) {
  ...
  describe('StopType', function() {
    it('should create an instance of StopType', function() {
      // uncomment below and update the code to test StopType
      //var instance = new AmazonSimpleSystemsManagerSsm.StopType();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.StopType);
    });
