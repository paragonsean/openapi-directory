...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeMaintenanceWindowTasksResult();
  });
  ...
  describe('DescribeMaintenanceWindowTasksResult', function() {
    it('should create an instance of DescribeMaintenanceWindowTasksResult', function() {
      // uncomment below and update the code to test DescribeMaintenanceWindowTasksResult
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeMaintenanceWindowTasksResult();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeMaintenanceWindowTasksResult);
    });
