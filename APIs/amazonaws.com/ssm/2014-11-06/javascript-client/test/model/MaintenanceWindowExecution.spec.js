...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.MaintenanceWindowExecution();
  });
  ...
  describe('MaintenanceWindowExecution', function() {
    it('should create an instance of MaintenanceWindowExecution', function() {
      // uncomment below and update the code to test MaintenanceWindowExecution
      //var instance = new AmazonSimpleSystemsManagerSsm.MaintenanceWindowExecution();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.MaintenanceWindowExecution);
    });
