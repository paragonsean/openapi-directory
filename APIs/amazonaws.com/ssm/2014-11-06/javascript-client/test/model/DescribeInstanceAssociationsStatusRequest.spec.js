...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeInstanceAssociationsStatusRequest();
  });
  ...
  describe('DescribeInstanceAssociationsStatusRequest', function() {
    it('should create an instance of DescribeInstanceAssociationsStatusRequest', function() {
      // uncomment below and update the code to test DescribeInstanceAssociationsStatusRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeInstanceAssociationsStatusRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeInstanceAssociationsStatusRequest);
    });
