...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.GetInventoryRequest();
  });
  ...
  describe('GetInventoryRequest', function() {
    it('should create an instance of GetInventoryRequest', function() {
      // uncomment below and update the code to test GetInventoryRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.GetInventoryRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.GetInventoryRequest);
    });
