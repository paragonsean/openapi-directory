...
(function(root, factory) {
  ...
  describe('AssociationSyncCompliance', function() {
    it('should create an instance of AssociationSyncCompliance', function() {
      // uncomment below and update the code to test AssociationSyncCompliance
      //var instance = new AmazonSimpleSystemsManagerSsm.AssociationSyncCompliance();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.AssociationSyncCompliance);
    });
