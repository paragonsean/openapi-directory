...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeDocumentResult();
  });
  ...
  describe('DescribeDocumentResult', function() {
    it('should create an instance of DescribeDocumentResult', function() {
      // uncomment below and update the code to test DescribeDocumentResult
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeDocumentResult();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeDocumentResult);
    });
