...
(function(root, factory) {
  ...
  describe('SessionFilterKey', function() {
    it('should create an instance of SessionFilterKey', function() {
      // uncomment below and update the code to test SessionFilterKey
      //var instance = new AmazonSimpleSystemsManagerSsm.SessionFilterKey();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.SessionFilterKey);
    });
