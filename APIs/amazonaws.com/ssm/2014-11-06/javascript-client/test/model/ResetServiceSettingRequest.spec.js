...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ResetServiceSettingRequest();
  });
  ...
  describe('ResetServiceSettingRequest', function() {
    it('should create an instance of ResetServiceSettingRequest', function() {
      // uncomment below and update the code to test ResetServiceSettingRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.ResetServiceSettingRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ResetServiceSettingRequest);
    });
