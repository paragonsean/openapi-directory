...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.GetOpsMetadataRequest();
  });
  ...
  describe('GetOpsMetadataRequest', function() {
    it('should create an instance of GetOpsMetadataRequest', function() {
      // uncomment below and update the code to test GetOpsMetadataRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.GetOpsMetadataRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.GetOpsMetadataRequest);
    });
