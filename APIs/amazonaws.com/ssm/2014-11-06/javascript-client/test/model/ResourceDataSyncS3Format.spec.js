...
(function(root, factory) {
  ...
  describe('ResourceDataSyncS3Format', function() {
    it('should create an instance of ResourceDataSyncS3Format', function() {
      // uncomment below and update the code to test ResourceDataSyncS3Format
      //var instance = new AmazonSimpleSystemsManagerSsm.ResourceDataSyncS3Format();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ResourceDataSyncS3Format);
    });
