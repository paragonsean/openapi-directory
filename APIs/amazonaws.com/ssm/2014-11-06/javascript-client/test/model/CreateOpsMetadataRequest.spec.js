...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.CreateOpsMetadataRequest();
  });
  ...
  describe('CreateOpsMetadataRequest', function() {
    it('should create an instance of CreateOpsMetadataRequest', function() {
      // uncomment below and update the code to test CreateOpsMetadataRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.CreateOpsMetadataRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.CreateOpsMetadataRequest);
    });
