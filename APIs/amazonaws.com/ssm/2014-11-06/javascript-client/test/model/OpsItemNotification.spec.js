...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.OpsItemNotification();
  });
  ...
  describe('OpsItemNotification', function() {
    it('should create an instance of OpsItemNotification', function() {
      // uncomment below and update the code to test OpsItemNotification
      //var instance = new AmazonSimpleSystemsManagerSsm.OpsItemNotification();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.OpsItemNotification);
    });
