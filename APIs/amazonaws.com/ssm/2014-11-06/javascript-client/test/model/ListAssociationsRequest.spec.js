...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ListAssociationsRequest();
  });
  ...
  describe('ListAssociationsRequest', function() {
    it('should create an instance of ListAssociationsRequest', function() {
      ...
      //var instance = new AmazonSimpleSystemsManagerSsm.ListAssociationsRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ListAssociationsRequest);
    });

    it('should have the property associationFilterList (base name: "AssociationFilterList")', function() {
      // uncomment below and update the code to test the property associationFilterList
      //var instance = new AmazonSimpleSystemsManagerSsm.ListAssociationsRequest();
