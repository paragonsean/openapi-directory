...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.CommandFilter();
  });
  ...
  describe('CommandFilter', function() {
    it('should create an instance of CommandFilter', function() {
      // uncomment below and update the code to test CommandFilter
      //var instance = new AmazonSimpleSystemsManagerSsm.CommandFilter();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.CommandFilter);
    });
