...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.MaintenanceWindowTarget();
  });
  ...
  describe('MaintenanceWindowTarget', function() {
    it('should create an instance of MaintenanceWindowTarget', function() {
      // uncomment below and update the code to test MaintenanceWindowTarget
      //var instance = new AmazonSimpleSystemsManagerSsm.MaintenanceWindowTarget();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.MaintenanceWindowTarget);
    });
