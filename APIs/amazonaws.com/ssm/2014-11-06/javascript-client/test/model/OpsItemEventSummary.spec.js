...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.OpsItemEventSummary();
  });
  ...
  describe('OpsItemEventSummary', function() {
    it('should create an instance of OpsItemEventSummary', function() {
      // uncomment below and update the code to test OpsItemEventSummary
      //var instance = new AmazonSimpleSystemsManagerSsm.OpsItemEventSummary();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.OpsItemEventSummary);
    });
