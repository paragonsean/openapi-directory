...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.MaintenanceWindowExecutionTaskInvocationIdentity();
  });
  ...
  describe('MaintenanceWindowExecutionTaskInvocationIdentity', function() {
    it('should create an instance of MaintenanceWindowExecutionTaskInvocationIdentity', function() {
      // uncomment below and update the code to test MaintenanceWindowExecutionTaskInvocationIdentity
      //var instance = new AmazonSimpleSystemsManagerSsm.MaintenanceWindowExecutionTaskInvocationIdentity();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.MaintenanceWindowExecutionTaskInvocationIdentity);
    });

    it('should have the property windowExecutionId (base name: "WindowExecutionId")', function() {
      // uncomment below and update the code to test the property windowExecutionId
      //var instance = new AmazonSimpleSystemsManagerSsm.MaintenanceWindowExecutionTaskInvocationIdentity();
      //expect(instance).to.be();
    });

    it('should have the property taskExecutionId (base name: "TaskExecutionId")', function() {
      // uncomment below and update the code to test the property taskExecutionId
      //var instance = new AmazonSimpleSystemsManagerSsm.MaintenanceWindowExecutionTaskInvocationIdentity();
      //expect(instance).to.be();
    });
    ...
    it('should have the property windowTargetId (base name: "WindowTargetId")', function() {
      // uncomment below and update the code to test the property windowTargetId
      //var instance = new AmazonSimpleSystemsManagerSsm.MaintenanceWindowExecutionTaskInvocationIdentity();
      //expect(instance).to.be();
    });
