...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.RegisterTargetWithMaintenanceWindowRequest();
  });
  ...
  describe('RegisterTargetWithMaintenanceWindowRequest', function() {
    it('should create an instance of RegisterTargetWithMaintenanceWindowRequest', function() {
      // uncomment below and update the code to test RegisterTargetWithMaintenanceWindowRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.RegisterTargetWithMaintenanceWindowRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.RegisterTargetWithMaintenanceWindowRequest);
    });
