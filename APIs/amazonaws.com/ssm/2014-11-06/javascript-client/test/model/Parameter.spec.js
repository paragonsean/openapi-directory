...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.Parameter();
  });
  ...
  describe('Parameter', function() {
    it('should create an instance of Parameter', function() {
      ...
      //var instance = new AmazonSimpleSystemsManagerSsm.Parameter();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.Parameter);
    });
