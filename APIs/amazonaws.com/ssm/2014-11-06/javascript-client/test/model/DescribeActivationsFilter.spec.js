...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeActivationsFilter();
  });
  ...
  describe('DescribeActivationsFilter', function() {
    it('should create an instance of DescribeActivationsFilter', function() {
      // uncomment below and update the code to test DescribeActivationsFilter
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeActivationsFilter();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeActivationsFilter);
    });
