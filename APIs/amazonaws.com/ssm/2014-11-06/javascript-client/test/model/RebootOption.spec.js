...
(function(root, factory) {
  ...
  describe('RebootOption', function() {
    it('should create an instance of RebootOption', function() {
      // uncomment below and update the code to test RebootOption
      //var instance = new AmazonSimpleSystemsManagerSsm.RebootOption();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.RebootOption);
    });
