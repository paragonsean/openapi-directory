...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.CreateAssociationBatchResult();
  });
  ...
  describe('CreateAssociationBatchResult', function() {
    it('should create an instance of CreateAssociationBatchResult', function() {
      // uncomment below and update the code to test CreateAssociationBatchResult
      //var instance = new AmazonSimpleSystemsManagerSsm.CreateAssociationBatchResult();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.CreateAssociationBatchResult);
    });
