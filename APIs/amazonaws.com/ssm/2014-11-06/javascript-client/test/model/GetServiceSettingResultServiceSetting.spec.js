...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.GetServiceSettingResultServiceSetting();
  });
  ...
  describe('GetServiceSettingResultServiceSetting', function() {
    it('should create an instance of GetServiceSettingResultServiceSetting', function() {
      // uncomment below and update the code to test GetServiceSettingResultServiceSetting
      //var instance = new AmazonSimpleSystemsManagerSsm.GetServiceSettingResultServiceSetting();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.GetServiceSettingResultServiceSetting);
    });
