...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeInstancePatchStatesRequest();
  });
  ...
  describe('DescribeInstancePatchStatesRequest', function() {
    it('should create an instance of DescribeInstancePatchStatesRequest', function() {
      // uncomment below and update the code to test DescribeInstancePatchStatesRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeInstancePatchStatesRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeInstancePatchStatesRequest);
    });
