...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.GetInventorySchemaRequest();
  });
  ...
  describe('GetInventorySchemaRequest', function() {
    it('should create an instance of GetInventorySchemaRequest', function() {
      // uncomment below and update the code to test GetInventorySchemaRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.GetInventorySchemaRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.GetInventorySchemaRequest);
    });
