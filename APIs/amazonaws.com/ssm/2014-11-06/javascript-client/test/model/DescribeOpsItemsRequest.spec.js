...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeOpsItemsRequest();
  });
  ...
  describe('DescribeOpsItemsRequest', function() {
    it('should create an instance of DescribeOpsItemsRequest', function() {
      // uncomment below and update the code to test DescribeOpsItemsRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeOpsItemsRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeOpsItemsRequest);
    });

    it('should have the property opsItemFilters (base name: "OpsItemFilters")', function() {
      // uncomment below and update the code to test the property opsItemFilters
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeOpsItemsRequest();
