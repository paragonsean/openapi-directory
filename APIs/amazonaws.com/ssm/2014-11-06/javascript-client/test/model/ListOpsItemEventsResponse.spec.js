...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ListOpsItemEventsResponse();
  });
  ...
  describe('ListOpsItemEventsResponse', function() {
    it('should create an instance of ListOpsItemEventsResponse', function() {
      // uncomment below and update the code to test ListOpsItemEventsResponse
      //var instance = new AmazonSimpleSystemsManagerSsm.ListOpsItemEventsResponse();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ListOpsItemEventsResponse);
    });
