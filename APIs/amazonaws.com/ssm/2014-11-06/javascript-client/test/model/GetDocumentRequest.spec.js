...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.GetDocumentRequest();
  });
  ...
  describe('GetDocumentRequest', function() {
    it('should create an instance of GetDocumentRequest', function() {
      // uncomment below and update the code to test GetDocumentRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.GetDocumentRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.GetDocumentRequest);
    });
