...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ListOpsMetadataRequest();
  });
  ...
  describe('ListOpsMetadataRequest', function() {
    it('should create an instance of ListOpsMetadataRequest', function() {
      // uncomment below and update the code to test ListOpsMetadataRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.ListOpsMetadataRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ListOpsMetadataRequest);
    });
