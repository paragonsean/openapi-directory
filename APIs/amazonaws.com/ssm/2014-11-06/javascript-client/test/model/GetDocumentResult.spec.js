...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.GetDocumentResult();
  });
  ...
  describe('GetDocumentResult', function() {
    it('should create an instance of GetDocumentResult', function() {
      // uncomment below and update the code to test GetDocumentResult
      //var instance = new AmazonSimpleSystemsManagerSsm.GetDocumentResult();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.GetDocumentResult);
    });
    ...
    it('should have the property attachmentsContent (base name: "AttachmentsContent")', function() {
      // uncomment below and update the code to test the property attachmentsContent
      //var instance = new AmazonSimpleSystemsManagerSsm.GetDocumentResult();
      //expect(instance).to.be();
    });
