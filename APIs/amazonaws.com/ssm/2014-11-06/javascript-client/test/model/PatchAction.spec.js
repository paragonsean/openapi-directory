...
(function(root, factory) {
  ...
  describe('PatchAction', function() {
    it('should create an instance of PatchAction', function() {
      // uncomment below and update the code to test PatchAction
      //var instance = new AmazonSimpleSystemsManagerSsm.PatchAction();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.PatchAction);
    });
