...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.FailedCreateAssociation();
  });
  ...
  describe('FailedCreateAssociation', function() {
    it('should create an instance of FailedCreateAssociation', function() {
      // uncomment below and update the code to test FailedCreateAssociation
      //var instance = new AmazonSimpleSystemsManagerSsm.FailedCreateAssociation();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.FailedCreateAssociation);
    });
