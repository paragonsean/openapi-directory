...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.OpsEntity();
  });
  ...
  describe('OpsEntity', function() {
    it('should create an instance of OpsEntity', function() {
      // uncomment below and update the code to test OpsEntity
      //var instance = new AmazonSimpleSystemsManagerSsm.OpsEntity();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.OpsEntity);
    });
