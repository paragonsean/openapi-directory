...
(function(root, factory) {
  ...
  describe('CommandStatus', function() {
    it('should create an instance of CommandStatus', function() {
      // uncomment below and update the code to test CommandStatus
      //var instance = new AmazonSimpleSystemsManagerSsm.CommandStatus();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.CommandStatus);
    });
