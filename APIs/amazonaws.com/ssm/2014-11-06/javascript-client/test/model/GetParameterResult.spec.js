...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.GetParameterResult();
  });
  ...
  describe('GetParameterResult', function() {
    it('should create an instance of GetParameterResult', function() {
      // uncomment below and update the code to test GetParameterResult
      //var instance = new AmazonSimpleSystemsManagerSsm.GetParameterResult();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.GetParameterResult);
    });
