...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.OpsItem();
  });
  ...
  describe('OpsItem', function() {
    it('should create an instance of OpsItem', function() {
      // uncomment below and update the code to test OpsItem
      //var instance = new AmazonSimpleSystemsManagerSsm.OpsItem();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.OpsItem);
    });
