...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.EffectivePatchPatch();
  });
  ...
  describe('EffectivePatchPatch', function() {
    it('should create an instance of EffectivePatchPatch', function() {
      // uncomment below and update the code to test EffectivePatchPatch
      //var instance = new AmazonSimpleSystemsManagerSsm.EffectivePatchPatch();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.EffectivePatchPatch);
    });
