...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.OpsItemEventSummaryCreatedBy();
  });
  ...
  describe('OpsItemEventSummaryCreatedBy', function() {
    it('should create an instance of OpsItemEventSummaryCreatedBy', function() {
      // uncomment below and update the code to test OpsItemEventSummaryCreatedBy
      //var instance = new AmazonSimpleSystemsManagerSsm.OpsItemEventSummaryCreatedBy();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.OpsItemEventSummaryCreatedBy);
    });
