...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ComplianceItemEntry();
  });
  ...
  describe('ComplianceItemEntry', function() {
    it('should create an instance of ComplianceItemEntry', function() {
      // uncomment below and update the code to test ComplianceItemEntry
      //var instance = new AmazonSimpleSystemsManagerSsm.ComplianceItemEntry();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ComplianceItemEntry);
    });
