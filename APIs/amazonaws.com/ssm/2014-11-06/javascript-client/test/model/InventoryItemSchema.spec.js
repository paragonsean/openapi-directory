...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.InventoryItemSchema();
  });
  ...
  describe('InventoryItemSchema', function() {
    it('should create an instance of InventoryItemSchema', function() {
      // uncomment below and update the code to test InventoryItemSchema
      //var instance = new AmazonSimpleSystemsManagerSsm.InventoryItemSchema();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.InventoryItemSchema);
    });
