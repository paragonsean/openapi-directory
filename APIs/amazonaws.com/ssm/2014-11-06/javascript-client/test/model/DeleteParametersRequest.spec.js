...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DeleteParametersRequest();
  });
  ...
  describe('DeleteParametersRequest', function() {
    it('should create an instance of DeleteParametersRequest', function() {
      // uncomment below and update the code to test DeleteParametersRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DeleteParametersRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DeleteParametersRequest);
    });
