...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeParametersResult();
  });
  ...
  describe('DescribeParametersResult', function() {
    it('should create an instance of DescribeParametersResult', function() {
      // uncomment below and update the code to test DescribeParametersResult
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeParametersResult();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeParametersResult);
    });
