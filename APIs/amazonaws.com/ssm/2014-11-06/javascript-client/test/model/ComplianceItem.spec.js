...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.ComplianceItem();
  });
  ...
  describe('ComplianceItem', function() {
    it('should create an instance of ComplianceItem', function() {
      // uncomment below and update the code to test ComplianceItem
      //var instance = new AmazonSimpleSystemsManagerSsm.ComplianceItem();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ComplianceItem);
    });
