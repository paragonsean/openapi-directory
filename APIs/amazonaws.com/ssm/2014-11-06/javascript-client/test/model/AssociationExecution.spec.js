...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.AssociationExecution();
  });
  ...
  describe('AssociationExecution', function() {
    it('should create an instance of AssociationExecution', function() {
      // uncomment below and update the code to test AssociationExecution
      //var instance = new AmazonSimpleSystemsManagerSsm.AssociationExecution();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.AssociationExecution);
    });
    ...
    it('should have the property resourceCountByStatus (base name: "ResourceCountByStatus")', function() {
      // uncomment below and update the code to test the property resourceCountByStatus
      //var instance = new AmazonSimpleSystemsManagerSsm.AssociationExecution();
      //expect(instance).to.be();
    });
