...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.TerminateSessionResponse();
  });
  ...
  describe('TerminateSessionResponse', function() {
    it('should create an instance of TerminateSessionResponse', function() {
      // uncomment below and update the code to test TerminateSessionResponse
      //var instance = new AmazonSimpleSystemsManagerSsm.TerminateSessionResponse();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.TerminateSessionResponse);
    });
