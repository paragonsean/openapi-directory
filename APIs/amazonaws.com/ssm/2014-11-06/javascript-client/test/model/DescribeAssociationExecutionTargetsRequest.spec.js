...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeAssociationExecutionTargetsRequest();
  });
  ...
  describe('DescribeAssociationExecutionTargetsRequest', function() {
    it('should create an instance of DescribeAssociationExecutionTargetsRequest', function() {
      // uncomment below and update the code to test DescribeAssociationExecutionTargetsRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeAssociationExecutionTargetsRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeAssociationExecutionTargetsRequest);
    });
