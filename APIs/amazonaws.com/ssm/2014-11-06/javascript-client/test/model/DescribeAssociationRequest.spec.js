...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeAssociationRequest();
  });
  ...
  describe('DescribeAssociationRequest', function() {
    it('should create an instance of DescribeAssociationRequest', function() {
      // uncomment below and update the code to test DescribeAssociationRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeAssociationRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeAssociationRequest);
    });
