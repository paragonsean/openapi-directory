...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeEffectiveInstanceAssociationsRequest();
  });
  ...
  describe('DescribeEffectiveInstanceAssociationsRequest', function() {
    it('should create an instance of DescribeEffectiveInstanceAssociationsRequest', function() {
      // uncomment below and update the code to test DescribeEffectiveInstanceAssociationsRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeEffectiveInstanceAssociationsRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeEffectiveInstanceAssociationsRequest);
    });
