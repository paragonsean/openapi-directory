...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.AssociateOpsItemRelatedItemResponse();
  });
  ...
  describe('AssociateOpsItemRelatedItemResponse', function() {
    it('should create an instance of AssociateOpsItemRelatedItemResponse', function() {
      // uncomment below and update the code to test AssociateOpsItemRelatedItemResponse
      //var instance = new AmazonSimpleSystemsManagerSsm.AssociateOpsItemRelatedItemResponse();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.AssociateOpsItemRelatedItemResponse);
    });
