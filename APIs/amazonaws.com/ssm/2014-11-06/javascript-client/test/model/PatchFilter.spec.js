...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.PatchFilter();
  });
  ...
  describe('PatchFilter', function() {
    it('should create an instance of PatchFilter', function() {
      // uncomment below and update the code to test PatchFilter
      //var instance = new AmazonSimpleSystemsManagerSsm.PatchFilter();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.PatchFilter);
    });
