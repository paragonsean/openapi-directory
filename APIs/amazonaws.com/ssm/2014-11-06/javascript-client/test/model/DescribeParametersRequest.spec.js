...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleSystemsManagerSsm.DescribeParametersRequest();
  });
  ...
  describe('DescribeParametersRequest', function() {
    it('should create an instance of DescribeParametersRequest', function() {
      // uncomment below and update the code to test DescribeParametersRequest
      //var instance = new AmazonSimpleSystemsManagerSsm.DescribeParametersRequest();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.DescribeParametersRequest);
    });
