...
(function(root, factory) {
  ...
  describe('ComplianceStatus', function() {
    it('should create an instance of ComplianceStatus', function() {
      // uncomment below and update the code to test ComplianceStatus
      //var instance = new AmazonSimpleSystemsManagerSsm.ComplianceStatus();
      //expect(instance).to.be.a(AmazonSimpleSystemsManagerSsm.ComplianceStatus);
    });
