...
/**
 * The AssociationDescription model module.
 * @module model/AssociationDescription
 * @version 2014-11-06
 */
class AssociationDescription {
    /**
     * Constructs a new <code>AssociationDescription</code>.
     * Describes the parameters for a document.
     * @alias module:model/AssociationDescription
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>AssociationDescription</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssociationDescription} obj Optional instance to populate.
     * @return {module:model/AssociationDescription} The populated <code>AssociationDescription</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssociationDescription();
    ...
    /**
     * Validates the JSON data with respect to <code>AssociationDescription</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssociationDescription</code>.
     */
...
export default AssociationDescription;
