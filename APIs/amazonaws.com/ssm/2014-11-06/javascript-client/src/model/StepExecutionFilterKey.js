...
* @readonly
*/
export default class StepExecutionFilterKey {
    ...
    /**
    * Returns a <code>StepExecutionFilterKey</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/StepExecutionFilterKey} The enum <code>StepExecutionFilterKey</code> value.
    */
