...
* @readonly
*/
export default class ExternalAlarmState {
    ...
    /**
    * Returns a <code>ExternalAlarmState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ExternalAlarmState} The enum <code>ExternalAlarmState</code> value.
    */
