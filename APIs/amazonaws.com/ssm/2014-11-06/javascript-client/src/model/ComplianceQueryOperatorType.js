...
* @readonly
*/
export default class ComplianceQueryOperatorType {
    ...
    /**
    * Returns a <code>ComplianceQueryOperatorType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ComplianceQueryOperatorType} The enum <code>ComplianceQueryOperatorType</code> value.
    */
