...
export default class PatchSet {
    ...
    /**
    * Returns a <code>PatchSet</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PatchSet} The enum <code>PatchSet</code> value.
    */
