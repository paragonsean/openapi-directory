...
* @readonly
*/
export default class LastResourceDataSyncStatus {
    ...
    /**
    * Returns a <code>LastResourceDataSyncStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/LastResourceDataSyncStatus} The enum <code>LastResourceDataSyncStatus</code> value.
    */
