...
* @readonly
*/
export default class OpsItemRelatedItemsFilterOperator {
    ...
    /**
    * Returns a <code>OpsItemRelatedItemsFilterOperator</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/OpsItemRelatedItemsFilterOperator} The enum <code>OpsItemRelatedItemsFilterOperator</code> value.
    */
