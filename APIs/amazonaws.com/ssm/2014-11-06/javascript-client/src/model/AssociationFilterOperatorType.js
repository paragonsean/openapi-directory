...
* @readonly
*/
export default class AssociationFilterOperatorType {
    ...
    /**
    * Returns a <code>AssociationFilterOperatorType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AssociationFilterOperatorType} The enum <code>AssociationFilterOperatorType</code> value.
    */
