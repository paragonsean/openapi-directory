...
export default class NotificationEvent {
    ...
    /**
    * Returns a <code>NotificationEvent</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/NotificationEvent} The enum <code>NotificationEvent</code> value.
    */
