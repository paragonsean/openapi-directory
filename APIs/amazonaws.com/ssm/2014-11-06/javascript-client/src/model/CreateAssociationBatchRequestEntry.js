...
/**
 * The CreateAssociationBatchRequestEntry model module.
 * @module model/CreateAssociationBatchRequestEntry
 * @version 2014-11-06
 */
class CreateAssociationBatchRequestEntry {
    /**
     * Constructs a new <code>CreateAssociationBatchRequestEntry</code>.
     * Describes the association of a Amazon Web Services Systems Manager document (SSM document) and a managed node.
     * @alias module:model/CreateAssociationBatchRequestEntry
     * @param name {String} 
     */
    constructor(name) { 
    ...
    /**
     * Constructs a <code>CreateAssociationBatchRequestEntry</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateAssociationBatchRequestEntry} obj Optional instance to populate.
     * @return {module:model/CreateAssociationBatchRequestEntry} The populated <code>CreateAssociationBatchRequestEntry</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateAssociationBatchRequestEntry();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateAssociationBatchRequestEntry</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateAssociationBatchRequestEntry</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateAssociationBatchRequestEntry.RequiredProperties) {
...
CreateAssociationBatchRequestEntry.RequiredProperties = ["Name"];
...
export default CreateAssociationBatchRequestEntry;
