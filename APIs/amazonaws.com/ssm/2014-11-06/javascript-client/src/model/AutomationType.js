...
* @readonly
*/
export default class AutomationType {
    ...
    /**
    * Returns a <code>AutomationType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AutomationType} The enum <code>AutomationType</code> value.
    */
