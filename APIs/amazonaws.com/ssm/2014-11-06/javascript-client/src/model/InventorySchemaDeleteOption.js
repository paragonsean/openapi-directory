...
* @readonly
*/
export default class InventorySchemaDeleteOption {
    ...
    /**
    * Returns a <code>InventorySchemaDeleteOption</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/InventorySchemaDeleteOption} The enum <code>InventorySchemaDeleteOption</code> value.
    */
