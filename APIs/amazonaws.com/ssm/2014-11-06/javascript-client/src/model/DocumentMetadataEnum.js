...
* @readonly
*/
export default class DocumentMetadataEnum {
    ...
    /**
    * Returns a <code>DocumentMetadataEnum</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DocumentMetadataEnum} The enum <code>DocumentMetadataEnum</code> value.
    */
