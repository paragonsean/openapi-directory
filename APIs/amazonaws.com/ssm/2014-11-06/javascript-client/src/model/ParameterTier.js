...
* @readonly
*/
export default class ParameterTier {
    ...
    /**
    * Returns a <code>ParameterTier</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ParameterTier} The enum <code>ParameterTier</code> value.
    */
