...
* @readonly
*/
export default class PatchDeploymentStatus {
    ...
    /**
    * Returns a <code>PatchDeploymentStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PatchDeploymentStatus} The enum <code>PatchDeploymentStatus</code> value.
    */
