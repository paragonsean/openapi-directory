...
* @readonly
*/
export default class MaintenanceWindowTaskType {
    ...
    /**
    * Returns a <code>MaintenanceWindowTaskType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/MaintenanceWindowTaskType} The enum <code>MaintenanceWindowTaskType</code> value.
    */
