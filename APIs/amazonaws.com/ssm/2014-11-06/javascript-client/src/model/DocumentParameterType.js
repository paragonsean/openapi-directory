...
* @readonly
*/
export default class DocumentParameterType {
    ...
    /**
    * Returns a <code>DocumentParameterType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DocumentParameterType} The enum <code>DocumentParameterType</code> value.
    */
