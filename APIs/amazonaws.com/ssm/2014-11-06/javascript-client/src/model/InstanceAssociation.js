...
/**
 * The InstanceAssociation model module.
 * @module model/InstanceAssociation
 * @version 2014-11-06
 */
class InstanceAssociation {
    /**
     * Constructs a new <code>InstanceAssociation</code>.
     * One or more association documents on the managed node. 
     * @alias module:model/InstanceAssociation
     */
    constructor() { 
        
        InstanceAssociation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InstanceAssociation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InstanceAssociation} obj Optional instance to populate.
     * @return {module:model/InstanceAssociation} The populated <code>InstanceAssociation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InstanceAssociation();
    ...
    /**
     * Validates the JSON data with respect to <code>InstanceAssociation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InstanceAssociation</code>.
     */
 ...
 */
InstanceAssociation.prototype['AssociationId'] = undefined;

/**
 * @member {String} InstanceId
 */
InstanceAssociation.prototype['InstanceId'] = undefined;

/**
 * @member {String} Content
 */
InstanceAssociation.prototype['Content'] = undefined;

/**
 * @member {String} AssociationVersion
 */
InstanceAssociation.prototype['AssociationVersion'] = undefined;
...
export default InstanceAssociation;
