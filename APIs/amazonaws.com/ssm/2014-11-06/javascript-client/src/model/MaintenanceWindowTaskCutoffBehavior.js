...
* @readonly
*/
export default class MaintenanceWindowTaskCutoffBehavior {
    ...
    /**
    * Returns a <code>MaintenanceWindowTaskCutoffBehavior</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/MaintenanceWindowTaskCutoffBehavior} The enum <code>MaintenanceWindowTaskCutoffBehavior</code> value.
    */
