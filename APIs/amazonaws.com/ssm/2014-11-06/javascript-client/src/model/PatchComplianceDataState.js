...
* @readonly
*/
export default class PatchComplianceDataState {
    ...
    /**
    * Returns a <code>PatchComplianceDataState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PatchComplianceDataState} The enum <code>PatchComplianceDataState</code> value.
    */
