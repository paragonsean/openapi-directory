...
* @readonly
*/
export default class AutomationExecutionFilterKey {
    ...
    /**
    * Returns a <code>AutomationExecutionFilterKey</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AutomationExecutionFilterKey} The enum <code>AutomationExecutionFilterKey</code> value.
    */
