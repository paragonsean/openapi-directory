...
* @readonly
*/
export default class OpsItemEventFilterOperator {
    ...
    /**
    * Returns a <code>OpsItemEventFilterOperator</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/OpsItemEventFilterOperator} The enum <code>OpsItemEventFilterOperator</code> value.
    */
