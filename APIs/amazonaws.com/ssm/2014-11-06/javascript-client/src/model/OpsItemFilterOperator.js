...
* @readonly
*/
export default class OpsItemFilterOperator {
    ...
    /**
    * Returns a <code>OpsItemFilterOperator</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/OpsItemFilterOperator} The enum <code>OpsItemFilterOperator</code> value.
    */
