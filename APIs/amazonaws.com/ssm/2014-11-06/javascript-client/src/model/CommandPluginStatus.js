...
* @readonly
*/
export default class CommandPluginStatus {
    ...
    /**
    * Returns a <code>CommandPluginStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CommandPluginStatus} The enum <code>CommandPluginStatus</code> value.
    */
