...
* @readonly
*/
export default class DocumentReviewCommentType {
    ...
    /**
    * Returns a <code>DocumentReviewCommentType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DocumentReviewCommentType} The enum <code>DocumentReviewCommentType</code> value.
    */
