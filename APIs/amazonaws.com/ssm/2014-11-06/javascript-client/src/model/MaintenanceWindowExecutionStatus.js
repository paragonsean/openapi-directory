...
* @readonly
*/
export default class MaintenanceWindowExecutionStatus {
    ...
    /**
    * Returns a <code>MaintenanceWindowExecutionStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/MaintenanceWindowExecutionStatus} The enum <code>MaintenanceWindowExecutionStatus</code> value.
    */
