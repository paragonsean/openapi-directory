...
* @readonly
*/
export default class PatchProperty {
    ...
    /**
    * Returns a <code>PatchProperty</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PatchProperty} The enum <code>PatchProperty</code> value.
    */
