...
* @readonly
*/
export default class AttachmentHashType {
    ...
    /**
    * Returns a <code>AttachmentHashType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AttachmentHashType} The enum <code>AttachmentHashType</code> value.
    */
