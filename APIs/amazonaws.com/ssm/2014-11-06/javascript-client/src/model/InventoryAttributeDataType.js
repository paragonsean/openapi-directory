...
* @readonly
*/
export default class InventoryAttributeDataType {
    ...
    /**
    * Returns a <code>InventoryAttributeDataType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/InventoryAttributeDataType} The enum <code>InventoryAttributeDataType</code> value.
    */
