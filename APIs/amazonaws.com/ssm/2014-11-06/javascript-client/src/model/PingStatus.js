...
* @readonly
*/
export default class PingStatus {
    ...
    /**
    * Returns a <code>PingStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PingStatus} The enum <code>PingStatus</code> value.
    */
