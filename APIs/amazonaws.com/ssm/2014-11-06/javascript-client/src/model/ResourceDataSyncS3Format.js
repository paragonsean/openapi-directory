...
* @readonly
*/
export default class ResourceDataSyncS3Format {
    ...
    /**
    * Returns a <code>ResourceDataSyncS3Format</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ResourceDataSyncS3Format} The enum <code>ResourceDataSyncS3Format</code> value.
    */
