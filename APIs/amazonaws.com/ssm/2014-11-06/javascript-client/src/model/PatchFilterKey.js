...
* @readonly
*/
export default class PatchFilterKey {
    ...
    /**
    * Returns a <code>PatchFilterKey</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PatchFilterKey} The enum <code>PatchFilterKey</code> value.
    */
