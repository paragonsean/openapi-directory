...
* @readonly
*/
export default class OpsItemDataType {
    ...
    /**
    * Returns a <code>OpsItemDataType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/OpsItemDataType} The enum <code>OpsItemDataType</code> value.
    */
