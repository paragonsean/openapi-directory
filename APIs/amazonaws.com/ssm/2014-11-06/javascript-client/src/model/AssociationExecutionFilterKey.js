...
* @readonly
*/
export default class AssociationExecutionFilterKey {
    ...
    /**
    * Returns a <code>AssociationExecutionFilterKey</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AssociationExecutionFilterKey} The enum <code>AssociationExecutionFilterKey</code> value.
    */
