...
* @readonly
*/
export default class SignalType {
    ...
    /**
    * Returns a <code>SignalType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SignalType} The enum <code>SignalType</code> value.
    */
