...
* @readonly
*/
export default class DescribeActivationsFilterKeys {
    ...
    /**
    * Returns a <code>DescribeActivationsFilterKeys</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DescribeActivationsFilterKeys} The enum <code>DescribeActivationsFilterKeys</code> value.
    */
