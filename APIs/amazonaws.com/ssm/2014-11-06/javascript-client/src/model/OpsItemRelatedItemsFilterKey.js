...
* @readonly
*/
export default class OpsItemRelatedItemsFilterKey {
    ...
    /**
    * Returns a <code>OpsItemRelatedItemsFilterKey</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/OpsItemRelatedItemsFilterKey} The enum <code>OpsItemRelatedItemsFilterKey</code> value.
    */
