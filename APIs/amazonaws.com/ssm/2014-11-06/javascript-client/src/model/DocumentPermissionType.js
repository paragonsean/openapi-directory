...
* @readonly
*/
export default class DocumentPermissionType {
    ...
    /**
    * Returns a <code>DocumentPermissionType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DocumentPermissionType} The enum <code>DocumentPermissionType</code> value.
    */
