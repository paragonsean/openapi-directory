...
/**
 * The DocumentDescription model module.
 * @module model/DocumentDescription
 * @version 2014-11-06
 */
class DocumentDescription {
    /**
     * Constructs a new <code>DocumentDescription</code>.
     * Describes an Amazon Web Services Systems Manager document (SSM document). 
     * @alias module:model/DocumentDescription
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>DocumentDescription</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DocumentDescription} obj Optional instance to populate.
     * @return {module:model/DocumentDescription} The populated <code>DocumentDescription</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocumentDescription();
    ...
    /**
     * Validates the JSON data with respect to <code>DocumentDescription</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DocumentDescription</code>.
     */
