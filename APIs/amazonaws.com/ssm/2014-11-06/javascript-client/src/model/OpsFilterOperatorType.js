...
* @readonly
*/
export default class OpsFilterOperatorType {
    ...
    /**
    * Returns a <code>OpsFilterOperatorType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/OpsFilterOperatorType} The enum <code>OpsFilterOperatorType</code> value.
    */
