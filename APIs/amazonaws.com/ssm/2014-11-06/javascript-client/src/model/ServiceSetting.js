...
/**
 * The ServiceSetting model module.
 * @module model/ServiceSetting
 * @version 2014-11-06
 */
class ServiceSetting {
    /**
     * Constructs a new <code>ServiceSetting</code>.
     ...
     * @alias module:model/ServiceSetting
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ServiceSetting</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServiceSetting} obj Optional instance to populate.
     * @return {module:model/ServiceSetting} The populated <code>ServiceSetting</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServiceSetting();
    ...
    /**
     * Validates the JSON data with respect to <code>ServiceSetting</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServiceSetting</code>.
     */
