...
import DocumentFilterKey from './DocumentFilterKey';
...
class DocumentFilter {
     ...
     * @param key {module:model/DocumentFilterKey} 
     * @param value {String} 
     */
    constructor(key, value) { 
        
        DocumentFilter.initialize(this, key, value);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('key')) {
                obj['key'] = ApiClient.convertToType(data['key'], DocumentFilterKey);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DocumentFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DocumentFilter</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DocumentFilter.RequiredProperties) {
        ...
        if (data['key']) { // data not null
          DocumentFilterKey.validateJSON(data['key']);
        }
...
DocumentFilter.RequiredProperties = ["key", "value"];

/**
 * @member {module:model/DocumentFilterKey} key
 */
DocumentFilter.prototype['key'] = undefined;

/**
 * @member {String} value
 */
DocumentFilter.prototype['value'] = undefined;
