...
* @readonly
*/
export default class AssociationSyncCompliance {
    ...
    /**
    * Returns a <code>AssociationSyncCompliance</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AssociationSyncCompliance} The enum <code>AssociationSyncCompliance</code> value.
    */
