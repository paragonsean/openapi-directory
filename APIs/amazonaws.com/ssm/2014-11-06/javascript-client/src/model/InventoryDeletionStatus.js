...
* @readonly
*/
export default class InventoryDeletionStatus {
    ...
    /**
    * Returns a <code>InventoryDeletionStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/InventoryDeletionStatus} The enum <code>InventoryDeletionStatus</code> value.
    */
