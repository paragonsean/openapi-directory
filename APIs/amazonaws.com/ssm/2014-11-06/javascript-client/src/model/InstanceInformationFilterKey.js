...
* @readonly
*/
export default class InstanceInformationFilterKey {
    ...
    /**
    * Returns a <code>InstanceInformationFilterKey</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/InstanceInformationFilterKey} The enum <code>InstanceInformationFilterKey</code> value.
    */
