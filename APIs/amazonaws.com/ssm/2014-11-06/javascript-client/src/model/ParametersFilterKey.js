...
* @readonly
*/
export default class ParametersFilterKey {
    ...
    /**
    * Returns a <code>ParametersFilterKey</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ParametersFilterKey} The enum <code>ParametersFilterKey</code> value.
    */
