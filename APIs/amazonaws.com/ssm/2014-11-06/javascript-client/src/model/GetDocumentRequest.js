...
class GetDocumentRequest {
    ...
    constructor(name) { 
        ...
        GetDocumentRequest.initialize(this, name);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetDocumentRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDocumentRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetDocumentRequest.RequiredProperties) {
...
GetDocumentRequest.RequiredProperties = ["Name"];

/**
 * @member {String} Name
 */
GetDocumentRequest.prototype['Name'] = undefined;

/**
 * @member {String} VersionName
 */
GetDocumentRequest.prototype['VersionName'] = undefined;

/**
 * @member {String} DocumentVersion
 */
GetDocumentRequest.prototype['DocumentVersion'] = undefined;

/**
 * @member {module:model/DocumentFormat} DocumentFormat
 */
GetDocumentRequest.prototype['DocumentFormat'] = undefined;
