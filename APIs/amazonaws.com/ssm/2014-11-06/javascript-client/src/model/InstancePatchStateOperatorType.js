...
* @readonly
*/
export default class InstancePatchStateOperatorType {
    ...
    /**
    * Returns a <code>InstancePatchStateOperatorType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/InstancePatchStateOperatorType} The enum <code>InstancePatchStateOperatorType</code> value.
    */
