...
* @readonly
*/
export default class OpsItemEventFilterKey {
    ...
    /**
    * Returns a <code>OpsItemEventFilterKey</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/OpsItemEventFilterKey} The enum <code>OpsItemEventFilterKey</code> value.
    */
