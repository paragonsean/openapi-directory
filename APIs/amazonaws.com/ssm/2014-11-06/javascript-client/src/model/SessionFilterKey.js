...
* @readonly
*/
export default class SessionFilterKey {
    ...
    /**
    * Returns a <code>SessionFilterKey</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SessionFilterKey} The enum <code>SessionFilterKey</code> value.
    */
