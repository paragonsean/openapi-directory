...
import SendCommandResultCommand from './SendCommandResultCommand';
...
class SendCommandResult {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Command')) {
                obj['Command'] = SendCommandResultCommand.constructFromObject(data['Command']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['Command']) { // data not null
          SendCommandResultCommand.validateJSON(data['Command']);
        }
...
/**
 * @member {module:model/SendCommandResultCommand} Command
 */
SendCommandResult.prototype['Command'] = undefined;
