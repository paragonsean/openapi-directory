...
* @readonly
*/
export default class AutomationSubtype {
    ...
    /**
    * Returns a <code>AutomationSubtype</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AutomationSubtype} The enum <code>AutomationSubtype</code> value.
    */
