...
/**
 * The MaintenanceWindowStepFunctionsParameters model module.
 * @module model/MaintenanceWindowStepFunctionsParameters
 * @version 2014-11-06
 */
class MaintenanceWindowStepFunctionsParameters {
    /**
     * Constructs a new <code>MaintenanceWindowStepFunctionsParameters</code>.
     ...
     * @alias module:model/MaintenanceWindowStepFunctionsParameters
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>MaintenanceWindowStepFunctionsParameters</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MaintenanceWindowStepFunctionsParameters} obj Optional instance to populate.
     * @return {module:model/MaintenanceWindowStepFunctionsParameters} The populated <code>MaintenanceWindowStepFunctionsParameters</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MaintenanceWindowStepFunctionsParameters();
    ...
    /**
     * Validates the JSON data with respect to <code>MaintenanceWindowStepFunctionsParameters</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MaintenanceWindowStepFunctionsParameters</code>.
     */
...
export default MaintenanceWindowStepFunctionsParameters;
