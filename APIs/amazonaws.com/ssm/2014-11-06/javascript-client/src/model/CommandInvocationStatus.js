...
* @readonly
*/
export default class CommandInvocationStatus {
    ...
    /**
    * Returns a <code>CommandInvocationStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CommandInvocationStatus} The enum <code>CommandInvocationStatus</code> value.
    */
