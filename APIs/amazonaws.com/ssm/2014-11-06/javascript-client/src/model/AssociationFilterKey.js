...
* @readonly
*/
export default class AssociationFilterKey {
    ...
    /**
    * Returns a <code>AssociationFilterKey</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AssociationFilterKey} The enum <code>AssociationFilterKey</code> value.
    */
