...
* @readonly
*/
export default class ResourceTypeForTagging {
    ...
    /**
    * Returns a <code>ResourceTypeForTagging</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ResourceTypeForTagging} The enum <code>ResourceTypeForTagging</code> value.
    */
