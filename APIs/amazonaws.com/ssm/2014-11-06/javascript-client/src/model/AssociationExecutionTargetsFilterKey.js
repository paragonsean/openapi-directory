...
* @readonly
*/
export default class AssociationExecutionTargetsFilterKey {
    ...
    /**
    * Returns a <code>AssociationExecutionTargetsFilterKey</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AssociationExecutionTargetsFilterKey} The enum <code>AssociationExecutionTargetsFilterKey</code> value.
    */
