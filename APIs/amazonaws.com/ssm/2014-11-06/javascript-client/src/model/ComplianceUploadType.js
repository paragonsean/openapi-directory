...
* @readonly
*/
export default class ComplianceUploadType {
    ...
    /**
    * Returns a <code>ComplianceUploadType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ComplianceUploadType} The enum <code>ComplianceUploadType</code> value.
    */
