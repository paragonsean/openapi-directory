...
/**
 * The UpdateAssociationResultAssociationDescription model module.
 * @module model/UpdateAssociationResultAssociationDescription
 * @version 2014-11-06
 */
class UpdateAssociationResultAssociationDescription {
    /**
     * Constructs a new <code>UpdateAssociationResultAssociationDescription</code>.
     * @alias module:model/UpdateAssociationResultAssociationDescription
     * @implements module:model/AssociationDescription
     */
    constructor() { 
        AssociationDescription.initialize(this);
        UpdateAssociationResultAssociationDescription.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateAssociationResultAssociationDescription</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateAssociationResultAssociationDescription} obj Optional instance to populate.
     * @return {module:model/UpdateAssociationResultAssociationDescription} The populated <code>UpdateAssociationResultAssociationDescription</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateAssociationResultAssociationDescription();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateAssociationResultAssociationDescription</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateAssociationResultAssociationDescription</code>.
     */
 ...
 * @member {String} Name
 */
UpdateAssociationResultAssociationDescription.prototype['Name'] = undefined;

/**
 * @member {String} InstanceId
 */
UpdateAssociationResultAssociationDescription.prototype['InstanceId'] = undefined;

/**
 * @member {String} AssociationVersion
 */
UpdateAssociationResultAssociationDescription.prototype['AssociationVersion'] = undefined;

/**
 * @member {Date} Date
 */
UpdateAssociationResultAssociationDescription.prototype['Date'] = undefined;

/**
 * @member {Date} LastUpdateAssociationDate
 */
UpdateAssociationResultAssociationDescription.prototype['LastUpdateAssociationDate'] = undefined;

/**
 * @member {module:model/UpdateAssociationStatusRequestAssociationStatus} Status
 */
UpdateAssociationResultAssociationDescription.prototype['Status'] = undefined;

/**
 * @member {module:model/AssociationOverview} Overview
 */
UpdateAssociationResultAssociationDescription.prototype['Overview'] = undefined;

/**
 * @member {String} DocumentVersion
 */
UpdateAssociationResultAssociationDescription.prototype['DocumentVersion'] = undefined;

/**
 * @member {String} AutomationTargetParameterName
 */
UpdateAssociationResultAssociationDescription.prototype['AutomationTargetParameterName'] = undefined;

/**
 * @member {Object} Parameters
 */
UpdateAssociationResultAssociationDescription.prototype['Parameters'] = undefined;

/**
 * @member {String} AssociationId
 */
UpdateAssociationResultAssociationDescription.prototype['AssociationId'] = undefined;

/**
 * @member {Array} Targets
 */
UpdateAssociationResultAssociationDescription.prototype['Targets'] = undefined;

/**
 * @member {String} ScheduleExpression
 */
UpdateAssociationResultAssociationDescription.prototype['ScheduleExpression'] = undefined;

/**
 * @member {module:model/AssociationDescriptionOutputLocation} OutputLocation
 */
UpdateAssociationResultAssociationDescription.prototype['OutputLocation'] = undefined;

/**
 * @member {Date} LastExecutionDate
 */
UpdateAssociationResultAssociationDescription.prototype['LastExecutionDate'] = undefined;

/**
 * @member {Date} LastSuccessfulExecutionDate
 */
UpdateAssociationResultAssociationDescription.prototype['LastSuccessfulExecutionDate'] = undefined;

/**
 * @member {String} AssociationName
 */
UpdateAssociationResultAssociationDescription.prototype['AssociationName'] = undefined;

/**
 * @member {String} MaxErrors
 */
UpdateAssociationResultAssociationDescription.prototype['MaxErrors'] = undefined;

/**
 * @member {String} MaxConcurrency
 */
UpdateAssociationResultAssociationDescription.prototype['MaxConcurrency'] = undefined;

/**
 * @member {module:model/AssociationComplianceSeverity} ComplianceSeverity
 */
UpdateAssociationResultAssociationDescription.prototype['ComplianceSeverity'] = undefined;

/**
 * @member {module:model/AssociationSyncCompliance} SyncCompliance
 */
UpdateAssociationResultAssociationDescription.prototype['SyncCompliance'] = undefined;

/**
 * @member {Boolean} ApplyOnlyAtCronInterval
 */
UpdateAssociationResultAssociationDescription.prototype['ApplyOnlyAtCronInterval'] = undefined;

/**
 * @member {Array} CalendarNames
 */
UpdateAssociationResultAssociationDescription.prototype['CalendarNames'] = undefined;

/**
 * @member {Array} TargetLocations
 */
UpdateAssociationResultAssociationDescription.prototype['TargetLocations'] = undefined;

/**
 * @member {Number} ScheduleOffset
 */
UpdateAssociationResultAssociationDescription.prototype['ScheduleOffset'] = undefined;

/**
 * @member {Array} TargetMaps
 */
UpdateAssociationResultAssociationDescription.prototype['TargetMaps'] = undefined;

/**
 * @member {module:model/AlarmConfiguration} AlarmConfiguration
 */
UpdateAssociationResultAssociationDescription.prototype['AlarmConfiguration'] = undefined;

/**
 * @member {Array} TriggeredAlarms
 */
UpdateAssociationResultAssociationDescription.prototype['TriggeredAlarms'] = undefined;
...
export default UpdateAssociationResultAssociationDescription;
