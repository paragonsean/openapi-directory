...
* @readonly
*/
export default class MaintenanceWindowResourceType {
    ...
    /**
    * Returns a <code>MaintenanceWindowResourceType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/MaintenanceWindowResourceType} The enum <code>MaintenanceWindowResourceType</code> value.
    */
