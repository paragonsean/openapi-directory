...
* @readonly
*/
export default class DocumentFilterKey {
    ...
    /**
    * Returns a <code>DocumentFilterKey</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DocumentFilterKey} The enum <code>DocumentFilterKey</code> value.
    */
