...
* @readonly
*/
export default class PatchAction {
    ...
    /**
    * Returns a <code>PatchAction</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PatchAction} The enum <code>PatchAction</code> value.
    */
