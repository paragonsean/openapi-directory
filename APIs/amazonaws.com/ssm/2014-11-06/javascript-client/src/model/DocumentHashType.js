...
* @readonly
*/
export default class DocumentHashType {
    ...
    /**
    * Returns a <code>DocumentHashType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DocumentHashType} The enum <code>DocumentHashType</code> value.
    */
