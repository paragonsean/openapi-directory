...
import AssociationStatusName from './AssociationStatusName';
...
class AssociationStatus {
     ...
     * @param date {Date} 
     * @param name {module:model/AssociationStatusName} 
     * @param message {String} 
     */
    constructor(date, name, message) { 
        
        AssociationStatus.initialize(this, date, name, message);
    }
     ...
     */
    static initialize(obj, date, name, message) { 
        obj['Date'] = date;
        obj['Name'] = name;
        obj['Message'] = message;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Name')) {
                obj['Name'] = ApiClient.convertToType(data['Name'], AssociationStatusName);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AssociationStatus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssociationStatus</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AssociationStatus.RequiredProperties) {
        ...
        if (data['Name']) { // data not null
          AssociationStatusName.validateJSON(data['Name']);
        }
...
AssociationStatus.RequiredProperties = ["Date", "Name", "Message"];

/**
 * @member {Date} Date
 */
AssociationStatus.prototype['Date'] = undefined;

/**
 * @member {module:model/AssociationStatusName} Name
 */
AssociationStatus.prototype['Name'] = undefined;
 ...
 */
AssociationStatus.prototype['AdditionalInfo'] = undefined;
...
export default AssociationStatus;
