...
* @readonly
*/
export default class DocumentReviewAction {
    ...
    /**
    * Returns a <code>DocumentReviewAction</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DocumentReviewAction} The enum <code>DocumentReviewAction</code> value.
    */
