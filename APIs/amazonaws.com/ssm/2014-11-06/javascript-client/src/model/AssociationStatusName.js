...
* @readonly
*/
export default class AssociationStatusName {
    ...
    /**
    * Returns a <code>AssociationStatusName</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AssociationStatusName} The enum <code>AssociationStatusName</code> value.
    */
