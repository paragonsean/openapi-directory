...
* @readonly
*/
export default class OpsItemStatus {
    ...
    /**
    * Returns a <code>OpsItemStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/OpsItemStatus} The enum <code>OpsItemStatus</code> value.
    */
