...
* @readonly
*/
export default class CommandFilterKey {
    ...
    /**
    * Returns a <code>CommandFilterKey</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CommandFilterKey} The enum <code>CommandFilterKey</code> value.
    */
