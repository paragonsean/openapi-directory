...
/**
 * The ParameterHistory model module.
 * @module model/ParameterHistory
 * @version 2014-11-06
 */
class ParameterHistory {
    /**
     * Constructs a new <code>ParameterHistory</code>.
     * Information about parameter usage.
     * @alias module:model/ParameterHistory
     */
    constructor() { 
        
        ParameterHistory.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ParameterHistory</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ParameterHistory} obj Optional instance to populate.
     * @return {module:model/ParameterHistory} The populated <code>ParameterHistory</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ParameterHistory();
    ...
    /**
     * Validates the JSON data with respect to <code>ParameterHistory</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParameterHistory</code>.
     */
 ...
 * @member {String} Name
 */
ParameterHistory.prototype['Name'] = undefined;

/**
 * @member {module:model/ParameterType} Type
 */
ParameterHistory.prototype['Type'] = undefined;

/**
 * @member {String} KeyId
 */
ParameterHistory.prototype['KeyId'] = undefined;

/**
 * @member {Date} LastModifiedDate
 */
ParameterHistory.prototype['LastModifiedDate'] = undefined;

/**
 * @member {String} LastModifiedUser
 */
ParameterHistory.prototype['LastModifiedUser'] = undefined;

/**
 * @member {String} Description
 */
ParameterHistory.prototype['Description'] = undefined;

/**
 * @member {String} Value
 */
ParameterHistory.prototype['Value'] = undefined;

/**
 * @member {String} AllowedPattern
 */
ParameterHistory.prototype['AllowedPattern'] = undefined;

/**
 * @member {Number} Version
 */
ParameterHistory.prototype['Version'] = undefined;

/**
 * @member {Array} Labels
 */
ParameterHistory.prototype['Labels'] = undefined;

/**
 * @member {module:model/ParameterTier} Tier
 */
ParameterHistory.prototype['Tier'] = undefined;

/**
 * @member {Array} Policies
 */
ParameterHistory.prototype['Policies'] = undefined;

/**
 * @member {String} DataType
 */
ParameterHistory.prototype['DataType'] = undefined;
