...
* @readonly
*/
export default class AutomationExecutionStatus {
    ...
    /**
    * Returns a <code>AutomationExecutionStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AutomationExecutionStatus} The enum <code>AutomationExecutionStatus</code> value.
    */
