...
export default class StopType {
    ...
    /**
    * Returns a <code>StopType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/StopType} The enum <code>StopType</code> value.
    */
