...
* @readonly
*/
export default class AttachmentsSourceKey {
    ...
    /**
    * Returns a <code>AttachmentsSourceKey</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AttachmentsSourceKey} The enum <code>AttachmentsSourceKey</code> value.
    */
