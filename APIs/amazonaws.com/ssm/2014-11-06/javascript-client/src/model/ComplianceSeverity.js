...
* @readonly
*/
export default class ComplianceSeverity {
    ...
    /**
    * Returns a <code>ComplianceSeverity</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ComplianceSeverity} The enum <code>ComplianceSeverity</code> value.
    */
