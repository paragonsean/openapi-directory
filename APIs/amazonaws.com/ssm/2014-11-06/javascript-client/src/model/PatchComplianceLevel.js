...
* @readonly
*/
export default class PatchComplianceLevel {
    ...
    /**
    * Returns a <code>PatchComplianceLevel</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PatchComplianceLevel} The enum <code>PatchComplianceLevel</code> value.
    */
