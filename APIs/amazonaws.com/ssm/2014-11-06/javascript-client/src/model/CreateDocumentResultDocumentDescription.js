...
/**
 * The CreateDocumentResultDocumentDescription model module.
 * @module model/CreateDocumentResultDocumentDescription
 * @version 2014-11-06
 */
class CreateDocumentResultDocumentDescription {
    /**
     * Constructs a new <code>CreateDocumentResultDocumentDescription</code>.
     * @alias module:model/CreateDocumentResultDocumentDescription
     * @implements module:model/DocumentDescription
     */
    constructor() { 
        DocumentDescription.initialize(this);
        CreateDocumentResultDocumentDescription.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateDocumentResultDocumentDescription</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateDocumentResultDocumentDescription} obj Optional instance to populate.
     * @return {module:model/CreateDocumentResultDocumentDescription} The populated <code>CreateDocumentResultDocumentDescription</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateDocumentResultDocumentDescription();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateDocumentResultDocumentDescription</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateDocumentResultDocumentDescription</code>.
     */
 ...
 * @member {String} Sha1
 */
CreateDocumentResultDocumentDescription.prototype['Sha1'] = undefined;

/**
 * @member {String} Hash
 */
CreateDocumentResultDocumentDescription.prototype['Hash'] = undefined;

/**
 * @member {module:model/DocumentHashType} HashType
 */
CreateDocumentResultDocumentDescription.prototype['HashType'] = undefined;

/**
 * @member {String} Name
 */
CreateDocumentResultDocumentDescription.prototype['Name'] = undefined;

/**
 * @member {String} DisplayName
 */
CreateDocumentResultDocumentDescription.prototype['DisplayName'] = undefined;

/**
 * @member {String} VersionName
 */
CreateDocumentResultDocumentDescription.prototype['VersionName'] = undefined;

/**
 * @member {String} Owner
 */
CreateDocumentResultDocumentDescription.prototype['Owner'] = undefined;

/**
 * @member {Date} CreatedDate
 */
CreateDocumentResultDocumentDescription.prototype['CreatedDate'] = undefined;

/**
 * @member {module:model/DocumentStatus} Status
 */
CreateDocumentResultDocumentDescription.prototype['Status'] = undefined;

/**
 * @member {String} StatusInformation
 */
CreateDocumentResultDocumentDescription.prototype['StatusInformation'] = undefined;

/**
 * @member {String} DocumentVersion
 */
CreateDocumentResultDocumentDescription.prototype['DocumentVersion'] = undefined;

/**
 * @member {String} Description
 */
CreateDocumentResultDocumentDescription.prototype['Description'] = undefined;

/**
 * @member {Array} Parameters
 */
CreateDocumentResultDocumentDescription.prototype['Parameters'] = undefined;

/**
 * @member {Array} PlatformTypes
 */
CreateDocumentResultDocumentDescription.prototype['PlatformTypes'] = undefined;

/**
 * @member {module:model/DocumentType} DocumentType
 */
CreateDocumentResultDocumentDescription.prototype['DocumentType'] = undefined;

/**
 * @member {String} SchemaVersion
 */
CreateDocumentResultDocumentDescription.prototype['SchemaVersion'] = undefined;

/**
 * @member {String} LatestVersion
 */
CreateDocumentResultDocumentDescription.prototype['LatestVersion'] = undefined;

/**
 * @member {String} DefaultVersion
 */
CreateDocumentResultDocumentDescription.prototype['DefaultVersion'] = undefined;

/**
 * @member {module:model/DocumentFormat} DocumentFormat
 */
CreateDocumentResultDocumentDescription.prototype['DocumentFormat'] = undefined;

/**
 * @member {String} TargetType
 */
CreateDocumentResultDocumentDescription.prototype['TargetType'] = undefined;

/**
 * @member {Array} Tags
 */
CreateDocumentResultDocumentDescription.prototype['Tags'] = undefined;

/**
 * @member {Array} AttachmentsInformation
 */
CreateDocumentResultDocumentDescription.prototype['AttachmentsInformation'] = undefined;

/**
 * @member {Array} Requires
 */
CreateDocumentResultDocumentDescription.prototype['Requires'] = undefined;

/**
 * @member {String} Author
 */
CreateDocumentResultDocumentDescription.prototype['Author'] = undefined;

/**
 * @member {Array} ReviewInformation
 */
CreateDocumentResultDocumentDescription.prototype['ReviewInformation'] = undefined;

/**
 * @member {String} ApprovedVersion
 */
CreateDocumentResultDocumentDescription.prototype['ApprovedVersion'] = undefined;

/**
 * @member {String} PendingReviewVersion
 */
CreateDocumentResultDocumentDescription.prototype['PendingReviewVersion'] = undefined;

/**
 * @member {module:model/ReviewStatus} ReviewStatus
 */
CreateDocumentResultDocumentDescription.prototype['ReviewStatus'] = undefined;

/**
 * @member {Array} Category
 */
CreateDocumentResultDocumentDescription.prototype['Category'] = undefined;

/**
 * @member {Array} CategoryEnum
 */
CreateDocumentResultDocumentDescription.prototype['CategoryEnum'] = undefined;
...
export default CreateDocumentResultDocumentDescription;
