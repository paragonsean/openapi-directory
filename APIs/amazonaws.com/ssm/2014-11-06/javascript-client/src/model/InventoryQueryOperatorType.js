...
* @readonly
*/
export default class InventoryQueryOperatorType {
    ...
    /**
    * Returns a <code>InventoryQueryOperatorType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/InventoryQueryOperatorType} The enum <code>InventoryQueryOperatorType</code> value.
    */
