...
public class AlarmAlarmState {
  ...
  public AlarmAlarmState() {
  }

  public AlarmAlarmState stateName(AlarmStateName stateName) {
  ...
  public AlarmAlarmState ruleEvaluation(AlarmStateRuleEvaluation ruleEvaluation) {
  ...
  public AlarmAlarmState customerAction(AlarmStateCustomerAction customerAction) {
  ...
  public AlarmAlarmState systemEvent(AlarmStateSystemEvent systemEvent) {
  ...
  public boolean equals(Object o) {
    ...
    AlarmAlarmState alarmAlarmState = (AlarmAlarmState) o;
    return Objects.equals(this.stateName, alarmAlarmState.stateName) &&
        Objects.equals(this.ruleEvaluation, alarmAlarmState.ruleEvaluation) &&
        Objects.equals(this.customerAction, alarmAlarmState.customerAction) &&
        Objects.equals(this.systemEvent, alarmAlarmState.systemEvent);
  }
  ...
  public String toString() {
    ...
    sb.append("class AlarmAlarmState {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AlarmAlarmState
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AlarmAlarmState.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AlarmAlarmState is not found in the empty JSON string", AlarmAlarmState.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AlarmAlarmState.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AlarmAlarmState` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AlarmAlarmState.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AlarmAlarmState' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AlarmAlarmState> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AlarmAlarmState.class));

       return (TypeAdapter<T>) new TypeAdapter<AlarmAlarmState>() {
           @Override
           public void write(JsonWriter out, AlarmAlarmState value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AlarmAlarmState read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AlarmAlarmState given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AlarmAlarmState
   * @throws IOException if the JSON string is invalid with respect to AlarmAlarmState
   */
  public static AlarmAlarmState fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AlarmAlarmState.class);
  }

  /**
   * Convert an instance of AlarmAlarmState to an JSON string
   *
   * @return JSON string
   */
