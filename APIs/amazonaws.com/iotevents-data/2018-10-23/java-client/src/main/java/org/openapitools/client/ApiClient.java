...
public class ApiClient {
    ...
    private String basePath = "http://data.iotevents.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2018-10-23/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://data.iotevents.us-east-1.amazonaws.com
