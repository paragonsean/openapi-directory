...
async def test_batch_acknowledge_alarm(client):
    """Test case for batch_acknowledge_alarm

    
    """
    body = {"acknowledgeActionRequests":""}
    headers = { 
...
async def test_batch_delete_detector(client):
    """Test case for batch_delete_detector
...
async def test_batch_disable_alarm(client):
    """Test case for batch_disable_alarm

    
    """
    body = {"disableActionRequests":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_batch_enable_alarm(client):
    """Test case for batch_enable_alarm

    
    """
    body = {"enableActionRequests":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_batch_put_message(client):
    """Test case for batch_put_message
...
async def test_batch_reset_alarm(client):
    """Test case for batch_reset_alarm

    
    """
    body = {"resetActionRequests":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_batch_snooze_alarm(client):
    """Test case for batch_snooze_alarm

    
    """
    body = {"snoozeActionRequests":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_batch_update_detector(client):
    """Test case for batch_update_detector
...
async def test_describe_alarm(client):
    """Test case for describe_alarm

    
    """
    params = [('keyValue', 'key_value_example')]
    headers = { 
        'Accept': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
        'x_amz_date': 'x_amz_date_example',
    ...
    response = await client.request(
        method='GET',
        path='/alarms/{alarm_model_name}/keyValues'.format(alarm_model_name='alarm_model_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_detector(client):
    ...
    response = await client.request(
        method='GET',
        path='/detectors/{detector_model_name}/keyValues'.format(detector_model_name='detector_model_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_alarms(client):
    ...
    response = await client.request(
        method='GET',
        path='/alarms/{alarm_model_name}'.format(alarm_model_name='alarm_model_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_detectors(client):
    ...
    """
    params = [('stateName', 'state_name_example'),
    ...
    response = await client.request(
        method='GET',
        path='/detectors/{detector_model_name}'.format(detector_model_name='detector_model_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
