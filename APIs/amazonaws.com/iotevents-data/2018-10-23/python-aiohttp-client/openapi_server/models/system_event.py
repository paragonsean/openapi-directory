...
class SystemEvent(Model):
    ...
    def __init__(self, event_type: EventType=None, state_change_configuration: SystemEventStateChangeConfiguration=None):
        ...
        :param state_change_configuration: The state_change_configuration of this SystemEvent.
        """
        self.openapi_types = {
    ...
    def state_change_configuration(self):
        """Gets the state_change_configuration of this SystemEvent.


        :return: The state_change_configuration of this SystemEvent.
    ...
    def state_change_configuration(self, state_change_configuration):
        """Sets the state_change_configuration of this SystemEvent.
