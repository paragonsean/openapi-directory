...
class AlarmState(Model):
    ...
    def __init__(self, state_name: AlarmStateName=None, rule_evaluation: AlarmStateRuleEvaluation=None, customer_action: AlarmStateCustomerAction=None, system_event: AlarmStateSystemEvent=None):
        ...
        :param state_name: The state_name of this AlarmState.
        :param rule_evaluation: The rule_evaluation of this AlarmState.
        :param customer_action: The customer_action of this AlarmState.
        :param system_event: The system_event of this AlarmState.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AlarmState':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The AlarmState of this AlarmState.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def state_name(self):
        """Gets the state_name of this AlarmState.


        :return: The state_name of this AlarmState.
    ...
    def state_name(self, state_name):
        """Sets the state_name of this AlarmState.
    ...
    def rule_evaluation(self):
        """Gets the rule_evaluation of this AlarmState.


        :return: The rule_evaluation of this AlarmState.
    ...
    def rule_evaluation(self, rule_evaluation):
        """Sets the rule_evaluation of this AlarmState.
    ...
    def customer_action(self):
        """Gets the customer_action of this AlarmState.


        :return: The customer_action of this AlarmState.
    ...
    def customer_action(self, customer_action):
        """Sets the customer_action of this AlarmState.
    ...
    def system_event(self):
        """Gets the system_event of this AlarmState.


        :return: The system_event of this AlarmState.
    ...
    def system_event(self, system_event):
        """Sets the system_event of this AlarmState.
