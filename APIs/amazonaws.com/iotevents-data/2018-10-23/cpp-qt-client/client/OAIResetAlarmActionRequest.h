...
/*
 * OAIResetAlarmActionRequest.h
 *
 * Information needed to reset the alarm.
 */

#ifndef OAIResetAlarmActionRequest_H
#define OAIResetAlarmActionRequest_H
...
class OAIResetAlarmActionRequest : public OAIObject {
public:
    OAIResetAlarmActionRequest();
    OAIResetAlarmActionRequest(QString json);
    ~OAIResetAlarmActionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResetAlarmActionRequest)

#endif // OAIResetAlarmActionRequest_H
