...
/*
 * OAIDeleteDetectorRequest.h
 *
 * Information used to delete the detector model.
 */

#ifndef OAIDeleteDetectorRequest_H
#define OAIDeleteDetectorRequest_H
...
class OAIDeleteDetectorRequest : public OAIObject {
public:
    OAIDeleteDetectorRequest();
    OAIDeleteDetectorRequest(QString json);
    ~OAIDeleteDetectorRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteDetectorRequest)

#endif // OAIDeleteDetectorRequest_H
