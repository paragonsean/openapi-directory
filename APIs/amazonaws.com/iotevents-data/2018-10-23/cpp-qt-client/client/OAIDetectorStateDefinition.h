...
/*
 * OAIDetectorStateDefinition.h
 *
 * The new state, variable values, and timer settings of the detector (instance).
 */

#ifndef OAIDetectorStateDefinition_H
#define OAIDetectorStateDefinition_H
...
class OAIDetectorStateDefinition : public OAIObject {
public:
    OAIDetectorStateDefinition();
    OAIDetectorStateDefinition(QString json);
    ~OAIDetectorStateDefinition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectorStateDefinition)

#endif // OAIDetectorStateDefinition_H
