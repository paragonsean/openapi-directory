...
/*
 * OAIDetectorSummary.h
 *
 * Information about the detector (instance).
 */

#ifndef OAIDetectorSummary_H
#define OAIDetectorSummary_H
...
namespace OpenAPI {
class OAIDetectorSummary_state;

class OAIDetectorSummary : public OAIObject {
public:
    OAIDetectorSummary();
    OAIDetectorSummary(QString json);
    ~OAIDetectorSummary() override;
    ...
    OAIDetectorSummary_state getState() const;
    void setState(const OAIDetectorSummary_state &state);
...
private:
    ...
    OAIDetectorSummary_state m_state;
    bool m_state_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectorSummary)

#endif // OAIDetectorSummary_H
