...
#ifndef OAICustomerAction_H
#define OAICustomerAction_H
...
class OAICustomerAction : public OAIObject {
public:
    OAICustomerAction();
    OAICustomerAction(QString json);
    ~OAICustomerAction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomerAction)

#endif // OAICustomerAction_H
