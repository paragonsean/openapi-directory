...
#ifndef OAIDetector_state_H
#define OAIDetector_state_H
...
class OAIDetector_state : public OAIObject {
public:
    OAIDetector_state();
    OAIDetector_state(QString json);
    ~OAIDetector_state() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetector_state)

#endif // OAIDetector_state_H
