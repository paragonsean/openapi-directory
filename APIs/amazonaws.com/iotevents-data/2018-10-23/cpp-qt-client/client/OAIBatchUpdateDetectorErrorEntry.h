...
/*
 * OAIBatchUpdateDetectorErrorEntry.h
 *
 * Information about the error that occurred when attempting to update a detector.
 */

#ifndef OAIBatchUpdateDetectorErrorEntry_H
#define OAIBatchUpdateDetectorErrorEntry_H
...
class OAIBatchUpdateDetectorErrorEntry : public OAIObject {
public:
    OAIBatchUpdateDetectorErrorEntry();
    OAIBatchUpdateDetectorErrorEntry(QString json);
    ~OAIBatchUpdateDetectorErrorEntry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchUpdateDetectorErrorEntry)

#endif // OAIBatchUpdateDetectorErrorEntry_H
