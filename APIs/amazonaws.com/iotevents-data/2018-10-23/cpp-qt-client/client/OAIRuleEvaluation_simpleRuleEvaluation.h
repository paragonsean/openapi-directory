...
/*
 * OAIRuleEvaluation_simpleRuleEvaluation.h
 *
 * 
 */

#ifndef OAIRuleEvaluation_simpleRuleEvaluation_H
#define OAIRuleEvaluation_simpleRuleEvaluation_H
...
class OAIRuleEvaluation_simpleRuleEvaluation : public OAIObject {
public:
    OAIRuleEvaluation_simpleRuleEvaluation();
    OAIRuleEvaluation_simpleRuleEvaluation(QString json);
    ~OAIRuleEvaluation_simpleRuleEvaluation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRuleEvaluation_simpleRuleEvaluation)

#endif // OAIRuleEvaluation_simpleRuleEvaluation_H
