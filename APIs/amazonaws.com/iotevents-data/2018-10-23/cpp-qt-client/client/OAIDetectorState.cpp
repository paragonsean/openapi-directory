...
OAIDetectorState::OAIDetectorState(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectorState::OAIDetectorState() {
    this->initializeModel();
}

OAIDetectorState::~OAIDetectorState() {}

void OAIDetectorState::initializeModel() {
...
void OAIDetectorState::fromJson(QString jsonString) {
...
void OAIDetectorState::fromJsonObject(QJsonObject json) {
...
QString OAIDetectorState::asJson() const {
...
QJsonObject OAIDetectorState::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDetectorState::getStateName() const {
    return m_state_name;
}
void OAIDetectorState::setStateName(const QString &state_name) {
    m_state_name = state_name;
    m_state_name_isSet = true;
}

bool OAIDetectorState::is_state_name_Set() const{
    return m_state_name_isSet;
}

bool OAIDetectorState::is_state_name_Valid() const{
    return m_state_name_isValid;
}

QList OAIDetectorState::getVariables() const {
    return m_variables;
}
void OAIDetectorState::setVariables(const QList &variables) {
    m_variables = variables;
    m_variables_isSet = true;
}

bool OAIDetectorState::is_variables_Set() const{
    return m_variables_isSet;
}

bool OAIDetectorState::is_variables_Valid() const{
    return m_variables_isValid;
}

QList OAIDetectorState::getTimers() const {
    return m_timers;
}
void OAIDetectorState::setTimers(const QList &timers) {
    m_timers = timers;
    m_timers_isSet = true;
}

bool OAIDetectorState::is_timers_Set() const{
    return m_timers_isSet;
}

bool OAIDetectorState::is_timers_Valid() const{
    return m_timers_isValid;
}

bool OAIDetectorState::isSet() const {
...
bool OAIDetectorState::isValid() const {
