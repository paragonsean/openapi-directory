...
#ifndef OAIAlarmState_H
#define OAIAlarmState_H
...
class OAIAlarmState : public OAIObject {
public:
    OAIAlarmState();
    OAIAlarmState(QString json);
    ~OAIAlarmState() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAlarmState)

#endif // OAIAlarmState_H
