...
/*
 * OAIEnableAlarmActionRequest.h
 *
 * Information needed to enable the alarm.
 */

#ifndef OAIEnableAlarmActionRequest_H
#define OAIEnableAlarmActionRequest_H
...
class OAIEnableAlarmActionRequest : public OAIObject {
public:
    OAIEnableAlarmActionRequest();
    OAIEnableAlarmActionRequest(QString json);
    ~OAIEnableAlarmActionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnableAlarmActionRequest)

#endif // OAIEnableAlarmActionRequest_H
