...
/*
 * OAIBatchPutMessageErrorEntry.h
 *
 * Contains information about the errors encountered.
 */

#ifndef OAIBatchPutMessageErrorEntry_H
#define OAIBatchPutMessageErrorEntry_H
...
class OAIBatchPutMessageErrorEntry : public OAIObject {
public:
    OAIBatchPutMessageErrorEntry();
    OAIBatchPutMessageErrorEntry(QString json);
    ~OAIBatchPutMessageErrorEntry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchPutMessageErrorEntry)

#endif // OAIBatchPutMessageErrorEntry_H
