...
#ifndef OAIDetectorState_H
#define OAIDetectorState_H
...
class OAIDetectorState : public OAIObject {
public:
    OAIDetectorState();
    OAIDetectorState(QString json);
    ~OAIDetectorState() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectorState)

#endif // OAIDetectorState_H
