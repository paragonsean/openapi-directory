...
/*
 * OAIDisableAlarmActionRequest.h
 *
 * Information used to disable the alarm.
 */

#ifndef OAIDisableAlarmActionRequest_H
#define OAIDisableAlarmActionRequest_H
...
class OAIDisableAlarmActionRequest : public OAIObject {
public:
    OAIDisableAlarmActionRequest();
    OAIDisableAlarmActionRequest(QString json);
    ~OAIDisableAlarmActionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisableAlarmActionRequest)

#endif // OAIDisableAlarmActionRequest_H
