...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTEventsData.AlarmSummary();
  });
  ...
  describe('AlarmSummary', function() {
    it('should create an instance of AlarmSummary', function() {
      // uncomment below and update the code to test AlarmSummary
      //var instance = new AwsIoTEventsData.AlarmSummary();
      //expect(instance).to.be.a(AwsIoTEventsData.AlarmSummary);
    });
