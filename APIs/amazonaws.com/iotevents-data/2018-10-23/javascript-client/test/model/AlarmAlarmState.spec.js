...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTEventsData.AlarmAlarmState();
  });
  ...
  describe('AlarmAlarmState', function() {
    it('should create an instance of AlarmAlarmState', function() {
      // uncomment below and update the code to test AlarmAlarmState
      //var instance = new AwsIoTEventsData.AlarmAlarmState();
      //expect(instance).to.be.a(AwsIoTEventsData.AlarmAlarmState);
    });
