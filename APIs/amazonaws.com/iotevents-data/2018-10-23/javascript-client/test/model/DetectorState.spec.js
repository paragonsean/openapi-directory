...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTEventsData.DetectorState();
  });
  ...
  describe('DetectorState', function() {
    it('should create an instance of DetectorState', function() {
      // uncomment below and update the code to test DetectorState
      //var instance = new AwsIoTEventsData.DetectorState();
      //expect(instance).to.be.a(AwsIoTEventsData.DetectorState);
    });
