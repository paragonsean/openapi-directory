...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://data.iotevents.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://data.iotevents.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2018-10-23/Javascript'
        };
