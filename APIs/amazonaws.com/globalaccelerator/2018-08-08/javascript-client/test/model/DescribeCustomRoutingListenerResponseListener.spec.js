...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DescribeCustomRoutingListenerResponseListener();
  });
  ...
  describe('DescribeCustomRoutingListenerResponseListener', function() {
    it('should create an instance of DescribeCustomRoutingListenerResponseListener', function() {
      // uncomment below and update the code to test DescribeCustomRoutingListenerResponseListener
      //var instance = new AwsGlobalAccelerator.DescribeCustomRoutingListenerResponseListener();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DescribeCustomRoutingListenerResponseListener);
    });
