...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.ListEndpointGroupsRequest();
  });
  ...
  describe('ListEndpointGroupsRequest', function() {
    it('should create an instance of ListEndpointGroupsRequest', function() {
      // uncomment below and update the code to test ListEndpointGroupsRequest
      //var instance = new AwsGlobalAccelerator.ListEndpointGroupsRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.ListEndpointGroupsRequest);
    });
