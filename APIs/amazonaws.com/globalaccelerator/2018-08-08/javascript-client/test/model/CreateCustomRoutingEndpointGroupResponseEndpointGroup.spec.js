...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.CreateCustomRoutingEndpointGroupResponseEndpointGroup();
  });
  ...
  describe('CreateCustomRoutingEndpointGroupResponseEndpointGroup', function() {
    it('should create an instance of CreateCustomRoutingEndpointGroupResponseEndpointGroup', function() {
      // uncomment below and update the code to test CreateCustomRoutingEndpointGroupResponseEndpointGroup
      //var instance = new AwsGlobalAccelerator.CreateCustomRoutingEndpointGroupResponseEndpointGroup();
      //expect(instance).to.be.a(AwsGlobalAccelerator.CreateCustomRoutingEndpointGroupResponseEndpointGroup);
    });

    it('should have the property endpointGroupArn (base name: "EndpointGroupArn")', function() {
      // uncomment below and update the code to test the property endpointGroupArn
      //var instance = new AwsGlobalAccelerator.CreateCustomRoutingEndpointGroupResponseEndpointGroup();
      //expect(instance).to.be();
    });

    it('should have the property endpointGroupRegion (base name: "EndpointGroupRegion")', function() {
      // uncomment below and update the code to test the property endpointGroupRegion
      //var instance = new AwsGlobalAccelerator.CreateCustomRoutingEndpointGroupResponseEndpointGroup();
      //expect(instance).to.be();
    });

    it('should have the property destinationDescriptions (base name: "DestinationDescriptions")', function() {
      // uncomment below and update the code to test the property destinationDescriptions
      //var instance = new AwsGlobalAccelerator.CreateCustomRoutingEndpointGroupResponseEndpointGroup();
      //expect(instance).to.be();
    });

    it('should have the property endpointDescriptions (base name: "EndpointDescriptions")', function() {
      // uncomment below and update the code to test the property endpointDescriptions
      //var instance = new AwsGlobalAccelerator.CreateCustomRoutingEndpointGroupResponseEndpointGroup();
      //expect(instance).to.be();
    });
