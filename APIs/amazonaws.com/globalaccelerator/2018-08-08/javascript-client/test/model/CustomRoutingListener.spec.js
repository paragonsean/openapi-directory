...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.CustomRoutingListener();
  });
  ...
  describe('CustomRoutingListener', function() {
    it('should create an instance of CustomRoutingListener', function() {
      // uncomment below and update the code to test CustomRoutingListener
      //var instance = new AwsGlobalAccelerator.CustomRoutingListener();
      //expect(instance).to.be.a(AwsGlobalAccelerator.CustomRoutingListener);
    });
