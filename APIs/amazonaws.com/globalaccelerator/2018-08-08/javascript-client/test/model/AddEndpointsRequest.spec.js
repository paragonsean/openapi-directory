...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.AddEndpointsRequest();
  });
  ...
  describe('AddEndpointsRequest', function() {
    it('should create an instance of AddEndpointsRequest', function() {
      // uncomment below and update the code to test AddEndpointsRequest
      //var instance = new AwsGlobalAccelerator.AddEndpointsRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.AddEndpointsRequest);
    });
