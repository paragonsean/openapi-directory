...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.UpdateCustomRoutingAcceleratorAttributesResponseAcceleratorAttributes();
  });
  ...
  describe('UpdateCustomRoutingAcceleratorAttributesResponseAcceleratorAttributes', function() {
    it('should create an instance of UpdateCustomRoutingAcceleratorAttributesResponseAcceleratorAttributes', function() {
      // uncomment below and update the code to test UpdateCustomRoutingAcceleratorAttributesResponseAcceleratorAttributes
      //var instance = new AwsGlobalAccelerator.UpdateCustomRoutingAcceleratorAttributesResponseAcceleratorAttributes();
      //expect(instance).to.be.a(AwsGlobalAccelerator.UpdateCustomRoutingAcceleratorAttributesResponseAcceleratorAttributes);
    });
