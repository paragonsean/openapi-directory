...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.ProvisionByoipCidrResponse();
  });
  ...
  describe('ProvisionByoipCidrResponse', function() {
    it('should create an instance of ProvisionByoipCidrResponse', function() {
      // uncomment below and update the code to test ProvisionByoipCidrResponse
      //var instance = new AwsGlobalAccelerator.ProvisionByoipCidrResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.ProvisionByoipCidrResponse);
    });
