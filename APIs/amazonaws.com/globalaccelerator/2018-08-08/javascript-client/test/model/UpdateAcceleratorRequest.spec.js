...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.UpdateAcceleratorRequest();
  });
  ...
  describe('UpdateAcceleratorRequest', function() {
    it('should create an instance of UpdateAcceleratorRequest', function() {
      // uncomment below and update the code to test UpdateAcceleratorRequest
      //var instance = new AwsGlobalAccelerator.UpdateAcceleratorRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.UpdateAcceleratorRequest);
    });
