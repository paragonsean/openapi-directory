...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.ListAcceleratorsResponse();
  });
  ...
  describe('ListAcceleratorsResponse', function() {
    it('should create an instance of ListAcceleratorsResponse', function() {
      // uncomment below and update the code to test ListAcceleratorsResponse
      //var instance = new AwsGlobalAccelerator.ListAcceleratorsResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.ListAcceleratorsResponse);
    });
