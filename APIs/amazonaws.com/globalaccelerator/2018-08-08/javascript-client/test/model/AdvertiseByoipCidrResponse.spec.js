...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.AdvertiseByoipCidrResponse();
  });
  ...
  describe('AdvertiseByoipCidrResponse', function() {
    it('should create an instance of AdvertiseByoipCidrResponse', function() {
      // uncomment below and update the code to test AdvertiseByoipCidrResponse
      //var instance = new AwsGlobalAccelerator.AdvertiseByoipCidrResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.AdvertiseByoipCidrResponse);
    });
