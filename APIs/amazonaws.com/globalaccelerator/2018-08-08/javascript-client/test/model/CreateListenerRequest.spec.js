...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.CreateListenerRequest();
  });
  ...
  describe('CreateListenerRequest', function() {
    it('should create an instance of CreateListenerRequest', function() {
      // uncomment below and update the code to test CreateListenerRequest
      //var instance = new AwsGlobalAccelerator.CreateListenerRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.CreateListenerRequest);
    });
