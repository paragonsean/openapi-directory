...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.CreateCustomRoutingListenerResponse();
  });
  ...
  describe('CreateCustomRoutingListenerResponse', function() {
    it('should create an instance of CreateCustomRoutingListenerResponse', function() {
      // uncomment below and update the code to test CreateCustomRoutingListenerResponse
      //var instance = new AwsGlobalAccelerator.CreateCustomRoutingListenerResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.CreateCustomRoutingListenerResponse);
    });
