...
(function(root, factory) {
  ...
  describe('CustomRoutingProtocol', function() {
    it('should create an instance of CustomRoutingProtocol', function() {
      // uncomment below and update the code to test CustomRoutingProtocol
      //var instance = new AwsGlobalAccelerator.CustomRoutingProtocol();
      //expect(instance).to.be.a(AwsGlobalAccelerator.CustomRoutingProtocol);
    });
