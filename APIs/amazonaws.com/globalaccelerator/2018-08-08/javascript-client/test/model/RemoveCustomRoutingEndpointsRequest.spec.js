...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.RemoveCustomRoutingEndpointsRequest();
  });
  ...
  describe('RemoveCustomRoutingEndpointsRequest', function() {
    it('should create an instance of RemoveCustomRoutingEndpointsRequest', function() {
      // uncomment below and update the code to test RemoveCustomRoutingEndpointsRequest
      //var instance = new AwsGlobalAccelerator.RemoveCustomRoutingEndpointsRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.RemoveCustomRoutingEndpointsRequest);
    });

    it('should have the property endpointIds (base name: "EndpointIds")', function() {
