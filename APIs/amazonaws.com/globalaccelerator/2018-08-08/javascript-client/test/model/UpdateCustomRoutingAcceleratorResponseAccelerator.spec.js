...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.UpdateCustomRoutingAcceleratorResponseAccelerator();
  });
  ...
  describe('UpdateCustomRoutingAcceleratorResponseAccelerator', function() {
    it('should create an instance of UpdateCustomRoutingAcceleratorResponseAccelerator', function() {
      // uncomment below and update the code to test UpdateCustomRoutingAcceleratorResponseAccelerator
      //var instance = new AwsGlobalAccelerator.UpdateCustomRoutingAcceleratorResponseAccelerator();
      //expect(instance).to.be.a(AwsGlobalAccelerator.UpdateCustomRoutingAcceleratorResponseAccelerator);
    });
