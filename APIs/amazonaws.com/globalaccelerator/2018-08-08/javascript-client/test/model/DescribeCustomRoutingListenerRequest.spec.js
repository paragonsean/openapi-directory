...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DescribeCustomRoutingListenerRequest();
  });
  ...
  describe('DescribeCustomRoutingListenerRequest', function() {
    it('should create an instance of DescribeCustomRoutingListenerRequest', function() {
      // uncomment below and update the code to test DescribeCustomRoutingListenerRequest
      //var instance = new AwsGlobalAccelerator.DescribeCustomRoutingListenerRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DescribeCustomRoutingListenerRequest);
    });
