...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DescribeCustomRoutingAcceleratorRequest();
  });
  ...
  describe('DescribeCustomRoutingAcceleratorRequest', function() {
    it('should create an instance of DescribeCustomRoutingAcceleratorRequest', function() {
      // uncomment below and update the code to test DescribeCustomRoutingAcceleratorRequest
      //var instance = new AwsGlobalAccelerator.DescribeCustomRoutingAcceleratorRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DescribeCustomRoutingAcceleratorRequest);
    });
