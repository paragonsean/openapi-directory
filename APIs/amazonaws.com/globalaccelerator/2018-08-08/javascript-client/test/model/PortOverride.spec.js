...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.PortOverride();
  });
  ...
  describe('PortOverride', function() {
    it('should create an instance of PortOverride', function() {
      // uncomment below and update the code to test PortOverride
      //var instance = new AwsGlobalAccelerator.PortOverride();
      //expect(instance).to.be.a(AwsGlobalAccelerator.PortOverride);
    });

    it('should have the property listenerPort (base name: "ListenerPort")', function() {
      // uncomment below and update the code to test the property listenerPort
      //var instance = new AwsGlobalAccelerator.PortOverride();
      //expect(instance).to.be();
    });

    it('should have the property endpointPort (base name: "EndpointPort")', function() {
      // uncomment below and update the code to test the property endpointPort
      //var instance = new AwsGlobalAccelerator.PortOverride();
      //expect(instance).to.be();
    });
