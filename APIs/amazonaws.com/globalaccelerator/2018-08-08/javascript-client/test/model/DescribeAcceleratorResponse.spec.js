...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DescribeAcceleratorResponse();
  });
  ...
  describe('DescribeAcceleratorResponse', function() {
    it('should create an instance of DescribeAcceleratorResponse', function() {
      // uncomment below and update the code to test DescribeAcceleratorResponse
      //var instance = new AwsGlobalAccelerator.DescribeAcceleratorResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DescribeAcceleratorResponse);
    });
