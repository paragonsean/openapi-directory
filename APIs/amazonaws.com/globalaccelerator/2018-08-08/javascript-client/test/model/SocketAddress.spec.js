...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.SocketAddress();
  });
  ...
  describe('SocketAddress', function() {
    it('should create an instance of SocketAddress', function() {
      ...
      //var instance = new AwsGlobalAccelerator.SocketAddress();
      //expect(instance).to.be.a(AwsGlobalAccelerator.SocketAddress);
    });
