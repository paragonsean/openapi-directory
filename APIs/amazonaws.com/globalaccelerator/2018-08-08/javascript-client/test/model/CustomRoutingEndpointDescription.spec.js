...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.CustomRoutingEndpointDescription();
  });
  ...
  describe('CustomRoutingEndpointDescription', function() {
    it('should create an instance of CustomRoutingEndpointDescription', function() {
      // uncomment below and update the code to test CustomRoutingEndpointDescription
      //var instance = new AwsGlobalAccelerator.CustomRoutingEndpointDescription();
      //expect(instance).to.be.a(AwsGlobalAccelerator.CustomRoutingEndpointDescription);
    });
