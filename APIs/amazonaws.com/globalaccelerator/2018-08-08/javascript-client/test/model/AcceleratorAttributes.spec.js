...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.AcceleratorAttributes();
  });
  ...
  describe('AcceleratorAttributes', function() {
    it('should create an instance of AcceleratorAttributes', function() {
      // uncomment below and update the code to test AcceleratorAttributes
      //var instance = new AwsGlobalAccelerator.AcceleratorAttributes();
      //expect(instance).to.be.a(AwsGlobalAccelerator.AcceleratorAttributes);
    });
