...
(function(root, factory) {
  ...
  describe('AcceleratorStatus', function() {
    it('should create an instance of AcceleratorStatus', function() {
      // uncomment below and update the code to test AcceleratorStatus
      //var instance = new AwsGlobalAccelerator.AcceleratorStatus();
      //expect(instance).to.be.a(AwsGlobalAccelerator.AcceleratorStatus);
    });
