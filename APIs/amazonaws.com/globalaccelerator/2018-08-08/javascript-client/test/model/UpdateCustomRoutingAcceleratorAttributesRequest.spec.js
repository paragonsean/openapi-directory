...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.UpdateCustomRoutingAcceleratorAttributesRequest();
  });
  ...
  describe('UpdateCustomRoutingAcceleratorAttributesRequest', function() {
    it('should create an instance of UpdateCustomRoutingAcceleratorAttributesRequest', function() {
      // uncomment below and update the code to test UpdateCustomRoutingAcceleratorAttributesRequest
      //var instance = new AwsGlobalAccelerator.UpdateCustomRoutingAcceleratorAttributesRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.UpdateCustomRoutingAcceleratorAttributesRequest);
    });

    it('should have the property acceleratorArn (base name: "AcceleratorArn")', function() {
      // uncomment below and update the code to test the property acceleratorArn
      //var instance = new AwsGlobalAccelerator.UpdateCustomRoutingAcceleratorAttributesRequest();
      //expect(instance).to.be();
    });

    it('should have the property flowLogsEnabled (base name: "FlowLogsEnabled")', function() {
      // uncomment below and update the code to test the property flowLogsEnabled
      //var instance = new AwsGlobalAccelerator.UpdateCustomRoutingAcceleratorAttributesRequest();
      //expect(instance).to.be();
    });

    it('should have the property flowLogsS3Bucket (base name: "FlowLogsS3Bucket")', function() {
      // uncomment below and update the code to test the property flowLogsS3Bucket
      //var instance = new AwsGlobalAccelerator.UpdateCustomRoutingAcceleratorAttributesRequest();
      //expect(instance).to.be();
    });

    it('should have the property flowLogsS3Prefix (base name: "FlowLogsS3Prefix")', function() {
      // uncomment below and update the code to test the property flowLogsS3Prefix
      //var instance = new AwsGlobalAccelerator.UpdateCustomRoutingAcceleratorAttributesRequest();
      //expect(instance).to.be();
    });
