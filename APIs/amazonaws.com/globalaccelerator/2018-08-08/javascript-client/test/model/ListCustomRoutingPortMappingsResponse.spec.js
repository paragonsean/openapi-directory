...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.ListCustomRoutingPortMappingsResponse();
  });
  ...
  describe('ListCustomRoutingPortMappingsResponse', function() {
    it('should create an instance of ListCustomRoutingPortMappingsResponse', function() {
      // uncomment below and update the code to test ListCustomRoutingPortMappingsResponse
      //var instance = new AwsGlobalAccelerator.ListCustomRoutingPortMappingsResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.ListCustomRoutingPortMappingsResponse);
    });
