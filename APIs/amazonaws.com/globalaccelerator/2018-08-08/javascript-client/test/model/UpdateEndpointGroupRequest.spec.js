...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.UpdateEndpointGroupRequest();
  });
  ...
  describe('UpdateEndpointGroupRequest', function() {
    it('should create an instance of UpdateEndpointGroupRequest', function() {
      // uncomment below and update the code to test UpdateEndpointGroupRequest
      //var instance = new AwsGlobalAccelerator.UpdateEndpointGroupRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.UpdateEndpointGroupRequest);
    });
    ...
    it('should have the property thresholdCount (base name: "ThresholdCount")', function() {
      // uncomment below and update the code to test the property thresholdCount
      //var instance = new AwsGlobalAccelerator.UpdateEndpointGroupRequest();
      //expect(instance).to.be();
    });

    it('should have the property portOverrides (base name: "PortOverrides")', function() {
      // uncomment below and update the code to test the property portOverrides
      //var instance = new AwsGlobalAccelerator.UpdateEndpointGroupRequest();
      //expect(instance).to.be();
    });
