...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DescribeEndpointGroupRequest();
  });
  ...
  describe('DescribeEndpointGroupRequest', function() {
    it('should create an instance of DescribeEndpointGroupRequest', function() {
      // uncomment below and update the code to test DescribeEndpointGroupRequest
      //var instance = new AwsGlobalAccelerator.DescribeEndpointGroupRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DescribeEndpointGroupRequest);
    });
