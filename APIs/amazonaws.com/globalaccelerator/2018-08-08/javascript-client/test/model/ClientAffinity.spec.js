...
(function(root, factory) {
  ...
  describe('ClientAffinity', function() {
    it('should create an instance of ClientAffinity', function() {
      // uncomment below and update the code to test ClientAffinity
      //var instance = new AwsGlobalAccelerator.ClientAffinity();
      //expect(instance).to.be.a(AwsGlobalAccelerator.ClientAffinity);
    });
