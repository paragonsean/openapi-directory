...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DeleteCustomRoutingAcceleratorRequest();
  });
  ...
  describe('DeleteCustomRoutingAcceleratorRequest', function() {
    it('should create an instance of DeleteCustomRoutingAcceleratorRequest', function() {
      // uncomment below and update the code to test DeleteCustomRoutingAcceleratorRequest
      //var instance = new AwsGlobalAccelerator.DeleteCustomRoutingAcceleratorRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DeleteCustomRoutingAcceleratorRequest);
    });
