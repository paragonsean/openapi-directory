...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DescribeAcceleratorAttributesRequest();
  });
  ...
  describe('DescribeAcceleratorAttributesRequest', function() {
    it('should create an instance of DescribeAcceleratorAttributesRequest', function() {
      // uncomment below and update the code to test DescribeAcceleratorAttributesRequest
      //var instance = new AwsGlobalAccelerator.DescribeAcceleratorAttributesRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DescribeAcceleratorAttributesRequest);
    });
