...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.UpdateCustomRoutingAcceleratorAttributesResponse();
  });
  ...
  describe('UpdateCustomRoutingAcceleratorAttributesResponse', function() {
    it('should create an instance of UpdateCustomRoutingAcceleratorAttributesResponse', function() {
      // uncomment below and update the code to test UpdateCustomRoutingAcceleratorAttributesResponse
      //var instance = new AwsGlobalAccelerator.UpdateCustomRoutingAcceleratorAttributesResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.UpdateCustomRoutingAcceleratorAttributesResponse);
    });
