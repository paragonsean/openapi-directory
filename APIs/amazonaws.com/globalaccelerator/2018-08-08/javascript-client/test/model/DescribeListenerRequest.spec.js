...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DescribeListenerRequest();
  });
  ...
  describe('DescribeListenerRequest', function() {
    it('should create an instance of DescribeListenerRequest', function() {
      // uncomment below and update the code to test DescribeListenerRequest
      //var instance = new AwsGlobalAccelerator.DescribeListenerRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DescribeListenerRequest);
    });
