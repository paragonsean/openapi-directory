...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.ProvisionByoipCidrRequestCidrAuthorizationContext();
  });
  ...
  describe('ProvisionByoipCidrRequestCidrAuthorizationContext', function() {
    it('should create an instance of ProvisionByoipCidrRequestCidrAuthorizationContext', function() {
      // uncomment below and update the code to test ProvisionByoipCidrRequestCidrAuthorizationContext
      //var instance = new AwsGlobalAccelerator.ProvisionByoipCidrRequestCidrAuthorizationContext();
      //expect(instance).to.be.a(AwsGlobalAccelerator.ProvisionByoipCidrRequestCidrAuthorizationContext);
    });
