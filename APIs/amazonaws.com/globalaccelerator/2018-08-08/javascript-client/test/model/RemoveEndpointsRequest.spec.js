...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.RemoveEndpointsRequest();
  });
  ...
  describe('RemoveEndpointsRequest', function() {
    it('should create an instance of RemoveEndpointsRequest', function() {
      // uncomment below and update the code to test RemoveEndpointsRequest
      //var instance = new AwsGlobalAccelerator.RemoveEndpointsRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.RemoveEndpointsRequest);
    });

    it('should have the property endpointIdentifiers (base name: "EndpointIdentifiers")', function() {
      // uncomment below and update the code to test the property endpointIdentifiers
      //var instance = new AwsGlobalAccelerator.RemoveEndpointsRequest();
