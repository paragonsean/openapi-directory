...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.CreateCustomRoutingAcceleratorResponse();
  });
  ...
  describe('CreateCustomRoutingAcceleratorResponse', function() {
    it('should create an instance of CreateCustomRoutingAcceleratorResponse', function() {
      // uncomment below and update the code to test CreateCustomRoutingAcceleratorResponse
      //var instance = new AwsGlobalAccelerator.CreateCustomRoutingAcceleratorResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.CreateCustomRoutingAcceleratorResponse);
    });
