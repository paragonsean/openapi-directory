...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.CustomRoutingAccelerator();
  });
  ...
  describe('CustomRoutingAccelerator', function() {
    it('should create an instance of CustomRoutingAccelerator', function() {
      // uncomment below and update the code to test CustomRoutingAccelerator
      //var instance = new AwsGlobalAccelerator.CustomRoutingAccelerator();
      //expect(instance).to.be.a(AwsGlobalAccelerator.CustomRoutingAccelerator);
    });
