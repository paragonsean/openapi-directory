...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.UpdateAcceleratorResponseAccelerator();
  });
  ...
  describe('UpdateAcceleratorResponseAccelerator', function() {
    it('should create an instance of UpdateAcceleratorResponseAccelerator', function() {
      // uncomment below and update the code to test UpdateAcceleratorResponseAccelerator
      //var instance = new AwsGlobalAccelerator.UpdateAcceleratorResponseAccelerator();
      //expect(instance).to.be.a(AwsGlobalAccelerator.UpdateAcceleratorResponseAccelerator);
    });
    ...
    it('should have the property dualStackDnsName (base name: "DualStackDnsName")', function() {
      // uncomment below and update the code to test the property dualStackDnsName
      //var instance = new AwsGlobalAccelerator.UpdateAcceleratorResponseAccelerator();
      //expect(instance).to.be();
    });
