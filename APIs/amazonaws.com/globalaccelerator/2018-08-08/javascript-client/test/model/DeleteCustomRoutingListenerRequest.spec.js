...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DeleteCustomRoutingListenerRequest();
  });
  ...
  describe('DeleteCustomRoutingListenerRequest', function() {
    it('should create an instance of DeleteCustomRoutingListenerRequest', function() {
      // uncomment below and update the code to test DeleteCustomRoutingListenerRequest
      //var instance = new AwsGlobalAccelerator.DeleteCustomRoutingListenerRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DeleteCustomRoutingListenerRequest);
    });
