...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.UpdateCustomRoutingListenerResponseListener();
  });
  ...
  describe('UpdateCustomRoutingListenerResponseListener', function() {
    it('should create an instance of UpdateCustomRoutingListenerResponseListener', function() {
      // uncomment below and update the code to test UpdateCustomRoutingListenerResponseListener
      //var instance = new AwsGlobalAccelerator.UpdateCustomRoutingListenerResponseListener();
      //expect(instance).to.be.a(AwsGlobalAccelerator.UpdateCustomRoutingListenerResponseListener);
    });
