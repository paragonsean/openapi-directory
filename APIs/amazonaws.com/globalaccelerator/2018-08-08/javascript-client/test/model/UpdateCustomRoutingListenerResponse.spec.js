...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.UpdateCustomRoutingListenerResponse();
  });
  ...
  describe('UpdateCustomRoutingListenerResponse', function() {
    it('should create an instance of UpdateCustomRoutingListenerResponse', function() {
      // uncomment below and update the code to test UpdateCustomRoutingListenerResponse
      //var instance = new AwsGlobalAccelerator.UpdateCustomRoutingListenerResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.UpdateCustomRoutingListenerResponse);
    });
