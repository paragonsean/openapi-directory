...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.CustomRoutingDestinationConfiguration();
  });
  ...
  describe('CustomRoutingDestinationConfiguration', function() {
    it('should create an instance of CustomRoutingDestinationConfiguration', function() {
      // uncomment below and update the code to test CustomRoutingDestinationConfiguration
      //var instance = new AwsGlobalAccelerator.CustomRoutingDestinationConfiguration();
      //expect(instance).to.be.a(AwsGlobalAccelerator.CustomRoutingDestinationConfiguration);
    });
