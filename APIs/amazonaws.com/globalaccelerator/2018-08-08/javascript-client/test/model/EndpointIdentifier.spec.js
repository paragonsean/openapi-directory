...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.EndpointIdentifier();
  });
  ...
  describe('EndpointIdentifier', function() {
    it('should create an instance of EndpointIdentifier', function() {
      // uncomment below and update the code to test EndpointIdentifier
      //var instance = new AwsGlobalAccelerator.EndpointIdentifier();
      //expect(instance).to.be.a(AwsGlobalAccelerator.EndpointIdentifier);
    });
    ...
    it('should have the property clientIPPreservationEnabled (base name: "ClientIPPreservationEnabled")', function() {
      // uncomment below and update the code to test the property clientIPPreservationEnabled
      //var instance = new AwsGlobalAccelerator.EndpointIdentifier();
      //expect(instance).to.be();
    });
