...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DescribeAcceleratorAttributesResponse();
  });
  ...
  describe('DescribeAcceleratorAttributesResponse', function() {
    it('should create an instance of DescribeAcceleratorAttributesResponse', function() {
      // uncomment below and update the code to test DescribeAcceleratorAttributesResponse
      //var instance = new AwsGlobalAccelerator.DescribeAcceleratorAttributesResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DescribeAcceleratorAttributesResponse);
    });
