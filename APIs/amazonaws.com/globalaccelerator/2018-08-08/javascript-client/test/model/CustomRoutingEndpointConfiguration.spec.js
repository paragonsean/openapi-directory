...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.CustomRoutingEndpointConfiguration();
  });
  ...
  describe('CustomRoutingEndpointConfiguration', function() {
    it('should create an instance of CustomRoutingEndpointConfiguration', function() {
      // uncomment below and update the code to test CustomRoutingEndpointConfiguration
      //var instance = new AwsGlobalAccelerator.CustomRoutingEndpointConfiguration();
      //expect(instance).to.be.a(AwsGlobalAccelerator.CustomRoutingEndpointConfiguration);
    });
