...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DescribeListenerResponseListener();
  });
  ...
  describe('DescribeListenerResponseListener', function() {
    it('should create an instance of DescribeListenerResponseListener', function() {
      // uncomment below and update the code to test DescribeListenerResponseListener
      //var instance = new AwsGlobalAccelerator.DescribeListenerResponseListener();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DescribeListenerResponseListener);
    });
