...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DescribeEndpointGroupResponse();
  });
  ...
  describe('DescribeEndpointGroupResponse', function() {
    it('should create an instance of DescribeEndpointGroupResponse', function() {
      // uncomment below and update the code to test DescribeEndpointGroupResponse
      //var instance = new AwsGlobalAccelerator.DescribeEndpointGroupResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DescribeEndpointGroupResponse);
    });
