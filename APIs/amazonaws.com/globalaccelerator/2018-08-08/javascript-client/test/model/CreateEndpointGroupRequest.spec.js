...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.CreateEndpointGroupRequest();
  });
  ...
  describe('CreateEndpointGroupRequest', function() {
    it('should create an instance of CreateEndpointGroupRequest', function() {
      // uncomment below and update the code to test CreateEndpointGroupRequest
      //var instance = new AwsGlobalAccelerator.CreateEndpointGroupRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.CreateEndpointGroupRequest);
    });
