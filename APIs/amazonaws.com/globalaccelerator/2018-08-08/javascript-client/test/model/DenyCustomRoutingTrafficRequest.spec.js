...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DenyCustomRoutingTrafficRequest();
  });
  ...
  describe('DenyCustomRoutingTrafficRequest', function() {
    it('should create an instance of DenyCustomRoutingTrafficRequest', function() {
      // uncomment below and update the code to test DenyCustomRoutingTrafficRequest
      //var instance = new AwsGlobalAccelerator.DenyCustomRoutingTrafficRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DenyCustomRoutingTrafficRequest);
    });
    ...
    it('should have the property denyAllTrafficToEndpoint (base name: "DenyAllTrafficToEndpoint")', function() {
      // uncomment below and update the code to test the property denyAllTrafficToEndpoint
      //var instance = new AwsGlobalAccelerator.DenyCustomRoutingTrafficRequest();
      //expect(instance).to.be();
    });
