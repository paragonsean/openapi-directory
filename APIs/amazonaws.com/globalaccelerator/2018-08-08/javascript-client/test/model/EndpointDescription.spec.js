...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.EndpointDescription();
  });
  ...
  describe('EndpointDescription', function() {
    it('should create an instance of EndpointDescription', function() {
      // uncomment below and update the code to test EndpointDescription
      //var instance = new AwsGlobalAccelerator.EndpointDescription();
      //expect(instance).to.be.a(AwsGlobalAccelerator.EndpointDescription);
    });
    ...
    it('should have the property healthReason (base name: "HealthReason")', function() {
      // uncomment below and update the code to test the property healthReason
      //var instance = new AwsGlobalAccelerator.EndpointDescription();
      //expect(instance).to.be();
    });
