...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.UpdateAcceleratorAttributesResponseAcceleratorAttributes();
  });
  ...
  describe('UpdateAcceleratorAttributesResponseAcceleratorAttributes', function() {
    it('should create an instance of UpdateAcceleratorAttributesResponseAcceleratorAttributes', function() {
      // uncomment below and update the code to test UpdateAcceleratorAttributesResponseAcceleratorAttributes
      //var instance = new AwsGlobalAccelerator.UpdateAcceleratorAttributesResponseAcceleratorAttributes();
      //expect(instance).to.be.a(AwsGlobalAccelerator.UpdateAcceleratorAttributesResponseAcceleratorAttributes);
    });
