...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.WithdrawByoipCidrResponse();
  });
  ...
  describe('WithdrawByoipCidrResponse', function() {
    it('should create an instance of WithdrawByoipCidrResponse', function() {
      // uncomment below and update the code to test WithdrawByoipCidrResponse
      //var instance = new AwsGlobalAccelerator.WithdrawByoipCidrResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.WithdrawByoipCidrResponse);
    });

    it('should have the property byoipCidr (base name: "ByoipCidr")', function() {
      // uncomment below and update the code to test the property byoipCidr
      //var instance = new AwsGlobalAccelerator.WithdrawByoipCidrResponse();
