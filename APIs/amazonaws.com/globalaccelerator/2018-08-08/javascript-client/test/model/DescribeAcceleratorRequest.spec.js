...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DescribeAcceleratorRequest();
  });
  ...
  describe('DescribeAcceleratorRequest', function() {
    it('should create an instance of DescribeAcceleratorRequest', function() {
      // uncomment below and update the code to test DescribeAcceleratorRequest
      //var instance = new AwsGlobalAccelerator.DescribeAcceleratorRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DescribeAcceleratorRequest);
    });
