...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.ListListenersRequest();
  });
  ...
  describe('ListListenersRequest', function() {
    it('should create an instance of ListListenersRequest', function() {
      // uncomment below and update the code to test ListListenersRequest
      //var instance = new AwsGlobalAccelerator.ListListenersRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.ListListenersRequest);
    });
