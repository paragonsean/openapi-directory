...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.CustomRoutingEndpointGroup();
  });
  ...
  describe('CustomRoutingEndpointGroup', function() {
    it('should create an instance of CustomRoutingEndpointGroup', function() {
      // uncomment below and update the code to test CustomRoutingEndpointGroup
      //var instance = new AwsGlobalAccelerator.CustomRoutingEndpointGroup();
      //expect(instance).to.be.a(AwsGlobalAccelerator.CustomRoutingEndpointGroup);
    });
