...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.CreateCustomRoutingEndpointGroupResponse();
  });
  ...
  describe('CreateCustomRoutingEndpointGroupResponse', function() {
    it('should create an instance of CreateCustomRoutingEndpointGroupResponse', function() {
      // uncomment below and update the code to test CreateCustomRoutingEndpointGroupResponse
      //var instance = new AwsGlobalAccelerator.CreateCustomRoutingEndpointGroupResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.CreateCustomRoutingEndpointGroupResponse);
    });
