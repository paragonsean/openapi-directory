...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.CreateAcceleratorResponse();
  });
  ...
  describe('CreateAcceleratorResponse', function() {
    it('should create an instance of CreateAcceleratorResponse', function() {
      // uncomment below and update the code to test CreateAcceleratorResponse
      //var instance = new AwsGlobalAccelerator.CreateAcceleratorResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.CreateAcceleratorResponse);
    });
