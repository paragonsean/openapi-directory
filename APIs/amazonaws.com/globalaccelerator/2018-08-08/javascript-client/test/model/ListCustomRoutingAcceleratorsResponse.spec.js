...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.ListCustomRoutingAcceleratorsResponse();
  });
  ...
  describe('ListCustomRoutingAcceleratorsResponse', function() {
    it('should create an instance of ListCustomRoutingAcceleratorsResponse', function() {
      // uncomment below and update the code to test ListCustomRoutingAcceleratorsResponse
      //var instance = new AwsGlobalAccelerator.ListCustomRoutingAcceleratorsResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.ListCustomRoutingAcceleratorsResponse);
    });
