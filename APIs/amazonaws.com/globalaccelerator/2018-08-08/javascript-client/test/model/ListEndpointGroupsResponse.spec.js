...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.ListEndpointGroupsResponse();
  });
  ...
  describe('ListEndpointGroupsResponse', function() {
    it('should create an instance of ListEndpointGroupsResponse', function() {
      // uncomment below and update the code to test ListEndpointGroupsResponse
      //var instance = new AwsGlobalAccelerator.ListEndpointGroupsResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.ListEndpointGroupsResponse);
    });
