...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.CreateCustomRoutingAcceleratorResponseAccelerator();
  });
  ...
  describe('CreateCustomRoutingAcceleratorResponseAccelerator', function() {
    it('should create an instance of CreateCustomRoutingAcceleratorResponseAccelerator', function() {
      // uncomment below and update the code to test CreateCustomRoutingAcceleratorResponseAccelerator
      //var instance = new AwsGlobalAccelerator.CreateCustomRoutingAcceleratorResponseAccelerator();
      //expect(instance).to.be.a(AwsGlobalAccelerator.CreateCustomRoutingAcceleratorResponseAccelerator);
    });
