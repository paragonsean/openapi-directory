...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.ListByoipCidrsResponse();
  });
  ...
  describe('ListByoipCidrsResponse', function() {
    it('should create an instance of ListByoipCidrsResponse', function() {
      // uncomment below and update the code to test ListByoipCidrsResponse
      //var instance = new AwsGlobalAccelerator.ListByoipCidrsResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.ListByoipCidrsResponse);
    });

    it('should have the property byoipCidrs (base name: "ByoipCidrs")', function() {
      // uncomment below and update the code to test the property byoipCidrs
      //var instance = new AwsGlobalAccelerator.ListByoipCidrsResponse();
