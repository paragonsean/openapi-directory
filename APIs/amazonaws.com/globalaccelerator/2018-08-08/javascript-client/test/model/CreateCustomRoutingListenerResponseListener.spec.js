...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.CreateCustomRoutingListenerResponseListener();
  });
  ...
  describe('CreateCustomRoutingListenerResponseListener', function() {
    it('should create an instance of CreateCustomRoutingListenerResponseListener', function() {
      // uncomment below and update the code to test CreateCustomRoutingListenerResponseListener
      //var instance = new AwsGlobalAccelerator.CreateCustomRoutingListenerResponseListener();
      //expect(instance).to.be.a(AwsGlobalAccelerator.CreateCustomRoutingListenerResponseListener);
    });
