...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.CreateListenerResponse();
  });
  ...
  describe('CreateListenerResponse', function() {
    it('should create an instance of CreateListenerResponse', function() {
      // uncomment below and update the code to test CreateListenerResponse
      //var instance = new AwsGlobalAccelerator.CreateListenerResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.CreateListenerResponse);
    });
