...
(function(root, factory) {
  ...
  describe('CustomRoutingDestinationTrafficState', function() {
    it('should create an instance of CustomRoutingDestinationTrafficState', function() {
      // uncomment below and update the code to test CustomRoutingDestinationTrafficState
      //var instance = new AwsGlobalAccelerator.CustomRoutingDestinationTrafficState();
      //expect(instance).to.be.a(AwsGlobalAccelerator.CustomRoutingDestinationTrafficState);
    });
