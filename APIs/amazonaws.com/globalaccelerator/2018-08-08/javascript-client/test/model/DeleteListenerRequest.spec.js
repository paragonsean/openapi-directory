...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DeleteListenerRequest();
  });
  ...
  describe('DeleteListenerRequest', function() {
    it('should create an instance of DeleteListenerRequest', function() {
      // uncomment below and update the code to test DeleteListenerRequest
      //var instance = new AwsGlobalAccelerator.DeleteListenerRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DeleteListenerRequest);
    });
