...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.CreateListenerResponseListener();
  });
  ...
  describe('CreateListenerResponseListener', function() {
    it('should create an instance of CreateListenerResponseListener', function() {
      // uncomment below and update the code to test CreateListenerResponseListener
      //var instance = new AwsGlobalAccelerator.CreateListenerResponseListener();
      //expect(instance).to.be.a(AwsGlobalAccelerator.CreateListenerResponseListener);
    });
