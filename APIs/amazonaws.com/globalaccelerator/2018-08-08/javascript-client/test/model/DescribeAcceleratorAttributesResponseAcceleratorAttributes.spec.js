...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DescribeAcceleratorAttributesResponseAcceleratorAttributes();
  });
  ...
  describe('DescribeAcceleratorAttributesResponseAcceleratorAttributes', function() {
    it('should create an instance of DescribeAcceleratorAttributesResponseAcceleratorAttributes', function() {
      // uncomment below and update the code to test DescribeAcceleratorAttributesResponseAcceleratorAttributes
      //var instance = new AwsGlobalAccelerator.DescribeAcceleratorAttributesResponseAcceleratorAttributes();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DescribeAcceleratorAttributesResponseAcceleratorAttributes);
    });
