...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DeleteEndpointGroupRequest();
  });
  ...
  describe('DeleteEndpointGroupRequest', function() {
    it('should create an instance of DeleteEndpointGroupRequest', function() {
      // uncomment below and update the code to test DeleteEndpointGroupRequest
      //var instance = new AwsGlobalAccelerator.DeleteEndpointGroupRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DeleteEndpointGroupRequest);
    });
