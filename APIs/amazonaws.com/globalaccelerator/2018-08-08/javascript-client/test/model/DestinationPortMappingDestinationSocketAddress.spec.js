...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DestinationPortMappingDestinationSocketAddress();
  });
  ...
  describe('DestinationPortMappingDestinationSocketAddress', function() {
    it('should create an instance of DestinationPortMappingDestinationSocketAddress', function() {
      // uncomment below and update the code to test DestinationPortMappingDestinationSocketAddress
      //var instance = new AwsGlobalAccelerator.DestinationPortMappingDestinationSocketAddress();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DestinationPortMappingDestinationSocketAddress);
    });
