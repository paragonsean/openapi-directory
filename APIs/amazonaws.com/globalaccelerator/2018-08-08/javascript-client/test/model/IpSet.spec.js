...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.IpSet();
  });
  ...
  describe('IpSet', function() {
    it('should create an instance of IpSet', function() {
      ...
      //var instance = new AwsGlobalAccelerator.IpSet();
      //expect(instance).to.be.a(AwsGlobalAccelerator.IpSet);
    });
    ...
    it('should have the property ipAddressFamily (base name: "IpAddressFamily")', function() {
      // uncomment below and update the code to test the property ipAddressFamily
      //var instance = new AwsGlobalAccelerator.IpSet();
      //expect(instance).to.be();
    });
