...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.UpdateAcceleratorResponse();
  });
  ...
  describe('UpdateAcceleratorResponse', function() {
    it('should create an instance of UpdateAcceleratorResponse', function() {
      // uncomment below and update the code to test UpdateAcceleratorResponse
      //var instance = new AwsGlobalAccelerator.UpdateAcceleratorResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.UpdateAcceleratorResponse);
    });
