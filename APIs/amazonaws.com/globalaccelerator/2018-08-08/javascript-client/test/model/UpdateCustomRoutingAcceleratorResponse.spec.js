...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.UpdateCustomRoutingAcceleratorResponse();
  });
  ...
  describe('UpdateCustomRoutingAcceleratorResponse', function() {
    it('should create an instance of UpdateCustomRoutingAcceleratorResponse', function() {
      // uncomment below and update the code to test UpdateCustomRoutingAcceleratorResponse
      //var instance = new AwsGlobalAccelerator.UpdateCustomRoutingAcceleratorResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.UpdateCustomRoutingAcceleratorResponse);
    });
