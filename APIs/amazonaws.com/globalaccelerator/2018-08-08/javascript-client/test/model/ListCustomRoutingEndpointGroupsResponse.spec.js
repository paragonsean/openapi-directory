...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.ListCustomRoutingEndpointGroupsResponse();
  });
  ...
  describe('ListCustomRoutingEndpointGroupsResponse', function() {
    it('should create an instance of ListCustomRoutingEndpointGroupsResponse', function() {
      // uncomment below and update the code to test ListCustomRoutingEndpointGroupsResponse
      //var instance = new AwsGlobalAccelerator.ListCustomRoutingEndpointGroupsResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.ListCustomRoutingEndpointGroupsResponse);
    });

    it('should have the property endpointGroups (base name: "EndpointGroups")', function() {
      // uncomment below and update the code to test the property endpointGroups
      //var instance = new AwsGlobalAccelerator.ListCustomRoutingEndpointGroupsResponse();
