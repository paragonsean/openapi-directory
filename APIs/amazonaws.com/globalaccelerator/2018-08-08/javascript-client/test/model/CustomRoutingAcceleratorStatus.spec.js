...
(function(root, factory) {
  ...
  describe('CustomRoutingAcceleratorStatus', function() {
    it('should create an instance of CustomRoutingAcceleratorStatus', function() {
      // uncomment below and update the code to test CustomRoutingAcceleratorStatus
      //var instance = new AwsGlobalAccelerator.CustomRoutingAcceleratorStatus();
      //expect(instance).to.be.a(AwsGlobalAccelerator.CustomRoutingAcceleratorStatus);
    });
