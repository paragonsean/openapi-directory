...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DescribeCustomRoutingEndpointGroupRequest();
  });
  ...
  describe('DescribeCustomRoutingEndpointGroupRequest', function() {
    it('should create an instance of DescribeCustomRoutingEndpointGroupRequest', function() {
      // uncomment below and update the code to test DescribeCustomRoutingEndpointGroupRequest
      //var instance = new AwsGlobalAccelerator.DescribeCustomRoutingEndpointGroupRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DescribeCustomRoutingEndpointGroupRequest);
    });
