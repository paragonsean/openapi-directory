...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.ListAcceleratorsRequest();
  });
  ...
  describe('ListAcceleratorsRequest', function() {
    it('should create an instance of ListAcceleratorsRequest', function() {
      // uncomment below and update the code to test ListAcceleratorsRequest
      //var instance = new AwsGlobalAccelerator.ListAcceleratorsRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.ListAcceleratorsRequest);
    });
