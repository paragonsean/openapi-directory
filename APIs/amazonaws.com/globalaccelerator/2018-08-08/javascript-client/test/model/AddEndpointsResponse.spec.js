...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.AddEndpointsResponse();
  });
  ...
  describe('AddEndpointsResponse', function() {
    it('should create an instance of AddEndpointsResponse', function() {
      // uncomment below and update the code to test AddEndpointsResponse
      //var instance = new AwsGlobalAccelerator.AddEndpointsResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.AddEndpointsResponse);
    });
