...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DescribeCustomRoutingAcceleratorAttributesRequest();
  });
  ...
  describe('DescribeCustomRoutingAcceleratorAttributesRequest', function() {
    it('should create an instance of DescribeCustomRoutingAcceleratorAttributesRequest', function() {
      // uncomment below and update the code to test DescribeCustomRoutingAcceleratorAttributesRequest
      //var instance = new AwsGlobalAccelerator.DescribeCustomRoutingAcceleratorAttributesRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DescribeCustomRoutingAcceleratorAttributesRequest);
    });
