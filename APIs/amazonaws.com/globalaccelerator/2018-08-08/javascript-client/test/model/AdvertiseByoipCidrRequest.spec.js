...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.AdvertiseByoipCidrRequest();
  });
  ...
  describe('AdvertiseByoipCidrRequest', function() {
    it('should create an instance of AdvertiseByoipCidrRequest', function() {
      // uncomment below and update the code to test AdvertiseByoipCidrRequest
      //var instance = new AwsGlobalAccelerator.AdvertiseByoipCidrRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.AdvertiseByoipCidrRequest);
    });
