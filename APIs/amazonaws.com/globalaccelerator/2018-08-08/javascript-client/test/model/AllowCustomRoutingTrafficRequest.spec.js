...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.AllowCustomRoutingTrafficRequest();
  });
  ...
  describe('AllowCustomRoutingTrafficRequest', function() {
    it('should create an instance of AllowCustomRoutingTrafficRequest', function() {
      // uncomment below and update the code to test AllowCustomRoutingTrafficRequest
      //var instance = new AwsGlobalAccelerator.AllowCustomRoutingTrafficRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.AllowCustomRoutingTrafficRequest);
    });
    ...
    it('should have the property allowAllTrafficToEndpoint (base name: "AllowAllTrafficToEndpoint")', function() {
      // uncomment below and update the code to test the property allowAllTrafficToEndpoint
      //var instance = new AwsGlobalAccelerator.AllowCustomRoutingTrafficRequest();
      //expect(instance).to.be();
    });
