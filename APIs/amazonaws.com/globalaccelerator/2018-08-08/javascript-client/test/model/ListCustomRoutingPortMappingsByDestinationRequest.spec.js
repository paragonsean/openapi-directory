...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.ListCustomRoutingPortMappingsByDestinationRequest();
  });
  ...
  describe('ListCustomRoutingPortMappingsByDestinationRequest', function() {
    it('should create an instance of ListCustomRoutingPortMappingsByDestinationRequest', function() {
      // uncomment below and update the code to test ListCustomRoutingPortMappingsByDestinationRequest
      //var instance = new AwsGlobalAccelerator.ListCustomRoutingPortMappingsByDestinationRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.ListCustomRoutingPortMappingsByDestinationRequest);
    });
