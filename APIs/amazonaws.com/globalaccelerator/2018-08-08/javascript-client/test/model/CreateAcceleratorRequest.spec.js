...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.CreateAcceleratorRequest();
  });
  ...
  describe('CreateAcceleratorRequest', function() {
    it('should create an instance of CreateAcceleratorRequest', function() {
      // uncomment below and update the code to test CreateAcceleratorRequest
      //var instance = new AwsGlobalAccelerator.CreateAcceleratorRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.CreateAcceleratorRequest);
    });
