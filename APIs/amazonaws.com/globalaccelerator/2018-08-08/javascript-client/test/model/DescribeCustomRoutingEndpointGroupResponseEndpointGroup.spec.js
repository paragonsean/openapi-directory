...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DescribeCustomRoutingEndpointGroupResponseEndpointGroup();
  });
  ...
  describe('DescribeCustomRoutingEndpointGroupResponseEndpointGroup', function() {
    it('should create an instance of DescribeCustomRoutingEndpointGroupResponseEndpointGroup', function() {
      // uncomment below and update the code to test DescribeCustomRoutingEndpointGroupResponseEndpointGroup
      //var instance = new AwsGlobalAccelerator.DescribeCustomRoutingEndpointGroupResponseEndpointGroup();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DescribeCustomRoutingEndpointGroupResponseEndpointGroup);
    });
