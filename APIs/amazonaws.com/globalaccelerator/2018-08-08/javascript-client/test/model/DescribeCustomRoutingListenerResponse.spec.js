...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DescribeCustomRoutingListenerResponse();
  });
  ...
  describe('DescribeCustomRoutingListenerResponse', function() {
    it('should create an instance of DescribeCustomRoutingListenerResponse', function() {
      // uncomment below and update the code to test DescribeCustomRoutingListenerResponse
      //var instance = new AwsGlobalAccelerator.DescribeCustomRoutingListenerResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DescribeCustomRoutingListenerResponse);
    });
