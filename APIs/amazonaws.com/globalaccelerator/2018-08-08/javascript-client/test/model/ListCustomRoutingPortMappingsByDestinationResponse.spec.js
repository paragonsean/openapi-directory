...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.ListCustomRoutingPortMappingsByDestinationResponse();
  });
  ...
  describe('ListCustomRoutingPortMappingsByDestinationResponse', function() {
    it('should create an instance of ListCustomRoutingPortMappingsByDestinationResponse', function() {
      // uncomment below and update the code to test ListCustomRoutingPortMappingsByDestinationResponse
      //var instance = new AwsGlobalAccelerator.ListCustomRoutingPortMappingsByDestinationResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.ListCustomRoutingPortMappingsByDestinationResponse);
    });

    it('should have the property destinationPortMappings (base name: "DestinationPortMappings")', function() {
      // uncomment below and update the code to test the property destinationPortMappings
      //var instance = new AwsGlobalAccelerator.ListCustomRoutingPortMappingsByDestinationResponse();
