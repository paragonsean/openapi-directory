...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.PortMapping();
  });
  ...
  describe('PortMapping', function() {
    it('should create an instance of PortMapping', function() {
      ...
      //var instance = new AwsGlobalAccelerator.PortMapping();
      //expect(instance).to.be.a(AwsGlobalAccelerator.PortMapping);
    });

    it('should have the property acceleratorPort (base name: "AcceleratorPort")', function() {
      // uncomment below and update the code to test the property acceleratorPort
      //var instance = new AwsGlobalAccelerator.PortMapping();
