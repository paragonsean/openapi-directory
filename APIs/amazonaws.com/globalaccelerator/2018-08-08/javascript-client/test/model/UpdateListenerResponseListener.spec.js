...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.UpdateListenerResponseListener();
  });
  ...
  describe('UpdateListenerResponseListener', function() {
    it('should create an instance of UpdateListenerResponseListener', function() {
      // uncomment below and update the code to test UpdateListenerResponseListener
      //var instance = new AwsGlobalAccelerator.UpdateListenerResponseListener();
      //expect(instance).to.be.a(AwsGlobalAccelerator.UpdateListenerResponseListener);
    });
    ...
    it('should have the property clientAffinity (base name: "ClientAffinity")', function() {
      // uncomment below and update the code to test the property clientAffinity
      //var instance = new AwsGlobalAccelerator.UpdateListenerResponseListener();
      //expect(instance).to.be();
    });
