...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DescribeCustomRoutingAcceleratorAttributesResponse();
  });
  ...
  describe('DescribeCustomRoutingAcceleratorAttributesResponse', function() {
    it('should create an instance of DescribeCustomRoutingAcceleratorAttributesResponse', function() {
      // uncomment below and update the code to test DescribeCustomRoutingAcceleratorAttributesResponse
      //var instance = new AwsGlobalAccelerator.DescribeCustomRoutingAcceleratorAttributesResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DescribeCustomRoutingAcceleratorAttributesResponse);
    });

    it('should have the property acceleratorAttributes (base name: "AcceleratorAttributes")', function() {
      // uncomment below and update the code to test the property acceleratorAttributes
      //var instance = new AwsGlobalAccelerator.DescribeCustomRoutingAcceleratorAttributesResponse();
