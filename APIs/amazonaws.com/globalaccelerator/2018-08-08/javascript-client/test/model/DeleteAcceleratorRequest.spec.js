...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DeleteAcceleratorRequest();
  });
  ...
  describe('DeleteAcceleratorRequest', function() {
    it('should create an instance of DeleteAcceleratorRequest', function() {
      // uncomment below and update the code to test DeleteAcceleratorRequest
      //var instance = new AwsGlobalAccelerator.DeleteAcceleratorRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DeleteAcceleratorRequest);
    });
