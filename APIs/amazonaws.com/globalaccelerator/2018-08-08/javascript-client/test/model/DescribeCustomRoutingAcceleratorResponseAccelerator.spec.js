...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DescribeCustomRoutingAcceleratorResponseAccelerator();
  });
  ...
  describe('DescribeCustomRoutingAcceleratorResponseAccelerator', function() {
    it('should create an instance of DescribeCustomRoutingAcceleratorResponseAccelerator', function() {
      // uncomment below and update the code to test DescribeCustomRoutingAcceleratorResponseAccelerator
      //var instance = new AwsGlobalAccelerator.DescribeCustomRoutingAcceleratorResponseAccelerator();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DescribeCustomRoutingAcceleratorResponseAccelerator);
    });
