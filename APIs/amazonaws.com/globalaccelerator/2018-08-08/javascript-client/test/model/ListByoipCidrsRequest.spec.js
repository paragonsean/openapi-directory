...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.ListByoipCidrsRequest();
  });
  ...
  describe('ListByoipCidrsRequest', function() {
    it('should create an instance of ListByoipCidrsRequest', function() {
      // uncomment below and update the code to test ListByoipCidrsRequest
      //var instance = new AwsGlobalAccelerator.ListByoipCidrsRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.ListByoipCidrsRequest);
    });
