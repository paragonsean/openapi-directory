...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.ByoipCidrEvent();
  });
  ...
  describe('ByoipCidrEvent', function() {
    it('should create an instance of ByoipCidrEvent', function() {
      // uncomment below and update the code to test ByoipCidrEvent
      //var instance = new AwsGlobalAccelerator.ByoipCidrEvent();
      //expect(instance).to.be.a(AwsGlobalAccelerator.ByoipCidrEvent);
    });
