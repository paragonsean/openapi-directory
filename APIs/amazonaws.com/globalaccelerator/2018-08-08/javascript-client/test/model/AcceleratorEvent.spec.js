...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.AcceleratorEvent();
  });
  ...
  describe('AcceleratorEvent', function() {
    it('should create an instance of AcceleratorEvent', function() {
      // uncomment below and update the code to test AcceleratorEvent
      //var instance = new AwsGlobalAccelerator.AcceleratorEvent();
      //expect(instance).to.be.a(AwsGlobalAccelerator.AcceleratorEvent);
    });
