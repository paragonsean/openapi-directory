...
(function(root, factory) {
  ...
  describe('IpAddressFamily', function() {
    it('should create an instance of IpAddressFamily', function() {
      // uncomment below and update the code to test IpAddressFamily
      //var instance = new AwsGlobalAccelerator.IpAddressFamily();
      //expect(instance).to.be.a(AwsGlobalAccelerator.IpAddressFamily);
    });
