...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.UpdateAcceleratorAttributesResponse();
  });
  ...
  describe('UpdateAcceleratorAttributesResponse', function() {
    it('should create an instance of UpdateAcceleratorAttributesResponse', function() {
      // uncomment below and update the code to test UpdateAcceleratorAttributesResponse
      //var instance = new AwsGlobalAccelerator.UpdateAcceleratorAttributesResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.UpdateAcceleratorAttributesResponse);
    });
