...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DescribeCustomRoutingAcceleratorAttributesResponseAcceleratorAttributes();
  });
  ...
  describe('DescribeCustomRoutingAcceleratorAttributesResponseAcceleratorAttributes', function() {
    it('should create an instance of DescribeCustomRoutingAcceleratorAttributesResponseAcceleratorAttributes', function() {
      // uncomment below and update the code to test DescribeCustomRoutingAcceleratorAttributesResponseAcceleratorAttributes
      //var instance = new AwsGlobalAccelerator.DescribeCustomRoutingAcceleratorAttributesResponseAcceleratorAttributes();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DescribeCustomRoutingAcceleratorAttributesResponseAcceleratorAttributes);
    });
