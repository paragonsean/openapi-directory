...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DeleteCustomRoutingEndpointGroupRequest();
  });
  ...
  describe('DeleteCustomRoutingEndpointGroupRequest', function() {
    it('should create an instance of DeleteCustomRoutingEndpointGroupRequest', function() {
      // uncomment below and update the code to test DeleteCustomRoutingEndpointGroupRequest
      //var instance = new AwsGlobalAccelerator.DeleteCustomRoutingEndpointGroupRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DeleteCustomRoutingEndpointGroupRequest);
    });
