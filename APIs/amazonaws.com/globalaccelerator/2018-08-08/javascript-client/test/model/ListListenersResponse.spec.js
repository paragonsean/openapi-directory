...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.ListListenersResponse();
  });
  ...
  describe('ListListenersResponse', function() {
    it('should create an instance of ListListenersResponse', function() {
      ...
      //var instance = new AwsGlobalAccelerator.ListListenersResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.ListListenersResponse);
    });
