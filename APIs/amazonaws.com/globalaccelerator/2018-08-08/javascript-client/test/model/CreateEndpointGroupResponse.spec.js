...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.CreateEndpointGroupResponse();
  });
  ...
  describe('CreateEndpointGroupResponse', function() {
    it('should create an instance of CreateEndpointGroupResponse', function() {
      // uncomment below and update the code to test CreateEndpointGroupResponse
      //var instance = new AwsGlobalAccelerator.CreateEndpointGroupResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.CreateEndpointGroupResponse);
    });
