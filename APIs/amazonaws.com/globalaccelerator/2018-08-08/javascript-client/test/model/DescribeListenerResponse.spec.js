...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DescribeListenerResponse();
  });
  ...
  describe('DescribeListenerResponse', function() {
    it('should create an instance of DescribeListenerResponse', function() {
      // uncomment below and update the code to test DescribeListenerResponse
      //var instance = new AwsGlobalAccelerator.DescribeListenerResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DescribeListenerResponse);
    });
