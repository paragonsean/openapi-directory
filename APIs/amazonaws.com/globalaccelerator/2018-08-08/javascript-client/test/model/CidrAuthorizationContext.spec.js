...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.CidrAuthorizationContext();
  });
  ...
  describe('CidrAuthorizationContext', function() {
    it('should create an instance of CidrAuthorizationContext', function() {
      // uncomment below and update the code to test CidrAuthorizationContext
      //var instance = new AwsGlobalAccelerator.CidrAuthorizationContext();
      //expect(instance).to.be.a(AwsGlobalAccelerator.CidrAuthorizationContext);
    });
