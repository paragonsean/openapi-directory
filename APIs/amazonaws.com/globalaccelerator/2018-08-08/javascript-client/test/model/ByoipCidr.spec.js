...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.ByoipCidr();
  });
  ...
  describe('ByoipCidr', function() {
    it('should create an instance of ByoipCidr', function() {
      // uncomment below and update the code to test ByoipCidr
      //var instance = new AwsGlobalAccelerator.ByoipCidr();
      //expect(instance).to.be.a(AwsGlobalAccelerator.ByoipCidr);
    });
