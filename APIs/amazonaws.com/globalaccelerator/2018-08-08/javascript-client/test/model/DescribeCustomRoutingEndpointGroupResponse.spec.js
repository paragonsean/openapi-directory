...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DescribeCustomRoutingEndpointGroupResponse();
  });
  ...
  describe('DescribeCustomRoutingEndpointGroupResponse', function() {
    it('should create an instance of DescribeCustomRoutingEndpointGroupResponse', function() {
      // uncomment below and update the code to test DescribeCustomRoutingEndpointGroupResponse
      //var instance = new AwsGlobalAccelerator.DescribeCustomRoutingEndpointGroupResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DescribeCustomRoutingEndpointGroupResponse);
    });

    it('should have the property endpointGroup (base name: "EndpointGroup")', function() {
      // uncomment below and update the code to test the property endpointGroup
      //var instance = new AwsGlobalAccelerator.DescribeCustomRoutingEndpointGroupResponse();
