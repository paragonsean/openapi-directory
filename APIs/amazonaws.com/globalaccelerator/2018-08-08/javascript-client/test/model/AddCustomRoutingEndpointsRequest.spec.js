...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.AddCustomRoutingEndpointsRequest();
  });
  ...
  describe('AddCustomRoutingEndpointsRequest', function() {
    it('should create an instance of AddCustomRoutingEndpointsRequest', function() {
      // uncomment below and update the code to test AddCustomRoutingEndpointsRequest
      //var instance = new AwsGlobalAccelerator.AddCustomRoutingEndpointsRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.AddCustomRoutingEndpointsRequest);
    });
