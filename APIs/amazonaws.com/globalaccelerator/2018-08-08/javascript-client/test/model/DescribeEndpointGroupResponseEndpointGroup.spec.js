...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DescribeEndpointGroupResponseEndpointGroup();
  });
  ...
  describe('DescribeEndpointGroupResponseEndpointGroup', function() {
    it('should create an instance of DescribeEndpointGroupResponseEndpointGroup', function() {
      // uncomment below and update the code to test DescribeEndpointGroupResponseEndpointGroup
      //var instance = new AwsGlobalAccelerator.DescribeEndpointGroupResponseEndpointGroup();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DescribeEndpointGroupResponseEndpointGroup);
    });
