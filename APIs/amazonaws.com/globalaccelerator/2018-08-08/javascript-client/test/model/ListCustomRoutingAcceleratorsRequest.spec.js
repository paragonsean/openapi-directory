...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.ListCustomRoutingAcceleratorsRequest();
  });
  ...
  describe('ListCustomRoutingAcceleratorsRequest', function() {
    it('should create an instance of ListCustomRoutingAcceleratorsRequest', function() {
      // uncomment below and update the code to test ListCustomRoutingAcceleratorsRequest
      //var instance = new AwsGlobalAccelerator.ListCustomRoutingAcceleratorsRequest();
      //expect(instance).to.be.a(AwsGlobalAccelerator.ListCustomRoutingAcceleratorsRequest);
    });
