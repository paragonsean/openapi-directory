...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DescribeCustomRoutingAcceleratorResponse();
  });
  ...
  describe('DescribeCustomRoutingAcceleratorResponse', function() {
    it('should create an instance of DescribeCustomRoutingAcceleratorResponse', function() {
      // uncomment below and update the code to test DescribeCustomRoutingAcceleratorResponse
      //var instance = new AwsGlobalAccelerator.DescribeCustomRoutingAcceleratorResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DescribeCustomRoutingAcceleratorResponse);
    });
