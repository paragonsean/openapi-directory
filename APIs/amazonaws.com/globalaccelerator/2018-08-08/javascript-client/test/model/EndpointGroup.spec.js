...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.EndpointGroup();
  });
  ...
  describe('EndpointGroup', function() {
    it('should create an instance of EndpointGroup', function() {
      // uncomment below and update the code to test EndpointGroup
      //var instance = new AwsGlobalAccelerator.EndpointGroup();
      //expect(instance).to.be.a(AwsGlobalAccelerator.EndpointGroup);
    });
