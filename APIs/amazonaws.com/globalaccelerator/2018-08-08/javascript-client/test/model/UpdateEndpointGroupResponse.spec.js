...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.UpdateEndpointGroupResponse();
  });
  ...
  describe('UpdateEndpointGroupResponse', function() {
    it('should create an instance of UpdateEndpointGroupResponse', function() {
      // uncomment below and update the code to test UpdateEndpointGroupResponse
      //var instance = new AwsGlobalAccelerator.UpdateEndpointGroupResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.UpdateEndpointGroupResponse);
    });
