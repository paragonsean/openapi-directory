...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsGlobalAccelerator.DeprovisionByoipCidrResponse();
  });
  ...
  describe('DeprovisionByoipCidrResponse', function() {
    it('should create an instance of DeprovisionByoipCidrResponse', function() {
      // uncomment below and update the code to test DeprovisionByoipCidrResponse
      //var instance = new AwsGlobalAccelerator.DeprovisionByoipCidrResponse();
      //expect(instance).to.be.a(AwsGlobalAccelerator.DeprovisionByoipCidrResponse);
    });
