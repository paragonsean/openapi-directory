...
/**
 * The WithdrawByoipCidrResponseByoipCidr model module.
 * @module model/WithdrawByoipCidrResponseByoipCidr
 * @version 2018-08-08
 */
class WithdrawByoipCidrResponseByoipCidr {
    /**
     * Constructs a new <code>WithdrawByoipCidrResponseByoipCidr</code>.
     * @alias module:model/WithdrawByoipCidrResponseByoipCidr
     * @implements module:model/ByoipCidr
     */
    constructor() { 
        ByoipCidr.initialize(this);
        WithdrawByoipCidrResponseByoipCidr.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WithdrawByoipCidrResponseByoipCidr</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WithdrawByoipCidrResponseByoipCidr} obj Optional instance to populate.
     * @return {module:model/WithdrawByoipCidrResponseByoipCidr} The populated <code>WithdrawByoipCidrResponseByoipCidr</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WithdrawByoipCidrResponseByoipCidr();
    ...
    /**
     * Validates the JSON data with respect to <code>WithdrawByoipCidrResponseByoipCidr</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WithdrawByoipCidrResponseByoipCidr</code>.
     */
 ...
 * @member {String} Cidr
 */
WithdrawByoipCidrResponseByoipCidr.prototype['Cidr'] = undefined;

/**
 * @member {module:model/ByoipCidrState} State
 */
WithdrawByoipCidrResponseByoipCidr.prototype['State'] = undefined;

/**
 * @member {Array} Events
 */
WithdrawByoipCidrResponseByoipCidr.prototype['Events'] = undefined;
...
export default WithdrawByoipCidrResponseByoipCidr;
