...
import DescribeListenerResponseListener from './DescribeListenerResponseListener';

/**
 * The DescribeListenerResponse model module.
 * @module model/DescribeListenerResponse
 * @version 2018-08-08
 */
class DescribeListenerResponse {
    /**
     * Constructs a new <code>DescribeListenerResponse</code>.
     * @alias module:model/DescribeListenerResponse
     */
    constructor() { 
        
        DescribeListenerResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeListenerResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeListenerResponse} obj Optional instance to populate.
     * @return {module:model/DescribeListenerResponse} The populated <code>DescribeListenerResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeListenerResponse();

            if (data.hasOwnProperty('Listener')) {
                obj['Listener'] = DescribeListenerResponseListener.constructFromObject(data['Listener']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeListenerResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeListenerResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Listener`
        if (data['Listener']) { // data not null
          DescribeListenerResponseListener.validateJSON(data['Listener']);
        }
...
/**
 * @member {module:model/DescribeListenerResponseListener} Listener
 */
DescribeListenerResponse.prototype['Listener'] = undefined;
...
export default DescribeListenerResponse;
