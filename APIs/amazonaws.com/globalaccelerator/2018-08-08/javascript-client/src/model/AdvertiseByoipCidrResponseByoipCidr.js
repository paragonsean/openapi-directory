...
/**
 * The AdvertiseByoipCidrResponseByoipCidr model module.
 * @module model/AdvertiseByoipCidrResponseByoipCidr
 * @version 2018-08-08
 */
class AdvertiseByoipCidrResponseByoipCidr {
    /**
     * Constructs a new <code>AdvertiseByoipCidrResponseByoipCidr</code>.
     * @alias module:model/AdvertiseByoipCidrResponseByoipCidr
     * @implements module:model/ByoipCidr
     */
    constructor() { 
        ByoipCidr.initialize(this);
        AdvertiseByoipCidrResponseByoipCidr.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AdvertiseByoipCidrResponseByoipCidr</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdvertiseByoipCidrResponseByoipCidr} obj Optional instance to populate.
     * @return {module:model/AdvertiseByoipCidrResponseByoipCidr} The populated <code>AdvertiseByoipCidrResponseByoipCidr</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdvertiseByoipCidrResponseByoipCidr();
            ByoipCidr.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>AdvertiseByoipCidrResponseByoipCidr</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdvertiseByoipCidrResponseByoipCidr</code>.
     */
 ...
 * @member {String} Cidr
 */
AdvertiseByoipCidrResponseByoipCidr.prototype['Cidr'] = undefined;

/**
 * @member {module:model/ByoipCidrState} State
 */
AdvertiseByoipCidrResponseByoipCidr.prototype['State'] = undefined;

/**
 * @member {Array} Events
 */
AdvertiseByoipCidrResponseByoipCidr.prototype['Events'] = undefined;


// Implement ByoipCidr interface:
/**
 * @member {String} Cidr
 */
...
export default AdvertiseByoipCidrResponseByoipCidr;
