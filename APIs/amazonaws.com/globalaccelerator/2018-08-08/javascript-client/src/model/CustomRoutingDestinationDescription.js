...
/**
 * The CustomRoutingDestinationDescription model module.
 * @module model/CustomRoutingDestinationDescription
 * @version 2018-08-08
 */
class CustomRoutingDestinationDescription {
    /**
     * Constructs a new <code>CustomRoutingDestinationDescription</code>.
     * For a custom routing accelerator, describes the port range and protocol for all endpoints (virtual private cloud subnets) in an endpoint group to accept client traffic on.
     * @alias module:model/CustomRoutingDestinationDescription
     */
    constructor() { 
        
        CustomRoutingDestinationDescription.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CustomRoutingDestinationDescription</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CustomRoutingDestinationDescription} obj Optional instance to populate.
     * @return {module:model/CustomRoutingDestinationDescription} The populated <code>CustomRoutingDestinationDescription</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomRoutingDestinationDescription();
    ...
    /**
     * Validates the JSON data with respect to <code>CustomRoutingDestinationDescription</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomRoutingDestinationDescription</code>.
     */
 ...
 */
CustomRoutingDestinationDescription.prototype['FromPort'] = undefined;

/**
 * @member {Number} ToPort
 */
CustomRoutingDestinationDescription.prototype['ToPort'] = undefined;

/**
 * @member {Array} Protocols
 */
CustomRoutingDestinationDescription.prototype['Protocols'] = undefined;
...
export default CustomRoutingDestinationDescription;
