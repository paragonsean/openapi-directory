...
/**
 * The DeprovisionByoipCidrResponse model module.
 * @module model/DeprovisionByoipCidrResponse
 * @version 2018-08-08
 */
class DeprovisionByoipCidrResponse {
    /**
     * Constructs a new <code>DeprovisionByoipCidrResponse</code>.
     * @alias module:model/DeprovisionByoipCidrResponse
     */
    constructor() { 
        
        DeprovisionByoipCidrResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeprovisionByoipCidrResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeprovisionByoipCidrResponse} obj Optional instance to populate.
     * @return {module:model/DeprovisionByoipCidrResponse} The populated <code>DeprovisionByoipCidrResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeprovisionByoipCidrResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DeprovisionByoipCidrResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeprovisionByoipCidrResponse</code>.
     */
 ...
 */
DeprovisionByoipCidrResponse.prototype['ByoipCidr'] = undefined;
...
export default DeprovisionByoipCidrResponse;
