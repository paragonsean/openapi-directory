...
/**
 * The CustomRoutingEndpointConfiguration model module.
 * @module model/CustomRoutingEndpointConfiguration
 * @version 2018-08-08
 */
class CustomRoutingEndpointConfiguration {
    /**
     * Constructs a new <code>CustomRoutingEndpointConfiguration</code>.
     * The list of endpoint objects. For custom routing, this is a list of virtual private cloud (VPC) subnet IDs.
     * @alias module:model/CustomRoutingEndpointConfiguration
     */
    constructor() { 
        
        CustomRoutingEndpointConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CustomRoutingEndpointConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CustomRoutingEndpointConfiguration} obj Optional instance to populate.
     * @return {module:model/CustomRoutingEndpointConfiguration} The populated <code>CustomRoutingEndpointConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomRoutingEndpointConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>CustomRoutingEndpointConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomRoutingEndpointConfiguration</code>.
     */
 ...
 */
CustomRoutingEndpointConfiguration.prototype['EndpointId'] = undefined;
...
export default CustomRoutingEndpointConfiguration;
