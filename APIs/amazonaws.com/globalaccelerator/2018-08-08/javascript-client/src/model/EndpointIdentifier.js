...
/**
 * The EndpointIdentifier model module.
 * @module model/EndpointIdentifier
 * @version 2018-08-08
 */
class EndpointIdentifier {
    /**
     * Constructs a new <code>EndpointIdentifier</code>.
     * A complex type for an endpoint. Specifies information about the endpoint to remove from the endpoint group.
     * @alias module:model/EndpointIdentifier
     * @param endpointId {String} 
     */
    constructor(endpointId) { 
        
        EndpointIdentifier.initialize(this, endpointId);
    }
    ...
    /**
     * Constructs a <code>EndpointIdentifier</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EndpointIdentifier} obj Optional instance to populate.
     * @return {module:model/EndpointIdentifier} The populated <code>EndpointIdentifier</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EndpointIdentifier();
    ...
    /**
     * Validates the JSON data with respect to <code>EndpointIdentifier</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EndpointIdentifier</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EndpointIdentifier.RequiredProperties) {
...
EndpointIdentifier.RequiredProperties = ["EndpointId"];

/**
 * @member {String} EndpointId
 */
EndpointIdentifier.prototype['EndpointId'] = undefined;

/**
 * @member {Boolean} ClientIPPreservationEnabled
 */
EndpointIdentifier.prototype['ClientIPPreservationEnabled'] = undefined;
...
export default EndpointIdentifier;
