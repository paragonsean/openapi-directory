...
/**
 * The CustomRoutingListener model module.
 * @module model/CustomRoutingListener
 * @version 2018-08-08
 */
class CustomRoutingListener {
    /**
     * Constructs a new <code>CustomRoutingListener</code>.
     * A complex type for a listener for a custom routing accelerator.
     * @alias module:model/CustomRoutingListener
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>CustomRoutingListener</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CustomRoutingListener} obj Optional instance to populate.
     * @return {module:model/CustomRoutingListener} The populated <code>CustomRoutingListener</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomRoutingListener();
    ...
    /**
     * Validates the JSON data with respect to <code>CustomRoutingListener</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomRoutingListener</code>.
     */
...
export default CustomRoutingListener;
