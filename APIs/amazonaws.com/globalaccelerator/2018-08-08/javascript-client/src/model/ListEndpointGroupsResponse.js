...
/**
 * The ListEndpointGroupsResponse model module.
 * @module model/ListEndpointGroupsResponse
 * @version 2018-08-08
 */
class ListEndpointGroupsResponse {
    /**
     * Constructs a new <code>ListEndpointGroupsResponse</code>.
     * @alias module:model/ListEndpointGroupsResponse
     */
    constructor() { 
        
        ListEndpointGroupsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListEndpointGroupsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListEndpointGroupsResponse} obj Optional instance to populate.
     * @return {module:model/ListEndpointGroupsResponse} The populated <code>ListEndpointGroupsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListEndpointGroupsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListEndpointGroupsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListEndpointGroupsResponse</code>.
     */
 ...
 */
ListEndpointGroupsResponse.prototype['EndpointGroups'] = undefined;

/**
 * @member {String} NextToken
 */
ListEndpointGroupsResponse.prototype['NextToken'] = undefined;
...
export default ListEndpointGroupsResponse;
