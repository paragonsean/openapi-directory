...
import CreateCustomRoutingListenerResponseListener from './CreateCustomRoutingListenerResponseListener';

/**
 * The CreateCustomRoutingListenerResponse model module.
 * @module model/CreateCustomRoutingListenerResponse
 * @version 2018-08-08
 */
class CreateCustomRoutingListenerResponse {
    /**
     * Constructs a new <code>CreateCustomRoutingListenerResponse</code>.
     * @alias module:model/CreateCustomRoutingListenerResponse
     */
    constructor() { 
        
        CreateCustomRoutingListenerResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateCustomRoutingListenerResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateCustomRoutingListenerResponse} obj Optional instance to populate.
     * @return {module:model/CreateCustomRoutingListenerResponse} The populated <code>CreateCustomRoutingListenerResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateCustomRoutingListenerResponse();

            if (data.hasOwnProperty('Listener')) {
                obj['Listener'] = CreateCustomRoutingListenerResponseListener.constructFromObject(data['Listener']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCustomRoutingListenerResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCustomRoutingListenerResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Listener`
        if (data['Listener']) { // data not null
          CreateCustomRoutingListenerResponseListener.validateJSON(data['Listener']);
        }
...
/**
 * @member {module:model/CreateCustomRoutingListenerResponseListener} Listener
 */
CreateCustomRoutingListenerResponse.prototype['Listener'] = undefined;
...
export default CreateCustomRoutingListenerResponse;
