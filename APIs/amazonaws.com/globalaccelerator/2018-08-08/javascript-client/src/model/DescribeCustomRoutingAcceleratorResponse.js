...
import DescribeCustomRoutingAcceleratorResponseAccelerator from './DescribeCustomRoutingAcceleratorResponseAccelerator';

/**
 * The DescribeCustomRoutingAcceleratorResponse model module.
 * @module model/DescribeCustomRoutingAcceleratorResponse
 * @version 2018-08-08
 */
class DescribeCustomRoutingAcceleratorResponse {
    /**
     * Constructs a new <code>DescribeCustomRoutingAcceleratorResponse</code>.
     * @alias module:model/DescribeCustomRoutingAcceleratorResponse
     */
    constructor() { 
        
        DescribeCustomRoutingAcceleratorResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeCustomRoutingAcceleratorResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeCustomRoutingAcceleratorResponse} obj Optional instance to populate.
     * @return {module:model/DescribeCustomRoutingAcceleratorResponse} The populated <code>DescribeCustomRoutingAcceleratorResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeCustomRoutingAcceleratorResponse();

            if (data.hasOwnProperty('Accelerator')) {
                obj['Accelerator'] = DescribeCustomRoutingAcceleratorResponseAccelerator.constructFromObject(data['Accelerator']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeCustomRoutingAcceleratorResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeCustomRoutingAcceleratorResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Accelerator`
        if (data['Accelerator']) { // data not null
          DescribeCustomRoutingAcceleratorResponseAccelerator.validateJSON(data['Accelerator']);
        }
...
/**
 * @member {module:model/DescribeCustomRoutingAcceleratorResponseAccelerator} Accelerator
 */
DescribeCustomRoutingAcceleratorResponse.prototype['Accelerator'] = undefined;
...
export default DescribeCustomRoutingAcceleratorResponse;
