...
/**
 * The PortMappingDestinationSocketAddress model module.
 * @module model/PortMappingDestinationSocketAddress
 * @version 2018-08-08
 */
class PortMappingDestinationSocketAddress {
    /**
     * Constructs a new <code>PortMappingDestinationSocketAddress</code>.
     * @alias module:model/PortMappingDestinationSocketAddress
     * @implements module:model/SocketAddress
     */
    constructor() { 
        SocketAddress.initialize(this);
        PortMappingDestinationSocketAddress.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PortMappingDestinationSocketAddress</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PortMappingDestinationSocketAddress} obj Optional instance to populate.
     * @return {module:model/PortMappingDestinationSocketAddress} The populated <code>PortMappingDestinationSocketAddress</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PortMappingDestinationSocketAddress();
    ...
    /**
     * Validates the JSON data with respect to <code>PortMappingDestinationSocketAddress</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PortMappingDestinationSocketAddress</code>.
     */
 ...
 */
PortMappingDestinationSocketAddress.prototype['IpAddress'] = undefined;

/**
 * @member {Number} Port
 */
PortMappingDestinationSocketAddress.prototype['Port'] = undefined;
...
export default PortMappingDestinationSocketAddress;
