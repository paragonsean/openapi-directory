...
/**
 * The ByoipCidrEvent model module.
 * @module model/ByoipCidrEvent
 * @version 2018-08-08
 */
class ByoipCidrEvent {
    /**
     * Constructs a new <code>ByoipCidrEvent</code>.
     ...
     * @alias module:model/ByoipCidrEvent
     */
    constructor() { 
        
        ByoipCidrEvent.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ByoipCidrEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ByoipCidrEvent} obj Optional instance to populate.
     * @return {module:model/ByoipCidrEvent} The populated <code>ByoipCidrEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ByoipCidrEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>ByoipCidrEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ByoipCidrEvent</code>.
     */
 ...
 */
ByoipCidrEvent.prototype['Message'] = undefined;

/**
 * @member {Date} Timestamp
 */
ByoipCidrEvent.prototype['Timestamp'] = undefined;
