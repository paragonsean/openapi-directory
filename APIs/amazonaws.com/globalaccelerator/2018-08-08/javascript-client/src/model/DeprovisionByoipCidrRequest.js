...
/**
 * The DeprovisionByoipCidrRequest model module.
 * @module model/DeprovisionByoipCidrRequest
 * @version 2018-08-08
 */
class DeprovisionByoipCidrRequest {
    /**
     * Constructs a new <code>DeprovisionByoipCidrRequest</code>.
     * @alias module:model/DeprovisionByoipCidrRequest
     * @param cidr {String} 
     */
    constructor(cidr) { 
        
        DeprovisionByoipCidrRequest.initialize(this, cidr);
    }
    ...
    /**
     * Constructs a <code>DeprovisionByoipCidrRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeprovisionByoipCidrRequest} obj Optional instance to populate.
     * @return {module:model/DeprovisionByoipCidrRequest} The populated <code>DeprovisionByoipCidrRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeprovisionByoipCidrRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeprovisionByoipCidrRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeprovisionByoipCidrRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeprovisionByoipCidrRequest.RequiredProperties) {
...
DeprovisionByoipCidrRequest.RequiredProperties = ["Cidr"];

/**
 * @member {String} Cidr
 */
DeprovisionByoipCidrRequest.prototype['Cidr'] = undefined;
...
export default DeprovisionByoipCidrRequest;
