...
import WithdrawByoipCidrResponseByoipCidr from './WithdrawByoipCidrResponseByoipCidr';

/**
 * The WithdrawByoipCidrResponse model module.
 * @module model/WithdrawByoipCidrResponse
 * @version 2018-08-08
 */
class WithdrawByoipCidrResponse {
    /**
     * Constructs a new <code>WithdrawByoipCidrResponse</code>.
     * @alias module:model/WithdrawByoipCidrResponse
     */
    constructor() { 
        
        WithdrawByoipCidrResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WithdrawByoipCidrResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WithdrawByoipCidrResponse} obj Optional instance to populate.
     * @return {module:model/WithdrawByoipCidrResponse} The populated <code>WithdrawByoipCidrResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WithdrawByoipCidrResponse();

            if (data.hasOwnProperty('ByoipCidr')) {
                obj['ByoipCidr'] = WithdrawByoipCidrResponseByoipCidr.constructFromObject(data['ByoipCidr']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>WithdrawByoipCidrResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WithdrawByoipCidrResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `ByoipCidr`
        if (data['ByoipCidr']) { // data not null
          WithdrawByoipCidrResponseByoipCidr.validateJSON(data['ByoipCidr']);
        }
...
/**
 * @member {module:model/WithdrawByoipCidrResponseByoipCidr} ByoipCidr
 */
WithdrawByoipCidrResponse.prototype['ByoipCidr'] = undefined;
...
export default WithdrawByoipCidrResponse;
