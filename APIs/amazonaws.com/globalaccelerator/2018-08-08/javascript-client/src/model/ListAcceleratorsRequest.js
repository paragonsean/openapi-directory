...
/**
 * The ListAcceleratorsRequest model module.
 * @module model/ListAcceleratorsRequest
 * @version 2018-08-08
 */
class ListAcceleratorsRequest {
    /**
     * Constructs a new <code>ListAcceleratorsRequest</code>.
     * @alias module:model/ListAcceleratorsRequest
     */
    constructor() { 
        
        ListAcceleratorsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListAcceleratorsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAcceleratorsRequest} obj Optional instance to populate.
     * @return {module:model/ListAcceleratorsRequest} The populated <code>ListAcceleratorsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListAcceleratorsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListAcceleratorsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListAcceleratorsRequest</code>.
     */
 ...
 */
ListAcceleratorsRequest.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
ListAcceleratorsRequest.prototype['NextToken'] = undefined;
...
export default ListAcceleratorsRequest;
