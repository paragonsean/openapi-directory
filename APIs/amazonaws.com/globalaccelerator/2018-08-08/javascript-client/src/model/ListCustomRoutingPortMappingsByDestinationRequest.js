...
/**
 * The ListCustomRoutingPortMappingsByDestinationRequest model module.
 * @module model/ListCustomRoutingPortMappingsByDestinationRequest
 * @version 2018-08-08
 */
class ListCustomRoutingPortMappingsByDestinationRequest {
    /**
     * Constructs a new <code>ListCustomRoutingPortMappingsByDestinationRequest</code>.
     * @alias module:model/ListCustomRoutingPortMappingsByDestinationRequest
     * @param endpointId {String} 
     * @param destinationAddress {String} 
     */
    constructor(endpointId, destinationAddress) { 
        
        ListCustomRoutingPortMappingsByDestinationRequest.initialize(this, endpointId, destinationAddress);
    }
     ...
     */
    static initialize(obj, endpointId, destinationAddress) { 
        obj['EndpointId'] = endpointId;
        obj['DestinationAddress'] = destinationAddress;
    }

    /**
     * Constructs a <code>ListCustomRoutingPortMappingsByDestinationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListCustomRoutingPortMappingsByDestinationRequest} obj Optional instance to populate.
     * @return {module:model/ListCustomRoutingPortMappingsByDestinationRequest} The populated <code>ListCustomRoutingPortMappingsByDestinationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListCustomRoutingPortMappingsByDestinationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListCustomRoutingPortMappingsByDestinationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListCustomRoutingPortMappingsByDestinationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListCustomRoutingPortMappingsByDestinationRequest.RequiredProperties) {
        ...
        if (data['DestinationAddress']) { // data not null
          String.validateJSON(data['DestinationAddress']);
        }
...
ListCustomRoutingPortMappingsByDestinationRequest.RequiredProperties = ["EndpointId", "DestinationAddress"];

/**
 * @member {String} EndpointId
 */
ListCustomRoutingPortMappingsByDestinationRequest.prototype['EndpointId'] = undefined;

/**
 * @member {String} DestinationAddress
 */
ListCustomRoutingPortMappingsByDestinationRequest.prototype['DestinationAddress'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListCustomRoutingPortMappingsByDestinationRequest.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
ListCustomRoutingPortMappingsByDestinationRequest.prototype['NextToken'] = undefined;
...
export default ListCustomRoutingPortMappingsByDestinationRequest;
