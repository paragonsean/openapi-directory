...
import CreateCustomRoutingAcceleratorResponseAccelerator from './CreateCustomRoutingAcceleratorResponseAccelerator';

/**
 * The CreateCustomRoutingAcceleratorResponse model module.
 * @module model/CreateCustomRoutingAcceleratorResponse
 * @version 2018-08-08
 */
class CreateCustomRoutingAcceleratorResponse {
    /**
     * Constructs a new <code>CreateCustomRoutingAcceleratorResponse</code>.
     * @alias module:model/CreateCustomRoutingAcceleratorResponse
     */
    constructor() { 
        
        CreateCustomRoutingAcceleratorResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateCustomRoutingAcceleratorResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateCustomRoutingAcceleratorResponse} obj Optional instance to populate.
     * @return {module:model/CreateCustomRoutingAcceleratorResponse} The populated <code>CreateCustomRoutingAcceleratorResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateCustomRoutingAcceleratorResponse();

            if (data.hasOwnProperty('Accelerator')) {
                obj['Accelerator'] = CreateCustomRoutingAcceleratorResponseAccelerator.constructFromObject(data['Accelerator']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCustomRoutingAcceleratorResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCustomRoutingAcceleratorResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Accelerator`
        if (data['Accelerator']) { // data not null
          CreateCustomRoutingAcceleratorResponseAccelerator.validateJSON(data['Accelerator']);
        }
...
/**
 * @member {module:model/CreateCustomRoutingAcceleratorResponseAccelerator} Accelerator
 */
CreateCustomRoutingAcceleratorResponse.prototype['Accelerator'] = undefined;
...
export default CreateCustomRoutingAcceleratorResponse;
