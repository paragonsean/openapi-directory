...
/**
 * The CreateAcceleratorRequest model module.
 * @module model/CreateAcceleratorRequest
 * @version 2018-08-08
 */
class CreateAcceleratorRequest {
    /**
     * Constructs a new <code>CreateAcceleratorRequest</code>.
     * @alias module:model/CreateAcceleratorRequest
     * @param name {String} 
     * @param idempotencyToken {String} 
     */
    constructor(name, idempotencyToken) { 
        
        CreateAcceleratorRequest.initialize(this, name, idempotencyToken);
    }
    ...
    /**
     * Constructs a <code>CreateAcceleratorRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateAcceleratorRequest} obj Optional instance to populate.
     * @return {module:model/CreateAcceleratorRequest} The populated <code>CreateAcceleratorRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateAcceleratorRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateAcceleratorRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateAcceleratorRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateAcceleratorRequest.RequiredProperties) {
...
CreateAcceleratorRequest.RequiredProperties = ["Name", "IdempotencyToken"];

/**
 * @member {String} Name
 */
CreateAcceleratorRequest.prototype['Name'] = undefined;

/**
 * @member {module:model/IpAddressType} IpAddressType
 */
CreateAcceleratorRequest.prototype['IpAddressType'] = undefined;

/**
 * @member {Array} IpAddresses
 */
CreateAcceleratorRequest.prototype['IpAddresses'] = undefined;

/**
 * @member {Boolean} Enabled
 */
CreateAcceleratorRequest.prototype['Enabled'] = undefined;

/**
 * @member {String} IdempotencyToken
 */
CreateAcceleratorRequest.prototype['IdempotencyToken'] = undefined;

/**
 * @member {Array} Tags
 */
CreateAcceleratorRequest.prototype['Tags'] = undefined;
...
export default CreateAcceleratorRequest;
