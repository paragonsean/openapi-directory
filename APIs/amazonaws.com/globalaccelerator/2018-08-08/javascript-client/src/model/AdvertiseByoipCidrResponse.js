...
/**
 * The AdvertiseByoipCidrResponse model module.
 * @module model/AdvertiseByoipCidrResponse
 * @version 2018-08-08
 */
class AdvertiseByoipCidrResponse {
    /**
     * Constructs a new <code>AdvertiseByoipCidrResponse</code>.
     * @alias module:model/AdvertiseByoipCidrResponse
     */
    constructor() { 
        
        AdvertiseByoipCidrResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AdvertiseByoipCidrResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdvertiseByoipCidrResponse} obj Optional instance to populate.
     * @return {module:model/AdvertiseByoipCidrResponse} The populated <code>AdvertiseByoipCidrResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdvertiseByoipCidrResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>AdvertiseByoipCidrResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdvertiseByoipCidrResponse</code>.
     */
 ...
 */
AdvertiseByoipCidrResponse.prototype['ByoipCidr'] = undefined;
...
export default AdvertiseByoipCidrResponse;
