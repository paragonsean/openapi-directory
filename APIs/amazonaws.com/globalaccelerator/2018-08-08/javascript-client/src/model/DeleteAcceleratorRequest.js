...
/**
 * The DeleteAcceleratorRequest model module.
 * @module model/DeleteAcceleratorRequest
 * @version 2018-08-08
 */
class DeleteAcceleratorRequest {
    /**
     * Constructs a new <code>DeleteAcceleratorRequest</code>.
     * @alias module:model/DeleteAcceleratorRequest
     * @param acceleratorArn {String} 
     */
    constructor(acceleratorArn) { 
        
        DeleteAcceleratorRequest.initialize(this, acceleratorArn);
    }
    ...
    /**
     * Constructs a <code>DeleteAcceleratorRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteAcceleratorRequest} obj Optional instance to populate.
     * @return {module:model/DeleteAcceleratorRequest} The populated <code>DeleteAcceleratorRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteAcceleratorRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteAcceleratorRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteAcceleratorRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteAcceleratorRequest.RequiredProperties) {
...
DeleteAcceleratorRequest.RequiredProperties = ["AcceleratorArn"];

/**
 * @member {String} AcceleratorArn
 */
DeleteAcceleratorRequest.prototype['AcceleratorArn'] = undefined;
...
export default DeleteAcceleratorRequest;
