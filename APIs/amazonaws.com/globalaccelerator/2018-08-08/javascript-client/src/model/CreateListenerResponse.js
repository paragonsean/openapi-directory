...
import CreateListenerResponseListener from './CreateListenerResponseListener';
...
class CreateListenerResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Listener')) {
                obj['Listener'] = CreateListenerResponseListener.constructFromObject(data['Listener']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['Listener']) { // data not null
          CreateListenerResponseListener.validateJSON(data['Listener']);
        }
...
/**
 * @member {module:model/CreateListenerResponseListener} Listener
 */
CreateListenerResponse.prototype['Listener'] = undefined;
