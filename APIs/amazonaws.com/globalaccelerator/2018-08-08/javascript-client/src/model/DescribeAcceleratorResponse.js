...
import DescribeAcceleratorResponseAccelerator from './DescribeAcceleratorResponseAccelerator';

/**
 * The DescribeAcceleratorResponse model module.
 * @module model/DescribeAcceleratorResponse
 * @version 2018-08-08
 */
class DescribeAcceleratorResponse {
    /**
     * Constructs a new <code>DescribeAcceleratorResponse</code>.
     * @alias module:model/DescribeAcceleratorResponse
     */
    constructor() { 
        
        DescribeAcceleratorResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeAcceleratorResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeAcceleratorResponse} obj Optional instance to populate.
     * @return {module:model/DescribeAcceleratorResponse} The populated <code>DescribeAcceleratorResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeAcceleratorResponse();

            if (data.hasOwnProperty('Accelerator')) {
                obj['Accelerator'] = DescribeAcceleratorResponseAccelerator.constructFromObject(data['Accelerator']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeAcceleratorResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeAcceleratorResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Accelerator`
        if (data['Accelerator']) { // data not null
          DescribeAcceleratorResponseAccelerator.validateJSON(data['Accelerator']);
        }
...
/**
 * @member {module:model/DescribeAcceleratorResponseAccelerator} Accelerator
 */
DescribeAcceleratorResponse.prototype['Accelerator'] = undefined;
...
export default DescribeAcceleratorResponse;
