...
/**
 * The ListByoipCidrsResponse model module.
 * @module model/ListByoipCidrsResponse
 * @version 2018-08-08
 */
class ListByoipCidrsResponse {
    /**
     * Constructs a new <code>ListByoipCidrsResponse</code>.
     * @alias module:model/ListByoipCidrsResponse
     */
    constructor() { 
        
        ListByoipCidrsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListByoipCidrsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListByoipCidrsResponse} obj Optional instance to populate.
     * @return {module:model/ListByoipCidrsResponse} The populated <code>ListByoipCidrsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListByoipCidrsResponse();

            if (data.hasOwnProperty('ByoipCidrs')) {
                obj['ByoipCidrs'] = ApiClient.convertToType(data['ByoipCidrs'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListByoipCidrsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListByoipCidrsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `ByoipCidrs`
        if (data['ByoipCidrs']) { // data not null
          Array.validateJSON(data['ByoipCidrs']);
        }
...
/**
 * @member {Array} ByoipCidrs
 */
ListByoipCidrsResponse.prototype['ByoipCidrs'] = undefined;

/**
 * @member {String} NextToken
 */
ListByoipCidrsResponse.prototype['NextToken'] = undefined;
...
export default ListByoipCidrsResponse;
