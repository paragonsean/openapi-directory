...
import CreateEndpointGroupResponseEndpointGroup from './CreateEndpointGroupResponseEndpointGroup';

/**
 * The CreateEndpointGroupResponse model module.
 * @module model/CreateEndpointGroupResponse
 * @version 2018-08-08
 */
class CreateEndpointGroupResponse {
    /**
     * Constructs a new <code>CreateEndpointGroupResponse</code>.
     * @alias module:model/CreateEndpointGroupResponse
     */
    constructor() { 
        
        CreateEndpointGroupResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateEndpointGroupResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateEndpointGroupResponse} obj Optional instance to populate.
     * @return {module:model/CreateEndpointGroupResponse} The populated <code>CreateEndpointGroupResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateEndpointGroupResponse();

            if (data.hasOwnProperty('EndpointGroup')) {
                obj['EndpointGroup'] = CreateEndpointGroupResponseEndpointGroup.constructFromObject(data['EndpointGroup']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateEndpointGroupResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateEndpointGroupResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `EndpointGroup`
        if (data['EndpointGroup']) { // data not null
          CreateEndpointGroupResponseEndpointGroup.validateJSON(data['EndpointGroup']);
        }
...
/**
 * @member {module:model/CreateEndpointGroupResponseEndpointGroup} EndpointGroup
 */
CreateEndpointGroupResponse.prototype['EndpointGroup'] = undefined;
...
export default CreateEndpointGroupResponse;
