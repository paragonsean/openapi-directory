...
import UpdateListenerResponseListener from './UpdateListenerResponseListener';
...
class UpdateListenerResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Listener')) {
                obj['Listener'] = UpdateListenerResponseListener.constructFromObject(data['Listener']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['Listener']) { // data not null
          UpdateListenerResponseListener.validateJSON(data['Listener']);
        }
...
/**
 * @member {module:model/UpdateListenerResponseListener} Listener
 */
UpdateListenerResponse.prototype['Listener'] = undefined;
