...
/**
 * The ListCustomRoutingEndpointGroupsResponse model module.
 * @module model/ListCustomRoutingEndpointGroupsResponse
 * @version 2018-08-08
 */
class ListCustomRoutingEndpointGroupsResponse {
    /**
     * Constructs a new <code>ListCustomRoutingEndpointGroupsResponse</code>.
     * @alias module:model/ListCustomRoutingEndpointGroupsResponse
     */
    constructor() { 
        
        ListCustomRoutingEndpointGroupsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListCustomRoutingEndpointGroupsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListCustomRoutingEndpointGroupsResponse} obj Optional instance to populate.
     * @return {module:model/ListCustomRoutingEndpointGroupsResponse} The populated <code>ListCustomRoutingEndpointGroupsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListCustomRoutingEndpointGroupsResponse();

            if (data.hasOwnProperty('EndpointGroups')) {
                obj['EndpointGroups'] = ApiClient.convertToType(data['EndpointGroups'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListCustomRoutingEndpointGroupsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListCustomRoutingEndpointGroupsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `EndpointGroups`
        if (data['EndpointGroups']) { // data not null
          Array.validateJSON(data['EndpointGroups']);
        }
...
/**
 * @member {Array} EndpointGroups
 */
ListCustomRoutingEndpointGroupsResponse.prototype['EndpointGroups'] = undefined;

/**
 * @member {String} NextToken
 */
ListCustomRoutingEndpointGroupsResponse.prototype['NextToken'] = undefined;
...
export default ListCustomRoutingEndpointGroupsResponse;
