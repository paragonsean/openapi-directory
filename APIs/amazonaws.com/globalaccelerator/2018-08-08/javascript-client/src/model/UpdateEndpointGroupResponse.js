...
import UpdateEndpointGroupResponseEndpointGroup from './UpdateEndpointGroupResponseEndpointGroup';

/**
 * The UpdateEndpointGroupResponse model module.
 * @module model/UpdateEndpointGroupResponse
 * @version 2018-08-08
 */
class UpdateEndpointGroupResponse {
    /**
     * Constructs a new <code>UpdateEndpointGroupResponse</code>.
     * @alias module:model/UpdateEndpointGroupResponse
     */
    constructor() { 
        
        UpdateEndpointGroupResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateEndpointGroupResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateEndpointGroupResponse} obj Optional instance to populate.
     * @return {module:model/UpdateEndpointGroupResponse} The populated <code>UpdateEndpointGroupResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateEndpointGroupResponse();

            if (data.hasOwnProperty('EndpointGroup')) {
                obj['EndpointGroup'] = UpdateEndpointGroupResponseEndpointGroup.constructFromObject(data['EndpointGroup']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateEndpointGroupResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateEndpointGroupResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `EndpointGroup`
        if (data['EndpointGroup']) { // data not null
          UpdateEndpointGroupResponseEndpointGroup.validateJSON(data['EndpointGroup']);
        }
...
/**
 * @member {module:model/UpdateEndpointGroupResponseEndpointGroup} EndpointGroup
 */
UpdateEndpointGroupResponse.prototype['EndpointGroup'] = undefined;
...
export default UpdateEndpointGroupResponse;
