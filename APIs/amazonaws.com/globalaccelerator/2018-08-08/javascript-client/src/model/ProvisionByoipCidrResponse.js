...
import AdvertiseByoipCidrResponseByoipCidr from './AdvertiseByoipCidrResponseByoipCidr';

/**
 * The ProvisionByoipCidrResponse model module.
 * @module model/ProvisionByoipCidrResponse
 * @version 2018-08-08
 */
class ProvisionByoipCidrResponse {
    /**
     * Constructs a new <code>ProvisionByoipCidrResponse</code>.
     * @alias module:model/ProvisionByoipCidrResponse
     */
    constructor() { 
        
        ProvisionByoipCidrResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProvisionByoipCidrResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProvisionByoipCidrResponse} obj Optional instance to populate.
     * @return {module:model/ProvisionByoipCidrResponse} The populated <code>ProvisionByoipCidrResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProvisionByoipCidrResponse();

            if (data.hasOwnProperty('ByoipCidr')) {
                obj['ByoipCidr'] = AdvertiseByoipCidrResponseByoipCidr.constructFromObject(data['ByoipCidr']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ProvisionByoipCidrResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProvisionByoipCidrResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `ByoipCidr`
        if (data['ByoipCidr']) { // data not null
          AdvertiseByoipCidrResponseByoipCidr.validateJSON(data['ByoipCidr']);
        }
...
/**
 * @member {module:model/AdvertiseByoipCidrResponseByoipCidr} ByoipCidr
 */
ProvisionByoipCidrResponse.prototype['ByoipCidr'] = undefined;
...
export default ProvisionByoipCidrResponse;
