...
import DescribeCustomRoutingListenerResponseListener from './DescribeCustomRoutingListenerResponseListener';

/**
 * The DescribeCustomRoutingListenerResponse model module.
 * @module model/DescribeCustomRoutingListenerResponse
 * @version 2018-08-08
 */
class DescribeCustomRoutingListenerResponse {
    /**
     * Constructs a new <code>DescribeCustomRoutingListenerResponse</code>.
     * @alias module:model/DescribeCustomRoutingListenerResponse
     */
    constructor() { 
        
        DescribeCustomRoutingListenerResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeCustomRoutingListenerResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeCustomRoutingListenerResponse} obj Optional instance to populate.
     * @return {module:model/DescribeCustomRoutingListenerResponse} The populated <code>DescribeCustomRoutingListenerResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeCustomRoutingListenerResponse();

            if (data.hasOwnProperty('Listener')) {
                obj['Listener'] = DescribeCustomRoutingListenerResponseListener.constructFromObject(data['Listener']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeCustomRoutingListenerResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeCustomRoutingListenerResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Listener`
        if (data['Listener']) { // data not null
          DescribeCustomRoutingListenerResponseListener.validateJSON(data['Listener']);
        }
...
/**
 * @member {module:model/DescribeCustomRoutingListenerResponseListener} Listener
 */
DescribeCustomRoutingListenerResponse.prototype['Listener'] = undefined;
...
export default DescribeCustomRoutingListenerResponse;
