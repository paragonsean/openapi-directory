...
* @readonly
*/
export default class CustomRoutingProtocol {
    ...
    /**
    * Returns a <code>CustomRoutingProtocol</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CustomRoutingProtocol} The enum <code>CustomRoutingProtocol</code> value.
    */
