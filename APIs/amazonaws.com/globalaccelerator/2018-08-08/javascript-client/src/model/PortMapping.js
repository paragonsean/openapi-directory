...
import PortMappingDestinationSocketAddress from './PortMappingDestinationSocketAddress';
...
class PortMapping {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('AcceleratorPort')) {
                obj['AcceleratorPort'] = ApiClient.convertToType(data['AcceleratorPort'], 'Number');
            }
            ...
            if (data.hasOwnProperty('DestinationSocketAddress')) {
                obj['DestinationSocketAddress'] = PortMappingDestinationSocketAddress.constructFromObject(data['DestinationSocketAddress']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['AcceleratorPort']) { // data not null
          Number.validateJSON(data['AcceleratorPort']);
        }
        ...
        if (data['DestinationSocketAddress']) { // data not null
          PortMappingDestinationSocketAddress.validateJSON(data['DestinationSocketAddress']);
        }
...
/**
 * @member {Number} AcceleratorPort
 */
PortMapping.prototype['AcceleratorPort'] = undefined;

/**
 * @member {String} EndpointGroupArn
 */
PortMapping.prototype['EndpointGroupArn'] = undefined;

/**
 * @member {String} EndpointId
 */
PortMapping.prototype['EndpointId'] = undefined;

/**
 * @member {module:model/PortMappingDestinationSocketAddress} DestinationSocketAddress
 */
PortMapping.prototype['DestinationSocketAddress'] = undefined;

/**
 * @member {Array} Protocols
 */
PortMapping.prototype['Protocols'] = undefined;

/**
 * @member {module:model/CustomRoutingDestinationTrafficState} DestinationTrafficState
 */
PortMapping.prototype['DestinationTrafficState'] = undefined;
