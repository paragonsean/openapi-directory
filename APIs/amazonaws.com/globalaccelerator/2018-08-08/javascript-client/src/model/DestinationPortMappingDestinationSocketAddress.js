...
/**
 * The DestinationPortMappingDestinationSocketAddress model module.
 * @module model/DestinationPortMappingDestinationSocketAddress
 * @version 2018-08-08
 */
class DestinationPortMappingDestinationSocketAddress {
    /**
     * Constructs a new <code>DestinationPortMappingDestinationSocketAddress</code>.
     * @alias module:model/DestinationPortMappingDestinationSocketAddress
     * @implements module:model/SocketAddress
     */
    constructor() { 
        SocketAddress.initialize(this);
        DestinationPortMappingDestinationSocketAddress.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DestinationPortMappingDestinationSocketAddress</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DestinationPortMappingDestinationSocketAddress} obj Optional instance to populate.
     * @return {module:model/DestinationPortMappingDestinationSocketAddress} The populated <code>DestinationPortMappingDestinationSocketAddress</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DestinationPortMappingDestinationSocketAddress();
    ...
    /**
     * Validates the JSON data with respect to <code>DestinationPortMappingDestinationSocketAddress</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DestinationPortMappingDestinationSocketAddress</code>.
     */
 ...
 */
DestinationPortMappingDestinationSocketAddress.prototype['IpAddress'] = undefined;

/**
 * @member {Number} Port
 */
DestinationPortMappingDestinationSocketAddress.prototype['Port'] = undefined;
 ...
 * @member {String} IpAddress
 */
SocketAddress.prototype['IpAddress'] = undefined;
/**
 * @member {Number} Port
 */
...
export default DestinationPortMappingDestinationSocketAddress;
