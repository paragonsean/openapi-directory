...
* @readonly
*/
export default class CustomRoutingDestinationTrafficState {
    ...
    /**
    * Returns a <code>CustomRoutingDestinationTrafficState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CustomRoutingDestinationTrafficState} The enum <code>CustomRoutingDestinationTrafficState</code> value.
    */
