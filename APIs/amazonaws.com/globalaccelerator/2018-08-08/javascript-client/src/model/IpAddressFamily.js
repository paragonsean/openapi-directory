...
* @readonly
*/
export default class IpAddressFamily {
    ...
    /**
    * Returns a <code>IpAddressFamily</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/IpAddressFamily} The enum <code>IpAddressFamily</code> value.
    */
