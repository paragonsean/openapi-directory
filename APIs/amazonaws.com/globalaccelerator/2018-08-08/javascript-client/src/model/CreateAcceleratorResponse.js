...
import CreateAcceleratorResponseAccelerator from './CreateAcceleratorResponseAccelerator';

/**
 * The CreateAcceleratorResponse model module.
 * @module model/CreateAcceleratorResponse
 * @version 2018-08-08
 */
class CreateAcceleratorResponse {
    /**
     * Constructs a new <code>CreateAcceleratorResponse</code>.
     * @alias module:model/CreateAcceleratorResponse
     */
    constructor() { 
        
        CreateAcceleratorResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateAcceleratorResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateAcceleratorResponse} obj Optional instance to populate.
     * @return {module:model/CreateAcceleratorResponse} The populated <code>CreateAcceleratorResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateAcceleratorResponse();

            if (data.hasOwnProperty('Accelerator')) {
                obj['Accelerator'] = CreateAcceleratorResponseAccelerator.constructFromObject(data['Accelerator']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateAcceleratorResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateAcceleratorResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Accelerator`
        if (data['Accelerator']) { // data not null
          CreateAcceleratorResponseAccelerator.validateJSON(data['Accelerator']);
        }
...
/**
 * @member {module:model/CreateAcceleratorResponseAccelerator} Accelerator
 */
CreateAcceleratorResponse.prototype['Accelerator'] = undefined;
...
export default CreateAcceleratorResponse;
