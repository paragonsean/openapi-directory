...
* @readonly
*/
export default class AcceleratorStatus {
    ...
    /**
    * Returns a <code>AcceleratorStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AcceleratorStatus} The enum <code>AcceleratorStatus</code> value.
    */
