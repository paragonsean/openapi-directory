...
/**
 * The CreateCustomRoutingAcceleratorRequest model module.
 * @module model/CreateCustomRoutingAcceleratorRequest
 * @version 2018-08-08
 */
class CreateCustomRoutingAcceleratorRequest {
    /**
     * Constructs a new <code>CreateCustomRoutingAcceleratorRequest</code>.
     * @alias module:model/CreateCustomRoutingAcceleratorRequest
     * @param name {String} 
     * @param idempotencyToken {String} 
     */
    constructor(name, idempotencyToken) { 
        
        CreateCustomRoutingAcceleratorRequest.initialize(this, name, idempotencyToken);
    }
     ...
     */
    static initialize(obj, name, idempotencyToken) { 
        obj['Name'] = name;
        obj['IdempotencyToken'] = idempotencyToken;
    }

    /**
     * Constructs a <code>CreateCustomRoutingAcceleratorRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateCustomRoutingAcceleratorRequest} obj Optional instance to populate.
     * @return {module:model/CreateCustomRoutingAcceleratorRequest} The populated <code>CreateCustomRoutingAcceleratorRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateCustomRoutingAcceleratorRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCustomRoutingAcceleratorRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCustomRoutingAcceleratorRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateCustomRoutingAcceleratorRequest.RequiredProperties) {
...
CreateCustomRoutingAcceleratorRequest.RequiredProperties = ["Name", "IdempotencyToken"];

/**
 * @member {String} Name
 */
CreateCustomRoutingAcceleratorRequest.prototype['Name'] = undefined;

/**
 * @member {module:model/IpAddressType} IpAddressType
 */
CreateCustomRoutingAcceleratorRequest.prototype['IpAddressType'] = undefined;

/**
 * @member {Array} IpAddresses
 */
CreateCustomRoutingAcceleratorRequest.prototype['IpAddresses'] = undefined;

/**
 * @member {Boolean} Enabled
 */
CreateCustomRoutingAcceleratorRequest.prototype['Enabled'] = undefined;

/**
 * @member {String} IdempotencyToken
 */
CreateCustomRoutingAcceleratorRequest.prototype['IdempotencyToken'] = undefined;

/**
 * @member {Array} Tags
 */
CreateCustomRoutingAcceleratorRequest.prototype['Tags'] = undefined;
...
export default CreateCustomRoutingAcceleratorRequest;
