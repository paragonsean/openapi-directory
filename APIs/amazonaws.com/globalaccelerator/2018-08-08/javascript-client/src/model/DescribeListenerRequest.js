...
/**
 * The DescribeListenerRequest model module.
 * @module model/DescribeListenerRequest
 * @version 2018-08-08
 */
class DescribeListenerRequest {
    /**
     * Constructs a new <code>DescribeListenerRequest</code>.
     * @alias module:model/DescribeListenerRequest
     * @param listenerArn {String} 
     */
    constructor(listenerArn) { 
        
        DescribeListenerRequest.initialize(this, listenerArn);
    }
    ...
    /**
     * Constructs a <code>DescribeListenerRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeListenerRequest} obj Optional instance to populate.
     * @return {module:model/DescribeListenerRequest} The populated <code>DescribeListenerRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeListenerRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeListenerRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeListenerRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeListenerRequest.RequiredProperties) {
...
DescribeListenerRequest.RequiredProperties = ["ListenerArn"];

/**
 * @member {String} ListenerArn
 */
DescribeListenerRequest.prototype['ListenerArn'] = undefined;
...
export default DescribeListenerRequest;
