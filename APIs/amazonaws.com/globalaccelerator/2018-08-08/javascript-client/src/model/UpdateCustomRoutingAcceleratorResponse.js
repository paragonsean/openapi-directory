...
import UpdateCustomRoutingAcceleratorResponseAccelerator from './UpdateCustomRoutingAcceleratorResponseAccelerator';

/**
 * The UpdateCustomRoutingAcceleratorResponse model module.
 * @module model/UpdateCustomRoutingAcceleratorResponse
 * @version 2018-08-08
 */
class UpdateCustomRoutingAcceleratorResponse {
    /**
     * Constructs a new <code>UpdateCustomRoutingAcceleratorResponse</code>.
     * @alias module:model/UpdateCustomRoutingAcceleratorResponse
     */
    constructor() { 
        
        UpdateCustomRoutingAcceleratorResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateCustomRoutingAcceleratorResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateCustomRoutingAcceleratorResponse} obj Optional instance to populate.
     * @return {module:model/UpdateCustomRoutingAcceleratorResponse} The populated <code>UpdateCustomRoutingAcceleratorResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateCustomRoutingAcceleratorResponse();

            if (data.hasOwnProperty('Accelerator')) {
                obj['Accelerator'] = UpdateCustomRoutingAcceleratorResponseAccelerator.constructFromObject(data['Accelerator']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateCustomRoutingAcceleratorResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateCustomRoutingAcceleratorResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Accelerator`
        if (data['Accelerator']) { // data not null
          UpdateCustomRoutingAcceleratorResponseAccelerator.validateJSON(data['Accelerator']);
        }
...
/**
 * @member {module:model/UpdateCustomRoutingAcceleratorResponseAccelerator} Accelerator
 */
UpdateCustomRoutingAcceleratorResponse.prototype['Accelerator'] = undefined;
...
export default UpdateCustomRoutingAcceleratorResponse;
