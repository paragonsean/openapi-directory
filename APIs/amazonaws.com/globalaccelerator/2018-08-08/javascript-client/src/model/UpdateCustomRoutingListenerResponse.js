...
import UpdateCustomRoutingListenerResponseListener from './UpdateCustomRoutingListenerResponseListener';

/**
 * The UpdateCustomRoutingListenerResponse model module.
 * @module model/UpdateCustomRoutingListenerResponse
 * @version 2018-08-08
 */
class UpdateCustomRoutingListenerResponse {
    /**
     * Constructs a new <code>UpdateCustomRoutingListenerResponse</code>.
     * @alias module:model/UpdateCustomRoutingListenerResponse
     */
    constructor() { 
        
        UpdateCustomRoutingListenerResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateCustomRoutingListenerResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateCustomRoutingListenerResponse} obj Optional instance to populate.
     * @return {module:model/UpdateCustomRoutingListenerResponse} The populated <code>UpdateCustomRoutingListenerResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateCustomRoutingListenerResponse();

            if (data.hasOwnProperty('Listener')) {
                obj['Listener'] = UpdateCustomRoutingListenerResponseListener.constructFromObject(data['Listener']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateCustomRoutingListenerResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateCustomRoutingListenerResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Listener`
        if (data['Listener']) { // data not null
          UpdateCustomRoutingListenerResponseListener.validateJSON(data['Listener']);
        }
...
/**
 * @member {module:model/UpdateCustomRoutingListenerResponseListener} Listener
 */
UpdateCustomRoutingListenerResponse.prototype['Listener'] = undefined;
...
export default UpdateCustomRoutingListenerResponse;
