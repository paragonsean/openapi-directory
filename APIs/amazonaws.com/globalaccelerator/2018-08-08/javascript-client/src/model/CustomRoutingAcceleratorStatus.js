...
* @readonly
*/
export default class CustomRoutingAcceleratorStatus {
    ...
    /**
    * Returns a <code>CustomRoutingAcceleratorStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CustomRoutingAcceleratorStatus} The enum <code>CustomRoutingAcceleratorStatus</code> value.
    */
