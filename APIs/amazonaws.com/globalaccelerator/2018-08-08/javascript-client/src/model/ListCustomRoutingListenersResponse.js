...
/**
 * The ListCustomRoutingListenersResponse model module.
 * @module model/ListCustomRoutingListenersResponse
 * @version 2018-08-08
 */
class ListCustomRoutingListenersResponse {
    /**
     * Constructs a new <code>ListCustomRoutingListenersResponse</code>.
     * @alias module:model/ListCustomRoutingListenersResponse
     */
    constructor() { 
        
        ListCustomRoutingListenersResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListCustomRoutingListenersResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListCustomRoutingListenersResponse} obj Optional instance to populate.
     * @return {module:model/ListCustomRoutingListenersResponse} The populated <code>ListCustomRoutingListenersResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListCustomRoutingListenersResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListCustomRoutingListenersResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListCustomRoutingListenersResponse</code>.
     */
 ...
 */
ListCustomRoutingListenersResponse.prototype['Listeners'] = undefined;

/**
 * @member {String} NextToken
 */
ListCustomRoutingListenersResponse.prototype['NextToken'] = undefined;
...
export default ListCustomRoutingListenersResponse;
