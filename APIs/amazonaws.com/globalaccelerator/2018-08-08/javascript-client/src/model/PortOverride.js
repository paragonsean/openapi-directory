...
/**
 * The PortOverride model module.
 * @module model/PortOverride
 * @version 2018-08-08
 */
class PortOverride {
    /**
     * Constructs a new <code>PortOverride</code>.
     ...
     * @alias module:model/PortOverride
     */
    constructor() { 
        
        PortOverride.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PortOverride</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PortOverride} obj Optional instance to populate.
     * @return {module:model/PortOverride} The populated <code>PortOverride</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PortOverride();

            if (data.hasOwnProperty('ListenerPort')) {
                obj['ListenerPort'] = ApiClient.convertToType(data['ListenerPort'], 'Number');
            }
            if (data.hasOwnProperty('EndpointPort')) {
                obj['EndpointPort'] = ApiClient.convertToType(data['EndpointPort'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PortOverride</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PortOverride</code>.
     */
    static validateJSON(data) {
        // validate the optional field `ListenerPort`
        if (data['ListenerPort']) { // data not null
          Number.validateJSON(data['ListenerPort']);
        }
        // validate the optional field `EndpointPort`
        if (data['EndpointPort']) { // data not null
          Number.validateJSON(data['EndpointPort']);
        }
 ...
 */
PortOverride.prototype['ListenerPort'] = undefined;

/**
 * @member {Number} EndpointPort
 */
PortOverride.prototype['EndpointPort'] = undefined;
