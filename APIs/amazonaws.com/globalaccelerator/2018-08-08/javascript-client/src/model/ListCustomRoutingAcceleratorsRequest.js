...
/**
 * The ListCustomRoutingAcceleratorsRequest model module.
 * @module model/ListCustomRoutingAcceleratorsRequest
 * @version 2018-08-08
 */
class ListCustomRoutingAcceleratorsRequest {
    /**
     * Constructs a new <code>ListCustomRoutingAcceleratorsRequest</code>.
     * @alias module:model/ListCustomRoutingAcceleratorsRequest
     */
    constructor() { 
        
        ListCustomRoutingAcceleratorsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListCustomRoutingAcceleratorsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListCustomRoutingAcceleratorsRequest} obj Optional instance to populate.
     * @return {module:model/ListCustomRoutingAcceleratorsRequest} The populated <code>ListCustomRoutingAcceleratorsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListCustomRoutingAcceleratorsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListCustomRoutingAcceleratorsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListCustomRoutingAcceleratorsRequest</code>.
     */
 ...
 */
ListCustomRoutingAcceleratorsRequest.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
ListCustomRoutingAcceleratorsRequest.prototype['NextToken'] = undefined;
...
export default ListCustomRoutingAcceleratorsRequest;
