...
* @readonly
*/
export default class ClientAffinity {
    ...
    /**
    * Returns a <code>ClientAffinity</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ClientAffinity} The enum <code>ClientAffinity</code> value.
    */
