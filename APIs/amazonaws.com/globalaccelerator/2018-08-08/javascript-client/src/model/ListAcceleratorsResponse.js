...
/**
 * The ListAcceleratorsResponse model module.
 * @module model/ListAcceleratorsResponse
 * @version 2018-08-08
 */
class ListAcceleratorsResponse {
    /**
     * Constructs a new <code>ListAcceleratorsResponse</code>.
     * @alias module:model/ListAcceleratorsResponse
     */
    constructor() { 
        
        ListAcceleratorsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListAcceleratorsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAcceleratorsResponse} obj Optional instance to populate.
     * @return {module:model/ListAcceleratorsResponse} The populated <code>ListAcceleratorsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListAcceleratorsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListAcceleratorsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListAcceleratorsResponse</code>.
     */
 ...
 */
ListAcceleratorsResponse.prototype['Accelerators'] = undefined;

/**
 * @member {String} NextToken
 */
ListAcceleratorsResponse.prototype['NextToken'] = undefined;
...
export default ListAcceleratorsResponse;
