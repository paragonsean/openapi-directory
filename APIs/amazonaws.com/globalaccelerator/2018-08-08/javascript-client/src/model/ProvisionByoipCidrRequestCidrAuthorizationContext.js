...
/**
 * The ProvisionByoipCidrRequestCidrAuthorizationContext model module.
 * @module model/ProvisionByoipCidrRequestCidrAuthorizationContext
 * @version 2018-08-08
 */
class ProvisionByoipCidrRequestCidrAuthorizationContext {
    /**
     * Constructs a new <code>ProvisionByoipCidrRequestCidrAuthorizationContext</code>.
     * @alias module:model/ProvisionByoipCidrRequestCidrAuthorizationContext
     * @implements module:model/CidrAuthorizationContext
     * @param message {String} 
     * @param signature {String} 
     */
    constructor(message, signature) { 
        CidrAuthorizationContext.initialize(this, message, signature);
        ProvisionByoipCidrRequestCidrAuthorizationContext.initialize(this, message, signature);
    }
    ...
    /**
     * Constructs a <code>ProvisionByoipCidrRequestCidrAuthorizationContext</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProvisionByoipCidrRequestCidrAuthorizationContext} obj Optional instance to populate.
     * @return {module:model/ProvisionByoipCidrRequestCidrAuthorizationContext} The populated <code>ProvisionByoipCidrRequestCidrAuthorizationContext</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProvisionByoipCidrRequestCidrAuthorizationContext();
            CidrAuthorizationContext.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ProvisionByoipCidrRequestCidrAuthorizationContext</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProvisionByoipCidrRequestCidrAuthorizationContext</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ProvisionByoipCidrRequestCidrAuthorizationContext.RequiredProperties) {
...
ProvisionByoipCidrRequestCidrAuthorizationContext.RequiredProperties = ["Message", "Signature"];

/**
 * @member {String} Message
 */
ProvisionByoipCidrRequestCidrAuthorizationContext.prototype['Message'] = undefined;

/**
 * @member {String} Signature
 */
ProvisionByoipCidrRequestCidrAuthorizationContext.prototype['Signature'] = undefined;


// Implement CidrAuthorizationContext interface:
/**
 * @member {String} Message
 */
...
export default ProvisionByoipCidrRequestCidrAuthorizationContext;
