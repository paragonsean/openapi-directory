...
/**
 * The WithdrawByoipCidrRequest model module.
 * @module model/WithdrawByoipCidrRequest
 * @version 2018-08-08
 */
class WithdrawByoipCidrRequest {
    /**
     * Constructs a new <code>WithdrawByoipCidrRequest</code>.
     * @alias module:model/WithdrawByoipCidrRequest
     * @param cidr {String} 
     */
    constructor(cidr) { 
        
        WithdrawByoipCidrRequest.initialize(this, cidr);
    }
    ...
    /**
     * Constructs a <code>WithdrawByoipCidrRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WithdrawByoipCidrRequest} obj Optional instance to populate.
     * @return {module:model/WithdrawByoipCidrRequest} The populated <code>WithdrawByoipCidrRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WithdrawByoipCidrRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>WithdrawByoipCidrRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WithdrawByoipCidrRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WithdrawByoipCidrRequest.RequiredProperties) {
...
WithdrawByoipCidrRequest.RequiredProperties = ["Cidr"];

/**
 * @member {String} Cidr
 */
WithdrawByoipCidrRequest.prototype['Cidr'] = undefined;
...
export default WithdrawByoipCidrRequest;
