...
/**
 * The ListCustomRoutingPortMappingsResponse model module.
 * @module model/ListCustomRoutingPortMappingsResponse
 * @version 2018-08-08
 */
class ListCustomRoutingPortMappingsResponse {
    /**
     * Constructs a new <code>ListCustomRoutingPortMappingsResponse</code>.
     * @alias module:model/ListCustomRoutingPortMappingsResponse
     */
    constructor() { 
        
        ListCustomRoutingPortMappingsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListCustomRoutingPortMappingsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListCustomRoutingPortMappingsResponse} obj Optional instance to populate.
     * @return {module:model/ListCustomRoutingPortMappingsResponse} The populated <code>ListCustomRoutingPortMappingsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListCustomRoutingPortMappingsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListCustomRoutingPortMappingsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListCustomRoutingPortMappingsResponse</code>.
     */
 ...
 */
ListCustomRoutingPortMappingsResponse.prototype['PortMappings'] = undefined;

/**
 * @member {String} NextToken
 */
ListCustomRoutingPortMappingsResponse.prototype['NextToken'] = undefined;
...
export default ListCustomRoutingPortMappingsResponse;
