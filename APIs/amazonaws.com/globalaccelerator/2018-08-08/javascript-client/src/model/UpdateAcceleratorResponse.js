...
import UpdateAcceleratorResponseAccelerator from './UpdateAcceleratorResponseAccelerator';

/**
 * The UpdateAcceleratorResponse model module.
 * @module model/UpdateAcceleratorResponse
 * @version 2018-08-08
 */
class UpdateAcceleratorResponse {
    /**
     * Constructs a new <code>UpdateAcceleratorResponse</code>.
     * @alias module:model/UpdateAcceleratorResponse
     */
    constructor() { 
        
        UpdateAcceleratorResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateAcceleratorResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateAcceleratorResponse} obj Optional instance to populate.
     * @return {module:model/UpdateAcceleratorResponse} The populated <code>UpdateAcceleratorResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateAcceleratorResponse();

            if (data.hasOwnProperty('Accelerator')) {
                obj['Accelerator'] = UpdateAcceleratorResponseAccelerator.constructFromObject(data['Accelerator']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateAcceleratorResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateAcceleratorResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Accelerator`
        if (data['Accelerator']) { // data not null
          UpdateAcceleratorResponseAccelerator.validateJSON(data['Accelerator']);
        }
...
/**
 * @member {module:model/UpdateAcceleratorResponseAccelerator} Accelerator
 */
UpdateAcceleratorResponse.prototype['Accelerator'] = undefined;
...
export default UpdateAcceleratorResponse;
