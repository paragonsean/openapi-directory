...
/**
 * The CustomRoutingAccelerator model module.
 * @module model/CustomRoutingAccelerator
 * @version 2018-08-08
 */
class CustomRoutingAccelerator {
    /**
     * Constructs a new <code>CustomRoutingAccelerator</code>.
     * Attributes of a custom routing accelerator.
     * @alias module:model/CustomRoutingAccelerator
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>CustomRoutingAccelerator</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CustomRoutingAccelerator} obj Optional instance to populate.
     * @return {module:model/CustomRoutingAccelerator} The populated <code>CustomRoutingAccelerator</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomRoutingAccelerator();
    ...
    /**
     * Validates the JSON data with respect to <code>CustomRoutingAccelerator</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomRoutingAccelerator</code>.
     */
...
export default CustomRoutingAccelerator;
