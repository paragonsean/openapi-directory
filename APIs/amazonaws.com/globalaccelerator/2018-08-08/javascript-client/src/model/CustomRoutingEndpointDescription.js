...
/**
 * The CustomRoutingEndpointDescription model module.
 * @module model/CustomRoutingEndpointDescription
 * @version 2018-08-08
 */
class CustomRoutingEndpointDescription {
    /**
     * Constructs a new <code>CustomRoutingEndpointDescription</code>.
     * A complex type for an endpoint for a custom routing accelerator. Each endpoint group can include one or more endpoints, which are virtual private cloud (VPC) subnets.
     * @alias module:model/CustomRoutingEndpointDescription
     */
    constructor() { 
        
        CustomRoutingEndpointDescription.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CustomRoutingEndpointDescription</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CustomRoutingEndpointDescription} obj Optional instance to populate.
     * @return {module:model/CustomRoutingEndpointDescription} The populated <code>CustomRoutingEndpointDescription</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomRoutingEndpointDescription();
    ...
    /**
     * Validates the JSON data with respect to <code>CustomRoutingEndpointDescription</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomRoutingEndpointDescription</code>.
     */
 ...
 */
CustomRoutingEndpointDescription.prototype['EndpointId'] = undefined;
...
export default CustomRoutingEndpointDescription;
