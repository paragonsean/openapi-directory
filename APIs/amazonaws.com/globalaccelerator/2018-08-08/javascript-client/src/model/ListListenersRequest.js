...
/**
 * The ListListenersRequest model module.
 * @module model/ListListenersRequest
 * @version 2018-08-08
 */
class ListListenersRequest {
    /**
     * Constructs a new <code>ListListenersRequest</code>.
     * @alias module:model/ListListenersRequest
     * @param acceleratorArn {String} 
     */
    constructor(acceleratorArn) { 
        
        ListListenersRequest.initialize(this, acceleratorArn);
    }
    ...
    /**
     * Constructs a <code>ListListenersRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListListenersRequest} obj Optional instance to populate.
     * @return {module:model/ListListenersRequest} The populated <code>ListListenersRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListListenersRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListListenersRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListListenersRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListListenersRequest.RequiredProperties) {
...
ListListenersRequest.RequiredProperties = ["AcceleratorArn"];

/**
 * @member {String} AcceleratorArn
 */
ListListenersRequest.prototype['AcceleratorArn'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListListenersRequest.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
ListListenersRequest.prototype['NextToken'] = undefined;
...
export default ListListenersRequest;
