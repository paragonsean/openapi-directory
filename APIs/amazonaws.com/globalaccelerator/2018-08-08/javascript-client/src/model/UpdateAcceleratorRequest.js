...
/**
 * The UpdateAcceleratorRequest model module.
 * @module model/UpdateAcceleratorRequest
 * @version 2018-08-08
 */
class UpdateAcceleratorRequest {
    /**
     * Constructs a new <code>UpdateAcceleratorRequest</code>.
     * @alias module:model/UpdateAcceleratorRequest
     * @param acceleratorArn {String} 
     */
    constructor(acceleratorArn) { 
        
        UpdateAcceleratorRequest.initialize(this, acceleratorArn);
    }
    ...
    /**
     * Constructs a <code>UpdateAcceleratorRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateAcceleratorRequest} obj Optional instance to populate.
     * @return {module:model/UpdateAcceleratorRequest} The populated <code>UpdateAcceleratorRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateAcceleratorRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateAcceleratorRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateAcceleratorRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateAcceleratorRequest.RequiredProperties) {
...
UpdateAcceleratorRequest.RequiredProperties = ["AcceleratorArn"];

/**
 * @member {String} AcceleratorArn
 */
UpdateAcceleratorRequest.prototype['AcceleratorArn'] = undefined;

/**
 * @member {String} Name
 */
UpdateAcceleratorRequest.prototype['Name'] = undefined;

/**
 * @member {module:model/IpAddressType} IpAddressType
 */
UpdateAcceleratorRequest.prototype['IpAddressType'] = undefined;

/**
 * @member {Boolean} Enabled
 */
UpdateAcceleratorRequest.prototype['Enabled'] = undefined;
...
export default UpdateAcceleratorRequest;
