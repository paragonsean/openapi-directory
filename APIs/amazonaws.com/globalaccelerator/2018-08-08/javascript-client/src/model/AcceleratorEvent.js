...
/**
 * The AcceleratorEvent model module.
 * @module model/AcceleratorEvent
 * @version 2018-08-08
 */
class AcceleratorEvent {
    /**
     * Constructs a new <code>AcceleratorEvent</code>.
     ...
     * @alias module:model/AcceleratorEvent
     */
    constructor() { 
        
        AcceleratorEvent.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AcceleratorEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AcceleratorEvent} obj Optional instance to populate.
     * @return {module:model/AcceleratorEvent} The populated <code>AcceleratorEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AcceleratorEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>AcceleratorEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AcceleratorEvent</code>.
     */
 ...
 */
AcceleratorEvent.prototype['Message'] = undefined;

/**
 * @member {Date} Timestamp
 */
AcceleratorEvent.prototype['Timestamp'] = undefined;
...
export default AcceleratorEvent;
