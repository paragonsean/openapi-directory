...
/**
 * The DeleteListenerRequest model module.
 * @module model/DeleteListenerRequest
 * @version 2018-08-08
 */
class DeleteListenerRequest {
    /**
     * Constructs a new <code>DeleteListenerRequest</code>.
     * @alias module:model/DeleteListenerRequest
     * @param listenerArn {String} 
     */
    constructor(listenerArn) { 
        
        DeleteListenerRequest.initialize(this, listenerArn);
    }
    ...
    /**
     * Constructs a <code>DeleteListenerRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteListenerRequest} obj Optional instance to populate.
     * @return {module:model/DeleteListenerRequest} The populated <code>DeleteListenerRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteListenerRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteListenerRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteListenerRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteListenerRequest.RequiredProperties) {
...
DeleteListenerRequest.RequiredProperties = ["ListenerArn"];

/**
 * @member {String} ListenerArn
 */
DeleteListenerRequest.prototype['ListenerArn'] = undefined;
...
export default DeleteListenerRequest;
