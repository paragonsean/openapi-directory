...
/**
 * The ListByoipCidrsRequest model module.
 * @module model/ListByoipCidrsRequest
 * @version 2018-08-08
 */
class ListByoipCidrsRequest {
    /**
     * Constructs a new <code>ListByoipCidrsRequest</code>.
     * @alias module:model/ListByoipCidrsRequest
     */
    constructor() { 
        
        ListByoipCidrsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListByoipCidrsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListByoipCidrsRequest} obj Optional instance to populate.
     * @return {module:model/ListByoipCidrsRequest} The populated <code>ListByoipCidrsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListByoipCidrsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListByoipCidrsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListByoipCidrsRequest</code>.
     */
 ...
 */
ListByoipCidrsRequest.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
ListByoipCidrsRequest.prototype['NextToken'] = undefined;
...
export default ListByoipCidrsRequest;
