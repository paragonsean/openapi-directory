...
import IpAddressFamily from './IpAddressFamily';
...
class IpSet {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('IpAddressFamily')) {
                obj['IpAddressFamily'] = ApiClient.convertToType(data['IpAddressFamily'], IpAddressFamily);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['IpFamily']) { // data not null
          String.validateJSON(data['IpFamily']);
        }
        ...
        if (data['IpAddressFamily']) { // data not null
          IpAddressFamily.validateJSON(data['IpAddressFamily']);
        }
 ...
 */
IpSet.prototype['IpFamily'] = undefined;

/**
 * @member {Array} IpAddresses
 */
IpSet.prototype['IpAddresses'] = undefined;

/**
 * @member {module:model/IpAddressFamily} IpAddressFamily
 */
IpSet.prototype['IpAddressFamily'] = undefined;
