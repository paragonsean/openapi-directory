...
/**
 * The ListCustomRoutingAcceleratorsResponse model module.
 * @module model/ListCustomRoutingAcceleratorsResponse
 * @version 2018-08-08
 */
class ListCustomRoutingAcceleratorsResponse {
    /**
     * Constructs a new <code>ListCustomRoutingAcceleratorsResponse</code>.
     * @alias module:model/ListCustomRoutingAcceleratorsResponse
     */
    constructor() { 
        
        ListCustomRoutingAcceleratorsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListCustomRoutingAcceleratorsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListCustomRoutingAcceleratorsResponse} obj Optional instance to populate.
     * @return {module:model/ListCustomRoutingAcceleratorsResponse} The populated <code>ListCustomRoutingAcceleratorsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListCustomRoutingAcceleratorsResponse();

            if (data.hasOwnProperty('Accelerators')) {
                obj['Accelerators'] = ApiClient.convertToType(data['Accelerators'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListCustomRoutingAcceleratorsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListCustomRoutingAcceleratorsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Accelerators`
        if (data['Accelerators']) { // data not null
          Array.validateJSON(data['Accelerators']);
        }
 ...
 */
ListCustomRoutingAcceleratorsResponse.prototype['Accelerators'] = undefined;

/**
 * @member {String} NextToken
 */
ListCustomRoutingAcceleratorsResponse.prototype['NextToken'] = undefined;
...
export default ListCustomRoutingAcceleratorsResponse;
