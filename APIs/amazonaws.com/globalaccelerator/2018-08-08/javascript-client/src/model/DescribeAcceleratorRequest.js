...
/**
 * The DescribeAcceleratorRequest model module.
 * @module model/DescribeAcceleratorRequest
 * @version 2018-08-08
 */
class DescribeAcceleratorRequest {
    /**
     * Constructs a new <code>DescribeAcceleratorRequest</code>.
     * @alias module:model/DescribeAcceleratorRequest
     * @param acceleratorArn {String} 
     */
    constructor(acceleratorArn) { 
        
        DescribeAcceleratorRequest.initialize(this, acceleratorArn);
    }
    ...
    /**
     * Constructs a <code>DescribeAcceleratorRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeAcceleratorRequest} obj Optional instance to populate.
     * @return {module:model/DescribeAcceleratorRequest} The populated <code>DescribeAcceleratorRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeAcceleratorRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeAcceleratorRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeAcceleratorRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeAcceleratorRequest.RequiredProperties) {
...
DescribeAcceleratorRequest.RequiredProperties = ["AcceleratorArn"];

/**
 * @member {String} AcceleratorArn
 */
DescribeAcceleratorRequest.prototype['AcceleratorArn'] = undefined;
...
export default DescribeAcceleratorRequest;
