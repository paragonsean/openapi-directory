...
/**
 * Gets or Sets IpAddressFamily
 */
@JsonAdapter(IpAddressFamily.Adapter.class)
public enum IpAddressFamily {
  ...
  public static IpAddressFamily fromValue(String value) {
    for (IpAddressFamily b : IpAddressFamily.values()) {
  ...
  public static class Adapter extends TypeAdapter<IpAddressFamily> {
    @Override
    public void write(final JsonWriter jsonWriter, final IpAddressFamily enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public IpAddressFamily read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return IpAddressFamily.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    IpAddressFamily.fromValue(value);
  }
}
