...
import org.openapitools.client.model.IpAddressFamily;
...
public class IpSet {
  ...
  public static final String SERIALIZED_NAME_IP_ADDRESS_FAMILY = "IpAddressFamily";
  @SerializedName(SERIALIZED_NAME_IP_ADDRESS_FAMILY)
  private IpAddressFamily ipAddressFamily;

  public IpSet() {
  }

  public IpSet ipFamily(String ipFamily) {
  ...
  public IpSet ipAddresses(List ipAddresses) {
  ...
  public IpSet ipAddressFamily(IpAddressFamily ipAddressFamily) {
  ...
  public boolean equals(Object o) {
    ...
    IpSet ipSet = (IpSet) o;
    return Objects.equals(this.ipFamily, ipSet.ipFamily) &&
        Objects.equals(this.ipAddresses, ipSet.ipAddresses) &&
        Objects.equals(this.ipAddressFamily, ipSet.ipAddressFamily);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ipFamily, ipAddresses, ipAddressFamily);
  }
  ...
  static {
    ...
    openapiFields.add("IpAddressFamily");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IpSet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IpSet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IpSet is not found in the empty JSON string", IpSet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IpSet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IpSet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `IpFamily`
      if (jsonObj.get("IpFamily") != null && !jsonObj.get("IpFamily").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("IpFamily"));
      }
      ...
      // validate the optional field `IpAddressFamily`
      if (jsonObj.get("IpAddressFamily") != null && !jsonObj.get("IpAddressFamily").isJsonNull()) {
        IpAddressFamily.validateJsonElement(jsonObj.get("IpAddressFamily"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IpSet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IpSet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IpSet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IpSet.class));

       return (TypeAdapter<T>) new TypeAdapter<IpSet>() {
           @Override
           public void write(JsonWriter out, IpSet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IpSet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IpSet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IpSet
   * @throws IOException if the JSON string is invalid with respect to IpSet
   */
  public static IpSet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IpSet.class);
  }

  /**
   * Convert an instance of IpSet to an JSON string
   *
   * @return JSON string
   */
