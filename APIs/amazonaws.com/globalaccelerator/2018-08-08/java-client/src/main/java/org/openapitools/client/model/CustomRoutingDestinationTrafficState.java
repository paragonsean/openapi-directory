...
/**
 * Gets or Sets CustomRoutingDestinationTrafficState
 */
@JsonAdapter(CustomRoutingDestinationTrafficState.Adapter.class)
public enum CustomRoutingDestinationTrafficState {
  ...
  CustomRoutingDestinationTrafficState(String value) {
    this.value = value;
  }
  ...
  public static CustomRoutingDestinationTrafficState fromValue(String value) {
    for (CustomRoutingDestinationTrafficState b : CustomRoutingDestinationTrafficState.values()) {
  ...
  public static class Adapter extends TypeAdapter<CustomRoutingDestinationTrafficState> {
    @Override
    public void write(final JsonWriter jsonWriter, final CustomRoutingDestinationTrafficState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CustomRoutingDestinationTrafficState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CustomRoutingDestinationTrafficState.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    CustomRoutingDestinationTrafficState.fromValue(value);
  }
}
