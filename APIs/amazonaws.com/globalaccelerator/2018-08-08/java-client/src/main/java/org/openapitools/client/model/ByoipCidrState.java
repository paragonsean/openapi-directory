...
/**
 * Gets or Sets ByoipCidrState
 */
@JsonAdapter(ByoipCidrState.Adapter.class)
public enum ByoipCidrState {
  ...
  public static ByoipCidrState fromValue(String value) {
    for (ByoipCidrState b : ByoipCidrState.values()) {
  ...
  public static class Adapter extends TypeAdapter<ByoipCidrState> {
    @Override
    public void write(final JsonWriter jsonWriter, final ByoipCidrState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ByoipCidrState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ByoipCidrState.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ByoipCidrState.fromValue(value);
  }
}
