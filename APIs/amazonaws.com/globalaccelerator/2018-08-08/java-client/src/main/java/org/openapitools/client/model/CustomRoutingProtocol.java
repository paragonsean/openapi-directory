...
/**
 * Gets or Sets CustomRoutingProtocol
 */
@JsonAdapter(CustomRoutingProtocol.Adapter.class)
public enum CustomRoutingProtocol {
  ...
  CustomRoutingProtocol(String value) {
    this.value = value;
  }
  ...
  public static CustomRoutingProtocol fromValue(String value) {
    for (CustomRoutingProtocol b : CustomRoutingProtocol.values()) {
  ...
  public static class Adapter extends TypeAdapter<CustomRoutingProtocol> {
    @Override
    public void write(final JsonWriter jsonWriter, final CustomRoutingProtocol enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CustomRoutingProtocol read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CustomRoutingProtocol.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    CustomRoutingProtocol.fromValue(value);
  }
}
