...
import org.openapitools.client.model.UpdateAcceleratorResponseAccelerator;
...
public class UpdateAcceleratorResponse {
  ...
  private UpdateAcceleratorResponseAccelerator accelerator;

  public UpdateAcceleratorResponse() {
  }

  public UpdateAcceleratorResponse accelerator(UpdateAcceleratorResponseAccelerator accelerator) {
  ...
  public UpdateAcceleratorResponseAccelerator getAccelerator() {
    return accelerator;
  }

  public void setAccelerator(UpdateAcceleratorResponseAccelerator accelerator) {
    this.accelerator = accelerator;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateAcceleratorResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAcceleratorResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateAcceleratorResponse is not found in the empty JSON string", UpdateAcceleratorResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateAcceleratorResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateAcceleratorResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Accelerator`
      if (jsonObj.get("Accelerator") != null && !jsonObj.get("Accelerator").isJsonNull()) {
        UpdateAcceleratorResponseAccelerator.validateJsonElement(jsonObj.get("Accelerator"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateAcceleratorResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateAcceleratorResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateAcceleratorResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateAcceleratorResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateAcceleratorResponse>() {
           @Override
           public void write(JsonWriter out, UpdateAcceleratorResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateAcceleratorResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateAcceleratorResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateAcceleratorResponse
   * @throws IOException if the JSON string is invalid with respect to UpdateAcceleratorResponse
   */
  public static UpdateAcceleratorResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateAcceleratorResponse.class);
  }

  /**
   * Convert an instance of UpdateAcceleratorResponse to an JSON string
   *
   * @return JSON string
   */
