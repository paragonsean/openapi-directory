...
public class ProvisionByoipCidrResponse {
  ...
  public ProvisionByoipCidrResponse byoipCidr(AdvertiseByoipCidrResponseByoipCidr byoipCidr) {
  ...
  public boolean equals(Object o) {
    ...
    ProvisionByoipCidrResponse provisionByoipCidrResponse = (ProvisionByoipCidrResponse) o;
    return Objects.equals(this.byoipCidr, provisionByoipCidrResponse.byoipCidr);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProvisionByoipCidrResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProvisionByoipCidrResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProvisionByoipCidrResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProvisionByoipCidrResponse is not found in the empty JSON string", ProvisionByoipCidrResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProvisionByoipCidrResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProvisionByoipCidrResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProvisionByoipCidrResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProvisionByoipCidrResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProvisionByoipCidrResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProvisionByoipCidrResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ProvisionByoipCidrResponse>() {
           @Override
           public void write(JsonWriter out, ProvisionByoipCidrResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProvisionByoipCidrResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProvisionByoipCidrResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProvisionByoipCidrResponse
   * @throws IOException if the JSON string is invalid with respect to ProvisionByoipCidrResponse
   */
  public static ProvisionByoipCidrResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProvisionByoipCidrResponse.class);
  }

  /**
   * Convert an instance of ProvisionByoipCidrResponse to an JSON string
   *
   * @return JSON string
   */
