...
/**
 * Gets or Sets ClientAffinity
 */
@JsonAdapter(ClientAffinity.Adapter.class)
public enum ClientAffinity {
  ...
  public static ClientAffinity fromValue(String value) {
    for (ClientAffinity b : ClientAffinity.values()) {
  ...
  public static class Adapter extends TypeAdapter<ClientAffinity> {
    @Override
    public void write(final JsonWriter jsonWriter, final ClientAffinity enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ClientAffinity read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ClientAffinity.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ClientAffinity.fromValue(value);
  }
}
