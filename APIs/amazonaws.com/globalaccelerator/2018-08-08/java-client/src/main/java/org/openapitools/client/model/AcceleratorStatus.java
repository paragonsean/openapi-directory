...
/**
 * Gets or Sets AcceleratorStatus
 */
@JsonAdapter(AcceleratorStatus.Adapter.class)
public enum AcceleratorStatus {
  ...
  AcceleratorStatus(String value) {
    this.value = value;
  }
  ...
  public static AcceleratorStatus fromValue(String value) {
    for (AcceleratorStatus b : AcceleratorStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<AcceleratorStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final AcceleratorStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AcceleratorStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AcceleratorStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AcceleratorStatus.fromValue(value);
  }
}
