...
/**
 * Gets or Sets CustomRoutingAcceleratorStatus
 */
@JsonAdapter(CustomRoutingAcceleratorStatus.Adapter.class)
public enum CustomRoutingAcceleratorStatus {
  ...
  CustomRoutingAcceleratorStatus(String value) {
    this.value = value;
  }
  ...
  public static CustomRoutingAcceleratorStatus fromValue(String value) {
    for (CustomRoutingAcceleratorStatus b : CustomRoutingAcceleratorStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<CustomRoutingAcceleratorStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final CustomRoutingAcceleratorStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CustomRoutingAcceleratorStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CustomRoutingAcceleratorStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    CustomRoutingAcceleratorStatus.fromValue(value);
  }
}
