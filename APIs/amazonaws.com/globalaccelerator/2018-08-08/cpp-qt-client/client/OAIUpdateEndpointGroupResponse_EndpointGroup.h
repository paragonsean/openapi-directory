...
/*
 * OAIUpdateEndpointGroupResponse_EndpointGroup.h
 *
 * 
 */

#ifndef OAIUpdateEndpointGroupResponse_EndpointGroup_H
#define OAIUpdateEndpointGroupResponse_EndpointGroup_H
...
class OAIUpdateEndpointGroupResponse_EndpointGroup : public OAIObject {
public:
    OAIUpdateEndpointGroupResponse_EndpointGroup();
    OAIUpdateEndpointGroupResponse_EndpointGroup(QString json);
    ~OAIUpdateEndpointGroupResponse_EndpointGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateEndpointGroupResponse_EndpointGroup)

#endif // OAIUpdateEndpointGroupResponse_EndpointGroup_H
