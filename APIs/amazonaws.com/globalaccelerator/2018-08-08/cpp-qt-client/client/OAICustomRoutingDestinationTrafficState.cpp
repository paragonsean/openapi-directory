...
OAICustomRoutingDestinationTrafficState::OAICustomRoutingDestinationTrafficState(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICustomRoutingDestinationTrafficState::OAICustomRoutingDestinationTrafficState() {
    this->initializeModel();
}

OAICustomRoutingDestinationTrafficState::~OAICustomRoutingDestinationTrafficState() {}

void OAICustomRoutingDestinationTrafficState::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAICustomRoutingDestinationTrafficState::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAICustomRoutingDestinationTrafficState::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ALLOW", Qt::CaseInsensitive) == 0) {
        m_value = eOAICustomRoutingDestinationTrafficState::ALLOW;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DENY", Qt::CaseInsensitive) == 0) {
        m_value = eOAICustomRoutingDestinationTrafficState::DENY;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAICustomRoutingDestinationTrafficState::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAICustomRoutingDestinationTrafficState::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAICustomRoutingDestinationTrafficState::ALLOW:
            val = "ALLOW";
            break;
        case eOAICustomRoutingDestinationTrafficState::DENY:
            val = "DENY";
            break;
        default:
            break;
...
QJsonValue OAICustomRoutingDestinationTrafficState::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAICustomRoutingDestinationTrafficState::eOAICustomRoutingDestinationTrafficState OAICustomRoutingDestinationTrafficState::getValue() const {
    return m_value;
}

void OAICustomRoutingDestinationTrafficState::setValue(const OAICustomRoutingDestinationTrafficState::eOAICustomRoutingDestinationTrafficState& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAICustomRoutingDestinationTrafficState::isSet() const {
    
    return m_value_isSet;
}

bool OAICustomRoutingDestinationTrafficState::isValid() const {
