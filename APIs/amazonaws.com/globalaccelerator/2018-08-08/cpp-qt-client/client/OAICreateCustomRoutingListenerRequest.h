...
/*
 * OAICreateCustomRoutingListenerRequest.h
 *
 * 
 */

#ifndef OAICreateCustomRoutingListenerRequest_H
#define OAICreateCustomRoutingListenerRequest_H
...
class OAICreateCustomRoutingListenerRequest : public OAIObject {
public:
    OAICreateCustomRoutingListenerRequest();
    OAICreateCustomRoutingListenerRequest(QString json);
    ~OAICreateCustomRoutingListenerRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCustomRoutingListenerRequest)

#endif // OAICreateCustomRoutingListenerRequest_H
