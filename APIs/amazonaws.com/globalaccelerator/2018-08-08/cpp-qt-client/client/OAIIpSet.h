...
public:
    ...
    OAIIpAddressFamily getIpAddressFamily() const;
    void setIpAddressFamily(const OAIIpAddressFamily &ip_address_family);
    bool is_ip_address_family_Set() const;
    bool is_ip_address_family_Valid() const;
...
private:
    ...
    OAIIpAddressFamily m_ip_address_family;
    bool m_ip_address_family_isSet;
    bool m_ip_address_family_isValid;
};
