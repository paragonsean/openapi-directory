...
#ifndef OAIEndpointGroup_H
#define OAIEndpointGroup_H
...
class OAIEndpointGroup : public OAIObject {
public:
    OAIEndpointGroup();
    OAIEndpointGroup(QString json);
    ~OAIEndpointGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEndpointGroup)

#endif // OAIEndpointGroup_H
