...
OAIDescribeCustomRoutingListenerResponse::OAIDescribeCustomRoutingListenerResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeCustomRoutingListenerResponse::OAIDescribeCustomRoutingListenerResponse() {
    this->initializeModel();
}

OAIDescribeCustomRoutingListenerResponse::~OAIDescribeCustomRoutingListenerResponse() {}

void OAIDescribeCustomRoutingListenerResponse::initializeModel() {

    m_listener_isSet = false;
    m_listener_isValid = false;
}

void OAIDescribeCustomRoutingListenerResponse::fromJson(QString jsonString) {
...
void OAIDescribeCustomRoutingListenerResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeCustomRoutingListenerResponse::asJson() const {
...
QJsonObject OAIDescribeCustomRoutingListenerResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_listener.isSet()) {
...
OAIDescribeCustomRoutingListenerResponse_Listener OAIDescribeCustomRoutingListenerResponse::getListener() const {
    return m_listener;
}
void OAIDescribeCustomRoutingListenerResponse::setListener(const OAIDescribeCustomRoutingListenerResponse_Listener &listener) {
    m_listener = listener;
    m_listener_isSet = true;
}

bool OAIDescribeCustomRoutingListenerResponse::is_listener_Set() const{
    return m_listener_isSet;
}

bool OAIDescribeCustomRoutingListenerResponse::is_listener_Valid() const{
    return m_listener_isValid;
}

bool OAIDescribeCustomRoutingListenerResponse::isSet() const {
...
bool OAIDescribeCustomRoutingListenerResponse::isValid() const {
