...
/*
 * OAIDescribeAcceleratorAttributesRequest.h
 *
 * 
 */

#ifndef OAIDescribeAcceleratorAttributesRequest_H
#define OAIDescribeAcceleratorAttributesRequest_H
...
class OAIDescribeAcceleratorAttributesRequest : public OAIObject {
public:
    OAIDescribeAcceleratorAttributesRequest();
    OAIDescribeAcceleratorAttributesRequest(QString json);
    ~OAIDescribeAcceleratorAttributesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAcceleratorAttributesRequest)

#endif // OAIDescribeAcceleratorAttributesRequest_H
