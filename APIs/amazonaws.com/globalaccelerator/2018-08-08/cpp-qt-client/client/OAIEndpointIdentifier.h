...
class OAIEndpointIdentifier : public OAIObject {
public:
    OAIEndpointIdentifier();
    OAIEndpointIdentifier(QString json);
    ~OAIEndpointIdentifier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEndpointIdentifier)

#endif // OAIEndpointIdentifier_H
