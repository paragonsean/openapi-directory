...
/*
 * OAIDescribeAcceleratorResponse.h
 *
 * 
 */

#ifndef OAIDescribeAcceleratorResponse_H
#define OAIDescribeAcceleratorResponse_H
...
namespace OpenAPI {
class OAIDescribeAcceleratorResponse_Accelerator;

class OAIDescribeAcceleratorResponse : public OAIObject {
public:
    OAIDescribeAcceleratorResponse();
    OAIDescribeAcceleratorResponse(QString json);
    ~OAIDescribeAcceleratorResponse() override;
    ...
    OAIDescribeAcceleratorResponse_Accelerator getAccelerator() const;
    void setAccelerator(const OAIDescribeAcceleratorResponse_Accelerator &accelerator);
...
private:
    ...
    OAIDescribeAcceleratorResponse_Accelerator m_accelerator;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAcceleratorResponse)

#endif // OAIDescribeAcceleratorResponse_H
