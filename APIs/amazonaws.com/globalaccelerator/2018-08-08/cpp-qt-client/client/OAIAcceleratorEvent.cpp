...
OAIAcceleratorEvent::OAIAcceleratorEvent(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAcceleratorEvent::OAIAcceleratorEvent() {
    this->initializeModel();
}

OAIAcceleratorEvent::~OAIAcceleratorEvent() {}

void OAIAcceleratorEvent::initializeModel() {
...
void OAIAcceleratorEvent::fromJson(QString jsonString) {
...
void OAIAcceleratorEvent::fromJsonObject(QJsonObject json) {
...
QString OAIAcceleratorEvent::asJson() const {
...
QJsonObject OAIAcceleratorEvent::asJsonObject() const {
    QJsonObject obj;
    if (m_message_isSet) {
...
QString OAIAcceleratorEvent::getMessage() const {
    return m_message;
}
void OAIAcceleratorEvent::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIAcceleratorEvent::is_message_Set() const{
    return m_message_isSet;
}

bool OAIAcceleratorEvent::is_message_Valid() const{
    return m_message_isValid;
}

QDateTime OAIAcceleratorEvent::getTimestamp() const {
    return m_timestamp;
}
void OAIAcceleratorEvent::setTimestamp(const QDateTime &timestamp) {
    m_timestamp = timestamp;
    m_timestamp_isSet = true;
}

bool OAIAcceleratorEvent::is_timestamp_Set() const{
    return m_timestamp_isSet;
}

bool OAIAcceleratorEvent::is_timestamp_Valid() const{
    return m_timestamp_isValid;
}

bool OAIAcceleratorEvent::isSet() const {
...
bool OAIAcceleratorEvent::isValid() const {
