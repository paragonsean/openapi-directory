...
OAIAcceleratorStatus::OAIAcceleratorStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAcceleratorStatus::OAIAcceleratorStatus() {
    this->initializeModel();
}

OAIAcceleratorStatus::~OAIAcceleratorStatus() {}

void OAIAcceleratorStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIAcceleratorStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIAcceleratorStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("DEPLOYED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAcceleratorStatus::DEPLOYED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("IN_PROGRESS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAcceleratorStatus::IN_PROGRESS;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIAcceleratorStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIAcceleratorStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIAcceleratorStatus::DEPLOYED:
            val = "DEPLOYED";
            break;
        case eOAIAcceleratorStatus::IN_PROGRESS:
            val = "IN_PROGRESS";
            break;
        default:
            break;
...
QJsonValue OAIAcceleratorStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIAcceleratorStatus::eOAIAcceleratorStatus OAIAcceleratorStatus::getValue() const {
    return m_value;
}

void OAIAcceleratorStatus::setValue(const OAIAcceleratorStatus::eOAIAcceleratorStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIAcceleratorStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIAcceleratorStatus::isValid() const {
