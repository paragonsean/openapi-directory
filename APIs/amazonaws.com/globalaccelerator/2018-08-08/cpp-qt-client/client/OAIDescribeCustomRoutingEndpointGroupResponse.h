...
/*
 * OAIDescribeCustomRoutingEndpointGroupResponse.h
 *
 * 
 */

#ifndef OAIDescribeCustomRoutingEndpointGroupResponse_H
#define OAIDescribeCustomRoutingEndpointGroupResponse_H
...
namespace OpenAPI {
class OAIDescribeCustomRoutingEndpointGroupResponse_EndpointGroup;

class OAIDescribeCustomRoutingEndpointGroupResponse : public OAIObject {
public:
    OAIDescribeCustomRoutingEndpointGroupResponse();
    OAIDescribeCustomRoutingEndpointGroupResponse(QString json);
    ~OAIDescribeCustomRoutingEndpointGroupResponse() override;
    ...
    OAIDescribeCustomRoutingEndpointGroupResponse_EndpointGroup getEndpointGroup() const;
    void setEndpointGroup(const OAIDescribeCustomRoutingEndpointGroupResponse_EndpointGroup &endpoint_group);
    bool is_endpoint_group_Set() const;
    bool is_endpoint_group_Valid() const;
...
private:
    ...
    OAIDescribeCustomRoutingEndpointGroupResponse_EndpointGroup m_endpoint_group;
    bool m_endpoint_group_isSet;
    bool m_endpoint_group_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCustomRoutingEndpointGroupResponse)

#endif // OAIDescribeCustomRoutingEndpointGroupResponse_H
