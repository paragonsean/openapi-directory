...
OAIDeprovisionByoipCidrResponse::OAIDeprovisionByoipCidrResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeprovisionByoipCidrResponse::OAIDeprovisionByoipCidrResponse() {
    this->initializeModel();
}

OAIDeprovisionByoipCidrResponse::~OAIDeprovisionByoipCidrResponse() {}

void OAIDeprovisionByoipCidrResponse::initializeModel() {

    m_byoip_cidr_isSet = false;
    m_byoip_cidr_isValid = false;
}

void OAIDeprovisionByoipCidrResponse::fromJson(QString jsonString) {
...
void OAIDeprovisionByoipCidrResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDeprovisionByoipCidrResponse::asJson() const {
...
QJsonObject OAIDeprovisionByoipCidrResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIAdvertiseByoipCidrResponse_ByoipCidr OAIDeprovisionByoipCidrResponse::getByoipCidr() const {
    return m_byoip_cidr;
}
void OAIDeprovisionByoipCidrResponse::setByoipCidr(const OAIAdvertiseByoipCidrResponse_ByoipCidr &byoip_cidr) {
    m_byoip_cidr = byoip_cidr;
    m_byoip_cidr_isSet = true;
}

bool OAIDeprovisionByoipCidrResponse::is_byoip_cidr_Set() const{
    return m_byoip_cidr_isSet;
}

bool OAIDeprovisionByoipCidrResponse::is_byoip_cidr_Valid() const{
    return m_byoip_cidr_isValid;
}

bool OAIDeprovisionByoipCidrResponse::isSet() const {
...
bool OAIDeprovisionByoipCidrResponse::isValid() const {
