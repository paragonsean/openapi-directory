...
/*
 * OAIDescribeListenerResponse_Listener.h
 *
 * 
 */

#ifndef OAIDescribeListenerResponse_Listener_H
#define OAIDescribeListenerResponse_Listener_H
...
class OAIDescribeListenerResponse_Listener : public OAIObject {
public:
    OAIDescribeListenerResponse_Listener();
    OAIDescribeListenerResponse_Listener(QString json);
    ~OAIDescribeListenerResponse_Listener() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeListenerResponse_Listener)

#endif // OAIDescribeListenerResponse_Listener_H
