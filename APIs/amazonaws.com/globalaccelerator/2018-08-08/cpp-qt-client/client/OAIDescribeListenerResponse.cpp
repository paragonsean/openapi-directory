...
OAIDescribeListenerResponse::OAIDescribeListenerResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeListenerResponse::OAIDescribeListenerResponse() {
    this->initializeModel();
}

OAIDescribeListenerResponse::~OAIDescribeListenerResponse() {}

void OAIDescribeListenerResponse::initializeModel() {

    m_listener_isSet = false;
    m_listener_isValid = false;
}

void OAIDescribeListenerResponse::fromJson(QString jsonString) {
...
void OAIDescribeListenerResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeListenerResponse::asJson() const {
...
QJsonObject OAIDescribeListenerResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_listener.isSet()) {
...
OAIDescribeListenerResponse_Listener OAIDescribeListenerResponse::getListener() const {
    return m_listener;
}
void OAIDescribeListenerResponse::setListener(const OAIDescribeListenerResponse_Listener &listener) {
    m_listener = listener;
    m_listener_isSet = true;
}

bool OAIDescribeListenerResponse::is_listener_Set() const{
    return m_listener_isSet;
}

bool OAIDescribeListenerResponse::is_listener_Valid() const{
    return m_listener_isValid;
}

bool OAIDescribeListenerResponse::isSet() const {
...
bool OAIDescribeListenerResponse::isValid() const {
