...
/*
 * OAIListCustomRoutingAcceleratorsResponse.h
 *
 * 
 */

#ifndef OAIListCustomRoutingAcceleratorsResponse_H
#define OAIListCustomRoutingAcceleratorsResponse_H
...
class OAIListCustomRoutingAcceleratorsResponse : public OAIObject {
public:
    OAIListCustomRoutingAcceleratorsResponse();
    OAIListCustomRoutingAcceleratorsResponse(QString json);
    ~OAIListCustomRoutingAcceleratorsResponse() override;
    ...
    QList getAccelerators() const;
    void setAccelerators(const QList &accelerators);
...
Q_DECLARE_METATYPE(OpenAPI::OAIListCustomRoutingAcceleratorsResponse)

#endif // OAIListCustomRoutingAcceleratorsResponse_H
