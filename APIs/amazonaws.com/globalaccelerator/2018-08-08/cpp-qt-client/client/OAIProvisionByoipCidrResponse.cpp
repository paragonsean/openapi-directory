...
OAIProvisionByoipCidrResponse::OAIProvisionByoipCidrResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProvisionByoipCidrResponse::OAIProvisionByoipCidrResponse() {
    this->initializeModel();
}

OAIProvisionByoipCidrResponse::~OAIProvisionByoipCidrResponse() {}

void OAIProvisionByoipCidrResponse::initializeModel() {

    m_byoip_cidr_isSet = false;
    m_byoip_cidr_isValid = false;
}

void OAIProvisionByoipCidrResponse::fromJson(QString jsonString) {
...
void OAIProvisionByoipCidrResponse::fromJsonObject(QJsonObject json) {

    m_byoip_cidr_isValid = ::OpenAPI::fromJsonValue(m_byoip_cidr, json[QString("ByoipCidr")]);
    m_byoip_cidr_isSet = !json[QString("ByoipCidr")].isNull() && m_byoip_cidr_isValid;
}

QString OAIProvisionByoipCidrResponse::asJson() const {
...
QJsonObject OAIProvisionByoipCidrResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_byoip_cidr.isSet()) {
        obj.insert(QString("ByoipCidr"), ::OpenAPI::toJsonValue(m_byoip_cidr));
    }
    return obj;
}

OAIAdvertiseByoipCidrResponse_ByoipCidr OAIProvisionByoipCidrResponse::getByoipCidr() const {
    return m_byoip_cidr;
}
void OAIProvisionByoipCidrResponse::setByoipCidr(const OAIAdvertiseByoipCidrResponse_ByoipCidr &byoip_cidr) {
    m_byoip_cidr = byoip_cidr;
    m_byoip_cidr_isSet = true;
}

bool OAIProvisionByoipCidrResponse::is_byoip_cidr_Set() const{
    return m_byoip_cidr_isSet;
}

bool OAIProvisionByoipCidrResponse::is_byoip_cidr_Valid() const{
    return m_byoip_cidr_isValid;
}

bool OAIProvisionByoipCidrResponse::isSet() const {
...
bool OAIProvisionByoipCidrResponse::isValid() const {
