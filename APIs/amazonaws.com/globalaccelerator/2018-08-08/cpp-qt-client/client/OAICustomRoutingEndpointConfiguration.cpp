...
#include "OAICustomRoutingEndpointConfiguration.h"
...
OAICustomRoutingEndpointConfiguration::OAICustomRoutingEndpointConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICustomRoutingEndpointConfiguration::OAICustomRoutingEndpointConfiguration() {
    this->initializeModel();
}

OAICustomRoutingEndpointConfiguration::~OAICustomRoutingEndpointConfiguration() {}

void OAICustomRoutingEndpointConfiguration::initializeModel() {

    m_endpoint_id_isSet = false;
    m_endpoint_id_isValid = false;
}

void OAICustomRoutingEndpointConfiguration::fromJson(QString jsonString) {
...
void OAICustomRoutingEndpointConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAICustomRoutingEndpointConfiguration::asJson() const {
...
QJsonObject OAICustomRoutingEndpointConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAICustomRoutingEndpointConfiguration::getEndpointId() const {
    return m_endpoint_id;
}
void OAICustomRoutingEndpointConfiguration::setEndpointId(const QString &endpoint_id) {
    m_endpoint_id = endpoint_id;
    m_endpoint_id_isSet = true;
}

bool OAICustomRoutingEndpointConfiguration::is_endpoint_id_Set() const{
    return m_endpoint_id_isSet;
}

bool OAICustomRoutingEndpointConfiguration::is_endpoint_id_Valid() const{
    return m_endpoint_id_isValid;
}

bool OAICustomRoutingEndpointConfiguration::isSet() const {
...
bool OAICustomRoutingEndpointConfiguration::isValid() const {
