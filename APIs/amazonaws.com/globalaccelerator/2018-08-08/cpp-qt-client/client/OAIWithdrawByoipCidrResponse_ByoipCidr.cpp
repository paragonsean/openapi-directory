...
#include "OAIWithdrawByoipCidrResponse_ByoipCidr.h"
...
OAIWithdrawByoipCidrResponse_ByoipCidr::OAIWithdrawByoipCidrResponse_ByoipCidr(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWithdrawByoipCidrResponse_ByoipCidr::OAIWithdrawByoipCidrResponse_ByoipCidr() {
    this->initializeModel();
}

OAIWithdrawByoipCidrResponse_ByoipCidr::~OAIWithdrawByoipCidrResponse_ByoipCidr() {}

void OAIWithdrawByoipCidrResponse_ByoipCidr::initializeModel() {
...
void OAIWithdrawByoipCidrResponse_ByoipCidr::fromJson(QString jsonString) {
...
void OAIWithdrawByoipCidrResponse_ByoipCidr::fromJsonObject(QJsonObject json) {
...
QString OAIWithdrawByoipCidrResponse_ByoipCidr::asJson() const {
...
QJsonObject OAIWithdrawByoipCidrResponse_ByoipCidr::asJsonObject() const {
    QJsonObject obj;
    if (m_cidr_isSet) {
...
QString OAIWithdrawByoipCidrResponse_ByoipCidr::getCidr() const {
    return m_cidr;
}
void OAIWithdrawByoipCidrResponse_ByoipCidr::setCidr(const QString &cidr) {
    m_cidr = cidr;
    m_cidr_isSet = true;
}

bool OAIWithdrawByoipCidrResponse_ByoipCidr::is_cidr_Set() const{
    return m_cidr_isSet;
}

bool OAIWithdrawByoipCidrResponse_ByoipCidr::is_cidr_Valid() const{
    return m_cidr_isValid;
}

OAIByoipCidrState OAIWithdrawByoipCidrResponse_ByoipCidr::getState() const {
    return m_state;
}
void OAIWithdrawByoipCidrResponse_ByoipCidr::setState(const OAIByoipCidrState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIWithdrawByoipCidrResponse_ByoipCidr::is_state_Set() const{
    return m_state_isSet;
}

bool OAIWithdrawByoipCidrResponse_ByoipCidr::is_state_Valid() const{
    return m_state_isValid;
}

QList OAIWithdrawByoipCidrResponse_ByoipCidr::getEvents() const {
    return m_events;
}
void OAIWithdrawByoipCidrResponse_ByoipCidr::setEvents(const QList &events) {
    m_events = events;
    m_events_isSet = true;
}

bool OAIWithdrawByoipCidrResponse_ByoipCidr::is_events_Set() const{
    return m_events_isSet;
}

bool OAIWithdrawByoipCidrResponse_ByoipCidr::is_events_Valid() const{
    return m_events_isValid;
}

bool OAIWithdrawByoipCidrResponse_ByoipCidr::isSet() const {
...
bool OAIWithdrawByoipCidrResponse_ByoipCidr::isValid() const {
