...
OAIUpdateCustomRoutingAcceleratorResponse::OAIUpdateCustomRoutingAcceleratorResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateCustomRoutingAcceleratorResponse::OAIUpdateCustomRoutingAcceleratorResponse() {
    this->initializeModel();
}

OAIUpdateCustomRoutingAcceleratorResponse::~OAIUpdateCustomRoutingAcceleratorResponse() {}

void OAIUpdateCustomRoutingAcceleratorResponse::initializeModel() {

    m_accelerator_isSet = false;
    m_accelerator_isValid = false;
}

void OAIUpdateCustomRoutingAcceleratorResponse::fromJson(QString jsonString) {
...
void OAIUpdateCustomRoutingAcceleratorResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateCustomRoutingAcceleratorResponse::asJson() const {
...
QJsonObject OAIUpdateCustomRoutingAcceleratorResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdateCustomRoutingAcceleratorResponse_Accelerator OAIUpdateCustomRoutingAcceleratorResponse::getAccelerator() const {
    return m_accelerator;
}
void OAIUpdateCustomRoutingAcceleratorResponse::setAccelerator(const OAIUpdateCustomRoutingAcceleratorResponse_Accelerator &accelerator) {
    m_accelerator = accelerator;
    m_accelerator_isSet = true;
}

bool OAIUpdateCustomRoutingAcceleratorResponse::is_accelerator_Set() const{
    return m_accelerator_isSet;
}

bool OAIUpdateCustomRoutingAcceleratorResponse::is_accelerator_Valid() const{
    return m_accelerator_isValid;
}

bool OAIUpdateCustomRoutingAcceleratorResponse::isSet() const {
...
bool OAIUpdateCustomRoutingAcceleratorResponse::isValid() const {
