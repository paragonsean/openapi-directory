...
/*
 * OAIListCustomRoutingPortMappingsByDestinationRequest.h
 *
 * 
 */

#ifndef OAIListCustomRoutingPortMappingsByDestinationRequest_H
#define OAIListCustomRoutingPortMappingsByDestinationRequest_H
...
class OAIListCustomRoutingPortMappingsByDestinationRequest : public OAIObject {
public:
    OAIListCustomRoutingPortMappingsByDestinationRequest();
    OAIListCustomRoutingPortMappingsByDestinationRequest(QString json);
    ~OAIListCustomRoutingPortMappingsByDestinationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListCustomRoutingPortMappingsByDestinationRequest)

#endif // OAIListCustomRoutingPortMappingsByDestinationRequest_H
