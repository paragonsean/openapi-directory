...
/*
 * OAIListByoipCidrsResponse.h
 *
 * 
 */

#ifndef OAIListByoipCidrsResponse_H
#define OAIListByoipCidrsResponse_H
...
class OAIListByoipCidrsResponse : public OAIObject {
public:
    OAIListByoipCidrsResponse();
    OAIListByoipCidrsResponse(QString json);
    ~OAIListByoipCidrsResponse() override;
    ...
    QList getByoipCidrs() const;
    void setByoipCidrs(const QList &byoip_cidrs);
    bool is_byoip_cidrs_Set() const;
    bool is_byoip_cidrs_Valid() const;
...
private:
    ...
    QList m_byoip_cidrs;
    bool m_byoip_cidrs_isSet;
    bool m_byoip_cidrs_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListByoipCidrsResponse)

#endif // OAIListByoipCidrsResponse_H
