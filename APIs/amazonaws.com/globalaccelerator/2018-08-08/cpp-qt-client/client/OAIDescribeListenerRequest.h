...
/*
 * OAIDescribeListenerRequest.h
 *
 * 
 */

#ifndef OAIDescribeListenerRequest_H
#define OAIDescribeListenerRequest_H
...
class OAIDescribeListenerRequest : public OAIObject {
public:
    OAIDescribeListenerRequest();
    OAIDescribeListenerRequest(QString json);
    ~OAIDescribeListenerRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeListenerRequest)

#endif // OAIDescribeListenerRequest_H
