...
OAIUpdateAcceleratorResponse::OAIUpdateAcceleratorResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateAcceleratorResponse::OAIUpdateAcceleratorResponse() {
    this->initializeModel();
}

OAIUpdateAcceleratorResponse::~OAIUpdateAcceleratorResponse() {}

void OAIUpdateAcceleratorResponse::initializeModel() {

    m_accelerator_isSet = false;
    m_accelerator_isValid = false;
}

void OAIUpdateAcceleratorResponse::fromJson(QString jsonString) {
...
void OAIUpdateAcceleratorResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateAcceleratorResponse::asJson() const {
...
QJsonObject OAIUpdateAcceleratorResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdateAcceleratorResponse_Accelerator OAIUpdateAcceleratorResponse::getAccelerator() const {
    return m_accelerator;
}
void OAIUpdateAcceleratorResponse::setAccelerator(const OAIUpdateAcceleratorResponse_Accelerator &accelerator) {
    m_accelerator = accelerator;
    m_accelerator_isSet = true;
}

bool OAIUpdateAcceleratorResponse::is_accelerator_Set() const{
    return m_accelerator_isSet;
}

bool OAIUpdateAcceleratorResponse::is_accelerator_Valid() const{
    return m_accelerator_isValid;
}

bool OAIUpdateAcceleratorResponse::isSet() const {
...
bool OAIUpdateAcceleratorResponse::isValid() const {
