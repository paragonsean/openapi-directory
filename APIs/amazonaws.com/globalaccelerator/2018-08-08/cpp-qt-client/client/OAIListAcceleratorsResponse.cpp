...
OAIListAcceleratorsResponse::OAIListAcceleratorsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListAcceleratorsResponse::OAIListAcceleratorsResponse() {
    this->initializeModel();
}

OAIListAcceleratorsResponse::~OAIListAcceleratorsResponse() {}

void OAIListAcceleratorsResponse::initializeModel() {
...
void OAIListAcceleratorsResponse::fromJson(QString jsonString) {
...
void OAIListAcceleratorsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListAcceleratorsResponse::asJson() const {
...
QJsonObject OAIListAcceleratorsResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIListAcceleratorsResponse::getAccelerators() const {
    return m_accelerators;
}
void OAIListAcceleratorsResponse::setAccelerators(const QList &accelerators) {
    m_accelerators = accelerators;
    m_accelerators_isSet = true;
}

bool OAIListAcceleratorsResponse::is_accelerators_Set() const{
    return m_accelerators_isSet;
}

bool OAIListAcceleratorsResponse::is_accelerators_Valid() const{
    return m_accelerators_isValid;
}

QString OAIListAcceleratorsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListAcceleratorsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListAcceleratorsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListAcceleratorsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListAcceleratorsResponse::isSet() const {
...
bool OAIListAcceleratorsResponse::isValid() const {
