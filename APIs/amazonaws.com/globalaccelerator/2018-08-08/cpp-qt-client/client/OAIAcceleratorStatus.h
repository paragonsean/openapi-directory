...
/*
 * OAIAcceleratorStatus.h
 *
 * 
 */

#ifndef OAIAcceleratorStatus_H
#define OAIAcceleratorStatus_H
...
class OAIAcceleratorStatus : public OAIEnum {
public:
    OAIAcceleratorStatus();
    OAIAcceleratorStatus(QString json);
    ~OAIAcceleratorStatus() override;
    ...
    enum class eOAIAcceleratorStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        DEPLOYED, 
        IN_PROGRESS
    };
    OAIAcceleratorStatus::eOAIAcceleratorStatus getValue() const;
    void setValue(const OAIAcceleratorStatus::eOAIAcceleratorStatus& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAcceleratorStatus)

#endif // OAIAcceleratorStatus_H
