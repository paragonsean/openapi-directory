...
QList OAIListListenersResponse::getListeners() const {
    return m_listeners;
}
void OAIListListenersResponse::setListeners(const QList &listeners) {
    m_listeners = listeners;
    m_listeners_isSet = true;
}

bool OAIListListenersResponse::is_listeners_Set() const{
    return m_listeners_isSet;
}

bool OAIListListenersResponse::is_listeners_Valid() const{
