...
OAIWithdrawByoipCidrResponse::OAIWithdrawByoipCidrResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWithdrawByoipCidrResponse::OAIWithdrawByoipCidrResponse() {
    this->initializeModel();
}

OAIWithdrawByoipCidrResponse::~OAIWithdrawByoipCidrResponse() {}

void OAIWithdrawByoipCidrResponse::initializeModel() {

    m_byoip_cidr_isSet = false;
    m_byoip_cidr_isValid = false;
}

void OAIWithdrawByoipCidrResponse::fromJson(QString jsonString) {
...
void OAIWithdrawByoipCidrResponse::fromJsonObject(QJsonObject json) {
...
QString OAIWithdrawByoipCidrResponse::asJson() const {
...
QJsonObject OAIWithdrawByoipCidrResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIWithdrawByoipCidrResponse_ByoipCidr OAIWithdrawByoipCidrResponse::getByoipCidr() const {
    return m_byoip_cidr;
}
void OAIWithdrawByoipCidrResponse::setByoipCidr(const OAIWithdrawByoipCidrResponse_ByoipCidr &byoip_cidr) {
    m_byoip_cidr = byoip_cidr;
    m_byoip_cidr_isSet = true;
}

bool OAIWithdrawByoipCidrResponse::is_byoip_cidr_Set() const{
    return m_byoip_cidr_isSet;
}

bool OAIWithdrawByoipCidrResponse::is_byoip_cidr_Valid() const{
    return m_byoip_cidr_isValid;
}

bool OAIWithdrawByoipCidrResponse::isSet() const {
...
bool OAIWithdrawByoipCidrResponse::isValid() const {
