...
OAIWithdrawByoipCidrRequest::OAIWithdrawByoipCidrRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWithdrawByoipCidrRequest::OAIWithdrawByoipCidrRequest() {
    this->initializeModel();
}

OAIWithdrawByoipCidrRequest::~OAIWithdrawByoipCidrRequest() {}

void OAIWithdrawByoipCidrRequest::initializeModel() {

    m_cidr_isSet = false;
    m_cidr_isValid = false;
}

void OAIWithdrawByoipCidrRequest::fromJson(QString jsonString) {
...
QJsonObject OAIWithdrawByoipCidrRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_cidr_isSet) {
...
QString OAIWithdrawByoipCidrRequest::getCidr() const {
    return m_cidr;
}
void OAIWithdrawByoipCidrRequest::setCidr(const QString &cidr) {
    m_cidr = cidr;
    m_cidr_isSet = true;
}

bool OAIWithdrawByoipCidrRequest::is_cidr_Set() const{
    return m_cidr_isSet;
}

bool OAIWithdrawByoipCidrRequest::is_cidr_Valid() const{
    return m_cidr_isValid;
}

bool OAIWithdrawByoipCidrRequest::isSet() const {
...
bool OAIWithdrawByoipCidrRequest::isValid() const {
