...
/*
 * OAICreateListenerResponse.h
 *
 * 
 */

#ifndef OAICreateListenerResponse_H
#define OAICreateListenerResponse_H

#include <QJsonObject>

#include "OAICreateListenerResponse_Listener.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAICreateListenerResponse_Listener;

class OAICreateListenerResponse : public OAIObject {
public:
    OAICreateListenerResponse();
    OAICreateListenerResponse(QString json);
    ~OAICreateListenerResponse() override;
    ...
    OAICreateListenerResponse_Listener getListener() const;
    void setListener(const OAICreateListenerResponse_Listener &listener);
...
private:
    ...
    OAICreateListenerResponse_Listener m_listener;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateListenerResponse)

#endif // OAICreateListenerResponse_H
