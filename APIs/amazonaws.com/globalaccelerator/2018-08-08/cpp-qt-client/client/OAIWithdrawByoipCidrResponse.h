...
/*
 * OAIWithdrawByoipCidrResponse.h
 *
 * 
 */

#ifndef OAIWithdrawByoipCidrResponse_H
#define OAIWithdrawByoipCidrResponse_H
...
namespace OpenAPI {
class OAIWithdrawByoipCidrResponse_ByoipCidr;

class OAIWithdrawByoipCidrResponse : public OAIObject {
public:
    OAIWithdrawByoipCidrResponse();
    OAIWithdrawByoipCidrResponse(QString json);
    ~OAIWithdrawByoipCidrResponse() override;
    ...
    OAIWithdrawByoipCidrResponse_ByoipCidr getByoipCidr() const;
    void setByoipCidr(const OAIWithdrawByoipCidrResponse_ByoipCidr &byoip_cidr);
    bool is_byoip_cidr_Set() const;
    bool is_byoip_cidr_Valid() const;
...
private:
    ...
    OAIWithdrawByoipCidrResponse_ByoipCidr m_byoip_cidr;
    bool m_byoip_cidr_isSet;
    bool m_byoip_cidr_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIWithdrawByoipCidrResponse)

#endif // OAIWithdrawByoipCidrResponse_H
