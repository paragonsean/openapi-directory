...
/*
 * OAIDescribeCustomRoutingAcceleratorAttributesResponse.h
 *
 * 
 */

#ifndef OAIDescribeCustomRoutingAcceleratorAttributesResponse_H
#define OAIDescribeCustomRoutingAcceleratorAttributesResponse_H
...
namespace OpenAPI {
class OAIDescribeCustomRoutingAcceleratorAttributesResponse_AcceleratorAttributes;

class OAIDescribeCustomRoutingAcceleratorAttributesResponse : public OAIObject {
public:
    OAIDescribeCustomRoutingAcceleratorAttributesResponse();
    OAIDescribeCustomRoutingAcceleratorAttributesResponse(QString json);
    ~OAIDescribeCustomRoutingAcceleratorAttributesResponse() override;
    ...
    OAIDescribeCustomRoutingAcceleratorAttributesResponse_AcceleratorAttributes getAcceleratorAttributes() const;
    void setAcceleratorAttributes(const OAIDescribeCustomRoutingAcceleratorAttributesResponse_AcceleratorAttributes &accelerator_attributes);
    bool is_accelerator_attributes_Set() const;
    bool is_accelerator_attributes_Valid() const;
...
private:
    ...
    OAIDescribeCustomRoutingAcceleratorAttributesResponse_AcceleratorAttributes m_accelerator_attributes;
    bool m_accelerator_attributes_isSet;
    bool m_accelerator_attributes_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCustomRoutingAcceleratorAttributesResponse)

#endif // OAIDescribeCustomRoutingAcceleratorAttributesResponse_H
