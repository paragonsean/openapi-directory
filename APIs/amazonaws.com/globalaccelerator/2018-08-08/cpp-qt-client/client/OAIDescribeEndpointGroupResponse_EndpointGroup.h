...
/*
 * OAIDescribeEndpointGroupResponse_EndpointGroup.h
 *
 * 
 */

#ifndef OAIDescribeEndpointGroupResponse_EndpointGroup_H
#define OAIDescribeEndpointGroupResponse_EndpointGroup_H
...
class OAIDescribeEndpointGroupResponse_EndpointGroup : public OAIObject {
public:
    OAIDescribeEndpointGroupResponse_EndpointGroup();
    OAIDescribeEndpointGroupResponse_EndpointGroup(QString json);
    ~OAIDescribeEndpointGroupResponse_EndpointGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEndpointGroupResponse_EndpointGroup)

#endif // OAIDescribeEndpointGroupResponse_EndpointGroup_H
