...
OAIListCustomRoutingPortMappingsByDestinationRequest::OAIListCustomRoutingPortMappingsByDestinationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListCustomRoutingPortMappingsByDestinationRequest::OAIListCustomRoutingPortMappingsByDestinationRequest() {
    this->initializeModel();
}

OAIListCustomRoutingPortMappingsByDestinationRequest::~OAIListCustomRoutingPortMappingsByDestinationRequest() {}

void OAIListCustomRoutingPortMappingsByDestinationRequest::initializeModel() {
...
void OAIListCustomRoutingPortMappingsByDestinationRequest::fromJson(QString jsonString) {
...
void OAIListCustomRoutingPortMappingsByDestinationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListCustomRoutingPortMappingsByDestinationRequest::asJson() const {
...
QJsonObject OAIListCustomRoutingPortMappingsByDestinationRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListCustomRoutingPortMappingsByDestinationRequest::getEndpointId() const {
    return m_endpoint_id;
}
void OAIListCustomRoutingPortMappingsByDestinationRequest::setEndpointId(const QString &endpoint_id) {
    m_endpoint_id = endpoint_id;
    m_endpoint_id_isSet = true;
}

bool OAIListCustomRoutingPortMappingsByDestinationRequest::is_endpoint_id_Set() const{
    return m_endpoint_id_isSet;
}

bool OAIListCustomRoutingPortMappingsByDestinationRequest::is_endpoint_id_Valid() const{
    return m_endpoint_id_isValid;
}

QString OAIListCustomRoutingPortMappingsByDestinationRequest::getDestinationAddress() const {
    return m_destination_address;
}
void OAIListCustomRoutingPortMappingsByDestinationRequest::setDestinationAddress(const QString &destination_address) {
    m_destination_address = destination_address;
    m_destination_address_isSet = true;
}

bool OAIListCustomRoutingPortMappingsByDestinationRequest::is_destination_address_Set() const{
    return m_destination_address_isSet;
}

bool OAIListCustomRoutingPortMappingsByDestinationRequest::is_destination_address_Valid() const{
    return m_destination_address_isValid;
}

qint32 OAIListCustomRoutingPortMappingsByDestinationRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListCustomRoutingPortMappingsByDestinationRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListCustomRoutingPortMappingsByDestinationRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListCustomRoutingPortMappingsByDestinationRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListCustomRoutingPortMappingsByDestinationRequest::getNextToken() const {
    return m_next_token;
}
void OAIListCustomRoutingPortMappingsByDestinationRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListCustomRoutingPortMappingsByDestinationRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListCustomRoutingPortMappingsByDestinationRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListCustomRoutingPortMappingsByDestinationRequest::isSet() const {
...
bool OAIListCustomRoutingPortMappingsByDestinationRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_endpoint_id_isValid && m_destination_address_isValid && true;
}
