...
public:
    ...
    QList getPortRanges() const;
    void setPortRanges(const QList &port_ranges);
    ...
    OAIClientAffinity getClientAffinity() const;
    void setClientAffinity(const OAIClientAffinity &client_affinity);
    bool is_client_affinity_Set() const;
    bool is_client_affinity_Valid() const;
...
private:
    ...
    OAIClientAffinity m_client_affinity;
    bool m_client_affinity_isSet;
    bool m_client_affinity_isValid;
};
