...
/*
 * OAIUpdateCustomRoutingListenerRequest.h
 *
 * 
 */

#ifndef OAIUpdateCustomRoutingListenerRequest_H
#define OAIUpdateCustomRoutingListenerRequest_H
...
class OAIUpdateCustomRoutingListenerRequest : public OAIObject {
public:
    OAIUpdateCustomRoutingListenerRequest();
    OAIUpdateCustomRoutingListenerRequest(QString json);
    ~OAIUpdateCustomRoutingListenerRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateCustomRoutingListenerRequest)

#endif // OAIUpdateCustomRoutingListenerRequest_H
