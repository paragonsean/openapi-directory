...
QString OAISocketAddress::getIpAddress() const {
    return m_ip_address;
}
void OAISocketAddress::setIpAddress(const QString &ip_address) {
    m_ip_address = ip_address;
    m_ip_address_isSet = true;
}

bool OAISocketAddress::is_ip_address_Set() const{
    return m_ip_address_isSet;
}

bool OAISocketAddress::is_ip_address_Valid() const{
