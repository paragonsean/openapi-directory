...
OAIListCustomRoutingListenersResponse::OAIListCustomRoutingListenersResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListCustomRoutingListenersResponse::OAIListCustomRoutingListenersResponse() {
    this->initializeModel();
}

OAIListCustomRoutingListenersResponse::~OAIListCustomRoutingListenersResponse() {}

void OAIListCustomRoutingListenersResponse::initializeModel() {
...
void OAIListCustomRoutingListenersResponse::fromJson(QString jsonString) {
...
void OAIListCustomRoutingListenersResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListCustomRoutingListenersResponse::asJson() const {
...
QJsonObject OAIListCustomRoutingListenersResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIListCustomRoutingListenersResponse::getListeners() const {
    return m_listeners;
}
void OAIListCustomRoutingListenersResponse::setListeners(const QList &listeners) {
    m_listeners = listeners;
    m_listeners_isSet = true;
}

bool OAIListCustomRoutingListenersResponse::is_listeners_Set() const{
    return m_listeners_isSet;
}

bool OAIListCustomRoutingListenersResponse::is_listeners_Valid() const{
    return m_listeners_isValid;
}

QString OAIListCustomRoutingListenersResponse::getNextToken() const {
    return m_next_token;
}
void OAIListCustomRoutingListenersResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListCustomRoutingListenersResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListCustomRoutingListenersResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListCustomRoutingListenersResponse::isSet() const {
...
bool OAIListCustomRoutingListenersResponse::isValid() const {
