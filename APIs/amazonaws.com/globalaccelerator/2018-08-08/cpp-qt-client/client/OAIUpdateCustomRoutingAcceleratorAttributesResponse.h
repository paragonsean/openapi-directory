...
/*
 * OAIUpdateCustomRoutingAcceleratorAttributesResponse.h
 *
 * 
 */

#ifndef OAIUpdateCustomRoutingAcceleratorAttributesResponse_H
#define OAIUpdateCustomRoutingAcceleratorAttributesResponse_H
...
namespace OpenAPI {
class OAIUpdateCustomRoutingAcceleratorAttributesResponse_AcceleratorAttributes;

class OAIUpdateCustomRoutingAcceleratorAttributesResponse : public OAIObject {
public:
    OAIUpdateCustomRoutingAcceleratorAttributesResponse();
    OAIUpdateCustomRoutingAcceleratorAttributesResponse(QString json);
    ~OAIUpdateCustomRoutingAcceleratorAttributesResponse() override;
    ...
    OAIUpdateCustomRoutingAcceleratorAttributesResponse_AcceleratorAttributes getAcceleratorAttributes() const;
    void setAcceleratorAttributes(const OAIUpdateCustomRoutingAcceleratorAttributesResponse_AcceleratorAttributes &accelerator_attributes);
...
private:
    ...
    OAIUpdateCustomRoutingAcceleratorAttributesResponse_AcceleratorAttributes m_accelerator_attributes;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateCustomRoutingAcceleratorAttributesResponse)

#endif // OAIUpdateCustomRoutingAcceleratorAttributesResponse_H
