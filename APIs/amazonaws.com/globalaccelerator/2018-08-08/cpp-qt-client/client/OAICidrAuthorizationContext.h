...
#ifndef OAICidrAuthorizationContext_H
#define OAICidrAuthorizationContext_H
...
class OAICidrAuthorizationContext : public OAIObject {
public:
    OAICidrAuthorizationContext();
    OAICidrAuthorizationContext(QString json);
    ~OAICidrAuthorizationContext() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICidrAuthorizationContext)

#endif // OAICidrAuthorizationContext_H
