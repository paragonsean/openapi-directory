...
OAIListCustomRoutingAcceleratorsResponse::OAIListCustomRoutingAcceleratorsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListCustomRoutingAcceleratorsResponse::OAIListCustomRoutingAcceleratorsResponse() {
    this->initializeModel();
}

OAIListCustomRoutingAcceleratorsResponse::~OAIListCustomRoutingAcceleratorsResponse() {}

void OAIListCustomRoutingAcceleratorsResponse::initializeModel() {
...
void OAIListCustomRoutingAcceleratorsResponse::fromJson(QString jsonString) {
...
void OAIListCustomRoutingAcceleratorsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListCustomRoutingAcceleratorsResponse::asJson() const {
...
QJsonObject OAIListCustomRoutingAcceleratorsResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIListCustomRoutingAcceleratorsResponse::getAccelerators() const {
    return m_accelerators;
}
void OAIListCustomRoutingAcceleratorsResponse::setAccelerators(const QList &accelerators) {
    m_accelerators = accelerators;
    m_accelerators_isSet = true;
}

bool OAIListCustomRoutingAcceleratorsResponse::is_accelerators_Set() const{
    return m_accelerators_isSet;
}

bool OAIListCustomRoutingAcceleratorsResponse::is_accelerators_Valid() const{
    return m_accelerators_isValid;
}

QString OAIListCustomRoutingAcceleratorsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListCustomRoutingAcceleratorsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListCustomRoutingAcceleratorsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListCustomRoutingAcceleratorsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListCustomRoutingAcceleratorsResponse::isSet() const {
...
bool OAIListCustomRoutingAcceleratorsResponse::isValid() const {
