...
#include "OAIUpdateListenerResponse_Listener.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIUpdateListenerResponse_Listener;
...
public:
    ...
    OAIUpdateListenerResponse_Listener getListener() const;
    void setListener(const OAIUpdateListenerResponse_Listener &listener);
...
private:
    ...
    OAIUpdateListenerResponse_Listener m_listener;
