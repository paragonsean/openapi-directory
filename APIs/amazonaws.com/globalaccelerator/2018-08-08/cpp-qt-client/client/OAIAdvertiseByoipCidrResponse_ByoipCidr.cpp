...
OAIAdvertiseByoipCidrResponse_ByoipCidr::OAIAdvertiseByoipCidrResponse_ByoipCidr(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdvertiseByoipCidrResponse_ByoipCidr::OAIAdvertiseByoipCidrResponse_ByoipCidr() {
    this->initializeModel();
}

OAIAdvertiseByoipCidrResponse_ByoipCidr::~OAIAdvertiseByoipCidrResponse_ByoipCidr() {}

void OAIAdvertiseByoipCidrResponse_ByoipCidr::initializeModel() {
...
void OAIAdvertiseByoipCidrResponse_ByoipCidr::fromJson(QString jsonString) {
...
void OAIAdvertiseByoipCidrResponse_ByoipCidr::fromJsonObject(QJsonObject json) {
...
QString OAIAdvertiseByoipCidrResponse_ByoipCidr::asJson() const {
...
QJsonObject OAIAdvertiseByoipCidrResponse_ByoipCidr::asJsonObject() const {
    QJsonObject obj;
    if (m_cidr_isSet) {
...
QString OAIAdvertiseByoipCidrResponse_ByoipCidr::getCidr() const {
    return m_cidr;
}
void OAIAdvertiseByoipCidrResponse_ByoipCidr::setCidr(const QString &cidr) {
    m_cidr = cidr;
    m_cidr_isSet = true;
}

bool OAIAdvertiseByoipCidrResponse_ByoipCidr::is_cidr_Set() const{
    return m_cidr_isSet;
}

bool OAIAdvertiseByoipCidrResponse_ByoipCidr::is_cidr_Valid() const{
    return m_cidr_isValid;
}

OAIByoipCidrState OAIAdvertiseByoipCidrResponse_ByoipCidr::getState() const {
    return m_state;
}
void OAIAdvertiseByoipCidrResponse_ByoipCidr::setState(const OAIByoipCidrState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIAdvertiseByoipCidrResponse_ByoipCidr::is_state_Set() const{
    return m_state_isSet;
}

bool OAIAdvertiseByoipCidrResponse_ByoipCidr::is_state_Valid() const{
    return m_state_isValid;
}

QList OAIAdvertiseByoipCidrResponse_ByoipCidr::getEvents() const {
    return m_events;
}
void OAIAdvertiseByoipCidrResponse_ByoipCidr::setEvents(const QList &events) {
    m_events = events;
    m_events_isSet = true;
}

bool OAIAdvertiseByoipCidrResponse_ByoipCidr::is_events_Set() const{
    return m_events_isSet;
}

bool OAIAdvertiseByoipCidrResponse_ByoipCidr::is_events_Valid() const{
    return m_events_isValid;
}

bool OAIAdvertiseByoipCidrResponse_ByoipCidr::isSet() const {
...
bool OAIAdvertiseByoipCidrResponse_ByoipCidr::isValid() const {
