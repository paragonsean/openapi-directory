...
/*
 * OAICreateEndpointGroupRequest.h
 *
 * 
 */

#ifndef OAICreateEndpointGroupRequest_H
#define OAICreateEndpointGroupRequest_H
...
class OAICreateEndpointGroupRequest : public OAIObject {
public:
    OAICreateEndpointGroupRequest();
    OAICreateEndpointGroupRequest(QString json);
    ~OAICreateEndpointGroupRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateEndpointGroupRequest)

#endif // OAICreateEndpointGroupRequest_H
