...
/*
 * OAIPortMapping_DestinationSocketAddress.h
 *
 * 
 */

#ifndef OAIPortMapping_DestinationSocketAddress_H
#define OAIPortMapping_DestinationSocketAddress_H
...
class OAIPortMapping_DestinationSocketAddress : public OAIObject {
public:
    OAIPortMapping_DestinationSocketAddress();
    OAIPortMapping_DestinationSocketAddress(QString json);
    ~OAIPortMapping_DestinationSocketAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPortMapping_DestinationSocketAddress)

#endif // OAIPortMapping_DestinationSocketAddress_H
