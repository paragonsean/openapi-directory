...
/*
 * OAICustomRoutingProtocol.h
 *
 * 
 */

#ifndef OAICustomRoutingProtocol_H
#define OAICustomRoutingProtocol_H
...
class OAICustomRoutingProtocol : public OAIEnum {
public:
    OAICustomRoutingProtocol();
    OAICustomRoutingProtocol(QString json);
    ~OAICustomRoutingProtocol() override;
    ...
    enum class eOAICustomRoutingProtocol {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        TCP, 
        UDP
    };
    OAICustomRoutingProtocol::eOAICustomRoutingProtocol getValue() const;
    void setValue(const OAICustomRoutingProtocol::eOAICustomRoutingProtocol& value);
...
private:
    ...
    eOAICustomRoutingProtocol m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomRoutingProtocol)

#endif // OAICustomRoutingProtocol_H
