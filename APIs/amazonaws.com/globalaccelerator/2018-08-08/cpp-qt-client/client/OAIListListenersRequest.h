...
/*
 * OAIListListenersRequest.h
 *
 * 
 */

#ifndef OAIListListenersRequest_H
#define OAIListListenersRequest_H
...
class OAIListListenersRequest : public OAIObject {
public:
    OAIListListenersRequest();
    OAIListListenersRequest(QString json);
    ~OAIListListenersRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListListenersRequest)

#endif // OAIListListenersRequest_H
