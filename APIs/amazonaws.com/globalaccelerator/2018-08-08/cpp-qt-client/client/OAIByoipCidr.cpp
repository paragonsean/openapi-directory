...
OAIByoipCidr::OAIByoipCidr(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIByoipCidr::OAIByoipCidr() {
    this->initializeModel();
}

OAIByoipCidr::~OAIByoipCidr() {}

void OAIByoipCidr::initializeModel() {
...
void OAIByoipCidr::fromJson(QString jsonString) {
...
void OAIByoipCidr::fromJsonObject(QJsonObject json) {
...
QString OAIByoipCidr::asJson() const {
...
QJsonObject OAIByoipCidr::asJsonObject() const {
    QJsonObject obj;
    if (m_cidr_isSet) {
...
QString OAIByoipCidr::getCidr() const {
    return m_cidr;
}
void OAIByoipCidr::setCidr(const QString &cidr) {
    m_cidr = cidr;
    m_cidr_isSet = true;
}

bool OAIByoipCidr::is_cidr_Set() const{
    return m_cidr_isSet;
}

bool OAIByoipCidr::is_cidr_Valid() const{
    return m_cidr_isValid;
}

OAIByoipCidrState OAIByoipCidr::getState() const {
    return m_state;
}
void OAIByoipCidr::setState(const OAIByoipCidrState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIByoipCidr::is_state_Set() const{
    return m_state_isSet;
}

bool OAIByoipCidr::is_state_Valid() const{
    return m_state_isValid;
}

QList OAIByoipCidr::getEvents() const {
    return m_events;
}
void OAIByoipCidr::setEvents(const QList &events) {
    m_events = events;
    m_events_isSet = true;
}

bool OAIByoipCidr::is_events_Set() const{
    return m_events_isSet;
}

bool OAIByoipCidr::is_events_Valid() const{
    return m_events_isValid;
}

bool OAIByoipCidr::isSet() const {
...
bool OAIByoipCidr::isValid() const {
