...
/*
 * OAIWithdrawByoipCidrRequest.h
 *
 * 
 */

#ifndef OAIWithdrawByoipCidrRequest_H
#define OAIWithdrawByoipCidrRequest_H
...
class OAIWithdrawByoipCidrRequest : public OAIObject {
public:
    OAIWithdrawByoipCidrRequest();
    OAIWithdrawByoipCidrRequest(QString json);
    ~OAIWithdrawByoipCidrRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWithdrawByoipCidrRequest)

#endif // OAIWithdrawByoipCidrRequest_H
