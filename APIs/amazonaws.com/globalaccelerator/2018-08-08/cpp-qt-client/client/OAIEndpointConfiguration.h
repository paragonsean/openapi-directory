...
/*
 * OAIEndpointConfiguration.h
 *
 * A complex type for endpoints. A resource must be valid and active when you add it as an endpoint.
 */

#ifndef OAIEndpointConfiguration_H
#define OAIEndpointConfiguration_H
...
class OAIEndpointConfiguration : public OAIObject {
public:
    OAIEndpointConfiguration();
    OAIEndpointConfiguration(QString json);
    ~OAIEndpointConfiguration() override;
    ...
    void setClientIpPreservationEnabled(const bool &client_ip_preservation_enabled);
    bool is_client_ip_preservation_enabled_Set() const;
    bool is_client_ip_preservation_enabled_Valid() const;
...
private:
    ...
    bool m_client_ip_preservation_enabled;
    bool m_client_ip_preservation_enabled_isSet;
    bool m_client_ip_preservation_enabled_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIEndpointConfiguration)

#endif // OAIEndpointConfiguration_H
