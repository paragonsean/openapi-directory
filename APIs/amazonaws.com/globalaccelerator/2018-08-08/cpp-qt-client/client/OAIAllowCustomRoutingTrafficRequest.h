...
/*
 * OAIAllowCustomRoutingTrafficRequest.h
 *
 * 
 */

#ifndef OAIAllowCustomRoutingTrafficRequest_H
#define OAIAllowCustomRoutingTrafficRequest_H
...
class OAIAllowCustomRoutingTrafficRequest : public OAIObject {
public:
    OAIAllowCustomRoutingTrafficRequest();
    OAIAllowCustomRoutingTrafficRequest(QString json);
    ~OAIAllowCustomRoutingTrafficRequest() override;
    ...
    QList getDestinationAddresses() const;
    void setDestinationAddresses(const QList &destination_addresses);
    ...
    void setAllowAllTrafficToEndpoint(const bool &allow_all_traffic_to_endpoint);
    bool is_allow_all_traffic_to_endpoint_Set() const;
    bool is_allow_all_traffic_to_endpoint_Valid() const;
...
private:
    ...
    bool m_allow_all_traffic_to_endpoint;
    bool m_allow_all_traffic_to_endpoint_isSet;
    bool m_allow_all_traffic_to_endpoint_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIAllowCustomRoutingTrafficRequest)

#endif // OAIAllowCustomRoutingTrafficRequest_H
