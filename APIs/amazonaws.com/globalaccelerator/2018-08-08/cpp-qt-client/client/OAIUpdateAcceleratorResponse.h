...
/*
 * OAIUpdateAcceleratorResponse.h
 *
 * 
 */

#ifndef OAIUpdateAcceleratorResponse_H
#define OAIUpdateAcceleratorResponse_H
...
namespace OpenAPI {
class OAIUpdateAcceleratorResponse_Accelerator;

class OAIUpdateAcceleratorResponse : public OAIObject {
public:
    OAIUpdateAcceleratorResponse();
    OAIUpdateAcceleratorResponse(QString json);
    ~OAIUpdateAcceleratorResponse() override;
    ...
    OAIUpdateAcceleratorResponse_Accelerator getAccelerator() const;
    void setAccelerator(const OAIUpdateAcceleratorResponse_Accelerator &accelerator);
...
private:
    ...
    OAIUpdateAcceleratorResponse_Accelerator m_accelerator;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAcceleratorResponse)

#endif // OAIUpdateAcceleratorResponse_H
