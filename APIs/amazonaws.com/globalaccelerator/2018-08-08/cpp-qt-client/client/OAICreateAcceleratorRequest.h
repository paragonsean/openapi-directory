...
/*
 * OAICreateAcceleratorRequest.h
 *
 * 
 */

#ifndef OAICreateAcceleratorRequest_H
#define OAICreateAcceleratorRequest_H
...
class OAICreateAcceleratorRequest : public OAIObject {
public:
    OAICreateAcceleratorRequest();
    OAICreateAcceleratorRequest(QString json);
    ~OAICreateAcceleratorRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAcceleratorRequest)

#endif // OAICreateAcceleratorRequest_H
