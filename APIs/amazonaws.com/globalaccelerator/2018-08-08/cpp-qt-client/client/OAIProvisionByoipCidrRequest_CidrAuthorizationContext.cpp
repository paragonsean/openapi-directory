...
#include "OAIProvisionByoipCidrRequest_CidrAuthorizationContext.h"
...
OAIProvisionByoipCidrRequest_CidrAuthorizationContext::OAIProvisionByoipCidrRequest_CidrAuthorizationContext(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProvisionByoipCidrRequest_CidrAuthorizationContext::OAIProvisionByoipCidrRequest_CidrAuthorizationContext() {
    this->initializeModel();
}

OAIProvisionByoipCidrRequest_CidrAuthorizationContext::~OAIProvisionByoipCidrRequest_CidrAuthorizationContext() {}

void OAIProvisionByoipCidrRequest_CidrAuthorizationContext::initializeModel() {
...
void OAIProvisionByoipCidrRequest_CidrAuthorizationContext::fromJson(QString jsonString) {
...
void OAIProvisionByoipCidrRequest_CidrAuthorizationContext::fromJsonObject(QJsonObject json) {
...
QString OAIProvisionByoipCidrRequest_CidrAuthorizationContext::asJson() const {
...
QJsonObject OAIProvisionByoipCidrRequest_CidrAuthorizationContext::asJsonObject() const {
    QJsonObject obj;
    if (m_message_isSet) {
...
QString OAIProvisionByoipCidrRequest_CidrAuthorizationContext::getMessage() const {
    return m_message;
}
void OAIProvisionByoipCidrRequest_CidrAuthorizationContext::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIProvisionByoipCidrRequest_CidrAuthorizationContext::is_message_Set() const{
    return m_message_isSet;
}

bool OAIProvisionByoipCidrRequest_CidrAuthorizationContext::is_message_Valid() const{
    return m_message_isValid;
}

QString OAIProvisionByoipCidrRequest_CidrAuthorizationContext::getSignature() const {
    return m_signature;
}
void OAIProvisionByoipCidrRequest_CidrAuthorizationContext::setSignature(const QString &signature) {
    m_signature = signature;
    m_signature_isSet = true;
}

bool OAIProvisionByoipCidrRequest_CidrAuthorizationContext::is_signature_Set() const{
    return m_signature_isSet;
}

bool OAIProvisionByoipCidrRequest_CidrAuthorizationContext::is_signature_Valid() const{
    return m_signature_isValid;
}

bool OAIProvisionByoipCidrRequest_CidrAuthorizationContext::isSet() const {
...
bool OAIProvisionByoipCidrRequest_CidrAuthorizationContext::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_message_isValid && m_signature_isValid && true;
}
