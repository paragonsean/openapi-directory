...
/*
 * OAIUpdateAcceleratorResponse_Accelerator.h
 *
 * 
 */

#ifndef OAIUpdateAcceleratorResponse_Accelerator_H
#define OAIUpdateAcceleratorResponse_Accelerator_H
...
class OAIUpdateAcceleratorResponse_Accelerator : public OAIObject {
public:
    OAIUpdateAcceleratorResponse_Accelerator();
    OAIUpdateAcceleratorResponse_Accelerator(QString json);
    ~OAIUpdateAcceleratorResponse_Accelerator() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAcceleratorResponse_Accelerator)

#endif // OAIUpdateAcceleratorResponse_Accelerator_H
