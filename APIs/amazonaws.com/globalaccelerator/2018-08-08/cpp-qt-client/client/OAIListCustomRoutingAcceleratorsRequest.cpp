...
OAIListCustomRoutingAcceleratorsRequest::OAIListCustomRoutingAcceleratorsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListCustomRoutingAcceleratorsRequest::OAIListCustomRoutingAcceleratorsRequest() {
    this->initializeModel();
}

OAIListCustomRoutingAcceleratorsRequest::~OAIListCustomRoutingAcceleratorsRequest() {}

void OAIListCustomRoutingAcceleratorsRequest::initializeModel() {
...
void OAIListCustomRoutingAcceleratorsRequest::fromJson(QString jsonString) {
...
void OAIListCustomRoutingAcceleratorsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListCustomRoutingAcceleratorsRequest::asJson() const {
...
QJsonObject OAIListCustomRoutingAcceleratorsRequest::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIListCustomRoutingAcceleratorsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListCustomRoutingAcceleratorsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListCustomRoutingAcceleratorsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListCustomRoutingAcceleratorsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListCustomRoutingAcceleratorsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListCustomRoutingAcceleratorsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListCustomRoutingAcceleratorsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListCustomRoutingAcceleratorsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListCustomRoutingAcceleratorsRequest::isSet() const {
...
bool OAIListCustomRoutingAcceleratorsRequest::isValid() const {
