...
/*
 * OAIUpdateListenerResponse_Listener.h
 *
 * 
 */

#ifndef OAIUpdateListenerResponse_Listener_H
#define OAIUpdateListenerResponse_Listener_H
...
class OAIUpdateListenerResponse_Listener : public OAIObject {
public:
    OAIUpdateListenerResponse_Listener();
    OAIUpdateListenerResponse_Listener(QString json);
    ~OAIUpdateListenerResponse_Listener() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateListenerResponse_Listener)

#endif // OAIUpdateListenerResponse_Listener_H
