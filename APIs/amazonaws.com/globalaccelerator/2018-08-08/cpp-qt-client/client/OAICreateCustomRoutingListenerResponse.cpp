...
OAICreateCustomRoutingListenerResponse::OAICreateCustomRoutingListenerResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateCustomRoutingListenerResponse::OAICreateCustomRoutingListenerResponse() {
    this->initializeModel();
}

OAICreateCustomRoutingListenerResponse::~OAICreateCustomRoutingListenerResponse() {}

void OAICreateCustomRoutingListenerResponse::initializeModel() {

    m_listener_isSet = false;
    m_listener_isValid = false;
}

void OAICreateCustomRoutingListenerResponse::fromJson(QString jsonString) {
...
void OAICreateCustomRoutingListenerResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateCustomRoutingListenerResponse::asJson() const {
...
QJsonObject OAICreateCustomRoutingListenerResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_listener.isSet()) {
...
OAICreateCustomRoutingListenerResponse_Listener OAICreateCustomRoutingListenerResponse::getListener() const {
    return m_listener;
}
void OAICreateCustomRoutingListenerResponse::setListener(const OAICreateCustomRoutingListenerResponse_Listener &listener) {
    m_listener = listener;
    m_listener_isSet = true;
}

bool OAICreateCustomRoutingListenerResponse::is_listener_Set() const{
    return m_listener_isSet;
}

bool OAICreateCustomRoutingListenerResponse::is_listener_Valid() const{
    return m_listener_isValid;
}

bool OAICreateCustomRoutingListenerResponse::isSet() const {
...
bool OAICreateCustomRoutingListenerResponse::isValid() const {
