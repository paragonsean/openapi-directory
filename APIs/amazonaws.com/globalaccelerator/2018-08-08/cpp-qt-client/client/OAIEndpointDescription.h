...
/*
 * OAIEndpointDescription.h
 *
 * A complex type for an endpoint. Each endpoint group can include one or more endpoints, such as load balancers.
 */

#ifndef OAIEndpointDescription_H
#define OAIEndpointDescription_H
...
class OAIEndpointDescription : public OAIObject {
public:
    OAIEndpointDescription();
    OAIEndpointDescription(QString json);
    ~OAIEndpointDescription() override;
    ...
    QString getHealthReason() const;
    void setHealthReason(const QString &health_reason);
    bool is_health_reason_Set() const;
    bool is_health_reason_Valid() const;
...
private:
    ...
    QString m_health_reason;
    bool m_health_reason_isSet;
    bool m_health_reason_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEndpointDescription)

#endif // OAIEndpointDescription_H
