...
/*
 * OAIDeleteCustomRoutingListenerRequest.h
 *
 * 
 */

#ifndef OAIDeleteCustomRoutingListenerRequest_H
#define OAIDeleteCustomRoutingListenerRequest_H
...
class OAIDeleteCustomRoutingListenerRequest : public OAIObject {
public:
    OAIDeleteCustomRoutingListenerRequest();
    OAIDeleteCustomRoutingListenerRequest(QString json);
    ~OAIDeleteCustomRoutingListenerRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteCustomRoutingListenerRequest)

#endif // OAIDeleteCustomRoutingListenerRequest_H
