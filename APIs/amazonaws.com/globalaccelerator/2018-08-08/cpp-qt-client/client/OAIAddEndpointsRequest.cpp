...
OAIAddEndpointsRequest::OAIAddEndpointsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddEndpointsRequest::OAIAddEndpointsRequest() {
    this->initializeModel();
}

OAIAddEndpointsRequest::~OAIAddEndpointsRequest() {}

void OAIAddEndpointsRequest::initializeModel() {
...
void OAIAddEndpointsRequest::fromJson(QString jsonString) {
...
void OAIAddEndpointsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAddEndpointsRequest::asJson() const {
...
QJsonObject OAIAddEndpointsRequest::asJsonObject() const {
    QJsonObject obj;
...
QList OAIAddEndpointsRequest::getEndpointConfigurations() const {
    return m_endpoint_configurations;
}
void OAIAddEndpointsRequest::setEndpointConfigurations(const QList &endpoint_configurations) {
    m_endpoint_configurations = endpoint_configurations;
    m_endpoint_configurations_isSet = true;
}

bool OAIAddEndpointsRequest::is_endpoint_configurations_Set() const{
    return m_endpoint_configurations_isSet;
}

bool OAIAddEndpointsRequest::is_endpoint_configurations_Valid() const{
    return m_endpoint_configurations_isValid;
}

QString OAIAddEndpointsRequest::getEndpointGroupArn() const {
    return m_endpoint_group_arn;
}
void OAIAddEndpointsRequest::setEndpointGroupArn(const QString &endpoint_group_arn) {
    m_endpoint_group_arn = endpoint_group_arn;
    m_endpoint_group_arn_isSet = true;
}

bool OAIAddEndpointsRequest::is_endpoint_group_arn_Set() const{
    return m_endpoint_group_arn_isSet;
}

bool OAIAddEndpointsRequest::is_endpoint_group_arn_Valid() const{
    return m_endpoint_group_arn_isValid;
}

bool OAIAddEndpointsRequest::isSet() const {
...
bool OAIAddEndpointsRequest::isValid() const {
