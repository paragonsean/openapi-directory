...
OAIDeleteAcceleratorRequest::OAIDeleteAcceleratorRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteAcceleratorRequest::OAIDeleteAcceleratorRequest() {
    this->initializeModel();
}

OAIDeleteAcceleratorRequest::~OAIDeleteAcceleratorRequest() {}

void OAIDeleteAcceleratorRequest::initializeModel() {

    m_accelerator_arn_isSet = false;
    m_accelerator_arn_isValid = false;
}

void OAIDeleteAcceleratorRequest::fromJson(QString jsonString) {
...
void OAIDeleteAcceleratorRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteAcceleratorRequest::asJson() const {
...
QJsonObject OAIDeleteAcceleratorRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteAcceleratorRequest::getAcceleratorArn() const {
    return m_accelerator_arn;
}
void OAIDeleteAcceleratorRequest::setAcceleratorArn(const QString &accelerator_arn) {
    m_accelerator_arn = accelerator_arn;
    m_accelerator_arn_isSet = true;
}

bool OAIDeleteAcceleratorRequest::is_accelerator_arn_Set() const{
    return m_accelerator_arn_isSet;
}

bool OAIDeleteAcceleratorRequest::is_accelerator_arn_Valid() const{
    return m_accelerator_arn_isValid;
}

bool OAIDeleteAcceleratorRequest::isSet() const {
...
bool OAIDeleteAcceleratorRequest::isValid() const {
