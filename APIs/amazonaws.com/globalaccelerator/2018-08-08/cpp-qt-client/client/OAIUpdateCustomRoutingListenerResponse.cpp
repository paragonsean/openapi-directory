...
OAIUpdateCustomRoutingListenerResponse::OAIUpdateCustomRoutingListenerResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateCustomRoutingListenerResponse::OAIUpdateCustomRoutingListenerResponse() {
    this->initializeModel();
}

OAIUpdateCustomRoutingListenerResponse::~OAIUpdateCustomRoutingListenerResponse() {}

void OAIUpdateCustomRoutingListenerResponse::initializeModel() {

    m_listener_isSet = false;
    m_listener_isValid = false;
}

void OAIUpdateCustomRoutingListenerResponse::fromJson(QString jsonString) {
...
void OAIUpdateCustomRoutingListenerResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateCustomRoutingListenerResponse::asJson() const {
...
QJsonObject OAIUpdateCustomRoutingListenerResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_listener.isSet()) {
...
OAIUpdateCustomRoutingListenerResponse_Listener OAIUpdateCustomRoutingListenerResponse::getListener() const {
    return m_listener;
}
void OAIUpdateCustomRoutingListenerResponse::setListener(const OAIUpdateCustomRoutingListenerResponse_Listener &listener) {
    m_listener = listener;
    m_listener_isSet = true;
}

bool OAIUpdateCustomRoutingListenerResponse::is_listener_Set() const{
    return m_listener_isSet;
}

bool OAIUpdateCustomRoutingListenerResponse::is_listener_Valid() const{
    return m_listener_isValid;
}

bool OAIUpdateCustomRoutingListenerResponse::isSet() const {
...
bool OAIUpdateCustomRoutingListenerResponse::isValid() const {
