...
/*
 * OAICreateCustomRoutingEndpointGroupResponse_EndpointGroup.h
 *
 * 
 */

#ifndef OAICreateCustomRoutingEndpointGroupResponse_EndpointGroup_H
#define OAICreateCustomRoutingEndpointGroupResponse_EndpointGroup_H
...
class OAICreateCustomRoutingEndpointGroupResponse_EndpointGroup : public OAIObject {
public:
    OAICreateCustomRoutingEndpointGroupResponse_EndpointGroup();
    OAICreateCustomRoutingEndpointGroupResponse_EndpointGroup(QString json);
    ~OAICreateCustomRoutingEndpointGroupResponse_EndpointGroup() override;
    ...
    QList getDestinationDescriptions() const;
    void setDestinationDescriptions(const QList &destination_descriptions);
    bool is_destination_descriptions_Set() const;
    bool is_destination_descriptions_Valid() const;

    QList getEndpointDescriptions() const;
    void setEndpointDescriptions(const QList &endpoint_descriptions);
    bool is_endpoint_descriptions_Set() const;
    bool is_endpoint_descriptions_Valid() const;
...
private:
    ...
    QList m_destination_descriptions;
    bool m_destination_descriptions_isSet;
    bool m_destination_descriptions_isValid;

    QList m_endpoint_descriptions;
    bool m_endpoint_descriptions_isSet;
    bool m_endpoint_descriptions_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateCustomRoutingEndpointGroupResponse_EndpointGroup)

#endif // OAICreateCustomRoutingEndpointGroupResponse_EndpointGroup_H
