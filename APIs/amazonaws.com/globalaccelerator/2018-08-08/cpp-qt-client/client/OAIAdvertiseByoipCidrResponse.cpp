...
OAIAdvertiseByoipCidrResponse::OAIAdvertiseByoipCidrResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdvertiseByoipCidrResponse::OAIAdvertiseByoipCidrResponse() {
    this->initializeModel();
}

OAIAdvertiseByoipCidrResponse::~OAIAdvertiseByoipCidrResponse() {}

void OAIAdvertiseByoipCidrResponse::initializeModel() {

    m_byoip_cidr_isSet = false;
    m_byoip_cidr_isValid = false;
}

void OAIAdvertiseByoipCidrResponse::fromJson(QString jsonString) {
...
void OAIAdvertiseByoipCidrResponse::fromJsonObject(QJsonObject json) {
...
QString OAIAdvertiseByoipCidrResponse::asJson() const {
...
QJsonObject OAIAdvertiseByoipCidrResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIAdvertiseByoipCidrResponse_ByoipCidr OAIAdvertiseByoipCidrResponse::getByoipCidr() const {
    return m_byoip_cidr;
}
void OAIAdvertiseByoipCidrResponse::setByoipCidr(const OAIAdvertiseByoipCidrResponse_ByoipCidr &byoip_cidr) {
    m_byoip_cidr = byoip_cidr;
    m_byoip_cidr_isSet = true;
}

bool OAIAdvertiseByoipCidrResponse::is_byoip_cidr_Set() const{
    return m_byoip_cidr_isSet;
}

bool OAIAdvertiseByoipCidrResponse::is_byoip_cidr_Valid() const{
    return m_byoip_cidr_isValid;
}

bool OAIAdvertiseByoipCidrResponse::isSet() const {
...
bool OAIAdvertiseByoipCidrResponse::isValid() const {
