...
OAICreateAcceleratorResponse::OAICreateAcceleratorResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateAcceleratorResponse::OAICreateAcceleratorResponse() {
    this->initializeModel();
}

OAICreateAcceleratorResponse::~OAICreateAcceleratorResponse() {}

void OAICreateAcceleratorResponse::initializeModel() {

    m_accelerator_isSet = false;
    m_accelerator_isValid = false;
}

void OAICreateAcceleratorResponse::fromJson(QString jsonString) {
...
void OAICreateAcceleratorResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateAcceleratorResponse::asJson() const {
...
QJsonObject OAICreateAcceleratorResponse::asJsonObject() const {
    QJsonObject obj;
...
OAICreateAcceleratorResponse_Accelerator OAICreateAcceleratorResponse::getAccelerator() const {
    return m_accelerator;
}
void OAICreateAcceleratorResponse::setAccelerator(const OAICreateAcceleratorResponse_Accelerator &accelerator) {
    m_accelerator = accelerator;
    m_accelerator_isSet = true;
}

bool OAICreateAcceleratorResponse::is_accelerator_Set() const{
    return m_accelerator_isSet;
}

bool OAICreateAcceleratorResponse::is_accelerator_Valid() const{
    return m_accelerator_isValid;
}

bool OAICreateAcceleratorResponse::isSet() const {
...
bool OAICreateAcceleratorResponse::isValid() const {
