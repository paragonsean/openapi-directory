...
/*
 * OAIUpdateCustomRoutingListenerResponse.h
 *
 * 
 */

#ifndef OAIUpdateCustomRoutingListenerResponse_H
#define OAIUpdateCustomRoutingListenerResponse_H
...
namespace OpenAPI {
class OAIUpdateCustomRoutingListenerResponse_Listener;

class OAIUpdateCustomRoutingListenerResponse : public OAIObject {
public:
    OAIUpdateCustomRoutingListenerResponse();
    OAIUpdateCustomRoutingListenerResponse(QString json);
    ~OAIUpdateCustomRoutingListenerResponse() override;
    ...
    OAIUpdateCustomRoutingListenerResponse_Listener getListener() const;
    void setListener(const OAIUpdateCustomRoutingListenerResponse_Listener &listener);
...
private:
    ...
    OAIUpdateCustomRoutingListenerResponse_Listener m_listener;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateCustomRoutingListenerResponse)

#endif // OAIUpdateCustomRoutingListenerResponse_H
