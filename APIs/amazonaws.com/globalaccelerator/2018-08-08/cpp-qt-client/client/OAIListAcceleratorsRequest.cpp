...
OAIListAcceleratorsRequest::OAIListAcceleratorsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListAcceleratorsRequest::OAIListAcceleratorsRequest() {
    this->initializeModel();
}

OAIListAcceleratorsRequest::~OAIListAcceleratorsRequest() {}

void OAIListAcceleratorsRequest::initializeModel() {
...
void OAIListAcceleratorsRequest::fromJson(QString jsonString) {
...
void OAIListAcceleratorsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListAcceleratorsRequest::asJson() const {
...
QJsonObject OAIListAcceleratorsRequest::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIListAcceleratorsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListAcceleratorsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListAcceleratorsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListAcceleratorsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListAcceleratorsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListAcceleratorsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListAcceleratorsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListAcceleratorsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListAcceleratorsRequest::isSet() const {
...
bool OAIListAcceleratorsRequest::isValid() const {
