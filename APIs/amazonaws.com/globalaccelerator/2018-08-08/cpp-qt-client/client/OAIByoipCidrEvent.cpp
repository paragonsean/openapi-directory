...
OAIByoipCidrEvent::OAIByoipCidrEvent(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIByoipCidrEvent::OAIByoipCidrEvent() {
    this->initializeModel();
}

OAIByoipCidrEvent::~OAIByoipCidrEvent() {}

void OAIByoipCidrEvent::initializeModel() {
...
void OAIByoipCidrEvent::fromJson(QString jsonString) {
...
void OAIByoipCidrEvent::fromJsonObject(QJsonObject json) {
...
QString OAIByoipCidrEvent::asJson() const {
...
QJsonObject OAIByoipCidrEvent::asJsonObject() const {
    QJsonObject obj;
    if (m_message_isSet) {
...
QString OAIByoipCidrEvent::getMessage() const {
    return m_message;
}
void OAIByoipCidrEvent::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIByoipCidrEvent::is_message_Set() const{
    return m_message_isSet;
}

bool OAIByoipCidrEvent::is_message_Valid() const{
    return m_message_isValid;
}

QDateTime OAIByoipCidrEvent::getTimestamp() const {
    return m_timestamp;
}
void OAIByoipCidrEvent::setTimestamp(const QDateTime &timestamp) {
    m_timestamp = timestamp;
    m_timestamp_isSet = true;
}

bool OAIByoipCidrEvent::is_timestamp_Set() const{
    return m_timestamp_isSet;
}

bool OAIByoipCidrEvent::is_timestamp_Valid() const{
    return m_timestamp_isValid;
}

bool OAIByoipCidrEvent::isSet() const {
...
bool OAIByoipCidrEvent::isValid() const {
