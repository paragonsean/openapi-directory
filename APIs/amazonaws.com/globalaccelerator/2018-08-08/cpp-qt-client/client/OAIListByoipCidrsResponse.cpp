...
OAIListByoipCidrsResponse::OAIListByoipCidrsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListByoipCidrsResponse::OAIListByoipCidrsResponse() {
    this->initializeModel();
}

OAIListByoipCidrsResponse::~OAIListByoipCidrsResponse() {}

void OAIListByoipCidrsResponse::initializeModel() {

    m_byoip_cidrs_isSet = false;
    m_byoip_cidrs_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIListByoipCidrsResponse::fromJson(QString jsonString) {
...
void OAIListByoipCidrsResponse::fromJsonObject(QJsonObject json) {

    m_byoip_cidrs_isValid = ::OpenAPI::fromJsonValue(m_byoip_cidrs, json[QString("ByoipCidrs")]);
    m_byoip_cidrs_isSet = !json[QString("ByoipCidrs")].isNull() && m_byoip_cidrs_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("NextToken")]);
    m_next_token_isSet = !json[QString("NextToken")].isNull() && m_next_token_isValid;
}

QString OAIListByoipCidrsResponse::asJson() const {
...
QJsonObject OAIListByoipCidrsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_byoip_cidrs.isSet()) {
        obj.insert(QString("ByoipCidrs"), ::OpenAPI::toJsonValue(m_byoip_cidrs));
    }
...
QList OAIListByoipCidrsResponse::getByoipCidrs() const {
    return m_byoip_cidrs;
}
void OAIListByoipCidrsResponse::setByoipCidrs(const QList &byoip_cidrs) {
    m_byoip_cidrs = byoip_cidrs;
    m_byoip_cidrs_isSet = true;
}

bool OAIListByoipCidrsResponse::is_byoip_cidrs_Set() const{
    return m_byoip_cidrs_isSet;
}

bool OAIListByoipCidrsResponse::is_byoip_cidrs_Valid() const{
    return m_byoip_cidrs_isValid;
}

QString OAIListByoipCidrsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListByoipCidrsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListByoipCidrsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListByoipCidrsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListByoipCidrsResponse::isSet() const {
...
bool OAIListByoipCidrsResponse::isValid() const {
