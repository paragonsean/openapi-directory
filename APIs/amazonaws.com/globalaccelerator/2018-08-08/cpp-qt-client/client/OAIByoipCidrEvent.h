...
#ifndef OAIByoipCidrEvent_H
#define OAIByoipCidrEvent_H
...
class OAIByoipCidrEvent : public OAIObject {
public:
    OAIByoipCidrEvent();
    OAIByoipCidrEvent(QString json);
    ~OAIByoipCidrEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIByoipCidrEvent)

#endif // OAIByoipCidrEvent_H
