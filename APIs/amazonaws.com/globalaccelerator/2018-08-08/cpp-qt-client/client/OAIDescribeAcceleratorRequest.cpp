...
OAIDescribeAcceleratorRequest::OAIDescribeAcceleratorRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeAcceleratorRequest::OAIDescribeAcceleratorRequest() {
    this->initializeModel();
}

OAIDescribeAcceleratorRequest::~OAIDescribeAcceleratorRequest() {}

void OAIDescribeAcceleratorRequest::initializeModel() {

    m_accelerator_arn_isSet = false;
    m_accelerator_arn_isValid = false;
}

void OAIDescribeAcceleratorRequest::fromJson(QString jsonString) {
...
void OAIDescribeAcceleratorRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeAcceleratorRequest::asJson() const {
...
QJsonObject OAIDescribeAcceleratorRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeAcceleratorRequest::getAcceleratorArn() const {
    return m_accelerator_arn;
}
void OAIDescribeAcceleratorRequest::setAcceleratorArn(const QString &accelerator_arn) {
    m_accelerator_arn = accelerator_arn;
    m_accelerator_arn_isSet = true;
}

bool OAIDescribeAcceleratorRequest::is_accelerator_arn_Set() const{
    return m_accelerator_arn_isSet;
}

bool OAIDescribeAcceleratorRequest::is_accelerator_arn_Valid() const{
    return m_accelerator_arn_isValid;
}

bool OAIDescribeAcceleratorRequest::isSet() const {
...
bool OAIDescribeAcceleratorRequest::isValid() const {
