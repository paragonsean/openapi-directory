...
/*
 * OAIListByoipCidrsRequest.h
 *
 * 
 */

#ifndef OAIListByoipCidrsRequest_H
#define OAIListByoipCidrsRequest_H
...
class OAIListByoipCidrsRequest : public OAIObject {
public:
    OAIListByoipCidrsRequest();
    OAIListByoipCidrsRequest(QString json);
    ~OAIListByoipCidrsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListByoipCidrsRequest)

#endif // OAIListByoipCidrsRequest_H
