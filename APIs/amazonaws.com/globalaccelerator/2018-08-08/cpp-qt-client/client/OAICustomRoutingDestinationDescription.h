...
/*
 * OAICustomRoutingDestinationDescription.h
 *
 * For a custom routing accelerator, describes the port range and protocol for all endpoints (virtual private cloud subnets) in an endpoint group to accept client traffic on.
 */

#ifndef OAICustomRoutingDestinationDescription_H
#define OAICustomRoutingDestinationDescription_H
...
class OAICustomRoutingDestinationDescription : public OAIObject {
public:
    OAICustomRoutingDestinationDescription();
    OAICustomRoutingDestinationDescription(QString json);
    ~OAICustomRoutingDestinationDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomRoutingDestinationDescription)

#endif // OAICustomRoutingDestinationDescription_H
