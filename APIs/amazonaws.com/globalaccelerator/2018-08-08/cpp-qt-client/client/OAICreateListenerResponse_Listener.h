...
/*
 * OAICreateListenerResponse_Listener.h
 *
 * 
 */

#ifndef OAICreateListenerResponse_Listener_H
#define OAICreateListenerResponse_Listener_H
...
class OAICreateListenerResponse_Listener : public OAIObject {
public:
    OAICreateListenerResponse_Listener();
    OAICreateListenerResponse_Listener(QString json);
    ~OAICreateListenerResponse_Listener() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateListenerResponse_Listener)

#endif // OAICreateListenerResponse_Listener_H
