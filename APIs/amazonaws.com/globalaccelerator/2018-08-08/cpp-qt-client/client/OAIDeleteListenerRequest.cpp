...
OAIDeleteListenerRequest::OAIDeleteListenerRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteListenerRequest::OAIDeleteListenerRequest() {
    this->initializeModel();
}

OAIDeleteListenerRequest::~OAIDeleteListenerRequest() {}

void OAIDeleteListenerRequest::initializeModel() {

    m_listener_arn_isSet = false;
    m_listener_arn_isValid = false;
}

void OAIDeleteListenerRequest::fromJson(QString jsonString) {
...
void OAIDeleteListenerRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteListenerRequest::asJson() const {
...
QJsonObject OAIDeleteListenerRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteListenerRequest::getListenerArn() const {
    return m_listener_arn;
}
void OAIDeleteListenerRequest::setListenerArn(const QString &listener_arn) {
    m_listener_arn = listener_arn;
    m_listener_arn_isSet = true;
}

bool OAIDeleteListenerRequest::is_listener_arn_Set() const{
    return m_listener_arn_isSet;
}

bool OAIDeleteListenerRequest::is_listener_arn_Valid() const{
    return m_listener_arn_isValid;
}

bool OAIDeleteListenerRequest::isSet() const {
...
bool OAIDeleteListenerRequest::isValid() const {
