...
/*
 * OAICreateCustomRoutingAcceleratorRequest.h
 *
 * 
 */

#ifndef OAICreateCustomRoutingAcceleratorRequest_H
#define OAICreateCustomRoutingAcceleratorRequest_H
...
class OAICreateCustomRoutingAcceleratorRequest : public OAIObject {
public:
    OAICreateCustomRoutingAcceleratorRequest();
    OAICreateCustomRoutingAcceleratorRequest(QString json);
    ~OAICreateCustomRoutingAcceleratorRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCustomRoutingAcceleratorRequest)

#endif // OAICreateCustomRoutingAcceleratorRequest_H
