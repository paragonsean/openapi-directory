...
/*
 * OAIProvisionByoipCidrRequest.h
 *
 * 
 */

#ifndef OAIProvisionByoipCidrRequest_H
#define OAIProvisionByoipCidrRequest_H
...
namespace OpenAPI {
class OAIProvisionByoipCidrRequest_CidrAuthorizationContext;

class OAIProvisionByoipCidrRequest : public OAIObject {
public:
    OAIProvisionByoipCidrRequest();
    OAIProvisionByoipCidrRequest(QString json);
    ~OAIProvisionByoipCidrRequest() override;
    ...
    OAIProvisionByoipCidrRequest_CidrAuthorizationContext getCidrAuthorizationContext() const;
    void setCidrAuthorizationContext(const OAIProvisionByoipCidrRequest_CidrAuthorizationContext &cidr_authorization_context);
    bool is_cidr_authorization_context_Set() const;
    bool is_cidr_authorization_context_Valid() const;
...
private:
    ...
    OAIProvisionByoipCidrRequest_CidrAuthorizationContext m_cidr_authorization_context;
    bool m_cidr_authorization_context_isSet;
    bool m_cidr_authorization_context_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIProvisionByoipCidrRequest)

#endif // OAIProvisionByoipCidrRequest_H
