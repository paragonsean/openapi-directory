...
/*
 * OAIDescribeEndpointGroupResponse.h
 *
 * 
 */

#ifndef OAIDescribeEndpointGroupResponse_H
#define OAIDescribeEndpointGroupResponse_H
...
namespace OpenAPI {
class OAIDescribeEndpointGroupResponse_EndpointGroup;

class OAIDescribeEndpointGroupResponse : public OAIObject {
public:
    OAIDescribeEndpointGroupResponse();
    OAIDescribeEndpointGroupResponse(QString json);
    ~OAIDescribeEndpointGroupResponse() override;
    ...
    OAIDescribeEndpointGroupResponse_EndpointGroup getEndpointGroup() const;
    void setEndpointGroup(const OAIDescribeEndpointGroupResponse_EndpointGroup &endpoint_group);
...
private:
    ...
    OAIDescribeEndpointGroupResponse_EndpointGroup m_endpoint_group;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEndpointGroupResponse)

#endif // OAIDescribeEndpointGroupResponse_H
