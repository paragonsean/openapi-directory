...
/*
 * OAIUpdateCustomRoutingAcceleratorResponse.h
 *
 * 
 */

#ifndef OAIUpdateCustomRoutingAcceleratorResponse_H
#define OAIUpdateCustomRoutingAcceleratorResponse_H
...
namespace OpenAPI {
class OAIUpdateCustomRoutingAcceleratorResponse_Accelerator;

class OAIUpdateCustomRoutingAcceleratorResponse : public OAIObject {
public:
    OAIUpdateCustomRoutingAcceleratorResponse();
    OAIUpdateCustomRoutingAcceleratorResponse(QString json);
    ~OAIUpdateCustomRoutingAcceleratorResponse() override;
    ...
    OAIUpdateCustomRoutingAcceleratorResponse_Accelerator getAccelerator() const;
    void setAccelerator(const OAIUpdateCustomRoutingAcceleratorResponse_Accelerator &accelerator);
...
private:
    ...
    OAIUpdateCustomRoutingAcceleratorResponse_Accelerator m_accelerator;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateCustomRoutingAcceleratorResponse)

#endif // OAIUpdateCustomRoutingAcceleratorResponse_H
