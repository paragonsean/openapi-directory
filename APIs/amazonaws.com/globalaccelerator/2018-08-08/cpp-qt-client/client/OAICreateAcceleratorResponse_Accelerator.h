...
/*
 * OAICreateAcceleratorResponse_Accelerator.h
 *
 * 
 */

#ifndef OAICreateAcceleratorResponse_Accelerator_H
#define OAICreateAcceleratorResponse_Accelerator_H
...
class OAICreateAcceleratorResponse_Accelerator : public OAIObject {
public:
    OAICreateAcceleratorResponse_Accelerator();
    OAICreateAcceleratorResponse_Accelerator(QString json);
    ~OAICreateAcceleratorResponse_Accelerator() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAcceleratorResponse_Accelerator)

#endif // OAICreateAcceleratorResponse_Accelerator_H
