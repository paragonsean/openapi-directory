...
/*
 * OAIDeleteCustomRoutingAcceleratorRequest.h
 *
 * 
 */

#ifndef OAIDeleteCustomRoutingAcceleratorRequest_H
#define OAIDeleteCustomRoutingAcceleratorRequest_H
...
class OAIDeleteCustomRoutingAcceleratorRequest : public OAIObject {
public:
    OAIDeleteCustomRoutingAcceleratorRequest();
    OAIDeleteCustomRoutingAcceleratorRequest(QString json);
    ~OAIDeleteCustomRoutingAcceleratorRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteCustomRoutingAcceleratorRequest)

#endif // OAIDeleteCustomRoutingAcceleratorRequest_H
