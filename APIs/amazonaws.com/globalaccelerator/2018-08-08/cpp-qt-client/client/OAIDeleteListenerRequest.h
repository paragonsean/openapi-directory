...
/*
 * OAIDeleteListenerRequest.h
 *
 * 
 */

#ifndef OAIDeleteListenerRequest_H
#define OAIDeleteListenerRequest_H
...
class OAIDeleteListenerRequest : public OAIObject {
public:
    OAIDeleteListenerRequest();
    OAIDeleteListenerRequest(QString json);
    ~OAIDeleteListenerRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteListenerRequest)

#endif // OAIDeleteListenerRequest_H
