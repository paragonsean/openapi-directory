...
/*
 * OAIDescribeCustomRoutingListenerRequest.h
 *
 * 
 */

#ifndef OAIDescribeCustomRoutingListenerRequest_H
#define OAIDescribeCustomRoutingListenerRequest_H
...
class OAIDescribeCustomRoutingListenerRequest : public OAIObject {
public:
    OAIDescribeCustomRoutingListenerRequest();
    OAIDescribeCustomRoutingListenerRequest(QString json);
    ~OAIDescribeCustomRoutingListenerRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCustomRoutingListenerRequest)

#endif // OAIDescribeCustomRoutingListenerRequest_H
