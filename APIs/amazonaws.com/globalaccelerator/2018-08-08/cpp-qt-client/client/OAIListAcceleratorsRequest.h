...
/*
 * OAIListAcceleratorsRequest.h
 *
 * 
 */

#ifndef OAIListAcceleratorsRequest_H
#define OAIListAcceleratorsRequest_H
...
class OAIListAcceleratorsRequest : public OAIObject {
public:
    OAIListAcceleratorsRequest();
    OAIListAcceleratorsRequest(QString json);
    ~OAIListAcceleratorsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAcceleratorsRequest)

#endif // OAIListAcceleratorsRequest_H
