...
OAIDescribeListenerRequest::OAIDescribeListenerRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeListenerRequest::OAIDescribeListenerRequest() {
    this->initializeModel();
}

OAIDescribeListenerRequest::~OAIDescribeListenerRequest() {}

void OAIDescribeListenerRequest::initializeModel() {

    m_listener_arn_isSet = false;
    m_listener_arn_isValid = false;
}

void OAIDescribeListenerRequest::fromJson(QString jsonString) {
...
void OAIDescribeListenerRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeListenerRequest::asJson() const {
...
QJsonObject OAIDescribeListenerRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeListenerRequest::getListenerArn() const {
    return m_listener_arn;
}
void OAIDescribeListenerRequest::setListenerArn(const QString &listener_arn) {
    m_listener_arn = listener_arn;
    m_listener_arn_isSet = true;
}

bool OAIDescribeListenerRequest::is_listener_arn_Set() const{
    return m_listener_arn_isSet;
}

bool OAIDescribeListenerRequest::is_listener_arn_Valid() const{
    return m_listener_arn_isValid;
}

bool OAIDescribeListenerRequest::isSet() const {
...
bool OAIDescribeListenerRequest::isValid() const {
