...
/*
 * OAIListCustomRoutingAcceleratorsRequest.h
 *
 * 
 */

#ifndef OAIListCustomRoutingAcceleratorsRequest_H
#define OAIListCustomRoutingAcceleratorsRequest_H
...
class OAIListCustomRoutingAcceleratorsRequest : public OAIObject {
public:
    OAIListCustomRoutingAcceleratorsRequest();
    OAIListCustomRoutingAcceleratorsRequest(QString json);
    ~OAIListCustomRoutingAcceleratorsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListCustomRoutingAcceleratorsRequest)

#endif // OAIListCustomRoutingAcceleratorsRequest_H
