...
/*
 * OAIHealthCheckProtocol.h
 *
 * 
 */

#ifndef OAIHealthCheckProtocol_H
#define OAIHealthCheckProtocol_H
...
class OAIHealthCheckProtocol : public OAIEnum {
public:
    OAIHealthCheckProtocol();
    OAIHealthCheckProtocol(QString json);
    ~OAIHealthCheckProtocol() override;
    ...
    enum class eOAIHealthCheckProtocol {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        TCP, 
        HTTP, 
        HTTPS
    };
    OAIHealthCheckProtocol::eOAIHealthCheckProtocol getValue() const;
    void setValue(const OAIHealthCheckProtocol::eOAIHealthCheckProtocol& value);
...
private:
    ...
    eOAIHealthCheckProtocol m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHealthCheckProtocol)

#endif // OAIHealthCheckProtocol_H
