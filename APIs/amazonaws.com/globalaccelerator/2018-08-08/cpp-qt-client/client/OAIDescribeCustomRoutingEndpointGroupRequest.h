...
/*
 * OAIDescribeCustomRoutingEndpointGroupRequest.h
 *
 * 
 */

#ifndef OAIDescribeCustomRoutingEndpointGroupRequest_H
#define OAIDescribeCustomRoutingEndpointGroupRequest_H
...
class OAIDescribeCustomRoutingEndpointGroupRequest : public OAIObject {
public:
    OAIDescribeCustomRoutingEndpointGroupRequest();
    OAIDescribeCustomRoutingEndpointGroupRequest(QString json);
    ~OAIDescribeCustomRoutingEndpointGroupRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCustomRoutingEndpointGroupRequest)

#endif // OAIDescribeCustomRoutingEndpointGroupRequest_H
