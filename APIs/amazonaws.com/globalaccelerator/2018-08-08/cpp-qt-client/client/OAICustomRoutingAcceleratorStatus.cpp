...
OAICustomRoutingAcceleratorStatus::OAICustomRoutingAcceleratorStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICustomRoutingAcceleratorStatus::OAICustomRoutingAcceleratorStatus() {
    this->initializeModel();
}

OAICustomRoutingAcceleratorStatus::~OAICustomRoutingAcceleratorStatus() {}

void OAICustomRoutingAcceleratorStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAICustomRoutingAcceleratorStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAICustomRoutingAcceleratorStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("DEPLOYED", Qt::CaseInsensitive) == 0) {
        m_value = eOAICustomRoutingAcceleratorStatus::DEPLOYED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("IN_PROGRESS", Qt::CaseInsensitive) == 0) {
        m_value = eOAICustomRoutingAcceleratorStatus::IN_PROGRESS;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAICustomRoutingAcceleratorStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAICustomRoutingAcceleratorStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAICustomRoutingAcceleratorStatus::DEPLOYED:
            val = "DEPLOYED";
            break;
        case eOAICustomRoutingAcceleratorStatus::IN_PROGRESS:
            val = "IN_PROGRESS";
            break;
        default:
            break;
...
QJsonValue OAICustomRoutingAcceleratorStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAICustomRoutingAcceleratorStatus::eOAICustomRoutingAcceleratorStatus OAICustomRoutingAcceleratorStatus::getValue() const {
    return m_value;
}

void OAICustomRoutingAcceleratorStatus::setValue(const OAICustomRoutingAcceleratorStatus::eOAICustomRoutingAcceleratorStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAICustomRoutingAcceleratorStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAICustomRoutingAcceleratorStatus::isValid() const {
