...
/*
 * OAIDeleteCustomRoutingEndpointGroupRequest.h
 *
 * 
 */

#ifndef OAIDeleteCustomRoutingEndpointGroupRequest_H
#define OAIDeleteCustomRoutingEndpointGroupRequest_H
...
class OAIDeleteCustomRoutingEndpointGroupRequest : public OAIObject {
public:
    OAIDeleteCustomRoutingEndpointGroupRequest();
    OAIDeleteCustomRoutingEndpointGroupRequest(QString json);
    ~OAIDeleteCustomRoutingEndpointGroupRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteCustomRoutingEndpointGroupRequest)

#endif // OAIDeleteCustomRoutingEndpointGroupRequest_H
