...
OAIDeleteCustomRoutingListenerRequest::OAIDeleteCustomRoutingListenerRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteCustomRoutingListenerRequest::OAIDeleteCustomRoutingListenerRequest() {
    this->initializeModel();
}

OAIDeleteCustomRoutingListenerRequest::~OAIDeleteCustomRoutingListenerRequest() {}

void OAIDeleteCustomRoutingListenerRequest::initializeModel() {

    m_listener_arn_isSet = false;
    m_listener_arn_isValid = false;
}

void OAIDeleteCustomRoutingListenerRequest::fromJson(QString jsonString) {
...
void OAIDeleteCustomRoutingListenerRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteCustomRoutingListenerRequest::asJson() const {
...
QJsonObject OAIDeleteCustomRoutingListenerRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteCustomRoutingListenerRequest::getListenerArn() const {
    return m_listener_arn;
}
void OAIDeleteCustomRoutingListenerRequest::setListenerArn(const QString &listener_arn) {
    m_listener_arn = listener_arn;
    m_listener_arn_isSet = true;
}

bool OAIDeleteCustomRoutingListenerRequest::is_listener_arn_Set() const{
    return m_listener_arn_isSet;
}

bool OAIDeleteCustomRoutingListenerRequest::is_listener_arn_Valid() const{
    return m_listener_arn_isValid;
}

bool OAIDeleteCustomRoutingListenerRequest::isSet() const {
...
bool OAIDeleteCustomRoutingListenerRequest::isValid() const {
