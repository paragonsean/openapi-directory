...
/*
 * OAIListCustomRoutingListenersResponse.h
 *
 * 
 */

#ifndef OAIListCustomRoutingListenersResponse_H
#define OAIListCustomRoutingListenersResponse_H
...
class OAIListCustomRoutingListenersResponse : public OAIObject {
public:
    OAIListCustomRoutingListenersResponse();
    OAIListCustomRoutingListenersResponse(QString json);
    ~OAIListCustomRoutingListenersResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListCustomRoutingListenersResponse)

#endif // OAIListCustomRoutingListenersResponse_H
