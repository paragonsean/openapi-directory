...
/*
 * OAIDestinationPortMapping_DestinationSocketAddress.h
 *
 * 
 */

#ifndef OAIDestinationPortMapping_DestinationSocketAddress_H
#define OAIDestinationPortMapping_DestinationSocketAddress_H
...
class OAIDestinationPortMapping_DestinationSocketAddress : public OAIObject {
public:
    OAIDestinationPortMapping_DestinationSocketAddress();
    OAIDestinationPortMapping_DestinationSocketAddress(QString json);
    ~OAIDestinationPortMapping_DestinationSocketAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestinationPortMapping_DestinationSocketAddress)

#endif // OAIDestinationPortMapping_DestinationSocketAddress_H
