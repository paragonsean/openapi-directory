...
void OAIPortRange::initializeModel() {
    ...
    m_from_port_isSet = false;
    m_from_port_isValid = false;

    m_to_port_isSet = false;
    m_to_port_isValid = false;
}
...
void OAIPortRange::fromJsonObject(QJsonObject json) {
    ...
    m_from_port_isValid = ::OpenAPI::fromJsonValue(m_from_port, json[QString("FromPort")]);
    m_from_port_isSet = !json[QString("FromPort")].isNull() && m_from_port_isValid;

    m_to_port_isValid = ::OpenAPI::fromJsonValue(m_to_port, json[QString("ToPort")]);
    m_to_port_isSet = !json[QString("ToPort")].isNull() && m_to_port_isValid;
}
...
QJsonObject OAIPortRange::asJsonObject() const {
    QJsonObject obj;
    if (m_from_port_isSet) {
        obj.insert(QString("FromPort"), ::OpenAPI::toJsonValue(m_from_port));
    }
    if (m_to_port_isSet) {
        obj.insert(QString("ToPort"), ::OpenAPI::toJsonValue(m_to_port));
    }
    return obj;
}

qint32 OAIPortRange::getFromPort() const {
    return m_from_port;
}
void OAIPortRange::setFromPort(const qint32 &from_port) {
    m_from_port = from_port;
    m_from_port_isSet = true;
}

bool OAIPortRange::is_from_port_Set() const{
    return m_from_port_isSet;
}

bool OAIPortRange::is_from_port_Valid() const{
    return m_from_port_isValid;
}

qint32 OAIPortRange::getToPort() const {
    return m_to_port;
}
void OAIPortRange::setToPort(const qint32 &to_port) {
    m_to_port = to_port;
    m_to_port_isSet = true;
}

bool OAIPortRange::is_to_port_Set() const{
    return m_to_port_isSet;
}

bool OAIPortRange::is_to_port_Valid() const{
    return m_to_port_isValid;
}
