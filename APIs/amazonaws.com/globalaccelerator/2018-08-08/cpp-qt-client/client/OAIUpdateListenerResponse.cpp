...
OAIUpdateListenerResponse_Listener OAIUpdateListenerResponse::getListener() const {
    return m_listener;
}
void OAIUpdateListenerResponse::setListener(const OAIUpdateListenerResponse_Listener &listener) {
    m_listener = listener;
    m_listener_isSet = true;
}

bool OAIUpdateListenerResponse::is_listener_Set() const{
    return m_listener_isSet;
}

bool OAIUpdateListenerResponse::is_listener_Valid() const{
