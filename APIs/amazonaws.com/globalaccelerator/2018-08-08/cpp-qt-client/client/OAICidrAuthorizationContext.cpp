...
#include "OAICidrAuthorizationContext.h"
...
OAICidrAuthorizationContext::OAICidrAuthorizationContext(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICidrAuthorizationContext::OAICidrAuthorizationContext() {
    this->initializeModel();
}

OAICidrAuthorizationContext::~OAICidrAuthorizationContext() {}

void OAICidrAuthorizationContext::initializeModel() {
...
void OAICidrAuthorizationContext::fromJson(QString jsonString) {
...
void OAICidrAuthorizationContext::fromJsonObject(QJsonObject json) {
...
QString OAICidrAuthorizationContext::asJson() const {
...
QJsonObject OAICidrAuthorizationContext::asJsonObject() const {
    QJsonObject obj;
    if (m_message_isSet) {
...
QString OAICidrAuthorizationContext::getMessage() const {
    return m_message;
}
void OAICidrAuthorizationContext::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAICidrAuthorizationContext::is_message_Set() const{
    return m_message_isSet;
}

bool OAICidrAuthorizationContext::is_message_Valid() const{
    return m_message_isValid;
}

QString OAICidrAuthorizationContext::getSignature() const {
    return m_signature;
}
void OAICidrAuthorizationContext::setSignature(const QString &signature) {
    m_signature = signature;
    m_signature_isSet = true;
}

bool OAICidrAuthorizationContext::is_signature_Set() const{
    return m_signature_isSet;
}

bool OAICidrAuthorizationContext::is_signature_Valid() const{
    return m_signature_isValid;
}

bool OAICidrAuthorizationContext::isSet() const {
...
bool OAICidrAuthorizationContext::isValid() const {
