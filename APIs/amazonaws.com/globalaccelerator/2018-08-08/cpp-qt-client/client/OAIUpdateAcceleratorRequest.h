...
/*
 * OAIUpdateAcceleratorRequest.h
 *
 * 
 */

#ifndef OAIUpdateAcceleratorRequest_H
#define OAIUpdateAcceleratorRequest_H
...
class OAIUpdateAcceleratorRequest : public OAIObject {
public:
    OAIUpdateAcceleratorRequest();
    OAIUpdateAcceleratorRequest(QString json);
    ~OAIUpdateAcceleratorRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAcceleratorRequest)

#endif // OAIUpdateAcceleratorRequest_H
