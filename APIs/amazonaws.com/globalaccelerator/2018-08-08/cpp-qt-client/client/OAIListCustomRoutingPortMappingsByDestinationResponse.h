...
/*
 * OAIListCustomRoutingPortMappingsByDestinationResponse.h
 *
 * 
 */

#ifndef OAIListCustomRoutingPortMappingsByDestinationResponse_H
#define OAIListCustomRoutingPortMappingsByDestinationResponse_H
...
class OAIListCustomRoutingPortMappingsByDestinationResponse : public OAIObject {
public:
    OAIListCustomRoutingPortMappingsByDestinationResponse();
    OAIListCustomRoutingPortMappingsByDestinationResponse(QString json);
    ~OAIListCustomRoutingPortMappingsByDestinationResponse() override;
    ...
    QList getDestinationPortMappings() const;
    void setDestinationPortMappings(const QList &destination_port_mappings);
    bool is_destination_port_mappings_Set() const;
    bool is_destination_port_mappings_Valid() const;
...
private:
    ...
    QList m_destination_port_mappings;
    bool m_destination_port_mappings_isSet;
    bool m_destination_port_mappings_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListCustomRoutingPortMappingsByDestinationResponse)

#endif // OAIListCustomRoutingPortMappingsByDestinationResponse_H
