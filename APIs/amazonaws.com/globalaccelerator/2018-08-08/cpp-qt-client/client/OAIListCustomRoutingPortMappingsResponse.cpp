...
OAIListCustomRoutingPortMappingsResponse::OAIListCustomRoutingPortMappingsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListCustomRoutingPortMappingsResponse::OAIListCustomRoutingPortMappingsResponse() {
    this->initializeModel();
}

OAIListCustomRoutingPortMappingsResponse::~OAIListCustomRoutingPortMappingsResponse() {}

void OAIListCustomRoutingPortMappingsResponse::initializeModel() {
...
void OAIListCustomRoutingPortMappingsResponse::fromJson(QString jsonString) {
...
void OAIListCustomRoutingPortMappingsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListCustomRoutingPortMappingsResponse::asJson() const {
...
QJsonObject OAIListCustomRoutingPortMappingsResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIListCustomRoutingPortMappingsResponse::getPortMappings() const {
    return m_port_mappings;
}
void OAIListCustomRoutingPortMappingsResponse::setPortMappings(const QList &port_mappings) {
    m_port_mappings = port_mappings;
    m_port_mappings_isSet = true;
}

bool OAIListCustomRoutingPortMappingsResponse::is_port_mappings_Set() const{
    return m_port_mappings_isSet;
}

bool OAIListCustomRoutingPortMappingsResponse::is_port_mappings_Valid() const{
    return m_port_mappings_isValid;
}

QString OAIListCustomRoutingPortMappingsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListCustomRoutingPortMappingsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListCustomRoutingPortMappingsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListCustomRoutingPortMappingsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListCustomRoutingPortMappingsResponse::isSet() const {
...
bool OAIListCustomRoutingPortMappingsResponse::isValid() const {
