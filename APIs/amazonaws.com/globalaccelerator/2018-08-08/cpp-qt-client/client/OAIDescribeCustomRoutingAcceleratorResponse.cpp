...
OAIDescribeCustomRoutingAcceleratorResponse::OAIDescribeCustomRoutingAcceleratorResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeCustomRoutingAcceleratorResponse::OAIDescribeCustomRoutingAcceleratorResponse() {
    this->initializeModel();
}

OAIDescribeCustomRoutingAcceleratorResponse::~OAIDescribeCustomRoutingAcceleratorResponse() {}

void OAIDescribeCustomRoutingAcceleratorResponse::initializeModel() {

    m_accelerator_isSet = false;
    m_accelerator_isValid = false;
}

void OAIDescribeCustomRoutingAcceleratorResponse::fromJson(QString jsonString) {
...
void OAIDescribeCustomRoutingAcceleratorResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeCustomRoutingAcceleratorResponse::asJson() const {
...
QJsonObject OAIDescribeCustomRoutingAcceleratorResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIDescribeCustomRoutingAcceleratorResponse_Accelerator OAIDescribeCustomRoutingAcceleratorResponse::getAccelerator() const {
    return m_accelerator;
}
void OAIDescribeCustomRoutingAcceleratorResponse::setAccelerator(const OAIDescribeCustomRoutingAcceleratorResponse_Accelerator &accelerator) {
    m_accelerator = accelerator;
    m_accelerator_isSet = true;
}

bool OAIDescribeCustomRoutingAcceleratorResponse::is_accelerator_Set() const{
    return m_accelerator_isSet;
}

bool OAIDescribeCustomRoutingAcceleratorResponse::is_accelerator_Valid() const{
    return m_accelerator_isValid;
}

bool OAIDescribeCustomRoutingAcceleratorResponse::isSet() const {
...
bool OAIDescribeCustomRoutingAcceleratorResponse::isValid() const {
