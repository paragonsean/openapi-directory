...
/*
 * OAIListCustomRoutingListenersRequest.h
 *
 * 
 */

#ifndef OAIListCustomRoutingListenersRequest_H
#define OAIListCustomRoutingListenersRequest_H
...
class OAIListCustomRoutingListenersRequest : public OAIObject {
public:
    OAIListCustomRoutingListenersRequest();
    OAIListCustomRoutingListenersRequest(QString json);
    ~OAIListCustomRoutingListenersRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListCustomRoutingListenersRequest)

#endif // OAIListCustomRoutingListenersRequest_H
