...
#ifndef OAIPortOverride_H
#define OAIPortOverride_H
...
class OAIPortOverride : public OAIObject {
public:
    OAIPortOverride();
    OAIPortOverride(QString json);
    ~OAIPortOverride() override;
    ...
    qint32 getListenerPort() const;
    void setListenerPort(const qint32 &listener_port);
    bool is_listener_port_Set() const;
    bool is_listener_port_Valid() const;

    qint32 getEndpointPort() const;
    void setEndpointPort(const qint32 &endpoint_port);
    bool is_endpoint_port_Set() const;
    bool is_endpoint_port_Valid() const;
...
private:
    ...
    qint32 m_listener_port;
    bool m_listener_port_isSet;
    bool m_listener_port_isValid;

    qint32 m_endpoint_port;
    bool m_endpoint_port_isSet;
    bool m_endpoint_port_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPortOverride)

#endif // OAIPortOverride_H
