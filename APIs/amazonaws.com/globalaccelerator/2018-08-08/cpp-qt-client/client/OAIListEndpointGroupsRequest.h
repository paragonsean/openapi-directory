...
/*
 * OAIListEndpointGroupsRequest.h
 *
 * 
 */

#ifndef OAIListEndpointGroupsRequest_H
#define OAIListEndpointGroupsRequest_H
...
class OAIListEndpointGroupsRequest : public OAIObject {
public:
    OAIListEndpointGroupsRequest();
    OAIListEndpointGroupsRequest(QString json);
    ~OAIListEndpointGroupsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListEndpointGroupsRequest)

#endif // OAIListEndpointGroupsRequest_H
