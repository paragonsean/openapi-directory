...
/*
 * OAIDeleteEndpointGroupRequest.h
 *
 * 
 */

#ifndef OAIDeleteEndpointGroupRequest_H
#define OAIDeleteEndpointGroupRequest_H
...
class OAIDeleteEndpointGroupRequest : public OAIObject {
public:
    OAIDeleteEndpointGroupRequest();
    OAIDeleteEndpointGroupRequest(QString json);
    ~OAIDeleteEndpointGroupRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteEndpointGroupRequest)

#endif // OAIDeleteEndpointGroupRequest_H
