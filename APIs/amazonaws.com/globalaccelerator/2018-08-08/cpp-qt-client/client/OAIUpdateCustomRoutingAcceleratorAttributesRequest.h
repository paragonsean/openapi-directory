...
/*
 * OAIUpdateCustomRoutingAcceleratorAttributesRequest.h
 *
 * 
 */

#ifndef OAIUpdateCustomRoutingAcceleratorAttributesRequest_H
#define OAIUpdateCustomRoutingAcceleratorAttributesRequest_H
...
class OAIUpdateCustomRoutingAcceleratorAttributesRequest : public OAIObject {
public:
    OAIUpdateCustomRoutingAcceleratorAttributesRequest();
    OAIUpdateCustomRoutingAcceleratorAttributesRequest(QString json);
    ~OAIUpdateCustomRoutingAcceleratorAttributesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateCustomRoutingAcceleratorAttributesRequest)

#endif // OAIUpdateCustomRoutingAcceleratorAttributesRequest_H
