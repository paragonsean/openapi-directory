...
void OAIIpSet::initializeModel() {
    ...
    m_ip_address_family_isSet = false;
    m_ip_address_family_isValid = false;
}
...
void OAIIpSet::fromJsonObject(QJsonObject json) {
    ...
    m_ip_address_family_isValid = ::OpenAPI::fromJsonValue(m_ip_address_family, json[QString("IpAddressFamily")]);
    m_ip_address_family_isSet = !json[QString("IpAddressFamily")].isNull() && m_ip_address_family_isValid;
}
...
QJsonObject OAIIpSet::asJsonObject() const {
    ...
    if (m_ip_address_family.isSet()) {
        obj.insert(QString("IpAddressFamily"), ::OpenAPI::toJsonValue(m_ip_address_family));
    }
    return obj;
}

QString OAIIpSet::getIpFamily() const {
    return m_ip_family;
}
void OAIIpSet::setIpFamily(const QString &ip_family) {
    m_ip_family = ip_family;
    m_ip_family_isSet = true;
}

bool OAIIpSet::is_ip_family_Set() const{
    return m_ip_family_isSet;
}

bool OAIIpSet::is_ip_family_Valid() const{
    return m_ip_family_isValid;
}

QList OAIIpSet::getIpAddresses() const {
    return m_ip_addresses;
}
void OAIIpSet::setIpAddresses(const QList &ip_addresses) {
    m_ip_addresses = ip_addresses;
    m_ip_addresses_isSet = true;
}

bool OAIIpSet::is_ip_addresses_Set() const{
    return m_ip_addresses_isSet;
}

bool OAIIpSet::is_ip_addresses_Valid() const{
    return m_ip_addresses_isValid;
}

OAIIpAddressFamily OAIIpSet::getIpAddressFamily() const {
    return m_ip_address_family;
}
void OAIIpSet::setIpAddressFamily(const OAIIpAddressFamily &ip_address_family) {
    m_ip_address_family = ip_address_family;
    m_ip_address_family_isSet = true;
}

bool OAIIpSet::is_ip_address_family_Set() const{
    return m_ip_address_family_isSet;
}

bool OAIIpSet::is_ip_address_family_Valid() const{
    return m_ip_address_family_isValid;
}
