...
namespace OpenAPI {
class OAIPortMapping_DestinationSocketAddress;
...
public:
    ...
    qint32 getAcceleratorPort() const;
    void setAcceleratorPort(const qint32 &accelerator_port);
    bool is_accelerator_port_Set() const;
    bool is_accelerator_port_Valid() const;
    ...
    OAIPortMapping_DestinationSocketAddress getDestinationSocketAddress() const;
    void setDestinationSocketAddress(const OAIPortMapping_DestinationSocketAddress &destination_socket_address);
...
private:
    ...
    qint32 m_accelerator_port;
    bool m_accelerator_port_isSet;
    bool m_accelerator_port_isValid;
    ...
    OAIPortMapping_DestinationSocketAddress m_destination_socket_address;
