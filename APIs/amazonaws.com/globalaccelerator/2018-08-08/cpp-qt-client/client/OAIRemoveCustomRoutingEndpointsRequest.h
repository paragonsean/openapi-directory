...
/*
 * OAIRemoveCustomRoutingEndpointsRequest.h
 *
 * 
 */

#ifndef OAIRemoveCustomRoutingEndpointsRequest_H
#define OAIRemoveCustomRoutingEndpointsRequest_H
...
class OAIRemoveCustomRoutingEndpointsRequest : public OAIObject {
public:
    OAIRemoveCustomRoutingEndpointsRequest();
    OAIRemoveCustomRoutingEndpointsRequest(QString json);
    ~OAIRemoveCustomRoutingEndpointsRequest() override;
    ...
    QList getEndpointIds() const;
    void setEndpointIds(const QList &endpoint_ids);
    bool is_endpoint_ids_Set() const;
    bool is_endpoint_ids_Valid() const;
...
private:
    ...
    QList m_endpoint_ids;
    bool m_endpoint_ids_isSet;
    bool m_endpoint_ids_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRemoveCustomRoutingEndpointsRequest)

#endif // OAIRemoveCustomRoutingEndpointsRequest_H
