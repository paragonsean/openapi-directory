...
/*
 * OAIDenyCustomRoutingTrafficRequest.h
 *
 * 
 */

#ifndef OAIDenyCustomRoutingTrafficRequest_H
#define OAIDenyCustomRoutingTrafficRequest_H
...
class OAIDenyCustomRoutingTrafficRequest : public OAIObject {
public:
    OAIDenyCustomRoutingTrafficRequest();
    OAIDenyCustomRoutingTrafficRequest(QString json);
    ~OAIDenyCustomRoutingTrafficRequest() override;
    ...
    void setDenyAllTrafficToEndpoint(const bool &deny_all_traffic_to_endpoint);
    bool is_deny_all_traffic_to_endpoint_Set() const;
    bool is_deny_all_traffic_to_endpoint_Valid() const;
...
private:
    ...
    bool m_deny_all_traffic_to_endpoint;
    bool m_deny_all_traffic_to_endpoint_isSet;
    bool m_deny_all_traffic_to_endpoint_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDenyCustomRoutingTrafficRequest)

#endif // OAIDenyCustomRoutingTrafficRequest_H
