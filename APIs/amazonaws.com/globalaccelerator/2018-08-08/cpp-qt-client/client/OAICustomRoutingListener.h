...
/*
 * OAICustomRoutingListener.h
 *
 * A complex type for a listener for a custom routing accelerator.
 */

#ifndef OAICustomRoutingListener_H
#define OAICustomRoutingListener_H
...
class OAICustomRoutingListener : public OAIObject {
public:
    OAICustomRoutingListener();
    OAICustomRoutingListener(QString json);
    ~OAICustomRoutingListener() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomRoutingListener)

#endif // OAICustomRoutingListener_H
