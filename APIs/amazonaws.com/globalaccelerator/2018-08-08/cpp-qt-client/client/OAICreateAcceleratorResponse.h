...
/*
 * OAICreateAcceleratorResponse.h
 *
 * 
 */

#ifndef OAICreateAcceleratorResponse_H
#define OAICreateAcceleratorResponse_H
...
namespace OpenAPI {
class OAICreateAcceleratorResponse_Accelerator;

class OAICreateAcceleratorResponse : public OAIObject {
public:
    OAICreateAcceleratorResponse();
    OAICreateAcceleratorResponse(QString json);
    ~OAICreateAcceleratorResponse() override;
    ...
    OAICreateAcceleratorResponse_Accelerator getAccelerator() const;
    void setAccelerator(const OAICreateAcceleratorResponse_Accelerator &accelerator);
...
private:
    ...
    OAICreateAcceleratorResponse_Accelerator m_accelerator;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAcceleratorResponse)

#endif // OAICreateAcceleratorResponse_H
