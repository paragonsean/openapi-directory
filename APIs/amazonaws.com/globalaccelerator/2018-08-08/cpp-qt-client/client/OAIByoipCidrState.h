...
#ifndef OAIByoipCidrState_H
#define OAIByoipCidrState_H
...
class OAIByoipCidrState : public OAIEnum {
public:
    OAIByoipCidrState();
    OAIByoipCidrState(QString json);
    ~OAIByoipCidrState() override;
    ...
    OAIByoipCidrState::eOAIByoipCidrState getValue() const;
    void setValue(const OAIByoipCidrState::eOAIByoipCidrState& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIByoipCidrState)

#endif // OAIByoipCidrState_H
