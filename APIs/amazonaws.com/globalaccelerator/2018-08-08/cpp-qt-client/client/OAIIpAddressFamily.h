...
/*
 * OAIIpAddressFamily.h
 *
 * 
 */

#ifndef OAIIpAddressFamily_H
#define OAIIpAddressFamily_H
...
class OAIIpAddressFamily : public OAIEnum {
public:
    OAIIpAddressFamily();
    OAIIpAddressFamily(QString json);
    ~OAIIpAddressFamily() override;
    ...
    enum class eOAIIpAddressFamily {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        IPV4, 
        IPV6
    };
    OAIIpAddressFamily::eOAIIpAddressFamily getValue() const;
    void setValue(const OAIIpAddressFamily::eOAIIpAddressFamily& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIIpAddressFamily)

#endif // OAIIpAddressFamily_H
