...
/*
 * OAIUpdateCustomRoutingAcceleratorRequest.h
 *
 * 
 */

#ifndef OAIUpdateCustomRoutingAcceleratorRequest_H
#define OAIUpdateCustomRoutingAcceleratorRequest_H
...
class OAIUpdateCustomRoutingAcceleratorRequest : public OAIObject {
public:
    OAIUpdateCustomRoutingAcceleratorRequest();
    OAIUpdateCustomRoutingAcceleratorRequest(QString json);
    ~OAIUpdateCustomRoutingAcceleratorRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateCustomRoutingAcceleratorRequest)

#endif // OAIUpdateCustomRoutingAcceleratorRequest_H
