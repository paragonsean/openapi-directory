...
/*
 * OAICreateCustomRoutingAcceleratorResponse.h
 *
 * 
 */

#ifndef OAICreateCustomRoutingAcceleratorResponse_H
#define OAICreateCustomRoutingAcceleratorResponse_H
...
namespace OpenAPI {
class OAICreateCustomRoutingAcceleratorResponse_Accelerator;

class OAICreateCustomRoutingAcceleratorResponse : public OAIObject {
public:
    OAICreateCustomRoutingAcceleratorResponse();
    OAICreateCustomRoutingAcceleratorResponse(QString json);
    ~OAICreateCustomRoutingAcceleratorResponse() override;
    ...
    OAICreateCustomRoutingAcceleratorResponse_Accelerator getAccelerator() const;
    void setAccelerator(const OAICreateCustomRoutingAcceleratorResponse_Accelerator &accelerator);
...
private:
    ...
    OAICreateCustomRoutingAcceleratorResponse_Accelerator m_accelerator;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCustomRoutingAcceleratorResponse)

#endif // OAICreateCustomRoutingAcceleratorResponse_H
