...
#ifndef OAIClientAffinity_H
#define OAIClientAffinity_H
...
class OAIClientAffinity : public OAIEnum {
public:
    OAIClientAffinity();
    OAIClientAffinity(QString json);
    ~OAIClientAffinity() override;
    ...
    enum class eOAIClientAffinity {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        NONE, 
        SOURCE_IP
    };
    OAIClientAffinity::eOAIClientAffinity getValue() const;
    void setValue(const OAIClientAffinity::eOAIClientAffinity& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIClientAffinity)

#endif // OAIClientAffinity_H
