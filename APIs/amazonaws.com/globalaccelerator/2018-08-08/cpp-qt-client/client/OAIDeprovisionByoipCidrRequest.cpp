...
OAIDeprovisionByoipCidrRequest::OAIDeprovisionByoipCidrRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeprovisionByoipCidrRequest::OAIDeprovisionByoipCidrRequest() {
    this->initializeModel();
}

OAIDeprovisionByoipCidrRequest::~OAIDeprovisionByoipCidrRequest() {}

void OAIDeprovisionByoipCidrRequest::initializeModel() {

    m_cidr_isSet = false;
    m_cidr_isValid = false;
}

void OAIDeprovisionByoipCidrRequest::fromJson(QString jsonString) {
...
void OAIDeprovisionByoipCidrRequest::fromJsonObject(QJsonObject json) {

    m_cidr_isValid = ::OpenAPI::fromJsonValue(m_cidr, json[QString("Cidr")]);
    m_cidr_isSet = !json[QString("Cidr")].isNull() && m_cidr_isValid;
}

QString OAIDeprovisionByoipCidrRequest::asJson() const {
...
QJsonObject OAIDeprovisionByoipCidrRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_cidr_isSet) {
...
QString OAIDeprovisionByoipCidrRequest::getCidr() const {
    return m_cidr;
}
void OAIDeprovisionByoipCidrRequest::setCidr(const QString &cidr) {
    m_cidr = cidr;
    m_cidr_isSet = true;
}

bool OAIDeprovisionByoipCidrRequest::is_cidr_Set() const{
    return m_cidr_isSet;
}

bool OAIDeprovisionByoipCidrRequest::is_cidr_Valid() const{
    return m_cidr_isValid;
}

bool OAIDeprovisionByoipCidrRequest::isSet() const {
...
bool OAIDeprovisionByoipCidrRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_cidr_isValid && true;
}
