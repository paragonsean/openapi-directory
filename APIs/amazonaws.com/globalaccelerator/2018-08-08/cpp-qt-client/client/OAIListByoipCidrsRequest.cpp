...
OAIListByoipCidrsRequest::OAIListByoipCidrsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListByoipCidrsRequest::OAIListByoipCidrsRequest() {
    this->initializeModel();
}

OAIListByoipCidrsRequest::~OAIListByoipCidrsRequest() {}

void OAIListByoipCidrsRequest::initializeModel() {
...
void OAIListByoipCidrsRequest::fromJson(QString jsonString) {
...
void OAIListByoipCidrsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListByoipCidrsRequest::asJson() const {
...
QJsonObject OAIListByoipCidrsRequest::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIListByoipCidrsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListByoipCidrsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListByoipCidrsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListByoipCidrsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListByoipCidrsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListByoipCidrsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListByoipCidrsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListByoipCidrsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListByoipCidrsRequest::isSet() const {
...
bool OAIListByoipCidrsRequest::isValid() const {
