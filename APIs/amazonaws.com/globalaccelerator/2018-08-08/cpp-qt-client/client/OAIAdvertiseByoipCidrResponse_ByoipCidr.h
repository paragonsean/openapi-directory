...
/*
 * OAIAdvertiseByoipCidrResponse_ByoipCidr.h
 *
 * 
 */

#ifndef OAIAdvertiseByoipCidrResponse_ByoipCidr_H
#define OAIAdvertiseByoipCidrResponse_ByoipCidr_H
...
class OAIAdvertiseByoipCidrResponse_ByoipCidr : public OAIObject {
public:
    OAIAdvertiseByoipCidrResponse_ByoipCidr();
    OAIAdvertiseByoipCidrResponse_ByoipCidr(QString json);
    ~OAIAdvertiseByoipCidrResponse_ByoipCidr() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdvertiseByoipCidrResponse_ByoipCidr)

#endif // OAIAdvertiseByoipCidrResponse_ByoipCidr_H
