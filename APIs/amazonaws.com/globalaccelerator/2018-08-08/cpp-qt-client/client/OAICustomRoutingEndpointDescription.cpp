...
#include "OAICustomRoutingEndpointDescription.h"
...
OAICustomRoutingEndpointDescription::OAICustomRoutingEndpointDescription(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICustomRoutingEndpointDescription::OAICustomRoutingEndpointDescription() {
    this->initializeModel();
}

OAICustomRoutingEndpointDescription::~OAICustomRoutingEndpointDescription() {}

void OAICustomRoutingEndpointDescription::initializeModel() {

    m_endpoint_id_isSet = false;
    m_endpoint_id_isValid = false;
}

void OAICustomRoutingEndpointDescription::fromJson(QString jsonString) {
...
void OAICustomRoutingEndpointDescription::fromJsonObject(QJsonObject json) {
...
QString OAICustomRoutingEndpointDescription::asJson() const {
...
QJsonObject OAICustomRoutingEndpointDescription::asJsonObject() const {
    QJsonObject obj;
...
QString OAICustomRoutingEndpointDescription::getEndpointId() const {
    return m_endpoint_id;
}
void OAICustomRoutingEndpointDescription::setEndpointId(const QString &endpoint_id) {
    m_endpoint_id = endpoint_id;
    m_endpoint_id_isSet = true;
}

bool OAICustomRoutingEndpointDescription::is_endpoint_id_Set() const{
    return m_endpoint_id_isSet;
}

bool OAICustomRoutingEndpointDescription::is_endpoint_id_Valid() const{
    return m_endpoint_id_isValid;
}

bool OAICustomRoutingEndpointDescription::isSet() const {
...
bool OAICustomRoutingEndpointDescription::isValid() const {
