...
#include "OAICustomRoutingProtocol.h"
...
OAICustomRoutingProtocol::OAICustomRoutingProtocol(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICustomRoutingProtocol::OAICustomRoutingProtocol() {
    this->initializeModel();
}

OAICustomRoutingProtocol::~OAICustomRoutingProtocol() {}

void OAICustomRoutingProtocol::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAICustomRoutingProtocol::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAICustomRoutingProtocol::fromJson(QString jsonString) {
    
    if ( jsonString.compare("TCP", Qt::CaseInsensitive) == 0) {
        m_value = eOAICustomRoutingProtocol::TCP;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("UDP", Qt::CaseInsensitive) == 0) {
        m_value = eOAICustomRoutingProtocol::UDP;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAICustomRoutingProtocol::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAICustomRoutingProtocol::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAICustomRoutingProtocol::TCP:
            val = "TCP";
            break;
        case eOAICustomRoutingProtocol::UDP:
            val = "UDP";
            break;
        default:
            break;
...
QJsonValue OAICustomRoutingProtocol::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAICustomRoutingProtocol::eOAICustomRoutingProtocol OAICustomRoutingProtocol::getValue() const {
    return m_value;
}

void OAICustomRoutingProtocol::setValue(const OAICustomRoutingProtocol::eOAICustomRoutingProtocol& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAICustomRoutingProtocol::isSet() const {
    
    return m_value_isSet;
}

bool OAICustomRoutingProtocol::isValid() const {
