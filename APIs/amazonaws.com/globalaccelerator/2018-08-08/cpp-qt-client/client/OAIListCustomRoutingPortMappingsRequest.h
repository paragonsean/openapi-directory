...
/*
 * OAIListCustomRoutingPortMappingsRequest.h
 *
 * 
 */

#ifndef OAIListCustomRoutingPortMappingsRequest_H
#define OAIListCustomRoutingPortMappingsRequest_H
...
class OAIListCustomRoutingPortMappingsRequest : public OAIObject {
public:
    OAIListCustomRoutingPortMappingsRequest();
    OAIListCustomRoutingPortMappingsRequest(QString json);
    ~OAIListCustomRoutingPortMappingsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListCustomRoutingPortMappingsRequest)

#endif // OAIListCustomRoutingPortMappingsRequest_H
