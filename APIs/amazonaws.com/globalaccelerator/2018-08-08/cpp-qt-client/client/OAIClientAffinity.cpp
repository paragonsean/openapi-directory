...
OAIClientAffinity::OAIClientAffinity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIClientAffinity::OAIClientAffinity() {
    this->initializeModel();
}

OAIClientAffinity::~OAIClientAffinity() {}

void OAIClientAffinity::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIClientAffinity::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIClientAffinity::fromJson(QString jsonString) {
    
    if ( jsonString.compare("NONE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIClientAffinity::NONE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SOURCE_IP", Qt::CaseInsensitive) == 0) {
        m_value = eOAIClientAffinity::SOURCE_IP;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIClientAffinity::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIClientAffinity::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIClientAffinity::NONE:
            val = "NONE";
            break;
        case eOAIClientAffinity::SOURCE_IP:
            val = "SOURCE_IP";
            break;
        default:
            break;
...
QJsonValue OAIClientAffinity::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIClientAffinity::eOAIClientAffinity OAIClientAffinity::getValue() const {
    return m_value;
}

void OAIClientAffinity::setValue(const OAIClientAffinity::eOAIClientAffinity& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIClientAffinity::isSet() const {
    
    return m_value_isSet;
}

bool OAIClientAffinity::isValid() const {
