...
/*
 * OAIDeleteAcceleratorRequest.h
 *
 * 
 */

#ifndef OAIDeleteAcceleratorRequest_H
#define OAIDeleteAcceleratorRequest_H
...
class OAIDeleteAcceleratorRequest : public OAIObject {
public:
    OAIDeleteAcceleratorRequest();
    OAIDeleteAcceleratorRequest(QString json);
    ~OAIDeleteAcceleratorRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteAcceleratorRequest)

#endif // OAIDeleteAcceleratorRequest_H
