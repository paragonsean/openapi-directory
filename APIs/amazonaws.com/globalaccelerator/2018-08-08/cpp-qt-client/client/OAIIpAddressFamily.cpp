...
OAIIpAddressFamily::OAIIpAddressFamily(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIpAddressFamily::OAIIpAddressFamily() {
    this->initializeModel();
}

OAIIpAddressFamily::~OAIIpAddressFamily() {}

void OAIIpAddressFamily::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIIpAddressFamily::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIIpAddressFamily::fromJson(QString jsonString) {
    
    if ( jsonString.compare("IPv4", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIpAddressFamily::IPV4;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("IPv6", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIpAddressFamily::IPV6;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIIpAddressFamily::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIIpAddressFamily::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIIpAddressFamily::IPV4:
            val = "IPv4";
            break;
        case eOAIIpAddressFamily::IPV6:
            val = "IPv6";
            break;
        default:
            break;
...
QJsonValue OAIIpAddressFamily::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIIpAddressFamily::eOAIIpAddressFamily OAIIpAddressFamily::getValue() const {
    return m_value;
}

void OAIIpAddressFamily::setValue(const OAIIpAddressFamily::eOAIIpAddressFamily& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIIpAddressFamily::isSet() const {
    
    return m_value_isSet;
}

bool OAIIpAddressFamily::isValid() const {
