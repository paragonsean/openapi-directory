...
/*
 * OAICustomRoutingEndpointConfiguration.h
 *
 * The list of endpoint objects. For custom routing, this is a list of virtual private cloud (VPC) subnet IDs.
 */

#ifndef OAICustomRoutingEndpointConfiguration_H
#define OAICustomRoutingEndpointConfiguration_H
...
class OAICustomRoutingEndpointConfiguration : public OAIObject {
public:
    OAICustomRoutingEndpointConfiguration();
    OAICustomRoutingEndpointConfiguration(QString json);
    ~OAICustomRoutingEndpointConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomRoutingEndpointConfiguration)

#endif // OAICustomRoutingEndpointConfiguration_H
