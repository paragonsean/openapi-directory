...
/*
 * OAICustomRoutingDestinationConfiguration.h
 *
 * For a custom routing accelerator, sets the port range and protocol for all endpoints (virtual private cloud subnets) in an endpoint group to accept client traffic on.
 */

#ifndef OAICustomRoutingDestinationConfiguration_H
#define OAICustomRoutingDestinationConfiguration_H
...
class OAICustomRoutingDestinationConfiguration : public OAIObject {
public:
    OAICustomRoutingDestinationConfiguration();
    OAICustomRoutingDestinationConfiguration(QString json);
    ~OAICustomRoutingDestinationConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomRoutingDestinationConfiguration)

#endif // OAICustomRoutingDestinationConfiguration_H
