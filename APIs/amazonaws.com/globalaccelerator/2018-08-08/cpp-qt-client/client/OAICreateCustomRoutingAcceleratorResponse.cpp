...
OAICreateCustomRoutingAcceleratorResponse::OAICreateCustomRoutingAcceleratorResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateCustomRoutingAcceleratorResponse::OAICreateCustomRoutingAcceleratorResponse() {
    this->initializeModel();
}

OAICreateCustomRoutingAcceleratorResponse::~OAICreateCustomRoutingAcceleratorResponse() {}

void OAICreateCustomRoutingAcceleratorResponse::initializeModel() {

    m_accelerator_isSet = false;
    m_accelerator_isValid = false;
}

void OAICreateCustomRoutingAcceleratorResponse::fromJson(QString jsonString) {
...
void OAICreateCustomRoutingAcceleratorResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateCustomRoutingAcceleratorResponse::asJson() const {
...
QJsonObject OAICreateCustomRoutingAcceleratorResponse::asJsonObject() const {
    QJsonObject obj;
...
OAICreateCustomRoutingAcceleratorResponse_Accelerator OAICreateCustomRoutingAcceleratorResponse::getAccelerator() const {
    return m_accelerator;
}
void OAICreateCustomRoutingAcceleratorResponse::setAccelerator(const OAICreateCustomRoutingAcceleratorResponse_Accelerator &accelerator) {
    m_accelerator = accelerator;
    m_accelerator_isSet = true;
}

bool OAICreateCustomRoutingAcceleratorResponse::is_accelerator_Set() const{
    return m_accelerator_isSet;
}

bool OAICreateCustomRoutingAcceleratorResponse::is_accelerator_Valid() const{
    return m_accelerator_isValid;
}

bool OAICreateCustomRoutingAcceleratorResponse::isSet() const {
...
bool OAICreateCustomRoutingAcceleratorResponse::isValid() const {
