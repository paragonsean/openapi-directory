...
/*
 * OAIRemoveEndpointsRequest.h
 *
 * 
 */

#ifndef OAIRemoveEndpointsRequest_H
#define OAIRemoveEndpointsRequest_H
...
class OAIRemoveEndpointsRequest : public OAIObject {
public:
    OAIRemoveEndpointsRequest();
    OAIRemoveEndpointsRequest(QString json);
    ~OAIRemoveEndpointsRequest() override;
    ...
    QList getEndpointIdentifiers() const;
    void setEndpointIdentifiers(const QList &endpoint_identifiers);
    bool is_endpoint_identifiers_Set() const;
    bool is_endpoint_identifiers_Valid() const;
...
private:
    ...
    QList m_endpoint_identifiers;
    bool m_endpoint_identifiers_isSet;
    bool m_endpoint_identifiers_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRemoveEndpointsRequest)

#endif // OAIRemoveEndpointsRequest_H
