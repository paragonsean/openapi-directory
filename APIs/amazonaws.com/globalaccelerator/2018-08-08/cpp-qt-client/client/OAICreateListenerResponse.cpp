...
OAICreateListenerResponse_Listener OAICreateListenerResponse::getListener() const {
    return m_listener;
}
void OAICreateListenerResponse::setListener(const OAICreateListenerResponse_Listener &listener) {
    m_listener = listener;
    m_listener_isSet = true;
}

bool OAICreateListenerResponse::is_listener_Set() const{
    return m_listener_isSet;
}

bool OAICreateListenerResponse::is_listener_Valid() const{
