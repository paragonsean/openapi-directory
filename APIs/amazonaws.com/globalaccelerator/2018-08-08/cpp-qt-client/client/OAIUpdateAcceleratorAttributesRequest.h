...
/*
 * OAIUpdateAcceleratorAttributesRequest.h
 *
 * 
 */

#ifndef OAIUpdateAcceleratorAttributesRequest_H
#define OAIUpdateAcceleratorAttributesRequest_H
...
class OAIUpdateAcceleratorAttributesRequest : public OAIObject {
public:
    OAIUpdateAcceleratorAttributesRequest();
    OAIUpdateAcceleratorAttributesRequest(QString json);
    ~OAIUpdateAcceleratorAttributesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAcceleratorAttributesRequest)

#endif // OAIUpdateAcceleratorAttributesRequest_H
