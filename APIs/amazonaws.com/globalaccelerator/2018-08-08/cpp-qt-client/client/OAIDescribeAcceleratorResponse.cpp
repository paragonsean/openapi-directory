...
OAIDescribeAcceleratorResponse::OAIDescribeAcceleratorResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeAcceleratorResponse::OAIDescribeAcceleratorResponse() {
    this->initializeModel();
}

OAIDescribeAcceleratorResponse::~OAIDescribeAcceleratorResponse() {}

void OAIDescribeAcceleratorResponse::initializeModel() {

    m_accelerator_isSet = false;
    m_accelerator_isValid = false;
}

void OAIDescribeAcceleratorResponse::fromJson(QString jsonString) {
...
void OAIDescribeAcceleratorResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeAcceleratorResponse::asJson() const {
...
QJsonObject OAIDescribeAcceleratorResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIDescribeAcceleratorResponse_Accelerator OAIDescribeAcceleratorResponse::getAccelerator() const {
    return m_accelerator;
}
void OAIDescribeAcceleratorResponse::setAccelerator(const OAIDescribeAcceleratorResponse_Accelerator &accelerator) {
    m_accelerator = accelerator;
    m_accelerator_isSet = true;
}

bool OAIDescribeAcceleratorResponse::is_accelerator_Set() const{
    return m_accelerator_isSet;
}

bool OAIDescribeAcceleratorResponse::is_accelerator_Valid() const{
    return m_accelerator_isValid;
}

bool OAIDescribeAcceleratorResponse::isSet() const {
...
bool OAIDescribeAcceleratorResponse::isValid() const {
