...
/*
 * OAIAddEndpointsResponse.h
 *
 * 
 */

#ifndef OAIAddEndpointsResponse_H
#define OAIAddEndpointsResponse_H
...
class OAIAddEndpointsResponse : public OAIObject {
public:
    OAIAddEndpointsResponse();
    OAIAddEndpointsResponse(QString json);
    ~OAIAddEndpointsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddEndpointsResponse)

#endif // OAIAddEndpointsResponse_H
