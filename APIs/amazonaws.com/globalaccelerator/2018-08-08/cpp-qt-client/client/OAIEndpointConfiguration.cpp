...
QString OAIEndpointConfiguration::getEndpointId() const {
    return m_endpoint_id;
}
void OAIEndpointConfiguration::setEndpointId(const QString &endpoint_id) {
    m_endpoint_id = endpoint_id;
    m_endpoint_id_isSet = true;
}

bool OAIEndpointConfiguration::is_endpoint_id_Set() const{
    return m_endpoint_id_isSet;
}

bool OAIEndpointConfiguration::is_endpoint_id_Valid() const{
    return m_endpoint_id_isValid;
}

qint32 OAIEndpointConfiguration::getWeight() const {
    return m_weight;
}
void OAIEndpointConfiguration::setWeight(const qint32 &weight) {
    m_weight = weight;
    m_weight_isSet = true;
}

bool OAIEndpointConfiguration::is_weight_Set() const{
    return m_weight_isSet;
}

bool OAIEndpointConfiguration::is_weight_Valid() const{
    return m_weight_isValid;
}

bool OAIEndpointConfiguration::getClientIpPreservationEnabled() const {
    return m_client_ip_preservation_enabled;
}
void OAIEndpointConfiguration::setClientIpPreservationEnabled(const bool &client_ip_preservation_enabled) {
    m_client_ip_preservation_enabled = client_ip_preservation_enabled;
    m_client_ip_preservation_enabled_isSet = true;
}

bool OAIEndpointConfiguration::is_client_ip_preservation_enabled_Set() const{
    return m_client_ip_preservation_enabled_isSet;
}

bool OAIEndpointConfiguration::is_client_ip_preservation_enabled_Valid() const{
