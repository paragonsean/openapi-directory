...
OAIAddCustomRoutingEndpointsRequest::OAIAddCustomRoutingEndpointsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddCustomRoutingEndpointsRequest::OAIAddCustomRoutingEndpointsRequest() {
    this->initializeModel();
}

OAIAddCustomRoutingEndpointsRequest::~OAIAddCustomRoutingEndpointsRequest() {}

void OAIAddCustomRoutingEndpointsRequest::initializeModel() {
...
void OAIAddCustomRoutingEndpointsRequest::fromJson(QString jsonString) {
...
void OAIAddCustomRoutingEndpointsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAddCustomRoutingEndpointsRequest::asJson() const {
...
QJsonObject OAIAddCustomRoutingEndpointsRequest::asJsonObject() const {
    QJsonObject obj;
...
QList OAIAddCustomRoutingEndpointsRequest::getEndpointConfigurations() const {
    return m_endpoint_configurations;
}
void OAIAddCustomRoutingEndpointsRequest::setEndpointConfigurations(const QList &endpoint_configurations) {
    m_endpoint_configurations = endpoint_configurations;
    m_endpoint_configurations_isSet = true;
}

bool OAIAddCustomRoutingEndpointsRequest::is_endpoint_configurations_Set() const{
    return m_endpoint_configurations_isSet;
}

bool OAIAddCustomRoutingEndpointsRequest::is_endpoint_configurations_Valid() const{
    return m_endpoint_configurations_isValid;
}

QString OAIAddCustomRoutingEndpointsRequest::getEndpointGroupArn() const {
    return m_endpoint_group_arn;
}
void OAIAddCustomRoutingEndpointsRequest::setEndpointGroupArn(const QString &endpoint_group_arn) {
    m_endpoint_group_arn = endpoint_group_arn;
    m_endpoint_group_arn_isSet = true;
}

bool OAIAddCustomRoutingEndpointsRequest::is_endpoint_group_arn_Set() const{
    return m_endpoint_group_arn_isSet;
}

bool OAIAddCustomRoutingEndpointsRequest::is_endpoint_group_arn_Valid() const{
    return m_endpoint_group_arn_isValid;
}

bool OAIAddCustomRoutingEndpointsRequest::isSet() const {
...
bool OAIAddCustomRoutingEndpointsRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_endpoint_configurations_isValid && m_endpoint_group_arn_isValid && true;
}
