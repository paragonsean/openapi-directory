...
/*
 * OAIDescribeEndpointGroupRequest.h
 *
 * 
 */

#ifndef OAIDescribeEndpointGroupRequest_H
#define OAIDescribeEndpointGroupRequest_H
...
class OAIDescribeEndpointGroupRequest : public OAIObject {
public:
    OAIDescribeEndpointGroupRequest();
    OAIDescribeEndpointGroupRequest(QString json);
    ~OAIDescribeEndpointGroupRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEndpointGroupRequest)

#endif // OAIDescribeEndpointGroupRequest_H
