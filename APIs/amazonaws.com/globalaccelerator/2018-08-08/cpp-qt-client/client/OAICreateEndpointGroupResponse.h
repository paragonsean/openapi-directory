...
/*
 * OAICreateEndpointGroupResponse.h
 *
 * 
 */

#ifndef OAICreateEndpointGroupResponse_H
#define OAICreateEndpointGroupResponse_H
...
namespace OpenAPI {
class OAICreateEndpointGroupResponse_EndpointGroup;

class OAICreateEndpointGroupResponse : public OAIObject {
public:
    OAICreateEndpointGroupResponse();
    OAICreateEndpointGroupResponse(QString json);
    ~OAICreateEndpointGroupResponse() override;
    ...
    OAICreateEndpointGroupResponse_EndpointGroup getEndpointGroup() const;
    void setEndpointGroup(const OAICreateEndpointGroupResponse_EndpointGroup &endpoint_group);
...
private:
    ...
    OAICreateEndpointGroupResponse_EndpointGroup m_endpoint_group;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateEndpointGroupResponse)

#endif // OAICreateEndpointGroupResponse_H
