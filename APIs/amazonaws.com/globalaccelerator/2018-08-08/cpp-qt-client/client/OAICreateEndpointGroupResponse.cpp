...
OAICreateEndpointGroupResponse::OAICreateEndpointGroupResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateEndpointGroupResponse::OAICreateEndpointGroupResponse() {
    this->initializeModel();
}

OAICreateEndpointGroupResponse::~OAICreateEndpointGroupResponse() {}

void OAICreateEndpointGroupResponse::initializeModel() {

    m_endpoint_group_isSet = false;
    m_endpoint_group_isValid = false;
}

void OAICreateEndpointGroupResponse::fromJson(QString jsonString) {
...
void OAICreateEndpointGroupResponse::fromJsonObject(QJsonObject json) {

    m_endpoint_group_isValid = ::OpenAPI::fromJsonValue(m_endpoint_group, json[QString("EndpointGroup")]);
    m_endpoint_group_isSet = !json[QString("EndpointGroup")].isNull() && m_endpoint_group_isValid;
}

QString OAICreateEndpointGroupResponse::asJson() const {
...
QJsonObject OAICreateEndpointGroupResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_endpoint_group.isSet()) {
        obj.insert(QString("EndpointGroup"), ::OpenAPI::toJsonValue(m_endpoint_group));
    }
    return obj;
}

OAICreateEndpointGroupResponse_EndpointGroup OAICreateEndpointGroupResponse::getEndpointGroup() const {
    return m_endpoint_group;
}
void OAICreateEndpointGroupResponse::setEndpointGroup(const OAICreateEndpointGroupResponse_EndpointGroup &endpoint_group) {
    m_endpoint_group = endpoint_group;
    m_endpoint_group_isSet = true;
}

bool OAICreateEndpointGroupResponse::is_endpoint_group_Set() const{
    return m_endpoint_group_isSet;
}

bool OAICreateEndpointGroupResponse::is_endpoint_group_Valid() const{
    return m_endpoint_group_isValid;
}

bool OAICreateEndpointGroupResponse::isSet() const {
...
bool OAICreateEndpointGroupResponse::isValid() const {
