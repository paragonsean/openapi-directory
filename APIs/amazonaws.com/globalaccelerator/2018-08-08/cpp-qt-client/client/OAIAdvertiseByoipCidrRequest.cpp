...
OAIAdvertiseByoipCidrRequest::OAIAdvertiseByoipCidrRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdvertiseByoipCidrRequest::OAIAdvertiseByoipCidrRequest() {
    this->initializeModel();
}

OAIAdvertiseByoipCidrRequest::~OAIAdvertiseByoipCidrRequest() {}

void OAIAdvertiseByoipCidrRequest::initializeModel() {

    m_cidr_isSet = false;
    m_cidr_isValid = false;
}

void OAIAdvertiseByoipCidrRequest::fromJson(QString jsonString) {
...
void OAIAdvertiseByoipCidrRequest::fromJsonObject(QJsonObject json) {

    m_cidr_isValid = ::OpenAPI::fromJsonValue(m_cidr, json[QString("Cidr")]);
    m_cidr_isSet = !json[QString("Cidr")].isNull() && m_cidr_isValid;
}

QString OAIAdvertiseByoipCidrRequest::asJson() const {
...
QJsonObject OAIAdvertiseByoipCidrRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_cidr_isSet) {
...
QString OAIAdvertiseByoipCidrRequest::getCidr() const {
    return m_cidr;
}
void OAIAdvertiseByoipCidrRequest::setCidr(const QString &cidr) {
    m_cidr = cidr;
    m_cidr_isSet = true;
}

bool OAIAdvertiseByoipCidrRequest::is_cidr_Set() const{
    return m_cidr_isSet;
}

bool OAIAdvertiseByoipCidrRequest::is_cidr_Valid() const{
    return m_cidr_isValid;
}

bool OAIAdvertiseByoipCidrRequest::isSet() const {
...
bool OAIAdvertiseByoipCidrRequest::isValid() const {
