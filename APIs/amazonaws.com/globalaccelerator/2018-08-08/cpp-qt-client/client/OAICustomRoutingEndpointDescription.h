...
/*
 * OAICustomRoutingEndpointDescription.h
 *
 * A complex type for an endpoint for a custom routing accelerator. Each endpoint group can include one or more endpoints, which are virtual private cloud (VPC) subnets.
 */

#ifndef OAICustomRoutingEndpointDescription_H
#define OAICustomRoutingEndpointDescription_H
...
class OAICustomRoutingEndpointDescription : public OAIObject {
public:
    OAICustomRoutingEndpointDescription();
    OAICustomRoutingEndpointDescription(QString json);
    ~OAICustomRoutingEndpointDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomRoutingEndpointDescription)

#endif // OAICustomRoutingEndpointDescription_H
