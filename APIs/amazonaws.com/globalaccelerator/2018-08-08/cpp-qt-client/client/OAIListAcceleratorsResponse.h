...
/*
 * OAIListAcceleratorsResponse.h
 *
 * 
 */

#ifndef OAIListAcceleratorsResponse_H
#define OAIListAcceleratorsResponse_H
...
class OAIListAcceleratorsResponse : public OAIObject {
public:
    OAIListAcceleratorsResponse();
    OAIListAcceleratorsResponse(QString json);
    ~OAIListAcceleratorsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAcceleratorsResponse)

#endif // OAIListAcceleratorsResponse_H
