...
/*
 * OAIDescribeAcceleratorRequest.h
 *
 * 
 */

#ifndef OAIDescribeAcceleratorRequest_H
#define OAIDescribeAcceleratorRequest_H
...
class OAIDescribeAcceleratorRequest : public OAIObject {
public:
    OAIDescribeAcceleratorRequest();
    OAIDescribeAcceleratorRequest(QString json);
    ~OAIDescribeAcceleratorRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAcceleratorRequest)

#endif // OAIDescribeAcceleratorRequest_H
