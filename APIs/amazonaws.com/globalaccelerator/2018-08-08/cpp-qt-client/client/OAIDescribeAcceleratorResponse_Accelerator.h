...
/*
 * OAIDescribeAcceleratorResponse_Accelerator.h
 *
 * 
 */

#ifndef OAIDescribeAcceleratorResponse_Accelerator_H
#define OAIDescribeAcceleratorResponse_Accelerator_H
...
class OAIDescribeAcceleratorResponse_Accelerator : public OAIObject {
public:
    OAIDescribeAcceleratorResponse_Accelerator();
    OAIDescribeAcceleratorResponse_Accelerator(QString json);
    ~OAIDescribeAcceleratorResponse_Accelerator() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAcceleratorResponse_Accelerator)

#endif // OAIDescribeAcceleratorResponse_Accelerator_H
