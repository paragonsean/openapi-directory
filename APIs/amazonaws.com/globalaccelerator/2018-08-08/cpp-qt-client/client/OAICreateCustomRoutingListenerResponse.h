...
/*
 * OAICreateCustomRoutingListenerResponse.h
 *
 * 
 */

#ifndef OAICreateCustomRoutingListenerResponse_H
#define OAICreateCustomRoutingListenerResponse_H
...
namespace OpenAPI {
class OAICreateCustomRoutingListenerResponse_Listener;

class OAICreateCustomRoutingListenerResponse : public OAIObject {
public:
    OAICreateCustomRoutingListenerResponse();
    OAICreateCustomRoutingListenerResponse(QString json);
    ~OAICreateCustomRoutingListenerResponse() override;
    ...
    OAICreateCustomRoutingListenerResponse_Listener getListener() const;
    void setListener(const OAICreateCustomRoutingListenerResponse_Listener &listener);
...
private:
    ...
    OAICreateCustomRoutingListenerResponse_Listener m_listener;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCustomRoutingListenerResponse)

#endif // OAICreateCustomRoutingListenerResponse_H
