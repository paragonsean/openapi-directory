...
/*
 * OAIDescribeCustomRoutingAcceleratorRequest.h
 *
 * 
 */

#ifndef OAIDescribeCustomRoutingAcceleratorRequest_H
#define OAIDescribeCustomRoutingAcceleratorRequest_H
...
class OAIDescribeCustomRoutingAcceleratorRequest : public OAIObject {
public:
    OAIDescribeCustomRoutingAcceleratorRequest();
    OAIDescribeCustomRoutingAcceleratorRequest(QString json);
    ~OAIDescribeCustomRoutingAcceleratorRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCustomRoutingAcceleratorRequest)

#endif // OAIDescribeCustomRoutingAcceleratorRequest_H
