...
/*
 * OAIListCustomRoutingEndpointGroupsRequest.h
 *
 * 
 */

#ifndef OAIListCustomRoutingEndpointGroupsRequest_H
#define OAIListCustomRoutingEndpointGroupsRequest_H
...
class OAIListCustomRoutingEndpointGroupsRequest : public OAIObject {
public:
    OAIListCustomRoutingEndpointGroupsRequest();
    OAIListCustomRoutingEndpointGroupsRequest(QString json);
    ~OAIListCustomRoutingEndpointGroupsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListCustomRoutingEndpointGroupsRequest)

#endif // OAIListCustomRoutingEndpointGroupsRequest_H
