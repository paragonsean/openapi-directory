...
OAIUpdateEndpointGroupResponse::OAIUpdateEndpointGroupResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateEndpointGroupResponse::OAIUpdateEndpointGroupResponse() {
    this->initializeModel();
}

OAIUpdateEndpointGroupResponse::~OAIUpdateEndpointGroupResponse() {}

void OAIUpdateEndpointGroupResponse::initializeModel() {

    m_endpoint_group_isSet = false;
    m_endpoint_group_isValid = false;
}

void OAIUpdateEndpointGroupResponse::fromJson(QString jsonString) {
...
void OAIUpdateEndpointGroupResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateEndpointGroupResponse::asJson() const {
...
QJsonObject OAIUpdateEndpointGroupResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdateEndpointGroupResponse_EndpointGroup OAIUpdateEndpointGroupResponse::getEndpointGroup() const {
    return m_endpoint_group;
}
void OAIUpdateEndpointGroupResponse::setEndpointGroup(const OAIUpdateEndpointGroupResponse_EndpointGroup &endpoint_group) {
    m_endpoint_group = endpoint_group;
    m_endpoint_group_isSet = true;
}

bool OAIUpdateEndpointGroupResponse::is_endpoint_group_Set() const{
    return m_endpoint_group_isSet;
}

bool OAIUpdateEndpointGroupResponse::is_endpoint_group_Valid() const{
    return m_endpoint_group_isValid;
}

bool OAIUpdateEndpointGroupResponse::isSet() const {
...
bool OAIUpdateEndpointGroupResponse::isValid() const {
