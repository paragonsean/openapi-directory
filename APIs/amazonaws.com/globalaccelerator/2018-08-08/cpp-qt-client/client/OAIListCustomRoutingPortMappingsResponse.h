...
/*
 * OAIListCustomRoutingPortMappingsResponse.h
 *
 * 
 */

#ifndef OAIListCustomRoutingPortMappingsResponse_H
#define OAIListCustomRoutingPortMappingsResponse_H
...
class OAIListCustomRoutingPortMappingsResponse : public OAIObject {
public:
    OAIListCustomRoutingPortMappingsResponse();
    OAIListCustomRoutingPortMappingsResponse(QString json);
    ~OAIListCustomRoutingPortMappingsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListCustomRoutingPortMappingsResponse)

#endif // OAIListCustomRoutingPortMappingsResponse_H
