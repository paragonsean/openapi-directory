...
#ifndef OAIAcceleratorEvent_H
#define OAIAcceleratorEvent_H
...
class OAIAcceleratorEvent : public OAIObject {
public:
    OAIAcceleratorEvent();
    OAIAcceleratorEvent(QString json);
    ~OAIAcceleratorEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAcceleratorEvent)

#endif // OAIAcceleratorEvent_H
