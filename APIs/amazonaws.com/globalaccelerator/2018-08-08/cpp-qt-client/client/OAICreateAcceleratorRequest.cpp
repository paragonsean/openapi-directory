...
OAICreateAcceleratorRequest::OAICreateAcceleratorRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateAcceleratorRequest::OAICreateAcceleratorRequest() {
    this->initializeModel();
}

OAICreateAcceleratorRequest::~OAICreateAcceleratorRequest() {}

void OAICreateAcceleratorRequest::initializeModel() {
...
void OAICreateAcceleratorRequest::fromJson(QString jsonString) {
...
void OAICreateAcceleratorRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateAcceleratorRequest::asJson() const {
...
QJsonObject OAICreateAcceleratorRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAICreateAcceleratorRequest::getName() const {
    return m_name;
}
void OAICreateAcceleratorRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateAcceleratorRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateAcceleratorRequest::is_name_Valid() const{
    return m_name_isValid;
}

OAIIpAddressType OAICreateAcceleratorRequest::getIpAddressType() const {
    return m_ip_address_type;
}
void OAICreateAcceleratorRequest::setIpAddressType(const OAIIpAddressType &ip_address_type) {
    m_ip_address_type = ip_address_type;
    m_ip_address_type_isSet = true;
}

bool OAICreateAcceleratorRequest::is_ip_address_type_Set() const{
    return m_ip_address_type_isSet;
}

bool OAICreateAcceleratorRequest::is_ip_address_type_Valid() const{
    return m_ip_address_type_isValid;
}

QList OAICreateAcceleratorRequest::getIpAddresses() const {
    return m_ip_addresses;
}
void OAICreateAcceleratorRequest::setIpAddresses(const QList &ip_addresses) {
    m_ip_addresses = ip_addresses;
    m_ip_addresses_isSet = true;
}

bool OAICreateAcceleratorRequest::is_ip_addresses_Set() const{
    return m_ip_addresses_isSet;
}

bool OAICreateAcceleratorRequest::is_ip_addresses_Valid() const{
    return m_ip_addresses_isValid;
}

bool OAICreateAcceleratorRequest::getEnabled() const {
    return m_enabled;
}
void OAICreateAcceleratorRequest::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAICreateAcceleratorRequest::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAICreateAcceleratorRequest::is_enabled_Valid() const{
    return m_enabled_isValid;
}

QString OAICreateAcceleratorRequest::getIdempotencyToken() const {
    return m_idempotency_token;
}
void OAICreateAcceleratorRequest::setIdempotencyToken(const QString &idempotency_token) {
    m_idempotency_token = idempotency_token;
    m_idempotency_token_isSet = true;
}

bool OAICreateAcceleratorRequest::is_idempotency_token_Set() const{
    return m_idempotency_token_isSet;
}

bool OAICreateAcceleratorRequest::is_idempotency_token_Valid() const{
    return m_idempotency_token_isValid;
}

QList OAICreateAcceleratorRequest::getTags() const {
    return m_tags;
}
void OAICreateAcceleratorRequest::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateAcceleratorRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateAcceleratorRequest::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAICreateAcceleratorRequest::isSet() const {
...
bool OAICreateAcceleratorRequest::isValid() const {
