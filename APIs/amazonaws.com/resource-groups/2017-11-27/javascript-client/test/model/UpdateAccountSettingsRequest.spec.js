...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.UpdateAccountSettingsRequest();
  });
  ...
  describe('UpdateAccountSettingsRequest', function() {
    it('should create an instance of UpdateAccountSettingsRequest', function() {
      // uncomment below and update the code to test UpdateAccountSettingsRequest
      //var instance = new AwsResourceGroups.UpdateAccountSettingsRequest();
      //expect(instance).to.be.a(AwsResourceGroups.UpdateAccountSettingsRequest);
    });
