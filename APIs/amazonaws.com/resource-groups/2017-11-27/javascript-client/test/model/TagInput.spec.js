...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.TagInput();
  });
  ...
  describe('TagInput', function() {
    it('should create an instance of TagInput', function() {
      // uncomment below and update the code to test TagInput
      //var instance = new AwsResourceGroups.TagInput();
      //expect(instance).to.be.a(AwsResourceGroups.TagInput);
    });
