...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.GroupQueryResourceQuery();
  });
  ...
  describe('GroupQueryResourceQuery', function() {
    it('should create an instance of GroupQueryResourceQuery', function() {
      // uncomment below and update the code to test GroupQueryResourceQuery
      //var instance = new AwsResourceGroups.GroupQueryResourceQuery();
      //expect(instance).to.be.a(AwsResourceGroups.GroupQueryResourceQuery);
    });
