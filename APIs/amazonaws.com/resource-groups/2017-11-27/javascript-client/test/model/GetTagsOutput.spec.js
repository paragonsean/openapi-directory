...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.GetTagsOutput();
  });
  ...
  describe('GetTagsOutput', function() {
    it('should create an instance of GetTagsOutput', function() {
      // uncomment below and update the code to test GetTagsOutput
      //var instance = new AwsResourceGroups.GetTagsOutput();
      //expect(instance).to.be.a(AwsResourceGroups.GetTagsOutput);
    });
