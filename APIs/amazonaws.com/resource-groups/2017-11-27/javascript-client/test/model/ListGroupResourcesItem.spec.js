...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.ListGroupResourcesItem();
  });
  ...
  describe('ListGroupResourcesItem', function() {
    it('should create an instance of ListGroupResourcesItem', function() {
      // uncomment below and update the code to test ListGroupResourcesItem
      //var instance = new AwsResourceGroups.ListGroupResourcesItem();
      //expect(instance).to.be.a(AwsResourceGroups.ListGroupResourcesItem);
    });
