...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.SearchResourcesInputResourceQuery();
  });
  ...
  describe('SearchResourcesInputResourceQuery', function() {
    it('should create an instance of SearchResourcesInputResourceQuery', function() {
      // uncomment below and update the code to test SearchResourcesInputResourceQuery
      //var instance = new AwsResourceGroups.SearchResourcesInputResourceQuery();
      //expect(instance).to.be.a(AwsResourceGroups.SearchResourcesInputResourceQuery);
    });
