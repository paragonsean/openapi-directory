...
(function(root, factory) {
  ...
  describe('GroupFilterName', function() {
    it('should create an instance of GroupFilterName', function() {
      // uncomment below and update the code to test GroupFilterName
      //var instance = new AwsResourceGroups.GroupFilterName();
      //expect(instance).to.be.a(AwsResourceGroups.GroupFilterName);
    });
