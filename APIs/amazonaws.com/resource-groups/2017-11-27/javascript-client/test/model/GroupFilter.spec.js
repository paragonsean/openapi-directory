...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.GroupFilter();
  });
  ...
  describe('GroupFilter', function() {
    it('should create an instance of GroupFilter', function() {
      // uncomment below and update the code to test GroupFilter
      //var instance = new AwsResourceGroups.GroupFilter();
      //expect(instance).to.be.a(AwsResourceGroups.GroupFilter);
    });
