...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.DeleteGroupInput();
  });
  ...
  describe('DeleteGroupInput', function() {
    it('should create an instance of DeleteGroupInput', function() {
      // uncomment below and update the code to test DeleteGroupInput
      //var instance = new AwsResourceGroups.DeleteGroupInput();
      //expect(instance).to.be.a(AwsResourceGroups.DeleteGroupInput);
    });
