...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.CreateGroupOutputGroup();
  });
  ...
  describe('CreateGroupOutputGroup', function() {
    it('should create an instance of CreateGroupOutputGroup', function() {
      // uncomment below and update the code to test CreateGroupOutputGroup
      //var instance = new AwsResourceGroups.CreateGroupOutputGroup();
      //expect(instance).to.be.a(AwsResourceGroups.CreateGroupOutputGroup);
    });
