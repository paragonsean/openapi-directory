...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.ListGroupResourcesItemStatus();
  });
  ...
  describe('ListGroupResourcesItemStatus', function() {
    it('should create an instance of ListGroupResourcesItemStatus', function() {
      // uncomment below and update the code to test ListGroupResourcesItemStatus
      //var instance = new AwsResourceGroups.ListGroupResourcesItemStatus();
      //expect(instance).to.be.a(AwsResourceGroups.ListGroupResourcesItemStatus);
    });
