...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.PendingResource();
  });
  ...
  describe('PendingResource', function() {
    it('should create an instance of PendingResource', function() {
      // uncomment below and update the code to test PendingResource
      //var instance = new AwsResourceGroups.PendingResource();
      //expect(instance).to.be.a(AwsResourceGroups.PendingResource);
    });
