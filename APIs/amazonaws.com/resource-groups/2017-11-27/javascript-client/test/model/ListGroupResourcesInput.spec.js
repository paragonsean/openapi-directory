...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.ListGroupResourcesInput();
  });
  ...
  describe('ListGroupResourcesInput', function() {
    it('should create an instance of ListGroupResourcesInput', function() {
      // uncomment below and update the code to test ListGroupResourcesInput
      //var instance = new AwsResourceGroups.ListGroupResourcesInput();
      //expect(instance).to.be.a(AwsResourceGroups.ListGroupResourcesInput);
    });
