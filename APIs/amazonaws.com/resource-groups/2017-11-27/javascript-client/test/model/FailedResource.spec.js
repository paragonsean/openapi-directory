...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.FailedResource();
  });
  ...
  describe('FailedResource', function() {
    it('should create an instance of FailedResource', function() {
      // uncomment below and update the code to test FailedResource
      //var instance = new AwsResourceGroups.FailedResource();
      //expect(instance).to.be.a(AwsResourceGroups.FailedResource);
    });
