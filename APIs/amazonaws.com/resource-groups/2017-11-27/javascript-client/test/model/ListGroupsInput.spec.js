...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.ListGroupsInput();
  });
  ...
  describe('ListGroupsInput', function() {
    it('should create an instance of ListGroupsInput', function() {
      // uncomment below and update the code to test ListGroupsInput
      //var instance = new AwsResourceGroups.ListGroupsInput();
      //expect(instance).to.be.a(AwsResourceGroups.ListGroupsInput);
    });
