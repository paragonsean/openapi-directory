...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.UpdateGroupInput();
  });
  ...
  describe('UpdateGroupInput', function() {
    it('should create an instance of UpdateGroupInput', function() {
      // uncomment below and update the code to test UpdateGroupInput
      //var instance = new AwsResourceGroups.UpdateGroupInput();
      //expect(instance).to.be.a(AwsResourceGroups.UpdateGroupInput);
    });
