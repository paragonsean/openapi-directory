...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.GetGroupQueryInput();
  });
  ...
  describe('GetGroupQueryInput', function() {
    it('should create an instance of GetGroupQueryInput', function() {
      // uncomment below and update the code to test GetGroupQueryInput
      //var instance = new AwsResourceGroups.GetGroupQueryInput();
      //expect(instance).to.be.a(AwsResourceGroups.GetGroupQueryInput);
    });
