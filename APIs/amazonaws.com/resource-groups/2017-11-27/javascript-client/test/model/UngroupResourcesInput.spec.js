...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.UngroupResourcesInput();
  });
  ...
  describe('UngroupResourcesInput', function() {
    it('should create an instance of UngroupResourcesInput', function() {
      // uncomment below and update the code to test UngroupResourcesInput
      //var instance = new AwsResourceGroups.UngroupResourcesInput();
      //expect(instance).to.be.a(AwsResourceGroups.UngroupResourcesInput);
    });
