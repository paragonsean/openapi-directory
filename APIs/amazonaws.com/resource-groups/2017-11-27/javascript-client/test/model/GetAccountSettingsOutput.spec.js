...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.GetAccountSettingsOutput();
  });
  ...
  describe('GetAccountSettingsOutput', function() {
    it('should create an instance of GetAccountSettingsOutput', function() {
      ...
      //var instance = new AwsResourceGroups.GetAccountSettingsOutput();
      //expect(instance).to.be.a(AwsResourceGroups.GetAccountSettingsOutput);
    });
