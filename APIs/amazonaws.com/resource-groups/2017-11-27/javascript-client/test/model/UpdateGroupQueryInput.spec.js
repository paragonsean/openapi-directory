...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.UpdateGroupQueryInput();
  });
  ...
  describe('UpdateGroupQueryInput', function() {
    it('should create an instance of UpdateGroupQueryInput', function() {
      // uncomment below and update the code to test UpdateGroupQueryInput
      //var instance = new AwsResourceGroups.UpdateGroupQueryInput();
      //expect(instance).to.be.a(AwsResourceGroups.UpdateGroupQueryInput);
    });
