...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.GetGroupConfigurationOutputGroupConfiguration();
  });
  ...
  describe('GetGroupConfigurationOutputGroupConfiguration', function() {
    it('should create an instance of GetGroupConfigurationOutputGroupConfiguration', function() {
      // uncomment below and update the code to test GetGroupConfigurationOutputGroupConfiguration
      //var instance = new AwsResourceGroups.GetGroupConfigurationOutputGroupConfiguration();
      //expect(instance).to.be.a(AwsResourceGroups.GetGroupConfigurationOutputGroupConfiguration);
    });
