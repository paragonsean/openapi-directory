...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.GetGroupQueryOutputGroupQuery();
  });
  ...
  describe('GetGroupQueryOutputGroupQuery', function() {
    it('should create an instance of GetGroupQueryOutputGroupQuery', function() {
      // uncomment below and update the code to test GetGroupQueryOutputGroupQuery
      //var instance = new AwsResourceGroups.GetGroupQueryOutputGroupQuery();
      //expect(instance).to.be.a(AwsResourceGroups.GetGroupQueryOutputGroupQuery);
    });
