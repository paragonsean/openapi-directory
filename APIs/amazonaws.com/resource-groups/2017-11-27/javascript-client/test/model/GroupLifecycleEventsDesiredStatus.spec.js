...
(function(root, factory) {
  ...
  describe('GroupLifecycleEventsDesiredStatus', function() {
    it('should create an instance of GroupLifecycleEventsDesiredStatus', function() {
      // uncomment below and update the code to test GroupLifecycleEventsDesiredStatus
      //var instance = new AwsResourceGroups.GroupLifecycleEventsDesiredStatus();
      //expect(instance).to.be.a(AwsResourceGroups.GroupLifecycleEventsDesiredStatus);
    });
