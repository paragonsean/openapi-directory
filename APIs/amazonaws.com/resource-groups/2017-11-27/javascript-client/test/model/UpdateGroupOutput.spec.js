...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.UpdateGroupOutput();
  });
  ...
  describe('UpdateGroupOutput', function() {
    it('should create an instance of UpdateGroupOutput', function() {
      // uncomment below and update the code to test UpdateGroupOutput
      //var instance = new AwsResourceGroups.UpdateGroupOutput();
      //expect(instance).to.be.a(AwsResourceGroups.UpdateGroupOutput);
    });
