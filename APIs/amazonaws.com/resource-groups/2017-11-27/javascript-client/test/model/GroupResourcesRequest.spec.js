...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.GroupResourcesRequest();
  });
  ...
  describe('GroupResourcesRequest', function() {
    it('should create an instance of GroupResourcesRequest', function() {
      // uncomment below and update the code to test GroupResourcesRequest
      //var instance = new AwsResourceGroups.GroupResourcesRequest();
      //expect(instance).to.be.a(AwsResourceGroups.GroupResourcesRequest);
    });
