...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.UpdateGroupQueryOutputGroupQuery();
  });
  ...
  describe('UpdateGroupQueryOutputGroupQuery', function() {
    it('should create an instance of UpdateGroupQueryOutputGroupQuery', function() {
      // uncomment below and update the code to test UpdateGroupQueryOutputGroupQuery
      //var instance = new AwsResourceGroups.UpdateGroupQueryOutputGroupQuery();
      //expect(instance).to.be.a(AwsResourceGroups.UpdateGroupQueryOutputGroupQuery);
    });
