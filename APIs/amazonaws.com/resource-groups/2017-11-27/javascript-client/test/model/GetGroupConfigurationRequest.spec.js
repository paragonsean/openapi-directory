...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.GetGroupConfigurationRequest();
  });
  ...
  describe('GetGroupConfigurationRequest', function() {
    it('should create an instance of GetGroupConfigurationRequest', function() {
      // uncomment below and update the code to test GetGroupConfigurationRequest
      //var instance = new AwsResourceGroups.GetGroupConfigurationRequest();
      //expect(instance).to.be.a(AwsResourceGroups.GetGroupConfigurationRequest);
    });
