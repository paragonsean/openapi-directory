...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.AccountSettings();
  });
  ...
  describe('AccountSettings', function() {
    it('should create an instance of AccountSettings', function() {
      ...
      //var instance = new AwsResourceGroups.AccountSettings();
      //expect(instance).to.be.a(AwsResourceGroups.AccountSettings);
    });
