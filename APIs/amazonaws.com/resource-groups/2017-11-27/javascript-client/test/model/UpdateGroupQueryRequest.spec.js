...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.UpdateGroupQueryRequest();
  });
  ...
  describe('UpdateGroupQueryRequest', function() {
    it('should create an instance of UpdateGroupQueryRequest', function() {
      // uncomment below and update the code to test UpdateGroupQueryRequest
      //var instance = new AwsResourceGroups.UpdateGroupQueryRequest();
      //expect(instance).to.be.a(AwsResourceGroups.UpdateGroupQueryRequest);
    });
