...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.UngroupResourcesRequest();
  });
  ...
  describe('UngroupResourcesRequest', function() {
    it('should create an instance of UngroupResourcesRequest', function() {
      // uncomment below and update the code to test UngroupResourcesRequest
      //var instance = new AwsResourceGroups.UngroupResourcesRequest();
      //expect(instance).to.be.a(AwsResourceGroups.UngroupResourcesRequest);
    });
