...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.UntagInput();
  });
  ...
  describe('UntagInput', function() {
    it('should create an instance of UntagInput', function() {
      // uncomment below and update the code to test UntagInput
      //var instance = new AwsResourceGroups.UntagInput();
      //expect(instance).to.be.a(AwsResourceGroups.UntagInput);
    });
