...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.DeleteGroupOutput();
  });
  ...
  describe('DeleteGroupOutput', function() {
    it('should create an instance of DeleteGroupOutput', function() {
      // uncomment below and update the code to test DeleteGroupOutput
      //var instance = new AwsResourceGroups.DeleteGroupOutput();
      //expect(instance).to.be.a(AwsResourceGroups.DeleteGroupOutput);
    });
