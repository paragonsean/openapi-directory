...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.UngroupResourcesOutput();
  });
  ...
  describe('UngroupResourcesOutput', function() {
    it('should create an instance of UngroupResourcesOutput', function() {
      // uncomment below and update the code to test UngroupResourcesOutput
      //var instance = new AwsResourceGroups.UngroupResourcesOutput();
      //expect(instance).to.be.a(AwsResourceGroups.UngroupResourcesOutput);
    });
