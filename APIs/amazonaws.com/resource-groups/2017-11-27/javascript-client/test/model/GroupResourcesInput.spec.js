...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.GroupResourcesInput();
  });
  ...
  describe('GroupResourcesInput', function() {
    it('should create an instance of GroupResourcesInput', function() {
      // uncomment below and update the code to test GroupResourcesInput
      //var instance = new AwsResourceGroups.GroupResourcesInput();
      //expect(instance).to.be.a(AwsResourceGroups.GroupResourcesInput);
    });
