...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.TagOutput();
  });
  ...
  describe('TagOutput', function() {
    it('should create an instance of TagOutput', function() {
      // uncomment below and update the code to test TagOutput
      //var instance = new AwsResourceGroups.TagOutput();
      //expect(instance).to.be.a(AwsResourceGroups.TagOutput);
    });
