...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.PutGroupConfigurationRequest();
  });
  ...
  describe('PutGroupConfigurationRequest', function() {
    it('should create an instance of PutGroupConfigurationRequest', function() {
      // uncomment below and update the code to test PutGroupConfigurationRequest
      //var instance = new AwsResourceGroups.PutGroupConfigurationRequest();
      //expect(instance).to.be.a(AwsResourceGroups.PutGroupConfigurationRequest);
    });
