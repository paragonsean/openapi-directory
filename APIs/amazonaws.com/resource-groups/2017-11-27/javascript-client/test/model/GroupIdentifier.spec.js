...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.GroupIdentifier();
  });
  ...
  describe('GroupIdentifier', function() {
    it('should create an instance of GroupIdentifier', function() {
      // uncomment below and update the code to test GroupIdentifier
      //var instance = new AwsResourceGroups.GroupIdentifier();
      //expect(instance).to.be.a(AwsResourceGroups.GroupIdentifier);
    });
