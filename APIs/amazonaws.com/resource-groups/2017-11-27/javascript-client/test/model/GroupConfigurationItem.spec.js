...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.GroupConfigurationItem();
  });
  ...
  describe('GroupConfigurationItem', function() {
    it('should create an instance of GroupConfigurationItem', function() {
      // uncomment below and update the code to test GroupConfigurationItem
      //var instance = new AwsResourceGroups.GroupConfigurationItem();
      //expect(instance).to.be.a(AwsResourceGroups.GroupConfigurationItem);
    });
