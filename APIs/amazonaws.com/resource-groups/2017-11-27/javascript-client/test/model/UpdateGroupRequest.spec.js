...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.UpdateGroupRequest();
  });
  ...
  describe('UpdateGroupRequest', function() {
    it('should create an instance of UpdateGroupRequest', function() {
      ...
      //var instance = new AwsResourceGroups.UpdateGroupRequest();
      //expect(instance).to.be.a(AwsResourceGroups.UpdateGroupRequest);
    });
