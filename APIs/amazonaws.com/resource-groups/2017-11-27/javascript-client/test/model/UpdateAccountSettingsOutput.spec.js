...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.UpdateAccountSettingsOutput();
  });
  ...
  describe('UpdateAccountSettingsOutput', function() {
    it('should create an instance of UpdateAccountSettingsOutput', function() {
      ...
      //var instance = new AwsResourceGroups.UpdateAccountSettingsOutput();
      //expect(instance).to.be.a(AwsResourceGroups.UpdateAccountSettingsOutput);
    });
