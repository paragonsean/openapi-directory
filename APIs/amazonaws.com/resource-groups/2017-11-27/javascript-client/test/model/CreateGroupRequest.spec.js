...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.CreateGroupRequest();
  });
  ...
  describe('CreateGroupRequest', function() {
    it('should create an instance of CreateGroupRequest', function() {
      ...
      //var instance = new AwsResourceGroups.CreateGroupRequest();
      //expect(instance).to.be.a(AwsResourceGroups.CreateGroupRequest);
    });
