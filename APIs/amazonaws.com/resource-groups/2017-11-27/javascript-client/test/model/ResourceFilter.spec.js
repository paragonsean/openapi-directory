...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.ResourceFilter();
  });
  ...
  describe('ResourceFilter', function() {
    it('should create an instance of ResourceFilter', function() {
      ...
      //var instance = new AwsResourceGroups.ResourceFilter();
      //expect(instance).to.be.a(AwsResourceGroups.ResourceFilter);
    });
