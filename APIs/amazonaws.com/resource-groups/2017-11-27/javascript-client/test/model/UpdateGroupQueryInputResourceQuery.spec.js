...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.UpdateGroupQueryInputResourceQuery();
  });
  ...
  describe('UpdateGroupQueryInputResourceQuery', function() {
    it('should create an instance of UpdateGroupQueryInputResourceQuery', function() {
      // uncomment below and update the code to test UpdateGroupQueryInputResourceQuery
      //var instance = new AwsResourceGroups.UpdateGroupQueryInputResourceQuery();
      //expect(instance).to.be.a(AwsResourceGroups.UpdateGroupQueryInputResourceQuery);
    });
