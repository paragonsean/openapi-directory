...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.CreateGroupInput();
  });
  ...
  describe('CreateGroupInput', function() {
    it('should create an instance of CreateGroupInput', function() {
      // uncomment below and update the code to test CreateGroupInput
      //var instance = new AwsResourceGroups.CreateGroupInput();
      //expect(instance).to.be.a(AwsResourceGroups.CreateGroupInput);
    });
    ...
    it('should have the property resourceQuery (base name: "ResourceQuery")', function() {
      // uncomment below and update the code to test the property resourceQuery
      //var instance = new AwsResourceGroups.CreateGroupInput();
      //expect(instance).to.be();
    });
