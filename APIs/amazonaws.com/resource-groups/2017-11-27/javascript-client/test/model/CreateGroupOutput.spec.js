...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.CreateGroupOutput();
  });
  ...
  describe('CreateGroupOutput', function() {
    it('should create an instance of CreateGroupOutput', function() {
      // uncomment below and update the code to test CreateGroupOutput
      //var instance = new AwsResourceGroups.CreateGroupOutput();
      //expect(instance).to.be.a(AwsResourceGroups.CreateGroupOutput);
    });
