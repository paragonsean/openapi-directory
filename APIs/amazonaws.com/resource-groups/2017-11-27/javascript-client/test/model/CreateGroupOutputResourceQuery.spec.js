...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.CreateGroupOutputResourceQuery();
  });
  ...
  describe('CreateGroupOutputResourceQuery', function() {
    it('should create an instance of CreateGroupOutputResourceQuery', function() {
      // uncomment below and update the code to test CreateGroupOutputResourceQuery
      //var instance = new AwsResourceGroups.CreateGroupOutputResourceQuery();
      //expect(instance).to.be.a(AwsResourceGroups.CreateGroupOutputResourceQuery);
    });
