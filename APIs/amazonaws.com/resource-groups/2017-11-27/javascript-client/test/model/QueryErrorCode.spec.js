...
(function(root, factory) {
  ...
  describe('QueryErrorCode', function() {
    it('should create an instance of QueryErrorCode', function() {
      // uncomment below and update the code to test QueryErrorCode
      //var instance = new AwsResourceGroups.QueryErrorCode();
      //expect(instance).to.be.a(AwsResourceGroups.QueryErrorCode);
    });
