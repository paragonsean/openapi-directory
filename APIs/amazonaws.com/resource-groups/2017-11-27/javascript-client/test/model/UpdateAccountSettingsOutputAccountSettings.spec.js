...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.UpdateAccountSettingsOutputAccountSettings();
  });
  ...
  describe('UpdateAccountSettingsOutputAccountSettings', function() {
    it('should create an instance of UpdateAccountSettingsOutputAccountSettings', function() {
      // uncomment below and update the code to test UpdateAccountSettingsOutputAccountSettings
      //var instance = new AwsResourceGroups.UpdateAccountSettingsOutputAccountSettings();
      //expect(instance).to.be.a(AwsResourceGroups.UpdateAccountSettingsOutputAccountSettings);
    });
    ...
    it('should have the property groupLifecycleEventsStatus (base name: "GroupLifecycleEventsStatus")', function() {
      // uncomment below and update the code to test the property groupLifecycleEventsStatus
      //var instance = new AwsResourceGroups.UpdateAccountSettingsOutputAccountSettings();
      //expect(instance).to.be();
    });

    it('should have the property groupLifecycleEventsStatusMessage (base name: "GroupLifecycleEventsStatusMessage")', function() {
      // uncomment below and update the code to test the property groupLifecycleEventsStatusMessage
      //var instance = new AwsResourceGroups.UpdateAccountSettingsOutputAccountSettings();
      //expect(instance).to.be();
    });
