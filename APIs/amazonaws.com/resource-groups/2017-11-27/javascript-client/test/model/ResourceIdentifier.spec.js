...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.ResourceIdentifier();
  });
  ...
  describe('ResourceIdentifier', function() {
    it('should create an instance of ResourceIdentifier', function() {
      ...
      //var instance = new AwsResourceGroups.ResourceIdentifier();
      //expect(instance).to.be.a(AwsResourceGroups.ResourceIdentifier);
    });
