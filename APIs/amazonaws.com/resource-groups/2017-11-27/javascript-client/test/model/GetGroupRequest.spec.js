...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.GetGroupRequest();
  });
  ...
  describe('GetGroupRequest', function() {
    it('should create an instance of GetGroupRequest', function() {
      ...
      //var instance = new AwsResourceGroups.GetGroupRequest();
      //expect(instance).to.be.a(AwsResourceGroups.GetGroupRequest);
    });
