...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.GetGroupOutput();
  });
  ...
  describe('GetGroupOutput', function() {
    it('should create an instance of GetGroupOutput', function() {
      ...
      //var instance = new AwsResourceGroups.GetGroupOutput();
      //expect(instance).to.be.a(AwsResourceGroups.GetGroupOutput);
    });
