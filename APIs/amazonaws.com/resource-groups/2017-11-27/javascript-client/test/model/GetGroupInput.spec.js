...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.GetGroupInput();
  });
  ...
  describe('GetGroupInput', function() {
    it('should create an instance of GetGroupInput', function() {
      // uncomment below and update the code to test GetGroupInput
      //var instance = new AwsResourceGroups.GetGroupInput();
      //expect(instance).to.be.a(AwsResourceGroups.GetGroupInput);
    });
