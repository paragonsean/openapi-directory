...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.QueryError();
  });
  ...
  describe('QueryError', function() {
    it('should create an instance of QueryError', function() {
      // uncomment below and update the code to test QueryError
      //var instance = new AwsResourceGroups.QueryError();
      //expect(instance).to.be.a(AwsResourceGroups.QueryError);
    });
