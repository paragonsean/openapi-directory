...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.CreateGroupOutputGroupConfiguration();
  });
  ...
  describe('CreateGroupOutputGroupConfiguration', function() {
    it('should create an instance of CreateGroupOutputGroupConfiguration', function() {
      // uncomment below and update the code to test CreateGroupOutputGroupConfiguration
      //var instance = new AwsResourceGroups.CreateGroupOutputGroupConfiguration();
      //expect(instance).to.be.a(AwsResourceGroups.CreateGroupOutputGroupConfiguration);
    });
    ...
    it('should have the property proposedConfiguration (base name: "ProposedConfiguration")', function() {
      // uncomment below and update the code to test the property proposedConfiguration
      //var instance = new AwsResourceGroups.CreateGroupOutputGroupConfiguration();
      //expect(instance).to.be();
    });
