...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.SearchResourcesInput();
  });
  ...
  describe('SearchResourcesInput', function() {
    it('should create an instance of SearchResourcesInput', function() {
      // uncomment below and update the code to test SearchResourcesInput
      //var instance = new AwsResourceGroups.SearchResourcesInput();
      //expect(instance).to.be.a(AwsResourceGroups.SearchResourcesInput);
    });
