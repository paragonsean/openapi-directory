...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.ListGroupResourcesOutput();
  });
  ...
  describe('ListGroupResourcesOutput', function() {
    it('should create an instance of ListGroupResourcesOutput', function() {
      // uncomment below and update the code to test ListGroupResourcesOutput
      //var instance = new AwsResourceGroups.ListGroupResourcesOutput();
      //expect(instance).to.be.a(AwsResourceGroups.ListGroupResourcesOutput);
    });
