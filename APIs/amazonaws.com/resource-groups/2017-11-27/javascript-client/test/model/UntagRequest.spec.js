...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.UntagRequest();
  });
  ...
  describe('UntagRequest', function() {
    it('should create an instance of UntagRequest', function() {
      // uncomment below and update the code to test UntagRequest
      //var instance = new AwsResourceGroups.UntagRequest();
      //expect(instance).to.be.a(AwsResourceGroups.UntagRequest);
    });
