...
(function(root, factory) {
  ...
  describe('GroupLifecycleEventsStatus', function() {
    it('should create an instance of GroupLifecycleEventsStatus', function() {
      // uncomment below and update the code to test GroupLifecycleEventsStatus
      //var instance = new AwsResourceGroups.GroupLifecycleEventsStatus();
      //expect(instance).to.be.a(AwsResourceGroups.GroupLifecycleEventsStatus);
    });
