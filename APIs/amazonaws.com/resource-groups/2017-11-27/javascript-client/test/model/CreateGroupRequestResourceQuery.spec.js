...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.CreateGroupRequestResourceQuery();
  });
  ...
  describe('CreateGroupRequestResourceQuery', function() {
    it('should create an instance of CreateGroupRequestResourceQuery', function() {
      // uncomment below and update the code to test CreateGroupRequestResourceQuery
      //var instance = new AwsResourceGroups.CreateGroupRequestResourceQuery();
      //expect(instance).to.be.a(AwsResourceGroups.CreateGroupRequestResourceQuery);
    });
