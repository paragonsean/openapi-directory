...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.UpdateAccountSettingsInput();
  });
  ...
  describe('UpdateAccountSettingsInput', function() {
    it('should create an instance of UpdateAccountSettingsInput', function() {
      ...
      //var instance = new AwsResourceGroups.UpdateAccountSettingsInput();
      //expect(instance).to.be.a(AwsResourceGroups.UpdateAccountSettingsInput);
    });

    it('should have the property groupLifecycleEventsDesiredStatus (base name: "GroupLifecycleEventsDesiredStatus")', function() {
      // uncomment below and update the code to test the property groupLifecycleEventsDesiredStatus
      //var instance = new AwsResourceGroups.UpdateAccountSettingsInput();
