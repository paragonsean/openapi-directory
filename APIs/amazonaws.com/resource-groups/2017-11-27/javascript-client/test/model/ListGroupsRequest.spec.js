...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.ListGroupsRequest();
  });
  ...
  describe('ListGroupsRequest', function() {
    it('should create an instance of ListGroupsRequest', function() {
      ...
      //var instance = new AwsResourceGroups.ListGroupsRequest();
      //expect(instance).to.be.a(AwsResourceGroups.ListGroupsRequest);
    });
