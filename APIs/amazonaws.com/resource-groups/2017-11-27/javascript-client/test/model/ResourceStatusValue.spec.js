...
(function(root, factory) {
  ...
  describe('ResourceStatusValue', function() {
    it('should create an instance of ResourceStatusValue', function() {
      // uncomment below and update the code to test ResourceStatusValue
      //var instance = new AwsResourceGroups.ResourceStatusValue();
      //expect(instance).to.be.a(AwsResourceGroups.ResourceStatusValue);
    });
