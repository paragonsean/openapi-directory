...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.UpdateGroupOutputGroup();
  });
  ...
  describe('UpdateGroupOutputGroup', function() {
    it('should create an instance of UpdateGroupOutputGroup', function() {
      // uncomment below and update the code to test UpdateGroupOutputGroup
      //var instance = new AwsResourceGroups.UpdateGroupOutputGroup();
      //expect(instance).to.be.a(AwsResourceGroups.UpdateGroupOutputGroup);
    });
