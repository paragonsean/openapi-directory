...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.PutGroupConfigurationInput();
  });
  ...
  describe('PutGroupConfigurationInput', function() {
    it('should create an instance of PutGroupConfigurationInput', function() {
      // uncomment below and update the code to test PutGroupConfigurationInput
      //var instance = new AwsResourceGroups.PutGroupConfigurationInput();
      //expect(instance).to.be.a(AwsResourceGroups.PutGroupConfigurationInput);
    });
