...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.ListGroupsOutput();
  });
  ...
  describe('ListGroupsOutput', function() {
    it('should create an instance of ListGroupsOutput', function() {
      ...
      //var instance = new AwsResourceGroups.ListGroupsOutput();
      //expect(instance).to.be.a(AwsResourceGroups.ListGroupsOutput);
    });

    it('should have the property groupIdentifiers (base name: "GroupIdentifiers")', function() {
      // uncomment below and update the code to test the property groupIdentifiers
      //var instance = new AwsResourceGroups.ListGroupsOutput();
