...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.ResourceQuery();
  });
  ...
  describe('ResourceQuery', function() {
    it('should create an instance of ResourceQuery', function() {
      // uncomment below and update the code to test ResourceQuery
      //var instance = new AwsResourceGroups.ResourceQuery();
      //expect(instance).to.be.a(AwsResourceGroups.ResourceQuery);
    });
