...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.UntagOutput();
  });
  ...
  describe('UntagOutput', function() {
    it('should create an instance of UntagOutput', function() {
      // uncomment below and update the code to test UntagOutput
      //var instance = new AwsResourceGroups.UntagOutput();
      //expect(instance).to.be.a(AwsResourceGroups.UntagOutput);
    });
