...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.ListGroupResourcesRequest();
  });
  ...
  describe('ListGroupResourcesRequest', function() {
    it('should create an instance of ListGroupResourcesRequest', function() {
      ...
      //var instance = new AwsResourceGroups.ListGroupResourcesRequest();
      //expect(instance).to.be.a(AwsResourceGroups.ListGroupResourcesRequest);
    });
