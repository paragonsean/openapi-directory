...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.UpdateGroupQueryOutput();
  });
  ...
  describe('UpdateGroupQueryOutput', function() {
    it('should create an instance of UpdateGroupQueryOutput', function() {
      // uncomment below and update the code to test UpdateGroupQueryOutput
      //var instance = new AwsResourceGroups.UpdateGroupQueryOutput();
      //expect(instance).to.be.a(AwsResourceGroups.UpdateGroupQueryOutput);
    });
