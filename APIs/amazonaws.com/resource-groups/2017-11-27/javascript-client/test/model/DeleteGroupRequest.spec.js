...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.DeleteGroupRequest();
  });
  ...
  describe('DeleteGroupRequest', function() {
    it('should create an instance of DeleteGroupRequest', function() {
      ...
      //var instance = new AwsResourceGroups.DeleteGroupRequest();
      //expect(instance).to.be.a(AwsResourceGroups.DeleteGroupRequest);
    });
