...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.GetGroupOutputGroup();
  });
  ...
  describe('GetGroupOutputGroup', function() {
    it('should create an instance of GetGroupOutputGroup', function() {
      // uncomment below and update the code to test GetGroupOutputGroup
      //var instance = new AwsResourceGroups.GetGroupOutputGroup();
      //expect(instance).to.be.a(AwsResourceGroups.GetGroupOutputGroup);
    });
