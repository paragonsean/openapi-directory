...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.GetGroupQueryRequest();
  });
  ...
  describe('GetGroupQueryRequest', function() {
    it('should create an instance of GetGroupQueryRequest', function() {
      // uncomment below and update the code to test GetGroupQueryRequest
      //var instance = new AwsResourceGroups.GetGroupQueryRequest();
      //expect(instance).to.be.a(AwsResourceGroups.GetGroupQueryRequest);
    });
