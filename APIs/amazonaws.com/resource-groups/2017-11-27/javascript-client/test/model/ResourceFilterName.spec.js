...
(function(root, factory) {
  ...
  describe('ResourceFilterName', function() {
    it('should create an instance of ResourceFilterName', function() {
      // uncomment below and update the code to test ResourceFilterName
      //var instance = new AwsResourceGroups.ResourceFilterName();
      //expect(instance).to.be.a(AwsResourceGroups.ResourceFilterName);
    });
