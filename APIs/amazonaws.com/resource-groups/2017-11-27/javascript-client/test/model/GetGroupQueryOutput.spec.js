...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.GetGroupQueryOutput();
  });
  ...
  describe('GetGroupQueryOutput', function() {
    it('should create an instance of GetGroupQueryOutput', function() {
      // uncomment below and update the code to test GetGroupQueryOutput
      //var instance = new AwsResourceGroups.GetGroupQueryOutput();
      //expect(instance).to.be.a(AwsResourceGroups.GetGroupQueryOutput);
    });

    it('should have the property groupQuery (base name: "GroupQuery")', function() {
      // uncomment below and update the code to test the property groupQuery
      //var instance = new AwsResourceGroups.GetGroupQueryOutput();
