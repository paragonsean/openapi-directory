...
(function(root, factory) {
  ...
  describe('GroupConfigurationStatus', function() {
    it('should create an instance of GroupConfigurationStatus', function() {
      // uncomment below and update the code to test GroupConfigurationStatus
      //var instance = new AwsResourceGroups.GroupConfigurationStatus();
      //expect(instance).to.be.a(AwsResourceGroups.GroupConfigurationStatus);
    });
