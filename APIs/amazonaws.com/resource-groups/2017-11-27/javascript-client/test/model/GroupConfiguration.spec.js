...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.GroupConfiguration();
  });
  ...
  describe('GroupConfiguration', function() {
    it('should create an instance of GroupConfiguration', function() {
      // uncomment below and update the code to test GroupConfiguration
      //var instance = new AwsResourceGroups.GroupConfiguration();
      //expect(instance).to.be.a(AwsResourceGroups.GroupConfiguration);
    });
