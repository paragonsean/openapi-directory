...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.GetGroupConfigurationInput();
  });
  ...
  describe('GetGroupConfigurationInput', function() {
    it('should create an instance of GetGroupConfigurationInput', function() {
      // uncomment below and update the code to test GetGroupConfigurationInput
      //var instance = new AwsResourceGroups.GetGroupConfigurationInput();
      //expect(instance).to.be.a(AwsResourceGroups.GetGroupConfigurationInput);
    });
