...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.CreateGroupInputResourceQuery();
  });
  ...
  describe('CreateGroupInputResourceQuery', function() {
    it('should create an instance of CreateGroupInputResourceQuery', function() {
      // uncomment below and update the code to test CreateGroupInputResourceQuery
      //var instance = new AwsResourceGroups.CreateGroupInputResourceQuery();
      //expect(instance).to.be.a(AwsResourceGroups.CreateGroupInputResourceQuery);
    });
