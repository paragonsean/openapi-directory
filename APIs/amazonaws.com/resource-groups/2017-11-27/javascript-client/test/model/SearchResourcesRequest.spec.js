...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.SearchResourcesRequest();
  });
  ...
  describe('SearchResourcesRequest', function() {
    it('should create an instance of SearchResourcesRequest', function() {
      ...
      //var instance = new AwsResourceGroups.SearchResourcesRequest();
      //expect(instance).to.be.a(AwsResourceGroups.SearchResourcesRequest);
    });
