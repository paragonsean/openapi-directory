...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.GroupResourcesOutput();
  });
  ...
  describe('GroupResourcesOutput', function() {
    it('should create an instance of GroupResourcesOutput', function() {
      // uncomment below and update the code to test GroupResourcesOutput
      //var instance = new AwsResourceGroups.GroupResourcesOutput();
      //expect(instance).to.be.a(AwsResourceGroups.GroupResourcesOutput);
    });
