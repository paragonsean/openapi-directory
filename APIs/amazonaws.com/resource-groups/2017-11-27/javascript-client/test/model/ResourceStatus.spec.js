...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.ResourceStatus();
  });
  ...
  describe('ResourceStatus', function() {
    it('should create an instance of ResourceStatus', function() {
      ...
      //var instance = new AwsResourceGroups.ResourceStatus();
      //expect(instance).to.be.a(AwsResourceGroups.ResourceStatus);
    });
