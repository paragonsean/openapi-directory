...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.SearchResourcesOutput();
  });
  ...
  describe('SearchResourcesOutput', function() {
    it('should create an instance of SearchResourcesOutput', function() {
      // uncomment below and update the code to test SearchResourcesOutput
      //var instance = new AwsResourceGroups.SearchResourcesOutput();
      //expect(instance).to.be.a(AwsResourceGroups.SearchResourcesOutput);
    });
    ...
    it('should have the property queryErrors (base name: "QueryErrors")', function() {
      // uncomment below and update the code to test the property queryErrors
      //var instance = new AwsResourceGroups.SearchResourcesOutput();
      //expect(instance).to.be();
    });
