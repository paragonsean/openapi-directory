...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.GroupConfigurationParameter();
  });
  ...
  describe('GroupConfigurationParameter', function() {
    it('should create an instance of GroupConfigurationParameter', function() {
      // uncomment below and update the code to test GroupConfigurationParameter
      //var instance = new AwsResourceGroups.GroupConfigurationParameter();
      //expect(instance).to.be.a(AwsResourceGroups.GroupConfigurationParameter);
    });
