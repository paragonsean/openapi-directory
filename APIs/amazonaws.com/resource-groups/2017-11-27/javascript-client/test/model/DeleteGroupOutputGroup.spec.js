...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.DeleteGroupOutputGroup();
  });
  ...
  describe('DeleteGroupOutputGroup', function() {
    it('should create an instance of DeleteGroupOutputGroup', function() {
      // uncomment below and update the code to test DeleteGroupOutputGroup
      //var instance = new AwsResourceGroups.DeleteGroupOutputGroup();
      //expect(instance).to.be.a(AwsResourceGroups.DeleteGroupOutputGroup);
    });
