...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResourceGroups.TagRequest();
  });
  ...
  describe('TagRequest', function() {
    it('should create an instance of TagRequest', function() {
      // uncomment below and update the code to test TagRequest
      //var instance = new AwsResourceGroups.TagRequest();
      //expect(instance).to.be.a(AwsResourceGroups.TagRequest);
    });
