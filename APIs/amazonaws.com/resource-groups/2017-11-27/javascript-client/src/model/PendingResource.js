...
/**
 * The PendingResource model module.
 * @module model/PendingResource
 * @version 2017-11-27
 */
class PendingResource {
    /**
     * Constructs a new <code>PendingResource</code>.
     ...
     * @alias module:model/PendingResource
     */
    constructor() { 
        
        PendingResource.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PendingResource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PendingResource} obj Optional instance to populate.
     * @return {module:model/PendingResource} The populated <code>PendingResource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PendingResource();
    ...
    /**
     * Validates the JSON data with respect to <code>PendingResource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PendingResource</code>.
     */
 ...
 */
PendingResource.prototype['ResourceArn'] = undefined;
