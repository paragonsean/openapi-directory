...
/**
 * The GetTagsOutput model module.
 * @module model/GetTagsOutput
 * @version 2017-11-27
 */
class GetTagsOutput {
    /**
     * Constructs a new <code>GetTagsOutput</code>.
     * @alias module:model/GetTagsOutput
     */
    constructor() { 
        
        GetTagsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetTagsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetTagsOutput} obj Optional instance to populate.
     * @return {module:model/GetTagsOutput} The populated <code>GetTagsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetTagsOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetTagsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTagsOutput</code>.
     */
 ...
 * @member {String} Arn
 */
GetTagsOutput.prototype['Arn'] = undefined;

/**
 * @member {Object} Tags
 */
GetTagsOutput.prototype['Tags'] = undefined;
