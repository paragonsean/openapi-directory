...
import ResourceFilterName from './ResourceFilterName';
...
class ResourceFilter {
     ...
     * @param name {module:model/ResourceFilterName} 
     * @param values {Array} 
     */
    constructor(name, values) { 
        
        ResourceFilter.initialize(this, name, values);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Name')) {
                obj['Name'] = ApiClient.convertToType(data['Name'], ResourceFilterName);
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of ResourceFilter.RequiredProperties) {
        ...
        if (data['Name']) { // data not null
          ResourceFilterName.validateJSON(data['Name']);
        }
...
ResourceFilter.RequiredProperties = ["Name", "Values"];

/**
 * @member {module:model/ResourceFilterName} Name
 */
ResourceFilter.prototype['Name'] = undefined;

/**
 * @member {Array} Values
 */
ResourceFilter.prototype['Values'] = undefined;
