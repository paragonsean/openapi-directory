...
/**
 * The DeleteGroupOutputGroup model module.
 * @module model/DeleteGroupOutputGroup
 * @version 2017-11-27
 */
class DeleteGroupOutputGroup {
    /**
     * Constructs a new <code>DeleteGroupOutputGroup</code>.
     * @alias module:model/DeleteGroupOutputGroup
    ...
    constructor(groupArn, name) { 
        ...
        DeleteGroupOutputGroup.initialize(this, groupArn, name);
    }
    ...
    /**
     * Constructs a <code>DeleteGroupOutputGroup</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteGroupOutputGroup} obj Optional instance to populate.
     * @return {module:model/DeleteGroupOutputGroup} The populated <code>DeleteGroupOutputGroup</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteGroupOutputGroup();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteGroupOutputGroup</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteGroupOutputGroup</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteGroupOutputGroup.RequiredProperties) {
...
DeleteGroupOutputGroup.RequiredProperties = ["GroupArn", "Name"];

/**
 * @member {String} GroupArn
 */
DeleteGroupOutputGroup.prototype['GroupArn'] = undefined;

/**
 * @member {String} Name
 */
DeleteGroupOutputGroup.prototype['Name'] = undefined;

/**
 * @member {String} Description
 */
DeleteGroupOutputGroup.prototype['Description'] = undefined;
...
export default DeleteGroupOutputGroup;
