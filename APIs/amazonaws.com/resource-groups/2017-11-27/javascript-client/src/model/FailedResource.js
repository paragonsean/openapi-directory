...
/**
 * The FailedResource model module.
 * @module model/FailedResource
 * @version 2017-11-27
 */
class FailedResource {
    /**
     * Constructs a new <code>FailedResource</code>.
     * A resource that failed to be added to or removed from a group.
     * @alias module:model/FailedResource
     */
    constructor() { 
        
        FailedResource.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FailedResource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FailedResource} obj Optional instance to populate.
     * @return {module:model/FailedResource} The populated <code>FailedResource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FailedResource();
    ...
    /**
     * Validates the JSON data with respect to <code>FailedResource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FailedResource</code>.
     */
 ...
 */
FailedResource.prototype['ResourceArn'] = undefined;

/**
 * @member {String} ErrorMessage
 */
FailedResource.prototype['ErrorMessage'] = undefined;

/**
 * @member {String} ErrorCode
 */
FailedResource.prototype['ErrorCode'] = undefined;
