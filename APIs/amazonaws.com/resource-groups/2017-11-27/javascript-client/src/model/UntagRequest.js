...
/**
 * The UntagRequest model module.
 * @module model/UntagRequest
 * @version 2017-11-27
 */
class UntagRequest {
    /**
     * Constructs a new <code>UntagRequest</code>.
     * @alias module:model/UntagRequest
     * @param keys {Array.<String>} The keys of the tags to be removed.
     */
    constructor(keys) { 
        
        UntagRequest.initialize(this, keys);
    }
    ...
    /**
     * Constructs a <code>UntagRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UntagRequest} obj Optional instance to populate.
     * @return {module:model/UntagRequest} The populated <code>UntagRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UntagRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UntagRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UntagRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UntagRequest.RequiredProperties) {
...
UntagRequest.RequiredProperties = ["Keys"];

/**
 * The keys of the tags to be removed.
 * @member {Array.<String>} Keys
 */
UntagRequest.prototype['Keys'] = undefined;
