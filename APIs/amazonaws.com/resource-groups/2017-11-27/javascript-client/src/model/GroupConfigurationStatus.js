...
* @readonly
*/
export default class GroupConfigurationStatus {
    ...
    /**
    * Returns a <code>GroupConfigurationStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/GroupConfigurationStatus} The enum <code>GroupConfigurationStatus</code> value.
    */
