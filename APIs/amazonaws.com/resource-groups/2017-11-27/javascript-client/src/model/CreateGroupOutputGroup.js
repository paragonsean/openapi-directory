...
/**
 * The CreateGroupOutputGroup model module.
 * @module model/CreateGroupOutputGroup
 * @version 2017-11-27
 */
class CreateGroupOutputGroup {
    /**
     * Constructs a new <code>CreateGroupOutputGroup</code>.
     * @alias module:model/CreateGroupOutputGroup
    ...
    constructor(groupArn, name) { 
        ...
        CreateGroupOutputGroup.initialize(this, groupArn, name);
    }
    ...
    /**
     * Constructs a <code>CreateGroupOutputGroup</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateGroupOutputGroup} obj Optional instance to populate.
     * @return {module:model/CreateGroupOutputGroup} The populated <code>CreateGroupOutputGroup</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateGroupOutputGroup();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateGroupOutputGroup</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateGroupOutputGroup</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateGroupOutputGroup.RequiredProperties) {
...
CreateGroupOutputGroup.RequiredProperties = ["GroupArn", "Name"];

/**
 * @member {String} GroupArn
 */
CreateGroupOutputGroup.prototype['GroupArn'] = undefined;

/**
 * @member {String} Name
 */
CreateGroupOutputGroup.prototype['Name'] = undefined;

/**
 * @member {String} Description
 */
CreateGroupOutputGroup.prototype['Description'] = undefined;
...
export default CreateGroupOutputGroup;
