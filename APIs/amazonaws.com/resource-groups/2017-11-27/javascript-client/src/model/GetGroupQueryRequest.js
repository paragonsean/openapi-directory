...
/**
 * The GetGroupQueryRequest model module.
 * @module model/GetGroupQueryRequest
 * @version 2017-11-27
 */
class GetGroupQueryRequest {
    /**
     * Constructs a new <code>GetGroupQueryRequest</code>.
     * @alias module:model/GetGroupQueryRequest
     */
    constructor() { 
        
        GetGroupQueryRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetGroupQueryRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetGroupQueryRequest} obj Optional instance to populate.
     * @return {module:model/GetGroupQueryRequest} The populated <code>GetGroupQueryRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetGroupQueryRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetGroupQueryRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetGroupQueryRequest</code>.
     */
 ...
 */
GetGroupQueryRequest.prototype['GroupName'] = undefined;

/**
 * The name or the ARN of the resource group to query.
 * @member {String} Group
 */
GetGroupQueryRequest.prototype['Group'] = undefined;
...
export default GetGroupQueryRequest;
