...
/**
 * The ListGroupResourcesInput model module.
 * @module model/ListGroupResourcesInput
 * @version 2017-11-27
 */
class ListGroupResourcesInput {
    /**
     * Constructs a new <code>ListGroupResourcesInput</code>.
     * @alias module:model/ListGroupResourcesInput
     */
    constructor() { 
        
        ListGroupResourcesInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListGroupResourcesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListGroupResourcesInput} obj Optional instance to populate.
     * @return {module:model/ListGroupResourcesInput} The populated <code>ListGroupResourcesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListGroupResourcesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListGroupResourcesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListGroupResourcesInput</code>.
     */
 ...
 */
ListGroupResourcesInput.prototype['GroupName'] = undefined;

/**
 * @member {String} Group
 */
ListGroupResourcesInput.prototype['Group'] = undefined;

/**
 * @member {Array} Filters
 */
ListGroupResourcesInput.prototype['Filters'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListGroupResourcesInput.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
ListGroupResourcesInput.prototype['NextToken'] = undefined;
...
export default ListGroupResourcesInput;
