...
/**
 * The PutGroupConfigurationInput model module.
 * @module model/PutGroupConfigurationInput
 * @version 2017-11-27
 */
class PutGroupConfigurationInput {
    /**
     * Constructs a new <code>PutGroupConfigurationInput</code>.
     * @alias module:model/PutGroupConfigurationInput
     */
    constructor() { 
        
        PutGroupConfigurationInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutGroupConfigurationInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutGroupConfigurationInput} obj Optional instance to populate.
     * @return {module:model/PutGroupConfigurationInput} The populated <code>PutGroupConfigurationInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutGroupConfigurationInput();
    ...
    /**
     * Validates the JSON data with respect to <code>PutGroupConfigurationInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutGroupConfigurationInput</code>.
     */
 ...
 * @member {String} Group
 */
PutGroupConfigurationInput.prototype['Group'] = undefined;

/**
 * @member {Array} Configuration
 */
PutGroupConfigurationInput.prototype['Configuration'] = undefined;
...
export default PutGroupConfigurationInput;
