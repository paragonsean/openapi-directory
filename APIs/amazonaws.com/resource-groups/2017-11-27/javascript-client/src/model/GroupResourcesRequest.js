...
/**
 * The GroupResourcesRequest model module.
 * @module model/GroupResourcesRequest
 * @version 2017-11-27
 */
class GroupResourcesRequest {
    /**
     * Constructs a new <code>GroupResourcesRequest</code>.
     * @alias module:model/GroupResourcesRequest
     * @param group {String} The name or the ARN of the resource group to add resources to.
     * @param resourceArns {Array.<String>} The list of ARNs of the resources to be added to the group. 
     */
    constructor(group, resourceArns) { 
        
        GroupResourcesRequest.initialize(this, group, resourceArns);
    }
    ...
    /**
     * Constructs a <code>GroupResourcesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GroupResourcesRequest} obj Optional instance to populate.
     * @return {module:model/GroupResourcesRequest} The populated <code>GroupResourcesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GroupResourcesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GroupResourcesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GroupResourcesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GroupResourcesRequest.RequiredProperties) {
...
GroupResourcesRequest.RequiredProperties = ["Group", "ResourceArns"];

/**
 * The name or the ARN of the resource group to add resources to.
 * @member {String} Group
 */
GroupResourcesRequest.prototype['Group'] = undefined;

/**
 * The list of ARNs of the resources to be added to the group. 
 * @member {Array.<String>} ResourceArns
 */
GroupResourcesRequest.prototype['ResourceArns'] = undefined;
...
export default GroupResourcesRequest;
