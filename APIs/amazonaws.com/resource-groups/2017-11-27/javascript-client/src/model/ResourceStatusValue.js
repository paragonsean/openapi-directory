...
* @readonly
*/
export default class ResourceStatusValue {
    ...
    /**
    * Returns a <code>ResourceStatusValue</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ResourceStatusValue} The enum <code>ResourceStatusValue</code> value.
    */
