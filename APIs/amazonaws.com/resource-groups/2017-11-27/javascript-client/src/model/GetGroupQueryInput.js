...
/**
 * The GetGroupQueryInput model module.
 * @module model/GetGroupQueryInput
 * @version 2017-11-27
 */
class GetGroupQueryInput {
    /**
     * Constructs a new <code>GetGroupQueryInput</code>.
     * @alias module:model/GetGroupQueryInput
     */
    constructor() { 
        
        GetGroupQueryInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetGroupQueryInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetGroupQueryInput} obj Optional instance to populate.
     * @return {module:model/GetGroupQueryInput} The populated <code>GetGroupQueryInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetGroupQueryInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetGroupQueryInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetGroupQueryInput</code>.
     */
 ...
 */
GetGroupQueryInput.prototype['GroupName'] = undefined;

/**
 * @member {String} Group
 */
GetGroupQueryInput.prototype['Group'] = undefined;
...
export default GetGroupQueryInput;
