...
/**
 * The GroupConfigurationParameter model module.
 * @module model/GroupConfigurationParameter
 * @version 2017-11-27
 */
class GroupConfigurationParameter {
    /**
     * Constructs a new <code>GroupConfigurationParameter</code>.
     ...
     * @alias module:model/GroupConfigurationParameter
     * @param name {String} 
     */
    constructor(name) { 
        
        GroupConfigurationParameter.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>GroupConfigurationParameter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GroupConfigurationParameter} obj Optional instance to populate.
     * @return {module:model/GroupConfigurationParameter} The populated <code>GroupConfigurationParameter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GroupConfigurationParameter();
    ...
    /**
     * Validates the JSON data with respect to <code>GroupConfigurationParameter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GroupConfigurationParameter</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GroupConfigurationParameter.RequiredProperties) {
...
GroupConfigurationParameter.RequiredProperties = ["Name"];

/**
 * @member {String} Name
 */
GroupConfigurationParameter.prototype['Name'] = undefined;

/**
 * @member {Array} Values
 */
GroupConfigurationParameter.prototype['Values'] = undefined;
...
export default GroupConfigurationParameter;
