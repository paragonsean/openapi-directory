...
/**
 * The ListGroupsInput model module.
 * @module model/ListGroupsInput
 * @version 2017-11-27
 */
class ListGroupsInput {
    /**
     * Constructs a new <code>ListGroupsInput</code>.
     * @alias module:model/ListGroupsInput
     */
    constructor() { 
        
        ListGroupsInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListGroupsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListGroupsInput} obj Optional instance to populate.
     * @return {module:model/ListGroupsInput} The populated <code>ListGroupsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListGroupsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListGroupsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListGroupsInput</code>.
     */
 ...
 */
ListGroupsInput.prototype['Filters'] = undefined;
...
export default ListGroupsInput;
