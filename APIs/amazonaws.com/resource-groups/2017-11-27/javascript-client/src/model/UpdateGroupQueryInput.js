...
import UpdateGroupQueryInputResourceQuery from './UpdateGroupQueryInputResourceQuery';

/**
 * The UpdateGroupQueryInput model module.
 * @module model/UpdateGroupQueryInput
 * @version 2017-11-27
 */
class UpdateGroupQueryInput {
    /**
     * Constructs a new <code>UpdateGroupQueryInput</code>.
     * @alias module:model/UpdateGroupQueryInput
     * @param resourceQuery {module:model/UpdateGroupQueryInputResourceQuery} 
     */
    constructor(resourceQuery) { 
        
        UpdateGroupQueryInput.initialize(this, resourceQuery);
    }
    ...
    /**
     * Constructs a <code>UpdateGroupQueryInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateGroupQueryInput} obj Optional instance to populate.
     * @return {module:model/UpdateGroupQueryInput} The populated <code>UpdateGroupQueryInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateGroupQueryInput();
            ...
            if (data.hasOwnProperty('ResourceQuery')) {
                obj['ResourceQuery'] = UpdateGroupQueryInputResourceQuery.constructFromObject(data['ResourceQuery']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateGroupQueryInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateGroupQueryInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateGroupQueryInput.RequiredProperties) {
        ...
        if (data['ResourceQuery']) { // data not null
          UpdateGroupQueryInputResourceQuery.validateJSON(data['ResourceQuery']);
        }
...
UpdateGroupQueryInput.RequiredProperties = ["ResourceQuery"];

/**
 * @member {String} GroupName
 */
UpdateGroupQueryInput.prototype['GroupName'] = undefined;

/**
 * @member {String} Group
 */
UpdateGroupQueryInput.prototype['Group'] = undefined;

/**
 * @member {module:model/UpdateGroupQueryInputResourceQuery} ResourceQuery
 */
UpdateGroupQueryInput.prototype['ResourceQuery'] = undefined;
...
export default UpdateGroupQueryInput;
