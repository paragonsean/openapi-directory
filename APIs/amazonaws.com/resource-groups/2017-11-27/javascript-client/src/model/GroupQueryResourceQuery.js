...
/**
 * The GroupQueryResourceQuery model module.
 * @module model/GroupQueryResourceQuery
 * @version 2017-11-27
 */
class GroupQueryResourceQuery {
    /**
     * Constructs a new <code>GroupQueryResourceQuery</code>.
     * @alias module:model/GroupQueryResourceQuery
    ...
    constructor(type, query) { 
        ...
        GroupQueryResourceQuery.initialize(this, type, query);
    }
    ...
    /**
     * Constructs a <code>GroupQueryResourceQuery</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GroupQueryResourceQuery} obj Optional instance to populate.
     * @return {module:model/GroupQueryResourceQuery} The populated <code>GroupQueryResourceQuery</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GroupQueryResourceQuery();
    ...
    /**
     * Validates the JSON data with respect to <code>GroupQueryResourceQuery</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GroupQueryResourceQuery</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GroupQueryResourceQuery.RequiredProperties) {
...
GroupQueryResourceQuery.RequiredProperties = ["Type", "Query"];

/**
 * @member {module:model/QueryType} Type
 */
GroupQueryResourceQuery.prototype['Type'] = undefined;

/**
 * @member {String} Query
 */
GroupQueryResourceQuery.prototype['Query'] = undefined;
...
export default GroupQueryResourceQuery;
