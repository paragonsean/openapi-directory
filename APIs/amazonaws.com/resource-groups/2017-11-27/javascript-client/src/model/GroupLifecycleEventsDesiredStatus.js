...
* @readonly
*/
export default class GroupLifecycleEventsDesiredStatus {
    ...
    /**
    * Returns a <code>GroupLifecycleEventsDesiredStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/GroupLifecycleEventsDesiredStatus} The enum <code>GroupLifecycleEventsDesiredStatus</code> value.
    */
