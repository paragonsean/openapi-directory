...
* @readonly
*/
export default class GroupLifecycleEventsStatus {
    ...
    /**
    * Returns a <code>GroupLifecycleEventsStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/GroupLifecycleEventsStatus} The enum <code>GroupLifecycleEventsStatus</code> value.
    */
