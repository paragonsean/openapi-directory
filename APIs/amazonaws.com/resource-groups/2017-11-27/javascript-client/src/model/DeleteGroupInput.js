...
/**
 * The DeleteGroupInput model module.
 * @module model/DeleteGroupInput
 * @version 2017-11-27
 */
class DeleteGroupInput {
    /**
     * Constructs a new <code>DeleteGroupInput</code>.
     * @alias module:model/DeleteGroupInput
     */
    constructor() { 
        
        DeleteGroupInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteGroupInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteGroupInput} obj Optional instance to populate.
     * @return {module:model/DeleteGroupInput} The populated <code>DeleteGroupInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteGroupInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteGroupInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteGroupInput</code>.
     */
 ...
 */
DeleteGroupInput.prototype['GroupName'] = undefined;

/**
 * @member {String} Group
 */
DeleteGroupInput.prototype['Group'] = undefined;
...
export default DeleteGroupInput;
