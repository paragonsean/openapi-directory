...
/**
 * The CreateGroupRequestResourceQuery model module.
 * @module model/CreateGroupRequestResourceQuery
 * @version 2017-11-27
 */
class CreateGroupRequestResourceQuery {
    /**
     * Constructs a new <code>CreateGroupRequestResourceQuery</code>.
     ...
     * @alias module:model/CreateGroupRequestResourceQuery
     */
    constructor() { 
        
        CreateGroupRequestResourceQuery.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateGroupRequestResourceQuery</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateGroupRequestResourceQuery} obj Optional instance to populate.
     * @return {module:model/CreateGroupRequestResourceQuery} The populated <code>CreateGroupRequestResourceQuery</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateGroupRequestResourceQuery();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateGroupRequestResourceQuery</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateGroupRequestResourceQuery</code>.
     */
 ...
 */
CreateGroupRequestResourceQuery.prototype['Type'] = undefined;

/**
 * @member {String} Query
 */
CreateGroupRequestResourceQuery.prototype['Query'] = undefined;
...
export default CreateGroupRequestResourceQuery;
