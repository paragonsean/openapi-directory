...
/**
 * The GetGroupConfigurationRequest model module.
 * @module model/GetGroupConfigurationRequest
 * @version 2017-11-27
 */
class GetGroupConfigurationRequest {
    /**
     * Constructs a new <code>GetGroupConfigurationRequest</code>.
     * @alias module:model/GetGroupConfigurationRequest
     */
    constructor() { 
        
        GetGroupConfigurationRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetGroupConfigurationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetGroupConfigurationRequest} obj Optional instance to populate.
     * @return {module:model/GetGroupConfigurationRequest} The populated <code>GetGroupConfigurationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetGroupConfigurationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetGroupConfigurationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetGroupConfigurationRequest</code>.
     */
 ...
 * @member {String} Group
 */
GetGroupConfigurationRequest.prototype['Group'] = undefined;
...
export default GetGroupConfigurationRequest;
