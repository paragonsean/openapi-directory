...
* @readonly
*/
export default class QueryErrorCode {
    
        /**
         * value: "CLOUDFORMATION_STACK_INACTIVE"
         * @const
         */
        "INACTIVE" = "CLOUDFORMATION_STACK_INACTIVE";

    
        /**
         * value: "CLOUDFORMATION_STACK_NOT_EXISTING"
         * @const
         */
        "NOT_EXISTING" = "CLOUDFORMATION_STACK_NOT_EXISTING";

    
        /**
         * value: "CLOUDFORMATION_STACK_UNASSUMABLE_ROLE"
         * @const
         */
        "UNASSUMABLE_ROLE" = "CLOUDFORMATION_STACK_UNASSUMABLE_ROLE";

    

    /**
    * Returns a <code>QueryErrorCode</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/QueryErrorCode} The enum <code>QueryErrorCode</code> value.
    */
