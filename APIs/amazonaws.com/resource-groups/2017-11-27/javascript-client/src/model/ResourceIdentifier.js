...
class ResourceIdentifier {
    ...
    constructor() { 
        ...
        ResourceIdentifier.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResourceIdentifier();
    ...
    /**
     * Validates the JSON data with respect to <code>ResourceIdentifier</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResourceIdentifier</code>.
     */
 ...
 */
ResourceIdentifier.prototype['ResourceArn'] = undefined;

/**
 * @member {String} ResourceType
 */
ResourceIdentifier.prototype['ResourceType'] = undefined;
