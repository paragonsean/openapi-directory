...
/**
 * The UngroupResourcesInput model module.
 * @module model/UngroupResourcesInput
 * @version 2017-11-27
 */
class UngroupResourcesInput {
    /**
     * Constructs a new <code>UngroupResourcesInput</code>.
     * @alias module:model/UngroupResourcesInput
     * @param group {String} 
     * @param resourceArns {Array} 
     */
    constructor(group, resourceArns) { 
        
        UngroupResourcesInput.initialize(this, group, resourceArns);
    }
    ...
    /**
     * Constructs a <code>UngroupResourcesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UngroupResourcesInput} obj Optional instance to populate.
     * @return {module:model/UngroupResourcesInput} The populated <code>UngroupResourcesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UngroupResourcesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UngroupResourcesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UngroupResourcesInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UngroupResourcesInput.RequiredProperties) {
...
UngroupResourcesInput.RequiredProperties = ["Group", "ResourceArns"];

/**
 * @member {String} Group
 */
UngroupResourcesInput.prototype['Group'] = undefined;

/**
 * @member {Array} ResourceArns
 */
UngroupResourcesInput.prototype['ResourceArns'] = undefined;
...
export default UngroupResourcesInput;
