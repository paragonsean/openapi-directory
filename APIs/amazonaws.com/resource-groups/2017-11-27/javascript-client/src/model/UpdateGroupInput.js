...
/**
 * The UpdateGroupInput model module.
 * @module model/UpdateGroupInput
 * @version 2017-11-27
 */
class UpdateGroupInput {
    /**
     * Constructs a new <code>UpdateGroupInput</code>.
     * @alias module:model/UpdateGroupInput
     */
    constructor() { 
        
        UpdateGroupInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateGroupInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateGroupInput} obj Optional instance to populate.
     * @return {module:model/UpdateGroupInput} The populated <code>UpdateGroupInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateGroupInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateGroupInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateGroupInput</code>.
     */
 ...
 */
UpdateGroupInput.prototype['GroupName'] = undefined;

/**
 * @member {String} Group
 */
UpdateGroupInput.prototype['Group'] = undefined;

/**
 * @member {String} Description
 */
UpdateGroupInput.prototype['Description'] = undefined;
...
export default UpdateGroupInput;
