...
* @readonly
*/
export default class ResourceFilterName {
    ...
    /**
    * Returns a <code>ResourceFilterName</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ResourceFilterName} The enum <code>ResourceFilterName</code> value.
    */
