...
/**
 * The GroupResourcesOutput model module.
 * @module model/GroupResourcesOutput
 * @version 2017-11-27
 */
class GroupResourcesOutput {
    /**
     * Constructs a new <code>GroupResourcesOutput</code>.
     * @alias module:model/GroupResourcesOutput
     */
    constructor() { 
        
        GroupResourcesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GroupResourcesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GroupResourcesOutput} obj Optional instance to populate.
     * @return {module:model/GroupResourcesOutput} The populated <code>GroupResourcesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GroupResourcesOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>GroupResourcesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GroupResourcesOutput</code>.
     */
 ...
 */
GroupResourcesOutput.prototype['Succeeded'] = undefined;

/**
 * @member {Array} Failed
 */
GroupResourcesOutput.prototype['Failed'] = undefined;

/**
 * @member {Array} Pending
 */
GroupResourcesOutput.prototype['Pending'] = undefined;
...
export default GroupResourcesOutput;
