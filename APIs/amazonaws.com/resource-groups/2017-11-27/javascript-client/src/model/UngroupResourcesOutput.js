...
/**
 * The UngroupResourcesOutput model module.
 * @module model/UngroupResourcesOutput
 * @version 2017-11-27
 */
class UngroupResourcesOutput {
    /**
     * Constructs a new <code>UngroupResourcesOutput</code>.
     * @alias module:model/UngroupResourcesOutput
     */
    constructor() { 
        
        UngroupResourcesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UngroupResourcesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UngroupResourcesOutput} obj Optional instance to populate.
     * @return {module:model/UngroupResourcesOutput} The populated <code>UngroupResourcesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UngroupResourcesOutput();

            if (data.hasOwnProperty('Succeeded')) {
                obj['Succeeded'] = ApiClient.convertToType(data['Succeeded'], Array);
            }
            if (data.hasOwnProperty('Failed')) {
                obj['Failed'] = ApiClient.convertToType(data['Failed'], Array);
            }
            if (data.hasOwnProperty('Pending')) {
                obj['Pending'] = ApiClient.convertToType(data['Pending'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UngroupResourcesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UngroupResourcesOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Succeeded`
        if (data['Succeeded']) { // data not null
          Array.validateJSON(data['Succeeded']);
        }
        ...
        if (data['Pending']) { // data not null
          Array.validateJSON(data['Pending']);
        }
...
/**
 * @member {Array} Succeeded
 */
UngroupResourcesOutput.prototype['Succeeded'] = undefined;

/**
 * @member {Array} Failed
 */
UngroupResourcesOutput.prototype['Failed'] = undefined;

/**
 * @member {Array} Pending
 */
UngroupResourcesOutput.prototype['Pending'] = undefined;
...
export default UngroupResourcesOutput;
