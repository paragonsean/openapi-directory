...
/**
 * The GroupResourcesInput model module.
 * @module model/GroupResourcesInput
 * @version 2017-11-27
 */
class GroupResourcesInput {
    /**
     * Constructs a new <code>GroupResourcesInput</code>.
     * @alias module:model/GroupResourcesInput
     * @param group {String} 
     * @param resourceArns {Array} 
     */
    constructor(group, resourceArns) { 
        
        GroupResourcesInput.initialize(this, group, resourceArns);
    }
    ...
    /**
     * Constructs a <code>GroupResourcesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GroupResourcesInput} obj Optional instance to populate.
     * @return {module:model/GroupResourcesInput} The populated <code>GroupResourcesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GroupResourcesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GroupResourcesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GroupResourcesInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GroupResourcesInput.RequiredProperties) {
...
GroupResourcesInput.RequiredProperties = ["Group", "ResourceArns"];

/**
 * @member {String} Group
 */
GroupResourcesInput.prototype['Group'] = undefined;

/**
 * @member {Array} ResourceArns
 */
GroupResourcesInput.prototype['ResourceArns'] = undefined;
...
export default GroupResourcesInput;
