...
/**
 * The UpdateGroupOutputGroup model module.
 * @module model/UpdateGroupOutputGroup
 * @version 2017-11-27
 */
class UpdateGroupOutputGroup {
    /**
     * Constructs a new <code>UpdateGroupOutputGroup</code>.
     * @alias module:model/UpdateGroupOutputGroup
    ...
    constructor(groupArn, name) { 
        ...
        UpdateGroupOutputGroup.initialize(this, groupArn, name);
    }
    ...
    /**
     * Constructs a <code>UpdateGroupOutputGroup</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateGroupOutputGroup} obj Optional instance to populate.
     * @return {module:model/UpdateGroupOutputGroup} The populated <code>UpdateGroupOutputGroup</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateGroupOutputGroup();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateGroupOutputGroup</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateGroupOutputGroup</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateGroupOutputGroup.RequiredProperties) {
...
UpdateGroupOutputGroup.RequiredProperties = ["GroupArn", "Name"];

/**
 * @member {String} GroupArn
 */
UpdateGroupOutputGroup.prototype['GroupArn'] = undefined;

/**
 * @member {String} Name
 */
UpdateGroupOutputGroup.prototype['Name'] = undefined;

/**
 * @member {String} Description
 */
UpdateGroupOutputGroup.prototype['Description'] = undefined;
...
export default UpdateGroupOutputGroup;
