...
/**
 * The PutGroupConfigurationRequest model module.
 * @module model/PutGroupConfigurationRequest
 * @version 2017-11-27
 */
class PutGroupConfigurationRequest {
    /**
     * Constructs a new <code>PutGroupConfigurationRequest</code>.
     * @alias module:model/PutGroupConfigurationRequest
     */
    constructor() { 
        
        PutGroupConfigurationRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutGroupConfigurationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutGroupConfigurationRequest} obj Optional instance to populate.
     * @return {module:model/PutGroupConfigurationRequest} The populated <code>PutGroupConfigurationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutGroupConfigurationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PutGroupConfigurationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutGroupConfigurationRequest</code>.
     */
 ...
 * @member {String} Group
 */
PutGroupConfigurationRequest.prototype['Group'] = undefined;
 ...
 */
PutGroupConfigurationRequest.prototype['Configuration'] = undefined;
...
export default PutGroupConfigurationRequest;
