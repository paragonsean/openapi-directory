...
import DeleteGroupOutputGroup from './DeleteGroupOutputGroup';
...
class DeleteGroupOutput {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Group')) {
                obj['Group'] = DeleteGroupOutputGroup.constructFromObject(data['Group']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteGroupOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteGroupOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Group`
        if (data['Group']) { // data not null
          DeleteGroupOutputGroup.validateJSON(data['Group']);
        }
...
/**
 * @member {module:model/DeleteGroupOutputGroup} Group
 */
DeleteGroupOutput.prototype['Group'] = undefined;
