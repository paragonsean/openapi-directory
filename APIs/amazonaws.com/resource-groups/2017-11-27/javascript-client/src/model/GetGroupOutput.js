...
import GetGroupOutputGroup from './GetGroupOutputGroup';
...
class GetGroupOutput {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Group')) {
                obj['Group'] = GetGroupOutputGroup.constructFromObject(data['Group']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['Group']) { // data not null
          GetGroupOutputGroup.validateJSON(data['Group']);
        }
...
/**
 * @member {module:model/GetGroupOutputGroup} Group
 */
GetGroupOutput.prototype['Group'] = undefined;
