...
/**
 * The UntagInput model module.
 * @module model/UntagInput
 * @version 2017-11-27
 */
class UntagInput {
    /**
     * Constructs a new <code>UntagInput</code>.
     * @alias module:model/UntagInput
     * @param keys {Array} 
     */
    constructor(keys) { 
        
        UntagInput.initialize(this, keys);
    }
    ...
    /**
     * Constructs a <code>UntagInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UntagInput} obj Optional instance to populate.
     * @return {module:model/UntagInput} The populated <code>UntagInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UntagInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UntagInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UntagInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UntagInput.RequiredProperties) {
...
UntagInput.RequiredProperties = ["Keys"];

/**
 * @member {Array} Keys
 */
UntagInput.prototype['Keys'] = undefined;
