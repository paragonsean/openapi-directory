...
import UpdateGroupOutputGroup from './UpdateGroupOutputGroup';
...
class UpdateGroupOutput {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Group')) {
                obj['Group'] = UpdateGroupOutputGroup.constructFromObject(data['Group']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['Group']) { // data not null
          UpdateGroupOutputGroup.validateJSON(data['Group']);
        }
...
/**
 * @member {module:model/UpdateGroupOutputGroup} Group
 */
UpdateGroupOutput.prototype['Group'] = undefined;
