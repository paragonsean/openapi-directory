...
import GetAccountSettingsOutputAccountSettings from './GetAccountSettingsOutputAccountSettings';

/**
 * The GetAccountSettingsOutput model module.
 * @module model/GetAccountSettingsOutput
 * @version 2017-11-27
 */
class GetAccountSettingsOutput {
    /**
     * Constructs a new <code>GetAccountSettingsOutput</code>.
     * @alias module:model/GetAccountSettingsOutput
     */
    constructor() { 
        
        GetAccountSettingsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetAccountSettingsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetAccountSettingsOutput} obj Optional instance to populate.
     * @return {module:model/GetAccountSettingsOutput} The populated <code>GetAccountSettingsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetAccountSettingsOutput();

            if (data.hasOwnProperty('AccountSettings')) {
                obj['AccountSettings'] = GetAccountSettingsOutputAccountSettings.constructFromObject(data['AccountSettings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetAccountSettingsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetAccountSettingsOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `AccountSettings`
        if (data['AccountSettings']) { // data not null
          GetAccountSettingsOutputAccountSettings.validateJSON(data['AccountSettings']);
        }
...
/**
 * @member {module:model/GetAccountSettingsOutputAccountSettings} AccountSettings
 */
GetAccountSettingsOutput.prototype['AccountSettings'] = undefined;
...
export default GetAccountSettingsOutput;
