...
/**
 * The GetGroupConfigurationInput model module.
 * @module model/GetGroupConfigurationInput
 * @version 2017-11-27
 */
class GetGroupConfigurationInput {
    /**
     * Constructs a new <code>GetGroupConfigurationInput</code>.
     * @alias module:model/GetGroupConfigurationInput
     */
    constructor() { 
        
        GetGroupConfigurationInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetGroupConfigurationInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetGroupConfigurationInput} obj Optional instance to populate.
     * @return {module:model/GetGroupConfigurationInput} The populated <code>GetGroupConfigurationInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetGroupConfigurationInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetGroupConfigurationInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetGroupConfigurationInput</code>.
     */
 ...
 * @member {String} Group
 */
GetGroupConfigurationInput.prototype['Group'] = undefined;
...
export default GetGroupConfigurationInput;
