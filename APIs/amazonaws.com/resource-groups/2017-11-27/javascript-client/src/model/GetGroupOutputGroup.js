...
/**
 * The GetGroupOutputGroup model module.
 * @module model/GetGroupOutputGroup
 * @version 2017-11-27
 */
class GetGroupOutputGroup {
    /**
     * Constructs a new <code>GetGroupOutputGroup</code>.
     * @alias module:model/GetGroupOutputGroup
    ...
    constructor(groupArn, name) { 
        ...
        GetGroupOutputGroup.initialize(this, groupArn, name);
    }
    ...
    /**
     * Constructs a <code>GetGroupOutputGroup</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetGroupOutputGroup} obj Optional instance to populate.
     * @return {module:model/GetGroupOutputGroup} The populated <code>GetGroupOutputGroup</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetGroupOutputGroup();
    ...
    /**
     * Validates the JSON data with respect to <code>GetGroupOutputGroup</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetGroupOutputGroup</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetGroupOutputGroup.RequiredProperties) {
...
GetGroupOutputGroup.RequiredProperties = ["GroupArn", "Name"];

/**
 * @member {String} GroupArn
 */
GetGroupOutputGroup.prototype['GroupArn'] = undefined;

/**
 * @member {String} Name
 */
GetGroupOutputGroup.prototype['Name'] = undefined;

/**
 * @member {String} Description
 */
GetGroupOutputGroup.prototype['Description'] = undefined;
...
export default GetGroupOutputGroup;
