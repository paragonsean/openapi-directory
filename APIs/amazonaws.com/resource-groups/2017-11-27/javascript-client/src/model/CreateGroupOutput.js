...
import CreateGroupOutputGroup from './CreateGroupOutputGroup';
import CreateGroupOutputGroupConfiguration from './CreateGroupOutputGroupConfiguration';
import CreateGroupOutputResourceQuery from './CreateGroupOutputResourceQuery';
...
class CreateGroupOutput {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Group')) {
                obj['Group'] = CreateGroupOutputGroup.constructFromObject(data['Group']);
            }
            if (data.hasOwnProperty('ResourceQuery')) {
                obj['ResourceQuery'] = CreateGroupOutputResourceQuery.constructFromObject(data['ResourceQuery']);
            }
            if (data.hasOwnProperty('Tags')) {
                obj['Tags'] = ApiClient.convertToType(data['Tags'], Object);
            }
            if (data.hasOwnProperty('GroupConfiguration')) {
                obj['GroupConfiguration'] = CreateGroupOutputGroupConfiguration.constructFromObject(data['GroupConfiguration']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['Group']) { // data not null
          CreateGroupOutputGroup.validateJSON(data['Group']);
        }
        // validate the optional field `ResourceQuery`
        if (data['ResourceQuery']) { // data not null
          CreateGroupOutputResourceQuery.validateJSON(data['ResourceQuery']);
        }
        ...
        if (data['GroupConfiguration']) { // data not null
          CreateGroupOutputGroupConfiguration.validateJSON(data['GroupConfiguration']);
        }
...
/**
 * @member {module:model/CreateGroupOutputGroup} Group
 */
CreateGroupOutput.prototype['Group'] = undefined;

/**
 * @member {module:model/CreateGroupOutputResourceQuery} ResourceQuery
 */
CreateGroupOutput.prototype['ResourceQuery'] = undefined;

/**
 * @member {Object} Tags
 */
CreateGroupOutput.prototype['Tags'] = undefined;

/**
 * @member {module:model/CreateGroupOutputGroupConfiguration} GroupConfiguration
 */
CreateGroupOutput.prototype['GroupConfiguration'] = undefined;
