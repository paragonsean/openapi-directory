...
import UpdateGroupQueryOutputGroupQuery from './UpdateGroupQueryOutputGroupQuery';

/**
 * The UpdateGroupQueryOutput model module.
 * @module model/UpdateGroupQueryOutput
 * @version 2017-11-27
 */
class UpdateGroupQueryOutput {
    /**
     * Constructs a new <code>UpdateGroupQueryOutput</code>.
     * @alias module:model/UpdateGroupQueryOutput
     */
    constructor() { 
        
        UpdateGroupQueryOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateGroupQueryOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateGroupQueryOutput} obj Optional instance to populate.
     * @return {module:model/UpdateGroupQueryOutput} The populated <code>UpdateGroupQueryOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateGroupQueryOutput();

            if (data.hasOwnProperty('GroupQuery')) {
                obj['GroupQuery'] = UpdateGroupQueryOutputGroupQuery.constructFromObject(data['GroupQuery']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateGroupQueryOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateGroupQueryOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GroupQuery`
        if (data['GroupQuery']) { // data not null
          UpdateGroupQueryOutputGroupQuery.validateJSON(data['GroupQuery']);
        }
...
/**
 * @member {module:model/UpdateGroupQueryOutputGroupQuery} GroupQuery
 */
UpdateGroupQueryOutput.prototype['GroupQuery'] = undefined;
...
export default UpdateGroupQueryOutput;
