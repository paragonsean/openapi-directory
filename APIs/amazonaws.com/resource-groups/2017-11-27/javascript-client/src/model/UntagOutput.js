...
/**
 * The UntagOutput model module.
 * @module model/UntagOutput
 * @version 2017-11-27
 */
class UntagOutput {
    /**
     * Constructs a new <code>UntagOutput</code>.
     * @alias module:model/UntagOutput
     */
    constructor() { 
        
        UntagOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UntagOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UntagOutput} obj Optional instance to populate.
     * @return {module:model/UntagOutput} The populated <code>UntagOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UntagOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>UntagOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UntagOutput</code>.
     */
 ...
 * @member {String} Arn
 */
UntagOutput.prototype['Arn'] = undefined;

/**
 * @member {Array} Keys
 */
UntagOutput.prototype['Keys'] = undefined;
