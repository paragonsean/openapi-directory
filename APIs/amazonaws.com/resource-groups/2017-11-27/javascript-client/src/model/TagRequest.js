...
class TagRequest {
     ...
     * @param tags {Object.<String, String>} The tags to add to the specified resource group. A tag is a string-to-string map of key-value pairs.
     */
    constructor(tags) { 
        
        TagRequest.initialize(this, tags);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of TagRequest.RequiredProperties) {
...
TagRequest.RequiredProperties = ["Tags"];

/**
 * The tags to add to the specified resource group. A tag is a string-to-string map of key-value pairs.
 * @member {Object.<String, String>} Tags
 */
TagRequest.prototype['Tags'] = undefined;
