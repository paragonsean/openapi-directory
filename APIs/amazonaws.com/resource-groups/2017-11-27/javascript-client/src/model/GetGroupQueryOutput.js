...
import GetGroupQueryOutputGroupQuery from './GetGroupQueryOutputGroupQuery';

/**
 * The GetGroupQueryOutput model module.
 * @module model/GetGroupQueryOutput
 * @version 2017-11-27
 */
class GetGroupQueryOutput {
    /**
     * Constructs a new <code>GetGroupQueryOutput</code>.
     * @alias module:model/GetGroupQueryOutput
     */
    constructor() { 
        
        GetGroupQueryOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetGroupQueryOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetGroupQueryOutput} obj Optional instance to populate.
     * @return {module:model/GetGroupQueryOutput} The populated <code>GetGroupQueryOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetGroupQueryOutput();

            if (data.hasOwnProperty('GroupQuery')) {
                obj['GroupQuery'] = GetGroupQueryOutputGroupQuery.constructFromObject(data['GroupQuery']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetGroupQueryOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetGroupQueryOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GroupQuery`
        if (data['GroupQuery']) { // data not null
          GetGroupQueryOutputGroupQuery.validateJSON(data['GroupQuery']);
        }
...
/**
 * @member {module:model/GetGroupQueryOutputGroupQuery} GroupQuery
 */
GetGroupQueryOutput.prototype['GroupQuery'] = undefined;
...
export default GetGroupQueryOutput;
