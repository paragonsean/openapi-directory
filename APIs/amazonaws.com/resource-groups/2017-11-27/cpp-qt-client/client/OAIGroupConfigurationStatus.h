...
/*
 * OAIGroupConfigurationStatus.h
 *
 * 
 */

#ifndef OAIGroupConfigurationStatus_H
#define OAIGroupConfigurationStatus_H
...
class OAIGroupConfigurationStatus : public OAIEnum {
public:
    OAIGroupConfigurationStatus();
    OAIGroupConfigurationStatus(QString json);
    ~OAIGroupConfigurationStatus() override;
    ...
    enum class eOAIGroupConfigurationStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        UPDATING, 
        UPDATE_COMPLETE, 
        UPDATE_FAILED
    };
    OAIGroupConfigurationStatus::eOAIGroupConfigurationStatus getValue() const;
    void setValue(const OAIGroupConfigurationStatus::eOAIGroupConfigurationStatus& value);
...
private:
    ...
    eOAIGroupConfigurationStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupConfigurationStatus)

#endif // OAIGroupConfigurationStatus_H
