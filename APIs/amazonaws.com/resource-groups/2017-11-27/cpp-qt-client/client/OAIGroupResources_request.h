...
/*
 * OAIGroupResources_request.h
 *
 * 
 */

#ifndef OAIGroupResources_request_H
#define OAIGroupResources_request_H
...
class OAIGroupResources_request : public OAIObject {
public:
    OAIGroupResources_request();
    OAIGroupResources_request(QString json);
    ~OAIGroupResources_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupResources_request)

#endif // OAIGroupResources_request_H
