...
/*
 * OAIGetGroupConfiguration_request.h
 *
 * 
 */

#ifndef OAIGetGroupConfiguration_request_H
#define OAIGetGroupConfiguration_request_H
...
class OAIGetGroupConfiguration_request : public OAIObject {
public:
    OAIGetGroupConfiguration_request();
    OAIGetGroupConfiguration_request(QString json);
    ~OAIGetGroupConfiguration_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetGroupConfiguration_request)

#endif // OAIGetGroupConfiguration_request_H
