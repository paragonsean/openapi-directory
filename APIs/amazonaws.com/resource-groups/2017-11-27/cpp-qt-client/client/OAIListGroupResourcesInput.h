...
/*
 * OAIListGroupResourcesInput.h
 *
 * 
 */

#ifndef OAIListGroupResourcesInput_H
#define OAIListGroupResourcesInput_H
...
class OAIListGroupResourcesInput : public OAIObject {
public:
    OAIListGroupResourcesInput();
    OAIListGroupResourcesInput(QString json);
    ~OAIListGroupResourcesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListGroupResourcesInput)

#endif // OAIListGroupResourcesInput_H
