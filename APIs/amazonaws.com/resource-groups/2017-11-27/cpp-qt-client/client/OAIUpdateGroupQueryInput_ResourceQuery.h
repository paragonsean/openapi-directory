...
/*
 * OAIUpdateGroupQueryInput_ResourceQuery.h
 *
 * 
 */

#ifndef OAIUpdateGroupQueryInput_ResourceQuery_H
#define OAIUpdateGroupQueryInput_ResourceQuery_H
...
class OAIUpdateGroupQueryInput_ResourceQuery : public OAIObject {
public:
    OAIUpdateGroupQueryInput_ResourceQuery();
    OAIUpdateGroupQueryInput_ResourceQuery(QString json);
    ~OAIUpdateGroupQueryInput_ResourceQuery() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateGroupQueryInput_ResourceQuery)

#endif // OAIUpdateGroupQueryInput_ResourceQuery_H
