...
QList<OAIGroupFilter> OAIListGroups_request::getFilters() const {
    return m_filters;
}
void OAIListGroups_request::setFilters(const QList<OAIGroupFilter> &filters) {
    m_filters = filters;
    m_filters_isSet = true;
}

bool OAIListGroups_request::is_filters_Set() const{
    return m_filters_isSet;
}

bool OAIListGroups_request::is_filters_Valid() const{
