...
/*
 * OAIResourceFilterName.h
 *
 * 
 */

#ifndef OAIResourceFilterName_H
#define OAIResourceFilterName_H
...
class OAIResourceFilterName : public OAIEnum {
public:
    OAIResourceFilterName();
    OAIResourceFilterName(QString json);
    ~OAIResourceFilterName() override;
    ...
    enum class eOAIResourceFilterName {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        RESOURCE_TYPE
    };
    OAIResourceFilterName::eOAIResourceFilterName getValue() const;
    void setValue(const OAIResourceFilterName::eOAIResourceFilterName& value);
...
private:
    ...
    eOAIResourceFilterName m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceFilterName)

#endif // OAIResourceFilterName_H
