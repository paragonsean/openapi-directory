...
/*
 * OAIGroupResourcesInput.h
 *
 * 
 */

#ifndef OAIGroupResourcesInput_H
#define OAIGroupResourcesInput_H
...
class OAIGroupResourcesInput : public OAIObject {
public:
    OAIGroupResourcesInput();
    OAIGroupResourcesInput(QString json);
    ~OAIGroupResourcesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupResourcesInput)

#endif // OAIGroupResourcesInput_H
