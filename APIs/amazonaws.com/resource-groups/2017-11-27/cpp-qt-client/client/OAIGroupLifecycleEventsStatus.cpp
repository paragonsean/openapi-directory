...
OAIGroupLifecycleEventsStatus::OAIGroupLifecycleEventsStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGroupLifecycleEventsStatus::OAIGroupLifecycleEventsStatus() {
    this->initializeModel();
}

OAIGroupLifecycleEventsStatus::~OAIGroupLifecycleEventsStatus() {}

void OAIGroupLifecycleEventsStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIGroupLifecycleEventsStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIGroupLifecycleEventsStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ACTIVE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGroupLifecycleEventsStatus::ACTIVE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("INACTIVE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGroupLifecycleEventsStatus::INACTIVE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("IN_PROGRESS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGroupLifecycleEventsStatus::IN_PROGRESS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ERROR", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGroupLifecycleEventsStatus::ERROR;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIGroupLifecycleEventsStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIGroupLifecycleEventsStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIGroupLifecycleEventsStatus::ACTIVE:
            val = "ACTIVE";
            break;
        case eOAIGroupLifecycleEventsStatus::INACTIVE:
            val = "INACTIVE";
            break;
        case eOAIGroupLifecycleEventsStatus::IN_PROGRESS:
            val = "IN_PROGRESS";
            break;
        case eOAIGroupLifecycleEventsStatus::ERROR:
            val = "ERROR";
            break;
        default:
            break;
...
QJsonValue OAIGroupLifecycleEventsStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIGroupLifecycleEventsStatus::eOAIGroupLifecycleEventsStatus OAIGroupLifecycleEventsStatus::getValue() const {
    return m_value;
}

void OAIGroupLifecycleEventsStatus::setValue(const OAIGroupLifecycleEventsStatus::eOAIGroupLifecycleEventsStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIGroupLifecycleEventsStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIGroupLifecycleEventsStatus::isValid() const {
