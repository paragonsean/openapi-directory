...
OAIGroupLifecycleEventsDesiredStatus::OAIGroupLifecycleEventsDesiredStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGroupLifecycleEventsDesiredStatus::OAIGroupLifecycleEventsDesiredStatus() {
    this->initializeModel();
}

OAIGroupLifecycleEventsDesiredStatus::~OAIGroupLifecycleEventsDesiredStatus() {}

void OAIGroupLifecycleEventsDesiredStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIGroupLifecycleEventsDesiredStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIGroupLifecycleEventsDesiredStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ACTIVE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGroupLifecycleEventsDesiredStatus::ACTIVE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("INACTIVE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGroupLifecycleEventsDesiredStatus::INACTIVE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIGroupLifecycleEventsDesiredStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIGroupLifecycleEventsDesiredStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIGroupLifecycleEventsDesiredStatus::ACTIVE:
            val = "ACTIVE";
            break;
        case eOAIGroupLifecycleEventsDesiredStatus::INACTIVE:
            val = "INACTIVE";
            break;
        default:
            break;
...
QJsonValue OAIGroupLifecycleEventsDesiredStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIGroupLifecycleEventsDesiredStatus::eOAIGroupLifecycleEventsDesiredStatus OAIGroupLifecycleEventsDesiredStatus::getValue() const {
    return m_value;
}

void OAIGroupLifecycleEventsDesiredStatus::setValue(const OAIGroupLifecycleEventsDesiredStatus::eOAIGroupLifecycleEventsDesiredStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIGroupLifecycleEventsDesiredStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIGroupLifecycleEventsDesiredStatus::isValid() const {
