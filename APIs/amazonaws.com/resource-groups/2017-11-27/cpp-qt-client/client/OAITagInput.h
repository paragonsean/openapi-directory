...
#ifndef OAITagInput_H
#define OAITagInput_H
...
class OAITagInput : public OAIObject {
public:
    OAITagInput();
    OAITagInput(QString json);
    ~OAITagInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITagInput)
