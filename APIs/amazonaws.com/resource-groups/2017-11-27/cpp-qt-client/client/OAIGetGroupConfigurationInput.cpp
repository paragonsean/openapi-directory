...
#include "OAIGetGroupConfigurationInput.h"
...
OAIGetGroupConfigurationInput::OAIGetGroupConfigurationInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetGroupConfigurationInput::OAIGetGroupConfigurationInput() {
    this->initializeModel();
}

OAIGetGroupConfigurationInput::~OAIGetGroupConfigurationInput() {}

void OAIGetGroupConfigurationInput::initializeModel() {

    m_group_isSet = false;
    m_group_isValid = false;
}

void OAIGetGroupConfigurationInput::fromJson(QString jsonString) {
...
void OAIGetGroupConfigurationInput::fromJsonObject(QJsonObject json) {

    m_group_isValid = ::OpenAPI::fromJsonValue(m_group, json[QString("Group")]);
    m_group_isSet = !json[QString("Group")].isNull() && m_group_isValid;
}

QString OAIGetGroupConfigurationInput::asJson() const {
...
QJsonObject OAIGetGroupConfigurationInput::asJsonObject() const {
    QJsonObject obj;
    if (m_group_isSet) {
...
QString OAIGetGroupConfigurationInput::getGroup() const {
    return m_group;
}
void OAIGetGroupConfigurationInput::setGroup(const QString &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAIGetGroupConfigurationInput::is_group_Set() const{
    return m_group_isSet;
}

bool OAIGetGroupConfigurationInput::is_group_Valid() const{
    return m_group_isValid;
}

bool OAIGetGroupConfigurationInput::isSet() const {
...
bool OAIGetGroupConfigurationInput::isValid() const {
