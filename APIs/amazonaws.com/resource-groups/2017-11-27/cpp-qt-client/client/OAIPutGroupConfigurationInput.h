...
/*
 * OAIPutGroupConfigurationInput.h
 *
 * 
 */

#ifndef OAIPutGroupConfigurationInput_H
#define OAIPutGroupConfigurationInput_H
...
class OAIPutGroupConfigurationInput : public OAIObject {
public:
    OAIPutGroupConfigurationInput();
    OAIPutGroupConfigurationInput(QString json);
    ~OAIPutGroupConfigurationInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutGroupConfigurationInput)

#endif // OAIPutGroupConfigurationInput_H
