...
OAIDeleteGroupOutput_Group::OAIDeleteGroupOutput_Group(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteGroupOutput_Group::OAIDeleteGroupOutput_Group() {
    this->initializeModel();
}

OAIDeleteGroupOutput_Group::~OAIDeleteGroupOutput_Group() {}

void OAIDeleteGroupOutput_Group::initializeModel() {
...
void OAIDeleteGroupOutput_Group::fromJson(QString jsonString) {
...
void OAIDeleteGroupOutput_Group::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteGroupOutput_Group::asJson() const {
...
QJsonObject OAIDeleteGroupOutput_Group::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteGroupOutput_Group::getGroupArn() const {
    return m_group_arn;
}
void OAIDeleteGroupOutput_Group::setGroupArn(const QString &group_arn) {
    m_group_arn = group_arn;
    m_group_arn_isSet = true;
}

bool OAIDeleteGroupOutput_Group::is_group_arn_Set() const{
    return m_group_arn_isSet;
}

bool OAIDeleteGroupOutput_Group::is_group_arn_Valid() const{
    return m_group_arn_isValid;
}

QString OAIDeleteGroupOutput_Group::getName() const {
    return m_name;
}
void OAIDeleteGroupOutput_Group::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDeleteGroupOutput_Group::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDeleteGroupOutput_Group::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIDeleteGroupOutput_Group::getDescription() const {
    return m_description;
}
void OAIDeleteGroupOutput_Group::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIDeleteGroupOutput_Group::is_description_Set() const{
    return m_description_isSet;
}

bool OAIDeleteGroupOutput_Group::is_description_Valid() const{
    return m_description_isValid;
}

bool OAIDeleteGroupOutput_Group::isSet() const {
...
bool OAIDeleteGroupOutput_Group::isValid() const {
