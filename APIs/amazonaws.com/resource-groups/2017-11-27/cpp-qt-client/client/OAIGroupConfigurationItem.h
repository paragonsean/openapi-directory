...
#ifndef OAIGroupConfigurationItem_H
#define OAIGroupConfigurationItem_H
...
class OAIGroupConfigurationItem : public OAIObject {
public:
    OAIGroupConfigurationItem();
    OAIGroupConfigurationItem(QString json);
    ~OAIGroupConfigurationItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupConfigurationItem)

#endif // OAIGroupConfigurationItem_H
