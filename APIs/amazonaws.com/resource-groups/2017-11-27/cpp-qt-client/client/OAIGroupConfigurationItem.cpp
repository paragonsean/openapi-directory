...
OAIGroupConfigurationItem::OAIGroupConfigurationItem(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGroupConfigurationItem::OAIGroupConfigurationItem() {
    this->initializeModel();
}

OAIGroupConfigurationItem::~OAIGroupConfigurationItem() {}

void OAIGroupConfigurationItem::initializeModel() {
...
void OAIGroupConfigurationItem::fromJson(QString jsonString) {
...
void OAIGroupConfigurationItem::fromJsonObject(QJsonObject json) {
...
QString OAIGroupConfigurationItem::asJson() const {
...
QJsonObject OAIGroupConfigurationItem::asJsonObject() const {
    QJsonObject obj;
    if (m_type_isSet) {
...
QString OAIGroupConfigurationItem::getType() const {
    return m_type;
}
void OAIGroupConfigurationItem::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIGroupConfigurationItem::is_type_Set() const{
    return m_type_isSet;
}

bool OAIGroupConfigurationItem::is_type_Valid() const{
    return m_type_isValid;
}

QList OAIGroupConfigurationItem::getParameters() const {
    return m_parameters;
}
void OAIGroupConfigurationItem::setParameters(const QList &parameters) {
    m_parameters = parameters;
    m_parameters_isSet = true;
}

bool OAIGroupConfigurationItem::is_parameters_Set() const{
    return m_parameters_isSet;
}

bool OAIGroupConfigurationItem::is_parameters_Valid() const{
    return m_parameters_isValid;
}

bool OAIGroupConfigurationItem::isSet() const {
...
bool OAIGroupConfigurationItem::isValid() const {
