...
#include "OAIGroupConfigurationParameter.h"
...
OAIGroupConfigurationParameter::OAIGroupConfigurationParameter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGroupConfigurationParameter::OAIGroupConfigurationParameter() {
    this->initializeModel();
}

OAIGroupConfigurationParameter::~OAIGroupConfigurationParameter() {}

void OAIGroupConfigurationParameter::initializeModel() {
...
void OAIGroupConfigurationParameter::fromJson(QString jsonString) {
...
void OAIGroupConfigurationParameter::fromJsonObject(QJsonObject json) {
...
QString OAIGroupConfigurationParameter::asJson() const {
...
QJsonObject OAIGroupConfigurationParameter::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIGroupConfigurationParameter::getName() const {
    return m_name;
}
void OAIGroupConfigurationParameter::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIGroupConfigurationParameter::is_name_Set() const{
    return m_name_isSet;
}

bool OAIGroupConfigurationParameter::is_name_Valid() const{
    return m_name_isValid;
}

QList OAIGroupConfigurationParameter::getValues() const {
    return m_values;
}
void OAIGroupConfigurationParameter::setValues(const QList &values) {
    m_values = values;
    m_values_isSet = true;
}

bool OAIGroupConfigurationParameter::is_values_Set() const{
    return m_values_isSet;
}

bool OAIGroupConfigurationParameter::is_values_Valid() const{
    return m_values_isValid;
}

bool OAIGroupConfigurationParameter::isSet() const {
...
bool OAIGroupConfigurationParameter::isValid() const {
