...
/*
 * OAIGroupFilterName.h
 *
 * 
 */

#ifndef OAIGroupFilterName_H
#define OAIGroupFilterName_H
...
class OAIGroupFilterName : public OAIEnum {
public:
    OAIGroupFilterName();
    OAIGroupFilterName(QString json);
    ~OAIGroupFilterName() override;
    ...
    enum class eOAIGroupFilterName {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        RESOURCE_TYPE, 
        CONFIGURATION_TYPE
    };
    OAIGroupFilterName::eOAIGroupFilterName getValue() const;
    void setValue(const OAIGroupFilterName::eOAIGroupFilterName& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupFilterName)

#endif // OAIGroupFilterName_H
