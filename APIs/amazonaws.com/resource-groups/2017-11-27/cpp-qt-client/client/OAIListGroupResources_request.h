...
/*
 * OAIListGroupResources_request.h
 *
 * 
 */

#ifndef OAIListGroupResources_request_H
#define OAIListGroupResources_request_H
...
class OAIListGroupResources_request : public OAIObject {
public:
    OAIListGroupResources_request();
    OAIListGroupResources_request(QString json);
    ~OAIListGroupResources_request() override;
    ...
    QList<OAIResourceFilter> getFilters() const;
    void setFilters(const QList<OAIResourceFilter> &filters);
...
private:
    ...
    QList<OAIResourceFilter> m_filters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListGroupResources_request)

#endif // OAIListGroupResources_request_H
