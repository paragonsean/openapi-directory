...
QJsonObject OAIUpdateAccountSettings_request::asJsonObject() const {
    QJsonObject obj;
    if (m_group_lifecycle_events_desired_status_isSet) {
        obj.insert(QString("GroupLifecycleEventsDesiredStatus"), ::OpenAPI::toJsonValue(m_group_lifecycle_events_desired_status));
    }
    return obj;
}

QString OAIUpdateAccountSettings_request::getGroupLifecycleEventsDesiredStatus() const {
    return m_group_lifecycle_events_desired_status;
}
void OAIUpdateAccountSettings_request::setGroupLifecycleEventsDesiredStatus(const QString &group_lifecycle_events_desired_status) {
...
bool OAIUpdateAccountSettings_request::is_group_lifecycle_events_desired_status_Set() const{
    return m_group_lifecycle_events_desired_status_isSet;
}

bool OAIUpdateAccountSettings_request::is_group_lifecycle_events_desired_status_Valid() const{
