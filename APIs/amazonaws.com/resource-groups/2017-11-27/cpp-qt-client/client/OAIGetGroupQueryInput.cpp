...
#include "OAIGetGroupQueryInput.h"
...
OAIGetGroupQueryInput::OAIGetGroupQueryInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetGroupQueryInput::OAIGetGroupQueryInput() {
    this->initializeModel();
}

OAIGetGroupQueryInput::~OAIGetGroupQueryInput() {}

void OAIGetGroupQueryInput::initializeModel() {
...
void OAIGetGroupQueryInput::fromJson(QString jsonString) {
...
void OAIGetGroupQueryInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetGroupQueryInput::asJson() const {
...
QJsonObject OAIGetGroupQueryInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetGroupQueryInput::getGroupName() const {
    return m_group_name;
}
void OAIGetGroupQueryInput::setGroupName(const QString &group_name) {
    m_group_name = group_name;
    m_group_name_isSet = true;
}

bool OAIGetGroupQueryInput::is_group_name_Set() const{
    return m_group_name_isSet;
}

bool OAIGetGroupQueryInput::is_group_name_Valid() const{
    return m_group_name_isValid;
}

QString OAIGetGroupQueryInput::getGroup() const {
    return m_group;
}
void OAIGetGroupQueryInput::setGroup(const QString &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAIGetGroupQueryInput::is_group_Set() const{
    return m_group_isSet;
}

bool OAIGetGroupQueryInput::is_group_Valid() const{
    return m_group_isValid;
}

bool OAIGetGroupQueryInput::isSet() const {
...
bool OAIGetGroupQueryInput::isValid() const {
