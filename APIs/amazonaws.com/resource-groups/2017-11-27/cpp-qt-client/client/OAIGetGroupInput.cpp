...
OAIGetGroupInput::OAIGetGroupInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetGroupInput::OAIGetGroupInput() {
    this->initializeModel();
}

OAIGetGroupInput::~OAIGetGroupInput() {}

void OAIGetGroupInput::initializeModel() {
...
void OAIGetGroupInput::fromJson(QString jsonString) {
...
void OAIGetGroupInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetGroupInput::asJson() const {
...
QJsonObject OAIGetGroupInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetGroupInput::getGroupName() const {
    return m_group_name;
}
void OAIGetGroupInput::setGroupName(const QString &group_name) {
    m_group_name = group_name;
    m_group_name_isSet = true;
}

bool OAIGetGroupInput::is_group_name_Set() const{
    return m_group_name_isSet;
}

bool OAIGetGroupInput::is_group_name_Valid() const{
    return m_group_name_isValid;
}

QString OAIGetGroupInput::getGroup() const {
    return m_group;
}
void OAIGetGroupInput::setGroup(const QString &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAIGetGroupInput::is_group_Set() const{
    return m_group_isSet;
}

bool OAIGetGroupInput::is_group_Valid() const{
    return m_group_isValid;
}

bool OAIGetGroupInput::isSet() const {
...
bool OAIGetGroupInput::isValid() const {
