...
/*
 * OAIGroupResourcesOutput.h
 *
 * 
 */

#ifndef OAIGroupResourcesOutput_H
#define OAIGroupResourcesOutput_H
...
class OAIGroupResourcesOutput : public OAIObject {
public:
    OAIGroupResourcesOutput();
    OAIGroupResourcesOutput(QString json);
    ~OAIGroupResourcesOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupResourcesOutput)

#endif // OAIGroupResourcesOutput_H
