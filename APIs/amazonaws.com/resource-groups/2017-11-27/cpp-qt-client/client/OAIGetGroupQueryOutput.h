...
/*
 * OAIGetGroupQueryOutput.h
 *
 * 
 */

#ifndef OAIGetGroupQueryOutput_H
#define OAIGetGroupQueryOutput_H
...
namespace OpenAPI {
class OAIGetGroupQueryOutput_GroupQuery;

class OAIGetGroupQueryOutput : public OAIObject {
public:
    OAIGetGroupQueryOutput();
    OAIGetGroupQueryOutput(QString json);
    ~OAIGetGroupQueryOutput() override;
    ...
    OAIGetGroupQueryOutput_GroupQuery getGroupQuery() const;
    void setGroupQuery(const OAIGetGroupQueryOutput_GroupQuery &group_query);
...
private:
    ...
    OAIGetGroupQueryOutput_GroupQuery m_group_query;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetGroupQueryOutput)

#endif // OAIGetGroupQueryOutput_H
