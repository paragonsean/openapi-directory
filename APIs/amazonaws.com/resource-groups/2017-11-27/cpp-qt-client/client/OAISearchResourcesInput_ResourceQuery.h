...
/*
 * OAISearchResourcesInput_ResourceQuery.h
 *
 * 
 */

#ifndef OAISearchResourcesInput_ResourceQuery_H
#define OAISearchResourcesInput_ResourceQuery_H
...
class OAISearchResourcesInput_ResourceQuery : public OAIObject {
public:
    OAISearchResourcesInput_ResourceQuery();
    OAISearchResourcesInput_ResourceQuery(QString json);
    ~OAISearchResourcesInput_ResourceQuery() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchResourcesInput_ResourceQuery)

#endif // OAISearchResourcesInput_ResourceQuery_H
