...
/*
 * OAIUpdateGroupOutput.h
 *
 * 
 */

#ifndef OAIUpdateGroupOutput_H
#define OAIUpdateGroupOutput_H
...
namespace OpenAPI {
class OAIUpdateGroupOutput_Group;

class OAIUpdateGroupOutput : public OAIObject {
public:
    OAIUpdateGroupOutput();
    OAIUpdateGroupOutput(QString json);
    ~OAIUpdateGroupOutput() override;
    ...
    OAIUpdateGroupOutput_Group getGroup() const;
    void setGroup(const OAIUpdateGroupOutput_Group &group);
...
private:
    ...
    OAIUpdateGroupOutput_Group m_group;
    bool m_group_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateGroupOutput)

#endif // OAIUpdateGroupOutput_H
