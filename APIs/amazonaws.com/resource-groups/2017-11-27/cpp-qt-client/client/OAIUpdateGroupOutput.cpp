...
OAIUpdateGroupOutput::OAIUpdateGroupOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateGroupOutput::OAIUpdateGroupOutput() {
    this->initializeModel();
}

OAIUpdateGroupOutput::~OAIUpdateGroupOutput() {}

void OAIUpdateGroupOutput::initializeModel() {

    m_group_isSet = false;
    m_group_isValid = false;
}

void OAIUpdateGroupOutput::fromJson(QString jsonString) {
...
void OAIUpdateGroupOutput::fromJsonObject(QJsonObject json) {

    m_group_isValid = ::OpenAPI::fromJsonValue(m_group, json[QString("Group")]);
    m_group_isSet = !json[QString("Group")].isNull() && m_group_isValid;
}

QString OAIUpdateGroupOutput::asJson() const {
...
QJsonObject OAIUpdateGroupOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_group.isSet()) {
...
OAIUpdateGroupOutput_Group OAIUpdateGroupOutput::getGroup() const {
    return m_group;
}
void OAIUpdateGroupOutput::setGroup(const OAIUpdateGroupOutput_Group &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAIUpdateGroupOutput::is_group_Set() const{
    return m_group_isSet;
}

bool OAIUpdateGroupOutput::is_group_Valid() const{
    return m_group_isValid;
}

bool OAIUpdateGroupOutput::isSet() const {
...
bool OAIUpdateGroupOutput::isValid() const {
