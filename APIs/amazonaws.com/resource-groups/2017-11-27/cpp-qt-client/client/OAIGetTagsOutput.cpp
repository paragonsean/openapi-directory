...
OAIGetTagsOutput::OAIGetTagsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetTagsOutput::OAIGetTagsOutput() {
    this->initializeModel();
}

OAIGetTagsOutput::~OAIGetTagsOutput() {}

void OAIGetTagsOutput::initializeModel() {
...
void OAIGetTagsOutput::fromJson(QString jsonString) {
...
void OAIGetTagsOutput::fromJsonObject(QJsonObject json) {
...
QString OAIGetTagsOutput::asJson() const {
...
QJsonObject OAIGetTagsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIGetTagsOutput::getArn() const {
    return m_arn;
}
void OAIGetTagsOutput::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIGetTagsOutput::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIGetTagsOutput::is_arn_Valid() const{
    return m_arn_isValid;
}

QMap OAIGetTagsOutput::getTags() const {
    return m_tags;
}
void OAIGetTagsOutput::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIGetTagsOutput::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIGetTagsOutput::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIGetTagsOutput::isSet() const {
...
bool OAIGetTagsOutput::isValid() const {
