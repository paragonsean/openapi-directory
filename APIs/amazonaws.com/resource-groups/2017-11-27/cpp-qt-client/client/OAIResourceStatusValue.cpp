...
#include "OAIResourceStatusValue.h"
...
OAIResourceStatusValue::OAIResourceStatusValue(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIResourceStatusValue::OAIResourceStatusValue() {
    this->initializeModel();
}

OAIResourceStatusValue::~OAIResourceStatusValue() {}

void OAIResourceStatusValue::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIResourceStatusValue::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIResourceStatusValue::fromJson(QString jsonString) {
    
    if ( jsonString.compare("PENDING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIResourceStatusValue::PENDING;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIResourceStatusValue::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIResourceStatusValue::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIResourceStatusValue::PENDING:
            val = "PENDING";
            break;
        default:
            break;
...
QJsonValue OAIResourceStatusValue::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIResourceStatusValue::eOAIResourceStatusValue OAIResourceStatusValue::getValue() const {
    return m_value;
}

void OAIResourceStatusValue::setValue(const OAIResourceStatusValue::eOAIResourceStatusValue& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIResourceStatusValue::isSet() const {
    
    return m_value_isSet;
}

bool OAIResourceStatusValue::isValid() const {
