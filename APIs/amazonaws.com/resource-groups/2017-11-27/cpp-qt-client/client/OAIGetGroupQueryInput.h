...
/*
 * OAIGetGroupQueryInput.h
 *
 * 
 */

#ifndef OAIGetGroupQueryInput_H
#define OAIGetGroupQueryInput_H
...
class OAIGetGroupQueryInput : public OAIObject {
public:
    OAIGetGroupQueryInput();
    OAIGetGroupQueryInput(QString json);
    ~OAIGetGroupQueryInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetGroupQueryInput)

#endif // OAIGetGroupQueryInput_H
