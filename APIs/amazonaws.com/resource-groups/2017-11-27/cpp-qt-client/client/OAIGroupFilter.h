...
#ifndef OAIGroupFilter_H
#define OAIGroupFilter_H
...
class OAIGroupFilter : public OAIObject {
public:
    OAIGroupFilter();
    OAIGroupFilter(QString json);
    ~OAIGroupFilter() override;
    ...
    OAIGroupFilterName getName() const;
    void setName(const OAIGroupFilterName &name);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupFilter)

#endif // OAIGroupFilter_H
