...
#ifndef OAIGetTagsOutput_H
#define OAIGetTagsOutput_H
...
class OAIGetTagsOutput : public OAIObject {
public:
    OAIGetTagsOutput();
    OAIGetTagsOutput(QString json);
    ~OAIGetTagsOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTagsOutput)

#endif // OAIGetTagsOutput_H
