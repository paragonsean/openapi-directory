...
OAIDeleteGroupOutput::OAIDeleteGroupOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteGroupOutput::OAIDeleteGroupOutput() {
    this->initializeModel();
}

OAIDeleteGroupOutput::~OAIDeleteGroupOutput() {}

void OAIDeleteGroupOutput::initializeModel() {

    m_group_isSet = false;
    m_group_isValid = false;
}

void OAIDeleteGroupOutput::fromJson(QString jsonString) {
...
void OAIDeleteGroupOutput::fromJsonObject(QJsonObject json) {

    m_group_isValid = ::OpenAPI::fromJsonValue(m_group, json[QString("Group")]);
    m_group_isSet = !json[QString("Group")].isNull() && m_group_isValid;
}

QString OAIDeleteGroupOutput::asJson() const {
...
QJsonObject OAIDeleteGroupOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_group.isSet()) {
...
OAIDeleteGroupOutput_Group OAIDeleteGroupOutput::getGroup() const {
    return m_group;
}
void OAIDeleteGroupOutput::setGroup(const OAIDeleteGroupOutput_Group &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAIDeleteGroupOutput::is_group_Set() const{
    return m_group_isSet;
}

bool OAIDeleteGroupOutput::is_group_Valid() const{
    return m_group_isValid;
}

bool OAIDeleteGroupOutput::isSet() const {
...
bool OAIDeleteGroupOutput::isValid() const {
