...
OAIGetGroupQueryOutput::OAIGetGroupQueryOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetGroupQueryOutput::OAIGetGroupQueryOutput() {
    this->initializeModel();
}

OAIGetGroupQueryOutput::~OAIGetGroupQueryOutput() {}

void OAIGetGroupQueryOutput::initializeModel() {

    m_group_query_isSet = false;
    m_group_query_isValid = false;
}

void OAIGetGroupQueryOutput::fromJson(QString jsonString) {
...
void OAIGetGroupQueryOutput::fromJsonObject(QJsonObject json) {
...
QString OAIGetGroupQueryOutput::asJson() const {
...
QJsonObject OAIGetGroupQueryOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIGetGroupQueryOutput_GroupQuery OAIGetGroupQueryOutput::getGroupQuery() const {
    return m_group_query;
}
void OAIGetGroupQueryOutput::setGroupQuery(const OAIGetGroupQueryOutput_GroupQuery &group_query) {
    m_group_query = group_query;
    m_group_query_isSet = true;
}

bool OAIGetGroupQueryOutput::is_group_query_Set() const{
    return m_group_query_isSet;
}

bool OAIGetGroupQueryOutput::is_group_query_Valid() const{
    return m_group_query_isValid;
}

bool OAIGetGroupQueryOutput::isSet() const {
...
bool OAIGetGroupQueryOutput::isValid() const {
