...
/*
 * OAICreateGroupInput_ResourceQuery.h
 *
 * 
 */

#ifndef OAICreateGroupInput_ResourceQuery_H
#define OAICreateGroupInput_ResourceQuery_H
...
class OAICreateGroupInput_ResourceQuery : public OAIObject {
public:
    OAICreateGroupInput_ResourceQuery();
    OAICreateGroupInput_ResourceQuery(QString json);
    ~OAICreateGroupInput_ResourceQuery() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateGroupInput_ResourceQuery)

#endif // OAICreateGroupInput_ResourceQuery_H
