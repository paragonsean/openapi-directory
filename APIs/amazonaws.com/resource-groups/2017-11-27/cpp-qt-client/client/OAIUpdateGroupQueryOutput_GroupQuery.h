...
/*
 * OAIUpdateGroupQueryOutput_GroupQuery.h
 *
 * 
 */

#ifndef OAIUpdateGroupQueryOutput_GroupQuery_H
#define OAIUpdateGroupQueryOutput_GroupQuery_H
...
class OAIUpdateGroupQueryOutput_GroupQuery : public OAIObject {
public:
    OAIUpdateGroupQueryOutput_GroupQuery();
    OAIUpdateGroupQueryOutput_GroupQuery(QString json);
    ~OAIUpdateGroupQueryOutput_GroupQuery() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateGroupQueryOutput_GroupQuery)

#endif // OAIUpdateGroupQueryOutput_GroupQuery_H
