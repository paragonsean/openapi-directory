...
/*
 * OAIUpdateGroupQuery_request.h
 *
 * 
 */

#ifndef OAIUpdateGroupQuery_request_H
#define OAIUpdateGroupQuery_request_H
...
class OAIUpdateGroupQuery_request : public OAIObject {
public:
    OAIUpdateGroupQuery_request();
    OAIUpdateGroupQuery_request(QString json);
    ~OAIUpdateGroupQuery_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateGroupQuery_request)

#endif // OAIUpdateGroupQuery_request_H
