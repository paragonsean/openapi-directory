...
OAIGroupQuery_ResourceQuery::OAIGroupQuery_ResourceQuery(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGroupQuery_ResourceQuery::OAIGroupQuery_ResourceQuery() {
    this->initializeModel();
}

OAIGroupQuery_ResourceQuery::~OAIGroupQuery_ResourceQuery() {}

void OAIGroupQuery_ResourceQuery::initializeModel() {
...
void OAIGroupQuery_ResourceQuery::fromJson(QString jsonString) {
...
void OAIGroupQuery_ResourceQuery::fromJsonObject(QJsonObject json) {
...
QString OAIGroupQuery_ResourceQuery::asJson() const {
...
QJsonObject OAIGroupQuery_ResourceQuery::asJsonObject() const {
    QJsonObject obj;
    if (m_type.isSet()) {
...
OAIQueryType OAIGroupQuery_ResourceQuery::getType() const {
    return m_type;
}
void OAIGroupQuery_ResourceQuery::setType(const OAIQueryType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIGroupQuery_ResourceQuery::is_type_Set() const{
    return m_type_isSet;
}

bool OAIGroupQuery_ResourceQuery::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIGroupQuery_ResourceQuery::getQuery() const {
    return m_query;
}
void OAIGroupQuery_ResourceQuery::setQuery(const QString &query) {
    m_query = query;
    m_query_isSet = true;
}

bool OAIGroupQuery_ResourceQuery::is_query_Set() const{
    return m_query_isSet;
}

bool OAIGroupQuery_ResourceQuery::is_query_Valid() const{
    return m_query_isValid;
}

bool OAIGroupQuery_ResourceQuery::isSet() const {
...
bool OAIGroupQuery_ResourceQuery::isValid() const {
