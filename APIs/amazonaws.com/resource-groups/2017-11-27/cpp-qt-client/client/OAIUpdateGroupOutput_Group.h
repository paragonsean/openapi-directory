...
/*
 * OAIUpdateGroupOutput_Group.h
 *
 * 
 */

#ifndef OAIUpdateGroupOutput_Group_H
#define OAIUpdateGroupOutput_Group_H
...
class OAIUpdateGroupOutput_Group : public OAIObject {
public:
    OAIUpdateGroupOutput_Group();
    OAIUpdateGroupOutput_Group(QString json);
    ~OAIUpdateGroupOutput_Group() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateGroupOutput_Group)

#endif // OAIUpdateGroupOutput_Group_H
