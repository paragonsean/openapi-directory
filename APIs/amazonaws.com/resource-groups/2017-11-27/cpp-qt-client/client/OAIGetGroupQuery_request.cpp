...
OAIGetGroupQuery_request::OAIGetGroupQuery_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetGroupQuery_request::OAIGetGroupQuery_request() {
    this->initializeModel();
}

OAIGetGroupQuery_request::~OAIGetGroupQuery_request() {}

void OAIGetGroupQuery_request::initializeModel() {
...
void OAIGetGroupQuery_request::fromJson(QString jsonString) {
...
void OAIGetGroupQuery_request::fromJsonObject(QJsonObject json) {
...
QString OAIGetGroupQuery_request::asJson() const {
...
QJsonObject OAIGetGroupQuery_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetGroupQuery_request::getGroupName() const {
    return m_group_name;
}
void OAIGetGroupQuery_request::setGroupName(const QString &group_name) {
    m_group_name = group_name;
    m_group_name_isSet = true;
}

bool OAIGetGroupQuery_request::is_group_name_Set() const{
    return m_group_name_isSet;
}

bool OAIGetGroupQuery_request::is_group_name_Valid() const{
    return m_group_name_isValid;
}

QString OAIGetGroupQuery_request::getGroup() const {
    return m_group;
}
void OAIGetGroupQuery_request::setGroup(const QString &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAIGetGroupQuery_request::is_group_Set() const{
    return m_group_isSet;
}

bool OAIGetGroupQuery_request::is_group_Valid() const{
    return m_group_isValid;
}

bool OAIGetGroupQuery_request::isSet() const {
...
bool OAIGetGroupQuery_request::isValid() const {
