...
/*
 * OAIDeleteGroupOutput.h
 *
 * 
 */

#ifndef OAIDeleteGroupOutput_H
#define OAIDeleteGroupOutput_H

#include <QJsonObject>

#include "OAIDeleteGroupOutput_Group.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIDeleteGroupOutput_Group;

class OAIDeleteGroupOutput : public OAIObject {
public:
    OAIDeleteGroupOutput();
    OAIDeleteGroupOutput(QString json);
    ~OAIDeleteGroupOutput() override;
    ...
    OAIDeleteGroupOutput_Group getGroup() const;
    void setGroup(const OAIDeleteGroupOutput_Group &group);
...
private:
    ...
    OAIDeleteGroupOutput_Group m_group;
    bool m_group_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteGroupOutput)

#endif // OAIDeleteGroupOutput_H
