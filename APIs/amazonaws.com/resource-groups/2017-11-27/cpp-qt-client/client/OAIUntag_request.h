...
#ifndef OAIUntag_request_H
#define OAIUntag_request_H
...
class OAIUntag_request : public OAIObject {
public:
    OAIUntag_request();
    OAIUntag_request(QString json);
    ~OAIUntag_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUntag_request)

#endif // OAIUntag_request_H
