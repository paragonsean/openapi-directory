...
#ifndef OAIGetGroupInput_H
#define OAIGetGroupInput_H
...
class OAIGetGroupInput : public OAIObject {
public:
    OAIGetGroupInput();
    OAIGetGroupInput(QString json);
    ~OAIGetGroupInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetGroupInput)

#endif // OAIGetGroupInput_H
