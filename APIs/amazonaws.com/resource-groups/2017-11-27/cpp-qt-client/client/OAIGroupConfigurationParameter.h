...
/*
 * OAIGroupConfigurationParameter.h
 *
...
#ifndef OAIGroupConfigurationParameter_H
#define OAIGroupConfigurationParameter_H
...
class OAIGroupConfigurationParameter : public OAIObject {
public:
    OAIGroupConfigurationParameter();
    OAIGroupConfigurationParameter(QString json);
    ~OAIGroupConfigurationParameter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupConfigurationParameter)

#endif // OAIGroupConfigurationParameter_H
