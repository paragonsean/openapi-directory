...
/*
 * OAIUpdateGroupInput.h
 *
 * 
 */

#ifndef OAIUpdateGroupInput_H
#define OAIUpdateGroupInput_H
...
class OAIUpdateGroupInput : public OAIObject {
public:
    OAIUpdateGroupInput();
    OAIUpdateGroupInput(QString json);
    ~OAIUpdateGroupInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateGroupInput)

#endif // OAIUpdateGroupInput_H
