...
/*
 * OAIListGroups_request.h
 *
 * 
 */

#ifndef OAIListGroups_request_H
#define OAIListGroups_request_H

#include <QJsonObject>

#include "OAIGroupFilter.h"
#include <QList>
...
namespace OpenAPI {
class OAIGroupFilter;

class OAIListGroups_request : public OAIObject {
public:
    OAIListGroups_request();
    OAIListGroups_request(QString json);
    ~OAIListGroups_request() override;
    ...
    QList<OAIGroupFilter> getFilters() const;
    void setFilters(const QList<OAIGroupFilter> &filters);
...
private:
    ...
    QList<OAIGroupFilter> m_filters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListGroups_request)

#endif // OAIListGroups_request_H
