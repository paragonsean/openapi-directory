...
OAIGroupFilter::OAIGroupFilter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGroupFilter::OAIGroupFilter() {
    this->initializeModel();
}

OAIGroupFilter::~OAIGroupFilter() {}

void OAIGroupFilter::initializeModel() {
...
void OAIGroupFilter::fromJson(QString jsonString) {
...
void OAIGroupFilter::fromJsonObject(QJsonObject json) {
...
QString OAIGroupFilter::asJson() const {
...
QJsonObject OAIGroupFilter::asJsonObject() const {
    QJsonObject obj;
    if (m_name.isSet()) {
...
OAIGroupFilterName OAIGroupFilter::getName() const {
    return m_name;
}
void OAIGroupFilter::setName(const OAIGroupFilterName &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIGroupFilter::is_name_Set() const{
    return m_name_isSet;
}

bool OAIGroupFilter::is_name_Valid() const{
    return m_name_isValid;
}

QList OAIGroupFilter::getValues() const {
    return m_values;
}
void OAIGroupFilter::setValues(const QList &values) {
    m_values = values;
    m_values_isSet = true;
}

bool OAIGroupFilter::is_values_Set() const{
    return m_values_isSet;
}

bool OAIGroupFilter::is_values_Valid() const{
    return m_values_isValid;
}

bool OAIGroupFilter::isSet() const {
...
bool OAIGroupFilter::isValid() const {
