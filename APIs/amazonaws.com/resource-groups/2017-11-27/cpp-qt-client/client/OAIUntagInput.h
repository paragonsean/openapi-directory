...
#ifndef OAIUntagInput_H
#define OAIUntagInput_H
...
class OAIUntagInput : public OAIObject {
public:
    OAIUntagInput();
    OAIUntagInput(QString json);
    ~OAIUntagInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUntagInput)

#endif // OAIUntagInput_H
