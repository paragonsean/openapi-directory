...
OAIUpdateGroupQueryOutput::OAIUpdateGroupQueryOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateGroupQueryOutput::OAIUpdateGroupQueryOutput() {
    this->initializeModel();
}

OAIUpdateGroupQueryOutput::~OAIUpdateGroupQueryOutput() {}

void OAIUpdateGroupQueryOutput::initializeModel() {

    m_group_query_isSet = false;
    m_group_query_isValid = false;
}

void OAIUpdateGroupQueryOutput::fromJson(QString jsonString) {
...
void OAIUpdateGroupQueryOutput::fromJsonObject(QJsonObject json) {

    m_group_query_isValid = ::OpenAPI::fromJsonValue(m_group_query, json[QString("GroupQuery")]);
    m_group_query_isSet = !json[QString("GroupQuery")].isNull() && m_group_query_isValid;
}

QString OAIUpdateGroupQueryOutput::asJson() const {
...
QJsonObject OAIUpdateGroupQueryOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_group_query.isSet()) {
        obj.insert(QString("GroupQuery"), ::OpenAPI::toJsonValue(m_group_query));
    }
    return obj;
}

OAIUpdateGroupQueryOutput_GroupQuery OAIUpdateGroupQueryOutput::getGroupQuery() const {
    return m_group_query;
}
void OAIUpdateGroupQueryOutput::setGroupQuery(const OAIUpdateGroupQueryOutput_GroupQuery &group_query) {
    m_group_query = group_query;
    m_group_query_isSet = true;
}

bool OAIUpdateGroupQueryOutput::is_group_query_Set() const{
    return m_group_query_isSet;
}

bool OAIUpdateGroupQueryOutput::is_group_query_Valid() const{
    return m_group_query_isValid;
}

bool OAIUpdateGroupQueryOutput::isSet() const {
...
bool OAIUpdateGroupQueryOutput::isValid() const {
