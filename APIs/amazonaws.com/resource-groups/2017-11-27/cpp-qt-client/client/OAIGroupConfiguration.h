...
#ifndef OAIGroupConfiguration_H
#define OAIGroupConfiguration_H
...
class OAIGroupConfiguration : public OAIObject {
public:
    OAIGroupConfiguration();
    OAIGroupConfiguration(QString json);
    ~OAIGroupConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupConfiguration)

#endif // OAIGroupConfiguration_H
