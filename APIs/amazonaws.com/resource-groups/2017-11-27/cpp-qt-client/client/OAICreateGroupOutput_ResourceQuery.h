...
/*
 * OAICreateGroupOutput_ResourceQuery.h
 *
 * 
 */

#ifndef OAICreateGroupOutput_ResourceQuery_H
#define OAICreateGroupOutput_ResourceQuery_H
...
class OAICreateGroupOutput_ResourceQuery : public OAIObject {
public:
    OAICreateGroupOutput_ResourceQuery();
    OAICreateGroupOutput_ResourceQuery(QString json);
    ~OAICreateGroupOutput_ResourceQuery() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateGroupOutput_ResourceQuery)

#endif // OAICreateGroupOutput_ResourceQuery_H
