...
/*
 * OAIResourceIdentifier.h
 *
 * A structure that contains the ARN of a resource and its resource type.
 */

#ifndef OAIResourceIdentifier_H
#define OAIResourceIdentifier_H
...
class OAIResourceIdentifier : public OAIObject {
public:
    OAIResourceIdentifier();
    OAIResourceIdentifier(QString json);
    ~OAIResourceIdentifier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceIdentifier)

#endif // OAIResourceIdentifier_H
