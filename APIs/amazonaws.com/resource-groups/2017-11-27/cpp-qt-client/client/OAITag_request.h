...
#ifndef OAITag_request_H
#define OAITag_request_H
...
class OAITag_request : public OAIObject {
public:
    OAITag_request();
    OAITag_request(QString json);
    ~OAITag_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITag_request)

#endif // OAITag_request_H
