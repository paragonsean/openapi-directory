...
#include "OAICreateGroupInput_ResourceQuery.h"
...
OAICreateGroupInput_ResourceQuery::OAICreateGroupInput_ResourceQuery(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateGroupInput_ResourceQuery::OAICreateGroupInput_ResourceQuery() {
    this->initializeModel();
}

OAICreateGroupInput_ResourceQuery::~OAICreateGroupInput_ResourceQuery() {}

void OAICreateGroupInput_ResourceQuery::initializeModel() {
...
void OAICreateGroupInput_ResourceQuery::fromJson(QString jsonString) {
...
void OAICreateGroupInput_ResourceQuery::fromJsonObject(QJsonObject json) {
...
QString OAICreateGroupInput_ResourceQuery::asJson() const {
...
QJsonObject OAICreateGroupInput_ResourceQuery::asJsonObject() const {
    QJsonObject obj;
    if (m_type.isSet()) {
...
OAIQueryType OAICreateGroupInput_ResourceQuery::getType() const {
    return m_type;
}
void OAICreateGroupInput_ResourceQuery::setType(const OAIQueryType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICreateGroupInput_ResourceQuery::is_type_Set() const{
    return m_type_isSet;
}

bool OAICreateGroupInput_ResourceQuery::is_type_Valid() const{
    return m_type_isValid;
}

QString OAICreateGroupInput_ResourceQuery::getQuery() const {
    return m_query;
}
void OAICreateGroupInput_ResourceQuery::setQuery(const QString &query) {
    m_query = query;
    m_query_isSet = true;
}

bool OAICreateGroupInput_ResourceQuery::is_query_Set() const{
    return m_query_isSet;
}

bool OAICreateGroupInput_ResourceQuery::is_query_Valid() const{
    return m_query_isValid;
}

bool OAICreateGroupInput_ResourceQuery::isSet() const {
...
bool OAICreateGroupInput_ResourceQuery::isValid() const {
