...
/*
 * OAIPutGroupConfiguration_request.h
 *
 * 
 */

#ifndef OAIPutGroupConfiguration_request_H
#define OAIPutGroupConfiguration_request_H
...
class OAIPutGroupConfiguration_request : public OAIObject {
public:
    OAIPutGroupConfiguration_request();
    OAIPutGroupConfiguration_request(QString json);
    ~OAIPutGroupConfiguration_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutGroupConfiguration_request)

#endif // OAIPutGroupConfiguration_request_H
