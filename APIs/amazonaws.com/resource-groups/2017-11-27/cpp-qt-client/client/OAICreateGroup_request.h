...
#include "OAICreateGroup_request_ResourceQuery.h"
#include "OAIGroupConfigurationItem.h"
#include <QList>
#include <QMap>
#include <QString>
...
namespace OpenAPI {
class OAICreateGroup_request_ResourceQuery;
class OAIGroupConfigurationItem;
...
public:
    ...
    OAICreateGroup_request_ResourceQuery getResourceQuery() const;
    void setResourceQuery(const OAICreateGroup_request_ResourceQuery &resource_query);
    ...
    QList<OAIGroupConfigurationItem> getConfiguration() const;
    void setConfiguration(const QList<OAIGroupConfigurationItem> &configuration);
...
private:
    ...
    OAICreateGroup_request_ResourceQuery m_resource_query;
    ...
    QList<OAIGroupConfigurationItem> m_configuration;
