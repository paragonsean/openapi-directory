...
OAIGetGroup_request::OAIGetGroup_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetGroup_request::OAIGetGroup_request() {
    this->initializeModel();
}

OAIGetGroup_request::~OAIGetGroup_request() {}

void OAIGetGroup_request::initializeModel() {
...
void OAIGetGroup_request::fromJson(QString jsonString) {
...
void OAIGetGroup_request::fromJsonObject(QJsonObject json) {
...
QString OAIGetGroup_request::asJson() const {
...
QJsonObject OAIGetGroup_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetGroup_request::getGroupName() const {
    return m_group_name;
}
void OAIGetGroup_request::setGroupName(const QString &group_name) {
    m_group_name = group_name;
    m_group_name_isSet = true;
}

bool OAIGetGroup_request::is_group_name_Set() const{
    return m_group_name_isSet;
}

bool OAIGetGroup_request::is_group_name_Valid() const{
    return m_group_name_isValid;
}

QString OAIGetGroup_request::getGroup() const {
    return m_group;
}
void OAIGetGroup_request::setGroup(const QString &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAIGetGroup_request::is_group_Set() const{
    return m_group_isSet;
}

bool OAIGetGroup_request::is_group_Valid() const{
    return m_group_isValid;
}

bool OAIGetGroup_request::isSet() const {
...
bool OAIGetGroup_request::isValid() const {
