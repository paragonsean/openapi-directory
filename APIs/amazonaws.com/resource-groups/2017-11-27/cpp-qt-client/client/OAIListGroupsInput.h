...
/*
 * OAIListGroupsInput.h
 *
 * 
 */

#ifndef OAIListGroupsInput_H
#define OAIListGroupsInput_H
...
class OAIListGroupsInput : public OAIObject {
public:
    OAIListGroupsInput();
    OAIListGroupsInput(QString json);
    ~OAIListGroupsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListGroupsInput)

#endif // OAIListGroupsInput_H
