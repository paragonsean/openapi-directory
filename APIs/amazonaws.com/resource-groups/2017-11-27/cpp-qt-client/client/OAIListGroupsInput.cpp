...
OAIListGroupsInput::OAIListGroupsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListGroupsInput::OAIListGroupsInput() {
    this->initializeModel();
}

OAIListGroupsInput::~OAIListGroupsInput() {}

void OAIListGroupsInput::initializeModel() {

    m_filters_isSet = false;
    m_filters_isValid = false;
}

void OAIListGroupsInput::fromJson(QString jsonString) {
...
void OAIListGroupsInput::fromJsonObject(QJsonObject json) {

    m_filters_isValid = ::OpenAPI::fromJsonValue(m_filters, json[QString("Filters")]);
    m_filters_isSet = !json[QString("Filters")].isNull() && m_filters_isValid;
}

QString OAIListGroupsInput::asJson() const {
...
QJsonObject OAIListGroupsInput::asJsonObject() const {
    QJsonObject obj;
    if (m_filters.isSet()) {
...
QList OAIListGroupsInput::getFilters() const {
    return m_filters;
}
void OAIListGroupsInput::setFilters(const QList &filters) {
    m_filters = filters;
    m_filters_isSet = true;
}

bool OAIListGroupsInput::is_filters_Set() const{
    return m_filters_isSet;
}

bool OAIListGroupsInput::is_filters_Valid() const{
    return m_filters_isValid;
}

bool OAIListGroupsInput::isSet() const {
...
bool OAIListGroupsInput::isValid() const {
