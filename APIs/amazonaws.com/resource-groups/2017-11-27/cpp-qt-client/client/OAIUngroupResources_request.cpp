...
OAIUngroupResources_request::OAIUngroupResources_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUngroupResources_request::OAIUngroupResources_request() {
    this->initializeModel();
}

OAIUngroupResources_request::~OAIUngroupResources_request() {}

void OAIUngroupResources_request::initializeModel() {
...
void OAIUngroupResources_request::fromJson(QString jsonString) {
...
void OAIUngroupResources_request::fromJsonObject(QJsonObject json) {
...
QString OAIUngroupResources_request::asJson() const {
...
QJsonObject OAIUngroupResources_request::asJsonObject() const {
    QJsonObject obj;
    if (m_group_isSet) {
...
QString OAIUngroupResources_request::getGroup() const {
    return m_group;
}
void OAIUngroupResources_request::setGroup(const QString &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAIUngroupResources_request::is_group_Set() const{
    return m_group_isSet;
}

bool OAIUngroupResources_request::is_group_Valid() const{
    return m_group_isValid;
}

QList<QString> OAIUngroupResources_request::getResourceArns() const {
    return m_resource_arns;
}
void OAIUngroupResources_request::setResourceArns(const QList<QString> &resource_arns) {
    m_resource_arns = resource_arns;
    m_resource_arns_isSet = true;
}

bool OAIUngroupResources_request::is_resource_arns_Set() const{
    return m_resource_arns_isSet;
}

bool OAIUngroupResources_request::is_resource_arns_Valid() const{
    return m_resource_arns_isValid;
}

bool OAIUngroupResources_request::isSet() const {
...
bool OAIUngroupResources_request::isValid() const {
