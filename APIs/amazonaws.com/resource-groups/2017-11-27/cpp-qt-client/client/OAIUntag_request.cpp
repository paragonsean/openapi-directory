...
OAIUntag_request::OAIUntag_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUntag_request::OAIUntag_request() {
    this->initializeModel();
}

OAIUntag_request::~OAIUntag_request() {}

void OAIUntag_request::initializeModel() {

    m_keys_isSet = false;
    m_keys_isValid = false;
}

void OAIUntag_request::fromJson(QString jsonString) {
...
QJsonObject OAIUntag_request::asJsonObject() const {
    QJsonObject obj;
    if (m_keys.size() > 0) {
...
QList<QString> OAIUntag_request::getKeys() const {
    return m_keys;
}
void OAIUntag_request::setKeys(const QList<QString> &keys) {
    m_keys = keys;
    m_keys_isSet = true;
}

bool OAIUntag_request::is_keys_Set() const{
    return m_keys_isSet;
}

bool OAIUntag_request::is_keys_Valid() const{
    return m_keys_isValid;
}

bool OAIUntag_request::isSet() const {
...
bool OAIUntag_request::isValid() const {
