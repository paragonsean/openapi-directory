...
#include "OAIGroupResourcesInput.h"
...
OAIGroupResourcesInput::OAIGroupResourcesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGroupResourcesInput::OAIGroupResourcesInput() {
    this->initializeModel();
}

OAIGroupResourcesInput::~OAIGroupResourcesInput() {}

void OAIGroupResourcesInput::initializeModel() {
...
void OAIGroupResourcesInput::fromJson(QString jsonString) {
...
void OAIGroupResourcesInput::fromJsonObject(QJsonObject json) {
...
QString OAIGroupResourcesInput::asJson() const {
...
QJsonObject OAIGroupResourcesInput::asJsonObject() const {
    QJsonObject obj;
    if (m_group_isSet) {
...
QString OAIGroupResourcesInput::getGroup() const {
    return m_group;
}
void OAIGroupResourcesInput::setGroup(const QString &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAIGroupResourcesInput::is_group_Set() const{
    return m_group_isSet;
}

bool OAIGroupResourcesInput::is_group_Valid() const{
    return m_group_isValid;
}

QList OAIGroupResourcesInput::getResourceArns() const {
    return m_resource_arns;
}
void OAIGroupResourcesInput::setResourceArns(const QList &resource_arns) {
    m_resource_arns = resource_arns;
    m_resource_arns_isSet = true;
}

bool OAIGroupResourcesInput::is_resource_arns_Set() const{
    return m_resource_arns_isSet;
}

bool OAIGroupResourcesInput::is_resource_arns_Valid() const{
    return m_resource_arns_isValid;
}

bool OAIGroupResourcesInput::isSet() const {
...
bool OAIGroupResourcesInput::isValid() const {
