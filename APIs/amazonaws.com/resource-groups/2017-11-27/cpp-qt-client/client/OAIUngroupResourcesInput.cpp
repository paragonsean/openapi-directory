...
#include "OAIUngroupResourcesInput.h"
...
OAIUngroupResourcesInput::OAIUngroupResourcesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUngroupResourcesInput::OAIUngroupResourcesInput() {
    this->initializeModel();
}

OAIUngroupResourcesInput::~OAIUngroupResourcesInput() {}

void OAIUngroupResourcesInput::initializeModel() {
...
void OAIUngroupResourcesInput::fromJson(QString jsonString) {
...
void OAIUngroupResourcesInput::fromJsonObject(QJsonObject json) {
...
QString OAIUngroupResourcesInput::asJson() const {
...
QJsonObject OAIUngroupResourcesInput::asJsonObject() const {
    QJsonObject obj;
    if (m_group_isSet) {
...
QString OAIUngroupResourcesInput::getGroup() const {
    return m_group;
}
void OAIUngroupResourcesInput::setGroup(const QString &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAIUngroupResourcesInput::is_group_Set() const{
    return m_group_isSet;
}

bool OAIUngroupResourcesInput::is_group_Valid() const{
    return m_group_isValid;
}

QList OAIUngroupResourcesInput::getResourceArns() const {
    return m_resource_arns;
}
void OAIUngroupResourcesInput::setResourceArns(const QList &resource_arns) {
    m_resource_arns = resource_arns;
    m_resource_arns_isSet = true;
}

bool OAIUngroupResourcesInput::is_resource_arns_Set() const{
    return m_resource_arns_isSet;
}

bool OAIUngroupResourcesInput::is_resource_arns_Valid() const{
    return m_resource_arns_isValid;
}

bool OAIUngroupResourcesInput::isSet() const {
...
bool OAIUngroupResourcesInput::isValid() const {
