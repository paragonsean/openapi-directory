...
/*
 * OAIDeleteGroupInput.h
 *
 * 
 */

#ifndef OAIDeleteGroupInput_H
#define OAIDeleteGroupInput_H
...
class OAIDeleteGroupInput : public OAIObject {
public:
    OAIDeleteGroupInput();
    OAIDeleteGroupInput(QString json);
    ~OAIDeleteGroupInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteGroupInput)

#endif // OAIDeleteGroupInput_H
