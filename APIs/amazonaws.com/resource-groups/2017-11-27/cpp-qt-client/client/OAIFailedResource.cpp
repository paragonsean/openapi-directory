...
OAIFailedResource::OAIFailedResource(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFailedResource::OAIFailedResource() {
    this->initializeModel();
}

OAIFailedResource::~OAIFailedResource() {}

void OAIFailedResource::initializeModel() {
...
void OAIFailedResource::fromJson(QString jsonString) {
...
void OAIFailedResource::fromJsonObject(QJsonObject json) {
...
QString OAIFailedResource::asJson() const {
...
QJsonObject OAIFailedResource::asJsonObject() const {
    QJsonObject obj;
...
QString OAIFailedResource::getResourceArn() const {
    return m_resource_arn;
}
void OAIFailedResource::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAIFailedResource::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAIFailedResource::is_resource_arn_Valid() const{
    return m_resource_arn_isValid;
}

QString OAIFailedResource::getErrorMessage() const {
    return m_error_message;
}
void OAIFailedResource::setErrorMessage(const QString &error_message) {
    m_error_message = error_message;
    m_error_message_isSet = true;
}

bool OAIFailedResource::is_error_message_Set() const{
    return m_error_message_isSet;
}

bool OAIFailedResource::is_error_message_Valid() const{
    return m_error_message_isValid;
}

QString OAIFailedResource::getErrorCode() const {
    return m_error_code;
}
void OAIFailedResource::setErrorCode(const QString &error_code) {
    m_error_code = error_code;
    m_error_code_isSet = true;
}

bool OAIFailedResource::is_error_code_Set() const{
    return m_error_code_isSet;
}

bool OAIFailedResource::is_error_code_Valid() const{
    return m_error_code_isValid;
}

bool OAIFailedResource::isSet() const {
...
bool OAIFailedResource::isValid() const {
