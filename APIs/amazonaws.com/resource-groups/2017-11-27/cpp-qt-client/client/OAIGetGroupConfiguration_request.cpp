...
OAIGetGroupConfiguration_request::OAIGetGroupConfiguration_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetGroupConfiguration_request::OAIGetGroupConfiguration_request() {
    this->initializeModel();
}

OAIGetGroupConfiguration_request::~OAIGetGroupConfiguration_request() {}

void OAIGetGroupConfiguration_request::initializeModel() {

    m_group_isSet = false;
    m_group_isValid = false;
}

void OAIGetGroupConfiguration_request::fromJson(QString jsonString) {
...
void OAIGetGroupConfiguration_request::fromJsonObject(QJsonObject json) {

    m_group_isValid = ::OpenAPI::fromJsonValue(m_group, json[QString("Group")]);
    m_group_isSet = !json[QString("Group")].isNull() && m_group_isValid;
}

QString OAIGetGroupConfiguration_request::asJson() const {
...
QJsonObject OAIGetGroupConfiguration_request::asJsonObject() const {
    QJsonObject obj;
    if (m_group_isSet) {
...
QString OAIGetGroupConfiguration_request::getGroup() const {
    return m_group;
}
void OAIGetGroupConfiguration_request::setGroup(const QString &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAIGetGroupConfiguration_request::is_group_Set() const{
    return m_group_isSet;
}

bool OAIGetGroupConfiguration_request::is_group_Valid() const{
    return m_group_isValid;
}

bool OAIGetGroupConfiguration_request::isSet() const {
...
bool OAIGetGroupConfiguration_request::isValid() const {
