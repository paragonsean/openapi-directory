...
OAITag_request::OAITag_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITag_request::OAITag_request() {
    this->initializeModel();
}

OAITag_request::~OAITag_request() {}

void OAITag_request::initializeModel() {

    m_tags_isSet = false;
    m_tags_isValid = false;
}

void OAITag_request::fromJson(QString jsonString) {
...
void OAITag_request::fromJsonObject(QJsonObject json) {

    m_tags_isValid = ::OpenAPI::fromJsonValue(m_tags, json[QString("Tags")]);
    m_tags_isSet = !json[QString("Tags")].isNull() && m_tags_isValid;
}

QString OAITag_request::asJson() const {
...
QJsonObject OAITag_request::asJsonObject() const {
    QJsonObject obj;
    if (m_tags.size() > 0) {
...
QMap<QString, QString> OAITag_request::getTags() const {
    return m_tags;
}
void OAITag_request::setTags(const QMap<QString, QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAITag_request::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAITag_request::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAITag_request::isSet() const {
...
bool OAITag_request::isValid() const {
