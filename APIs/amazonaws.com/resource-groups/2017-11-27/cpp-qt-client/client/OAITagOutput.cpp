...
OAITagOutput::OAITagOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITagOutput::OAITagOutput() {
    this->initializeModel();
}

OAITagOutput::~OAITagOutput() {}

void OAITagOutput::initializeModel() {
...
void OAITagOutput::fromJson(QString jsonString) {
...
void OAITagOutput::fromJsonObject(QJsonObject json) {
...
QString OAITagOutput::asJson() const {
...
QJsonObject OAITagOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAITagOutput::getArn() const {
    return m_arn;
}
void OAITagOutput::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAITagOutput::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAITagOutput::is_arn_Valid() const{
    return m_arn_isValid;
}

QMap OAITagOutput::getTags() const {
    return m_tags;
}
void OAITagOutput::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAITagOutput::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAITagOutput::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAITagOutput::isSet() const {
...
bool OAITagOutput::isValid() const {
