...
public:
    ...
    QString getGroupLifecycleEventsDesiredStatus() const;
    void setGroupLifecycleEventsDesiredStatus(const QString &group_lifecycle_events_desired_status);
...
private:
    ...
    QString m_group_lifecycle_events_desired_status;
