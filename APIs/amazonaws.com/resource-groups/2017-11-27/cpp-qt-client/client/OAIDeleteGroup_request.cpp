...
QString OAIDeleteGroup_request::getGroup() const {
    return m_group;
}
void OAIDeleteGroup_request::setGroup(const QString &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAIDeleteGroup_request::is_group_Set() const{
    return m_group_isSet;
}

bool OAIDeleteGroup_request::is_group_Valid() const{
