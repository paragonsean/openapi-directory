...
/*
 * OAIListGroupResourcesOutput.h
 *
 * 
 */

#ifndef OAIListGroupResourcesOutput_H
#define OAIListGroupResourcesOutput_H
...
class OAIListGroupResourcesOutput : public OAIObject {
public:
    OAIListGroupResourcesOutput();
    OAIListGroupResourcesOutput(QString json);
    ~OAIListGroupResourcesOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListGroupResourcesOutput)

#endif // OAIListGroupResourcesOutput_H
