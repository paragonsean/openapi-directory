...
/*
 * OAIGroupIdentifier.h
 *
 * The unique identifiers for a resource group.
 */

#ifndef OAIGroupIdentifier_H
#define OAIGroupIdentifier_H
...
class OAIGroupIdentifier : public OAIObject {
public:
    OAIGroupIdentifier();
    OAIGroupIdentifier(QString json);
    ~OAIGroupIdentifier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupIdentifier)

#endif // OAIGroupIdentifier_H
