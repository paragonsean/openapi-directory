...
#ifndef OAIListGroupResourcesItem_H
#define OAIListGroupResourcesItem_H
...
namespace OpenAPI {
class OAIResourceIdentifier;
class OAIListGroupResourcesItem_Status;

class OAIListGroupResourcesItem : public OAIObject {
public:
    OAIListGroupResourcesItem();
    OAIListGroupResourcesItem(QString json);
    ~OAIListGroupResourcesItem() override;
    ...
    OAIResourceIdentifier getIdentifier() const;
    void setIdentifier(const OAIResourceIdentifier &identifier);
    bool is_identifier_Set() const;
    bool is_identifier_Valid() const;

    OAIListGroupResourcesItem_Status getStatus() const;
    void setStatus(const OAIListGroupResourcesItem_Status &status);
...
private:
    ...
    OAIResourceIdentifier m_identifier;
    bool m_identifier_isSet;
    bool m_identifier_isValid;

    OAIListGroupResourcesItem_Status m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListGroupResourcesItem)

#endif // OAIListGroupResourcesItem_H
