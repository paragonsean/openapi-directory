...
#include "OAIResourceIdentifier.h"
...
OAIResourceIdentifier::OAIResourceIdentifier(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIResourceIdentifier::OAIResourceIdentifier() {
    this->initializeModel();
}

OAIResourceIdentifier::~OAIResourceIdentifier() {}

void OAIResourceIdentifier::initializeModel() {
...
void OAIResourceIdentifier::fromJson(QString jsonString) {
...
void OAIResourceIdentifier::fromJsonObject(QJsonObject json) {
...
QString OAIResourceIdentifier::asJson() const {
...
QJsonObject OAIResourceIdentifier::asJsonObject() const {
    QJsonObject obj;
...
QString OAIResourceIdentifier::getResourceArn() const {
    return m_resource_arn;
}
void OAIResourceIdentifier::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAIResourceIdentifier::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAIResourceIdentifier::is_resource_arn_Valid() const{
    return m_resource_arn_isValid;
}

QString OAIResourceIdentifier::getResourceType() const {
    return m_resource_type;
}
void OAIResourceIdentifier::setResourceType(const QString &resource_type) {
    m_resource_type = resource_type;
    m_resource_type_isSet = true;
}

bool OAIResourceIdentifier::is_resource_type_Set() const{
    return m_resource_type_isSet;
}

bool OAIResourceIdentifier::is_resource_type_Valid() const{
    return m_resource_type_isValid;
}

bool OAIResourceIdentifier::isSet() const {
...
bool OAIResourceIdentifier::isValid() const {
