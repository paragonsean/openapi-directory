...
/*
 * OAICreateGroupInput.h
 *
 * 
 */

#ifndef OAICreateGroupInput_H
#define OAICreateGroupInput_H
...
namespace OpenAPI {
class OAICreateGroupInput_ResourceQuery;

class OAICreateGroupInput : public OAIObject {
public:
    OAICreateGroupInput();
    OAICreateGroupInput(QString json);
    ~OAICreateGroupInput() override;
    ...
    OAICreateGroupInput_ResourceQuery getResourceQuery() const;
    void setResourceQuery(const OAICreateGroupInput_ResourceQuery &resource_query);
...
private:
    ...
    OAICreateGroupInput_ResourceQuery m_resource_query;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateGroupInput)

#endif // OAICreateGroupInput_H
