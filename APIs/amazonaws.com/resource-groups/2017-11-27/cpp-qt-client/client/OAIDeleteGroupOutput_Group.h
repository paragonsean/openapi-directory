...
/*
 * OAIDeleteGroupOutput_Group.h
 *
 * 
 */

#ifndef OAIDeleteGroupOutput_Group_H
#define OAIDeleteGroupOutput_Group_H
...
class OAIDeleteGroupOutput_Group : public OAIObject {
public:
    OAIDeleteGroupOutput_Group();
    OAIDeleteGroupOutput_Group(QString json);
    ~OAIDeleteGroupOutput_Group() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteGroupOutput_Group)

#endif // OAIDeleteGroupOutput_Group_H
