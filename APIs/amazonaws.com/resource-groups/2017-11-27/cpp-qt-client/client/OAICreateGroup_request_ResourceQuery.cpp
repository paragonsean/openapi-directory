...
OAICreateGroup_request_ResourceQuery::OAICreateGroup_request_ResourceQuery(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateGroup_request_ResourceQuery::OAICreateGroup_request_ResourceQuery() {
    this->initializeModel();
}

OAICreateGroup_request_ResourceQuery::~OAICreateGroup_request_ResourceQuery() {}

void OAICreateGroup_request_ResourceQuery::initializeModel() {
...
void OAICreateGroup_request_ResourceQuery::fromJson(QString jsonString) {
...
void OAICreateGroup_request_ResourceQuery::fromJsonObject(QJsonObject json) {
...
QString OAICreateGroup_request_ResourceQuery::asJson() const {
...
QJsonObject OAICreateGroup_request_ResourceQuery::asJsonObject() const {
    QJsonObject obj;
    if (m_type.isSet()) {
...
OAIQueryType OAICreateGroup_request_ResourceQuery::getType() const {
    return m_type;
}
void OAICreateGroup_request_ResourceQuery::setType(const OAIQueryType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICreateGroup_request_ResourceQuery::is_type_Set() const{
    return m_type_isSet;
}

bool OAICreateGroup_request_ResourceQuery::is_type_Valid() const{
    return m_type_isValid;
}

QString OAICreateGroup_request_ResourceQuery::getQuery() const {
    return m_query;
}
void OAICreateGroup_request_ResourceQuery::setQuery(const QString &query) {
    m_query = query;
    m_query_isSet = true;
}

bool OAICreateGroup_request_ResourceQuery::is_query_Set() const{
    return m_query_isSet;
}

bool OAICreateGroup_request_ResourceQuery::is_query_Valid() const{
    return m_query_isValid;
}

bool OAICreateGroup_request_ResourceQuery::isSet() const {
...
bool OAICreateGroup_request_ResourceQuery::isValid() const {
