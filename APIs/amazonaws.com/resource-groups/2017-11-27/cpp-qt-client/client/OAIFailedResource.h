...
#ifndef OAIFailedResource_H
#define OAIFailedResource_H
...
class OAIFailedResource : public OAIObject {
public:
    OAIFailedResource();
    OAIFailedResource(QString json);
    ~OAIFailedResource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFailedResource)

#endif // OAIFailedResource_H
