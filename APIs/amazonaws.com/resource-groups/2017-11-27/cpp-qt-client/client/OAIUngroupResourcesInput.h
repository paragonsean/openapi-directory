...
/*
 * OAIUngroupResourcesInput.h
 *
 * 
 */

#ifndef OAIUngroupResourcesInput_H
#define OAIUngroupResourcesInput_H
...
class OAIUngroupResourcesInput : public OAIObject {
public:
    OAIUngroupResourcesInput();
    OAIUngroupResourcesInput(QString json);
    ~OAIUngroupResourcesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUngroupResourcesInput)

#endif // OAIUngroupResourcesInput_H
