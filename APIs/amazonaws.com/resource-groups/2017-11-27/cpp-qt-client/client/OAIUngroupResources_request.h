...
/*
 * OAIUngroupResources_request.h
 *
 * 
 */

#ifndef OAIUngroupResources_request_H
#define OAIUngroupResources_request_H
...
class OAIUngroupResources_request : public OAIObject {
public:
    OAIUngroupResources_request();
    OAIUngroupResources_request(QString json);
    ~OAIUngroupResources_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUngroupResources_request)

#endif // OAIUngroupResources_request_H
