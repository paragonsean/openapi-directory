...
OAIPutGroupConfiguration_request::OAIPutGroupConfiguration_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutGroupConfiguration_request::OAIPutGroupConfiguration_request() {
    this->initializeModel();
}

OAIPutGroupConfiguration_request::~OAIPutGroupConfiguration_request() {}

void OAIPutGroupConfiguration_request::initializeModel() {
...
void OAIPutGroupConfiguration_request::fromJson(QString jsonString) {
...
void OAIPutGroupConfiguration_request::fromJsonObject(QJsonObject json) {
...
QString OAIPutGroupConfiguration_request::asJson() const {
...
QJsonObject OAIPutGroupConfiguration_request::asJsonObject() const {
    QJsonObject obj;
    if (m_group_isSet) {
...
QString OAIPutGroupConfiguration_request::getGroup() const {
    return m_group;
}
void OAIPutGroupConfiguration_request::setGroup(const QString &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAIPutGroupConfiguration_request::is_group_Set() const{
    return m_group_isSet;
}

bool OAIPutGroupConfiguration_request::is_group_Valid() const{
    return m_group_isValid;
}

QList<OAIGroupConfigurationItem> OAIPutGroupConfiguration_request::getConfiguration() const {
    return m_configuration;
}
void OAIPutGroupConfiguration_request::setConfiguration(const QList<OAIGroupConfigurationItem> &configuration) {
    m_configuration = configuration;
    m_configuration_isSet = true;
}

bool OAIPutGroupConfiguration_request::is_configuration_Set() const{
    return m_configuration_isSet;
}

bool OAIPutGroupConfiguration_request::is_configuration_Valid() const{
    return m_configuration_isValid;
}

bool OAIPutGroupConfiguration_request::isSet() const {
...
bool OAIPutGroupConfiguration_request::isValid() const {
