...
/*
 * OAIGroupQuery_ResourceQuery.h
 *
 * 
 */

#ifndef OAIGroupQuery_ResourceQuery_H
#define OAIGroupQuery_ResourceQuery_H
...
class OAIGroupQuery_ResourceQuery : public OAIObject {
public:
    OAIGroupQuery_ResourceQuery();
    OAIGroupQuery_ResourceQuery(QString json);
    ~OAIGroupQuery_ResourceQuery() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupQuery_ResourceQuery)

#endif // OAIGroupQuery_ResourceQuery_H
