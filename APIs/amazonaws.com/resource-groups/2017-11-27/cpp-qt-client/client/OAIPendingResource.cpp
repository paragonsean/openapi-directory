...
OAIPendingResource::OAIPendingResource(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPendingResource::OAIPendingResource() {
    this->initializeModel();
}

OAIPendingResource::~OAIPendingResource() {}

void OAIPendingResource::initializeModel() {

    m_resource_arn_isSet = false;
    m_resource_arn_isValid = false;
}

void OAIPendingResource::fromJson(QString jsonString) {
...
void OAIPendingResource::fromJsonObject(QJsonObject json) {

    m_resource_arn_isValid = ::OpenAPI::fromJsonValue(m_resource_arn, json[QString("ResourceArn")]);
    m_resource_arn_isSet = !json[QString("ResourceArn")].isNull() && m_resource_arn_isValid;
}

QString OAIPendingResource::asJson() const {
...
QJsonObject OAIPendingResource::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPendingResource::getResourceArn() const {
    return m_resource_arn;
}
void OAIPendingResource::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAIPendingResource::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAIPendingResource::is_resource_arn_Valid() const{
    return m_resource_arn_isValid;
}

bool OAIPendingResource::isSet() const {
...
bool OAIPendingResource::isValid() const {
