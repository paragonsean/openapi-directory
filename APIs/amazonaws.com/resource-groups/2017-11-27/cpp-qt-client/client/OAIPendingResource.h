...
#ifndef OAIPendingResource_H
#define OAIPendingResource_H
...
class OAIPendingResource : public OAIObject {
public:
    OAIPendingResource();
    OAIPendingResource(QString json);
    ~OAIPendingResource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPendingResource)

#endif // OAIPendingResource_H
