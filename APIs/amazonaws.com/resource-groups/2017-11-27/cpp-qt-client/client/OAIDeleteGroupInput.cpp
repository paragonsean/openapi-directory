...
OAIDeleteGroupInput::OAIDeleteGroupInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteGroupInput::OAIDeleteGroupInput() {
    this->initializeModel();
}

OAIDeleteGroupInput::~OAIDeleteGroupInput() {}

void OAIDeleteGroupInput::initializeModel() {
...
void OAIDeleteGroupInput::fromJson(QString jsonString) {
...
void OAIDeleteGroupInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteGroupInput::asJson() const {
...
QJsonObject OAIDeleteGroupInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteGroupInput::getGroupName() const {
    return m_group_name;
}
void OAIDeleteGroupInput::setGroupName(const QString &group_name) {
    m_group_name = group_name;
    m_group_name_isSet = true;
}

bool OAIDeleteGroupInput::is_group_name_Set() const{
    return m_group_name_isSet;
}

bool OAIDeleteGroupInput::is_group_name_Valid() const{
    return m_group_name_isValid;
}

QString OAIDeleteGroupInput::getGroup() const {
    return m_group;
}
void OAIDeleteGroupInput::setGroup(const QString &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAIDeleteGroupInput::is_group_Set() const{
    return m_group_isSet;
}

bool OAIDeleteGroupInput::is_group_Valid() const{
    return m_group_isValid;
}

bool OAIDeleteGroupInput::isSet() const {
...
bool OAIDeleteGroupInput::isValid() const {
