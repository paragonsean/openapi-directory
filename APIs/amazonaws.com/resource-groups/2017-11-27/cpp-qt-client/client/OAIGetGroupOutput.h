...
#ifndef OAIGetGroupOutput_H
#define OAIGetGroupOutput_H
...
namespace OpenAPI {
class OAIGetGroupOutput_Group;

class OAIGetGroupOutput : public OAIObject {
public:
    OAIGetGroupOutput();
    OAIGetGroupOutput(QString json);
    ~OAIGetGroupOutput() override;
    ...
    OAIGetGroupOutput_Group getGroup() const;
    void setGroup(const OAIGetGroupOutput_Group &group);
...
private:
    ...
    OAIGetGroupOutput_Group m_group;
    bool m_group_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetGroupOutput)

#endif // OAIGetGroupOutput_H
