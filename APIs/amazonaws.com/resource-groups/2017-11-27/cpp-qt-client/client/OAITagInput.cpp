...
OAITagInput::OAITagInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITagInput::OAITagInput() {
    this->initializeModel();
}

OAITagInput::~OAITagInput() {}

void OAITagInput::initializeModel() {

    m_tags_isSet = false;
    m_tags_isValid = false;
}

void OAITagInput::fromJson(QString jsonString) {
...
void OAITagInput::fromJsonObject(QJsonObject json) {

    m_tags_isValid = ::OpenAPI::fromJsonValue(m_tags, json[QString("Tags")]);
    m_tags_isSet = !json[QString("Tags")].isNull() && m_tags_isValid;
}

QString OAITagInput::asJson() const {
...
QJsonObject OAITagInput::asJsonObject() const {
    QJsonObject obj;
    if (m_tags.isSet()) {
...
QMap OAITagInput::getTags() const {
    return m_tags;
}
void OAITagInput::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAITagInput::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAITagInput::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAITagInput::isSet() const {
...
bool OAITagInput::isValid() const {
