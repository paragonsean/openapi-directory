...
/*
 * OAIGroupLifecycleEventsStatus.h
 *
 * 
 */

#ifndef OAIGroupLifecycleEventsStatus_H
#define OAIGroupLifecycleEventsStatus_H
...
class OAIGroupLifecycleEventsStatus : public OAIEnum {
public:
    OAIGroupLifecycleEventsStatus();
    OAIGroupLifecycleEventsStatus(QString json);
    ~OAIGroupLifecycleEventsStatus() override;
    ...
    enum class eOAIGroupLifecycleEventsStatus {
    ...
    OAIGroupLifecycleEventsStatus::eOAIGroupLifecycleEventsStatus getValue() const;
    void setValue(const OAIGroupLifecycleEventsStatus::eOAIGroupLifecycleEventsStatus& value);
...
private:
    ...
    eOAIGroupLifecycleEventsStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupLifecycleEventsStatus)

#endif // OAIGroupLifecycleEventsStatus_H
