...
/*
 * OAIGetGroup_request.h
 *
 * 
 */

#ifndef OAIGetGroup_request_H
#define OAIGetGroup_request_H
...
class OAIGetGroup_request : public OAIObject {
public:
    OAIGetGroup_request();
    OAIGetGroup_request(QString json);
    ~OAIGetGroup_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetGroup_request)

#endif // OAIGetGroup_request_H
