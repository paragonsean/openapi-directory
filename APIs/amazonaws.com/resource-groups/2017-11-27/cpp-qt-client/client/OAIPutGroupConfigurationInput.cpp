...
#include "OAIPutGroupConfigurationInput.h"
...
OAIPutGroupConfigurationInput::OAIPutGroupConfigurationInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutGroupConfigurationInput::OAIPutGroupConfigurationInput() {
    this->initializeModel();
}

OAIPutGroupConfigurationInput::~OAIPutGroupConfigurationInput() {}

void OAIPutGroupConfigurationInput::initializeModel() {
...
void OAIPutGroupConfigurationInput::fromJson(QString jsonString) {
...
void OAIPutGroupConfigurationInput::fromJsonObject(QJsonObject json) {
...
QString OAIPutGroupConfigurationInput::asJson() const {
...
QJsonObject OAIPutGroupConfigurationInput::asJsonObject() const {
    QJsonObject obj;
    if (m_group_isSet) {
...
QString OAIPutGroupConfigurationInput::getGroup() const {
    return m_group;
}
void OAIPutGroupConfigurationInput::setGroup(const QString &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAIPutGroupConfigurationInput::is_group_Set() const{
    return m_group_isSet;
}

bool OAIPutGroupConfigurationInput::is_group_Valid() const{
    return m_group_isValid;
}

QList OAIPutGroupConfigurationInput::getConfiguration() const {
    return m_configuration;
}
void OAIPutGroupConfigurationInput::setConfiguration(const QList &configuration) {
    m_configuration = configuration;
    m_configuration_isSet = true;
}

bool OAIPutGroupConfigurationInput::is_configuration_Set() const{
    return m_configuration_isSet;
}

bool OAIPutGroupConfigurationInput::is_configuration_Valid() const{
    return m_configuration_isValid;
}

bool OAIPutGroupConfigurationInput::isSet() const {
...
bool OAIPutGroupConfigurationInput::isValid() const {
