...
/*
 * OAIUpdateGroupQueryOutput.h
 *
 * 
 */

#ifndef OAIUpdateGroupQueryOutput_H
#define OAIUpdateGroupQueryOutput_H
...
namespace OpenAPI {
class OAIUpdateGroupQueryOutput_GroupQuery;

class OAIUpdateGroupQueryOutput : public OAIObject {
public:
    OAIUpdateGroupQueryOutput();
    OAIUpdateGroupQueryOutput(QString json);
    ~OAIUpdateGroupQueryOutput() override;
    ...
    OAIUpdateGroupQueryOutput_GroupQuery getGroupQuery() const;
    void setGroupQuery(const OAIUpdateGroupQueryOutput_GroupQuery &group_query);
    bool is_group_query_Set() const;
    bool is_group_query_Valid() const;
...
private:
    ...
    OAIUpdateGroupQueryOutput_GroupQuery m_group_query;
    bool m_group_query_isSet;
    bool m_group_query_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUpdateGroupQueryOutput)

#endif // OAIUpdateGroupQueryOutput_H
