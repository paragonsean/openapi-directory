...
OAIGroupQuery::OAIGroupQuery(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGroupQuery::OAIGroupQuery() {
    this->initializeModel();
}

OAIGroupQuery::~OAIGroupQuery() {}

void OAIGroupQuery::initializeModel() {
...
void OAIGroupQuery::fromJson(QString jsonString) {
...
void OAIGroupQuery::fromJsonObject(QJsonObject json) {
...
QString OAIGroupQuery::asJson() const {
...
QJsonObject OAIGroupQuery::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGroupQuery::getGroupName() const {
    return m_group_name;
}
void OAIGroupQuery::setGroupName(const QString &group_name) {
    m_group_name = group_name;
    m_group_name_isSet = true;
}

bool OAIGroupQuery::is_group_name_Set() const{
    return m_group_name_isSet;
}

bool OAIGroupQuery::is_group_name_Valid() const{
    return m_group_name_isValid;
}

OAIGroupQuery_ResourceQuery OAIGroupQuery::getResourceQuery() const {
    return m_resource_query;
}
void OAIGroupQuery::setResourceQuery(const OAIGroupQuery_ResourceQuery &resource_query) {
    m_resource_query = resource_query;
    m_resource_query_isSet = true;
}

bool OAIGroupQuery::is_resource_query_Set() const{
    return m_resource_query_isSet;
}

bool OAIGroupQuery::is_resource_query_Valid() const{
    return m_resource_query_isValid;
}

bool OAIGroupQuery::isSet() const {
...
bool OAIGroupQuery::isValid() const {
