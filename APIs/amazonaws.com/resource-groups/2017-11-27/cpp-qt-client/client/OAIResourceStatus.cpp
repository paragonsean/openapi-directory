...
OAIResourceStatusValue OAIResourceStatus::getName() const {
    return m_name;
}
void OAIResourceStatus::setName(const OAIResourceStatusValue &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIResourceStatus::is_name_Set() const{
    return m_name_isSet;
}

bool OAIResourceStatus::is_name_Valid() const{
