...
/*
 * OAIGetGroupConfigurationInput.h
 *
 * 
 */

#ifndef OAIGetGroupConfigurationInput_H
#define OAIGetGroupConfigurationInput_H
...
class OAIGetGroupConfigurationInput : public OAIObject {
public:
    OAIGetGroupConfigurationInput();
    OAIGetGroupConfigurationInput(QString json);
    ~OAIGetGroupConfigurationInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetGroupConfigurationInput)

#endif // OAIGetGroupConfigurationInput_H
