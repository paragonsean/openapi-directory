...
/*
 * OAIUpdateGroupQueryInput.h
 *
 * 
 */

#ifndef OAIUpdateGroupQueryInput_H
#define OAIUpdateGroupQueryInput_H
...
namespace OpenAPI {
class OAIUpdateGroupQueryInput_ResourceQuery;

class OAIUpdateGroupQueryInput : public OAIObject {
public:
    OAIUpdateGroupQueryInput();
    OAIUpdateGroupQueryInput(QString json);
    ~OAIUpdateGroupQueryInput() override;
    ...
    OAIUpdateGroupQueryInput_ResourceQuery getResourceQuery() const;
    void setResourceQuery(const OAIUpdateGroupQueryInput_ResourceQuery &resource_query);
...
private:
    ...
    OAIUpdateGroupQueryInput_ResourceQuery m_resource_query;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateGroupQueryInput)

#endif // OAIUpdateGroupQueryInput_H
