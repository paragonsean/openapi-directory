...
OAICreateGroupOutput_ResourceQuery::OAICreateGroupOutput_ResourceQuery(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateGroupOutput_ResourceQuery::OAICreateGroupOutput_ResourceQuery() {
    this->initializeModel();
}

OAICreateGroupOutput_ResourceQuery::~OAICreateGroupOutput_ResourceQuery() {}

void OAICreateGroupOutput_ResourceQuery::initializeModel() {
...
void OAICreateGroupOutput_ResourceQuery::fromJson(QString jsonString) {
...
void OAICreateGroupOutput_ResourceQuery::fromJsonObject(QJsonObject json) {
...
QString OAICreateGroupOutput_ResourceQuery::asJson() const {
...
QJsonObject OAICreateGroupOutput_ResourceQuery::asJsonObject() const {
    QJsonObject obj;
    if (m_type.isSet()) {
...
OAIQueryType OAICreateGroupOutput_ResourceQuery::getType() const {
    return m_type;
}
void OAICreateGroupOutput_ResourceQuery::setType(const OAIQueryType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICreateGroupOutput_ResourceQuery::is_type_Set() const{
    return m_type_isSet;
}

bool OAICreateGroupOutput_ResourceQuery::is_type_Valid() const{
    return m_type_isValid;
}

QString OAICreateGroupOutput_ResourceQuery::getQuery() const {
    return m_query;
}
void OAICreateGroupOutput_ResourceQuery::setQuery(const QString &query) {
    m_query = query;
    m_query_isSet = true;
}

bool OAICreateGroupOutput_ResourceQuery::is_query_Set() const{
    return m_query_isSet;
}

bool OAICreateGroupOutput_ResourceQuery::is_query_Valid() const{
    return m_query_isValid;
}

bool OAICreateGroupOutput_ResourceQuery::isSet() const {
...
bool OAICreateGroupOutput_ResourceQuery::isValid() const {
