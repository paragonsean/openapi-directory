...
/*
 * OAIGetGroupConfigurationOutput.h
 *
 * 
 */

#ifndef OAIGetGroupConfigurationOutput_H
#define OAIGetGroupConfigurationOutput_H
...
namespace OpenAPI {
class OAIGetGroupConfigurationOutput_GroupConfiguration;

class OAIGetGroupConfigurationOutput : public OAIObject {
public:
    OAIGetGroupConfigurationOutput();
    OAIGetGroupConfigurationOutput(QString json);
    ~OAIGetGroupConfigurationOutput() override;
    ...
    OAIGetGroupConfigurationOutput_GroupConfiguration getGroupConfiguration() const;
    void setGroupConfiguration(const OAIGetGroupConfigurationOutput_GroupConfiguration &group_configuration);
...
private:
    ...
    OAIGetGroupConfigurationOutput_GroupConfiguration m_group_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetGroupConfigurationOutput)

#endif // OAIGetGroupConfigurationOutput_H
