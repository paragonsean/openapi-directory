...
/*
 * OAIGetAccountSettingsOutput.h
 *
 * 
 */

#ifndef OAIGetAccountSettingsOutput_H
#define OAIGetAccountSettingsOutput_H
...
namespace OpenAPI {
class OAIGetAccountSettingsOutput_AccountSettings;

class OAIGetAccountSettingsOutput : public OAIObject {
public:
    OAIGetAccountSettingsOutput();
    OAIGetAccountSettingsOutput(QString json);
    ~OAIGetAccountSettingsOutput() override;
    ...
    OAIGetAccountSettingsOutput_AccountSettings getAccountSettings() const;
    void setAccountSettings(const OAIGetAccountSettingsOutput_AccountSettings &account_settings);
...
private:
    ...
    OAIGetAccountSettingsOutput_AccountSettings m_account_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAccountSettingsOutput)

#endif // OAIGetAccountSettingsOutput_H
