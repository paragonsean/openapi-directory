...
/*
 * OAIListGroupResourcesItem_Status.h
 *
 * 
 */

#ifndef OAIListGroupResourcesItem_Status_H
#define OAIListGroupResourcesItem_Status_H
...
class OAIListGroupResourcesItem_Status : public OAIObject {
public:
    OAIListGroupResourcesItem_Status();
    OAIListGroupResourcesItem_Status(QString json);
    ~OAIListGroupResourcesItem_Status() override;
    ...
    OAIResourceStatusValue getName() const;
    void setName(const OAIResourceStatusValue &name);
...
Q_DECLARE_METATYPE(OpenAPI::OAIListGroupResourcesItem_Status)

#endif // OAIListGroupResourcesItem_Status_H
