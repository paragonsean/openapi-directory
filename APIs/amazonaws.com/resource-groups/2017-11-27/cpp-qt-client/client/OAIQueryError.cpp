...
OAIQueryError::OAIQueryError(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIQueryError::OAIQueryError() {
    this->initializeModel();
}

OAIQueryError::~OAIQueryError() {}

void OAIQueryError::initializeModel() {
...
void OAIQueryError::fromJson(QString jsonString) {
...
void OAIQueryError::fromJsonObject(QJsonObject json) {
...
QString OAIQueryError::asJson() const {
...
QJsonObject OAIQueryError::asJsonObject() const {
    QJsonObject obj;
...
OAIQueryErrorCode OAIQueryError::getErrorCode() const {
    return m_error_code;
}
void OAIQueryError::setErrorCode(const OAIQueryErrorCode &error_code) {
    m_error_code = error_code;
    m_error_code_isSet = true;
}

bool OAIQueryError::is_error_code_Set() const{
    return m_error_code_isSet;
}

bool OAIQueryError::is_error_code_Valid() const{
    return m_error_code_isValid;
}

QString OAIQueryError::getMessage() const {
    return m_message;
}
void OAIQueryError::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIQueryError::is_message_Set() const{
    return m_message_isSet;
}

bool OAIQueryError::is_message_Valid() const{
    return m_message_isValid;
}

bool OAIQueryError::isSet() const {
...
bool OAIQueryError::isValid() const {
