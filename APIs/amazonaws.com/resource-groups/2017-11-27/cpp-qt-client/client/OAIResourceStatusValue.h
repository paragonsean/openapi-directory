...
/*
 * OAIResourceStatusValue.h
 *
 * 
 */

#ifndef OAIResourceStatusValue_H
#define OAIResourceStatusValue_H
...
class OAIResourceStatusValue : public OAIEnum {
public:
    OAIResourceStatusValue();
    OAIResourceStatusValue(QString json);
    ~OAIResourceStatusValue() override;
    ...
    enum class eOAIResourceStatusValue {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        PENDING
    };
    OAIResourceStatusValue::eOAIResourceStatusValue getValue() const;
    void setValue(const OAIResourceStatusValue::eOAIResourceStatusValue& value);
...
private:
    ...
    eOAIResourceStatusValue m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceStatusValue)

#endif // OAIResourceStatusValue_H
