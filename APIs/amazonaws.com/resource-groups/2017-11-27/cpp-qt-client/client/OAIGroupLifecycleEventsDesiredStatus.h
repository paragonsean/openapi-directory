...
/*
 * OAIGroupLifecycleEventsDesiredStatus.h
 *
 * 
 */

#ifndef OAIGroupLifecycleEventsDesiredStatus_H
#define OAIGroupLifecycleEventsDesiredStatus_H
...
class OAIGroupLifecycleEventsDesiredStatus : public OAIEnum {
public:
    OAIGroupLifecycleEventsDesiredStatus();
    OAIGroupLifecycleEventsDesiredStatus(QString json);
    ~OAIGroupLifecycleEventsDesiredStatus() override;
    ...
    enum class eOAIGroupLifecycleEventsDesiredStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ACTIVE, 
        INACTIVE
    };
    OAIGroupLifecycleEventsDesiredStatus::eOAIGroupLifecycleEventsDesiredStatus getValue() const;
    void setValue(const OAIGroupLifecycleEventsDesiredStatus::eOAIGroupLifecycleEventsDesiredStatus& value);
...
private:
    ...
    eOAIGroupLifecycleEventsDesiredStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupLifecycleEventsDesiredStatus)

#endif // OAIGroupLifecycleEventsDesiredStatus_H
