...
/*
 * OAICreateGroupOutput_Group.h
 *
 * 
 */

#ifndef OAICreateGroupOutput_Group_H
#define OAICreateGroupOutput_Group_H
...
class OAICreateGroupOutput_Group : public OAIObject {
public:
    OAICreateGroupOutput_Group();
    OAICreateGroupOutput_Group(QString json);
    ~OAICreateGroupOutput_Group() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateGroupOutput_Group)

#endif // OAICreateGroupOutput_Group_H
