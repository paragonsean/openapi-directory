...
OAIGetGroupOutput::OAIGetGroupOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetGroupOutput::OAIGetGroupOutput() {
    this->initializeModel();
}

OAIGetGroupOutput::~OAIGetGroupOutput() {}

void OAIGetGroupOutput::initializeModel() {

    m_group_isSet = false;
    m_group_isValid = false;
}

void OAIGetGroupOutput::fromJson(QString jsonString) {
...
void OAIGetGroupOutput::fromJsonObject(QJsonObject json) {

    m_group_isValid = ::OpenAPI::fromJsonValue(m_group, json[QString("Group")]);
    m_group_isSet = !json[QString("Group")].isNull() && m_group_isValid;
}

QString OAIGetGroupOutput::asJson() const {
...
QJsonObject OAIGetGroupOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_group.isSet()) {
...
OAIGetGroupOutput_Group OAIGetGroupOutput::getGroup() const {
    return m_group;
}
void OAIGetGroupOutput::setGroup(const OAIGetGroupOutput_Group &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAIGetGroupOutput::is_group_Set() const{
    return m_group_isSet;
}

bool OAIGetGroupOutput::is_group_Valid() const{
    return m_group_isValid;
}

bool OAIGetGroupOutput::isSet() const {
...
bool OAIGetGroupOutput::isValid() const {
