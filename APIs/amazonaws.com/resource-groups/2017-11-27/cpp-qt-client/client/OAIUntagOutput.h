...
#ifndef OAIUntagOutput_H
#define OAIUntagOutput_H
...
class OAIUntagOutput : public OAIObject {
public:
    OAIUntagOutput();
    OAIUntagOutput(QString json);
    ~OAIUntagOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUntagOutput)

#endif // OAIUntagOutput_H
