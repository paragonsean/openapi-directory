...
/*
 * OAIGetGroupQuery_request.h
 *
 * 
 */

#ifndef OAIGetGroupQuery_request_H
#define OAIGetGroupQuery_request_H
...
class OAIGetGroupQuery_request : public OAIObject {
public:
    OAIGetGroupQuery_request();
    OAIGetGroupQuery_request(QString json);
    ~OAIGetGroupQuery_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetGroupQuery_request)

#endif // OAIGetGroupQuery_request_H
