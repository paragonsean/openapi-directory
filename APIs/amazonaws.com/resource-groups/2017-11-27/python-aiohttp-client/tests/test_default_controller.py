...
async def test_delete_group(client):
    ...
    """
    body = openapi_server.DeleteGroupRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_get_group(client):
    ...
    """
    body = openapi_server.GetGroupRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_get_group_configuration(client):
    """Test case for get_group_configuration

    
    """
    body = openapi_server.GetGroupConfigurationRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_get_group_query(client):
    """Test case for get_group_query

    
    """
    body = openapi_server.GetGroupQueryRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_get_tags(client):
    ...
    response = await client.request(
        method='GET',
        path='/resources/{arn}/tags'.format(arn='arn_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_group_resources(client):
    """Test case for group_resources

    
    """
    body = openapi_server.GroupResourcesRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_list_group_resources(client):
    """Test case for list_group_resources

    
    """
    body = openapi_server.ListGroupResourcesRequest()
...
async def test_list_groups(client):
    ...
    """
    body = openapi_server.ListGroupsRequest()
...
async def test_put_group_configuration(client):
    """Test case for put_group_configuration

    
    """
    body = openapi_server.PutGroupConfigurationRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_search_resources(client):
    ...
    """
    body = openapi_server.SearchResourcesRequest()
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_tag(client):
    """Test case for tag

    
    """
    body = openapi_server.TagRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_ungroup_resources(client):
    """Test case for ungroup_resources

    
    """
    body = openapi_server.UngroupResourcesRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_untag(client):
    """Test case for untag

    
    """
    body = openapi_server.UntagRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_account_settings(client):
    ...
    """
    body = openapi_server.UpdateAccountSettingsRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_group(client):
    ...
    """
    body = openapi_server.UpdateGroupRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_group_query(client):
    """Test case for update_group_query

    
    """
    body = openapi_server.UpdateGroupQueryRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
