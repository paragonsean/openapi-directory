...
class UngroupResourcesRequest(Model):
    ...
    def __init__(self, group: str=None, resource_arns: List[str]=None):
        """UngroupResourcesRequest - a model defined in OpenAPI

        :param group: The group of this UngroupResourcesRequest.
        :param resource_arns: The resource_arns of this UngroupResourcesRequest.
        """
        self.openapi_types = {
            'group': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UngroupResourcesRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UngroupResources_request of this UngroupResourcesRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def group(self):
        """Gets the group of this UngroupResourcesRequest.

        The name or the ARN of the resource group from which to remove the resources.

        :return: The group of this UngroupResourcesRequest.
        :rtype: str
        """
        return self._group
    ...
    def group(self, group):
        """Sets the group of this UngroupResourcesRequest.
    ...
    def resource_arns(self):
        """Gets the resource_arns of this UngroupResourcesRequest.

        The ARNs of the resources to be removed from the group.

        :return: The resource_arns of this UngroupResourcesRequest.
        :rtype: List[str]
        """
    ...
    def resource_arns(self, resource_arns):
        """Sets the resource_arns of this UngroupResourcesRequest.
