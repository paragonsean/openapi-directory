...
class GetGroupQueryRequest(Model):
    ...
    def __init__(self, group_name: str=None, group: str=None):
        """GetGroupQueryRequest - a model defined in OpenAPI

        :param group_name: The group_name of this GetGroupQueryRequest.
        :param group: The group of this GetGroupQueryRequest.
        """
        self.openapi_types = {
            'group_name': str,
            'group': str
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetGroupQueryRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GetGroupQuery_request of this GetGroupQueryRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def group_name(self):
        """Gets the group_name of this GetGroupQueryRequest.

        Don't use this parameter. Use <code>Group</code> instead.

        :return: The group_name of this GetGroupQueryRequest.
        :rtype: str
        """
    ...
    def group_name(self, group_name):
        """Sets the group_name of this GetGroupQueryRequest.
    ...
    @property
    def group(self):
        """Gets the group of this GetGroupQueryRequest.

        The name or the ARN of the resource group to query.

        :return: The group of this GetGroupQueryRequest.
        :rtype: str
        """
        return self._group
    ...
    def group(self, group):
        """Sets the group of this GetGroupQueryRequest.
