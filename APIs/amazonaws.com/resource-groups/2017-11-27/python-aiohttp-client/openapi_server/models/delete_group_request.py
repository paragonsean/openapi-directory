...
class DeleteGroupRequest(Model):
    ...
    def __init__(self, group_name: str=None, group: str=None):
        ...
        :param group: The group of this DeleteGroupRequest.
        """
        self.openapi_types = {
            'group_name': str,
            'group': str
    ...
    @property
    def group(self):
        """Gets the group of this DeleteGroupRequest.

        The name or the ARN of the resource group to delete.

        :return: The group of this DeleteGroupRequest.
        :rtype: str
        """
        return self._group
    ...
    def group(self, group):
        """Sets the group of this DeleteGroupRequest.
