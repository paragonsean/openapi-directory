...
public class FailedResource {
  ...
  public FailedResource resourceArn(String resourceArn) {
  ...
  public FailedResource errorMessage(String errorMessage) {
  ...
  public FailedResource errorCode(String errorCode) {
  ...
  public boolean equals(Object o) {
    ...
    FailedResource failedResource = (FailedResource) o;
    return Objects.equals(this.resourceArn, failedResource.resourceArn) &&
        Objects.equals(this.errorMessage, failedResource.errorMessage) &&
        Objects.equals(this.errorCode, failedResource.errorCode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(resourceArn, errorMessage, errorCode);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FailedResource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FailedResource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FailedResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FailedResource is not found in the empty JSON string", FailedResource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FailedResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FailedResource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FailedResource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FailedResource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FailedResource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FailedResource.class));

       return (TypeAdapter<T>) new TypeAdapter<FailedResource>() {
           @Override
           public void write(JsonWriter out, FailedResource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FailedResource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FailedResource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FailedResource
   * @throws IOException if the JSON string is invalid with respect to FailedResource
   */
  public static FailedResource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FailedResource.class);
  }

  /**
   * Convert an instance of FailedResource to an JSON string
   *
   * @return JSON string
   */
