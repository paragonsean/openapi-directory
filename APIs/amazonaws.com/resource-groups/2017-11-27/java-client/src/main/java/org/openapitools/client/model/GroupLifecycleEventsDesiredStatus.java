...
/**
 * Gets or Sets GroupLifecycleEventsDesiredStatus
 */
@JsonAdapter(GroupLifecycleEventsDesiredStatus.Adapter.class)
public enum GroupLifecycleEventsDesiredStatus {
  ...
  GroupLifecycleEventsDesiredStatus(String value) {
    this.value = value;
  }
  ...
  public static GroupLifecycleEventsDesiredStatus fromValue(String value) {
    for (GroupLifecycleEventsDesiredStatus b : GroupLifecycleEventsDesiredStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<GroupLifecycleEventsDesiredStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final GroupLifecycleEventsDesiredStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public GroupLifecycleEventsDesiredStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return GroupLifecycleEventsDesiredStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    GroupLifecycleEventsDesiredStatus.fromValue(value);
  }
}
