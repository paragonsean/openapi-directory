...
/**
 * Gets or Sets GroupFilterName
 */
@JsonAdapter(GroupFilterName.Adapter.class)
public enum GroupFilterName {
  ...
  public static GroupFilterName fromValue(String value) {
    for (GroupFilterName b : GroupFilterName.values()) {
  ...
  public static class Adapter extends TypeAdapter<GroupFilterName> {
    @Override
    public void write(final JsonWriter jsonWriter, final GroupFilterName enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public GroupFilterName read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return GroupFilterName.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    GroupFilterName.fromValue(value);
  }
}
