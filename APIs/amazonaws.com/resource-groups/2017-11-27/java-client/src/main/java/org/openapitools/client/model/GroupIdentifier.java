...
public class GroupIdentifier {
  ...
  public GroupIdentifier groupName(String groupName) {
  ...
  public GroupIdentifier groupArn(String groupArn) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.groupName, groupIdentifier.groupName) &&
        Objects.equals(this.groupArn, groupIdentifier.groupArn);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GroupIdentifier
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GroupIdentifier.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GroupIdentifier is not found in the empty JSON string", GroupIdentifier.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GroupIdentifier.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GroupIdentifier` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GroupIdentifier.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GroupIdentifier' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GroupIdentifier> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GroupIdentifier.class));

       return (TypeAdapter<T>) new TypeAdapter<GroupIdentifier>() {
           @Override
           public void write(JsonWriter out, GroupIdentifier value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GroupIdentifier read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GroupIdentifier given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GroupIdentifier
   * @throws IOException if the JSON string is invalid with respect to GroupIdentifier
   */
  public static GroupIdentifier fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GroupIdentifier.class);
  }

  /**
   * Convert an instance of GroupIdentifier to an JSON string
   *
   * @return JSON string
   */
