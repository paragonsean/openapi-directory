...
public class UntagOutput {
  ...
  public UntagOutput arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public UntagOutput keys(List keys) {
    this.keys = keys;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UntagOutput untagOutput = (UntagOutput) o;
    return Objects.equals(this.arn, untagOutput.arn) &&
        Objects.equals(this.keys, untagOutput.keys);
  }

  @Override
  public int hashCode() {
    return Objects.hash(arn, keys);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UntagOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UntagOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UntagOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UntagOutput is not found in the empty JSON string", UntagOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UntagOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UntagOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UntagOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UntagOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UntagOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UntagOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UntagOutput>() {
           @Override
           public void write(JsonWriter out, UntagOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UntagOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UntagOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UntagOutput
   * @throws IOException if the JSON string is invalid with respect to UntagOutput
   */
  public static UntagOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UntagOutput.class);
  }

  /**
   * Convert an instance of UntagOutput to an JSON string
   *
   * @return JSON string
   */
