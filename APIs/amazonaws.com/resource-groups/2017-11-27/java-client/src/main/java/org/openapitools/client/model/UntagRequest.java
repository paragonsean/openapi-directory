...
public class UntagRequest {
  ...
  public UntagRequest keys(List<String> keys) {
    this.keys = keys;
    return this;
  }

  public UntagRequest addKeysItem(String keysItem) {
    if (this.keys == null) {
  ...
  public boolean equals(Object o) {
    ...
    UntagRequest untagRequest = (UntagRequest) o;
    return Objects.equals(this.keys, untagRequest.keys);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UntagRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UntagRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UntagRequest is not found in the empty JSON string", UntagRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UntagRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UntagRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UntagRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UntagRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UntagRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UntagRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UntagRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UntagRequest>() {
           @Override
           public void write(JsonWriter out, UntagRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UntagRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UntagRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UntagRequest
   * @throws IOException if the JSON string is invalid with respect to UntagRequest
   */
  public static UntagRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UntagRequest.class);
  }

  /**
   * Convert an instance of UntagRequest to an JSON string
   *
   * @return JSON string
   */
