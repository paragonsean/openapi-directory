...
/**
 * Gets or Sets GroupLifecycleEventsStatus
 */
@JsonAdapter(GroupLifecycleEventsStatus.Adapter.class)
public enum GroupLifecycleEventsStatus {
  ...
  GroupLifecycleEventsStatus(String value) {
    this.value = value;
  }
  ...
  public static GroupLifecycleEventsStatus fromValue(String value) {
    for (GroupLifecycleEventsStatus b : GroupLifecycleEventsStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<GroupLifecycleEventsStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final GroupLifecycleEventsStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public GroupLifecycleEventsStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return GroupLifecycleEventsStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    GroupLifecycleEventsStatus.fromValue(value);
  }
}
