...
public class ResourceQuery {
  ...
  public ResourceQuery type(QueryType type) {
    this.type = type;
    return this;
  }
  ...
  public ResourceQuery query(String query) {
    this.query = query;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ResourceQuery resourceQuery = (ResourceQuery) o;
    return Objects.equals(this.type, resourceQuery.type) &&
        Objects.equals(this.query, resourceQuery.query);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResourceQuery
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceQuery.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceQuery is not found in the empty JSON string", ResourceQuery.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResourceQuery.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceQuery` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceQuery.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceQuery.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceQuery' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceQuery> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceQuery.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceQuery>() {
           @Override
           public void write(JsonWriter out, ResourceQuery value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceQuery read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResourceQuery given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResourceQuery
   * @throws IOException if the JSON string is invalid with respect to ResourceQuery
   */
  public static ResourceQuery fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceQuery.class);
  }

  /**
   * Convert an instance of ResourceQuery to an JSON string
   *
   * @return JSON string
   */
