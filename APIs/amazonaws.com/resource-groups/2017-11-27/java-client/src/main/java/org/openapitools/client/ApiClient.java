...
public class ApiClient {
    ...
    private String basePath = "http://resource-groups.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://resource-groups.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "http://resource-groups.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://resource-groups.{region}.amazonaws.com.cn",
      "The Resource Groups endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://resource-groups.us-east-1.amazonaws.com
