...
/**
 * Gets or Sets QueryErrorCode
 */
@JsonAdapter(QueryErrorCode.Adapter.class)
public enum QueryErrorCode {
  ...
  public static QueryErrorCode fromValue(String value) {
    for (QueryErrorCode b : QueryErrorCode.values()) {
  ...
  public static class Adapter extends TypeAdapter<QueryErrorCode> {
    @Override
    public void write(final JsonWriter jsonWriter, final QueryErrorCode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public QueryErrorCode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return QueryErrorCode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    QueryErrorCode.fromValue(value);
  }
}
