...
public class PendingResource {
  ...
  public PendingResource resourceArn(String resourceArn) {
  ...
  public boolean equals(Object o) {
    ...
    PendingResource pendingResource = (PendingResource) o;
    return Objects.equals(this.resourceArn, pendingResource.resourceArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class PendingResource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PendingResource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PendingResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PendingResource is not found in the empty JSON string", PendingResource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PendingResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PendingResource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PendingResource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PendingResource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PendingResource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PendingResource.class));

       return (TypeAdapter<T>) new TypeAdapter<PendingResource>() {
           @Override
           public void write(JsonWriter out, PendingResource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PendingResource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PendingResource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PendingResource
   * @throws IOException if the JSON string is invalid with respect to PendingResource
   */
  public static PendingResource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PendingResource.class);
  }

  /**
   * Convert an instance of PendingResource to an JSON string
   *
   * @return JSON string
   */
