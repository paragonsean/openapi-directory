...
import org.openapitools.client.model.GroupFilter;
...
public class ListGroupsRequest {
  ...
  private List<GroupFilter> filters = new ArrayList<>();

  public ListGroupsRequest() {
  }

  public ListGroupsRequest filters(List<GroupFilter> filters) {
    this.filters = filters;
    return this;
  }

  public ListGroupsRequest addFiltersItem(GroupFilter filtersItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.filters, listGroupsRequest.filters);
  }
      ...
      if (jsonObj.get("Filters") != null && !jsonObj.get("Filters").isJsonNull()) {
        ...
        if (jsonArrayfilters != null) {
          ...
          for (int i = 0; i < jsonArrayfilters.size(); i++) {
            GroupFilter.validateJsonElement(jsonArrayfilters.get(i));
          };
        }
      }
  }
