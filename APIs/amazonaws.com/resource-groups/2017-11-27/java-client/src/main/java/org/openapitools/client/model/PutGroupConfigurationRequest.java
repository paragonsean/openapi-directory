...
public class PutGroupConfigurationRequest {
  ...
  public PutGroupConfigurationRequest() {
  }

  public PutGroupConfigurationRequest group(String group) {
    this.group = group;
    return this;
  }
  ...
  public PutGroupConfigurationRequest _configuration(List<GroupConfigurationItem> _configuration) {
    this._configuration = _configuration;
    return this;
  }

  public PutGroupConfigurationRequest addConfigurationItem(GroupConfigurationItem _configurationItem) {
  ...
  public boolean equals(Object o) {
    ...
    PutGroupConfigurationRequest putGroupConfigurationRequest = (PutGroupConfigurationRequest) o;
    return Objects.equals(this.group, putGroupConfigurationRequest.group) &&
        Objects.equals(this._configuration, putGroupConfigurationRequest._configuration);
  }

  @Override
  public int hashCode() {
    return Objects.hash(group, _configuration);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutGroupConfigurationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutGroupConfigurationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutGroupConfigurationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutGroupConfigurationRequest is not found in the empty JSON string", PutGroupConfigurationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutGroupConfigurationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutGroupConfigurationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutGroupConfigurationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutGroupConfigurationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutGroupConfigurationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutGroupConfigurationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PutGroupConfigurationRequest>() {
           @Override
           public void write(JsonWriter out, PutGroupConfigurationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutGroupConfigurationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutGroupConfigurationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutGroupConfigurationRequest
   * @throws IOException if the JSON string is invalid with respect to PutGroupConfigurationRequest
   */
  public static PutGroupConfigurationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutGroupConfigurationRequest.class);
  }

  /**
   * Convert an instance of PutGroupConfigurationRequest to an JSON string
   *
   * @return JSON string
   */
