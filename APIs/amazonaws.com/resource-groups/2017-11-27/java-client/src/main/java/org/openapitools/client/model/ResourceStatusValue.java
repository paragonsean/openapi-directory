...
/**
 * Gets or Sets ResourceStatusValue
 */
@JsonAdapter(ResourceStatusValue.Adapter.class)
public enum ResourceStatusValue {
  ...
  ResourceStatusValue(String value) {
    this.value = value;
  }
  ...
  public static ResourceStatusValue fromValue(String value) {
    for (ResourceStatusValue b : ResourceStatusValue.values()) {
  ...
  public static class Adapter extends TypeAdapter<ResourceStatusValue> {
    @Override
    public void write(final JsonWriter jsonWriter, final ResourceStatusValue enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ResourceStatusValue read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ResourceStatusValue.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ResourceStatusValue.fromValue(value);
  }
}
