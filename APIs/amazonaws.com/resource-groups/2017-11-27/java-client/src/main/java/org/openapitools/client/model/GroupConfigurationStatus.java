...
/**
 * Gets or Sets GroupConfigurationStatus
 */
@JsonAdapter(GroupConfigurationStatus.Adapter.class)
public enum GroupConfigurationStatus {
  ...
  GroupConfigurationStatus(String value) {
    this.value = value;
  }
  ...
  public static GroupConfigurationStatus fromValue(String value) {
    for (GroupConfigurationStatus b : GroupConfigurationStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<GroupConfigurationStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final GroupConfigurationStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public GroupConfigurationStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return GroupConfigurationStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    GroupConfigurationStatus.fromValue(value);
  }
}
