...
public class UngroupResourcesOutput {
  ...
  public UngroupResourcesOutput() {
  }

  public UngroupResourcesOutput succeeded(List succeeded) {
  ...
  public UngroupResourcesOutput failed(List failed) {
    this.failed = failed;
    return this;
  }
  ...
  public UngroupResourcesOutput pending(List pending) {
  ...
  public boolean equals(Object o) {
    ...
    UngroupResourcesOutput ungroupResourcesOutput = (UngroupResourcesOutput) o;
    return Objects.equals(this.succeeded, ungroupResourcesOutput.succeeded) &&
        Objects.equals(this.failed, ungroupResourcesOutput.failed) &&
        Objects.equals(this.pending, ungroupResourcesOutput.pending);
  }
  ...
  public String toString() {
    ...
    sb.append("class UngroupResourcesOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UngroupResourcesOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UngroupResourcesOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UngroupResourcesOutput is not found in the empty JSON string", UngroupResourcesOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UngroupResourcesOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UngroupResourcesOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UngroupResourcesOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UngroupResourcesOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UngroupResourcesOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UngroupResourcesOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UngroupResourcesOutput>() {
           @Override
           public void write(JsonWriter out, UngroupResourcesOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UngroupResourcesOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UngroupResourcesOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UngroupResourcesOutput
   * @throws IOException if the JSON string is invalid with respect to UngroupResourcesOutput
   */
  public static UngroupResourcesOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UngroupResourcesOutput.class);
  }

  /**
   * Convert an instance of UngroupResourcesOutput to an JSON string
   *
   * @return JSON string
   */
