...
/**
 * The CanaryRunConfigOutput model module.
 * @module model/CanaryRunConfigOutput
 * @version 2017-10-11
 */
class CanaryRunConfigOutput {
    /**
     * Constructs a new <code>CanaryRunConfigOutput</code>.
     * A structure that contains information about a canary run.
     * @alias module:model/CanaryRunConfigOutput
     */
    constructor() { 
        
        CanaryRunConfigOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CanaryRunConfigOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CanaryRunConfigOutput} obj Optional instance to populate.
     * @return {module:model/CanaryRunConfigOutput} The populated <code>CanaryRunConfigOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CanaryRunConfigOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>CanaryRunConfigOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CanaryRunConfigOutput</code>.
     */
 ...
 */
CanaryRunConfigOutput.prototype['TimeoutInSeconds'] = undefined;

/**
 * @member {Number} MemoryInMB
 */
CanaryRunConfigOutput.prototype['MemoryInMB'] = undefined;

/**
 * @member {Boolean} ActiveTracing
 */
CanaryRunConfigOutput.prototype['ActiveTracing'] = undefined;
...
export default CanaryRunConfigOutput;
