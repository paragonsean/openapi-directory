...
/**
 * The DescribeCanariesLastRunRequest model module.
 * @module model/DescribeCanariesLastRunRequest
 * @version 2017-10-11
 */
class DescribeCanariesLastRunRequest {
    /**
     * Constructs a new <code>DescribeCanariesLastRunRequest</code>.
     * @alias module:model/DescribeCanariesLastRunRequest
     */
    constructor() { 
        
        DescribeCanariesLastRunRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeCanariesLastRunRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeCanariesLastRunRequest} obj Optional instance to populate.
     * @return {module:model/DescribeCanariesLastRunRequest} The populated <code>DescribeCanariesLastRunRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeCanariesLastRunRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeCanariesLastRunRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeCanariesLastRunRequest</code>.
     */
 ...
 */
DescribeCanariesLastRunRequest.prototype['NextToken'] = undefined;
 ...
 */
DescribeCanariesLastRunRequest.prototype['MaxResults'] = undefined;
 ...
 */
DescribeCanariesLastRunRequest.prototype['Names'] = undefined;
...
export default DescribeCanariesLastRunRequest;
