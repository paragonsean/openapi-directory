...
/**
 * The UpdateCanaryRequestVisualReference model module.
 * @module model/UpdateCanaryRequestVisualReference
 * @version 2017-10-11
 */
class UpdateCanaryRequestVisualReference {
    /**
     * Constructs a new <code>UpdateCanaryRequestVisualReference</code>.
     * @alias module:model/UpdateCanaryRequestVisualReference
     * @implements module:model/VisualReferenceInput
     * @param baseCanaryRunId {String} 
     */
    constructor(baseCanaryRunId) { 
        VisualReferenceInput.initialize(this, baseCanaryRunId);
        UpdateCanaryRequestVisualReference.initialize(this, baseCanaryRunId);
    }
    ...
    /**
     * Constructs a <code>UpdateCanaryRequestVisualReference</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateCanaryRequestVisualReference} obj Optional instance to populate.
     * @return {module:model/UpdateCanaryRequestVisualReference} The populated <code>UpdateCanaryRequestVisualReference</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateCanaryRequestVisualReference();
            VisualReferenceInput.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateCanaryRequestVisualReference</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateCanaryRequestVisualReference</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateCanaryRequestVisualReference.RequiredProperties) {
...
UpdateCanaryRequestVisualReference.RequiredProperties = ["BaseCanaryRunId"];

/**
 * @member {Array} BaseScreenshots
 */
UpdateCanaryRequestVisualReference.prototype['BaseScreenshots'] = undefined;

/**
 * @member {String} BaseCanaryRunId
 */
UpdateCanaryRequestVisualReference.prototype['BaseCanaryRunId'] = undefined;


// Implement VisualReferenceInput interface:
/**
 * @member {Array} BaseScreenshots
 */
...
export default UpdateCanaryRequestVisualReference;
