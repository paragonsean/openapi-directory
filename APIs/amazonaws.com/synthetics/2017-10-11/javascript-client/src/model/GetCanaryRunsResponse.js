...
/**
 * The GetCanaryRunsResponse model module.
 * @module model/GetCanaryRunsResponse
 * @version 2017-10-11
 */
class GetCanaryRunsResponse {
    /**
     * Constructs a new <code>GetCanaryRunsResponse</code>.
     * @alias module:model/GetCanaryRunsResponse
     */
    constructor() { 
        
        GetCanaryRunsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetCanaryRunsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCanaryRunsResponse} obj Optional instance to populate.
     * @return {module:model/GetCanaryRunsResponse} The populated <code>GetCanaryRunsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCanaryRunsResponse();

            if (data.hasOwnProperty('CanaryRuns')) {
                obj['CanaryRuns'] = ApiClient.convertToType(data['CanaryRuns'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetCanaryRunsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCanaryRunsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `CanaryRuns`
        if (data['CanaryRuns']) { // data not null
          Array.validateJSON(data['CanaryRuns']);
        }
...
/**
 * @member {Array} CanaryRuns
 */
GetCanaryRunsResponse.prototype['CanaryRuns'] = undefined;

/**
 * @member {String} NextToken
 */
GetCanaryRunsResponse.prototype['NextToken'] = undefined;
...
export default GetCanaryRunsResponse;
