...
import GetCanaryResponseCanary from './GetCanaryResponseCanary';

/**
 * The GetCanaryResponse model module.
 * @module model/GetCanaryResponse
 * @version 2017-10-11
 */
class GetCanaryResponse {
    /**
     * Constructs a new <code>GetCanaryResponse</code>.
     * @alias module:model/GetCanaryResponse
     */
    constructor() { 
        
        GetCanaryResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetCanaryResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCanaryResponse} obj Optional instance to populate.
     * @return {module:model/GetCanaryResponse} The populated <code>GetCanaryResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCanaryResponse();

            if (data.hasOwnProperty('Canary')) {
                obj['Canary'] = GetCanaryResponseCanary.constructFromObject(data['Canary']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetCanaryResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCanaryResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Canary`
        if (data['Canary']) { // data not null
          GetCanaryResponseCanary.validateJSON(data['Canary']);
        }
...
/**
 * @member {module:model/GetCanaryResponseCanary} Canary
 */
GetCanaryResponse.prototype['Canary'] = undefined;
...
export default GetCanaryResponse;
