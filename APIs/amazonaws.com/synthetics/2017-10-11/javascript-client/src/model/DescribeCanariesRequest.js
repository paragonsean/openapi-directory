...
/**
 * The DescribeCanariesRequest model module.
 * @module model/DescribeCanariesRequest
 * @version 2017-10-11
 */
class DescribeCanariesRequest {
    /**
     * Constructs a new <code>DescribeCanariesRequest</code>.
     * @alias module:model/DescribeCanariesRequest
     */
    constructor() { 
        
        DescribeCanariesRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeCanariesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeCanariesRequest} obj Optional instance to populate.
     * @return {module:model/DescribeCanariesRequest} The populated <code>DescribeCanariesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeCanariesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeCanariesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeCanariesRequest</code>.
     */
 ...
 */
DescribeCanariesRequest.prototype['NextToken'] = undefined;
 ...
 */
DescribeCanariesRequest.prototype['MaxResults'] = undefined;
 ...
 */
DescribeCanariesRequest.prototype['Names'] = undefined;
...
export default DescribeCanariesRequest;
