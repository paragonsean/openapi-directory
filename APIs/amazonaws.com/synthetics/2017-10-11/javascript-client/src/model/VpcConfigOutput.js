...
/**
 * The VpcConfigOutput model module.
 * @module model/VpcConfigOutput
 * @version 2017-10-11
 */
class VpcConfigOutput {
    /**
     * Constructs a new <code>VpcConfigOutput</code>.
     ...
     * @alias module:model/VpcConfigOutput
     */
    constructor() { 
        
        VpcConfigOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VpcConfigOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VpcConfigOutput} obj Optional instance to populate.
     * @return {module:model/VpcConfigOutput} The populated <code>VpcConfigOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VpcConfigOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>VpcConfigOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VpcConfigOutput</code>.
     */
 ...
 * @member {String} VpcId
 */
VpcConfigOutput.prototype['VpcId'] = undefined;

/**
 * @member {Array} SubnetIds
 */
VpcConfigOutput.prototype['SubnetIds'] = undefined;

/**
 * @member {Array} SecurityGroupIds
 */
VpcConfigOutput.prototype['SecurityGroupIds'] = undefined;
...
export default VpcConfigOutput;
