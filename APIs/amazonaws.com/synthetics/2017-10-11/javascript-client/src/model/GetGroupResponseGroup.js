...
/**
 * The GetGroupResponseGroup model module.
 * @module model/GetGroupResponseGroup
 * @version 2017-10-11
 */
class GetGroupResponseGroup {
    /**
     * Constructs a new <code>GetGroupResponseGroup</code>.
     * @alias module:model/GetGroupResponseGroup
     * @implements module:model/Group
     */
    constructor() { 
        Group.initialize(this);
        GetGroupResponseGroup.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetGroupResponseGroup</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetGroupResponseGroup} obj Optional instance to populate.
     * @return {module:model/GetGroupResponseGroup} The populated <code>GetGroupResponseGroup</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetGroupResponseGroup();
    ...
    /**
     * Validates the JSON data with respect to <code>GetGroupResponseGroup</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetGroupResponseGroup</code>.
     */
 ...
 * @member {String} Id
 */
GetGroupResponseGroup.prototype['Id'] = undefined;

/**
 * @member {String} Name
 */
GetGroupResponseGroup.prototype['Name'] = undefined;

/**
 * @member {String} Arn
 */
GetGroupResponseGroup.prototype['Arn'] = undefined;

/**
 * @member {Object} Tags
 */
GetGroupResponseGroup.prototype['Tags'] = undefined;

/**
 * @member {Date} CreatedTime
 */
GetGroupResponseGroup.prototype['CreatedTime'] = undefined;

/**
 * @member {Date} LastModifiedTime
 */
GetGroupResponseGroup.prototype['LastModifiedTime'] = undefined;
...
export default GetGroupResponseGroup;
