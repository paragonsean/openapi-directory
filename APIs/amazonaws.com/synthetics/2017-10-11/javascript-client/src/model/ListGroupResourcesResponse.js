...
/**
 * The ListGroupResourcesResponse model module.
 * @module model/ListGroupResourcesResponse
 * @version 2017-10-11
 */
class ListGroupResourcesResponse {
    /**
     * Constructs a new <code>ListGroupResourcesResponse</code>.
     * @alias module:model/ListGroupResourcesResponse
     */
    constructor() { 
        
        ListGroupResourcesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListGroupResourcesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListGroupResourcesResponse} obj Optional instance to populate.
     * @return {module:model/ListGroupResourcesResponse} The populated <code>ListGroupResourcesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListGroupResourcesResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListGroupResourcesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListGroupResourcesResponse</code>.
     */
 ...
 */
ListGroupResourcesResponse.prototype['Resources'] = undefined;

/**
 * @member {String} NextToken
 */
ListGroupResourcesResponse.prototype['NextToken'] = undefined;
...
export default ListGroupResourcesResponse;
