...
/**
 * The ListAssociatedGroupsResponse model module.
 * @module model/ListAssociatedGroupsResponse
 * @version 2017-10-11
 */
class ListAssociatedGroupsResponse {
    /**
     * Constructs a new <code>ListAssociatedGroupsResponse</code>.
     * @alias module:model/ListAssociatedGroupsResponse
     */
    constructor() { 
        
        ListAssociatedGroupsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListAssociatedGroupsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAssociatedGroupsResponse} obj Optional instance to populate.
     * @return {module:model/ListAssociatedGroupsResponse} The populated <code>ListAssociatedGroupsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListAssociatedGroupsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListAssociatedGroupsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListAssociatedGroupsResponse</code>.
     */
 ...
 * @member {Array} Groups
 */
ListAssociatedGroupsResponse.prototype['Groups'] = undefined;

/**
 * @member {String} NextToken
 */
ListAssociatedGroupsResponse.prototype['NextToken'] = undefined;
...
export default ListAssociatedGroupsResponse;
