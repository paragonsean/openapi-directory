...
* @readonly
*/
export default class CanaryRunStateReasonCode {
    ...
    /**
    * Returns a <code>CanaryRunStateReasonCode</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CanaryRunStateReasonCode} The enum <code>CanaryRunStateReasonCode</code> value.
    */
