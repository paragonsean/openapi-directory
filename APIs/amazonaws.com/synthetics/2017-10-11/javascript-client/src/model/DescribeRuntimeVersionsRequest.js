...
/**
 * The DescribeRuntimeVersionsRequest model module.
 * @module model/DescribeRuntimeVersionsRequest
 * @version 2017-10-11
 */
class DescribeRuntimeVersionsRequest {
    /**
     * Constructs a new <code>DescribeRuntimeVersionsRequest</code>.
     * @alias module:model/DescribeRuntimeVersionsRequest
     */
    constructor() { 
        
        DescribeRuntimeVersionsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeRuntimeVersionsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeRuntimeVersionsRequest} obj Optional instance to populate.
     * @return {module:model/DescribeRuntimeVersionsRequest} The populated <code>DescribeRuntimeVersionsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeRuntimeVersionsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeRuntimeVersionsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeRuntimeVersionsRequest</code>.
     */
 ...
 */
DescribeRuntimeVersionsRequest.prototype['NextToken'] = undefined;
 ...
 */
DescribeRuntimeVersionsRequest.prototype['MaxResults'] = undefined;
...
export default DescribeRuntimeVersionsRequest;
