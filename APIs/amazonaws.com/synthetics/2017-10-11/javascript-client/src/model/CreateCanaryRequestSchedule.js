...
import CanaryScheduleInput from './CanaryScheduleInput';

/**
 * The CreateCanaryRequestSchedule model module.
 * @module model/CreateCanaryRequestSchedule
 * @version 2017-10-11
 */
class CreateCanaryRequestSchedule {
    /**
     * Constructs a new <code>CreateCanaryRequestSchedule</code>.
     * @alias module:model/CreateCanaryRequestSchedule
     * @implements module:model/CanaryScheduleInput
     * @param expression {String} 
     */
    constructor(expression) { 
        CanaryScheduleInput.initialize(this, expression);
        CreateCanaryRequestSchedule.initialize(this, expression);
    }
    ...
    /**
     * Constructs a <code>CreateCanaryRequestSchedule</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateCanaryRequestSchedule} obj Optional instance to populate.
     * @return {module:model/CreateCanaryRequestSchedule} The populated <code>CreateCanaryRequestSchedule</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateCanaryRequestSchedule();
            CanaryScheduleInput.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCanaryRequestSchedule</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCanaryRequestSchedule</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateCanaryRequestSchedule.RequiredProperties) {
...
CreateCanaryRequestSchedule.RequiredProperties = ["Expression"];

/**
 * @member {String} Expression
 */
CreateCanaryRequestSchedule.prototype['Expression'] = undefined;

/**
 * @member {Number} DurationInSeconds
 */
CreateCanaryRequestSchedule.prototype['DurationInSeconds'] = undefined;


// Implement CanaryScheduleInput interface:
/**
 * @member {String} Expression
 */
...
export default CreateCanaryRequestSchedule;
