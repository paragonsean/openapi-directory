...
import CreateCanaryResponseCanary from './CreateCanaryResponseCanary';

/**
 * The CreateCanaryResponse model module.
 * @module model/CreateCanaryResponse
 * @version 2017-10-11
 */
class CreateCanaryResponse {
    /**
     * Constructs a new <code>CreateCanaryResponse</code>.
     * @alias module:model/CreateCanaryResponse
     */
    constructor() { 
        
        CreateCanaryResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateCanaryResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateCanaryResponse} obj Optional instance to populate.
     * @return {module:model/CreateCanaryResponse} The populated <code>CreateCanaryResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateCanaryResponse();

            if (data.hasOwnProperty('Canary')) {
                obj['Canary'] = CreateCanaryResponseCanary.constructFromObject(data['Canary']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCanaryResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCanaryResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Canary`
        if (data['Canary']) { // data not null
          CreateCanaryResponseCanary.validateJSON(data['Canary']);
        }
...
/**
 * @member {module:model/CreateCanaryResponseCanary} Canary
 */
CreateCanaryResponse.prototype['Canary'] = undefined;
...
export default CreateCanaryResponse;
