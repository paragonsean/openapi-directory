...
* @readonly
*/
export default class CanaryState {
    ...
    /**
    * Returns a <code>CanaryState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CanaryState} The enum <code>CanaryState</code> value.
    */
