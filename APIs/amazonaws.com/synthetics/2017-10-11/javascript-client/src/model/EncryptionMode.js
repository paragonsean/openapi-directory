...
* @readonly
*/
export default class EncryptionMode {
    ...
    /**
    * Returns a <code>EncryptionMode</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/EncryptionMode} The enum <code>EncryptionMode</code> value.
    */
