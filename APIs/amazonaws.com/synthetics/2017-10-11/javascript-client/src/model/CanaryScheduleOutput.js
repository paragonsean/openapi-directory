...
/**
 * The CanaryScheduleOutput model module.
 * @module model/CanaryScheduleOutput
 * @version 2017-10-11
 */
class CanaryScheduleOutput {
    /**
     * Constructs a new <code>CanaryScheduleOutput</code>.
     ...
     * @alias module:model/CanaryScheduleOutput
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>CanaryScheduleOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CanaryScheduleOutput} obj Optional instance to populate.
     * @return {module:model/CanaryScheduleOutput} The populated <code>CanaryScheduleOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CanaryScheduleOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>CanaryScheduleOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CanaryScheduleOutput</code>.
     */
...
export default CanaryScheduleOutput;
