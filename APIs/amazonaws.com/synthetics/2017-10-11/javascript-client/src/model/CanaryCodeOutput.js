...
/**
 * The CanaryCodeOutput model module.
 * @module model/CanaryCodeOutput
 * @version 2017-10-11
 */
class CanaryCodeOutput {
    /**
     * Constructs a new <code>CanaryCodeOutput</code>.
     * This structure contains information about the canary&#39;s Lambda handler and where its code is stored by CloudWatch Synthetics.
     * @alias module:model/CanaryCodeOutput
     */
    constructor() { 
        
        CanaryCodeOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CanaryCodeOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CanaryCodeOutput} obj Optional instance to populate.
     * @return {module:model/CanaryCodeOutput} The populated <code>CanaryCodeOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CanaryCodeOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>CanaryCodeOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CanaryCodeOutput</code>.
     */
 ...
 */
CanaryCodeOutput.prototype['SourceLocationArn'] = undefined;

/**
 * @member {String} Handler
 */
CanaryCodeOutput.prototype['Handler'] = undefined;
...
export default CanaryCodeOutput;
