...
/**
 * The ListAssociatedGroupsRequest model module.
 * @module model/ListAssociatedGroupsRequest
 * @version 2017-10-11
 */
class ListAssociatedGroupsRequest {
    /**
     * Constructs a new <code>ListAssociatedGroupsRequest</code>.
     * @alias module:model/ListAssociatedGroupsRequest
     */
    constructor() { 
        
        ListAssociatedGroupsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListAssociatedGroupsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAssociatedGroupsRequest} obj Optional instance to populate.
     * @return {module:model/ListAssociatedGroupsRequest} The populated <code>ListAssociatedGroupsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListAssociatedGroupsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListAssociatedGroupsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListAssociatedGroupsRequest</code>.
     */
 ...
 */
ListAssociatedGroupsRequest.prototype['NextToken'] = undefined;
 ...
 */
ListAssociatedGroupsRequest.prototype['MaxResults'] = undefined;
...
export default ListAssociatedGroupsRequest;
