...
/**
 * The CanaryScheduleInput model module.
 * @module model/CanaryScheduleInput
 * @version 2017-10-11
 */
class CanaryScheduleInput {
    /**
     * Constructs a new <code>CanaryScheduleInput</code>.
     * This structure specifies how often a canary is to make runs and the date and time when it should stop making runs.
     * @alias module:model/CanaryScheduleInput
     * @param expression {String} 
     */
    constructor(expression) { 
        
        CanaryScheduleInput.initialize(this, expression);
    }
    ...
    /**
     * Constructs a <code>CanaryScheduleInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CanaryScheduleInput} obj Optional instance to populate.
     * @return {module:model/CanaryScheduleInput} The populated <code>CanaryScheduleInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CanaryScheduleInput();
    ...
    /**
     * Validates the JSON data with respect to <code>CanaryScheduleInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CanaryScheduleInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CanaryScheduleInput.RequiredProperties) {
...
CanaryScheduleInput.RequiredProperties = ["Expression"];

/**
 * @member {String} Expression
 */
CanaryScheduleInput.prototype['Expression'] = undefined;

/**
 * @member {Number} DurationInSeconds
 */
CanaryScheduleInput.prototype['DurationInSeconds'] = undefined;
...
export default CanaryScheduleInput;
