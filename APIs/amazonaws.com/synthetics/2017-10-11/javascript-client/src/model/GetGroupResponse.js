...
import GetGroupResponseGroup from './GetGroupResponseGroup';

/**
 * The GetGroupResponse model module.
 * @module model/GetGroupResponse
 * @version 2017-10-11
 */
class GetGroupResponse {
    /**
     * Constructs a new <code>GetGroupResponse</code>.
     * @alias module:model/GetGroupResponse
     */
    constructor() { 
        
        GetGroupResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetGroupResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetGroupResponse} obj Optional instance to populate.
     * @return {module:model/GetGroupResponse} The populated <code>GetGroupResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetGroupResponse();

            if (data.hasOwnProperty('Group')) {
                obj['Group'] = GetGroupResponseGroup.constructFromObject(data['Group']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetGroupResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetGroupResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Group`
        if (data['Group']) { // data not null
          GetGroupResponseGroup.validateJSON(data['Group']);
        }
...
/**
 * @member {module:model/GetGroupResponseGroup} Group
 */
GetGroupResponse.prototype['Group'] = undefined;
...
export default GetGroupResponse;
