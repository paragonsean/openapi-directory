...
* @readonly
*/
export default class CanaryStateReasonCode {
    ...
    /**
    * Returns a <code>CanaryStateReasonCode</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CanaryStateReasonCode} The enum <code>CanaryStateReasonCode</code> value.
    */
