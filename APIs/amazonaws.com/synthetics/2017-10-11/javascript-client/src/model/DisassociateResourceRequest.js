...
/**
 * The DisassociateResourceRequest model module.
 * @module model/DisassociateResourceRequest
 * @version 2017-10-11
 */
class DisassociateResourceRequest {
    /**
     * Constructs a new <code>DisassociateResourceRequest</code>.
     * @alias module:model/DisassociateResourceRequest
     * @param resourceArn {String} The ARN of the canary that you want to remove from the specified group.
     */
    constructor(resourceArn) { 
        
        DisassociateResourceRequest.initialize(this, resourceArn);
    }
    ...
    /**
     * Constructs a <code>DisassociateResourceRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisassociateResourceRequest} obj Optional instance to populate.
     * @return {module:model/DisassociateResourceRequest} The populated <code>DisassociateResourceRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisassociateResourceRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DisassociateResourceRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisassociateResourceRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DisassociateResourceRequest.RequiredProperties) {
...
DisassociateResourceRequest.RequiredProperties = ["ResourceArn"];

/**
 * The ARN of the canary that you want to remove from the specified group.
 * @member {String} ResourceArn
 */
DisassociateResourceRequest.prototype['ResourceArn'] = undefined;
...
export default DisassociateResourceRequest;
