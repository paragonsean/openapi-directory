...
/**
 * The UpdateCanaryRequestSchedule model module.
 * @module model/UpdateCanaryRequestSchedule
 * @version 2017-10-11
 */
class UpdateCanaryRequestSchedule {
    /**
     * Constructs a new <code>UpdateCanaryRequestSchedule</code>.
     * @alias module:model/UpdateCanaryRequestSchedule
     * @implements module:model/CanaryScheduleInput
     * @param expression {String} 
     */
    constructor(expression) { 
        CanaryScheduleInput.initialize(this, expression);
        UpdateCanaryRequestSchedule.initialize(this, expression);
    }
    ...
    /**
     * Constructs a <code>UpdateCanaryRequestSchedule</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateCanaryRequestSchedule} obj Optional instance to populate.
     * @return {module:model/UpdateCanaryRequestSchedule} The populated <code>UpdateCanaryRequestSchedule</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateCanaryRequestSchedule();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateCanaryRequestSchedule</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateCanaryRequestSchedule</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateCanaryRequestSchedule.RequiredProperties) {
...
UpdateCanaryRequestSchedule.RequiredProperties = ["Expression"];

/**
 * @member {String} Expression
 */
UpdateCanaryRequestSchedule.prototype['Expression'] = undefined;

/**
 * @member {Number} DurationInSeconds
 */
UpdateCanaryRequestSchedule.prototype['DurationInSeconds'] = undefined;
...
export default UpdateCanaryRequestSchedule;
