...
/**
 * The CanaryRunConfigInput model module.
 * @module model/CanaryRunConfigInput
 * @version 2017-10-11
 */
class CanaryRunConfigInput {
    /**
     * Constructs a new <code>CanaryRunConfigInput</code>.
     * A structure that contains input information for a canary run.
     * @alias module:model/CanaryRunConfigInput
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>CanaryRunConfigInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CanaryRunConfigInput} obj Optional instance to populate.
     * @return {module:model/CanaryRunConfigInput} The populated <code>CanaryRunConfigInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CanaryRunConfigInput();
    ...
    /**
     * Validates the JSON data with respect to <code>CanaryRunConfigInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CanaryRunConfigInput</code>.
     */
...
export default CanaryRunConfigInput;
