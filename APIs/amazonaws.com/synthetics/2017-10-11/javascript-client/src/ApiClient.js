...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://synthetics.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://synthetics.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2017-10-11/Javascript'
        };
