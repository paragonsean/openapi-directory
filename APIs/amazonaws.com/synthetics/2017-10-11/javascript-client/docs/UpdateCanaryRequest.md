# Synthetics.UpdateCanaryRequest
...
**successRetentionPeriodInDays** | **Number** | The number of days to retain data about successful runs of this canary. | [optional] 
**failureRetentionPeriodInDays** | **Number** | The number of days to retain data about failed runs of this canary. | [optional] 
