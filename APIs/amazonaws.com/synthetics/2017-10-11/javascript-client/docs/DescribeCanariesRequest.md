# Synthetics.DescribeCanariesRequest
...
**maxResults** | **Number** | Specify this parameter to limit how many canaries are returned each time you use the &lt;code&gt;DescribeCanaries&lt;/code&gt; operation. If you omit this parameter, the default of 100 is used. | [optional] 
