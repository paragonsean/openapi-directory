...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.ArtifactConfigOutputS3Encryption();
  });
  ...
  describe('ArtifactConfigOutputS3Encryption', function() {
    it('should create an instance of ArtifactConfigOutputS3Encryption', function() {
      // uncomment below and update the code to test ArtifactConfigOutputS3Encryption
      //var instance = new Synthetics.ArtifactConfigOutputS3Encryption();
      //expect(instance).to.be.a(Synthetics.ArtifactConfigOutputS3Encryption);
    });
