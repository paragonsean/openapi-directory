...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.CanaryRunConfigOutput();
  });
  ...
  describe('CanaryRunConfigOutput', function() {
    it('should create an instance of CanaryRunConfigOutput', function() {
      // uncomment below and update the code to test CanaryRunConfigOutput
      //var instance = new Synthetics.CanaryRunConfigOutput();
      //expect(instance).to.be.a(Synthetics.CanaryRunConfigOutput);
    });
