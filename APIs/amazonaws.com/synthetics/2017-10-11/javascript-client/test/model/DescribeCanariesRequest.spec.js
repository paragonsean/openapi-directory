...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.DescribeCanariesRequest();
  });
  ...
  describe('DescribeCanariesRequest', function() {
    it('should create an instance of DescribeCanariesRequest', function() {
      // uncomment below and update the code to test DescribeCanariesRequest
      //var instance = new Synthetics.DescribeCanariesRequest();
      //expect(instance).to.be.a(Synthetics.DescribeCanariesRequest);
    });
