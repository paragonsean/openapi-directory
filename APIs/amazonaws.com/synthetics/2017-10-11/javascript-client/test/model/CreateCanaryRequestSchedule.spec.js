...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.CreateCanaryRequestSchedule();
  });
  ...
  describe('CreateCanaryRequestSchedule', function() {
    it('should create an instance of CreateCanaryRequestSchedule', function() {
      // uncomment below and update the code to test CreateCanaryRequestSchedule
      //var instance = new Synthetics.CreateCanaryRequestSchedule();
      //expect(instance).to.be.a(Synthetics.CreateCanaryRequestSchedule);
    });
