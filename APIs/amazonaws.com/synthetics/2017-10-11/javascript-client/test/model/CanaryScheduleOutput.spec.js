...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.CanaryScheduleOutput();
  });
  ...
  describe('CanaryScheduleOutput', function() {
    it('should create an instance of CanaryScheduleOutput', function() {
      // uncomment below and update the code to test CanaryScheduleOutput
      //var instance = new Synthetics.CanaryScheduleOutput();
      //expect(instance).to.be.a(Synthetics.CanaryScheduleOutput);
    });
