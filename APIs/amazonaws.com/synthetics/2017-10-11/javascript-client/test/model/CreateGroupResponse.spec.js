...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.CreateGroupResponse();
  });
  ...
  describe('CreateGroupResponse', function() {
    it('should create an instance of CreateGroupResponse', function() {
      // uncomment below and update the code to test CreateGroupResponse
      //var instance = new Synthetics.CreateGroupResponse();
      //expect(instance).to.be.a(Synthetics.CreateGroupResponse);
    });
