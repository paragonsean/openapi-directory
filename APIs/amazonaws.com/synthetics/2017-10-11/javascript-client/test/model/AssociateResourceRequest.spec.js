...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.AssociateResourceRequest();
  });
  ...
  describe('AssociateResourceRequest', function() {
    it('should create an instance of AssociateResourceRequest', function() {
      // uncomment below and update the code to test AssociateResourceRequest
      //var instance = new Synthetics.AssociateResourceRequest();
      //expect(instance).to.be.a(Synthetics.AssociateResourceRequest);
    });
