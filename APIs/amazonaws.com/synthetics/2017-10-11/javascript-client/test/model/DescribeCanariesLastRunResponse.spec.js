...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.DescribeCanariesLastRunResponse();
  });
  ...
  describe('DescribeCanariesLastRunResponse', function() {
    it('should create an instance of DescribeCanariesLastRunResponse', function() {
      // uncomment below and update the code to test DescribeCanariesLastRunResponse
      //var instance = new Synthetics.DescribeCanariesLastRunResponse();
      //expect(instance).to.be.a(Synthetics.DescribeCanariesLastRunResponse);
    });

    it('should have the property canariesLastRun (base name: "CanariesLastRun")', function() {
      // uncomment below and update the code to test the property canariesLastRun
      //var instance = new Synthetics.DescribeCanariesLastRunResponse();
