...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.CreateCanaryResponse();
  });
  ...
  describe('CreateCanaryResponse', function() {
    it('should create an instance of CreateCanaryResponse', function() {
      // uncomment below and update the code to test CreateCanaryResponse
      //var instance = new Synthetics.CreateCanaryResponse();
      //expect(instance).to.be.a(Synthetics.CreateCanaryResponse);
    });
