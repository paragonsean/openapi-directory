...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.ListGroupResourcesResponse();
  });
  ...
  describe('ListGroupResourcesResponse', function() {
    it('should create an instance of ListGroupResourcesResponse', function() {
      // uncomment below and update the code to test ListGroupResourcesResponse
      //var instance = new Synthetics.ListGroupResourcesResponse();
      //expect(instance).to.be.a(Synthetics.ListGroupResourcesResponse);
    });
