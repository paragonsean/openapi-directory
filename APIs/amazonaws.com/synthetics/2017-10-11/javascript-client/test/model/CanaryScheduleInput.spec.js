...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.CanaryScheduleInput();
  });
  ...
  describe('CanaryScheduleInput', function() {
    it('should create an instance of CanaryScheduleInput', function() {
      // uncomment below and update the code to test CanaryScheduleInput
      //var instance = new Synthetics.CanaryScheduleInput();
      //expect(instance).to.be.a(Synthetics.CanaryScheduleInput);
    });
