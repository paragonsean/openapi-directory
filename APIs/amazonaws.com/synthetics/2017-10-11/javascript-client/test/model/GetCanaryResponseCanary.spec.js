...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.GetCanaryResponseCanary();
  });
  ...
  describe('GetCanaryResponseCanary', function() {
    it('should create an instance of GetCanaryResponseCanary', function() {
      // uncomment below and update the code to test GetCanaryResponseCanary
      //var instance = new Synthetics.GetCanaryResponseCanary();
      //expect(instance).to.be.a(Synthetics.GetCanaryResponseCanary);
    });
