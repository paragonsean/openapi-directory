...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.CanaryRunTimeline();
  });
  ...
  describe('CanaryRunTimeline', function() {
    it('should create an instance of CanaryRunTimeline', function() {
      // uncomment below and update the code to test CanaryRunTimeline
      //var instance = new Synthetics.CanaryRunTimeline();
      //expect(instance).to.be.a(Synthetics.CanaryRunTimeline);
    });
