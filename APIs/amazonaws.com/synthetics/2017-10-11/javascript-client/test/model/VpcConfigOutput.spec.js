...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.VpcConfigOutput();
  });
  ...
  describe('VpcConfigOutput', function() {
    it('should create an instance of VpcConfigOutput', function() {
      // uncomment below and update the code to test VpcConfigOutput
      //var instance = new Synthetics.VpcConfigOutput();
      //expect(instance).to.be.a(Synthetics.VpcConfigOutput);
    });
