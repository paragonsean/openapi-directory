...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.ListAssociatedGroupsResponse();
  });
  ...
  describe('ListAssociatedGroupsResponse', function() {
    it('should create an instance of ListAssociatedGroupsResponse', function() {
      // uncomment below and update the code to test ListAssociatedGroupsResponse
      //var instance = new Synthetics.ListAssociatedGroupsResponse();
      //expect(instance).to.be.a(Synthetics.ListAssociatedGroupsResponse);
    });
