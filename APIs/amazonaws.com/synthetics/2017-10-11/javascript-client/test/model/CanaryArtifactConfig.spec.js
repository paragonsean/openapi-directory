...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.CanaryArtifactConfig();
  });
  ...
  describe('CanaryArtifactConfig', function() {
    it('should create an instance of CanaryArtifactConfig', function() {
      // uncomment below and update the code to test CanaryArtifactConfig
      //var instance = new Synthetics.CanaryArtifactConfig();
      //expect(instance).to.be.a(Synthetics.CanaryArtifactConfig);
    });
