...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.CreateCanaryRequestCode();
  });
  ...
  describe('CreateCanaryRequestCode', function() {
    it('should create an instance of CreateCanaryRequestCode', function() {
      // uncomment below and update the code to test CreateCanaryRequestCode
      //var instance = new Synthetics.CreateCanaryRequestCode();
      //expect(instance).to.be.a(Synthetics.CreateCanaryRequestCode);
    });
    ...
    it('should have the property s3Version (base name: "S3Version")', function() {
      // uncomment below and update the code to test the property s3Version
      //var instance = new Synthetics.CreateCanaryRequestCode();
      //expect(instance).to.be();
    });

    it('should have the property zipFile (base name: "ZipFile")', function() {
      // uncomment below and update the code to test the property zipFile
      //var instance = new Synthetics.CreateCanaryRequestCode();
      //expect(instance).to.be();
    });
