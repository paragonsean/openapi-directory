...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.UpdateCanaryRequestRunConfig();
  });
  ...
  describe('UpdateCanaryRequestRunConfig', function() {
    it('should create an instance of UpdateCanaryRequestRunConfig', function() {
      // uncomment below and update the code to test UpdateCanaryRequestRunConfig
      //var instance = new Synthetics.UpdateCanaryRequestRunConfig();
      //expect(instance).to.be.a(Synthetics.UpdateCanaryRequestRunConfig);
    });
