...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.GetGroupResponseGroup();
  });
  ...
  describe('GetGroupResponseGroup', function() {
    it('should create an instance of GetGroupResponseGroup', function() {
      // uncomment below and update the code to test GetGroupResponseGroup
      //var instance = new Synthetics.GetGroupResponseGroup();
      //expect(instance).to.be.a(Synthetics.GetGroupResponseGroup);
    });
