...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.CanarySchedule();
  });
  ...
  describe('CanarySchedule', function() {
    it('should create an instance of CanarySchedule', function() {
      // uncomment below and update the code to test CanarySchedule
      //var instance = new Synthetics.CanarySchedule();
      //expect(instance).to.be.a(Synthetics.CanarySchedule);
    });
