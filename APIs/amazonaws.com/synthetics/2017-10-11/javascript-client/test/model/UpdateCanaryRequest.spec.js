...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.UpdateCanaryRequest();
  });
  ...
  describe('UpdateCanaryRequest', function() {
    it('should create an instance of UpdateCanaryRequest', function() {
      // uncomment below and update the code to test UpdateCanaryRequest
      //var instance = new Synthetics.UpdateCanaryRequest();
      //expect(instance).to.be.a(Synthetics.UpdateCanaryRequest);
    });
