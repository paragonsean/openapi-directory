...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.GetCanaryRunsRequest();
  });
  ...
  describe('GetCanaryRunsRequest', function() {
    it('should create an instance of GetCanaryRunsRequest', function() {
      // uncomment below and update the code to test GetCanaryRunsRequest
      //var instance = new Synthetics.GetCanaryRunsRequest();
      //expect(instance).to.be.a(Synthetics.GetCanaryRunsRequest);
    });
