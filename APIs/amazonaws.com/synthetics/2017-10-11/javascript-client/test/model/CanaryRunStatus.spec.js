...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.CanaryRunStatus();
  });
  ...
  describe('CanaryRunStatus', function() {
    it('should create an instance of CanaryRunStatus', function() {
      // uncomment below and update the code to test CanaryRunStatus
      //var instance = new Synthetics.CanaryRunStatus();
      //expect(instance).to.be.a(Synthetics.CanaryRunStatus);
    });
