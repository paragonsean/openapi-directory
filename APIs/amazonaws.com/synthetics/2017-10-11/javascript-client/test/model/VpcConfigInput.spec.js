...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.VpcConfigInput();
  });
  ...
  describe('VpcConfigInput', function() {
    it('should create an instance of VpcConfigInput', function() {
      // uncomment below and update the code to test VpcConfigInput
      //var instance = new Synthetics.VpcConfigInput();
      //expect(instance).to.be.a(Synthetics.VpcConfigInput);
    });
