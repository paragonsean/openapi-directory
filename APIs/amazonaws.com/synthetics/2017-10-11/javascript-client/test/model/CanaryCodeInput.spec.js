...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.CanaryCodeInput();
  });
  ...
  describe('CanaryCodeInput', function() {
    it('should create an instance of CanaryCodeInput', function() {
      // uncomment below and update the code to test CanaryCodeInput
      //var instance = new Synthetics.CanaryCodeInput();
      //expect(instance).to.be.a(Synthetics.CanaryCodeInput);
    });
