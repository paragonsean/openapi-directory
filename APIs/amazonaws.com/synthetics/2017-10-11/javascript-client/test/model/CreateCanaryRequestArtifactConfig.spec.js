...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.CreateCanaryRequestArtifactConfig();
  });
  ...
  describe('CreateCanaryRequestArtifactConfig', function() {
    it('should create an instance of CreateCanaryRequestArtifactConfig', function() {
      // uncomment below and update the code to test CreateCanaryRequestArtifactConfig
      //var instance = new Synthetics.CreateCanaryRequestArtifactConfig();
      //expect(instance).to.be.a(Synthetics.CreateCanaryRequestArtifactConfig);
    });

    it('should have the property s3Encryption (base name: "S3Encryption")', function() {
      // uncomment below and update the code to test the property s3Encryption
      //var instance = new Synthetics.CreateCanaryRequestArtifactConfig();
