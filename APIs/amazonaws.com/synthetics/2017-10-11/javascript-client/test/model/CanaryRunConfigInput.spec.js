...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.CanaryRunConfigInput();
  });
  ...
  describe('CanaryRunConfigInput', function() {
    it('should create an instance of CanaryRunConfigInput', function() {
      // uncomment below and update the code to test CanaryRunConfigInput
      //var instance = new Synthetics.CanaryRunConfigInput();
      //expect(instance).to.be.a(Synthetics.CanaryRunConfigInput);
    });
    ...
    it('should have the property activeTracing (base name: "ActiveTracing")', function() {
      // uncomment below and update the code to test the property activeTracing
      //var instance = new Synthetics.CanaryRunConfigInput();
      //expect(instance).to.be();
    });
