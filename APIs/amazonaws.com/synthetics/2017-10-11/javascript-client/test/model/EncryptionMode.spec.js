...
(function(root, factory) {
  ...
  describe('EncryptionMode', function() {
    it('should create an instance of EncryptionMode', function() {
      // uncomment below and update the code to test EncryptionMode
      //var instance = new Synthetics.EncryptionMode();
      //expect(instance).to.be.a(Synthetics.EncryptionMode);
    });
