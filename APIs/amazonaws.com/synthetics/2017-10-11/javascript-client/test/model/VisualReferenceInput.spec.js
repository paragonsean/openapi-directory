...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.VisualReferenceInput();
  });
  ...
  describe('VisualReferenceInput', function() {
    it('should create an instance of VisualReferenceInput', function() {
      // uncomment below and update the code to test VisualReferenceInput
      //var instance = new Synthetics.VisualReferenceInput();
      //expect(instance).to.be.a(Synthetics.VisualReferenceInput);
    });
