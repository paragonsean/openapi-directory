...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.CreateCanaryRequestArtifactConfigS3Encryption();
  });
  ...
  describe('CreateCanaryRequestArtifactConfigS3Encryption', function() {
    it('should create an instance of CreateCanaryRequestArtifactConfigS3Encryption', function() {
      // uncomment below and update the code to test CreateCanaryRequestArtifactConfigS3Encryption
      //var instance = new Synthetics.CreateCanaryRequestArtifactConfigS3Encryption();
      //expect(instance).to.be.a(Synthetics.CreateCanaryRequestArtifactConfigS3Encryption);
    });
