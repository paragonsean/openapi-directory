...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.GetCanaryRunsResponse();
  });
  ...
  describe('GetCanaryRunsResponse', function() {
    it('should create an instance of GetCanaryRunsResponse', function() {
      // uncomment below and update the code to test GetCanaryRunsResponse
      //var instance = new Synthetics.GetCanaryRunsResponse();
      //expect(instance).to.be.a(Synthetics.GetCanaryRunsResponse);
    });

    it('should have the property canaryRuns (base name: "CanaryRuns")', function() {
      // uncomment below and update the code to test the property canaryRuns
      //var instance = new Synthetics.GetCanaryRunsResponse();
