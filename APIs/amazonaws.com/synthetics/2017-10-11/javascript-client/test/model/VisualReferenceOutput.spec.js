...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.VisualReferenceOutput();
  });
  ...
  describe('VisualReferenceOutput', function() {
    it('should create an instance of VisualReferenceOutput', function() {
      // uncomment below and update the code to test VisualReferenceOutput
      //var instance = new Synthetics.VisualReferenceOutput();
      //expect(instance).to.be.a(Synthetics.VisualReferenceOutput);
    });

    it('should have the property baseScreenshots (base name: "BaseScreenshots")', function() {
      // uncomment below and update the code to test the property baseScreenshots
      //var instance = new Synthetics.VisualReferenceOutput();
      //expect(instance).to.be();
    });

    it('should have the property baseCanaryRunId (base name: "BaseCanaryRunId")', function() {
      // uncomment below and update the code to test the property baseCanaryRunId
      //var instance = new Synthetics.VisualReferenceOutput();
      //expect(instance).to.be();
    });
