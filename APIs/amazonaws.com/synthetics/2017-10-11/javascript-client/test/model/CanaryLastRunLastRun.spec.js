...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.CanaryLastRunLastRun();
  });
  ...
  describe('CanaryLastRunLastRun', function() {
    it('should create an instance of CanaryLastRunLastRun', function() {
      // uncomment below and update the code to test CanaryLastRunLastRun
      //var instance = new Synthetics.CanaryLastRunLastRun();
      //expect(instance).to.be.a(Synthetics.CanaryLastRunLastRun);
    });
