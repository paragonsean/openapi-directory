...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.CanaryVisualReference();
  });
  ...
  describe('CanaryVisualReference', function() {
    it('should create an instance of CanaryVisualReference', function() {
      // uncomment below and update the code to test CanaryVisualReference
      //var instance = new Synthetics.CanaryVisualReference();
      //expect(instance).to.be.a(Synthetics.CanaryVisualReference);
    });
