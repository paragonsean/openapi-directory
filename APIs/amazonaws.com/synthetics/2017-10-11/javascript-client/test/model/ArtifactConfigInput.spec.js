...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.ArtifactConfigInput();
  });
  ...
  describe('ArtifactConfigInput', function() {
    it('should create an instance of ArtifactConfigInput', function() {
      // uncomment below and update the code to test ArtifactConfigInput
      //var instance = new Synthetics.ArtifactConfigInput();
      //expect(instance).to.be.a(Synthetics.ArtifactConfigInput);
    });
