...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.DescribeRuntimeVersionsResponse();
  });
  ...
  describe('DescribeRuntimeVersionsResponse', function() {
    it('should create an instance of DescribeRuntimeVersionsResponse', function() {
      // uncomment below and update the code to test DescribeRuntimeVersionsResponse
      //var instance = new Synthetics.DescribeRuntimeVersionsResponse();
      //expect(instance).to.be.a(Synthetics.DescribeRuntimeVersionsResponse);
    });
