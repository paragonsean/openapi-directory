...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.CreateCanaryRequestRunConfig();
  });
  ...
  describe('CreateCanaryRequestRunConfig', function() {
    it('should create an instance of CreateCanaryRequestRunConfig', function() {
      // uncomment below and update the code to test CreateCanaryRequestRunConfig
      //var instance = new Synthetics.CreateCanaryRequestRunConfig();
      //expect(instance).to.be.a(Synthetics.CreateCanaryRequestRunConfig);
    });
