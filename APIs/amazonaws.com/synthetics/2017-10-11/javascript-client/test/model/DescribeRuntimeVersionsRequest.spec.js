...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.DescribeRuntimeVersionsRequest();
  });
  ...
  describe('DescribeRuntimeVersionsRequest', function() {
    it('should create an instance of DescribeRuntimeVersionsRequest', function() {
      // uncomment below and update the code to test DescribeRuntimeVersionsRequest
      //var instance = new Synthetics.DescribeRuntimeVersionsRequest();
      //expect(instance).to.be.a(Synthetics.DescribeRuntimeVersionsRequest);
    });
