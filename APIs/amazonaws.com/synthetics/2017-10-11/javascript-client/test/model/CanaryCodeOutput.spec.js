...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.CanaryCodeOutput();
  });
  ...
  describe('CanaryCodeOutput', function() {
    it('should create an instance of CanaryCodeOutput', function() {
      // uncomment below and update the code to test CanaryCodeOutput
      //var instance = new Synthetics.CanaryCodeOutput();
      //expect(instance).to.be.a(Synthetics.CanaryCodeOutput);
    });
