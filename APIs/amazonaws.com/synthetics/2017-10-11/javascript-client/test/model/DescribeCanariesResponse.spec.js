...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.DescribeCanariesResponse();
  });
  ...
  describe('DescribeCanariesResponse', function() {
    it('should create an instance of DescribeCanariesResponse', function() {
      // uncomment below and update the code to test DescribeCanariesResponse
      //var instance = new Synthetics.DescribeCanariesResponse();
      //expect(instance).to.be.a(Synthetics.DescribeCanariesResponse);
    });

    it('should have the property canaries (base name: "Canaries")', function() {
      // uncomment below and update the code to test the property canaries
      //var instance = new Synthetics.DescribeCanariesResponse();
