...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.CanaryStatus();
  });
  ...
  describe('CanaryStatus', function() {
    it('should create an instance of CanaryStatus', function() {
      // uncomment below and update the code to test CanaryStatus
      //var instance = new Synthetics.CanaryStatus();
      //expect(instance).to.be.a(Synthetics.CanaryStatus);
    });
    ...
    it('should have the property stateReasonCode (base name: "StateReasonCode")', function() {
      // uncomment below and update the code to test the property stateReasonCode
      //var instance = new Synthetics.CanaryStatus();
      //expect(instance).to.be();
    });
