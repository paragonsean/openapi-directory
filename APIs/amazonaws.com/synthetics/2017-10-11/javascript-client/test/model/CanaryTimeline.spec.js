...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.CanaryTimeline();
  });
  ...
  describe('CanaryTimeline', function() {
    it('should create an instance of CanaryTimeline', function() {
      // uncomment below and update the code to test CanaryTimeline
      //var instance = new Synthetics.CanaryTimeline();
      //expect(instance).to.be.a(Synthetics.CanaryTimeline);
    });
    ...
    it('should have the property lastStarted (base name: "LastStarted")', function() {
      // uncomment below and update the code to test the property lastStarted
      //var instance = new Synthetics.CanaryTimeline();
      //expect(instance).to.be();
    });

    it('should have the property lastStopped (base name: "LastStopped")', function() {
      // uncomment below and update the code to test the property lastStopped
      //var instance = new Synthetics.CanaryTimeline();
      //expect(instance).to.be();
    });
