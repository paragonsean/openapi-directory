...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.UpdateCanaryRequestSchedule();
  });
  ...
  describe('UpdateCanaryRequestSchedule', function() {
    it('should create an instance of UpdateCanaryRequestSchedule', function() {
      // uncomment below and update the code to test UpdateCanaryRequestSchedule
      //var instance = new Synthetics.UpdateCanaryRequestSchedule();
      //expect(instance).to.be.a(Synthetics.UpdateCanaryRequestSchedule);
    });
