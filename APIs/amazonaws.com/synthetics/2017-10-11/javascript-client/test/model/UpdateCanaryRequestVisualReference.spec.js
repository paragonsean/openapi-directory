...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.UpdateCanaryRequestVisualReference();
  });
  ...
  describe('UpdateCanaryRequestVisualReference', function() {
    it('should create an instance of UpdateCanaryRequestVisualReference', function() {
      // uncomment below and update the code to test UpdateCanaryRequestVisualReference
      //var instance = new Synthetics.UpdateCanaryRequestVisualReference();
      //expect(instance).to.be.a(Synthetics.UpdateCanaryRequestVisualReference);
    });
