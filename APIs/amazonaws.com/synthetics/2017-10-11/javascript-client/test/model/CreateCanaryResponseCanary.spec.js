...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.CreateCanaryResponseCanary();
  });
  ...
  describe('CreateCanaryResponseCanary', function() {
    it('should create an instance of CreateCanaryResponseCanary', function() {
      // uncomment below and update the code to test CreateCanaryResponseCanary
      //var instance = new Synthetics.CreateCanaryResponseCanary();
      //expect(instance).to.be.a(Synthetics.CreateCanaryResponseCanary);
    });
