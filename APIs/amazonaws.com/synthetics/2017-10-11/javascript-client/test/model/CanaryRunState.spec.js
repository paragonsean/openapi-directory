...
(function(root, factory) {
  ...
  describe('CanaryRunState', function() {
    it('should create an instance of CanaryRunState', function() {
      // uncomment below and update the code to test CanaryRunState
      //var instance = new Synthetics.CanaryRunState();
      //expect(instance).to.be.a(Synthetics.CanaryRunState);
    });
