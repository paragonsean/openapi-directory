...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.CreateCanaryRequest();
  });
  ...
  describe('CreateCanaryRequest', function() {
    it('should create an instance of CreateCanaryRequest', function() {
      // uncomment below and update the code to test CreateCanaryRequest
      //var instance = new Synthetics.CreateCanaryRequest();
      //expect(instance).to.be.a(Synthetics.CreateCanaryRequest);
    });
