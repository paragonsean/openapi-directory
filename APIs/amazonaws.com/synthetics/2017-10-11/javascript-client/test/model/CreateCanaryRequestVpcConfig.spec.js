...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.CreateCanaryRequestVpcConfig();
  });
  ...
  describe('CreateCanaryRequestVpcConfig', function() {
    it('should create an instance of CreateCanaryRequestVpcConfig', function() {
      // uncomment below and update the code to test CreateCanaryRequestVpcConfig
      //var instance = new Synthetics.CreateCanaryRequestVpcConfig();
      //expect(instance).to.be.a(Synthetics.CreateCanaryRequestVpcConfig);
    });
