...
(function(root, factory) {
  ...
  describe('CanaryStateReasonCode', function() {
    it('should create an instance of CanaryStateReasonCode', function() {
      // uncomment below and update the code to test CanaryStateReasonCode
      //var instance = new Synthetics.CanaryStateReasonCode();
      //expect(instance).to.be.a(Synthetics.CanaryStateReasonCode);
    });
