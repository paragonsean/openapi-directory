...
(function(root, factory) {
  ...
  describe('CanaryState', function() {
    it('should create an instance of CanaryState', function() {
      // uncomment below and update the code to test CanaryState
      //var instance = new Synthetics.CanaryState();
      //expect(instance).to.be.a(Synthetics.CanaryState);
    });
