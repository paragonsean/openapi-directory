...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.CanaryLastRun();
  });
  ...
  describe('CanaryLastRun', function() {
    it('should create an instance of CanaryLastRun', function() {
      // uncomment below and update the code to test CanaryLastRun
      //var instance = new Synthetics.CanaryLastRun();
      //expect(instance).to.be.a(Synthetics.CanaryLastRun);
    });

    it('should have the property canaryName (base name: "CanaryName")', function() {
      // uncomment below and update the code to test the property canaryName
      //var instance = new Synthetics.CanaryLastRun();
