...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.GetCanaryResponse();
  });
  ...
  describe('GetCanaryResponse', function() {
    it('should create an instance of GetCanaryResponse', function() {
      // uncomment below and update the code to test GetCanaryResponse
      //var instance = new Synthetics.GetCanaryResponse();
      //expect(instance).to.be.a(Synthetics.GetCanaryResponse);
    });
