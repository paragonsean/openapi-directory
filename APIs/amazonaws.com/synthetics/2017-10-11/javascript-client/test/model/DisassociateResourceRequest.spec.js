...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.DisassociateResourceRequest();
  });
  ...
  describe('DisassociateResourceRequest', function() {
    it('should create an instance of DisassociateResourceRequest', function() {
      // uncomment below and update the code to test DisassociateResourceRequest
      //var instance = new Synthetics.DisassociateResourceRequest();
      //expect(instance).to.be.a(Synthetics.DisassociateResourceRequest);
    });
