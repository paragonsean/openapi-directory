...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.S3EncryptionConfig();
  });
  ...
  describe('S3EncryptionConfig', function() {
    it('should create an instance of S3EncryptionConfig', function() {
      // uncomment below and update the code to test S3EncryptionConfig
      //var instance = new Synthetics.S3EncryptionConfig();
      //expect(instance).to.be.a(Synthetics.S3EncryptionConfig);
    });
