...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.BaseScreenshot();
  });
  ...
  describe('BaseScreenshot', function() {
    it('should create an instance of BaseScreenshot', function() {
      // uncomment below and update the code to test BaseScreenshot
      //var instance = new Synthetics.BaseScreenshot();
      //expect(instance).to.be.a(Synthetics.BaseScreenshot);
    });

    it('should have the property screenshotName (base name: "ScreenshotName")', function() {
      // uncomment below and update the code to test the property screenshotName
      //var instance = new Synthetics.BaseScreenshot();
      //expect(instance).to.be();
    });

    it('should have the property ignoreCoordinates (base name: "IgnoreCoordinates")', function() {
      // uncomment below and update the code to test the property ignoreCoordinates
      //var instance = new Synthetics.BaseScreenshot();
      //expect(instance).to.be();
    });
