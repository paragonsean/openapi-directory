...
(function(root, factory) {
  ...
  describe('CanaryRunStateReasonCode', function() {
    it('should create an instance of CanaryRunStateReasonCode', function() {
      // uncomment below and update the code to test CanaryRunStateReasonCode
      //var instance = new Synthetics.CanaryRunStateReasonCode();
      //expect(instance).to.be.a(Synthetics.CanaryRunStateReasonCode);
    });
