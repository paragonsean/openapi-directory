...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.CanaryRun();
  });
  ...
  describe('CanaryRun', function() {
    it('should create an instance of CanaryRun', function() {
      // uncomment below and update the code to test CanaryRun
      //var instance = new Synthetics.CanaryRun();
      //expect(instance).to.be.a(Synthetics.CanaryRun);
    });
