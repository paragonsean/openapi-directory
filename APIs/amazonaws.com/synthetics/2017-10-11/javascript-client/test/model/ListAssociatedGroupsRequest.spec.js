...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.ListAssociatedGroupsRequest();
  });
  ...
  describe('ListAssociatedGroupsRequest', function() {
    it('should create an instance of ListAssociatedGroupsRequest', function() {
      // uncomment below and update the code to test ListAssociatedGroupsRequest
      //var instance = new Synthetics.ListAssociatedGroupsRequest();
      //expect(instance).to.be.a(Synthetics.ListAssociatedGroupsRequest);
    });
