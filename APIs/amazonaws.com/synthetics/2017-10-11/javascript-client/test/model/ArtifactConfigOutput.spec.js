...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.ArtifactConfigOutput();
  });
  ...
  describe('ArtifactConfigOutput', function() {
    it('should create an instance of ArtifactConfigOutput', function() {
      // uncomment below and update the code to test ArtifactConfigOutput
      //var instance = new Synthetics.ArtifactConfigOutput();
      //expect(instance).to.be.a(Synthetics.ArtifactConfigOutput);
    });
