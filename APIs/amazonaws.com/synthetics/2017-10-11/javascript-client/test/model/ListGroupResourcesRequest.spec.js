...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Synthetics.ListGroupResourcesRequest();
  });
  ...
  describe('ListGroupResourcesRequest', function() {
    it('should create an instance of ListGroupResourcesRequest', function() {
      // uncomment below and update the code to test ListGroupResourcesRequest
      //var instance = new Synthetics.ListGroupResourcesRequest();
      //expect(instance).to.be.a(Synthetics.ListGroupResourcesRequest);
    });
