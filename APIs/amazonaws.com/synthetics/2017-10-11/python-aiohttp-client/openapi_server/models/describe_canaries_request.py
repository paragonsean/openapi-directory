...
class DescribeCanariesRequest(Model):
    ...
    def __init__(self, next_token: str=None, max_results: int=None, names: List[str]=None):
        """DescribeCanariesRequest - a model defined in OpenAPI

        :param next_token: The next_token of this DescribeCanariesRequest.
        :param max_results: The max_results of this DescribeCanariesRequest.
        :param names: The names of this DescribeCanariesRequest.
        """
        self.openapi_types = {
            'next_token': str,
            'max_results': int,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DescribeCanariesRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DescribeCanaries_request of this DescribeCanariesRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def next_token(self):
        """Gets the next_token of this DescribeCanariesRequest.

        A token that indicates that there is more data available. You can use this token in a subsequent operation to retrieve the next set of results.

        :return: The next_token of this DescribeCanariesRequest.
        :rtype: str
        """
    ...
    def next_token(self, next_token):
        """Sets the next_token of this DescribeCanariesRequest.
    ...
    def max_results(self):
        """Gets the max_results of this DescribeCanariesRequest.
        ...
        :return: The max_results of this DescribeCanariesRequest.
        :rtype: int
        """
    ...
    def max_results(self, max_results):
        """Sets the max_results of this DescribeCanariesRequest.
    ...
    @property
    def names(self):
        """Gets the names of this DescribeCanariesRequest.
        ...
        :return: The names of this DescribeCanariesRequest.
        :rtype: List[str]
        """
        return self._names
    ...
    def names(self, names):
        """Sets the names of this DescribeCanariesRequest.
