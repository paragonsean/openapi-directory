...
class ListAssociatedGroupsRequest(Model):
    ...
    def __init__(self, next_token: str=None, max_results: int=None):
        """ListAssociatedGroupsRequest - a model defined in OpenAPI

        :param next_token: The next_token of this ListAssociatedGroupsRequest.
        :param max_results: The max_results of this ListAssociatedGroupsRequest.
        """
        self.openapi_types = {
            'next_token': str,
            'max_results': int
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ListAssociatedGroupsRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ListAssociatedGroups_request of this ListAssociatedGroupsRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def next_token(self):
        """Gets the next_token of this ListAssociatedGroupsRequest.

        A token that indicates that there is more data available. You can use this token in a subsequent operation to retrieve the next set of results.

        :return: The next_token of this ListAssociatedGroupsRequest.
        :rtype: str
        """
    ...
    def next_token(self, next_token):
        """Sets the next_token of this ListAssociatedGroupsRequest.
    ...
    def max_results(self):
        """Gets the max_results of this ListAssociatedGroupsRequest.
        ...
        :return: The max_results of this ListAssociatedGroupsRequest.
        :rtype: int
        """
    ...
    def max_results(self, max_results):
        """Sets the max_results of this ListAssociatedGroupsRequest.
