...
async def test_associate_resource(client):
    ...
    response = await client.request(
        method='PATCH',
        path='/group/{group_identifier}/associate'.format(group_identifier='group_identifier_example'),
        headers=headers,
        json=body,
        )
...
async def test_create_canary(client):
    """Test case for create_canary

    
    """
    body = {"ExecutionRoleArn":"","VpcConfig":{"SubnetIds":"","SecurityGroupIds":""},"ArtifactConfig":{"S3Encryption":{"KmsKeyArn":"","EncryptionMode":""}},"Schedule":{"DurationInSeconds":"","Expression":""},"SuccessRetentionPeriodInDays":"","RuntimeVersion":"","RunConfig":{"TimeoutInSeconds":"","EnvironmentVariables":"","MemoryInMB":"","ActiveTracing":""},"Code":{"S3Version":"","S3Bucket":"","ZipFile":"","S3Key":"","Handler":""},"ArtifactS3Location":"","Tags":"","Name":"","FailureRetentionPeriodInDays":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_delete_canary(client):
    """Test case for delete_canary

    
    """
    params = [('deleteLambda', True)]
    headers = { 
        'Accept': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
        'x_amz_date': 'x_amz_date_example',
    ...
    response = await client.request(
        method='DELETE',
        path='/canary/{name}'.format(name='name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_group(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/group/{group_identifier}'.format(group_identifier='group_identifier_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_canaries(client):
    """Test case for describe_canaries
...
async def test_describe_canaries_last_run(client):
    """Test case for describe_canaries_last_run
...
async def test_describe_runtime_versions(client):
    """Test case for describe_runtime_versions
...
async def test_disassociate_resource(client):
    ...
    response = await client.request(
        method='PATCH',
        path='/group/{group_identifier}/disassociate'.format(group_identifier='group_identifier_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_canary(client):
    """Test case for get_canary
...
async def test_get_canary_runs(client):
    """Test case for get_canary_runs
    ...
    response = await client.request(
        method='POST',
        path='/canary/{name}/runs'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_associated_groups(client):
    """Test case for list_associated_groups
    ...
    response = await client.request(
        method='POST',
        path='/resource/{resource_arn}/groups'.format(resource_arn='resource_arn_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_group_resources(client):
    ...
    response = await client.request(
        method='POST',
        path='/group/{group_identifier}/resources'.format(group_identifier='group_identifier_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_start_canary(client):
    """Test case for start_canary
    ...
    response = await client.request(
        method='POST',
        path='/canary/{name}/start'.format(name='name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_stop_canary(client):
    """Test case for stop_canary
    ...
    response = await client.request(
        method='POST',
        path='/canary/{name}/stop'.format(name='name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_canary(client):
    """Test case for update_canary

    
    """
    body = {"ExecutionRoleArn":"","VisualReference":{"BaseScreenshots":"","BaseCanaryRunId":""},"VpcConfig":{"SubnetIds":"","SecurityGroupIds":""},"ArtifactConfig":{"S3Encryption":{"KmsKeyArn":"","EncryptionMode":""}},"Schedule":{"DurationInSeconds":"","Expression":""},"SuccessRetentionPeriodInDays":"","RuntimeVersion":"","RunConfig":{"TimeoutInSeconds":"","EnvironmentVariables":"","MemoryInMB":"","ActiveTracing":""},"Code":{"S3Version":"","S3Bucket":"","ZipFile":"","S3Key":"","Handler":""},"ArtifactS3Location":"","FailureRetentionPeriodInDays":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
