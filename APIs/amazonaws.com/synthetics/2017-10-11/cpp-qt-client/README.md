...
class Example : public QObject {
    Q_OBJECT
    QString create();
    OAIAssociateResource_request create();
    QString create();
    QString create();
    QString create();
    QString create();
...
QString Example::create(){
    QString obj;
OAIAssociateResource_request Example::create(){
    OAIAssociateResource_request obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::associateResourceSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::associateResourceSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString group_identifier = create(); // QString | Specifies the group. You can specify the group name, the ARN, or the group ID as the <code>GroupIdentifier</code>.
      ...
      OAIAssociateResource_request oai_associate_resource_request = create(); // OAIAssociateResource_request | 
      ...
      apiInstance.associateResource(group_identifieroai_associate_resource_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
