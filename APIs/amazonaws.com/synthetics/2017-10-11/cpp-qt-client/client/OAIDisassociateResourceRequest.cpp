...
#include "OAIDisassociateResourceRequest.h"
...
OAIDisassociateResourceRequest::OAIDisassociateResourceRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDisassociateResourceRequest::OAIDisassociateResourceRequest() {
    this->initializeModel();
}

OAIDisassociateResourceRequest::~OAIDisassociateResourceRequest() {}

void OAIDisassociateResourceRequest::initializeModel() {

    m_resource_arn_isSet = false;
    m_resource_arn_isValid = false;
}

void OAIDisassociateResourceRequest::fromJson(QString jsonString) {
...
void OAIDisassociateResourceRequest::fromJsonObject(QJsonObject json) {

    m_resource_arn_isValid = ::OpenAPI::fromJsonValue(m_resource_arn, json[QString("ResourceArn")]);
    m_resource_arn_isSet = !json[QString("ResourceArn")].isNull() && m_resource_arn_isValid;
}

QString OAIDisassociateResourceRequest::asJson() const {
...
QJsonObject OAIDisassociateResourceRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDisassociateResourceRequest::getResourceArn() const {
    return m_resource_arn;
}
void OAIDisassociateResourceRequest::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAIDisassociateResourceRequest::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAIDisassociateResourceRequest::is_resource_arn_Valid() const{
    return m_resource_arn_isValid;
}

bool OAIDisassociateResourceRequest::isSet() const {
...
bool OAIDisassociateResourceRequest::isValid() const {
