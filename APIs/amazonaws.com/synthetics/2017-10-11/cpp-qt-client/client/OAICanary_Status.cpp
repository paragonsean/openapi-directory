...
OAICanary_Status::OAICanary_Status(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICanary_Status::OAICanary_Status() {
    this->initializeModel();
}

OAICanary_Status::~OAICanary_Status() {}

void OAICanary_Status::initializeModel() {
...
void OAICanary_Status::fromJson(QString jsonString) {
...
void OAICanary_Status::fromJsonObject(QJsonObject json) {
...
QString OAICanary_Status::asJson() const {
...
QJsonObject OAICanary_Status::asJsonObject() const {
    QJsonObject obj;
    if (m_state.isSet()) {
...
OAICanaryState OAICanary_Status::getState() const {
    return m_state;
}
void OAICanary_Status::setState(const OAICanaryState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAICanary_Status::is_state_Set() const{
    return m_state_isSet;
}

bool OAICanary_Status::is_state_Valid() const{
    return m_state_isValid;
}

QString OAICanary_Status::getStateReason() const {
    return m_state_reason;
}
void OAICanary_Status::setStateReason(const QString &state_reason) {
    m_state_reason = state_reason;
    m_state_reason_isSet = true;
}

bool OAICanary_Status::is_state_reason_Set() const{
    return m_state_reason_isSet;
}

bool OAICanary_Status::is_state_reason_Valid() const{
    return m_state_reason_isValid;
}

OAICanaryStateReasonCode OAICanary_Status::getStateReasonCode() const {
    return m_state_reason_code;
}
void OAICanary_Status::setStateReasonCode(const OAICanaryStateReasonCode &state_reason_code) {
    m_state_reason_code = state_reason_code;
    m_state_reason_code_isSet = true;
}

bool OAICanary_Status::is_state_reason_code_Set() const{
    return m_state_reason_code_isSet;
}

bool OAICanary_Status::is_state_reason_code_Valid() const{
    return m_state_reason_code_isValid;
}

bool OAICanary_Status::isSet() const {
...
bool OAICanary_Status::isValid() const {
