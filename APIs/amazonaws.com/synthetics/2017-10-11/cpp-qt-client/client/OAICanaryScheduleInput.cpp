...
#include "OAICanaryScheduleInput.h"
...
OAICanaryScheduleInput::OAICanaryScheduleInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICanaryScheduleInput::OAICanaryScheduleInput() {
    this->initializeModel();
}

OAICanaryScheduleInput::~OAICanaryScheduleInput() {}

void OAICanaryScheduleInput::initializeModel() {
...
void OAICanaryScheduleInput::fromJson(QString jsonString) {
...
void OAICanaryScheduleInput::fromJsonObject(QJsonObject json) {
...
QString OAICanaryScheduleInput::asJson() const {
...
QJsonObject OAICanaryScheduleInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAICanaryScheduleInput::getExpression() const {
    return m_expression;
}
void OAICanaryScheduleInput::setExpression(const QString &expression) {
    m_expression = expression;
    m_expression_isSet = true;
}

bool OAICanaryScheduleInput::is_expression_Set() const{
    return m_expression_isSet;
}

bool OAICanaryScheduleInput::is_expression_Valid() const{
    return m_expression_isValid;
}

qint32 OAICanaryScheduleInput::getDurationInSeconds() const {
    return m_duration_in_seconds;
}
void OAICanaryScheduleInput::setDurationInSeconds(const qint32 &duration_in_seconds) {
    m_duration_in_seconds = duration_in_seconds;
    m_duration_in_seconds_isSet = true;
}

bool OAICanaryScheduleInput::is_duration_in_seconds_Set() const{
    return m_duration_in_seconds_isSet;
}

bool OAICanaryScheduleInput::is_duration_in_seconds_Valid() const{
    return m_duration_in_seconds_isValid;
}

bool OAICanaryScheduleInput::isSet() const {
...
bool OAICanaryScheduleInput::isValid() const {
