...
OAICreateCanary_request_ArtifactConfig_S3Encryption::OAICreateCanary_request_ArtifactConfig_S3Encryption(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateCanary_request_ArtifactConfig_S3Encryption::OAICreateCanary_request_ArtifactConfig_S3Encryption() {
    this->initializeModel();
}

OAICreateCanary_request_ArtifactConfig_S3Encryption::~OAICreateCanary_request_ArtifactConfig_S3Encryption() {}

void OAICreateCanary_request_ArtifactConfig_S3Encryption::initializeModel() {
...
void OAICreateCanary_request_ArtifactConfig_S3Encryption::fromJson(QString jsonString) {
...
void OAICreateCanary_request_ArtifactConfig_S3Encryption::fromJsonObject(QJsonObject json) {
...
QString OAICreateCanary_request_ArtifactConfig_S3Encryption::asJson() const {
...
QJsonObject OAICreateCanary_request_ArtifactConfig_S3Encryption::asJsonObject() const {
    QJsonObject obj;
...
OAIEncryptionMode OAICreateCanary_request_ArtifactConfig_S3Encryption::getEncryptionMode() const {
    return m_encryption_mode;
}
void OAICreateCanary_request_ArtifactConfig_S3Encryption::setEncryptionMode(const OAIEncryptionMode &encryption_mode) {
    m_encryption_mode = encryption_mode;
    m_encryption_mode_isSet = true;
}

bool OAICreateCanary_request_ArtifactConfig_S3Encryption::is_encryption_mode_Set() const{
    return m_encryption_mode_isSet;
}

bool OAICreateCanary_request_ArtifactConfig_S3Encryption::is_encryption_mode_Valid() const{
    return m_encryption_mode_isValid;
}

QString OAICreateCanary_request_ArtifactConfig_S3Encryption::getKmsKeyArn() const {
    return m_kms_key_arn;
}
void OAICreateCanary_request_ArtifactConfig_S3Encryption::setKmsKeyArn(const QString &kms_key_arn) {
    m_kms_key_arn = kms_key_arn;
    m_kms_key_arn_isSet = true;
}

bool OAICreateCanary_request_ArtifactConfig_S3Encryption::is_kms_key_arn_Set() const{
    return m_kms_key_arn_isSet;
}

bool OAICreateCanary_request_ArtifactConfig_S3Encryption::is_kms_key_arn_Valid() const{
    return m_kms_key_arn_isValid;
}

bool OAICreateCanary_request_ArtifactConfig_S3Encryption::isSet() const {
...
bool OAICreateCanary_request_ArtifactConfig_S3Encryption::isValid() const {
