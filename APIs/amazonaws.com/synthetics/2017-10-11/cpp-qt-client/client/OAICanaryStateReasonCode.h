...
/*
 * OAICanaryStateReasonCode.h
 *
 * 
 */

#ifndef OAICanaryStateReasonCode_H
#define OAICanaryStateReasonCode_H
...
class OAICanaryStateReasonCode : public OAIEnum {
public:
    OAICanaryStateReasonCode();
    OAICanaryStateReasonCode(QString json);
    ~OAICanaryStateReasonCode() override;
    ...
    enum class eOAICanaryStateReasonCode {
    ...
    OAICanaryStateReasonCode::eOAICanaryStateReasonCode getValue() const;
    void setValue(const OAICanaryStateReasonCode::eOAICanaryStateReasonCode& value);
...
private:
    ...
    eOAICanaryStateReasonCode m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICanaryStateReasonCode)

#endif // OAICanaryStateReasonCode_H
