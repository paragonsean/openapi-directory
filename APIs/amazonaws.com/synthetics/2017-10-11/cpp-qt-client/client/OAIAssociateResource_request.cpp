...
OAIAssociateResource_request::OAIAssociateResource_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssociateResource_request::OAIAssociateResource_request() {
    this->initializeModel();
}

OAIAssociateResource_request::~OAIAssociateResource_request() {}

void OAIAssociateResource_request::initializeModel() {

    m_resource_arn_isSet = false;
    m_resource_arn_isValid = false;
}

void OAIAssociateResource_request::fromJson(QString jsonString) {
...
void OAIAssociateResource_request::fromJsonObject(QJsonObject json) {

    m_resource_arn_isValid = ::OpenAPI::fromJsonValue(m_resource_arn, json[QString("ResourceArn")]);
    m_resource_arn_isSet = !json[QString("ResourceArn")].isNull() && m_resource_arn_isValid;
}

QString OAIAssociateResource_request::asJson() const {
...
QJsonObject OAIAssociateResource_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAssociateResource_request::getResourceArn() const {
    return m_resource_arn;
}
void OAIAssociateResource_request::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAIAssociateResource_request::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAIAssociateResource_request::is_resource_arn_Valid() const{
    return m_resource_arn_isValid;
}

bool OAIAssociateResource_request::isSet() const {
...
bool OAIAssociateResource_request::isValid() const {
