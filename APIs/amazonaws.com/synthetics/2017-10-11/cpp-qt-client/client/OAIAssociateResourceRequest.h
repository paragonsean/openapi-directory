...
/*
 * OAIAssociateResourceRequest.h
 *
 * 
 */

#ifndef OAIAssociateResourceRequest_H
#define OAIAssociateResourceRequest_H
...
class OAIAssociateResourceRequest : public OAIObject {
public:
    OAIAssociateResourceRequest();
    OAIAssociateResourceRequest(QString json);
    ~OAIAssociateResourceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateResourceRequest)

#endif // OAIAssociateResourceRequest_H
