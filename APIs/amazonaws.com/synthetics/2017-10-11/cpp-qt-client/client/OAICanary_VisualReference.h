...
/*
 * OAICanary_VisualReference.h
 *
 * 
 */

#ifndef OAICanary_VisualReference_H
#define OAICanary_VisualReference_H
...
class OAICanary_VisualReference : public OAIObject {
public:
    OAICanary_VisualReference();
    OAICanary_VisualReference(QString json);
    ~OAICanary_VisualReference() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICanary_VisualReference)

#endif // OAICanary_VisualReference_H
