...
#include "OAICreateCanaryResponse_Canary.h"
...
OAICreateCanaryResponse_Canary::OAICreateCanaryResponse_Canary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateCanaryResponse_Canary::OAICreateCanaryResponse_Canary() {
    this->initializeModel();
}

OAICreateCanaryResponse_Canary::~OAICreateCanaryResponse_Canary() {}

void OAICreateCanaryResponse_Canary::initializeModel() {
...
void OAICreateCanaryResponse_Canary::fromJson(QString jsonString) {
...
void OAICreateCanaryResponse_Canary::fromJsonObject(QJsonObject json) {
...
QString OAICreateCanaryResponse_Canary::asJson() const {
...
QJsonObject OAICreateCanaryResponse_Canary::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAICreateCanaryResponse_Canary::getId() const {
    return m_id;
}
void OAICreateCanaryResponse_Canary::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICreateCanaryResponse_Canary::is_id_Set() const{
    return m_id_isSet;
}

bool OAICreateCanaryResponse_Canary::is_id_Valid() const{
    return m_id_isValid;
}

QString OAICreateCanaryResponse_Canary::getName() const {
    return m_name;
}
void OAICreateCanaryResponse_Canary::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateCanaryResponse_Canary::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateCanaryResponse_Canary::is_name_Valid() const{
    return m_name_isValid;
}

OAICanaryCodeOutput OAICreateCanaryResponse_Canary::getCode() const {
    return m_code;
}
void OAICreateCanaryResponse_Canary::setCode(const OAICanaryCodeOutput &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAICreateCanaryResponse_Canary::is_code_Set() const{
    return m_code_isSet;
}

bool OAICreateCanaryResponse_Canary::is_code_Valid() const{
    return m_code_isValid;
}

QString OAICreateCanaryResponse_Canary::getExecutionRoleArn() const {
    return m_execution_role_arn;
}
void OAICreateCanaryResponse_Canary::setExecutionRoleArn(const QString &execution_role_arn) {
    m_execution_role_arn = execution_role_arn;
    m_execution_role_arn_isSet = true;
}

bool OAICreateCanaryResponse_Canary::is_execution_role_arn_Set() const{
    return m_execution_role_arn_isSet;
}

bool OAICreateCanaryResponse_Canary::is_execution_role_arn_Valid() const{
    return m_execution_role_arn_isValid;
}

OAICanary_Schedule OAICreateCanaryResponse_Canary::getSchedule() const {
    return m_schedule;
}
void OAICreateCanaryResponse_Canary::setSchedule(const OAICanary_Schedule &schedule) {
    m_schedule = schedule;
    m_schedule_isSet = true;
}

bool OAICreateCanaryResponse_Canary::is_schedule_Set() const{
    return m_schedule_isSet;
}

bool OAICreateCanaryResponse_Canary::is_schedule_Valid() const{
    return m_schedule_isValid;
}

OAICanaryRunConfigOutput OAICreateCanaryResponse_Canary::getRunConfig() const {
    return m_run_config;
}
void OAICreateCanaryResponse_Canary::setRunConfig(const OAICanaryRunConfigOutput &run_config) {
    m_run_config = run_config;
    m_run_config_isSet = true;
}

bool OAICreateCanaryResponse_Canary::is_run_config_Set() const{
    return m_run_config_isSet;
}

bool OAICreateCanaryResponse_Canary::is_run_config_Valid() const{
    return m_run_config_isValid;
}

qint32 OAICreateCanaryResponse_Canary::getSuccessRetentionPeriodInDays() const {
    return m_success_retention_period_in_days;
}
void OAICreateCanaryResponse_Canary::setSuccessRetentionPeriodInDays(const qint32 &success_retention_period_in_days) {
    m_success_retention_period_in_days = success_retention_period_in_days;
    m_success_retention_period_in_days_isSet = true;
}

bool OAICreateCanaryResponse_Canary::is_success_retention_period_in_days_Set() const{
    return m_success_retention_period_in_days_isSet;
}

bool OAICreateCanaryResponse_Canary::is_success_retention_period_in_days_Valid() const{
    return m_success_retention_period_in_days_isValid;
}

qint32 OAICreateCanaryResponse_Canary::getFailureRetentionPeriodInDays() const {
    return m_failure_retention_period_in_days;
}
void OAICreateCanaryResponse_Canary::setFailureRetentionPeriodInDays(const qint32 &failure_retention_period_in_days) {
    m_failure_retention_period_in_days = failure_retention_period_in_days;
    m_failure_retention_period_in_days_isSet = true;
}

bool OAICreateCanaryResponse_Canary::is_failure_retention_period_in_days_Set() const{
    return m_failure_retention_period_in_days_isSet;
}

bool OAICreateCanaryResponse_Canary::is_failure_retention_period_in_days_Valid() const{
    return m_failure_retention_period_in_days_isValid;
}

OAICanary_Status OAICreateCanaryResponse_Canary::getStatus() const {
    return m_status;
}
void OAICreateCanaryResponse_Canary::setStatus(const OAICanary_Status &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICreateCanaryResponse_Canary::is_status_Set() const{
    return m_status_isSet;
}

bool OAICreateCanaryResponse_Canary::is_status_Valid() const{
    return m_status_isValid;
}

OAICanary_Timeline OAICreateCanaryResponse_Canary::getTimeline() const {
    return m_timeline;
}
void OAICreateCanaryResponse_Canary::setTimeline(const OAICanary_Timeline &timeline) {
    m_timeline = timeline;
    m_timeline_isSet = true;
}

bool OAICreateCanaryResponse_Canary::is_timeline_Set() const{
    return m_timeline_isSet;
}

bool OAICreateCanaryResponse_Canary::is_timeline_Valid() const{
    return m_timeline_isValid;
}

QString OAICreateCanaryResponse_Canary::getArtifactS3Location() const {
    return m_artifact_s3_location;
}
void OAICreateCanaryResponse_Canary::setArtifactS3Location(const QString &artifact_s3_location) {
    m_artifact_s3_location = artifact_s3_location;
    m_artifact_s3_location_isSet = true;
}

bool OAICreateCanaryResponse_Canary::is_artifact_s3_location_Set() const{
    return m_artifact_s3_location_isSet;
}

bool OAICreateCanaryResponse_Canary::is_artifact_s3_location_Valid() const{
    return m_artifact_s3_location_isValid;
}

QString OAICreateCanaryResponse_Canary::getEngineArn() const {
    return m_engine_arn;
}
void OAICreateCanaryResponse_Canary::setEngineArn(const QString &engine_arn) {
    m_engine_arn = engine_arn;
    m_engine_arn_isSet = true;
}

bool OAICreateCanaryResponse_Canary::is_engine_arn_Set() const{
    return m_engine_arn_isSet;
}

bool OAICreateCanaryResponse_Canary::is_engine_arn_Valid() const{
    return m_engine_arn_isValid;
}

QString OAICreateCanaryResponse_Canary::getRuntimeVersion() const {
    return m_runtime_version;
}
void OAICreateCanaryResponse_Canary::setRuntimeVersion(const QString &runtime_version) {
    m_runtime_version = runtime_version;
    m_runtime_version_isSet = true;
}

bool OAICreateCanaryResponse_Canary::is_runtime_version_Set() const{
    return m_runtime_version_isSet;
}

bool OAICreateCanaryResponse_Canary::is_runtime_version_Valid() const{
    return m_runtime_version_isValid;
}

OAIVpcConfigOutput OAICreateCanaryResponse_Canary::getVpcConfig() const {
    return m_vpc_config;
}
void OAICreateCanaryResponse_Canary::setVpcConfig(const OAIVpcConfigOutput &vpc_config) {
    m_vpc_config = vpc_config;
    m_vpc_config_isSet = true;
}

bool OAICreateCanaryResponse_Canary::is_vpc_config_Set() const{
    return m_vpc_config_isSet;
}

bool OAICreateCanaryResponse_Canary::is_vpc_config_Valid() const{
    return m_vpc_config_isValid;
}

OAICanary_VisualReference OAICreateCanaryResponse_Canary::getVisualReference() const {
    return m_visual_reference;
}
void OAICreateCanaryResponse_Canary::setVisualReference(const OAICanary_VisualReference &visual_reference) {
    m_visual_reference = visual_reference;
    m_visual_reference_isSet = true;
}

bool OAICreateCanaryResponse_Canary::is_visual_reference_Set() const{
    return m_visual_reference_isSet;
}

bool OAICreateCanaryResponse_Canary::is_visual_reference_Valid() const{
    return m_visual_reference_isValid;
}

QMap OAICreateCanaryResponse_Canary::getTags() const {
    return m_tags;
}
void OAICreateCanaryResponse_Canary::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateCanaryResponse_Canary::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateCanaryResponse_Canary::is_tags_Valid() const{
    return m_tags_isValid;
}

OAICanary_ArtifactConfig OAICreateCanaryResponse_Canary::getArtifactConfig() const {
    return m_artifact_config;
}
void OAICreateCanaryResponse_Canary::setArtifactConfig(const OAICanary_ArtifactConfig &artifact_config) {
    m_artifact_config = artifact_config;
    m_artifact_config_isSet = true;
}

bool OAICreateCanaryResponse_Canary::is_artifact_config_Set() const{
    return m_artifact_config_isSet;
}

bool OAICreateCanaryResponse_Canary::is_artifact_config_Valid() const{
    return m_artifact_config_isValid;
}

bool OAICreateCanaryResponse_Canary::isSet() const {
...
bool OAICreateCanaryResponse_Canary::isValid() const {
