...
OAICreateCanary_request_RunConfig::OAICreateCanary_request_RunConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateCanary_request_RunConfig::OAICreateCanary_request_RunConfig() {
    this->initializeModel();
}

OAICreateCanary_request_RunConfig::~OAICreateCanary_request_RunConfig() {}

void OAICreateCanary_request_RunConfig::initializeModel() {
...
void OAICreateCanary_request_RunConfig::fromJson(QString jsonString) {
...
void OAICreateCanary_request_RunConfig::fromJsonObject(QJsonObject json) {
...
QString OAICreateCanary_request_RunConfig::asJson() const {
...
QJsonObject OAICreateCanary_request_RunConfig::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAICreateCanary_request_RunConfig::getTimeoutInSeconds() const {
    return m_timeout_in_seconds;
}
void OAICreateCanary_request_RunConfig::setTimeoutInSeconds(const qint32 &timeout_in_seconds) {
    m_timeout_in_seconds = timeout_in_seconds;
    m_timeout_in_seconds_isSet = true;
}

bool OAICreateCanary_request_RunConfig::is_timeout_in_seconds_Set() const{
    return m_timeout_in_seconds_isSet;
}

bool OAICreateCanary_request_RunConfig::is_timeout_in_seconds_Valid() const{
    return m_timeout_in_seconds_isValid;
}

qint32 OAICreateCanary_request_RunConfig::getMemoryInMb() const {
    return m_memory_in_mb;
}
void OAICreateCanary_request_RunConfig::setMemoryInMb(const qint32 &memory_in_mb) {
    m_memory_in_mb = memory_in_mb;
    m_memory_in_mb_isSet = true;
}

bool OAICreateCanary_request_RunConfig::is_memory_in_mb_Set() const{
    return m_memory_in_mb_isSet;
}

bool OAICreateCanary_request_RunConfig::is_memory_in_mb_Valid() const{
    return m_memory_in_mb_isValid;
}

bool OAICreateCanary_request_RunConfig::getActiveTracing() const {
    return m_active_tracing;
}
void OAICreateCanary_request_RunConfig::setActiveTracing(const bool &active_tracing) {
    m_active_tracing = active_tracing;
    m_active_tracing_isSet = true;
}

bool OAICreateCanary_request_RunConfig::is_active_tracing_Set() const{
    return m_active_tracing_isSet;
}

bool OAICreateCanary_request_RunConfig::is_active_tracing_Valid() const{
    return m_active_tracing_isValid;
}

QMap OAICreateCanary_request_RunConfig::getEnvironmentVariables() const {
    return m_environment_variables;
}
void OAICreateCanary_request_RunConfig::setEnvironmentVariables(const QMap &environment_variables) {
    m_environment_variables = environment_variables;
    m_environment_variables_isSet = true;
}

bool OAICreateCanary_request_RunConfig::is_environment_variables_Set() const{
    return m_environment_variables_isSet;
}

bool OAICreateCanary_request_RunConfig::is_environment_variables_Valid() const{
    return m_environment_variables_isValid;
}

bool OAICreateCanary_request_RunConfig::isSet() const {
...
bool OAICreateCanary_request_RunConfig::isValid() const {
