...
/*
 * OAICanary_Timeline.h
 *
 * 
 */

#ifndef OAICanary_Timeline_H
#define OAICanary_Timeline_H
...
class OAICanary_Timeline : public OAIObject {
public:
    OAICanary_Timeline();
    OAICanary_Timeline(QString json);
    ~OAICanary_Timeline() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICanary_Timeline)

#endif // OAICanary_Timeline_H
