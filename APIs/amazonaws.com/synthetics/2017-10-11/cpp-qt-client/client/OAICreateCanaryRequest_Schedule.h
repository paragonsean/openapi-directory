...
/*
 * OAICreateCanaryRequest_Schedule.h
 *
 * 
 */

#ifndef OAICreateCanaryRequest_Schedule_H
#define OAICreateCanaryRequest_Schedule_H
...
class OAICreateCanaryRequest_Schedule : public OAIObject {
public:
    OAICreateCanaryRequest_Schedule();
    OAICreateCanaryRequest_Schedule(QString json);
    ~OAICreateCanaryRequest_Schedule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCanaryRequest_Schedule)

#endif // OAICreateCanaryRequest_Schedule_H
