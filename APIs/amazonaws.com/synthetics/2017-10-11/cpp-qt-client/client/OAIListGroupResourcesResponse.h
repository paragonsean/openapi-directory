...
/*
 * OAIListGroupResourcesResponse.h
 *
 * 
 */

#ifndef OAIListGroupResourcesResponse_H
#define OAIListGroupResourcesResponse_H
...
class OAIListGroupResourcesResponse : public OAIObject {
public:
    OAIListGroupResourcesResponse();
    OAIListGroupResourcesResponse(QString json);
    ~OAIListGroupResourcesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListGroupResourcesResponse)

#endif // OAIListGroupResourcesResponse_H
