...
OAICanary_VisualReference::OAICanary_VisualReference(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICanary_VisualReference::OAICanary_VisualReference() {
    this->initializeModel();
}

OAICanary_VisualReference::~OAICanary_VisualReference() {}

void OAICanary_VisualReference::initializeModel() {
...
void OAICanary_VisualReference::fromJson(QString jsonString) {
...
void OAICanary_VisualReference::fromJsonObject(QJsonObject json) {
...
QString OAICanary_VisualReference::asJson() const {
...
QJsonObject OAICanary_VisualReference::asJsonObject() const {
    QJsonObject obj;
...
QList OAICanary_VisualReference::getBaseScreenshots() const {
    return m_base_screenshots;
}
void OAICanary_VisualReference::setBaseScreenshots(const QList &base_screenshots) {
    m_base_screenshots = base_screenshots;
    m_base_screenshots_isSet = true;
}

bool OAICanary_VisualReference::is_base_screenshots_Set() const{
    return m_base_screenshots_isSet;
}

bool OAICanary_VisualReference::is_base_screenshots_Valid() const{
    return m_base_screenshots_isValid;
}

QString OAICanary_VisualReference::getBaseCanaryRunId() const {
    return m_base_canary_run_id;
}
void OAICanary_VisualReference::setBaseCanaryRunId(const QString &base_canary_run_id) {
    m_base_canary_run_id = base_canary_run_id;
    m_base_canary_run_id_isSet = true;
}

bool OAICanary_VisualReference::is_base_canary_run_id_Set() const{
    return m_base_canary_run_id_isSet;
}

bool OAICanary_VisualReference::is_base_canary_run_id_Valid() const{
    return m_base_canary_run_id_isValid;
}

bool OAICanary_VisualReference::isSet() const {
...
bool OAICanary_VisualReference::isValid() const {
