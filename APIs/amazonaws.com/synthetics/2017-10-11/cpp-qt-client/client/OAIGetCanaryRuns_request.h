...
/*
 * OAIGetCanaryRuns_request.h
 *
 * 
 */

#ifndef OAIGetCanaryRuns_request_H
#define OAIGetCanaryRuns_request_H
...
class OAIGetCanaryRuns_request : public OAIObject {
public:
    OAIGetCanaryRuns_request();
    OAIGetCanaryRuns_request(QString json);
    ~OAIGetCanaryRuns_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCanaryRuns_request)

#endif // OAIGetCanaryRuns_request_H
