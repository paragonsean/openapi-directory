...
/*
 * OAIUpdateCanaryRequest_VisualReference.h
 *
 * 
 */

#ifndef OAIUpdateCanaryRequest_VisualReference_H
#define OAIUpdateCanaryRequest_VisualReference_H
...
class OAIUpdateCanaryRequest_VisualReference : public OAIObject {
public:
    OAIUpdateCanaryRequest_VisualReference();
    OAIUpdateCanaryRequest_VisualReference(QString json);
    ~OAIUpdateCanaryRequest_VisualReference() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateCanaryRequest_VisualReference)

#endif // OAIUpdateCanaryRequest_VisualReference_H
