...
namespace OpenAPI {
class OAIGetGroupResponse_Group;
...
public:
    ...
    OAIGetGroupResponse_Group getGroup() const;
    void setGroup(const OAIGetGroupResponse_Group &group);
...
private:
    ...
    OAIGetGroupResponse_Group m_group;
    bool m_group_isSet;
