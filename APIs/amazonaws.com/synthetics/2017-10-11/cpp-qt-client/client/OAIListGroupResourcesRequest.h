...
/*
 * OAIListGroupResourcesRequest.h
 *
 * 
 */

#ifndef OAIListGroupResourcesRequest_H
#define OAIListGroupResourcesRequest_H
...
class OAIListGroupResourcesRequest : public OAIObject {
public:
    OAIListGroupResourcesRequest();
    OAIListGroupResourcesRequest(QString json);
    ~OAIListGroupResourcesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListGroupResourcesRequest)

#endif // OAIListGroupResourcesRequest_H
