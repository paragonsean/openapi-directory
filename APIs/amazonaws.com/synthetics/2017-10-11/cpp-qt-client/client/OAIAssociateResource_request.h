...
/*
 * OAIAssociateResource_request.h
 *
 * 
 */

#ifndef OAIAssociateResource_request_H
#define OAIAssociateResource_request_H
...
class OAIAssociateResource_request : public OAIObject {
public:
    OAIAssociateResource_request();
    OAIAssociateResource_request(QString json);
    ~OAIAssociateResource_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateResource_request)

#endif // OAIAssociateResource_request_H
