...
/*
 * OAICreateCanaryResponse.h
 *
 * 
 */

#ifndef OAICreateCanaryResponse_H
#define OAICreateCanaryResponse_H
...
namespace OpenAPI {
class OAICreateCanaryResponse_Canary;

class OAICreateCanaryResponse : public OAIObject {
public:
    OAICreateCanaryResponse();
    OAICreateCanaryResponse(QString json);
    ~OAICreateCanaryResponse() override;
    ...
    OAICreateCanaryResponse_Canary getCanary() const;
    void setCanary(const OAICreateCanaryResponse_Canary &canary);
...
private:
    ...
    OAICreateCanaryResponse_Canary m_canary;
    bool m_canary_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCanaryResponse)

#endif // OAICreateCanaryResponse_H
