...
OAIUpdateCanary_request_VisualReference::OAIUpdateCanary_request_VisualReference(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateCanary_request_VisualReference::OAIUpdateCanary_request_VisualReference() {
    this->initializeModel();
}

OAIUpdateCanary_request_VisualReference::~OAIUpdateCanary_request_VisualReference() {}

void OAIUpdateCanary_request_VisualReference::initializeModel() {
...
void OAIUpdateCanary_request_VisualReference::fromJson(QString jsonString) {
...
void OAIUpdateCanary_request_VisualReference::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateCanary_request_VisualReference::asJson() const {
...
QJsonObject OAIUpdateCanary_request_VisualReference::asJsonObject() const {
    QJsonObject obj;
...
QList OAIUpdateCanary_request_VisualReference::getBaseScreenshots() const {
    return m_base_screenshots;
}
void OAIUpdateCanary_request_VisualReference::setBaseScreenshots(const QList &base_screenshots) {
    m_base_screenshots = base_screenshots;
    m_base_screenshots_isSet = true;
}

bool OAIUpdateCanary_request_VisualReference::is_base_screenshots_Set() const{
    return m_base_screenshots_isSet;
}

bool OAIUpdateCanary_request_VisualReference::is_base_screenshots_Valid() const{
    return m_base_screenshots_isValid;
}

QString OAIUpdateCanary_request_VisualReference::getBaseCanaryRunId() const {
    return m_base_canary_run_id;
}
void OAIUpdateCanary_request_VisualReference::setBaseCanaryRunId(const QString &base_canary_run_id) {
    m_base_canary_run_id = base_canary_run_id;
    m_base_canary_run_id_isSet = true;
}

bool OAIUpdateCanary_request_VisualReference::is_base_canary_run_id_Set() const{
    return m_base_canary_run_id_isSet;
}

bool OAIUpdateCanary_request_VisualReference::is_base_canary_run_id_Valid() const{
    return m_base_canary_run_id_isValid;
}

bool OAIUpdateCanary_request_VisualReference::isSet() const {
...
bool OAIUpdateCanary_request_VisualReference::isValid() const {
