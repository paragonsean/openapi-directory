...
#include "OAIVisualReferenceOutput.h"
...
OAIVisualReferenceOutput::OAIVisualReferenceOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVisualReferenceOutput::OAIVisualReferenceOutput() {
    this->initializeModel();
}

OAIVisualReferenceOutput::~OAIVisualReferenceOutput() {}

void OAIVisualReferenceOutput::initializeModel() {
...
void OAIVisualReferenceOutput::fromJson(QString jsonString) {
...
void OAIVisualReferenceOutput::fromJsonObject(QJsonObject json) {
...
QString OAIVisualReferenceOutput::asJson() const {
...
QJsonObject OAIVisualReferenceOutput::asJsonObject() const {
    QJsonObject obj;
...
QList OAIVisualReferenceOutput::getBaseScreenshots() const {
    return m_base_screenshots;
}
void OAIVisualReferenceOutput::setBaseScreenshots(const QList &base_screenshots) {
    m_base_screenshots = base_screenshots;
    m_base_screenshots_isSet = true;
}

bool OAIVisualReferenceOutput::is_base_screenshots_Set() const{
    return m_base_screenshots_isSet;
}

bool OAIVisualReferenceOutput::is_base_screenshots_Valid() const{
    return m_base_screenshots_isValid;
}

QString OAIVisualReferenceOutput::getBaseCanaryRunId() const {
    return m_base_canary_run_id;
}
void OAIVisualReferenceOutput::setBaseCanaryRunId(const QString &base_canary_run_id) {
    m_base_canary_run_id = base_canary_run_id;
    m_base_canary_run_id_isSet = true;
}

bool OAIVisualReferenceOutput::is_base_canary_run_id_Set() const{
    return m_base_canary_run_id_isSet;
}

bool OAIVisualReferenceOutput::is_base_canary_run_id_Valid() const{
    return m_base_canary_run_id_isValid;
}

bool OAIVisualReferenceOutput::isSet() const {
...
bool OAIVisualReferenceOutput::isValid() const {
