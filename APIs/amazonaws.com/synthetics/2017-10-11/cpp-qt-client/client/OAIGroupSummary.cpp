...
QString OAIGroupSummary::getId() const {
    return m_id;
}
void OAIGroupSummary::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGroupSummary::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGroupSummary::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIGroupSummary::getName() const {
    return m_name;
}
void OAIGroupSummary::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIGroupSummary::is_name_Set() const{
    return m_name_isSet;
}

bool OAIGroupSummary::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIGroupSummary::getArn() const {
    return m_arn;
}
void OAIGroupSummary::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIGroupSummary::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIGroupSummary::is_arn_Valid() const{
