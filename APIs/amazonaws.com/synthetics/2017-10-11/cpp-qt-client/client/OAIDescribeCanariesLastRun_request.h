...
/*
 * OAIDescribeCanariesLastRun_request.h
 *
 * 
 */

#ifndef OAIDescribeCanariesLastRun_request_H
#define OAIDescribeCanariesLastRun_request_H
...
class OAIDescribeCanariesLastRun_request : public OAIObject {
public:
    OAIDescribeCanariesLastRun_request();
    OAIDescribeCanariesLastRun_request(QString json);
    ~OAIDescribeCanariesLastRun_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCanariesLastRun_request)

#endif // OAIDescribeCanariesLastRun_request_H
