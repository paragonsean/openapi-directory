...
OAICanaryStatus::OAICanaryStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICanaryStatus::OAICanaryStatus() {
    this->initializeModel();
}

OAICanaryStatus::~OAICanaryStatus() {}

void OAICanaryStatus::initializeModel() {
...
void OAICanaryStatus::fromJson(QString jsonString) {
...
void OAICanaryStatus::fromJsonObject(QJsonObject json) {
...
QString OAICanaryStatus::asJson() const {
...
QJsonObject OAICanaryStatus::asJsonObject() const {
    QJsonObject obj;
    if (m_state.isSet()) {
...
OAICanaryState OAICanaryStatus::getState() const {
    return m_state;
}
void OAICanaryStatus::setState(const OAICanaryState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAICanaryStatus::is_state_Set() const{
    return m_state_isSet;
}

bool OAICanaryStatus::is_state_Valid() const{
    return m_state_isValid;
}

QString OAICanaryStatus::getStateReason() const {
    return m_state_reason;
}
void OAICanaryStatus::setStateReason(const QString &state_reason) {
    m_state_reason = state_reason;
    m_state_reason_isSet = true;
}

bool OAICanaryStatus::is_state_reason_Set() const{
    return m_state_reason_isSet;
}

bool OAICanaryStatus::is_state_reason_Valid() const{
    return m_state_reason_isValid;
}

OAICanaryStateReasonCode OAICanaryStatus::getStateReasonCode() const {
    return m_state_reason_code;
}
void OAICanaryStatus::setStateReasonCode(const OAICanaryStateReasonCode &state_reason_code) {
    m_state_reason_code = state_reason_code;
    m_state_reason_code_isSet = true;
}

bool OAICanaryStatus::is_state_reason_code_Set() const{
    return m_state_reason_code_isSet;
}

bool OAICanaryStatus::is_state_reason_code_Valid() const{
    return m_state_reason_code_isValid;
}

bool OAICanaryStatus::isSet() const {
...
bool OAICanaryStatus::isValid() const {
