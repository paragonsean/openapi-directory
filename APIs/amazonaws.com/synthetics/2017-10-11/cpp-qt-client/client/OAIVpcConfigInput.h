...
#ifndef OAIVpcConfigInput_H
#define OAIVpcConfigInput_H
...
class OAIVpcConfigInput : public OAIObject {
public:
    OAIVpcConfigInput();
    OAIVpcConfigInput(QString json);
    ~OAIVpcConfigInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVpcConfigInput)

#endif // OAIVpcConfigInput_H
