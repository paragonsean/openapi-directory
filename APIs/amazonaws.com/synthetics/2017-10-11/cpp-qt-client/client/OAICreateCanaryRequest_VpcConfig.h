...
/*
 * OAICreateCanaryRequest_VpcConfig.h
 *
 * 
 */

#ifndef OAICreateCanaryRequest_VpcConfig_H
#define OAICreateCanaryRequest_VpcConfig_H
...
class OAICreateCanaryRequest_VpcConfig : public OAIObject {
public:
    OAICreateCanaryRequest_VpcConfig();
    OAICreateCanaryRequest_VpcConfig(QString json);
    ~OAICreateCanaryRequest_VpcConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCanaryRequest_VpcConfig)

#endif // OAICreateCanaryRequest_VpcConfig_H
