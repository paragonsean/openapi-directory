...
OAIGetCanaryRuns_request::OAIGetCanaryRuns_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetCanaryRuns_request::OAIGetCanaryRuns_request() {
    this->initializeModel();
}

OAIGetCanaryRuns_request::~OAIGetCanaryRuns_request() {}

void OAIGetCanaryRuns_request::initializeModel() {
...
void OAIGetCanaryRuns_request::fromJson(QString jsonString) {
...
void OAIGetCanaryRuns_request::fromJsonObject(QJsonObject json) {
...
QString OAIGetCanaryRuns_request::asJson() const {
...
QJsonObject OAIGetCanaryRuns_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetCanaryRuns_request::getNextToken() const {
    return m_next_token;
}
void OAIGetCanaryRuns_request::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIGetCanaryRuns_request::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIGetCanaryRuns_request::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIGetCanaryRuns_request::getMaxResults() const {
    return m_max_results;
}
void OAIGetCanaryRuns_request::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIGetCanaryRuns_request::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIGetCanaryRuns_request::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIGetCanaryRuns_request::isSet() const {
...
bool OAIGetCanaryRuns_request::isValid() const {
