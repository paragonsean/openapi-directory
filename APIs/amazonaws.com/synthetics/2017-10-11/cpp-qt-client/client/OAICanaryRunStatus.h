...
/*
 * OAICanaryRunStatus.h
 *
 * This structure contains the status information about a canary run.
 */

#ifndef OAICanaryRunStatus_H
#define OAICanaryRunStatus_H
...
class OAICanaryRunStatus : public OAIObject {
public:
    OAICanaryRunStatus();
    OAICanaryRunStatus(QString json);
    ~OAICanaryRunStatus() override;
    ...
    OAICanaryRunState getState() const;
    void setState(const OAICanaryRunState &state);
    ...
    OAICanaryRunStateReasonCode getStateReasonCode() const;
    void setStateReasonCode(const OAICanaryRunStateReasonCode &state_reason_code);
...
private:
    ...
    OAICanaryRunStateReasonCode m_state_reason_code;
...
Q_DECLARE_METATYPE(OpenAPI::OAICanaryRunStatus)

#endif // OAICanaryRunStatus_H
