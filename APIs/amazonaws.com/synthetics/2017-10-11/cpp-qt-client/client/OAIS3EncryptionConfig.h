...
#ifndef OAIS3EncryptionConfig_H
#define OAIS3EncryptionConfig_H
...
class OAIS3EncryptionConfig : public OAIObject {
public:
    OAIS3EncryptionConfig();
    OAIS3EncryptionConfig(QString json);
    ~OAIS3EncryptionConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIS3EncryptionConfig)

#endif // OAIS3EncryptionConfig_H
