...
/*
 * OAICreateCanary_request_ArtifactConfig.h
 *
 * A structure that contains the configuration for canary artifacts, including the encryption-at-rest settings for artifacts that the canary uploads to Amazon S3.
 */

#ifndef OAICreateCanary_request_ArtifactConfig_H
#define OAICreateCanary_request_ArtifactConfig_H
...
class OAICreateCanary_request_ArtifactConfig : public OAIObject {
public:
    OAICreateCanary_request_ArtifactConfig();
    OAICreateCanary_request_ArtifactConfig(QString json);
    ~OAICreateCanary_request_ArtifactConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCanary_request_ArtifactConfig)

#endif // OAICreateCanary_request_ArtifactConfig_H
