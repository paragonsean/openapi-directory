...
OAICreateCanary_request_Schedule::OAICreateCanary_request_Schedule(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateCanary_request_Schedule::OAICreateCanary_request_Schedule() {
    this->initializeModel();
}

OAICreateCanary_request_Schedule::~OAICreateCanary_request_Schedule() {}

void OAICreateCanary_request_Schedule::initializeModel() {
...
void OAICreateCanary_request_Schedule::fromJson(QString jsonString) {
...
void OAICreateCanary_request_Schedule::fromJsonObject(QJsonObject json) {
...
QString OAICreateCanary_request_Schedule::asJson() const {
...
QJsonObject OAICreateCanary_request_Schedule::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateCanary_request_Schedule::getExpression() const {
    return m_expression;
}
void OAICreateCanary_request_Schedule::setExpression(const QString &expression) {
    m_expression = expression;
    m_expression_isSet = true;
}

bool OAICreateCanary_request_Schedule::is_expression_Set() const{
    return m_expression_isSet;
}

bool OAICreateCanary_request_Schedule::is_expression_Valid() const{
    return m_expression_isValid;
}

qint32 OAICreateCanary_request_Schedule::getDurationInSeconds() const {
    return m_duration_in_seconds;
}
void OAICreateCanary_request_Schedule::setDurationInSeconds(const qint32 &duration_in_seconds) {
    m_duration_in_seconds = duration_in_seconds;
    m_duration_in_seconds_isSet = true;
}

bool OAICreateCanary_request_Schedule::is_duration_in_seconds_Set() const{
    return m_duration_in_seconds_isSet;
}

bool OAICreateCanary_request_Schedule::is_duration_in_seconds_Valid() const{
    return m_duration_in_seconds_isValid;
}

bool OAICreateCanary_request_Schedule::isSet() const {
...
bool OAICreateCanary_request_Schedule::isValid() const {
