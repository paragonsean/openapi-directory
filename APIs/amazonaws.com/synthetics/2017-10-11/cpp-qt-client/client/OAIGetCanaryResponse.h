...
/*
 * OAIGetCanaryResponse.h
 *
 * 
 */

#ifndef OAIGetCanaryResponse_H
#define OAIGetCanaryResponse_H
...
namespace OpenAPI {
class OAIGetCanaryResponse_Canary;

class OAIGetCanaryResponse : public OAIObject {
public:
    OAIGetCanaryResponse();
    OAIGetCanaryResponse(QString json);
    ~OAIGetCanaryResponse() override;
    ...
    OAIGetCanaryResponse_Canary getCanary() const;
    void setCanary(const OAIGetCanaryResponse_Canary &canary);
...
private:
    ...
    OAIGetCanaryResponse_Canary m_canary;
    bool m_canary_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCanaryResponse)

#endif // OAIGetCanaryResponse_H
