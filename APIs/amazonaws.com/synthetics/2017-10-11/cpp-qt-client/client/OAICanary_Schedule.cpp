...
OAICanary_Schedule::OAICanary_Schedule(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICanary_Schedule::OAICanary_Schedule() {
    this->initializeModel();
}

OAICanary_Schedule::~OAICanary_Schedule() {}

void OAICanary_Schedule::initializeModel() {
...
void OAICanary_Schedule::fromJson(QString jsonString) {
...
void OAICanary_Schedule::fromJsonObject(QJsonObject json) {
...
QString OAICanary_Schedule::asJson() const {
...
QJsonObject OAICanary_Schedule::asJsonObject() const {
    QJsonObject obj;
...
QString OAICanary_Schedule::getExpression() const {
    return m_expression;
}
void OAICanary_Schedule::setExpression(const QString &expression) {
    m_expression = expression;
    m_expression_isSet = true;
}

bool OAICanary_Schedule::is_expression_Set() const{
    return m_expression_isSet;
}

bool OAICanary_Schedule::is_expression_Valid() const{
    return m_expression_isValid;
}

qint32 OAICanary_Schedule::getDurationInSeconds() const {
    return m_duration_in_seconds;
}
void OAICanary_Schedule::setDurationInSeconds(const qint32 &duration_in_seconds) {
    m_duration_in_seconds = duration_in_seconds;
    m_duration_in_seconds_isSet = true;
}

bool OAICanary_Schedule::is_duration_in_seconds_Set() const{
    return m_duration_in_seconds_isSet;
}

bool OAICanary_Schedule::is_duration_in_seconds_Valid() const{
    return m_duration_in_seconds_isValid;
}

bool OAICanary_Schedule::isSet() const {
...
bool OAICanary_Schedule::isValid() const {
