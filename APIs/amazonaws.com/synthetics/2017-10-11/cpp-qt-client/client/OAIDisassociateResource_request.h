...
/*
 * OAIDisassociateResource_request.h
 *
 * 
 */

#ifndef OAIDisassociateResource_request_H
#define OAIDisassociateResource_request_H
...
class OAIDisassociateResource_request : public OAIObject {
public:
    OAIDisassociateResource_request();
    OAIDisassociateResource_request(QString json);
    ~OAIDisassociateResource_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateResource_request)

#endif // OAIDisassociateResource_request_H
