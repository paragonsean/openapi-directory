...
/*
 * OAIDescribeCanaries_request.h
 *
 * 
 */

#ifndef OAIDescribeCanaries_request_H
#define OAIDescribeCanaries_request_H
...
class OAIDescribeCanaries_request : public OAIObject {
public:
    OAIDescribeCanaries_request();
    OAIDescribeCanaries_request(QString json);
    ~OAIDescribeCanaries_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCanaries_request)

#endif // OAIDescribeCanaries_request_H
