...
/*
 * OAICanary_Schedule.h
 *
 * 
 */

#ifndef OAICanary_Schedule_H
#define OAICanary_Schedule_H
...
class OAICanary_Schedule : public OAIObject {
public:
    OAICanary_Schedule();
    OAICanary_Schedule(QString json);
    ~OAICanary_Schedule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICanary_Schedule)

#endif // OAICanary_Schedule_H
