...
OAICreateCanaryRequest_RunConfig::OAICreateCanaryRequest_RunConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateCanaryRequest_RunConfig::OAICreateCanaryRequest_RunConfig() {
    this->initializeModel();
}

OAICreateCanaryRequest_RunConfig::~OAICreateCanaryRequest_RunConfig() {}

void OAICreateCanaryRequest_RunConfig::initializeModel() {
...
void OAICreateCanaryRequest_RunConfig::fromJson(QString jsonString) {
...
void OAICreateCanaryRequest_RunConfig::fromJsonObject(QJsonObject json) {
...
QString OAICreateCanaryRequest_RunConfig::asJson() const {
...
QJsonObject OAICreateCanaryRequest_RunConfig::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAICreateCanaryRequest_RunConfig::getTimeoutInSeconds() const {
    return m_timeout_in_seconds;
}
void OAICreateCanaryRequest_RunConfig::setTimeoutInSeconds(const qint32 &timeout_in_seconds) {
    m_timeout_in_seconds = timeout_in_seconds;
    m_timeout_in_seconds_isSet = true;
}

bool OAICreateCanaryRequest_RunConfig::is_timeout_in_seconds_Set() const{
    return m_timeout_in_seconds_isSet;
}

bool OAICreateCanaryRequest_RunConfig::is_timeout_in_seconds_Valid() const{
    return m_timeout_in_seconds_isValid;
}

qint32 OAICreateCanaryRequest_RunConfig::getMemoryInMb() const {
    return m_memory_in_mb;
}
void OAICreateCanaryRequest_RunConfig::setMemoryInMb(const qint32 &memory_in_mb) {
    m_memory_in_mb = memory_in_mb;
    m_memory_in_mb_isSet = true;
}

bool OAICreateCanaryRequest_RunConfig::is_memory_in_mb_Set() const{
    return m_memory_in_mb_isSet;
}

bool OAICreateCanaryRequest_RunConfig::is_memory_in_mb_Valid() const{
    return m_memory_in_mb_isValid;
}

bool OAICreateCanaryRequest_RunConfig::getActiveTracing() const {
    return m_active_tracing;
}
void OAICreateCanaryRequest_RunConfig::setActiveTracing(const bool &active_tracing) {
    m_active_tracing = active_tracing;
    m_active_tracing_isSet = true;
}

bool OAICreateCanaryRequest_RunConfig::is_active_tracing_Set() const{
    return m_active_tracing_isSet;
}

bool OAICreateCanaryRequest_RunConfig::is_active_tracing_Valid() const{
    return m_active_tracing_isValid;
}

QMap OAICreateCanaryRequest_RunConfig::getEnvironmentVariables() const {
    return m_environment_variables;
}
void OAICreateCanaryRequest_RunConfig::setEnvironmentVariables(const QMap &environment_variables) {
    m_environment_variables = environment_variables;
    m_environment_variables_isSet = true;
}

bool OAICreateCanaryRequest_RunConfig::is_environment_variables_Set() const{
    return m_environment_variables_isSet;
}

bool OAICreateCanaryRequest_RunConfig::is_environment_variables_Valid() const{
    return m_environment_variables_isValid;
}

bool OAICreateCanaryRequest_RunConfig::isSet() const {
...
bool OAICreateCanaryRequest_RunConfig::isValid() const {
