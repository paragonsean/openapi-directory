...
#include "OAIDescribeCanariesRequest.h"
...
OAIDescribeCanariesRequest::OAIDescribeCanariesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeCanariesRequest::OAIDescribeCanariesRequest() {
    this->initializeModel();
}

OAIDescribeCanariesRequest::~OAIDescribeCanariesRequest() {}

void OAIDescribeCanariesRequest::initializeModel() {
...
void OAIDescribeCanariesRequest::fromJson(QString jsonString) {
...
void OAIDescribeCanariesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeCanariesRequest::asJson() const {
...
QJsonObject OAIDescribeCanariesRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeCanariesRequest::getNextToken() const {
    return m_next_token;
}
void OAIDescribeCanariesRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeCanariesRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeCanariesRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIDescribeCanariesRequest::getMaxResults() const {
    return m_max_results;
}
void OAIDescribeCanariesRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIDescribeCanariesRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIDescribeCanariesRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QList OAIDescribeCanariesRequest::getNames() const {
    return m_names;
}
void OAIDescribeCanariesRequest::setNames(const QList &names) {
    m_names = names;
    m_names_isSet = true;
}

bool OAIDescribeCanariesRequest::is_names_Set() const{
    return m_names_isSet;
}

bool OAIDescribeCanariesRequest::is_names_Valid() const{
    return m_names_isValid;
}

bool OAIDescribeCanariesRequest::isSet() const {
...
bool OAIDescribeCanariesRequest::isValid() const {
