...
#ifndef OAICanaryStatus_H
#define OAICanaryStatus_H
...
class OAICanaryStatus : public OAIObject {
public:
    OAICanaryStatus();
    OAICanaryStatus(QString json);
    ~OAICanaryStatus() override;
    ...
    OAICanaryState getState() const;
    void setState(const OAICanaryState &state);
    ...
    OAICanaryStateReasonCode getStateReasonCode() const;
    void setStateReasonCode(const OAICanaryStateReasonCode &state_reason_code);
...
private:
    ...
    OAICanaryStateReasonCode m_state_reason_code;
...
Q_DECLARE_METATYPE(OpenAPI::OAICanaryStatus)

#endif // OAICanaryStatus_H
