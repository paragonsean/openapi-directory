...
#ifndef OAIVisualReferenceInput_H
#define OAIVisualReferenceInput_H
...
class OAIVisualReferenceInput : public OAIObject {
public:
    OAIVisualReferenceInput();
    OAIVisualReferenceInput(QString json);
    ~OAIVisualReferenceInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVisualReferenceInput)

#endif // OAIVisualReferenceInput_H
