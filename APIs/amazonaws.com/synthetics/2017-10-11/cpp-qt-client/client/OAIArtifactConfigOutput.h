...
/*
 * OAIArtifactConfigOutput.h
 *
 * A structure that contains the configuration for canary artifacts, including the encryption-at-rest settings for artifacts that the canary uploads to Amazon S3.
 */

#ifndef OAIArtifactConfigOutput_H
#define OAIArtifactConfigOutput_H
...
class OAIArtifactConfigOutput : public OAIObject {
public:
    OAIArtifactConfigOutput();
    OAIArtifactConfigOutput(QString json);
    ~OAIArtifactConfigOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIArtifactConfigOutput)

#endif // OAIArtifactConfigOutput_H
