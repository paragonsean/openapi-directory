...
/*
 * OAIUpdateCanaryRequest_RunConfig.h
 *
 * 
 */

#ifndef OAIUpdateCanaryRequest_RunConfig_H
#define OAIUpdateCanaryRequest_RunConfig_H
...
class OAIUpdateCanaryRequest_RunConfig : public OAIObject {
public:
    OAIUpdateCanaryRequest_RunConfig();
    OAIUpdateCanaryRequest_RunConfig(QString json);
    ~OAIUpdateCanaryRequest_RunConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateCanaryRequest_RunConfig)

#endif // OAIUpdateCanaryRequest_RunConfig_H
