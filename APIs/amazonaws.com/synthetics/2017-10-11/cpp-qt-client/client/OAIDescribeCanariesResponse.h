...
/*
 * OAIDescribeCanariesResponse.h
 *
 * 
 */

#ifndef OAIDescribeCanariesResponse_H
#define OAIDescribeCanariesResponse_H
...
class OAIDescribeCanariesResponse : public OAIObject {
public:
    OAIDescribeCanariesResponse();
    OAIDescribeCanariesResponse(QString json);
    ~OAIDescribeCanariesResponse() override;
    ...
    QList getCanaries() const;
    void setCanaries(const QList &canaries);
    bool is_canaries_Set() const;
    bool is_canaries_Valid() const;
...
private:
    ...
    QList m_canaries;
    bool m_canaries_isSet;
    bool m_canaries_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCanariesResponse)

#endif // OAIDescribeCanariesResponse_H
