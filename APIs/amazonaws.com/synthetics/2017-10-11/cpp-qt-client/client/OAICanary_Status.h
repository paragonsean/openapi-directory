...
#ifndef OAICanary_Status_H
#define OAICanary_Status_H
...
class OAICanary_Status : public OAIObject {
public:
    OAICanary_Status();
    OAICanary_Status(QString json);
    ~OAICanary_Status() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICanary_Status)

#endif // OAICanary_Status_H
