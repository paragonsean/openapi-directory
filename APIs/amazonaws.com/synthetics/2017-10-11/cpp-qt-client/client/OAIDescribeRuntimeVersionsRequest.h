...
/*
 * OAIDescribeRuntimeVersionsRequest.h
 *
 * 
 */

#ifndef OAIDescribeRuntimeVersionsRequest_H
#define OAIDescribeRuntimeVersionsRequest_H
...
class OAIDescribeRuntimeVersionsRequest : public OAIObject {
public:
    OAIDescribeRuntimeVersionsRequest();
    OAIDescribeRuntimeVersionsRequest(QString json);
    ~OAIDescribeRuntimeVersionsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeRuntimeVersionsRequest)

#endif // OAIDescribeRuntimeVersionsRequest_H
