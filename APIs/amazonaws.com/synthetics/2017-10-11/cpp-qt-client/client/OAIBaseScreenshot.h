...
#ifndef OAIBaseScreenshot_H
#define OAIBaseScreenshot_H
...
class OAIBaseScreenshot : public OAIObject {
public:
    OAIBaseScreenshot();
    OAIBaseScreenshot(QString json);
    ~OAIBaseScreenshot() override;
    ...
    void setScreenshotName(const QString &screenshot_name);
    bool is_screenshot_name_Set() const;
    bool is_screenshot_name_Valid() const;

    QList getIgnoreCoordinates() const;
    void setIgnoreCoordinates(const QList &ignore_coordinates);
    bool is_ignore_coordinates_Set() const;
    bool is_ignore_coordinates_Valid() const;
...
private:
    ...
    QString m_screenshot_name;
    bool m_screenshot_name_isSet;
    bool m_screenshot_name_isValid;

    QList m_ignore_coordinates;
    bool m_ignore_coordinates_isSet;
    bool m_ignore_coordinates_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIBaseScreenshot)

#endif // OAIBaseScreenshot_H
