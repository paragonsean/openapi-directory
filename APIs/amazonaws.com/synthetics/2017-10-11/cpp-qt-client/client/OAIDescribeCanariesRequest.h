...
/*
 * OAIDescribeCanariesRequest.h
 *
 * 
 */

#ifndef OAIDescribeCanariesRequest_H
#define OAIDescribeCanariesRequest_H
...
class OAIDescribeCanariesRequest : public OAIObject {
public:
    OAIDescribeCanariesRequest();
    OAIDescribeCanariesRequest(QString json);
    ~OAIDescribeCanariesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCanariesRequest)

#endif // OAIDescribeCanariesRequest_H
