...
#ifndef OAICanaryRunState_H
#define OAICanaryRunState_H
...
class OAICanaryRunState : public OAIEnum {
public:
    OAICanaryRunState();
    OAICanaryRunState(QString json);
    ~OAICanaryRunState() override;
    ...
    enum class eOAICanaryRunState {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        RUNNING, 
        PASSED, 
        FAILED
    };
    OAICanaryRunState::eOAICanaryRunState getValue() const;
    void setValue(const OAICanaryRunState::eOAICanaryRunState& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAICanaryRunState)

#endif // OAICanaryRunState_H
