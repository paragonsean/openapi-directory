...
/*
 * OAICreateCanaryRequest_RunConfig.h
 *
 * 
 */

#ifndef OAICreateCanaryRequest_RunConfig_H
#define OAICreateCanaryRequest_RunConfig_H
...
class OAICreateCanaryRequest_RunConfig : public OAIObject {
public:
    OAICreateCanaryRequest_RunConfig();
    OAICreateCanaryRequest_RunConfig(QString json);
    ~OAICreateCanaryRequest_RunConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCanaryRequest_RunConfig)

#endif // OAICreateCanaryRequest_RunConfig_H
