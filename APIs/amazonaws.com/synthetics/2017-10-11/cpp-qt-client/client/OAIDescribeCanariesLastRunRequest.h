...
/*
 * OAIDescribeCanariesLastRunRequest.h
 *
 * 
 */

#ifndef OAIDescribeCanariesLastRunRequest_H
#define OAIDescribeCanariesLastRunRequest_H
...
class OAIDescribeCanariesLastRunRequest : public OAIObject {
public:
    OAIDescribeCanariesLastRunRequest();
    OAIDescribeCanariesLastRunRequest(QString json);
    ~OAIDescribeCanariesLastRunRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCanariesLastRunRequest)

#endif // OAIDescribeCanariesLastRunRequest_H
