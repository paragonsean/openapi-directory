...
/*
 * OAIGetCanaryRunsRequest.h
 *
 * 
 */

#ifndef OAIGetCanaryRunsRequest_H
#define OAIGetCanaryRunsRequest_H
...
class OAIGetCanaryRunsRequest : public OAIObject {
public:
    OAIGetCanaryRunsRequest();
    OAIGetCanaryRunsRequest(QString json);
    ~OAIGetCanaryRunsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCanaryRunsRequest)

#endif // OAIGetCanaryRunsRequest_H
