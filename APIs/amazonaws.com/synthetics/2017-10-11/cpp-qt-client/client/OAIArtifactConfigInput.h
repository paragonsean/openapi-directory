...
/*
 * OAIArtifactConfigInput.h
 *
 * A structure that contains the configuration for canary artifacts, including the encryption-at-rest settings for artifacts that the canary uploads to Amazon S3.
 */

#ifndef OAIArtifactConfigInput_H
#define OAIArtifactConfigInput_H
...
class OAIArtifactConfigInput : public OAIObject {
public:
    OAIArtifactConfigInput();
    OAIArtifactConfigInput(QString json);
    ~OAIArtifactConfigInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIArtifactConfigInput)

#endif // OAIArtifactConfigInput_H
