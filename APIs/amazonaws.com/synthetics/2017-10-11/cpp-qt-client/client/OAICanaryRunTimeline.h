...
/*
 * OAICanaryRunTimeline.h
 *
 * This structure contains the start and end times of a single canary run.
 */

#ifndef OAICanaryRunTimeline_H
#define OAICanaryRunTimeline_H
...
class OAICanaryRunTimeline : public OAIObject {
public:
    OAICanaryRunTimeline();
    OAICanaryRunTimeline(QString json);
    ~OAICanaryRunTimeline() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICanaryRunTimeline)

#endif // OAICanaryRunTimeline_H
