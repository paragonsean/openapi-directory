...
/*
 * OAICanaryRunConfigInput.h
 *
 * A structure that contains input information for a canary run.
 */

#ifndef OAICanaryRunConfigInput_H
#define OAICanaryRunConfigInput_H
...
class OAICanaryRunConfigInput : public OAIObject {
public:
    OAICanaryRunConfigInput();
    OAICanaryRunConfigInput(QString json);
    ~OAICanaryRunConfigInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICanaryRunConfigInput)

#endif // OAICanaryRunConfigInput_H
