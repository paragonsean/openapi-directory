...
/*
 * OAIDescribeRuntimeVersions_request.h
 *
 * 
 */

#ifndef OAIDescribeRuntimeVersions_request_H
#define OAIDescribeRuntimeVersions_request_H
...
class OAIDescribeRuntimeVersions_request : public OAIObject {
public:
    OAIDescribeRuntimeVersions_request();
    OAIDescribeRuntimeVersions_request(QString json);
    ~OAIDescribeRuntimeVersions_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeRuntimeVersions_request)

#endif // OAIDescribeRuntimeVersions_request_H
