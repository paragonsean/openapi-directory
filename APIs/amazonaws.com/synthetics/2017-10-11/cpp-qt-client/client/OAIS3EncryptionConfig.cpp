...
#include "OAIS3EncryptionConfig.h"
...
OAIS3EncryptionConfig::OAIS3EncryptionConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIS3EncryptionConfig::OAIS3EncryptionConfig() {
    this->initializeModel();
}

OAIS3EncryptionConfig::~OAIS3EncryptionConfig() {}

void OAIS3EncryptionConfig::initializeModel() {
...
void OAIS3EncryptionConfig::fromJson(QString jsonString) {
...
void OAIS3EncryptionConfig::fromJsonObject(QJsonObject json) {
...
QString OAIS3EncryptionConfig::asJson() const {
...
QJsonObject OAIS3EncryptionConfig::asJsonObject() const {
    QJsonObject obj;
...
OAIEncryptionMode OAIS3EncryptionConfig::getEncryptionMode() const {
    return m_encryption_mode;
}
void OAIS3EncryptionConfig::setEncryptionMode(const OAIEncryptionMode &encryption_mode) {
    m_encryption_mode = encryption_mode;
    m_encryption_mode_isSet = true;
}

bool OAIS3EncryptionConfig::is_encryption_mode_Set() const{
    return m_encryption_mode_isSet;
}

bool OAIS3EncryptionConfig::is_encryption_mode_Valid() const{
    return m_encryption_mode_isValid;
}

QString OAIS3EncryptionConfig::getKmsKeyArn() const {
    return m_kms_key_arn;
}
void OAIS3EncryptionConfig::setKmsKeyArn(const QString &kms_key_arn) {
    m_kms_key_arn = kms_key_arn;
    m_kms_key_arn_isSet = true;
}

bool OAIS3EncryptionConfig::is_kms_key_arn_Set() const{
    return m_kms_key_arn_isSet;
}

bool OAIS3EncryptionConfig::is_kms_key_arn_Valid() const{
    return m_kms_key_arn_isValid;
}

bool OAIS3EncryptionConfig::isSet() const {
...
bool OAIS3EncryptionConfig::isValid() const {
