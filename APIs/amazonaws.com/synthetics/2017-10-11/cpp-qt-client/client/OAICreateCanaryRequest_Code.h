...
/*
 * OAICreateCanaryRequest_Code.h
 *
 * 
 */

#ifndef OAICreateCanaryRequest_Code_H
#define OAICreateCanaryRequest_Code_H
...
class OAICreateCanaryRequest_Code : public OAIObject {
public:
    OAICreateCanaryRequest_Code();
    OAICreateCanaryRequest_Code(QString json);
    ~OAICreateCanaryRequest_Code() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCanaryRequest_Code)

#endif // OAICreateCanaryRequest_Code_H
