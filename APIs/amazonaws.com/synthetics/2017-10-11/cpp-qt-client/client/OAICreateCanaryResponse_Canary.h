...
/*
 * OAICreateCanaryResponse_Canary.h
 *
 * 
 */

#ifndef OAICreateCanaryResponse_Canary_H
#define OAICreateCanaryResponse_Canary_H
...
class OAICreateCanaryResponse_Canary : public OAIObject {
public:
    OAICreateCanaryResponse_Canary();
    OAICreateCanaryResponse_Canary(QString json);
    ~OAICreateCanaryResponse_Canary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCanaryResponse_Canary)

#endif // OAICreateCanaryResponse_Canary_H
