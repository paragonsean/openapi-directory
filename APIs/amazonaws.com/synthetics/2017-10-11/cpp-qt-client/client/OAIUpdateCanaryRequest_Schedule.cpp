...
OAIUpdateCanaryRequest_Schedule::OAIUpdateCanaryRequest_Schedule(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateCanaryRequest_Schedule::OAIUpdateCanaryRequest_Schedule() {
    this->initializeModel();
}

OAIUpdateCanaryRequest_Schedule::~OAIUpdateCanaryRequest_Schedule() {}

void OAIUpdateCanaryRequest_Schedule::initializeModel() {
...
void OAIUpdateCanaryRequest_Schedule::fromJson(QString jsonString) {
...
void OAIUpdateCanaryRequest_Schedule::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateCanaryRequest_Schedule::asJson() const {
...
QJsonObject OAIUpdateCanaryRequest_Schedule::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateCanaryRequest_Schedule::getExpression() const {
    return m_expression;
}
void OAIUpdateCanaryRequest_Schedule::setExpression(const QString &expression) {
    m_expression = expression;
    m_expression_isSet = true;
}

bool OAIUpdateCanaryRequest_Schedule::is_expression_Set() const{
    return m_expression_isSet;
}

bool OAIUpdateCanaryRequest_Schedule::is_expression_Valid() const{
    return m_expression_isValid;
}

qint32 OAIUpdateCanaryRequest_Schedule::getDurationInSeconds() const {
    return m_duration_in_seconds;
}
void OAIUpdateCanaryRequest_Schedule::setDurationInSeconds(const qint32 &duration_in_seconds) {
    m_duration_in_seconds = duration_in_seconds;
    m_duration_in_seconds_isSet = true;
}

bool OAIUpdateCanaryRequest_Schedule::is_duration_in_seconds_Set() const{
    return m_duration_in_seconds_isSet;
}

bool OAIUpdateCanaryRequest_Schedule::is_duration_in_seconds_Valid() const{
    return m_duration_in_seconds_isValid;
}

bool OAIUpdateCanaryRequest_Schedule::isSet() const {
...
bool OAIUpdateCanaryRequest_Schedule::isValid() const {
