...
#include "OAIGetCanaryRunsRequest.h"
...
OAIGetCanaryRunsRequest::OAIGetCanaryRunsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetCanaryRunsRequest::OAIGetCanaryRunsRequest() {
    this->initializeModel();
}

OAIGetCanaryRunsRequest::~OAIGetCanaryRunsRequest() {}

void OAIGetCanaryRunsRequest::initializeModel() {
...
void OAIGetCanaryRunsRequest::fromJson(QString jsonString) {
...
void OAIGetCanaryRunsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetCanaryRunsRequest::asJson() const {
...
QJsonObject OAIGetCanaryRunsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetCanaryRunsRequest::getNextToken() const {
    return m_next_token;
}
void OAIGetCanaryRunsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIGetCanaryRunsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIGetCanaryRunsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIGetCanaryRunsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIGetCanaryRunsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIGetCanaryRunsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIGetCanaryRunsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIGetCanaryRunsRequest::isSet() const {
...
bool OAIGetCanaryRunsRequest::isValid() const {
