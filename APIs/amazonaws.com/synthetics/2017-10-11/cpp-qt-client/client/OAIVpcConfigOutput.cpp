...
OAIVpcConfigOutput::OAIVpcConfigOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVpcConfigOutput::OAIVpcConfigOutput() {
    this->initializeModel();
}

OAIVpcConfigOutput::~OAIVpcConfigOutput() {}

void OAIVpcConfigOutput::initializeModel() {
...
void OAIVpcConfigOutput::fromJson(QString jsonString) {
...
void OAIVpcConfigOutput::fromJsonObject(QJsonObject json) {
...
QString OAIVpcConfigOutput::asJson() const {
...
QJsonObject OAIVpcConfigOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_vpc_id_isSet) {
...
QString OAIVpcConfigOutput::getVpcId() const {
    return m_vpc_id;
}
void OAIVpcConfigOutput::setVpcId(const QString &vpc_id) {
    m_vpc_id = vpc_id;
    m_vpc_id_isSet = true;
}

bool OAIVpcConfigOutput::is_vpc_id_Set() const{
    return m_vpc_id_isSet;
}

bool OAIVpcConfigOutput::is_vpc_id_Valid() const{
    return m_vpc_id_isValid;
}

QList OAIVpcConfigOutput::getSubnetIds() const {
    return m_subnet_ids;
}
void OAIVpcConfigOutput::setSubnetIds(const QList &subnet_ids) {
    m_subnet_ids = subnet_ids;
    m_subnet_ids_isSet = true;
}

bool OAIVpcConfigOutput::is_subnet_ids_Set() const{
    return m_subnet_ids_isSet;
}

bool OAIVpcConfigOutput::is_subnet_ids_Valid() const{
    return m_subnet_ids_isValid;
}

QList OAIVpcConfigOutput::getSecurityGroupIds() const {
    return m_security_group_ids;
}
void OAIVpcConfigOutput::setSecurityGroupIds(const QList &security_group_ids) {
    m_security_group_ids = security_group_ids;
    m_security_group_ids_isSet = true;
}

bool OAIVpcConfigOutput::is_security_group_ids_Set() const{
    return m_security_group_ids_isSet;
}

bool OAIVpcConfigOutput::is_security_group_ids_Valid() const{
    return m_security_group_ids_isValid;
}

bool OAIVpcConfigOutput::isSet() const {
...
bool OAIVpcConfigOutput::isValid() const {
