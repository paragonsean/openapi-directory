...
OAICreateCanary_request_ArtifactConfig::OAICreateCanary_request_ArtifactConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateCanary_request_ArtifactConfig::OAICreateCanary_request_ArtifactConfig() {
    this->initializeModel();
}

OAICreateCanary_request_ArtifactConfig::~OAICreateCanary_request_ArtifactConfig() {}

void OAICreateCanary_request_ArtifactConfig::initializeModel() {

    m_s3_encryption_isSet = false;
    m_s3_encryption_isValid = false;
}

void OAICreateCanary_request_ArtifactConfig::fromJson(QString jsonString) {
...
void OAICreateCanary_request_ArtifactConfig::fromJsonObject(QJsonObject json) {
...
QString OAICreateCanary_request_ArtifactConfig::asJson() const {
...
QJsonObject OAICreateCanary_request_ArtifactConfig::asJsonObject() const {
    QJsonObject obj;
...
OAICreateCanary_request_ArtifactConfig_S3Encryption OAICreateCanary_request_ArtifactConfig::getS3Encryption() const {
    return m_s3_encryption;
}
void OAICreateCanary_request_ArtifactConfig::setS3Encryption(const OAICreateCanary_request_ArtifactConfig_S3Encryption &s3_encryption) {
    m_s3_encryption = s3_encryption;
    m_s3_encryption_isSet = true;
}

bool OAICreateCanary_request_ArtifactConfig::is_s3_encryption_Set() const{
    return m_s3_encryption_isSet;
}

bool OAICreateCanary_request_ArtifactConfig::is_s3_encryption_Valid() const{
    return m_s3_encryption_isValid;
}

bool OAICreateCanary_request_ArtifactConfig::isSet() const {
...
bool OAICreateCanary_request_ArtifactConfig::isValid() const {
