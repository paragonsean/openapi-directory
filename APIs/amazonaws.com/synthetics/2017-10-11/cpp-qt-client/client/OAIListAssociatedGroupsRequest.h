...
/*
 * OAIListAssociatedGroupsRequest.h
 *
 * 
 */

#ifndef OAIListAssociatedGroupsRequest_H
#define OAIListAssociatedGroupsRequest_H
...
class OAIListAssociatedGroupsRequest : public OAIObject {
public:
    OAIListAssociatedGroupsRequest();
    OAIListAssociatedGroupsRequest(QString json);
    ~OAIListAssociatedGroupsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAssociatedGroupsRequest)

#endif // OAIListAssociatedGroupsRequest_H
