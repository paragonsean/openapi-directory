...
/*
 * OAICreateCanary_request_Schedule.h
 *
 * This structure specifies how often a canary is to make runs and the date and time when it should stop making runs.
 */

#ifndef OAICreateCanary_request_Schedule_H
#define OAICreateCanary_request_Schedule_H
...
class OAICreateCanary_request_Schedule : public OAIObject {
public:
    OAICreateCanary_request_Schedule();
    OAICreateCanary_request_Schedule(QString json);
    ~OAICreateCanary_request_Schedule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCanary_request_Schedule)

#endif // OAICreateCanary_request_Schedule_H
