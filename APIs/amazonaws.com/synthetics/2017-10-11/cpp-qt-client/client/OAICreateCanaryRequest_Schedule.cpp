...
OAICreateCanaryRequest_Schedule::OAICreateCanaryRequest_Schedule(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateCanaryRequest_Schedule::OAICreateCanaryRequest_Schedule() {
    this->initializeModel();
}

OAICreateCanaryRequest_Schedule::~OAICreateCanaryRequest_Schedule() {}

void OAICreateCanaryRequest_Schedule::initializeModel() {
...
void OAICreateCanaryRequest_Schedule::fromJson(QString jsonString) {
...
void OAICreateCanaryRequest_Schedule::fromJsonObject(QJsonObject json) {
...
QString OAICreateCanaryRequest_Schedule::asJson() const {
...
QJsonObject OAICreateCanaryRequest_Schedule::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateCanaryRequest_Schedule::getExpression() const {
    return m_expression;
}
void OAICreateCanaryRequest_Schedule::setExpression(const QString &expression) {
    m_expression = expression;
    m_expression_isSet = true;
}

bool OAICreateCanaryRequest_Schedule::is_expression_Set() const{
    return m_expression_isSet;
}

bool OAICreateCanaryRequest_Schedule::is_expression_Valid() const{
    return m_expression_isValid;
}

qint32 OAICreateCanaryRequest_Schedule::getDurationInSeconds() const {
    return m_duration_in_seconds;
}
void OAICreateCanaryRequest_Schedule::setDurationInSeconds(const qint32 &duration_in_seconds) {
    m_duration_in_seconds = duration_in_seconds;
    m_duration_in_seconds_isSet = true;
}

bool OAICreateCanaryRequest_Schedule::is_duration_in_seconds_Set() const{
    return m_duration_in_seconds_isSet;
}

bool OAICreateCanaryRequest_Schedule::is_duration_in_seconds_Valid() const{
    return m_duration_in_seconds_isValid;
}

bool OAICreateCanaryRequest_Schedule::isSet() const {
...
bool OAICreateCanaryRequest_Schedule::isValid() const {
