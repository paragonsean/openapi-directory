...
OAICanary_ArtifactConfig::OAICanary_ArtifactConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICanary_ArtifactConfig::OAICanary_ArtifactConfig() {
    this->initializeModel();
}

OAICanary_ArtifactConfig::~OAICanary_ArtifactConfig() {}

void OAICanary_ArtifactConfig::initializeModel() {

    m_s3_encryption_isSet = false;
    m_s3_encryption_isValid = false;
}

void OAICanary_ArtifactConfig::fromJson(QString jsonString) {
...
void OAICanary_ArtifactConfig::fromJsonObject(QJsonObject json) {
...
QString OAICanary_ArtifactConfig::asJson() const {
...
QJsonObject OAICanary_ArtifactConfig::asJsonObject() const {
    QJsonObject obj;
...
OAIArtifactConfigOutput_S3Encryption OAICanary_ArtifactConfig::getS3Encryption() const {
    return m_s3_encryption;
}
void OAICanary_ArtifactConfig::setS3Encryption(const OAIArtifactConfigOutput_S3Encryption &s3_encryption) {
    m_s3_encryption = s3_encryption;
    m_s3_encryption_isSet = true;
}

bool OAICanary_ArtifactConfig::is_s3_encryption_Set() const{
    return m_s3_encryption_isSet;
}

bool OAICanary_ArtifactConfig::is_s3_encryption_Valid() const{
    return m_s3_encryption_isValid;
}

bool OAICanary_ArtifactConfig::isSet() const {
...
bool OAICanary_ArtifactConfig::isValid() const {
