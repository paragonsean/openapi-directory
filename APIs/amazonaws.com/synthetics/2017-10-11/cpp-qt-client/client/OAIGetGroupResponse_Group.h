...
/*
 * OAIGetGroupResponse_Group.h
 *
 * 
 */

#ifndef OAIGetGroupResponse_Group_H
#define OAIGetGroupResponse_Group_H
...
class OAIGetGroupResponse_Group : public OAIObject {
public:
    OAIGetGroupResponse_Group();
    OAIGetGroupResponse_Group(QString json);
    ~OAIGetGroupResponse_Group() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetGroupResponse_Group)

#endif // OAIGetGroupResponse_Group_H
