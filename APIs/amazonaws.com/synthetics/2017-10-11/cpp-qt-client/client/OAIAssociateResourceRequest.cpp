...
#include "OAIAssociateResourceRequest.h"
...
OAIAssociateResourceRequest::OAIAssociateResourceRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssociateResourceRequest::OAIAssociateResourceRequest() {
    this->initializeModel();
}

OAIAssociateResourceRequest::~OAIAssociateResourceRequest() {}

void OAIAssociateResourceRequest::initializeModel() {

    m_resource_arn_isSet = false;
    m_resource_arn_isValid = false;
}

void OAIAssociateResourceRequest::fromJson(QString jsonString) {
...
void OAIAssociateResourceRequest::fromJsonObject(QJsonObject json) {

    m_resource_arn_isValid = ::OpenAPI::fromJsonValue(m_resource_arn, json[QString("ResourceArn")]);
    m_resource_arn_isSet = !json[QString("ResourceArn")].isNull() && m_resource_arn_isValid;
}

QString OAIAssociateResourceRequest::asJson() const {
...
QJsonObject OAIAssociateResourceRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAssociateResourceRequest::getResourceArn() const {
    return m_resource_arn;
}
void OAIAssociateResourceRequest::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAIAssociateResourceRequest::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAIAssociateResourceRequest::is_resource_arn_Valid() const{
    return m_resource_arn_isValid;
}

bool OAIAssociateResourceRequest::isSet() const {
...
bool OAIAssociateResourceRequest::isValid() const {
