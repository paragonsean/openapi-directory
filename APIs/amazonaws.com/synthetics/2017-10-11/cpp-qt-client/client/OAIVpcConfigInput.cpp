...
OAIVpcConfigInput::OAIVpcConfigInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVpcConfigInput::OAIVpcConfigInput() {
    this->initializeModel();
}

OAIVpcConfigInput::~OAIVpcConfigInput() {}

void OAIVpcConfigInput::initializeModel() {
...
void OAIVpcConfigInput::fromJson(QString jsonString) {
...
void OAIVpcConfigInput::fromJsonObject(QJsonObject json) {
...
QString OAIVpcConfigInput::asJson() const {
...
QJsonObject OAIVpcConfigInput::asJsonObject() const {
    QJsonObject obj;
...
QList OAIVpcConfigInput::getSubnetIds() const {
    return m_subnet_ids;
}
void OAIVpcConfigInput::setSubnetIds(const QList &subnet_ids) {
    m_subnet_ids = subnet_ids;
    m_subnet_ids_isSet = true;
}

bool OAIVpcConfigInput::is_subnet_ids_Set() const{
    return m_subnet_ids_isSet;
}

bool OAIVpcConfigInput::is_subnet_ids_Valid() const{
    return m_subnet_ids_isValid;
}

QList OAIVpcConfigInput::getSecurityGroupIds() const {
    return m_security_group_ids;
}
void OAIVpcConfigInput::setSecurityGroupIds(const QList &security_group_ids) {
    m_security_group_ids = security_group_ids;
    m_security_group_ids_isSet = true;
}

bool OAIVpcConfigInput::is_security_group_ids_Set() const{
    return m_security_group_ids_isSet;
}

bool OAIVpcConfigInput::is_security_group_ids_Valid() const{
    return m_security_group_ids_isValid;
}

bool OAIVpcConfigInput::isSet() const {
...
bool OAIVpcConfigInput::isValid() const {
