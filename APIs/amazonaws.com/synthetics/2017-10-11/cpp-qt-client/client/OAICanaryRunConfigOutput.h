...
/*
 * OAICanaryRunConfigOutput.h
 *
 * A structure that contains information about a canary run.
 */

#ifndef OAICanaryRunConfigOutput_H
#define OAICanaryRunConfigOutput_H
...
class OAICanaryRunConfigOutput : public OAIObject {
public:
    OAICanaryRunConfigOutput();
    OAICanaryRunConfigOutput(QString json);
    ~OAICanaryRunConfigOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICanaryRunConfigOutput)

#endif // OAICanaryRunConfigOutput_H
