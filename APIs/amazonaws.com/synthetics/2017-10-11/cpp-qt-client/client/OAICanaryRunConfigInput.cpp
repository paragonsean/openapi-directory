...
#include "OAICanaryRunConfigInput.h"
...
OAICanaryRunConfigInput::OAICanaryRunConfigInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICanaryRunConfigInput::OAICanaryRunConfigInput() {
    this->initializeModel();
}

OAICanaryRunConfigInput::~OAICanaryRunConfigInput() {}

void OAICanaryRunConfigInput::initializeModel() {
...
void OAICanaryRunConfigInput::fromJson(QString jsonString) {
...
void OAICanaryRunConfigInput::fromJsonObject(QJsonObject json) {
...
QString OAICanaryRunConfigInput::asJson() const {
...
QJsonObject OAICanaryRunConfigInput::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAICanaryRunConfigInput::getTimeoutInSeconds() const {
    return m_timeout_in_seconds;
}
void OAICanaryRunConfigInput::setTimeoutInSeconds(const qint32 &timeout_in_seconds) {
    m_timeout_in_seconds = timeout_in_seconds;
    m_timeout_in_seconds_isSet = true;
}

bool OAICanaryRunConfigInput::is_timeout_in_seconds_Set() const{
    return m_timeout_in_seconds_isSet;
}

bool OAICanaryRunConfigInput::is_timeout_in_seconds_Valid() const{
    return m_timeout_in_seconds_isValid;
}

qint32 OAICanaryRunConfigInput::getMemoryInMb() const {
    return m_memory_in_mb;
}
void OAICanaryRunConfigInput::setMemoryInMb(const qint32 &memory_in_mb) {
    m_memory_in_mb = memory_in_mb;
    m_memory_in_mb_isSet = true;
}

bool OAICanaryRunConfigInput::is_memory_in_mb_Set() const{
    return m_memory_in_mb_isSet;
}

bool OAICanaryRunConfigInput::is_memory_in_mb_Valid() const{
    return m_memory_in_mb_isValid;
}

bool OAICanaryRunConfigInput::getActiveTracing() const {
    return m_active_tracing;
}
void OAICanaryRunConfigInput::setActiveTracing(const bool &active_tracing) {
    m_active_tracing = active_tracing;
    m_active_tracing_isSet = true;
}

bool OAICanaryRunConfigInput::is_active_tracing_Set() const{
    return m_active_tracing_isSet;
}

bool OAICanaryRunConfigInput::is_active_tracing_Valid() const{
    return m_active_tracing_isValid;
}

QMap OAICanaryRunConfigInput::getEnvironmentVariables() const {
    return m_environment_variables;
}
void OAICanaryRunConfigInput::setEnvironmentVariables(const QMap &environment_variables) {
    m_environment_variables = environment_variables;
    m_environment_variables_isSet = true;
}

bool OAICanaryRunConfigInput::is_environment_variables_Set() const{
    return m_environment_variables_isSet;
}

bool OAICanaryRunConfigInput::is_environment_variables_Valid() const{
    return m_environment_variables_isValid;
}

bool OAICanaryRunConfigInput::isSet() const {
...
bool OAICanaryRunConfigInput::isValid() const {
