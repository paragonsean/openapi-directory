...
/*
 * OAICanaryScheduleInput.h
 *
 * This structure specifies how often a canary is to make runs and the date and time when it should stop making runs.
 */

#ifndef OAICanaryScheduleInput_H
#define OAICanaryScheduleInput_H
...
class OAICanaryScheduleInput : public OAIObject {
public:
    OAICanaryScheduleInput();
    OAICanaryScheduleInput(QString json);
    ~OAICanaryScheduleInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICanaryScheduleInput)

#endif // OAICanaryScheduleInput_H
