...
#include "OAIArtifactConfigOutput.h"
...
OAIArtifactConfigOutput::OAIArtifactConfigOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIArtifactConfigOutput::OAIArtifactConfigOutput() {
    this->initializeModel();
}

OAIArtifactConfigOutput::~OAIArtifactConfigOutput() {}

void OAIArtifactConfigOutput::initializeModel() {

    m_s3_encryption_isSet = false;
    m_s3_encryption_isValid = false;
}

void OAIArtifactConfigOutput::fromJson(QString jsonString) {
...
void OAIArtifactConfigOutput::fromJsonObject(QJsonObject json) {
...
QString OAIArtifactConfigOutput::asJson() const {
...
QJsonObject OAIArtifactConfigOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIArtifactConfigOutput_S3Encryption OAIArtifactConfigOutput::getS3Encryption() const {
    return m_s3_encryption;
}
void OAIArtifactConfigOutput::setS3Encryption(const OAIArtifactConfigOutput_S3Encryption &s3_encryption) {
    m_s3_encryption = s3_encryption;
    m_s3_encryption_isSet = true;
}

bool OAIArtifactConfigOutput::is_s3_encryption_Set() const{
    return m_s3_encryption_isSet;
}

bool OAIArtifactConfigOutput::is_s3_encryption_Valid() const{
    return m_s3_encryption_isValid;
}

bool OAIArtifactConfigOutput::isSet() const {
...
bool OAIArtifactConfigOutput::isValid() const {
