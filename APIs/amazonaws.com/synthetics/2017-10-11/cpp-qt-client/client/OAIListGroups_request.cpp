...
OAIListGroups_request::OAIListGroups_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListGroups_request::OAIListGroups_request() {
    this->initializeModel();
}

OAIListGroups_request::~OAIListGroups_request() {}

void OAIListGroups_request::initializeModel() {
...
void OAIListGroups_request::fromJson(QString jsonString) {
...
void OAIListGroups_request::fromJsonObject(QJsonObject json) {
...
QString OAIListGroups_request::asJson() const {
...
QJsonObject OAIListGroups_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListGroups_request::getNextToken() const {
    return m_next_token;
}
void OAIListGroups_request::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListGroups_request::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListGroups_request::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListGroups_request::getMaxResults() const {
    return m_max_results;
}
void OAIListGroups_request::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListGroups_request::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListGroups_request::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListGroups_request::isSet() const {
...
bool OAIListGroups_request::isValid() const {
