...
/*
 * OAICanaryRun_Status.h
 *
 * 
 */

#ifndef OAICanaryRun_Status_H
#define OAICanaryRun_Status_H
...
class OAICanaryRun_Status : public OAIObject {
public:
    OAICanaryRun_Status();
    OAICanaryRun_Status(QString json);
    ~OAICanaryRun_Status() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICanaryRun_Status)

#endif // OAICanaryRun_Status_H
