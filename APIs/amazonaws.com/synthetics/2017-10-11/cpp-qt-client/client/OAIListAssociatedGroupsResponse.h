...
/*
 * OAIListAssociatedGroupsResponse.h
 *
 * 
 */

#ifndef OAIListAssociatedGroupsResponse_H
#define OAIListAssociatedGroupsResponse_H
...
class OAIListAssociatedGroupsResponse : public OAIObject {
public:
    OAIListAssociatedGroupsResponse();
    OAIListAssociatedGroupsResponse(QString json);
    ~OAIListAssociatedGroupsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAssociatedGroupsResponse)

#endif // OAIListAssociatedGroupsResponse_H
