...
/*
 * OAICanary_ArtifactConfig.h
 *
 * 
 */

#ifndef OAICanary_ArtifactConfig_H
#define OAICanary_ArtifactConfig_H
...
namespace OpenAPI {
class OAIArtifactConfigOutput_S3Encryption;

class OAICanary_ArtifactConfig : public OAIObject {
public:
    OAICanary_ArtifactConfig();
    OAICanary_ArtifactConfig(QString json);
    ~OAICanary_ArtifactConfig() override;
    ...
    OAIArtifactConfigOutput_S3Encryption getS3Encryption() const;
    void setS3Encryption(const OAIArtifactConfigOutput_S3Encryption &s3_encryption);
...
private:
    ...
    OAIArtifactConfigOutput_S3Encryption m_s3_encryption;
...
Q_DECLARE_METATYPE(OpenAPI::OAICanary_ArtifactConfig)

#endif // OAICanary_ArtifactConfig_H
