...
QMap OAIGroup::getTags() const {
    return m_tags;
}
void OAIGroup::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIGroup::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIGroup::is_tags_Valid() const{
    return m_tags_isValid;
}

QDateTime OAIGroup::getCreatedTime() const {
    return m_created_time;
}
void OAIGroup::setCreatedTime(const QDateTime &created_time) {
...
QDateTime OAIGroup::getLastModifiedTime() const {
    return m_last_modified_time;
}
void OAIGroup::setLastModifiedTime(const QDateTime &last_modified_time) {
    m_last_modified_time = last_modified_time;
    m_last_modified_time_isSet = true;
}

bool OAIGroup::is_last_modified_time_Set() const{
    return m_last_modified_time_isSet;
}

bool OAIGroup::is_last_modified_time_Valid() const{
