...
/*
 * OAIDescribeRuntimeVersionsResponse.h
 *
 * 
 */

#ifndef OAIDescribeRuntimeVersionsResponse_H
#define OAIDescribeRuntimeVersionsResponse_H
...
class OAIDescribeRuntimeVersionsResponse : public OAIObject {
public:
    OAIDescribeRuntimeVersionsResponse();
    OAIDescribeRuntimeVersionsResponse(QString json);
    ~OAIDescribeRuntimeVersionsResponse() override;
    ...
    QList getRuntimeVersions() const;
    void setRuntimeVersions(const QList &runtime_versions);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeRuntimeVersionsResponse)

#endif // OAIDescribeRuntimeVersionsResponse_H
