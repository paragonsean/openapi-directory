...
#ifndef OAIVisualReferenceOutput_H
#define OAIVisualReferenceOutput_H
...
class OAIVisualReferenceOutput : public OAIObject {
public:
    OAIVisualReferenceOutput();
    OAIVisualReferenceOutput(QString json);
    ~OAIVisualReferenceOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVisualReferenceOutput)

#endif // OAIVisualReferenceOutput_H
