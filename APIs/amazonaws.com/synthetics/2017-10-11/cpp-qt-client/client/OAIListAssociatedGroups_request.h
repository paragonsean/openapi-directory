...
/*
 * OAIListAssociatedGroups_request.h
 *
 * 
 */

#ifndef OAIListAssociatedGroups_request_H
#define OAIListAssociatedGroups_request_H
...
class OAIListAssociatedGroups_request : public OAIObject {
public:
    OAIListAssociatedGroups_request();
    OAIListAssociatedGroups_request(QString json);
    ~OAIListAssociatedGroups_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAssociatedGroups_request)

#endif // OAIListAssociatedGroups_request_H
