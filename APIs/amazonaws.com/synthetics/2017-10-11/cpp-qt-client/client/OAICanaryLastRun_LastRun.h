...
/*
 * OAICanaryLastRun_LastRun.h
 *
 * 
 */

#ifndef OAICanaryLastRun_LastRun_H
#define OAICanaryLastRun_LastRun_H
...
class OAICanaryLastRun_LastRun : public OAIObject {
public:
    OAICanaryLastRun_LastRun();
    OAICanaryLastRun_LastRun(QString json);
    ~OAICanaryLastRun_LastRun() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICanaryLastRun_LastRun)

#endif // OAICanaryLastRun_LastRun_H
