...
/*
 * OAICreateCanary_request_ArtifactConfig_S3Encryption.h
 *
 * 
 */

#ifndef OAICreateCanary_request_ArtifactConfig_S3Encryption_H
#define OAICreateCanary_request_ArtifactConfig_S3Encryption_H
...
class OAICreateCanary_request_ArtifactConfig_S3Encryption : public OAIObject {
public:
    OAICreateCanary_request_ArtifactConfig_S3Encryption();
    OAICreateCanary_request_ArtifactConfig_S3Encryption(QString json);
    ~OAICreateCanary_request_ArtifactConfig_S3Encryption() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCanary_request_ArtifactConfig_S3Encryption)

#endif // OAICreateCanary_request_ArtifactConfig_S3Encryption_H
