...
public class CanaryRunConfigOutput {
  ...
  public CanaryRunConfigOutput timeoutInSeconds(Integer timeoutInSeconds) {
  ...
  public CanaryRunConfigOutput memoryInMB(Integer memoryInMB) {
  ...
  public CanaryRunConfigOutput activeTracing(Boolean activeTracing) {
  ...
  public boolean equals(Object o) {
    ...
    CanaryRunConfigOutput canaryRunConfigOutput = (CanaryRunConfigOutput) o;
    return Objects.equals(this.timeoutInSeconds, canaryRunConfigOutput.timeoutInSeconds) &&
        Objects.equals(this.memoryInMB, canaryRunConfigOutput.memoryInMB) &&
        Objects.equals(this.activeTracing, canaryRunConfigOutput.activeTracing);
  }

  @Override
  public int hashCode() {
    return Objects.hash(timeoutInSeconds, memoryInMB, activeTracing);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CanaryRunConfigOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CanaryRunConfigOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CanaryRunConfigOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CanaryRunConfigOutput is not found in the empty JSON string", CanaryRunConfigOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CanaryRunConfigOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CanaryRunConfigOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CanaryRunConfigOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CanaryRunConfigOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CanaryRunConfigOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CanaryRunConfigOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<CanaryRunConfigOutput>() {
           @Override
           public void write(JsonWriter out, CanaryRunConfigOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CanaryRunConfigOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CanaryRunConfigOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CanaryRunConfigOutput
   * @throws IOException if the JSON string is invalid with respect to CanaryRunConfigOutput
   */
  public static CanaryRunConfigOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CanaryRunConfigOutput.class);
  }

  /**
   * Convert an instance of CanaryRunConfigOutput to an JSON string
   *
   * @return JSON string
   */
