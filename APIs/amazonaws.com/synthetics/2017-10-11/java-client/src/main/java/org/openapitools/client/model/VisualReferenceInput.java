...
public class VisualReferenceInput {
  ...
  public VisualReferenceInput() {
  }

  public VisualReferenceInput baseScreenshots(List baseScreenshots) {
  ...
  public VisualReferenceInput baseCanaryRunId(String baseCanaryRunId) {
  ...
  public boolean equals(Object o) {
    ...
    VisualReferenceInput visualReferenceInput = (VisualReferenceInput) o;
    return Objects.equals(this.baseScreenshots, visualReferenceInput.baseScreenshots) &&
        Objects.equals(this.baseCanaryRunId, visualReferenceInput.baseCanaryRunId);
  }
  ...
  public String toString() {
    ...
    sb.append("class VisualReferenceInput {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("BaseCanaryRunId");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to VisualReferenceInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VisualReferenceInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VisualReferenceInput is not found in the empty JSON string", VisualReferenceInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VisualReferenceInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VisualReferenceInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VisualReferenceInput.openapiRequiredFields) {
      ...
      // validate the required field `BaseCanaryRunId`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VisualReferenceInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VisualReferenceInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VisualReferenceInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VisualReferenceInput.class));

       return (TypeAdapter<T>) new TypeAdapter<VisualReferenceInput>() {
           @Override
           public void write(JsonWriter out, VisualReferenceInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VisualReferenceInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VisualReferenceInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VisualReferenceInput
   * @throws IOException if the JSON string is invalid with respect to VisualReferenceInput
   */
  public static VisualReferenceInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VisualReferenceInput.class);
  }

  /**
   * Convert an instance of VisualReferenceInput to an JSON string
   *
   * @return JSON string
   */
