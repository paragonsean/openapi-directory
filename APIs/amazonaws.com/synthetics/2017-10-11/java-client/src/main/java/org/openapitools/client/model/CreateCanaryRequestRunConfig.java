...
public class CreateCanaryRequestRunConfig {
  ...
  public CreateCanaryRequestRunConfig() {
  }

  public CreateCanaryRequestRunConfig timeoutInSeconds(Integer timeoutInSeconds) {
  ...
  public CreateCanaryRequestRunConfig memoryInMB(Integer memoryInMB) {
  ...
  public CreateCanaryRequestRunConfig activeTracing(Boolean activeTracing) {
  ...
  public CreateCanaryRequestRunConfig environmentVariables(Map environmentVariables) {
  ...
  public boolean equals(Object o) {
    ...
    CreateCanaryRequestRunConfig createCanaryRequestRunConfig = (CreateCanaryRequestRunConfig) o;
    return Objects.equals(this.timeoutInSeconds, createCanaryRequestRunConfig.timeoutInSeconds) &&
        Objects.equals(this.memoryInMB, createCanaryRequestRunConfig.memoryInMB) &&
        Objects.equals(this.activeTracing, createCanaryRequestRunConfig.activeTracing) &&
        Objects.equals(this.environmentVariables, createCanaryRequestRunConfig.environmentVariables);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateCanaryRequestRunConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateCanaryRequestRunConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCanaryRequestRunConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateCanaryRequestRunConfig is not found in the empty JSON string", CreateCanaryRequestRunConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateCanaryRequestRunConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateCanaryRequestRunConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateCanaryRequestRunConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateCanaryRequestRunConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateCanaryRequestRunConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateCanaryRequestRunConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateCanaryRequestRunConfig>() {
           @Override
           public void write(JsonWriter out, CreateCanaryRequestRunConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateCanaryRequestRunConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateCanaryRequestRunConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateCanaryRequestRunConfig
   * @throws IOException if the JSON string is invalid with respect to CreateCanaryRequestRunConfig
   */
  public static CreateCanaryRequestRunConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCanaryRequestRunConfig.class);
  }

  /**
   * Convert an instance of CreateCanaryRequestRunConfig to an JSON string
   *
   * @return JSON string
   */
