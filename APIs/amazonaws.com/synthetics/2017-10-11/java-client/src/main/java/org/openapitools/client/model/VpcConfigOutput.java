...
public class VpcConfigOutput {
  ...
  public VpcConfigOutput vpcId(String vpcId) {
    this.vpcId = vpcId;
    return this;
  }
  ...
  public VpcConfigOutput subnetIds(List subnetIds) {
  ...
  public VpcConfigOutput securityGroupIds(List securityGroupIds) {
  ...
  public boolean equals(Object o) {
    ...
    VpcConfigOutput vpcConfigOutput = (VpcConfigOutput) o;
    return Objects.equals(this.vpcId, vpcConfigOutput.vpcId) &&
        Objects.equals(this.subnetIds, vpcConfigOutput.subnetIds) &&
        Objects.equals(this.securityGroupIds, vpcConfigOutput.securityGroupIds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(vpcId, subnetIds, securityGroupIds);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VpcConfigOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VpcConfigOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VpcConfigOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VpcConfigOutput is not found in the empty JSON string", VpcConfigOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VpcConfigOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VpcConfigOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VpcConfigOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VpcConfigOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VpcConfigOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VpcConfigOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<VpcConfigOutput>() {
           @Override
           public void write(JsonWriter out, VpcConfigOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VpcConfigOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VpcConfigOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VpcConfigOutput
   * @throws IOException if the JSON string is invalid with respect to VpcConfigOutput
   */
  public static VpcConfigOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VpcConfigOutput.class);
  }

  /**
   * Convert an instance of VpcConfigOutput to an JSON string
   *
   * @return JSON string
   */
