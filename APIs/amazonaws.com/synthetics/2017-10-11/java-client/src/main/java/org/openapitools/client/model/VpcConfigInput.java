...
public class VpcConfigInput {
  ...
  public VpcConfigInput() {
  }

  public VpcConfigInput subnetIds(List subnetIds) {
  ...
  public VpcConfigInput securityGroupIds(List securityGroupIds) {
  ...
  public boolean equals(Object o) {
    ...
    VpcConfigInput vpcConfigInput = (VpcConfigInput) o;
    return Objects.equals(this.subnetIds, vpcConfigInput.subnetIds) &&
        Objects.equals(this.securityGroupIds, vpcConfigInput.securityGroupIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class VpcConfigInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VpcConfigInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VpcConfigInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VpcConfigInput is not found in the empty JSON string", VpcConfigInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VpcConfigInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VpcConfigInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VpcConfigInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VpcConfigInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VpcConfigInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VpcConfigInput.class));

       return (TypeAdapter<T>) new TypeAdapter<VpcConfigInput>() {
           @Override
           public void write(JsonWriter out, VpcConfigInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VpcConfigInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VpcConfigInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VpcConfigInput
   * @throws IOException if the JSON string is invalid with respect to VpcConfigInput
   */
  public static VpcConfigInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VpcConfigInput.class);
  }

  /**
   * Convert an instance of VpcConfigInput to an JSON string
   *
   * @return JSON string
   */
