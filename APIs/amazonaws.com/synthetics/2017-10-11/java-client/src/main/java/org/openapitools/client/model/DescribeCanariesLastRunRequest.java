...
public class DescribeCanariesLastRunRequest {
  ...
  public DescribeCanariesLastRunRequest() {
  }

  public DescribeCanariesLastRunRequest nextToken(String nextToken) {
  ...
  public DescribeCanariesLastRunRequest maxResults(Integer maxResults) {
  ...
  public DescribeCanariesLastRunRequest names(List<String> names) {
    this.names = names;
    return this;
  }

  public DescribeCanariesLastRunRequest addNamesItem(String namesItem) {
    if (this.names == null) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeCanariesLastRunRequest describeCanariesLastRunRequest = (DescribeCanariesLastRunRequest) o;
    return Objects.equals(this.nextToken, describeCanariesLastRunRequest.nextToken) &&
        Objects.equals(this.maxResults, describeCanariesLastRunRequest.maxResults) &&
        Objects.equals(this.names, describeCanariesLastRunRequest.names);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nextToken, maxResults, names);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeCanariesLastRunRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeCanariesLastRunRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeCanariesLastRunRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeCanariesLastRunRequest is not found in the empty JSON string", DescribeCanariesLastRunRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeCanariesLastRunRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeCanariesLastRunRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeCanariesLastRunRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeCanariesLastRunRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeCanariesLastRunRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeCanariesLastRunRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeCanariesLastRunRequest>() {
           @Override
           public void write(JsonWriter out, DescribeCanariesLastRunRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeCanariesLastRunRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeCanariesLastRunRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeCanariesLastRunRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeCanariesLastRunRequest
   */
  public static DescribeCanariesLastRunRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeCanariesLastRunRequest.class);
  }

  /**
   * Convert an instance of DescribeCanariesLastRunRequest to an JSON string
   *
   * @return JSON string
   */
