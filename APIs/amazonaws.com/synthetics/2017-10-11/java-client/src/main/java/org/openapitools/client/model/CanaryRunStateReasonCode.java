...
/**
 * Gets or Sets CanaryRunStateReasonCode
 */
@JsonAdapter(CanaryRunStateReasonCode.Adapter.class)
public enum CanaryRunStateReasonCode {
  ...
  CanaryRunStateReasonCode(String value) {
    this.value = value;
  }
  ...
  public static CanaryRunStateReasonCode fromValue(String value) {
    for (CanaryRunStateReasonCode b : CanaryRunStateReasonCode.values()) {
  ...
  public static class Adapter extends TypeAdapter<CanaryRunStateReasonCode> {
    @Override
    public void write(final JsonWriter jsonWriter, final CanaryRunStateReasonCode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CanaryRunStateReasonCode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CanaryRunStateReasonCode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    CanaryRunStateReasonCode.fromValue(value);
  }
}
