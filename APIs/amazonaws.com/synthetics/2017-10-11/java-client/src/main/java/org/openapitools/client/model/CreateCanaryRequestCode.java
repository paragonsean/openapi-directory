...
public class CreateCanaryRequestCode {
  ...
  public CreateCanaryRequestCode() {
  }

  public CreateCanaryRequestCode s3Bucket(String s3Bucket) {
  ...
  public CreateCanaryRequestCode s3Key(String s3Key) {
    this.s3Key = s3Key;
    return this;
  }
  ...
  public CreateCanaryRequestCode s3Version(String s3Version) {
  ...
  public CreateCanaryRequestCode zipFile(String zipFile) {
  ...
  public CreateCanaryRequestCode handler(String handler) {
  ...
  public boolean equals(Object o) {
    ...
    CreateCanaryRequestCode createCanaryRequestCode = (CreateCanaryRequestCode) o;
    return Objects.equals(this.s3Bucket, createCanaryRequestCode.s3Bucket) &&
        Objects.equals(this.s3Key, createCanaryRequestCode.s3Key) &&
        Objects.equals(this.s3Version, createCanaryRequestCode.s3Version) &&
        Objects.equals(this.zipFile, createCanaryRequestCode.zipFile) &&
        Objects.equals(this.handler, createCanaryRequestCode.handler);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateCanaryRequestCode {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateCanaryRequestCode
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCanaryRequestCode.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateCanaryRequestCode is not found in the empty JSON string", CreateCanaryRequestCode.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateCanaryRequestCode.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateCanaryRequestCode` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateCanaryRequestCode.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateCanaryRequestCode.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateCanaryRequestCode' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateCanaryRequestCode> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateCanaryRequestCode.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateCanaryRequestCode>() {
           @Override
           public void write(JsonWriter out, CreateCanaryRequestCode value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateCanaryRequestCode read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateCanaryRequestCode given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateCanaryRequestCode
   * @throws IOException if the JSON string is invalid with respect to CreateCanaryRequestCode
   */
  public static CreateCanaryRequestCode fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCanaryRequestCode.class);
  }

  /**
   * Convert an instance of CreateCanaryRequestCode to an JSON string
   *
   * @return JSON string
   */
