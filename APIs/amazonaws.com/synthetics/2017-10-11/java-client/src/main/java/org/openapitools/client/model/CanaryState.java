...
/**
 * Gets or Sets CanaryState
 */
@JsonAdapter(CanaryState.Adapter.class)
public enum CanaryState {
  ...
  public static CanaryState fromValue(String value) {
    for (CanaryState b : CanaryState.values()) {
  ...
  public static class Adapter extends TypeAdapter<CanaryState> {
    @Override
    public void write(final JsonWriter jsonWriter, final CanaryState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CanaryState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CanaryState.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    CanaryState.fromValue(value);
  }
}
