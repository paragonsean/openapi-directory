...
public class DescribeCanariesRequest {
  ...
  public DescribeCanariesRequest() {
  }

  public DescribeCanariesRequest nextToken(String nextToken) {
  ...
  public DescribeCanariesRequest maxResults(Integer maxResults) {
  ...
  public DescribeCanariesRequest names(List<String> names) {
    this.names = names;
    return this;
  }

  public DescribeCanariesRequest addNamesItem(String namesItem) {
    if (this.names == null) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeCanariesRequest describeCanariesRequest = (DescribeCanariesRequest) o;
    return Objects.equals(this.nextToken, describeCanariesRequest.nextToken) &&
        Objects.equals(this.maxResults, describeCanariesRequest.maxResults) &&
        Objects.equals(this.names, describeCanariesRequest.names);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeCanariesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeCanariesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeCanariesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeCanariesRequest is not found in the empty JSON string", DescribeCanariesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeCanariesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeCanariesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeCanariesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeCanariesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeCanariesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeCanariesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeCanariesRequest>() {
           @Override
           public void write(JsonWriter out, DescribeCanariesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeCanariesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeCanariesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeCanariesRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeCanariesRequest
   */
  public static DescribeCanariesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeCanariesRequest.class);
  }

  /**
   * Convert an instance of DescribeCanariesRequest to an JSON string
   *
   * @return JSON string
   */
