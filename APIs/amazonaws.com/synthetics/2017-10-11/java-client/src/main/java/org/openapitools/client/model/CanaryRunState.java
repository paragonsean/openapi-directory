...
/**
 * Gets or Sets CanaryRunState
 */
@JsonAdapter(CanaryRunState.Adapter.class)
public enum CanaryRunState {
  ...
  public static CanaryRunState fromValue(String value) {
    for (CanaryRunState b : CanaryRunState.values()) {
  ...
  public static class Adapter extends TypeAdapter<CanaryRunState> {
    @Override
    public void write(final JsonWriter jsonWriter, final CanaryRunState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CanaryRunState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CanaryRunState.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    CanaryRunState.fromValue(value);
  }
}
