...
public class CanaryLastRunLastRun {
  ...
  public CanaryLastRunLastRun() {
  }

  public CanaryLastRunLastRun id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CanaryLastRunLastRun name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CanaryLastRunLastRun status(CanaryRunStatus status) {
    this.status = status;
    return this;
  }
  ...
  public CanaryLastRunLastRun timeline(CanaryRunTimeline timeline) {
  ...
  public CanaryLastRunLastRun artifactS3Location(String artifactS3Location) {
  ...
  public boolean equals(Object o) {
    ...
    CanaryLastRunLastRun canaryLastRunLastRun = (CanaryLastRunLastRun) o;
    return Objects.equals(this.id, canaryLastRunLastRun.id) &&
        Objects.equals(this.name, canaryLastRunLastRun.name) &&
        Objects.equals(this.status, canaryLastRunLastRun.status) &&
        Objects.equals(this.timeline, canaryLastRunLastRun.timeline) &&
        Objects.equals(this.artifactS3Location, canaryLastRunLastRun.artifactS3Location);
  }
  ...
  public String toString() {
    ...
    sb.append("class CanaryLastRunLastRun {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CanaryLastRunLastRun
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CanaryLastRunLastRun.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CanaryLastRunLastRun is not found in the empty JSON string", CanaryLastRunLastRun.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CanaryLastRunLastRun.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CanaryLastRunLastRun` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CanaryLastRunLastRun.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CanaryLastRunLastRun' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CanaryLastRunLastRun> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CanaryLastRunLastRun.class));

       return (TypeAdapter<T>) new TypeAdapter<CanaryLastRunLastRun>() {
           @Override
           public void write(JsonWriter out, CanaryLastRunLastRun value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CanaryLastRunLastRun read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CanaryLastRunLastRun given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CanaryLastRunLastRun
   * @throws IOException if the JSON string is invalid with respect to CanaryLastRunLastRun
   */
  public static CanaryLastRunLastRun fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CanaryLastRunLastRun.class);
  }

  /**
   * Convert an instance of CanaryLastRunLastRun to an JSON string
   *
   * @return JSON string
   */
