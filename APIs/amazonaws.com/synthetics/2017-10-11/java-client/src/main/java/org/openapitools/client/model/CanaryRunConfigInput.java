...
public class CanaryRunConfigInput {
  ...
  public CanaryRunConfigInput() {
  }

  public CanaryRunConfigInput timeoutInSeconds(Integer timeoutInSeconds) {
  ...
  public CanaryRunConfigInput memoryInMB(Integer memoryInMB) {
  ...
  public CanaryRunConfigInput activeTracing(Boolean activeTracing) {
  ...
  public CanaryRunConfigInput environmentVariables(Map environmentVariables) {
  ...
  public boolean equals(Object o) {
    ...
    CanaryRunConfigInput canaryRunConfigInput = (CanaryRunConfigInput) o;
    return Objects.equals(this.timeoutInSeconds, canaryRunConfigInput.timeoutInSeconds) &&
        Objects.equals(this.memoryInMB, canaryRunConfigInput.memoryInMB) &&
        Objects.equals(this.activeTracing, canaryRunConfigInput.activeTracing) &&
        Objects.equals(this.environmentVariables, canaryRunConfigInput.environmentVariables);
  }
  ...
  public String toString() {
    ...
    sb.append("class CanaryRunConfigInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CanaryRunConfigInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CanaryRunConfigInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CanaryRunConfigInput is not found in the empty JSON string", CanaryRunConfigInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CanaryRunConfigInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CanaryRunConfigInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CanaryRunConfigInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CanaryRunConfigInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CanaryRunConfigInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CanaryRunConfigInput.class));

       return (TypeAdapter<T>) new TypeAdapter<CanaryRunConfigInput>() {
           @Override
           public void write(JsonWriter out, CanaryRunConfigInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CanaryRunConfigInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CanaryRunConfigInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CanaryRunConfigInput
   * @throws IOException if the JSON string is invalid with respect to CanaryRunConfigInput
   */
  public static CanaryRunConfigInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CanaryRunConfigInput.class);
  }

  /**
   * Convert an instance of CanaryRunConfigInput to an JSON string
   *
   * @return JSON string
   */
