...
public class CanaryVisualReference {
  ...
  public CanaryVisualReference baseScreenshots(List baseScreenshots) {
  ...
  public CanaryVisualReference baseCanaryRunId(String baseCanaryRunId) {
  ...
  public boolean equals(Object o) {
    ...
    CanaryVisualReference canaryVisualReference = (CanaryVisualReference) o;
    return Objects.equals(this.baseScreenshots, canaryVisualReference.baseScreenshots) &&
        Objects.equals(this.baseCanaryRunId, canaryVisualReference.baseCanaryRunId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CanaryVisualReference {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CanaryVisualReference
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CanaryVisualReference.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CanaryVisualReference is not found in the empty JSON string", CanaryVisualReference.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CanaryVisualReference.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CanaryVisualReference` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CanaryVisualReference.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CanaryVisualReference' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CanaryVisualReference> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CanaryVisualReference.class));

       return (TypeAdapter<T>) new TypeAdapter<CanaryVisualReference>() {
           @Override
           public void write(JsonWriter out, CanaryVisualReference value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CanaryVisualReference read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CanaryVisualReference given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CanaryVisualReference
   * @throws IOException if the JSON string is invalid with respect to CanaryVisualReference
   */
  public static CanaryVisualReference fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CanaryVisualReference.class);
  }

  /**
   * Convert an instance of CanaryVisualReference to an JSON string
   *
   * @return JSON string
   */
