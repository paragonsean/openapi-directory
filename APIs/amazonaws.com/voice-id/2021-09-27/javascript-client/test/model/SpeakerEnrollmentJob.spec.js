...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVoiceId.SpeakerEnrollmentJob();
  });
  ...
  describe('SpeakerEnrollmentJob', function() {
    it('should create an instance of SpeakerEnrollmentJob', function() {
      // uncomment below and update the code to test SpeakerEnrollmentJob
      //var instance = new AmazonVoiceId.SpeakerEnrollmentJob();
      //expect(instance).to.be.a(AmazonVoiceId.SpeakerEnrollmentJob);
    });
