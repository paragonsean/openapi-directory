...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVoiceId.ListFraudstersRequest();
  });
  ...
  describe('ListFraudstersRequest', function() {
    it('should create an instance of ListFraudstersRequest', function() {
      // uncomment below and update the code to test ListFraudstersRequest
      //var instance = new AmazonVoiceId.ListFraudstersRequest();
      //expect(instance).to.be.a(AmazonVoiceId.ListFraudstersRequest);
    });
