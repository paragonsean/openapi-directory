...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVoiceId.DescribeFraudsterRegistrationJobResponseJob();
  });
  ...
  describe('DescribeFraudsterRegistrationJobResponseJob', function() {
    it('should create an instance of DescribeFraudsterRegistrationJobResponseJob', function() {
      // uncomment below and update the code to test DescribeFraudsterRegistrationJobResponseJob
      //var instance = new AmazonVoiceId.DescribeFraudsterRegistrationJobResponseJob();
      //expect(instance).to.be.a(AmazonVoiceId.DescribeFraudsterRegistrationJobResponseJob);
    });
