...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVoiceId.ListSpeakersRequest();
  });
  ...
  describe('ListSpeakersRequest', function() {
    it('should create an instance of ListSpeakersRequest', function() {
      // uncomment below and update the code to test ListSpeakersRequest
      //var instance = new AmazonVoiceId.ListSpeakersRequest();
      //expect(instance).to.be.a(AmazonVoiceId.ListSpeakersRequest);
    });
