...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVoiceId.DescribeSpeakerEnrollmentJobResponseJob();
  });
  ...
  describe('DescribeSpeakerEnrollmentJobResponseJob', function() {
    it('should create an instance of DescribeSpeakerEnrollmentJobResponseJob', function() {
      // uncomment below and update the code to test DescribeSpeakerEnrollmentJobResponseJob
      //var instance = new AmazonVoiceId.DescribeSpeakerEnrollmentJobResponseJob();
      //expect(instance).to.be.a(AmazonVoiceId.DescribeSpeakerEnrollmentJobResponseJob);
    });
