...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVoiceId.ListWatchlistsRequest();
  });
  ...
  describe('ListWatchlistsRequest', function() {
    it('should create an instance of ListWatchlistsRequest', function() {
      // uncomment below and update the code to test ListWatchlistsRequest
      //var instance = new AmazonVoiceId.ListWatchlistsRequest();
      //expect(instance).to.be.a(AmazonVoiceId.ListWatchlistsRequest);
    });
