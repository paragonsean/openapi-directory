...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVoiceId.CreateWatchlistRequest();
  });
  ...
  describe('CreateWatchlistRequest', function() {
    it('should create an instance of CreateWatchlistRequest', function() {
      // uncomment below and update the code to test CreateWatchlistRequest
      //var instance = new AmazonVoiceId.CreateWatchlistRequest();
      //expect(instance).to.be.a(AmazonVoiceId.CreateWatchlistRequest);
    });
