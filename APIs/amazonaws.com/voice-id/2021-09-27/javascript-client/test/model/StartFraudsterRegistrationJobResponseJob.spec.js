...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVoiceId.StartFraudsterRegistrationJobResponseJob();
  });
  ...
  describe('StartFraudsterRegistrationJobResponseJob', function() {
    it('should create an instance of StartFraudsterRegistrationJobResponseJob', function() {
      // uncomment below and update the code to test StartFraudsterRegistrationJobResponseJob
      //var instance = new AmazonVoiceId.StartFraudsterRegistrationJobResponseJob();
      //expect(instance).to.be.a(AmazonVoiceId.StartFraudsterRegistrationJobResponseJob);
    });
