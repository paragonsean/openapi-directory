...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVoiceId.ListFraudsterRegistrationJobsRequest();
  });
  ...
  describe('ListFraudsterRegistrationJobsRequest', function() {
    it('should create an instance of ListFraudsterRegistrationJobsRequest', function() {
      // uncomment below and update the code to test ListFraudsterRegistrationJobsRequest
      //var instance = new AmazonVoiceId.ListFraudsterRegistrationJobsRequest();
      //expect(instance).to.be.a(AmazonVoiceId.ListFraudsterRegistrationJobsRequest);
    });
