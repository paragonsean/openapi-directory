...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVoiceId.StartSpeakerEnrollmentJobRequest();
  });
  ...
  describe('StartSpeakerEnrollmentJobRequest', function() {
    it('should create an instance of StartSpeakerEnrollmentJobRequest', function() {
      // uncomment below and update the code to test StartSpeakerEnrollmentJobRequest
      //var instance = new AmazonVoiceId.StartSpeakerEnrollmentJobRequest();
      //expect(instance).to.be.a(AmazonVoiceId.StartSpeakerEnrollmentJobRequest);
    });
    ...
    it('should have the property enrollmentConfig (base name: "EnrollmentConfig")', function() {
      // uncomment below and update the code to test the property enrollmentConfig
      //var instance = new AmazonVoiceId.StartSpeakerEnrollmentJobRequest();
      //expect(instance).to.be();
    });
