...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVoiceId.UpdateDomainRequest();
  });
  ...
  describe('UpdateDomainRequest', function() {
    it('should create an instance of UpdateDomainRequest', function() {
      ...
      //var instance = new AmazonVoiceId.UpdateDomainRequest();
      //expect(instance).to.be.a(AmazonVoiceId.UpdateDomainRequest);
    });
