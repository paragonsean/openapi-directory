...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVoiceId.StartSpeakerEnrollmentJobResponseJob();
  });
  ...
  describe('StartSpeakerEnrollmentJobResponseJob', function() {
    it('should create an instance of StartSpeakerEnrollmentJobResponseJob', function() {
      // uncomment below and update the code to test StartSpeakerEnrollmentJobResponseJob
      //var instance = new AmazonVoiceId.StartSpeakerEnrollmentJobResponseJob();
      //expect(instance).to.be.a(AmazonVoiceId.StartSpeakerEnrollmentJobResponseJob);
    });
