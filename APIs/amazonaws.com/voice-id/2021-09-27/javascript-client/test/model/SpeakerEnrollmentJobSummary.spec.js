...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVoiceId.SpeakerEnrollmentJobSummary();
  });
  ...
  describe('SpeakerEnrollmentJobSummary', function() {
    it('should create an instance of SpeakerEnrollmentJobSummary', function() {
      // uncomment below and update the code to test SpeakerEnrollmentJobSummary
      //var instance = new AmazonVoiceId.SpeakerEnrollmentJobSummary();
      //expect(instance).to.be.a(AmazonVoiceId.SpeakerEnrollmentJobSummary);
    });
