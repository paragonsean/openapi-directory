...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVoiceId.ListSpeakerEnrollmentJobsRequest();
  });
  ...
  describe('ListSpeakerEnrollmentJobsRequest', function() {
    it('should create an instance of ListSpeakerEnrollmentJobsRequest', function() {
      // uncomment below and update the code to test ListSpeakerEnrollmentJobsRequest
      //var instance = new AmazonVoiceId.ListSpeakerEnrollmentJobsRequest();
      //expect(instance).to.be.a(AmazonVoiceId.ListSpeakerEnrollmentJobsRequest);
    });
