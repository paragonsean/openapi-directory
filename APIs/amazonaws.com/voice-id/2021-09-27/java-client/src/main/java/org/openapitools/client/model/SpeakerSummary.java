...
public class SpeakerSummary {
  ...
  public SpeakerSummary createdAt(OffsetDateTime createdAt) {
  ...
  public SpeakerSummary customerSpeakerId(String customerSpeakerId) {
  ...
  public SpeakerSummary domainId(String domainId) {
  ...
  public SpeakerSummary generatedSpeakerId(String generatedSpeakerId) {
  ...
  public SpeakerSummary lastAccessedAt(OffsetDateTime lastAccessedAt) {
  ...
  public SpeakerSummary status(SpeakerStatus status) {
    this.status = status;
    return this;
  }
  ...
  public SpeakerSummary updatedAt(OffsetDateTime updatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    SpeakerSummary speakerSummary = (SpeakerSummary) o;
    return Objects.equals(this.createdAt, speakerSummary.createdAt) &&
        Objects.equals(this.customerSpeakerId, speakerSummary.customerSpeakerId) &&
        Objects.equals(this.domainId, speakerSummary.domainId) &&
        Objects.equals(this.generatedSpeakerId, speakerSummary.generatedSpeakerId) &&
        Objects.equals(this.lastAccessedAt, speakerSummary.lastAccessedAt) &&
        Objects.equals(this.status, speakerSummary.status) &&
        Objects.equals(this.updatedAt, speakerSummary.updatedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class SpeakerSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SpeakerSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SpeakerSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SpeakerSummary is not found in the empty JSON string", SpeakerSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SpeakerSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SpeakerSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SpeakerSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SpeakerSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SpeakerSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SpeakerSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<SpeakerSummary>() {
           @Override
           public void write(JsonWriter out, SpeakerSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SpeakerSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SpeakerSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SpeakerSummary
   * @throws IOException if the JSON string is invalid with respect to SpeakerSummary
   */
  public static SpeakerSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SpeakerSummary.class);
  }

  /**
   * Convert an instance of SpeakerSummary to an JSON string
   *
   * @return JSON string
   */
