...
public class UpdateDomainResponseDomain {
  ...
  public UpdateDomainResponseDomain() {
  }

  public UpdateDomainResponseDomain arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public UpdateDomainResponseDomain createdAt(OffsetDateTime createdAt) {
  ...
  public UpdateDomainResponseDomain description(String description) {
  ...
  public UpdateDomainResponseDomain domainId(String domainId) {
  ...
  public UpdateDomainResponseDomain domainStatus(DomainStatus domainStatus) {
  ...
  public UpdateDomainResponseDomain name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateDomainResponseDomain serverSideEncryptionConfiguration(DomainServerSideEncryptionConfiguration serverSideEncryptionConfiguration) {
  ...
  public UpdateDomainResponseDomain serverSideEncryptionUpdateDetails(DomainServerSideEncryptionUpdateDetails serverSideEncryptionUpdateDetails) {
  ...
  public UpdateDomainResponseDomain updatedAt(OffsetDateTime updatedAt) {
  ...
  public UpdateDomainResponseDomain watchlistDetails(DomainWatchlistDetails watchlistDetails) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateDomainResponseDomain updateDomainResponseDomain = (UpdateDomainResponseDomain) o;
    return Objects.equals(this.arn, updateDomainResponseDomain.arn) &&
        Objects.equals(this.createdAt, updateDomainResponseDomain.createdAt) &&
        Objects.equals(this.description, updateDomainResponseDomain.description) &&
        Objects.equals(this.domainId, updateDomainResponseDomain.domainId) &&
        Objects.equals(this.domainStatus, updateDomainResponseDomain.domainStatus) &&
        Objects.equals(this.name, updateDomainResponseDomain.name) &&
        Objects.equals(this.serverSideEncryptionConfiguration, updateDomainResponseDomain.serverSideEncryptionConfiguration) &&
        Objects.equals(this.serverSideEncryptionUpdateDetails, updateDomainResponseDomain.serverSideEncryptionUpdateDetails) &&
        Objects.equals(this.updatedAt, updateDomainResponseDomain.updatedAt) &&
        Objects.equals(this.watchlistDetails, updateDomainResponseDomain.watchlistDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateDomainResponseDomain {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateDomainResponseDomain
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateDomainResponseDomain.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateDomainResponseDomain is not found in the empty JSON string", UpdateDomainResponseDomain.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateDomainResponseDomain.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateDomainResponseDomain` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateDomainResponseDomain.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateDomainResponseDomain' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateDomainResponseDomain> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateDomainResponseDomain.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateDomainResponseDomain>() {
           @Override
           public void write(JsonWriter out, UpdateDomainResponseDomain value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateDomainResponseDomain read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateDomainResponseDomain given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateDomainResponseDomain
   * @throws IOException if the JSON string is invalid with respect to UpdateDomainResponseDomain
   */
  public static UpdateDomainResponseDomain fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateDomainResponseDomain.class);
  }

  /**
   * Convert an instance of UpdateDomainResponseDomain to an JSON string
   *
   * @return JSON string
   */
