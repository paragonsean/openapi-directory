...
public class DescribeDomainResponseDomain {
  ...
  public DescribeDomainResponseDomain() {
  }

  public DescribeDomainResponseDomain arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public DescribeDomainResponseDomain createdAt(OffsetDateTime createdAt) {
  ...
  public DescribeDomainResponseDomain description(String description) {
  ...
  public DescribeDomainResponseDomain domainId(String domainId) {
  ...
  public DescribeDomainResponseDomain domainStatus(DomainStatus domainStatus) {
  ...
  public DescribeDomainResponseDomain name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DescribeDomainResponseDomain serverSideEncryptionConfiguration(DomainServerSideEncryptionConfiguration serverSideEncryptionConfiguration) {
  ...
  public DescribeDomainResponseDomain serverSideEncryptionUpdateDetails(DomainServerSideEncryptionUpdateDetails serverSideEncryptionUpdateDetails) {
  ...
  public DescribeDomainResponseDomain updatedAt(OffsetDateTime updatedAt) {
  ...
  public DescribeDomainResponseDomain watchlistDetails(DomainWatchlistDetails watchlistDetails) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeDomainResponseDomain describeDomainResponseDomain = (DescribeDomainResponseDomain) o;
    return Objects.equals(this.arn, describeDomainResponseDomain.arn) &&
        Objects.equals(this.createdAt, describeDomainResponseDomain.createdAt) &&
        Objects.equals(this.description, describeDomainResponseDomain.description) &&
        Objects.equals(this.domainId, describeDomainResponseDomain.domainId) &&
        Objects.equals(this.domainStatus, describeDomainResponseDomain.domainStatus) &&
        Objects.equals(this.name, describeDomainResponseDomain.name) &&
        Objects.equals(this.serverSideEncryptionConfiguration, describeDomainResponseDomain.serverSideEncryptionConfiguration) &&
        Objects.equals(this.serverSideEncryptionUpdateDetails, describeDomainResponseDomain.serverSideEncryptionUpdateDetails) &&
        Objects.equals(this.updatedAt, describeDomainResponseDomain.updatedAt) &&
        Objects.equals(this.watchlistDetails, describeDomainResponseDomain.watchlistDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeDomainResponseDomain {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeDomainResponseDomain
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeDomainResponseDomain.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeDomainResponseDomain is not found in the empty JSON string", DescribeDomainResponseDomain.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeDomainResponseDomain.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeDomainResponseDomain` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeDomainResponseDomain.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeDomainResponseDomain' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeDomainResponseDomain> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeDomainResponseDomain.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeDomainResponseDomain>() {
           @Override
           public void write(JsonWriter out, DescribeDomainResponseDomain value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeDomainResponseDomain read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeDomainResponseDomain given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeDomainResponseDomain
   * @throws IOException if the JSON string is invalid with respect to DescribeDomainResponseDomain
   */
  public static DescribeDomainResponseDomain fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeDomainResponseDomain.class);
  }

  /**
   * Convert an instance of DescribeDomainResponseDomain to an JSON string
   *
   * @return JSON string
   */
