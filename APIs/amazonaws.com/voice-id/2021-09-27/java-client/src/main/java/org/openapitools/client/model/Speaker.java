...
public class Speaker {
  ...
  public Speaker createdAt(OffsetDateTime createdAt) {
  ...
  public Speaker customerSpeakerId(String customerSpeakerId) {
  ...
  public Speaker domainId(String domainId) {
  ...
  public Speaker generatedSpeakerId(String generatedSpeakerId) {
  ...
  public Speaker lastAccessedAt(OffsetDateTime lastAccessedAt) {
  ...
  public Speaker status(SpeakerStatus status) {
    this.status = status;
    return this;
  }
  ...
  public Speaker updatedAt(OffsetDateTime updatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, speaker.createdAt) &&
        Objects.equals(this.customerSpeakerId, speaker.customerSpeakerId) &&
        Objects.equals(this.domainId, speaker.domainId) &&
        Objects.equals(this.generatedSpeakerId, speaker.generatedSpeakerId) &&
        Objects.equals(this.lastAccessedAt, speaker.lastAccessedAt) &&
        Objects.equals(this.status, speaker.status) &&
        Objects.equals(this.updatedAt, speaker.updatedAt);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Speaker
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Speaker.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Speaker is not found in the empty JSON string", Speaker.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Speaker.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Speaker` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Speaker.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Speaker' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Speaker> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Speaker.class));

       return (TypeAdapter<T>) new TypeAdapter<Speaker>() {
           @Override
           public void write(JsonWriter out, Speaker value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Speaker read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Speaker given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Speaker
   * @throws IOException if the JSON string is invalid with respect to Speaker
   */
  public static Speaker fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Speaker.class);
  }

  /**
   * Convert an instance of Speaker to an JSON string
   *
   * @return JSON string
   */
