...
public class EvaluateSessionResponseFraudDetectionResult {
  ...
  public EvaluateSessionResponseFraudDetectionResult() {
  }

  public EvaluateSessionResponseFraudDetectionResult audioAggregationEndedAt(OffsetDateTime audioAggregationEndedAt) {
  ...
  public EvaluateSessionResponseFraudDetectionResult audioAggregationStartedAt(OffsetDateTime audioAggregationStartedAt) {
  ...
  public EvaluateSessionResponseFraudDetectionResult _configuration(FraudDetectionResultConfiguration _configuration) {
  ...
  public EvaluateSessionResponseFraudDetectionResult decision(FraudDetectionDecision decision) {
  ...
  public EvaluateSessionResponseFraudDetectionResult fraudDetectionResultId(String fraudDetectionResultId) {
  ...
  public EvaluateSessionResponseFraudDetectionResult reasons(List reasons) {
  ...
  public EvaluateSessionResponseFraudDetectionResult riskDetails(FraudDetectionResultRiskDetails riskDetails) {
  ...
  public boolean equals(Object o) {
    ...
    EvaluateSessionResponseFraudDetectionResult evaluateSessionResponseFraudDetectionResult = (EvaluateSessionResponseFraudDetectionResult) o;
    return Objects.equals(this.audioAggregationEndedAt, evaluateSessionResponseFraudDetectionResult.audioAggregationEndedAt) &&
        Objects.equals(this.audioAggregationStartedAt, evaluateSessionResponseFraudDetectionResult.audioAggregationStartedAt) &&
        Objects.equals(this._configuration, evaluateSessionResponseFraudDetectionResult._configuration) &&
        Objects.equals(this.decision, evaluateSessionResponseFraudDetectionResult.decision) &&
        Objects.equals(this.fraudDetectionResultId, evaluateSessionResponseFraudDetectionResult.fraudDetectionResultId) &&
        Objects.equals(this.reasons, evaluateSessionResponseFraudDetectionResult.reasons) &&
        Objects.equals(this.riskDetails, evaluateSessionResponseFraudDetectionResult.riskDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class EvaluateSessionResponseFraudDetectionResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EvaluateSessionResponseFraudDetectionResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EvaluateSessionResponseFraudDetectionResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EvaluateSessionResponseFraudDetectionResult is not found in the empty JSON string", EvaluateSessionResponseFraudDetectionResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EvaluateSessionResponseFraudDetectionResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EvaluateSessionResponseFraudDetectionResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EvaluateSessionResponseFraudDetectionResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EvaluateSessionResponseFraudDetectionResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EvaluateSessionResponseFraudDetectionResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EvaluateSessionResponseFraudDetectionResult.class));

       return (TypeAdapter<T>) new TypeAdapter<EvaluateSessionResponseFraudDetectionResult>() {
           @Override
           public void write(JsonWriter out, EvaluateSessionResponseFraudDetectionResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EvaluateSessionResponseFraudDetectionResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EvaluateSessionResponseFraudDetectionResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EvaluateSessionResponseFraudDetectionResult
   * @throws IOException if the JSON string is invalid with respect to EvaluateSessionResponseFraudDetectionResult
   */
  public static EvaluateSessionResponseFraudDetectionResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EvaluateSessionResponseFraudDetectionResult.class);
  }

  /**
   * Convert an instance of EvaluateSessionResponseFraudDetectionResult to an JSON string
   *
   * @return JSON string
   */
