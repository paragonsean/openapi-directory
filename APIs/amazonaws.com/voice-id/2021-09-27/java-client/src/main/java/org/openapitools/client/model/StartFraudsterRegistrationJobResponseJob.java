...
public class StartFraudsterRegistrationJobResponseJob {
  ...
  public StartFraudsterRegistrationJobResponseJob() {
  }

  public StartFraudsterRegistrationJobResponseJob createdAt(OffsetDateTime createdAt) {
  ...
  public StartFraudsterRegistrationJobResponseJob dataAccessRoleArn(String dataAccessRoleArn) {
  ...
  public StartFraudsterRegistrationJobResponseJob domainId(String domainId) {
  ...
  public StartFraudsterRegistrationJobResponseJob endedAt(OffsetDateTime endedAt) {
  ...
  public StartFraudsterRegistrationJobResponseJob failureDetails(FraudsterRegistrationJobFailureDetails failureDetails) {
  ...
  public StartFraudsterRegistrationJobResponseJob inputDataConfig(FraudsterRegistrationJobInputDataConfig inputDataConfig) {
  ...
  public StartFraudsterRegistrationJobResponseJob jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public StartFraudsterRegistrationJobResponseJob jobName(String jobName) {
  ...
  public StartFraudsterRegistrationJobResponseJob jobProgress(FraudsterRegistrationJobJobProgress jobProgress) {
  ...
  public StartFraudsterRegistrationJobResponseJob jobStatus(FraudsterRegistrationJobStatus jobStatus) {
  ...
  public StartFraudsterRegistrationJobResponseJob outputDataConfig(FraudsterRegistrationJobOutputDataConfig outputDataConfig) {
  ...
  public StartFraudsterRegistrationJobResponseJob registrationConfig(FraudsterRegistrationJobRegistrationConfig registrationConfig) {
  ...
  public boolean equals(Object o) {
    ...
    StartFraudsterRegistrationJobResponseJob startFraudsterRegistrationJobResponseJob = (StartFraudsterRegistrationJobResponseJob) o;
    return Objects.equals(this.createdAt, startFraudsterRegistrationJobResponseJob.createdAt) &&
        Objects.equals(this.dataAccessRoleArn, startFraudsterRegistrationJobResponseJob.dataAccessRoleArn) &&
        Objects.equals(this.domainId, startFraudsterRegistrationJobResponseJob.domainId) &&
        Objects.equals(this.endedAt, startFraudsterRegistrationJobResponseJob.endedAt) &&
        Objects.equals(this.failureDetails, startFraudsterRegistrationJobResponseJob.failureDetails) &&
        Objects.equals(this.inputDataConfig, startFraudsterRegistrationJobResponseJob.inputDataConfig) &&
        Objects.equals(this.jobId, startFraudsterRegistrationJobResponseJob.jobId) &&
        Objects.equals(this.jobName, startFraudsterRegistrationJobResponseJob.jobName) &&
        Objects.equals(this.jobProgress, startFraudsterRegistrationJobResponseJob.jobProgress) &&
        Objects.equals(this.jobStatus, startFraudsterRegistrationJobResponseJob.jobStatus) &&
        Objects.equals(this.outputDataConfig, startFraudsterRegistrationJobResponseJob.outputDataConfig) &&
        Objects.equals(this.registrationConfig, startFraudsterRegistrationJobResponseJob.registrationConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartFraudsterRegistrationJobResponseJob {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartFraudsterRegistrationJobResponseJob
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartFraudsterRegistrationJobResponseJob.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartFraudsterRegistrationJobResponseJob is not found in the empty JSON string", StartFraudsterRegistrationJobResponseJob.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartFraudsterRegistrationJobResponseJob.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartFraudsterRegistrationJobResponseJob` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartFraudsterRegistrationJobResponseJob.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartFraudsterRegistrationJobResponseJob' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartFraudsterRegistrationJobResponseJob> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartFraudsterRegistrationJobResponseJob.class));

       return (TypeAdapter<T>) new TypeAdapter<StartFraudsterRegistrationJobResponseJob>() {
           @Override
           public void write(JsonWriter out, StartFraudsterRegistrationJobResponseJob value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartFraudsterRegistrationJobResponseJob read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartFraudsterRegistrationJobResponseJob given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartFraudsterRegistrationJobResponseJob
   * @throws IOException if the JSON string is invalid with respect to StartFraudsterRegistrationJobResponseJob
   */
  public static StartFraudsterRegistrationJobResponseJob fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartFraudsterRegistrationJobResponseJob.class);
  }

  /**
   * Convert an instance of StartFraudsterRegistrationJobResponseJob to an JSON string
   *
   * @return JSON string
   */
