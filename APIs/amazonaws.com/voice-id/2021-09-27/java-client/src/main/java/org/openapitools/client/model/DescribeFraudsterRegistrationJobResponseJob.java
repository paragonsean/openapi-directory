...
public class DescribeFraudsterRegistrationJobResponseJob {
  ...
  public DescribeFraudsterRegistrationJobResponseJob() {
  }

  public DescribeFraudsterRegistrationJobResponseJob createdAt(OffsetDateTime createdAt) {
  ...
  public DescribeFraudsterRegistrationJobResponseJob dataAccessRoleArn(String dataAccessRoleArn) {
  ...
  public DescribeFraudsterRegistrationJobResponseJob domainId(String domainId) {
  ...
  public DescribeFraudsterRegistrationJobResponseJob endedAt(OffsetDateTime endedAt) {
  ...
  public DescribeFraudsterRegistrationJobResponseJob failureDetails(FraudsterRegistrationJobFailureDetails failureDetails) {
  ...
  public DescribeFraudsterRegistrationJobResponseJob inputDataConfig(FraudsterRegistrationJobInputDataConfig inputDataConfig) {
  ...
  public DescribeFraudsterRegistrationJobResponseJob jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public DescribeFraudsterRegistrationJobResponseJob jobName(String jobName) {
  ...
  public DescribeFraudsterRegistrationJobResponseJob jobProgress(FraudsterRegistrationJobJobProgress jobProgress) {
  ...
  public DescribeFraudsterRegistrationJobResponseJob jobStatus(FraudsterRegistrationJobStatus jobStatus) {
  ...
  public DescribeFraudsterRegistrationJobResponseJob outputDataConfig(FraudsterRegistrationJobOutputDataConfig outputDataConfig) {
  ...
  public DescribeFraudsterRegistrationJobResponseJob registrationConfig(FraudsterRegistrationJobRegistrationConfig registrationConfig) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeFraudsterRegistrationJobResponseJob describeFraudsterRegistrationJobResponseJob = (DescribeFraudsterRegistrationJobResponseJob) o;
    return Objects.equals(this.createdAt, describeFraudsterRegistrationJobResponseJob.createdAt) &&
        Objects.equals(this.dataAccessRoleArn, describeFraudsterRegistrationJobResponseJob.dataAccessRoleArn) &&
        Objects.equals(this.domainId, describeFraudsterRegistrationJobResponseJob.domainId) &&
        Objects.equals(this.endedAt, describeFraudsterRegistrationJobResponseJob.endedAt) &&
        Objects.equals(this.failureDetails, describeFraudsterRegistrationJobResponseJob.failureDetails) &&
        Objects.equals(this.inputDataConfig, describeFraudsterRegistrationJobResponseJob.inputDataConfig) &&
        Objects.equals(this.jobId, describeFraudsterRegistrationJobResponseJob.jobId) &&
        Objects.equals(this.jobName, describeFraudsterRegistrationJobResponseJob.jobName) &&
        Objects.equals(this.jobProgress, describeFraudsterRegistrationJobResponseJob.jobProgress) &&
        Objects.equals(this.jobStatus, describeFraudsterRegistrationJobResponseJob.jobStatus) &&
        Objects.equals(this.outputDataConfig, describeFraudsterRegistrationJobResponseJob.outputDataConfig) &&
        Objects.equals(this.registrationConfig, describeFraudsterRegistrationJobResponseJob.registrationConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeFraudsterRegistrationJobResponseJob {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeFraudsterRegistrationJobResponseJob
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeFraudsterRegistrationJobResponseJob.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeFraudsterRegistrationJobResponseJob is not found in the empty JSON string", DescribeFraudsterRegistrationJobResponseJob.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeFraudsterRegistrationJobResponseJob.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeFraudsterRegistrationJobResponseJob` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeFraudsterRegistrationJobResponseJob.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeFraudsterRegistrationJobResponseJob' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeFraudsterRegistrationJobResponseJob> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeFraudsterRegistrationJobResponseJob.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeFraudsterRegistrationJobResponseJob>() {
           @Override
           public void write(JsonWriter out, DescribeFraudsterRegistrationJobResponseJob value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeFraudsterRegistrationJobResponseJob read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeFraudsterRegistrationJobResponseJob given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeFraudsterRegistrationJobResponseJob
   * @throws IOException if the JSON string is invalid with respect to DescribeFraudsterRegistrationJobResponseJob
   */
  public static DescribeFraudsterRegistrationJobResponseJob fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeFraudsterRegistrationJobResponseJob.class);
  }

  /**
   * Convert an instance of DescribeFraudsterRegistrationJobResponseJob to an JSON string
   *
   * @return JSON string
   */
