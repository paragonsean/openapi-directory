...
class EnrollmentConfig(Model):
    ...
    def __init__(self, existing_enrollment_action: ExistingEnrollmentAction=None, fraud_detection_config: EnrollmentConfigFraudDetectionConfig=None):
        """EnrollmentConfig - a model defined in OpenAPI

        :param existing_enrollment_action: The existing_enrollment_action of this EnrollmentConfig.
        :param fraud_detection_config: The fraud_detection_config of this EnrollmentConfig.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'EnrollmentConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The EnrollmentConfig of this EnrollmentConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def existing_enrollment_action(self):
        """Gets the existing_enrollment_action of this EnrollmentConfig.


        :return: The existing_enrollment_action of this EnrollmentConfig.
    ...
    def existing_enrollment_action(self, existing_enrollment_action):
        """Sets the existing_enrollment_action of this EnrollmentConfig.
    ...
    def fraud_detection_config(self):
        """Gets the fraud_detection_config of this EnrollmentConfig.


        :return: The fraud_detection_config of this EnrollmentConfig.
    ...
    def fraud_detection_config(self, fraud_detection_config):
        """Sets the fraud_detection_config of this EnrollmentConfig.
