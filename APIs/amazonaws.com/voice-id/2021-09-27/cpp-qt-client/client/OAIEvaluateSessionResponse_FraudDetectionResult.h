...
/*
 * OAIEvaluateSessionResponse_FraudDetectionResult.h
 *
 * 
 */

#ifndef OAIEvaluateSessionResponse_FraudDetectionResult_H
#define OAIEvaluateSessionResponse_FraudDetectionResult_H
...
class OAIEvaluateSessionResponse_FraudDetectionResult : public OAIObject {
public:
    OAIEvaluateSessionResponse_FraudDetectionResult();
    OAIEvaluateSessionResponse_FraudDetectionResult(QString json);
    ~OAIEvaluateSessionResponse_FraudDetectionResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEvaluateSessionResponse_FraudDetectionResult)

#endif // OAIEvaluateSessionResponse_FraudDetectionResult_H
