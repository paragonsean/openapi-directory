...
class ResourceChange(Model):
    ...
    def __init__(self, action: ChangeAction=None, logical_resource_id: str=None, physical_resource_id: str=None, resource_type: str=None, replacement: Replacement=None, scope: List=None, details: List=None, change_set_id: str=None, module_info: ResourceChangeModuleInfo=None):
        ...
        :param change_set_id: The change_set_id of this ResourceChange.
        :param module_info: The module_info of this ResourceChange.
        """
        self.openapi_types = {
            'action': ChangeAction,
    ...
    def change_set_id(self):
        """Gets the change_set_id of this ResourceChange.


        :return: The change_set_id of this ResourceChange.
        :rtype: str
        """
    ...
    def change_set_id(self, change_set_id):
        """Sets the change_set_id of this ResourceChange.
    ...
    def module_info(self):
        """Gets the module_info of this ResourceChange.


        :return: The module_info of this ResourceChange.
    ...
    def module_info(self, module_info):
        """Sets the module_info of this ResourceChange.
