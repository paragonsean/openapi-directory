...
class DeploymentTargets(Model):
    ...
    def __init__(self, accounts: List=None, accounts_url: str=None, organizational_unit_ids: List=None, account_filter_type: AccountFilterType=None):
        """DeploymentTargets - a model defined in OpenAPI

        :param accounts: The accounts of this DeploymentTargets.
        :param accounts_url: The accounts_url of this DeploymentTargets.
        :param organizational_unit_ids: The organizational_unit_ids of this DeploymentTargets.
        :param account_filter_type: The account_filter_type of this DeploymentTargets.
        """
        self.openapi_types = {
            'accounts': List,
            'accounts_url': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DeploymentTargets':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DeploymentTargets of this DeploymentTargets.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def accounts(self):
        """Gets the accounts of this DeploymentTargets.


        :return: The accounts of this DeploymentTargets.
        :rtype: List
        """
    ...
    def accounts(self, accounts):
        """Sets the accounts of this DeploymentTargets.
    ...
    def accounts_url(self):
        """Gets the accounts_url of this DeploymentTargets.


        :return: The accounts_url of this DeploymentTargets.
        :rtype: str
        """
    ...
    def accounts_url(self, accounts_url):
        """Sets the accounts_url of this DeploymentTargets.
    ...
    def account_filter_type(self):
        """Gets the account_filter_type of this DeploymentTargets.


        :return: The account_filter_type of this DeploymentTargets.
    ...
    def account_filter_type(self, account_filter_type):
        """Sets the account_filter_type of this DeploymentTargets.
