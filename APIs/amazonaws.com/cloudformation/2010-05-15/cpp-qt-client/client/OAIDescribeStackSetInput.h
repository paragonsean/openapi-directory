...
/*
 * OAIDescribeStackSetInput.h
 *
 * 
 */

#ifndef OAIDescribeStackSetInput_H
#define OAIDescribeStackSetInput_H
...
class OAIDescribeStackSetInput : public OAIObject {
public:
    OAIDescribeStackSetInput();
    OAIDescribeStackSetInput(QString json);
    ~OAIDescribeStackSetInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeStackSetInput)

#endif // OAIDescribeStackSetInput_H
