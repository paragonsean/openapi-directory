...
/*
 * OAIStackSetOperation_StackSetDriftDetectionDetails.h
 *
 * 
 */

#ifndef OAIStackSetOperation_StackSetDriftDetectionDetails_H
#define OAIStackSetOperation_StackSetDriftDetectionDetails_H
...
class OAIStackSetOperation_StackSetDriftDetectionDetails : public OAIObject {
public:
    OAIStackSetOperation_StackSetDriftDetectionDetails();
    OAIStackSetOperation_StackSetDriftDetectionDetails(QString json);
    ~OAIStackSetOperation_StackSetDriftDetectionDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStackSetOperation_StackSetDriftDetectionDetails)

#endif // OAIStackSetOperation_StackSetDriftDetectionDetails_H
