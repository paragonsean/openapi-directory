...
/*
 * OAIRollbackStackInput.h
 *
 * 
 */

#ifndef OAIRollbackStackInput_H
#define OAIRollbackStackInput_H
...
class OAIRollbackStackInput : public OAIObject {
public:
    OAIRollbackStackInput();
    OAIRollbackStackInput(QString json);
    ~OAIRollbackStackInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRollbackStackInput)

#endif // OAIRollbackStackInput_H
