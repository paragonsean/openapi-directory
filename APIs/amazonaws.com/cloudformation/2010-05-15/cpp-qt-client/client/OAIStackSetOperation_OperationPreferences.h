...
/*
 * OAIStackSetOperation_OperationPreferences.h
 *
 * 
 */

#ifndef OAIStackSetOperation_OperationPreferences_H
#define OAIStackSetOperation_OperationPreferences_H
...
class OAIStackSetOperation_OperationPreferences : public OAIObject {
public:
    OAIStackSetOperation_OperationPreferences();
    OAIStackSetOperation_OperationPreferences(QString json);
    ~OAIStackSetOperation_OperationPreferences() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStackSetOperation_OperationPreferences)

#endif // OAIStackSetOperation_OperationPreferences_H
