...
/*
 * OAIGET_ListTypes_Filters_parameter.h
 *
 * Filter criteria to use in determining which extensions to return.
 */

#ifndef OAIGET_ListTypes_Filters_parameter_H
#define OAIGET_ListTypes_Filters_parameter_H
...
class OAIGET_ListTypes_Filters_parameter : public OAIObject {
public:
    OAIGET_ListTypes_Filters_parameter();
    OAIGET_ListTypes_Filters_parameter(QString json);
    ~OAIGET_ListTypes_Filters_parameter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGET_ListTypes_Filters_parameter)

#endif // OAIGET_ListTypes_Filters_parameter_H
