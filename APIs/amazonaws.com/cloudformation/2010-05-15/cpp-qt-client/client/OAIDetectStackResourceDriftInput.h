...
/*
 * OAIDetectStackResourceDriftInput.h
 *
 * 
 */

#ifndef OAIDetectStackResourceDriftInput_H
#define OAIDetectStackResourceDriftInput_H
...
class OAIDetectStackResourceDriftInput : public OAIObject {
public:
    OAIDetectStackResourceDriftInput();
    OAIDetectStackResourceDriftInput(QString json);
    ~OAIDetectStackResourceDriftInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectStackResourceDriftInput)

#endif // OAIDetectStackResourceDriftInput_H
