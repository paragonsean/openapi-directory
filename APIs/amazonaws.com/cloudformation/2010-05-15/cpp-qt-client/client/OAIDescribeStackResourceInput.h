...
/*
 * OAIDescribeStackResourceInput.h
 *
 * The input for &lt;a&gt;DescribeStackResource&lt;/a&gt; action.
 */

#ifndef OAIDescribeStackResourceInput_H
#define OAIDescribeStackResourceInput_H
...
class OAIDescribeStackResourceInput : public OAIObject {
public:
    OAIDescribeStackResourceInput();
    OAIDescribeStackResourceInput(QString json);
    ~OAIDescribeStackResourceInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeStackResourceInput)

#endif // OAIDescribeStackResourceInput_H
