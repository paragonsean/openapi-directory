...
/*
 * OAIEstimateTemplateCostInput.h
 *
 * The input for an &lt;a&gt;EstimateTemplateCost&lt;/a&gt; action.
 */

#ifndef OAIEstimateTemplateCostInput_H
#define OAIEstimateTemplateCostInput_H
...
class OAIEstimateTemplateCostInput : public OAIObject {
public:
    OAIEstimateTemplateCostInput();
    OAIEstimateTemplateCostInput(QString json);
    ~OAIEstimateTemplateCostInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEstimateTemplateCostInput)

#endif // OAIEstimateTemplateCostInput_H
