...
/*
 * OAIImportStacksToStackSetInput.h
 *
 * 
 */

#ifndef OAIImportStacksToStackSetInput_H
#define OAIImportStacksToStackSetInput_H
...
class OAIImportStacksToStackSetInput : public OAIObject {
public:
    OAIImportStacksToStackSetInput();
    OAIImportStacksToStackSetInput(QString json);
    ~OAIImportStacksToStackSetInput() override;
    ...
    QList getStackIds() const;
    void setStackIds(const QList &stack_ids);
    bool is_stack_ids_Set() const;
    bool is_stack_ids_Valid() const;

    QString getStackIdsUrl() const;
    void setStackIdsUrl(const QString &stack_ids_url);
    bool is_stack_ids_url_Set() const;
    bool is_stack_ids_url_Valid() const;
...
private:
    ...
    QList m_stack_ids;
    bool m_stack_ids_isSet;
    bool m_stack_ids_isValid;

    QString m_stack_ids_url;
    bool m_stack_ids_url_isSet;
    bool m_stack_ids_url_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportStacksToStackSetInput)

#endif // OAIImportStacksToStackSetInput_H
