...
/*
 * OAIStopStackSetOperationInput.h
 *
 * 
 */

#ifndef OAIStopStackSetOperationInput_H
#define OAIStopStackSetOperationInput_H
...
class OAIStopStackSetOperationInput : public OAIObject {
public:
    OAIStopStackSetOperationInput();
    OAIStopStackSetOperationInput(QString json);
    ~OAIStopStackSetOperationInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopStackSetOperationInput)

#endif // OAIStopStackSetOperationInput_H
