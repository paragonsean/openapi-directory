...
/*
 * OAITypeVersionSummary.h
 *
 * Contains summary information about a specific version of a CloudFormation extension.
 */

#ifndef OAITypeVersionSummary_H
#define OAITypeVersionSummary_H
...
class OAITypeVersionSummary : public OAIObject {
public:
    OAITypeVersionSummary();
    OAITypeVersionSummary(QString json);
    ~OAITypeVersionSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITypeVersionSummary)

#endif // OAITypeVersionSummary_H
