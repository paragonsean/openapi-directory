...
#include "OAIDeploymentTargets.h"
...
OAIDeploymentTargets::OAIDeploymentTargets(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeploymentTargets::OAIDeploymentTargets() {
    this->initializeModel();
}

OAIDeploymentTargets::~OAIDeploymentTargets() {}

void OAIDeploymentTargets::initializeModel() {
...
void OAIDeploymentTargets::fromJson(QString jsonString) {
...
void OAIDeploymentTargets::fromJsonObject(QJsonObject json) {
...
QString OAIDeploymentTargets::asJson() const {
...
QJsonObject OAIDeploymentTargets::asJsonObject() const {
    QJsonObject obj;
    if (m_accounts.isSet()) {
...
QList OAIDeploymentTargets::getAccounts() const {
    return m_accounts;
}
void OAIDeploymentTargets::setAccounts(const QList &accounts) {
    m_accounts = accounts;
    m_accounts_isSet = true;
}

bool OAIDeploymentTargets::is_accounts_Set() const{
    return m_accounts_isSet;
}

bool OAIDeploymentTargets::is_accounts_Valid() const{
    return m_accounts_isValid;
}

QString OAIDeploymentTargets::getAccountsUrl() const {
    return m_accounts_url;
}
void OAIDeploymentTargets::setAccountsUrl(const QString &accounts_url) {
    m_accounts_url = accounts_url;
    m_accounts_url_isSet = true;
}

bool OAIDeploymentTargets::is_accounts_url_Set() const{
    return m_accounts_url_isSet;
}

bool OAIDeploymentTargets::is_accounts_url_Valid() const{
    return m_accounts_url_isValid;
}

QList OAIDeploymentTargets::getOrganizationalUnitIds() const {
    return m_organizational_unit_ids;
}
void OAIDeploymentTargets::setOrganizationalUnitIds(const QList &organizational_unit_ids) {
    m_organizational_unit_ids = organizational_unit_ids;
    m_organizational_unit_ids_isSet = true;
}

bool OAIDeploymentTargets::is_organizational_unit_ids_Set() const{
    return m_organizational_unit_ids_isSet;
}

bool OAIDeploymentTargets::is_organizational_unit_ids_Valid() const{
    return m_organizational_unit_ids_isValid;
}

OAIAccountFilterType OAIDeploymentTargets::getAccountFilterType() const {
    return m_account_filter_type;
}
void OAIDeploymentTargets::setAccountFilterType(const OAIAccountFilterType &account_filter_type) {
    m_account_filter_type = account_filter_type;
    m_account_filter_type_isSet = true;
}

bool OAIDeploymentTargets::is_account_filter_type_Set() const{
    return m_account_filter_type_isSet;
}

bool OAIDeploymentTargets::is_account_filter_type_Valid() const{
    return m_account_filter_type_isValid;
}

bool OAIDeploymentTargets::isSet() const {
...
bool OAIDeploymentTargets::isValid() const {
