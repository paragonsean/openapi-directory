...
/*
 * OAIValidateTemplateInput.h
 *
 * The input for &lt;a&gt;ValidateTemplate&lt;/a&gt; action.
 */

#ifndef OAIValidateTemplateInput_H
#define OAIValidateTemplateInput_H
...
class OAIValidateTemplateInput : public OAIObject {
public:
    OAIValidateTemplateInput();
    OAIValidateTemplateInput(QString json);
    ~OAIValidateTemplateInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIValidateTemplateInput)

#endif // OAIValidateTemplateInput_H
