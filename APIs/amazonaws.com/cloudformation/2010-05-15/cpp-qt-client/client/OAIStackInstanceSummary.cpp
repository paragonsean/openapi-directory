...
#include "OAIStackInstanceSummary.h"
...
OAIStackInstanceSummary::OAIStackInstanceSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStackInstanceSummary::OAIStackInstanceSummary() {
    this->initializeModel();
}

OAIStackInstanceSummary::~OAIStackInstanceSummary() {}

void OAIStackInstanceSummary::initializeModel() {
...
void OAIStackInstanceSummary::fromJson(QString jsonString) {
...
void OAIStackInstanceSummary::fromJsonObject(QJsonObject json) {
...
QString OAIStackInstanceSummary::asJson() const {
...
QJsonObject OAIStackInstanceSummary::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStackInstanceSummary::getStackSetId() const {
    return m_stack_set_id;
}
void OAIStackInstanceSummary::setStackSetId(const QString &stack_set_id) {
    m_stack_set_id = stack_set_id;
    m_stack_set_id_isSet = true;
}

bool OAIStackInstanceSummary::is_stack_set_id_Set() const{
    return m_stack_set_id_isSet;
}

bool OAIStackInstanceSummary::is_stack_set_id_Valid() const{
    return m_stack_set_id_isValid;
}

QString OAIStackInstanceSummary::getRegion() const {
    return m_region;
}
void OAIStackInstanceSummary::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIStackInstanceSummary::is_region_Set() const{
    return m_region_isSet;
}

bool OAIStackInstanceSummary::is_region_Valid() const{
    return m_region_isValid;
}

QString OAIStackInstanceSummary::getAccount() const {
    return m_account;
}
void OAIStackInstanceSummary::setAccount(const QString &account) {
    m_account = account;
    m_account_isSet = true;
}

bool OAIStackInstanceSummary::is_account_Set() const{
    return m_account_isSet;
}

bool OAIStackInstanceSummary::is_account_Valid() const{
    return m_account_isValid;
}

QString OAIStackInstanceSummary::getStackId() const {
    return m_stack_id;
}
void OAIStackInstanceSummary::setStackId(const QString &stack_id) {
    m_stack_id = stack_id;
    m_stack_id_isSet = true;
}

bool OAIStackInstanceSummary::is_stack_id_Set() const{
    return m_stack_id_isSet;
}

bool OAIStackInstanceSummary::is_stack_id_Valid() const{
    return m_stack_id_isValid;
}

OAIStackInstanceStatus OAIStackInstanceSummary::getStatus() const {
    return m_status;
}
void OAIStackInstanceSummary::setStatus(const OAIStackInstanceStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIStackInstanceSummary::is_status_Set() const{
    return m_status_isSet;
}

bool OAIStackInstanceSummary::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIStackInstanceSummary::getStatusReason() const {
    return m_status_reason;
}
void OAIStackInstanceSummary::setStatusReason(const QString &status_reason) {
    m_status_reason = status_reason;
    m_status_reason_isSet = true;
}

bool OAIStackInstanceSummary::is_status_reason_Set() const{
    return m_status_reason_isSet;
}

bool OAIStackInstanceSummary::is_status_reason_Valid() const{
    return m_status_reason_isValid;
}

OAIStackInstance_StackInstanceStatus OAIStackInstanceSummary::getStackInstanceStatus() const {
    return m_stack_instance_status;
}
void OAIStackInstanceSummary::setStackInstanceStatus(const OAIStackInstance_StackInstanceStatus &stack_instance_status) {
    m_stack_instance_status = stack_instance_status;
    m_stack_instance_status_isSet = true;
}

bool OAIStackInstanceSummary::is_stack_instance_status_Set() const{
    return m_stack_instance_status_isSet;
}

bool OAIStackInstanceSummary::is_stack_instance_status_Valid() const{
    return m_stack_instance_status_isValid;
}

QString OAIStackInstanceSummary::getOrganizationalUnitId() const {
    return m_organizational_unit_id;
}
void OAIStackInstanceSummary::setOrganizationalUnitId(const QString &organizational_unit_id) {
    m_organizational_unit_id = organizational_unit_id;
    m_organizational_unit_id_isSet = true;
}

bool OAIStackInstanceSummary::is_organizational_unit_id_Set() const{
    return m_organizational_unit_id_isSet;
}

bool OAIStackInstanceSummary::is_organizational_unit_id_Valid() const{
    return m_organizational_unit_id_isValid;
}

OAIStackDriftStatus OAIStackInstanceSummary::getDriftStatus() const {
    return m_drift_status;
}
void OAIStackInstanceSummary::setDriftStatus(const OAIStackDriftStatus &drift_status) {
    m_drift_status = drift_status;
    m_drift_status_isSet = true;
}

bool OAIStackInstanceSummary::is_drift_status_Set() const{
    return m_drift_status_isSet;
}

bool OAIStackInstanceSummary::is_drift_status_Valid() const{
    return m_drift_status_isValid;
}

QDateTime OAIStackInstanceSummary::getLastDriftCheckTimestamp() const {
    return m_last_drift_check_timestamp;
}
void OAIStackInstanceSummary::setLastDriftCheckTimestamp(const QDateTime &last_drift_check_timestamp) {
    m_last_drift_check_timestamp = last_drift_check_timestamp;
    m_last_drift_check_timestamp_isSet = true;
}

bool OAIStackInstanceSummary::is_last_drift_check_timestamp_Set() const{
    return m_last_drift_check_timestamp_isSet;
}

bool OAIStackInstanceSummary::is_last_drift_check_timestamp_Valid() const{
    return m_last_drift_check_timestamp_isValid;
}

QString OAIStackInstanceSummary::getLastOperationId() const {
    return m_last_operation_id;
}
void OAIStackInstanceSummary::setLastOperationId(const QString &last_operation_id) {
    m_last_operation_id = last_operation_id;
    m_last_operation_id_isSet = true;
}

bool OAIStackInstanceSummary::is_last_operation_id_Set() const{
    return m_last_operation_id_isSet;
}

bool OAIStackInstanceSummary::is_last_operation_id_Valid() const{
    return m_last_operation_id_isValid;
}

bool OAIStackInstanceSummary::isSet() const {
...
bool OAIStackInstanceSummary::isValid() const {
