...
OAICreateStackInstancesInput::OAICreateStackInstancesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateStackInstancesInput::OAICreateStackInstancesInput() {
    this->initializeModel();
}

OAICreateStackInstancesInput::~OAICreateStackInstancesInput() {}

void OAICreateStackInstancesInput::initializeModel() {
...
void OAICreateStackInstancesInput::fromJson(QString jsonString) {
...
void OAICreateStackInstancesInput::fromJsonObject(QJsonObject json) {
...
QString OAICreateStackInstancesInput::asJson() const {
...
QJsonObject OAICreateStackInstancesInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateStackInstancesInput::getStackSetName() const {
    return m_stack_set_name;
}
void OAICreateStackInstancesInput::setStackSetName(const QString &stack_set_name) {
    m_stack_set_name = stack_set_name;
    m_stack_set_name_isSet = true;
}

bool OAICreateStackInstancesInput::is_stack_set_name_Set() const{
    return m_stack_set_name_isSet;
}

bool OAICreateStackInstancesInput::is_stack_set_name_Valid() const{
    return m_stack_set_name_isValid;
}

QList OAICreateStackInstancesInput::getAccounts() const {
    return m_accounts;
}
void OAICreateStackInstancesInput::setAccounts(const QList &accounts) {
    m_accounts = accounts;
    m_accounts_isSet = true;
}

bool OAICreateStackInstancesInput::is_accounts_Set() const{
    return m_accounts_isSet;
}

bool OAICreateStackInstancesInput::is_accounts_Valid() const{
    return m_accounts_isValid;
}

OAICreateStackInstancesInput_DeploymentTargets OAICreateStackInstancesInput::getDeploymentTargets() const {
    return m_deployment_targets;
}
void OAICreateStackInstancesInput::setDeploymentTargets(const OAICreateStackInstancesInput_DeploymentTargets &deployment_targets) {
    m_deployment_targets = deployment_targets;
    m_deployment_targets_isSet = true;
}

bool OAICreateStackInstancesInput::is_deployment_targets_Set() const{
    return m_deployment_targets_isSet;
}

bool OAICreateStackInstancesInput::is_deployment_targets_Valid() const{
    return m_deployment_targets_isValid;
}

QList OAICreateStackInstancesInput::getRegions() const {
    return m_regions;
}
void OAICreateStackInstancesInput::setRegions(const QList &regions) {
    m_regions = regions;
    m_regions_isSet = true;
}

bool OAICreateStackInstancesInput::is_regions_Set() const{
    return m_regions_isSet;
}

bool OAICreateStackInstancesInput::is_regions_Valid() const{
    return m_regions_isValid;
}

QList OAICreateStackInstancesInput::getParameterOverrides() const {
    return m_parameter_overrides;
}
void OAICreateStackInstancesInput::setParameterOverrides(const QList &parameter_overrides) {
    m_parameter_overrides = parameter_overrides;
    m_parameter_overrides_isSet = true;
}

bool OAICreateStackInstancesInput::is_parameter_overrides_Set() const{
    return m_parameter_overrides_isSet;
}

bool OAICreateStackInstancesInput::is_parameter_overrides_Valid() const{
    return m_parameter_overrides_isValid;
}

OAICreateStackInstancesInput_OperationPreferences OAICreateStackInstancesInput::getOperationPreferences() const {
    return m_operation_preferences;
}
void OAICreateStackInstancesInput::setOperationPreferences(const OAICreateStackInstancesInput_OperationPreferences &operation_preferences) {
    m_operation_preferences = operation_preferences;
    m_operation_preferences_isSet = true;
}

bool OAICreateStackInstancesInput::is_operation_preferences_Set() const{
    return m_operation_preferences_isSet;
}

bool OAICreateStackInstancesInput::is_operation_preferences_Valid() const{
    return m_operation_preferences_isValid;
}

QString OAICreateStackInstancesInput::getOperationId() const {
    return m_operation_id;
}
void OAICreateStackInstancesInput::setOperationId(const QString &operation_id) {
    m_operation_id = operation_id;
    m_operation_id_isSet = true;
}

bool OAICreateStackInstancesInput::is_operation_id_Set() const{
    return m_operation_id_isSet;
}

bool OAICreateStackInstancesInput::is_operation_id_Valid() const{
    return m_operation_id_isValid;
}

OAICallAs OAICreateStackInstancesInput::getCallAs() const {
    return m_call_as;
}
void OAICreateStackInstancesInput::setCallAs(const OAICallAs &call_as) {
    m_call_as = call_as;
    m_call_as_isSet = true;
}

bool OAICreateStackInstancesInput::is_call_as_Set() const{
    return m_call_as_isSet;
}

bool OAICreateStackInstancesInput::is_call_as_Valid() const{
    return m_call_as_isValid;
}

bool OAICreateStackInstancesInput::isSet() const {
...
bool OAICreateStackInstancesInput::isValid() const {
