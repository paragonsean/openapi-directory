...
/*
 * OAICreateStackInput.h
 *
 * The input for &lt;a&gt;CreateStack&lt;/a&gt; action.
 */

#ifndef OAICreateStackInput_H
#define OAICreateStackInput_H
...
class OAICreateStackInput : public OAIObject {
public:
    OAICreateStackInput();
    OAICreateStackInput(QString json);
    ~OAICreateStackInput() override;
    ...
    OAIOnFailure getOnFailure() const;
    void setOnFailure(const OAIOnFailure &on_failure);
    bool is_on_failure_Set() const;
    bool is_on_failure_Valid() const;
...
private:
    ...
    OAIOnFailure m_on_failure;
    bool m_on_failure_isSet;
    bool m_on_failure_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateStackInput)

#endif // OAICreateStackInput_H
