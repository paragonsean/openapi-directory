...
/*
 * OAIDeleteChangeSetInput.h
 *
 * The input for the &lt;a&gt;DeleteChangeSet&lt;/a&gt; action.
 */

#ifndef OAIDeleteChangeSetInput_H
#define OAIDeleteChangeSetInput_H
...
class OAIDeleteChangeSetInput : public OAIObject {
public:
    OAIDeleteChangeSetInput();
    OAIDeleteChangeSetInput(QString json);
    ~OAIDeleteChangeSetInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteChangeSetInput)

#endif // OAIDeleteChangeSetInput_H
