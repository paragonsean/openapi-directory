...
/*
 * OAIUpdateStackInstancesInput.h
 *
 * 
 */

#ifndef OAIUpdateStackInstancesInput_H
#define OAIUpdateStackInstancesInput_H

#include <QJsonObject>

#include "OAICallAs.h"
#include "OAICreateStackInstancesInput_OperationPreferences.h"
#include "OAIUpdateStackInstancesInput_DeploymentTargets.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIUpdateStackInstancesInput_DeploymentTargets;
class OAICreateStackInstancesInput_OperationPreferences;

class OAIUpdateStackInstancesInput : public OAIObject {
public:
    OAIUpdateStackInstancesInput();
    OAIUpdateStackInstancesInput(QString json);
    ~OAIUpdateStackInstancesInput() override;
    ...
    OAIUpdateStackInstancesInput_DeploymentTargets getDeploymentTargets() const;
    void setDeploymentTargets(const OAIUpdateStackInstancesInput_DeploymentTargets &deployment_targets);
...
private:
    ...
    OAIUpdateStackInstancesInput_DeploymentTargets m_deployment_targets;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateStackInstancesInput)

#endif // OAIUpdateStackInstancesInput_H
