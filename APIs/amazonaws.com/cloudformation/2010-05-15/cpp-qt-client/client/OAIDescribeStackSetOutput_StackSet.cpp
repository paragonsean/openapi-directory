...
OAIDescribeStackSetOutput_StackSet::OAIDescribeStackSetOutput_StackSet(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeStackSetOutput_StackSet::OAIDescribeStackSetOutput_StackSet() {
    this->initializeModel();
}

OAIDescribeStackSetOutput_StackSet::~OAIDescribeStackSetOutput_StackSet() {}

void OAIDescribeStackSetOutput_StackSet::initializeModel() {
...
void OAIDescribeStackSetOutput_StackSet::fromJson(QString jsonString) {
...
void OAIDescribeStackSetOutput_StackSet::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeStackSetOutput_StackSet::asJson() const {
...
QJsonObject OAIDescribeStackSetOutput_StackSet::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeStackSetOutput_StackSet::getStackSetName() const {
    return m_stack_set_name;
}
void OAIDescribeStackSetOutput_StackSet::setStackSetName(const QString &stack_set_name) {
    m_stack_set_name = stack_set_name;
    m_stack_set_name_isSet = true;
}

bool OAIDescribeStackSetOutput_StackSet::is_stack_set_name_Set() const{
    return m_stack_set_name_isSet;
}

bool OAIDescribeStackSetOutput_StackSet::is_stack_set_name_Valid() const{
    return m_stack_set_name_isValid;
}

QString OAIDescribeStackSetOutput_StackSet::getStackSetId() const {
    return m_stack_set_id;
}
void OAIDescribeStackSetOutput_StackSet::setStackSetId(const QString &stack_set_id) {
    m_stack_set_id = stack_set_id;
    m_stack_set_id_isSet = true;
}

bool OAIDescribeStackSetOutput_StackSet::is_stack_set_id_Set() const{
    return m_stack_set_id_isSet;
}

bool OAIDescribeStackSetOutput_StackSet::is_stack_set_id_Valid() const{
    return m_stack_set_id_isValid;
}

QString OAIDescribeStackSetOutput_StackSet::getDescription() const {
    return m_description;
}
void OAIDescribeStackSetOutput_StackSet::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIDescribeStackSetOutput_StackSet::is_description_Set() const{
    return m_description_isSet;
}

bool OAIDescribeStackSetOutput_StackSet::is_description_Valid() const{
    return m_description_isValid;
}

OAIStackSetStatus OAIDescribeStackSetOutput_StackSet::getStatus() const {
    return m_status;
}
void OAIDescribeStackSetOutput_StackSet::setStatus(const OAIStackSetStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDescribeStackSetOutput_StackSet::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDescribeStackSetOutput_StackSet::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIDescribeStackSetOutput_StackSet::getTemplateBody() const {
    return m_template_body;
}
void OAIDescribeStackSetOutput_StackSet::setTemplateBody(const QString &template_body) {
    m_template_body = template_body;
    m_template_body_isSet = true;
}

bool OAIDescribeStackSetOutput_StackSet::is_template_body_Set() const{
    return m_template_body_isSet;
}

bool OAIDescribeStackSetOutput_StackSet::is_template_body_Valid() const{
    return m_template_body_isValid;
}

QList OAIDescribeStackSetOutput_StackSet::getParameters() const {
    return m_parameters;
}
void OAIDescribeStackSetOutput_StackSet::setParameters(const QList &parameters) {
    m_parameters = parameters;
    m_parameters_isSet = true;
}

bool OAIDescribeStackSetOutput_StackSet::is_parameters_Set() const{
    return m_parameters_isSet;
}

bool OAIDescribeStackSetOutput_StackSet::is_parameters_Valid() const{
    return m_parameters_isValid;
}

QList OAIDescribeStackSetOutput_StackSet::getCapabilities() const {
    return m_capabilities;
}
void OAIDescribeStackSetOutput_StackSet::setCapabilities(const QList &capabilities) {
    m_capabilities = capabilities;
    m_capabilities_isSet = true;
}

bool OAIDescribeStackSetOutput_StackSet::is_capabilities_Set() const{
    return m_capabilities_isSet;
}

bool OAIDescribeStackSetOutput_StackSet::is_capabilities_Valid() const{
    return m_capabilities_isValid;
}

QList OAIDescribeStackSetOutput_StackSet::getTags() const {
    return m_tags;
}
void OAIDescribeStackSetOutput_StackSet::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIDescribeStackSetOutput_StackSet::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIDescribeStackSetOutput_StackSet::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAIDescribeStackSetOutput_StackSet::getStackSetArn() const {
    return m_stack_set_arn;
}
void OAIDescribeStackSetOutput_StackSet::setStackSetArn(const QString &stack_set_arn) {
    m_stack_set_arn = stack_set_arn;
    m_stack_set_arn_isSet = true;
}

bool OAIDescribeStackSetOutput_StackSet::is_stack_set_arn_Set() const{
    return m_stack_set_arn_isSet;
}

bool OAIDescribeStackSetOutput_StackSet::is_stack_set_arn_Valid() const{
    return m_stack_set_arn_isValid;
}

QString OAIDescribeStackSetOutput_StackSet::getAdministrationRoleArn() const {
    return m_administration_role_arn;
}
void OAIDescribeStackSetOutput_StackSet::setAdministrationRoleArn(const QString &administration_role_arn) {
    m_administration_role_arn = administration_role_arn;
    m_administration_role_arn_isSet = true;
}

bool OAIDescribeStackSetOutput_StackSet::is_administration_role_arn_Set() const{
    return m_administration_role_arn_isSet;
}

bool OAIDescribeStackSetOutput_StackSet::is_administration_role_arn_Valid() const{
    return m_administration_role_arn_isValid;
}

QString OAIDescribeStackSetOutput_StackSet::getExecutionRoleName() const {
    return m_execution_role_name;
}
void OAIDescribeStackSetOutput_StackSet::setExecutionRoleName(const QString &execution_role_name) {
    m_execution_role_name = execution_role_name;
    m_execution_role_name_isSet = true;
}

bool OAIDescribeStackSetOutput_StackSet::is_execution_role_name_Set() const{
    return m_execution_role_name_isSet;
}

bool OAIDescribeStackSetOutput_StackSet::is_execution_role_name_Valid() const{
    return m_execution_role_name_isValid;
}

OAIStackSet_StackSetDriftDetectionDetails OAIDescribeStackSetOutput_StackSet::getStackSetDriftDetectionDetails() const {
    return m_stack_set_drift_detection_details;
}
void OAIDescribeStackSetOutput_StackSet::setStackSetDriftDetectionDetails(const OAIStackSet_StackSetDriftDetectionDetails &stack_set_drift_detection_details) {
    m_stack_set_drift_detection_details = stack_set_drift_detection_details;
    m_stack_set_drift_detection_details_isSet = true;
}

bool OAIDescribeStackSetOutput_StackSet::is_stack_set_drift_detection_details_Set() const{
    return m_stack_set_drift_detection_details_isSet;
}

bool OAIDescribeStackSetOutput_StackSet::is_stack_set_drift_detection_details_Valid() const{
    return m_stack_set_drift_detection_details_isValid;
}

OAIStackSet_AutoDeployment OAIDescribeStackSetOutput_StackSet::getAutoDeployment() const {
    return m_auto_deployment;
}
void OAIDescribeStackSetOutput_StackSet::setAutoDeployment(const OAIStackSet_AutoDeployment &auto_deployment) {
    m_auto_deployment = auto_deployment;
    m_auto_deployment_isSet = true;
}

bool OAIDescribeStackSetOutput_StackSet::is_auto_deployment_Set() const{
    return m_auto_deployment_isSet;
}

bool OAIDescribeStackSetOutput_StackSet::is_auto_deployment_Valid() const{
    return m_auto_deployment_isValid;
}

OAIPermissionModels OAIDescribeStackSetOutput_StackSet::getPermissionModel() const {
    return m_permission_model;
}
void OAIDescribeStackSetOutput_StackSet::setPermissionModel(const OAIPermissionModels &permission_model) {
    m_permission_model = permission_model;
    m_permission_model_isSet = true;
}

bool OAIDescribeStackSetOutput_StackSet::is_permission_model_Set() const{
    return m_permission_model_isSet;
}

bool OAIDescribeStackSetOutput_StackSet::is_permission_model_Valid() const{
    return m_permission_model_isValid;
}

QList OAIDescribeStackSetOutput_StackSet::getOrganizationalUnitIds() const {
    return m_organizational_unit_ids;
}
void OAIDescribeStackSetOutput_StackSet::setOrganizationalUnitIds(const QList &organizational_unit_ids) {
    m_organizational_unit_ids = organizational_unit_ids;
    m_organizational_unit_ids_isSet = true;
}

bool OAIDescribeStackSetOutput_StackSet::is_organizational_unit_ids_Set() const{
    return m_organizational_unit_ids_isSet;
}

bool OAIDescribeStackSetOutput_StackSet::is_organizational_unit_ids_Valid() const{
    return m_organizational_unit_ids_isValid;
}

OAICreateStackSetInput_ManagedExecution OAIDescribeStackSetOutput_StackSet::getManagedExecution() const {
    return m_managed_execution;
}
void OAIDescribeStackSetOutput_StackSet::setManagedExecution(const OAICreateStackSetInput_ManagedExecution &managed_execution) {
    m_managed_execution = managed_execution;
    m_managed_execution_isSet = true;
}

bool OAIDescribeStackSetOutput_StackSet::is_managed_execution_Set() const{
    return m_managed_execution_isSet;
}

bool OAIDescribeStackSetOutput_StackSet::is_managed_execution_Valid() const{
    return m_managed_execution_isValid;
}

QList OAIDescribeStackSetOutput_StackSet::getRegions() const {
    return m_regions;
}
void OAIDescribeStackSetOutput_StackSet::setRegions(const QList &regions) {
    m_regions = regions;
    m_regions_isSet = true;
}

bool OAIDescribeStackSetOutput_StackSet::is_regions_Set() const{
    return m_regions_isSet;
}

bool OAIDescribeStackSetOutput_StackSet::is_regions_Valid() const{
    return m_regions_isValid;
}

bool OAIDescribeStackSetOutput_StackSet::isSet() const {
...
bool OAIDescribeStackSetOutput_StackSet::isValid() const {
