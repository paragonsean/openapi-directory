...
/*
 * OAIDescribeStackResourcesInput.h
 *
 * The input for &lt;a&gt;DescribeStackResources&lt;/a&gt; action.
 */

#ifndef OAIDescribeStackResourcesInput_H
#define OAIDescribeStackResourcesInput_H
...
class OAIDescribeStackResourcesInput : public OAIObject {
public:
    OAIDescribeStackResourcesInput();
    OAIDescribeStackResourcesInput(QString json);
    ~OAIDescribeStackResourcesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeStackResourcesInput)

#endif // OAIDescribeStackResourcesInput_H
