...
/*
 * OAIStackSetDriftDetectionDetails.h
 *
...
#ifndef OAIStackSetDriftDetectionDetails_H
#define OAIStackSetDriftDetectionDetails_H
...
class OAIStackSetDriftDetectionDetails : public OAIObject {
public:
    OAIStackSetDriftDetectionDetails();
    OAIStackSetDriftDetectionDetails(QString json);
    ~OAIStackSetDriftDetectionDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStackSetDriftDetectionDetails)

#endif // OAIStackSetDriftDetectionDetails_H
