...
#ifndef OAIStackResource_H
#define OAIStackResource_H
...
class OAIStackResource : public OAIObject {
public:
    OAIStackResource();
    OAIStackResource(QString json);
    ~OAIStackResource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStackResource)

#endif // OAIStackResource_H
