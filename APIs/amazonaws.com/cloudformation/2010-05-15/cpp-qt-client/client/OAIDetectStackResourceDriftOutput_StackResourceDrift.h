...
/*
 * OAIDetectStackResourceDriftOutput_StackResourceDrift.h
 *
 * 
 */

#ifndef OAIDetectStackResourceDriftOutput_StackResourceDrift_H
#define OAIDetectStackResourceDriftOutput_StackResourceDrift_H
...
class OAIDetectStackResourceDriftOutput_StackResourceDrift : public OAIObject {
public:
    OAIDetectStackResourceDriftOutput_StackResourceDrift();
    OAIDetectStackResourceDriftOutput_StackResourceDrift(QString json);
    ~OAIDetectStackResourceDriftOutput_StackResourceDrift() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectStackResourceDriftOutput_StackResourceDrift)

#endif // OAIDetectStackResourceDriftOutput_StackResourceDrift_H
