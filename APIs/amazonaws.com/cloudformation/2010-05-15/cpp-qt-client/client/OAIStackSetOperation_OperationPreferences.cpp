...
OAIStackSetOperation_OperationPreferences::OAIStackSetOperation_OperationPreferences(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStackSetOperation_OperationPreferences::OAIStackSetOperation_OperationPreferences() {
    this->initializeModel();
}

OAIStackSetOperation_OperationPreferences::~OAIStackSetOperation_OperationPreferences() {}

void OAIStackSetOperation_OperationPreferences::initializeModel() {
...
void OAIStackSetOperation_OperationPreferences::fromJson(QString jsonString) {
...
void OAIStackSetOperation_OperationPreferences::fromJsonObject(QJsonObject json) {
...
QString OAIStackSetOperation_OperationPreferences::asJson() const {
...
QJsonObject OAIStackSetOperation_OperationPreferences::asJsonObject() const {
    QJsonObject obj;
...
OAIRegionConcurrencyType OAIStackSetOperation_OperationPreferences::getRegionConcurrencyType() const {
    return m_region_concurrency_type;
}
void OAIStackSetOperation_OperationPreferences::setRegionConcurrencyType(const OAIRegionConcurrencyType &region_concurrency_type) {
    m_region_concurrency_type = region_concurrency_type;
    m_region_concurrency_type_isSet = true;
}

bool OAIStackSetOperation_OperationPreferences::is_region_concurrency_type_Set() const{
    return m_region_concurrency_type_isSet;
}

bool OAIStackSetOperation_OperationPreferences::is_region_concurrency_type_Valid() const{
    return m_region_concurrency_type_isValid;
}

QList OAIStackSetOperation_OperationPreferences::getRegionOrder() const {
    return m_region_order;
}
void OAIStackSetOperation_OperationPreferences::setRegionOrder(const QList &region_order) {
    m_region_order = region_order;
    m_region_order_isSet = true;
}

bool OAIStackSetOperation_OperationPreferences::is_region_order_Set() const{
    return m_region_order_isSet;
}

bool OAIStackSetOperation_OperationPreferences::is_region_order_Valid() const{
    return m_region_order_isValid;
}

qint32 OAIStackSetOperation_OperationPreferences::getFailureToleranceCount() const {
    return m_failure_tolerance_count;
}
void OAIStackSetOperation_OperationPreferences::setFailureToleranceCount(const qint32 &failure_tolerance_count) {
    m_failure_tolerance_count = failure_tolerance_count;
    m_failure_tolerance_count_isSet = true;
}

bool OAIStackSetOperation_OperationPreferences::is_failure_tolerance_count_Set() const{
    return m_failure_tolerance_count_isSet;
}

bool OAIStackSetOperation_OperationPreferences::is_failure_tolerance_count_Valid() const{
    return m_failure_tolerance_count_isValid;
}

qint32 OAIStackSetOperation_OperationPreferences::getFailureTolerancePercentage() const {
    return m_failure_tolerance_percentage;
}
void OAIStackSetOperation_OperationPreferences::setFailureTolerancePercentage(const qint32 &failure_tolerance_percentage) {
    m_failure_tolerance_percentage = failure_tolerance_percentage;
    m_failure_tolerance_percentage_isSet = true;
}

bool OAIStackSetOperation_OperationPreferences::is_failure_tolerance_percentage_Set() const{
    return m_failure_tolerance_percentage_isSet;
}

bool OAIStackSetOperation_OperationPreferences::is_failure_tolerance_percentage_Valid() const{
    return m_failure_tolerance_percentage_isValid;
}

qint32 OAIStackSetOperation_OperationPreferences::getMaxConcurrentCount() const {
    return m_max_concurrent_count;
}
void OAIStackSetOperation_OperationPreferences::setMaxConcurrentCount(const qint32 &max_concurrent_count) {
    m_max_concurrent_count = max_concurrent_count;
    m_max_concurrent_count_isSet = true;
}

bool OAIStackSetOperation_OperationPreferences::is_max_concurrent_count_Set() const{
    return m_max_concurrent_count_isSet;
}

bool OAIStackSetOperation_OperationPreferences::is_max_concurrent_count_Valid() const{
    return m_max_concurrent_count_isValid;
}

qint32 OAIStackSetOperation_OperationPreferences::getMaxConcurrentPercentage() const {
    return m_max_concurrent_percentage;
}
void OAIStackSetOperation_OperationPreferences::setMaxConcurrentPercentage(const qint32 &max_concurrent_percentage) {
    m_max_concurrent_percentage = max_concurrent_percentage;
    m_max_concurrent_percentage_isSet = true;
}

bool OAIStackSetOperation_OperationPreferences::is_max_concurrent_percentage_Set() const{
    return m_max_concurrent_percentage_isSet;
}

bool OAIStackSetOperation_OperationPreferences::is_max_concurrent_percentage_Valid() const{
    return m_max_concurrent_percentage_isValid;
}

bool OAIStackSetOperation_OperationPreferences::isSet() const {
...
bool OAIStackSetOperation_OperationPreferences::isValid() const {
