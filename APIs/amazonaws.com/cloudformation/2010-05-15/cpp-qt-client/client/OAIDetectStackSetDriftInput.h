...
/*
 * OAIDetectStackSetDriftInput.h
 *
 * 
 */

#ifndef OAIDetectStackSetDriftInput_H
#define OAIDetectStackSetDriftInput_H
...
class OAIDetectStackSetDriftInput : public OAIObject {
public:
    OAIDetectStackSetDriftInput();
    OAIDetectStackSetDriftInput(QString json);
    ~OAIDetectStackSetDriftInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectStackSetDriftInput)

#endif // OAIDetectStackSetDriftInput_H
