...
#ifndef OAITestTypeOutput_H
#define OAITestTypeOutput_H
...
class OAITestTypeOutput : public OAIObject {
public:
    OAITestTypeOutput();
    OAITestTypeOutput(QString json);
    ~OAITestTypeOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITestTypeOutput)

#endif // OAITestTypeOutput_H
