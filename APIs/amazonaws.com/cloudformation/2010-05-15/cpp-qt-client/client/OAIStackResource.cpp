...
OAIStackResource::OAIStackResource(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStackResource::OAIStackResource() {
    this->initializeModel();
}

OAIStackResource::~OAIStackResource() {}

void OAIStackResource::initializeModel() {
...
void OAIStackResource::fromJson(QString jsonString) {
...
void OAIStackResource::fromJsonObject(QJsonObject json) {
...
QString OAIStackResource::asJson() const {
...
QJsonObject OAIStackResource::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStackResource::getStackName() const {
    return m_stack_name;
}
void OAIStackResource::setStackName(const QString &stack_name) {
    m_stack_name = stack_name;
    m_stack_name_isSet = true;
}

bool OAIStackResource::is_stack_name_Set() const{
    return m_stack_name_isSet;
}

bool OAIStackResource::is_stack_name_Valid() const{
    return m_stack_name_isValid;
}

QString OAIStackResource::getStackId() const {
    return m_stack_id;
}
void OAIStackResource::setStackId(const QString &stack_id) {
    m_stack_id = stack_id;
    m_stack_id_isSet = true;
}

bool OAIStackResource::is_stack_id_Set() const{
    return m_stack_id_isSet;
}

bool OAIStackResource::is_stack_id_Valid() const{
    return m_stack_id_isValid;
}

QString OAIStackResource::getLogicalResourceId() const {
    return m_logical_resource_id;
}
void OAIStackResource::setLogicalResourceId(const QString &logical_resource_id) {
    m_logical_resource_id = logical_resource_id;
    m_logical_resource_id_isSet = true;
}

bool OAIStackResource::is_logical_resource_id_Set() const{
    return m_logical_resource_id_isSet;
}

bool OAIStackResource::is_logical_resource_id_Valid() const{
    return m_logical_resource_id_isValid;
}

QString OAIStackResource::getPhysicalResourceId() const {
    return m_physical_resource_id;
}
void OAIStackResource::setPhysicalResourceId(const QString &physical_resource_id) {
    m_physical_resource_id = physical_resource_id;
    m_physical_resource_id_isSet = true;
}

bool OAIStackResource::is_physical_resource_id_Set() const{
    return m_physical_resource_id_isSet;
}

bool OAIStackResource::is_physical_resource_id_Valid() const{
    return m_physical_resource_id_isValid;
}

QString OAIStackResource::getResourceType() const {
    return m_resource_type;
}
void OAIStackResource::setResourceType(const QString &resource_type) {
    m_resource_type = resource_type;
    m_resource_type_isSet = true;
}

bool OAIStackResource::is_resource_type_Set() const{
    return m_resource_type_isSet;
}

bool OAIStackResource::is_resource_type_Valid() const{
    return m_resource_type_isValid;
}

QDateTime OAIStackResource::getTimestamp() const {
    return m_timestamp;
}
void OAIStackResource::setTimestamp(const QDateTime &timestamp) {
    m_timestamp = timestamp;
    m_timestamp_isSet = true;
}

bool OAIStackResource::is_timestamp_Set() const{
    return m_timestamp_isSet;
}

bool OAIStackResource::is_timestamp_Valid() const{
    return m_timestamp_isValid;
}

OAIResourceStatus OAIStackResource::getResourceStatus() const {
    return m_resource_status;
}
void OAIStackResource::setResourceStatus(const OAIResourceStatus &resource_status) {
    m_resource_status = resource_status;
    m_resource_status_isSet = true;
}

bool OAIStackResource::is_resource_status_Set() const{
    return m_resource_status_isSet;
}

bool OAIStackResource::is_resource_status_Valid() const{
    return m_resource_status_isValid;
}

QString OAIStackResource::getResourceStatusReason() const {
    return m_resource_status_reason;
}
void OAIStackResource::setResourceStatusReason(const QString &resource_status_reason) {
    m_resource_status_reason = resource_status_reason;
    m_resource_status_reason_isSet = true;
}

bool OAIStackResource::is_resource_status_reason_Set() const{
    return m_resource_status_reason_isSet;
}

bool OAIStackResource::is_resource_status_reason_Valid() const{
    return m_resource_status_reason_isValid;
}

QString OAIStackResource::getDescription() const {
    return m_description;
}
void OAIStackResource::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIStackResource::is_description_Set() const{
    return m_description_isSet;
}

bool OAIStackResource::is_description_Valid() const{
    return m_description_isValid;
}

OAIStackResourceDetail_DriftInformation OAIStackResource::getDriftInformation() const {
    return m_drift_information;
}
void OAIStackResource::setDriftInformation(const OAIStackResourceDetail_DriftInformation &drift_information) {
    m_drift_information = drift_information;
    m_drift_information_isSet = true;
}

bool OAIStackResource::is_drift_information_Set() const{
    return m_drift_information_isSet;
}

bool OAIStackResource::is_drift_information_Valid() const{
    return m_drift_information_isValid;
}

OAIResourceChange_ModuleInfo OAIStackResource::getModuleInfo() const {
    return m_module_info;
}
void OAIStackResource::setModuleInfo(const OAIResourceChange_ModuleInfo &module_info) {
    m_module_info = module_info;
    m_module_info_isSet = true;
}

bool OAIStackResource::is_module_info_Set() const{
    return m_module_info_isSet;
}

bool OAIStackResource::is_module_info_Valid() const{
    return m_module_info_isValid;
}

bool OAIStackResource::isSet() const {
...
bool OAIStackResource::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_logical_resource_id_isValid && m_resource_type_isValid && m_timestamp_isValid && m_resource_status_isValid && true;
}
