...
QString OAIResourceChange::getChangeSetId() const {
    return m_change_set_id;
}
void OAIResourceChange::setChangeSetId(const QString &change_set_id) {
    m_change_set_id = change_set_id;
    m_change_set_id_isSet = true;
}

bool OAIResourceChange::is_change_set_id_Set() const{
    return m_change_set_id_isSet;
}

bool OAIResourceChange::is_change_set_id_Valid() const{
    return m_change_set_id_isValid;
}

OAIResourceChange_ModuleInfo OAIResourceChange::getModuleInfo() const {
    return m_module_info;
}
void OAIResourceChange::setModuleInfo(const OAIResourceChange_ModuleInfo &module_info) {
    m_module_info = module_info;
    m_module_info_isSet = true;
}

bool OAIResourceChange::is_module_info_Set() const{
    return m_module_info_isSet;
}

bool OAIResourceChange::is_module_info_Valid() const{
