...
/*
 * OAIListTypeVersionsInput.h
 *
 * 
 */

#ifndef OAIListTypeVersionsInput_H
#define OAIListTypeVersionsInput_H
...
class OAIListTypeVersionsInput : public OAIObject {
public:
    OAIListTypeVersionsInput();
    OAIListTypeVersionsInput(QString json);
    ~OAIListTypeVersionsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListTypeVersionsInput)

#endif // OAIListTypeVersionsInput_H
