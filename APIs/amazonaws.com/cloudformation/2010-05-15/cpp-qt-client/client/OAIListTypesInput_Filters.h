...
/*
 * OAIListTypesInput_Filters.h
 *
 * 
 */

#ifndef OAIListTypesInput_Filters_H
#define OAIListTypesInput_Filters_H
...
class OAIListTypesInput_Filters : public OAIObject {
public:
    OAIListTypesInput_Filters();
    OAIListTypesInput_Filters(QString json);
    ~OAIListTypesInput_Filters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListTypesInput_Filters)

#endif // OAIListTypesInput_Filters_H
