...
/*
 * OAIPublishTypeInput.h
 *
 * 
 */

#ifndef OAIPublishTypeInput_H
#define OAIPublishTypeInput_H
...
class OAIPublishTypeInput : public OAIObject {
public:
    OAIPublishTypeInput();
    OAIPublishTypeInput(QString json);
    ~OAIPublishTypeInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPublishTypeInput)

#endif // OAIPublishTypeInput_H
