...
/*
 * OAIResourceToImport.h
 *
 * Describes the target resource of an import operation.
 */

#ifndef OAIResourceToImport_H
#define OAIResourceToImport_H
...
class OAIResourceToImport : public OAIObject {
public:
    OAIResourceToImport();
    OAIResourceToImport(QString json);
    ~OAIResourceToImport() override;
    ...
    QMap getResourceIdentifier() const;
    void setResourceIdentifier(const QMap &resource_identifier);
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceToImport)

#endif // OAIResourceToImport_H
