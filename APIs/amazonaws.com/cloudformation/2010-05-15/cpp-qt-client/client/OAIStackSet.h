...
#ifndef OAIStackSet_H
#define OAIStackSet_H
...
class OAIStackSet : public OAIObject {
public:
    OAIStackSet();
    OAIStackSet(QString json);
    ~OAIStackSet() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStackSet)
