...
/*
 * OAIDescribeStackSetOperationOutput_StackSetOperation.h
 *
 * 
 */

#ifndef OAIDescribeStackSetOperationOutput_StackSetOperation_H
#define OAIDescribeStackSetOperationOutput_StackSetOperation_H
...
class OAIDescribeStackSetOperationOutput_StackSetOperation : public OAIObject {
public:
    OAIDescribeStackSetOperationOutput_StackSetOperation();
    OAIDescribeStackSetOperationOutput_StackSetOperation(QString json);
    ~OAIDescribeStackSetOperationOutput_StackSetOperation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeStackSetOperationOutput_StackSetOperation)

#endif // OAIDescribeStackSetOperationOutput_StackSetOperation_H
