...
/*
 * OAIDescribeTypeInput.h
 *
 * 
 */

#ifndef OAIDescribeTypeInput_H
#define OAIDescribeTypeInput_H
...
class OAIDescribeTypeInput : public OAIObject {
public:
    OAIDescribeTypeInput();
    OAIDescribeTypeInput(QString json);
    ~OAIDescribeTypeInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeTypeInput)

#endif // OAIDescribeTypeInput_H
