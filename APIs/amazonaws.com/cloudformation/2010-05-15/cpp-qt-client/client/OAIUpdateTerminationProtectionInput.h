...
/*
 * OAIUpdateTerminationProtectionInput.h
 *
 * 
 */

#ifndef OAIUpdateTerminationProtectionInput_H
#define OAIUpdateTerminationProtectionInput_H
...
class OAIUpdateTerminationProtectionInput : public OAIObject {
public:
    OAIUpdateTerminationProtectionInput();
    OAIUpdateTerminationProtectionInput(QString json);
    ~OAIUpdateTerminationProtectionInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateTerminationProtectionInput)

#endif // OAIUpdateTerminationProtectionInput_H
