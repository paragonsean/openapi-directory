...
/*
 * OAIDescribeChangeSetInput.h
 *
 * The input for the &lt;a&gt;DescribeChangeSet&lt;/a&gt; action.
 */

#ifndef OAIDescribeChangeSetInput_H
#define OAIDescribeChangeSetInput_H
...
class OAIDescribeChangeSetInput : public OAIObject {
public:
    OAIDescribeChangeSetInput();
    OAIDescribeChangeSetInput(QString json);
    ~OAIDescribeChangeSetInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeChangeSetInput)

#endif // OAIDescribeChangeSetInput_H
