...
/*
 * OAIStackInstanceSummary.h
 *
 * The structure that contains summary information about a stack instance.
 */

#ifndef OAIStackInstanceSummary_H
#define OAIStackInstanceSummary_H
...
class OAIStackInstanceSummary : public OAIObject {
public:
    OAIStackInstanceSummary();
    OAIStackInstanceSummary(QString json);
    ~OAIStackInstanceSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStackInstanceSummary)

#endif // OAIStackInstanceSummary_H
