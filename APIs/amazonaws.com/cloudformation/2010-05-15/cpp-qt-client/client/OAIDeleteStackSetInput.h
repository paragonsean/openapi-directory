...
/*
 * OAIDeleteStackSetInput.h
 *
 * 
 */

#ifndef OAIDeleteStackSetInput_H
#define OAIDeleteStackSetInput_H
...
class OAIDeleteStackSetInput : public OAIObject {
public:
    OAIDeleteStackSetInput();
    OAIDeleteStackSetInput(QString json);
    ~OAIDeleteStackSetInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteStackSetInput)

#endif // OAIDeleteStackSetInput_H
