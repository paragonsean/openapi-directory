...
/*
 * OAIDetectStackSetDriftInput_OperationPreferences.h
 *
 * 
 */

#ifndef OAIDetectStackSetDriftInput_OperationPreferences_H
#define OAIDetectStackSetDriftInput_OperationPreferences_H
...
class OAIDetectStackSetDriftInput_OperationPreferences : public OAIObject {
public:
    OAIDetectStackSetDriftInput_OperationPreferences();
    OAIDetectStackSetDriftInput_OperationPreferences(QString json);
    ~OAIDetectStackSetDriftInput_OperationPreferences() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectStackSetDriftInput_OperationPreferences)

#endif // OAIDetectStackSetDriftInput_OperationPreferences_H
