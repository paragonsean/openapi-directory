...
/*
 * OAIExecuteChangeSetInput.h
 *
 * The input for the &lt;a&gt;ExecuteChangeSet&lt;/a&gt; action.
 */

#ifndef OAIExecuteChangeSetInput_H
#define OAIExecuteChangeSetInput_H
...
class OAIExecuteChangeSetInput : public OAIObject {
public:
    OAIExecuteChangeSetInput();
    OAIExecuteChangeSetInput(QString json);
    ~OAIExecuteChangeSetInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExecuteChangeSetInput)

#endif // OAIExecuteChangeSetInput_H
