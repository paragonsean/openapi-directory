...
/*
 * OAICancelUpdateStackInput.h
 *
 * The input for the &lt;a&gt;CancelUpdateStack&lt;/a&gt; action.
 */

#ifndef OAICancelUpdateStackInput_H
#define OAICancelUpdateStackInput_H
...
class OAICancelUpdateStackInput : public OAIObject {
public:
    OAICancelUpdateStackInput();
    OAICancelUpdateStackInput(QString json);
    ~OAICancelUpdateStackInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICancelUpdateStackInput)

#endif // OAICancelUpdateStackInput_H
