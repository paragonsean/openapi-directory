...
/*
 * OAISetTypeDefaultVersionInput.h
 *
 * 
 */

#ifndef OAISetTypeDefaultVersionInput_H
#define OAISetTypeDefaultVersionInput_H
...
class OAISetTypeDefaultVersionInput : public OAIObject {
public:
    OAISetTypeDefaultVersionInput();
    OAISetTypeDefaultVersionInput(QString json);
    ~OAISetTypeDefaultVersionInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetTypeDefaultVersionInput)

#endif // OAISetTypeDefaultVersionInput_H
