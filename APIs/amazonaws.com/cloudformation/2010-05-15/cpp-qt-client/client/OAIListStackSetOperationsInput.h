...
/*
 * OAIListStackSetOperationsInput.h
 *
 * 
 */

#ifndef OAIListStackSetOperationsInput_H
#define OAIListStackSetOperationsInput_H
...
class OAIListStackSetOperationsInput : public OAIObject {
public:
    OAIListStackSetOperationsInput();
    OAIListStackSetOperationsInput(QString json);
    ~OAIListStackSetOperationsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListStackSetOperationsInput)

#endif // OAIListStackSetOperationsInput_H
