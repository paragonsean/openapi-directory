...
/*
 * OAIDescribeStackResourceOutput_StackResourceDetail.h
 *
 * 
 */

#ifndef OAIDescribeStackResourceOutput_StackResourceDetail_H
#define OAIDescribeStackResourceOutput_StackResourceDetail_H
...
class OAIDescribeStackResourceOutput_StackResourceDetail : public OAIObject {
public:
    OAIDescribeStackResourceOutput_StackResourceDetail();
    OAIDescribeStackResourceOutput_StackResourceDetail(QString json);
    ~OAIDescribeStackResourceOutput_StackResourceDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeStackResourceOutput_StackResourceDetail)

#endif // OAIDescribeStackResourceOutput_StackResourceDetail_H
