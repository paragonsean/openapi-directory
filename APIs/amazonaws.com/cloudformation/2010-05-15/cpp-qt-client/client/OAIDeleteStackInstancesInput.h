...
/*
 * OAIDeleteStackInstancesInput.h
 *
 * 
 */

#ifndef OAIDeleteStackInstancesInput_H
#define OAIDeleteStackInstancesInput_H

#include <QJsonObject>

#include "OAICallAs.h"
#include "OAICreateStackInstancesInput_OperationPreferences.h"
#include "OAIDeleteStackInstancesInput_DeploymentTargets.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIDeleteStackInstancesInput_DeploymentTargets;
class OAICreateStackInstancesInput_OperationPreferences;

class OAIDeleteStackInstancesInput : public OAIObject {
public:
    OAIDeleteStackInstancesInput();
    OAIDeleteStackInstancesInput(QString json);
    ~OAIDeleteStackInstancesInput() override;
    ...
    OAIDeleteStackInstancesInput_DeploymentTargets getDeploymentTargets() const;
    void setDeploymentTargets(const OAIDeleteStackInstancesInput_DeploymentTargets &deployment_targets);
...
private:
    ...
    OAIDeleteStackInstancesInput_DeploymentTargets m_deployment_targets;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteStackInstancesInput)

#endif // OAIDeleteStackInstancesInput_H
