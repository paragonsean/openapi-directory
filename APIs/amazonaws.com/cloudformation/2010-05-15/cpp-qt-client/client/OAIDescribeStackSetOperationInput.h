...
/*
 * OAIDescribeStackSetOperationInput.h
 *
 * 
 */

#ifndef OAIDescribeStackSetOperationInput_H
#define OAIDescribeStackSetOperationInput_H
...
class OAIDescribeStackSetOperationInput : public OAIObject {
public:
    OAIDescribeStackSetOperationInput();
    OAIDescribeStackSetOperationInput(QString json);
    ~OAIDescribeStackSetOperationInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeStackSetOperationInput)

#endif // OAIDescribeStackSetOperationInput_H
