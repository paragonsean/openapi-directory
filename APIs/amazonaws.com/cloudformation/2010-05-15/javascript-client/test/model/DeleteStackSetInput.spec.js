...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.DeleteStackSetInput();
  });
  ...
  describe('DeleteStackSetInput', function() {
    it('should create an instance of DeleteStackSetInput', function() {
      // uncomment below and update the code to test DeleteStackSetInput
      //var instance = new AwsCloudFormation.DeleteStackSetInput();
      //expect(instance).to.be.a(AwsCloudFormation.DeleteStackSetInput);
    });
