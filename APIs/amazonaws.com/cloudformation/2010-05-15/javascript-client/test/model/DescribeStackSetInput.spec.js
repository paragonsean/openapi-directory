...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.DescribeStackSetInput();
  });
  ...
  describe('DescribeStackSetInput', function() {
    it('should create an instance of DescribeStackSetInput', function() {
      // uncomment below and update the code to test DescribeStackSetInput
      //var instance = new AwsCloudFormation.DescribeStackSetInput();
      //expect(instance).to.be.a(AwsCloudFormation.DescribeStackSetInput);
    });
