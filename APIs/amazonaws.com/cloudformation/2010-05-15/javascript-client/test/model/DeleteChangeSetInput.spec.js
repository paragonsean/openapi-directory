...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.DeleteChangeSetInput();
  });
  ...
  describe('DeleteChangeSetInput', function() {
    it('should create an instance of DeleteChangeSetInput', function() {
      // uncomment below and update the code to test DeleteChangeSetInput
      //var instance = new AwsCloudFormation.DeleteChangeSetInput();
      //expect(instance).to.be.a(AwsCloudFormation.DeleteChangeSetInput);
    });
