...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.DetectStackSetDriftInput();
  });
  ...
  describe('DetectStackSetDriftInput', function() {
    it('should create an instance of DetectStackSetDriftInput', function() {
      // uncomment below and update the code to test DetectStackSetDriftInput
      //var instance = new AwsCloudFormation.DetectStackSetDriftInput();
      //expect(instance).to.be.a(AwsCloudFormation.DetectStackSetDriftInput);
    });
