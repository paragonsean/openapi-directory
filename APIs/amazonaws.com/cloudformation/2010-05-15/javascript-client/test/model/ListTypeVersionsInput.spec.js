...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.ListTypeVersionsInput();
  });
  ...
  describe('ListTypeVersionsInput', function() {
    it('should create an instance of ListTypeVersionsInput', function() {
      // uncomment below and update the code to test ListTypeVersionsInput
      //var instance = new AwsCloudFormation.ListTypeVersionsInput();
      //expect(instance).to.be.a(AwsCloudFormation.ListTypeVersionsInput);
    });
