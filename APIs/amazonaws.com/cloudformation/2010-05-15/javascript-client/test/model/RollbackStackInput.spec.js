...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.RollbackStackInput();
  });
  ...
  describe('RollbackStackInput', function() {
    it('should create an instance of RollbackStackInput', function() {
      // uncomment below and update the code to test RollbackStackInput
      //var instance = new AwsCloudFormation.RollbackStackInput();
      //expect(instance).to.be.a(AwsCloudFormation.RollbackStackInput);
    });
