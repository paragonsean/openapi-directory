...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.ListChangeSetsInput();
  });
  ...
  describe('ListChangeSetsInput', function() {
    it('should create an instance of ListChangeSetsInput', function() {
      // uncomment below and update the code to test ListChangeSetsInput
      //var instance = new AwsCloudFormation.ListChangeSetsInput();
      //expect(instance).to.be.a(AwsCloudFormation.ListChangeSetsInput);
    });
