...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.UpdateStackInstancesInput();
  });
  ...
  describe('UpdateStackInstancesInput', function() {
    it('should create an instance of UpdateStackInstancesInput', function() {
      // uncomment below and update the code to test UpdateStackInstancesInput
      //var instance = new AwsCloudFormation.UpdateStackInstancesInput();
      //expect(instance).to.be.a(AwsCloudFormation.UpdateStackInstancesInput);
    });
