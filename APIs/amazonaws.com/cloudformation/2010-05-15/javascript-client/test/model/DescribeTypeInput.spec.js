...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.DescribeTypeInput();
  });
  ...
  describe('DescribeTypeInput', function() {
    it('should create an instance of DescribeTypeInput', function() {
      // uncomment below and update the code to test DescribeTypeInput
      //var instance = new AwsCloudFormation.DescribeTypeInput();
      //expect(instance).to.be.a(AwsCloudFormation.DescribeTypeInput);
    });
