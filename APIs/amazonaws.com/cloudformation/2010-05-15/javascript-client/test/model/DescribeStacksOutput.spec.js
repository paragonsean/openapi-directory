...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.DescribeStacksOutput();
  });
  ...
  describe('DescribeStacksOutput', function() {
    it('should create an instance of DescribeStacksOutput', function() {
      // uncomment below and update the code to test DescribeStacksOutput
      //var instance = new AwsCloudFormation.DescribeStacksOutput();
      //expect(instance).to.be.a(AwsCloudFormation.DescribeStacksOutput);
    });
