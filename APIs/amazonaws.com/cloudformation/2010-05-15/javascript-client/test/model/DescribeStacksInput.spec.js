...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.DescribeStacksInput();
  });
  ...
  describe('DescribeStacksInput', function() {
    it('should create an instance of DescribeStacksInput', function() {
      // uncomment below and update the code to test DescribeStacksInput
      //var instance = new AwsCloudFormation.DescribeStacksInput();
      //expect(instance).to.be.a(AwsCloudFormation.DescribeStacksInput);
    });
