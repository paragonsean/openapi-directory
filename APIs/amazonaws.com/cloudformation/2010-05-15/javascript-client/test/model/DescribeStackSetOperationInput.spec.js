...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.DescribeStackSetOperationInput();
  });
  ...
  describe('DescribeStackSetOperationInput', function() {
    it('should create an instance of DescribeStackSetOperationInput', function() {
      // uncomment below and update the code to test DescribeStackSetOperationInput
      //var instance = new AwsCloudFormation.DescribeStackSetOperationInput();
      //expect(instance).to.be.a(AwsCloudFormation.DescribeStackSetOperationInput);
    });
