...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.ListTypesInput();
  });
  ...
  describe('ListTypesInput', function() {
    it('should create an instance of ListTypesInput', function() {
      // uncomment below and update the code to test ListTypesInput
      //var instance = new AwsCloudFormation.ListTypesInput();
      //expect(instance).to.be.a(AwsCloudFormation.ListTypesInput);
    });
