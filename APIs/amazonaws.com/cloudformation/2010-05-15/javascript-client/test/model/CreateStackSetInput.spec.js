...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.CreateStackSetInput();
  });
  ...
  describe('CreateStackSetInput', function() {
    it('should create an instance of CreateStackSetInput', function() {
      // uncomment below and update the code to test CreateStackSetInput
      //var instance = new AwsCloudFormation.CreateStackSetInput();
      //expect(instance).to.be.a(AwsCloudFormation.CreateStackSetInput);
    });
