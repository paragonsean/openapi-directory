...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.ListExportsOutput();
  });
  ...
  describe('ListExportsOutput', function() {
    it('should create an instance of ListExportsOutput', function() {
      // uncomment below and update the code to test ListExportsOutput
      //var instance = new AwsCloudFormation.ListExportsOutput();
      //expect(instance).to.be.a(AwsCloudFormation.ListExportsOutput);
    });
