...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.DescribeChangeSetInput();
  });
  ...
  describe('DescribeChangeSetInput', function() {
    it('should create an instance of DescribeChangeSetInput', function() {
      // uncomment below and update the code to test DescribeChangeSetInput
      //var instance = new AwsCloudFormation.DescribeChangeSetInput();
      //expect(instance).to.be.a(AwsCloudFormation.DescribeChangeSetInput);
    });
