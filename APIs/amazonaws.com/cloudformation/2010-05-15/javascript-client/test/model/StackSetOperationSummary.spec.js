...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.StackSetOperationSummary();
  });
  ...
  describe('StackSetOperationSummary', function() {
    it('should create an instance of StackSetOperationSummary', function() {
      // uncomment below and update the code to test StackSetOperationSummary
      //var instance = new AwsCloudFormation.StackSetOperationSummary();
      //expect(instance).to.be.a(AwsCloudFormation.StackSetOperationSummary);
    });
