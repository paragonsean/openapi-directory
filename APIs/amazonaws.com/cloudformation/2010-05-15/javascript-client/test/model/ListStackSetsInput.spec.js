...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.ListStackSetsInput();
  });
  ...
  describe('ListStackSetsInput', function() {
    it('should create an instance of ListStackSetsInput', function() {
      // uncomment below and update the code to test ListStackSetsInput
      //var instance = new AwsCloudFormation.ListStackSetsInput();
      //expect(instance).to.be.a(AwsCloudFormation.ListStackSetsInput);
    });
