...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.TypeVersionSummary();
  });
  ...
  describe('TypeVersionSummary', function() {
    it('should create an instance of TypeVersionSummary', function() {
      // uncomment below and update the code to test TypeVersionSummary
      //var instance = new AwsCloudFormation.TypeVersionSummary();
      //expect(instance).to.be.a(AwsCloudFormation.TypeVersionSummary);
    });
