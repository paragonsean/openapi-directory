...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.DeleteStackInstancesInput();
  });
  ...
  describe('DeleteStackInstancesInput', function() {
    it('should create an instance of DeleteStackInstancesInput', function() {
      // uncomment below and update the code to test DeleteStackInstancesInput
      //var instance = new AwsCloudFormation.DeleteStackInstancesInput();
      //expect(instance).to.be.a(AwsCloudFormation.DeleteStackInstancesInput);
    });
