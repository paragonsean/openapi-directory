...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.StopStackSetOperationInput();
  });
  ...
  describe('StopStackSetOperationInput', function() {
    it('should create an instance of StopStackSetOperationInput', function() {
      // uncomment below and update the code to test StopStackSetOperationInput
      //var instance = new AwsCloudFormation.StopStackSetOperationInput();
      //expect(instance).to.be.a(AwsCloudFormation.StopStackSetOperationInput);
    });
