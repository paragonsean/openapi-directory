...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.CreateStackInput();
  });
  ...
  describe('CreateStackInput', function() {
    it('should create an instance of CreateStackInput', function() {
      // uncomment below and update the code to test CreateStackInput
      //var instance = new AwsCloudFormation.CreateStackInput();
      //expect(instance).to.be.a(AwsCloudFormation.CreateStackInput);
    });
