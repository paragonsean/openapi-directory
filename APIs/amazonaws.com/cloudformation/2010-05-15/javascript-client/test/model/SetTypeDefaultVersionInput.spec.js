...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.SetTypeDefaultVersionInput();
  });
  ...
  describe('SetTypeDefaultVersionInput', function() {
    it('should create an instance of SetTypeDefaultVersionInput', function() {
      // uncomment below and update the code to test SetTypeDefaultVersionInput
      //var instance = new AwsCloudFormation.SetTypeDefaultVersionInput();
      //expect(instance).to.be.a(AwsCloudFormation.SetTypeDefaultVersionInput);
    });
