...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.DeleteStackInput();
  });
  ...
  describe('DeleteStackInput', function() {
    it('should create an instance of DeleteStackInput', function() {
      // uncomment below and update the code to test DeleteStackInput
      //var instance = new AwsCloudFormation.DeleteStackInput();
      //expect(instance).to.be.a(AwsCloudFormation.DeleteStackInput);
    });
    ...
    it('should have the property retainResources (base name: "RetainResources")', function() {
      // uncomment below and update the code to test the property retainResources
      //var instance = new AwsCloudFormation.DeleteStackInput();
      //expect(instance).to.be();
    });
