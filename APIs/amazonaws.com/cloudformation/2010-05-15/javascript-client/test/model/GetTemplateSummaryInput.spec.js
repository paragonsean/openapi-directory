...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.GetTemplateSummaryInput();
  });
  ...
  describe('GetTemplateSummaryInput', function() {
    it('should create an instance of GetTemplateSummaryInput', function() {
      // uncomment below and update the code to test GetTemplateSummaryInput
      //var instance = new AwsCloudFormation.GetTemplateSummaryInput();
      //expect(instance).to.be.a(AwsCloudFormation.GetTemplateSummaryInput);
    });
    ...
    it('should have the property templateSummaryConfig (base name: "TemplateSummaryConfig")', function() {
      // uncomment below and update the code to test the property templateSummaryConfig
      //var instance = new AwsCloudFormation.GetTemplateSummaryInput();
      //expect(instance).to.be();
    });
