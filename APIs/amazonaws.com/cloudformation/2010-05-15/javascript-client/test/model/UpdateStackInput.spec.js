...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.UpdateStackInput();
  });
  ...
  describe('UpdateStackInput', function() {
    it('should create an instance of UpdateStackInput', function() {
      // uncomment below and update the code to test UpdateStackInput
      //var instance = new AwsCloudFormation.UpdateStackInput();
      //expect(instance).to.be.a(AwsCloudFormation.UpdateStackInput);
    });
    ...
    it('should have the property stackPolicyDuringUpdateBody (base name: "StackPolicyDuringUpdateBody")', function() {
      // uncomment below and update the code to test the property stackPolicyDuringUpdateBody
      //var instance = new AwsCloudFormation.UpdateStackInput();
      //expect(instance).to.be();
    });

    it('should have the property stackPolicyDuringUpdateURL (base name: "StackPolicyDuringUpdateURL")', function() {
      // uncomment below and update the code to test the property stackPolicyDuringUpdateURL
      //var instance = new AwsCloudFormation.UpdateStackInput();
      //expect(instance).to.be();
    });
    ...
    it('should have the property stackPolicyBody (base name: "StackPolicyBody")', function() {
      // uncomment below and update the code to test the property stackPolicyBody
      //var instance = new AwsCloudFormation.UpdateStackInput();
      //expect(instance).to.be();
    });

    it('should have the property stackPolicyURL (base name: "StackPolicyURL")', function() {
      // uncomment below and update the code to test the property stackPolicyURL
      //var instance = new AwsCloudFormation.UpdateStackInput();
      //expect(instance).to.be();
    });
