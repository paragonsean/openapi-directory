...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.DeregisterTypeInput();
  });
  ...
  describe('DeregisterTypeInput', function() {
    it('should create an instance of DeregisterTypeInput', function() {
      // uncomment below and update the code to test DeregisterTypeInput
      //var instance = new AwsCloudFormation.DeregisterTypeInput();
      //expect(instance).to.be.a(AwsCloudFormation.DeregisterTypeInput);
    });
