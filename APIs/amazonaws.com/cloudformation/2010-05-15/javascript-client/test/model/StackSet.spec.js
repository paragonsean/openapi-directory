...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.StackSet();
  });
  ...
  describe('StackSet', function() {
    it('should create an instance of StackSet', function() {
      // uncomment below and update the code to test StackSet
      //var instance = new AwsCloudFormation.StackSet();
      //expect(instance).to.be.a(AwsCloudFormation.StackSet);
    });
