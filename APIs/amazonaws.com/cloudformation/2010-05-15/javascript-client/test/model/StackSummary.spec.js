...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.StackSummary();
  });
  ...
  describe('StackSummary', function() {
    it('should create an instance of StackSummary', function() {
      // uncomment below and update the code to test StackSummary
      //var instance = new AwsCloudFormation.StackSummary();
      //expect(instance).to.be.a(AwsCloudFormation.StackSummary);
    });
