...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.ListStackSetOperationsInput();
  });
  ...
  describe('ListStackSetOperationsInput', function() {
    it('should create an instance of ListStackSetOperationsInput', function() {
      // uncomment below and update the code to test ListStackSetOperationsInput
      //var instance = new AwsCloudFormation.ListStackSetOperationsInput();
      //expect(instance).to.be.a(AwsCloudFormation.ListStackSetOperationsInput);
    });
