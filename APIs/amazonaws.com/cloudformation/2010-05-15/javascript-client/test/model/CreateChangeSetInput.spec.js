...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.CreateChangeSetInput();
  });
  ...
  describe('CreateChangeSetInput', function() {
    it('should create an instance of CreateChangeSetInput', function() {
      // uncomment below and update the code to test CreateChangeSetInput
      //var instance = new AwsCloudFormation.CreateChangeSetInput();
      //expect(instance).to.be.a(AwsCloudFormation.CreateChangeSetInput);
    });
    ...
    it('should have the property changeSetType (base name: "ChangeSetType")', function() {
      // uncomment below and update the code to test the property changeSetType
      //var instance = new AwsCloudFormation.CreateChangeSetInput();
      //expect(instance).to.be();
    });

    it('should have the property resourcesToImport (base name: "ResourcesToImport")', function() {
      // uncomment below and update the code to test the property resourcesToImport
      //var instance = new AwsCloudFormation.CreateChangeSetInput();
      //expect(instance).to.be();
    });
