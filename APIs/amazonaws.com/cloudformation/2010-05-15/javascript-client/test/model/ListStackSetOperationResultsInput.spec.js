...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.ListStackSetOperationResultsInput();
  });
  ...
  describe('ListStackSetOperationResultsInput', function() {
    it('should create an instance of ListStackSetOperationResultsInput', function() {
      // uncomment below and update the code to test ListStackSetOperationResultsInput
      //var instance = new AwsCloudFormation.ListStackSetOperationResultsInput();
      //expect(instance).to.be.a(AwsCloudFormation.ListStackSetOperationResultsInput);
    });
