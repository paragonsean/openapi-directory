...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.ListStackSetsOutput();
  });
  ...
  describe('ListStackSetsOutput', function() {
    it('should create an instance of ListStackSetsOutput', function() {
      // uncomment below and update the code to test ListStackSetsOutput
      //var instance = new AwsCloudFormation.ListStackSetsOutput();
      //expect(instance).to.be.a(AwsCloudFormation.ListStackSetsOutput);
    });
