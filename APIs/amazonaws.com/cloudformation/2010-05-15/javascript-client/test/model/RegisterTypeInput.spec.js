...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.RegisterTypeInput();
  });
  ...
  describe('RegisterTypeInput', function() {
    it('should create an instance of RegisterTypeInput', function() {
      // uncomment below and update the code to test RegisterTypeInput
      //var instance = new AwsCloudFormation.RegisterTypeInput();
      //expect(instance).to.be.a(AwsCloudFormation.RegisterTypeInput);
    });
    ...
    it('should have the property schemaHandlerPackage (base name: "SchemaHandlerPackage")', function() {
      // uncomment below and update the code to test the property schemaHandlerPackage
      //var instance = new AwsCloudFormation.RegisterTypeInput();
      //expect(instance).to.be();
    });
