...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.CancelUpdateStackInput();
  });
  ...
  describe('CancelUpdateStackInput', function() {
    it('should create an instance of CancelUpdateStackInput', function() {
      // uncomment below and update the code to test CancelUpdateStackInput
      //var instance = new AwsCloudFormation.CancelUpdateStackInput();
      //expect(instance).to.be.a(AwsCloudFormation.CancelUpdateStackInput);
    });
