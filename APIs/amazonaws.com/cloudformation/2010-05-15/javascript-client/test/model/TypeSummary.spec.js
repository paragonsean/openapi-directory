...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.TypeSummary();
  });
  ...
  describe('TypeSummary', function() {
    it('should create an instance of TypeSummary', function() {
      // uncomment below and update the code to test TypeSummary
      //var instance = new AwsCloudFormation.TypeSummary();
      //expect(instance).to.be.a(AwsCloudFormation.TypeSummary);
    });
    ...
    it('should have the property publisherIdentity (base name: "PublisherIdentity")', function() {
      // uncomment below and update the code to test the property publisherIdentity
      //var instance = new AwsCloudFormation.TypeSummary();
      //expect(instance).to.be();
    });
