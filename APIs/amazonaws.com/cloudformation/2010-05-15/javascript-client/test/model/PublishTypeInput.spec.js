...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.PublishTypeInput();
  });
  ...
  describe('PublishTypeInput', function() {
    it('should create an instance of PublishTypeInput', function() {
      // uncomment below and update the code to test PublishTypeInput
      //var instance = new AwsCloudFormation.PublishTypeInput();
      //expect(instance).to.be.a(AwsCloudFormation.PublishTypeInput);
    });
