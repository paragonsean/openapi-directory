...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.ListChangeSetsOutput();
  });
  ...
  describe('ListChangeSetsOutput', function() {
    it('should create an instance of ListChangeSetsOutput', function() {
      // uncomment below and update the code to test ListChangeSetsOutput
      //var instance = new AwsCloudFormation.ListChangeSetsOutput();
      //expect(instance).to.be.a(AwsCloudFormation.ListChangeSetsOutput);
    });
