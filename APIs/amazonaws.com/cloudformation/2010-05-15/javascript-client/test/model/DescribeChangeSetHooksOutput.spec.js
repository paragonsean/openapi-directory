...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.DescribeChangeSetHooksOutput();
  });
  ...
  describe('DescribeChangeSetHooksOutput', function() {
    it('should create an instance of DescribeChangeSetHooksOutput', function() {
      // uncomment below and update the code to test DescribeChangeSetHooksOutput
      //var instance = new AwsCloudFormation.DescribeChangeSetHooksOutput();
      //expect(instance).to.be.a(AwsCloudFormation.DescribeChangeSetHooksOutput);
    });
