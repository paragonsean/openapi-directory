...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.ValidateTemplateInput();
  });
  ...
  describe('ValidateTemplateInput', function() {
    it('should create an instance of ValidateTemplateInput', function() {
      // uncomment below and update the code to test ValidateTemplateInput
      //var instance = new AwsCloudFormation.ValidateTemplateInput();
      //expect(instance).to.be.a(AwsCloudFormation.ValidateTemplateInput);
    });
