...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.CreateStackInstancesInput();
  });
  ...
  describe('CreateStackInstancesInput', function() {
    it('should create an instance of CreateStackInstancesInput', function() {
      // uncomment below and update the code to test CreateStackInstancesInput
      //var instance = new AwsCloudFormation.CreateStackInstancesInput();
      //expect(instance).to.be.a(AwsCloudFormation.CreateStackInstancesInput);
    });
