...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.ListStackInstancesInput();
  });
  ...
  describe('ListStackInstancesInput', function() {
    it('should create an instance of ListStackInstancesInput', function() {
      // uncomment below and update the code to test ListStackInstancesInput
      //var instance = new AwsCloudFormation.ListStackInstancesInput();
      //expect(instance).to.be.a(AwsCloudFormation.ListStackInstancesInput);
    });
