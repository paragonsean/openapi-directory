...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.TestTypeInput();
  });
  ...
  describe('TestTypeInput', function() {
    it('should create an instance of TestTypeInput', function() {
      // uncomment below and update the code to test TestTypeInput
      //var instance = new AwsCloudFormation.TestTypeInput();
      //expect(instance).to.be.a(AwsCloudFormation.TestTypeInput);
    });
    ...
    it('should have the property logDeliveryBucket (base name: "LogDeliveryBucket")', function() {
      // uncomment below and update the code to test the property logDeliveryBucket
      //var instance = new AwsCloudFormation.TestTypeInput();
      //expect(instance).to.be();
    });
