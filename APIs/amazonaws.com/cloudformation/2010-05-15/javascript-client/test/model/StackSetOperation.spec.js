...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudFormation.StackSetOperation();
  });
  ...
  describe('StackSetOperation', function() {
    it('should create an instance of StackSetOperation', function() {
      // uncomment below and update the code to test StackSetOperation
      //var instance = new AwsCloudFormation.StackSetOperation();
      //expect(instance).to.be.a(AwsCloudFormation.StackSetOperation);
    });
