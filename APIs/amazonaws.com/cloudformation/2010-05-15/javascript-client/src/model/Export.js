...
class Export {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ExportingStackId')) {
                obj['ExportingStackId'] = ApiClient.convertToType(data['ExportingStackId'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        if (data['ExportingStackId']) { // data not null
          String.validateJSON(data['ExportingStackId']);
        }
...
/**
 * @member {String} ExportingStackId
 */
Export.prototype['ExportingStackId'] = undefined;
 ...
 * @member {String} Value
 */
Export.prototype['Value'] = undefined;
