...
public class StackSetOperationOperationPreferences {
  ...
  public StackSetOperationOperationPreferences() {
  }

  public StackSetOperationOperationPreferences regionConcurrencyType(RegionConcurrencyType regionConcurrencyType) {
  ...
  public StackSetOperationOperationPreferences regionOrder(List regionOrder) {
  ...
  public StackSetOperationOperationPreferences failureToleranceCount(Integer failureToleranceCount) {
  ...
  public StackSetOperationOperationPreferences failureTolerancePercentage(Integer failureTolerancePercentage) {
  ...
  public StackSetOperationOperationPreferences maxConcurrentCount(Integer maxConcurrentCount) {
  ...
  public StackSetOperationOperationPreferences maxConcurrentPercentage(Integer maxConcurrentPercentage) {
  ...
  public boolean equals(Object o) {
    ...
    StackSetOperationOperationPreferences stackSetOperationOperationPreferences = (StackSetOperationOperationPreferences) o;
    return Objects.equals(this.regionConcurrencyType, stackSetOperationOperationPreferences.regionConcurrencyType) &&
        Objects.equals(this.regionOrder, stackSetOperationOperationPreferences.regionOrder) &&
        Objects.equals(this.failureToleranceCount, stackSetOperationOperationPreferences.failureToleranceCount) &&
        Objects.equals(this.failureTolerancePercentage, stackSetOperationOperationPreferences.failureTolerancePercentage) &&
        Objects.equals(this.maxConcurrentCount, stackSetOperationOperationPreferences.maxConcurrentCount) &&
        Objects.equals(this.maxConcurrentPercentage, stackSetOperationOperationPreferences.maxConcurrentPercentage);
  }
  ...
  public String toString() {
    ...
    sb.append("class StackSetOperationOperationPreferences {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StackSetOperationOperationPreferences
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StackSetOperationOperationPreferences.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StackSetOperationOperationPreferences is not found in the empty JSON string", StackSetOperationOperationPreferences.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StackSetOperationOperationPreferences.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StackSetOperationOperationPreferences` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StackSetOperationOperationPreferences.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StackSetOperationOperationPreferences' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StackSetOperationOperationPreferences> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StackSetOperationOperationPreferences.class));

       return (TypeAdapter<T>) new TypeAdapter<StackSetOperationOperationPreferences>() {
           @Override
           public void write(JsonWriter out, StackSetOperationOperationPreferences value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StackSetOperationOperationPreferences read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StackSetOperationOperationPreferences given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StackSetOperationOperationPreferences
   * @throws IOException if the JSON string is invalid with respect to StackSetOperationOperationPreferences
   */
  public static StackSetOperationOperationPreferences fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StackSetOperationOperationPreferences.class);
  }

  /**
   * Convert an instance of StackSetOperationOperationPreferences to an JSON string
   *
   * @return JSON string
   */
