...
public class TypeConfigurationIdentifier {
  ...
  public TypeConfigurationIdentifier typeArn(String typeArn) {
  ...
  public TypeConfigurationIdentifier typeConfigurationAlias(String typeConfigurationAlias) {
  ...
  public TypeConfigurationIdentifier typeConfigurationArn(String typeConfigurationArn) {
  ...
  public TypeConfigurationIdentifier type(ThirdPartyType type) {
    this.type = type;
    return this;
  }
  ...
  public TypeConfigurationIdentifier typeName(String typeName) {
  ...
  public boolean equals(Object o) {
    ...
    TypeConfigurationIdentifier typeConfigurationIdentifier = (TypeConfigurationIdentifier) o;
    return Objects.equals(this.typeArn, typeConfigurationIdentifier.typeArn) &&
        Objects.equals(this.typeConfigurationAlias, typeConfigurationIdentifier.typeConfigurationAlias) &&
        Objects.equals(this.typeConfigurationArn, typeConfigurationIdentifier.typeConfigurationArn) &&
        Objects.equals(this.type, typeConfigurationIdentifier.type) &&
        Objects.equals(this.typeName, typeConfigurationIdentifier.typeName);
  }
  ...
  public String toString() {
    ...
    sb.append("class TypeConfigurationIdentifier {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TypeConfigurationIdentifier
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TypeConfigurationIdentifier.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TypeConfigurationIdentifier is not found in the empty JSON string", TypeConfigurationIdentifier.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TypeConfigurationIdentifier.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TypeConfigurationIdentifier` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TypeConfigurationIdentifier.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TypeConfigurationIdentifier' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TypeConfigurationIdentifier> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TypeConfigurationIdentifier.class));

       return (TypeAdapter<T>) new TypeAdapter<TypeConfigurationIdentifier>() {
           @Override
           public void write(JsonWriter out, TypeConfigurationIdentifier value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TypeConfigurationIdentifier read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TypeConfigurationIdentifier given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TypeConfigurationIdentifier
   * @throws IOException if the JSON string is invalid with respect to TypeConfigurationIdentifier
   */
  public static TypeConfigurationIdentifier fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TypeConfigurationIdentifier.class);
  }

  /**
   * Convert an instance of TypeConfigurationIdentifier to an JSON string
   *
   * @return JSON string
   */
