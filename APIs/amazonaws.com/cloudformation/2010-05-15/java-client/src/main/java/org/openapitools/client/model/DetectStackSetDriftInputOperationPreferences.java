...
public class DetectStackSetDriftInputOperationPreferences {
  ...
  public DetectStackSetDriftInputOperationPreferences() {
  }

  public DetectStackSetDriftInputOperationPreferences regionConcurrencyType(RegionConcurrencyType regionConcurrencyType) {
  ...
  public DetectStackSetDriftInputOperationPreferences regionOrder(List regionOrder) {
  ...
  public DetectStackSetDriftInputOperationPreferences failureToleranceCount(Integer failureToleranceCount) {
  ...
  public DetectStackSetDriftInputOperationPreferences failureTolerancePercentage(Integer failureTolerancePercentage) {
  ...
  public DetectStackSetDriftInputOperationPreferences maxConcurrentCount(Integer maxConcurrentCount) {
  ...
  public DetectStackSetDriftInputOperationPreferences maxConcurrentPercentage(Integer maxConcurrentPercentage) {
  ...
  public boolean equals(Object o) {
    ...
    DetectStackSetDriftInputOperationPreferences detectStackSetDriftInputOperationPreferences = (DetectStackSetDriftInputOperationPreferences) o;
    return Objects.equals(this.regionConcurrencyType, detectStackSetDriftInputOperationPreferences.regionConcurrencyType) &&
        Objects.equals(this.regionOrder, detectStackSetDriftInputOperationPreferences.regionOrder) &&
        Objects.equals(this.failureToleranceCount, detectStackSetDriftInputOperationPreferences.failureToleranceCount) &&
        Objects.equals(this.failureTolerancePercentage, detectStackSetDriftInputOperationPreferences.failureTolerancePercentage) &&
        Objects.equals(this.maxConcurrentCount, detectStackSetDriftInputOperationPreferences.maxConcurrentCount) &&
        Objects.equals(this.maxConcurrentPercentage, detectStackSetDriftInputOperationPreferences.maxConcurrentPercentage);
  }
  ...
  public String toString() {
    ...
    sb.append("class DetectStackSetDriftInputOperationPreferences {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectStackSetDriftInputOperationPreferences
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectStackSetDriftInputOperationPreferences.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectStackSetDriftInputOperationPreferences is not found in the empty JSON string", DetectStackSetDriftInputOperationPreferences.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectStackSetDriftInputOperationPreferences.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectStackSetDriftInputOperationPreferences` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectStackSetDriftInputOperationPreferences.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectStackSetDriftInputOperationPreferences' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectStackSetDriftInputOperationPreferences> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectStackSetDriftInputOperationPreferences.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectStackSetDriftInputOperationPreferences>() {
           @Override
           public void write(JsonWriter out, DetectStackSetDriftInputOperationPreferences value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectStackSetDriftInputOperationPreferences read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectStackSetDriftInputOperationPreferences given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectStackSetDriftInputOperationPreferences
   * @throws IOException if the JSON string is invalid with respect to DetectStackSetDriftInputOperationPreferences
   */
  public static DetectStackSetDriftInputOperationPreferences fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectStackSetDriftInputOperationPreferences.class);
  }

  /**
   * Convert an instance of DetectStackSetDriftInputOperationPreferences to an JSON string
   *
   * @return JSON string
   */
