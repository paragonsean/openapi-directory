...
public class StackSetOperation {
  ...
  public StackSetOperation operationId(String operationId) {
  ...
  public StackSetOperation stackSetId(String stackSetId) {
  ...
  public StackSetOperation action(StackSetOperationAction action) {
    this.action = action;
    return this;
  }
  ...
  public StackSetOperation status(StackSetOperationStatus status) {
    this.status = status;
    return this;
  }
  ...
  public StackSetOperation operationPreferences(StackSetOperationOperationPreferences operationPreferences) {
  ...
  public StackSetOperation retainStacks(Boolean retainStacks) {
  ...
  public StackSetOperation administrationRoleARN(String administrationRoleARN) {
  ...
  public StackSetOperation executionRoleName(String executionRoleName) {
  ...
  public StackSetOperation creationTimestamp(OffsetDateTime creationTimestamp) {
  ...
  public StackSetOperation endTimestamp(OffsetDateTime endTimestamp) {
  ...
  public StackSetOperation deploymentTargets(StackSetOperationDeploymentTargets deploymentTargets) {
  ...
  public StackSetOperation stackSetDriftDetectionDetails(StackSetOperationStackSetDriftDetectionDetails stackSetDriftDetectionDetails) {
  ...
  public StackSetOperation statusReason(String statusReason) {
  ...
  public StackSetOperation statusDetails(StackSetOperationStatusDetails statusDetails) {
  ...
  public boolean equals(Object o) {
    ...
    StackSetOperation stackSetOperation = (StackSetOperation) o;
    return Objects.equals(this.operationId, stackSetOperation.operationId) &&
        Objects.equals(this.stackSetId, stackSetOperation.stackSetId) &&
        Objects.equals(this.action, stackSetOperation.action) &&
        Objects.equals(this.status, stackSetOperation.status) &&
        Objects.equals(this.operationPreferences, stackSetOperation.operationPreferences) &&
        Objects.equals(this.retainStacks, stackSetOperation.retainStacks) &&
        Objects.equals(this.administrationRoleARN, stackSetOperation.administrationRoleARN) &&
        Objects.equals(this.executionRoleName, stackSetOperation.executionRoleName) &&
        Objects.equals(this.creationTimestamp, stackSetOperation.creationTimestamp) &&
        Objects.equals(this.endTimestamp, stackSetOperation.endTimestamp) &&
        Objects.equals(this.deploymentTargets, stackSetOperation.deploymentTargets) &&
        Objects.equals(this.stackSetDriftDetectionDetails, stackSetOperation.stackSetDriftDetectionDetails) &&
        Objects.equals(this.statusReason, stackSetOperation.statusReason) &&
        Objects.equals(this.statusDetails, stackSetOperation.statusDetails);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to StackSetOperation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StackSetOperation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StackSetOperation is not found in the empty JSON string", StackSetOperation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StackSetOperation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StackSetOperation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StackSetOperation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StackSetOperation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StackSetOperation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StackSetOperation.class));

       return (TypeAdapter<T>) new TypeAdapter<StackSetOperation>() {
           @Override
           public void write(JsonWriter out, StackSetOperation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StackSetOperation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StackSetOperation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StackSetOperation
   * @throws IOException if the JSON string is invalid with respect to StackSetOperation
   */
  public static StackSetOperation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StackSetOperation.class);
  }

  /**
   * Convert an instance of StackSetOperation to an JSON string
   *
   * @return JSON string
   */
