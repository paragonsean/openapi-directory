...
public class StackSetStackSetDriftDetectionDetails {
  ...
  public StackSetStackSetDriftDetectionDetails() {
  }

  public StackSetStackSetDriftDetectionDetails driftStatus(StackSetDriftStatus driftStatus) {
  ...
  public StackSetStackSetDriftDetectionDetails driftDetectionStatus(StackSetDriftDetectionStatus driftDetectionStatus) {
  ...
  public StackSetStackSetDriftDetectionDetails lastDriftCheckTimestamp(OffsetDateTime lastDriftCheckTimestamp) {
  ...
  public StackSetStackSetDriftDetectionDetails totalStackInstancesCount(Integer totalStackInstancesCount) {
  ...
  public StackSetStackSetDriftDetectionDetails driftedStackInstancesCount(Integer driftedStackInstancesCount) {
  ...
  public StackSetStackSetDriftDetectionDetails inSyncStackInstancesCount(Integer inSyncStackInstancesCount) {
  ...
  public StackSetStackSetDriftDetectionDetails inProgressStackInstancesCount(Integer inProgressStackInstancesCount) {
  ...
  public StackSetStackSetDriftDetectionDetails failedStackInstancesCount(Integer failedStackInstancesCount) {
  ...
  public boolean equals(Object o) {
    ...
    StackSetStackSetDriftDetectionDetails stackSetStackSetDriftDetectionDetails = (StackSetStackSetDriftDetectionDetails) o;
    return Objects.equals(this.driftStatus, stackSetStackSetDriftDetectionDetails.driftStatus) &&
        Objects.equals(this.driftDetectionStatus, stackSetStackSetDriftDetectionDetails.driftDetectionStatus) &&
        Objects.equals(this.lastDriftCheckTimestamp, stackSetStackSetDriftDetectionDetails.lastDriftCheckTimestamp) &&
        Objects.equals(this.totalStackInstancesCount, stackSetStackSetDriftDetectionDetails.totalStackInstancesCount) &&
        Objects.equals(this.driftedStackInstancesCount, stackSetStackSetDriftDetectionDetails.driftedStackInstancesCount) &&
        Objects.equals(this.inSyncStackInstancesCount, stackSetStackSetDriftDetectionDetails.inSyncStackInstancesCount) &&
        Objects.equals(this.inProgressStackInstancesCount, stackSetStackSetDriftDetectionDetails.inProgressStackInstancesCount) &&
        Objects.equals(this.failedStackInstancesCount, stackSetStackSetDriftDetectionDetails.failedStackInstancesCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class StackSetStackSetDriftDetectionDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StackSetStackSetDriftDetectionDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StackSetStackSetDriftDetectionDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StackSetStackSetDriftDetectionDetails is not found in the empty JSON string", StackSetStackSetDriftDetectionDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StackSetStackSetDriftDetectionDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StackSetStackSetDriftDetectionDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StackSetStackSetDriftDetectionDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StackSetStackSetDriftDetectionDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StackSetStackSetDriftDetectionDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StackSetStackSetDriftDetectionDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<StackSetStackSetDriftDetectionDetails>() {
           @Override
           public void write(JsonWriter out, StackSetStackSetDriftDetectionDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StackSetStackSetDriftDetectionDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StackSetStackSetDriftDetectionDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StackSetStackSetDriftDetectionDetails
   * @throws IOException if the JSON string is invalid with respect to StackSetStackSetDriftDetectionDetails
   */
  public static StackSetStackSetDriftDetectionDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StackSetStackSetDriftDetectionDetails.class);
  }

  /**
   * Convert an instance of StackSetStackSetDriftDetectionDetails to an JSON string
   *
   * @return JSON string
   */
