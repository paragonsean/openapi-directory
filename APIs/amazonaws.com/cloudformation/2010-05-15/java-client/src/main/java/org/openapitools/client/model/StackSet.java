...
public class StackSet {
  ...
  public StackSet stackSetName(String stackSetName) {
  ...
  public StackSet stackSetId(String stackSetId) {
  ...
  public StackSet description(String description) {
  ...
  public StackSet status(StackSetStatus status) {
    this.status = status;
    return this;
  }
  ...
  public StackSet templateBody(String templateBody) {
  ...
  public StackSet parameters(List parameters) {
  ...
  public StackSet capabilities(List capabilities) {
  ...
  public StackSet tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public StackSet stackSetARN(String stackSetARN) {
  ...
  public StackSet administrationRoleARN(String administrationRoleARN) {
  ...
  public StackSet executionRoleName(String executionRoleName) {
  ...
  public StackSet stackSetDriftDetectionDetails(StackSetStackSetDriftDetectionDetails stackSetDriftDetectionDetails) {
  ...
  public StackSet autoDeployment(StackSetAutoDeployment autoDeployment) {
  ...
  public StackSet permissionModel(PermissionModels permissionModel) {
  ...
  public StackSet organizationalUnitIds(List organizationalUnitIds) {
  ...
  public StackSet managedExecution(CreateStackSetInputManagedExecution managedExecution) {
  ...
  public StackSet regions(List regions) {
  ...
  public boolean equals(Object o) {
    ...
    StackSet stackSet = (StackSet) o;
    return Objects.equals(this.stackSetName, stackSet.stackSetName) &&
        Objects.equals(this.stackSetId, stackSet.stackSetId) &&
        Objects.equals(this.description, stackSet.description) &&
        Objects.equals(this.status, stackSet.status) &&
        Objects.equals(this.templateBody, stackSet.templateBody) &&
        Objects.equals(this.parameters, stackSet.parameters) &&
        Objects.equals(this.capabilities, stackSet.capabilities) &&
        Objects.equals(this.tags, stackSet.tags) &&
        Objects.equals(this.stackSetARN, stackSet.stackSetARN) &&
        Objects.equals(this.administrationRoleARN, stackSet.administrationRoleARN) &&
        Objects.equals(this.executionRoleName, stackSet.executionRoleName) &&
        Objects.equals(this.stackSetDriftDetectionDetails, stackSet.stackSetDriftDetectionDetails) &&
        Objects.equals(this.autoDeployment, stackSet.autoDeployment) &&
        Objects.equals(this.permissionModel, stackSet.permissionModel) &&
        Objects.equals(this.organizationalUnitIds, stackSet.organizationalUnitIds) &&
        Objects.equals(this.managedExecution, stackSet.managedExecution) &&
        Objects.equals(this.regions, stackSet.regions);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to StackSet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StackSet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StackSet is not found in the empty JSON string", StackSet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StackSet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StackSet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StackSet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StackSet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StackSet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StackSet.class));

       return (TypeAdapter<T>) new TypeAdapter<StackSet>() {
           @Override
           public void write(JsonWriter out, StackSet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StackSet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StackSet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StackSet
   * @throws IOException if the JSON string is invalid with respect to StackSet
   */
  public static StackSet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StackSet.class);
  }

  /**
   * Convert an instance of StackSet to an JSON string
   *
   * @return JSON string
   */
