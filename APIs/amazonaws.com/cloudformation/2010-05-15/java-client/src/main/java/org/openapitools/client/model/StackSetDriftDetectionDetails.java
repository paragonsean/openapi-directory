...
public class StackSetDriftDetectionDetails {
  ...
  public StackSetDriftDetectionDetails driftStatus(StackSetDriftStatus driftStatus) {
  ...
  public StackSetDriftDetectionDetails driftDetectionStatus(StackSetDriftDetectionStatus driftDetectionStatus) {
  ...
  public StackSetDriftDetectionDetails lastDriftCheckTimestamp(OffsetDateTime lastDriftCheckTimestamp) {
  ...
  public StackSetDriftDetectionDetails totalStackInstancesCount(Integer totalStackInstancesCount) {
  ...
  public StackSetDriftDetectionDetails driftedStackInstancesCount(Integer driftedStackInstancesCount) {
  ...
  public StackSetDriftDetectionDetails inSyncStackInstancesCount(Integer inSyncStackInstancesCount) {
  ...
  public StackSetDriftDetectionDetails inProgressStackInstancesCount(Integer inProgressStackInstancesCount) {
  ...
  public StackSetDriftDetectionDetails failedStackInstancesCount(Integer failedStackInstancesCount) {
  ...
  public boolean equals(Object o) {
    ...
    StackSetDriftDetectionDetails stackSetDriftDetectionDetails = (StackSetDriftDetectionDetails) o;
    return Objects.equals(this.driftStatus, stackSetDriftDetectionDetails.driftStatus) &&
        Objects.equals(this.driftDetectionStatus, stackSetDriftDetectionDetails.driftDetectionStatus) &&
        Objects.equals(this.lastDriftCheckTimestamp, stackSetDriftDetectionDetails.lastDriftCheckTimestamp) &&
        Objects.equals(this.totalStackInstancesCount, stackSetDriftDetectionDetails.totalStackInstancesCount) &&
        Objects.equals(this.driftedStackInstancesCount, stackSetDriftDetectionDetails.driftedStackInstancesCount) &&
        Objects.equals(this.inSyncStackInstancesCount, stackSetDriftDetectionDetails.inSyncStackInstancesCount) &&
        Objects.equals(this.inProgressStackInstancesCount, stackSetDriftDetectionDetails.inProgressStackInstancesCount) &&
        Objects.equals(this.failedStackInstancesCount, stackSetDriftDetectionDetails.failedStackInstancesCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class StackSetDriftDetectionDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StackSetDriftDetectionDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StackSetDriftDetectionDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StackSetDriftDetectionDetails is not found in the empty JSON string", StackSetDriftDetectionDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StackSetDriftDetectionDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StackSetDriftDetectionDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StackSetDriftDetectionDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StackSetDriftDetectionDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StackSetDriftDetectionDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StackSetDriftDetectionDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<StackSetDriftDetectionDetails>() {
           @Override
           public void write(JsonWriter out, StackSetDriftDetectionDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StackSetDriftDetectionDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StackSetDriftDetectionDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StackSetDriftDetectionDetails
   * @throws IOException if the JSON string is invalid with respect to StackSetDriftDetectionDetails
   */
  public static StackSetDriftDetectionDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StackSetDriftDetectionDetails.class);
  }

  /**
   * Convert an instance of StackSetDriftDetectionDetails to an JSON string
   *
   * @return JSON string
   */
