...
public class CreateStackInstancesInputOperationPreferences {
  ...
  public CreateStackInstancesInputOperationPreferences() {
  }

  public CreateStackInstancesInputOperationPreferences regionConcurrencyType(RegionConcurrencyType regionConcurrencyType) {
  ...
  public CreateStackInstancesInputOperationPreferences regionOrder(List regionOrder) {
  ...
  public CreateStackInstancesInputOperationPreferences failureToleranceCount(Integer failureToleranceCount) {
  ...
  public CreateStackInstancesInputOperationPreferences failureTolerancePercentage(Integer failureTolerancePercentage) {
  ...
  public CreateStackInstancesInputOperationPreferences maxConcurrentCount(Integer maxConcurrentCount) {
  ...
  public CreateStackInstancesInputOperationPreferences maxConcurrentPercentage(Integer maxConcurrentPercentage) {
  ...
  public boolean equals(Object o) {
    ...
    CreateStackInstancesInputOperationPreferences createStackInstancesInputOperationPreferences = (CreateStackInstancesInputOperationPreferences) o;
    return Objects.equals(this.regionConcurrencyType, createStackInstancesInputOperationPreferences.regionConcurrencyType) &&
        Objects.equals(this.regionOrder, createStackInstancesInputOperationPreferences.regionOrder) &&
        Objects.equals(this.failureToleranceCount, createStackInstancesInputOperationPreferences.failureToleranceCount) &&
        Objects.equals(this.failureTolerancePercentage, createStackInstancesInputOperationPreferences.failureTolerancePercentage) &&
        Objects.equals(this.maxConcurrentCount, createStackInstancesInputOperationPreferences.maxConcurrentCount) &&
        Objects.equals(this.maxConcurrentPercentage, createStackInstancesInputOperationPreferences.maxConcurrentPercentage);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateStackInstancesInputOperationPreferences {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateStackInstancesInputOperationPreferences
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateStackInstancesInputOperationPreferences.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateStackInstancesInputOperationPreferences is not found in the empty JSON string", CreateStackInstancesInputOperationPreferences.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateStackInstancesInputOperationPreferences.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateStackInstancesInputOperationPreferences` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateStackInstancesInputOperationPreferences.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateStackInstancesInputOperationPreferences' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateStackInstancesInputOperationPreferences> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateStackInstancesInputOperationPreferences.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateStackInstancesInputOperationPreferences>() {
           @Override
           public void write(JsonWriter out, CreateStackInstancesInputOperationPreferences value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateStackInstancesInputOperationPreferences read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateStackInstancesInputOperationPreferences given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateStackInstancesInputOperationPreferences
   * @throws IOException if the JSON string is invalid with respect to CreateStackInstancesInputOperationPreferences
   */
  public static CreateStackInstancesInputOperationPreferences fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateStackInstancesInputOperationPreferences.class);
  }

  /**
   * Convert an instance of CreateStackInstancesInputOperationPreferences to an JSON string
   *
   * @return JSON string
   */
