...
public class StackResource {
  ...
  public StackResource stackName(String stackName) {
  ...
  public StackResource stackId(String stackId) {
  ...
  public StackResource logicalResourceId(String logicalResourceId) {
  ...
  public StackResource physicalResourceId(String physicalResourceId) {
  ...
  public StackResource resourceType(String resourceType) {
  ...
  public StackResource timestamp(OffsetDateTime timestamp) {
  ...
  public StackResource resourceStatus(ResourceStatus resourceStatus) {
  ...
  public StackResource resourceStatusReason(String resourceStatusReason) {
  ...
  public StackResource description(String description) {
  ...
  public StackResource driftInformation(StackResourceDetailDriftInformation driftInformation) {
  ...
  public StackResource moduleInfo(ResourceChangeModuleInfo moduleInfo) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.stackName, stackResource.stackName) &&
        Objects.equals(this.stackId, stackResource.stackId) &&
        Objects.equals(this.logicalResourceId, stackResource.logicalResourceId) &&
        Objects.equals(this.physicalResourceId, stackResource.physicalResourceId) &&
        Objects.equals(this.resourceType, stackResource.resourceType) &&
        Objects.equals(this.timestamp, stackResource.timestamp) &&
        Objects.equals(this.resourceStatus, stackResource.resourceStatus) &&
        Objects.equals(this.resourceStatusReason, stackResource.resourceStatusReason) &&
        Objects.equals(this.description, stackResource.description) &&
        Objects.equals(this.driftInformation, stackResource.driftInformation) &&
        Objects.equals(this.moduleInfo, stackResource.moduleInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(stackName, stackId, logicalResourceId, physicalResourceId, resourceType, timestamp, resourceStatus, resourceStatusReason, description, driftInformation, moduleInfo);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to StackResource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StackResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StackResource is not found in the empty JSON string", StackResource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StackResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StackResource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StackResource.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StackResource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StackResource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StackResource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StackResource.class));

       return (TypeAdapter<T>) new TypeAdapter<StackResource>() {
           @Override
           public void write(JsonWriter out, StackResource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StackResource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StackResource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StackResource
   * @throws IOException if the JSON string is invalid with respect to StackResource
   */
  public static StackResource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StackResource.class);
  }

  /**
   * Convert an instance of StackResource to an JSON string
   *
   * @return JSON string
   */
