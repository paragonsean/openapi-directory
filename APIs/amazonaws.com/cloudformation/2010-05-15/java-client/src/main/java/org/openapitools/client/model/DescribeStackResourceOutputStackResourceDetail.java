...
public class DescribeStackResourceOutputStackResourceDetail {
  ...
  public DescribeStackResourceOutputStackResourceDetail() {
  }

  public DescribeStackResourceOutputStackResourceDetail stackName(String stackName) {
  ...
  public DescribeStackResourceOutputStackResourceDetail stackId(String stackId) {
  ...
  public DescribeStackResourceOutputStackResourceDetail logicalResourceId(String logicalResourceId) {
  ...
  public DescribeStackResourceOutputStackResourceDetail physicalResourceId(String physicalResourceId) {
  ...
  public DescribeStackResourceOutputStackResourceDetail resourceType(String resourceType) {
  ...
  public DescribeStackResourceOutputStackResourceDetail lastUpdatedTimestamp(OffsetDateTime lastUpdatedTimestamp) {
  ...
  public DescribeStackResourceOutputStackResourceDetail resourceStatus(ResourceStatus resourceStatus) {
  ...
  public DescribeStackResourceOutputStackResourceDetail resourceStatusReason(String resourceStatusReason) {
  ...
  public DescribeStackResourceOutputStackResourceDetail description(String description) {
  ...
  public DescribeStackResourceOutputStackResourceDetail metadata(String metadata) {
  ...
  public DescribeStackResourceOutputStackResourceDetail driftInformation(StackResourceDetailDriftInformation driftInformation) {
  ...
  public DescribeStackResourceOutputStackResourceDetail moduleInfo(ResourceChangeModuleInfo moduleInfo) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeStackResourceOutputStackResourceDetail describeStackResourceOutputStackResourceDetail = (DescribeStackResourceOutputStackResourceDetail) o;
    return Objects.equals(this.stackName, describeStackResourceOutputStackResourceDetail.stackName) &&
        Objects.equals(this.stackId, describeStackResourceOutputStackResourceDetail.stackId) &&
        Objects.equals(this.logicalResourceId, describeStackResourceOutputStackResourceDetail.logicalResourceId) &&
        Objects.equals(this.physicalResourceId, describeStackResourceOutputStackResourceDetail.physicalResourceId) &&
        Objects.equals(this.resourceType, describeStackResourceOutputStackResourceDetail.resourceType) &&
        Objects.equals(this.lastUpdatedTimestamp, describeStackResourceOutputStackResourceDetail.lastUpdatedTimestamp) &&
        Objects.equals(this.resourceStatus, describeStackResourceOutputStackResourceDetail.resourceStatus) &&
        Objects.equals(this.resourceStatusReason, describeStackResourceOutputStackResourceDetail.resourceStatusReason) &&
        Objects.equals(this.description, describeStackResourceOutputStackResourceDetail.description) &&
        Objects.equals(this.metadata, describeStackResourceOutputStackResourceDetail.metadata) &&
        Objects.equals(this.driftInformation, describeStackResourceOutputStackResourceDetail.driftInformation) &&
        Objects.equals(this.moduleInfo, describeStackResourceOutputStackResourceDetail.moduleInfo);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeStackResourceOutputStackResourceDetail {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeStackResourceOutputStackResourceDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeStackResourceOutputStackResourceDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeStackResourceOutputStackResourceDetail is not found in the empty JSON string", DescribeStackResourceOutputStackResourceDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeStackResourceOutputStackResourceDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeStackResourceOutputStackResourceDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeStackResourceOutputStackResourceDetail.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeStackResourceOutputStackResourceDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeStackResourceOutputStackResourceDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeStackResourceOutputStackResourceDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeStackResourceOutputStackResourceDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeStackResourceOutputStackResourceDetail>() {
           @Override
           public void write(JsonWriter out, DescribeStackResourceOutputStackResourceDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeStackResourceOutputStackResourceDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeStackResourceOutputStackResourceDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeStackResourceOutputStackResourceDetail
   * @throws IOException if the JSON string is invalid with respect to DescribeStackResourceOutputStackResourceDetail
   */
  public static DescribeStackResourceOutputStackResourceDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeStackResourceOutputStackResourceDetail.class);
  }

  /**
   * Convert an instance of DescribeStackResourceOutputStackResourceDetail to an JSON string
   *
   * @return JSON string
   */
