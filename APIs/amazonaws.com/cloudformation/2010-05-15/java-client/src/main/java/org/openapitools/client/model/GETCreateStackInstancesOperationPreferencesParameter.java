...
public class GETCreateStackInstancesOperationPreferencesParameter {
  ...
  public GETCreateStackInstancesOperationPreferencesParameter() {
  }

  public GETCreateStackInstancesOperationPreferencesParameter regionConcurrencyType(RegionConcurrencyType regionConcurrencyType) {
  ...
  public GETCreateStackInstancesOperationPreferencesParameter regionOrder(List regionOrder) {
  ...
  public GETCreateStackInstancesOperationPreferencesParameter failureToleranceCount(Integer failureToleranceCount) {
  ...
  public GETCreateStackInstancesOperationPreferencesParameter failureTolerancePercentage(Integer failureTolerancePercentage) {
  ...
  public GETCreateStackInstancesOperationPreferencesParameter maxConcurrentCount(Integer maxConcurrentCount) {
  ...
  public GETCreateStackInstancesOperationPreferencesParameter maxConcurrentPercentage(Integer maxConcurrentPercentage) {
  ...
  public boolean equals(Object o) {
    ...
    GETCreateStackInstancesOperationPreferencesParameter geTCreateStackInstancesOperationPreferencesParameter = (GETCreateStackInstancesOperationPreferencesParameter) o;
    return Objects.equals(this.regionConcurrencyType, geTCreateStackInstancesOperationPreferencesParameter.regionConcurrencyType) &&
        Objects.equals(this.regionOrder, geTCreateStackInstancesOperationPreferencesParameter.regionOrder) &&
        Objects.equals(this.failureToleranceCount, geTCreateStackInstancesOperationPreferencesParameter.failureToleranceCount) &&
        Objects.equals(this.failureTolerancePercentage, geTCreateStackInstancesOperationPreferencesParameter.failureTolerancePercentage) &&
        Objects.equals(this.maxConcurrentCount, geTCreateStackInstancesOperationPreferencesParameter.maxConcurrentCount) &&
        Objects.equals(this.maxConcurrentPercentage, geTCreateStackInstancesOperationPreferencesParameter.maxConcurrentPercentage);
  }
  ...
  public String toString() {
    ...
    sb.append("class GETCreateStackInstancesOperationPreferencesParameter {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GETCreateStackInstancesOperationPreferencesParameter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GETCreateStackInstancesOperationPreferencesParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GETCreateStackInstancesOperationPreferencesParameter is not found in the empty JSON string", GETCreateStackInstancesOperationPreferencesParameter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GETCreateStackInstancesOperationPreferencesParameter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GETCreateStackInstancesOperationPreferencesParameter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GETCreateStackInstancesOperationPreferencesParameter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GETCreateStackInstancesOperationPreferencesParameter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GETCreateStackInstancesOperationPreferencesParameter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GETCreateStackInstancesOperationPreferencesParameter.class));

       return (TypeAdapter<T>) new TypeAdapter<GETCreateStackInstancesOperationPreferencesParameter>() {
           @Override
           public void write(JsonWriter out, GETCreateStackInstancesOperationPreferencesParameter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GETCreateStackInstancesOperationPreferencesParameter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GETCreateStackInstancesOperationPreferencesParameter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GETCreateStackInstancesOperationPreferencesParameter
   * @throws IOException if the JSON string is invalid with respect to GETCreateStackInstancesOperationPreferencesParameter
   */
  public static GETCreateStackInstancesOperationPreferencesParameter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GETCreateStackInstancesOperationPreferencesParameter.class);
  }

  /**
   * Convert an instance of GETCreateStackInstancesOperationPreferencesParameter to an JSON string
   *
   * @return JSON string
   */
