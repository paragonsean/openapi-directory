...
public class StackInstanceResourceDriftsSummary {
  ...
  public StackInstanceResourceDriftsSummary() {
  }

  public StackInstanceResourceDriftsSummary stackId(String stackId) {
  ...
  public StackInstanceResourceDriftsSummary logicalResourceId(String logicalResourceId) {
  ...
  public StackInstanceResourceDriftsSummary physicalResourceId(String physicalResourceId) {
  ...
  public StackInstanceResourceDriftsSummary physicalResourceIdContext(List physicalResourceIdContext) {
  ...
  public StackInstanceResourceDriftsSummary resourceType(String resourceType) {
  ...
  public StackInstanceResourceDriftsSummary propertyDifferences(List propertyDifferences) {
  ...
  public StackInstanceResourceDriftsSummary stackResourceDriftStatus(StackResourceDriftStatus stackResourceDriftStatus) {
  ...
  public StackInstanceResourceDriftsSummary timestamp(OffsetDateTime timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    StackInstanceResourceDriftsSummary stackInstanceResourceDriftsSummary = (StackInstanceResourceDriftsSummary) o;
    return Objects.equals(this.stackId, stackInstanceResourceDriftsSummary.stackId) &&
        Objects.equals(this.logicalResourceId, stackInstanceResourceDriftsSummary.logicalResourceId) &&
        Objects.equals(this.physicalResourceId, stackInstanceResourceDriftsSummary.physicalResourceId) &&
        Objects.equals(this.physicalResourceIdContext, stackInstanceResourceDriftsSummary.physicalResourceIdContext) &&
        Objects.equals(this.resourceType, stackInstanceResourceDriftsSummary.resourceType) &&
        Objects.equals(this.propertyDifferences, stackInstanceResourceDriftsSummary.propertyDifferences) &&
        Objects.equals(this.stackResourceDriftStatus, stackInstanceResourceDriftsSummary.stackResourceDriftStatus) &&
        Objects.equals(this.timestamp, stackInstanceResourceDriftsSummary.timestamp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(stackId, logicalResourceId, physicalResourceId, physicalResourceIdContext, resourceType, propertyDifferences, stackResourceDriftStatus, timestamp);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StackInstanceResourceDriftsSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StackInstanceResourceDriftsSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StackInstanceResourceDriftsSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StackInstanceResourceDriftsSummary is not found in the empty JSON string", StackInstanceResourceDriftsSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StackInstanceResourceDriftsSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StackInstanceResourceDriftsSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StackInstanceResourceDriftsSummary.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StackInstanceResourceDriftsSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StackInstanceResourceDriftsSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StackInstanceResourceDriftsSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StackInstanceResourceDriftsSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<StackInstanceResourceDriftsSummary>() {
           @Override
           public void write(JsonWriter out, StackInstanceResourceDriftsSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StackInstanceResourceDriftsSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StackInstanceResourceDriftsSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StackInstanceResourceDriftsSummary
   * @throws IOException if the JSON string is invalid with respect to StackInstanceResourceDriftsSummary
   */
  public static StackInstanceResourceDriftsSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StackInstanceResourceDriftsSummary.class);
  }

  /**
   * Convert an instance of StackInstanceResourceDriftsSummary to an JSON string
   *
   * @return JSON string
   */
