...
public class StackInstanceSummary {
  ...
  public StackInstanceSummary stackSetId(String stackSetId) {
  ...
  public StackInstanceSummary region(String region) {
    this.region = region;
    return this;
  }
  ...
  public StackInstanceSummary account(String account) {
  ...
  public StackInstanceSummary stackId(String stackId) {
  ...
  public StackInstanceSummary status(StackInstanceStatus status) {
    this.status = status;
    return this;
  }
  ...
  public StackInstanceSummary statusReason(String statusReason) {
  ...
  public StackInstanceSummary stackInstanceStatus(StackInstanceStackInstanceStatus stackInstanceStatus) {
  ...
  public StackInstanceSummary organizationalUnitId(String organizationalUnitId) {
  ...
  public StackInstanceSummary driftStatus(StackDriftStatus driftStatus) {
  ...
  public StackInstanceSummary lastDriftCheckTimestamp(OffsetDateTime lastDriftCheckTimestamp) {
  ...
  public StackInstanceSummary lastOperationId(String lastOperationId) {
  ...
  public boolean equals(Object o) {
    ...
    StackInstanceSummary stackInstanceSummary = (StackInstanceSummary) o;
    return Objects.equals(this.stackSetId, stackInstanceSummary.stackSetId) &&
        Objects.equals(this.region, stackInstanceSummary.region) &&
        Objects.equals(this.account, stackInstanceSummary.account) &&
        Objects.equals(this.stackId, stackInstanceSummary.stackId) &&
        Objects.equals(this.status, stackInstanceSummary.status) &&
        Objects.equals(this.statusReason, stackInstanceSummary.statusReason) &&
        Objects.equals(this.stackInstanceStatus, stackInstanceSummary.stackInstanceStatus) &&
        Objects.equals(this.organizationalUnitId, stackInstanceSummary.organizationalUnitId) &&
        Objects.equals(this.driftStatus, stackInstanceSummary.driftStatus) &&
        Objects.equals(this.lastDriftCheckTimestamp, stackInstanceSummary.lastDriftCheckTimestamp) &&
        Objects.equals(this.lastOperationId, stackInstanceSummary.lastOperationId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(stackSetId, region, account, stackId, status, statusReason, stackInstanceStatus, organizationalUnitId, driftStatus, lastDriftCheckTimestamp, lastOperationId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StackInstanceSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StackInstanceSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StackInstanceSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StackInstanceSummary is not found in the empty JSON string", StackInstanceSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StackInstanceSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StackInstanceSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StackInstanceSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StackInstanceSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StackInstanceSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StackInstanceSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<StackInstanceSummary>() {
           @Override
           public void write(JsonWriter out, StackInstanceSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StackInstanceSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StackInstanceSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StackInstanceSummary
   * @throws IOException if the JSON string is invalid with respect to StackInstanceSummary
   */
  public static StackInstanceSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StackInstanceSummary.class);
  }

  /**
   * Convert an instance of StackInstanceSummary to an JSON string
   *
   * @return JSON string
   */
