...
public class StackResourceDrift {
  ...
  public StackResourceDrift() {
  }

  public StackResourceDrift stackId(String stackId) {
  ...
  public StackResourceDrift logicalResourceId(String logicalResourceId) {
  ...
  public StackResourceDrift physicalResourceId(String physicalResourceId) {
  ...
  public StackResourceDrift physicalResourceIdContext(List physicalResourceIdContext) {
  ...
  public StackResourceDrift resourceType(String resourceType) {
  ...
  public StackResourceDrift expectedProperties(String expectedProperties) {
  ...
  public StackResourceDrift actualProperties(String actualProperties) {
  ...
  public StackResourceDrift propertyDifferences(List propertyDifferences) {
  ...
  public StackResourceDrift stackResourceDriftStatus(StackResourceDriftStatus stackResourceDriftStatus) {
  ...
  public StackResourceDrift timestamp(OffsetDateTime timestamp) {
  ...
  public StackResourceDrift moduleInfo(ResourceChangeModuleInfo moduleInfo) {
  ...
  public boolean equals(Object o) {
    ...
    StackResourceDrift stackResourceDrift = (StackResourceDrift) o;
    return Objects.equals(this.stackId, stackResourceDrift.stackId) &&
        Objects.equals(this.logicalResourceId, stackResourceDrift.logicalResourceId) &&
        Objects.equals(this.physicalResourceId, stackResourceDrift.physicalResourceId) &&
        Objects.equals(this.physicalResourceIdContext, stackResourceDrift.physicalResourceIdContext) &&
        Objects.equals(this.resourceType, stackResourceDrift.resourceType) &&
        Objects.equals(this.expectedProperties, stackResourceDrift.expectedProperties) &&
        Objects.equals(this.actualProperties, stackResourceDrift.actualProperties) &&
        Objects.equals(this.propertyDifferences, stackResourceDrift.propertyDifferences) &&
        Objects.equals(this.stackResourceDriftStatus, stackResourceDrift.stackResourceDriftStatus) &&
        Objects.equals(this.timestamp, stackResourceDrift.timestamp) &&
        Objects.equals(this.moduleInfo, stackResourceDrift.moduleInfo);
  }
  ...
  public String toString() {
    ...
    sb.append("class StackResourceDrift {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StackResourceDrift
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StackResourceDrift.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StackResourceDrift is not found in the empty JSON string", StackResourceDrift.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StackResourceDrift.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StackResourceDrift` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StackResourceDrift.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StackResourceDrift.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StackResourceDrift' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StackResourceDrift> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StackResourceDrift.class));

       return (TypeAdapter<T>) new TypeAdapter<StackResourceDrift>() {
           @Override
           public void write(JsonWriter out, StackResourceDrift value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StackResourceDrift read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StackResourceDrift given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StackResourceDrift
   * @throws IOException if the JSON string is invalid with respect to StackResourceDrift
   */
  public static StackResourceDrift fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StackResourceDrift.class);
  }

  /**
   * Convert an instance of StackResourceDrift to an JSON string
   *
   * @return JSON string
   */
