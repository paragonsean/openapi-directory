...
#include "OAICreateCluster_request_outpostConfig.h"
...
class OAICreateCluster_request_kubernetesNetworkConfig;
class OAICreateCluster_request_logging;
class OAIEncryptionConfig;
class OAICreateCluster_request_outpostConfig;
...
public:
    ...
    OAICreateCluster_request_kubernetesNetworkConfig getKubernetesNetworkConfig() const;
    void setKubernetesNetworkConfig(const OAICreateCluster_request_kubernetesNetworkConfig &kubernetes_network_config);
    ...
    QList<OAIEncryptionConfig> getEncryptionConfig() const;
    void setEncryptionConfig(const QList<OAIEncryptionConfig> &encryption_config);
    bool is_encryption_config_Set() const;
    bool is_encryption_config_Valid() const;

    OAICreateCluster_request_outpostConfig getOutpostConfig() const;
    void setOutpostConfig(const OAICreateCluster_request_outpostConfig &outpost_config);
...
private:
    ...
    OAICreateCluster_request_kubernetesNetworkConfig m_kubernetes_network_config;
    ...
    QList<OAIEncryptionConfig> m_encryption_config;
    bool m_encryption_config_isSet;
    bool m_encryption_config_isValid;

    OAICreateCluster_request_outpostConfig m_outpost_config;
