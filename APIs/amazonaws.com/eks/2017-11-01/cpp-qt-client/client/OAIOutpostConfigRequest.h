...
#ifndef OAIOutpostConfigRequest_H
#define OAIOutpostConfigRequest_H
...
class OAIOutpostConfigRequest : public OAIObject {
public:
    OAIOutpostConfigRequest();
    OAIOutpostConfigRequest(QString json);
    ~OAIOutpostConfigRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOutpostConfigRequest)

#endif // OAIOutpostConfigRequest_H
