...
#include "OAICreateAddonRequest.h"
...
OAICreateAddonRequest::OAICreateAddonRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateAddonRequest::OAICreateAddonRequest() {
    this->initializeModel();
}

OAICreateAddonRequest::~OAICreateAddonRequest() {}

void OAICreateAddonRequest::initializeModel() {
...
void OAICreateAddonRequest::fromJson(QString jsonString) {
...
void OAICreateAddonRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateAddonRequest::asJson() const {
...
QJsonObject OAICreateAddonRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateAddonRequest::getAddonName() const {
    return m_addon_name;
}
void OAICreateAddonRequest::setAddonName(const QString &addon_name) {
    m_addon_name = addon_name;
    m_addon_name_isSet = true;
}

bool OAICreateAddonRequest::is_addon_name_Set() const{
    return m_addon_name_isSet;
}

bool OAICreateAddonRequest::is_addon_name_Valid() const{
    return m_addon_name_isValid;
}

QString OAICreateAddonRequest::getAddonVersion() const {
    return m_addon_version;
}
void OAICreateAddonRequest::setAddonVersion(const QString &addon_version) {
    m_addon_version = addon_version;
    m_addon_version_isSet = true;
}

bool OAICreateAddonRequest::is_addon_version_Set() const{
    return m_addon_version_isSet;
}

bool OAICreateAddonRequest::is_addon_version_Valid() const{
    return m_addon_version_isValid;
}

QString OAICreateAddonRequest::getServiceAccountRoleArn() const {
    return m_service_account_role_arn;
}
void OAICreateAddonRequest::setServiceAccountRoleArn(const QString &service_account_role_arn) {
    m_service_account_role_arn = service_account_role_arn;
    m_service_account_role_arn_isSet = true;
}

bool OAICreateAddonRequest::is_service_account_role_arn_Set() const{
    return m_service_account_role_arn_isSet;
}

bool OAICreateAddonRequest::is_service_account_role_arn_Valid() const{
    return m_service_account_role_arn_isValid;
}

OAIResolveConflicts OAICreateAddonRequest::getResolveConflicts() const {
    return m_resolve_conflicts;
}
void OAICreateAddonRequest::setResolveConflicts(const OAIResolveConflicts &resolve_conflicts) {
    m_resolve_conflicts = resolve_conflicts;
    m_resolve_conflicts_isSet = true;
}

bool OAICreateAddonRequest::is_resolve_conflicts_Set() const{
    return m_resolve_conflicts_isSet;
}

bool OAICreateAddonRequest::is_resolve_conflicts_Valid() const{
    return m_resolve_conflicts_isValid;
}

QString OAICreateAddonRequest::getClientRequestToken() const {
    return m_client_request_token;
}
void OAICreateAddonRequest::setClientRequestToken(const QString &client_request_token) {
    m_client_request_token = client_request_token;
    m_client_request_token_isSet = true;
}

bool OAICreateAddonRequest::is_client_request_token_Set() const{
    return m_client_request_token_isSet;
}

bool OAICreateAddonRequest::is_client_request_token_Valid() const{
    return m_client_request_token_isValid;
}

QMap OAICreateAddonRequest::getTags() const {
    return m_tags;
}
void OAICreateAddonRequest::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateAddonRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateAddonRequest::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAICreateAddonRequest::getConfigurationValues() const {
    return m_configuration_values;
}
void OAICreateAddonRequest::setConfigurationValues(const QString &configuration_values) {
    m_configuration_values = configuration_values;
    m_configuration_values_isSet = true;
}

bool OAICreateAddonRequest::is_configuration_values_Set() const{
    return m_configuration_values_isSet;
}

bool OAICreateAddonRequest::is_configuration_values_Valid() const{
    return m_configuration_values_isValid;
}

bool OAICreateAddonRequest::isSet() const {
...
bool OAICreateAddonRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_addon_name_isValid && true;
}
