...
/*
 * OAICluster_resourcesVpcConfig.h
 *
 * 
 */

#ifndef OAICluster_resourcesVpcConfig_H
#define OAICluster_resourcesVpcConfig_H
...
class OAICluster_resourcesVpcConfig : public OAIObject {
public:
    OAICluster_resourcesVpcConfig();
    OAICluster_resourcesVpcConfig(QString json);
    ~OAICluster_resourcesVpcConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICluster_resourcesVpcConfig)

#endif // OAICluster_resourcesVpcConfig_H
