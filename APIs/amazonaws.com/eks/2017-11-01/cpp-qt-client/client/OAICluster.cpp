...
QDateTime OAICluster::getCreatedAt() const {
    return m_created_at;
}
void OAICluster::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAICluster::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAICluster::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAICluster::getVersion() const {
    return m_version;
}
void OAICluster::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAICluster::is_version_Set() const{
    return m_version_isSet;
}

bool OAICluster::is_version_Valid() const{
...
QString OAICluster::getRoleArn() const {
    return m_role_arn;
}
void OAICluster::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAICluster::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAICluster::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

OAICluster_resourcesVpcConfig OAICluster::getResourcesVpcConfig() const {
    return m_resources_vpc_config;
}
void OAICluster::setResourcesVpcConfig(const OAICluster_resourcesVpcConfig &resources_vpc_config) {
    m_resources_vpc_config = resources_vpc_config;
    m_resources_vpc_config_isSet = true;
}

bool OAICluster::is_resources_vpc_config_Set() const{
    return m_resources_vpc_config_isSet;
}

bool OAICluster::is_resources_vpc_config_Valid() const{
    return m_resources_vpc_config_isValid;
}

OAICluster_kubernetesNetworkConfig OAICluster::getKubernetesNetworkConfig() const {
    return m_kubernetes_network_config;
}
void OAICluster::setKubernetesNetworkConfig(const OAICluster_kubernetesNetworkConfig &kubernetes_network_config) {
    m_kubernetes_network_config = kubernetes_network_config;
    m_kubernetes_network_config_isSet = true;
}

bool OAICluster::is_kubernetes_network_config_Set() const{
    return m_kubernetes_network_config_isSet;
}

bool OAICluster::is_kubernetes_network_config_Valid() const{
    return m_kubernetes_network_config_isValid;
}

OAICluster_logging OAICluster::getLogging() const {
    return m_logging;
}
void OAICluster::setLogging(const OAICluster_logging &logging) {
    m_logging = logging;
    m_logging_isSet = true;
}

bool OAICluster::is_logging_Set() const{
    return m_logging_isSet;
}

bool OAICluster::is_logging_Valid() const{
    return m_logging_isValid;
}

OAICluster_identity OAICluster::getIdentity() const {
    return m_identity;
}
void OAICluster::setIdentity(const OAICluster_identity &identity) {
    m_identity = identity;
...
OAICluster_certificateAuthority OAICluster::getCertificateAuthority() const {
    return m_certificate_authority;
}
void OAICluster::setCertificateAuthority(const OAICluster_certificateAuthority &certificate_authority) {
    m_certificate_authority = certificate_authority;
    m_certificate_authority_isSet = true;
}

bool OAICluster::is_certificate_authority_Set() const{
    return m_certificate_authority_isSet;
}

bool OAICluster::is_certificate_authority_Valid() const{
    return m_certificate_authority_isValid;
}

QString OAICluster::getClientRequestToken() const {
    return m_client_request_token;
}
void OAICluster::setClientRequestToken(const QString &client_request_token) {
    m_client_request_token = client_request_token;
    m_client_request_token_isSet = true;
}

bool OAICluster::is_client_request_token_Set() const{
    return m_client_request_token_isSet;
}

bool OAICluster::is_client_request_token_Valid() const{
    return m_client_request_token_isValid;
}

QString OAICluster::getPlatformVersion() const {
    return m_platform_version;
}
void OAICluster::setPlatformVersion(const QString &platform_version) {
    m_platform_version = platform_version;
    m_platform_version_isSet = true;
}

bool OAICluster::is_platform_version_Set() const{
    return m_platform_version_isSet;
}

bool OAICluster::is_platform_version_Valid() const{
...
QList OAICluster::getEncryptionConfig() const {
    return m_encryption_config;
}
void OAICluster::setEncryptionConfig(const QList &encryption_config) {
...
OAICluster_connectorConfig OAICluster::getConnectorConfig() const {
    return m_connector_config;
}
void OAICluster::setConnectorConfig(const OAICluster_connectorConfig &connector_config) {
    m_connector_config = connector_config;
    m_connector_config_isSet = true;
}

bool OAICluster::is_connector_config_Set() const{
    return m_connector_config_isSet;
}

bool OAICluster::is_connector_config_Valid() const{
...
OAICluster_health OAICluster::getHealth() const {
    return m_health;
}
void OAICluster::setHealth(const OAICluster_health &health) {
    m_health = health;
    m_health_isSet = true;
}

bool OAICluster::is_health_Set() const{
    return m_health_isSet;
}

bool OAICluster::is_health_Valid() const{
    return m_health_isValid;
}

OAICluster_outpostConfig OAICluster::getOutpostConfig() const {
    return m_outpost_config;
}
void OAICluster::setOutpostConfig(const OAICluster_outpostConfig &outpost_config) {
    m_outpost_config = outpost_config;
    m_outpost_config_isSet = true;
}

bool OAICluster::is_outpost_config_Set() const{
    return m_outpost_config_isSet;
}

bool OAICluster::is_outpost_config_Valid() const{
