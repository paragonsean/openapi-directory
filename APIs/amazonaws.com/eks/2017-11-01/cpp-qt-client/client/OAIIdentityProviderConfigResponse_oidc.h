...
/*
 * OAIIdentityProviderConfigResponse_oidc.h
 *
 * 
 */

#ifndef OAIIdentityProviderConfigResponse_oidc_H
#define OAIIdentityProviderConfigResponse_oidc_H
...
class OAIIdentityProviderConfigResponse_oidc : public OAIObject {
public:
    OAIIdentityProviderConfigResponse_oidc();
    OAIIdentityProviderConfigResponse_oidc(QString json);
    ~OAIIdentityProviderConfigResponse_oidc() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIdentityProviderConfigResponse_oidc)

#endif // OAIIdentityProviderConfigResponse_oidc_H
