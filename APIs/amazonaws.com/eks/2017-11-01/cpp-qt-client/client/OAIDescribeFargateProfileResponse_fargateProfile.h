...
/*
 * OAIDescribeFargateProfileResponse_fargateProfile.h
 *
 * 
 */

#ifndef OAIDescribeFargateProfileResponse_fargateProfile_H
#define OAIDescribeFargateProfileResponse_fargateProfile_H
...
class OAIDescribeFargateProfileResponse_fargateProfile : public OAIObject {
public:
    OAIDescribeFargateProfileResponse_fargateProfile();
    OAIDescribeFargateProfileResponse_fargateProfile(QString json);
    ~OAIDescribeFargateProfileResponse_fargateProfile() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFargateProfileResponse_fargateProfile)

#endif // OAIDescribeFargateProfileResponse_fargateProfile_H
