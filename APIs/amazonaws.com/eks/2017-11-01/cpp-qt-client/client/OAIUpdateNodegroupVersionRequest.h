...
/*
 * OAIUpdateNodegroupVersionRequest.h
 *
 * 
 */

#ifndef OAIUpdateNodegroupVersionRequest_H
#define OAIUpdateNodegroupVersionRequest_H
...
namespace OpenAPI {
class OAIUpdateNodegroupVersionRequest_launchTemplate;

class OAIUpdateNodegroupVersionRequest : public OAIObject {
public:
    OAIUpdateNodegroupVersionRequest();
    OAIUpdateNodegroupVersionRequest(QString json);
    ~OAIUpdateNodegroupVersionRequest() override;
    ...
    OAIUpdateNodegroupVersionRequest_launchTemplate getLaunchTemplate() const;
    void setLaunchTemplate(const OAIUpdateNodegroupVersionRequest_launchTemplate &launch_template);
...
private:
    ...
    OAIUpdateNodegroupVersionRequest_launchTemplate m_launch_template;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateNodegroupVersionRequest)

#endif // OAIUpdateNodegroupVersionRequest_H
