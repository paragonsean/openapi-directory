...
public:
    ...
    QList getPlatformVersions() const;
    void setPlatformVersions(const QList &platform_versions);
    bool is_platform_versions_Set() const;
    bool is_platform_versions_Valid() const;
...
private:
    ...
    QList m_platform_versions;
    bool m_platform_versions_isSet;
    bool m_platform_versions_isValid;
