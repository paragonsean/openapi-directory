...
#include "OAICreateNodegroupRequest.h"
...
OAICreateNodegroupRequest::OAICreateNodegroupRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateNodegroupRequest::OAICreateNodegroupRequest() {
    this->initializeModel();
}

OAICreateNodegroupRequest::~OAICreateNodegroupRequest() {}

void OAICreateNodegroupRequest::initializeModel() {
...
void OAICreateNodegroupRequest::fromJson(QString jsonString) {
...
void OAICreateNodegroupRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateNodegroupRequest::asJson() const {
...
QJsonObject OAICreateNodegroupRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateNodegroupRequest::getNodegroupName() const {
    return m_nodegroup_name;
}
void OAICreateNodegroupRequest::setNodegroupName(const QString &nodegroup_name) {
    m_nodegroup_name = nodegroup_name;
    m_nodegroup_name_isSet = true;
}

bool OAICreateNodegroupRequest::is_nodegroup_name_Set() const{
    return m_nodegroup_name_isSet;
}

bool OAICreateNodegroupRequest::is_nodegroup_name_Valid() const{
    return m_nodegroup_name_isValid;
}

OAICreateNodegroupRequest_scalingConfig OAICreateNodegroupRequest::getScalingConfig() const {
    return m_scaling_config;
}
void OAICreateNodegroupRequest::setScalingConfig(const OAICreateNodegroupRequest_scalingConfig &scaling_config) {
    m_scaling_config = scaling_config;
    m_scaling_config_isSet = true;
}

bool OAICreateNodegroupRequest::is_scaling_config_Set() const{
    return m_scaling_config_isSet;
}

bool OAICreateNodegroupRequest::is_scaling_config_Valid() const{
    return m_scaling_config_isValid;
}

qint32 OAICreateNodegroupRequest::getDiskSize() const {
    return m_disk_size;
}
void OAICreateNodegroupRequest::setDiskSize(const qint32 &disk_size) {
    m_disk_size = disk_size;
    m_disk_size_isSet = true;
}

bool OAICreateNodegroupRequest::is_disk_size_Set() const{
    return m_disk_size_isSet;
}

bool OAICreateNodegroupRequest::is_disk_size_Valid() const{
    return m_disk_size_isValid;
}

QList OAICreateNodegroupRequest::getSubnets() const {
    return m_subnets;
}
void OAICreateNodegroupRequest::setSubnets(const QList &subnets) {
    m_subnets = subnets;
    m_subnets_isSet = true;
}

bool OAICreateNodegroupRequest::is_subnets_Set() const{
    return m_subnets_isSet;
}

bool OAICreateNodegroupRequest::is_subnets_Valid() const{
    return m_subnets_isValid;
}

QList OAICreateNodegroupRequest::getInstanceTypes() const {
    return m_instance_types;
}
void OAICreateNodegroupRequest::setInstanceTypes(const QList &instance_types) {
    m_instance_types = instance_types;
    m_instance_types_isSet = true;
}

bool OAICreateNodegroupRequest::is_instance_types_Set() const{
    return m_instance_types_isSet;
}

bool OAICreateNodegroupRequest::is_instance_types_Valid() const{
    return m_instance_types_isValid;
}

OAIAMITypes OAICreateNodegroupRequest::getAmiType() const {
    return m_ami_type;
}
void OAICreateNodegroupRequest::setAmiType(const OAIAMITypes &ami_type) {
    m_ami_type = ami_type;
    m_ami_type_isSet = true;
}

bool OAICreateNodegroupRequest::is_ami_type_Set() const{
    return m_ami_type_isSet;
}

bool OAICreateNodegroupRequest::is_ami_type_Valid() const{
    return m_ami_type_isValid;
}

OAICreateNodegroupRequest_remoteAccess OAICreateNodegroupRequest::getRemoteAccess() const {
    return m_remote_access;
}
void OAICreateNodegroupRequest::setRemoteAccess(const OAICreateNodegroupRequest_remoteAccess &remote_access) {
    m_remote_access = remote_access;
    m_remote_access_isSet = true;
}

bool OAICreateNodegroupRequest::is_remote_access_Set() const{
    return m_remote_access_isSet;
}

bool OAICreateNodegroupRequest::is_remote_access_Valid() const{
    return m_remote_access_isValid;
}

QString OAICreateNodegroupRequest::getNodeRole() const {
    return m_node_role;
}
void OAICreateNodegroupRequest::setNodeRole(const QString &node_role) {
    m_node_role = node_role;
    m_node_role_isSet = true;
}

bool OAICreateNodegroupRequest::is_node_role_Set() const{
    return m_node_role_isSet;
}

bool OAICreateNodegroupRequest::is_node_role_Valid() const{
    return m_node_role_isValid;
}

QMap OAICreateNodegroupRequest::getLabels() const {
    return m_labels;
}
void OAICreateNodegroupRequest::setLabels(const QMap &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAICreateNodegroupRequest::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAICreateNodegroupRequest::is_labels_Valid() const{
    return m_labels_isValid;
}

QList OAICreateNodegroupRequest::getTaints() const {
    return m_taints;
}
void OAICreateNodegroupRequest::setTaints(const QList &taints) {
    m_taints = taints;
    m_taints_isSet = true;
}

bool OAICreateNodegroupRequest::is_taints_Set() const{
    return m_taints_isSet;
}

bool OAICreateNodegroupRequest::is_taints_Valid() const{
    return m_taints_isValid;
}

QMap OAICreateNodegroupRequest::getTags() const {
    return m_tags;
}
void OAICreateNodegroupRequest::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateNodegroupRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateNodegroupRequest::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAICreateNodegroupRequest::getClientRequestToken() const {
    return m_client_request_token;
}
void OAICreateNodegroupRequest::setClientRequestToken(const QString &client_request_token) {
    m_client_request_token = client_request_token;
    m_client_request_token_isSet = true;
}

bool OAICreateNodegroupRequest::is_client_request_token_Set() const{
    return m_client_request_token_isSet;
}

bool OAICreateNodegroupRequest::is_client_request_token_Valid() const{
    return m_client_request_token_isValid;
}

OAICreateNodegroupRequest_launchTemplate OAICreateNodegroupRequest::getLaunchTemplate() const {
    return m_launch_template;
}
void OAICreateNodegroupRequest::setLaunchTemplate(const OAICreateNodegroupRequest_launchTemplate &launch_template) {
    m_launch_template = launch_template;
    m_launch_template_isSet = true;
}

bool OAICreateNodegroupRequest::is_launch_template_Set() const{
    return m_launch_template_isSet;
}

bool OAICreateNodegroupRequest::is_launch_template_Valid() const{
    return m_launch_template_isValid;
}

OAICreateNodegroupRequest_updateConfig OAICreateNodegroupRequest::getUpdateConfig() const {
    return m_update_config;
}
void OAICreateNodegroupRequest::setUpdateConfig(const OAICreateNodegroupRequest_updateConfig &update_config) {
    m_update_config = update_config;
    m_update_config_isSet = true;
}

bool OAICreateNodegroupRequest::is_update_config_Set() const{
    return m_update_config_isSet;
}

bool OAICreateNodegroupRequest::is_update_config_Valid() const{
    return m_update_config_isValid;
}

OAICapacityTypes OAICreateNodegroupRequest::getCapacityType() const {
    return m_capacity_type;
}
void OAICreateNodegroupRequest::setCapacityType(const OAICapacityTypes &capacity_type) {
    m_capacity_type = capacity_type;
    m_capacity_type_isSet = true;
}

bool OAICreateNodegroupRequest::is_capacity_type_Set() const{
    return m_capacity_type_isSet;
}

bool OAICreateNodegroupRequest::is_capacity_type_Valid() const{
    return m_capacity_type_isValid;
}

QString OAICreateNodegroupRequest::getVersion() const {
    return m_version;
}
void OAICreateNodegroupRequest::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAICreateNodegroupRequest::is_version_Set() const{
    return m_version_isSet;
}

bool OAICreateNodegroupRequest::is_version_Valid() const{
    return m_version_isValid;
}

QString OAICreateNodegroupRequest::getReleaseVersion() const {
    return m_release_version;
}
void OAICreateNodegroupRequest::setReleaseVersion(const QString &release_version) {
    m_release_version = release_version;
    m_release_version_isSet = true;
}

bool OAICreateNodegroupRequest::is_release_version_Set() const{
    return m_release_version_isSet;
}

bool OAICreateNodegroupRequest::is_release_version_Valid() const{
    return m_release_version_isValid;
}

bool OAICreateNodegroupRequest::isSet() const {
...
bool OAICreateNodegroupRequest::isValid() const {
