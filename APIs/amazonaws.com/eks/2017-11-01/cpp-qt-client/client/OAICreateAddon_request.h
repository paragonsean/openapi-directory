...
/*
 * OAICreateAddon_request.h
 *
 * 
 */

#ifndef OAICreateAddon_request_H
#define OAICreateAddon_request_H
...
class OAICreateAddon_request : public OAIObject {
public:
    OAICreateAddon_request();
    OAICreateAddon_request(QString json);
    ~OAICreateAddon_request() override;
    ...
    QString getResolveConflicts() const;
    void setResolveConflicts(const QString &resolve_conflicts);
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAddon_request)

#endif // OAICreateAddon_request_H
