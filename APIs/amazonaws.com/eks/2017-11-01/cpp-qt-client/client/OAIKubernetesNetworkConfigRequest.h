...
/*
 * OAIKubernetesNetworkConfigRequest.h
 *
 * The Kubernetes network configuration for the cluster.
 */

#ifndef OAIKubernetesNetworkConfigRequest_H
#define OAIKubernetesNetworkConfigRequest_H
...
class OAIKubernetesNetworkConfigRequest : public OAIObject {
public:
    OAIKubernetesNetworkConfigRequest();
    OAIKubernetesNetworkConfigRequest(QString json);
    ~OAIKubernetesNetworkConfigRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKubernetesNetworkConfigRequest)

#endif // OAIKubernetesNetworkConfigRequest_H
