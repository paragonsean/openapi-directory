...
/*
 * OAIAddon_marketplaceInformation.h
 *
 * 
 */

#ifndef OAIAddon_marketplaceInformation_H
#define OAIAddon_marketplaceInformation_H
...
class OAIAddon_marketplaceInformation : public OAIObject {
public:
    OAIAddon_marketplaceInformation();
    OAIAddon_marketplaceInformation(QString json);
    ~OAIAddon_marketplaceInformation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddon_marketplaceInformation)

#endif // OAIAddon_marketplaceInformation_H
