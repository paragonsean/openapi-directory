...
OAICreateClusterRequest_outpostConfig::OAICreateClusterRequest_outpostConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateClusterRequest_outpostConfig::OAICreateClusterRequest_outpostConfig() {
    this->initializeModel();
}

OAICreateClusterRequest_outpostConfig::~OAICreateClusterRequest_outpostConfig() {}

void OAICreateClusterRequest_outpostConfig::initializeModel() {
...
void OAICreateClusterRequest_outpostConfig::fromJson(QString jsonString) {
...
void OAICreateClusterRequest_outpostConfig::fromJsonObject(QJsonObject json) {
...
QString OAICreateClusterRequest_outpostConfig::asJson() const {
...
QJsonObject OAICreateClusterRequest_outpostConfig::asJsonObject() const {
    QJsonObject obj;
...
QList OAICreateClusterRequest_outpostConfig::getOutpostArns() const {
    return m_outpost_arns;
}
void OAICreateClusterRequest_outpostConfig::setOutpostArns(const QList &outpost_arns) {
    m_outpost_arns = outpost_arns;
    m_outpost_arns_isSet = true;
}

bool OAICreateClusterRequest_outpostConfig::is_outpost_arns_Set() const{
    return m_outpost_arns_isSet;
}

bool OAICreateClusterRequest_outpostConfig::is_outpost_arns_Valid() const{
    return m_outpost_arns_isValid;
}

QString OAICreateClusterRequest_outpostConfig::getControlPlaneInstanceType() const {
    return m_control_plane_instance_type;
}
void OAICreateClusterRequest_outpostConfig::setControlPlaneInstanceType(const QString &control_plane_instance_type) {
    m_control_plane_instance_type = control_plane_instance_type;
    m_control_plane_instance_type_isSet = true;
}

bool OAICreateClusterRequest_outpostConfig::is_control_plane_instance_type_Set() const{
    return m_control_plane_instance_type_isSet;
}

bool OAICreateClusterRequest_outpostConfig::is_control_plane_instance_type_Valid() const{
    return m_control_plane_instance_type_isValid;
}

OAICreateCluster_request_outpostConfig_controlPlanePlacement OAICreateClusterRequest_outpostConfig::getControlPlanePlacement() const {
    return m_control_plane_placement;
}
void OAICreateClusterRequest_outpostConfig::setControlPlanePlacement(const OAICreateCluster_request_outpostConfig_controlPlanePlacement &control_plane_placement) {
    m_control_plane_placement = control_plane_placement;
    m_control_plane_placement_isSet = true;
}

bool OAICreateClusterRequest_outpostConfig::is_control_plane_placement_Set() const{
    return m_control_plane_placement_isSet;
}

bool OAICreateClusterRequest_outpostConfig::is_control_plane_placement_Valid() const{
    return m_control_plane_placement_isValid;
}

bool OAICreateClusterRequest_outpostConfig::isSet() const {
...
bool OAICreateClusterRequest_outpostConfig::isValid() const {
