...
/*
 * OAIMarketplaceInformation.h
 *
 * Information about an Amazon EKS add-on from the Amazon Web Services Marketplace.
 */

#ifndef OAIMarketplaceInformation_H
#define OAIMarketplaceInformation_H
...
class OAIMarketplaceInformation : public OAIObject {
public:
    OAIMarketplaceInformation();
    OAIMarketplaceInformation(QString json);
    ~OAIMarketplaceInformation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMarketplaceInformation)

#endif // OAIMarketplaceInformation_H
