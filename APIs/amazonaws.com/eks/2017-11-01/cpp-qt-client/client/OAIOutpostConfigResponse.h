...
#ifndef OAIOutpostConfigResponse_H
#define OAIOutpostConfigResponse_H
...
namespace OpenAPI {
class OAIOutpostConfigResponse_controlPlanePlacement;

class OAIOutpostConfigResponse : public OAIObject {
public:
    OAIOutpostConfigResponse();
    OAIOutpostConfigResponse(QString json);
    ~OAIOutpostConfigResponse() override;
    ...
    OAIOutpostConfigResponse_controlPlanePlacement getControlPlanePlacement() const;
    void setControlPlanePlacement(const OAIOutpostConfigResponse_controlPlanePlacement &control_plane_placement);
...
private:
    ...
    OAIOutpostConfigResponse_controlPlanePlacement m_control_plane_placement;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOutpostConfigResponse)

#endif // OAIOutpostConfigResponse_H
