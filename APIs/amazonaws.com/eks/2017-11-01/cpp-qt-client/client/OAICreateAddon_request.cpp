...
OAICreateAddon_request::OAICreateAddon_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateAddon_request::OAICreateAddon_request() {
    this->initializeModel();
}

OAICreateAddon_request::~OAICreateAddon_request() {}

void OAICreateAddon_request::initializeModel() {
...
void OAICreateAddon_request::fromJson(QString jsonString) {
...
void OAICreateAddon_request::fromJsonObject(QJsonObject json) {
...
QString OAICreateAddon_request::asJson() const {
...
QJsonObject OAICreateAddon_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateAddon_request::getAddonName() const {
    return m_addon_name;
}
void OAICreateAddon_request::setAddonName(const QString &addon_name) {
    m_addon_name = addon_name;
    m_addon_name_isSet = true;
}

bool OAICreateAddon_request::is_addon_name_Set() const{
    return m_addon_name_isSet;
}

bool OAICreateAddon_request::is_addon_name_Valid() const{
    return m_addon_name_isValid;
}

QString OAICreateAddon_request::getAddonVersion() const {
    return m_addon_version;
}
void OAICreateAddon_request::setAddonVersion(const QString &addon_version) {
    m_addon_version = addon_version;
    m_addon_version_isSet = true;
}

bool OAICreateAddon_request::is_addon_version_Set() const{
    return m_addon_version_isSet;
}

bool OAICreateAddon_request::is_addon_version_Valid() const{
    return m_addon_version_isValid;
}

QString OAICreateAddon_request::getServiceAccountRoleArn() const {
    return m_service_account_role_arn;
}
void OAICreateAddon_request::setServiceAccountRoleArn(const QString &service_account_role_arn) {
    m_service_account_role_arn = service_account_role_arn;
    m_service_account_role_arn_isSet = true;
}

bool OAICreateAddon_request::is_service_account_role_arn_Set() const{
    return m_service_account_role_arn_isSet;
}

bool OAICreateAddon_request::is_service_account_role_arn_Valid() const{
    return m_service_account_role_arn_isValid;
}

QString OAICreateAddon_request::getResolveConflicts() const {
    return m_resolve_conflicts;
}
void OAICreateAddon_request::setResolveConflicts(const QString &resolve_conflicts) {
    m_resolve_conflicts = resolve_conflicts;
    m_resolve_conflicts_isSet = true;
}

bool OAICreateAddon_request::is_resolve_conflicts_Set() const{
    return m_resolve_conflicts_isSet;
}

bool OAICreateAddon_request::is_resolve_conflicts_Valid() const{
    return m_resolve_conflicts_isValid;
}

QString OAICreateAddon_request::getClientRequestToken() const {
    return m_client_request_token;
}
void OAICreateAddon_request::setClientRequestToken(const QString &client_request_token) {
    m_client_request_token = client_request_token;
    m_client_request_token_isSet = true;
}

bool OAICreateAddon_request::is_client_request_token_Set() const{
    return m_client_request_token_isSet;
}

bool OAICreateAddon_request::is_client_request_token_Valid() const{
    return m_client_request_token_isValid;
}

QMap<QString, QString> OAICreateAddon_request::getTags() const {
    return m_tags;
}
void OAICreateAddon_request::setTags(const QMap<QString, QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateAddon_request::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateAddon_request::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAICreateAddon_request::getConfigurationValues() const {
    return m_configuration_values;
}
void OAICreateAddon_request::setConfigurationValues(const QString &configuration_values) {
    m_configuration_values = configuration_values;
    m_configuration_values_isSet = true;
}

bool OAICreateAddon_request::is_configuration_values_Set() const{
    return m_configuration_values_isSet;
}

bool OAICreateAddon_request::is_configuration_values_Valid() const{
    return m_configuration_values_isValid;
}

bool OAICreateAddon_request::isSet() const {
...
bool OAICreateAddon_request::isValid() const {
