...
/*
 * OAIOidcIdentityProviderConfigRequest.h
 *
...
#ifndef OAIOidcIdentityProviderConfigRequest_H
#define OAIOidcIdentityProviderConfigRequest_H
...
class OAIOidcIdentityProviderConfigRequest : public OAIObject {
public:
    OAIOidcIdentityProviderConfigRequest();
    OAIOidcIdentityProviderConfigRequest(QString json);
    ~OAIOidcIdentityProviderConfigRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOidcIdentityProviderConfigRequest)

#endif // OAIOidcIdentityProviderConfigRequest_H
