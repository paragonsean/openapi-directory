...
/*
 * OAICreateNodegroup_request.h
 *
 * 
 */

#ifndef OAICreateNodegroup_request_H
#define OAICreateNodegroup_request_H
...
class OAICreateNodegroup_request_remoteAccess;
class OAITaint;
class OAICreateNodegroup_request_launchTemplate;
class OAICreateNodegroup_request_updateConfig;

class OAICreateNodegroup_request : public OAIObject {
public:
    OAICreateNodegroup_request();
    OAICreateNodegroup_request(QString json);
    ~OAICreateNodegroup_request() override;
    ...
    QList<QString> getInstanceTypes() const;
    void setInstanceTypes(const QList<QString> &instance_types);
    bool is_instance_types_Set() const;
    bool is_instance_types_Valid() const;

    QString getAmiType() const;
    void setAmiType(const QString &ami_type);
    bool is_ami_type_Set() const;
    bool is_ami_type_Valid() const;

    OAICreateNodegroup_request_remoteAccess getRemoteAccess() const;
    void setRemoteAccess(const OAICreateNodegroup_request_remoteAccess &remote_access);
    ...
    QList<OAITaint> getTaints() const;
    void setTaints(const QList<OAITaint> &taints);
...
private:
    ...
    QList<QString> m_instance_types;
    ...
    OAICreateNodegroup_request_remoteAccess m_remote_access;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateNodegroup_request)

#endif // OAICreateNodegroup_request_H
