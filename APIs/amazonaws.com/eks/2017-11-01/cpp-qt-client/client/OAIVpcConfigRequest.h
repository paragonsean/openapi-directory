...
/*
 * OAIVpcConfigRequest.h
 *
 * An object representing the VPC configuration to use for an Amazon EKS cluster.
 */

#ifndef OAIVpcConfigRequest_H
#define OAIVpcConfigRequest_H
...
class OAIVpcConfigRequest : public OAIObject {
public:
    OAIVpcConfigRequest();
    OAIVpcConfigRequest(QString json);
    ~OAIVpcConfigRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVpcConfigRequest)

#endif // OAIVpcConfigRequest_H
