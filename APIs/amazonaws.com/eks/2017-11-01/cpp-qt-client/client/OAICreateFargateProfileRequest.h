...
/*
 * OAICreateFargateProfileRequest.h
 *
 * 
 */

#ifndef OAICreateFargateProfileRequest_H
#define OAICreateFargateProfileRequest_H
...
class OAICreateFargateProfileRequest : public OAIObject {
public:
    OAICreateFargateProfileRequest();
    OAICreateFargateProfileRequest(QString json);
    ~OAICreateFargateProfileRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFargateProfileRequest)

#endif // OAICreateFargateProfileRequest_H
