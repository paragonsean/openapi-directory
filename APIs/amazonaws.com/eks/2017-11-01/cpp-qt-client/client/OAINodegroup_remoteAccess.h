...
/*
 * OAINodegroup_remoteAccess.h
 *
 * 
 */

#ifndef OAINodegroup_remoteAccess_H
#define OAINodegroup_remoteAccess_H
...
class OAINodegroup_remoteAccess : public OAIObject {
public:
    OAINodegroup_remoteAccess();
    OAINodegroup_remoteAccess(QString json);
    ~OAINodegroup_remoteAccess() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINodegroup_remoteAccess)

#endif // OAINodegroup_remoteAccess_H
