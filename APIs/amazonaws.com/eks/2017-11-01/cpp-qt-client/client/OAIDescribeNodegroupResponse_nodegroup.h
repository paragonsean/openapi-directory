...
/*
 * OAIDescribeNodegroupResponse_nodegroup.h
 *
 * 
 */

#ifndef OAIDescribeNodegroupResponse_nodegroup_H
#define OAIDescribeNodegroupResponse_nodegroup_H
...
class OAIDescribeNodegroupResponse_nodegroup : public OAIObject {
public:
    OAIDescribeNodegroupResponse_nodegroup();
    OAIDescribeNodegroupResponse_nodegroup(QString json);
    ~OAIDescribeNodegroupResponse_nodegroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeNodegroupResponse_nodegroup)

#endif // OAIDescribeNodegroupResponse_nodegroup_H
