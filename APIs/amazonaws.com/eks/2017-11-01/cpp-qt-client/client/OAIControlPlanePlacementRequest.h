...
/*
 * OAIControlPlanePlacementRequest.h
 *
...
#ifndef OAIControlPlanePlacementRequest_H
#define OAIControlPlanePlacementRequest_H
...
class OAIControlPlanePlacementRequest : public OAIObject {
public:
    OAIControlPlanePlacementRequest();
    OAIControlPlanePlacementRequest(QString json);
    ~OAIControlPlanePlacementRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIControlPlanePlacementRequest)

#endif // OAIControlPlanePlacementRequest_H
