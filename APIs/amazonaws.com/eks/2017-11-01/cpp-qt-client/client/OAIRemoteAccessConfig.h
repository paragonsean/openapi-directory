...
/*
 * OAIRemoteAccessConfig.h
 *
 * An object representing the remote access configuration for the managed node group.
 */

#ifndef OAIRemoteAccessConfig_H
#define OAIRemoteAccessConfig_H
...
class OAIRemoteAccessConfig : public OAIObject {
public:
    OAIRemoteAccessConfig();
    OAIRemoteAccessConfig(QString json);
    ~OAIRemoteAccessConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRemoteAccessConfig)

#endif // OAIRemoteAccessConfig_H
