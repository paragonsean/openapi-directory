...
/*
 * OAIUpdateAddon_request.h
 *
 * 
 */

#ifndef OAIUpdateAddon_request_H
#define OAIUpdateAddon_request_H
...
class OAIUpdateAddon_request : public OAIObject {
public:
    OAIUpdateAddon_request();
    OAIUpdateAddon_request(QString json);
    ~OAIUpdateAddon_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAddon_request)

#endif // OAIUpdateAddon_request_H
