...
/*
 * OAICreateNodegroup_request_launchTemplate.h
 *
...
#ifndef OAICreateNodegroup_request_launchTemplate_H
#define OAICreateNodegroup_request_launchTemplate_H
...
class OAICreateNodegroup_request_launchTemplate : public OAIObject {
public:
    OAICreateNodegroup_request_launchTemplate();
    OAICreateNodegroup_request_launchTemplate(QString json);
    ~OAICreateNodegroup_request_launchTemplate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateNodegroup_request_launchTemplate)

#endif // OAICreateNodegroup_request_launchTemplate_H
