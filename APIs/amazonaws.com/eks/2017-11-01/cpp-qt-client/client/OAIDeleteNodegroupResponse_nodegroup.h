...
/*
 * OAIDeleteNodegroupResponse_nodegroup.h
 *
 * 
 */

#ifndef OAIDeleteNodegroupResponse_nodegroup_H
#define OAIDeleteNodegroupResponse_nodegroup_H
...
class OAIDeleteNodegroupResponse_nodegroup : public OAIObject {
public:
    OAIDeleteNodegroupResponse_nodegroup();
    OAIDeleteNodegroupResponse_nodegroup(QString json);
    ~OAIDeleteNodegroupResponse_nodegroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteNodegroupResponse_nodegroup)

#endif // OAIDeleteNodegroupResponse_nodegroup_H
