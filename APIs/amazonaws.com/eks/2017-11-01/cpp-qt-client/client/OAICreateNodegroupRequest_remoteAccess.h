...
/*
 * OAICreateNodegroupRequest_remoteAccess.h
 *
 * 
 */

#ifndef OAICreateNodegroupRequest_remoteAccess_H
#define OAICreateNodegroupRequest_remoteAccess_H
...
class OAICreateNodegroupRequest_remoteAccess : public OAIObject {
public:
    OAICreateNodegroupRequest_remoteAccess();
    OAICreateNodegroupRequest_remoteAccess(QString json);
    ~OAICreateNodegroupRequest_remoteAccess() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateNodegroupRequest_remoteAccess)

#endif // OAICreateNodegroupRequest_remoteAccess_H
