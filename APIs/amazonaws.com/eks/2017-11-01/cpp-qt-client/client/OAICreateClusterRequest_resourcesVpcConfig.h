...
/*
 * OAICreateClusterRequest_resourcesVpcConfig.h
 *
 * 
 */

#ifndef OAICreateClusterRequest_resourcesVpcConfig_H
#define OAICreateClusterRequest_resourcesVpcConfig_H
...
class OAICreateClusterRequest_resourcesVpcConfig : public OAIObject {
public:
    OAICreateClusterRequest_resourcesVpcConfig();
    OAICreateClusterRequest_resourcesVpcConfig(QString json);
    ~OAICreateClusterRequest_resourcesVpcConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateClusterRequest_resourcesVpcConfig)

#endif // OAICreateClusterRequest_resourcesVpcConfig_H
