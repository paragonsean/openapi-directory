...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticKubernetesService.OidcIdentityProviderConfigRequest();
  });
  ...
  describe('OidcIdentityProviderConfigRequest', function() {
    it('should create an instance of OidcIdentityProviderConfigRequest', function() {
      // uncomment below and update the code to test OidcIdentityProviderConfigRequest
      //var instance = new AmazonElasticKubernetesService.OidcIdentityProviderConfigRequest();
      //expect(instance).to.be.a(AmazonElasticKubernetesService.OidcIdentityProviderConfigRequest);
    });
