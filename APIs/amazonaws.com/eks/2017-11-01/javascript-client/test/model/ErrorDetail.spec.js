...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticKubernetesService.ErrorDetail();
  });
  ...
  describe('ErrorDetail', function() {
    it('should create an instance of ErrorDetail', function() {
      ...
      //var instance = new AmazonElasticKubernetesService.ErrorDetail();
      //expect(instance).to.be.a(AmazonElasticKubernetesService.ErrorDetail);
    });
