...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticKubernetesService.ListAddonsResponse();
  });
  ...
  describe('ListAddonsResponse', function() {
    it('should create an instance of ListAddonsResponse', function() {
      // uncomment below and update the code to test ListAddonsResponse
      //var instance = new AmazonElasticKubernetesService.ListAddonsResponse();
      //expect(instance).to.be.a(AmazonElasticKubernetesService.ListAddonsResponse);
    });
