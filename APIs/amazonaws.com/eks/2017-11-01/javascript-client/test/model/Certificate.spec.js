...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticKubernetesService.Certificate();
  });
  ...
  describe('Certificate', function() {
    it('should create an instance of Certificate', function() {
      ...
      //var instance = new AmazonElasticKubernetesService.Certificate();
      //expect(instance).to.be.a(AmazonElasticKubernetesService.Certificate);
    });
