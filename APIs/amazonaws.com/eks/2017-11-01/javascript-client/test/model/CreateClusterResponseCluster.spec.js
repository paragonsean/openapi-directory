...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticKubernetesService.CreateClusterResponseCluster();
  });
  ...
  describe('CreateClusterResponseCluster', function() {
    it('should create an instance of CreateClusterResponseCluster', function() {
      ...
      //var instance = new AmazonElasticKubernetesService.CreateClusterResponseCluster();
      //expect(instance).to.be.a(AmazonElasticKubernetesService.CreateClusterResponseCluster);
    });
    ...
    it('should have the property connectorConfig (base name: "connectorConfig")', function() {
      // uncomment below and update the code to test the property connectorConfig
      //var instance = new AmazonElasticKubernetesService.CreateClusterResponseCluster();
      //expect(instance).to.be();
    });
