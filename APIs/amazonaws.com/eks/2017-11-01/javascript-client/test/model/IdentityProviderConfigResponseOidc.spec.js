...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticKubernetesService.IdentityProviderConfigResponseOidc();
  });
  ...
  describe('IdentityProviderConfigResponseOidc', function() {
    it('should create an instance of IdentityProviderConfigResponseOidc', function() {
      // uncomment below and update the code to test IdentityProviderConfigResponseOidc
      //var instance = new AmazonElasticKubernetesService.IdentityProviderConfigResponseOidc();
      //expect(instance).to.be.a(AmazonElasticKubernetesService.IdentityProviderConfigResponseOidc);
    });
