...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticKubernetesService.UpdateNodegroupVersionRequest();
  });
  ...
  describe('UpdateNodegroupVersionRequest', function() {
    it('should create an instance of UpdateNodegroupVersionRequest', function() {
      // uncomment below and update the code to test UpdateNodegroupVersionRequest
      //var instance = new AmazonElasticKubernetesService.UpdateNodegroupVersionRequest();
      //expect(instance).to.be.a(AmazonElasticKubernetesService.UpdateNodegroupVersionRequest);
    });
