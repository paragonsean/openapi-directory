...
public class IdentityProviderConfigResponseOidc {
  ...
  public IdentityProviderConfigResponseOidc() {
  }

  public IdentityProviderConfigResponseOidc identityProviderConfigName(String identityProviderConfigName) {
  ...
  public IdentityProviderConfigResponseOidc identityProviderConfigArn(String identityProviderConfigArn) {
  ...
  public IdentityProviderConfigResponseOidc clusterName(String clusterName) {
  ...
  public IdentityProviderConfigResponseOidc issuerUrl(String issuerUrl) {
  ...
  public IdentityProviderConfigResponseOidc clientId(String clientId) {
  ...
  public IdentityProviderConfigResponseOidc usernameClaim(String usernameClaim) {
  ...
  public IdentityProviderConfigResponseOidc usernamePrefix(String usernamePrefix) {
  ...
  public IdentityProviderConfigResponseOidc groupsClaim(String groupsClaim) {
  ...
  public IdentityProviderConfigResponseOidc groupsPrefix(String groupsPrefix) {
  ...
  public IdentityProviderConfigResponseOidc requiredClaims(Map requiredClaims) {
  ...
  public IdentityProviderConfigResponseOidc tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public IdentityProviderConfigResponseOidc status(ConfigStatus status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    IdentityProviderConfigResponseOidc identityProviderConfigResponseOidc = (IdentityProviderConfigResponseOidc) o;
    return Objects.equals(this.identityProviderConfigName, identityProviderConfigResponseOidc.identityProviderConfigName) &&
        Objects.equals(this.identityProviderConfigArn, identityProviderConfigResponseOidc.identityProviderConfigArn) &&
        Objects.equals(this.clusterName, identityProviderConfigResponseOidc.clusterName) &&
        Objects.equals(this.issuerUrl, identityProviderConfigResponseOidc.issuerUrl) &&
        Objects.equals(this.clientId, identityProviderConfigResponseOidc.clientId) &&
        Objects.equals(this.usernameClaim, identityProviderConfigResponseOidc.usernameClaim) &&
        Objects.equals(this.usernamePrefix, identityProviderConfigResponseOidc.usernamePrefix) &&
        Objects.equals(this.groupsClaim, identityProviderConfigResponseOidc.groupsClaim) &&
        Objects.equals(this.groupsPrefix, identityProviderConfigResponseOidc.groupsPrefix) &&
        Objects.equals(this.requiredClaims, identityProviderConfigResponseOidc.requiredClaims) &&
        Objects.equals(this.tags, identityProviderConfigResponseOidc.tags) &&
        Objects.equals(this.status, identityProviderConfigResponseOidc.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class IdentityProviderConfigResponseOidc {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IdentityProviderConfigResponseOidc
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IdentityProviderConfigResponseOidc.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IdentityProviderConfigResponseOidc is not found in the empty JSON string", IdentityProviderConfigResponseOidc.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IdentityProviderConfigResponseOidc.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IdentityProviderConfigResponseOidc` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IdentityProviderConfigResponseOidc.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IdentityProviderConfigResponseOidc' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IdentityProviderConfigResponseOidc> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IdentityProviderConfigResponseOidc.class));

       return (TypeAdapter<T>) new TypeAdapter<IdentityProviderConfigResponseOidc>() {
           @Override
           public void write(JsonWriter out, IdentityProviderConfigResponseOidc value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IdentityProviderConfigResponseOidc read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IdentityProviderConfigResponseOidc given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IdentityProviderConfigResponseOidc
   * @throws IOException if the JSON string is invalid with respect to IdentityProviderConfigResponseOidc
   */
  public static IdentityProviderConfigResponseOidc fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IdentityProviderConfigResponseOidc.class);
  }

  /**
   * Convert an instance of IdentityProviderConfigResponseOidc to an JSON string
   *
   * @return JSON string
   */
