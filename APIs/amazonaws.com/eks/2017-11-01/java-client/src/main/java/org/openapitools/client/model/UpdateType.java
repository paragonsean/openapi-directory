 ...
 */
@JsonAdapter(UpdateType.Adapter.class)
public enum UpdateType {
  ...
  public static class Adapter extends TypeAdapter<UpdateType> {
    @Override
    public void write(final JsonWriter jsonWriter, final UpdateType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public UpdateType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return UpdateType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    UpdateType.fromValue(value);
  }
}
