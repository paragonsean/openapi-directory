...
public class OidcIdentityProviderConfigRequest {
  ...
  public OidcIdentityProviderConfigRequest identityProviderConfigName(String identityProviderConfigName) {
  ...
  public OidcIdentityProviderConfigRequest issuerUrl(String issuerUrl) {
  ...
  public OidcIdentityProviderConfigRequest clientId(String clientId) {
  ...
  public OidcIdentityProviderConfigRequest usernameClaim(String usernameClaim) {
  ...
  public OidcIdentityProviderConfigRequest usernamePrefix(String usernamePrefix) {
  ...
  public OidcIdentityProviderConfigRequest groupsClaim(String groupsClaim) {
  ...
  public OidcIdentityProviderConfigRequest groupsPrefix(String groupsPrefix) {
  ...
  public OidcIdentityProviderConfigRequest requiredClaims(Map requiredClaims) {
  ...
  public boolean equals(Object o) {
    ...
    OidcIdentityProviderConfigRequest oidcIdentityProviderConfigRequest = (OidcIdentityProviderConfigRequest) o;
    return Objects.equals(this.identityProviderConfigName, oidcIdentityProviderConfigRequest.identityProviderConfigName) &&
        Objects.equals(this.issuerUrl, oidcIdentityProviderConfigRequest.issuerUrl) &&
        Objects.equals(this.clientId, oidcIdentityProviderConfigRequest.clientId) &&
        Objects.equals(this.usernameClaim, oidcIdentityProviderConfigRequest.usernameClaim) &&
        Objects.equals(this.usernamePrefix, oidcIdentityProviderConfigRequest.usernamePrefix) &&
        Objects.equals(this.groupsClaim, oidcIdentityProviderConfigRequest.groupsClaim) &&
        Objects.equals(this.groupsPrefix, oidcIdentityProviderConfigRequest.groupsPrefix) &&
        Objects.equals(this.requiredClaims, oidcIdentityProviderConfigRequest.requiredClaims);
  }
  ...
  public String toString() {
    ...
    sb.append("class OidcIdentityProviderConfigRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OidcIdentityProviderConfigRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OidcIdentityProviderConfigRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OidcIdentityProviderConfigRequest is not found in the empty JSON string", OidcIdentityProviderConfigRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OidcIdentityProviderConfigRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OidcIdentityProviderConfigRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OidcIdentityProviderConfigRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OidcIdentityProviderConfigRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OidcIdentityProviderConfigRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OidcIdentityProviderConfigRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OidcIdentityProviderConfigRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<OidcIdentityProviderConfigRequest>() {
           @Override
           public void write(JsonWriter out, OidcIdentityProviderConfigRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OidcIdentityProviderConfigRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OidcIdentityProviderConfigRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OidcIdentityProviderConfigRequest
   * @throws IOException if the JSON string is invalid with respect to OidcIdentityProviderConfigRequest
   */
  public static OidcIdentityProviderConfigRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OidcIdentityProviderConfigRequest.class);
  }

  /**
   * Convert an instance of OidcIdentityProviderConfigRequest to an JSON string
   *
   * @return JSON string
   */
