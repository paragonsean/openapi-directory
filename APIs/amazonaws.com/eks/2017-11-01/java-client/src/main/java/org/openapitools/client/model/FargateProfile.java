...
public class FargateProfile {
  ...
  public FargateProfile fargateProfileName(String fargateProfileName) {
  ...
  public FargateProfile fargateProfileArn(String fargateProfileArn) {
  ...
  public FargateProfile clusterName(String clusterName) {
  ...
  public FargateProfile createdAt(OffsetDateTime createdAt) {
  ...
  public FargateProfile podExecutionRoleArn(String podExecutionRoleArn) {
  ...
  public FargateProfile subnets(List subnets) {
  ...
  public FargateProfile selectors(List selectors) {
  ...
  public FargateProfile status(FargateProfileStatus status) {
    this.status = status;
    return this;
  }
  ...
  public FargateProfile tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FargateProfile fargateProfile = (FargateProfile) o;
    return Objects.equals(this.fargateProfileName, fargateProfile.fargateProfileName) &&
        Objects.equals(this.fargateProfileArn, fargateProfile.fargateProfileArn) &&
        Objects.equals(this.clusterName, fargateProfile.clusterName) &&
        Objects.equals(this.createdAt, fargateProfile.createdAt) &&
        Objects.equals(this.podExecutionRoleArn, fargateProfile.podExecutionRoleArn) &&
        Objects.equals(this.subnets, fargateProfile.subnets) &&
        Objects.equals(this.selectors, fargateProfile.selectors) &&
        Objects.equals(this.status, fargateProfile.status) &&
        Objects.equals(this.tags, fargateProfile.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class FargateProfile {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FargateProfile
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FargateProfile.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FargateProfile is not found in the empty JSON string", FargateProfile.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FargateProfile.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FargateProfile` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FargateProfile.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FargateProfile' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FargateProfile> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FargateProfile.class));

       return (TypeAdapter<T>) new TypeAdapter<FargateProfile>() {
           @Override
           public void write(JsonWriter out, FargateProfile value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FargateProfile read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FargateProfile given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FargateProfile
   * @throws IOException if the JSON string is invalid with respect to FargateProfile
   */
  public static FargateProfile fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FargateProfile.class);
  }

  /**
   * Convert an instance of FargateProfile to an JSON string
   *
   * @return JSON string
   */
