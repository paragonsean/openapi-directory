...
public class DeleteNodegroupResponseNodegroup {
  ...
  public DeleteNodegroupResponseNodegroup() {
  }

  public DeleteNodegroupResponseNodegroup nodegroupName(String nodegroupName) {
  ...
  public DeleteNodegroupResponseNodegroup nodegroupArn(String nodegroupArn) {
  ...
  public DeleteNodegroupResponseNodegroup clusterName(String clusterName) {
  ...
  public DeleteNodegroupResponseNodegroup version(String version) {
  ...
  public DeleteNodegroupResponseNodegroup releaseVersion(String releaseVersion) {
  ...
  public DeleteNodegroupResponseNodegroup createdAt(OffsetDateTime createdAt) {
  ...
  public DeleteNodegroupResponseNodegroup modifiedAt(OffsetDateTime modifiedAt) {
  ...
  public DeleteNodegroupResponseNodegroup status(NodegroupStatus status) {
    this.status = status;
    return this;
  }
  ...
  public DeleteNodegroupResponseNodegroup capacityType(CapacityTypes capacityType) {
  ...
  public DeleteNodegroupResponseNodegroup scalingConfig(NodegroupScalingConfig scalingConfig) {
  ...
  public DeleteNodegroupResponseNodegroup instanceTypes(List instanceTypes) {
  ...
  public DeleteNodegroupResponseNodegroup subnets(List subnets) {
  ...
  public DeleteNodegroupResponseNodegroup remoteAccess(NodegroupRemoteAccess remoteAccess) {
  ...
  public DeleteNodegroupResponseNodegroup amiType(AMITypes amiType) {
  ...
  public DeleteNodegroupResponseNodegroup nodeRole(String nodeRole) {
  ...
  public DeleteNodegroupResponseNodegroup labels(Map labels) {
    this.labels = labels;
    return this;
  }
  ...
  public DeleteNodegroupResponseNodegroup taints(List taints) {
    this.taints = taints;
    return this;
  }
  ...
  public DeleteNodegroupResponseNodegroup resources(NodegroupResources resources) {
  ...
  public DeleteNodegroupResponseNodegroup diskSize(Integer diskSize) {
  ...
  public DeleteNodegroupResponseNodegroup health(NodegroupHealth health) {
    this.health = health;
    return this;
  }
  ...
  public DeleteNodegroupResponseNodegroup updateConfig(CreateNodegroupRequestUpdateConfig updateConfig) {
  ...
  public DeleteNodegroupResponseNodegroup launchTemplate(NodegroupLaunchTemplate launchTemplate) {
  ...
  public DeleteNodegroupResponseNodegroup tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteNodegroupResponseNodegroup deleteNodegroupResponseNodegroup = (DeleteNodegroupResponseNodegroup) o;
    return Objects.equals(this.nodegroupName, deleteNodegroupResponseNodegroup.nodegroupName) &&
        Objects.equals(this.nodegroupArn, deleteNodegroupResponseNodegroup.nodegroupArn) &&
        Objects.equals(this.clusterName, deleteNodegroupResponseNodegroup.clusterName) &&
        Objects.equals(this.version, deleteNodegroupResponseNodegroup.version) &&
        Objects.equals(this.releaseVersion, deleteNodegroupResponseNodegroup.releaseVersion) &&
        Objects.equals(this.createdAt, deleteNodegroupResponseNodegroup.createdAt) &&
        Objects.equals(this.modifiedAt, deleteNodegroupResponseNodegroup.modifiedAt) &&
        Objects.equals(this.status, deleteNodegroupResponseNodegroup.status) &&
        Objects.equals(this.capacityType, deleteNodegroupResponseNodegroup.capacityType) &&
        Objects.equals(this.scalingConfig, deleteNodegroupResponseNodegroup.scalingConfig) &&
        Objects.equals(this.instanceTypes, deleteNodegroupResponseNodegroup.instanceTypes) &&
        Objects.equals(this.subnets, deleteNodegroupResponseNodegroup.subnets) &&
        Objects.equals(this.remoteAccess, deleteNodegroupResponseNodegroup.remoteAccess) &&
        Objects.equals(this.amiType, deleteNodegroupResponseNodegroup.amiType) &&
        Objects.equals(this.nodeRole, deleteNodegroupResponseNodegroup.nodeRole) &&
        Objects.equals(this.labels, deleteNodegroupResponseNodegroup.labels) &&
        Objects.equals(this.taints, deleteNodegroupResponseNodegroup.taints) &&
        Objects.equals(this.resources, deleteNodegroupResponseNodegroup.resources) &&
        Objects.equals(this.diskSize, deleteNodegroupResponseNodegroup.diskSize) &&
        Objects.equals(this.health, deleteNodegroupResponseNodegroup.health) &&
        Objects.equals(this.updateConfig, deleteNodegroupResponseNodegroup.updateConfig) &&
        Objects.equals(this.launchTemplate, deleteNodegroupResponseNodegroup.launchTemplate) &&
        Objects.equals(this.tags, deleteNodegroupResponseNodegroup.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteNodegroupResponseNodegroup {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteNodegroupResponseNodegroup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteNodegroupResponseNodegroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteNodegroupResponseNodegroup is not found in the empty JSON string", DeleteNodegroupResponseNodegroup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteNodegroupResponseNodegroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteNodegroupResponseNodegroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteNodegroupResponseNodegroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteNodegroupResponseNodegroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteNodegroupResponseNodegroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteNodegroupResponseNodegroup.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteNodegroupResponseNodegroup>() {
           @Override
           public void write(JsonWriter out, DeleteNodegroupResponseNodegroup value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteNodegroupResponseNodegroup read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteNodegroupResponseNodegroup given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteNodegroupResponseNodegroup
   * @throws IOException if the JSON string is invalid with respect to DeleteNodegroupResponseNodegroup
   */
  public static DeleteNodegroupResponseNodegroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteNodegroupResponseNodegroup.class);
  }

  /**
   * Convert an instance of DeleteNodegroupResponseNodegroup to an JSON string
   *
   * @return JSON string
   */
