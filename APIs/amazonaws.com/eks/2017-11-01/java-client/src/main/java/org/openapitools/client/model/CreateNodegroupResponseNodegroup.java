...
public class CreateNodegroupResponseNodegroup {
  ...
  public CreateNodegroupResponseNodegroup() {
  }

  public CreateNodegroupResponseNodegroup nodegroupName(String nodegroupName) {
  ...
  public CreateNodegroupResponseNodegroup nodegroupArn(String nodegroupArn) {
  ...
  public CreateNodegroupResponseNodegroup clusterName(String clusterName) {
  ...
  public CreateNodegroupResponseNodegroup version(String version) {
  ...
  public CreateNodegroupResponseNodegroup releaseVersion(String releaseVersion) {
  ...
  public CreateNodegroupResponseNodegroup createdAt(OffsetDateTime createdAt) {
  ...
  public CreateNodegroupResponseNodegroup modifiedAt(OffsetDateTime modifiedAt) {
  ...
  public CreateNodegroupResponseNodegroup status(NodegroupStatus status) {
    this.status = status;
    return this;
  }
  ...
  public CreateNodegroupResponseNodegroup capacityType(CapacityTypes capacityType) {
  ...
  public CreateNodegroupResponseNodegroup scalingConfig(NodegroupScalingConfig scalingConfig) {
  ...
  public CreateNodegroupResponseNodegroup instanceTypes(List instanceTypes) {
  ...
  public CreateNodegroupResponseNodegroup subnets(List subnets) {
  ...
  public CreateNodegroupResponseNodegroup remoteAccess(NodegroupRemoteAccess remoteAccess) {
  ...
  public CreateNodegroupResponseNodegroup amiType(AMITypes amiType) {
  ...
  public CreateNodegroupResponseNodegroup nodeRole(String nodeRole) {
  ...
  public CreateNodegroupResponseNodegroup labels(Map labels) {
    this.labels = labels;
    return this;
  }
  ...
  public CreateNodegroupResponseNodegroup taints(List taints) {
    this.taints = taints;
    return this;
  }
  ...
  public CreateNodegroupResponseNodegroup resources(NodegroupResources resources) {
  ...
  public CreateNodegroupResponseNodegroup diskSize(Integer diskSize) {
  ...
  public CreateNodegroupResponseNodegroup health(NodegroupHealth health) {
    this.health = health;
    return this;
  }
  ...
  public CreateNodegroupResponseNodegroup updateConfig(CreateNodegroupRequestUpdateConfig updateConfig) {
  ...
  public CreateNodegroupResponseNodegroup launchTemplate(NodegroupLaunchTemplate launchTemplate) {
  ...
  public CreateNodegroupResponseNodegroup tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateNodegroupResponseNodegroup createNodegroupResponseNodegroup = (CreateNodegroupResponseNodegroup) o;
    return Objects.equals(this.nodegroupName, createNodegroupResponseNodegroup.nodegroupName) &&
        Objects.equals(this.nodegroupArn, createNodegroupResponseNodegroup.nodegroupArn) &&
        Objects.equals(this.clusterName, createNodegroupResponseNodegroup.clusterName) &&
        Objects.equals(this.version, createNodegroupResponseNodegroup.version) &&
        Objects.equals(this.releaseVersion, createNodegroupResponseNodegroup.releaseVersion) &&
        Objects.equals(this.createdAt, createNodegroupResponseNodegroup.createdAt) &&
        Objects.equals(this.modifiedAt, createNodegroupResponseNodegroup.modifiedAt) &&
        Objects.equals(this.status, createNodegroupResponseNodegroup.status) &&
        Objects.equals(this.capacityType, createNodegroupResponseNodegroup.capacityType) &&
        Objects.equals(this.scalingConfig, createNodegroupResponseNodegroup.scalingConfig) &&
        Objects.equals(this.instanceTypes, createNodegroupResponseNodegroup.instanceTypes) &&
        Objects.equals(this.subnets, createNodegroupResponseNodegroup.subnets) &&
        Objects.equals(this.remoteAccess, createNodegroupResponseNodegroup.remoteAccess) &&
        Objects.equals(this.amiType, createNodegroupResponseNodegroup.amiType) &&
        Objects.equals(this.nodeRole, createNodegroupResponseNodegroup.nodeRole) &&
        Objects.equals(this.labels, createNodegroupResponseNodegroup.labels) &&
        Objects.equals(this.taints, createNodegroupResponseNodegroup.taints) &&
        Objects.equals(this.resources, createNodegroupResponseNodegroup.resources) &&
        Objects.equals(this.diskSize, createNodegroupResponseNodegroup.diskSize) &&
        Objects.equals(this.health, createNodegroupResponseNodegroup.health) &&
        Objects.equals(this.updateConfig, createNodegroupResponseNodegroup.updateConfig) &&
        Objects.equals(this.launchTemplate, createNodegroupResponseNodegroup.launchTemplate) &&
        Objects.equals(this.tags, createNodegroupResponseNodegroup.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateNodegroupResponseNodegroup {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateNodegroupResponseNodegroup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateNodegroupResponseNodegroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateNodegroupResponseNodegroup is not found in the empty JSON string", CreateNodegroupResponseNodegroup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateNodegroupResponseNodegroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateNodegroupResponseNodegroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateNodegroupResponseNodegroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateNodegroupResponseNodegroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateNodegroupResponseNodegroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateNodegroupResponseNodegroup.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateNodegroupResponseNodegroup>() {
           @Override
           public void write(JsonWriter out, CreateNodegroupResponseNodegroup value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateNodegroupResponseNodegroup read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateNodegroupResponseNodegroup given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateNodegroupResponseNodegroup
   * @throws IOException if the JSON string is invalid with respect to CreateNodegroupResponseNodegroup
   */
  public static CreateNodegroupResponseNodegroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateNodegroupResponseNodegroup.class);
  }

  /**
   * Convert an instance of CreateNodegroupResponseNodegroup to an JSON string
   *
   * @return JSON string
   */
