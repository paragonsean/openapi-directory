...
public class CreateAddonRequest {
  ...
  public CreateAddonRequest addonName(String addonName) {
  ...
  public CreateAddonRequest addonVersion(String addonVersion) {
  ...
  public CreateAddonRequest serviceAccountRoleArn(String serviceAccountRoleArn) {
  ...
  public CreateAddonRequest resolveConflicts(ResolveConflictsEnum resolveConflicts) {
  ...
  public CreateAddonRequest clientRequestToken(String clientRequestToken) {
  ...
  public CreateAddonRequest tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public CreateAddonRequest putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
  ...
  public CreateAddonRequest configurationValues(String configurationValues) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.addonName, createAddonRequest.addonName) &&
        Objects.equals(this.addonVersion, createAddonRequest.addonVersion) &&
        Objects.equals(this.serviceAccountRoleArn, createAddonRequest.serviceAccountRoleArn) &&
        Objects.equals(this.resolveConflicts, createAddonRequest.resolveConflicts) &&
        Objects.equals(this.clientRequestToken, createAddonRequest.clientRequestToken) &&
        Objects.equals(this.tags, createAddonRequest.tags) &&
        Objects.equals(this.configurationValues, createAddonRequest.configurationValues);
  }

  @Override
  public int hashCode() {
    return Objects.hash(addonName, addonVersion, serviceAccountRoleArn, resolveConflicts, clientRequestToken, tags, configurationValues);
  }
