...
public class DescribeNodegroupResponseNodegroup {
  ...
  public DescribeNodegroupResponseNodegroup() {
  }

  public DescribeNodegroupResponseNodegroup nodegroupName(String nodegroupName) {
  ...
  public DescribeNodegroupResponseNodegroup nodegroupArn(String nodegroupArn) {
  ...
  public DescribeNodegroupResponseNodegroup clusterName(String clusterName) {
  ...
  public DescribeNodegroupResponseNodegroup version(String version) {
  ...
  public DescribeNodegroupResponseNodegroup releaseVersion(String releaseVersion) {
  ...
  public DescribeNodegroupResponseNodegroup createdAt(OffsetDateTime createdAt) {
  ...
  public DescribeNodegroupResponseNodegroup modifiedAt(OffsetDateTime modifiedAt) {
  ...
  public DescribeNodegroupResponseNodegroup status(NodegroupStatus status) {
    this.status = status;
    return this;
  }
  ...
  public DescribeNodegroupResponseNodegroup capacityType(CapacityTypes capacityType) {
  ...
  public DescribeNodegroupResponseNodegroup scalingConfig(NodegroupScalingConfig scalingConfig) {
  ...
  public DescribeNodegroupResponseNodegroup instanceTypes(List instanceTypes) {
  ...
  public DescribeNodegroupResponseNodegroup subnets(List subnets) {
  ...
  public DescribeNodegroupResponseNodegroup remoteAccess(NodegroupRemoteAccess remoteAccess) {
  ...
  public DescribeNodegroupResponseNodegroup amiType(AMITypes amiType) {
  ...
  public DescribeNodegroupResponseNodegroup nodeRole(String nodeRole) {
  ...
  public DescribeNodegroupResponseNodegroup labels(Map labels) {
    this.labels = labels;
    return this;
  }
  ...
  public DescribeNodegroupResponseNodegroup taints(List taints) {
    this.taints = taints;
    return this;
  }
  ...
  public DescribeNodegroupResponseNodegroup resources(NodegroupResources resources) {
  ...
  public DescribeNodegroupResponseNodegroup diskSize(Integer diskSize) {
  ...
  public DescribeNodegroupResponseNodegroup health(NodegroupHealth health) {
    this.health = health;
    return this;
  }
  ...
  public DescribeNodegroupResponseNodegroup updateConfig(CreateNodegroupRequestUpdateConfig updateConfig) {
  ...
  public DescribeNodegroupResponseNodegroup launchTemplate(NodegroupLaunchTemplate launchTemplate) {
  ...
  public DescribeNodegroupResponseNodegroup tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeNodegroupResponseNodegroup describeNodegroupResponseNodegroup = (DescribeNodegroupResponseNodegroup) o;
    return Objects.equals(this.nodegroupName, describeNodegroupResponseNodegroup.nodegroupName) &&
        Objects.equals(this.nodegroupArn, describeNodegroupResponseNodegroup.nodegroupArn) &&
        Objects.equals(this.clusterName, describeNodegroupResponseNodegroup.clusterName) &&
        Objects.equals(this.version, describeNodegroupResponseNodegroup.version) &&
        Objects.equals(this.releaseVersion, describeNodegroupResponseNodegroup.releaseVersion) &&
        Objects.equals(this.createdAt, describeNodegroupResponseNodegroup.createdAt) &&
        Objects.equals(this.modifiedAt, describeNodegroupResponseNodegroup.modifiedAt) &&
        Objects.equals(this.status, describeNodegroupResponseNodegroup.status) &&
        Objects.equals(this.capacityType, describeNodegroupResponseNodegroup.capacityType) &&
        Objects.equals(this.scalingConfig, describeNodegroupResponseNodegroup.scalingConfig) &&
        Objects.equals(this.instanceTypes, describeNodegroupResponseNodegroup.instanceTypes) &&
        Objects.equals(this.subnets, describeNodegroupResponseNodegroup.subnets) &&
        Objects.equals(this.remoteAccess, describeNodegroupResponseNodegroup.remoteAccess) &&
        Objects.equals(this.amiType, describeNodegroupResponseNodegroup.amiType) &&
        Objects.equals(this.nodeRole, describeNodegroupResponseNodegroup.nodeRole) &&
        Objects.equals(this.labels, describeNodegroupResponseNodegroup.labels) &&
        Objects.equals(this.taints, describeNodegroupResponseNodegroup.taints) &&
        Objects.equals(this.resources, describeNodegroupResponseNodegroup.resources) &&
        Objects.equals(this.diskSize, describeNodegroupResponseNodegroup.diskSize) &&
        Objects.equals(this.health, describeNodegroupResponseNodegroup.health) &&
        Objects.equals(this.updateConfig, describeNodegroupResponseNodegroup.updateConfig) &&
        Objects.equals(this.launchTemplate, describeNodegroupResponseNodegroup.launchTemplate) &&
        Objects.equals(this.tags, describeNodegroupResponseNodegroup.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeNodegroupResponseNodegroup {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeNodegroupResponseNodegroup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeNodegroupResponseNodegroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeNodegroupResponseNodegroup is not found in the empty JSON string", DescribeNodegroupResponseNodegroup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeNodegroupResponseNodegroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeNodegroupResponseNodegroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeNodegroupResponseNodegroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeNodegroupResponseNodegroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeNodegroupResponseNodegroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeNodegroupResponseNodegroup.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeNodegroupResponseNodegroup>() {
           @Override
           public void write(JsonWriter out, DescribeNodegroupResponseNodegroup value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeNodegroupResponseNodegroup read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeNodegroupResponseNodegroup given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeNodegroupResponseNodegroup
   * @throws IOException if the JSON string is invalid with respect to DescribeNodegroupResponseNodegroup
   */
  public static DescribeNodegroupResponseNodegroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeNodegroupResponseNodegroup.class);
  }

  /**
   * Convert an instance of DescribeNodegroupResponseNodegroup to an JSON string
   *
   * @return JSON string
   */
