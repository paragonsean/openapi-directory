...
QString OAIEncryptRequest::getKeyId() const {
    return m_key_id;
}
void OAIEncryptRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIEncryptRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIEncryptRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

QString OAIEncryptRequest::getPlaintext() const {
    return m_plaintext;
}
void OAIEncryptRequest::setPlaintext(const QString &plaintext) {
...
QMap OAIEncryptRequest::getEncryptionContext() const {
    return m_encryption_context;
}
void OAIEncryptRequest::setEncryptionContext(const QMap &encryption_context) {
    m_encryption_context = encryption_context;
    m_encryption_context_isSet = true;
}

bool OAIEncryptRequest::is_encryption_context_Set() const{
    return m_encryption_context_isSet;
}

bool OAIEncryptRequest::is_encryption_context_Valid() const{
    return m_encryption_context_isValid;
}

QList OAIEncryptRequest::getGrantTokens() const {
    return m_grant_tokens;
}
void OAIEncryptRequest::setGrantTokens(const QList &grant_tokens) {
    m_grant_tokens = grant_tokens;
    m_grant_tokens_isSet = true;
}

bool OAIEncryptRequest::is_grant_tokens_Set() const{
    return m_grant_tokens_isSet;
}

bool OAIEncryptRequest::is_grant_tokens_Valid() const{
    return m_grant_tokens_isValid;
}

OAIEncryptionAlgorithmSpec OAIEncryptRequest::getEncryptionAlgorithm() const {
    return m_encryption_algorithm;
}
void OAIEncryptRequest::setEncryptionAlgorithm(const OAIEncryptionAlgorithmSpec &encryption_algorithm) {
    m_encryption_algorithm = encryption_algorithm;
    m_encryption_algorithm_isSet = true;
}

bool OAIEncryptRequest::is_encryption_algorithm_Set() const{
    return m_encryption_algorithm_isSet;
}

bool OAIEncryptRequest::is_encryption_algorithm_Valid() const{
    return m_encryption_algorithm_isValid;
}

bool OAIEncryptRequest::getDryRun() const {
    return m_dry_run;
}
void OAIEncryptRequest::setDryRun(const bool &dry_run) {
    m_dry_run = dry_run;
    m_dry_run_isSet = true;
}

bool OAIEncryptRequest::is_dry_run_Set() const{
    return m_dry_run_isSet;
}

bool OAIEncryptRequest::is_dry_run_Valid() const{
...
bool OAIEncryptRequest::isValid() const {
    ...
    return m_key_id_isValid && m_plaintext_isValid && true;
}
