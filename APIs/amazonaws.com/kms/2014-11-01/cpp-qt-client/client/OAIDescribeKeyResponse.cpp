...
void OAIDescribeKeyResponse::initializeModel() {
    ...
    m_key_metadata_isSet = false;
    m_key_metadata_isValid = false;
}
...
void OAIDescribeKeyResponse::fromJsonObject(QJsonObject json) {
    ...
    m_key_metadata_isValid = ::OpenAPI::fromJsonValue(m_key_metadata, json[QString("KeyMetadata")]);
    m_key_metadata_isSet = !json[QString("KeyMetadata")].isNull() && m_key_metadata_isValid;
}
...
QJsonObject OAIDescribeKeyResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_key_metadata.isSet()) {
        obj.insert(QString("KeyMetadata"), ::OpenAPI::toJsonValue(m_key_metadata));
    }
    return obj;
}

OAIDescribeKeyResponse_KeyMetadata OAIDescribeKeyResponse::getKeyMetadata() const {
    return m_key_metadata;
}
void OAIDescribeKeyResponse::setKeyMetadata(const OAIDescribeKeyResponse_KeyMetadata &key_metadata) {
    m_key_metadata = key_metadata;
    m_key_metadata_isSet = true;
}

bool OAIDescribeKeyResponse::is_key_metadata_Set() const{
    return m_key_metadata_isSet;
}

bool OAIDescribeKeyResponse::is_key_metadata_Valid() const{
    return m_key_metadata_isValid;
}
