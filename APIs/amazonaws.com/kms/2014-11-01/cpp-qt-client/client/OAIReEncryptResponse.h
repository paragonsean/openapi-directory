...
/*
 * OAIReEncryptResponse.h
 *
 * 
 */

#ifndef OAIReEncryptResponse_H
#define OAIReEncryptResponse_H
...
class OAIReEncryptResponse : public OAIObject {
public:
    OAIReEncryptResponse();
    OAIReEncryptResponse(QString json);
    ~OAIReEncryptResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReEncryptResponse)

#endif // OAIReEncryptResponse_H
