...
/*
 * OAIListRetirableGrantsRequest.h
 *
 * 
 */

#ifndef OAIListRetirableGrantsRequest_H
#define OAIListRetirableGrantsRequest_H
...
class OAIListRetirableGrantsRequest : public OAIObject {
public:
    OAIListRetirableGrantsRequest();
    OAIListRetirableGrantsRequest(QString json);
    ~OAIListRetirableGrantsRequest() override;
    ...
    QString getRetiringPrincipal() const;
    void setRetiringPrincipal(const QString &retiring_principal);
    bool is_retiring_principal_Set() const;
    bool is_retiring_principal_Valid() const;
...
private:
    ...
    QString m_retiring_principal;
    bool m_retiring_principal_isSet;
    bool m_retiring_principal_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListRetirableGrantsRequest)

#endif // OAIListRetirableGrantsRequest_H
