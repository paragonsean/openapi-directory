...
/*
 * OAIGenerateRandomRequest.h
 *
 * 
 */

#ifndef OAIGenerateRandomRequest_H
#define OAIGenerateRandomRequest_H
...
namespace OpenAPI {
class OAIGenerateRandomRequest_Recipient;

class OAIGenerateRandomRequest : public OAIObject {
public:
    OAIGenerateRandomRequest();
    OAIGenerateRandomRequest(QString json);
    ~OAIGenerateRandomRequest() override;
    ...
    OAIGenerateRandomRequest_Recipient getRecipient() const;
    void setRecipient(const OAIGenerateRandomRequest_Recipient &recipient);
...
private:
    ...
    OAIGenerateRandomRequest_Recipient m_recipient;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGenerateRandomRequest)

#endif // OAIGenerateRandomRequest_H
