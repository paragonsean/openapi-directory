...
void OAIConnectionStateType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("CONNECTED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIConnectionStateType::CONNECTED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CONNECTING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIConnectionStateType::CONNECTING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("FAILED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIConnectionStateType::FAILED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DISCONNECTED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIConnectionStateType::DISCONNECTED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DISCONNECTING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIConnectionStateType::DISCONNECTING;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIConnectionStateType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIConnectionStateType::CONNECTED:
            val = "CONNECTED";
            break;
        case eOAIConnectionStateType::CONNECTING:
            val = "CONNECTING";
            break;
        case eOAIConnectionStateType::FAILED:
            val = "FAILED";
            break;
        case eOAIConnectionStateType::DISCONNECTED:
            val = "DISCONNECTED";
            break;
        case eOAIConnectionStateType::DISCONNECTING:
            val = "DISCONNECTING";
            break;
        default:
            break;
