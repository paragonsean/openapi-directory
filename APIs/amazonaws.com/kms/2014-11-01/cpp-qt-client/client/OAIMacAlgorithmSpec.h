...
/*
 * OAIMacAlgorithmSpec.h
 *
 * 
 */

#ifndef OAIMacAlgorithmSpec_H
#define OAIMacAlgorithmSpec_H
...
class OAIMacAlgorithmSpec : public OAIEnum {
public:
    OAIMacAlgorithmSpec();
    OAIMacAlgorithmSpec(QString json);
    ~OAIMacAlgorithmSpec() override;
    ...
    enum class eOAIMacAlgorithmSpec {
    ...
    OAIMacAlgorithmSpec::eOAIMacAlgorithmSpec getValue() const;
    void setValue(const OAIMacAlgorithmSpec::eOAIMacAlgorithmSpec& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIMacAlgorithmSpec)

#endif // OAIMacAlgorithmSpec_H
