...
/*
 * OAICreateKeyRequest.h
 *
 * 
 */

#ifndef OAICreateKeyRequest_H
#define OAICreateKeyRequest_H
...
class OAICreateKeyRequest : public OAIObject {
public:
    OAICreateKeyRequest();
    OAICreateKeyRequest(QString json);
    ~OAICreateKeyRequest() override;
    ...
    QString getXksKeyId() const;
    void setXksKeyId(const QString &xks_key_id);
    bool is_xks_key_id_Set() const;
    bool is_xks_key_id_Valid() const;
...
private:
    ...
    QString m_xks_key_id;
    bool m_xks_key_id_isSet;
    bool m_xks_key_id_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateKeyRequest)

#endif // OAICreateKeyRequest_H
