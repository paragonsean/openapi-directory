...
OAIAliasListEntry::OAIAliasListEntry(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAliasListEntry::OAIAliasListEntry() {
    this->initializeModel();
}

OAIAliasListEntry::~OAIAliasListEntry() {}

void OAIAliasListEntry::initializeModel() {
    ...
    m_target_key_id_isSet = false;
    m_target_key_id_isValid = false;
...
void OAIAliasListEntry::fromJson(QString jsonString) {
...
void OAIAliasListEntry::fromJsonObject(QJsonObject json) {
    ...
    m_target_key_id_isValid = ::OpenAPI::fromJsonValue(m_target_key_id, json[QString("TargetKeyId")]);
    m_target_key_id_isSet = !json[QString("TargetKeyId")].isNull() && m_target_key_id_isValid;
...
QString OAIAliasListEntry::asJson() const {
...
QJsonObject OAIAliasListEntry::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_target_key_id_isSet) {
        obj.insert(QString("TargetKeyId"), ::OpenAPI::toJsonValue(m_target_key_id));
    }
...
QString OAIAliasListEntry::getAliasName() const {
    return m_alias_name;
}
void OAIAliasListEntry::setAliasName(const QString &alias_name) {
    m_alias_name = alias_name;
    m_alias_name_isSet = true;
}

bool OAIAliasListEntry::is_alias_name_Set() const{
    return m_alias_name_isSet;
}

bool OAIAliasListEntry::is_alias_name_Valid() const{
    return m_alias_name_isValid;
}

QString OAIAliasListEntry::getAliasArn() const {
    return m_alias_arn;
}
void OAIAliasListEntry::setAliasArn(const QString &alias_arn) {
    m_alias_arn = alias_arn;
    m_alias_arn_isSet = true;
}

bool OAIAliasListEntry::is_alias_arn_Set() const{
    return m_alias_arn_isSet;
}

bool OAIAliasListEntry::is_alias_arn_Valid() const{
    return m_alias_arn_isValid;
}

QString OAIAliasListEntry::getTargetKeyId() const {
    return m_target_key_id;
}
void OAIAliasListEntry::setTargetKeyId(const QString &target_key_id) {
    m_target_key_id = target_key_id;
    m_target_key_id_isSet = true;
}

bool OAIAliasListEntry::is_target_key_id_Set() const{
    return m_target_key_id_isSet;
}

bool OAIAliasListEntry::is_target_key_id_Valid() const{
    return m_target_key_id_isValid;
}

QDateTime OAIAliasListEntry::getCreationDate() const {
    return m_creation_date;
}
void OAIAliasListEntry::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAIAliasListEntry::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAIAliasListEntry::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

QDateTime OAIAliasListEntry::getLastUpdatedDate() const {
    return m_last_updated_date;
}
void OAIAliasListEntry::setLastUpdatedDate(const QDateTime &last_updated_date) {
    m_last_updated_date = last_updated_date;
    m_last_updated_date_isSet = true;
}

bool OAIAliasListEntry::is_last_updated_date_Set() const{
    return m_last_updated_date_isSet;
}

bool OAIAliasListEntry::is_last_updated_date_Valid() const{
    return m_last_updated_date_isValid;
}

bool OAIAliasListEntry::isSet() const {
...
bool OAIAliasListEntry::isValid() const {
