...
/*
 * OAICreateCustomKeyStoreResponse.h
 *
 * 
 */

#ifndef OAICreateCustomKeyStoreResponse_H
#define OAICreateCustomKeyStoreResponse_H
...
class OAICreateCustomKeyStoreResponse : public OAIObject {
public:
    OAICreateCustomKeyStoreResponse();
    OAICreateCustomKeyStoreResponse(QString json);
    ~OAICreateCustomKeyStoreResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCustomKeyStoreResponse)

#endif // OAICreateCustomKeyStoreResponse_H
