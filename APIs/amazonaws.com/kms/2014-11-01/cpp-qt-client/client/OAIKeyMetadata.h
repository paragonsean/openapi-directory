...
#ifndef OAIKeyMetadata_H
#define OAIKeyMetadata_H
...
class OAIKeyMetadata : public OAIObject {
public:
    OAIKeyMetadata();
    OAIKeyMetadata(QString json);
    ~OAIKeyMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKeyMetadata)

#endif // OAIKeyMetadata_H
