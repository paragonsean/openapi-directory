...
OAIGenerateDataKeyResponse::OAIGenerateDataKeyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGenerateDataKeyResponse::OAIGenerateDataKeyResponse() {
    this->initializeModel();
}

OAIGenerateDataKeyResponse::~OAIGenerateDataKeyResponse() {}

void OAIGenerateDataKeyResponse::initializeModel() {
...
void OAIGenerateDataKeyResponse::fromJson(QString jsonString) {
...
void OAIGenerateDataKeyResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGenerateDataKeyResponse::asJson() const {
...
QJsonObject OAIGenerateDataKeyResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGenerateDataKeyResponse::getCiphertextBlob() const {
    return m_ciphertext_blob;
}
void OAIGenerateDataKeyResponse::setCiphertextBlob(const QString &ciphertext_blob) {
    m_ciphertext_blob = ciphertext_blob;
    m_ciphertext_blob_isSet = true;
}

bool OAIGenerateDataKeyResponse::is_ciphertext_blob_Set() const{
    return m_ciphertext_blob_isSet;
}

bool OAIGenerateDataKeyResponse::is_ciphertext_blob_Valid() const{
    return m_ciphertext_blob_isValid;
}

QString OAIGenerateDataKeyResponse::getPlaintext() const {
    return m_plaintext;
}
void OAIGenerateDataKeyResponse::setPlaintext(const QString &plaintext) {
    m_plaintext = plaintext;
    m_plaintext_isSet = true;
}

bool OAIGenerateDataKeyResponse::is_plaintext_Set() const{
    return m_plaintext_isSet;
}

bool OAIGenerateDataKeyResponse::is_plaintext_Valid() const{
    return m_plaintext_isValid;
}

QString OAIGenerateDataKeyResponse::getKeyId() const {
    return m_key_id;
}
void OAIGenerateDataKeyResponse::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIGenerateDataKeyResponse::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIGenerateDataKeyResponse::is_key_id_Valid() const{
    return m_key_id_isValid;
}

QString OAIGenerateDataKeyResponse::getCiphertextForRecipient() const {
    return m_ciphertext_for_recipient;
}
void OAIGenerateDataKeyResponse::setCiphertextForRecipient(const QString &ciphertext_for_recipient) {
    m_ciphertext_for_recipient = ciphertext_for_recipient;
    m_ciphertext_for_recipient_isSet = true;
}

bool OAIGenerateDataKeyResponse::is_ciphertext_for_recipient_Set() const{
    return m_ciphertext_for_recipient_isSet;
}

bool OAIGenerateDataKeyResponse::is_ciphertext_for_recipient_Valid() const{
    return m_ciphertext_for_recipient_isValid;
}

bool OAIGenerateDataKeyResponse::isSet() const {
...
bool OAIGenerateDataKeyResponse::isValid() const {
