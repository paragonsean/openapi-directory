...
#ifndef OAIVerifyResponse_H
#define OAIVerifyResponse_H
...
class OAIVerifyResponse : public OAIObject {
public:
    OAIVerifyResponse();
    OAIVerifyResponse(QString json);
    ~OAIVerifyResponse() override;
    ...
    OAISigningAlgorithmSpec getSigningAlgorithm() const;
    void setSigningAlgorithm(const OAISigningAlgorithmSpec &signing_algorithm);
...
private:
    ...
    OAISigningAlgorithmSpec m_signing_algorithm;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVerifyResponse)

#endif // OAIVerifyResponse_H
