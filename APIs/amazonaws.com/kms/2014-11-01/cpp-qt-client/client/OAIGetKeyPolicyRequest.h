...
/*
 * OAIGetKeyPolicyRequest.h
 *
 * 
 */

#ifndef OAIGetKeyPolicyRequest_H
#define OAIGetKeyPolicyRequest_H
...
class OAIGetKeyPolicyRequest : public OAIObject {
public:
    OAIGetKeyPolicyRequest();
    OAIGetKeyPolicyRequest(QString json);
    ~OAIGetKeyPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetKeyPolicyRequest)

#endif // OAIGetKeyPolicyRequest_H
