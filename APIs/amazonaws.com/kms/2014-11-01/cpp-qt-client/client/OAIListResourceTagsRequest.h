...
/*
 * OAIListResourceTagsRequest.h
 *
 * 
 */

#ifndef OAIListResourceTagsRequest_H
#define OAIListResourceTagsRequest_H
...
class OAIListResourceTagsRequest : public OAIObject {
public:
    OAIListResourceTagsRequest();
    OAIListResourceTagsRequest(QString json);
    ~OAIListResourceTagsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListResourceTagsRequest)

#endif // OAIListResourceTagsRequest_H
