...
#ifndef OAIGrantOperation_H
#define OAIGrantOperation_H
...
class OAIGrantOperation : public OAIEnum {
public:
    OAIGrantOperation();
    OAIGrantOperation(QString json);
    ~OAIGrantOperation() override;
    ...
    OAIGrantOperation::eOAIGrantOperation getValue() const;
    void setValue(const OAIGrantOperation::eOAIGrantOperation& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGrantOperation)

#endif // OAIGrantOperation_H
