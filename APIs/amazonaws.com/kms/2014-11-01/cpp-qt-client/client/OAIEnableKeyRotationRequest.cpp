...
OAIEnableKeyRotationRequest::OAIEnableKeyRotationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEnableKeyRotationRequest::OAIEnableKeyRotationRequest() {
    this->initializeModel();
}

OAIEnableKeyRotationRequest::~OAIEnableKeyRotationRequest() {}

void OAIEnableKeyRotationRequest::initializeModel() {

    m_key_id_isSet = false;
    m_key_id_isValid = false;
}

void OAIEnableKeyRotationRequest::fromJson(QString jsonString) {
...
void OAIEnableKeyRotationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIEnableKeyRotationRequest::asJson() const {
...
QJsonObject OAIEnableKeyRotationRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAIEnableKeyRotationRequest::getKeyId() const {
    return m_key_id;
}
void OAIEnableKeyRotationRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIEnableKeyRotationRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIEnableKeyRotationRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

bool OAIEnableKeyRotationRequest::isSet() const {
...
bool OAIEnableKeyRotationRequest::isValid() const {
