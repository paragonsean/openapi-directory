...
OAIKeyManagerType::OAIKeyManagerType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIKeyManagerType::OAIKeyManagerType() {
    this->initializeModel();
}

OAIKeyManagerType::~OAIKeyManagerType() {}

void OAIKeyManagerType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIKeyManagerType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIKeyManagerType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("AWS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKeyManagerType::AWS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CUSTOMER", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKeyManagerType::CUSTOMER;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIKeyManagerType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIKeyManagerType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIKeyManagerType::AWS:
            val = "AWS";
            break;
        case eOAIKeyManagerType::CUSTOMER:
            val = "CUSTOMER";
            break;
        default:
            break;
...
QJsonValue OAIKeyManagerType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIKeyManagerType::eOAIKeyManagerType OAIKeyManagerType::getValue() const {
    return m_value;
}

void OAIKeyManagerType::setValue(const OAIKeyManagerType::eOAIKeyManagerType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIKeyManagerType::isSet() const {
    
    return m_value_isSet;
}

bool OAIKeyManagerType::isValid() const {
