...
OAIListKeyPoliciesRequest::OAIListKeyPoliciesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListKeyPoliciesRequest::OAIListKeyPoliciesRequest() {
    this->initializeModel();
}

OAIListKeyPoliciesRequest::~OAIListKeyPoliciesRequest() {}

void OAIListKeyPoliciesRequest::initializeModel() {
...
void OAIListKeyPoliciesRequest::fromJson(QString jsonString) {
...
void OAIListKeyPoliciesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListKeyPoliciesRequest::asJson() const {
...
QJsonObject OAIListKeyPoliciesRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAIListKeyPoliciesRequest::getKeyId() const {
    return m_key_id;
}
void OAIListKeyPoliciesRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIListKeyPoliciesRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIListKeyPoliciesRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

qint32 OAIListKeyPoliciesRequest::getLimit() const {
    return m_limit;
}
void OAIListKeyPoliciesRequest::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIListKeyPoliciesRequest::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIListKeyPoliciesRequest::is_limit_Valid() const{
    return m_limit_isValid;
}

QString OAIListKeyPoliciesRequest::getMarker() const {
    return m_marker;
}
void OAIListKeyPoliciesRequest::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIListKeyPoliciesRequest::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIListKeyPoliciesRequest::is_marker_Valid() const{
    return m_marker_isValid;
}

bool OAIListKeyPoliciesRequest::isSet() const {
...
bool OAIListKeyPoliciesRequest::isValid() const {
