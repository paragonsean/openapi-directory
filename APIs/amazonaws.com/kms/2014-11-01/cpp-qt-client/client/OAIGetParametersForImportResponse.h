...
/*
 * OAIGetParametersForImportResponse.h
 *
 * 
 */

#ifndef OAIGetParametersForImportResponse_H
#define OAIGetParametersForImportResponse_H
...
class OAIGetParametersForImportResponse : public OAIObject {
public:
    OAIGetParametersForImportResponse();
    OAIGetParametersForImportResponse(QString json);
    ~OAIGetParametersForImportResponse() override;
    ...
    QDateTime getParametersValidTo() const;
    void setParametersValidTo(const QDateTime &parameters_valid_to);
    bool is_parameters_valid_to_Set() const;
    bool is_parameters_valid_to_Valid() const;
...
private:
    ...
    QDateTime m_parameters_valid_to;
    bool m_parameters_valid_to_isSet;
    bool m_parameters_valid_to_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetParametersForImportResponse)

#endif // OAIGetParametersForImportResponse_H
