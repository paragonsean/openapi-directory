...
OAIDisableKeyRequest::OAIDisableKeyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDisableKeyRequest::OAIDisableKeyRequest() {
    this->initializeModel();
}

OAIDisableKeyRequest::~OAIDisableKeyRequest() {}

void OAIDisableKeyRequest::initializeModel() {

    m_key_id_isSet = false;
    m_key_id_isValid = false;
}

void OAIDisableKeyRequest::fromJson(QString jsonString) {
...
void OAIDisableKeyRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDisableKeyRequest::asJson() const {
...
QJsonObject OAIDisableKeyRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAIDisableKeyRequest::getKeyId() const {
    return m_key_id;
}
void OAIDisableKeyRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIDisableKeyRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIDisableKeyRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

bool OAIDisableKeyRequest::isSet() const {
...
bool OAIDisableKeyRequest::isValid() const {
