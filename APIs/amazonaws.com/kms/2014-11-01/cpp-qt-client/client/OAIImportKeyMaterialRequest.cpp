...
OAIImportKeyMaterialRequest::OAIImportKeyMaterialRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImportKeyMaterialRequest::OAIImportKeyMaterialRequest() {
    this->initializeModel();
}

OAIImportKeyMaterialRequest::~OAIImportKeyMaterialRequest() {}

void OAIImportKeyMaterialRequest::initializeModel() {
    ...
    m_encrypted_key_material_isSet = false;
    m_encrypted_key_material_isValid = false;
...
void OAIImportKeyMaterialRequest::fromJson(QString jsonString) {
...
void OAIImportKeyMaterialRequest::fromJsonObject(QJsonObject json) {
    ...
    m_encrypted_key_material_isValid = ::OpenAPI::fromJsonValue(m_encrypted_key_material, json[QString("EncryptedKeyMaterial")]);
    m_encrypted_key_material_isSet = !json[QString("EncryptedKeyMaterial")].isNull() && m_encrypted_key_material_isValid;
...
QString OAIImportKeyMaterialRequest::asJson() const {
...
QJsonObject OAIImportKeyMaterialRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
    ...
    if (m_encrypted_key_material_isSet) {
        obj.insert(QString("EncryptedKeyMaterial"), ::OpenAPI::toJsonValue(m_encrypted_key_material));
    }
    if (m_valid_to_isSet) {
...
QString OAIImportKeyMaterialRequest::getKeyId() const {
    return m_key_id;
}
void OAIImportKeyMaterialRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIImportKeyMaterialRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIImportKeyMaterialRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

QString OAIImportKeyMaterialRequest::getImportToken() const {
    return m_import_token;
}
void OAIImportKeyMaterialRequest::setImportToken(const QString &import_token) {
    m_import_token = import_token;
    m_import_token_isSet = true;
}

bool OAIImportKeyMaterialRequest::is_import_token_Set() const{
    return m_import_token_isSet;
}

bool OAIImportKeyMaterialRequest::is_import_token_Valid() const{
    return m_import_token_isValid;
}

QString OAIImportKeyMaterialRequest::getEncryptedKeyMaterial() const {
    return m_encrypted_key_material;
}
void OAIImportKeyMaterialRequest::setEncryptedKeyMaterial(const QString &encrypted_key_material) {
    m_encrypted_key_material = encrypted_key_material;
    m_encrypted_key_material_isSet = true;
}

bool OAIImportKeyMaterialRequest::is_encrypted_key_material_Set() const{
    return m_encrypted_key_material_isSet;
}

bool OAIImportKeyMaterialRequest::is_encrypted_key_material_Valid() const{
    return m_encrypted_key_material_isValid;
}

QDateTime OAIImportKeyMaterialRequest::getValidTo() const {
    return m_valid_to;
}
void OAIImportKeyMaterialRequest::setValidTo(const QDateTime &valid_to) {
    m_valid_to = valid_to;
    m_valid_to_isSet = true;
}

bool OAIImportKeyMaterialRequest::is_valid_to_Set() const{
    return m_valid_to_isSet;
}

bool OAIImportKeyMaterialRequest::is_valid_to_Valid() const{
    return m_valid_to_isValid;
}

OAIExpirationModelType OAIImportKeyMaterialRequest::getExpirationModel() const {
    return m_expiration_model;
}
void OAIImportKeyMaterialRequest::setExpirationModel(const OAIExpirationModelType &expiration_model) {
    m_expiration_model = expiration_model;
    m_expiration_model_isSet = true;
}

bool OAIImportKeyMaterialRequest::is_expiration_model_Set() const{
    return m_expiration_model_isSet;
}

bool OAIImportKeyMaterialRequest::is_expiration_model_Valid() const{
    return m_expiration_model_isValid;
}

bool OAIImportKeyMaterialRequest::isSet() const {
...
bool OAIImportKeyMaterialRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_key_id_isValid && m_import_token_isValid && m_encrypted_key_material_isValid && true;
}
