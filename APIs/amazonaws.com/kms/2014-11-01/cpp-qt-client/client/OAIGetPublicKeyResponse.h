...
/*
 * OAIGetPublicKeyResponse.h
 *
 * 
 */

#ifndef OAIGetPublicKeyResponse_H
#define OAIGetPublicKeyResponse_H
...
class OAIGetPublicKeyResponse : public OAIObject {
public:
    OAIGetPublicKeyResponse();
    OAIGetPublicKeyResponse(QString json);
    ~OAIGetPublicKeyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPublicKeyResponse)

#endif // OAIGetPublicKeyResponse_H
