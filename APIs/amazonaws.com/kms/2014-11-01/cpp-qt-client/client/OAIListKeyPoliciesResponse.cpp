...
OAIListKeyPoliciesResponse::OAIListKeyPoliciesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListKeyPoliciesResponse::OAIListKeyPoliciesResponse() {
    this->initializeModel();
}

OAIListKeyPoliciesResponse::~OAIListKeyPoliciesResponse() {}

void OAIListKeyPoliciesResponse::initializeModel() {
...
void OAIListKeyPoliciesResponse::fromJson(QString jsonString) {
...
void OAIListKeyPoliciesResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListKeyPoliciesResponse::asJson() const {
...
QJsonObject OAIListKeyPoliciesResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIListKeyPoliciesResponse::getPolicyNames() const {
    return m_policy_names;
}
void OAIListKeyPoliciesResponse::setPolicyNames(const QList &policy_names) {
    m_policy_names = policy_names;
    m_policy_names_isSet = true;
}

bool OAIListKeyPoliciesResponse::is_policy_names_Set() const{
    return m_policy_names_isSet;
}

bool OAIListKeyPoliciesResponse::is_policy_names_Valid() const{
    return m_policy_names_isValid;
}

QString OAIListKeyPoliciesResponse::getNextMarker() const {
    return m_next_marker;
}
void OAIListKeyPoliciesResponse::setNextMarker(const QString &next_marker) {
    m_next_marker = next_marker;
    m_next_marker_isSet = true;
}

bool OAIListKeyPoliciesResponse::is_next_marker_Set() const{
    return m_next_marker_isSet;
}

bool OAIListKeyPoliciesResponse::is_next_marker_Valid() const{
    return m_next_marker_isValid;
}

bool OAIListKeyPoliciesResponse::getTruncated() const {
    return m_truncated;
}
void OAIListKeyPoliciesResponse::setTruncated(const bool &truncated) {
    m_truncated = truncated;
    m_truncated_isSet = true;
}

bool OAIListKeyPoliciesResponse::is_truncated_Set() const{
    return m_truncated_isSet;
}

bool OAIListKeyPoliciesResponse::is_truncated_Valid() const{
    return m_truncated_isValid;
}

bool OAIListKeyPoliciesResponse::isSet() const {
...
bool OAIListKeyPoliciesResponse::isValid() const {
