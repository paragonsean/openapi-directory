...
namespace OpenAPI {
class OAICreateKeyResponse_KeyMetadata;
...
public:
    ...
    OAICreateKeyResponse_KeyMetadata getKeyMetadata() const;
    void setKeyMetadata(const OAICreateKeyResponse_KeyMetadata &key_metadata);
...
private:
    ...
    OAICreateKeyResponse_KeyMetadata m_key_metadata;
