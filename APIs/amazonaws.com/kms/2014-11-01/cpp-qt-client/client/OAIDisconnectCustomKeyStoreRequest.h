...
/*
 * OAIDisconnectCustomKeyStoreRequest.h
 *
 * 
 */

#ifndef OAIDisconnectCustomKeyStoreRequest_H
#define OAIDisconnectCustomKeyStoreRequest_H
...
class OAIDisconnectCustomKeyStoreRequest : public OAIObject {
public:
    OAIDisconnectCustomKeyStoreRequest();
    OAIDisconnectCustomKeyStoreRequest(QString json);
    ~OAIDisconnectCustomKeyStoreRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisconnectCustomKeyStoreRequest)

#endif // OAIDisconnectCustomKeyStoreRequest_H
