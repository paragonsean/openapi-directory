...
qint32 OAIListKeysRequest::getLimit() const {
    return m_limit;
}
void OAIListKeysRequest::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIListKeysRequest::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIListKeysRequest::is_limit_Valid() const{
    return m_limit_isValid;
}

QString OAIListKeysRequest::getMarker() const {
    return m_marker;
}
void OAIListKeysRequest::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIListKeysRequest::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIListKeysRequest::is_marker_Valid() const{
