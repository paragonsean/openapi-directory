...
OAIDisconnectCustomKeyStoreRequest::OAIDisconnectCustomKeyStoreRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDisconnectCustomKeyStoreRequest::OAIDisconnectCustomKeyStoreRequest() {
    this->initializeModel();
}

OAIDisconnectCustomKeyStoreRequest::~OAIDisconnectCustomKeyStoreRequest() {}

void OAIDisconnectCustomKeyStoreRequest::initializeModel() {

    m_custom_key_store_id_isSet = false;
    m_custom_key_store_id_isValid = false;
}

void OAIDisconnectCustomKeyStoreRequest::fromJson(QString jsonString) {
...
void OAIDisconnectCustomKeyStoreRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDisconnectCustomKeyStoreRequest::asJson() const {
...
QJsonObject OAIDisconnectCustomKeyStoreRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDisconnectCustomKeyStoreRequest::getCustomKeyStoreId() const {
    return m_custom_key_store_id;
}
void OAIDisconnectCustomKeyStoreRequest::setCustomKeyStoreId(const QString &custom_key_store_id) {
    m_custom_key_store_id = custom_key_store_id;
    m_custom_key_store_id_isSet = true;
}

bool OAIDisconnectCustomKeyStoreRequest::is_custom_key_store_id_Set() const{
    return m_custom_key_store_id_isSet;
}

bool OAIDisconnectCustomKeyStoreRequest::is_custom_key_store_id_Valid() const{
    return m_custom_key_store_id_isValid;
}

bool OAIDisconnectCustomKeyStoreRequest::isSet() const {
...
bool OAIDisconnectCustomKeyStoreRequest::isValid() const {
