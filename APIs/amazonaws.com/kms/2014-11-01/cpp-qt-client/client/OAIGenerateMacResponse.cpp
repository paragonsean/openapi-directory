...
OAIGenerateMacResponse::OAIGenerateMacResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGenerateMacResponse::OAIGenerateMacResponse() {
    this->initializeModel();
}

OAIGenerateMacResponse::~OAIGenerateMacResponse() {}

void OAIGenerateMacResponse::initializeModel() {
...
void OAIGenerateMacResponse::fromJson(QString jsonString) {
...
void OAIGenerateMacResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGenerateMacResponse::asJson() const {
...
QJsonObject OAIGenerateMacResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_mac_isSet) {
...
QString OAIGenerateMacResponse::getMac() const {
    return m_mac;
}
void OAIGenerateMacResponse::setMac(const QString &mac) {
    m_mac = mac;
    m_mac_isSet = true;
}

bool OAIGenerateMacResponse::is_mac_Set() const{
    return m_mac_isSet;
}

bool OAIGenerateMacResponse::is_mac_Valid() const{
    return m_mac_isValid;
}

OAIMacAlgorithmSpec OAIGenerateMacResponse::getMacAlgorithm() const {
    return m_mac_algorithm;
}
void OAIGenerateMacResponse::setMacAlgorithm(const OAIMacAlgorithmSpec &mac_algorithm) {
    m_mac_algorithm = mac_algorithm;
    m_mac_algorithm_isSet = true;
}

bool OAIGenerateMacResponse::is_mac_algorithm_Set() const{
    return m_mac_algorithm_isSet;
}

bool OAIGenerateMacResponse::is_mac_algorithm_Valid() const{
    return m_mac_algorithm_isValid;
}

QString OAIGenerateMacResponse::getKeyId() const {
    return m_key_id;
}
void OAIGenerateMacResponse::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIGenerateMacResponse::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIGenerateMacResponse::is_key_id_Valid() const{
    return m_key_id_isValid;
}

bool OAIGenerateMacResponse::isSet() const {
...
bool OAIGenerateMacResponse::isValid() const {
