...
/*
 * OAIVerifyMacResponse.h
 *
 * 
 */

#ifndef OAIVerifyMacResponse_H
#define OAIVerifyMacResponse_H

#include <QJsonObject>

#include "OAIMacAlgorithmSpec.h"
#include <QString>
...
class OAIVerifyMacResponse : public OAIObject {
public:
    OAIVerifyMacResponse();
    OAIVerifyMacResponse(QString json);
    ~OAIVerifyMacResponse() override;
    ...
    bool getMacValid() const;
    void setMacValid(const bool &mac_valid);
    bool is_mac_valid_Set() const;
    bool is_mac_valid_Valid() const;

    OAIMacAlgorithmSpec getMacAlgorithm() const;
    void setMacAlgorithm(const OAIMacAlgorithmSpec &mac_algorithm);
    bool is_mac_algorithm_Set() const;
    bool is_mac_algorithm_Valid() const;
...
private:
    ...
    bool m_mac_valid;
    bool m_mac_valid_isSet;
    bool m_mac_valid_isValid;

    OAIMacAlgorithmSpec m_mac_algorithm;
    bool m_mac_algorithm_isSet;
    bool m_mac_algorithm_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIVerifyMacResponse)

#endif // OAIVerifyMacResponse_H
