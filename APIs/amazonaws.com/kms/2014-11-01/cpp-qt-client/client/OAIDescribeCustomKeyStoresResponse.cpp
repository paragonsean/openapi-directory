...
OAIDescribeCustomKeyStoresResponse::OAIDescribeCustomKeyStoresResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeCustomKeyStoresResponse::OAIDescribeCustomKeyStoresResponse() {
    this->initializeModel();
}

OAIDescribeCustomKeyStoresResponse::~OAIDescribeCustomKeyStoresResponse() {}

void OAIDescribeCustomKeyStoresResponse::initializeModel() {

    m_custom_key_stores_isSet = false;
    m_custom_key_stores_isValid = false;
...
void OAIDescribeCustomKeyStoresResponse::fromJson(QString jsonString) {
...
void OAIDescribeCustomKeyStoresResponse::fromJsonObject(QJsonObject json) {

    m_custom_key_stores_isValid = ::OpenAPI::fromJsonValue(m_custom_key_stores, json[QString("CustomKeyStores")]);
    m_custom_key_stores_isSet = !json[QString("CustomKeyStores")].isNull() && m_custom_key_stores_isValid;
...
QString OAIDescribeCustomKeyStoresResponse::asJson() const {
...
QJsonObject OAIDescribeCustomKeyStoresResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_custom_key_stores.isSet()) {
        obj.insert(QString("CustomKeyStores"), ::OpenAPI::toJsonValue(m_custom_key_stores));
    }
...
QList OAIDescribeCustomKeyStoresResponse::getCustomKeyStores() const {
    return m_custom_key_stores;
}
void OAIDescribeCustomKeyStoresResponse::setCustomKeyStores(const QList &custom_key_stores) {
    m_custom_key_stores = custom_key_stores;
    m_custom_key_stores_isSet = true;
}

bool OAIDescribeCustomKeyStoresResponse::is_custom_key_stores_Set() const{
    return m_custom_key_stores_isSet;
}

bool OAIDescribeCustomKeyStoresResponse::is_custom_key_stores_Valid() const{
    return m_custom_key_stores_isValid;
}

QString OAIDescribeCustomKeyStoresResponse::getNextMarker() const {
    return m_next_marker;
}
void OAIDescribeCustomKeyStoresResponse::setNextMarker(const QString &next_marker) {
    m_next_marker = next_marker;
    m_next_marker_isSet = true;
}

bool OAIDescribeCustomKeyStoresResponse::is_next_marker_Set() const{
    return m_next_marker_isSet;
}

bool OAIDescribeCustomKeyStoresResponse::is_next_marker_Valid() const{
    return m_next_marker_isValid;
}

bool OAIDescribeCustomKeyStoresResponse::getTruncated() const {
    return m_truncated;
}
void OAIDescribeCustomKeyStoresResponse::setTruncated(const bool &truncated) {
    m_truncated = truncated;
    m_truncated_isSet = true;
}

bool OAIDescribeCustomKeyStoresResponse::is_truncated_Set() const{
    return m_truncated_isSet;
}

bool OAIDescribeCustomKeyStoresResponse::is_truncated_Valid() const{
    return m_truncated_isValid;
}

bool OAIDescribeCustomKeyStoresResponse::isSet() const {
...
bool OAIDescribeCustomKeyStoresResponse::isValid() const {
