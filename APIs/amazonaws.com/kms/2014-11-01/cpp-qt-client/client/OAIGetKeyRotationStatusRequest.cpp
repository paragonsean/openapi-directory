...
OAIGetKeyRotationStatusRequest::OAIGetKeyRotationStatusRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetKeyRotationStatusRequest::OAIGetKeyRotationStatusRequest() {
    this->initializeModel();
}

OAIGetKeyRotationStatusRequest::~OAIGetKeyRotationStatusRequest() {}

void OAIGetKeyRotationStatusRequest::initializeModel() {

    m_key_id_isSet = false;
    m_key_id_isValid = false;
}

void OAIGetKeyRotationStatusRequest::fromJson(QString jsonString) {
...
void OAIGetKeyRotationStatusRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetKeyRotationStatusRequest::asJson() const {
...
QJsonObject OAIGetKeyRotationStatusRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAIGetKeyRotationStatusRequest::getKeyId() const {
    return m_key_id;
}
void OAIGetKeyRotationStatusRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIGetKeyRotationStatusRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIGetKeyRotationStatusRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

bool OAIGetKeyRotationStatusRequest::isSet() const {
...
bool OAIGetKeyRotationStatusRequest::isValid() const {
