...
OAIScheduleKeyDeletionRequest::OAIScheduleKeyDeletionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIScheduleKeyDeletionRequest::OAIScheduleKeyDeletionRequest() {
    this->initializeModel();
}

OAIScheduleKeyDeletionRequest::~OAIScheduleKeyDeletionRequest() {}

void OAIScheduleKeyDeletionRequest::initializeModel() {
...
void OAIScheduleKeyDeletionRequest::fromJson(QString jsonString) {
...
void OAIScheduleKeyDeletionRequest::fromJsonObject(QJsonObject json) {
...
QString OAIScheduleKeyDeletionRequest::asJson() const {
...
QJsonObject OAIScheduleKeyDeletionRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAIScheduleKeyDeletionRequest::getKeyId() const {
    return m_key_id;
}
void OAIScheduleKeyDeletionRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIScheduleKeyDeletionRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIScheduleKeyDeletionRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

qint32 OAIScheduleKeyDeletionRequest::getPendingWindowInDays() const {
    return m_pending_window_in_days;
}
void OAIScheduleKeyDeletionRequest::setPendingWindowInDays(const qint32 &pending_window_in_days) {
    m_pending_window_in_days = pending_window_in_days;
    m_pending_window_in_days_isSet = true;
}

bool OAIScheduleKeyDeletionRequest::is_pending_window_in_days_Set() const{
    return m_pending_window_in_days_isSet;
}

bool OAIScheduleKeyDeletionRequest::is_pending_window_in_days_Valid() const{
    return m_pending_window_in_days_isValid;
}

bool OAIScheduleKeyDeletionRequest::isSet() const {
...
bool OAIScheduleKeyDeletionRequest::isValid() const {
