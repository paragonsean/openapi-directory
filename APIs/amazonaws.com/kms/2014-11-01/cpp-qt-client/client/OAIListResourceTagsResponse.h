...
/*
 * OAIListResourceTagsResponse.h
 *
 * 
 */

#ifndef OAIListResourceTagsResponse_H
#define OAIListResourceTagsResponse_H
...
class OAIListResourceTagsResponse : public OAIObject {
public:
    OAIListResourceTagsResponse();
    OAIListResourceTagsResponse(QString json);
    ~OAIListResourceTagsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListResourceTagsResponse)

#endif // OAIListResourceTagsResponse_H
