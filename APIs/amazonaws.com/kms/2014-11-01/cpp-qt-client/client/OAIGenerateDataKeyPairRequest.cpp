...
OAIGenerateDataKeyPairRequest::OAIGenerateDataKeyPairRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGenerateDataKeyPairRequest::OAIGenerateDataKeyPairRequest() {
    this->initializeModel();
}

OAIGenerateDataKeyPairRequest::~OAIGenerateDataKeyPairRequest() {}

void OAIGenerateDataKeyPairRequest::initializeModel() {
...
void OAIGenerateDataKeyPairRequest::fromJson(QString jsonString) {
...
void OAIGenerateDataKeyPairRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGenerateDataKeyPairRequest::asJson() const {
...
QJsonObject OAIGenerateDataKeyPairRequest::asJsonObject() const {
    QJsonObject obj;
...
QMap OAIGenerateDataKeyPairRequest::getEncryptionContext() const {
    return m_encryption_context;
}
void OAIGenerateDataKeyPairRequest::setEncryptionContext(const QMap &encryption_context) {
    m_encryption_context = encryption_context;
    m_encryption_context_isSet = true;
}

bool OAIGenerateDataKeyPairRequest::is_encryption_context_Set() const{
    return m_encryption_context_isSet;
}

bool OAIGenerateDataKeyPairRequest::is_encryption_context_Valid() const{
    return m_encryption_context_isValid;
}

QString OAIGenerateDataKeyPairRequest::getKeyId() const {
    return m_key_id;
}
void OAIGenerateDataKeyPairRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIGenerateDataKeyPairRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIGenerateDataKeyPairRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

OAIDataKeyPairSpec OAIGenerateDataKeyPairRequest::getKeyPairSpec() const {
    return m_key_pair_spec;
}
void OAIGenerateDataKeyPairRequest::setKeyPairSpec(const OAIDataKeyPairSpec &key_pair_spec) {
    m_key_pair_spec = key_pair_spec;
    m_key_pair_spec_isSet = true;
}

bool OAIGenerateDataKeyPairRequest::is_key_pair_spec_Set() const{
    return m_key_pair_spec_isSet;
}

bool OAIGenerateDataKeyPairRequest::is_key_pair_spec_Valid() const{
    return m_key_pair_spec_isValid;
}

QList OAIGenerateDataKeyPairRequest::getGrantTokens() const {
    return m_grant_tokens;
}
void OAIGenerateDataKeyPairRequest::setGrantTokens(const QList &grant_tokens) {
    m_grant_tokens = grant_tokens;
    m_grant_tokens_isSet = true;
}

bool OAIGenerateDataKeyPairRequest::is_grant_tokens_Set() const{
    return m_grant_tokens_isSet;
}

bool OAIGenerateDataKeyPairRequest::is_grant_tokens_Valid() const{
    return m_grant_tokens_isValid;
}

OAIGenerateDataKeyPairRequest_Recipient OAIGenerateDataKeyPairRequest::getRecipient() const {
    return m_recipient;
}
void OAIGenerateDataKeyPairRequest::setRecipient(const OAIGenerateDataKeyPairRequest_Recipient &recipient) {
    m_recipient = recipient;
    m_recipient_isSet = true;
}

bool OAIGenerateDataKeyPairRequest::is_recipient_Set() const{
    return m_recipient_isSet;
}

bool OAIGenerateDataKeyPairRequest::is_recipient_Valid() const{
    return m_recipient_isValid;
}

bool OAIGenerateDataKeyPairRequest::getDryRun() const {
    return m_dry_run;
}
void OAIGenerateDataKeyPairRequest::setDryRun(const bool &dry_run) {
    m_dry_run = dry_run;
    m_dry_run_isSet = true;
}

bool OAIGenerateDataKeyPairRequest::is_dry_run_Set() const{
    return m_dry_run_isSet;
}

bool OAIGenerateDataKeyPairRequest::is_dry_run_Valid() const{
    return m_dry_run_isValid;
}

bool OAIGenerateDataKeyPairRequest::isSet() const {
...
bool OAIGenerateDataKeyPairRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_key_id_isValid && m_key_pair_spec_isValid && true;
}
