...
/*
 * OAIUpdateAliasRequest.h
 *
 * 
 */

#ifndef OAIUpdateAliasRequest_H
#define OAIUpdateAliasRequest_H
...
class OAIUpdateAliasRequest : public OAIObject {
public:
    OAIUpdateAliasRequest();
    OAIUpdateAliasRequest(QString json);
    ~OAIUpdateAliasRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAliasRequest)

#endif // OAIUpdateAliasRequest_H
