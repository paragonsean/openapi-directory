...
/*
 * OAIGetPublicKeyRequest.h
 *
 * 
 */

#ifndef OAIGetPublicKeyRequest_H
#define OAIGetPublicKeyRequest_H
...
class OAIGetPublicKeyRequest : public OAIObject {
public:
    OAIGetPublicKeyRequest();
    OAIGetPublicKeyRequest(QString json);
    ~OAIGetPublicKeyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPublicKeyRequest)

#endif // OAIGetPublicKeyRequest_H
