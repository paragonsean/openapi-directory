...
/*
 * OAIWrappingKeySpec.h
 *
 * 
 */

#ifndef OAIWrappingKeySpec_H
#define OAIWrappingKeySpec_H
...
class OAIWrappingKeySpec : public OAIEnum {
public:
    OAIWrappingKeySpec();
    OAIWrappingKeySpec(QString json);
    ~OAIWrappingKeySpec() override;
    ...
    enum class eOAIWrappingKeySpec {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        _2048, 
        _3072, 
        _4096
    };
    OAIWrappingKeySpec::eOAIWrappingKeySpec getValue() const;
    void setValue(const OAIWrappingKeySpec::eOAIWrappingKeySpec& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIWrappingKeySpec)

#endif // OAIWrappingKeySpec_H
