...
OAIKeyEncryptionMechanism::OAIKeyEncryptionMechanism(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIKeyEncryptionMechanism::OAIKeyEncryptionMechanism() {
    this->initializeModel();
}

OAIKeyEncryptionMechanism::~OAIKeyEncryptionMechanism() {}

void OAIKeyEncryptionMechanism::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIKeyEncryptionMechanism::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIKeyEncryptionMechanism::fromJson(QString jsonString) {
    
    if ( jsonString.compare("RSAES_OAEP_SHA_256", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKeyEncryptionMechanism::RSAES_OAEP_SHA_256;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIKeyEncryptionMechanism::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIKeyEncryptionMechanism::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIKeyEncryptionMechanism::RSAES_OAEP_SHA_256:
...
QJsonValue OAIKeyEncryptionMechanism::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIKeyEncryptionMechanism::eOAIKeyEncryptionMechanism OAIKeyEncryptionMechanism::getValue() const {
    return m_value;
}

void OAIKeyEncryptionMechanism::setValue(const OAIKeyEncryptionMechanism::eOAIKeyEncryptionMechanism& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIKeyEncryptionMechanism::isSet() const {
    
    return m_value_isSet;
}

bool OAIKeyEncryptionMechanism::isValid() const {
