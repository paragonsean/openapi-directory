...
OAIGetPublicKeyRequest::OAIGetPublicKeyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPublicKeyRequest::OAIGetPublicKeyRequest() {
    this->initializeModel();
}

OAIGetPublicKeyRequest::~OAIGetPublicKeyRequest() {}

void OAIGetPublicKeyRequest::initializeModel() {
...
void OAIGetPublicKeyRequest::fromJson(QString jsonString) {
...
void OAIGetPublicKeyRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetPublicKeyRequest::asJson() const {
...
QJsonObject OAIGetPublicKeyRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAIGetPublicKeyRequest::getKeyId() const {
    return m_key_id;
}
void OAIGetPublicKeyRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIGetPublicKeyRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIGetPublicKeyRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

QList OAIGetPublicKeyRequest::getGrantTokens() const {
    return m_grant_tokens;
}
void OAIGetPublicKeyRequest::setGrantTokens(const QList &grant_tokens) {
    m_grant_tokens = grant_tokens;
    m_grant_tokens_isSet = true;
}

bool OAIGetPublicKeyRequest::is_grant_tokens_Set() const{
    return m_grant_tokens_isSet;
}

bool OAIGetPublicKeyRequest::is_grant_tokens_Valid() const{
    return m_grant_tokens_isValid;
}

bool OAIGetPublicKeyRequest::isSet() const {
...
bool OAIGetPublicKeyRequest::isValid() const {
