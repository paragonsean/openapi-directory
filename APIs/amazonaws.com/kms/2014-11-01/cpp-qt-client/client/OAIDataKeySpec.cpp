...
OAIDataKeySpec::OAIDataKeySpec(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDataKeySpec::OAIDataKeySpec() {
    this->initializeModel();
}

OAIDataKeySpec::~OAIDataKeySpec() {}

void OAIDataKeySpec::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIDataKeySpec::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIDataKeySpec::fromJson(QString jsonString) {
    
    if ( jsonString.compare("AES_256", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDataKeySpec::_256;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("AES_128", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDataKeySpec::_128;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIDataKeySpec::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIDataKeySpec::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIDataKeySpec::_256:
            val = "AES_256";
            break;
        case eOAIDataKeySpec::_128:
            val = "AES_128";
            break;
        default:
            break;
...
QJsonValue OAIDataKeySpec::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIDataKeySpec::eOAIDataKeySpec OAIDataKeySpec::getValue() const {
    return m_value;
}

void OAIDataKeySpec::setValue(const OAIDataKeySpec::eOAIDataKeySpec& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIDataKeySpec::isSet() const {
    
    return m_value_isSet;
}

bool OAIDataKeySpec::isValid() const {
