...
OAIDescribeKeyRequest::OAIDescribeKeyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeKeyRequest::OAIDescribeKeyRequest() {
    this->initializeModel();
}

OAIDescribeKeyRequest::~OAIDescribeKeyRequest() {}

void OAIDescribeKeyRequest::initializeModel() {
...
void OAIDescribeKeyRequest::fromJson(QString jsonString) {
...
void OAIDescribeKeyRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeKeyRequest::asJson() const {
...
QJsonObject OAIDescribeKeyRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAIDescribeKeyRequest::getKeyId() const {
    return m_key_id;
}
void OAIDescribeKeyRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIDescribeKeyRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIDescribeKeyRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

QList OAIDescribeKeyRequest::getGrantTokens() const {
    return m_grant_tokens;
}
void OAIDescribeKeyRequest::setGrantTokens(const QList &grant_tokens) {
    m_grant_tokens = grant_tokens;
    m_grant_tokens_isSet = true;
}

bool OAIDescribeKeyRequest::is_grant_tokens_Set() const{
    return m_grant_tokens_isSet;
}

bool OAIDescribeKeyRequest::is_grant_tokens_Valid() const{
    return m_grant_tokens_isValid;
}

bool OAIDescribeKeyRequest::isSet() const {
...
bool OAIDescribeKeyRequest::isValid() const {
