...
OAIRetireGrantRequest::OAIRetireGrantRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRetireGrantRequest::OAIRetireGrantRequest() {
    this->initializeModel();
}

OAIRetireGrantRequest::~OAIRetireGrantRequest() {}

void OAIRetireGrantRequest::initializeModel() {
...
void OAIRetireGrantRequest::fromJson(QString jsonString) {
...
void OAIRetireGrantRequest::fromJsonObject(QJsonObject json) {
...
QString OAIRetireGrantRequest::asJson() const {
...
QJsonObject OAIRetireGrantRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRetireGrantRequest::getGrantToken() const {
    return m_grant_token;
}
void OAIRetireGrantRequest::setGrantToken(const QString &grant_token) {
    m_grant_token = grant_token;
    m_grant_token_isSet = true;
}

bool OAIRetireGrantRequest::is_grant_token_Set() const{
    return m_grant_token_isSet;
}

bool OAIRetireGrantRequest::is_grant_token_Valid() const{
    return m_grant_token_isValid;
}

QString OAIRetireGrantRequest::getKeyId() const {
    return m_key_id;
}
void OAIRetireGrantRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIRetireGrantRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIRetireGrantRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

QString OAIRetireGrantRequest::getGrantId() const {
    return m_grant_id;
}
void OAIRetireGrantRequest::setGrantId(const QString &grant_id) {
    m_grant_id = grant_id;
    m_grant_id_isSet = true;
}

bool OAIRetireGrantRequest::is_grant_id_Set() const{
    return m_grant_id_isSet;
}

bool OAIRetireGrantRequest::is_grant_id_Valid() const{
    return m_grant_id_isValid;
}

bool OAIRetireGrantRequest::getDryRun() const {
    return m_dry_run;
}
void OAIRetireGrantRequest::setDryRun(const bool &dry_run) {
    m_dry_run = dry_run;
    m_dry_run_isSet = true;
}

bool OAIRetireGrantRequest::is_dry_run_Set() const{
    return m_dry_run_isSet;
}

bool OAIRetireGrantRequest::is_dry_run_Valid() const{
    return m_dry_run_isValid;
}

bool OAIRetireGrantRequest::isSet() const {
...
bool OAIRetireGrantRequest::isValid() const {
