...
QList OAIListAliasesResponse::getAliases() const {
    return m_aliases;
}
void OAIListAliasesResponse::setAliases(const QList &aliases) {
    m_aliases = aliases;
    m_aliases_isSet = true;
}

bool OAIListAliasesResponse::is_aliases_Set() const{
    return m_aliases_isSet;
}

bool OAIListAliasesResponse::is_aliases_Valid() const{
    return m_aliases_isValid;
}

QString OAIListAliasesResponse::getNextMarker() const {
    return m_next_marker;
}
void OAIListAliasesResponse::setNextMarker(const QString &next_marker) {
    m_next_marker = next_marker;
    m_next_marker_isSet = true;
}

bool OAIListAliasesResponse::is_next_marker_Set() const{
    return m_next_marker_isSet;
}

bool OAIListAliasesResponse::is_next_marker_Valid() const{
    return m_next_marker_isValid;
}

bool OAIListAliasesResponse::getTruncated() const {
    return m_truncated;
}
void OAIListAliasesResponse::setTruncated(const bool &truncated) {
    m_truncated = truncated;
    m_truncated_isSet = true;
}

bool OAIListAliasesResponse::is_truncated_Set() const{
    return m_truncated_isSet;
}

bool OAIListAliasesResponse::is_truncated_Valid() const{
