...
/*
 * OAIRevokeGrantRequest.h
 *
 * 
 */

#ifndef OAIRevokeGrantRequest_H
#define OAIRevokeGrantRequest_H
...
class OAIRevokeGrantRequest : public OAIObject {
public:
    OAIRevokeGrantRequest();
    OAIRevokeGrantRequest(QString json);
    ~OAIRevokeGrantRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRevokeGrantRequest)

#endif // OAIRevokeGrantRequest_H
