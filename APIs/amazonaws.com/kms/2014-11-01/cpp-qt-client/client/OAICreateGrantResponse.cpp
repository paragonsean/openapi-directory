...
void OAICreateGrantResponse::initializeModel() {
    ...
    m_grant_token_isSet = false;
    m_grant_token_isValid = false;
...
void OAICreateGrantResponse::fromJsonObject(QJsonObject json) {
    ...
    m_grant_token_isValid = ::OpenAPI::fromJsonValue(m_grant_token, json[QString("GrantToken")]);
    m_grant_token_isSet = !json[QString("GrantToken")].isNull() && m_grant_token_isValid;
...
QJsonObject OAICreateGrantResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_grant_token_isSet) {
        obj.insert(QString("GrantToken"), ::OpenAPI::toJsonValue(m_grant_token));
    }
    if (m_grant_id_isSet) {
...
QString OAICreateGrantResponse::getGrantToken() const {
    return m_grant_token;
}
void OAICreateGrantResponse::setGrantToken(const QString &grant_token) {
    m_grant_token = grant_token;
    m_grant_token_isSet = true;
}

bool OAICreateGrantResponse::is_grant_token_Set() const{
    return m_grant_token_isSet;
}

bool OAICreateGrantResponse::is_grant_token_Valid() const{
    return m_grant_token_isValid;
}

QString OAICreateGrantResponse::getGrantId() const {
    return m_grant_id;
}
void OAICreateGrantResponse::setGrantId(const QString &grant_id) {
    m_grant_id = grant_id;
    m_grant_id_isSet = true;
}

bool OAICreateGrantResponse::is_grant_id_Set() const{
    return m_grant_id_isSet;
}

bool OAICreateGrantResponse::is_grant_id_Valid() const{
