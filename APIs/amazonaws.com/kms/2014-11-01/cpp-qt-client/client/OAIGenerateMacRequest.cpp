...
OAIGenerateMacRequest::OAIGenerateMacRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGenerateMacRequest::OAIGenerateMacRequest() {
    this->initializeModel();
}

OAIGenerateMacRequest::~OAIGenerateMacRequest() {}

void OAIGenerateMacRequest::initializeModel() {
...
void OAIGenerateMacRequest::fromJson(QString jsonString) {
...
void OAIGenerateMacRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGenerateMacRequest::asJson() const {
...
QJsonObject OAIGenerateMacRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_message_isSet) {
...
QString OAIGenerateMacRequest::getMessage() const {
    return m_message;
}
void OAIGenerateMacRequest::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIGenerateMacRequest::is_message_Set() const{
    return m_message_isSet;
}

bool OAIGenerateMacRequest::is_message_Valid() const{
    return m_message_isValid;
}

QString OAIGenerateMacRequest::getKeyId() const {
    return m_key_id;
}
void OAIGenerateMacRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIGenerateMacRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIGenerateMacRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

OAIMacAlgorithmSpec OAIGenerateMacRequest::getMacAlgorithm() const {
    return m_mac_algorithm;
}
void OAIGenerateMacRequest::setMacAlgorithm(const OAIMacAlgorithmSpec &mac_algorithm) {
    m_mac_algorithm = mac_algorithm;
    m_mac_algorithm_isSet = true;
}

bool OAIGenerateMacRequest::is_mac_algorithm_Set() const{
    return m_mac_algorithm_isSet;
}

bool OAIGenerateMacRequest::is_mac_algorithm_Valid() const{
    return m_mac_algorithm_isValid;
}

QList OAIGenerateMacRequest::getGrantTokens() const {
    return m_grant_tokens;
}
void OAIGenerateMacRequest::setGrantTokens(const QList &grant_tokens) {
    m_grant_tokens = grant_tokens;
    m_grant_tokens_isSet = true;
}

bool OAIGenerateMacRequest::is_grant_tokens_Set() const{
    return m_grant_tokens_isSet;
}

bool OAIGenerateMacRequest::is_grant_tokens_Valid() const{
    return m_grant_tokens_isValid;
}

bool OAIGenerateMacRequest::getDryRun() const {
    return m_dry_run;
}
void OAIGenerateMacRequest::setDryRun(const bool &dry_run) {
    m_dry_run = dry_run;
    m_dry_run_isSet = true;
}

bool OAIGenerateMacRequest::is_dry_run_Set() const{
    return m_dry_run_isSet;
}

bool OAIGenerateMacRequest::is_dry_run_Valid() const{
    return m_dry_run_isValid;
}

bool OAIGenerateMacRequest::isSet() const {
...
bool OAIGenerateMacRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_message_isValid && m_key_id_isValid && m_mac_algorithm_isValid && true;
}
