...
#include "OAIXksProxyAuthenticationCredentialType.h"
...
OAIXksProxyAuthenticationCredentialType::OAIXksProxyAuthenticationCredentialType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIXksProxyAuthenticationCredentialType::OAIXksProxyAuthenticationCredentialType() {
    this->initializeModel();
}

OAIXksProxyAuthenticationCredentialType::~OAIXksProxyAuthenticationCredentialType() {}

void OAIXksProxyAuthenticationCredentialType::initializeModel() {
...
void OAIXksProxyAuthenticationCredentialType::fromJson(QString jsonString) {
...
void OAIXksProxyAuthenticationCredentialType::fromJsonObject(QJsonObject json) {
...
QString OAIXksProxyAuthenticationCredentialType::asJson() const {
...
QJsonObject OAIXksProxyAuthenticationCredentialType::asJsonObject() const {
    QJsonObject obj;
...
QString OAIXksProxyAuthenticationCredentialType::getAccessKeyId() const {
    return m_access_key_id;
}
void OAIXksProxyAuthenticationCredentialType::setAccessKeyId(const QString &access_key_id) {
    m_access_key_id = access_key_id;
    m_access_key_id_isSet = true;
}

bool OAIXksProxyAuthenticationCredentialType::is_access_key_id_Set() const{
    return m_access_key_id_isSet;
}

bool OAIXksProxyAuthenticationCredentialType::is_access_key_id_Valid() const{
    return m_access_key_id_isValid;
}

QString OAIXksProxyAuthenticationCredentialType::getRawSecretAccessKey() const {
    return m_raw_secret_access_key;
}
void OAIXksProxyAuthenticationCredentialType::setRawSecretAccessKey(const QString &raw_secret_access_key) {
    m_raw_secret_access_key = raw_secret_access_key;
    m_raw_secret_access_key_isSet = true;
}

bool OAIXksProxyAuthenticationCredentialType::is_raw_secret_access_key_Set() const{
    return m_raw_secret_access_key_isSet;
}

bool OAIXksProxyAuthenticationCredentialType::is_raw_secret_access_key_Valid() const{
    return m_raw_secret_access_key_isValid;
}

bool OAIXksProxyAuthenticationCredentialType::isSet() const {
...
bool OAIXksProxyAuthenticationCredentialType::isValid() const {
