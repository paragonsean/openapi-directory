...
/*
 * OAIGenerateDataKeyResponse.h
 *
 * 
 */

#ifndef OAIGenerateDataKeyResponse_H
#define OAIGenerateDataKeyResponse_H
...
class OAIGenerateDataKeyResponse : public OAIObject {
public:
    OAIGenerateDataKeyResponse();
    OAIGenerateDataKeyResponse(QString json);
    ~OAIGenerateDataKeyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGenerateDataKeyResponse)

#endif // OAIGenerateDataKeyResponse_H
