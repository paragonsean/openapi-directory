...
OAIUpdatePrimaryRegionRequest::OAIUpdatePrimaryRegionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePrimaryRegionRequest::OAIUpdatePrimaryRegionRequest() {
    this->initializeModel();
}

OAIUpdatePrimaryRegionRequest::~OAIUpdatePrimaryRegionRequest() {}

void OAIUpdatePrimaryRegionRequest::initializeModel() {
...
void OAIUpdatePrimaryRegionRequest::fromJson(QString jsonString) {
...
void OAIUpdatePrimaryRegionRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdatePrimaryRegionRequest::asJson() const {
...
QJsonObject OAIUpdatePrimaryRegionRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAIUpdatePrimaryRegionRequest::getKeyId() const {
    return m_key_id;
}
void OAIUpdatePrimaryRegionRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIUpdatePrimaryRegionRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIUpdatePrimaryRegionRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

QString OAIUpdatePrimaryRegionRequest::getPrimaryRegion() const {
    return m_primary_region;
}
void OAIUpdatePrimaryRegionRequest::setPrimaryRegion(const QString &primary_region) {
    m_primary_region = primary_region;
    m_primary_region_isSet = true;
}

bool OAIUpdatePrimaryRegionRequest::is_primary_region_Set() const{
    return m_primary_region_isSet;
}

bool OAIUpdatePrimaryRegionRequest::is_primary_region_Valid() const{
    return m_primary_region_isValid;
}

bool OAIUpdatePrimaryRegionRequest::isSet() const {
...
bool OAIUpdatePrimaryRegionRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_key_id_isValid && m_primary_region_isValid && true;
}
