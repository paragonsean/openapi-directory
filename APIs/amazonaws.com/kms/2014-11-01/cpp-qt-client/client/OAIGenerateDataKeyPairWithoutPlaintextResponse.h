...
/*
 * OAIGenerateDataKeyPairWithoutPlaintextResponse.h
 *
 * 
 */

#ifndef OAIGenerateDataKeyPairWithoutPlaintextResponse_H
#define OAIGenerateDataKeyPairWithoutPlaintextResponse_H
...
class OAIGenerateDataKeyPairWithoutPlaintextResponse : public OAIObject {
public:
    OAIGenerateDataKeyPairWithoutPlaintextResponse();
    OAIGenerateDataKeyPairWithoutPlaintextResponse(QString json);
    ~OAIGenerateDataKeyPairWithoutPlaintextResponse() override;
    ...
    QString getPrivateKeyCiphertextBlob() const;
    void setPrivateKeyCiphertextBlob(const QString &private_key_ciphertext_blob);
    bool is_private_key_ciphertext_blob_Set() const;
    bool is_private_key_ciphertext_blob_Valid() const;
...
private:
    ...
    QString m_private_key_ciphertext_blob;
    bool m_private_key_ciphertext_blob_isSet;
    bool m_private_key_ciphertext_blob_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGenerateDataKeyPairWithoutPlaintextResponse)

#endif // OAIGenerateDataKeyPairWithoutPlaintextResponse_H
