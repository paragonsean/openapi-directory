...
/*
 * OAIUpdatePrimaryRegionRequest.h
 *
 * 
 */

#ifndef OAIUpdatePrimaryRegionRequest_H
#define OAIUpdatePrimaryRegionRequest_H
...
class OAIUpdatePrimaryRegionRequest : public OAIObject {
public:
    OAIUpdatePrimaryRegionRequest();
    OAIUpdatePrimaryRegionRequest(QString json);
    ~OAIUpdatePrimaryRegionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePrimaryRegionRequest)

#endif // OAIUpdatePrimaryRegionRequest_H
