...
#include "OAIDecryptRequest_Recipient.h"
...
namespace OpenAPI {
class OAIDecryptRequest_Recipient;
...
public:
    ...
    OAIDecryptRequest_Recipient getRecipient() const;
    void setRecipient(const OAIDecryptRequest_Recipient &recipient);
...
private:
    ...
    OAIDecryptRequest_Recipient m_recipient;
