...
/*
 * OAIGrantListEntry_Constraints.h
 *
 * 
 */

#ifndef OAIGrantListEntry_Constraints_H
#define OAIGrantListEntry_Constraints_H
...
class OAIGrantListEntry_Constraints : public OAIObject {
public:
    OAIGrantListEntry_Constraints();
    OAIGrantListEntry_Constraints(QString json);
    ~OAIGrantListEntry_Constraints() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGrantListEntry_Constraints)

#endif // OAIGrantListEntry_Constraints_H
