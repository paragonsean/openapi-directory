...
void OAIOriginType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("AWS_KMS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIOriginType::AWS_KMS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("EXTERNAL", Qt::CaseInsensitive) == 0) {
        m_value = eOAIOriginType::EXTERNAL;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("AWS_CLOUDHSM", Qt::CaseInsensitive) == 0) {
        m_value = eOAIOriginType::AWS_CLOUDHSM;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("EXTERNAL_KEY_STORE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIOriginType::EXTERNAL_KEY_STORE;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIOriginType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIOriginType::AWS_KMS:
            val = "AWS_KMS";
            break;
        case eOAIOriginType::EXTERNAL:
            val = "EXTERNAL";
            break;
        case eOAIOriginType::AWS_CLOUDHSM:
            val = "AWS_CLOUDHSM";
            break;
        case eOAIOriginType::EXTERNAL_KEY_STORE:
