...
OAIMultiRegionConfiguration_PrimaryKey::OAIMultiRegionConfiguration_PrimaryKey(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMultiRegionConfiguration_PrimaryKey::OAIMultiRegionConfiguration_PrimaryKey() {
    this->initializeModel();
}

OAIMultiRegionConfiguration_PrimaryKey::~OAIMultiRegionConfiguration_PrimaryKey() {}

void OAIMultiRegionConfiguration_PrimaryKey::initializeModel() {
...
void OAIMultiRegionConfiguration_PrimaryKey::fromJson(QString jsonString) {
...
void OAIMultiRegionConfiguration_PrimaryKey::fromJsonObject(QJsonObject json) {
...
QString OAIMultiRegionConfiguration_PrimaryKey::asJson() const {
...
QJsonObject OAIMultiRegionConfiguration_PrimaryKey::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIMultiRegionConfiguration_PrimaryKey::getArn() const {
    return m_arn;
}
void OAIMultiRegionConfiguration_PrimaryKey::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIMultiRegionConfiguration_PrimaryKey::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIMultiRegionConfiguration_PrimaryKey::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIMultiRegionConfiguration_PrimaryKey::getRegion() const {
    return m_region;
}
void OAIMultiRegionConfiguration_PrimaryKey::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIMultiRegionConfiguration_PrimaryKey::is_region_Set() const{
    return m_region_isSet;
}

bool OAIMultiRegionConfiguration_PrimaryKey::is_region_Valid() const{
    return m_region_isValid;
}

bool OAIMultiRegionConfiguration_PrimaryKey::isSet() const {
...
bool OAIMultiRegionConfiguration_PrimaryKey::isValid() const {
