...
/*
 * OAICreateAliasRequest.h
 *
 * 
 */

#ifndef OAICreateAliasRequest_H
#define OAICreateAliasRequest_H
...
class OAICreateAliasRequest : public OAIObject {
public:
    OAICreateAliasRequest();
    OAICreateAliasRequest(QString json);
    ~OAICreateAliasRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAliasRequest)

#endif // OAICreateAliasRequest_H
