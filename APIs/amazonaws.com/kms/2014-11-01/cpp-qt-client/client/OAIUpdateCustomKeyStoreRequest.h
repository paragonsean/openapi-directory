...
/*
 * OAIUpdateCustomKeyStoreRequest.h
 *
 * 
 */

#ifndef OAIUpdateCustomKeyStoreRequest_H
#define OAIUpdateCustomKeyStoreRequest_H

#include <QJsonObject>

#include "OAIUpdateCustomKeyStoreRequest_XksProxyAuthenticationCredential.h"
#include "OAIXksProxyConnectivityType.h"
#include <QString>
...
namespace OpenAPI {
class OAIUpdateCustomKeyStoreRequest_XksProxyAuthenticationCredential;

class OAIUpdateCustomKeyStoreRequest : public OAIObject {
public:
    OAIUpdateCustomKeyStoreRequest();
    OAIUpdateCustomKeyStoreRequest(QString json);
    ~OAIUpdateCustomKeyStoreRequest() override;
    ...
    QString getNewCustomKeyStoreName() const;
    void setNewCustomKeyStoreName(const QString &new_custom_key_store_name);
    bool is_new_custom_key_store_name_Set() const;
    bool is_new_custom_key_store_name_Valid() const;

    QString getKeyStorePassword() const;
    void setKeyStorePassword(const QString &key_store_password);
    ...
    QString getXksProxyUriEndpoint() const;
    void setXksProxyUriEndpoint(const QString &xks_proxy_uri_endpoint);
    bool is_xks_proxy_uri_endpoint_Set() const;
    bool is_xks_proxy_uri_endpoint_Valid() const;

    QString getXksProxyUriPath() const;
    void setXksProxyUriPath(const QString &xks_proxy_uri_path);
    bool is_xks_proxy_uri_path_Set() const;
    bool is_xks_proxy_uri_path_Valid() const;

    QString getXksProxyVpcEndpointServiceName() const;
    void setXksProxyVpcEndpointServiceName(const QString &xks_proxy_vpc_endpoint_service_name);
    bool is_xks_proxy_vpc_endpoint_service_name_Set() const;
    bool is_xks_proxy_vpc_endpoint_service_name_Valid() const;

    OAIUpdateCustomKeyStoreRequest_XksProxyAuthenticationCredential getXksProxyAuthenticationCredential() const;
    void setXksProxyAuthenticationCredential(const OAIUpdateCustomKeyStoreRequest_XksProxyAuthenticationCredential &xks_proxy_authentication_credential);
    bool is_xks_proxy_authentication_credential_Set() const;
    bool is_xks_proxy_authentication_credential_Valid() const;

    OAIXksProxyConnectivityType getXksProxyConnectivity() const;
    void setXksProxyConnectivity(const OAIXksProxyConnectivityType &xks_proxy_connectivity);
    bool is_xks_proxy_connectivity_Set() const;
    bool is_xks_proxy_connectivity_Valid() const;
...
private:
    ...
    QString m_new_custom_key_store_name;
    bool m_new_custom_key_store_name_isSet;
    bool m_new_custom_key_store_name_isValid;

    QString m_key_store_password;
    ...
    QString m_xks_proxy_uri_endpoint;
    bool m_xks_proxy_uri_endpoint_isSet;
    bool m_xks_proxy_uri_endpoint_isValid;

    QString m_xks_proxy_uri_path;
    bool m_xks_proxy_uri_path_isSet;
    bool m_xks_proxy_uri_path_isValid;

    QString m_xks_proxy_vpc_endpoint_service_name;
    bool m_xks_proxy_vpc_endpoint_service_name_isSet;
    bool m_xks_proxy_vpc_endpoint_service_name_isValid;

    OAIUpdateCustomKeyStoreRequest_XksProxyAuthenticationCredential m_xks_proxy_authentication_credential;
    bool m_xks_proxy_authentication_credential_isSet;
    bool m_xks_proxy_authentication_credential_isValid;

    OAIXksProxyConnectivityType m_xks_proxy_connectivity;
    bool m_xks_proxy_connectivity_isSet;
    bool m_xks_proxy_connectivity_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUpdateCustomKeyStoreRequest)

#endif // OAIUpdateCustomKeyStoreRequest_H
