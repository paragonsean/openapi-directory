...
#ifndef OAIKeyListEntry_H
#define OAIKeyListEntry_H
...
class OAIKeyListEntry : public OAIObject {
public:
    OAIKeyListEntry();
    OAIKeyListEntry(QString json);
    ~OAIKeyListEntry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKeyListEntry)

#endif // OAIKeyListEntry_H
