...
QString OAITagResourceRequest::getKeyId() const {
    return m_key_id;
}
void OAITagResourceRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAITagResourceRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAITagResourceRequest::is_key_id_Valid() const{
...
bool OAITagResourceRequest::isValid() const {
    ...
    return m_key_id_isValid && m_tags_isValid && true;
}
