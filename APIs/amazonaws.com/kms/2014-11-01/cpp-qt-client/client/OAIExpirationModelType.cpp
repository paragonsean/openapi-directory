...
OAIExpirationModelType::OAIExpirationModelType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExpirationModelType::OAIExpirationModelType() {
    this->initializeModel();
}

OAIExpirationModelType::~OAIExpirationModelType() {}

void OAIExpirationModelType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIExpirationModelType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIExpirationModelType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("KEY_MATERIAL_EXPIRES", Qt::CaseInsensitive) == 0) {
        m_value = eOAIExpirationModelType::EXPIRES;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("KEY_MATERIAL_DOES_NOT_EXPIRE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIExpirationModelType::DOES_NOT_EXPIRE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIExpirationModelType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIExpirationModelType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIExpirationModelType::EXPIRES:
            val = "KEY_MATERIAL_EXPIRES";
            break;
        case eOAIExpirationModelType::DOES_NOT_EXPIRE:
            val = "KEY_MATERIAL_DOES_NOT_EXPIRE";
            break;
        default:
            break;
    }
...
QJsonValue OAIExpirationModelType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIExpirationModelType::eOAIExpirationModelType OAIExpirationModelType::getValue() const {
    return m_value;
}

void OAIExpirationModelType::setValue(const OAIExpirationModelType::eOAIExpirationModelType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIExpirationModelType::isSet() const {
    
    return m_value_isSet;
}

bool OAIExpirationModelType::isValid() const {
