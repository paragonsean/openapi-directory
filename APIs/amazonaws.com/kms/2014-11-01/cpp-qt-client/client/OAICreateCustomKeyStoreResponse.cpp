...
OAICreateCustomKeyStoreResponse::OAICreateCustomKeyStoreResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateCustomKeyStoreResponse::OAICreateCustomKeyStoreResponse() {
    this->initializeModel();
}

OAICreateCustomKeyStoreResponse::~OAICreateCustomKeyStoreResponse() {}

void OAICreateCustomKeyStoreResponse::initializeModel() {

    m_custom_key_store_id_isSet = false;
    m_custom_key_store_id_isValid = false;
}

void OAICreateCustomKeyStoreResponse::fromJson(QString jsonString) {
...
void OAICreateCustomKeyStoreResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateCustomKeyStoreResponse::asJson() const {
...
QJsonObject OAICreateCustomKeyStoreResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateCustomKeyStoreResponse::getCustomKeyStoreId() const {
    return m_custom_key_store_id;
}
void OAICreateCustomKeyStoreResponse::setCustomKeyStoreId(const QString &custom_key_store_id) {
    m_custom_key_store_id = custom_key_store_id;
    m_custom_key_store_id_isSet = true;
}

bool OAICreateCustomKeyStoreResponse::is_custom_key_store_id_Set() const{
    return m_custom_key_store_id_isSet;
}

bool OAICreateCustomKeyStoreResponse::is_custom_key_store_id_Valid() const{
    return m_custom_key_store_id_isValid;
}

bool OAICreateCustomKeyStoreResponse::isSet() const {
...
bool OAICreateCustomKeyStoreResponse::isValid() const {
