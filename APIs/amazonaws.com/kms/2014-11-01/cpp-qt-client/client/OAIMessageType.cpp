...
void OAIMessageType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("RAW", Qt::CaseInsensitive) == 0) {
        m_value = eOAIMessageType::RAW;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DIGEST", Qt::CaseInsensitive) == 0) {
        m_value = eOAIMessageType::DIGEST;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIMessageType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIMessageType::RAW:
            val = "RAW";
            break;
        case eOAIMessageType::DIGEST:
            val = "DIGEST";
            break;
        default:
            break;
