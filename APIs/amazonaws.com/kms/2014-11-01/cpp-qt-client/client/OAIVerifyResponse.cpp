...
OAIVerifyResponse::OAIVerifyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVerifyResponse::OAIVerifyResponse() {
    this->initializeModel();
}

OAIVerifyResponse::~OAIVerifyResponse() {}

void OAIVerifyResponse::initializeModel() {
...
void OAIVerifyResponse::fromJson(QString jsonString) {
...
void OAIVerifyResponse::fromJsonObject(QJsonObject json) {
...
QString OAIVerifyResponse::asJson() const {
...
QJsonObject OAIVerifyResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAIVerifyResponse::getKeyId() const {
    return m_key_id;
}
void OAIVerifyResponse::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIVerifyResponse::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIVerifyResponse::is_key_id_Valid() const{
    return m_key_id_isValid;
}

bool OAIVerifyResponse::getSignatureValid() const {
    return m_signature_valid;
}
void OAIVerifyResponse::setSignatureValid(const bool &signature_valid) {
    m_signature_valid = signature_valid;
    m_signature_valid_isSet = true;
}

bool OAIVerifyResponse::is_signature_valid_Set() const{
    return m_signature_valid_isSet;
}

bool OAIVerifyResponse::is_signature_valid_Valid() const{
    return m_signature_valid_isValid;
}

OAISigningAlgorithmSpec OAIVerifyResponse::getSigningAlgorithm() const {
    return m_signing_algorithm;
}
void OAIVerifyResponse::setSigningAlgorithm(const OAISigningAlgorithmSpec &signing_algorithm) {
    m_signing_algorithm = signing_algorithm;
    m_signing_algorithm_isSet = true;
}

bool OAIVerifyResponse::is_signing_algorithm_Set() const{
    return m_signing_algorithm_isSet;
}

bool OAIVerifyResponse::is_signing_algorithm_Valid() const{
    return m_signing_algorithm_isValid;
}

bool OAIVerifyResponse::isSet() const {
...
bool OAIVerifyResponse::isValid() const {
