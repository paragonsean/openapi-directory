...
OAIConnectCustomKeyStoreRequest::OAIConnectCustomKeyStoreRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConnectCustomKeyStoreRequest::OAIConnectCustomKeyStoreRequest() {
    this->initializeModel();
}

OAIConnectCustomKeyStoreRequest::~OAIConnectCustomKeyStoreRequest() {}

void OAIConnectCustomKeyStoreRequest::initializeModel() {

    m_custom_key_store_id_isSet = false;
    m_custom_key_store_id_isValid = false;
}

void OAIConnectCustomKeyStoreRequest::fromJson(QString jsonString) {
...
void OAIConnectCustomKeyStoreRequest::fromJsonObject(QJsonObject json) {
...
QString OAIConnectCustomKeyStoreRequest::asJson() const {
...
QJsonObject OAIConnectCustomKeyStoreRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIConnectCustomKeyStoreRequest::getCustomKeyStoreId() const {
    return m_custom_key_store_id;
}
void OAIConnectCustomKeyStoreRequest::setCustomKeyStoreId(const QString &custom_key_store_id) {
    m_custom_key_store_id = custom_key_store_id;
    m_custom_key_store_id_isSet = true;
}

bool OAIConnectCustomKeyStoreRequest::is_custom_key_store_id_Set() const{
    return m_custom_key_store_id_isSet;
}

bool OAIConnectCustomKeyStoreRequest::is_custom_key_store_id_Valid() const{
    return m_custom_key_store_id_isValid;
}

bool OAIConnectCustomKeyStoreRequest::isSet() const {
...
bool OAIConnectCustomKeyStoreRequest::isValid() const {
