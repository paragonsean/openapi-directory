...
OAIKeyUsageType::OAIKeyUsageType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIKeyUsageType::OAIKeyUsageType() {
    this->initializeModel();
}

OAIKeyUsageType::~OAIKeyUsageType() {}

void OAIKeyUsageType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIKeyUsageType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIKeyUsageType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("SIGN_VERIFY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKeyUsageType::SIGN_VERIFY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ENCRYPT_DECRYPT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKeyUsageType::ENCRYPT_DECRYPT;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("GENERATE_VERIFY_MAC", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKeyUsageType::GENERATE_VERIFY_MAC;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIKeyUsageType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIKeyUsageType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIKeyUsageType::SIGN_VERIFY:
            val = "SIGN_VERIFY";
            break;
        case eOAIKeyUsageType::ENCRYPT_DECRYPT:
            val = "ENCRYPT_DECRYPT";
            break;
        case eOAIKeyUsageType::GENERATE_VERIFY_MAC:
            val = "GENERATE_VERIFY_MAC";
            break;
        default:
            break;
    }
...
QJsonValue OAIKeyUsageType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIKeyUsageType::eOAIKeyUsageType OAIKeyUsageType::getValue() const {
    return m_value;
}

void OAIKeyUsageType::setValue(const OAIKeyUsageType::eOAIKeyUsageType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIKeyUsageType::isSet() const {
    
    return m_value_isSet;
}

bool OAIKeyUsageType::isValid() const {
