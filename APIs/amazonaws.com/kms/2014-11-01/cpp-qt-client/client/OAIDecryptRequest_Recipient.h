...
/*
 * OAIDecryptRequest_Recipient.h
 *
 * 
 */

#ifndef OAIDecryptRequest_Recipient_H
#define OAIDecryptRequest_Recipient_H
...
class OAIDecryptRequest_Recipient : public OAIObject {
public:
    OAIDecryptRequest_Recipient();
    OAIDecryptRequest_Recipient(QString json);
    ~OAIDecryptRequest_Recipient() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDecryptRequest_Recipient)

#endif // OAIDecryptRequest_Recipient_H
