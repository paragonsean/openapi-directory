...
OAIListGrantsRequest::OAIListGrantsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListGrantsRequest::OAIListGrantsRequest() {
    this->initializeModel();
}

OAIListGrantsRequest::~OAIListGrantsRequest() {}

void OAIListGrantsRequest::initializeModel() {
...
void OAIListGrantsRequest::fromJson(QString jsonString) {
...
void OAIListGrantsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListGrantsRequest::asJson() const {
...
QJsonObject OAIListGrantsRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_limit_isSet) {
...
qint32 OAIListGrantsRequest::getLimit() const {
    return m_limit;
}
void OAIListGrantsRequest::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIListGrantsRequest::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIListGrantsRequest::is_limit_Valid() const{
    return m_limit_isValid;
}

QString OAIListGrantsRequest::getMarker() const {
    return m_marker;
}
void OAIListGrantsRequest::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIListGrantsRequest::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIListGrantsRequest::is_marker_Valid() const{
    return m_marker_isValid;
}

QString OAIListGrantsRequest::getKeyId() const {
    return m_key_id;
}
void OAIListGrantsRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIListGrantsRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIListGrantsRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

QString OAIListGrantsRequest::getGrantId() const {
    return m_grant_id;
}
void OAIListGrantsRequest::setGrantId(const QString &grant_id) {
    m_grant_id = grant_id;
    m_grant_id_isSet = true;
}

bool OAIListGrantsRequest::is_grant_id_Set() const{
    return m_grant_id_isSet;
}

bool OAIListGrantsRequest::is_grant_id_Valid() const{
    return m_grant_id_isValid;
}

QString OAIListGrantsRequest::getGranteePrincipal() const {
    return m_grantee_principal;
}
void OAIListGrantsRequest::setGranteePrincipal(const QString &grantee_principal) {
    m_grantee_principal = grantee_principal;
    m_grantee_principal_isSet = true;
}

bool OAIListGrantsRequest::is_grantee_principal_Set() const{
    return m_grantee_principal_isSet;
}

bool OAIListGrantsRequest::is_grantee_principal_Valid() const{
    return m_grantee_principal_isValid;
}

bool OAIListGrantsRequest::isSet() const {
...
bool OAIListGrantsRequest::isValid() const {
