...
/*
 * OAIDisableKeyRequest.h
 *
 * 
 */

#ifndef OAIDisableKeyRequest_H
#define OAIDisableKeyRequest_H
...
class OAIDisableKeyRequest : public OAIObject {
public:
    OAIDisableKeyRequest();
    OAIDisableKeyRequest(QString json);
    ~OAIDisableKeyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisableKeyRequest)

#endif // OAIDisableKeyRequest_H
