...
OAIGetKeyRotationStatusResponse::OAIGetKeyRotationStatusResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetKeyRotationStatusResponse::OAIGetKeyRotationStatusResponse() {
    this->initializeModel();
}

OAIGetKeyRotationStatusResponse::~OAIGetKeyRotationStatusResponse() {}

void OAIGetKeyRotationStatusResponse::initializeModel() {

    m_key_rotation_enabled_isSet = false;
    m_key_rotation_enabled_isValid = false;
}

void OAIGetKeyRotationStatusResponse::fromJson(QString jsonString) {
...
void OAIGetKeyRotationStatusResponse::fromJsonObject(QJsonObject json) {

    m_key_rotation_enabled_isValid = ::OpenAPI::fromJsonValue(m_key_rotation_enabled, json[QString("KeyRotationEnabled")]);
    m_key_rotation_enabled_isSet = !json[QString("KeyRotationEnabled")].isNull() && m_key_rotation_enabled_isValid;
}

QString OAIGetKeyRotationStatusResponse::asJson() const {
...
QJsonObject OAIGetKeyRotationStatusResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_key_rotation_enabled_isSet) {
        obj.insert(QString("KeyRotationEnabled"), ::OpenAPI::toJsonValue(m_key_rotation_enabled));
    }
    return obj;
}

bool OAIGetKeyRotationStatusResponse::getKeyRotationEnabled() const {
    return m_key_rotation_enabled;
}
void OAIGetKeyRotationStatusResponse::setKeyRotationEnabled(const bool &key_rotation_enabled) {
    m_key_rotation_enabled = key_rotation_enabled;
    m_key_rotation_enabled_isSet = true;
}

bool OAIGetKeyRotationStatusResponse::is_key_rotation_enabled_Set() const{
    return m_key_rotation_enabled_isSet;
}

bool OAIGetKeyRotationStatusResponse::is_key_rotation_enabled_Valid() const{
    return m_key_rotation_enabled_isValid;
}

bool OAIGetKeyRotationStatusResponse::isSet() const {
...
bool OAIGetKeyRotationStatusResponse::isValid() const {
