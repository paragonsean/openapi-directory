...
#ifndef OAIMultiRegionConfiguration_H
#define OAIMultiRegionConfiguration_H

#include <QJsonObject>

#include "OAIMultiRegionConfiguration_PrimaryKey.h"
#include "OAIMultiRegionKeyType.h"
#include <QList>
...
namespace OpenAPI {
class OAIMultiRegionConfiguration_PrimaryKey;

class OAIMultiRegionConfiguration : public OAIObject {
public:
    OAIMultiRegionConfiguration();
    OAIMultiRegionConfiguration(QString json);
    ~OAIMultiRegionConfiguration() override;
    ...
    OAIMultiRegionKeyType getMultiRegionKeyType() const;
    void setMultiRegionKeyType(const OAIMultiRegionKeyType &multi_region_key_type);
    bool is_multi_region_key_type_Set() const;
    bool is_multi_region_key_type_Valid() const;

    OAIMultiRegionConfiguration_PrimaryKey getPrimaryKey() const;
    void setPrimaryKey(const OAIMultiRegionConfiguration_PrimaryKey &primary_key);
    bool is_primary_key_Set() const;
    bool is_primary_key_Valid() const;

    QList getReplicaKeys() const;
    void setReplicaKeys(const QList &replica_keys);
    bool is_replica_keys_Set() const;
    bool is_replica_keys_Valid() const;
...
private:
    ...
    OAIMultiRegionKeyType m_multi_region_key_type;
    bool m_multi_region_key_type_isSet;
    bool m_multi_region_key_type_isValid;

    OAIMultiRegionConfiguration_PrimaryKey m_primary_key;
    bool m_primary_key_isSet;
    bool m_primary_key_isValid;

    QList m_replica_keys;
    bool m_replica_keys_isSet;
    bool m_replica_keys_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIMultiRegionConfiguration)

#endif // OAIMultiRegionConfiguration_H
