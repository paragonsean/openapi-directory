...
/*
 * OAIGenerateRandomResponse.h
 *
 * 
 */

#ifndef OAIGenerateRandomResponse_H
#define OAIGenerateRandomResponse_H
...
class OAIGenerateRandomResponse : public OAIObject {
public:
    OAIGenerateRandomResponse();
    OAIGenerateRandomResponse(QString json);
    ~OAIGenerateRandomResponse() override;
    ...
    QString getCiphertextForRecipient() const;
    void setCiphertextForRecipient(const QString &ciphertext_for_recipient);
    bool is_ciphertext_for_recipient_Set() const;
    bool is_ciphertext_for_recipient_Valid() const;
...
private:
    ...
    QString m_ciphertext_for_recipient;
    bool m_ciphertext_for_recipient_isSet;
    bool m_ciphertext_for_recipient_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGenerateRandomResponse)

#endif // OAIGenerateRandomResponse_H
