...
#ifndef OAIAlgorithmSpec_H
#define OAIAlgorithmSpec_H
...
class OAIAlgorithmSpec : public OAIEnum {
public:
    OAIAlgorithmSpec();
    OAIAlgorithmSpec(QString json);
    ~OAIAlgorithmSpec() override;
    ...
    OAIAlgorithmSpec::eOAIAlgorithmSpec getValue() const;
    void setValue(const OAIAlgorithmSpec::eOAIAlgorithmSpec& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAlgorithmSpec)

#endif // OAIAlgorithmSpec_H
