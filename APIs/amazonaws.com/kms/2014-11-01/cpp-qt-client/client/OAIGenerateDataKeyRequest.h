...
/*
 * OAIGenerateDataKeyRequest.h
 *
 * 
 */

#ifndef OAIGenerateDataKeyRequest_H
#define OAIGenerateDataKeyRequest_H
...
namespace OpenAPI {
class OAIGenerateDataKeyRequest_Recipient;

class OAIGenerateDataKeyRequest : public OAIObject {
public:
    OAIGenerateDataKeyRequest();
    OAIGenerateDataKeyRequest(QString json);
    ~OAIGenerateDataKeyRequest() override;
    ...
    OAIGenerateDataKeyRequest_Recipient getRecipient() const;
    void setRecipient(const OAIGenerateDataKeyRequest_Recipient &recipient);
...
private:
    ...
    OAIGenerateDataKeyRequest_Recipient m_recipient;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGenerateDataKeyRequest)

#endif // OAIGenerateDataKeyRequest_H
