...
/*
 * OAIGenerateDataKeyPairRequest_Recipient.h
 *
 * 
 */

#ifndef OAIGenerateDataKeyPairRequest_Recipient_H
#define OAIGenerateDataKeyPairRequest_Recipient_H
...
class OAIGenerateDataKeyPairRequest_Recipient : public OAIObject {
public:
    OAIGenerateDataKeyPairRequest_Recipient();
    OAIGenerateDataKeyPairRequest_Recipient(QString json);
    ~OAIGenerateDataKeyPairRequest_Recipient() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGenerateDataKeyPairRequest_Recipient)

#endif // OAIGenerateDataKeyPairRequest_Recipient_H
