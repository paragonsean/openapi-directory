...
/*
 * OAIGetKeyPolicyResponse.h
 *
 * 
 */

#ifndef OAIGetKeyPolicyResponse_H
#define OAIGetKeyPolicyResponse_H
...
class OAIGetKeyPolicyResponse : public OAIObject {
public:
    OAIGetKeyPolicyResponse();
    OAIGetKeyPolicyResponse(QString json);
    ~OAIGetKeyPolicyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetKeyPolicyResponse)

#endif // OAIGetKeyPolicyResponse_H
