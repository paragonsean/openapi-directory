...
/*
 * OAIPutKeyPolicyRequest.h
 *
 * 
 */

#ifndef OAIPutKeyPolicyRequest_H
#define OAIPutKeyPolicyRequest_H
...
class OAIPutKeyPolicyRequest : public OAIObject {
public:
    OAIPutKeyPolicyRequest();
    OAIPutKeyPolicyRequest(QString json);
    ~OAIPutKeyPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutKeyPolicyRequest)

#endif // OAIPutKeyPolicyRequest_H
