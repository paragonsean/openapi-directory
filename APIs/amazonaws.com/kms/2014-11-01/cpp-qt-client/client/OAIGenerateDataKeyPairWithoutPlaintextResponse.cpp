...
OAIGenerateDataKeyPairWithoutPlaintextResponse::OAIGenerateDataKeyPairWithoutPlaintextResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGenerateDataKeyPairWithoutPlaintextResponse::OAIGenerateDataKeyPairWithoutPlaintextResponse() {
    this->initializeModel();
}

OAIGenerateDataKeyPairWithoutPlaintextResponse::~OAIGenerateDataKeyPairWithoutPlaintextResponse() {}

void OAIGenerateDataKeyPairWithoutPlaintextResponse::initializeModel() {
...
void OAIGenerateDataKeyPairWithoutPlaintextResponse::fromJson(QString jsonString) {
...
void OAIGenerateDataKeyPairWithoutPlaintextResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGenerateDataKeyPairWithoutPlaintextResponse::asJson() const {
...
QJsonObject OAIGenerateDataKeyPairWithoutPlaintextResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGenerateDataKeyPairWithoutPlaintextResponse::getPrivateKeyCiphertextBlob() const {
    return m_private_key_ciphertext_blob;
}
void OAIGenerateDataKeyPairWithoutPlaintextResponse::setPrivateKeyCiphertextBlob(const QString &private_key_ciphertext_blob) {
    m_private_key_ciphertext_blob = private_key_ciphertext_blob;
    m_private_key_ciphertext_blob_isSet = true;
}

bool OAIGenerateDataKeyPairWithoutPlaintextResponse::is_private_key_ciphertext_blob_Set() const{
    return m_private_key_ciphertext_blob_isSet;
}

bool OAIGenerateDataKeyPairWithoutPlaintextResponse::is_private_key_ciphertext_blob_Valid() const{
    return m_private_key_ciphertext_blob_isValid;
}

QString OAIGenerateDataKeyPairWithoutPlaintextResponse::getPublicKey() const {
    return m_public_key;
}
void OAIGenerateDataKeyPairWithoutPlaintextResponse::setPublicKey(const QString &public_key) {
    m_public_key = public_key;
    m_public_key_isSet = true;
}

bool OAIGenerateDataKeyPairWithoutPlaintextResponse::is_public_key_Set() const{
    return m_public_key_isSet;
}

bool OAIGenerateDataKeyPairWithoutPlaintextResponse::is_public_key_Valid() const{
    return m_public_key_isValid;
}

QString OAIGenerateDataKeyPairWithoutPlaintextResponse::getKeyId() const {
    return m_key_id;
}
void OAIGenerateDataKeyPairWithoutPlaintextResponse::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIGenerateDataKeyPairWithoutPlaintextResponse::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIGenerateDataKeyPairWithoutPlaintextResponse::is_key_id_Valid() const{
    return m_key_id_isValid;
}

OAIDataKeyPairSpec OAIGenerateDataKeyPairWithoutPlaintextResponse::getKeyPairSpec() const {
    return m_key_pair_spec;
}
void OAIGenerateDataKeyPairWithoutPlaintextResponse::setKeyPairSpec(const OAIDataKeyPairSpec &key_pair_spec) {
    m_key_pair_spec = key_pair_spec;
    m_key_pair_spec_isSet = true;
}

bool OAIGenerateDataKeyPairWithoutPlaintextResponse::is_key_pair_spec_Set() const{
    return m_key_pair_spec_isSet;
}

bool OAIGenerateDataKeyPairWithoutPlaintextResponse::is_key_pair_spec_Valid() const{
    return m_key_pair_spec_isValid;
}

bool OAIGenerateDataKeyPairWithoutPlaintextResponse::isSet() const {
...
bool OAIGenerateDataKeyPairWithoutPlaintextResponse::isValid() const {
