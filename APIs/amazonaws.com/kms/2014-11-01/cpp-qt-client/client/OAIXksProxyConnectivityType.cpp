...
OAIXksProxyConnectivityType::OAIXksProxyConnectivityType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIXksProxyConnectivityType::OAIXksProxyConnectivityType() {
    this->initializeModel();
}

OAIXksProxyConnectivityType::~OAIXksProxyConnectivityType() {}

void OAIXksProxyConnectivityType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIXksProxyConnectivityType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIXksProxyConnectivityType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("PUBLIC_ENDPOINT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIXksProxyConnectivityType::PUBLIC_ENDPOINT;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("VPC_ENDPOINT_SERVICE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIXksProxyConnectivityType::VPC_ENDPOINT_SERVICE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIXksProxyConnectivityType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIXksProxyConnectivityType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIXksProxyConnectivityType::PUBLIC_ENDPOINT:
            val = "PUBLIC_ENDPOINT";
            break;
        case eOAIXksProxyConnectivityType::VPC_ENDPOINT_SERVICE:
            val = "VPC_ENDPOINT_SERVICE";
            break;
        default:
            break;
    }
...
QJsonValue OAIXksProxyConnectivityType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIXksProxyConnectivityType::eOAIXksProxyConnectivityType OAIXksProxyConnectivityType::getValue() const {
    return m_value;
}

void OAIXksProxyConnectivityType::setValue(const OAIXksProxyConnectivityType::eOAIXksProxyConnectivityType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIXksProxyConnectivityType::isSet() const {
    
    return m_value_isSet;
}

bool OAIXksProxyConnectivityType::isValid() const {
