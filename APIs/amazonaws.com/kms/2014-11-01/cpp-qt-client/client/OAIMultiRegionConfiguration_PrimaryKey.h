...
/*
 * OAIMultiRegionConfiguration_PrimaryKey.h
 *
 * 
 */

#ifndef OAIMultiRegionConfiguration_PrimaryKey_H
#define OAIMultiRegionConfiguration_PrimaryKey_H
...
class OAIMultiRegionConfiguration_PrimaryKey : public OAIObject {
public:
    OAIMultiRegionConfiguration_PrimaryKey();
    OAIMultiRegionConfiguration_PrimaryKey(QString json);
    ~OAIMultiRegionConfiguration_PrimaryKey() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMultiRegionConfiguration_PrimaryKey)

#endif // OAIMultiRegionConfiguration_PrimaryKey_H
