...
/*
 * OAIDescribeKeyResponse_KeyMetadata.h
 *
 * 
 */

#ifndef OAIDescribeKeyResponse_KeyMetadata_H
#define OAIDescribeKeyResponse_KeyMetadata_H
...
class OAIDescribeKeyResponse_KeyMetadata : public OAIObject {
public:
    OAIDescribeKeyResponse_KeyMetadata();
    OAIDescribeKeyResponse_KeyMetadata(QString json);
    ~OAIDescribeKeyResponse_KeyMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeKeyResponse_KeyMetadata)

#endif // OAIDescribeKeyResponse_KeyMetadata_H
