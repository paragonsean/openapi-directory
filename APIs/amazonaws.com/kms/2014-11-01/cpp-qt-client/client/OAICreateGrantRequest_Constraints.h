...
/*
 * OAICreateGrantRequest_Constraints.h
 *
 * 
 */

#ifndef OAICreateGrantRequest_Constraints_H
#define OAICreateGrantRequest_Constraints_H
...
class OAICreateGrantRequest_Constraints : public OAIObject {
public:
    OAICreateGrantRequest_Constraints();
    OAICreateGrantRequest_Constraints(QString json);
    ~OAICreateGrantRequest_Constraints() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateGrantRequest_Constraints)

#endif // OAICreateGrantRequest_Constraints_H
