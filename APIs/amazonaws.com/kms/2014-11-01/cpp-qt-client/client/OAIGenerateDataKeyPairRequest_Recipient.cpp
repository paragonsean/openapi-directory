...
OAIGenerateDataKeyPairRequest_Recipient::OAIGenerateDataKeyPairRequest_Recipient(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGenerateDataKeyPairRequest_Recipient::OAIGenerateDataKeyPairRequest_Recipient() {
    this->initializeModel();
}

OAIGenerateDataKeyPairRequest_Recipient::~OAIGenerateDataKeyPairRequest_Recipient() {}

void OAIGenerateDataKeyPairRequest_Recipient::initializeModel() {
...
void OAIGenerateDataKeyPairRequest_Recipient::fromJson(QString jsonString) {
...
void OAIGenerateDataKeyPairRequest_Recipient::fromJsonObject(QJsonObject json) {
...
QString OAIGenerateDataKeyPairRequest_Recipient::asJson() const {
...
QJsonObject OAIGenerateDataKeyPairRequest_Recipient::asJsonObject() const {
    QJsonObject obj;
...
OAIKeyEncryptionMechanism OAIGenerateDataKeyPairRequest_Recipient::getKeyEncryptionAlgorithm() const {
    return m_key_encryption_algorithm;
}
void OAIGenerateDataKeyPairRequest_Recipient::setKeyEncryptionAlgorithm(const OAIKeyEncryptionMechanism &key_encryption_algorithm) {
    m_key_encryption_algorithm = key_encryption_algorithm;
    m_key_encryption_algorithm_isSet = true;
}

bool OAIGenerateDataKeyPairRequest_Recipient::is_key_encryption_algorithm_Set() const{
    return m_key_encryption_algorithm_isSet;
}

bool OAIGenerateDataKeyPairRequest_Recipient::is_key_encryption_algorithm_Valid() const{
    return m_key_encryption_algorithm_isValid;
}

QString OAIGenerateDataKeyPairRequest_Recipient::getAttestationDocument() const {
    return m_attestation_document;
}
void OAIGenerateDataKeyPairRequest_Recipient::setAttestationDocument(const QString &attestation_document) {
    m_attestation_document = attestation_document;
    m_attestation_document_isSet = true;
}

bool OAIGenerateDataKeyPairRequest_Recipient::is_attestation_document_Set() const{
    return m_attestation_document_isSet;
}

bool OAIGenerateDataKeyPairRequest_Recipient::is_attestation_document_Valid() const{
    return m_attestation_document_isValid;
}

bool OAIGenerateDataKeyPairRequest_Recipient::isSet() const {
...
bool OAIGenerateDataKeyPairRequest_Recipient::isValid() const {
