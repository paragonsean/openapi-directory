...
#ifndef OAIXksKeyConfigurationType_H
#define OAIXksKeyConfigurationType_H
...
class OAIXksKeyConfigurationType : public OAIObject {
public:
    OAIXksKeyConfigurationType();
    OAIXksKeyConfigurationType(QString json);
    ~OAIXksKeyConfigurationType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIXksKeyConfigurationType)

#endif // OAIXksKeyConfigurationType_H
