...
OAIRevokeGrantRequest::OAIRevokeGrantRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRevokeGrantRequest::OAIRevokeGrantRequest() {
    this->initializeModel();
}

OAIRevokeGrantRequest::~OAIRevokeGrantRequest() {}

void OAIRevokeGrantRequest::initializeModel() {
...
void OAIRevokeGrantRequest::fromJson(QString jsonString) {
...
void OAIRevokeGrantRequest::fromJsonObject(QJsonObject json) {
...
QString OAIRevokeGrantRequest::asJson() const {
...
QJsonObject OAIRevokeGrantRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAIRevokeGrantRequest::getKeyId() const {
    return m_key_id;
}
void OAIRevokeGrantRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIRevokeGrantRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIRevokeGrantRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

QString OAIRevokeGrantRequest::getGrantId() const {
    return m_grant_id;
}
void OAIRevokeGrantRequest::setGrantId(const QString &grant_id) {
    m_grant_id = grant_id;
    m_grant_id_isSet = true;
}

bool OAIRevokeGrantRequest::is_grant_id_Set() const{
    return m_grant_id_isSet;
}

bool OAIRevokeGrantRequest::is_grant_id_Valid() const{
    return m_grant_id_isValid;
}

bool OAIRevokeGrantRequest::getDryRun() const {
    return m_dry_run;
}
void OAIRevokeGrantRequest::setDryRun(const bool &dry_run) {
    m_dry_run = dry_run;
    m_dry_run_isSet = true;
}

bool OAIRevokeGrantRequest::is_dry_run_Set() const{
    return m_dry_run_isSet;
}

bool OAIRevokeGrantRequest::is_dry_run_Valid() const{
    return m_dry_run_isValid;
}

bool OAIRevokeGrantRequest::isSet() const {
...
bool OAIRevokeGrantRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_key_id_isValid && m_grant_id_isValid && true;
}
