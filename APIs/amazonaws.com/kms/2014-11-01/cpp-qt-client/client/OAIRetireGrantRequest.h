...
/*
 * OAIRetireGrantRequest.h
 *
 * 
 */

#ifndef OAIRetireGrantRequest_H
#define OAIRetireGrantRequest_H
...
class OAIRetireGrantRequest : public OAIObject {
public:
    OAIRetireGrantRequest();
    OAIRetireGrantRequest(QString json);
    ~OAIRetireGrantRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRetireGrantRequest)

#endif // OAIRetireGrantRequest_H
