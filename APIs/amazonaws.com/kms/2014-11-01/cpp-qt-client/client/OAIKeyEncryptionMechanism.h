...
/*
 * OAIKeyEncryptionMechanism.h
 *
 * 
 */

#ifndef OAIKeyEncryptionMechanism_H
#define OAIKeyEncryptionMechanism_H
...
class OAIKeyEncryptionMechanism : public OAIEnum {
public:
    OAIKeyEncryptionMechanism();
    OAIKeyEncryptionMechanism(QString json);
    ~OAIKeyEncryptionMechanism() override;
    ...
    enum class eOAIKeyEncryptionMechanism {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        RSAES_OAEP_SHA_256
    };
    OAIKeyEncryptionMechanism::eOAIKeyEncryptionMechanism getValue() const;
    void setValue(const OAIKeyEncryptionMechanism::eOAIKeyEncryptionMechanism& value);
...
private:
    ...
    eOAIKeyEncryptionMechanism m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKeyEncryptionMechanism)

#endif // OAIKeyEncryptionMechanism_H
