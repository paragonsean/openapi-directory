...
/*
 * OAIGenerateDataKeyPairRequest.h
 *
 * 
 */

#ifndef OAIGenerateDataKeyPairRequest_H
#define OAIGenerateDataKeyPairRequest_H

#include <QJsonObject>

#include "OAIDataKeyPairSpec.h"
#include "OAIGenerateDataKeyPairRequest_Recipient.h"
#include <QList>
#include <QMap>
#include <QString>
...
namespace OpenAPI {
class OAIGenerateDataKeyPairRequest_Recipient;

class OAIGenerateDataKeyPairRequest : public OAIObject {
public:
    OAIGenerateDataKeyPairRequest();
    OAIGenerateDataKeyPairRequest(QString json);
    ~OAIGenerateDataKeyPairRequest() override;
    ...
    QMap getEncryptionContext() const;
    void setEncryptionContext(const QMap &encryption_context);
    bool is_encryption_context_Set() const;
    bool is_encryption_context_Valid() const;
    ...
    OAIDataKeyPairSpec getKeyPairSpec() const;
    void setKeyPairSpec(const OAIDataKeyPairSpec &key_pair_spec);
    bool is_key_pair_spec_Set() const;
    bool is_key_pair_spec_Valid() const;
    ...
    OAIGenerateDataKeyPairRequest_Recipient getRecipient() const;
    void setRecipient(const OAIGenerateDataKeyPairRequest_Recipient &recipient);
...
private:
    ...
    QMap m_encryption_context;
    bool m_encryption_context_isSet;
    bool m_encryption_context_isValid;

    QString m_key_id;
    bool m_key_id_isSet;
    bool m_key_id_isValid;

    OAIDataKeyPairSpec m_key_pair_spec;
    bool m_key_pair_spec_isSet;
    bool m_key_pair_spec_isValid;

    QList m_grant_tokens;
    bool m_grant_tokens_isSet;
    bool m_grant_tokens_isValid;

    OAIGenerateDataKeyPairRequest_Recipient m_recipient;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGenerateDataKeyPairRequest)

#endif // OAIGenerateDataKeyPairRequest_H
