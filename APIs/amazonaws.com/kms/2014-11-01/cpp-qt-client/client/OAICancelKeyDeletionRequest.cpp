...
OAICancelKeyDeletionRequest::OAICancelKeyDeletionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICancelKeyDeletionRequest::OAICancelKeyDeletionRequest() {
    this->initializeModel();
}

OAICancelKeyDeletionRequest::~OAICancelKeyDeletionRequest() {}

void OAICancelKeyDeletionRequest::initializeModel() {

    m_key_id_isSet = false;
    m_key_id_isValid = false;
}

void OAICancelKeyDeletionRequest::fromJson(QString jsonString) {
...
void OAICancelKeyDeletionRequest::fromJsonObject(QJsonObject json) {
...
QString OAICancelKeyDeletionRequest::asJson() const {
...
QJsonObject OAICancelKeyDeletionRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAICancelKeyDeletionRequest::getKeyId() const {
    return m_key_id;
}
void OAICancelKeyDeletionRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAICancelKeyDeletionRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAICancelKeyDeletionRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

bool OAICancelKeyDeletionRequest::isSet() const {
...
bool OAICancelKeyDeletionRequest::isValid() const {
