...
OAIVerifyMacResponse::OAIVerifyMacResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVerifyMacResponse::OAIVerifyMacResponse() {
    this->initializeModel();
}

OAIVerifyMacResponse::~OAIVerifyMacResponse() {}

void OAIVerifyMacResponse::initializeModel() {

    m_key_id_isSet = false;
    m_key_id_isValid = false;

    m_mac_valid_isSet = false;
    m_mac_valid_isValid = false;

    m_mac_algorithm_isSet = false;
    m_mac_algorithm_isValid = false;
}

void OAIVerifyMacResponse::fromJson(QString jsonString) {
...
void OAIVerifyMacResponse::fromJsonObject(QJsonObject json) {
    ...
    m_mac_valid_isValid = ::OpenAPI::fromJsonValue(m_mac_valid, json[QString("MacValid")]);
    m_mac_valid_isSet = !json[QString("MacValid")].isNull() && m_mac_valid_isValid;
...
QString OAIVerifyMacResponse::asJson() const {
...
QJsonObject OAIVerifyMacResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
        obj.insert(QString("KeyId"), ::OpenAPI::toJsonValue(m_key_id));
    }
    if (m_mac_valid_isSet) {
        obj.insert(QString("MacValid"), ::OpenAPI::toJsonValue(m_mac_valid));
    }
...
QString OAIVerifyMacResponse::getKeyId() const {
    return m_key_id;
}
void OAIVerifyMacResponse::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIVerifyMacResponse::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIVerifyMacResponse::is_key_id_Valid() const{
    return m_key_id_isValid;
}

bool OAIVerifyMacResponse::getMacValid() const {
    return m_mac_valid;
}
void OAIVerifyMacResponse::setMacValid(const bool &mac_valid) {
    m_mac_valid = mac_valid;
    m_mac_valid_isSet = true;
}

bool OAIVerifyMacResponse::is_mac_valid_Set() const{
    return m_mac_valid_isSet;
}

bool OAIVerifyMacResponse::is_mac_valid_Valid() const{
    return m_mac_valid_isValid;
}

OAIMacAlgorithmSpec OAIVerifyMacResponse::getMacAlgorithm() const {
    return m_mac_algorithm;
}
void OAIVerifyMacResponse::setMacAlgorithm(const OAIMacAlgorithmSpec &mac_algorithm) {
    m_mac_algorithm = mac_algorithm;
    m_mac_algorithm_isSet = true;
}

bool OAIVerifyMacResponse::is_mac_algorithm_Set() const{
    return m_mac_algorithm_isSet;
}

bool OAIVerifyMacResponse::is_mac_algorithm_Valid() const{
    return m_mac_algorithm_isValid;
}

bool OAIVerifyMacResponse::isSet() const {
...
bool OAIVerifyMacResponse::isValid() const {
