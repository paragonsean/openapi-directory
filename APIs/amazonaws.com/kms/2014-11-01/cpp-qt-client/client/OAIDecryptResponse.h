...
public:
    ...
    OAIEncryptionAlgorithmSpec getEncryptionAlgorithm() const;
    void setEncryptionAlgorithm(const OAIEncryptionAlgorithmSpec &encryption_algorithm);
...
private:
    ...
    OAIEncryptionAlgorithmSpec m_encryption_algorithm;
