...
OAISignResponse::OAISignResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISignResponse::OAISignResponse() {
    this->initializeModel();
}

OAISignResponse::~OAISignResponse() {}

void OAISignResponse::initializeModel() {
...
void OAISignResponse::fromJson(QString jsonString) {
...
void OAISignResponse::fromJsonObject(QJsonObject json) {
...
QString OAISignResponse::asJson() const {
...
QJsonObject OAISignResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAISignResponse::getKeyId() const {
    return m_key_id;
}
void OAISignResponse::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAISignResponse::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAISignResponse::is_key_id_Valid() const{
    return m_key_id_isValid;
}

QString OAISignResponse::getSignature() const {
    return m_signature;
}
void OAISignResponse::setSignature(const QString &signature) {
    m_signature = signature;
    m_signature_isSet = true;
}

bool OAISignResponse::is_signature_Set() const{
    return m_signature_isSet;
}

bool OAISignResponse::is_signature_Valid() const{
    return m_signature_isValid;
}

OAISigningAlgorithmSpec OAISignResponse::getSigningAlgorithm() const {
    return m_signing_algorithm;
}
void OAISignResponse::setSigningAlgorithm(const OAISigningAlgorithmSpec &signing_algorithm) {
    m_signing_algorithm = signing_algorithm;
    m_signing_algorithm_isSet = true;
}

bool OAISignResponse::is_signing_algorithm_Set() const{
    return m_signing_algorithm_isSet;
}

bool OAISignResponse::is_signing_algorithm_Valid() const{
    return m_signing_algorithm_isValid;
}

bool OAISignResponse::isSet() const {
...
bool OAISignResponse::isValid() const {
