...
/*
 * OAIGenerateMacRequest.h
 *
 * 
 */

#ifndef OAIGenerateMacRequest_H
#define OAIGenerateMacRequest_H
...
class OAIGenerateMacRequest : public OAIObject {
public:
    OAIGenerateMacRequest();
    OAIGenerateMacRequest(QString json);
    ~OAIGenerateMacRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGenerateMacRequest)

#endif // OAIGenerateMacRequest_H
