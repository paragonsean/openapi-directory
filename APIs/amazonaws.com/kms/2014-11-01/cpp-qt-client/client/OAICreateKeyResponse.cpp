...
OAICreateKeyResponse_KeyMetadata OAICreateKeyResponse::getKeyMetadata() const {
    return m_key_metadata;
}
void OAICreateKeyResponse::setKeyMetadata(const OAICreateKeyResponse_KeyMetadata &key_metadata) {
    m_key_metadata = key_metadata;
    m_key_metadata_isSet = true;
}

bool OAICreateKeyResponse::is_key_metadata_Set() const{
    return m_key_metadata_isSet;
}

bool OAICreateKeyResponse::is_key_metadata_Valid() const{
