...
OAIDeleteCustomKeyStoreRequest::OAIDeleteCustomKeyStoreRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteCustomKeyStoreRequest::OAIDeleteCustomKeyStoreRequest() {
    this->initializeModel();
}

OAIDeleteCustomKeyStoreRequest::~OAIDeleteCustomKeyStoreRequest() {}

void OAIDeleteCustomKeyStoreRequest::initializeModel() {

    m_custom_key_store_id_isSet = false;
    m_custom_key_store_id_isValid = false;
}

void OAIDeleteCustomKeyStoreRequest::fromJson(QString jsonString) {
...
void OAIDeleteCustomKeyStoreRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteCustomKeyStoreRequest::asJson() const {
...
QJsonObject OAIDeleteCustomKeyStoreRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteCustomKeyStoreRequest::getCustomKeyStoreId() const {
    return m_custom_key_store_id;
}
void OAIDeleteCustomKeyStoreRequest::setCustomKeyStoreId(const QString &custom_key_store_id) {
    m_custom_key_store_id = custom_key_store_id;
    m_custom_key_store_id_isSet = true;
}

bool OAIDeleteCustomKeyStoreRequest::is_custom_key_store_id_Set() const{
    return m_custom_key_store_id_isSet;
}

bool OAIDeleteCustomKeyStoreRequest::is_custom_key_store_id_Valid() const{
    return m_custom_key_store_id_isValid;
}

bool OAIDeleteCustomKeyStoreRequest::isSet() const {
...
bool OAIDeleteCustomKeyStoreRequest::isValid() const {
