...
/*
 * OAIKeyMetadata_XksKeyConfiguration.h
 *
 * 
 */

#ifndef OAIKeyMetadata_XksKeyConfiguration_H
#define OAIKeyMetadata_XksKeyConfiguration_H
...
class OAIKeyMetadata_XksKeyConfiguration : public OAIObject {
public:
    OAIKeyMetadata_XksKeyConfiguration();
    OAIKeyMetadata_XksKeyConfiguration(QString json);
    ~OAIKeyMetadata_XksKeyConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKeyMetadata_XksKeyConfiguration)

#endif // OAIKeyMetadata_XksKeyConfiguration_H
