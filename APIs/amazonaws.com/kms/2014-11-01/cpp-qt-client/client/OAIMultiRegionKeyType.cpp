...
OAIMultiRegionKeyType::OAIMultiRegionKeyType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMultiRegionKeyType::OAIMultiRegionKeyType() {
    this->initializeModel();
}

OAIMultiRegionKeyType::~OAIMultiRegionKeyType() {}

void OAIMultiRegionKeyType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIMultiRegionKeyType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIMultiRegionKeyType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("PRIMARY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIMultiRegionKeyType::PRIMARY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("REPLICA", Qt::CaseInsensitive) == 0) {
        m_value = eOAIMultiRegionKeyType::REPLICA;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIMultiRegionKeyType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIMultiRegionKeyType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIMultiRegionKeyType::PRIMARY:
            val = "PRIMARY";
            break;
        case eOAIMultiRegionKeyType::REPLICA:
            val = "REPLICA";
            break;
        default:
            break;
...
QJsonValue OAIMultiRegionKeyType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIMultiRegionKeyType::eOAIMultiRegionKeyType OAIMultiRegionKeyType::getValue() const {
    return m_value;
}

void OAIMultiRegionKeyType::setValue(const OAIMultiRegionKeyType::eOAIMultiRegionKeyType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIMultiRegionKeyType::isSet() const {
    
    return m_value_isSet;
}

bool OAIMultiRegionKeyType::isValid() const {
