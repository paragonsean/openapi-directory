...
/*
 * OAIConnectionErrorCodeType.h
 *
 * 
 */

#ifndef OAIConnectionErrorCodeType_H
#define OAIConnectionErrorCodeType_H
...
class OAIConnectionErrorCodeType : public OAIEnum {
public:
    OAIConnectionErrorCodeType();
    OAIConnectionErrorCodeType(QString json);
    ~OAIConnectionErrorCodeType() override;
    ...
    enum class eOAIConnectionErrorCodeType {
    ...
    OAIConnectionErrorCodeType::eOAIConnectionErrorCodeType getValue() const;
    void setValue(const OAIConnectionErrorCodeType::eOAIConnectionErrorCodeType& value);
...
private:
    ...
    eOAIConnectionErrorCodeType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnectionErrorCodeType)

#endif // OAIConnectionErrorCodeType_H
