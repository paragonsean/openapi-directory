...
OAIReplicateKeyResponse::OAIReplicateKeyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReplicateKeyResponse::OAIReplicateKeyResponse() {
    this->initializeModel();
}

OAIReplicateKeyResponse::~OAIReplicateKeyResponse() {}

void OAIReplicateKeyResponse::initializeModel() {

    m_replica_key_metadata_isSet = false;
    m_replica_key_metadata_isValid = false;

    m_replica_policy_isSet = false;
    m_replica_policy_isValid = false;

    m_replica_tags_isSet = false;
    m_replica_tags_isValid = false;
}

void OAIReplicateKeyResponse::fromJson(QString jsonString) {
...
void OAIReplicateKeyResponse::fromJsonObject(QJsonObject json) {

    m_replica_key_metadata_isValid = ::OpenAPI::fromJsonValue(m_replica_key_metadata, json[QString("ReplicaKeyMetadata")]);
    m_replica_key_metadata_isSet = !json[QString("ReplicaKeyMetadata")].isNull() && m_replica_key_metadata_isValid;

    m_replica_policy_isValid = ::OpenAPI::fromJsonValue(m_replica_policy, json[QString("ReplicaPolicy")]);
    m_replica_policy_isSet = !json[QString("ReplicaPolicy")].isNull() && m_replica_policy_isValid;

    m_replica_tags_isValid = ::OpenAPI::fromJsonValue(m_replica_tags, json[QString("ReplicaTags")]);
    m_replica_tags_isSet = !json[QString("ReplicaTags")].isNull() && m_replica_tags_isValid;
}

QString OAIReplicateKeyResponse::asJson() const {
...
QJsonObject OAIReplicateKeyResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_replica_key_metadata.isSet()) {
        obj.insert(QString("ReplicaKeyMetadata"), ::OpenAPI::toJsonValue(m_replica_key_metadata));
    }
    if (m_replica_policy_isSet) {
        obj.insert(QString("ReplicaPolicy"), ::OpenAPI::toJsonValue(m_replica_policy));
    }
    if (m_replica_tags.isSet()) {
        obj.insert(QString("ReplicaTags"), ::OpenAPI::toJsonValue(m_replica_tags));
    }
    return obj;
}

OAIReplicateKeyResponse_ReplicaKeyMetadata OAIReplicateKeyResponse::getReplicaKeyMetadata() const {
    return m_replica_key_metadata;
}
void OAIReplicateKeyResponse::setReplicaKeyMetadata(const OAIReplicateKeyResponse_ReplicaKeyMetadata &replica_key_metadata) {
    m_replica_key_metadata = replica_key_metadata;
    m_replica_key_metadata_isSet = true;
}

bool OAIReplicateKeyResponse::is_replica_key_metadata_Set() const{
    return m_replica_key_metadata_isSet;
}

bool OAIReplicateKeyResponse::is_replica_key_metadata_Valid() const{
    return m_replica_key_metadata_isValid;
}

QString OAIReplicateKeyResponse::getReplicaPolicy() const {
    return m_replica_policy;
}
void OAIReplicateKeyResponse::setReplicaPolicy(const QString &replica_policy) {
    m_replica_policy = replica_policy;
    m_replica_policy_isSet = true;
}

bool OAIReplicateKeyResponse::is_replica_policy_Set() const{
    return m_replica_policy_isSet;
}

bool OAIReplicateKeyResponse::is_replica_policy_Valid() const{
    return m_replica_policy_isValid;
}

QList OAIReplicateKeyResponse::getReplicaTags() const {
    return m_replica_tags;
}
void OAIReplicateKeyResponse::setReplicaTags(const QList &replica_tags) {
    m_replica_tags = replica_tags;
    m_replica_tags_isSet = true;
}

bool OAIReplicateKeyResponse::is_replica_tags_Set() const{
    return m_replica_tags_isSet;
}

bool OAIReplicateKeyResponse::is_replica_tags_Valid() const{
    return m_replica_tags_isValid;
}

bool OAIReplicateKeyResponse::isSet() const {
...
bool OAIReplicateKeyResponse::isValid() const {
