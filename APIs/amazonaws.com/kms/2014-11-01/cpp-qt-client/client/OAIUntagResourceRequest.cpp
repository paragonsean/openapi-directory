...
QString OAIUntagResourceRequest::getKeyId() const {
    return m_key_id;
}
void OAIUntagResourceRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIUntagResourceRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIUntagResourceRequest::is_key_id_Valid() const{
...
bool OAIUntagResourceRequest::isValid() const {
    ...
    return m_key_id_isValid && m_tag_keys_isValid && true;
}
