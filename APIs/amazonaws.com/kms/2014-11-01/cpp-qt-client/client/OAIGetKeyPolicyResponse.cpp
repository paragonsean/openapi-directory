...
OAIGetKeyPolicyResponse::OAIGetKeyPolicyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetKeyPolicyResponse::OAIGetKeyPolicyResponse() {
    this->initializeModel();
}

OAIGetKeyPolicyResponse::~OAIGetKeyPolicyResponse() {}

void OAIGetKeyPolicyResponse::initializeModel() {

    m_policy_isSet = false;
    m_policy_isValid = false;
}

void OAIGetKeyPolicyResponse::fromJson(QString jsonString) {
...
void OAIGetKeyPolicyResponse::fromJsonObject(QJsonObject json) {

    m_policy_isValid = ::OpenAPI::fromJsonValue(m_policy, json[QString("Policy")]);
    m_policy_isSet = !json[QString("Policy")].isNull() && m_policy_isValid;
}

QString OAIGetKeyPolicyResponse::asJson() const {
...
QJsonObject OAIGetKeyPolicyResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_policy_isSet) {
...
QString OAIGetKeyPolicyResponse::getPolicy() const {
    return m_policy;
}
void OAIGetKeyPolicyResponse::setPolicy(const QString &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAIGetKeyPolicyResponse::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAIGetKeyPolicyResponse::is_policy_Valid() const{
    return m_policy_isValid;
}

bool OAIGetKeyPolicyResponse::isSet() const {
...
bool OAIGetKeyPolicyResponse::isValid() const {
