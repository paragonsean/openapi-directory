...
#include "OAIXksKeyConfigurationType.h"
...
OAIXksKeyConfigurationType::OAIXksKeyConfigurationType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIXksKeyConfigurationType::OAIXksKeyConfigurationType() {
    this->initializeModel();
}

OAIXksKeyConfigurationType::~OAIXksKeyConfigurationType() {}

void OAIXksKeyConfigurationType::initializeModel() {

    m_id_isSet = false;
    m_id_isValid = false;
}

void OAIXksKeyConfigurationType::fromJson(QString jsonString) {
...
void OAIXksKeyConfigurationType::fromJsonObject(QJsonObject json) {

    m_id_isValid = ::OpenAPI::fromJsonValue(m_id, json[QString("Id")]);
    m_id_isSet = !json[QString("Id")].isNull() && m_id_isValid;
}

QString OAIXksKeyConfigurationType::asJson() const {
...
QJsonObject OAIXksKeyConfigurationType::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIXksKeyConfigurationType::getId() const {
    return m_id;
}
void OAIXksKeyConfigurationType::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIXksKeyConfigurationType::is_id_Set() const{
    return m_id_isSet;
}

bool OAIXksKeyConfigurationType::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIXksKeyConfigurationType::isSet() const {
...
bool OAIXksKeyConfigurationType::isValid() const {
