...
OAIMacAlgorithmSpec::OAIMacAlgorithmSpec(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMacAlgorithmSpec::OAIMacAlgorithmSpec() {
    this->initializeModel();
}

OAIMacAlgorithmSpec::~OAIMacAlgorithmSpec() {}

void OAIMacAlgorithmSpec::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIMacAlgorithmSpec::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIMacAlgorithmSpec::fromJson(QString jsonString) {
    
    if ( jsonString.compare("HMAC_SHA_224", Qt::CaseInsensitive) == 0) {
        m_value = eOAIMacAlgorithmSpec::_224;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("HMAC_SHA_256", Qt::CaseInsensitive) == 0) {
        m_value = eOAIMacAlgorithmSpec::_256;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("HMAC_SHA_384", Qt::CaseInsensitive) == 0) {
        m_value = eOAIMacAlgorithmSpec::_384;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("HMAC_SHA_512", Qt::CaseInsensitive) == 0) {
        m_value = eOAIMacAlgorithmSpec::_512;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIMacAlgorithmSpec::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIMacAlgorithmSpec::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIMacAlgorithmSpec::_224:
            val = "HMAC_SHA_224";
            break;
        case eOAIMacAlgorithmSpec::_256:
            val = "HMAC_SHA_256";
            break;
        case eOAIMacAlgorithmSpec::_384:
            val = "HMAC_SHA_384";
            break;
        case eOAIMacAlgorithmSpec::_512:
            val = "HMAC_SHA_512";
            break;
        default:
            break;
...
QJsonValue OAIMacAlgorithmSpec::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIMacAlgorithmSpec::eOAIMacAlgorithmSpec OAIMacAlgorithmSpec::getValue() const {
    return m_value;
}

void OAIMacAlgorithmSpec::setValue(const OAIMacAlgorithmSpec::eOAIMacAlgorithmSpec& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIMacAlgorithmSpec::isSet() const {
    
    return m_value_isSet;
}

bool OAIMacAlgorithmSpec::isValid() const {
