...
/*
 * OAIListGrantsRequest.h
 *
 * 
 */

#ifndef OAIListGrantsRequest_H
#define OAIListGrantsRequest_H
...
class OAIListGrantsRequest : public OAIObject {
public:
    OAIListGrantsRequest();
    OAIListGrantsRequest(QString json);
    ~OAIListGrantsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListGrantsRequest)

#endif // OAIListGrantsRequest_H
