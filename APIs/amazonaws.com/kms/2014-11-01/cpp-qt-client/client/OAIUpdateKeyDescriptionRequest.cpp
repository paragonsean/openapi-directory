...
OAIUpdateKeyDescriptionRequest::OAIUpdateKeyDescriptionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateKeyDescriptionRequest::OAIUpdateKeyDescriptionRequest() {
    this->initializeModel();
}

OAIUpdateKeyDescriptionRequest::~OAIUpdateKeyDescriptionRequest() {}

void OAIUpdateKeyDescriptionRequest::initializeModel() {
...
void OAIUpdateKeyDescriptionRequest::fromJson(QString jsonString) {
...
void OAIUpdateKeyDescriptionRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateKeyDescriptionRequest::asJson() const {
...
QJsonObject OAIUpdateKeyDescriptionRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAIUpdateKeyDescriptionRequest::getKeyId() const {
    return m_key_id;
}
void OAIUpdateKeyDescriptionRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIUpdateKeyDescriptionRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIUpdateKeyDescriptionRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

QString OAIUpdateKeyDescriptionRequest::getDescription() const {
    return m_description;
}
void OAIUpdateKeyDescriptionRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateKeyDescriptionRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateKeyDescriptionRequest::is_description_Valid() const{
    return m_description_isValid;
}

bool OAIUpdateKeyDescriptionRequest::isSet() const {
...
bool OAIUpdateKeyDescriptionRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_key_id_isValid && m_description_isValid && true;
}
