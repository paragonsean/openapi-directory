...
public:
    ...
    QString getGrantToken() const;
    void setGrantToken(const QString &grant_token);
    bool is_grant_token_Set() const;
    bool is_grant_token_Valid() const;
...
private:
    ...
    QString m_grant_token;
    bool m_grant_token_isSet;
    bool m_grant_token_isValid;
