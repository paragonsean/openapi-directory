...
OAIVerifyMacRequest::OAIVerifyMacRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVerifyMacRequest::OAIVerifyMacRequest() {
    this->initializeModel();
}

OAIVerifyMacRequest::~OAIVerifyMacRequest() {}

void OAIVerifyMacRequest::initializeModel() {
    ...
    m_mac_algorithm_isSet = false;
    m_mac_algorithm_isValid = false;
...
void OAIVerifyMacRequest::fromJson(QString jsonString) {
...
void OAIVerifyMacRequest::fromJsonObject(QJsonObject json) {
    ...
    m_mac_algorithm_isValid = ::OpenAPI::fromJsonValue(m_mac_algorithm, json[QString("MacAlgorithm")]);
    m_mac_algorithm_isSet = !json[QString("MacAlgorithm")].isNull() && m_mac_algorithm_isValid;
...
QString OAIVerifyMacRequest::asJson() const {
...
QJsonObject OAIVerifyMacRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_message_isSet) {
    ...
    if (m_mac_algorithm.isSet()) {
        obj.insert(QString("MacAlgorithm"), ::OpenAPI::toJsonValue(m_mac_algorithm));
    }
    if (m_mac_isSet) {
...
QString OAIVerifyMacRequest::getMessage() const {
    return m_message;
}
void OAIVerifyMacRequest::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIVerifyMacRequest::is_message_Set() const{
    return m_message_isSet;
}

bool OAIVerifyMacRequest::is_message_Valid() const{
    return m_message_isValid;
}

QString OAIVerifyMacRequest::getKeyId() const {
    return m_key_id;
}
void OAIVerifyMacRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIVerifyMacRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIVerifyMacRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

OAIMacAlgorithmSpec OAIVerifyMacRequest::getMacAlgorithm() const {
    return m_mac_algorithm;
}
void OAIVerifyMacRequest::setMacAlgorithm(const OAIMacAlgorithmSpec &mac_algorithm) {
    m_mac_algorithm = mac_algorithm;
    m_mac_algorithm_isSet = true;
}

bool OAIVerifyMacRequest::is_mac_algorithm_Set() const{
    return m_mac_algorithm_isSet;
}

bool OAIVerifyMacRequest::is_mac_algorithm_Valid() const{
    return m_mac_algorithm_isValid;
}

QString OAIVerifyMacRequest::getMac() const {
    return m_mac;
}
void OAIVerifyMacRequest::setMac(const QString &mac) {
    m_mac = mac;
    m_mac_isSet = true;
}

bool OAIVerifyMacRequest::is_mac_Set() const{
    return m_mac_isSet;
}

bool OAIVerifyMacRequest::is_mac_Valid() const{
    return m_mac_isValid;
}

QList OAIVerifyMacRequest::getGrantTokens() const {
    return m_grant_tokens;
}
void OAIVerifyMacRequest::setGrantTokens(const QList &grant_tokens) {
    m_grant_tokens = grant_tokens;
    m_grant_tokens_isSet = true;
}

bool OAIVerifyMacRequest::is_grant_tokens_Set() const{
    return m_grant_tokens_isSet;
}

bool OAIVerifyMacRequest::is_grant_tokens_Valid() const{
    return m_grant_tokens_isValid;
}

bool OAIVerifyMacRequest::getDryRun() const {
    return m_dry_run;
}
void OAIVerifyMacRequest::setDryRun(const bool &dry_run) {
    m_dry_run = dry_run;
    m_dry_run_isSet = true;
}

bool OAIVerifyMacRequest::is_dry_run_Set() const{
    return m_dry_run_isSet;
}

bool OAIVerifyMacRequest::is_dry_run_Valid() const{
    return m_dry_run_isValid;
}

bool OAIVerifyMacRequest::isSet() const {
...
bool OAIVerifyMacRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_message_isValid && m_key_id_isValid && m_mac_algorithm_isValid && m_mac_isValid && true;
}
