...
OAIGetKeyPolicyRequest::OAIGetKeyPolicyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetKeyPolicyRequest::OAIGetKeyPolicyRequest() {
    this->initializeModel();
}

OAIGetKeyPolicyRequest::~OAIGetKeyPolicyRequest() {}

void OAIGetKeyPolicyRequest::initializeModel() {
...
void OAIGetKeyPolicyRequest::fromJson(QString jsonString) {
...
void OAIGetKeyPolicyRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetKeyPolicyRequest::asJson() const {
...
QJsonObject OAIGetKeyPolicyRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAIGetKeyPolicyRequest::getKeyId() const {
    return m_key_id;
}
void OAIGetKeyPolicyRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIGetKeyPolicyRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIGetKeyPolicyRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

QString OAIGetKeyPolicyRequest::getPolicyName() const {
    return m_policy_name;
}
void OAIGetKeyPolicyRequest::setPolicyName(const QString &policy_name) {
    m_policy_name = policy_name;
    m_policy_name_isSet = true;
}

bool OAIGetKeyPolicyRequest::is_policy_name_Set() const{
    return m_policy_name_isSet;
}

bool OAIGetKeyPolicyRequest::is_policy_name_Valid() const{
    return m_policy_name_isValid;
}

bool OAIGetKeyPolicyRequest::isSet() const {
...
bool OAIGetKeyPolicyRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_key_id_isValid && m_policy_name_isValid && true;
}
