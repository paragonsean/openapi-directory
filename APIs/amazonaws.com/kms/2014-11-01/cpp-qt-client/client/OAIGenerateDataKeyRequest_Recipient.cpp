...
#include "OAIGenerateDataKeyRequest_Recipient.h"
...
OAIGenerateDataKeyRequest_Recipient::OAIGenerateDataKeyRequest_Recipient(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGenerateDataKeyRequest_Recipient::OAIGenerateDataKeyRequest_Recipient() {
    this->initializeModel();
}

OAIGenerateDataKeyRequest_Recipient::~OAIGenerateDataKeyRequest_Recipient() {}

void OAIGenerateDataKeyRequest_Recipient::initializeModel() {

    m_key_encryption_algorithm_isSet = false;
    m_key_encryption_algorithm_isValid = false;

    m_attestation_document_isSet = false;
    m_attestation_document_isValid = false;
}

void OAIGenerateDataKeyRequest_Recipient::fromJson(QString jsonString) {
...
void OAIGenerateDataKeyRequest_Recipient::fromJsonObject(QJsonObject json) {

    m_key_encryption_algorithm_isValid = ::OpenAPI::fromJsonValue(m_key_encryption_algorithm, json[QString("KeyEncryptionAlgorithm")]);
    m_key_encryption_algorithm_isSet = !json[QString("KeyEncryptionAlgorithm")].isNull() && m_key_encryption_algorithm_isValid;

    m_attestation_document_isValid = ::OpenAPI::fromJsonValue(m_attestation_document, json[QString("AttestationDocument")]);
    m_attestation_document_isSet = !json[QString("AttestationDocument")].isNull() && m_attestation_document_isValid;
}

QString OAIGenerateDataKeyRequest_Recipient::asJson() const {
...
QJsonObject OAIGenerateDataKeyRequest_Recipient::asJsonObject() const {
    QJsonObject obj;
    if (m_key_encryption_algorithm.isSet()) {
        obj.insert(QString("KeyEncryptionAlgorithm"), ::OpenAPI::toJsonValue(m_key_encryption_algorithm));
    }
    if (m_attestation_document_isSet) {
        obj.insert(QString("AttestationDocument"), ::OpenAPI::toJsonValue(m_attestation_document));
    }
    return obj;
}

OAIKeyEncryptionMechanism OAIGenerateDataKeyRequest_Recipient::getKeyEncryptionAlgorithm() const {
    return m_key_encryption_algorithm;
}
void OAIGenerateDataKeyRequest_Recipient::setKeyEncryptionAlgorithm(const OAIKeyEncryptionMechanism &key_encryption_algorithm) {
    m_key_encryption_algorithm = key_encryption_algorithm;
    m_key_encryption_algorithm_isSet = true;
}

bool OAIGenerateDataKeyRequest_Recipient::is_key_encryption_algorithm_Set() const{
    return m_key_encryption_algorithm_isSet;
}

bool OAIGenerateDataKeyRequest_Recipient::is_key_encryption_algorithm_Valid() const{
    return m_key_encryption_algorithm_isValid;
}

QString OAIGenerateDataKeyRequest_Recipient::getAttestationDocument() const {
    return m_attestation_document;
}
void OAIGenerateDataKeyRequest_Recipient::setAttestationDocument(const QString &attestation_document) {
    m_attestation_document = attestation_document;
    m_attestation_document_isSet = true;
}

bool OAIGenerateDataKeyRequest_Recipient::is_attestation_document_Set() const{
    return m_attestation_document_isSet;
}

bool OAIGenerateDataKeyRequest_Recipient::is_attestation_document_Valid() const{
    return m_attestation_document_isValid;
}

bool OAIGenerateDataKeyRequest_Recipient::isSet() const {
...
bool OAIGenerateDataKeyRequest_Recipient::isValid() const {
