...
OAIListRetirableGrantsRequest::OAIListRetirableGrantsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListRetirableGrantsRequest::OAIListRetirableGrantsRequest() {
    this->initializeModel();
}

OAIListRetirableGrantsRequest::~OAIListRetirableGrantsRequest() {}

void OAIListRetirableGrantsRequest::initializeModel() {
...
void OAIListRetirableGrantsRequest::fromJson(QString jsonString) {
...
void OAIListRetirableGrantsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListRetirableGrantsRequest::asJson() const {
...
QJsonObject OAIListRetirableGrantsRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_limit_isSet) {
...
qint32 OAIListRetirableGrantsRequest::getLimit() const {
    return m_limit;
}
void OAIListRetirableGrantsRequest::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIListRetirableGrantsRequest::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIListRetirableGrantsRequest::is_limit_Valid() const{
    return m_limit_isValid;
}

QString OAIListRetirableGrantsRequest::getMarker() const {
    return m_marker;
}
void OAIListRetirableGrantsRequest::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIListRetirableGrantsRequest::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIListRetirableGrantsRequest::is_marker_Valid() const{
    return m_marker_isValid;
}

QString OAIListRetirableGrantsRequest::getRetiringPrincipal() const {
    return m_retiring_principal;
}
void OAIListRetirableGrantsRequest::setRetiringPrincipal(const QString &retiring_principal) {
    m_retiring_principal = retiring_principal;
    m_retiring_principal_isSet = true;
}

bool OAIListRetirableGrantsRequest::is_retiring_principal_Set() const{
    return m_retiring_principal_isSet;
}

bool OAIListRetirableGrantsRequest::is_retiring_principal_Valid() const{
    return m_retiring_principal_isValid;
}

bool OAIListRetirableGrantsRequest::isSet() const {
...
bool OAIListRetirableGrantsRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_retiring_principal_isValid && true;
}
