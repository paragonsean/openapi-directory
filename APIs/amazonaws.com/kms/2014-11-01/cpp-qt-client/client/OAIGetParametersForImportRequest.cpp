...
OAIGetParametersForImportRequest::OAIGetParametersForImportRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetParametersForImportRequest::OAIGetParametersForImportRequest() {
    this->initializeModel();
}

OAIGetParametersForImportRequest::~OAIGetParametersForImportRequest() {}

void OAIGetParametersForImportRequest::initializeModel() {

    m_key_id_isSet = false;
    m_key_id_isValid = false;

    m_wrapping_algorithm_isSet = false;
    m_wrapping_algorithm_isValid = false;

    m_wrapping_key_spec_isSet = false;
    m_wrapping_key_spec_isValid = false;
}

void OAIGetParametersForImportRequest::fromJson(QString jsonString) {
...
void OAIGetParametersForImportRequest::fromJsonObject(QJsonObject json) {
    ...
    m_wrapping_algorithm_isValid = ::OpenAPI::fromJsonValue(m_wrapping_algorithm, json[QString("WrappingAlgorithm")]);
    m_wrapping_algorithm_isSet = !json[QString("WrappingAlgorithm")].isNull() && m_wrapping_algorithm_isValid;

    m_wrapping_key_spec_isValid = ::OpenAPI::fromJsonValue(m_wrapping_key_spec, json[QString("WrappingKeySpec")]);
    m_wrapping_key_spec_isSet = !json[QString("WrappingKeySpec")].isNull() && m_wrapping_key_spec_isValid;
}

QString OAIGetParametersForImportRequest::asJson() const {
...
QJsonObject OAIGetParametersForImportRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
        obj.insert(QString("KeyId"), ::OpenAPI::toJsonValue(m_key_id));
    }
    if (m_wrapping_algorithm.isSet()) {
        obj.insert(QString("WrappingAlgorithm"), ::OpenAPI::toJsonValue(m_wrapping_algorithm));
    }
    if (m_wrapping_key_spec.isSet()) {
        obj.insert(QString("WrappingKeySpec"), ::OpenAPI::toJsonValue(m_wrapping_key_spec));
    }
    return obj;
}

QString OAIGetParametersForImportRequest::getKeyId() const {
    return m_key_id;
}
void OAIGetParametersForImportRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIGetParametersForImportRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIGetParametersForImportRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

OAIAlgorithmSpec OAIGetParametersForImportRequest::getWrappingAlgorithm() const {
    return m_wrapping_algorithm;
}
void OAIGetParametersForImportRequest::setWrappingAlgorithm(const OAIAlgorithmSpec &wrapping_algorithm) {
    m_wrapping_algorithm = wrapping_algorithm;
    m_wrapping_algorithm_isSet = true;
}

bool OAIGetParametersForImportRequest::is_wrapping_algorithm_Set() const{
    return m_wrapping_algorithm_isSet;
}

bool OAIGetParametersForImportRequest::is_wrapping_algorithm_Valid() const{
    return m_wrapping_algorithm_isValid;
}

OAIWrappingKeySpec OAIGetParametersForImportRequest::getWrappingKeySpec() const {
    return m_wrapping_key_spec;
}
void OAIGetParametersForImportRequest::setWrappingKeySpec(const OAIWrappingKeySpec &wrapping_key_spec) {
    m_wrapping_key_spec = wrapping_key_spec;
    m_wrapping_key_spec_isSet = true;
}

bool OAIGetParametersForImportRequest::is_wrapping_key_spec_Set() const{
    return m_wrapping_key_spec_isSet;
}

bool OAIGetParametersForImportRequest::is_wrapping_key_spec_Valid() const{
    return m_wrapping_key_spec_isValid;
}

bool OAIGetParametersForImportRequest::isSet() const {
...
bool OAIGetParametersForImportRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_key_id_isValid && m_wrapping_algorithm_isValid && m_wrapping_key_spec_isValid && true;
}
