...
QString OAIDecryptResponse::getKeyId() const {
    return m_key_id;
}
void OAIDecryptResponse::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIDecryptResponse::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIDecryptResponse::is_key_id_Valid() const{
    return m_key_id_isValid;
}

QString OAIDecryptResponse::getPlaintext() const {
    return m_plaintext;
}
void OAIDecryptResponse::setPlaintext(const QString &plaintext) {
...
OAIEncryptionAlgorithmSpec OAIDecryptResponse::getEncryptionAlgorithm() const {
    return m_encryption_algorithm;
}
void OAIDecryptResponse::setEncryptionAlgorithm(const OAIEncryptionAlgorithmSpec &encryption_algorithm) {
    m_encryption_algorithm = encryption_algorithm;
    m_encryption_algorithm_isSet = true;
}

bool OAIDecryptResponse::is_encryption_algorithm_Set() const{
    return m_encryption_algorithm_isSet;
}

bool OAIDecryptResponse::is_encryption_algorithm_Valid() const{
    return m_encryption_algorithm_isValid;
}

QString OAIDecryptResponse::getCiphertextForRecipient() const {
    return m_ciphertext_for_recipient;
}
void OAIDecryptResponse::setCiphertextForRecipient(const QString &ciphertext_for_recipient) {
    m_ciphertext_for_recipient = ciphertext_for_recipient;
    m_ciphertext_for_recipient_isSet = true;
}

bool OAIDecryptResponse::is_ciphertext_for_recipient_Set() const{
    return m_ciphertext_for_recipient_isSet;
}

bool OAIDecryptResponse::is_ciphertext_for_recipient_Valid() const{
