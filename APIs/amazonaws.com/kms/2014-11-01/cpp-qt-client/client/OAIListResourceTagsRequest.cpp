...
OAIListResourceTagsRequest::OAIListResourceTagsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListResourceTagsRequest::OAIListResourceTagsRequest() {
    this->initializeModel();
}

OAIListResourceTagsRequest::~OAIListResourceTagsRequest() {}

void OAIListResourceTagsRequest::initializeModel() {
...
void OAIListResourceTagsRequest::fromJson(QString jsonString) {
...
void OAIListResourceTagsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListResourceTagsRequest::asJson() const {
...
QJsonObject OAIListResourceTagsRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAIListResourceTagsRequest::getKeyId() const {
    return m_key_id;
}
void OAIListResourceTagsRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIListResourceTagsRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIListResourceTagsRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

qint32 OAIListResourceTagsRequest::getLimit() const {
    return m_limit;
}
void OAIListResourceTagsRequest::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIListResourceTagsRequest::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIListResourceTagsRequest::is_limit_Valid() const{
    return m_limit_isValid;
}

QString OAIListResourceTagsRequest::getMarker() const {
    return m_marker;
}
void OAIListResourceTagsRequest::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIListResourceTagsRequest::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIListResourceTagsRequest::is_marker_Valid() const{
    return m_marker_isValid;
}

bool OAIListResourceTagsRequest::isSet() const {
...
bool OAIListResourceTagsRequest::isValid() const {
