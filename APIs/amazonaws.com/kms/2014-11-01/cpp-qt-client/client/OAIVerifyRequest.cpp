...
OAIVerifyRequest::OAIVerifyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVerifyRequest::OAIVerifyRequest() {
    this->initializeModel();
}

OAIVerifyRequest::~OAIVerifyRequest() {}

void OAIVerifyRequest::initializeModel() {
...
void OAIVerifyRequest::fromJson(QString jsonString) {
...
void OAIVerifyRequest::fromJsonObject(QJsonObject json) {
...
QString OAIVerifyRequest::asJson() const {
...
QJsonObject OAIVerifyRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAIVerifyRequest::getKeyId() const {
    return m_key_id;
}
void OAIVerifyRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIVerifyRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIVerifyRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

QString OAIVerifyRequest::getMessage() const {
    return m_message;
}
void OAIVerifyRequest::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIVerifyRequest::is_message_Set() const{
    return m_message_isSet;
}

bool OAIVerifyRequest::is_message_Valid() const{
    return m_message_isValid;
}

OAIMessageType OAIVerifyRequest::getMessageType() const {
    return m_message_type;
}
void OAIVerifyRequest::setMessageType(const OAIMessageType &message_type) {
    m_message_type = message_type;
    m_message_type_isSet = true;
}

bool OAIVerifyRequest::is_message_type_Set() const{
    return m_message_type_isSet;
}

bool OAIVerifyRequest::is_message_type_Valid() const{
    return m_message_type_isValid;
}

QString OAIVerifyRequest::getSignature() const {
    return m_signature;
}
void OAIVerifyRequest::setSignature(const QString &signature) {
    m_signature = signature;
    m_signature_isSet = true;
}

bool OAIVerifyRequest::is_signature_Set() const{
    return m_signature_isSet;
}

bool OAIVerifyRequest::is_signature_Valid() const{
    return m_signature_isValid;
}

OAISigningAlgorithmSpec OAIVerifyRequest::getSigningAlgorithm() const {
    return m_signing_algorithm;
}
void OAIVerifyRequest::setSigningAlgorithm(const OAISigningAlgorithmSpec &signing_algorithm) {
    m_signing_algorithm = signing_algorithm;
    m_signing_algorithm_isSet = true;
}

bool OAIVerifyRequest::is_signing_algorithm_Set() const{
    return m_signing_algorithm_isSet;
}

bool OAIVerifyRequest::is_signing_algorithm_Valid() const{
    return m_signing_algorithm_isValid;
}

QList OAIVerifyRequest::getGrantTokens() const {
    return m_grant_tokens;
}
void OAIVerifyRequest::setGrantTokens(const QList &grant_tokens) {
    m_grant_tokens = grant_tokens;
    m_grant_tokens_isSet = true;
}

bool OAIVerifyRequest::is_grant_tokens_Set() const{
    return m_grant_tokens_isSet;
}

bool OAIVerifyRequest::is_grant_tokens_Valid() const{
    return m_grant_tokens_isValid;
}

bool OAIVerifyRequest::getDryRun() const {
    return m_dry_run;
}
void OAIVerifyRequest::setDryRun(const bool &dry_run) {
    m_dry_run = dry_run;
    m_dry_run_isSet = true;
}

bool OAIVerifyRequest::is_dry_run_Set() const{
    return m_dry_run_isSet;
}

bool OAIVerifyRequest::is_dry_run_Valid() const{
    return m_dry_run_isValid;
}

bool OAIVerifyRequest::isSet() const {
...
bool OAIVerifyRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_key_id_isValid && m_message_isValid && m_signature_isValid && m_signing_algorithm_isValid && true;
}
