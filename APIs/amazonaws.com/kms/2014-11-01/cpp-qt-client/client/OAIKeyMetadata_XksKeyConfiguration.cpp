...
OAIKeyMetadata_XksKeyConfiguration::OAIKeyMetadata_XksKeyConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIKeyMetadata_XksKeyConfiguration::OAIKeyMetadata_XksKeyConfiguration() {
    this->initializeModel();
}

OAIKeyMetadata_XksKeyConfiguration::~OAIKeyMetadata_XksKeyConfiguration() {}

void OAIKeyMetadata_XksKeyConfiguration::initializeModel() {

    m_id_isSet = false;
    m_id_isValid = false;
}

void OAIKeyMetadata_XksKeyConfiguration::fromJson(QString jsonString) {
...
void OAIKeyMetadata_XksKeyConfiguration::fromJsonObject(QJsonObject json) {

    m_id_isValid = ::OpenAPI::fromJsonValue(m_id, json[QString("Id")]);
    m_id_isSet = !json[QString("Id")].isNull() && m_id_isValid;
}

QString OAIKeyMetadata_XksKeyConfiguration::asJson() const {
...
QJsonObject OAIKeyMetadata_XksKeyConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIKeyMetadata_XksKeyConfiguration::getId() const {
    return m_id;
}
void OAIKeyMetadata_XksKeyConfiguration::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIKeyMetadata_XksKeyConfiguration::is_id_Set() const{
    return m_id_isSet;
}

bool OAIKeyMetadata_XksKeyConfiguration::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIKeyMetadata_XksKeyConfiguration::isSet() const {
...
bool OAIKeyMetadata_XksKeyConfiguration::isValid() const {
