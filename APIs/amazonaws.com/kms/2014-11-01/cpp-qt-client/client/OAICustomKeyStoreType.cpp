...
OAICustomKeyStoreType::OAICustomKeyStoreType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICustomKeyStoreType::OAICustomKeyStoreType() {
    this->initializeModel();
}

OAICustomKeyStoreType::~OAICustomKeyStoreType() {}

void OAICustomKeyStoreType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAICustomKeyStoreType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAICustomKeyStoreType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("AWS_CLOUDHSM", Qt::CaseInsensitive) == 0) {
        m_value = eOAICustomKeyStoreType::AWS_CLOUDHSM;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("EXTERNAL_KEY_STORE", Qt::CaseInsensitive) == 0) {
        m_value = eOAICustomKeyStoreType::EXTERNAL_KEY_STORE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAICustomKeyStoreType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAICustomKeyStoreType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAICustomKeyStoreType::AWS_CLOUDHSM:
            val = "AWS_CLOUDHSM";
            break;
        case eOAICustomKeyStoreType::EXTERNAL_KEY_STORE:
            val = "EXTERNAL_KEY_STORE";
            break;
        default:
            break;
    }
...
QJsonValue OAICustomKeyStoreType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAICustomKeyStoreType::eOAICustomKeyStoreType OAICustomKeyStoreType::getValue() const {
    return m_value;
}

void OAICustomKeyStoreType::setValue(const OAICustomKeyStoreType::eOAICustomKeyStoreType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAICustomKeyStoreType::isSet() const {
    
    return m_value_isSet;
}

bool OAICustomKeyStoreType::isValid() const {
