...
/*
 * OAIEncryptionAlgorithmSpec.h
 *
 * 
 */

#ifndef OAIEncryptionAlgorithmSpec_H
#define OAIEncryptionAlgorithmSpec_H
...
class OAIEncryptionAlgorithmSpec : public OAIEnum {
public:
    OAIEncryptionAlgorithmSpec();
    OAIEncryptionAlgorithmSpec(QString json);
    ~OAIEncryptionAlgorithmSpec() override;
    ...
    enum class eOAIEncryptionAlgorithmSpec {
    ...
    OAIEncryptionAlgorithmSpec::eOAIEncryptionAlgorithmSpec getValue() const;
    void setValue(const OAIEncryptionAlgorithmSpec::eOAIEncryptionAlgorithmSpec& value);
...
private:
    ...
    eOAIEncryptionAlgorithmSpec m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEncryptionAlgorithmSpec)

#endif // OAIEncryptionAlgorithmSpec_H
