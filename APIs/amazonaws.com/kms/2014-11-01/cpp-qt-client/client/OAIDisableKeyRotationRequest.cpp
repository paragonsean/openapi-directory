...
OAIDisableKeyRotationRequest::OAIDisableKeyRotationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDisableKeyRotationRequest::OAIDisableKeyRotationRequest() {
    this->initializeModel();
}

OAIDisableKeyRotationRequest::~OAIDisableKeyRotationRequest() {}

void OAIDisableKeyRotationRequest::initializeModel() {

    m_key_id_isSet = false;
    m_key_id_isValid = false;
}

void OAIDisableKeyRotationRequest::fromJson(QString jsonString) {
...
void OAIDisableKeyRotationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDisableKeyRotationRequest::asJson() const {
...
QJsonObject OAIDisableKeyRotationRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAIDisableKeyRotationRequest::getKeyId() const {
    return m_key_id;
}
void OAIDisableKeyRotationRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIDisableKeyRotationRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIDisableKeyRotationRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

bool OAIDisableKeyRotationRequest::isSet() const {
...
bool OAIDisableKeyRotationRequest::isValid() const {
