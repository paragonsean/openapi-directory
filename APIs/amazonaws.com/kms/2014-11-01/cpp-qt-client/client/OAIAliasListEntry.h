...
#ifndef OAIAliasListEntry_H
#define OAIAliasListEntry_H
...
class OAIAliasListEntry : public OAIObject {
public:
    OAIAliasListEntry();
    OAIAliasListEntry(QString json);
    ~OAIAliasListEntry() override;
    ...
    QString getTargetKeyId() const;
    void setTargetKeyId(const QString &target_key_id);
    bool is_target_key_id_Set() const;
    bool is_target_key_id_Valid() const;
...
private:
    ...
    QString m_target_key_id;
    bool m_target_key_id_isSet;
    bool m_target_key_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAliasListEntry)

#endif // OAIAliasListEntry_H
