...
/*
 * OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential.h
 *
 * 
 */

#ifndef OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential_H
#define OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential_H
...
class OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential : public OAIObject {
public:
    OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential();
    OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential(QString json);
    ~OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential() override;
    ...
    QString getRawSecretAccessKey() const;
    void setRawSecretAccessKey(const QString &raw_secret_access_key);
    bool is_raw_secret_access_key_Set() const;
    bool is_raw_secret_access_key_Valid() const;
...
private:
    ...
    QString m_raw_secret_access_key;
    bool m_raw_secret_access_key_isSet;
    bool m_raw_secret_access_key_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential)

#endif // OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential_H
