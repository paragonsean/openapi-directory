...
/*
 * OAIExpirationModelType.h
 *
 * 
 */

#ifndef OAIExpirationModelType_H
#define OAIExpirationModelType_H
...
class OAIExpirationModelType : public OAIEnum {
public:
    OAIExpirationModelType();
    OAIExpirationModelType(QString json);
    ~OAIExpirationModelType() override;
    ...
    enum class eOAIExpirationModelType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        EXPIRES, 
        DOES_NOT_EXPIRE
    };
    OAIExpirationModelType::eOAIExpirationModelType getValue() const;
    void setValue(const OAIExpirationModelType::eOAIExpirationModelType& value);
...
private:
    ...
    eOAIExpirationModelType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExpirationModelType)

#endif // OAIExpirationModelType_H
