...
#ifndef OAIMultiRegionKey_H
#define OAIMultiRegionKey_H
...
class OAIMultiRegionKey : public OAIObject {
public:
    OAIMultiRegionKey();
    OAIMultiRegionKey(QString json);
    ~OAIMultiRegionKey() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMultiRegionKey)

#endif // OAIMultiRegionKey_H
