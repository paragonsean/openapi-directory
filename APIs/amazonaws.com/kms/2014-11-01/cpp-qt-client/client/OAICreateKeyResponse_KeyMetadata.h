...
/*
 * OAICreateKeyResponse_KeyMetadata.h
 *
 * 
 */

#ifndef OAICreateKeyResponse_KeyMetadata_H
#define OAICreateKeyResponse_KeyMetadata_H
...
class OAICreateKeyResponse_KeyMetadata : public OAIObject {
public:
    OAICreateKeyResponse_KeyMetadata();
    OAICreateKeyResponse_KeyMetadata(QString json);
    ~OAICreateKeyResponse_KeyMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateKeyResponse_KeyMetadata)

#endif // OAICreateKeyResponse_KeyMetadata_H
