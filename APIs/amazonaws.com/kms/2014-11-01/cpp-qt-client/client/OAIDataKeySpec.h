...
#ifndef OAIDataKeySpec_H
#define OAIDataKeySpec_H
...
class OAIDataKeySpec : public OAIEnum {
public:
    OAIDataKeySpec();
    OAIDataKeySpec(QString json);
    ~OAIDataKeySpec() override;
    ...
    enum class eOAIDataKeySpec {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        _256, 
        _128
    };
    OAIDataKeySpec::eOAIDataKeySpec getValue() const;
    void setValue(const OAIDataKeySpec::eOAIDataKeySpec& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataKeySpec)

#endif // OAIDataKeySpec_H
