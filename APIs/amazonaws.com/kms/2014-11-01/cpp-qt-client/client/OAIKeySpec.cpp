...
OAIKeySpec::OAIKeySpec(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIKeySpec::OAIKeySpec() {
    this->initializeModel();
}

OAIKeySpec::~OAIKeySpec() {}

void OAIKeySpec::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIKeySpec::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIKeySpec::fromJson(QString jsonString) {
    
    if ( jsonString.compare("RSA_2048", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKeySpec::RSA_2048;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("RSA_3072", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKeySpec::RSA_3072;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("RSA_4096", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKeySpec::RSA_4096;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ECC_NIST_P256", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKeySpec::ECC_NIST_P256;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ECC_NIST_P384", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKeySpec::ECC_NIST_P384;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ECC_NIST_P521", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKeySpec::ECC_NIST_P521;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ECC_SECG_P256K1", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKeySpec::ECC_SECG_P256K1;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SYMMETRIC_DEFAULT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKeySpec::SYMMETRIC_DEFAULT;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("HMAC_224", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKeySpec::HMAC_224;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("HMAC_256", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKeySpec::HMAC_256;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("HMAC_384", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKeySpec::HMAC_384;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("HMAC_512", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKeySpec::HMAC_512;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SM2", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKeySpec::SM2;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIKeySpec::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIKeySpec::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIKeySpec::RSA_2048:
            val = "RSA_2048";
            break;
        case eOAIKeySpec::RSA_3072:
            val = "RSA_3072";
            break;
        case eOAIKeySpec::RSA_4096:
            val = "RSA_4096";
            break;
        case eOAIKeySpec::ECC_NIST_P256:
            val = "ECC_NIST_P256";
            break;
        case eOAIKeySpec::ECC_NIST_P384:
            val = "ECC_NIST_P384";
            break;
        case eOAIKeySpec::ECC_NIST_P521:
            val = "ECC_NIST_P521";
            break;
        case eOAIKeySpec::ECC_SECG_P256K1:
            val = "ECC_SECG_P256K1";
            break;
        case eOAIKeySpec::SYMMETRIC_DEFAULT:
            val = "SYMMETRIC_DEFAULT";
            break;
        case eOAIKeySpec::HMAC_224:
            val = "HMAC_224";
            break;
        case eOAIKeySpec::HMAC_256:
            val = "HMAC_256";
            break;
        case eOAIKeySpec::HMAC_384:
            val = "HMAC_384";
            break;
        case eOAIKeySpec::HMAC_512:
            val = "HMAC_512";
            break;
        case eOAIKeySpec::SM2:
            val = "SM2";
            break;
        default:
            break;
...
QJsonValue OAIKeySpec::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIKeySpec::eOAIKeySpec OAIKeySpec::getValue() const {
    return m_value;
}

void OAIKeySpec::setValue(const OAIKeySpec::eOAIKeySpec& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIKeySpec::isSet() const {
    
    return m_value_isSet;
}

bool OAIKeySpec::isValid() const {
