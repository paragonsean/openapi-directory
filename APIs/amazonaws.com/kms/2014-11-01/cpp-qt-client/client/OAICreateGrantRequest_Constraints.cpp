...
#include "OAICreateGrantRequest_Constraints.h"
...
OAICreateGrantRequest_Constraints::OAICreateGrantRequest_Constraints(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateGrantRequest_Constraints::OAICreateGrantRequest_Constraints() {
    this->initializeModel();
}

OAICreateGrantRequest_Constraints::~OAICreateGrantRequest_Constraints() {}

void OAICreateGrantRequest_Constraints::initializeModel() {
...
void OAICreateGrantRequest_Constraints::fromJson(QString jsonString) {
...
void OAICreateGrantRequest_Constraints::fromJsonObject(QJsonObject json) {
...
QString OAICreateGrantRequest_Constraints::asJson() const {
...
QJsonObject OAICreateGrantRequest_Constraints::asJsonObject() const {
    QJsonObject obj;
...
QMap OAICreateGrantRequest_Constraints::getEncryptionContextSubset() const {
    return m_encryption_context_subset;
}
void OAICreateGrantRequest_Constraints::setEncryptionContextSubset(const QMap &encryption_context_subset) {
    m_encryption_context_subset = encryption_context_subset;
    m_encryption_context_subset_isSet = true;
}

bool OAICreateGrantRequest_Constraints::is_encryption_context_subset_Set() const{
    return m_encryption_context_subset_isSet;
}

bool OAICreateGrantRequest_Constraints::is_encryption_context_subset_Valid() const{
    return m_encryption_context_subset_isValid;
}

QMap OAICreateGrantRequest_Constraints::getEncryptionContextEquals() const {
    return m_encryption_context_equals;
}
void OAICreateGrantRequest_Constraints::setEncryptionContextEquals(const QMap &encryption_context_equals) {
    m_encryption_context_equals = encryption_context_equals;
    m_encryption_context_equals_isSet = true;
}

bool OAICreateGrantRequest_Constraints::is_encryption_context_equals_Set() const{
    return m_encryption_context_equals_isSet;
}

bool OAICreateGrantRequest_Constraints::is_encryption_context_equals_Valid() const{
    return m_encryption_context_equals_isValid;
}

bool OAICreateGrantRequest_Constraints::isSet() const {
...
bool OAICreateGrantRequest_Constraints::isValid() const {
