...
#ifndef OAIVerifyRequest_H
#define OAIVerifyRequest_H
...
class OAIVerifyRequest : public OAIObject {
public:
    OAIVerifyRequest();
    OAIVerifyRequest(QString json);
    ~OAIVerifyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVerifyRequest)

#endif // OAIVerifyRequest_H
