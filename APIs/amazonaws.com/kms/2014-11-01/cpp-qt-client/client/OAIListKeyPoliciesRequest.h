...
/*
 * OAIListKeyPoliciesRequest.h
 *
 * 
 */

#ifndef OAIListKeyPoliciesRequest_H
#define OAIListKeyPoliciesRequest_H
...
class OAIListKeyPoliciesRequest : public OAIObject {
public:
    OAIListKeyPoliciesRequest();
    OAIListKeyPoliciesRequest(QString json);
    ~OAIListKeyPoliciesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListKeyPoliciesRequest)

#endif // OAIListKeyPoliciesRequest_H
