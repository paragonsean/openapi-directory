...
OAIEncryptionAlgorithmSpec::OAIEncryptionAlgorithmSpec(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEncryptionAlgorithmSpec::OAIEncryptionAlgorithmSpec() {
    this->initializeModel();
}

OAIEncryptionAlgorithmSpec::~OAIEncryptionAlgorithmSpec() {}

void OAIEncryptionAlgorithmSpec::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIEncryptionAlgorithmSpec::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIEncryptionAlgorithmSpec::fromJson(QString jsonString) {
    
    if ( jsonString.compare("SYMMETRIC_DEFAULT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEncryptionAlgorithmSpec::SYMMETRIC_DEFAULT;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("RSAES_OAEP_SHA_1", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEncryptionAlgorithmSpec::RSAES_OAEP_SHA_1;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("RSAES_OAEP_SHA_256", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEncryptionAlgorithmSpec::RSAES_OAEP_SHA_256;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SM2PKE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEncryptionAlgorithmSpec::SM2PKE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIEncryptionAlgorithmSpec::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIEncryptionAlgorithmSpec::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIEncryptionAlgorithmSpec::SYMMETRIC_DEFAULT:
            val = "SYMMETRIC_DEFAULT";
            break;
        case eOAIEncryptionAlgorithmSpec::RSAES_OAEP_SHA_1:
            val = "RSAES_OAEP_SHA_1";
            break;
        case eOAIEncryptionAlgorithmSpec::RSAES_OAEP_SHA_256:
            val = "RSAES_OAEP_SHA_256";
            break;
        case eOAIEncryptionAlgorithmSpec::SM2PKE:
            val = "SM2PKE";
            break;
        default:
            break;
...
QJsonValue OAIEncryptionAlgorithmSpec::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIEncryptionAlgorithmSpec::eOAIEncryptionAlgorithmSpec OAIEncryptionAlgorithmSpec::getValue() const {
    return m_value;
}

void OAIEncryptionAlgorithmSpec::setValue(const OAIEncryptionAlgorithmSpec::eOAIEncryptionAlgorithmSpec& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIEncryptionAlgorithmSpec::isSet() const {
    
    return m_value_isSet;
}

bool OAIEncryptionAlgorithmSpec::isValid() const {
