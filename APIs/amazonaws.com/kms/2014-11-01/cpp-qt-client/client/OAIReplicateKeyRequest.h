...
/*
 * OAIReplicateKeyRequest.h
 *
 * 
 */

#ifndef OAIReplicateKeyRequest_H
#define OAIReplicateKeyRequest_H
...
class OAIReplicateKeyRequest : public OAIObject {
public:
    OAIReplicateKeyRequest();
    OAIReplicateKeyRequest(QString json);
    ~OAIReplicateKeyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReplicateKeyRequest)

#endif // OAIReplicateKeyRequest_H
