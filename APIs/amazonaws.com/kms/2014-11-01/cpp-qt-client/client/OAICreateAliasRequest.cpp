...
OAICreateAliasRequest::OAICreateAliasRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateAliasRequest::OAICreateAliasRequest() {
    this->initializeModel();
}

OAICreateAliasRequest::~OAICreateAliasRequest() {}

void OAICreateAliasRequest::initializeModel() {
...
void OAICreateAliasRequest::fromJson(QString jsonString) {
...
void OAICreateAliasRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateAliasRequest::asJson() const {
...
QJsonObject OAICreateAliasRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateAliasRequest::getAliasName() const {
    return m_alias_name;
}
void OAICreateAliasRequest::setAliasName(const QString &alias_name) {
    m_alias_name = alias_name;
    m_alias_name_isSet = true;
}

bool OAICreateAliasRequest::is_alias_name_Set() const{
    return m_alias_name_isSet;
}

bool OAICreateAliasRequest::is_alias_name_Valid() const{
    return m_alias_name_isValid;
}

QString OAICreateAliasRequest::getTargetKeyId() const {
    return m_target_key_id;
}
void OAICreateAliasRequest::setTargetKeyId(const QString &target_key_id) {
    m_target_key_id = target_key_id;
    m_target_key_id_isSet = true;
}

bool OAICreateAliasRequest::is_target_key_id_Set() const{
    return m_target_key_id_isSet;
}

bool OAICreateAliasRequest::is_target_key_id_Valid() const{
    return m_target_key_id_isValid;
}

bool OAICreateAliasRequest::isSet() const {
...
bool OAICreateAliasRequest::isValid() const {
