...
OAIScheduleKeyDeletionResponse::OAIScheduleKeyDeletionResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIScheduleKeyDeletionResponse::OAIScheduleKeyDeletionResponse() {
    this->initializeModel();
}

OAIScheduleKeyDeletionResponse::~OAIScheduleKeyDeletionResponse() {}

void OAIScheduleKeyDeletionResponse::initializeModel() {
    ...
    m_pending_window_in_days_isSet = false;
    m_pending_window_in_days_isValid = false;
}

void OAIScheduleKeyDeletionResponse::fromJson(QString jsonString) {
...
void OAIScheduleKeyDeletionResponse::fromJsonObject(QJsonObject json) {
    ...
    m_pending_window_in_days_isValid = ::OpenAPI::fromJsonValue(m_pending_window_in_days, json[QString("PendingWindowInDays")]);
    m_pending_window_in_days_isSet = !json[QString("PendingWindowInDays")].isNull() && m_pending_window_in_days_isValid;
}

QString OAIScheduleKeyDeletionResponse::asJson() const {
...
QJsonObject OAIScheduleKeyDeletionResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
    ...
    if (m_pending_window_in_days_isSet) {
        obj.insert(QString("PendingWindowInDays"), ::OpenAPI::toJsonValue(m_pending_window_in_days));
    }
    return obj;
}

QString OAIScheduleKeyDeletionResponse::getKeyId() const {
    return m_key_id;
}
void OAIScheduleKeyDeletionResponse::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIScheduleKeyDeletionResponse::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIScheduleKeyDeletionResponse::is_key_id_Valid() const{
    return m_key_id_isValid;
}

QDateTime OAIScheduleKeyDeletionResponse::getDeletionDate() const {
    return m_deletion_date;
}
void OAIScheduleKeyDeletionResponse::setDeletionDate(const QDateTime &deletion_date) {
    m_deletion_date = deletion_date;
    m_deletion_date_isSet = true;
}

bool OAIScheduleKeyDeletionResponse::is_deletion_date_Set() const{
    return m_deletion_date_isSet;
}

bool OAIScheduleKeyDeletionResponse::is_deletion_date_Valid() const{
    return m_deletion_date_isValid;
}

OAIKeyState OAIScheduleKeyDeletionResponse::getKeyState() const {
    return m_key_state;
}
void OAIScheduleKeyDeletionResponse::setKeyState(const OAIKeyState &key_state) {
    m_key_state = key_state;
    m_key_state_isSet = true;
}

bool OAIScheduleKeyDeletionResponse::is_key_state_Set() const{
    return m_key_state_isSet;
}

bool OAIScheduleKeyDeletionResponse::is_key_state_Valid() const{
    return m_key_state_isValid;
}

qint32 OAIScheduleKeyDeletionResponse::getPendingWindowInDays() const {
    return m_pending_window_in_days;
}
void OAIScheduleKeyDeletionResponse::setPendingWindowInDays(const qint32 &pending_window_in_days) {
    m_pending_window_in_days = pending_window_in_days;
    m_pending_window_in_days_isSet = true;
}

bool OAIScheduleKeyDeletionResponse::is_pending_window_in_days_Set() const{
    return m_pending_window_in_days_isSet;
}

bool OAIScheduleKeyDeletionResponse::is_pending_window_in_days_Valid() const{
    return m_pending_window_in_days_isValid;
}

bool OAIScheduleKeyDeletionResponse::isSet() const {
...
bool OAIScheduleKeyDeletionResponse::isValid() const {
