...
OAIWrappingKeySpec::OAIWrappingKeySpec(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWrappingKeySpec::OAIWrappingKeySpec() {
    this->initializeModel();
}

OAIWrappingKeySpec::~OAIWrappingKeySpec() {}

void OAIWrappingKeySpec::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIWrappingKeySpec::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIWrappingKeySpec::fromJson(QString jsonString) {
    
    if ( jsonString.compare("RSA_2048", Qt::CaseInsensitive) == 0) {
        m_value = eOAIWrappingKeySpec::_2048;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("RSA_3072", Qt::CaseInsensitive) == 0) {
        m_value = eOAIWrappingKeySpec::_3072;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("RSA_4096", Qt::CaseInsensitive) == 0) {
        m_value = eOAIWrappingKeySpec::_4096;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIWrappingKeySpec::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIWrappingKeySpec::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIWrappingKeySpec::_2048:
            val = "RSA_2048";
            break;
        case eOAIWrappingKeySpec::_3072:
            val = "RSA_3072";
            break;
        case eOAIWrappingKeySpec::_4096:
            val = "RSA_4096";
            break;
        default:
            break;
...
QJsonValue OAIWrappingKeySpec::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIWrappingKeySpec::eOAIWrappingKeySpec OAIWrappingKeySpec::getValue() const {
    return m_value;
}

void OAIWrappingKeySpec::setValue(const OAIWrappingKeySpec::eOAIWrappingKeySpec& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIWrappingKeySpec::isSet() const {
    
    return m_value_isSet;
}

bool OAIWrappingKeySpec::isValid() const {
