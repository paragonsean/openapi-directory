...
/*
 * OAIGetParametersForImportRequest.h
 *
 * 
 */

#ifndef OAIGetParametersForImportRequest_H
#define OAIGetParametersForImportRequest_H

#include <QJsonObject>

#include "OAIAlgorithmSpec.h"
#include "OAIWrappingKeySpec.h"
#include <QString>
...
class OAIGetParametersForImportRequest : public OAIObject {
public:
    OAIGetParametersForImportRequest();
    OAIGetParametersForImportRequest(QString json);
    ~OAIGetParametersForImportRequest() override;
    ...
    OAIAlgorithmSpec getWrappingAlgorithm() const;
    void setWrappingAlgorithm(const OAIAlgorithmSpec &wrapping_algorithm);
    bool is_wrapping_algorithm_Set() const;
    bool is_wrapping_algorithm_Valid() const;

    OAIWrappingKeySpec getWrappingKeySpec() const;
    void setWrappingKeySpec(const OAIWrappingKeySpec &wrapping_key_spec);
    bool is_wrapping_key_spec_Set() const;
    bool is_wrapping_key_spec_Valid() const;
...
private:
    ...
    OAIAlgorithmSpec m_wrapping_algorithm;
    bool m_wrapping_algorithm_isSet;
    bool m_wrapping_algorithm_isValid;

    OAIWrappingKeySpec m_wrapping_key_spec;
    bool m_wrapping_key_spec_isSet;
    bool m_wrapping_key_spec_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetParametersForImportRequest)

#endif // OAIGetParametersForImportRequest_H
