...
QList OAIListKeysResponse::getKeys() const {
    return m_keys;
}
void OAIListKeysResponse::setKeys(const QList &keys) {
    m_keys = keys;
    m_keys_isSet = true;
}

bool OAIListKeysResponse::is_keys_Set() const{
    return m_keys_isSet;
}

bool OAIListKeysResponse::is_keys_Valid() const{
    return m_keys_isValid;
}

QString OAIListKeysResponse::getNextMarker() const {
    return m_next_marker;
}
void OAIListKeysResponse::setNextMarker(const QString &next_marker) {
    m_next_marker = next_marker;
    m_next_marker_isSet = true;
}

bool OAIListKeysResponse::is_next_marker_Set() const{
    return m_next_marker_isSet;
}

bool OAIListKeysResponse::is_next_marker_Valid() const{
    return m_next_marker_isValid;
}

bool OAIListKeysResponse::getTruncated() const {
    return m_truncated;
}
void OAIListKeysResponse::setTruncated(const bool &truncated) {
    m_truncated = truncated;
    m_truncated_isSet = true;
}

bool OAIListKeysResponse::is_truncated_Set() const{
    return m_truncated_isSet;
}

bool OAIListKeysResponse::is_truncated_Valid() const{
