...
/*
 * OAIDescribeKeyRequest.h
 *
 * 
 */

#ifndef OAIDescribeKeyRequest_H
#define OAIDescribeKeyRequest_H
...
class OAIDescribeKeyRequest : public OAIObject {
public:
    OAIDescribeKeyRequest();
    OAIDescribeKeyRequest(QString json);
    ~OAIDescribeKeyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeKeyRequest)

#endif // OAIDescribeKeyRequest_H
