...
/*
 * OAIMultiRegionKeyType.h
 *
 * 
 */

#ifndef OAIMultiRegionKeyType_H
#define OAIMultiRegionKeyType_H
...
class OAIMultiRegionKeyType : public OAIEnum {
public:
    OAIMultiRegionKeyType();
    OAIMultiRegionKeyType(QString json);
    ~OAIMultiRegionKeyType() override;
    ...
    enum class eOAIMultiRegionKeyType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        PRIMARY, 
        REPLICA
    };
    OAIMultiRegionKeyType::eOAIMultiRegionKeyType getValue() const;
    void setValue(const OAIMultiRegionKeyType::eOAIMultiRegionKeyType& value);
...
private:
    ...
    eOAIMultiRegionKeyType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMultiRegionKeyType)

#endif // OAIMultiRegionKeyType_H
