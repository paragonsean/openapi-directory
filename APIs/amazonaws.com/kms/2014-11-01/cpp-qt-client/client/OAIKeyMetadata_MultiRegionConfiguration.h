...
/*
 * OAIKeyMetadata_MultiRegionConfiguration.h
 *
 * 
 */

#ifndef OAIKeyMetadata_MultiRegionConfiguration_H
#define OAIKeyMetadata_MultiRegionConfiguration_H
...
class OAIKeyMetadata_MultiRegionConfiguration : public OAIObject {
public:
    OAIKeyMetadata_MultiRegionConfiguration();
    OAIKeyMetadata_MultiRegionConfiguration(QString json);
    ~OAIKeyMetadata_MultiRegionConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKeyMetadata_MultiRegionConfiguration)

#endif // OAIKeyMetadata_MultiRegionConfiguration_H
