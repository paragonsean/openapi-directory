...
/*
 * OAIScheduleKeyDeletionRequest.h
 *
 * 
 */

#ifndef OAIScheduleKeyDeletionRequest_H
#define OAIScheduleKeyDeletionRequest_H
...
class OAIScheduleKeyDeletionRequest : public OAIObject {
public:
    OAIScheduleKeyDeletionRequest();
    OAIScheduleKeyDeletionRequest(QString json);
    ~OAIScheduleKeyDeletionRequest() override;
    ...
    qint32 getPendingWindowInDays() const;
    void setPendingWindowInDays(const qint32 &pending_window_in_days);
    bool is_pending_window_in_days_Set() const;
    bool is_pending_window_in_days_Valid() const;
...
private:
    ...
    qint32 m_pending_window_in_days;
    bool m_pending_window_in_days_isSet;
    bool m_pending_window_in_days_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIScheduleKeyDeletionRequest)

#endif // OAIScheduleKeyDeletionRequest_H
