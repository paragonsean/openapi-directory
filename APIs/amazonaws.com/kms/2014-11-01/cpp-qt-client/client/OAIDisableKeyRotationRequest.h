...
/*
 * OAIDisableKeyRotationRequest.h
 *
 * 
 */

#ifndef OAIDisableKeyRotationRequest_H
#define OAIDisableKeyRotationRequest_H
...
class OAIDisableKeyRotationRequest : public OAIObject {
public:
    OAIDisableKeyRotationRequest();
    OAIDisableKeyRotationRequest(QString json);
    ~OAIDisableKeyRotationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisableKeyRotationRequest)

#endif // OAIDisableKeyRotationRequest_H
