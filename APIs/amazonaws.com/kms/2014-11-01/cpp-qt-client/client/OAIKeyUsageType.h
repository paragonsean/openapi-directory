...
#ifndef OAIKeyUsageType_H
#define OAIKeyUsageType_H
...
class OAIKeyUsageType : public OAIEnum {
public:
    OAIKeyUsageType();
    OAIKeyUsageType(QString json);
    ~OAIKeyUsageType() override;
    ...
    enum class eOAIKeyUsageType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        SIGN_VERIFY, 
        ENCRYPT_DECRYPT, 
        GENERATE_VERIFY_MAC
    };
    OAIKeyUsageType::eOAIKeyUsageType getValue() const;
    void setValue(const OAIKeyUsageType::eOAIKeyUsageType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIKeyUsageType)

#endif // OAIKeyUsageType_H
