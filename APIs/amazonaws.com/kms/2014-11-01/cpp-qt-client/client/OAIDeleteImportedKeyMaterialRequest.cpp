...
OAIDeleteImportedKeyMaterialRequest::OAIDeleteImportedKeyMaterialRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteImportedKeyMaterialRequest::OAIDeleteImportedKeyMaterialRequest() {
    this->initializeModel();
}

OAIDeleteImportedKeyMaterialRequest::~OAIDeleteImportedKeyMaterialRequest() {}

void OAIDeleteImportedKeyMaterialRequest::initializeModel() {

    m_key_id_isSet = false;
    m_key_id_isValid = false;
}

void OAIDeleteImportedKeyMaterialRequest::fromJson(QString jsonString) {
...
void OAIDeleteImportedKeyMaterialRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteImportedKeyMaterialRequest::asJson() const {
...
QJsonObject OAIDeleteImportedKeyMaterialRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAIDeleteImportedKeyMaterialRequest::getKeyId() const {
    return m_key_id;
}
void OAIDeleteImportedKeyMaterialRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIDeleteImportedKeyMaterialRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIDeleteImportedKeyMaterialRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

bool OAIDeleteImportedKeyMaterialRequest::isSet() const {
...
bool OAIDeleteImportedKeyMaterialRequest::isValid() const {
