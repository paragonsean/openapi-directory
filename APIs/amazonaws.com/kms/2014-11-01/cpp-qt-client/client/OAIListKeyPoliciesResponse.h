...
/*
 * OAIListKeyPoliciesResponse.h
 *
 * 
 */

#ifndef OAIListKeyPoliciesResponse_H
#define OAIListKeyPoliciesResponse_H
...
class OAIListKeyPoliciesResponse : public OAIObject {
public:
    OAIListKeyPoliciesResponse();
    OAIListKeyPoliciesResponse(QString json);
    ~OAIListKeyPoliciesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListKeyPoliciesResponse)

#endif // OAIListKeyPoliciesResponse_H
