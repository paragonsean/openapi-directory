...
/*
 * OAIDescribeCustomKeyStoresRequest.h
 *
 * 
 */

#ifndef OAIDescribeCustomKeyStoresRequest_H
#define OAIDescribeCustomKeyStoresRequest_H
...
class OAIDescribeCustomKeyStoresRequest : public OAIObject {
public:
    OAIDescribeCustomKeyStoresRequest();
    OAIDescribeCustomKeyStoresRequest(QString json);
    ~OAIDescribeCustomKeyStoresRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCustomKeyStoresRequest)

#endif // OAIDescribeCustomKeyStoresRequest_H
