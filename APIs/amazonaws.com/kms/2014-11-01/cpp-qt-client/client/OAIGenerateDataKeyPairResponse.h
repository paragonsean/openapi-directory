...
/*
 * OAIGenerateDataKeyPairResponse.h
 *
 * 
 */

#ifndef OAIGenerateDataKeyPairResponse_H
#define OAIGenerateDataKeyPairResponse_H
...
class OAIGenerateDataKeyPairResponse : public OAIObject {
public:
    OAIGenerateDataKeyPairResponse();
    OAIGenerateDataKeyPairResponse(QString json);
    ~OAIGenerateDataKeyPairResponse() override;
    ...
    QString getPrivateKeyPlaintext() const;
    void setPrivateKeyPlaintext(const QString &private_key_plaintext);
    bool is_private_key_plaintext_Set() const;
    bool is_private_key_plaintext_Valid() const;
...
private:
    ...
    QString m_private_key_plaintext;
    bool m_private_key_plaintext_isSet;
    bool m_private_key_plaintext_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGenerateDataKeyPairResponse)

#endif // OAIGenerateDataKeyPairResponse_H
