...
OAIEnableKeyRequest::OAIEnableKeyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEnableKeyRequest::OAIEnableKeyRequest() {
    this->initializeModel();
}

OAIEnableKeyRequest::~OAIEnableKeyRequest() {}

void OAIEnableKeyRequest::initializeModel() {

    m_key_id_isSet = false;
    m_key_id_isValid = false;
}

void OAIEnableKeyRequest::fromJson(QString jsonString) {
...
void OAIEnableKeyRequest::fromJsonObject(QJsonObject json) {
...
QString OAIEnableKeyRequest::asJson() const {
...
QJsonObject OAIEnableKeyRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAIEnableKeyRequest::getKeyId() const {
    return m_key_id;
}
void OAIEnableKeyRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIEnableKeyRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIEnableKeyRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

bool OAIEnableKeyRequest::isSet() const {
...
bool OAIEnableKeyRequest::isValid() const {
