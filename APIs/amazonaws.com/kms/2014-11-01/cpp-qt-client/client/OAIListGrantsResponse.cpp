...
OAIListGrantsResponse::OAIListGrantsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListGrantsResponse::OAIListGrantsResponse() {
    this->initializeModel();
}

OAIListGrantsResponse::~OAIListGrantsResponse() {}

void OAIListGrantsResponse::initializeModel() {
...
void OAIListGrantsResponse::fromJson(QString jsonString) {
...
void OAIListGrantsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListGrantsResponse::asJson() const {
...
QJsonObject OAIListGrantsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_grants.isSet()) {
...
QList OAIListGrantsResponse::getGrants() const {
    return m_grants;
}
void OAIListGrantsResponse::setGrants(const QList &grants) {
    m_grants = grants;
    m_grants_isSet = true;
}

bool OAIListGrantsResponse::is_grants_Set() const{
    return m_grants_isSet;
}

bool OAIListGrantsResponse::is_grants_Valid() const{
    return m_grants_isValid;
}

QString OAIListGrantsResponse::getNextMarker() const {
    return m_next_marker;
}
void OAIListGrantsResponse::setNextMarker(const QString &next_marker) {
    m_next_marker = next_marker;
    m_next_marker_isSet = true;
}

bool OAIListGrantsResponse::is_next_marker_Set() const{
    return m_next_marker_isSet;
}

bool OAIListGrantsResponse::is_next_marker_Valid() const{
    return m_next_marker_isValid;
}

bool OAIListGrantsResponse::getTruncated() const {
    return m_truncated;
}
void OAIListGrantsResponse::setTruncated(const bool &truncated) {
    m_truncated = truncated;
    m_truncated_isSet = true;
}

bool OAIListGrantsResponse::is_truncated_Set() const{
    return m_truncated_isSet;
}

bool OAIListGrantsResponse::is_truncated_Valid() const{
    return m_truncated_isValid;
}

bool OAIListGrantsResponse::isSet() const {
...
bool OAIListGrantsResponse::isValid() const {
