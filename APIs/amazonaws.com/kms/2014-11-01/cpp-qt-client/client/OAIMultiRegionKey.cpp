...
OAIMultiRegionKey::OAIMultiRegionKey(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMultiRegionKey::OAIMultiRegionKey() {
    this->initializeModel();
}

OAIMultiRegionKey::~OAIMultiRegionKey() {}

void OAIMultiRegionKey::initializeModel() {
...
void OAIMultiRegionKey::fromJson(QString jsonString) {
...
void OAIMultiRegionKey::fromJsonObject(QJsonObject json) {
...
QString OAIMultiRegionKey::asJson() const {
...
QJsonObject OAIMultiRegionKey::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIMultiRegionKey::getArn() const {
    return m_arn;
}
void OAIMultiRegionKey::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIMultiRegionKey::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIMultiRegionKey::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIMultiRegionKey::getRegion() const {
    return m_region;
}
void OAIMultiRegionKey::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIMultiRegionKey::is_region_Set() const{
    return m_region_isSet;
}

bool OAIMultiRegionKey::is_region_Valid() const{
    return m_region_isValid;
}

bool OAIMultiRegionKey::isSet() const {
...
bool OAIMultiRegionKey::isValid() const {
