...
/*
 * OAIVerifyMacRequest.h
 *
 * 
 */

#ifndef OAIVerifyMacRequest_H
#define OAIVerifyMacRequest_H
...
class OAIVerifyMacRequest : public OAIObject {
public:
    OAIVerifyMacRequest();
    OAIVerifyMacRequest(QString json);
    ~OAIVerifyMacRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVerifyMacRequest)

#endif // OAIVerifyMacRequest_H
