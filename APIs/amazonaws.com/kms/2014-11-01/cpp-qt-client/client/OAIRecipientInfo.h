...
#ifndef OAIRecipientInfo_H
#define OAIRecipientInfo_H
...
class OAIRecipientInfo : public OAIObject {
public:
    OAIRecipientInfo();
    OAIRecipientInfo(QString json);
    ~OAIRecipientInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRecipientInfo)

#endif // OAIRecipientInfo_H
