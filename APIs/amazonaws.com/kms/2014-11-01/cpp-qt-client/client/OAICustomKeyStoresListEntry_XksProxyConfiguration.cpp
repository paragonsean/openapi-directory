...
OAICustomKeyStoresListEntry_XksProxyConfiguration::OAICustomKeyStoresListEntry_XksProxyConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICustomKeyStoresListEntry_XksProxyConfiguration::OAICustomKeyStoresListEntry_XksProxyConfiguration() {
    this->initializeModel();
}

OAICustomKeyStoresListEntry_XksProxyConfiguration::~OAICustomKeyStoresListEntry_XksProxyConfiguration() {}

void OAICustomKeyStoresListEntry_XksProxyConfiguration::initializeModel() {
...
void OAICustomKeyStoresListEntry_XksProxyConfiguration::fromJson(QString jsonString) {
...
void OAICustomKeyStoresListEntry_XksProxyConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAICustomKeyStoresListEntry_XksProxyConfiguration::asJson() const {
...
QJsonObject OAICustomKeyStoresListEntry_XksProxyConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAIXksProxyConnectivityType OAICustomKeyStoresListEntry_XksProxyConfiguration::getConnectivity() const {
    return m_connectivity;
}
void OAICustomKeyStoresListEntry_XksProxyConfiguration::setConnectivity(const OAIXksProxyConnectivityType &connectivity) {
    m_connectivity = connectivity;
    m_connectivity_isSet = true;
}

bool OAICustomKeyStoresListEntry_XksProxyConfiguration::is_connectivity_Set() const{
    return m_connectivity_isSet;
}

bool OAICustomKeyStoresListEntry_XksProxyConfiguration::is_connectivity_Valid() const{
    return m_connectivity_isValid;
}

QString OAICustomKeyStoresListEntry_XksProxyConfiguration::getAccessKeyId() const {
    return m_access_key_id;
}
void OAICustomKeyStoresListEntry_XksProxyConfiguration::setAccessKeyId(const QString &access_key_id) {
    m_access_key_id = access_key_id;
    m_access_key_id_isSet = true;
}

bool OAICustomKeyStoresListEntry_XksProxyConfiguration::is_access_key_id_Set() const{
    return m_access_key_id_isSet;
}

bool OAICustomKeyStoresListEntry_XksProxyConfiguration::is_access_key_id_Valid() const{
    return m_access_key_id_isValid;
}

QString OAICustomKeyStoresListEntry_XksProxyConfiguration::getUriEndpoint() const {
    return m_uri_endpoint;
}
void OAICustomKeyStoresListEntry_XksProxyConfiguration::setUriEndpoint(const QString &uri_endpoint) {
    m_uri_endpoint = uri_endpoint;
    m_uri_endpoint_isSet = true;
}

bool OAICustomKeyStoresListEntry_XksProxyConfiguration::is_uri_endpoint_Set() const{
    return m_uri_endpoint_isSet;
}

bool OAICustomKeyStoresListEntry_XksProxyConfiguration::is_uri_endpoint_Valid() const{
    return m_uri_endpoint_isValid;
}

QString OAICustomKeyStoresListEntry_XksProxyConfiguration::getUriPath() const {
    return m_uri_path;
}
void OAICustomKeyStoresListEntry_XksProxyConfiguration::setUriPath(const QString &uri_path) {
    m_uri_path = uri_path;
    m_uri_path_isSet = true;
}

bool OAICustomKeyStoresListEntry_XksProxyConfiguration::is_uri_path_Set() const{
    return m_uri_path_isSet;
}

bool OAICustomKeyStoresListEntry_XksProxyConfiguration::is_uri_path_Valid() const{
    return m_uri_path_isValid;
}

QString OAICustomKeyStoresListEntry_XksProxyConfiguration::getVpcEndpointServiceName() const {
    return m_vpc_endpoint_service_name;
}
void OAICustomKeyStoresListEntry_XksProxyConfiguration::setVpcEndpointServiceName(const QString &vpc_endpoint_service_name) {
    m_vpc_endpoint_service_name = vpc_endpoint_service_name;
    m_vpc_endpoint_service_name_isSet = true;
}

bool OAICustomKeyStoresListEntry_XksProxyConfiguration::is_vpc_endpoint_service_name_Set() const{
    return m_vpc_endpoint_service_name_isSet;
}

bool OAICustomKeyStoresListEntry_XksProxyConfiguration::is_vpc_endpoint_service_name_Valid() const{
    return m_vpc_endpoint_service_name_isValid;
}

bool OAICustomKeyStoresListEntry_XksProxyConfiguration::isSet() const {
...
bool OAICustomKeyStoresListEntry_XksProxyConfiguration::isValid() const {
