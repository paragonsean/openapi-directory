...
/*
 * OAIGetKeyRotationStatusRequest.h
 *
 * 
 */

#ifndef OAIGetKeyRotationStatusRequest_H
#define OAIGetKeyRotationStatusRequest_H
...
class OAIGetKeyRotationStatusRequest : public OAIObject {
public:
    OAIGetKeyRotationStatusRequest();
    OAIGetKeyRotationStatusRequest(QString json);
    ~OAIGetKeyRotationStatusRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetKeyRotationStatusRequest)

#endif // OAIGetKeyRotationStatusRequest_H
