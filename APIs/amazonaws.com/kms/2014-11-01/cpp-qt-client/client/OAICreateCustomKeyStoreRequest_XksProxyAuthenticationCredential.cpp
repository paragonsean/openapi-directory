...
#include "OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential.h"
...
OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential::OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential::OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential() {
    this->initializeModel();
}

OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential::~OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential() {}

void OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential::initializeModel() {
...
void OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential::fromJson(QString jsonString) {
...
void OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential::fromJsonObject(QJsonObject json) {
...
QString OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential::asJson() const {
...
QJsonObject OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential::getAccessKeyId() const {
    return m_access_key_id;
}
void OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential::setAccessKeyId(const QString &access_key_id) {
    m_access_key_id = access_key_id;
    m_access_key_id_isSet = true;
}

bool OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential::is_access_key_id_Set() const{
    return m_access_key_id_isSet;
}

bool OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential::is_access_key_id_Valid() const{
    return m_access_key_id_isValid;
}

QString OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential::getRawSecretAccessKey() const {
    return m_raw_secret_access_key;
}
void OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential::setRawSecretAccessKey(const QString &raw_secret_access_key) {
    m_raw_secret_access_key = raw_secret_access_key;
    m_raw_secret_access_key_isSet = true;
}

bool OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential::is_raw_secret_access_key_Set() const{
    return m_raw_secret_access_key_isSet;
}

bool OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential::is_raw_secret_access_key_Valid() const{
    return m_raw_secret_access_key_isValid;
}

bool OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential::isSet() const {
...
bool OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential::isValid() const {
