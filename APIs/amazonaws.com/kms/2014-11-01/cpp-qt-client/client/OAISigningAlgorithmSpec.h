...
/*
 * OAISigningAlgorithmSpec.h
 *
 * 
 */

#ifndef OAISigningAlgorithmSpec_H
#define OAISigningAlgorithmSpec_H
...
class OAISigningAlgorithmSpec : public OAIEnum {
public:
    OAISigningAlgorithmSpec();
    OAISigningAlgorithmSpec(QString json);
    ~OAISigningAlgorithmSpec() override;
    ...
    enum class eOAISigningAlgorithmSpec {
    ...
    OAISigningAlgorithmSpec::eOAISigningAlgorithmSpec getValue() const;
    void setValue(const OAISigningAlgorithmSpec::eOAISigningAlgorithmSpec& value);
...
private:
    ...
    eOAISigningAlgorithmSpec m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAISigningAlgorithmSpec)

#endif // OAISigningAlgorithmSpec_H
