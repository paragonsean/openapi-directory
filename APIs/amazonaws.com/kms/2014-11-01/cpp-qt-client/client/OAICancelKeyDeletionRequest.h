...
/*
 * OAICancelKeyDeletionRequest.h
 *
 * 
 */

#ifndef OAICancelKeyDeletionRequest_H
#define OAICancelKeyDeletionRequest_H
...
class OAICancelKeyDeletionRequest : public OAIObject {
public:
    OAICancelKeyDeletionRequest();
    OAICancelKeyDeletionRequest(QString json);
    ~OAICancelKeyDeletionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICancelKeyDeletionRequest)

#endif // OAICancelKeyDeletionRequest_H
