...
/*
 * OAIGenerateMacResponse.h
 *
 * 
 */

#ifndef OAIGenerateMacResponse_H
#define OAIGenerateMacResponse_H
...
class OAIGenerateMacResponse : public OAIObject {
public:
    OAIGenerateMacResponse();
    OAIGenerateMacResponse(QString json);
    ~OAIGenerateMacResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGenerateMacResponse)

#endif // OAIGenerateMacResponse_H
