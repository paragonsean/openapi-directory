...
/*
 * OAIXksProxyConnectivityType.h
 *
 * 
 */

#ifndef OAIXksProxyConnectivityType_H
#define OAIXksProxyConnectivityType_H
...
class OAIXksProxyConnectivityType : public OAIEnum {
public:
    OAIXksProxyConnectivityType();
    OAIXksProxyConnectivityType(QString json);
    ~OAIXksProxyConnectivityType() override;
    ...
    enum class eOAIXksProxyConnectivityType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        PUBLIC_ENDPOINT, 
        VPC_ENDPOINT_SERVICE
    };
    OAIXksProxyConnectivityType::eOAIXksProxyConnectivityType getValue() const;
    void setValue(const OAIXksProxyConnectivityType::eOAIXksProxyConnectivityType& value);
...
private:
    ...
    eOAIXksProxyConnectivityType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIXksProxyConnectivityType)

#endif // OAIXksProxyConnectivityType_H
