...
/*
 * OAIDeleteImportedKeyMaterialRequest.h
 *
 * 
 */

#ifndef OAIDeleteImportedKeyMaterialRequest_H
#define OAIDeleteImportedKeyMaterialRequest_H
...
class OAIDeleteImportedKeyMaterialRequest : public OAIObject {
public:
    OAIDeleteImportedKeyMaterialRequest();
    OAIDeleteImportedKeyMaterialRequest(QString json);
    ~OAIDeleteImportedKeyMaterialRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteImportedKeyMaterialRequest)

#endif // OAIDeleteImportedKeyMaterialRequest_H
