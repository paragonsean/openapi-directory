...
#ifndef OAIKeyManagerType_H
#define OAIKeyManagerType_H
...
class OAIKeyManagerType : public OAIEnum {
public:
    OAIKeyManagerType();
    OAIKeyManagerType(QString json);
    ~OAIKeyManagerType() override;
    ...
    enum class eOAIKeyManagerType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        AWS, 
        CUSTOMER
    };
    OAIKeyManagerType::eOAIKeyManagerType getValue() const;
    void setValue(const OAIKeyManagerType::eOAIKeyManagerType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIKeyManagerType)

#endif // OAIKeyManagerType_H
