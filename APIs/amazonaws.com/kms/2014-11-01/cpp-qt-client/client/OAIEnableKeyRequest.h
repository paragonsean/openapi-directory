...
/*
 * OAIEnableKeyRequest.h
 *
 * 
 */

#ifndef OAIEnableKeyRequest_H
#define OAIEnableKeyRequest_H
...
class OAIEnableKeyRequest : public OAIObject {
public:
    OAIEnableKeyRequest();
    OAIEnableKeyRequest(QString json);
    ~OAIEnableKeyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnableKeyRequest)

#endif // OAIEnableKeyRequest_H
