...
/*
 * OAIConnectCustomKeyStoreRequest.h
 *
 * 
 */

#ifndef OAIConnectCustomKeyStoreRequest_H
#define OAIConnectCustomKeyStoreRequest_H
...
class OAIConnectCustomKeyStoreRequest : public OAIObject {
public:
    OAIConnectCustomKeyStoreRequest();
    OAIConnectCustomKeyStoreRequest(QString json);
    ~OAIConnectCustomKeyStoreRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnectCustomKeyStoreRequest)

#endif // OAIConnectCustomKeyStoreRequest_H
