...
#include "OAIGenerateRandomRequest_Recipient.h"
...
OAIGenerateRandomRequest_Recipient::OAIGenerateRandomRequest_Recipient(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGenerateRandomRequest_Recipient::OAIGenerateRandomRequest_Recipient() {
    this->initializeModel();
}

OAIGenerateRandomRequest_Recipient::~OAIGenerateRandomRequest_Recipient() {}

void OAIGenerateRandomRequest_Recipient::initializeModel() {
...
void OAIGenerateRandomRequest_Recipient::fromJson(QString jsonString) {
...
void OAIGenerateRandomRequest_Recipient::fromJsonObject(QJsonObject json) {
...
QString OAIGenerateRandomRequest_Recipient::asJson() const {
...
QJsonObject OAIGenerateRandomRequest_Recipient::asJsonObject() const {
    QJsonObject obj;
...
OAIKeyEncryptionMechanism OAIGenerateRandomRequest_Recipient::getKeyEncryptionAlgorithm() const {
    return m_key_encryption_algorithm;
}
void OAIGenerateRandomRequest_Recipient::setKeyEncryptionAlgorithm(const OAIKeyEncryptionMechanism &key_encryption_algorithm) {
    m_key_encryption_algorithm = key_encryption_algorithm;
    m_key_encryption_algorithm_isSet = true;
}

bool OAIGenerateRandomRequest_Recipient::is_key_encryption_algorithm_Set() const{
    return m_key_encryption_algorithm_isSet;
}

bool OAIGenerateRandomRequest_Recipient::is_key_encryption_algorithm_Valid() const{
    return m_key_encryption_algorithm_isValid;
}

QString OAIGenerateRandomRequest_Recipient::getAttestationDocument() const {
    return m_attestation_document;
}
void OAIGenerateRandomRequest_Recipient::setAttestationDocument(const QString &attestation_document) {
    m_attestation_document = attestation_document;
    m_attestation_document_isSet = true;
}

bool OAIGenerateRandomRequest_Recipient::is_attestation_document_Set() const{
    return m_attestation_document_isSet;
}

bool OAIGenerateRandomRequest_Recipient::is_attestation_document_Valid() const{
    return m_attestation_document_isValid;
}

bool OAIGenerateRandomRequest_Recipient::isSet() const {
...
bool OAIGenerateRandomRequest_Recipient::isValid() const {
