...
OAIGenerateDataKeyWithoutPlaintextRequest::OAIGenerateDataKeyWithoutPlaintextRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGenerateDataKeyWithoutPlaintextRequest::OAIGenerateDataKeyWithoutPlaintextRequest() {
    this->initializeModel();
}

OAIGenerateDataKeyWithoutPlaintextRequest::~OAIGenerateDataKeyWithoutPlaintextRequest() {}

void OAIGenerateDataKeyWithoutPlaintextRequest::initializeModel() {
...
void OAIGenerateDataKeyWithoutPlaintextRequest::fromJson(QString jsonString) {
...
void OAIGenerateDataKeyWithoutPlaintextRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGenerateDataKeyWithoutPlaintextRequest::asJson() const {
...
QJsonObject OAIGenerateDataKeyWithoutPlaintextRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAIGenerateDataKeyWithoutPlaintextRequest::getKeyId() const {
    return m_key_id;
}
void OAIGenerateDataKeyWithoutPlaintextRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIGenerateDataKeyWithoutPlaintextRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIGenerateDataKeyWithoutPlaintextRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

QMap OAIGenerateDataKeyWithoutPlaintextRequest::getEncryptionContext() const {
    return m_encryption_context;
}
void OAIGenerateDataKeyWithoutPlaintextRequest::setEncryptionContext(const QMap &encryption_context) {
    m_encryption_context = encryption_context;
    m_encryption_context_isSet = true;
}

bool OAIGenerateDataKeyWithoutPlaintextRequest::is_encryption_context_Set() const{
    return m_encryption_context_isSet;
}

bool OAIGenerateDataKeyWithoutPlaintextRequest::is_encryption_context_Valid() const{
    return m_encryption_context_isValid;
}

OAIDataKeySpec OAIGenerateDataKeyWithoutPlaintextRequest::getKeySpec() const {
    return m_key_spec;
}
void OAIGenerateDataKeyWithoutPlaintextRequest::setKeySpec(const OAIDataKeySpec &key_spec) {
    m_key_spec = key_spec;
    m_key_spec_isSet = true;
}

bool OAIGenerateDataKeyWithoutPlaintextRequest::is_key_spec_Set() const{
    return m_key_spec_isSet;
}

bool OAIGenerateDataKeyWithoutPlaintextRequest::is_key_spec_Valid() const{
    return m_key_spec_isValid;
}

qint32 OAIGenerateDataKeyWithoutPlaintextRequest::getNumberOfBytes() const {
    return m_number_of_bytes;
}
void OAIGenerateDataKeyWithoutPlaintextRequest::setNumberOfBytes(const qint32 &number_of_bytes) {
    m_number_of_bytes = number_of_bytes;
    m_number_of_bytes_isSet = true;
}

bool OAIGenerateDataKeyWithoutPlaintextRequest::is_number_of_bytes_Set() const{
    return m_number_of_bytes_isSet;
}

bool OAIGenerateDataKeyWithoutPlaintextRequest::is_number_of_bytes_Valid() const{
    return m_number_of_bytes_isValid;
}

QList OAIGenerateDataKeyWithoutPlaintextRequest::getGrantTokens() const {
    return m_grant_tokens;
}
void OAIGenerateDataKeyWithoutPlaintextRequest::setGrantTokens(const QList &grant_tokens) {
    m_grant_tokens = grant_tokens;
    m_grant_tokens_isSet = true;
}

bool OAIGenerateDataKeyWithoutPlaintextRequest::is_grant_tokens_Set() const{
    return m_grant_tokens_isSet;
}

bool OAIGenerateDataKeyWithoutPlaintextRequest::is_grant_tokens_Valid() const{
    return m_grant_tokens_isValid;
}

bool OAIGenerateDataKeyWithoutPlaintextRequest::getDryRun() const {
    return m_dry_run;
}
void OAIGenerateDataKeyWithoutPlaintextRequest::setDryRun(const bool &dry_run) {
    m_dry_run = dry_run;
    m_dry_run_isSet = true;
}

bool OAIGenerateDataKeyWithoutPlaintextRequest::is_dry_run_Set() const{
    return m_dry_run_isSet;
}

bool OAIGenerateDataKeyWithoutPlaintextRequest::is_dry_run_Valid() const{
    return m_dry_run_isValid;
}

bool OAIGenerateDataKeyWithoutPlaintextRequest::isSet() const {
...
bool OAIGenerateDataKeyWithoutPlaintextRequest::isValid() const {
