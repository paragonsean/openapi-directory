...
OAIKeyState::OAIKeyState(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIKeyState::OAIKeyState() {
    this->initializeModel();
}

OAIKeyState::~OAIKeyState() {}

void OAIKeyState::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIKeyState::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIKeyState::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Creating", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKeyState::CREATING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Enabled", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKeyState::ENABLED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Disabled", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKeyState::DISABLED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("PendingDeletion", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKeyState::PENDINGDELETION;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("PendingImport", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKeyState::PENDINGIMPORT;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("PendingReplicaDeletion", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKeyState::PENDINGREPLICADELETION;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Unavailable", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKeyState::UNAVAILABLE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Updating", Qt::CaseInsensitive) == 0) {
        m_value = eOAIKeyState::UPDATING;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIKeyState::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIKeyState::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIKeyState::CREATING:
            val = "Creating";
            break;
        case eOAIKeyState::ENABLED:
            val = "Enabled";
            break;
        case eOAIKeyState::DISABLED:
            val = "Disabled";
            break;
        case eOAIKeyState::PENDINGDELETION:
            val = "PendingDeletion";
            break;
        case eOAIKeyState::PENDINGIMPORT:
            val = "PendingImport";
            break;
        case eOAIKeyState::PENDINGREPLICADELETION:
            val = "PendingReplicaDeletion";
            break;
        case eOAIKeyState::UNAVAILABLE:
            val = "Unavailable";
            break;
        case eOAIKeyState::UPDATING:
            val = "Updating";
            break;
        default:
            break;
...
QJsonValue OAIKeyState::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIKeyState::eOAIKeyState OAIKeyState::getValue() const {
    return m_value;
}

void OAIKeyState::setValue(const OAIKeyState::eOAIKeyState& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIKeyState::isSet() const {
    
    return m_value_isSet;
}

bool OAIKeyState::isValid() const {
