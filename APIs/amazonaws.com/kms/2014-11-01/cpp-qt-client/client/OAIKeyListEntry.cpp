...
OAIKeyListEntry::OAIKeyListEntry(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIKeyListEntry::OAIKeyListEntry() {
    this->initializeModel();
}

OAIKeyListEntry::~OAIKeyListEntry() {}

void OAIKeyListEntry::initializeModel() {
...
void OAIKeyListEntry::fromJson(QString jsonString) {
...
void OAIKeyListEntry::fromJsonObject(QJsonObject json) {
...
QString OAIKeyListEntry::asJson() const {
...
QJsonObject OAIKeyListEntry::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAIKeyListEntry::getKeyId() const {
    return m_key_id;
}
void OAIKeyListEntry::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIKeyListEntry::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIKeyListEntry::is_key_id_Valid() const{
    return m_key_id_isValid;
}

QString OAIKeyListEntry::getKeyArn() const {
    return m_key_arn;
}
void OAIKeyListEntry::setKeyArn(const QString &key_arn) {
    m_key_arn = key_arn;
    m_key_arn_isSet = true;
}

bool OAIKeyListEntry::is_key_arn_Set() const{
    return m_key_arn_isSet;
}

bool OAIKeyListEntry::is_key_arn_Valid() const{
    return m_key_arn_isValid;
}

bool OAIKeyListEntry::isSet() const {
...
bool OAIKeyListEntry::isValid() const {
