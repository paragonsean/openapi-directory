...
class OAIKeySpec : public OAIEnum {
public:
    OAIKeySpec();
    OAIKeySpec(QString json);
    ~OAIKeySpec() override;
    ...
    OAIKeySpec::eOAIKeySpec getValue() const;
    void setValue(const OAIKeySpec::eOAIKeySpec& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIKeySpec)
