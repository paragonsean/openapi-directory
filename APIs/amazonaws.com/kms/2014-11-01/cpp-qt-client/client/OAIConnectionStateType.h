...
/*
 * OAIConnectionStateType.h
 *
 * 
 */

#ifndef OAIConnectionStateType_H
#define OAIConnectionStateType_H
...
class OAIConnectionStateType : public OAIEnum {
public:
    OAIConnectionStateType();
    OAIConnectionStateType(QString json);
    ~OAIConnectionStateType() override;
    ...
    enum class eOAIConnectionStateType {
    ...
    OAIConnectionStateType::eOAIConnectionStateType getValue() const;
    void setValue(const OAIConnectionStateType::eOAIConnectionStateType& value);
...
private:
    ...
    eOAIConnectionStateType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnectionStateType)

#endif // OAIConnectionStateType_H
