...
OAIGenerateRandomResponse::OAIGenerateRandomResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGenerateRandomResponse::OAIGenerateRandomResponse() {
    this->initializeModel();
}

OAIGenerateRandomResponse::~OAIGenerateRandomResponse() {}

void OAIGenerateRandomResponse::initializeModel() {
...
void OAIGenerateRandomResponse::fromJson(QString jsonString) {
...
void OAIGenerateRandomResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGenerateRandomResponse::asJson() const {
...
QJsonObject OAIGenerateRandomResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGenerateRandomResponse::getPlaintext() const {
    return m_plaintext;
}
void OAIGenerateRandomResponse::setPlaintext(const QString &plaintext) {
    m_plaintext = plaintext;
    m_plaintext_isSet = true;
}

bool OAIGenerateRandomResponse::is_plaintext_Set() const{
    return m_plaintext_isSet;
}

bool OAIGenerateRandomResponse::is_plaintext_Valid() const{
    return m_plaintext_isValid;
}

QString OAIGenerateRandomResponse::getCiphertextForRecipient() const {
    return m_ciphertext_for_recipient;
}
void OAIGenerateRandomResponse::setCiphertextForRecipient(const QString &ciphertext_for_recipient) {
    m_ciphertext_for_recipient = ciphertext_for_recipient;
    m_ciphertext_for_recipient_isSet = true;
}

bool OAIGenerateRandomResponse::is_ciphertext_for_recipient_Set() const{
    return m_ciphertext_for_recipient_isSet;
}

bool OAIGenerateRandomResponse::is_ciphertext_for_recipient_Valid() const{
    return m_ciphertext_for_recipient_isValid;
}

bool OAIGenerateRandomResponse::isSet() const {
...
bool OAIGenerateRandomResponse::isValid() const {
