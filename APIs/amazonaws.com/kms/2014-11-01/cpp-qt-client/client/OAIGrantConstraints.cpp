...
OAIGrantConstraints::OAIGrantConstraints(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGrantConstraints::OAIGrantConstraints() {
    this->initializeModel();
}

OAIGrantConstraints::~OAIGrantConstraints() {}

void OAIGrantConstraints::initializeModel() {
...
void OAIGrantConstraints::fromJson(QString jsonString) {
...
void OAIGrantConstraints::fromJsonObject(QJsonObject json) {
...
QString OAIGrantConstraints::asJson() const {
...
QJsonObject OAIGrantConstraints::asJsonObject() const {
    QJsonObject obj;
...
QMap OAIGrantConstraints::getEncryptionContextSubset() const {
    return m_encryption_context_subset;
}
void OAIGrantConstraints::setEncryptionContextSubset(const QMap &encryption_context_subset) {
    m_encryption_context_subset = encryption_context_subset;
    m_encryption_context_subset_isSet = true;
}

bool OAIGrantConstraints::is_encryption_context_subset_Set() const{
    return m_encryption_context_subset_isSet;
}

bool OAIGrantConstraints::is_encryption_context_subset_Valid() const{
    return m_encryption_context_subset_isValid;
}

QMap OAIGrantConstraints::getEncryptionContextEquals() const {
    return m_encryption_context_equals;
}
void OAIGrantConstraints::setEncryptionContextEquals(const QMap &encryption_context_equals) {
    m_encryption_context_equals = encryption_context_equals;
    m_encryption_context_equals_isSet = true;
}

bool OAIGrantConstraints::is_encryption_context_equals_Set() const{
    return m_encryption_context_equals_isSet;
}

bool OAIGrantConstraints::is_encryption_context_equals_Valid() const{
    return m_encryption_context_equals_isValid;
}

bool OAIGrantConstraints::isSet() const {
...
bool OAIGrantConstraints::isValid() const {
