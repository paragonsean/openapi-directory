...
/*
 * OAIDeleteAliasRequest.h
 *
 * 
 */

#ifndef OAIDeleteAliasRequest_H
#define OAIDeleteAliasRequest_H
...
class OAIDeleteAliasRequest : public OAIObject {
public:
    OAIDeleteAliasRequest();
    OAIDeleteAliasRequest(QString json);
    ~OAIDeleteAliasRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteAliasRequest)

#endif // OAIDeleteAliasRequest_H
