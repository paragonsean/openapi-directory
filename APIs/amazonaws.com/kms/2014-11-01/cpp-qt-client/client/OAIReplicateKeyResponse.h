...
/*
 * OAIReplicateKeyResponse.h
 *
 * 
 */

#ifndef OAIReplicateKeyResponse_H
#define OAIReplicateKeyResponse_H
...
namespace OpenAPI {
class OAIReplicateKeyResponse_ReplicaKeyMetadata;

class OAIReplicateKeyResponse : public OAIObject {
public:
    OAIReplicateKeyResponse();
    OAIReplicateKeyResponse(QString json);
    ~OAIReplicateKeyResponse() override;
    ...
    OAIReplicateKeyResponse_ReplicaKeyMetadata getReplicaKeyMetadata() const;
    void setReplicaKeyMetadata(const OAIReplicateKeyResponse_ReplicaKeyMetadata &replica_key_metadata);
    bool is_replica_key_metadata_Set() const;
    bool is_replica_key_metadata_Valid() const;

    QString getReplicaPolicy() const;
    void setReplicaPolicy(const QString &replica_policy);
    bool is_replica_policy_Set() const;
    bool is_replica_policy_Valid() const;

    QList getReplicaTags() const;
    void setReplicaTags(const QList &replica_tags);
    bool is_replica_tags_Set() const;
    bool is_replica_tags_Valid() const;
...
private:
    ...
    OAIReplicateKeyResponse_ReplicaKeyMetadata m_replica_key_metadata;
    bool m_replica_key_metadata_isSet;
    bool m_replica_key_metadata_isValid;

    QString m_replica_policy;
    bool m_replica_policy_isSet;
    bool m_replica_policy_isValid;

    QList m_replica_tags;
    bool m_replica_tags_isSet;
    bool m_replica_tags_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIReplicateKeyResponse)

#endif // OAIReplicateKeyResponse_H
