...
OAIDescribeCustomKeyStoresRequest::OAIDescribeCustomKeyStoresRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeCustomKeyStoresRequest::OAIDescribeCustomKeyStoresRequest() {
    this->initializeModel();
}

OAIDescribeCustomKeyStoresRequest::~OAIDescribeCustomKeyStoresRequest() {}

void OAIDescribeCustomKeyStoresRequest::initializeModel() {
...
void OAIDescribeCustomKeyStoresRequest::fromJson(QString jsonString) {
...
void OAIDescribeCustomKeyStoresRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeCustomKeyStoresRequest::asJson() const {
...
QJsonObject OAIDescribeCustomKeyStoresRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeCustomKeyStoresRequest::getCustomKeyStoreId() const {
    return m_custom_key_store_id;
}
void OAIDescribeCustomKeyStoresRequest::setCustomKeyStoreId(const QString &custom_key_store_id) {
    m_custom_key_store_id = custom_key_store_id;
    m_custom_key_store_id_isSet = true;
}

bool OAIDescribeCustomKeyStoresRequest::is_custom_key_store_id_Set() const{
    return m_custom_key_store_id_isSet;
}

bool OAIDescribeCustomKeyStoresRequest::is_custom_key_store_id_Valid() const{
    return m_custom_key_store_id_isValid;
}

QString OAIDescribeCustomKeyStoresRequest::getCustomKeyStoreName() const {
    return m_custom_key_store_name;
}
void OAIDescribeCustomKeyStoresRequest::setCustomKeyStoreName(const QString &custom_key_store_name) {
    m_custom_key_store_name = custom_key_store_name;
    m_custom_key_store_name_isSet = true;
}

bool OAIDescribeCustomKeyStoresRequest::is_custom_key_store_name_Set() const{
    return m_custom_key_store_name_isSet;
}

bool OAIDescribeCustomKeyStoresRequest::is_custom_key_store_name_Valid() const{
    return m_custom_key_store_name_isValid;
}

qint32 OAIDescribeCustomKeyStoresRequest::getLimit() const {
    return m_limit;
}
void OAIDescribeCustomKeyStoresRequest::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIDescribeCustomKeyStoresRequest::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIDescribeCustomKeyStoresRequest::is_limit_Valid() const{
    return m_limit_isValid;
}

QString OAIDescribeCustomKeyStoresRequest::getMarker() const {
    return m_marker;
}
void OAIDescribeCustomKeyStoresRequest::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIDescribeCustomKeyStoresRequest::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIDescribeCustomKeyStoresRequest::is_marker_Valid() const{
    return m_marker_isValid;
}

bool OAIDescribeCustomKeyStoresRequest::isSet() const {
...
bool OAIDescribeCustomKeyStoresRequest::isValid() const {
