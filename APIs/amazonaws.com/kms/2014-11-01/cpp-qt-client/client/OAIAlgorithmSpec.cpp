...
OAIAlgorithmSpec::OAIAlgorithmSpec(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAlgorithmSpec::OAIAlgorithmSpec() {
    this->initializeModel();
}

OAIAlgorithmSpec::~OAIAlgorithmSpec() {}

void OAIAlgorithmSpec::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIAlgorithmSpec::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIAlgorithmSpec::fromJson(QString jsonString) {
    
    if ( jsonString.compare("RSAES_PKCS1_V1_5", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAlgorithmSpec::RSAES_PKCS1_V1_5;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("RSAES_OAEP_SHA_1", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAlgorithmSpec::RSAES_OAEP_SHA_1;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("RSAES_OAEP_SHA_256", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAlgorithmSpec::RSAES_OAEP_SHA_256;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("RSA_AES_KEY_WRAP_SHA_1", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAlgorithmSpec::RSA_AES_KEY_WRAP_SHA_1;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("RSA_AES_KEY_WRAP_SHA_256", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAlgorithmSpec::RSA_AES_KEY_WRAP_SHA_256;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIAlgorithmSpec::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIAlgorithmSpec::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIAlgorithmSpec::RSAES_PKCS1_V1_5:
            val = "RSAES_PKCS1_V1_5";
            break;
        case eOAIAlgorithmSpec::RSAES_OAEP_SHA_1:
            val = "RSAES_OAEP_SHA_1";
            break;
        case eOAIAlgorithmSpec::RSAES_OAEP_SHA_256:
            val = "RSAES_OAEP_SHA_256";
            break;
        case eOAIAlgorithmSpec::RSA_AES_KEY_WRAP_SHA_1:
            val = "RSA_AES_KEY_WRAP_SHA_1";
            break;
        case eOAIAlgorithmSpec::RSA_AES_KEY_WRAP_SHA_256:
            val = "RSA_AES_KEY_WRAP_SHA_256";
            break;
        default:
            break;
    }
...
QJsonValue OAIAlgorithmSpec::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIAlgorithmSpec::eOAIAlgorithmSpec OAIAlgorithmSpec::getValue() const {
    return m_value;
}

void OAIAlgorithmSpec::setValue(const OAIAlgorithmSpec::eOAIAlgorithmSpec& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIAlgorithmSpec::isSet() const {
    
    return m_value_isSet;
}

bool OAIAlgorithmSpec::isValid() const {
