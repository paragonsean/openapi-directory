...
/*
 * OAICreateCustomKeyStoreRequest.h
 *
 * 
 */

#ifndef OAICreateCustomKeyStoreRequest_H
#define OAICreateCustomKeyStoreRequest_H
...
namespace OpenAPI {
class OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential;

class OAICreateCustomKeyStoreRequest : public OAIObject {
public:
    OAICreateCustomKeyStoreRequest();
    OAICreateCustomKeyStoreRequest(QString json);
    ~OAICreateCustomKeyStoreRequest() override;
    ...
    OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential getXksProxyAuthenticationCredential() const;
    void setXksProxyAuthenticationCredential(const OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential &xks_proxy_authentication_credential);
...
private:
    ...
    OAICreateCustomKeyStoreRequest_XksProxyAuthenticationCredential m_xks_proxy_authentication_credential;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCustomKeyStoreRequest)

#endif // OAICreateCustomKeyStoreRequest_H
