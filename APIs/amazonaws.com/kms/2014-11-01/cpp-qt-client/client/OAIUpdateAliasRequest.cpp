...
QString OAIUpdateAliasRequest::getAliasName() const {
    return m_alias_name;
}
void OAIUpdateAliasRequest::setAliasName(const QString &alias_name) {
    m_alias_name = alias_name;
    m_alias_name_isSet = true;
}

bool OAIUpdateAliasRequest::is_alias_name_Set() const{
    return m_alias_name_isSet;
}

bool OAIUpdateAliasRequest::is_alias_name_Valid() const{
    return m_alias_name_isValid;
}

QString OAIUpdateAliasRequest::getTargetKeyId() const {
    return m_target_key_id;
}
void OAIUpdateAliasRequest::setTargetKeyId(const QString &target_key_id) {
    m_target_key_id = target_key_id;
    m_target_key_id_isSet = true;
}

bool OAIUpdateAliasRequest::is_target_key_id_Set() const{
    return m_target_key_id_isSet;
}

bool OAIUpdateAliasRequest::is_target_key_id_Valid() const{
...
bool OAIUpdateAliasRequest::isValid() const {
    ...
    return m_alias_name_isValid && m_target_key_id_isValid && true;
}
