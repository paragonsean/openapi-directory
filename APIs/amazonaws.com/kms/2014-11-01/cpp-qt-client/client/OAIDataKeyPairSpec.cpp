...
OAIDataKeyPairSpec::OAIDataKeyPairSpec(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDataKeyPairSpec::OAIDataKeyPairSpec() {
    this->initializeModel();
}

OAIDataKeyPairSpec::~OAIDataKeyPairSpec() {}

void OAIDataKeyPairSpec::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIDataKeyPairSpec::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIDataKeyPairSpec::fromJson(QString jsonString) {
    
    if ( jsonString.compare("RSA_2048", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDataKeyPairSpec::RSA_2048;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("RSA_3072", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDataKeyPairSpec::RSA_3072;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("RSA_4096", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDataKeyPairSpec::RSA_4096;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ECC_NIST_P256", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDataKeyPairSpec::ECC_NIST_P256;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ECC_NIST_P384", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDataKeyPairSpec::ECC_NIST_P384;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ECC_NIST_P521", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDataKeyPairSpec::ECC_NIST_P521;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ECC_SECG_P256K1", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDataKeyPairSpec::ECC_SECG_P256K1;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SM2", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDataKeyPairSpec::SM2;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIDataKeyPairSpec::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIDataKeyPairSpec::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIDataKeyPairSpec::RSA_2048:
            val = "RSA_2048";
            break;
        case eOAIDataKeyPairSpec::RSA_3072:
            val = "RSA_3072";
            break;
        case eOAIDataKeyPairSpec::RSA_4096:
            val = "RSA_4096";
            break;
        case eOAIDataKeyPairSpec::ECC_NIST_P256:
            val = "ECC_NIST_P256";
            break;
        case eOAIDataKeyPairSpec::ECC_NIST_P384:
            val = "ECC_NIST_P384";
            break;
        case eOAIDataKeyPairSpec::ECC_NIST_P521:
            val = "ECC_NIST_P521";
            break;
        case eOAIDataKeyPairSpec::ECC_SECG_P256K1:
            val = "ECC_SECG_P256K1";
            break;
        case eOAIDataKeyPairSpec::SM2:
            val = "SM2";
            break;
        default:
            break;
...
QJsonValue OAIDataKeyPairSpec::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIDataKeyPairSpec::eOAIDataKeyPairSpec OAIDataKeyPairSpec::getValue() const {
    return m_value;
}

void OAIDataKeyPairSpec::setValue(const OAIDataKeyPairSpec::eOAIDataKeyPairSpec& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIDataKeyPairSpec::isSet() const {
    
    return m_value_isSet;
}

bool OAIDataKeyPairSpec::isValid() const {
