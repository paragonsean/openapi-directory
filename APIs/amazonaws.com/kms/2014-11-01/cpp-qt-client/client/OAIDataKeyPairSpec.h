...
/*
 * OAIDataKeyPairSpec.h
 *
 * 
 */

#ifndef OAIDataKeyPairSpec_H
#define OAIDataKeyPairSpec_H
...
class OAIDataKeyPairSpec : public OAIEnum {
public:
    OAIDataKeyPairSpec();
    OAIDataKeyPairSpec(QString json);
    ~OAIDataKeyPairSpec() override;
    ...
    enum class eOAIDataKeyPairSpec {
    ...
    OAIDataKeyPairSpec::eOAIDataKeyPairSpec getValue() const;
    void setValue(const OAIDataKeyPairSpec::eOAIDataKeyPairSpec& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataKeyPairSpec)

#endif // OAIDataKeyPairSpec_H
