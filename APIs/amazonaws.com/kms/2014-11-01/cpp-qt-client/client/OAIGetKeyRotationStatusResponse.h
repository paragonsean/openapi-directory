...
/*
 * OAIGetKeyRotationStatusResponse.h
 *
 * 
 */

#ifndef OAIGetKeyRotationStatusResponse_H
#define OAIGetKeyRotationStatusResponse_H
...
class OAIGetKeyRotationStatusResponse : public OAIObject {
public:
    OAIGetKeyRotationStatusResponse();
    OAIGetKeyRotationStatusResponse(QString json);
    ~OAIGetKeyRotationStatusResponse() override;
    ...
    void setKeyRotationEnabled(const bool &key_rotation_enabled);
    bool is_key_rotation_enabled_Set() const;
    bool is_key_rotation_enabled_Valid() const;
...
private:
    ...
    bool m_key_rotation_enabled;
    bool m_key_rotation_enabled_isSet;
    bool m_key_rotation_enabled_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetKeyRotationStatusResponse)

#endif // OAIGetKeyRotationStatusResponse_H
