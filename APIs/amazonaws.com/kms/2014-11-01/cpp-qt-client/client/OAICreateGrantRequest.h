...
namespace OpenAPI {
class OAICreateGrantRequest_Constraints;
...
public:
    ...
    OAICreateGrantRequest_Constraints getConstraints() const;
    void setConstraints(const OAICreateGrantRequest_Constraints &constraints);
...
private:
    ...
    OAICreateGrantRequest_Constraints m_constraints;
