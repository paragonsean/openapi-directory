...
#include "OAIDescribeKeyResponse_KeyMetadata.h"
...
OAIDescribeKeyResponse_KeyMetadata::OAIDescribeKeyResponse_KeyMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeKeyResponse_KeyMetadata::OAIDescribeKeyResponse_KeyMetadata() {
    this->initializeModel();
}

OAIDescribeKeyResponse_KeyMetadata::~OAIDescribeKeyResponse_KeyMetadata() {}

void OAIDescribeKeyResponse_KeyMetadata::initializeModel() {
...
void OAIDescribeKeyResponse_KeyMetadata::fromJson(QString jsonString) {
...
void OAIDescribeKeyResponse_KeyMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeKeyResponse_KeyMetadata::asJson() const {
...
QJsonObject OAIDescribeKeyResponse_KeyMetadata::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeKeyResponse_KeyMetadata::getAwsAccountId() const {
    return m_aws_account_id;
}
void OAIDescribeKeyResponse_KeyMetadata::setAwsAccountId(const QString &aws_account_id) {
    m_aws_account_id = aws_account_id;
    m_aws_account_id_isSet = true;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_aws_account_id_Set() const{
    return m_aws_account_id_isSet;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_aws_account_id_Valid() const{
    return m_aws_account_id_isValid;
}

QString OAIDescribeKeyResponse_KeyMetadata::getKeyId() const {
    return m_key_id;
}
void OAIDescribeKeyResponse_KeyMetadata::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_key_id_Valid() const{
    return m_key_id_isValid;
}

QString OAIDescribeKeyResponse_KeyMetadata::getArn() const {
    return m_arn;
}
void OAIDescribeKeyResponse_KeyMetadata::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_arn_Valid() const{
    return m_arn_isValid;
}

QDateTime OAIDescribeKeyResponse_KeyMetadata::getCreationDate() const {
    return m_creation_date;
}
void OAIDescribeKeyResponse_KeyMetadata::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

bool OAIDescribeKeyResponse_KeyMetadata::getEnabled() const {
    return m_enabled;
}
void OAIDescribeKeyResponse_KeyMetadata::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_enabled_Valid() const{
    return m_enabled_isValid;
}

QString OAIDescribeKeyResponse_KeyMetadata::getDescription() const {
    return m_description;
}
void OAIDescribeKeyResponse_KeyMetadata::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_description_Set() const{
    return m_description_isSet;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_description_Valid() const{
    return m_description_isValid;
}

OAIKeyUsageType OAIDescribeKeyResponse_KeyMetadata::getKeyUsage() const {
    return m_key_usage;
}
void OAIDescribeKeyResponse_KeyMetadata::setKeyUsage(const OAIKeyUsageType &key_usage) {
    m_key_usage = key_usage;
    m_key_usage_isSet = true;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_key_usage_Set() const{
    return m_key_usage_isSet;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_key_usage_Valid() const{
    return m_key_usage_isValid;
}

OAIKeyState OAIDescribeKeyResponse_KeyMetadata::getKeyState() const {
    return m_key_state;
}
void OAIDescribeKeyResponse_KeyMetadata::setKeyState(const OAIKeyState &key_state) {
    m_key_state = key_state;
    m_key_state_isSet = true;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_key_state_Set() const{
    return m_key_state_isSet;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_key_state_Valid() const{
    return m_key_state_isValid;
}

QDateTime OAIDescribeKeyResponse_KeyMetadata::getDeletionDate() const {
    return m_deletion_date;
}
void OAIDescribeKeyResponse_KeyMetadata::setDeletionDate(const QDateTime &deletion_date) {
    m_deletion_date = deletion_date;
    m_deletion_date_isSet = true;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_deletion_date_Set() const{
    return m_deletion_date_isSet;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_deletion_date_Valid() const{
    return m_deletion_date_isValid;
}

QDateTime OAIDescribeKeyResponse_KeyMetadata::getValidTo() const {
    return m_valid_to;
}
void OAIDescribeKeyResponse_KeyMetadata::setValidTo(const QDateTime &valid_to) {
    m_valid_to = valid_to;
    m_valid_to_isSet = true;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_valid_to_Set() const{
    return m_valid_to_isSet;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_valid_to_Valid() const{
    return m_valid_to_isValid;
}

OAIOriginType OAIDescribeKeyResponse_KeyMetadata::getOrigin() const {
    return m_origin;
}
void OAIDescribeKeyResponse_KeyMetadata::setOrigin(const OAIOriginType &origin) {
    m_origin = origin;
    m_origin_isSet = true;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_origin_Set() const{
    return m_origin_isSet;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_origin_Valid() const{
    return m_origin_isValid;
}

QString OAIDescribeKeyResponse_KeyMetadata::getCustomKeyStoreId() const {
    return m_custom_key_store_id;
}
void OAIDescribeKeyResponse_KeyMetadata::setCustomKeyStoreId(const QString &custom_key_store_id) {
    m_custom_key_store_id = custom_key_store_id;
    m_custom_key_store_id_isSet = true;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_custom_key_store_id_Set() const{
    return m_custom_key_store_id_isSet;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_custom_key_store_id_Valid() const{
    return m_custom_key_store_id_isValid;
}

QString OAIDescribeKeyResponse_KeyMetadata::getCloudHsmClusterId() const {
    return m_cloud_hsm_cluster_id;
}
void OAIDescribeKeyResponse_KeyMetadata::setCloudHsmClusterId(const QString &cloud_hsm_cluster_id) {
    m_cloud_hsm_cluster_id = cloud_hsm_cluster_id;
    m_cloud_hsm_cluster_id_isSet = true;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_cloud_hsm_cluster_id_Set() const{
    return m_cloud_hsm_cluster_id_isSet;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_cloud_hsm_cluster_id_Valid() const{
    return m_cloud_hsm_cluster_id_isValid;
}

OAIExpirationModelType OAIDescribeKeyResponse_KeyMetadata::getExpirationModel() const {
    return m_expiration_model;
}
void OAIDescribeKeyResponse_KeyMetadata::setExpirationModel(const OAIExpirationModelType &expiration_model) {
    m_expiration_model = expiration_model;
    m_expiration_model_isSet = true;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_expiration_model_Set() const{
    return m_expiration_model_isSet;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_expiration_model_Valid() const{
    return m_expiration_model_isValid;
}

OAIKeyManagerType OAIDescribeKeyResponse_KeyMetadata::getKeyManager() const {
    return m_key_manager;
}
void OAIDescribeKeyResponse_KeyMetadata::setKeyManager(const OAIKeyManagerType &key_manager) {
    m_key_manager = key_manager;
    m_key_manager_isSet = true;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_key_manager_Set() const{
    return m_key_manager_isSet;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_key_manager_Valid() const{
    return m_key_manager_isValid;
}

OAICustomerMasterKeySpec OAIDescribeKeyResponse_KeyMetadata::getCustomerMasterKeySpec() const {
    return m_customer_master_key_spec;
}
void OAIDescribeKeyResponse_KeyMetadata::setCustomerMasterKeySpec(const OAICustomerMasterKeySpec &customer_master_key_spec) {
    m_customer_master_key_spec = customer_master_key_spec;
    m_customer_master_key_spec_isSet = true;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_customer_master_key_spec_Set() const{
    return m_customer_master_key_spec_isSet;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_customer_master_key_spec_Valid() const{
    return m_customer_master_key_spec_isValid;
}

OAIKeySpec OAIDescribeKeyResponse_KeyMetadata::getKeySpec() const {
    return m_key_spec;
}
void OAIDescribeKeyResponse_KeyMetadata::setKeySpec(const OAIKeySpec &key_spec) {
    m_key_spec = key_spec;
    m_key_spec_isSet = true;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_key_spec_Set() const{
    return m_key_spec_isSet;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_key_spec_Valid() const{
    return m_key_spec_isValid;
}

QList OAIDescribeKeyResponse_KeyMetadata::getEncryptionAlgorithms() const {
    return m_encryption_algorithms;
}
void OAIDescribeKeyResponse_KeyMetadata::setEncryptionAlgorithms(const QList &encryption_algorithms) {
    m_encryption_algorithms = encryption_algorithms;
    m_encryption_algorithms_isSet = true;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_encryption_algorithms_Set() const{
    return m_encryption_algorithms_isSet;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_encryption_algorithms_Valid() const{
    return m_encryption_algorithms_isValid;
}

QList OAIDescribeKeyResponse_KeyMetadata::getSigningAlgorithms() const {
    return m_signing_algorithms;
}
void OAIDescribeKeyResponse_KeyMetadata::setSigningAlgorithms(const QList &signing_algorithms) {
    m_signing_algorithms = signing_algorithms;
    m_signing_algorithms_isSet = true;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_signing_algorithms_Set() const{
    return m_signing_algorithms_isSet;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_signing_algorithms_Valid() const{
    return m_signing_algorithms_isValid;
}

bool OAIDescribeKeyResponse_KeyMetadata::getMultiRegion() const {
    return m_multi_region;
}
void OAIDescribeKeyResponse_KeyMetadata::setMultiRegion(const bool &multi_region) {
    m_multi_region = multi_region;
    m_multi_region_isSet = true;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_multi_region_Set() const{
    return m_multi_region_isSet;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_multi_region_Valid() const{
    return m_multi_region_isValid;
}

OAIKeyMetadata_MultiRegionConfiguration OAIDescribeKeyResponse_KeyMetadata::getMultiRegionConfiguration() const {
    return m_multi_region_configuration;
}
void OAIDescribeKeyResponse_KeyMetadata::setMultiRegionConfiguration(const OAIKeyMetadata_MultiRegionConfiguration &multi_region_configuration) {
    m_multi_region_configuration = multi_region_configuration;
    m_multi_region_configuration_isSet = true;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_multi_region_configuration_Set() const{
    return m_multi_region_configuration_isSet;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_multi_region_configuration_Valid() const{
    return m_multi_region_configuration_isValid;
}

qint32 OAIDescribeKeyResponse_KeyMetadata::getPendingDeletionWindowInDays() const {
    return m_pending_deletion_window_in_days;
}
void OAIDescribeKeyResponse_KeyMetadata::setPendingDeletionWindowInDays(const qint32 &pending_deletion_window_in_days) {
    m_pending_deletion_window_in_days = pending_deletion_window_in_days;
    m_pending_deletion_window_in_days_isSet = true;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_pending_deletion_window_in_days_Set() const{
    return m_pending_deletion_window_in_days_isSet;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_pending_deletion_window_in_days_Valid() const{
    return m_pending_deletion_window_in_days_isValid;
}

QList OAIDescribeKeyResponse_KeyMetadata::getMacAlgorithms() const {
    return m_mac_algorithms;
}
void OAIDescribeKeyResponse_KeyMetadata::setMacAlgorithms(const QList &mac_algorithms) {
    m_mac_algorithms = mac_algorithms;
    m_mac_algorithms_isSet = true;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_mac_algorithms_Set() const{
    return m_mac_algorithms_isSet;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_mac_algorithms_Valid() const{
    return m_mac_algorithms_isValid;
}

OAIKeyMetadata_XksKeyConfiguration OAIDescribeKeyResponse_KeyMetadata::getXksKeyConfiguration() const {
    return m_xks_key_configuration;
}
void OAIDescribeKeyResponse_KeyMetadata::setXksKeyConfiguration(const OAIKeyMetadata_XksKeyConfiguration &xks_key_configuration) {
    m_xks_key_configuration = xks_key_configuration;
    m_xks_key_configuration_isSet = true;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_xks_key_configuration_Set() const{
    return m_xks_key_configuration_isSet;
}

bool OAIDescribeKeyResponse_KeyMetadata::is_xks_key_configuration_Valid() const{
    return m_xks_key_configuration_isValid;
}

bool OAIDescribeKeyResponse_KeyMetadata::isSet() const {
...
bool OAIDescribeKeyResponse_KeyMetadata::isValid() const {
