...
OAIKeyMetadata::OAIKeyMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIKeyMetadata::OAIKeyMetadata() {
    this->initializeModel();
}

OAIKeyMetadata::~OAIKeyMetadata() {}

void OAIKeyMetadata::initializeModel() {
...
void OAIKeyMetadata::fromJson(QString jsonString) {
...
void OAIKeyMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIKeyMetadata::asJson() const {
...
QJsonObject OAIKeyMetadata::asJsonObject() const {
    QJsonObject obj;
...
QString OAIKeyMetadata::getAwsAccountId() const {
    return m_aws_account_id;
}
void OAIKeyMetadata::setAwsAccountId(const QString &aws_account_id) {
    m_aws_account_id = aws_account_id;
    m_aws_account_id_isSet = true;
}

bool OAIKeyMetadata::is_aws_account_id_Set() const{
    return m_aws_account_id_isSet;
}

bool OAIKeyMetadata::is_aws_account_id_Valid() const{
    return m_aws_account_id_isValid;
}

QString OAIKeyMetadata::getKeyId() const {
    return m_key_id;
}
void OAIKeyMetadata::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIKeyMetadata::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIKeyMetadata::is_key_id_Valid() const{
    return m_key_id_isValid;
}

QString OAIKeyMetadata::getArn() const {
    return m_arn;
}
void OAIKeyMetadata::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIKeyMetadata::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIKeyMetadata::is_arn_Valid() const{
    return m_arn_isValid;
}

QDateTime OAIKeyMetadata::getCreationDate() const {
    return m_creation_date;
}
void OAIKeyMetadata::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAIKeyMetadata::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAIKeyMetadata::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

bool OAIKeyMetadata::getEnabled() const {
    return m_enabled;
}
void OAIKeyMetadata::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIKeyMetadata::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIKeyMetadata::is_enabled_Valid() const{
    return m_enabled_isValid;
}

QString OAIKeyMetadata::getDescription() const {
    return m_description;
}
void OAIKeyMetadata::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIKeyMetadata::is_description_Set() const{
    return m_description_isSet;
}

bool OAIKeyMetadata::is_description_Valid() const{
    return m_description_isValid;
}

OAIKeyUsageType OAIKeyMetadata::getKeyUsage() const {
    return m_key_usage;
}
void OAIKeyMetadata::setKeyUsage(const OAIKeyUsageType &key_usage) {
    m_key_usage = key_usage;
    m_key_usage_isSet = true;
}

bool OAIKeyMetadata::is_key_usage_Set() const{
    return m_key_usage_isSet;
}

bool OAIKeyMetadata::is_key_usage_Valid() const{
    return m_key_usage_isValid;
}

OAIKeyState OAIKeyMetadata::getKeyState() const {
    return m_key_state;
}
void OAIKeyMetadata::setKeyState(const OAIKeyState &key_state) {
    m_key_state = key_state;
    m_key_state_isSet = true;
}

bool OAIKeyMetadata::is_key_state_Set() const{
    return m_key_state_isSet;
}

bool OAIKeyMetadata::is_key_state_Valid() const{
    return m_key_state_isValid;
}

QDateTime OAIKeyMetadata::getDeletionDate() const {
    return m_deletion_date;
}
void OAIKeyMetadata::setDeletionDate(const QDateTime &deletion_date) {
    m_deletion_date = deletion_date;
    m_deletion_date_isSet = true;
}

bool OAIKeyMetadata::is_deletion_date_Set() const{
    return m_deletion_date_isSet;
}

bool OAIKeyMetadata::is_deletion_date_Valid() const{
    return m_deletion_date_isValid;
}

QDateTime OAIKeyMetadata::getValidTo() const {
    return m_valid_to;
}
void OAIKeyMetadata::setValidTo(const QDateTime &valid_to) {
    m_valid_to = valid_to;
    m_valid_to_isSet = true;
}

bool OAIKeyMetadata::is_valid_to_Set() const{
    return m_valid_to_isSet;
}

bool OAIKeyMetadata::is_valid_to_Valid() const{
    return m_valid_to_isValid;
}

OAIOriginType OAIKeyMetadata::getOrigin() const {
    return m_origin;
}
void OAIKeyMetadata::setOrigin(const OAIOriginType &origin) {
    m_origin = origin;
    m_origin_isSet = true;
}

bool OAIKeyMetadata::is_origin_Set() const{
    return m_origin_isSet;
}

bool OAIKeyMetadata::is_origin_Valid() const{
    return m_origin_isValid;
}

QString OAIKeyMetadata::getCustomKeyStoreId() const {
    return m_custom_key_store_id;
}
void OAIKeyMetadata::setCustomKeyStoreId(const QString &custom_key_store_id) {
    m_custom_key_store_id = custom_key_store_id;
    m_custom_key_store_id_isSet = true;
}

bool OAIKeyMetadata::is_custom_key_store_id_Set() const{
    return m_custom_key_store_id_isSet;
}

bool OAIKeyMetadata::is_custom_key_store_id_Valid() const{
    return m_custom_key_store_id_isValid;
}

QString OAIKeyMetadata::getCloudHsmClusterId() const {
    return m_cloud_hsm_cluster_id;
}
void OAIKeyMetadata::setCloudHsmClusterId(const QString &cloud_hsm_cluster_id) {
    m_cloud_hsm_cluster_id = cloud_hsm_cluster_id;
    m_cloud_hsm_cluster_id_isSet = true;
}

bool OAIKeyMetadata::is_cloud_hsm_cluster_id_Set() const{
    return m_cloud_hsm_cluster_id_isSet;
}

bool OAIKeyMetadata::is_cloud_hsm_cluster_id_Valid() const{
    return m_cloud_hsm_cluster_id_isValid;
}

OAIExpirationModelType OAIKeyMetadata::getExpirationModel() const {
    return m_expiration_model;
}
void OAIKeyMetadata::setExpirationModel(const OAIExpirationModelType &expiration_model) {
    m_expiration_model = expiration_model;
    m_expiration_model_isSet = true;
}

bool OAIKeyMetadata::is_expiration_model_Set() const{
    return m_expiration_model_isSet;
}

bool OAIKeyMetadata::is_expiration_model_Valid() const{
    return m_expiration_model_isValid;
}

OAIKeyManagerType OAIKeyMetadata::getKeyManager() const {
    return m_key_manager;
}
void OAIKeyMetadata::setKeyManager(const OAIKeyManagerType &key_manager) {
    m_key_manager = key_manager;
    m_key_manager_isSet = true;
}

bool OAIKeyMetadata::is_key_manager_Set() const{
    return m_key_manager_isSet;
}

bool OAIKeyMetadata::is_key_manager_Valid() const{
    return m_key_manager_isValid;
}

OAICustomerMasterKeySpec OAIKeyMetadata::getCustomerMasterKeySpec() const {
    return m_customer_master_key_spec;
}
void OAIKeyMetadata::setCustomerMasterKeySpec(const OAICustomerMasterKeySpec &customer_master_key_spec) {
    m_customer_master_key_spec = customer_master_key_spec;
    m_customer_master_key_spec_isSet = true;
}

bool OAIKeyMetadata::is_customer_master_key_spec_Set() const{
    return m_customer_master_key_spec_isSet;
}

bool OAIKeyMetadata::is_customer_master_key_spec_Valid() const{
    return m_customer_master_key_spec_isValid;
}

OAIKeySpec OAIKeyMetadata::getKeySpec() const {
    return m_key_spec;
}
void OAIKeyMetadata::setKeySpec(const OAIKeySpec &key_spec) {
    m_key_spec = key_spec;
    m_key_spec_isSet = true;
}

bool OAIKeyMetadata::is_key_spec_Set() const{
    return m_key_spec_isSet;
}

bool OAIKeyMetadata::is_key_spec_Valid() const{
    return m_key_spec_isValid;
}

QList OAIKeyMetadata::getEncryptionAlgorithms() const {
    return m_encryption_algorithms;
}
void OAIKeyMetadata::setEncryptionAlgorithms(const QList &encryption_algorithms) {
    m_encryption_algorithms = encryption_algorithms;
    m_encryption_algorithms_isSet = true;
}

bool OAIKeyMetadata::is_encryption_algorithms_Set() const{
    return m_encryption_algorithms_isSet;
}

bool OAIKeyMetadata::is_encryption_algorithms_Valid() const{
    return m_encryption_algorithms_isValid;
}

QList OAIKeyMetadata::getSigningAlgorithms() const {
    return m_signing_algorithms;
}
void OAIKeyMetadata::setSigningAlgorithms(const QList &signing_algorithms) {
    m_signing_algorithms = signing_algorithms;
    m_signing_algorithms_isSet = true;
}

bool OAIKeyMetadata::is_signing_algorithms_Set() const{
    return m_signing_algorithms_isSet;
}

bool OAIKeyMetadata::is_signing_algorithms_Valid() const{
    return m_signing_algorithms_isValid;
}

bool OAIKeyMetadata::getMultiRegion() const {
    return m_multi_region;
}
void OAIKeyMetadata::setMultiRegion(const bool &multi_region) {
    m_multi_region = multi_region;
    m_multi_region_isSet = true;
}

bool OAIKeyMetadata::is_multi_region_Set() const{
    return m_multi_region_isSet;
}

bool OAIKeyMetadata::is_multi_region_Valid() const{
    return m_multi_region_isValid;
}

OAIKeyMetadata_MultiRegionConfiguration OAIKeyMetadata::getMultiRegionConfiguration() const {
    return m_multi_region_configuration;
}
void OAIKeyMetadata::setMultiRegionConfiguration(const OAIKeyMetadata_MultiRegionConfiguration &multi_region_configuration) {
    m_multi_region_configuration = multi_region_configuration;
    m_multi_region_configuration_isSet = true;
}

bool OAIKeyMetadata::is_multi_region_configuration_Set() const{
    return m_multi_region_configuration_isSet;
}

bool OAIKeyMetadata::is_multi_region_configuration_Valid() const{
    return m_multi_region_configuration_isValid;
}

qint32 OAIKeyMetadata::getPendingDeletionWindowInDays() const {
    return m_pending_deletion_window_in_days;
}
void OAIKeyMetadata::setPendingDeletionWindowInDays(const qint32 &pending_deletion_window_in_days) {
    m_pending_deletion_window_in_days = pending_deletion_window_in_days;
    m_pending_deletion_window_in_days_isSet = true;
}

bool OAIKeyMetadata::is_pending_deletion_window_in_days_Set() const{
    return m_pending_deletion_window_in_days_isSet;
}

bool OAIKeyMetadata::is_pending_deletion_window_in_days_Valid() const{
    return m_pending_deletion_window_in_days_isValid;
}

QList OAIKeyMetadata::getMacAlgorithms() const {
    return m_mac_algorithms;
}
void OAIKeyMetadata::setMacAlgorithms(const QList &mac_algorithms) {
    m_mac_algorithms = mac_algorithms;
    m_mac_algorithms_isSet = true;
}

bool OAIKeyMetadata::is_mac_algorithms_Set() const{
    return m_mac_algorithms_isSet;
}

bool OAIKeyMetadata::is_mac_algorithms_Valid() const{
    return m_mac_algorithms_isValid;
}

OAIKeyMetadata_XksKeyConfiguration OAIKeyMetadata::getXksKeyConfiguration() const {
    return m_xks_key_configuration;
}
void OAIKeyMetadata::setXksKeyConfiguration(const OAIKeyMetadata_XksKeyConfiguration &xks_key_configuration) {
    m_xks_key_configuration = xks_key_configuration;
    m_xks_key_configuration_isSet = true;
}

bool OAIKeyMetadata::is_xks_key_configuration_Set() const{
    return m_xks_key_configuration_isSet;
}

bool OAIKeyMetadata::is_xks_key_configuration_Valid() const{
    return m_xks_key_configuration_isValid;
}

bool OAIKeyMetadata::isSet() const {
...
bool OAIKeyMetadata::isValid() const {
