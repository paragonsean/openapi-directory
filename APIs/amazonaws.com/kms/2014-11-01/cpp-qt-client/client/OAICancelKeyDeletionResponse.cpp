...
OAICancelKeyDeletionResponse::OAICancelKeyDeletionResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICancelKeyDeletionResponse::OAICancelKeyDeletionResponse() {
    this->initializeModel();
}

OAICancelKeyDeletionResponse::~OAICancelKeyDeletionResponse() {}

void OAICancelKeyDeletionResponse::initializeModel() {

    m_key_id_isSet = false;
    m_key_id_isValid = false;
}

void OAICancelKeyDeletionResponse::fromJson(QString jsonString) {
...
void OAICancelKeyDeletionResponse::fromJsonObject(QJsonObject json) {
...
QString OAICancelKeyDeletionResponse::asJson() const {
...
QJsonObject OAICancelKeyDeletionResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAICancelKeyDeletionResponse::getKeyId() const {
    return m_key_id;
}
void OAICancelKeyDeletionResponse::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAICancelKeyDeletionResponse::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAICancelKeyDeletionResponse::is_key_id_Valid() const{
    return m_key_id_isValid;
}

bool OAICancelKeyDeletionResponse::isSet() const {
...
bool OAICancelKeyDeletionResponse::isValid() const {
