...
/*
 * OAIGenerateRandomRequest_Recipient.h
 *
 * 
 */

#ifndef OAIGenerateRandomRequest_Recipient_H
#define OAIGenerateRandomRequest_Recipient_H
...
class OAIGenerateRandomRequest_Recipient : public OAIObject {
public:
    OAIGenerateRandomRequest_Recipient();
    OAIGenerateRandomRequest_Recipient(QString json);
    ~OAIGenerateRandomRequest_Recipient() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGenerateRandomRequest_Recipient)

#endif // OAIGenerateRandomRequest_Recipient_H
