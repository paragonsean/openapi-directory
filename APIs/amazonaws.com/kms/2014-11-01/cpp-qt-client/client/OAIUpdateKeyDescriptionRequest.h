...
/*
 * OAIUpdateKeyDescriptionRequest.h
 *
 * 
 */

#ifndef OAIUpdateKeyDescriptionRequest_H
#define OAIUpdateKeyDescriptionRequest_H
...
class OAIUpdateKeyDescriptionRequest : public OAIObject {
public:
    OAIUpdateKeyDescriptionRequest();
    OAIUpdateKeyDescriptionRequest(QString json);
    ~OAIUpdateKeyDescriptionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateKeyDescriptionRequest)

#endif // OAIUpdateKeyDescriptionRequest_H
