...
QString OAIEncryptResponse::getCiphertextBlob() const {
    return m_ciphertext_blob;
}
void OAIEncryptResponse::setCiphertextBlob(const QString &ciphertext_blob) {
    m_ciphertext_blob = ciphertext_blob;
    m_ciphertext_blob_isSet = true;
}

bool OAIEncryptResponse::is_ciphertext_blob_Set() const{
    return m_ciphertext_blob_isSet;
}

bool OAIEncryptResponse::is_ciphertext_blob_Valid() const{
    return m_ciphertext_blob_isValid;
}

QString OAIEncryptResponse::getKeyId() const {
    return m_key_id;
}
void OAIEncryptResponse::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIEncryptResponse::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIEncryptResponse::is_key_id_Valid() const{
    return m_key_id_isValid;
}

OAIEncryptionAlgorithmSpec OAIEncryptResponse::getEncryptionAlgorithm() const {
    return m_encryption_algorithm;
}
void OAIEncryptResponse::setEncryptionAlgorithm(const OAIEncryptionAlgorithmSpec &encryption_algorithm) {
    m_encryption_algorithm = encryption_algorithm;
    m_encryption_algorithm_isSet = true;
}

bool OAIEncryptResponse::is_encryption_algorithm_Set() const{
    return m_encryption_algorithm_isSet;
}

bool OAIEncryptResponse::is_encryption_algorithm_Valid() const{
