...
/*
 * OAIGenerateDataKeyRequest_Recipient.h
 *
 * 
 */

#ifndef OAIGenerateDataKeyRequest_Recipient_H
#define OAIGenerateDataKeyRequest_Recipient_H

#include <QJsonObject>

#include "OAIKeyEncryptionMechanism.h"
#include <QString>
...
class OAIGenerateDataKeyRequest_Recipient : public OAIObject {
public:
    OAIGenerateDataKeyRequest_Recipient();
    OAIGenerateDataKeyRequest_Recipient(QString json);
    ~OAIGenerateDataKeyRequest_Recipient() override;
    ...
    OAIKeyEncryptionMechanism getKeyEncryptionAlgorithm() const;
    void setKeyEncryptionAlgorithm(const OAIKeyEncryptionMechanism &key_encryption_algorithm);
    bool is_key_encryption_algorithm_Set() const;
    bool is_key_encryption_algorithm_Valid() const;

    QString getAttestationDocument() const;
    void setAttestationDocument(const QString &attestation_document);
    bool is_attestation_document_Set() const;
    bool is_attestation_document_Valid() const;
...
private:
    ...
    OAIKeyEncryptionMechanism m_key_encryption_algorithm;
    bool m_key_encryption_algorithm_isSet;
    bool m_key_encryption_algorithm_isValid;

    QString m_attestation_document;
    bool m_attestation_document_isSet;
    bool m_attestation_document_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGenerateDataKeyRequest_Recipient)

#endif // OAIGenerateDataKeyRequest_Recipient_H
