...
/*
 * OAICustomerMasterKeySpec.h
 *
 * This enum has been deprecated. Instead, use the KeySpec enum.
 */

#ifndef OAICustomerMasterKeySpec_H
#define OAICustomerMasterKeySpec_H
...
class OAICustomerMasterKeySpec : public OAIEnum {
public:
    OAICustomerMasterKeySpec();
    OAICustomerMasterKeySpec(QString json);
    ~OAICustomerMasterKeySpec() override;
    ...
    enum class eOAICustomerMasterKeySpec {
    ...
    OAICustomerMasterKeySpec::eOAICustomerMasterKeySpec getValue() const;
    void setValue(const OAICustomerMasterKeySpec::eOAICustomerMasterKeySpec& value);
...
private:
    ...
    eOAICustomerMasterKeySpec m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomerMasterKeySpec)

#endif // OAICustomerMasterKeySpec_H
