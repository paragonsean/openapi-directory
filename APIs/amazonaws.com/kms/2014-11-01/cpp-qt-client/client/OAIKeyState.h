...
#ifndef OAIKeyState_H
#define OAIKeyState_H
...
class OAIKeyState : public OAIEnum {
public:
    OAIKeyState();
    OAIKeyState(QString json);
    ~OAIKeyState() override;
    ...
    OAIKeyState::eOAIKeyState getValue() const;
    void setValue(const OAIKeyState::eOAIKeyState& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIKeyState)
