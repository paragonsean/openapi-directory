...
/*
 * OAIListGrantsResponse.h
 *
 * 
 */

#ifndef OAIListGrantsResponse_H
#define OAIListGrantsResponse_H
...
class OAIListGrantsResponse : public OAIObject {
public:
    OAIListGrantsResponse();
    OAIListGrantsResponse(QString json);
    ~OAIListGrantsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListGrantsResponse)

#endif // OAIListGrantsResponse_H
