...
#ifndef OAISignResponse_H
#define OAISignResponse_H
...
class OAISignResponse : public OAIObject {
public:
    OAISignResponse();
    OAISignResponse(QString json);
    ~OAISignResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISignResponse)

#endif // OAISignResponse_H
