...
OAIGenerateDataKeyPairWithoutPlaintextRequest::OAIGenerateDataKeyPairWithoutPlaintextRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGenerateDataKeyPairWithoutPlaintextRequest::OAIGenerateDataKeyPairWithoutPlaintextRequest() {
    this->initializeModel();
}

OAIGenerateDataKeyPairWithoutPlaintextRequest::~OAIGenerateDataKeyPairWithoutPlaintextRequest() {}

void OAIGenerateDataKeyPairWithoutPlaintextRequest::initializeModel() {
...
void OAIGenerateDataKeyPairWithoutPlaintextRequest::fromJson(QString jsonString) {
...
void OAIGenerateDataKeyPairWithoutPlaintextRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGenerateDataKeyPairWithoutPlaintextRequest::asJson() const {
...
QJsonObject OAIGenerateDataKeyPairWithoutPlaintextRequest::asJsonObject() const {
    QJsonObject obj;
...
QMap OAIGenerateDataKeyPairWithoutPlaintextRequest::getEncryptionContext() const {
    return m_encryption_context;
}
void OAIGenerateDataKeyPairWithoutPlaintextRequest::setEncryptionContext(const QMap &encryption_context) {
    m_encryption_context = encryption_context;
    m_encryption_context_isSet = true;
}

bool OAIGenerateDataKeyPairWithoutPlaintextRequest::is_encryption_context_Set() const{
    return m_encryption_context_isSet;
}

bool OAIGenerateDataKeyPairWithoutPlaintextRequest::is_encryption_context_Valid() const{
    return m_encryption_context_isValid;
}

QString OAIGenerateDataKeyPairWithoutPlaintextRequest::getKeyId() const {
    return m_key_id;
}
void OAIGenerateDataKeyPairWithoutPlaintextRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIGenerateDataKeyPairWithoutPlaintextRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIGenerateDataKeyPairWithoutPlaintextRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

OAIDataKeyPairSpec OAIGenerateDataKeyPairWithoutPlaintextRequest::getKeyPairSpec() const {
    return m_key_pair_spec;
}
void OAIGenerateDataKeyPairWithoutPlaintextRequest::setKeyPairSpec(const OAIDataKeyPairSpec &key_pair_spec) {
    m_key_pair_spec = key_pair_spec;
    m_key_pair_spec_isSet = true;
}

bool OAIGenerateDataKeyPairWithoutPlaintextRequest::is_key_pair_spec_Set() const{
    return m_key_pair_spec_isSet;
}

bool OAIGenerateDataKeyPairWithoutPlaintextRequest::is_key_pair_spec_Valid() const{
    return m_key_pair_spec_isValid;
}

QList OAIGenerateDataKeyPairWithoutPlaintextRequest::getGrantTokens() const {
    return m_grant_tokens;
}
void OAIGenerateDataKeyPairWithoutPlaintextRequest::setGrantTokens(const QList &grant_tokens) {
    m_grant_tokens = grant_tokens;
    m_grant_tokens_isSet = true;
}

bool OAIGenerateDataKeyPairWithoutPlaintextRequest::is_grant_tokens_Set() const{
    return m_grant_tokens_isSet;
}

bool OAIGenerateDataKeyPairWithoutPlaintextRequest::is_grant_tokens_Valid() const{
    return m_grant_tokens_isValid;
}

bool OAIGenerateDataKeyPairWithoutPlaintextRequest::getDryRun() const {
    return m_dry_run;
}
void OAIGenerateDataKeyPairWithoutPlaintextRequest::setDryRun(const bool &dry_run) {
    m_dry_run = dry_run;
    m_dry_run_isSet = true;
}

bool OAIGenerateDataKeyPairWithoutPlaintextRequest::is_dry_run_Set() const{
    return m_dry_run_isSet;
}

bool OAIGenerateDataKeyPairWithoutPlaintextRequest::is_dry_run_Valid() const{
    return m_dry_run_isValid;
}

bool OAIGenerateDataKeyPairWithoutPlaintextRequest::isSet() const {
...
bool OAIGenerateDataKeyPairWithoutPlaintextRequest::isValid() const {
