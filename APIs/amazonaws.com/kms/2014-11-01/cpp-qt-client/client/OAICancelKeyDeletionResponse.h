...
/*
 * OAICancelKeyDeletionResponse.h
 *
 * 
 */

#ifndef OAICancelKeyDeletionResponse_H
#define OAICancelKeyDeletionResponse_H
...
class OAICancelKeyDeletionResponse : public OAIObject {
public:
    OAICancelKeyDeletionResponse();
    OAICancelKeyDeletionResponse(QString json);
    ~OAICancelKeyDeletionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICancelKeyDeletionResponse)

#endif // OAICancelKeyDeletionResponse_H
