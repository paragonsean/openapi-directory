...
/*
 * OAIDescribeCustomKeyStoresResponse.h
 *
 * 
 */

#ifndef OAIDescribeCustomKeyStoresResponse_H
#define OAIDescribeCustomKeyStoresResponse_H
...
class OAIDescribeCustomKeyStoresResponse : public OAIObject {
public:
    OAIDescribeCustomKeyStoresResponse();
    OAIDescribeCustomKeyStoresResponse(QString json);
    ~OAIDescribeCustomKeyStoresResponse() override;
    ...
    QList getCustomKeyStores() const;
    void setCustomKeyStores(const QList &custom_key_stores);
    bool is_custom_key_stores_Set() const;
    bool is_custom_key_stores_Valid() const;
...
private:
    ...
    QList m_custom_key_stores;
    bool m_custom_key_stores_isSet;
    bool m_custom_key_stores_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCustomKeyStoresResponse)

#endif // OAIDescribeCustomKeyStoresResponse_H
