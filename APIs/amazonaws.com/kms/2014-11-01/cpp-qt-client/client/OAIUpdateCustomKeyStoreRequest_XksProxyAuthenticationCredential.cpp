...
OAIUpdateCustomKeyStoreRequest_XksProxyAuthenticationCredential::OAIUpdateCustomKeyStoreRequest_XksProxyAuthenticationCredential(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateCustomKeyStoreRequest_XksProxyAuthenticationCredential::OAIUpdateCustomKeyStoreRequest_XksProxyAuthenticationCredential() {
    this->initializeModel();
}

OAIUpdateCustomKeyStoreRequest_XksProxyAuthenticationCredential::~OAIUpdateCustomKeyStoreRequest_XksProxyAuthenticationCredential() {}

void OAIUpdateCustomKeyStoreRequest_XksProxyAuthenticationCredential::initializeModel() {

    m_access_key_id_isSet = false;
    m_access_key_id_isValid = false;

    m_raw_secret_access_key_isSet = false;
    m_raw_secret_access_key_isValid = false;
}

void OAIUpdateCustomKeyStoreRequest_XksProxyAuthenticationCredential::fromJson(QString jsonString) {
...
void OAIUpdateCustomKeyStoreRequest_XksProxyAuthenticationCredential::fromJsonObject(QJsonObject json) {
    ...
    m_raw_secret_access_key_isValid = ::OpenAPI::fromJsonValue(m_raw_secret_access_key, json[QString("RawSecretAccessKey")]);
    m_raw_secret_access_key_isSet = !json[QString("RawSecretAccessKey")].isNull() && m_raw_secret_access_key_isValid;
}

QString OAIUpdateCustomKeyStoreRequest_XksProxyAuthenticationCredential::asJson() const {
...
QJsonObject OAIUpdateCustomKeyStoreRequest_XksProxyAuthenticationCredential::asJsonObject() const {
    QJsonObject obj;
    if (m_access_key_id_isSet) {
        obj.insert(QString("AccessKeyId"), ::OpenAPI::toJsonValue(m_access_key_id));
    }
    if (m_raw_secret_access_key_isSet) {
        obj.insert(QString("RawSecretAccessKey"), ::OpenAPI::toJsonValue(m_raw_secret_access_key));
    }
    return obj;
}

QString OAIUpdateCustomKeyStoreRequest_XksProxyAuthenticationCredential::getAccessKeyId() const {
    return m_access_key_id;
}
void OAIUpdateCustomKeyStoreRequest_XksProxyAuthenticationCredential::setAccessKeyId(const QString &access_key_id) {
    m_access_key_id = access_key_id;
    m_access_key_id_isSet = true;
}

bool OAIUpdateCustomKeyStoreRequest_XksProxyAuthenticationCredential::is_access_key_id_Set() const{
    return m_access_key_id_isSet;
}

bool OAIUpdateCustomKeyStoreRequest_XksProxyAuthenticationCredential::is_access_key_id_Valid() const{
    return m_access_key_id_isValid;
}

QString OAIUpdateCustomKeyStoreRequest_XksProxyAuthenticationCredential::getRawSecretAccessKey() const {
    return m_raw_secret_access_key;
}
void OAIUpdateCustomKeyStoreRequest_XksProxyAuthenticationCredential::setRawSecretAccessKey(const QString &raw_secret_access_key) {
    m_raw_secret_access_key = raw_secret_access_key;
    m_raw_secret_access_key_isSet = true;
}

bool OAIUpdateCustomKeyStoreRequest_XksProxyAuthenticationCredential::is_raw_secret_access_key_Set() const{
    return m_raw_secret_access_key_isSet;
}

bool OAIUpdateCustomKeyStoreRequest_XksProxyAuthenticationCredential::is_raw_secret_access_key_Valid() const{
    return m_raw_secret_access_key_isValid;
}

bool OAIUpdateCustomKeyStoreRequest_XksProxyAuthenticationCredential::isSet() const {
...
bool OAIUpdateCustomKeyStoreRequest_XksProxyAuthenticationCredential::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_access_key_id_isValid && m_raw_secret_access_key_isValid && true;
}
