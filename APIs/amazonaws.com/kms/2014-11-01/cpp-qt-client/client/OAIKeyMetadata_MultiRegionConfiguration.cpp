...
OAIKeyMetadata_MultiRegionConfiguration::OAIKeyMetadata_MultiRegionConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIKeyMetadata_MultiRegionConfiguration::OAIKeyMetadata_MultiRegionConfiguration() {
    this->initializeModel();
}

OAIKeyMetadata_MultiRegionConfiguration::~OAIKeyMetadata_MultiRegionConfiguration() {}

void OAIKeyMetadata_MultiRegionConfiguration::initializeModel() {
...
void OAIKeyMetadata_MultiRegionConfiguration::fromJson(QString jsonString) {
...
void OAIKeyMetadata_MultiRegionConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIKeyMetadata_MultiRegionConfiguration::asJson() const {
...
QJsonObject OAIKeyMetadata_MultiRegionConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAIMultiRegionKeyType OAIKeyMetadata_MultiRegionConfiguration::getMultiRegionKeyType() const {
    return m_multi_region_key_type;
}
void OAIKeyMetadata_MultiRegionConfiguration::setMultiRegionKeyType(const OAIMultiRegionKeyType &multi_region_key_type) {
    m_multi_region_key_type = multi_region_key_type;
    m_multi_region_key_type_isSet = true;
}

bool OAIKeyMetadata_MultiRegionConfiguration::is_multi_region_key_type_Set() const{
    return m_multi_region_key_type_isSet;
}

bool OAIKeyMetadata_MultiRegionConfiguration::is_multi_region_key_type_Valid() const{
    return m_multi_region_key_type_isValid;
}

OAIMultiRegionConfiguration_PrimaryKey OAIKeyMetadata_MultiRegionConfiguration::getPrimaryKey() const {
    return m_primary_key;
}
void OAIKeyMetadata_MultiRegionConfiguration::setPrimaryKey(const OAIMultiRegionConfiguration_PrimaryKey &primary_key) {
    m_primary_key = primary_key;
    m_primary_key_isSet = true;
}

bool OAIKeyMetadata_MultiRegionConfiguration::is_primary_key_Set() const{
    return m_primary_key_isSet;
}

bool OAIKeyMetadata_MultiRegionConfiguration::is_primary_key_Valid() const{
    return m_primary_key_isValid;
}

QList OAIKeyMetadata_MultiRegionConfiguration::getReplicaKeys() const {
    return m_replica_keys;
}
void OAIKeyMetadata_MultiRegionConfiguration::setReplicaKeys(const QList &replica_keys) {
    m_replica_keys = replica_keys;
    m_replica_keys_isSet = true;
}

bool OAIKeyMetadata_MultiRegionConfiguration::is_replica_keys_Set() const{
    return m_replica_keys_isSet;
}

bool OAIKeyMetadata_MultiRegionConfiguration::is_replica_keys_Valid() const{
    return m_replica_keys_isValid;
}

bool OAIKeyMetadata_MultiRegionConfiguration::isSet() const {
...
bool OAIKeyMetadata_MultiRegionConfiguration::isValid() const {
