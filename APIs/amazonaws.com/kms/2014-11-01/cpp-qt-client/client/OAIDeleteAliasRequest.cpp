...
OAIDeleteAliasRequest::OAIDeleteAliasRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteAliasRequest::OAIDeleteAliasRequest() {
    this->initializeModel();
}

OAIDeleteAliasRequest::~OAIDeleteAliasRequest() {}

void OAIDeleteAliasRequest::initializeModel() {

    m_alias_name_isSet = false;
    m_alias_name_isValid = false;
}

void OAIDeleteAliasRequest::fromJson(QString jsonString) {
...
void OAIDeleteAliasRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteAliasRequest::asJson() const {
...
QJsonObject OAIDeleteAliasRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteAliasRequest::getAliasName() const {
    return m_alias_name;
}
void OAIDeleteAliasRequest::setAliasName(const QString &alias_name) {
    m_alias_name = alias_name;
    m_alias_name_isSet = true;
}

bool OAIDeleteAliasRequest::is_alias_name_Set() const{
    return m_alias_name_isSet;
}

bool OAIDeleteAliasRequest::is_alias_name_Valid() const{
    return m_alias_name_isValid;
}

bool OAIDeleteAliasRequest::isSet() const {
...
bool OAIDeleteAliasRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_alias_name_isValid && true;
}
