...
OAIDecryptRequest_Recipient::OAIDecryptRequest_Recipient(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDecryptRequest_Recipient::OAIDecryptRequest_Recipient() {
    this->initializeModel();
}

OAIDecryptRequest_Recipient::~OAIDecryptRequest_Recipient() {}

void OAIDecryptRequest_Recipient::initializeModel() {
...
void OAIDecryptRequest_Recipient::fromJson(QString jsonString) {
...
void OAIDecryptRequest_Recipient::fromJsonObject(QJsonObject json) {
...
QString OAIDecryptRequest_Recipient::asJson() const {
...
QJsonObject OAIDecryptRequest_Recipient::asJsonObject() const {
    QJsonObject obj;
...
OAIKeyEncryptionMechanism OAIDecryptRequest_Recipient::getKeyEncryptionAlgorithm() const {
    return m_key_encryption_algorithm;
}
void OAIDecryptRequest_Recipient::setKeyEncryptionAlgorithm(const OAIKeyEncryptionMechanism &key_encryption_algorithm) {
    m_key_encryption_algorithm = key_encryption_algorithm;
    m_key_encryption_algorithm_isSet = true;
}

bool OAIDecryptRequest_Recipient::is_key_encryption_algorithm_Set() const{
    return m_key_encryption_algorithm_isSet;
}

bool OAIDecryptRequest_Recipient::is_key_encryption_algorithm_Valid() const{
    return m_key_encryption_algorithm_isValid;
}

QString OAIDecryptRequest_Recipient::getAttestationDocument() const {
    return m_attestation_document;
}
void OAIDecryptRequest_Recipient::setAttestationDocument(const QString &attestation_document) {
    m_attestation_document = attestation_document;
    m_attestation_document_isSet = true;
}

bool OAIDecryptRequest_Recipient::is_attestation_document_Set() const{
    return m_attestation_document_isSet;
}

bool OAIDecryptRequest_Recipient::is_attestation_document_Valid() const{
    return m_attestation_document_isValid;
}

bool OAIDecryptRequest_Recipient::isSet() const {
...
bool OAIDecryptRequest_Recipient::isValid() const {
