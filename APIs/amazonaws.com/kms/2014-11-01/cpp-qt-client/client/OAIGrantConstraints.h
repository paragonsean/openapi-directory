...
#ifndef OAIGrantConstraints_H
#define OAIGrantConstraints_H
...
class OAIGrantConstraints : public OAIObject {
public:
    OAIGrantConstraints();
    OAIGrantConstraints(QString json);
    ~OAIGrantConstraints() override;
    ...
    QMap getEncryptionContextSubset() const;
    void setEncryptionContextSubset(const QMap &encryption_context_subset);
    bool is_encryption_context_subset_Set() const;
    bool is_encryption_context_subset_Valid() const;

    QMap getEncryptionContextEquals() const;
    void setEncryptionContextEquals(const QMap &encryption_context_equals);
    bool is_encryption_context_equals_Set() const;
    bool is_encryption_context_equals_Valid() const;
...
private:
    ...
    QMap m_encryption_context_subset;
    bool m_encryption_context_subset_isSet;
    bool m_encryption_context_subset_isValid;

    QMap m_encryption_context_equals;
    bool m_encryption_context_equals_isSet;
    bool m_encryption_context_equals_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGrantConstraints)

#endif // OAIGrantConstraints_H
