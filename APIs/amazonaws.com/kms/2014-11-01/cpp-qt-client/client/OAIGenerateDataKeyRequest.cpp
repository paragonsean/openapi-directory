...
OAIGenerateDataKeyRequest::OAIGenerateDataKeyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGenerateDataKeyRequest::OAIGenerateDataKeyRequest() {
    this->initializeModel();
}

OAIGenerateDataKeyRequest::~OAIGenerateDataKeyRequest() {}

void OAIGenerateDataKeyRequest::initializeModel() {
...
void OAIGenerateDataKeyRequest::fromJson(QString jsonString) {
...
void OAIGenerateDataKeyRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGenerateDataKeyRequest::asJson() const {
...
QJsonObject OAIGenerateDataKeyRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAIGenerateDataKeyRequest::getKeyId() const {
    return m_key_id;
}
void OAIGenerateDataKeyRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIGenerateDataKeyRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIGenerateDataKeyRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

QMap OAIGenerateDataKeyRequest::getEncryptionContext() const {
    return m_encryption_context;
}
void OAIGenerateDataKeyRequest::setEncryptionContext(const QMap &encryption_context) {
    m_encryption_context = encryption_context;
    m_encryption_context_isSet = true;
}

bool OAIGenerateDataKeyRequest::is_encryption_context_Set() const{
    return m_encryption_context_isSet;
}

bool OAIGenerateDataKeyRequest::is_encryption_context_Valid() const{
    return m_encryption_context_isValid;
}

qint32 OAIGenerateDataKeyRequest::getNumberOfBytes() const {
    return m_number_of_bytes;
}
void OAIGenerateDataKeyRequest::setNumberOfBytes(const qint32 &number_of_bytes) {
    m_number_of_bytes = number_of_bytes;
    m_number_of_bytes_isSet = true;
}

bool OAIGenerateDataKeyRequest::is_number_of_bytes_Set() const{
    return m_number_of_bytes_isSet;
}

bool OAIGenerateDataKeyRequest::is_number_of_bytes_Valid() const{
    return m_number_of_bytes_isValid;
}

OAIDataKeySpec OAIGenerateDataKeyRequest::getKeySpec() const {
    return m_key_spec;
}
void OAIGenerateDataKeyRequest::setKeySpec(const OAIDataKeySpec &key_spec) {
    m_key_spec = key_spec;
    m_key_spec_isSet = true;
}

bool OAIGenerateDataKeyRequest::is_key_spec_Set() const{
    return m_key_spec_isSet;
}

bool OAIGenerateDataKeyRequest::is_key_spec_Valid() const{
    return m_key_spec_isValid;
}

QList OAIGenerateDataKeyRequest::getGrantTokens() const {
    return m_grant_tokens;
}
void OAIGenerateDataKeyRequest::setGrantTokens(const QList &grant_tokens) {
    m_grant_tokens = grant_tokens;
    m_grant_tokens_isSet = true;
}

bool OAIGenerateDataKeyRequest::is_grant_tokens_Set() const{
    return m_grant_tokens_isSet;
}

bool OAIGenerateDataKeyRequest::is_grant_tokens_Valid() const{
    return m_grant_tokens_isValid;
}

OAIGenerateDataKeyRequest_Recipient OAIGenerateDataKeyRequest::getRecipient() const {
    return m_recipient;
}
void OAIGenerateDataKeyRequest::setRecipient(const OAIGenerateDataKeyRequest_Recipient &recipient) {
    m_recipient = recipient;
    m_recipient_isSet = true;
}

bool OAIGenerateDataKeyRequest::is_recipient_Set() const{
    return m_recipient_isSet;
}

bool OAIGenerateDataKeyRequest::is_recipient_Valid() const{
    return m_recipient_isValid;
}

bool OAIGenerateDataKeyRequest::getDryRun() const {
    return m_dry_run;
}
void OAIGenerateDataKeyRequest::setDryRun(const bool &dry_run) {
    m_dry_run = dry_run;
    m_dry_run_isSet = true;
}

bool OAIGenerateDataKeyRequest::is_dry_run_Set() const{
    return m_dry_run_isSet;
}

bool OAIGenerateDataKeyRequest::is_dry_run_Valid() const{
    return m_dry_run_isValid;
}

bool OAIGenerateDataKeyRequest::isSet() const {
...
bool OAIGenerateDataKeyRequest::isValid() const {
