...
/*
 * OAIDeleteCustomKeyStoreRequest.h
 *
 * 
 */

#ifndef OAIDeleteCustomKeyStoreRequest_H
#define OAIDeleteCustomKeyStoreRequest_H
...
class OAIDeleteCustomKeyStoreRequest : public OAIObject {
public:
    OAIDeleteCustomKeyStoreRequest();
    OAIDeleteCustomKeyStoreRequest(QString json);
    ~OAIDeleteCustomKeyStoreRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteCustomKeyStoreRequest)

#endif // OAIDeleteCustomKeyStoreRequest_H
