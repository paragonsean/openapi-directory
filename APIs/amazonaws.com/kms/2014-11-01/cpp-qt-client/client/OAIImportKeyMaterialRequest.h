...
/*
 * OAIImportKeyMaterialRequest.h
 *
 * 
 */

#ifndef OAIImportKeyMaterialRequest_H
#define OAIImportKeyMaterialRequest_H
...
class OAIImportKeyMaterialRequest : public OAIObject {
public:
    OAIImportKeyMaterialRequest();
    OAIImportKeyMaterialRequest(QString json);
    ~OAIImportKeyMaterialRequest() override;
    ...
    QString getEncryptedKeyMaterial() const;
    void setEncryptedKeyMaterial(const QString &encrypted_key_material);
    bool is_encrypted_key_material_Set() const;
    bool is_encrypted_key_material_Valid() const;
...
private:
    ...
    QString m_encrypted_key_material;
    bool m_encrypted_key_material_isSet;
    bool m_encrypted_key_material_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportKeyMaterialRequest)

#endif // OAIImportKeyMaterialRequest_H
