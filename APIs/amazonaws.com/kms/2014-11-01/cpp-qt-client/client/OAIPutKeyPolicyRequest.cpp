...
OAIPutKeyPolicyRequest::OAIPutKeyPolicyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutKeyPolicyRequest::OAIPutKeyPolicyRequest() {
    this->initializeModel();
}

OAIPutKeyPolicyRequest::~OAIPutKeyPolicyRequest() {}

void OAIPutKeyPolicyRequest::initializeModel() {
...
void OAIPutKeyPolicyRequest::fromJson(QString jsonString) {
...
void OAIPutKeyPolicyRequest::fromJsonObject(QJsonObject json) {
...
QString OAIPutKeyPolicyRequest::asJson() const {
...
QJsonObject OAIPutKeyPolicyRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAIPutKeyPolicyRequest::getKeyId() const {
    return m_key_id;
}
void OAIPutKeyPolicyRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIPutKeyPolicyRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIPutKeyPolicyRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

QString OAIPutKeyPolicyRequest::getPolicyName() const {
    return m_policy_name;
}
void OAIPutKeyPolicyRequest::setPolicyName(const QString &policy_name) {
    m_policy_name = policy_name;
    m_policy_name_isSet = true;
}

bool OAIPutKeyPolicyRequest::is_policy_name_Set() const{
    return m_policy_name_isSet;
}

bool OAIPutKeyPolicyRequest::is_policy_name_Valid() const{
    return m_policy_name_isValid;
}

QString OAIPutKeyPolicyRequest::getPolicy() const {
    return m_policy;
}
void OAIPutKeyPolicyRequest::setPolicy(const QString &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAIPutKeyPolicyRequest::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAIPutKeyPolicyRequest::is_policy_Valid() const{
    return m_policy_isValid;
}

bool OAIPutKeyPolicyRequest::getBypassPolicyLockoutSafetyCheck() const {
    return m_bypass_policy_lockout_safety_check;
}
void OAIPutKeyPolicyRequest::setBypassPolicyLockoutSafetyCheck(const bool &bypass_policy_lockout_safety_check) {
    m_bypass_policy_lockout_safety_check = bypass_policy_lockout_safety_check;
    m_bypass_policy_lockout_safety_check_isSet = true;
}

bool OAIPutKeyPolicyRequest::is_bypass_policy_lockout_safety_check_Set() const{
    return m_bypass_policy_lockout_safety_check_isSet;
}

bool OAIPutKeyPolicyRequest::is_bypass_policy_lockout_safety_check_Valid() const{
    return m_bypass_policy_lockout_safety_check_isValid;
}

bool OAIPutKeyPolicyRequest::isSet() const {
...
bool OAIPutKeyPolicyRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_key_id_isValid && m_policy_name_isValid && m_policy_isValid && true;
}
