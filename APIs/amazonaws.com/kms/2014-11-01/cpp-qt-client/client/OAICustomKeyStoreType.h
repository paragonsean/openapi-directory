...
/*
 * OAICustomKeyStoreType.h
 *
 * 
 */

#ifndef OAICustomKeyStoreType_H
#define OAICustomKeyStoreType_H
...
class OAICustomKeyStoreType : public OAIEnum {
public:
    OAICustomKeyStoreType();
    OAICustomKeyStoreType(QString json);
    ~OAICustomKeyStoreType() override;
    ...
    enum class eOAICustomKeyStoreType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        AWS_CLOUDHSM, 
        EXTERNAL_KEY_STORE
    };
    OAICustomKeyStoreType::eOAICustomKeyStoreType getValue() const;
    void setValue(const OAICustomKeyStoreType::eOAICustomKeyStoreType& value);
...
private:
    ...
    eOAICustomKeyStoreType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomKeyStoreType)

#endif // OAICustomKeyStoreType_H
