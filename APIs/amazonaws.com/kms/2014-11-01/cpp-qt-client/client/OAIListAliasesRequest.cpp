...
QString OAIListAliasesRequest::getKeyId() const {
    return m_key_id;
}
void OAIListAliasesRequest::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIListAliasesRequest::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIListAliasesRequest::is_key_id_Valid() const{
    return m_key_id_isValid;
}

qint32 OAIListAliasesRequest::getLimit() const {
    return m_limit;
}
void OAIListAliasesRequest::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIListAliasesRequest::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIListAliasesRequest::is_limit_Valid() const{
    return m_limit_isValid;
}

QString OAIListAliasesRequest::getMarker() const {
    return m_marker;
}
void OAIListAliasesRequest::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIListAliasesRequest::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIListAliasesRequest::is_marker_Valid() const{
