...
#ifndef OAISignRequest_H
#define OAISignRequest_H
...
class OAISignRequest : public OAIObject {
public:
    OAISignRequest();
    OAISignRequest(QString json);
    ~OAISignRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISignRequest)

#endif // OAISignRequest_H
