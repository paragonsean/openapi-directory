...
/*
 * OAIEnableKeyRotationRequest.h
 *
 * 
 */

#ifndef OAIEnableKeyRotationRequest_H
#define OAIEnableKeyRotationRequest_H
...
class OAIEnableKeyRotationRequest : public OAIObject {
public:
    OAIEnableKeyRotationRequest();
    OAIEnableKeyRotationRequest(QString json);
    ~OAIEnableKeyRotationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnableKeyRotationRequest)

#endif // OAIEnableKeyRotationRequest_H
