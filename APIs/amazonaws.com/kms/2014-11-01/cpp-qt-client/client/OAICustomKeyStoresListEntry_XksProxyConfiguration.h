...
/*
 * OAICustomKeyStoresListEntry_XksProxyConfiguration.h
 *
 * 
 */

#ifndef OAICustomKeyStoresListEntry_XksProxyConfiguration_H
#define OAICustomKeyStoresListEntry_XksProxyConfiguration_H
...
class OAICustomKeyStoresListEntry_XksProxyConfiguration : public OAIObject {
public:
    OAICustomKeyStoresListEntry_XksProxyConfiguration();
    OAICustomKeyStoresListEntry_XksProxyConfiguration(QString json);
    ~OAICustomKeyStoresListEntry_XksProxyConfiguration() override;
    ...
    OAIXksProxyConnectivityType getConnectivity() const;
    void setConnectivity(const OAIXksProxyConnectivityType &connectivity);
    ...
    QString getUriEndpoint() const;
    void setUriEndpoint(const QString &uri_endpoint);
    bool is_uri_endpoint_Set() const;
    bool is_uri_endpoint_Valid() const;
    ...
    QString getVpcEndpointServiceName() const;
    void setVpcEndpointServiceName(const QString &vpc_endpoint_service_name);
    bool is_vpc_endpoint_service_name_Set() const;
    bool is_vpc_endpoint_service_name_Valid() const;
...
private:
    ...
    OAIXksProxyConnectivityType m_connectivity;
    ...
    QString m_uri_endpoint;
    bool m_uri_endpoint_isSet;
    bool m_uri_endpoint_isValid;

    QString m_uri_path;
    bool m_uri_path_isSet;
    bool m_uri_path_isValid;

    QString m_vpc_endpoint_service_name;
    bool m_vpc_endpoint_service_name_isSet;
    bool m_vpc_endpoint_service_name_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICustomKeyStoresListEntry_XksProxyConfiguration)

#endif // OAICustomKeyStoresListEntry_XksProxyConfiguration_H
