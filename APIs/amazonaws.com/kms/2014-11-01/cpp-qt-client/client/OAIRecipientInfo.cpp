...
OAIRecipientInfo::OAIRecipientInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRecipientInfo::OAIRecipientInfo() {
    this->initializeModel();
}

OAIRecipientInfo::~OAIRecipientInfo() {}

void OAIRecipientInfo::initializeModel() {
...
void OAIRecipientInfo::fromJson(QString jsonString) {
...
void OAIRecipientInfo::fromJsonObject(QJsonObject json) {
...
QString OAIRecipientInfo::asJson() const {
...
QJsonObject OAIRecipientInfo::asJsonObject() const {
    QJsonObject obj;
...
OAIKeyEncryptionMechanism OAIRecipientInfo::getKeyEncryptionAlgorithm() const {
    return m_key_encryption_algorithm;
}
void OAIRecipientInfo::setKeyEncryptionAlgorithm(const OAIKeyEncryptionMechanism &key_encryption_algorithm) {
    m_key_encryption_algorithm = key_encryption_algorithm;
    m_key_encryption_algorithm_isSet = true;
}

bool OAIRecipientInfo::is_key_encryption_algorithm_Set() const{
    return m_key_encryption_algorithm_isSet;
}

bool OAIRecipientInfo::is_key_encryption_algorithm_Valid() const{
    return m_key_encryption_algorithm_isValid;
}

QString OAIRecipientInfo::getAttestationDocument() const {
    return m_attestation_document;
}
void OAIRecipientInfo::setAttestationDocument(const QString &attestation_document) {
    m_attestation_document = attestation_document;
    m_attestation_document_isSet = true;
}

bool OAIRecipientInfo::is_attestation_document_Set() const{
    return m_attestation_document_isSet;
}

bool OAIRecipientInfo::is_attestation_document_Valid() const{
    return m_attestation_document_isValid;
}

bool OAIRecipientInfo::isSet() const {
...
bool OAIRecipientInfo::isValid() const {
