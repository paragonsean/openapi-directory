...
#ifndef OAIGrantListEntry_H
#define OAIGrantListEntry_H
...
namespace OpenAPI {
class OAIGrantListEntry_Constraints;

class OAIGrantListEntry : public OAIObject {
public:
    OAIGrantListEntry();
    OAIGrantListEntry(QString json);
    ~OAIGrantListEntry() override;
    ...
    QString getGranteePrincipal() const;
    void setGranteePrincipal(const QString &grantee_principal);
    bool is_grantee_principal_Set() const;
    bool is_grantee_principal_Valid() const;
    ...
    QString getIssuingAccount() const;
    void setIssuingAccount(const QString &issuing_account);
    bool is_issuing_account_Set() const;
    bool is_issuing_account_Valid() const;
    ...
    OAIGrantListEntry_Constraints getConstraints() const;
    void setConstraints(const OAIGrantListEntry_Constraints &constraints);
...
private:
    ...
    QString m_grantee_principal;
    bool m_grantee_principal_isSet;
    bool m_grantee_principal_isValid;

    QString m_retiring_principal;
    bool m_retiring_principal_isSet;
    bool m_retiring_principal_isValid;

    QString m_issuing_account;
    bool m_issuing_account_isSet;
    bool m_issuing_account_isValid;

    QList m_operations;
    bool m_operations_isSet;
    bool m_operations_isValid;

    OAIGrantListEntry_Constraints m_constraints;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGrantListEntry)

#endif // OAIGrantListEntry_H
