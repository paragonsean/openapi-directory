...
/*
 * OAIGenerateDataKeyWithoutPlaintextRequest.h
 *
 * 
 */

#ifndef OAIGenerateDataKeyWithoutPlaintextRequest_H
#define OAIGenerateDataKeyWithoutPlaintextRequest_H

#include <QJsonObject>

#include "OAIDataKeySpec.h"
#include <QList>
#include <QMap>
#include <QString>
...
class OAIGenerateDataKeyWithoutPlaintextRequest : public OAIObject {
public:
    OAIGenerateDataKeyWithoutPlaintextRequest();
    OAIGenerateDataKeyWithoutPlaintextRequest(QString json);
    ~OAIGenerateDataKeyWithoutPlaintextRequest() override;
    ...
    OAIDataKeySpec getKeySpec() const;
    void setKeySpec(const OAIDataKeySpec &key_spec);
    bool is_key_spec_Set() const;
    bool is_key_spec_Valid() const;

    qint32 getNumberOfBytes() const;
    void setNumberOfBytes(const qint32 &number_of_bytes);
    bool is_number_of_bytes_Set() const;
    bool is_number_of_bytes_Valid() const;
...
private:
    ...
    OAIDataKeySpec m_key_spec;
    bool m_key_spec_isSet;
    bool m_key_spec_isValid;

    qint32 m_number_of_bytes;
    bool m_number_of_bytes_isSet;
    bool m_number_of_bytes_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGenerateDataKeyWithoutPlaintextRequest)

#endif // OAIGenerateDataKeyWithoutPlaintextRequest_H
