...
OAIGenerateDataKeyWithoutPlaintextResponse::OAIGenerateDataKeyWithoutPlaintextResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGenerateDataKeyWithoutPlaintextResponse::OAIGenerateDataKeyWithoutPlaintextResponse() {
    this->initializeModel();
}

OAIGenerateDataKeyWithoutPlaintextResponse::~OAIGenerateDataKeyWithoutPlaintextResponse() {}

void OAIGenerateDataKeyWithoutPlaintextResponse::initializeModel() {
...
void OAIGenerateDataKeyWithoutPlaintextResponse::fromJson(QString jsonString) {
...
void OAIGenerateDataKeyWithoutPlaintextResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGenerateDataKeyWithoutPlaintextResponse::asJson() const {
...
QJsonObject OAIGenerateDataKeyWithoutPlaintextResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGenerateDataKeyWithoutPlaintextResponse::getCiphertextBlob() const {
    return m_ciphertext_blob;
}
void OAIGenerateDataKeyWithoutPlaintextResponse::setCiphertextBlob(const QString &ciphertext_blob) {
    m_ciphertext_blob = ciphertext_blob;
    m_ciphertext_blob_isSet = true;
}

bool OAIGenerateDataKeyWithoutPlaintextResponse::is_ciphertext_blob_Set() const{
    return m_ciphertext_blob_isSet;
}

bool OAIGenerateDataKeyWithoutPlaintextResponse::is_ciphertext_blob_Valid() const{
    return m_ciphertext_blob_isValid;
}

QString OAIGenerateDataKeyWithoutPlaintextResponse::getKeyId() const {
    return m_key_id;
}
void OAIGenerateDataKeyWithoutPlaintextResponse::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIGenerateDataKeyWithoutPlaintextResponse::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIGenerateDataKeyWithoutPlaintextResponse::is_key_id_Valid() const{
    return m_key_id_isValid;
}

bool OAIGenerateDataKeyWithoutPlaintextResponse::isSet() const {
...
bool OAIGenerateDataKeyWithoutPlaintextResponse::isValid() const {
