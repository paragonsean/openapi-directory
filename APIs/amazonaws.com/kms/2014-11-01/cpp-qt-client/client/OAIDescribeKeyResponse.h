...
namespace OpenAPI {
class OAIDescribeKeyResponse_KeyMetadata;
...
public:
    ...
    OAIDescribeKeyResponse_KeyMetadata getKeyMetadata() const;
    void setKeyMetadata(const OAIDescribeKeyResponse_KeyMetadata &key_metadata);
    bool is_key_metadata_Set() const;
    bool is_key_metadata_Valid() const;
...
private:
    ...
    OAIDescribeKeyResponse_KeyMetadata m_key_metadata;
    bool m_key_metadata_isSet;
    bool m_key_metadata_isValid;
};
