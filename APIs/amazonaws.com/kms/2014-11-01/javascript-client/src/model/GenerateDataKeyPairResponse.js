...
/**
 * The GenerateDataKeyPairResponse model module.
 * @module model/GenerateDataKeyPairResponse
 * @version 2014-11-01
 */
class GenerateDataKeyPairResponse {
    /**
     * Constructs a new <code>GenerateDataKeyPairResponse</code>.
     * @alias module:model/GenerateDataKeyPairResponse
     */
    constructor() { 
        
        GenerateDataKeyPairResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GenerateDataKeyPairResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenerateDataKeyPairResponse} obj Optional instance to populate.
     * @return {module:model/GenerateDataKeyPairResponse} The populated <code>GenerateDataKeyPairResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenerateDataKeyPairResponse();

            if (data.hasOwnProperty('PrivateKeyCiphertextBlob')) {
                obj['PrivateKeyCiphertextBlob'] = ApiClient.convertToType(data['PrivateKeyCiphertextBlob'], 'String');
            }
            if (data.hasOwnProperty('PrivateKeyPlaintext')) {
                obj['PrivateKeyPlaintext'] = ApiClient.convertToType(data['PrivateKeyPlaintext'], 'String');
            }
            ...
            if (data.hasOwnProperty('CiphertextForRecipient')) {
                obj['CiphertextForRecipient'] = ApiClient.convertToType(data['CiphertextForRecipient'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateDataKeyPairResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateDataKeyPairResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `PrivateKeyCiphertextBlob`
        if (data['PrivateKeyCiphertextBlob']) { // data not null
          String.validateJSON(data['PrivateKeyCiphertextBlob']);
        }
        // validate the optional field `PrivateKeyPlaintext`
        if (data['PrivateKeyPlaintext']) { // data not null
          String.validateJSON(data['PrivateKeyPlaintext']);
        }
        ...
        if (data['CiphertextForRecipient']) { // data not null
          String.validateJSON(data['CiphertextForRecipient']);
        }
...
/**
 * @member {String} PrivateKeyCiphertextBlob
 */
GenerateDataKeyPairResponse.prototype['PrivateKeyCiphertextBlob'] = undefined;

/**
 * @member {String} PrivateKeyPlaintext
 */
GenerateDataKeyPairResponse.prototype['PrivateKeyPlaintext'] = undefined;

/**
 * @member {String} PublicKey
 */
GenerateDataKeyPairResponse.prototype['PublicKey'] = undefined;

/**
 * @member {String} KeyId
 */
GenerateDataKeyPairResponse.prototype['KeyId'] = undefined;

/**
 * @member {module:model/DataKeyPairSpec} KeyPairSpec
 */
GenerateDataKeyPairResponse.prototype['KeyPairSpec'] = undefined;

/**
 * @member {String} CiphertextForRecipient
 */
GenerateDataKeyPairResponse.prototype['CiphertextForRecipient'] = undefined;
...
export default GenerateDataKeyPairResponse;
