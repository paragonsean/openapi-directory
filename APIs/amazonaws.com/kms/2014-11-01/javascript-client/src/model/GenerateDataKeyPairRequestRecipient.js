...
/**
 * The GenerateDataKeyPairRequestRecipient model module.
 * @module model/GenerateDataKeyPairRequestRecipient
 * @version 2014-11-01
 */
class GenerateDataKeyPairRequestRecipient {
    /**
     * Constructs a new <code>GenerateDataKeyPairRequestRecipient</code>.
     * @alias module:model/GenerateDataKeyPairRequestRecipient
     * @implements module:model/RecipientInfo
     */
    constructor() { 
        RecipientInfo.initialize(this);
        GenerateDataKeyPairRequestRecipient.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GenerateDataKeyPairRequestRecipient</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenerateDataKeyPairRequestRecipient} obj Optional instance to populate.
     * @return {module:model/GenerateDataKeyPairRequestRecipient} The populated <code>GenerateDataKeyPairRequestRecipient</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenerateDataKeyPairRequestRecipient();
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateDataKeyPairRequestRecipient</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateDataKeyPairRequestRecipient</code>.
     */
 ...
 */
GenerateDataKeyPairRequestRecipient.prototype['KeyEncryptionAlgorithm'] = undefined;

/**
 * @member {String} AttestationDocument
 */
GenerateDataKeyPairRequestRecipient.prototype['AttestationDocument'] = undefined;
...
export default GenerateDataKeyPairRequestRecipient;
