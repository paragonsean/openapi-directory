...
/**
 * The MultiRegionConfigurationPrimaryKey model module.
 * @module model/MultiRegionConfigurationPrimaryKey
 * @version 2014-11-01
 */
class MultiRegionConfigurationPrimaryKey {
    /**
     * Constructs a new <code>MultiRegionConfigurationPrimaryKey</code>.
     * @alias module:model/MultiRegionConfigurationPrimaryKey
     * @implements module:model/MultiRegionKey
     */
    constructor() { 
        MultiRegionKey.initialize(this);
        MultiRegionConfigurationPrimaryKey.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MultiRegionConfigurationPrimaryKey</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MultiRegionConfigurationPrimaryKey} obj Optional instance to populate.
     * @return {module:model/MultiRegionConfigurationPrimaryKey} The populated <code>MultiRegionConfigurationPrimaryKey</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MultiRegionConfigurationPrimaryKey();
            MultiRegionKey.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>MultiRegionConfigurationPrimaryKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MultiRegionConfigurationPrimaryKey</code>.
     */
 ...
 * @member {String} Arn
 */
MultiRegionConfigurationPrimaryKey.prototype['Arn'] = undefined;

/**
 * @member {String} Region
 */
MultiRegionConfigurationPrimaryKey.prototype['Region'] = undefined;


// Implement MultiRegionKey interface:
/**
 * @member {String} Arn
 */
MultiRegionKey.prototype['Arn'] = undefined;
/**
 * @member {String} Region
 */
MultiRegionKey.prototype['Region'] = undefined;




export default MultiRegionConfigurationPrimaryKey;
