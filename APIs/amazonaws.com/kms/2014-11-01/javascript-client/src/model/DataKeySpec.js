...
* @readonly
*/
export default class DataKeySpec {
    ...
    /**
    * Returns a <code>DataKeySpec</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DataKeySpec} The enum <code>DataKeySpec</code> value.
    */
