...
* @readonly
*/
export default class KeyEncryptionMechanism {
    ...
    /**
    * Returns a <code>KeyEncryptionMechanism</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/KeyEncryptionMechanism} The enum <code>KeyEncryptionMechanism</code> value.
    */
