...
/**
 * The DescribeKeyRequest model module.
 * @module model/DescribeKeyRequest
 * @version 2014-11-01
 */
class DescribeKeyRequest {
    /**
     * Constructs a new <code>DescribeKeyRequest</code>.
     * @alias module:model/DescribeKeyRequest
     * @param keyId {String} 
     */
    constructor(keyId) { 
        
        DescribeKeyRequest.initialize(this, keyId);
    }
    ...
    /**
     * Constructs a <code>DescribeKeyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeKeyRequest} obj Optional instance to populate.
     * @return {module:model/DescribeKeyRequest} The populated <code>DescribeKeyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeKeyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeKeyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeKeyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeKeyRequest.RequiredProperties) {
...
DescribeKeyRequest.RequiredProperties = ["KeyId"];

/**
 * @member {String} KeyId
 */
DescribeKeyRequest.prototype['KeyId'] = undefined;

/**
 * @member {Array} GrantTokens
 */
DescribeKeyRequest.prototype['GrantTokens'] = undefined;
...
export default DescribeKeyRequest;
