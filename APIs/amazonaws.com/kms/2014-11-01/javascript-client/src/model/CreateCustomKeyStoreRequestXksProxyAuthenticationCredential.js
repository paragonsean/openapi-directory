...
/**
 * The CreateCustomKeyStoreRequestXksProxyAuthenticationCredential model module.
 * @module model/CreateCustomKeyStoreRequestXksProxyAuthenticationCredential
 * @version 2014-11-01
 */
class CreateCustomKeyStoreRequestXksProxyAuthenticationCredential {
    /**
     * Constructs a new <code>CreateCustomKeyStoreRequestXksProxyAuthenticationCredential</code>.
     * @alias module:model/CreateCustomKeyStoreRequestXksProxyAuthenticationCredential
    ...
    constructor(accessKeyId, rawSecretAccessKey) { 
        ...
        CreateCustomKeyStoreRequestXksProxyAuthenticationCredential.initialize(this, accessKeyId, rawSecretAccessKey);
    }
    ...
    /**
     * Constructs a <code>CreateCustomKeyStoreRequestXksProxyAuthenticationCredential</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateCustomKeyStoreRequestXksProxyAuthenticationCredential} obj Optional instance to populate.
     * @return {module:model/CreateCustomKeyStoreRequestXksProxyAuthenticationCredential} The populated <code>CreateCustomKeyStoreRequestXksProxyAuthenticationCredential</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateCustomKeyStoreRequestXksProxyAuthenticationCredential();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCustomKeyStoreRequestXksProxyAuthenticationCredential</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCustomKeyStoreRequestXksProxyAuthenticationCredential</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateCustomKeyStoreRequestXksProxyAuthenticationCredential.RequiredProperties) {
...
CreateCustomKeyStoreRequestXksProxyAuthenticationCredential.RequiredProperties = ["AccessKeyId", "RawSecretAccessKey"];

/**
 * @member {String} AccessKeyId
 */
CreateCustomKeyStoreRequestXksProxyAuthenticationCredential.prototype['AccessKeyId'] = undefined;

/**
 * @member {String} RawSecretAccessKey
 */
CreateCustomKeyStoreRequestXksProxyAuthenticationCredential.prototype['RawSecretAccessKey'] = undefined;
...
export default CreateCustomKeyStoreRequestXksProxyAuthenticationCredential;
