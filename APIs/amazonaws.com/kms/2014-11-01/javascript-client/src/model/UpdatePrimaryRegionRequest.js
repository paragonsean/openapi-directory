...
/**
 * The UpdatePrimaryRegionRequest model module.
 * @module model/UpdatePrimaryRegionRequest
 * @version 2014-11-01
 */
class UpdatePrimaryRegionRequest {
    /**
     * Constructs a new <code>UpdatePrimaryRegionRequest</code>.
     * @alias module:model/UpdatePrimaryRegionRequest
     * @param keyId {String} 
     * @param primaryRegion {String} 
     */
    constructor(keyId, primaryRegion) { 
        
        UpdatePrimaryRegionRequest.initialize(this, keyId, primaryRegion);
    }
     ...
     */
    static initialize(obj, keyId, primaryRegion) { 
        obj['KeyId'] = keyId;
        obj['PrimaryRegion'] = primaryRegion;
    }

    /**
     * Constructs a <code>UpdatePrimaryRegionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePrimaryRegionRequest} obj Optional instance to populate.
     * @return {module:model/UpdatePrimaryRegionRequest} The populated <code>UpdatePrimaryRegionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePrimaryRegionRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePrimaryRegionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePrimaryRegionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdatePrimaryRegionRequest.RequiredProperties) {
...
UpdatePrimaryRegionRequest.RequiredProperties = ["KeyId", "PrimaryRegion"];

/**
 * @member {String} KeyId
 */
UpdatePrimaryRegionRequest.prototype['KeyId'] = undefined;

/**
 * @member {String} PrimaryRegion
 */
UpdatePrimaryRegionRequest.prototype['PrimaryRegion'] = undefined;
...
export default UpdatePrimaryRegionRequest;
