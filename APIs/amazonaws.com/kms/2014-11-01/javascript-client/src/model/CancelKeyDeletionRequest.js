...
/**
 * The CancelKeyDeletionRequest model module.
 * @module model/CancelKeyDeletionRequest
 * @version 2014-11-01
 */
class CancelKeyDeletionRequest {
    /**
     * Constructs a new <code>CancelKeyDeletionRequest</code>.
     * @alias module:model/CancelKeyDeletionRequest
     * @param keyId {String} 
     */
    constructor(keyId) { 
        
        CancelKeyDeletionRequest.initialize(this, keyId);
    }
    ...
    /**
     * Constructs a <code>CancelKeyDeletionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CancelKeyDeletionRequest} obj Optional instance to populate.
     * @return {module:model/CancelKeyDeletionRequest} The populated <code>CancelKeyDeletionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CancelKeyDeletionRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CancelKeyDeletionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CancelKeyDeletionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CancelKeyDeletionRequest.RequiredProperties) {
...
CancelKeyDeletionRequest.RequiredProperties = ["KeyId"];

/**
 * @member {String} KeyId
 */
CancelKeyDeletionRequest.prototype['KeyId'] = undefined;
...
export default CancelKeyDeletionRequest;
