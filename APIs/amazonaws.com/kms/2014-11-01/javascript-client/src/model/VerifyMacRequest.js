...
import MacAlgorithmSpec from './MacAlgorithmSpec';

/**
 * The VerifyMacRequest model module.
 * @module model/VerifyMacRequest
 * @version 2014-11-01
 */
class VerifyMacRequest {
    /**
     * Constructs a new <code>VerifyMacRequest</code>.
     * @alias module:model/VerifyMacRequest
     * @param message {String} 
     * @param keyId {String} 
     * @param macAlgorithm {module:model/MacAlgorithmSpec} 
     * @param mac {String} 
     */
    constructor(message, keyId, macAlgorithm, mac) { 
        
        VerifyMacRequest.initialize(this, message, keyId, macAlgorithm, mac);
    }
     ...
     */
    static initialize(obj, message, keyId, macAlgorithm, mac) { 
        obj['Message'] = message;
        obj['KeyId'] = keyId;
        obj['MacAlgorithm'] = macAlgorithm;
        obj['Mac'] = mac;
    }

    /**
     * Constructs a <code>VerifyMacRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VerifyMacRequest} obj Optional instance to populate.
     * @return {module:model/VerifyMacRequest} The populated <code>VerifyMacRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VerifyMacRequest();
            ...
            if (data.hasOwnProperty('MacAlgorithm')) {
                obj['MacAlgorithm'] = ApiClient.convertToType(data['MacAlgorithm'], MacAlgorithmSpec);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>VerifyMacRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VerifyMacRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of VerifyMacRequest.RequiredProperties) {
        ...
        if (data['MacAlgorithm']) { // data not null
          MacAlgorithmSpec.validateJSON(data['MacAlgorithm']);
        }
        // validate the optional field `Mac`
        if (data['Mac']) { // data not null
          String.validateJSON(data['Mac']);
        }
...
VerifyMacRequest.RequiredProperties = ["Message", "KeyId", "MacAlgorithm", "Mac"];

/**
 * @member {String} Message
 */
VerifyMacRequest.prototype['Message'] = undefined;

/**
 * @member {String} KeyId
 */
VerifyMacRequest.prototype['KeyId'] = undefined;

/**
 * @member {module:model/MacAlgorithmSpec} MacAlgorithm
 */
VerifyMacRequest.prototype['MacAlgorithm'] = undefined;

/**
 * @member {String} Mac
 */
VerifyMacRequest.prototype['Mac'] = undefined;

/**
 * @member {Array} GrantTokens
 */
VerifyMacRequest.prototype['GrantTokens'] = undefined;

/**
 * @member {Boolean} DryRun
 */
VerifyMacRequest.prototype['DryRun'] = undefined;
...
export default VerifyMacRequest;
