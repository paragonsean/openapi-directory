...
import DescribeKeyResponseKeyMetadata from './DescribeKeyResponseKeyMetadata';
...
class DescribeKeyResponse {
    ...
    constructor() { 
        ...
        DescribeKeyResponse.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('KeyMetadata')) {
                obj['KeyMetadata'] = DescribeKeyResponseKeyMetadata.constructFromObject(data['KeyMetadata']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        // validate the optional field `KeyMetadata`
        if (data['KeyMetadata']) { // data not null
          DescribeKeyResponseKeyMetadata.validateJSON(data['KeyMetadata']);
        }
...
/**
 * @member {module:model/DescribeKeyResponseKeyMetadata} KeyMetadata
 */
DescribeKeyResponse.prototype['KeyMetadata'] = undefined;
