...
/**
 * The GenerateDataKeyRequestRecipient model module.
 * @module model/GenerateDataKeyRequestRecipient
 * @version 2014-11-01
 */
class GenerateDataKeyRequestRecipient {
    /**
     * Constructs a new <code>GenerateDataKeyRequestRecipient</code>.
     * @alias module:model/GenerateDataKeyRequestRecipient
     * @implements module:model/RecipientInfo
     */
    constructor() { 
        RecipientInfo.initialize(this);
        GenerateDataKeyRequestRecipient.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GenerateDataKeyRequestRecipient</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenerateDataKeyRequestRecipient} obj Optional instance to populate.
     * @return {module:model/GenerateDataKeyRequestRecipient} The populated <code>GenerateDataKeyRequestRecipient</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenerateDataKeyRequestRecipient();
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateDataKeyRequestRecipient</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateDataKeyRequestRecipient</code>.
     */
 ...
 */
GenerateDataKeyRequestRecipient.prototype['KeyEncryptionAlgorithm'] = undefined;

/**
 * @member {String} AttestationDocument
 */
GenerateDataKeyRequestRecipient.prototype['AttestationDocument'] = undefined;
...
export default GenerateDataKeyRequestRecipient;
