...
/**
 * The EnableKeyRotationRequest model module.
 * @module model/EnableKeyRotationRequest
 * @version 2014-11-01
 */
class EnableKeyRotationRequest {
    /**
     * Constructs a new <code>EnableKeyRotationRequest</code>.
     * @alias module:model/EnableKeyRotationRequest
     * @param keyId {String} 
     */
    constructor(keyId) { 
        
        EnableKeyRotationRequest.initialize(this, keyId);
    }
    ...
    /**
     * Constructs a <code>EnableKeyRotationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EnableKeyRotationRequest} obj Optional instance to populate.
     * @return {module:model/EnableKeyRotationRequest} The populated <code>EnableKeyRotationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EnableKeyRotationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>EnableKeyRotationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EnableKeyRotationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EnableKeyRotationRequest.RequiredProperties) {
...
EnableKeyRotationRequest.RequiredProperties = ["KeyId"];

/**
 * @member {String} KeyId
 */
EnableKeyRotationRequest.prototype['KeyId'] = undefined;
...
export default EnableKeyRotationRequest;
