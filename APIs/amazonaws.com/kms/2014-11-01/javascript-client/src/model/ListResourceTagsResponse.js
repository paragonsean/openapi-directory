...
/**
 * The ListResourceTagsResponse model module.
 * @module model/ListResourceTagsResponse
 * @version 2014-11-01
 */
class ListResourceTagsResponse {
    /**
     * Constructs a new <code>ListResourceTagsResponse</code>.
     * @alias module:model/ListResourceTagsResponse
     */
    constructor() { 
        
        ListResourceTagsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListResourceTagsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListResourceTagsResponse} obj Optional instance to populate.
     * @return {module:model/ListResourceTagsResponse} The populated <code>ListResourceTagsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListResourceTagsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListResourceTagsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListResourceTagsResponse</code>.
     */
 ...
 * @member {Array} Tags
 */
ListResourceTagsResponse.prototype['Tags'] = undefined;

/**
 * @member {String} NextMarker
 */
ListResourceTagsResponse.prototype['NextMarker'] = undefined;

/**
 * @member {Boolean} Truncated
 */
ListResourceTagsResponse.prototype['Truncated'] = undefined;
...
export default ListResourceTagsResponse;
