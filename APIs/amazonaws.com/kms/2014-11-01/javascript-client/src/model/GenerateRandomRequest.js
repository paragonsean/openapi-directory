...
import GenerateRandomRequestRecipient from './GenerateRandomRequestRecipient';

/**
 * The GenerateRandomRequest model module.
 * @module model/GenerateRandomRequest
 * @version 2014-11-01
 */
class GenerateRandomRequest {
    /**
     * Constructs a new <code>GenerateRandomRequest</code>.
     * @alias module:model/GenerateRandomRequest
     */
    constructor() { 
        
        GenerateRandomRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GenerateRandomRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenerateRandomRequest} obj Optional instance to populate.
     * @return {module:model/GenerateRandomRequest} The populated <code>GenerateRandomRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenerateRandomRequest();

            if (data.hasOwnProperty('NumberOfBytes')) {
                obj['NumberOfBytes'] = ApiClient.convertToType(data['NumberOfBytes'], 'Number');
            }
            if (data.hasOwnProperty('CustomKeyStoreId')) {
                obj['CustomKeyStoreId'] = ApiClient.convertToType(data['CustomKeyStoreId'], 'String');
            }
            if (data.hasOwnProperty('Recipient')) {
                obj['Recipient'] = GenerateRandomRequestRecipient.constructFromObject(data['Recipient']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateRandomRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateRandomRequest</code>.
     */
    static validateJSON(data) {
        // validate the optional field `NumberOfBytes`
        if (data['NumberOfBytes']) { // data not null
          Number.validateJSON(data['NumberOfBytes']);
        }
        ...
        if (data['Recipient']) { // data not null
          GenerateRandomRequestRecipient.validateJSON(data['Recipient']);
        }
...
/**
 * @member {Number} NumberOfBytes
 */
GenerateRandomRequest.prototype['NumberOfBytes'] = undefined;

/**
 * @member {String} CustomKeyStoreId
 */
GenerateRandomRequest.prototype['CustomKeyStoreId'] = undefined;

/**
 * @member {module:model/GenerateRandomRequestRecipient} Recipient
 */
GenerateRandomRequest.prototype['Recipient'] = undefined;
