...
/**
 * The CreateCustomKeyStoreResponse model module.
 * @module model/CreateCustomKeyStoreResponse
 * @version 2014-11-01
 */
class CreateCustomKeyStoreResponse {
    /**
     * Constructs a new <code>CreateCustomKeyStoreResponse</code>.
     * @alias module:model/CreateCustomKeyStoreResponse
     */
    constructor() { 
        
        CreateCustomKeyStoreResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateCustomKeyStoreResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateCustomKeyStoreResponse} obj Optional instance to populate.
     * @return {module:model/CreateCustomKeyStoreResponse} The populated <code>CreateCustomKeyStoreResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateCustomKeyStoreResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCustomKeyStoreResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCustomKeyStoreResponse</code>.
     */
 ...
 */
CreateCustomKeyStoreResponse.prototype['CustomKeyStoreId'] = undefined;
...
export default CreateCustomKeyStoreResponse;
