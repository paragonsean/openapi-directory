...
class SignRequest {
     ...
     */
    constructor(keyId, message, signingAlgorithm) { 
        
        SignRequest.initialize(this, keyId, message, signingAlgorithm);
    }
     ...
     */
    static initialize(obj, keyId, message, signingAlgorithm) { 
        obj['KeyId'] = keyId;
        obj['Message'] = message;
    ...
    static validateJSON(data) {
        ...
        for (const property of SignRequest.RequiredProperties) {
...
SignRequest.RequiredProperties = ["KeyId", "Message", "SigningAlgorithm"];

/**
 * @member {String} KeyId
 */
SignRequest.prototype['KeyId'] = undefined;

/**
 * @member {String} Message
 */
SignRequest.prototype['Message'] = undefined;

/**
 * @member {module:model/MessageType} MessageType
 */
SignRequest.prototype['MessageType'] = undefined;

/**
 * @member {Array} GrantTokens
 */
SignRequest.prototype['GrantTokens'] = undefined;

/**
 * @member {module:model/SigningAlgorithmSpec} SigningAlgorithm
 */
SignRequest.prototype['SigningAlgorithm'] = undefined;

/**
 * @member {Boolean} DryRun
 */
SignRequest.prototype['DryRun'] = undefined;
