...
/**
 * The RevokeGrantRequest model module.
 * @module model/RevokeGrantRequest
 * @version 2014-11-01
 */
class RevokeGrantRequest {
    /**
     * Constructs a new <code>RevokeGrantRequest</code>.
     * @alias module:model/RevokeGrantRequest
     * @param keyId {String} 
     * @param grantId {String} 
     */
    constructor(keyId, grantId) { 
        
        RevokeGrantRequest.initialize(this, keyId, grantId);
    }
     ...
     */
    static initialize(obj, keyId, grantId) { 
        obj['KeyId'] = keyId;
        obj['GrantId'] = grantId;
    }

    /**
     * Constructs a <code>RevokeGrantRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RevokeGrantRequest} obj Optional instance to populate.
     * @return {module:model/RevokeGrantRequest} The populated <code>RevokeGrantRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RevokeGrantRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>RevokeGrantRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RevokeGrantRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RevokeGrantRequest.RequiredProperties) {
...
RevokeGrantRequest.RequiredProperties = ["KeyId", "GrantId"];

/**
 * @member {String} KeyId
 */
RevokeGrantRequest.prototype['KeyId'] = undefined;

/**
 * @member {String} GrantId
 */
RevokeGrantRequest.prototype['GrantId'] = undefined;

/**
 * @member {Boolean} DryRun
 */
RevokeGrantRequest.prototype['DryRun'] = undefined;
...
export default RevokeGrantRequest;
