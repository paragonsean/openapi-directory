...
import SigningAlgorithmSpec from './SigningAlgorithmSpec';
...
class VerifyRequest {
     ...
     * @param signingAlgorithm {module:model/SigningAlgorithmSpec} 
     */
    constructor(keyId, message, signature, signingAlgorithm) { 
        
        VerifyRequest.initialize(this, keyId, message, signature, signingAlgorithm);
    }
     ...
     */
    static initialize(obj, keyId, message, signature, signingAlgorithm) { 
        obj['KeyId'] = keyId;
        obj['Message'] = message;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('SigningAlgorithm')) {
                obj['SigningAlgorithm'] = ApiClient.convertToType(data['SigningAlgorithm'], SigningAlgorithmSpec);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['SigningAlgorithm']) { // data not null
          SigningAlgorithmSpec.validateJSON(data['SigningAlgorithm']);
        }
...
VerifyRequest.RequiredProperties = ["KeyId", "Message", "Signature", "SigningAlgorithm"];
 ...
 */
VerifyRequest.prototype['Message'] = undefined;

/**
 * @member {module:model/MessageType} MessageType
 */
VerifyRequest.prototype['MessageType'] = undefined;

/**
 * @member {String} Signature
 */
VerifyRequest.prototype['Signature'] = undefined;

/**
 * @member {module:model/SigningAlgorithmSpec} SigningAlgorithm
 */
VerifyRequest.prototype['SigningAlgorithm'] = undefined;

/**
 * @member {Array} GrantTokens
 */
VerifyRequest.prototype['GrantTokens'] = undefined;

/**
 * @member {Boolean} DryRun
 */
VerifyRequest.prototype['DryRun'] = undefined;
