...
/**
 * The GenerateRandomResponse model module.
 * @module model/GenerateRandomResponse
 * @version 2014-11-01
 */
class GenerateRandomResponse {
    /**
     * Constructs a new <code>GenerateRandomResponse</code>.
     * @alias module:model/GenerateRandomResponse
     */
    constructor() { 
        
        GenerateRandomResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GenerateRandomResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenerateRandomResponse} obj Optional instance to populate.
     * @return {module:model/GenerateRandomResponse} The populated <code>GenerateRandomResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenerateRandomResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateRandomResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateRandomResponse</code>.
     */
 ...
 */
GenerateRandomResponse.prototype['Plaintext'] = undefined;

/**
 * @member {String} CiphertextForRecipient
 */
GenerateRandomResponse.prototype['CiphertextForRecipient'] = undefined;
...
export default GenerateRandomResponse;
