...
/**
 * The GetParametersForImportResponse model module.
 * @module model/GetParametersForImportResponse
 * @version 2014-11-01
 */
class GetParametersForImportResponse {
    /**
     * Constructs a new <code>GetParametersForImportResponse</code>.
     * @alias module:model/GetParametersForImportResponse
     */
    constructor() { 
        
        GetParametersForImportResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetParametersForImportResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetParametersForImportResponse} obj Optional instance to populate.
     * @return {module:model/GetParametersForImportResponse} The populated <code>GetParametersForImportResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetParametersForImportResponse();
            ...
            if (data.hasOwnProperty('ParametersValidTo')) {
                obj['ParametersValidTo'] = ApiClient.convertToType(data['ParametersValidTo'], 'Date');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetParametersForImportResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetParametersForImportResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['ParametersValidTo']) { // data not null
          Date.validateJSON(data['ParametersValidTo']);
        }
 ...
 * @member {String} KeyId
 */
GetParametersForImportResponse.prototype['KeyId'] = undefined;

/**
 * @member {String} ImportToken
 */
GetParametersForImportResponse.prototype['ImportToken'] = undefined;

/**
 * @member {String} PublicKey
 */
GetParametersForImportResponse.prototype['PublicKey'] = undefined;

/**
 * @member {Date} ParametersValidTo
 */
GetParametersForImportResponse.prototype['ParametersValidTo'] = undefined;
...
export default GetParametersForImportResponse;
