...
/**
 * The ListResourceTagsRequest model module.
 * @module model/ListResourceTagsRequest
 * @version 2014-11-01
 */
class ListResourceTagsRequest {
    /**
     * Constructs a new <code>ListResourceTagsRequest</code>.
     * @alias module:model/ListResourceTagsRequest
     * @param keyId {String} 
     */
    constructor(keyId) { 
        
        ListResourceTagsRequest.initialize(this, keyId);
    }
    ...
    /**
     * Constructs a <code>ListResourceTagsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListResourceTagsRequest} obj Optional instance to populate.
     * @return {module:model/ListResourceTagsRequest} The populated <code>ListResourceTagsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListResourceTagsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListResourceTagsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListResourceTagsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListResourceTagsRequest.RequiredProperties) {
...
ListResourceTagsRequest.RequiredProperties = ["KeyId"];

/**
 * @member {String} KeyId
 */
ListResourceTagsRequest.prototype['KeyId'] = undefined;

/**
 * @member {Number} Limit
 */
ListResourceTagsRequest.prototype['Limit'] = undefined;

/**
 * @member {String} Marker
 */
ListResourceTagsRequest.prototype['Marker'] = undefined;
...
export default ListResourceTagsRequest;
