...
/**
 * The XksProxyAuthenticationCredentialType model module.
 * @module model/XksProxyAuthenticationCredentialType
 * @version 2014-11-01
 */
class XksProxyAuthenticationCredentialType {
    /**
     * Constructs a new <code>XksProxyAuthenticationCredentialType</code>.
     ...
     * @alias module:model/XksProxyAuthenticationCredentialType
    ...
    /**
     * Constructs a <code>XksProxyAuthenticationCredentialType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/XksProxyAuthenticationCredentialType} obj Optional instance to populate.
     * @return {module:model/XksProxyAuthenticationCredentialType} The populated <code>XksProxyAuthenticationCredentialType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new XksProxyAuthenticationCredentialType();
    ...
    /**
     * Validates the JSON data with respect to <code>XksProxyAuthenticationCredentialType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>XksProxyAuthenticationCredentialType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of XksProxyAuthenticationCredentialType.RequiredProperties) {
...
XksProxyAuthenticationCredentialType.RequiredProperties = ["AccessKeyId", "RawSecretAccessKey"];
...
export default XksProxyAuthenticationCredentialType;
