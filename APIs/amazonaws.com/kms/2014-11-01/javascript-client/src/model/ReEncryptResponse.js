...
/**
 * The ReEncryptResponse model module.
 * @module model/ReEncryptResponse
 * @version 2014-11-01
 */
class ReEncryptResponse {
    /**
     * Constructs a new <code>ReEncryptResponse</code>.
     * @alias module:model/ReEncryptResponse
     */
    constructor() { 
        
        ReEncryptResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ReEncryptResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReEncryptResponse} obj Optional instance to populate.
     * @return {module:model/ReEncryptResponse} The populated <code>ReEncryptResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReEncryptResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ReEncryptResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReEncryptResponse</code>.
     */
 ...
 */
ReEncryptResponse.prototype['CiphertextBlob'] = undefined;

/**
 * @member {String} SourceKeyId
 */
ReEncryptResponse.prototype['SourceKeyId'] = undefined;

/**
 * @member {String} KeyId
 */
ReEncryptResponse.prototype['KeyId'] = undefined;

/**
 * @member {module:model/EncryptionAlgorithmSpec} SourceEncryptionAlgorithm
 */
ReEncryptResponse.prototype['SourceEncryptionAlgorithm'] = undefined;

/**
 * @member {module:model/EncryptionAlgorithmSpec} DestinationEncryptionAlgorithm
 */
ReEncryptResponse.prototype['DestinationEncryptionAlgorithm'] = undefined;
...
export default ReEncryptResponse;
