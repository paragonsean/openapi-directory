...
/**
 * The GenerateDataKeyPairWithoutPlaintextResponse model module.
 * @module model/GenerateDataKeyPairWithoutPlaintextResponse
 * @version 2014-11-01
 */
class GenerateDataKeyPairWithoutPlaintextResponse {
    /**
     * Constructs a new <code>GenerateDataKeyPairWithoutPlaintextResponse</code>.
     * @alias module:model/GenerateDataKeyPairWithoutPlaintextResponse
     */
    constructor() { 
        
        GenerateDataKeyPairWithoutPlaintextResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GenerateDataKeyPairWithoutPlaintextResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenerateDataKeyPairWithoutPlaintextResponse} obj Optional instance to populate.
     * @return {module:model/GenerateDataKeyPairWithoutPlaintextResponse} The populated <code>GenerateDataKeyPairWithoutPlaintextResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenerateDataKeyPairWithoutPlaintextResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateDataKeyPairWithoutPlaintextResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateDataKeyPairWithoutPlaintextResponse</code>.
     */
 ...
 */
GenerateDataKeyPairWithoutPlaintextResponse.prototype['PrivateKeyCiphertextBlob'] = undefined;

/**
 * @member {String} PublicKey
 */
GenerateDataKeyPairWithoutPlaintextResponse.prototype['PublicKey'] = undefined;

/**
 * @member {String} KeyId
 */
GenerateDataKeyPairWithoutPlaintextResponse.prototype['KeyId'] = undefined;

/**
 * @member {module:model/DataKeyPairSpec} KeyPairSpec
 */
GenerateDataKeyPairWithoutPlaintextResponse.prototype['KeyPairSpec'] = undefined;
...
export default GenerateDataKeyPairWithoutPlaintextResponse;
