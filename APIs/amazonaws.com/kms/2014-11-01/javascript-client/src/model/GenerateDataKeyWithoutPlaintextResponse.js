...
/**
 * The GenerateDataKeyWithoutPlaintextResponse model module.
 * @module model/GenerateDataKeyWithoutPlaintextResponse
 * @version 2014-11-01
 */
class GenerateDataKeyWithoutPlaintextResponse {
    /**
     * Constructs a new <code>GenerateDataKeyWithoutPlaintextResponse</code>.
     * @alias module:model/GenerateDataKeyWithoutPlaintextResponse
     */
    constructor() { 
        
        GenerateDataKeyWithoutPlaintextResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GenerateDataKeyWithoutPlaintextResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenerateDataKeyWithoutPlaintextResponse} obj Optional instance to populate.
     * @return {module:model/GenerateDataKeyWithoutPlaintextResponse} The populated <code>GenerateDataKeyWithoutPlaintextResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenerateDataKeyWithoutPlaintextResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateDataKeyWithoutPlaintextResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateDataKeyWithoutPlaintextResponse</code>.
     */
 ...
 */
GenerateDataKeyWithoutPlaintextResponse.prototype['CiphertextBlob'] = undefined;

/**
 * @member {String} KeyId
 */
GenerateDataKeyWithoutPlaintextResponse.prototype['KeyId'] = undefined;
...
export default GenerateDataKeyWithoutPlaintextResponse;
