...
* @readonly
*/
export default class DataKeyPairSpec {
    ...
    /**
    * Returns a <code>DataKeyPairSpec</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DataKeyPairSpec} The enum <code>DataKeyPairSpec</code> value.
    */
