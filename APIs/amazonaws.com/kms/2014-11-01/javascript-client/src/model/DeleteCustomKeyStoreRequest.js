...
/**
 * The DeleteCustomKeyStoreRequest model module.
 * @module model/DeleteCustomKeyStoreRequest
 * @version 2014-11-01
 */
class DeleteCustomKeyStoreRequest {
    /**
     * Constructs a new <code>DeleteCustomKeyStoreRequest</code>.
     * @alias module:model/DeleteCustomKeyStoreRequest
     * @param customKeyStoreId {String} 
     */
    constructor(customKeyStoreId) { 
        
        DeleteCustomKeyStoreRequest.initialize(this, customKeyStoreId);
    }
    ...
    /**
     * Constructs a <code>DeleteCustomKeyStoreRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteCustomKeyStoreRequest} obj Optional instance to populate.
     * @return {module:model/DeleteCustomKeyStoreRequest} The populated <code>DeleteCustomKeyStoreRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteCustomKeyStoreRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteCustomKeyStoreRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteCustomKeyStoreRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteCustomKeyStoreRequest.RequiredProperties) {
...
DeleteCustomKeyStoreRequest.RequiredProperties = ["CustomKeyStoreId"];

/**
 * @member {String} CustomKeyStoreId
 */
DeleteCustomKeyStoreRequest.prototype['CustomKeyStoreId'] = undefined;
...
export default DeleteCustomKeyStoreRequest;
