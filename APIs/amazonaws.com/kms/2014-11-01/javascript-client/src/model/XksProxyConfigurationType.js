...
/**
 * The XksProxyConfigurationType model module.
 * @module model/XksProxyConfigurationType
 * @version 2014-11-01
 */
class XksProxyConfigurationType {
    /**
     * Constructs a new <code>XksProxyConfigurationType</code>.
     ...
     * @alias module:model/XksProxyConfigurationType
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>XksProxyConfigurationType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/XksProxyConfigurationType} obj Optional instance to populate.
     * @return {module:model/XksProxyConfigurationType} The populated <code>XksProxyConfigurationType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new XksProxyConfigurationType();
    ...
    /**
     * Validates the JSON data with respect to <code>XksProxyConfigurationType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>XksProxyConfigurationType</code>.
     */
...
export default XksProxyConfigurationType;
