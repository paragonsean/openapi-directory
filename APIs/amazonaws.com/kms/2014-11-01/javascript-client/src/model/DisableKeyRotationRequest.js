...
/**
 * The DisableKeyRotationRequest model module.
 * @module model/DisableKeyRotationRequest
 * @version 2014-11-01
 */
class DisableKeyRotationRequest {
    /**
     * Constructs a new <code>DisableKeyRotationRequest</code>.
     * @alias module:model/DisableKeyRotationRequest
     * @param keyId {String} 
     */
    constructor(keyId) { 
        
        DisableKeyRotationRequest.initialize(this, keyId);
    }
    ...
    /**
     * Constructs a <code>DisableKeyRotationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisableKeyRotationRequest} obj Optional instance to populate.
     * @return {module:model/DisableKeyRotationRequest} The populated <code>DisableKeyRotationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisableKeyRotationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DisableKeyRotationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisableKeyRotationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DisableKeyRotationRequest.RequiredProperties) {
...
DisableKeyRotationRequest.RequiredProperties = ["KeyId"];

/**
 * @member {String} KeyId
 */
DisableKeyRotationRequest.prototype['KeyId'] = undefined;
...
export default DisableKeyRotationRequest;
