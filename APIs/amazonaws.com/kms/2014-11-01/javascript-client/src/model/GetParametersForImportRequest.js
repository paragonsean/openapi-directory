...
import WrappingKeySpec from './WrappingKeySpec';

/**
 * The GetParametersForImportRequest model module.
 * @module model/GetParametersForImportRequest
 * @version 2014-11-01
 */
class GetParametersForImportRequest {
    /**
     * Constructs a new <code>GetParametersForImportRequest</code>.
     * @alias module:model/GetParametersForImportRequest
     * @param keyId {String} 
     * @param wrappingAlgorithm {module:model/AlgorithmSpec} 
     * @param wrappingKeySpec {module:model/WrappingKeySpec} 
     */
    constructor(keyId, wrappingAlgorithm, wrappingKeySpec) { 
        
        GetParametersForImportRequest.initialize(this, keyId, wrappingAlgorithm, wrappingKeySpec);
    }
     ...
     */
    static initialize(obj, keyId, wrappingAlgorithm, wrappingKeySpec) { 
        obj['KeyId'] = keyId;
        obj['WrappingAlgorithm'] = wrappingAlgorithm;
        obj['WrappingKeySpec'] = wrappingKeySpec;
    }

    /**
     * Constructs a <code>GetParametersForImportRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetParametersForImportRequest} obj Optional instance to populate.
     * @return {module:model/GetParametersForImportRequest} The populated <code>GetParametersForImportRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetParametersForImportRequest();

            if (data.hasOwnProperty('KeyId')) {
                obj['KeyId'] = ApiClient.convertToType(data['KeyId'], 'String');
            }
            if (data.hasOwnProperty('WrappingAlgorithm')) {
                obj['WrappingAlgorithm'] = ApiClient.convertToType(data['WrappingAlgorithm'], AlgorithmSpec);
            }
            if (data.hasOwnProperty('WrappingKeySpec')) {
                obj['WrappingKeySpec'] = ApiClient.convertToType(data['WrappingKeySpec'], WrappingKeySpec);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetParametersForImportRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetParametersForImportRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetParametersForImportRequest.RequiredProperties) {
        ...
        // validate the optional field `WrappingAlgorithm`
        if (data['WrappingAlgorithm']) { // data not null
          AlgorithmSpec.validateJSON(data['WrappingAlgorithm']);
        }
        // validate the optional field `WrappingKeySpec`
        if (data['WrappingKeySpec']) { // data not null
          WrappingKeySpec.validateJSON(data['WrappingKeySpec']);
        }
...
GetParametersForImportRequest.RequiredProperties = ["KeyId", "WrappingAlgorithm", "WrappingKeySpec"];

/**
 * @member {String} KeyId
 */
GetParametersForImportRequest.prototype['KeyId'] = undefined;

/**
 * @member {module:model/AlgorithmSpec} WrappingAlgorithm
 */
GetParametersForImportRequest.prototype['WrappingAlgorithm'] = undefined;

/**
 * @member {module:model/WrappingKeySpec} WrappingKeySpec
 */
GetParametersForImportRequest.prototype['WrappingKeySpec'] = undefined;
...
export default GetParametersForImportRequest;
