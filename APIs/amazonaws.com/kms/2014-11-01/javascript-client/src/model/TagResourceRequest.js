...
class TagResourceRequest {
     ...
     * @param tags {Array} 
     */
    constructor(keyId, tags) { 
        
        TagResourceRequest.initialize(this, keyId, tags);
    }
     ...
     */
    static initialize(obj, keyId, tags) { 
        obj['KeyId'] = keyId;
        obj['Tags'] = tags;
    }
...
TagResourceRequest.RequiredProperties = ["KeyId", "Tags"];

/**
 * @member {String} KeyId
 */
TagResourceRequest.prototype['KeyId'] = undefined;
