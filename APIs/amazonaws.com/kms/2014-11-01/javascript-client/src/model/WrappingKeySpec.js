...
* @readonly
*/
export default class WrappingKeySpec {
    ...
    /**
    * Returns a <code>WrappingKeySpec</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/WrappingKeySpec} The enum <code>WrappingKeySpec</code> value.
    */
