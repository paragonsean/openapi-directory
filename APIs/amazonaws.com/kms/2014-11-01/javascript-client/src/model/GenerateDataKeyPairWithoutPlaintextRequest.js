...
import DataKeyPairSpec from './DataKeyPairSpec';

/**
 * The GenerateDataKeyPairWithoutPlaintextRequest model module.
 * @module model/GenerateDataKeyPairWithoutPlaintextRequest
 * @version 2014-11-01
 */
class GenerateDataKeyPairWithoutPlaintextRequest {
    /**
     * Constructs a new <code>GenerateDataKeyPairWithoutPlaintextRequest</code>.
     * @alias module:model/GenerateDataKeyPairWithoutPlaintextRequest
     * @param keyId {String} 
     * @param keyPairSpec {module:model/DataKeyPairSpec} 
     */
    constructor(keyId, keyPairSpec) { 
        
        GenerateDataKeyPairWithoutPlaintextRequest.initialize(this, keyId, keyPairSpec);
    }
     ...
     */
    static initialize(obj, keyId, keyPairSpec) { 
        obj['KeyId'] = keyId;
        obj['KeyPairSpec'] = keyPairSpec;
    }

    /**
     * Constructs a <code>GenerateDataKeyPairWithoutPlaintextRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenerateDataKeyPairWithoutPlaintextRequest} obj Optional instance to populate.
     * @return {module:model/GenerateDataKeyPairWithoutPlaintextRequest} The populated <code>GenerateDataKeyPairWithoutPlaintextRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenerateDataKeyPairWithoutPlaintextRequest();

            if (data.hasOwnProperty('EncryptionContext')) {
                obj['EncryptionContext'] = ApiClient.convertToType(data['EncryptionContext'], Object);
            }
            if (data.hasOwnProperty('KeyId')) {
                obj['KeyId'] = ApiClient.convertToType(data['KeyId'], 'String');
            }
            if (data.hasOwnProperty('KeyPairSpec')) {
                obj['KeyPairSpec'] = ApiClient.convertToType(data['KeyPairSpec'], DataKeyPairSpec);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateDataKeyPairWithoutPlaintextRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateDataKeyPairWithoutPlaintextRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GenerateDataKeyPairWithoutPlaintextRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `EncryptionContext`
        if (data['EncryptionContext']) { // data not null
          Object.validateJSON(data['EncryptionContext']);
        }
        ...
        if (data['KeyPairSpec']) { // data not null
          DataKeyPairSpec.validateJSON(data['KeyPairSpec']);
        }
...
GenerateDataKeyPairWithoutPlaintextRequest.RequiredProperties = ["KeyId", "KeyPairSpec"];

/**
 * @member {Object} EncryptionContext
 */
GenerateDataKeyPairWithoutPlaintextRequest.prototype['EncryptionContext'] = undefined;

/**
 * @member {String} KeyId
 */
GenerateDataKeyPairWithoutPlaintextRequest.prototype['KeyId'] = undefined;

/**
 * @member {module:model/DataKeyPairSpec} KeyPairSpec
 */
GenerateDataKeyPairWithoutPlaintextRequest.prototype['KeyPairSpec'] = undefined;

/**
 * @member {Array} GrantTokens
 */
GenerateDataKeyPairWithoutPlaintextRequest.prototype['GrantTokens'] = undefined;

/**
 * @member {Boolean} DryRun
 */
GenerateDataKeyPairWithoutPlaintextRequest.prototype['DryRun'] = undefined;
...
export default GenerateDataKeyPairWithoutPlaintextRequest;
