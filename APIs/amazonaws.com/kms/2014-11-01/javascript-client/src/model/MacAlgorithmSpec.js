...
* @readonly
*/
export default class MacAlgorithmSpec {
    ...
    /**
    * Returns a <code>MacAlgorithmSpec</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/MacAlgorithmSpec} The enum <code>MacAlgorithmSpec</code> value.
    */
