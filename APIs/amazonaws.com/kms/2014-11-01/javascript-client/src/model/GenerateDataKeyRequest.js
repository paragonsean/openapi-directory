...
import DataKeySpec from './DataKeySpec';
import GenerateDataKeyRequestRecipient from './GenerateDataKeyRequestRecipient';

/**
 * The GenerateDataKeyRequest model module.
 * @module model/GenerateDataKeyRequest
 * @version 2014-11-01
 */
class GenerateDataKeyRequest {
    /**
     * Constructs a new <code>GenerateDataKeyRequest</code>.
     * @alias module:model/GenerateDataKeyRequest
     * @param keyId {String} 
     */
    constructor(keyId) { 
        
        GenerateDataKeyRequest.initialize(this, keyId);
    }
    ...
    /**
     * Constructs a <code>GenerateDataKeyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenerateDataKeyRequest} obj Optional instance to populate.
     * @return {module:model/GenerateDataKeyRequest} The populated <code>GenerateDataKeyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenerateDataKeyRequest();
            ...
            if (data.hasOwnProperty('KeySpec')) {
                obj['KeySpec'] = ApiClient.convertToType(data['KeySpec'], DataKeySpec);
            }
            if (data.hasOwnProperty('GrantTokens')) {
                obj['GrantTokens'] = ApiClient.convertToType(data['GrantTokens'], Array);
            }
            if (data.hasOwnProperty('Recipient')) {
                obj['Recipient'] = GenerateDataKeyRequestRecipient.constructFromObject(data['Recipient']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateDataKeyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateDataKeyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GenerateDataKeyRequest.RequiredProperties) {
        ...
        if (data['KeySpec']) { // data not null
          DataKeySpec.validateJSON(data['KeySpec']);
        }
        ...
        if (data['Recipient']) { // data not null
          GenerateDataKeyRequestRecipient.validateJSON(data['Recipient']);
        }
...
GenerateDataKeyRequest.RequiredProperties = ["KeyId"];

/**
 * @member {String} KeyId
 */
GenerateDataKeyRequest.prototype['KeyId'] = undefined;

/**
 * @member {Object} EncryptionContext
 */
GenerateDataKeyRequest.prototype['EncryptionContext'] = undefined;

/**
 * @member {Number} NumberOfBytes
 */
GenerateDataKeyRequest.prototype['NumberOfBytes'] = undefined;

/**
 * @member {module:model/DataKeySpec} KeySpec
 */
GenerateDataKeyRequest.prototype['KeySpec'] = undefined;

/**
 * @member {Array} GrantTokens
 */
GenerateDataKeyRequest.prototype['GrantTokens'] = undefined;

/**
 * @member {module:model/GenerateDataKeyRequestRecipient} Recipient
 */
GenerateDataKeyRequest.prototype['Recipient'] = undefined;

/**
 * @member {Boolean} DryRun
 */
GenerateDataKeyRequest.prototype['DryRun'] = undefined;
...
export default GenerateDataKeyRequest;
