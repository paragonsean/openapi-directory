...
/**
 * The ListGrantsRequest model module.
 * @module model/ListGrantsRequest
 * @version 2014-11-01
 */
class ListGrantsRequest {
    /**
     * Constructs a new <code>ListGrantsRequest</code>.
     * @alias module:model/ListGrantsRequest
     * @param keyId {String} 
     */
    constructor(keyId) { 
        
        ListGrantsRequest.initialize(this, keyId);
    }
    ...
    /**
     * Constructs a <code>ListGrantsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListGrantsRequest} obj Optional instance to populate.
     * @return {module:model/ListGrantsRequest} The populated <code>ListGrantsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListGrantsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListGrantsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListGrantsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListGrantsRequest.RequiredProperties) {
...
ListGrantsRequest.RequiredProperties = ["KeyId"];

/**
 * @member {Number} Limit
 */
ListGrantsRequest.prototype['Limit'] = undefined;

/**
 * @member {String} Marker
 */
ListGrantsRequest.prototype['Marker'] = undefined;

/**
 * @member {String} KeyId
 */
ListGrantsRequest.prototype['KeyId'] = undefined;

/**
 * @member {String} GrantId
 */
ListGrantsRequest.prototype['GrantId'] = undefined;

/**
 * @member {String} GranteePrincipal
 */
ListGrantsRequest.prototype['GranteePrincipal'] = undefined;
...
export default ListGrantsRequest;
