...
* @readonly
*/
export default class KeyUsageType {
    ...
    /**
    * Returns a <code>KeyUsageType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/KeyUsageType} The enum <code>KeyUsageType</code> value.
    */
