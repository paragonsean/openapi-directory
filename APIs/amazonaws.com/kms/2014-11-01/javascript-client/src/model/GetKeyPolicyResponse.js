...
/**
 * The GetKeyPolicyResponse model module.
 * @module model/GetKeyPolicyResponse
 * @version 2014-11-01
 */
class GetKeyPolicyResponse {
    /**
     * Constructs a new <code>GetKeyPolicyResponse</code>.
     * @alias module:model/GetKeyPolicyResponse
     */
    constructor() { 
        
        GetKeyPolicyResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetKeyPolicyResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetKeyPolicyResponse} obj Optional instance to populate.
     * @return {module:model/GetKeyPolicyResponse} The populated <code>GetKeyPolicyResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetKeyPolicyResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetKeyPolicyResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetKeyPolicyResponse</code>.
     */
 ...
 */
GetKeyPolicyResponse.prototype['Policy'] = undefined;
...
export default GetKeyPolicyResponse;
