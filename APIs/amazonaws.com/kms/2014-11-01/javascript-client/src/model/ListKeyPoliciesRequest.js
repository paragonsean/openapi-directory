...
/**
 * The ListKeyPoliciesRequest model module.
 * @module model/ListKeyPoliciesRequest
 * @version 2014-11-01
 */
class ListKeyPoliciesRequest {
    /**
     * Constructs a new <code>ListKeyPoliciesRequest</code>.
     * @alias module:model/ListKeyPoliciesRequest
     * @param keyId {String} 
     */
    constructor(keyId) { 
        
        ListKeyPoliciesRequest.initialize(this, keyId);
    }
    ...
    /**
     * Constructs a <code>ListKeyPoliciesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListKeyPoliciesRequest} obj Optional instance to populate.
     * @return {module:model/ListKeyPoliciesRequest} The populated <code>ListKeyPoliciesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListKeyPoliciesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListKeyPoliciesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListKeyPoliciesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListKeyPoliciesRequest.RequiredProperties) {
...
ListKeyPoliciesRequest.RequiredProperties = ["KeyId"];

/**
 * @member {String} KeyId
 */
ListKeyPoliciesRequest.prototype['KeyId'] = undefined;

/**
 * @member {Number} Limit
 */
ListKeyPoliciesRequest.prototype['Limit'] = undefined;

/**
 * @member {String} Marker
 */
ListKeyPoliciesRequest.prototype['Marker'] = undefined;
...
export default ListKeyPoliciesRequest;
