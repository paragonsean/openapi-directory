...
import CreateGrantRequestConstraints from './CreateGrantRequestConstraints';
...
class CreateGrantRequest {
     ...
     * @param keyId {String} 
     * @param granteePrincipal {String} 
     * @param operations {Array} 
     */
    constructor(keyId, granteePrincipal, operations) { 
        
        CreateGrantRequest.initialize(this, keyId, granteePrincipal, operations);
    }
     ...
     */
    static initialize(obj, keyId, granteePrincipal, operations) { 
        obj['KeyId'] = keyId;
        obj['GranteePrincipal'] = granteePrincipal;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('GranteePrincipal')) {
                obj['GranteePrincipal'] = ApiClient.convertToType(data['GranteePrincipal'], 'String');
            }
            if (data.hasOwnProperty('RetiringPrincipal')) {
                obj['RetiringPrincipal'] = ApiClient.convertToType(data['RetiringPrincipal'], 'String');
            }
            if (data.hasOwnProperty('Operations')) {
                obj['Operations'] = ApiClient.convertToType(data['Operations'], Array);
            }
            if (data.hasOwnProperty('Constraints')) {
                obj['Constraints'] = CreateGrantRequestConstraints.constructFromObject(data['Constraints']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['GranteePrincipal']) { // data not null
          String.validateJSON(data['GranteePrincipal']);
        }
        // validate the optional field `RetiringPrincipal`
        if (data['RetiringPrincipal']) { // data not null
          String.validateJSON(data['RetiringPrincipal']);
        }
        ...
        if (data['Constraints']) { // data not null
          CreateGrantRequestConstraints.validateJSON(data['Constraints']);
        }
...
CreateGrantRequest.RequiredProperties = ["KeyId", "GranteePrincipal", "Operations"];

/**
 * @member {String} KeyId
 */
CreateGrantRequest.prototype['KeyId'] = undefined;

/**
 * @member {String} GranteePrincipal
 */
CreateGrantRequest.prototype['GranteePrincipal'] = undefined;

/**
 * @member {String} RetiringPrincipal
 */
CreateGrantRequest.prototype['RetiringPrincipal'] = undefined;

/**
 * @member {Array} Operations
 */
CreateGrantRequest.prototype['Operations'] = undefined;

/**
 * @member {module:model/CreateGrantRequestConstraints} Constraints
 */
CreateGrantRequest.prototype['Constraints'] = undefined;

/**
 * @member {Array} GrantTokens
 */
CreateGrantRequest.prototype['GrantTokens'] = undefined;

/**
 * @member {String} Name
 */
CreateGrantRequest.prototype['Name'] = undefined;

/**
 * @member {Boolean} DryRun
 */
CreateGrantRequest.prototype['DryRun'] = undefined;
