...
/**
 * The MultiRegionKey model module.
 * @module model/MultiRegionKey
 * @version 2014-11-01
 */
class MultiRegionKey {
    /**
     * Constructs a new <code>MultiRegionKey</code>.
     * Describes the primary or replica key in a multi-Region key.
     * @alias module:model/MultiRegionKey
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>MultiRegionKey</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MultiRegionKey} obj Optional instance to populate.
     * @return {module:model/MultiRegionKey} The populated <code>MultiRegionKey</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MultiRegionKey();
    ...
    /**
     * Validates the JSON data with respect to <code>MultiRegionKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MultiRegionKey</code>.
     */
