...
import GrantListEntryConstraints from './GrantListEntryConstraints';

/**
 * The GrantListEntry model module.
 * @module model/GrantListEntry
 * @version 2014-11-01
 */
class GrantListEntry {
    /**
     * Constructs a new <code>GrantListEntry</code>.
     * Contains information about a grant.
     * @alias module:model/GrantListEntry
     */
    constructor() { 
        
        GrantListEntry.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GrantListEntry</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GrantListEntry} obj Optional instance to populate.
     * @return {module:model/GrantListEntry} The populated <code>GrantListEntry</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GrantListEntry();
            ...
            if (data.hasOwnProperty('IssuingAccount')) {
                obj['IssuingAccount'] = ApiClient.convertToType(data['IssuingAccount'], 'String');
            }
            if (data.hasOwnProperty('Operations')) {
                obj['Operations'] = ApiClient.convertToType(data['Operations'], Array);
            }
            if (data.hasOwnProperty('Constraints')) {
                obj['Constraints'] = GrantListEntryConstraints.constructFromObject(data['Constraints']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GrantListEntry</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GrantListEntry</code>.
     */
    static validateJSON(data) {
        ...
        if (data['IssuingAccount']) { // data not null
          String.validateJSON(data['IssuingAccount']);
        }
        ...
        if (data['Constraints']) { // data not null
          GrantListEntryConstraints.validateJSON(data['Constraints']);
        }
 ...
 * @member {String} KeyId
 */
GrantListEntry.prototype['KeyId'] = undefined;

/**
 * @member {String} GrantId
 */
GrantListEntry.prototype['GrantId'] = undefined;

/**
 * @member {String} Name
 */
GrantListEntry.prototype['Name'] = undefined;

/**
 * @member {Date} CreationDate
 */
GrantListEntry.prototype['CreationDate'] = undefined;

/**
 * @member {String} GranteePrincipal
 */
GrantListEntry.prototype['GranteePrincipal'] = undefined;

/**
 * @member {String} RetiringPrincipal
 */
GrantListEntry.prototype['RetiringPrincipal'] = undefined;

/**
 * @member {String} IssuingAccount
 */
GrantListEntry.prototype['IssuingAccount'] = undefined;

/**
 * @member {Array} Operations
 */
GrantListEntry.prototype['Operations'] = undefined;

/**
 * @member {module:model/GrantListEntryConstraints} Constraints
 */
GrantListEntry.prototype['Constraints'] = undefined;
