...
/**
 * The GenerateMacResponse model module.
 * @module model/GenerateMacResponse
 * @version 2014-11-01
 */
class GenerateMacResponse {
    /**
     * Constructs a new <code>GenerateMacResponse</code>.
     * @alias module:model/GenerateMacResponse
     */
    constructor() { 
        
        GenerateMacResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GenerateMacResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenerateMacResponse} obj Optional instance to populate.
     * @return {module:model/GenerateMacResponse} The populated <code>GenerateMacResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenerateMacResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateMacResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateMacResponse</code>.
     */
 ...
 * @member {String} Mac
 */
GenerateMacResponse.prototype['Mac'] = undefined;

/**
 * @member {module:model/MacAlgorithmSpec} MacAlgorithm
 */
GenerateMacResponse.prototype['MacAlgorithm'] = undefined;

/**
 * @member {String} KeyId
 */
GenerateMacResponse.prototype['KeyId'] = undefined;
...
export default GenerateMacResponse;
