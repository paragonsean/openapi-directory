...
* @readonly
*/
export default class GrantOperation {
    ...
    /**
    * Returns a <code>GrantOperation</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/GrantOperation} The enum <code>GrantOperation</code> value.
    */
