...
* @readonly
*/
export default class AlgorithmSpec {
        ...
        /**
         * value: "RSA_AES_KEY_WRAP_SHA_256"
         * @const
         */
    ...
    /**
    * Returns a <code>AlgorithmSpec</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AlgorithmSpec} The enum <code>AlgorithmSpec</code> value.
    */
