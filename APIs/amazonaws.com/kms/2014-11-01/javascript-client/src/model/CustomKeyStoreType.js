...
* @readonly
*/
export default class CustomKeyStoreType {
    ...
    /**
    * Returns a <code>CustomKeyStoreType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CustomKeyStoreType} The enum <code>CustomKeyStoreType</code> value.
    */
