...
/**
 * The CreateGrantRequestConstraints model module.
 * @module model/CreateGrantRequestConstraints
 * @version 2014-11-01
 */
class CreateGrantRequestConstraints {
    /**
     * Constructs a new <code>CreateGrantRequestConstraints</code>.
     * @alias module:model/CreateGrantRequestConstraints
     * @implements module:model/GrantConstraints
     */
    constructor() { 
        GrantConstraints.initialize(this);
        CreateGrantRequestConstraints.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateGrantRequestConstraints</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateGrantRequestConstraints} obj Optional instance to populate.
     * @return {module:model/CreateGrantRequestConstraints} The populated <code>CreateGrantRequestConstraints</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateGrantRequestConstraints();
            GrantConstraints.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreateGrantRequestConstraints</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateGrantRequestConstraints</code>.
     */
 ...
 */
CreateGrantRequestConstraints.prototype['EncryptionContextSubset'] = undefined;

/**
 * @member {Object} EncryptionContextEquals
 */
CreateGrantRequestConstraints.prototype['EncryptionContextEquals'] = undefined;


// Implement GrantConstraints interface:
/**
 * @member {Object} EncryptionContextSubset
 */
...
export default CreateGrantRequestConstraints;
