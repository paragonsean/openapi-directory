...
/**
 * The ListRetirableGrantsRequest model module.
 * @module model/ListRetirableGrantsRequest
 * @version 2014-11-01
 */
class ListRetirableGrantsRequest {
    /**
     * Constructs a new <code>ListRetirableGrantsRequest</code>.
     * @alias module:model/ListRetirableGrantsRequest
     * @param retiringPrincipal {String} 
     */
    constructor(retiringPrincipal) { 
        
        ListRetirableGrantsRequest.initialize(this, retiringPrincipal);
    }
     ...
     */
    static initialize(obj, retiringPrincipal) { 
        obj['RetiringPrincipal'] = retiringPrincipal;
    }

    /**
     * Constructs a <code>ListRetirableGrantsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListRetirableGrantsRequest} obj Optional instance to populate.
     * @return {module:model/ListRetirableGrantsRequest} The populated <code>ListRetirableGrantsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListRetirableGrantsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListRetirableGrantsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListRetirableGrantsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListRetirableGrantsRequest.RequiredProperties) {
...
ListRetirableGrantsRequest.RequiredProperties = ["RetiringPrincipal"];

/**
 * @member {Number} Limit
 */
ListRetirableGrantsRequest.prototype['Limit'] = undefined;

/**
 * @member {String} Marker
 */
ListRetirableGrantsRequest.prototype['Marker'] = undefined;

/**
 * @member {String} RetiringPrincipal
 */
ListRetirableGrantsRequest.prototype['RetiringPrincipal'] = undefined;
...
export default ListRetirableGrantsRequest;
