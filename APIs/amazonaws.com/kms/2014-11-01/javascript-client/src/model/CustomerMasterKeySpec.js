...
* @readonly
*/
export default class CustomerMasterKeySpec {
    ...
    /**
    * Returns a <code>CustomerMasterKeySpec</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CustomerMasterKeySpec} The enum <code>CustomerMasterKeySpec</code> value.
    */
