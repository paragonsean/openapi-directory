...
export default class KeyState {
    ...
    /**
    * Returns a <code>KeyState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/KeyState} The enum <code>KeyState</code> value.
    */
