...
/**
 * The ScheduleKeyDeletionResponse model module.
 * @module model/ScheduleKeyDeletionResponse
 * @version 2014-11-01
 */
class ScheduleKeyDeletionResponse {
    /**
     * Constructs a new <code>ScheduleKeyDeletionResponse</code>.
     * @alias module:model/ScheduleKeyDeletionResponse
     */
    constructor() { 
        
        ScheduleKeyDeletionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ScheduleKeyDeletionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScheduleKeyDeletionResponse} obj Optional instance to populate.
     * @return {module:model/ScheduleKeyDeletionResponse} The populated <code>ScheduleKeyDeletionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScheduleKeyDeletionResponse();
            ...
            if (data.hasOwnProperty('PendingWindowInDays')) {
                obj['PendingWindowInDays'] = ApiClient.convertToType(data['PendingWindowInDays'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ScheduleKeyDeletionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScheduleKeyDeletionResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['PendingWindowInDays']) { // data not null
          Number.validateJSON(data['PendingWindowInDays']);
        }
 ...
 * @member {String} KeyId
 */
ScheduleKeyDeletionResponse.prototype['KeyId'] = undefined;

/**
 * @member {Date} DeletionDate
 */
ScheduleKeyDeletionResponse.prototype['DeletionDate'] = undefined;

/**
 * @member {module:model/KeyState} KeyState
 */
ScheduleKeyDeletionResponse.prototype['KeyState'] = undefined;

/**
 * @member {Number} PendingWindowInDays
 */
ScheduleKeyDeletionResponse.prototype['PendingWindowInDays'] = undefined;
...
export default ScheduleKeyDeletionResponse;
