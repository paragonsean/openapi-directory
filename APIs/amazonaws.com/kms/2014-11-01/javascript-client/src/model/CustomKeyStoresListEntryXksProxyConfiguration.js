...
/**
 * The CustomKeyStoresListEntryXksProxyConfiguration model module.
 * @module model/CustomKeyStoresListEntryXksProxyConfiguration
 * @version 2014-11-01
 */
class CustomKeyStoresListEntryXksProxyConfiguration {
    /**
     * Constructs a new <code>CustomKeyStoresListEntryXksProxyConfiguration</code>.
     * @alias module:model/CustomKeyStoresListEntryXksProxyConfiguration
     * @implements module:model/XksProxyConfigurationType
     */
    constructor() { 
        XksProxyConfigurationType.initialize(this);
        CustomKeyStoresListEntryXksProxyConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CustomKeyStoresListEntryXksProxyConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CustomKeyStoresListEntryXksProxyConfiguration} obj Optional instance to populate.
     * @return {module:model/CustomKeyStoresListEntryXksProxyConfiguration} The populated <code>CustomKeyStoresListEntryXksProxyConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomKeyStoresListEntryXksProxyConfiguration();
            XksProxyConfigurationType.constructFromObject(data, obj);

            if (data.hasOwnProperty('Connectivity')) {
                obj['Connectivity'] = ApiClient.convertToType(data['Connectivity'], XksProxyConnectivityType);
            }
            if (data.hasOwnProperty('AccessKeyId')) {
                obj['AccessKeyId'] = ApiClient.convertToType(data['AccessKeyId'], 'String');
            }
            if (data.hasOwnProperty('UriEndpoint')) {
                obj['UriEndpoint'] = ApiClient.convertToType(data['UriEndpoint'], 'String');
            }
            if (data.hasOwnProperty('UriPath')) {
                obj['UriPath'] = ApiClient.convertToType(data['UriPath'], 'String');
            }
            if (data.hasOwnProperty('VpcEndpointServiceName')) {
                obj['VpcEndpointServiceName'] = ApiClient.convertToType(data['VpcEndpointServiceName'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CustomKeyStoresListEntryXksProxyConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomKeyStoresListEntryXksProxyConfiguration</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Connectivity`
        if (data['Connectivity']) { // data not null
          XksProxyConnectivityType.validateJSON(data['Connectivity']);
        }
        ...
        if (data['UriEndpoint']) { // data not null
          String.validateJSON(data['UriEndpoint']);
        }
        // validate the optional field `UriPath`
        if (data['UriPath']) { // data not null
          String.validateJSON(data['UriPath']);
        }
        // validate the optional field `VpcEndpointServiceName`
        if (data['VpcEndpointServiceName']) { // data not null
          String.validateJSON(data['VpcEndpointServiceName']);
        }
...
/**
 * @member {module:model/XksProxyConnectivityType} Connectivity
 */
CustomKeyStoresListEntryXksProxyConfiguration.prototype['Connectivity'] = undefined;

/**
 * @member {String} AccessKeyId
 */
CustomKeyStoresListEntryXksProxyConfiguration.prototype['AccessKeyId'] = undefined;

/**
 * @member {String} UriEndpoint
 */
CustomKeyStoresListEntryXksProxyConfiguration.prototype['UriEndpoint'] = undefined;

/**
 * @member {String} UriPath
 */
CustomKeyStoresListEntryXksProxyConfiguration.prototype['UriPath'] = undefined;

/**
 * @member {String} VpcEndpointServiceName
 */
CustomKeyStoresListEntryXksProxyConfiguration.prototype['VpcEndpointServiceName'] = undefined;


// Implement XksProxyConfigurationType interface:
/**
 * @member {module:model/XksProxyConnectivityType} Connectivity
 */
XksProxyConfigurationType.prototype['Connectivity'] = undefined;
/**
 * @member {String} AccessKeyId
 */
XksProxyConfigurationType.prototype['AccessKeyId'] = undefined;
/**
 * @member {String} UriEndpoint
 */
XksProxyConfigurationType.prototype['UriEndpoint'] = undefined;
/**
 * @member {String} UriPath
 */
XksProxyConfigurationType.prototype['UriPath'] = undefined;
/**
 * @member {String} VpcEndpointServiceName
 */
XksProxyConfigurationType.prototype['VpcEndpointServiceName'] = undefined;




export default CustomKeyStoresListEntryXksProxyConfiguration;
