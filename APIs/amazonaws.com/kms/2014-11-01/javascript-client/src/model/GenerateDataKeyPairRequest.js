...
import GenerateDataKeyPairRequestRecipient from './GenerateDataKeyPairRequestRecipient';

/**
 * The GenerateDataKeyPairRequest model module.
 * @module model/GenerateDataKeyPairRequest
 * @version 2014-11-01
 */
class GenerateDataKeyPairRequest {
    /**
     * Constructs a new <code>GenerateDataKeyPairRequest</code>.
     * @alias module:model/GenerateDataKeyPairRequest
     * @param keyId {String} 
     * @param keyPairSpec {module:model/DataKeyPairSpec} 
     */
    constructor(keyId, keyPairSpec) { 
        
        GenerateDataKeyPairRequest.initialize(this, keyId, keyPairSpec);
    }
    ...
    /**
     * Constructs a <code>GenerateDataKeyPairRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenerateDataKeyPairRequest} obj Optional instance to populate.
     * @return {module:model/GenerateDataKeyPairRequest} The populated <code>GenerateDataKeyPairRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenerateDataKeyPairRequest();
            ...
            if (data.hasOwnProperty('Recipient')) {
                obj['Recipient'] = GenerateDataKeyPairRequestRecipient.constructFromObject(data['Recipient']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateDataKeyPairRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateDataKeyPairRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GenerateDataKeyPairRequest.RequiredProperties) {
        ...
        if (data['Recipient']) { // data not null
          GenerateDataKeyPairRequestRecipient.validateJSON(data['Recipient']);
        }
...
GenerateDataKeyPairRequest.RequiredProperties = ["KeyId", "KeyPairSpec"];

/**
 * @member {Object} EncryptionContext
 */
GenerateDataKeyPairRequest.prototype['EncryptionContext'] = undefined;

/**
 * @member {String} KeyId
 */
GenerateDataKeyPairRequest.prototype['KeyId'] = undefined;

/**
 * @member {module:model/DataKeyPairSpec} KeyPairSpec
 */
GenerateDataKeyPairRequest.prototype['KeyPairSpec'] = undefined;

/**
 * @member {Array} GrantTokens
 */
GenerateDataKeyPairRequest.prototype['GrantTokens'] = undefined;

/**
 * @member {module:model/GenerateDataKeyPairRequestRecipient} Recipient
 */
GenerateDataKeyPairRequest.prototype['Recipient'] = undefined;

/**
 * @member {Boolean} DryRun
 */
GenerateDataKeyPairRequest.prototype['DryRun'] = undefined;
...
export default GenerateDataKeyPairRequest;
