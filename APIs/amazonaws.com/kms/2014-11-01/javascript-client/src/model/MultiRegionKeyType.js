...
* @readonly
*/
export default class MultiRegionKeyType {
    ...
    /**
    * Returns a <code>MultiRegionKeyType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/MultiRegionKeyType} The enum <code>MultiRegionKeyType</code> value.
    */
