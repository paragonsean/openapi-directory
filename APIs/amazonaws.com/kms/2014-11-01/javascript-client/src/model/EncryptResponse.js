...
class EncryptResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('EncryptionAlgorithm')) {
                obj['EncryptionAlgorithm'] = ApiClient.convertToType(data['EncryptionAlgorithm'], EncryptionAlgorithmSpec);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['EncryptionAlgorithm']) { // data not null
          EncryptionAlgorithmSpec.validateJSON(data['EncryptionAlgorithm']);
        }
 ...
 */
EncryptResponse.prototype['CiphertextBlob'] = undefined;

/**
 * @member {String} KeyId
 */
EncryptResponse.prototype['KeyId'] = undefined;

/**
 * @member {module:model/EncryptionAlgorithmSpec} EncryptionAlgorithm
 */
EncryptResponse.prototype['EncryptionAlgorithm'] = undefined;
