...
/**
 * The DescribeCustomKeyStoresRequest model module.
 * @module model/DescribeCustomKeyStoresRequest
 * @version 2014-11-01
 */
class DescribeCustomKeyStoresRequest {
    /**
     * Constructs a new <code>DescribeCustomKeyStoresRequest</code>.
     * @alias module:model/DescribeCustomKeyStoresRequest
     */
    constructor() { 
        
        DescribeCustomKeyStoresRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeCustomKeyStoresRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeCustomKeyStoresRequest} obj Optional instance to populate.
     * @return {module:model/DescribeCustomKeyStoresRequest} The populated <code>DescribeCustomKeyStoresRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeCustomKeyStoresRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeCustomKeyStoresRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeCustomKeyStoresRequest</code>.
     */
 ...
 */
DescribeCustomKeyStoresRequest.prototype['CustomKeyStoreId'] = undefined;

/**
 * @member {String} CustomKeyStoreName
 */
DescribeCustomKeyStoresRequest.prototype['CustomKeyStoreName'] = undefined;

/**
 * @member {Number} Limit
 */
DescribeCustomKeyStoresRequest.prototype['Limit'] = undefined;

/**
 * @member {String} Marker
 */
DescribeCustomKeyStoresRequest.prototype['Marker'] = undefined;
...
export default DescribeCustomKeyStoresRequest;
