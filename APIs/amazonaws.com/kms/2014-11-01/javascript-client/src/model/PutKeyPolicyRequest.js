...
/**
 * The PutKeyPolicyRequest model module.
 * @module model/PutKeyPolicyRequest
 * @version 2014-11-01
 */
class PutKeyPolicyRequest {
    /**
     * Constructs a new <code>PutKeyPolicyRequest</code>.
     * @alias module:model/PutKeyPolicyRequest
     * @param keyId {String} 
     * @param policyName {String} 
     * @param policy {String} 
     */
    constructor(keyId, policyName, policy) { 
        
        PutKeyPolicyRequest.initialize(this, keyId, policyName, policy);
    }
     ...
     */
    static initialize(obj, keyId, policyName, policy) { 
        obj['KeyId'] = keyId;
    ...
    /**
     * Constructs a <code>PutKeyPolicyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutKeyPolicyRequest} obj Optional instance to populate.
     * @return {module:model/PutKeyPolicyRequest} The populated <code>PutKeyPolicyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutKeyPolicyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PutKeyPolicyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutKeyPolicyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutKeyPolicyRequest.RequiredProperties) {
...
PutKeyPolicyRequest.RequiredProperties = ["KeyId", "PolicyName", "Policy"];

/**
 * @member {String} KeyId
 */
PutKeyPolicyRequest.prototype['KeyId'] = undefined;

/**
 * @member {String} PolicyName
 */
PutKeyPolicyRequest.prototype['PolicyName'] = undefined;

/**
 * @member {String} Policy
 */
PutKeyPolicyRequest.prototype['Policy'] = undefined;

/**
 * @member {Boolean} BypassPolicyLockoutSafetyCheck
 */
PutKeyPolicyRequest.prototype['BypassPolicyLockoutSafetyCheck'] = undefined;
...
export default PutKeyPolicyRequest;
