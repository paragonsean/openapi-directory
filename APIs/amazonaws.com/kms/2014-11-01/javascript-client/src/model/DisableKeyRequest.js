...
/**
 * The DisableKeyRequest model module.
 * @module model/DisableKeyRequest
 * @version 2014-11-01
 */
class DisableKeyRequest {
    /**
     * Constructs a new <code>DisableKeyRequest</code>.
     * @alias module:model/DisableKeyRequest
     * @param keyId {String} 
     */
    constructor(keyId) { 
        
        DisableKeyRequest.initialize(this, keyId);
    }
    ...
    /**
     * Constructs a <code>DisableKeyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisableKeyRequest} obj Optional instance to populate.
     * @return {module:model/DisableKeyRequest} The populated <code>DisableKeyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisableKeyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DisableKeyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisableKeyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DisableKeyRequest.RequiredProperties) {
...
DisableKeyRequest.RequiredProperties = ["KeyId"];

/**
 * @member {String} KeyId
 */
DisableKeyRequest.prototype['KeyId'] = undefined;
...
export default DisableKeyRequest;
