...
/**
 * The GenerateRandomRequestRecipient model module.
 * @module model/GenerateRandomRequestRecipient
 * @version 2014-11-01
 */
class GenerateRandomRequestRecipient {
    /**
     * Constructs a new <code>GenerateRandomRequestRecipient</code>.
     * @alias module:model/GenerateRandomRequestRecipient
     * @implements module:model/RecipientInfo
     */
    constructor() { 
        RecipientInfo.initialize(this);
        GenerateRandomRequestRecipient.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GenerateRandomRequestRecipient</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenerateRandomRequestRecipient} obj Optional instance to populate.
     * @return {module:model/GenerateRandomRequestRecipient} The populated <code>GenerateRandomRequestRecipient</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenerateRandomRequestRecipient();
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateRandomRequestRecipient</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateRandomRequestRecipient</code>.
     */
 ...
 */
GenerateRandomRequestRecipient.prototype['KeyEncryptionAlgorithm'] = undefined;

/**
 * @member {String} AttestationDocument
 */
GenerateRandomRequestRecipient.prototype['AttestationDocument'] = undefined;
...
export default GenerateRandomRequestRecipient;
