...
/**
 * The AliasListEntry model module.
 * @module model/AliasListEntry
 * @version 2014-11-01
 */
class AliasListEntry {
    /**
     * Constructs a new <code>AliasListEntry</code>.
     * Contains information about an alias.
     * @alias module:model/AliasListEntry
     */
    constructor() { 
        
        AliasListEntry.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AliasListEntry</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AliasListEntry} obj Optional instance to populate.
     * @return {module:model/AliasListEntry} The populated <code>AliasListEntry</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AliasListEntry();
    ...
    /**
     * Validates the JSON data with respect to <code>AliasListEntry</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AliasListEntry</code>.
     */
 ...
 */
AliasListEntry.prototype['AliasName'] = undefined;

/**
 * @member {String} AliasArn
 */
AliasListEntry.prototype['AliasArn'] = undefined;

/**
 * @member {String} TargetKeyId
 */
AliasListEntry.prototype['TargetKeyId'] = undefined;

/**
 * @member {Date} CreationDate
 */
AliasListEntry.prototype['CreationDate'] = undefined;

/**
 * @member {Date} LastUpdatedDate
 */
AliasListEntry.prototype['LastUpdatedDate'] = undefined;
