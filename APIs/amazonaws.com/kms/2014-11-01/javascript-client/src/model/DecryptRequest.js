...
import DecryptRequestRecipient from './DecryptRequestRecipient';
...
class DecryptRequest {
     ...
     */
    constructor(ciphertextBlob) { 
        
        DecryptRequest.initialize(this, ciphertextBlob);
    }
     ...
     */
    static initialize(obj, ciphertextBlob) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Recipient')) {
                obj['Recipient'] = DecryptRequestRecipient.constructFromObject(data['Recipient']);
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of DecryptRequest.RequiredProperties) {
        ...
        if (data['Recipient']) { // data not null
          DecryptRequestRecipient.validateJSON(data['Recipient']);
        }
...
DecryptRequest.RequiredProperties = ["CiphertextBlob"];

/**
 * @member {String} CiphertextBlob
 */
DecryptRequest.prototype['CiphertextBlob'] = undefined;

/**
 * @member {Object} EncryptionContext
 */
DecryptRequest.prototype['EncryptionContext'] = undefined;

/**
 * @member {Array} GrantTokens
 */
DecryptRequest.prototype['GrantTokens'] = undefined;

/**
 * @member {String} KeyId
 */
DecryptRequest.prototype['KeyId'] = undefined;

/**
 * @member {module:model/EncryptionAlgorithmSpec} EncryptionAlgorithm
 */
DecryptRequest.prototype['EncryptionAlgorithm'] = undefined;

/**
 * @member {module:model/DecryptRequestRecipient} Recipient
 */
DecryptRequest.prototype['Recipient'] = undefined;

/**
 * @member {Boolean} DryRun
 */
DecryptRequest.prototype['DryRun'] = undefined;
