...
/**
 * The GenerateDataKeyResponse model module.
 * @module model/GenerateDataKeyResponse
 * @version 2014-11-01
 */
class GenerateDataKeyResponse {
    /**
     * Constructs a new <code>GenerateDataKeyResponse</code>.
     * @alias module:model/GenerateDataKeyResponse
     */
    constructor() { 
        
        GenerateDataKeyResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GenerateDataKeyResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenerateDataKeyResponse} obj Optional instance to populate.
     * @return {module:model/GenerateDataKeyResponse} The populated <code>GenerateDataKeyResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenerateDataKeyResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateDataKeyResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateDataKeyResponse</code>.
     */
    static validateJSON(data) {
        ...
        // validate the optional field `Plaintext`
        if (data['Plaintext']) { // data not null
          String.validateJSON(data['Plaintext']);
        }
 ...
 */
GenerateDataKeyResponse.prototype['CiphertextBlob'] = undefined;

/**
 * @member {String} Plaintext
 */
GenerateDataKeyResponse.prototype['Plaintext'] = undefined;

/**
 * @member {String} KeyId
 */
GenerateDataKeyResponse.prototype['KeyId'] = undefined;

/**
 * @member {String} CiphertextForRecipient
 */
GenerateDataKeyResponse.prototype['CiphertextForRecipient'] = undefined;
...
export default GenerateDataKeyResponse;
