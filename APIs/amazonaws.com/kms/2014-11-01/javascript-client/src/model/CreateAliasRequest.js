...
class CreateAliasRequest {
     ...
     * @param targetKeyId {String} 
     */
    constructor(aliasName, targetKeyId) { 
        
        CreateAliasRequest.initialize(this, aliasName, targetKeyId);
    }
     ...
     */
    static initialize(obj, aliasName, targetKeyId) { 
        obj['AliasName'] = aliasName;
        obj['TargetKeyId'] = targetKeyId;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('TargetKeyId')) {
                obj['TargetKeyId'] = ApiClient.convertToType(data['TargetKeyId'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of CreateAliasRequest.RequiredProperties) {
        ...
        // validate the optional field `TargetKeyId`
        if (data['TargetKeyId']) { // data not null
          String.validateJSON(data['TargetKeyId']);
        }
...
CreateAliasRequest.RequiredProperties = ["AliasName", "TargetKeyId"];

/**
 * @member {String} AliasName
 */
CreateAliasRequest.prototype['AliasName'] = undefined;

/**
 * @member {String} TargetKeyId
 */
CreateAliasRequest.prototype['TargetKeyId'] = undefined;
