...
/**
 * The DecryptRequestRecipient model module.
 * @module model/DecryptRequestRecipient
 * @version 2014-11-01
 */
class DecryptRequestRecipient {
    /**
     * Constructs a new <code>DecryptRequestRecipient</code>.
     * @alias module:model/DecryptRequestRecipient
     * @implements module:model/RecipientInfo
     */
    constructor() { 
        RecipientInfo.initialize(this);
        DecryptRequestRecipient.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DecryptRequestRecipient</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DecryptRequestRecipient} obj Optional instance to populate.
     * @return {module:model/DecryptRequestRecipient} The populated <code>DecryptRequestRecipient</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DecryptRequestRecipient();
            RecipientInfo.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DecryptRequestRecipient</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DecryptRequestRecipient</code>.
     */
 ...
 */
DecryptRequestRecipient.prototype['KeyEncryptionAlgorithm'] = undefined;

/**
 * @member {String} AttestationDocument
 */
DecryptRequestRecipient.prototype['AttestationDocument'] = undefined;


// Implement RecipientInfo interface:
/**
 * @member {module:model/KeyEncryptionMechanism} KeyEncryptionAlgorithm
 */
...
export default DecryptRequestRecipient;
