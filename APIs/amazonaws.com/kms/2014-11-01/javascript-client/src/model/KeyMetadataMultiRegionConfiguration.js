...
import MultiRegionConfigurationPrimaryKey from './MultiRegionConfigurationPrimaryKey';
import MultiRegionKeyType from './MultiRegionKeyType';

/**
 * The KeyMetadataMultiRegionConfiguration model module.
 * @module model/KeyMetadataMultiRegionConfiguration
 * @version 2014-11-01
 */
class KeyMetadataMultiRegionConfiguration {
    /**
     * Constructs a new <code>KeyMetadataMultiRegionConfiguration</code>.
     * @alias module:model/KeyMetadataMultiRegionConfiguration
     * @implements module:model/MultiRegionConfiguration
     */
    constructor() { 
        MultiRegionConfiguration.initialize(this);
        KeyMetadataMultiRegionConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>KeyMetadataMultiRegionConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/KeyMetadataMultiRegionConfiguration} obj Optional instance to populate.
     * @return {module:model/KeyMetadataMultiRegionConfiguration} The populated <code>KeyMetadataMultiRegionConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new KeyMetadataMultiRegionConfiguration();
            MultiRegionConfiguration.constructFromObject(data, obj);

            if (data.hasOwnProperty('MultiRegionKeyType')) {
                obj['MultiRegionKeyType'] = ApiClient.convertToType(data['MultiRegionKeyType'], MultiRegionKeyType);
            }
            if (data.hasOwnProperty('PrimaryKey')) {
                obj['PrimaryKey'] = MultiRegionConfigurationPrimaryKey.constructFromObject(data['PrimaryKey']);
            }
            if (data.hasOwnProperty('ReplicaKeys')) {
                obj['ReplicaKeys'] = ApiClient.convertToType(data['ReplicaKeys'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>KeyMetadataMultiRegionConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>KeyMetadataMultiRegionConfiguration</code>.
     */
    static validateJSON(data) {
        // validate the optional field `MultiRegionKeyType`
        if (data['MultiRegionKeyType']) { // data not null
          MultiRegionKeyType.validateJSON(data['MultiRegionKeyType']);
        }
        // validate the optional field `PrimaryKey`
        if (data['PrimaryKey']) { // data not null
          MultiRegionConfigurationPrimaryKey.validateJSON(data['PrimaryKey']);
        }
        // validate the optional field `ReplicaKeys`
        if (data['ReplicaKeys']) { // data not null
          Array.validateJSON(data['ReplicaKeys']);
        }
...
/**
 * @member {module:model/MultiRegionKeyType} MultiRegionKeyType
 */
KeyMetadataMultiRegionConfiguration.prototype['MultiRegionKeyType'] = undefined;

/**
 * @member {module:model/MultiRegionConfigurationPrimaryKey} PrimaryKey
 */
KeyMetadataMultiRegionConfiguration.prototype['PrimaryKey'] = undefined;

/**
 * @member {Array} ReplicaKeys
 */
KeyMetadataMultiRegionConfiguration.prototype['ReplicaKeys'] = undefined;


// Implement MultiRegionConfiguration interface:
/**
 * @member {module:model/MultiRegionKeyType} MultiRegionKeyType
 */
MultiRegionConfiguration.prototype['MultiRegionKeyType'] = undefined;
/**
 * @member {module:model/MultiRegionConfigurationPrimaryKey} PrimaryKey
 */
MultiRegionConfiguration.prototype['PrimaryKey'] = undefined;
/**
 * @member {Array} ReplicaKeys
 */
MultiRegionConfiguration.prototype['ReplicaKeys'] = undefined;




export default KeyMetadataMultiRegionConfiguration;
