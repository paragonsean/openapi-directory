...
/**
 * The ScheduleKeyDeletionRequest model module.
 * @module model/ScheduleKeyDeletionRequest
 * @version 2014-11-01
 */
class ScheduleKeyDeletionRequest {
    /**
     * Constructs a new <code>ScheduleKeyDeletionRequest</code>.
     * @alias module:model/ScheduleKeyDeletionRequest
     * @param keyId {String} 
     */
    constructor(keyId) { 
        
        ScheduleKeyDeletionRequest.initialize(this, keyId);
    }
    ...
    /**
     * Constructs a <code>ScheduleKeyDeletionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScheduleKeyDeletionRequest} obj Optional instance to populate.
     * @return {module:model/ScheduleKeyDeletionRequest} The populated <code>ScheduleKeyDeletionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScheduleKeyDeletionRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ScheduleKeyDeletionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScheduleKeyDeletionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ScheduleKeyDeletionRequest.RequiredProperties) {
...
ScheduleKeyDeletionRequest.RequiredProperties = ["KeyId"];

/**
 * @member {String} KeyId
 */
ScheduleKeyDeletionRequest.prototype['KeyId'] = undefined;

/**
 * @member {Number} PendingWindowInDays
 */
ScheduleKeyDeletionRequest.prototype['PendingWindowInDays'] = undefined;
...
export default ScheduleKeyDeletionRequest;
