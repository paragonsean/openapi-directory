...
/**
 * The DescribeCustomKeyStoresResponse model module.
 * @module model/DescribeCustomKeyStoresResponse
 * @version 2014-11-01
 */
class DescribeCustomKeyStoresResponse {
    /**
     * Constructs a new <code>DescribeCustomKeyStoresResponse</code>.
     * @alias module:model/DescribeCustomKeyStoresResponse
     */
    constructor() { 
        
        DescribeCustomKeyStoresResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeCustomKeyStoresResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeCustomKeyStoresResponse} obj Optional instance to populate.
     * @return {module:model/DescribeCustomKeyStoresResponse} The populated <code>DescribeCustomKeyStoresResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeCustomKeyStoresResponse();

            if (data.hasOwnProperty('CustomKeyStores')) {
                obj['CustomKeyStores'] = ApiClient.convertToType(data['CustomKeyStores'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeCustomKeyStoresResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeCustomKeyStoresResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `CustomKeyStores`
        if (data['CustomKeyStores']) { // data not null
          Array.validateJSON(data['CustomKeyStores']);
        }
...
/**
 * @member {Array} CustomKeyStores
 */
DescribeCustomKeyStoresResponse.prototype['CustomKeyStores'] = undefined;

/**
 * @member {String} NextMarker
 */
DescribeCustomKeyStoresResponse.prototype['NextMarker'] = undefined;

/**
 * @member {Boolean} Truncated
 */
DescribeCustomKeyStoresResponse.prototype['Truncated'] = undefined;
...
export default DescribeCustomKeyStoresResponse;
