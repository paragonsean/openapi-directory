...
class GetPublicKeyRequest {
    ...
    constructor(keyId) { 
        ...
        GetPublicKeyRequest.initialize(this, keyId);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetPublicKeyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPublicKeyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetPublicKeyRequest.RequiredProperties) {
...
GetPublicKeyRequest.RequiredProperties = ["KeyId"];

/**
 * @member {String} KeyId
 */
GetPublicKeyRequest.prototype['KeyId'] = undefined;

/**
 * @member {Array} GrantTokens
 */
GetPublicKeyRequest.prototype['GrantTokens'] = undefined;
