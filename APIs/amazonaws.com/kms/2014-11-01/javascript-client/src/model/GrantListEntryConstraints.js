...
/**
 * The GrantListEntryConstraints model module.
 * @module model/GrantListEntryConstraints
 * @version 2014-11-01
 */
class GrantListEntryConstraints {
    /**
     * Constructs a new <code>GrantListEntryConstraints</code>.
     * @alias module:model/GrantListEntryConstraints
     * @implements module:model/GrantConstraints
     */
    constructor() { 
        GrantConstraints.initialize(this);
        GrantListEntryConstraints.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GrantListEntryConstraints</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GrantListEntryConstraints} obj Optional instance to populate.
     * @return {module:model/GrantListEntryConstraints} The populated <code>GrantListEntryConstraints</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GrantListEntryConstraints();
    ...
    /**
     * Validates the JSON data with respect to <code>GrantListEntryConstraints</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GrantListEntryConstraints</code>.
     */
 ...
 */
GrantListEntryConstraints.prototype['EncryptionContextSubset'] = undefined;

/**
 * @member {Object} EncryptionContextEquals
 */
GrantListEntryConstraints.prototype['EncryptionContextEquals'] = undefined;
...
export default GrantListEntryConstraints;
