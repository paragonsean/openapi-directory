...
* @readonly
*/
export default class XksProxyConnectivityType {
    ...
    /**
    * Returns a <code>XksProxyConnectivityType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/XksProxyConnectivityType} The enum <code>XksProxyConnectivityType</code> value.
    */
