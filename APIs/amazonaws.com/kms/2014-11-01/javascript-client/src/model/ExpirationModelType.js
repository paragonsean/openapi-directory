...
* @readonly
*/
export default class ExpirationModelType {
    ...
    /**
    * Returns a <code>ExpirationModelType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ExpirationModelType} The enum <code>ExpirationModelType</code> value.
    */
