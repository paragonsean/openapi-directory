...
export default class KeySpec {
    ...
    /**
    * Returns a <code>KeySpec</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/KeySpec} The enum <code>KeySpec</code> value.
    */
