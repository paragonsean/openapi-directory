...
/**
 * The XksKeyConfigurationType model module.
 * @module model/XksKeyConfigurationType
 * @version 2014-11-01
 */
class XksKeyConfigurationType {
    /**
     * Constructs a new <code>XksKeyConfigurationType</code>.
     ...
     * @alias module:model/XksKeyConfigurationType
     */
    constructor() { 
        
        XksKeyConfigurationType.initialize(this);
    }
    ...
    /**
     * Constructs a <code>XksKeyConfigurationType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/XksKeyConfigurationType} obj Optional instance to populate.
     * @return {module:model/XksKeyConfigurationType} The populated <code>XksKeyConfigurationType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new XksKeyConfigurationType();
    ...
    /**
     * Validates the JSON data with respect to <code>XksKeyConfigurationType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>XksKeyConfigurationType</code>.
     */
 ...
 * @member {String} Id
 */
XksKeyConfigurationType.prototype['Id'] = undefined;
...
export default XksKeyConfigurationType;
