...
/**
 * The GetKeyPolicyRequest model module.
 * @module model/GetKeyPolicyRequest
 * @version 2014-11-01
 */
class GetKeyPolicyRequest {
    /**
     * Constructs a new <code>GetKeyPolicyRequest</code>.
     * @alias module:model/GetKeyPolicyRequest
     * @param keyId {String} 
     * @param policyName {String} 
     */
    constructor(keyId, policyName) { 
        
        GetKeyPolicyRequest.initialize(this, keyId, policyName);
    }
     ...
     */
    static initialize(obj, keyId, policyName) { 
        obj['KeyId'] = keyId;
        obj['PolicyName'] = policyName;
    }

    /**
     * Constructs a <code>GetKeyPolicyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetKeyPolicyRequest} obj Optional instance to populate.
     * @return {module:model/GetKeyPolicyRequest} The populated <code>GetKeyPolicyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetKeyPolicyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetKeyPolicyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetKeyPolicyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetKeyPolicyRequest.RequiredProperties) {
...
GetKeyPolicyRequest.RequiredProperties = ["KeyId", "PolicyName"];

/**
 * @member {String} KeyId
 */
GetKeyPolicyRequest.prototype['KeyId'] = undefined;

/**
 * @member {String} PolicyName
 */
GetKeyPolicyRequest.prototype['PolicyName'] = undefined;
...
export default GetKeyPolicyRequest;
