...
/**
 * The RetireGrantRequest model module.
 * @module model/RetireGrantRequest
 * @version 2014-11-01
 */
class RetireGrantRequest {
    /**
     * Constructs a new <code>RetireGrantRequest</code>.
     * @alias module:model/RetireGrantRequest
     */
    constructor() { 
        
        RetireGrantRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RetireGrantRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RetireGrantRequest} obj Optional instance to populate.
     * @return {module:model/RetireGrantRequest} The populated <code>RetireGrantRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RetireGrantRequest();

            if (data.hasOwnProperty('GrantToken')) {
                obj['GrantToken'] = ApiClient.convertToType(data['GrantToken'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>RetireGrantRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RetireGrantRequest</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GrantToken`
        if (data['GrantToken']) { // data not null
          String.validateJSON(data['GrantToken']);
        }
        ...
        if (data['GrantId']) { // data not null
          String.validateJSON(data['GrantId']);
        }
...
/**
 * @member {String} GrantToken
 */
RetireGrantRequest.prototype['GrantToken'] = undefined;

/**
 * @member {String} KeyId
 */
RetireGrantRequest.prototype['KeyId'] = undefined;

/**
 * @member {String} GrantId
 */
RetireGrantRequest.prototype['GrantId'] = undefined;

/**
 * @member {Boolean} DryRun
 */
RetireGrantRequest.prototype['DryRun'] = undefined;
...
export default RetireGrantRequest;
