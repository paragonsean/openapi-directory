...
import ReplicateKeyResponseReplicaKeyMetadata from './ReplicateKeyResponseReplicaKeyMetadata';

/**
 * The ReplicateKeyResponse model module.
 * @module model/ReplicateKeyResponse
 * @version 2014-11-01
 */
class ReplicateKeyResponse {
    /**
     * Constructs a new <code>ReplicateKeyResponse</code>.
     * @alias module:model/ReplicateKeyResponse
     */
    constructor() { 
        
        ReplicateKeyResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ReplicateKeyResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReplicateKeyResponse} obj Optional instance to populate.
     * @return {module:model/ReplicateKeyResponse} The populated <code>ReplicateKeyResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReplicateKeyResponse();

            if (data.hasOwnProperty('ReplicaKeyMetadata')) {
                obj['ReplicaKeyMetadata'] = ReplicateKeyResponseReplicaKeyMetadata.constructFromObject(data['ReplicaKeyMetadata']);
            }
            if (data.hasOwnProperty('ReplicaPolicy')) {
                obj['ReplicaPolicy'] = ApiClient.convertToType(data['ReplicaPolicy'], 'String');
            }
            if (data.hasOwnProperty('ReplicaTags')) {
                obj['ReplicaTags'] = ApiClient.convertToType(data['ReplicaTags'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ReplicateKeyResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReplicateKeyResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `ReplicaKeyMetadata`
        if (data['ReplicaKeyMetadata']) { // data not null
          ReplicateKeyResponseReplicaKeyMetadata.validateJSON(data['ReplicaKeyMetadata']);
        }
        // validate the optional field `ReplicaPolicy`
        if (data['ReplicaPolicy']) { // data not null
          String.validateJSON(data['ReplicaPolicy']);
        }
        // validate the optional field `ReplicaTags`
        if (data['ReplicaTags']) { // data not null
          Array.validateJSON(data['ReplicaTags']);
        }
...
/**
 * @member {module:model/ReplicateKeyResponseReplicaKeyMetadata} ReplicaKeyMetadata
 */
ReplicateKeyResponse.prototype['ReplicaKeyMetadata'] = undefined;

/**
 * @member {String} ReplicaPolicy
 */
ReplicateKeyResponse.prototype['ReplicaPolicy'] = undefined;

/**
 * @member {Array} ReplicaTags
 */
ReplicateKeyResponse.prototype['ReplicaTags'] = undefined;
...
export default ReplicateKeyResponse;
