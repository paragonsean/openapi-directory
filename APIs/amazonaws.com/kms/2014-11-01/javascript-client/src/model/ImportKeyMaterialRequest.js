...
/**
 * The ImportKeyMaterialRequest model module.
 * @module model/ImportKeyMaterialRequest
 * @version 2014-11-01
 */
class ImportKeyMaterialRequest {
    /**
     * Constructs a new <code>ImportKeyMaterialRequest</code>.
     * @alias module:model/ImportKeyMaterialRequest
     * @param keyId {String} 
     * @param importToken {String} 
     * @param encryptedKeyMaterial {String} 
     */
    constructor(keyId, importToken, encryptedKeyMaterial) { 
        
        ImportKeyMaterialRequest.initialize(this, keyId, importToken, encryptedKeyMaterial);
    }
     ...
     */
    static initialize(obj, keyId, importToken, encryptedKeyMaterial) { 
        obj['KeyId'] = keyId;
        obj['ImportToken'] = importToken;
        obj['EncryptedKeyMaterial'] = encryptedKeyMaterial;
    }

    /**
     * Constructs a <code>ImportKeyMaterialRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImportKeyMaterialRequest} obj Optional instance to populate.
     * @return {module:model/ImportKeyMaterialRequest} The populated <code>ImportKeyMaterialRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImportKeyMaterialRequest();
            ...
            if (data.hasOwnProperty('EncryptedKeyMaterial')) {
                obj['EncryptedKeyMaterial'] = ApiClient.convertToType(data['EncryptedKeyMaterial'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ImportKeyMaterialRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImportKeyMaterialRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ImportKeyMaterialRequest.RequiredProperties) {
        ...
        if (data['ImportToken']) { // data not null
          String.validateJSON(data['ImportToken']);
        }
        // validate the optional field `EncryptedKeyMaterial`
        if (data['EncryptedKeyMaterial']) { // data not null
          String.validateJSON(data['EncryptedKeyMaterial']);
        }
...
ImportKeyMaterialRequest.RequiredProperties = ["KeyId", "ImportToken", "EncryptedKeyMaterial"];

/**
 * @member {String} KeyId
 */
ImportKeyMaterialRequest.prototype['KeyId'] = undefined;

/**
 * @member {String} ImportToken
 */
ImportKeyMaterialRequest.prototype['ImportToken'] = undefined;

/**
 * @member {String} EncryptedKeyMaterial
 */
ImportKeyMaterialRequest.prototype['EncryptedKeyMaterial'] = undefined;

/**
 * @member {Date} ValidTo
 */
ImportKeyMaterialRequest.prototype['ValidTo'] = undefined;

/**
 * @member {module:model/ExpirationModelType} ExpirationModel
 */
ImportKeyMaterialRequest.prototype['ExpirationModel'] = undefined;
...
export default ImportKeyMaterialRequest;
