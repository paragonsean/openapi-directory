...
* @readonly
*/
export default class SigningAlgorithmSpec {
    ...
    /**
    * Returns a <code>SigningAlgorithmSpec</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SigningAlgorithmSpec} The enum <code>SigningAlgorithmSpec</code> value.
    */
