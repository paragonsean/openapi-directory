...
/**
 * The ReplicateKeyRequest model module.
 * @module model/ReplicateKeyRequest
 * @version 2014-11-01
 */
class ReplicateKeyRequest {
    /**
     * Constructs a new <code>ReplicateKeyRequest</code>.
     * @alias module:model/ReplicateKeyRequest
     * @param keyId {String} 
     * @param replicaRegion {String} 
     */
    constructor(keyId, replicaRegion) { 
        
        ReplicateKeyRequest.initialize(this, keyId, replicaRegion);
    }
     ...
     */
    static initialize(obj, keyId, replicaRegion) { 
        obj['KeyId'] = keyId;
        obj['ReplicaRegion'] = replicaRegion;
    }

    /**
     * Constructs a <code>ReplicateKeyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReplicateKeyRequest} obj Optional instance to populate.
     * @return {module:model/ReplicateKeyRequest} The populated <code>ReplicateKeyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReplicateKeyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ReplicateKeyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReplicateKeyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ReplicateKeyRequest.RequiredProperties) {
        ...
        // validate the optional field `ReplicaRegion`
        if (data['ReplicaRegion']) { // data not null
          String.validateJSON(data['ReplicaRegion']);
        }
        ...
        if (data['BypassPolicyLockoutSafetyCheck']) { // data not null
          Boolean.validateJSON(data['BypassPolicyLockoutSafetyCheck']);
        }
...
ReplicateKeyRequest.RequiredProperties = ["KeyId", "ReplicaRegion"];

/**
 * @member {String} KeyId
 */
ReplicateKeyRequest.prototype['KeyId'] = undefined;

/**
 * @member {String} ReplicaRegion
 */
ReplicateKeyRequest.prototype['ReplicaRegion'] = undefined;

/**
 * @member {String} Policy
 */
ReplicateKeyRequest.prototype['Policy'] = undefined;

/**
 * @member {Boolean} BypassPolicyLockoutSafetyCheck
 */
ReplicateKeyRequest.prototype['BypassPolicyLockoutSafetyCheck'] = undefined;

/**
 * @member {String} Description
 */
ReplicateKeyRequest.prototype['Description'] = undefined;

/**
 * @member {Array} Tags
 */
ReplicateKeyRequest.prototype['Tags'] = undefined;
...
export default ReplicateKeyRequest;
