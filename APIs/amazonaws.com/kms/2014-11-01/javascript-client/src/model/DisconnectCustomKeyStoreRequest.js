...
/**
 * The DisconnectCustomKeyStoreRequest model module.
 * @module model/DisconnectCustomKeyStoreRequest
 * @version 2014-11-01
 */
class DisconnectCustomKeyStoreRequest {
    /**
     * Constructs a new <code>DisconnectCustomKeyStoreRequest</code>.
     * @alias module:model/DisconnectCustomKeyStoreRequest
     * @param customKeyStoreId {String} 
     */
    constructor(customKeyStoreId) { 
        
        DisconnectCustomKeyStoreRequest.initialize(this, customKeyStoreId);
    }
    ...
    /**
     * Constructs a <code>DisconnectCustomKeyStoreRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisconnectCustomKeyStoreRequest} obj Optional instance to populate.
     * @return {module:model/DisconnectCustomKeyStoreRequest} The populated <code>DisconnectCustomKeyStoreRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisconnectCustomKeyStoreRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DisconnectCustomKeyStoreRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisconnectCustomKeyStoreRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DisconnectCustomKeyStoreRequest.RequiredProperties) {
...
DisconnectCustomKeyStoreRequest.RequiredProperties = ["CustomKeyStoreId"];

/**
 * @member {String} CustomKeyStoreId
 */
DisconnectCustomKeyStoreRequest.prototype['CustomKeyStoreId'] = undefined;
...
export default DisconnectCustomKeyStoreRequest;
