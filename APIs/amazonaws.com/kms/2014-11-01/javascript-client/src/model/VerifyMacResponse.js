...
/**
 * The VerifyMacResponse model module.
 * @module model/VerifyMacResponse
 * @version 2014-11-01
 */
class VerifyMacResponse {
    /**
     * Constructs a new <code>VerifyMacResponse</code>.
     * @alias module:model/VerifyMacResponse
     */
    constructor() { 
        
        VerifyMacResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VerifyMacResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VerifyMacResponse} obj Optional instance to populate.
     * @return {module:model/VerifyMacResponse} The populated <code>VerifyMacResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VerifyMacResponse();

            if (data.hasOwnProperty('KeyId')) {
                obj['KeyId'] = ApiClient.convertToType(data['KeyId'], 'String');
            }
            if (data.hasOwnProperty('MacValid')) {
                obj['MacValid'] = ApiClient.convertToType(data['MacValid'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>VerifyMacResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VerifyMacResponse</code>.
     */
    static validateJSON(data) {
        ...
        // validate the optional field `MacValid`
        if (data['MacValid']) { // data not null
          Boolean.validateJSON(data['MacValid']);
        }
 ...
 * @member {String} KeyId
 */
VerifyMacResponse.prototype['KeyId'] = undefined;

/**
 * @member {Boolean} MacValid
 */
VerifyMacResponse.prototype['MacValid'] = undefined;

/**
 * @member {module:model/MacAlgorithmSpec} MacAlgorithm
 */
VerifyMacResponse.prototype['MacAlgorithm'] = undefined;
...
export default VerifyMacResponse;
