...
* @readonly
*/
export default class KeyManagerType {
    ...
    /**
    * Returns a <code>KeyManagerType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/KeyManagerType} The enum <code>KeyManagerType</code> value.
    */
