...
/**
 * The EnableKeyRequest model module.
 * @module model/EnableKeyRequest
 * @version 2014-11-01
 */
class EnableKeyRequest {
    /**
     * Constructs a new <code>EnableKeyRequest</code>.
     * @alias module:model/EnableKeyRequest
     * @param keyId {String} 
     */
    constructor(keyId) { 
        
        EnableKeyRequest.initialize(this, keyId);
    }
    ...
    /**
     * Constructs a <code>EnableKeyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EnableKeyRequest} obj Optional instance to populate.
     * @return {module:model/EnableKeyRequest} The populated <code>EnableKeyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EnableKeyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>EnableKeyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EnableKeyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EnableKeyRequest.RequiredProperties) {
...
EnableKeyRequest.RequiredProperties = ["KeyId"];

/**
 * @member {String} KeyId
 */
EnableKeyRequest.prototype['KeyId'] = undefined;
...
export default EnableKeyRequest;
