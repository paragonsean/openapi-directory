...
/**
 * The KeyListEntry model module.
 * @module model/KeyListEntry
 * @version 2014-11-01
 */
class KeyListEntry {
    /**
     * Constructs a new <code>KeyListEntry</code>.
     * Contains information about each entry in the key list.
     * @alias module:model/KeyListEntry
     */
    constructor() { 
        
        KeyListEntry.initialize(this);
    }
    ...
    /**
     * Constructs a <code>KeyListEntry</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/KeyListEntry} obj Optional instance to populate.
     * @return {module:model/KeyListEntry} The populated <code>KeyListEntry</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new KeyListEntry();
    ...
    /**
     * Validates the JSON data with respect to <code>KeyListEntry</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>KeyListEntry</code>.
     */
 ...
 * @member {String} KeyId
 */
KeyListEntry.prototype['KeyId'] = undefined;

/**
 * @member {String} KeyArn
 */
KeyListEntry.prototype['KeyArn'] = undefined;
