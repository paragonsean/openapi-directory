...
/**
 * The ListKeyPoliciesResponse model module.
 * @module model/ListKeyPoliciesResponse
 * @version 2014-11-01
 */
class ListKeyPoliciesResponse {
    /**
     * Constructs a new <code>ListKeyPoliciesResponse</code>.
     * @alias module:model/ListKeyPoliciesResponse
     */
    constructor() { 
        
        ListKeyPoliciesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListKeyPoliciesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListKeyPoliciesResponse} obj Optional instance to populate.
     * @return {module:model/ListKeyPoliciesResponse} The populated <code>ListKeyPoliciesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListKeyPoliciesResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListKeyPoliciesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListKeyPoliciesResponse</code>.
     */
 ...
 */
ListKeyPoliciesResponse.prototype['PolicyNames'] = undefined;

/**
 * @member {String} NextMarker
 */
ListKeyPoliciesResponse.prototype['NextMarker'] = undefined;

/**
 * @member {Boolean} Truncated
 */
ListKeyPoliciesResponse.prototype['Truncated'] = undefined;
...
export default ListKeyPoliciesResponse;
