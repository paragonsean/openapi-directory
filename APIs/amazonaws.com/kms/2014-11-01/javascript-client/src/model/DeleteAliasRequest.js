...
/**
 * The DeleteAliasRequest model module.
 * @module model/DeleteAliasRequest
 * @version 2014-11-01
 */
class DeleteAliasRequest {
    /**
     * Constructs a new <code>DeleteAliasRequest</code>.
     * @alias module:model/DeleteAliasRequest
     * @param aliasName {String} 
     */
    constructor(aliasName) { 
        
        DeleteAliasRequest.initialize(this, aliasName);
    }
     ...
     */
    static initialize(obj, aliasName) { 
        obj['AliasName'] = aliasName;
    }

    /**
     * Constructs a <code>DeleteAliasRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteAliasRequest} obj Optional instance to populate.
     * @return {module:model/DeleteAliasRequest} The populated <code>DeleteAliasRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteAliasRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteAliasRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteAliasRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteAliasRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `AliasName`
        if (data['AliasName']) { // data not null
          String.validateJSON(data['AliasName']);
        }
...
DeleteAliasRequest.RequiredProperties = ["AliasName"];

/**
 * @member {String} AliasName
 */
DeleteAliasRequest.prototype['AliasName'] = undefined;
...
export default DeleteAliasRequest;
