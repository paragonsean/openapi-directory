...
/**
 * The GenerateMacRequest model module.
 * @module model/GenerateMacRequest
 * @version 2014-11-01
 */
class GenerateMacRequest {
    /**
     * Constructs a new <code>GenerateMacRequest</code>.
     * @alias module:model/GenerateMacRequest
     * @param message {String} 
     * @param keyId {String} 
     * @param macAlgorithm {module:model/MacAlgorithmSpec} 
     */
    constructor(message, keyId, macAlgorithm) { 
        
        GenerateMacRequest.initialize(this, message, keyId, macAlgorithm);
    }
     ...
     */
    static initialize(obj, message, keyId, macAlgorithm) { 
        obj['Message'] = message;
        obj['KeyId'] = keyId;
    ...
    /**
     * Constructs a <code>GenerateMacRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenerateMacRequest} obj Optional instance to populate.
     * @return {module:model/GenerateMacRequest} The populated <code>GenerateMacRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenerateMacRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateMacRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateMacRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GenerateMacRequest.RequiredProperties) {
...
GenerateMacRequest.RequiredProperties = ["Message", "KeyId", "MacAlgorithm"];

/**
 * @member {String} Message
 */
GenerateMacRequest.prototype['Message'] = undefined;

/**
 * @member {String} KeyId
 */
GenerateMacRequest.prototype['KeyId'] = undefined;

/**
 * @member {module:model/MacAlgorithmSpec} MacAlgorithm
 */
GenerateMacRequest.prototype['MacAlgorithm'] = undefined;

/**
 * @member {Array} GrantTokens
 */
GenerateMacRequest.prototype['GrantTokens'] = undefined;

/**
 * @member {Boolean} DryRun
 */
GenerateMacRequest.prototype['DryRun'] = undefined;
...
export default GenerateMacRequest;
