...
/**
 * The UpdateKeyDescriptionRequest model module.
 * @module model/UpdateKeyDescriptionRequest
 * @version 2014-11-01
 */
class UpdateKeyDescriptionRequest {
    /**
     * Constructs a new <code>UpdateKeyDescriptionRequest</code>.
     * @alias module:model/UpdateKeyDescriptionRequest
     * @param keyId {String} 
     * @param description {String} 
     */
    constructor(keyId, description) { 
        
        UpdateKeyDescriptionRequest.initialize(this, keyId, description);
    }
     ...
     */
    static initialize(obj, keyId, description) { 
        obj['KeyId'] = keyId;
        obj['Description'] = description;
    }

    /**
     * Constructs a <code>UpdateKeyDescriptionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateKeyDescriptionRequest} obj Optional instance to populate.
     * @return {module:model/UpdateKeyDescriptionRequest} The populated <code>UpdateKeyDescriptionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateKeyDescriptionRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateKeyDescriptionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateKeyDescriptionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateKeyDescriptionRequest.RequiredProperties) {
...
UpdateKeyDescriptionRequest.RequiredProperties = ["KeyId", "Description"];

/**
 * @member {String} KeyId
 */
UpdateKeyDescriptionRequest.prototype['KeyId'] = undefined;

/**
 * @member {String} Description
 */
UpdateKeyDescriptionRequest.prototype['Description'] = undefined;
...
export default UpdateKeyDescriptionRequest;
