...
/**
 * The GetKeyRotationStatusRequest model module.
 * @module model/GetKeyRotationStatusRequest
 * @version 2014-11-01
 */
class GetKeyRotationStatusRequest {
    /**
     * Constructs a new <code>GetKeyRotationStatusRequest</code>.
     * @alias module:model/GetKeyRotationStatusRequest
     * @param keyId {String} 
     */
    constructor(keyId) { 
        
        GetKeyRotationStatusRequest.initialize(this, keyId);
    }
    ...
    /**
     * Constructs a <code>GetKeyRotationStatusRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetKeyRotationStatusRequest} obj Optional instance to populate.
     * @return {module:model/GetKeyRotationStatusRequest} The populated <code>GetKeyRotationStatusRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetKeyRotationStatusRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetKeyRotationStatusRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetKeyRotationStatusRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetKeyRotationStatusRequest.RequiredProperties) {
...
GetKeyRotationStatusRequest.RequiredProperties = ["KeyId"];

/**
 * @member {String} KeyId
 */
GetKeyRotationStatusRequest.prototype['KeyId'] = undefined;
...
export default GetKeyRotationStatusRequest;
