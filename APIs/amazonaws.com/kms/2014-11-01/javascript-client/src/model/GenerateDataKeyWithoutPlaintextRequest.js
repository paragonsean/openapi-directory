...
/**
 * The GenerateDataKeyWithoutPlaintextRequest model module.
 * @module model/GenerateDataKeyWithoutPlaintextRequest
 * @version 2014-11-01
 */
class GenerateDataKeyWithoutPlaintextRequest {
    /**
     * Constructs a new <code>GenerateDataKeyWithoutPlaintextRequest</code>.
     * @alias module:model/GenerateDataKeyWithoutPlaintextRequest
     * @param keyId {String} 
     */
    constructor(keyId) { 
        
        GenerateDataKeyWithoutPlaintextRequest.initialize(this, keyId);
    }
    ...
    /**
     * Constructs a <code>GenerateDataKeyWithoutPlaintextRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenerateDataKeyWithoutPlaintextRequest} obj Optional instance to populate.
     * @return {module:model/GenerateDataKeyWithoutPlaintextRequest} The populated <code>GenerateDataKeyWithoutPlaintextRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenerateDataKeyWithoutPlaintextRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateDataKeyWithoutPlaintextRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateDataKeyWithoutPlaintextRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GenerateDataKeyWithoutPlaintextRequest.RequiredProperties) {
...
GenerateDataKeyWithoutPlaintextRequest.RequiredProperties = ["KeyId"];

/**
 * @member {String} KeyId
 */
GenerateDataKeyWithoutPlaintextRequest.prototype['KeyId'] = undefined;

/**
 * @member {Object} EncryptionContext
 */
GenerateDataKeyWithoutPlaintextRequest.prototype['EncryptionContext'] = undefined;

/**
 * @member {module:model/DataKeySpec} KeySpec
 */
GenerateDataKeyWithoutPlaintextRequest.prototype['KeySpec'] = undefined;

/**
 * @member {Number} NumberOfBytes
 */
GenerateDataKeyWithoutPlaintextRequest.prototype['NumberOfBytes'] = undefined;

/**
 * @member {Array} GrantTokens
 */
GenerateDataKeyWithoutPlaintextRequest.prototype['GrantTokens'] = undefined;

/**
 * @member {Boolean} DryRun
 */
GenerateDataKeyWithoutPlaintextRequest.prototype['DryRun'] = undefined;
...
export default GenerateDataKeyWithoutPlaintextRequest;
