...
/**
 * The CancelKeyDeletionResponse model module.
 * @module model/CancelKeyDeletionResponse
 * @version 2014-11-01
 */
class CancelKeyDeletionResponse {
    /**
     * Constructs a new <code>CancelKeyDeletionResponse</code>.
     * @alias module:model/CancelKeyDeletionResponse
     */
    constructor() { 
        
        CancelKeyDeletionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CancelKeyDeletionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CancelKeyDeletionResponse} obj Optional instance to populate.
     * @return {module:model/CancelKeyDeletionResponse} The populated <code>CancelKeyDeletionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CancelKeyDeletionResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CancelKeyDeletionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CancelKeyDeletionResponse</code>.
     */
 ...
 * @member {String} KeyId
 */
CancelKeyDeletionResponse.prototype['KeyId'] = undefined;
...
export default CancelKeyDeletionResponse;
