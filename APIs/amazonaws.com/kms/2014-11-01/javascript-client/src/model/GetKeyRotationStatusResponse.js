...
/**
 * The GetKeyRotationStatusResponse model module.
 * @module model/GetKeyRotationStatusResponse
 * @version 2014-11-01
 */
class GetKeyRotationStatusResponse {
    /**
     * Constructs a new <code>GetKeyRotationStatusResponse</code>.
     * @alias module:model/GetKeyRotationStatusResponse
     */
    constructor() { 
        
        GetKeyRotationStatusResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetKeyRotationStatusResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetKeyRotationStatusResponse} obj Optional instance to populate.
     * @return {module:model/GetKeyRotationStatusResponse} The populated <code>GetKeyRotationStatusResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetKeyRotationStatusResponse();

            if (data.hasOwnProperty('KeyRotationEnabled')) {
                obj['KeyRotationEnabled'] = ApiClient.convertToType(data['KeyRotationEnabled'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetKeyRotationStatusResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetKeyRotationStatusResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `KeyRotationEnabled`
        if (data['KeyRotationEnabled']) { // data not null
          Boolean.validateJSON(data['KeyRotationEnabled']);
        }
...
/**
 * @member {Boolean} KeyRotationEnabled
 */
GetKeyRotationStatusResponse.prototype['KeyRotationEnabled'] = undefined;
...
export default GetKeyRotationStatusResponse;
