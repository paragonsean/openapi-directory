...
* @readonly
*/
export default class EncryptionAlgorithmSpec {
    ...
    /**
    * Returns a <code>EncryptionAlgorithmSpec</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/EncryptionAlgorithmSpec} The enum <code>EncryptionAlgorithmSpec</code> value.
    */
