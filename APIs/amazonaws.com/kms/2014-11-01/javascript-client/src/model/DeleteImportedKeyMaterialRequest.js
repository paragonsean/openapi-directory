...
/**
 * The DeleteImportedKeyMaterialRequest model module.
 * @module model/DeleteImportedKeyMaterialRequest
 * @version 2014-11-01
 */
class DeleteImportedKeyMaterialRequest {
    /**
     * Constructs a new <code>DeleteImportedKeyMaterialRequest</code>.
     * @alias module:model/DeleteImportedKeyMaterialRequest
     * @param keyId {String} 
     */
    constructor(keyId) { 
        
        DeleteImportedKeyMaterialRequest.initialize(this, keyId);
    }
    ...
    /**
     * Constructs a <code>DeleteImportedKeyMaterialRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteImportedKeyMaterialRequest} obj Optional instance to populate.
     * @return {module:model/DeleteImportedKeyMaterialRequest} The populated <code>DeleteImportedKeyMaterialRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteImportedKeyMaterialRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteImportedKeyMaterialRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteImportedKeyMaterialRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteImportedKeyMaterialRequest.RequiredProperties) {
...
DeleteImportedKeyMaterialRequest.RequiredProperties = ["KeyId"];

/**
 * @member {String} KeyId
 */
DeleteImportedKeyMaterialRequest.prototype['KeyId'] = undefined;
...
export default DeleteImportedKeyMaterialRequest;
