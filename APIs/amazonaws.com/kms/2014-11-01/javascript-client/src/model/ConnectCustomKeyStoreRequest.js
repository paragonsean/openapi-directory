...
/**
 * The ConnectCustomKeyStoreRequest model module.
 * @module model/ConnectCustomKeyStoreRequest
 * @version 2014-11-01
 */
class ConnectCustomKeyStoreRequest {
    /**
     * Constructs a new <code>ConnectCustomKeyStoreRequest</code>.
     * @alias module:model/ConnectCustomKeyStoreRequest
     * @param customKeyStoreId {String} 
     */
    constructor(customKeyStoreId) { 
        
        ConnectCustomKeyStoreRequest.initialize(this, customKeyStoreId);
    }
    ...
    /**
     * Constructs a <code>ConnectCustomKeyStoreRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConnectCustomKeyStoreRequest} obj Optional instance to populate.
     * @return {module:model/ConnectCustomKeyStoreRequest} The populated <code>ConnectCustomKeyStoreRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConnectCustomKeyStoreRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ConnectCustomKeyStoreRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConnectCustomKeyStoreRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ConnectCustomKeyStoreRequest.RequiredProperties) {
...
ConnectCustomKeyStoreRequest.RequiredProperties = ["CustomKeyStoreId"];

/**
 * @member {String} CustomKeyStoreId
 */
ConnectCustomKeyStoreRequest.prototype['CustomKeyStoreId'] = undefined;
...
export default ConnectCustomKeyStoreRequest;
