...
/**
 * The ListGrantsResponse model module.
 * @module model/ListGrantsResponse
 * @version 2014-11-01
 */
class ListGrantsResponse {
    /**
     * Constructs a new <code>ListGrantsResponse</code>.
     * @alias module:model/ListGrantsResponse
     */
    constructor() { 
        
        ListGrantsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListGrantsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListGrantsResponse} obj Optional instance to populate.
     * @return {module:model/ListGrantsResponse} The populated <code>ListGrantsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListGrantsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListGrantsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListGrantsResponse</code>.
     */
 ...
 * @member {Array} Grants
 */
ListGrantsResponse.prototype['Grants'] = undefined;

/**
 * @member {String} NextMarker
 */
ListGrantsResponse.prototype['NextMarker'] = undefined;

/**
 * @member {Boolean} Truncated
 */
ListGrantsResponse.prototype['Truncated'] = undefined;
...
export default ListGrantsResponse;
