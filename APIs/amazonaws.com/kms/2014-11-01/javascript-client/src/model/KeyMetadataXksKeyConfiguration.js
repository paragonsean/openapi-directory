...
/**
 * The KeyMetadataXksKeyConfiguration model module.
 * @module model/KeyMetadataXksKeyConfiguration
 * @version 2014-11-01
 */
class KeyMetadataXksKeyConfiguration {
    /**
     * Constructs a new <code>KeyMetadataXksKeyConfiguration</code>.
     * @alias module:model/KeyMetadataXksKeyConfiguration
     * @implements module:model/XksKeyConfigurationType
     */
    constructor() { 
        XksKeyConfigurationType.initialize(this);
        KeyMetadataXksKeyConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>KeyMetadataXksKeyConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/KeyMetadataXksKeyConfiguration} obj Optional instance to populate.
     * @return {module:model/KeyMetadataXksKeyConfiguration} The populated <code>KeyMetadataXksKeyConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new KeyMetadataXksKeyConfiguration();
            XksKeyConfigurationType.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>KeyMetadataXksKeyConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>KeyMetadataXksKeyConfiguration</code>.
     */
 ...
 * @member {String} Id
 */
KeyMetadataXksKeyConfiguration.prototype['Id'] = undefined;


// Implement XksKeyConfigurationType interface:
/**
 * @member {String} Id
 */
...
export default KeyMetadataXksKeyConfiguration;
