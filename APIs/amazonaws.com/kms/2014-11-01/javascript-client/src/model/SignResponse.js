...
class SignResponse {
    ...
    /**
     * Validates the JSON data with respect to <code>SignResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SignResponse</code>.
     */
 ...
 * @member {String} KeyId
 */
SignResponse.prototype['KeyId'] = undefined;

/**
 * @member {String} Signature
 */
SignResponse.prototype['Signature'] = undefined;

/**
 * @member {module:model/SigningAlgorithmSpec} SigningAlgorithm
 */
SignResponse.prototype['SigningAlgorithm'] = undefined;
