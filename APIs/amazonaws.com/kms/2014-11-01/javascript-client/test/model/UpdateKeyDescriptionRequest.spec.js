...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.UpdateKeyDescriptionRequest();
  });
  ...
  describe('UpdateKeyDescriptionRequest', function() {
    it('should create an instance of UpdateKeyDescriptionRequest', function() {
      // uncomment below and update the code to test UpdateKeyDescriptionRequest
      //var instance = new AwsKeyManagementService.UpdateKeyDescriptionRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.UpdateKeyDescriptionRequest);
    });
