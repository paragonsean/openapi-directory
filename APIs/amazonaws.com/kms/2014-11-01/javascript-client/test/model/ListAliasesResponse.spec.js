...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.ListAliasesResponse();
  });
  ...
  describe('ListAliasesResponse', function() {
    it('should create an instance of ListAliasesResponse', function() {
      ...
      //var instance = new AwsKeyManagementService.ListAliasesResponse();
      //expect(instance).to.be.a(AwsKeyManagementService.ListAliasesResponse);
    });
