...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.ListAliasesRequest();
  });
  ...
  describe('ListAliasesRequest', function() {
    it('should create an instance of ListAliasesRequest', function() {
      ...
      //var instance = new AwsKeyManagementService.ListAliasesRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.ListAliasesRequest);
    });
