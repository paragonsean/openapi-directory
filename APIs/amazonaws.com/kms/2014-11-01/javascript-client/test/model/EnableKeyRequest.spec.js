...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.EnableKeyRequest();
  });
  ...
  describe('EnableKeyRequest', function() {
    it('should create an instance of EnableKeyRequest', function() {
      // uncomment below and update the code to test EnableKeyRequest
      //var instance = new AwsKeyManagementService.EnableKeyRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.EnableKeyRequest);
    });
