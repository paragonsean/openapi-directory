...
(function(root, factory) {
  ...
  describe('KeyState', function() {
    it('should create an instance of KeyState', function() {
      // uncomment below and update the code to test KeyState
      //var instance = new AwsKeyManagementService.KeyState();
      //expect(instance).to.be.a(AwsKeyManagementService.KeyState);
    });
