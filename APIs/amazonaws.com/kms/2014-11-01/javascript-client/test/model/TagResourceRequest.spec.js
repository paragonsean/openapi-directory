...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AwsKeyManagementService.TagResourceRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.TagResourceRequest);
    });
