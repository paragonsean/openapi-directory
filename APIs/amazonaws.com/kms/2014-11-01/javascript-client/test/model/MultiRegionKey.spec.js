...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.MultiRegionKey();
  });
  ...
  describe('MultiRegionKey', function() {
    it('should create an instance of MultiRegionKey', function() {
      // uncomment below and update the code to test MultiRegionKey
      //var instance = new AwsKeyManagementService.MultiRegionKey();
      //expect(instance).to.be.a(AwsKeyManagementService.MultiRegionKey);
    });
