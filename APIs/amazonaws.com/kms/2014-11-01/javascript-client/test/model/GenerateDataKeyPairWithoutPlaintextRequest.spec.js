...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.GenerateDataKeyPairWithoutPlaintextRequest();
  });
  ...
  describe('GenerateDataKeyPairWithoutPlaintextRequest', function() {
    it('should create an instance of GenerateDataKeyPairWithoutPlaintextRequest', function() {
      // uncomment below and update the code to test GenerateDataKeyPairWithoutPlaintextRequest
      //var instance = new AwsKeyManagementService.GenerateDataKeyPairWithoutPlaintextRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.GenerateDataKeyPairWithoutPlaintextRequest);
    });

    it('should have the property encryptionContext (base name: "EncryptionContext")', function() {
