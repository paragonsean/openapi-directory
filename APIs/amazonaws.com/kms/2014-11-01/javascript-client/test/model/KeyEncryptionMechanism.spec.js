...
(function(root, factory) {
  ...
  describe('KeyEncryptionMechanism', function() {
    it('should create an instance of KeyEncryptionMechanism', function() {
      // uncomment below and update the code to test KeyEncryptionMechanism
      //var instance = new AwsKeyManagementService.KeyEncryptionMechanism();
      //expect(instance).to.be.a(AwsKeyManagementService.KeyEncryptionMechanism);
    });
