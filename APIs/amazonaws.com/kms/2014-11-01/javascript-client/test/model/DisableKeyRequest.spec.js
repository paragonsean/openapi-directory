...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.DisableKeyRequest();
  });
  ...
  describe('DisableKeyRequest', function() {
    it('should create an instance of DisableKeyRequest', function() {
      // uncomment below and update the code to test DisableKeyRequest
      //var instance = new AwsKeyManagementService.DisableKeyRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.DisableKeyRequest);
    });
