...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.CreateGrantResponse();
  });
  ...
  describe('CreateGrantResponse', function() {
    it('should create an instance of CreateGrantResponse', function() {
      // uncomment below and update the code to test CreateGrantResponse
      //var instance = new AwsKeyManagementService.CreateGrantResponse();
      //expect(instance).to.be.a(AwsKeyManagementService.CreateGrantResponse);
    });
