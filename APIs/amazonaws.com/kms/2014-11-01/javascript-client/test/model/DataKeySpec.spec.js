...
(function(root, factory) {
  ...
  describe('DataKeySpec', function() {
    it('should create an instance of DataKeySpec', function() {
      // uncomment below and update the code to test DataKeySpec
      //var instance = new AwsKeyManagementService.DataKeySpec();
      //expect(instance).to.be.a(AwsKeyManagementService.DataKeySpec);
    });
