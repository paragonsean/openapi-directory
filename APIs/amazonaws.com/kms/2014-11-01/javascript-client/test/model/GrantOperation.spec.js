...
(function(root, factory) {
  ...
  describe('GrantOperation', function() {
    it('should create an instance of GrantOperation', function() {
      // uncomment below and update the code to test GrantOperation
      //var instance = new AwsKeyManagementService.GrantOperation();
      //expect(instance).to.be.a(AwsKeyManagementService.GrantOperation);
    });
