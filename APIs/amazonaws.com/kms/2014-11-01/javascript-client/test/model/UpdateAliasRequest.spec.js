...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.UpdateAliasRequest();
  });
  ...
  describe('UpdateAliasRequest', function() {
    it('should create an instance of UpdateAliasRequest', function() {
      // uncomment below and update the code to test UpdateAliasRequest
      //var instance = new AwsKeyManagementService.UpdateAliasRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.UpdateAliasRequest);
    });
    ...
    it('should have the property targetKeyId (base name: "TargetKeyId")', function() {
      // uncomment below and update the code to test the property targetKeyId
      //var instance = new AwsKeyManagementService.UpdateAliasRequest();
      //expect(instance).to.be();
    });
