...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.CreateGrantRequestConstraints();
  });
  ...
  describe('CreateGrantRequestConstraints', function() {
    it('should create an instance of CreateGrantRequestConstraints', function() {
      // uncomment below and update the code to test CreateGrantRequestConstraints
      //var instance = new AwsKeyManagementService.CreateGrantRequestConstraints();
      //expect(instance).to.be.a(AwsKeyManagementService.CreateGrantRequestConstraints);
    });

    it('should have the property encryptionContextSubset (base name: "EncryptionContextSubset")', function() {
      // uncomment below and update the code to test the property encryptionContextSubset
      //var instance = new AwsKeyManagementService.CreateGrantRequestConstraints();
      //expect(instance).to.be();
    });

    it('should have the property encryptionContextEquals (base name: "EncryptionContextEquals")', function() {
      // uncomment below and update the code to test the property encryptionContextEquals
      //var instance = new AwsKeyManagementService.CreateGrantRequestConstraints();
      //expect(instance).to.be();
    });
