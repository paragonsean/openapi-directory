...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.GenerateDataKeyPairWithoutPlaintextResponse();
  });
  ...
  describe('GenerateDataKeyPairWithoutPlaintextResponse', function() {
    it('should create an instance of GenerateDataKeyPairWithoutPlaintextResponse', function() {
      // uncomment below and update the code to test GenerateDataKeyPairWithoutPlaintextResponse
      //var instance = new AwsKeyManagementService.GenerateDataKeyPairWithoutPlaintextResponse();
      //expect(instance).to.be.a(AwsKeyManagementService.GenerateDataKeyPairWithoutPlaintextResponse);
    });
