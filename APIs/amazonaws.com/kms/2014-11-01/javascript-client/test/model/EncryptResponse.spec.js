...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.EncryptResponse();
  });
  ...
  describe('EncryptResponse', function() {
    it('should create an instance of EncryptResponse', function() {
      ...
      //var instance = new AwsKeyManagementService.EncryptResponse();
      //expect(instance).to.be.a(AwsKeyManagementService.EncryptResponse);
    });
