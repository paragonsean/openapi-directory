...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.GenerateMacResponse();
  });
  ...
  describe('GenerateMacResponse', function() {
    it('should create an instance of GenerateMacResponse', function() {
      // uncomment below and update the code to test GenerateMacResponse
      //var instance = new AwsKeyManagementService.GenerateMacResponse();
      //expect(instance).to.be.a(AwsKeyManagementService.GenerateMacResponse);
    });
