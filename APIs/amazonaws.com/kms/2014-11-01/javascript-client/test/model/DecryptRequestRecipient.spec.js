...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.DecryptRequestRecipient();
  });
  ...
  describe('DecryptRequestRecipient', function() {
    it('should create an instance of DecryptRequestRecipient', function() {
      // uncomment below and update the code to test DecryptRequestRecipient
      //var instance = new AwsKeyManagementService.DecryptRequestRecipient();
      //expect(instance).to.be.a(AwsKeyManagementService.DecryptRequestRecipient);
    });
