...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.ListResourceTagsResponse();
  });
  ...
  describe('ListResourceTagsResponse', function() {
    it('should create an instance of ListResourceTagsResponse', function() {
      // uncomment below and update the code to test ListResourceTagsResponse
      //var instance = new AwsKeyManagementService.ListResourceTagsResponse();
      //expect(instance).to.be.a(AwsKeyManagementService.ListResourceTagsResponse);
    });
