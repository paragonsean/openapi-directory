...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential();
  });
  ...
  describe('UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential', function() {
    it('should create an instance of UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential', function() {
      // uncomment below and update the code to test UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential
      //var instance = new AwsKeyManagementService.UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential();
      //expect(instance).to.be.a(AwsKeyManagementService.UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential);
    });
    ...
    it('should have the property rawSecretAccessKey (base name: "RawSecretAccessKey")', function() {
      // uncomment below and update the code to test the property rawSecretAccessKey
      //var instance = new AwsKeyManagementService.UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential();
      //expect(instance).to.be();
    });
