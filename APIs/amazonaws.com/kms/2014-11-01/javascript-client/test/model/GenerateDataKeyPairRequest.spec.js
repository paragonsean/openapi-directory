...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.GenerateDataKeyPairRequest();
  });
  ...
  describe('GenerateDataKeyPairRequest', function() {
    it('should create an instance of GenerateDataKeyPairRequest', function() {
      // uncomment below and update the code to test GenerateDataKeyPairRequest
      //var instance = new AwsKeyManagementService.GenerateDataKeyPairRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.GenerateDataKeyPairRequest);
    });
