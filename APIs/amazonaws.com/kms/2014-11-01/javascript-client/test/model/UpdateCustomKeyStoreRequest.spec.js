...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.UpdateCustomKeyStoreRequest();
  });
  ...
  describe('UpdateCustomKeyStoreRequest', function() {
    it('should create an instance of UpdateCustomKeyStoreRequest', function() {
      // uncomment below and update the code to test UpdateCustomKeyStoreRequest
      //var instance = new AwsKeyManagementService.UpdateCustomKeyStoreRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.UpdateCustomKeyStoreRequest);
    });
    ...
    it('should have the property newCustomKeyStoreName (base name: "NewCustomKeyStoreName")', function() {
      // uncomment below and update the code to test the property newCustomKeyStoreName
      //var instance = new AwsKeyManagementService.UpdateCustomKeyStoreRequest();
      //expect(instance).to.be();
    });
