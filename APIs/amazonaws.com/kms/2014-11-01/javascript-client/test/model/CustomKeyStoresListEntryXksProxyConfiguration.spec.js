...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.CustomKeyStoresListEntryXksProxyConfiguration();
  });
  ...
  describe('CustomKeyStoresListEntryXksProxyConfiguration', function() {
    it('should create an instance of CustomKeyStoresListEntryXksProxyConfiguration', function() {
      // uncomment below and update the code to test CustomKeyStoresListEntryXksProxyConfiguration
      //var instance = new AwsKeyManagementService.CustomKeyStoresListEntryXksProxyConfiguration();
      //expect(instance).to.be.a(AwsKeyManagementService.CustomKeyStoresListEntryXksProxyConfiguration);
    });
