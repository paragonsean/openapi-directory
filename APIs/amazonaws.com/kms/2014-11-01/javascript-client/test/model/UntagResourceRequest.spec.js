...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.UntagResourceRequest();
  });
  ...
  describe('UntagResourceRequest', function() {
    it('should create an instance of UntagResourceRequest', function() {
      ...
      //var instance = new AwsKeyManagementService.UntagResourceRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.UntagResourceRequest);
    });
