...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.DescribeCustomKeyStoresResponse();
  });
  ...
  describe('DescribeCustomKeyStoresResponse', function() {
    it('should create an instance of DescribeCustomKeyStoresResponse', function() {
      // uncomment below and update the code to test DescribeCustomKeyStoresResponse
      //var instance = new AwsKeyManagementService.DescribeCustomKeyStoresResponse();
      //expect(instance).to.be.a(AwsKeyManagementService.DescribeCustomKeyStoresResponse);
    });

    it('should have the property customKeyStores (base name: "CustomKeyStores")', function() {
      // uncomment below and update the code to test the property customKeyStores
      //var instance = new AwsKeyManagementService.DescribeCustomKeyStoresResponse();
