...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.GetParametersForImportResponse();
  });
  ...
  describe('GetParametersForImportResponse', function() {
    it('should create an instance of GetParametersForImportResponse', function() {
      // uncomment below and update the code to test GetParametersForImportResponse
      //var instance = new AwsKeyManagementService.GetParametersForImportResponse();
      //expect(instance).to.be.a(AwsKeyManagementService.GetParametersForImportResponse);
    });
    ...
    it('should have the property parametersValidTo (base name: "ParametersValidTo")', function() {
      // uncomment below and update the code to test the property parametersValidTo
      //var instance = new AwsKeyManagementService.GetParametersForImportResponse();
      //expect(instance).to.be();
    });
