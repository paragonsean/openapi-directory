...
(function(root, factory) {
  ...
  describe('SigningAlgorithmSpec', function() {
    it('should create an instance of SigningAlgorithmSpec', function() {
      // uncomment below and update the code to test SigningAlgorithmSpec
      //var instance = new AwsKeyManagementService.SigningAlgorithmSpec();
      //expect(instance).to.be.a(AwsKeyManagementService.SigningAlgorithmSpec);
    });
