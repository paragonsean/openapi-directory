...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.CustomKeyStoresListEntry();
  });
  ...
  describe('CustomKeyStoresListEntry', function() {
    it('should create an instance of CustomKeyStoresListEntry', function() {
      // uncomment below and update the code to test CustomKeyStoresListEntry
      //var instance = new AwsKeyManagementService.CustomKeyStoresListEntry();
      //expect(instance).to.be.a(AwsKeyManagementService.CustomKeyStoresListEntry);
    });
    ...
    it('should have the property connectionErrorCode (base name: "ConnectionErrorCode")', function() {
      // uncomment below and update the code to test the property connectionErrorCode
      //var instance = new AwsKeyManagementService.CustomKeyStoresListEntry();
      //expect(instance).to.be();
    });
    ...
    it('should have the property xksProxyConfiguration (base name: "XksProxyConfiguration")', function() {
      // uncomment below and update the code to test the property xksProxyConfiguration
      //var instance = new AwsKeyManagementService.CustomKeyStoresListEntry();
      //expect(instance).to.be();
    });
