...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.GetKeyPolicyRequest();
  });
  ...
  describe('GetKeyPolicyRequest', function() {
    it('should create an instance of GetKeyPolicyRequest', function() {
      // uncomment below and update the code to test GetKeyPolicyRequest
      //var instance = new AwsKeyManagementService.GetKeyPolicyRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.GetKeyPolicyRequest);
    });
