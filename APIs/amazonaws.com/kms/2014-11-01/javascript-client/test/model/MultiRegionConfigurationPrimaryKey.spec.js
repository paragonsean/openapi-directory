...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.MultiRegionConfigurationPrimaryKey();
  });
  ...
  describe('MultiRegionConfigurationPrimaryKey', function() {
    it('should create an instance of MultiRegionConfigurationPrimaryKey', function() {
      // uncomment below and update the code to test MultiRegionConfigurationPrimaryKey
      //var instance = new AwsKeyManagementService.MultiRegionConfigurationPrimaryKey();
      //expect(instance).to.be.a(AwsKeyManagementService.MultiRegionConfigurationPrimaryKey);
    });
