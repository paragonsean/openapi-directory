...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.VerifyMacResponse();
  });
  ...
  describe('VerifyMacResponse', function() {
    it('should create an instance of VerifyMacResponse', function() {
      // uncomment below and update the code to test VerifyMacResponse
      //var instance = new AwsKeyManagementService.VerifyMacResponse();
      //expect(instance).to.be.a(AwsKeyManagementService.VerifyMacResponse);
    });
    ...
    it('should have the property macValid (base name: "MacValid")', function() {
      // uncomment below and update the code to test the property macValid
      //var instance = new AwsKeyManagementService.VerifyMacResponse();
      //expect(instance).to.be();
    });
