...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.ReEncryptRequest();
  });
  ...
  describe('ReEncryptRequest', function() {
    it('should create an instance of ReEncryptRequest', function() {
      // uncomment below and update the code to test ReEncryptRequest
      //var instance = new AwsKeyManagementService.ReEncryptRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.ReEncryptRequest);
    });
    ...
    it('should have the property sourceEncryptionContext (base name: "SourceEncryptionContext")', function() {
      // uncomment below and update the code to test the property sourceEncryptionContext
      //var instance = new AwsKeyManagementService.ReEncryptRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property destinationKeyId (base name: "DestinationKeyId")', function() {
      // uncomment below and update the code to test the property destinationKeyId
      //var instance = new AwsKeyManagementService.ReEncryptRequest();
      //expect(instance).to.be();
    });

    it('should have the property destinationEncryptionContext (base name: "DestinationEncryptionContext")', function() {
      // uncomment below and update the code to test the property destinationEncryptionContext
      //var instance = new AwsKeyManagementService.ReEncryptRequest();
      //expect(instance).to.be();
    });
