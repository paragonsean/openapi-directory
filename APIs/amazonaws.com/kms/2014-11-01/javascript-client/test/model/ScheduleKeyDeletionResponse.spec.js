...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.ScheduleKeyDeletionResponse();
  });
  ...
  describe('ScheduleKeyDeletionResponse', function() {
    it('should create an instance of ScheduleKeyDeletionResponse', function() {
      // uncomment below and update the code to test ScheduleKeyDeletionResponse
      //var instance = new AwsKeyManagementService.ScheduleKeyDeletionResponse();
      //expect(instance).to.be.a(AwsKeyManagementService.ScheduleKeyDeletionResponse);
    });
    ...
    it('should have the property pendingWindowInDays (base name: "PendingWindowInDays")', function() {
      // uncomment below and update the code to test the property pendingWindowInDays
      //var instance = new AwsKeyManagementService.ScheduleKeyDeletionResponse();
      //expect(instance).to.be();
    });
