...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.ImportKeyMaterialRequest();
  });
  ...
  describe('ImportKeyMaterialRequest', function() {
    it('should create an instance of ImportKeyMaterialRequest', function() {
      // uncomment below and update the code to test ImportKeyMaterialRequest
      //var instance = new AwsKeyManagementService.ImportKeyMaterialRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.ImportKeyMaterialRequest);
    });
    ...
    it('should have the property encryptedKeyMaterial (base name: "EncryptedKeyMaterial")', function() {
      // uncomment below and update the code to test the property encryptedKeyMaterial
      //var instance = new AwsKeyManagementService.ImportKeyMaterialRequest();
      //expect(instance).to.be();
    });
