...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.DeleteImportedKeyMaterialRequest();
  });
  ...
  describe('DeleteImportedKeyMaterialRequest', function() {
    it('should create an instance of DeleteImportedKeyMaterialRequest', function() {
      // uncomment below and update the code to test DeleteImportedKeyMaterialRequest
      //var instance = new AwsKeyManagementService.DeleteImportedKeyMaterialRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.DeleteImportedKeyMaterialRequest);
    });
