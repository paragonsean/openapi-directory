...
(function(root, factory) {
  ...
  describe('KeyUsageType', function() {
    it('should create an instance of KeyUsageType', function() {
      // uncomment below and update the code to test KeyUsageType
      //var instance = new AwsKeyManagementService.KeyUsageType();
      //expect(instance).to.be.a(AwsKeyManagementService.KeyUsageType);
    });
