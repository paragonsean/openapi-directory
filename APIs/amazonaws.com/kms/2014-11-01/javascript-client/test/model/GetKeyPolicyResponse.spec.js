...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.GetKeyPolicyResponse();
  });
  ...
  describe('GetKeyPolicyResponse', function() {
    it('should create an instance of GetKeyPolicyResponse', function() {
      // uncomment below and update the code to test GetKeyPolicyResponse
      //var instance = new AwsKeyManagementService.GetKeyPolicyResponse();
      //expect(instance).to.be.a(AwsKeyManagementService.GetKeyPolicyResponse);
    });
