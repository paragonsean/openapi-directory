...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.MultiRegionConfiguration();
  });
  ...
  describe('MultiRegionConfiguration', function() {
    it('should create an instance of MultiRegionConfiguration', function() {
      // uncomment below and update the code to test MultiRegionConfiguration
      //var instance = new AwsKeyManagementService.MultiRegionConfiguration();
      //expect(instance).to.be.a(AwsKeyManagementService.MultiRegionConfiguration);
    });
