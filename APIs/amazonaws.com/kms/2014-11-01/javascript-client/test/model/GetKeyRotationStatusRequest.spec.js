...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.GetKeyRotationStatusRequest();
  });
  ...
  describe('GetKeyRotationStatusRequest', function() {
    it('should create an instance of GetKeyRotationStatusRequest', function() {
      // uncomment below and update the code to test GetKeyRotationStatusRequest
      //var instance = new AwsKeyManagementService.GetKeyRotationStatusRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.GetKeyRotationStatusRequest);
    });
