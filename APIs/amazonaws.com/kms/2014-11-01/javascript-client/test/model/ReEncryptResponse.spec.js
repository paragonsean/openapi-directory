...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.ReEncryptResponse();
  });
  ...
  describe('ReEncryptResponse', function() {
    it('should create an instance of ReEncryptResponse', function() {
      // uncomment below and update the code to test ReEncryptResponse
      //var instance = new AwsKeyManagementService.ReEncryptResponse();
      //expect(instance).to.be.a(AwsKeyManagementService.ReEncryptResponse);
    });

    it('should have the property ciphertextBlob (base name: "CiphertextBlob")', function() {
      // uncomment below and update the code to test the property ciphertextBlob
      //var instance = new AwsKeyManagementService.ReEncryptResponse();
      //expect(instance).to.be();
    });

    it('should have the property sourceKeyId (base name: "SourceKeyId")', function() {
      // uncomment below and update the code to test the property sourceKeyId
      //var instance = new AwsKeyManagementService.ReEncryptResponse();
      //expect(instance).to.be();
    });
    ...
    it('should have the property sourceEncryptionAlgorithm (base name: "SourceEncryptionAlgorithm")', function() {
      // uncomment below and update the code to test the property sourceEncryptionAlgorithm
      //var instance = new AwsKeyManagementService.ReEncryptResponse();
      //expect(instance).to.be();
    });

    it('should have the property destinationEncryptionAlgorithm (base name: "DestinationEncryptionAlgorithm")', function() {
      // uncomment below and update the code to test the property destinationEncryptionAlgorithm
      //var instance = new AwsKeyManagementService.ReEncryptResponse();
      //expect(instance).to.be();
    });
