...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.GetPublicKeyRequest();
  });
  ...
  describe('GetPublicKeyRequest', function() {
    it('should create an instance of GetPublicKeyRequest', function() {
      ...
      //var instance = new AwsKeyManagementService.GetPublicKeyRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.GetPublicKeyRequest);
    });
