...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.GenerateDataKeyWithoutPlaintextResponse();
  });
  ...
  describe('GenerateDataKeyWithoutPlaintextResponse', function() {
    it('should create an instance of GenerateDataKeyWithoutPlaintextResponse', function() {
      // uncomment below and update the code to test GenerateDataKeyWithoutPlaintextResponse
      //var instance = new AwsKeyManagementService.GenerateDataKeyWithoutPlaintextResponse();
      //expect(instance).to.be.a(AwsKeyManagementService.GenerateDataKeyWithoutPlaintextResponse);
    });
