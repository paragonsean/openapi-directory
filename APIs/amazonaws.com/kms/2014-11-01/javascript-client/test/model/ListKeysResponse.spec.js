...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.ListKeysResponse();
  });
  ...
  describe('ListKeysResponse', function() {
    it('should create an instance of ListKeysResponse', function() {
      // uncomment below and update the code to test ListKeysResponse
      //var instance = new AwsKeyManagementService.ListKeysResponse();
      //expect(instance).to.be.a(AwsKeyManagementService.ListKeysResponse);
    });
