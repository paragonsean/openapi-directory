...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.CreateAliasRequest();
  });
  ...
  describe('CreateAliasRequest', function() {
    it('should create an instance of CreateAliasRequest', function() {
      ...
      //var instance = new AwsKeyManagementService.CreateAliasRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.CreateAliasRequest);
    });
