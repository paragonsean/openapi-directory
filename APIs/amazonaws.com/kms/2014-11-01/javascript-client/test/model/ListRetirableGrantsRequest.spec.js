...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.ListRetirableGrantsRequest();
  });
  ...
  describe('ListRetirableGrantsRequest', function() {
    it('should create an instance of ListRetirableGrantsRequest', function() {
      // uncomment below and update the code to test ListRetirableGrantsRequest
      //var instance = new AwsKeyManagementService.ListRetirableGrantsRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.ListRetirableGrantsRequest);
    });
    ...
    it('should have the property retiringPrincipal (base name: "RetiringPrincipal")', function() {
      // uncomment below and update the code to test the property retiringPrincipal
      //var instance = new AwsKeyManagementService.ListRetirableGrantsRequest();
      //expect(instance).to.be();
    });
