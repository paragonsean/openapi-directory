...
(function(root, factory) {
  ...
  describe('MultiRegionKeyType', function() {
    it('should create an instance of MultiRegionKeyType', function() {
      // uncomment below and update the code to test MultiRegionKeyType
      //var instance = new AwsKeyManagementService.MultiRegionKeyType();
      //expect(instance).to.be.a(AwsKeyManagementService.MultiRegionKeyType);
    });
