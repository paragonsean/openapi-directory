...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.CreateCustomKeyStoreRequestXksProxyAuthenticationCredential();
  });
  ...
  describe('CreateCustomKeyStoreRequestXksProxyAuthenticationCredential', function() {
    it('should create an instance of CreateCustomKeyStoreRequestXksProxyAuthenticationCredential', function() {
      // uncomment below and update the code to test CreateCustomKeyStoreRequestXksProxyAuthenticationCredential
      //var instance = new AwsKeyManagementService.CreateCustomKeyStoreRequestXksProxyAuthenticationCredential();
      //expect(instance).to.be.a(AwsKeyManagementService.CreateCustomKeyStoreRequestXksProxyAuthenticationCredential);
    });
