...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.KeyMetadataXksKeyConfiguration();
  });
  ...
  describe('KeyMetadataXksKeyConfiguration', function() {
    it('should create an instance of KeyMetadataXksKeyConfiguration', function() {
      // uncomment below and update the code to test KeyMetadataXksKeyConfiguration
      //var instance = new AwsKeyManagementService.KeyMetadataXksKeyConfiguration();
      //expect(instance).to.be.a(AwsKeyManagementService.KeyMetadataXksKeyConfiguration);
    });
