...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.ListKeyPoliciesResponse();
  });
  ...
  describe('ListKeyPoliciesResponse', function() {
    it('should create an instance of ListKeyPoliciesResponse', function() {
      // uncomment below and update the code to test ListKeyPoliciesResponse
      //var instance = new AwsKeyManagementService.ListKeyPoliciesResponse();
      //expect(instance).to.be.a(AwsKeyManagementService.ListKeyPoliciesResponse);
    });
