...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.GrantListEntryConstraints();
  });
  ...
  describe('GrantListEntryConstraints', function() {
    it('should create an instance of GrantListEntryConstraints', function() {
      // uncomment below and update the code to test GrantListEntryConstraints
      //var instance = new AwsKeyManagementService.GrantListEntryConstraints();
      //expect(instance).to.be.a(AwsKeyManagementService.GrantListEntryConstraints);
    });
