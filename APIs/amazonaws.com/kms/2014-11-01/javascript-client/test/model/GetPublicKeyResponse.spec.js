...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.GetPublicKeyResponse();
  });
  ...
  describe('GetPublicKeyResponse', function() {
    it('should create an instance of GetPublicKeyResponse', function() {
      // uncomment below and update the code to test GetPublicKeyResponse
      //var instance = new AwsKeyManagementService.GetPublicKeyResponse();
      //expect(instance).to.be.a(AwsKeyManagementService.GetPublicKeyResponse);
    });
