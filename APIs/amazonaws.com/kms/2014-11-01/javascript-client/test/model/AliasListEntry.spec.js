...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.AliasListEntry();
  });
  ...
  describe('AliasListEntry', function() {
    it('should create an instance of AliasListEntry', function() {
      // uncomment below and update the code to test AliasListEntry
      //var instance = new AwsKeyManagementService.AliasListEntry();
      //expect(instance).to.be.a(AwsKeyManagementService.AliasListEntry);
    });
