...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.GenerateMacRequest();
  });
  ...
  describe('GenerateMacRequest', function() {
    it('should create an instance of GenerateMacRequest', function() {
      // uncomment below and update the code to test GenerateMacRequest
      //var instance = new AwsKeyManagementService.GenerateMacRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.GenerateMacRequest);
    });
