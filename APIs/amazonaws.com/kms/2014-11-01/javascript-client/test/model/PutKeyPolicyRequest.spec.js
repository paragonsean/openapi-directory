...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.PutKeyPolicyRequest();
  });
  ...
  describe('PutKeyPolicyRequest', function() {
    it('should create an instance of PutKeyPolicyRequest', function() {
      // uncomment below and update the code to test PutKeyPolicyRequest
      //var instance = new AwsKeyManagementService.PutKeyPolicyRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.PutKeyPolicyRequest);
    });
