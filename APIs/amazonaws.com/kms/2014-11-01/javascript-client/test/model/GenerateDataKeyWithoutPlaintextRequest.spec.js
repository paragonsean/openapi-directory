...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.GenerateDataKeyWithoutPlaintextRequest();
  });
  ...
  describe('GenerateDataKeyWithoutPlaintextRequest', function() {
    it('should create an instance of GenerateDataKeyWithoutPlaintextRequest', function() {
      // uncomment below and update the code to test GenerateDataKeyWithoutPlaintextRequest
      //var instance = new AwsKeyManagementService.GenerateDataKeyWithoutPlaintextRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.GenerateDataKeyWithoutPlaintextRequest);
    });
