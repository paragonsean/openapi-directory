...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.GenerateRandomRequestRecipient();
  });
  ...
  describe('GenerateRandomRequestRecipient', function() {
    it('should create an instance of GenerateRandomRequestRecipient', function() {
      // uncomment below and update the code to test GenerateRandomRequestRecipient
      //var instance = new AwsKeyManagementService.GenerateRandomRequestRecipient();
      //expect(instance).to.be.a(AwsKeyManagementService.GenerateRandomRequestRecipient);
    });
