...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.CreateKeyRequest();
  });
  ...
  describe('CreateKeyRequest', function() {
    it('should create an instance of CreateKeyRequest', function() {
      ...
      //var instance = new AwsKeyManagementService.CreateKeyRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.CreateKeyRequest);
    });
    ...
    it('should have the property xksKeyId (base name: "XksKeyId")', function() {
      // uncomment below and update the code to test the property xksKeyId
      //var instance = new AwsKeyManagementService.CreateKeyRequest();
      //expect(instance).to.be();
    });
