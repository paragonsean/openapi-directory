...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.RetireGrantRequest();
  });
  ...
  describe('RetireGrantRequest', function() {
    it('should create an instance of RetireGrantRequest', function() {
      // uncomment below and update the code to test RetireGrantRequest
      //var instance = new AwsKeyManagementService.RetireGrantRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.RetireGrantRequest);
    });

    it('should have the property grantToken (base name: "GrantToken")', function() {
      // uncomment below and update the code to test the property grantToken
      //var instance = new AwsKeyManagementService.RetireGrantRequest();
