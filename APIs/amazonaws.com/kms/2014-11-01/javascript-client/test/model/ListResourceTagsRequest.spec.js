...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.ListResourceTagsRequest();
  });
  ...
  describe('ListResourceTagsRequest', function() {
    it('should create an instance of ListResourceTagsRequest', function() {
      // uncomment below and update the code to test ListResourceTagsRequest
      //var instance = new AwsKeyManagementService.ListResourceTagsRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.ListResourceTagsRequest);
    });
