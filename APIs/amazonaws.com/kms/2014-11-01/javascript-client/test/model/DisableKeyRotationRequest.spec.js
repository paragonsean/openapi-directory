...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.DisableKeyRotationRequest();
  });
  ...
  describe('DisableKeyRotationRequest', function() {
    it('should create an instance of DisableKeyRotationRequest', function() {
      // uncomment below and update the code to test DisableKeyRotationRequest
      //var instance = new AwsKeyManagementService.DisableKeyRotationRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.DisableKeyRotationRequest);
    });
