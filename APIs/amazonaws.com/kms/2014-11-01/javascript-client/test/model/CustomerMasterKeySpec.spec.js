...
(function(root, factory) {
  ...
  describe('CustomerMasterKeySpec', function() {
    it('should create an instance of CustomerMasterKeySpec', function() {
      // uncomment below and update the code to test CustomerMasterKeySpec
      //var instance = new AwsKeyManagementService.CustomerMasterKeySpec();
      //expect(instance).to.be.a(AwsKeyManagementService.CustomerMasterKeySpec);
    });
