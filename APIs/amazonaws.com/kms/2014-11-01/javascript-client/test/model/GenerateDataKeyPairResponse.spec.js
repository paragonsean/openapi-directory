...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.GenerateDataKeyPairResponse();
  });
  ...
  describe('GenerateDataKeyPairResponse', function() {
    it('should create an instance of GenerateDataKeyPairResponse', function() {
      // uncomment below and update the code to test GenerateDataKeyPairResponse
      //var instance = new AwsKeyManagementService.GenerateDataKeyPairResponse();
      //expect(instance).to.be.a(AwsKeyManagementService.GenerateDataKeyPairResponse);
    });

    it('should have the property privateKeyCiphertextBlob (base name: "PrivateKeyCiphertextBlob")', function() {
      // uncomment below and update the code to test the property privateKeyCiphertextBlob
      //var instance = new AwsKeyManagementService.GenerateDataKeyPairResponse();
      //expect(instance).to.be();
    });

    it('should have the property privateKeyPlaintext (base name: "PrivateKeyPlaintext")', function() {
      // uncomment below and update the code to test the property privateKeyPlaintext
      //var instance = new AwsKeyManagementService.GenerateDataKeyPairResponse();
      //expect(instance).to.be();
    });
    ...
    it('should have the property keyPairSpec (base name: "KeyPairSpec")', function() {
      // uncomment below and update the code to test the property keyPairSpec
      //var instance = new AwsKeyManagementService.GenerateDataKeyPairResponse();
      //expect(instance).to.be();
    });
