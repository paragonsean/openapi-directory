...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.GenerateDataKeyRequest();
  });
  ...
  describe('GenerateDataKeyRequest', function() {
    it('should create an instance of GenerateDataKeyRequest', function() {
      // uncomment below and update the code to test GenerateDataKeyRequest
      //var instance = new AwsKeyManagementService.GenerateDataKeyRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.GenerateDataKeyRequest);
    });
    ...
    it('should have the property numberOfBytes (base name: "NumberOfBytes")', function() {
      // uncomment below and update the code to test the property numberOfBytes
      //var instance = new AwsKeyManagementService.GenerateDataKeyRequest();
      //expect(instance).to.be();
    });
