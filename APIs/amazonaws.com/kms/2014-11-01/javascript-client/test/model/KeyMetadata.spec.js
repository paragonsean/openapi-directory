...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.KeyMetadata();
  });
  ...
  describe('KeyMetadata', function() {
    it('should create an instance of KeyMetadata', function() {
      ...
      //var instance = new AwsKeyManagementService.KeyMetadata();
      //expect(instance).to.be.a(AwsKeyManagementService.KeyMetadata);
    });
    ...
    it('should have the property keyState (base name: "KeyState")', function() {
    ...
    it('should have the property customKeyStoreId (base name: "CustomKeyStoreId")', function() {
      // uncomment below and update the code to test the property customKeyStoreId
      //var instance = new AwsKeyManagementService.KeyMetadata();
      //expect(instance).to.be();
    });

    it('should have the property cloudHsmClusterId (base name: "CloudHsmClusterId")', function() {
      // uncomment below and update the code to test the property cloudHsmClusterId
      //var instance = new AwsKeyManagementService.KeyMetadata();
      //expect(instance).to.be();
    });

    it('should have the property expirationModel (base name: "ExpirationModel")', function() {
      // uncomment below and update the code to test the property expirationModel
      //var instance = new AwsKeyManagementService.KeyMetadata();
      //expect(instance).to.be();
    });

    it('should have the property keyManager (base name: "KeyManager")', function() {
      // uncomment below and update the code to test the property keyManager
      //var instance = new AwsKeyManagementService.KeyMetadata();
      //expect(instance).to.be();
    });

    it('should have the property customerMasterKeySpec (base name: "CustomerMasterKeySpec")', function() {
      // uncomment below and update the code to test the property customerMasterKeySpec
      //var instance = new AwsKeyManagementService.KeyMetadata();
      //expect(instance).to.be();
    });
    ...
    it('should have the property encryptionAlgorithms (base name: "EncryptionAlgorithms")', function() {
      // uncomment below and update the code to test the property encryptionAlgorithms
      //var instance = new AwsKeyManagementService.KeyMetadata();
      //expect(instance).to.be();
    });

    it('should have the property signingAlgorithms (base name: "SigningAlgorithms")', function() {
      // uncomment below and update the code to test the property signingAlgorithms
      //var instance = new AwsKeyManagementService.KeyMetadata();
      //expect(instance).to.be();
    });
    ...
    it('should have the property multiRegionConfiguration (base name: "MultiRegionConfiguration")', function() {
      // uncomment below and update the code to test the property multiRegionConfiguration
      //var instance = new AwsKeyManagementService.KeyMetadata();
      //expect(instance).to.be();
    });

    it('should have the property pendingDeletionWindowInDays (base name: "PendingDeletionWindowInDays")', function() {
      // uncomment below and update the code to test the property pendingDeletionWindowInDays
      //var instance = new AwsKeyManagementService.KeyMetadata();
      //expect(instance).to.be();
    });

    it('should have the property macAlgorithms (base name: "MacAlgorithms")', function() {
      // uncomment below and update the code to test the property macAlgorithms
      //var instance = new AwsKeyManagementService.KeyMetadata();
      //expect(instance).to.be();
    });

    it('should have the property xksKeyConfiguration (base name: "XksKeyConfiguration")', function() {
      // uncomment below and update the code to test the property xksKeyConfiguration
      //var instance = new AwsKeyManagementService.KeyMetadata();
      //expect(instance).to.be();
    });
