...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.DecryptResponse();
  });
  ...
  describe('DecryptResponse', function() {
    it('should create an instance of DecryptResponse', function() {
      ...
      //var instance = new AwsKeyManagementService.DecryptResponse();
      //expect(instance).to.be.a(AwsKeyManagementService.DecryptResponse);
    });
