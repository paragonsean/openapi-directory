...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.XksKeyConfigurationType();
  });
  ...
  describe('XksKeyConfigurationType', function() {
    it('should create an instance of XksKeyConfigurationType', function() {
      // uncomment below and update the code to test XksKeyConfigurationType
      //var instance = new AwsKeyManagementService.XksKeyConfigurationType();
      //expect(instance).to.be.a(AwsKeyManagementService.XksKeyConfigurationType);
    });
