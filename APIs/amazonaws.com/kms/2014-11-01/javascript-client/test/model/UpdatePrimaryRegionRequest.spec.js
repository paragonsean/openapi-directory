...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.UpdatePrimaryRegionRequest();
  });
  ...
  describe('UpdatePrimaryRegionRequest', function() {
    it('should create an instance of UpdatePrimaryRegionRequest', function() {
      // uncomment below and update the code to test UpdatePrimaryRegionRequest
      //var instance = new AwsKeyManagementService.UpdatePrimaryRegionRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.UpdatePrimaryRegionRequest);
    });
    ...
    it('should have the property primaryRegion (base name: "PrimaryRegion")', function() {
      // uncomment below and update the code to test the property primaryRegion
      //var instance = new AwsKeyManagementService.UpdatePrimaryRegionRequest();
      //expect(instance).to.be();
    });
