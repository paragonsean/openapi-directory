...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.SignRequest();
  });
  ...
  describe('SignRequest', function() {
    it('should create an instance of SignRequest', function() {
      ...
      //var instance = new AwsKeyManagementService.SignRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.SignRequest);
    });
