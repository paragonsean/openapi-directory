...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.GrantListEntry();
  });
  ...
  describe('GrantListEntry', function() {
    it('should create an instance of GrantListEntry', function() {
      // uncomment below and update the code to test GrantListEntry
      //var instance = new AwsKeyManagementService.GrantListEntry();
      //expect(instance).to.be.a(AwsKeyManagementService.GrantListEntry);
    });
    ...
    it('should have the property issuingAccount (base name: "IssuingAccount")', function() {
      // uncomment below and update the code to test the property issuingAccount
      //var instance = new AwsKeyManagementService.GrantListEntry();
      //expect(instance).to.be();
    });
