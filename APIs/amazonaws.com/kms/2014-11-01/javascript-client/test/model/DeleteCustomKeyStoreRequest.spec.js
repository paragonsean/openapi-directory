...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.DeleteCustomKeyStoreRequest();
  });
  ...
  describe('DeleteCustomKeyStoreRequest', function() {
    it('should create an instance of DeleteCustomKeyStoreRequest', function() {
      // uncomment below and update the code to test DeleteCustomKeyStoreRequest
      //var instance = new AwsKeyManagementService.DeleteCustomKeyStoreRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.DeleteCustomKeyStoreRequest);
    });
