...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.ListKeyPoliciesRequest();
  });
  ...
  describe('ListKeyPoliciesRequest', function() {
    it('should create an instance of ListKeyPoliciesRequest', function() {
      // uncomment below and update the code to test ListKeyPoliciesRequest
      //var instance = new AwsKeyManagementService.ListKeyPoliciesRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.ListKeyPoliciesRequest);
    });
