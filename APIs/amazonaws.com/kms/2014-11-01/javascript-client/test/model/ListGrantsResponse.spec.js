...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.ListGrantsResponse();
  });
  ...
  describe('ListGrantsResponse', function() {
    it('should create an instance of ListGrantsResponse', function() {
      // uncomment below and update the code to test ListGrantsResponse
      //var instance = new AwsKeyManagementService.ListGrantsResponse();
      //expect(instance).to.be.a(AwsKeyManagementService.ListGrantsResponse);
    });
