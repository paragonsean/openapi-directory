...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.GenerateRandomResponse();
  });
  ...
  describe('GenerateRandomResponse', function() {
    it('should create an instance of GenerateRandomResponse', function() {
      // uncomment below and update the code to test GenerateRandomResponse
      //var instance = new AwsKeyManagementService.GenerateRandomResponse();
      //expect(instance).to.be.a(AwsKeyManagementService.GenerateRandomResponse);
    });
