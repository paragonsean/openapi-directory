...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.ReplicateKeyRequest();
  });
  ...
  describe('ReplicateKeyRequest', function() {
    it('should create an instance of ReplicateKeyRequest', function() {
      // uncomment below and update the code to test ReplicateKeyRequest
      //var instance = new AwsKeyManagementService.ReplicateKeyRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.ReplicateKeyRequest);
    });
