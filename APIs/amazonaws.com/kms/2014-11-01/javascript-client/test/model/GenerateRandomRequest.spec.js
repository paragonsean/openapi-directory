...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.GenerateRandomRequest();
  });
  ...
  describe('GenerateRandomRequest', function() {
    it('should create an instance of GenerateRandomRequest', function() {
      // uncomment below and update the code to test GenerateRandomRequest
      //var instance = new AwsKeyManagementService.GenerateRandomRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.GenerateRandomRequest);
    });
