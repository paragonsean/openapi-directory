...
(function(root, factory) {
  ...
  describe('ExpirationModelType', function() {
    it('should create an instance of ExpirationModelType', function() {
      // uncomment below and update the code to test ExpirationModelType
      //var instance = new AwsKeyManagementService.ExpirationModelType();
      //expect(instance).to.be.a(AwsKeyManagementService.ExpirationModelType);
    });
