...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.CreateGrantRequest();
  });
  ...
  describe('CreateGrantRequest', function() {
    it('should create an instance of CreateGrantRequest', function() {
      ...
      //var instance = new AwsKeyManagementService.CreateGrantRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.CreateGrantRequest);
    });
