...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.ScheduleKeyDeletionRequest();
  });
  ...
  describe('ScheduleKeyDeletionRequest', function() {
    it('should create an instance of ScheduleKeyDeletionRequest', function() {
      // uncomment below and update the code to test ScheduleKeyDeletionRequest
      //var instance = new AwsKeyManagementService.ScheduleKeyDeletionRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.ScheduleKeyDeletionRequest);
    });
