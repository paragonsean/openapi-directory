...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.DisconnectCustomKeyStoreRequest();
  });
  ...
  describe('DisconnectCustomKeyStoreRequest', function() {
    it('should create an instance of DisconnectCustomKeyStoreRequest', function() {
      // uncomment below and update the code to test DisconnectCustomKeyStoreRequest
      //var instance = new AwsKeyManagementService.DisconnectCustomKeyStoreRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.DisconnectCustomKeyStoreRequest);
    });
