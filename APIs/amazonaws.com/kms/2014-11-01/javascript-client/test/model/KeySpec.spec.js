...
(function(root, factory) {
  ...
  describe('KeySpec', function() {
    it('should create an instance of KeySpec', function() {
      // uncomment below and update the code to test KeySpec
      //var instance = new AwsKeyManagementService.KeySpec();
      //expect(instance).to.be.a(AwsKeyManagementService.KeySpec);
    });
