...
(function(root, factory) {
  ...
  describe('XksProxyConnectivityType', function() {
    it('should create an instance of XksProxyConnectivityType', function() {
      // uncomment below and update the code to test XksProxyConnectivityType
      //var instance = new AwsKeyManagementService.XksProxyConnectivityType();
      //expect(instance).to.be.a(AwsKeyManagementService.XksProxyConnectivityType);
    });
