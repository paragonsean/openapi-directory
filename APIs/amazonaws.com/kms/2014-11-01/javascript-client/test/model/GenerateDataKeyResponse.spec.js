...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.GenerateDataKeyResponse();
  });
  ...
  describe('GenerateDataKeyResponse', function() {
    it('should create an instance of GenerateDataKeyResponse', function() {
      // uncomment below and update the code to test GenerateDataKeyResponse
      //var instance = new AwsKeyManagementService.GenerateDataKeyResponse();
      //expect(instance).to.be.a(AwsKeyManagementService.GenerateDataKeyResponse);
    });
    ...
    it('should have the property ciphertextForRecipient (base name: "CiphertextForRecipient")', function() {
      // uncomment below and update the code to test the property ciphertextForRecipient
      //var instance = new AwsKeyManagementService.GenerateDataKeyResponse();
      //expect(instance).to.be();
    });
