...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.CreateCustomKeyStoreRequest();
  });
  ...
  describe('CreateCustomKeyStoreRequest', function() {
    it('should create an instance of CreateCustomKeyStoreRequest', function() {
      // uncomment below and update the code to test CreateCustomKeyStoreRequest
      //var instance = new AwsKeyManagementService.CreateCustomKeyStoreRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.CreateCustomKeyStoreRequest);
    });

    it('should have the property customKeyStoreName (base name: "CustomKeyStoreName")', function() {
      // uncomment below and update the code to test the property customKeyStoreName
      //var instance = new AwsKeyManagementService.CreateCustomKeyStoreRequest();
    ...
    it('should have the property trustAnchorCertificate (base name: "TrustAnchorCertificate")', function() {
      // uncomment below and update the code to test the property trustAnchorCertificate
      //var instance = new AwsKeyManagementService.CreateCustomKeyStoreRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property customKeyStoreType (base name: "CustomKeyStoreType")', function() {
      // uncomment below and update the code to test the property customKeyStoreType
      //var instance = new AwsKeyManagementService.CreateCustomKeyStoreRequest();
      //expect(instance).to.be();
    });

    it('should have the property xksProxyUriEndpoint (base name: "XksProxyUriEndpoint")', function() {
      // uncomment below and update the code to test the property xksProxyUriEndpoint
      //var instance = new AwsKeyManagementService.CreateCustomKeyStoreRequest();
      //expect(instance).to.be();
    });

    it('should have the property xksProxyUriPath (base name: "XksProxyUriPath")', function() {
      // uncomment below and update the code to test the property xksProxyUriPath
      //var instance = new AwsKeyManagementService.CreateCustomKeyStoreRequest();
      //expect(instance).to.be();
    });

    it('should have the property xksProxyVpcEndpointServiceName (base name: "XksProxyVpcEndpointServiceName")', function() {
      // uncomment below and update the code to test the property xksProxyVpcEndpointServiceName
      //var instance = new AwsKeyManagementService.CreateCustomKeyStoreRequest();
      //expect(instance).to.be();
    });

    it('should have the property xksProxyAuthenticationCredential (base name: "XksProxyAuthenticationCredential")', function() {
      // uncomment below and update the code to test the property xksProxyAuthenticationCredential
      //var instance = new AwsKeyManagementService.CreateCustomKeyStoreRequest();
      //expect(instance).to.be();
    });

    it('should have the property xksProxyConnectivity (base name: "XksProxyConnectivity")', function() {
      // uncomment below and update the code to test the property xksProxyConnectivity
      //var instance = new AwsKeyManagementService.CreateCustomKeyStoreRequest();
      //expect(instance).to.be();
    });
