...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.ListGrantsRequest();
  });
  ...
  describe('ListGrantsRequest', function() {
    it('should create an instance of ListGrantsRequest', function() {
      // uncomment below and update the code to test ListGrantsRequest
      //var instance = new AwsKeyManagementService.ListGrantsRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.ListGrantsRequest);
    });
    ...
    it('should have the property granteePrincipal (base name: "GranteePrincipal")', function() {
      // uncomment below and update the code to test the property granteePrincipal
      //var instance = new AwsKeyManagementService.ListGrantsRequest();
      //expect(instance).to.be();
    });
