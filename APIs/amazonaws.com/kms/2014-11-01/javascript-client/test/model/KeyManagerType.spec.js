...
(function(root, factory) {
  ...
  describe('KeyManagerType', function() {
    it('should create an instance of KeyManagerType', function() {
      // uncomment below and update the code to test KeyManagerType
      //var instance = new AwsKeyManagementService.KeyManagerType();
      //expect(instance).to.be.a(AwsKeyManagementService.KeyManagerType);
    });
