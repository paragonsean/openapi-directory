...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.DescribeKeyResponse();
  });
  ...
  describe('DescribeKeyResponse', function() {
    it('should create an instance of DescribeKeyResponse', function() {
      ...
      //var instance = new AwsKeyManagementService.DescribeKeyResponse();
      //expect(instance).to.be.a(AwsKeyManagementService.DescribeKeyResponse);
    });
