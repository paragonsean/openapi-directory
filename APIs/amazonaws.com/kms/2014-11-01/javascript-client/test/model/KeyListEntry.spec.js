...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.KeyListEntry();
  });
  ...
  describe('KeyListEntry', function() {
    it('should create an instance of KeyListEntry', function() {
      // uncomment below and update the code to test KeyListEntry
      //var instance = new AwsKeyManagementService.KeyListEntry();
      //expect(instance).to.be.a(AwsKeyManagementService.KeyListEntry);
    });
