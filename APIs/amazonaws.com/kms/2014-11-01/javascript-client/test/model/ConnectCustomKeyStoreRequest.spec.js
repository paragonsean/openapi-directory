...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.ConnectCustomKeyStoreRequest();
  });
  ...
  describe('ConnectCustomKeyStoreRequest', function() {
    it('should create an instance of ConnectCustomKeyStoreRequest', function() {
      // uncomment below and update the code to test ConnectCustomKeyStoreRequest
      //var instance = new AwsKeyManagementService.ConnectCustomKeyStoreRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.ConnectCustomKeyStoreRequest);
    });
