...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.DescribeCustomKeyStoresRequest();
  });
  ...
  describe('DescribeCustomKeyStoresRequest', function() {
    it('should create an instance of DescribeCustomKeyStoresRequest', function() {
      // uncomment below and update the code to test DescribeCustomKeyStoresRequest
      //var instance = new AwsKeyManagementService.DescribeCustomKeyStoresRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.DescribeCustomKeyStoresRequest);
    });
