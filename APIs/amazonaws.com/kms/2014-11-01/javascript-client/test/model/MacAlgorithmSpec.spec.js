...
(function(root, factory) {
  ...
  describe('MacAlgorithmSpec', function() {
    it('should create an instance of MacAlgorithmSpec', function() {
      // uncomment below and update the code to test MacAlgorithmSpec
      //var instance = new AwsKeyManagementService.MacAlgorithmSpec();
      //expect(instance).to.be.a(AwsKeyManagementService.MacAlgorithmSpec);
    });
