...
(function(root, factory) {
  ...
  describe('ConnectionStateType', function() {
    it('should create an instance of ConnectionStateType', function() {
      // uncomment below and update the code to test ConnectionStateType
      //var instance = new AwsKeyManagementService.ConnectionStateType();
      //expect(instance).to.be.a(AwsKeyManagementService.ConnectionStateType);
    });
