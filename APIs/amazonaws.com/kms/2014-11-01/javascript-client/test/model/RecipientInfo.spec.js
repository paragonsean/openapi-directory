...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.RecipientInfo();
  });
  ...
  describe('RecipientInfo', function() {
    it('should create an instance of RecipientInfo', function() {
      // uncomment below and update the code to test RecipientInfo
      //var instance = new AwsKeyManagementService.RecipientInfo();
      //expect(instance).to.be.a(AwsKeyManagementService.RecipientInfo);
    });
