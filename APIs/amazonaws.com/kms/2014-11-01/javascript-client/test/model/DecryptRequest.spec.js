...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.DecryptRequest();
  });
  ...
  describe('DecryptRequest', function() {
    it('should create an instance of DecryptRequest', function() {
      // uncomment below and update the code to test DecryptRequest
      //var instance = new AwsKeyManagementService.DecryptRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.DecryptRequest);
    });
