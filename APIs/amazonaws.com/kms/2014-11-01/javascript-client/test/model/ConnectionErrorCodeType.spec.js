...
(function(root, factory) {
  ...
  describe('ConnectionErrorCodeType', function() {
    it('should create an instance of ConnectionErrorCodeType', function() {
      // uncomment below and update the code to test ConnectionErrorCodeType
      //var instance = new AwsKeyManagementService.ConnectionErrorCodeType();
      //expect(instance).to.be.a(AwsKeyManagementService.ConnectionErrorCodeType);
    });
