...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.EncryptRequest();
  });
  ...
  describe('EncryptRequest', function() {
    it('should create an instance of EncryptRequest', function() {
      ...
      //var instance = new AwsKeyManagementService.EncryptRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.EncryptRequest);
    });
