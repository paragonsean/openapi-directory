...
(function(root, factory) {
  ...
  describe('DataKeyPairSpec', function() {
    it('should create an instance of DataKeyPairSpec', function() {
      // uncomment below and update the code to test DataKeyPairSpec
      //var instance = new AwsKeyManagementService.DataKeyPairSpec();
      //expect(instance).to.be.a(AwsKeyManagementService.DataKeyPairSpec);
    });
