...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.KeyMetadataMultiRegionConfiguration();
  });
  ...
  describe('KeyMetadataMultiRegionConfiguration', function() {
    it('should create an instance of KeyMetadataMultiRegionConfiguration', function() {
      // uncomment below and update the code to test KeyMetadataMultiRegionConfiguration
      //var instance = new AwsKeyManagementService.KeyMetadataMultiRegionConfiguration();
      //expect(instance).to.be.a(AwsKeyManagementService.KeyMetadataMultiRegionConfiguration);
    });

    it('should have the property multiRegionKeyType (base name: "MultiRegionKeyType")', function() {
      // uncomment below and update the code to test the property multiRegionKeyType
      //var instance = new AwsKeyManagementService.KeyMetadataMultiRegionConfiguration();
    ...
    it('should have the property replicaKeys (base name: "ReplicaKeys")', function() {
      // uncomment below and update the code to test the property replicaKeys
      //var instance = new AwsKeyManagementService.KeyMetadataMultiRegionConfiguration();
      //expect(instance).to.be();
    });
