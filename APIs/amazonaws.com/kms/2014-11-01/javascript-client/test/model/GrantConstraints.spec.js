...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.GrantConstraints();
  });
  ...
  describe('GrantConstraints', function() {
    it('should create an instance of GrantConstraints', function() {
      // uncomment below and update the code to test GrantConstraints
      //var instance = new AwsKeyManagementService.GrantConstraints();
      //expect(instance).to.be.a(AwsKeyManagementService.GrantConstraints);
    });
