...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.RevokeGrantRequest();
  });
  ...
  describe('RevokeGrantRequest', function() {
    it('should create an instance of RevokeGrantRequest', function() {
      // uncomment below and update the code to test RevokeGrantRequest
      //var instance = new AwsKeyManagementService.RevokeGrantRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.RevokeGrantRequest);
    });
