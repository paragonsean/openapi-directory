...
(function(root, factory) {
  ...
  describe('EncryptionAlgorithmSpec', function() {
    it('should create an instance of EncryptionAlgorithmSpec', function() {
      // uncomment below and update the code to test EncryptionAlgorithmSpec
      //var instance = new AwsKeyManagementService.EncryptionAlgorithmSpec();
      //expect(instance).to.be.a(AwsKeyManagementService.EncryptionAlgorithmSpec);
    });
