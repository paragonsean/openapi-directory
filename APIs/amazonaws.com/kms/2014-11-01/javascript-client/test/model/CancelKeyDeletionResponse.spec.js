...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.CancelKeyDeletionResponse();
  });
  ...
  describe('CancelKeyDeletionResponse', function() {
    it('should create an instance of CancelKeyDeletionResponse', function() {
      // uncomment below and update the code to test CancelKeyDeletionResponse
      //var instance = new AwsKeyManagementService.CancelKeyDeletionResponse();
      //expect(instance).to.be.a(AwsKeyManagementService.CancelKeyDeletionResponse);
    });
