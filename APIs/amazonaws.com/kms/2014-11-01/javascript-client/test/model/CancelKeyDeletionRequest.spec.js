...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.CancelKeyDeletionRequest();
  });
  ...
  describe('CancelKeyDeletionRequest', function() {
    it('should create an instance of CancelKeyDeletionRequest', function() {
      // uncomment below and update the code to test CancelKeyDeletionRequest
      //var instance = new AwsKeyManagementService.CancelKeyDeletionRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.CancelKeyDeletionRequest);
    });
