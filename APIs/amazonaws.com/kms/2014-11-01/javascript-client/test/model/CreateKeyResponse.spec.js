...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.CreateKeyResponse();
  });
  ...
  describe('CreateKeyResponse', function() {
    it('should create an instance of CreateKeyResponse', function() {
      ...
      //var instance = new AwsKeyManagementService.CreateKeyResponse();
      //expect(instance).to.be.a(AwsKeyManagementService.CreateKeyResponse);
    });
