...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.CreateKeyResponseKeyMetadata();
  });
  ...
  describe('CreateKeyResponseKeyMetadata', function() {
    it('should create an instance of CreateKeyResponseKeyMetadata', function() {
      // uncomment below and update the code to test CreateKeyResponseKeyMetadata
      //var instance = new AwsKeyManagementService.CreateKeyResponseKeyMetadata();
      //expect(instance).to.be.a(AwsKeyManagementService.CreateKeyResponseKeyMetadata);
    });
