...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.GetParametersForImportRequest();
  });
  ...
  describe('GetParametersForImportRequest', function() {
    it('should create an instance of GetParametersForImportRequest', function() {
      // uncomment below and update the code to test GetParametersForImportRequest
      //var instance = new AwsKeyManagementService.GetParametersForImportRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.GetParametersForImportRequest);
    });
    ...
    it('should have the property wrappingAlgorithm (base name: "WrappingAlgorithm")', function() {
      // uncomment below and update the code to test the property wrappingAlgorithm
      //var instance = new AwsKeyManagementService.GetParametersForImportRequest();
      //expect(instance).to.be();
    });

    it('should have the property wrappingKeySpec (base name: "WrappingKeySpec")', function() {
      // uncomment below and update the code to test the property wrappingKeySpec
      //var instance = new AwsKeyManagementService.GetParametersForImportRequest();
      //expect(instance).to.be();
    });
