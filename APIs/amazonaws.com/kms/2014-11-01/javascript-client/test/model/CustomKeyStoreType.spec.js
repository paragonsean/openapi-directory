...
(function(root, factory) {
  ...
  describe('CustomKeyStoreType', function() {
    it('should create an instance of CustomKeyStoreType', function() {
      // uncomment below and update the code to test CustomKeyStoreType
      //var instance = new AwsKeyManagementService.CustomKeyStoreType();
      //expect(instance).to.be.a(AwsKeyManagementService.CustomKeyStoreType);
    });
