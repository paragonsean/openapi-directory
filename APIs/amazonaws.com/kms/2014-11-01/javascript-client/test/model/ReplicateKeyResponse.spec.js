...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.ReplicateKeyResponse();
  });
  ...
  describe('ReplicateKeyResponse', function() {
    it('should create an instance of ReplicateKeyResponse', function() {
      // uncomment below and update the code to test ReplicateKeyResponse
      //var instance = new AwsKeyManagementService.ReplicateKeyResponse();
      //expect(instance).to.be.a(AwsKeyManagementService.ReplicateKeyResponse);
    });

    it('should have the property replicaKeyMetadata (base name: "ReplicaKeyMetadata")', function() {
      // uncomment below and update the code to test the property replicaKeyMetadata
      //var instance = new AwsKeyManagementService.ReplicateKeyResponse();
      //expect(instance).to.be();
    });

    it('should have the property replicaPolicy (base name: "ReplicaPolicy")', function() {
      // uncomment below and update the code to test the property replicaPolicy
      //var instance = new AwsKeyManagementService.ReplicateKeyResponse();
      //expect(instance).to.be();
    });

    it('should have the property replicaTags (base name: "ReplicaTags")', function() {
      // uncomment below and update the code to test the property replicaTags
      //var instance = new AwsKeyManagementService.ReplicateKeyResponse();
      //expect(instance).to.be();
    });
