...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.DeleteAliasRequest();
  });
  ...
  describe('DeleteAliasRequest', function() {
    it('should create an instance of DeleteAliasRequest', function() {
      // uncomment below and update the code to test DeleteAliasRequest
      //var instance = new AwsKeyManagementService.DeleteAliasRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.DeleteAliasRequest);
    });
