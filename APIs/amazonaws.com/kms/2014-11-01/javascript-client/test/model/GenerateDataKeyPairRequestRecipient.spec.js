...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.GenerateDataKeyPairRequestRecipient();
  });
  ...
  describe('GenerateDataKeyPairRequestRecipient', function() {
    it('should create an instance of GenerateDataKeyPairRequestRecipient', function() {
      // uncomment below and update the code to test GenerateDataKeyPairRequestRecipient
      //var instance = new AwsKeyManagementService.GenerateDataKeyPairRequestRecipient();
      //expect(instance).to.be.a(AwsKeyManagementService.GenerateDataKeyPairRequestRecipient);
    });
