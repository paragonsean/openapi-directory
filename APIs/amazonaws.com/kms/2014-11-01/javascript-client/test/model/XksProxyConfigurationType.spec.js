...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.XksProxyConfigurationType();
  });
  ...
  describe('XksProxyConfigurationType', function() {
    it('should create an instance of XksProxyConfigurationType', function() {
      // uncomment below and update the code to test XksProxyConfigurationType
      //var instance = new AwsKeyManagementService.XksProxyConfigurationType();
      //expect(instance).to.be.a(AwsKeyManagementService.XksProxyConfigurationType);
    });
    ...
    it('should have the property uriEndpoint (base name: "UriEndpoint")', function() {
      // uncomment below and update the code to test the property uriEndpoint
      //var instance = new AwsKeyManagementService.XksProxyConfigurationType();
      //expect(instance).to.be();
    });
    ...
    it('should have the property vpcEndpointServiceName (base name: "VpcEndpointServiceName")', function() {
      // uncomment below and update the code to test the property vpcEndpointServiceName
      //var instance = new AwsKeyManagementService.XksProxyConfigurationType();
      //expect(instance).to.be();
    });
