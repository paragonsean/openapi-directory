...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.GetKeyRotationStatusResponse();
  });
  ...
  describe('GetKeyRotationStatusResponse', function() {
    it('should create an instance of GetKeyRotationStatusResponse', function() {
      // uncomment below and update the code to test GetKeyRotationStatusResponse
      //var instance = new AwsKeyManagementService.GetKeyRotationStatusResponse();
      //expect(instance).to.be.a(AwsKeyManagementService.GetKeyRotationStatusResponse);
    });

    it('should have the property keyRotationEnabled (base name: "KeyRotationEnabled")', function() {
      // uncomment below and update the code to test the property keyRotationEnabled
      //var instance = new AwsKeyManagementService.GetKeyRotationStatusResponse();
