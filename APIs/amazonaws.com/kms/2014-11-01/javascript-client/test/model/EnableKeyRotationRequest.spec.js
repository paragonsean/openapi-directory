...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.EnableKeyRotationRequest();
  });
  ...
  describe('EnableKeyRotationRequest', function() {
    it('should create an instance of EnableKeyRotationRequest', function() {
      // uncomment below and update the code to test EnableKeyRotationRequest
      //var instance = new AwsKeyManagementService.EnableKeyRotationRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.EnableKeyRotationRequest);
    });
