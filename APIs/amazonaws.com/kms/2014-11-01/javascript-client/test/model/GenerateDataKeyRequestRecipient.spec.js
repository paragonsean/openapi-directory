...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.GenerateDataKeyRequestRecipient();
  });
  ...
  describe('GenerateDataKeyRequestRecipient', function() {
    it('should create an instance of GenerateDataKeyRequestRecipient', function() {
      // uncomment below and update the code to test GenerateDataKeyRequestRecipient
      //var instance = new AwsKeyManagementService.GenerateDataKeyRequestRecipient();
      //expect(instance).to.be.a(AwsKeyManagementService.GenerateDataKeyRequestRecipient);
    });

    it('should have the property keyEncryptionAlgorithm (base name: "KeyEncryptionAlgorithm")', function() {
      // uncomment below and update the code to test the property keyEncryptionAlgorithm
      //var instance = new AwsKeyManagementService.GenerateDataKeyRequestRecipient();
      //expect(instance).to.be();
    });

    it('should have the property attestationDocument (base name: "AttestationDocument")', function() {
      // uncomment below and update the code to test the property attestationDocument
      //var instance = new AwsKeyManagementService.GenerateDataKeyRequestRecipient();
      //expect(instance).to.be();
    });
