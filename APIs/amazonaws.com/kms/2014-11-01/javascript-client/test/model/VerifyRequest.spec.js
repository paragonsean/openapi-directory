...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.VerifyRequest();
  });
  ...
  describe('VerifyRequest', function() {
    it('should create an instance of VerifyRequest', function() {
      ...
      //var instance = new AwsKeyManagementService.VerifyRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.VerifyRequest);
    });
