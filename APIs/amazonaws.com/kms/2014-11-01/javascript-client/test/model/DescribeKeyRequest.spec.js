...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.DescribeKeyRequest();
  });
  ...
  describe('DescribeKeyRequest', function() {
    it('should create an instance of DescribeKeyRequest', function() {
      // uncomment below and update the code to test DescribeKeyRequest
      //var instance = new AwsKeyManagementService.DescribeKeyRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.DescribeKeyRequest);
    });
