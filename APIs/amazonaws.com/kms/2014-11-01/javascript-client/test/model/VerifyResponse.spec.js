...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.VerifyResponse();
  });
  ...
  describe('VerifyResponse', function() {
    it('should create an instance of VerifyResponse', function() {
      ...
      //var instance = new AwsKeyManagementService.VerifyResponse();
      //expect(instance).to.be.a(AwsKeyManagementService.VerifyResponse);
    });
