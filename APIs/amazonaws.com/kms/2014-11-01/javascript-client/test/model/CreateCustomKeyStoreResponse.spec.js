...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.CreateCustomKeyStoreResponse();
  });
  ...
  describe('CreateCustomKeyStoreResponse', function() {
    it('should create an instance of CreateCustomKeyStoreResponse', function() {
      // uncomment below and update the code to test CreateCustomKeyStoreResponse
      //var instance = new AwsKeyManagementService.CreateCustomKeyStoreResponse();
      //expect(instance).to.be.a(AwsKeyManagementService.CreateCustomKeyStoreResponse);
    });
