...
(function(root, factory) {
  ...
  describe('WrappingKeySpec', function() {
    it('should create an instance of WrappingKeySpec', function() {
      // uncomment below and update the code to test WrappingKeySpec
      //var instance = new AwsKeyManagementService.WrappingKeySpec();
      //expect(instance).to.be.a(AwsKeyManagementService.WrappingKeySpec);
    });
