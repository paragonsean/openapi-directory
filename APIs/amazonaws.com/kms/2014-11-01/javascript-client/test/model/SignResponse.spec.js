...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.SignResponse();
  });
  ...
  describe('SignResponse', function() {
    it('should create an instance of SignResponse', function() {
      ...
      //var instance = new AwsKeyManagementService.SignResponse();
      //expect(instance).to.be.a(AwsKeyManagementService.SignResponse);
    });
