...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsKeyManagementService.ListKeysRequest();
  });
  ...
  describe('ListKeysRequest', function() {
    it('should create an instance of ListKeysRequest', function() {
      ...
      //var instance = new AwsKeyManagementService.ListKeysRequest();
      //expect(instance).to.be.a(AwsKeyManagementService.ListKeysRequest);
    });
