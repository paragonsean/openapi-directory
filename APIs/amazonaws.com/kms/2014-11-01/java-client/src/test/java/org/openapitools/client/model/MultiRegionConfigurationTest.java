...
/**
 * Model tests for MultiRegionConfiguration
 */
public class MultiRegionConfigurationTest {
    private final MultiRegionConfiguration model = new MultiRegionConfiguration();
