...
public class GenerateMacRequest {
  ...
  public GenerateMacRequest macAlgorithm(MacAlgorithmSpec macAlgorithm) {
  ...
  public GenerateMacRequest grantTokens(List grantTokens) {
  ...
  public GenerateMacRequest dryRun(Boolean dryRun) {
    this.dryRun = dryRun;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.message, generateMacRequest.message) &&
        Objects.equals(this.keyId, generateMacRequest.keyId) &&
        Objects.equals(this.macAlgorithm, generateMacRequest.macAlgorithm) &&
        Objects.equals(this.grantTokens, generateMacRequest.grantTokens) &&
        Objects.equals(this.dryRun, generateMacRequest.dryRun);
  }

  @Override
  public int hashCode() {
    return Objects.hash(message, keyId, macAlgorithm, grantTokens, dryRun);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GenerateMacRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GenerateMacRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenerateMacRequest is not found in the empty JSON string", GenerateMacRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GenerateMacRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenerateMacRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GenerateMacRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenerateMacRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenerateMacRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenerateMacRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenerateMacRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GenerateMacRequest>() {
           @Override
           public void write(JsonWriter out, GenerateMacRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GenerateMacRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GenerateMacRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GenerateMacRequest
   * @throws IOException if the JSON string is invalid with respect to GenerateMacRequest
   */
  public static GenerateMacRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateMacRequest.class);
  }

  /**
   * Convert an instance of GenerateMacRequest to an JSON string
   *
   * @return JSON string
   */
