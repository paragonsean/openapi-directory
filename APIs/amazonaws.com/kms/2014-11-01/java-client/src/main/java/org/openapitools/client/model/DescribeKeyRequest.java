...
public class DescribeKeyRequest {
  ...
  public DescribeKeyRequest grantTokens(List grantTokens) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keyId, describeKeyRequest.keyId) &&
        Objects.equals(this.grantTokens, describeKeyRequest.grantTokens);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeKeyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeKeyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeKeyRequest is not found in the empty JSON string", DescribeKeyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeKeyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeKeyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeKeyRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeKeyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeKeyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeKeyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeKeyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeKeyRequest>() {
           @Override
           public void write(JsonWriter out, DescribeKeyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeKeyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeKeyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeKeyRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeKeyRequest
   */
  public static DescribeKeyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeKeyRequest.class);
  }

  /**
   * Convert an instance of DescribeKeyRequest to an JSON string
   *
   * @return JSON string
   */
