...
/**
 * Gets or Sets DataKeyPairSpec
 */
@JsonAdapter(DataKeyPairSpec.Adapter.class)
public enum DataKeyPairSpec {
  ...
  public static DataKeyPairSpec fromValue(String value) {
    for (DataKeyPairSpec b : DataKeyPairSpec.values()) {
  ...
  public static class Adapter extends TypeAdapter<DataKeyPairSpec> {
    @Override
    public void write(final JsonWriter jsonWriter, final DataKeyPairSpec enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DataKeyPairSpec read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DataKeyPairSpec.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    DataKeyPairSpec.fromValue(value);
  }
}
