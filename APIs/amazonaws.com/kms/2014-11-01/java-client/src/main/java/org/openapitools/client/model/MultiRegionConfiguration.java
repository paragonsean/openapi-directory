...
public class MultiRegionConfiguration {
  ...
  public MultiRegionConfiguration multiRegionKeyType(MultiRegionKeyType multiRegionKeyType) {
  ...
  public MultiRegionConfiguration primaryKey(MultiRegionConfigurationPrimaryKey primaryKey) {
  ...
  public MultiRegionConfiguration replicaKeys(List replicaKeys) {
  ...
  public boolean equals(Object o) {
    ...
    MultiRegionConfiguration multiRegionConfiguration = (MultiRegionConfiguration) o;
    return Objects.equals(this.multiRegionKeyType, multiRegionConfiguration.multiRegionKeyType) &&
        Objects.equals(this.primaryKey, multiRegionConfiguration.primaryKey) &&
        Objects.equals(this.replicaKeys, multiRegionConfiguration.replicaKeys);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultiRegionConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MultiRegionConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MultiRegionConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MultiRegionConfiguration is not found in the empty JSON string", MultiRegionConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MultiRegionConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MultiRegionConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MultiRegionConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MultiRegionConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MultiRegionConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MultiRegionConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<MultiRegionConfiguration>() {
           @Override
           public void write(JsonWriter out, MultiRegionConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MultiRegionConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MultiRegionConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MultiRegionConfiguration
   * @throws IOException if the JSON string is invalid with respect to MultiRegionConfiguration
   */
  public static MultiRegionConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MultiRegionConfiguration.class);
  }

  /**
   * Convert an instance of MultiRegionConfiguration to an JSON string
   *
   * @return JSON string
   */
