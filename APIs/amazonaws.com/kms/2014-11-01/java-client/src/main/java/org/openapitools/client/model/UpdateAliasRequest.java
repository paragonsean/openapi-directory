...
public class UpdateAliasRequest {
  ...
  public static final String SERIALIZED_NAME_TARGET_KEY_ID = "TargetKeyId";
  @SerializedName(SERIALIZED_NAME_TARGET_KEY_ID)
  private String targetKeyId;

  public UpdateAliasRequest() {
  }

  public UpdateAliasRequest aliasName(String aliasName) {
  ...
  public UpdateAliasRequest targetKeyId(String targetKeyId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.aliasName, updateAliasRequest.aliasName) &&
        Objects.equals(this.targetKeyId, updateAliasRequest.targetKeyId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aliasName, targetKeyId);
  }
  ...
  static {
    ...
    openapiFields.add("TargetKeyId");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("AliasName");
    openapiRequiredFields.add("TargetKeyId");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateAliasRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAliasRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateAliasRequest is not found in the empty JSON string", UpdateAliasRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateAliasRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateAliasRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateAliasRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `AliasName`
      String.validateJsonElement(jsonObj.get("AliasName"));
      // validate the required field `TargetKeyId`
      String.validateJsonElement(jsonObj.get("TargetKeyId"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateAliasRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateAliasRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateAliasRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateAliasRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateAliasRequest>() {
           @Override
           public void write(JsonWriter out, UpdateAliasRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateAliasRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateAliasRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateAliasRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateAliasRequest
   */
  public static UpdateAliasRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateAliasRequest.class);
  }

  /**
   * Convert an instance of UpdateAliasRequest to an JSON string
   *
   * @return JSON string
   */
