...
public class GenerateDataKeyWithoutPlaintextResponse {
  ...
  public GenerateDataKeyWithoutPlaintextResponse ciphertextBlob(String ciphertextBlob) {
  ...
  public GenerateDataKeyWithoutPlaintextResponse keyId(String keyId) {
    this.keyId = keyId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GenerateDataKeyWithoutPlaintextResponse generateDataKeyWithoutPlaintextResponse = (GenerateDataKeyWithoutPlaintextResponse) o;
    return Objects.equals(this.ciphertextBlob, generateDataKeyWithoutPlaintextResponse.ciphertextBlob) &&
        Objects.equals(this.keyId, generateDataKeyWithoutPlaintextResponse.keyId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GenerateDataKeyWithoutPlaintextResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GenerateDataKeyWithoutPlaintextResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GenerateDataKeyWithoutPlaintextResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenerateDataKeyWithoutPlaintextResponse is not found in the empty JSON string", GenerateDataKeyWithoutPlaintextResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GenerateDataKeyWithoutPlaintextResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenerateDataKeyWithoutPlaintextResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenerateDataKeyWithoutPlaintextResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenerateDataKeyWithoutPlaintextResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenerateDataKeyWithoutPlaintextResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenerateDataKeyWithoutPlaintextResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GenerateDataKeyWithoutPlaintextResponse>() {
           @Override
           public void write(JsonWriter out, GenerateDataKeyWithoutPlaintextResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GenerateDataKeyWithoutPlaintextResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GenerateDataKeyWithoutPlaintextResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GenerateDataKeyWithoutPlaintextResponse
   * @throws IOException if the JSON string is invalid with respect to GenerateDataKeyWithoutPlaintextResponse
   */
  public static GenerateDataKeyWithoutPlaintextResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateDataKeyWithoutPlaintextResponse.class);
  }

  /**
   * Convert an instance of GenerateDataKeyWithoutPlaintextResponse to an JSON string
   *
   * @return JSON string
   */
