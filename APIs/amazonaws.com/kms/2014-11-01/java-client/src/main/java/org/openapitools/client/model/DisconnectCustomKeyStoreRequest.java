...
public class DisconnectCustomKeyStoreRequest {
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisconnectCustomKeyStoreRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisconnectCustomKeyStoreRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisconnectCustomKeyStoreRequest is not found in the empty JSON string", DisconnectCustomKeyStoreRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisconnectCustomKeyStoreRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisconnectCustomKeyStoreRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DisconnectCustomKeyStoreRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisconnectCustomKeyStoreRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisconnectCustomKeyStoreRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisconnectCustomKeyStoreRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisconnectCustomKeyStoreRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DisconnectCustomKeyStoreRequest>() {
           @Override
           public void write(JsonWriter out, DisconnectCustomKeyStoreRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisconnectCustomKeyStoreRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisconnectCustomKeyStoreRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisconnectCustomKeyStoreRequest
   * @throws IOException if the JSON string is invalid with respect to DisconnectCustomKeyStoreRequest
   */
  public static DisconnectCustomKeyStoreRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisconnectCustomKeyStoreRequest.class);
  }

  /**
   * Convert an instance of DisconnectCustomKeyStoreRequest to an JSON string
   *
   * @return JSON string
   */
