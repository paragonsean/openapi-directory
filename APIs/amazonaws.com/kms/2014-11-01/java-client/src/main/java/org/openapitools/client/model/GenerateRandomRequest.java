...
import org.openapitools.client.model.GenerateRandomRequestRecipient;
...
public class GenerateRandomRequest {
  public static final String SERIALIZED_NAME_NUMBER_OF_BYTES = "NumberOfBytes";
  @SerializedName(SERIALIZED_NAME_NUMBER_OF_BYTES)
  ...
  private GenerateRandomRequestRecipient recipient;

  public GenerateRandomRequest() {
  }

  public GenerateRandomRequest numberOfBytes(Integer numberOfBytes) {
  ...
  public GenerateRandomRequest customKeyStoreId(String customKeyStoreId) {
  ...
  public GenerateRandomRequest recipient(GenerateRandomRequestRecipient recipient) {
   ...
   */
  @javax.annotation.Nullable
  public GenerateRandomRequestRecipient getRecipient() {
    return recipient;
  }

  public void setRecipient(GenerateRandomRequestRecipient recipient) {
    this.recipient = recipient;
  }
  ...
  public boolean equals(Object o) {
    ...
    GenerateRandomRequest generateRandomRequest = (GenerateRandomRequest) o;
    return Objects.equals(this.numberOfBytes, generateRandomRequest.numberOfBytes) &&
        Objects.equals(this.customKeyStoreId, generateRandomRequest.customKeyStoreId) &&
        Objects.equals(this.recipient, generateRandomRequest.recipient);
  }

  @Override
  public int hashCode() {
    return Objects.hash(numberOfBytes, customKeyStoreId, recipient);
  }
  ...
  static {
    ...
    openapiFields.add("NumberOfBytes");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GenerateRandomRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GenerateRandomRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenerateRandomRequest is not found in the empty JSON string", GenerateRandomRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GenerateRandomRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenerateRandomRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `NumberOfBytes`
      if (jsonObj.get("NumberOfBytes") != null && !jsonObj.get("NumberOfBytes").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("NumberOfBytes"));
      }
      ...
      if (jsonObj.get("Recipient") != null && !jsonObj.get("Recipient").isJsonNull()) {
        GenerateRandomRequestRecipient.validateJsonElement(jsonObj.get("Recipient"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenerateRandomRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenerateRandomRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenerateRandomRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenerateRandomRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GenerateRandomRequest>() {
           @Override
           public void write(JsonWriter out, GenerateRandomRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GenerateRandomRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GenerateRandomRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GenerateRandomRequest
   * @throws IOException if the JSON string is invalid with respect to GenerateRandomRequest
   */
  public static GenerateRandomRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateRandomRequest.class);
  }

  /**
   * Convert an instance of GenerateRandomRequest to an JSON string
   *
   * @return JSON string
   */
