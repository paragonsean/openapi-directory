...
public class CancelKeyDeletionResponse {
  ...
  public CancelKeyDeletionResponse keyId(String keyId) {
    this.keyId = keyId;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CancelKeyDeletionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CancelKeyDeletionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CancelKeyDeletionResponse is not found in the empty JSON string", CancelKeyDeletionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CancelKeyDeletionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CancelKeyDeletionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CancelKeyDeletionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CancelKeyDeletionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CancelKeyDeletionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CancelKeyDeletionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CancelKeyDeletionResponse>() {
           @Override
           public void write(JsonWriter out, CancelKeyDeletionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CancelKeyDeletionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CancelKeyDeletionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CancelKeyDeletionResponse
   * @throws IOException if the JSON string is invalid with respect to CancelKeyDeletionResponse
   */
  public static CancelKeyDeletionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CancelKeyDeletionResponse.class);
  }

  /**
   * Convert an instance of CancelKeyDeletionResponse to an JSON string
   *
   * @return JSON string
   */
