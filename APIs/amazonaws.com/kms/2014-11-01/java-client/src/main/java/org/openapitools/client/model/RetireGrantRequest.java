...
public class RetireGrantRequest {
  ...
  public RetireGrantRequest grantToken(String grantToken) {
  ...
  public RetireGrantRequest keyId(String keyId) {
    this.keyId = keyId;
    return this;
  }
  ...
  public RetireGrantRequest grantId(String grantId) {
  ...
  public RetireGrantRequest dryRun(Boolean dryRun) {
    this.dryRun = dryRun;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RetireGrantRequest retireGrantRequest = (RetireGrantRequest) o;
    return Objects.equals(this.grantToken, retireGrantRequest.grantToken) &&
        Objects.equals(this.keyId, retireGrantRequest.keyId) &&
        Objects.equals(this.grantId, retireGrantRequest.grantId) &&
        Objects.equals(this.dryRun, retireGrantRequest.dryRun);
  }

  @Override
  public int hashCode() {
    return Objects.hash(grantToken, keyId, grantId, dryRun);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RetireGrantRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RetireGrantRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RetireGrantRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RetireGrantRequest is not found in the empty JSON string", RetireGrantRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RetireGrantRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RetireGrantRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RetireGrantRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RetireGrantRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RetireGrantRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RetireGrantRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RetireGrantRequest>() {
           @Override
           public void write(JsonWriter out, RetireGrantRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RetireGrantRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RetireGrantRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RetireGrantRequest
   * @throws IOException if the JSON string is invalid with respect to RetireGrantRequest
   */
  public static RetireGrantRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RetireGrantRequest.class);
  }

  /**
   * Convert an instance of RetireGrantRequest to an JSON string
   *
   * @return JSON string
   */
