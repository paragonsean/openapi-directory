...
public class GrantConstraints {
  ...
  public GrantConstraints encryptionContextSubset(Map encryptionContextSubset) {
  ...
  public void setEncryptionContextSubset(Map encryptionContextSubset) {
    this.encryptionContextSubset = encryptionContextSubset;
  }


  public GrantConstraints encryptionContextEquals(Map encryptionContextEquals) {
  ...
  public void setEncryptionContextEquals(Map encryptionContextEquals) {
    this.encryptionContextEquals = encryptionContextEquals;
  }
  ...
  public boolean equals(Object o) {
    ...
    GrantConstraints grantConstraints = (GrantConstraints) o;
    return Objects.equals(this.encryptionContextSubset, grantConstraints.encryptionContextSubset) &&
        Objects.equals(this.encryptionContextEquals, grantConstraints.encryptionContextEquals);
  }

  @Override
  public int hashCode() {
    return Objects.hash(encryptionContextSubset, encryptionContextEquals);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GrantConstraints {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GrantConstraints
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GrantConstraints.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GrantConstraints is not found in the empty JSON string", GrantConstraints.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GrantConstraints.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GrantConstraints` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GrantConstraints.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GrantConstraints' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GrantConstraints> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GrantConstraints.class));

       return (TypeAdapter<T>) new TypeAdapter<GrantConstraints>() {
           @Override
           public void write(JsonWriter out, GrantConstraints value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GrantConstraints read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GrantConstraints given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GrantConstraints
   * @throws IOException if the JSON string is invalid with respect to GrantConstraints
   */
  public static GrantConstraints fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GrantConstraints.class);
  }

  /**
   * Convert an instance of GrantConstraints to an JSON string
   *
   * @return JSON string
   */
