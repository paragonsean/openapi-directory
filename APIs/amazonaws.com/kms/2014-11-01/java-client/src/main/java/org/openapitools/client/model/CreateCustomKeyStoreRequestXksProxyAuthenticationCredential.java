...
public class CreateCustomKeyStoreRequestXksProxyAuthenticationCredential {
  public static final String SERIALIZED_NAME_ACCESS_KEY_ID = "AccessKeyId";
  @SerializedName(SERIALIZED_NAME_ACCESS_KEY_ID)
  private String accessKeyId;

  public static final String SERIALIZED_NAME_RAW_SECRET_ACCESS_KEY = "RawSecretAccessKey";
  @SerializedName(SERIALIZED_NAME_RAW_SECRET_ACCESS_KEY)
  private String rawSecretAccessKey;

  public CreateCustomKeyStoreRequestXksProxyAuthenticationCredential() {
  }

  public CreateCustomKeyStoreRequestXksProxyAuthenticationCredential accessKeyId(String accessKeyId) {
  ...
  public CreateCustomKeyStoreRequestXksProxyAuthenticationCredential rawSecretAccessKey(String rawSecretAccessKey) {
    this.rawSecretAccessKey = rawSecretAccessKey;
    return this;
  }

  /**
   * Get rawSecretAccessKey
  ...
  public boolean equals(Object o) {
    ...
    CreateCustomKeyStoreRequestXksProxyAuthenticationCredential createCustomKeyStoreRequestXksProxyAuthenticationCredential = (CreateCustomKeyStoreRequestXksProxyAuthenticationCredential) o;
    return Objects.equals(this.accessKeyId, createCustomKeyStoreRequestXksProxyAuthenticationCredential.accessKeyId) &&
        Objects.equals(this.rawSecretAccessKey, createCustomKeyStoreRequestXksProxyAuthenticationCredential.rawSecretAccessKey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessKeyId, rawSecretAccessKey);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateCustomKeyStoreRequestXksProxyAuthenticationCredential {\n");
    sb.append("    accessKeyId: ").append(toIndentedString(accessKeyId)).append("\n");
    sb.append("    rawSecretAccessKey: ").append(toIndentedString(rawSecretAccessKey)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("RawSecretAccessKey");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("AccessKeyId");
    openapiRequiredFields.add("RawSecretAccessKey");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateCustomKeyStoreRequestXksProxyAuthenticationCredential
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCustomKeyStoreRequestXksProxyAuthenticationCredential.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateCustomKeyStoreRequestXksProxyAuthenticationCredential is not found in the empty JSON string", CreateCustomKeyStoreRequestXksProxyAuthenticationCredential.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateCustomKeyStoreRequestXksProxyAuthenticationCredential.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateCustomKeyStoreRequestXksProxyAuthenticationCredential` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateCustomKeyStoreRequestXksProxyAuthenticationCredential.openapiRequiredFields) {
      ...
      // validate the required field `RawSecretAccessKey`
      String.validateJsonElement(jsonObj.get("RawSecretAccessKey"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateCustomKeyStoreRequestXksProxyAuthenticationCredential.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateCustomKeyStoreRequestXksProxyAuthenticationCredential' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateCustomKeyStoreRequestXksProxyAuthenticationCredential> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateCustomKeyStoreRequestXksProxyAuthenticationCredential.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateCustomKeyStoreRequestXksProxyAuthenticationCredential>() {
           @Override
           public void write(JsonWriter out, CreateCustomKeyStoreRequestXksProxyAuthenticationCredential value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateCustomKeyStoreRequestXksProxyAuthenticationCredential read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateCustomKeyStoreRequestXksProxyAuthenticationCredential given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateCustomKeyStoreRequestXksProxyAuthenticationCredential
   * @throws IOException if the JSON string is invalid with respect to CreateCustomKeyStoreRequestXksProxyAuthenticationCredential
   */
  public static CreateCustomKeyStoreRequestXksProxyAuthenticationCredential fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCustomKeyStoreRequestXksProxyAuthenticationCredential.class);
  }

  /**
   * Convert an instance of CreateCustomKeyStoreRequestXksProxyAuthenticationCredential to an JSON string
   *
   * @return JSON string
   */
