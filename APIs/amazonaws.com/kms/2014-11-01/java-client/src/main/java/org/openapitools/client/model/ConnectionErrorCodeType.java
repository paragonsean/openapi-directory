...
/**
 * Gets or Sets ConnectionErrorCodeType
 */
@JsonAdapter(ConnectionErrorCodeType.Adapter.class)
public enum ConnectionErrorCodeType {
  ...
  ConnectionErrorCodeType(String value) {
    this.value = value;
  }
  ...
  public static ConnectionErrorCodeType fromValue(String value) {
    for (ConnectionErrorCodeType b : ConnectionErrorCodeType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ConnectionErrorCodeType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ConnectionErrorCodeType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ConnectionErrorCodeType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ConnectionErrorCodeType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ConnectionErrorCodeType.fromValue(value);
  }
}
