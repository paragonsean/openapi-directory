...
/**
 * Gets or Sets DataKeySpec
 */
@JsonAdapter(DataKeySpec.Adapter.class)
public enum DataKeySpec {
  ...
  public static DataKeySpec fromValue(String value) {
    for (DataKeySpec b : DataKeySpec.values()) {
  ...
  public static class Adapter extends TypeAdapter<DataKeySpec> {
    @Override
    public void write(final JsonWriter jsonWriter, final DataKeySpec enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DataKeySpec read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DataKeySpec.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    DataKeySpec.fromValue(value);
  }
}
