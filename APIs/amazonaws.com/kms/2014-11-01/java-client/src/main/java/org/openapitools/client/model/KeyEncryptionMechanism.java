...
/**
 * Gets or Sets KeyEncryptionMechanism
 */
@JsonAdapter(KeyEncryptionMechanism.Adapter.class)
public enum KeyEncryptionMechanism {
  ...
  KeyEncryptionMechanism(String value) {
    this.value = value;
  }
  ...
  public static KeyEncryptionMechanism fromValue(String value) {
    for (KeyEncryptionMechanism b : KeyEncryptionMechanism.values()) {
  ...
  public static class Adapter extends TypeAdapter<KeyEncryptionMechanism> {
    @Override
    public void write(final JsonWriter jsonWriter, final KeyEncryptionMechanism enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public KeyEncryptionMechanism read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return KeyEncryptionMechanism.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    KeyEncryptionMechanism.fromValue(value);
  }
}
