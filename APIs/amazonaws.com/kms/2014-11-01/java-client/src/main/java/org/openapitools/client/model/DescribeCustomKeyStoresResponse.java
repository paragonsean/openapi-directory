...
public class DescribeCustomKeyStoresResponse {
  public static final String SERIALIZED_NAME_CUSTOM_KEY_STORES = "CustomKeyStores";
  @SerializedName(SERIALIZED_NAME_CUSTOM_KEY_STORES)
  private List customKeyStores;
  ...
  public DescribeCustomKeyStoresResponse() {
  }

  public DescribeCustomKeyStoresResponse customKeyStores(List customKeyStores) {
  ...
  public void setCustomKeyStores(List customKeyStores) {
    this.customKeyStores = customKeyStores;
  }


  public DescribeCustomKeyStoresResponse nextMarker(String nextMarker) {
  ...
  public DescribeCustomKeyStoresResponse truncated(Boolean truncated) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.customKeyStores, describeCustomKeyStoresResponse.customKeyStores) &&
        Objects.equals(this.nextMarker, describeCustomKeyStoresResponse.nextMarker) &&
        Objects.equals(this.truncated, describeCustomKeyStoresResponse.truncated);
  }

  @Override
  public int hashCode() {
    return Objects.hash(customKeyStores, nextMarker, truncated);
  }
  ...
  static {
    ...
    openapiFields.add("CustomKeyStores");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeCustomKeyStoresResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeCustomKeyStoresResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeCustomKeyStoresResponse is not found in the empty JSON string", DescribeCustomKeyStoresResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeCustomKeyStoresResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeCustomKeyStoresResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `CustomKeyStores`
      if (jsonObj.get("CustomKeyStores") != null && !jsonObj.get("CustomKeyStores").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("CustomKeyStores"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeCustomKeyStoresResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeCustomKeyStoresResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeCustomKeyStoresResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeCustomKeyStoresResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeCustomKeyStoresResponse>() {
           @Override
           public void write(JsonWriter out, DescribeCustomKeyStoresResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeCustomKeyStoresResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeCustomKeyStoresResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeCustomKeyStoresResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeCustomKeyStoresResponse
   */
  public static DescribeCustomKeyStoresResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeCustomKeyStoresResponse.class);
  }

  /**
   * Convert an instance of DescribeCustomKeyStoresResponse to an JSON string
   *
   * @return JSON string
   */
