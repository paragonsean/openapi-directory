...
public class ReplicateKeyRequest {
  ...
  public ReplicateKeyRequest policy(String policy) {
    this.policy = policy;
    return this;
  }
  ...
  public ReplicateKeyRequest bypassPolicyLockoutSafetyCheck(Boolean bypassPolicyLockoutSafetyCheck) {
  ...
  public ReplicateKeyRequest tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keyId, replicateKeyRequest.keyId) &&
        Objects.equals(this.replicaRegion, replicateKeyRequest.replicaRegion) &&
        Objects.equals(this.policy, replicateKeyRequest.policy) &&
        Objects.equals(this.bypassPolicyLockoutSafetyCheck, replicateKeyRequest.bypassPolicyLockoutSafetyCheck) &&
        Objects.equals(this.description, replicateKeyRequest.description) &&
        Objects.equals(this.tags, replicateKeyRequest.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keyId, replicaRegion, policy, bypassPolicyLockoutSafetyCheck, description, tags);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReplicateKeyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReplicateKeyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReplicateKeyRequest is not found in the empty JSON string", ReplicateKeyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReplicateKeyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReplicateKeyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReplicateKeyRequest.openapiRequiredFields) {
      ...
      // validate the required field `ReplicaRegion`
      String.validateJsonElement(jsonObj.get("ReplicaRegion"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReplicateKeyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReplicateKeyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReplicateKeyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReplicateKeyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ReplicateKeyRequest>() {
           @Override
           public void write(JsonWriter out, ReplicateKeyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReplicateKeyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReplicateKeyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReplicateKeyRequest
   * @throws IOException if the JSON string is invalid with respect to ReplicateKeyRequest
   */
  public static ReplicateKeyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReplicateKeyRequest.class);
  }

  /**
   * Convert an instance of ReplicateKeyRequest to an JSON string
   *
   * @return JSON string
   */
