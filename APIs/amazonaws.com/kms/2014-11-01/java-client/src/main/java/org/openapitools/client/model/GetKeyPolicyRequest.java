...
public class GetKeyPolicyRequest {
  ...
  public GetKeyPolicyRequest keyId(String keyId) {
    this.keyId = keyId;
    return this;
  }
  ...
  public GetKeyPolicyRequest policyName(String policyName) {
  ...
  public boolean equals(Object o) {
    ...
    GetKeyPolicyRequest getKeyPolicyRequest = (GetKeyPolicyRequest) o;
    return Objects.equals(this.keyId, getKeyPolicyRequest.keyId) &&
        Objects.equals(this.policyName, getKeyPolicyRequest.policyName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keyId, policyName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetKeyPolicyRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetKeyPolicyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetKeyPolicyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetKeyPolicyRequest is not found in the empty JSON string", GetKeyPolicyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetKeyPolicyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetKeyPolicyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetKeyPolicyRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetKeyPolicyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetKeyPolicyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetKeyPolicyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetKeyPolicyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetKeyPolicyRequest>() {
           @Override
           public void write(JsonWriter out, GetKeyPolicyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetKeyPolicyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetKeyPolicyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetKeyPolicyRequest
   * @throws IOException if the JSON string is invalid with respect to GetKeyPolicyRequest
   */
  public static GetKeyPolicyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetKeyPolicyRequest.class);
  }

  /**
   * Convert an instance of GetKeyPolicyRequest to an JSON string
   *
   * @return JSON string
   */
