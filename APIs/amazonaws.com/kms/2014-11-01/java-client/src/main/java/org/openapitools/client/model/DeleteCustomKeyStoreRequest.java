...
public class DeleteCustomKeyStoreRequest {
  ...
  public DeleteCustomKeyStoreRequest customKeyStoreId(String customKeyStoreId) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteCustomKeyStoreRequest deleteCustomKeyStoreRequest = (DeleteCustomKeyStoreRequest) o;
    return Objects.equals(this.customKeyStoreId, deleteCustomKeyStoreRequest.customKeyStoreId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteCustomKeyStoreRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("CustomKeyStoreId");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteCustomKeyStoreRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteCustomKeyStoreRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteCustomKeyStoreRequest is not found in the empty JSON string", DeleteCustomKeyStoreRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteCustomKeyStoreRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteCustomKeyStoreRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteCustomKeyStoreRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `CustomKeyStoreId`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteCustomKeyStoreRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteCustomKeyStoreRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteCustomKeyStoreRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteCustomKeyStoreRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteCustomKeyStoreRequest>() {
           @Override
           public void write(JsonWriter out, DeleteCustomKeyStoreRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteCustomKeyStoreRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteCustomKeyStoreRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteCustomKeyStoreRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteCustomKeyStoreRequest
   */
  public static DeleteCustomKeyStoreRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteCustomKeyStoreRequest.class);
  }

  /**
   * Convert an instance of DeleteCustomKeyStoreRequest to an JSON string
   *
   * @return JSON string
   */
