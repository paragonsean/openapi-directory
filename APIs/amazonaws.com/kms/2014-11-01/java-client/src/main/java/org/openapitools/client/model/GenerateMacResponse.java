...
public class GenerateMacResponse {
  ...
  public GenerateMacResponse macAlgorithm(MacAlgorithmSpec macAlgorithm) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.mac, generateMacResponse.mac) &&
        Objects.equals(this.macAlgorithm, generateMacResponse.macAlgorithm) &&
        Objects.equals(this.keyId, generateMacResponse.keyId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(mac, macAlgorithm, keyId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GenerateMacResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GenerateMacResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenerateMacResponse is not found in the empty JSON string", GenerateMacResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GenerateMacResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenerateMacResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Mac`
      if (jsonObj.get("Mac") != null && !jsonObj.get("Mac").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("Mac"));
      }
      // validate the optional field `MacAlgorithm`
      if (jsonObj.get("MacAlgorithm") != null && !jsonObj.get("MacAlgorithm").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenerateMacResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenerateMacResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenerateMacResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenerateMacResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GenerateMacResponse>() {
           @Override
           public void write(JsonWriter out, GenerateMacResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GenerateMacResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GenerateMacResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GenerateMacResponse
   * @throws IOException if the JSON string is invalid with respect to GenerateMacResponse
   */
  public static GenerateMacResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateMacResponse.class);
  }

  /**
   * Convert an instance of GenerateMacResponse to an JSON string
   *
   * @return JSON string
   */
