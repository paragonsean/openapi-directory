...
import org.openapitools.client.model.ReplicateKeyResponseReplicaKeyMetadata;
...
public class ReplicateKeyResponse {
  public static final String SERIALIZED_NAME_REPLICA_KEY_METADATA = "ReplicaKeyMetadata";
  @SerializedName(SERIALIZED_NAME_REPLICA_KEY_METADATA)
  private ReplicateKeyResponseReplicaKeyMetadata replicaKeyMetadata;

  public static final String SERIALIZED_NAME_REPLICA_POLICY = "ReplicaPolicy";
  @SerializedName(SERIALIZED_NAME_REPLICA_POLICY)
  private String replicaPolicy;

  public static final String SERIALIZED_NAME_REPLICA_TAGS = "ReplicaTags";
  @SerializedName(SERIALIZED_NAME_REPLICA_TAGS)
  private List replicaTags;

  public ReplicateKeyResponse() {
  }

  public ReplicateKeyResponse replicaKeyMetadata(ReplicateKeyResponseReplicaKeyMetadata replicaKeyMetadata) {
  ...
  public ReplicateKeyResponseReplicaKeyMetadata getReplicaKeyMetadata() {
    return replicaKeyMetadata;
  }

  public void setReplicaKeyMetadata(ReplicateKeyResponseReplicaKeyMetadata replicaKeyMetadata) {
    this.replicaKeyMetadata = replicaKeyMetadata;
  }


  public ReplicateKeyResponse replicaPolicy(String replicaPolicy) {
  ...
  public ReplicateKeyResponse replicaTags(List replicaTags) {
  ...
  public void setReplicaTags(List replicaTags) {
    this.replicaTags = replicaTags;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.replicaKeyMetadata, replicateKeyResponse.replicaKeyMetadata) &&
        Objects.equals(this.replicaPolicy, replicateKeyResponse.replicaPolicy) &&
        Objects.equals(this.replicaTags, replicateKeyResponse.replicaTags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(replicaKeyMetadata, replicaPolicy, replicaTags);
  }
  ...
  public String toString() {
    ...
    sb.append("    replicaKeyMetadata: ").append(toIndentedString(replicaKeyMetadata)).append("\n");
    sb.append("    replicaPolicy: ").append(toIndentedString(replicaPolicy)).append("\n");
    sb.append("    replicaTags: ").append(toIndentedString(replicaTags)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("ReplicaKeyMetadata");
    openapiFields.add("ReplicaPolicy");
    openapiFields.add("ReplicaTags");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReplicateKeyResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReplicateKeyResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReplicateKeyResponse is not found in the empty JSON string", ReplicateKeyResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReplicateKeyResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReplicateKeyResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `ReplicaKeyMetadata`
      if (jsonObj.get("ReplicaKeyMetadata") != null && !jsonObj.get("ReplicaKeyMetadata").isJsonNull()) {
        ReplicateKeyResponseReplicaKeyMetadata.validateJsonElement(jsonObj.get("ReplicaKeyMetadata"));
      }
      // validate the optional field `ReplicaPolicy`
      if (jsonObj.get("ReplicaPolicy") != null && !jsonObj.get("ReplicaPolicy").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("ReplicaPolicy"));
      }
      // validate the optional field `ReplicaTags`
      if (jsonObj.get("ReplicaTags") != null && !jsonObj.get("ReplicaTags").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("ReplicaTags"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReplicateKeyResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReplicateKeyResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReplicateKeyResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReplicateKeyResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ReplicateKeyResponse>() {
           @Override
           public void write(JsonWriter out, ReplicateKeyResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReplicateKeyResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReplicateKeyResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReplicateKeyResponse
   * @throws IOException if the JSON string is invalid with respect to ReplicateKeyResponse
   */
  public static ReplicateKeyResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReplicateKeyResponse.class);
  }

  /**
   * Convert an instance of ReplicateKeyResponse to an JSON string
   *
   * @return JSON string
   */
