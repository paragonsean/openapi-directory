 ...
 */
@JsonAdapter(CustomKeyStoreType.Adapter.class)
public enum CustomKeyStoreType {
  ...
  CustomKeyStoreType(String value) {
    this.value = value;
  }
  ...
  public static CustomKeyStoreType fromValue(String value) {
    for (CustomKeyStoreType b : CustomKeyStoreType.values()) {
  ...
  public static class Adapter extends TypeAdapter<CustomKeyStoreType> {
    @Override
    public void write(final JsonWriter jsonWriter, final CustomKeyStoreType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CustomKeyStoreType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CustomKeyStoreType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    CustomKeyStoreType.fromValue(value);
  }
}
