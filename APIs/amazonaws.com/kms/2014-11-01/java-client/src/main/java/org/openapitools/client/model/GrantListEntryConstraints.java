...
public class GrantListEntryConstraints {
  ...
  public GrantListEntryConstraints() {
  }

  public GrantListEntryConstraints encryptionContextSubset(Map encryptionContextSubset) {
  ...
  public GrantListEntryConstraints encryptionContextEquals(Map encryptionContextEquals) {
  ...
  public boolean equals(Object o) {
    ...
    GrantListEntryConstraints grantListEntryConstraints = (GrantListEntryConstraints) o;
    return Objects.equals(this.encryptionContextSubset, grantListEntryConstraints.encryptionContextSubset) &&
        Objects.equals(this.encryptionContextEquals, grantListEntryConstraints.encryptionContextEquals);
  }
  ...
  public String toString() {
    ...
    sb.append("class GrantListEntryConstraints {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GrantListEntryConstraints
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GrantListEntryConstraints.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GrantListEntryConstraints is not found in the empty JSON string", GrantListEntryConstraints.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GrantListEntryConstraints.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GrantListEntryConstraints` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GrantListEntryConstraints.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GrantListEntryConstraints' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GrantListEntryConstraints> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GrantListEntryConstraints.class));

       return (TypeAdapter<T>) new TypeAdapter<GrantListEntryConstraints>() {
           @Override
           public void write(JsonWriter out, GrantListEntryConstraints value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GrantListEntryConstraints read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GrantListEntryConstraints given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GrantListEntryConstraints
   * @throws IOException if the JSON string is invalid with respect to GrantListEntryConstraints
   */
  public static GrantListEntryConstraints fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GrantListEntryConstraints.class);
  }

  /**
   * Convert an instance of GrantListEntryConstraints to an JSON string
   *
   * @return JSON string
   */
