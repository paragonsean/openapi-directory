...
public class GetPublicKeyRequest {
  ...
  public GetPublicKeyRequest grantTokens(List grantTokens) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keyId, getPublicKeyRequest.keyId) &&
        Objects.equals(this.grantTokens, getPublicKeyRequest.grantTokens);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keyId, grantTokens);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPublicKeyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPublicKeyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPublicKeyRequest is not found in the empty JSON string", GetPublicKeyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPublicKeyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPublicKeyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetPublicKeyRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPublicKeyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPublicKeyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPublicKeyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPublicKeyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPublicKeyRequest>() {
           @Override
           public void write(JsonWriter out, GetPublicKeyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPublicKeyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPublicKeyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPublicKeyRequest
   * @throws IOException if the JSON string is invalid with respect to GetPublicKeyRequest
   */
  public static GetPublicKeyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPublicKeyRequest.class);
  }

  /**
   * Convert an instance of GetPublicKeyRequest to an JSON string
   *
   * @return JSON string
   */
