...
import org.openapitools.client.model.MultiRegionConfigurationPrimaryKey;
import org.openapitools.client.model.MultiRegionKeyType;
...
public class KeyMetadataMultiRegionConfiguration {
  public static final String SERIALIZED_NAME_MULTI_REGION_KEY_TYPE = "MultiRegionKeyType";
  @SerializedName(SERIALIZED_NAME_MULTI_REGION_KEY_TYPE)
  ...
  private MultiRegionConfigurationPrimaryKey primaryKey;

  public static final String SERIALIZED_NAME_REPLICA_KEYS = "ReplicaKeys";
  @SerializedName(SERIALIZED_NAME_REPLICA_KEYS)
  private List replicaKeys;

  public KeyMetadataMultiRegionConfiguration() {
  }

  public KeyMetadataMultiRegionConfiguration multiRegionKeyType(MultiRegionKeyType multiRegionKeyType) {
  ...
  public KeyMetadataMultiRegionConfiguration primaryKey(MultiRegionConfigurationPrimaryKey primaryKey) {
   ...
   */
  @javax.annotation.Nullable
  public MultiRegionConfigurationPrimaryKey getPrimaryKey() {
    return primaryKey;
  }

  public void setPrimaryKey(MultiRegionConfigurationPrimaryKey primaryKey) {
    this.primaryKey = primaryKey;
  }


  public KeyMetadataMultiRegionConfiguration replicaKeys(List replicaKeys) {
  ...
  public void setReplicaKeys(List replicaKeys) {
    this.replicaKeys = replicaKeys;
  }
  ...
  public boolean equals(Object o) {
    ...
    KeyMetadataMultiRegionConfiguration keyMetadataMultiRegionConfiguration = (KeyMetadataMultiRegionConfiguration) o;
    return Objects.equals(this.multiRegionKeyType, keyMetadataMultiRegionConfiguration.multiRegionKeyType) &&
        Objects.equals(this.primaryKey, keyMetadataMultiRegionConfiguration.primaryKey) &&
        Objects.equals(this.replicaKeys, keyMetadataMultiRegionConfiguration.replicaKeys);
  }
  ...
  public String toString() {
    ...
    sb.append("class KeyMetadataMultiRegionConfiguration {\n");
  ...
  static {
    ...
    openapiFields.add("MultiRegionKeyType");
    openapiFields.add("PrimaryKey");
    openapiFields.add("ReplicaKeys");
   ...
   * @throws IOException if the JSON Element is invalid with respect to KeyMetadataMultiRegionConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KeyMetadataMultiRegionConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KeyMetadataMultiRegionConfiguration is not found in the empty JSON string", KeyMetadataMultiRegionConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!KeyMetadataMultiRegionConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `KeyMetadataMultiRegionConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `MultiRegionKeyType`
      if (jsonObj.get("MultiRegionKeyType") != null && !jsonObj.get("MultiRegionKeyType").isJsonNull()) {
        MultiRegionKeyType.validateJsonElement(jsonObj.get("MultiRegionKeyType"));
      }
      // validate the optional field `PrimaryKey`
      if (jsonObj.get("PrimaryKey") != null && !jsonObj.get("PrimaryKey").isJsonNull()) {
        MultiRegionConfigurationPrimaryKey.validateJsonElement(jsonObj.get("PrimaryKey"));
      }
      // validate the optional field `ReplicaKeys`
      if (jsonObj.get("ReplicaKeys") != null && !jsonObj.get("ReplicaKeys").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("ReplicaKeys"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KeyMetadataMultiRegionConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KeyMetadataMultiRegionConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KeyMetadataMultiRegionConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KeyMetadataMultiRegionConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<KeyMetadataMultiRegionConfiguration>() {
           @Override
           public void write(JsonWriter out, KeyMetadataMultiRegionConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public KeyMetadataMultiRegionConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of KeyMetadataMultiRegionConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of KeyMetadataMultiRegionConfiguration
   * @throws IOException if the JSON string is invalid with respect to KeyMetadataMultiRegionConfiguration
   */
  public static KeyMetadataMultiRegionConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KeyMetadataMultiRegionConfiguration.class);
  }

  /**
   * Convert an instance of KeyMetadataMultiRegionConfiguration to an JSON string
   *
   * @return JSON string
   */
