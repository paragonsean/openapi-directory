...
public class MultiRegionConfigurationPrimaryKey {
  ...
  public MultiRegionConfigurationPrimaryKey() {
  }

  public MultiRegionConfigurationPrimaryKey arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public MultiRegionConfigurationPrimaryKey region(String region) {
    this.region = region;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MultiRegionConfigurationPrimaryKey multiRegionConfigurationPrimaryKey = (MultiRegionConfigurationPrimaryKey) o;
    return Objects.equals(this.arn, multiRegionConfigurationPrimaryKey.arn) &&
        Objects.equals(this.region, multiRegionConfigurationPrimaryKey.region);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultiRegionConfigurationPrimaryKey {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MultiRegionConfigurationPrimaryKey
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MultiRegionConfigurationPrimaryKey.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MultiRegionConfigurationPrimaryKey is not found in the empty JSON string", MultiRegionConfigurationPrimaryKey.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MultiRegionConfigurationPrimaryKey.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MultiRegionConfigurationPrimaryKey` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MultiRegionConfigurationPrimaryKey.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MultiRegionConfigurationPrimaryKey' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MultiRegionConfigurationPrimaryKey> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MultiRegionConfigurationPrimaryKey.class));

       return (TypeAdapter<T>) new TypeAdapter<MultiRegionConfigurationPrimaryKey>() {
           @Override
           public void write(JsonWriter out, MultiRegionConfigurationPrimaryKey value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MultiRegionConfigurationPrimaryKey read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MultiRegionConfigurationPrimaryKey given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MultiRegionConfigurationPrimaryKey
   * @throws IOException if the JSON string is invalid with respect to MultiRegionConfigurationPrimaryKey
   */
  public static MultiRegionConfigurationPrimaryKey fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MultiRegionConfigurationPrimaryKey.class);
  }

  /**
   * Convert an instance of MultiRegionConfigurationPrimaryKey to an JSON string
   *
   * @return JSON string
   */
