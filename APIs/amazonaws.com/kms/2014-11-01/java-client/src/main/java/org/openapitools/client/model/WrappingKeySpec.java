...
/**
 * Gets or Sets WrappingKeySpec
 */
@JsonAdapter(WrappingKeySpec.Adapter.class)
public enum WrappingKeySpec {
  ...
  public static WrappingKeySpec fromValue(String value) {
    for (WrappingKeySpec b : WrappingKeySpec.values()) {
  ...
  public static class Adapter extends TypeAdapter<WrappingKeySpec> {
    @Override
    public void write(final JsonWriter jsonWriter, final WrappingKeySpec enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public WrappingKeySpec read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return WrappingKeySpec.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    WrappingKeySpec.fromValue(value);
  }
}
