...
public class ListRetirableGrantsRequest {
  ...
  public ListRetirableGrantsRequest limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public ListRetirableGrantsRequest marker(String marker) {
    this.marker = marker;
    return this;
  }
  ...
  public ListRetirableGrantsRequest retiringPrincipal(String retiringPrincipal) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.limit, listRetirableGrantsRequest.limit) &&
        Objects.equals(this.marker, listRetirableGrantsRequest.marker) &&
        Objects.equals(this.retiringPrincipal, listRetirableGrantsRequest.retiringPrincipal);
  }

  @Override
  public int hashCode() {
    return Objects.hash(limit, marker, retiringPrincipal);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("RetiringPrincipal");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListRetirableGrantsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListRetirableGrantsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListRetirableGrantsRequest is not found in the empty JSON string", ListRetirableGrantsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListRetirableGrantsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListRetirableGrantsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListRetirableGrantsRequest.openapiRequiredFields) {
      ...
      // validate the required field `RetiringPrincipal`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListRetirableGrantsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListRetirableGrantsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListRetirableGrantsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListRetirableGrantsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListRetirableGrantsRequest>() {
           @Override
           public void write(JsonWriter out, ListRetirableGrantsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListRetirableGrantsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListRetirableGrantsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListRetirableGrantsRequest
   * @throws IOException if the JSON string is invalid with respect to ListRetirableGrantsRequest
   */
  public static ListRetirableGrantsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListRetirableGrantsRequest.class);
  }

  /**
   * Convert an instance of ListRetirableGrantsRequest to an JSON string
   *
   * @return JSON string
   */
