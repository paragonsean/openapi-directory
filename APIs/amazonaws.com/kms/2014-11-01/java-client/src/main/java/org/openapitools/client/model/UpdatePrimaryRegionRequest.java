...
public class UpdatePrimaryRegionRequest {
  ...
  public UpdatePrimaryRegionRequest() {
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePrimaryRegionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePrimaryRegionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePrimaryRegionRequest is not found in the empty JSON string", UpdatePrimaryRegionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePrimaryRegionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePrimaryRegionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdatePrimaryRegionRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePrimaryRegionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePrimaryRegionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePrimaryRegionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePrimaryRegionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePrimaryRegionRequest>() {
           @Override
           public void write(JsonWriter out, UpdatePrimaryRegionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePrimaryRegionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePrimaryRegionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePrimaryRegionRequest
   * @throws IOException if the JSON string is invalid with respect to UpdatePrimaryRegionRequest
   */
  public static UpdatePrimaryRegionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePrimaryRegionRequest.class);
  }

  /**
   * Convert an instance of UpdatePrimaryRegionRequest to an JSON string
   *
   * @return JSON string
   */
