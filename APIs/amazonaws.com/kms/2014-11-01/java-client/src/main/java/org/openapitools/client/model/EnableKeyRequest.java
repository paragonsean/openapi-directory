...
public class EnableKeyRequest {
   ...
   * @throws IOException if the JSON Element is invalid with respect to EnableKeyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EnableKeyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EnableKeyRequest is not found in the empty JSON string", EnableKeyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EnableKeyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EnableKeyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EnableKeyRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EnableKeyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EnableKeyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EnableKeyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EnableKeyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<EnableKeyRequest>() {
           @Override
           public void write(JsonWriter out, EnableKeyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EnableKeyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EnableKeyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EnableKeyRequest
   * @throws IOException if the JSON string is invalid with respect to EnableKeyRequest
   */
  public static EnableKeyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EnableKeyRequest.class);
  }

  /**
   * Convert an instance of EnableKeyRequest to an JSON string
   *
   * @return JSON string
   */
