...
public class GenerateDataKeyRequestRecipient {
  ...
  public GenerateDataKeyRequestRecipient() {
  }

  public GenerateDataKeyRequestRecipient keyEncryptionAlgorithm(KeyEncryptionMechanism keyEncryptionAlgorithm) {
  ...
  public GenerateDataKeyRequestRecipient attestationDocument(String attestationDocument) {
  ...
  public boolean equals(Object o) {
    ...
    GenerateDataKeyRequestRecipient generateDataKeyRequestRecipient = (GenerateDataKeyRequestRecipient) o;
    return Objects.equals(this.keyEncryptionAlgorithm, generateDataKeyRequestRecipient.keyEncryptionAlgorithm) &&
        Objects.equals(this.attestationDocument, generateDataKeyRequestRecipient.attestationDocument);
  }
  ...
  public String toString() {
    ...
    sb.append("class GenerateDataKeyRequestRecipient {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GenerateDataKeyRequestRecipient
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GenerateDataKeyRequestRecipient.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenerateDataKeyRequestRecipient is not found in the empty JSON string", GenerateDataKeyRequestRecipient.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GenerateDataKeyRequestRecipient.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenerateDataKeyRequestRecipient` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenerateDataKeyRequestRecipient.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenerateDataKeyRequestRecipient' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenerateDataKeyRequestRecipient> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenerateDataKeyRequestRecipient.class));

       return (TypeAdapter<T>) new TypeAdapter<GenerateDataKeyRequestRecipient>() {
           @Override
           public void write(JsonWriter out, GenerateDataKeyRequestRecipient value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GenerateDataKeyRequestRecipient read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GenerateDataKeyRequestRecipient given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GenerateDataKeyRequestRecipient
   * @throws IOException if the JSON string is invalid with respect to GenerateDataKeyRequestRecipient
   */
  public static GenerateDataKeyRequestRecipient fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateDataKeyRequestRecipient.class);
  }

  /**
   * Convert an instance of GenerateDataKeyRequestRecipient to an JSON string
   *
   * @return JSON string
   */
