...
import org.openapitools.client.model.GenerateDataKeyRequestRecipient;
...
public class GenerateDataKeyRequest {
  ...
  private GenerateDataKeyRequestRecipient recipient;
  ...
  public GenerateDataKeyRequest encryptionContext(Map encryptionContext) {
  ...
  public GenerateDataKeyRequest keySpec(DataKeySpec keySpec) {
  ...
  public GenerateDataKeyRequest grantTokens(List grantTokens) {
  ...
  public GenerateDataKeyRequest recipient(GenerateDataKeyRequestRecipient recipient) {
   ...
   */
  @javax.annotation.Nullable
  public GenerateDataKeyRequestRecipient getRecipient() {
    return recipient;
  }

  public void setRecipient(GenerateDataKeyRequestRecipient recipient) {
    this.recipient = recipient;
  }


  public GenerateDataKeyRequest dryRun(Boolean dryRun) {
    this.dryRun = dryRun;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keyId, generateDataKeyRequest.keyId) &&
        Objects.equals(this.encryptionContext, generateDataKeyRequest.encryptionContext) &&
        ...
        Objects.equals(this.grantTokens, generateDataKeyRequest.grantTokens) &&
        Objects.equals(this.recipient, generateDataKeyRequest.recipient) &&
        Objects.equals(this.dryRun, generateDataKeyRequest.dryRun);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keyId, encryptionContext, numberOfBytes, keySpec, grantTokens, recipient, dryRun);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GenerateDataKeyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GenerateDataKeyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenerateDataKeyRequest is not found in the empty JSON string", GenerateDataKeyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GenerateDataKeyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenerateDataKeyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GenerateDataKeyRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("KeySpec") != null && !jsonObj.get("KeySpec").isJsonNull()) {
        DataKeySpec.validateJsonElement(jsonObj.get("KeySpec"));
      }
      ...
      if (jsonObj.get("Recipient") != null && !jsonObj.get("Recipient").isJsonNull()) {
        GenerateDataKeyRequestRecipient.validateJsonElement(jsonObj.get("Recipient"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenerateDataKeyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenerateDataKeyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenerateDataKeyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenerateDataKeyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GenerateDataKeyRequest>() {
           @Override
           public void write(JsonWriter out, GenerateDataKeyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GenerateDataKeyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GenerateDataKeyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GenerateDataKeyRequest
   * @throws IOException if the JSON string is invalid with respect to GenerateDataKeyRequest
   */
  public static GenerateDataKeyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateDataKeyRequest.class);
  }

  /**
   * Convert an instance of GenerateDataKeyRequest to an JSON string
   *
   * @return JSON string
   */
