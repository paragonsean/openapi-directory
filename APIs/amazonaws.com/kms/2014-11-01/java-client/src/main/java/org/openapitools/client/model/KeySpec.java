 ...
 */
@JsonAdapter(KeySpec.Adapter.class)
public enum KeySpec {
  ...
  public static class Adapter extends TypeAdapter<KeySpec> {
    @Override
    public void write(final JsonWriter jsonWriter, final KeySpec enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public KeySpec read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return KeySpec.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    KeySpec.fromValue(value);
  }
}
