...
public class GenerateRandomRequestRecipient {
  ...
  public GenerateRandomRequestRecipient() {
  }

  public GenerateRandomRequestRecipient keyEncryptionAlgorithm(KeyEncryptionMechanism keyEncryptionAlgorithm) {
  ...
  public GenerateRandomRequestRecipient attestationDocument(String attestationDocument) {
  ...
  public boolean equals(Object o) {
    ...
    GenerateRandomRequestRecipient generateRandomRequestRecipient = (GenerateRandomRequestRecipient) o;
    return Objects.equals(this.keyEncryptionAlgorithm, generateRandomRequestRecipient.keyEncryptionAlgorithm) &&
        Objects.equals(this.attestationDocument, generateRandomRequestRecipient.attestationDocument);
  }
  ...
  public String toString() {
    ...
    sb.append("class GenerateRandomRequestRecipient {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GenerateRandomRequestRecipient
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GenerateRandomRequestRecipient.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenerateRandomRequestRecipient is not found in the empty JSON string", GenerateRandomRequestRecipient.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GenerateRandomRequestRecipient.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenerateRandomRequestRecipient` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenerateRandomRequestRecipient.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenerateRandomRequestRecipient' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenerateRandomRequestRecipient> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenerateRandomRequestRecipient.class));

       return (TypeAdapter<T>) new TypeAdapter<GenerateRandomRequestRecipient>() {
           @Override
           public void write(JsonWriter out, GenerateRandomRequestRecipient value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GenerateRandomRequestRecipient read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GenerateRandomRequestRecipient given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GenerateRandomRequestRecipient
   * @throws IOException if the JSON string is invalid with respect to GenerateRandomRequestRecipient
   */
  public static GenerateRandomRequestRecipient fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateRandomRequestRecipient.class);
  }

  /**
   * Convert an instance of GenerateRandomRequestRecipient to an JSON string
   *
   * @return JSON string
   */
