 ...
 */
@JsonAdapter(KeyUsageType.Adapter.class)
public enum KeyUsageType {
  ...
  public static class Adapter extends TypeAdapter<KeyUsageType> {
    @Override
    public void write(final JsonWriter jsonWriter, final KeyUsageType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public KeyUsageType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return KeyUsageType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    KeyUsageType.fromValue(value);
  }
}
