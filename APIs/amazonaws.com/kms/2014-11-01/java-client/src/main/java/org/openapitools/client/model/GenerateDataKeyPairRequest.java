...
public class GenerateDataKeyPairRequest {
  ...
  private GenerateDataKeyPairRequestRecipient recipient;
  ...
  public GenerateDataKeyPairRequest encryptionContext(Map encryptionContext) {
  ...
  public GenerateDataKeyPairRequest keyId(String keyId) {
    this.keyId = keyId;
    return this;
  }
  ...
  public GenerateDataKeyPairRequest keyPairSpec(DataKeyPairSpec keyPairSpec) {
  ...
  public GenerateDataKeyPairRequest grantTokens(List grantTokens) {
  ...
  public GenerateDataKeyPairRequest recipient(GenerateDataKeyPairRequestRecipient recipient) {
   ...
   */
  @javax.annotation.Nullable
  public GenerateDataKeyPairRequestRecipient getRecipient() {
    return recipient;
  }

  public void setRecipient(GenerateDataKeyPairRequestRecipient recipient) {
    this.recipient = recipient;
  }


  public GenerateDataKeyPairRequest dryRun(Boolean dryRun) {
    this.dryRun = dryRun;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GenerateDataKeyPairRequest generateDataKeyPairRequest = (GenerateDataKeyPairRequest) o;
    return Objects.equals(this.encryptionContext, generateDataKeyPairRequest.encryptionContext) &&
        Objects.equals(this.keyId, generateDataKeyPairRequest.keyId) &&
        Objects.equals(this.keyPairSpec, generateDataKeyPairRequest.keyPairSpec) &&
        Objects.equals(this.grantTokens, generateDataKeyPairRequest.grantTokens) &&
        Objects.equals(this.recipient, generateDataKeyPairRequest.recipient) &&
        Objects.equals(this.dryRun, generateDataKeyPairRequest.dryRun);
  }

  @Override
  public int hashCode() {
    return Objects.hash(encryptionContext, keyId, keyPairSpec, grantTokens, recipient, dryRun);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GenerateDataKeyPairRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GenerateDataKeyPairRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GenerateDataKeyPairRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenerateDataKeyPairRequest is not found in the empty JSON string", GenerateDataKeyPairRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GenerateDataKeyPairRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenerateDataKeyPairRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GenerateDataKeyPairRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("Recipient") != null && !jsonObj.get("Recipient").isJsonNull()) {
        GenerateDataKeyPairRequestRecipient.validateJsonElement(jsonObj.get("Recipient"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenerateDataKeyPairRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenerateDataKeyPairRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenerateDataKeyPairRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenerateDataKeyPairRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GenerateDataKeyPairRequest>() {
           @Override
           public void write(JsonWriter out, GenerateDataKeyPairRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GenerateDataKeyPairRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GenerateDataKeyPairRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GenerateDataKeyPairRequest
   * @throws IOException if the JSON string is invalid with respect to GenerateDataKeyPairRequest
   */
  public static GenerateDataKeyPairRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateDataKeyPairRequest.class);
  }

  /**
   * Convert an instance of GenerateDataKeyPairRequest to an JSON string
   *
   * @return JSON string
   */
