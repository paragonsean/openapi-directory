...
/**
 * Gets or Sets MacAlgorithmSpec
 */
@JsonAdapter(MacAlgorithmSpec.Adapter.class)
public enum MacAlgorithmSpec {
  ...
  public static MacAlgorithmSpec fromValue(String value) {
    for (MacAlgorithmSpec b : MacAlgorithmSpec.values()) {
  ...
  public static class Adapter extends TypeAdapter<MacAlgorithmSpec> {
    @Override
    public void write(final JsonWriter jsonWriter, final MacAlgorithmSpec enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public MacAlgorithmSpec read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return MacAlgorithmSpec.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    MacAlgorithmSpec.fromValue(value);
  }
}
