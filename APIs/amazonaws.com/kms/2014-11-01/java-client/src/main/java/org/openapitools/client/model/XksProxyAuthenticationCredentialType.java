...
public class XksProxyAuthenticationCredentialType {
  ...
  public XksProxyAuthenticationCredentialType accessKeyId(String accessKeyId) {
  ...
  public XksProxyAuthenticationCredentialType rawSecretAccessKey(String rawSecretAccessKey) {
  ...
  public boolean equals(Object o) {
    ...
    XksProxyAuthenticationCredentialType xksProxyAuthenticationCredentialType = (XksProxyAuthenticationCredentialType) o;
    return Objects.equals(this.accessKeyId, xksProxyAuthenticationCredentialType.accessKeyId) &&
        Objects.equals(this.rawSecretAccessKey, xksProxyAuthenticationCredentialType.rawSecretAccessKey);
  }
  ...
  public String toString() {
    ...
    sb.append("class XksProxyAuthenticationCredentialType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to XksProxyAuthenticationCredentialType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!XksProxyAuthenticationCredentialType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in XksProxyAuthenticationCredentialType is not found in the empty JSON string", XksProxyAuthenticationCredentialType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!XksProxyAuthenticationCredentialType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `XksProxyAuthenticationCredentialType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : XksProxyAuthenticationCredentialType.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!XksProxyAuthenticationCredentialType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'XksProxyAuthenticationCredentialType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<XksProxyAuthenticationCredentialType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(XksProxyAuthenticationCredentialType.class));

       return (TypeAdapter<T>) new TypeAdapter<XksProxyAuthenticationCredentialType>() {
           @Override
           public void write(JsonWriter out, XksProxyAuthenticationCredentialType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public XksProxyAuthenticationCredentialType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of XksProxyAuthenticationCredentialType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of XksProxyAuthenticationCredentialType
   * @throws IOException if the JSON string is invalid with respect to XksProxyAuthenticationCredentialType
   */
  public static XksProxyAuthenticationCredentialType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, XksProxyAuthenticationCredentialType.class);
  }

  /**
   * Convert an instance of XksProxyAuthenticationCredentialType to an JSON string
   *
   * @return JSON string
   */
