...
public class ScheduleKeyDeletionResponse {
  ...
  public static final String SERIALIZED_NAME_PENDING_WINDOW_IN_DAYS = "PendingWindowInDays";
  @SerializedName(SERIALIZED_NAME_PENDING_WINDOW_IN_DAYS)
  private Integer pendingWindowInDays;

  public ScheduleKeyDeletionResponse() {
  }

  public ScheduleKeyDeletionResponse keyId(String keyId) {
    this.keyId = keyId;
    return this;
  }
  ...
  public ScheduleKeyDeletionResponse deletionDate(OffsetDateTime deletionDate) {
  ...
  public ScheduleKeyDeletionResponse keyState(KeyState keyState) {
  ...
  public ScheduleKeyDeletionResponse pendingWindowInDays(Integer pendingWindowInDays) {
  ...
  public boolean equals(Object o) {
    ...
    ScheduleKeyDeletionResponse scheduleKeyDeletionResponse = (ScheduleKeyDeletionResponse) o;
    return Objects.equals(this.keyId, scheduleKeyDeletionResponse.keyId) &&
        Objects.equals(this.deletionDate, scheduleKeyDeletionResponse.deletionDate) &&
        Objects.equals(this.keyState, scheduleKeyDeletionResponse.keyState) &&
        Objects.equals(this.pendingWindowInDays, scheduleKeyDeletionResponse.pendingWindowInDays);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keyId, deletionDate, keyState, pendingWindowInDays);
  }
  ...
  static {
    ...
    openapiFields.add("PendingWindowInDays");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScheduleKeyDeletionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScheduleKeyDeletionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScheduleKeyDeletionResponse is not found in the empty JSON string", ScheduleKeyDeletionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScheduleKeyDeletionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScheduleKeyDeletionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `PendingWindowInDays`
      if (jsonObj.get("PendingWindowInDays") != null && !jsonObj.get("PendingWindowInDays").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("PendingWindowInDays"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScheduleKeyDeletionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScheduleKeyDeletionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScheduleKeyDeletionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScheduleKeyDeletionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ScheduleKeyDeletionResponse>() {
           @Override
           public void write(JsonWriter out, ScheduleKeyDeletionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScheduleKeyDeletionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ScheduleKeyDeletionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScheduleKeyDeletionResponse
   * @throws IOException if the JSON string is invalid with respect to ScheduleKeyDeletionResponse
   */
  public static ScheduleKeyDeletionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScheduleKeyDeletionResponse.class);
  }

  /**
   * Convert an instance of ScheduleKeyDeletionResponse to an JSON string
   *
   * @return JSON string
   */
