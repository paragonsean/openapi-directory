...
public class ScheduleKeyDeletionRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(keyId, pendingWindowInDays);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScheduleKeyDeletionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScheduleKeyDeletionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScheduleKeyDeletionRequest is not found in the empty JSON string", ScheduleKeyDeletionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScheduleKeyDeletionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScheduleKeyDeletionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ScheduleKeyDeletionRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScheduleKeyDeletionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScheduleKeyDeletionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScheduleKeyDeletionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScheduleKeyDeletionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ScheduleKeyDeletionRequest>() {
           @Override
           public void write(JsonWriter out, ScheduleKeyDeletionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScheduleKeyDeletionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ScheduleKeyDeletionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScheduleKeyDeletionRequest
   * @throws IOException if the JSON string is invalid with respect to ScheduleKeyDeletionRequest
   */
  public static ScheduleKeyDeletionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScheduleKeyDeletionRequest.class);
  }

  /**
   * Convert an instance of ScheduleKeyDeletionRequest to an JSON string
   *
   * @return JSON string
   */
