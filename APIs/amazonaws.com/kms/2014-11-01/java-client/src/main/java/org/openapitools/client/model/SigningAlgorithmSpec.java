...
/**
 * Gets or Sets SigningAlgorithmSpec
 */
@JsonAdapter(SigningAlgorithmSpec.Adapter.class)
public enum SigningAlgorithmSpec {
  ...
  SigningAlgorithmSpec(String value) {
    this.value = value;
  }
  ...
  public static SigningAlgorithmSpec fromValue(String value) {
    for (SigningAlgorithmSpec b : SigningAlgorithmSpec.values()) {
  ...
  public static class Adapter extends TypeAdapter<SigningAlgorithmSpec> {
    @Override
    public void write(final JsonWriter jsonWriter, final SigningAlgorithmSpec enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SigningAlgorithmSpec read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SigningAlgorithmSpec.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    SigningAlgorithmSpec.fromValue(value);
  }
}
