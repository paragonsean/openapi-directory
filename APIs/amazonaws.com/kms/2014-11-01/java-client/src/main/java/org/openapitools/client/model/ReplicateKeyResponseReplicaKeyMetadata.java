...
public class ReplicateKeyResponseReplicaKeyMetadata {
  ...
  public ReplicateKeyResponseReplicaKeyMetadata() {
  }

  public ReplicateKeyResponseReplicaKeyMetadata awSAccountId(String awSAccountId) {
  ...
  public ReplicateKeyResponseReplicaKeyMetadata keyId(String keyId) {
    this.keyId = keyId;
    return this;
  }
  ...
  public ReplicateKeyResponseReplicaKeyMetadata arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public ReplicateKeyResponseReplicaKeyMetadata creationDate(OffsetDateTime creationDate) {
  ...
  public ReplicateKeyResponseReplicaKeyMetadata enabled(Boolean enabled) {
  ...
  public ReplicateKeyResponseReplicaKeyMetadata description(String description) {
  ...
  public ReplicateKeyResponseReplicaKeyMetadata keyUsage(KeyUsageType keyUsage) {
  ...
  public ReplicateKeyResponseReplicaKeyMetadata keyState(KeyState keyState) {
  ...
  public ReplicateKeyResponseReplicaKeyMetadata deletionDate(OffsetDateTime deletionDate) {
  ...
  public ReplicateKeyResponseReplicaKeyMetadata validTo(OffsetDateTime validTo) {
  ...
  public ReplicateKeyResponseReplicaKeyMetadata origin(OriginType origin) {
    this.origin = origin;
    return this;
  }
  ...
  public ReplicateKeyResponseReplicaKeyMetadata customKeyStoreId(String customKeyStoreId) {
  ...
  public ReplicateKeyResponseReplicaKeyMetadata cloudHsmClusterId(String cloudHsmClusterId) {
  ...
  public ReplicateKeyResponseReplicaKeyMetadata expirationModel(ExpirationModelType expirationModel) {
  ...
  public ReplicateKeyResponseReplicaKeyMetadata keyManager(KeyManagerType keyManager) {
  ...
  public ReplicateKeyResponseReplicaKeyMetadata customerMasterKeySpec(CustomerMasterKeySpec customerMasterKeySpec) {
  ...
  public ReplicateKeyResponseReplicaKeyMetadata keySpec(KeySpec keySpec) {
  ...
  public ReplicateKeyResponseReplicaKeyMetadata encryptionAlgorithms(List encryptionAlgorithms) {
  ...
  public ReplicateKeyResponseReplicaKeyMetadata signingAlgorithms(List signingAlgorithms) {
  ...
  public ReplicateKeyResponseReplicaKeyMetadata multiRegion(Boolean multiRegion) {
  ...
  public ReplicateKeyResponseReplicaKeyMetadata multiRegionConfiguration(KeyMetadataMultiRegionConfiguration multiRegionConfiguration) {
  ...
  public ReplicateKeyResponseReplicaKeyMetadata pendingDeletionWindowInDays(Integer pendingDeletionWindowInDays) {
  ...
  public ReplicateKeyResponseReplicaKeyMetadata macAlgorithms(List macAlgorithms) {
  ...
  public ReplicateKeyResponseReplicaKeyMetadata xksKeyConfiguration(KeyMetadataXksKeyConfiguration xksKeyConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    ReplicateKeyResponseReplicaKeyMetadata replicateKeyResponseReplicaKeyMetadata = (ReplicateKeyResponseReplicaKeyMetadata) o;
    return Objects.equals(this.awSAccountId, replicateKeyResponseReplicaKeyMetadata.awSAccountId) &&
        Objects.equals(this.keyId, replicateKeyResponseReplicaKeyMetadata.keyId) &&
        Objects.equals(this.arn, replicateKeyResponseReplicaKeyMetadata.arn) &&
        Objects.equals(this.creationDate, replicateKeyResponseReplicaKeyMetadata.creationDate) &&
        Objects.equals(this.enabled, replicateKeyResponseReplicaKeyMetadata.enabled) &&
        Objects.equals(this.description, replicateKeyResponseReplicaKeyMetadata.description) &&
        Objects.equals(this.keyUsage, replicateKeyResponseReplicaKeyMetadata.keyUsage) &&
        Objects.equals(this.keyState, replicateKeyResponseReplicaKeyMetadata.keyState) &&
        Objects.equals(this.deletionDate, replicateKeyResponseReplicaKeyMetadata.deletionDate) &&
        Objects.equals(this.validTo, replicateKeyResponseReplicaKeyMetadata.validTo) &&
        Objects.equals(this.origin, replicateKeyResponseReplicaKeyMetadata.origin) &&
        Objects.equals(this.customKeyStoreId, replicateKeyResponseReplicaKeyMetadata.customKeyStoreId) &&
        Objects.equals(this.cloudHsmClusterId, replicateKeyResponseReplicaKeyMetadata.cloudHsmClusterId) &&
        Objects.equals(this.expirationModel, replicateKeyResponseReplicaKeyMetadata.expirationModel) &&
        Objects.equals(this.keyManager, replicateKeyResponseReplicaKeyMetadata.keyManager) &&
        Objects.equals(this.customerMasterKeySpec, replicateKeyResponseReplicaKeyMetadata.customerMasterKeySpec) &&
        Objects.equals(this.keySpec, replicateKeyResponseReplicaKeyMetadata.keySpec) &&
        Objects.equals(this.encryptionAlgorithms, replicateKeyResponseReplicaKeyMetadata.encryptionAlgorithms) &&
        Objects.equals(this.signingAlgorithms, replicateKeyResponseReplicaKeyMetadata.signingAlgorithms) &&
        Objects.equals(this.multiRegion, replicateKeyResponseReplicaKeyMetadata.multiRegion) &&
        Objects.equals(this.multiRegionConfiguration, replicateKeyResponseReplicaKeyMetadata.multiRegionConfiguration) &&
        Objects.equals(this.pendingDeletionWindowInDays, replicateKeyResponseReplicaKeyMetadata.pendingDeletionWindowInDays) &&
        Objects.equals(this.macAlgorithms, replicateKeyResponseReplicaKeyMetadata.macAlgorithms) &&
        Objects.equals(this.xksKeyConfiguration, replicateKeyResponseReplicaKeyMetadata.xksKeyConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReplicateKeyResponseReplicaKeyMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReplicateKeyResponseReplicaKeyMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReplicateKeyResponseReplicaKeyMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReplicateKeyResponseReplicaKeyMetadata is not found in the empty JSON string", ReplicateKeyResponseReplicaKeyMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReplicateKeyResponseReplicaKeyMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReplicateKeyResponseReplicaKeyMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReplicateKeyResponseReplicaKeyMetadata.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReplicateKeyResponseReplicaKeyMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReplicateKeyResponseReplicaKeyMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReplicateKeyResponseReplicaKeyMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReplicateKeyResponseReplicaKeyMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<ReplicateKeyResponseReplicaKeyMetadata>() {
           @Override
           public void write(JsonWriter out, ReplicateKeyResponseReplicaKeyMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReplicateKeyResponseReplicaKeyMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReplicateKeyResponseReplicaKeyMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReplicateKeyResponseReplicaKeyMetadata
   * @throws IOException if the JSON string is invalid with respect to ReplicateKeyResponseReplicaKeyMetadata
   */
  public static ReplicateKeyResponseReplicaKeyMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReplicateKeyResponseReplicaKeyMetadata.class);
  }

  /**
   * Convert an instance of ReplicateKeyResponseReplicaKeyMetadata to an JSON string
   *
   * @return JSON string
   */
