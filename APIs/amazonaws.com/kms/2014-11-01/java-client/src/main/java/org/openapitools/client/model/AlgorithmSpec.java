...
/**
 * Gets or Sets AlgorithmSpec
 */
@JsonAdapter(AlgorithmSpec.Adapter.class)
public enum AlgorithmSpec {
  ...
  public static AlgorithmSpec fromValue(String value) {
    for (AlgorithmSpec b : AlgorithmSpec.values()) {
  ...
  public static class Adapter extends TypeAdapter<AlgorithmSpec> {
    @Override
    public void write(final JsonWriter jsonWriter, final AlgorithmSpec enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AlgorithmSpec read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AlgorithmSpec.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AlgorithmSpec.fromValue(value);
  }
}
