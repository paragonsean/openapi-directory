...
public class GenerateDataKeyPairWithoutPlaintextRequest {
  ...
  public GenerateDataKeyPairWithoutPlaintextRequest encryptionContext(Map encryptionContext) {
  ...
  public GenerateDataKeyPairWithoutPlaintextRequest keyId(String keyId) {
    this.keyId = keyId;
    return this;
  }
  ...
  public GenerateDataKeyPairWithoutPlaintextRequest keyPairSpec(DataKeyPairSpec keyPairSpec) {
  ...
  public GenerateDataKeyPairWithoutPlaintextRequest grantTokens(List grantTokens) {
  ...
  public GenerateDataKeyPairWithoutPlaintextRequest dryRun(Boolean dryRun) {
    this.dryRun = dryRun;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GenerateDataKeyPairWithoutPlaintextRequest generateDataKeyPairWithoutPlaintextRequest = (GenerateDataKeyPairWithoutPlaintextRequest) o;
    return Objects.equals(this.encryptionContext, generateDataKeyPairWithoutPlaintextRequest.encryptionContext) &&
        Objects.equals(this.keyId, generateDataKeyPairWithoutPlaintextRequest.keyId) &&
        Objects.equals(this.keyPairSpec, generateDataKeyPairWithoutPlaintextRequest.keyPairSpec) &&
        Objects.equals(this.grantTokens, generateDataKeyPairWithoutPlaintextRequest.grantTokens) &&
        Objects.equals(this.dryRun, generateDataKeyPairWithoutPlaintextRequest.dryRun);
  }

  @Override
  public int hashCode() {
    return Objects.hash(encryptionContext, keyId, keyPairSpec, grantTokens, dryRun);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GenerateDataKeyPairWithoutPlaintextRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("KeyPairSpec");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GenerateDataKeyPairWithoutPlaintextRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GenerateDataKeyPairWithoutPlaintextRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenerateDataKeyPairWithoutPlaintextRequest is not found in the empty JSON string", GenerateDataKeyPairWithoutPlaintextRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GenerateDataKeyPairWithoutPlaintextRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenerateDataKeyPairWithoutPlaintextRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GenerateDataKeyPairWithoutPlaintextRequest.openapiRequiredFields) {
      ...
      // validate the required field `KeyPairSpec`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenerateDataKeyPairWithoutPlaintextRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenerateDataKeyPairWithoutPlaintextRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenerateDataKeyPairWithoutPlaintextRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenerateDataKeyPairWithoutPlaintextRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GenerateDataKeyPairWithoutPlaintextRequest>() {
           @Override
           public void write(JsonWriter out, GenerateDataKeyPairWithoutPlaintextRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GenerateDataKeyPairWithoutPlaintextRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GenerateDataKeyPairWithoutPlaintextRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GenerateDataKeyPairWithoutPlaintextRequest
   * @throws IOException if the JSON string is invalid with respect to GenerateDataKeyPairWithoutPlaintextRequest
   */
  public static GenerateDataKeyPairWithoutPlaintextRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateDataKeyPairWithoutPlaintextRequest.class);
  }

  /**
   * Convert an instance of GenerateDataKeyPairWithoutPlaintextRequest to an JSON string
   *
   * @return JSON string
   */
