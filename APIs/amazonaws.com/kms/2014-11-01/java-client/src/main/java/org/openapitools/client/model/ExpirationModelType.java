...
/**
 * Gets or Sets ExpirationModelType
 */
@JsonAdapter(ExpirationModelType.Adapter.class)
public enum ExpirationModelType {
  
  EXPIRES("KEY_MATERIAL_EXPIRES"),
  
  DOES_NOT_EXPIRE("KEY_MATERIAL_DOES_NOT_EXPIRE");

  private String value;

  ExpirationModelType(String value) {
    this.value = value;
  }
  ...
  public static ExpirationModelType fromValue(String value) {
    for (ExpirationModelType b : ExpirationModelType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ExpirationModelType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ExpirationModelType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ExpirationModelType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ExpirationModelType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ExpirationModelType.fromValue(value);
  }
}
