...
public class AliasListEntry {
  ...
  public AliasListEntry aliasName(String aliasName) {
  ...
  public AliasListEntry aliasArn(String aliasArn) {
  ...
  public AliasListEntry targetKeyId(String targetKeyId) {
  ...
  public AliasListEntry creationDate(OffsetDateTime creationDate) {
  ...
  public AliasListEntry lastUpdatedDate(OffsetDateTime lastUpdatedDate) {
  ...
  public boolean equals(Object o) {
    ...
    AliasListEntry aliasListEntry = (AliasListEntry) o;
    return Objects.equals(this.aliasName, aliasListEntry.aliasName) &&
        Objects.equals(this.aliasArn, aliasListEntry.aliasArn) &&
        Objects.equals(this.targetKeyId, aliasListEntry.targetKeyId) &&
        Objects.equals(this.creationDate, aliasListEntry.creationDate) &&
        Objects.equals(this.lastUpdatedDate, aliasListEntry.lastUpdatedDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aliasName, aliasArn, targetKeyId, creationDate, lastUpdatedDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AliasListEntry {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AliasListEntry
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AliasListEntry.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AliasListEntry is not found in the empty JSON string", AliasListEntry.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AliasListEntry.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AliasListEntry` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `AliasName`
      if (jsonObj.get("AliasName") != null && !jsonObj.get("AliasName").isJsonNull()) {
      ...
      if (jsonObj.get("TargetKeyId") != null && !jsonObj.get("TargetKeyId").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AliasListEntry.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AliasListEntry' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AliasListEntry> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AliasListEntry.class));

       return (TypeAdapter<T>) new TypeAdapter<AliasListEntry>() {
           @Override
           public void write(JsonWriter out, AliasListEntry value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AliasListEntry read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AliasListEntry given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AliasListEntry
   * @throws IOException if the JSON string is invalid with respect to AliasListEntry
   */
  public static AliasListEntry fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AliasListEntry.class);
  }

  /**
   * Convert an instance of AliasListEntry to an JSON string
   *
   * @return JSON string
   */
