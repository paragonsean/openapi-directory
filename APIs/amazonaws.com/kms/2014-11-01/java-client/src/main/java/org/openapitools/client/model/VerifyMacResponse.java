...
public class VerifyMacResponse {
  ...
  public static final String SERIALIZED_NAME_MAC_VALID = "MacValid";
  @SerializedName(SERIALIZED_NAME_MAC_VALID)
  ...
  public VerifyMacResponse macAlgorithm(MacAlgorithmSpec macAlgorithm) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keyId, verifyMacResponse.keyId) &&
        ...
        Objects.equals(this.macAlgorithm, verifyMacResponse.macAlgorithm);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keyId, macValid, macAlgorithm);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to VerifyMacResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VerifyMacResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VerifyMacResponse is not found in the empty JSON string", VerifyMacResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VerifyMacResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VerifyMacResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("MacValid") != null && !jsonObj.get("MacValid").isJsonNull()) {
        Boolean.validateJsonElement(jsonObj.get("MacValid"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VerifyMacResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VerifyMacResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VerifyMacResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VerifyMacResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<VerifyMacResponse>() {
           @Override
           public void write(JsonWriter out, VerifyMacResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VerifyMacResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VerifyMacResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VerifyMacResponse
   * @throws IOException if the JSON string is invalid with respect to VerifyMacResponse
   */
  public static VerifyMacResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VerifyMacResponse.class);
  }

  /**
   * Convert an instance of VerifyMacResponse to an JSON string
   *
   * @return JSON string
   */
