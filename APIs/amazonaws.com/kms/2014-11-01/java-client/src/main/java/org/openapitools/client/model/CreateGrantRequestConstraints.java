...
public class CreateGrantRequestConstraints {
  ...
  public CreateGrantRequestConstraints() {
  }

  public CreateGrantRequestConstraints encryptionContextSubset(Map encryptionContextSubset) {
  ...
  public CreateGrantRequestConstraints encryptionContextEquals(Map encryptionContextEquals) {
  ...
  public boolean equals(Object o) {
    ...
    CreateGrantRequestConstraints createGrantRequestConstraints = (CreateGrantRequestConstraints) o;
    return Objects.equals(this.encryptionContextSubset, createGrantRequestConstraints.encryptionContextSubset) &&
        Objects.equals(this.encryptionContextEquals, createGrantRequestConstraints.encryptionContextEquals);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateGrantRequestConstraints {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateGrantRequestConstraints
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateGrantRequestConstraints.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateGrantRequestConstraints is not found in the empty JSON string", CreateGrantRequestConstraints.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateGrantRequestConstraints.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateGrantRequestConstraints` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateGrantRequestConstraints.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateGrantRequestConstraints' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateGrantRequestConstraints> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateGrantRequestConstraints.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateGrantRequestConstraints>() {
           @Override
           public void write(JsonWriter out, CreateGrantRequestConstraints value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateGrantRequestConstraints read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateGrantRequestConstraints given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateGrantRequestConstraints
   * @throws IOException if the JSON string is invalid with respect to CreateGrantRequestConstraints
   */
  public static CreateGrantRequestConstraints fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateGrantRequestConstraints.class);
  }

  /**
   * Convert an instance of CreateGrantRequestConstraints to an JSON string
   *
   * @return JSON string
   */
