...
public class ApiClient {
    ...
    private String basePath = "http://kms.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2014-11-01/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://kms.us-east-1.amazonaws.com
