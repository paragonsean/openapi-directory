...
public class CustomKeyStoresListEntryXksProxyConfiguration {
  ...
  public CustomKeyStoresListEntryXksProxyConfiguration() {
  }

  public CustomKeyStoresListEntryXksProxyConfiguration connectivity(XksProxyConnectivityType connectivity) {
  ...
  public CustomKeyStoresListEntryXksProxyConfiguration accessKeyId(String accessKeyId) {
  ...
  public CustomKeyStoresListEntryXksProxyConfiguration uriEndpoint(String uriEndpoint) {
  ...
  public CustomKeyStoresListEntryXksProxyConfiguration uriPath(String uriPath) {
  ...
  public CustomKeyStoresListEntryXksProxyConfiguration vpcEndpointServiceName(String vpcEndpointServiceName) {
  ...
  public boolean equals(Object o) {
    ...
    CustomKeyStoresListEntryXksProxyConfiguration customKeyStoresListEntryXksProxyConfiguration = (CustomKeyStoresListEntryXksProxyConfiguration) o;
    return Objects.equals(this.connectivity, customKeyStoresListEntryXksProxyConfiguration.connectivity) &&
        Objects.equals(this.accessKeyId, customKeyStoresListEntryXksProxyConfiguration.accessKeyId) &&
        Objects.equals(this.uriEndpoint, customKeyStoresListEntryXksProxyConfiguration.uriEndpoint) &&
        Objects.equals(this.uriPath, customKeyStoresListEntryXksProxyConfiguration.uriPath) &&
        Objects.equals(this.vpcEndpointServiceName, customKeyStoresListEntryXksProxyConfiguration.vpcEndpointServiceName);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomKeyStoresListEntryXksProxyConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CustomKeyStoresListEntryXksProxyConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomKeyStoresListEntryXksProxyConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustomKeyStoresListEntryXksProxyConfiguration is not found in the empty JSON string", CustomKeyStoresListEntryXksProxyConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomKeyStoresListEntryXksProxyConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomKeyStoresListEntryXksProxyConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomKeyStoresListEntryXksProxyConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomKeyStoresListEntryXksProxyConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomKeyStoresListEntryXksProxyConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomKeyStoresListEntryXksProxyConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomKeyStoresListEntryXksProxyConfiguration>() {
           @Override
           public void write(JsonWriter out, CustomKeyStoresListEntryXksProxyConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CustomKeyStoresListEntryXksProxyConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CustomKeyStoresListEntryXksProxyConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CustomKeyStoresListEntryXksProxyConfiguration
   * @throws IOException if the JSON string is invalid with respect to CustomKeyStoresListEntryXksProxyConfiguration
   */
  public static CustomKeyStoresListEntryXksProxyConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustomKeyStoresListEntryXksProxyConfiguration.class);
  }

  /**
   * Convert an instance of CustomKeyStoresListEntryXksProxyConfiguration to an JSON string
   *
   * @return JSON string
   */
