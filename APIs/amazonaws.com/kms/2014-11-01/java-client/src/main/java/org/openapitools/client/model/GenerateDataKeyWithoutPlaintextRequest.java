...
public class GenerateDataKeyWithoutPlaintextRequest {
  ...
  public GenerateDataKeyWithoutPlaintextRequest keyId(String keyId) {
    this.keyId = keyId;
    return this;
  }
  ...
  public GenerateDataKeyWithoutPlaintextRequest encryptionContext(Map encryptionContext) {
  ...
  public GenerateDataKeyWithoutPlaintextRequest keySpec(DataKeySpec keySpec) {
  ...
  public GenerateDataKeyWithoutPlaintextRequest numberOfBytes(Integer numberOfBytes) {
  ...
  public GenerateDataKeyWithoutPlaintextRequest grantTokens(List grantTokens) {
  ...
  public GenerateDataKeyWithoutPlaintextRequest dryRun(Boolean dryRun) {
    this.dryRun = dryRun;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GenerateDataKeyWithoutPlaintextRequest generateDataKeyWithoutPlaintextRequest = (GenerateDataKeyWithoutPlaintextRequest) o;
    return Objects.equals(this.keyId, generateDataKeyWithoutPlaintextRequest.keyId) &&
        Objects.equals(this.encryptionContext, generateDataKeyWithoutPlaintextRequest.encryptionContext) &&
        Objects.equals(this.keySpec, generateDataKeyWithoutPlaintextRequest.keySpec) &&
        Objects.equals(this.numberOfBytes, generateDataKeyWithoutPlaintextRequest.numberOfBytes) &&
        Objects.equals(this.grantTokens, generateDataKeyWithoutPlaintextRequest.grantTokens) &&
        Objects.equals(this.dryRun, generateDataKeyWithoutPlaintextRequest.dryRun);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keyId, encryptionContext, keySpec, numberOfBytes, grantTokens, dryRun);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GenerateDataKeyWithoutPlaintextRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GenerateDataKeyWithoutPlaintextRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GenerateDataKeyWithoutPlaintextRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenerateDataKeyWithoutPlaintextRequest is not found in the empty JSON string", GenerateDataKeyWithoutPlaintextRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GenerateDataKeyWithoutPlaintextRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenerateDataKeyWithoutPlaintextRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GenerateDataKeyWithoutPlaintextRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenerateDataKeyWithoutPlaintextRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenerateDataKeyWithoutPlaintextRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenerateDataKeyWithoutPlaintextRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenerateDataKeyWithoutPlaintextRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GenerateDataKeyWithoutPlaintextRequest>() {
           @Override
           public void write(JsonWriter out, GenerateDataKeyWithoutPlaintextRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GenerateDataKeyWithoutPlaintextRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GenerateDataKeyWithoutPlaintextRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GenerateDataKeyWithoutPlaintextRequest
   * @throws IOException if the JSON string is invalid with respect to GenerateDataKeyWithoutPlaintextRequest
   */
  public static GenerateDataKeyWithoutPlaintextRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateDataKeyWithoutPlaintextRequest.class);
  }

  /**
   * Convert an instance of GenerateDataKeyWithoutPlaintextRequest to an JSON string
   *
   * @return JSON string
   */
