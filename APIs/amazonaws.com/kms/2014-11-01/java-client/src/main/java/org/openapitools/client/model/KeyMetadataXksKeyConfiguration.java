...
public class KeyMetadataXksKeyConfiguration {
  public static final String SERIALIZED_NAME_ID = "Id";
  @SerializedName(SERIALIZED_NAME_ID)
  private String id;

  public KeyMetadataXksKeyConfiguration() {
  }

  public KeyMetadataXksKeyConfiguration id(String id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    KeyMetadataXksKeyConfiguration keyMetadataXksKeyConfiguration = (KeyMetadataXksKeyConfiguration) o;
    return Objects.equals(this.id, keyMetadataXksKeyConfiguration.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class KeyMetadataXksKeyConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to KeyMetadataXksKeyConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KeyMetadataXksKeyConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KeyMetadataXksKeyConfiguration is not found in the empty JSON string", KeyMetadataXksKeyConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!KeyMetadataXksKeyConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `KeyMetadataXksKeyConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KeyMetadataXksKeyConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KeyMetadataXksKeyConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KeyMetadataXksKeyConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KeyMetadataXksKeyConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<KeyMetadataXksKeyConfiguration>() {
           @Override
           public void write(JsonWriter out, KeyMetadataXksKeyConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public KeyMetadataXksKeyConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of KeyMetadataXksKeyConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of KeyMetadataXksKeyConfiguration
   * @throws IOException if the JSON string is invalid with respect to KeyMetadataXksKeyConfiguration
   */
  public static KeyMetadataXksKeyConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KeyMetadataXksKeyConfiguration.class);
  }

  /**
   * Convert an instance of KeyMetadataXksKeyConfiguration to an JSON string
   *
   * @return JSON string
   */
