...
public class CancelKeyDeletionRequest {
   ...
   * @throws IOException if the JSON Element is invalid with respect to CancelKeyDeletionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CancelKeyDeletionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CancelKeyDeletionRequest is not found in the empty JSON string", CancelKeyDeletionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CancelKeyDeletionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CancelKeyDeletionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CancelKeyDeletionRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CancelKeyDeletionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CancelKeyDeletionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CancelKeyDeletionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CancelKeyDeletionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CancelKeyDeletionRequest>() {
           @Override
           public void write(JsonWriter out, CancelKeyDeletionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CancelKeyDeletionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CancelKeyDeletionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CancelKeyDeletionRequest
   * @throws IOException if the JSON string is invalid with respect to CancelKeyDeletionRequest
   */
  public static CancelKeyDeletionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CancelKeyDeletionRequest.class);
  }

  /**
   * Convert an instance of CancelKeyDeletionRequest to an JSON string
   *
   * @return JSON string
   */
