...
public class ListResourceTagsResponse {
  ...
  public ListResourceTagsResponse tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public ListResourceTagsResponse nextMarker(String nextMarker) {
  ...
  public ListResourceTagsResponse truncated(Boolean truncated) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, listResourceTagsResponse.tags) &&
        Objects.equals(this.nextMarker, listResourceTagsResponse.nextMarker) &&
        Objects.equals(this.truncated, listResourceTagsResponse.truncated);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tags, nextMarker, truncated);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListResourceTagsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListResourceTagsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListResourceTagsResponse is not found in the empty JSON string", ListResourceTagsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListResourceTagsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListResourceTagsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListResourceTagsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListResourceTagsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListResourceTagsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListResourceTagsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListResourceTagsResponse>() {
           @Override
           public void write(JsonWriter out, ListResourceTagsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListResourceTagsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListResourceTagsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListResourceTagsResponse
   * @throws IOException if the JSON string is invalid with respect to ListResourceTagsResponse
   */
  public static ListResourceTagsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListResourceTagsResponse.class);
  }

  /**
   * Convert an instance of ListResourceTagsResponse to an JSON string
   *
   * @return JSON string
   */
