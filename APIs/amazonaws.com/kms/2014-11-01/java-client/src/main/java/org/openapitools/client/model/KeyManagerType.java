...
/**
 * Gets or Sets KeyManagerType
 */
@JsonAdapter(KeyManagerType.Adapter.class)
public enum KeyManagerType {
  ...
  public static KeyManagerType fromValue(String value) {
    for (KeyManagerType b : KeyManagerType.values()) {
  ...
  public static class Adapter extends TypeAdapter<KeyManagerType> {
    @Override
    public void write(final JsonWriter jsonWriter, final KeyManagerType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public KeyManagerType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return KeyManagerType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    KeyManagerType.fromValue(value);
  }
}
