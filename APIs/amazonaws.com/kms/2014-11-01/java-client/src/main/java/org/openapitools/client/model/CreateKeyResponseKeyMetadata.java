...
public class CreateKeyResponseKeyMetadata {
  ...
  public CreateKeyResponseKeyMetadata() {
  }

  public CreateKeyResponseKeyMetadata awSAccountId(String awSAccountId) {
  ...
  public CreateKeyResponseKeyMetadata keyId(String keyId) {
    this.keyId = keyId;
    return this;
  }
  ...
  public CreateKeyResponseKeyMetadata arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public CreateKeyResponseKeyMetadata creationDate(OffsetDateTime creationDate) {
  ...
  public CreateKeyResponseKeyMetadata enabled(Boolean enabled) {
  ...
  public CreateKeyResponseKeyMetadata description(String description) {
  ...
  public CreateKeyResponseKeyMetadata keyUsage(KeyUsageType keyUsage) {
  ...
  public CreateKeyResponseKeyMetadata keyState(KeyState keyState) {
  ...
  public CreateKeyResponseKeyMetadata deletionDate(OffsetDateTime deletionDate) {
  ...
  public CreateKeyResponseKeyMetadata validTo(OffsetDateTime validTo) {
  ...
  public CreateKeyResponseKeyMetadata origin(OriginType origin) {
    this.origin = origin;
    return this;
  }
  ...
  public CreateKeyResponseKeyMetadata customKeyStoreId(String customKeyStoreId) {
  ...
  public CreateKeyResponseKeyMetadata cloudHsmClusterId(String cloudHsmClusterId) {
  ...
  public CreateKeyResponseKeyMetadata expirationModel(ExpirationModelType expirationModel) {
  ...
  public CreateKeyResponseKeyMetadata keyManager(KeyManagerType keyManager) {
  ...
  public CreateKeyResponseKeyMetadata customerMasterKeySpec(CustomerMasterKeySpec customerMasterKeySpec) {
  ...
  public CreateKeyResponseKeyMetadata keySpec(KeySpec keySpec) {
  ...
  public CreateKeyResponseKeyMetadata encryptionAlgorithms(List encryptionAlgorithms) {
  ...
  public CreateKeyResponseKeyMetadata signingAlgorithms(List signingAlgorithms) {
  ...
  public CreateKeyResponseKeyMetadata multiRegion(Boolean multiRegion) {
  ...
  public CreateKeyResponseKeyMetadata multiRegionConfiguration(KeyMetadataMultiRegionConfiguration multiRegionConfiguration) {
  ...
  public CreateKeyResponseKeyMetadata pendingDeletionWindowInDays(Integer pendingDeletionWindowInDays) {
  ...
  public CreateKeyResponseKeyMetadata macAlgorithms(List macAlgorithms) {
  ...
  public CreateKeyResponseKeyMetadata xksKeyConfiguration(KeyMetadataXksKeyConfiguration xksKeyConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    CreateKeyResponseKeyMetadata createKeyResponseKeyMetadata = (CreateKeyResponseKeyMetadata) o;
    return Objects.equals(this.awSAccountId, createKeyResponseKeyMetadata.awSAccountId) &&
        Objects.equals(this.keyId, createKeyResponseKeyMetadata.keyId) &&
        Objects.equals(this.arn, createKeyResponseKeyMetadata.arn) &&
        Objects.equals(this.creationDate, createKeyResponseKeyMetadata.creationDate) &&
        Objects.equals(this.enabled, createKeyResponseKeyMetadata.enabled) &&
        Objects.equals(this.description, createKeyResponseKeyMetadata.description) &&
        Objects.equals(this.keyUsage, createKeyResponseKeyMetadata.keyUsage) &&
        Objects.equals(this.keyState, createKeyResponseKeyMetadata.keyState) &&
        Objects.equals(this.deletionDate, createKeyResponseKeyMetadata.deletionDate) &&
        Objects.equals(this.validTo, createKeyResponseKeyMetadata.validTo) &&
        Objects.equals(this.origin, createKeyResponseKeyMetadata.origin) &&
        Objects.equals(this.customKeyStoreId, createKeyResponseKeyMetadata.customKeyStoreId) &&
        Objects.equals(this.cloudHsmClusterId, createKeyResponseKeyMetadata.cloudHsmClusterId) &&
        Objects.equals(this.expirationModel, createKeyResponseKeyMetadata.expirationModel) &&
        Objects.equals(this.keyManager, createKeyResponseKeyMetadata.keyManager) &&
        Objects.equals(this.customerMasterKeySpec, createKeyResponseKeyMetadata.customerMasterKeySpec) &&
        Objects.equals(this.keySpec, createKeyResponseKeyMetadata.keySpec) &&
        Objects.equals(this.encryptionAlgorithms, createKeyResponseKeyMetadata.encryptionAlgorithms) &&
        Objects.equals(this.signingAlgorithms, createKeyResponseKeyMetadata.signingAlgorithms) &&
        Objects.equals(this.multiRegion, createKeyResponseKeyMetadata.multiRegion) &&
        Objects.equals(this.multiRegionConfiguration, createKeyResponseKeyMetadata.multiRegionConfiguration) &&
        Objects.equals(this.pendingDeletionWindowInDays, createKeyResponseKeyMetadata.pendingDeletionWindowInDays) &&
        Objects.equals(this.macAlgorithms, createKeyResponseKeyMetadata.macAlgorithms) &&
        Objects.equals(this.xksKeyConfiguration, createKeyResponseKeyMetadata.xksKeyConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateKeyResponseKeyMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateKeyResponseKeyMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateKeyResponseKeyMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateKeyResponseKeyMetadata is not found in the empty JSON string", CreateKeyResponseKeyMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateKeyResponseKeyMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateKeyResponseKeyMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateKeyResponseKeyMetadata.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateKeyResponseKeyMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateKeyResponseKeyMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateKeyResponseKeyMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateKeyResponseKeyMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateKeyResponseKeyMetadata>() {
           @Override
           public void write(JsonWriter out, CreateKeyResponseKeyMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateKeyResponseKeyMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateKeyResponseKeyMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateKeyResponseKeyMetadata
   * @throws IOException if the JSON string is invalid with respect to CreateKeyResponseKeyMetadata
   */
  public static CreateKeyResponseKeyMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateKeyResponseKeyMetadata.class);
  }

  /**
   * Convert an instance of CreateKeyResponseKeyMetadata to an JSON string
   *
   * @return JSON string
   */
