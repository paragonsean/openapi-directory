...
public class ListGrantsResponse {
  ...
  public ListGrantsResponse grants(List grants) {
    this.grants = grants;
    return this;
  }
  ...
  public ListGrantsResponse nextMarker(String nextMarker) {
  ...
  public ListGrantsResponse truncated(Boolean truncated) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListGrantsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListGrantsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListGrantsResponse is not found in the empty JSON string", ListGrantsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListGrantsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListGrantsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListGrantsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListGrantsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListGrantsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListGrantsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListGrantsResponse>() {
           @Override
           public void write(JsonWriter out, ListGrantsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListGrantsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListGrantsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListGrantsResponse
   * @throws IOException if the JSON string is invalid with respect to ListGrantsResponse
   */
  public static ListGrantsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListGrantsResponse.class);
  }

  /**
   * Convert an instance of ListGrantsResponse to an JSON string
   *
   * @return JSON string
   */
