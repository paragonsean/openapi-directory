 ...
 */
@JsonAdapter(CustomerMasterKeySpec.Adapter.class)
public enum CustomerMasterKeySpec {
  ...
  CustomerMasterKeySpec(String value) {
    this.value = value;
  }
  ...
  public static CustomerMasterKeySpec fromValue(String value) {
    for (CustomerMasterKeySpec b : CustomerMasterKeySpec.values()) {
  ...
  public static class Adapter extends TypeAdapter<CustomerMasterKeySpec> {
    @Override
    public void write(final JsonWriter jsonWriter, final CustomerMasterKeySpec enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CustomerMasterKeySpec read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CustomerMasterKeySpec.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    CustomerMasterKeySpec.fromValue(value);
  }
}
