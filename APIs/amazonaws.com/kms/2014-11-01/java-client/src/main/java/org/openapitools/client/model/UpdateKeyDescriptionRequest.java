...
public class UpdateKeyDescriptionRequest {
  ...
  public UpdateKeyDescriptionRequest description(String description) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keyId, updateKeyDescriptionRequest.keyId) &&
        Objects.equals(this.description, updateKeyDescriptionRequest.description);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keyId, description);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateKeyDescriptionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateKeyDescriptionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateKeyDescriptionRequest is not found in the empty JSON string", UpdateKeyDescriptionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateKeyDescriptionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateKeyDescriptionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateKeyDescriptionRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateKeyDescriptionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateKeyDescriptionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateKeyDescriptionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateKeyDescriptionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateKeyDescriptionRequest>() {
           @Override
           public void write(JsonWriter out, UpdateKeyDescriptionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateKeyDescriptionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateKeyDescriptionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateKeyDescriptionRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateKeyDescriptionRequest
   */
  public static UpdateKeyDescriptionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateKeyDescriptionRequest.class);
  }

  /**
   * Convert an instance of UpdateKeyDescriptionRequest to an JSON string
   *
   * @return JSON string
   */
