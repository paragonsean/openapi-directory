...
public class GenerateDataKeyPairWithoutPlaintextResponse {
  ...
  public GenerateDataKeyPairWithoutPlaintextResponse privateKeyCiphertextBlob(String privateKeyCiphertextBlob) {
  ...
  public GenerateDataKeyPairWithoutPlaintextResponse publicKey(String publicKey) {
  ...
  public GenerateDataKeyPairWithoutPlaintextResponse keyId(String keyId) {
    this.keyId = keyId;
    return this;
  }
  ...
  public GenerateDataKeyPairWithoutPlaintextResponse keyPairSpec(DataKeyPairSpec keyPairSpec) {
  ...
  public boolean equals(Object o) {
    ...
    GenerateDataKeyPairWithoutPlaintextResponse generateDataKeyPairWithoutPlaintextResponse = (GenerateDataKeyPairWithoutPlaintextResponse) o;
    return Objects.equals(this.privateKeyCiphertextBlob, generateDataKeyPairWithoutPlaintextResponse.privateKeyCiphertextBlob) &&
        Objects.equals(this.publicKey, generateDataKeyPairWithoutPlaintextResponse.publicKey) &&
        Objects.equals(this.keyId, generateDataKeyPairWithoutPlaintextResponse.keyId) &&
        Objects.equals(this.keyPairSpec, generateDataKeyPairWithoutPlaintextResponse.keyPairSpec);
  }

  @Override
  public int hashCode() {
    return Objects.hash(privateKeyCiphertextBlob, publicKey, keyId, keyPairSpec);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GenerateDataKeyPairWithoutPlaintextResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GenerateDataKeyPairWithoutPlaintextResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GenerateDataKeyPairWithoutPlaintextResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenerateDataKeyPairWithoutPlaintextResponse is not found in the empty JSON string", GenerateDataKeyPairWithoutPlaintextResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GenerateDataKeyPairWithoutPlaintextResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenerateDataKeyPairWithoutPlaintextResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenerateDataKeyPairWithoutPlaintextResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenerateDataKeyPairWithoutPlaintextResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenerateDataKeyPairWithoutPlaintextResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenerateDataKeyPairWithoutPlaintextResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GenerateDataKeyPairWithoutPlaintextResponse>() {
           @Override
           public void write(JsonWriter out, GenerateDataKeyPairWithoutPlaintextResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GenerateDataKeyPairWithoutPlaintextResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GenerateDataKeyPairWithoutPlaintextResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GenerateDataKeyPairWithoutPlaintextResponse
   * @throws IOException if the JSON string is invalid with respect to GenerateDataKeyPairWithoutPlaintextResponse
   */
  public static GenerateDataKeyPairWithoutPlaintextResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateDataKeyPairWithoutPlaintextResponse.class);
  }

  /**
   * Convert an instance of GenerateDataKeyPairWithoutPlaintextResponse to an JSON string
   *
   * @return JSON string
   */
