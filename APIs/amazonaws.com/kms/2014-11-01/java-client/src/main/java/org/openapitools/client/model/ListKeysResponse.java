...
public class ListKeysResponse {
  ...
  public ListKeysResponse keys(List keys) {
    this.keys = keys;
    return this;
  }
  ...
  public ListKeysResponse nextMarker(String nextMarker) {
  ...
  public ListKeysResponse truncated(Boolean truncated) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(keys, nextMarker, truncated);
  }
