...
public class UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential {
  ...
  public UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential() {
  }

  public UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential accessKeyId(String accessKeyId) {
  ...
  public UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential rawSecretAccessKey(String rawSecretAccessKey) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential updateCustomKeyStoreRequestXksProxyAuthenticationCredential = (UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential) o;
    return Objects.equals(this.accessKeyId, updateCustomKeyStoreRequestXksProxyAuthenticationCredential.accessKeyId) &&
        Objects.equals(this.rawSecretAccessKey, updateCustomKeyStoreRequestXksProxyAuthenticationCredential.rawSecretAccessKey);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential is not found in the empty JSON string", UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential>() {
           @Override
           public void write(JsonWriter out, UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential
   * @throws IOException if the JSON string is invalid with respect to UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential
   */
  public static UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential.class);
  }

  /**
   * Convert an instance of UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential to an JSON string
   *
   * @return JSON string
   */
