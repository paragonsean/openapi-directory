...
public class SignResponse {
  ...
  public SignResponse keyId(String keyId) {
    this.keyId = keyId;
    return this;
  }
  ...
  public SignResponse signature(String signature) {
  ...
  public SignResponse signingAlgorithm(SigningAlgorithmSpec signingAlgorithm) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keyId, signResponse.keyId) &&
        Objects.equals(this.signature, signResponse.signature) &&
        Objects.equals(this.signingAlgorithm, signResponse.signingAlgorithm);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keyId, signature, signingAlgorithm);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SignResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SignResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SignResponse is not found in the empty JSON string", SignResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SignResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SignResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SignResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SignResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SignResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SignResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SignResponse>() {
           @Override
           public void write(JsonWriter out, SignResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SignResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SignResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SignResponse
   * @throws IOException if the JSON string is invalid with respect to SignResponse
   */
  public static SignResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SignResponse.class);
  }

  /**
   * Convert an instance of SignResponse to an JSON string
   *
   * @return JSON string
   */
