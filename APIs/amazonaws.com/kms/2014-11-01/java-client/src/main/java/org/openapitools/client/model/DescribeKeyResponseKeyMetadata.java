...
public class DescribeKeyResponseKeyMetadata {
  ...
  public DescribeKeyResponseKeyMetadata() {
  }

  public DescribeKeyResponseKeyMetadata awSAccountId(String awSAccountId) {
  ...
  public DescribeKeyResponseKeyMetadata keyId(String keyId) {
    this.keyId = keyId;
    return this;
  }
  ...
  public DescribeKeyResponseKeyMetadata arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public DescribeKeyResponseKeyMetadata creationDate(OffsetDateTime creationDate) {
  ...
  public DescribeKeyResponseKeyMetadata enabled(Boolean enabled) {
  ...
  public DescribeKeyResponseKeyMetadata description(String description) {
  ...
  public DescribeKeyResponseKeyMetadata keyUsage(KeyUsageType keyUsage) {
  ...
  public DescribeKeyResponseKeyMetadata keyState(KeyState keyState) {
  ...
  public DescribeKeyResponseKeyMetadata deletionDate(OffsetDateTime deletionDate) {
  ...
  public DescribeKeyResponseKeyMetadata validTo(OffsetDateTime validTo) {
  ...
  public DescribeKeyResponseKeyMetadata origin(OriginType origin) {
    this.origin = origin;
    return this;
  }
  ...
  public DescribeKeyResponseKeyMetadata customKeyStoreId(String customKeyStoreId) {
  ...
  public DescribeKeyResponseKeyMetadata cloudHsmClusterId(String cloudHsmClusterId) {
  ...
  public DescribeKeyResponseKeyMetadata expirationModel(ExpirationModelType expirationModel) {
  ...
  public DescribeKeyResponseKeyMetadata keyManager(KeyManagerType keyManager) {
  ...
  public DescribeKeyResponseKeyMetadata customerMasterKeySpec(CustomerMasterKeySpec customerMasterKeySpec) {
  ...
  public DescribeKeyResponseKeyMetadata keySpec(KeySpec keySpec) {
  ...
  public DescribeKeyResponseKeyMetadata encryptionAlgorithms(List encryptionAlgorithms) {
  ...
  public DescribeKeyResponseKeyMetadata signingAlgorithms(List signingAlgorithms) {
  ...
  public DescribeKeyResponseKeyMetadata multiRegion(Boolean multiRegion) {
  ...
  public DescribeKeyResponseKeyMetadata multiRegionConfiguration(KeyMetadataMultiRegionConfiguration multiRegionConfiguration) {
  ...
  public DescribeKeyResponseKeyMetadata pendingDeletionWindowInDays(Integer pendingDeletionWindowInDays) {
  ...
  public DescribeKeyResponseKeyMetadata macAlgorithms(List macAlgorithms) {
  ...
  public DescribeKeyResponseKeyMetadata xksKeyConfiguration(KeyMetadataXksKeyConfiguration xksKeyConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeKeyResponseKeyMetadata describeKeyResponseKeyMetadata = (DescribeKeyResponseKeyMetadata) o;
    return Objects.equals(this.awSAccountId, describeKeyResponseKeyMetadata.awSAccountId) &&
        Objects.equals(this.keyId, describeKeyResponseKeyMetadata.keyId) &&
        Objects.equals(this.arn, describeKeyResponseKeyMetadata.arn) &&
        Objects.equals(this.creationDate, describeKeyResponseKeyMetadata.creationDate) &&
        Objects.equals(this.enabled, describeKeyResponseKeyMetadata.enabled) &&
        Objects.equals(this.description, describeKeyResponseKeyMetadata.description) &&
        Objects.equals(this.keyUsage, describeKeyResponseKeyMetadata.keyUsage) &&
        Objects.equals(this.keyState, describeKeyResponseKeyMetadata.keyState) &&
        Objects.equals(this.deletionDate, describeKeyResponseKeyMetadata.deletionDate) &&
        Objects.equals(this.validTo, describeKeyResponseKeyMetadata.validTo) &&
        Objects.equals(this.origin, describeKeyResponseKeyMetadata.origin) &&
        Objects.equals(this.customKeyStoreId, describeKeyResponseKeyMetadata.customKeyStoreId) &&
        Objects.equals(this.cloudHsmClusterId, describeKeyResponseKeyMetadata.cloudHsmClusterId) &&
        Objects.equals(this.expirationModel, describeKeyResponseKeyMetadata.expirationModel) &&
        Objects.equals(this.keyManager, describeKeyResponseKeyMetadata.keyManager) &&
        Objects.equals(this.customerMasterKeySpec, describeKeyResponseKeyMetadata.customerMasterKeySpec) &&
        Objects.equals(this.keySpec, describeKeyResponseKeyMetadata.keySpec) &&
        Objects.equals(this.encryptionAlgorithms, describeKeyResponseKeyMetadata.encryptionAlgorithms) &&
        Objects.equals(this.signingAlgorithms, describeKeyResponseKeyMetadata.signingAlgorithms) &&
        Objects.equals(this.multiRegion, describeKeyResponseKeyMetadata.multiRegion) &&
        Objects.equals(this.multiRegionConfiguration, describeKeyResponseKeyMetadata.multiRegionConfiguration) &&
        Objects.equals(this.pendingDeletionWindowInDays, describeKeyResponseKeyMetadata.pendingDeletionWindowInDays) &&
        Objects.equals(this.macAlgorithms, describeKeyResponseKeyMetadata.macAlgorithms) &&
        Objects.equals(this.xksKeyConfiguration, describeKeyResponseKeyMetadata.xksKeyConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeKeyResponseKeyMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeKeyResponseKeyMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeKeyResponseKeyMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeKeyResponseKeyMetadata is not found in the empty JSON string", DescribeKeyResponseKeyMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeKeyResponseKeyMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeKeyResponseKeyMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeKeyResponseKeyMetadata.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeKeyResponseKeyMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeKeyResponseKeyMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeKeyResponseKeyMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeKeyResponseKeyMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeKeyResponseKeyMetadata>() {
           @Override
           public void write(JsonWriter out, DescribeKeyResponseKeyMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeKeyResponseKeyMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeKeyResponseKeyMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeKeyResponseKeyMetadata
   * @throws IOException if the JSON string is invalid with respect to DescribeKeyResponseKeyMetadata
   */
  public static DescribeKeyResponseKeyMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeKeyResponseKeyMetadata.class);
  }

  /**
   * Convert an instance of DescribeKeyResponseKeyMetadata to an JSON string
   *
   * @return JSON string
   */
