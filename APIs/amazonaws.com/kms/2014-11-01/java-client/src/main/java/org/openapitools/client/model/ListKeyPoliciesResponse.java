...
public class ListKeyPoliciesResponse {
  ...
  public ListKeyPoliciesResponse policyNames(List policyNames) {
  ...
  public ListKeyPoliciesResponse nextMarker(String nextMarker) {
  ...
  public ListKeyPoliciesResponse truncated(Boolean truncated) {
  ...
  public boolean equals(Object o) {
    ...
    ListKeyPoliciesResponse listKeyPoliciesResponse = (ListKeyPoliciesResponse) o;
    return Objects.equals(this.policyNames, listKeyPoliciesResponse.policyNames) &&
        Objects.equals(this.nextMarker, listKeyPoliciesResponse.nextMarker) &&
        Objects.equals(this.truncated, listKeyPoliciesResponse.truncated);
  }

  @Override
  public int hashCode() {
    return Objects.hash(policyNames, nextMarker, truncated);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListKeyPoliciesResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListKeyPoliciesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListKeyPoliciesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListKeyPoliciesResponse is not found in the empty JSON string", ListKeyPoliciesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListKeyPoliciesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListKeyPoliciesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListKeyPoliciesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListKeyPoliciesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListKeyPoliciesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListKeyPoliciesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListKeyPoliciesResponse>() {
           @Override
           public void write(JsonWriter out, ListKeyPoliciesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListKeyPoliciesResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListKeyPoliciesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListKeyPoliciesResponse
   * @throws IOException if the JSON string is invalid with respect to ListKeyPoliciesResponse
   */
  public static ListKeyPoliciesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListKeyPoliciesResponse.class);
  }

  /**
   * Convert an instance of ListKeyPoliciesResponse to an JSON string
   *
   * @return JSON string
   */
