...
/**
 * Gets or Sets GrantOperation
 */
@JsonAdapter(GrantOperation.Adapter.class)
public enum GrantOperation {
  ...
  public static GrantOperation fromValue(String value) {
    for (GrantOperation b : GrantOperation.values()) {
  ...
  public static class Adapter extends TypeAdapter<GrantOperation> {
    @Override
    public void write(final JsonWriter jsonWriter, final GrantOperation enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public GrantOperation read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return GrantOperation.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    GrantOperation.fromValue(value);
  }
}
