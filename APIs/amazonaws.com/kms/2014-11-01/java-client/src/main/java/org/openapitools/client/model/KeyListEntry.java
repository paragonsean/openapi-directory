...
public class KeyListEntry {
  ...
  public KeyListEntry keyId(String keyId) {
    this.keyId = keyId;
    return this;
  }
  ...
  public KeyListEntry keyArn(String keyArn) {
    this.keyArn = keyArn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    KeyListEntry keyListEntry = (KeyListEntry) o;
    return Objects.equals(this.keyId, keyListEntry.keyId) &&
        Objects.equals(this.keyArn, keyListEntry.keyArn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keyId, keyArn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class KeyListEntry {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to KeyListEntry
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KeyListEntry.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KeyListEntry is not found in the empty JSON string", KeyListEntry.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!KeyListEntry.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `KeyListEntry` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KeyListEntry.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KeyListEntry' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KeyListEntry> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KeyListEntry.class));

       return (TypeAdapter<T>) new TypeAdapter<KeyListEntry>() {
           @Override
           public void write(JsonWriter out, KeyListEntry value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public KeyListEntry read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of KeyListEntry given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of KeyListEntry
   * @throws IOException if the JSON string is invalid with respect to KeyListEntry
   */
  public static KeyListEntry fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KeyListEntry.class);
  }

  /**
   * Convert an instance of KeyListEntry to an JSON string
   *
   * @return JSON string
   */
