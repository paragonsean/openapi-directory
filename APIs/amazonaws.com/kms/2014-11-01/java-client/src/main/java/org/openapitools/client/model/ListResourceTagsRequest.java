...
public class ListResourceTagsRequest {
  ...
  public ListResourceTagsRequest keyId(String keyId) {
    this.keyId = keyId;
    return this;
  }
  ...
  public ListResourceTagsRequest limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public ListResourceTagsRequest marker(String marker) {
    this.marker = marker;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keyId, listResourceTagsRequest.keyId) &&
        Objects.equals(this.limit, listResourceTagsRequest.limit) &&
        Objects.equals(this.marker, listResourceTagsRequest.marker);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListResourceTagsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListResourceTagsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListResourceTagsRequest is not found in the empty JSON string", ListResourceTagsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListResourceTagsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListResourceTagsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListResourceTagsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListResourceTagsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListResourceTagsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListResourceTagsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListResourceTagsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListResourceTagsRequest>() {
           @Override
           public void write(JsonWriter out, ListResourceTagsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListResourceTagsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListResourceTagsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListResourceTagsRequest
   * @throws IOException if the JSON string is invalid with respect to ListResourceTagsRequest
   */
  public static ListResourceTagsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListResourceTagsRequest.class);
  }

  /**
   * Convert an instance of ListResourceTagsRequest to an JSON string
   *
   * @return JSON string
   */
