...
public class ConnectCustomKeyStoreRequest {
  ...
  public ConnectCustomKeyStoreRequest customKeyStoreId(String customKeyStoreId) {
  ...
  public boolean equals(Object o) {
    ...
    ConnectCustomKeyStoreRequest connectCustomKeyStoreRequest = (ConnectCustomKeyStoreRequest) o;
    return Objects.equals(this.customKeyStoreId, connectCustomKeyStoreRequest.customKeyStoreId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConnectCustomKeyStoreRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConnectCustomKeyStoreRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConnectCustomKeyStoreRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConnectCustomKeyStoreRequest is not found in the empty JSON string", ConnectCustomKeyStoreRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConnectCustomKeyStoreRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConnectCustomKeyStoreRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConnectCustomKeyStoreRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConnectCustomKeyStoreRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConnectCustomKeyStoreRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConnectCustomKeyStoreRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConnectCustomKeyStoreRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ConnectCustomKeyStoreRequest>() {
           @Override
           public void write(JsonWriter out, ConnectCustomKeyStoreRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConnectCustomKeyStoreRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConnectCustomKeyStoreRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConnectCustomKeyStoreRequest
   * @throws IOException if the JSON string is invalid with respect to ConnectCustomKeyStoreRequest
   */
  public static ConnectCustomKeyStoreRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConnectCustomKeyStoreRequest.class);
  }

  /**
   * Convert an instance of ConnectCustomKeyStoreRequest to an JSON string
   *
   * @return JSON string
   */
