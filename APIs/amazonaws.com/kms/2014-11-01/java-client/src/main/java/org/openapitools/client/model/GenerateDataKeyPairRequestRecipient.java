...
public class GenerateDataKeyPairRequestRecipient {
  ...
  public GenerateDataKeyPairRequestRecipient() {
  }

  public GenerateDataKeyPairRequestRecipient keyEncryptionAlgorithm(KeyEncryptionMechanism keyEncryptionAlgorithm) {
  ...
  public GenerateDataKeyPairRequestRecipient attestationDocument(String attestationDocument) {
  ...
  public boolean equals(Object o) {
    ...
    GenerateDataKeyPairRequestRecipient generateDataKeyPairRequestRecipient = (GenerateDataKeyPairRequestRecipient) o;
    return Objects.equals(this.keyEncryptionAlgorithm, generateDataKeyPairRequestRecipient.keyEncryptionAlgorithm) &&
        Objects.equals(this.attestationDocument, generateDataKeyPairRequestRecipient.attestationDocument);
  }
  ...
  public String toString() {
    ...
    sb.append("class GenerateDataKeyPairRequestRecipient {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GenerateDataKeyPairRequestRecipient
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GenerateDataKeyPairRequestRecipient.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenerateDataKeyPairRequestRecipient is not found in the empty JSON string", GenerateDataKeyPairRequestRecipient.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GenerateDataKeyPairRequestRecipient.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenerateDataKeyPairRequestRecipient` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenerateDataKeyPairRequestRecipient.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenerateDataKeyPairRequestRecipient' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenerateDataKeyPairRequestRecipient> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenerateDataKeyPairRequestRecipient.class));

       return (TypeAdapter<T>) new TypeAdapter<GenerateDataKeyPairRequestRecipient>() {
           @Override
           public void write(JsonWriter out, GenerateDataKeyPairRequestRecipient value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GenerateDataKeyPairRequestRecipient read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GenerateDataKeyPairRequestRecipient given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GenerateDataKeyPairRequestRecipient
   * @throws IOException if the JSON string is invalid with respect to GenerateDataKeyPairRequestRecipient
   */
  public static GenerateDataKeyPairRequestRecipient fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateDataKeyPairRequestRecipient.class);
  }

  /**
   * Convert an instance of GenerateDataKeyPairRequestRecipient to an JSON string
   *
   * @return JSON string
   */
