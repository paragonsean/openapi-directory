...
public class RecipientInfo {
  ...
  public RecipientInfo keyEncryptionAlgorithm(KeyEncryptionMechanism keyEncryptionAlgorithm) {
  ...
  public RecipientInfo attestationDocument(String attestationDocument) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keyEncryptionAlgorithm, recipientInfo.keyEncryptionAlgorithm) &&
        Objects.equals(this.attestationDocument, recipientInfo.attestationDocument);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RecipientInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RecipientInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RecipientInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RecipientInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
