...
public class PutKeyPolicyRequest {
  ...
  public PutKeyPolicyRequest keyId(String keyId) {
    this.keyId = keyId;
    return this;
  }
  ...
  public PutKeyPolicyRequest policyName(String policyName) {
  ...
  public PutKeyPolicyRequest policy(String policy) {
    this.policy = policy;
    return this;
  }
  ...
  public PutKeyPolicyRequest bypassPolicyLockoutSafetyCheck(Boolean bypassPolicyLockoutSafetyCheck) {
  ...
  public boolean equals(Object o) {
    ...
    PutKeyPolicyRequest putKeyPolicyRequest = (PutKeyPolicyRequest) o;
    return Objects.equals(this.keyId, putKeyPolicyRequest.keyId) &&
        Objects.equals(this.policyName, putKeyPolicyRequest.policyName) &&
        Objects.equals(this.policy, putKeyPolicyRequest.policy) &&
        Objects.equals(this.bypassPolicyLockoutSafetyCheck, putKeyPolicyRequest.bypassPolicyLockoutSafetyCheck);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keyId, policyName, policy, bypassPolicyLockoutSafetyCheck);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutKeyPolicyRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutKeyPolicyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutKeyPolicyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutKeyPolicyRequest is not found in the empty JSON string", PutKeyPolicyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutKeyPolicyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutKeyPolicyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PutKeyPolicyRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutKeyPolicyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutKeyPolicyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutKeyPolicyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutKeyPolicyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PutKeyPolicyRequest>() {
           @Override
           public void write(JsonWriter out, PutKeyPolicyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutKeyPolicyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutKeyPolicyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutKeyPolicyRequest
   * @throws IOException if the JSON string is invalid with respect to PutKeyPolicyRequest
   */
  public static PutKeyPolicyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutKeyPolicyRequest.class);
  }

  /**
   * Convert an instance of PutKeyPolicyRequest to an JSON string
   *
   * @return JSON string
   */
