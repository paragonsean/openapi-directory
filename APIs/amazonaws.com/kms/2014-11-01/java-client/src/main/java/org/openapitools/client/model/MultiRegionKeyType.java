 ...
 */
@JsonAdapter(MultiRegionKeyType.Adapter.class)
public enum MultiRegionKeyType {
  ...
  MultiRegionKeyType(String value) {
    this.value = value;
  }
  ...
  public static MultiRegionKeyType fromValue(String value) {
    for (MultiRegionKeyType b : MultiRegionKeyType.values()) {
  ...
  public static class Adapter extends TypeAdapter<MultiRegionKeyType> {
    @Override
    public void write(final JsonWriter jsonWriter, final MultiRegionKeyType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public MultiRegionKeyType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return MultiRegionKeyType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    MultiRegionKeyType.fromValue(value);
  }
}
