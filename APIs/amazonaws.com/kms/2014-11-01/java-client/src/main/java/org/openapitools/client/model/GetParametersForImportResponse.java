...
public class GetParametersForImportResponse {
  ...
  public static final String SERIALIZED_NAME_PARAMETERS_VALID_TO = "ParametersValidTo";
  @SerializedName(SERIALIZED_NAME_PARAMETERS_VALID_TO)
  private OffsetDateTime parametersValidTo;
  ...
  public GetParametersForImportResponse parametersValidTo(OffsetDateTime parametersValidTo) {
    this.parametersValidTo = parametersValidTo;
    return this;
  }

  /**
   * Get parametersValidTo
   * @return parametersValidTo
   */
  @javax.annotation.Nullable
  public OffsetDateTime getParametersValidTo() {
    return parametersValidTo;
  }

  public void setParametersValidTo(OffsetDateTime parametersValidTo) {
    this.parametersValidTo = parametersValidTo;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keyId, getParametersForImportResponse.keyId) &&
        Objects.equals(this.importToken, getParametersForImportResponse.importToken) &&
        Objects.equals(this.publicKey, getParametersForImportResponse.publicKey) &&
        Objects.equals(this.parametersValidTo, getParametersForImportResponse.parametersValidTo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keyId, importToken, publicKey, parametersValidTo);
  }
  ...
  public String toString() {
    ...
    sb.append("    parametersValidTo: ").append(toIndentedString(parametersValidTo)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("ParametersValidTo");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetParametersForImportResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetParametersForImportResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetParametersForImportResponse is not found in the empty JSON string", GetParametersForImportResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetParametersForImportResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetParametersForImportResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `ImportToken`
      if (jsonObj.get("ImportToken") != null && !jsonObj.get("ImportToken").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("ImportToken"));
      }
      ...
      // validate the optional field `ParametersValidTo`
      if (jsonObj.get("ParametersValidTo") != null && !jsonObj.get("ParametersValidTo").isJsonNull()) {
        OffsetDateTime.validateJsonElement(jsonObj.get("ParametersValidTo"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetParametersForImportResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetParametersForImportResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetParametersForImportResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetParametersForImportResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetParametersForImportResponse>() {
           @Override
           public void write(JsonWriter out, GetParametersForImportResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetParametersForImportResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetParametersForImportResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetParametersForImportResponse
   * @throws IOException if the JSON string is invalid with respect to GetParametersForImportResponse
   */
  public static GetParametersForImportResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetParametersForImportResponse.class);
  }

  /**
   * Convert an instance of GetParametersForImportResponse to an JSON string
   *
   * @return JSON string
   */
