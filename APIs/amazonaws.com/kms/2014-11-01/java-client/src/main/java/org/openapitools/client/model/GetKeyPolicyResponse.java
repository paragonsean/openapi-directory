...
public class GetKeyPolicyResponse {
  ...
  public GetKeyPolicyResponse() {
  }

  public GetKeyPolicyResponse policy(String policy) {
    this.policy = policy;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetKeyPolicyResponse getKeyPolicyResponse = (GetKeyPolicyResponse) o;
    return Objects.equals(this.policy, getKeyPolicyResponse.policy);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetKeyPolicyResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetKeyPolicyResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetKeyPolicyResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetKeyPolicyResponse is not found in the empty JSON string", GetKeyPolicyResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetKeyPolicyResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetKeyPolicyResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetKeyPolicyResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetKeyPolicyResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetKeyPolicyResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetKeyPolicyResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetKeyPolicyResponse>() {
           @Override
           public void write(JsonWriter out, GetKeyPolicyResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetKeyPolicyResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetKeyPolicyResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetKeyPolicyResponse
   * @throws IOException if the JSON string is invalid with respect to GetKeyPolicyResponse
   */
  public static GetKeyPolicyResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetKeyPolicyResponse.class);
  }

  /**
   * Convert an instance of GetKeyPolicyResponse to an JSON string
   *
   * @return JSON string
   */
