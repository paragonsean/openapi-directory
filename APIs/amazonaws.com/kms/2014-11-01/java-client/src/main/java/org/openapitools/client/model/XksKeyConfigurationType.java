...
public class XksKeyConfigurationType {
  ...
  public XksKeyConfigurationType id(String id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    XksKeyConfigurationType xksKeyConfigurationType = (XksKeyConfigurationType) o;
    return Objects.equals(this.id, xksKeyConfigurationType.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class XksKeyConfigurationType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to XksKeyConfigurationType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!XksKeyConfigurationType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in XksKeyConfigurationType is not found in the empty JSON string", XksKeyConfigurationType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!XksKeyConfigurationType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `XksKeyConfigurationType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!XksKeyConfigurationType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'XksKeyConfigurationType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<XksKeyConfigurationType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(XksKeyConfigurationType.class));

       return (TypeAdapter<T>) new TypeAdapter<XksKeyConfigurationType>() {
           @Override
           public void write(JsonWriter out, XksKeyConfigurationType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public XksKeyConfigurationType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of XksKeyConfigurationType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of XksKeyConfigurationType
   * @throws IOException if the JSON string is invalid with respect to XksKeyConfigurationType
   */
  public static XksKeyConfigurationType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, XksKeyConfigurationType.class);
  }

  /**
   * Convert an instance of XksKeyConfigurationType to an JSON string
   *
   * @return JSON string
   */
