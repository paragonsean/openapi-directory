...
public class GetKeyRotationStatusRequest {
  ...
  public GetKeyRotationStatusRequest keyId(String keyId) {
    this.keyId = keyId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetKeyRotationStatusRequest getKeyRotationStatusRequest = (GetKeyRotationStatusRequest) o;
    return Objects.equals(this.keyId, getKeyRotationStatusRequest.keyId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetKeyRotationStatusRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetKeyRotationStatusRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetKeyRotationStatusRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetKeyRotationStatusRequest is not found in the empty JSON string", GetKeyRotationStatusRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetKeyRotationStatusRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetKeyRotationStatusRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetKeyRotationStatusRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetKeyRotationStatusRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetKeyRotationStatusRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetKeyRotationStatusRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetKeyRotationStatusRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetKeyRotationStatusRequest>() {
           @Override
           public void write(JsonWriter out, GetKeyRotationStatusRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetKeyRotationStatusRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetKeyRotationStatusRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetKeyRotationStatusRequest
   * @throws IOException if the JSON string is invalid with respect to GetKeyRotationStatusRequest
   */
  public static GetKeyRotationStatusRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetKeyRotationStatusRequest.class);
  }

  /**
   * Convert an instance of GetKeyRotationStatusRequest to an JSON string
   *
   * @return JSON string
   */
