...
/**
 * Gets or Sets EncryptionAlgorithmSpec
 */
@JsonAdapter(EncryptionAlgorithmSpec.Adapter.class)
public enum EncryptionAlgorithmSpec {
  ...
  EncryptionAlgorithmSpec(String value) {
    this.value = value;
  }
  ...
  public static EncryptionAlgorithmSpec fromValue(String value) {
    for (EncryptionAlgorithmSpec b : EncryptionAlgorithmSpec.values()) {
  ...
  public static class Adapter extends TypeAdapter<EncryptionAlgorithmSpec> {
    @Override
    public void write(final JsonWriter jsonWriter, final EncryptionAlgorithmSpec enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EncryptionAlgorithmSpec read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EncryptionAlgorithmSpec.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    EncryptionAlgorithmSpec.fromValue(value);
  }
}
