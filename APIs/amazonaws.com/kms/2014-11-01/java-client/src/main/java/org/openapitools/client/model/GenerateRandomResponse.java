...
public class GenerateRandomResponse {
  ...
  public GenerateRandomResponse plaintext(String plaintext) {
  ...
  public GenerateRandomResponse ciphertextForRecipient(String ciphertextForRecipient) {
  ...
  public boolean equals(Object o) {
    ...
    GenerateRandomResponse generateRandomResponse = (GenerateRandomResponse) o;
    return Objects.equals(this.plaintext, generateRandomResponse.plaintext) &&
        Objects.equals(this.ciphertextForRecipient, generateRandomResponse.ciphertextForRecipient);
  }

  @Override
  public int hashCode() {
    return Objects.hash(plaintext, ciphertextForRecipient);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GenerateRandomResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GenerateRandomResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenerateRandomResponse is not found in the empty JSON string", GenerateRandomResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GenerateRandomResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenerateRandomResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenerateRandomResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenerateRandomResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenerateRandomResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenerateRandomResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GenerateRandomResponse>() {
           @Override
           public void write(JsonWriter out, GenerateRandomResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GenerateRandomResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GenerateRandomResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GenerateRandomResponse
   * @throws IOException if the JSON string is invalid with respect to GenerateRandomResponse
   */
  public static GenerateRandomResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateRandomResponse.class);
  }

  /**
   * Convert an instance of GenerateRandomResponse to an JSON string
   *
   * @return JSON string
   */
