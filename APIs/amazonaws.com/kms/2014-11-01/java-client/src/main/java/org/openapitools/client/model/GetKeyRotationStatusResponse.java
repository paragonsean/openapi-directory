...
public class GetKeyRotationStatusResponse {
  public static final String SERIALIZED_NAME_KEY_ROTATION_ENABLED = "KeyRotationEnabled";
  @SerializedName(SERIALIZED_NAME_KEY_ROTATION_ENABLED)
  private Boolean keyRotationEnabled;

  public GetKeyRotationStatusResponse() {
  }

  public GetKeyRotationStatusResponse keyRotationEnabled(Boolean keyRotationEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    GetKeyRotationStatusResponse getKeyRotationStatusResponse = (GetKeyRotationStatusResponse) o;
    return Objects.equals(this.keyRotationEnabled, getKeyRotationStatusResponse.keyRotationEnabled);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keyRotationEnabled);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetKeyRotationStatusResponse {\n");
  ...
  static {
    ...
    openapiFields.add("KeyRotationEnabled");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetKeyRotationStatusResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetKeyRotationStatusResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetKeyRotationStatusResponse is not found in the empty JSON string", GetKeyRotationStatusResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetKeyRotationStatusResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetKeyRotationStatusResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `KeyRotationEnabled`
      if (jsonObj.get("KeyRotationEnabled") != null && !jsonObj.get("KeyRotationEnabled").isJsonNull()) {
        Boolean.validateJsonElement(jsonObj.get("KeyRotationEnabled"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetKeyRotationStatusResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetKeyRotationStatusResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetKeyRotationStatusResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetKeyRotationStatusResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetKeyRotationStatusResponse>() {
           @Override
           public void write(JsonWriter out, GetKeyRotationStatusResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetKeyRotationStatusResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetKeyRotationStatusResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetKeyRotationStatusResponse
   * @throws IOException if the JSON string is invalid with respect to GetKeyRotationStatusResponse
   */
  public static GetKeyRotationStatusResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetKeyRotationStatusResponse.class);
  }

  /**
   * Convert an instance of GetKeyRotationStatusResponse to an JSON string
   *
   * @return JSON string
   */
