...
import org.openapitools.client.model.UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential;
...
public class UpdateCustomKeyStoreRequest {
  ...
  public static final String SERIALIZED_NAME_NEW_CUSTOM_KEY_STORE_NAME = "NewCustomKeyStoreName";
  @SerializedName(SERIALIZED_NAME_NEW_CUSTOM_KEY_STORE_NAME)
  ...
  private UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential xksProxyAuthenticationCredential;
  ...
  public UpdateCustomKeyStoreRequest keyStorePassword(String keyStorePassword) {
  ...
  public UpdateCustomKeyStoreRequest cloudHsmClusterId(String cloudHsmClusterId) {
  ...
  public UpdateCustomKeyStoreRequest xksProxyAuthenticationCredential(UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential xksProxyAuthenticationCredential) {
   ...
   */
  @javax.annotation.Nullable
  public UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential getXksProxyAuthenticationCredential() {
    return xksProxyAuthenticationCredential;
  }

  public void setXksProxyAuthenticationCredential(UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential xksProxyAuthenticationCredential) {
    this.xksProxyAuthenticationCredential = xksProxyAuthenticationCredential;
  }


  public UpdateCustomKeyStoreRequest xksProxyConnectivity(XksProxyConnectivityType xksProxyConnectivity) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.customKeyStoreId, updateCustomKeyStoreRequest.customKeyStoreId) &&
        ...
        Objects.equals(this.keyStorePassword, updateCustomKeyStoreRequest.keyStorePassword) &&
        Objects.equals(this.cloudHsmClusterId, updateCustomKeyStoreRequest.cloudHsmClusterId) &&
        ...
        Objects.equals(this.xksProxyAuthenticationCredential, updateCustomKeyStoreRequest.xksProxyAuthenticationCredential) &&
        Objects.equals(this.xksProxyConnectivity, updateCustomKeyStoreRequest.xksProxyConnectivity);
  }

  @Override
  public int hashCode() {
    return Objects.hash(customKeyStoreId, newCustomKeyStoreName, keyStorePassword, cloudHsmClusterId, xksProxyUriEndpoint, xksProxyUriPath, xksProxyVpcEndpointServiceName, xksProxyAuthenticationCredential, xksProxyConnectivity);
  }
  ...
  static {
    ...
    openapiFields.add("NewCustomKeyStoreName");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateCustomKeyStoreRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateCustomKeyStoreRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateCustomKeyStoreRequest is not found in the empty JSON string", UpdateCustomKeyStoreRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateCustomKeyStoreRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateCustomKeyStoreRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateCustomKeyStoreRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("NewCustomKeyStoreName") != null && !jsonObj.get("NewCustomKeyStoreName").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("NewCustomKeyStoreName"));
      }
      ...
      if (jsonObj.get("XksProxyAuthenticationCredential") != null && !jsonObj.get("XksProxyAuthenticationCredential").isJsonNull()) {
        UpdateCustomKeyStoreRequestXksProxyAuthenticationCredential.validateJsonElement(jsonObj.get("XksProxyAuthenticationCredential"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateCustomKeyStoreRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateCustomKeyStoreRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateCustomKeyStoreRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateCustomKeyStoreRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateCustomKeyStoreRequest>() {
           @Override
           public void write(JsonWriter out, UpdateCustomKeyStoreRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateCustomKeyStoreRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateCustomKeyStoreRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateCustomKeyStoreRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateCustomKeyStoreRequest
   */
  public static UpdateCustomKeyStoreRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateCustomKeyStoreRequest.class);
  }

  /**
   * Convert an instance of UpdateCustomKeyStoreRequest to an JSON string
   *
   * @return JSON string
   */
