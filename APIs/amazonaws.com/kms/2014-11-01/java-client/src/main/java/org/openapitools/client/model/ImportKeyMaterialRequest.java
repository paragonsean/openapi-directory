...
public class ImportKeyMaterialRequest {
  ...
  public static final String SERIALIZED_NAME_ENCRYPTED_KEY_MATERIAL = "EncryptedKeyMaterial";
  @SerializedName(SERIALIZED_NAME_ENCRYPTED_KEY_MATERIAL)
  ...
  public ImportKeyMaterialRequest validTo(OffsetDateTime validTo) {
  ...
  public ImportKeyMaterialRequest expirationModel(ExpirationModelType expirationModel) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keyId, importKeyMaterialRequest.keyId) &&
        Objects.equals(this.importToken, importKeyMaterialRequest.importToken) &&
        Objects.equals(this.encryptedKeyMaterial, importKeyMaterialRequest.encryptedKeyMaterial) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(keyId, importToken, encryptedKeyMaterial, validTo, expirationModel);
  }
  ...
  static {
    ...
    openapiFields.add("EncryptedKeyMaterial");
    ...
    openapiRequiredFields.add("ImportToken");
    openapiRequiredFields.add("EncryptedKeyMaterial");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportKeyMaterialRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportKeyMaterialRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportKeyMaterialRequest is not found in the empty JSON string", ImportKeyMaterialRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportKeyMaterialRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportKeyMaterialRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImportKeyMaterialRequest.openapiRequiredFields) {
      ...
      // validate the required field `ImportToken`
      String.validateJsonElement(jsonObj.get("ImportToken"));
      // validate the required field `EncryptedKeyMaterial`
      String.validateJsonElement(jsonObj.get("EncryptedKeyMaterial"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportKeyMaterialRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportKeyMaterialRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportKeyMaterialRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportKeyMaterialRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportKeyMaterialRequest>() {
           @Override
           public void write(JsonWriter out, ImportKeyMaterialRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportKeyMaterialRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportKeyMaterialRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportKeyMaterialRequest
   * @throws IOException if the JSON string is invalid with respect to ImportKeyMaterialRequest
   */
  public static ImportKeyMaterialRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportKeyMaterialRequest.class);
  }

  /**
   * Convert an instance of ImportKeyMaterialRequest to an JSON string
   *
   * @return JSON string
   */
