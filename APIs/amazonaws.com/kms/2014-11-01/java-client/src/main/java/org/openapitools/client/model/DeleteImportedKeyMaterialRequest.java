...
public class DeleteImportedKeyMaterialRequest {
  ...
  public DeleteImportedKeyMaterialRequest keyId(String keyId) {
    this.keyId = keyId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keyId, deleteImportedKeyMaterialRequest.keyId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteImportedKeyMaterialRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteImportedKeyMaterialRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteImportedKeyMaterialRequest is not found in the empty JSON string", DeleteImportedKeyMaterialRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteImportedKeyMaterialRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteImportedKeyMaterialRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteImportedKeyMaterialRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteImportedKeyMaterialRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteImportedKeyMaterialRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteImportedKeyMaterialRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteImportedKeyMaterialRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteImportedKeyMaterialRequest>() {
           @Override
           public void write(JsonWriter out, DeleteImportedKeyMaterialRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteImportedKeyMaterialRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteImportedKeyMaterialRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteImportedKeyMaterialRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteImportedKeyMaterialRequest
   */
  public static DeleteImportedKeyMaterialRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteImportedKeyMaterialRequest.class);
  }

  /**
   * Convert an instance of DeleteImportedKeyMaterialRequest to an JSON string
   *
   * @return JSON string
   */
