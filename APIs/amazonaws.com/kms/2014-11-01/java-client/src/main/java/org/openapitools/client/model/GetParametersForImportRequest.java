...
public class GetParametersForImportRequest {
  ...
  public static final String SERIALIZED_NAME_WRAPPING_ALGORITHM = "WrappingAlgorithm";
  @SerializedName(SERIALIZED_NAME_WRAPPING_ALGORITHM)
  private AlgorithmSpec wrappingAlgorithm;

  public static final String SERIALIZED_NAME_WRAPPING_KEY_SPEC = "WrappingKeySpec";
  @SerializedName(SERIALIZED_NAME_WRAPPING_KEY_SPEC)
  private WrappingKeySpec wrappingKeySpec;
  ...
  public GetParametersForImportRequest wrappingAlgorithm(AlgorithmSpec wrappingAlgorithm) {
   ...
   */
  @javax.annotation.Nonnull
  public AlgorithmSpec getWrappingAlgorithm() {
    return wrappingAlgorithm;
  }
  ...
  public GetParametersForImportRequest wrappingKeySpec(WrappingKeySpec wrappingKeySpec) {
   ...
   */
  @javax.annotation.Nonnull
  public WrappingKeySpec getWrappingKeySpec() {
    return wrappingKeySpec;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(keyId, wrappingAlgorithm, wrappingKeySpec);
  }
  ...
  static {
    ...
    openapiFields.add("WrappingAlgorithm");
    openapiFields.add("WrappingKeySpec");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("KeyId");
    openapiRequiredFields.add("WrappingAlgorithm");
    openapiRequiredFields.add("WrappingKeySpec");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetParametersForImportRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetParametersForImportRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetParametersForImportRequest is not found in the empty JSON string", GetParametersForImportRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetParametersForImportRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetParametersForImportRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetParametersForImportRequest.openapiRequiredFields) {
      ...
      // validate the required field `WrappingAlgorithm`
      AlgorithmSpec.validateJsonElement(jsonObj.get("WrappingAlgorithm"));
      // validate the required field `WrappingKeySpec`
      WrappingKeySpec.validateJsonElement(jsonObj.get("WrappingKeySpec"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetParametersForImportRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetParametersForImportRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetParametersForImportRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetParametersForImportRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetParametersForImportRequest>() {
           @Override
           public void write(JsonWriter out, GetParametersForImportRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetParametersForImportRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetParametersForImportRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetParametersForImportRequest
   * @throws IOException if the JSON string is invalid with respect to GetParametersForImportRequest
   */
  public static GetParametersForImportRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetParametersForImportRequest.class);
  }

  /**
   * Convert an instance of GetParametersForImportRequest to an JSON string
   *
   * @return JSON string
   */
