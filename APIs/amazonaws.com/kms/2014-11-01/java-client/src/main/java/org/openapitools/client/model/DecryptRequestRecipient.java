...
import org.openapitools.client.model.KeyEncryptionMechanism;
...
public class DecryptRequestRecipient {
  public static final String SERIALIZED_NAME_KEY_ENCRYPTION_ALGORITHM = "KeyEncryptionAlgorithm";
  @SerializedName(SERIALIZED_NAME_KEY_ENCRYPTION_ALGORITHM)
  private KeyEncryptionMechanism keyEncryptionAlgorithm;

  public static final String SERIALIZED_NAME_ATTESTATION_DOCUMENT = "AttestationDocument";
  @SerializedName(SERIALIZED_NAME_ATTESTATION_DOCUMENT)
  private String attestationDocument;

  public DecryptRequestRecipient() {
  }

  public DecryptRequestRecipient keyEncryptionAlgorithm(KeyEncryptionMechanism keyEncryptionAlgorithm) {
  ...
  public KeyEncryptionMechanism getKeyEncryptionAlgorithm() {
    return keyEncryptionAlgorithm;
  }
  ...
  public DecryptRequestRecipient attestationDocument(String attestationDocument) {
  ...
  public boolean equals(Object o) {
    ...
    DecryptRequestRecipient decryptRequestRecipient = (DecryptRequestRecipient) o;
    return Objects.equals(this.keyEncryptionAlgorithm, decryptRequestRecipient.keyEncryptionAlgorithm) &&
        Objects.equals(this.attestationDocument, decryptRequestRecipient.attestationDocument);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keyEncryptionAlgorithm, attestationDocument);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DecryptRequestRecipient {\n");
  ...
  static {
    ...
    openapiFields.add("KeyEncryptionAlgorithm");
    openapiFields.add("AttestationDocument");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DecryptRequestRecipient
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DecryptRequestRecipient.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DecryptRequestRecipient is not found in the empty JSON string", DecryptRequestRecipient.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DecryptRequestRecipient.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DecryptRequestRecipient` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `KeyEncryptionAlgorithm`
      if (jsonObj.get("KeyEncryptionAlgorithm") != null && !jsonObj.get("KeyEncryptionAlgorithm").isJsonNull()) {
        KeyEncryptionMechanism.validateJsonElement(jsonObj.get("KeyEncryptionAlgorithm"));
      }
      // validate the optional field `AttestationDocument`
      if (jsonObj.get("AttestationDocument") != null && !jsonObj.get("AttestationDocument").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("AttestationDocument"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DecryptRequestRecipient.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DecryptRequestRecipient' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DecryptRequestRecipient> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DecryptRequestRecipient.class));

       return (TypeAdapter<T>) new TypeAdapter<DecryptRequestRecipient>() {
           @Override
           public void write(JsonWriter out, DecryptRequestRecipient value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DecryptRequestRecipient read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DecryptRequestRecipient given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DecryptRequestRecipient
   * @throws IOException if the JSON string is invalid with respect to DecryptRequestRecipient
   */
  public static DecryptRequestRecipient fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DecryptRequestRecipient.class);
  }

  /**
   * Convert an instance of DecryptRequestRecipient to an JSON string
   *
   * @return JSON string
   */
