...
public class RevokeGrantRequest {
  ...
  public RevokeGrantRequest keyId(String keyId) {
    this.keyId = keyId;
    return this;
  }
  ...
  public RevokeGrantRequest grantId(String grantId) {
  ...
  public RevokeGrantRequest dryRun(Boolean dryRun) {
    this.dryRun = dryRun;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RevokeGrantRequest revokeGrantRequest = (RevokeGrantRequest) o;
    return Objects.equals(this.keyId, revokeGrantRequest.keyId) &&
        Objects.equals(this.grantId, revokeGrantRequest.grantId) &&
        Objects.equals(this.dryRun, revokeGrantRequest.dryRun);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keyId, grantId, dryRun);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RevokeGrantRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("GrantId");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RevokeGrantRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RevokeGrantRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RevokeGrantRequest is not found in the empty JSON string", RevokeGrantRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RevokeGrantRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RevokeGrantRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RevokeGrantRequest.openapiRequiredFields) {
      ...
      // validate the required field `GrantId`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RevokeGrantRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RevokeGrantRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RevokeGrantRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RevokeGrantRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RevokeGrantRequest>() {
           @Override
           public void write(JsonWriter out, RevokeGrantRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RevokeGrantRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RevokeGrantRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RevokeGrantRequest
   * @throws IOException if the JSON string is invalid with respect to RevokeGrantRequest
   */
  public static RevokeGrantRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RevokeGrantRequest.class);
  }

  /**
   * Convert an instance of RevokeGrantRequest to an JSON string
   *
   * @return JSON string
   */
