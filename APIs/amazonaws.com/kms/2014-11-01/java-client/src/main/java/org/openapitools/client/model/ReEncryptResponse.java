...
public class ReEncryptResponse {
  ...
  public ReEncryptResponse sourceKeyId(String sourceKeyId) {
  ...
  public ReEncryptResponse keyId(String keyId) {
    this.keyId = keyId;
    return this;
  }
  ...
  public ReEncryptResponse sourceEncryptionAlgorithm(EncryptionAlgorithmSpec sourceEncryptionAlgorithm) {
  ...
  public ReEncryptResponse destinationEncryptionAlgorithm(EncryptionAlgorithmSpec destinationEncryptionAlgorithm) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ciphertextBlob, reEncryptResponse.ciphertextBlob) &&
        Objects.equals(this.sourceKeyId, reEncryptResponse.sourceKeyId) &&
        Objects.equals(this.keyId, reEncryptResponse.keyId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ciphertextBlob, sourceKeyId, keyId, sourceEncryptionAlgorithm, destinationEncryptionAlgorithm);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReEncryptResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReEncryptResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReEncryptResponse is not found in the empty JSON string", ReEncryptResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReEncryptResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReEncryptResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReEncryptResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReEncryptResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReEncryptResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReEncryptResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ReEncryptResponse>() {
           @Override
           public void write(JsonWriter out, ReEncryptResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReEncryptResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReEncryptResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReEncryptResponse
   * @throws IOException if the JSON string is invalid with respect to ReEncryptResponse
   */
  public static ReEncryptResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReEncryptResponse.class);
  }

  /**
   * Convert an instance of ReEncryptResponse to an JSON string
   *
   * @return JSON string
   */
