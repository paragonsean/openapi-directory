...
public class GenerateDataKeyResponse {
  ...
  public GenerateDataKeyResponse keyId(String keyId) {
    this.keyId = keyId;
    return this;
  }
  ...
  public GenerateDataKeyResponse ciphertextForRecipient(String ciphertextForRecipient) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ciphertextBlob, generateDataKeyResponse.ciphertextBlob) &&
        ...
        Objects.equals(this.keyId, generateDataKeyResponse.keyId) &&
        Objects.equals(this.ciphertextForRecipient, generateDataKeyResponse.ciphertextForRecipient);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ciphertextBlob, plaintext, keyId, ciphertextForRecipient);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GenerateDataKeyResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GenerateDataKeyResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenerateDataKeyResponse is not found in the empty JSON string", GenerateDataKeyResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GenerateDataKeyResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenerateDataKeyResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `CiphertextBlob`
      if (jsonObj.get("CiphertextBlob") != null && !jsonObj.get("CiphertextBlob").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("CiphertextBlob"));
      }
      // validate the optional field `Plaintext`
      if (jsonObj.get("Plaintext") != null && !jsonObj.get("Plaintext").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenerateDataKeyResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenerateDataKeyResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenerateDataKeyResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenerateDataKeyResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GenerateDataKeyResponse>() {
           @Override
           public void write(JsonWriter out, GenerateDataKeyResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GenerateDataKeyResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GenerateDataKeyResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GenerateDataKeyResponse
   * @throws IOException if the JSON string is invalid with respect to GenerateDataKeyResponse
   */
  public static GenerateDataKeyResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateDataKeyResponse.class);
  }

  /**
   * Convert an instance of GenerateDataKeyResponse to an JSON string
   *
   * @return JSON string
   */
