...
public class ListKeyPoliciesRequest {
  ...
  public ListKeyPoliciesRequest keyId(String keyId) {
    this.keyId = keyId;
    return this;
  }
  ...
  public ListKeyPoliciesRequest limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public ListKeyPoliciesRequest marker(String marker) {
    this.marker = marker;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListKeyPoliciesRequest listKeyPoliciesRequest = (ListKeyPoliciesRequest) o;
    return Objects.equals(this.keyId, listKeyPoliciesRequest.keyId) &&
        Objects.equals(this.limit, listKeyPoliciesRequest.limit) &&
        Objects.equals(this.marker, listKeyPoliciesRequest.marker);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListKeyPoliciesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListKeyPoliciesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListKeyPoliciesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListKeyPoliciesRequest is not found in the empty JSON string", ListKeyPoliciesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListKeyPoliciesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListKeyPoliciesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListKeyPoliciesRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListKeyPoliciesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListKeyPoliciesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListKeyPoliciesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListKeyPoliciesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListKeyPoliciesRequest>() {
           @Override
           public void write(JsonWriter out, ListKeyPoliciesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListKeyPoliciesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListKeyPoliciesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListKeyPoliciesRequest
   * @throws IOException if the JSON string is invalid with respect to ListKeyPoliciesRequest
   */
  public static ListKeyPoliciesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListKeyPoliciesRequest.class);
  }

  /**
   * Convert an instance of ListKeyPoliciesRequest to an JSON string
   *
   * @return JSON string
   */
