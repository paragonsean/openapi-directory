...
public class CreateCustomKeyStoreResponse {
  ...
  public CreateCustomKeyStoreResponse customKeyStoreId(String customKeyStoreId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.customKeyStoreId, createCustomKeyStoreResponse.customKeyStoreId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateCustomKeyStoreResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCustomKeyStoreResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateCustomKeyStoreResponse is not found in the empty JSON string", CreateCustomKeyStoreResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateCustomKeyStoreResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateCustomKeyStoreResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateCustomKeyStoreResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateCustomKeyStoreResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateCustomKeyStoreResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateCustomKeyStoreResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateCustomKeyStoreResponse>() {
           @Override
           public void write(JsonWriter out, CreateCustomKeyStoreResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateCustomKeyStoreResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateCustomKeyStoreResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateCustomKeyStoreResponse
   * @throws IOException if the JSON string is invalid with respect to CreateCustomKeyStoreResponse
   */
  public static CreateCustomKeyStoreResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCustomKeyStoreResponse.class);
  }

  /**
   * Convert an instance of CreateCustomKeyStoreResponse to an JSON string
   *
   * @return JSON string
   */
