...
async def test_cancel_key_deletion(client):
    """Test case for cancel_key_deletion
...
async def test_connect_custom_key_store(client):
    """Test case for connect_custom_key_store
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.ConnectCustomKeyStore',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_alias(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.CreateAlias',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_custom_key_store(client):
    """Test case for create_custom_key_store

    
    """
    body = {"KeyStorePassword":"","XksProxyVpcEndpointServiceName":"","CustomKeyStoreName":"","CustomKeyStoreType":"","XksProxyUriEndpoint":"","XksProxyConnectivity":"","TrustAnchorCertificate":"","XksProxyUriPath":"","XksProxyAuthenticationCredential":{"RawSecretAccessKey":"","AccessKeyId":""},"CloudHsmClusterId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.CreateCustomKeyStore',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_grant(client):
    ...
    """
    body = {"GranteePrincipal":"","Constraints":{"EncryptionContextEquals":"","EncryptionContextSubset":""},"RetiringPrincipal":"","DryRun":"","KeyId":"","Operations":"","GrantTokens":"","Name":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.CreateGrant',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_key(client):
    ...
    """
    body = {"Policy":"","CustomerMasterKeySpec":"","Origin":"","MultiRegion":"","Description":"","BypassPolicyLockoutSafetyCheck":"","KeySpec":"","KeyUsage":"","CustomKeyStoreId":"","XksKeyId":"","Tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.CreateKey',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_decrypt(client):
    ...
    """
    body = {"EncryptionContext":"","CiphertextBlob":"","DryRun":"","EncryptionAlgorithm":"","KeyId":"","Recipient":{"AttestationDocument":"","KeyEncryptionAlgorithm":""},"GrantTokens":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.Decrypt',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_alias(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.DeleteAlias',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_custom_key_store(client):
    """Test case for delete_custom_key_store
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.DeleteCustomKeyStore',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_imported_key_material(client):
    """Test case for delete_imported_key_material
...
async def test_describe_custom_key_stores(client):
    """Test case for describe_custom_key_stores

    
    """
    body = {"CustomKeyStoreName":"","CustomKeyStoreId":"","Limit":"","Marker":""}
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.DescribeCustomKeyStores',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_describe_key(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.DescribeKey',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_disable_key(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.DisableKey',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_disable_key_rotation(client):
    """Test case for disable_key_rotation
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.DisableKeyRotation',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_disconnect_custom_key_store(client):
    """Test case for disconnect_custom_key_store
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.DisconnectCustomKeyStore',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enable_key(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.EnableKey',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enable_key_rotation(client):
    """Test case for enable_key_rotation
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.EnableKeyRotation',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_encrypt(client):
    ...
    """
    body = {"EncryptionContext":"","Plaintext":"","DryRun":"","EncryptionAlgorithm":"","KeyId":"","GrantTokens":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.Encrypt',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_generate_data_key(client):
    """Test case for generate_data_key

    
    """
    body = {"EncryptionContext":"","KeySpec":"","DryRun":"","KeyId":"","Recipient":{"AttestationDocument":"","KeyEncryptionAlgorithm":""},"NumberOfBytes":"","GrantTokens":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.GenerateDataKey',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_generate_data_key_pair(client):
    """Test case for generate_data_key_pair

    
    """
    body = {"KeyPairSpec":"","EncryptionContext":"","DryRun":"","KeyId":"","Recipient":{"AttestationDocument":"","KeyEncryptionAlgorithm":""},"GrantTokens":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.GenerateDataKeyPair',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_generate_data_key_pair_without_plaintext(client):
    """Test case for generate_data_key_pair_without_plaintext

    
    """
    body = {"KeyPairSpec":"","EncryptionContext":"","DryRun":"","KeyId":"","GrantTokens":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.GenerateDataKeyPairWithoutPlaintext',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_generate_data_key_without_plaintext(client):
    """Test case for generate_data_key_without_plaintext

    
    """
    body = {"EncryptionContext":"","KeySpec":"","DryRun":"","KeyId":"","NumberOfBytes":"","GrantTokens":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.GenerateDataKeyWithoutPlaintext',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_generate_mac(client):
    """Test case for generate_mac

    
    """
    body = {"MacAlgorithm":"","Message":"","DryRun":"","KeyId":"","GrantTokens":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.GenerateMac',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_generate_random(client):
    """Test case for generate_random

    
    """
    body = {"CustomKeyStoreId":"","Recipient":{"AttestationDocument":"","KeyEncryptionAlgorithm":""},"NumberOfBytes":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_get_key_policy(client):
    """Test case for get_key_policy

    
    """
    body = {"PolicyName":"","KeyId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_get_key_rotation_status(client):
    """Test case for get_key_rotation_status
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.GetKeyRotationStatus',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_parameters_for_import(client):
    """Test case for get_parameters_for_import

    
    """
    body = {"WrappingKeySpec":"","KeyId":"","WrappingAlgorithm":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.GetParametersForImport',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_public_key(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.GetPublicKey',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_import_key_material(client):
    """Test case for import_key_material

    
    """
    body = {"ValidTo":"","ExpirationModel":"","EncryptedKeyMaterial":"","KeyId":"","ImportToken":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.ImportKeyMaterial',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_aliases(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.ListAliases',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_grants(client):
    ...
    """
    body = {"GranteePrincipal":"","KeyId":"","GrantId":"","Limit":"","Marker":""}
    params = [('Limit', 'limit_example'),
                    ('Marker', 'marker_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_key_policies(client):
    """Test case for list_key_policies
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.ListKeyPolicies',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_resource_tags(client):
    """Test case for list_resource_tags
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.ListResourceTags',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_retirable_grants(client):
    """Test case for list_retirable_grants

    
    """
    body = {"RetiringPrincipal":"","Limit":"","Marker":""}
    params = [('Limit', 'limit_example'),
                    ('Marker', 'marker_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_put_key_policy(client):
    """Test case for put_key_policy

    
    """
    body = {"Policy":"","BypassPolicyLockoutSafetyCheck":"","PolicyName":"","KeyId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.PutKeyPolicy',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_re_encrypt(client):
    """Test case for re_encrypt

    
    """
    body = {"DestinationKeyId":"","SourceKeyId":"","SourceEncryptionAlgorithm":"","SourceEncryptionContext":"","DestinationEncryptionContext":"","CiphertextBlob":"","DryRun":"","DestinationEncryptionAlgorithm":"","GrantTokens":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.ReEncrypt',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_replicate_key(client):
    """Test case for replicate_key

    
    """
    body = {"Policy":"","Description":"","BypassPolicyLockoutSafetyCheck":"","KeyId":"","ReplicaRegion":"","Tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.ReplicateKey',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_retire_grant(client):
    """Test case for retire_grant

    
    """
    body = {"GrantToken":"","DryRun":"","KeyId":"","GrantId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_revoke_grant(client):
    """Test case for revoke_grant

    
    """
    body = {"DryRun":"","KeyId":"","GrantId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.RevokeGrant',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_schedule_key_deletion(client):
    """Test case for schedule_key_deletion

    
    """
    body = {"PendingWindowInDays":"","KeyId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.ScheduleKeyDeletion',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_sign(client):
    ...
    """
    body = {"Message":"","DryRun":"","SigningAlgorithm":"","KeyId":"","MessageType":"","GrantTokens":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.Sign',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_untag_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.UntagResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_alias(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.UpdateAlias',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_custom_key_store(client):
    """Test case for update_custom_key_store

    
    """
    body = {"KeyStorePassword":"","XksProxyVpcEndpointServiceName":"","XksProxyUriEndpoint":"","XksProxyConnectivity":"","CustomKeyStoreId":"","NewCustomKeyStoreName":"","XksProxyUriPath":"","XksProxyAuthenticationCredential":{"RawSecretAccessKey":"","AccessKeyId":""},"CloudHsmClusterId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.UpdateCustomKeyStore',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_key_description(client):
    """Test case for update_key_description
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.UpdateKeyDescription',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_primary_region(client):
    """Test case for update_primary_region

    
    """
    body = {"PrimaryRegion":"","KeyId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.UpdatePrimaryRegion',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_verify(client):
    ...
    """
    body = {"Message":"","Signature":"","DryRun":"","SigningAlgorithm":"","KeyId":"","MessageType":"","GrantTokens":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=TrentService.Verify',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_verify_mac(client):
    """Test case for verify_mac

    
    """
    body = {"MacAlgorithm":"","Message":"","DryRun":"","KeyId":"","Mac":"","GrantTokens":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
