...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://gamelift.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://gamelift.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2015-10-01/Javascript'
        };
