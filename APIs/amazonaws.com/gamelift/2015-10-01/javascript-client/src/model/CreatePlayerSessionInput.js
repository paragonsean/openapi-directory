...
/**
 * The CreatePlayerSessionInput model module.
 * @module model/CreatePlayerSessionInput
 * @version 2015-10-01
 */
class CreatePlayerSessionInput {
    /**
     * Constructs a new <code>CreatePlayerSessionInput</code>.
     * @alias module:model/CreatePlayerSessionInput
     * @param gameSessionId {String} 
     * @param playerId {String} 
     */
    constructor(gameSessionId, playerId) { 
        
        CreatePlayerSessionInput.initialize(this, gameSessionId, playerId);
    }
     ...
     */
    static initialize(obj, gameSessionId, playerId) { 
        obj['GameSessionId'] = gameSessionId;
        obj['PlayerId'] = playerId;
    }

    /**
     * Constructs a <code>CreatePlayerSessionInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePlayerSessionInput} obj Optional instance to populate.
     * @return {module:model/CreatePlayerSessionInput} The populated <code>CreatePlayerSessionInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePlayerSessionInput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePlayerSessionInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePlayerSessionInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreatePlayerSessionInput.RequiredProperties) {
...
CreatePlayerSessionInput.RequiredProperties = ["GameSessionId", "PlayerId"];

/**
 * @member {String} GameSessionId
 */
CreatePlayerSessionInput.prototype['GameSessionId'] = undefined;

/**
 * @member {String} PlayerId
 */
CreatePlayerSessionInput.prototype['PlayerId'] = undefined;

/**
 * @member {String} PlayerData
 */
CreatePlayerSessionInput.prototype['PlayerData'] = undefined;
...
export default CreatePlayerSessionInput;
