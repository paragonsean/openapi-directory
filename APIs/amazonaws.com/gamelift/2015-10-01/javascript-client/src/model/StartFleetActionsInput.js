...
/**
 * The StartFleetActionsInput model module.
 * @module model/StartFleetActionsInput
 * @version 2015-10-01
 */
class StartFleetActionsInput {
    /**
     * Constructs a new <code>StartFleetActionsInput</code>.
     * @alias module:model/StartFleetActionsInput
     * @param fleetId {String} 
     * @param actions {Array} 
     */
    constructor(fleetId, actions) { 
        
        StartFleetActionsInput.initialize(this, fleetId, actions);
    }
     ...
     */
    static initialize(obj, fleetId, actions) { 
        obj['FleetId'] = fleetId;
        obj['Actions'] = actions;
    }

    /**
     * Constructs a <code>StartFleetActionsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartFleetActionsInput} obj Optional instance to populate.
     * @return {module:model/StartFleetActionsInput} The populated <code>StartFleetActionsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartFleetActionsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>StartFleetActionsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartFleetActionsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartFleetActionsInput.RequiredProperties) {
...
StartFleetActionsInput.RequiredProperties = ["FleetId", "Actions"];

/**
 * @member {String} FleetId
 */
StartFleetActionsInput.prototype['FleetId'] = undefined;

/**
 * @member {Array} Actions
 */
StartFleetActionsInput.prototype['Actions'] = undefined;

/**
 * @member {String} Location
 */
StartFleetActionsInput.prototype['Location'] = undefined;
...
export default StartFleetActionsInput;
