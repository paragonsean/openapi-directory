...
* @readonly
*/
export default class GameServerUtilizationStatus {
    ...
    /**
    * Returns a <code>GameServerUtilizationStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/GameServerUtilizationStatus} The enum <code>GameServerUtilizationStatus</code> value.
    */
