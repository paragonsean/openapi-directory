...
/**
 * The DescribeMatchmakingConfigurationsOutput model module.
 * @module model/DescribeMatchmakingConfigurationsOutput
 * @version 2015-10-01
 */
class DescribeMatchmakingConfigurationsOutput {
    /**
     * Constructs a new <code>DescribeMatchmakingConfigurationsOutput</code>.
     * @alias module:model/DescribeMatchmakingConfigurationsOutput
     */
    constructor() { 
        
        DescribeMatchmakingConfigurationsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeMatchmakingConfigurationsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeMatchmakingConfigurationsOutput} obj Optional instance to populate.
     * @return {module:model/DescribeMatchmakingConfigurationsOutput} The populated <code>DescribeMatchmakingConfigurationsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeMatchmakingConfigurationsOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeMatchmakingConfigurationsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeMatchmakingConfigurationsOutput</code>.
     */
 ...
 */
DescribeMatchmakingConfigurationsOutput.prototype['Configurations'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeMatchmakingConfigurationsOutput.prototype['NextToken'] = undefined;
...
export default DescribeMatchmakingConfigurationsOutput;
