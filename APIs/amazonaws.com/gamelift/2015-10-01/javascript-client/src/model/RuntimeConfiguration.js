...
/**
 * The RuntimeConfiguration model module.
 * @module model/RuntimeConfiguration
 * @version 2015-10-01
 */
class RuntimeConfiguration {
    /**
     * Constructs a new <code>RuntimeConfiguration</code>.
     ...
     * @alias module:model/RuntimeConfiguration
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>RuntimeConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RuntimeConfiguration} obj Optional instance to populate.
     * @return {module:model/RuntimeConfiguration} The populated <code>RuntimeConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RuntimeConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>RuntimeConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RuntimeConfiguration</code>.
     */
