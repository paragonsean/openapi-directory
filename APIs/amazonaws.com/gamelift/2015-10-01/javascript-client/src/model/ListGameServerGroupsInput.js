...
/**
 * The ListGameServerGroupsInput model module.
 * @module model/ListGameServerGroupsInput
 * @version 2015-10-01
 */
class ListGameServerGroupsInput {
    /**
     * Constructs a new <code>ListGameServerGroupsInput</code>.
     * @alias module:model/ListGameServerGroupsInput
     */
    constructor() { 
        
        ListGameServerGroupsInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListGameServerGroupsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListGameServerGroupsInput} obj Optional instance to populate.
     * @return {module:model/ListGameServerGroupsInput} The populated <code>ListGameServerGroupsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListGameServerGroupsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListGameServerGroupsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListGameServerGroupsInput</code>.
     */
 ...
 * @member {Number} Limit
 */
ListGameServerGroupsInput.prototype['Limit'] = undefined;

/**
 * @member {String} NextToken
 */
ListGameServerGroupsInput.prototype['NextToken'] = undefined;
...
export default ListGameServerGroupsInput;
