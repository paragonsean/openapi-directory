...
import CreateAliasOutputAlias from './CreateAliasOutputAlias';

/**
 * The CreateAliasOutput model module.
 * @module model/CreateAliasOutput
 * @version 2015-10-01
 */
class CreateAliasOutput {
    /**
     * Constructs a new <code>CreateAliasOutput</code>.
     * @alias module:model/CreateAliasOutput
     */
    constructor() { 
        
        CreateAliasOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateAliasOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateAliasOutput} obj Optional instance to populate.
     * @return {module:model/CreateAliasOutput} The populated <code>CreateAliasOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateAliasOutput();

            if (data.hasOwnProperty('Alias')) {
                obj['Alias'] = CreateAliasOutputAlias.constructFromObject(data['Alias']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateAliasOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateAliasOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Alias`
        if (data['Alias']) { // data not null
          CreateAliasOutputAlias.validateJSON(data['Alias']);
        }
...
/**
 * @member {module:model/CreateAliasOutputAlias} Alias
 */
CreateAliasOutput.prototype['Alias'] = undefined;
...
export default CreateAliasOutput;
