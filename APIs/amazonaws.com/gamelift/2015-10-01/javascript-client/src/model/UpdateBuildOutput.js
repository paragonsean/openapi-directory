...
import UpdateBuildOutputBuild from './UpdateBuildOutputBuild';

/**
 * The UpdateBuildOutput model module.
 * @module model/UpdateBuildOutput
 * @version 2015-10-01
 */
class UpdateBuildOutput {
    /**
     * Constructs a new <code>UpdateBuildOutput</code>.
     * @alias module:model/UpdateBuildOutput
     */
    constructor() { 
        
        UpdateBuildOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateBuildOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateBuildOutput} obj Optional instance to populate.
     * @return {module:model/UpdateBuildOutput} The populated <code>UpdateBuildOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateBuildOutput();

            if (data.hasOwnProperty('Build')) {
                obj['Build'] = UpdateBuildOutputBuild.constructFromObject(data['Build']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateBuildOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateBuildOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Build`
        if (data['Build']) { // data not null
          UpdateBuildOutputBuild.validateJSON(data['Build']);
        }
...
/**
 * @member {module:model/UpdateBuildOutputBuild} Build
 */
UpdateBuildOutput.prototype['Build'] = undefined;
...
export default UpdateBuildOutput;
