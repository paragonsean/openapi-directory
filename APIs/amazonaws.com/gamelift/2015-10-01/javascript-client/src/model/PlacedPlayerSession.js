...
/**
 * The PlacedPlayerSession model module.
 * @module model/PlacedPlayerSession
 * @version 2015-10-01
 */
class PlacedPlayerSession {
    /**
     * Constructs a new <code>PlacedPlayerSession</code>.
     ...
     * @alias module:model/PlacedPlayerSession
     */
    constructor() { 
        
        PlacedPlayerSession.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PlacedPlayerSession</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PlacedPlayerSession} obj Optional instance to populate.
     * @return {module:model/PlacedPlayerSession} The populated <code>PlacedPlayerSession</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PlacedPlayerSession();
    ...
    /**
     * Validates the JSON data with respect to <code>PlacedPlayerSession</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PlacedPlayerSession</code>.
     */
 ...
 */
PlacedPlayerSession.prototype['PlayerId'] = undefined;

/**
 * @member {String} PlayerSessionId
 */
PlacedPlayerSession.prototype['PlayerSessionId'] = undefined;
...
export default PlacedPlayerSession;
