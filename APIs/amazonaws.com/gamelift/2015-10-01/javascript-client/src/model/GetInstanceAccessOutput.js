...
import GetInstanceAccessOutputInstanceAccess from './GetInstanceAccessOutputInstanceAccess';

/**
 * The GetInstanceAccessOutput model module.
 * @module model/GetInstanceAccessOutput
 * @version 2015-10-01
 */
class GetInstanceAccessOutput {
    /**
     * Constructs a new <code>GetInstanceAccessOutput</code>.
     * @alias module:model/GetInstanceAccessOutput
     */
    constructor() { 
        
        GetInstanceAccessOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetInstanceAccessOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetInstanceAccessOutput} obj Optional instance to populate.
     * @return {module:model/GetInstanceAccessOutput} The populated <code>GetInstanceAccessOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetInstanceAccessOutput();

            if (data.hasOwnProperty('InstanceAccess')) {
                obj['InstanceAccess'] = GetInstanceAccessOutputInstanceAccess.constructFromObject(data['InstanceAccess']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetInstanceAccessOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetInstanceAccessOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `InstanceAccess`
        if (data['InstanceAccess']) { // data not null
          GetInstanceAccessOutputInstanceAccess.validateJSON(data['InstanceAccess']);
        }
...
/**
 * @member {module:model/GetInstanceAccessOutputInstanceAccess} InstanceAccess
 */
GetInstanceAccessOutput.prototype['InstanceAccess'] = undefined;
...
export default GetInstanceAccessOutput;
