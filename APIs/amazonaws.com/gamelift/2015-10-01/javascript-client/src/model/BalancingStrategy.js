...
* @readonly
*/
export default class BalancingStrategy {
    ...
    /**
    * Returns a <code>BalancingStrategy</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/BalancingStrategy} The enum <code>BalancingStrategy</code> value.
    */
