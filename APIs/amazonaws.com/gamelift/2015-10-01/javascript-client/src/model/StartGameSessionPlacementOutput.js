...
import StartGameSessionPlacementOutputGameSessionPlacement from './StartGameSessionPlacementOutputGameSessionPlacement';

/**
 * The StartGameSessionPlacementOutput model module.
 * @module model/StartGameSessionPlacementOutput
 * @version 2015-10-01
 */
class StartGameSessionPlacementOutput {
    /**
     * Constructs a new <code>StartGameSessionPlacementOutput</code>.
     * @alias module:model/StartGameSessionPlacementOutput
     */
    constructor() { 
        
        StartGameSessionPlacementOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartGameSessionPlacementOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartGameSessionPlacementOutput} obj Optional instance to populate.
     * @return {module:model/StartGameSessionPlacementOutput} The populated <code>StartGameSessionPlacementOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartGameSessionPlacementOutput();

            if (data.hasOwnProperty('GameSessionPlacement')) {
                obj['GameSessionPlacement'] = StartGameSessionPlacementOutputGameSessionPlacement.constructFromObject(data['GameSessionPlacement']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StartGameSessionPlacementOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartGameSessionPlacementOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GameSessionPlacement`
        if (data['GameSessionPlacement']) { // data not null
          StartGameSessionPlacementOutputGameSessionPlacement.validateJSON(data['GameSessionPlacement']);
        }
...
/**
 * @member {module:model/StartGameSessionPlacementOutputGameSessionPlacement} GameSessionPlacement
 */
StartGameSessionPlacementOutput.prototype['GameSessionPlacement'] = undefined;
...
export default StartGameSessionPlacementOutput;
