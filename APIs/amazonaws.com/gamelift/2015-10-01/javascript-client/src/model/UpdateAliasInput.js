...
import UpdateAliasInputRoutingStrategy from './UpdateAliasInputRoutingStrategy';

/**
 * The UpdateAliasInput model module.
 * @module model/UpdateAliasInput
 * @version 2015-10-01
 */
class UpdateAliasInput {
    /**
     * Constructs a new <code>UpdateAliasInput</code>.
     * @alias module:model/UpdateAliasInput
     * @param aliasId {String} 
     */
    constructor(aliasId) { 
        
        UpdateAliasInput.initialize(this, aliasId);
    }
    ...
    /**
     * Constructs a <code>UpdateAliasInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateAliasInput} obj Optional instance to populate.
     * @return {module:model/UpdateAliasInput} The populated <code>UpdateAliasInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateAliasInput();
            ...
            if (data.hasOwnProperty('RoutingStrategy')) {
                obj['RoutingStrategy'] = UpdateAliasInputRoutingStrategy.constructFromObject(data['RoutingStrategy']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateAliasInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateAliasInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateAliasInput.RequiredProperties) {
        ...
        if (data['RoutingStrategy']) { // data not null
          UpdateAliasInputRoutingStrategy.validateJSON(data['RoutingStrategy']);
        }
...
UpdateAliasInput.RequiredProperties = ["AliasId"];

/**
 * @member {String} AliasId
 */
UpdateAliasInput.prototype['AliasId'] = undefined;

/**
 * @member {String} Name
 */
UpdateAliasInput.prototype['Name'] = undefined;

/**
 * @member {String} Description
 */
UpdateAliasInput.prototype['Description'] = undefined;

/**
 * @member {module:model/UpdateAliasInputRoutingStrategy} RoutingStrategy
 */
UpdateAliasInput.prototype['RoutingStrategy'] = undefined;
...
export default UpdateAliasInput;
