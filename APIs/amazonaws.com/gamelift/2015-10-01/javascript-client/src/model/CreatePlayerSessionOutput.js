...
import CreatePlayerSessionOutputPlayerSession from './CreatePlayerSessionOutputPlayerSession';

/**
 * The CreatePlayerSessionOutput model module.
 * @module model/CreatePlayerSessionOutput
 * @version 2015-10-01
 */
class CreatePlayerSessionOutput {
    /**
     * Constructs a new <code>CreatePlayerSessionOutput</code>.
     * @alias module:model/CreatePlayerSessionOutput
     */
    constructor() { 
        
        CreatePlayerSessionOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreatePlayerSessionOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePlayerSessionOutput} obj Optional instance to populate.
     * @return {module:model/CreatePlayerSessionOutput} The populated <code>CreatePlayerSessionOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePlayerSessionOutput();

            if (data.hasOwnProperty('PlayerSession')) {
                obj['PlayerSession'] = CreatePlayerSessionOutputPlayerSession.constructFromObject(data['PlayerSession']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePlayerSessionOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePlayerSessionOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `PlayerSession`
        if (data['PlayerSession']) { // data not null
          CreatePlayerSessionOutputPlayerSession.validateJSON(data['PlayerSession']);
        }
...
/**
 * @member {module:model/CreatePlayerSessionOutputPlayerSession} PlayerSession
 */
CreatePlayerSessionOutput.prototype['PlayerSession'] = undefined;
...
export default CreatePlayerSessionOutput;
