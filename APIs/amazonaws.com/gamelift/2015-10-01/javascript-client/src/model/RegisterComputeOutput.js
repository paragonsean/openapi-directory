...
/**
 * The RegisterComputeOutput model module.
 * @module model/RegisterComputeOutput
 * @version 2015-10-01
 */
class RegisterComputeOutput {
    /**
     * Constructs a new <code>RegisterComputeOutput</code>.
     * @alias module:model/RegisterComputeOutput
     */
    constructor() { 
        
        RegisterComputeOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RegisterComputeOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RegisterComputeOutput} obj Optional instance to populate.
     * @return {module:model/RegisterComputeOutput} The populated <code>RegisterComputeOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RegisterComputeOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>RegisterComputeOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RegisterComputeOutput</code>.
     */
 ...
 */
RegisterComputeOutput.prototype['Compute'] = undefined;
...
export default RegisterComputeOutput;
