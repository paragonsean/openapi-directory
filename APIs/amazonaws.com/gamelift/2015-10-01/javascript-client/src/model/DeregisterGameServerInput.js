...
/**
 * The DeregisterGameServerInput model module.
 * @module model/DeregisterGameServerInput
 * @version 2015-10-01
 */
class DeregisterGameServerInput {
    /**
     * Constructs a new <code>DeregisterGameServerInput</code>.
     * @alias module:model/DeregisterGameServerInput
     * @param gameServerGroupName {String} 
     * @param gameServerId {String} 
     */
    constructor(gameServerGroupName, gameServerId) { 
        
        DeregisterGameServerInput.initialize(this, gameServerGroupName, gameServerId);
    }
    ...
    /**
     * Constructs a <code>DeregisterGameServerInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeregisterGameServerInput} obj Optional instance to populate.
     * @return {module:model/DeregisterGameServerInput} The populated <code>DeregisterGameServerInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeregisterGameServerInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeregisterGameServerInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeregisterGameServerInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeregisterGameServerInput.RequiredProperties) {
...
DeregisterGameServerInput.RequiredProperties = ["GameServerGroupName", "GameServerId"];

/**
 * @member {String} GameServerGroupName
 */
DeregisterGameServerInput.prototype['GameServerGroupName'] = undefined;

/**
 * @member {String} GameServerId
 */
DeregisterGameServerInput.prototype['GameServerId'] = undefined;
...
export default DeregisterGameServerInput;
