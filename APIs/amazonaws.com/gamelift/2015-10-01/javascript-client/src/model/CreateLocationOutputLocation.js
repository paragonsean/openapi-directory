...
/**
 * The CreateLocationOutputLocation model module.
 * @module model/CreateLocationOutputLocation
 * @version 2015-10-01
 */
class CreateLocationOutputLocation {
    /**
     * Constructs a new <code>CreateLocationOutputLocation</code>.
     * @alias module:model/CreateLocationOutputLocation
     * @implements module:model/LocationModel
     */
    constructor() { 
        LocationModel.initialize(this);
        CreateLocationOutputLocation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateLocationOutputLocation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateLocationOutputLocation} obj Optional instance to populate.
     * @return {module:model/CreateLocationOutputLocation} The populated <code>CreateLocationOutputLocation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateLocationOutputLocation();
            LocationModel.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreateLocationOutputLocation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateLocationOutputLocation</code>.
     */
 ...
 */
CreateLocationOutputLocation.prototype['LocationName'] = undefined;

/**
 * @member {String} LocationArn
 */
CreateLocationOutputLocation.prototype['LocationArn'] = undefined;


// Implement LocationModel interface:
/**
 * @member {String} LocationName
 */
LocationModel.prototype['LocationName'] = undefined;
/**
 * @member {String} LocationArn
 */
LocationModel.prototype['LocationArn'] = undefined;




export default CreateLocationOutputLocation;
