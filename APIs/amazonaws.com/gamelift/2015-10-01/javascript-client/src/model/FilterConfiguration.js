...
/**
 * The FilterConfiguration model module.
 * @module model/FilterConfiguration
 * @version 2015-10-01
 */
class FilterConfiguration {
    /**
     * Constructs a new <code>FilterConfiguration</code>.
     ...
     * @alias module:model/FilterConfiguration
     */
    constructor() { 
        
        FilterConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FilterConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FilterConfiguration} obj Optional instance to populate.
     * @return {module:model/FilterConfiguration} The populated <code>FilterConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FilterConfiguration();

            if (data.hasOwnProperty('AllowedLocations')) {
                obj['AllowedLocations'] = ApiClient.convertToType(data['AllowedLocations'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FilterConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FilterConfiguration</code>.
     */
    static validateJSON(data) {
        // validate the optional field `AllowedLocations`
        if (data['AllowedLocations']) { // data not null
          Array.validateJSON(data['AllowedLocations']);
        }
...
/**
 * @member {Array} AllowedLocations
 */
FilterConfiguration.prototype['AllowedLocations'] = undefined;
