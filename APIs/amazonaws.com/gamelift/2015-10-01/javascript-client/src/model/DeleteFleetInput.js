...
/**
 * The DeleteFleetInput model module.
 * @module model/DeleteFleetInput
 * @version 2015-10-01
 */
class DeleteFleetInput {
    /**
     * Constructs a new <code>DeleteFleetInput</code>.
     * @alias module:model/DeleteFleetInput
     * @param fleetId {String} 
     */
    constructor(fleetId) { 
        
        DeleteFleetInput.initialize(this, fleetId);
    }
    ...
    /**
     * Constructs a <code>DeleteFleetInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteFleetInput} obj Optional instance to populate.
     * @return {module:model/DeleteFleetInput} The populated <code>DeleteFleetInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteFleetInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteFleetInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteFleetInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteFleetInput.RequiredProperties) {
...
DeleteFleetInput.RequiredProperties = ["FleetId"];

/**
 * @member {String} FleetId
 */
DeleteFleetInput.prototype['FleetId'] = undefined;
...
export default DeleteFleetInput;
