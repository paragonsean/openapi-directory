...
/**
 * The DeleteVpcPeeringConnectionInput model module.
 * @module model/DeleteVpcPeeringConnectionInput
 * @version 2015-10-01
 */
class DeleteVpcPeeringConnectionInput {
    /**
     * Constructs a new <code>DeleteVpcPeeringConnectionInput</code>.
     * @alias module:model/DeleteVpcPeeringConnectionInput
     * @param fleetId {String} 
     * @param vpcPeeringConnectionId {String} 
     */
    constructor(fleetId, vpcPeeringConnectionId) { 
        
        DeleteVpcPeeringConnectionInput.initialize(this, fleetId, vpcPeeringConnectionId);
    }
     ...
     */
    static initialize(obj, fleetId, vpcPeeringConnectionId) { 
        obj['FleetId'] = fleetId;
        obj['VpcPeeringConnectionId'] = vpcPeeringConnectionId;
    }

    /**
     * Constructs a <code>DeleteVpcPeeringConnectionInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteVpcPeeringConnectionInput} obj Optional instance to populate.
     * @return {module:model/DeleteVpcPeeringConnectionInput} The populated <code>DeleteVpcPeeringConnectionInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteVpcPeeringConnectionInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteVpcPeeringConnectionInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteVpcPeeringConnectionInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteVpcPeeringConnectionInput.RequiredProperties) {
        ...
        if (data['VpcPeeringConnectionId']) { // data not null
          String.validateJSON(data['VpcPeeringConnectionId']);
        }
...
DeleteVpcPeeringConnectionInput.RequiredProperties = ["FleetId", "VpcPeeringConnectionId"];

/**
 * @member {String} FleetId
 */
DeleteVpcPeeringConnectionInput.prototype['FleetId'] = undefined;

/**
 * @member {String} VpcPeeringConnectionId
 */
DeleteVpcPeeringConnectionInput.prototype['VpcPeeringConnectionId'] = undefined;
...
export default DeleteVpcPeeringConnectionInput;
