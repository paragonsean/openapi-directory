...
/**
 * The GetComputeAccessOutputCredentials model module.
 * @module model/GetComputeAccessOutputCredentials
 * @version 2015-10-01
 */
class GetComputeAccessOutputCredentials {
    /**
     * Constructs a new <code>GetComputeAccessOutputCredentials</code>.
     * @alias module:model/GetComputeAccessOutputCredentials
     * @implements module:model/AwsCredentials
     */
    constructor() { 
        AwsCredentials.initialize(this);
        GetComputeAccessOutputCredentials.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetComputeAccessOutputCredentials</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetComputeAccessOutputCredentials} obj Optional instance to populate.
     * @return {module:model/GetComputeAccessOutputCredentials} The populated <code>GetComputeAccessOutputCredentials</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetComputeAccessOutputCredentials();
            AwsCredentials.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>GetComputeAccessOutputCredentials</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetComputeAccessOutputCredentials</code>.
     */
 ...
 */
GetComputeAccessOutputCredentials.prototype['AccessKeyId'] = undefined;

/**
 * @member {String} SecretAccessKey
 */
GetComputeAccessOutputCredentials.prototype['SecretAccessKey'] = undefined;

/**
 * @member {String} SessionToken
 */
GetComputeAccessOutputCredentials.prototype['SessionToken'] = undefined;


// Implement AwsCredentials interface:
/**
 * @member {String} AccessKeyId
 */
...
export default GetComputeAccessOutputCredentials;
