...
/**
 * The DescribeMatchmakingInput model module.
 * @module model/DescribeMatchmakingInput
 * @version 2015-10-01
 */
class DescribeMatchmakingInput {
    /**
     * Constructs a new <code>DescribeMatchmakingInput</code>.
     * @alias module:model/DescribeMatchmakingInput
     * @param ticketIds {Array} 
     */
    constructor(ticketIds) { 
        
        DescribeMatchmakingInput.initialize(this, ticketIds);
    }
    ...
    /**
     * Constructs a <code>DescribeMatchmakingInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeMatchmakingInput} obj Optional instance to populate.
     * @return {module:model/DescribeMatchmakingInput} The populated <code>DescribeMatchmakingInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeMatchmakingInput();

            if (data.hasOwnProperty('TicketIds')) {
                obj['TicketIds'] = ApiClient.convertToType(data['TicketIds'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeMatchmakingInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeMatchmakingInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeMatchmakingInput.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `TicketIds`
        if (data['TicketIds']) { // data not null
          Array.validateJSON(data['TicketIds']);
        }
...
DescribeMatchmakingInput.RequiredProperties = ["TicketIds"];

/**
 * @member {Array} TicketIds
 */
DescribeMatchmakingInput.prototype['TicketIds'] = undefined;
...
export default DescribeMatchmakingInput;
