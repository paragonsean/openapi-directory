...
/**
 * The DeleteGameSessionQueueInput model module.
 * @module model/DeleteGameSessionQueueInput
 * @version 2015-10-01
 */
class DeleteGameSessionQueueInput {
    /**
     * Constructs a new <code>DeleteGameSessionQueueInput</code>.
     * @alias module:model/DeleteGameSessionQueueInput
     * @param name {String} 
     */
    constructor(name) { 
        
        DeleteGameSessionQueueInput.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>DeleteGameSessionQueueInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteGameSessionQueueInput} obj Optional instance to populate.
     * @return {module:model/DeleteGameSessionQueueInput} The populated <code>DeleteGameSessionQueueInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteGameSessionQueueInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteGameSessionQueueInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteGameSessionQueueInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteGameSessionQueueInput.RequiredProperties) {
...
DeleteGameSessionQueueInput.RequiredProperties = ["Name"];

/**
 * @member {String} Name
 */
DeleteGameSessionQueueInput.prototype['Name'] = undefined;
...
export default DeleteGameSessionQueueInput;
