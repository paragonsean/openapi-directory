...
* @readonly
*/
export default class FlexMatchMode {
    ...
    /**
    * Returns a <code>FlexMatchMode</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FlexMatchMode} The enum <code>FlexMatchMode</code> value.
    */
