...
/**
 * The DescribeMatchmakingConfigurationsInput model module.
 * @module model/DescribeMatchmakingConfigurationsInput
 * @version 2015-10-01
 */
class DescribeMatchmakingConfigurationsInput {
    /**
     * Constructs a new <code>DescribeMatchmakingConfigurationsInput</code>.
     * @alias module:model/DescribeMatchmakingConfigurationsInput
     */
    constructor() { 
        
        DescribeMatchmakingConfigurationsInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeMatchmakingConfigurationsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeMatchmakingConfigurationsInput} obj Optional instance to populate.
     * @return {module:model/DescribeMatchmakingConfigurationsInput} The populated <code>DescribeMatchmakingConfigurationsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeMatchmakingConfigurationsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeMatchmakingConfigurationsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeMatchmakingConfigurationsInput</code>.
     */
 ...
 * @member {Array} Names
 */
DescribeMatchmakingConfigurationsInput.prototype['Names'] = undefined;

/**
 * @member {String} RuleSetName
 */
DescribeMatchmakingConfigurationsInput.prototype['RuleSetName'] = undefined;

/**
 * @member {Number} Limit
 */
DescribeMatchmakingConfigurationsInput.prototype['Limit'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeMatchmakingConfigurationsInput.prototype['NextToken'] = undefined;
...
export default DescribeMatchmakingConfigurationsInput;
