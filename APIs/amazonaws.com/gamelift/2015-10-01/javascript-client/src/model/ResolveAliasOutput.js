...
/**
 * The ResolveAliasOutput model module.
 * @module model/ResolveAliasOutput
 * @version 2015-10-01
 */
class ResolveAliasOutput {
    /**
     * Constructs a new <code>ResolveAliasOutput</code>.
     * @alias module:model/ResolveAliasOutput
     */
    constructor() { 
        
        ResolveAliasOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResolveAliasOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResolveAliasOutput} obj Optional instance to populate.
     * @return {module:model/ResolveAliasOutput} The populated <code>ResolveAliasOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResolveAliasOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>ResolveAliasOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResolveAliasOutput</code>.
     */
 ...
 */
ResolveAliasOutput.prototype['FleetId'] = undefined;

/**
 * @member {String} FleetArn
 */
ResolveAliasOutput.prototype['FleetArn'] = undefined;
...
export default ResolveAliasOutput;
