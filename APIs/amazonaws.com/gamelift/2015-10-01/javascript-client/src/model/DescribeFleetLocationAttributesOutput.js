...
/**
 * The DescribeFleetLocationAttributesOutput model module.
 * @module model/DescribeFleetLocationAttributesOutput
 * @version 2015-10-01
 */
class DescribeFleetLocationAttributesOutput {
    /**
     * Constructs a new <code>DescribeFleetLocationAttributesOutput</code>.
     * @alias module:model/DescribeFleetLocationAttributesOutput
     */
    constructor() { 
        
        DescribeFleetLocationAttributesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeFleetLocationAttributesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeFleetLocationAttributesOutput} obj Optional instance to populate.
     * @return {module:model/DescribeFleetLocationAttributesOutput} The populated <code>DescribeFleetLocationAttributesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeFleetLocationAttributesOutput();
            ...
            if (data.hasOwnProperty('LocationAttributes')) {
                obj['LocationAttributes'] = ApiClient.convertToType(data['LocationAttributes'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeFleetLocationAttributesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeFleetLocationAttributesOutput</code>.
     */
    static validateJSON(data) {
        ...
        // validate the optional field `LocationAttributes`
        if (data['LocationAttributes']) { // data not null
          Array.validateJSON(data['LocationAttributes']);
        }
 ...
 */
DescribeFleetLocationAttributesOutput.prototype['FleetId'] = undefined;

/**
 * @member {String} FleetArn
 */
DescribeFleetLocationAttributesOutput.prototype['FleetArn'] = undefined;

/**
 * @member {Array} LocationAttributes
 */
DescribeFleetLocationAttributesOutput.prototype['LocationAttributes'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeFleetLocationAttributesOutput.prototype['NextToken'] = undefined;
...
export default DescribeFleetLocationAttributesOutput;
