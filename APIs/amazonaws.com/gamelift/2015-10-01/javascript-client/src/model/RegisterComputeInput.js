...
/**
 * The RegisterComputeInput model module.
 * @module model/RegisterComputeInput
 * @version 2015-10-01
 */
class RegisterComputeInput {
    /**
     * Constructs a new <code>RegisterComputeInput</code>.
     * @alias module:model/RegisterComputeInput
     * @param fleetId {String} 
     * @param computeName {String} 
     */
    constructor(fleetId, computeName) { 
        
        RegisterComputeInput.initialize(this, fleetId, computeName);
    }
    ...
    /**
     * Constructs a <code>RegisterComputeInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RegisterComputeInput} obj Optional instance to populate.
     * @return {module:model/RegisterComputeInput} The populated <code>RegisterComputeInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RegisterComputeInput();
    ...
    /**
     * Validates the JSON data with respect to <code>RegisterComputeInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RegisterComputeInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RegisterComputeInput.RequiredProperties) {
        ...
        if (data['CertificatePath']) { // data not null
          String.validateJSON(data['CertificatePath']);
        }
...
RegisterComputeInput.RequiredProperties = ["FleetId", "ComputeName"];

/**
 * @member {String} FleetId
 */
RegisterComputeInput.prototype['FleetId'] = undefined;

/**
 * @member {String} ComputeName
 */
RegisterComputeInput.prototype['ComputeName'] = undefined;

/**
 * @member {String} CertificatePath
 */
RegisterComputeInput.prototype['CertificatePath'] = undefined;

/**
 * @member {String} DnsName
 */
RegisterComputeInput.prototype['DnsName'] = undefined;

/**
 * @member {String} IpAddress
 */
RegisterComputeInput.prototype['IpAddress'] = undefined;

/**
 * @member {String} Location
 */
RegisterComputeInput.prototype['Location'] = undefined;
...
export default RegisterComputeInput;
