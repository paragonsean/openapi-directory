...
import UpdateGameSessionQueueOutputGameSessionQueue from './UpdateGameSessionQueueOutputGameSessionQueue';

/**
 * The UpdateGameSessionQueueOutput model module.
 * @module model/UpdateGameSessionQueueOutput
 * @version 2015-10-01
 */
class UpdateGameSessionQueueOutput {
    /**
     * Constructs a new <code>UpdateGameSessionQueueOutput</code>.
     * @alias module:model/UpdateGameSessionQueueOutput
     */
    constructor() { 
        
        UpdateGameSessionQueueOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateGameSessionQueueOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateGameSessionQueueOutput} obj Optional instance to populate.
     * @return {module:model/UpdateGameSessionQueueOutput} The populated <code>UpdateGameSessionQueueOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateGameSessionQueueOutput();

            if (data.hasOwnProperty('GameSessionQueue')) {
                obj['GameSessionQueue'] = UpdateGameSessionQueueOutputGameSessionQueue.constructFromObject(data['GameSessionQueue']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateGameSessionQueueOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateGameSessionQueueOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GameSessionQueue`
        if (data['GameSessionQueue']) { // data not null
          UpdateGameSessionQueueOutputGameSessionQueue.validateJSON(data['GameSessionQueue']);
        }
...
/**
 * @member {module:model/UpdateGameSessionQueueOutputGameSessionQueue} GameSessionQueue
 */
UpdateGameSessionQueueOutput.prototype['GameSessionQueue'] = undefined;
...
export default UpdateGameSessionQueueOutput;
