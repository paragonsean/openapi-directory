...
/**
 * The PriorityConfiguration model module.
 * @module model/PriorityConfiguration
 * @version 2015-10-01
 */
class PriorityConfiguration {
    /**
     * Constructs a new <code>PriorityConfiguration</code>.
     ...
     * @alias module:model/PriorityConfiguration
     */
    constructor() { 
        
        PriorityConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PriorityConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PriorityConfiguration} obj Optional instance to populate.
     * @return {module:model/PriorityConfiguration} The populated <code>PriorityConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PriorityConfiguration();

            if (data.hasOwnProperty('PriorityOrder')) {
                obj['PriorityOrder'] = ApiClient.convertToType(data['PriorityOrder'], Array);
            }
            if (data.hasOwnProperty('LocationOrder')) {
                obj['LocationOrder'] = ApiClient.convertToType(data['LocationOrder'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PriorityConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PriorityConfiguration</code>.
     */
    static validateJSON(data) {
        // validate the optional field `PriorityOrder`
        if (data['PriorityOrder']) { // data not null
          Array.validateJSON(data['PriorityOrder']);
        }
        // validate the optional field `LocationOrder`
        if (data['LocationOrder']) { // data not null
          Array.validateJSON(data['LocationOrder']);
        }
...
/**
 * @member {Array} PriorityOrder
 */
PriorityConfiguration.prototype['PriorityOrder'] = undefined;

/**
 * @member {Array} LocationOrder
 */
PriorityConfiguration.prototype['LocationOrder'] = undefined;
