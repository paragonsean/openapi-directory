...
/**
 * The StopMatchmakingInput model module.
 * @module model/StopMatchmakingInput
 * @version 2015-10-01
 */
class StopMatchmakingInput {
    /**
     * Constructs a new <code>StopMatchmakingInput</code>.
     * @alias module:model/StopMatchmakingInput
     * @param ticketId {String} 
     */
    constructor(ticketId) { 
        
        StopMatchmakingInput.initialize(this, ticketId);
    }
    ...
    /**
     * Constructs a <code>StopMatchmakingInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StopMatchmakingInput} obj Optional instance to populate.
     * @return {module:model/StopMatchmakingInput} The populated <code>StopMatchmakingInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StopMatchmakingInput();
    ...
    /**
     * Validates the JSON data with respect to <code>StopMatchmakingInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StopMatchmakingInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StopMatchmakingInput.RequiredProperties) {
...
StopMatchmakingInput.RequiredProperties = ["TicketId"];

/**
 * @member {String} TicketId
 */
StopMatchmakingInput.prototype['TicketId'] = undefined;
...
export default StopMatchmakingInput;
