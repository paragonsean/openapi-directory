...
/**
 * The DescribeMatchmakingRuleSetsOutput model module.
 * @module model/DescribeMatchmakingRuleSetsOutput
 * @version 2015-10-01
 */
class DescribeMatchmakingRuleSetsOutput {
    /**
     * Constructs a new <code>DescribeMatchmakingRuleSetsOutput</code>.
     * @alias module:model/DescribeMatchmakingRuleSetsOutput
     * @param ruleSets {Array} 
     */
    constructor(ruleSets) { 
        
        DescribeMatchmakingRuleSetsOutput.initialize(this, ruleSets);
    }
     ...
     */
    static initialize(obj, ruleSets) { 
        obj['RuleSets'] = ruleSets;
    }

    /**
     * Constructs a <code>DescribeMatchmakingRuleSetsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeMatchmakingRuleSetsOutput} obj Optional instance to populate.
     * @return {module:model/DescribeMatchmakingRuleSetsOutput} The populated <code>DescribeMatchmakingRuleSetsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeMatchmakingRuleSetsOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeMatchmakingRuleSetsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeMatchmakingRuleSetsOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeMatchmakingRuleSetsOutput.RequiredProperties) {
...
DescribeMatchmakingRuleSetsOutput.RequiredProperties = ["RuleSets"];

/**
 * @member {Array} RuleSets
 */
DescribeMatchmakingRuleSetsOutput.prototype['RuleSets'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeMatchmakingRuleSetsOutput.prototype['NextToken'] = undefined;
...
export default DescribeMatchmakingRuleSetsOutput;
