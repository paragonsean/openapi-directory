...
/**
 * The CreateBuildOutputBuild model module.
 * @module model/CreateBuildOutputBuild
 * @version 2015-10-01
 */
class CreateBuildOutputBuild {
    /**
     * Constructs a new <code>CreateBuildOutputBuild</code>.
     * @alias module:model/CreateBuildOutputBuild
     * @implements module:model/Build
     */
    constructor() { 
        Build.initialize(this);
        CreateBuildOutputBuild.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateBuildOutputBuild</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateBuildOutputBuild} obj Optional instance to populate.
     * @return {module:model/CreateBuildOutputBuild} The populated <code>CreateBuildOutputBuild</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateBuildOutputBuild();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateBuildOutputBuild</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateBuildOutputBuild</code>.
     */
 ...
 */
CreateBuildOutputBuild.prototype['BuildId'] = undefined;

/**
 * @member {String} BuildArn
 */
CreateBuildOutputBuild.prototype['BuildArn'] = undefined;

/**
 * @member {String} Name
 */
CreateBuildOutputBuild.prototype['Name'] = undefined;

/**
 * @member {String} Version
 */
CreateBuildOutputBuild.prototype['Version'] = undefined;

/**
 * @member {module:model/BuildStatus} Status
 */
CreateBuildOutputBuild.prototype['Status'] = undefined;

/**
 * @member {Number} SizeOnDisk
 */
CreateBuildOutputBuild.prototype['SizeOnDisk'] = undefined;

/**
 * @member {module:model/OperatingSystem} OperatingSystem
 */
CreateBuildOutputBuild.prototype['OperatingSystem'] = undefined;

/**
 * @member {Date} CreationTime
 */
CreateBuildOutputBuild.prototype['CreationTime'] = undefined;

/**
 * @member {String} ServerSdkVersion
 */
CreateBuildOutputBuild.prototype['ServerSdkVersion'] = undefined;
...
export default CreateBuildOutputBuild;
