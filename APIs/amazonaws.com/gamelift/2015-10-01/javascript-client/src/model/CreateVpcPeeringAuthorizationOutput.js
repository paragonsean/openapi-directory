...
import CreateVpcPeeringAuthorizationOutputVpcPeeringAuthorization from './CreateVpcPeeringAuthorizationOutputVpcPeeringAuthorization';

/**
 * The CreateVpcPeeringAuthorizationOutput model module.
 * @module model/CreateVpcPeeringAuthorizationOutput
 * @version 2015-10-01
 */
class CreateVpcPeeringAuthorizationOutput {
    /**
     * Constructs a new <code>CreateVpcPeeringAuthorizationOutput</code>.
     * @alias module:model/CreateVpcPeeringAuthorizationOutput
     */
    constructor() { 
        
        CreateVpcPeeringAuthorizationOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateVpcPeeringAuthorizationOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateVpcPeeringAuthorizationOutput} obj Optional instance to populate.
     * @return {module:model/CreateVpcPeeringAuthorizationOutput} The populated <code>CreateVpcPeeringAuthorizationOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateVpcPeeringAuthorizationOutput();

            if (data.hasOwnProperty('VpcPeeringAuthorization')) {
                obj['VpcPeeringAuthorization'] = CreateVpcPeeringAuthorizationOutputVpcPeeringAuthorization.constructFromObject(data['VpcPeeringAuthorization']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateVpcPeeringAuthorizationOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateVpcPeeringAuthorizationOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `VpcPeeringAuthorization`
        if (data['VpcPeeringAuthorization']) { // data not null
          CreateVpcPeeringAuthorizationOutputVpcPeeringAuthorization.validateJSON(data['VpcPeeringAuthorization']);
        }
...
/**
 * @member {module:model/CreateVpcPeeringAuthorizationOutputVpcPeeringAuthorization} VpcPeeringAuthorization
 */
CreateVpcPeeringAuthorizationOutput.prototype['VpcPeeringAuthorization'] = undefined;
...
export default CreateVpcPeeringAuthorizationOutput;
