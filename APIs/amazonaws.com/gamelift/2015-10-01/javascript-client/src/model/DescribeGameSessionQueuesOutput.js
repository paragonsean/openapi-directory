...
/**
 * The DescribeGameSessionQueuesOutput model module.
 * @module model/DescribeGameSessionQueuesOutput
 * @version 2015-10-01
 */
class DescribeGameSessionQueuesOutput {
    /**
     * Constructs a new <code>DescribeGameSessionQueuesOutput</code>.
     * @alias module:model/DescribeGameSessionQueuesOutput
     */
    constructor() { 
        
        DescribeGameSessionQueuesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeGameSessionQueuesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeGameSessionQueuesOutput} obj Optional instance to populate.
     * @return {module:model/DescribeGameSessionQueuesOutput} The populated <code>DescribeGameSessionQueuesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeGameSessionQueuesOutput();

            if (data.hasOwnProperty('GameSessionQueues')) {
                obj['GameSessionQueues'] = ApiClient.convertToType(data['GameSessionQueues'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeGameSessionQueuesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeGameSessionQueuesOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GameSessionQueues`
        if (data['GameSessionQueues']) { // data not null
          Array.validateJSON(data['GameSessionQueues']);
        }
...
/**
 * @member {Array} GameSessionQueues
 */
DescribeGameSessionQueuesOutput.prototype['GameSessionQueues'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeGameSessionQueuesOutput.prototype['NextToken'] = undefined;
...
export default DescribeGameSessionQueuesOutput;
