...
import UpdateGameServerGroupOutputGameServerGroup from './UpdateGameServerGroupOutputGameServerGroup';

/**
 * The UpdateGameServerGroupOutput model module.
 * @module model/UpdateGameServerGroupOutput
 * @version 2015-10-01
 */
class UpdateGameServerGroupOutput {
    /**
     * Constructs a new <code>UpdateGameServerGroupOutput</code>.
     * @alias module:model/UpdateGameServerGroupOutput
     */
    constructor() { 
        
        UpdateGameServerGroupOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateGameServerGroupOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateGameServerGroupOutput} obj Optional instance to populate.
     * @return {module:model/UpdateGameServerGroupOutput} The populated <code>UpdateGameServerGroupOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateGameServerGroupOutput();

            if (data.hasOwnProperty('GameServerGroup')) {
                obj['GameServerGroup'] = UpdateGameServerGroupOutputGameServerGroup.constructFromObject(data['GameServerGroup']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateGameServerGroupOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateGameServerGroupOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GameServerGroup`
        if (data['GameServerGroup']) { // data not null
          UpdateGameServerGroupOutputGameServerGroup.validateJSON(data['GameServerGroup']);
        }
...
/**
 * @member {module:model/UpdateGameServerGroupOutputGameServerGroup} GameServerGroup
 */
UpdateGameServerGroupOutput.prototype['GameServerGroup'] = undefined;
...
export default UpdateGameServerGroupOutput;
