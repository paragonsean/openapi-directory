...
/**
 * The CreateBuildInputStorageLocation model module.
 * @module model/CreateBuildInputStorageLocation
 * @version 2015-10-01
 */
class CreateBuildInputStorageLocation {
    /**
     * Constructs a new <code>CreateBuildInputStorageLocation</code>.
     * @alias module:model/CreateBuildInputStorageLocation
     * @implements module:model/S3Location
     */
    constructor() { 
        S3Location.initialize(this);
        CreateBuildInputStorageLocation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateBuildInputStorageLocation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateBuildInputStorageLocation} obj Optional instance to populate.
     * @return {module:model/CreateBuildInputStorageLocation} The populated <code>CreateBuildInputStorageLocation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateBuildInputStorageLocation();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateBuildInputStorageLocation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateBuildInputStorageLocation</code>.
     */
 ...
 */
CreateBuildInputStorageLocation.prototype['Bucket'] = undefined;

/**
 * @member {String} Key
 */
CreateBuildInputStorageLocation.prototype['Key'] = undefined;

/**
 * @member {String} RoleArn
 */
CreateBuildInputStorageLocation.prototype['RoleArn'] = undefined;

/**
 * @member {String} ObjectVersion
 */
CreateBuildInputStorageLocation.prototype['ObjectVersion'] = undefined;
...
export default CreateBuildInputStorageLocation;
