...
* @readonly
*/
export default class GameServerGroupDeleteOption {
    ...
    /**
    * Returns a <code>GameServerGroupDeleteOption</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/GameServerGroupDeleteOption} The enum <code>GameServerGroupDeleteOption</code> value.
    */
