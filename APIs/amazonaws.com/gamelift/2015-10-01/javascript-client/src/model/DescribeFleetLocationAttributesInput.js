...
/**
 * The DescribeFleetLocationAttributesInput model module.
 * @module model/DescribeFleetLocationAttributesInput
 * @version 2015-10-01
 */
class DescribeFleetLocationAttributesInput {
    /**
     * Constructs a new <code>DescribeFleetLocationAttributesInput</code>.
     * @alias module:model/DescribeFleetLocationAttributesInput
     * @param fleetId {String} 
     */
    constructor(fleetId) { 
        
        DescribeFleetLocationAttributesInput.initialize(this, fleetId);
    }
    ...
    /**
     * Constructs a <code>DescribeFleetLocationAttributesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeFleetLocationAttributesInput} obj Optional instance to populate.
     * @return {module:model/DescribeFleetLocationAttributesInput} The populated <code>DescribeFleetLocationAttributesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeFleetLocationAttributesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeFleetLocationAttributesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeFleetLocationAttributesInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeFleetLocationAttributesInput.RequiredProperties) {
...
DescribeFleetLocationAttributesInput.RequiredProperties = ["FleetId"];

/**
 * @member {String} FleetId
 */
DescribeFleetLocationAttributesInput.prototype['FleetId'] = undefined;

/**
 * @member {Array} Locations
 */
DescribeFleetLocationAttributesInput.prototype['Locations'] = undefined;

/**
 * @member {Number} Limit
 */
DescribeFleetLocationAttributesInput.prototype['Limit'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeFleetLocationAttributesInput.prototype['NextToken'] = undefined;
...
export default DescribeFleetLocationAttributesInput;
