...
/**
 * The DeregisterComputeInput model module.
 * @module model/DeregisterComputeInput
 * @version 2015-10-01
 */
class DeregisterComputeInput {
    /**
     * Constructs a new <code>DeregisterComputeInput</code>.
     * @alias module:model/DeregisterComputeInput
     * @param fleetId {String} 
     * @param computeName {String} 
     */
    constructor(fleetId, computeName) { 
        
        DeregisterComputeInput.initialize(this, fleetId, computeName);
    }
    ...
    /**
     * Constructs a <code>DeregisterComputeInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeregisterComputeInput} obj Optional instance to populate.
     * @return {module:model/DeregisterComputeInput} The populated <code>DeregisterComputeInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeregisterComputeInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeregisterComputeInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeregisterComputeInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeregisterComputeInput.RequiredProperties) {
...
DeregisterComputeInput.RequiredProperties = ["FleetId", "ComputeName"];

/**
 * @member {String} FleetId
 */
DeregisterComputeInput.prototype['FleetId'] = undefined;

/**
 * @member {String} ComputeName
 */
DeregisterComputeInput.prototype['ComputeName'] = undefined;
...
export default DeregisterComputeInput;
