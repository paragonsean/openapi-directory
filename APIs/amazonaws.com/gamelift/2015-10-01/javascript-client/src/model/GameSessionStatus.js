...
* @readonly
*/
export default class GameSessionStatus {
    ...
    /**
    * Returns a <code>GameSessionStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/GameSessionStatus} The enum <code>GameSessionStatus</code> value.
    */
