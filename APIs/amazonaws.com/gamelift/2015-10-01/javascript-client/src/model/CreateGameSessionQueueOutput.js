...
import CreateGameSessionQueueOutputGameSessionQueue from './CreateGameSessionQueueOutputGameSessionQueue';

/**
 * The CreateGameSessionQueueOutput model module.
 * @module model/CreateGameSessionQueueOutput
 * @version 2015-10-01
 */
class CreateGameSessionQueueOutput {
    /**
     * Constructs a new <code>CreateGameSessionQueueOutput</code>.
     * @alias module:model/CreateGameSessionQueueOutput
     */
    constructor() { 
        
        CreateGameSessionQueueOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateGameSessionQueueOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateGameSessionQueueOutput} obj Optional instance to populate.
     * @return {module:model/CreateGameSessionQueueOutput} The populated <code>CreateGameSessionQueueOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateGameSessionQueueOutput();

            if (data.hasOwnProperty('GameSessionQueue')) {
                obj['GameSessionQueue'] = CreateGameSessionQueueOutputGameSessionQueue.constructFromObject(data['GameSessionQueue']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateGameSessionQueueOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateGameSessionQueueOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GameSessionQueue`
        if (data['GameSessionQueue']) { // data not null
          CreateGameSessionQueueOutputGameSessionQueue.validateJSON(data['GameSessionQueue']);
        }
...
/**
 * @member {module:model/CreateGameSessionQueueOutputGameSessionQueue} GameSessionQueue
 */
CreateGameSessionQueueOutput.prototype['GameSessionQueue'] = undefined;
...
export default CreateGameSessionQueueOutput;
