...
* @readonly
*/
export default class BackfillMode {
    ...
    /**
    * Returns a <code>BackfillMode</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/BackfillMode} The enum <code>BackfillMode</code> value.
    */
