...
/**
 * The DescribeGameSessionDetailsInput model module.
 * @module model/DescribeGameSessionDetailsInput
 * @version 2015-10-01
 */
class DescribeGameSessionDetailsInput {
    /**
     * Constructs a new <code>DescribeGameSessionDetailsInput</code>.
     * @alias module:model/DescribeGameSessionDetailsInput
     */
    constructor() { 
        
        DescribeGameSessionDetailsInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeGameSessionDetailsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeGameSessionDetailsInput} obj Optional instance to populate.
     * @return {module:model/DescribeGameSessionDetailsInput} The populated <code>DescribeGameSessionDetailsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeGameSessionDetailsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeGameSessionDetailsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeGameSessionDetailsInput</code>.
     */
    static validateJSON(data) {
        ...
        if (data['StatusFilter']) { // data not null
          String.validateJSON(data['StatusFilter']);
        }
 ...
 */
DescribeGameSessionDetailsInput.prototype['FleetId'] = undefined;

/**
 * @member {String} GameSessionId
 */
DescribeGameSessionDetailsInput.prototype['GameSessionId'] = undefined;

/**
 * @member {String} AliasId
 */
DescribeGameSessionDetailsInput.prototype['AliasId'] = undefined;

/**
 * @member {String} Location
 */
DescribeGameSessionDetailsInput.prototype['Location'] = undefined;

/**
 * @member {String} StatusFilter
 */
DescribeGameSessionDetailsInput.prototype['StatusFilter'] = undefined;

/**
 * @member {Number} Limit
 */
DescribeGameSessionDetailsInput.prototype['Limit'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeGameSessionDetailsInput.prototype['NextToken'] = undefined;
...
export default DescribeGameSessionDetailsInput;
