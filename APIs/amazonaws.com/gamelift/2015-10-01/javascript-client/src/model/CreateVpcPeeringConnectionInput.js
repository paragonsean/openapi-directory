...
/**
 * The CreateVpcPeeringConnectionInput model module.
 * @module model/CreateVpcPeeringConnectionInput
 * @version 2015-10-01
 */
class CreateVpcPeeringConnectionInput {
    /**
     * Constructs a new <code>CreateVpcPeeringConnectionInput</code>.
     * @alias module:model/CreateVpcPeeringConnectionInput
     * @param fleetId {String} 
     * @param peerVpcAwsAccountId {String} 
     * @param peerVpcId {String} 
     */
    constructor(fleetId, peerVpcAwsAccountId, peerVpcId) { 
        
        CreateVpcPeeringConnectionInput.initialize(this, fleetId, peerVpcAwsAccountId, peerVpcId);
    }
     ...
     */
    static initialize(obj, fleetId, peerVpcAwsAccountId, peerVpcId) { 
        obj['FleetId'] = fleetId;
        obj['PeerVpcAwsAccountId'] = peerVpcAwsAccountId;
        obj['PeerVpcId'] = peerVpcId;
    }

    /**
     * Constructs a <code>CreateVpcPeeringConnectionInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateVpcPeeringConnectionInput} obj Optional instance to populate.
     * @return {module:model/CreateVpcPeeringConnectionInput} The populated <code>CreateVpcPeeringConnectionInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateVpcPeeringConnectionInput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateVpcPeeringConnectionInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateVpcPeeringConnectionInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateVpcPeeringConnectionInput.RequiredProperties) {
...
CreateVpcPeeringConnectionInput.RequiredProperties = ["FleetId", "PeerVpcAwsAccountId", "PeerVpcId"];

/**
 * @member {String} FleetId
 */
CreateVpcPeeringConnectionInput.prototype['FleetId'] = undefined;

/**
 * @member {String} PeerVpcAwsAccountId
 */
CreateVpcPeeringConnectionInput.prototype['PeerVpcAwsAccountId'] = undefined;

/**
 * @member {String} PeerVpcId
 */
CreateVpcPeeringConnectionInput.prototype['PeerVpcId'] = undefined;
...
export default CreateVpcPeeringConnectionInput;
