...
/**
 * The StartMatchBackfillInput model module.
 * @module model/StartMatchBackfillInput
 * @version 2015-10-01
 */
class StartMatchBackfillInput {
    /**
     * Constructs a new <code>StartMatchBackfillInput</code>.
     * @alias module:model/StartMatchBackfillInput
     * @param configurationName {String} 
     * @param players {Array} 
     */
    constructor(configurationName, players) { 
        
        StartMatchBackfillInput.initialize(this, configurationName, players);
    }
     ...
     */
    static initialize(obj, configurationName, players) { 
        obj['ConfigurationName'] = configurationName;
        obj['Players'] = players;
    }

    /**
     * Constructs a <code>StartMatchBackfillInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartMatchBackfillInput} obj Optional instance to populate.
     * @return {module:model/StartMatchBackfillInput} The populated <code>StartMatchBackfillInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartMatchBackfillInput();
    ...
    /**
     * Validates the JSON data with respect to <code>StartMatchBackfillInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartMatchBackfillInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartMatchBackfillInput.RequiredProperties) {
...
StartMatchBackfillInput.RequiredProperties = ["ConfigurationName", "Players"];

/**
 * @member {String} TicketId
 */
StartMatchBackfillInput.prototype['TicketId'] = undefined;

/**
 * @member {String} ConfigurationName
 */
StartMatchBackfillInput.prototype['ConfigurationName'] = undefined;

/**
 * @member {String} GameSessionArn
 */
StartMatchBackfillInput.prototype['GameSessionArn'] = undefined;

/**
 * @member {Array} Players
 */
StartMatchBackfillInput.prototype['Players'] = undefined;
...
export default StartMatchBackfillInput;
