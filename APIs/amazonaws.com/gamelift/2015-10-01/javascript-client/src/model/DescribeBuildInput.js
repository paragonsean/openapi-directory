...
/**
 * The DescribeBuildInput model module.
 * @module model/DescribeBuildInput
 * @version 2015-10-01
 */
class DescribeBuildInput {
    /**
     * Constructs a new <code>DescribeBuildInput</code>.
     * @alias module:model/DescribeBuildInput
     * @param buildId {String} 
     */
    constructor(buildId) { 
        
        DescribeBuildInput.initialize(this, buildId);
    }
    ...
    /**
     * Constructs a <code>DescribeBuildInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeBuildInput} obj Optional instance to populate.
     * @return {module:model/DescribeBuildInput} The populated <code>DescribeBuildInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeBuildInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeBuildInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeBuildInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeBuildInput.RequiredProperties) {
...
DescribeBuildInput.RequiredProperties = ["BuildId"];

/**
 * @member {String} BuildId
 */
DescribeBuildInput.prototype['BuildId'] = undefined;
...
export default DescribeBuildInput;
