...
* @readonly
*/
export default class FleetAction {
    ...
    /**
    * Returns a <code>FleetAction</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FleetAction} The enum <code>FleetAction</code> value.
    */
