...
/**
 * The ListScriptsOutput model module.
 * @module model/ListScriptsOutput
 * @version 2015-10-01
 */
class ListScriptsOutput {
    /**
     * Constructs a new <code>ListScriptsOutput</code>.
     * @alias module:model/ListScriptsOutput
     */
    constructor() { 
        
        ListScriptsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListScriptsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListScriptsOutput} obj Optional instance to populate.
     * @return {module:model/ListScriptsOutput} The populated <code>ListScriptsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListScriptsOutput();

            if (data.hasOwnProperty('Scripts')) {
                obj['Scripts'] = ApiClient.convertToType(data['Scripts'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListScriptsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListScriptsOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Scripts`
        if (data['Scripts']) { // data not null
          Array.validateJSON(data['Scripts']);
        }
...
/**
 * @member {Array} Scripts
 */
ListScriptsOutput.prototype['Scripts'] = undefined;

/**
 * @member {String} NextToken
 */
ListScriptsOutput.prototype['NextToken'] = undefined;
...
export default ListScriptsOutput;
