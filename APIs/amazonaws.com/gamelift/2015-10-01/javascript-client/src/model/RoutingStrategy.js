...
/**
 * The RoutingStrategy model module.
 * @module model/RoutingStrategy
 * @version 2015-10-01
 */
class RoutingStrategy {
    /**
     * Constructs a new <code>RoutingStrategy</code>.
     ...
     * @alias module:model/RoutingStrategy
     */
    constructor() { 
        
        RoutingStrategy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RoutingStrategy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RoutingStrategy} obj Optional instance to populate.
     * @return {module:model/RoutingStrategy} The populated <code>RoutingStrategy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RoutingStrategy();

            if (data.hasOwnProperty('Type')) {
                obj['Type'] = ApiClient.convertToType(data['Type'], RoutingStrategyType);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>RoutingStrategy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RoutingStrategy</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Type`
        if (data['Type']) { // data not null
          RoutingStrategyType.validateJSON(data['Type']);
        }
...
/**
 * @member {module:model/RoutingStrategyType} Type
 */
RoutingStrategy.prototype['Type'] = undefined;

/**
 * @member {String} FleetId
 */
RoutingStrategy.prototype['FleetId'] = undefined;

/**
 * @member {String} Message
 */
RoutingStrategy.prototype['Message'] = undefined;
