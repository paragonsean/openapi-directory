...
/**
 * The UpdateScriptOutputScript model module.
 * @module model/UpdateScriptOutputScript
 * @version 2015-10-01
 */
class UpdateScriptOutputScript {
    /**
     * Constructs a new <code>UpdateScriptOutputScript</code>.
     * @alias module:model/UpdateScriptOutputScript
     * @implements module:model/Script
     */
    constructor() { 
        Script.initialize(this);
        UpdateScriptOutputScript.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateScriptOutputScript</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateScriptOutputScript} obj Optional instance to populate.
     * @return {module:model/UpdateScriptOutputScript} The populated <code>UpdateScriptOutputScript</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateScriptOutputScript();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateScriptOutputScript</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateScriptOutputScript</code>.
     */
 ...
 */
UpdateScriptOutputScript.prototype['ScriptId'] = undefined;

/**
 * @member {String} ScriptArn
 */
UpdateScriptOutputScript.prototype['ScriptArn'] = undefined;

/**
 * @member {String} Name
 */
UpdateScriptOutputScript.prototype['Name'] = undefined;

/**
 * @member {String} Version
 */
UpdateScriptOutputScript.prototype['Version'] = undefined;

/**
 * @member {Number} SizeOnDisk
 */
UpdateScriptOutputScript.prototype['SizeOnDisk'] = undefined;

/**
 * @member {Date} CreationTime
 */
UpdateScriptOutputScript.prototype['CreationTime'] = undefined;

/**
 * @member {module:model/CreateScriptInputStorageLocation} StorageLocation
 */
UpdateScriptOutputScript.prototype['StorageLocation'] = undefined;
...
export default UpdateScriptOutputScript;
