...
/**
 * The DescribeFleetPortSettingsInput model module.
 * @module model/DescribeFleetPortSettingsInput
 * @version 2015-10-01
 */
class DescribeFleetPortSettingsInput {
    /**
     * Constructs a new <code>DescribeFleetPortSettingsInput</code>.
     * @alias module:model/DescribeFleetPortSettingsInput
     * @param fleetId {String} 
     */
    constructor(fleetId) { 
        
        DescribeFleetPortSettingsInput.initialize(this, fleetId);
    }
    ...
    /**
     * Constructs a <code>DescribeFleetPortSettingsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeFleetPortSettingsInput} obj Optional instance to populate.
     * @return {module:model/DescribeFleetPortSettingsInput} The populated <code>DescribeFleetPortSettingsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeFleetPortSettingsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeFleetPortSettingsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeFleetPortSettingsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeFleetPortSettingsInput.RequiredProperties) {
...
DescribeFleetPortSettingsInput.RequiredProperties = ["FleetId"];

/**
 * @member {String} FleetId
 */
DescribeFleetPortSettingsInput.prototype['FleetId'] = undefined;

/**
 * @member {String} Location
 */
DescribeFleetPortSettingsInput.prototype['Location'] = undefined;
...
export default DescribeFleetPortSettingsInput;
