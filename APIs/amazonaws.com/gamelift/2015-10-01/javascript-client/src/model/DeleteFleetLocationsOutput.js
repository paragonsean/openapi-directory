...
/**
 * The DeleteFleetLocationsOutput model module.
 * @module model/DeleteFleetLocationsOutput
 * @version 2015-10-01
 */
class DeleteFleetLocationsOutput {
    /**
     * Constructs a new <code>DeleteFleetLocationsOutput</code>.
     * @alias module:model/DeleteFleetLocationsOutput
     */
    constructor() { 
        
        DeleteFleetLocationsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteFleetLocationsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteFleetLocationsOutput} obj Optional instance to populate.
     * @return {module:model/DeleteFleetLocationsOutput} The populated <code>DeleteFleetLocationsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteFleetLocationsOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteFleetLocationsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteFleetLocationsOutput</code>.
     */
 ...
 */
DeleteFleetLocationsOutput.prototype['FleetId'] = undefined;

/**
 * @member {String} FleetArn
 */
DeleteFleetLocationsOutput.prototype['FleetArn'] = undefined;

/**
 * @member {Array} LocationStates
 */
DeleteFleetLocationsOutput.prototype['LocationStates'] = undefined;
...
export default DeleteFleetLocationsOutput;
