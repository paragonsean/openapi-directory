...
/**
 * The DescribeFleetEventsInput model module.
 * @module model/DescribeFleetEventsInput
 * @version 2015-10-01
 */
class DescribeFleetEventsInput {
    /**
     * Constructs a new <code>DescribeFleetEventsInput</code>.
     * @alias module:model/DescribeFleetEventsInput
     * @param fleetId {String} 
     */
    constructor(fleetId) { 
        
        DescribeFleetEventsInput.initialize(this, fleetId);
    }
    ...
    /**
     * Constructs a <code>DescribeFleetEventsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeFleetEventsInput} obj Optional instance to populate.
     * @return {module:model/DescribeFleetEventsInput} The populated <code>DescribeFleetEventsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeFleetEventsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeFleetEventsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeFleetEventsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeFleetEventsInput.RequiredProperties) {
...
DescribeFleetEventsInput.RequiredProperties = ["FleetId"];

/**
 * @member {String} FleetId
 */
DescribeFleetEventsInput.prototype['FleetId'] = undefined;

/**
 * @member {Date} StartTime
 */
DescribeFleetEventsInput.prototype['StartTime'] = undefined;

/**
 * @member {Date} EndTime
 */
DescribeFleetEventsInput.prototype['EndTime'] = undefined;

/**
 * @member {Number} Limit
 */
DescribeFleetEventsInput.prototype['Limit'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeFleetEventsInput.prototype['NextToken'] = undefined;
...
export default DescribeFleetEventsInput;
