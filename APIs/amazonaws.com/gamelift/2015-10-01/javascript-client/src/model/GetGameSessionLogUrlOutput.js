...
/**
 * The GetGameSessionLogUrlOutput model module.
 * @module model/GetGameSessionLogUrlOutput
 * @version 2015-10-01
 */
class GetGameSessionLogUrlOutput {
    /**
     * Constructs a new <code>GetGameSessionLogUrlOutput</code>.
     * @alias module:model/GetGameSessionLogUrlOutput
     */
    constructor() { 
        
        GetGameSessionLogUrlOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetGameSessionLogUrlOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetGameSessionLogUrlOutput} obj Optional instance to populate.
     * @return {module:model/GetGameSessionLogUrlOutput} The populated <code>GetGameSessionLogUrlOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetGameSessionLogUrlOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetGameSessionLogUrlOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetGameSessionLogUrlOutput</code>.
     */
 ...
 */
GetGameSessionLogUrlOutput.prototype['PreSignedUrl'] = undefined;
...
export default GetGameSessionLogUrlOutput;
