...
* @readonly
*/
export default class PlayerSessionStatus {
    ...
    /**
    * Returns a <code>PlayerSessionStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PlayerSessionStatus} The enum <code>PlayerSessionStatus</code> value.
    */
