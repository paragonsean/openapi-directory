...
/**
 * The LocationModel model module.
 * @module model/LocationModel
 * @version 2015-10-01
 */
class LocationModel {
    /**
     * Constructs a new <code>LocationModel</code>.
     * Properties of a location
     * @alias module:model/LocationModel
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>LocationModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LocationModel} obj Optional instance to populate.
     * @return {module:model/LocationModel} The populated <code>LocationModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LocationModel();
    ...
    /**
     * Validates the JSON data with respect to <code>LocationModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LocationModel</code>.
     */
