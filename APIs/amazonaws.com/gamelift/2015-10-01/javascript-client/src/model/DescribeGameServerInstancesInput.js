...
/**
 * The DescribeGameServerInstancesInput model module.
 * @module model/DescribeGameServerInstancesInput
 * @version 2015-10-01
 */
class DescribeGameServerInstancesInput {
    /**
     * Constructs a new <code>DescribeGameServerInstancesInput</code>.
     * @alias module:model/DescribeGameServerInstancesInput
     * @param gameServerGroupName {String} 
     */
    constructor(gameServerGroupName) { 
        
        DescribeGameServerInstancesInput.initialize(this, gameServerGroupName);
    }
    ...
    /**
     * Constructs a <code>DescribeGameServerInstancesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeGameServerInstancesInput} obj Optional instance to populate.
     * @return {module:model/DescribeGameServerInstancesInput} The populated <code>DescribeGameServerInstancesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeGameServerInstancesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeGameServerInstancesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeGameServerInstancesInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeGameServerInstancesInput.RequiredProperties) {
...
DescribeGameServerInstancesInput.RequiredProperties = ["GameServerGroupName"];

/**
 * @member {String} GameServerGroupName
 */
DescribeGameServerInstancesInput.prototype['GameServerGroupName'] = undefined;

/**
 * @member {Array} InstanceIds
 */
DescribeGameServerInstancesInput.prototype['InstanceIds'] = undefined;

/**
 * @member {Number} Limit
 */
DescribeGameServerInstancesInput.prototype['Limit'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeGameServerInstancesInput.prototype['NextToken'] = undefined;
...
export default DescribeGameServerInstancesInput;
