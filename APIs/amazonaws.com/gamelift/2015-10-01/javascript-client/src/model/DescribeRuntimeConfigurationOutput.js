...
import DescribeRuntimeConfigurationOutputRuntimeConfiguration from './DescribeRuntimeConfigurationOutputRuntimeConfiguration';

/**
 * The DescribeRuntimeConfigurationOutput model module.
 * @module model/DescribeRuntimeConfigurationOutput
 * @version 2015-10-01
 */
class DescribeRuntimeConfigurationOutput {
    /**
     * Constructs a new <code>DescribeRuntimeConfigurationOutput</code>.
     * @alias module:model/DescribeRuntimeConfigurationOutput
     */
    constructor() { 
        
        DescribeRuntimeConfigurationOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeRuntimeConfigurationOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeRuntimeConfigurationOutput} obj Optional instance to populate.
     * @return {module:model/DescribeRuntimeConfigurationOutput} The populated <code>DescribeRuntimeConfigurationOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeRuntimeConfigurationOutput();

            if (data.hasOwnProperty('RuntimeConfiguration')) {
                obj['RuntimeConfiguration'] = DescribeRuntimeConfigurationOutputRuntimeConfiguration.constructFromObject(data['RuntimeConfiguration']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeRuntimeConfigurationOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeRuntimeConfigurationOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `RuntimeConfiguration`
        if (data['RuntimeConfiguration']) { // data not null
          DescribeRuntimeConfigurationOutputRuntimeConfiguration.validateJSON(data['RuntimeConfiguration']);
        }
...
/**
 * @member {module:model/DescribeRuntimeConfigurationOutputRuntimeConfiguration} RuntimeConfiguration
 */
DescribeRuntimeConfigurationOutput.prototype['RuntimeConfiguration'] = undefined;
...
export default DescribeRuntimeConfigurationOutput;
