...
import CreateScriptOutputScript from './CreateScriptOutputScript';

/**
 * The CreateScriptOutput model module.
 * @module model/CreateScriptOutput
 * @version 2015-10-01
 */
class CreateScriptOutput {
    /**
     * Constructs a new <code>CreateScriptOutput</code>.
     * @alias module:model/CreateScriptOutput
     */
    constructor() { 
        
        CreateScriptOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateScriptOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateScriptOutput} obj Optional instance to populate.
     * @return {module:model/CreateScriptOutput} The populated <code>CreateScriptOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateScriptOutput();

            if (data.hasOwnProperty('Script')) {
                obj['Script'] = CreateScriptOutputScript.constructFromObject(data['Script']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateScriptOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateScriptOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Script`
        if (data['Script']) { // data not null
          CreateScriptOutputScript.validateJSON(data['Script']);
        }
...
/**
 * @member {module:model/CreateScriptOutputScript} Script
 */
CreateScriptOutput.prototype['Script'] = undefined;
...
export default CreateScriptOutput;
