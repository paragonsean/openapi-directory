...
/**
 * The DescribeAliasInput model module.
 * @module model/DescribeAliasInput
 * @version 2015-10-01
 */
class DescribeAliasInput {
    /**
     * Constructs a new <code>DescribeAliasInput</code>.
     * @alias module:model/DescribeAliasInput
     * @param aliasId {String} 
     */
    constructor(aliasId) { 
        
        DescribeAliasInput.initialize(this, aliasId);
    }
    ...
    /**
     * Constructs a <code>DescribeAliasInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeAliasInput} obj Optional instance to populate.
     * @return {module:model/DescribeAliasInput} The populated <code>DescribeAliasInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeAliasInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeAliasInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeAliasInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeAliasInput.RequiredProperties) {
...
DescribeAliasInput.RequiredProperties = ["AliasId"];

/**
 * @member {String} AliasId
 */
DescribeAliasInput.prototype['AliasId'] = undefined;
...
export default DescribeAliasInput;
