...
/**
 * The DescribeScriptOutputScript model module.
 * @module model/DescribeScriptOutputScript
 * @version 2015-10-01
 */
class DescribeScriptOutputScript {
    /**
     * Constructs a new <code>DescribeScriptOutputScript</code>.
     * @alias module:model/DescribeScriptOutputScript
     * @implements module:model/Script
     */
    constructor() { 
        Script.initialize(this);
        DescribeScriptOutputScript.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeScriptOutputScript</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeScriptOutputScript} obj Optional instance to populate.
     * @return {module:model/DescribeScriptOutputScript} The populated <code>DescribeScriptOutputScript</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeScriptOutputScript();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeScriptOutputScript</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeScriptOutputScript</code>.
     */
 ...
 */
DescribeScriptOutputScript.prototype['ScriptId'] = undefined;

/**
 * @member {String} ScriptArn
 */
DescribeScriptOutputScript.prototype['ScriptArn'] = undefined;

/**
 * @member {String} Name
 */
DescribeScriptOutputScript.prototype['Name'] = undefined;

/**
 * @member {String} Version
 */
DescribeScriptOutputScript.prototype['Version'] = undefined;

/**
 * @member {Number} SizeOnDisk
 */
DescribeScriptOutputScript.prototype['SizeOnDisk'] = undefined;

/**
 * @member {Date} CreationTime
 */
DescribeScriptOutputScript.prototype['CreationTime'] = undefined;

/**
 * @member {module:model/CreateScriptInputStorageLocation} StorageLocation
 */
DescribeScriptOutputScript.prototype['StorageLocation'] = undefined;
...
export default DescribeScriptOutputScript;
