...
/**
 * The GameSessionConnectionInfo model module.
 * @module model/GameSessionConnectionInfo
 * @version 2015-10-01
 */
class GameSessionConnectionInfo {
    /**
     * Constructs a new <code>GameSessionConnectionInfo</code>.
     ...
     * @alias module:model/GameSessionConnectionInfo
     */
    constructor() { 
        
        GameSessionConnectionInfo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GameSessionConnectionInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GameSessionConnectionInfo} obj Optional instance to populate.
     * @return {module:model/GameSessionConnectionInfo} The populated <code>GameSessionConnectionInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GameSessionConnectionInfo();
            ...
            if (data.hasOwnProperty('MatchedPlayerSessions')) {
                obj['MatchedPlayerSessions'] = ApiClient.convertToType(data['MatchedPlayerSessions'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GameSessionConnectionInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GameSessionConnectionInfo</code>.
     */
    static validateJSON(data) {
        ...
        if (data['MatchedPlayerSessions']) { // data not null
          Array.validateJSON(data['MatchedPlayerSessions']);
        }
 ...
 */
GameSessionConnectionInfo.prototype['GameSessionArn'] = undefined;

/**
 * @member {String} IpAddress
 */
GameSessionConnectionInfo.prototype['IpAddress'] = undefined;

/**
 * @member {String} DnsName
 */
GameSessionConnectionInfo.prototype['DnsName'] = undefined;

/**
 * @member {Number} Port
 */
GameSessionConnectionInfo.prototype['Port'] = undefined;

/**
 * @member {Array} MatchedPlayerSessions
 */
GameSessionConnectionInfo.prototype['MatchedPlayerSessions'] = undefined;
...
export default GameSessionConnectionInfo;
