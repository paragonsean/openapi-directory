...
/**
 * The UpdateBuildOutputBuild model module.
 * @module model/UpdateBuildOutputBuild
 * @version 2015-10-01
 */
class UpdateBuildOutputBuild {
    /**
     * Constructs a new <code>UpdateBuildOutputBuild</code>.
     * @alias module:model/UpdateBuildOutputBuild
     * @implements module:model/Build
     */
    constructor() { 
        Build.initialize(this);
        UpdateBuildOutputBuild.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateBuildOutputBuild</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateBuildOutputBuild} obj Optional instance to populate.
     * @return {module:model/UpdateBuildOutputBuild} The populated <code>UpdateBuildOutputBuild</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateBuildOutputBuild();
            ...
            if (data.hasOwnProperty('Status')) {
                obj['Status'] = ApiClient.convertToType(data['Status'], BuildStatus);
            }
            ...
            if (data.hasOwnProperty('ServerSdkVersion')) {
                obj['ServerSdkVersion'] = ApiClient.convertToType(data['ServerSdkVersion'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateBuildOutputBuild</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateBuildOutputBuild</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Status']) { // data not null
          BuildStatus.validateJSON(data['Status']);
        }
        ...
        if (data['ServerSdkVersion']) { // data not null
          String.validateJSON(data['ServerSdkVersion']);
        }
 ...
 */
UpdateBuildOutputBuild.prototype['BuildId'] = undefined;

/**
 * @member {String} BuildArn
 */
UpdateBuildOutputBuild.prototype['BuildArn'] = undefined;

/**
 * @member {String} Name
 */
UpdateBuildOutputBuild.prototype['Name'] = undefined;

/**
 * @member {String} Version
 */
UpdateBuildOutputBuild.prototype['Version'] = undefined;

/**
 * @member {module:model/BuildStatus} Status
 */
UpdateBuildOutputBuild.prototype['Status'] = undefined;

/**
 * @member {Number} SizeOnDisk
 */
UpdateBuildOutputBuild.prototype['SizeOnDisk'] = undefined;

/**
 * @member {module:model/OperatingSystem} OperatingSystem
 */
UpdateBuildOutputBuild.prototype['OperatingSystem'] = undefined;

/**
 * @member {Date} CreationTime
 */
UpdateBuildOutputBuild.prototype['CreationTime'] = undefined;

/**
 * @member {String} ServerSdkVersion
 */
UpdateBuildOutputBuild.prototype['ServerSdkVersion'] = undefined;
 ...
 * @member {String} BuildArn
 */
Build.prototype['BuildArn'] = undefined;
/**
 * @member {String} Name
 */
 ...
 * @member {Number} SizeOnDisk
 */
Build.prototype['SizeOnDisk'] = undefined;
/**
 * @member {module:model/OperatingSystem} OperatingSystem
 */
Build.prototype['OperatingSystem'] = undefined;
/**
 * @member {Date} CreationTime
 */
Build.prototype['CreationTime'] = undefined;
/**
 * @member {String} ServerSdkVersion
 */
Build.prototype['ServerSdkVersion'] = undefined;




export default UpdateBuildOutputBuild;
