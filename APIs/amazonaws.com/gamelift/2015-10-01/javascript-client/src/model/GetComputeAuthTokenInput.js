...
/**
 * The GetComputeAuthTokenInput model module.
 * @module model/GetComputeAuthTokenInput
 * @version 2015-10-01
 */
class GetComputeAuthTokenInput {
    /**
     * Constructs a new <code>GetComputeAuthTokenInput</code>.
     * @alias module:model/GetComputeAuthTokenInput
     * @param fleetId {String} 
     * @param computeName {String} 
     */
    constructor(fleetId, computeName) { 
        
        GetComputeAuthTokenInput.initialize(this, fleetId, computeName);
    }
     ...
     */
    static initialize(obj, fleetId, computeName) { 
        obj['FleetId'] = fleetId;
        obj['ComputeName'] = computeName;
    }

    /**
     * Constructs a <code>GetComputeAuthTokenInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetComputeAuthTokenInput} obj Optional instance to populate.
     * @return {module:model/GetComputeAuthTokenInput} The populated <code>GetComputeAuthTokenInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetComputeAuthTokenInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetComputeAuthTokenInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetComputeAuthTokenInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetComputeAuthTokenInput.RequiredProperties) {
...
GetComputeAuthTokenInput.RequiredProperties = ["FleetId", "ComputeName"];

/**
 * @member {String} FleetId
 */
GetComputeAuthTokenInput.prototype['FleetId'] = undefined;

/**
 * @member {String} ComputeName
 */
GetComputeAuthTokenInput.prototype['ComputeName'] = undefined;
...
export default GetComputeAuthTokenInput;
