...
/**
 * The ResolveAliasInput model module.
 * @module model/ResolveAliasInput
 * @version 2015-10-01
 */
class ResolveAliasInput {
    /**
     * Constructs a new <code>ResolveAliasInput</code>.
     * @alias module:model/ResolveAliasInput
     * @param aliasId {String} 
     */
    constructor(aliasId) { 
        
        ResolveAliasInput.initialize(this, aliasId);
    }
    ...
    /**
     * Constructs a <code>ResolveAliasInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResolveAliasInput} obj Optional instance to populate.
     * @return {module:model/ResolveAliasInput} The populated <code>ResolveAliasInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResolveAliasInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ResolveAliasInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResolveAliasInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ResolveAliasInput.RequiredProperties) {
...
ResolveAliasInput.RequiredProperties = ["AliasId"];

/**
 * @member {String} AliasId
 */
ResolveAliasInput.prototype['AliasId'] = undefined;
...
export default ResolveAliasInput;
