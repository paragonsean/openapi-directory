...
/**
 * The InstanceCredentials model module.
 * @module model/InstanceCredentials
 * @version 2015-10-01
 */
class InstanceCredentials {
    /**
     * Constructs a new <code>InstanceCredentials</code>.
     * Set of credentials required to remotely access a fleet instance.
     * @alias module:model/InstanceCredentials
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>InstanceCredentials</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InstanceCredentials} obj Optional instance to populate.
     * @return {module:model/InstanceCredentials} The populated <code>InstanceCredentials</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InstanceCredentials();
    ...
    /**
     * Validates the JSON data with respect to <code>InstanceCredentials</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InstanceCredentials</code>.
     */
