...
/**
 * The UpdateFleetCapacityOutput model module.
 * @module model/UpdateFleetCapacityOutput
 * @version 2015-10-01
 */
class UpdateFleetCapacityOutput {
    /**
     * Constructs a new <code>UpdateFleetCapacityOutput</code>.
     * @alias module:model/UpdateFleetCapacityOutput
     */
    constructor() { 
        
        UpdateFleetCapacityOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateFleetCapacityOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateFleetCapacityOutput} obj Optional instance to populate.
     * @return {module:model/UpdateFleetCapacityOutput} The populated <code>UpdateFleetCapacityOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateFleetCapacityOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateFleetCapacityOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateFleetCapacityOutput</code>.
     */
 ...
 */
UpdateFleetCapacityOutput.prototype['FleetId'] = undefined;

/**
 * @member {String} FleetArn
 */
UpdateFleetCapacityOutput.prototype['FleetArn'] = undefined;

/**
 * @member {String} Location
 */
UpdateFleetCapacityOutput.prototype['Location'] = undefined;
...
export default UpdateFleetCapacityOutput;
