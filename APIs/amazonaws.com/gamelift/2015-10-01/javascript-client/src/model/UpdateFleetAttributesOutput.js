...
/**
 * The UpdateFleetAttributesOutput model module.
 * @module model/UpdateFleetAttributesOutput
 * @version 2015-10-01
 */
class UpdateFleetAttributesOutput {
    /**
     * Constructs a new <code>UpdateFleetAttributesOutput</code>.
     * @alias module:model/UpdateFleetAttributesOutput
     */
    constructor() { 
        
        UpdateFleetAttributesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateFleetAttributesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateFleetAttributesOutput} obj Optional instance to populate.
     * @return {module:model/UpdateFleetAttributesOutput} The populated <code>UpdateFleetAttributesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateFleetAttributesOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateFleetAttributesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateFleetAttributesOutput</code>.
     */
 ...
 */
UpdateFleetAttributesOutput.prototype['FleetId'] = undefined;

/**
 * @member {String} FleetArn
 */
UpdateFleetAttributesOutput.prototype['FleetArn'] = undefined;
...
export default UpdateFleetAttributesOutput;
