...
/**
 * The ServerProcess model module.
 * @module model/ServerProcess
 * @version 2015-10-01
 */
class ServerProcess {
    /**
     * Constructs a new <code>ServerProcess</code>.
     ...
     * @alias module:model/ServerProcess
     * @param launchPath {String} 
     * @param concurrentExecutions {Number} 
     */
    constructor(launchPath, concurrentExecutions) { 
        
        ServerProcess.initialize(this, launchPath, concurrentExecutions);
    }
     ...
     */
    static initialize(obj, launchPath, concurrentExecutions) { 
        obj['LaunchPath'] = launchPath;
        obj['ConcurrentExecutions'] = concurrentExecutions;
    }

    /**
     * Constructs a <code>ServerProcess</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServerProcess} obj Optional instance to populate.
     * @return {module:model/ServerProcess} The populated <code>ServerProcess</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServerProcess();
            ...
            if (data.hasOwnProperty('ConcurrentExecutions')) {
                obj['ConcurrentExecutions'] = ApiClient.convertToType(data['ConcurrentExecutions'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ServerProcess</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServerProcess</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ServerProcess.RequiredProperties) {
        ...
        // validate the optional field `ConcurrentExecutions`
        if (data['ConcurrentExecutions']) { // data not null
          Number.validateJSON(data['ConcurrentExecutions']);
        }
...
ServerProcess.RequiredProperties = ["LaunchPath", "ConcurrentExecutions"];

/**
 * @member {String} LaunchPath
 */
ServerProcess.prototype['LaunchPath'] = undefined;

/**
 * @member {String} Parameters
 */
ServerProcess.prototype['Parameters'] = undefined;

/**
 * @member {Number} ConcurrentExecutions
 */
ServerProcess.prototype['ConcurrentExecutions'] = undefined;
