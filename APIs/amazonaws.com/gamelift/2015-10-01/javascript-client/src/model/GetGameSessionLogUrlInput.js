...
/**
 * The GetGameSessionLogUrlInput model module.
 * @module model/GetGameSessionLogUrlInput
 * @version 2015-10-01
 */
class GetGameSessionLogUrlInput {
    /**
     * Constructs a new <code>GetGameSessionLogUrlInput</code>.
     * @alias module:model/GetGameSessionLogUrlInput
     * @param gameSessionId {String} 
     */
    constructor(gameSessionId) { 
        
        GetGameSessionLogUrlInput.initialize(this, gameSessionId);
    }
    ...
    /**
     * Constructs a <code>GetGameSessionLogUrlInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetGameSessionLogUrlInput} obj Optional instance to populate.
     * @return {module:model/GetGameSessionLogUrlInput} The populated <code>GetGameSessionLogUrlInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetGameSessionLogUrlInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetGameSessionLogUrlInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetGameSessionLogUrlInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetGameSessionLogUrlInput.RequiredProperties) {
...
GetGameSessionLogUrlInput.RequiredProperties = ["GameSessionId"];

/**
 * @member {String} GameSessionId
 */
GetGameSessionLogUrlInput.prototype['GameSessionId'] = undefined;
...
export default GetGameSessionLogUrlInput;
