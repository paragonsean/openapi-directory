...
import StopGameSessionPlacementOutputGameSessionPlacement from './StopGameSessionPlacementOutputGameSessionPlacement';

/**
 * The StopGameSessionPlacementOutput model module.
 * @module model/StopGameSessionPlacementOutput
 * @version 2015-10-01
 */
class StopGameSessionPlacementOutput {
    /**
     * Constructs a new <code>StopGameSessionPlacementOutput</code>.
     * @alias module:model/StopGameSessionPlacementOutput
     */
    constructor() { 
        
        StopGameSessionPlacementOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StopGameSessionPlacementOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StopGameSessionPlacementOutput} obj Optional instance to populate.
     * @return {module:model/StopGameSessionPlacementOutput} The populated <code>StopGameSessionPlacementOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StopGameSessionPlacementOutput();

            if (data.hasOwnProperty('GameSessionPlacement')) {
                obj['GameSessionPlacement'] = StopGameSessionPlacementOutputGameSessionPlacement.constructFromObject(data['GameSessionPlacement']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StopGameSessionPlacementOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StopGameSessionPlacementOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GameSessionPlacement`
        if (data['GameSessionPlacement']) { // data not null
          StopGameSessionPlacementOutputGameSessionPlacement.validateJSON(data['GameSessionPlacement']);
        }
...
/**
 * @member {module:model/StopGameSessionPlacementOutputGameSessionPlacement} GameSessionPlacement
 */
StopGameSessionPlacementOutput.prototype['GameSessionPlacement'] = undefined;
...
export default StopGameSessionPlacementOutput;
