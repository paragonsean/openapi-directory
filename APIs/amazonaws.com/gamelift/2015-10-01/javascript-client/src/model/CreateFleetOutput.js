...
import CreateFleetOutputFleetAttributes from './CreateFleetOutputFleetAttributes';

/**
 * The CreateFleetOutput model module.
 * @module model/CreateFleetOutput
 * @version 2015-10-01
 */
class CreateFleetOutput {
    /**
     * Constructs a new <code>CreateFleetOutput</code>.
     * @alias module:model/CreateFleetOutput
     */
    constructor() { 
        
        CreateFleetOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateFleetOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateFleetOutput} obj Optional instance to populate.
     * @return {module:model/CreateFleetOutput} The populated <code>CreateFleetOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateFleetOutput();

            if (data.hasOwnProperty('FleetAttributes')) {
                obj['FleetAttributes'] = CreateFleetOutputFleetAttributes.constructFromObject(data['FleetAttributes']);
            }
            if (data.hasOwnProperty('LocationStates')) {
                obj['LocationStates'] = ApiClient.convertToType(data['LocationStates'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFleetOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFleetOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `FleetAttributes`
        if (data['FleetAttributes']) { // data not null
          CreateFleetOutputFleetAttributes.validateJSON(data['FleetAttributes']);
        }
        // validate the optional field `LocationStates`
        if (data['LocationStates']) { // data not null
          Array.validateJSON(data['LocationStates']);
        }
...
/**
 * @member {module:model/CreateFleetOutputFleetAttributes} FleetAttributes
 */
CreateFleetOutput.prototype['FleetAttributes'] = undefined;

/**
 * @member {Array} LocationStates
 */
CreateFleetOutput.prototype['LocationStates'] = undefined;
...
export default CreateFleetOutput;
