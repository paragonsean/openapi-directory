...
/**
 * The DeleteAliasInput model module.
 * @module model/DeleteAliasInput
 * @version 2015-10-01
 */
class DeleteAliasInput {
    /**
     * Constructs a new <code>DeleteAliasInput</code>.
     * @alias module:model/DeleteAliasInput
     * @param aliasId {String} 
     */
    constructor(aliasId) { 
        
        DeleteAliasInput.initialize(this, aliasId);
    }
    ...
    /**
     * Constructs a <code>DeleteAliasInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteAliasInput} obj Optional instance to populate.
     * @return {module:model/DeleteAliasInput} The populated <code>DeleteAliasInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteAliasInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteAliasInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteAliasInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteAliasInput.RequiredProperties) {
...
DeleteAliasInput.RequiredProperties = ["AliasId"];

/**
 * @member {String} AliasId
 */
DeleteAliasInput.prototype['AliasId'] = undefined;
...
export default DeleteAliasInput;
