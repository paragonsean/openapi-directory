...
* @readonly
*/
export default class ProtectionPolicy {
    ...
    /**
    * Returns a <code>ProtectionPolicy</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ProtectionPolicy} The enum <code>ProtectionPolicy</code> value.
    */
