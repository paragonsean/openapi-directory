...
/**
 * The DescribeEC2InstanceLimitsInput model module.
 * @module model/DescribeEC2InstanceLimitsInput
 * @version 2015-10-01
 */
class DescribeEC2InstanceLimitsInput {
    /**
     * Constructs a new <code>DescribeEC2InstanceLimitsInput</code>.
     * @alias module:model/DescribeEC2InstanceLimitsInput
     */
    constructor() { 
        
        DescribeEC2InstanceLimitsInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeEC2InstanceLimitsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeEC2InstanceLimitsInput} obj Optional instance to populate.
     * @return {module:model/DescribeEC2InstanceLimitsInput} The populated <code>DescribeEC2InstanceLimitsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeEC2InstanceLimitsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeEC2InstanceLimitsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeEC2InstanceLimitsInput</code>.
     */
 ...
 */
DescribeEC2InstanceLimitsInput.prototype['EC2InstanceType'] = undefined;

/**
 * @member {String} Location
 */
DescribeEC2InstanceLimitsInput.prototype['Location'] = undefined;
...
export default DescribeEC2InstanceLimitsInput;
