...
class AttributeValue {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('SL')) {
                obj['SL'] = ApiClient.convertToType(data['SL'], Array);
            }
            if (data.hasOwnProperty('SDM')) {
                obj['SDM'] = ApiClient.convertToType(data['SDM'], Object);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['SL']) { // data not null
          Array.validateJSON(data['SL']);
        }
        // validate the optional field `SDM`
        if (data['SDM']) { // data not null
          Object.validateJSON(data['SDM']);
        }
 ...
 * @member {Array} SL
 */
AttributeValue.prototype['SL'] = undefined;

/**
 * @member {Object} SDM
 */
AttributeValue.prototype['SDM'] = undefined;
