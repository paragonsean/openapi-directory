...
import ResumeGameServerGroupOutputGameServerGroup from './ResumeGameServerGroupOutputGameServerGroup';

/**
 * The ResumeGameServerGroupOutput model module.
 * @module model/ResumeGameServerGroupOutput
 * @version 2015-10-01
 */
class ResumeGameServerGroupOutput {
    /**
     * Constructs a new <code>ResumeGameServerGroupOutput</code>.
     * @alias module:model/ResumeGameServerGroupOutput
     */
    constructor() { 
        
        ResumeGameServerGroupOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResumeGameServerGroupOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResumeGameServerGroupOutput} obj Optional instance to populate.
     * @return {module:model/ResumeGameServerGroupOutput} The populated <code>ResumeGameServerGroupOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResumeGameServerGroupOutput();

            if (data.hasOwnProperty('GameServerGroup')) {
                obj['GameServerGroup'] = ResumeGameServerGroupOutputGameServerGroup.constructFromObject(data['GameServerGroup']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ResumeGameServerGroupOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResumeGameServerGroupOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GameServerGroup`
        if (data['GameServerGroup']) { // data not null
          ResumeGameServerGroupOutputGameServerGroup.validateJSON(data['GameServerGroup']);
        }
...
/**
 * @member {module:model/ResumeGameServerGroupOutputGameServerGroup} GameServerGroup
 */
ResumeGameServerGroupOutput.prototype['GameServerGroup'] = undefined;
...
export default ResumeGameServerGroupOutput;
