...
import ClaimGameServerOutputGameServer from './ClaimGameServerOutputGameServer';

/**
 * The ClaimGameServerOutput model module.
 * @module model/ClaimGameServerOutput
 * @version 2015-10-01
 */
class ClaimGameServerOutput {
    /**
     * Constructs a new <code>ClaimGameServerOutput</code>.
     * @alias module:model/ClaimGameServerOutput
     */
    constructor() { 
        
        ClaimGameServerOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ClaimGameServerOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ClaimGameServerOutput} obj Optional instance to populate.
     * @return {module:model/ClaimGameServerOutput} The populated <code>ClaimGameServerOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClaimGameServerOutput();

            if (data.hasOwnProperty('GameServer')) {
                obj['GameServer'] = ClaimGameServerOutputGameServer.constructFromObject(data['GameServer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ClaimGameServerOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClaimGameServerOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GameServer`
        if (data['GameServer']) { // data not null
          ClaimGameServerOutputGameServer.validateJSON(data['GameServer']);
        }
...
/**
 * @member {module:model/ClaimGameServerOutputGameServer} GameServer
 */
ClaimGameServerOutput.prototype['GameServer'] = undefined;
...
export default ClaimGameServerOutput;
