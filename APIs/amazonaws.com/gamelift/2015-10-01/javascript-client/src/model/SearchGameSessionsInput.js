...
/**
 * The SearchGameSessionsInput model module.
 * @module model/SearchGameSessionsInput
 * @version 2015-10-01
 */
class SearchGameSessionsInput {
    /**
     * Constructs a new <code>SearchGameSessionsInput</code>.
     * @alias module:model/SearchGameSessionsInput
     */
    constructor() { 
        
        SearchGameSessionsInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SearchGameSessionsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchGameSessionsInput} obj Optional instance to populate.
     * @return {module:model/SearchGameSessionsInput} The populated <code>SearchGameSessionsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchGameSessionsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>SearchGameSessionsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchGameSessionsInput</code>.
     */
 ...
 */
SearchGameSessionsInput.prototype['FleetId'] = undefined;

/**
 * @member {String} AliasId
 */
SearchGameSessionsInput.prototype['AliasId'] = undefined;

/**
 * @member {String} Location
 */
SearchGameSessionsInput.prototype['Location'] = undefined;

/**
 * @member {String} FilterExpression
 */
SearchGameSessionsInput.prototype['FilterExpression'] = undefined;

/**
 * @member {String} SortExpression
 */
SearchGameSessionsInput.prototype['SortExpression'] = undefined;

/**
 * @member {Number} Limit
 */
SearchGameSessionsInput.prototype['Limit'] = undefined;

/**
 * @member {String} NextToken
 */
SearchGameSessionsInput.prototype['NextToken'] = undefined;
...
export default SearchGameSessionsInput;
