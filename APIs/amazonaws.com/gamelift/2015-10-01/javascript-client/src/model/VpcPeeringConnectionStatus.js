...
/**
 * The VpcPeeringConnectionStatus model module.
 * @module model/VpcPeeringConnectionStatus
 * @version 2015-10-01
 */
class VpcPeeringConnectionStatus {
    /**
     * Constructs a new <code>VpcPeeringConnectionStatus</code>.
     * @alias module:model/VpcPeeringConnectionStatus
     * @implements module:model/VpcPeeringConnectionStatus
     */
    constructor() { 
        VpcPeeringConnectionStatus.initialize(this);
        VpcPeeringConnectionStatus.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VpcPeeringConnectionStatus</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VpcPeeringConnectionStatus} obj Optional instance to populate.
     * @return {module:model/VpcPeeringConnectionStatus} The populated <code>VpcPeeringConnectionStatus</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VpcPeeringConnectionStatus();
            VpcPeeringConnectionStatus.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>VpcPeeringConnectionStatus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VpcPeeringConnectionStatus</code>.
     */
 ...
 * @member {String} Code
 */
VpcPeeringConnectionStatus.prototype['Code'] = undefined;

/**
 * @member {String} Message
 */
VpcPeeringConnectionStatus.prototype['Message'] = undefined;


// Implement VpcPeeringConnectionStatus interface:
/**
 * @member {String} Code
 */
VpcPeeringConnectionStatus.prototype['Code'] = undefined;
...
export default VpcPeeringConnectionStatus;
