...
/**
 * The StopFleetActionsInput model module.
 * @module model/StopFleetActionsInput
 * @version 2015-10-01
 */
class StopFleetActionsInput {
    /**
     * Constructs a new <code>StopFleetActionsInput</code>.
     * @alias module:model/StopFleetActionsInput
     * @param fleetId {String} 
     * @param actions {Array} 
     */
    constructor(fleetId, actions) { 
        
        StopFleetActionsInput.initialize(this, fleetId, actions);
    }
    ...
    /**
     * Constructs a <code>StopFleetActionsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StopFleetActionsInput} obj Optional instance to populate.
     * @return {module:model/StopFleetActionsInput} The populated <code>StopFleetActionsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StopFleetActionsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>StopFleetActionsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StopFleetActionsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StopFleetActionsInput.RequiredProperties) {
...
StopFleetActionsInput.RequiredProperties = ["FleetId", "Actions"];

/**
 * @member {String} FleetId
 */
StopFleetActionsInput.prototype['FleetId'] = undefined;

/**
 * @member {Array} Actions
 */
StopFleetActionsInput.prototype['Actions'] = undefined;

/**
 * @member {String} Location
 */
StopFleetActionsInput.prototype['Location'] = undefined;
...
export default StopFleetActionsInput;
