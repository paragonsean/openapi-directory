...
/**
 * The PutScalingPolicyInputTargetConfiguration model module.
 * @module model/PutScalingPolicyInputTargetConfiguration
 * @version 2015-10-01
 */
class PutScalingPolicyInputTargetConfiguration {
    /**
     * Constructs a new <code>PutScalingPolicyInputTargetConfiguration</code>.
     * @alias module:model/PutScalingPolicyInputTargetConfiguration
     * @implements module:model/TargetConfiguration
     * @param targetValue {Number} 
     */
    constructor(targetValue) { 
        TargetConfiguration.initialize(this, targetValue);
        PutScalingPolicyInputTargetConfiguration.initialize(this, targetValue);
    }
    ...
    /**
     * Constructs a <code>PutScalingPolicyInputTargetConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutScalingPolicyInputTargetConfiguration} obj Optional instance to populate.
     * @return {module:model/PutScalingPolicyInputTargetConfiguration} The populated <code>PutScalingPolicyInputTargetConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutScalingPolicyInputTargetConfiguration();
            TargetConfiguration.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>PutScalingPolicyInputTargetConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutScalingPolicyInputTargetConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutScalingPolicyInputTargetConfiguration.RequiredProperties) {
...
PutScalingPolicyInputTargetConfiguration.RequiredProperties = ["TargetValue"];

/**
 * @member {Number} TargetValue
 */
PutScalingPolicyInputTargetConfiguration.prototype['TargetValue'] = undefined;


// Implement TargetConfiguration interface:
/**
 * @member {Number} TargetValue
 */
TargetConfiguration.prototype['TargetValue'] = undefined;




export default PutScalingPolicyInputTargetConfiguration;
