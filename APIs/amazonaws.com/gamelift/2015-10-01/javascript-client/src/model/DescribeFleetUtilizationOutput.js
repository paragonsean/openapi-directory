...
/**
 * The DescribeFleetUtilizationOutput model module.
 * @module model/DescribeFleetUtilizationOutput
 * @version 2015-10-01
 */
class DescribeFleetUtilizationOutput {
    /**
     * Constructs a new <code>DescribeFleetUtilizationOutput</code>.
     * @alias module:model/DescribeFleetUtilizationOutput
     */
    constructor() { 
        
        DescribeFleetUtilizationOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeFleetUtilizationOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeFleetUtilizationOutput} obj Optional instance to populate.
     * @return {module:model/DescribeFleetUtilizationOutput} The populated <code>DescribeFleetUtilizationOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeFleetUtilizationOutput();

            if (data.hasOwnProperty('FleetUtilization')) {
                obj['FleetUtilization'] = ApiClient.convertToType(data['FleetUtilization'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeFleetUtilizationOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeFleetUtilizationOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `FleetUtilization`
        if (data['FleetUtilization']) { // data not null
          Array.validateJSON(data['FleetUtilization']);
        }
...
/**
 * @member {Array} FleetUtilization
 */
DescribeFleetUtilizationOutput.prototype['FleetUtilization'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeFleetUtilizationOutput.prototype['NextToken'] = undefined;
...
export default DescribeFleetUtilizationOutput;
