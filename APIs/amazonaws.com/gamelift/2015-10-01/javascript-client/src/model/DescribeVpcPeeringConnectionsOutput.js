...
/**
 * The DescribeVpcPeeringConnectionsOutput model module.
 * @module model/DescribeVpcPeeringConnectionsOutput
 * @version 2015-10-01
 */
class DescribeVpcPeeringConnectionsOutput {
    /**
     * Constructs a new <code>DescribeVpcPeeringConnectionsOutput</code>.
     * @alias module:model/DescribeVpcPeeringConnectionsOutput
     */
    constructor() { 
        
        DescribeVpcPeeringConnectionsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeVpcPeeringConnectionsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeVpcPeeringConnectionsOutput} obj Optional instance to populate.
     * @return {module:model/DescribeVpcPeeringConnectionsOutput} The populated <code>DescribeVpcPeeringConnectionsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeVpcPeeringConnectionsOutput();

            if (data.hasOwnProperty('VpcPeeringConnections')) {
                obj['VpcPeeringConnections'] = ApiClient.convertToType(data['VpcPeeringConnections'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeVpcPeeringConnectionsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeVpcPeeringConnectionsOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `VpcPeeringConnections`
        if (data['VpcPeeringConnections']) { // data not null
          Array.validateJSON(data['VpcPeeringConnections']);
        }
...
/**
 * @member {Array} VpcPeeringConnections
 */
DescribeVpcPeeringConnectionsOutput.prototype['VpcPeeringConnections'] = undefined;
...
export default DescribeVpcPeeringConnectionsOutput;
