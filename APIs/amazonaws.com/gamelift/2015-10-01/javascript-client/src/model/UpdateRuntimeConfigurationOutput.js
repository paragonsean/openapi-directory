...
import UpdateRuntimeConfigurationOutputRuntimeConfiguration from './UpdateRuntimeConfigurationOutputRuntimeConfiguration';

/**
 * The UpdateRuntimeConfigurationOutput model module.
 * @module model/UpdateRuntimeConfigurationOutput
 * @version 2015-10-01
 */
class UpdateRuntimeConfigurationOutput {
    /**
     * Constructs a new <code>UpdateRuntimeConfigurationOutput</code>.
     * @alias module:model/UpdateRuntimeConfigurationOutput
     */
    constructor() { 
        
        UpdateRuntimeConfigurationOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateRuntimeConfigurationOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateRuntimeConfigurationOutput} obj Optional instance to populate.
     * @return {module:model/UpdateRuntimeConfigurationOutput} The populated <code>UpdateRuntimeConfigurationOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateRuntimeConfigurationOutput();

            if (data.hasOwnProperty('RuntimeConfiguration')) {
                obj['RuntimeConfiguration'] = UpdateRuntimeConfigurationOutputRuntimeConfiguration.constructFromObject(data['RuntimeConfiguration']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateRuntimeConfigurationOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateRuntimeConfigurationOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `RuntimeConfiguration`
        if (data['RuntimeConfiguration']) { // data not null
          UpdateRuntimeConfigurationOutputRuntimeConfiguration.validateJSON(data['RuntimeConfiguration']);
        }
...
/**
 * @member {module:model/UpdateRuntimeConfigurationOutputRuntimeConfiguration} RuntimeConfiguration
 */
UpdateRuntimeConfigurationOutput.prototype['RuntimeConfiguration'] = undefined;
...
export default UpdateRuntimeConfigurationOutput;
