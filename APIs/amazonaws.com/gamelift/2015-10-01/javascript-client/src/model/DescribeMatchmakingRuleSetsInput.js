...
/**
 * The DescribeMatchmakingRuleSetsInput model module.
 * @module model/DescribeMatchmakingRuleSetsInput
 * @version 2015-10-01
 */
class DescribeMatchmakingRuleSetsInput {
    /**
     * Constructs a new <code>DescribeMatchmakingRuleSetsInput</code>.
     * @alias module:model/DescribeMatchmakingRuleSetsInput
     */
    constructor() { 
        
        DescribeMatchmakingRuleSetsInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeMatchmakingRuleSetsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeMatchmakingRuleSetsInput} obj Optional instance to populate.
     * @return {module:model/DescribeMatchmakingRuleSetsInput} The populated <code>DescribeMatchmakingRuleSetsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeMatchmakingRuleSetsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeMatchmakingRuleSetsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeMatchmakingRuleSetsInput</code>.
     */
 ...
 * @member {Array} Names
 */
DescribeMatchmakingRuleSetsInput.prototype['Names'] = undefined;

/**
 * @member {Number} Limit
 */
DescribeMatchmakingRuleSetsInput.prototype['Limit'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeMatchmakingRuleSetsInput.prototype['NextToken'] = undefined;
...
export default DescribeMatchmakingRuleSetsInput;
