...
/**
 * The MatchedPlayerSession model module.
 * @module model/MatchedPlayerSession
 * @version 2015-10-01
 */
class MatchedPlayerSession {
    /**
     * Constructs a new <code>MatchedPlayerSession</code>.
     ...
     * @alias module:model/MatchedPlayerSession
     */
    constructor() { 
        
        MatchedPlayerSession.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MatchedPlayerSession</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MatchedPlayerSession} obj Optional instance to populate.
     * @return {module:model/MatchedPlayerSession} The populated <code>MatchedPlayerSession</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MatchedPlayerSession();
    ...
    /**
     * Validates the JSON data with respect to <code>MatchedPlayerSession</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MatchedPlayerSession</code>.
     */
 ...
 */
MatchedPlayerSession.prototype['PlayerId'] = undefined;

/**
 * @member {String} PlayerSessionId
 */
MatchedPlayerSession.prototype['PlayerSessionId'] = undefined;
...
export default MatchedPlayerSession;
