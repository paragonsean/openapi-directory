...
/**
 * The PutScalingPolicyOutput model module.
 * @module model/PutScalingPolicyOutput
 * @version 2015-10-01
 */
class PutScalingPolicyOutput {
    /**
     * Constructs a new <code>PutScalingPolicyOutput</code>.
     * @alias module:model/PutScalingPolicyOutput
     */
    constructor() { 
        
        PutScalingPolicyOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutScalingPolicyOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutScalingPolicyOutput} obj Optional instance to populate.
     * @return {module:model/PutScalingPolicyOutput} The populated <code>PutScalingPolicyOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutScalingPolicyOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>PutScalingPolicyOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutScalingPolicyOutput</code>.
     */
 ...
 * @member {String} Name
 */
PutScalingPolicyOutput.prototype['Name'] = undefined;
...
export default PutScalingPolicyOutput;
