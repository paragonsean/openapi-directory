...
/**
 * The StartFleetActionsOutput model module.
 * @module model/StartFleetActionsOutput
 * @version 2015-10-01
 */
class StartFleetActionsOutput {
    /**
     * Constructs a new <code>StartFleetActionsOutput</code>.
     * @alias module:model/StartFleetActionsOutput
     */
    constructor() { 
        
        StartFleetActionsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartFleetActionsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartFleetActionsOutput} obj Optional instance to populate.
     * @return {module:model/StartFleetActionsOutput} The populated <code>StartFleetActionsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartFleetActionsOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>StartFleetActionsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartFleetActionsOutput</code>.
     */
 ...
 */
StartFleetActionsOutput.prototype['FleetId'] = undefined;

/**
 * @member {String} FleetArn
 */
StartFleetActionsOutput.prototype['FleetArn'] = undefined;
...
export default StartFleetActionsOutput;
