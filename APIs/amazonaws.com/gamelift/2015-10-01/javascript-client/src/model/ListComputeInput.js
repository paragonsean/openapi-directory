...
/**
 * The ListComputeInput model module.
 * @module model/ListComputeInput
 * @version 2015-10-01
 */
class ListComputeInput {
    /**
     * Constructs a new <code>ListComputeInput</code>.
     * @alias module:model/ListComputeInput
     * @param fleetId {String} 
     */
    constructor(fleetId) { 
        
        ListComputeInput.initialize(this, fleetId);
    }
    ...
    /**
     * Constructs a <code>ListComputeInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListComputeInput} obj Optional instance to populate.
     * @return {module:model/ListComputeInput} The populated <code>ListComputeInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListComputeInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListComputeInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListComputeInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListComputeInput.RequiredProperties) {
...
ListComputeInput.RequiredProperties = ["FleetId"];

/**
 * @member {String} FleetId
 */
ListComputeInput.prototype['FleetId'] = undefined;

/**
 * @member {String} Location
 */
ListComputeInput.prototype['Location'] = undefined;

/**
 * @member {Number} Limit
 */
ListComputeInput.prototype['Limit'] = undefined;

/**
 * @member {String} NextToken
 */
ListComputeInput.prototype['NextToken'] = undefined;
...
export default ListComputeInput;
