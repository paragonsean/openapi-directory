...
/**
 * The ListAliasesOutput model module.
 * @module model/ListAliasesOutput
 * @version 2015-10-01
 */
class ListAliasesOutput {
    /**
     * Constructs a new <code>ListAliasesOutput</code>.
     * @alias module:model/ListAliasesOutput
     */
    constructor() { 
        
        ListAliasesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListAliasesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAliasesOutput} obj Optional instance to populate.
     * @return {module:model/ListAliasesOutput} The populated <code>ListAliasesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListAliasesOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListAliasesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListAliasesOutput</code>.
     */
 ...
 */
ListAliasesOutput.prototype['Aliases'] = undefined;

/**
 * @member {String} NextToken
 */
ListAliasesOutput.prototype['NextToken'] = undefined;
...
export default ListAliasesOutput;
