...
/**
 * The ListScriptsInput model module.
 * @module model/ListScriptsInput
 * @version 2015-10-01
 */
class ListScriptsInput {
    /**
     * Constructs a new <code>ListScriptsInput</code>.
     * @alias module:model/ListScriptsInput
     */
    constructor() { 
        
        ListScriptsInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListScriptsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListScriptsInput} obj Optional instance to populate.
     * @return {module:model/ListScriptsInput} The populated <code>ListScriptsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListScriptsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListScriptsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListScriptsInput</code>.
     */
 ...
 * @member {Number} Limit
 */
ListScriptsInput.prototype['Limit'] = undefined;

/**
 * @member {String} NextToken
 */
ListScriptsInput.prototype['NextToken'] = undefined;
...
export default ListScriptsInput;
