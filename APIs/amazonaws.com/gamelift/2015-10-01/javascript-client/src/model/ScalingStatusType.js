...
* @readonly
*/
export default class ScalingStatusType {
    ...
    /**
    * Returns a <code>ScalingStatusType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ScalingStatusType} The enum <code>ScalingStatusType</code> value.
    */
