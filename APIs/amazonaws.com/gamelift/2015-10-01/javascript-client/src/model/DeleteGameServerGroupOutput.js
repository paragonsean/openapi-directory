...
import DeleteGameServerGroupOutputGameServerGroup from './DeleteGameServerGroupOutputGameServerGroup';

/**
 * The DeleteGameServerGroupOutput model module.
 * @module model/DeleteGameServerGroupOutput
 * @version 2015-10-01
 */
class DeleteGameServerGroupOutput {
    /**
     * Constructs a new <code>DeleteGameServerGroupOutput</code>.
     * @alias module:model/DeleteGameServerGroupOutput
     */
    constructor() { 
        
        DeleteGameServerGroupOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteGameServerGroupOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteGameServerGroupOutput} obj Optional instance to populate.
     * @return {module:model/DeleteGameServerGroupOutput} The populated <code>DeleteGameServerGroupOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteGameServerGroupOutput();

            if (data.hasOwnProperty('GameServerGroup')) {
                obj['GameServerGroup'] = DeleteGameServerGroupOutputGameServerGroup.constructFromObject(data['GameServerGroup']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteGameServerGroupOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteGameServerGroupOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GameServerGroup`
        if (data['GameServerGroup']) { // data not null
          DeleteGameServerGroupOutputGameServerGroup.validateJSON(data['GameServerGroup']);
        }
...
/**
 * @member {module:model/DeleteGameServerGroupOutputGameServerGroup} GameServerGroup
 */
DeleteGameServerGroupOutput.prototype['GameServerGroup'] = undefined;
...
export default DeleteGameServerGroupOutput;
