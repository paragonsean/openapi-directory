...
/**
 * The DescribeFleetLocationUtilizationInput model module.
 * @module model/DescribeFleetLocationUtilizationInput
 * @version 2015-10-01
 */
class DescribeFleetLocationUtilizationInput {
    /**
     * Constructs a new <code>DescribeFleetLocationUtilizationInput</code>.
     * @alias module:model/DescribeFleetLocationUtilizationInput
     * @param fleetId {String} 
     * @param location {String} 
     */
    constructor(fleetId, location) { 
        
        DescribeFleetLocationUtilizationInput.initialize(this, fleetId, location);
    }
    ...
    /**
     * Constructs a <code>DescribeFleetLocationUtilizationInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeFleetLocationUtilizationInput} obj Optional instance to populate.
     * @return {module:model/DescribeFleetLocationUtilizationInput} The populated <code>DescribeFleetLocationUtilizationInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeFleetLocationUtilizationInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeFleetLocationUtilizationInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeFleetLocationUtilizationInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeFleetLocationUtilizationInput.RequiredProperties) {
...
DescribeFleetLocationUtilizationInput.RequiredProperties = ["FleetId", "Location"];

/**
 * @member {String} FleetId
 */
DescribeFleetLocationUtilizationInput.prototype['FleetId'] = undefined;

/**
 * @member {String} Location
 */
DescribeFleetLocationUtilizationInput.prototype['Location'] = undefined;
...
export default DescribeFleetLocationUtilizationInput;
