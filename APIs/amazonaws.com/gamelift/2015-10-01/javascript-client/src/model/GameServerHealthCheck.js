...
* @readonly
*/
export default class GameServerHealthCheck {
    ...
    /**
    * Returns a <code>GameServerHealthCheck</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/GameServerHealthCheck} The enum <code>GameServerHealthCheck</code> value.
    */
