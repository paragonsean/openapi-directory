...
import CreateBuildInputStorageLocation from './CreateBuildInputStorageLocation';
import OperatingSystem from './OperatingSystem';

/**
 * The CreateBuildInput model module.
 * @module model/CreateBuildInput
 * @version 2015-10-01
 */
class CreateBuildInput {
    /**
     * Constructs a new <code>CreateBuildInput</code>.
     * @alias module:model/CreateBuildInput
     */
    constructor() { 
        
        CreateBuildInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateBuildInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateBuildInput} obj Optional instance to populate.
     * @return {module:model/CreateBuildInput} The populated <code>CreateBuildInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateBuildInput();
            ...
            if (data.hasOwnProperty('StorageLocation')) {
                obj['StorageLocation'] = CreateBuildInputStorageLocation.constructFromObject(data['StorageLocation']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateBuildInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateBuildInput</code>.
     */
    static validateJSON(data) {
        ...
        if (data['StorageLocation']) { // data not null
          CreateBuildInputStorageLocation.validateJSON(data['StorageLocation']);
        }
 ...
 * @member {String} Name
 */
CreateBuildInput.prototype['Name'] = undefined;

/**
 * @member {String} Version
 */
CreateBuildInput.prototype['Version'] = undefined;

/**
 * @member {module:model/CreateBuildInputStorageLocation} StorageLocation
 */
CreateBuildInput.prototype['StorageLocation'] = undefined;

/**
 * @member {module:model/OperatingSystem} OperatingSystem
 */
CreateBuildInput.prototype['OperatingSystem'] = undefined;

/**
 * @member {Array} Tags
 */
CreateBuildInput.prototype['Tags'] = undefined;

/**
 * @member {String} ServerSdkVersion
 */
CreateBuildInput.prototype['ServerSdkVersion'] = undefined;
...
export default CreateBuildInput;
