...
/**
 * The DescribeInstancesOutput model module.
 * @module model/DescribeInstancesOutput
 * @version 2015-10-01
 */
class DescribeInstancesOutput {
    /**
     * Constructs a new <code>DescribeInstancesOutput</code>.
     * @alias module:model/DescribeInstancesOutput
     */
    constructor() { 
        
        DescribeInstancesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeInstancesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeInstancesOutput} obj Optional instance to populate.
     * @return {module:model/DescribeInstancesOutput} The populated <code>DescribeInstancesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeInstancesOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeInstancesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeInstancesOutput</code>.
     */
 ...
 */
DescribeInstancesOutput.prototype['Instances'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeInstancesOutput.prototype['NextToken'] = undefined;
...
export default DescribeInstancesOutput;
