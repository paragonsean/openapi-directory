...
/**
 * The DescribeFleetEventsOutput model module.
 * @module model/DescribeFleetEventsOutput
 * @version 2015-10-01
 */
class DescribeFleetEventsOutput {
    /**
     * Constructs a new <code>DescribeFleetEventsOutput</code>.
     * @alias module:model/DescribeFleetEventsOutput
     */
    constructor() { 
        
        DescribeFleetEventsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeFleetEventsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeFleetEventsOutput} obj Optional instance to populate.
     * @return {module:model/DescribeFleetEventsOutput} The populated <code>DescribeFleetEventsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeFleetEventsOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeFleetEventsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeFleetEventsOutput</code>.
     */
 ...
 * @member {Array} Events
 */
DescribeFleetEventsOutput.prototype['Events'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeFleetEventsOutput.prototype['NextToken'] = undefined;
...
export default DescribeFleetEventsOutput;
