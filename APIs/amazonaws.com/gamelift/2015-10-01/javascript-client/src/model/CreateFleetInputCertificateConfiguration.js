...
/**
 * The CreateFleetInputCertificateConfiguration model module.
 * @module model/CreateFleetInputCertificateConfiguration
 * @version 2015-10-01
 */
class CreateFleetInputCertificateConfiguration {
    /**
     * Constructs a new <code>CreateFleetInputCertificateConfiguration</code>.
     * @alias module:model/CreateFleetInputCertificateConfiguration
     * @implements module:model/CertificateConfiguration
     * @param certificateType {module:model/CertificateType} 
     */
    constructor(certificateType) { 
        CertificateConfiguration.initialize(this, certificateType);
        CreateFleetInputCertificateConfiguration.initialize(this, certificateType);
    }
     ...
     */
    static initialize(obj, certificateType) { 
        obj['CertificateType'] = certificateType;
    }

    /**
     * Constructs a <code>CreateFleetInputCertificateConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateFleetInputCertificateConfiguration} obj Optional instance to populate.
     * @return {module:model/CreateFleetInputCertificateConfiguration} The populated <code>CreateFleetInputCertificateConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateFleetInputCertificateConfiguration();
            CertificateConfiguration.constructFromObject(data, obj);

            if (data.hasOwnProperty('CertificateType')) {
                obj['CertificateType'] = ApiClient.convertToType(data['CertificateType'], CertificateType);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFleetInputCertificateConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFleetInputCertificateConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateFleetInputCertificateConfiguration.RequiredProperties) {
        ...
        if (data['CertificateType']) { // data not null
          CertificateType.validateJSON(data['CertificateType']);
        }
...
CreateFleetInputCertificateConfiguration.RequiredProperties = ["CertificateType"];

/**
 * @member {module:model/CertificateType} CertificateType
 */
CreateFleetInputCertificateConfiguration.prototype['CertificateType'] = undefined;


// Implement CertificateConfiguration interface:
/**
 * @member {module:model/CertificateType} CertificateType
 */
CertificateConfiguration.prototype['CertificateType'] = undefined;




export default CreateFleetInputCertificateConfiguration;
