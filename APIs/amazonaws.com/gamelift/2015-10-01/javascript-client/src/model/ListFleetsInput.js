...
/**
 * The ListFleetsInput model module.
 * @module model/ListFleetsInput
 * @version 2015-10-01
 */
class ListFleetsInput {
    /**
     * Constructs a new <code>ListFleetsInput</code>.
     * @alias module:model/ListFleetsInput
     */
    constructor() { 
        
        ListFleetsInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListFleetsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListFleetsInput} obj Optional instance to populate.
     * @return {module:model/ListFleetsInput} The populated <code>ListFleetsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListFleetsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListFleetsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListFleetsInput</code>.
     */
 ...
 */
ListFleetsInput.prototype['BuildId'] = undefined;

/**
 * @member {String} ScriptId
 */
ListFleetsInput.prototype['ScriptId'] = undefined;

/**
 * @member {Number} Limit
 */
ListFleetsInput.prototype['Limit'] = undefined;

/**
 * @member {String} NextToken
 */
ListFleetsInput.prototype['NextToken'] = undefined;
...
export default ListFleetsInput;
