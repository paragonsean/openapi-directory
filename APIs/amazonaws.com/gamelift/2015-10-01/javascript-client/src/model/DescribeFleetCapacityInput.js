...
/**
 * The DescribeFleetCapacityInput model module.
 * @module model/DescribeFleetCapacityInput
 * @version 2015-10-01
 */
class DescribeFleetCapacityInput {
    /**
     * Constructs a new <code>DescribeFleetCapacityInput</code>.
     * @alias module:model/DescribeFleetCapacityInput
     */
    constructor() { 
        
        DescribeFleetCapacityInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeFleetCapacityInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeFleetCapacityInput} obj Optional instance to populate.
     * @return {module:model/DescribeFleetCapacityInput} The populated <code>DescribeFleetCapacityInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeFleetCapacityInput();

            if (data.hasOwnProperty('FleetIds')) {
                obj['FleetIds'] = ApiClient.convertToType(data['FleetIds'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeFleetCapacityInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeFleetCapacityInput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `FleetIds`
        if (data['FleetIds']) { // data not null
          Array.validateJSON(data['FleetIds']);
        }
...
/**
 * @member {Array} FleetIds
 */
DescribeFleetCapacityInput.prototype['FleetIds'] = undefined;

/**
 * @member {Number} Limit
 */
DescribeFleetCapacityInput.prototype['Limit'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeFleetCapacityInput.prototype['NextToken'] = undefined;
...
export default DescribeFleetCapacityInput;
