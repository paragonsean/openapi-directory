...
/**
 * The CreateFleetLocationsOutput model module.
 * @module model/CreateFleetLocationsOutput
 * @version 2015-10-01
 */
class CreateFleetLocationsOutput {
    /**
     * Constructs a new <code>CreateFleetLocationsOutput</code>.
     * @alias module:model/CreateFleetLocationsOutput
     */
    constructor() { 
        
        CreateFleetLocationsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateFleetLocationsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateFleetLocationsOutput} obj Optional instance to populate.
     * @return {module:model/CreateFleetLocationsOutput} The populated <code>CreateFleetLocationsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateFleetLocationsOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFleetLocationsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFleetLocationsOutput</code>.
     */
 ...
 */
CreateFleetLocationsOutput.prototype['FleetId'] = undefined;

/**
 * @member {String} FleetArn
 */
CreateFleetLocationsOutput.prototype['FleetArn'] = undefined;

/**
 * @member {Array} LocationStates
 */
CreateFleetLocationsOutput.prototype['LocationStates'] = undefined;
...
export default CreateFleetLocationsOutput;
