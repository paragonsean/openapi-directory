...
/**
 * The GameProperty model module.
 * @module model/GameProperty
 * @version 2015-10-01
 */
class GameProperty {
    /**
     * Constructs a new <code>GameProperty</code>.
     ...
     * @alias module:model/GameProperty
     * @param key {String} 
     * @param value {String} 
     */
    constructor(key, value) { 
        
        GameProperty.initialize(this, key, value);
    }
    ...
    /**
     * Constructs a <code>GameProperty</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GameProperty} obj Optional instance to populate.
     * @return {module:model/GameProperty} The populated <code>GameProperty</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GameProperty();
    ...
    /**
     * Validates the JSON data with respect to <code>GameProperty</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GameProperty</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GameProperty.RequiredProperties) {
...
GameProperty.RequiredProperties = ["Key", "Value"];

/**
 * @member {String} Key
 */
GameProperty.prototype['Key'] = undefined;

/**
 * @member {String} Value
 */
GameProperty.prototype['Value'] = undefined;
