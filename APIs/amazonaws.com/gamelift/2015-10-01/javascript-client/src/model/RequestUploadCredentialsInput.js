...
/**
 * The RequestUploadCredentialsInput model module.
 * @module model/RequestUploadCredentialsInput
 * @version 2015-10-01
 */
class RequestUploadCredentialsInput {
    /**
     * Constructs a new <code>RequestUploadCredentialsInput</code>.
     * @alias module:model/RequestUploadCredentialsInput
     * @param buildId {String} 
     */
    constructor(buildId) { 
        
        RequestUploadCredentialsInput.initialize(this, buildId);
    }
    ...
    /**
     * Constructs a <code>RequestUploadCredentialsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RequestUploadCredentialsInput} obj Optional instance to populate.
     * @return {module:model/RequestUploadCredentialsInput} The populated <code>RequestUploadCredentialsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RequestUploadCredentialsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>RequestUploadCredentialsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RequestUploadCredentialsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RequestUploadCredentialsInput.RequiredProperties) {
...
RequestUploadCredentialsInput.RequiredProperties = ["BuildId"];

/**
 * @member {String} BuildId
 */
RequestUploadCredentialsInput.prototype['BuildId'] = undefined;
...
export default RequestUploadCredentialsInput;
