...
/**
 * The DescribeRuntimeConfigurationInput model module.
 * @module model/DescribeRuntimeConfigurationInput
 * @version 2015-10-01
 */
class DescribeRuntimeConfigurationInput {
    /**
     * Constructs a new <code>DescribeRuntimeConfigurationInput</code>.
     * @alias module:model/DescribeRuntimeConfigurationInput
     * @param fleetId {String} 
     */
    constructor(fleetId) { 
        
        DescribeRuntimeConfigurationInput.initialize(this, fleetId);
    }
    ...
    /**
     * Constructs a <code>DescribeRuntimeConfigurationInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeRuntimeConfigurationInput} obj Optional instance to populate.
     * @return {module:model/DescribeRuntimeConfigurationInput} The populated <code>DescribeRuntimeConfigurationInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeRuntimeConfigurationInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeRuntimeConfigurationInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeRuntimeConfigurationInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeRuntimeConfigurationInput.RequiredProperties) {
...
DescribeRuntimeConfigurationInput.RequiredProperties = ["FleetId"];

/**
 * @member {String} FleetId
 */
DescribeRuntimeConfigurationInput.prototype['FleetId'] = undefined;
...
export default DescribeRuntimeConfigurationInput;
