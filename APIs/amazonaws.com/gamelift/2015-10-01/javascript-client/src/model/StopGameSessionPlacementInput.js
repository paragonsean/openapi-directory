...
/**
 * The StopGameSessionPlacementInput model module.
 * @module model/StopGameSessionPlacementInput
 * @version 2015-10-01
 */
class StopGameSessionPlacementInput {
    /**
     * Constructs a new <code>StopGameSessionPlacementInput</code>.
     * @alias module:model/StopGameSessionPlacementInput
     * @param placementId {String} 
     */
    constructor(placementId) { 
        
        StopGameSessionPlacementInput.initialize(this, placementId);
    }
    ...
    /**
     * Constructs a <code>StopGameSessionPlacementInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StopGameSessionPlacementInput} obj Optional instance to populate.
     * @return {module:model/StopGameSessionPlacementInput} The populated <code>StopGameSessionPlacementInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StopGameSessionPlacementInput();
    ...
    /**
     * Validates the JSON data with respect to <code>StopGameSessionPlacementInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StopGameSessionPlacementInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StopGameSessionPlacementInput.RequiredProperties) {
...
StopGameSessionPlacementInput.RequiredProperties = ["PlacementId"];

/**
 * @member {String} PlacementId
 */
StopGameSessionPlacementInput.prototype['PlacementId'] = undefined;
...
export default StopGameSessionPlacementInput;
