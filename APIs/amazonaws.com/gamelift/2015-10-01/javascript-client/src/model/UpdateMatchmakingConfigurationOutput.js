...
import UpdateMatchmakingConfigurationOutputConfiguration from './UpdateMatchmakingConfigurationOutputConfiguration';

/**
 * The UpdateMatchmakingConfigurationOutput model module.
 * @module model/UpdateMatchmakingConfigurationOutput
 * @version 2015-10-01
 */
class UpdateMatchmakingConfigurationOutput {
    /**
     * Constructs a new <code>UpdateMatchmakingConfigurationOutput</code>.
     * @alias module:model/UpdateMatchmakingConfigurationOutput
     */
    constructor() { 
        
        UpdateMatchmakingConfigurationOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateMatchmakingConfigurationOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateMatchmakingConfigurationOutput} obj Optional instance to populate.
     * @return {module:model/UpdateMatchmakingConfigurationOutput} The populated <code>UpdateMatchmakingConfigurationOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateMatchmakingConfigurationOutput();

            if (data.hasOwnProperty('Configuration')) {
                obj['Configuration'] = UpdateMatchmakingConfigurationOutputConfiguration.constructFromObject(data['Configuration']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateMatchmakingConfigurationOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateMatchmakingConfigurationOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Configuration`
        if (data['Configuration']) { // data not null
          UpdateMatchmakingConfigurationOutputConfiguration.validateJSON(data['Configuration']);
        }
...
/**
 * @member {module:model/UpdateMatchmakingConfigurationOutputConfiguration} Configuration
 */
UpdateMatchmakingConfigurationOutput.prototype['Configuration'] = undefined;
...
export default UpdateMatchmakingConfigurationOutput;
