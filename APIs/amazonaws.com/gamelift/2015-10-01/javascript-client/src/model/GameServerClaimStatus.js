...
* @readonly
*/
export default class GameServerClaimStatus {
    ...
    /**
    * Returns a <code>GameServerClaimStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/GameServerClaimStatus} The enum <code>GameServerClaimStatus</code> value.
    */
