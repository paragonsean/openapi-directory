...
/**
 * The InstanceAccessCredentials model module.
 * @module model/InstanceAccessCredentials
 * @version 2015-10-01
 */
class InstanceAccessCredentials {
    /**
     * Constructs a new <code>InstanceAccessCredentials</code>.
     * @alias module:model/InstanceAccessCredentials
     * @implements module:model/InstanceCredentials
     */
    constructor() { 
        InstanceCredentials.initialize(this);
        InstanceAccessCredentials.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InstanceAccessCredentials</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InstanceAccessCredentials} obj Optional instance to populate.
     * @return {module:model/InstanceAccessCredentials} The populated <code>InstanceAccessCredentials</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InstanceAccessCredentials();
            InstanceCredentials.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>InstanceAccessCredentials</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InstanceAccessCredentials</code>.
     */
 ...
 */
InstanceAccessCredentials.prototype['UserName'] = undefined;

/**
 * @member {String} Secret
 */
InstanceAccessCredentials.prototype['Secret'] = undefined;


// Implement InstanceCredentials interface:
/**
 * @member {String} UserName
 */
InstanceCredentials.prototype['UserName'] = undefined;
/**
 * @member {String} Secret
 */
InstanceCredentials.prototype['Secret'] = undefined;




export default InstanceAccessCredentials;
