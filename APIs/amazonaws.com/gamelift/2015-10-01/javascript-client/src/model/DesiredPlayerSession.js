...
/**
 * The DesiredPlayerSession model module.
 * @module model/DesiredPlayerSession
 * @version 2015-10-01
 */
class DesiredPlayerSession {
    /**
     * Constructs a new <code>DesiredPlayerSession</code>.
     * Player information for use when creating player sessions using a game session placement request.
     * @alias module:model/DesiredPlayerSession
     */
    constructor() { 
        
        DesiredPlayerSession.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DesiredPlayerSession</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DesiredPlayerSession} obj Optional instance to populate.
     * @return {module:model/DesiredPlayerSession} The populated <code>DesiredPlayerSession</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DesiredPlayerSession();
    ...
    /**
     * Validates the JSON data with respect to <code>DesiredPlayerSession</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DesiredPlayerSession</code>.
     */
 ...
 */
DesiredPlayerSession.prototype['PlayerId'] = undefined;

/**
 * @member {String} PlayerData
 */
DesiredPlayerSession.prototype['PlayerData'] = undefined;
...
export default DesiredPlayerSession;
