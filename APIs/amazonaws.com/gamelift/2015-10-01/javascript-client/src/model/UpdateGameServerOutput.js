...
import UpdateGameServerOutputGameServer from './UpdateGameServerOutputGameServer';

/**
 * The UpdateGameServerOutput model module.
 * @module model/UpdateGameServerOutput
 * @version 2015-10-01
 */
class UpdateGameServerOutput {
    /**
     * Constructs a new <code>UpdateGameServerOutput</code>.
     * @alias module:model/UpdateGameServerOutput
     */
    constructor() { 
        
        UpdateGameServerOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateGameServerOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateGameServerOutput} obj Optional instance to populate.
     * @return {module:model/UpdateGameServerOutput} The populated <code>UpdateGameServerOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateGameServerOutput();

            if (data.hasOwnProperty('GameServer')) {
                obj['GameServer'] = UpdateGameServerOutputGameServer.constructFromObject(data['GameServer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateGameServerOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateGameServerOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GameServer`
        if (data['GameServer']) { // data not null
          UpdateGameServerOutputGameServer.validateJSON(data['GameServer']);
        }
...
/**
 * @member {module:model/UpdateGameServerOutputGameServer} GameServer
 */
UpdateGameServerOutput.prototype['GameServer'] = undefined;
...
export default UpdateGameServerOutput;
