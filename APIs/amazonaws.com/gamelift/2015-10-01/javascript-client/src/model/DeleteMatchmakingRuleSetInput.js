...
/**
 * The DeleteMatchmakingRuleSetInput model module.
 * @module model/DeleteMatchmakingRuleSetInput
 * @version 2015-10-01
 */
class DeleteMatchmakingRuleSetInput {
    /**
     * Constructs a new <code>DeleteMatchmakingRuleSetInput</code>.
     * @alias module:model/DeleteMatchmakingRuleSetInput
     * @param name {String} 
     */
    constructor(name) { 
        
        DeleteMatchmakingRuleSetInput.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>DeleteMatchmakingRuleSetInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteMatchmakingRuleSetInput} obj Optional instance to populate.
     * @return {module:model/DeleteMatchmakingRuleSetInput} The populated <code>DeleteMatchmakingRuleSetInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteMatchmakingRuleSetInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteMatchmakingRuleSetInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteMatchmakingRuleSetInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteMatchmakingRuleSetInput.RequiredProperties) {
...
DeleteMatchmakingRuleSetInput.RequiredProperties = ["Name"];

/**
 * @member {String} Name
 */
DeleteMatchmakingRuleSetInput.prototype['Name'] = undefined;
...
export default DeleteMatchmakingRuleSetInput;
