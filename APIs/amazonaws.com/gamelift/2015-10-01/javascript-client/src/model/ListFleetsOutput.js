...
/**
 * The ListFleetsOutput model module.
 * @module model/ListFleetsOutput
 * @version 2015-10-01
 */
class ListFleetsOutput {
    /**
     * Constructs a new <code>ListFleetsOutput</code>.
     * @alias module:model/ListFleetsOutput
     */
    constructor() { 
        
        ListFleetsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListFleetsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListFleetsOutput} obj Optional instance to populate.
     * @return {module:model/ListFleetsOutput} The populated <code>ListFleetsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListFleetsOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListFleetsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListFleetsOutput</code>.
     */
 ...
 */
ListFleetsOutput.prototype['FleetIds'] = undefined;

/**
 * @member {String} NextToken
 */
ListFleetsOutput.prototype['NextToken'] = undefined;
...
export default ListFleetsOutput;
