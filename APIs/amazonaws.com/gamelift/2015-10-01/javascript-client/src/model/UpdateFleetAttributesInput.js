...
import UpdateFleetAttributesInputResourceCreationLimitPolicy from './UpdateFleetAttributesInputResourceCreationLimitPolicy';

/**
 * The UpdateFleetAttributesInput model module.
 * @module model/UpdateFleetAttributesInput
 * @version 2015-10-01
 */
class UpdateFleetAttributesInput {
    /**
     * Constructs a new <code>UpdateFleetAttributesInput</code>.
     * @alias module:model/UpdateFleetAttributesInput
     * @param fleetId {String} 
     */
    constructor(fleetId) { 
        
        UpdateFleetAttributesInput.initialize(this, fleetId);
    }
    ...
    /**
     * Constructs a <code>UpdateFleetAttributesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateFleetAttributesInput} obj Optional instance to populate.
     * @return {module:model/UpdateFleetAttributesInput} The populated <code>UpdateFleetAttributesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateFleetAttributesInput();
            ...
            if (data.hasOwnProperty('ResourceCreationLimitPolicy')) {
                obj['ResourceCreationLimitPolicy'] = UpdateFleetAttributesInputResourceCreationLimitPolicy.constructFromObject(data['ResourceCreationLimitPolicy']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateFleetAttributesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateFleetAttributesInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateFleetAttributesInput.RequiredProperties) {
        ...
        if (data['ResourceCreationLimitPolicy']) { // data not null
          UpdateFleetAttributesInputResourceCreationLimitPolicy.validateJSON(data['ResourceCreationLimitPolicy']);
        }
...
UpdateFleetAttributesInput.RequiredProperties = ["FleetId"];

/**
 * @member {String} FleetId
 */
UpdateFleetAttributesInput.prototype['FleetId'] = undefined;

/**
 * @member {String} Name
 */
UpdateFleetAttributesInput.prototype['Name'] = undefined;

/**
 * @member {String} Description
 */
UpdateFleetAttributesInput.prototype['Description'] = undefined;

/**
 * @member {module:model/ProtectionPolicy} NewGameSessionProtectionPolicy
 */
UpdateFleetAttributesInput.prototype['NewGameSessionProtectionPolicy'] = undefined;

/**
 * @member {module:model/UpdateFleetAttributesInputResourceCreationLimitPolicy} ResourceCreationLimitPolicy
 */
UpdateFleetAttributesInput.prototype['ResourceCreationLimitPolicy'] = undefined;

/**
 * @member {Array} MetricGroups
 */
UpdateFleetAttributesInput.prototype['MetricGroups'] = undefined;

/**
 * @member {module:model/CreateFleetInputAnywhereConfiguration} AnywhereConfiguration
 */
UpdateFleetAttributesInput.prototype['AnywhereConfiguration'] = undefined;
...
export default UpdateFleetAttributesInput;
