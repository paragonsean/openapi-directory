...
/**
 * The DescribeEC2InstanceLimitsOutput model module.
 * @module model/DescribeEC2InstanceLimitsOutput
 * @version 2015-10-01
 */
class DescribeEC2InstanceLimitsOutput {
    /**
     * Constructs a new <code>DescribeEC2InstanceLimitsOutput</code>.
     * @alias module:model/DescribeEC2InstanceLimitsOutput
     */
    constructor() { 
        
        DescribeEC2InstanceLimitsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeEC2InstanceLimitsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeEC2InstanceLimitsOutput} obj Optional instance to populate.
     * @return {module:model/DescribeEC2InstanceLimitsOutput} The populated <code>DescribeEC2InstanceLimitsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeEC2InstanceLimitsOutput();

            if (data.hasOwnProperty('EC2InstanceLimits')) {
                obj['EC2InstanceLimits'] = ApiClient.convertToType(data['EC2InstanceLimits'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeEC2InstanceLimitsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeEC2InstanceLimitsOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `EC2InstanceLimits`
        if (data['EC2InstanceLimits']) { // data not null
          Array.validateJSON(data['EC2InstanceLimits']);
        }
...
/**
 * @member {Array} EC2InstanceLimits
 */
DescribeEC2InstanceLimitsOutput.prototype['EC2InstanceLimits'] = undefined;
...
export default DescribeEC2InstanceLimitsOutput;
