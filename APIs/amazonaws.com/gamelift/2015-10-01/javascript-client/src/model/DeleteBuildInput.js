...
/**
 * The DeleteBuildInput model module.
 * @module model/DeleteBuildInput
 * @version 2015-10-01
 */
class DeleteBuildInput {
    /**
     * Constructs a new <code>DeleteBuildInput</code>.
     * @alias module:model/DeleteBuildInput
     * @param buildId {String} 
     */
    constructor(buildId) { 
        
        DeleteBuildInput.initialize(this, buildId);
    }
    ...
    /**
     * Constructs a <code>DeleteBuildInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteBuildInput} obj Optional instance to populate.
     * @return {module:model/DeleteBuildInput} The populated <code>DeleteBuildInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteBuildInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteBuildInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteBuildInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteBuildInput.RequiredProperties) {
...
DeleteBuildInput.RequiredProperties = ["BuildId"];

/**
 * @member {String} BuildId
 */
DeleteBuildInput.prototype['BuildId'] = undefined;
...
export default DeleteBuildInput;
