...
* @readonly
*/
export default class GameSessionPlacementState {
    ...
    /**
    * Returns a <code>GameSessionPlacementState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/GameSessionPlacementState} The enum <code>GameSessionPlacementState</code> value.
    */
