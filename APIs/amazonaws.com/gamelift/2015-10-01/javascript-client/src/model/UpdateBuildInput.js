...
/**
 * The UpdateBuildInput model module.
 * @module model/UpdateBuildInput
 * @version 2015-10-01
 */
class UpdateBuildInput {
    /**
     * Constructs a new <code>UpdateBuildInput</code>.
     * @alias module:model/UpdateBuildInput
     * @param buildId {String} 
     */
    constructor(buildId) { 
        
        UpdateBuildInput.initialize(this, buildId);
    }
    ...
    /**
     * Constructs a <code>UpdateBuildInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateBuildInput} obj Optional instance to populate.
     * @return {module:model/UpdateBuildInput} The populated <code>UpdateBuildInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateBuildInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateBuildInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateBuildInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateBuildInput.RequiredProperties) {
...
UpdateBuildInput.RequiredProperties = ["BuildId"];

/**
 * @member {String} BuildId
 */
UpdateBuildInput.prototype['BuildId'] = undefined;

/**
 * @member {String} Name
 */
UpdateBuildInput.prototype['Name'] = undefined;

/**
 * @member {String} Version
 */
UpdateBuildInput.prototype['Version'] = undefined;
...
export default UpdateBuildInput;
