...
/**
 * The ListComputeOutput model module.
 * @module model/ListComputeOutput
 * @version 2015-10-01
 */
class ListComputeOutput {
    /**
     * Constructs a new <code>ListComputeOutput</code>.
     * @alias module:model/ListComputeOutput
     */
    constructor() { 
        
        ListComputeOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListComputeOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListComputeOutput} obj Optional instance to populate.
     * @return {module:model/ListComputeOutput} The populated <code>ListComputeOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListComputeOutput();

            if (data.hasOwnProperty('ComputeList')) {
                obj['ComputeList'] = ApiClient.convertToType(data['ComputeList'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListComputeOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListComputeOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `ComputeList`
        if (data['ComputeList']) { // data not null
          Array.validateJSON(data['ComputeList']);
        }
...
/**
 * @member {Array} ComputeList
 */
ListComputeOutput.prototype['ComputeList'] = undefined;

/**
 * @member {String} NextToken
 */
ListComputeOutput.prototype['NextToken'] = undefined;
...
export default ListComputeOutput;
