...
/**
 * The AnywhereConfiguration model module.
 * @module model/AnywhereConfiguration
 * @version 2015-10-01
 */
class AnywhereConfiguration {
    /**
     * Constructs a new <code>AnywhereConfiguration</code>.
     * Amazon GameLift Anywhere configuration options for your Anywhere fleets.
     * @alias module:model/AnywhereConfiguration
     * @param cost {String} 
     */
    constructor(cost) { 
    ...
    /**
     * Constructs a <code>AnywhereConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AnywhereConfiguration} obj Optional instance to populate.
     * @return {module:model/AnywhereConfiguration} The populated <code>AnywhereConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AnywhereConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>AnywhereConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AnywhereConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AnywhereConfiguration.RequiredProperties) {
...
AnywhereConfiguration.RequiredProperties = ["Cost"];
...
export default AnywhereConfiguration;
