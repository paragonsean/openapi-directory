...
/**
 * The SearchGameSessionsOutput model module.
 * @module model/SearchGameSessionsOutput
 * @version 2015-10-01
 */
class SearchGameSessionsOutput {
    /**
     * Constructs a new <code>SearchGameSessionsOutput</code>.
     * @alias module:model/SearchGameSessionsOutput
     */
    constructor() { 
        
        SearchGameSessionsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SearchGameSessionsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchGameSessionsOutput} obj Optional instance to populate.
     * @return {module:model/SearchGameSessionsOutput} The populated <code>SearchGameSessionsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchGameSessionsOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>SearchGameSessionsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchGameSessionsOutput</code>.
     */
 ...
 */
SearchGameSessionsOutput.prototype['GameSessions'] = undefined;

/**
 * @member {String} NextToken
 */
SearchGameSessionsOutput.prototype['NextToken'] = undefined;
...
export default SearchGameSessionsOutput;
