...
/**
 * The RequestUploadCredentialsOutputStorageLocation model module.
 * @module model/RequestUploadCredentialsOutputStorageLocation
 * @version 2015-10-01
 */
class RequestUploadCredentialsOutputStorageLocation {
    /**
     * Constructs a new <code>RequestUploadCredentialsOutputStorageLocation</code>.
     * @alias module:model/RequestUploadCredentialsOutputStorageLocation
     * @implements module:model/S3Location
     */
    constructor() { 
        S3Location.initialize(this);
        RequestUploadCredentialsOutputStorageLocation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RequestUploadCredentialsOutputStorageLocation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RequestUploadCredentialsOutputStorageLocation} obj Optional instance to populate.
     * @return {module:model/RequestUploadCredentialsOutputStorageLocation} The populated <code>RequestUploadCredentialsOutputStorageLocation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RequestUploadCredentialsOutputStorageLocation();
    ...
    /**
     * Validates the JSON data with respect to <code>RequestUploadCredentialsOutputStorageLocation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RequestUploadCredentialsOutputStorageLocation</code>.
     */
 ...
 */
RequestUploadCredentialsOutputStorageLocation.prototype['Bucket'] = undefined;

/**
 * @member {String} Key
 */
RequestUploadCredentialsOutputStorageLocation.prototype['Key'] = undefined;

/**
 * @member {String} RoleArn
 */
RequestUploadCredentialsOutputStorageLocation.prototype['RoleArn'] = undefined;

/**
 * @member {String} ObjectVersion
 */
RequestUploadCredentialsOutputStorageLocation.prototype['ObjectVersion'] = undefined;
...
export default RequestUploadCredentialsOutputStorageLocation;
