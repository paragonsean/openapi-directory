...
/**
 * The DescribeFleetAttributesInput model module.
 * @module model/DescribeFleetAttributesInput
 * @version 2015-10-01
 */
class DescribeFleetAttributesInput {
    /**
     * Constructs a new <code>DescribeFleetAttributesInput</code>.
     * @alias module:model/DescribeFleetAttributesInput
     */
    constructor() { 
        
        DescribeFleetAttributesInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeFleetAttributesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeFleetAttributesInput} obj Optional instance to populate.
     * @return {module:model/DescribeFleetAttributesInput} The populated <code>DescribeFleetAttributesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeFleetAttributesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeFleetAttributesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeFleetAttributesInput</code>.
     */
 ...
 */
DescribeFleetAttributesInput.prototype['FleetIds'] = undefined;

/**
 * @member {Number} Limit
 */
DescribeFleetAttributesInput.prototype['Limit'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeFleetAttributesInput.prototype['NextToken'] = undefined;
...
export default DescribeFleetAttributesInput;
