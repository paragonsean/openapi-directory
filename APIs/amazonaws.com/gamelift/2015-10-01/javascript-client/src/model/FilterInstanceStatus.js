...
* @readonly
*/
export default class FilterInstanceStatus {
    ...
    /**
    * Returns a <code>FilterInstanceStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FilterInstanceStatus} The enum <code>FilterInstanceStatus</code> value.
    */
