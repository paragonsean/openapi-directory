...
/**
 * The CreateScriptInput model module.
 * @module model/CreateScriptInput
 * @version 2015-10-01
 */
class CreateScriptInput {
    /**
     * Constructs a new <code>CreateScriptInput</code>.
     * @alias module:model/CreateScriptInput
     */
    constructor() { 
        
        CreateScriptInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateScriptInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateScriptInput} obj Optional instance to populate.
     * @return {module:model/CreateScriptInput} The populated <code>CreateScriptInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateScriptInput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateScriptInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateScriptInput</code>.
     */
 ...
 * @member {String} Name
 */
CreateScriptInput.prototype['Name'] = undefined;

/**
 * @member {String} Version
 */
CreateScriptInput.prototype['Version'] = undefined;

/**
 * @member {module:model/CreateScriptInputStorageLocation} StorageLocation
 */
CreateScriptInput.prototype['StorageLocation'] = undefined;

/**
 * @member {String} ZipFile
 */
CreateScriptInput.prototype['ZipFile'] = undefined;

/**
 * @member {Array} Tags
 */
CreateScriptInput.prototype['Tags'] = undefined;
...
export default CreateScriptInput;
