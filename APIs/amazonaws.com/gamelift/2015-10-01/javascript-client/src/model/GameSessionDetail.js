...
import GameSessionDetailGameSession from './GameSessionDetailGameSession';
import ProtectionPolicy from './ProtectionPolicy';

/**
 * The GameSessionDetail model module.
 * @module model/GameSessionDetail
 * @version 2015-10-01
 */
class GameSessionDetail {
    /**
     * Constructs a new <code>GameSessionDetail</code>.
     * A game session&#39;s properties plus the protection policy currently in force.
     * @alias module:model/GameSessionDetail
     */
    constructor() { 
        
        GameSessionDetail.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GameSessionDetail</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GameSessionDetail} obj Optional instance to populate.
     * @return {module:model/GameSessionDetail} The populated <code>GameSessionDetail</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GameSessionDetail();

            if (data.hasOwnProperty('GameSession')) {
                obj['GameSession'] = GameSessionDetailGameSession.constructFromObject(data['GameSession']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GameSessionDetail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GameSessionDetail</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GameSession`
        if (data['GameSession']) { // data not null
          GameSessionDetailGameSession.validateJSON(data['GameSession']);
        }
...
/**
 * @member {module:model/GameSessionDetailGameSession} GameSession
 */
GameSessionDetail.prototype['GameSession'] = undefined;

/**
 * @member {module:model/ProtectionPolicy} ProtectionPolicy
 */
GameSessionDetail.prototype['ProtectionPolicy'] = undefined;
...
export default GameSessionDetail;
