...
/**
 * The FleetUtilization model module.
 * @module model/FleetUtilization
 * @version 2015-10-01
 */
class FleetUtilization {
    /**
     * Constructs a new <code>FleetUtilization</code>.
     ...
     * @alias module:model/FleetUtilization
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>FleetUtilization</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FleetUtilization} obj Optional instance to populate.
     * @return {module:model/FleetUtilization} The populated <code>FleetUtilization</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FleetUtilization();
    ...
    /**
     * Validates the JSON data with respect to <code>FleetUtilization</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FleetUtilization</code>.
     */
