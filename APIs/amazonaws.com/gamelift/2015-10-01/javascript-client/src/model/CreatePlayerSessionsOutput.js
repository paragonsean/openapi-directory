...
/**
 * The CreatePlayerSessionsOutput model module.
 * @module model/CreatePlayerSessionsOutput
 * @version 2015-10-01
 */
class CreatePlayerSessionsOutput {
    /**
     * Constructs a new <code>CreatePlayerSessionsOutput</code>.
     * @alias module:model/CreatePlayerSessionsOutput
     */
    constructor() { 
        
        CreatePlayerSessionsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreatePlayerSessionsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePlayerSessionsOutput} obj Optional instance to populate.
     * @return {module:model/CreatePlayerSessionsOutput} The populated <code>CreatePlayerSessionsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePlayerSessionsOutput();

            if (data.hasOwnProperty('PlayerSessions')) {
                obj['PlayerSessions'] = ApiClient.convertToType(data['PlayerSessions'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePlayerSessionsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePlayerSessionsOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `PlayerSessions`
        if (data['PlayerSessions']) { // data not null
          Array.validateJSON(data['PlayerSessions']);
        }
...
/**
 * @member {Array} PlayerSessions
 */
CreatePlayerSessionsOutput.prototype['PlayerSessions'] = undefined;
...
export default CreatePlayerSessionsOutput;
