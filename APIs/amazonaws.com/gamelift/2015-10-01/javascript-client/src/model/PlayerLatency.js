...
/**
 * The PlayerLatency model module.
 * @module model/PlayerLatency
 * @version 2015-10-01
 */
class PlayerLatency {
    /**
     * Constructs a new <code>PlayerLatency</code>.
     * Regional latency information for a player, used when requesting a new game session. This value indicates the amount of time lag that exists when the player is connected to a fleet in the specified Region. The relative difference between a player&#39;s latency values for multiple Regions are used to determine which fleets are best suited to place a new game session for the player. 
     * @alias module:model/PlayerLatency
     */
    constructor() { 
        
        PlayerLatency.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PlayerLatency</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PlayerLatency} obj Optional instance to populate.
     * @return {module:model/PlayerLatency} The populated <code>PlayerLatency</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PlayerLatency();

            if (data.hasOwnProperty('PlayerId')) {
                obj['PlayerId'] = ApiClient.convertToType(data['PlayerId'], 'String');
            }
            if (data.hasOwnProperty('RegionIdentifier')) {
                obj['RegionIdentifier'] = ApiClient.convertToType(data['RegionIdentifier'], 'String');
            }
            if (data.hasOwnProperty('LatencyInMilliseconds')) {
                obj['LatencyInMilliseconds'] = ApiClient.convertToType(data['LatencyInMilliseconds'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PlayerLatency</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PlayerLatency</code>.
     */
    static validateJSON(data) {
        ...
        if (data['RegionIdentifier']) { // data not null
          String.validateJSON(data['RegionIdentifier']);
        }
        // validate the optional field `LatencyInMilliseconds`
        if (data['LatencyInMilliseconds']) { // data not null
          Number.validateJSON(data['LatencyInMilliseconds']);
        }
 ...
 */
PlayerLatency.prototype['PlayerId'] = undefined;

/**
 * @member {String} RegionIdentifier
 */
PlayerLatency.prototype['RegionIdentifier'] = undefined;

/**
 * @member {Number} LatencyInMilliseconds
 */
PlayerLatency.prototype['LatencyInMilliseconds'] = undefined;
