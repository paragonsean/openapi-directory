...
/**
 * The DescribeGameServerGroupInput model module.
 * @module model/DescribeGameServerGroupInput
 * @version 2015-10-01
 */
class DescribeGameServerGroupInput {
    /**
     * Constructs a new <code>DescribeGameServerGroupInput</code>.
     * @alias module:model/DescribeGameServerGroupInput
     * @param gameServerGroupName {String} 
     */
    constructor(gameServerGroupName) { 
        
        DescribeGameServerGroupInput.initialize(this, gameServerGroupName);
    }
    ...
    /**
     * Constructs a <code>DescribeGameServerGroupInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeGameServerGroupInput} obj Optional instance to populate.
     * @return {module:model/DescribeGameServerGroupInput} The populated <code>DescribeGameServerGroupInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeGameServerGroupInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeGameServerGroupInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeGameServerGroupInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeGameServerGroupInput.RequiredProperties) {
...
DescribeGameServerGroupInput.RequiredProperties = ["GameServerGroupName"];

/**
 * @member {String} GameServerGroupName
 */
DescribeGameServerGroupInput.prototype['GameServerGroupName'] = undefined;
...
export default DescribeGameServerGroupInput;
