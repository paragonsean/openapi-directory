...
/**
 * The VpcPeeringAuthorization model module.
 * @module model/VpcPeeringAuthorization
 * @version 2015-10-01
 */
class VpcPeeringAuthorization {
    /**
     * Constructs a new <code>VpcPeeringAuthorization</code>.
     ...
     * @alias module:model/VpcPeeringAuthorization
     */
    constructor() { 
        
        VpcPeeringAuthorization.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VpcPeeringAuthorization</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VpcPeeringAuthorization} obj Optional instance to populate.
     * @return {module:model/VpcPeeringAuthorization} The populated <code>VpcPeeringAuthorization</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VpcPeeringAuthorization();
    ...
    /**
     * Validates the JSON data with respect to <code>VpcPeeringAuthorization</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VpcPeeringAuthorization</code>.
     */
 ...
 */
VpcPeeringAuthorization.prototype['GameLiftAwsAccountId'] = undefined;

/**
 * @member {String} PeerVpcAwsAccountId
 */
VpcPeeringAuthorization.prototype['PeerVpcAwsAccountId'] = undefined;

/**
 * @member {String} PeerVpcId
 */
VpcPeeringAuthorization.prototype['PeerVpcId'] = undefined;

/**
 * @member {Date} CreationTime
 */
VpcPeeringAuthorization.prototype['CreationTime'] = undefined;

/**
 * @member {Date} ExpirationTime
 */
VpcPeeringAuthorization.prototype['ExpirationTime'] = undefined;
...
export default VpcPeeringAuthorization;
