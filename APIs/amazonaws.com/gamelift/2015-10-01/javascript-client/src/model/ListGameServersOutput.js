...
/**
 * The ListGameServersOutput model module.
 * @module model/ListGameServersOutput
 * @version 2015-10-01
 */
class ListGameServersOutput {
    /**
     * Constructs a new <code>ListGameServersOutput</code>.
     * @alias module:model/ListGameServersOutput
     */
    constructor() { 
        
        ListGameServersOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListGameServersOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListGameServersOutput} obj Optional instance to populate.
     * @return {module:model/ListGameServersOutput} The populated <code>ListGameServersOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListGameServersOutput();

            if (data.hasOwnProperty('GameServers')) {
                obj['GameServers'] = ApiClient.convertToType(data['GameServers'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListGameServersOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListGameServersOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GameServers`
        if (data['GameServers']) { // data not null
          Array.validateJSON(data['GameServers']);
        }
...
/**
 * @member {Array} GameServers
 */
ListGameServersOutput.prototype['GameServers'] = undefined;

/**
 * @member {String} NextToken
 */
ListGameServersOutput.prototype['NextToken'] = undefined;
...
export default ListGameServersOutput;
