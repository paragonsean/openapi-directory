...
/**
 * The DescribeFleetCapacityOutput model module.
 * @module model/DescribeFleetCapacityOutput
 * @version 2015-10-01
 */
class DescribeFleetCapacityOutput {
    /**
     * Constructs a new <code>DescribeFleetCapacityOutput</code>.
     * @alias module:model/DescribeFleetCapacityOutput
     */
    constructor() { 
        
        DescribeFleetCapacityOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeFleetCapacityOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeFleetCapacityOutput} obj Optional instance to populate.
     * @return {module:model/DescribeFleetCapacityOutput} The populated <code>DescribeFleetCapacityOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeFleetCapacityOutput();

            if (data.hasOwnProperty('FleetCapacity')) {
                obj['FleetCapacity'] = ApiClient.convertToType(data['FleetCapacity'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeFleetCapacityOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeFleetCapacityOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `FleetCapacity`
        if (data['FleetCapacity']) { // data not null
          Array.validateJSON(data['FleetCapacity']);
        }
...
/**
 * @member {Array} FleetCapacity
 */
DescribeFleetCapacityOutput.prototype['FleetCapacity'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeFleetCapacityOutput.prototype['NextToken'] = undefined;
...
export default DescribeFleetCapacityOutput;
