...
import CreateLocationOutputLocation from './CreateLocationOutputLocation';

/**
 * The CreateLocationOutput model module.
 * @module model/CreateLocationOutput
 * @version 2015-10-01
 */
class CreateLocationOutput {
    /**
     * Constructs a new <code>CreateLocationOutput</code>.
     * @alias module:model/CreateLocationOutput
     */
    constructor() { 
        
        CreateLocationOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateLocationOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateLocationOutput} obj Optional instance to populate.
     * @return {module:model/CreateLocationOutput} The populated <code>CreateLocationOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateLocationOutput();

            if (data.hasOwnProperty('Location')) {
                obj['Location'] = CreateLocationOutputLocation.constructFromObject(data['Location']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateLocationOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateLocationOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Location`
        if (data['Location']) { // data not null
          CreateLocationOutputLocation.validateJSON(data['Location']);
        }
...
/**
 * @member {module:model/CreateLocationOutputLocation} Location
 */
CreateLocationOutput.prototype['Location'] = undefined;
...
export default CreateLocationOutput;
