...
/**
 * The UpdateAliasInputRoutingStrategy model module.
 * @module model/UpdateAliasInputRoutingStrategy
 * @version 2015-10-01
 */
class UpdateAliasInputRoutingStrategy {
    /**
     * Constructs a new <code>UpdateAliasInputRoutingStrategy</code>.
     * @alias module:model/UpdateAliasInputRoutingStrategy
     * @implements module:model/RoutingStrategy
     */
    constructor() { 
        RoutingStrategy.initialize(this);
        UpdateAliasInputRoutingStrategy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateAliasInputRoutingStrategy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateAliasInputRoutingStrategy} obj Optional instance to populate.
     * @return {module:model/UpdateAliasInputRoutingStrategy} The populated <code>UpdateAliasInputRoutingStrategy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateAliasInputRoutingStrategy();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateAliasInputRoutingStrategy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateAliasInputRoutingStrategy</code>.
     */
 ...
 */
UpdateAliasInputRoutingStrategy.prototype['Type'] = undefined;

/**
 * @member {String} FleetId
 */
UpdateAliasInputRoutingStrategy.prototype['FleetId'] = undefined;

/**
 * @member {String} Message
 */
UpdateAliasInputRoutingStrategy.prototype['Message'] = undefined;
...
export default UpdateAliasInputRoutingStrategy;
