...
import LocationUpdateStatus from './LocationUpdateStatus';

/**
 * The DescribeFleetPortSettingsOutput model module.
 * @module model/DescribeFleetPortSettingsOutput
 * @version 2015-10-01
 */
class DescribeFleetPortSettingsOutput {
    /**
     * Constructs a new <code>DescribeFleetPortSettingsOutput</code>.
     * @alias module:model/DescribeFleetPortSettingsOutput
     */
    constructor() { 
        
        DescribeFleetPortSettingsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeFleetPortSettingsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeFleetPortSettingsOutput} obj Optional instance to populate.
     * @return {module:model/DescribeFleetPortSettingsOutput} The populated <code>DescribeFleetPortSettingsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeFleetPortSettingsOutput();
            ...
            if (data.hasOwnProperty('InboundPermissions')) {
                obj['InboundPermissions'] = ApiClient.convertToType(data['InboundPermissions'], Array);
            }
            if (data.hasOwnProperty('UpdateStatus')) {
                obj['UpdateStatus'] = ApiClient.convertToType(data['UpdateStatus'], LocationUpdateStatus);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeFleetPortSettingsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeFleetPortSettingsOutput</code>.
     */
    static validateJSON(data) {
        ...
        if (data['InboundPermissions']) { // data not null
          Array.validateJSON(data['InboundPermissions']);
        }
        // validate the optional field `UpdateStatus`
        if (data['UpdateStatus']) { // data not null
          LocationUpdateStatus.validateJSON(data['UpdateStatus']);
        }
 ...
 */
DescribeFleetPortSettingsOutput.prototype['FleetId'] = undefined;

/**
 * @member {String} FleetArn
 */
DescribeFleetPortSettingsOutput.prototype['FleetArn'] = undefined;

/**
 * @member {Array} InboundPermissions
 */
DescribeFleetPortSettingsOutput.prototype['InboundPermissions'] = undefined;

/**
 * @member {module:model/LocationUpdateStatus} UpdateStatus
 */
DescribeFleetPortSettingsOutput.prototype['UpdateStatus'] = undefined;

/**
 * @member {String} Location
 */
DescribeFleetPortSettingsOutput.prototype['Location'] = undefined;
...
export default DescribeFleetPortSettingsOutput;
