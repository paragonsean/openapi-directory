...
/**
 * The StartMatchmakingInput model module.
 * @module model/StartMatchmakingInput
 * @version 2015-10-01
 */
class StartMatchmakingInput {
    /**
     * Constructs a new <code>StartMatchmakingInput</code>.
     * @alias module:model/StartMatchmakingInput
     * @param configurationName {String} 
     * @param players {Array} 
     */
    constructor(configurationName, players) { 
        
        StartMatchmakingInput.initialize(this, configurationName, players);
    }
    ...
    /**
     * Constructs a <code>StartMatchmakingInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartMatchmakingInput} obj Optional instance to populate.
     * @return {module:model/StartMatchmakingInput} The populated <code>StartMatchmakingInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartMatchmakingInput();
    ...
    /**
     * Validates the JSON data with respect to <code>StartMatchmakingInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartMatchmakingInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartMatchmakingInput.RequiredProperties) {
...
StartMatchmakingInput.RequiredProperties = ["ConfigurationName", "Players"];

/**
 * @member {String} TicketId
 */
StartMatchmakingInput.prototype['TicketId'] = undefined;

/**
 * @member {String} ConfigurationName
 */
StartMatchmakingInput.prototype['ConfigurationName'] = undefined;

/**
 * @member {Array} Players
 */
StartMatchmakingInput.prototype['Players'] = undefined;
...
export default StartMatchmakingInput;
