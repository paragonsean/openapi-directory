...
/**
 * The UpdateScriptInput model module.
 * @module model/UpdateScriptInput
 * @version 2015-10-01
 */
class UpdateScriptInput {
    /**
     * Constructs a new <code>UpdateScriptInput</code>.
     * @alias module:model/UpdateScriptInput
     * @param scriptId {String} 
     */
    constructor(scriptId) { 
        
        UpdateScriptInput.initialize(this, scriptId);
    }
    ...
    /**
     * Constructs a <code>UpdateScriptInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateScriptInput} obj Optional instance to populate.
     * @return {module:model/UpdateScriptInput} The populated <code>UpdateScriptInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateScriptInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateScriptInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateScriptInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateScriptInput.RequiredProperties) {
...
UpdateScriptInput.RequiredProperties = ["ScriptId"];

/**
 * @member {String} ScriptId
 */
UpdateScriptInput.prototype['ScriptId'] = undefined;

/**
 * @member {String} Name
 */
UpdateScriptInput.prototype['Name'] = undefined;

/**
 * @member {String} Version
 */
UpdateScriptInput.prototype['Version'] = undefined;

/**
 * @member {module:model/CreateScriptInputStorageLocation} StorageLocation
 */
UpdateScriptInput.prototype['StorageLocation'] = undefined;

/**
 * @member {String} ZipFile
 */
UpdateScriptInput.prototype['ZipFile'] = undefined;
...
export default UpdateScriptInput;
