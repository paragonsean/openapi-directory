...
/**
 * The DescribeComputeInput model module.
 * @module model/DescribeComputeInput
 * @version 2015-10-01
 */
class DescribeComputeInput {
    /**
     * Constructs a new <code>DescribeComputeInput</code>.
     * @alias module:model/DescribeComputeInput
     * @param fleetId {String} 
     * @param computeName {String} 
     */
    constructor(fleetId, computeName) { 
        
        DescribeComputeInput.initialize(this, fleetId, computeName);
    }
    ...
    /**
     * Constructs a <code>DescribeComputeInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeComputeInput} obj Optional instance to populate.
     * @return {module:model/DescribeComputeInput} The populated <code>DescribeComputeInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeComputeInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeComputeInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeComputeInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeComputeInput.RequiredProperties) {
...
DescribeComputeInput.RequiredProperties = ["FleetId", "ComputeName"];

/**
 * @member {String} FleetId
 */
DescribeComputeInput.prototype['FleetId'] = undefined;

/**
 * @member {String} ComputeName
 */
DescribeComputeInput.prototype['ComputeName'] = undefined;
...
export default DescribeComputeInput;
