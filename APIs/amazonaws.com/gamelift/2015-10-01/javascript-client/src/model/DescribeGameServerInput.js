...
/**
 * The DescribeGameServerInput model module.
 * @module model/DescribeGameServerInput
 * @version 2015-10-01
 */
class DescribeGameServerInput {
    /**
     * Constructs a new <code>DescribeGameServerInput</code>.
     * @alias module:model/DescribeGameServerInput
     * @param gameServerGroupName {String} 
     * @param gameServerId {String} 
     */
    constructor(gameServerGroupName, gameServerId) { 
        
        DescribeGameServerInput.initialize(this, gameServerGroupName, gameServerId);
    }
    ...
    /**
     * Constructs a <code>DescribeGameServerInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeGameServerInput} obj Optional instance to populate.
     * @return {module:model/DescribeGameServerInput} The populated <code>DescribeGameServerInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeGameServerInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeGameServerInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeGameServerInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeGameServerInput.RequiredProperties) {
...
DescribeGameServerInput.RequiredProperties = ["GameServerGroupName", "GameServerId"];

/**
 * @member {String} GameServerGroupName
 */
DescribeGameServerInput.prototype['GameServerGroupName'] = undefined;

/**
 * @member {String} GameServerId
 */
DescribeGameServerInput.prototype['GameServerId'] = undefined;
...
export default DescribeGameServerInput;
