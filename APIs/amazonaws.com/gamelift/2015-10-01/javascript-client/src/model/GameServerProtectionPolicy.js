...
* @readonly
*/
export default class GameServerProtectionPolicy {
    ...
    /**
    * Returns a <code>GameServerProtectionPolicy</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/GameServerProtectionPolicy} The enum <code>GameServerProtectionPolicy</code> value.
    */
