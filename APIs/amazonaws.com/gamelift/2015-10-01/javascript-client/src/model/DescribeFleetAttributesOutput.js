...
/**
 * The DescribeFleetAttributesOutput model module.
 * @module model/DescribeFleetAttributesOutput
 * @version 2015-10-01
 */
class DescribeFleetAttributesOutput {
    /**
     * Constructs a new <code>DescribeFleetAttributesOutput</code>.
     * @alias module:model/DescribeFleetAttributesOutput
     */
    constructor() { 
        
        DescribeFleetAttributesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeFleetAttributesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeFleetAttributesOutput} obj Optional instance to populate.
     * @return {module:model/DescribeFleetAttributesOutput} The populated <code>DescribeFleetAttributesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeFleetAttributesOutput();

            if (data.hasOwnProperty('FleetAttributes')) {
                obj['FleetAttributes'] = ApiClient.convertToType(data['FleetAttributes'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeFleetAttributesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeFleetAttributesOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `FleetAttributes`
        if (data['FleetAttributes']) { // data not null
          Array.validateJSON(data['FleetAttributes']);
        }
...
/**
 * @member {Array} FleetAttributes
 */
DescribeFleetAttributesOutput.prototype['FleetAttributes'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeFleetAttributesOutput.prototype['NextToken'] = undefined;
...
export default DescribeFleetAttributesOutput;
