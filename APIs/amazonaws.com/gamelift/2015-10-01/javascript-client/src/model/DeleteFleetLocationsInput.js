...
/**
 * The DeleteFleetLocationsInput model module.
 * @module model/DeleteFleetLocationsInput
 * @version 2015-10-01
 */
class DeleteFleetLocationsInput {
    /**
     * Constructs a new <code>DeleteFleetLocationsInput</code>.
     * @alias module:model/DeleteFleetLocationsInput
     * @param fleetId {String} 
     * @param locations {Array} 
     */
    constructor(fleetId, locations) { 
        
        DeleteFleetLocationsInput.initialize(this, fleetId, locations);
    }
     ...
     */
    static initialize(obj, fleetId, locations) { 
        obj['FleetId'] = fleetId;
        obj['Locations'] = locations;
    }

    /**
     * Constructs a <code>DeleteFleetLocationsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteFleetLocationsInput} obj Optional instance to populate.
     * @return {module:model/DeleteFleetLocationsInput} The populated <code>DeleteFleetLocationsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteFleetLocationsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteFleetLocationsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteFleetLocationsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteFleetLocationsInput.RequiredProperties) {
...
DeleteFleetLocationsInput.RequiredProperties = ["FleetId", "Locations"];

/**
 * @member {String} FleetId
 */
DeleteFleetLocationsInput.prototype['FleetId'] = undefined;

/**
 * @member {Array} Locations
 */
DeleteFleetLocationsInput.prototype['Locations'] = undefined;
...
export default DeleteFleetLocationsInput;
