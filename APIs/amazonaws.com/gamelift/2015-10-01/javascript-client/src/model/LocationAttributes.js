...
import LocationAttributesLocationState from './LocationAttributesLocationState';
import LocationUpdateStatus from './LocationUpdateStatus';

/**
 * The LocationAttributes model module.
 * @module model/LocationAttributes
 * @version 2015-10-01
 */
class LocationAttributes {
    /**
     * Constructs a new <code>LocationAttributes</code>.
     * Details about a location in a multi-location fleet.
     * @alias module:model/LocationAttributes
     */
    constructor() { 
        
        LocationAttributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LocationAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LocationAttributes} obj Optional instance to populate.
     * @return {module:model/LocationAttributes} The populated <code>LocationAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LocationAttributes();

            if (data.hasOwnProperty('LocationState')) {
                obj['LocationState'] = LocationAttributesLocationState.constructFromObject(data['LocationState']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>LocationAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LocationAttributes</code>.
     */
    static validateJSON(data) {
        // validate the optional field `LocationState`
        if (data['LocationState']) { // data not null
          LocationAttributesLocationState.validateJSON(data['LocationState']);
        }
...
/**
 * @member {module:model/LocationAttributesLocationState} LocationState
 */
LocationAttributes.prototype['LocationState'] = undefined;

/**
 * @member {Array} StoppedActions
 */
LocationAttributes.prototype['StoppedActions'] = undefined;

/**
 * @member {module:model/LocationUpdateStatus} UpdateStatus
 */
LocationAttributes.prototype['UpdateStatus'] = undefined;
