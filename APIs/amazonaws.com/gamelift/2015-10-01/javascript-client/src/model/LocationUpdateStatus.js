...
* @readonly
*/
export default class LocationUpdateStatus {
    ...
    /**
    * Returns a <code>LocationUpdateStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/LocationUpdateStatus} The enum <code>LocationUpdateStatus</code> value.
    */
