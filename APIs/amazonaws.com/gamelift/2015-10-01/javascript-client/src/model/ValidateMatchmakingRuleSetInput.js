...
/**
 * The ValidateMatchmakingRuleSetInput model module.
 * @module model/ValidateMatchmakingRuleSetInput
 * @version 2015-10-01
 */
class ValidateMatchmakingRuleSetInput {
    /**
     * Constructs a new <code>ValidateMatchmakingRuleSetInput</code>.
     * @alias module:model/ValidateMatchmakingRuleSetInput
     * @param ruleSetBody {String} 
     */
    constructor(ruleSetBody) { 
        
        ValidateMatchmakingRuleSetInput.initialize(this, ruleSetBody);
    }
    ...
    /**
     * Constructs a <code>ValidateMatchmakingRuleSetInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ValidateMatchmakingRuleSetInput} obj Optional instance to populate.
     * @return {module:model/ValidateMatchmakingRuleSetInput} The populated <code>ValidateMatchmakingRuleSetInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ValidateMatchmakingRuleSetInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ValidateMatchmakingRuleSetInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ValidateMatchmakingRuleSetInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ValidateMatchmakingRuleSetInput.RequiredProperties) {
...
ValidateMatchmakingRuleSetInput.RequiredProperties = ["RuleSetBody"];

/**
 * @member {String} RuleSetBody
 */
ValidateMatchmakingRuleSetInput.prototype['RuleSetBody'] = undefined;
...
export default ValidateMatchmakingRuleSetInput;
