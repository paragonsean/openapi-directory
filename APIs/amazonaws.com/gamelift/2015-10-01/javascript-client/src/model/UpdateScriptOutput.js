...
import UpdateScriptOutputScript from './UpdateScriptOutputScript';

/**
 * The UpdateScriptOutput model module.
 * @module model/UpdateScriptOutput
 * @version 2015-10-01
 */
class UpdateScriptOutput {
    /**
     * Constructs a new <code>UpdateScriptOutput</code>.
     * @alias module:model/UpdateScriptOutput
     */
    constructor() { 
        
        UpdateScriptOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateScriptOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateScriptOutput} obj Optional instance to populate.
     * @return {module:model/UpdateScriptOutput} The populated <code>UpdateScriptOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateScriptOutput();

            if (data.hasOwnProperty('Script')) {
                obj['Script'] = UpdateScriptOutputScript.constructFromObject(data['Script']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateScriptOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateScriptOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Script`
        if (data['Script']) { // data not null
          UpdateScriptOutputScript.validateJSON(data['Script']);
        }
...
/**
 * @member {module:model/UpdateScriptOutputScript} Script
 */
UpdateScriptOutput.prototype['Script'] = undefined;
...
export default UpdateScriptOutput;
