...
/**
 * The UpdateFleetPortSettingsOutput model module.
 * @module model/UpdateFleetPortSettingsOutput
 * @version 2015-10-01
 */
class UpdateFleetPortSettingsOutput {
    /**
     * Constructs a new <code>UpdateFleetPortSettingsOutput</code>.
     * @alias module:model/UpdateFleetPortSettingsOutput
     */
    constructor() { 
        
        UpdateFleetPortSettingsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateFleetPortSettingsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateFleetPortSettingsOutput} obj Optional instance to populate.
     * @return {module:model/UpdateFleetPortSettingsOutput} The populated <code>UpdateFleetPortSettingsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateFleetPortSettingsOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateFleetPortSettingsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateFleetPortSettingsOutput</code>.
     */
 ...
 */
UpdateFleetPortSettingsOutput.prototype['FleetId'] = undefined;

/**
 * @member {String} FleetArn
 */
UpdateFleetPortSettingsOutput.prototype['FleetArn'] = undefined;
...
export default UpdateFleetPortSettingsOutput;
