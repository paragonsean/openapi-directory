...
/**
 * The MatchmakingTicket model module.
 * @module model/MatchmakingTicket
 * @version 2015-10-01
 */
class MatchmakingTicket {
    /**
     * Constructs a new <code>MatchmakingTicket</code>.
     ...
     * @alias module:model/MatchmakingTicket
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>MatchmakingTicket</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MatchmakingTicket} obj Optional instance to populate.
     * @return {module:model/MatchmakingTicket} The populated <code>MatchmakingTicket</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MatchmakingTicket();
    ...
    /**
     * Validates the JSON data with respect to <code>MatchmakingTicket</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MatchmakingTicket</code>.
     */
...
export default MatchmakingTicket;
