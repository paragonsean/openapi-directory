...
import ScalingStatusType from './ScalingStatusType';

/**
 * The DescribeScalingPoliciesInput model module.
 * @module model/DescribeScalingPoliciesInput
 * @version 2015-10-01
 */
class DescribeScalingPoliciesInput {
    /**
     * Constructs a new <code>DescribeScalingPoliciesInput</code>.
     * @alias module:model/DescribeScalingPoliciesInput
     * @param fleetId {String} 
     */
    constructor(fleetId) { 
        
        DescribeScalingPoliciesInput.initialize(this, fleetId);
    }
    ...
    /**
     * Constructs a <code>DescribeScalingPoliciesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeScalingPoliciesInput} obj Optional instance to populate.
     * @return {module:model/DescribeScalingPoliciesInput} The populated <code>DescribeScalingPoliciesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeScalingPoliciesInput();

            if (data.hasOwnProperty('FleetId')) {
                obj['FleetId'] = ApiClient.convertToType(data['FleetId'], 'String');
            }
            if (data.hasOwnProperty('StatusFilter')) {
                obj['StatusFilter'] = ApiClient.convertToType(data['StatusFilter'], ScalingStatusType);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeScalingPoliciesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeScalingPoliciesInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeScalingPoliciesInput.RequiredProperties) {
        ...
        if (data['StatusFilter']) { // data not null
          ScalingStatusType.validateJSON(data['StatusFilter']);
        }
...
DescribeScalingPoliciesInput.RequiredProperties = ["FleetId"];

/**
 * @member {String} FleetId
 */
DescribeScalingPoliciesInput.prototype['FleetId'] = undefined;

/**
 * @member {module:model/ScalingStatusType} StatusFilter
 */
DescribeScalingPoliciesInput.prototype['StatusFilter'] = undefined;

/**
 * @member {Number} Limit
 */
DescribeScalingPoliciesInput.prototype['Limit'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeScalingPoliciesInput.prototype['NextToken'] = undefined;

/**
 * @member {String} Location
 */
DescribeScalingPoliciesInput.prototype['Location'] = undefined;
...
export default DescribeScalingPoliciesInput;
