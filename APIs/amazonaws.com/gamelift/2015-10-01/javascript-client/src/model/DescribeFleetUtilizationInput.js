...
/**
 * The DescribeFleetUtilizationInput model module.
 * @module model/DescribeFleetUtilizationInput
 * @version 2015-10-01
 */
class DescribeFleetUtilizationInput {
    /**
     * Constructs a new <code>DescribeFleetUtilizationInput</code>.
     * @alias module:model/DescribeFleetUtilizationInput
     */
    constructor() { 
        
        DescribeFleetUtilizationInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeFleetUtilizationInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeFleetUtilizationInput} obj Optional instance to populate.
     * @return {module:model/DescribeFleetUtilizationInput} The populated <code>DescribeFleetUtilizationInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeFleetUtilizationInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeFleetUtilizationInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeFleetUtilizationInput</code>.
     */
 ...
 */
DescribeFleetUtilizationInput.prototype['FleetIds'] = undefined;

/**
 * @member {Number} Limit
 */
DescribeFleetUtilizationInput.prototype['Limit'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeFleetUtilizationInput.prototype['NextToken'] = undefined;
...
export default DescribeFleetUtilizationInput;
