...
/**
 * The PlayerLatencyPolicy model module.
 * @module model/PlayerLatencyPolicy
 * @version 2015-10-01
 */
class PlayerLatencyPolicy {
    /**
     * Constructs a new <code>PlayerLatencyPolicy</code>.
     * Sets a latency cap for individual players when placing a game session. With a latency policy in force, a game session cannot be placed in a fleet location where a player reports latency higher than the cap. Latency policies are used only with placement request that provide player latency information. Player latency policies can be stacked to gradually relax latency requirements over time. 
     * @alias module:model/PlayerLatencyPolicy
     */
    constructor() { 
        
        PlayerLatencyPolicy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PlayerLatencyPolicy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PlayerLatencyPolicy} obj Optional instance to populate.
     * @return {module:model/PlayerLatencyPolicy} The populated <code>PlayerLatencyPolicy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PlayerLatencyPolicy();

            if (data.hasOwnProperty('MaximumIndividualPlayerLatencyMilliseconds')) {
                obj['MaximumIndividualPlayerLatencyMilliseconds'] = ApiClient.convertToType(data['MaximumIndividualPlayerLatencyMilliseconds'], 'Number');
            }
            if (data.hasOwnProperty('PolicyDurationSeconds')) {
                obj['PolicyDurationSeconds'] = ApiClient.convertToType(data['PolicyDurationSeconds'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PlayerLatencyPolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PlayerLatencyPolicy</code>.
     */
    static validateJSON(data) {
        // validate the optional field `MaximumIndividualPlayerLatencyMilliseconds`
        if (data['MaximumIndividualPlayerLatencyMilliseconds']) { // data not null
          Number.validateJSON(data['MaximumIndividualPlayerLatencyMilliseconds']);
        }
        // validate the optional field `PolicyDurationSeconds`
        if (data['PolicyDurationSeconds']) { // data not null
          Number.validateJSON(data['PolicyDurationSeconds']);
        }
...
/**
 * @member {Number} MaximumIndividualPlayerLatencyMilliseconds
 */
PlayerLatencyPolicy.prototype['MaximumIndividualPlayerLatencyMilliseconds'] = undefined;

/**
 * @member {Number} PolicyDurationSeconds
 */
PlayerLatencyPolicy.prototype['PolicyDurationSeconds'] = undefined;
...
export default PlayerLatencyPolicy;
