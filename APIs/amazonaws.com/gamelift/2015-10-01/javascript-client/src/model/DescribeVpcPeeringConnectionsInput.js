...
/**
 * The DescribeVpcPeeringConnectionsInput model module.
 * @module model/DescribeVpcPeeringConnectionsInput
 * @version 2015-10-01
 */
class DescribeVpcPeeringConnectionsInput {
    /**
     * Constructs a new <code>DescribeVpcPeeringConnectionsInput</code>.
     * @alias module:model/DescribeVpcPeeringConnectionsInput
     */
    constructor() { 
        
        DescribeVpcPeeringConnectionsInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeVpcPeeringConnectionsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeVpcPeeringConnectionsInput} obj Optional instance to populate.
     * @return {module:model/DescribeVpcPeeringConnectionsInput} The populated <code>DescribeVpcPeeringConnectionsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeVpcPeeringConnectionsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeVpcPeeringConnectionsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeVpcPeeringConnectionsInput</code>.
     */
 ...
 */
DescribeVpcPeeringConnectionsInput.prototype['FleetId'] = undefined;
...
export default DescribeVpcPeeringConnectionsInput;
