...
/**
 * The CreateGameServerGroupInputLaunchTemplate model module.
 * @module model/CreateGameServerGroupInputLaunchTemplate
 * @version 2015-10-01
 */
class CreateGameServerGroupInputLaunchTemplate {
    /**
     * Constructs a new <code>CreateGameServerGroupInputLaunchTemplate</code>.
     * @alias module:model/CreateGameServerGroupInputLaunchTemplate
     * @implements module:model/LaunchTemplateSpecification
     */
    constructor() { 
        LaunchTemplateSpecification.initialize(this);
        CreateGameServerGroupInputLaunchTemplate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateGameServerGroupInputLaunchTemplate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateGameServerGroupInputLaunchTemplate} obj Optional instance to populate.
     * @return {module:model/CreateGameServerGroupInputLaunchTemplate} The populated <code>CreateGameServerGroupInputLaunchTemplate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateGameServerGroupInputLaunchTemplate();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateGameServerGroupInputLaunchTemplate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateGameServerGroupInputLaunchTemplate</code>.
     */
 ...
 */
CreateGameServerGroupInputLaunchTemplate.prototype['LaunchTemplateId'] = undefined;

/**
 * @member {String} LaunchTemplateName
 */
CreateGameServerGroupInputLaunchTemplate.prototype['LaunchTemplateName'] = undefined;

/**
 * @member {String} Version
 */
CreateGameServerGroupInputLaunchTemplate.prototype['Version'] = undefined;
...
export default CreateGameServerGroupInputLaunchTemplate;
