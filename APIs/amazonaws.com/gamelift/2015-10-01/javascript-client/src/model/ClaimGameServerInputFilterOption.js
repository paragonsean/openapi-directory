...
import ClaimFilterOption from './ClaimFilterOption';

/**
 * The ClaimGameServerInputFilterOption model module.
 * @module model/ClaimGameServerInputFilterOption
 * @version 2015-10-01
 */
class ClaimGameServerInputFilterOption {
    /**
     * Constructs a new <code>ClaimGameServerInputFilterOption</code>.
     * @alias module:model/ClaimGameServerInputFilterOption
     * @implements module:model/ClaimFilterOption
     */
    constructor() { 
        ClaimFilterOption.initialize(this);
        ClaimGameServerInputFilterOption.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ClaimGameServerInputFilterOption</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ClaimGameServerInputFilterOption} obj Optional instance to populate.
     * @return {module:model/ClaimGameServerInputFilterOption} The populated <code>ClaimGameServerInputFilterOption</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClaimGameServerInputFilterOption();
            ClaimFilterOption.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ClaimGameServerInputFilterOption</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClaimGameServerInputFilterOption</code>.
     */
 ...
 */
ClaimGameServerInputFilterOption.prototype['InstanceStatuses'] = undefined;


// Implement ClaimFilterOption interface:
/**
 * @member {Array} InstanceStatuses
 */
...
export default ClaimGameServerInputFilterOption;
