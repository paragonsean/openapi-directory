...
/**
 * The DescribeInstancesInput model module.
 * @module model/DescribeInstancesInput
 * @version 2015-10-01
 */
class DescribeInstancesInput {
    /**
     * Constructs a new <code>DescribeInstancesInput</code>.
     * @alias module:model/DescribeInstancesInput
     * @param fleetId {String} 
     */
    constructor(fleetId) { 
        
        DescribeInstancesInput.initialize(this, fleetId);
    }
    ...
    /**
     * Constructs a <code>DescribeInstancesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeInstancesInput} obj Optional instance to populate.
     * @return {module:model/DescribeInstancesInput} The populated <code>DescribeInstancesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeInstancesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeInstancesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeInstancesInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeInstancesInput.RequiredProperties) {
...
DescribeInstancesInput.RequiredProperties = ["FleetId"];

/**
 * @member {String} FleetId
 */
DescribeInstancesInput.prototype['FleetId'] = undefined;

/**
 * @member {String} InstanceId
 */
DescribeInstancesInput.prototype['InstanceId'] = undefined;

/**
 * @member {Number} Limit
 */
DescribeInstancesInput.prototype['Limit'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeInstancesInput.prototype['NextToken'] = undefined;

/**
 * @member {String} Location
 */
DescribeInstancesInput.prototype['Location'] = undefined;
...
export default DescribeInstancesInput;
