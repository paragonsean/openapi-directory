...
class Player {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('PlayerAttributes')) {
                obj['PlayerAttributes'] = ApiClient.convertToType(data['PlayerAttributes'], Object);
            }
            if (data.hasOwnProperty('Team')) {
                obj['Team'] = ApiClient.convertToType(data['Team'], 'String');
            }
            if (data.hasOwnProperty('LatencyInMs')) {
                obj['LatencyInMs'] = ApiClient.convertToType(data['LatencyInMs'], Object);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['PlayerAttributes']) { // data not null
          Object.validateJSON(data['PlayerAttributes']);
        }
        // validate the optional field `Team`
        if (data['Team']) { // data not null
          String.validateJSON(data['Team']);
        }
        // validate the optional field `LatencyInMs`
        if (data['LatencyInMs']) { // data not null
          Object.validateJSON(data['LatencyInMs']);
        }
...
/**
 * @member {Object} PlayerAttributes
 */
Player.prototype['PlayerAttributes'] = undefined;
...
/**
 * @member {Object} LatencyInMs
 */
Player.prototype['LatencyInMs'] = undefined;
