...
/**
 * The LocationAttributesLocationState model module.
 * @module model/LocationAttributesLocationState
 * @version 2015-10-01
 */
class LocationAttributesLocationState {
    /**
     * Constructs a new <code>LocationAttributesLocationState</code>.
     * @alias module:model/LocationAttributesLocationState
     * @implements module:model/LocationState
     */
    constructor() { 
        LocationState.initialize(this);
        LocationAttributesLocationState.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LocationAttributesLocationState</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LocationAttributesLocationState} obj Optional instance to populate.
     * @return {module:model/LocationAttributesLocationState} The populated <code>LocationAttributesLocationState</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LocationAttributesLocationState();
            LocationState.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>LocationAttributesLocationState</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LocationAttributesLocationState</code>.
     */
 ...
 */
LocationAttributesLocationState.prototype['Location'] = undefined;

/**
 * @member {module:model/FleetStatus} Status
 */
LocationAttributesLocationState.prototype['Status'] = undefined;


// Implement LocationState interface:
/**
 * @member {String} Location
 */
...
export default LocationAttributesLocationState;
