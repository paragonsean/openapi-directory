...
/**
 * The ClaimFilterOption model module.
 * @module model/ClaimFilterOption
 * @version 2015-10-01
 */
class ClaimFilterOption {
    /**
     * Constructs a new <code>ClaimFilterOption</code>.
     ...
     * @alias module:model/ClaimFilterOption
     */
    constructor() { 
        
        ClaimFilterOption.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ClaimFilterOption</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ClaimFilterOption} obj Optional instance to populate.
     * @return {module:model/ClaimFilterOption} The populated <code>ClaimFilterOption</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClaimFilterOption();

            if (data.hasOwnProperty('InstanceStatuses')) {
                obj['InstanceStatuses'] = ApiClient.convertToType(data['InstanceStatuses'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ClaimFilterOption</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClaimFilterOption</code>.
     */
    static validateJSON(data) {
        // validate the optional field `InstanceStatuses`
        if (data['InstanceStatuses']) { // data not null
          Array.validateJSON(data['InstanceStatuses']);
        }
...
/**
 * @member {Array} InstanceStatuses
 */
ClaimFilterOption.prototype['InstanceStatuses'] = undefined;
...
export default ClaimFilterOption;
