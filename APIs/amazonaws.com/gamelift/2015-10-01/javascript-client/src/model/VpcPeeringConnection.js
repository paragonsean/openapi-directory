...
class VpcPeeringConnection {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Status')) {
                obj['Status'] = VpcPeeringConnectionStatus.constructFromObject(data['Status']);
            }
            if (data.hasOwnProperty('PeerVpcId')) {
                obj['PeerVpcId'] = ApiClient.convertToType(data['PeerVpcId'], 'String');
            }
            if (data.hasOwnProperty('GameLiftVpcId')) {
                obj['GameLiftVpcId'] = ApiClient.convertToType(data['GameLiftVpcId'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>VpcPeeringConnection</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VpcPeeringConnection</code>.
     */
    static validateJSON(data) {
        ...
        if (data['IpV4CidrBlock']) { // data not null
          String.validateJSON(data['IpV4CidrBlock']);
        }
        ...
        if (data['Status']) { // data not null
          VpcPeeringConnectionStatus.validateJSON(data['Status']);
        }
        ...
        if (data['GameLiftVpcId']) { // data not null
          String.validateJSON(data['GameLiftVpcId']);
        }
 ...
 */
VpcPeeringConnection.prototype['FleetId'] = undefined;

/**
 * @member {String} FleetArn
 */
VpcPeeringConnection.prototype['FleetArn'] = undefined;

/**
 * @member {String} IpV4CidrBlock
 */
VpcPeeringConnection.prototype['IpV4CidrBlock'] = undefined;
...
/**
 * @member {module:model/VpcPeeringConnectionStatus} Status
 */
 ...
 */
VpcPeeringConnection.prototype['PeerVpcId'] = undefined;

/**
 * @member {String} GameLiftVpcId
 */
VpcPeeringConnection.prototype['GameLiftVpcId'] = undefined;
