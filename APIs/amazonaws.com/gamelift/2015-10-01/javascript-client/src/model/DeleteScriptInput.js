...
/**
 * The DeleteScriptInput model module.
 * @module model/DeleteScriptInput
 * @version 2015-10-01
 */
class DeleteScriptInput {
    /**
     * Constructs a new <code>DeleteScriptInput</code>.
     * @alias module:model/DeleteScriptInput
     * @param scriptId {String} 
     */
    constructor(scriptId) { 
        
        DeleteScriptInput.initialize(this, scriptId);
    }
    ...
    /**
     * Constructs a <code>DeleteScriptInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteScriptInput} obj Optional instance to populate.
     * @return {module:model/DeleteScriptInput} The populated <code>DeleteScriptInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteScriptInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteScriptInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteScriptInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteScriptInput.RequiredProperties) {
...
DeleteScriptInput.RequiredProperties = ["ScriptId"];

/**
 * @member {String} ScriptId
 */
DeleteScriptInput.prototype['ScriptId'] = undefined;
...
export default DeleteScriptInput;
