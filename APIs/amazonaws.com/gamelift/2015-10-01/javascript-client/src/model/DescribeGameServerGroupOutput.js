...
import DescribeGameServerGroupOutputGameServerGroup from './DescribeGameServerGroupOutputGameServerGroup';

/**
 * The DescribeGameServerGroupOutput model module.
 * @module model/DescribeGameServerGroupOutput
 * @version 2015-10-01
 */
class DescribeGameServerGroupOutput {
    /**
     * Constructs a new <code>DescribeGameServerGroupOutput</code>.
     * @alias module:model/DescribeGameServerGroupOutput
     */
    constructor() { 
        
        DescribeGameServerGroupOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeGameServerGroupOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeGameServerGroupOutput} obj Optional instance to populate.
     * @return {module:model/DescribeGameServerGroupOutput} The populated <code>DescribeGameServerGroupOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeGameServerGroupOutput();

            if (data.hasOwnProperty('GameServerGroup')) {
                obj['GameServerGroup'] = DescribeGameServerGroupOutputGameServerGroup.constructFromObject(data['GameServerGroup']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeGameServerGroupOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeGameServerGroupOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GameServerGroup`
        if (data['GameServerGroup']) { // data not null
          DescribeGameServerGroupOutputGameServerGroup.validateJSON(data['GameServerGroup']);
        }
...
/**
 * @member {module:model/DescribeGameServerGroupOutputGameServerGroup} GameServerGroup
 */
DescribeGameServerGroupOutput.prototype['GameServerGroup'] = undefined;
...
export default DescribeGameServerGroupOutput;
