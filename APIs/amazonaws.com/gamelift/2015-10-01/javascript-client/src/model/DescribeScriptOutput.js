...
import DescribeScriptOutputScript from './DescribeScriptOutputScript';

/**
 * The DescribeScriptOutput model module.
 * @module model/DescribeScriptOutput
 * @version 2015-10-01
 */
class DescribeScriptOutput {
    /**
     * Constructs a new <code>DescribeScriptOutput</code>.
     * @alias module:model/DescribeScriptOutput
     */
    constructor() { 
        
        DescribeScriptOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeScriptOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeScriptOutput} obj Optional instance to populate.
     * @return {module:model/DescribeScriptOutput} The populated <code>DescribeScriptOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeScriptOutput();

            if (data.hasOwnProperty('Script')) {
                obj['Script'] = DescribeScriptOutputScript.constructFromObject(data['Script']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeScriptOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeScriptOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Script`
        if (data['Script']) { // data not null
          DescribeScriptOutputScript.validateJSON(data['Script']);
        }
...
/**
 * @member {module:model/DescribeScriptOutputScript} Script
 */
DescribeScriptOutput.prototype['Script'] = undefined;
...
export default DescribeScriptOutput;
