...
* @readonly
*/
export default class ComparisonOperatorType {
    ...
    /**
    * Returns a <code>ComparisonOperatorType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ComparisonOperatorType} The enum <code>ComparisonOperatorType</code> value.
    */
