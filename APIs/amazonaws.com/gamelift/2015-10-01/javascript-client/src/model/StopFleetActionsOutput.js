...
/**
 * The StopFleetActionsOutput model module.
 * @module model/StopFleetActionsOutput
 * @version 2015-10-01
 */
class StopFleetActionsOutput {
    /**
     * Constructs a new <code>StopFleetActionsOutput</code>.
     * @alias module:model/StopFleetActionsOutput
     */
    constructor() { 
        
        StopFleetActionsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StopFleetActionsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StopFleetActionsOutput} obj Optional instance to populate.
     * @return {module:model/StopFleetActionsOutput} The populated <code>StopFleetActionsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StopFleetActionsOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>StopFleetActionsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StopFleetActionsOutput</code>.
     */
 ...
 */
StopFleetActionsOutput.prototype['FleetId'] = undefined;

/**
 * @member {String} FleetArn
 */
StopFleetActionsOutput.prototype['FleetArn'] = undefined;
...
export default StopFleetActionsOutput;
