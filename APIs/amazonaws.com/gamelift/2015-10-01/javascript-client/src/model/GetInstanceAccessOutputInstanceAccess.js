...
/**
 * The GetInstanceAccessOutputInstanceAccess model module.
 * @module model/GetInstanceAccessOutputInstanceAccess
 * @version 2015-10-01
 */
class GetInstanceAccessOutputInstanceAccess {
    /**
     * Constructs a new <code>GetInstanceAccessOutputInstanceAccess</code>.
     * @alias module:model/GetInstanceAccessOutputInstanceAccess
     * @implements module:model/InstanceAccess
     */
    constructor() { 
        InstanceAccess.initialize(this);
        GetInstanceAccessOutputInstanceAccess.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetInstanceAccessOutputInstanceAccess</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetInstanceAccessOutputInstanceAccess} obj Optional instance to populate.
     * @return {module:model/GetInstanceAccessOutputInstanceAccess} The populated <code>GetInstanceAccessOutputInstanceAccess</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetInstanceAccessOutputInstanceAccess();
            InstanceAccess.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>GetInstanceAccessOutputInstanceAccess</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetInstanceAccessOutputInstanceAccess</code>.
     */
 ...
 */
GetInstanceAccessOutputInstanceAccess.prototype['FleetId'] = undefined;

/**
 * @member {String} InstanceId
 */
GetInstanceAccessOutputInstanceAccess.prototype['InstanceId'] = undefined;

/**
 * @member {String} IpAddress
 */
GetInstanceAccessOutputInstanceAccess.prototype['IpAddress'] = undefined;

/**
 * @member {module:model/OperatingSystem} OperatingSystem
 */
GetInstanceAccessOutputInstanceAccess.prototype['OperatingSystem'] = undefined;

/**
 * @member {module:model/InstanceAccessCredentials} Credentials
 */
GetInstanceAccessOutputInstanceAccess.prototype['Credentials'] = undefined;


// Implement InstanceAccess interface:
/**
 * @member {String} FleetId
 */
...
export default GetInstanceAccessOutputInstanceAccess;
