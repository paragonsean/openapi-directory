...
import SuspendGameServerGroupOutputGameServerGroup from './SuspendGameServerGroupOutputGameServerGroup';

/**
 * The SuspendGameServerGroupOutput model module.
 * @module model/SuspendGameServerGroupOutput
 * @version 2015-10-01
 */
class SuspendGameServerGroupOutput {
    /**
     * Constructs a new <code>SuspendGameServerGroupOutput</code>.
     * @alias module:model/SuspendGameServerGroupOutput
     */
    constructor() { 
        
        SuspendGameServerGroupOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SuspendGameServerGroupOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SuspendGameServerGroupOutput} obj Optional instance to populate.
     * @return {module:model/SuspendGameServerGroupOutput} The populated <code>SuspendGameServerGroupOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SuspendGameServerGroupOutput();

            if (data.hasOwnProperty('GameServerGroup')) {
                obj['GameServerGroup'] = SuspendGameServerGroupOutputGameServerGroup.constructFromObject(data['GameServerGroup']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SuspendGameServerGroupOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SuspendGameServerGroupOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GameServerGroup`
        if (data['GameServerGroup']) { // data not null
          SuspendGameServerGroupOutputGameServerGroup.validateJSON(data['GameServerGroup']);
        }
...
/**
 * @member {module:model/SuspendGameServerGroupOutputGameServerGroup} GameServerGroup
 */
SuspendGameServerGroupOutput.prototype['GameServerGroup'] = undefined;
...
export default SuspendGameServerGroupOutput;
