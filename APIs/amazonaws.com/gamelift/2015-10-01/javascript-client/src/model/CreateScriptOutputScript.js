...
import CreateScriptInputStorageLocation from './CreateScriptInputStorageLocation';
import Script from './Script';

/**
 * The CreateScriptOutputScript model module.
 * @module model/CreateScriptOutputScript
 * @version 2015-10-01
 */
class CreateScriptOutputScript {
    /**
     * Constructs a new <code>CreateScriptOutputScript</code>.
     * @alias module:model/CreateScriptOutputScript
     * @implements module:model/Script
     */
    constructor() { 
        Script.initialize(this);
        CreateScriptOutputScript.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateScriptOutputScript</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateScriptOutputScript} obj Optional instance to populate.
     * @return {module:model/CreateScriptOutputScript} The populated <code>CreateScriptOutputScript</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateScriptOutputScript();
            ...
            if (data.hasOwnProperty('StorageLocation')) {
                obj['StorageLocation'] = CreateScriptInputStorageLocation.constructFromObject(data['StorageLocation']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateScriptOutputScript</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateScriptOutputScript</code>.
     */
    static validateJSON(data) {
        ...
        if (data['SizeOnDisk']) { // data not null
          Number.validateJSON(data['SizeOnDisk']);
        }
        ...
        if (data['StorageLocation']) { // data not null
          CreateScriptInputStorageLocation.validateJSON(data['StorageLocation']);
        }
 ...
 */
CreateScriptOutputScript.prototype['ScriptId'] = undefined;

/**
 * @member {String} ScriptArn
 */
CreateScriptOutputScript.prototype['ScriptArn'] = undefined;

/**
 * @member {String} Name
 */
CreateScriptOutputScript.prototype['Name'] = undefined;

/**
 * @member {String} Version
 */
CreateScriptOutputScript.prototype['Version'] = undefined;

/**
 * @member {Number} SizeOnDisk
 */
CreateScriptOutputScript.prototype['SizeOnDisk'] = undefined;

/**
 * @member {Date} CreationTime
 */
CreateScriptOutputScript.prototype['CreationTime'] = undefined;

/**
 * @member {module:model/CreateScriptInputStorageLocation} StorageLocation
 */
CreateScriptOutputScript.prototype['StorageLocation'] = undefined;


// Implement Script interface:
/**
 * @member {String} ScriptId
 */
Script.prototype['ScriptId'] = undefined;
/**
 * @member {String} ScriptArn
 */
Script.prototype['ScriptArn'] = undefined;
/**
 * @member {String} Name
 */
 ...
 * @member {String} Version
 */
Script.prototype['Version'] = undefined;
/**
 * @member {Number} SizeOnDisk
 */
Script.prototype['SizeOnDisk'] = undefined;
/**
 * @member {Date} CreationTime
 */
Script.prototype['CreationTime'] = undefined;
/**
 * @member {module:model/CreateScriptInputStorageLocation} StorageLocation
 */
Script.prototype['StorageLocation'] = undefined;




export default CreateScriptOutputScript;
