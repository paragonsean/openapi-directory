...
* @readonly
*/
export default class GameServerGroupStatus {
    ...
    /**
    * Returns a <code>GameServerGroupStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/GameServerGroupStatus} The enum <code>GameServerGroupStatus</code> value.
    */
