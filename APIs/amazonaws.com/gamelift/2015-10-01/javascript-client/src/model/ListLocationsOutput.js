...
/**
 * The ListLocationsOutput model module.
 * @module model/ListLocationsOutput
 * @version 2015-10-01
 */
class ListLocationsOutput {
    /**
     * Constructs a new <code>ListLocationsOutput</code>.
     * @alias module:model/ListLocationsOutput
     */
    constructor() { 
        
        ListLocationsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListLocationsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListLocationsOutput} obj Optional instance to populate.
     * @return {module:model/ListLocationsOutput} The populated <code>ListLocationsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListLocationsOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListLocationsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListLocationsOutput</code>.
     */
 ...
 */
ListLocationsOutput.prototype['Locations'] = undefined;

/**
 * @member {String} NextToken
 */
ListLocationsOutput.prototype['NextToken'] = undefined;
...
export default ListLocationsOutput;
