...
* @readonly
*/
export default class IpProtocol {
    ...
    /**
    * Returns a <code>IpProtocol</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/IpProtocol} The enum <code>IpProtocol</code> value.
    */
