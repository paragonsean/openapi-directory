...
/**
 * The DescribeGameSessionDetailsOutput model module.
 * @module model/DescribeGameSessionDetailsOutput
 * @version 2015-10-01
 */
class DescribeGameSessionDetailsOutput {
    /**
     * Constructs a new <code>DescribeGameSessionDetailsOutput</code>.
     * @alias module:model/DescribeGameSessionDetailsOutput
     */
    constructor() { 
        
        DescribeGameSessionDetailsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeGameSessionDetailsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeGameSessionDetailsOutput} obj Optional instance to populate.
     * @return {module:model/DescribeGameSessionDetailsOutput} The populated <code>DescribeGameSessionDetailsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeGameSessionDetailsOutput();

            if (data.hasOwnProperty('GameSessionDetails')) {
                obj['GameSessionDetails'] = ApiClient.convertToType(data['GameSessionDetails'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeGameSessionDetailsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeGameSessionDetailsOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GameSessionDetails`
        if (data['GameSessionDetails']) { // data not null
          Array.validateJSON(data['GameSessionDetails']);
        }
...
/**
 * @member {Array} GameSessionDetails
 */
DescribeGameSessionDetailsOutput.prototype['GameSessionDetails'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeGameSessionDetailsOutput.prototype['NextToken'] = undefined;
...
export default DescribeGameSessionDetailsOutput;
