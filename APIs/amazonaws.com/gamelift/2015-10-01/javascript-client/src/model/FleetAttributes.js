...
/**
 * The FleetAttributes model module.
 * @module model/FleetAttributes
 * @version 2015-10-01
 */
class FleetAttributes {
    /**
     * Constructs a new <code>FleetAttributes</code>.
     * &lt;p&gt;Describes a Amazon GameLift fleet of game hosting resources.&lt;/p&gt; &lt;p&gt; &lt;b&gt;Related actions&lt;/b&gt; &lt;/p&gt;
     * @alias module:model/FleetAttributes
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>FleetAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FleetAttributes} obj Optional instance to populate.
     * @return {module:model/FleetAttributes} The populated <code>FleetAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FleetAttributes();
    ...
    /**
     * Validates the JSON data with respect to <code>FleetAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FleetAttributes</code>.
     */
