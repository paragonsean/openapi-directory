...
/**
 * The DescribePlayerSessionsOutput model module.
 * @module model/DescribePlayerSessionsOutput
 * @version 2015-10-01
 */
class DescribePlayerSessionsOutput {
    /**
     * Constructs a new <code>DescribePlayerSessionsOutput</code>.
     * @alias module:model/DescribePlayerSessionsOutput
     */
    constructor() { 
        
        DescribePlayerSessionsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribePlayerSessionsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribePlayerSessionsOutput} obj Optional instance to populate.
     * @return {module:model/DescribePlayerSessionsOutput} The populated <code>DescribePlayerSessionsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribePlayerSessionsOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribePlayerSessionsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribePlayerSessionsOutput</code>.
     */
 ...
 */
DescribePlayerSessionsOutput.prototype['PlayerSessions'] = undefined;

/**
 * @member {String} NextToken
 */
DescribePlayerSessionsOutput.prototype['NextToken'] = undefined;
...
export default DescribePlayerSessionsOutput;
