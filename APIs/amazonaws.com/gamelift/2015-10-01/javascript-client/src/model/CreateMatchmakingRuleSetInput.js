...
/**
 * The CreateMatchmakingRuleSetInput model module.
 * @module model/CreateMatchmakingRuleSetInput
 * @version 2015-10-01
 */
class CreateMatchmakingRuleSetInput {
    /**
     * Constructs a new <code>CreateMatchmakingRuleSetInput</code>.
     * @alias module:model/CreateMatchmakingRuleSetInput
     * @param name {String} 
     * @param ruleSetBody {String} 
     */
    constructor(name, ruleSetBody) { 
        
        CreateMatchmakingRuleSetInput.initialize(this, name, ruleSetBody);
    }
     ...
     */
    static initialize(obj, name, ruleSetBody) { 
        obj['Name'] = name;
        obj['RuleSetBody'] = ruleSetBody;
    }

    /**
     * Constructs a <code>CreateMatchmakingRuleSetInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateMatchmakingRuleSetInput} obj Optional instance to populate.
     * @return {module:model/CreateMatchmakingRuleSetInput} The populated <code>CreateMatchmakingRuleSetInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateMatchmakingRuleSetInput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateMatchmakingRuleSetInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateMatchmakingRuleSetInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateMatchmakingRuleSetInput.RequiredProperties) {
...
CreateMatchmakingRuleSetInput.RequiredProperties = ["Name", "RuleSetBody"];

/**
 * @member {String} Name
 */
CreateMatchmakingRuleSetInput.prototype['Name'] = undefined;

/**
 * @member {String} RuleSetBody
 */
CreateMatchmakingRuleSetInput.prototype['RuleSetBody'] = undefined;

/**
 * @member {Array} Tags
 */
CreateMatchmakingRuleSetInput.prototype['Tags'] = undefined;
...
export default CreateMatchmakingRuleSetInput;
