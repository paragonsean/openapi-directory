...
import CreateGameServerGroupOutputGameServerGroup from './CreateGameServerGroupOutputGameServerGroup';

/**
 * The CreateGameServerGroupOutput model module.
 * @module model/CreateGameServerGroupOutput
 * @version 2015-10-01
 */
class CreateGameServerGroupOutput {
    /**
     * Constructs a new <code>CreateGameServerGroupOutput</code>.
     * @alias module:model/CreateGameServerGroupOutput
     */
    constructor() { 
        
        CreateGameServerGroupOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateGameServerGroupOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateGameServerGroupOutput} obj Optional instance to populate.
     * @return {module:model/CreateGameServerGroupOutput} The populated <code>CreateGameServerGroupOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateGameServerGroupOutput();

            if (data.hasOwnProperty('GameServerGroup')) {
                obj['GameServerGroup'] = CreateGameServerGroupOutputGameServerGroup.constructFromObject(data['GameServerGroup']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateGameServerGroupOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateGameServerGroupOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GameServerGroup`
        if (data['GameServerGroup']) { // data not null
          CreateGameServerGroupOutputGameServerGroup.validateJSON(data['GameServerGroup']);
        }
...
/**
 * @member {module:model/CreateGameServerGroupOutputGameServerGroup} GameServerGroup
 */
CreateGameServerGroupOutput.prototype['GameServerGroup'] = undefined;
...
export default CreateGameServerGroupOutput;
