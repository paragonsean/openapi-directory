...
/**
 * The ListLocationsInput model module.
 * @module model/ListLocationsInput
 * @version 2015-10-01
 */
class ListLocationsInput {
    /**
     * Constructs a new <code>ListLocationsInput</code>.
     * @alias module:model/ListLocationsInput
     */
    constructor() { 
        
        ListLocationsInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListLocationsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListLocationsInput} obj Optional instance to populate.
     * @return {module:model/ListLocationsInput} The populated <code>ListLocationsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListLocationsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListLocationsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListLocationsInput</code>.
     */
 ...
 */
ListLocationsInput.prototype['Filters'] = undefined;

/**
 * @member {Number} Limit
 */
ListLocationsInput.prototype['Limit'] = undefined;

/**
 * @member {String} NextToken
 */
ListLocationsInput.prototype['NextToken'] = undefined;
...
export default ListLocationsInput;
