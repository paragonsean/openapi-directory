...
/**
 * The DescribeFleetLocationCapacityInput model module.
 * @module model/DescribeFleetLocationCapacityInput
 * @version 2015-10-01
 */
class DescribeFleetLocationCapacityInput {
    /**
     * Constructs a new <code>DescribeFleetLocationCapacityInput</code>.
     * @alias module:model/DescribeFleetLocationCapacityInput
     * @param fleetId {String} 
     * @param location {String} 
     */
    constructor(fleetId, location) { 
        
        DescribeFleetLocationCapacityInput.initialize(this, fleetId, location);
    }
     ...
     */
    static initialize(obj, fleetId, location) { 
        obj['FleetId'] = fleetId;
        obj['Location'] = location;
    }

    /**
     * Constructs a <code>DescribeFleetLocationCapacityInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeFleetLocationCapacityInput} obj Optional instance to populate.
     * @return {module:model/DescribeFleetLocationCapacityInput} The populated <code>DescribeFleetLocationCapacityInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeFleetLocationCapacityInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeFleetLocationCapacityInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeFleetLocationCapacityInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeFleetLocationCapacityInput.RequiredProperties) {
...
DescribeFleetLocationCapacityInput.RequiredProperties = ["FleetId", "Location"];

/**
 * @member {String} FleetId
 */
DescribeFleetLocationCapacityInput.prototype['FleetId'] = undefined;

/**
 * @member {String} Location
 */
DescribeFleetLocationCapacityInput.prototype['Location'] = undefined;
...
export default DescribeFleetLocationCapacityInput;
