...
/**
 * The DeleteScalingPolicyInput model module.
 * @module model/DeleteScalingPolicyInput
 * @version 2015-10-01
 */
class DeleteScalingPolicyInput {
    /**
     * Constructs a new <code>DeleteScalingPolicyInput</code>.
     * @alias module:model/DeleteScalingPolicyInput
     * @param name {String} 
     * @param fleetId {String} 
     */
    constructor(name, fleetId) { 
        
        DeleteScalingPolicyInput.initialize(this, name, fleetId);
    }
     ...
     */
    static initialize(obj, name, fleetId) { 
        obj['Name'] = name;
        obj['FleetId'] = fleetId;
    }

    /**
     * Constructs a <code>DeleteScalingPolicyInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteScalingPolicyInput} obj Optional instance to populate.
     * @return {module:model/DeleteScalingPolicyInput} The populated <code>DeleteScalingPolicyInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteScalingPolicyInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteScalingPolicyInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteScalingPolicyInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteScalingPolicyInput.RequiredProperties) {
...
DeleteScalingPolicyInput.RequiredProperties = ["Name", "FleetId"];

/**
 * @member {String} Name
 */
DeleteScalingPolicyInput.prototype['Name'] = undefined;

/**
 * @member {String} FleetId
 */
DeleteScalingPolicyInput.prototype['FleetId'] = undefined;
...
export default DeleteScalingPolicyInput;
