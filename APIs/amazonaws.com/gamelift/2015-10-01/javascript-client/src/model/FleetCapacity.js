...
/**
 * The FleetCapacity model module.
 * @module model/FleetCapacity
 * @version 2015-10-01
 */
class FleetCapacity {
    /**
     * Constructs a new <code>FleetCapacity</code>.
     ...
     * @alias module:model/FleetCapacity
     */
    constructor() { 
        
        FleetCapacity.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FleetCapacity</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FleetCapacity} obj Optional instance to populate.
     * @return {module:model/FleetCapacity} The populated <code>FleetCapacity</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FleetCapacity();
            ...
            if (data.hasOwnProperty('InstanceCounts')) {
                obj['InstanceCounts'] = EC2InstanceCounts.constructFromObject(data['InstanceCounts']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>FleetCapacity</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FleetCapacity</code>.
     */
    static validateJSON(data) {
        ...
        if (data['InstanceCounts']) { // data not null
          EC2InstanceCounts.validateJSON(data['InstanceCounts']);
        }
 ...
 */
FleetCapacity.prototype['FleetId'] = undefined;

/**
 * @member {String} FleetArn
 */
FleetCapacity.prototype['FleetArn'] = undefined;

/**
 * @member {module:model/EC2InstanceType} InstanceType
 */
FleetCapacity.prototype['InstanceType'] = undefined;

/**
 * @member {module:model/EC2InstanceCounts} InstanceCounts
 */
FleetCapacity.prototype['InstanceCounts'] = undefined;

/**
 * @member {String} Location
 */
FleetCapacity.prototype['Location'] = undefined;
