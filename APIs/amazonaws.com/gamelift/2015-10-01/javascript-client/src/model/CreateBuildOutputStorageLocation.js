...
/**
 * The CreateBuildOutputStorageLocation model module.
 * @module model/CreateBuildOutputStorageLocation
 * @version 2015-10-01
 */
class CreateBuildOutputStorageLocation {
    /**
     * Constructs a new <code>CreateBuildOutputStorageLocation</code>.
     * @alias module:model/CreateBuildOutputStorageLocation
     * @implements module:model/S3Location
     */
    constructor() { 
        S3Location.initialize(this);
        CreateBuildOutputStorageLocation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateBuildOutputStorageLocation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateBuildOutputStorageLocation} obj Optional instance to populate.
     * @return {module:model/CreateBuildOutputStorageLocation} The populated <code>CreateBuildOutputStorageLocation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateBuildOutputStorageLocation();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateBuildOutputStorageLocation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateBuildOutputStorageLocation</code>.
     */
 ...
 */
CreateBuildOutputStorageLocation.prototype['Bucket'] = undefined;

/**
 * @member {String} Key
 */
CreateBuildOutputStorageLocation.prototype['Key'] = undefined;

/**
 * @member {String} RoleArn
 */
CreateBuildOutputStorageLocation.prototype['RoleArn'] = undefined;

/**
 * @member {String} ObjectVersion
 */
CreateBuildOutputStorageLocation.prototype['ObjectVersion'] = undefined;
...
export default CreateBuildOutputStorageLocation;
