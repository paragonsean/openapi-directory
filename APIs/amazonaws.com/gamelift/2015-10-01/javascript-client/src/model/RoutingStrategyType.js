...
* @readonly
*/
export default class RoutingStrategyType {
    ...
    /**
    * Returns a <code>RoutingStrategyType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/RoutingStrategyType} The enum <code>RoutingStrategyType</code> value.
    */
