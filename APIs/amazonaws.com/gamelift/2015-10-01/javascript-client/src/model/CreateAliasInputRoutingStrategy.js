...
/**
 * The CreateAliasInputRoutingStrategy model module.
 * @module model/CreateAliasInputRoutingStrategy
 * @version 2015-10-01
 */
class CreateAliasInputRoutingStrategy {
    /**
     * Constructs a new <code>CreateAliasInputRoutingStrategy</code>.
     * @alias module:model/CreateAliasInputRoutingStrategy
     * @implements module:model/RoutingStrategy
     */
    constructor() { 
        RoutingStrategy.initialize(this);
        CreateAliasInputRoutingStrategy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateAliasInputRoutingStrategy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateAliasInputRoutingStrategy} obj Optional instance to populate.
     * @return {module:model/CreateAliasInputRoutingStrategy} The populated <code>CreateAliasInputRoutingStrategy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateAliasInputRoutingStrategy();
            RoutingStrategy.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreateAliasInputRoutingStrategy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateAliasInputRoutingStrategy</code>.
     */
 ...
 */
CreateAliasInputRoutingStrategy.prototype['Type'] = undefined;

/**
 * @member {String} FleetId
 */
CreateAliasInputRoutingStrategy.prototype['FleetId'] = undefined;

/**
 * @member {String} Message
 */
CreateAliasInputRoutingStrategy.prototype['Message'] = undefined;


// Implement RoutingStrategy interface:
/**
 * @member {module:model/RoutingStrategyType} Type
 */
...
export default CreateAliasInputRoutingStrategy;
