...
import UpdateGameSessionOutputGameSession from './UpdateGameSessionOutputGameSession';

/**
 * The UpdateGameSessionOutput model module.
 * @module model/UpdateGameSessionOutput
 * @version 2015-10-01
 */
class UpdateGameSessionOutput {
    /**
     * Constructs a new <code>UpdateGameSessionOutput</code>.
     * @alias module:model/UpdateGameSessionOutput
     */
    constructor() { 
        
        UpdateGameSessionOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateGameSessionOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateGameSessionOutput} obj Optional instance to populate.
     * @return {module:model/UpdateGameSessionOutput} The populated <code>UpdateGameSessionOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateGameSessionOutput();

            if (data.hasOwnProperty('GameSession')) {
                obj['GameSession'] = UpdateGameSessionOutputGameSession.constructFromObject(data['GameSession']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateGameSessionOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateGameSessionOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GameSession`
        if (data['GameSession']) { // data not null
          UpdateGameSessionOutputGameSession.validateJSON(data['GameSession']);
        }
...
/**
 * @member {module:model/UpdateGameSessionOutputGameSession} GameSession
 */
UpdateGameSessionOutput.prototype['GameSession'] = undefined;
...
export default UpdateGameSessionOutput;
