...
/**
 * The UpdateFleetCapacityInput model module.
 * @module model/UpdateFleetCapacityInput
 * @version 2015-10-01
 */
class UpdateFleetCapacityInput {
    /**
     * Constructs a new <code>UpdateFleetCapacityInput</code>.
     * @alias module:model/UpdateFleetCapacityInput
     * @param fleetId {String} 
     */
    constructor(fleetId) { 
        
        UpdateFleetCapacityInput.initialize(this, fleetId);
    }
    ...
    /**
     * Constructs a <code>UpdateFleetCapacityInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateFleetCapacityInput} obj Optional instance to populate.
     * @return {module:model/UpdateFleetCapacityInput} The populated <code>UpdateFleetCapacityInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateFleetCapacityInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateFleetCapacityInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateFleetCapacityInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateFleetCapacityInput.RequiredProperties) {
...
UpdateFleetCapacityInput.RequiredProperties = ["FleetId"];

/**
 * @member {String} FleetId
 */
UpdateFleetCapacityInput.prototype['FleetId'] = undefined;

/**
 * @member {Number} DesiredInstances
 */
UpdateFleetCapacityInput.prototype['DesiredInstances'] = undefined;

/**
 * @member {Number} MinSize
 */
UpdateFleetCapacityInput.prototype['MinSize'] = undefined;

/**
 * @member {Number} MaxSize
 */
UpdateFleetCapacityInput.prototype['MaxSize'] = undefined;

/**
 * @member {String} Location
 */
UpdateFleetCapacityInput.prototype['Location'] = undefined;
...
export default UpdateFleetCapacityInput;
