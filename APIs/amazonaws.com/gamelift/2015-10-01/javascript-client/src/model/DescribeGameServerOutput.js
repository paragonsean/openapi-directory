...
import DescribeGameServerOutputGameServer from './DescribeGameServerOutputGameServer';

/**
 * The DescribeGameServerOutput model module.
 * @module model/DescribeGameServerOutput
 * @version 2015-10-01
 */
class DescribeGameServerOutput {
    /**
     * Constructs a new <code>DescribeGameServerOutput</code>.
     * @alias module:model/DescribeGameServerOutput
     */
    constructor() { 
        
        DescribeGameServerOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeGameServerOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeGameServerOutput} obj Optional instance to populate.
     * @return {module:model/DescribeGameServerOutput} The populated <code>DescribeGameServerOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeGameServerOutput();

            if (data.hasOwnProperty('GameServer')) {
                obj['GameServer'] = DescribeGameServerOutputGameServer.constructFromObject(data['GameServer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeGameServerOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeGameServerOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GameServer`
        if (data['GameServer']) { // data not null
          DescribeGameServerOutputGameServer.validateJSON(data['GameServer']);
        }
...
/**
 * @member {module:model/DescribeGameServerOutputGameServer} GameServer
 */
DescribeGameServerOutput.prototype['GameServer'] = undefined;
...
export default DescribeGameServerOutput;
