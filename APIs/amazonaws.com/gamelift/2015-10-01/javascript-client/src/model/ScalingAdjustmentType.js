...
* @readonly
*/
export default class ScalingAdjustmentType {
    ...
    /**
    * Returns a <code>ScalingAdjustmentType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ScalingAdjustmentType} The enum <code>ScalingAdjustmentType</code> value.
    */
