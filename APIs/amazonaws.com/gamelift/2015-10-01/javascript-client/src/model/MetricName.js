...
* @readonly
*/
export default class MetricName {
        ...
        /**
         * value: "PercentAvailableGameSessions"
         * @const
         */
        ...
        /**
         * value: "ConcurrentActivatableGameSessions"
         * @const
         */
    ...
    /**
    * Returns a <code>MetricName</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/MetricName} The enum <code>MetricName</code> value.
    */
