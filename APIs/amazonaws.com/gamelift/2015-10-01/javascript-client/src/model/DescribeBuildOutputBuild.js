...
/**
 * The DescribeBuildOutputBuild model module.
 * @module model/DescribeBuildOutputBuild
 * @version 2015-10-01
 */
class DescribeBuildOutputBuild {
    /**
     * Constructs a new <code>DescribeBuildOutputBuild</code>.
     * @alias module:model/DescribeBuildOutputBuild
     * @implements module:model/Build
     */
    constructor() { 
        Build.initialize(this);
        DescribeBuildOutputBuild.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeBuildOutputBuild</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeBuildOutputBuild} obj Optional instance to populate.
     * @return {module:model/DescribeBuildOutputBuild} The populated <code>DescribeBuildOutputBuild</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeBuildOutputBuild();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeBuildOutputBuild</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeBuildOutputBuild</code>.
     */
 ...
 */
DescribeBuildOutputBuild.prototype['BuildId'] = undefined;

/**
 * @member {String} BuildArn
 */
DescribeBuildOutputBuild.prototype['BuildArn'] = undefined;

/**
 * @member {String} Name
 */
DescribeBuildOutputBuild.prototype['Name'] = undefined;

/**
 * @member {String} Version
 */
DescribeBuildOutputBuild.prototype['Version'] = undefined;

/**
 * @member {module:model/BuildStatus} Status
 */
DescribeBuildOutputBuild.prototype['Status'] = undefined;

/**
 * @member {Number} SizeOnDisk
 */
DescribeBuildOutputBuild.prototype['SizeOnDisk'] = undefined;

/**
 * @member {module:model/OperatingSystem} OperatingSystem
 */
DescribeBuildOutputBuild.prototype['OperatingSystem'] = undefined;

/**
 * @member {Date} CreationTime
 */
DescribeBuildOutputBuild.prototype['CreationTime'] = undefined;

/**
 * @member {String} ServerSdkVersion
 */
DescribeBuildOutputBuild.prototype['ServerSdkVersion'] = undefined;
...
export default DescribeBuildOutputBuild;
