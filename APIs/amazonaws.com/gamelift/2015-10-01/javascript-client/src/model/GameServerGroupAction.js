...
* @readonly
*/
export default class GameServerGroupAction {
    
        /**
         * value: "REPLACE_INSTANCE_TYPES"
         * @const
         */
    ...
    /**
    * Returns a <code>GameServerGroupAction</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/GameServerGroupAction} The enum <code>GameServerGroupAction</code> value.
    */
