...
/**
 * The DescribeGameSessionsOutput model module.
 * @module model/DescribeGameSessionsOutput
 * @version 2015-10-01
 */
class DescribeGameSessionsOutput {
    /**
     * Constructs a new <code>DescribeGameSessionsOutput</code>.
     * @alias module:model/DescribeGameSessionsOutput
     */
    constructor() { 
        
        DescribeGameSessionsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeGameSessionsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeGameSessionsOutput} obj Optional instance to populate.
     * @return {module:model/DescribeGameSessionsOutput} The populated <code>DescribeGameSessionsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeGameSessionsOutput();

            if (data.hasOwnProperty('GameSessions')) {
                obj['GameSessions'] = ApiClient.convertToType(data['GameSessions'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeGameSessionsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeGameSessionsOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GameSessions`
        if (data['GameSessions']) { // data not null
          Array.validateJSON(data['GameSessions']);
        }
...
/**
 * @member {Array} GameSessions
 */
DescribeGameSessionsOutput.prototype['GameSessions'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeGameSessionsOutput.prototype['NextToken'] = undefined;
...
export default DescribeGameSessionsOutput;
