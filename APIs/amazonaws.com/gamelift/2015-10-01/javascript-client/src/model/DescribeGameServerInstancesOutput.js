...
/**
 * The DescribeGameServerInstancesOutput model module.
 * @module model/DescribeGameServerInstancesOutput
 * @version 2015-10-01
 */
class DescribeGameServerInstancesOutput {
    /**
     * Constructs a new <code>DescribeGameServerInstancesOutput</code>.
     * @alias module:model/DescribeGameServerInstancesOutput
     */
    constructor() { 
        
        DescribeGameServerInstancesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeGameServerInstancesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeGameServerInstancesOutput} obj Optional instance to populate.
     * @return {module:model/DescribeGameServerInstancesOutput} The populated <code>DescribeGameServerInstancesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeGameServerInstancesOutput();

            if (data.hasOwnProperty('GameServerInstances')) {
                obj['GameServerInstances'] = ApiClient.convertToType(data['GameServerInstances'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeGameServerInstancesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeGameServerInstancesOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GameServerInstances`
        if (data['GameServerInstances']) { // data not null
          Array.validateJSON(data['GameServerInstances']);
        }
...
/**
 * @member {Array} GameServerInstances
 */
DescribeGameServerInstancesOutput.prototype['GameServerInstances'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeGameServerInstancesOutput.prototype['NextToken'] = undefined;
...
export default DescribeGameServerInstancesOutput;
