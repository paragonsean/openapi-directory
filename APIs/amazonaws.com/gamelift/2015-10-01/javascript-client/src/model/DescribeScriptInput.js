...
/**
 * The DescribeScriptInput model module.
 * @module model/DescribeScriptInput
 * @version 2015-10-01
 */
class DescribeScriptInput {
    /**
     * Constructs a new <code>DescribeScriptInput</code>.
     * @alias module:model/DescribeScriptInput
     * @param scriptId {String} 
     */
    constructor(scriptId) { 
        
        DescribeScriptInput.initialize(this, scriptId);
    }
     ...
     */
    static initialize(obj, scriptId) { 
        obj['ScriptId'] = scriptId;
    }

    /**
     * Constructs a <code>DescribeScriptInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeScriptInput} obj Optional instance to populate.
     * @return {module:model/DescribeScriptInput} The populated <code>DescribeScriptInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeScriptInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeScriptInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeScriptInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeScriptInput.RequiredProperties) {
...
DescribeScriptInput.RequiredProperties = ["ScriptId"];

/**
 * @member {String} ScriptId
 */
DescribeScriptInput.prototype['ScriptId'] = undefined;
...
export default DescribeScriptInput;
