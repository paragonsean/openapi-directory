...
import DescribeAliasOutputAlias from './DescribeAliasOutputAlias';

/**
 * The DescribeAliasOutput model module.
 * @module model/DescribeAliasOutput
 * @version 2015-10-01
 */
class DescribeAliasOutput {
    /**
     * Constructs a new <code>DescribeAliasOutput</code>.
     * @alias module:model/DescribeAliasOutput
     */
    constructor() { 
        
        DescribeAliasOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeAliasOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeAliasOutput} obj Optional instance to populate.
     * @return {module:model/DescribeAliasOutput} The populated <code>DescribeAliasOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeAliasOutput();

            if (data.hasOwnProperty('Alias')) {
                obj['Alias'] = DescribeAliasOutputAlias.constructFromObject(data['Alias']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeAliasOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeAliasOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Alias`
        if (data['Alias']) { // data not null
          DescribeAliasOutputAlias.validateJSON(data['Alias']);
        }
...
/**
 * @member {module:model/DescribeAliasOutputAlias} Alias
 */
DescribeAliasOutput.prototype['Alias'] = undefined;
...
export default DescribeAliasOutput;
