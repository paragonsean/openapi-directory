...
/**
 * The DescribeFleetLocationCapacityOutputFleetCapacity model module.
 * @module model/DescribeFleetLocationCapacityOutputFleetCapacity
 * @version 2015-10-01
 */
class DescribeFleetLocationCapacityOutputFleetCapacity {
    /**
     * Constructs a new <code>DescribeFleetLocationCapacityOutputFleetCapacity</code>.
     * @alias module:model/DescribeFleetLocationCapacityOutputFleetCapacity
     * @implements module:model/FleetCapacity
     */
    constructor() { 
        FleetCapacity.initialize(this);
        DescribeFleetLocationCapacityOutputFleetCapacity.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeFleetLocationCapacityOutputFleetCapacity</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeFleetLocationCapacityOutputFleetCapacity} obj Optional instance to populate.
     * @return {module:model/DescribeFleetLocationCapacityOutputFleetCapacity} The populated <code>DescribeFleetLocationCapacityOutputFleetCapacity</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeFleetLocationCapacityOutputFleetCapacity();
            FleetCapacity.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeFleetLocationCapacityOutputFleetCapacity</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeFleetLocationCapacityOutputFleetCapacity</code>.
     */
 ...
 */
DescribeFleetLocationCapacityOutputFleetCapacity.prototype['FleetId'] = undefined;

/**
 * @member {String} FleetArn
 */
DescribeFleetLocationCapacityOutputFleetCapacity.prototype['FleetArn'] = undefined;

/**
 * @member {module:model/EC2InstanceType} InstanceType
 */
DescribeFleetLocationCapacityOutputFleetCapacity.prototype['InstanceType'] = undefined;

/**
 * @member {module:model/EC2InstanceCounts} InstanceCounts
 */
DescribeFleetLocationCapacityOutputFleetCapacity.prototype['InstanceCounts'] = undefined;

/**
 * @member {String} Location
 */
DescribeFleetLocationCapacityOutputFleetCapacity.prototype['Location'] = undefined;


// Implement FleetCapacity interface:
/**
 * @member {String} FleetId
 */
...
export default DescribeFleetLocationCapacityOutputFleetCapacity;
