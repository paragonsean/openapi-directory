...
import CreateGameSessionOutputGameSession from './CreateGameSessionOutputGameSession';

/**
 * The CreateGameSessionOutput model module.
 * @module model/CreateGameSessionOutput
 * @version 2015-10-01
 */
class CreateGameSessionOutput {
    /**
     * Constructs a new <code>CreateGameSessionOutput</code>.
     * @alias module:model/CreateGameSessionOutput
     */
    constructor() { 
        
        CreateGameSessionOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateGameSessionOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateGameSessionOutput} obj Optional instance to populate.
     * @return {module:model/CreateGameSessionOutput} The populated <code>CreateGameSessionOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateGameSessionOutput();

            if (data.hasOwnProperty('GameSession')) {
                obj['GameSession'] = CreateGameSessionOutputGameSession.constructFromObject(data['GameSession']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateGameSessionOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateGameSessionOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GameSession`
        if (data['GameSession']) { // data not null
          CreateGameSessionOutputGameSession.validateJSON(data['GameSession']);
        }
...
/**
 * @member {module:model/CreateGameSessionOutputGameSession} GameSession
 */
CreateGameSessionOutput.prototype['GameSession'] = undefined;
...
export default CreateGameSessionOutput;
