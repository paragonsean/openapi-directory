...
/**
 * The ListGameServersInput model module.
 * @module model/ListGameServersInput
 * @version 2015-10-01
 */
class ListGameServersInput {
    /**
     * Constructs a new <code>ListGameServersInput</code>.
     * @alias module:model/ListGameServersInput
     * @param gameServerGroupName {String} 
     */
    constructor(gameServerGroupName) { 
        
        ListGameServersInput.initialize(this, gameServerGroupName);
    }
    ...
    /**
     * Constructs a <code>ListGameServersInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListGameServersInput} obj Optional instance to populate.
     * @return {module:model/ListGameServersInput} The populated <code>ListGameServersInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListGameServersInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListGameServersInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListGameServersInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListGameServersInput.RequiredProperties) {
...
ListGameServersInput.RequiredProperties = ["GameServerGroupName"];

/**
 * @member {String} GameServerGroupName
 */
ListGameServersInput.prototype['GameServerGroupName'] = undefined;

/**
 * @member {module:model/SortOrder} SortOrder
 */
ListGameServersInput.prototype['SortOrder'] = undefined;

/**
 * @member {Number} Limit
 */
ListGameServersInput.prototype['Limit'] = undefined;

/**
 * @member {String} NextToken
 */
ListGameServersInput.prototype['NextToken'] = undefined;
...
export default ListGameServersInput;
