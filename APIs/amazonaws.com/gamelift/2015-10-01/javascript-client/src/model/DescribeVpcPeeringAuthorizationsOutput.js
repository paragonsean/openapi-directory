...
/**
 * The DescribeVpcPeeringAuthorizationsOutput model module.
 * @module model/DescribeVpcPeeringAuthorizationsOutput
 * @version 2015-10-01
 */
class DescribeVpcPeeringAuthorizationsOutput {
    /**
     * Constructs a new <code>DescribeVpcPeeringAuthorizationsOutput</code>.
     * @alias module:model/DescribeVpcPeeringAuthorizationsOutput
     */
    constructor() { 
        
        DescribeVpcPeeringAuthorizationsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeVpcPeeringAuthorizationsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeVpcPeeringAuthorizationsOutput} obj Optional instance to populate.
     * @return {module:model/DescribeVpcPeeringAuthorizationsOutput} The populated <code>DescribeVpcPeeringAuthorizationsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeVpcPeeringAuthorizationsOutput();

            if (data.hasOwnProperty('VpcPeeringAuthorizations')) {
                obj['VpcPeeringAuthorizations'] = ApiClient.convertToType(data['VpcPeeringAuthorizations'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeVpcPeeringAuthorizationsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeVpcPeeringAuthorizationsOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `VpcPeeringAuthorizations`
        if (data['VpcPeeringAuthorizations']) { // data not null
          Array.validateJSON(data['VpcPeeringAuthorizations']);
        }
...
/**
 * @member {Array} VpcPeeringAuthorizations
 */
DescribeVpcPeeringAuthorizationsOutput.prototype['VpcPeeringAuthorizations'] = undefined;
...
export default DescribeVpcPeeringAuthorizationsOutput;
