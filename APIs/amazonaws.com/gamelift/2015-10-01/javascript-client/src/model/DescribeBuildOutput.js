...
import DescribeBuildOutputBuild from './DescribeBuildOutputBuild';

/**
 * The DescribeBuildOutput model module.
 * @module model/DescribeBuildOutput
 * @version 2015-10-01
 */
class DescribeBuildOutput {
    /**
     * Constructs a new <code>DescribeBuildOutput</code>.
     * @alias module:model/DescribeBuildOutput
     */
    constructor() { 
        
        DescribeBuildOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeBuildOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeBuildOutput} obj Optional instance to populate.
     * @return {module:model/DescribeBuildOutput} The populated <code>DescribeBuildOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeBuildOutput();

            if (data.hasOwnProperty('Build')) {
                obj['Build'] = DescribeBuildOutputBuild.constructFromObject(data['Build']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeBuildOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeBuildOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Build`
        if (data['Build']) { // data not null
          DescribeBuildOutputBuild.validateJSON(data['Build']);
        }
...
/**
 * @member {module:model/DescribeBuildOutputBuild} Build
 */
DescribeBuildOutput.prototype['Build'] = undefined;
...
export default DescribeBuildOutput;
