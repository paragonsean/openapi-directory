...
/**
 * The LocationConfiguration model module.
 * @module model/LocationConfiguration
 * @version 2015-10-01
 */
class LocationConfiguration {
    /**
     * Constructs a new <code>LocationConfiguration</code>.
     * A remote location where a multi-location fleet can deploy game servers for game hosting. 
     * @alias module:model/LocationConfiguration
     * @param location {String} 
     */
    constructor(location) { 
        
        LocationConfiguration.initialize(this, location);
    }
    ...
    /**
     * Constructs a <code>LocationConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LocationConfiguration} obj Optional instance to populate.
     * @return {module:model/LocationConfiguration} The populated <code>LocationConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LocationConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>LocationConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LocationConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LocationConfiguration.RequiredProperties) {
...
LocationConfiguration.RequiredProperties = ["Location"];

/**
 * @member {String} Location
 */
LocationConfiguration.prototype['Location'] = undefined;
