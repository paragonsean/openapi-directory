...
import StartMatchBackfillOutputMatchmakingTicket from './StartMatchBackfillOutputMatchmakingTicket';

/**
 * The StartMatchBackfillOutput model module.
 * @module model/StartMatchBackfillOutput
 * @version 2015-10-01
 */
class StartMatchBackfillOutput {
    /**
     * Constructs a new <code>StartMatchBackfillOutput</code>.
     * @alias module:model/StartMatchBackfillOutput
     */
    constructor() { 
        
        StartMatchBackfillOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartMatchBackfillOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartMatchBackfillOutput} obj Optional instance to populate.
     * @return {module:model/StartMatchBackfillOutput} The populated <code>StartMatchBackfillOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartMatchBackfillOutput();

            if (data.hasOwnProperty('MatchmakingTicket')) {
                obj['MatchmakingTicket'] = StartMatchBackfillOutputMatchmakingTicket.constructFromObject(data['MatchmakingTicket']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StartMatchBackfillOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartMatchBackfillOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `MatchmakingTicket`
        if (data['MatchmakingTicket']) { // data not null
          StartMatchBackfillOutputMatchmakingTicket.validateJSON(data['MatchmakingTicket']);
        }
...
/**
 * @member {module:model/StartMatchBackfillOutputMatchmakingTicket} MatchmakingTicket
 */
StartMatchBackfillOutput.prototype['MatchmakingTicket'] = undefined;
...
export default StartMatchBackfillOutput;
