...
* @readonly
*/
export default class PlayerSessionCreationPolicy {
    ...
    /**
    * Returns a <code>PlayerSessionCreationPolicy</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PlayerSessionCreationPolicy} The enum <code>PlayerSessionCreationPolicy</code> value.
    */
