...
/**
 * The CreatePlayerSessionsInput model module.
 * @module model/CreatePlayerSessionsInput
 * @version 2015-10-01
 */
class CreatePlayerSessionsInput {
    /**
     * Constructs a new <code>CreatePlayerSessionsInput</code>.
     * @alias module:model/CreatePlayerSessionsInput
     * @param gameSessionId {String} 
     * @param playerIds {Array} 
     */
    constructor(gameSessionId, playerIds) { 
        
        CreatePlayerSessionsInput.initialize(this, gameSessionId, playerIds);
    }
     ...
     */
    static initialize(obj, gameSessionId, playerIds) { 
        obj['GameSessionId'] = gameSessionId;
        obj['PlayerIds'] = playerIds;
    }

    /**
     * Constructs a <code>CreatePlayerSessionsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePlayerSessionsInput} obj Optional instance to populate.
     * @return {module:model/CreatePlayerSessionsInput} The populated <code>CreatePlayerSessionsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePlayerSessionsInput();
            ...
            if (data.hasOwnProperty('PlayerIds')) {
                obj['PlayerIds'] = ApiClient.convertToType(data['PlayerIds'], Array);
            }
            if (data.hasOwnProperty('PlayerDataMap')) {
                obj['PlayerDataMap'] = ApiClient.convertToType(data['PlayerDataMap'], Object);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePlayerSessionsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePlayerSessionsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreatePlayerSessionsInput.RequiredProperties) {
        ...
        // validate the optional field `PlayerIds`
        if (data['PlayerIds']) { // data not null
          Array.validateJSON(data['PlayerIds']);
        }
        // validate the optional field `PlayerDataMap`
        if (data['PlayerDataMap']) { // data not null
          Object.validateJSON(data['PlayerDataMap']);
        }
...
CreatePlayerSessionsInput.RequiredProperties = ["GameSessionId", "PlayerIds"];

/**
 * @member {String} GameSessionId
 */
CreatePlayerSessionsInput.prototype['GameSessionId'] = undefined;

/**
 * @member {Array} PlayerIds
 */
CreatePlayerSessionsInput.prototype['PlayerIds'] = undefined;

/**
 * @member {Object} PlayerDataMap
 */
CreatePlayerSessionsInput.prototype['PlayerDataMap'] = undefined;
...
export default CreatePlayerSessionsInput;
