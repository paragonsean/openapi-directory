...
* @readonly
*/
export default class GameSessionStatusReason {
    ...
    /**
    * Returns a <code>GameSessionStatusReason</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/GameSessionStatusReason} The enum <code>GameSessionStatusReason</code> value.
    */
