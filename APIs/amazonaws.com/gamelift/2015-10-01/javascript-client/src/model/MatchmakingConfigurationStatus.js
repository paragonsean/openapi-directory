...
* @readonly
*/
export default class MatchmakingConfigurationStatus {
    ...
    /**
    * Returns a <code>MatchmakingConfigurationStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/MatchmakingConfigurationStatus} The enum <code>MatchmakingConfigurationStatus</code> value.
    */
