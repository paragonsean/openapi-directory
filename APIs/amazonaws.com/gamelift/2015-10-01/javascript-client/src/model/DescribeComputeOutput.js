...
import DescribeComputeOutputCompute from './DescribeComputeOutputCompute';

/**
 * The DescribeComputeOutput model module.
 * @module model/DescribeComputeOutput
 * @version 2015-10-01
 */
class DescribeComputeOutput {
    /**
     * Constructs a new <code>DescribeComputeOutput</code>.
     * @alias module:model/DescribeComputeOutput
     */
    constructor() { 
        
        DescribeComputeOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeComputeOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeComputeOutput} obj Optional instance to populate.
     * @return {module:model/DescribeComputeOutput} The populated <code>DescribeComputeOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeComputeOutput();

            if (data.hasOwnProperty('Compute')) {
                obj['Compute'] = DescribeComputeOutputCompute.constructFromObject(data['Compute']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeComputeOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeComputeOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Compute`
        if (data['Compute']) { // data not null
          DescribeComputeOutputCompute.validateJSON(data['Compute']);
        }
...
/**
 * @member {module:model/DescribeComputeOutputCompute} Compute
 */
DescribeComputeOutput.prototype['Compute'] = undefined;
...
export default DescribeComputeOutput;
