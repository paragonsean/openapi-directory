...
import CreateMatchmakingRuleSetOutputRuleSet from './CreateMatchmakingRuleSetOutputRuleSet';

/**
 * The CreateMatchmakingRuleSetOutput model module.
 * @module model/CreateMatchmakingRuleSetOutput
 * @version 2015-10-01
 */
class CreateMatchmakingRuleSetOutput {
    /**
     * Constructs a new <code>CreateMatchmakingRuleSetOutput</code>.
     * @alias module:model/CreateMatchmakingRuleSetOutput
     * @param ruleSet {module:model/CreateMatchmakingRuleSetOutputRuleSet} 
     */
    constructor(ruleSet) { 
        
        CreateMatchmakingRuleSetOutput.initialize(this, ruleSet);
    }
    ...
    /**
     * Constructs a <code>CreateMatchmakingRuleSetOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateMatchmakingRuleSetOutput} obj Optional instance to populate.
     * @return {module:model/CreateMatchmakingRuleSetOutput} The populated <code>CreateMatchmakingRuleSetOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateMatchmakingRuleSetOutput();

            if (data.hasOwnProperty('RuleSet')) {
                obj['RuleSet'] = CreateMatchmakingRuleSetOutputRuleSet.constructFromObject(data['RuleSet']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateMatchmakingRuleSetOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateMatchmakingRuleSetOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateMatchmakingRuleSetOutput.RequiredProperties) {
        ...
        if (data['RuleSet']) { // data not null
          CreateMatchmakingRuleSetOutputRuleSet.validateJSON(data['RuleSet']);
        }
...
CreateMatchmakingRuleSetOutput.RequiredProperties = ["RuleSet"];

/**
 * @member {module:model/CreateMatchmakingRuleSetOutputRuleSet} RuleSet
 */
CreateMatchmakingRuleSetOutput.prototype['RuleSet'] = undefined;
...
export default CreateMatchmakingRuleSetOutput;
