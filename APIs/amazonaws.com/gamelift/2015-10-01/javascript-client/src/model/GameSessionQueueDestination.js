...
/**
 * The GameSessionQueueDestination model module.
 * @module model/GameSessionQueueDestination
 * @version 2015-10-01
 */
class GameSessionQueueDestination {
    /**
     * Constructs a new <code>GameSessionQueueDestination</code>.
     * A fleet or alias designated in a game session queue. Queues fulfill requests for new game sessions by placing a new game session on any of the queue&#39;s destinations. 
     * @alias module:model/GameSessionQueueDestination
     */
    constructor() { 
        
        GameSessionQueueDestination.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GameSessionQueueDestination</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GameSessionQueueDestination} obj Optional instance to populate.
     * @return {module:model/GameSessionQueueDestination} The populated <code>GameSessionQueueDestination</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GameSessionQueueDestination();
    ...
    /**
     * Validates the JSON data with respect to <code>GameSessionQueueDestination</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GameSessionQueueDestination</code>.
     */
 ...
 */
GameSessionQueueDestination.prototype['DestinationArn'] = undefined;
...
export default GameSessionQueueDestination;
