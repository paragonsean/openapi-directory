...
/**
 * The GetComputeAccessInput model module.
 * @module model/GetComputeAccessInput
 * @version 2015-10-01
 */
class GetComputeAccessInput {
    /**
     * Constructs a new <code>GetComputeAccessInput</code>.
     * @alias module:model/GetComputeAccessInput
     * @param fleetId {String} 
     * @param computeName {String} 
     */
    constructor(fleetId, computeName) { 
        
        GetComputeAccessInput.initialize(this, fleetId, computeName);
    }
    ...
    /**
     * Constructs a <code>GetComputeAccessInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetComputeAccessInput} obj Optional instance to populate.
     * @return {module:model/GetComputeAccessInput} The populated <code>GetComputeAccessInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetComputeAccessInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetComputeAccessInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetComputeAccessInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetComputeAccessInput.RequiredProperties) {
...
GetComputeAccessInput.RequiredProperties = ["FleetId", "ComputeName"];

/**
 * @member {String} FleetId
 */
GetComputeAccessInput.prototype['FleetId'] = undefined;

/**
 * @member {String} ComputeName
 */
GetComputeAccessInput.prototype['ComputeName'] = undefined;
...
export default GetComputeAccessInput;
