...
import DescribeFleetLocationUtilizationOutputFleetUtilization from './DescribeFleetLocationUtilizationOutputFleetUtilization';

/**
 * The DescribeFleetLocationUtilizationOutput model module.
 * @module model/DescribeFleetLocationUtilizationOutput
 * @version 2015-10-01
 */
class DescribeFleetLocationUtilizationOutput {
    /**
     * Constructs a new <code>DescribeFleetLocationUtilizationOutput</code>.
     * @alias module:model/DescribeFleetLocationUtilizationOutput
     */
    constructor() { 
        
        DescribeFleetLocationUtilizationOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeFleetLocationUtilizationOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeFleetLocationUtilizationOutput} obj Optional instance to populate.
     * @return {module:model/DescribeFleetLocationUtilizationOutput} The populated <code>DescribeFleetLocationUtilizationOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeFleetLocationUtilizationOutput();

            if (data.hasOwnProperty('FleetUtilization')) {
                obj['FleetUtilization'] = DescribeFleetLocationUtilizationOutputFleetUtilization.constructFromObject(data['FleetUtilization']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeFleetLocationUtilizationOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeFleetLocationUtilizationOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `FleetUtilization`
        if (data['FleetUtilization']) { // data not null
          DescribeFleetLocationUtilizationOutputFleetUtilization.validateJSON(data['FleetUtilization']);
        }
...
/**
 * @member {module:model/DescribeFleetLocationUtilizationOutputFleetUtilization} FleetUtilization
 */
DescribeFleetLocationUtilizationOutput.prototype['FleetUtilization'] = undefined;
...
export default DescribeFleetLocationUtilizationOutput;
