...
import DescribeGameSessionPlacementOutputGameSessionPlacement from './DescribeGameSessionPlacementOutputGameSessionPlacement';

/**
 * The DescribeGameSessionPlacementOutput model module.
 * @module model/DescribeGameSessionPlacementOutput
 * @version 2015-10-01
 */
class DescribeGameSessionPlacementOutput {
    /**
     * Constructs a new <code>DescribeGameSessionPlacementOutput</code>.
     * @alias module:model/DescribeGameSessionPlacementOutput
     */
    constructor() { 
        
        DescribeGameSessionPlacementOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeGameSessionPlacementOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeGameSessionPlacementOutput} obj Optional instance to populate.
     * @return {module:model/DescribeGameSessionPlacementOutput} The populated <code>DescribeGameSessionPlacementOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeGameSessionPlacementOutput();

            if (data.hasOwnProperty('GameSessionPlacement')) {
                obj['GameSessionPlacement'] = DescribeGameSessionPlacementOutputGameSessionPlacement.constructFromObject(data['GameSessionPlacement']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeGameSessionPlacementOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeGameSessionPlacementOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GameSessionPlacement`
        if (data['GameSessionPlacement']) { // data not null
          DescribeGameSessionPlacementOutputGameSessionPlacement.validateJSON(data['GameSessionPlacement']);
        }
...
/**
 * @member {module:model/DescribeGameSessionPlacementOutputGameSessionPlacement} GameSessionPlacement
 */
DescribeGameSessionPlacementOutput.prototype['GameSessionPlacement'] = undefined;
...
export default DescribeGameSessionPlacementOutput;
