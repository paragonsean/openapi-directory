...
/**
 * The DeleteLocationInput model module.
 * @module model/DeleteLocationInput
 * @version 2015-10-01
 */
class DeleteLocationInput {
    /**
     * Constructs a new <code>DeleteLocationInput</code>.
     * @alias module:model/DeleteLocationInput
     * @param locationName {String} 
     */
    constructor(locationName) { 
        
        DeleteLocationInput.initialize(this, locationName);
    }
    ...
    /**
     * Constructs a <code>DeleteLocationInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteLocationInput} obj Optional instance to populate.
     * @return {module:model/DeleteLocationInput} The populated <code>DeleteLocationInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteLocationInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteLocationInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteLocationInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteLocationInput.RequiredProperties) {
...
DeleteLocationInput.RequiredProperties = ["LocationName"];

/**
 * @member {String} LocationName
 */
DeleteLocationInput.prototype['LocationName'] = undefined;
...
export default DeleteLocationInput;
