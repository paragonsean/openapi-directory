...
import StartMatchmakingOutputMatchmakingTicket from './StartMatchmakingOutputMatchmakingTicket';

/**
 * The StartMatchmakingOutput model module.
 * @module model/StartMatchmakingOutput
 * @version 2015-10-01
 */
class StartMatchmakingOutput {
    /**
     * Constructs a new <code>StartMatchmakingOutput</code>.
     * @alias module:model/StartMatchmakingOutput
     */
    constructor() { 
        
        StartMatchmakingOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartMatchmakingOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartMatchmakingOutput} obj Optional instance to populate.
     * @return {module:model/StartMatchmakingOutput} The populated <code>StartMatchmakingOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartMatchmakingOutput();

            if (data.hasOwnProperty('MatchmakingTicket')) {
                obj['MatchmakingTicket'] = StartMatchmakingOutputMatchmakingTicket.constructFromObject(data['MatchmakingTicket']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StartMatchmakingOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartMatchmakingOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `MatchmakingTicket`
        if (data['MatchmakingTicket']) { // data not null
          StartMatchmakingOutputMatchmakingTicket.validateJSON(data['MatchmakingTicket']);
        }
...
/**
 * @member {module:model/StartMatchmakingOutputMatchmakingTicket} MatchmakingTicket
 */
StartMatchmakingOutput.prototype['MatchmakingTicket'] = undefined;
...
export default StartMatchmakingOutput;
