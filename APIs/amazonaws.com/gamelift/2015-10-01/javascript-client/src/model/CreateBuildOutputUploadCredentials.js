...
/**
 * The CreateBuildOutputUploadCredentials model module.
 * @module model/CreateBuildOutputUploadCredentials
 * @version 2015-10-01
 */
class CreateBuildOutputUploadCredentials {
    /**
     * Constructs a new <code>CreateBuildOutputUploadCredentials</code>.
     * @alias module:model/CreateBuildOutputUploadCredentials
     * @implements module:model/AwsCredentials
     */
    constructor() { 
        AwsCredentials.initialize(this);
        CreateBuildOutputUploadCredentials.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateBuildOutputUploadCredentials</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateBuildOutputUploadCredentials} obj Optional instance to populate.
     * @return {module:model/CreateBuildOutputUploadCredentials} The populated <code>CreateBuildOutputUploadCredentials</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateBuildOutputUploadCredentials();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateBuildOutputUploadCredentials</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateBuildOutputUploadCredentials</code>.
     */
 ...
 */
CreateBuildOutputUploadCredentials.prototype['AccessKeyId'] = undefined;

/**
 * @member {String} SecretAccessKey
 */
CreateBuildOutputUploadCredentials.prototype['SecretAccessKey'] = undefined;

/**
 * @member {String} SessionToken
 */
CreateBuildOutputUploadCredentials.prototype['SessionToken'] = undefined;
...
export default CreateBuildOutputUploadCredentials;
