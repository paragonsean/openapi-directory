...
import UpdateAliasOutputAlias from './UpdateAliasOutputAlias';

/**
 * The UpdateAliasOutput model module.
 * @module model/UpdateAliasOutput
 * @version 2015-10-01
 */
class UpdateAliasOutput {
    /**
     * Constructs a new <code>UpdateAliasOutput</code>.
     * @alias module:model/UpdateAliasOutput
     */
    constructor() { 
        
        UpdateAliasOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateAliasOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateAliasOutput} obj Optional instance to populate.
     * @return {module:model/UpdateAliasOutput} The populated <code>UpdateAliasOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateAliasOutput();

            if (data.hasOwnProperty('Alias')) {
                obj['Alias'] = UpdateAliasOutputAlias.constructFromObject(data['Alias']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateAliasOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateAliasOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Alias`
        if (data['Alias']) { // data not null
          UpdateAliasOutputAlias.validateJSON(data['Alias']);
        }
...
/**
 * @member {module:model/UpdateAliasOutputAlias} Alias
 */
UpdateAliasOutput.prototype['Alias'] = undefined;
...
export default UpdateAliasOutput;
