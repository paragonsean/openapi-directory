...
/**
 * The DescribeGameSessionsInput model module.
 * @module model/DescribeGameSessionsInput
 * @version 2015-10-01
 */
class DescribeGameSessionsInput {
    /**
     * Constructs a new <code>DescribeGameSessionsInput</code>.
     * @alias module:model/DescribeGameSessionsInput
     */
    constructor() { 
        
        DescribeGameSessionsInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeGameSessionsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeGameSessionsInput} obj Optional instance to populate.
     * @return {module:model/DescribeGameSessionsInput} The populated <code>DescribeGameSessionsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeGameSessionsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeGameSessionsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeGameSessionsInput</code>.
     */
 ...
 */
DescribeGameSessionsInput.prototype['FleetId'] = undefined;

/**
 * @member {String} GameSessionId
 */
DescribeGameSessionsInput.prototype['GameSessionId'] = undefined;

/**
 * @member {String} AliasId
 */
DescribeGameSessionsInput.prototype['AliasId'] = undefined;

/**
 * @member {String} Location
 */
DescribeGameSessionsInput.prototype['Location'] = undefined;

/**
 * @member {String} StatusFilter
 */
DescribeGameSessionsInput.prototype['StatusFilter'] = undefined;

/**
 * @member {Number} Limit
 */
DescribeGameSessionsInput.prototype['Limit'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeGameSessionsInput.prototype['NextToken'] = undefined;
...
export default DescribeGameSessionsInput;
