...
import InstanceAccessCredentials from './InstanceAccessCredentials';
import OperatingSystem from './OperatingSystem';

/**
 * The InstanceAccess model module.
 * @module model/InstanceAccess
 * @version 2015-10-01
 */
class InstanceAccess {
    /**
     * Constructs a new <code>InstanceAccess</code>.
     * Information required to remotely connect to a fleet instance. 
     * @alias module:model/InstanceAccess
     */
    constructor() { 
        
        InstanceAccess.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InstanceAccess</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InstanceAccess} obj Optional instance to populate.
     * @return {module:model/InstanceAccess} The populated <code>InstanceAccess</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InstanceAccess();
            ...
            if (data.hasOwnProperty('Credentials')) {
                obj['Credentials'] = InstanceAccessCredentials.constructFromObject(data['Credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>InstanceAccess</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InstanceAccess</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Credentials']) { // data not null
          InstanceAccessCredentials.validateJSON(data['Credentials']);
        }
 ...
 */
InstanceAccess.prototype['FleetId'] = undefined;

/**
 * @member {String} InstanceId
 */
InstanceAccess.prototype['InstanceId'] = undefined;

/**
 * @member {String} IpAddress
 */
InstanceAccess.prototype['IpAddress'] = undefined;

/**
 * @member {module:model/OperatingSystem} OperatingSystem
 */
InstanceAccess.prototype['OperatingSystem'] = undefined;

/**
 * @member {module:model/InstanceAccessCredentials} Credentials
 */
InstanceAccess.prototype['Credentials'] = undefined;
