...
/**
 * The CreateScriptInputStorageLocation model module.
 * @module model/CreateScriptInputStorageLocation
 * @version 2015-10-01
 */
class CreateScriptInputStorageLocation {
    /**
     * Constructs a new <code>CreateScriptInputStorageLocation</code>.
     * @alias module:model/CreateScriptInputStorageLocation
     * @implements module:model/S3Location
     */
    constructor() { 
        S3Location.initialize(this);
        CreateScriptInputStorageLocation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateScriptInputStorageLocation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateScriptInputStorageLocation} obj Optional instance to populate.
     * @return {module:model/CreateScriptInputStorageLocation} The populated <code>CreateScriptInputStorageLocation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateScriptInputStorageLocation();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateScriptInputStorageLocation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateScriptInputStorageLocation</code>.
     */
 ...
 */
CreateScriptInputStorageLocation.prototype['Bucket'] = undefined;

/**
 * @member {String} Key
 */
CreateScriptInputStorageLocation.prototype['Key'] = undefined;

/**
 * @member {String} RoleArn
 */
CreateScriptInputStorageLocation.prototype['RoleArn'] = undefined;

/**
 * @member {String} ObjectVersion
 */
CreateScriptInputStorageLocation.prototype['ObjectVersion'] = undefined;
 ...
 * @member {String} RoleArn
 */
S3Location.prototype['RoleArn'] = undefined;
/**
 * @member {String} ObjectVersion
 */
S3Location.prototype['ObjectVersion'] = undefined;




export default CreateScriptInputStorageLocation;
