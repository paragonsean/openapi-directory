...
/**
 * The DeleteMatchmakingConfigurationInput model module.
 * @module model/DeleteMatchmakingConfigurationInput
 * @version 2015-10-01
 */
class DeleteMatchmakingConfigurationInput {
    /**
     * Constructs a new <code>DeleteMatchmakingConfigurationInput</code>.
     * @alias module:model/DeleteMatchmakingConfigurationInput
     * @param name {String} 
     */
    constructor(name) { 
        
        DeleteMatchmakingConfigurationInput.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>DeleteMatchmakingConfigurationInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteMatchmakingConfigurationInput} obj Optional instance to populate.
     * @return {module:model/DeleteMatchmakingConfigurationInput} The populated <code>DeleteMatchmakingConfigurationInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteMatchmakingConfigurationInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteMatchmakingConfigurationInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteMatchmakingConfigurationInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteMatchmakingConfigurationInput.RequiredProperties) {
...
DeleteMatchmakingConfigurationInput.RequiredProperties = ["Name"];

/**
 * @member {String} Name
 */
DeleteMatchmakingConfigurationInput.prototype['Name'] = undefined;
...
export default DeleteMatchmakingConfigurationInput;
