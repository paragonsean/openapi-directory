...
/**
 * The DescribeGameSessionPlacementInput model module.
 * @module model/DescribeGameSessionPlacementInput
 * @version 2015-10-01
 */
class DescribeGameSessionPlacementInput {
    /**
     * Constructs a new <code>DescribeGameSessionPlacementInput</code>.
     * @alias module:model/DescribeGameSessionPlacementInput
     * @param placementId {String} 
     */
    constructor(placementId) { 
        
        DescribeGameSessionPlacementInput.initialize(this, placementId);
    }
     ...
     */
    static initialize(obj, placementId) { 
        obj['PlacementId'] = placementId;
    }

    /**
     * Constructs a <code>DescribeGameSessionPlacementInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeGameSessionPlacementInput} obj Optional instance to populate.
     * @return {module:model/DescribeGameSessionPlacementInput} The populated <code>DescribeGameSessionPlacementInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeGameSessionPlacementInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeGameSessionPlacementInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeGameSessionPlacementInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeGameSessionPlacementInput.RequiredProperties) {
...
DescribeGameSessionPlacementInput.RequiredProperties = ["PlacementId"];

/**
 * @member {String} PlacementId
 */
DescribeGameSessionPlacementInput.prototype['PlacementId'] = undefined;
...
export default DescribeGameSessionPlacementInput;
