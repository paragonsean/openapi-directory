...
/**
 * The DescribeScalingPoliciesOutput model module.
 * @module model/DescribeScalingPoliciesOutput
 * @version 2015-10-01
 */
class DescribeScalingPoliciesOutput {
    /**
     * Constructs a new <code>DescribeScalingPoliciesOutput</code>.
     * @alias module:model/DescribeScalingPoliciesOutput
     */
    constructor() { 
        
        DescribeScalingPoliciesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeScalingPoliciesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeScalingPoliciesOutput} obj Optional instance to populate.
     * @return {module:model/DescribeScalingPoliciesOutput} The populated <code>DescribeScalingPoliciesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeScalingPoliciesOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeScalingPoliciesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeScalingPoliciesOutput</code>.
     */
 ...
 */
DescribeScalingPoliciesOutput.prototype['ScalingPolicies'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeScalingPoliciesOutput.prototype['NextToken'] = undefined;
...
export default DescribeScalingPoliciesOutput;
