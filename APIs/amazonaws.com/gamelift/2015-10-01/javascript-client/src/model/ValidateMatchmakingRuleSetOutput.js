...
/**
 * The ValidateMatchmakingRuleSetOutput model module.
 * @module model/ValidateMatchmakingRuleSetOutput
 * @version 2015-10-01
 */
class ValidateMatchmakingRuleSetOutput {
    /**
     * Constructs a new <code>ValidateMatchmakingRuleSetOutput</code>.
     * @alias module:model/ValidateMatchmakingRuleSetOutput
     */
    constructor() { 
        
        ValidateMatchmakingRuleSetOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ValidateMatchmakingRuleSetOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ValidateMatchmakingRuleSetOutput} obj Optional instance to populate.
     * @return {module:model/ValidateMatchmakingRuleSetOutput} The populated <code>ValidateMatchmakingRuleSetOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ValidateMatchmakingRuleSetOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>ValidateMatchmakingRuleSetOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ValidateMatchmakingRuleSetOutput</code>.
     */
 ...
 */
ValidateMatchmakingRuleSetOutput.prototype['Valid'] = undefined;
...
export default ValidateMatchmakingRuleSetOutput;
