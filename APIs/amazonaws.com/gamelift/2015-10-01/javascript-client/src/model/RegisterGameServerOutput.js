...
import RegisterGameServerOutputGameServer from './RegisterGameServerOutputGameServer';

/**
 * The RegisterGameServerOutput model module.
 * @module model/RegisterGameServerOutput
 * @version 2015-10-01
 */
class RegisterGameServerOutput {
    /**
     * Constructs a new <code>RegisterGameServerOutput</code>.
     * @alias module:model/RegisterGameServerOutput
     */
    constructor() { 
        
        RegisterGameServerOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RegisterGameServerOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RegisterGameServerOutput} obj Optional instance to populate.
     * @return {module:model/RegisterGameServerOutput} The populated <code>RegisterGameServerOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RegisterGameServerOutput();

            if (data.hasOwnProperty('GameServer')) {
                obj['GameServer'] = RegisterGameServerOutputGameServer.constructFromObject(data['GameServer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RegisterGameServerOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RegisterGameServerOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GameServer`
        if (data['GameServer']) { // data not null
          RegisterGameServerOutputGameServer.validateJSON(data['GameServer']);
        }
...
/**
 * @member {module:model/RegisterGameServerOutputGameServer} GameServer
 */
RegisterGameServerOutput.prototype['GameServer'] = undefined;
...
export default RegisterGameServerOutput;
