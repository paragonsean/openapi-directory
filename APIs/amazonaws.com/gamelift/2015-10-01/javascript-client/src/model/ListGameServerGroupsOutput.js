...
/**
 * The ListGameServerGroupsOutput model module.
 * @module model/ListGameServerGroupsOutput
 * @version 2015-10-01
 */
class ListGameServerGroupsOutput {
    /**
     * Constructs a new <code>ListGameServerGroupsOutput</code>.
     * @alias module:model/ListGameServerGroupsOutput
     */
    constructor() { 
        
        ListGameServerGroupsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListGameServerGroupsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListGameServerGroupsOutput} obj Optional instance to populate.
     * @return {module:model/ListGameServerGroupsOutput} The populated <code>ListGameServerGroupsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListGameServerGroupsOutput();

            if (data.hasOwnProperty('GameServerGroups')) {
                obj['GameServerGroups'] = ApiClient.convertToType(data['GameServerGroups'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListGameServerGroupsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListGameServerGroupsOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GameServerGroups`
        if (data['GameServerGroups']) { // data not null
          Array.validateJSON(data['GameServerGroups']);
        }
...
/**
 * @member {Array} GameServerGroups
 */
ListGameServerGroupsOutput.prototype['GameServerGroups'] = undefined;

/**
 * @member {String} NextToken
 */
ListGameServerGroupsOutput.prototype['NextToken'] = undefined;
...
export default ListGameServerGroupsOutput;
