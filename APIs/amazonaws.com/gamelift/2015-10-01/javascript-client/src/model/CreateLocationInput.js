...
/**
 * The CreateLocationInput model module.
 * @module model/CreateLocationInput
 * @version 2015-10-01
 */
class CreateLocationInput {
    /**
     * Constructs a new <code>CreateLocationInput</code>.
     * @alias module:model/CreateLocationInput
     * @param locationName {String} 
     */
    constructor(locationName) { 
        
        CreateLocationInput.initialize(this, locationName);
    }
    ...
    /**
     * Constructs a <code>CreateLocationInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateLocationInput} obj Optional instance to populate.
     * @return {module:model/CreateLocationInput} The populated <code>CreateLocationInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateLocationInput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateLocationInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateLocationInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateLocationInput.RequiredProperties) {
...
CreateLocationInput.RequiredProperties = ["LocationName"];

/**
 * @member {String} LocationName
 */
CreateLocationInput.prototype['LocationName'] = undefined;

/**
 * @member {Array} Tags
 */
CreateLocationInput.prototype['Tags'] = undefined;
...
export default CreateLocationInput;
