...
import GetComputeAccessOutputCredentials from './GetComputeAccessOutputCredentials';

/**
 * The GetComputeAccessOutput model module.
 * @module model/GetComputeAccessOutput
 * @version 2015-10-01
 */
class GetComputeAccessOutput {
    /**
     * Constructs a new <code>GetComputeAccessOutput</code>.
     * @alias module:model/GetComputeAccessOutput
     */
    constructor() { 
        
        GetComputeAccessOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetComputeAccessOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetComputeAccessOutput} obj Optional instance to populate.
     * @return {module:model/GetComputeAccessOutput} The populated <code>GetComputeAccessOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetComputeAccessOutput();
            ...
            if (data.hasOwnProperty('Credentials')) {
                obj['Credentials'] = GetComputeAccessOutputCredentials.constructFromObject(data['Credentials']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetComputeAccessOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetComputeAccessOutput</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Credentials']) { // data not null
          GetComputeAccessOutputCredentials.validateJSON(data['Credentials']);
        }
 ...
 */
GetComputeAccessOutput.prototype['FleetId'] = undefined;

/**
 * @member {String} FleetArn
 */
GetComputeAccessOutput.prototype['FleetArn'] = undefined;

/**
 * @member {String} ComputeName
 */
GetComputeAccessOutput.prototype['ComputeName'] = undefined;

/**
 * @member {String} ComputeArn
 */
GetComputeAccessOutput.prototype['ComputeArn'] = undefined;

/**
 * @member {module:model/GetComputeAccessOutputCredentials} Credentials
 */
GetComputeAccessOutput.prototype['Credentials'] = undefined;
...
export default GetComputeAccessOutput;
