...
/**
 * The DescribeMatchmakingOutput model module.
 * @module model/DescribeMatchmakingOutput
 * @version 2015-10-01
 */
class DescribeMatchmakingOutput {
    /**
     * Constructs a new <code>DescribeMatchmakingOutput</code>.
     * @alias module:model/DescribeMatchmakingOutput
     */
    constructor() { 
        
        DescribeMatchmakingOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeMatchmakingOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeMatchmakingOutput} obj Optional instance to populate.
     * @return {module:model/DescribeMatchmakingOutput} The populated <code>DescribeMatchmakingOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeMatchmakingOutput();

            if (data.hasOwnProperty('TicketList')) {
                obj['TicketList'] = ApiClient.convertToType(data['TicketList'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeMatchmakingOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeMatchmakingOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `TicketList`
        if (data['TicketList']) { // data not null
          Array.validateJSON(data['TicketList']);
        }
...
/**
 * @member {Array} TicketList
 */
DescribeMatchmakingOutput.prototype['TicketList'] = undefined;
...
export default DescribeMatchmakingOutput;
