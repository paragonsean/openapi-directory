...
* @readonly
*/
export default class ComputeStatus {
    ...
    /**
    * Returns a <code>ComputeStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ComputeStatus} The enum <code>ComputeStatus</code> value.
    */
