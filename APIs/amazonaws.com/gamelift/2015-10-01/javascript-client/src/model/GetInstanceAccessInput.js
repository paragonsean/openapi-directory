...
/**
 * The GetInstanceAccessInput model module.
 * @module model/GetInstanceAccessInput
 * @version 2015-10-01
 */
class GetInstanceAccessInput {
    /**
     * Constructs a new <code>GetInstanceAccessInput</code>.
     * @alias module:model/GetInstanceAccessInput
     * @param fleetId {String} 
     * @param instanceId {String} 
     */
    constructor(fleetId, instanceId) { 
        
        GetInstanceAccessInput.initialize(this, fleetId, instanceId);
    }
     ...
     */
    static initialize(obj, fleetId, instanceId) { 
        obj['FleetId'] = fleetId;
        obj['InstanceId'] = instanceId;
    }

    /**
     * Constructs a <code>GetInstanceAccessInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetInstanceAccessInput} obj Optional instance to populate.
     * @return {module:model/GetInstanceAccessInput} The populated <code>GetInstanceAccessInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetInstanceAccessInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetInstanceAccessInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetInstanceAccessInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetInstanceAccessInput.RequiredProperties) {
...
GetInstanceAccessInput.RequiredProperties = ["FleetId", "InstanceId"];

/**
 * @member {String} FleetId
 */
GetInstanceAccessInput.prototype['FleetId'] = undefined;

/**
 * @member {String} InstanceId
 */
GetInstanceAccessInput.prototype['InstanceId'] = undefined;
...
export default GetInstanceAccessInput;
