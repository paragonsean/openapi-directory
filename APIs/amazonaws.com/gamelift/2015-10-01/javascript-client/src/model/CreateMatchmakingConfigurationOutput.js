...
import CreateMatchmakingConfigurationOutputConfiguration from './CreateMatchmakingConfigurationOutputConfiguration';

/**
 * The CreateMatchmakingConfigurationOutput model module.
 * @module model/CreateMatchmakingConfigurationOutput
 * @version 2015-10-01
 */
class CreateMatchmakingConfigurationOutput {
    /**
     * Constructs a new <code>CreateMatchmakingConfigurationOutput</code>.
     * @alias module:model/CreateMatchmakingConfigurationOutput
     */
    constructor() { 
        
        CreateMatchmakingConfigurationOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateMatchmakingConfigurationOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateMatchmakingConfigurationOutput} obj Optional instance to populate.
     * @return {module:model/CreateMatchmakingConfigurationOutput} The populated <code>CreateMatchmakingConfigurationOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateMatchmakingConfigurationOutput();

            if (data.hasOwnProperty('Configuration')) {
                obj['Configuration'] = CreateMatchmakingConfigurationOutputConfiguration.constructFromObject(data['Configuration']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateMatchmakingConfigurationOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateMatchmakingConfigurationOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Configuration`
        if (data['Configuration']) { // data not null
          CreateMatchmakingConfigurationOutputConfiguration.validateJSON(data['Configuration']);
        }
...
/**
 * @member {module:model/CreateMatchmakingConfigurationOutputConfiguration} Configuration
 */
CreateMatchmakingConfigurationOutput.prototype['Configuration'] = undefined;
...
export default CreateMatchmakingConfigurationOutput;
