...
import DescribeFleetLocationCapacityOutputFleetCapacity from './DescribeFleetLocationCapacityOutputFleetCapacity';

/**
 * The DescribeFleetLocationCapacityOutput model module.
 * @module model/DescribeFleetLocationCapacityOutput
 * @version 2015-10-01
 */
class DescribeFleetLocationCapacityOutput {
    /**
     * Constructs a new <code>DescribeFleetLocationCapacityOutput</code>.
     * @alias module:model/DescribeFleetLocationCapacityOutput
     */
    constructor() { 
        
        DescribeFleetLocationCapacityOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeFleetLocationCapacityOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeFleetLocationCapacityOutput} obj Optional instance to populate.
     * @return {module:model/DescribeFleetLocationCapacityOutput} The populated <code>DescribeFleetLocationCapacityOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeFleetLocationCapacityOutput();

            if (data.hasOwnProperty('FleetCapacity')) {
                obj['FleetCapacity'] = DescribeFleetLocationCapacityOutputFleetCapacity.constructFromObject(data['FleetCapacity']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeFleetLocationCapacityOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeFleetLocationCapacityOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `FleetCapacity`
        if (data['FleetCapacity']) { // data not null
          DescribeFleetLocationCapacityOutputFleetCapacity.validateJSON(data['FleetCapacity']);
        }
...
/**
 * @member {module:model/DescribeFleetLocationCapacityOutputFleetCapacity} FleetCapacity
 */
DescribeFleetLocationCapacityOutput.prototype['FleetCapacity'] = undefined;
...
export default DescribeFleetLocationCapacityOutput;
