...
/**
 * The RequestUploadCredentialsOutputUploadCredentials model module.
 * @module model/RequestUploadCredentialsOutputUploadCredentials
 * @version 2015-10-01
 */
class RequestUploadCredentialsOutputUploadCredentials {
    /**
     * Constructs a new <code>RequestUploadCredentialsOutputUploadCredentials</code>.
     * @alias module:model/RequestUploadCredentialsOutputUploadCredentials
     * @implements module:model/AwsCredentials
     */
    constructor() { 
        AwsCredentials.initialize(this);
        RequestUploadCredentialsOutputUploadCredentials.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RequestUploadCredentialsOutputUploadCredentials</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RequestUploadCredentialsOutputUploadCredentials} obj Optional instance to populate.
     * @return {module:model/RequestUploadCredentialsOutputUploadCredentials} The populated <code>RequestUploadCredentialsOutputUploadCredentials</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RequestUploadCredentialsOutputUploadCredentials();
    ...
    /**
     * Validates the JSON data with respect to <code>RequestUploadCredentialsOutputUploadCredentials</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RequestUploadCredentialsOutputUploadCredentials</code>.
     */
 ...
 */
RequestUploadCredentialsOutputUploadCredentials.prototype['AccessKeyId'] = undefined;

/**
 * @member {String} SecretAccessKey
 */
RequestUploadCredentialsOutputUploadCredentials.prototype['SecretAccessKey'] = undefined;

/**
 * @member {String} SessionToken
 */
RequestUploadCredentialsOutputUploadCredentials.prototype['SessionToken'] = undefined;
...
export default RequestUploadCredentialsOutputUploadCredentials;
