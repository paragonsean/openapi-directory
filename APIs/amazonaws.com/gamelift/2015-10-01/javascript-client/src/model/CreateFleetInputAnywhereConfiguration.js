...
/**
 * The CreateFleetInputAnywhereConfiguration model module.
 * @module model/CreateFleetInputAnywhereConfiguration
 * @version 2015-10-01
 */
class CreateFleetInputAnywhereConfiguration {
    /**
     * Constructs a new <code>CreateFleetInputAnywhereConfiguration</code>.
     * @alias module:model/CreateFleetInputAnywhereConfiguration
     * @implements module:model/AnywhereConfiguration
     * @param cost {String} 
     */
    constructor(cost) { 
        AnywhereConfiguration.initialize(this, cost);
        CreateFleetInputAnywhereConfiguration.initialize(this, cost);
    }
    ...
    /**
     * Constructs a <code>CreateFleetInputAnywhereConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateFleetInputAnywhereConfiguration} obj Optional instance to populate.
     * @return {module:model/CreateFleetInputAnywhereConfiguration} The populated <code>CreateFleetInputAnywhereConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateFleetInputAnywhereConfiguration();
            AnywhereConfiguration.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFleetInputAnywhereConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFleetInputAnywhereConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateFleetInputAnywhereConfiguration.RequiredProperties) {
...
CreateFleetInputAnywhereConfiguration.RequiredProperties = ["Cost"];

/**
 * @member {String} Cost
 */
CreateFleetInputAnywhereConfiguration.prototype['Cost'] = undefined;


// Implement AnywhereConfiguration interface:
/**
 * @member {String} Cost
 */
AnywhereConfiguration.prototype['Cost'] = undefined;




export default CreateFleetInputAnywhereConfiguration;
