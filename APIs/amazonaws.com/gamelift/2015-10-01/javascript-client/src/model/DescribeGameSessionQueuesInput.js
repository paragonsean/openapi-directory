...
/**
 * The DescribeGameSessionQueuesInput model module.
 * @module model/DescribeGameSessionQueuesInput
 * @version 2015-10-01
 */
class DescribeGameSessionQueuesInput {
    /**
     * Constructs a new <code>DescribeGameSessionQueuesInput</code>.
     * @alias module:model/DescribeGameSessionQueuesInput
     */
    constructor() { 
        
        DescribeGameSessionQueuesInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeGameSessionQueuesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeGameSessionQueuesInput} obj Optional instance to populate.
     * @return {module:model/DescribeGameSessionQueuesInput} The populated <code>DescribeGameSessionQueuesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeGameSessionQueuesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeGameSessionQueuesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeGameSessionQueuesInput</code>.
     */
 ...
 * @member {Array} Names
 */
DescribeGameSessionQueuesInput.prototype['Names'] = undefined;

/**
 * @member {Number} Limit
 */
DescribeGameSessionQueuesInput.prototype['Limit'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeGameSessionQueuesInput.prototype['NextToken'] = undefined;
...
export default DescribeGameSessionQueuesInput;
