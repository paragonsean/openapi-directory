...
/**
 * The CreateFleetLocationsInput model module.
 * @module model/CreateFleetLocationsInput
 * @version 2015-10-01
 */
class CreateFleetLocationsInput {
    /**
     * Constructs a new <code>CreateFleetLocationsInput</code>.
     * @alias module:model/CreateFleetLocationsInput
     * @param fleetId {String} 
     * @param locations {Array} 
     */
    constructor(fleetId, locations) { 
        
        CreateFleetLocationsInput.initialize(this, fleetId, locations);
    }
    ...
    /**
     * Constructs a <code>CreateFleetLocationsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateFleetLocationsInput} obj Optional instance to populate.
     * @return {module:model/CreateFleetLocationsInput} The populated <code>CreateFleetLocationsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateFleetLocationsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFleetLocationsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFleetLocationsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateFleetLocationsInput.RequiredProperties) {
...
CreateFleetLocationsInput.RequiredProperties = ["FleetId", "Locations"];

/**
 * @member {String} FleetId
 */
CreateFleetLocationsInput.prototype['FleetId'] = undefined;

/**
 * @member {Array} Locations
 */
CreateFleetLocationsInput.prototype['Locations'] = undefined;
...
export default CreateFleetLocationsInput;
