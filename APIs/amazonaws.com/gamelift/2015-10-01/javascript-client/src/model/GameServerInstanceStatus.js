...
* @readonly
*/
export default class GameServerInstanceStatus {
    ...
    /**
    * Returns a <code>GameServerInstanceStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/GameServerInstanceStatus} The enum <code>GameServerInstanceStatus</code> value.
    */
