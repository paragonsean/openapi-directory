...
import UpdateRuntimeConfigurationInputRuntimeConfiguration from './UpdateRuntimeConfigurationInputRuntimeConfiguration';

/**
 * The UpdateRuntimeConfigurationInput model module.
 * @module model/UpdateRuntimeConfigurationInput
 * @version 2015-10-01
 */
class UpdateRuntimeConfigurationInput {
    /**
     * Constructs a new <code>UpdateRuntimeConfigurationInput</code>.
     * @alias module:model/UpdateRuntimeConfigurationInput
     * @param fleetId {String} 
     * @param runtimeConfiguration {module:model/UpdateRuntimeConfigurationInputRuntimeConfiguration} 
     */
    constructor(fleetId, runtimeConfiguration) { 
        
        UpdateRuntimeConfigurationInput.initialize(this, fleetId, runtimeConfiguration);
    }
     ...
     */
    static initialize(obj, fleetId, runtimeConfiguration) { 
        obj['FleetId'] = fleetId;
        obj['RuntimeConfiguration'] = runtimeConfiguration;
    }

    /**
     * Constructs a <code>UpdateRuntimeConfigurationInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateRuntimeConfigurationInput} obj Optional instance to populate.
     * @return {module:model/UpdateRuntimeConfigurationInput} The populated <code>UpdateRuntimeConfigurationInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateRuntimeConfigurationInput();
            ...
            if (data.hasOwnProperty('RuntimeConfiguration')) {
                obj['RuntimeConfiguration'] = UpdateRuntimeConfigurationInputRuntimeConfiguration.constructFromObject(data['RuntimeConfiguration']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateRuntimeConfigurationInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateRuntimeConfigurationInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateRuntimeConfigurationInput.RequiredProperties) {
        ...
        if (data['RuntimeConfiguration']) { // data not null
          UpdateRuntimeConfigurationInputRuntimeConfiguration.validateJSON(data['RuntimeConfiguration']);
        }
...
UpdateRuntimeConfigurationInput.RequiredProperties = ["FleetId", "RuntimeConfiguration"];

/**
 * @member {String} FleetId
 */
UpdateRuntimeConfigurationInput.prototype['FleetId'] = undefined;

/**
 * @member {module:model/UpdateRuntimeConfigurationInputRuntimeConfiguration} RuntimeConfiguration
 */
UpdateRuntimeConfigurationInput.prototype['RuntimeConfiguration'] = undefined;
...
export default UpdateRuntimeConfigurationInput;
