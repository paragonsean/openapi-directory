...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeGameServerOutput();
  });
  ...
  describe('DescribeGameServerOutput', function() {
    it('should create an instance of DescribeGameServerOutput', function() {
      // uncomment below and update the code to test DescribeGameServerOutput
      //var instance = new AmazonGameLift.DescribeGameServerOutput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeGameServerOutput);
    });

    it('should have the property gameServer (base name: "GameServer")', function() {
      // uncomment below and update the code to test the property gameServer
      //var instance = new AmazonGameLift.DescribeGameServerOutput();
