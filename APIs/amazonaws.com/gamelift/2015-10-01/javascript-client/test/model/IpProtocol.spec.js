...
(function(root, factory) {
  ...
  describe('IpProtocol', function() {
    it('should create an instance of IpProtocol', function() {
      // uncomment below and update the code to test IpProtocol
      //var instance = new AmazonGameLift.IpProtocol();
      //expect(instance).to.be.a(AmazonGameLift.IpProtocol);
    });
