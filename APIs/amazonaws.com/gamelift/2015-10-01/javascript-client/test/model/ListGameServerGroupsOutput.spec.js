...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.ListGameServerGroupsOutput();
  });
  ...
  describe('ListGameServerGroupsOutput', function() {
    it('should create an instance of ListGameServerGroupsOutput', function() {
      // uncomment below and update the code to test ListGameServerGroupsOutput
      //var instance = new AmazonGameLift.ListGameServerGroupsOutput();
      //expect(instance).to.be.a(AmazonGameLift.ListGameServerGroupsOutput);
    });

    it('should have the property gameServerGroups (base name: "GameServerGroups")', function() {
      // uncomment below and update the code to test the property gameServerGroups
      //var instance = new AmazonGameLift.ListGameServerGroupsOutput();
