...
(function(root, factory) {
  ...
  describe('GameSessionPlacementState', function() {
    it('should create an instance of GameSessionPlacementState', function() {
      // uncomment below and update the code to test GameSessionPlacementState
      //var instance = new AmazonGameLift.GameSessionPlacementState();
      //expect(instance).to.be.a(AmazonGameLift.GameSessionPlacementState);
    });
