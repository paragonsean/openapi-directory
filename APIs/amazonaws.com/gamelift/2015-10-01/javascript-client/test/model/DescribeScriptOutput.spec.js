...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeScriptOutput();
  });
  ...
  describe('DescribeScriptOutput', function() {
    it('should create an instance of DescribeScriptOutput', function() {
      // uncomment below and update the code to test DescribeScriptOutput
      //var instance = new AmazonGameLift.DescribeScriptOutput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeScriptOutput);
    });
