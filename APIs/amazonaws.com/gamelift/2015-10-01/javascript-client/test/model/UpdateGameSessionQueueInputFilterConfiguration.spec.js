...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateGameSessionQueueInputFilterConfiguration();
  });
  ...
  describe('UpdateGameSessionQueueInputFilterConfiguration', function() {
    it('should create an instance of UpdateGameSessionQueueInputFilterConfiguration', function() {
      // uncomment below and update the code to test UpdateGameSessionQueueInputFilterConfiguration
      //var instance = new AmazonGameLift.UpdateGameSessionQueueInputFilterConfiguration();
      //expect(instance).to.be.a(AmazonGameLift.UpdateGameSessionQueueInputFilterConfiguration);
    });
