...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.RequestUploadCredentialsOutputUploadCredentials();
  });
  ...
  describe('RequestUploadCredentialsOutputUploadCredentials', function() {
    it('should create an instance of RequestUploadCredentialsOutputUploadCredentials', function() {
      // uncomment below and update the code to test RequestUploadCredentialsOutputUploadCredentials
      //var instance = new AmazonGameLift.RequestUploadCredentialsOutputUploadCredentials();
      //expect(instance).to.be.a(AmazonGameLift.RequestUploadCredentialsOutputUploadCredentials);
    });
