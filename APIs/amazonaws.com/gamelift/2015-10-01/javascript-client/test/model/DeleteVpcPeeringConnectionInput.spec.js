...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DeleteVpcPeeringConnectionInput();
  });
  ...
  describe('DeleteVpcPeeringConnectionInput', function() {
    it('should create an instance of DeleteVpcPeeringConnectionInput', function() {
      // uncomment below and update the code to test DeleteVpcPeeringConnectionInput
      //var instance = new AmazonGameLift.DeleteVpcPeeringConnectionInput();
      //expect(instance).to.be.a(AmazonGameLift.DeleteVpcPeeringConnectionInput);
    });
