...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.GameSessionQueueDestination();
  });
  ...
  describe('GameSessionQueueDestination', function() {
    it('should create an instance of GameSessionQueueDestination', function() {
      // uncomment below and update the code to test GameSessionQueueDestination
      //var instance = new AmazonGameLift.GameSessionQueueDestination();
      //expect(instance).to.be.a(AmazonGameLift.GameSessionQueueDestination);
    });
