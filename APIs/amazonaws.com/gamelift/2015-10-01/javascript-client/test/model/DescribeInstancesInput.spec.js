...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeInstancesInput();
  });
  ...
  describe('DescribeInstancesInput', function() {
    it('should create an instance of DescribeInstancesInput', function() {
      // uncomment below and update the code to test DescribeInstancesInput
      //var instance = new AmazonGameLift.DescribeInstancesInput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeInstancesInput);
    });
