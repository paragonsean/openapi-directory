...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeFleetAttributesInput();
  });
  ...
  describe('DescribeFleetAttributesInput', function() {
    it('should create an instance of DescribeFleetAttributesInput', function() {
      // uncomment below and update the code to test DescribeFleetAttributesInput
      //var instance = new AmazonGameLift.DescribeFleetAttributesInput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeFleetAttributesInput);
    });
