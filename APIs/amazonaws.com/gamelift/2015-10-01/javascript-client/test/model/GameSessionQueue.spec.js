...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.GameSessionQueue();
  });
  ...
  describe('GameSessionQueue', function() {
    it('should create an instance of GameSessionQueue', function() {
      // uncomment below and update the code to test GameSessionQueue
      //var instance = new AmazonGameLift.GameSessionQueue();
      //expect(instance).to.be.a(AmazonGameLift.GameSessionQueue);
    });
    ...
    it('should have the property gameSessionQueueArn (base name: "GameSessionQueueArn")', function() {
      // uncomment below and update the code to test the property gameSessionQueueArn
      //var instance = new AmazonGameLift.GameSessionQueue();
      //expect(instance).to.be();
    });
    ...
    it('should have the property playerLatencyPolicies (base name: "PlayerLatencyPolicies")', function() {
      // uncomment below and update the code to test the property playerLatencyPolicies
      //var instance = new AmazonGameLift.GameSessionQueue();
      //expect(instance).to.be();
    });
    ...
    it('should have the property filterConfiguration (base name: "FilterConfiguration")', function() {
      // uncomment below and update the code to test the property filterConfiguration
      //var instance = new AmazonGameLift.GameSessionQueue();
      //expect(instance).to.be();
    });

    it('should have the property priorityConfiguration (base name: "PriorityConfiguration")', function() {
      // uncomment below and update the code to test the property priorityConfiguration
      //var instance = new AmazonGameLift.GameSessionQueue();
      //expect(instance).to.be();
    });
