...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeRuntimeConfigurationOutput();
  });
  ...
  describe('DescribeRuntimeConfigurationOutput', function() {
    it('should create an instance of DescribeRuntimeConfigurationOutput', function() {
      // uncomment below and update the code to test DescribeRuntimeConfigurationOutput
      //var instance = new AmazonGameLift.DescribeRuntimeConfigurationOutput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeRuntimeConfigurationOutput);
    });
