...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateFleetAttributesInput();
  });
  ...
  describe('UpdateFleetAttributesInput', function() {
    it('should create an instance of UpdateFleetAttributesInput', function() {
      // uncomment below and update the code to test UpdateFleetAttributesInput
      //var instance = new AmazonGameLift.UpdateFleetAttributesInput();
      //expect(instance).to.be.a(AmazonGameLift.UpdateFleetAttributesInput);
    });
