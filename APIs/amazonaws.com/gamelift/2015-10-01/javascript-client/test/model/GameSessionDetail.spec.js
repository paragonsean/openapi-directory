...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.GameSessionDetail();
  });
  ...
  describe('GameSessionDetail', function() {
    it('should create an instance of GameSessionDetail', function() {
      // uncomment below and update the code to test GameSessionDetail
      //var instance = new AmazonGameLift.GameSessionDetail();
      //expect(instance).to.be.a(AmazonGameLift.GameSessionDetail);
    });
