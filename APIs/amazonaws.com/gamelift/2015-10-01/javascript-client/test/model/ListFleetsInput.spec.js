...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.ListFleetsInput();
  });
  ...
  describe('ListFleetsInput', function() {
    it('should create an instance of ListFleetsInput', function() {
      // uncomment below and update the code to test ListFleetsInput
      //var instance = new AmazonGameLift.ListFleetsInput();
      //expect(instance).to.be.a(AmazonGameLift.ListFleetsInput);
    });
