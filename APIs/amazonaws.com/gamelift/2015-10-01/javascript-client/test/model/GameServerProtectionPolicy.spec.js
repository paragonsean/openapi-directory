...
(function(root, factory) {
  ...
  describe('GameServerProtectionPolicy', function() {
    it('should create an instance of GameServerProtectionPolicy', function() {
      // uncomment below and update the code to test GameServerProtectionPolicy
      //var instance = new AmazonGameLift.GameServerProtectionPolicy();
      //expect(instance).to.be.a(AmazonGameLift.GameServerProtectionPolicy);
    });
