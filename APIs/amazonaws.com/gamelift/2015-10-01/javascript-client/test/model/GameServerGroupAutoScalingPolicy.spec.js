...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.GameServerGroupAutoScalingPolicy();
  });
  ...
  describe('GameServerGroupAutoScalingPolicy', function() {
    it('should create an instance of GameServerGroupAutoScalingPolicy', function() {
      // uncomment below and update the code to test GameServerGroupAutoScalingPolicy
      //var instance = new AmazonGameLift.GameServerGroupAutoScalingPolicy();
      //expect(instance).to.be.a(AmazonGameLift.GameServerGroupAutoScalingPolicy);
    });
