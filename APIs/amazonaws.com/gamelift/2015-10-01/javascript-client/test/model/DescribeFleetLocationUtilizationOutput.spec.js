...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeFleetLocationUtilizationOutput();
  });
  ...
  describe('DescribeFleetLocationUtilizationOutput', function() {
    it('should create an instance of DescribeFleetLocationUtilizationOutput', function() {
      // uncomment below and update the code to test DescribeFleetLocationUtilizationOutput
      //var instance = new AmazonGameLift.DescribeFleetLocationUtilizationOutput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeFleetLocationUtilizationOutput);
    });
