...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.LocationAttributes();
  });
  ...
  describe('LocationAttributes', function() {
    it('should create an instance of LocationAttributes', function() {
      // uncomment below and update the code to test LocationAttributes
      //var instance = new AmazonGameLift.LocationAttributes();
      //expect(instance).to.be.a(AmazonGameLift.LocationAttributes);
    });
