...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeFleetPortSettingsInput();
  });
  ...
  describe('DescribeFleetPortSettingsInput', function() {
    it('should create an instance of DescribeFleetPortSettingsInput', function() {
      // uncomment below and update the code to test DescribeFleetPortSettingsInput
      //var instance = new AmazonGameLift.DescribeFleetPortSettingsInput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeFleetPortSettingsInput);
    });
