...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.ListGameServersOutput();
  });
  ...
  describe('ListGameServersOutput', function() {
    it('should create an instance of ListGameServersOutput', function() {
      // uncomment below and update the code to test ListGameServersOutput
      //var instance = new AmazonGameLift.ListGameServersOutput();
      //expect(instance).to.be.a(AmazonGameLift.ListGameServersOutput);
    });

    it('should have the property gameServers (base name: "GameServers")', function() {
      // uncomment below and update the code to test the property gameServers
      //var instance = new AmazonGameLift.ListGameServersOutput();
