...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateLocationInput();
  });
  ...
  describe('CreateLocationInput', function() {
    it('should create an instance of CreateLocationInput', function() {
      // uncomment below and update the code to test CreateLocationInput
      //var instance = new AmazonGameLift.CreateLocationInput();
      //expect(instance).to.be.a(AmazonGameLift.CreateLocationInput);
    });
