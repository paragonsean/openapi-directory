...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.ListBuildsOutput();
  });
  ...
  describe('ListBuildsOutput', function() {
    it('should create an instance of ListBuildsOutput', function() {
      // uncomment below and update the code to test ListBuildsOutput
      //var instance = new AmazonGameLift.ListBuildsOutput();
      //expect(instance).to.be.a(AmazonGameLift.ListBuildsOutput);
    });
