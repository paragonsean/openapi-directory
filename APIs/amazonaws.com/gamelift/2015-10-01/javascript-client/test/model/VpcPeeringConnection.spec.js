...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.VpcPeeringConnection();
  });
  ...
  describe('VpcPeeringConnection', function() {
    it('should create an instance of VpcPeeringConnection', function() {
      // uncomment below and update the code to test VpcPeeringConnection
      //var instance = new AmazonGameLift.VpcPeeringConnection();
      //expect(instance).to.be.a(AmazonGameLift.VpcPeeringConnection);
    });
    ...
    it('should have the property ipV4CidrBlock (base name: "IpV4CidrBlock")', function() {
      // uncomment below and update the code to test the property ipV4CidrBlock
      //var instance = new AmazonGameLift.VpcPeeringConnection();
      //expect(instance).to.be();
    });
    ...
    it('should have the property gameLiftVpcId (base name: "GameLiftVpcId")', function() {
      // uncomment below and update the code to test the property gameLiftVpcId
      //var instance = new AmazonGameLift.VpcPeeringConnection();
      //expect(instance).to.be();
    });
