...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateGameSessionQueueInput();
  });
  ...
  describe('CreateGameSessionQueueInput', function() {
    it('should create an instance of CreateGameSessionQueueInput', function() {
      // uncomment below and update the code to test CreateGameSessionQueueInput
      //var instance = new AmazonGameLift.CreateGameSessionQueueInput();
      //expect(instance).to.be.a(AmazonGameLift.CreateGameSessionQueueInput);
    });
