...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeMatchmakingOutput();
  });
  ...
  describe('DescribeMatchmakingOutput', function() {
    it('should create an instance of DescribeMatchmakingOutput', function() {
      // uncomment below and update the code to test DescribeMatchmakingOutput
      //var instance = new AmazonGameLift.DescribeMatchmakingOutput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeMatchmakingOutput);
    });

    it('should have the property ticketList (base name: "TicketList")', function() {
      // uncomment below and update the code to test the property ticketList
      //var instance = new AmazonGameLift.DescribeMatchmakingOutput();
