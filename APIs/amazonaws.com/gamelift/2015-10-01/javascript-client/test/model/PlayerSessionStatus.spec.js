...
(function(root, factory) {
  ...
  describe('PlayerSessionStatus', function() {
    it('should create an instance of PlayerSessionStatus', function() {
      // uncomment below and update the code to test PlayerSessionStatus
      //var instance = new AmazonGameLift.PlayerSessionStatus();
      //expect(instance).to.be.a(AmazonGameLift.PlayerSessionStatus);
    });
