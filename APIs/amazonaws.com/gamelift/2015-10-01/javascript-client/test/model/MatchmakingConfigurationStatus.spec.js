...
(function(root, factory) {
  ...
  describe('MatchmakingConfigurationStatus', function() {
    it('should create an instance of MatchmakingConfigurationStatus', function() {
      // uncomment below and update the code to test MatchmakingConfigurationStatus
      //var instance = new AmazonGameLift.MatchmakingConfigurationStatus();
      //expect(instance).to.be.a(AmazonGameLift.MatchmakingConfigurationStatus);
    });
