...
(function(root, factory) {
  ...
  describe('BuildStatus', function() {
    it('should create an instance of BuildStatus', function() {
      // uncomment below and update the code to test BuildStatus
      //var instance = new AmazonGameLift.BuildStatus();
      //expect(instance).to.be.a(AmazonGameLift.BuildStatus);
    });
