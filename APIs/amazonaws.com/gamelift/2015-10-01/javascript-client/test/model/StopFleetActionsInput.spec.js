...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.StopFleetActionsInput();
  });
  ...
  describe('StopFleetActionsInput', function() {
    it('should create an instance of StopFleetActionsInput', function() {
      // uncomment below and update the code to test StopFleetActionsInput
      //var instance = new AmazonGameLift.StopFleetActionsInput();
      //expect(instance).to.be.a(AmazonGameLift.StopFleetActionsInput);
    });
