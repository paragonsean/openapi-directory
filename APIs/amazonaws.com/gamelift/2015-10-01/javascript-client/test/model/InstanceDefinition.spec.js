...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.InstanceDefinition();
  });
  ...
  describe('InstanceDefinition', function() {
    it('should create an instance of InstanceDefinition', function() {
      // uncomment below and update the code to test InstanceDefinition
      //var instance = new AmazonGameLift.InstanceDefinition();
      //expect(instance).to.be.a(AmazonGameLift.InstanceDefinition);
    });
