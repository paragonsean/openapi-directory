...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DeleteFleetInput();
  });
  ...
  describe('DeleteFleetInput', function() {
    it('should create an instance of DeleteFleetInput', function() {
      // uncomment below and update the code to test DeleteFleetInput
      //var instance = new AmazonGameLift.DeleteFleetInput();
      //expect(instance).to.be.a(AmazonGameLift.DeleteFleetInput);
    });
