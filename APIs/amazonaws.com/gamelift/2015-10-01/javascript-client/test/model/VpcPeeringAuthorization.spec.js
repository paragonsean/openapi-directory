...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.VpcPeeringAuthorization();
  });
  ...
  describe('VpcPeeringAuthorization', function() {
    it('should create an instance of VpcPeeringAuthorization', function() {
      // uncomment below and update the code to test VpcPeeringAuthorization
      //var instance = new AmazonGameLift.VpcPeeringAuthorization();
      //expect(instance).to.be.a(AmazonGameLift.VpcPeeringAuthorization);
    });
