...
(function(root, factory) {
  ...
  describe('GameServerUtilizationStatus', function() {
    it('should create an instance of GameServerUtilizationStatus', function() {
      // uncomment below and update the code to test GameServerUtilizationStatus
      //var instance = new AmazonGameLift.GameServerUtilizationStatus();
      //expect(instance).to.be.a(AmazonGameLift.GameServerUtilizationStatus);
    });
