...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.SearchGameSessionsOutput();
  });
  ...
  describe('SearchGameSessionsOutput', function() {
    it('should create an instance of SearchGameSessionsOutput', function() {
      // uncomment below and update the code to test SearchGameSessionsOutput
      //var instance = new AmazonGameLift.SearchGameSessionsOutput();
      //expect(instance).to.be.a(AmazonGameLift.SearchGameSessionsOutput);
    });
