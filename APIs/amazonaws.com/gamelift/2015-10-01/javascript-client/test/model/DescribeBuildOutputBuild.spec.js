...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeBuildOutputBuild();
  });
  ...
  describe('DescribeBuildOutputBuild', function() {
    it('should create an instance of DescribeBuildOutputBuild', function() {
      // uncomment below and update the code to test DescribeBuildOutputBuild
      //var instance = new AmazonGameLift.DescribeBuildOutputBuild();
      //expect(instance).to.be.a(AmazonGameLift.DescribeBuildOutputBuild);
    });
