...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeGameServerInput();
  });
  ...
  describe('DescribeGameServerInput', function() {
    it('should create an instance of DescribeGameServerInput', function() {
      // uncomment below and update the code to test DescribeGameServerInput
      //var instance = new AmazonGameLift.DescribeGameServerInput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeGameServerInput);
    });
