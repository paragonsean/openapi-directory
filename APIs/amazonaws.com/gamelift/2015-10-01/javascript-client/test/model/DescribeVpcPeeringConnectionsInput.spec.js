...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeVpcPeeringConnectionsInput();
  });
  ...
  describe('DescribeVpcPeeringConnectionsInput', function() {
    it('should create an instance of DescribeVpcPeeringConnectionsInput', function() {
      // uncomment below and update the code to test DescribeVpcPeeringConnectionsInput
      //var instance = new AmazonGameLift.DescribeVpcPeeringConnectionsInput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeVpcPeeringConnectionsInput);
    });
