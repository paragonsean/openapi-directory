...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CertificateConfiguration();
  });
  ...
  describe('CertificateConfiguration', function() {
    it('should create an instance of CertificateConfiguration', function() {
      ...
      //var instance = new AmazonGameLift.CertificateConfiguration();
      //expect(instance).to.be.a(AmazonGameLift.CertificateConfiguration);
    });
