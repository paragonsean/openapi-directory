...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.AwsCredentials();
  });
  ...
  describe('AwsCredentials', function() {
    it('should create an instance of AwsCredentials', function() {
      // uncomment below and update the code to test AwsCredentials
      //var instance = new AmazonGameLift.AwsCredentials();
      //expect(instance).to.be.a(AmazonGameLift.AwsCredentials);
    });
