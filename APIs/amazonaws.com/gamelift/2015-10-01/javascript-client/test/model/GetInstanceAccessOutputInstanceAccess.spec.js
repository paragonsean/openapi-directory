...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.GetInstanceAccessOutputInstanceAccess();
  });
  ...
  describe('GetInstanceAccessOutputInstanceAccess', function() {
    it('should create an instance of GetInstanceAccessOutputInstanceAccess', function() {
      // uncomment below and update the code to test GetInstanceAccessOutputInstanceAccess
      //var instance = new AmazonGameLift.GetInstanceAccessOutputInstanceAccess();
      //expect(instance).to.be.a(AmazonGameLift.GetInstanceAccessOutputInstanceAccess);
    });
