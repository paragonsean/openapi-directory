...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AmazonGameLift.TagResourceRequest();
      //expect(instance).to.be.a(AmazonGameLift.TagResourceRequest);
    });
