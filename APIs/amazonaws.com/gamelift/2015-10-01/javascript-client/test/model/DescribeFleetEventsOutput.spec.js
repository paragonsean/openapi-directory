...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeFleetEventsOutput();
  });
  ...
  describe('DescribeFleetEventsOutput', function() {
    it('should create an instance of DescribeFleetEventsOutput', function() {
      // uncomment below and update the code to test DescribeFleetEventsOutput
      //var instance = new AmazonGameLift.DescribeFleetEventsOutput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeFleetEventsOutput);
    });
