...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeFleetLocationCapacityOutput();
  });
  ...
  describe('DescribeFleetLocationCapacityOutput', function() {
    it('should create an instance of DescribeFleetLocationCapacityOutput', function() {
      // uncomment below and update the code to test DescribeFleetLocationCapacityOutput
      //var instance = new AmazonGameLift.DescribeFleetLocationCapacityOutput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeFleetLocationCapacityOutput);
    });

    it('should have the property fleetCapacity (base name: "FleetCapacity")', function() {
      // uncomment below and update the code to test the property fleetCapacity
      //var instance = new AmazonGameLift.DescribeFleetLocationCapacityOutput();
