...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateBuildOutputBuild();
  });
  ...
  describe('UpdateBuildOutputBuild', function() {
    it('should create an instance of UpdateBuildOutputBuild', function() {
      // uncomment below and update the code to test UpdateBuildOutputBuild
      //var instance = new AmazonGameLift.UpdateBuildOutputBuild();
      //expect(instance).to.be.a(AmazonGameLift.UpdateBuildOutputBuild);
    });
