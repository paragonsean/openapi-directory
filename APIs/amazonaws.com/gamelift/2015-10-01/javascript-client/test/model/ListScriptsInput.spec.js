...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.ListScriptsInput();
  });
  ...
  describe('ListScriptsInput', function() {
    it('should create an instance of ListScriptsInput', function() {
      // uncomment below and update the code to test ListScriptsInput
      //var instance = new AmazonGameLift.ListScriptsInput();
      //expect(instance).to.be.a(AmazonGameLift.ListScriptsInput);
    });
