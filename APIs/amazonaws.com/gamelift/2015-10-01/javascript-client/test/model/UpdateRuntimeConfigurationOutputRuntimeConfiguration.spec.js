...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateRuntimeConfigurationOutputRuntimeConfiguration();
  });
  ...
  describe('UpdateRuntimeConfigurationOutputRuntimeConfiguration', function() {
    it('should create an instance of UpdateRuntimeConfigurationOutputRuntimeConfiguration', function() {
      // uncomment below and update the code to test UpdateRuntimeConfigurationOutputRuntimeConfiguration
      //var instance = new AmazonGameLift.UpdateRuntimeConfigurationOutputRuntimeConfiguration();
      //expect(instance).to.be.a(AmazonGameLift.UpdateRuntimeConfigurationOutputRuntimeConfiguration);
    });

    it('should have the property serverProcesses (base name: "ServerProcesses")', function() {
      // uncomment below and update the code to test the property serverProcesses
      //var instance = new AmazonGameLift.UpdateRuntimeConfigurationOutputRuntimeConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property maxConcurrentGameSessionActivations (base name: "MaxConcurrentGameSessionActivations")', function() {
      // uncomment below and update the code to test the property maxConcurrentGameSessionActivations
      //var instance = new AmazonGameLift.UpdateRuntimeConfigurationOutputRuntimeConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property gameSessionActivationTimeoutSeconds (base name: "GameSessionActivationTimeoutSeconds")', function() {
      // uncomment below and update the code to test the property gameSessionActivationTimeoutSeconds
      //var instance = new AmazonGameLift.UpdateRuntimeConfigurationOutputRuntimeConfiguration();
      //expect(instance).to.be();
    });
