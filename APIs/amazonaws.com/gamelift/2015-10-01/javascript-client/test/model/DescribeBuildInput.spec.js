...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeBuildInput();
  });
  ...
  describe('DescribeBuildInput', function() {
    it('should create an instance of DescribeBuildInput', function() {
      // uncomment below and update the code to test DescribeBuildInput
      //var instance = new AmazonGameLift.DescribeBuildInput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeBuildInput);
    });
