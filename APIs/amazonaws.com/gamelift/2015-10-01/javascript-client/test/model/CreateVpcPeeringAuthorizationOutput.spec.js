...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateVpcPeeringAuthorizationOutput();
  });
  ...
  describe('CreateVpcPeeringAuthorizationOutput', function() {
    it('should create an instance of CreateVpcPeeringAuthorizationOutput', function() {
      // uncomment below and update the code to test CreateVpcPeeringAuthorizationOutput
      //var instance = new AmazonGameLift.CreateVpcPeeringAuthorizationOutput();
      //expect(instance).to.be.a(AmazonGameLift.CreateVpcPeeringAuthorizationOutput);
    });

    it('should have the property vpcPeeringAuthorization (base name: "VpcPeeringAuthorization")', function() {
      // uncomment below and update the code to test the property vpcPeeringAuthorization
      //var instance = new AmazonGameLift.CreateVpcPeeringAuthorizationOutput();
