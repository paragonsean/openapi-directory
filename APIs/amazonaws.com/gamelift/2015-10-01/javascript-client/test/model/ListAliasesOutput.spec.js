...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.ListAliasesOutput();
  });
  ...
  describe('ListAliasesOutput', function() {
    it('should create an instance of ListAliasesOutput', function() {
      // uncomment below and update the code to test ListAliasesOutput
      //var instance = new AmazonGameLift.ListAliasesOutput();
      //expect(instance).to.be.a(AmazonGameLift.ListAliasesOutput);
    });
