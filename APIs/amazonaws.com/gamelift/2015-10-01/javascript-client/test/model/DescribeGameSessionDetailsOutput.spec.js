...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeGameSessionDetailsOutput();
  });
  ...
  describe('DescribeGameSessionDetailsOutput', function() {
    it('should create an instance of DescribeGameSessionDetailsOutput', function() {
      // uncomment below and update the code to test DescribeGameSessionDetailsOutput
      //var instance = new AmazonGameLift.DescribeGameSessionDetailsOutput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeGameSessionDetailsOutput);
    });

    it('should have the property gameSessionDetails (base name: "GameSessionDetails")', function() {
      // uncomment below and update the code to test the property gameSessionDetails
      //var instance = new AmazonGameLift.DescribeGameSessionDetailsOutput();
