...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.EC2InstanceCounts();
  });
  ...
  describe('EC2InstanceCounts', function() {
    it('should create an instance of EC2InstanceCounts', function() {
      // uncomment below and update the code to test EC2InstanceCounts
      //var instance = new AmazonGameLift.EC2InstanceCounts();
      //expect(instance).to.be.a(AmazonGameLift.EC2InstanceCounts);
    });
