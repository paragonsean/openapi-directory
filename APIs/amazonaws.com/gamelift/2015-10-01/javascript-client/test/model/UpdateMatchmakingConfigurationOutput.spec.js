...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateMatchmakingConfigurationOutput();
  });
  ...
  describe('UpdateMatchmakingConfigurationOutput', function() {
    it('should create an instance of UpdateMatchmakingConfigurationOutput', function() {
      // uncomment below and update the code to test UpdateMatchmakingConfigurationOutput
      //var instance = new AmazonGameLift.UpdateMatchmakingConfigurationOutput();
      //expect(instance).to.be.a(AmazonGameLift.UpdateMatchmakingConfigurationOutput);
    });
