...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeGameSessionDetailsInput();
  });
  ...
  describe('DescribeGameSessionDetailsInput', function() {
    it('should create an instance of DescribeGameSessionDetailsInput', function() {
      // uncomment below and update the code to test DescribeGameSessionDetailsInput
      //var instance = new AmazonGameLift.DescribeGameSessionDetailsInput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeGameSessionDetailsInput);
    });
