...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeGameSessionsOutput();
  });
  ...
  describe('DescribeGameSessionsOutput', function() {
    it('should create an instance of DescribeGameSessionsOutput', function() {
      // uncomment below and update the code to test DescribeGameSessionsOutput
      //var instance = new AmazonGameLift.DescribeGameSessionsOutput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeGameSessionsOutput);
    });

    it('should have the property gameSessions (base name: "GameSessions")', function() {
      // uncomment below and update the code to test the property gameSessions
      //var instance = new AmazonGameLift.DescribeGameSessionsOutput();
