...
(function(root, factory) {
  ...
  describe('PlayerSessionCreationPolicy', function() {
    it('should create an instance of PlayerSessionCreationPolicy', function() {
      // uncomment below and update the code to test PlayerSessionCreationPolicy
      //var instance = new AmazonGameLift.PlayerSessionCreationPolicy();
      //expect(instance).to.be.a(AmazonGameLift.PlayerSessionCreationPolicy);
    });
