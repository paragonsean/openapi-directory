...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.ListGameServerGroupsInput();
  });
  ...
  describe('ListGameServerGroupsInput', function() {
    it('should create an instance of ListGameServerGroupsInput', function() {
      // uncomment below and update the code to test ListGameServerGroupsInput
      //var instance = new AmazonGameLift.ListGameServerGroupsInput();
      //expect(instance).to.be.a(AmazonGameLift.ListGameServerGroupsInput);
    });
