...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.ListLocationsOutput();
  });
  ...
  describe('ListLocationsOutput', function() {
    it('should create an instance of ListLocationsOutput', function() {
      // uncomment below and update the code to test ListLocationsOutput
      //var instance = new AmazonGameLift.ListLocationsOutput();
      //expect(instance).to.be.a(AmazonGameLift.ListLocationsOutput);
    });
