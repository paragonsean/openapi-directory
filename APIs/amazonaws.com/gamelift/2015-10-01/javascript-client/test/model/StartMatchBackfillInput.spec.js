...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.StartMatchBackfillInput();
  });
  ...
  describe('StartMatchBackfillInput', function() {
    it('should create an instance of StartMatchBackfillInput', function() {
      // uncomment below and update the code to test StartMatchBackfillInput
      //var instance = new AmazonGameLift.StartMatchBackfillInput();
      //expect(instance).to.be.a(AmazonGameLift.StartMatchBackfillInput);
    });
