...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.ResumeGameServerGroupInput();
  });
  ...
  describe('ResumeGameServerGroupInput', function() {
    it('should create an instance of ResumeGameServerGroupInput', function() {
      // uncomment below and update the code to test ResumeGameServerGroupInput
      //var instance = new AmazonGameLift.ResumeGameServerGroupInput();
      //expect(instance).to.be.a(AmazonGameLift.ResumeGameServerGroupInput);
    });
    ...
    it('should have the property resumeActions (base name: "ResumeActions")', function() {
      // uncomment below and update the code to test the property resumeActions
      //var instance = new AmazonGameLift.ResumeGameServerGroupInput();
      //expect(instance).to.be();
    });
