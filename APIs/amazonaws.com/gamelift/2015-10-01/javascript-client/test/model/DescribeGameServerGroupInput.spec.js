...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeGameServerGroupInput();
  });
  ...
  describe('DescribeGameServerGroupInput', function() {
    it('should create an instance of DescribeGameServerGroupInput', function() {
      // uncomment below and update the code to test DescribeGameServerGroupInput
      //var instance = new AmazonGameLift.DescribeGameServerGroupInput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeGameServerGroupInput);
    });
