...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeFleetUtilizationOutput();
  });
  ...
  describe('DescribeFleetUtilizationOutput', function() {
    it('should create an instance of DescribeFleetUtilizationOutput', function() {
      // uncomment below and update the code to test DescribeFleetUtilizationOutput
      //var instance = new AmazonGameLift.DescribeFleetUtilizationOutput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeFleetUtilizationOutput);
    });

    it('should have the property fleetUtilization (base name: "FleetUtilization")', function() {
      // uncomment below and update the code to test the property fleetUtilization
      //var instance = new AmazonGameLift.DescribeFleetUtilizationOutput();
