...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateFleetAttributesOutput();
  });
  ...
  describe('UpdateFleetAttributesOutput', function() {
    it('should create an instance of UpdateFleetAttributesOutput', function() {
      // uncomment below and update the code to test UpdateFleetAttributesOutput
      //var instance = new AmazonGameLift.UpdateFleetAttributesOutput();
      //expect(instance).to.be.a(AmazonGameLift.UpdateFleetAttributesOutput);
    });
