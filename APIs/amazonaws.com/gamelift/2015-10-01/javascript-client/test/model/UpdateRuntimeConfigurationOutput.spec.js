...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateRuntimeConfigurationOutput();
  });
  ...
  describe('UpdateRuntimeConfigurationOutput', function() {
    it('should create an instance of UpdateRuntimeConfigurationOutput', function() {
      // uncomment below and update the code to test UpdateRuntimeConfigurationOutput
      //var instance = new AmazonGameLift.UpdateRuntimeConfigurationOutput();
      //expect(instance).to.be.a(AmazonGameLift.UpdateRuntimeConfigurationOutput);
    });
