...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.FleetCapacity();
  });
  ...
  describe('FleetCapacity', function() {
    it('should create an instance of FleetCapacity', function() {
      // uncomment below and update the code to test FleetCapacity
      //var instance = new AmazonGameLift.FleetCapacity();
      //expect(instance).to.be.a(AmazonGameLift.FleetCapacity);
    });
