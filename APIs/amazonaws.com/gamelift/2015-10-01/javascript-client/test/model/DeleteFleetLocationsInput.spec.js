...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DeleteFleetLocationsInput();
  });
  ...
  describe('DeleteFleetLocationsInput', function() {
    it('should create an instance of DeleteFleetLocationsInput', function() {
      // uncomment below and update the code to test DeleteFleetLocationsInput
      //var instance = new AmazonGameLift.DeleteFleetLocationsInput();
      //expect(instance).to.be.a(AmazonGameLift.DeleteFleetLocationsInput);
    });
