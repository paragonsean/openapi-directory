...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.GameServerGroup();
  });
  ...
  describe('GameServerGroup', function() {
    it('should create an instance of GameServerGroup', function() {
      // uncomment below and update the code to test GameServerGroup
      //var instance = new AmazonGameLift.GameServerGroup();
      //expect(instance).to.be.a(AmazonGameLift.GameServerGroup);
    });
