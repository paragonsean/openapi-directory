...
(function(root, factory) {
  ...
  describe('ScalingStatusType', function() {
    it('should create an instance of ScalingStatusType', function() {
      // uncomment below and update the code to test ScalingStatusType
      //var instance = new AmazonGameLift.ScalingStatusType();
      //expect(instance).to.be.a(AmazonGameLift.ScalingStatusType);
    });
