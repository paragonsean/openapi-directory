...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.GameServer();
  });
  ...
  describe('GameServer', function() {
    it('should create an instance of GameServer', function() {
      // uncomment below and update the code to test GameServer
      //var instance = new AmazonGameLift.GameServer();
      //expect(instance).to.be.a(AmazonGameLift.GameServer);
    });
