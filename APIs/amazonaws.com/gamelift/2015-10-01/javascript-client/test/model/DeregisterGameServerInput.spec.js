...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DeregisterGameServerInput();
  });
  ...
  describe('DeregisterGameServerInput', function() {
    it('should create an instance of DeregisterGameServerInput', function() {
      // uncomment below and update the code to test DeregisterGameServerInput
      //var instance = new AmazonGameLift.DeregisterGameServerInput();
      //expect(instance).to.be.a(AmazonGameLift.DeregisterGameServerInput);
    });
