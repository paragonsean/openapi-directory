...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.GetGameSessionLogUrlInput();
  });
  ...
  describe('GetGameSessionLogUrlInput', function() {
    it('should create an instance of GetGameSessionLogUrlInput', function() {
      // uncomment below and update the code to test GetGameSessionLogUrlInput
      //var instance = new AmazonGameLift.GetGameSessionLogUrlInput();
      //expect(instance).to.be.a(AmazonGameLift.GetGameSessionLogUrlInput);
    });
