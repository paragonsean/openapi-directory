...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DeleteGameServerGroupInput();
  });
  ...
  describe('DeleteGameServerGroupInput', function() {
    it('should create an instance of DeleteGameServerGroupInput', function() {
      // uncomment below and update the code to test DeleteGameServerGroupInput
      //var instance = new AmazonGameLift.DeleteGameServerGroupInput();
      //expect(instance).to.be.a(AmazonGameLift.DeleteGameServerGroupInput);
    });
    ...
    it('should have the property deleteOption (base name: "DeleteOption")', function() {
      // uncomment below and update the code to test the property deleteOption
      //var instance = new AmazonGameLift.DeleteGameServerGroupInput();
      //expect(instance).to.be();
    });
