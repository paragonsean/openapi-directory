...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeGameSessionPlacementOutput();
  });
  ...
  describe('DescribeGameSessionPlacementOutput', function() {
    it('should create an instance of DescribeGameSessionPlacementOutput', function() {
      // uncomment below and update the code to test DescribeGameSessionPlacementOutput
      //var instance = new AmazonGameLift.DescribeGameSessionPlacementOutput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeGameSessionPlacementOutput);
    });

    it('should have the property gameSessionPlacement (base name: "GameSessionPlacement")', function() {
      // uncomment below and update the code to test the property gameSessionPlacement
      //var instance = new AmazonGameLift.DescribeGameSessionPlacementOutput();
