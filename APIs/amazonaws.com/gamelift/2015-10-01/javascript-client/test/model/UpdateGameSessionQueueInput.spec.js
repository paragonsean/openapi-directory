...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateGameSessionQueueInput();
  });
  ...
  describe('UpdateGameSessionQueueInput', function() {
    it('should create an instance of UpdateGameSessionQueueInput', function() {
      // uncomment below and update the code to test UpdateGameSessionQueueInput
      //var instance = new AmazonGameLift.UpdateGameSessionQueueInput();
      //expect(instance).to.be.a(AmazonGameLift.UpdateGameSessionQueueInput);
    });
