...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeFleetLocationAttributesInput();
  });
  ...
  describe('DescribeFleetLocationAttributesInput', function() {
    it('should create an instance of DescribeFleetLocationAttributesInput', function() {
      // uncomment below and update the code to test DescribeFleetLocationAttributesInput
      //var instance = new AmazonGameLift.DescribeFleetLocationAttributesInput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeFleetLocationAttributesInput);
    });
