...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DeleteGameServerGroupOutput();
  });
  ...
  describe('DeleteGameServerGroupOutput', function() {
    it('should create an instance of DeleteGameServerGroupOutput', function() {
      // uncomment below and update the code to test DeleteGameServerGroupOutput
      //var instance = new AmazonGameLift.DeleteGameServerGroupOutput();
      //expect(instance).to.be.a(AmazonGameLift.DeleteGameServerGroupOutput);
    });
