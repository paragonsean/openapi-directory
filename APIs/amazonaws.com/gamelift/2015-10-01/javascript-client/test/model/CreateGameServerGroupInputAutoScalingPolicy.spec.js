...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateGameServerGroupInputAutoScalingPolicy();
  });
  ...
  describe('CreateGameServerGroupInputAutoScalingPolicy', function() {
    it('should create an instance of CreateGameServerGroupInputAutoScalingPolicy', function() {
      // uncomment below and update the code to test CreateGameServerGroupInputAutoScalingPolicy
      //var instance = new AmazonGameLift.CreateGameServerGroupInputAutoScalingPolicy();
      //expect(instance).to.be.a(AmazonGameLift.CreateGameServerGroupInputAutoScalingPolicy);
    });
