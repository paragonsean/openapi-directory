...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeGameSessionsInput();
  });
  ...
  describe('DescribeGameSessionsInput', function() {
    it('should create an instance of DescribeGameSessionsInput', function() {
      // uncomment below and update the code to test DescribeGameSessionsInput
      //var instance = new AmazonGameLift.DescribeGameSessionsInput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeGameSessionsInput);
    });
