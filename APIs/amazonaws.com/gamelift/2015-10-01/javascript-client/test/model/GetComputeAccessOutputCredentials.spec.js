...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.GetComputeAccessOutputCredentials();
  });
  ...
  describe('GetComputeAccessOutputCredentials', function() {
    it('should create an instance of GetComputeAccessOutputCredentials', function() {
      // uncomment below and update the code to test GetComputeAccessOutputCredentials
      //var instance = new AmazonGameLift.GetComputeAccessOutputCredentials();
      //expect(instance).to.be.a(AmazonGameLift.GetComputeAccessOutputCredentials);
    });
