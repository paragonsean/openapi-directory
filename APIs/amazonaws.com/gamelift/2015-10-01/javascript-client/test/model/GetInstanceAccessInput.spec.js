...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.GetInstanceAccessInput();
  });
  ...
  describe('GetInstanceAccessInput', function() {
    it('should create an instance of GetInstanceAccessInput', function() {
      // uncomment below and update the code to test GetInstanceAccessInput
      //var instance = new AmazonGameLift.GetInstanceAccessInput();
      //expect(instance).to.be.a(AmazonGameLift.GetInstanceAccessInput);
    });
