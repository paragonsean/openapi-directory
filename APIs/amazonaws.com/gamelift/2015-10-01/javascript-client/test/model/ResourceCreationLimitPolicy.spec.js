...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.ResourceCreationLimitPolicy();
  });
  ...
  describe('ResourceCreationLimitPolicy', function() {
    it('should create an instance of ResourceCreationLimitPolicy', function() {
      // uncomment below and update the code to test ResourceCreationLimitPolicy
      //var instance = new AmazonGameLift.ResourceCreationLimitPolicy();
      //expect(instance).to.be.a(AmazonGameLift.ResourceCreationLimitPolicy);
    });
