...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.GetGameSessionLogUrlOutput();
  });
  ...
  describe('GetGameSessionLogUrlOutput', function() {
    it('should create an instance of GetGameSessionLogUrlOutput', function() {
      // uncomment below and update the code to test GetGameSessionLogUrlOutput
      //var instance = new AmazonGameLift.GetGameSessionLogUrlOutput();
      //expect(instance).to.be.a(AmazonGameLift.GetGameSessionLogUrlOutput);
    });
