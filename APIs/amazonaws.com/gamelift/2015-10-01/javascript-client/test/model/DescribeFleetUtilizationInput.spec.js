...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeFleetUtilizationInput();
  });
  ...
  describe('DescribeFleetUtilizationInput', function() {
    it('should create an instance of DescribeFleetUtilizationInput', function() {
      // uncomment below and update the code to test DescribeFleetUtilizationInput
      //var instance = new AmazonGameLift.DescribeFleetUtilizationInput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeFleetUtilizationInput);
    });

    it('should have the property fleetIds (base name: "FleetIds")', function() {
      // uncomment below and update the code to test the property fleetIds
      //var instance = new AmazonGameLift.DescribeFleetUtilizationInput();
