...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreatePlayerSessionInput();
  });
  ...
  describe('CreatePlayerSessionInput', function() {
    it('should create an instance of CreatePlayerSessionInput', function() {
      // uncomment below and update the code to test CreatePlayerSessionInput
      //var instance = new AmazonGameLift.CreatePlayerSessionInput();
      //expect(instance).to.be.a(AmazonGameLift.CreatePlayerSessionInput);
    });
