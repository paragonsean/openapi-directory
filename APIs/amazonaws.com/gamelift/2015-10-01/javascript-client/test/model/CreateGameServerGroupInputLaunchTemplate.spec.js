...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateGameServerGroupInputLaunchTemplate();
  });
  ...
  describe('CreateGameServerGroupInputLaunchTemplate', function() {
    it('should create an instance of CreateGameServerGroupInputLaunchTemplate', function() {
      // uncomment below and update the code to test CreateGameServerGroupInputLaunchTemplate
      //var instance = new AmazonGameLift.CreateGameServerGroupInputLaunchTemplate();
      //expect(instance).to.be.a(AmazonGameLift.CreateGameServerGroupInputLaunchTemplate);
    });
