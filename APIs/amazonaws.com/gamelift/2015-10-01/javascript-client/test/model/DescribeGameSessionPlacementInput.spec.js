...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeGameSessionPlacementInput();
  });
  ...
  describe('DescribeGameSessionPlacementInput', function() {
    it('should create an instance of DescribeGameSessionPlacementInput', function() {
      // uncomment below and update the code to test DescribeGameSessionPlacementInput
      //var instance = new AmazonGameLift.DescribeGameSessionPlacementInput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeGameSessionPlacementInput);
    });
