...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeFleetCapacityInput();
  });
  ...
  describe('DescribeFleetCapacityInput', function() {
    it('should create an instance of DescribeFleetCapacityInput', function() {
      // uncomment below and update the code to test DescribeFleetCapacityInput
      //var instance = new AmazonGameLift.DescribeFleetCapacityInput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeFleetCapacityInput);
    });
