...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.MatchmakingRuleSet();
  });
  ...
  describe('MatchmakingRuleSet', function() {
    it('should create an instance of MatchmakingRuleSet', function() {
      // uncomment below and update the code to test MatchmakingRuleSet
      //var instance = new AmazonGameLift.MatchmakingRuleSet();
      //expect(instance).to.be.a(AmazonGameLift.MatchmakingRuleSet);
    });
