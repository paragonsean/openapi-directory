...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateScriptInputStorageLocation();
  });
  ...
  describe('CreateScriptInputStorageLocation', function() {
    it('should create an instance of CreateScriptInputStorageLocation', function() {
      // uncomment below and update the code to test CreateScriptInputStorageLocation
      //var instance = new AmazonGameLift.CreateScriptInputStorageLocation();
      //expect(instance).to.be.a(AmazonGameLift.CreateScriptInputStorageLocation);
    });
