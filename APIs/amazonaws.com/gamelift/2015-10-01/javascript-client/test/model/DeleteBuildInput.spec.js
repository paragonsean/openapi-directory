...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DeleteBuildInput();
  });
  ...
  describe('DeleteBuildInput', function() {
    it('should create an instance of DeleteBuildInput', function() {
      // uncomment below and update the code to test DeleteBuildInput
      //var instance = new AmazonGameLift.DeleteBuildInput();
      //expect(instance).to.be.a(AmazonGameLift.DeleteBuildInput);
    });
