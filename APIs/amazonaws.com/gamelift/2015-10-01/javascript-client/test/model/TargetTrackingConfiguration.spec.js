...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.TargetTrackingConfiguration();
  });
  ...
  describe('TargetTrackingConfiguration', function() {
    it('should create an instance of TargetTrackingConfiguration', function() {
      // uncomment below and update the code to test TargetTrackingConfiguration
      //var instance = new AmazonGameLift.TargetTrackingConfiguration();
      //expect(instance).to.be.a(AmazonGameLift.TargetTrackingConfiguration);
    });
