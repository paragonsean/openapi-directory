...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateAliasInputRoutingStrategy();
  });
  ...
  describe('CreateAliasInputRoutingStrategy', function() {
    it('should create an instance of CreateAliasInputRoutingStrategy', function() {
      // uncomment below and update the code to test CreateAliasInputRoutingStrategy
      //var instance = new AmazonGameLift.CreateAliasInputRoutingStrategy();
      //expect(instance).to.be.a(AmazonGameLift.CreateAliasInputRoutingStrategy);
    });
