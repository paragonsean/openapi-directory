...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeRuntimeConfigurationInput();
  });
  ...
  describe('DescribeRuntimeConfigurationInput', function() {
    it('should create an instance of DescribeRuntimeConfigurationInput', function() {
      // uncomment below and update the code to test DescribeRuntimeConfigurationInput
      //var instance = new AmazonGameLift.DescribeRuntimeConfigurationInput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeRuntimeConfigurationInput);
    });
