...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateLocationOutput();
  });
  ...
  describe('CreateLocationOutput', function() {
    it('should create an instance of CreateLocationOutput', function() {
      // uncomment below and update the code to test CreateLocationOutput
      //var instance = new AmazonGameLift.CreateLocationOutput();
      //expect(instance).to.be.a(AmazonGameLift.CreateLocationOutput);
    });
