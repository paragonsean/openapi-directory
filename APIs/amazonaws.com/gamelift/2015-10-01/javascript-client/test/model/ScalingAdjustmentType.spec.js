...
(function(root, factory) {
  ...
  describe('ScalingAdjustmentType', function() {
    it('should create an instance of ScalingAdjustmentType', function() {
      // uncomment below and update the code to test ScalingAdjustmentType
      //var instance = new AmazonGameLift.ScalingAdjustmentType();
      //expect(instance).to.be.a(AmazonGameLift.ScalingAdjustmentType);
    });
