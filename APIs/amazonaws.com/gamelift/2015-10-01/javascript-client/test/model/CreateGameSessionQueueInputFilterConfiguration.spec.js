...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateGameSessionQueueInputFilterConfiguration();
  });
  ...
  describe('CreateGameSessionQueueInputFilterConfiguration', function() {
    it('should create an instance of CreateGameSessionQueueInputFilterConfiguration', function() {
      // uncomment below and update the code to test CreateGameSessionQueueInputFilterConfiguration
      //var instance = new AmazonGameLift.CreateGameSessionQueueInputFilterConfiguration();
      //expect(instance).to.be.a(AmazonGameLift.CreateGameSessionQueueInputFilterConfiguration);
    });

    it('should have the property allowedLocations (base name: "AllowedLocations")', function() {
      // uncomment below and update the code to test the property allowedLocations
      //var instance = new AmazonGameLift.CreateGameSessionQueueInputFilterConfiguration();
