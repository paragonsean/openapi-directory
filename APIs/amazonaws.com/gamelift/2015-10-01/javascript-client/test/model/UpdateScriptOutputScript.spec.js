...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateScriptOutputScript();
  });
  ...
  describe('UpdateScriptOutputScript', function() {
    it('should create an instance of UpdateScriptOutputScript', function() {
      // uncomment below and update the code to test UpdateScriptOutputScript
      //var instance = new AmazonGameLift.UpdateScriptOutputScript();
      //expect(instance).to.be.a(AmazonGameLift.UpdateScriptOutputScript);
    });
