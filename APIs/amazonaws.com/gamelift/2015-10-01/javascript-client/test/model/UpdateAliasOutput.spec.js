...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateAliasOutput();
  });
  ...
  describe('UpdateAliasOutput', function() {
    it('should create an instance of UpdateAliasOutput', function() {
      // uncomment below and update the code to test UpdateAliasOutput
      //var instance = new AmazonGameLift.UpdateAliasOutput();
      //expect(instance).to.be.a(AmazonGameLift.UpdateAliasOutput);
    });
