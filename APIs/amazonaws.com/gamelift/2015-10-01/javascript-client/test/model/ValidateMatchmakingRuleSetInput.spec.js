...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.ValidateMatchmakingRuleSetInput();
  });
  ...
  describe('ValidateMatchmakingRuleSetInput', function() {
    it('should create an instance of ValidateMatchmakingRuleSetInput', function() {
      // uncomment below and update the code to test ValidateMatchmakingRuleSetInput
      //var instance = new AmazonGameLift.ValidateMatchmakingRuleSetInput();
      //expect(instance).to.be.a(AmazonGameLift.ValidateMatchmakingRuleSetInput);
    });
