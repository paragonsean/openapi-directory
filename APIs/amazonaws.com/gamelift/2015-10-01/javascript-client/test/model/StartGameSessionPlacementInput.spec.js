...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.StartGameSessionPlacementInput();
  });
  ...
  describe('StartGameSessionPlacementInput', function() {
    it('should create an instance of StartGameSessionPlacementInput', function() {
      // uncomment below and update the code to test StartGameSessionPlacementInput
      //var instance = new AmazonGameLift.StartGameSessionPlacementInput();
      //expect(instance).to.be.a(AmazonGameLift.StartGameSessionPlacementInput);
    });
    ...
    it('should have the property desiredPlayerSessions (base name: "DesiredPlayerSessions")', function() {
      // uncomment below and update the code to test the property desiredPlayerSessions
      //var instance = new AmazonGameLift.StartGameSessionPlacementInput();
      //expect(instance).to.be();
    });
