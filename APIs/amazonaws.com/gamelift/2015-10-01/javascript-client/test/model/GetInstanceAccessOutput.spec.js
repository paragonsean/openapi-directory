...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.GetInstanceAccessOutput();
  });
  ...
  describe('GetInstanceAccessOutput', function() {
    it('should create an instance of GetInstanceAccessOutput', function() {
      // uncomment below and update the code to test GetInstanceAccessOutput
      //var instance = new AmazonGameLift.GetInstanceAccessOutput();
      //expect(instance).to.be.a(AmazonGameLift.GetInstanceAccessOutput);
    });

    it('should have the property instanceAccess (base name: "InstanceAccess")', function() {
      // uncomment below and update the code to test the property instanceAccess
      //var instance = new AmazonGameLift.GetInstanceAccessOutput();
