...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.StartMatchBackfillOutput();
  });
  ...
  describe('StartMatchBackfillOutput', function() {
    it('should create an instance of StartMatchBackfillOutput', function() {
      // uncomment below and update the code to test StartMatchBackfillOutput
      //var instance = new AmazonGameLift.StartMatchBackfillOutput();
      //expect(instance).to.be.a(AmazonGameLift.StartMatchBackfillOutput);
    });

    it('should have the property matchmakingTicket (base name: "MatchmakingTicket")', function() {
      // uncomment below and update the code to test the property matchmakingTicket
      //var instance = new AmazonGameLift.StartMatchBackfillOutput();
