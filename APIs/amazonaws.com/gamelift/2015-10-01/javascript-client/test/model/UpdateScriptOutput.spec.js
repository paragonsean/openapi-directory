...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateScriptOutput();
  });
  ...
  describe('UpdateScriptOutput', function() {
    it('should create an instance of UpdateScriptOutput', function() {
      // uncomment below and update the code to test UpdateScriptOutput
      //var instance = new AmazonGameLift.UpdateScriptOutput();
      //expect(instance).to.be.a(AmazonGameLift.UpdateScriptOutput);
    });
