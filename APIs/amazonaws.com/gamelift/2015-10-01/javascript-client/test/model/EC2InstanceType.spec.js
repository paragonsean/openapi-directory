...
(function(root, factory) {
  ...
  describe('EC2InstanceType', function() {
    it('should create an instance of EC2InstanceType', function() {
      // uncomment below and update the code to test EC2InstanceType
      //var instance = new AmazonGameLift.EC2InstanceType();
      //expect(instance).to.be.a(AmazonGameLift.EC2InstanceType);
    });
