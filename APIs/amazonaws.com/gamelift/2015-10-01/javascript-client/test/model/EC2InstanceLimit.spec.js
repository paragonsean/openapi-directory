...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.EC2InstanceLimit();
  });
  ...
  describe('EC2InstanceLimit', function() {
    it('should create an instance of EC2InstanceLimit', function() {
      // uncomment below and update the code to test EC2InstanceLimit
      //var instance = new AmazonGameLift.EC2InstanceLimit();
      //expect(instance).to.be.a(AmazonGameLift.EC2InstanceLimit);
    });
    ...
    it('should have the property currentInstances (base name: "CurrentInstances")', function() {
      // uncomment below and update the code to test the property currentInstances
      //var instance = new AmazonGameLift.EC2InstanceLimit();
      //expect(instance).to.be();
    });

    it('should have the property instanceLimit (base name: "InstanceLimit")', function() {
      // uncomment below and update the code to test the property instanceLimit
      //var instance = new AmazonGameLift.EC2InstanceLimit();
      //expect(instance).to.be();
    });
