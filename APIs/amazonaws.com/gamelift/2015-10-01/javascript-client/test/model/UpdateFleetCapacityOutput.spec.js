...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateFleetCapacityOutput();
  });
  ...
  describe('UpdateFleetCapacityOutput', function() {
    it('should create an instance of UpdateFleetCapacityOutput', function() {
      // uncomment below and update the code to test UpdateFleetCapacityOutput
      //var instance = new AmazonGameLift.UpdateFleetCapacityOutput();
      //expect(instance).to.be.a(AmazonGameLift.UpdateFleetCapacityOutput);
    });
