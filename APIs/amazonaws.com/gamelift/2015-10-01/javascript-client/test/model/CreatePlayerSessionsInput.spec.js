...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreatePlayerSessionsInput();
  });
  ...
  describe('CreatePlayerSessionsInput', function() {
    it('should create an instance of CreatePlayerSessionsInput', function() {
      // uncomment below and update the code to test CreatePlayerSessionsInput
      //var instance = new AmazonGameLift.CreatePlayerSessionsInput();
      //expect(instance).to.be.a(AmazonGameLift.CreatePlayerSessionsInput);
    });
    ...
    it('should have the property playerDataMap (base name: "PlayerDataMap")', function() {
      // uncomment below and update the code to test the property playerDataMap
      //var instance = new AmazonGameLift.CreatePlayerSessionsInput();
      //expect(instance).to.be();
    });
