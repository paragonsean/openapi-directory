...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.PlayerLatencyPolicy();
  });
  ...
  describe('PlayerLatencyPolicy', function() {
    it('should create an instance of PlayerLatencyPolicy', function() {
      // uncomment below and update the code to test PlayerLatencyPolicy
      //var instance = new AmazonGameLift.PlayerLatencyPolicy();
      //expect(instance).to.be.a(AmazonGameLift.PlayerLatencyPolicy);
    });

    it('should have the property maximumIndividualPlayerLatencyMilliseconds (base name: "MaximumIndividualPlayerLatencyMilliseconds")', function() {
      // uncomment below and update the code to test the property maximumIndividualPlayerLatencyMilliseconds
      //var instance = new AmazonGameLift.PlayerLatencyPolicy();
      //expect(instance).to.be();
    });

    it('should have the property policyDurationSeconds (base name: "PolicyDurationSeconds")', function() {
      // uncomment below and update the code to test the property policyDurationSeconds
      //var instance = new AmazonGameLift.PlayerLatencyPolicy();
      //expect(instance).to.be();
    });
