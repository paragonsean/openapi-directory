...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.ListGameServersInput();
  });
  ...
  describe('ListGameServersInput', function() {
    it('should create an instance of ListGameServersInput', function() {
      // uncomment below and update the code to test ListGameServersInput
      //var instance = new AmazonGameLift.ListGameServersInput();
      //expect(instance).to.be.a(AmazonGameLift.ListGameServersInput);
    });
