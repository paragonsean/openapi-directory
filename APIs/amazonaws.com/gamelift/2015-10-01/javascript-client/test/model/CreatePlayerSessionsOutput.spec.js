...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreatePlayerSessionsOutput();
  });
  ...
  describe('CreatePlayerSessionsOutput', function() {
    it('should create an instance of CreatePlayerSessionsOutput', function() {
      // uncomment below and update the code to test CreatePlayerSessionsOutput
      //var instance = new AmazonGameLift.CreatePlayerSessionsOutput();
      //expect(instance).to.be.a(AmazonGameLift.CreatePlayerSessionsOutput);
    });
