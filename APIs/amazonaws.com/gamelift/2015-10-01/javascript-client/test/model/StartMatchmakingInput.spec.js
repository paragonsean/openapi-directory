...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.StartMatchmakingInput();
  });
  ...
  describe('StartMatchmakingInput', function() {
    it('should create an instance of StartMatchmakingInput', function() {
      // uncomment below and update the code to test StartMatchmakingInput
      //var instance = new AmazonGameLift.StartMatchmakingInput();
      //expect(instance).to.be.a(AmazonGameLift.StartMatchmakingInput);
    });
