...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.GameProperty();
  });
  ...
  describe('GameProperty', function() {
    it('should create an instance of GameProperty', function() {
      // uncomment below and update the code to test GameProperty
      //var instance = new AmazonGameLift.GameProperty();
      //expect(instance).to.be.a(AmazonGameLift.GameProperty);
    });
