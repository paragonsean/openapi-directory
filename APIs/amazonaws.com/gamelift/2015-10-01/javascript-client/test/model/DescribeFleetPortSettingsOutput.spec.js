...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeFleetPortSettingsOutput();
  });
  ...
  describe('DescribeFleetPortSettingsOutput', function() {
    it('should create an instance of DescribeFleetPortSettingsOutput', function() {
      // uncomment below and update the code to test DescribeFleetPortSettingsOutput
      //var instance = new AmazonGameLift.DescribeFleetPortSettingsOutput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeFleetPortSettingsOutput);
    });
    ...
    it('should have the property inboundPermissions (base name: "InboundPermissions")', function() {
      // uncomment below and update the code to test the property inboundPermissions
      //var instance = new AmazonGameLift.DescribeFleetPortSettingsOutput();
      //expect(instance).to.be();
    });
