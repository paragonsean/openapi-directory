...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.AnywhereConfiguration();
  });
  ...
  describe('AnywhereConfiguration', function() {
    it('should create an instance of AnywhereConfiguration', function() {
      // uncomment below and update the code to test AnywhereConfiguration
      //var instance = new AmazonGameLift.AnywhereConfiguration();
      //expect(instance).to.be.a(AmazonGameLift.AnywhereConfiguration);
    });
