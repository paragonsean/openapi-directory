...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateFleetInputResourceCreationLimitPolicy();
  });
  ...
  describe('CreateFleetInputResourceCreationLimitPolicy', function() {
    it('should create an instance of CreateFleetInputResourceCreationLimitPolicy', function() {
      // uncomment below and update the code to test CreateFleetInputResourceCreationLimitPolicy
      //var instance = new AmazonGameLift.CreateFleetInputResourceCreationLimitPolicy();
      //expect(instance).to.be.a(AmazonGameLift.CreateFleetInputResourceCreationLimitPolicy);
    });

    it('should have the property newGameSessionsPerCreator (base name: "NewGameSessionsPerCreator")', function() {
      // uncomment below and update the code to test the property newGameSessionsPerCreator
      //var instance = new AmazonGameLift.CreateFleetInputResourceCreationLimitPolicy();
      //expect(instance).to.be();
    });

    it('should have the property policyPeriodInMinutes (base name: "PolicyPeriodInMinutes")', function() {
      // uncomment below and update the code to test the property policyPeriodInMinutes
      //var instance = new AmazonGameLift.CreateFleetInputResourceCreationLimitPolicy();
      //expect(instance).to.be();
    });
