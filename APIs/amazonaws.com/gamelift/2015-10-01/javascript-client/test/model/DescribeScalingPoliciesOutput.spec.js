...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeScalingPoliciesOutput();
  });
  ...
  describe('DescribeScalingPoliciesOutput', function() {
    it('should create an instance of DescribeScalingPoliciesOutput', function() {
      // uncomment below and update the code to test DescribeScalingPoliciesOutput
      //var instance = new AmazonGameLift.DescribeScalingPoliciesOutput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeScalingPoliciesOutput);
    });
