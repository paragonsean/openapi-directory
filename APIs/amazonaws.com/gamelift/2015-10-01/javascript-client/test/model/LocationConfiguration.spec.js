...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.LocationConfiguration();
  });
  ...
  describe('LocationConfiguration', function() {
    it('should create an instance of LocationConfiguration', function() {
      // uncomment below and update the code to test LocationConfiguration
      //var instance = new AmazonGameLift.LocationConfiguration();
      //expect(instance).to.be.a(AmazonGameLift.LocationConfiguration);
    });
