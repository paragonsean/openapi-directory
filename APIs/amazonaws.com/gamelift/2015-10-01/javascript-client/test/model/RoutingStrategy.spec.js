...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.RoutingStrategy();
  });
  ...
  describe('RoutingStrategy', function() {
    it('should create an instance of RoutingStrategy', function() {
      // uncomment below and update the code to test RoutingStrategy
      //var instance = new AmazonGameLift.RoutingStrategy();
      //expect(instance).to.be.a(AmazonGameLift.RoutingStrategy);
    });
