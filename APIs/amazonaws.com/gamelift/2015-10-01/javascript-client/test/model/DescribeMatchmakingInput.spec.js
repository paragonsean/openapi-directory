...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeMatchmakingInput();
  });
  ...
  describe('DescribeMatchmakingInput', function() {
    it('should create an instance of DescribeMatchmakingInput', function() {
      // uncomment below and update the code to test DescribeMatchmakingInput
      //var instance = new AmazonGameLift.DescribeMatchmakingInput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeMatchmakingInput);
    });
