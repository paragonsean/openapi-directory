...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.TargetConfiguration();
  });
  ...
  describe('TargetConfiguration', function() {
    it('should create an instance of TargetConfiguration', function() {
      ...
      //var instance = new AmazonGameLift.TargetConfiguration();
      //expect(instance).to.be.a(AmazonGameLift.TargetConfiguration);
    });
