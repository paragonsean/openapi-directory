...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.ClaimGameServerOutputGameServer();
  });
  ...
  describe('ClaimGameServerOutputGameServer', function() {
    it('should create an instance of ClaimGameServerOutputGameServer', function() {
      // uncomment below and update the code to test ClaimGameServerOutputGameServer
      //var instance = new AmazonGameLift.ClaimGameServerOutputGameServer();
      //expect(instance).to.be.a(AmazonGameLift.ClaimGameServerOutputGameServer);
    });
