...
(function(root, factory) {
  ...
  describe('FlexMatchMode', function() {
    it('should create an instance of FlexMatchMode', function() {
      // uncomment below and update the code to test FlexMatchMode
      //var instance = new AmazonGameLift.FlexMatchMode();
      //expect(instance).to.be.a(AmazonGameLift.FlexMatchMode);
    });
