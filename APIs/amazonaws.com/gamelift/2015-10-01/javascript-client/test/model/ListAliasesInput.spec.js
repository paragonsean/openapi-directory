...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.ListAliasesInput();
  });
  ...
  describe('ListAliasesInput', function() {
    it('should create an instance of ListAliasesInput', function() {
      // uncomment below and update the code to test ListAliasesInput
      //var instance = new AmazonGameLift.ListAliasesInput();
      //expect(instance).to.be.a(AmazonGameLift.ListAliasesInput);
    });

    it('should have the property routingStrategyType (base name: "RoutingStrategyType")', function() {
      // uncomment below and update the code to test the property routingStrategyType
      //var instance = new AmazonGameLift.ListAliasesInput();
