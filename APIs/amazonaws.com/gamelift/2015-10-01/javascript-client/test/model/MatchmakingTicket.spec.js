...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.MatchmakingTicket();
  });
  ...
  describe('MatchmakingTicket', function() {
    it('should create an instance of MatchmakingTicket', function() {
      // uncomment below and update the code to test MatchmakingTicket
      //var instance = new AmazonGameLift.MatchmakingTicket();
      //expect(instance).to.be.a(AmazonGameLift.MatchmakingTicket);
    });
