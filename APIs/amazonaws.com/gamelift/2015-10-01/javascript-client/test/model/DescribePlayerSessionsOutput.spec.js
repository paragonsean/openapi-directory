...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribePlayerSessionsOutput();
  });
  ...
  describe('DescribePlayerSessionsOutput', function() {
    it('should create an instance of DescribePlayerSessionsOutput', function() {
      // uncomment below and update the code to test DescribePlayerSessionsOutput
      //var instance = new AmazonGameLift.DescribePlayerSessionsOutput();
      //expect(instance).to.be.a(AmazonGameLift.DescribePlayerSessionsOutput);
    });

    it('should have the property playerSessions (base name: "PlayerSessions")', function() {
      // uncomment below and update the code to test the property playerSessions
      //var instance = new AmazonGameLift.DescribePlayerSessionsOutput();
