...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribePlayerSessionsInput();
  });
  ...
  describe('DescribePlayerSessionsInput', function() {
    it('should create an instance of DescribePlayerSessionsInput', function() {
      // uncomment below and update the code to test DescribePlayerSessionsInput
      //var instance = new AmazonGameLift.DescribePlayerSessionsInput();
      //expect(instance).to.be.a(AmazonGameLift.DescribePlayerSessionsInput);
    });
    ...
    it('should have the property playerSessionStatusFilter (base name: "PlayerSessionStatusFilter")', function() {
      // uncomment below and update the code to test the property playerSessionStatusFilter
      //var instance = new AmazonGameLift.DescribePlayerSessionsInput();
      //expect(instance).to.be();
    });
