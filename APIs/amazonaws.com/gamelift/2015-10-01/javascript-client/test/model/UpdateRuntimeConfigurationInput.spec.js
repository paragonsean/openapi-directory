...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateRuntimeConfigurationInput();
  });
  ...
  describe('UpdateRuntimeConfigurationInput', function() {
    it('should create an instance of UpdateRuntimeConfigurationInput', function() {
      // uncomment below and update the code to test UpdateRuntimeConfigurationInput
      //var instance = new AmazonGameLift.UpdateRuntimeConfigurationInput();
      //expect(instance).to.be.a(AmazonGameLift.UpdateRuntimeConfigurationInput);
    });
