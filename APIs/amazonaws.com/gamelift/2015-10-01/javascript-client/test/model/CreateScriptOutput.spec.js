...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateScriptOutput();
  });
  ...
  describe('CreateScriptOutput', function() {
    it('should create an instance of CreateScriptOutput', function() {
      // uncomment below and update the code to test CreateScriptOutput
      //var instance = new AmazonGameLift.CreateScriptOutput();
      //expect(instance).to.be.a(AmazonGameLift.CreateScriptOutput);
    });
