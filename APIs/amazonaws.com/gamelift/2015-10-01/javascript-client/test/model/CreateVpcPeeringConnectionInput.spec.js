...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateVpcPeeringConnectionInput();
  });
  ...
  describe('CreateVpcPeeringConnectionInput', function() {
    it('should create an instance of CreateVpcPeeringConnectionInput', function() {
      // uncomment below and update the code to test CreateVpcPeeringConnectionInput
      //var instance = new AmazonGameLift.CreateVpcPeeringConnectionInput();
      //expect(instance).to.be.a(AmazonGameLift.CreateVpcPeeringConnectionInput);
    });
