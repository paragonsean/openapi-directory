...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.ResolveAliasOutput();
  });
  ...
  describe('ResolveAliasOutput', function() {
    it('should create an instance of ResolveAliasOutput', function() {
      // uncomment below and update the code to test ResolveAliasOutput
      //var instance = new AmazonGameLift.ResolveAliasOutput();
      //expect(instance).to.be.a(AmazonGameLift.ResolveAliasOutput);
    });
