...
(function(root, factory) {
  ...
  describe('ComputeStatus', function() {
    it('should create an instance of ComputeStatus', function() {
      // uncomment below and update the code to test ComputeStatus
      //var instance = new AmazonGameLift.ComputeStatus();
      //expect(instance).to.be.a(AmazonGameLift.ComputeStatus);
    });
