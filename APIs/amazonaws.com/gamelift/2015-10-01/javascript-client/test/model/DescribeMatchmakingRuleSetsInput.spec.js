...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeMatchmakingRuleSetsInput();
  });
  ...
  describe('DescribeMatchmakingRuleSetsInput', function() {
    it('should create an instance of DescribeMatchmakingRuleSetsInput', function() {
      // uncomment below and update the code to test DescribeMatchmakingRuleSetsInput
      //var instance = new AmazonGameLift.DescribeMatchmakingRuleSetsInput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeMatchmakingRuleSetsInput);
    });
