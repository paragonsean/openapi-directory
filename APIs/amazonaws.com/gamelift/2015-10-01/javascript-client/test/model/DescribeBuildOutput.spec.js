...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeBuildOutput();
  });
  ...
  describe('DescribeBuildOutput', function() {
    it('should create an instance of DescribeBuildOutput', function() {
      // uncomment below and update the code to test DescribeBuildOutput
      //var instance = new AmazonGameLift.DescribeBuildOutput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeBuildOutput);
    });
