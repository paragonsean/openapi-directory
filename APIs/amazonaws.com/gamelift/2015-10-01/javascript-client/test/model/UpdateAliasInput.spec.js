...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateAliasInput();
  });
  ...
  describe('UpdateAliasInput', function() {
    it('should create an instance of UpdateAliasInput', function() {
      // uncomment below and update the code to test UpdateAliasInput
      //var instance = new AmazonGameLift.UpdateAliasInput();
      //expect(instance).to.be.a(AmazonGameLift.UpdateAliasInput);
    });
