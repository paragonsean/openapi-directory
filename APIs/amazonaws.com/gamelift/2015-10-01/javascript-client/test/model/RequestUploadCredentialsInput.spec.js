...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.RequestUploadCredentialsInput();
  });
  ...
  describe('RequestUploadCredentialsInput', function() {
    it('should create an instance of RequestUploadCredentialsInput', function() {
      // uncomment below and update the code to test RequestUploadCredentialsInput
      //var instance = new AmazonGameLift.RequestUploadCredentialsInput();
      //expect(instance).to.be.a(AmazonGameLift.RequestUploadCredentialsInput);
    });
