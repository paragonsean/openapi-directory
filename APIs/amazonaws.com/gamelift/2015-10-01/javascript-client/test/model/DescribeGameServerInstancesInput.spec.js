...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeGameServerInstancesInput();
  });
  ...
  describe('DescribeGameServerInstancesInput', function() {
    it('should create an instance of DescribeGameServerInstancesInput', function() {
      // uncomment below and update the code to test DescribeGameServerInstancesInput
      //var instance = new AmazonGameLift.DescribeGameServerInstancesInput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeGameServerInstancesInput);
    });
