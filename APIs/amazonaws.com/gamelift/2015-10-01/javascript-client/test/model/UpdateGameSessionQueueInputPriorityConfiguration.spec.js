...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateGameSessionQueueInputPriorityConfiguration();
  });
  ...
  describe('UpdateGameSessionQueueInputPriorityConfiguration', function() {
    it('should create an instance of UpdateGameSessionQueueInputPriorityConfiguration', function() {
      // uncomment below and update the code to test UpdateGameSessionQueueInputPriorityConfiguration
      //var instance = new AmazonGameLift.UpdateGameSessionQueueInputPriorityConfiguration();
      //expect(instance).to.be.a(AmazonGameLift.UpdateGameSessionQueueInputPriorityConfiguration);
    });
