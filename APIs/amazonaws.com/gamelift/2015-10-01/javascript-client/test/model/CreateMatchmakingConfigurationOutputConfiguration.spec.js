...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateMatchmakingConfigurationOutputConfiguration();
  });
  ...
  describe('CreateMatchmakingConfigurationOutputConfiguration', function() {
    it('should create an instance of CreateMatchmakingConfigurationOutputConfiguration', function() {
      // uncomment below and update the code to test CreateMatchmakingConfigurationOutputConfiguration
      //var instance = new AmazonGameLift.CreateMatchmakingConfigurationOutputConfiguration();
      //expect(instance).to.be.a(AmazonGameLift.CreateMatchmakingConfigurationOutputConfiguration);
    });
