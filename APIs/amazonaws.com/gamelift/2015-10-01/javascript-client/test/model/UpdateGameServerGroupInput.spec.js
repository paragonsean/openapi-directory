...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateGameServerGroupInput();
  });
  ...
  describe('UpdateGameServerGroupInput', function() {
    it('should create an instance of UpdateGameServerGroupInput', function() {
      // uncomment below and update the code to test UpdateGameServerGroupInput
      //var instance = new AmazonGameLift.UpdateGameServerGroupInput();
      //expect(instance).to.be.a(AmazonGameLift.UpdateGameServerGroupInput);
    });
