...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DeleteScalingPolicyInput();
  });
  ...
  describe('DeleteScalingPolicyInput', function() {
    it('should create an instance of DeleteScalingPolicyInput', function() {
      // uncomment below and update the code to test DeleteScalingPolicyInput
      //var instance = new AmazonGameLift.DeleteScalingPolicyInput();
      //expect(instance).to.be.a(AmazonGameLift.DeleteScalingPolicyInput);
    });
