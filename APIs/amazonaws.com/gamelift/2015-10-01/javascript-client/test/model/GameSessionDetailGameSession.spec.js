...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.GameSessionDetailGameSession();
  });
  ...
  describe('GameSessionDetailGameSession', function() {
    it('should create an instance of GameSessionDetailGameSession', function() {
      // uncomment below and update the code to test GameSessionDetailGameSession
      //var instance = new AmazonGameLift.GameSessionDetailGameSession();
      //expect(instance).to.be.a(AmazonGameLift.GameSessionDetailGameSession);
    });
