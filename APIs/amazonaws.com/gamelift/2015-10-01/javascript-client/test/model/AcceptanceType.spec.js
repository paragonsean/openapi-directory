...
(function(root, factory) {
  ...
  describe('AcceptanceType', function() {
    it('should create an instance of AcceptanceType', function() {
      // uncomment below and update the code to test AcceptanceType
      //var instance = new AmazonGameLift.AcceptanceType();
      //expect(instance).to.be.a(AmazonGameLift.AcceptanceType);
    });
