...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DesiredPlayerSession();
  });
  ...
  describe('DesiredPlayerSession', function() {
    it('should create an instance of DesiredPlayerSession', function() {
      // uncomment below and update the code to test DesiredPlayerSession
      //var instance = new AmazonGameLift.DesiredPlayerSession();
      //expect(instance).to.be.a(AmazonGameLift.DesiredPlayerSession);
    });
