...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.VpcPeeringConnectionStatus();
  });
  ...
  describe('VpcPeeringConnectionStatus', function() {
    it('should create an instance of VpcPeeringConnectionStatus', function() {
      // uncomment below and update the code to test VpcPeeringConnectionStatus
      //var instance = new AmazonGameLift.VpcPeeringConnectionStatus();
      //expect(instance).to.be.a(AmazonGameLift.VpcPeeringConnectionStatus);
    });
