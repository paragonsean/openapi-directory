...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateMatchmakingConfigurationInput();
  });
  ...
  describe('UpdateMatchmakingConfigurationInput', function() {
    it('should create an instance of UpdateMatchmakingConfigurationInput', function() {
      // uncomment below and update the code to test UpdateMatchmakingConfigurationInput
      //var instance = new AmazonGameLift.UpdateMatchmakingConfigurationInput();
      //expect(instance).to.be.a(AmazonGameLift.UpdateMatchmakingConfigurationInput);
    });
