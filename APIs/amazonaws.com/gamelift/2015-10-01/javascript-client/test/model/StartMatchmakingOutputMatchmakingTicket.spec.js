...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.StartMatchmakingOutputMatchmakingTicket();
  });
  ...
  describe('StartMatchmakingOutputMatchmakingTicket', function() {
    it('should create an instance of StartMatchmakingOutputMatchmakingTicket', function() {
      // uncomment below and update the code to test StartMatchmakingOutputMatchmakingTicket
      //var instance = new AmazonGameLift.StartMatchmakingOutputMatchmakingTicket();
      //expect(instance).to.be.a(AmazonGameLift.StartMatchmakingOutputMatchmakingTicket);
    });
    ...
    it('should have the property gameSessionConnectionInfo (base name: "GameSessionConnectionInfo")', function() {
      // uncomment below and update the code to test the property gameSessionConnectionInfo
      //var instance = new AmazonGameLift.StartMatchmakingOutputMatchmakingTicket();
      //expect(instance).to.be();
    });

    it('should have the property estimatedWaitTime (base name: "EstimatedWaitTime")', function() {
      // uncomment below and update the code to test the property estimatedWaitTime
      //var instance = new AmazonGameLift.StartMatchmakingOutputMatchmakingTicket();
      //expect(instance).to.be();
    });
