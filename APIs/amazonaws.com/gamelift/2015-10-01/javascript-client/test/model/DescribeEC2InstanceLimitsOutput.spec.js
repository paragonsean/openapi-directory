...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeEC2InstanceLimitsOutput();
  });
  ...
  describe('DescribeEC2InstanceLimitsOutput', function() {
    it('should create an instance of DescribeEC2InstanceLimitsOutput', function() {
      // uncomment below and update the code to test DescribeEC2InstanceLimitsOutput
      //var instance = new AmazonGameLift.DescribeEC2InstanceLimitsOutput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeEC2InstanceLimitsOutput);
    });

    it('should have the property eC2InstanceLimits (base name: "EC2InstanceLimits")', function() {
      // uncomment below and update the code to test the property eC2InstanceLimits
      //var instance = new AmazonGameLift.DescribeEC2InstanceLimitsOutput();
