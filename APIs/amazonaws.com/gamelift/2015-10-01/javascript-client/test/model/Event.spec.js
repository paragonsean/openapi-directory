...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.Event();
  });
  ...
  describe('Event', function() {
    it('should create an instance of Event', function() {
      ...
      //var instance = new AmazonGameLift.Event();
      //expect(instance).to.be.a(AmazonGameLift.Event);
    });
    ...
    it('should have the property preSignedLogUrl (base name: "PreSignedLogUrl")', function() {
      // uncomment below and update the code to test the property preSignedLogUrl
      //var instance = new AmazonGameLift.Event();
      //expect(instance).to.be();
    });
