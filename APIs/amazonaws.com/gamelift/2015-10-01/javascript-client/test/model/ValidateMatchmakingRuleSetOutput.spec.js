...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.ValidateMatchmakingRuleSetOutput();
  });
  ...
  describe('ValidateMatchmakingRuleSetOutput', function() {
    it('should create an instance of ValidateMatchmakingRuleSetOutput', function() {
      // uncomment below and update the code to test ValidateMatchmakingRuleSetOutput
      //var instance = new AmazonGameLift.ValidateMatchmakingRuleSetOutput();
      //expect(instance).to.be.a(AmazonGameLift.ValidateMatchmakingRuleSetOutput);
    });
