...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateGameSessionOutput();
  });
  ...
  describe('UpdateGameSessionOutput', function() {
    it('should create an instance of UpdateGameSessionOutput', function() {
      // uncomment below and update the code to test UpdateGameSessionOutput
      //var instance = new AmazonGameLift.UpdateGameSessionOutput();
      //expect(instance).to.be.a(AmazonGameLift.UpdateGameSessionOutput);
    });
