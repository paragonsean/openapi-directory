...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.GameSessionConnectionInfo();
  });
  ...
  describe('GameSessionConnectionInfo', function() {
    it('should create an instance of GameSessionConnectionInfo', function() {
      // uncomment below and update the code to test GameSessionConnectionInfo
      //var instance = new AmazonGameLift.GameSessionConnectionInfo();
      //expect(instance).to.be.a(AmazonGameLift.GameSessionConnectionInfo);
    });
