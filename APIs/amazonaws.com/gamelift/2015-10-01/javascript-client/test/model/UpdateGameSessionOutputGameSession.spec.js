...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateGameSessionOutputGameSession();
  });
  ...
  describe('UpdateGameSessionOutputGameSession', function() {
    it('should create an instance of UpdateGameSessionOutputGameSession', function() {
      // uncomment below and update the code to test UpdateGameSessionOutputGameSession
      //var instance = new AmazonGameLift.UpdateGameSessionOutputGameSession();
      //expect(instance).to.be.a(AmazonGameLift.UpdateGameSessionOutputGameSession);
    });
    ...
    it('should have the property currentPlayerSessionCount (base name: "CurrentPlayerSessionCount")', function() {
      // uncomment below and update the code to test the property currentPlayerSessionCount
      //var instance = new AmazonGameLift.UpdateGameSessionOutputGameSession();
      //expect(instance).to.be();
    });
    ...
    it('should have the property playerSessionCreationPolicy (base name: "PlayerSessionCreationPolicy")', function() {
      // uncomment below and update the code to test the property playerSessionCreationPolicy
      //var instance = new AmazonGameLift.UpdateGameSessionOutputGameSession();
      //expect(instance).to.be();
    });
