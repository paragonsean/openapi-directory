...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateScriptInput();
  });
  ...
  describe('UpdateScriptInput', function() {
    it('should create an instance of UpdateScriptInput', function() {
      // uncomment below and update the code to test UpdateScriptInput
      //var instance = new AmazonGameLift.UpdateScriptInput();
      //expect(instance).to.be.a(AmazonGameLift.UpdateScriptInput);
    });
