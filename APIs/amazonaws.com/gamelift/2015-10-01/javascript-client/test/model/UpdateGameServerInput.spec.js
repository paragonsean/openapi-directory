...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateGameServerInput();
  });
  ...
  describe('UpdateGameServerInput', function() {
    it('should create an instance of UpdateGameServerInput', function() {
      // uncomment below and update the code to test UpdateGameServerInput
      //var instance = new AmazonGameLift.UpdateGameServerInput();
      //expect(instance).to.be.a(AmazonGameLift.UpdateGameServerInput);
    });
