...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateGameSessionOutput();
  });
  ...
  describe('CreateGameSessionOutput', function() {
    it('should create an instance of CreateGameSessionOutput', function() {
      // uncomment below and update the code to test CreateGameSessionOutput
      //var instance = new AmazonGameLift.CreateGameSessionOutput();
      //expect(instance).to.be.a(AmazonGameLift.CreateGameSessionOutput);
    });

    it('should have the property gameSession (base name: "GameSession")', function() {
      // uncomment below and update the code to test the property gameSession
      //var instance = new AmazonGameLift.CreateGameSessionOutput();
