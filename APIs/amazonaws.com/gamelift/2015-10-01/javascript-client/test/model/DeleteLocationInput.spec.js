...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DeleteLocationInput();
  });
  ...
  describe('DeleteLocationInput', function() {
    it('should create an instance of DeleteLocationInput', function() {
      // uncomment below and update the code to test DeleteLocationInput
      //var instance = new AmazonGameLift.DeleteLocationInput();
      //expect(instance).to.be.a(AmazonGameLift.DeleteLocationInput);
    });
