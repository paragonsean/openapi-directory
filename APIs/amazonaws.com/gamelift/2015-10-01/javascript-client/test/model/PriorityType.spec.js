...
(function(root, factory) {
  ...
  describe('PriorityType', function() {
    it('should create an instance of PriorityType', function() {
      // uncomment below and update the code to test PriorityType
      //var instance = new AmazonGameLift.PriorityType();
      //expect(instance).to.be.a(AmazonGameLift.PriorityType);
    });
