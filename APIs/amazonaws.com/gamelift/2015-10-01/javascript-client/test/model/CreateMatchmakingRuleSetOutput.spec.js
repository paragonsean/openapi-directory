...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateMatchmakingRuleSetOutput();
  });
  ...
  describe('CreateMatchmakingRuleSetOutput', function() {
    it('should create an instance of CreateMatchmakingRuleSetOutput', function() {
      // uncomment below and update the code to test CreateMatchmakingRuleSetOutput
      //var instance = new AmazonGameLift.CreateMatchmakingRuleSetOutput();
      //expect(instance).to.be.a(AmazonGameLift.CreateMatchmakingRuleSetOutput);
    });
