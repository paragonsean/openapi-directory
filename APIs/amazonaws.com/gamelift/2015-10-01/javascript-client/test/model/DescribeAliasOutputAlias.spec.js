...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeAliasOutputAlias();
  });
  ...
  describe('DescribeAliasOutputAlias', function() {
    it('should create an instance of DescribeAliasOutputAlias', function() {
      // uncomment below and update the code to test DescribeAliasOutputAlias
      //var instance = new AmazonGameLift.DescribeAliasOutputAlias();
      //expect(instance).to.be.a(AmazonGameLift.DescribeAliasOutputAlias);
    });
