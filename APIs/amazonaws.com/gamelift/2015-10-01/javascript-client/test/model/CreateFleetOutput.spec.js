...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateFleetOutput();
  });
  ...
  describe('CreateFleetOutput', function() {
    it('should create an instance of CreateFleetOutput', function() {
      // uncomment below and update the code to test CreateFleetOutput
      //var instance = new AmazonGameLift.CreateFleetOutput();
      //expect(instance).to.be.a(AmazonGameLift.CreateFleetOutput);
    });
