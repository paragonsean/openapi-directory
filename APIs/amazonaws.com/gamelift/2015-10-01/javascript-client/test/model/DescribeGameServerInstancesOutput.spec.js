...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeGameServerInstancesOutput();
  });
  ...
  describe('DescribeGameServerInstancesOutput', function() {
    it('should create an instance of DescribeGameServerInstancesOutput', function() {
      // uncomment below and update the code to test DescribeGameServerInstancesOutput
      //var instance = new AmazonGameLift.DescribeGameServerInstancesOutput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeGameServerInstancesOutput);
    });

    it('should have the property gameServerInstances (base name: "GameServerInstances")', function() {
      // uncomment below and update the code to test the property gameServerInstances
      //var instance = new AmazonGameLift.DescribeGameServerInstancesOutput();
