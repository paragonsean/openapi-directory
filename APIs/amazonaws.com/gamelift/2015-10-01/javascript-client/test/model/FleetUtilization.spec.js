...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.FleetUtilization();
  });
  ...
  describe('FleetUtilization', function() {
    it('should create an instance of FleetUtilization', function() {
      // uncomment below and update the code to test FleetUtilization
      //var instance = new AmazonGameLift.FleetUtilization();
      //expect(instance).to.be.a(AmazonGameLift.FleetUtilization);
    });
    ...
    it('should have the property activeServerProcessCount (base name: "ActiveServerProcessCount")', function() {
      // uncomment below and update the code to test the property activeServerProcessCount
      //var instance = new AmazonGameLift.FleetUtilization();
      //expect(instance).to.be();
    });

    it('should have the property activeGameSessionCount (base name: "ActiveGameSessionCount")', function() {
      // uncomment below and update the code to test the property activeGameSessionCount
      //var instance = new AmazonGameLift.FleetUtilization();
      //expect(instance).to.be();
    });
