...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.MatchmakingTicketGameSessionConnectionInfo();
  });
  ...
  describe('MatchmakingTicketGameSessionConnectionInfo', function() {
    it('should create an instance of MatchmakingTicketGameSessionConnectionInfo', function() {
      // uncomment below and update the code to test MatchmakingTicketGameSessionConnectionInfo
      //var instance = new AmazonGameLift.MatchmakingTicketGameSessionConnectionInfo();
      //expect(instance).to.be.a(AmazonGameLift.MatchmakingTicketGameSessionConnectionInfo);
    });
    ...
    it('should have the property matchedPlayerSessions (base name: "MatchedPlayerSessions")', function() {
      // uncomment below and update the code to test the property matchedPlayerSessions
      //var instance = new AmazonGameLift.MatchmakingTicketGameSessionConnectionInfo();
      //expect(instance).to.be();
    });
