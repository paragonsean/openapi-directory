...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.SuspendGameServerGroupOutput();
  });
  ...
  describe('SuspendGameServerGroupOutput', function() {
    it('should create an instance of SuspendGameServerGroupOutput', function() {
      // uncomment below and update the code to test SuspendGameServerGroupOutput
      //var instance = new AmazonGameLift.SuspendGameServerGroupOutput();
      //expect(instance).to.be.a(AmazonGameLift.SuspendGameServerGroupOutput);
    });
