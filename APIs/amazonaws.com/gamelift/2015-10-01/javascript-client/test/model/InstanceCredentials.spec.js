...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.InstanceCredentials();
  });
  ...
  describe('InstanceCredentials', function() {
    it('should create an instance of InstanceCredentials', function() {
      // uncomment below and update the code to test InstanceCredentials
      //var instance = new AmazonGameLift.InstanceCredentials();
      //expect(instance).to.be.a(AmazonGameLift.InstanceCredentials);
    });
