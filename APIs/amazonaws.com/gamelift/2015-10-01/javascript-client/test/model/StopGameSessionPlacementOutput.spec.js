...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.StopGameSessionPlacementOutput();
  });
  ...
  describe('StopGameSessionPlacementOutput', function() {
    it('should create an instance of StopGameSessionPlacementOutput', function() {
      // uncomment below and update the code to test StopGameSessionPlacementOutput
      //var instance = new AmazonGameLift.StopGameSessionPlacementOutput();
      //expect(instance).to.be.a(AmazonGameLift.StopGameSessionPlacementOutput);
    });
