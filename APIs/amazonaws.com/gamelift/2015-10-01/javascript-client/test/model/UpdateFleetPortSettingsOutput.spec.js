...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateFleetPortSettingsOutput();
  });
  ...
  describe('UpdateFleetPortSettingsOutput', function() {
    it('should create an instance of UpdateFleetPortSettingsOutput', function() {
      // uncomment below and update the code to test UpdateFleetPortSettingsOutput
      //var instance = new AmazonGameLift.UpdateFleetPortSettingsOutput();
      //expect(instance).to.be.a(AmazonGameLift.UpdateFleetPortSettingsOutput);
    });
