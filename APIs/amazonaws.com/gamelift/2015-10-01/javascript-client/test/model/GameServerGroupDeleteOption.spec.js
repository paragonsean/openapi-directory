...
(function(root, factory) {
  ...
  describe('GameServerGroupDeleteOption', function() {
    it('should create an instance of GameServerGroupDeleteOption', function() {
      // uncomment below and update the code to test GameServerGroupDeleteOption
      //var instance = new AmazonGameLift.GameServerGroupDeleteOption();
      //expect(instance).to.be.a(AmazonGameLift.GameServerGroupDeleteOption);
    });
