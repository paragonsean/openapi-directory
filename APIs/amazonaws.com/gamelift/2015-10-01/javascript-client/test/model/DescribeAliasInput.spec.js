...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeAliasInput();
  });
  ...
  describe('DescribeAliasInput', function() {
    it('should create an instance of DescribeAliasInput', function() {
      // uncomment below and update the code to test DescribeAliasInput
      //var instance = new AmazonGameLift.DescribeAliasInput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeAliasInput);
    });
