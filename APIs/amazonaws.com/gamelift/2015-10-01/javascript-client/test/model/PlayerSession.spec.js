...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.PlayerSession();
  });
  ...
  describe('PlayerSession', function() {
    it('should create an instance of PlayerSession', function() {
      // uncomment below and update the code to test PlayerSession
      //var instance = new AmazonGameLift.PlayerSession();
      //expect(instance).to.be.a(AmazonGameLift.PlayerSession);
    });
