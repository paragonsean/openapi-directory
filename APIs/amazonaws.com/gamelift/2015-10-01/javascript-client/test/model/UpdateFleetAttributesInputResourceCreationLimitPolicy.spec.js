...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateFleetAttributesInputResourceCreationLimitPolicy();
  });
  ...
  describe('UpdateFleetAttributesInputResourceCreationLimitPolicy', function() {
    it('should create an instance of UpdateFleetAttributesInputResourceCreationLimitPolicy', function() {
      // uncomment below and update the code to test UpdateFleetAttributesInputResourceCreationLimitPolicy
      //var instance = new AmazonGameLift.UpdateFleetAttributesInputResourceCreationLimitPolicy();
      //expect(instance).to.be.a(AmazonGameLift.UpdateFleetAttributesInputResourceCreationLimitPolicy);
    });
