...
(function(root, factory) {
  ...
  describe('FleetAction', function() {
    it('should create an instance of FleetAction', function() {
      // uncomment below and update the code to test FleetAction
      //var instance = new AmazonGameLift.FleetAction();
      //expect(instance).to.be.a(AmazonGameLift.FleetAction);
    });
