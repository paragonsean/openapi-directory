...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeMatchmakingRuleSetsOutput();
  });
  ...
  describe('DescribeMatchmakingRuleSetsOutput', function() {
    it('should create an instance of DescribeMatchmakingRuleSetsOutput', function() {
      // uncomment below and update the code to test DescribeMatchmakingRuleSetsOutput
      //var instance = new AmazonGameLift.DescribeMatchmakingRuleSetsOutput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeMatchmakingRuleSetsOutput);
    });
