...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateBuildInput();
  });
  ...
  describe('CreateBuildInput', function() {
    it('should create an instance of CreateBuildInput', function() {
      // uncomment below and update the code to test CreateBuildInput
      //var instance = new AmazonGameLift.CreateBuildInput();
      //expect(instance).to.be.a(AmazonGameLift.CreateBuildInput);
    });
