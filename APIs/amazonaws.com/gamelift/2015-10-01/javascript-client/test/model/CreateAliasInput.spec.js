...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateAliasInput();
  });
  ...
  describe('CreateAliasInput', function() {
    it('should create an instance of CreateAliasInput', function() {
      // uncomment below and update the code to test CreateAliasInput
      //var instance = new AmazonGameLift.CreateAliasInput();
      //expect(instance).to.be.a(AmazonGameLift.CreateAliasInput);
    });
