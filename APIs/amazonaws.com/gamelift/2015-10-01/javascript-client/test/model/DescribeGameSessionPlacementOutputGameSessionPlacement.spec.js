...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeGameSessionPlacementOutputGameSessionPlacement();
  });
  ...
  describe('DescribeGameSessionPlacementOutputGameSessionPlacement', function() {
    it('should create an instance of DescribeGameSessionPlacementOutputGameSessionPlacement', function() {
      // uncomment below and update the code to test DescribeGameSessionPlacementOutputGameSessionPlacement
      //var instance = new AmazonGameLift.DescribeGameSessionPlacementOutputGameSessionPlacement();
      //expect(instance).to.be.a(AmazonGameLift.DescribeGameSessionPlacementOutputGameSessionPlacement);
    });
