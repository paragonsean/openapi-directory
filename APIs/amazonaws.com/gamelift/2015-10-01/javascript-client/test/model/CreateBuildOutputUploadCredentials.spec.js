...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateBuildOutputUploadCredentials();
  });
  ...
  describe('CreateBuildOutputUploadCredentials', function() {
    it('should create an instance of CreateBuildOutputUploadCredentials', function() {
      // uncomment below and update the code to test CreateBuildOutputUploadCredentials
      //var instance = new AmazonGameLift.CreateBuildOutputUploadCredentials();
      //expect(instance).to.be.a(AmazonGameLift.CreateBuildOutputUploadCredentials);
    });
