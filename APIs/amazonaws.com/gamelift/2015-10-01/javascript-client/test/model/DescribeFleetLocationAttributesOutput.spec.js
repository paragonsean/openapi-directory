...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeFleetLocationAttributesOutput();
  });
  ...
  describe('DescribeFleetLocationAttributesOutput', function() {
    it('should create an instance of DescribeFleetLocationAttributesOutput', function() {
      // uncomment below and update the code to test DescribeFleetLocationAttributesOutput
      //var instance = new AmazonGameLift.DescribeFleetLocationAttributesOutput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeFleetLocationAttributesOutput);
    });
    ...
    it('should have the property locationAttributes (base name: "LocationAttributes")', function() {
      // uncomment below and update the code to test the property locationAttributes
      //var instance = new AmazonGameLift.DescribeFleetLocationAttributesOutput();
      //expect(instance).to.be();
    });
