...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.GetComputeAuthTokenInput();
  });
  ...
  describe('GetComputeAuthTokenInput', function() {
    it('should create an instance of GetComputeAuthTokenInput', function() {
      // uncomment below and update the code to test GetComputeAuthTokenInput
      //var instance = new AmazonGameLift.GetComputeAuthTokenInput();
      //expect(instance).to.be.a(AmazonGameLift.GetComputeAuthTokenInput);
    });
