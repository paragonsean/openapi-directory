...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeFleetEventsInput();
  });
  ...
  describe('DescribeFleetEventsInput', function() {
    it('should create an instance of DescribeFleetEventsInput', function() {
      // uncomment below and update the code to test DescribeFleetEventsInput
      //var instance = new AmazonGameLift.DescribeFleetEventsInput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeFleetEventsInput);
    });
