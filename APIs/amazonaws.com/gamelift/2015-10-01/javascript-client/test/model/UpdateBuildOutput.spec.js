...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateBuildOutput();
  });
  ...
  describe('UpdateBuildOutput', function() {
    it('should create an instance of UpdateBuildOutput', function() {
      // uncomment below and update the code to test UpdateBuildOutput
      //var instance = new AmazonGameLift.UpdateBuildOutput();
      //expect(instance).to.be.a(AmazonGameLift.UpdateBuildOutput);
    });
