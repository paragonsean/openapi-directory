...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UntagResourceRequest();
  });
  ...
  describe('UntagResourceRequest', function() {
    it('should create an instance of UntagResourceRequest', function() {
      ...
      //var instance = new AmazonGameLift.UntagResourceRequest();
      //expect(instance).to.be.a(AmazonGameLift.UntagResourceRequest);
    });
