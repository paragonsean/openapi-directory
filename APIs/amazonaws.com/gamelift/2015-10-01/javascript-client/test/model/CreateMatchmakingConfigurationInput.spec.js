...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateMatchmakingConfigurationInput();
  });
  ...
  describe('CreateMatchmakingConfigurationInput', function() {
    it('should create an instance of CreateMatchmakingConfigurationInput', function() {
      // uncomment below and update the code to test CreateMatchmakingConfigurationInput
      //var instance = new AmazonGameLift.CreateMatchmakingConfigurationInput();
      //expect(instance).to.be.a(AmazonGameLift.CreateMatchmakingConfigurationInput);
    });
