...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.FilterConfiguration();
  });
  ...
  describe('FilterConfiguration', function() {
    it('should create an instance of FilterConfiguration', function() {
      // uncomment below and update the code to test FilterConfiguration
      //var instance = new AmazonGameLift.FilterConfiguration();
      //expect(instance).to.be.a(AmazonGameLift.FilterConfiguration);
    });
