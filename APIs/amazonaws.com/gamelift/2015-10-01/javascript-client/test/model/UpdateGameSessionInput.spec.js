...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateGameSessionInput();
  });
  ...
  describe('UpdateGameSessionInput', function() {
    it('should create an instance of UpdateGameSessionInput', function() {
      // uncomment below and update the code to test UpdateGameSessionInput
      //var instance = new AmazonGameLift.UpdateGameSessionInput();
      //expect(instance).to.be.a(AmazonGameLift.UpdateGameSessionInput);
    });
