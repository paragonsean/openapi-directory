...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.GetComputeAuthTokenOutput();
  });
  ...
  describe('GetComputeAuthTokenOutput', function() {
    it('should create an instance of GetComputeAuthTokenOutput', function() {
      // uncomment below and update the code to test GetComputeAuthTokenOutput
      //var instance = new AmazonGameLift.GetComputeAuthTokenOutput();
      //expect(instance).to.be.a(AmazonGameLift.GetComputeAuthTokenOutput);
    });
    ...
    it('should have the property computeArn (base name: "ComputeArn")', function() {
      // uncomment below and update the code to test the property computeArn
      //var instance = new AmazonGameLift.GetComputeAuthTokenOutput();
      //expect(instance).to.be();
    });
