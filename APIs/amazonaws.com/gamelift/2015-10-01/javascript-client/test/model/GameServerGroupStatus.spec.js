...
(function(root, factory) {
  ...
  describe('GameServerGroupStatus', function() {
    it('should create an instance of GameServerGroupStatus', function() {
      // uncomment below and update the code to test GameServerGroupStatus
      //var instance = new AmazonGameLift.GameServerGroupStatus();
      //expect(instance).to.be.a(AmazonGameLift.GameServerGroupStatus);
    });
