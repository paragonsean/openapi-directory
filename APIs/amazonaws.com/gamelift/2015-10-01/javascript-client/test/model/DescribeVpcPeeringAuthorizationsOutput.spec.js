...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeVpcPeeringAuthorizationsOutput();
  });
  ...
  describe('DescribeVpcPeeringAuthorizationsOutput', function() {
    it('should create an instance of DescribeVpcPeeringAuthorizationsOutput', function() {
      // uncomment below and update the code to test DescribeVpcPeeringAuthorizationsOutput
      //var instance = new AmazonGameLift.DescribeVpcPeeringAuthorizationsOutput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeVpcPeeringAuthorizationsOutput);
    });

    it('should have the property vpcPeeringAuthorizations (base name: "VpcPeeringAuthorizations")', function() {
      // uncomment below and update the code to test the property vpcPeeringAuthorizations
      //var instance = new AmazonGameLift.DescribeVpcPeeringAuthorizationsOutput();
