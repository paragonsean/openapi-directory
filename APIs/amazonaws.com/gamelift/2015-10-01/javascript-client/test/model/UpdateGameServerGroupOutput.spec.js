...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateGameServerGroupOutput();
  });
  ...
  describe('UpdateGameServerGroupOutput', function() {
    it('should create an instance of UpdateGameServerGroupOutput', function() {
      // uncomment below and update the code to test UpdateGameServerGroupOutput
      //var instance = new AmazonGameLift.UpdateGameServerGroupOutput();
      //expect(instance).to.be.a(AmazonGameLift.UpdateGameServerGroupOutput);
    });
