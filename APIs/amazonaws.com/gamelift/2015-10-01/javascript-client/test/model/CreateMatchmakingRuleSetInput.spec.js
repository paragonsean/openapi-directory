...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateMatchmakingRuleSetInput();
  });
  ...
  describe('CreateMatchmakingRuleSetInput', function() {
    it('should create an instance of CreateMatchmakingRuleSetInput', function() {
      // uncomment below and update the code to test CreateMatchmakingRuleSetInput
      //var instance = new AmazonGameLift.CreateMatchmakingRuleSetInput();
      //expect(instance).to.be.a(AmazonGameLift.CreateMatchmakingRuleSetInput);
    });
