...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeFleetAttributesOutput();
  });
  ...
  describe('DescribeFleetAttributesOutput', function() {
    it('should create an instance of DescribeFleetAttributesOutput', function() {
      // uncomment below and update the code to test DescribeFleetAttributesOutput
      //var instance = new AmazonGameLift.DescribeFleetAttributesOutput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeFleetAttributesOutput);
    });

    it('should have the property fleetAttributes (base name: "FleetAttributes")', function() {
      // uncomment below and update the code to test the property fleetAttributes
      //var instance = new AmazonGameLift.DescribeFleetAttributesOutput();
