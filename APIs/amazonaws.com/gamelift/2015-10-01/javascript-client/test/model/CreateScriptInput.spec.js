...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateScriptInput();
  });
  ...
  describe('CreateScriptInput', function() {
    it('should create an instance of CreateScriptInput', function() {
      // uncomment below and update the code to test CreateScriptInput
      //var instance = new AmazonGameLift.CreateScriptInput();
      //expect(instance).to.be.a(AmazonGameLift.CreateScriptInput);
    });
