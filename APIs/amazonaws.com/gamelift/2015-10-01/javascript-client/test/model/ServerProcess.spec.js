...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.ServerProcess();
  });
  ...
  describe('ServerProcess', function() {
    it('should create an instance of ServerProcess', function() {
      // uncomment below and update the code to test ServerProcess
      //var instance = new AmazonGameLift.ServerProcess();
      //expect(instance).to.be.a(AmazonGameLift.ServerProcess);
    });
    ...
    it('should have the property concurrentExecutions (base name: "ConcurrentExecutions")', function() {
      // uncomment below and update the code to test the property concurrentExecutions
      //var instance = new AmazonGameLift.ServerProcess();
      //expect(instance).to.be();
    });
