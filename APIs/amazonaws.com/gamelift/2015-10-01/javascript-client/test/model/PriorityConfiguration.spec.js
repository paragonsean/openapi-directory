...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.PriorityConfiguration();
  });
  ...
  describe('PriorityConfiguration', function() {
    it('should create an instance of PriorityConfiguration', function() {
      // uncomment below and update the code to test PriorityConfiguration
      //var instance = new AmazonGameLift.PriorityConfiguration();
      //expect(instance).to.be.a(AmazonGameLift.PriorityConfiguration);
    });
    ...
    it('should have the property locationOrder (base name: "LocationOrder")', function() {
      // uncomment below and update the code to test the property locationOrder
      //var instance = new AmazonGameLift.PriorityConfiguration();
      //expect(instance).to.be();
    });
