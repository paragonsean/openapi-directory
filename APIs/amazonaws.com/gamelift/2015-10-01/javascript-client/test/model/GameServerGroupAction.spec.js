...
(function(root, factory) {
  ...
  describe('GameServerGroupAction', function() {
    it('should create an instance of GameServerGroupAction', function() {
      // uncomment below and update the code to test GameServerGroupAction
      //var instance = new AmazonGameLift.GameServerGroupAction();
      //expect(instance).to.be.a(AmazonGameLift.GameServerGroupAction);
    });
