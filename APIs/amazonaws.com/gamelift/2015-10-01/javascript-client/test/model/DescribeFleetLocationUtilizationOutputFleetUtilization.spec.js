...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeFleetLocationUtilizationOutputFleetUtilization();
  });
  ...
  describe('DescribeFleetLocationUtilizationOutputFleetUtilization', function() {
    it('should create an instance of DescribeFleetLocationUtilizationOutputFleetUtilization', function() {
      // uncomment below and update the code to test DescribeFleetLocationUtilizationOutputFleetUtilization
      //var instance = new AmazonGameLift.DescribeFleetLocationUtilizationOutputFleetUtilization();
      //expect(instance).to.be.a(AmazonGameLift.DescribeFleetLocationUtilizationOutputFleetUtilization);
    });
