...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeScalingPoliciesInput();
  });
  ...
  describe('DescribeScalingPoliciesInput', function() {
    it('should create an instance of DescribeScalingPoliciesInput', function() {
      // uncomment below and update the code to test DescribeScalingPoliciesInput
      //var instance = new AmazonGameLift.DescribeScalingPoliciesInput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeScalingPoliciesInput);
    });
