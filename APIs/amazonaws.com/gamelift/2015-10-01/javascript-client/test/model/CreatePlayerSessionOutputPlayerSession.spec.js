...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreatePlayerSessionOutputPlayerSession();
  });
  ...
  describe('CreatePlayerSessionOutputPlayerSession', function() {
    it('should create an instance of CreatePlayerSessionOutputPlayerSession', function() {
      // uncomment below and update the code to test CreatePlayerSessionOutputPlayerSession
      //var instance = new AmazonGameLift.CreatePlayerSessionOutputPlayerSession();
      //expect(instance).to.be.a(AmazonGameLift.CreatePlayerSessionOutputPlayerSession);
    });

    it('should have the property playerSessionId (base name: "PlayerSessionId")', function() {
      // uncomment below and update the code to test the property playerSessionId
      //var instance = new AmazonGameLift.CreatePlayerSessionOutputPlayerSession();
    ...
    it('should have the property playerData (base name: "PlayerData")', function() {
      // uncomment below and update the code to test the property playerData
      //var instance = new AmazonGameLift.CreatePlayerSessionOutputPlayerSession();
      //expect(instance).to.be();
    });
