...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.ResolveAliasInput();
  });
  ...
  describe('ResolveAliasInput', function() {
    it('should create an instance of ResolveAliasInput', function() {
      // uncomment below and update the code to test ResolveAliasInput
      //var instance = new AmazonGameLift.ResolveAliasInput();
      //expect(instance).to.be.a(AmazonGameLift.ResolveAliasInput);
    });
