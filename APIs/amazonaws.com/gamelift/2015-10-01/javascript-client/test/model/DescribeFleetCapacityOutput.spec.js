...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeFleetCapacityOutput();
  });
  ...
  describe('DescribeFleetCapacityOutput', function() {
    it('should create an instance of DescribeFleetCapacityOutput', function() {
      // uncomment below and update the code to test DescribeFleetCapacityOutput
      //var instance = new AmazonGameLift.DescribeFleetCapacityOutput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeFleetCapacityOutput);
    });
