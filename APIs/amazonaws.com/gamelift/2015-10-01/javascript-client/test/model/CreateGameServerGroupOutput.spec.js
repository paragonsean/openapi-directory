...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateGameServerGroupOutput();
  });
  ...
  describe('CreateGameServerGroupOutput', function() {
    it('should create an instance of CreateGameServerGroupOutput', function() {
      // uncomment below and update the code to test CreateGameServerGroupOutput
      //var instance = new AmazonGameLift.CreateGameServerGroupOutput();
      //expect(instance).to.be.a(AmazonGameLift.CreateGameServerGroupOutput);
    });
