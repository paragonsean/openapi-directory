...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeVpcPeeringConnectionsOutput();
  });
  ...
  describe('DescribeVpcPeeringConnectionsOutput', function() {
    it('should create an instance of DescribeVpcPeeringConnectionsOutput', function() {
      // uncomment below and update the code to test DescribeVpcPeeringConnectionsOutput
      //var instance = new AmazonGameLift.DescribeVpcPeeringConnectionsOutput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeVpcPeeringConnectionsOutput);
    });
