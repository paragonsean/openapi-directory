...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.PlayerLatency();
  });
  ...
  describe('PlayerLatency', function() {
    it('should create an instance of PlayerLatency', function() {
      // uncomment below and update the code to test PlayerLatency
      //var instance = new AmazonGameLift.PlayerLatency();
      //expect(instance).to.be.a(AmazonGameLift.PlayerLatency);
    });
    ...
    it('should have the property regionIdentifier (base name: "RegionIdentifier")', function() {
      // uncomment below and update the code to test the property regionIdentifier
      //var instance = new AmazonGameLift.PlayerLatency();
      //expect(instance).to.be();
    });

    it('should have the property latencyInMilliseconds (base name: "LatencyInMilliseconds")', function() {
      // uncomment below and update the code to test the property latencyInMilliseconds
      //var instance = new AmazonGameLift.PlayerLatency();
      //expect(instance).to.be();
    });
