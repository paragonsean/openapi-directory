...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DeleteMatchmakingConfigurationInput();
  });
  ...
  describe('DeleteMatchmakingConfigurationInput', function() {
    it('should create an instance of DeleteMatchmakingConfigurationInput', function() {
      // uncomment below and update the code to test DeleteMatchmakingConfigurationInput
      //var instance = new AmazonGameLift.DeleteMatchmakingConfigurationInput();
      //expect(instance).to.be.a(AmazonGameLift.DeleteMatchmakingConfigurationInput);
    });
