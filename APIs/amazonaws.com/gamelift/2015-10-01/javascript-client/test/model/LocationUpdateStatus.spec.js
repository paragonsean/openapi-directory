...
(function(root, factory) {
  ...
  describe('LocationUpdateStatus', function() {
    it('should create an instance of LocationUpdateStatus', function() {
      // uncomment below and update the code to test LocationUpdateStatus
      //var instance = new AmazonGameLift.LocationUpdateStatus();
      //expect(instance).to.be.a(AmazonGameLift.LocationUpdateStatus);
    });
