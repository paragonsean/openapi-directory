...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateFleetInputCertificateConfiguration();
  });
  ...
  describe('CreateFleetInputCertificateConfiguration', function() {
    it('should create an instance of CreateFleetInputCertificateConfiguration', function() {
      // uncomment below and update the code to test CreateFleetInputCertificateConfiguration
      //var instance = new AmazonGameLift.CreateFleetInputCertificateConfiguration();
      //expect(instance).to.be.a(AmazonGameLift.CreateFleetInputCertificateConfiguration);
    });
