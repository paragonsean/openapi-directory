...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateVpcPeeringAuthorizationInput();
  });
  ...
  describe('CreateVpcPeeringAuthorizationInput', function() {
    it('should create an instance of CreateVpcPeeringAuthorizationInput', function() {
      // uncomment below and update the code to test CreateVpcPeeringAuthorizationInput
      //var instance = new AmazonGameLift.CreateVpcPeeringAuthorizationInput();
      //expect(instance).to.be.a(AmazonGameLift.CreateVpcPeeringAuthorizationInput);
    });

    it('should have the property gameLiftAwsAccountId (base name: "GameLiftAwsAccountId")', function() {
      // uncomment below and update the code to test the property gameLiftAwsAccountId
      //var instance = new AmazonGameLift.CreateVpcPeeringAuthorizationInput();
