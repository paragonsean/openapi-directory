...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateGameSessionQueueOutput();
  });
  ...
  describe('UpdateGameSessionQueueOutput', function() {
    it('should create an instance of UpdateGameSessionQueueOutput', function() {
      // uncomment below and update the code to test UpdateGameSessionQueueOutput
      //var instance = new AmazonGameLift.UpdateGameSessionQueueOutput();
      //expect(instance).to.be.a(AmazonGameLift.UpdateGameSessionQueueOutput);
    });
