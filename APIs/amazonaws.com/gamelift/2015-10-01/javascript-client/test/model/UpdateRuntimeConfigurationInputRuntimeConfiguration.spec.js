...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateRuntimeConfigurationInputRuntimeConfiguration();
  });
  ...
  describe('UpdateRuntimeConfigurationInputRuntimeConfiguration', function() {
    it('should create an instance of UpdateRuntimeConfigurationInputRuntimeConfiguration', function() {
      // uncomment below and update the code to test UpdateRuntimeConfigurationInputRuntimeConfiguration
      //var instance = new AmazonGameLift.UpdateRuntimeConfigurationInputRuntimeConfiguration();
      //expect(instance).to.be.a(AmazonGameLift.UpdateRuntimeConfigurationInputRuntimeConfiguration);
    });
