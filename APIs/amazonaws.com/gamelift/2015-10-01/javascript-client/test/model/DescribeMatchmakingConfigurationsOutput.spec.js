...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeMatchmakingConfigurationsOutput();
  });
  ...
  describe('DescribeMatchmakingConfigurationsOutput', function() {
    it('should create an instance of DescribeMatchmakingConfigurationsOutput', function() {
      // uncomment below and update the code to test DescribeMatchmakingConfigurationsOutput
      //var instance = new AmazonGameLift.DescribeMatchmakingConfigurationsOutput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeMatchmakingConfigurationsOutput);
    });
