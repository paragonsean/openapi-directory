...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DeleteFleetLocationsOutput();
  });
  ...
  describe('DeleteFleetLocationsOutput', function() {
    it('should create an instance of DeleteFleetLocationsOutput', function() {
      // uncomment below and update the code to test DeleteFleetLocationsOutput
      //var instance = new AmazonGameLift.DeleteFleetLocationsOutput();
      //expect(instance).to.be.a(AmazonGameLift.DeleteFleetLocationsOutput);
    });
    ...
    it('should have the property locationStates (base name: "LocationStates")', function() {
      // uncomment below and update the code to test the property locationStates
      //var instance = new AmazonGameLift.DeleteFleetLocationsOutput();
      //expect(instance).to.be();
    });
