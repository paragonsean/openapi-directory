...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateGameSessionQueueInputPriorityConfiguration();
  });
  ...
  describe('CreateGameSessionQueueInputPriorityConfiguration', function() {
    it('should create an instance of CreateGameSessionQueueInputPriorityConfiguration', function() {
      // uncomment below and update the code to test CreateGameSessionQueueInputPriorityConfiguration
      //var instance = new AmazonGameLift.CreateGameSessionQueueInputPriorityConfiguration();
      //expect(instance).to.be.a(AmazonGameLift.CreateGameSessionQueueInputPriorityConfiguration);
    });
