...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.StartFleetActionsInput();
  });
  ...
  describe('StartFleetActionsInput', function() {
    it('should create an instance of StartFleetActionsInput', function() {
      // uncomment below and update the code to test StartFleetActionsInput
      //var instance = new AmazonGameLift.StartFleetActionsInput();
      //expect(instance).to.be.a(AmazonGameLift.StartFleetActionsInput);
    });
