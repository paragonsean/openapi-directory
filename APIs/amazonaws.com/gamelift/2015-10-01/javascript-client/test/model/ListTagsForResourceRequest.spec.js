...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.ListTagsForResourceRequest();
  });
  ...
  describe('ListTagsForResourceRequest', function() {
    it('should create an instance of ListTagsForResourceRequest', function() {
      ...
      //var instance = new AmazonGameLift.ListTagsForResourceRequest();
      //expect(instance).to.be.a(AmazonGameLift.ListTagsForResourceRequest);
    });
