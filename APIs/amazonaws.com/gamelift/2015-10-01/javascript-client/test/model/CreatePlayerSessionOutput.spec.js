...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreatePlayerSessionOutput();
  });
  ...
  describe('CreatePlayerSessionOutput', function() {
    it('should create an instance of CreatePlayerSessionOutput', function() {
      // uncomment below and update the code to test CreatePlayerSessionOutput
      //var instance = new AmazonGameLift.CreatePlayerSessionOutput();
      //expect(instance).to.be.a(AmazonGameLift.CreatePlayerSessionOutput);
    });

    it('should have the property playerSession (base name: "PlayerSession")', function() {
      // uncomment below and update the code to test the property playerSession
      //var instance = new AmazonGameLift.CreatePlayerSessionOutput();
