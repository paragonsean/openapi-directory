...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeComputeOutputCompute();
  });
  ...
  describe('DescribeComputeOutputCompute', function() {
    it('should create an instance of DescribeComputeOutputCompute', function() {
      // uncomment below and update the code to test DescribeComputeOutputCompute
      //var instance = new AmazonGameLift.DescribeComputeOutputCompute();
      //expect(instance).to.be.a(AmazonGameLift.DescribeComputeOutputCompute);
    });
    ...
    it('should have the property computeStatus (base name: "ComputeStatus")', function() {
      // uncomment below and update the code to test the property computeStatus
      //var instance = new AmazonGameLift.DescribeComputeOutputCompute();
      //expect(instance).to.be();
    });
    ...
    it('should have the property gameLiftServiceSdkEndpoint (base name: "GameLiftServiceSdkEndpoint")', function() {
      // uncomment below and update the code to test the property gameLiftServiceSdkEndpoint
      //var instance = new AmazonGameLift.DescribeComputeOutputCompute();
      //expect(instance).to.be();
    });
