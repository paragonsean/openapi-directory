...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeFleetLocationUtilizationInput();
  });
  ...
  describe('DescribeFleetLocationUtilizationInput', function() {
    it('should create an instance of DescribeFleetLocationUtilizationInput', function() {
      // uncomment below and update the code to test DescribeFleetLocationUtilizationInput
      //var instance = new AmazonGameLift.DescribeFleetLocationUtilizationInput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeFleetLocationUtilizationInput);
    });
