...
(function(root, factory) {
  ...
  describe('GameServerInstanceStatus', function() {
    it('should create an instance of GameServerInstanceStatus', function() {
      // uncomment below and update the code to test GameServerInstanceStatus
      //var instance = new AmazonGameLift.GameServerInstanceStatus();
      //expect(instance).to.be.a(AmazonGameLift.GameServerInstanceStatus);
    });
