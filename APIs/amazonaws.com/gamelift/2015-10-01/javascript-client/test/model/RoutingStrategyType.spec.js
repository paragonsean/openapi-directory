...
(function(root, factory) {
  ...
  describe('RoutingStrategyType', function() {
    it('should create an instance of RoutingStrategyType', function() {
      // uncomment below and update the code to test RoutingStrategyType
      //var instance = new AmazonGameLift.RoutingStrategyType();
      //expect(instance).to.be.a(AmazonGameLift.RoutingStrategyType);
    });
