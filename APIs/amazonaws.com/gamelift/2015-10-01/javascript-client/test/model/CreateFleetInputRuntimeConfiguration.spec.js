...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateFleetInputRuntimeConfiguration();
  });
  ...
  describe('CreateFleetInputRuntimeConfiguration', function() {
    it('should create an instance of CreateFleetInputRuntimeConfiguration', function() {
      // uncomment below and update the code to test CreateFleetInputRuntimeConfiguration
      //var instance = new AmazonGameLift.CreateFleetInputRuntimeConfiguration();
      //expect(instance).to.be.a(AmazonGameLift.CreateFleetInputRuntimeConfiguration);
    });
