...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.PutScalingPolicyOutput();
  });
  ...
  describe('PutScalingPolicyOutput', function() {
    it('should create an instance of PutScalingPolicyOutput', function() {
      // uncomment below and update the code to test PutScalingPolicyOutput
      //var instance = new AmazonGameLift.PutScalingPolicyOutput();
      //expect(instance).to.be.a(AmazonGameLift.PutScalingPolicyOutput);
    });
