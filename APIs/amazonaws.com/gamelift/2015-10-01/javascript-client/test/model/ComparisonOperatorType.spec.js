...
(function(root, factory) {
  ...
  describe('ComparisonOperatorType', function() {
    it('should create an instance of ComparisonOperatorType', function() {
      // uncomment below and update the code to test ComparisonOperatorType
      //var instance = new AmazonGameLift.ComparisonOperatorType();
      //expect(instance).to.be.a(AmazonGameLift.ComparisonOperatorType);
    });
