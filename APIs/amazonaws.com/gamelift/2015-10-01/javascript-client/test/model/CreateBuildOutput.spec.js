...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateBuildOutput();
  });
  ...
  describe('CreateBuildOutput', function() {
    it('should create an instance of CreateBuildOutput', function() {
      // uncomment below and update the code to test CreateBuildOutput
      //var instance = new AmazonGameLift.CreateBuildOutput();
      //expect(instance).to.be.a(AmazonGameLift.CreateBuildOutput);
    });
    ...
    it('should have the property uploadCredentials (base name: "UploadCredentials")', function() {
