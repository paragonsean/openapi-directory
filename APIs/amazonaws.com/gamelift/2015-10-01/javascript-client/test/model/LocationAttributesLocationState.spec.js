...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.LocationAttributesLocationState();
  });
  ...
  describe('LocationAttributesLocationState', function() {
    it('should create an instance of LocationAttributesLocationState', function() {
      // uncomment below and update the code to test LocationAttributesLocationState
      //var instance = new AmazonGameLift.LocationAttributesLocationState();
      //expect(instance).to.be.a(AmazonGameLift.LocationAttributesLocationState);
    });
