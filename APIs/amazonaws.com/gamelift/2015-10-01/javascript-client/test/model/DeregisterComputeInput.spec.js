...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DeregisterComputeInput();
  });
  ...
  describe('DeregisterComputeInput', function() {
    it('should create an instance of DeregisterComputeInput', function() {
      // uncomment below and update the code to test DeregisterComputeInput
      //var instance = new AmazonGameLift.DeregisterComputeInput();
      //expect(instance).to.be.a(AmazonGameLift.DeregisterComputeInput);
    });
