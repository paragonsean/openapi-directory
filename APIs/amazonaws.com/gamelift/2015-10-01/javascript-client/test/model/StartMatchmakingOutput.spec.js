...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.StartMatchmakingOutput();
  });
  ...
  describe('StartMatchmakingOutput', function() {
    it('should create an instance of StartMatchmakingOutput', function() {
      // uncomment below and update the code to test StartMatchmakingOutput
      //var instance = new AmazonGameLift.StartMatchmakingOutput();
      //expect(instance).to.be.a(AmazonGameLift.StartMatchmakingOutput);
    });
