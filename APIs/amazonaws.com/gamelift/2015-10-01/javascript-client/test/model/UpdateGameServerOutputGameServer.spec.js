...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateGameServerOutputGameServer();
  });
  ...
  describe('UpdateGameServerOutputGameServer', function() {
    it('should create an instance of UpdateGameServerOutputGameServer', function() {
      // uncomment below and update the code to test UpdateGameServerOutputGameServer
      //var instance = new AmazonGameLift.UpdateGameServerOutputGameServer();
      //expect(instance).to.be.a(AmazonGameLift.UpdateGameServerOutputGameServer);
    });
