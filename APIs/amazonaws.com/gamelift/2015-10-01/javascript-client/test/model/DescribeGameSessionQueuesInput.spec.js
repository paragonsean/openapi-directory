...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeGameSessionQueuesInput();
  });
  ...
  describe('DescribeGameSessionQueuesInput', function() {
    it('should create an instance of DescribeGameSessionQueuesInput', function() {
      // uncomment below and update the code to test DescribeGameSessionQueuesInput
      //var instance = new AmazonGameLift.DescribeGameSessionQueuesInput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeGameSessionQueuesInput);
    });
