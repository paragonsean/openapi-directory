...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateLocationOutputLocation();
  });
  ...
  describe('CreateLocationOutputLocation', function() {
    it('should create an instance of CreateLocationOutputLocation', function() {
      // uncomment below and update the code to test CreateLocationOutputLocation
      //var instance = new AmazonGameLift.CreateLocationOutputLocation();
      //expect(instance).to.be.a(AmazonGameLift.CreateLocationOutputLocation);
    });
