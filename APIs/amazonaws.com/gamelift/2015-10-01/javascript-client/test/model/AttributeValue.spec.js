...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.AttributeValue();
  });
  ...
  describe('AttributeValue', function() {
    it('should create an instance of AttributeValue', function() {
      ...
      //var instance = new AmazonGameLift.AttributeValue();
      //expect(instance).to.be.a(AmazonGameLift.AttributeValue);
    });
    ...
    it('should have the property SDM (base name: "SDM")', function() {
      // uncomment below and update the code to test the property SDM
      //var instance = new AmazonGameLift.AttributeValue();
      //expect(instance).to.be();
    });
