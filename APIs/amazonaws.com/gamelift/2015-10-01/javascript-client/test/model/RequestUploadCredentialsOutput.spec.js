...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.RequestUploadCredentialsOutput();
  });
  ...
  describe('RequestUploadCredentialsOutput', function() {
    it('should create an instance of RequestUploadCredentialsOutput', function() {
      // uncomment below and update the code to test RequestUploadCredentialsOutput
      //var instance = new AmazonGameLift.RequestUploadCredentialsOutput();
      //expect(instance).to.be.a(AmazonGameLift.RequestUploadCredentialsOutput);
    });
