...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeGameServerOutputGameServer();
  });
  ...
  describe('DescribeGameServerOutputGameServer', function() {
    it('should create an instance of DescribeGameServerOutputGameServer', function() {
      // uncomment below and update the code to test DescribeGameServerOutputGameServer
      //var instance = new AmazonGameLift.DescribeGameServerOutputGameServer();
      //expect(instance).to.be.a(AmazonGameLift.DescribeGameServerOutputGameServer);
    });

    it('should have the property gameServerGroupName (base name: "GameServerGroupName")', function() {
      // uncomment below and update the code to test the property gameServerGroupName
      //var instance = new AmazonGameLift.DescribeGameServerOutputGameServer();
      //expect(instance).to.be();
    });

    it('should have the property gameServerGroupArn (base name: "GameServerGroupArn")', function() {
      // uncomment below and update the code to test the property gameServerGroupArn
      //var instance = new AmazonGameLift.DescribeGameServerOutputGameServer();
      //expect(instance).to.be();
    });

    it('should have the property gameServerId (base name: "GameServerId")', function() {
      // uncomment below and update the code to test the property gameServerId
      //var instance = new AmazonGameLift.DescribeGameServerOutputGameServer();
      //expect(instance).to.be();
    });
    ...
    it('should have the property gameServerData (base name: "GameServerData")', function() {
      // uncomment below and update the code to test the property gameServerData
      //var instance = new AmazonGameLift.DescribeGameServerOutputGameServer();
      //expect(instance).to.be();
    });
    ...
    it('should have the property utilizationStatus (base name: "UtilizationStatus")', function() {
      // uncomment below and update the code to test the property utilizationStatus
      //var instance = new AmazonGameLift.DescribeGameServerOutputGameServer();
      //expect(instance).to.be();
    });
    ...
    it('should have the property lastClaimTime (base name: "LastClaimTime")', function() {
      // uncomment below and update the code to test the property lastClaimTime
      //var instance = new AmazonGameLift.DescribeGameServerOutputGameServer();
      //expect(instance).to.be();
    });

    it('should have the property lastHealthCheckTime (base name: "LastHealthCheckTime")', function() {
      // uncomment below and update the code to test the property lastHealthCheckTime
      //var instance = new AmazonGameLift.DescribeGameServerOutputGameServer();
      //expect(instance).to.be();
    });
