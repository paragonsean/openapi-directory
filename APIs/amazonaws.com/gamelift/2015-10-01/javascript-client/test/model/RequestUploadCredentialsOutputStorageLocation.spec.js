...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.RequestUploadCredentialsOutputStorageLocation();
  });
  ...
  describe('RequestUploadCredentialsOutputStorageLocation', function() {
    it('should create an instance of RequestUploadCredentialsOutputStorageLocation', function() {
      // uncomment below and update the code to test RequestUploadCredentialsOutputStorageLocation
      //var instance = new AmazonGameLift.RequestUploadCredentialsOutputStorageLocation();
      //expect(instance).to.be.a(AmazonGameLift.RequestUploadCredentialsOutputStorageLocation);
    });
