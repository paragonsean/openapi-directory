...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.StopGameSessionPlacementOutputGameSessionPlacement();
  });
  ...
  describe('StopGameSessionPlacementOutputGameSessionPlacement', function() {
    it('should create an instance of StopGameSessionPlacementOutputGameSessionPlacement', function() {
      // uncomment below and update the code to test StopGameSessionPlacementOutputGameSessionPlacement
      //var instance = new AmazonGameLift.StopGameSessionPlacementOutputGameSessionPlacement();
      //expect(instance).to.be.a(AmazonGameLift.StopGameSessionPlacementOutputGameSessionPlacement);
    });
