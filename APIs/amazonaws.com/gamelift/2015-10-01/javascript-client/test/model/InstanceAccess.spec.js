...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.InstanceAccess();
  });
  ...
  describe('InstanceAccess', function() {
    it('should create an instance of InstanceAccess', function() {
      // uncomment below and update the code to test InstanceAccess
      //var instance = new AmazonGameLift.InstanceAccess();
      //expect(instance).to.be.a(AmazonGameLift.InstanceAccess);
    });
