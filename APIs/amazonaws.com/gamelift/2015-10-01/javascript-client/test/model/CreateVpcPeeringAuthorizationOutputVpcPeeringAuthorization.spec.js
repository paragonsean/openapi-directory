...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateVpcPeeringAuthorizationOutputVpcPeeringAuthorization();
  });
  ...
  describe('CreateVpcPeeringAuthorizationOutputVpcPeeringAuthorization', function() {
    it('should create an instance of CreateVpcPeeringAuthorizationOutputVpcPeeringAuthorization', function() {
      // uncomment below and update the code to test CreateVpcPeeringAuthorizationOutputVpcPeeringAuthorization
      //var instance = new AmazonGameLift.CreateVpcPeeringAuthorizationOutputVpcPeeringAuthorization();
      //expect(instance).to.be.a(AmazonGameLift.CreateVpcPeeringAuthorizationOutputVpcPeeringAuthorization);
    });
