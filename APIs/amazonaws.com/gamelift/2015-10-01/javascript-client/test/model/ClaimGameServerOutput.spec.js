...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.ClaimGameServerOutput();
  });
  ...
  describe('ClaimGameServerOutput', function() {
    it('should create an instance of ClaimGameServerOutput', function() {
      // uncomment below and update the code to test ClaimGameServerOutput
      //var instance = new AmazonGameLift.ClaimGameServerOutput();
      //expect(instance).to.be.a(AmazonGameLift.ClaimGameServerOutput);
    });
