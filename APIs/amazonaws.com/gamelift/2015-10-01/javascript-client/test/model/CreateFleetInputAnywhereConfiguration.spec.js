...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateFleetInputAnywhereConfiguration();
  });
  ...
  describe('CreateFleetInputAnywhereConfiguration', function() {
    it('should create an instance of CreateFleetInputAnywhereConfiguration', function() {
      // uncomment below and update the code to test CreateFleetInputAnywhereConfiguration
      //var instance = new AmazonGameLift.CreateFleetInputAnywhereConfiguration();
      //expect(instance).to.be.a(AmazonGameLift.CreateFleetInputAnywhereConfiguration);
    });
