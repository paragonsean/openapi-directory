...
(function(root, factory) {
  ...
  describe('GameServerGroupInstanceType', function() {
    it('should create an instance of GameServerGroupInstanceType', function() {
      // uncomment below and update the code to test GameServerGroupInstanceType
      //var instance = new AmazonGameLift.GameServerGroupInstanceType();
      //expect(instance).to.be.a(AmazonGameLift.GameServerGroupInstanceType);
    });
