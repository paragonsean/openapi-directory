...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateMatchmakingRuleSetOutputRuleSet();
  });
  ...
  describe('CreateMatchmakingRuleSetOutputRuleSet', function() {
    it('should create an instance of CreateMatchmakingRuleSetOutputRuleSet', function() {
      // uncomment below and update the code to test CreateMatchmakingRuleSetOutputRuleSet
      //var instance = new AmazonGameLift.CreateMatchmakingRuleSetOutputRuleSet();
      //expect(instance).to.be.a(AmazonGameLift.CreateMatchmakingRuleSetOutputRuleSet);
    });
    ...
    it('should have the property ruleSetBody (base name: "RuleSetBody")', function() {
      // uncomment below and update the code to test the property ruleSetBody
      //var instance = new AmazonGameLift.CreateMatchmakingRuleSetOutputRuleSet();
      //expect(instance).to.be();
    });
