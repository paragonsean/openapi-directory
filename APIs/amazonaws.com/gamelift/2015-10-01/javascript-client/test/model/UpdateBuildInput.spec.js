...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateBuildInput();
  });
  ...
  describe('UpdateBuildInput', function() {
    it('should create an instance of UpdateBuildInput', function() {
      // uncomment below and update the code to test UpdateBuildInput
      //var instance = new AmazonGameLift.UpdateBuildInput();
      //expect(instance).to.be.a(AmazonGameLift.UpdateBuildInput);
    });
