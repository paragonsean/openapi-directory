...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.GetComputeAccessOutput();
  });
  ...
  describe('GetComputeAccessOutput', function() {
    it('should create an instance of GetComputeAccessOutput', function() {
      // uncomment below and update the code to test GetComputeAccessOutput
      //var instance = new AmazonGameLift.GetComputeAccessOutput();
      //expect(instance).to.be.a(AmazonGameLift.GetComputeAccessOutput);
    });
