...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DeleteMatchmakingRuleSetInput();
  });
  ...
  describe('DeleteMatchmakingRuleSetInput', function() {
    it('should create an instance of DeleteMatchmakingRuleSetInput', function() {
      // uncomment below and update the code to test DeleteMatchmakingRuleSetInput
      //var instance = new AmazonGameLift.DeleteMatchmakingRuleSetInput();
      //expect(instance).to.be.a(AmazonGameLift.DeleteMatchmakingRuleSetInput);
    });
