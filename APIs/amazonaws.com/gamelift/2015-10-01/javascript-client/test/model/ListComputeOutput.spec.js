...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.ListComputeOutput();
  });
  ...
  describe('ListComputeOutput', function() {
    it('should create an instance of ListComputeOutput', function() {
      // uncomment below and update the code to test ListComputeOutput
      //var instance = new AmazonGameLift.ListComputeOutput();
      //expect(instance).to.be.a(AmazonGameLift.ListComputeOutput);
    });

    it('should have the property computeList (base name: "ComputeList")', function() {
      // uncomment below and update the code to test the property computeList
      //var instance = new AmazonGameLift.ListComputeOutput();
