...
(function(root, factory) {
  ...
  describe('BalancingStrategy', function() {
    it('should create an instance of BalancingStrategy', function() {
      // uncomment below and update the code to test BalancingStrategy
      //var instance = new AmazonGameLift.BalancingStrategy();
      //expect(instance).to.be.a(AmazonGameLift.BalancingStrategy);
    });
