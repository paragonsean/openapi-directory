...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.RegisterComputeOutput();
  });
  ...
  describe('RegisterComputeOutput', function() {
    it('should create an instance of RegisterComputeOutput', function() {
      // uncomment below and update the code to test RegisterComputeOutput
      //var instance = new AmazonGameLift.RegisterComputeOutput();
      //expect(instance).to.be.a(AmazonGameLift.RegisterComputeOutput);
    });
