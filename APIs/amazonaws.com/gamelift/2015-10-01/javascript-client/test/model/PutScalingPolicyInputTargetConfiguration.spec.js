...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.PutScalingPolicyInputTargetConfiguration();
  });
  ...
  describe('PutScalingPolicyInputTargetConfiguration', function() {
    it('should create an instance of PutScalingPolicyInputTargetConfiguration', function() {
      // uncomment below and update the code to test PutScalingPolicyInputTargetConfiguration
      //var instance = new AmazonGameLift.PutScalingPolicyInputTargetConfiguration();
      //expect(instance).to.be.a(AmazonGameLift.PutScalingPolicyInputTargetConfiguration);
    });
