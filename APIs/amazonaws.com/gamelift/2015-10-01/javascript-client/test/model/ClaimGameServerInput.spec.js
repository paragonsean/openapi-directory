...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.ClaimGameServerInput();
  });
  ...
  describe('ClaimGameServerInput', function() {
    it('should create an instance of ClaimGameServerInput', function() {
      // uncomment below and update the code to test ClaimGameServerInput
      //var instance = new AmazonGameLift.ClaimGameServerInput();
      //expect(instance).to.be.a(AmazonGameLift.ClaimGameServerInput);
    });
    ...
    it('should have the property filterOption (base name: "FilterOption")', function() {
      // uncomment below and update the code to test the property filterOption
      //var instance = new AmazonGameLift.ClaimGameServerInput();
      //expect(instance).to.be();
    });
