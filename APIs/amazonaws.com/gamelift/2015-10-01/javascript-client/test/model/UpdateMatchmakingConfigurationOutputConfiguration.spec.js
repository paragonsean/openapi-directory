...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateMatchmakingConfigurationOutputConfiguration();
  });
  ...
  describe('UpdateMatchmakingConfigurationOutputConfiguration', function() {
    it('should create an instance of UpdateMatchmakingConfigurationOutputConfiguration', function() {
      // uncomment below and update the code to test UpdateMatchmakingConfigurationOutputConfiguration
      //var instance = new AmazonGameLift.UpdateMatchmakingConfigurationOutputConfiguration();
      //expect(instance).to.be.a(AmazonGameLift.UpdateMatchmakingConfigurationOutputConfiguration);
    });
