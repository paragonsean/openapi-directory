...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.GameSessionPlacement();
  });
  ...
  describe('GameSessionPlacement', function() {
    it('should create an instance of GameSessionPlacement', function() {
      // uncomment below and update the code to test GameSessionPlacement
      //var instance = new AmazonGameLift.GameSessionPlacement();
      //expect(instance).to.be.a(AmazonGameLift.GameSessionPlacement);
    });
