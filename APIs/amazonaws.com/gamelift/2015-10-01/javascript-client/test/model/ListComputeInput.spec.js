...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.ListComputeInput();
  });
  ...
  describe('ListComputeInput', function() {
    it('should create an instance of ListComputeInput', function() {
      // uncomment below and update the code to test ListComputeInput
      //var instance = new AmazonGameLift.ListComputeInput();
      //expect(instance).to.be.a(AmazonGameLift.ListComputeInput);
    });
