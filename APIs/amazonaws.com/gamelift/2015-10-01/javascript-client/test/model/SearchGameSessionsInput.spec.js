...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.SearchGameSessionsInput();
  });
  ...
  describe('SearchGameSessionsInput', function() {
    it('should create an instance of SearchGameSessionsInput', function() {
      // uncomment below and update the code to test SearchGameSessionsInput
      //var instance = new AmazonGameLift.SearchGameSessionsInput();
      //expect(instance).to.be.a(AmazonGameLift.SearchGameSessionsInput);
    });
    ...
    it('should have the property sortExpression (base name: "SortExpression")', function() {
      // uncomment below and update the code to test the property sortExpression
      //var instance = new AmazonGameLift.SearchGameSessionsInput();
      //expect(instance).to.be();
    });
