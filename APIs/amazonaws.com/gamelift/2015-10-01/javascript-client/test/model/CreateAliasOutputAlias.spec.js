...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateAliasOutputAlias();
  });
  ...
  describe('CreateAliasOutputAlias', function() {
    it('should create an instance of CreateAliasOutputAlias', function() {
      // uncomment below and update the code to test CreateAliasOutputAlias
      //var instance = new AmazonGameLift.CreateAliasOutputAlias();
      //expect(instance).to.be.a(AmazonGameLift.CreateAliasOutputAlias);
    });
