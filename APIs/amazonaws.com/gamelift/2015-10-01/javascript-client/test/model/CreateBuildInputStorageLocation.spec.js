...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateBuildInputStorageLocation();
  });
  ...
  describe('CreateBuildInputStorageLocation', function() {
    it('should create an instance of CreateBuildInputStorageLocation', function() {
      // uncomment below and update the code to test CreateBuildInputStorageLocation
      //var instance = new AmazonGameLift.CreateBuildInputStorageLocation();
      //expect(instance).to.be.a(AmazonGameLift.CreateBuildInputStorageLocation);
    });
