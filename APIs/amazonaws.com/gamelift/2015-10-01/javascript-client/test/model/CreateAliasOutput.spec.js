...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateAliasOutput();
  });
  ...
  describe('CreateAliasOutput', function() {
    it('should create an instance of CreateAliasOutput', function() {
      // uncomment below and update the code to test CreateAliasOutput
      //var instance = new AmazonGameLift.CreateAliasOutput();
      //expect(instance).to.be.a(AmazonGameLift.CreateAliasOutput);
    });
