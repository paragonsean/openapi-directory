...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.RuntimeConfiguration();
  });
  ...
  describe('RuntimeConfiguration', function() {
    it('should create an instance of RuntimeConfiguration', function() {
      // uncomment below and update the code to test RuntimeConfiguration
      //var instance = new AmazonGameLift.RuntimeConfiguration();
      //expect(instance).to.be.a(AmazonGameLift.RuntimeConfiguration);
    });
