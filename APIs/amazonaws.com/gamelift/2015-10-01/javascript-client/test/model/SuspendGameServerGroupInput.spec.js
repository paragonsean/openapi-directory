...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.SuspendGameServerGroupInput();
  });
  ...
  describe('SuspendGameServerGroupInput', function() {
    it('should create an instance of SuspendGameServerGroupInput', function() {
      // uncomment below and update the code to test SuspendGameServerGroupInput
      //var instance = new AmazonGameLift.SuspendGameServerGroupInput();
      //expect(instance).to.be.a(AmazonGameLift.SuspendGameServerGroupInput);
    });
    ...
    it('should have the property suspendActions (base name: "SuspendActions")', function() {
      // uncomment below and update the code to test the property suspendActions
      //var instance = new AmazonGameLift.SuspendGameServerGroupInput();
      //expect(instance).to.be();
    });
