...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.InstanceAccessCredentials();
  });
  ...
  describe('InstanceAccessCredentials', function() {
    it('should create an instance of InstanceAccessCredentials', function() {
      // uncomment below and update the code to test InstanceAccessCredentials
      //var instance = new AmazonGameLift.InstanceAccessCredentials();
      //expect(instance).to.be.a(AmazonGameLift.InstanceAccessCredentials);
    });
