...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeInstancesOutput();
  });
  ...
  describe('DescribeInstancesOutput', function() {
    it('should create an instance of DescribeInstancesOutput', function() {
      // uncomment below and update the code to test DescribeInstancesOutput
      //var instance = new AmazonGameLift.DescribeInstancesOutput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeInstancesOutput);
    });
