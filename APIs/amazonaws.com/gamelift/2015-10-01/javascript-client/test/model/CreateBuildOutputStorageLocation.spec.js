...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateBuildOutputStorageLocation();
  });
  ...
  describe('CreateBuildOutputStorageLocation', function() {
    it('should create an instance of CreateBuildOutputStorageLocation', function() {
      // uncomment below and update the code to test CreateBuildOutputStorageLocation
      //var instance = new AmazonGameLift.CreateBuildOutputStorageLocation();
      //expect(instance).to.be.a(AmazonGameLift.CreateBuildOutputStorageLocation);
    });
