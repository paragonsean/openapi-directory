...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeFleetLocationCapacityOutputFleetCapacity();
  });
  ...
  describe('DescribeFleetLocationCapacityOutputFleetCapacity', function() {
    it('should create an instance of DescribeFleetLocationCapacityOutputFleetCapacity', function() {
      // uncomment below and update the code to test DescribeFleetLocationCapacityOutputFleetCapacity
      //var instance = new AmazonGameLift.DescribeFleetLocationCapacityOutputFleetCapacity();
      //expect(instance).to.be.a(AmazonGameLift.DescribeFleetLocationCapacityOutputFleetCapacity);
    });
