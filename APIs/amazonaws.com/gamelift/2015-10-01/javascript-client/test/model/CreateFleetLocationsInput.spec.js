...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateFleetLocationsInput();
  });
  ...
  describe('CreateFleetLocationsInput', function() {
    it('should create an instance of CreateFleetLocationsInput', function() {
      // uncomment below and update the code to test CreateFleetLocationsInput
      //var instance = new AmazonGameLift.CreateFleetLocationsInput();
      //expect(instance).to.be.a(AmazonGameLift.CreateFleetLocationsInput);
    });
