...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeComputeInput();
  });
  ...
  describe('DescribeComputeInput', function() {
    it('should create an instance of DescribeComputeInput', function() {
      // uncomment below and update the code to test DescribeComputeInput
      //var instance = new AmazonGameLift.DescribeComputeInput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeComputeInput);
    });
