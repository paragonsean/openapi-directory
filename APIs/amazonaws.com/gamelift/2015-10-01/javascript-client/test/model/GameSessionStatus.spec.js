...
(function(root, factory) {
  ...
  describe('GameSessionStatus', function() {
    it('should create an instance of GameSessionStatus', function() {
      // uncomment below and update the code to test GameSessionStatus
      //var instance = new AmazonGameLift.GameSessionStatus();
      //expect(instance).to.be.a(AmazonGameLift.GameSessionStatus);
    });
