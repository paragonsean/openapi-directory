...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.MatchedPlayerSession();
  });
  ...
  describe('MatchedPlayerSession', function() {
    it('should create an instance of MatchedPlayerSession', function() {
      // uncomment below and update the code to test MatchedPlayerSession
      //var instance = new AmazonGameLift.MatchedPlayerSession();
      //expect(instance).to.be.a(AmazonGameLift.MatchedPlayerSession);
    });
