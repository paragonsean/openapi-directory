...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.GameServerInstance();
  });
  ...
  describe('GameServerInstance', function() {
    it('should create an instance of GameServerInstance', function() {
      // uncomment below and update the code to test GameServerInstance
      //var instance = new AmazonGameLift.GameServerInstance();
      //expect(instance).to.be.a(AmazonGameLift.GameServerInstance);
    });
