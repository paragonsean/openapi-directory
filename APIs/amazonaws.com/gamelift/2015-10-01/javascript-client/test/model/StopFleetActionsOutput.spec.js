...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.StopFleetActionsOutput();
  });
  ...
  describe('StopFleetActionsOutput', function() {
    it('should create an instance of StopFleetActionsOutput', function() {
      // uncomment below and update the code to test StopFleetActionsOutput
      //var instance = new AmazonGameLift.StopFleetActionsOutput();
      //expect(instance).to.be.a(AmazonGameLift.StopFleetActionsOutput);
    });
