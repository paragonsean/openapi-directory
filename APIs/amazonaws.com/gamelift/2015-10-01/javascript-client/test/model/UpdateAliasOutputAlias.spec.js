...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateAliasOutputAlias();
  });
  ...
  describe('UpdateAliasOutputAlias', function() {
    it('should create an instance of UpdateAliasOutputAlias', function() {
      // uncomment below and update the code to test UpdateAliasOutputAlias
      //var instance = new AmazonGameLift.UpdateAliasOutputAlias();
      //expect(instance).to.be.a(AmazonGameLift.UpdateAliasOutputAlias);
    });
