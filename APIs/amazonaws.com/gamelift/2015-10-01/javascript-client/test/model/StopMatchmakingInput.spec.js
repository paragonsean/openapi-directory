...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.StopMatchmakingInput();
  });
  ...
  describe('StopMatchmakingInput', function() {
    it('should create an instance of StopMatchmakingInput', function() {
      // uncomment below and update the code to test StopMatchmakingInput
      //var instance = new AmazonGameLift.StopMatchmakingInput();
      //expect(instance).to.be.a(AmazonGameLift.StopMatchmakingInput);
    });
