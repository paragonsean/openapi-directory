...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateScriptOutputScript();
  });
  ...
  describe('CreateScriptOutputScript', function() {
    it('should create an instance of CreateScriptOutputScript', function() {
      // uncomment below and update the code to test CreateScriptOutputScript
      //var instance = new AmazonGameLift.CreateScriptOutputScript();
      //expect(instance).to.be.a(AmazonGameLift.CreateScriptOutputScript);
    });
