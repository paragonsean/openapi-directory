...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.RegisterGameServerInput();
  });
  ...
  describe('RegisterGameServerInput', function() {
    it('should create an instance of RegisterGameServerInput', function() {
      // uncomment below and update the code to test RegisterGameServerInput
      //var instance = new AmazonGameLift.RegisterGameServerInput();
      //expect(instance).to.be.a(AmazonGameLift.RegisterGameServerInput);
    });
