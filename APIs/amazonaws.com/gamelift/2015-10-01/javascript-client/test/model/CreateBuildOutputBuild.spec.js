...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateBuildOutputBuild();
  });
  ...
  describe('CreateBuildOutputBuild', function() {
    it('should create an instance of CreateBuildOutputBuild', function() {
      // uncomment below and update the code to test CreateBuildOutputBuild
      //var instance = new AmazonGameLift.CreateBuildOutputBuild();
      //expect(instance).to.be.a(AmazonGameLift.CreateBuildOutputBuild);
    });
    ...
    it('should have the property serverSdkVersion (base name: "ServerSdkVersion")', function() {
      // uncomment below and update the code to test the property serverSdkVersion
      //var instance = new AmazonGameLift.CreateBuildOutputBuild();
      //expect(instance).to.be();
    });
