...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.AcceptMatchInput();
  });
  ...
  describe('AcceptMatchInput', function() {
    it('should create an instance of AcceptMatchInput', function() {
      // uncomment below and update the code to test AcceptMatchInput
      //var instance = new AmazonGameLift.AcceptMatchInput();
      //expect(instance).to.be.a(AmazonGameLift.AcceptMatchInput);
    });
    ...
    it('should have the property acceptanceType (base name: "AcceptanceType")', function() {
      // uncomment below and update the code to test the property acceptanceType
      //var instance = new AmazonGameLift.AcceptMatchInput();
      //expect(instance).to.be();
    });
