...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeMatchmakingConfigurationsInput();
  });
  ...
  describe('DescribeMatchmakingConfigurationsInput', function() {
    it('should create an instance of DescribeMatchmakingConfigurationsInput', function() {
      // uncomment below and update the code to test DescribeMatchmakingConfigurationsInput
      //var instance = new AmazonGameLift.DescribeMatchmakingConfigurationsInput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeMatchmakingConfigurationsInput);
    });
