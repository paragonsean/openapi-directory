...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DeleteScriptInput();
  });
  ...
  describe('DeleteScriptInput', function() {
    it('should create an instance of DeleteScriptInput', function() {
      // uncomment below and update the code to test DeleteScriptInput
      //var instance = new AmazonGameLift.DeleteScriptInput();
      //expect(instance).to.be.a(AmazonGameLift.DeleteScriptInput);
    });
