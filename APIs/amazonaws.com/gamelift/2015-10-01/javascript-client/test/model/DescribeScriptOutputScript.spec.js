...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeScriptOutputScript();
  });
  ...
  describe('DescribeScriptOutputScript', function() {
    it('should create an instance of DescribeScriptOutputScript', function() {
      // uncomment below and update the code to test DescribeScriptOutputScript
      //var instance = new AmazonGameLift.DescribeScriptOutputScript();
      //expect(instance).to.be.a(AmazonGameLift.DescribeScriptOutputScript);
    });
