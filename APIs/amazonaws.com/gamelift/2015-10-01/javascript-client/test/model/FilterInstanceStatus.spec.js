...
(function(root, factory) {
  ...
  describe('FilterInstanceStatus', function() {
    it('should create an instance of FilterInstanceStatus', function() {
      // uncomment below and update the code to test FilterInstanceStatus
      //var instance = new AmazonGameLift.FilterInstanceStatus();
      //expect(instance).to.be.a(AmazonGameLift.FilterInstanceStatus);
    });
