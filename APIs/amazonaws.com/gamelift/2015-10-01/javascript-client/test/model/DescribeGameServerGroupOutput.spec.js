...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeGameServerGroupOutput();
  });
  ...
  describe('DescribeGameServerGroupOutput', function() {
    it('should create an instance of DescribeGameServerGroupOutput', function() {
      // uncomment below and update the code to test DescribeGameServerGroupOutput
      //var instance = new AmazonGameLift.DescribeGameServerGroupOutput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeGameServerGroupOutput);
    });

    it('should have the property gameServerGroup (base name: "GameServerGroup")', function() {
      // uncomment below and update the code to test the property gameServerGroup
      //var instance = new AmazonGameLift.DescribeGameServerGroupOutput();
