...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.PlacedPlayerSession();
  });
  ...
  describe('PlacedPlayerSession', function() {
    it('should create an instance of PlacedPlayerSession', function() {
      // uncomment below and update the code to test PlacedPlayerSession
      //var instance = new AmazonGameLift.PlacedPlayerSession();
      //expect(instance).to.be.a(AmazonGameLift.PlacedPlayerSession);
    });
