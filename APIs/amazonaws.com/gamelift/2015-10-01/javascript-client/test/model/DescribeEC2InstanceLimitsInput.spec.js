...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeEC2InstanceLimitsInput();
  });
  ...
  describe('DescribeEC2InstanceLimitsInput', function() {
    it('should create an instance of DescribeEC2InstanceLimitsInput', function() {
      // uncomment below and update the code to test DescribeEC2InstanceLimitsInput
      //var instance = new AmazonGameLift.DescribeEC2InstanceLimitsInput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeEC2InstanceLimitsInput);
    });
