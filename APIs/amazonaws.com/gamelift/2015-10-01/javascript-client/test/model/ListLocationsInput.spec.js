...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.ListLocationsInput();
  });
  ...
  describe('ListLocationsInput', function() {
    it('should create an instance of ListLocationsInput', function() {
      // uncomment below and update the code to test ListLocationsInput
      //var instance = new AmazonGameLift.ListLocationsInput();
      //expect(instance).to.be.a(AmazonGameLift.ListLocationsInput);
    });
