...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DeleteVpcPeeringAuthorizationInput();
  });
  ...
  describe('DeleteVpcPeeringAuthorizationInput', function() {
    it('should create an instance of DeleteVpcPeeringAuthorizationInput', function() {
      // uncomment below and update the code to test DeleteVpcPeeringAuthorizationInput
      //var instance = new AmazonGameLift.DeleteVpcPeeringAuthorizationInput();
      //expect(instance).to.be.a(AmazonGameLift.DeleteVpcPeeringAuthorizationInput);
    });
