...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeFleetLocationCapacityInput();
  });
  ...
  describe('DescribeFleetLocationCapacityInput', function() {
    it('should create an instance of DescribeFleetLocationCapacityInput', function() {
      // uncomment below and update the code to test DescribeFleetLocationCapacityInput
      //var instance = new AmazonGameLift.DescribeFleetLocationCapacityInput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeFleetLocationCapacityInput);
    });
