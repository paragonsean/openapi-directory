...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeComputeOutput();
  });
  ...
  describe('DescribeComputeOutput', function() {
    it('should create an instance of DescribeComputeOutput', function() {
      // uncomment below and update the code to test DescribeComputeOutput
      //var instance = new AmazonGameLift.DescribeComputeOutput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeComputeOutput);
    });
