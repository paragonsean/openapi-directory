...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.ListFleetsOutput();
  });
  ...
  describe('ListFleetsOutput', function() {
    it('should create an instance of ListFleetsOutput', function() {
      // uncomment below and update the code to test ListFleetsOutput
      //var instance = new AmazonGameLift.ListFleetsOutput();
      //expect(instance).to.be.a(AmazonGameLift.ListFleetsOutput);
    });
