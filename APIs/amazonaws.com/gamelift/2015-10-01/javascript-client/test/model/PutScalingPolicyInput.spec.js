...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.PutScalingPolicyInput();
  });
  ...
  describe('PutScalingPolicyInput', function() {
    it('should create an instance of PutScalingPolicyInput', function() {
      // uncomment below and update the code to test PutScalingPolicyInput
      //var instance = new AmazonGameLift.PutScalingPolicyInput();
      //expect(instance).to.be.a(AmazonGameLift.PutScalingPolicyInput);
    });
    ...
    it('should have the property scalingAdjustmentType (base name: "ScalingAdjustmentType")', function() {
      // uncomment below and update the code to test the property scalingAdjustmentType
      //var instance = new AmazonGameLift.PutScalingPolicyInput();
      //expect(instance).to.be();
    });
    ...
    it('should have the property targetConfiguration (base name: "TargetConfiguration")', function() {
      // uncomment below and update the code to test the property targetConfiguration
      //var instance = new AmazonGameLift.PutScalingPolicyInput();
      //expect(instance).to.be();
    });
