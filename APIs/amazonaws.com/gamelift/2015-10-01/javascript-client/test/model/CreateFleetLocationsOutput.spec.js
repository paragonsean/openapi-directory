...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateFleetLocationsOutput();
  });
  ...
  describe('CreateFleetLocationsOutput', function() {
    it('should create an instance of CreateFleetLocationsOutput', function() {
      // uncomment below and update the code to test CreateFleetLocationsOutput
      //var instance = new AmazonGameLift.CreateFleetLocationsOutput();
      //expect(instance).to.be.a(AmazonGameLift.CreateFleetLocationsOutput);
    });
