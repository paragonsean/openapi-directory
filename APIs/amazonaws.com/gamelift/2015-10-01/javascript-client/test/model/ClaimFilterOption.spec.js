...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.ClaimFilterOption();
  });
  ...
  describe('ClaimFilterOption', function() {
    it('should create an instance of ClaimFilterOption', function() {
      // uncomment below and update the code to test ClaimFilterOption
      //var instance = new AmazonGameLift.ClaimFilterOption();
      //expect(instance).to.be.a(AmazonGameLift.ClaimFilterOption);
    });
