...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateFleetCapacityInput();
  });
  ...
  describe('UpdateFleetCapacityInput', function() {
    it('should create an instance of UpdateFleetCapacityInput', function() {
      // uncomment below and update the code to test UpdateFleetCapacityInput
      //var instance = new AmazonGameLift.UpdateFleetCapacityInput();
      //expect(instance).to.be.a(AmazonGameLift.UpdateFleetCapacityInput);
    });
