...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateGameSessionInput();
  });
  ...
  describe('CreateGameSessionInput', function() {
    it('should create an instance of CreateGameSessionInput', function() {
      // uncomment below and update the code to test CreateGameSessionInput
      //var instance = new AmazonGameLift.CreateGameSessionInput();
      //expect(instance).to.be.a(AmazonGameLift.CreateGameSessionInput);
    });
