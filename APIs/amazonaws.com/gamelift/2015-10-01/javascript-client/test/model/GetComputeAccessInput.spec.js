...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.GetComputeAccessInput();
  });
  ...
  describe('GetComputeAccessInput', function() {
    it('should create an instance of GetComputeAccessInput', function() {
      // uncomment below and update the code to test GetComputeAccessInput
      //var instance = new AmazonGameLift.GetComputeAccessInput();
      //expect(instance).to.be.a(AmazonGameLift.GetComputeAccessInput);
    });
