...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.StartGameSessionPlacementOutput();
  });
  ...
  describe('StartGameSessionPlacementOutput', function() {
    it('should create an instance of StartGameSessionPlacementOutput', function() {
      // uncomment below and update the code to test StartGameSessionPlacementOutput
      //var instance = new AmazonGameLift.StartGameSessionPlacementOutput();
      //expect(instance).to.be.a(AmazonGameLift.StartGameSessionPlacementOutput);
    });
