...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateFleetPortSettingsInput();
  });
  ...
  describe('UpdateFleetPortSettingsInput', function() {
    it('should create an instance of UpdateFleetPortSettingsInput', function() {
      // uncomment below and update the code to test UpdateFleetPortSettingsInput
      //var instance = new AmazonGameLift.UpdateFleetPortSettingsInput();
      //expect(instance).to.be.a(AmazonGameLift.UpdateFleetPortSettingsInput);
    });
    ...
    it('should have the property inboundPermissionAuthorizations (base name: "InboundPermissionAuthorizations")', function() {
      // uncomment below and update the code to test the property inboundPermissionAuthorizations
      //var instance = new AmazonGameLift.UpdateFleetPortSettingsInput();
      //expect(instance).to.be();
    });

    it('should have the property inboundPermissionRevocations (base name: "InboundPermissionRevocations")', function() {
      // uncomment below and update the code to test the property inboundPermissionRevocations
      //var instance = new AmazonGameLift.UpdateFleetPortSettingsInput();
      //expect(instance).to.be();
    });
