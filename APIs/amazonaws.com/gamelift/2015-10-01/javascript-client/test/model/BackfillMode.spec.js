...
(function(root, factory) {
  ...
  describe('BackfillMode', function() {
    it('should create an instance of BackfillMode', function() {
      // uncomment below and update the code to test BackfillMode
      //var instance = new AmazonGameLift.BackfillMode();
      //expect(instance).to.be.a(AmazonGameLift.BackfillMode);
    });
