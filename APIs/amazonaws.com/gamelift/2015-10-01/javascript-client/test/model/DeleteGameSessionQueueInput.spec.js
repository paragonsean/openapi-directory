...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DeleteGameSessionQueueInput();
  });
  ...
  describe('DeleteGameSessionQueueInput', function() {
    it('should create an instance of DeleteGameSessionQueueInput', function() {
      // uncomment below and update the code to test DeleteGameSessionQueueInput
      //var instance = new AmazonGameLift.DeleteGameSessionQueueInput();
      //expect(instance).to.be.a(AmazonGameLift.DeleteGameSessionQueueInput);
    });
