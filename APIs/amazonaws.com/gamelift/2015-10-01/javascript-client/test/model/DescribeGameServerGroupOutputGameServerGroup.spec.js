...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeGameServerGroupOutputGameServerGroup();
  });
  ...
  describe('DescribeGameServerGroupOutputGameServerGroup', function() {
    it('should create an instance of DescribeGameServerGroupOutputGameServerGroup', function() {
      // uncomment below and update the code to test DescribeGameServerGroupOutputGameServerGroup
      //var instance = new AmazonGameLift.DescribeGameServerGroupOutputGameServerGroup();
      //expect(instance).to.be.a(AmazonGameLift.DescribeGameServerGroupOutputGameServerGroup);
    });
    ...
    it('should have the property instanceDefinitions (base name: "InstanceDefinitions")', function() {
      // uncomment below and update the code to test the property instanceDefinitions
      //var instance = new AmazonGameLift.DescribeGameServerGroupOutputGameServerGroup();
      //expect(instance).to.be();
    });

    it('should have the property balancingStrategy (base name: "BalancingStrategy")', function() {
      // uncomment below and update the code to test the property balancingStrategy
      //var instance = new AmazonGameLift.DescribeGameServerGroupOutputGameServerGroup();
      //expect(instance).to.be();
    });

    it('should have the property gameServerProtectionPolicy (base name: "GameServerProtectionPolicy")', function() {
      // uncomment below and update the code to test the property gameServerProtectionPolicy
      //var instance = new AmazonGameLift.DescribeGameServerGroupOutputGameServerGroup();
      //expect(instance).to.be();
    });
    ...
    it('should have the property suspendedActions (base name: "SuspendedActions")', function() {
      // uncomment below and update the code to test the property suspendedActions
      //var instance = new AmazonGameLift.DescribeGameServerGroupOutputGameServerGroup();
      //expect(instance).to.be();
    });
