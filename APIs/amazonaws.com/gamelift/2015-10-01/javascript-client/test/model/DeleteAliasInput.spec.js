...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DeleteAliasInput();
  });
  ...
  describe('DeleteAliasInput', function() {
    it('should create an instance of DeleteAliasInput', function() {
      // uncomment below and update the code to test DeleteAliasInput
      //var instance = new AmazonGameLift.DeleteAliasInput();
      //expect(instance).to.be.a(AmazonGameLift.DeleteAliasInput);
    });
