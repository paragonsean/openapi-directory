...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateAliasInputRoutingStrategy();
  });
  ...
  describe('UpdateAliasInputRoutingStrategy', function() {
    it('should create an instance of UpdateAliasInputRoutingStrategy', function() {
      // uncomment below and update the code to test UpdateAliasInputRoutingStrategy
      //var instance = new AmazonGameLift.UpdateAliasInputRoutingStrategy();
      //expect(instance).to.be.a(AmazonGameLift.UpdateAliasInputRoutingStrategy);
    });
