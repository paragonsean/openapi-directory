...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.StartFleetActionsOutput();
  });
  ...
  describe('StartFleetActionsOutput', function() {
    it('should create an instance of StartFleetActionsOutput', function() {
      // uncomment below and update the code to test StartFleetActionsOutput
      //var instance = new AmazonGameLift.StartFleetActionsOutput();
      //expect(instance).to.be.a(AmazonGameLift.StartFleetActionsOutput);
    });
