...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.ResumeGameServerGroupOutput();
  });
  ...
  describe('ResumeGameServerGroupOutput', function() {
    it('should create an instance of ResumeGameServerGroupOutput', function() {
      // uncomment below and update the code to test ResumeGameServerGroupOutput
      //var instance = new AmazonGameLift.ResumeGameServerGroupOutput();
      //expect(instance).to.be.a(AmazonGameLift.ResumeGameServerGroupOutput);
    });
