...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.UpdateGameServerOutput();
  });
  ...
  describe('UpdateGameServerOutput', function() {
    it('should create an instance of UpdateGameServerOutput', function() {
      // uncomment below and update the code to test UpdateGameServerOutput
      //var instance = new AmazonGameLift.UpdateGameServerOutput();
      //expect(instance).to.be.a(AmazonGameLift.UpdateGameServerOutput);
    });
