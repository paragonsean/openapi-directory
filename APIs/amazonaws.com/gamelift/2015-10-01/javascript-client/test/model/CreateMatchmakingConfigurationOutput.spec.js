...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateMatchmakingConfigurationOutput();
  });
  ...
  describe('CreateMatchmakingConfigurationOutput', function() {
    it('should create an instance of CreateMatchmakingConfigurationOutput', function() {
      // uncomment below and update the code to test CreateMatchmakingConfigurationOutput
      //var instance = new AmazonGameLift.CreateMatchmakingConfigurationOutput();
      //expect(instance).to.be.a(AmazonGameLift.CreateMatchmakingConfigurationOutput);
    });
