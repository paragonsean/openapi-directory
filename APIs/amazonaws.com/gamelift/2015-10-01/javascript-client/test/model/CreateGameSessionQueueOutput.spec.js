...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.CreateGameSessionQueueOutput();
  });
  ...
  describe('CreateGameSessionQueueOutput', function() {
    it('should create an instance of CreateGameSessionQueueOutput', function() {
      // uncomment below and update the code to test CreateGameSessionQueueOutput
      //var instance = new AmazonGameLift.CreateGameSessionQueueOutput();
      //expect(instance).to.be.a(AmazonGameLift.CreateGameSessionQueueOutput);
    });

    it('should have the property gameSessionQueue (base name: "GameSessionQueue")', function() {
      // uncomment below and update the code to test the property gameSessionQueue
      //var instance = new AmazonGameLift.CreateGameSessionQueueOutput();
