...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeRuntimeConfigurationOutputRuntimeConfiguration();
  });
  ...
  describe('DescribeRuntimeConfigurationOutputRuntimeConfiguration', function() {
    it('should create an instance of DescribeRuntimeConfigurationOutputRuntimeConfiguration', function() {
      // uncomment below and update the code to test DescribeRuntimeConfigurationOutputRuntimeConfiguration
      //var instance = new AmazonGameLift.DescribeRuntimeConfigurationOutputRuntimeConfiguration();
      //expect(instance).to.be.a(AmazonGameLift.DescribeRuntimeConfigurationOutputRuntimeConfiguration);
    });
