...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.RegisterComputeInput();
  });
  ...
  describe('RegisterComputeInput', function() {
    it('should create an instance of RegisterComputeInput', function() {
      // uncomment below and update the code to test RegisterComputeInput
      //var instance = new AmazonGameLift.RegisterComputeInput();
      //expect(instance).to.be.a(AmazonGameLift.RegisterComputeInput);
    });
