...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.IpPermission();
  });
  ...
  describe('IpPermission', function() {
    it('should create an instance of IpPermission', function() {
      // uncomment below and update the code to test IpPermission
      //var instance = new AmazonGameLift.IpPermission();
      //expect(instance).to.be.a(AmazonGameLift.IpPermission);
    });
