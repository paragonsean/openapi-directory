...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeGameSessionQueuesOutput();
  });
  ...
  describe('DescribeGameSessionQueuesOutput', function() {
    it('should create an instance of DescribeGameSessionQueuesOutput', function() {
      // uncomment below and update the code to test DescribeGameSessionQueuesOutput
      //var instance = new AmazonGameLift.DescribeGameSessionQueuesOutput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeGameSessionQueuesOutput);
    });

    it('should have the property gameSessionQueues (base name: "GameSessionQueues")', function() {
      // uncomment below and update the code to test the property gameSessionQueues
      //var instance = new AmazonGameLift.DescribeGameSessionQueuesOutput();
