...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.ClaimGameServerInputFilterOption();
  });
  ...
  describe('ClaimGameServerInputFilterOption', function() {
    it('should create an instance of ClaimGameServerInputFilterOption', function() {
      // uncomment below and update the code to test ClaimGameServerInputFilterOption
      //var instance = new AmazonGameLift.ClaimGameServerInputFilterOption();
      //expect(instance).to.be.a(AmazonGameLift.ClaimGameServerInputFilterOption);
    });
