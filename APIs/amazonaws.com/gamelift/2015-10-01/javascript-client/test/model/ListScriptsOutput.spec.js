...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.ListScriptsOutput();
  });
  ...
  describe('ListScriptsOutput', function() {
    it('should create an instance of ListScriptsOutput', function() {
      // uncomment below and update the code to test ListScriptsOutput
      //var instance = new AmazonGameLift.ListScriptsOutput();
      //expect(instance).to.be.a(AmazonGameLift.ListScriptsOutput);
    });
