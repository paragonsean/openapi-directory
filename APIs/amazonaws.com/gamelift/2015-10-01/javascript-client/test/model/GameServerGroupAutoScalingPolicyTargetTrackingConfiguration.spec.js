...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.GameServerGroupAutoScalingPolicyTargetTrackingConfiguration();
  });
  ...
  describe('GameServerGroupAutoScalingPolicyTargetTrackingConfiguration', function() {
    it('should create an instance of GameServerGroupAutoScalingPolicyTargetTrackingConfiguration', function() {
      // uncomment below and update the code to test GameServerGroupAutoScalingPolicyTargetTrackingConfiguration
      //var instance = new AmazonGameLift.GameServerGroupAutoScalingPolicyTargetTrackingConfiguration();
      //expect(instance).to.be.a(AmazonGameLift.GameServerGroupAutoScalingPolicyTargetTrackingConfiguration);
    });
