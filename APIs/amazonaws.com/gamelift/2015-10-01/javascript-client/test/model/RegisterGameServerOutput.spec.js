...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.RegisterGameServerOutput();
  });
  ...
  describe('RegisterGameServerOutput', function() {
    it('should create an instance of RegisterGameServerOutput', function() {
      // uncomment below and update the code to test RegisterGameServerOutput
      //var instance = new AmazonGameLift.RegisterGameServerOutput();
      //expect(instance).to.be.a(AmazonGameLift.RegisterGameServerOutput);
    });
