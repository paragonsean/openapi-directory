...
(function(root, factory) {
  ...
  describe('GameSessionStatusReason', function() {
    it('should create an instance of GameSessionStatusReason', function() {
      // uncomment below and update the code to test GameSessionStatusReason
      //var instance = new AmazonGameLift.GameSessionStatusReason();
      //expect(instance).to.be.a(AmazonGameLift.GameSessionStatusReason);
    });
