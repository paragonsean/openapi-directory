...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.LocationModel();
  });
  ...
  describe('LocationModel', function() {
    it('should create an instance of LocationModel', function() {
      // uncomment below and update the code to test LocationModel
      //var instance = new AmazonGameLift.LocationModel();
      //expect(instance).to.be.a(AmazonGameLift.LocationModel);
    });
