...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeAliasOutput();
  });
  ...
  describe('DescribeAliasOutput', function() {
    it('should create an instance of DescribeAliasOutput', function() {
      // uncomment below and update the code to test DescribeAliasOutput
      //var instance = new AmazonGameLift.DescribeAliasOutput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeAliasOutput);
    });
