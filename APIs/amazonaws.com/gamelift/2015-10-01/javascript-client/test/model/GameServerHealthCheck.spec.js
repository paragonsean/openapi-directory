...
(function(root, factory) {
  ...
  describe('GameServerHealthCheck', function() {
    it('should create an instance of GameServerHealthCheck', function() {
      // uncomment below and update the code to test GameServerHealthCheck
      //var instance = new AmazonGameLift.GameServerHealthCheck();
      //expect(instance).to.be.a(AmazonGameLift.GameServerHealthCheck);
    });
