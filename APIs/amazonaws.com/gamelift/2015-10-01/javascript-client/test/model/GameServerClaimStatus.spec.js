...
(function(root, factory) {
  ...
  describe('GameServerClaimStatus', function() {
    it('should create an instance of GameServerClaimStatus', function() {
      // uncomment below and update the code to test GameServerClaimStatus
      //var instance = new AmazonGameLift.GameServerClaimStatus();
      //expect(instance).to.be.a(AmazonGameLift.GameServerClaimStatus);
    });
