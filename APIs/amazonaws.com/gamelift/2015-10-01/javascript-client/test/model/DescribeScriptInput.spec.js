...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.DescribeScriptInput();
  });
  ...
  describe('DescribeScriptInput', function() {
    it('should create an instance of DescribeScriptInput', function() {
      // uncomment below and update the code to test DescribeScriptInput
      //var instance = new AmazonGameLift.DescribeScriptInput();
      //expect(instance).to.be.a(AmazonGameLift.DescribeScriptInput);
    });
