...
(function(root, factory) {
  ...
  describe('FleetStatus', function() {
    it('should create an instance of FleetStatus', function() {
      // uncomment below and update the code to test FleetStatus
      //var instance = new AmazonGameLift.FleetStatus();
      //expect(instance).to.be.a(AmazonGameLift.FleetStatus);
    });
