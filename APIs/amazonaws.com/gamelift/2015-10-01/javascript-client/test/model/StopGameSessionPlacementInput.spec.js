...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonGameLift.StopGameSessionPlacementInput();
  });
  ...
  describe('StopGameSessionPlacementInput', function() {
    it('should create an instance of StopGameSessionPlacementInput', function() {
      // uncomment below and update the code to test StopGameSessionPlacementInput
      //var instance = new AmazonGameLift.StopGameSessionPlacementInput();
      //expect(instance).to.be.a(AmazonGameLift.StopGameSessionPlacementInput);
    });
