...
OAIGetGameSessionLogUrlOutput::OAIGetGameSessionLogUrlOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetGameSessionLogUrlOutput::OAIGetGameSessionLogUrlOutput() {
    this->initializeModel();
}

OAIGetGameSessionLogUrlOutput::~OAIGetGameSessionLogUrlOutput() {}

void OAIGetGameSessionLogUrlOutput::initializeModel() {

    m_pre_signed_url_isSet = false;
    m_pre_signed_url_isValid = false;
}

void OAIGetGameSessionLogUrlOutput::fromJson(QString jsonString) {
...
void OAIGetGameSessionLogUrlOutput::fromJsonObject(QJsonObject json) {
...
QString OAIGetGameSessionLogUrlOutput::asJson() const {
...
QJsonObject OAIGetGameSessionLogUrlOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetGameSessionLogUrlOutput::getPreSignedUrl() const {
    return m_pre_signed_url;
}
void OAIGetGameSessionLogUrlOutput::setPreSignedUrl(const QString &pre_signed_url) {
    m_pre_signed_url = pre_signed_url;
    m_pre_signed_url_isSet = true;
}

bool OAIGetGameSessionLogUrlOutput::is_pre_signed_url_Set() const{
    return m_pre_signed_url_isSet;
}

bool OAIGetGameSessionLogUrlOutput::is_pre_signed_url_Valid() const{
    return m_pre_signed_url_isValid;
}

bool OAIGetGameSessionLogUrlOutput::isSet() const {
...
bool OAIGetGameSessionLogUrlOutput::isValid() const {
