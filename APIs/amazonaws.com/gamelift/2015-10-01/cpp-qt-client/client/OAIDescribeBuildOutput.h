...
/*
 * OAIDescribeBuildOutput.h
 *
 * 
 */

#ifndef OAIDescribeBuildOutput_H
#define OAIDescribeBuildOutput_H
...
namespace OpenAPI {
class OAIDescribeBuildOutput_Build;

class OAIDescribeBuildOutput : public OAIObject {
public:
    OAIDescribeBuildOutput();
    OAIDescribeBuildOutput(QString json);
    ~OAIDescribeBuildOutput() override;
    ...
    OAIDescribeBuildOutput_Build getBuild() const;
    void setBuild(const OAIDescribeBuildOutput_Build &build);
...
private:
    ...
    OAIDescribeBuildOutput_Build m_build;
    bool m_build_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeBuildOutput)

#endif // OAIDescribeBuildOutput_H
