...
OAIRequestUploadCredentialsOutput::OAIRequestUploadCredentialsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRequestUploadCredentialsOutput::OAIRequestUploadCredentialsOutput() {
    this->initializeModel();
}

OAIRequestUploadCredentialsOutput::~OAIRequestUploadCredentialsOutput() {}

void OAIRequestUploadCredentialsOutput::initializeModel() {

    m_upload_credentials_isSet = false;
    m_upload_credentials_isValid = false;

    m_storage_location_isSet = false;
    m_storage_location_isValid = false;
}

void OAIRequestUploadCredentialsOutput::fromJson(QString jsonString) {
...
void OAIRequestUploadCredentialsOutput::fromJsonObject(QJsonObject json) {

    m_upload_credentials_isValid = ::OpenAPI::fromJsonValue(m_upload_credentials, json[QString("UploadCredentials")]);
    m_upload_credentials_isSet = !json[QString("UploadCredentials")].isNull() && m_upload_credentials_isValid;
...
QString OAIRequestUploadCredentialsOutput::asJson() const {
...
QJsonObject OAIRequestUploadCredentialsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_upload_credentials.isSet()) {
        obj.insert(QString("UploadCredentials"), ::OpenAPI::toJsonValue(m_upload_credentials));
    }
...
OAIRequestUploadCredentialsOutput_UploadCredentials OAIRequestUploadCredentialsOutput::getUploadCredentials() const {
    return m_upload_credentials;
}
void OAIRequestUploadCredentialsOutput::setUploadCredentials(const OAIRequestUploadCredentialsOutput_UploadCredentials &upload_credentials) {
    m_upload_credentials = upload_credentials;
    m_upload_credentials_isSet = true;
}

bool OAIRequestUploadCredentialsOutput::is_upload_credentials_Set() const{
    return m_upload_credentials_isSet;
}

bool OAIRequestUploadCredentialsOutput::is_upload_credentials_Valid() const{
    return m_upload_credentials_isValid;
}

OAIRequestUploadCredentialsOutput_StorageLocation OAIRequestUploadCredentialsOutput::getStorageLocation() const {
    return m_storage_location;
}
void OAIRequestUploadCredentialsOutput::setStorageLocation(const OAIRequestUploadCredentialsOutput_StorageLocation &storage_location) {
    m_storage_location = storage_location;
    m_storage_location_isSet = true;
}

bool OAIRequestUploadCredentialsOutput::is_storage_location_Set() const{
    return m_storage_location_isSet;
}

bool OAIRequestUploadCredentialsOutput::is_storage_location_Valid() const{
    return m_storage_location_isValid;
}

bool OAIRequestUploadCredentialsOutput::isSet() const {
...
bool OAIRequestUploadCredentialsOutput::isValid() const {
