...
void OAIPlayer::initializeModel() {
    ...
    m_player_attributes_isSet = false;
    m_player_attributes_isValid = false;

    m_team_isSet = false;
    m_team_isValid = false;

    m_latency_in_ms_isSet = false;
    m_latency_in_ms_isValid = false;
}
...
void OAIPlayer::fromJsonObject(QJsonObject json) {
    ...
    m_player_attributes_isValid = ::OpenAPI::fromJsonValue(m_player_attributes, json[QString("PlayerAttributes")]);
    m_player_attributes_isSet = !json[QString("PlayerAttributes")].isNull() && m_player_attributes_isValid;

    m_team_isValid = ::OpenAPI::fromJsonValue(m_team, json[QString("Team")]);
    m_team_isSet = !json[QString("Team")].isNull() && m_team_isValid;

    m_latency_in_ms_isValid = ::OpenAPI::fromJsonValue(m_latency_in_ms, json[QString("LatencyInMs")]);
    m_latency_in_ms_isSet = !json[QString("LatencyInMs")].isNull() && m_latency_in_ms_isValid;
}
...
QJsonObject OAIPlayer::asJsonObject() const {
    ...
    if (m_player_attributes.isSet()) {
        obj.insert(QString("PlayerAttributes"), ::OpenAPI::toJsonValue(m_player_attributes));
    }
    if (m_team_isSet) {
        obj.insert(QString("Team"), ::OpenAPI::toJsonValue(m_team));
    }
    if (m_latency_in_ms.isSet()) {
        obj.insert(QString("LatencyInMs"), ::OpenAPI::toJsonValue(m_latency_in_ms));
    }
    return obj;
}
...
QMap OAIPlayer::getPlayerAttributes() const {
    return m_player_attributes;
}
void OAIPlayer::setPlayerAttributes(const QMap &player_attributes) {
    m_player_attributes = player_attributes;
    m_player_attributes_isSet = true;
}

bool OAIPlayer::is_player_attributes_Set() const{
    return m_player_attributes_isSet;
}

bool OAIPlayer::is_player_attributes_Valid() const{
    return m_player_attributes_isValid;
}
...
QMap OAIPlayer::getLatencyInMs() const {
    return m_latency_in_ms;
}
void OAIPlayer::setLatencyInMs(const QMap &latency_in_ms) {
    m_latency_in_ms = latency_in_ms;
    m_latency_in_ms_isSet = true;
}

bool OAIPlayer::is_latency_in_ms_Set() const{
    return m_latency_in_ms_isSet;
}

bool OAIPlayer::is_latency_in_ms_Valid() const{
    return m_latency_in_ms_isValid;
}
