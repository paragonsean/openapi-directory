...
#ifndef OAIFlexMatchMode_H
#define OAIFlexMatchMode_H
...
class OAIFlexMatchMode : public OAIEnum {
public:
    OAIFlexMatchMode();
    OAIFlexMatchMode(QString json);
    ~OAIFlexMatchMode() override;
    ...
    enum class eOAIFlexMatchMode {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        STANDALONE, 
        WITH_QUEUE
    };
    OAIFlexMatchMode::eOAIFlexMatchMode getValue() const;
    void setValue(const OAIFlexMatchMode::eOAIFlexMatchMode& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFlexMatchMode)

#endif // OAIFlexMatchMode_H
