...
/*
 * OAIClaimGameServerOutput_GameServer.h
 *
 * 
 */

#ifndef OAIClaimGameServerOutput_GameServer_H
#define OAIClaimGameServerOutput_GameServer_H
...
class OAIClaimGameServerOutput_GameServer : public OAIObject {
public:
    OAIClaimGameServerOutput_GameServer();
    OAIClaimGameServerOutput_GameServer(QString json);
    ~OAIClaimGameServerOutput_GameServer() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClaimGameServerOutput_GameServer)

#endif // OAIClaimGameServerOutput_GameServer_H
