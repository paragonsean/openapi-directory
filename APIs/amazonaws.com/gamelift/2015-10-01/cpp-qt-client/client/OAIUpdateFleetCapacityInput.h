...
/*
 * OAIUpdateFleetCapacityInput.h
 *
 * 
 */

#ifndef OAIUpdateFleetCapacityInput_H
#define OAIUpdateFleetCapacityInput_H
...
class OAIUpdateFleetCapacityInput : public OAIObject {
public:
    OAIUpdateFleetCapacityInput();
    OAIUpdateFleetCapacityInput(QString json);
    ~OAIUpdateFleetCapacityInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFleetCapacityInput)

#endif // OAIUpdateFleetCapacityInput_H
