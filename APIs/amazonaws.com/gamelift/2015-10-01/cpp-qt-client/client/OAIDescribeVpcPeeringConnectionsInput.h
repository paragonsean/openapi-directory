...
/*
 * OAIDescribeVpcPeeringConnectionsInput.h
 *
 * 
 */

#ifndef OAIDescribeVpcPeeringConnectionsInput_H
#define OAIDescribeVpcPeeringConnectionsInput_H
...
class OAIDescribeVpcPeeringConnectionsInput : public OAIObject {
public:
    OAIDescribeVpcPeeringConnectionsInput();
    OAIDescribeVpcPeeringConnectionsInput(QString json);
    ~OAIDescribeVpcPeeringConnectionsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeVpcPeeringConnectionsInput)

#endif // OAIDescribeVpcPeeringConnectionsInput_H
