...
OAIRoutingStrategyType::OAIRoutingStrategyType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRoutingStrategyType::OAIRoutingStrategyType() {
    this->initializeModel();
}

OAIRoutingStrategyType::~OAIRoutingStrategyType() {}

void OAIRoutingStrategyType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIRoutingStrategyType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIRoutingStrategyType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("SIMPLE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRoutingStrategyType::SIMPLE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("TERMINAL", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRoutingStrategyType::TERMINAL;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIRoutingStrategyType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIRoutingStrategyType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIRoutingStrategyType::SIMPLE:
            val = "SIMPLE";
            break;
        case eOAIRoutingStrategyType::TERMINAL:
            val = "TERMINAL";
            break;
        default:
            break;
...
QJsonValue OAIRoutingStrategyType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIRoutingStrategyType::eOAIRoutingStrategyType OAIRoutingStrategyType::getValue() const {
    return m_value;
}

void OAIRoutingStrategyType::setValue(const OAIRoutingStrategyType::eOAIRoutingStrategyType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIRoutingStrategyType::isSet() const {
    
    return m_value_isSet;
}

bool OAIRoutingStrategyType::isValid() const {
