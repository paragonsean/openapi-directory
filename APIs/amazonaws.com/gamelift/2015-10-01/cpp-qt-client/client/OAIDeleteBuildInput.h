...
/*
 * OAIDeleteBuildInput.h
 *
 * 
 */

#ifndef OAIDeleteBuildInput_H
#define OAIDeleteBuildInput_H
...
class OAIDeleteBuildInput : public OAIObject {
public:
    OAIDeleteBuildInput();
    OAIDeleteBuildInput(QString json);
    ~OAIDeleteBuildInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteBuildInput)

#endif // OAIDeleteBuildInput_H
