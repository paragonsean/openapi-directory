...
/*
 * OAIDeleteScriptInput.h
 *
 * 
 */

#ifndef OAIDeleteScriptInput_H
#define OAIDeleteScriptInput_H
...
class OAIDeleteScriptInput : public OAIObject {
public:
    OAIDeleteScriptInput();
    OAIDeleteScriptInput(QString json);
    ~OAIDeleteScriptInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteScriptInput)

#endif // OAIDeleteScriptInput_H
