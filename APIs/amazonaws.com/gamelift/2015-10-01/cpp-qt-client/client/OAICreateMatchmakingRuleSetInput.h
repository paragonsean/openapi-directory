...
/*
 * OAICreateMatchmakingRuleSetInput.h
 *
 * 
 */

#ifndef OAICreateMatchmakingRuleSetInput_H
#define OAICreateMatchmakingRuleSetInput_H
...
class OAICreateMatchmakingRuleSetInput : public OAIObject {
public:
    OAICreateMatchmakingRuleSetInput();
    OAICreateMatchmakingRuleSetInput(QString json);
    ~OAICreateMatchmakingRuleSetInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMatchmakingRuleSetInput)

#endif // OAICreateMatchmakingRuleSetInput_H
