...
/*
 * OAIStartMatchBackfillInput.h
 *
 * 
 */

#ifndef OAIStartMatchBackfillInput_H
#define OAIStartMatchBackfillInput_H
...
class OAIStartMatchBackfillInput : public OAIObject {
public:
    OAIStartMatchBackfillInput();
    OAIStartMatchBackfillInput(QString json);
    ~OAIStartMatchBackfillInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartMatchBackfillInput)

#endif // OAIStartMatchBackfillInput_H
