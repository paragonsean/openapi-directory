...
OAIPlayerSessionStatus::OAIPlayerSessionStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPlayerSessionStatus::OAIPlayerSessionStatus() {
    this->initializeModel();
}

OAIPlayerSessionStatus::~OAIPlayerSessionStatus() {}

void OAIPlayerSessionStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIPlayerSessionStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIPlayerSessionStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("RESERVED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPlayerSessionStatus::RESERVED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ACTIVE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPlayerSessionStatus::ACTIVE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("COMPLETED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPlayerSessionStatus::COMPLETED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("TIMEDOUT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPlayerSessionStatus::TIMEDOUT;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIPlayerSessionStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIPlayerSessionStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIPlayerSessionStatus::RESERVED:
            val = "RESERVED";
            break;
        case eOAIPlayerSessionStatus::ACTIVE:
            val = "ACTIVE";
            break;
        case eOAIPlayerSessionStatus::COMPLETED:
            val = "COMPLETED";
            break;
        case eOAIPlayerSessionStatus::TIMEDOUT:
            val = "TIMEDOUT";
            break;
        default:
            break;
...
QJsonValue OAIPlayerSessionStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIPlayerSessionStatus::eOAIPlayerSessionStatus OAIPlayerSessionStatus::getValue() const {
    return m_value;
}

void OAIPlayerSessionStatus::setValue(const OAIPlayerSessionStatus::eOAIPlayerSessionStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIPlayerSessionStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIPlayerSessionStatus::isValid() const {
