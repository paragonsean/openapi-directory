...
OAIUpdateFleetAttributesOutput::OAIUpdateFleetAttributesOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateFleetAttributesOutput::OAIUpdateFleetAttributesOutput() {
    this->initializeModel();
}

OAIUpdateFleetAttributesOutput::~OAIUpdateFleetAttributesOutput() {}

void OAIUpdateFleetAttributesOutput::initializeModel() {
...
void OAIUpdateFleetAttributesOutput::fromJson(QString jsonString) {
...
void OAIUpdateFleetAttributesOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateFleetAttributesOutput::asJson() const {
...
QJsonObject OAIUpdateFleetAttributesOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
...
QString OAIUpdateFleetAttributesOutput::getFleetId() const {
    return m_fleet_id;
}
void OAIUpdateFleetAttributesOutput::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIUpdateFleetAttributesOutput::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIUpdateFleetAttributesOutput::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

QString OAIUpdateFleetAttributesOutput::getFleetArn() const {
    return m_fleet_arn;
}
void OAIUpdateFleetAttributesOutput::setFleetArn(const QString &fleet_arn) {
    m_fleet_arn = fleet_arn;
    m_fleet_arn_isSet = true;
}

bool OAIUpdateFleetAttributesOutput::is_fleet_arn_Set() const{
    return m_fleet_arn_isSet;
}

bool OAIUpdateFleetAttributesOutput::is_fleet_arn_Valid() const{
    return m_fleet_arn_isValid;
}

bool OAIUpdateFleetAttributesOutput::isSet() const {
...
bool OAIUpdateFleetAttributesOutput::isValid() const {
