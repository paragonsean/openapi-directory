...
/*
 * OAIUpdateGameServerGroupInput.h
 *
 * 
 */

#ifndef OAIUpdateGameServerGroupInput_H
#define OAIUpdateGameServerGroupInput_H
...
class OAIUpdateGameServerGroupInput : public OAIObject {
public:
    OAIUpdateGameServerGroupInput();
    OAIUpdateGameServerGroupInput(QString json);
    ~OAIUpdateGameServerGroupInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateGameServerGroupInput)

#endif // OAIUpdateGameServerGroupInput_H
