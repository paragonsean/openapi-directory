...
OAIListFleetsOutput::OAIListFleetsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListFleetsOutput::OAIListFleetsOutput() {
    this->initializeModel();
}

OAIListFleetsOutput::~OAIListFleetsOutput() {}

void OAIListFleetsOutput::initializeModel() {
...
void OAIListFleetsOutput::fromJson(QString jsonString) {
...
void OAIListFleetsOutput::fromJsonObject(QJsonObject json) {
...
QString OAIListFleetsOutput::asJson() const {
...
QJsonObject OAIListFleetsOutput::asJsonObject() const {
    QJsonObject obj;
...
QList OAIListFleetsOutput::getFleetIds() const {
    return m_fleet_ids;
}
void OAIListFleetsOutput::setFleetIds(const QList &fleet_ids) {
    m_fleet_ids = fleet_ids;
    m_fleet_ids_isSet = true;
}

bool OAIListFleetsOutput::is_fleet_ids_Set() const{
    return m_fleet_ids_isSet;
}

bool OAIListFleetsOutput::is_fleet_ids_Valid() const{
    return m_fleet_ids_isValid;
}

QString OAIListFleetsOutput::getNextToken() const {
    return m_next_token;
}
void OAIListFleetsOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListFleetsOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListFleetsOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListFleetsOutput::isSet() const {
...
bool OAIListFleetsOutput::isValid() const {
