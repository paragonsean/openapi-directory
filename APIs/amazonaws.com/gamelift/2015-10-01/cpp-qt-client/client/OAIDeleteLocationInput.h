...
/*
 * OAIDeleteLocationInput.h
 *
 * 
 */

#ifndef OAIDeleteLocationInput_H
#define OAIDeleteLocationInput_H
...
class OAIDeleteLocationInput : public OAIObject {
public:
    OAIDeleteLocationInput();
    OAIDeleteLocationInput(QString json);
    ~OAIDeleteLocationInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteLocationInput)

#endif // OAIDeleteLocationInput_H
