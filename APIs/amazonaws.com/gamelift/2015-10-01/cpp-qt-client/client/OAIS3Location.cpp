...
QString OAIS3Location::getRoleArn() const {
    return m_role_arn;
}
void OAIS3Location::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIS3Location::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIS3Location::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

QString OAIS3Location::getObjectVersion() const {
    return m_object_version;
}
void OAIS3Location::setObjectVersion(const QString &object_version) {
    m_object_version = object_version;
    m_object_version_isSet = true;
}

bool OAIS3Location::is_object_version_Set() const{
    return m_object_version_isSet;
}

bool OAIS3Location::is_object_version_Valid() const{
