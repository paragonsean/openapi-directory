...
/*
 * OAIGetComputeAuthTokenInput.h
 *
 * 
 */

#ifndef OAIGetComputeAuthTokenInput_H
#define OAIGetComputeAuthTokenInput_H
...
class OAIGetComputeAuthTokenInput : public OAIObject {
public:
    OAIGetComputeAuthTokenInput();
    OAIGetComputeAuthTokenInput(QString json);
    ~OAIGetComputeAuthTokenInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetComputeAuthTokenInput)

#endif // OAIGetComputeAuthTokenInput_H
