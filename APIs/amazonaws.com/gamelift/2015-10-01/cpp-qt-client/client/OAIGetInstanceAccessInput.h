...
/*
 * OAIGetInstanceAccessInput.h
 *
 * 
 */

#ifndef OAIGetInstanceAccessInput_H
#define OAIGetInstanceAccessInput_H
...
class OAIGetInstanceAccessInput : public OAIObject {
public:
    OAIGetInstanceAccessInput();
    OAIGetInstanceAccessInput(QString json);
    ~OAIGetInstanceAccessInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetInstanceAccessInput)

#endif // OAIGetInstanceAccessInput_H
