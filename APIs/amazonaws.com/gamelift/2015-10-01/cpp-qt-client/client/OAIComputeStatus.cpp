...
OAIComputeStatus::OAIComputeStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIComputeStatus::OAIComputeStatus() {
    this->initializeModel();
}

OAIComputeStatus::~OAIComputeStatus() {}

void OAIComputeStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIComputeStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIComputeStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("PENDING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIComputeStatus::PENDING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ACTIVE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIComputeStatus::ACTIVE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("TERMINATING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIComputeStatus::TERMINATING;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIComputeStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIComputeStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIComputeStatus::PENDING:
            val = "PENDING";
            break;
        case eOAIComputeStatus::ACTIVE:
            val = "ACTIVE";
            break;
        case eOAIComputeStatus::TERMINATING:
            val = "TERMINATING";
            break;
        default:
            break;
...
QJsonValue OAIComputeStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIComputeStatus::eOAIComputeStatus OAIComputeStatus::getValue() const {
    return m_value;
}

void OAIComputeStatus::setValue(const OAIComputeStatus::eOAIComputeStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIComputeStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIComputeStatus::isValid() const {
