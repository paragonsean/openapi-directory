...
OAIGameServerGroupAutoScalingPolicy_TargetTrackingConfiguration::OAIGameServerGroupAutoScalingPolicy_TargetTrackingConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGameServerGroupAutoScalingPolicy_TargetTrackingConfiguration::OAIGameServerGroupAutoScalingPolicy_TargetTrackingConfiguration() {
    this->initializeModel();
}

OAIGameServerGroupAutoScalingPolicy_TargetTrackingConfiguration::~OAIGameServerGroupAutoScalingPolicy_TargetTrackingConfiguration() {}

void OAIGameServerGroupAutoScalingPolicy_TargetTrackingConfiguration::initializeModel() {

    m_target_value_isSet = false;
    m_target_value_isValid = false;
}

void OAIGameServerGroupAutoScalingPolicy_TargetTrackingConfiguration::fromJson(QString jsonString) {
...
void OAIGameServerGroupAutoScalingPolicy_TargetTrackingConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIGameServerGroupAutoScalingPolicy_TargetTrackingConfiguration::asJson() const {
...
QJsonObject OAIGameServerGroupAutoScalingPolicy_TargetTrackingConfiguration::asJsonObject() const {
    QJsonObject obj;
...
double OAIGameServerGroupAutoScalingPolicy_TargetTrackingConfiguration::getTargetValue() const {
    return m_target_value;
}
void OAIGameServerGroupAutoScalingPolicy_TargetTrackingConfiguration::setTargetValue(const double &target_value) {
    m_target_value = target_value;
    m_target_value_isSet = true;
}

bool OAIGameServerGroupAutoScalingPolicy_TargetTrackingConfiguration::is_target_value_Set() const{
    return m_target_value_isSet;
}

bool OAIGameServerGroupAutoScalingPolicy_TargetTrackingConfiguration::is_target_value_Valid() const{
    return m_target_value_isValid;
}

bool OAIGameServerGroupAutoScalingPolicy_TargetTrackingConfiguration::isSet() const {
...
bool OAIGameServerGroupAutoScalingPolicy_TargetTrackingConfiguration::isValid() const {
