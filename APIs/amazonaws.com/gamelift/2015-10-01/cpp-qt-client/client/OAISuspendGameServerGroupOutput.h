...
/*
 * OAISuspendGameServerGroupOutput.h
 *
 * 
 */

#ifndef OAISuspendGameServerGroupOutput_H
#define OAISuspendGameServerGroupOutput_H
...
namespace OpenAPI {
class OAISuspendGameServerGroupOutput_GameServerGroup;

class OAISuspendGameServerGroupOutput : public OAIObject {
public:
    OAISuspendGameServerGroupOutput();
    OAISuspendGameServerGroupOutput(QString json);
    ~OAISuspendGameServerGroupOutput() override;
    ...
    OAISuspendGameServerGroupOutput_GameServerGroup getGameServerGroup() const;
    void setGameServerGroup(const OAISuspendGameServerGroupOutput_GameServerGroup &game_server_group);
...
private:
    ...
    OAISuspendGameServerGroupOutput_GameServerGroup m_game_server_group;
...
Q_DECLARE_METATYPE(OpenAPI::OAISuspendGameServerGroupOutput)

#endif // OAISuspendGameServerGroupOutput_H
