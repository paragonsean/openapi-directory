...
/*
 * OAIDescribeGameSessionQueuesOutput.h
 *
 * 
 */

#ifndef OAIDescribeGameSessionQueuesOutput_H
#define OAIDescribeGameSessionQueuesOutput_H
...
class OAIDescribeGameSessionQueuesOutput : public OAIObject {
public:
    OAIDescribeGameSessionQueuesOutput();
    OAIDescribeGameSessionQueuesOutput(QString json);
    ~OAIDescribeGameSessionQueuesOutput() override;
    ...
    QList getGameSessionQueues() const;
    void setGameSessionQueues(const QList &game_session_queues);
    bool is_game_session_queues_Set() const;
    bool is_game_session_queues_Valid() const;
...
private:
    ...
    QList m_game_session_queues;
    bool m_game_session_queues_isSet;
    bool m_game_session_queues_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeGameSessionQueuesOutput)

#endif // OAIDescribeGameSessionQueuesOutput_H
