...
/*
 * OAIDeregisterComputeInput.h
 *
 * 
 */

#ifndef OAIDeregisterComputeInput_H
#define OAIDeregisterComputeInput_H
...
class OAIDeregisterComputeInput : public OAIObject {
public:
    OAIDeregisterComputeInput();
    OAIDeregisterComputeInput(QString json);
    ~OAIDeregisterComputeInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeregisterComputeInput)

#endif // OAIDeregisterComputeInput_H
