...
/*
 * OAIRegisterGameServerInput.h
 *
 * 
 */

#ifndef OAIRegisterGameServerInput_H
#define OAIRegisterGameServerInput_H
...
class OAIRegisterGameServerInput : public OAIObject {
public:
    OAIRegisterGameServerInput();
    OAIRegisterGameServerInput(QString json);
    ~OAIRegisterGameServerInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegisterGameServerInput)

#endif // OAIRegisterGameServerInput_H
