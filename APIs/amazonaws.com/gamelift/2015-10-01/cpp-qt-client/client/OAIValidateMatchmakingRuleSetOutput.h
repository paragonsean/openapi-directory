...
/*
 * OAIValidateMatchmakingRuleSetOutput.h
 *
 * 
 */

#ifndef OAIValidateMatchmakingRuleSetOutput_H
#define OAIValidateMatchmakingRuleSetOutput_H
...
class OAIValidateMatchmakingRuleSetOutput : public OAIObject {
public:
    OAIValidateMatchmakingRuleSetOutput();
    OAIValidateMatchmakingRuleSetOutput(QString json);
    ~OAIValidateMatchmakingRuleSetOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIValidateMatchmakingRuleSetOutput)

#endif // OAIValidateMatchmakingRuleSetOutput_H
