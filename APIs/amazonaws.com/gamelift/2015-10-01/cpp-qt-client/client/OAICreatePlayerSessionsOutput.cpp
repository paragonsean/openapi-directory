...
OAICreatePlayerSessionsOutput::OAICreatePlayerSessionsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreatePlayerSessionsOutput::OAICreatePlayerSessionsOutput() {
    this->initializeModel();
}

OAICreatePlayerSessionsOutput::~OAICreatePlayerSessionsOutput() {}

void OAICreatePlayerSessionsOutput::initializeModel() {

    m_player_sessions_isSet = false;
    m_player_sessions_isValid = false;
}

void OAICreatePlayerSessionsOutput::fromJson(QString jsonString) {
...
void OAICreatePlayerSessionsOutput::fromJsonObject(QJsonObject json) {
...
QString OAICreatePlayerSessionsOutput::asJson() const {
...
QJsonObject OAICreatePlayerSessionsOutput::asJsonObject() const {
    QJsonObject obj;
...
QList OAICreatePlayerSessionsOutput::getPlayerSessions() const {
    return m_player_sessions;
}
void OAICreatePlayerSessionsOutput::setPlayerSessions(const QList &player_sessions) {
    m_player_sessions = player_sessions;
    m_player_sessions_isSet = true;
}

bool OAICreatePlayerSessionsOutput::is_player_sessions_Set() const{
    return m_player_sessions_isSet;
}

bool OAICreatePlayerSessionsOutput::is_player_sessions_Valid() const{
    return m_player_sessions_isValid;
}

bool OAICreatePlayerSessionsOutput::isSet() const {
...
bool OAICreatePlayerSessionsOutput::isValid() const {
