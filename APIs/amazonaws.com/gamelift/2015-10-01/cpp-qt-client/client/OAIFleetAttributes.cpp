...
OAIFleetAttributes::OAIFleetAttributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFleetAttributes::OAIFleetAttributes() {
    this->initializeModel();
}

OAIFleetAttributes::~OAIFleetAttributes() {}

void OAIFleetAttributes::initializeModel() {
...
void OAIFleetAttributes::fromJson(QString jsonString) {
...
void OAIFleetAttributes::fromJsonObject(QJsonObject json) {
...
QString OAIFleetAttributes::asJson() const {
...
QJsonObject OAIFleetAttributes::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
...
QString OAIFleetAttributes::getFleetId() const {
    return m_fleet_id;
}
void OAIFleetAttributes::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIFleetAttributes::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIFleetAttributes::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

QString OAIFleetAttributes::getFleetArn() const {
    return m_fleet_arn;
}
void OAIFleetAttributes::setFleetArn(const QString &fleet_arn) {
    m_fleet_arn = fleet_arn;
    m_fleet_arn_isSet = true;
}

bool OAIFleetAttributes::is_fleet_arn_Set() const{
    return m_fleet_arn_isSet;
}

bool OAIFleetAttributes::is_fleet_arn_Valid() const{
    return m_fleet_arn_isValid;
}

OAIFleetType OAIFleetAttributes::getFleetType() const {
    return m_fleet_type;
}
void OAIFleetAttributes::setFleetType(const OAIFleetType &fleet_type) {
    m_fleet_type = fleet_type;
    m_fleet_type_isSet = true;
}

bool OAIFleetAttributes::is_fleet_type_Set() const{
    return m_fleet_type_isSet;
}

bool OAIFleetAttributes::is_fleet_type_Valid() const{
    return m_fleet_type_isValid;
}

OAIEC2InstanceType OAIFleetAttributes::getInstanceType() const {
    return m_instance_type;
}
void OAIFleetAttributes::setInstanceType(const OAIEC2InstanceType &instance_type) {
    m_instance_type = instance_type;
    m_instance_type_isSet = true;
}

bool OAIFleetAttributes::is_instance_type_Set() const{
    return m_instance_type_isSet;
}

bool OAIFleetAttributes::is_instance_type_Valid() const{
    return m_instance_type_isValid;
}

QString OAIFleetAttributes::getDescription() const {
    return m_description;
}
void OAIFleetAttributes::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIFleetAttributes::is_description_Set() const{
    return m_description_isSet;
}

bool OAIFleetAttributes::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIFleetAttributes::getName() const {
    return m_name;
}
void OAIFleetAttributes::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIFleetAttributes::is_name_Set() const{
    return m_name_isSet;
}

bool OAIFleetAttributes::is_name_Valid() const{
    return m_name_isValid;
}

QDateTime OAIFleetAttributes::getCreationTime() const {
    return m_creation_time;
}
void OAIFleetAttributes::setCreationTime(const QDateTime &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAIFleetAttributes::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAIFleetAttributes::is_creation_time_Valid() const{
    return m_creation_time_isValid;
}

QDateTime OAIFleetAttributes::getTerminationTime() const {
    return m_termination_time;
}
void OAIFleetAttributes::setTerminationTime(const QDateTime &termination_time) {
    m_termination_time = termination_time;
    m_termination_time_isSet = true;
}

bool OAIFleetAttributes::is_termination_time_Set() const{
    return m_termination_time_isSet;
}

bool OAIFleetAttributes::is_termination_time_Valid() const{
    return m_termination_time_isValid;
}

OAIFleetStatus OAIFleetAttributes::getStatus() const {
    return m_status;
}
void OAIFleetAttributes::setStatus(const OAIFleetStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIFleetAttributes::is_status_Set() const{
    return m_status_isSet;
}

bool OAIFleetAttributes::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIFleetAttributes::getBuildId() const {
    return m_build_id;
}
void OAIFleetAttributes::setBuildId(const QString &build_id) {
    m_build_id = build_id;
    m_build_id_isSet = true;
}

bool OAIFleetAttributes::is_build_id_Set() const{
    return m_build_id_isSet;
}

bool OAIFleetAttributes::is_build_id_Valid() const{
    return m_build_id_isValid;
}

QString OAIFleetAttributes::getBuildArn() const {
    return m_build_arn;
}
void OAIFleetAttributes::setBuildArn(const QString &build_arn) {
    m_build_arn = build_arn;
    m_build_arn_isSet = true;
}

bool OAIFleetAttributes::is_build_arn_Set() const{
    return m_build_arn_isSet;
}

bool OAIFleetAttributes::is_build_arn_Valid() const{
    return m_build_arn_isValid;
}

QString OAIFleetAttributes::getScriptId() const {
    return m_script_id;
}
void OAIFleetAttributes::setScriptId(const QString &script_id) {
    m_script_id = script_id;
    m_script_id_isSet = true;
}

bool OAIFleetAttributes::is_script_id_Set() const{
    return m_script_id_isSet;
}

bool OAIFleetAttributes::is_script_id_Valid() const{
    return m_script_id_isValid;
}

QString OAIFleetAttributes::getScriptArn() const {
    return m_script_arn;
}
void OAIFleetAttributes::setScriptArn(const QString &script_arn) {
    m_script_arn = script_arn;
    m_script_arn_isSet = true;
}

bool OAIFleetAttributes::is_script_arn_Set() const{
    return m_script_arn_isSet;
}

bool OAIFleetAttributes::is_script_arn_Valid() const{
    return m_script_arn_isValid;
}

QString OAIFleetAttributes::getServerLaunchPath() const {
    return m_server_launch_path;
}
void OAIFleetAttributes::setServerLaunchPath(const QString &server_launch_path) {
    m_server_launch_path = server_launch_path;
    m_server_launch_path_isSet = true;
}

bool OAIFleetAttributes::is_server_launch_path_Set() const{
    return m_server_launch_path_isSet;
}

bool OAIFleetAttributes::is_server_launch_path_Valid() const{
    return m_server_launch_path_isValid;
}

QString OAIFleetAttributes::getServerLaunchParameters() const {
    return m_server_launch_parameters;
}
void OAIFleetAttributes::setServerLaunchParameters(const QString &server_launch_parameters) {
    m_server_launch_parameters = server_launch_parameters;
    m_server_launch_parameters_isSet = true;
}

bool OAIFleetAttributes::is_server_launch_parameters_Set() const{
    return m_server_launch_parameters_isSet;
}

bool OAIFleetAttributes::is_server_launch_parameters_Valid() const{
    return m_server_launch_parameters_isValid;
}

QList OAIFleetAttributes::getLogPaths() const {
    return m_log_paths;
}
void OAIFleetAttributes::setLogPaths(const QList &log_paths) {
    m_log_paths = log_paths;
    m_log_paths_isSet = true;
}

bool OAIFleetAttributes::is_log_paths_Set() const{
    return m_log_paths_isSet;
}

bool OAIFleetAttributes::is_log_paths_Valid() const{
    return m_log_paths_isValid;
}

OAIProtectionPolicy OAIFleetAttributes::getNewGameSessionProtectionPolicy() const {
    return m_new_game_session_protection_policy;
}
void OAIFleetAttributes::setNewGameSessionProtectionPolicy(const OAIProtectionPolicy &new_game_session_protection_policy) {
    m_new_game_session_protection_policy = new_game_session_protection_policy;
    m_new_game_session_protection_policy_isSet = true;
}

bool OAIFleetAttributes::is_new_game_session_protection_policy_Set() const{
    return m_new_game_session_protection_policy_isSet;
}

bool OAIFleetAttributes::is_new_game_session_protection_policy_Valid() const{
    return m_new_game_session_protection_policy_isValid;
}

OAIOperatingSystem OAIFleetAttributes::getOperatingSystem() const {
    return m_operating_system;
}
void OAIFleetAttributes::setOperatingSystem(const OAIOperatingSystem &operating_system) {
    m_operating_system = operating_system;
    m_operating_system_isSet = true;
}

bool OAIFleetAttributes::is_operating_system_Set() const{
    return m_operating_system_isSet;
}

bool OAIFleetAttributes::is_operating_system_Valid() const{
    return m_operating_system_isValid;
}

OAIResourceCreationLimitPolicy OAIFleetAttributes::getResourceCreationLimitPolicy() const {
    return m_resource_creation_limit_policy;
}
void OAIFleetAttributes::setResourceCreationLimitPolicy(const OAIResourceCreationLimitPolicy &resource_creation_limit_policy) {
    m_resource_creation_limit_policy = resource_creation_limit_policy;
    m_resource_creation_limit_policy_isSet = true;
}

bool OAIFleetAttributes::is_resource_creation_limit_policy_Set() const{
    return m_resource_creation_limit_policy_isSet;
}

bool OAIFleetAttributes::is_resource_creation_limit_policy_Valid() const{
    return m_resource_creation_limit_policy_isValid;
}

QList OAIFleetAttributes::getMetricGroups() const {
    return m_metric_groups;
}
void OAIFleetAttributes::setMetricGroups(const QList &metric_groups) {
    m_metric_groups = metric_groups;
    m_metric_groups_isSet = true;
}

bool OAIFleetAttributes::is_metric_groups_Set() const{
    return m_metric_groups_isSet;
}

bool OAIFleetAttributes::is_metric_groups_Valid() const{
    return m_metric_groups_isValid;
}

QList OAIFleetAttributes::getStoppedActions() const {
    return m_stopped_actions;
}
void OAIFleetAttributes::setStoppedActions(const QList &stopped_actions) {
    m_stopped_actions = stopped_actions;
    m_stopped_actions_isSet = true;
}

bool OAIFleetAttributes::is_stopped_actions_Set() const{
    return m_stopped_actions_isSet;
}

bool OAIFleetAttributes::is_stopped_actions_Valid() const{
    return m_stopped_actions_isValid;
}

QString OAIFleetAttributes::getInstanceRoleArn() const {
    return m_instance_role_arn;
}
void OAIFleetAttributes::setInstanceRoleArn(const QString &instance_role_arn) {
    m_instance_role_arn = instance_role_arn;
    m_instance_role_arn_isSet = true;
}

bool OAIFleetAttributes::is_instance_role_arn_Set() const{
    return m_instance_role_arn_isSet;
}

bool OAIFleetAttributes::is_instance_role_arn_Valid() const{
    return m_instance_role_arn_isValid;
}

OAICertificateConfiguration OAIFleetAttributes::getCertificateConfiguration() const {
    return m_certificate_configuration;
}
void OAIFleetAttributes::setCertificateConfiguration(const OAICertificateConfiguration &certificate_configuration) {
    m_certificate_configuration = certificate_configuration;
    m_certificate_configuration_isSet = true;
}

bool OAIFleetAttributes::is_certificate_configuration_Set() const{
    return m_certificate_configuration_isSet;
}

bool OAIFleetAttributes::is_certificate_configuration_Valid() const{
    return m_certificate_configuration_isValid;
}

OAIComputeType OAIFleetAttributes::getComputeType() const {
    return m_compute_type;
}
void OAIFleetAttributes::setComputeType(const OAIComputeType &compute_type) {
    m_compute_type = compute_type;
    m_compute_type_isSet = true;
}

bool OAIFleetAttributes::is_compute_type_Set() const{
    return m_compute_type_isSet;
}

bool OAIFleetAttributes::is_compute_type_Valid() const{
    return m_compute_type_isValid;
}

OAIAnywhereConfiguration OAIFleetAttributes::getAnywhereConfiguration() const {
    return m_anywhere_configuration;
}
void OAIFleetAttributes::setAnywhereConfiguration(const OAIAnywhereConfiguration &anywhere_configuration) {
    m_anywhere_configuration = anywhere_configuration;
    m_anywhere_configuration_isSet = true;
}

bool OAIFleetAttributes::is_anywhere_configuration_Set() const{
    return m_anywhere_configuration_isSet;
}

bool OAIFleetAttributes::is_anywhere_configuration_Valid() const{
    return m_anywhere_configuration_isValid;
}

bool OAIFleetAttributes::isSet() const {
...
bool OAIFleetAttributes::isValid() const {
