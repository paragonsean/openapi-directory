...
OAIDeleteBuildInput::OAIDeleteBuildInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteBuildInput::OAIDeleteBuildInput() {
    this->initializeModel();
}

OAIDeleteBuildInput::~OAIDeleteBuildInput() {}

void OAIDeleteBuildInput::initializeModel() {

    m_build_id_isSet = false;
    m_build_id_isValid = false;
}

void OAIDeleteBuildInput::fromJson(QString jsonString) {
...
void OAIDeleteBuildInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteBuildInput::asJson() const {
...
QJsonObject OAIDeleteBuildInput::asJsonObject() const {
    QJsonObject obj;
    if (m_build_id_isSet) {
...
QString OAIDeleteBuildInput::getBuildId() const {
    return m_build_id;
}
void OAIDeleteBuildInput::setBuildId(const QString &build_id) {
    m_build_id = build_id;
    m_build_id_isSet = true;
}

bool OAIDeleteBuildInput::is_build_id_Set() const{
    return m_build_id_isSet;
}

bool OAIDeleteBuildInput::is_build_id_Valid() const{
    return m_build_id_isValid;
}

bool OAIDeleteBuildInput::isSet() const {
...
bool OAIDeleteBuildInput::isValid() const {
