...
#include "OAIGameServerGroupAutoScalingPolicy.h"
...
OAIGameServerGroupAutoScalingPolicy::OAIGameServerGroupAutoScalingPolicy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGameServerGroupAutoScalingPolicy::OAIGameServerGroupAutoScalingPolicy() {
    this->initializeModel();
}

OAIGameServerGroupAutoScalingPolicy::~OAIGameServerGroupAutoScalingPolicy() {}

void OAIGameServerGroupAutoScalingPolicy::initializeModel() {
...
void OAIGameServerGroupAutoScalingPolicy::fromJson(QString jsonString) {
...
void OAIGameServerGroupAutoScalingPolicy::fromJsonObject(QJsonObject json) {
...
QString OAIGameServerGroupAutoScalingPolicy::asJson() const {
...
QJsonObject OAIGameServerGroupAutoScalingPolicy::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIGameServerGroupAutoScalingPolicy::getEstimatedInstanceWarmup() const {
    return m_estimated_instance_warmup;
}
void OAIGameServerGroupAutoScalingPolicy::setEstimatedInstanceWarmup(const qint32 &estimated_instance_warmup) {
    m_estimated_instance_warmup = estimated_instance_warmup;
    m_estimated_instance_warmup_isSet = true;
}

bool OAIGameServerGroupAutoScalingPolicy::is_estimated_instance_warmup_Set() const{
    return m_estimated_instance_warmup_isSet;
}

bool OAIGameServerGroupAutoScalingPolicy::is_estimated_instance_warmup_Valid() const{
    return m_estimated_instance_warmup_isValid;
}

OAIGameServerGroupAutoScalingPolicy_TargetTrackingConfiguration OAIGameServerGroupAutoScalingPolicy::getTargetTrackingConfiguration() const {
    return m_target_tracking_configuration;
}
void OAIGameServerGroupAutoScalingPolicy::setTargetTrackingConfiguration(const OAIGameServerGroupAutoScalingPolicy_TargetTrackingConfiguration &target_tracking_configuration) {
    m_target_tracking_configuration = target_tracking_configuration;
    m_target_tracking_configuration_isSet = true;
}

bool OAIGameServerGroupAutoScalingPolicy::is_target_tracking_configuration_Set() const{
    return m_target_tracking_configuration_isSet;
}

bool OAIGameServerGroupAutoScalingPolicy::is_target_tracking_configuration_Valid() const{
    return m_target_tracking_configuration_isValid;
}

bool OAIGameServerGroupAutoScalingPolicy::isSet() const {
...
bool OAIGameServerGroupAutoScalingPolicy::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_target_tracking_configuration_isValid && true;
}
