...
/*
 * OAICreateGameSessionQueueOutput.h
 *
 * 
 */

#ifndef OAICreateGameSessionQueueOutput_H
#define OAICreateGameSessionQueueOutput_H
...
namespace OpenAPI {
class OAICreateGameSessionQueueOutput_GameSessionQueue;

class OAICreateGameSessionQueueOutput : public OAIObject {
public:
    OAICreateGameSessionQueueOutput();
    OAICreateGameSessionQueueOutput(QString json);
    ~OAICreateGameSessionQueueOutput() override;
    ...
    OAICreateGameSessionQueueOutput_GameSessionQueue getGameSessionQueue() const;
    void setGameSessionQueue(const OAICreateGameSessionQueueOutput_GameSessionQueue &game_session_queue);
...
private:
    ...
    OAICreateGameSessionQueueOutput_GameSessionQueue m_game_session_queue;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateGameSessionQueueOutput)

#endif // OAICreateGameSessionQueueOutput_H
