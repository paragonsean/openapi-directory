...
/*
 * OAIListScriptsOutput.h
 *
 * 
 */

#ifndef OAIListScriptsOutput_H
#define OAIListScriptsOutput_H
...
class OAIListScriptsOutput : public OAIObject {
public:
    OAIListScriptsOutput();
    OAIListScriptsOutput(QString json);
    ~OAIListScriptsOutput() override;
    ...
    QList getScripts() const;
    void setScripts(const QList &scripts);
...
Q_DECLARE_METATYPE(OpenAPI::OAIListScriptsOutput)

#endif // OAIListScriptsOutput_H
