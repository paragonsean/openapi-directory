...
public:
    ...
    QMap getPlayerAttributes() const;
    void setPlayerAttributes(const QMap &player_attributes);
    bool is_player_attributes_Set() const;
    bool is_player_attributes_Valid() const;
    ...
    QMap getLatencyInMs() const;
    void setLatencyInMs(const QMap &latency_in_ms);
    bool is_latency_in_ms_Set() const;
    bool is_latency_in_ms_Valid() const;
...
private:
    ...
    QMap m_player_attributes;
    bool m_player_attributes_isSet;
    bool m_player_attributes_isValid;

    QString m_team;
    bool m_team_isSet;
    bool m_team_isValid;

    QMap m_latency_in_ms;
    bool m_latency_in_ms_isSet;
    bool m_latency_in_ms_isValid;
};
