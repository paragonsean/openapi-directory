...
#include "OAIClaimGameServerInput_FilterOption.h"
...
OAIClaimGameServerInput_FilterOption::OAIClaimGameServerInput_FilterOption(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIClaimGameServerInput_FilterOption::OAIClaimGameServerInput_FilterOption() {
    this->initializeModel();
}

OAIClaimGameServerInput_FilterOption::~OAIClaimGameServerInput_FilterOption() {}

void OAIClaimGameServerInput_FilterOption::initializeModel() {

    m_instance_statuses_isSet = false;
    m_instance_statuses_isValid = false;
}

void OAIClaimGameServerInput_FilterOption::fromJson(QString jsonString) {
...
void OAIClaimGameServerInput_FilterOption::fromJsonObject(QJsonObject json) {
...
QString OAIClaimGameServerInput_FilterOption::asJson() const {
...
QJsonObject OAIClaimGameServerInput_FilterOption::asJsonObject() const {
    QJsonObject obj;
...
QList OAIClaimGameServerInput_FilterOption::getInstanceStatuses() const {
    return m_instance_statuses;
}
void OAIClaimGameServerInput_FilterOption::setInstanceStatuses(const QList &instance_statuses) {
    m_instance_statuses = instance_statuses;
    m_instance_statuses_isSet = true;
}

bool OAIClaimGameServerInput_FilterOption::is_instance_statuses_Set() const{
    return m_instance_statuses_isSet;
}

bool OAIClaimGameServerInput_FilterOption::is_instance_statuses_Valid() const{
    return m_instance_statuses_isValid;
}

bool OAIClaimGameServerInput_FilterOption::isSet() const {
...
bool OAIClaimGameServerInput_FilterOption::isValid() const {
