...
#ifndef OAILocationModel_H
#define OAILocationModel_H
...
class OAILocationModel : public OAIObject {
public:
    OAILocationModel();
    OAILocationModel(QString json);
    ~OAILocationModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILocationModel)

#endif // OAILocationModel_H
