...
/*
 * OAIDescribeFleetUtilizationInput.h
 *
 * 
 */

#ifndef OAIDescribeFleetUtilizationInput_H
#define OAIDescribeFleetUtilizationInput_H
...
class OAIDescribeFleetUtilizationInput : public OAIObject {
public:
    OAIDescribeFleetUtilizationInput();
    OAIDescribeFleetUtilizationInput(QString json);
    ~OAIDescribeFleetUtilizationInput() override;
    ...
    QList getFleetIds() const;
    void setFleetIds(const QList &fleet_ids);
    bool is_fleet_ids_Set() const;
    bool is_fleet_ids_Valid() const;
...
private:
    ...
    QList m_fleet_ids;
    bool m_fleet_ids_isSet;
    bool m_fleet_ids_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFleetUtilizationInput)

#endif // OAIDescribeFleetUtilizationInput_H
