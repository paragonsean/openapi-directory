...
/*
 * OAIGetInstanceAccessOutput_InstanceAccess.h
 *
 * 
 */

#ifndef OAIGetInstanceAccessOutput_InstanceAccess_H
#define OAIGetInstanceAccessOutput_InstanceAccess_H
...
class OAIGetInstanceAccessOutput_InstanceAccess : public OAIObject {
public:
    OAIGetInstanceAccessOutput_InstanceAccess();
    OAIGetInstanceAccessOutput_InstanceAccess(QString json);
    ~OAIGetInstanceAccessOutput_InstanceAccess() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetInstanceAccessOutput_InstanceAccess)

#endif // OAIGetInstanceAccessOutput_InstanceAccess_H
