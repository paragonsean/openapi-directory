...
/*
 * OAICreatePlayerSessionInput.h
 *
 * 
 */

#ifndef OAICreatePlayerSessionInput_H
#define OAICreatePlayerSessionInput_H
...
class OAICreatePlayerSessionInput : public OAIObject {
public:
    OAICreatePlayerSessionInput();
    OAICreatePlayerSessionInput(QString json);
    ~OAICreatePlayerSessionInput() override;
    ...
    QString getPlayerData() const;
    void setPlayerData(const QString &player_data);
    bool is_player_data_Set() const;
    bool is_player_data_Valid() const;
...
private:
    ...
    bool m_player_data_isSet;
    bool m_player_data_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreatePlayerSessionInput)

#endif // OAICreatePlayerSessionInput_H
