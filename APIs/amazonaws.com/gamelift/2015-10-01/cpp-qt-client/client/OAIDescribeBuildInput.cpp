...
OAIDescribeBuildInput::OAIDescribeBuildInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeBuildInput::OAIDescribeBuildInput() {
    this->initializeModel();
}

OAIDescribeBuildInput::~OAIDescribeBuildInput() {}

void OAIDescribeBuildInput::initializeModel() {

    m_build_id_isSet = false;
    m_build_id_isValid = false;
}

void OAIDescribeBuildInput::fromJson(QString jsonString) {
...
void OAIDescribeBuildInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeBuildInput::asJson() const {
...
QJsonObject OAIDescribeBuildInput::asJsonObject() const {
    QJsonObject obj;
    if (m_build_id_isSet) {
...
QString OAIDescribeBuildInput::getBuildId() const {
    return m_build_id;
}
void OAIDescribeBuildInput::setBuildId(const QString &build_id) {
    m_build_id = build_id;
    m_build_id_isSet = true;
}

bool OAIDescribeBuildInput::is_build_id_Set() const{
    return m_build_id_isSet;
}

bool OAIDescribeBuildInput::is_build_id_Valid() const{
    return m_build_id_isValid;
}

bool OAIDescribeBuildInput::isSet() const {
...
bool OAIDescribeBuildInput::isValid() const {
