...
/*
 * OAIGetInstanceAccessOutput.h
 *
 * 
 */

#ifndef OAIGetInstanceAccessOutput_H
#define OAIGetInstanceAccessOutput_H
...
namespace OpenAPI {
class OAIGetInstanceAccessOutput_InstanceAccess;

class OAIGetInstanceAccessOutput : public OAIObject {
public:
    OAIGetInstanceAccessOutput();
    OAIGetInstanceAccessOutput(QString json);
    ~OAIGetInstanceAccessOutput() override;
    ...
    OAIGetInstanceAccessOutput_InstanceAccess getInstanceAccess() const;
    void setInstanceAccess(const OAIGetInstanceAccessOutput_InstanceAccess &instance_access);
    bool is_instance_access_Set() const;
    bool is_instance_access_Valid() const;
...
private:
    ...
    OAIGetInstanceAccessOutput_InstanceAccess m_instance_access;
    bool m_instance_access_isSet;
    bool m_instance_access_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetInstanceAccessOutput)

#endif // OAIGetInstanceAccessOutput_H
