...
/*
 * OAIDescribeFleetCapacityInput.h
 *
 * 
 */

#ifndef OAIDescribeFleetCapacityInput_H
#define OAIDescribeFleetCapacityInput_H
...
class OAIDescribeFleetCapacityInput : public OAIObject {
public:
    OAIDescribeFleetCapacityInput();
    OAIDescribeFleetCapacityInput(QString json);
    ~OAIDescribeFleetCapacityInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFleetCapacityInput)

#endif // OAIDescribeFleetCapacityInput_H
