...
OAIRequestUploadCredentialsInput::OAIRequestUploadCredentialsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRequestUploadCredentialsInput::OAIRequestUploadCredentialsInput() {
    this->initializeModel();
}

OAIRequestUploadCredentialsInput::~OAIRequestUploadCredentialsInput() {}

void OAIRequestUploadCredentialsInput::initializeModel() {

    m_build_id_isSet = false;
    m_build_id_isValid = false;
}

void OAIRequestUploadCredentialsInput::fromJson(QString jsonString) {
...
void OAIRequestUploadCredentialsInput::fromJsonObject(QJsonObject json) {
...
QString OAIRequestUploadCredentialsInput::asJson() const {
...
QJsonObject OAIRequestUploadCredentialsInput::asJsonObject() const {
    QJsonObject obj;
    if (m_build_id_isSet) {
...
QString OAIRequestUploadCredentialsInput::getBuildId() const {
    return m_build_id;
}
void OAIRequestUploadCredentialsInput::setBuildId(const QString &build_id) {
    m_build_id = build_id;
    m_build_id_isSet = true;
}

bool OAIRequestUploadCredentialsInput::is_build_id_Set() const{
    return m_build_id_isSet;
}

bool OAIRequestUploadCredentialsInput::is_build_id_Valid() const{
    return m_build_id_isValid;
}

bool OAIRequestUploadCredentialsInput::isSet() const {
...
bool OAIRequestUploadCredentialsInput::isValid() const {
