...
/*
 * OAIRoutingStrategyType.h
 *
 * 
 */

#ifndef OAIRoutingStrategyType_H
#define OAIRoutingStrategyType_H
...
class OAIRoutingStrategyType : public OAIEnum {
public:
    OAIRoutingStrategyType();
    OAIRoutingStrategyType(QString json);
    ~OAIRoutingStrategyType() override;
    ...
    enum class eOAIRoutingStrategyType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        SIMPLE, 
        TERMINAL
    };
    OAIRoutingStrategyType::eOAIRoutingStrategyType getValue() const;
    void setValue(const OAIRoutingStrategyType::eOAIRoutingStrategyType& value);
...
private:
    ...
    eOAIRoutingStrategyType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRoutingStrategyType)

#endif // OAIRoutingStrategyType_H
