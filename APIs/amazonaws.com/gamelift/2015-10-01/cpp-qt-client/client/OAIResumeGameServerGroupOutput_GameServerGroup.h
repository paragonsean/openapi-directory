...
/*
 * OAIResumeGameServerGroupOutput_GameServerGroup.h
 *
 * 
 */

#ifndef OAIResumeGameServerGroupOutput_GameServerGroup_H
#define OAIResumeGameServerGroupOutput_GameServerGroup_H
...
class OAIResumeGameServerGroupOutput_GameServerGroup : public OAIObject {
public:
    OAIResumeGameServerGroupOutput_GameServerGroup();
    OAIResumeGameServerGroupOutput_GameServerGroup(QString json);
    ~OAIResumeGameServerGroupOutput_GameServerGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResumeGameServerGroupOutput_GameServerGroup)

#endif // OAIResumeGameServerGroupOutput_GameServerGroup_H
