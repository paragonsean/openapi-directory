...
/*
 * OAIDescribeRuntimeConfigurationOutput.h
 *
 * 
 */

#ifndef OAIDescribeRuntimeConfigurationOutput_H
#define OAIDescribeRuntimeConfigurationOutput_H
...
namespace OpenAPI {
class OAIDescribeRuntimeConfigurationOutput_RuntimeConfiguration;

class OAIDescribeRuntimeConfigurationOutput : public OAIObject {
public:
    OAIDescribeRuntimeConfigurationOutput();
    OAIDescribeRuntimeConfigurationOutput(QString json);
    ~OAIDescribeRuntimeConfigurationOutput() override;
    ...
    OAIDescribeRuntimeConfigurationOutput_RuntimeConfiguration getRuntimeConfiguration() const;
    void setRuntimeConfiguration(const OAIDescribeRuntimeConfigurationOutput_RuntimeConfiguration &runtime_configuration);
...
private:
    ...
    OAIDescribeRuntimeConfigurationOutput_RuntimeConfiguration m_runtime_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeRuntimeConfigurationOutput)

#endif // OAIDescribeRuntimeConfigurationOutput_H
