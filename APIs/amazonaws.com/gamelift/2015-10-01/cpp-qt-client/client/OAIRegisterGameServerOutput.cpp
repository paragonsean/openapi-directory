...
OAIRegisterGameServerOutput::OAIRegisterGameServerOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRegisterGameServerOutput::OAIRegisterGameServerOutput() {
    this->initializeModel();
}

OAIRegisterGameServerOutput::~OAIRegisterGameServerOutput() {}

void OAIRegisterGameServerOutput::initializeModel() {

    m_game_server_isSet = false;
    m_game_server_isValid = false;
}

void OAIRegisterGameServerOutput::fromJson(QString jsonString) {
...
void OAIRegisterGameServerOutput::fromJsonObject(QJsonObject json) {
...
QString OAIRegisterGameServerOutput::asJson() const {
...
QJsonObject OAIRegisterGameServerOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIRegisterGameServerOutput_GameServer OAIRegisterGameServerOutput::getGameServer() const {
    return m_game_server;
}
void OAIRegisterGameServerOutput::setGameServer(const OAIRegisterGameServerOutput_GameServer &game_server) {
    m_game_server = game_server;
    m_game_server_isSet = true;
}

bool OAIRegisterGameServerOutput::is_game_server_Set() const{
    return m_game_server_isSet;
}

bool OAIRegisterGameServerOutput::is_game_server_Valid() const{
    return m_game_server_isValid;
}

bool OAIRegisterGameServerOutput::isSet() const {
...
bool OAIRegisterGameServerOutput::isValid() const {
