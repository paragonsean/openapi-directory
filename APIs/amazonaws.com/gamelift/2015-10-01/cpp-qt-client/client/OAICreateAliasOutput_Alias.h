...
/*
 * OAICreateAliasOutput_Alias.h
 *
 * 
 */

#ifndef OAICreateAliasOutput_Alias_H
#define OAICreateAliasOutput_Alias_H
...
class OAICreateAliasOutput_Alias : public OAIObject {
public:
    OAICreateAliasOutput_Alias();
    OAICreateAliasOutput_Alias(QString json);
    ~OAICreateAliasOutput_Alias() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAliasOutput_Alias)

#endif // OAICreateAliasOutput_Alias_H
