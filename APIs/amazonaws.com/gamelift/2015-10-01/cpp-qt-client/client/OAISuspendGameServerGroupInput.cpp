...
OAISuspendGameServerGroupInput::OAISuspendGameServerGroupInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISuspendGameServerGroupInput::OAISuspendGameServerGroupInput() {
    this->initializeModel();
}

OAISuspendGameServerGroupInput::~OAISuspendGameServerGroupInput() {}

void OAISuspendGameServerGroupInput::initializeModel() {

    m_game_server_group_name_isSet = false;
    m_game_server_group_name_isValid = false;

    m_suspend_actions_isSet = false;
    m_suspend_actions_isValid = false;
}

void OAISuspendGameServerGroupInput::fromJson(QString jsonString) {
...
void OAISuspendGameServerGroupInput::fromJsonObject(QJsonObject json) {
    ...
    m_suspend_actions_isValid = ::OpenAPI::fromJsonValue(m_suspend_actions, json[QString("SuspendActions")]);
    m_suspend_actions_isSet = !json[QString("SuspendActions")].isNull() && m_suspend_actions_isValid;
}

QString OAISuspendGameServerGroupInput::asJson() const {
...
QJsonObject OAISuspendGameServerGroupInput::asJsonObject() const {
    QJsonObject obj;
    if (m_game_server_group_name_isSet) {
        obj.insert(QString("GameServerGroupName"), ::OpenAPI::toJsonValue(m_game_server_group_name));
    }
    if (m_suspend_actions.isSet()) {
        obj.insert(QString("SuspendActions"), ::OpenAPI::toJsonValue(m_suspend_actions));
    }
    return obj;
}

QString OAISuspendGameServerGroupInput::getGameServerGroupName() const {
    return m_game_server_group_name;
}
void OAISuspendGameServerGroupInput::setGameServerGroupName(const QString &game_server_group_name) {
    m_game_server_group_name = game_server_group_name;
    m_game_server_group_name_isSet = true;
}

bool OAISuspendGameServerGroupInput::is_game_server_group_name_Set() const{
    return m_game_server_group_name_isSet;
}

bool OAISuspendGameServerGroupInput::is_game_server_group_name_Valid() const{
    return m_game_server_group_name_isValid;
}

QList OAISuspendGameServerGroupInput::getSuspendActions() const {
    return m_suspend_actions;
}
void OAISuspendGameServerGroupInput::setSuspendActions(const QList &suspend_actions) {
    m_suspend_actions = suspend_actions;
    m_suspend_actions_isSet = true;
}

bool OAISuspendGameServerGroupInput::is_suspend_actions_Set() const{
    return m_suspend_actions_isSet;
}

bool OAISuspendGameServerGroupInput::is_suspend_actions_Valid() const{
    return m_suspend_actions_isValid;
}

bool OAISuspendGameServerGroupInput::isSet() const {
...
bool OAISuspendGameServerGroupInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_game_server_group_name_isValid && m_suspend_actions_isValid && true;
}
