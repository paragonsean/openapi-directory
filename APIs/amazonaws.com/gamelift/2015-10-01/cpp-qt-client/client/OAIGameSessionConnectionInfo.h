...
/*
 * OAIGameSessionConnectionInfo.h
 *
...
#ifndef OAIGameSessionConnectionInfo_H
#define OAIGameSessionConnectionInfo_H
...
class OAIGameSessionConnectionInfo : public OAIObject {
public:
    OAIGameSessionConnectionInfo();
    OAIGameSessionConnectionInfo(QString json);
    ~OAIGameSessionConnectionInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGameSessionConnectionInfo)

#endif // OAIGameSessionConnectionInfo_H
