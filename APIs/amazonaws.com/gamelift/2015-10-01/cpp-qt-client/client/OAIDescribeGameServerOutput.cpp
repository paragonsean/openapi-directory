...
OAIDescribeGameServerOutput::OAIDescribeGameServerOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeGameServerOutput::OAIDescribeGameServerOutput() {
    this->initializeModel();
}

OAIDescribeGameServerOutput::~OAIDescribeGameServerOutput() {}

void OAIDescribeGameServerOutput::initializeModel() {

    m_game_server_isSet = false;
    m_game_server_isValid = false;
}

void OAIDescribeGameServerOutput::fromJson(QString jsonString) {
...
void OAIDescribeGameServerOutput::fromJsonObject(QJsonObject json) {

    m_game_server_isValid = ::OpenAPI::fromJsonValue(m_game_server, json[QString("GameServer")]);
    m_game_server_isSet = !json[QString("GameServer")].isNull() && m_game_server_isValid;
}

QString OAIDescribeGameServerOutput::asJson() const {
...
QJsonObject OAIDescribeGameServerOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_game_server.isSet()) {
        obj.insert(QString("GameServer"), ::OpenAPI::toJsonValue(m_game_server));
    }
    return obj;
}

OAIDescribeGameServerOutput_GameServer OAIDescribeGameServerOutput::getGameServer() const {
    return m_game_server;
}
void OAIDescribeGameServerOutput::setGameServer(const OAIDescribeGameServerOutput_GameServer &game_server) {
    m_game_server = game_server;
    m_game_server_isSet = true;
}

bool OAIDescribeGameServerOutput::is_game_server_Set() const{
    return m_game_server_isSet;
}

bool OAIDescribeGameServerOutput::is_game_server_Valid() const{
    return m_game_server_isValid;
}

bool OAIDescribeGameServerOutput::isSet() const {
...
bool OAIDescribeGameServerOutput::isValid() const {
