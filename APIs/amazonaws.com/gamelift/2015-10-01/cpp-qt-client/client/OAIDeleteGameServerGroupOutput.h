...
/*
 * OAIDeleteGameServerGroupOutput.h
 *
 * 
 */

#ifndef OAIDeleteGameServerGroupOutput_H
#define OAIDeleteGameServerGroupOutput_H

#include <QJsonObject>

#include "OAIDeleteGameServerGroupOutput_GameServerGroup.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIDeleteGameServerGroupOutput_GameServerGroup;

class OAIDeleteGameServerGroupOutput : public OAIObject {
public:
    OAIDeleteGameServerGroupOutput();
    OAIDeleteGameServerGroupOutput(QString json);
    ~OAIDeleteGameServerGroupOutput() override;
    ...
    OAIDeleteGameServerGroupOutput_GameServerGroup getGameServerGroup() const;
    void setGameServerGroup(const OAIDeleteGameServerGroupOutput_GameServerGroup &game_server_group);
...
private:
    ...
    OAIDeleteGameServerGroupOutput_GameServerGroup m_game_server_group;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteGameServerGroupOutput)

#endif // OAIDeleteGameServerGroupOutput_H
