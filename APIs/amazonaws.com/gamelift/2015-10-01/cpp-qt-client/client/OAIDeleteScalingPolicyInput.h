...
/*
 * OAIDeleteScalingPolicyInput.h
 *
 * 
 */

#ifndef OAIDeleteScalingPolicyInput_H
#define OAIDeleteScalingPolicyInput_H
...
class OAIDeleteScalingPolicyInput : public OAIObject {
public:
    OAIDeleteScalingPolicyInput();
    OAIDeleteScalingPolicyInput(QString json);
    ~OAIDeleteScalingPolicyInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteScalingPolicyInput)

#endif // OAIDeleteScalingPolicyInput_H
