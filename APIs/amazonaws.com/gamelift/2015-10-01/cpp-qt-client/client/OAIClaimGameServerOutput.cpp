...
OAIClaimGameServerOutput::OAIClaimGameServerOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIClaimGameServerOutput::OAIClaimGameServerOutput() {
    this->initializeModel();
}

OAIClaimGameServerOutput::~OAIClaimGameServerOutput() {}

void OAIClaimGameServerOutput::initializeModel() {

    m_game_server_isSet = false;
    m_game_server_isValid = false;
}

void OAIClaimGameServerOutput::fromJson(QString jsonString) {
...
void OAIClaimGameServerOutput::fromJsonObject(QJsonObject json) {
...
QString OAIClaimGameServerOutput::asJson() const {
...
QJsonObject OAIClaimGameServerOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIClaimGameServerOutput_GameServer OAIClaimGameServerOutput::getGameServer() const {
    return m_game_server;
}
void OAIClaimGameServerOutput::setGameServer(const OAIClaimGameServerOutput_GameServer &game_server) {
    m_game_server = game_server;
    m_game_server_isSet = true;
}

bool OAIClaimGameServerOutput::is_game_server_Set() const{
    return m_game_server_isSet;
}

bool OAIClaimGameServerOutput::is_game_server_Valid() const{
    return m_game_server_isValid;
}

bool OAIClaimGameServerOutput::isSet() const {
...
bool OAIClaimGameServerOutput::isValid() const {
