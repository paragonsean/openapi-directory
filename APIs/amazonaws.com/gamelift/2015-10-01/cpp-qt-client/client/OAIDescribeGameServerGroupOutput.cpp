...
OAIDescribeGameServerGroupOutput::OAIDescribeGameServerGroupOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeGameServerGroupOutput::OAIDescribeGameServerGroupOutput() {
    this->initializeModel();
}

OAIDescribeGameServerGroupOutput::~OAIDescribeGameServerGroupOutput() {}

void OAIDescribeGameServerGroupOutput::initializeModel() {

    m_game_server_group_isSet = false;
    m_game_server_group_isValid = false;
}

void OAIDescribeGameServerGroupOutput::fromJson(QString jsonString) {
...
void OAIDescribeGameServerGroupOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeGameServerGroupOutput::asJson() const {
...
QJsonObject OAIDescribeGameServerGroupOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIDescribeGameServerGroupOutput_GameServerGroup OAIDescribeGameServerGroupOutput::getGameServerGroup() const {
    return m_game_server_group;
}
void OAIDescribeGameServerGroupOutput::setGameServerGroup(const OAIDescribeGameServerGroupOutput_GameServerGroup &game_server_group) {
    m_game_server_group = game_server_group;
    m_game_server_group_isSet = true;
}

bool OAIDescribeGameServerGroupOutput::is_game_server_group_Set() const{
    return m_game_server_group_isSet;
}

bool OAIDescribeGameServerGroupOutput::is_game_server_group_Valid() const{
    return m_game_server_group_isValid;
}

bool OAIDescribeGameServerGroupOutput::isSet() const {
...
bool OAIDescribeGameServerGroupOutput::isValid() const {
