...
OAIUpdateGameServerGroupOutput::OAIUpdateGameServerGroupOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateGameServerGroupOutput::OAIUpdateGameServerGroupOutput() {
    this->initializeModel();
}

OAIUpdateGameServerGroupOutput::~OAIUpdateGameServerGroupOutput() {}

void OAIUpdateGameServerGroupOutput::initializeModel() {

    m_game_server_group_isSet = false;
    m_game_server_group_isValid = false;
}

void OAIUpdateGameServerGroupOutput::fromJson(QString jsonString) {
...
void OAIUpdateGameServerGroupOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateGameServerGroupOutput::asJson() const {
...
QJsonObject OAIUpdateGameServerGroupOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdateGameServerGroupOutput_GameServerGroup OAIUpdateGameServerGroupOutput::getGameServerGroup() const {
    return m_game_server_group;
}
void OAIUpdateGameServerGroupOutput::setGameServerGroup(const OAIUpdateGameServerGroupOutput_GameServerGroup &game_server_group) {
    m_game_server_group = game_server_group;
    m_game_server_group_isSet = true;
}

bool OAIUpdateGameServerGroupOutput::is_game_server_group_Set() const{
    return m_game_server_group_isSet;
}

bool OAIUpdateGameServerGroupOutput::is_game_server_group_Valid() const{
    return m_game_server_group_isValid;
}

bool OAIUpdateGameServerGroupOutput::isSet() const {
...
bool OAIUpdateGameServerGroupOutput::isValid() const {
