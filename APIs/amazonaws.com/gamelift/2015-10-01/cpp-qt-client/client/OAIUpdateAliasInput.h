...
/*
 * OAIUpdateAliasInput.h
 *
 * 
 */

#ifndef OAIUpdateAliasInput_H
#define OAIUpdateAliasInput_H

#include <QJsonObject>

#include "OAIUpdateAliasInput_RoutingStrategy.h"
#include <QString>
...
namespace OpenAPI {
class OAIUpdateAliasInput_RoutingStrategy;

class OAIUpdateAliasInput : public OAIObject {
public:
    OAIUpdateAliasInput();
    OAIUpdateAliasInput(QString json);
    ~OAIUpdateAliasInput() override;
    ...
    OAIUpdateAliasInput_RoutingStrategy getRoutingStrategy() const;
    void setRoutingStrategy(const OAIUpdateAliasInput_RoutingStrategy &routing_strategy);
...
private:
    ...
    OAIUpdateAliasInput_RoutingStrategy m_routing_strategy;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAliasInput)

#endif // OAIUpdateAliasInput_H
