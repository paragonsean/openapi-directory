...
/*
 * OAIGameSessionDetail_GameSession.h
 *
 * 
 */

#ifndef OAIGameSessionDetail_GameSession_H
#define OAIGameSessionDetail_GameSession_H
...
class OAIGameSessionDetail_GameSession : public OAIObject {
public:
    OAIGameSessionDetail_GameSession();
    OAIGameSessionDetail_GameSession(QString json);
    ~OAIGameSessionDetail_GameSession() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGameSessionDetail_GameSession)

#endif // OAIGameSessionDetail_GameSession_H
