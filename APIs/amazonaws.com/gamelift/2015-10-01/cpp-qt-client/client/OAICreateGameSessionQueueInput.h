...
/*
 * OAICreateGameSessionQueueInput.h
 *
 * 
 */

#ifndef OAICreateGameSessionQueueInput_H
#define OAICreateGameSessionQueueInput_H

#include <QJsonObject>

#include "OAICreateGameSessionQueueInput_FilterConfiguration.h"
#include "OAICreateGameSessionQueueInput_PriorityConfiguration.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAICreateGameSessionQueueInput_FilterConfiguration;
class OAICreateGameSessionQueueInput_PriorityConfiguration;

class OAICreateGameSessionQueueInput : public OAIObject {
public:
    OAICreateGameSessionQueueInput();
    OAICreateGameSessionQueueInput(QString json);
    ~OAICreateGameSessionQueueInput() override;
    ...
    OAICreateGameSessionQueueInput_FilterConfiguration getFilterConfiguration() const;
    void setFilterConfiguration(const OAICreateGameSessionQueueInput_FilterConfiguration &filter_configuration);
    bool is_filter_configuration_Set() const;
    bool is_filter_configuration_Valid() const;

    OAICreateGameSessionQueueInput_PriorityConfiguration getPriorityConfiguration() const;
    void setPriorityConfiguration(const OAICreateGameSessionQueueInput_PriorityConfiguration &priority_configuration);
...
private:
    ...
    OAICreateGameSessionQueueInput_FilterConfiguration m_filter_configuration;
    bool m_filter_configuration_isSet;
    bool m_filter_configuration_isValid;

    OAICreateGameSessionQueueInput_PriorityConfiguration m_priority_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateGameSessionQueueInput)

#endif // OAICreateGameSessionQueueInput_H
