...
/*
 * OAIDeleteGameSessionQueueInput.h
 *
 * 
 */

#ifndef OAIDeleteGameSessionQueueInput_H
#define OAIDeleteGameSessionQueueInput_H
...
class OAIDeleteGameSessionQueueInput : public OAIObject {
public:
    OAIDeleteGameSessionQueueInput();
    OAIDeleteGameSessionQueueInput(QString json);
    ~OAIDeleteGameSessionQueueInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteGameSessionQueueInput)

#endif // OAIDeleteGameSessionQueueInput_H
