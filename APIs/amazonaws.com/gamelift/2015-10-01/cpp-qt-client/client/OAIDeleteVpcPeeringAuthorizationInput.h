...
/*
 * OAIDeleteVpcPeeringAuthorizationInput.h
 *
 * 
 */

#ifndef OAIDeleteVpcPeeringAuthorizationInput_H
#define OAIDeleteVpcPeeringAuthorizationInput_H
...
class OAIDeleteVpcPeeringAuthorizationInput : public OAIObject {
public:
    OAIDeleteVpcPeeringAuthorizationInput();
    OAIDeleteVpcPeeringAuthorizationInput(QString json);
    ~OAIDeleteVpcPeeringAuthorizationInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteVpcPeeringAuthorizationInput)

#endif // OAIDeleteVpcPeeringAuthorizationInput_H
