...
/*
 * OAIDescribeFleetLocationUtilizationOutput.h
 *
 * 
 */

#ifndef OAIDescribeFleetLocationUtilizationOutput_H
#define OAIDescribeFleetLocationUtilizationOutput_H
...
namespace OpenAPI {
class OAIDescribeFleetLocationUtilizationOutput_FleetUtilization;

class OAIDescribeFleetLocationUtilizationOutput : public OAIObject {
public:
    OAIDescribeFleetLocationUtilizationOutput();
    OAIDescribeFleetLocationUtilizationOutput(QString json);
    ~OAIDescribeFleetLocationUtilizationOutput() override;
    ...
    OAIDescribeFleetLocationUtilizationOutput_FleetUtilization getFleetUtilization() const;
    void setFleetUtilization(const OAIDescribeFleetLocationUtilizationOutput_FleetUtilization &fleet_utilization);
    bool is_fleet_utilization_Set() const;
    bool is_fleet_utilization_Valid() const;
...
private:
    ...
    OAIDescribeFleetLocationUtilizationOutput_FleetUtilization m_fleet_utilization;
    bool m_fleet_utilization_isSet;
    bool m_fleet_utilization_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFleetLocationUtilizationOutput)

#endif // OAIDescribeFleetLocationUtilizationOutput_H
