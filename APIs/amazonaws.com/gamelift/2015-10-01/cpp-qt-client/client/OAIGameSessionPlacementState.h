...
/*
 * OAIGameSessionPlacementState.h
 *
 * 
 */

#ifndef OAIGameSessionPlacementState_H
#define OAIGameSessionPlacementState_H
...
class OAIGameSessionPlacementState : public OAIEnum {
public:
    OAIGameSessionPlacementState();
    OAIGameSessionPlacementState(QString json);
    ~OAIGameSessionPlacementState() override;
    ...
    enum class eOAIGameSessionPlacementState {
    ...
    OAIGameSessionPlacementState::eOAIGameSessionPlacementState getValue() const;
    void setValue(const OAIGameSessionPlacementState::eOAIGameSessionPlacementState& value);
...
private:
    ...
    eOAIGameSessionPlacementState m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGameSessionPlacementState)

#endif // OAIGameSessionPlacementState_H
