...
/*
 * OAIRegisterGameServerOutput.h
 *
 * 
 */

#ifndef OAIRegisterGameServerOutput_H
#define OAIRegisterGameServerOutput_H
...
namespace OpenAPI {
class OAIRegisterGameServerOutput_GameServer;

class OAIRegisterGameServerOutput : public OAIObject {
public:
    OAIRegisterGameServerOutput();
    OAIRegisterGameServerOutput(QString json);
    ~OAIRegisterGameServerOutput() override;
    ...
    OAIRegisterGameServerOutput_GameServer getGameServer() const;
    void setGameServer(const OAIRegisterGameServerOutput_GameServer &game_server);
...
private:
    ...
    OAIRegisterGameServerOutput_GameServer m_game_server;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegisterGameServerOutput)

#endif // OAIRegisterGameServerOutput_H
