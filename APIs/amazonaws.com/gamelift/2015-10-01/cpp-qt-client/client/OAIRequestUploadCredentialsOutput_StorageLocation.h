...
/*
 * OAIRequestUploadCredentialsOutput_StorageLocation.h
 *
 * 
 */

#ifndef OAIRequestUploadCredentialsOutput_StorageLocation_H
#define OAIRequestUploadCredentialsOutput_StorageLocation_H
...
class OAIRequestUploadCredentialsOutput_StorageLocation : public OAIObject {
public:
    OAIRequestUploadCredentialsOutput_StorageLocation();
    OAIRequestUploadCredentialsOutput_StorageLocation(QString json);
    ~OAIRequestUploadCredentialsOutput_StorageLocation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRequestUploadCredentialsOutput_StorageLocation)

#endif // OAIRequestUploadCredentialsOutput_StorageLocation_H
