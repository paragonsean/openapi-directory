...
OAIDescribeScriptInput::OAIDescribeScriptInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeScriptInput::OAIDescribeScriptInput() {
    this->initializeModel();
}

OAIDescribeScriptInput::~OAIDescribeScriptInput() {}

void OAIDescribeScriptInput::initializeModel() {

    m_script_id_isSet = false;
    m_script_id_isValid = false;
}

void OAIDescribeScriptInput::fromJson(QString jsonString) {
...
void OAIDescribeScriptInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeScriptInput::asJson() const {
...
QJsonObject OAIDescribeScriptInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeScriptInput::getScriptId() const {
    return m_script_id;
}
void OAIDescribeScriptInput::setScriptId(const QString &script_id) {
    m_script_id = script_id;
    m_script_id_isSet = true;
}

bool OAIDescribeScriptInput::is_script_id_Set() const{
    return m_script_id_isSet;
}

bool OAIDescribeScriptInput::is_script_id_Valid() const{
    return m_script_id_isValid;
}

bool OAIDescribeScriptInput::isSet() const {
...
bool OAIDescribeScriptInput::isValid() const {
