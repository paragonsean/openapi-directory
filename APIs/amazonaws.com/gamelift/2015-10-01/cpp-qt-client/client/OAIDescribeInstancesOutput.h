...
/*
 * OAIDescribeInstancesOutput.h
 *
 * 
 */

#ifndef OAIDescribeInstancesOutput_H
#define OAIDescribeInstancesOutput_H
...
class OAIDescribeInstancesOutput : public OAIObject {
public:
    OAIDescribeInstancesOutput();
    OAIDescribeInstancesOutput(QString json);
    ~OAIDescribeInstancesOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeInstancesOutput)

#endif // OAIDescribeInstancesOutput_H
