...
/*
 * OAIDescribeFleetPortSettingsOutput.h
 *
 * 
 */

#ifndef OAIDescribeFleetPortSettingsOutput_H
#define OAIDescribeFleetPortSettingsOutput_H
...
class OAIDescribeFleetPortSettingsOutput : public OAIObject {
public:
    OAIDescribeFleetPortSettingsOutput();
    OAIDescribeFleetPortSettingsOutput(QString json);
    ~OAIDescribeFleetPortSettingsOutput() override;
    ...
    QList getInboundPermissions() const;
    void setInboundPermissions(const QList &inbound_permissions);
    bool is_inbound_permissions_Set() const;
    bool is_inbound_permissions_Valid() const;
...
private:
    ...
    QList m_inbound_permissions;
    bool m_inbound_permissions_isSet;
    bool m_inbound_permissions_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFleetPortSettingsOutput)

#endif // OAIDescribeFleetPortSettingsOutput_H
