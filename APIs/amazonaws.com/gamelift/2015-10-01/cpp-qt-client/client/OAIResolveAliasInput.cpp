...
OAIResolveAliasInput::OAIResolveAliasInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIResolveAliasInput::OAIResolveAliasInput() {
    this->initializeModel();
}

OAIResolveAliasInput::~OAIResolveAliasInput() {}

void OAIResolveAliasInput::initializeModel() {

    m_alias_id_isSet = false;
    m_alias_id_isValid = false;
}

void OAIResolveAliasInput::fromJson(QString jsonString) {
...
void OAIResolveAliasInput::fromJsonObject(QJsonObject json) {
...
QString OAIResolveAliasInput::asJson() const {
...
QJsonObject OAIResolveAliasInput::asJsonObject() const {
    QJsonObject obj;
    if (m_alias_id_isSet) {
...
QString OAIResolveAliasInput::getAliasId() const {
    return m_alias_id;
}
void OAIResolveAliasInput::setAliasId(const QString &alias_id) {
    m_alias_id = alias_id;
    m_alias_id_isSet = true;
}

bool OAIResolveAliasInput::is_alias_id_Set() const{
    return m_alias_id_isSet;
}

bool OAIResolveAliasInput::is_alias_id_Valid() const{
    return m_alias_id_isValid;
}

bool OAIResolveAliasInput::isSet() const {
...
bool OAIResolveAliasInput::isValid() const {
