...
OAIBackfillMode::OAIBackfillMode(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBackfillMode::OAIBackfillMode() {
    this->initializeModel();
}

OAIBackfillMode::~OAIBackfillMode() {}

void OAIBackfillMode::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIBackfillMode::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIBackfillMode::fromJson(QString jsonString) {
    
    if ( jsonString.compare("AUTOMATIC", Qt::CaseInsensitive) == 0) {
        m_value = eOAIBackfillMode::AUTOMATIC;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("MANUAL", Qt::CaseInsensitive) == 0) {
        m_value = eOAIBackfillMode::MANUAL;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIBackfillMode::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIBackfillMode::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIBackfillMode::AUTOMATIC:
            val = "AUTOMATIC";
            break;
        case eOAIBackfillMode::MANUAL:
            val = "MANUAL";
            break;
        default:
            break;
...
QJsonValue OAIBackfillMode::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIBackfillMode::eOAIBackfillMode OAIBackfillMode::getValue() const {
    return m_value;
}

void OAIBackfillMode::setValue(const OAIBackfillMode::eOAIBackfillMode& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIBackfillMode::isSet() const {
    
    return m_value_isSet;
}

bool OAIBackfillMode::isValid() const {
