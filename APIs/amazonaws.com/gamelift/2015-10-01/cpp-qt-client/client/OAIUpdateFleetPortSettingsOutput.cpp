...
OAIUpdateFleetPortSettingsOutput::OAIUpdateFleetPortSettingsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateFleetPortSettingsOutput::OAIUpdateFleetPortSettingsOutput() {
    this->initializeModel();
}

OAIUpdateFleetPortSettingsOutput::~OAIUpdateFleetPortSettingsOutput() {}

void OAIUpdateFleetPortSettingsOutput::initializeModel() {
...
void OAIUpdateFleetPortSettingsOutput::fromJson(QString jsonString) {
...
void OAIUpdateFleetPortSettingsOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateFleetPortSettingsOutput::asJson() const {
...
QJsonObject OAIUpdateFleetPortSettingsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
...
QString OAIUpdateFleetPortSettingsOutput::getFleetId() const {
    return m_fleet_id;
}
void OAIUpdateFleetPortSettingsOutput::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIUpdateFleetPortSettingsOutput::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIUpdateFleetPortSettingsOutput::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

QString OAIUpdateFleetPortSettingsOutput::getFleetArn() const {
    return m_fleet_arn;
}
void OAIUpdateFleetPortSettingsOutput::setFleetArn(const QString &fleet_arn) {
    m_fleet_arn = fleet_arn;
    m_fleet_arn_isSet = true;
}

bool OAIUpdateFleetPortSettingsOutput::is_fleet_arn_Set() const{
    return m_fleet_arn_isSet;
}

bool OAIUpdateFleetPortSettingsOutput::is_fleet_arn_Valid() const{
    return m_fleet_arn_isValid;
}

bool OAIUpdateFleetPortSettingsOutput::isSet() const {
...
bool OAIUpdateFleetPortSettingsOutput::isValid() const {
