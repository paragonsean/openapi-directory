...
/*
 * OAIValidateMatchmakingRuleSetInput.h
 *
 * 
 */

#ifndef OAIValidateMatchmakingRuleSetInput_H
#define OAIValidateMatchmakingRuleSetInput_H
...
class OAIValidateMatchmakingRuleSetInput : public OAIObject {
public:
    OAIValidateMatchmakingRuleSetInput();
    OAIValidateMatchmakingRuleSetInput(QString json);
    ~OAIValidateMatchmakingRuleSetInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIValidateMatchmakingRuleSetInput)

#endif // OAIValidateMatchmakingRuleSetInput_H
