...
OAIFlexMatchMode::OAIFlexMatchMode(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFlexMatchMode::OAIFlexMatchMode() {
    this->initializeModel();
}

OAIFlexMatchMode::~OAIFlexMatchMode() {}

void OAIFlexMatchMode::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFlexMatchMode::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFlexMatchMode::fromJson(QString jsonString) {
    
    if ( jsonString.compare("STANDALONE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFlexMatchMode::STANDALONE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("WITH_QUEUE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFlexMatchMode::WITH_QUEUE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFlexMatchMode::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFlexMatchMode::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFlexMatchMode::STANDALONE:
            val = "STANDALONE";
            break;
        case eOAIFlexMatchMode::WITH_QUEUE:
            val = "WITH_QUEUE";
            break;
        default:
            break;
...
QJsonValue OAIFlexMatchMode::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFlexMatchMode::eOAIFlexMatchMode OAIFlexMatchMode::getValue() const {
    return m_value;
}

void OAIFlexMatchMode::setValue(const OAIFlexMatchMode::eOAIFlexMatchMode& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFlexMatchMode::isSet() const {
    
    return m_value_isSet;
}

bool OAIFlexMatchMode::isValid() const {
