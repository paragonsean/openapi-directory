...
/*
 * OAIStartMatchmakingOutput.h
 *
 * 
 */

#ifndef OAIStartMatchmakingOutput_H
#define OAIStartMatchmakingOutput_H
...
namespace OpenAPI {
class OAIStartMatchmakingOutput_MatchmakingTicket;

class OAIStartMatchmakingOutput : public OAIObject {
public:
    OAIStartMatchmakingOutput();
    OAIStartMatchmakingOutput(QString json);
    ~OAIStartMatchmakingOutput() override;
    ...
    OAIStartMatchmakingOutput_MatchmakingTicket getMatchmakingTicket() const;
    void setMatchmakingTicket(const OAIStartMatchmakingOutput_MatchmakingTicket &matchmaking_ticket);
...
private:
    ...
    OAIStartMatchmakingOutput_MatchmakingTicket m_matchmaking_ticket;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartMatchmakingOutput)

#endif // OAIStartMatchmakingOutput_H
