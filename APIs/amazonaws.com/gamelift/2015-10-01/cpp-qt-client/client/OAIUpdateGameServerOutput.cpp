...
OAIUpdateGameServerOutput::OAIUpdateGameServerOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateGameServerOutput::OAIUpdateGameServerOutput() {
    this->initializeModel();
}

OAIUpdateGameServerOutput::~OAIUpdateGameServerOutput() {}

void OAIUpdateGameServerOutput::initializeModel() {

    m_game_server_isSet = false;
    m_game_server_isValid = false;
}

void OAIUpdateGameServerOutput::fromJson(QString jsonString) {
...
void OAIUpdateGameServerOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateGameServerOutput::asJson() const {
...
QJsonObject OAIUpdateGameServerOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdateGameServerOutput_GameServer OAIUpdateGameServerOutput::getGameServer() const {
    return m_game_server;
}
void OAIUpdateGameServerOutput::setGameServer(const OAIUpdateGameServerOutput_GameServer &game_server) {
    m_game_server = game_server;
    m_game_server_isSet = true;
}

bool OAIUpdateGameServerOutput::is_game_server_Set() const{
    return m_game_server_isSet;
}

bool OAIUpdateGameServerOutput::is_game_server_Valid() const{
    return m_game_server_isValid;
}

bool OAIUpdateGameServerOutput::isSet() const {
...
bool OAIUpdateGameServerOutput::isValid() const {
