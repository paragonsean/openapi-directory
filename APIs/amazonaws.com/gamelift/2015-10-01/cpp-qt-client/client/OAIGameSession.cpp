...
OAIGameSession::OAIGameSession(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGameSession::OAIGameSession() {
    this->initializeModel();
}

OAIGameSession::~OAIGameSession() {}

void OAIGameSession::initializeModel() {
...
void OAIGameSession::fromJson(QString jsonString) {
...
void OAIGameSession::fromJsonObject(QJsonObject json) {
...
QString OAIGameSession::asJson() const {
...
QJsonObject OAIGameSession::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGameSession::getGameSessionId() const {
    return m_game_session_id;
}
void OAIGameSession::setGameSessionId(const QString &game_session_id) {
    m_game_session_id = game_session_id;
    m_game_session_id_isSet = true;
}

bool OAIGameSession::is_game_session_id_Set() const{
    return m_game_session_id_isSet;
}

bool OAIGameSession::is_game_session_id_Valid() const{
    return m_game_session_id_isValid;
}

QString OAIGameSession::getName() const {
    return m_name;
}
void OAIGameSession::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIGameSession::is_name_Set() const{
    return m_name_isSet;
}

bool OAIGameSession::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIGameSession::getFleetId() const {
    return m_fleet_id;
}
void OAIGameSession::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIGameSession::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIGameSession::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

QString OAIGameSession::getFleetArn() const {
    return m_fleet_arn;
}
void OAIGameSession::setFleetArn(const QString &fleet_arn) {
    m_fleet_arn = fleet_arn;
    m_fleet_arn_isSet = true;
}

bool OAIGameSession::is_fleet_arn_Set() const{
    return m_fleet_arn_isSet;
}

bool OAIGameSession::is_fleet_arn_Valid() const{
    return m_fleet_arn_isValid;
}

QDateTime OAIGameSession::getCreationTime() const {
    return m_creation_time;
}
void OAIGameSession::setCreationTime(const QDateTime &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAIGameSession::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAIGameSession::is_creation_time_Valid() const{
    return m_creation_time_isValid;
}

QDateTime OAIGameSession::getTerminationTime() const {
    return m_termination_time;
}
void OAIGameSession::setTerminationTime(const QDateTime &termination_time) {
    m_termination_time = termination_time;
    m_termination_time_isSet = true;
}

bool OAIGameSession::is_termination_time_Set() const{
    return m_termination_time_isSet;
}

bool OAIGameSession::is_termination_time_Valid() const{
    return m_termination_time_isValid;
}

qint32 OAIGameSession::getCurrentPlayerSessionCount() const {
    return m_current_player_session_count;
}
void OAIGameSession::setCurrentPlayerSessionCount(const qint32 &current_player_session_count) {
    m_current_player_session_count = current_player_session_count;
    m_current_player_session_count_isSet = true;
}

bool OAIGameSession::is_current_player_session_count_Set() const{
    return m_current_player_session_count_isSet;
}

bool OAIGameSession::is_current_player_session_count_Valid() const{
    return m_current_player_session_count_isValid;
}

qint32 OAIGameSession::getMaximumPlayerSessionCount() const {
    return m_maximum_player_session_count;
}
void OAIGameSession::setMaximumPlayerSessionCount(const qint32 &maximum_player_session_count) {
    m_maximum_player_session_count = maximum_player_session_count;
    m_maximum_player_session_count_isSet = true;
}

bool OAIGameSession::is_maximum_player_session_count_Set() const{
    return m_maximum_player_session_count_isSet;
}

bool OAIGameSession::is_maximum_player_session_count_Valid() const{
    return m_maximum_player_session_count_isValid;
}

OAIGameSessionStatus OAIGameSession::getStatus() const {
    return m_status;
}
void OAIGameSession::setStatus(const OAIGameSessionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGameSession::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGameSession::is_status_Valid() const{
    return m_status_isValid;
}

OAIGameSessionStatusReason OAIGameSession::getStatusReason() const {
    return m_status_reason;
}
void OAIGameSession::setStatusReason(const OAIGameSessionStatusReason &status_reason) {
    m_status_reason = status_reason;
    m_status_reason_isSet = true;
}

bool OAIGameSession::is_status_reason_Set() const{
    return m_status_reason_isSet;
}

bool OAIGameSession::is_status_reason_Valid() const{
    return m_status_reason_isValid;
}

QList OAIGameSession::getGameProperties() const {
    return m_game_properties;
}
void OAIGameSession::setGameProperties(const QList &game_properties) {
    m_game_properties = game_properties;
    m_game_properties_isSet = true;
}

bool OAIGameSession::is_game_properties_Set() const{
    return m_game_properties_isSet;
}

bool OAIGameSession::is_game_properties_Valid() const{
    return m_game_properties_isValid;
}

QString OAIGameSession::getIpAddress() const {
    return m_ip_address;
}
void OAIGameSession::setIpAddress(const QString &ip_address) {
    m_ip_address = ip_address;
    m_ip_address_isSet = true;
}

bool OAIGameSession::is_ip_address_Set() const{
    return m_ip_address_isSet;
}

bool OAIGameSession::is_ip_address_Valid() const{
    return m_ip_address_isValid;
}

QString OAIGameSession::getDnsName() const {
    return m_dns_name;
}
void OAIGameSession::setDnsName(const QString &dns_name) {
    m_dns_name = dns_name;
    m_dns_name_isSet = true;
}

bool OAIGameSession::is_dns_name_Set() const{
    return m_dns_name_isSet;
}

bool OAIGameSession::is_dns_name_Valid() const{
    return m_dns_name_isValid;
}

qint32 OAIGameSession::getPort() const {
    return m_port;
}
void OAIGameSession::setPort(const qint32 &port) {
    m_port = port;
    m_port_isSet = true;
}

bool OAIGameSession::is_port_Set() const{
    return m_port_isSet;
}

bool OAIGameSession::is_port_Valid() const{
    return m_port_isValid;
}

OAIPlayerSessionCreationPolicy OAIGameSession::getPlayerSessionCreationPolicy() const {
    return m_player_session_creation_policy;
}
void OAIGameSession::setPlayerSessionCreationPolicy(const OAIPlayerSessionCreationPolicy &player_session_creation_policy) {
    m_player_session_creation_policy = player_session_creation_policy;
    m_player_session_creation_policy_isSet = true;
}

bool OAIGameSession::is_player_session_creation_policy_Set() const{
    return m_player_session_creation_policy_isSet;
}

bool OAIGameSession::is_player_session_creation_policy_Valid() const{
    return m_player_session_creation_policy_isValid;
}

QString OAIGameSession::getCreatorId() const {
    return m_creator_id;
}
void OAIGameSession::setCreatorId(const QString &creator_id) {
    m_creator_id = creator_id;
    m_creator_id_isSet = true;
}

bool OAIGameSession::is_creator_id_Set() const{
    return m_creator_id_isSet;
}

bool OAIGameSession::is_creator_id_Valid() const{
    return m_creator_id_isValid;
}

QString OAIGameSession::getGameSessionData() const {
    return m_game_session_data;
}
void OAIGameSession::setGameSessionData(const QString &game_session_data) {
    m_game_session_data = game_session_data;
    m_game_session_data_isSet = true;
}

bool OAIGameSession::is_game_session_data_Set() const{
    return m_game_session_data_isSet;
}

bool OAIGameSession::is_game_session_data_Valid() const{
    return m_game_session_data_isValid;
}

QString OAIGameSession::getMatchmakerData() const {
    return m_matchmaker_data;
}
void OAIGameSession::setMatchmakerData(const QString &matchmaker_data) {
    m_matchmaker_data = matchmaker_data;
    m_matchmaker_data_isSet = true;
}

bool OAIGameSession::is_matchmaker_data_Set() const{
    return m_matchmaker_data_isSet;
}

bool OAIGameSession::is_matchmaker_data_Valid() const{
    return m_matchmaker_data_isValid;
}

QString OAIGameSession::getLocation() const {
    return m_location;
}
void OAIGameSession::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIGameSession::is_location_Set() const{
    return m_location_isSet;
}

bool OAIGameSession::is_location_Valid() const{
    return m_location_isValid;
}

bool OAIGameSession::isSet() const {
...
bool OAIGameSession::isValid() const {
