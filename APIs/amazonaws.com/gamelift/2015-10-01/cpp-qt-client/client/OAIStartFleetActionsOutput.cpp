...
OAIStartFleetActionsOutput::OAIStartFleetActionsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartFleetActionsOutput::OAIStartFleetActionsOutput() {
    this->initializeModel();
}

OAIStartFleetActionsOutput::~OAIStartFleetActionsOutput() {}

void OAIStartFleetActionsOutput::initializeModel() {
...
void OAIStartFleetActionsOutput::fromJson(QString jsonString) {
...
void OAIStartFleetActionsOutput::fromJsonObject(QJsonObject json) {
...
QString OAIStartFleetActionsOutput::asJson() const {
...
QJsonObject OAIStartFleetActionsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
...
QString OAIStartFleetActionsOutput::getFleetId() const {
    return m_fleet_id;
}
void OAIStartFleetActionsOutput::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIStartFleetActionsOutput::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIStartFleetActionsOutput::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

QString OAIStartFleetActionsOutput::getFleetArn() const {
    return m_fleet_arn;
}
void OAIStartFleetActionsOutput::setFleetArn(const QString &fleet_arn) {
    m_fleet_arn = fleet_arn;
    m_fleet_arn_isSet = true;
}

bool OAIStartFleetActionsOutput::is_fleet_arn_Set() const{
    return m_fleet_arn_isSet;
}

bool OAIStartFleetActionsOutput::is_fleet_arn_Valid() const{
    return m_fleet_arn_isValid;
}

bool OAIStartFleetActionsOutput::isSet() const {
...
bool OAIStartFleetActionsOutput::isValid() const {
