...
OAIUpdateAliasInput_RoutingStrategy::OAIUpdateAliasInput_RoutingStrategy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateAliasInput_RoutingStrategy::OAIUpdateAliasInput_RoutingStrategy() {
    this->initializeModel();
}

OAIUpdateAliasInput_RoutingStrategy::~OAIUpdateAliasInput_RoutingStrategy() {}

void OAIUpdateAliasInput_RoutingStrategy::initializeModel() {
...
void OAIUpdateAliasInput_RoutingStrategy::fromJson(QString jsonString) {
...
void OAIUpdateAliasInput_RoutingStrategy::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateAliasInput_RoutingStrategy::asJson() const {
...
QJsonObject OAIUpdateAliasInput_RoutingStrategy::asJsonObject() const {
    QJsonObject obj;
    if (m_type.isSet()) {
...
OAIRoutingStrategyType OAIUpdateAliasInput_RoutingStrategy::getType() const {
    return m_type;
}
void OAIUpdateAliasInput_RoutingStrategy::setType(const OAIRoutingStrategyType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIUpdateAliasInput_RoutingStrategy::is_type_Set() const{
    return m_type_isSet;
}

bool OAIUpdateAliasInput_RoutingStrategy::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIUpdateAliasInput_RoutingStrategy::getFleetId() const {
    return m_fleet_id;
}
void OAIUpdateAliasInput_RoutingStrategy::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIUpdateAliasInput_RoutingStrategy::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIUpdateAliasInput_RoutingStrategy::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

QString OAIUpdateAliasInput_RoutingStrategy::getMessage() const {
    return m_message;
}
void OAIUpdateAliasInput_RoutingStrategy::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIUpdateAliasInput_RoutingStrategy::is_message_Set() const{
    return m_message_isSet;
}

bool OAIUpdateAliasInput_RoutingStrategy::is_message_Valid() const{
    return m_message_isValid;
}

bool OAIUpdateAliasInput_RoutingStrategy::isSet() const {
...
bool OAIUpdateAliasInput_RoutingStrategy::isValid() const {
