...
/*
 * OAIGameSessionStatusReason.h
 *
 * 
 */

#ifndef OAIGameSessionStatusReason_H
#define OAIGameSessionStatusReason_H
...
class OAIGameSessionStatusReason : public OAIEnum {
public:
    OAIGameSessionStatusReason();
    OAIGameSessionStatusReason(QString json);
    ~OAIGameSessionStatusReason() override;
    ...
    enum class eOAIGameSessionStatusReason {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        INTERRUPTED
    };
    OAIGameSessionStatusReason::eOAIGameSessionStatusReason getValue() const;
    void setValue(const OAIGameSessionStatusReason::eOAIGameSessionStatusReason& value);
...
private:
    ...
    eOAIGameSessionStatusReason m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGameSessionStatusReason)

#endif // OAIGameSessionStatusReason_H
