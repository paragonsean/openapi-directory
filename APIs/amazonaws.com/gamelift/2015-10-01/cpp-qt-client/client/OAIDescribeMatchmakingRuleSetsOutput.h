...
/*
 * OAIDescribeMatchmakingRuleSetsOutput.h
 *
 * 
 */

#ifndef OAIDescribeMatchmakingRuleSetsOutput_H
#define OAIDescribeMatchmakingRuleSetsOutput_H
...
class OAIDescribeMatchmakingRuleSetsOutput : public OAIObject {
public:
    OAIDescribeMatchmakingRuleSetsOutput();
    OAIDescribeMatchmakingRuleSetsOutput(QString json);
    ~OAIDescribeMatchmakingRuleSetsOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeMatchmakingRuleSetsOutput)

#endif // OAIDescribeMatchmakingRuleSetsOutput_H
