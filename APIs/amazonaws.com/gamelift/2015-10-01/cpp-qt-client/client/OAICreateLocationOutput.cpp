...
OAICreateLocationOutput::OAICreateLocationOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateLocationOutput::OAICreateLocationOutput() {
    this->initializeModel();
}

OAICreateLocationOutput::~OAICreateLocationOutput() {}

void OAICreateLocationOutput::initializeModel() {

    m_location_isSet = false;
    m_location_isValid = false;
}

void OAICreateLocationOutput::fromJson(QString jsonString) {
...
void OAICreateLocationOutput::fromJsonObject(QJsonObject json) {

    m_location_isValid = ::OpenAPI::fromJsonValue(m_location, json[QString("Location")]);
    m_location_isSet = !json[QString("Location")].isNull() && m_location_isValid;
}

QString OAICreateLocationOutput::asJson() const {
...
QJsonObject OAICreateLocationOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_location.isSet()) {
...
OAICreateLocationOutput_Location OAICreateLocationOutput::getLocation() const {
    return m_location;
}
void OAICreateLocationOutput::setLocation(const OAICreateLocationOutput_Location &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAICreateLocationOutput::is_location_Set() const{
    return m_location_isSet;
}

bool OAICreateLocationOutput::is_location_Valid() const{
    return m_location_isValid;
}

bool OAICreateLocationOutput::isSet() const {
...
bool OAICreateLocationOutput::isValid() const {
