...
#ifndef OAIClaimFilterOption_H
#define OAIClaimFilterOption_H
...
class OAIClaimFilterOption : public OAIObject {
public:
    OAIClaimFilterOption();
    OAIClaimFilterOption(QString json);
    ~OAIClaimFilterOption() override;
    ...
    QList getInstanceStatuses() const;
    void setInstanceStatuses(const QList &instance_statuses);
    bool is_instance_statuses_Set() const;
    bool is_instance_statuses_Valid() const;
...
private:
    ...
    QList m_instance_statuses;
    bool m_instance_statuses_isSet;
    bool m_instance_statuses_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIClaimFilterOption)

#endif // OAIClaimFilterOption_H
