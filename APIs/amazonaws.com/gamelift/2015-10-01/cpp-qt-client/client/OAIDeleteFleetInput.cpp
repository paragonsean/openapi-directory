...
OAIDeleteFleetInput::OAIDeleteFleetInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteFleetInput::OAIDeleteFleetInput() {
    this->initializeModel();
}

OAIDeleteFleetInput::~OAIDeleteFleetInput() {}

void OAIDeleteFleetInput::initializeModel() {

    m_fleet_id_isSet = false;
    m_fleet_id_isValid = false;
}

void OAIDeleteFleetInput::fromJson(QString jsonString) {
...
void OAIDeleteFleetInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteFleetInput::asJson() const {
...
QJsonObject OAIDeleteFleetInput::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
...
QString OAIDeleteFleetInput::getFleetId() const {
    return m_fleet_id;
}
void OAIDeleteFleetInput::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIDeleteFleetInput::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIDeleteFleetInput::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

bool OAIDeleteFleetInput::isSet() const {
...
bool OAIDeleteFleetInput::isValid() const {
