...
/*
 * OAIListComputeInput.h
 *
 * 
 */

#ifndef OAIListComputeInput_H
#define OAIListComputeInput_H
...
class OAIListComputeInput : public OAIObject {
public:
    OAIListComputeInput();
    OAIListComputeInput(QString json);
    ~OAIListComputeInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListComputeInput)

#endif // OAIListComputeInput_H
