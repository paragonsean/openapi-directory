...
OAIListAliasesOutput::OAIListAliasesOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListAliasesOutput::OAIListAliasesOutput() {
    this->initializeModel();
}

OAIListAliasesOutput::~OAIListAliasesOutput() {}

void OAIListAliasesOutput::initializeModel() {
...
void OAIListAliasesOutput::fromJson(QString jsonString) {
...
void OAIListAliasesOutput::fromJsonObject(QJsonObject json) {
...
QString OAIListAliasesOutput::asJson() const {
...
QJsonObject OAIListAliasesOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_aliases.isSet()) {
...
QList OAIListAliasesOutput::getAliases() const {
    return m_aliases;
}
void OAIListAliasesOutput::setAliases(const QList &aliases) {
    m_aliases = aliases;
    m_aliases_isSet = true;
}

bool OAIListAliasesOutput::is_aliases_Set() const{
    return m_aliases_isSet;
}

bool OAIListAliasesOutput::is_aliases_Valid() const{
    return m_aliases_isValid;
}

QString OAIListAliasesOutput::getNextToken() const {
    return m_next_token;
}
void OAIListAliasesOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListAliasesOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListAliasesOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListAliasesOutput::isSet() const {
...
bool OAIListAliasesOutput::isValid() const {
