...
/*
 * OAICreateFleetInput_ResourceCreationLimitPolicy.h
 *
 * 
 */

#ifndef OAICreateFleetInput_ResourceCreationLimitPolicy_H
#define OAICreateFleetInput_ResourceCreationLimitPolicy_H
...
class OAICreateFleetInput_ResourceCreationLimitPolicy : public OAIObject {
public:
    OAICreateFleetInput_ResourceCreationLimitPolicy();
    OAICreateFleetInput_ResourceCreationLimitPolicy(QString json);
    ~OAICreateFleetInput_ResourceCreationLimitPolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFleetInput_ResourceCreationLimitPolicy)

#endif // OAICreateFleetInput_ResourceCreationLimitPolicy_H
