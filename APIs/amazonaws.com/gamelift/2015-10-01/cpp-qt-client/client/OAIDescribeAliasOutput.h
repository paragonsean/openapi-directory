...
/*
 * OAIDescribeAliasOutput.h
 *
 * 
 */

#ifndef OAIDescribeAliasOutput_H
#define OAIDescribeAliasOutput_H
...
namespace OpenAPI {
class OAIDescribeAliasOutput_Alias;

class OAIDescribeAliasOutput : public OAIObject {
public:
    OAIDescribeAliasOutput();
    OAIDescribeAliasOutput(QString json);
    ~OAIDescribeAliasOutput() override;
    ...
    OAIDescribeAliasOutput_Alias getAlias() const;
    void setAlias(const OAIDescribeAliasOutput_Alias &alias);
...
private:
    ...
    OAIDescribeAliasOutput_Alias m_alias;
    bool m_alias_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAliasOutput)

#endif // OAIDescribeAliasOutput_H
