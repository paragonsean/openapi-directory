...
/*
 * OAIGameServerHealthCheck.h
 *
 * 
 */

#ifndef OAIGameServerHealthCheck_H
#define OAIGameServerHealthCheck_H
...
class OAIGameServerHealthCheck : public OAIEnum {
public:
    OAIGameServerHealthCheck();
    OAIGameServerHealthCheck(QString json);
    ~OAIGameServerHealthCheck() override;
    ...
    enum class eOAIGameServerHealthCheck {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        HEALTHY
    };
    OAIGameServerHealthCheck::eOAIGameServerHealthCheck getValue() const;
    void setValue(const OAIGameServerHealthCheck::eOAIGameServerHealthCheck& value);
...
private:
    ...
    eOAIGameServerHealthCheck m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGameServerHealthCheck)

#endif // OAIGameServerHealthCheck_H
