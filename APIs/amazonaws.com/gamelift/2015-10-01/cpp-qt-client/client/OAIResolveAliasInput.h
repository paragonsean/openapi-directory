...
/*
 * OAIResolveAliasInput.h
 *
 * 
 */

#ifndef OAIResolveAliasInput_H
#define OAIResolveAliasInput_H
...
class OAIResolveAliasInput : public OAIObject {
public:
    OAIResolveAliasInput();
    OAIResolveAliasInput(QString json);
    ~OAIResolveAliasInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResolveAliasInput)

#endif // OAIResolveAliasInput_H
