...
/*
 * OAIDescribeFleetLocationUtilizationOutput_FleetUtilization.h
 *
 * 
 */

#ifndef OAIDescribeFleetLocationUtilizationOutput_FleetUtilization_H
#define OAIDescribeFleetLocationUtilizationOutput_FleetUtilization_H
...
class OAIDescribeFleetLocationUtilizationOutput_FleetUtilization : public OAIObject {
public:
    OAIDescribeFleetLocationUtilizationOutput_FleetUtilization();
    OAIDescribeFleetLocationUtilizationOutput_FleetUtilization(QString json);
    ~OAIDescribeFleetLocationUtilizationOutput_FleetUtilization() override;
    ...
    qint32 getActiveServerProcessCount() const;
    void setActiveServerProcessCount(const qint32 &active_server_process_count);
    bool is_active_server_process_count_Set() const;
    bool is_active_server_process_count_Valid() const;

    qint32 getActiveGameSessionCount() const;
    void setActiveGameSessionCount(const qint32 &active_game_session_count);
    bool is_active_game_session_count_Set() const;
    bool is_active_game_session_count_Valid() const;
...
private:
    ...
    qint32 m_active_server_process_count;
    bool m_active_server_process_count_isSet;
    bool m_active_server_process_count_isValid;

    qint32 m_active_game_session_count;
    bool m_active_game_session_count_isSet;
    bool m_active_game_session_count_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFleetLocationUtilizationOutput_FleetUtilization)

#endif // OAIDescribeFleetLocationUtilizationOutput_FleetUtilization_H
