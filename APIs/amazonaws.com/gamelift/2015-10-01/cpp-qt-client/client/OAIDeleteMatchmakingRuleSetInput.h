...
/*
 * OAIDeleteMatchmakingRuleSetInput.h
 *
 * 
 */

#ifndef OAIDeleteMatchmakingRuleSetInput_H
#define OAIDeleteMatchmakingRuleSetInput_H
...
class OAIDeleteMatchmakingRuleSetInput : public OAIObject {
public:
    OAIDeleteMatchmakingRuleSetInput();
    OAIDeleteMatchmakingRuleSetInput(QString json);
    ~OAIDeleteMatchmakingRuleSetInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteMatchmakingRuleSetInput)

#endif // OAIDeleteMatchmakingRuleSetInput_H
