...
OAIGetInstanceAccessInput::OAIGetInstanceAccessInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetInstanceAccessInput::OAIGetInstanceAccessInput() {
    this->initializeModel();
}

OAIGetInstanceAccessInput::~OAIGetInstanceAccessInput() {}

void OAIGetInstanceAccessInput::initializeModel() {
...
void OAIGetInstanceAccessInput::fromJson(QString jsonString) {
...
void OAIGetInstanceAccessInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetInstanceAccessInput::asJson() const {
...
QJsonObject OAIGetInstanceAccessInput::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
...
QString OAIGetInstanceAccessInput::getFleetId() const {
    return m_fleet_id;
}
void OAIGetInstanceAccessInput::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIGetInstanceAccessInput::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIGetInstanceAccessInput::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

QString OAIGetInstanceAccessInput::getInstanceId() const {
    return m_instance_id;
}
void OAIGetInstanceAccessInput::setInstanceId(const QString &instance_id) {
    m_instance_id = instance_id;
    m_instance_id_isSet = true;
}

bool OAIGetInstanceAccessInput::is_instance_id_Set() const{
    return m_instance_id_isSet;
}

bool OAIGetInstanceAccessInput::is_instance_id_Valid() const{
    return m_instance_id_isValid;
}

bool OAIGetInstanceAccessInput::isSet() const {
...
bool OAIGetInstanceAccessInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_fleet_id_isValid && m_instance_id_isValid && true;
}
