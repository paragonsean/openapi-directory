...
/*
 * OAIClaimGameServerInput.h
 *
 * 
 */

#ifndef OAIClaimGameServerInput_H
#define OAIClaimGameServerInput_H
...
namespace OpenAPI {
class OAIClaimGameServerInput_FilterOption;

class OAIClaimGameServerInput : public OAIObject {
public:
    OAIClaimGameServerInput();
    OAIClaimGameServerInput(QString json);
    ~OAIClaimGameServerInput() override;
    ...
    OAIClaimGameServerInput_FilterOption getFilterOption() const;
    void setFilterOption(const OAIClaimGameServerInput_FilterOption &filter_option);
    bool is_filter_option_Set() const;
    bool is_filter_option_Valid() const;
...
private:
    ...
    OAIClaimGameServerInput_FilterOption m_filter_option;
    bool m_filter_option_isSet;
    bool m_filter_option_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIClaimGameServerInput)

#endif // OAIClaimGameServerInput_H
