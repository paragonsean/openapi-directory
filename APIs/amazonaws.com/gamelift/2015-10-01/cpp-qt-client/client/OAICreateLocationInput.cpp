...
OAICreateLocationInput::OAICreateLocationInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateLocationInput::OAICreateLocationInput() {
    this->initializeModel();
}

OAICreateLocationInput::~OAICreateLocationInput() {}

void OAICreateLocationInput::initializeModel() {
...
void OAICreateLocationInput::fromJson(QString jsonString) {
...
void OAICreateLocationInput::fromJsonObject(QJsonObject json) {
...
QString OAICreateLocationInput::asJson() const {
...
QJsonObject OAICreateLocationInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateLocationInput::getLocationName() const {
    return m_location_name;
}
void OAICreateLocationInput::setLocationName(const QString &location_name) {
    m_location_name = location_name;
    m_location_name_isSet = true;
}

bool OAICreateLocationInput::is_location_name_Set() const{
    return m_location_name_isSet;
}

bool OAICreateLocationInput::is_location_name_Valid() const{
    return m_location_name_isValid;
}

QList OAICreateLocationInput::getTags() const {
    return m_tags;
}
void OAICreateLocationInput::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateLocationInput::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateLocationInput::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAICreateLocationInput::isSet() const {
...
bool OAICreateLocationInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_location_name_isValid && true;
}
