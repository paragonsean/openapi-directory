...
OAIDescribeRuntimeConfigurationOutput::OAIDescribeRuntimeConfigurationOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeRuntimeConfigurationOutput::OAIDescribeRuntimeConfigurationOutput() {
    this->initializeModel();
}

OAIDescribeRuntimeConfigurationOutput::~OAIDescribeRuntimeConfigurationOutput() {}

void OAIDescribeRuntimeConfigurationOutput::initializeModel() {

    m_runtime_configuration_isSet = false;
    m_runtime_configuration_isValid = false;
}

void OAIDescribeRuntimeConfigurationOutput::fromJson(QString jsonString) {
...
void OAIDescribeRuntimeConfigurationOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeRuntimeConfigurationOutput::asJson() const {
...
QJsonObject OAIDescribeRuntimeConfigurationOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIDescribeRuntimeConfigurationOutput_RuntimeConfiguration OAIDescribeRuntimeConfigurationOutput::getRuntimeConfiguration() const {
    return m_runtime_configuration;
}
void OAIDescribeRuntimeConfigurationOutput::setRuntimeConfiguration(const OAIDescribeRuntimeConfigurationOutput_RuntimeConfiguration &runtime_configuration) {
    m_runtime_configuration = runtime_configuration;
    m_runtime_configuration_isSet = true;
}

bool OAIDescribeRuntimeConfigurationOutput::is_runtime_configuration_Set() const{
    return m_runtime_configuration_isSet;
}

bool OAIDescribeRuntimeConfigurationOutput::is_runtime_configuration_Valid() const{
    return m_runtime_configuration_isValid;
}

bool OAIDescribeRuntimeConfigurationOutput::isSet() const {
...
bool OAIDescribeRuntimeConfigurationOutput::isValid() const {
