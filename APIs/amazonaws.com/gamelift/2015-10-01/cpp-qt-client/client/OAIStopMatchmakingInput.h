...
/*
 * OAIStopMatchmakingInput.h
 *
 * 
 */

#ifndef OAIStopMatchmakingInput_H
#define OAIStopMatchmakingInput_H
...
class OAIStopMatchmakingInput : public OAIObject {
public:
    OAIStopMatchmakingInput();
    OAIStopMatchmakingInput(QString json);
    ~OAIStopMatchmakingInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopMatchmakingInput)

#endif // OAIStopMatchmakingInput_H
