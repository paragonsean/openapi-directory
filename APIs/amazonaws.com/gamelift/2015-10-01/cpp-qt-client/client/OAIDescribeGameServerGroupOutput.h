...
/*
 * OAIDescribeGameServerGroupOutput.h
 *
 * 
 */

#ifndef OAIDescribeGameServerGroupOutput_H
#define OAIDescribeGameServerGroupOutput_H

#include <QJsonObject>

#include "OAIDescribeGameServerGroupOutput_GameServerGroup.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIDescribeGameServerGroupOutput_GameServerGroup;

class OAIDescribeGameServerGroupOutput : public OAIObject {
public:
    OAIDescribeGameServerGroupOutput();
    OAIDescribeGameServerGroupOutput(QString json);
    ~OAIDescribeGameServerGroupOutput() override;
    ...
    OAIDescribeGameServerGroupOutput_GameServerGroup getGameServerGroup() const;
    void setGameServerGroup(const OAIDescribeGameServerGroupOutput_GameServerGroup &game_server_group);
    bool is_game_server_group_Set() const;
    bool is_game_server_group_Valid() const;
...
private:
    ...
    OAIDescribeGameServerGroupOutput_GameServerGroup m_game_server_group;
    bool m_game_server_group_isSet;
    bool m_game_server_group_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeGameServerGroupOutput)

#endif // OAIDescribeGameServerGroupOutput_H
