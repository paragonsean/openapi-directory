...
#ifndef OAIFleetCapacity_H
#define OAIFleetCapacity_H
...
class OAIFleetCapacity : public OAIObject {
public:
    OAIFleetCapacity();
    OAIFleetCapacity(QString json);
    ~OAIFleetCapacity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFleetCapacity)

#endif // OAIFleetCapacity_H
