...
OAIDescribeGameSessionPlacementInput::OAIDescribeGameSessionPlacementInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeGameSessionPlacementInput::OAIDescribeGameSessionPlacementInput() {
    this->initializeModel();
}

OAIDescribeGameSessionPlacementInput::~OAIDescribeGameSessionPlacementInput() {}

void OAIDescribeGameSessionPlacementInput::initializeModel() {

    m_placement_id_isSet = false;
    m_placement_id_isValid = false;
}

void OAIDescribeGameSessionPlacementInput::fromJson(QString jsonString) {
...
void OAIDescribeGameSessionPlacementInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeGameSessionPlacementInput::asJson() const {
...
QJsonObject OAIDescribeGameSessionPlacementInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeGameSessionPlacementInput::getPlacementId() const {
    return m_placement_id;
}
void OAIDescribeGameSessionPlacementInput::setPlacementId(const QString &placement_id) {
    m_placement_id = placement_id;
    m_placement_id_isSet = true;
}

bool OAIDescribeGameSessionPlacementInput::is_placement_id_Set() const{
    return m_placement_id_isSet;
}

bool OAIDescribeGameSessionPlacementInput::is_placement_id_Valid() const{
    return m_placement_id_isValid;
}

bool OAIDescribeGameSessionPlacementInput::isSet() const {
...
bool OAIDescribeGameSessionPlacementInput::isValid() const {
