...
OAILocationUpdateStatus::OAILocationUpdateStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILocationUpdateStatus::OAILocationUpdateStatus() {
    this->initializeModel();
}

OAILocationUpdateStatus::~OAILocationUpdateStatus() {}

void OAILocationUpdateStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAILocationUpdateStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAILocationUpdateStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("PENDING_UPDATE", Qt::CaseInsensitive) == 0) {
        m_value = eOAILocationUpdateStatus::PENDING_UPDATE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAILocationUpdateStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAILocationUpdateStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAILocationUpdateStatus::PENDING_UPDATE:
            val = "PENDING_UPDATE";
            break;
        default:
            break;
...
QJsonValue OAILocationUpdateStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAILocationUpdateStatus::eOAILocationUpdateStatus OAILocationUpdateStatus::getValue() const {
    return m_value;
}

void OAILocationUpdateStatus::setValue(const OAILocationUpdateStatus::eOAILocationUpdateStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAILocationUpdateStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAILocationUpdateStatus::isValid() const {
