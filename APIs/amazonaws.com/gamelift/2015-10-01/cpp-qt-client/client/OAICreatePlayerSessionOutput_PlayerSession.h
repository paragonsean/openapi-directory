...
/*
 * OAICreatePlayerSessionOutput_PlayerSession.h
 *
 * 
 */

#ifndef OAICreatePlayerSessionOutput_PlayerSession_H
#define OAICreatePlayerSessionOutput_PlayerSession_H

#include <QJsonObject>

#include "OAIPlayerSessionStatus.h"
#include <QDateTime>
#include <QString>
...
class OAICreatePlayerSessionOutput_PlayerSession : public OAIObject {
public:
    OAICreatePlayerSessionOutput_PlayerSession();
    OAICreatePlayerSessionOutput_PlayerSession(QString json);
    ~OAICreatePlayerSessionOutput_PlayerSession() override;
    ...
    OAIPlayerSessionStatus getStatus() const;
    void setStatus(const OAIPlayerSessionStatus &status);
...
private:
    ...
    OAIPlayerSessionStatus m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePlayerSessionOutput_PlayerSession)

#endif // OAICreatePlayerSessionOutput_PlayerSession_H
