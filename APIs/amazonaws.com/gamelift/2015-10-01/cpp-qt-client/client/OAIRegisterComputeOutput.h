...
/*
 * OAIRegisterComputeOutput.h
 *
 * 
 */

#ifndef OAIRegisterComputeOutput_H
#define OAIRegisterComputeOutput_H

#include <QJsonObject>

#include "OAIDescribeComputeOutput_Compute.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIDescribeComputeOutput_Compute;

class OAIRegisterComputeOutput : public OAIObject {
public:
    OAIRegisterComputeOutput();
    OAIRegisterComputeOutput(QString json);
    ~OAIRegisterComputeOutput() override;
    ...
    OAIDescribeComputeOutput_Compute getCompute() const;
    void setCompute(const OAIDescribeComputeOutput_Compute &compute);
...
private:
    ...
    OAIDescribeComputeOutput_Compute m_compute;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegisterComputeOutput)

#endif // OAIRegisterComputeOutput_H
