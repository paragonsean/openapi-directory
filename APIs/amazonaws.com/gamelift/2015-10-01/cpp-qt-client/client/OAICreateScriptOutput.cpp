...
OAICreateScriptOutput::OAICreateScriptOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateScriptOutput::OAICreateScriptOutput() {
    this->initializeModel();
}

OAICreateScriptOutput::~OAICreateScriptOutput() {}

void OAICreateScriptOutput::initializeModel() {

    m_script_isSet = false;
    m_script_isValid = false;
}

void OAICreateScriptOutput::fromJson(QString jsonString) {
...
void OAICreateScriptOutput::fromJsonObject(QJsonObject json) {
...
QString OAICreateScriptOutput::asJson() const {
...
QJsonObject OAICreateScriptOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_script.isSet()) {
...
OAICreateScriptOutput_Script OAICreateScriptOutput::getScript() const {
    return m_script;
}
void OAICreateScriptOutput::setScript(const OAICreateScriptOutput_Script &script) {
    m_script = script;
    m_script_isSet = true;
}

bool OAICreateScriptOutput::is_script_Set() const{
    return m_script_isSet;
}

bool OAICreateScriptOutput::is_script_Valid() const{
    return m_script_isValid;
}

bool OAICreateScriptOutput::isSet() const {
...
bool OAICreateScriptOutput::isValid() const {
