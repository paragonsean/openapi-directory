...
/*
 * OAIDescribeBuildOutput_Build.h
 *
 * 
 */

#ifndef OAIDescribeBuildOutput_Build_H
#define OAIDescribeBuildOutput_Build_H
...
class OAIDescribeBuildOutput_Build : public OAIObject {
public:
    OAIDescribeBuildOutput_Build();
    OAIDescribeBuildOutput_Build(QString json);
    ~OAIDescribeBuildOutput_Build() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeBuildOutput_Build)

#endif // OAIDescribeBuildOutput_Build_H
