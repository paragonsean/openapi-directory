...
/*
 * OAIScalingAdjustmentType.h
 *
 * 
 */

#ifndef OAIScalingAdjustmentType_H
#define OAIScalingAdjustmentType_H
...
class OAIScalingAdjustmentType : public OAIEnum {
public:
    OAIScalingAdjustmentType();
    OAIScalingAdjustmentType(QString json);
    ~OAIScalingAdjustmentType() override;
    ...
    enum class eOAIScalingAdjustmentType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        CHANGEINCAPACITY, 
        EXACTCAPACITY, 
        PERCENTCHANGEINCAPACITY
    };
    OAIScalingAdjustmentType::eOAIScalingAdjustmentType getValue() const;
    void setValue(const OAIScalingAdjustmentType::eOAIScalingAdjustmentType& value);
...
private:
    ...
    eOAIScalingAdjustmentType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScalingAdjustmentType)

#endif // OAIScalingAdjustmentType_H
