...
/*
 * OAITargetConfiguration.h
 *
 * Settings for a target-based scaling policy. A target-based policy tracks a particular fleet metric specifies a target value for the metric. As player usage changes, the policy triggers Amazon GameLift to adjust capacity so that the metric returns to the target value. The target configuration specifies settings as needed for the target based policy, including the target value. 
 */

#ifndef OAITargetConfiguration_H
#define OAITargetConfiguration_H
...
class OAITargetConfiguration : public OAIObject {
public:
    OAITargetConfiguration();
    OAITargetConfiguration(QString json);
    ~OAITargetConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITargetConfiguration)

#endif // OAITargetConfiguration_H
