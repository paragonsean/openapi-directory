...
/*
 * OAIGameSessionStatus.h
 *
 * 
 */

#ifndef OAIGameSessionStatus_H
#define OAIGameSessionStatus_H
...
class OAIGameSessionStatus : public OAIEnum {
public:
    OAIGameSessionStatus();
    OAIGameSessionStatus(QString json);
    ~OAIGameSessionStatus() override;
    ...
    enum class eOAIGameSessionStatus {
    ...
    OAIGameSessionStatus::eOAIGameSessionStatus getValue() const;
    void setValue(const OAIGameSessionStatus::eOAIGameSessionStatus& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGameSessionStatus)

#endif // OAIGameSessionStatus_H
