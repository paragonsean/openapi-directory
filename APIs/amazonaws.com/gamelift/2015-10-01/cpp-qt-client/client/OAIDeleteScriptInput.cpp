...
OAIDeleteScriptInput::OAIDeleteScriptInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteScriptInput::OAIDeleteScriptInput() {
    this->initializeModel();
}

OAIDeleteScriptInput::~OAIDeleteScriptInput() {}

void OAIDeleteScriptInput::initializeModel() {

    m_script_id_isSet = false;
    m_script_id_isValid = false;
}

void OAIDeleteScriptInput::fromJson(QString jsonString) {
...
void OAIDeleteScriptInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteScriptInput::asJson() const {
...
QJsonObject OAIDeleteScriptInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteScriptInput::getScriptId() const {
    return m_script_id;
}
void OAIDeleteScriptInput::setScriptId(const QString &script_id) {
    m_script_id = script_id;
    m_script_id_isSet = true;
}

bool OAIDeleteScriptInput::is_script_id_Set() const{
    return m_script_id_isSet;
}

bool OAIDeleteScriptInput::is_script_id_Valid() const{
    return m_script_id_isValid;
}

bool OAIDeleteScriptInput::isSet() const {
...
bool OAIDeleteScriptInput::isValid() const {
