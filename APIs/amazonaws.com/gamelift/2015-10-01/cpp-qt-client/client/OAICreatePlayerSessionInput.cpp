...
OAICreatePlayerSessionInput::OAICreatePlayerSessionInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreatePlayerSessionInput::OAICreatePlayerSessionInput() {
    this->initializeModel();
}

OAICreatePlayerSessionInput::~OAICreatePlayerSessionInput() {}

void OAICreatePlayerSessionInput::initializeModel() {
...
void OAICreatePlayerSessionInput::fromJson(QString jsonString) {
...
void OAICreatePlayerSessionInput::fromJsonObject(QJsonObject json) {
...
QString OAICreatePlayerSessionInput::asJson() const {
...
QJsonObject OAICreatePlayerSessionInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreatePlayerSessionInput::getGameSessionId() const {
    return m_game_session_id;
}
void OAICreatePlayerSessionInput::setGameSessionId(const QString &game_session_id) {
    m_game_session_id = game_session_id;
    m_game_session_id_isSet = true;
}

bool OAICreatePlayerSessionInput::is_game_session_id_Set() const{
    return m_game_session_id_isSet;
}

bool OAICreatePlayerSessionInput::is_game_session_id_Valid() const{
    return m_game_session_id_isValid;
}

QString OAICreatePlayerSessionInput::getPlayerId() const {
    return m_player_id;
}
void OAICreatePlayerSessionInput::setPlayerId(const QString &player_id) {
    m_player_id = player_id;
    m_player_id_isSet = true;
}

bool OAICreatePlayerSessionInput::is_player_id_Set() const{
    return m_player_id_isSet;
}

bool OAICreatePlayerSessionInput::is_player_id_Valid() const{
    return m_player_id_isValid;
}

QString OAICreatePlayerSessionInput::getPlayerData() const {
    return m_player_data;
}
void OAICreatePlayerSessionInput::setPlayerData(const QString &player_data) {
    m_player_data = player_data;
    m_player_data_isSet = true;
}

bool OAICreatePlayerSessionInput::is_player_data_Set() const{
    return m_player_data_isSet;
}

bool OAICreatePlayerSessionInput::is_player_data_Valid() const{
    return m_player_data_isValid;
}

bool OAICreatePlayerSessionInput::isSet() const {
...
bool OAICreatePlayerSessionInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_game_session_id_isValid && m_player_id_isValid && true;
}
