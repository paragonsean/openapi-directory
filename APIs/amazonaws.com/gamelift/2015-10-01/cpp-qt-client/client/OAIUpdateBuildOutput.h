...
/*
 * OAIUpdateBuildOutput.h
 *
 * 
 */

#ifndef OAIUpdateBuildOutput_H
#define OAIUpdateBuildOutput_H

#include <QJsonObject>

#include "OAIUpdateBuildOutput_Build.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIUpdateBuildOutput_Build;

class OAIUpdateBuildOutput : public OAIObject {
public:
    OAIUpdateBuildOutput();
    OAIUpdateBuildOutput(QString json);
    ~OAIUpdateBuildOutput() override;
    ...
    OAIUpdateBuildOutput_Build getBuild() const;
    void setBuild(const OAIUpdateBuildOutput_Build &build);
...
private:
    ...
    OAIUpdateBuildOutput_Build m_build;
    bool m_build_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateBuildOutput)

#endif // OAIUpdateBuildOutput_H
