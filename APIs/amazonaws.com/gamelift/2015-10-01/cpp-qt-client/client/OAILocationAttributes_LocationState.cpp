...
#include "OAILocationAttributes_LocationState.h"
...
OAILocationAttributes_LocationState::OAILocationAttributes_LocationState(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILocationAttributes_LocationState::OAILocationAttributes_LocationState() {
    this->initializeModel();
}

OAILocationAttributes_LocationState::~OAILocationAttributes_LocationState() {}

void OAILocationAttributes_LocationState::initializeModel() {
...
void OAILocationAttributes_LocationState::fromJson(QString jsonString) {
...
void OAILocationAttributes_LocationState::fromJsonObject(QJsonObject json) {
...
QString OAILocationAttributes_LocationState::asJson() const {
...
QJsonObject OAILocationAttributes_LocationState::asJsonObject() const {
    QJsonObject obj;
    if (m_location_isSet) {
...
QString OAILocationAttributes_LocationState::getLocation() const {
    return m_location;
}
void OAILocationAttributes_LocationState::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAILocationAttributes_LocationState::is_location_Set() const{
    return m_location_isSet;
}

bool OAILocationAttributes_LocationState::is_location_Valid() const{
    return m_location_isValid;
}

OAIFleetStatus OAILocationAttributes_LocationState::getStatus() const {
    return m_status;
}
void OAILocationAttributes_LocationState::setStatus(const OAIFleetStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAILocationAttributes_LocationState::is_status_Set() const{
    return m_status_isSet;
}

bool OAILocationAttributes_LocationState::is_status_Valid() const{
    return m_status_isValid;
}

bool OAILocationAttributes_LocationState::isSet() const {
...
bool OAILocationAttributes_LocationState::isValid() const {
