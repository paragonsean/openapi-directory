...
/*
 * OAICreateBuildOutput_UploadCredentials.h
 *
 * 
 */

#ifndef OAICreateBuildOutput_UploadCredentials_H
#define OAICreateBuildOutput_UploadCredentials_H
...
class OAICreateBuildOutput_UploadCredentials : public OAIObject {
public:
    OAICreateBuildOutput_UploadCredentials();
    OAICreateBuildOutput_UploadCredentials(QString json);
    ~OAICreateBuildOutput_UploadCredentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateBuildOutput_UploadCredentials)

#endif // OAICreateBuildOutput_UploadCredentials_H
