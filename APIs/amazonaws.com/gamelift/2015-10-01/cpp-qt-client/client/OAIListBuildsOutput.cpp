...
OAIListBuildsOutput::OAIListBuildsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListBuildsOutput::OAIListBuildsOutput() {
    this->initializeModel();
}

OAIListBuildsOutput::~OAIListBuildsOutput() {}

void OAIListBuildsOutput::initializeModel() {
...
void OAIListBuildsOutput::fromJson(QString jsonString) {
...
void OAIListBuildsOutput::fromJsonObject(QJsonObject json) {
...
QString OAIListBuildsOutput::asJson() const {
...
QJsonObject OAIListBuildsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_builds.isSet()) {
...
QList OAIListBuildsOutput::getBuilds() const {
    return m_builds;
}
void OAIListBuildsOutput::setBuilds(const QList &builds) {
    m_builds = builds;
    m_builds_isSet = true;
}

bool OAIListBuildsOutput::is_builds_Set() const{
    return m_builds_isSet;
}

bool OAIListBuildsOutput::is_builds_Valid() const{
    return m_builds_isValid;
}

QString OAIListBuildsOutput::getNextToken() const {
    return m_next_token;
}
void OAIListBuildsOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListBuildsOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListBuildsOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListBuildsOutput::isSet() const {
...
bool OAIListBuildsOutput::isValid() const {
