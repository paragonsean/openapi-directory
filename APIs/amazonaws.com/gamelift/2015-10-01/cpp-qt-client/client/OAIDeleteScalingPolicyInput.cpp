...
OAIDeleteScalingPolicyInput::OAIDeleteScalingPolicyInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteScalingPolicyInput::OAIDeleteScalingPolicyInput() {
    this->initializeModel();
}

OAIDeleteScalingPolicyInput::~OAIDeleteScalingPolicyInput() {}

void OAIDeleteScalingPolicyInput::initializeModel() {
...
void OAIDeleteScalingPolicyInput::fromJson(QString jsonString) {
...
void OAIDeleteScalingPolicyInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteScalingPolicyInput::asJson() const {
...
QJsonObject OAIDeleteScalingPolicyInput::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIDeleteScalingPolicyInput::getName() const {
    return m_name;
}
void OAIDeleteScalingPolicyInput::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDeleteScalingPolicyInput::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDeleteScalingPolicyInput::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIDeleteScalingPolicyInput::getFleetId() const {
    return m_fleet_id;
}
void OAIDeleteScalingPolicyInput::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIDeleteScalingPolicyInput::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIDeleteScalingPolicyInput::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

bool OAIDeleteScalingPolicyInput::isSet() const {
...
bool OAIDeleteScalingPolicyInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_name_isValid && m_fleet_id_isValid && true;
}
