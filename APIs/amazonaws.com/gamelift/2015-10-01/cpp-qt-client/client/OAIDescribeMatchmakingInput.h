...
/*
 * OAIDescribeMatchmakingInput.h
 *
 * 
 */

#ifndef OAIDescribeMatchmakingInput_H
#define OAIDescribeMatchmakingInput_H
...
class OAIDescribeMatchmakingInput : public OAIObject {
public:
    OAIDescribeMatchmakingInput();
    OAIDescribeMatchmakingInput(QString json);
    ~OAIDescribeMatchmakingInput() override;
    ...
    QList getTicketIds() const;
    void setTicketIds(const QList &ticket_ids);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeMatchmakingInput)

#endif // OAIDescribeMatchmakingInput_H
