...
/*
 * OAIDeleteAliasInput.h
 *
 * 
 */

#ifndef OAIDeleteAliasInput_H
#define OAIDeleteAliasInput_H
...
class OAIDeleteAliasInput : public OAIObject {
public:
    OAIDeleteAliasInput();
    OAIDeleteAliasInput(QString json);
    ~OAIDeleteAliasInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteAliasInput)

#endif // OAIDeleteAliasInput_H
