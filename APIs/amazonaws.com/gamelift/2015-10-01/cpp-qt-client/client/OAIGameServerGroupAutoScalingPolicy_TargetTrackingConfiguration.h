...
/*
 * OAIGameServerGroupAutoScalingPolicy_TargetTrackingConfiguration.h
 *
 * 
 */

#ifndef OAIGameServerGroupAutoScalingPolicy_TargetTrackingConfiguration_H
#define OAIGameServerGroupAutoScalingPolicy_TargetTrackingConfiguration_H
...
class OAIGameServerGroupAutoScalingPolicy_TargetTrackingConfiguration : public OAIObject {
public:
    OAIGameServerGroupAutoScalingPolicy_TargetTrackingConfiguration();
    OAIGameServerGroupAutoScalingPolicy_TargetTrackingConfiguration(QString json);
    ~OAIGameServerGroupAutoScalingPolicy_TargetTrackingConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGameServerGroupAutoScalingPolicy_TargetTrackingConfiguration)

#endif // OAIGameServerGroupAutoScalingPolicy_TargetTrackingConfiguration_H
