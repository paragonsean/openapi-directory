...
#ifndef OAIFleetAction_H
#define OAIFleetAction_H
...
class OAIFleetAction : public OAIEnum {
public:
    OAIFleetAction();
    OAIFleetAction(QString json);
    ~OAIFleetAction() override;
    ...
    enum class eOAIFleetAction {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        AUTO_SCALING
    };
    OAIFleetAction::eOAIFleetAction getValue() const;
    void setValue(const OAIFleetAction::eOAIFleetAction& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFleetAction)

#endif // OAIFleetAction_H
