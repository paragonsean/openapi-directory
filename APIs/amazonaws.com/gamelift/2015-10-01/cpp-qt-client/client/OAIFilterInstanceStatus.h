...
/*
 * OAIFilterInstanceStatus.h
 *
 * 
 */

#ifndef OAIFilterInstanceStatus_H
#define OAIFilterInstanceStatus_H
...
class OAIFilterInstanceStatus : public OAIEnum {
public:
    OAIFilterInstanceStatus();
    OAIFilterInstanceStatus(QString json);
    ~OAIFilterInstanceStatus() override;
    ...
    enum class eOAIFilterInstanceStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ACTIVE, 
        DRAINING
    };
    OAIFilterInstanceStatus::eOAIFilterInstanceStatus getValue() const;
    void setValue(const OAIFilterInstanceStatus::eOAIFilterInstanceStatus& value);
...
private:
    ...
    eOAIFilterInstanceStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFilterInstanceStatus)

#endif // OAIFilterInstanceStatus_H
