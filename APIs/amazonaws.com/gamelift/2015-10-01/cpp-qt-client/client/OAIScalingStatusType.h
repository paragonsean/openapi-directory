...
/*
 * OAIScalingStatusType.h
 *
 * 
 */

#ifndef OAIScalingStatusType_H
#define OAIScalingStatusType_H
...
class OAIScalingStatusType : public OAIEnum {
public:
    OAIScalingStatusType();
    OAIScalingStatusType(QString json);
    ~OAIScalingStatusType() override;
    ...
    enum class eOAIScalingStatusType {
    ...
    OAIScalingStatusType::eOAIScalingStatusType getValue() const;
    void setValue(const OAIScalingStatusType::eOAIScalingStatusType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIScalingStatusType)

#endif // OAIScalingStatusType_H
