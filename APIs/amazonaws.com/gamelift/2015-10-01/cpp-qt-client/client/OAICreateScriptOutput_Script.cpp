...
#include "OAICreateScriptOutput_Script.h"
...
OAICreateScriptOutput_Script::OAICreateScriptOutput_Script(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateScriptOutput_Script::OAICreateScriptOutput_Script() {
    this->initializeModel();
}

OAICreateScriptOutput_Script::~OAICreateScriptOutput_Script() {}

void OAICreateScriptOutput_Script::initializeModel() {
...
void OAICreateScriptOutput_Script::fromJson(QString jsonString) {
...
void OAICreateScriptOutput_Script::fromJsonObject(QJsonObject json) {
...
QString OAICreateScriptOutput_Script::asJson() const {
...
QJsonObject OAICreateScriptOutput_Script::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateScriptOutput_Script::getScriptId() const {
    return m_script_id;
}
void OAICreateScriptOutput_Script::setScriptId(const QString &script_id) {
    m_script_id = script_id;
    m_script_id_isSet = true;
}

bool OAICreateScriptOutput_Script::is_script_id_Set() const{
    return m_script_id_isSet;
}

bool OAICreateScriptOutput_Script::is_script_id_Valid() const{
    return m_script_id_isValid;
}

QString OAICreateScriptOutput_Script::getScriptArn() const {
    return m_script_arn;
}
void OAICreateScriptOutput_Script::setScriptArn(const QString &script_arn) {
    m_script_arn = script_arn;
    m_script_arn_isSet = true;
}

bool OAICreateScriptOutput_Script::is_script_arn_Set() const{
    return m_script_arn_isSet;
}

bool OAICreateScriptOutput_Script::is_script_arn_Valid() const{
    return m_script_arn_isValid;
}

QString OAICreateScriptOutput_Script::getName() const {
    return m_name;
}
void OAICreateScriptOutput_Script::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateScriptOutput_Script::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateScriptOutput_Script::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICreateScriptOutput_Script::getVersion() const {
    return m_version;
}
void OAICreateScriptOutput_Script::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAICreateScriptOutput_Script::is_version_Set() const{
    return m_version_isSet;
}

bool OAICreateScriptOutput_Script::is_version_Valid() const{
    return m_version_isValid;
}

qint32 OAICreateScriptOutput_Script::getSizeOnDisk() const {
    return m_size_on_disk;
}
void OAICreateScriptOutput_Script::setSizeOnDisk(const qint32 &size_on_disk) {
    m_size_on_disk = size_on_disk;
    m_size_on_disk_isSet = true;
}

bool OAICreateScriptOutput_Script::is_size_on_disk_Set() const{
    return m_size_on_disk_isSet;
}

bool OAICreateScriptOutput_Script::is_size_on_disk_Valid() const{
    return m_size_on_disk_isValid;
}

QDateTime OAICreateScriptOutput_Script::getCreationTime() const {
    return m_creation_time;
}
void OAICreateScriptOutput_Script::setCreationTime(const QDateTime &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAICreateScriptOutput_Script::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAICreateScriptOutput_Script::is_creation_time_Valid() const{
    return m_creation_time_isValid;
}

OAICreateScriptInput_StorageLocation OAICreateScriptOutput_Script::getStorageLocation() const {
    return m_storage_location;
}
void OAICreateScriptOutput_Script::setStorageLocation(const OAICreateScriptInput_StorageLocation &storage_location) {
    m_storage_location = storage_location;
    m_storage_location_isSet = true;
}

bool OAICreateScriptOutput_Script::is_storage_location_Set() const{
    return m_storage_location_isSet;
}

bool OAICreateScriptOutput_Script::is_storage_location_Valid() const{
    return m_storage_location_isValid;
}

bool OAICreateScriptOutput_Script::isSet() const {
...
bool OAICreateScriptOutput_Script::isValid() const {
