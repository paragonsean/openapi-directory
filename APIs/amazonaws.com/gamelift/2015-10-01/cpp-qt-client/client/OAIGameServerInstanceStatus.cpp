...
OAIGameServerInstanceStatus::OAIGameServerInstanceStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGameServerInstanceStatus::OAIGameServerInstanceStatus() {
    this->initializeModel();
}

OAIGameServerInstanceStatus::~OAIGameServerInstanceStatus() {}

void OAIGameServerInstanceStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIGameServerInstanceStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIGameServerInstanceStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ACTIVE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGameServerInstanceStatus::ACTIVE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DRAINING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGameServerInstanceStatus::DRAINING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SPOT_TERMINATING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGameServerInstanceStatus::SPOT_TERMINATING;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIGameServerInstanceStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIGameServerInstanceStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIGameServerInstanceStatus::ACTIVE:
            val = "ACTIVE";
            break;
        case eOAIGameServerInstanceStatus::DRAINING:
            val = "DRAINING";
            break;
        case eOAIGameServerInstanceStatus::SPOT_TERMINATING:
            val = "SPOT_TERMINATING";
            break;
        default:
            break;
    }
...
QJsonValue OAIGameServerInstanceStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIGameServerInstanceStatus::eOAIGameServerInstanceStatus OAIGameServerInstanceStatus::getValue() const {
    return m_value;
}

void OAIGameServerInstanceStatus::setValue(const OAIGameServerInstanceStatus::eOAIGameServerInstanceStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIGameServerInstanceStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIGameServerInstanceStatus::isValid() const {
