...
/*
 * OAIDeleteMatchmakingConfigurationInput.h
 *
 * 
 */

#ifndef OAIDeleteMatchmakingConfigurationInput_H
#define OAIDeleteMatchmakingConfigurationInput_H
...
class OAIDeleteMatchmakingConfigurationInput : public OAIObject {
public:
    OAIDeleteMatchmakingConfigurationInput();
    OAIDeleteMatchmakingConfigurationInput(QString json);
    ~OAIDeleteMatchmakingConfigurationInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteMatchmakingConfigurationInput)

#endif // OAIDeleteMatchmakingConfigurationInput_H
