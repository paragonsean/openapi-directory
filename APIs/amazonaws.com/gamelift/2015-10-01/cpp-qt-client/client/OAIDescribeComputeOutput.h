...
/*
 * OAIDescribeComputeOutput.h
 *
 * 
 */

#ifndef OAIDescribeComputeOutput_H
#define OAIDescribeComputeOutput_H
...
class OAIDescribeComputeOutput : public OAIObject {
public:
    OAIDescribeComputeOutput();
    OAIDescribeComputeOutput(QString json);
    ~OAIDescribeComputeOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeComputeOutput)

#endif // OAIDescribeComputeOutput_H
