...
/*
 * OAIStartFleetActionsOutput.h
 *
 * 
 */

#ifndef OAIStartFleetActionsOutput_H
#define OAIStartFleetActionsOutput_H
...
class OAIStartFleetActionsOutput : public OAIObject {
public:
    OAIStartFleetActionsOutput();
    OAIStartFleetActionsOutput(QString json);
    ~OAIStartFleetActionsOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartFleetActionsOutput)

#endif // OAIStartFleetActionsOutput_H
