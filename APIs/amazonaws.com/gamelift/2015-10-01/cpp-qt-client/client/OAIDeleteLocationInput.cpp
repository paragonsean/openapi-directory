...
OAIDeleteLocationInput::OAIDeleteLocationInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteLocationInput::OAIDeleteLocationInput() {
    this->initializeModel();
}

OAIDeleteLocationInput::~OAIDeleteLocationInput() {}

void OAIDeleteLocationInput::initializeModel() {

    m_location_name_isSet = false;
    m_location_name_isValid = false;
}

void OAIDeleteLocationInput::fromJson(QString jsonString) {
...
void OAIDeleteLocationInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteLocationInput::asJson() const {
...
QJsonObject OAIDeleteLocationInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteLocationInput::getLocationName() const {
    return m_location_name;
}
void OAIDeleteLocationInput::setLocationName(const QString &location_name) {
    m_location_name = location_name;
    m_location_name_isSet = true;
}

bool OAIDeleteLocationInput::is_location_name_Set() const{
    return m_location_name_isSet;
}

bool OAIDeleteLocationInput::is_location_name_Valid() const{
    return m_location_name_isValid;
}

bool OAIDeleteLocationInput::isSet() const {
...
bool OAIDeleteLocationInput::isValid() const {
