...
/*
 * OAICreateAliasInput_RoutingStrategy.h
 *
 * 
 */

#ifndef OAICreateAliasInput_RoutingStrategy_H
#define OAICreateAliasInput_RoutingStrategy_H

#include <QJsonObject>

#include "OAIRoutingStrategyType.h"
#include <QString>
...
class OAICreateAliasInput_RoutingStrategy : public OAIObject {
public:
    OAICreateAliasInput_RoutingStrategy();
    OAICreateAliasInput_RoutingStrategy(QString json);
    ~OAICreateAliasInput_RoutingStrategy() override;
    ...
    OAIRoutingStrategyType getType() const;
    void setType(const OAIRoutingStrategyType &type);
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAliasInput_RoutingStrategy)

#endif // OAICreateAliasInput_RoutingStrategy_H
