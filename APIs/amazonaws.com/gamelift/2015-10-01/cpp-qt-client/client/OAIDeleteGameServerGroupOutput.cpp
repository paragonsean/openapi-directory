...
OAIDeleteGameServerGroupOutput::OAIDeleteGameServerGroupOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteGameServerGroupOutput::OAIDeleteGameServerGroupOutput() {
    this->initializeModel();
}

OAIDeleteGameServerGroupOutput::~OAIDeleteGameServerGroupOutput() {}

void OAIDeleteGameServerGroupOutput::initializeModel() {

    m_game_server_group_isSet = false;
    m_game_server_group_isValid = false;
}

void OAIDeleteGameServerGroupOutput::fromJson(QString jsonString) {
...
void OAIDeleteGameServerGroupOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteGameServerGroupOutput::asJson() const {
...
QJsonObject OAIDeleteGameServerGroupOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIDeleteGameServerGroupOutput_GameServerGroup OAIDeleteGameServerGroupOutput::getGameServerGroup() const {
    return m_game_server_group;
}
void OAIDeleteGameServerGroupOutput::setGameServerGroup(const OAIDeleteGameServerGroupOutput_GameServerGroup &game_server_group) {
    m_game_server_group = game_server_group;
    m_game_server_group_isSet = true;
}

bool OAIDeleteGameServerGroupOutput::is_game_server_group_Set() const{
    return m_game_server_group_isSet;
}

bool OAIDeleteGameServerGroupOutput::is_game_server_group_Valid() const{
    return m_game_server_group_isValid;
}

bool OAIDeleteGameServerGroupOutput::isSet() const {
...
bool OAIDeleteGameServerGroupOutput::isValid() const {
