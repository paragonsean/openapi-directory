...
/*
 * OAIDescribeGameServerGroupInput.h
 *
 * 
 */

#ifndef OAIDescribeGameServerGroupInput_H
#define OAIDescribeGameServerGroupInput_H
...
class OAIDescribeGameServerGroupInput : public OAIObject {
public:
    OAIDescribeGameServerGroupInput();
    OAIDescribeGameServerGroupInput(QString json);
    ~OAIDescribeGameServerGroupInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeGameServerGroupInput)

#endif // OAIDescribeGameServerGroupInput_H
