...
OAIResumeGameServerGroupOutput::OAIResumeGameServerGroupOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIResumeGameServerGroupOutput::OAIResumeGameServerGroupOutput() {
    this->initializeModel();
}

OAIResumeGameServerGroupOutput::~OAIResumeGameServerGroupOutput() {}

void OAIResumeGameServerGroupOutput::initializeModel() {

    m_game_server_group_isSet = false;
    m_game_server_group_isValid = false;
}

void OAIResumeGameServerGroupOutput::fromJson(QString jsonString) {
...
void OAIResumeGameServerGroupOutput::fromJsonObject(QJsonObject json) {
...
QString OAIResumeGameServerGroupOutput::asJson() const {
...
QJsonObject OAIResumeGameServerGroupOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIResumeGameServerGroupOutput_GameServerGroup OAIResumeGameServerGroupOutput::getGameServerGroup() const {
    return m_game_server_group;
}
void OAIResumeGameServerGroupOutput::setGameServerGroup(const OAIResumeGameServerGroupOutput_GameServerGroup &game_server_group) {
    m_game_server_group = game_server_group;
    m_game_server_group_isSet = true;
}

bool OAIResumeGameServerGroupOutput::is_game_server_group_Set() const{
    return m_game_server_group_isSet;
}

bool OAIResumeGameServerGroupOutput::is_game_server_group_Valid() const{
    return m_game_server_group_isValid;
}

bool OAIResumeGameServerGroupOutput::isSet() const {
...
bool OAIResumeGameServerGroupOutput::isValid() const {
