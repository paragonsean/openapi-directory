...
OAIDescribeFleetPortSettingsOutput::OAIDescribeFleetPortSettingsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeFleetPortSettingsOutput::OAIDescribeFleetPortSettingsOutput() {
    this->initializeModel();
}

OAIDescribeFleetPortSettingsOutput::~OAIDescribeFleetPortSettingsOutput() {}

void OAIDescribeFleetPortSettingsOutput::initializeModel() {
    ...
    m_inbound_permissions_isSet = false;
    m_inbound_permissions_isValid = false;
...
void OAIDescribeFleetPortSettingsOutput::fromJson(QString jsonString) {
...
void OAIDescribeFleetPortSettingsOutput::fromJsonObject(QJsonObject json) {
    ...
    m_inbound_permissions_isValid = ::OpenAPI::fromJsonValue(m_inbound_permissions, json[QString("InboundPermissions")]);
    m_inbound_permissions_isSet = !json[QString("InboundPermissions")].isNull() && m_inbound_permissions_isValid;
...
QString OAIDescribeFleetPortSettingsOutput::asJson() const {
...
QJsonObject OAIDescribeFleetPortSettingsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
    ...
    if (m_inbound_permissions.isSet()) {
        obj.insert(QString("InboundPermissions"), ::OpenAPI::toJsonValue(m_inbound_permissions));
    }
...
QString OAIDescribeFleetPortSettingsOutput::getFleetId() const {
    return m_fleet_id;
}
void OAIDescribeFleetPortSettingsOutput::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIDescribeFleetPortSettingsOutput::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIDescribeFleetPortSettingsOutput::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

QString OAIDescribeFleetPortSettingsOutput::getFleetArn() const {
    return m_fleet_arn;
}
void OAIDescribeFleetPortSettingsOutput::setFleetArn(const QString &fleet_arn) {
    m_fleet_arn = fleet_arn;
    m_fleet_arn_isSet = true;
}

bool OAIDescribeFleetPortSettingsOutput::is_fleet_arn_Set() const{
    return m_fleet_arn_isSet;
}

bool OAIDescribeFleetPortSettingsOutput::is_fleet_arn_Valid() const{
    return m_fleet_arn_isValid;
}

QList OAIDescribeFleetPortSettingsOutput::getInboundPermissions() const {
    return m_inbound_permissions;
}
void OAIDescribeFleetPortSettingsOutput::setInboundPermissions(const QList &inbound_permissions) {
    m_inbound_permissions = inbound_permissions;
    m_inbound_permissions_isSet = true;
}

bool OAIDescribeFleetPortSettingsOutput::is_inbound_permissions_Set() const{
    return m_inbound_permissions_isSet;
}

bool OAIDescribeFleetPortSettingsOutput::is_inbound_permissions_Valid() const{
    return m_inbound_permissions_isValid;
}

OAILocationUpdateStatus OAIDescribeFleetPortSettingsOutput::getUpdateStatus() const {
    return m_update_status;
}
void OAIDescribeFleetPortSettingsOutput::setUpdateStatus(const OAILocationUpdateStatus &update_status) {
    m_update_status = update_status;
    m_update_status_isSet = true;
}

bool OAIDescribeFleetPortSettingsOutput::is_update_status_Set() const{
    return m_update_status_isSet;
}

bool OAIDescribeFleetPortSettingsOutput::is_update_status_Valid() const{
    return m_update_status_isValid;
}

QString OAIDescribeFleetPortSettingsOutput::getLocation() const {
    return m_location;
}
void OAIDescribeFleetPortSettingsOutput::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIDescribeFleetPortSettingsOutput::is_location_Set() const{
    return m_location_isSet;
}

bool OAIDescribeFleetPortSettingsOutput::is_location_Valid() const{
    return m_location_isValid;
}

bool OAIDescribeFleetPortSettingsOutput::isSet() const {
...
bool OAIDescribeFleetPortSettingsOutput::isValid() const {
