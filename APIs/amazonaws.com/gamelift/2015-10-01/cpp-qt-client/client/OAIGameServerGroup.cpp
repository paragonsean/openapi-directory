...
OAIGameServerGroup::OAIGameServerGroup(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGameServerGroup::OAIGameServerGroup() {
    this->initializeModel();
}

OAIGameServerGroup::~OAIGameServerGroup() {}

void OAIGameServerGroup::initializeModel() {
...
void OAIGameServerGroup::fromJson(QString jsonString) {
...
void OAIGameServerGroup::fromJsonObject(QJsonObject json) {
...
QString OAIGameServerGroup::asJson() const {
...
QJsonObject OAIGameServerGroup::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGameServerGroup::getGameServerGroupName() const {
    return m_game_server_group_name;
}
void OAIGameServerGroup::setGameServerGroupName(const QString &game_server_group_name) {
    m_game_server_group_name = game_server_group_name;
    m_game_server_group_name_isSet = true;
}

bool OAIGameServerGroup::is_game_server_group_name_Set() const{
    return m_game_server_group_name_isSet;
}

bool OAIGameServerGroup::is_game_server_group_name_Valid() const{
    return m_game_server_group_name_isValid;
}

QString OAIGameServerGroup::getGameServerGroupArn() const {
    return m_game_server_group_arn;
}
void OAIGameServerGroup::setGameServerGroupArn(const QString &game_server_group_arn) {
    m_game_server_group_arn = game_server_group_arn;
    m_game_server_group_arn_isSet = true;
}

bool OAIGameServerGroup::is_game_server_group_arn_Set() const{
    return m_game_server_group_arn_isSet;
}

bool OAIGameServerGroup::is_game_server_group_arn_Valid() const{
    return m_game_server_group_arn_isValid;
}

QString OAIGameServerGroup::getRoleArn() const {
    return m_role_arn;
}
void OAIGameServerGroup::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIGameServerGroup::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIGameServerGroup::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

QList OAIGameServerGroup::getInstanceDefinitions() const {
    return m_instance_definitions;
}
void OAIGameServerGroup::setInstanceDefinitions(const QList &instance_definitions) {
    m_instance_definitions = instance_definitions;
    m_instance_definitions_isSet = true;
}

bool OAIGameServerGroup::is_instance_definitions_Set() const{
    return m_instance_definitions_isSet;
}

bool OAIGameServerGroup::is_instance_definitions_Valid() const{
    return m_instance_definitions_isValid;
}

OAIBalancingStrategy OAIGameServerGroup::getBalancingStrategy() const {
    return m_balancing_strategy;
}
void OAIGameServerGroup::setBalancingStrategy(const OAIBalancingStrategy &balancing_strategy) {
    m_balancing_strategy = balancing_strategy;
    m_balancing_strategy_isSet = true;
}

bool OAIGameServerGroup::is_balancing_strategy_Set() const{
    return m_balancing_strategy_isSet;
}

bool OAIGameServerGroup::is_balancing_strategy_Valid() const{
    return m_balancing_strategy_isValid;
}

OAIGameServerProtectionPolicy OAIGameServerGroup::getGameServerProtectionPolicy() const {
    return m_game_server_protection_policy;
}
void OAIGameServerGroup::setGameServerProtectionPolicy(const OAIGameServerProtectionPolicy &game_server_protection_policy) {
    m_game_server_protection_policy = game_server_protection_policy;
    m_game_server_protection_policy_isSet = true;
}

bool OAIGameServerGroup::is_game_server_protection_policy_Set() const{
    return m_game_server_protection_policy_isSet;
}

bool OAIGameServerGroup::is_game_server_protection_policy_Valid() const{
    return m_game_server_protection_policy_isValid;
}

QString OAIGameServerGroup::getAutoScalingGroupArn() const {
    return m_auto_scaling_group_arn;
}
void OAIGameServerGroup::setAutoScalingGroupArn(const QString &auto_scaling_group_arn) {
    m_auto_scaling_group_arn = auto_scaling_group_arn;
    m_auto_scaling_group_arn_isSet = true;
}

bool OAIGameServerGroup::is_auto_scaling_group_arn_Set() const{
    return m_auto_scaling_group_arn_isSet;
}

bool OAIGameServerGroup::is_auto_scaling_group_arn_Valid() const{
    return m_auto_scaling_group_arn_isValid;
}

OAIGameServerGroupStatus OAIGameServerGroup::getStatus() const {
    return m_status;
}
void OAIGameServerGroup::setStatus(const OAIGameServerGroupStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGameServerGroup::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGameServerGroup::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIGameServerGroup::getStatusReason() const {
    return m_status_reason;
}
void OAIGameServerGroup::setStatusReason(const QString &status_reason) {
    m_status_reason = status_reason;
    m_status_reason_isSet = true;
}

bool OAIGameServerGroup::is_status_reason_Set() const{
    return m_status_reason_isSet;
}

bool OAIGameServerGroup::is_status_reason_Valid() const{
    return m_status_reason_isValid;
}

QList OAIGameServerGroup::getSuspendedActions() const {
    return m_suspended_actions;
}
void OAIGameServerGroup::setSuspendedActions(const QList &suspended_actions) {
    m_suspended_actions = suspended_actions;
    m_suspended_actions_isSet = true;
}

bool OAIGameServerGroup::is_suspended_actions_Set() const{
    return m_suspended_actions_isSet;
}

bool OAIGameServerGroup::is_suspended_actions_Valid() const{
    return m_suspended_actions_isValid;
}

QDateTime OAIGameServerGroup::getCreationTime() const {
    return m_creation_time;
}
void OAIGameServerGroup::setCreationTime(const QDateTime &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAIGameServerGroup::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAIGameServerGroup::is_creation_time_Valid() const{
    return m_creation_time_isValid;
}

QDateTime OAIGameServerGroup::getLastUpdatedTime() const {
    return m_last_updated_time;
}
void OAIGameServerGroup::setLastUpdatedTime(const QDateTime &last_updated_time) {
    m_last_updated_time = last_updated_time;
    m_last_updated_time_isSet = true;
}

bool OAIGameServerGroup::is_last_updated_time_Set() const{
    return m_last_updated_time_isSet;
}

bool OAIGameServerGroup::is_last_updated_time_Valid() const{
    return m_last_updated_time_isValid;
}

bool OAIGameServerGroup::isSet() const {
...
bool OAIGameServerGroup::isValid() const {
