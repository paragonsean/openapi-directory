...
/*
 * OAIResumeGameServerGroupInput.h
 *
 * 
 */

#ifndef OAIResumeGameServerGroupInput_H
#define OAIResumeGameServerGroupInput_H
...
class OAIResumeGameServerGroupInput : public OAIObject {
public:
    OAIResumeGameServerGroupInput();
    OAIResumeGameServerGroupInput(QString json);
    ~OAIResumeGameServerGroupInput() override;
    ...
    QList getResumeActions() const;
    void setResumeActions(const QList &resume_actions);
    bool is_resume_actions_Set() const;
    bool is_resume_actions_Valid() const;
...
private:
    ...
    QList m_resume_actions;
    bool m_resume_actions_isSet;
    bool m_resume_actions_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIResumeGameServerGroupInput)

#endif // OAIResumeGameServerGroupInput_H
