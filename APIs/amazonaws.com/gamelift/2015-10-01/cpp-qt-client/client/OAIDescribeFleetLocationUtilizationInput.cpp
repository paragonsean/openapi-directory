...
OAIDescribeFleetLocationUtilizationInput::OAIDescribeFleetLocationUtilizationInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeFleetLocationUtilizationInput::OAIDescribeFleetLocationUtilizationInput() {
    this->initializeModel();
}

OAIDescribeFleetLocationUtilizationInput::~OAIDescribeFleetLocationUtilizationInput() {}

void OAIDescribeFleetLocationUtilizationInput::initializeModel() {
...
void OAIDescribeFleetLocationUtilizationInput::fromJson(QString jsonString) {
...
void OAIDescribeFleetLocationUtilizationInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeFleetLocationUtilizationInput::asJson() const {
...
QJsonObject OAIDescribeFleetLocationUtilizationInput::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
...
QString OAIDescribeFleetLocationUtilizationInput::getFleetId() const {
    return m_fleet_id;
}
void OAIDescribeFleetLocationUtilizationInput::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIDescribeFleetLocationUtilizationInput::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIDescribeFleetLocationUtilizationInput::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

QString OAIDescribeFleetLocationUtilizationInput::getLocation() const {
    return m_location;
}
void OAIDescribeFleetLocationUtilizationInput::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIDescribeFleetLocationUtilizationInput::is_location_Set() const{
    return m_location_isSet;
}

bool OAIDescribeFleetLocationUtilizationInput::is_location_Valid() const{
    return m_location_isValid;
}

bool OAIDescribeFleetLocationUtilizationInput::isSet() const {
...
bool OAIDescribeFleetLocationUtilizationInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_fleet_id_isValid && m_location_isValid && true;
}
