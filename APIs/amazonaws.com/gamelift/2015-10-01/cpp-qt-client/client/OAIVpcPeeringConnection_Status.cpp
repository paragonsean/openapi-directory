...
OAIVpcPeeringConnection_Status::OAIVpcPeeringConnection_Status(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVpcPeeringConnection_Status::OAIVpcPeeringConnection_Status() {
    this->initializeModel();
}

OAIVpcPeeringConnection_Status::~OAIVpcPeeringConnection_Status() {}

void OAIVpcPeeringConnection_Status::initializeModel() {
...
void OAIVpcPeeringConnection_Status::fromJson(QString jsonString) {
...
void OAIVpcPeeringConnection_Status::fromJsonObject(QJsonObject json) {
...
QString OAIVpcPeeringConnection_Status::asJson() const {
...
QJsonObject OAIVpcPeeringConnection_Status::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
...
QString OAIVpcPeeringConnection_Status::getCode() const {
    return m_code;
}
void OAIVpcPeeringConnection_Status::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIVpcPeeringConnection_Status::is_code_Set() const{
    return m_code_isSet;
}

bool OAIVpcPeeringConnection_Status::is_code_Valid() const{
    return m_code_isValid;
}

QString OAIVpcPeeringConnection_Status::getMessage() const {
    return m_message;
}
void OAIVpcPeeringConnection_Status::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIVpcPeeringConnection_Status::is_message_Set() const{
    return m_message_isSet;
}

bool OAIVpcPeeringConnection_Status::is_message_Valid() const{
    return m_message_isValid;
}

bool OAIVpcPeeringConnection_Status::isSet() const {
...
bool OAIVpcPeeringConnection_Status::isValid() const {
