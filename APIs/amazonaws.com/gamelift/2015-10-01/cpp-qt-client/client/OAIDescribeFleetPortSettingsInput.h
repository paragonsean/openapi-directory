...
/*
 * OAIDescribeFleetPortSettingsInput.h
 *
 * 
 */

#ifndef OAIDescribeFleetPortSettingsInput_H
#define OAIDescribeFleetPortSettingsInput_H
...
class OAIDescribeFleetPortSettingsInput : public OAIObject {
public:
    OAIDescribeFleetPortSettingsInput();
    OAIDescribeFleetPortSettingsInput(QString json);
    ~OAIDescribeFleetPortSettingsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFleetPortSettingsInput)

#endif // OAIDescribeFleetPortSettingsInput_H
