...
/*
 * OAIDeleteGameServerGroupOutput_GameServerGroup.h
 *
 * 
 */

#ifndef OAIDeleteGameServerGroupOutput_GameServerGroup_H
#define OAIDeleteGameServerGroupOutput_GameServerGroup_H
...
class OAIDeleteGameServerGroupOutput_GameServerGroup : public OAIObject {
public:
    OAIDeleteGameServerGroupOutput_GameServerGroup();
    OAIDeleteGameServerGroupOutput_GameServerGroup(QString json);
    ~OAIDeleteGameServerGroupOutput_GameServerGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteGameServerGroupOutput_GameServerGroup)

#endif // OAIDeleteGameServerGroupOutput_GameServerGroup_H
