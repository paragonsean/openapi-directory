...
#ifndef OAIFleetStatus_H
#define OAIFleetStatus_H
...
class OAIFleetStatus : public OAIEnum {
public:
    OAIFleetStatus();
    OAIFleetStatus(QString json);
    ~OAIFleetStatus() override;
    ...
    OAIFleetStatus::eOAIFleetStatus getValue() const;
    void setValue(const OAIFleetStatus::eOAIFleetStatus& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFleetStatus)

#endif // OAIFleetStatus_H
