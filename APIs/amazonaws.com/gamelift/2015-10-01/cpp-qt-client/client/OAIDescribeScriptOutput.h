...
/*
 * OAIDescribeScriptOutput.h
 *
 * 
 */

#ifndef OAIDescribeScriptOutput_H
#define OAIDescribeScriptOutput_H
...
namespace OpenAPI {
class OAIDescribeScriptOutput_Script;

class OAIDescribeScriptOutput : public OAIObject {
public:
    OAIDescribeScriptOutput();
    OAIDescribeScriptOutput(QString json);
    ~OAIDescribeScriptOutput() override;
    ...
    OAIDescribeScriptOutput_Script getScript() const;
    void setScript(const OAIDescribeScriptOutput_Script &script);
...
private:
    ...
    OAIDescribeScriptOutput_Script m_script;
    bool m_script_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeScriptOutput)

#endif // OAIDescribeScriptOutput_H
