...
/*
 * OAIClaimGameServerOutput.h
 *
 * 
 */

#ifndef OAIClaimGameServerOutput_H
#define OAIClaimGameServerOutput_H
...
namespace OpenAPI {
class OAIClaimGameServerOutput_GameServer;

class OAIClaimGameServerOutput : public OAIObject {
public:
    OAIClaimGameServerOutput();
    OAIClaimGameServerOutput(QString json);
    ~OAIClaimGameServerOutput() override;
    ...
    OAIClaimGameServerOutput_GameServer getGameServer() const;
    void setGameServer(const OAIClaimGameServerOutput_GameServer &game_server);
...
private:
    ...
    OAIClaimGameServerOutput_GameServer m_game_server;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClaimGameServerOutput)

#endif // OAIClaimGameServerOutput_H
