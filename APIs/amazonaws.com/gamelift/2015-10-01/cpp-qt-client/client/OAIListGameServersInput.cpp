...
OAIListGameServersInput::OAIListGameServersInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListGameServersInput::OAIListGameServersInput() {
    this->initializeModel();
}

OAIListGameServersInput::~OAIListGameServersInput() {}

void OAIListGameServersInput::initializeModel() {
...
void OAIListGameServersInput::fromJson(QString jsonString) {
...
void OAIListGameServersInput::fromJsonObject(QJsonObject json) {
...
QString OAIListGameServersInput::asJson() const {
...
QJsonObject OAIListGameServersInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListGameServersInput::getGameServerGroupName() const {
    return m_game_server_group_name;
}
void OAIListGameServersInput::setGameServerGroupName(const QString &game_server_group_name) {
    m_game_server_group_name = game_server_group_name;
    m_game_server_group_name_isSet = true;
}

bool OAIListGameServersInput::is_game_server_group_name_Set() const{
    return m_game_server_group_name_isSet;
}

bool OAIListGameServersInput::is_game_server_group_name_Valid() const{
    return m_game_server_group_name_isValid;
}

OAISortOrder OAIListGameServersInput::getSortOrder() const {
    return m_sort_order;
}
void OAIListGameServersInput::setSortOrder(const OAISortOrder &sort_order) {
    m_sort_order = sort_order;
    m_sort_order_isSet = true;
}

bool OAIListGameServersInput::is_sort_order_Set() const{
    return m_sort_order_isSet;
}

bool OAIListGameServersInput::is_sort_order_Valid() const{
    return m_sort_order_isValid;
}

qint32 OAIListGameServersInput::getLimit() const {
    return m_limit;
}
void OAIListGameServersInput::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIListGameServersInput::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIListGameServersInput::is_limit_Valid() const{
    return m_limit_isValid;
}

QString OAIListGameServersInput::getNextToken() const {
    return m_next_token;
}
void OAIListGameServersInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListGameServersInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListGameServersInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListGameServersInput::isSet() const {
...
bool OAIListGameServersInput::isValid() const {
