...
/*
 * OAICreateMatchmakingConfigurationOutput.h
 *
 * 
 */

#ifndef OAICreateMatchmakingConfigurationOutput_H
#define OAICreateMatchmakingConfigurationOutput_H
...
namespace OpenAPI {
class OAICreateMatchmakingConfigurationOutput_Configuration;

class OAICreateMatchmakingConfigurationOutput : public OAIObject {
public:
    OAICreateMatchmakingConfigurationOutput();
    OAICreateMatchmakingConfigurationOutput(QString json);
    ~OAICreateMatchmakingConfigurationOutput() override;
    ...
    OAICreateMatchmakingConfigurationOutput_Configuration getConfiguration() const;
    void setConfiguration(const OAICreateMatchmakingConfigurationOutput_Configuration &configuration);
...
private:
    ...
    OAICreateMatchmakingConfigurationOutput_Configuration m_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMatchmakingConfigurationOutput)

#endif // OAICreateMatchmakingConfigurationOutput_H
