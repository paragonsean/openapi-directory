...
/*
 * OAIDeleteFleetLocationsOutput.h
 *
 * 
 */

#ifndef OAIDeleteFleetLocationsOutput_H
#define OAIDeleteFleetLocationsOutput_H
...
class OAIDeleteFleetLocationsOutput : public OAIObject {
public:
    OAIDeleteFleetLocationsOutput();
    OAIDeleteFleetLocationsOutput(QString json);
    ~OAIDeleteFleetLocationsOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteFleetLocationsOutput)

#endif // OAIDeleteFleetLocationsOutput_H
