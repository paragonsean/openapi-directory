...
/*
 * OAICreateBuildInput.h
 *
 * 
 */

#ifndef OAICreateBuildInput_H
#define OAICreateBuildInput_H

#include <QJsonObject>

#include "OAICreateBuildInput_StorageLocation.h"
...
namespace OpenAPI {
class OAICreateBuildInput_StorageLocation;

class OAICreateBuildInput : public OAIObject {
public:
    OAICreateBuildInput();
    OAICreateBuildInput(QString json);
    ~OAICreateBuildInput() override;
    ...
    OAICreateBuildInput_StorageLocation getStorageLocation() const;
    void setStorageLocation(const OAICreateBuildInput_StorageLocation &storage_location);
...
private:
    ...
    OAICreateBuildInput_StorageLocation m_storage_location;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateBuildInput)

#endif // OAICreateBuildInput_H
