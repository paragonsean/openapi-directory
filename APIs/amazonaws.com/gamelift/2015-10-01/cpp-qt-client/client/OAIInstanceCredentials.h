...
/*
 * OAIInstanceCredentials.h
 *
 * Set of credentials required to remotely access a fleet instance.
 */

#ifndef OAIInstanceCredentials_H
#define OAIInstanceCredentials_H
...
class OAIInstanceCredentials : public OAIObject {
public:
    OAIInstanceCredentials();
    OAIInstanceCredentials(QString json);
    ~OAIInstanceCredentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInstanceCredentials)

#endif // OAIInstanceCredentials_H
