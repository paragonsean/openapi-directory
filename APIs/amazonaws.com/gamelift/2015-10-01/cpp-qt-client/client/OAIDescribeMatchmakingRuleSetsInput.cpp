...
OAIDescribeMatchmakingRuleSetsInput::OAIDescribeMatchmakingRuleSetsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeMatchmakingRuleSetsInput::OAIDescribeMatchmakingRuleSetsInput() {
    this->initializeModel();
}

OAIDescribeMatchmakingRuleSetsInput::~OAIDescribeMatchmakingRuleSetsInput() {}

void OAIDescribeMatchmakingRuleSetsInput::initializeModel() {
...
void OAIDescribeMatchmakingRuleSetsInput::fromJson(QString jsonString) {
...
void OAIDescribeMatchmakingRuleSetsInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeMatchmakingRuleSetsInput::asJson() const {
...
QJsonObject OAIDescribeMatchmakingRuleSetsInput::asJsonObject() const {
    QJsonObject obj;
    if (m_names.isSet()) {
...
QList OAIDescribeMatchmakingRuleSetsInput::getNames() const {
    return m_names;
}
void OAIDescribeMatchmakingRuleSetsInput::setNames(const QList &names) {
    m_names = names;
    m_names_isSet = true;
}

bool OAIDescribeMatchmakingRuleSetsInput::is_names_Set() const{
    return m_names_isSet;
}

bool OAIDescribeMatchmakingRuleSetsInput::is_names_Valid() const{
    return m_names_isValid;
}

qint32 OAIDescribeMatchmakingRuleSetsInput::getLimit() const {
    return m_limit;
}
void OAIDescribeMatchmakingRuleSetsInput::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIDescribeMatchmakingRuleSetsInput::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIDescribeMatchmakingRuleSetsInput::is_limit_Valid() const{
    return m_limit_isValid;
}

QString OAIDescribeMatchmakingRuleSetsInput::getNextToken() const {
    return m_next_token;
}
void OAIDescribeMatchmakingRuleSetsInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeMatchmakingRuleSetsInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeMatchmakingRuleSetsInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeMatchmakingRuleSetsInput::isSet() const {
...
bool OAIDescribeMatchmakingRuleSetsInput::isValid() const {
