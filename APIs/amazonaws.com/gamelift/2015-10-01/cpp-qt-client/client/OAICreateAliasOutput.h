...
/*
 * OAICreateAliasOutput.h
 *
 * 
 */

#ifndef OAICreateAliasOutput_H
#define OAICreateAliasOutput_H
...
namespace OpenAPI {
class OAICreateAliasOutput_Alias;

class OAICreateAliasOutput : public OAIObject {
public:
    OAICreateAliasOutput();
    OAICreateAliasOutput(QString json);
    ~OAICreateAliasOutput() override;
    ...
    OAICreateAliasOutput_Alias getAlias() const;
    void setAlias(const OAICreateAliasOutput_Alias &alias);
...
private:
    ...
    OAICreateAliasOutput_Alias m_alias;
    bool m_alias_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAliasOutput)

#endif // OAICreateAliasOutput_H
