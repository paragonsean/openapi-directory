...
/*
 * OAIResolveAliasOutput.h
 *
 * 
 */

#ifndef OAIResolveAliasOutput_H
#define OAIResolveAliasOutput_H
...
class OAIResolveAliasOutput : public OAIObject {
public:
    OAIResolveAliasOutput();
    OAIResolveAliasOutput(QString json);
    ~OAIResolveAliasOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResolveAliasOutput)

#endif // OAIResolveAliasOutput_H
