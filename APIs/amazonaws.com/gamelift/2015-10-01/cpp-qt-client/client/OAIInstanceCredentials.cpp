...
#include "OAIInstanceCredentials.h"
...
OAIInstanceCredentials::OAIInstanceCredentials(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInstanceCredentials::OAIInstanceCredentials() {
    this->initializeModel();
}

OAIInstanceCredentials::~OAIInstanceCredentials() {}

void OAIInstanceCredentials::initializeModel() {
...
void OAIInstanceCredentials::fromJson(QString jsonString) {
...
void OAIInstanceCredentials::fromJsonObject(QJsonObject json) {
...
QString OAIInstanceCredentials::asJson() const {
...
QJsonObject OAIInstanceCredentials::asJsonObject() const {
    QJsonObject obj;
...
QString OAIInstanceCredentials::getUserName() const {
    return m_user_name;
}
void OAIInstanceCredentials::setUserName(const QString &user_name) {
    m_user_name = user_name;
    m_user_name_isSet = true;
}

bool OAIInstanceCredentials::is_user_name_Set() const{
    return m_user_name_isSet;
}

bool OAIInstanceCredentials::is_user_name_Valid() const{
    return m_user_name_isValid;
}

QString OAIInstanceCredentials::getSecret() const {
    return m_secret;
}
void OAIInstanceCredentials::setSecret(const QString &secret) {
    m_secret = secret;
    m_secret_isSet = true;
}

bool OAIInstanceCredentials::is_secret_Set() const{
    return m_secret_isSet;
}

bool OAIInstanceCredentials::is_secret_Valid() const{
    return m_secret_isValid;
}

bool OAIInstanceCredentials::isSet() const {
...
bool OAIInstanceCredentials::isValid() const {
