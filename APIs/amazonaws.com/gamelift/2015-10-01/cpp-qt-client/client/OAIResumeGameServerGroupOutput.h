...
/*
 * OAIResumeGameServerGroupOutput.h
 *
 * 
 */

#ifndef OAIResumeGameServerGroupOutput_H
#define OAIResumeGameServerGroupOutput_H
...
namespace OpenAPI {
class OAIResumeGameServerGroupOutput_GameServerGroup;

class OAIResumeGameServerGroupOutput : public OAIObject {
public:
    OAIResumeGameServerGroupOutput();
    OAIResumeGameServerGroupOutput(QString json);
    ~OAIResumeGameServerGroupOutput() override;
    ...
    OAIResumeGameServerGroupOutput_GameServerGroup getGameServerGroup() const;
    void setGameServerGroup(const OAIResumeGameServerGroupOutput_GameServerGroup &game_server_group);
...
private:
    ...
    OAIResumeGameServerGroupOutput_GameServerGroup m_game_server_group;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResumeGameServerGroupOutput)

#endif // OAIResumeGameServerGroupOutput_H
