...
/*
 * OAISearchGameSessionsOutput.h
 *
 * 
 */

#ifndef OAISearchGameSessionsOutput_H
#define OAISearchGameSessionsOutput_H
...
class OAISearchGameSessionsOutput : public OAIObject {
public:
    OAISearchGameSessionsOutput();
    OAISearchGameSessionsOutput(QString json);
    ~OAISearchGameSessionsOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchGameSessionsOutput)

#endif // OAISearchGameSessionsOutput_H
