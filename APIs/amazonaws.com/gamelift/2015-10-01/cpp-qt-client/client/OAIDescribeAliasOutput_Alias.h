...
/*
 * OAIDescribeAliasOutput_Alias.h
 *
 * 
 */

#ifndef OAIDescribeAliasOutput_Alias_H
#define OAIDescribeAliasOutput_Alias_H
...
class OAIDescribeAliasOutput_Alias : public OAIObject {
public:
    OAIDescribeAliasOutput_Alias();
    OAIDescribeAliasOutput_Alias(QString json);
    ~OAIDescribeAliasOutput_Alias() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAliasOutput_Alias)

#endif // OAIDescribeAliasOutput_Alias_H
