...
void OAILocationFilter::initializeModel() {
    ...
    m_value = eOAILocationFilter::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAILocationFilter::fromJson(QString jsonString) {
    
    if ( jsonString.compare("AWS", Qt::CaseInsensitive) == 0) {
        m_value = eOAILocationFilter::AWS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CUSTOM", Qt::CaseInsensitive) == 0) {
        m_value = eOAILocationFilter::CUSTOM;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAILocationFilter::fromJsonValue(QJsonValue json) {
...
QString OAILocationFilter::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAILocationFilter::AWS:
            val = "AWS";
            break;
        case eOAILocationFilter::CUSTOM:
            val = "CUSTOM";
            break;
        default:
            break;
...
QJsonValue OAILocationFilter::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAILocationFilter::eOAILocationFilter OAILocationFilter::getValue() const {
    return m_value;
}

void OAILocationFilter::setValue(const OAILocationFilter::eOAILocationFilter& value){
    m_value = value;
    m_value_isSet = true;
}
