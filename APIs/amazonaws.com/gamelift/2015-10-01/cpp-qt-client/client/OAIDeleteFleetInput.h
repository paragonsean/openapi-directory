...
/*
 * OAIDeleteFleetInput.h
 *
 * 
 */

#ifndef OAIDeleteFleetInput_H
#define OAIDeleteFleetInput_H
...
class OAIDeleteFleetInput : public OAIObject {
public:
    OAIDeleteFleetInput();
    OAIDeleteFleetInput(QString json);
    ~OAIDeleteFleetInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteFleetInput)

#endif // OAIDeleteFleetInput_H
