...
OAIBalancingStrategy::OAIBalancingStrategy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBalancingStrategy::OAIBalancingStrategy() {
    this->initializeModel();
}

OAIBalancingStrategy::~OAIBalancingStrategy() {}

void OAIBalancingStrategy::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIBalancingStrategy::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIBalancingStrategy::fromJson(QString jsonString) {
    
    if ( jsonString.compare("SPOT_ONLY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIBalancingStrategy::SPOT_ONLY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SPOT_PREFERRED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIBalancingStrategy::SPOT_PREFERRED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ON_DEMAND_ONLY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIBalancingStrategy::ON_DEMAND_ONLY;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIBalancingStrategy::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIBalancingStrategy::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIBalancingStrategy::SPOT_ONLY:
            val = "SPOT_ONLY";
            break;
        case eOAIBalancingStrategy::SPOT_PREFERRED:
            val = "SPOT_PREFERRED";
            break;
        case eOAIBalancingStrategy::ON_DEMAND_ONLY:
            val = "ON_DEMAND_ONLY";
            break;
        default:
            break;
...
QJsonValue OAIBalancingStrategy::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIBalancingStrategy::eOAIBalancingStrategy OAIBalancingStrategy::getValue() const {
    return m_value;
}

void OAIBalancingStrategy::setValue(const OAIBalancingStrategy::eOAIBalancingStrategy& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIBalancingStrategy::isSet() const {
    
    return m_value_isSet;
}

bool OAIBalancingStrategy::isValid() const {
