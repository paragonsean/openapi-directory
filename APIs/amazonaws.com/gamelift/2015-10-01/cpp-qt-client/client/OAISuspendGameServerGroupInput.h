...
/*
 * OAISuspendGameServerGroupInput.h
 *
 * 
 */

#ifndef OAISuspendGameServerGroupInput_H
#define OAISuspendGameServerGroupInput_H
...
class OAISuspendGameServerGroupInput : public OAIObject {
public:
    OAISuspendGameServerGroupInput();
    OAISuspendGameServerGroupInput(QString json);
    ~OAISuspendGameServerGroupInput() override;
    ...
    QList getSuspendActions() const;
    void setSuspendActions(const QList &suspend_actions);
    bool is_suspend_actions_Set() const;
    bool is_suspend_actions_Valid() const;
...
private:
    ...
    QList m_suspend_actions;
    bool m_suspend_actions_isSet;
    bool m_suspend_actions_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAISuspendGameServerGroupInput)

#endif // OAISuspendGameServerGroupInput_H
