...
OAIDescribeGameServerGroupInput::OAIDescribeGameServerGroupInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeGameServerGroupInput::OAIDescribeGameServerGroupInput() {
    this->initializeModel();
}

OAIDescribeGameServerGroupInput::~OAIDescribeGameServerGroupInput() {}

void OAIDescribeGameServerGroupInput::initializeModel() {

    m_game_server_group_name_isSet = false;
    m_game_server_group_name_isValid = false;
}

void OAIDescribeGameServerGroupInput::fromJson(QString jsonString) {
...
void OAIDescribeGameServerGroupInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeGameServerGroupInput::asJson() const {
...
QJsonObject OAIDescribeGameServerGroupInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeGameServerGroupInput::getGameServerGroupName() const {
    return m_game_server_group_name;
}
void OAIDescribeGameServerGroupInput::setGameServerGroupName(const QString &game_server_group_name) {
    m_game_server_group_name = game_server_group_name;
    m_game_server_group_name_isSet = true;
}

bool OAIDescribeGameServerGroupInput::is_game_server_group_name_Set() const{
    return m_game_server_group_name_isSet;
}

bool OAIDescribeGameServerGroupInput::is_game_server_group_name_Valid() const{
    return m_game_server_group_name_isValid;
}

bool OAIDescribeGameServerGroupInput::isSet() const {
...
bool OAIDescribeGameServerGroupInput::isValid() const {
