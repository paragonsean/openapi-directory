...
/*
 * OAIDescribeGameSessionPlacementInput.h
 *
 * 
 */

#ifndef OAIDescribeGameSessionPlacementInput_H
#define OAIDescribeGameSessionPlacementInput_H
...
class OAIDescribeGameSessionPlacementInput : public OAIObject {
public:
    OAIDescribeGameSessionPlacementInput();
    OAIDescribeGameSessionPlacementInput(QString json);
    ~OAIDescribeGameSessionPlacementInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeGameSessionPlacementInput)

#endif // OAIDescribeGameSessionPlacementInput_H
