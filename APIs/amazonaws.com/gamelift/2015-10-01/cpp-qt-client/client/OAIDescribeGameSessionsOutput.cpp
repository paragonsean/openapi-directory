...
OAIDescribeGameSessionsOutput::OAIDescribeGameSessionsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeGameSessionsOutput::OAIDescribeGameSessionsOutput() {
    this->initializeModel();
}

OAIDescribeGameSessionsOutput::~OAIDescribeGameSessionsOutput() {}

void OAIDescribeGameSessionsOutput::initializeModel() {

    m_game_sessions_isSet = false;
    m_game_sessions_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIDescribeGameSessionsOutput::fromJson(QString jsonString) {
...
void OAIDescribeGameSessionsOutput::fromJsonObject(QJsonObject json) {

    m_game_sessions_isValid = ::OpenAPI::fromJsonValue(m_game_sessions, json[QString("GameSessions")]);
    m_game_sessions_isSet = !json[QString("GameSessions")].isNull() && m_game_sessions_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("NextToken")]);
    m_next_token_isSet = !json[QString("NextToken")].isNull() && m_next_token_isValid;
}

QString OAIDescribeGameSessionsOutput::asJson() const {
...
QJsonObject OAIDescribeGameSessionsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_game_sessions.isSet()) {
        obj.insert(QString("GameSessions"), ::OpenAPI::toJsonValue(m_game_sessions));
    }
...
QList OAIDescribeGameSessionsOutput::getGameSessions() const {
    return m_game_sessions;
}
void OAIDescribeGameSessionsOutput::setGameSessions(const QList &game_sessions) {
    m_game_sessions = game_sessions;
    m_game_sessions_isSet = true;
}

bool OAIDescribeGameSessionsOutput::is_game_sessions_Set() const{
    return m_game_sessions_isSet;
}

bool OAIDescribeGameSessionsOutput::is_game_sessions_Valid() const{
    return m_game_sessions_isValid;
}

QString OAIDescribeGameSessionsOutput::getNextToken() const {
    return m_next_token;
}
void OAIDescribeGameSessionsOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeGameSessionsOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeGameSessionsOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeGameSessionsOutput::isSet() const {
...
bool OAIDescribeGameSessionsOutput::isValid() const {
