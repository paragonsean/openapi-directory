...
/*
 * OAIStartGameSessionPlacementInput.h
 *
 * 
 */

#ifndef OAIStartGameSessionPlacementInput_H
#define OAIStartGameSessionPlacementInput_H
...
class OAIStartGameSessionPlacementInput : public OAIObject {
public:
    OAIStartGameSessionPlacementInput();
    OAIStartGameSessionPlacementInput(QString json);
    ~OAIStartGameSessionPlacementInput() override;
    ...
    QList getDesiredPlayerSessions() const;
    void setDesiredPlayerSessions(const QList &desired_player_sessions);
    bool is_desired_player_sessions_Set() const;
    bool is_desired_player_sessions_Valid() const;
...
private:
    ...
    QList m_desired_player_sessions;
    bool m_desired_player_sessions_isSet;
    bool m_desired_player_sessions_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartGameSessionPlacementInput)

#endif // OAIStartGameSessionPlacementInput_H
