...
/*
 * OAIUpdateScriptOutput.h
 *
 * 
 */

#ifndef OAIUpdateScriptOutput_H
#define OAIUpdateScriptOutput_H
...
namespace OpenAPI {
class OAIUpdateScriptOutput_Script;

class OAIUpdateScriptOutput : public OAIObject {
public:
    OAIUpdateScriptOutput();
    OAIUpdateScriptOutput(QString json);
    ~OAIUpdateScriptOutput() override;
    ...
    OAIUpdateScriptOutput_Script getScript() const;
    void setScript(const OAIUpdateScriptOutput_Script &script);
...
private:
    ...
    OAIUpdateScriptOutput_Script m_script;
    bool m_script_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateScriptOutput)

#endif // OAIUpdateScriptOutput_H
