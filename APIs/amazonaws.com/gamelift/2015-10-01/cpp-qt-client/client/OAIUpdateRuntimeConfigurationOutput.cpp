...
OAIUpdateRuntimeConfigurationOutput::OAIUpdateRuntimeConfigurationOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateRuntimeConfigurationOutput::OAIUpdateRuntimeConfigurationOutput() {
    this->initializeModel();
}

OAIUpdateRuntimeConfigurationOutput::~OAIUpdateRuntimeConfigurationOutput() {}

void OAIUpdateRuntimeConfigurationOutput::initializeModel() {

    m_runtime_configuration_isSet = false;
    m_runtime_configuration_isValid = false;
}

void OAIUpdateRuntimeConfigurationOutput::fromJson(QString jsonString) {
...
void OAIUpdateRuntimeConfigurationOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateRuntimeConfigurationOutput::asJson() const {
...
QJsonObject OAIUpdateRuntimeConfigurationOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdateRuntimeConfigurationOutput_RuntimeConfiguration OAIUpdateRuntimeConfigurationOutput::getRuntimeConfiguration() const {
    return m_runtime_configuration;
}
void OAIUpdateRuntimeConfigurationOutput::setRuntimeConfiguration(const OAIUpdateRuntimeConfigurationOutput_RuntimeConfiguration &runtime_configuration) {
    m_runtime_configuration = runtime_configuration;
    m_runtime_configuration_isSet = true;
}

bool OAIUpdateRuntimeConfigurationOutput::is_runtime_configuration_Set() const{
    return m_runtime_configuration_isSet;
}

bool OAIUpdateRuntimeConfigurationOutput::is_runtime_configuration_Valid() const{
    return m_runtime_configuration_isValid;
}

bool OAIUpdateRuntimeConfigurationOutput::isSet() const {
...
bool OAIUpdateRuntimeConfigurationOutput::isValid() const {
