...
/*
 * OAICreateFleetInput_CertificateConfiguration.h
 *
 * 
 */

#ifndef OAICreateFleetInput_CertificateConfiguration_H
#define OAICreateFleetInput_CertificateConfiguration_H
...
class OAICreateFleetInput_CertificateConfiguration : public OAIObject {
public:
    OAICreateFleetInput_CertificateConfiguration();
    OAICreateFleetInput_CertificateConfiguration(QString json);
    ~OAICreateFleetInput_CertificateConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFleetInput_CertificateConfiguration)

#endif // OAICreateFleetInput_CertificateConfiguration_H
