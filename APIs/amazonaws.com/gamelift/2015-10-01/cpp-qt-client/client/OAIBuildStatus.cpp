...
void OAIBuildStatus::initializeModel() {
    ...
    m_value = eOAIBuildStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIBuildStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("INITIALIZED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIBuildStatus::INITIALIZED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("READY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIBuildStatus::READY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("FAILED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIBuildStatus::FAILED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIBuildStatus::fromJsonValue(QJsonValue json) {
...
QString OAIBuildStatus::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIBuildStatus::INITIALIZED:
            val = "INITIALIZED";
            break;
        case eOAIBuildStatus::READY:
            val = "READY";
            break;
        case eOAIBuildStatus::FAILED:
            val = "FAILED";
            break;
        default:
            break;
...
QJsonValue OAIBuildStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIBuildStatus::eOAIBuildStatus OAIBuildStatus::getValue() const {
    return m_value;
}

void OAIBuildStatus::setValue(const OAIBuildStatus::eOAIBuildStatus& value){
    m_value = value;
    m_value_isSet = true;
}
