...
/*
 * OAIRequestUploadCredentialsOutput_UploadCredentials.h
 *
 * 
 */

#ifndef OAIRequestUploadCredentialsOutput_UploadCredentials_H
#define OAIRequestUploadCredentialsOutput_UploadCredentials_H
...
class OAIRequestUploadCredentialsOutput_UploadCredentials : public OAIObject {
public:
    OAIRequestUploadCredentialsOutput_UploadCredentials();
    OAIRequestUploadCredentialsOutput_UploadCredentials(QString json);
    ~OAIRequestUploadCredentialsOutput_UploadCredentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRequestUploadCredentialsOutput_UploadCredentials)

#endif // OAIRequestUploadCredentialsOutput_UploadCredentials_H
