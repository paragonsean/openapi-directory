...
#ifndef OAIPlayerLatency_H
#define OAIPlayerLatency_H
...
class OAIPlayerLatency : public OAIObject {
public:
    OAIPlayerLatency();
    OAIPlayerLatency(QString json);
    ~OAIPlayerLatency() override;
    ...
    QString getRegionIdentifier() const;
    void setRegionIdentifier(const QString &region_identifier);
    bool is_region_identifier_Set() const;
    bool is_region_identifier_Valid() const;

    float getLatencyInMilliseconds() const;
    void setLatencyInMilliseconds(const float &latency_in_milliseconds);
    bool is_latency_in_milliseconds_Set() const;
    bool is_latency_in_milliseconds_Valid() const;
...
private:
    ...
    QString m_region_identifier;
    bool m_region_identifier_isSet;
    bool m_region_identifier_isValid;

    float m_latency_in_milliseconds;
    bool m_latency_in_milliseconds_isSet;
    bool m_latency_in_milliseconds_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPlayerLatency)

#endif // OAIPlayerLatency_H
