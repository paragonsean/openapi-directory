...
OAIRegisterComputeOutput::OAIRegisterComputeOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRegisterComputeOutput::OAIRegisterComputeOutput() {
    this->initializeModel();
}

OAIRegisterComputeOutput::~OAIRegisterComputeOutput() {}

void OAIRegisterComputeOutput::initializeModel() {

    m_compute_isSet = false;
    m_compute_isValid = false;
}

void OAIRegisterComputeOutput::fromJson(QString jsonString) {
...
void OAIRegisterComputeOutput::fromJsonObject(QJsonObject json) {
...
QString OAIRegisterComputeOutput::asJson() const {
...
QJsonObject OAIRegisterComputeOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_compute.isSet()) {
...
OAIDescribeComputeOutput_Compute OAIRegisterComputeOutput::getCompute() const {
    return m_compute;
}
void OAIRegisterComputeOutput::setCompute(const OAIDescribeComputeOutput_Compute &compute) {
    m_compute = compute;
    m_compute_isSet = true;
}

bool OAIRegisterComputeOutput::is_compute_Set() const{
    return m_compute_isSet;
}

bool OAIRegisterComputeOutput::is_compute_Valid() const{
    return m_compute_isValid;
}

bool OAIRegisterComputeOutput::isSet() const {
...
bool OAIRegisterComputeOutput::isValid() const {
