...
OAICreateMatchmakingConfigurationOutput::OAICreateMatchmakingConfigurationOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateMatchmakingConfigurationOutput::OAICreateMatchmakingConfigurationOutput() {
    this->initializeModel();
}

OAICreateMatchmakingConfigurationOutput::~OAICreateMatchmakingConfigurationOutput() {}

void OAICreateMatchmakingConfigurationOutput::initializeModel() {

    m_configuration_isSet = false;
    m_configuration_isValid = false;
}

void OAICreateMatchmakingConfigurationOutput::fromJson(QString jsonString) {
...
void OAICreateMatchmakingConfigurationOutput::fromJsonObject(QJsonObject json) {

    m_configuration_isValid = ::OpenAPI::fromJsonValue(m_configuration, json[QString("Configuration")]);
    m_configuration_isSet = !json[QString("Configuration")].isNull() && m_configuration_isValid;
}

QString OAICreateMatchmakingConfigurationOutput::asJson() const {
...
QJsonObject OAICreateMatchmakingConfigurationOutput::asJsonObject() const {
    QJsonObject obj;
...
OAICreateMatchmakingConfigurationOutput_Configuration OAICreateMatchmakingConfigurationOutput::getConfiguration() const {
    return m_configuration;
}
void OAICreateMatchmakingConfigurationOutput::setConfiguration(const OAICreateMatchmakingConfigurationOutput_Configuration &configuration) {
    m_configuration = configuration;
    m_configuration_isSet = true;
}

bool OAICreateMatchmakingConfigurationOutput::is_configuration_Set() const{
    return m_configuration_isSet;
}

bool OAICreateMatchmakingConfigurationOutput::is_configuration_Valid() const{
    return m_configuration_isValid;
}

bool OAICreateMatchmakingConfigurationOutput::isSet() const {
...
bool OAICreateMatchmakingConfigurationOutput::isValid() const {
