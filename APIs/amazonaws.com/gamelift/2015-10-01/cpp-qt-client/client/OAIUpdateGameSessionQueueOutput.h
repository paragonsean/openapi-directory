...
/*
 * OAIUpdateGameSessionQueueOutput.h
 *
 * 
 */

#ifndef OAIUpdateGameSessionQueueOutput_H
#define OAIUpdateGameSessionQueueOutput_H

#include <QJsonObject>

#include "OAIUpdateGameSessionQueueOutput_GameSessionQueue.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIUpdateGameSessionQueueOutput_GameSessionQueue;

class OAIUpdateGameSessionQueueOutput : public OAIObject {
public:
    OAIUpdateGameSessionQueueOutput();
    OAIUpdateGameSessionQueueOutput(QString json);
    ~OAIUpdateGameSessionQueueOutput() override;
    ...
    OAIUpdateGameSessionQueueOutput_GameSessionQueue getGameSessionQueue() const;
    void setGameSessionQueue(const OAIUpdateGameSessionQueueOutput_GameSessionQueue &game_session_queue);
    bool is_game_session_queue_Set() const;
    bool is_game_session_queue_Valid() const;
...
private:
    ...
    OAIUpdateGameSessionQueueOutput_GameSessionQueue m_game_session_queue;
    bool m_game_session_queue_isSet;
    bool m_game_session_queue_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUpdateGameSessionQueueOutput)

#endif // OAIUpdateGameSessionQueueOutput_H
