...
/*
 * OAIUpdateGameSessionQueueInput_FilterConfiguration.h
 *
 * 
 */

#ifndef OAIUpdateGameSessionQueueInput_FilterConfiguration_H
#define OAIUpdateGameSessionQueueInput_FilterConfiguration_H
...
class OAIUpdateGameSessionQueueInput_FilterConfiguration : public OAIObject {
public:
    OAIUpdateGameSessionQueueInput_FilterConfiguration();
    OAIUpdateGameSessionQueueInput_FilterConfiguration(QString json);
    ~OAIUpdateGameSessionQueueInput_FilterConfiguration() override;
    ...
    QList getAllowedLocations() const;
    void setAllowedLocations(const QList &allowed_locations);
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateGameSessionQueueInput_FilterConfiguration)

#endif // OAIUpdateGameSessionQueueInput_FilterConfiguration_H
