...
/*
 * OAIUpdateBuildInput.h
 *
 * 
 */

#ifndef OAIUpdateBuildInput_H
#define OAIUpdateBuildInput_H
...
class OAIUpdateBuildInput : public OAIObject {
public:
    OAIUpdateBuildInput();
    OAIUpdateBuildInput(QString json);
    ~OAIUpdateBuildInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateBuildInput)

#endif // OAIUpdateBuildInput_H
