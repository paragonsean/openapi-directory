...
/*
 * OAIPutScalingPolicyOutput.h
 *
 * 
 */

#ifndef OAIPutScalingPolicyOutput_H
#define OAIPutScalingPolicyOutput_H
...
class OAIPutScalingPolicyOutput : public OAIObject {
public:
    OAIPutScalingPolicyOutput();
    OAIPutScalingPolicyOutput(QString json);
    ~OAIPutScalingPolicyOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutScalingPolicyOutput)

#endif // OAIPutScalingPolicyOutput_H
