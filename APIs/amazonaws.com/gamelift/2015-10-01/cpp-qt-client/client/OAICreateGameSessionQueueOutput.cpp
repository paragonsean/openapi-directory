...
OAICreateGameSessionQueueOutput::OAICreateGameSessionQueueOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateGameSessionQueueOutput::OAICreateGameSessionQueueOutput() {
    this->initializeModel();
}

OAICreateGameSessionQueueOutput::~OAICreateGameSessionQueueOutput() {}

void OAICreateGameSessionQueueOutput::initializeModel() {

    m_game_session_queue_isSet = false;
    m_game_session_queue_isValid = false;
}

void OAICreateGameSessionQueueOutput::fromJson(QString jsonString) {
...
void OAICreateGameSessionQueueOutput::fromJsonObject(QJsonObject json) {
...
QString OAICreateGameSessionQueueOutput::asJson() const {
...
QJsonObject OAICreateGameSessionQueueOutput::asJsonObject() const {
    QJsonObject obj;
...
OAICreateGameSessionQueueOutput_GameSessionQueue OAICreateGameSessionQueueOutput::getGameSessionQueue() const {
    return m_game_session_queue;
}
void OAICreateGameSessionQueueOutput::setGameSessionQueue(const OAICreateGameSessionQueueOutput_GameSessionQueue &game_session_queue) {
    m_game_session_queue = game_session_queue;
    m_game_session_queue_isSet = true;
}

bool OAICreateGameSessionQueueOutput::is_game_session_queue_Set() const{
    return m_game_session_queue_isSet;
}

bool OAICreateGameSessionQueueOutput::is_game_session_queue_Valid() const{
    return m_game_session_queue_isValid;
}

bool OAICreateGameSessionQueueOutput::isSet() const {
...
bool OAICreateGameSessionQueueOutput::isValid() const {
