...
/*
 * OAICreateMatchmakingRuleSetOutput.h
 *
 * 
 */

#ifndef OAICreateMatchmakingRuleSetOutput_H
#define OAICreateMatchmakingRuleSetOutput_H
...
namespace OpenAPI {
class OAICreateMatchmakingRuleSetOutput_RuleSet;

class OAICreateMatchmakingRuleSetOutput : public OAIObject {
public:
    OAICreateMatchmakingRuleSetOutput();
    OAICreateMatchmakingRuleSetOutput(QString json);
    ~OAICreateMatchmakingRuleSetOutput() override;
    ...
    OAICreateMatchmakingRuleSetOutput_RuleSet getRuleSet() const;
    void setRuleSet(const OAICreateMatchmakingRuleSetOutput_RuleSet &rule_set);
...
private:
    ...
    OAICreateMatchmakingRuleSetOutput_RuleSet m_rule_set;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMatchmakingRuleSetOutput)

#endif // OAICreateMatchmakingRuleSetOutput_H
