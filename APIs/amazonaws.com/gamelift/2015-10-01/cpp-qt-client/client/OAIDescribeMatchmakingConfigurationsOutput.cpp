...
OAIDescribeMatchmakingConfigurationsOutput::OAIDescribeMatchmakingConfigurationsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeMatchmakingConfigurationsOutput::OAIDescribeMatchmakingConfigurationsOutput() {
    this->initializeModel();
}

OAIDescribeMatchmakingConfigurationsOutput::~OAIDescribeMatchmakingConfigurationsOutput() {}

void OAIDescribeMatchmakingConfigurationsOutput::initializeModel() {
...
void OAIDescribeMatchmakingConfigurationsOutput::fromJson(QString jsonString) {
...
void OAIDescribeMatchmakingConfigurationsOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeMatchmakingConfigurationsOutput::asJson() const {
...
QJsonObject OAIDescribeMatchmakingConfigurationsOutput::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeMatchmakingConfigurationsOutput::getConfigurations() const {
    return m_configurations;
}
void OAIDescribeMatchmakingConfigurationsOutput::setConfigurations(const QList &configurations) {
    m_configurations = configurations;
    m_configurations_isSet = true;
}

bool OAIDescribeMatchmakingConfigurationsOutput::is_configurations_Set() const{
    return m_configurations_isSet;
}

bool OAIDescribeMatchmakingConfigurationsOutput::is_configurations_Valid() const{
    return m_configurations_isValid;
}

QString OAIDescribeMatchmakingConfigurationsOutput::getNextToken() const {
    return m_next_token;
}
void OAIDescribeMatchmakingConfigurationsOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeMatchmakingConfigurationsOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeMatchmakingConfigurationsOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeMatchmakingConfigurationsOutput::isSet() const {
...
bool OAIDescribeMatchmakingConfigurationsOutput::isValid() const {
