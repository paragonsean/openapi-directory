...
#include "OAIDescribeScriptOutput_Script.h"
...
OAIDescribeScriptOutput_Script::OAIDescribeScriptOutput_Script(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeScriptOutput_Script::OAIDescribeScriptOutput_Script() {
    this->initializeModel();
}

OAIDescribeScriptOutput_Script::~OAIDescribeScriptOutput_Script() {}

void OAIDescribeScriptOutput_Script::initializeModel() {
...
void OAIDescribeScriptOutput_Script::fromJson(QString jsonString) {
...
void OAIDescribeScriptOutput_Script::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeScriptOutput_Script::asJson() const {
...
QJsonObject OAIDescribeScriptOutput_Script::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeScriptOutput_Script::getScriptId() const {
    return m_script_id;
}
void OAIDescribeScriptOutput_Script::setScriptId(const QString &script_id) {
    m_script_id = script_id;
    m_script_id_isSet = true;
}

bool OAIDescribeScriptOutput_Script::is_script_id_Set() const{
    return m_script_id_isSet;
}

bool OAIDescribeScriptOutput_Script::is_script_id_Valid() const{
    return m_script_id_isValid;
}

QString OAIDescribeScriptOutput_Script::getScriptArn() const {
    return m_script_arn;
}
void OAIDescribeScriptOutput_Script::setScriptArn(const QString &script_arn) {
    m_script_arn = script_arn;
    m_script_arn_isSet = true;
}

bool OAIDescribeScriptOutput_Script::is_script_arn_Set() const{
    return m_script_arn_isSet;
}

bool OAIDescribeScriptOutput_Script::is_script_arn_Valid() const{
    return m_script_arn_isValid;
}

QString OAIDescribeScriptOutput_Script::getName() const {
    return m_name;
}
void OAIDescribeScriptOutput_Script::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDescribeScriptOutput_Script::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDescribeScriptOutput_Script::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIDescribeScriptOutput_Script::getVersion() const {
    return m_version;
}
void OAIDescribeScriptOutput_Script::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIDescribeScriptOutput_Script::is_version_Set() const{
    return m_version_isSet;
}

bool OAIDescribeScriptOutput_Script::is_version_Valid() const{
    return m_version_isValid;
}

qint32 OAIDescribeScriptOutput_Script::getSizeOnDisk() const {
    return m_size_on_disk;
}
void OAIDescribeScriptOutput_Script::setSizeOnDisk(const qint32 &size_on_disk) {
    m_size_on_disk = size_on_disk;
    m_size_on_disk_isSet = true;
}

bool OAIDescribeScriptOutput_Script::is_size_on_disk_Set() const{
    return m_size_on_disk_isSet;
}

bool OAIDescribeScriptOutput_Script::is_size_on_disk_Valid() const{
    return m_size_on_disk_isValid;
}

QDateTime OAIDescribeScriptOutput_Script::getCreationTime() const {
    return m_creation_time;
}
void OAIDescribeScriptOutput_Script::setCreationTime(const QDateTime &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAIDescribeScriptOutput_Script::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAIDescribeScriptOutput_Script::is_creation_time_Valid() const{
    return m_creation_time_isValid;
}

OAICreateScriptInput_StorageLocation OAIDescribeScriptOutput_Script::getStorageLocation() const {
    return m_storage_location;
}
void OAIDescribeScriptOutput_Script::setStorageLocation(const OAICreateScriptInput_StorageLocation &storage_location) {
    m_storage_location = storage_location;
    m_storage_location_isSet = true;
}

bool OAIDescribeScriptOutput_Script::is_storage_location_Set() const{
    return m_storage_location_isSet;
}

bool OAIDescribeScriptOutput_Script::is_storage_location_Valid() const{
    return m_storage_location_isValid;
}

bool OAIDescribeScriptOutput_Script::isSet() const {
...
bool OAIDescribeScriptOutput_Script::isValid() const {
