...
/*
 * OAIDescribeFleetEventsInput.h
 *
 * 
 */

#ifndef OAIDescribeFleetEventsInput_H
#define OAIDescribeFleetEventsInput_H
...
class OAIDescribeFleetEventsInput : public OAIObject {
public:
    OAIDescribeFleetEventsInput();
    OAIDescribeFleetEventsInput(QString json);
    ~OAIDescribeFleetEventsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFleetEventsInput)

#endif // OAIDescribeFleetEventsInput_H
