...
/*
 * OAIDescribeGameServerOutput_GameServer.h
 *
 * 
 */

#ifndef OAIDescribeGameServerOutput_GameServer_H
#define OAIDescribeGameServerOutput_GameServer_H
...
class OAIDescribeGameServerOutput_GameServer : public OAIObject {
public:
    OAIDescribeGameServerOutput_GameServer();
    OAIDescribeGameServerOutput_GameServer(QString json);
    ~OAIDescribeGameServerOutput_GameServer() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeGameServerOutput_GameServer)

#endif // OAIDescribeGameServerOutput_GameServer_H
