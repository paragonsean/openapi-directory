...
/*
 * OAIStopGameSessionPlacementOutput.h
 *
 * 
 */

#ifndef OAIStopGameSessionPlacementOutput_H
#define OAIStopGameSessionPlacementOutput_H

#include <QJsonObject>

#include "OAIStopGameSessionPlacementOutput_GameSessionPlacement.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIStopGameSessionPlacementOutput_GameSessionPlacement;

class OAIStopGameSessionPlacementOutput : public OAIObject {
public:
    OAIStopGameSessionPlacementOutput();
    OAIStopGameSessionPlacementOutput(QString json);
    ~OAIStopGameSessionPlacementOutput() override;
    ...
    OAIStopGameSessionPlacementOutput_GameSessionPlacement getGameSessionPlacement() const;
    void setGameSessionPlacement(const OAIStopGameSessionPlacementOutput_GameSessionPlacement &game_session_placement);
    bool is_game_session_placement_Set() const;
    bool is_game_session_placement_Valid() const;
...
private:
    ...
    OAIStopGameSessionPlacementOutput_GameSessionPlacement m_game_session_placement;
    bool m_game_session_placement_isSet;
    bool m_game_session_placement_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIStopGameSessionPlacementOutput)

#endif // OAIStopGameSessionPlacementOutput_H
