...
/*
 * OAIGameServerGroupStatus.h
 *
 * 
 */

#ifndef OAIGameServerGroupStatus_H
#define OAIGameServerGroupStatus_H
...
class OAIGameServerGroupStatus : public OAIEnum {
public:
    OAIGameServerGroupStatus();
    OAIGameServerGroupStatus(QString json);
    ~OAIGameServerGroupStatus() override;
    ...
    enum class eOAIGameServerGroupStatus {
    ...
    OAIGameServerGroupStatus::eOAIGameServerGroupStatus getValue() const;
    void setValue(const OAIGameServerGroupStatus::eOAIGameServerGroupStatus& value);
...
private:
    ...
    eOAIGameServerGroupStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGameServerGroupStatus)

#endif // OAIGameServerGroupStatus_H
