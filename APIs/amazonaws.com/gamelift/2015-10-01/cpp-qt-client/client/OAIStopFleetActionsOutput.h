...
/*
 * OAIStopFleetActionsOutput.h
 *
 * 
 */

#ifndef OAIStopFleetActionsOutput_H
#define OAIStopFleetActionsOutput_H
...
class OAIStopFleetActionsOutput : public OAIObject {
public:
    OAIStopFleetActionsOutput();
    OAIStopFleetActionsOutput(QString json);
    ~OAIStopFleetActionsOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopFleetActionsOutput)

#endif // OAIStopFleetActionsOutput_H
