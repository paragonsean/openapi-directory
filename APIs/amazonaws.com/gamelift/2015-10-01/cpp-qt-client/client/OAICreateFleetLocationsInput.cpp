...
OAICreateFleetLocationsInput::OAICreateFleetLocationsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateFleetLocationsInput::OAICreateFleetLocationsInput() {
    this->initializeModel();
}

OAICreateFleetLocationsInput::~OAICreateFleetLocationsInput() {}

void OAICreateFleetLocationsInput::initializeModel() {
...
void OAICreateFleetLocationsInput::fromJson(QString jsonString) {
...
void OAICreateFleetLocationsInput::fromJsonObject(QJsonObject json) {
...
QString OAICreateFleetLocationsInput::asJson() const {
...
QJsonObject OAICreateFleetLocationsInput::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
...
QString OAICreateFleetLocationsInput::getFleetId() const {
    return m_fleet_id;
}
void OAICreateFleetLocationsInput::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAICreateFleetLocationsInput::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAICreateFleetLocationsInput::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

QList OAICreateFleetLocationsInput::getLocations() const {
    return m_locations;
}
void OAICreateFleetLocationsInput::setLocations(const QList &locations) {
    m_locations = locations;
    m_locations_isSet = true;
}

bool OAICreateFleetLocationsInput::is_locations_Set() const{
    return m_locations_isSet;
}

bool OAICreateFleetLocationsInput::is_locations_Valid() const{
    return m_locations_isValid;
}

bool OAICreateFleetLocationsInput::isSet() const {
...
bool OAICreateFleetLocationsInput::isValid() const {
