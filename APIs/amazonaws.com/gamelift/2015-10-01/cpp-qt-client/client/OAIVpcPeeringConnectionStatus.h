...
/*
 * OAIVpcPeeringConnectionStatus.h
 *
...
#ifndef OAIVpcPeeringConnectionStatus_H
#define OAIVpcPeeringConnectionStatus_H
...
class OAIVpcPeeringConnectionStatus : public OAIObject {
public:
    OAIVpcPeeringConnectionStatus();
    OAIVpcPeeringConnectionStatus(QString json);
    ~OAIVpcPeeringConnectionStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVpcPeeringConnectionStatus)

#endif // OAIVpcPeeringConnectionStatus_H
