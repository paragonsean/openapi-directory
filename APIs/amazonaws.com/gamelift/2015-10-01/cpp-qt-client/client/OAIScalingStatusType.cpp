...
#include "OAIScalingStatusType.h"
...
OAIScalingStatusType::OAIScalingStatusType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIScalingStatusType::OAIScalingStatusType() {
    this->initializeModel();
}

OAIScalingStatusType::~OAIScalingStatusType() {}

void OAIScalingStatusType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIScalingStatusType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIScalingStatusType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ACTIVE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIScalingStatusType::ACTIVE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("UPDATE_REQUESTED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIScalingStatusType::UPDATE_REQUESTED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("UPDATING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIScalingStatusType::UPDATING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DELETE_REQUESTED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIScalingStatusType::DELETE_REQUESTED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DELETING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIScalingStatusType::DELETING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DELETED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIScalingStatusType::DELETED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ERROR", Qt::CaseInsensitive) == 0) {
        m_value = eOAIScalingStatusType::ERROR;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIScalingStatusType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIScalingStatusType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIScalingStatusType::ACTIVE:
            val = "ACTIVE";
            break;
        case eOAIScalingStatusType::UPDATE_REQUESTED:
            val = "UPDATE_REQUESTED";
            break;
        case eOAIScalingStatusType::UPDATING:
            val = "UPDATING";
            break;
        case eOAIScalingStatusType::DELETE_REQUESTED:
            val = "DELETE_REQUESTED";
            break;
        case eOAIScalingStatusType::DELETING:
            val = "DELETING";
            break;
        case eOAIScalingStatusType::DELETED:
            val = "DELETED";
            break;
        case eOAIScalingStatusType::ERROR:
            val = "ERROR";
            break;
        default:
            break;
...
QJsonValue OAIScalingStatusType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIScalingStatusType::eOAIScalingStatusType OAIScalingStatusType::getValue() const {
    return m_value;
}

void OAIScalingStatusType::setValue(const OAIScalingStatusType::eOAIScalingStatusType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIScalingStatusType::isSet() const {
    
    return m_value_isSet;
}

bool OAIScalingStatusType::isValid() const {
