...
OAIStopFleetActionsOutput::OAIStopFleetActionsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStopFleetActionsOutput::OAIStopFleetActionsOutput() {
    this->initializeModel();
}

OAIStopFleetActionsOutput::~OAIStopFleetActionsOutput() {}

void OAIStopFleetActionsOutput::initializeModel() {
...
void OAIStopFleetActionsOutput::fromJson(QString jsonString) {
...
void OAIStopFleetActionsOutput::fromJsonObject(QJsonObject json) {
...
QString OAIStopFleetActionsOutput::asJson() const {
...
QJsonObject OAIStopFleetActionsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
...
QString OAIStopFleetActionsOutput::getFleetId() const {
    return m_fleet_id;
}
void OAIStopFleetActionsOutput::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIStopFleetActionsOutput::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIStopFleetActionsOutput::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

QString OAIStopFleetActionsOutput::getFleetArn() const {
    return m_fleet_arn;
}
void OAIStopFleetActionsOutput::setFleetArn(const QString &fleet_arn) {
    m_fleet_arn = fleet_arn;
    m_fleet_arn_isSet = true;
}

bool OAIStopFleetActionsOutput::is_fleet_arn_Set() const{
    return m_fleet_arn_isSet;
}

bool OAIStopFleetActionsOutput::is_fleet_arn_Valid() const{
    return m_fleet_arn_isValid;
}

bool OAIStopFleetActionsOutput::isSet() const {
...
bool OAIStopFleetActionsOutput::isValid() const {
