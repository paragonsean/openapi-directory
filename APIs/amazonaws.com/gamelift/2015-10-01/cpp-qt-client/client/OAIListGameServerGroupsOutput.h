...
/*
 * OAIListGameServerGroupsOutput.h
 *
 * 
 */

#ifndef OAIListGameServerGroupsOutput_H
#define OAIListGameServerGroupsOutput_H
...
class OAIListGameServerGroupsOutput : public OAIObject {
public:
    OAIListGameServerGroupsOutput();
    OAIListGameServerGroupsOutput(QString json);
    ~OAIListGameServerGroupsOutput() override;
    ...
    QList getGameServerGroups() const;
    void setGameServerGroups(const QList &game_server_groups);
    bool is_game_server_groups_Set() const;
    bool is_game_server_groups_Valid() const;
...
private:
    ...
    QList m_game_server_groups;
    bool m_game_server_groups_isSet;
    bool m_game_server_groups_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListGameServerGroupsOutput)

#endif // OAIListGameServerGroupsOutput_H
