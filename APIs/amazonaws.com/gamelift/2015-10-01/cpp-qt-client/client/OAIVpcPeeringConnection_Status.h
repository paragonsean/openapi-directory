...
/*
 * OAIVpcPeeringConnection_Status.h
 *
 * 
 */

#ifndef OAIVpcPeeringConnection_Status_H
#define OAIVpcPeeringConnection_Status_H
...
class OAIVpcPeeringConnection_Status : public OAIObject {
public:
    OAIVpcPeeringConnection_Status();
    OAIVpcPeeringConnection_Status(QString json);
    ~OAIVpcPeeringConnection_Status() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVpcPeeringConnection_Status)

#endif // OAIVpcPeeringConnection_Status_H
