...
OAIRoutingStrategy::OAIRoutingStrategy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRoutingStrategy::OAIRoutingStrategy() {
    this->initializeModel();
}

OAIRoutingStrategy::~OAIRoutingStrategy() {}

void OAIRoutingStrategy::initializeModel() {
...
void OAIRoutingStrategy::fromJson(QString jsonString) {
...
void OAIRoutingStrategy::fromJsonObject(QJsonObject json) {
...
QString OAIRoutingStrategy::asJson() const {
...
QJsonObject OAIRoutingStrategy::asJsonObject() const {
    QJsonObject obj;
    if (m_type.isSet()) {
...
OAIRoutingStrategyType OAIRoutingStrategy::getType() const {
    return m_type;
}
void OAIRoutingStrategy::setType(const OAIRoutingStrategyType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIRoutingStrategy::is_type_Set() const{
    return m_type_isSet;
}

bool OAIRoutingStrategy::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIRoutingStrategy::getFleetId() const {
    return m_fleet_id;
}
void OAIRoutingStrategy::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIRoutingStrategy::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIRoutingStrategy::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

QString OAIRoutingStrategy::getMessage() const {
    return m_message;
}
void OAIRoutingStrategy::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIRoutingStrategy::is_message_Set() const{
    return m_message_isSet;
}

bool OAIRoutingStrategy::is_message_Valid() const{
    return m_message_isValid;
}

bool OAIRoutingStrategy::isSet() const {
...
bool OAIRoutingStrategy::isValid() const {
