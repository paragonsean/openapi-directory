...
/*
 * OAIPlayerSessionCreationPolicy.h
 *
 * 
 */

#ifndef OAIPlayerSessionCreationPolicy_H
#define OAIPlayerSessionCreationPolicy_H
...
class OAIPlayerSessionCreationPolicy : public OAIEnum {
public:
    OAIPlayerSessionCreationPolicy();
    OAIPlayerSessionCreationPolicy(QString json);
    ~OAIPlayerSessionCreationPolicy() override;
    ...
    enum class eOAIPlayerSessionCreationPolicy {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ACCEPT_ALL, 
        DENY_ALL
    };
    OAIPlayerSessionCreationPolicy::eOAIPlayerSessionCreationPolicy getValue() const;
    void setValue(const OAIPlayerSessionCreationPolicy::eOAIPlayerSessionCreationPolicy& value);
...
private:
    ...
    eOAIPlayerSessionCreationPolicy m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlayerSessionCreationPolicy)

#endif // OAIPlayerSessionCreationPolicy_H
