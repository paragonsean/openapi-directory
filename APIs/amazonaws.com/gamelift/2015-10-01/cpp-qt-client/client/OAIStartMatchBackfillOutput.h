...
/*
 * OAIStartMatchBackfillOutput.h
 *
 * 
 */

#ifndef OAIStartMatchBackfillOutput_H
#define OAIStartMatchBackfillOutput_H

#include <QJsonObject>

#include "OAIStartMatchBackfillOutput_MatchmakingTicket.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIStartMatchBackfillOutput_MatchmakingTicket;

class OAIStartMatchBackfillOutput : public OAIObject {
public:
    OAIStartMatchBackfillOutput();
    OAIStartMatchBackfillOutput(QString json);
    ~OAIStartMatchBackfillOutput() override;
    ...
    OAIStartMatchBackfillOutput_MatchmakingTicket getMatchmakingTicket() const;
    void setMatchmakingTicket(const OAIStartMatchBackfillOutput_MatchmakingTicket &matchmaking_ticket);
    bool is_matchmaking_ticket_Set() const;
    bool is_matchmaking_ticket_Valid() const;
...
private:
    ...
    OAIStartMatchBackfillOutput_MatchmakingTicket m_matchmaking_ticket;
    bool m_matchmaking_ticket_isSet;
    bool m_matchmaking_ticket_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIStartMatchBackfillOutput)

#endif // OAIStartMatchBackfillOutput_H
