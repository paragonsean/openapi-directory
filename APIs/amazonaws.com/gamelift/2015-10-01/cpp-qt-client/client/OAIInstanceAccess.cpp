...
OAIInstanceAccess::OAIInstanceAccess(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInstanceAccess::OAIInstanceAccess() {
    this->initializeModel();
}

OAIInstanceAccess::~OAIInstanceAccess() {}

void OAIInstanceAccess::initializeModel() {
...
void OAIInstanceAccess::fromJson(QString jsonString) {
...
void OAIInstanceAccess::fromJsonObject(QJsonObject json) {
...
QString OAIInstanceAccess::asJson() const {
...
QJsonObject OAIInstanceAccess::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
...
QString OAIInstanceAccess::getFleetId() const {
    return m_fleet_id;
}
void OAIInstanceAccess::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIInstanceAccess::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIInstanceAccess::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

QString OAIInstanceAccess::getInstanceId() const {
    return m_instance_id;
}
void OAIInstanceAccess::setInstanceId(const QString &instance_id) {
    m_instance_id = instance_id;
    m_instance_id_isSet = true;
}

bool OAIInstanceAccess::is_instance_id_Set() const{
    return m_instance_id_isSet;
}

bool OAIInstanceAccess::is_instance_id_Valid() const{
    return m_instance_id_isValid;
}

QString OAIInstanceAccess::getIpAddress() const {
    return m_ip_address;
}
void OAIInstanceAccess::setIpAddress(const QString &ip_address) {
    m_ip_address = ip_address;
    m_ip_address_isSet = true;
}

bool OAIInstanceAccess::is_ip_address_Set() const{
    return m_ip_address_isSet;
}

bool OAIInstanceAccess::is_ip_address_Valid() const{
    return m_ip_address_isValid;
}

OAIOperatingSystem OAIInstanceAccess::getOperatingSystem() const {
    return m_operating_system;
}
void OAIInstanceAccess::setOperatingSystem(const OAIOperatingSystem &operating_system) {
    m_operating_system = operating_system;
    m_operating_system_isSet = true;
}

bool OAIInstanceAccess::is_operating_system_Set() const{
    return m_operating_system_isSet;
}

bool OAIInstanceAccess::is_operating_system_Valid() const{
    return m_operating_system_isValid;
}

OAIInstanceAccess_Credentials OAIInstanceAccess::getCredentials() const {
    return m_credentials;
}
void OAIInstanceAccess::setCredentials(const OAIInstanceAccess_Credentials &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIInstanceAccess::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIInstanceAccess::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIInstanceAccess::isSet() const {
...
bool OAIInstanceAccess::isValid() const {
