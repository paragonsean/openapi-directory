...
/*
 * OAICreateScriptInput.h
 *
 * 
 */

#ifndef OAICreateScriptInput_H
#define OAICreateScriptInput_H
...
class OAICreateScriptInput : public OAIObject {
public:
    OAICreateScriptInput();
    OAICreateScriptInput(QString json);
    ~OAICreateScriptInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateScriptInput)

#endif // OAICreateScriptInput_H
