...
OAIDeregisterGameServerInput::OAIDeregisterGameServerInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeregisterGameServerInput::OAIDeregisterGameServerInput() {
    this->initializeModel();
}

OAIDeregisterGameServerInput::~OAIDeregisterGameServerInput() {}

void OAIDeregisterGameServerInput::initializeModel() {
...
void OAIDeregisterGameServerInput::fromJson(QString jsonString) {
...
void OAIDeregisterGameServerInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeregisterGameServerInput::asJson() const {
...
QJsonObject OAIDeregisterGameServerInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeregisterGameServerInput::getGameServerGroupName() const {
    return m_game_server_group_name;
}
void OAIDeregisterGameServerInput::setGameServerGroupName(const QString &game_server_group_name) {
    m_game_server_group_name = game_server_group_name;
    m_game_server_group_name_isSet = true;
}

bool OAIDeregisterGameServerInput::is_game_server_group_name_Set() const{
    return m_game_server_group_name_isSet;
}

bool OAIDeregisterGameServerInput::is_game_server_group_name_Valid() const{
    return m_game_server_group_name_isValid;
}

QString OAIDeregisterGameServerInput::getGameServerId() const {
    return m_game_server_id;
}
void OAIDeregisterGameServerInput::setGameServerId(const QString &game_server_id) {
    m_game_server_id = game_server_id;
    m_game_server_id_isSet = true;
}

bool OAIDeregisterGameServerInput::is_game_server_id_Set() const{
    return m_game_server_id_isSet;
}

bool OAIDeregisterGameServerInput::is_game_server_id_Valid() const{
    return m_game_server_id_isValid;
}

bool OAIDeregisterGameServerInput::isSet() const {
...
bool OAIDeregisterGameServerInput::isValid() const {
