...
/*
 * OAIDescribeRuntimeConfigurationInput.h
 *
 * 
 */

#ifndef OAIDescribeRuntimeConfigurationInput_H
#define OAIDescribeRuntimeConfigurationInput_H
...
class OAIDescribeRuntimeConfigurationInput : public OAIObject {
public:
    OAIDescribeRuntimeConfigurationInput();
    OAIDescribeRuntimeConfigurationInput(QString json);
    ~OAIDescribeRuntimeConfigurationInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeRuntimeConfigurationInput)

#endif // OAIDescribeRuntimeConfigurationInput_H
