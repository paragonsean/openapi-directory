...
OAIDeleteVpcPeeringConnectionInput::OAIDeleteVpcPeeringConnectionInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteVpcPeeringConnectionInput::OAIDeleteVpcPeeringConnectionInput() {
    this->initializeModel();
}

OAIDeleteVpcPeeringConnectionInput::~OAIDeleteVpcPeeringConnectionInput() {}

void OAIDeleteVpcPeeringConnectionInput::initializeModel() {

    m_fleet_id_isSet = false;
    m_fleet_id_isValid = false;

    m_vpc_peering_connection_id_isSet = false;
    m_vpc_peering_connection_id_isValid = false;
}

void OAIDeleteVpcPeeringConnectionInput::fromJson(QString jsonString) {
...
void OAIDeleteVpcPeeringConnectionInput::fromJsonObject(QJsonObject json) {
    ...
    m_vpc_peering_connection_id_isValid = ::OpenAPI::fromJsonValue(m_vpc_peering_connection_id, json[QString("VpcPeeringConnectionId")]);
    m_vpc_peering_connection_id_isSet = !json[QString("VpcPeeringConnectionId")].isNull() && m_vpc_peering_connection_id_isValid;
}

QString OAIDeleteVpcPeeringConnectionInput::asJson() const {
...
QJsonObject OAIDeleteVpcPeeringConnectionInput::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
        obj.insert(QString("FleetId"), ::OpenAPI::toJsonValue(m_fleet_id));
    }
    if (m_vpc_peering_connection_id_isSet) {
        obj.insert(QString("VpcPeeringConnectionId"), ::OpenAPI::toJsonValue(m_vpc_peering_connection_id));
    }
    return obj;
}

QString OAIDeleteVpcPeeringConnectionInput::getFleetId() const {
    return m_fleet_id;
}
void OAIDeleteVpcPeeringConnectionInput::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIDeleteVpcPeeringConnectionInput::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIDeleteVpcPeeringConnectionInput::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

QString OAIDeleteVpcPeeringConnectionInput::getVpcPeeringConnectionId() const {
    return m_vpc_peering_connection_id;
}
void OAIDeleteVpcPeeringConnectionInput::setVpcPeeringConnectionId(const QString &vpc_peering_connection_id) {
    m_vpc_peering_connection_id = vpc_peering_connection_id;
    m_vpc_peering_connection_id_isSet = true;
}

bool OAIDeleteVpcPeeringConnectionInput::is_vpc_peering_connection_id_Set() const{
    return m_vpc_peering_connection_id_isSet;
}

bool OAIDeleteVpcPeeringConnectionInput::is_vpc_peering_connection_id_Valid() const{
    return m_vpc_peering_connection_id_isValid;
}

bool OAIDeleteVpcPeeringConnectionInput::isSet() const {
...
bool OAIDeleteVpcPeeringConnectionInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_fleet_id_isValid && m_vpc_peering_connection_id_isValid && true;
}
