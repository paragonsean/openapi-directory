...
OAICreatePlayerSessionOutput::OAICreatePlayerSessionOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreatePlayerSessionOutput::OAICreatePlayerSessionOutput() {
    this->initializeModel();
}

OAICreatePlayerSessionOutput::~OAICreatePlayerSessionOutput() {}

void OAICreatePlayerSessionOutput::initializeModel() {

    m_player_session_isSet = false;
    m_player_session_isValid = false;
}

void OAICreatePlayerSessionOutput::fromJson(QString jsonString) {
...
void OAICreatePlayerSessionOutput::fromJsonObject(QJsonObject json) {

    m_player_session_isValid = ::OpenAPI::fromJsonValue(m_player_session, json[QString("PlayerSession")]);
    m_player_session_isSet = !json[QString("PlayerSession")].isNull() && m_player_session_isValid;
}

QString OAICreatePlayerSessionOutput::asJson() const {
...
QJsonObject OAICreatePlayerSessionOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_player_session.isSet()) {
        obj.insert(QString("PlayerSession"), ::OpenAPI::toJsonValue(m_player_session));
    }
    return obj;
}

OAICreatePlayerSessionOutput_PlayerSession OAICreatePlayerSessionOutput::getPlayerSession() const {
    return m_player_session;
}
void OAICreatePlayerSessionOutput::setPlayerSession(const OAICreatePlayerSessionOutput_PlayerSession &player_session) {
    m_player_session = player_session;
    m_player_session_isSet = true;
}

bool OAICreatePlayerSessionOutput::is_player_session_Set() const{
    return m_player_session_isSet;
}

bool OAICreatePlayerSessionOutput::is_player_session_Valid() const{
    return m_player_session_isValid;
}

bool OAICreatePlayerSessionOutput::isSet() const {
...
bool OAICreatePlayerSessionOutput::isValid() const {
