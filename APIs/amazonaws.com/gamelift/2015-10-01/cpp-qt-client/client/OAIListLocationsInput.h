...
/*
 * OAIListLocationsInput.h
 *
 * 
 */

#ifndef OAIListLocationsInput_H
#define OAIListLocationsInput_H
...
class OAIListLocationsInput : public OAIObject {
public:
    OAIListLocationsInput();
    OAIListLocationsInput(QString json);
    ~OAIListLocationsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListLocationsInput)

#endif // OAIListLocationsInput_H
