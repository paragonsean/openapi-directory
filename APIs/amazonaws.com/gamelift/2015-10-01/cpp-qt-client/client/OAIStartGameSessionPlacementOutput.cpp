...
OAIStartGameSessionPlacementOutput::OAIStartGameSessionPlacementOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartGameSessionPlacementOutput::OAIStartGameSessionPlacementOutput() {
    this->initializeModel();
}

OAIStartGameSessionPlacementOutput::~OAIStartGameSessionPlacementOutput() {}

void OAIStartGameSessionPlacementOutput::initializeModel() {

    m_game_session_placement_isSet = false;
    m_game_session_placement_isValid = false;
}

void OAIStartGameSessionPlacementOutput::fromJson(QString jsonString) {
...
void OAIStartGameSessionPlacementOutput::fromJsonObject(QJsonObject json) {
...
QString OAIStartGameSessionPlacementOutput::asJson() const {
...
QJsonObject OAIStartGameSessionPlacementOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIStartGameSessionPlacementOutput_GameSessionPlacement OAIStartGameSessionPlacementOutput::getGameSessionPlacement() const {
    return m_game_session_placement;
}
void OAIStartGameSessionPlacementOutput::setGameSessionPlacement(const OAIStartGameSessionPlacementOutput_GameSessionPlacement &game_session_placement) {
    m_game_session_placement = game_session_placement;
    m_game_session_placement_isSet = true;
}

bool OAIStartGameSessionPlacementOutput::is_game_session_placement_Set() const{
    return m_game_session_placement_isSet;
}

bool OAIStartGameSessionPlacementOutput::is_game_session_placement_Valid() const{
    return m_game_session_placement_isValid;
}

bool OAIStartGameSessionPlacementOutput::isSet() const {
...
bool OAIStartGameSessionPlacementOutput::isValid() const {
