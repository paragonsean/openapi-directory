...
/*
 * OAIListAliasesInput.h
 *
 * 
 */

#ifndef OAIListAliasesInput_H
#define OAIListAliasesInput_H
...
class OAIListAliasesInput : public OAIObject {
public:
    OAIListAliasesInput();
    OAIListAliasesInput(QString json);
    ~OAIListAliasesInput() override;
    ...
    OAIRoutingStrategyType getRoutingStrategyType() const;
    void setRoutingStrategyType(const OAIRoutingStrategyType &routing_strategy_type);
    bool is_routing_strategy_type_Set() const;
    bool is_routing_strategy_type_Valid() const;
...
private:
    ...
    OAIRoutingStrategyType m_routing_strategy_type;
    bool m_routing_strategy_type_isSet;
    bool m_routing_strategy_type_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAliasesInput)

#endif // OAIListAliasesInput_H
