...
/*
 * OAICreateGameServerGroupOutput_GameServerGroup.h
 *
 * 
 */

#ifndef OAICreateGameServerGroupOutput_GameServerGroup_H
#define OAICreateGameServerGroupOutput_GameServerGroup_H
...
class OAICreateGameServerGroupOutput_GameServerGroup : public OAIObject {
public:
    OAICreateGameServerGroupOutput_GameServerGroup();
    OAICreateGameServerGroupOutput_GameServerGroup(QString json);
    ~OAICreateGameServerGroupOutput_GameServerGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateGameServerGroupOutput_GameServerGroup)

#endif // OAICreateGameServerGroupOutput_GameServerGroup_H
