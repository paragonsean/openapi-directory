...
OAIStopMatchmakingInput::OAIStopMatchmakingInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStopMatchmakingInput::OAIStopMatchmakingInput() {
    this->initializeModel();
}

OAIStopMatchmakingInput::~OAIStopMatchmakingInput() {}

void OAIStopMatchmakingInput::initializeModel() {

    m_ticket_id_isSet = false;
    m_ticket_id_isValid = false;
}

void OAIStopMatchmakingInput::fromJson(QString jsonString) {
...
void OAIStopMatchmakingInput::fromJsonObject(QJsonObject json) {
...
QString OAIStopMatchmakingInput::asJson() const {
...
QJsonObject OAIStopMatchmakingInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStopMatchmakingInput::getTicketId() const {
    return m_ticket_id;
}
void OAIStopMatchmakingInput::setTicketId(const QString &ticket_id) {
    m_ticket_id = ticket_id;
    m_ticket_id_isSet = true;
}

bool OAIStopMatchmakingInput::is_ticket_id_Set() const{
    return m_ticket_id_isSet;
}

bool OAIStopMatchmakingInput::is_ticket_id_Valid() const{
    return m_ticket_id_isValid;
}

bool OAIStopMatchmakingInput::isSet() const {
...
bool OAIStopMatchmakingInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_ticket_id_isValid && true;
}
