...
OAIDeleteAliasInput::OAIDeleteAliasInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteAliasInput::OAIDeleteAliasInput() {
    this->initializeModel();
}

OAIDeleteAliasInput::~OAIDeleteAliasInput() {}

void OAIDeleteAliasInput::initializeModel() {

    m_alias_id_isSet = false;
    m_alias_id_isValid = false;
}

void OAIDeleteAliasInput::fromJson(QString jsonString) {
...
void OAIDeleteAliasInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteAliasInput::asJson() const {
...
QJsonObject OAIDeleteAliasInput::asJsonObject() const {
    QJsonObject obj;
    if (m_alias_id_isSet) {
...
QString OAIDeleteAliasInput::getAliasId() const {
    return m_alias_id;
}
void OAIDeleteAliasInput::setAliasId(const QString &alias_id) {
    m_alias_id = alias_id;
    m_alias_id_isSet = true;
}

bool OAIDeleteAliasInput::is_alias_id_Set() const{
    return m_alias_id_isSet;
}

bool OAIDeleteAliasInput::is_alias_id_Valid() const{
    return m_alias_id_isValid;
}

bool OAIDeleteAliasInput::isSet() const {
...
bool OAIDeleteAliasInput::isValid() const {
