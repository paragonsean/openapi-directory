...
OAIRequestUploadCredentialsOutput_UploadCredentials::OAIRequestUploadCredentialsOutput_UploadCredentials(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRequestUploadCredentialsOutput_UploadCredentials::OAIRequestUploadCredentialsOutput_UploadCredentials() {
    this->initializeModel();
}

OAIRequestUploadCredentialsOutput_UploadCredentials::~OAIRequestUploadCredentialsOutput_UploadCredentials() {}

void OAIRequestUploadCredentialsOutput_UploadCredentials::initializeModel() {
...
void OAIRequestUploadCredentialsOutput_UploadCredentials::fromJson(QString jsonString) {
...
void OAIRequestUploadCredentialsOutput_UploadCredentials::fromJsonObject(QJsonObject json) {
...
QString OAIRequestUploadCredentialsOutput_UploadCredentials::asJson() const {
...
QJsonObject OAIRequestUploadCredentialsOutput_UploadCredentials::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRequestUploadCredentialsOutput_UploadCredentials::getAccessKeyId() const {
    return m_access_key_id;
}
void OAIRequestUploadCredentialsOutput_UploadCredentials::setAccessKeyId(const QString &access_key_id) {
    m_access_key_id = access_key_id;
    m_access_key_id_isSet = true;
}

bool OAIRequestUploadCredentialsOutput_UploadCredentials::is_access_key_id_Set() const{
    return m_access_key_id_isSet;
}

bool OAIRequestUploadCredentialsOutput_UploadCredentials::is_access_key_id_Valid() const{
    return m_access_key_id_isValid;
}

QString OAIRequestUploadCredentialsOutput_UploadCredentials::getSecretAccessKey() const {
    return m_secret_access_key;
}
void OAIRequestUploadCredentialsOutput_UploadCredentials::setSecretAccessKey(const QString &secret_access_key) {
    m_secret_access_key = secret_access_key;
    m_secret_access_key_isSet = true;
}

bool OAIRequestUploadCredentialsOutput_UploadCredentials::is_secret_access_key_Set() const{
    return m_secret_access_key_isSet;
}

bool OAIRequestUploadCredentialsOutput_UploadCredentials::is_secret_access_key_Valid() const{
    return m_secret_access_key_isValid;
}

QString OAIRequestUploadCredentialsOutput_UploadCredentials::getSessionToken() const {
    return m_session_token;
}
void OAIRequestUploadCredentialsOutput_UploadCredentials::setSessionToken(const QString &session_token) {
    m_session_token = session_token;
    m_session_token_isSet = true;
}

bool OAIRequestUploadCredentialsOutput_UploadCredentials::is_session_token_Set() const{
    return m_session_token_isSet;
}

bool OAIRequestUploadCredentialsOutput_UploadCredentials::is_session_token_Valid() const{
    return m_session_token_isValid;
}

bool OAIRequestUploadCredentialsOutput_UploadCredentials::isSet() const {
...
bool OAIRequestUploadCredentialsOutput_UploadCredentials::isValid() const {
