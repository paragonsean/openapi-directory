...
#include "OAIFilterConfiguration.h"
...
OAIFilterConfiguration::OAIFilterConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFilterConfiguration::OAIFilterConfiguration() {
    this->initializeModel();
}

OAIFilterConfiguration::~OAIFilterConfiguration() {}

void OAIFilterConfiguration::initializeModel() {

    m_allowed_locations_isSet = false;
    m_allowed_locations_isValid = false;
}

void OAIFilterConfiguration::fromJson(QString jsonString) {
...
void OAIFilterConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIFilterConfiguration::asJson() const {
...
QJsonObject OAIFilterConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_allowed_locations.isSet()) {
        obj.insert(QString("AllowedLocations"), ::OpenAPI::toJsonValue(m_allowed_locations));
    }
    return obj;
}

QList OAIFilterConfiguration::getAllowedLocations() const {
    return m_allowed_locations;
}
void OAIFilterConfiguration::setAllowedLocations(const QList &allowed_locations) {
    m_allowed_locations = allowed_locations;
    m_allowed_locations_isSet = true;
}

bool OAIFilterConfiguration::is_allowed_locations_Set() const{
    return m_allowed_locations_isSet;
}

bool OAIFilterConfiguration::is_allowed_locations_Valid() const{
    return m_allowed_locations_isValid;
}

bool OAIFilterConfiguration::isSet() const {
...
bool OAIFilterConfiguration::isValid() const {
