...
#ifndef OAIRoutingStrategy_H
#define OAIRoutingStrategy_H
...
class OAIRoutingStrategy : public OAIObject {
public:
    OAIRoutingStrategy();
    OAIRoutingStrategy(QString json);
    ~OAIRoutingStrategy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRoutingStrategy)

#endif // OAIRoutingStrategy_H
