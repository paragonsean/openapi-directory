...
#ifndef OAIBackfillMode_H
#define OAIBackfillMode_H
...
class OAIBackfillMode : public OAIEnum {
public:
    OAIBackfillMode();
    OAIBackfillMode(QString json);
    ~OAIBackfillMode() override;
    ...
    enum class eOAIBackfillMode {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        AUTOMATIC, 
        MANUAL
    };
    OAIBackfillMode::eOAIBackfillMode getValue() const;
    void setValue(const OAIBackfillMode::eOAIBackfillMode& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIBackfillMode)

#endif // OAIBackfillMode_H
