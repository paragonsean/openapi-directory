...
/*
 * OAIUpdateScriptOutput_Script.h
 *
 * 
 */

#ifndef OAIUpdateScriptOutput_Script_H
#define OAIUpdateScriptOutput_Script_H

#include <QJsonObject>

#include "OAICreateScriptInput_StorageLocation.h"
#include <QDateTime>
#include <QString>
...
namespace OpenAPI {
class OAICreateScriptInput_StorageLocation;

class OAIUpdateScriptOutput_Script : public OAIObject {
public:
    OAIUpdateScriptOutput_Script();
    OAIUpdateScriptOutput_Script(QString json);
    ~OAIUpdateScriptOutput_Script() override;
    ...
    OAICreateScriptInput_StorageLocation getStorageLocation() const;
    void setStorageLocation(const OAICreateScriptInput_StorageLocation &storage_location);
...
private:
    ...
    OAICreateScriptInput_StorageLocation m_storage_location;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateScriptOutput_Script)

#endif // OAIUpdateScriptOutput_Script_H
