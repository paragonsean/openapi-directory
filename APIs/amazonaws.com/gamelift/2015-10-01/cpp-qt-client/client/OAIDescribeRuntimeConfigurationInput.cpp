...
OAIDescribeRuntimeConfigurationInput::OAIDescribeRuntimeConfigurationInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeRuntimeConfigurationInput::OAIDescribeRuntimeConfigurationInput() {
    this->initializeModel();
}

OAIDescribeRuntimeConfigurationInput::~OAIDescribeRuntimeConfigurationInput() {}

void OAIDescribeRuntimeConfigurationInput::initializeModel() {

    m_fleet_id_isSet = false;
    m_fleet_id_isValid = false;
}

void OAIDescribeRuntimeConfigurationInput::fromJson(QString jsonString) {
...
void OAIDescribeRuntimeConfigurationInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeRuntimeConfigurationInput::asJson() const {
...
QJsonObject OAIDescribeRuntimeConfigurationInput::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
...
QString OAIDescribeRuntimeConfigurationInput::getFleetId() const {
    return m_fleet_id;
}
void OAIDescribeRuntimeConfigurationInput::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIDescribeRuntimeConfigurationInput::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIDescribeRuntimeConfigurationInput::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

bool OAIDescribeRuntimeConfigurationInput::isSet() const {
...
bool OAIDescribeRuntimeConfigurationInput::isValid() const {
