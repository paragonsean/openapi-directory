...
#ifndef OAIFilterConfiguration_H
#define OAIFilterConfiguration_H
...
class OAIFilterConfiguration : public OAIObject {
public:
    OAIFilterConfiguration();
    OAIFilterConfiguration(QString json);
    ~OAIFilterConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFilterConfiguration)

#endif // OAIFilterConfiguration_H
