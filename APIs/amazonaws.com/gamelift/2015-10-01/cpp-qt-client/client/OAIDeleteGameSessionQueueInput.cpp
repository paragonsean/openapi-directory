...
OAIDeleteGameSessionQueueInput::OAIDeleteGameSessionQueueInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteGameSessionQueueInput::OAIDeleteGameSessionQueueInput() {
    this->initializeModel();
}

OAIDeleteGameSessionQueueInput::~OAIDeleteGameSessionQueueInput() {}

void OAIDeleteGameSessionQueueInput::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;
}

void OAIDeleteGameSessionQueueInput::fromJson(QString jsonString) {
...
void OAIDeleteGameSessionQueueInput::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("Name")]);
    m_name_isSet = !json[QString("Name")].isNull() && m_name_isValid;
}

QString OAIDeleteGameSessionQueueInput::asJson() const {
...
QJsonObject OAIDeleteGameSessionQueueInput::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIDeleteGameSessionQueueInput::getName() const {
    return m_name;
}
void OAIDeleteGameSessionQueueInput::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDeleteGameSessionQueueInput::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDeleteGameSessionQueueInput::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIDeleteGameSessionQueueInput::isSet() const {
...
bool OAIDeleteGameSessionQueueInput::isValid() const {
