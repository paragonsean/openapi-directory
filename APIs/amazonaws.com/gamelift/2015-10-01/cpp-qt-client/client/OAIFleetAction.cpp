...
OAIFleetAction::OAIFleetAction(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFleetAction::OAIFleetAction() {
    this->initializeModel();
}

OAIFleetAction::~OAIFleetAction() {}

void OAIFleetAction::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFleetAction::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFleetAction::fromJson(QString jsonString) {
    
    if ( jsonString.compare("AUTO_SCALING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFleetAction::AUTO_SCALING;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFleetAction::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFleetAction::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFleetAction::AUTO_SCALING:
            val = "AUTO_SCALING";
            break;
        default:
            break;
...
QJsonValue OAIFleetAction::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFleetAction::eOAIFleetAction OAIFleetAction::getValue() const {
    return m_value;
}

void OAIFleetAction::setValue(const OAIFleetAction::eOAIFleetAction& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFleetAction::isSet() const {
    
    return m_value_isSet;
}

bool OAIFleetAction::isValid() const {
