...
void OAIComputeType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("EC2", Qt::CaseInsensitive) == 0) {
        m_value = eOAIComputeType::EC2;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ANYWHERE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIComputeType::ANYWHERE;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIComputeType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIComputeType::EC2:
            val = "EC2";
            break;
        case eOAIComputeType::ANYWHERE:
            val = "ANYWHERE";
            break;
        default:
            break;
