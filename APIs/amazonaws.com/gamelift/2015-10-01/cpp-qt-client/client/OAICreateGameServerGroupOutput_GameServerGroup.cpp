...
#include "OAICreateGameServerGroupOutput_GameServerGroup.h"
...
OAICreateGameServerGroupOutput_GameServerGroup::OAICreateGameServerGroupOutput_GameServerGroup(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateGameServerGroupOutput_GameServerGroup::OAICreateGameServerGroupOutput_GameServerGroup() {
    this->initializeModel();
}

OAICreateGameServerGroupOutput_GameServerGroup::~OAICreateGameServerGroupOutput_GameServerGroup() {}

void OAICreateGameServerGroupOutput_GameServerGroup::initializeModel() {
...
void OAICreateGameServerGroupOutput_GameServerGroup::fromJson(QString jsonString) {
...
void OAICreateGameServerGroupOutput_GameServerGroup::fromJsonObject(QJsonObject json) {
...
QString OAICreateGameServerGroupOutput_GameServerGroup::asJson() const {
...
QJsonObject OAICreateGameServerGroupOutput_GameServerGroup::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateGameServerGroupOutput_GameServerGroup::getGameServerGroupName() const {
    return m_game_server_group_name;
}
void OAICreateGameServerGroupOutput_GameServerGroup::setGameServerGroupName(const QString &game_server_group_name) {
    m_game_server_group_name = game_server_group_name;
    m_game_server_group_name_isSet = true;
}

bool OAICreateGameServerGroupOutput_GameServerGroup::is_game_server_group_name_Set() const{
    return m_game_server_group_name_isSet;
}

bool OAICreateGameServerGroupOutput_GameServerGroup::is_game_server_group_name_Valid() const{
    return m_game_server_group_name_isValid;
}

QString OAICreateGameServerGroupOutput_GameServerGroup::getGameServerGroupArn() const {
    return m_game_server_group_arn;
}
void OAICreateGameServerGroupOutput_GameServerGroup::setGameServerGroupArn(const QString &game_server_group_arn) {
    m_game_server_group_arn = game_server_group_arn;
    m_game_server_group_arn_isSet = true;
}

bool OAICreateGameServerGroupOutput_GameServerGroup::is_game_server_group_arn_Set() const{
    return m_game_server_group_arn_isSet;
}

bool OAICreateGameServerGroupOutput_GameServerGroup::is_game_server_group_arn_Valid() const{
    return m_game_server_group_arn_isValid;
}

QString OAICreateGameServerGroupOutput_GameServerGroup::getRoleArn() const {
    return m_role_arn;
}
void OAICreateGameServerGroupOutput_GameServerGroup::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAICreateGameServerGroupOutput_GameServerGroup::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAICreateGameServerGroupOutput_GameServerGroup::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

QList OAICreateGameServerGroupOutput_GameServerGroup::getInstanceDefinitions() const {
    return m_instance_definitions;
}
void OAICreateGameServerGroupOutput_GameServerGroup::setInstanceDefinitions(const QList &instance_definitions) {
    m_instance_definitions = instance_definitions;
    m_instance_definitions_isSet = true;
}

bool OAICreateGameServerGroupOutput_GameServerGroup::is_instance_definitions_Set() const{
    return m_instance_definitions_isSet;
}

bool OAICreateGameServerGroupOutput_GameServerGroup::is_instance_definitions_Valid() const{
    return m_instance_definitions_isValid;
}

OAIBalancingStrategy OAICreateGameServerGroupOutput_GameServerGroup::getBalancingStrategy() const {
    return m_balancing_strategy;
}
void OAICreateGameServerGroupOutput_GameServerGroup::setBalancingStrategy(const OAIBalancingStrategy &balancing_strategy) {
    m_balancing_strategy = balancing_strategy;
    m_balancing_strategy_isSet = true;
}

bool OAICreateGameServerGroupOutput_GameServerGroup::is_balancing_strategy_Set() const{
    return m_balancing_strategy_isSet;
}

bool OAICreateGameServerGroupOutput_GameServerGroup::is_balancing_strategy_Valid() const{
    return m_balancing_strategy_isValid;
}

OAIGameServerProtectionPolicy OAICreateGameServerGroupOutput_GameServerGroup::getGameServerProtectionPolicy() const {
    return m_game_server_protection_policy;
}
void OAICreateGameServerGroupOutput_GameServerGroup::setGameServerProtectionPolicy(const OAIGameServerProtectionPolicy &game_server_protection_policy) {
    m_game_server_protection_policy = game_server_protection_policy;
    m_game_server_protection_policy_isSet = true;
}

bool OAICreateGameServerGroupOutput_GameServerGroup::is_game_server_protection_policy_Set() const{
    return m_game_server_protection_policy_isSet;
}

bool OAICreateGameServerGroupOutput_GameServerGroup::is_game_server_protection_policy_Valid() const{
    return m_game_server_protection_policy_isValid;
}

QString OAICreateGameServerGroupOutput_GameServerGroup::getAutoScalingGroupArn() const {
    return m_auto_scaling_group_arn;
}
void OAICreateGameServerGroupOutput_GameServerGroup::setAutoScalingGroupArn(const QString &auto_scaling_group_arn) {
    m_auto_scaling_group_arn = auto_scaling_group_arn;
    m_auto_scaling_group_arn_isSet = true;
}

bool OAICreateGameServerGroupOutput_GameServerGroup::is_auto_scaling_group_arn_Set() const{
    return m_auto_scaling_group_arn_isSet;
}

bool OAICreateGameServerGroupOutput_GameServerGroup::is_auto_scaling_group_arn_Valid() const{
    return m_auto_scaling_group_arn_isValid;
}

OAIGameServerGroupStatus OAICreateGameServerGroupOutput_GameServerGroup::getStatus() const {
    return m_status;
}
void OAICreateGameServerGroupOutput_GameServerGroup::setStatus(const OAIGameServerGroupStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICreateGameServerGroupOutput_GameServerGroup::is_status_Set() const{
    return m_status_isSet;
}

bool OAICreateGameServerGroupOutput_GameServerGroup::is_status_Valid() const{
    return m_status_isValid;
}

QString OAICreateGameServerGroupOutput_GameServerGroup::getStatusReason() const {
    return m_status_reason;
}
void OAICreateGameServerGroupOutput_GameServerGroup::setStatusReason(const QString &status_reason) {
    m_status_reason = status_reason;
    m_status_reason_isSet = true;
}

bool OAICreateGameServerGroupOutput_GameServerGroup::is_status_reason_Set() const{
    return m_status_reason_isSet;
}

bool OAICreateGameServerGroupOutput_GameServerGroup::is_status_reason_Valid() const{
    return m_status_reason_isValid;
}

QList OAICreateGameServerGroupOutput_GameServerGroup::getSuspendedActions() const {
    return m_suspended_actions;
}
void OAICreateGameServerGroupOutput_GameServerGroup::setSuspendedActions(const QList &suspended_actions) {
    m_suspended_actions = suspended_actions;
    m_suspended_actions_isSet = true;
}

bool OAICreateGameServerGroupOutput_GameServerGroup::is_suspended_actions_Set() const{
    return m_suspended_actions_isSet;
}

bool OAICreateGameServerGroupOutput_GameServerGroup::is_suspended_actions_Valid() const{
    return m_suspended_actions_isValid;
}

QDateTime OAICreateGameServerGroupOutput_GameServerGroup::getCreationTime() const {
    return m_creation_time;
}
void OAICreateGameServerGroupOutput_GameServerGroup::setCreationTime(const QDateTime &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAICreateGameServerGroupOutput_GameServerGroup::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAICreateGameServerGroupOutput_GameServerGroup::is_creation_time_Valid() const{
    return m_creation_time_isValid;
}

QDateTime OAICreateGameServerGroupOutput_GameServerGroup::getLastUpdatedTime() const {
    return m_last_updated_time;
}
void OAICreateGameServerGroupOutput_GameServerGroup::setLastUpdatedTime(const QDateTime &last_updated_time) {
    m_last_updated_time = last_updated_time;
    m_last_updated_time_isSet = true;
}

bool OAICreateGameServerGroupOutput_GameServerGroup::is_last_updated_time_Set() const{
    return m_last_updated_time_isSet;
}

bool OAICreateGameServerGroupOutput_GameServerGroup::is_last_updated_time_Valid() const{
    return m_last_updated_time_isValid;
}

bool OAICreateGameServerGroupOutput_GameServerGroup::isSet() const {
...
bool OAICreateGameServerGroupOutput_GameServerGroup::isValid() const {
