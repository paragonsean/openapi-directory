...
OAIDescribeFleetAttributesOutput::OAIDescribeFleetAttributesOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeFleetAttributesOutput::OAIDescribeFleetAttributesOutput() {
    this->initializeModel();
}

OAIDescribeFleetAttributesOutput::~OAIDescribeFleetAttributesOutput() {}

void OAIDescribeFleetAttributesOutput::initializeModel() {

    m_fleet_attributes_isSet = false;
    m_fleet_attributes_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIDescribeFleetAttributesOutput::fromJson(QString jsonString) {
...
void OAIDescribeFleetAttributesOutput::fromJsonObject(QJsonObject json) {

    m_fleet_attributes_isValid = ::OpenAPI::fromJsonValue(m_fleet_attributes, json[QString("FleetAttributes")]);
    m_fleet_attributes_isSet = !json[QString("FleetAttributes")].isNull() && m_fleet_attributes_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("NextToken")]);
    m_next_token_isSet = !json[QString("NextToken")].isNull() && m_next_token_isValid;
}

QString OAIDescribeFleetAttributesOutput::asJson() const {
...
QJsonObject OAIDescribeFleetAttributesOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_attributes.isSet()) {
        obj.insert(QString("FleetAttributes"), ::OpenAPI::toJsonValue(m_fleet_attributes));
    }
...
QList OAIDescribeFleetAttributesOutput::getFleetAttributes() const {
    return m_fleet_attributes;
}
void OAIDescribeFleetAttributesOutput::setFleetAttributes(const QList &fleet_attributes) {
    m_fleet_attributes = fleet_attributes;
    m_fleet_attributes_isSet = true;
}

bool OAIDescribeFleetAttributesOutput::is_fleet_attributes_Set() const{
    return m_fleet_attributes_isSet;
}

bool OAIDescribeFleetAttributesOutput::is_fleet_attributes_Valid() const{
    return m_fleet_attributes_isValid;
}

QString OAIDescribeFleetAttributesOutput::getNextToken() const {
    return m_next_token;
}
void OAIDescribeFleetAttributesOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeFleetAttributesOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeFleetAttributesOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeFleetAttributesOutput::isSet() const {
...
bool OAIDescribeFleetAttributesOutput::isValid() const {
