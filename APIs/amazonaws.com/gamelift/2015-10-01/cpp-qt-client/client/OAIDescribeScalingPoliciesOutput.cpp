...
OAIDescribeScalingPoliciesOutput::OAIDescribeScalingPoliciesOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeScalingPoliciesOutput::OAIDescribeScalingPoliciesOutput() {
    this->initializeModel();
}

OAIDescribeScalingPoliciesOutput::~OAIDescribeScalingPoliciesOutput() {}

void OAIDescribeScalingPoliciesOutput::initializeModel() {
...
void OAIDescribeScalingPoliciesOutput::fromJson(QString jsonString) {
...
void OAIDescribeScalingPoliciesOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeScalingPoliciesOutput::asJson() const {
...
QJsonObject OAIDescribeScalingPoliciesOutput::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeScalingPoliciesOutput::getScalingPolicies() const {
    return m_scaling_policies;
}
void OAIDescribeScalingPoliciesOutput::setScalingPolicies(const QList &scaling_policies) {
    m_scaling_policies = scaling_policies;
    m_scaling_policies_isSet = true;
}

bool OAIDescribeScalingPoliciesOutput::is_scaling_policies_Set() const{
    return m_scaling_policies_isSet;
}

bool OAIDescribeScalingPoliciesOutput::is_scaling_policies_Valid() const{
    return m_scaling_policies_isValid;
}

QString OAIDescribeScalingPoliciesOutput::getNextToken() const {
    return m_next_token;
}
void OAIDescribeScalingPoliciesOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeScalingPoliciesOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeScalingPoliciesOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeScalingPoliciesOutput::isSet() const {
...
bool OAIDescribeScalingPoliciesOutput::isValid() const {
