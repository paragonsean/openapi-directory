...
OAIDescribeFleetLocationCapacityInput::OAIDescribeFleetLocationCapacityInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeFleetLocationCapacityInput::OAIDescribeFleetLocationCapacityInput() {
    this->initializeModel();
}

OAIDescribeFleetLocationCapacityInput::~OAIDescribeFleetLocationCapacityInput() {}

void OAIDescribeFleetLocationCapacityInput::initializeModel() {
...
void OAIDescribeFleetLocationCapacityInput::fromJson(QString jsonString) {
...
void OAIDescribeFleetLocationCapacityInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeFleetLocationCapacityInput::asJson() const {
...
QJsonObject OAIDescribeFleetLocationCapacityInput::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
...
QString OAIDescribeFleetLocationCapacityInput::getFleetId() const {
    return m_fleet_id;
}
void OAIDescribeFleetLocationCapacityInput::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIDescribeFleetLocationCapacityInput::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIDescribeFleetLocationCapacityInput::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

QString OAIDescribeFleetLocationCapacityInput::getLocation() const {
    return m_location;
}
void OAIDescribeFleetLocationCapacityInput::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIDescribeFleetLocationCapacityInput::is_location_Set() const{
    return m_location_isSet;
}

bool OAIDescribeFleetLocationCapacityInput::is_location_Valid() const{
    return m_location_isValid;
}

bool OAIDescribeFleetLocationCapacityInput::isSet() const {
...
bool OAIDescribeFleetLocationCapacityInput::isValid() const {
