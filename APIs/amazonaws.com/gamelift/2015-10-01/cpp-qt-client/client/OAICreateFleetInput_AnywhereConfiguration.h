...
/*
 * OAICreateFleetInput_AnywhereConfiguration.h
 *
 * 
 */

#ifndef OAICreateFleetInput_AnywhereConfiguration_H
#define OAICreateFleetInput_AnywhereConfiguration_H
...
class OAICreateFleetInput_AnywhereConfiguration : public OAIObject {
public:
    OAICreateFleetInput_AnywhereConfiguration();
    OAICreateFleetInput_AnywhereConfiguration(QString json);
    ~OAICreateFleetInput_AnywhereConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFleetInput_AnywhereConfiguration)

#endif // OAICreateFleetInput_AnywhereConfiguration_H
