...
#ifndef OAIGameProperty_H
#define OAIGameProperty_H
...
class OAIGameProperty : public OAIObject {
public:
    OAIGameProperty();
    OAIGameProperty(QString json);
    ~OAIGameProperty() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGameProperty)

#endif // OAIGameProperty_H
