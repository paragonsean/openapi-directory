...
/*
 * OAICreatePlayerSessionsInput.h
 *
 * 
 */

#ifndef OAICreatePlayerSessionsInput_H
#define OAICreatePlayerSessionsInput_H
...
class OAICreatePlayerSessionsInput : public OAIObject {
public:
    OAICreatePlayerSessionsInput();
    OAICreatePlayerSessionsInput(QString json);
    ~OAICreatePlayerSessionsInput() override;
    ...
    QList getPlayerIds() const;
    void setPlayerIds(const QList &player_ids);
    bool is_player_ids_Set() const;
    bool is_player_ids_Valid() const;

    QMap getPlayerDataMap() const;
    void setPlayerDataMap(const QMap &player_data_map);
    bool is_player_data_map_Set() const;
    bool is_player_data_map_Valid() const;
...
private:
    ...
    QMap m_player_data_map;
    bool m_player_data_map_isSet;
    bool m_player_data_map_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreatePlayerSessionsInput)

#endif // OAICreatePlayerSessionsInput_H
