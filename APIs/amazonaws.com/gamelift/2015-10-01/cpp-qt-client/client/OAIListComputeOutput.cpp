...
OAIListComputeOutput::OAIListComputeOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListComputeOutput::OAIListComputeOutput() {
    this->initializeModel();
}

OAIListComputeOutput::~OAIListComputeOutput() {}

void OAIListComputeOutput::initializeModel() {

    m_compute_list_isSet = false;
    m_compute_list_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIListComputeOutput::fromJson(QString jsonString) {
...
void OAIListComputeOutput::fromJsonObject(QJsonObject json) {

    m_compute_list_isValid = ::OpenAPI::fromJsonValue(m_compute_list, json[QString("ComputeList")]);
    m_compute_list_isSet = !json[QString("ComputeList")].isNull() && m_compute_list_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("NextToken")]);
    m_next_token_isSet = !json[QString("NextToken")].isNull() && m_next_token_isValid;
}

QString OAIListComputeOutput::asJson() const {
...
QJsonObject OAIListComputeOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_compute_list.isSet()) {
        obj.insert(QString("ComputeList"), ::OpenAPI::toJsonValue(m_compute_list));
    }
...
QList OAIListComputeOutput::getComputeList() const {
    return m_compute_list;
}
void OAIListComputeOutput::setComputeList(const QList &compute_list) {
    m_compute_list = compute_list;
    m_compute_list_isSet = true;
}

bool OAIListComputeOutput::is_compute_list_Set() const{
    return m_compute_list_isSet;
}

bool OAIListComputeOutput::is_compute_list_Valid() const{
    return m_compute_list_isValid;
}

QString OAIListComputeOutput::getNextToken() const {
    return m_next_token;
}
void OAIListComputeOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListComputeOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListComputeOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListComputeOutput::isSet() const {
...
bool OAIListComputeOutput::isValid() const {
