...
/*
 * OAIStartMatchmakingInput.h
 *
 * 
 */

#ifndef OAIStartMatchmakingInput_H
#define OAIStartMatchmakingInput_H
...
class OAIStartMatchmakingInput : public OAIObject {
public:
    OAIStartMatchmakingInput();
    OAIStartMatchmakingInput(QString json);
    ~OAIStartMatchmakingInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartMatchmakingInput)

#endif // OAIStartMatchmakingInput_H
