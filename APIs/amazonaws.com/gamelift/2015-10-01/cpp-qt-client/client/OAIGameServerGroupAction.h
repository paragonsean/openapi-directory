...
/*
 * OAIGameServerGroupAction.h
 *
 * 
 */

#ifndef OAIGameServerGroupAction_H
#define OAIGameServerGroupAction_H
...
class OAIGameServerGroupAction : public OAIEnum {
public:
    OAIGameServerGroupAction();
    OAIGameServerGroupAction(QString json);
    ~OAIGameServerGroupAction() override;
    ...
    enum class eOAIGameServerGroupAction {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        REPLACE_INSTANCE_TYPES
    };
    OAIGameServerGroupAction::eOAIGameServerGroupAction getValue() const;
    void setValue(const OAIGameServerGroupAction::eOAIGameServerGroupAction& value);
...
private:
    ...
    eOAIGameServerGroupAction m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGameServerGroupAction)

#endif // OAIGameServerGroupAction_H
