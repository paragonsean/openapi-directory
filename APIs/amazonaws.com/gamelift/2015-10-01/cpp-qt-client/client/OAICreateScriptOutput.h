...
/*
 * OAICreateScriptOutput.h
 *
 * 
 */

#ifndef OAICreateScriptOutput_H
#define OAICreateScriptOutput_H
...
namespace OpenAPI {
class OAICreateScriptOutput_Script;

class OAICreateScriptOutput : public OAIObject {
public:
    OAICreateScriptOutput();
    OAICreateScriptOutput(QString json);
    ~OAICreateScriptOutput() override;
    ...
    OAICreateScriptOutput_Script getScript() const;
    void setScript(const OAICreateScriptOutput_Script &script);
...
private:
    ...
    OAICreateScriptOutput_Script m_script;
    bool m_script_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateScriptOutput)

#endif // OAICreateScriptOutput_H
