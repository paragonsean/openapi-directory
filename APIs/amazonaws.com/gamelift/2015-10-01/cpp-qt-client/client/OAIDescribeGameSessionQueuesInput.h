...
/*
 * OAIDescribeGameSessionQueuesInput.h
 *
 * 
 */

#ifndef OAIDescribeGameSessionQueuesInput_H
#define OAIDescribeGameSessionQueuesInput_H
...
class OAIDescribeGameSessionQueuesInput : public OAIObject {
public:
    OAIDescribeGameSessionQueuesInput();
    OAIDescribeGameSessionQueuesInput(QString json);
    ~OAIDescribeGameSessionQueuesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeGameSessionQueuesInput)

#endif // OAIDescribeGameSessionQueuesInput_H
