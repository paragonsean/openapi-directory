...
/*
 * OAIGameServerUtilizationStatus.h
 *
 * 
 */

#ifndef OAIGameServerUtilizationStatus_H
#define OAIGameServerUtilizationStatus_H
...
class OAIGameServerUtilizationStatus : public OAIEnum {
public:
    OAIGameServerUtilizationStatus();
    OAIGameServerUtilizationStatus(QString json);
    ~OAIGameServerUtilizationStatus() override;
    ...
    enum class eOAIGameServerUtilizationStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        AVAILABLE, 
        UTILIZED
    };
    OAIGameServerUtilizationStatus::eOAIGameServerUtilizationStatus getValue() const;
    void setValue(const OAIGameServerUtilizationStatus::eOAIGameServerUtilizationStatus& value);
...
private:
    ...
    eOAIGameServerUtilizationStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGameServerUtilizationStatus)

#endif // OAIGameServerUtilizationStatus_H
