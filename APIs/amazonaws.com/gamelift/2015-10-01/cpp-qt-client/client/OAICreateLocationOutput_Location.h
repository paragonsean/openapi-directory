...
/*
 * OAICreateLocationOutput_Location.h
 *
 * 
 */

#ifndef OAICreateLocationOutput_Location_H
#define OAICreateLocationOutput_Location_H
...
class OAICreateLocationOutput_Location : public OAIObject {
public:
    OAICreateLocationOutput_Location();
    OAICreateLocationOutput_Location(QString json);
    ~OAICreateLocationOutput_Location() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLocationOutput_Location)

#endif // OAICreateLocationOutput_Location_H
