...
/*
 * OAIDescribeEC2InstanceLimitsInput.h
 *
 * 
 */

#ifndef OAIDescribeEC2InstanceLimitsInput_H
#define OAIDescribeEC2InstanceLimitsInput_H
...
class OAIDescribeEC2InstanceLimitsInput : public OAIObject {
public:
    OAIDescribeEC2InstanceLimitsInput();
    OAIDescribeEC2InstanceLimitsInput(QString json);
    ~OAIDescribeEC2InstanceLimitsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEC2InstanceLimitsInput)

#endif // OAIDescribeEC2InstanceLimitsInput_H
