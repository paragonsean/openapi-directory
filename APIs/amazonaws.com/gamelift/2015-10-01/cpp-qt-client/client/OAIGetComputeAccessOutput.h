...
/*
 * OAIGetComputeAccessOutput.h
 *
 * 
 */

#ifndef OAIGetComputeAccessOutput_H
#define OAIGetComputeAccessOutput_H

#include <QJsonObject>

#include "OAIGetComputeAccessOutput_Credentials.h"
#include <QString>
...
namespace OpenAPI {
class OAIGetComputeAccessOutput_Credentials;

class OAIGetComputeAccessOutput : public OAIObject {
public:
    OAIGetComputeAccessOutput();
    OAIGetComputeAccessOutput(QString json);
    ~OAIGetComputeAccessOutput() override;
    ...
    OAIGetComputeAccessOutput_Credentials getCredentials() const;
    void setCredentials(const OAIGetComputeAccessOutput_Credentials &credentials);
...
private:
    ...
    OAIGetComputeAccessOutput_Credentials m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetComputeAccessOutput)

#endif // OAIGetComputeAccessOutput_H
