...
OAIDescribeVpcPeeringConnectionsInput::OAIDescribeVpcPeeringConnectionsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeVpcPeeringConnectionsInput::OAIDescribeVpcPeeringConnectionsInput() {
    this->initializeModel();
}

OAIDescribeVpcPeeringConnectionsInput::~OAIDescribeVpcPeeringConnectionsInput() {}

void OAIDescribeVpcPeeringConnectionsInput::initializeModel() {

    m_fleet_id_isSet = false;
    m_fleet_id_isValid = false;
}

void OAIDescribeVpcPeeringConnectionsInput::fromJson(QString jsonString) {
...
void OAIDescribeVpcPeeringConnectionsInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeVpcPeeringConnectionsInput::asJson() const {
...
QJsonObject OAIDescribeVpcPeeringConnectionsInput::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
...
QString OAIDescribeVpcPeeringConnectionsInput::getFleetId() const {
    return m_fleet_id;
}
void OAIDescribeVpcPeeringConnectionsInput::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIDescribeVpcPeeringConnectionsInput::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIDescribeVpcPeeringConnectionsInput::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

bool OAIDescribeVpcPeeringConnectionsInput::isSet() const {
...
bool OAIDescribeVpcPeeringConnectionsInput::isValid() const {
