...
OAIComparisonOperatorType::OAIComparisonOperatorType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIComparisonOperatorType::OAIComparisonOperatorType() {
    this->initializeModel();
}

OAIComparisonOperatorType::~OAIComparisonOperatorType() {}

void OAIComparisonOperatorType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIComparisonOperatorType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIComparisonOperatorType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("GreaterThanOrEqualToThreshold", Qt::CaseInsensitive) == 0) {
        m_value = eOAIComparisonOperatorType::GREATERTHANOREQUALTOTHRESHOLD;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("GreaterThanThreshold", Qt::CaseInsensitive) == 0) {
        m_value = eOAIComparisonOperatorType::GREATERTHANTHRESHOLD;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("LessThanThreshold", Qt::CaseInsensitive) == 0) {
        m_value = eOAIComparisonOperatorType::LESSTHANTHRESHOLD;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("LessThanOrEqualToThreshold", Qt::CaseInsensitive) == 0) {
        m_value = eOAIComparisonOperatorType::LESSTHANOREQUALTOTHRESHOLD;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIComparisonOperatorType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIComparisonOperatorType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIComparisonOperatorType::GREATERTHANOREQUALTOTHRESHOLD:
            val = "GreaterThanOrEqualToThreshold";
            break;
        case eOAIComparisonOperatorType::GREATERTHANTHRESHOLD:
            val = "GreaterThanThreshold";
            break;
        case eOAIComparisonOperatorType::LESSTHANTHRESHOLD:
            val = "LessThanThreshold";
            break;
        case eOAIComparisonOperatorType::LESSTHANOREQUALTOTHRESHOLD:
...
QJsonValue OAIComparisonOperatorType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIComparisonOperatorType::eOAIComparisonOperatorType OAIComparisonOperatorType::getValue() const {
    return m_value;
}

void OAIComparisonOperatorType::setValue(const OAIComparisonOperatorType::eOAIComparisonOperatorType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIComparisonOperatorType::isSet() const {
    
    return m_value_isSet;
}

bool OAIComparisonOperatorType::isValid() const {
