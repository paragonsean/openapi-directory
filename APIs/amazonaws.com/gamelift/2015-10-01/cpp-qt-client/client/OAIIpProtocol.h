...
#ifndef OAIIpProtocol_H
#define OAIIpProtocol_H
...
class OAIIpProtocol : public OAIEnum {
public:
    OAIIpProtocol();
    OAIIpProtocol(QString json);
    ~OAIIpProtocol() override;
    ...
    enum class eOAIIpProtocol {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        TCP, 
        UDP
    };
    OAIIpProtocol::eOAIIpProtocol getValue() const;
    void setValue(const OAIIpProtocol::eOAIIpProtocol& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIIpProtocol)

#endif // OAIIpProtocol_H
