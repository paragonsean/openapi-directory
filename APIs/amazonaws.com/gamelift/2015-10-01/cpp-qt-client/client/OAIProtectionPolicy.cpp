...
void OAIProtectionPolicy::initializeModel() {
    ...
    m_value = eOAIProtectionPolicy::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIProtectionPolicy::fromJson(QString jsonString) {
    
    if ( jsonString.compare("NoProtection", Qt::CaseInsensitive) == 0) {
        m_value = eOAIProtectionPolicy::NOPROTECTION;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("FullProtection", Qt::CaseInsensitive) == 0) {
        m_value = eOAIProtectionPolicy::FULLPROTECTION;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIProtectionPolicy::fromJsonValue(QJsonValue json) {
...
QString OAIProtectionPolicy::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIProtectionPolicy::NOPROTECTION:
            val = "NoProtection";
            break;
        case eOAIProtectionPolicy::FULLPROTECTION:
            val = "FullProtection";
            break;
        default:
            break;
...
QJsonValue OAIProtectionPolicy::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIProtectionPolicy::eOAIProtectionPolicy OAIProtectionPolicy::getValue() const {
    return m_value;
}

void OAIProtectionPolicy::setValue(const OAIProtectionPolicy::eOAIProtectionPolicy& value){
    m_value = value;
    m_value_isSet = true;
}
