...
/*
 * OAIDescribeGameServerInput.h
 *
 * 
 */

#ifndef OAIDescribeGameServerInput_H
#define OAIDescribeGameServerInput_H
...
class OAIDescribeGameServerInput : public OAIObject {
public:
    OAIDescribeGameServerInput();
    OAIDescribeGameServerInput(QString json);
    ~OAIDescribeGameServerInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeGameServerInput)

#endif // OAIDescribeGameServerInput_H
