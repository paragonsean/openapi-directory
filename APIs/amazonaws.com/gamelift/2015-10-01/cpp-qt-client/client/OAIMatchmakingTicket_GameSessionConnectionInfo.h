...
/*
 * OAIMatchmakingTicket_GameSessionConnectionInfo.h
 *
 * 
 */

#ifndef OAIMatchmakingTicket_GameSessionConnectionInfo_H
#define OAIMatchmakingTicket_GameSessionConnectionInfo_H
...
class OAIMatchmakingTicket_GameSessionConnectionInfo : public OAIObject {
public:
    OAIMatchmakingTicket_GameSessionConnectionInfo();
    OAIMatchmakingTicket_GameSessionConnectionInfo(QString json);
    ~OAIMatchmakingTicket_GameSessionConnectionInfo() override;
    ...
    QList getMatchedPlayerSessions() const;
    void setMatchedPlayerSessions(const QList &matched_player_sessions);
    bool is_matched_player_sessions_Set() const;
    bool is_matched_player_sessions_Valid() const;
...
private:
    ...
    QList m_matched_player_sessions;
    bool m_matched_player_sessions_isSet;
    bool m_matched_player_sessions_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIMatchmakingTicket_GameSessionConnectionInfo)

#endif // OAIMatchmakingTicket_GameSessionConnectionInfo_H
