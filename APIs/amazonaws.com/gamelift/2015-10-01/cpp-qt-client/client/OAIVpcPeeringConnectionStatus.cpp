...
#include "OAIVpcPeeringConnectionStatus.h"
...
OAIVpcPeeringConnectionStatus::OAIVpcPeeringConnectionStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVpcPeeringConnectionStatus::OAIVpcPeeringConnectionStatus() {
    this->initializeModel();
}

OAIVpcPeeringConnectionStatus::~OAIVpcPeeringConnectionStatus() {}

void OAIVpcPeeringConnectionStatus::initializeModel() {
...
void OAIVpcPeeringConnectionStatus::fromJson(QString jsonString) {
...
void OAIVpcPeeringConnectionStatus::fromJsonObject(QJsonObject json) {
...
QString OAIVpcPeeringConnectionStatus::asJson() const {
...
QJsonObject OAIVpcPeeringConnectionStatus::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
...
QString OAIVpcPeeringConnectionStatus::getCode() const {
    return m_code;
}
void OAIVpcPeeringConnectionStatus::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIVpcPeeringConnectionStatus::is_code_Set() const{
    return m_code_isSet;
}

bool OAIVpcPeeringConnectionStatus::is_code_Valid() const{
    return m_code_isValid;
}

QString OAIVpcPeeringConnectionStatus::getMessage() const {
    return m_message;
}
void OAIVpcPeeringConnectionStatus::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIVpcPeeringConnectionStatus::is_message_Set() const{
    return m_message_isSet;
}

bool OAIVpcPeeringConnectionStatus::is_message_Valid() const{
    return m_message_isValid;
}

bool OAIVpcPeeringConnectionStatus::isSet() const {
...
bool OAIVpcPeeringConnectionStatus::isValid() const {
