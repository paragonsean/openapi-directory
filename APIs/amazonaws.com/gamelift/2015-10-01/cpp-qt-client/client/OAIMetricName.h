...
class OAIMetricName : public OAIEnum {
public:
    OAIMetricName();
    ...
    OAIMetricName::eOAIMetricName getValue() const;
    void setValue(const OAIMetricName::eOAIMetricName& value);
