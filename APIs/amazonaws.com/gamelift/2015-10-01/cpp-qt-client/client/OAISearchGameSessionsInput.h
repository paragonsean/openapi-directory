...
/*
 * OAISearchGameSessionsInput.h
 *
 * 
 */

#ifndef OAISearchGameSessionsInput_H
#define OAISearchGameSessionsInput_H
...
class OAISearchGameSessionsInput : public OAIObject {
public:
    OAISearchGameSessionsInput();
    OAISearchGameSessionsInput(QString json);
    ~OAISearchGameSessionsInput() override;
    ...
    QString getSortExpression() const;
    void setSortExpression(const QString &sort_expression);
    bool is_sort_expression_Set() const;
    bool is_sort_expression_Valid() const;
...
private:
    ...
    QString m_sort_expression;
    bool m_sort_expression_isSet;
    bool m_sort_expression_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchGameSessionsInput)

#endif // OAISearchGameSessionsInput_H
