...
#include "OAIFilterInstanceStatus.h"
...
OAIFilterInstanceStatus::OAIFilterInstanceStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFilterInstanceStatus::OAIFilterInstanceStatus() {
    this->initializeModel();
}

OAIFilterInstanceStatus::~OAIFilterInstanceStatus() {}

void OAIFilterInstanceStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFilterInstanceStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFilterInstanceStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ACTIVE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFilterInstanceStatus::ACTIVE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DRAINING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFilterInstanceStatus::DRAINING;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFilterInstanceStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFilterInstanceStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFilterInstanceStatus::ACTIVE:
            val = "ACTIVE";
            break;
        case eOAIFilterInstanceStatus::DRAINING:
            val = "DRAINING";
            break;
        default:
            break;
...
QJsonValue OAIFilterInstanceStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFilterInstanceStatus::eOAIFilterInstanceStatus OAIFilterInstanceStatus::getValue() const {
    return m_value;
}

void OAIFilterInstanceStatus::setValue(const OAIFilterInstanceStatus::eOAIFilterInstanceStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFilterInstanceStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIFilterInstanceStatus::isValid() const {
