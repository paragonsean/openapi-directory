...
/*
 * OAIDescribeFleetCapacityOutput.h
 *
 * 
 */

#ifndef OAIDescribeFleetCapacityOutput_H
#define OAIDescribeFleetCapacityOutput_H
...
class OAIDescribeFleetCapacityOutput : public OAIObject {
public:
    OAIDescribeFleetCapacityOutput();
    OAIDescribeFleetCapacityOutput(QString json);
    ~OAIDescribeFleetCapacityOutput() override;
    ...
    QList getFleetCapacity() const;
    void setFleetCapacity(const QList &fleet_capacity);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFleetCapacityOutput)

#endif // OAIDescribeFleetCapacityOutput_H
