...
/*
 * OAIDescribeComputeInput.h
 *
 * 
 */

#ifndef OAIDescribeComputeInput_H
#define OAIDescribeComputeInput_H
...
class OAIDescribeComputeInput : public OAIObject {
public:
    OAIDescribeComputeInput();
    OAIDescribeComputeInput(QString json);
    ~OAIDescribeComputeInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeComputeInput)

#endif // OAIDescribeComputeInput_H
