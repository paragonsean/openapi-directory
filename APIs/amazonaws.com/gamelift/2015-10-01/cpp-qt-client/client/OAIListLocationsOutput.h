...
/*
 * OAIListLocationsOutput.h
 *
 * 
 */

#ifndef OAIListLocationsOutput_H
#define OAIListLocationsOutput_H
...
class OAIListLocationsOutput : public OAIObject {
public:
    OAIListLocationsOutput();
    OAIListLocationsOutput(QString json);
    ~OAIListLocationsOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListLocationsOutput)

#endif // OAIListLocationsOutput_H
