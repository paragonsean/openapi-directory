...
OAIPutScalingPolicyOutput::OAIPutScalingPolicyOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutScalingPolicyOutput::OAIPutScalingPolicyOutput() {
    this->initializeModel();
}

OAIPutScalingPolicyOutput::~OAIPutScalingPolicyOutput() {}

void OAIPutScalingPolicyOutput::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;
}

void OAIPutScalingPolicyOutput::fromJson(QString jsonString) {
...
void OAIPutScalingPolicyOutput::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("Name")]);
    m_name_isSet = !json[QString("Name")].isNull() && m_name_isValid;
}

QString OAIPutScalingPolicyOutput::asJson() const {
...
QJsonObject OAIPutScalingPolicyOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIPutScalingPolicyOutput::getName() const {
    return m_name;
}
void OAIPutScalingPolicyOutput::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIPutScalingPolicyOutput::is_name_Set() const{
    return m_name_isSet;
}

bool OAIPutScalingPolicyOutput::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIPutScalingPolicyOutput::isSet() const {
...
bool OAIPutScalingPolicyOutput::isValid() const {
