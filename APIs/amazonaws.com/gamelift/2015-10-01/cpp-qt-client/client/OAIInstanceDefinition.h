...
#ifndef OAIInstanceDefinition_H
#define OAIInstanceDefinition_H
...
class OAIInstanceDefinition : public OAIObject {
public:
    OAIInstanceDefinition();
    OAIInstanceDefinition(QString json);
    ~OAIInstanceDefinition() override;
    ...
    OAIGameServerGroupInstanceType getInstanceType() const;
    void setInstanceType(const OAIGameServerGroupInstanceType &instance_type);
...
private:
    ...
    OAIGameServerGroupInstanceType m_instance_type;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInstanceDefinition)

#endif // OAIInstanceDefinition_H
