...
OAIDescribeGameSessionQueuesInput::OAIDescribeGameSessionQueuesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeGameSessionQueuesInput::OAIDescribeGameSessionQueuesInput() {
    this->initializeModel();
}

OAIDescribeGameSessionQueuesInput::~OAIDescribeGameSessionQueuesInput() {}

void OAIDescribeGameSessionQueuesInput::initializeModel() {
...
void OAIDescribeGameSessionQueuesInput::fromJson(QString jsonString) {
...
void OAIDescribeGameSessionQueuesInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeGameSessionQueuesInput::asJson() const {
...
QJsonObject OAIDescribeGameSessionQueuesInput::asJsonObject() const {
    QJsonObject obj;
    if (m_names.isSet()) {
...
QList OAIDescribeGameSessionQueuesInput::getNames() const {
    return m_names;
}
void OAIDescribeGameSessionQueuesInput::setNames(const QList &names) {
    m_names = names;
    m_names_isSet = true;
}

bool OAIDescribeGameSessionQueuesInput::is_names_Set() const{
    return m_names_isSet;
}

bool OAIDescribeGameSessionQueuesInput::is_names_Valid() const{
    return m_names_isValid;
}

qint32 OAIDescribeGameSessionQueuesInput::getLimit() const {
    return m_limit;
}
void OAIDescribeGameSessionQueuesInput::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIDescribeGameSessionQueuesInput::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIDescribeGameSessionQueuesInput::is_limit_Valid() const{
    return m_limit_isValid;
}

QString OAIDescribeGameSessionQueuesInput::getNextToken() const {
    return m_next_token;
}
void OAIDescribeGameSessionQueuesInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeGameSessionQueuesInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeGameSessionQueuesInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeGameSessionQueuesInput::isSet() const {
...
bool OAIDescribeGameSessionQueuesInput::isValid() const {
