...
/*
 * OAIUpdateRuntimeConfigurationOutput.h
 *
 * 
 */

#ifndef OAIUpdateRuntimeConfigurationOutput_H
#define OAIUpdateRuntimeConfigurationOutput_H
...
namespace OpenAPI {
class OAIUpdateRuntimeConfigurationOutput_RuntimeConfiguration;

class OAIUpdateRuntimeConfigurationOutput : public OAIObject {
public:
    OAIUpdateRuntimeConfigurationOutput();
    OAIUpdateRuntimeConfigurationOutput(QString json);
    ~OAIUpdateRuntimeConfigurationOutput() override;
    ...
    OAIUpdateRuntimeConfigurationOutput_RuntimeConfiguration getRuntimeConfiguration() const;
    void setRuntimeConfiguration(const OAIUpdateRuntimeConfigurationOutput_RuntimeConfiguration &runtime_configuration);
...
private:
    ...
    OAIUpdateRuntimeConfigurationOutput_RuntimeConfiguration m_runtime_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRuntimeConfigurationOutput)

#endif // OAIUpdateRuntimeConfigurationOutput_H
