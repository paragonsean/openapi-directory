...
/*
 * OAIUpdateAliasInput_RoutingStrategy.h
 *
 * 
 */

#ifndef OAIUpdateAliasInput_RoutingStrategy_H
#define OAIUpdateAliasInput_RoutingStrategy_H
...
class OAIUpdateAliasInput_RoutingStrategy : public OAIObject {
public:
    OAIUpdateAliasInput_RoutingStrategy();
    OAIUpdateAliasInput_RoutingStrategy(QString json);
    ~OAIUpdateAliasInput_RoutingStrategy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAliasInput_RoutingStrategy)

#endif // OAIUpdateAliasInput_RoutingStrategy_H
