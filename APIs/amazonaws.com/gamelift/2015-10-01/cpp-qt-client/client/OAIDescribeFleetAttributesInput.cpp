...
OAIDescribeFleetAttributesInput::OAIDescribeFleetAttributesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeFleetAttributesInput::OAIDescribeFleetAttributesInput() {
    this->initializeModel();
}

OAIDescribeFleetAttributesInput::~OAIDescribeFleetAttributesInput() {}

void OAIDescribeFleetAttributesInput::initializeModel() {
...
void OAIDescribeFleetAttributesInput::fromJson(QString jsonString) {
...
void OAIDescribeFleetAttributesInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeFleetAttributesInput::asJson() const {
...
QJsonObject OAIDescribeFleetAttributesInput::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeFleetAttributesInput::getFleetIds() const {
    return m_fleet_ids;
}
void OAIDescribeFleetAttributesInput::setFleetIds(const QList &fleet_ids) {
    m_fleet_ids = fleet_ids;
    m_fleet_ids_isSet = true;
}

bool OAIDescribeFleetAttributesInput::is_fleet_ids_Set() const{
    return m_fleet_ids_isSet;
}

bool OAIDescribeFleetAttributesInput::is_fleet_ids_Valid() const{
    return m_fleet_ids_isValid;
}

qint32 OAIDescribeFleetAttributesInput::getLimit() const {
    return m_limit;
}
void OAIDescribeFleetAttributesInput::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIDescribeFleetAttributesInput::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIDescribeFleetAttributesInput::is_limit_Valid() const{
    return m_limit_isValid;
}

QString OAIDescribeFleetAttributesInput::getNextToken() const {
    return m_next_token;
}
void OAIDescribeFleetAttributesInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeFleetAttributesInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeFleetAttributesInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeFleetAttributesInput::isSet() const {
...
bool OAIDescribeFleetAttributesInput::isValid() const {
