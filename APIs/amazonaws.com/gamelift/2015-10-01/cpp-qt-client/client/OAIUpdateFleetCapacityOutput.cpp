...
OAIUpdateFleetCapacityOutput::OAIUpdateFleetCapacityOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateFleetCapacityOutput::OAIUpdateFleetCapacityOutput() {
    this->initializeModel();
}

OAIUpdateFleetCapacityOutput::~OAIUpdateFleetCapacityOutput() {}

void OAIUpdateFleetCapacityOutput::initializeModel() {
...
void OAIUpdateFleetCapacityOutput::fromJson(QString jsonString) {
...
void OAIUpdateFleetCapacityOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateFleetCapacityOutput::asJson() const {
...
QJsonObject OAIUpdateFleetCapacityOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
...
QString OAIUpdateFleetCapacityOutput::getFleetId() const {
    return m_fleet_id;
}
void OAIUpdateFleetCapacityOutput::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIUpdateFleetCapacityOutput::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIUpdateFleetCapacityOutput::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

QString OAIUpdateFleetCapacityOutput::getFleetArn() const {
    return m_fleet_arn;
}
void OAIUpdateFleetCapacityOutput::setFleetArn(const QString &fleet_arn) {
    m_fleet_arn = fleet_arn;
    m_fleet_arn_isSet = true;
}

bool OAIUpdateFleetCapacityOutput::is_fleet_arn_Set() const{
    return m_fleet_arn_isSet;
}

bool OAIUpdateFleetCapacityOutput::is_fleet_arn_Valid() const{
    return m_fleet_arn_isValid;
}

QString OAIUpdateFleetCapacityOutput::getLocation() const {
    return m_location;
}
void OAIUpdateFleetCapacityOutput::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIUpdateFleetCapacityOutput::is_location_Set() const{
    return m_location_isSet;
}

bool OAIUpdateFleetCapacityOutput::is_location_Valid() const{
    return m_location_isValid;
}

bool OAIUpdateFleetCapacityOutput::isSet() const {
...
bool OAIUpdateFleetCapacityOutput::isValid() const {
