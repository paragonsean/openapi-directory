...
OAIGameServerGroupDeleteOption::OAIGameServerGroupDeleteOption(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGameServerGroupDeleteOption::OAIGameServerGroupDeleteOption() {
    this->initializeModel();
}

OAIGameServerGroupDeleteOption::~OAIGameServerGroupDeleteOption() {}

void OAIGameServerGroupDeleteOption::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIGameServerGroupDeleteOption::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIGameServerGroupDeleteOption::fromJson(QString jsonString) {
    
    if ( jsonString.compare("SAFE_DELETE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGameServerGroupDeleteOption::SAFE_DELETE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("FORCE_DELETE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGameServerGroupDeleteOption::FORCE_DELETE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("RETAIN", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGameServerGroupDeleteOption::RETAIN;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIGameServerGroupDeleteOption::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIGameServerGroupDeleteOption::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIGameServerGroupDeleteOption::SAFE_DELETE:
            val = "SAFE_DELETE";
            break;
        case eOAIGameServerGroupDeleteOption::FORCE_DELETE:
            val = "FORCE_DELETE";
            break;
        case eOAIGameServerGroupDeleteOption::RETAIN:
            val = "RETAIN";
            break;
        default:
            break;
...
QJsonValue OAIGameServerGroupDeleteOption::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIGameServerGroupDeleteOption::eOAIGameServerGroupDeleteOption OAIGameServerGroupDeleteOption::getValue() const {
    return m_value;
}

void OAIGameServerGroupDeleteOption::setValue(const OAIGameServerGroupDeleteOption::eOAIGameServerGroupDeleteOption& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIGameServerGroupDeleteOption::isSet() const {
    
    return m_value_isSet;
}

bool OAIGameServerGroupDeleteOption::isValid() const {
