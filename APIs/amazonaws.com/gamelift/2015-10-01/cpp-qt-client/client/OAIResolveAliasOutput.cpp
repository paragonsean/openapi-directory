...
OAIResolveAliasOutput::OAIResolveAliasOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIResolveAliasOutput::OAIResolveAliasOutput() {
    this->initializeModel();
}

OAIResolveAliasOutput::~OAIResolveAliasOutput() {}

void OAIResolveAliasOutput::initializeModel() {
...
void OAIResolveAliasOutput::fromJson(QString jsonString) {
...
void OAIResolveAliasOutput::fromJsonObject(QJsonObject json) {
...
QString OAIResolveAliasOutput::asJson() const {
...
QJsonObject OAIResolveAliasOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
...
QString OAIResolveAliasOutput::getFleetId() const {
    return m_fleet_id;
}
void OAIResolveAliasOutput::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIResolveAliasOutput::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIResolveAliasOutput::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

QString OAIResolveAliasOutput::getFleetArn() const {
    return m_fleet_arn;
}
void OAIResolveAliasOutput::setFleetArn(const QString &fleet_arn) {
    m_fleet_arn = fleet_arn;
    m_fleet_arn_isSet = true;
}

bool OAIResolveAliasOutput::is_fleet_arn_Set() const{
    return m_fleet_arn_isSet;
}

bool OAIResolveAliasOutput::is_fleet_arn_Valid() const{
    return m_fleet_arn_isValid;
}

bool OAIResolveAliasOutput::isSet() const {
...
bool OAIResolveAliasOutput::isValid() const {
