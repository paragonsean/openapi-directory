...
OAIUpdateMatchmakingConfigurationOutput::OAIUpdateMatchmakingConfigurationOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateMatchmakingConfigurationOutput::OAIUpdateMatchmakingConfigurationOutput() {
    this->initializeModel();
}

OAIUpdateMatchmakingConfigurationOutput::~OAIUpdateMatchmakingConfigurationOutput() {}

void OAIUpdateMatchmakingConfigurationOutput::initializeModel() {

    m_configuration_isSet = false;
    m_configuration_isValid = false;
}

void OAIUpdateMatchmakingConfigurationOutput::fromJson(QString jsonString) {
...
void OAIUpdateMatchmakingConfigurationOutput::fromJsonObject(QJsonObject json) {

    m_configuration_isValid = ::OpenAPI::fromJsonValue(m_configuration, json[QString("Configuration")]);
    m_configuration_isSet = !json[QString("Configuration")].isNull() && m_configuration_isValid;
}

QString OAIUpdateMatchmakingConfigurationOutput::asJson() const {
...
QJsonObject OAIUpdateMatchmakingConfigurationOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdateMatchmakingConfigurationOutput_Configuration OAIUpdateMatchmakingConfigurationOutput::getConfiguration() const {
    return m_configuration;
}
void OAIUpdateMatchmakingConfigurationOutput::setConfiguration(const OAIUpdateMatchmakingConfigurationOutput_Configuration &configuration) {
    m_configuration = configuration;
    m_configuration_isSet = true;
}

bool OAIUpdateMatchmakingConfigurationOutput::is_configuration_Set() const{
    return m_configuration_isSet;
}

bool OAIUpdateMatchmakingConfigurationOutput::is_configuration_Valid() const{
    return m_configuration_isValid;
}

bool OAIUpdateMatchmakingConfigurationOutput::isSet() const {
...
bool OAIUpdateMatchmakingConfigurationOutput::isValid() const {
