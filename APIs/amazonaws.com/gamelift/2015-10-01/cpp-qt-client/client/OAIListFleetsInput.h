...
/*
 * OAIListFleetsInput.h
 *
 * 
 */

#ifndef OAIListFleetsInput_H
#define OAIListFleetsInput_H
...
class OAIListFleetsInput : public OAIObject {
public:
    OAIListFleetsInput();
    OAIListFleetsInput(QString json);
    ~OAIListFleetsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListFleetsInput)

#endif // OAIListFleetsInput_H
