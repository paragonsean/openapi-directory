...
OAIDescribeMatchmakingRuleSetsOutput::OAIDescribeMatchmakingRuleSetsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeMatchmakingRuleSetsOutput::OAIDescribeMatchmakingRuleSetsOutput() {
    this->initializeModel();
}

OAIDescribeMatchmakingRuleSetsOutput::~OAIDescribeMatchmakingRuleSetsOutput() {}

void OAIDescribeMatchmakingRuleSetsOutput::initializeModel() {
...
void OAIDescribeMatchmakingRuleSetsOutput::fromJson(QString jsonString) {
...
void OAIDescribeMatchmakingRuleSetsOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeMatchmakingRuleSetsOutput::asJson() const {
...
QJsonObject OAIDescribeMatchmakingRuleSetsOutput::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeMatchmakingRuleSetsOutput::getRuleSets() const {
    return m_rule_sets;
}
void OAIDescribeMatchmakingRuleSetsOutput::setRuleSets(const QList &rule_sets) {
    m_rule_sets = rule_sets;
    m_rule_sets_isSet = true;
}

bool OAIDescribeMatchmakingRuleSetsOutput::is_rule_sets_Set() const{
    return m_rule_sets_isSet;
}

bool OAIDescribeMatchmakingRuleSetsOutput::is_rule_sets_Valid() const{
    return m_rule_sets_isValid;
}

QString OAIDescribeMatchmakingRuleSetsOutput::getNextToken() const {
    return m_next_token;
}
void OAIDescribeMatchmakingRuleSetsOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeMatchmakingRuleSetsOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeMatchmakingRuleSetsOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeMatchmakingRuleSetsOutput::isSet() const {
...
bool OAIDescribeMatchmakingRuleSetsOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_rule_sets_isValid && true;
}
