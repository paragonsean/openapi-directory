...
/*
 * OAICreateBuildInput_StorageLocation.h
 *
 * 
 */

#ifndef OAICreateBuildInput_StorageLocation_H
#define OAICreateBuildInput_StorageLocation_H
...
class OAICreateBuildInput_StorageLocation : public OAIObject {
public:
    OAICreateBuildInput_StorageLocation();
    OAICreateBuildInput_StorageLocation(QString json);
    ~OAICreateBuildInput_StorageLocation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateBuildInput_StorageLocation)

#endif // OAICreateBuildInput_StorageLocation_H
