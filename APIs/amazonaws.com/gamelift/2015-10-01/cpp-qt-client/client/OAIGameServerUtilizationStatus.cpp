...
OAIGameServerUtilizationStatus::OAIGameServerUtilizationStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGameServerUtilizationStatus::OAIGameServerUtilizationStatus() {
    this->initializeModel();
}

OAIGameServerUtilizationStatus::~OAIGameServerUtilizationStatus() {}

void OAIGameServerUtilizationStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIGameServerUtilizationStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIGameServerUtilizationStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("AVAILABLE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGameServerUtilizationStatus::AVAILABLE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("UTILIZED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGameServerUtilizationStatus::UTILIZED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIGameServerUtilizationStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIGameServerUtilizationStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIGameServerUtilizationStatus::AVAILABLE:
            val = "AVAILABLE";
            break;
        case eOAIGameServerUtilizationStatus::UTILIZED:
            val = "UTILIZED";
            break;
        default:
            break;
...
QJsonValue OAIGameServerUtilizationStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIGameServerUtilizationStatus::eOAIGameServerUtilizationStatus OAIGameServerUtilizationStatus::getValue() const {
    return m_value;
}

void OAIGameServerUtilizationStatus::setValue(const OAIGameServerUtilizationStatus::eOAIGameServerUtilizationStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIGameServerUtilizationStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIGameServerUtilizationStatus::isValid() const {
