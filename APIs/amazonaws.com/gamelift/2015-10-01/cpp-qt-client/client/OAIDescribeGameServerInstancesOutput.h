...
/*
 * OAIDescribeGameServerInstancesOutput.h
 *
 * 
 */

#ifndef OAIDescribeGameServerInstancesOutput_H
#define OAIDescribeGameServerInstancesOutput_H
...
class OAIDescribeGameServerInstancesOutput : public OAIObject {
public:
    OAIDescribeGameServerInstancesOutput();
    OAIDescribeGameServerInstancesOutput(QString json);
    ~OAIDescribeGameServerInstancesOutput() override;
    ...
    QList getGameServerInstances() const;
    void setGameServerInstances(const QList &game_server_instances);
    bool is_game_server_instances_Set() const;
    bool is_game_server_instances_Valid() const;
...
private:
    ...
    QList m_game_server_instances;
    bool m_game_server_instances_isSet;
    bool m_game_server_instances_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeGameServerInstancesOutput)

#endif // OAIDescribeGameServerInstancesOutput_H
