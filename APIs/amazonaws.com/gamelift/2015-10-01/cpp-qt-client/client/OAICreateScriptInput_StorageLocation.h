...
/*
 * OAICreateScriptInput_StorageLocation.h
 *
 * 
 */

#ifndef OAICreateScriptInput_StorageLocation_H
#define OAICreateScriptInput_StorageLocation_H
...
class OAICreateScriptInput_StorageLocation : public OAIObject {
public:
    OAICreateScriptInput_StorageLocation();
    OAICreateScriptInput_StorageLocation(QString json);
    ~OAICreateScriptInput_StorageLocation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateScriptInput_StorageLocation)

#endif // OAICreateScriptInput_StorageLocation_H
