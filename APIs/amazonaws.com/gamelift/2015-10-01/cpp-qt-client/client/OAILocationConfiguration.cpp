...
#include "OAILocationConfiguration.h"
...
OAILocationConfiguration::OAILocationConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILocationConfiguration::OAILocationConfiguration() {
    this->initializeModel();
}

OAILocationConfiguration::~OAILocationConfiguration() {}

void OAILocationConfiguration::initializeModel() {

    m_location_isSet = false;
    m_location_isValid = false;
}

void OAILocationConfiguration::fromJson(QString jsonString) {
...
void OAILocationConfiguration::fromJsonObject(QJsonObject json) {

    m_location_isValid = ::OpenAPI::fromJsonValue(m_location, json[QString("Location")]);
    m_location_isSet = !json[QString("Location")].isNull() && m_location_isValid;
}

QString OAILocationConfiguration::asJson() const {
...
QJsonObject OAILocationConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_location_isSet) {
...
QString OAILocationConfiguration::getLocation() const {
    return m_location;
}
void OAILocationConfiguration::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAILocationConfiguration::is_location_Set() const{
    return m_location_isSet;
}

bool OAILocationConfiguration::is_location_Valid() const{
    return m_location_isValid;
}

bool OAILocationConfiguration::isSet() const {
...
bool OAILocationConfiguration::isValid() const {
