...
/*
 * OAIStartFleetActionsInput.h
 *
 * 
 */

#ifndef OAIStartFleetActionsInput_H
#define OAIStartFleetActionsInput_H
...
class OAIStartFleetActionsInput : public OAIObject {
public:
    OAIStartFleetActionsInput();
    OAIStartFleetActionsInput(QString json);
    ~OAIStartFleetActionsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartFleetActionsInput)

#endif // OAIStartFleetActionsInput_H
