...
#ifndef OAIEC2InstanceLimit_H
#define OAIEC2InstanceLimit_H
...
class OAIEC2InstanceLimit : public OAIObject {
public:
    OAIEC2InstanceLimit();
    OAIEC2InstanceLimit(QString json);
    ~OAIEC2InstanceLimit() override;
    ...
    qint32 getCurrentInstances() const;
    void setCurrentInstances(const qint32 &current_instances);
    bool is_current_instances_Set() const;
    bool is_current_instances_Valid() const;

    qint32 getInstanceLimit() const;
    void setInstanceLimit(const qint32 &instance_limit);
    bool is_instance_limit_Set() const;
    bool is_instance_limit_Valid() const;
...
private:
    ...
    qint32 m_current_instances;
    bool m_current_instances_isSet;
    bool m_current_instances_isValid;

    qint32 m_instance_limit;
    bool m_instance_limit_isSet;
    bool m_instance_limit_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEC2InstanceLimit)

#endif // OAIEC2InstanceLimit_H
