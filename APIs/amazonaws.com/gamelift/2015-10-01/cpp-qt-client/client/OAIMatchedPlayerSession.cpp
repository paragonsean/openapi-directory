...
#include "OAIMatchedPlayerSession.h"
...
OAIMatchedPlayerSession::OAIMatchedPlayerSession(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMatchedPlayerSession::OAIMatchedPlayerSession() {
    this->initializeModel();
}

OAIMatchedPlayerSession::~OAIMatchedPlayerSession() {}

void OAIMatchedPlayerSession::initializeModel() {
...
void OAIMatchedPlayerSession::fromJson(QString jsonString) {
...
void OAIMatchedPlayerSession::fromJsonObject(QJsonObject json) {
...
QString OAIMatchedPlayerSession::asJson() const {
...
QJsonObject OAIMatchedPlayerSession::asJsonObject() const {
    QJsonObject obj;
...
QString OAIMatchedPlayerSession::getPlayerId() const {
    return m_player_id;
}
void OAIMatchedPlayerSession::setPlayerId(const QString &player_id) {
    m_player_id = player_id;
    m_player_id_isSet = true;
}

bool OAIMatchedPlayerSession::is_player_id_Set() const{
    return m_player_id_isSet;
}

bool OAIMatchedPlayerSession::is_player_id_Valid() const{
    return m_player_id_isValid;
}

QString OAIMatchedPlayerSession::getPlayerSessionId() const {
    return m_player_session_id;
}
void OAIMatchedPlayerSession::setPlayerSessionId(const QString &player_session_id) {
    m_player_session_id = player_session_id;
    m_player_session_id_isSet = true;
}

bool OAIMatchedPlayerSession::is_player_session_id_Set() const{
    return m_player_session_id_isSet;
}

bool OAIMatchedPlayerSession::is_player_session_id_Valid() const{
    return m_player_session_id_isValid;
}

bool OAIMatchedPlayerSession::isSet() const {
...
bool OAIMatchedPlayerSession::isValid() const {
