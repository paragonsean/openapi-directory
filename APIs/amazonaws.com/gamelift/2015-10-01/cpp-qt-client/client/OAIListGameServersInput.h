...
/*
 * OAIListGameServersInput.h
 *
 * 
 */

#ifndef OAIListGameServersInput_H
#define OAIListGameServersInput_H
...
class OAIListGameServersInput : public OAIObject {
public:
    OAIListGameServersInput();
    OAIListGameServersInput(QString json);
    ~OAIListGameServersInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListGameServersInput)

#endif // OAIListGameServersInput_H
