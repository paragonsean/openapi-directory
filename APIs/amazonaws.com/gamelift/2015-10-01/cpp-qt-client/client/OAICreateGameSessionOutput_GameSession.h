...
/*
 * OAICreateGameSessionOutput_GameSession.h
 *
 * 
 */

#ifndef OAICreateGameSessionOutput_GameSession_H
#define OAICreateGameSessionOutput_GameSession_H
...
class OAICreateGameSessionOutput_GameSession : public OAIObject {
public:
    OAICreateGameSessionOutput_GameSession();
    OAICreateGameSessionOutput_GameSession(QString json);
    ~OAICreateGameSessionOutput_GameSession() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateGameSessionOutput_GameSession)

#endif // OAICreateGameSessionOutput_GameSession_H
