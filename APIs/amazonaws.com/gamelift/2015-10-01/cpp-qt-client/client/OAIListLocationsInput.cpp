...
OAIListLocationsInput::OAIListLocationsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListLocationsInput::OAIListLocationsInput() {
    this->initializeModel();
}

OAIListLocationsInput::~OAIListLocationsInput() {}

void OAIListLocationsInput::initializeModel() {
...
void OAIListLocationsInput::fromJson(QString jsonString) {
...
void OAIListLocationsInput::fromJsonObject(QJsonObject json) {
...
QString OAIListLocationsInput::asJson() const {
...
QJsonObject OAIListLocationsInput::asJsonObject() const {
    QJsonObject obj;
    if (m_filters.isSet()) {
...
QList OAIListLocationsInput::getFilters() const {
    return m_filters;
}
void OAIListLocationsInput::setFilters(const QList &filters) {
    m_filters = filters;
    m_filters_isSet = true;
}

bool OAIListLocationsInput::is_filters_Set() const{
    return m_filters_isSet;
}

bool OAIListLocationsInput::is_filters_Valid() const{
    return m_filters_isValid;
}

qint32 OAIListLocationsInput::getLimit() const {
    return m_limit;
}
void OAIListLocationsInput::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIListLocationsInput::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIListLocationsInput::is_limit_Valid() const{
    return m_limit_isValid;
}

QString OAIListLocationsInput::getNextToken() const {
    return m_next_token;
}
void OAIListLocationsInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListLocationsInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListLocationsInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListLocationsInput::isSet() const {
...
bool OAIListLocationsInput::isValid() const {
