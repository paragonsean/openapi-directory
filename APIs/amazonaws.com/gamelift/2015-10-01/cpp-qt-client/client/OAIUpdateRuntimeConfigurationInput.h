...
/*
 * OAIUpdateRuntimeConfigurationInput.h
 *
 * 
 */

#ifndef OAIUpdateRuntimeConfigurationInput_H
#define OAIUpdateRuntimeConfigurationInput_H
...
namespace OpenAPI {
class OAIUpdateRuntimeConfigurationInput_RuntimeConfiguration;

class OAIUpdateRuntimeConfigurationInput : public OAIObject {
public:
    OAIUpdateRuntimeConfigurationInput();
    OAIUpdateRuntimeConfigurationInput(QString json);
    ~OAIUpdateRuntimeConfigurationInput() override;
    ...
    OAIUpdateRuntimeConfigurationInput_RuntimeConfiguration getRuntimeConfiguration() const;
    void setRuntimeConfiguration(const OAIUpdateRuntimeConfigurationInput_RuntimeConfiguration &runtime_configuration);
...
private:
    ...
    OAIUpdateRuntimeConfigurationInput_RuntimeConfiguration m_runtime_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRuntimeConfigurationInput)

#endif // OAIUpdateRuntimeConfigurationInput_H
