...
/*
 * OAIDeleteVpcPeeringConnectionInput.h
 *
 * 
 */

#ifndef OAIDeleteVpcPeeringConnectionInput_H
#define OAIDeleteVpcPeeringConnectionInput_H
...
class OAIDeleteVpcPeeringConnectionInput : public OAIObject {
public:
    OAIDeleteVpcPeeringConnectionInput();
    OAIDeleteVpcPeeringConnectionInput(QString json);
    ~OAIDeleteVpcPeeringConnectionInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteVpcPeeringConnectionInput)

#endif // OAIDeleteVpcPeeringConnectionInput_H
