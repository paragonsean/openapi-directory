...
OAICreateVpcPeeringConnectionInput::OAICreateVpcPeeringConnectionInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateVpcPeeringConnectionInput::OAICreateVpcPeeringConnectionInput() {
    this->initializeModel();
}

OAICreateVpcPeeringConnectionInput::~OAICreateVpcPeeringConnectionInput() {}

void OAICreateVpcPeeringConnectionInput::initializeModel() {
...
void OAICreateVpcPeeringConnectionInput::fromJson(QString jsonString) {
...
void OAICreateVpcPeeringConnectionInput::fromJsonObject(QJsonObject json) {
...
QString OAICreateVpcPeeringConnectionInput::asJson() const {
...
QJsonObject OAICreateVpcPeeringConnectionInput::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
...
QString OAICreateVpcPeeringConnectionInput::getFleetId() const {
    return m_fleet_id;
}
void OAICreateVpcPeeringConnectionInput::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAICreateVpcPeeringConnectionInput::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAICreateVpcPeeringConnectionInput::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

QString OAICreateVpcPeeringConnectionInput::getPeerVpcAwsAccountId() const {
    return m_peer_vpc_aws_account_id;
}
void OAICreateVpcPeeringConnectionInput::setPeerVpcAwsAccountId(const QString &peer_vpc_aws_account_id) {
    m_peer_vpc_aws_account_id = peer_vpc_aws_account_id;
    m_peer_vpc_aws_account_id_isSet = true;
}

bool OAICreateVpcPeeringConnectionInput::is_peer_vpc_aws_account_id_Set() const{
    return m_peer_vpc_aws_account_id_isSet;
}

bool OAICreateVpcPeeringConnectionInput::is_peer_vpc_aws_account_id_Valid() const{
    return m_peer_vpc_aws_account_id_isValid;
}

QString OAICreateVpcPeeringConnectionInput::getPeerVpcId() const {
    return m_peer_vpc_id;
}
void OAICreateVpcPeeringConnectionInput::setPeerVpcId(const QString &peer_vpc_id) {
    m_peer_vpc_id = peer_vpc_id;
    m_peer_vpc_id_isSet = true;
}

bool OAICreateVpcPeeringConnectionInput::is_peer_vpc_id_Set() const{
    return m_peer_vpc_id_isSet;
}

bool OAICreateVpcPeeringConnectionInput::is_peer_vpc_id_Valid() const{
    return m_peer_vpc_id_isValid;
}

bool OAICreateVpcPeeringConnectionInput::isSet() const {
...
bool OAICreateVpcPeeringConnectionInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_fleet_id_isValid && m_peer_vpc_aws_account_id_isValid && m_peer_vpc_id_isValid && true;
}
