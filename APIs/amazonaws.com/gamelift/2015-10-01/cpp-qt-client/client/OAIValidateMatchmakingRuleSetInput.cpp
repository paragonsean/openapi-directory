...
OAIValidateMatchmakingRuleSetInput::OAIValidateMatchmakingRuleSetInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIValidateMatchmakingRuleSetInput::OAIValidateMatchmakingRuleSetInput() {
    this->initializeModel();
}

OAIValidateMatchmakingRuleSetInput::~OAIValidateMatchmakingRuleSetInput() {}

void OAIValidateMatchmakingRuleSetInput::initializeModel() {

    m_rule_set_body_isSet = false;
    m_rule_set_body_isValid = false;
}

void OAIValidateMatchmakingRuleSetInput::fromJson(QString jsonString) {
...
void OAIValidateMatchmakingRuleSetInput::fromJsonObject(QJsonObject json) {
...
QString OAIValidateMatchmakingRuleSetInput::asJson() const {
...
QJsonObject OAIValidateMatchmakingRuleSetInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIValidateMatchmakingRuleSetInput::getRuleSetBody() const {
    return m_rule_set_body;
}
void OAIValidateMatchmakingRuleSetInput::setRuleSetBody(const QString &rule_set_body) {
    m_rule_set_body = rule_set_body;
    m_rule_set_body_isSet = true;
}

bool OAIValidateMatchmakingRuleSetInput::is_rule_set_body_Set() const{
    return m_rule_set_body_isSet;
}

bool OAIValidateMatchmakingRuleSetInput::is_rule_set_body_Valid() const{
    return m_rule_set_body_isValid;
}

bool OAIValidateMatchmakingRuleSetInput::isSet() const {
...
bool OAIValidateMatchmakingRuleSetInput::isValid() const {
