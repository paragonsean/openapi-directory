...
/*
 * OAIUpdateGameServerGroupOutput_GameServerGroup.h
 *
 * 
 */

#ifndef OAIUpdateGameServerGroupOutput_GameServerGroup_H
#define OAIUpdateGameServerGroupOutput_GameServerGroup_H
...
class OAIUpdateGameServerGroupOutput_GameServerGroup : public OAIObject {
public:
    OAIUpdateGameServerGroupOutput_GameServerGroup();
    OAIUpdateGameServerGroupOutput_GameServerGroup(QString json);
    ~OAIUpdateGameServerGroupOutput_GameServerGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateGameServerGroupOutput_GameServerGroup)

#endif // OAIUpdateGameServerGroupOutput_GameServerGroup_H
