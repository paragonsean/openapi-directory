...
#include "OAIGameSessionQueueDestination.h"
...
OAIGameSessionQueueDestination::OAIGameSessionQueueDestination(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGameSessionQueueDestination::OAIGameSessionQueueDestination() {
    this->initializeModel();
}

OAIGameSessionQueueDestination::~OAIGameSessionQueueDestination() {}

void OAIGameSessionQueueDestination::initializeModel() {

    m_destination_arn_isSet = false;
    m_destination_arn_isValid = false;
}

void OAIGameSessionQueueDestination::fromJson(QString jsonString) {
...
void OAIGameSessionQueueDestination::fromJsonObject(QJsonObject json) {
...
QString OAIGameSessionQueueDestination::asJson() const {
...
QJsonObject OAIGameSessionQueueDestination::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGameSessionQueueDestination::getDestinationArn() const {
    return m_destination_arn;
}
void OAIGameSessionQueueDestination::setDestinationArn(const QString &destination_arn) {
    m_destination_arn = destination_arn;
    m_destination_arn_isSet = true;
}

bool OAIGameSessionQueueDestination::is_destination_arn_Set() const{
    return m_destination_arn_isSet;
}

bool OAIGameSessionQueueDestination::is_destination_arn_Valid() const{
    return m_destination_arn_isValid;
}

bool OAIGameSessionQueueDestination::isSet() const {
...
bool OAIGameSessionQueueDestination::isValid() const {
