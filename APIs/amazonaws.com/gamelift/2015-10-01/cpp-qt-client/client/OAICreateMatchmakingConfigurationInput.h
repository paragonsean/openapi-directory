...
/*
 * OAICreateMatchmakingConfigurationInput.h
 *
 * 
 */

#ifndef OAICreateMatchmakingConfigurationInput_H
#define OAICreateMatchmakingConfigurationInput_H
...
class OAICreateMatchmakingConfigurationInput : public OAIObject {
public:
    OAICreateMatchmakingConfigurationInput();
    OAICreateMatchmakingConfigurationInput(QString json);
    ~OAICreateMatchmakingConfigurationInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMatchmakingConfigurationInput)

#endif // OAICreateMatchmakingConfigurationInput_H
