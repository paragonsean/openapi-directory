...
OAIDescribeEC2InstanceLimitsInput::OAIDescribeEC2InstanceLimitsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeEC2InstanceLimitsInput::OAIDescribeEC2InstanceLimitsInput() {
    this->initializeModel();
}

OAIDescribeEC2InstanceLimitsInput::~OAIDescribeEC2InstanceLimitsInput() {}

void OAIDescribeEC2InstanceLimitsInput::initializeModel() {
...
void OAIDescribeEC2InstanceLimitsInput::fromJson(QString jsonString) {
...
void OAIDescribeEC2InstanceLimitsInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeEC2InstanceLimitsInput::asJson() const {
...
QJsonObject OAIDescribeEC2InstanceLimitsInput::asJsonObject() const {
    QJsonObject obj;
...
OAIEC2InstanceType OAIDescribeEC2InstanceLimitsInput::getEc2InstanceType() const {
    return m_ec2_instance_type;
}
void OAIDescribeEC2InstanceLimitsInput::setEc2InstanceType(const OAIEC2InstanceType &ec2_instance_type) {
    m_ec2_instance_type = ec2_instance_type;
    m_ec2_instance_type_isSet = true;
}

bool OAIDescribeEC2InstanceLimitsInput::is_ec2_instance_type_Set() const{
    return m_ec2_instance_type_isSet;
}

bool OAIDescribeEC2InstanceLimitsInput::is_ec2_instance_type_Valid() const{
    return m_ec2_instance_type_isValid;
}

QString OAIDescribeEC2InstanceLimitsInput::getLocation() const {
    return m_location;
}
void OAIDescribeEC2InstanceLimitsInput::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIDescribeEC2InstanceLimitsInput::is_location_Set() const{
    return m_location_isSet;
}

bool OAIDescribeEC2InstanceLimitsInput::is_location_Valid() const{
    return m_location_isValid;
}

bool OAIDescribeEC2InstanceLimitsInput::isSet() const {
...
bool OAIDescribeEC2InstanceLimitsInput::isValid() const {
