...
#ifndef OAIPriorityConfiguration_H
#define OAIPriorityConfiguration_H
...
class OAIPriorityConfiguration : public OAIObject {
public:
    OAIPriorityConfiguration();
    OAIPriorityConfiguration(QString json);
    ~OAIPriorityConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPriorityConfiguration)

#endif // OAIPriorityConfiguration_H
