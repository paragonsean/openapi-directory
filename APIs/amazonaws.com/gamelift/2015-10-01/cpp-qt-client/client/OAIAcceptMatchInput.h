...
/*
 * OAIAcceptMatchInput.h
 *
 * 
 */

#ifndef OAIAcceptMatchInput_H
#define OAIAcceptMatchInput_H

#include <QJsonObject>

#include "OAIAcceptanceType.h"
#include <QList>
#include <QString>
...
class OAIAcceptMatchInput : public OAIObject {
public:
    OAIAcceptMatchInput();
    OAIAcceptMatchInput(QString json);
    ~OAIAcceptMatchInput() override;
    ...
    OAIAcceptanceType getAcceptanceType() const;
    void setAcceptanceType(const OAIAcceptanceType &acceptance_type);
    bool is_acceptance_type_Set() const;
    bool is_acceptance_type_Valid() const;
...
private:
    ...
    OAIAcceptanceType m_acceptance_type;
    bool m_acceptance_type_isSet;
    bool m_acceptance_type_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIAcceptMatchInput)

#endif // OAIAcceptMatchInput_H
