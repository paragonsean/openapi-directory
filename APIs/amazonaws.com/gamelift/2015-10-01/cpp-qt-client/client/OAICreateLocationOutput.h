...
/*
 * OAICreateLocationOutput.h
 *
 * 
 */

#ifndef OAICreateLocationOutput_H
#define OAICreateLocationOutput_H

#include <QJsonObject>

#include "OAICreateLocationOutput_Location.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAICreateLocationOutput_Location;

class OAICreateLocationOutput : public OAIObject {
public:
    OAICreateLocationOutput();
    OAICreateLocationOutput(QString json);
    ~OAICreateLocationOutput() override;
    ...
    OAICreateLocationOutput_Location getLocation() const;
    void setLocation(const OAICreateLocationOutput_Location &location);
...
private:
    ...
    OAICreateLocationOutput_Location m_location;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLocationOutput)

#endif // OAICreateLocationOutput_H
