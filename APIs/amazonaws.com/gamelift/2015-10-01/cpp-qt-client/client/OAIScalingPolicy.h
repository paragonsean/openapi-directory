...
#include "OAILocationUpdateStatus.h"
...
public:
    ...
    OAIScalingStatusType getStatus() const;
    void setStatus(const OAIScalingStatusType &status);
    ...
    OAILocationUpdateStatus getUpdateStatus() const;
    void setUpdateStatus(const OAILocationUpdateStatus &update_status);
...
private:
    ...
    OAILocationUpdateStatus m_update_status;
