...
/*
 * OAIGetComputeAccessInput.h
 *
 * 
 */

#ifndef OAIGetComputeAccessInput_H
#define OAIGetComputeAccessInput_H
...
class OAIGetComputeAccessInput : public OAIObject {
public:
    OAIGetComputeAccessInput();
    OAIGetComputeAccessInput(QString json);
    ~OAIGetComputeAccessInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetComputeAccessInput)

#endif // OAIGetComputeAccessInput_H
