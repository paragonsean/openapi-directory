...
OAIDescribeComputeInput::OAIDescribeComputeInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeComputeInput::OAIDescribeComputeInput() {
    this->initializeModel();
}

OAIDescribeComputeInput::~OAIDescribeComputeInput() {}

void OAIDescribeComputeInput::initializeModel() {
...
void OAIDescribeComputeInput::fromJson(QString jsonString) {
...
void OAIDescribeComputeInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeComputeInput::asJson() const {
...
QJsonObject OAIDescribeComputeInput::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
...
QString OAIDescribeComputeInput::getFleetId() const {
    return m_fleet_id;
}
void OAIDescribeComputeInput::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIDescribeComputeInput::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIDescribeComputeInput::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

QString OAIDescribeComputeInput::getComputeName() const {
    return m_compute_name;
}
void OAIDescribeComputeInput::setComputeName(const QString &compute_name) {
    m_compute_name = compute_name;
    m_compute_name_isSet = true;
}

bool OAIDescribeComputeInput::is_compute_name_Set() const{
    return m_compute_name_isSet;
}

bool OAIDescribeComputeInput::is_compute_name_Valid() const{
    return m_compute_name_isValid;
}

bool OAIDescribeComputeInput::isSet() const {
...
bool OAIDescribeComputeInput::isValid() const {
