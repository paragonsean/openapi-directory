...
/*
 * OAIUpdateGameSessionInput.h
 *
 * 
 */

#ifndef OAIUpdateGameSessionInput_H
#define OAIUpdateGameSessionInput_H
...
class OAIUpdateGameSessionInput : public OAIObject {
public:
    OAIUpdateGameSessionInput();
    OAIUpdateGameSessionInput(QString json);
    ~OAIUpdateGameSessionInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateGameSessionInput)

#endif // OAIUpdateGameSessionInput_H
