...
#ifndef OAIPlacedPlayerSession_H
#define OAIPlacedPlayerSession_H
...
class OAIPlacedPlayerSession : public OAIObject {
public:
    OAIPlacedPlayerSession();
    OAIPlacedPlayerSession(QString json);
    ~OAIPlacedPlayerSession() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlacedPlayerSession)

#endif // OAIPlacedPlayerSession_H
