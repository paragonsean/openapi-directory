...
/*
 * OAIClaimGameServerInput_FilterOption.h
 *
 * 
 */

#ifndef OAIClaimGameServerInput_FilterOption_H
#define OAIClaimGameServerInput_FilterOption_H
...
class OAIClaimGameServerInput_FilterOption : public OAIObject {
public:
    OAIClaimGameServerInput_FilterOption();
    OAIClaimGameServerInput_FilterOption(QString json);
    ~OAIClaimGameServerInput_FilterOption() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClaimGameServerInput_FilterOption)

#endif // OAIClaimGameServerInput_FilterOption_H
