...
/*
 * OAICreateGameServerGroupInput_AutoScalingPolicy.h
 *
 * 
 */

#ifndef OAICreateGameServerGroupInput_AutoScalingPolicy_H
#define OAICreateGameServerGroupInput_AutoScalingPolicy_H
...
class OAICreateGameServerGroupInput_AutoScalingPolicy : public OAIObject {
public:
    OAICreateGameServerGroupInput_AutoScalingPolicy();
    OAICreateGameServerGroupInput_AutoScalingPolicy(QString json);
    ~OAICreateGameServerGroupInput_AutoScalingPolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateGameServerGroupInput_AutoScalingPolicy)

#endif // OAICreateGameServerGroupInput_AutoScalingPolicy_H
