...
/*
 * OAIListScriptsInput.h
 *
 * 
 */

#ifndef OAIListScriptsInput_H
#define OAIListScriptsInput_H
...
class OAIListScriptsInput : public OAIObject {
public:
    OAIListScriptsInput();
    OAIListScriptsInput(QString json);
    ~OAIListScriptsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListScriptsInput)

#endif // OAIListScriptsInput_H
