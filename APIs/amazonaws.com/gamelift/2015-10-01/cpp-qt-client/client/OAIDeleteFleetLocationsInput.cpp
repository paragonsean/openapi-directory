...
OAIDeleteFleetLocationsInput::OAIDeleteFleetLocationsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteFleetLocationsInput::OAIDeleteFleetLocationsInput() {
    this->initializeModel();
}

OAIDeleteFleetLocationsInput::~OAIDeleteFleetLocationsInput() {}

void OAIDeleteFleetLocationsInput::initializeModel() {
...
void OAIDeleteFleetLocationsInput::fromJson(QString jsonString) {
...
void OAIDeleteFleetLocationsInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteFleetLocationsInput::asJson() const {
...
QJsonObject OAIDeleteFleetLocationsInput::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
...
QString OAIDeleteFleetLocationsInput::getFleetId() const {
    return m_fleet_id;
}
void OAIDeleteFleetLocationsInput::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIDeleteFleetLocationsInput::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIDeleteFleetLocationsInput::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

QList OAIDeleteFleetLocationsInput::getLocations() const {
    return m_locations;
}
void OAIDeleteFleetLocationsInput::setLocations(const QList &locations) {
    m_locations = locations;
    m_locations_isSet = true;
}

bool OAIDeleteFleetLocationsInput::is_locations_Set() const{
    return m_locations_isSet;
}

bool OAIDeleteFleetLocationsInput::is_locations_Valid() const{
    return m_locations_isValid;
}

bool OAIDeleteFleetLocationsInput::isSet() const {
...
bool OAIDeleteFleetLocationsInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_fleet_id_isValid && m_locations_isValid && true;
}
