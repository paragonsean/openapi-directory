...
/*
 * OAICreateBuildOutput.h
 *
 * 
 */

#ifndef OAICreateBuildOutput_H
#define OAICreateBuildOutput_H

#include <QJsonObject>

#include "OAICreateBuildOutput_Build.h"
...
namespace OpenAPI {
class OAICreateBuildOutput_Build;
class OAICreateBuildOutput_UploadCredentials;
class OAICreateBuildOutput_StorageLocation;

class OAICreateBuildOutput : public OAIObject {
public:
    OAICreateBuildOutput();
    OAICreateBuildOutput(QString json);
    ~OAICreateBuildOutput() override;
    ...
    OAICreateBuildOutput_Build getBuild() const;
    void setBuild(const OAICreateBuildOutput_Build &build);
    bool is_build_Set() const;
    bool is_build_Valid() const;

    OAICreateBuildOutput_UploadCredentials getUploadCredentials() const;
    void setUploadCredentials(const OAICreateBuildOutput_UploadCredentials &upload_credentials);
    bool is_upload_credentials_Set() const;
    bool is_upload_credentials_Valid() const;

    OAICreateBuildOutput_StorageLocation getStorageLocation() const;
    void setStorageLocation(const OAICreateBuildOutput_StorageLocation &storage_location);
...
private:
    ...
    OAICreateBuildOutput_Build m_build;
    bool m_build_isSet;
    bool m_build_isValid;

    OAICreateBuildOutput_UploadCredentials m_upload_credentials;
    bool m_upload_credentials_isSet;
    bool m_upload_credentials_isValid;

    OAICreateBuildOutput_StorageLocation m_storage_location;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateBuildOutput)

#endif // OAICreateBuildOutput_H
