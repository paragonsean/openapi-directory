...
/*
 * OAIDescribeFleetLocationCapacityInput.h
 *
 * 
 */

#ifndef OAIDescribeFleetLocationCapacityInput_H
#define OAIDescribeFleetLocationCapacityInput_H
...
class OAIDescribeFleetLocationCapacityInput : public OAIObject {
public:
    OAIDescribeFleetLocationCapacityInput();
    OAIDescribeFleetLocationCapacityInput(QString json);
    ~OAIDescribeFleetLocationCapacityInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFleetLocationCapacityInput)

#endif // OAIDescribeFleetLocationCapacityInput_H
