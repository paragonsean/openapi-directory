...
OAIAnywhereConfiguration::OAIAnywhereConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAnywhereConfiguration::OAIAnywhereConfiguration() {
    this->initializeModel();
}

OAIAnywhereConfiguration::~OAIAnywhereConfiguration() {}

void OAIAnywhereConfiguration::initializeModel() {

    m_cost_isSet = false;
    m_cost_isValid = false;
}

void OAIAnywhereConfiguration::fromJson(QString jsonString) {
...
QJsonObject OAIAnywhereConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_cost_isSet) {
...
QString OAIAnywhereConfiguration::getCost() const {
    return m_cost;
}
void OAIAnywhereConfiguration::setCost(const QString &cost) {
    m_cost = cost;
    m_cost_isSet = true;
}

bool OAIAnywhereConfiguration::is_cost_Set() const{
    return m_cost_isSet;
}

bool OAIAnywhereConfiguration::is_cost_Valid() const{
    return m_cost_isValid;
}

bool OAIAnywhereConfiguration::isSet() const {
...
bool OAIAnywhereConfiguration::isValid() const {
