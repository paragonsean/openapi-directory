...
/*
 * OAIUpdateAliasOutput.h
 *
 * 
 */

#ifndef OAIUpdateAliasOutput_H
#define OAIUpdateAliasOutput_H
...
namespace OpenAPI {
class OAIUpdateAliasOutput_Alias;

class OAIUpdateAliasOutput : public OAIObject {
public:
    OAIUpdateAliasOutput();
    OAIUpdateAliasOutput(QString json);
    ~OAIUpdateAliasOutput() override;
    ...
    OAIUpdateAliasOutput_Alias getAlias() const;
    void setAlias(const OAIUpdateAliasOutput_Alias &alias);
...
private:
    ...
    OAIUpdateAliasOutput_Alias m_alias;
    bool m_alias_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAliasOutput)

#endif // OAIUpdateAliasOutput_H
