...
OAIDescribeFleetLocationAttributesInput::OAIDescribeFleetLocationAttributesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeFleetLocationAttributesInput::OAIDescribeFleetLocationAttributesInput() {
    this->initializeModel();
}

OAIDescribeFleetLocationAttributesInput::~OAIDescribeFleetLocationAttributesInput() {}

void OAIDescribeFleetLocationAttributesInput::initializeModel() {
...
void OAIDescribeFleetLocationAttributesInput::fromJson(QString jsonString) {
...
void OAIDescribeFleetLocationAttributesInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeFleetLocationAttributesInput::asJson() const {
...
QJsonObject OAIDescribeFleetLocationAttributesInput::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
...
QString OAIDescribeFleetLocationAttributesInput::getFleetId() const {
    return m_fleet_id;
}
void OAIDescribeFleetLocationAttributesInput::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIDescribeFleetLocationAttributesInput::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIDescribeFleetLocationAttributesInput::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

QList OAIDescribeFleetLocationAttributesInput::getLocations() const {
    return m_locations;
}
void OAIDescribeFleetLocationAttributesInput::setLocations(const QList &locations) {
    m_locations = locations;
    m_locations_isSet = true;
}

bool OAIDescribeFleetLocationAttributesInput::is_locations_Set() const{
    return m_locations_isSet;
}

bool OAIDescribeFleetLocationAttributesInput::is_locations_Valid() const{
    return m_locations_isValid;
}

qint32 OAIDescribeFleetLocationAttributesInput::getLimit() const {
    return m_limit;
}
void OAIDescribeFleetLocationAttributesInput::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIDescribeFleetLocationAttributesInput::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIDescribeFleetLocationAttributesInput::is_limit_Valid() const{
    return m_limit_isValid;
}

QString OAIDescribeFleetLocationAttributesInput::getNextToken() const {
    return m_next_token;
}
void OAIDescribeFleetLocationAttributesInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeFleetLocationAttributesInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeFleetLocationAttributesInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeFleetLocationAttributesInput::isSet() const {
...
bool OAIDescribeFleetLocationAttributesInput::isValid() const {
