...
/*
 * OAIDescribeGameSessionsOutput.h
 *
 * 
 */

#ifndef OAIDescribeGameSessionsOutput_H
#define OAIDescribeGameSessionsOutput_H
...
class OAIDescribeGameSessionsOutput : public OAIObject {
public:
    OAIDescribeGameSessionsOutput();
    OAIDescribeGameSessionsOutput(QString json);
    ~OAIDescribeGameSessionsOutput() override;
    ...
    QList getGameSessions() const;
    void setGameSessions(const QList &game_sessions);
    bool is_game_sessions_Set() const;
    bool is_game_sessions_Valid() const;
...
private:
    ...
    QList m_game_sessions;
    bool m_game_sessions_isSet;
    bool m_game_sessions_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeGameSessionsOutput)

#endif // OAIDescribeGameSessionsOutput_H
