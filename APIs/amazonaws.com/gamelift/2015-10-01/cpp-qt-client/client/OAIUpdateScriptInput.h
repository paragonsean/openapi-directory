...
/*
 * OAIUpdateScriptInput.h
 *
 * 
 */

#ifndef OAIUpdateScriptInput_H
#define OAIUpdateScriptInput_H
...
class OAIUpdateScriptInput : public OAIObject {
public:
    OAIUpdateScriptInput();
    OAIUpdateScriptInput(QString json);
    ~OAIUpdateScriptInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateScriptInput)

#endif // OAIUpdateScriptInput_H
