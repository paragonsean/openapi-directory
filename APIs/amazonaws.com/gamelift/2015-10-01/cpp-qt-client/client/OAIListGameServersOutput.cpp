...
OAIListGameServersOutput::OAIListGameServersOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListGameServersOutput::OAIListGameServersOutput() {
    this->initializeModel();
}

OAIListGameServersOutput::~OAIListGameServersOutput() {}

void OAIListGameServersOutput::initializeModel() {

    m_game_servers_isSet = false;
    m_game_servers_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIListGameServersOutput::fromJson(QString jsonString) {
...
void OAIListGameServersOutput::fromJsonObject(QJsonObject json) {

    m_game_servers_isValid = ::OpenAPI::fromJsonValue(m_game_servers, json[QString("GameServers")]);
    m_game_servers_isSet = !json[QString("GameServers")].isNull() && m_game_servers_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("NextToken")]);
    m_next_token_isSet = !json[QString("NextToken")].isNull() && m_next_token_isValid;
}

QString OAIListGameServersOutput::asJson() const {
...
QJsonObject OAIListGameServersOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_game_servers.isSet()) {
        obj.insert(QString("GameServers"), ::OpenAPI::toJsonValue(m_game_servers));
    }
...
QList OAIListGameServersOutput::getGameServers() const {
    return m_game_servers;
}
void OAIListGameServersOutput::setGameServers(const QList &game_servers) {
    m_game_servers = game_servers;
    m_game_servers_isSet = true;
}

bool OAIListGameServersOutput::is_game_servers_Set() const{
    return m_game_servers_isSet;
}

bool OAIListGameServersOutput::is_game_servers_Valid() const{
    return m_game_servers_isValid;
}

QString OAIListGameServersOutput::getNextToken() const {
    return m_next_token;
}
void OAIListGameServersOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListGameServersOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListGameServersOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListGameServersOutput::isSet() const {
...
bool OAIListGameServersOutput::isValid() const {
