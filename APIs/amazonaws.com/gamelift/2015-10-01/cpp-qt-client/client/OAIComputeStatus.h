...
#ifndef OAIComputeStatus_H
#define OAIComputeStatus_H
...
class OAIComputeStatus : public OAIEnum {
public:
    OAIComputeStatus();
    OAIComputeStatus(QString json);
    ~OAIComputeStatus() override;
    ...
    enum class eOAIComputeStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        PENDING, 
        ACTIVE, 
        TERMINATING
    };
    OAIComputeStatus::eOAIComputeStatus getValue() const;
    void setValue(const OAIComputeStatus::eOAIComputeStatus& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIComputeStatus)

#endif // OAIComputeStatus_H
