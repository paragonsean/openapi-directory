...
/*
 * OAILocationAttributes_LocationState.h
 *
 * 
 */

#ifndef OAILocationAttributes_LocationState_H
#define OAILocationAttributes_LocationState_H
...
class OAILocationAttributes_LocationState : public OAIObject {
public:
    OAILocationAttributes_LocationState();
    OAILocationAttributes_LocationState(QString json);
    ~OAILocationAttributes_LocationState() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILocationAttributes_LocationState)

#endif // OAILocationAttributes_LocationState_H
