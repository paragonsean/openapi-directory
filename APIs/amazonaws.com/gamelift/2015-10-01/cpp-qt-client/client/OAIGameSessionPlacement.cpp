...
#include "OAIGameSessionPlacement.h"
...
OAIGameSessionPlacement::OAIGameSessionPlacement(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGameSessionPlacement::OAIGameSessionPlacement() {
    this->initializeModel();
}

OAIGameSessionPlacement::~OAIGameSessionPlacement() {}

void OAIGameSessionPlacement::initializeModel() {
...
void OAIGameSessionPlacement::fromJson(QString jsonString) {
...
void OAIGameSessionPlacement::fromJsonObject(QJsonObject json) {
...
QString OAIGameSessionPlacement::asJson() const {
...
QJsonObject OAIGameSessionPlacement::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGameSessionPlacement::getPlacementId() const {
    return m_placement_id;
}
void OAIGameSessionPlacement::setPlacementId(const QString &placement_id) {
    m_placement_id = placement_id;
    m_placement_id_isSet = true;
}

bool OAIGameSessionPlacement::is_placement_id_Set() const{
    return m_placement_id_isSet;
}

bool OAIGameSessionPlacement::is_placement_id_Valid() const{
    return m_placement_id_isValid;
}

QString OAIGameSessionPlacement::getGameSessionQueueName() const {
    return m_game_session_queue_name;
}
void OAIGameSessionPlacement::setGameSessionQueueName(const QString &game_session_queue_name) {
    m_game_session_queue_name = game_session_queue_name;
    m_game_session_queue_name_isSet = true;
}

bool OAIGameSessionPlacement::is_game_session_queue_name_Set() const{
    return m_game_session_queue_name_isSet;
}

bool OAIGameSessionPlacement::is_game_session_queue_name_Valid() const{
    return m_game_session_queue_name_isValid;
}

OAIGameSessionPlacementState OAIGameSessionPlacement::getStatus() const {
    return m_status;
}
void OAIGameSessionPlacement::setStatus(const OAIGameSessionPlacementState &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGameSessionPlacement::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGameSessionPlacement::is_status_Valid() const{
    return m_status_isValid;
}

QList OAIGameSessionPlacement::getGameProperties() const {
    return m_game_properties;
}
void OAIGameSessionPlacement::setGameProperties(const QList &game_properties) {
    m_game_properties = game_properties;
    m_game_properties_isSet = true;
}

bool OAIGameSessionPlacement::is_game_properties_Set() const{
    return m_game_properties_isSet;
}

bool OAIGameSessionPlacement::is_game_properties_Valid() const{
    return m_game_properties_isValid;
}

qint32 OAIGameSessionPlacement::getMaximumPlayerSessionCount() const {
    return m_maximum_player_session_count;
}
void OAIGameSessionPlacement::setMaximumPlayerSessionCount(const qint32 &maximum_player_session_count) {
    m_maximum_player_session_count = maximum_player_session_count;
    m_maximum_player_session_count_isSet = true;
}

bool OAIGameSessionPlacement::is_maximum_player_session_count_Set() const{
    return m_maximum_player_session_count_isSet;
}

bool OAIGameSessionPlacement::is_maximum_player_session_count_Valid() const{
    return m_maximum_player_session_count_isValid;
}

QString OAIGameSessionPlacement::getGameSessionName() const {
    return m_game_session_name;
}
void OAIGameSessionPlacement::setGameSessionName(const QString &game_session_name) {
    m_game_session_name = game_session_name;
    m_game_session_name_isSet = true;
}

bool OAIGameSessionPlacement::is_game_session_name_Set() const{
    return m_game_session_name_isSet;
}

bool OAIGameSessionPlacement::is_game_session_name_Valid() const{
    return m_game_session_name_isValid;
}

QString OAIGameSessionPlacement::getGameSessionId() const {
    return m_game_session_id;
}
void OAIGameSessionPlacement::setGameSessionId(const QString &game_session_id) {
    m_game_session_id = game_session_id;
    m_game_session_id_isSet = true;
}

bool OAIGameSessionPlacement::is_game_session_id_Set() const{
    return m_game_session_id_isSet;
}

bool OAIGameSessionPlacement::is_game_session_id_Valid() const{
    return m_game_session_id_isValid;
}

QString OAIGameSessionPlacement::getGameSessionArn() const {
    return m_game_session_arn;
}
void OAIGameSessionPlacement::setGameSessionArn(const QString &game_session_arn) {
    m_game_session_arn = game_session_arn;
    m_game_session_arn_isSet = true;
}

bool OAIGameSessionPlacement::is_game_session_arn_Set() const{
    return m_game_session_arn_isSet;
}

bool OAIGameSessionPlacement::is_game_session_arn_Valid() const{
    return m_game_session_arn_isValid;
}

QString OAIGameSessionPlacement::getGameSessionRegion() const {
    return m_game_session_region;
}
void OAIGameSessionPlacement::setGameSessionRegion(const QString &game_session_region) {
    m_game_session_region = game_session_region;
    m_game_session_region_isSet = true;
}

bool OAIGameSessionPlacement::is_game_session_region_Set() const{
    return m_game_session_region_isSet;
}

bool OAIGameSessionPlacement::is_game_session_region_Valid() const{
    return m_game_session_region_isValid;
}

QList OAIGameSessionPlacement::getPlayerLatencies() const {
    return m_player_latencies;
}
void OAIGameSessionPlacement::setPlayerLatencies(const QList &player_latencies) {
    m_player_latencies = player_latencies;
    m_player_latencies_isSet = true;
}

bool OAIGameSessionPlacement::is_player_latencies_Set() const{
    return m_player_latencies_isSet;
}

bool OAIGameSessionPlacement::is_player_latencies_Valid() const{
    return m_player_latencies_isValid;
}

QDateTime OAIGameSessionPlacement::getStartTime() const {
    return m_start_time;
}
void OAIGameSessionPlacement::setStartTime(const QDateTime &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIGameSessionPlacement::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIGameSessionPlacement::is_start_time_Valid() const{
    return m_start_time_isValid;
}

QDateTime OAIGameSessionPlacement::getEndTime() const {
    return m_end_time;
}
void OAIGameSessionPlacement::setEndTime(const QDateTime &end_time) {
    m_end_time = end_time;
    m_end_time_isSet = true;
}

bool OAIGameSessionPlacement::is_end_time_Set() const{
    return m_end_time_isSet;
}

bool OAIGameSessionPlacement::is_end_time_Valid() const{
    return m_end_time_isValid;
}

QString OAIGameSessionPlacement::getIpAddress() const {
    return m_ip_address;
}
void OAIGameSessionPlacement::setIpAddress(const QString &ip_address) {
    m_ip_address = ip_address;
    m_ip_address_isSet = true;
}

bool OAIGameSessionPlacement::is_ip_address_Set() const{
    return m_ip_address_isSet;
}

bool OAIGameSessionPlacement::is_ip_address_Valid() const{
    return m_ip_address_isValid;
}

QString OAIGameSessionPlacement::getDnsName() const {
    return m_dns_name;
}
void OAIGameSessionPlacement::setDnsName(const QString &dns_name) {
    m_dns_name = dns_name;
    m_dns_name_isSet = true;
}

bool OAIGameSessionPlacement::is_dns_name_Set() const{
    return m_dns_name_isSet;
}

bool OAIGameSessionPlacement::is_dns_name_Valid() const{
    return m_dns_name_isValid;
}

qint32 OAIGameSessionPlacement::getPort() const {
    return m_port;
}
void OAIGameSessionPlacement::setPort(const qint32 &port) {
    m_port = port;
    m_port_isSet = true;
}

bool OAIGameSessionPlacement::is_port_Set() const{
    return m_port_isSet;
}

bool OAIGameSessionPlacement::is_port_Valid() const{
    return m_port_isValid;
}

QList OAIGameSessionPlacement::getPlacedPlayerSessions() const {
    return m_placed_player_sessions;
}
void OAIGameSessionPlacement::setPlacedPlayerSessions(const QList &placed_player_sessions) {
    m_placed_player_sessions = placed_player_sessions;
    m_placed_player_sessions_isSet = true;
}

bool OAIGameSessionPlacement::is_placed_player_sessions_Set() const{
    return m_placed_player_sessions_isSet;
}

bool OAIGameSessionPlacement::is_placed_player_sessions_Valid() const{
    return m_placed_player_sessions_isValid;
}

QString OAIGameSessionPlacement::getGameSessionData() const {
    return m_game_session_data;
}
void OAIGameSessionPlacement::setGameSessionData(const QString &game_session_data) {
    m_game_session_data = game_session_data;
    m_game_session_data_isSet = true;
}

bool OAIGameSessionPlacement::is_game_session_data_Set() const{
    return m_game_session_data_isSet;
}

bool OAIGameSessionPlacement::is_game_session_data_Valid() const{
    return m_game_session_data_isValid;
}

QString OAIGameSessionPlacement::getMatchmakerData() const {
    return m_matchmaker_data;
}
void OAIGameSessionPlacement::setMatchmakerData(const QString &matchmaker_data) {
    m_matchmaker_data = matchmaker_data;
    m_matchmaker_data_isSet = true;
}

bool OAIGameSessionPlacement::is_matchmaker_data_Set() const{
    return m_matchmaker_data_isSet;
}

bool OAIGameSessionPlacement::is_matchmaker_data_Valid() const{
    return m_matchmaker_data_isValid;
}

bool OAIGameSessionPlacement::isSet() const {
...
bool OAIGameSessionPlacement::isValid() const {
