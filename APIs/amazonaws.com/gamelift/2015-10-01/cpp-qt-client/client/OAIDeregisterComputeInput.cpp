...
OAIDeregisterComputeInput::OAIDeregisterComputeInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeregisterComputeInput::OAIDeregisterComputeInput() {
    this->initializeModel();
}

OAIDeregisterComputeInput::~OAIDeregisterComputeInput() {}

void OAIDeregisterComputeInput::initializeModel() {
...
void OAIDeregisterComputeInput::fromJson(QString jsonString) {
...
void OAIDeregisterComputeInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeregisterComputeInput::asJson() const {
...
QJsonObject OAIDeregisterComputeInput::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
...
QString OAIDeregisterComputeInput::getFleetId() const {
    return m_fleet_id;
}
void OAIDeregisterComputeInput::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIDeregisterComputeInput::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIDeregisterComputeInput::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

QString OAIDeregisterComputeInput::getComputeName() const {
    return m_compute_name;
}
void OAIDeregisterComputeInput::setComputeName(const QString &compute_name) {
    m_compute_name = compute_name;
    m_compute_name_isSet = true;
}

bool OAIDeregisterComputeInput::is_compute_name_Set() const{
    return m_compute_name_isSet;
}

bool OAIDeregisterComputeInput::is_compute_name_Valid() const{
    return m_compute_name_isValid;
}

bool OAIDeregisterComputeInput::isSet() const {
...
bool OAIDeregisterComputeInput::isValid() const {
