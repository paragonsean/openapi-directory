...
OAIUpdateAliasOutput::OAIUpdateAliasOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateAliasOutput::OAIUpdateAliasOutput() {
    this->initializeModel();
}

OAIUpdateAliasOutput::~OAIUpdateAliasOutput() {}

void OAIUpdateAliasOutput::initializeModel() {

    m_alias_isSet = false;
    m_alias_isValid = false;
}

void OAIUpdateAliasOutput::fromJson(QString jsonString) {
...
QJsonObject OAIUpdateAliasOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_alias.isSet()) {
...
OAIUpdateAliasOutput_Alias OAIUpdateAliasOutput::getAlias() const {
    return m_alias;
}
void OAIUpdateAliasOutput::setAlias(const OAIUpdateAliasOutput_Alias &alias) {
    m_alias = alias;
    m_alias_isSet = true;
}

bool OAIUpdateAliasOutput::is_alias_Set() const{
    return m_alias_isSet;
}

bool OAIUpdateAliasOutput::is_alias_Valid() const{
    return m_alias_isValid;
}

bool OAIUpdateAliasOutput::isSet() const {
...
bool OAIUpdateAliasOutput::isValid() const {
