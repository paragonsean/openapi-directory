...
OAICreateLocationOutput_Location::OAICreateLocationOutput_Location(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateLocationOutput_Location::OAICreateLocationOutput_Location() {
    this->initializeModel();
}

OAICreateLocationOutput_Location::~OAICreateLocationOutput_Location() {}

void OAICreateLocationOutput_Location::initializeModel() {
...
void OAICreateLocationOutput_Location::fromJson(QString jsonString) {
...
void OAICreateLocationOutput_Location::fromJsonObject(QJsonObject json) {
...
QString OAICreateLocationOutput_Location::asJson() const {
...
QJsonObject OAICreateLocationOutput_Location::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateLocationOutput_Location::getLocationName() const {
    return m_location_name;
}
void OAICreateLocationOutput_Location::setLocationName(const QString &location_name) {
    m_location_name = location_name;
    m_location_name_isSet = true;
}

bool OAICreateLocationOutput_Location::is_location_name_Set() const{
    return m_location_name_isSet;
}

bool OAICreateLocationOutput_Location::is_location_name_Valid() const{
    return m_location_name_isValid;
}

QString OAICreateLocationOutput_Location::getLocationArn() const {
    return m_location_arn;
}
void OAICreateLocationOutput_Location::setLocationArn(const QString &location_arn) {
    m_location_arn = location_arn;
    m_location_arn_isSet = true;
}

bool OAICreateLocationOutput_Location::is_location_arn_Set() const{
    return m_location_arn_isSet;
}

bool OAICreateLocationOutput_Location::is_location_arn_Valid() const{
    return m_location_arn_isValid;
}

bool OAICreateLocationOutput_Location::isSet() const {
...
bool OAICreateLocationOutput_Location::isValid() const {
