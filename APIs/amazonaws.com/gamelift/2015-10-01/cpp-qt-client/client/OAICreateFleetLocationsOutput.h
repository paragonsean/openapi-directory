...
/*
 * OAICreateFleetLocationsOutput.h
 *
 * 
 */

#ifndef OAICreateFleetLocationsOutput_H
#define OAICreateFleetLocationsOutput_H
...
class OAICreateFleetLocationsOutput : public OAIObject {
public:
    OAICreateFleetLocationsOutput();
    OAICreateFleetLocationsOutput(QString json);
    ~OAICreateFleetLocationsOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFleetLocationsOutput)

#endif // OAICreateFleetLocationsOutput_H
