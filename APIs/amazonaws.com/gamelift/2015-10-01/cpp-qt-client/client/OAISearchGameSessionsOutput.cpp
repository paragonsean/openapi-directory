...
OAISearchGameSessionsOutput::OAISearchGameSessionsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISearchGameSessionsOutput::OAISearchGameSessionsOutput() {
    this->initializeModel();
}

OAISearchGameSessionsOutput::~OAISearchGameSessionsOutput() {}

void OAISearchGameSessionsOutput::initializeModel() {
...
void OAISearchGameSessionsOutput::fromJson(QString jsonString) {
...
void OAISearchGameSessionsOutput::fromJsonObject(QJsonObject json) {
...
QString OAISearchGameSessionsOutput::asJson() const {
...
QJsonObject OAISearchGameSessionsOutput::asJsonObject() const {
    QJsonObject obj;
...
QList OAISearchGameSessionsOutput::getGameSessions() const {
    return m_game_sessions;
}
void OAISearchGameSessionsOutput::setGameSessions(const QList &game_sessions) {
    m_game_sessions = game_sessions;
    m_game_sessions_isSet = true;
}

bool OAISearchGameSessionsOutput::is_game_sessions_Set() const{
    return m_game_sessions_isSet;
}

bool OAISearchGameSessionsOutput::is_game_sessions_Valid() const{
    return m_game_sessions_isValid;
}

QString OAISearchGameSessionsOutput::getNextToken() const {
    return m_next_token;
}
void OAISearchGameSessionsOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAISearchGameSessionsOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAISearchGameSessionsOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAISearchGameSessionsOutput::isSet() const {
...
bool OAISearchGameSessionsOutput::isValid() const {
