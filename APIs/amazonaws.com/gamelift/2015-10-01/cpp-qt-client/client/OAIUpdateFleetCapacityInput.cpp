...
OAIUpdateFleetCapacityInput::OAIUpdateFleetCapacityInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateFleetCapacityInput::OAIUpdateFleetCapacityInput() {
    this->initializeModel();
}

OAIUpdateFleetCapacityInput::~OAIUpdateFleetCapacityInput() {}

void OAIUpdateFleetCapacityInput::initializeModel() {
...
void OAIUpdateFleetCapacityInput::fromJson(QString jsonString) {
...
void OAIUpdateFleetCapacityInput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateFleetCapacityInput::asJson() const {
...
QJsonObject OAIUpdateFleetCapacityInput::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
...
QString OAIUpdateFleetCapacityInput::getFleetId() const {
    return m_fleet_id;
}
void OAIUpdateFleetCapacityInput::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIUpdateFleetCapacityInput::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIUpdateFleetCapacityInput::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

qint32 OAIUpdateFleetCapacityInput::getDesiredInstances() const {
    return m_desired_instances;
}
void OAIUpdateFleetCapacityInput::setDesiredInstances(const qint32 &desired_instances) {
    m_desired_instances = desired_instances;
    m_desired_instances_isSet = true;
}

bool OAIUpdateFleetCapacityInput::is_desired_instances_Set() const{
    return m_desired_instances_isSet;
}

bool OAIUpdateFleetCapacityInput::is_desired_instances_Valid() const{
    return m_desired_instances_isValid;
}

qint32 OAIUpdateFleetCapacityInput::getMinSize() const {
    return m_min_size;
}
void OAIUpdateFleetCapacityInput::setMinSize(const qint32 &min_size) {
    m_min_size = min_size;
    m_min_size_isSet = true;
}

bool OAIUpdateFleetCapacityInput::is_min_size_Set() const{
    return m_min_size_isSet;
}

bool OAIUpdateFleetCapacityInput::is_min_size_Valid() const{
    return m_min_size_isValid;
}

qint32 OAIUpdateFleetCapacityInput::getMaxSize() const {
    return m_max_size;
}
void OAIUpdateFleetCapacityInput::setMaxSize(const qint32 &max_size) {
    m_max_size = max_size;
    m_max_size_isSet = true;
}

bool OAIUpdateFleetCapacityInput::is_max_size_Set() const{
    return m_max_size_isSet;
}

bool OAIUpdateFleetCapacityInput::is_max_size_Valid() const{
    return m_max_size_isValid;
}

QString OAIUpdateFleetCapacityInput::getLocation() const {
    return m_location;
}
void OAIUpdateFleetCapacityInput::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIUpdateFleetCapacityInput::is_location_Set() const{
    return m_location_isSet;
}

bool OAIUpdateFleetCapacityInput::is_location_Valid() const{
    return m_location_isValid;
}

bool OAIUpdateFleetCapacityInput::isSet() const {
...
bool OAIUpdateFleetCapacityInput::isValid() const {
