...
/*
 * OAICreateBuildOutput_Build.h
 *
 * 
 */

#ifndef OAICreateBuildOutput_Build_H
#define OAICreateBuildOutput_Build_H
...
class OAICreateBuildOutput_Build : public OAIObject {
public:
    OAICreateBuildOutput_Build();
    OAICreateBuildOutput_Build(QString json);
    ~OAICreateBuildOutput_Build() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateBuildOutput_Build)

#endif // OAICreateBuildOutput_Build_H
