...
/*
 * OAIListFleetsOutput.h
 *
 * 
 */

#ifndef OAIListFleetsOutput_H
#define OAIListFleetsOutput_H
...
class OAIListFleetsOutput : public OAIObject {
public:
    OAIListFleetsOutput();
    OAIListFleetsOutput(QString json);
    ~OAIListFleetsOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListFleetsOutput)

#endif // OAIListFleetsOutput_H
