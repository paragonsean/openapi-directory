...
/*
 * OAIUpdateFleetAttributesInput.h
 *
 * 
 */

#ifndef OAIUpdateFleetAttributesInput_H
#define OAIUpdateFleetAttributesInput_H
...
namespace OpenAPI {
class OAIUpdateFleetAttributesInput_ResourceCreationLimitPolicy;
class OAICreateFleetInput_AnywhereConfiguration;

class OAIUpdateFleetAttributesInput : public OAIObject {
public:
    OAIUpdateFleetAttributesInput();
    OAIUpdateFleetAttributesInput(QString json);
    ~OAIUpdateFleetAttributesInput() override;
    ...
    OAIUpdateFleetAttributesInput_ResourceCreationLimitPolicy getResourceCreationLimitPolicy() const;
    void setResourceCreationLimitPolicy(const OAIUpdateFleetAttributesInput_ResourceCreationLimitPolicy &resource_creation_limit_policy);
...
private:
    ...
    OAIUpdateFleetAttributesInput_ResourceCreationLimitPolicy m_resource_creation_limit_policy;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFleetAttributesInput)

#endif // OAIUpdateFleetAttributesInput_H
