...
OAIDescribeEC2InstanceLimitsOutput::OAIDescribeEC2InstanceLimitsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeEC2InstanceLimitsOutput::OAIDescribeEC2InstanceLimitsOutput() {
    this->initializeModel();
}

OAIDescribeEC2InstanceLimitsOutput::~OAIDescribeEC2InstanceLimitsOutput() {}

void OAIDescribeEC2InstanceLimitsOutput::initializeModel() {

    m_ec2_instance_limits_isSet = false;
    m_ec2_instance_limits_isValid = false;
}

void OAIDescribeEC2InstanceLimitsOutput::fromJson(QString jsonString) {
...
void OAIDescribeEC2InstanceLimitsOutput::fromJsonObject(QJsonObject json) {

    m_ec2_instance_limits_isValid = ::OpenAPI::fromJsonValue(m_ec2_instance_limits, json[QString("EC2InstanceLimits")]);
    m_ec2_instance_limits_isSet = !json[QString("EC2InstanceLimits")].isNull() && m_ec2_instance_limits_isValid;
}

QString OAIDescribeEC2InstanceLimitsOutput::asJson() const {
...
QJsonObject OAIDescribeEC2InstanceLimitsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_ec2_instance_limits.isSet()) {
        obj.insert(QString("EC2InstanceLimits"), ::OpenAPI::toJsonValue(m_ec2_instance_limits));
    }
    return obj;
}

QList OAIDescribeEC2InstanceLimitsOutput::getEc2InstanceLimits() const {
    return m_ec2_instance_limits;
}
void OAIDescribeEC2InstanceLimitsOutput::setEc2InstanceLimits(const QList &ec2_instance_limits) {
    m_ec2_instance_limits = ec2_instance_limits;
    m_ec2_instance_limits_isSet = true;
}

bool OAIDescribeEC2InstanceLimitsOutput::is_ec2_instance_limits_Set() const{
    return m_ec2_instance_limits_isSet;
}

bool OAIDescribeEC2InstanceLimitsOutput::is_ec2_instance_limits_Valid() const{
    return m_ec2_instance_limits_isValid;
}

bool OAIDescribeEC2InstanceLimitsOutput::isSet() const {
...
bool OAIDescribeEC2InstanceLimitsOutput::isValid() const {
