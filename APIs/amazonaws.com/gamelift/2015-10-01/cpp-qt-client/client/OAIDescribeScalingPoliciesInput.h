...
/*
 * OAIDescribeScalingPoliciesInput.h
 *
 * 
 */

#ifndef OAIDescribeScalingPoliciesInput_H
#define OAIDescribeScalingPoliciesInput_H
...
class OAIDescribeScalingPoliciesInput : public OAIObject {
public:
    OAIDescribeScalingPoliciesInput();
    OAIDescribeScalingPoliciesInput(QString json);
    ~OAIDescribeScalingPoliciesInput() override;
    ...
    OAIScalingStatusType getStatusFilter() const;
    void setStatusFilter(const OAIScalingStatusType &status_filter);
...
private:
    ...
    OAIScalingStatusType m_status_filter;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeScalingPoliciesInput)

#endif // OAIDescribeScalingPoliciesInput_H
