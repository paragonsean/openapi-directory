...
OAIGameServerGroupStatus::OAIGameServerGroupStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGameServerGroupStatus::OAIGameServerGroupStatus() {
    this->initializeModel();
}

OAIGameServerGroupStatus::~OAIGameServerGroupStatus() {}

void OAIGameServerGroupStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIGameServerGroupStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIGameServerGroupStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("NEW", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGameServerGroupStatus::NEW;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ACTIVATING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGameServerGroupStatus::ACTIVATING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ACTIVE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGameServerGroupStatus::ACTIVE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DELETE_SCHEDULED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGameServerGroupStatus::DELETE_SCHEDULED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DELETING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGameServerGroupStatus::DELETING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DELETED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGameServerGroupStatus::DELETED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ERROR", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGameServerGroupStatus::ERROR;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIGameServerGroupStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIGameServerGroupStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIGameServerGroupStatus::NEW:
            val = "NEW";
            break;
        case eOAIGameServerGroupStatus::ACTIVATING:
            val = "ACTIVATING";
            break;
        case eOAIGameServerGroupStatus::ACTIVE:
            val = "ACTIVE";
            break;
        case eOAIGameServerGroupStatus::DELETE_SCHEDULED:
            val = "DELETE_SCHEDULED";
            break;
        case eOAIGameServerGroupStatus::DELETING:
            val = "DELETING";
            break;
        case eOAIGameServerGroupStatus::DELETED:
            val = "DELETED";
            break;
        case eOAIGameServerGroupStatus::ERROR:
            val = "ERROR";
            break;
        default:
            break;
...
QJsonValue OAIGameServerGroupStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIGameServerGroupStatus::eOAIGameServerGroupStatus OAIGameServerGroupStatus::getValue() const {
    return m_value;
}

void OAIGameServerGroupStatus::setValue(const OAIGameServerGroupStatus::eOAIGameServerGroupStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIGameServerGroupStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIGameServerGroupStatus::isValid() const {
