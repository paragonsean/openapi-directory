...
/*
 * OAIUpdateGameServerGroupOutput.h
 *
 * 
 */

#ifndef OAIUpdateGameServerGroupOutput_H
#define OAIUpdateGameServerGroupOutput_H
...
namespace OpenAPI {
class OAIUpdateGameServerGroupOutput_GameServerGroup;

class OAIUpdateGameServerGroupOutput : public OAIObject {
public:
    OAIUpdateGameServerGroupOutput();
    OAIUpdateGameServerGroupOutput(QString json);
    ~OAIUpdateGameServerGroupOutput() override;
    ...
    OAIUpdateGameServerGroupOutput_GameServerGroup getGameServerGroup() const;
    void setGameServerGroup(const OAIUpdateGameServerGroupOutput_GameServerGroup &game_server_group);
...
private:
    ...
    OAIUpdateGameServerGroupOutput_GameServerGroup m_game_server_group;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateGameServerGroupOutput)

#endif // OAIUpdateGameServerGroupOutput_H
