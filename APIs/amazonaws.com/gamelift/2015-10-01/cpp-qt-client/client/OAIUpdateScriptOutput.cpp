...
OAIUpdateScriptOutput::OAIUpdateScriptOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateScriptOutput::OAIUpdateScriptOutput() {
    this->initializeModel();
}

OAIUpdateScriptOutput::~OAIUpdateScriptOutput() {}

void OAIUpdateScriptOutput::initializeModel() {

    m_script_isSet = false;
    m_script_isValid = false;
}

void OAIUpdateScriptOutput::fromJson(QString jsonString) {
...
void OAIUpdateScriptOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateScriptOutput::asJson() const {
...
QJsonObject OAIUpdateScriptOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_script.isSet()) {
...
OAIUpdateScriptOutput_Script OAIUpdateScriptOutput::getScript() const {
    return m_script;
}
void OAIUpdateScriptOutput::setScript(const OAIUpdateScriptOutput_Script &script) {
    m_script = script;
    m_script_isSet = true;
}

bool OAIUpdateScriptOutput::is_script_Set() const{
    return m_script_isSet;
}

bool OAIUpdateScriptOutput::is_script_Valid() const{
    return m_script_isValid;
}

bool OAIUpdateScriptOutput::isSet() const {
...
bool OAIUpdateScriptOutput::isValid() const {
