...
OAIScalingAdjustmentType::OAIScalingAdjustmentType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIScalingAdjustmentType::OAIScalingAdjustmentType() {
    this->initializeModel();
}

OAIScalingAdjustmentType::~OAIScalingAdjustmentType() {}

void OAIScalingAdjustmentType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIScalingAdjustmentType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIScalingAdjustmentType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ChangeInCapacity", Qt::CaseInsensitive) == 0) {
        m_value = eOAIScalingAdjustmentType::CHANGEINCAPACITY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ExactCapacity", Qt::CaseInsensitive) == 0) {
        m_value = eOAIScalingAdjustmentType::EXACTCAPACITY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("PercentChangeInCapacity", Qt::CaseInsensitive) == 0) {
        m_value = eOAIScalingAdjustmentType::PERCENTCHANGEINCAPACITY;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIScalingAdjustmentType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIScalingAdjustmentType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIScalingAdjustmentType::CHANGEINCAPACITY:
            val = "ChangeInCapacity";
            break;
        case eOAIScalingAdjustmentType::EXACTCAPACITY:
            val = "ExactCapacity";
            break;
        case eOAIScalingAdjustmentType::PERCENTCHANGEINCAPACITY:
...
QJsonValue OAIScalingAdjustmentType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIScalingAdjustmentType::eOAIScalingAdjustmentType OAIScalingAdjustmentType::getValue() const {
    return m_value;
}

void OAIScalingAdjustmentType::setValue(const OAIScalingAdjustmentType::eOAIScalingAdjustmentType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIScalingAdjustmentType::isSet() const {
    
    return m_value_isSet;
}

bool OAIScalingAdjustmentType::isValid() const {
