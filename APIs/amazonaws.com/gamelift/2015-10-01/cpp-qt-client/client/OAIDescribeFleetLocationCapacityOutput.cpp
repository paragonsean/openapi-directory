...
OAIDescribeFleetLocationCapacityOutput::OAIDescribeFleetLocationCapacityOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeFleetLocationCapacityOutput::OAIDescribeFleetLocationCapacityOutput() {
    this->initializeModel();
}

OAIDescribeFleetLocationCapacityOutput::~OAIDescribeFleetLocationCapacityOutput() {}

void OAIDescribeFleetLocationCapacityOutput::initializeModel() {

    m_fleet_capacity_isSet = false;
    m_fleet_capacity_isValid = false;
}

void OAIDescribeFleetLocationCapacityOutput::fromJson(QString jsonString) {
...
void OAIDescribeFleetLocationCapacityOutput::fromJsonObject(QJsonObject json) {

    m_fleet_capacity_isValid = ::OpenAPI::fromJsonValue(m_fleet_capacity, json[QString("FleetCapacity")]);
    m_fleet_capacity_isSet = !json[QString("FleetCapacity")].isNull() && m_fleet_capacity_isValid;
}

QString OAIDescribeFleetLocationCapacityOutput::asJson() const {
...
QJsonObject OAIDescribeFleetLocationCapacityOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_capacity.isSet()) {
        obj.insert(QString("FleetCapacity"), ::OpenAPI::toJsonValue(m_fleet_capacity));
    }
    return obj;
}

OAIDescribeFleetLocationCapacityOutput_FleetCapacity OAIDescribeFleetLocationCapacityOutput::getFleetCapacity() const {
    return m_fleet_capacity;
}
void OAIDescribeFleetLocationCapacityOutput::setFleetCapacity(const OAIDescribeFleetLocationCapacityOutput_FleetCapacity &fleet_capacity) {
    m_fleet_capacity = fleet_capacity;
    m_fleet_capacity_isSet = true;
}

bool OAIDescribeFleetLocationCapacityOutput::is_fleet_capacity_Set() const{
    return m_fleet_capacity_isSet;
}

bool OAIDescribeFleetLocationCapacityOutput::is_fleet_capacity_Valid() const{
    return m_fleet_capacity_isValid;
}

bool OAIDescribeFleetLocationCapacityOutput::isSet() const {
...
bool OAIDescribeFleetLocationCapacityOutput::isValid() const {
