...
OAIDescribeGameSessionDetailsInput::OAIDescribeGameSessionDetailsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeGameSessionDetailsInput::OAIDescribeGameSessionDetailsInput() {
    this->initializeModel();
}

OAIDescribeGameSessionDetailsInput::~OAIDescribeGameSessionDetailsInput() {}

void OAIDescribeGameSessionDetailsInput::initializeModel() {
...
void OAIDescribeGameSessionDetailsInput::fromJson(QString jsonString) {
...
void OAIDescribeGameSessionDetailsInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeGameSessionDetailsInput::asJson() const {
...
QJsonObject OAIDescribeGameSessionDetailsInput::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
...
QString OAIDescribeGameSessionDetailsInput::getFleetId() const {
    return m_fleet_id;
}
void OAIDescribeGameSessionDetailsInput::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIDescribeGameSessionDetailsInput::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIDescribeGameSessionDetailsInput::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

QString OAIDescribeGameSessionDetailsInput::getGameSessionId() const {
    return m_game_session_id;
}
void OAIDescribeGameSessionDetailsInput::setGameSessionId(const QString &game_session_id) {
    m_game_session_id = game_session_id;
    m_game_session_id_isSet = true;
}

bool OAIDescribeGameSessionDetailsInput::is_game_session_id_Set() const{
    return m_game_session_id_isSet;
}

bool OAIDescribeGameSessionDetailsInput::is_game_session_id_Valid() const{
    return m_game_session_id_isValid;
}

QString OAIDescribeGameSessionDetailsInput::getAliasId() const {
    return m_alias_id;
}
void OAIDescribeGameSessionDetailsInput::setAliasId(const QString &alias_id) {
    m_alias_id = alias_id;
    m_alias_id_isSet = true;
}

bool OAIDescribeGameSessionDetailsInput::is_alias_id_Set() const{
    return m_alias_id_isSet;
}

bool OAIDescribeGameSessionDetailsInput::is_alias_id_Valid() const{
    return m_alias_id_isValid;
}

QString OAIDescribeGameSessionDetailsInput::getLocation() const {
    return m_location;
}
void OAIDescribeGameSessionDetailsInput::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIDescribeGameSessionDetailsInput::is_location_Set() const{
    return m_location_isSet;
}

bool OAIDescribeGameSessionDetailsInput::is_location_Valid() const{
    return m_location_isValid;
}

QString OAIDescribeGameSessionDetailsInput::getStatusFilter() const {
    return m_status_filter;
}
void OAIDescribeGameSessionDetailsInput::setStatusFilter(const QString &status_filter) {
    m_status_filter = status_filter;
    m_status_filter_isSet = true;
}

bool OAIDescribeGameSessionDetailsInput::is_status_filter_Set() const{
    return m_status_filter_isSet;
}

bool OAIDescribeGameSessionDetailsInput::is_status_filter_Valid() const{
    return m_status_filter_isValid;
}

qint32 OAIDescribeGameSessionDetailsInput::getLimit() const {
    return m_limit;
}
void OAIDescribeGameSessionDetailsInput::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIDescribeGameSessionDetailsInput::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIDescribeGameSessionDetailsInput::is_limit_Valid() const{
    return m_limit_isValid;
}

QString OAIDescribeGameSessionDetailsInput::getNextToken() const {
    return m_next_token;
}
void OAIDescribeGameSessionDetailsInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeGameSessionDetailsInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeGameSessionDetailsInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeGameSessionDetailsInput::isSet() const {
...
bool OAIDescribeGameSessionDetailsInput::isValid() const {
