...
OAICreateMatchmakingRuleSetOutput::OAICreateMatchmakingRuleSetOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateMatchmakingRuleSetOutput::OAICreateMatchmakingRuleSetOutput() {
    this->initializeModel();
}

OAICreateMatchmakingRuleSetOutput::~OAICreateMatchmakingRuleSetOutput() {}

void OAICreateMatchmakingRuleSetOutput::initializeModel() {

    m_rule_set_isSet = false;
    m_rule_set_isValid = false;
}

void OAICreateMatchmakingRuleSetOutput::fromJson(QString jsonString) {
...
void OAICreateMatchmakingRuleSetOutput::fromJsonObject(QJsonObject json) {
...
QString OAICreateMatchmakingRuleSetOutput::asJson() const {
...
QJsonObject OAICreateMatchmakingRuleSetOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_rule_set.isSet()) {
...
OAICreateMatchmakingRuleSetOutput_RuleSet OAICreateMatchmakingRuleSetOutput::getRuleSet() const {
    return m_rule_set;
}
void OAICreateMatchmakingRuleSetOutput::setRuleSet(const OAICreateMatchmakingRuleSetOutput_RuleSet &rule_set) {
    m_rule_set = rule_set;
    m_rule_set_isSet = true;
}

bool OAICreateMatchmakingRuleSetOutput::is_rule_set_Set() const{
    return m_rule_set_isSet;
}

bool OAICreateMatchmakingRuleSetOutput::is_rule_set_Valid() const{
    return m_rule_set_isValid;
}

bool OAICreateMatchmakingRuleSetOutput::isSet() const {
...
bool OAICreateMatchmakingRuleSetOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_rule_set_isValid && true;
}
