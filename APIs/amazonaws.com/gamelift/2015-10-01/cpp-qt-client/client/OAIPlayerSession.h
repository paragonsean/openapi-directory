...
#ifndef OAIPlayerSession_H
#define OAIPlayerSession_H
...
class OAIPlayerSession : public OAIObject {
public:
    OAIPlayerSession();
    OAIPlayerSession(QString json);
    ~OAIPlayerSession() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlayerSession)

#endif // OAIPlayerSession_H
