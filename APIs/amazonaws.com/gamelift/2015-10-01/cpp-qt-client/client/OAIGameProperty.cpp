...
OAIGameProperty::OAIGameProperty(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGameProperty::OAIGameProperty() {
    this->initializeModel();
}

OAIGameProperty::~OAIGameProperty() {}

void OAIGameProperty::initializeModel() {
...
void OAIGameProperty::fromJson(QString jsonString) {
...
void OAIGameProperty::fromJsonObject(QJsonObject json) {
...
QString OAIGameProperty::asJson() const {
...
QJsonObject OAIGameProperty::asJsonObject() const {
    QJsonObject obj;
    if (m_key_isSet) {
...
QString OAIGameProperty::getKey() const {
    return m_key;
}
void OAIGameProperty::setKey(const QString &key) {
    m_key = key;
    m_key_isSet = true;
}

bool OAIGameProperty::is_key_Set() const{
    return m_key_isSet;
}

bool OAIGameProperty::is_key_Valid() const{
    return m_key_isValid;
}

QString OAIGameProperty::getValue() const {
    return m_value;
}
void OAIGameProperty::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIGameProperty::is_value_Set() const{
    return m_value_isSet;
}

bool OAIGameProperty::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIGameProperty::isSet() const {
...
bool OAIGameProperty::isValid() const {
