...
OAIDescribeAliasInput::OAIDescribeAliasInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeAliasInput::OAIDescribeAliasInput() {
    this->initializeModel();
}

OAIDescribeAliasInput::~OAIDescribeAliasInput() {}

void OAIDescribeAliasInput::initializeModel() {

    m_alias_id_isSet = false;
    m_alias_id_isValid = false;
}

void OAIDescribeAliasInput::fromJson(QString jsonString) {
...
void OAIDescribeAliasInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeAliasInput::asJson() const {
...
QJsonObject OAIDescribeAliasInput::asJsonObject() const {
    QJsonObject obj;
    if (m_alias_id_isSet) {
...
QString OAIDescribeAliasInput::getAliasId() const {
    return m_alias_id;
}
void OAIDescribeAliasInput::setAliasId(const QString &alias_id) {
    m_alias_id = alias_id;
    m_alias_id_isSet = true;
}

bool OAIDescribeAliasInput::is_alias_id_Set() const{
    return m_alias_id_isSet;
}

bool OAIDescribeAliasInput::is_alias_id_Valid() const{
    return m_alias_id_isValid;
}

bool OAIDescribeAliasInput::isSet() const {
...
bool OAIDescribeAliasInput::isValid() const {
