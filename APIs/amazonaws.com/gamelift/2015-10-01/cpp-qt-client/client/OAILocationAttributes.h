...
/*
 * OAILocationAttributes.h
 *
 * Details about a location in a multi-location fleet.
 */

#ifndef OAILocationAttributes_H
#define OAILocationAttributes_H
...
namespace OpenAPI {
class OAILocationAttributes_LocationState;

class OAILocationAttributes : public OAIObject {
public:
    OAILocationAttributes();
    OAILocationAttributes(QString json);
    ~OAILocationAttributes() override;
    ...
    OAILocationAttributes_LocationState getLocationState() const;
    void setLocationState(const OAILocationAttributes_LocationState &location_state);
...
private:
    ...
    OAILocationAttributes_LocationState m_location_state;
...
Q_DECLARE_METATYPE(OpenAPI::OAILocationAttributes)

#endif // OAILocationAttributes_H
