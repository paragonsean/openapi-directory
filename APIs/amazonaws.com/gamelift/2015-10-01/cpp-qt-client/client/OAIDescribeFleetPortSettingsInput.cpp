...
OAIDescribeFleetPortSettingsInput::OAIDescribeFleetPortSettingsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeFleetPortSettingsInput::OAIDescribeFleetPortSettingsInput() {
    this->initializeModel();
}

OAIDescribeFleetPortSettingsInput::~OAIDescribeFleetPortSettingsInput() {}

void OAIDescribeFleetPortSettingsInput::initializeModel() {
...
void OAIDescribeFleetPortSettingsInput::fromJson(QString jsonString) {
...
void OAIDescribeFleetPortSettingsInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeFleetPortSettingsInput::asJson() const {
...
QJsonObject OAIDescribeFleetPortSettingsInput::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
...
QString OAIDescribeFleetPortSettingsInput::getFleetId() const {
    return m_fleet_id;
}
void OAIDescribeFleetPortSettingsInput::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIDescribeFleetPortSettingsInput::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIDescribeFleetPortSettingsInput::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

QString OAIDescribeFleetPortSettingsInput::getLocation() const {
    return m_location;
}
void OAIDescribeFleetPortSettingsInput::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIDescribeFleetPortSettingsInput::is_location_Set() const{
    return m_location_isSet;
}

bool OAIDescribeFleetPortSettingsInput::is_location_Valid() const{
    return m_location_isValid;
}

bool OAIDescribeFleetPortSettingsInput::isSet() const {
...
bool OAIDescribeFleetPortSettingsInput::isValid() const {
