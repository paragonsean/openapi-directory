...
/*
 * OAIDescribeGameSessionPlacementOutput.h
 *
 * 
 */

#ifndef OAIDescribeGameSessionPlacementOutput_H
#define OAIDescribeGameSessionPlacementOutput_H
...
namespace OpenAPI {
class OAIDescribeGameSessionPlacementOutput_GameSessionPlacement;

class OAIDescribeGameSessionPlacementOutput : public OAIObject {
public:
    OAIDescribeGameSessionPlacementOutput();
    OAIDescribeGameSessionPlacementOutput(QString json);
    ~OAIDescribeGameSessionPlacementOutput() override;
    ...
    OAIDescribeGameSessionPlacementOutput_GameSessionPlacement getGameSessionPlacement() const;
    void setGameSessionPlacement(const OAIDescribeGameSessionPlacementOutput_GameSessionPlacement &game_session_placement);
...
private:
    ...
    OAIDescribeGameSessionPlacementOutput_GameSessionPlacement m_game_session_placement;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeGameSessionPlacementOutput)

#endif // OAIDescribeGameSessionPlacementOutput_H
