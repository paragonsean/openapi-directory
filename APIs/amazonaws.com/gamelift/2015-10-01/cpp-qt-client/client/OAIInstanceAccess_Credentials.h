...
/*
 * OAIInstanceAccess_Credentials.h
 *
 * 
 */

#ifndef OAIInstanceAccess_Credentials_H
#define OAIInstanceAccess_Credentials_H
...
class OAIInstanceAccess_Credentials : public OAIObject {
public:
    OAIInstanceAccess_Credentials();
    OAIInstanceAccess_Credentials(QString json);
    ~OAIInstanceAccess_Credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInstanceAccess_Credentials)

#endif // OAIInstanceAccess_Credentials_H
