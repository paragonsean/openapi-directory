...
OAIGetGameSessionLogUrlInput::OAIGetGameSessionLogUrlInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetGameSessionLogUrlInput::OAIGetGameSessionLogUrlInput() {
    this->initializeModel();
}

OAIGetGameSessionLogUrlInput::~OAIGetGameSessionLogUrlInput() {}

void OAIGetGameSessionLogUrlInput::initializeModel() {

    m_game_session_id_isSet = false;
    m_game_session_id_isValid = false;
}

void OAIGetGameSessionLogUrlInput::fromJson(QString jsonString) {
...
void OAIGetGameSessionLogUrlInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetGameSessionLogUrlInput::asJson() const {
...
QJsonObject OAIGetGameSessionLogUrlInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetGameSessionLogUrlInput::getGameSessionId() const {
    return m_game_session_id;
}
void OAIGetGameSessionLogUrlInput::setGameSessionId(const QString &game_session_id) {
    m_game_session_id = game_session_id;
    m_game_session_id_isSet = true;
}

bool OAIGetGameSessionLogUrlInput::is_game_session_id_Set() const{
    return m_game_session_id_isSet;
}

bool OAIGetGameSessionLogUrlInput::is_game_session_id_Valid() const{
    return m_game_session_id_isValid;
}

bool OAIGetGameSessionLogUrlInput::isSet() const {
...
bool OAIGetGameSessionLogUrlInput::isValid() const {
