...
#ifndef OAIAwsCredentials_H
#define OAIAwsCredentials_H
...
class OAIAwsCredentials : public OAIObject {
public:
    OAIAwsCredentials();
    OAIAwsCredentials(QString json);
    ~OAIAwsCredentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAwsCredentials)

#endif // OAIAwsCredentials_H
