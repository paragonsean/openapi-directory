...
/*
 * OAICreateVpcPeeringConnectionInput.h
 *
 * 
 */

#ifndef OAICreateVpcPeeringConnectionInput_H
#define OAICreateVpcPeeringConnectionInput_H
...
class OAICreateVpcPeeringConnectionInput : public OAIObject {
public:
    OAICreateVpcPeeringConnectionInput();
    OAICreateVpcPeeringConnectionInput(QString json);
    ~OAICreateVpcPeeringConnectionInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateVpcPeeringConnectionInput)

#endif // OAICreateVpcPeeringConnectionInput_H
