...
OAIFleetStatus::OAIFleetStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFleetStatus::OAIFleetStatus() {
    this->initializeModel();
}

OAIFleetStatus::~OAIFleetStatus() {}

void OAIFleetStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFleetStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFleetStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("NEW", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFleetStatus::NEW;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DOWNLOADING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFleetStatus::DOWNLOADING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("VALIDATING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFleetStatus::VALIDATING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("BUILDING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFleetStatus::BUILDING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ACTIVATING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFleetStatus::ACTIVATING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ACTIVE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFleetStatus::ACTIVE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DELETING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFleetStatus::DELETING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ERROR", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFleetStatus::ERROR;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("TERMINATED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFleetStatus::TERMINATED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("NOT_FOUND", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFleetStatus::NOT_FOUND;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFleetStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFleetStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFleetStatus::NEW:
            val = "NEW";
            break;
        case eOAIFleetStatus::DOWNLOADING:
            val = "DOWNLOADING";
            break;
        case eOAIFleetStatus::VALIDATING:
            val = "VALIDATING";
            break;
        case eOAIFleetStatus::BUILDING:
            val = "BUILDING";
            break;
        case eOAIFleetStatus::ACTIVATING:
            val = "ACTIVATING";
            break;
        case eOAIFleetStatus::ACTIVE:
            val = "ACTIVE";
            break;
        case eOAIFleetStatus::DELETING:
            val = "DELETING";
            break;
        case eOAIFleetStatus::ERROR:
            val = "ERROR";
            break;
        case eOAIFleetStatus::TERMINATED:
            val = "TERMINATED";
            break;
        case eOAIFleetStatus::NOT_FOUND:
            val = "NOT_FOUND";
            break;
        default:
            break;
...
QJsonValue OAIFleetStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFleetStatus::eOAIFleetStatus OAIFleetStatus::getValue() const {
    return m_value;
}

void OAIFleetStatus::setValue(const OAIFleetStatus::eOAIFleetStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFleetStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIFleetStatus::isValid() const {
