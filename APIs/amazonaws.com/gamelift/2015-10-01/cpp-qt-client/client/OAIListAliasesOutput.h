...
/*
 * OAIListAliasesOutput.h
 *
 * 
 */

#ifndef OAIListAliasesOutput_H
#define OAIListAliasesOutput_H
...
class OAIListAliasesOutput : public OAIObject {
public:
    OAIListAliasesOutput();
    OAIListAliasesOutput(QString json);
    ~OAIListAliasesOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAliasesOutput)

#endif // OAIListAliasesOutput_H
