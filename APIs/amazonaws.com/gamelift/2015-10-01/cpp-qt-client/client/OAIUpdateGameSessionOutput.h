...
/*
 * OAIUpdateGameSessionOutput.h
 *
 * 
 */

#ifndef OAIUpdateGameSessionOutput_H
#define OAIUpdateGameSessionOutput_H
...
namespace OpenAPI {
class OAIUpdateGameSessionOutput_GameSession;

class OAIUpdateGameSessionOutput : public OAIObject {
public:
    OAIUpdateGameSessionOutput();
    OAIUpdateGameSessionOutput(QString json);
    ~OAIUpdateGameSessionOutput() override;
    ...
    OAIUpdateGameSessionOutput_GameSession getGameSession() const;
    void setGameSession(const OAIUpdateGameSessionOutput_GameSession &game_session);
    bool is_game_session_Set() const;
    bool is_game_session_Valid() const;
...
private:
    ...
    OAIUpdateGameSessionOutput_GameSession m_game_session;
    bool m_game_session_isSet;
    bool m_game_session_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUpdateGameSessionOutput)

#endif // OAIUpdateGameSessionOutput_H
