...
OAIPutScalingPolicyInput_TargetConfiguration::OAIPutScalingPolicyInput_TargetConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutScalingPolicyInput_TargetConfiguration::OAIPutScalingPolicyInput_TargetConfiguration() {
    this->initializeModel();
}

OAIPutScalingPolicyInput_TargetConfiguration::~OAIPutScalingPolicyInput_TargetConfiguration() {}

void OAIPutScalingPolicyInput_TargetConfiguration::initializeModel() {

    m_target_value_isSet = false;
    m_target_value_isValid = false;
}

void OAIPutScalingPolicyInput_TargetConfiguration::fromJson(QString jsonString) {
...
void OAIPutScalingPolicyInput_TargetConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIPutScalingPolicyInput_TargetConfiguration::asJson() const {
...
QJsonObject OAIPutScalingPolicyInput_TargetConfiguration::asJsonObject() const {
    QJsonObject obj;
...
double OAIPutScalingPolicyInput_TargetConfiguration::getTargetValue() const {
    return m_target_value;
}
void OAIPutScalingPolicyInput_TargetConfiguration::setTargetValue(const double &target_value) {
    m_target_value = target_value;
    m_target_value_isSet = true;
}

bool OAIPutScalingPolicyInput_TargetConfiguration::is_target_value_Set() const{
    return m_target_value_isSet;
}

bool OAIPutScalingPolicyInput_TargetConfiguration::is_target_value_Valid() const{
    return m_target_value_isValid;
}

bool OAIPutScalingPolicyInput_TargetConfiguration::isSet() const {
...
bool OAIPutScalingPolicyInput_TargetConfiguration::isValid() const {
