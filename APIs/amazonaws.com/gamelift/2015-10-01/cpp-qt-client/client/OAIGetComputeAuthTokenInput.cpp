...
OAIGetComputeAuthTokenInput::OAIGetComputeAuthTokenInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetComputeAuthTokenInput::OAIGetComputeAuthTokenInput() {
    this->initializeModel();
}

OAIGetComputeAuthTokenInput::~OAIGetComputeAuthTokenInput() {}

void OAIGetComputeAuthTokenInput::initializeModel() {
...
void OAIGetComputeAuthTokenInput::fromJson(QString jsonString) {
...
void OAIGetComputeAuthTokenInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetComputeAuthTokenInput::asJson() const {
...
QJsonObject OAIGetComputeAuthTokenInput::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
...
QString OAIGetComputeAuthTokenInput::getFleetId() const {
    return m_fleet_id;
}
void OAIGetComputeAuthTokenInput::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIGetComputeAuthTokenInput::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIGetComputeAuthTokenInput::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

QString OAIGetComputeAuthTokenInput::getComputeName() const {
    return m_compute_name;
}
void OAIGetComputeAuthTokenInput::setComputeName(const QString &compute_name) {
    m_compute_name = compute_name;
    m_compute_name_isSet = true;
}

bool OAIGetComputeAuthTokenInput::is_compute_name_Set() const{
    return m_compute_name_isSet;
}

bool OAIGetComputeAuthTokenInput::is_compute_name_Valid() const{
    return m_compute_name_isValid;
}

bool OAIGetComputeAuthTokenInput::isSet() const {
...
bool OAIGetComputeAuthTokenInput::isValid() const {
