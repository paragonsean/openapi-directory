...
class OAIProtectionPolicy : public OAIEnum {
public:
    OAIProtectionPolicy();
    ...
    enum class eOAIProtectionPolicy {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        NOPROTECTION, 
        FULLPROTECTION
    };
    OAIProtectionPolicy::eOAIProtectionPolicy getValue() const;
    void setValue(const OAIProtectionPolicy::eOAIProtectionPolicy& value);
