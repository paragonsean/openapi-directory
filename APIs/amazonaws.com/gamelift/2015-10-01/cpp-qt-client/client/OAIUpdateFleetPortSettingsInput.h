...
/*
 * OAIUpdateFleetPortSettingsInput.h
 *
 * 
 */

#ifndef OAIUpdateFleetPortSettingsInput_H
#define OAIUpdateFleetPortSettingsInput_H
...
class OAIUpdateFleetPortSettingsInput : public OAIObject {
public:
    OAIUpdateFleetPortSettingsInput();
    OAIUpdateFleetPortSettingsInput(QString json);
    ~OAIUpdateFleetPortSettingsInput() override;
    ...
    QList getInboundPermissionAuthorizations() const;
    void setInboundPermissionAuthorizations(const QList &inbound_permission_authorizations);
    bool is_inbound_permission_authorizations_Set() const;
    bool is_inbound_permission_authorizations_Valid() const;

    QList getInboundPermissionRevocations() const;
    void setInboundPermissionRevocations(const QList &inbound_permission_revocations);
    bool is_inbound_permission_revocations_Set() const;
    bool is_inbound_permission_revocations_Valid() const;
...
private:
    ...
    QList m_inbound_permission_authorizations;
    bool m_inbound_permission_authorizations_isSet;
    bool m_inbound_permission_authorizations_isValid;

    QList m_inbound_permission_revocations;
    bool m_inbound_permission_revocations_isSet;
    bool m_inbound_permission_revocations_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFleetPortSettingsInput)

#endif // OAIUpdateFleetPortSettingsInput_H
