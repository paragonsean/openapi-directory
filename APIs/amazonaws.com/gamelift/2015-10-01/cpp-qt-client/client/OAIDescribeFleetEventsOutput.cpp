...
OAIDescribeFleetEventsOutput::OAIDescribeFleetEventsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeFleetEventsOutput::OAIDescribeFleetEventsOutput() {
    this->initializeModel();
}

OAIDescribeFleetEventsOutput::~OAIDescribeFleetEventsOutput() {}

void OAIDescribeFleetEventsOutput::initializeModel() {
...
void OAIDescribeFleetEventsOutput::fromJson(QString jsonString) {
...
void OAIDescribeFleetEventsOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeFleetEventsOutput::asJson() const {
...
QJsonObject OAIDescribeFleetEventsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_events.isSet()) {
...
QList OAIDescribeFleetEventsOutput::getEvents() const {
    return m_events;
}
void OAIDescribeFleetEventsOutput::setEvents(const QList &events) {
    m_events = events;
    m_events_isSet = true;
}

bool OAIDescribeFleetEventsOutput::is_events_Set() const{
    return m_events_isSet;
}

bool OAIDescribeFleetEventsOutput::is_events_Valid() const{
    return m_events_isValid;
}

QString OAIDescribeFleetEventsOutput::getNextToken() const {
    return m_next_token;
}
void OAIDescribeFleetEventsOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeFleetEventsOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeFleetEventsOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeFleetEventsOutput::isSet() const {
...
bool OAIDescribeFleetEventsOutput::isValid() const {
