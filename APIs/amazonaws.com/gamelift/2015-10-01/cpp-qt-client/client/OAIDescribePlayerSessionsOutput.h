...
/*
 * OAIDescribePlayerSessionsOutput.h
 *
 * 
 */

#ifndef OAIDescribePlayerSessionsOutput_H
#define OAIDescribePlayerSessionsOutput_H
...
class OAIDescribePlayerSessionsOutput : public OAIObject {
public:
    OAIDescribePlayerSessionsOutput();
    OAIDescribePlayerSessionsOutput(QString json);
    ~OAIDescribePlayerSessionsOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribePlayerSessionsOutput)

#endif // OAIDescribePlayerSessionsOutput_H
