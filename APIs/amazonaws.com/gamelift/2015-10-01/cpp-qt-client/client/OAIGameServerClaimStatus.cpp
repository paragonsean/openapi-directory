...
OAIGameServerClaimStatus::OAIGameServerClaimStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGameServerClaimStatus::OAIGameServerClaimStatus() {
    this->initializeModel();
}

OAIGameServerClaimStatus::~OAIGameServerClaimStatus() {}

void OAIGameServerClaimStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIGameServerClaimStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIGameServerClaimStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("CLAIMED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGameServerClaimStatus::CLAIMED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIGameServerClaimStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIGameServerClaimStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIGameServerClaimStatus::CLAIMED:
            val = "CLAIMED";
            break;
        default:
            break;
...
QJsonValue OAIGameServerClaimStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIGameServerClaimStatus::eOAIGameServerClaimStatus OAIGameServerClaimStatus::getValue() const {
    return m_value;
}

void OAIGameServerClaimStatus::setValue(const OAIGameServerClaimStatus::eOAIGameServerClaimStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIGameServerClaimStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIGameServerClaimStatus::isValid() const {
