...
/*
 * OAIGameServerProtectionPolicy.h
 *
 * 
 */

#ifndef OAIGameServerProtectionPolicy_H
#define OAIGameServerProtectionPolicy_H
...
class OAIGameServerProtectionPolicy : public OAIEnum {
public:
    OAIGameServerProtectionPolicy();
    OAIGameServerProtectionPolicy(QString json);
    ~OAIGameServerProtectionPolicy() override;
    ...
    enum class eOAIGameServerProtectionPolicy {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        NO_PROTECTION, 
        FULL_PROTECTION
    };
    OAIGameServerProtectionPolicy::eOAIGameServerProtectionPolicy getValue() const;
    void setValue(const OAIGameServerProtectionPolicy::eOAIGameServerProtectionPolicy& value);
...
private:
    ...
    eOAIGameServerProtectionPolicy m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGameServerProtectionPolicy)

#endif // OAIGameServerProtectionPolicy_H
