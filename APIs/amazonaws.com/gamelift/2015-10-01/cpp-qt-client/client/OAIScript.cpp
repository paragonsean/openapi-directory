...
QString OAIScript::getScriptId() const {
    return m_script_id;
}
void OAIScript::setScriptId(const QString &script_id) {
    m_script_id = script_id;
    m_script_id_isSet = true;
}

bool OAIScript::is_script_id_Set() const{
    return m_script_id_isSet;
}

bool OAIScript::is_script_id_Valid() const{
    return m_script_id_isValid;
}

QString OAIScript::getScriptArn() const {
    return m_script_arn;
}
void OAIScript::setScriptArn(const QString &script_arn) {
    m_script_arn = script_arn;
    m_script_arn_isSet = true;
}

bool OAIScript::is_script_arn_Set() const{
    return m_script_arn_isSet;
}

bool OAIScript::is_script_arn_Valid() const{
...
QString OAIScript::getVersion() const {
    return m_version;
}
void OAIScript::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIScript::is_version_Set() const{
    return m_version_isSet;
}

bool OAIScript::is_version_Valid() const{
    return m_version_isValid;
}

qint32 OAIScript::getSizeOnDisk() const {
    return m_size_on_disk;
}
void OAIScript::setSizeOnDisk(const qint32 &size_on_disk) {
    m_size_on_disk = size_on_disk;
    m_size_on_disk_isSet = true;
}

bool OAIScript::is_size_on_disk_Set() const{
    return m_size_on_disk_isSet;
}

bool OAIScript::is_size_on_disk_Valid() const{
    return m_size_on_disk_isValid;
}

QDateTime OAIScript::getCreationTime() const {
    return m_creation_time;
}
void OAIScript::setCreationTime(const QDateTime &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAIScript::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAIScript::is_creation_time_Valid() const{
    return m_creation_time_isValid;
}

OAICreateScriptInput_StorageLocation OAIScript::getStorageLocation() const {
    return m_storage_location;
}
void OAIScript::setStorageLocation(const OAICreateScriptInput_StorageLocation &storage_location) {
    m_storage_location = storage_location;
    m_storage_location_isSet = true;
}

bool OAIScript::is_storage_location_Set() const{
    return m_storage_location_isSet;
}

bool OAIScript::is_storage_location_Valid() const{
