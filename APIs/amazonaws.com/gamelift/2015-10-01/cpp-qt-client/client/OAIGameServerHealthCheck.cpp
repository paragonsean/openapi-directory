...
OAIGameServerHealthCheck::OAIGameServerHealthCheck(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGameServerHealthCheck::OAIGameServerHealthCheck() {
    this->initializeModel();
}

OAIGameServerHealthCheck::~OAIGameServerHealthCheck() {}

void OAIGameServerHealthCheck::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIGameServerHealthCheck::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIGameServerHealthCheck::fromJson(QString jsonString) {
    
    if ( jsonString.compare("HEALTHY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGameServerHealthCheck::HEALTHY;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIGameServerHealthCheck::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIGameServerHealthCheck::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIGameServerHealthCheck::HEALTHY:
            val = "HEALTHY";
            break;
        default:
            break;
...
QJsonValue OAIGameServerHealthCheck::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIGameServerHealthCheck::eOAIGameServerHealthCheck OAIGameServerHealthCheck::getValue() const {
    return m_value;
}

void OAIGameServerHealthCheck::setValue(const OAIGameServerHealthCheck::eOAIGameServerHealthCheck& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIGameServerHealthCheck::isSet() const {
    
    return m_value_isSet;
}

bool OAIGameServerHealthCheck::isValid() const {
