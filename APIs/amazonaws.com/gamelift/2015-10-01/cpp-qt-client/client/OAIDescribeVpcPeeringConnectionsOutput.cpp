...
OAIDescribeVpcPeeringConnectionsOutput::OAIDescribeVpcPeeringConnectionsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeVpcPeeringConnectionsOutput::OAIDescribeVpcPeeringConnectionsOutput() {
    this->initializeModel();
}

OAIDescribeVpcPeeringConnectionsOutput::~OAIDescribeVpcPeeringConnectionsOutput() {}

void OAIDescribeVpcPeeringConnectionsOutput::initializeModel() {

    m_vpc_peering_connections_isSet = false;
    m_vpc_peering_connections_isValid = false;
}

void OAIDescribeVpcPeeringConnectionsOutput::fromJson(QString jsonString) {
...
void OAIDescribeVpcPeeringConnectionsOutput::fromJsonObject(QJsonObject json) {

    m_vpc_peering_connections_isValid = ::OpenAPI::fromJsonValue(m_vpc_peering_connections, json[QString("VpcPeeringConnections")]);
    m_vpc_peering_connections_isSet = !json[QString("VpcPeeringConnections")].isNull() && m_vpc_peering_connections_isValid;
}

QString OAIDescribeVpcPeeringConnectionsOutput::asJson() const {
...
QJsonObject OAIDescribeVpcPeeringConnectionsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_vpc_peering_connections.isSet()) {
        obj.insert(QString("VpcPeeringConnections"), ::OpenAPI::toJsonValue(m_vpc_peering_connections));
    }
    return obj;
}

QList OAIDescribeVpcPeeringConnectionsOutput::getVpcPeeringConnections() const {
    return m_vpc_peering_connections;
}
void OAIDescribeVpcPeeringConnectionsOutput::setVpcPeeringConnections(const QList &vpc_peering_connections) {
    m_vpc_peering_connections = vpc_peering_connections;
    m_vpc_peering_connections_isSet = true;
}

bool OAIDescribeVpcPeeringConnectionsOutput::is_vpc_peering_connections_Set() const{
    return m_vpc_peering_connections_isSet;
}

bool OAIDescribeVpcPeeringConnectionsOutput::is_vpc_peering_connections_Valid() const{
    return m_vpc_peering_connections_isValid;
}

bool OAIDescribeVpcPeeringConnectionsOutput::isSet() const {
...
bool OAIDescribeVpcPeeringConnectionsOutput::isValid() const {
