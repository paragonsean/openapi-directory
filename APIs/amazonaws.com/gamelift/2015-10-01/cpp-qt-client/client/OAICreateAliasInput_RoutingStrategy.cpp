...
OAICreateAliasInput_RoutingStrategy::OAICreateAliasInput_RoutingStrategy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateAliasInput_RoutingStrategy::OAICreateAliasInput_RoutingStrategy() {
    this->initializeModel();
}

OAICreateAliasInput_RoutingStrategy::~OAICreateAliasInput_RoutingStrategy() {}

void OAICreateAliasInput_RoutingStrategy::initializeModel() {
...
void OAICreateAliasInput_RoutingStrategy::fromJson(QString jsonString) {
...
void OAICreateAliasInput_RoutingStrategy::fromJsonObject(QJsonObject json) {
...
QString OAICreateAliasInput_RoutingStrategy::asJson() const {
...
QJsonObject OAICreateAliasInput_RoutingStrategy::asJsonObject() const {
    QJsonObject obj;
    if (m_type.isSet()) {
...
OAIRoutingStrategyType OAICreateAliasInput_RoutingStrategy::getType() const {
    return m_type;
}
void OAICreateAliasInput_RoutingStrategy::setType(const OAIRoutingStrategyType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICreateAliasInput_RoutingStrategy::is_type_Set() const{
    return m_type_isSet;
}

bool OAICreateAliasInput_RoutingStrategy::is_type_Valid() const{
    return m_type_isValid;
}

QString OAICreateAliasInput_RoutingStrategy::getFleetId() const {
    return m_fleet_id;
}
void OAICreateAliasInput_RoutingStrategy::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAICreateAliasInput_RoutingStrategy::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAICreateAliasInput_RoutingStrategy::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

QString OAICreateAliasInput_RoutingStrategy::getMessage() const {
    return m_message;
}
void OAICreateAliasInput_RoutingStrategy::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAICreateAliasInput_RoutingStrategy::is_message_Set() const{
    return m_message_isSet;
}

bool OAICreateAliasInput_RoutingStrategy::is_message_Valid() const{
    return m_message_isValid;
}

bool OAICreateAliasInput_RoutingStrategy::isSet() const {
...
bool OAICreateAliasInput_RoutingStrategy::isValid() const {
