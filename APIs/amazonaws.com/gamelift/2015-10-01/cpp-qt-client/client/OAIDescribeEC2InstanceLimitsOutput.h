...
/*
 * OAIDescribeEC2InstanceLimitsOutput.h
 *
 * 
 */

#ifndef OAIDescribeEC2InstanceLimitsOutput_H
#define OAIDescribeEC2InstanceLimitsOutput_H
...
class OAIDescribeEC2InstanceLimitsOutput : public OAIObject {
public:
    OAIDescribeEC2InstanceLimitsOutput();
    OAIDescribeEC2InstanceLimitsOutput(QString json);
    ~OAIDescribeEC2InstanceLimitsOutput() override;
    ...
    QList getEc2InstanceLimits() const;
    void setEc2InstanceLimits(const QList &ec2_instance_limits);
    bool is_ec2_instance_limits_Set() const;
    bool is_ec2_instance_limits_Valid() const;
...
private:
    ...
    QList m_ec2_instance_limits;
    bool m_ec2_instance_limits_isSet;
    bool m_ec2_instance_limits_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEC2InstanceLimitsOutput)

#endif // OAIDescribeEC2InstanceLimitsOutput_H
