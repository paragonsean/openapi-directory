...
#ifndef OAIFleetType_H
#define OAIFleetType_H
...
class OAIFleetType : public OAIEnum {
public:
    OAIFleetType();
    OAIFleetType(QString json);
    ~OAIFleetType() override;
    ...
    enum class eOAIFleetType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ON_DEMAND, 
        SPOT
    };
    OAIFleetType::eOAIFleetType getValue() const;
    void setValue(const OAIFleetType::eOAIFleetType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFleetType)

#endif // OAIFleetType_H
