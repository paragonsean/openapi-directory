...
/*
 * OAIUpdateFleetPortSettingsOutput.h
 *
 * 
 */

#ifndef OAIUpdateFleetPortSettingsOutput_H
#define OAIUpdateFleetPortSettingsOutput_H
...
class OAIUpdateFleetPortSettingsOutput : public OAIObject {
public:
    OAIUpdateFleetPortSettingsOutput();
    OAIUpdateFleetPortSettingsOutput(QString json);
    ~OAIUpdateFleetPortSettingsOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFleetPortSettingsOutput)

#endif // OAIUpdateFleetPortSettingsOutput_H
