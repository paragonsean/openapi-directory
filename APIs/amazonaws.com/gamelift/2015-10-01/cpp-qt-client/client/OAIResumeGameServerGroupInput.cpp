...
OAIResumeGameServerGroupInput::OAIResumeGameServerGroupInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIResumeGameServerGroupInput::OAIResumeGameServerGroupInput() {
    this->initializeModel();
}

OAIResumeGameServerGroupInput::~OAIResumeGameServerGroupInput() {}

void OAIResumeGameServerGroupInput::initializeModel() {

    m_game_server_group_name_isSet = false;
    m_game_server_group_name_isValid = false;

    m_resume_actions_isSet = false;
    m_resume_actions_isValid = false;
}

void OAIResumeGameServerGroupInput::fromJson(QString jsonString) {
...
void OAIResumeGameServerGroupInput::fromJsonObject(QJsonObject json) {
    ...
    m_resume_actions_isValid = ::OpenAPI::fromJsonValue(m_resume_actions, json[QString("ResumeActions")]);
    m_resume_actions_isSet = !json[QString("ResumeActions")].isNull() && m_resume_actions_isValid;
}

QString OAIResumeGameServerGroupInput::asJson() const {
...
QJsonObject OAIResumeGameServerGroupInput::asJsonObject() const {
    QJsonObject obj;
    if (m_game_server_group_name_isSet) {
        obj.insert(QString("GameServerGroupName"), ::OpenAPI::toJsonValue(m_game_server_group_name));
    }
    if (m_resume_actions.isSet()) {
        obj.insert(QString("ResumeActions"), ::OpenAPI::toJsonValue(m_resume_actions));
    }
    return obj;
}

QString OAIResumeGameServerGroupInput::getGameServerGroupName() const {
    return m_game_server_group_name;
}
void OAIResumeGameServerGroupInput::setGameServerGroupName(const QString &game_server_group_name) {
    m_game_server_group_name = game_server_group_name;
    m_game_server_group_name_isSet = true;
}

bool OAIResumeGameServerGroupInput::is_game_server_group_name_Set() const{
    return m_game_server_group_name_isSet;
}

bool OAIResumeGameServerGroupInput::is_game_server_group_name_Valid() const{
    return m_game_server_group_name_isValid;
}

QList OAIResumeGameServerGroupInput::getResumeActions() const {
    return m_resume_actions;
}
void OAIResumeGameServerGroupInput::setResumeActions(const QList &resume_actions) {
    m_resume_actions = resume_actions;
    m_resume_actions_isSet = true;
}

bool OAIResumeGameServerGroupInput::is_resume_actions_Set() const{
    return m_resume_actions_isSet;
}

bool OAIResumeGameServerGroupInput::is_resume_actions_Valid() const{
    return m_resume_actions_isValid;
}

bool OAIResumeGameServerGroupInput::isSet() const {
...
bool OAIResumeGameServerGroupInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_game_server_group_name_isValid && m_resume_actions_isValid && true;
}
