...
/*
 * OAIRequestUploadCredentialsInput.h
 *
 * 
 */

#ifndef OAIRequestUploadCredentialsInput_H
#define OAIRequestUploadCredentialsInput_H
...
class OAIRequestUploadCredentialsInput : public OAIObject {
public:
    OAIRequestUploadCredentialsInput();
    OAIRequestUploadCredentialsInput(QString json);
    ~OAIRequestUploadCredentialsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRequestUploadCredentialsInput)

#endif // OAIRequestUploadCredentialsInput_H
