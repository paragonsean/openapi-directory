...
OAIListGameServerGroupsOutput::OAIListGameServerGroupsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListGameServerGroupsOutput::OAIListGameServerGroupsOutput() {
    this->initializeModel();
}

OAIListGameServerGroupsOutput::~OAIListGameServerGroupsOutput() {}

void OAIListGameServerGroupsOutput::initializeModel() {

    m_game_server_groups_isSet = false;
    m_game_server_groups_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIListGameServerGroupsOutput::fromJson(QString jsonString) {
...
void OAIListGameServerGroupsOutput::fromJsonObject(QJsonObject json) {

    m_game_server_groups_isValid = ::OpenAPI::fromJsonValue(m_game_server_groups, json[QString("GameServerGroups")]);
    m_game_server_groups_isSet = !json[QString("GameServerGroups")].isNull() && m_game_server_groups_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("NextToken")]);
    m_next_token_isSet = !json[QString("NextToken")].isNull() && m_next_token_isValid;
}

QString OAIListGameServerGroupsOutput::asJson() const {
...
QJsonObject OAIListGameServerGroupsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_game_server_groups.isSet()) {
        obj.insert(QString("GameServerGroups"), ::OpenAPI::toJsonValue(m_game_server_groups));
    }
...
QList OAIListGameServerGroupsOutput::getGameServerGroups() const {
    return m_game_server_groups;
}
void OAIListGameServerGroupsOutput::setGameServerGroups(const QList &game_server_groups) {
    m_game_server_groups = game_server_groups;
    m_game_server_groups_isSet = true;
}

bool OAIListGameServerGroupsOutput::is_game_server_groups_Set() const{
    return m_game_server_groups_isSet;
}

bool OAIListGameServerGroupsOutput::is_game_server_groups_Valid() const{
    return m_game_server_groups_isValid;
}

QString OAIListGameServerGroupsOutput::getNextToken() const {
    return m_next_token;
}
void OAIListGameServerGroupsOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListGameServerGroupsOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListGameServerGroupsOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListGameServerGroupsOutput::isSet() const {
...
bool OAIListGameServerGroupsOutput::isValid() const {
