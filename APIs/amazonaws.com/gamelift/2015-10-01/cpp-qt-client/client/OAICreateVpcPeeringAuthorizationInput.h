...
/*
 * OAICreateVpcPeeringAuthorizationInput.h
 *
 * 
 */

#ifndef OAICreateVpcPeeringAuthorizationInput_H
#define OAICreateVpcPeeringAuthorizationInput_H
...
class OAICreateVpcPeeringAuthorizationInput : public OAIObject {
public:
    OAICreateVpcPeeringAuthorizationInput();
    OAICreateVpcPeeringAuthorizationInput(QString json);
    ~OAICreateVpcPeeringAuthorizationInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateVpcPeeringAuthorizationInput)

#endif // OAICreateVpcPeeringAuthorizationInput_H
