...
OAIListScriptsInput::OAIListScriptsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListScriptsInput::OAIListScriptsInput() {
    this->initializeModel();
}

OAIListScriptsInput::~OAIListScriptsInput() {}

void OAIListScriptsInput::initializeModel() {
...
void OAIListScriptsInput::fromJson(QString jsonString) {
...
void OAIListScriptsInput::fromJsonObject(QJsonObject json) {
...
QString OAIListScriptsInput::asJson() const {
...
QJsonObject OAIListScriptsInput::asJsonObject() const {
    QJsonObject obj;
    if (m_limit_isSet) {
...
qint32 OAIListScriptsInput::getLimit() const {
    return m_limit;
}
void OAIListScriptsInput::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIListScriptsInput::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIListScriptsInput::is_limit_Valid() const{
    return m_limit_isValid;
}

QString OAIListScriptsInput::getNextToken() const {
    return m_next_token;
}
void OAIListScriptsInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListScriptsInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListScriptsInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListScriptsInput::isSet() const {
...
bool OAIListScriptsInput::isValid() const {
