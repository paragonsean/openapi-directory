...
/*
 * OAIDescribeFleetLocationCapacityOutput.h
 *
 * 
 */

#ifndef OAIDescribeFleetLocationCapacityOutput_H
#define OAIDescribeFleetLocationCapacityOutput_H

#include <QJsonObject>

#include "OAIDescribeFleetLocationCapacityOutput_FleetCapacity.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIDescribeFleetLocationCapacityOutput_FleetCapacity;

class OAIDescribeFleetLocationCapacityOutput : public OAIObject {
public:
    OAIDescribeFleetLocationCapacityOutput();
    OAIDescribeFleetLocationCapacityOutput(QString json);
    ~OAIDescribeFleetLocationCapacityOutput() override;
    ...
    OAIDescribeFleetLocationCapacityOutput_FleetCapacity getFleetCapacity() const;
    void setFleetCapacity(const OAIDescribeFleetLocationCapacityOutput_FleetCapacity &fleet_capacity);
    bool is_fleet_capacity_Set() const;
    bool is_fleet_capacity_Valid() const;
...
private:
    ...
    OAIDescribeFleetLocationCapacityOutput_FleetCapacity m_fleet_capacity;
    bool m_fleet_capacity_isSet;
    bool m_fleet_capacity_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFleetLocationCapacityOutput)

#endif // OAIDescribeFleetLocationCapacityOutput_H
