...
/*
 * OAIDescribeScriptInput.h
 *
 * 
 */

#ifndef OAIDescribeScriptInput_H
#define OAIDescribeScriptInput_H
...
class OAIDescribeScriptInput : public OAIObject {
public:
    OAIDescribeScriptInput();
    OAIDescribeScriptInput(QString json);
    ~OAIDescribeScriptInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeScriptInput)

#endif // OAIDescribeScriptInput_H
