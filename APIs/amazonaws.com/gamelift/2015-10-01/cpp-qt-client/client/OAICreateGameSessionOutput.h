...
/*
 * OAICreateGameSessionOutput.h
 *
 * 
 */

#ifndef OAICreateGameSessionOutput_H
#define OAICreateGameSessionOutput_H
...
namespace OpenAPI {
class OAICreateGameSessionOutput_GameSession;

class OAICreateGameSessionOutput : public OAIObject {
public:
    OAICreateGameSessionOutput();
    OAICreateGameSessionOutput(QString json);
    ~OAICreateGameSessionOutput() override;
    ...
    OAICreateGameSessionOutput_GameSession getGameSession() const;
    void setGameSession(const OAICreateGameSessionOutput_GameSession &game_session);
...
private:
    ...
    OAICreateGameSessionOutput_GameSession m_game_session;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateGameSessionOutput)

#endif // OAICreateGameSessionOutput_H
