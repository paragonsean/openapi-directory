...
OAIDescribeScriptOutput::OAIDescribeScriptOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeScriptOutput::OAIDescribeScriptOutput() {
    this->initializeModel();
}

OAIDescribeScriptOutput::~OAIDescribeScriptOutput() {}

void OAIDescribeScriptOutput::initializeModel() {

    m_script_isSet = false;
    m_script_isValid = false;
}

void OAIDescribeScriptOutput::fromJson(QString jsonString) {
...
void OAIDescribeScriptOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeScriptOutput::asJson() const {
...
QJsonObject OAIDescribeScriptOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_script.isSet()) {
...
OAIDescribeScriptOutput_Script OAIDescribeScriptOutput::getScript() const {
    return m_script;
}
void OAIDescribeScriptOutput::setScript(const OAIDescribeScriptOutput_Script &script) {
    m_script = script;
    m_script_isSet = true;
}

bool OAIDescribeScriptOutput::is_script_Set() const{
    return m_script_isSet;
}

bool OAIDescribeScriptOutput::is_script_Valid() const{
    return m_script_isValid;
}

bool OAIDescribeScriptOutput::isSet() const {
...
bool OAIDescribeScriptOutput::isValid() const {
