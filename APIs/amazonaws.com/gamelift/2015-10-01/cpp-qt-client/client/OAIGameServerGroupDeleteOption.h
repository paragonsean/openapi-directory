...
/*
 * OAIGameServerGroupDeleteOption.h
 *
 * 
 */

#ifndef OAIGameServerGroupDeleteOption_H
#define OAIGameServerGroupDeleteOption_H
...
class OAIGameServerGroupDeleteOption : public OAIEnum {
public:
    OAIGameServerGroupDeleteOption();
    OAIGameServerGroupDeleteOption(QString json);
    ~OAIGameServerGroupDeleteOption() override;
    ...
    enum class eOAIGameServerGroupDeleteOption {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        SAFE_DELETE, 
        FORCE_DELETE, 
        RETAIN
    };
    OAIGameServerGroupDeleteOption::eOAIGameServerGroupDeleteOption getValue() const;
    void setValue(const OAIGameServerGroupDeleteOption::eOAIGameServerGroupDeleteOption& value);
...
private:
    ...
    eOAIGameServerGroupDeleteOption m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGameServerGroupDeleteOption)

#endif // OAIGameServerGroupDeleteOption_H
