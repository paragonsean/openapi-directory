...
/*
 * OAIDescribeFleetLocationCapacityOutput_FleetCapacity.h
 *
 * 
 */

#ifndef OAIDescribeFleetLocationCapacityOutput_FleetCapacity_H
#define OAIDescribeFleetLocationCapacityOutput_FleetCapacity_H
...
namespace OpenAPI {
class OAIEC2InstanceCounts;

class OAIDescribeFleetLocationCapacityOutput_FleetCapacity : public OAIObject {
public:
    OAIDescribeFleetLocationCapacityOutput_FleetCapacity();
    OAIDescribeFleetLocationCapacityOutput_FleetCapacity(QString json);
    ~OAIDescribeFleetLocationCapacityOutput_FleetCapacity() override;
    ...
    OAIEC2InstanceCounts getInstanceCounts() const;
    void setInstanceCounts(const OAIEC2InstanceCounts &instance_counts);
    bool is_instance_counts_Set() const;
    bool is_instance_counts_Valid() const;
...
private:
    ...
    OAIEC2InstanceCounts m_instance_counts;
    bool m_instance_counts_isSet;
    bool m_instance_counts_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFleetLocationCapacityOutput_FleetCapacity)

#endif // OAIDescribeFleetLocationCapacityOutput_FleetCapacity_H
