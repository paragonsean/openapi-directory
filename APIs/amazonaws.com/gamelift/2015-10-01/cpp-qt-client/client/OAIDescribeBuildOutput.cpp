...
OAIDescribeBuildOutput::OAIDescribeBuildOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeBuildOutput::OAIDescribeBuildOutput() {
    this->initializeModel();
}

OAIDescribeBuildOutput::~OAIDescribeBuildOutput() {}

void OAIDescribeBuildOutput::initializeModel() {

    m_build_isSet = false;
    m_build_isValid = false;
}

void OAIDescribeBuildOutput::fromJson(QString jsonString) {
...
QJsonObject OAIDescribeBuildOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_build.isSet()) {
...
OAIDescribeBuildOutput_Build OAIDescribeBuildOutput::getBuild() const {
    return m_build;
}
void OAIDescribeBuildOutput::setBuild(const OAIDescribeBuildOutput_Build &build) {
    m_build = build;
    m_build_isSet = true;
}

bool OAIDescribeBuildOutput::is_build_Set() const{
    return m_build_isSet;
}

bool OAIDescribeBuildOutput::is_build_Valid() const{
    return m_build_isValid;
}

bool OAIDescribeBuildOutput::isSet() const {
...
bool OAIDescribeBuildOutput::isValid() const {
