...
/*
 * OAIUpdateGameServerOutput_GameServer.h
 *
 * 
 */

#ifndef OAIUpdateGameServerOutput_GameServer_H
#define OAIUpdateGameServerOutput_GameServer_H
...
class OAIUpdateGameServerOutput_GameServer : public OAIObject {
public:
    OAIUpdateGameServerOutput_GameServer();
    OAIUpdateGameServerOutput_GameServer(QString json);
    ~OAIUpdateGameServerOutput_GameServer() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateGameServerOutput_GameServer)

#endif // OAIUpdateGameServerOutput_GameServer_H
