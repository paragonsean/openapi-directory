...
/*
 * OAIRegisterComputeInput.h
 *
 * 
 */

#ifndef OAIRegisterComputeInput_H
#define OAIRegisterComputeInput_H
...
class OAIRegisterComputeInput : public OAIObject {
public:
    OAIRegisterComputeInput();
    OAIRegisterComputeInput(QString json);
    ~OAIRegisterComputeInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegisterComputeInput)

#endif // OAIRegisterComputeInput_H
