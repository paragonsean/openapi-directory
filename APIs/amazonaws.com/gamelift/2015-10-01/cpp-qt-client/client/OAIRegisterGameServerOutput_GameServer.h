...
/*
 * OAIRegisterGameServerOutput_GameServer.h
 *
 * 
 */

#ifndef OAIRegisterGameServerOutput_GameServer_H
#define OAIRegisterGameServerOutput_GameServer_H
...
class OAIRegisterGameServerOutput_GameServer : public OAIObject {
public:
    OAIRegisterGameServerOutput_GameServer();
    OAIRegisterGameServerOutput_GameServer(QString json);
    ~OAIRegisterGameServerOutput_GameServer() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegisterGameServerOutput_GameServer)

#endif // OAIRegisterGameServerOutput_GameServer_H
