...
/*
 * OAIDescribeFleetLocationAttributesInput.h
 *
 * 
 */

#ifndef OAIDescribeFleetLocationAttributesInput_H
#define OAIDescribeFleetLocationAttributesInput_H
...
class OAIDescribeFleetLocationAttributesInput : public OAIObject {
public:
    OAIDescribeFleetLocationAttributesInput();
    OAIDescribeFleetLocationAttributesInput(QString json);
    ~OAIDescribeFleetLocationAttributesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFleetLocationAttributesInput)

#endif // OAIDescribeFleetLocationAttributesInput_H
