...
OAIDescribePlayerSessionsOutput::OAIDescribePlayerSessionsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribePlayerSessionsOutput::OAIDescribePlayerSessionsOutput() {
    this->initializeModel();
}

OAIDescribePlayerSessionsOutput::~OAIDescribePlayerSessionsOutput() {}

void OAIDescribePlayerSessionsOutput::initializeModel() {

    m_player_sessions_isSet = false;
    m_player_sessions_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIDescribePlayerSessionsOutput::fromJson(QString jsonString) {
...
void OAIDescribePlayerSessionsOutput::fromJsonObject(QJsonObject json) {

    m_player_sessions_isValid = ::OpenAPI::fromJsonValue(m_player_sessions, json[QString("PlayerSessions")]);
    m_player_sessions_isSet = !json[QString("PlayerSessions")].isNull() && m_player_sessions_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("NextToken")]);
    m_next_token_isSet = !json[QString("NextToken")].isNull() && m_next_token_isValid;
}

QString OAIDescribePlayerSessionsOutput::asJson() const {
...
QJsonObject OAIDescribePlayerSessionsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_player_sessions.isSet()) {
        obj.insert(QString("PlayerSessions"), ::OpenAPI::toJsonValue(m_player_sessions));
    }
...
QList OAIDescribePlayerSessionsOutput::getPlayerSessions() const {
    return m_player_sessions;
}
void OAIDescribePlayerSessionsOutput::setPlayerSessions(const QList &player_sessions) {
    m_player_sessions = player_sessions;
    m_player_sessions_isSet = true;
}

bool OAIDescribePlayerSessionsOutput::is_player_sessions_Set() const{
    return m_player_sessions_isSet;
}

bool OAIDescribePlayerSessionsOutput::is_player_sessions_Valid() const{
    return m_player_sessions_isValid;
}

QString OAIDescribePlayerSessionsOutput::getNextToken() const {
    return m_next_token;
}
void OAIDescribePlayerSessionsOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribePlayerSessionsOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribePlayerSessionsOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribePlayerSessionsOutput::isSet() const {
...
bool OAIDescribePlayerSessionsOutput::isValid() const {
