...
OAIDescribeFleetCapacityInput::OAIDescribeFleetCapacityInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeFleetCapacityInput::OAIDescribeFleetCapacityInput() {
    this->initializeModel();
}

OAIDescribeFleetCapacityInput::~OAIDescribeFleetCapacityInput() {}

void OAIDescribeFleetCapacityInput::initializeModel() {
...
void OAIDescribeFleetCapacityInput::fromJson(QString jsonString) {
...
void OAIDescribeFleetCapacityInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeFleetCapacityInput::asJson() const {
...
QJsonObject OAIDescribeFleetCapacityInput::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeFleetCapacityInput::getFleetIds() const {
    return m_fleet_ids;
}
void OAIDescribeFleetCapacityInput::setFleetIds(const QList &fleet_ids) {
    m_fleet_ids = fleet_ids;
    m_fleet_ids_isSet = true;
}

bool OAIDescribeFleetCapacityInput::is_fleet_ids_Set() const{
    return m_fleet_ids_isSet;
}

bool OAIDescribeFleetCapacityInput::is_fleet_ids_Valid() const{
    return m_fleet_ids_isValid;
}

qint32 OAIDescribeFleetCapacityInput::getLimit() const {
    return m_limit;
}
void OAIDescribeFleetCapacityInput::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIDescribeFleetCapacityInput::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIDescribeFleetCapacityInput::is_limit_Valid() const{
    return m_limit_isValid;
}

QString OAIDescribeFleetCapacityInput::getNextToken() const {
    return m_next_token;
}
void OAIDescribeFleetCapacityInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeFleetCapacityInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeFleetCapacityInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeFleetCapacityInput::isSet() const {
...
bool OAIDescribeFleetCapacityInput::isValid() const {
