...
OAIDescribeInstancesInput::OAIDescribeInstancesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeInstancesInput::OAIDescribeInstancesInput() {
    this->initializeModel();
}

OAIDescribeInstancesInput::~OAIDescribeInstancesInput() {}

void OAIDescribeInstancesInput::initializeModel() {
...
void OAIDescribeInstancesInput::fromJson(QString jsonString) {
...
void OAIDescribeInstancesInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeInstancesInput::asJson() const {
...
QJsonObject OAIDescribeInstancesInput::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
...
QString OAIDescribeInstancesInput::getFleetId() const {
    return m_fleet_id;
}
void OAIDescribeInstancesInput::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIDescribeInstancesInput::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIDescribeInstancesInput::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

QString OAIDescribeInstancesInput::getInstanceId() const {
    return m_instance_id;
}
void OAIDescribeInstancesInput::setInstanceId(const QString &instance_id) {
    m_instance_id = instance_id;
    m_instance_id_isSet = true;
}

bool OAIDescribeInstancesInput::is_instance_id_Set() const{
    return m_instance_id_isSet;
}

bool OAIDescribeInstancesInput::is_instance_id_Valid() const{
    return m_instance_id_isValid;
}

qint32 OAIDescribeInstancesInput::getLimit() const {
    return m_limit;
}
void OAIDescribeInstancesInput::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIDescribeInstancesInput::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIDescribeInstancesInput::is_limit_Valid() const{
    return m_limit_isValid;
}

QString OAIDescribeInstancesInput::getNextToken() const {
    return m_next_token;
}
void OAIDescribeInstancesInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeInstancesInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeInstancesInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QString OAIDescribeInstancesInput::getLocation() const {
    return m_location;
}
void OAIDescribeInstancesInput::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIDescribeInstancesInput::is_location_Set() const{
    return m_location_isSet;
}

bool OAIDescribeInstancesInput::is_location_Valid() const{
    return m_location_isValid;
}

bool OAIDescribeInstancesInput::isSet() const {
...
bool OAIDescribeInstancesInput::isValid() const {
