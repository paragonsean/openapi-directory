...
OAIStopGameSessionPlacementInput::OAIStopGameSessionPlacementInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStopGameSessionPlacementInput::OAIStopGameSessionPlacementInput() {
    this->initializeModel();
}

OAIStopGameSessionPlacementInput::~OAIStopGameSessionPlacementInput() {}

void OAIStopGameSessionPlacementInput::initializeModel() {

    m_placement_id_isSet = false;
    m_placement_id_isValid = false;
}

void OAIStopGameSessionPlacementInput::fromJson(QString jsonString) {
...
void OAIStopGameSessionPlacementInput::fromJsonObject(QJsonObject json) {
...
QString OAIStopGameSessionPlacementInput::asJson() const {
...
QJsonObject OAIStopGameSessionPlacementInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStopGameSessionPlacementInput::getPlacementId() const {
    return m_placement_id;
}
void OAIStopGameSessionPlacementInput::setPlacementId(const QString &placement_id) {
    m_placement_id = placement_id;
    m_placement_id_isSet = true;
}

bool OAIStopGameSessionPlacementInput::is_placement_id_Set() const{
    return m_placement_id_isSet;
}

bool OAIStopGameSessionPlacementInput::is_placement_id_Valid() const{
    return m_placement_id_isValid;
}

bool OAIStopGameSessionPlacementInput::isSet() const {
...
bool OAIStopGameSessionPlacementInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_placement_id_isValid && true;
}
