...
OAIUpdateGameSessionQueueInput_FilterConfiguration::OAIUpdateGameSessionQueueInput_FilterConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateGameSessionQueueInput_FilterConfiguration::OAIUpdateGameSessionQueueInput_FilterConfiguration() {
    this->initializeModel();
}

OAIUpdateGameSessionQueueInput_FilterConfiguration::~OAIUpdateGameSessionQueueInput_FilterConfiguration() {}

void OAIUpdateGameSessionQueueInput_FilterConfiguration::initializeModel() {

    m_allowed_locations_isSet = false;
    m_allowed_locations_isValid = false;
}

void OAIUpdateGameSessionQueueInput_FilterConfiguration::fromJson(QString jsonString) {
...
void OAIUpdateGameSessionQueueInput_FilterConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateGameSessionQueueInput_FilterConfiguration::asJson() const {
...
QJsonObject OAIUpdateGameSessionQueueInput_FilterConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QList OAIUpdateGameSessionQueueInput_FilterConfiguration::getAllowedLocations() const {
    return m_allowed_locations;
}
void OAIUpdateGameSessionQueueInput_FilterConfiguration::setAllowedLocations(const QList &allowed_locations) {
    m_allowed_locations = allowed_locations;
    m_allowed_locations_isSet = true;
}

bool OAIUpdateGameSessionQueueInput_FilterConfiguration::is_allowed_locations_Set() const{
    return m_allowed_locations_isSet;
}

bool OAIUpdateGameSessionQueueInput_FilterConfiguration::is_allowed_locations_Valid() const{
    return m_allowed_locations_isValid;
}

bool OAIUpdateGameSessionQueueInput_FilterConfiguration::isSet() const {
...
bool OAIUpdateGameSessionQueueInput_FilterConfiguration::isValid() const {
