...
/*
 * OAIDescribeInstancesInput.h
 *
 * 
 */

#ifndef OAIDescribeInstancesInput_H
#define OAIDescribeInstancesInput_H
...
class OAIDescribeInstancesInput : public OAIObject {
public:
    OAIDescribeInstancesInput();
    OAIDescribeInstancesInput(QString json);
    ~OAIDescribeInstancesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeInstancesInput)

#endif // OAIDescribeInstancesInput_H
