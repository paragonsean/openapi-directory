...
/*
 * OAIPlayerLatencyPolicy.h
 *
 * Sets a latency cap for individual players when placing a game session. With a latency policy in force, a game session cannot be placed in a fleet location where a player reports latency higher than the cap. Latency policies are used only with placement request that provide player latency information. Player latency policies can be stacked to gradually relax latency requirements over time. 
 */

#ifndef OAIPlayerLatencyPolicy_H
#define OAIPlayerLatencyPolicy_H
...
class OAIPlayerLatencyPolicy : public OAIObject {
public:
    OAIPlayerLatencyPolicy();
    OAIPlayerLatencyPolicy(QString json);
    ~OAIPlayerLatencyPolicy() override;
    ...
    qint32 getMaximumIndividualPlayerLatencyMilliseconds() const;
    void setMaximumIndividualPlayerLatencyMilliseconds(const qint32 &maximum_individual_player_latency_milliseconds);
    bool is_maximum_individual_player_latency_milliseconds_Set() const;
    bool is_maximum_individual_player_latency_milliseconds_Valid() const;

    qint32 getPolicyDurationSeconds() const;
    void setPolicyDurationSeconds(const qint32 &policy_duration_seconds);
    bool is_policy_duration_seconds_Set() const;
    bool is_policy_duration_seconds_Valid() const;
...
private:
    ...
    qint32 m_maximum_individual_player_latency_milliseconds;
    bool m_maximum_individual_player_latency_milliseconds_isSet;
    bool m_maximum_individual_player_latency_milliseconds_isValid;

    qint32 m_policy_duration_seconds;
    bool m_policy_duration_seconds_isSet;
    bool m_policy_duration_seconds_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPlayerLatencyPolicy)

#endif // OAIPlayerLatencyPolicy_H
