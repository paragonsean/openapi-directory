...
OAIListLocationsOutput::OAIListLocationsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListLocationsOutput::OAIListLocationsOutput() {
    this->initializeModel();
}

OAIListLocationsOutput::~OAIListLocationsOutput() {}

void OAIListLocationsOutput::initializeModel() {
...
void OAIListLocationsOutput::fromJson(QString jsonString) {
...
void OAIListLocationsOutput::fromJsonObject(QJsonObject json) {
...
QString OAIListLocationsOutput::asJson() const {
...
QJsonObject OAIListLocationsOutput::asJsonObject() const {
    QJsonObject obj;
...
QList OAIListLocationsOutput::getLocations() const {
    return m_locations;
}
void OAIListLocationsOutput::setLocations(const QList &locations) {
    m_locations = locations;
    m_locations_isSet = true;
}

bool OAIListLocationsOutput::is_locations_Set() const{
    return m_locations_isSet;
}

bool OAIListLocationsOutput::is_locations_Valid() const{
    return m_locations_isValid;
}

QString OAIListLocationsOutput::getNextToken() const {
    return m_next_token;
}
void OAIListLocationsOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListLocationsOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListLocationsOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListLocationsOutput::isSet() const {
...
bool OAIListLocationsOutput::isValid() const {
