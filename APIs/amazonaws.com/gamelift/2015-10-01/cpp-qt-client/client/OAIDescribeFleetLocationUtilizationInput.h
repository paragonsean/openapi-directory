...
/*
 * OAIDescribeFleetLocationUtilizationInput.h
 *
 * 
 */

#ifndef OAIDescribeFleetLocationUtilizationInput_H
#define OAIDescribeFleetLocationUtilizationInput_H
...
class OAIDescribeFleetLocationUtilizationInput : public OAIObject {
public:
    OAIDescribeFleetLocationUtilizationInput();
    OAIDescribeFleetLocationUtilizationInput(QString json);
    ~OAIDescribeFleetLocationUtilizationInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFleetLocationUtilizationInput)

#endif // OAIDescribeFleetLocationUtilizationInput_H
