...
OAIListGameServerGroupsInput::OAIListGameServerGroupsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListGameServerGroupsInput::OAIListGameServerGroupsInput() {
    this->initializeModel();
}

OAIListGameServerGroupsInput::~OAIListGameServerGroupsInput() {}

void OAIListGameServerGroupsInput::initializeModel() {
...
void OAIListGameServerGroupsInput::fromJson(QString jsonString) {
...
void OAIListGameServerGroupsInput::fromJsonObject(QJsonObject json) {
...
QString OAIListGameServerGroupsInput::asJson() const {
...
QJsonObject OAIListGameServerGroupsInput::asJsonObject() const {
    QJsonObject obj;
    if (m_limit_isSet) {
...
qint32 OAIListGameServerGroupsInput::getLimit() const {
    return m_limit;
}
void OAIListGameServerGroupsInput::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIListGameServerGroupsInput::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIListGameServerGroupsInput::is_limit_Valid() const{
    return m_limit_isValid;
}

QString OAIListGameServerGroupsInput::getNextToken() const {
    return m_next_token;
}
void OAIListGameServerGroupsInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListGameServerGroupsInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListGameServerGroupsInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListGameServerGroupsInput::isSet() const {
...
bool OAIListGameServerGroupsInput::isValid() const {
