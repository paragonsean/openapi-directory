...
/*
 * OAIUpdateGameServerOutput.h
 *
 * 
 */

#ifndef OAIUpdateGameServerOutput_H
#define OAIUpdateGameServerOutput_H
...
namespace OpenAPI {
class OAIUpdateGameServerOutput_GameServer;

class OAIUpdateGameServerOutput : public OAIObject {
public:
    OAIUpdateGameServerOutput();
    OAIUpdateGameServerOutput(QString json);
    ~OAIUpdateGameServerOutput() override;
    ...
    OAIUpdateGameServerOutput_GameServer getGameServer() const;
    void setGameServer(const OAIUpdateGameServerOutput_GameServer &game_server);
...
private:
    ...
    OAIUpdateGameServerOutput_GameServer m_game_server;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateGameServerOutput)

#endif // OAIUpdateGameServerOutput_H
