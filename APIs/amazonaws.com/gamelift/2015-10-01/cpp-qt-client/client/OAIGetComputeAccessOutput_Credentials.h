...
/*
 * OAIGetComputeAccessOutput_Credentials.h
 *
 * 
 */

#ifndef OAIGetComputeAccessOutput_Credentials_H
#define OAIGetComputeAccessOutput_Credentials_H
...
class OAIGetComputeAccessOutput_Credentials : public OAIObject {
public:
    OAIGetComputeAccessOutput_Credentials();
    OAIGetComputeAccessOutput_Credentials(QString json);
    ~OAIGetComputeAccessOutput_Credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetComputeAccessOutput_Credentials)

#endif // OAIGetComputeAccessOutput_Credentials_H
