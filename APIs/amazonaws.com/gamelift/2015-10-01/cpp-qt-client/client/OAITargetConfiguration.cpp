...
#include "OAITargetConfiguration.h"
...
OAITargetConfiguration::OAITargetConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITargetConfiguration::OAITargetConfiguration() {
    this->initializeModel();
}

OAITargetConfiguration::~OAITargetConfiguration() {}

void OAITargetConfiguration::initializeModel() {

    m_target_value_isSet = false;
    m_target_value_isValid = false;
}

void OAITargetConfiguration::fromJson(QString jsonString) {
...
void OAITargetConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAITargetConfiguration::asJson() const {
...
QJsonObject OAITargetConfiguration::asJsonObject() const {
    QJsonObject obj;
...
double OAITargetConfiguration::getTargetValue() const {
    return m_target_value;
}
void OAITargetConfiguration::setTargetValue(const double &target_value) {
    m_target_value = target_value;
    m_target_value_isSet = true;
}

bool OAITargetConfiguration::is_target_value_Set() const{
    return m_target_value_isSet;
}

bool OAITargetConfiguration::is_target_value_Valid() const{
    return m_target_value_isValid;
}

bool OAITargetConfiguration::isSet() const {
...
bool OAITargetConfiguration::isValid() const {
