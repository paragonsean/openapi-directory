...
/*
 * OAIStartGameSessionPlacementOutput.h
 *
 * 
 */

#ifndef OAIStartGameSessionPlacementOutput_H
#define OAIStartGameSessionPlacementOutput_H
...
namespace OpenAPI {
class OAIStartGameSessionPlacementOutput_GameSessionPlacement;

class OAIStartGameSessionPlacementOutput : public OAIObject {
public:
    OAIStartGameSessionPlacementOutput();
    OAIStartGameSessionPlacementOutput(QString json);
    ~OAIStartGameSessionPlacementOutput() override;
    ...
    OAIStartGameSessionPlacementOutput_GameSessionPlacement getGameSessionPlacement() const;
    void setGameSessionPlacement(const OAIStartGameSessionPlacementOutput_GameSessionPlacement &game_session_placement);
...
private:
    ...
    OAIStartGameSessionPlacementOutput_GameSessionPlacement m_game_session_placement;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartGameSessionPlacementOutput)

#endif // OAIStartGameSessionPlacementOutput_H
