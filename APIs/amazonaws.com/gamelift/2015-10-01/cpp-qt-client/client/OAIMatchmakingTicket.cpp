...
#include "OAIMatchmakingTicket.h"
...
OAIMatchmakingTicket::OAIMatchmakingTicket(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMatchmakingTicket::OAIMatchmakingTicket() {
    this->initializeModel();
}

OAIMatchmakingTicket::~OAIMatchmakingTicket() {}

void OAIMatchmakingTicket::initializeModel() {
...
void OAIMatchmakingTicket::fromJson(QString jsonString) {
...
void OAIMatchmakingTicket::fromJsonObject(QJsonObject json) {
...
QString OAIMatchmakingTicket::asJson() const {
...
QJsonObject OAIMatchmakingTicket::asJsonObject() const {
    QJsonObject obj;
...
QString OAIMatchmakingTicket::getTicketId() const {
    return m_ticket_id;
}
void OAIMatchmakingTicket::setTicketId(const QString &ticket_id) {
    m_ticket_id = ticket_id;
    m_ticket_id_isSet = true;
}

bool OAIMatchmakingTicket::is_ticket_id_Set() const{
    return m_ticket_id_isSet;
}

bool OAIMatchmakingTicket::is_ticket_id_Valid() const{
    return m_ticket_id_isValid;
}

QString OAIMatchmakingTicket::getConfigurationName() const {
    return m_configuration_name;
}
void OAIMatchmakingTicket::setConfigurationName(const QString &configuration_name) {
    m_configuration_name = configuration_name;
    m_configuration_name_isSet = true;
}

bool OAIMatchmakingTicket::is_configuration_name_Set() const{
    return m_configuration_name_isSet;
}

bool OAIMatchmakingTicket::is_configuration_name_Valid() const{
    return m_configuration_name_isValid;
}

QString OAIMatchmakingTicket::getConfigurationArn() const {
    return m_configuration_arn;
}
void OAIMatchmakingTicket::setConfigurationArn(const QString &configuration_arn) {
    m_configuration_arn = configuration_arn;
    m_configuration_arn_isSet = true;
}

bool OAIMatchmakingTicket::is_configuration_arn_Set() const{
    return m_configuration_arn_isSet;
}

bool OAIMatchmakingTicket::is_configuration_arn_Valid() const{
    return m_configuration_arn_isValid;
}

OAIMatchmakingConfigurationStatus OAIMatchmakingTicket::getStatus() const {
    return m_status;
}
void OAIMatchmakingTicket::setStatus(const OAIMatchmakingConfigurationStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIMatchmakingTicket::is_status_Set() const{
    return m_status_isSet;
}

bool OAIMatchmakingTicket::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIMatchmakingTicket::getStatusReason() const {
    return m_status_reason;
}
void OAIMatchmakingTicket::setStatusReason(const QString &status_reason) {
    m_status_reason = status_reason;
    m_status_reason_isSet = true;
}

bool OAIMatchmakingTicket::is_status_reason_Set() const{
    return m_status_reason_isSet;
}

bool OAIMatchmakingTicket::is_status_reason_Valid() const{
    return m_status_reason_isValid;
}

QString OAIMatchmakingTicket::getStatusMessage() const {
    return m_status_message;
}
void OAIMatchmakingTicket::setStatusMessage(const QString &status_message) {
    m_status_message = status_message;
    m_status_message_isSet = true;
}

bool OAIMatchmakingTicket::is_status_message_Set() const{
    return m_status_message_isSet;
}

bool OAIMatchmakingTicket::is_status_message_Valid() const{
    return m_status_message_isValid;
}

QDateTime OAIMatchmakingTicket::getStartTime() const {
    return m_start_time;
}
void OAIMatchmakingTicket::setStartTime(const QDateTime &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIMatchmakingTicket::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIMatchmakingTicket::is_start_time_Valid() const{
    return m_start_time_isValid;
}

QDateTime OAIMatchmakingTicket::getEndTime() const {
    return m_end_time;
}
void OAIMatchmakingTicket::setEndTime(const QDateTime &end_time) {
    m_end_time = end_time;
    m_end_time_isSet = true;
}

bool OAIMatchmakingTicket::is_end_time_Set() const{
    return m_end_time_isSet;
}

bool OAIMatchmakingTicket::is_end_time_Valid() const{
    return m_end_time_isValid;
}

QList OAIMatchmakingTicket::getPlayers() const {
    return m_players;
}
void OAIMatchmakingTicket::setPlayers(const QList &players) {
    m_players = players;
    m_players_isSet = true;
}

bool OAIMatchmakingTicket::is_players_Set() const{
    return m_players_isSet;
}

bool OAIMatchmakingTicket::is_players_Valid() const{
    return m_players_isValid;
}

OAIMatchmakingTicket_GameSessionConnectionInfo OAIMatchmakingTicket::getGameSessionConnectionInfo() const {
    return m_game_session_connection_info;
}
void OAIMatchmakingTicket::setGameSessionConnectionInfo(const OAIMatchmakingTicket_GameSessionConnectionInfo &game_session_connection_info) {
    m_game_session_connection_info = game_session_connection_info;
    m_game_session_connection_info_isSet = true;
}

bool OAIMatchmakingTicket::is_game_session_connection_info_Set() const{
    return m_game_session_connection_info_isSet;
}

bool OAIMatchmakingTicket::is_game_session_connection_info_Valid() const{
    return m_game_session_connection_info_isValid;
}

qint32 OAIMatchmakingTicket::getEstimatedWaitTime() const {
    return m_estimated_wait_time;
}
void OAIMatchmakingTicket::setEstimatedWaitTime(const qint32 &estimated_wait_time) {
    m_estimated_wait_time = estimated_wait_time;
    m_estimated_wait_time_isSet = true;
}

bool OAIMatchmakingTicket::is_estimated_wait_time_Set() const{
    return m_estimated_wait_time_isSet;
}

bool OAIMatchmakingTicket::is_estimated_wait_time_Valid() const{
    return m_estimated_wait_time_isValid;
}

bool OAIMatchmakingTicket::isSet() const {
...
bool OAIMatchmakingTicket::isValid() const {
