...
/*
 * OAIDescribeGameSessionDetailsInput.h
 *
 * 
 */

#ifndef OAIDescribeGameSessionDetailsInput_H
#define OAIDescribeGameSessionDetailsInput_H
...
class OAIDescribeGameSessionDetailsInput : public OAIObject {
public:
    OAIDescribeGameSessionDetailsInput();
    OAIDescribeGameSessionDetailsInput(QString json);
    ~OAIDescribeGameSessionDetailsInput() override;
    ...
    void setStatusFilter(const QString &status_filter);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeGameSessionDetailsInput)

#endif // OAIDescribeGameSessionDetailsInput_H
