...
OAIFleetCapacity::OAIFleetCapacity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFleetCapacity::OAIFleetCapacity() {
    this->initializeModel();
}

OAIFleetCapacity::~OAIFleetCapacity() {}

void OAIFleetCapacity::initializeModel() {
...
void OAIFleetCapacity::fromJson(QString jsonString) {
...
void OAIFleetCapacity::fromJsonObject(QJsonObject json) {
...
QString OAIFleetCapacity::asJson() const {
...
QJsonObject OAIFleetCapacity::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
...
QString OAIFleetCapacity::getFleetId() const {
    return m_fleet_id;
}
void OAIFleetCapacity::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIFleetCapacity::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIFleetCapacity::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

QString OAIFleetCapacity::getFleetArn() const {
    return m_fleet_arn;
}
void OAIFleetCapacity::setFleetArn(const QString &fleet_arn) {
    m_fleet_arn = fleet_arn;
    m_fleet_arn_isSet = true;
}

bool OAIFleetCapacity::is_fleet_arn_Set() const{
    return m_fleet_arn_isSet;
}

bool OAIFleetCapacity::is_fleet_arn_Valid() const{
    return m_fleet_arn_isValid;
}

OAIEC2InstanceType OAIFleetCapacity::getInstanceType() const {
    return m_instance_type;
}
void OAIFleetCapacity::setInstanceType(const OAIEC2InstanceType &instance_type) {
    m_instance_type = instance_type;
    m_instance_type_isSet = true;
}

bool OAIFleetCapacity::is_instance_type_Set() const{
    return m_instance_type_isSet;
}

bool OAIFleetCapacity::is_instance_type_Valid() const{
    return m_instance_type_isValid;
}

OAIEC2InstanceCounts OAIFleetCapacity::getInstanceCounts() const {
    return m_instance_counts;
}
void OAIFleetCapacity::setInstanceCounts(const OAIEC2InstanceCounts &instance_counts) {
    m_instance_counts = instance_counts;
    m_instance_counts_isSet = true;
}

bool OAIFleetCapacity::is_instance_counts_Set() const{
    return m_instance_counts_isSet;
}

bool OAIFleetCapacity::is_instance_counts_Valid() const{
    return m_instance_counts_isValid;
}

QString OAIFleetCapacity::getLocation() const {
    return m_location;
}
void OAIFleetCapacity::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIFleetCapacity::is_location_Set() const{
    return m_location_isSet;
}

bool OAIFleetCapacity::is_location_Valid() const{
    return m_location_isValid;
}

bool OAIFleetCapacity::isSet() const {
...
bool OAIFleetCapacity::isValid() const {
