...
OAIUpdateGameSessionQueueOutput::OAIUpdateGameSessionQueueOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateGameSessionQueueOutput::OAIUpdateGameSessionQueueOutput() {
    this->initializeModel();
}

OAIUpdateGameSessionQueueOutput::~OAIUpdateGameSessionQueueOutput() {}

void OAIUpdateGameSessionQueueOutput::initializeModel() {

    m_game_session_queue_isSet = false;
    m_game_session_queue_isValid = false;
}

void OAIUpdateGameSessionQueueOutput::fromJson(QString jsonString) {
...
void OAIUpdateGameSessionQueueOutput::fromJsonObject(QJsonObject json) {

    m_game_session_queue_isValid = ::OpenAPI::fromJsonValue(m_game_session_queue, json[QString("GameSessionQueue")]);
    m_game_session_queue_isSet = !json[QString("GameSessionQueue")].isNull() && m_game_session_queue_isValid;
}

QString OAIUpdateGameSessionQueueOutput::asJson() const {
...
QJsonObject OAIUpdateGameSessionQueueOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_game_session_queue.isSet()) {
        obj.insert(QString("GameSessionQueue"), ::OpenAPI::toJsonValue(m_game_session_queue));
    }
    return obj;
}

OAIUpdateGameSessionQueueOutput_GameSessionQueue OAIUpdateGameSessionQueueOutput::getGameSessionQueue() const {
    return m_game_session_queue;
}
void OAIUpdateGameSessionQueueOutput::setGameSessionQueue(const OAIUpdateGameSessionQueueOutput_GameSessionQueue &game_session_queue) {
    m_game_session_queue = game_session_queue;
    m_game_session_queue_isSet = true;
}

bool OAIUpdateGameSessionQueueOutput::is_game_session_queue_Set() const{
    return m_game_session_queue_isSet;
}

bool OAIUpdateGameSessionQueueOutput::is_game_session_queue_Valid() const{
    return m_game_session_queue_isValid;
}

bool OAIUpdateGameSessionQueueOutput::isSet() const {
...
bool OAIUpdateGameSessionQueueOutput::isValid() const {
