...
/*
 * OAICreateFleetLocationsInput.h
 *
 * 
 */

#ifndef OAICreateFleetLocationsInput_H
#define OAICreateFleetLocationsInput_H
...
class OAICreateFleetLocationsInput : public OAIObject {
public:
    OAICreateFleetLocationsInput();
    OAICreateFleetLocationsInput(QString json);
    ~OAICreateFleetLocationsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFleetLocationsInput)

#endif // OAICreateFleetLocationsInput_H
