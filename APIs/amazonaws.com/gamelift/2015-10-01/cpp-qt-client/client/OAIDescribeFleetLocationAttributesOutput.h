...
/*
 * OAIDescribeFleetLocationAttributesOutput.h
 *
 * 
 */

#ifndef OAIDescribeFleetLocationAttributesOutput_H
#define OAIDescribeFleetLocationAttributesOutput_H
...
class OAIDescribeFleetLocationAttributesOutput : public OAIObject {
public:
    OAIDescribeFleetLocationAttributesOutput();
    OAIDescribeFleetLocationAttributesOutput(QString json);
    ~OAIDescribeFleetLocationAttributesOutput() override;
    ...
    QList getLocationAttributes() const;
    void setLocationAttributes(const QList &location_attributes);
    bool is_location_attributes_Set() const;
    bool is_location_attributes_Valid() const;
...
private:
    ...
    QList m_location_attributes;
    bool m_location_attributes_isSet;
    bool m_location_attributes_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFleetLocationAttributesOutput)

#endif // OAIDescribeFleetLocationAttributesOutput_H
