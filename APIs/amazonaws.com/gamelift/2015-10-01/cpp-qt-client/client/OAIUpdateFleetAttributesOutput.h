...
/*
 * OAIUpdateFleetAttributesOutput.h
 *
 * 
 */

#ifndef OAIUpdateFleetAttributesOutput_H
#define OAIUpdateFleetAttributesOutput_H
...
class OAIUpdateFleetAttributesOutput : public OAIObject {
public:
    OAIUpdateFleetAttributesOutput();
    OAIUpdateFleetAttributesOutput(QString json);
    ~OAIUpdateFleetAttributesOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFleetAttributesOutput)

#endif // OAIUpdateFleetAttributesOutput_H
