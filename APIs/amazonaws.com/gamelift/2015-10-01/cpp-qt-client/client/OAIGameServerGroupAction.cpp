...
#include "OAIGameServerGroupAction.h"
...
OAIGameServerGroupAction::OAIGameServerGroupAction(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGameServerGroupAction::OAIGameServerGroupAction() {
    this->initializeModel();
}

OAIGameServerGroupAction::~OAIGameServerGroupAction() {}

void OAIGameServerGroupAction::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIGameServerGroupAction::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIGameServerGroupAction::fromJson(QString jsonString) {
    
    if ( jsonString.compare("REPLACE_INSTANCE_TYPES", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGameServerGroupAction::REPLACE_INSTANCE_TYPES;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIGameServerGroupAction::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIGameServerGroupAction::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIGameServerGroupAction::REPLACE_INSTANCE_TYPES:
            val = "REPLACE_INSTANCE_TYPES";
            break;
        default:
            break;
    }
...
QJsonValue OAIGameServerGroupAction::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIGameServerGroupAction::eOAIGameServerGroupAction OAIGameServerGroupAction::getValue() const {
    return m_value;
}

void OAIGameServerGroupAction::setValue(const OAIGameServerGroupAction::eOAIGameServerGroupAction& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIGameServerGroupAction::isSet() const {
    
    return m_value_isSet;
}

bool OAIGameServerGroupAction::isValid() const {
