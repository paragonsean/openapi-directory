...
/*
 * OAICreateAliasInput.h
 *
 * 
 */

#ifndef OAICreateAliasInput_H
#define OAICreateAliasInput_H
...
class OAICreateAliasInput : public OAIObject {
public:
    OAICreateAliasInput();
    OAICreateAliasInput(QString json);
    ~OAICreateAliasInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAliasInput)

#endif // OAICreateAliasInput_H
