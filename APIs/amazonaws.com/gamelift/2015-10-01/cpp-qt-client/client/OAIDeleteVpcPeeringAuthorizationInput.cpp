...
OAIDeleteVpcPeeringAuthorizationInput::OAIDeleteVpcPeeringAuthorizationInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteVpcPeeringAuthorizationInput::OAIDeleteVpcPeeringAuthorizationInput() {
    this->initializeModel();
}

OAIDeleteVpcPeeringAuthorizationInput::~OAIDeleteVpcPeeringAuthorizationInput() {}

void OAIDeleteVpcPeeringAuthorizationInput::initializeModel() {
...
void OAIDeleteVpcPeeringAuthorizationInput::fromJson(QString jsonString) {
...
void OAIDeleteVpcPeeringAuthorizationInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteVpcPeeringAuthorizationInput::asJson() const {
...
QJsonObject OAIDeleteVpcPeeringAuthorizationInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteVpcPeeringAuthorizationInput::getGameLiftAwsAccountId() const {
    return m_game_lift_aws_account_id;
}
void OAIDeleteVpcPeeringAuthorizationInput::setGameLiftAwsAccountId(const QString &game_lift_aws_account_id) {
    m_game_lift_aws_account_id = game_lift_aws_account_id;
    m_game_lift_aws_account_id_isSet = true;
}

bool OAIDeleteVpcPeeringAuthorizationInput::is_game_lift_aws_account_id_Set() const{
    return m_game_lift_aws_account_id_isSet;
}

bool OAIDeleteVpcPeeringAuthorizationInput::is_game_lift_aws_account_id_Valid() const{
    return m_game_lift_aws_account_id_isValid;
}

QString OAIDeleteVpcPeeringAuthorizationInput::getPeerVpcId() const {
    return m_peer_vpc_id;
}
void OAIDeleteVpcPeeringAuthorizationInput::setPeerVpcId(const QString &peer_vpc_id) {
    m_peer_vpc_id = peer_vpc_id;
    m_peer_vpc_id_isSet = true;
}

bool OAIDeleteVpcPeeringAuthorizationInput::is_peer_vpc_id_Set() const{
    return m_peer_vpc_id_isSet;
}

bool OAIDeleteVpcPeeringAuthorizationInput::is_peer_vpc_id_Valid() const{
    return m_peer_vpc_id_isValid;
}

bool OAIDeleteVpcPeeringAuthorizationInput::isSet() const {
...
bool OAIDeleteVpcPeeringAuthorizationInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_game_lift_aws_account_id_isValid && m_peer_vpc_id_isValid && true;
}
