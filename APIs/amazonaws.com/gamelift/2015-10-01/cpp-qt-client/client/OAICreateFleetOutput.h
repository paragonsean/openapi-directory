...
/*
 * OAICreateFleetOutput.h
 *
 * 
 */

#ifndef OAICreateFleetOutput_H
#define OAICreateFleetOutput_H
...
namespace OpenAPI {
class OAICreateFleetOutput_FleetAttributes;

class OAICreateFleetOutput : public OAIObject {
public:
    OAICreateFleetOutput();
    OAICreateFleetOutput(QString json);
    ~OAICreateFleetOutput() override;
    ...
    OAICreateFleetOutput_FleetAttributes getFleetAttributes() const;
    void setFleetAttributes(const OAICreateFleetOutput_FleetAttributes &fleet_attributes);
    bool is_fleet_attributes_Set() const;
    bool is_fleet_attributes_Valid() const;

    QList getLocationStates() const;
    void setLocationStates(const QList &location_states);
    bool is_location_states_Set() const;
    bool is_location_states_Valid() const;
...
private:
    ...
    OAICreateFleetOutput_FleetAttributes m_fleet_attributes;
    bool m_fleet_attributes_isSet;
    bool m_fleet_attributes_isValid;

    QList m_location_states;
    bool m_location_states_isSet;
    bool m_location_states_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateFleetOutput)

#endif // OAICreateFleetOutput_H
