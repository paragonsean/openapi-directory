...
OAIAcceptanceType::OAIAcceptanceType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAcceptanceType::OAIAcceptanceType() {
    this->initializeModel();
}

OAIAcceptanceType::~OAIAcceptanceType() {}

void OAIAcceptanceType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIAcceptanceType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIAcceptanceType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ACCEPT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAcceptanceType::ACCEPT;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("REJECT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAcceptanceType::REJECT;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIAcceptanceType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIAcceptanceType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIAcceptanceType::ACCEPT:
            val = "ACCEPT";
            break;
        case eOAIAcceptanceType::REJECT:
            val = "REJECT";
            break;
        default:
            break;
...
QJsonValue OAIAcceptanceType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIAcceptanceType::eOAIAcceptanceType OAIAcceptanceType::getValue() const {
    return m_value;
}

void OAIAcceptanceType::setValue(const OAIAcceptanceType::eOAIAcceptanceType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIAcceptanceType::isSet() const {
    
    return m_value_isSet;
}

bool OAIAcceptanceType::isValid() const {
