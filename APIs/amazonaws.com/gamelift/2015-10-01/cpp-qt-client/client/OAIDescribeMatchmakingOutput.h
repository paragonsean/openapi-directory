...
/*
 * OAIDescribeMatchmakingOutput.h
 *
 * 
 */

#ifndef OAIDescribeMatchmakingOutput_H
#define OAIDescribeMatchmakingOutput_H
...
class OAIDescribeMatchmakingOutput : public OAIObject {
public:
    OAIDescribeMatchmakingOutput();
    OAIDescribeMatchmakingOutput(QString json);
    ~OAIDescribeMatchmakingOutput() override;
    ...
    QList getTicketList() const;
    void setTicketList(const QList &ticket_list);
    bool is_ticket_list_Set() const;
    bool is_ticket_list_Valid() const;
...
private:
    ...
    QList m_ticket_list;
    bool m_ticket_list_isSet;
    bool m_ticket_list_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeMatchmakingOutput)

#endif // OAIDescribeMatchmakingOutput_H
