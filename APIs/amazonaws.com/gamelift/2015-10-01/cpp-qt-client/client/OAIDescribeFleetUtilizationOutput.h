...
/*
 * OAIDescribeFleetUtilizationOutput.h
 *
 * 
 */

#ifndef OAIDescribeFleetUtilizationOutput_H
#define OAIDescribeFleetUtilizationOutput_H
...
class OAIDescribeFleetUtilizationOutput : public OAIObject {
public:
    OAIDescribeFleetUtilizationOutput();
    OAIDescribeFleetUtilizationOutput(QString json);
    ~OAIDescribeFleetUtilizationOutput() override;
    ...
    QList getFleetUtilization() const;
    void setFleetUtilization(const QList &fleet_utilization);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFleetUtilizationOutput)

#endif // OAIDescribeFleetUtilizationOutput_H
