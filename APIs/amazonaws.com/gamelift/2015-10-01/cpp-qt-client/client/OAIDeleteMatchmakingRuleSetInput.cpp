...
OAIDeleteMatchmakingRuleSetInput::OAIDeleteMatchmakingRuleSetInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteMatchmakingRuleSetInput::OAIDeleteMatchmakingRuleSetInput() {
    this->initializeModel();
}

OAIDeleteMatchmakingRuleSetInput::~OAIDeleteMatchmakingRuleSetInput() {}

void OAIDeleteMatchmakingRuleSetInput::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;
}

void OAIDeleteMatchmakingRuleSetInput::fromJson(QString jsonString) {
...
void OAIDeleteMatchmakingRuleSetInput::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("Name")]);
    m_name_isSet = !json[QString("Name")].isNull() && m_name_isValid;
}

QString OAIDeleteMatchmakingRuleSetInput::asJson() const {
...
QJsonObject OAIDeleteMatchmakingRuleSetInput::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIDeleteMatchmakingRuleSetInput::getName() const {
    return m_name;
}
void OAIDeleteMatchmakingRuleSetInput::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDeleteMatchmakingRuleSetInput::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDeleteMatchmakingRuleSetInput::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIDeleteMatchmakingRuleSetInput::isSet() const {
...
bool OAIDeleteMatchmakingRuleSetInput::isValid() const {
