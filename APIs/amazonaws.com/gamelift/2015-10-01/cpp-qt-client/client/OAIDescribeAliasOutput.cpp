...
OAIDescribeAliasOutput::OAIDescribeAliasOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeAliasOutput::OAIDescribeAliasOutput() {
    this->initializeModel();
}

OAIDescribeAliasOutput::~OAIDescribeAliasOutput() {}

void OAIDescribeAliasOutput::initializeModel() {

    m_alias_isSet = false;
    m_alias_isValid = false;
}

void OAIDescribeAliasOutput::fromJson(QString jsonString) {
...
QJsonObject OAIDescribeAliasOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_alias.isSet()) {
...
OAIDescribeAliasOutput_Alias OAIDescribeAliasOutput::getAlias() const {
    return m_alias;
}
void OAIDescribeAliasOutput::setAlias(const OAIDescribeAliasOutput_Alias &alias) {
    m_alias = alias;
    m_alias_isSet = true;
}

bool OAIDescribeAliasOutput::is_alias_Set() const{
    return m_alias_isSet;
}

bool OAIDescribeAliasOutput::is_alias_Valid() const{
    return m_alias_isValid;
}

bool OAIDescribeAliasOutput::isSet() const {
...
bool OAIDescribeAliasOutput::isValid() const {
