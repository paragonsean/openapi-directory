...
/*
 * OAICreateGameServerGroupOutput.h
 *
 * 
 */

#ifndef OAICreateGameServerGroupOutput_H
#define OAICreateGameServerGroupOutput_H
...
namespace OpenAPI {
class OAICreateGameServerGroupOutput_GameServerGroup;

class OAICreateGameServerGroupOutput : public OAIObject {
public:
    OAICreateGameServerGroupOutput();
    OAICreateGameServerGroupOutput(QString json);
    ~OAICreateGameServerGroupOutput() override;
    ...
    OAICreateGameServerGroupOutput_GameServerGroup getGameServerGroup() const;
    void setGameServerGroup(const OAICreateGameServerGroupOutput_GameServerGroup &game_server_group);
...
private:
    ...
    OAICreateGameServerGroupOutput_GameServerGroup m_game_server_group;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateGameServerGroupOutput)

#endif // OAICreateGameServerGroupOutput_H
