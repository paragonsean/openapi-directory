...
OAIIpProtocol::OAIIpProtocol(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIpProtocol::OAIIpProtocol() {
    this->initializeModel();
}

OAIIpProtocol::~OAIIpProtocol() {}

void OAIIpProtocol::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIIpProtocol::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIIpProtocol::fromJson(QString jsonString) {
    
    if ( jsonString.compare("TCP", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIpProtocol::TCP;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("UDP", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIpProtocol::UDP;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIIpProtocol::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIIpProtocol::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIIpProtocol::TCP:
            val = "TCP";
            break;
        case eOAIIpProtocol::UDP:
            val = "UDP";
            break;
        default:
            break;
...
QJsonValue OAIIpProtocol::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIIpProtocol::eOAIIpProtocol OAIIpProtocol::getValue() const {
    return m_value;
}

void OAIIpProtocol::setValue(const OAIIpProtocol::eOAIIpProtocol& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIIpProtocol::isSet() const {
    
    return m_value_isSet;
}

bool OAIIpProtocol::isValid() const {
