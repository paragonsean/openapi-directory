...
/*
 * OAIGetComputeAuthTokenOutput.h
 *
 * 
 */

#ifndef OAIGetComputeAuthTokenOutput_H
#define OAIGetComputeAuthTokenOutput_H
...
class OAIGetComputeAuthTokenOutput : public OAIObject {
public:
    OAIGetComputeAuthTokenOutput();
    OAIGetComputeAuthTokenOutput(QString json);
    ~OAIGetComputeAuthTokenOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetComputeAuthTokenOutput)

#endif // OAIGetComputeAuthTokenOutput_H
