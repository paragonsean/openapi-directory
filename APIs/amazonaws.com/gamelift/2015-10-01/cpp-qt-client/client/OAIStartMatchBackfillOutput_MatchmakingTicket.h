...
/*
 * OAIStartMatchBackfillOutput_MatchmakingTicket.h
 *
 * 
 */

#ifndef OAIStartMatchBackfillOutput_MatchmakingTicket_H
#define OAIStartMatchBackfillOutput_MatchmakingTicket_H
...
class OAIStartMatchBackfillOutput_MatchmakingTicket : public OAIObject {
public:
    OAIStartMatchBackfillOutput_MatchmakingTicket();
    OAIStartMatchBackfillOutput_MatchmakingTicket(QString json);
    ~OAIStartMatchBackfillOutput_MatchmakingTicket() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartMatchBackfillOutput_MatchmakingTicket)

#endif // OAIStartMatchBackfillOutput_MatchmakingTicket_H
