...
/*
 * OAIAnywhereConfiguration.h
 *
 * Amazon GameLift Anywhere configuration options for your Anywhere fleets.
 */

#ifndef OAIAnywhereConfiguration_H
#define OAIAnywhereConfiguration_H
...
class OAIAnywhereConfiguration : public OAIObject {
public:
    OAIAnywhereConfiguration();
    OAIAnywhereConfiguration(QString json);
    ~OAIAnywhereConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAnywhereConfiguration)

#endif // OAIAnywhereConfiguration_H
