...
OAIPlayerSessionCreationPolicy::OAIPlayerSessionCreationPolicy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPlayerSessionCreationPolicy::OAIPlayerSessionCreationPolicy() {
    this->initializeModel();
}

OAIPlayerSessionCreationPolicy::~OAIPlayerSessionCreationPolicy() {}

void OAIPlayerSessionCreationPolicy::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIPlayerSessionCreationPolicy::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIPlayerSessionCreationPolicy::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ACCEPT_ALL", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPlayerSessionCreationPolicy::ACCEPT_ALL;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DENY_ALL", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPlayerSessionCreationPolicy::DENY_ALL;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIPlayerSessionCreationPolicy::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIPlayerSessionCreationPolicy::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIPlayerSessionCreationPolicy::ACCEPT_ALL:
            val = "ACCEPT_ALL";
            break;
        case eOAIPlayerSessionCreationPolicy::DENY_ALL:
            val = "DENY_ALL";
            break;
        default:
            break;
...
QJsonValue OAIPlayerSessionCreationPolicy::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIPlayerSessionCreationPolicy::eOAIPlayerSessionCreationPolicy OAIPlayerSessionCreationPolicy::getValue() const {
    return m_value;
}

void OAIPlayerSessionCreationPolicy::setValue(const OAIPlayerSessionCreationPolicy::eOAIPlayerSessionCreationPolicy& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIPlayerSessionCreationPolicy::isSet() const {
    
    return m_value_isSet;
}

bool OAIPlayerSessionCreationPolicy::isValid() const {
