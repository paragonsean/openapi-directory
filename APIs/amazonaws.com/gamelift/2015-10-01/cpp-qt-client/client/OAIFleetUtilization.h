...
#ifndef OAIFleetUtilization_H
#define OAIFleetUtilization_H
...
class OAIFleetUtilization : public OAIObject {
public:
    OAIFleetUtilization();
    OAIFleetUtilization(QString json);
    ~OAIFleetUtilization() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFleetUtilization)

#endif // OAIFleetUtilization_H
