...
OAIStartMatchmakingOutput::OAIStartMatchmakingOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartMatchmakingOutput::OAIStartMatchmakingOutput() {
    this->initializeModel();
}

OAIStartMatchmakingOutput::~OAIStartMatchmakingOutput() {}

void OAIStartMatchmakingOutput::initializeModel() {

    m_matchmaking_ticket_isSet = false;
    m_matchmaking_ticket_isValid = false;
}

void OAIStartMatchmakingOutput::fromJson(QString jsonString) {
...
void OAIStartMatchmakingOutput::fromJsonObject(QJsonObject json) {
...
QString OAIStartMatchmakingOutput::asJson() const {
...
QJsonObject OAIStartMatchmakingOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIStartMatchmakingOutput_MatchmakingTicket OAIStartMatchmakingOutput::getMatchmakingTicket() const {
    return m_matchmaking_ticket;
}
void OAIStartMatchmakingOutput::setMatchmakingTicket(const OAIStartMatchmakingOutput_MatchmakingTicket &matchmaking_ticket) {
    m_matchmaking_ticket = matchmaking_ticket;
    m_matchmaking_ticket_isSet = true;
}

bool OAIStartMatchmakingOutput::is_matchmaking_ticket_Set() const{
    return m_matchmaking_ticket_isSet;
}

bool OAIStartMatchmakingOutput::is_matchmaking_ticket_Valid() const{
    return m_matchmaking_ticket_isValid;
}

bool OAIStartMatchmakingOutput::isSet() const {
...
bool OAIStartMatchmakingOutput::isValid() const {
