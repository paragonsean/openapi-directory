...
/*
 * OAIDeleteGameServerGroupInput.h
 *
 * 
 */

#ifndef OAIDeleteGameServerGroupInput_H
#define OAIDeleteGameServerGroupInput_H

#include <QJsonObject>

#include "OAIGameServerGroupDeleteOption.h"
#include <QString>
...
class OAIDeleteGameServerGroupInput : public OAIObject {
public:
    OAIDeleteGameServerGroupInput();
    OAIDeleteGameServerGroupInput(QString json);
    ~OAIDeleteGameServerGroupInput() override;
    ...
    OAIGameServerGroupDeleteOption getDeleteOption() const;
    void setDeleteOption(const OAIGameServerGroupDeleteOption &delete_option);
    bool is_delete_option_Set() const;
    bool is_delete_option_Valid() const;
...
private:
    ...
    OAIGameServerGroupDeleteOption m_delete_option;
    bool m_delete_option_isSet;
    bool m_delete_option_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDeleteGameServerGroupInput)

#endif // OAIDeleteGameServerGroupInput_H
