...
/*
 * OAIStopFleetActionsInput.h
 *
 * 
 */

#ifndef OAIStopFleetActionsInput_H
#define OAIStopFleetActionsInput_H
...
class OAIStopFleetActionsInput : public OAIObject {
public:
    OAIStopFleetActionsInput();
    OAIStopFleetActionsInput(QString json);
    ~OAIStopFleetActionsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopFleetActionsInput)

#endif // OAIStopFleetActionsInput_H
