...
#ifndef OAIPolicyType_H
#define OAIPolicyType_H
...
class OAIPolicyType : public OAIEnum {
public:
    OAIPolicyType();
    OAIPolicyType(QString json);
    ~OAIPolicyType() override;
    ...
    enum class eOAIPolicyType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        RULEBASED, 
        TARGETBASED
    };
    OAIPolicyType::eOAIPolicyType getValue() const;
    void setValue(const OAIPolicyType::eOAIPolicyType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPolicyType)

#endif // OAIPolicyType_H
