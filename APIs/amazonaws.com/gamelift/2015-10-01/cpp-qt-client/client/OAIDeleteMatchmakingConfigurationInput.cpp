...
OAIDeleteMatchmakingConfigurationInput::OAIDeleteMatchmakingConfigurationInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteMatchmakingConfigurationInput::OAIDeleteMatchmakingConfigurationInput() {
    this->initializeModel();
}

OAIDeleteMatchmakingConfigurationInput::~OAIDeleteMatchmakingConfigurationInput() {}

void OAIDeleteMatchmakingConfigurationInput::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;
}

void OAIDeleteMatchmakingConfigurationInput::fromJson(QString jsonString) {
...
void OAIDeleteMatchmakingConfigurationInput::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("Name")]);
    m_name_isSet = !json[QString("Name")].isNull() && m_name_isValid;
}

QString OAIDeleteMatchmakingConfigurationInput::asJson() const {
...
QJsonObject OAIDeleteMatchmakingConfigurationInput::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIDeleteMatchmakingConfigurationInput::getName() const {
    return m_name;
}
void OAIDeleteMatchmakingConfigurationInput::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDeleteMatchmakingConfigurationInput::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDeleteMatchmakingConfigurationInput::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIDeleteMatchmakingConfigurationInput::isSet() const {
...
bool OAIDeleteMatchmakingConfigurationInput::isValid() const {
