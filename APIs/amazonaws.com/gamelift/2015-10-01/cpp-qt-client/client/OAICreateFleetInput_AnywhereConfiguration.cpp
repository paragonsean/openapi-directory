...
OAICreateFleetInput_AnywhereConfiguration::OAICreateFleetInput_AnywhereConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateFleetInput_AnywhereConfiguration::OAICreateFleetInput_AnywhereConfiguration() {
    this->initializeModel();
}

OAICreateFleetInput_AnywhereConfiguration::~OAICreateFleetInput_AnywhereConfiguration() {}

void OAICreateFleetInput_AnywhereConfiguration::initializeModel() {

    m_cost_isSet = false;
    m_cost_isValid = false;
}

void OAICreateFleetInput_AnywhereConfiguration::fromJson(QString jsonString) {
...
void OAICreateFleetInput_AnywhereConfiguration::fromJsonObject(QJsonObject json) {

    m_cost_isValid = ::OpenAPI::fromJsonValue(m_cost, json[QString("Cost")]);
    m_cost_isSet = !json[QString("Cost")].isNull() && m_cost_isValid;
}

QString OAICreateFleetInput_AnywhereConfiguration::asJson() const {
...
QJsonObject OAICreateFleetInput_AnywhereConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_cost_isSet) {
...
QString OAICreateFleetInput_AnywhereConfiguration::getCost() const {
    return m_cost;
}
void OAICreateFleetInput_AnywhereConfiguration::setCost(const QString &cost) {
    m_cost = cost;
    m_cost_isSet = true;
}

bool OAICreateFleetInput_AnywhereConfiguration::is_cost_Set() const{
    return m_cost_isSet;
}

bool OAICreateFleetInput_AnywhereConfiguration::is_cost_Valid() const{
    return m_cost_isValid;
}

bool OAICreateFleetInput_AnywhereConfiguration::isSet() const {
...
bool OAICreateFleetInput_AnywhereConfiguration::isValid() const {
