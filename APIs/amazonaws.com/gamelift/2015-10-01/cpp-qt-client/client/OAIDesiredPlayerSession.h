...
class OAIDesiredPlayerSession : public OAIObject {
public:
    OAIDesiredPlayerSession();
    OAIDesiredPlayerSession(QString json);
    ~OAIDesiredPlayerSession() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDesiredPlayerSession)

#endif // OAIDesiredPlayerSession_H
