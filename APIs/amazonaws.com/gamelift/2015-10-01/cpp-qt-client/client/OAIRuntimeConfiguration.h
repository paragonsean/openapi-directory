...
#ifndef OAIRuntimeConfiguration_H
#define OAIRuntimeConfiguration_H
...
class OAIRuntimeConfiguration : public OAIObject {
public:
    OAIRuntimeConfiguration();
    OAIRuntimeConfiguration(QString json);
    ~OAIRuntimeConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRuntimeConfiguration)

#endif // OAIRuntimeConfiguration_H
