...
OAIDescribeComputeOutput::OAIDescribeComputeOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeComputeOutput::OAIDescribeComputeOutput() {
    this->initializeModel();
}

OAIDescribeComputeOutput::~OAIDescribeComputeOutput() {}

void OAIDescribeComputeOutput::initializeModel() {

    m_compute_isSet = false;
    m_compute_isValid = false;
}

void OAIDescribeComputeOutput::fromJson(QString jsonString) {
...
void OAIDescribeComputeOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeComputeOutput::asJson() const {
...
QJsonObject OAIDescribeComputeOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_compute.isSet()) {
...
OAIDescribeComputeOutput_Compute OAIDescribeComputeOutput::getCompute() const {
    return m_compute;
}
void OAIDescribeComputeOutput::setCompute(const OAIDescribeComputeOutput_Compute &compute) {
    m_compute = compute;
    m_compute_isSet = true;
}

bool OAIDescribeComputeOutput::is_compute_Set() const{
    return m_compute_isSet;
}

bool OAIDescribeComputeOutput::is_compute_Valid() const{
    return m_compute_isValid;
}

bool OAIDescribeComputeOutput::isSet() const {
...
bool OAIDescribeComputeOutput::isValid() const {
