...
/*
 * OAIListGameServersOutput.h
 *
 * 
 */

#ifndef OAIListGameServersOutput_H
#define OAIListGameServersOutput_H
...
class OAIListGameServersOutput : public OAIObject {
public:
    OAIListGameServersOutput();
    OAIListGameServersOutput(QString json);
    ~OAIListGameServersOutput() override;
    ...
    QList getGameServers() const;
    void setGameServers(const QList &game_servers);
    bool is_game_servers_Set() const;
    bool is_game_servers_Valid() const;
...
private:
    ...
    QList m_game_servers;
    bool m_game_servers_isSet;
    bool m_game_servers_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListGameServersOutput)

#endif // OAIListGameServersOutput_H
