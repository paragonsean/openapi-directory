...
#ifndef OAIAcceptanceType_H
#define OAIAcceptanceType_H
...
class OAIAcceptanceType : public OAIEnum {
public:
    OAIAcceptanceType();
    OAIAcceptanceType(QString json);
    ~OAIAcceptanceType() override;
    ...
    enum class eOAIAcceptanceType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ACCEPT, 
        REJECT
    };
    OAIAcceptanceType::eOAIAcceptanceType getValue() const;
    void setValue(const OAIAcceptanceType::eOAIAcceptanceType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAcceptanceType)

#endif // OAIAcceptanceType_H
