...
/*
 * OAIDescribeAliasInput.h
 *
 * 
 */

#ifndef OAIDescribeAliasInput_H
#define OAIDescribeAliasInput_H
...
class OAIDescribeAliasInput : public OAIObject {
public:
    OAIDescribeAliasInput();
    OAIDescribeAliasInput(QString json);
    ~OAIDescribeAliasInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAliasInput)

#endif // OAIDescribeAliasInput_H
