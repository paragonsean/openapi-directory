...
#ifndef OAIGameSession_H
#define OAIGameSession_H
...
class OAIGameSession : public OAIObject {
public:
    OAIGameSession();
    OAIGameSession(QString json);
    ~OAIGameSession() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGameSession)

#endif // OAIGameSession_H
