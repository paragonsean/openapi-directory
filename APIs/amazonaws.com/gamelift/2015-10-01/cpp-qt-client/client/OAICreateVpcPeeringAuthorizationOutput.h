...
/*
 * OAICreateVpcPeeringAuthorizationOutput.h
 *
 * 
 */

#ifndef OAICreateVpcPeeringAuthorizationOutput_H
#define OAICreateVpcPeeringAuthorizationOutput_H
...
namespace OpenAPI {
class OAICreateVpcPeeringAuthorizationOutput_VpcPeeringAuthorization;

class OAICreateVpcPeeringAuthorizationOutput : public OAIObject {
public:
    OAICreateVpcPeeringAuthorizationOutput();
    OAICreateVpcPeeringAuthorizationOutput(QString json);
    ~OAICreateVpcPeeringAuthorizationOutput() override;
    ...
    OAICreateVpcPeeringAuthorizationOutput_VpcPeeringAuthorization getVpcPeeringAuthorization() const;
    void setVpcPeeringAuthorization(const OAICreateVpcPeeringAuthorizationOutput_VpcPeeringAuthorization &vpc_peering_authorization);
    bool is_vpc_peering_authorization_Set() const;
    bool is_vpc_peering_authorization_Valid() const;
...
private:
    ...
    OAICreateVpcPeeringAuthorizationOutput_VpcPeeringAuthorization m_vpc_peering_authorization;
    bool m_vpc_peering_authorization_isSet;
    bool m_vpc_peering_authorization_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateVpcPeeringAuthorizationOutput)

#endif // OAICreateVpcPeeringAuthorizationOutput_H
