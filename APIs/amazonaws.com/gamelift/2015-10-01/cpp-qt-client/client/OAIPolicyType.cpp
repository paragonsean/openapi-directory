...
void OAIPolicyType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("RuleBased", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPolicyType::RULEBASED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("TargetBased", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPolicyType::TARGETBASED;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIPolicyType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIPolicyType::RULEBASED:
            val = "RuleBased";
            break;
        case eOAIPolicyType::TARGETBASED:
            val = "TargetBased";
            break;
        default:
            break;
