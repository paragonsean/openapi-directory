...
class OAIFleetAttributes : public OAIObject {
public:
    OAIFleetAttributes();
    OAIFleetAttributes(QString json);
    ~OAIFleetAttributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFleetAttributes)

#endif // OAIFleetAttributes_H
