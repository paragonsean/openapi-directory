...
/*
 * OAICreatePlayerSessionsOutput.h
 *
 * 
 */

#ifndef OAICreatePlayerSessionsOutput_H
#define OAICreatePlayerSessionsOutput_H
...
class OAICreatePlayerSessionsOutput : public OAIObject {
public:
    OAICreatePlayerSessionsOutput();
    OAICreatePlayerSessionsOutput(QString json);
    ~OAICreatePlayerSessionsOutput() override;
    ...
    QList getPlayerSessions() const;
    void setPlayerSessions(const QList &player_sessions);
    bool is_player_sessions_Set() const;
    bool is_player_sessions_Valid() const;
...
private:
    ...
    QList m_player_sessions;
    bool m_player_sessions_isSet;
    bool m_player_sessions_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreatePlayerSessionsOutput)

#endif // OAICreatePlayerSessionsOutput_H
