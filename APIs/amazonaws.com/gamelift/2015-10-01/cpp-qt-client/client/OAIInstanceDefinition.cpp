...
#include "OAIInstanceDefinition.h"
...
OAIInstanceDefinition::OAIInstanceDefinition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInstanceDefinition::OAIInstanceDefinition() {
    this->initializeModel();
}

OAIInstanceDefinition::~OAIInstanceDefinition() {}

void OAIInstanceDefinition::initializeModel() {
...
void OAIInstanceDefinition::fromJson(QString jsonString) {
...
void OAIInstanceDefinition::fromJsonObject(QJsonObject json) {
...
QString OAIInstanceDefinition::asJson() const {
...
QJsonObject OAIInstanceDefinition::asJsonObject() const {
    QJsonObject obj;
...
OAIGameServerGroupInstanceType OAIInstanceDefinition::getInstanceType() const {
    return m_instance_type;
}
void OAIInstanceDefinition::setInstanceType(const OAIGameServerGroupInstanceType &instance_type) {
    m_instance_type = instance_type;
    m_instance_type_isSet = true;
}

bool OAIInstanceDefinition::is_instance_type_Set() const{
    return m_instance_type_isSet;
}

bool OAIInstanceDefinition::is_instance_type_Valid() const{
    return m_instance_type_isValid;
}

QString OAIInstanceDefinition::getWeightedCapacity() const {
    return m_weighted_capacity;
}
void OAIInstanceDefinition::setWeightedCapacity(const QString &weighted_capacity) {
    m_weighted_capacity = weighted_capacity;
    m_weighted_capacity_isSet = true;
}

bool OAIInstanceDefinition::is_weighted_capacity_Set() const{
    return m_weighted_capacity_isSet;
}

bool OAIInstanceDefinition::is_weighted_capacity_Valid() const{
    return m_weighted_capacity_isValid;
}

bool OAIInstanceDefinition::isSet() const {
...
bool OAIInstanceDefinition::isValid() const {
