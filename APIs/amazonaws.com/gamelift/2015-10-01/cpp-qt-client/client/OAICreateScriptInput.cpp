...
OAICreateScriptInput::OAICreateScriptInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateScriptInput::OAICreateScriptInput() {
    this->initializeModel();
}

OAICreateScriptInput::~OAICreateScriptInput() {}

void OAICreateScriptInput::initializeModel() {
...
void OAICreateScriptInput::fromJson(QString jsonString) {
...
void OAICreateScriptInput::fromJsonObject(QJsonObject json) {
...
QString OAICreateScriptInput::asJson() const {
...
QJsonObject OAICreateScriptInput::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAICreateScriptInput::getName() const {
    return m_name;
}
void OAICreateScriptInput::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateScriptInput::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateScriptInput::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICreateScriptInput::getVersion() const {
    return m_version;
}
void OAICreateScriptInput::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAICreateScriptInput::is_version_Set() const{
    return m_version_isSet;
}

bool OAICreateScriptInput::is_version_Valid() const{
    return m_version_isValid;
}

OAICreateScriptInput_StorageLocation OAICreateScriptInput::getStorageLocation() const {
    return m_storage_location;
}
void OAICreateScriptInput::setStorageLocation(const OAICreateScriptInput_StorageLocation &storage_location) {
    m_storage_location = storage_location;
    m_storage_location_isSet = true;
}

bool OAICreateScriptInput::is_storage_location_Set() const{
    return m_storage_location_isSet;
}

bool OAICreateScriptInput::is_storage_location_Valid() const{
    return m_storage_location_isValid;
}

QString OAICreateScriptInput::getZipFile() const {
    return m_zip_file;
}
void OAICreateScriptInput::setZipFile(const QString &zip_file) {
    m_zip_file = zip_file;
    m_zip_file_isSet = true;
}

bool OAICreateScriptInput::is_zip_file_Set() const{
    return m_zip_file_isSet;
}

bool OAICreateScriptInput::is_zip_file_Valid() const{
    return m_zip_file_isValid;
}

QList OAICreateScriptInput::getTags() const {
    return m_tags;
}
void OAICreateScriptInput::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateScriptInput::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateScriptInput::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAICreateScriptInput::isSet() const {
...
bool OAICreateScriptInput::isValid() const {
