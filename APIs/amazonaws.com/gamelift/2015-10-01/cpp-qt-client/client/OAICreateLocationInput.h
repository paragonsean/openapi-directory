...
/*
 * OAICreateLocationInput.h
 *
 * 
 */

#ifndef OAICreateLocationInput_H
#define OAICreateLocationInput_H
...
class OAICreateLocationInput : public OAIObject {
public:
    OAICreateLocationInput();
    OAICreateLocationInput(QString json);
    ~OAICreateLocationInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLocationInput)

#endif // OAICreateLocationInput_H
