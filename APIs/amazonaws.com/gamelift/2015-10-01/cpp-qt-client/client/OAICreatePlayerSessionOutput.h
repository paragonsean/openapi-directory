...
/*
 * OAICreatePlayerSessionOutput.h
 *
 * 
 */

#ifndef OAICreatePlayerSessionOutput_H
#define OAICreatePlayerSessionOutput_H
...
namespace OpenAPI {
class OAICreatePlayerSessionOutput_PlayerSession;

class OAICreatePlayerSessionOutput : public OAIObject {
public:
    OAICreatePlayerSessionOutput();
    OAICreatePlayerSessionOutput(QString json);
    ~OAICreatePlayerSessionOutput() override;
    ...
    OAICreatePlayerSessionOutput_PlayerSession getPlayerSession() const;
    void setPlayerSession(const OAICreatePlayerSessionOutput_PlayerSession &player_session);
    bool is_player_session_Set() const;
    bool is_player_session_Valid() const;
...
private:
    ...
    OAICreatePlayerSessionOutput_PlayerSession m_player_session;
    bool m_player_session_isSet;
    bool m_player_session_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreatePlayerSessionOutput)

#endif // OAICreatePlayerSessionOutput_H
