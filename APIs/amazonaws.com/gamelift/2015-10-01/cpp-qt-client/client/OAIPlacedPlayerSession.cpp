...
#include "OAIPlacedPlayerSession.h"
...
OAIPlacedPlayerSession::OAIPlacedPlayerSession(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPlacedPlayerSession::OAIPlacedPlayerSession() {
    this->initializeModel();
}

OAIPlacedPlayerSession::~OAIPlacedPlayerSession() {}

void OAIPlacedPlayerSession::initializeModel() {
...
void OAIPlacedPlayerSession::fromJson(QString jsonString) {
...
void OAIPlacedPlayerSession::fromJsonObject(QJsonObject json) {
...
QString OAIPlacedPlayerSession::asJson() const {
...
QJsonObject OAIPlacedPlayerSession::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPlacedPlayerSession::getPlayerId() const {
    return m_player_id;
}
void OAIPlacedPlayerSession::setPlayerId(const QString &player_id) {
    m_player_id = player_id;
    m_player_id_isSet = true;
}

bool OAIPlacedPlayerSession::is_player_id_Set() const{
    return m_player_id_isSet;
}

bool OAIPlacedPlayerSession::is_player_id_Valid() const{
    return m_player_id_isValid;
}

QString OAIPlacedPlayerSession::getPlayerSessionId() const {
    return m_player_session_id;
}
void OAIPlacedPlayerSession::setPlayerSessionId(const QString &player_session_id) {
    m_player_session_id = player_session_id;
    m_player_session_id_isSet = true;
}

bool OAIPlacedPlayerSession::is_player_session_id_Set() const{
    return m_player_session_id_isSet;
}

bool OAIPlacedPlayerSession::is_player_session_id_Valid() const{
    return m_player_session_id_isValid;
}

bool OAIPlacedPlayerSession::isSet() const {
...
bool OAIPlacedPlayerSession::isValid() const {
