...
/*
 * OAIGameServerClaimStatus.h
 *
 * 
 */

#ifndef OAIGameServerClaimStatus_H
#define OAIGameServerClaimStatus_H
...
class OAIGameServerClaimStatus : public OAIEnum {
public:
    OAIGameServerClaimStatus();
    OAIGameServerClaimStatus(QString json);
    ~OAIGameServerClaimStatus() override;
    ...
    enum class eOAIGameServerClaimStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        CLAIMED
    };
    OAIGameServerClaimStatus::eOAIGameServerClaimStatus getValue() const;
    void setValue(const OAIGameServerClaimStatus::eOAIGameServerClaimStatus& value);
...
private:
    ...
    eOAIGameServerClaimStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGameServerClaimStatus)

#endif // OAIGameServerClaimStatus_H
