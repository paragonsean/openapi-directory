...
/*
 * OAIUpdateGameSessionQueueInput_PriorityConfiguration.h
 *
 * 
 */

#ifndef OAIUpdateGameSessionQueueInput_PriorityConfiguration_H
#define OAIUpdateGameSessionQueueInput_PriorityConfiguration_H
...
class OAIUpdateGameSessionQueueInput_PriorityConfiguration : public OAIObject {
public:
    OAIUpdateGameSessionQueueInput_PriorityConfiguration();
    OAIUpdateGameSessionQueueInput_PriorityConfiguration(QString json);
    ~OAIUpdateGameSessionQueueInput_PriorityConfiguration() override;
    ...
    QList getPriorityOrder() const;
    void setPriorityOrder(const QList &priority_order);
    bool is_priority_order_Set() const;
    bool is_priority_order_Valid() const;

    QList getLocationOrder() const;
    void setLocationOrder(const QList &location_order);
    bool is_location_order_Set() const;
    bool is_location_order_Valid() const;
...
private:
    ...
    QList m_priority_order;
    bool m_priority_order_isSet;
    bool m_priority_order_isValid;

    QList m_location_order;
    bool m_location_order_isSet;
    bool m_location_order_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUpdateGameSessionQueueInput_PriorityConfiguration)

#endif // OAIUpdateGameSessionQueueInput_PriorityConfiguration_H
