...
/*
 * OAIDescribeFleetEventsOutput.h
 *
 * 
 */

#ifndef OAIDescribeFleetEventsOutput_H
#define OAIDescribeFleetEventsOutput_H
...
class OAIDescribeFleetEventsOutput : public OAIObject {
public:
    OAIDescribeFleetEventsOutput();
    OAIDescribeFleetEventsOutput(QString json);
    ~OAIDescribeFleetEventsOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFleetEventsOutput)

#endif // OAIDescribeFleetEventsOutput_H
