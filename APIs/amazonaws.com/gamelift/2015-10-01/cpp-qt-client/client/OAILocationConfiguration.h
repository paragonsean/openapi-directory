...
/*
 * OAILocationConfiguration.h
 *
 * A remote location where a multi-location fleet can deploy game servers for game hosting. 
 */

#ifndef OAILocationConfiguration_H
#define OAILocationConfiguration_H
...
class OAILocationConfiguration : public OAIObject {
public:
    OAILocationConfiguration();
    OAILocationConfiguration(QString json);
    ~OAILocationConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILocationConfiguration)

#endif // OAILocationConfiguration_H
