...
/*
 * OAIDeregisterGameServerInput.h
 *
 * 
 */

#ifndef OAIDeregisterGameServerInput_H
#define OAIDeregisterGameServerInput_H
...
class OAIDeregisterGameServerInput : public OAIObject {
public:
    OAIDeregisterGameServerInput();
    OAIDeregisterGameServerInput(QString json);
    ~OAIDeregisterGameServerInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeregisterGameServerInput)

#endif // OAIDeregisterGameServerInput_H
