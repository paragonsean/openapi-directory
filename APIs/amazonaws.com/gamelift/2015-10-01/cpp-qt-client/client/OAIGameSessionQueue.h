...
#ifndef OAIGameSessionQueue_H
#define OAIGameSessionQueue_H
...
class OAIGameSessionQueue : public OAIObject {
public:
    OAIGameSessionQueue();
    OAIGameSessionQueue(QString json);
    ~OAIGameSessionQueue() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGameSessionQueue)

#endif // OAIGameSessionQueue_H
