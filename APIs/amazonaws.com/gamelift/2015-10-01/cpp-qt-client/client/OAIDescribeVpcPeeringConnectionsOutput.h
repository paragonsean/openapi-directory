...
/*
 * OAIDescribeVpcPeeringConnectionsOutput.h
 *
 * 
 */

#ifndef OAIDescribeVpcPeeringConnectionsOutput_H
#define OAIDescribeVpcPeeringConnectionsOutput_H
...
class OAIDescribeVpcPeeringConnectionsOutput : public OAIObject {
public:
    OAIDescribeVpcPeeringConnectionsOutput();
    OAIDescribeVpcPeeringConnectionsOutput(QString json);
    ~OAIDescribeVpcPeeringConnectionsOutput() override;
    ...
    QList getVpcPeeringConnections() const;
    void setVpcPeeringConnections(const QList &vpc_peering_connections);
    bool is_vpc_peering_connections_Set() const;
    bool is_vpc_peering_connections_Valid() const;
...
private:
    ...
    QList m_vpc_peering_connections;
    bool m_vpc_peering_connections_isSet;
    bool m_vpc_peering_connections_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeVpcPeeringConnectionsOutput)

#endif // OAIDescribeVpcPeeringConnectionsOutput_H
