...
OAICreateScriptInput_StorageLocation::OAICreateScriptInput_StorageLocation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateScriptInput_StorageLocation::OAICreateScriptInput_StorageLocation() {
    this->initializeModel();
}

OAICreateScriptInput_StorageLocation::~OAICreateScriptInput_StorageLocation() {}

void OAICreateScriptInput_StorageLocation::initializeModel() {
...
void OAICreateScriptInput_StorageLocation::fromJson(QString jsonString) {
...
void OAICreateScriptInput_StorageLocation::fromJsonObject(QJsonObject json) {
...
QString OAICreateScriptInput_StorageLocation::asJson() const {
...
QJsonObject OAICreateScriptInput_StorageLocation::asJsonObject() const {
    QJsonObject obj;
    if (m_bucket_isSet) {
...
QString OAICreateScriptInput_StorageLocation::getBucket() const {
    return m_bucket;
}
void OAICreateScriptInput_StorageLocation::setBucket(const QString &bucket) {
    m_bucket = bucket;
    m_bucket_isSet = true;
}

bool OAICreateScriptInput_StorageLocation::is_bucket_Set() const{
    return m_bucket_isSet;
}

bool OAICreateScriptInput_StorageLocation::is_bucket_Valid() const{
    return m_bucket_isValid;
}

QString OAICreateScriptInput_StorageLocation::getKey() const {
    return m_key;
}
void OAICreateScriptInput_StorageLocation::setKey(const QString &key) {
    m_key = key;
    m_key_isSet = true;
}

bool OAICreateScriptInput_StorageLocation::is_key_Set() const{
    return m_key_isSet;
}

bool OAICreateScriptInput_StorageLocation::is_key_Valid() const{
    return m_key_isValid;
}

QString OAICreateScriptInput_StorageLocation::getRoleArn() const {
    return m_role_arn;
}
void OAICreateScriptInput_StorageLocation::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAICreateScriptInput_StorageLocation::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAICreateScriptInput_StorageLocation::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

QString OAICreateScriptInput_StorageLocation::getObjectVersion() const {
    return m_object_version;
}
void OAICreateScriptInput_StorageLocation::setObjectVersion(const QString &object_version) {
    m_object_version = object_version;
    m_object_version_isSet = true;
}

bool OAICreateScriptInput_StorageLocation::is_object_version_Set() const{
    return m_object_version_isSet;
}

bool OAICreateScriptInput_StorageLocation::is_object_version_Valid() const{
    return m_object_version_isValid;
}

bool OAICreateScriptInput_StorageLocation::isSet() const {
...
bool OAICreateScriptInput_StorageLocation::isValid() const {
