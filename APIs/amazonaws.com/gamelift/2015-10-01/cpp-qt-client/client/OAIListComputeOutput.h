...
/*
 * OAIListComputeOutput.h
 *
 * 
 */

#ifndef OAIListComputeOutput_H
#define OAIListComputeOutput_H
...
class OAIListComputeOutput : public OAIObject {
public:
    OAIListComputeOutput();
    OAIListComputeOutput(QString json);
    ~OAIListComputeOutput() override;
    ...
    QList getComputeList() const;
    void setComputeList(const QList &compute_list);
    bool is_compute_list_Set() const;
    bool is_compute_list_Valid() const;
...
private:
    ...
    QList m_compute_list;
    bool m_compute_list_isSet;
    bool m_compute_list_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListComputeOutput)

#endif // OAIListComputeOutput_H
