...
#ifndef OAIMatchedPlayerSession_H
#define OAIMatchedPlayerSession_H
...
class OAIMatchedPlayerSession : public OAIObject {
public:
    OAIMatchedPlayerSession();
    OAIMatchedPlayerSession(QString json);
    ~OAIMatchedPlayerSession() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMatchedPlayerSession)

#endif // OAIMatchedPlayerSession_H
