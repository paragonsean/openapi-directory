...
OAIPriorityType::OAIPriorityType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPriorityType::OAIPriorityType() {
    this->initializeModel();
}

OAIPriorityType::~OAIPriorityType() {}

void OAIPriorityType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIPriorityType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIPriorityType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("LATENCY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPriorityType::LATENCY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("COST", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPriorityType::COST;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DESTINATION", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPriorityType::DESTINATION;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("LOCATION", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPriorityType::LOCATION;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIPriorityType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIPriorityType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIPriorityType::LATENCY:
            val = "LATENCY";
            break;
        case eOAIPriorityType::COST:
            val = "COST";
            break;
        case eOAIPriorityType::DESTINATION:
            val = "DESTINATION";
            break;
        case eOAIPriorityType::LOCATION:
            val = "LOCATION";
            break;
        default:
            break;
...
QJsonValue OAIPriorityType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIPriorityType::eOAIPriorityType OAIPriorityType::getValue() const {
    return m_value;
}

void OAIPriorityType::setValue(const OAIPriorityType::eOAIPriorityType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIPriorityType::isSet() const {
    
    return m_value_isSet;
}

bool OAIPriorityType::isValid() const {
