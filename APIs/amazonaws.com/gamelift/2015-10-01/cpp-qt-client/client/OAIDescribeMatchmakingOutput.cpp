...
OAIDescribeMatchmakingOutput::OAIDescribeMatchmakingOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeMatchmakingOutput::OAIDescribeMatchmakingOutput() {
    this->initializeModel();
}

OAIDescribeMatchmakingOutput::~OAIDescribeMatchmakingOutput() {}

void OAIDescribeMatchmakingOutput::initializeModel() {

    m_ticket_list_isSet = false;
    m_ticket_list_isValid = false;
}

void OAIDescribeMatchmakingOutput::fromJson(QString jsonString) {
...
void OAIDescribeMatchmakingOutput::fromJsonObject(QJsonObject json) {

    m_ticket_list_isValid = ::OpenAPI::fromJsonValue(m_ticket_list, json[QString("TicketList")]);
    m_ticket_list_isSet = !json[QString("TicketList")].isNull() && m_ticket_list_isValid;
}

QString OAIDescribeMatchmakingOutput::asJson() const {
...
QJsonObject OAIDescribeMatchmakingOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_ticket_list.isSet()) {
        obj.insert(QString("TicketList"), ::OpenAPI::toJsonValue(m_ticket_list));
    }
    return obj;
}

QList OAIDescribeMatchmakingOutput::getTicketList() const {
    return m_ticket_list;
}
void OAIDescribeMatchmakingOutput::setTicketList(const QList &ticket_list) {
    m_ticket_list = ticket_list;
    m_ticket_list_isSet = true;
}

bool OAIDescribeMatchmakingOutput::is_ticket_list_Set() const{
    return m_ticket_list_isSet;
}

bool OAIDescribeMatchmakingOutput::is_ticket_list_Valid() const{
    return m_ticket_list_isValid;
}

bool OAIDescribeMatchmakingOutput::isSet() const {
...
bool OAIDescribeMatchmakingOutput::isValid() const {
