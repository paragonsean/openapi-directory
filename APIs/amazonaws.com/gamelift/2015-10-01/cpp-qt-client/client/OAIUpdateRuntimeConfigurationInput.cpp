...
OAIUpdateRuntimeConfigurationInput::OAIUpdateRuntimeConfigurationInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateRuntimeConfigurationInput::OAIUpdateRuntimeConfigurationInput() {
    this->initializeModel();
}

OAIUpdateRuntimeConfigurationInput::~OAIUpdateRuntimeConfigurationInput() {}

void OAIUpdateRuntimeConfigurationInput::initializeModel() {
...
void OAIUpdateRuntimeConfigurationInput::fromJson(QString jsonString) {
...
void OAIUpdateRuntimeConfigurationInput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateRuntimeConfigurationInput::asJson() const {
...
QJsonObject OAIUpdateRuntimeConfigurationInput::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
...
QString OAIUpdateRuntimeConfigurationInput::getFleetId() const {
    return m_fleet_id;
}
void OAIUpdateRuntimeConfigurationInput::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIUpdateRuntimeConfigurationInput::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIUpdateRuntimeConfigurationInput::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

OAIUpdateRuntimeConfigurationInput_RuntimeConfiguration OAIUpdateRuntimeConfigurationInput::getRuntimeConfiguration() const {
    return m_runtime_configuration;
}
void OAIUpdateRuntimeConfigurationInput::setRuntimeConfiguration(const OAIUpdateRuntimeConfigurationInput_RuntimeConfiguration &runtime_configuration) {
    m_runtime_configuration = runtime_configuration;
    m_runtime_configuration_isSet = true;
}

bool OAIUpdateRuntimeConfigurationInput::is_runtime_configuration_Set() const{
    return m_runtime_configuration_isSet;
}

bool OAIUpdateRuntimeConfigurationInput::is_runtime_configuration_Valid() const{
    return m_runtime_configuration_isValid;
}

bool OAIUpdateRuntimeConfigurationInput::isSet() const {
...
bool OAIUpdateRuntimeConfigurationInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_fleet_id_isValid && m_runtime_configuration_isValid && true;
}
