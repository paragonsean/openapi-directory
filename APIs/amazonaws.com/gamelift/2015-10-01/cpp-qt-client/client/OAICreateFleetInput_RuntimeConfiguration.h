...
/*
 * OAICreateFleetInput_RuntimeConfiguration.h
 *
 * 
 */

#ifndef OAICreateFleetInput_RuntimeConfiguration_H
#define OAICreateFleetInput_RuntimeConfiguration_H
...
class OAICreateFleetInput_RuntimeConfiguration : public OAIObject {
public:
    OAICreateFleetInput_RuntimeConfiguration();
    OAICreateFleetInput_RuntimeConfiguration(QString json);
    ~OAICreateFleetInput_RuntimeConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFleetInput_RuntimeConfiguration)

#endif // OAICreateFleetInput_RuntimeConfiguration_H
