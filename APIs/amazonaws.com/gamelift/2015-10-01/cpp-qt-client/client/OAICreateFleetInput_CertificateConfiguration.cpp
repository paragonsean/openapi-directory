...
OAICreateFleetInput_CertificateConfiguration::OAICreateFleetInput_CertificateConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateFleetInput_CertificateConfiguration::OAICreateFleetInput_CertificateConfiguration() {
    this->initializeModel();
}

OAICreateFleetInput_CertificateConfiguration::~OAICreateFleetInput_CertificateConfiguration() {}

void OAICreateFleetInput_CertificateConfiguration::initializeModel() {

    m_certificate_type_isSet = false;
    m_certificate_type_isValid = false;
}

void OAICreateFleetInput_CertificateConfiguration::fromJson(QString jsonString) {
...
void OAICreateFleetInput_CertificateConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAICreateFleetInput_CertificateConfiguration::asJson() const {
...
QJsonObject OAICreateFleetInput_CertificateConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAICertificateType OAICreateFleetInput_CertificateConfiguration::getCertificateType() const {
    return m_certificate_type;
}
void OAICreateFleetInput_CertificateConfiguration::setCertificateType(const OAICertificateType &certificate_type) {
    m_certificate_type = certificate_type;
    m_certificate_type_isSet = true;
}

bool OAICreateFleetInput_CertificateConfiguration::is_certificate_type_Set() const{
    return m_certificate_type_isSet;
}

bool OAICreateFleetInput_CertificateConfiguration::is_certificate_type_Valid() const{
    return m_certificate_type_isValid;
}

bool OAICreateFleetInput_CertificateConfiguration::isSet() const {
...
bool OAICreateFleetInput_CertificateConfiguration::isValid() const {
