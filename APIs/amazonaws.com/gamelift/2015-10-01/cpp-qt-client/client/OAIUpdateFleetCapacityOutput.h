...
/*
 * OAIUpdateFleetCapacityOutput.h
 *
 * 
 */

#ifndef OAIUpdateFleetCapacityOutput_H
#define OAIUpdateFleetCapacityOutput_H
...
class OAIUpdateFleetCapacityOutput : public OAIObject {
public:
    OAIUpdateFleetCapacityOutput();
    OAIUpdateFleetCapacityOutput(QString json);
    ~OAIUpdateFleetCapacityOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFleetCapacityOutput)

#endif // OAIUpdateFleetCapacityOutput_H
