...
/*
 * OAIMatchmakingConfiguration.h
 *
 * Guidelines for use with FlexMatch to match players into games. All matchmaking requests must specify a matchmaking configuration.
 */

#ifndef OAIMatchmakingConfiguration_H
#define OAIMatchmakingConfiguration_H
...
class OAIMatchmakingConfiguration : public OAIObject {
public:
    OAIMatchmakingConfiguration();
    OAIMatchmakingConfiguration(QString json);
    ~OAIMatchmakingConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMatchmakingConfiguration)

#endif // OAIMatchmakingConfiguration_H
