...
QString OAILocationState::getLocation() const {
    return m_location;
}
void OAILocationState::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAILocationState::is_location_Set() const{
    return m_location_isSet;
}

bool OAILocationState::is_location_Valid() const{
    return m_location_isValid;
}

OAIFleetStatus OAILocationState::getStatus() const {
    return m_status;
}
void OAILocationState::setStatus(const OAIFleetStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAILocationState::is_status_Set() const{
    return m_status_isSet;
}

bool OAILocationState::is_status_Valid() const{
