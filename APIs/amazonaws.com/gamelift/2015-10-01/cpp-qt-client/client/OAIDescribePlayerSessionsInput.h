...
/*
 * OAIDescribePlayerSessionsInput.h
 *
 * 
 */

#ifndef OAIDescribePlayerSessionsInput_H
#define OAIDescribePlayerSessionsInput_H
...
class OAIDescribePlayerSessionsInput : public OAIObject {
public:
    OAIDescribePlayerSessionsInput();
    OAIDescribePlayerSessionsInput(QString json);
    ~OAIDescribePlayerSessionsInput() override;
    ...
    QString getPlayerSessionId() const;
    void setPlayerSessionId(const QString &player_session_id);
    bool is_player_session_id_Set() const;
    bool is_player_session_id_Valid() const;

    QString getPlayerSessionStatusFilter() const;
    void setPlayerSessionStatusFilter(const QString &player_session_status_filter);
    bool is_player_session_status_filter_Set() const;
    bool is_player_session_status_filter_Valid() const;
...
private:
    ...
    QString m_player_session_id;
    bool m_player_session_id_isSet;
    bool m_player_session_id_isValid;

    QString m_player_session_status_filter;
    bool m_player_session_status_filter_isSet;
    bool m_player_session_status_filter_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribePlayerSessionsInput)

#endif // OAIDescribePlayerSessionsInput_H
