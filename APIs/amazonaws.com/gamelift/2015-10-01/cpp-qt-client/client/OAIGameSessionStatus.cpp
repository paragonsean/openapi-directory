...
OAIGameSessionStatus::OAIGameSessionStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGameSessionStatus::OAIGameSessionStatus() {
    this->initializeModel();
}

OAIGameSessionStatus::~OAIGameSessionStatus() {}

void OAIGameSessionStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIGameSessionStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIGameSessionStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ACTIVE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGameSessionStatus::ACTIVE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ACTIVATING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGameSessionStatus::ACTIVATING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("TERMINATED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGameSessionStatus::TERMINATED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("TERMINATING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGameSessionStatus::TERMINATING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ERROR", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGameSessionStatus::ERROR;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIGameSessionStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIGameSessionStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIGameSessionStatus::ACTIVE:
            val = "ACTIVE";
            break;
        case eOAIGameSessionStatus::ACTIVATING:
            val = "ACTIVATING";
            break;
        case eOAIGameSessionStatus::TERMINATED:
            val = "TERMINATED";
            break;
        case eOAIGameSessionStatus::TERMINATING:
            val = "TERMINATING";
            break;
        case eOAIGameSessionStatus::ERROR:
            val = "ERROR";
            break;
        default:
            break;
...
QJsonValue OAIGameSessionStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIGameSessionStatus::eOAIGameSessionStatus OAIGameSessionStatus::getValue() const {
    return m_value;
}

void OAIGameSessionStatus::setValue(const OAIGameSessionStatus::eOAIGameSessionStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIGameSessionStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIGameSessionStatus::isValid() const {
