...
OAIDescribeGameServerInput::OAIDescribeGameServerInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeGameServerInput::OAIDescribeGameServerInput() {
    this->initializeModel();
}

OAIDescribeGameServerInput::~OAIDescribeGameServerInput() {}

void OAIDescribeGameServerInput::initializeModel() {
...
void OAIDescribeGameServerInput::fromJson(QString jsonString) {
...
void OAIDescribeGameServerInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeGameServerInput::asJson() const {
...
QJsonObject OAIDescribeGameServerInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeGameServerInput::getGameServerGroupName() const {
    return m_game_server_group_name;
}
void OAIDescribeGameServerInput::setGameServerGroupName(const QString &game_server_group_name) {
    m_game_server_group_name = game_server_group_name;
    m_game_server_group_name_isSet = true;
}

bool OAIDescribeGameServerInput::is_game_server_group_name_Set() const{
    return m_game_server_group_name_isSet;
}

bool OAIDescribeGameServerInput::is_game_server_group_name_Valid() const{
    return m_game_server_group_name_isValid;
}

QString OAIDescribeGameServerInput::getGameServerId() const {
    return m_game_server_id;
}
void OAIDescribeGameServerInput::setGameServerId(const QString &game_server_id) {
    m_game_server_id = game_server_id;
    m_game_server_id_isSet = true;
}

bool OAIDescribeGameServerInput::is_game_server_id_Set() const{
    return m_game_server_id_isSet;
}

bool OAIDescribeGameServerInput::is_game_server_id_Valid() const{
    return m_game_server_id_isValid;
}

bool OAIDescribeGameServerInput::isSet() const {
...
bool OAIDescribeGameServerInput::isValid() const {
