...
/*
 * OAIPlayerSessionStatus.h
 *
 * 
 */

#ifndef OAIPlayerSessionStatus_H
#define OAIPlayerSessionStatus_H
...
class OAIPlayerSessionStatus : public OAIEnum {
public:
    OAIPlayerSessionStatus();
    OAIPlayerSessionStatus(QString json);
    ~OAIPlayerSessionStatus() override;
    ...
    enum class eOAIPlayerSessionStatus {
    ...
    OAIPlayerSessionStatus::eOAIPlayerSessionStatus getValue() const;
    void setValue(const OAIPlayerSessionStatus::eOAIPlayerSessionStatus& value);
...
private:
    ...
    eOAIPlayerSessionStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlayerSessionStatus)

#endif // OAIPlayerSessionStatus_H
