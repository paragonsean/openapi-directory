...
OAIDescribeFleetEventsInput::OAIDescribeFleetEventsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeFleetEventsInput::OAIDescribeFleetEventsInput() {
    this->initializeModel();
}

OAIDescribeFleetEventsInput::~OAIDescribeFleetEventsInput() {}

void OAIDescribeFleetEventsInput::initializeModel() {
...
void OAIDescribeFleetEventsInput::fromJson(QString jsonString) {
...
void OAIDescribeFleetEventsInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeFleetEventsInput::asJson() const {
...
QJsonObject OAIDescribeFleetEventsInput::asJsonObject() const {
    QJsonObject obj;
    if (m_fleet_id_isSet) {
...
QString OAIDescribeFleetEventsInput::getFleetId() const {
    return m_fleet_id;
}
void OAIDescribeFleetEventsInput::setFleetId(const QString &fleet_id) {
    m_fleet_id = fleet_id;
    m_fleet_id_isSet = true;
}

bool OAIDescribeFleetEventsInput::is_fleet_id_Set() const{
    return m_fleet_id_isSet;
}

bool OAIDescribeFleetEventsInput::is_fleet_id_Valid() const{
    return m_fleet_id_isValid;
}

QDateTime OAIDescribeFleetEventsInput::getStartTime() const {
    return m_start_time;
}
void OAIDescribeFleetEventsInput::setStartTime(const QDateTime &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIDescribeFleetEventsInput::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIDescribeFleetEventsInput::is_start_time_Valid() const{
    return m_start_time_isValid;
}

QDateTime OAIDescribeFleetEventsInput::getEndTime() const {
    return m_end_time;
}
void OAIDescribeFleetEventsInput::setEndTime(const QDateTime &end_time) {
    m_end_time = end_time;
    m_end_time_isSet = true;
}

bool OAIDescribeFleetEventsInput::is_end_time_Set() const{
    return m_end_time_isSet;
}

bool OAIDescribeFleetEventsInput::is_end_time_Valid() const{
    return m_end_time_isValid;
}

qint32 OAIDescribeFleetEventsInput::getLimit() const {
    return m_limit;
}
void OAIDescribeFleetEventsInput::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIDescribeFleetEventsInput::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIDescribeFleetEventsInput::is_limit_Valid() const{
    return m_limit_isValid;
}

QString OAIDescribeFleetEventsInput::getNextToken() const {
    return m_next_token;
}
void OAIDescribeFleetEventsInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeFleetEventsInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeFleetEventsInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeFleetEventsInput::isSet() const {
...
bool OAIDescribeFleetEventsInput::isValid() const {
