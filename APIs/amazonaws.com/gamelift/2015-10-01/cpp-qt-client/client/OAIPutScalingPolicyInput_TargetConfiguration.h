...
/*
 * OAIPutScalingPolicyInput_TargetConfiguration.h
 *
 * 
 */

#ifndef OAIPutScalingPolicyInput_TargetConfiguration_H
#define OAIPutScalingPolicyInput_TargetConfiguration_H
...
class OAIPutScalingPolicyInput_TargetConfiguration : public OAIObject {
public:
    OAIPutScalingPolicyInput_TargetConfiguration();
    OAIPutScalingPolicyInput_TargetConfiguration(QString json);
    ~OAIPutScalingPolicyInput_TargetConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutScalingPolicyInput_TargetConfiguration)

#endif // OAIPutScalingPolicyInput_TargetConfiguration_H
