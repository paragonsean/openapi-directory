...
/*
 * OAIComparisonOperatorType.h
 *
 * 
 */

#ifndef OAIComparisonOperatorType_H
#define OAIComparisonOperatorType_H
...
class OAIComparisonOperatorType : public OAIEnum {
public:
    OAIComparisonOperatorType();
    OAIComparisonOperatorType(QString json);
    ~OAIComparisonOperatorType() override;
    ...
    enum class eOAIComparisonOperatorType {
    ...
    OAIComparisonOperatorType::eOAIComparisonOperatorType getValue() const;
    void setValue(const OAIComparisonOperatorType::eOAIComparisonOperatorType& value);
...
private:
    ...
    eOAIComparisonOperatorType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIComparisonOperatorType)

#endif // OAIComparisonOperatorType_H
