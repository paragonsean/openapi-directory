...
OAIUpdateBuildOutput::OAIUpdateBuildOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateBuildOutput::OAIUpdateBuildOutput() {
    this->initializeModel();
}

OAIUpdateBuildOutput::~OAIUpdateBuildOutput() {}

void OAIUpdateBuildOutput::initializeModel() {

    m_build_isSet = false;
    m_build_isValid = false;
}

void OAIUpdateBuildOutput::fromJson(QString jsonString) {
...
QJsonObject OAIUpdateBuildOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_build.isSet()) {
...
OAIUpdateBuildOutput_Build OAIUpdateBuildOutput::getBuild() const {
    return m_build;
}
void OAIUpdateBuildOutput::setBuild(const OAIUpdateBuildOutput_Build &build) {
    m_build = build;
    m_build_isSet = true;
}

bool OAIUpdateBuildOutput::is_build_Set() const{
    return m_build_isSet;
}

bool OAIUpdateBuildOutput::is_build_Valid() const{
    return m_build_isValid;
}

bool OAIUpdateBuildOutput::isSet() const {
...
bool OAIUpdateBuildOutput::isValid() const {
