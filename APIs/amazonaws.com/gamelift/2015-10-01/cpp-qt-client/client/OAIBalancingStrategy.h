...
/*
 * OAIBalancingStrategy.h
 *
 * 
 */

#ifndef OAIBalancingStrategy_H
#define OAIBalancingStrategy_H
...
class OAIBalancingStrategy : public OAIEnum {
public:
    OAIBalancingStrategy();
    OAIBalancingStrategy(QString json);
    ~OAIBalancingStrategy() override;
    ...
    enum class eOAIBalancingStrategy {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        SPOT_ONLY, 
        SPOT_PREFERRED, 
        ON_DEMAND_ONLY
    };
    OAIBalancingStrategy::eOAIBalancingStrategy getValue() const;
    void setValue(const OAIBalancingStrategy::eOAIBalancingStrategy& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIBalancingStrategy)

#endif // OAIBalancingStrategy_H
