...
class OAILocationFilter : public OAIEnum {
public:
    OAILocationFilter();
    ...
    enum class eOAILocationFilter {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        AWS, 
        CUSTOM
    };
    OAILocationFilter::eOAILocationFilter getValue() const;
    void setValue(const OAILocationFilter::eOAILocationFilter& value);
