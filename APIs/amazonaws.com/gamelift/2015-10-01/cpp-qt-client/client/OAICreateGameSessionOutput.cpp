...
OAICreateGameSessionOutput::OAICreateGameSessionOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateGameSessionOutput::OAICreateGameSessionOutput() {
    this->initializeModel();
}

OAICreateGameSessionOutput::~OAICreateGameSessionOutput() {}

void OAICreateGameSessionOutput::initializeModel() {

    m_game_session_isSet = false;
    m_game_session_isValid = false;
}

void OAICreateGameSessionOutput::fromJson(QString jsonString) {
...
void OAICreateGameSessionOutput::fromJsonObject(QJsonObject json) {
...
QString OAICreateGameSessionOutput::asJson() const {
...
QJsonObject OAICreateGameSessionOutput::asJsonObject() const {
    QJsonObject obj;
...
OAICreateGameSessionOutput_GameSession OAICreateGameSessionOutput::getGameSession() const {
    return m_game_session;
}
void OAICreateGameSessionOutput::setGameSession(const OAICreateGameSessionOutput_GameSession &game_session) {
    m_game_session = game_session;
    m_game_session_isSet = true;
}

bool OAICreateGameSessionOutput::is_game_session_Set() const{
    return m_game_session_isSet;
}

bool OAICreateGameSessionOutput::is_game_session_Valid() const{
    return m_game_session_isValid;
}

bool OAICreateGameSessionOutput::isSet() const {
...
bool OAICreateGameSessionOutput::isValid() const {
