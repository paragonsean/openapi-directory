...
/*
 * OAIDescribeMatchmakingRuleSetsInput.h
 *
 * 
 */

#ifndef OAIDescribeMatchmakingRuleSetsInput_H
#define OAIDescribeMatchmakingRuleSetsInput_H
...
class OAIDescribeMatchmakingRuleSetsInput : public OAIObject {
public:
    OAIDescribeMatchmakingRuleSetsInput();
    OAIDescribeMatchmakingRuleSetsInput(QString json);
    ~OAIDescribeMatchmakingRuleSetsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeMatchmakingRuleSetsInput)

#endif // OAIDescribeMatchmakingRuleSetsInput_H
