...
#ifndef OAIGameServerGroup_H
#define OAIGameServerGroup_H
...
class OAIGameServerGroup : public OAIObject {
public:
    OAIGameServerGroup();
    OAIGameServerGroup(QString json);
    ~OAIGameServerGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGameServerGroup)

#endif // OAIGameServerGroup_H
