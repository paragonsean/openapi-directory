...
/*
 * OAILocationUpdateStatus.h
 *
 * 
 */

#ifndef OAILocationUpdateStatus_H
#define OAILocationUpdateStatus_H
...
class OAILocationUpdateStatus : public OAIEnum {
public:
    OAILocationUpdateStatus();
    OAILocationUpdateStatus(QString json);
    ~OAILocationUpdateStatus() override;
    ...
    enum class eOAILocationUpdateStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        PENDING_UPDATE
    };
    OAILocationUpdateStatus::eOAILocationUpdateStatus getValue() const;
    void setValue(const OAILocationUpdateStatus::eOAILocationUpdateStatus& value);
...
private:
    ...
    eOAILocationUpdateStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAILocationUpdateStatus)

#endif // OAILocationUpdateStatus_H
