...
OAIGameSessionStatusReason::OAIGameSessionStatusReason(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGameSessionStatusReason::OAIGameSessionStatusReason() {
    this->initializeModel();
}

OAIGameSessionStatusReason::~OAIGameSessionStatusReason() {}

void OAIGameSessionStatusReason::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIGameSessionStatusReason::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIGameSessionStatusReason::fromJson(QString jsonString) {
    
    if ( jsonString.compare("INTERRUPTED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGameSessionStatusReason::INTERRUPTED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIGameSessionStatusReason::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIGameSessionStatusReason::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIGameSessionStatusReason::INTERRUPTED:
            val = "INTERRUPTED";
            break;
        default:
            break;
...
QJsonValue OAIGameSessionStatusReason::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIGameSessionStatusReason::eOAIGameSessionStatusReason OAIGameSessionStatusReason::getValue() const {
    return m_value;
}

void OAIGameSessionStatusReason::setValue(const OAIGameSessionStatusReason::eOAIGameSessionStatusReason& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIGameSessionStatusReason::isSet() const {
    
    return m_value_isSet;
}

bool OAIGameSessionStatusReason::isValid() const {
