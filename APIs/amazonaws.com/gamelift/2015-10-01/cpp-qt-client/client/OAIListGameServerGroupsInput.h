...
/*
 * OAIListGameServerGroupsInput.h
 *
 * 
 */

#ifndef OAIListGameServerGroupsInput_H
#define OAIListGameServerGroupsInput_H
...
class OAIListGameServerGroupsInput : public OAIObject {
public:
    OAIListGameServerGroupsInput();
    OAIListGameServerGroupsInput(QString json);
    ~OAIListGameServerGroupsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListGameServerGroupsInput)

#endif // OAIListGameServerGroupsInput_H
