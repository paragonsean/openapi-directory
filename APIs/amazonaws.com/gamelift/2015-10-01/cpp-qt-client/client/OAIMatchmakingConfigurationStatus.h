...
/*
 * OAIMatchmakingConfigurationStatus.h
 *
 * 
 */

#ifndef OAIMatchmakingConfigurationStatus_H
#define OAIMatchmakingConfigurationStatus_H
...
class OAIMatchmakingConfigurationStatus : public OAIEnum {
public:
    OAIMatchmakingConfigurationStatus();
    OAIMatchmakingConfigurationStatus(QString json);
    ~OAIMatchmakingConfigurationStatus() override;
    ...
    enum class eOAIMatchmakingConfigurationStatus {
    ...
    OAIMatchmakingConfigurationStatus::eOAIMatchmakingConfigurationStatus getValue() const;
    void setValue(const OAIMatchmakingConfigurationStatus::eOAIMatchmakingConfigurationStatus& value);
...
private:
    ...
    eOAIMatchmakingConfigurationStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMatchmakingConfigurationStatus)

#endif // OAIMatchmakingConfigurationStatus_H
