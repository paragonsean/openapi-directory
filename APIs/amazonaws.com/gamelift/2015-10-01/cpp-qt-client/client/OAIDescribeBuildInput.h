...
/*
 * OAIDescribeBuildInput.h
 *
 * 
 */

#ifndef OAIDescribeBuildInput_H
#define OAIDescribeBuildInput_H
...
class OAIDescribeBuildInput : public OAIObject {
public:
    OAIDescribeBuildInput();
    OAIDescribeBuildInput(QString json);
    ~OAIDescribeBuildInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeBuildInput)

#endif // OAIDescribeBuildInput_H
