...
OAIDescribeFleetCapacityOutput::OAIDescribeFleetCapacityOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeFleetCapacityOutput::OAIDescribeFleetCapacityOutput() {
    this->initializeModel();
}

OAIDescribeFleetCapacityOutput::~OAIDescribeFleetCapacityOutput() {}

void OAIDescribeFleetCapacityOutput::initializeModel() {
...
void OAIDescribeFleetCapacityOutput::fromJson(QString jsonString) {
...
void OAIDescribeFleetCapacityOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeFleetCapacityOutput::asJson() const {
...
QJsonObject OAIDescribeFleetCapacityOutput::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeFleetCapacityOutput::getFleetCapacity() const {
    return m_fleet_capacity;
}
void OAIDescribeFleetCapacityOutput::setFleetCapacity(const QList &fleet_capacity) {
    m_fleet_capacity = fleet_capacity;
    m_fleet_capacity_isSet = true;
}

bool OAIDescribeFleetCapacityOutput::is_fleet_capacity_Set() const{
    return m_fleet_capacity_isSet;
}

bool OAIDescribeFleetCapacityOutput::is_fleet_capacity_Valid() const{
    return m_fleet_capacity_isValid;
}

QString OAIDescribeFleetCapacityOutput::getNextToken() const {
    return m_next_token;
}
void OAIDescribeFleetCapacityOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeFleetCapacityOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeFleetCapacityOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeFleetCapacityOutput::isSet() const {
...
bool OAIDescribeFleetCapacityOutput::isValid() const {
