...
/*
 * OAIDeleteFleetLocationsInput.h
 *
 * 
 */

#ifndef OAIDeleteFleetLocationsInput_H
#define OAIDeleteFleetLocationsInput_H
...
class OAIDeleteFleetLocationsInput : public OAIObject {
public:
    OAIDeleteFleetLocationsInput();
    OAIDeleteFleetLocationsInput(QString json);
    ~OAIDeleteFleetLocationsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteFleetLocationsInput)

#endif // OAIDeleteFleetLocationsInput_H
