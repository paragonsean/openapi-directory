...
/*
 * OAIGameSessionQueueDestination.h
 *
 * A fleet or alias designated in a game session queue. Queues fulfill requests for new game sessions by placing a new game session on any of the queue&#39;s destinations. 
 */

#ifndef OAIGameSessionQueueDestination_H
#define OAIGameSessionQueueDestination_H
...
class OAIGameSessionQueueDestination : public OAIObject {
public:
    OAIGameSessionQueueDestination();
    OAIGameSessionQueueDestination(QString json);
    ~OAIGameSessionQueueDestination() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGameSessionQueueDestination)

#endif // OAIGameSessionQueueDestination_H
