...
/*
 * OAIGameSessionDetail.h
 *
 * A game session&#39;s properties plus the protection policy currently in force.
 */

#ifndef OAIGameSessionDetail_H
#define OAIGameSessionDetail_H
...
namespace OpenAPI {
class OAIGameSessionDetail_GameSession;

class OAIGameSessionDetail : public OAIObject {
public:
    OAIGameSessionDetail();
    OAIGameSessionDetail(QString json);
    ~OAIGameSessionDetail() override;
    ...
    OAIGameSessionDetail_GameSession getGameSession() const;
    void setGameSession(const OAIGameSessionDetail_GameSession &game_session);
    bool is_game_session_Set() const;
    bool is_game_session_Valid() const;

    OAIProtectionPolicy getProtectionPolicy() const;
    void setProtectionPolicy(const OAIProtectionPolicy &protection_policy);
...
private:
    ...
    OAIGameSessionDetail_GameSession m_game_session;
    bool m_game_session_isSet;
    bool m_game_session_isValid;

    OAIProtectionPolicy m_protection_policy;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGameSessionDetail)

#endif // OAIGameSessionDetail_H
