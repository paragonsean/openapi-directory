...
/*
 * OAIUpdateMatchmakingConfigurationOutput.h
 *
 * 
 */

#ifndef OAIUpdateMatchmakingConfigurationOutput_H
#define OAIUpdateMatchmakingConfigurationOutput_H
...
namespace OpenAPI {
class OAIUpdateMatchmakingConfigurationOutput_Configuration;

class OAIUpdateMatchmakingConfigurationOutput : public OAIObject {
public:
    OAIUpdateMatchmakingConfigurationOutput();
    OAIUpdateMatchmakingConfigurationOutput(QString json);
    ~OAIUpdateMatchmakingConfigurationOutput() override;
    ...
    OAIUpdateMatchmakingConfigurationOutput_Configuration getConfiguration() const;
    void setConfiguration(const OAIUpdateMatchmakingConfigurationOutput_Configuration &configuration);
...
private:
    ...
    OAIUpdateMatchmakingConfigurationOutput_Configuration m_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateMatchmakingConfigurationOutput)

#endif // OAIUpdateMatchmakingConfigurationOutput_H
