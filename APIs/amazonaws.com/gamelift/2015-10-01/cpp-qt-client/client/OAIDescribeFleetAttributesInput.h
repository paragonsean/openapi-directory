...
/*
 * OAIDescribeFleetAttributesInput.h
 *
 * 
 */

#ifndef OAIDescribeFleetAttributesInput_H
#define OAIDescribeFleetAttributesInput_H
...
class OAIDescribeFleetAttributesInput : public OAIObject {
public:
    OAIDescribeFleetAttributesInput();
    OAIDescribeFleetAttributesInput(QString json);
    ~OAIDescribeFleetAttributesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFleetAttributesInput)

#endif // OAIDescribeFleetAttributesInput_H
