...
OAICreateBuildInput_StorageLocation::OAICreateBuildInput_StorageLocation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateBuildInput_StorageLocation::OAICreateBuildInput_StorageLocation() {
    this->initializeModel();
}

OAICreateBuildInput_StorageLocation::~OAICreateBuildInput_StorageLocation() {}

void OAICreateBuildInput_StorageLocation::initializeModel() {
...
void OAICreateBuildInput_StorageLocation::fromJson(QString jsonString) {
...
void OAICreateBuildInput_StorageLocation::fromJsonObject(QJsonObject json) {
...
QString OAICreateBuildInput_StorageLocation::asJson() const {
...
QJsonObject OAICreateBuildInput_StorageLocation::asJsonObject() const {
    QJsonObject obj;
    if (m_bucket_isSet) {
...
QString OAICreateBuildInput_StorageLocation::getBucket() const {
    return m_bucket;
}
void OAICreateBuildInput_StorageLocation::setBucket(const QString &bucket) {
    m_bucket = bucket;
    m_bucket_isSet = true;
}

bool OAICreateBuildInput_StorageLocation::is_bucket_Set() const{
    return m_bucket_isSet;
}

bool OAICreateBuildInput_StorageLocation::is_bucket_Valid() const{
    return m_bucket_isValid;
}

QString OAICreateBuildInput_StorageLocation::getKey() const {
    return m_key;
}
void OAICreateBuildInput_StorageLocation::setKey(const QString &key) {
    m_key = key;
    m_key_isSet = true;
}

bool OAICreateBuildInput_StorageLocation::is_key_Set() const{
    return m_key_isSet;
}

bool OAICreateBuildInput_StorageLocation::is_key_Valid() const{
    return m_key_isValid;
}

QString OAICreateBuildInput_StorageLocation::getRoleArn() const {
    return m_role_arn;
}
void OAICreateBuildInput_StorageLocation::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAICreateBuildInput_StorageLocation::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAICreateBuildInput_StorageLocation::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

QString OAICreateBuildInput_StorageLocation::getObjectVersion() const {
    return m_object_version;
}
void OAICreateBuildInput_StorageLocation::setObjectVersion(const QString &object_version) {
    m_object_version = object_version;
    m_object_version_isSet = true;
}

bool OAICreateBuildInput_StorageLocation::is_object_version_Set() const{
    return m_object_version_isSet;
}

bool OAICreateBuildInput_StorageLocation::is_object_version_Valid() const{
    return m_object_version_isValid;
}

bool OAICreateBuildInput_StorageLocation::isSet() const {
...
bool OAICreateBuildInput_StorageLocation::isValid() const {
