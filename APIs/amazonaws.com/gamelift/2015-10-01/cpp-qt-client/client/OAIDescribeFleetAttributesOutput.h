...
/*
 * OAIDescribeFleetAttributesOutput.h
 *
 * 
 */

#ifndef OAIDescribeFleetAttributesOutput_H
#define OAIDescribeFleetAttributesOutput_H
...
class OAIDescribeFleetAttributesOutput : public OAIObject {
public:
    OAIDescribeFleetAttributesOutput();
    OAIDescribeFleetAttributesOutput(QString json);
    ~OAIDescribeFleetAttributesOutput() override;
    ...
    QList getFleetAttributes() const;
    void setFleetAttributes(const QList &fleet_attributes);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFleetAttributesOutput)

#endif // OAIDescribeFleetAttributesOutput_H
