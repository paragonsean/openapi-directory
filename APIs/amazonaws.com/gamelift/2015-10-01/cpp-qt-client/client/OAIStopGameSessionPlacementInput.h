...
/*
 * OAIStopGameSessionPlacementInput.h
 *
 * 
 */

#ifndef OAIStopGameSessionPlacementInput_H
#define OAIStopGameSessionPlacementInput_H
...
class OAIStopGameSessionPlacementInput : public OAIObject {
public:
    OAIStopGameSessionPlacementInput();
    OAIStopGameSessionPlacementInput(QString json);
    ~OAIStopGameSessionPlacementInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopGameSessionPlacementInput)

#endif // OAIStopGameSessionPlacementInput_H
