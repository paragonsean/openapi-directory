...
/*
 * OAIDescribeGameSessionDetailsOutput.h
 *
 * 
 */

#ifndef OAIDescribeGameSessionDetailsOutput_H
#define OAIDescribeGameSessionDetailsOutput_H
...
class OAIDescribeGameSessionDetailsOutput : public OAIObject {
public:
    OAIDescribeGameSessionDetailsOutput();
    OAIDescribeGameSessionDetailsOutput(QString json);
    ~OAIDescribeGameSessionDetailsOutput() override;
    ...
    QList getGameSessionDetails() const;
    void setGameSessionDetails(const QList &game_session_details);
    bool is_game_session_details_Set() const;
    bool is_game_session_details_Valid() const;
...
private:
    ...
    QList m_game_session_details;
    bool m_game_session_details_isSet;
    bool m_game_session_details_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeGameSessionDetailsOutput)

#endif // OAIDescribeGameSessionDetailsOutput_H
