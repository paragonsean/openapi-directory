...
/*
 * OAIGetGameSessionLogUrlInput.h
 *
 * 
 */

#ifndef OAIGetGameSessionLogUrlInput_H
#define OAIGetGameSessionLogUrlInput_H
...
class OAIGetGameSessionLogUrlInput : public OAIObject {
public:
    OAIGetGameSessionLogUrlInput();
    OAIGetGameSessionLogUrlInput(QString json);
    ~OAIGetGameSessionLogUrlInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetGameSessionLogUrlInput)

#endif // OAIGetGameSessionLogUrlInput_H
