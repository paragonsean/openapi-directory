...
/*
 * OAICreateBuildOutput_StorageLocation.h
 *
 * 
 */

#ifndef OAICreateBuildOutput_StorageLocation_H
#define OAICreateBuildOutput_StorageLocation_H
...
class OAICreateBuildOutput_StorageLocation : public OAIObject {
public:
    OAICreateBuildOutput_StorageLocation();
    OAICreateBuildOutput_StorageLocation(QString json);
    ~OAICreateBuildOutput_StorageLocation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateBuildOutput_StorageLocation)

#endif // OAICreateBuildOutput_StorageLocation_H
