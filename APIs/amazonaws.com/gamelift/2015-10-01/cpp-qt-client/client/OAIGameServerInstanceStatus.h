...
/*
 * OAIGameServerInstanceStatus.h
 *
 * 
 */

#ifndef OAIGameServerInstanceStatus_H
#define OAIGameServerInstanceStatus_H
...
class OAIGameServerInstanceStatus : public OAIEnum {
public:
    OAIGameServerInstanceStatus();
    OAIGameServerInstanceStatus(QString json);
    ~OAIGameServerInstanceStatus() override;
    ...
    enum class eOAIGameServerInstanceStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ACTIVE, 
        DRAINING, 
        SPOT_TERMINATING
    };
    OAIGameServerInstanceStatus::eOAIGameServerInstanceStatus getValue() const;
    void setValue(const OAIGameServerInstanceStatus::eOAIGameServerInstanceStatus& value);
...
private:
    ...
    eOAIGameServerInstanceStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGameServerInstanceStatus)

#endif // OAIGameServerInstanceStatus_H
