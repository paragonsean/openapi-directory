...
/*
 * OAIGetGameSessionLogUrlOutput.h
 *
 * 
 */

#ifndef OAIGetGameSessionLogUrlOutput_H
#define OAIGetGameSessionLogUrlOutput_H
...
class OAIGetGameSessionLogUrlOutput : public OAIObject {
public:
    OAIGetGameSessionLogUrlOutput();
    OAIGetGameSessionLogUrlOutput(QString json);
    ~OAIGetGameSessionLogUrlOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetGameSessionLogUrlOutput)

#endif // OAIGetGameSessionLogUrlOutput_H
