...
/*
 * OAIDescribeScalingPoliciesOutput.h
 *
 * 
 */

#ifndef OAIDescribeScalingPoliciesOutput_H
#define OAIDescribeScalingPoliciesOutput_H
...
class OAIDescribeScalingPoliciesOutput : public OAIObject {
public:
    OAIDescribeScalingPoliciesOutput();
    OAIDescribeScalingPoliciesOutput(QString json);
    ~OAIDescribeScalingPoliciesOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeScalingPoliciesOutput)

#endif // OAIDescribeScalingPoliciesOutput_H
