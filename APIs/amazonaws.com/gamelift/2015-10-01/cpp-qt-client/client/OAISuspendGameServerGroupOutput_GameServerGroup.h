...
/*
 * OAISuspendGameServerGroupOutput_GameServerGroup.h
 *
 * 
 */

#ifndef OAISuspendGameServerGroupOutput_GameServerGroup_H
#define OAISuspendGameServerGroupOutput_GameServerGroup_H
...
class OAISuspendGameServerGroupOutput_GameServerGroup : public OAIObject {
public:
    OAISuspendGameServerGroupOutput_GameServerGroup();
    OAISuspendGameServerGroupOutput_GameServerGroup(QString json);
    ~OAISuspendGameServerGroupOutput_GameServerGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISuspendGameServerGroupOutput_GameServerGroup)

#endif // OAISuspendGameServerGroupOutput_GameServerGroup_H
