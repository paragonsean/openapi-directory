...
OAICreateGameServerGroupOutput::OAICreateGameServerGroupOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateGameServerGroupOutput::OAICreateGameServerGroupOutput() {
    this->initializeModel();
}

OAICreateGameServerGroupOutput::~OAICreateGameServerGroupOutput() {}

void OAICreateGameServerGroupOutput::initializeModel() {

    m_game_server_group_isSet = false;
    m_game_server_group_isValid = false;
}

void OAICreateGameServerGroupOutput::fromJson(QString jsonString) {
...
void OAICreateGameServerGroupOutput::fromJsonObject(QJsonObject json) {
...
QString OAICreateGameServerGroupOutput::asJson() const {
...
QJsonObject OAICreateGameServerGroupOutput::asJsonObject() const {
    QJsonObject obj;
...
OAICreateGameServerGroupOutput_GameServerGroup OAICreateGameServerGroupOutput::getGameServerGroup() const {
    return m_game_server_group;
}
void OAICreateGameServerGroupOutput::setGameServerGroup(const OAICreateGameServerGroupOutput_GameServerGroup &game_server_group) {
    m_game_server_group = game_server_group;
    m_game_server_group_isSet = true;
}

bool OAICreateGameServerGroupOutput::is_game_server_group_Set() const{
    return m_game_server_group_isSet;
}

bool OAICreateGameServerGroupOutput::is_game_server_group_Valid() const{
    return m_game_server_group_isValid;
}

bool OAICreateGameServerGroupOutput::isSet() const {
...
bool OAICreateGameServerGroupOutput::isValid() const {
