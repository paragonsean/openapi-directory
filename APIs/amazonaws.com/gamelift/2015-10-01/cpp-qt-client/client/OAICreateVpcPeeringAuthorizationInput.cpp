...
OAICreateVpcPeeringAuthorizationInput::OAICreateVpcPeeringAuthorizationInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateVpcPeeringAuthorizationInput::OAICreateVpcPeeringAuthorizationInput() {
    this->initializeModel();
}

OAICreateVpcPeeringAuthorizationInput::~OAICreateVpcPeeringAuthorizationInput() {}

void OAICreateVpcPeeringAuthorizationInput::initializeModel() {
...
void OAICreateVpcPeeringAuthorizationInput::fromJson(QString jsonString) {
...
void OAICreateVpcPeeringAuthorizationInput::fromJsonObject(QJsonObject json) {
...
QString OAICreateVpcPeeringAuthorizationInput::asJson() const {
...
QJsonObject OAICreateVpcPeeringAuthorizationInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateVpcPeeringAuthorizationInput::getGameLiftAwsAccountId() const {
    return m_game_lift_aws_account_id;
}
void OAICreateVpcPeeringAuthorizationInput::setGameLiftAwsAccountId(const QString &game_lift_aws_account_id) {
    m_game_lift_aws_account_id = game_lift_aws_account_id;
    m_game_lift_aws_account_id_isSet = true;
}

bool OAICreateVpcPeeringAuthorizationInput::is_game_lift_aws_account_id_Set() const{
    return m_game_lift_aws_account_id_isSet;
}

bool OAICreateVpcPeeringAuthorizationInput::is_game_lift_aws_account_id_Valid() const{
    return m_game_lift_aws_account_id_isValid;
}

QString OAICreateVpcPeeringAuthorizationInput::getPeerVpcId() const {
    return m_peer_vpc_id;
}
void OAICreateVpcPeeringAuthorizationInput::setPeerVpcId(const QString &peer_vpc_id) {
    m_peer_vpc_id = peer_vpc_id;
    m_peer_vpc_id_isSet = true;
}

bool OAICreateVpcPeeringAuthorizationInput::is_peer_vpc_id_Set() const{
    return m_peer_vpc_id_isSet;
}

bool OAICreateVpcPeeringAuthorizationInput::is_peer_vpc_id_Valid() const{
    return m_peer_vpc_id_isValid;
}

bool OAICreateVpcPeeringAuthorizationInput::isSet() const {
...
bool OAICreateVpcPeeringAuthorizationInput::isValid() const {
