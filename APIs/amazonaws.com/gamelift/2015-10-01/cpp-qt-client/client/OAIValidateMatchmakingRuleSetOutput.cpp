...
OAIValidateMatchmakingRuleSetOutput::OAIValidateMatchmakingRuleSetOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIValidateMatchmakingRuleSetOutput::OAIValidateMatchmakingRuleSetOutput() {
    this->initializeModel();
}

OAIValidateMatchmakingRuleSetOutput::~OAIValidateMatchmakingRuleSetOutput() {}

void OAIValidateMatchmakingRuleSetOutput::initializeModel() {

    m_r_valid_isSet = false;
    m_r_valid_isValid = false;
}

void OAIValidateMatchmakingRuleSetOutput::fromJson(QString jsonString) {
...
void OAIValidateMatchmakingRuleSetOutput::fromJsonObject(QJsonObject json) {
...
QString OAIValidateMatchmakingRuleSetOutput::asJson() const {
...
QJsonObject OAIValidateMatchmakingRuleSetOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_r_valid_isSet) {
...
bool OAIValidateMatchmakingRuleSetOutput::getRValid() const {
    return m_r_valid;
}
void OAIValidateMatchmakingRuleSetOutput::setRValid(const bool &r_valid) {
    m_r_valid = r_valid;
    m_r_valid_isSet = true;
}

bool OAIValidateMatchmakingRuleSetOutput::is_r_valid_Set() const{
    return m_r_valid_isSet;
}

bool OAIValidateMatchmakingRuleSetOutput::is_r_valid_Valid() const{
    return m_r_valid_isValid;
}

bool OAIValidateMatchmakingRuleSetOutput::isSet() const {
...
bool OAIValidateMatchmakingRuleSetOutput::isValid() const {
