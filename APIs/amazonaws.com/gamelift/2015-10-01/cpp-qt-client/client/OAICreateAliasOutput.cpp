...
OAICreateAliasOutput::OAICreateAliasOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateAliasOutput::OAICreateAliasOutput() {
    this->initializeModel();
}

OAICreateAliasOutput::~OAICreateAliasOutput() {}

void OAICreateAliasOutput::initializeModel() {

    m_alias_isSet = false;
    m_alias_isValid = false;
}

void OAICreateAliasOutput::fromJson(QString jsonString) {
...
QJsonObject OAICreateAliasOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_alias.isSet()) {
...
OAICreateAliasOutput_Alias OAICreateAliasOutput::getAlias() const {
    return m_alias;
}
void OAICreateAliasOutput::setAlias(const OAICreateAliasOutput_Alias &alias) {
    m_alias = alias;
    m_alias_isSet = true;
}

bool OAICreateAliasOutput::is_alias_Set() const{
    return m_alias_isSet;
}

bool OAICreateAliasOutput::is_alias_Valid() const{
    return m_alias_isValid;
}

bool OAICreateAliasOutput::isSet() const {
...
bool OAICreateAliasOutput::isValid() const {
