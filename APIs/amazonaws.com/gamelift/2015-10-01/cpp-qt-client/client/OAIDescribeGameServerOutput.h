...
/*
 * OAIDescribeGameServerOutput.h
 *
 * 
 */

#ifndef OAIDescribeGameServerOutput_H
#define OAIDescribeGameServerOutput_H

#include <QJsonObject>

#include "OAIDescribeGameServerOutput_GameServer.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIDescribeGameServerOutput_GameServer;

class OAIDescribeGameServerOutput : public OAIObject {
public:
    OAIDescribeGameServerOutput();
    OAIDescribeGameServerOutput(QString json);
    ~OAIDescribeGameServerOutput() override;
    ...
    OAIDescribeGameServerOutput_GameServer getGameServer() const;
    void setGameServer(const OAIDescribeGameServerOutput_GameServer &game_server);
    bool is_game_server_Set() const;
    bool is_game_server_Valid() const;
...
private:
    ...
    OAIDescribeGameServerOutput_GameServer m_game_server;
    bool m_game_server_isSet;
    bool m_game_server_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeGameServerOutput)

#endif // OAIDescribeGameServerOutput_H
