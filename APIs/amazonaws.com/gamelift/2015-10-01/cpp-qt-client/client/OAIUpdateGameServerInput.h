...
/*
 * OAIUpdateGameServerInput.h
 *
 * 
 */

#ifndef OAIUpdateGameServerInput_H
#define OAIUpdateGameServerInput_H

#include <QJsonObject>

#include "OAIGameServerHealthCheck.h"
...
class OAIUpdateGameServerInput : public OAIObject {
public:
    OAIUpdateGameServerInput();
    OAIUpdateGameServerInput(QString json);
    ~OAIUpdateGameServerInput() override;
    ...
    OAIGameServerHealthCheck getHealthCheck() const;
    void setHealthCheck(const OAIGameServerHealthCheck &health_check);
...
private:
    ...
    OAIGameServerHealthCheck m_health_check;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateGameServerInput)

#endif // OAIUpdateGameServerInput_H
