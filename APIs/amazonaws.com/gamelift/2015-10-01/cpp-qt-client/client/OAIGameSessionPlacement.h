...
class OAIGameSessionPlacement : public OAIObject {
public:
    OAIGameSessionPlacement();
    OAIGameSessionPlacement(QString json);
    ~OAIGameSessionPlacement() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGameSessionPlacement)

#endif // OAIGameSessionPlacement_H
