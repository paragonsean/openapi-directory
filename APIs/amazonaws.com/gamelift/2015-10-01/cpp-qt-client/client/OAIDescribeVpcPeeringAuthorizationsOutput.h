...
/*
 * OAIDescribeVpcPeeringAuthorizationsOutput.h
 *
 * 
 */

#ifndef OAIDescribeVpcPeeringAuthorizationsOutput_H
#define OAIDescribeVpcPeeringAuthorizationsOutput_H
...
class OAIDescribeVpcPeeringAuthorizationsOutput : public OAIObject {
public:
    OAIDescribeVpcPeeringAuthorizationsOutput();
    OAIDescribeVpcPeeringAuthorizationsOutput(QString json);
    ~OAIDescribeVpcPeeringAuthorizationsOutput() override;
    ...
    QList getVpcPeeringAuthorizations() const;
    void setVpcPeeringAuthorizations(const QList &vpc_peering_authorizations);
    bool is_vpc_peering_authorizations_Set() const;
    bool is_vpc_peering_authorizations_Valid() const;
...
private:
    ...
    QList m_vpc_peering_authorizations;
    bool m_vpc_peering_authorizations_isSet;
    bool m_vpc_peering_authorizations_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeVpcPeeringAuthorizationsOutput)

#endif // OAIDescribeVpcPeeringAuthorizationsOutput_H
