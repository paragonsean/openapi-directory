...
#ifndef OAIPriorityType_H
#define OAIPriorityType_H
...
class OAIPriorityType : public OAIEnum {
public:
    OAIPriorityType();
    OAIPriorityType(QString json);
    ~OAIPriorityType() override;
    ...
    OAIPriorityType::eOAIPriorityType getValue() const;
    void setValue(const OAIPriorityType::eOAIPriorityType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPriorityType)

#endif // OAIPriorityType_H
