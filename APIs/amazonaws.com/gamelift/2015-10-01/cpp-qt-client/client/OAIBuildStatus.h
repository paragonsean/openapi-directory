...
class OAIBuildStatus : public OAIEnum {
public:
    OAIBuildStatus();
    ...
    enum class eOAIBuildStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        INITIALIZED, 
        READY, 
        FAILED
    };
    OAIBuildStatus::eOAIBuildStatus getValue() const;
    void setValue(const OAIBuildStatus::eOAIBuildStatus& value);
