...
OAIStartMatchBackfillOutput::OAIStartMatchBackfillOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartMatchBackfillOutput::OAIStartMatchBackfillOutput() {
    this->initializeModel();
}

OAIStartMatchBackfillOutput::~OAIStartMatchBackfillOutput() {}

void OAIStartMatchBackfillOutput::initializeModel() {

    m_matchmaking_ticket_isSet = false;
    m_matchmaking_ticket_isValid = false;
}

void OAIStartMatchBackfillOutput::fromJson(QString jsonString) {
...
void OAIStartMatchBackfillOutput::fromJsonObject(QJsonObject json) {

    m_matchmaking_ticket_isValid = ::OpenAPI::fromJsonValue(m_matchmaking_ticket, json[QString("MatchmakingTicket")]);
    m_matchmaking_ticket_isSet = !json[QString("MatchmakingTicket")].isNull() && m_matchmaking_ticket_isValid;
}

QString OAIStartMatchBackfillOutput::asJson() const {
...
QJsonObject OAIStartMatchBackfillOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_matchmaking_ticket.isSet()) {
        obj.insert(QString("MatchmakingTicket"), ::OpenAPI::toJsonValue(m_matchmaking_ticket));
    }
    return obj;
}

OAIStartMatchBackfillOutput_MatchmakingTicket OAIStartMatchBackfillOutput::getMatchmakingTicket() const {
    return m_matchmaking_ticket;
}
void OAIStartMatchBackfillOutput::setMatchmakingTicket(const OAIStartMatchBackfillOutput_MatchmakingTicket &matchmaking_ticket) {
    m_matchmaking_ticket = matchmaking_ticket;
    m_matchmaking_ticket_isSet = true;
}

bool OAIStartMatchBackfillOutput::is_matchmaking_ticket_Set() const{
    return m_matchmaking_ticket_isSet;
}

bool OAIStartMatchBackfillOutput::is_matchmaking_ticket_Valid() const{
    return m_matchmaking_ticket_isValid;
}

bool OAIStartMatchBackfillOutput::isSet() const {
...
bool OAIStartMatchBackfillOutput::isValid() const {
