...
import org.openapitools.client.model.EventCode;
...
public class Event {
  ...
  public static final String SERIALIZED_NAME_PRE_SIGNED_LOG_URL = "PreSignedLogUrl";
  @SerializedName(SERIALIZED_NAME_PRE_SIGNED_LOG_URL)
  ...
  public Event preSignedLogUrl(String preSignedLogUrl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.eventId, event.eventId) &&
        ...
        Objects.equals(this.preSignedLogUrl, event.preSignedLogUrl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eventId, resourceId, eventCode, message, eventTime, preSignedLogUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("    preSignedLogUrl: ").append(toIndentedString(preSignedLogUrl)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("PreSignedLogUrl");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("EventCode") != null && !jsonObj.get("EventCode").isJsonNull()) {
      ...
      if (jsonObj.get("PreSignedLogUrl") != null && !jsonObj.get("PreSignedLogUrl").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("PreSignedLogUrl"));
      }
  }
