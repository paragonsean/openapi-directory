...
public class DescribeScriptInput {
  ...
  public DescribeScriptInput() {
  }

  public DescribeScriptInput scriptId(String scriptId) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeScriptInput describeScriptInput = (DescribeScriptInput) o;
    return Objects.equals(this.scriptId, describeScriptInput.scriptId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeScriptInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeScriptInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeScriptInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeScriptInput is not found in the empty JSON string", DescribeScriptInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeScriptInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeScriptInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeScriptInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeScriptInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeScriptInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeScriptInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeScriptInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeScriptInput>() {
           @Override
           public void write(JsonWriter out, DescribeScriptInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeScriptInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeScriptInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeScriptInput
   * @throws IOException if the JSON string is invalid with respect to DescribeScriptInput
   */
  public static DescribeScriptInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeScriptInput.class);
  }

  /**
   * Convert an instance of DescribeScriptInput to an JSON string
   *
   * @return JSON string
   */
