...
public class PlacedPlayerSession {
  ...
  public PlacedPlayerSession playerId(String playerId) {
  ...
  public PlacedPlayerSession playerSessionId(String playerSessionId) {
  ...
  public boolean equals(Object o) {
    ...
    PlacedPlayerSession placedPlayerSession = (PlacedPlayerSession) o;
    return Objects.equals(this.playerId, placedPlayerSession.playerId) &&
        Objects.equals(this.playerSessionId, placedPlayerSession.playerSessionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class PlacedPlayerSession {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PlacedPlayerSession
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PlacedPlayerSession.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PlacedPlayerSession is not found in the empty JSON string", PlacedPlayerSession.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PlacedPlayerSession.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PlacedPlayerSession` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PlacedPlayerSession.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PlacedPlayerSession' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PlacedPlayerSession> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PlacedPlayerSession.class));

       return (TypeAdapter<T>) new TypeAdapter<PlacedPlayerSession>() {
           @Override
           public void write(JsonWriter out, PlacedPlayerSession value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PlacedPlayerSession read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PlacedPlayerSession given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PlacedPlayerSession
   * @throws IOException if the JSON string is invalid with respect to PlacedPlayerSession
   */
  public static PlacedPlayerSession fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PlacedPlayerSession.class);
  }

  /**
   * Convert an instance of PlacedPlayerSession to an JSON string
   *
   * @return JSON string
   */
