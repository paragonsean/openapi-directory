...
public class UpdateFleetCapacityInput {
  ...
  public UpdateFleetCapacityInput() {
  }

  public UpdateFleetCapacityInput fleetId(String fleetId) {
  ...
  public UpdateFleetCapacityInput desiredInstances(Integer desiredInstances) {
  ...
  public UpdateFleetCapacityInput minSize(Integer minSize) {
  ...
  public UpdateFleetCapacityInput maxSize(Integer maxSize) {
  ...
  public UpdateFleetCapacityInput location(String location) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateFleetCapacityInput updateFleetCapacityInput = (UpdateFleetCapacityInput) o;
    return Objects.equals(this.fleetId, updateFleetCapacityInput.fleetId) &&
        Objects.equals(this.desiredInstances, updateFleetCapacityInput.desiredInstances) &&
        Objects.equals(this.minSize, updateFleetCapacityInput.minSize) &&
        Objects.equals(this.maxSize, updateFleetCapacityInput.maxSize) &&
        Objects.equals(this.location, updateFleetCapacityInput.location);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fleetId, desiredInstances, minSize, maxSize, location);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateFleetCapacityInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateFleetCapacityInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateFleetCapacityInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateFleetCapacityInput is not found in the empty JSON string", UpdateFleetCapacityInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateFleetCapacityInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateFleetCapacityInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateFleetCapacityInput.openapiRequiredFields) {
      ...
      if (jsonObj.get("DesiredInstances") != null && !jsonObj.get("DesiredInstances").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateFleetCapacityInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateFleetCapacityInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateFleetCapacityInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateFleetCapacityInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateFleetCapacityInput>() {
           @Override
           public void write(JsonWriter out, UpdateFleetCapacityInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateFleetCapacityInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateFleetCapacityInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateFleetCapacityInput
   * @throws IOException if the JSON string is invalid with respect to UpdateFleetCapacityInput
   */
  public static UpdateFleetCapacityInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateFleetCapacityInput.class);
  }

  /**
   * Convert an instance of UpdateFleetCapacityInput to an JSON string
   *
   * @return JSON string
   */
