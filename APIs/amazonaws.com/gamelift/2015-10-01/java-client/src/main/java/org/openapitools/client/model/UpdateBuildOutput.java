...
public class UpdateBuildOutput {
  ...
  private UpdateBuildOutputBuild build;

  public UpdateBuildOutput() {
  }

  public UpdateBuildOutput build(UpdateBuildOutputBuild build) {
    this.build = build;
    return this;
  }
  ...
  public UpdateBuildOutputBuild getBuild() {
    return build;
  }

  public void setBuild(UpdateBuildOutputBuild build) {
    this.build = build;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateBuildOutput updateBuildOutput = (UpdateBuildOutput) o;
    return Objects.equals(this.build, updateBuildOutput.build);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateBuildOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateBuildOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateBuildOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateBuildOutput is not found in the empty JSON string", UpdateBuildOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateBuildOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateBuildOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Build`
      if (jsonObj.get("Build") != null && !jsonObj.get("Build").isJsonNull()) {
        UpdateBuildOutputBuild.validateJsonElement(jsonObj.get("Build"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateBuildOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateBuildOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateBuildOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateBuildOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateBuildOutput>() {
           @Override
           public void write(JsonWriter out, UpdateBuildOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateBuildOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateBuildOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateBuildOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateBuildOutput
   */
  public static UpdateBuildOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateBuildOutput.class);
  }

  /**
   * Convert an instance of UpdateBuildOutput to an JSON string
   *
   * @return JSON string
   */
