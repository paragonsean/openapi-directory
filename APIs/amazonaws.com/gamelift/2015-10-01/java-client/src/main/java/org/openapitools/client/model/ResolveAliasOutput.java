...
public class ResolveAliasOutput {
  ...
  public ResolveAliasOutput fleetId(String fleetId) {
  ...
  public ResolveAliasOutput fleetArn(String fleetArn) {
  ...
  public boolean equals(Object o) {
    ...
    ResolveAliasOutput resolveAliasOutput = (ResolveAliasOutput) o;
    return Objects.equals(this.fleetId, resolveAliasOutput.fleetId) &&
        Objects.equals(this.fleetArn, resolveAliasOutput.fleetArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResolveAliasOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResolveAliasOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResolveAliasOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResolveAliasOutput is not found in the empty JSON string", ResolveAliasOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResolveAliasOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResolveAliasOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResolveAliasOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResolveAliasOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResolveAliasOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResolveAliasOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ResolveAliasOutput>() {
           @Override
           public void write(JsonWriter out, ResolveAliasOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResolveAliasOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResolveAliasOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResolveAliasOutput
   * @throws IOException if the JSON string is invalid with respect to ResolveAliasOutput
   */
  public static ResolveAliasOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResolveAliasOutput.class);
  }

  /**
   * Convert an instance of ResolveAliasOutput to an JSON string
   *
   * @return JSON string
   */
