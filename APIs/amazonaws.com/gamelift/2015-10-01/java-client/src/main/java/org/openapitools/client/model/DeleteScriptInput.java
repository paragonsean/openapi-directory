...
public class DeleteScriptInput {
  ...
  public DeleteScriptInput() {
  }

  public DeleteScriptInput scriptId(String scriptId) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteScriptInput deleteScriptInput = (DeleteScriptInput) o;
    return Objects.equals(this.scriptId, deleteScriptInput.scriptId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteScriptInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteScriptInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteScriptInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteScriptInput is not found in the empty JSON string", DeleteScriptInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteScriptInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteScriptInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteScriptInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteScriptInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteScriptInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteScriptInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteScriptInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteScriptInput>() {
           @Override
           public void write(JsonWriter out, DeleteScriptInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteScriptInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteScriptInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteScriptInput
   * @throws IOException if the JSON string is invalid with respect to DeleteScriptInput
   */
  public static DeleteScriptInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteScriptInput.class);
  }

  /**
   * Convert an instance of DeleteScriptInput to an JSON string
   *
   * @return JSON string
   */
