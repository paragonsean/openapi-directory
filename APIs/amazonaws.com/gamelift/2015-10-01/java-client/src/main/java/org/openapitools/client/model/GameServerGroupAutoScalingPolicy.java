...
public class GameServerGroupAutoScalingPolicy {
  ...
  public GameServerGroupAutoScalingPolicy estimatedInstanceWarmup(Integer estimatedInstanceWarmup) {
  ...
  public GameServerGroupAutoScalingPolicy targetTrackingConfiguration(GameServerGroupAutoScalingPolicyTargetTrackingConfiguration targetTrackingConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    GameServerGroupAutoScalingPolicy gameServerGroupAutoScalingPolicy = (GameServerGroupAutoScalingPolicy) o;
    return Objects.equals(this.estimatedInstanceWarmup, gameServerGroupAutoScalingPolicy.estimatedInstanceWarmup) &&
        Objects.equals(this.targetTrackingConfiguration, gameServerGroupAutoScalingPolicy.targetTrackingConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class GameServerGroupAutoScalingPolicy {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GameServerGroupAutoScalingPolicy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GameServerGroupAutoScalingPolicy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GameServerGroupAutoScalingPolicy is not found in the empty JSON string", GameServerGroupAutoScalingPolicy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GameServerGroupAutoScalingPolicy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GameServerGroupAutoScalingPolicy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GameServerGroupAutoScalingPolicy.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GameServerGroupAutoScalingPolicy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GameServerGroupAutoScalingPolicy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GameServerGroupAutoScalingPolicy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GameServerGroupAutoScalingPolicy.class));

       return (TypeAdapter<T>) new TypeAdapter<GameServerGroupAutoScalingPolicy>() {
           @Override
           public void write(JsonWriter out, GameServerGroupAutoScalingPolicy value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GameServerGroupAutoScalingPolicy read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GameServerGroupAutoScalingPolicy given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GameServerGroupAutoScalingPolicy
   * @throws IOException if the JSON string is invalid with respect to GameServerGroupAutoScalingPolicy
   */
  public static GameServerGroupAutoScalingPolicy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GameServerGroupAutoScalingPolicy.class);
  }

  /**
   * Convert an instance of GameServerGroupAutoScalingPolicy to an JSON string
   *
   * @return JSON string
   */
