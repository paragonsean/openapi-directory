...
public class CreatePlayerSessionInput {
  ...
  public CreatePlayerSessionInput() {
  }

  public CreatePlayerSessionInput gameSessionId(String gameSessionId) {
  ...
  public CreatePlayerSessionInput playerId(String playerId) {
  ...
  public CreatePlayerSessionInput playerData(String playerData) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePlayerSessionInput createPlayerSessionInput = (CreatePlayerSessionInput) o;
    return Objects.equals(this.gameSessionId, createPlayerSessionInput.gameSessionId) &&
        Objects.equals(this.playerId, createPlayerSessionInput.playerId) &&
        Objects.equals(this.playerData, createPlayerSessionInput.playerData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gameSessionId, playerId, playerData);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreatePlayerSessionInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePlayerSessionInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePlayerSessionInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePlayerSessionInput is not found in the empty JSON string", CreatePlayerSessionInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePlayerSessionInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePlayerSessionInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreatePlayerSessionInput.openapiRequiredFields) {
      ...
      // validate the required field `PlayerId`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePlayerSessionInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePlayerSessionInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePlayerSessionInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePlayerSessionInput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePlayerSessionInput>() {
           @Override
           public void write(JsonWriter out, CreatePlayerSessionInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePlayerSessionInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePlayerSessionInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePlayerSessionInput
   * @throws IOException if the JSON string is invalid with respect to CreatePlayerSessionInput
   */
  public static CreatePlayerSessionInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePlayerSessionInput.class);
  }

  /**
   * Convert an instance of CreatePlayerSessionInput to an JSON string
   *
   * @return JSON string
   */
