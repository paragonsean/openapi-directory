...
public class CreateFleetLocationsInput {
  ...
  public CreateFleetLocationsInput() {
  }

  public CreateFleetLocationsInput fleetId(String fleetId) {
  ...
  public CreateFleetLocationsInput locations(List locations) {
  ...
  public boolean equals(Object o) {
    ...
    CreateFleetLocationsInput createFleetLocationsInput = (CreateFleetLocationsInput) o;
    return Objects.equals(this.fleetId, createFleetLocationsInput.fleetId) &&
        Objects.equals(this.locations, createFleetLocationsInput.locations);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fleetId, locations);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateFleetLocationsInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateFleetLocationsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateFleetLocationsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateFleetLocationsInput is not found in the empty JSON string", CreateFleetLocationsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateFleetLocationsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateFleetLocationsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateFleetLocationsInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateFleetLocationsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateFleetLocationsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateFleetLocationsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateFleetLocationsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateFleetLocationsInput>() {
           @Override
           public void write(JsonWriter out, CreateFleetLocationsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateFleetLocationsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateFleetLocationsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateFleetLocationsInput
   * @throws IOException if the JSON string is invalid with respect to CreateFleetLocationsInput
   */
  public static CreateFleetLocationsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateFleetLocationsInput.class);
  }

  /**
   * Convert an instance of CreateFleetLocationsInput to an JSON string
   *
   * @return JSON string
   */
