...
public class DescribeGameServerInstancesInput {
  ...
  public DescribeGameServerInstancesInput() {
  }

  public DescribeGameServerInstancesInput gameServerGroupName(String gameServerGroupName) {
  ...
  public DescribeGameServerInstancesInput instanceIds(List instanceIds) {
  ...
  public DescribeGameServerInstancesInput limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public DescribeGameServerInstancesInput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeGameServerInstancesInput describeGameServerInstancesInput = (DescribeGameServerInstancesInput) o;
    return Objects.equals(this.gameServerGroupName, describeGameServerInstancesInput.gameServerGroupName) &&
        Objects.equals(this.instanceIds, describeGameServerInstancesInput.instanceIds) &&
        Objects.equals(this.limit, describeGameServerInstancesInput.limit) &&
        Objects.equals(this.nextToken, describeGameServerInstancesInput.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gameServerGroupName, instanceIds, limit, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeGameServerInstancesInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeGameServerInstancesInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeGameServerInstancesInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeGameServerInstancesInput is not found in the empty JSON string", DescribeGameServerInstancesInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeGameServerInstancesInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeGameServerInstancesInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeGameServerInstancesInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeGameServerInstancesInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeGameServerInstancesInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeGameServerInstancesInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeGameServerInstancesInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeGameServerInstancesInput>() {
           @Override
           public void write(JsonWriter out, DescribeGameServerInstancesInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeGameServerInstancesInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeGameServerInstancesInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeGameServerInstancesInput
   * @throws IOException if the JSON string is invalid with respect to DescribeGameServerInstancesInput
   */
  public static DescribeGameServerInstancesInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeGameServerInstancesInput.class);
  }

  /**
   * Convert an instance of DescribeGameServerInstancesInput to an JSON string
   *
   * @return JSON string
   */
