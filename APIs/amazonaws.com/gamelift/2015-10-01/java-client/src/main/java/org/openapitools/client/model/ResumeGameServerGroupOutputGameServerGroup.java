...
public class ResumeGameServerGroupOutputGameServerGroup {
  ...
  public ResumeGameServerGroupOutputGameServerGroup() {
  }

  public ResumeGameServerGroupOutputGameServerGroup gameServerGroupName(String gameServerGroupName) {
  ...
  public ResumeGameServerGroupOutputGameServerGroup gameServerGroupArn(String gameServerGroupArn) {
  ...
  public ResumeGameServerGroupOutputGameServerGroup roleArn(String roleArn) {
  ...
  public ResumeGameServerGroupOutputGameServerGroup instanceDefinitions(List instanceDefinitions) {
  ...
  public ResumeGameServerGroupOutputGameServerGroup balancingStrategy(BalancingStrategy balancingStrategy) {
  ...
  public ResumeGameServerGroupOutputGameServerGroup gameServerProtectionPolicy(GameServerProtectionPolicy gameServerProtectionPolicy) {
  ...
  public ResumeGameServerGroupOutputGameServerGroup autoScalingGroupArn(String autoScalingGroupArn) {
  ...
  public ResumeGameServerGroupOutputGameServerGroup status(GameServerGroupStatus status) {
    this.status = status;
    return this;
  }
  ...
  public ResumeGameServerGroupOutputGameServerGroup statusReason(String statusReason) {
  ...
  public ResumeGameServerGroupOutputGameServerGroup suspendedActions(List suspendedActions) {
  ...
  public ResumeGameServerGroupOutputGameServerGroup creationTime(OffsetDateTime creationTime) {
  ...
  public ResumeGameServerGroupOutputGameServerGroup lastUpdatedTime(OffsetDateTime lastUpdatedTime) {
  ...
  public boolean equals(Object o) {
    ...
    ResumeGameServerGroupOutputGameServerGroup resumeGameServerGroupOutputGameServerGroup = (ResumeGameServerGroupOutputGameServerGroup) o;
    return Objects.equals(this.gameServerGroupName, resumeGameServerGroupOutputGameServerGroup.gameServerGroupName) &&
        Objects.equals(this.gameServerGroupArn, resumeGameServerGroupOutputGameServerGroup.gameServerGroupArn) &&
        Objects.equals(this.roleArn, resumeGameServerGroupOutputGameServerGroup.roleArn) &&
        Objects.equals(this.instanceDefinitions, resumeGameServerGroupOutputGameServerGroup.instanceDefinitions) &&
        Objects.equals(this.balancingStrategy, resumeGameServerGroupOutputGameServerGroup.balancingStrategy) &&
        Objects.equals(this.gameServerProtectionPolicy, resumeGameServerGroupOutputGameServerGroup.gameServerProtectionPolicy) &&
        Objects.equals(this.autoScalingGroupArn, resumeGameServerGroupOutputGameServerGroup.autoScalingGroupArn) &&
        Objects.equals(this.status, resumeGameServerGroupOutputGameServerGroup.status) &&
        Objects.equals(this.statusReason, resumeGameServerGroupOutputGameServerGroup.statusReason) &&
        Objects.equals(this.suspendedActions, resumeGameServerGroupOutputGameServerGroup.suspendedActions) &&
        Objects.equals(this.creationTime, resumeGameServerGroupOutputGameServerGroup.creationTime) &&
        Objects.equals(this.lastUpdatedTime, resumeGameServerGroupOutputGameServerGroup.lastUpdatedTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResumeGameServerGroupOutputGameServerGroup {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResumeGameServerGroupOutputGameServerGroup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResumeGameServerGroupOutputGameServerGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResumeGameServerGroupOutputGameServerGroup is not found in the empty JSON string", ResumeGameServerGroupOutputGameServerGroup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResumeGameServerGroupOutputGameServerGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResumeGameServerGroupOutputGameServerGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResumeGameServerGroupOutputGameServerGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResumeGameServerGroupOutputGameServerGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResumeGameServerGroupOutputGameServerGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResumeGameServerGroupOutputGameServerGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<ResumeGameServerGroupOutputGameServerGroup>() {
           @Override
           public void write(JsonWriter out, ResumeGameServerGroupOutputGameServerGroup value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResumeGameServerGroupOutputGameServerGroup read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResumeGameServerGroupOutputGameServerGroup given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResumeGameServerGroupOutputGameServerGroup
   * @throws IOException if the JSON string is invalid with respect to ResumeGameServerGroupOutputGameServerGroup
   */
  public static ResumeGameServerGroupOutputGameServerGroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResumeGameServerGroupOutputGameServerGroup.class);
  }

  /**
   * Convert an instance of ResumeGameServerGroupOutputGameServerGroup to an JSON string
   *
   * @return JSON string
   */
