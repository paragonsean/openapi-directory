...
public class RegisterGameServerOutputGameServer {
  ...
  public RegisterGameServerOutputGameServer() {
  }

  public RegisterGameServerOutputGameServer gameServerGroupName(String gameServerGroupName) {
  ...
  public RegisterGameServerOutputGameServer gameServerGroupArn(String gameServerGroupArn) {
  ...
  public RegisterGameServerOutputGameServer gameServerId(String gameServerId) {
  ...
  public RegisterGameServerOutputGameServer instanceId(String instanceId) {
  ...
  public RegisterGameServerOutputGameServer connectionInfo(String connectionInfo) {
  ...
  public RegisterGameServerOutputGameServer gameServerData(String gameServerData) {
  ...
  public RegisterGameServerOutputGameServer claimStatus(GameServerClaimStatus claimStatus) {
  ...
  public RegisterGameServerOutputGameServer utilizationStatus(GameServerUtilizationStatus utilizationStatus) {
  ...
  public RegisterGameServerOutputGameServer registrationTime(OffsetDateTime registrationTime) {
  ...
  public RegisterGameServerOutputGameServer lastClaimTime(OffsetDateTime lastClaimTime) {
  ...
  public RegisterGameServerOutputGameServer lastHealthCheckTime(OffsetDateTime lastHealthCheckTime) {
  ...
  public boolean equals(Object o) {
    ...
    RegisterGameServerOutputGameServer registerGameServerOutputGameServer = (RegisterGameServerOutputGameServer) o;
    return Objects.equals(this.gameServerGroupName, registerGameServerOutputGameServer.gameServerGroupName) &&
        Objects.equals(this.gameServerGroupArn, registerGameServerOutputGameServer.gameServerGroupArn) &&
        Objects.equals(this.gameServerId, registerGameServerOutputGameServer.gameServerId) &&
        Objects.equals(this.instanceId, registerGameServerOutputGameServer.instanceId) &&
        Objects.equals(this.connectionInfo, registerGameServerOutputGameServer.connectionInfo) &&
        Objects.equals(this.gameServerData, registerGameServerOutputGameServer.gameServerData) &&
        Objects.equals(this.claimStatus, registerGameServerOutputGameServer.claimStatus) &&
        Objects.equals(this.utilizationStatus, registerGameServerOutputGameServer.utilizationStatus) &&
        Objects.equals(this.registrationTime, registerGameServerOutputGameServer.registrationTime) &&
        Objects.equals(this.lastClaimTime, registerGameServerOutputGameServer.lastClaimTime) &&
        Objects.equals(this.lastHealthCheckTime, registerGameServerOutputGameServer.lastHealthCheckTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class RegisterGameServerOutputGameServer {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RegisterGameServerOutputGameServer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RegisterGameServerOutputGameServer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RegisterGameServerOutputGameServer is not found in the empty JSON string", RegisterGameServerOutputGameServer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RegisterGameServerOutputGameServer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RegisterGameServerOutputGameServer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RegisterGameServerOutputGameServer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RegisterGameServerOutputGameServer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RegisterGameServerOutputGameServer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RegisterGameServerOutputGameServer.class));

       return (TypeAdapter<T>) new TypeAdapter<RegisterGameServerOutputGameServer>() {
           @Override
           public void write(JsonWriter out, RegisterGameServerOutputGameServer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RegisterGameServerOutputGameServer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RegisterGameServerOutputGameServer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RegisterGameServerOutputGameServer
   * @throws IOException if the JSON string is invalid with respect to RegisterGameServerOutputGameServer
   */
  public static RegisterGameServerOutputGameServer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RegisterGameServerOutputGameServer.class);
  }

  /**
   * Convert an instance of RegisterGameServerOutputGameServer to an JSON string
   *
   * @return JSON string
   */
