...
import org.openapitools.client.model.GetComputeAccessOutputCredentials;
...
public class GetComputeAccessOutput {
  ...
  private GetComputeAccessOutputCredentials credentials;

  public GetComputeAccessOutput() {
  }

  public GetComputeAccessOutput fleetId(String fleetId) {
  ...
  public GetComputeAccessOutput fleetArn(String fleetArn) {
  ...
  public GetComputeAccessOutput computeName(String computeName) {
  ...
  public GetComputeAccessOutput computeArn(String computeArn) {
  ...
  public GetComputeAccessOutput credentials(GetComputeAccessOutputCredentials credentials) {
   ...
   */
  @javax.annotation.Nullable
  public GetComputeAccessOutputCredentials getCredentials() {
    return credentials;
  }

  public void setCredentials(GetComputeAccessOutputCredentials credentials) {
    this.credentials = credentials;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetComputeAccessOutput getComputeAccessOutput = (GetComputeAccessOutput) o;
    return Objects.equals(this.fleetId, getComputeAccessOutput.fleetId) &&
        Objects.equals(this.fleetArn, getComputeAccessOutput.fleetArn) &&
        Objects.equals(this.computeName, getComputeAccessOutput.computeName) &&
        Objects.equals(this.computeArn, getComputeAccessOutput.computeArn) &&
        Objects.equals(this.credentials, getComputeAccessOutput.credentials);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fleetId, fleetArn, computeName, computeArn, credentials);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetComputeAccessOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetComputeAccessOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetComputeAccessOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetComputeAccessOutput is not found in the empty JSON string", GetComputeAccessOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetComputeAccessOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetComputeAccessOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("Credentials") != null && !jsonObj.get("Credentials").isJsonNull()) {
        GetComputeAccessOutputCredentials.validateJsonElement(jsonObj.get("Credentials"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetComputeAccessOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetComputeAccessOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetComputeAccessOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetComputeAccessOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetComputeAccessOutput>() {
           @Override
           public void write(JsonWriter out, GetComputeAccessOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetComputeAccessOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetComputeAccessOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetComputeAccessOutput
   * @throws IOException if the JSON string is invalid with respect to GetComputeAccessOutput
   */
  public static GetComputeAccessOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetComputeAccessOutput.class);
  }

  /**
   * Convert an instance of GetComputeAccessOutput to an JSON string
   *
   * @return JSON string
   */
