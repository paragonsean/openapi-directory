...
public class UpdateMatchmakingConfigurationOutputConfiguration {
  ...
  public UpdateMatchmakingConfigurationOutputConfiguration() {
  }

  public UpdateMatchmakingConfigurationOutputConfiguration name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateMatchmakingConfigurationOutputConfiguration configurationArn(String configurationArn) {
  ...
  public UpdateMatchmakingConfigurationOutputConfiguration description(String description) {
  ...
  public UpdateMatchmakingConfigurationOutputConfiguration gameSessionQueueArns(List gameSessionQueueArns) {
  ...
  public UpdateMatchmakingConfigurationOutputConfiguration requestTimeoutSeconds(Integer requestTimeoutSeconds) {
  ...
  public UpdateMatchmakingConfigurationOutputConfiguration acceptanceTimeoutSeconds(Integer acceptanceTimeoutSeconds) {
  ...
  public UpdateMatchmakingConfigurationOutputConfiguration acceptanceRequired(Boolean acceptanceRequired) {
  ...
  public UpdateMatchmakingConfigurationOutputConfiguration ruleSetName(String ruleSetName) {
  ...
  public UpdateMatchmakingConfigurationOutputConfiguration ruleSetArn(String ruleSetArn) {
  ...
  public UpdateMatchmakingConfigurationOutputConfiguration notificationTarget(String notificationTarget) {
  ...
  public UpdateMatchmakingConfigurationOutputConfiguration additionalPlayerCount(Integer additionalPlayerCount) {
  ...
  public UpdateMatchmakingConfigurationOutputConfiguration customEventData(String customEventData) {
  ...
  public UpdateMatchmakingConfigurationOutputConfiguration creationTime(OffsetDateTime creationTime) {
  ...
  public UpdateMatchmakingConfigurationOutputConfiguration gameProperties(List gameProperties) {
  ...
  public UpdateMatchmakingConfigurationOutputConfiguration gameSessionData(String gameSessionData) {
  ...
  public UpdateMatchmakingConfigurationOutputConfiguration backfillMode(BackfillMode backfillMode) {
  ...
  public UpdateMatchmakingConfigurationOutputConfiguration flexMatchMode(FlexMatchMode flexMatchMode) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateMatchmakingConfigurationOutputConfiguration updateMatchmakingConfigurationOutputConfiguration = (UpdateMatchmakingConfigurationOutputConfiguration) o;
    return Objects.equals(this.name, updateMatchmakingConfigurationOutputConfiguration.name) &&
        Objects.equals(this.configurationArn, updateMatchmakingConfigurationOutputConfiguration.configurationArn) &&
        Objects.equals(this.description, updateMatchmakingConfigurationOutputConfiguration.description) &&
        Objects.equals(this.gameSessionQueueArns, updateMatchmakingConfigurationOutputConfiguration.gameSessionQueueArns) &&
        Objects.equals(this.requestTimeoutSeconds, updateMatchmakingConfigurationOutputConfiguration.requestTimeoutSeconds) &&
        Objects.equals(this.acceptanceTimeoutSeconds, updateMatchmakingConfigurationOutputConfiguration.acceptanceTimeoutSeconds) &&
        Objects.equals(this.acceptanceRequired, updateMatchmakingConfigurationOutputConfiguration.acceptanceRequired) &&
        Objects.equals(this.ruleSetName, updateMatchmakingConfigurationOutputConfiguration.ruleSetName) &&
        Objects.equals(this.ruleSetArn, updateMatchmakingConfigurationOutputConfiguration.ruleSetArn) &&
        Objects.equals(this.notificationTarget, updateMatchmakingConfigurationOutputConfiguration.notificationTarget) &&
        Objects.equals(this.additionalPlayerCount, updateMatchmakingConfigurationOutputConfiguration.additionalPlayerCount) &&
        Objects.equals(this.customEventData, updateMatchmakingConfigurationOutputConfiguration.customEventData) &&
        Objects.equals(this.creationTime, updateMatchmakingConfigurationOutputConfiguration.creationTime) &&
        Objects.equals(this.gameProperties, updateMatchmakingConfigurationOutputConfiguration.gameProperties) &&
        Objects.equals(this.gameSessionData, updateMatchmakingConfigurationOutputConfiguration.gameSessionData) &&
        Objects.equals(this.backfillMode, updateMatchmakingConfigurationOutputConfiguration.backfillMode) &&
        Objects.equals(this.flexMatchMode, updateMatchmakingConfigurationOutputConfiguration.flexMatchMode);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateMatchmakingConfigurationOutputConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateMatchmakingConfigurationOutputConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateMatchmakingConfigurationOutputConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateMatchmakingConfigurationOutputConfiguration is not found in the empty JSON string", UpdateMatchmakingConfigurationOutputConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateMatchmakingConfigurationOutputConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateMatchmakingConfigurationOutputConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateMatchmakingConfigurationOutputConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateMatchmakingConfigurationOutputConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateMatchmakingConfigurationOutputConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateMatchmakingConfigurationOutputConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateMatchmakingConfigurationOutputConfiguration>() {
           @Override
           public void write(JsonWriter out, UpdateMatchmakingConfigurationOutputConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateMatchmakingConfigurationOutputConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateMatchmakingConfigurationOutputConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateMatchmakingConfigurationOutputConfiguration
   * @throws IOException if the JSON string is invalid with respect to UpdateMatchmakingConfigurationOutputConfiguration
   */
  public static UpdateMatchmakingConfigurationOutputConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateMatchmakingConfigurationOutputConfiguration.class);
  }

  /**
   * Convert an instance of UpdateMatchmakingConfigurationOutputConfiguration to an JSON string
   *
   * @return JSON string
   */
