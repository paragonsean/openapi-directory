...
/**
 * Gets or Sets AcceptanceType
 */
@JsonAdapter(AcceptanceType.Adapter.class)
public enum AcceptanceType {
  ...
  public static AcceptanceType fromValue(String value) {
    for (AcceptanceType b : AcceptanceType.values()) {
  ...
  public static class Adapter extends TypeAdapter<AcceptanceType> {
    @Override
    public void write(final JsonWriter jsonWriter, final AcceptanceType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AcceptanceType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AcceptanceType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AcceptanceType.fromValue(value);
  }
}
