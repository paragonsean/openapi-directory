...
public class VpcPeeringConnectionStatus {
  ...
  public VpcPeeringConnectionStatus code(String code) {
    this.code = code;
    return this;
  }
  ...
  public VpcPeeringConnectionStatus message(String message) {
  ...
  public boolean equals(Object o) {
    ...
    VpcPeeringConnectionStatus vpcPeeringConnectionStatus = (VpcPeeringConnectionStatus) o;
    return Objects.equals(this.code, vpcPeeringConnectionStatus.code) &&
        Objects.equals(this.message, vpcPeeringConnectionStatus.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class VpcPeeringConnectionStatus {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VpcPeeringConnectionStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VpcPeeringConnectionStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VpcPeeringConnectionStatus is not found in the empty JSON string", VpcPeeringConnectionStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VpcPeeringConnectionStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VpcPeeringConnectionStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VpcPeeringConnectionStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VpcPeeringConnectionStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VpcPeeringConnectionStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VpcPeeringConnectionStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<VpcPeeringConnectionStatus>() {
           @Override
           public void write(JsonWriter out, VpcPeeringConnectionStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VpcPeeringConnectionStatus read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VpcPeeringConnectionStatus given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VpcPeeringConnectionStatus
   * @throws IOException if the JSON string is invalid with respect to VpcPeeringConnectionStatus
   */
  public static VpcPeeringConnectionStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VpcPeeringConnectionStatus.class);
  }

  /**
   * Convert an instance of VpcPeeringConnectionStatus to an JSON string
   *
   * @return JSON string
   */
