...
public class ListScriptsInput {
  ...
  public ListScriptsInput limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public ListScriptsInput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListScriptsInput listScriptsInput = (ListScriptsInput) o;
    return Objects.equals(this.limit, listScriptsInput.limit) &&
        Objects.equals(this.nextToken, listScriptsInput.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListScriptsInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListScriptsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListScriptsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListScriptsInput is not found in the empty JSON string", ListScriptsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListScriptsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListScriptsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListScriptsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListScriptsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListScriptsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListScriptsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListScriptsInput>() {
           @Override
           public void write(JsonWriter out, ListScriptsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListScriptsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListScriptsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListScriptsInput
   * @throws IOException if the JSON string is invalid with respect to ListScriptsInput
   */
  public static ListScriptsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListScriptsInput.class);
  }

  /**
   * Convert an instance of ListScriptsInput to an JSON string
   *
   * @return JSON string
   */
