...
import org.openapitools.client.model.GameServerHealthCheck;
...
public class UpdateGameServerInput {
  ...
  private GameServerHealthCheck healthCheck;

  public UpdateGameServerInput() {
  }

  public UpdateGameServerInput gameServerGroupName(String gameServerGroupName) {
  ...
  public UpdateGameServerInput gameServerId(String gameServerId) {
  ...
  public UpdateGameServerInput gameServerData(String gameServerData) {
  ...
  public UpdateGameServerInput utilizationStatus(GameServerUtilizationStatus utilizationStatus) {
  ...
  public UpdateGameServerInput healthCheck(GameServerHealthCheck healthCheck) {
   ...
   */
  @javax.annotation.Nullable
  public GameServerHealthCheck getHealthCheck() {
    return healthCheck;
  }

  public void setHealthCheck(GameServerHealthCheck healthCheck) {
    this.healthCheck = healthCheck;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateGameServerInput updateGameServerInput = (UpdateGameServerInput) o;
    return Objects.equals(this.gameServerGroupName, updateGameServerInput.gameServerGroupName) &&
        Objects.equals(this.gameServerId, updateGameServerInput.gameServerId) &&
        Objects.equals(this.gameServerData, updateGameServerInput.gameServerData) &&
        Objects.equals(this.utilizationStatus, updateGameServerInput.utilizationStatus) &&
        Objects.equals(this.healthCheck, updateGameServerInput.healthCheck);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gameServerGroupName, gameServerId, gameServerData, utilizationStatus, healthCheck);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateGameServerInput {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("GameServerId");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateGameServerInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateGameServerInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateGameServerInput is not found in the empty JSON string", UpdateGameServerInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateGameServerInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateGameServerInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateGameServerInput.openapiRequiredFields) {
      ...
      // validate the required field `GameServerId`
      ...
      if (jsonObj.get("HealthCheck") != null && !jsonObj.get("HealthCheck").isJsonNull()) {
        GameServerHealthCheck.validateJsonElement(jsonObj.get("HealthCheck"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateGameServerInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateGameServerInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateGameServerInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateGameServerInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateGameServerInput>() {
           @Override
           public void write(JsonWriter out, UpdateGameServerInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateGameServerInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateGameServerInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateGameServerInput
   * @throws IOException if the JSON string is invalid with respect to UpdateGameServerInput
   */
  public static UpdateGameServerInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateGameServerInput.class);
  }

  /**
   * Convert an instance of UpdateGameServerInput to an JSON string
   *
   * @return JSON string
   */
