...
public class DescribeComputeOutputCompute {
  ...
  public DescribeComputeOutputCompute() {
  }

  public DescribeComputeOutputCompute fleetId(String fleetId) {
  ...
  public DescribeComputeOutputCompute fleetArn(String fleetArn) {
  ...
  public DescribeComputeOutputCompute computeName(String computeName) {
  ...
  public DescribeComputeOutputCompute computeArn(String computeArn) {
  ...
  public DescribeComputeOutputCompute ipAddress(String ipAddress) {
  ...
  public DescribeComputeOutputCompute dnsName(String dnsName) {
  ...
  public DescribeComputeOutputCompute computeStatus(ComputeStatus computeStatus) {
  ...
  public DescribeComputeOutputCompute location(String location) {
  ...
  public DescribeComputeOutputCompute creationTime(OffsetDateTime creationTime) {
  ...
  public DescribeComputeOutputCompute operatingSystem(OperatingSystem operatingSystem) {
  ...
  public DescribeComputeOutputCompute type(EC2InstanceType type) {
    this.type = type;
    return this;
  }
  ...
  public DescribeComputeOutputCompute gameLiftServiceSdkEndpoint(String gameLiftServiceSdkEndpoint) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeComputeOutputCompute describeComputeOutputCompute = (DescribeComputeOutputCompute) o;
    return Objects.equals(this.fleetId, describeComputeOutputCompute.fleetId) &&
        Objects.equals(this.fleetArn, describeComputeOutputCompute.fleetArn) &&
        Objects.equals(this.computeName, describeComputeOutputCompute.computeName) &&
        Objects.equals(this.computeArn, describeComputeOutputCompute.computeArn) &&
        Objects.equals(this.ipAddress, describeComputeOutputCompute.ipAddress) &&
        Objects.equals(this.dnsName, describeComputeOutputCompute.dnsName) &&
        Objects.equals(this.computeStatus, describeComputeOutputCompute.computeStatus) &&
        Objects.equals(this.location, describeComputeOutputCompute.location) &&
        Objects.equals(this.creationTime, describeComputeOutputCompute.creationTime) &&
        Objects.equals(this.operatingSystem, describeComputeOutputCompute.operatingSystem) &&
        Objects.equals(this.type, describeComputeOutputCompute.type) &&
        Objects.equals(this.gameLiftServiceSdkEndpoint, describeComputeOutputCompute.gameLiftServiceSdkEndpoint);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeComputeOutputCompute {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeComputeOutputCompute
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeComputeOutputCompute.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeComputeOutputCompute is not found in the empty JSON string", DescribeComputeOutputCompute.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeComputeOutputCompute.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeComputeOutputCompute` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeComputeOutputCompute.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeComputeOutputCompute' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeComputeOutputCompute> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeComputeOutputCompute.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeComputeOutputCompute>() {
           @Override
           public void write(JsonWriter out, DescribeComputeOutputCompute value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeComputeOutputCompute read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeComputeOutputCompute given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeComputeOutputCompute
   * @throws IOException if the JSON string is invalid with respect to DescribeComputeOutputCompute
   */
  public static DescribeComputeOutputCompute fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeComputeOutputCompute.class);
  }

  /**
   * Convert an instance of DescribeComputeOutputCompute to an JSON string
   *
   * @return JSON string
   */
