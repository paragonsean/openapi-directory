...
public class DescribeVpcPeeringConnectionsInput {
  ...
  public DescribeVpcPeeringConnectionsInput fleetId(String fleetId) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeVpcPeeringConnectionsInput describeVpcPeeringConnectionsInput = (DescribeVpcPeeringConnectionsInput) o;
    return Objects.equals(this.fleetId, describeVpcPeeringConnectionsInput.fleetId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeVpcPeeringConnectionsInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeVpcPeeringConnectionsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeVpcPeeringConnectionsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeVpcPeeringConnectionsInput is not found in the empty JSON string", DescribeVpcPeeringConnectionsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeVpcPeeringConnectionsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeVpcPeeringConnectionsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeVpcPeeringConnectionsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeVpcPeeringConnectionsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeVpcPeeringConnectionsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeVpcPeeringConnectionsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeVpcPeeringConnectionsInput>() {
           @Override
           public void write(JsonWriter out, DescribeVpcPeeringConnectionsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeVpcPeeringConnectionsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeVpcPeeringConnectionsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeVpcPeeringConnectionsInput
   * @throws IOException if the JSON string is invalid with respect to DescribeVpcPeeringConnectionsInput
   */
  public static DescribeVpcPeeringConnectionsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeVpcPeeringConnectionsInput.class);
  }

  /**
   * Convert an instance of DescribeVpcPeeringConnectionsInput to an JSON string
   *
   * @return JSON string
   */
