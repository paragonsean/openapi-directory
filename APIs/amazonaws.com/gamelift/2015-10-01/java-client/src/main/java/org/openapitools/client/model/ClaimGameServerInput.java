...
public class ClaimGameServerInput {
  ...
  public static final String SERIALIZED_NAME_FILTER_OPTION = "FilterOption";
  @SerializedName(SERIALIZED_NAME_FILTER_OPTION)
  private ClaimGameServerInputFilterOption filterOption;

  public ClaimGameServerInput() {
  }

  public ClaimGameServerInput gameServerGroupName(String gameServerGroupName) {
  ...
  public ClaimGameServerInput gameServerId(String gameServerId) {
  ...
  public ClaimGameServerInput gameServerData(String gameServerData) {
  ...
  public ClaimGameServerInput filterOption(ClaimGameServerInputFilterOption filterOption) {
   ...
   */
  @javax.annotation.Nullable
  public ClaimGameServerInputFilterOption getFilterOption() {
    return filterOption;
  }

  public void setFilterOption(ClaimGameServerInputFilterOption filterOption) {
    this.filterOption = filterOption;
  }
  ...
  public boolean equals(Object o) {
    ...
    ClaimGameServerInput claimGameServerInput = (ClaimGameServerInput) o;
    return Objects.equals(this.gameServerGroupName, claimGameServerInput.gameServerGroupName) &&
        Objects.equals(this.gameServerId, claimGameServerInput.gameServerId) &&
        Objects.equals(this.gameServerData, claimGameServerInput.gameServerData) &&
        Objects.equals(this.filterOption, claimGameServerInput.filterOption);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gameServerGroupName, gameServerId, gameServerData, filterOption);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ClaimGameServerInput {\n");
  ...
  static {
    ...
    openapiFields.add("FilterOption");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClaimGameServerInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClaimGameServerInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClaimGameServerInput is not found in the empty JSON string", ClaimGameServerInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClaimGameServerInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ClaimGameServerInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ClaimGameServerInput.openapiRequiredFields) {
      ...
      if (jsonObj.get("FilterOption") != null && !jsonObj.get("FilterOption").isJsonNull()) {
        ClaimGameServerInputFilterOption.validateJsonElement(jsonObj.get("FilterOption"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClaimGameServerInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClaimGameServerInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClaimGameServerInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClaimGameServerInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ClaimGameServerInput>() {
           @Override
           public void write(JsonWriter out, ClaimGameServerInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ClaimGameServerInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ClaimGameServerInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ClaimGameServerInput
   * @throws IOException if the JSON string is invalid with respect to ClaimGameServerInput
   */
  public static ClaimGameServerInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClaimGameServerInput.class);
  }

  /**
   * Convert an instance of ClaimGameServerInput to an JSON string
   *
   * @return JSON string
   */
