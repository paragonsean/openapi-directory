...
/**
 * Gets or Sets GameSessionPlacementState
 */
@JsonAdapter(GameSessionPlacementState.Adapter.class)
public enum GameSessionPlacementState {
  ...
  GameSessionPlacementState(String value) {
    this.value = value;
  }
  ...
  public static GameSessionPlacementState fromValue(String value) {
    for (GameSessionPlacementState b : GameSessionPlacementState.values()) {
  ...
  public static class Adapter extends TypeAdapter<GameSessionPlacementState> {
    @Override
    public void write(final JsonWriter jsonWriter, final GameSessionPlacementState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public GameSessionPlacementState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return GameSessionPlacementState.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    GameSessionPlacementState.fromValue(value);
  }
}
