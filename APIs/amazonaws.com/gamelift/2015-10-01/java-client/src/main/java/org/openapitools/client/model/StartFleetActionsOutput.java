...
public class StartFleetActionsOutput {
  ...
  public StartFleetActionsOutput fleetId(String fleetId) {
  ...
  public StartFleetActionsOutput fleetArn(String fleetArn) {
  ...
  public boolean equals(Object o) {
    ...
    StartFleetActionsOutput startFleetActionsOutput = (StartFleetActionsOutput) o;
    return Objects.equals(this.fleetId, startFleetActionsOutput.fleetId) &&
        Objects.equals(this.fleetArn, startFleetActionsOutput.fleetArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartFleetActionsOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartFleetActionsOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartFleetActionsOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartFleetActionsOutput is not found in the empty JSON string", StartFleetActionsOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartFleetActionsOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartFleetActionsOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartFleetActionsOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartFleetActionsOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartFleetActionsOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartFleetActionsOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<StartFleetActionsOutput>() {
           @Override
           public void write(JsonWriter out, StartFleetActionsOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartFleetActionsOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartFleetActionsOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartFleetActionsOutput
   * @throws IOException if the JSON string is invalid with respect to StartFleetActionsOutput
   */
  public static StartFleetActionsOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartFleetActionsOutput.class);
  }

  /**
   * Convert an instance of StartFleetActionsOutput to an JSON string
   *
   * @return JSON string
   */
