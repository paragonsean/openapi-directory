...
public class GameServerInstance {
  ...
  private GameServerInstanceStatus instanceStatus;

  public GameServerInstance() {
  }

  public GameServerInstance gameServerGroupName(String gameServerGroupName) {
  ...
  public GameServerInstance gameServerGroupArn(String gameServerGroupArn) {
  ...
  public GameServerInstance instanceId(String instanceId) {
  ...
  public GameServerInstance instanceStatus(GameServerInstanceStatus instanceStatus) {
   ...
   */
  @javax.annotation.Nullable
  public GameServerInstanceStatus getInstanceStatus() {
    return instanceStatus;
  }

  public void setInstanceStatus(GameServerInstanceStatus instanceStatus) {
    this.instanceStatus = instanceStatus;
  }
  ...
  public boolean equals(Object o) {
    ...
    GameServerInstance gameServerInstance = (GameServerInstance) o;
    return Objects.equals(this.gameServerGroupName, gameServerInstance.gameServerGroupName) &&
        Objects.equals(this.gameServerGroupArn, gameServerInstance.gameServerGroupArn) &&
        Objects.equals(this.instanceId, gameServerInstance.instanceId) &&
        Objects.equals(this.instanceStatus, gameServerInstance.instanceStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gameServerGroupName, gameServerGroupArn, instanceId, instanceStatus);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GameServerInstance {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GameServerInstance
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GameServerInstance.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GameServerInstance is not found in the empty JSON string", GameServerInstance.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GameServerInstance.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GameServerInstance` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("InstanceStatus") != null && !jsonObj.get("InstanceStatus").isJsonNull()) {
        GameServerInstanceStatus.validateJsonElement(jsonObj.get("InstanceStatus"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GameServerInstance.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GameServerInstance' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GameServerInstance> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GameServerInstance.class));

       return (TypeAdapter<T>) new TypeAdapter<GameServerInstance>() {
           @Override
           public void write(JsonWriter out, GameServerInstance value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GameServerInstance read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GameServerInstance given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GameServerInstance
   * @throws IOException if the JSON string is invalid with respect to GameServerInstance
   */
  public static GameServerInstance fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GameServerInstance.class);
  }

  /**
   * Convert an instance of GameServerInstance to an JSON string
   *
   * @return JSON string
   */
