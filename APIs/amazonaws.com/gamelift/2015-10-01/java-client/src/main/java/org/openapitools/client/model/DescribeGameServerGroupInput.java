...
public class DescribeGameServerGroupInput {
  ...
  public DescribeGameServerGroupInput() {
  }

  public DescribeGameServerGroupInput gameServerGroupName(String gameServerGroupName) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeGameServerGroupInput describeGameServerGroupInput = (DescribeGameServerGroupInput) o;
    return Objects.equals(this.gameServerGroupName, describeGameServerGroupInput.gameServerGroupName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gameServerGroupName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeGameServerGroupInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeGameServerGroupInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeGameServerGroupInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeGameServerGroupInput is not found in the empty JSON string", DescribeGameServerGroupInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeGameServerGroupInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeGameServerGroupInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeGameServerGroupInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeGameServerGroupInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeGameServerGroupInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeGameServerGroupInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeGameServerGroupInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeGameServerGroupInput>() {
           @Override
           public void write(JsonWriter out, DescribeGameServerGroupInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeGameServerGroupInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeGameServerGroupInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeGameServerGroupInput
   * @throws IOException if the JSON string is invalid with respect to DescribeGameServerGroupInput
   */
  public static DescribeGameServerGroupInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeGameServerGroupInput.class);
  }

  /**
   * Convert an instance of DescribeGameServerGroupInput to an JSON string
   *
   * @return JSON string
   */
