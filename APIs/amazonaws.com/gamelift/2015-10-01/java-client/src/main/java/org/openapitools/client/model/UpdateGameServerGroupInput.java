...
public class UpdateGameServerGroupInput {
  ...
  public UpdateGameServerGroupInput() {
  }

  public UpdateGameServerGroupInput gameServerGroupName(String gameServerGroupName) {
  ...
  public UpdateGameServerGroupInput roleArn(String roleArn) {
  ...
  public UpdateGameServerGroupInput instanceDefinitions(List instanceDefinitions) {
  ...
  public UpdateGameServerGroupInput gameServerProtectionPolicy(GameServerProtectionPolicy gameServerProtectionPolicy) {
  ...
  public UpdateGameServerGroupInput balancingStrategy(BalancingStrategy balancingStrategy) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateGameServerGroupInput updateGameServerGroupInput = (UpdateGameServerGroupInput) o;
    return Objects.equals(this.gameServerGroupName, updateGameServerGroupInput.gameServerGroupName) &&
        Objects.equals(this.roleArn, updateGameServerGroupInput.roleArn) &&
        Objects.equals(this.instanceDefinitions, updateGameServerGroupInput.instanceDefinitions) &&
        Objects.equals(this.gameServerProtectionPolicy, updateGameServerGroupInput.gameServerProtectionPolicy) &&
        Objects.equals(this.balancingStrategy, updateGameServerGroupInput.balancingStrategy);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gameServerGroupName, roleArn, instanceDefinitions, gameServerProtectionPolicy, balancingStrategy);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateGameServerGroupInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateGameServerGroupInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateGameServerGroupInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateGameServerGroupInput is not found in the empty JSON string", UpdateGameServerGroupInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateGameServerGroupInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateGameServerGroupInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateGameServerGroupInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateGameServerGroupInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateGameServerGroupInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateGameServerGroupInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateGameServerGroupInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateGameServerGroupInput>() {
           @Override
           public void write(JsonWriter out, UpdateGameServerGroupInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateGameServerGroupInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateGameServerGroupInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateGameServerGroupInput
   * @throws IOException if the JSON string is invalid with respect to UpdateGameServerGroupInput
   */
  public static UpdateGameServerGroupInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateGameServerGroupInput.class);
  }

  /**
   * Convert an instance of UpdateGameServerGroupInput to an JSON string
   *
   * @return JSON string
   */
