...
public class DescribeBuildOutput {
  ...
  private DescribeBuildOutputBuild build;

  public DescribeBuildOutput() {
  }

  public DescribeBuildOutput build(DescribeBuildOutputBuild build) {
    this.build = build;
    return this;
  }
  ...
  public DescribeBuildOutputBuild getBuild() {
    return build;
  }

  public void setBuild(DescribeBuildOutputBuild build) {
    this.build = build;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeBuildOutput describeBuildOutput = (DescribeBuildOutput) o;
    return Objects.equals(this.build, describeBuildOutput.build);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeBuildOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeBuildOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeBuildOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeBuildOutput is not found in the empty JSON string", DescribeBuildOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeBuildOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeBuildOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Build`
      if (jsonObj.get("Build") != null && !jsonObj.get("Build").isJsonNull()) {
        DescribeBuildOutputBuild.validateJsonElement(jsonObj.get("Build"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeBuildOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeBuildOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeBuildOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeBuildOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeBuildOutput>() {
           @Override
           public void write(JsonWriter out, DescribeBuildOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeBuildOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeBuildOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeBuildOutput
   * @throws IOException if the JSON string is invalid with respect to DescribeBuildOutput
   */
  public static DescribeBuildOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeBuildOutput.class);
  }

  /**
   * Convert an instance of DescribeBuildOutput to an JSON string
   *
   * @return JSON string
   */
