...
public class DescribeGameServerGroupOutputGameServerGroup {
  ...
  public DescribeGameServerGroupOutputGameServerGroup() {
  }

  public DescribeGameServerGroupOutputGameServerGroup gameServerGroupName(String gameServerGroupName) {
  ...
  public DescribeGameServerGroupOutputGameServerGroup gameServerGroupArn(String gameServerGroupArn) {
  ...
  public DescribeGameServerGroupOutputGameServerGroup roleArn(String roleArn) {
  ...
  public DescribeGameServerGroupOutputGameServerGroup instanceDefinitions(List instanceDefinitions) {
  ...
  public DescribeGameServerGroupOutputGameServerGroup balancingStrategy(BalancingStrategy balancingStrategy) {
  ...
  public DescribeGameServerGroupOutputGameServerGroup gameServerProtectionPolicy(GameServerProtectionPolicy gameServerProtectionPolicy) {
  ...
  public DescribeGameServerGroupOutputGameServerGroup autoScalingGroupArn(String autoScalingGroupArn) {
  ...
  public DescribeGameServerGroupOutputGameServerGroup status(GameServerGroupStatus status) {
    this.status = status;
    return this;
  }
  ...
  public DescribeGameServerGroupOutputGameServerGroup statusReason(String statusReason) {
  ...
  public DescribeGameServerGroupOutputGameServerGroup suspendedActions(List suspendedActions) {
  ...
  public DescribeGameServerGroupOutputGameServerGroup creationTime(OffsetDateTime creationTime) {
  ...
  public DescribeGameServerGroupOutputGameServerGroup lastUpdatedTime(OffsetDateTime lastUpdatedTime) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeGameServerGroupOutputGameServerGroup describeGameServerGroupOutputGameServerGroup = (DescribeGameServerGroupOutputGameServerGroup) o;
    return Objects.equals(this.gameServerGroupName, describeGameServerGroupOutputGameServerGroup.gameServerGroupName) &&
        Objects.equals(this.gameServerGroupArn, describeGameServerGroupOutputGameServerGroup.gameServerGroupArn) &&
        Objects.equals(this.roleArn, describeGameServerGroupOutputGameServerGroup.roleArn) &&
        Objects.equals(this.instanceDefinitions, describeGameServerGroupOutputGameServerGroup.instanceDefinitions) &&
        Objects.equals(this.balancingStrategy, describeGameServerGroupOutputGameServerGroup.balancingStrategy) &&
        Objects.equals(this.gameServerProtectionPolicy, describeGameServerGroupOutputGameServerGroup.gameServerProtectionPolicy) &&
        Objects.equals(this.autoScalingGroupArn, describeGameServerGroupOutputGameServerGroup.autoScalingGroupArn) &&
        Objects.equals(this.status, describeGameServerGroupOutputGameServerGroup.status) &&
        Objects.equals(this.statusReason, describeGameServerGroupOutputGameServerGroup.statusReason) &&
        Objects.equals(this.suspendedActions, describeGameServerGroupOutputGameServerGroup.suspendedActions) &&
        Objects.equals(this.creationTime, describeGameServerGroupOutputGameServerGroup.creationTime) &&
        Objects.equals(this.lastUpdatedTime, describeGameServerGroupOutputGameServerGroup.lastUpdatedTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeGameServerGroupOutputGameServerGroup {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeGameServerGroupOutputGameServerGroup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeGameServerGroupOutputGameServerGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeGameServerGroupOutputGameServerGroup is not found in the empty JSON string", DescribeGameServerGroupOutputGameServerGroup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeGameServerGroupOutputGameServerGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeGameServerGroupOutputGameServerGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeGameServerGroupOutputGameServerGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeGameServerGroupOutputGameServerGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeGameServerGroupOutputGameServerGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeGameServerGroupOutputGameServerGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeGameServerGroupOutputGameServerGroup>() {
           @Override
           public void write(JsonWriter out, DescribeGameServerGroupOutputGameServerGroup value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeGameServerGroupOutputGameServerGroup read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeGameServerGroupOutputGameServerGroup given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeGameServerGroupOutputGameServerGroup
   * @throws IOException if the JSON string is invalid with respect to DescribeGameServerGroupOutputGameServerGroup
   */
  public static DescribeGameServerGroupOutputGameServerGroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeGameServerGroupOutputGameServerGroup.class);
  }

  /**
   * Convert an instance of DescribeGameServerGroupOutputGameServerGroup to an JSON string
   *
   * @return JSON string
   */
