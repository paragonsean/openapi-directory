...
public class UpdateFleetPortSettingsOutput {
  ...
  public UpdateFleetPortSettingsOutput fleetId(String fleetId) {
  ...
  public UpdateFleetPortSettingsOutput fleetArn(String fleetArn) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateFleetPortSettingsOutput updateFleetPortSettingsOutput = (UpdateFleetPortSettingsOutput) o;
    return Objects.equals(this.fleetId, updateFleetPortSettingsOutput.fleetId) &&
        Objects.equals(this.fleetArn, updateFleetPortSettingsOutput.fleetArn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fleetId, fleetArn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateFleetPortSettingsOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateFleetPortSettingsOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateFleetPortSettingsOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateFleetPortSettingsOutput is not found in the empty JSON string", UpdateFleetPortSettingsOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateFleetPortSettingsOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateFleetPortSettingsOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateFleetPortSettingsOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateFleetPortSettingsOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateFleetPortSettingsOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateFleetPortSettingsOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateFleetPortSettingsOutput>() {
           @Override
           public void write(JsonWriter out, UpdateFleetPortSettingsOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateFleetPortSettingsOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateFleetPortSettingsOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateFleetPortSettingsOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateFleetPortSettingsOutput
   */
  public static UpdateFleetPortSettingsOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateFleetPortSettingsOutput.class);
  }

  /**
   * Convert an instance of UpdateFleetPortSettingsOutput to an JSON string
   *
   * @return JSON string
   */
