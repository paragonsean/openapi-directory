...
public class TargetConfiguration {
  ...
  public TargetConfiguration targetValue(Double targetValue) {
  ...
  public boolean equals(Object o) {
    ...
    TargetConfiguration targetConfiguration = (TargetConfiguration) o;
    return Objects.equals(this.targetValue, targetConfiguration.targetValue);
  }
  ...
  public String toString() {
    ...
    sb.append("class TargetConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TargetConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TargetConfiguration is not found in the empty JSON string", TargetConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TargetConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TargetConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TargetConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TargetConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TargetConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TargetConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<TargetConfiguration>() {
           @Override
           public void write(JsonWriter out, TargetConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TargetConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TargetConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TargetConfiguration
   * @throws IOException if the JSON string is invalid with respect to TargetConfiguration
   */
  public static TargetConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TargetConfiguration.class);
  }

  /**
   * Convert an instance of TargetConfiguration to an JSON string
   *
   * @return JSON string
   */
