...
public class DeregisterGameServerInput {
  ...
  public DeregisterGameServerInput() {
  }

  public DeregisterGameServerInput gameServerGroupName(String gameServerGroupName) {
  ...
  public DeregisterGameServerInput gameServerId(String gameServerId) {
  ...
  public boolean equals(Object o) {
    ...
    DeregisterGameServerInput deregisterGameServerInput = (DeregisterGameServerInput) o;
    return Objects.equals(this.gameServerGroupName, deregisterGameServerInput.gameServerGroupName) &&
        Objects.equals(this.gameServerId, deregisterGameServerInput.gameServerId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gameServerGroupName, gameServerId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeregisterGameServerInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeregisterGameServerInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeregisterGameServerInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeregisterGameServerInput is not found in the empty JSON string", DeregisterGameServerInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeregisterGameServerInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeregisterGameServerInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeregisterGameServerInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeregisterGameServerInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeregisterGameServerInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeregisterGameServerInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeregisterGameServerInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeregisterGameServerInput>() {
           @Override
           public void write(JsonWriter out, DeregisterGameServerInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeregisterGameServerInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeregisterGameServerInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeregisterGameServerInput
   * @throws IOException if the JSON string is invalid with respect to DeregisterGameServerInput
   */
  public static DeregisterGameServerInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeregisterGameServerInput.class);
  }

  /**
   * Convert an instance of DeregisterGameServerInput to an JSON string
   *
   * @return JSON string
   */
