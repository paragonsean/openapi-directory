...
public class StartMatchBackfillOutputMatchmakingTicket {
  ...
  public StartMatchBackfillOutputMatchmakingTicket() {
  }

  public StartMatchBackfillOutputMatchmakingTicket ticketId(String ticketId) {
  ...
  public StartMatchBackfillOutputMatchmakingTicket configurationName(String configurationName) {
  ...
  public StartMatchBackfillOutputMatchmakingTicket configurationArn(String configurationArn) {
  ...
  public StartMatchBackfillOutputMatchmakingTicket status(MatchmakingConfigurationStatus status) {
    this.status = status;
    return this;
  }
  ...
  public StartMatchBackfillOutputMatchmakingTicket statusReason(String statusReason) {
  ...
  public StartMatchBackfillOutputMatchmakingTicket statusMessage(String statusMessage) {
  ...
  public StartMatchBackfillOutputMatchmakingTicket startTime(OffsetDateTime startTime) {
  ...
  public StartMatchBackfillOutputMatchmakingTicket endTime(OffsetDateTime endTime) {
  ...
  public StartMatchBackfillOutputMatchmakingTicket players(List players) {
  ...
  public StartMatchBackfillOutputMatchmakingTicket gameSessionConnectionInfo(MatchmakingTicketGameSessionConnectionInfo gameSessionConnectionInfo) {
  ...
  public StartMatchBackfillOutputMatchmakingTicket estimatedWaitTime(Integer estimatedWaitTime) {
  ...
  public boolean equals(Object o) {
    ...
    StartMatchBackfillOutputMatchmakingTicket startMatchBackfillOutputMatchmakingTicket = (StartMatchBackfillOutputMatchmakingTicket) o;
    return Objects.equals(this.ticketId, startMatchBackfillOutputMatchmakingTicket.ticketId) &&
        Objects.equals(this.configurationName, startMatchBackfillOutputMatchmakingTicket.configurationName) &&
        Objects.equals(this.configurationArn, startMatchBackfillOutputMatchmakingTicket.configurationArn) &&
        Objects.equals(this.status, startMatchBackfillOutputMatchmakingTicket.status) &&
        Objects.equals(this.statusReason, startMatchBackfillOutputMatchmakingTicket.statusReason) &&
        Objects.equals(this.statusMessage, startMatchBackfillOutputMatchmakingTicket.statusMessage) &&
        Objects.equals(this.startTime, startMatchBackfillOutputMatchmakingTicket.startTime) &&
        Objects.equals(this.endTime, startMatchBackfillOutputMatchmakingTicket.endTime) &&
        Objects.equals(this.players, startMatchBackfillOutputMatchmakingTicket.players) &&
        Objects.equals(this.gameSessionConnectionInfo, startMatchBackfillOutputMatchmakingTicket.gameSessionConnectionInfo) &&
        Objects.equals(this.estimatedWaitTime, startMatchBackfillOutputMatchmakingTicket.estimatedWaitTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartMatchBackfillOutputMatchmakingTicket {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartMatchBackfillOutputMatchmakingTicket
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartMatchBackfillOutputMatchmakingTicket.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartMatchBackfillOutputMatchmakingTicket is not found in the empty JSON string", StartMatchBackfillOutputMatchmakingTicket.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartMatchBackfillOutputMatchmakingTicket.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartMatchBackfillOutputMatchmakingTicket` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartMatchBackfillOutputMatchmakingTicket.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartMatchBackfillOutputMatchmakingTicket' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartMatchBackfillOutputMatchmakingTicket> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartMatchBackfillOutputMatchmakingTicket.class));

       return (TypeAdapter<T>) new TypeAdapter<StartMatchBackfillOutputMatchmakingTicket>() {
           @Override
           public void write(JsonWriter out, StartMatchBackfillOutputMatchmakingTicket value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartMatchBackfillOutputMatchmakingTicket read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartMatchBackfillOutputMatchmakingTicket given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartMatchBackfillOutputMatchmakingTicket
   * @throws IOException if the JSON string is invalid with respect to StartMatchBackfillOutputMatchmakingTicket
   */
  public static StartMatchBackfillOutputMatchmakingTicket fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartMatchBackfillOutputMatchmakingTicket.class);
  }

  /**
   * Convert an instance of StartMatchBackfillOutputMatchmakingTicket to an JSON string
   *
   * @return JSON string
   */
