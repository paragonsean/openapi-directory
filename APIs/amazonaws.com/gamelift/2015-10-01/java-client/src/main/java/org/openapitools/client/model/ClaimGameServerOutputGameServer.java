...
public class ClaimGameServerOutputGameServer {
  ...
  public ClaimGameServerOutputGameServer() {
  }

  public ClaimGameServerOutputGameServer gameServerGroupName(String gameServerGroupName) {
  ...
  public ClaimGameServerOutputGameServer gameServerGroupArn(String gameServerGroupArn) {
  ...
  public ClaimGameServerOutputGameServer gameServerId(String gameServerId) {
  ...
  public ClaimGameServerOutputGameServer instanceId(String instanceId) {
  ...
  public ClaimGameServerOutputGameServer connectionInfo(String connectionInfo) {
  ...
  public ClaimGameServerOutputGameServer gameServerData(String gameServerData) {
  ...
  public ClaimGameServerOutputGameServer claimStatus(GameServerClaimStatus claimStatus) {
  ...
  public ClaimGameServerOutputGameServer utilizationStatus(GameServerUtilizationStatus utilizationStatus) {
  ...
  public ClaimGameServerOutputGameServer registrationTime(OffsetDateTime registrationTime) {
  ...
  public ClaimGameServerOutputGameServer lastClaimTime(OffsetDateTime lastClaimTime) {
  ...
  public ClaimGameServerOutputGameServer lastHealthCheckTime(OffsetDateTime lastHealthCheckTime) {
  ...
  public boolean equals(Object o) {
    ...
    ClaimGameServerOutputGameServer claimGameServerOutputGameServer = (ClaimGameServerOutputGameServer) o;
    return Objects.equals(this.gameServerGroupName, claimGameServerOutputGameServer.gameServerGroupName) &&
        Objects.equals(this.gameServerGroupArn, claimGameServerOutputGameServer.gameServerGroupArn) &&
        Objects.equals(this.gameServerId, claimGameServerOutputGameServer.gameServerId) &&
        Objects.equals(this.instanceId, claimGameServerOutputGameServer.instanceId) &&
        Objects.equals(this.connectionInfo, claimGameServerOutputGameServer.connectionInfo) &&
        Objects.equals(this.gameServerData, claimGameServerOutputGameServer.gameServerData) &&
        Objects.equals(this.claimStatus, claimGameServerOutputGameServer.claimStatus) &&
        Objects.equals(this.utilizationStatus, claimGameServerOutputGameServer.utilizationStatus) &&
        Objects.equals(this.registrationTime, claimGameServerOutputGameServer.registrationTime) &&
        Objects.equals(this.lastClaimTime, claimGameServerOutputGameServer.lastClaimTime) &&
        Objects.equals(this.lastHealthCheckTime, claimGameServerOutputGameServer.lastHealthCheckTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClaimGameServerOutputGameServer {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClaimGameServerOutputGameServer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClaimGameServerOutputGameServer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClaimGameServerOutputGameServer is not found in the empty JSON string", ClaimGameServerOutputGameServer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClaimGameServerOutputGameServer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ClaimGameServerOutputGameServer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClaimGameServerOutputGameServer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClaimGameServerOutputGameServer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClaimGameServerOutputGameServer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClaimGameServerOutputGameServer.class));

       return (TypeAdapter<T>) new TypeAdapter<ClaimGameServerOutputGameServer>() {
           @Override
           public void write(JsonWriter out, ClaimGameServerOutputGameServer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ClaimGameServerOutputGameServer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ClaimGameServerOutputGameServer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ClaimGameServerOutputGameServer
   * @throws IOException if the JSON string is invalid with respect to ClaimGameServerOutputGameServer
   */
  public static ClaimGameServerOutputGameServer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClaimGameServerOutputGameServer.class);
  }

  /**
   * Convert an instance of ClaimGameServerOutputGameServer to an JSON string
   *
   * @return JSON string
   */
