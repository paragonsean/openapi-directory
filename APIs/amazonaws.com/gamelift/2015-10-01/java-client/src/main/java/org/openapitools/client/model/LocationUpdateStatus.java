...
/**
 * Gets or Sets LocationUpdateStatus
 */
@JsonAdapter(LocationUpdateStatus.Adapter.class)
public enum LocationUpdateStatus {
  ...
  LocationUpdateStatus(String value) {
    this.value = value;
  }
  ...
  public static LocationUpdateStatus fromValue(String value) {
    for (LocationUpdateStatus b : LocationUpdateStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<LocationUpdateStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final LocationUpdateStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public LocationUpdateStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return LocationUpdateStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    LocationUpdateStatus.fromValue(value);
  }
}
