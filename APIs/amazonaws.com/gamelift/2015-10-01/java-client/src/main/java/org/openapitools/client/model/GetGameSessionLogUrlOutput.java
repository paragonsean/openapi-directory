...
public class GetGameSessionLogUrlOutput {
  ...
  public GetGameSessionLogUrlOutput preSignedUrl(String preSignedUrl) {
  ...
  public boolean equals(Object o) {
    ...
    GetGameSessionLogUrlOutput getGameSessionLogUrlOutput = (GetGameSessionLogUrlOutput) o;
    return Objects.equals(this.preSignedUrl, getGameSessionLogUrlOutput.preSignedUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetGameSessionLogUrlOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetGameSessionLogUrlOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetGameSessionLogUrlOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetGameSessionLogUrlOutput is not found in the empty JSON string", GetGameSessionLogUrlOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetGameSessionLogUrlOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetGameSessionLogUrlOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetGameSessionLogUrlOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetGameSessionLogUrlOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetGameSessionLogUrlOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetGameSessionLogUrlOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetGameSessionLogUrlOutput>() {
           @Override
           public void write(JsonWriter out, GetGameSessionLogUrlOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetGameSessionLogUrlOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetGameSessionLogUrlOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetGameSessionLogUrlOutput
   * @throws IOException if the JSON string is invalid with respect to GetGameSessionLogUrlOutput
   */
  public static GetGameSessionLogUrlOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetGameSessionLogUrlOutput.class);
  }

  /**
   * Convert an instance of GetGameSessionLogUrlOutput to an JSON string
   *
   * @return JSON string
   */
