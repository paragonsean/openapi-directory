...
public class ListGameServerGroupsInput {
  ...
  public ListGameServerGroupsInput limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public ListGameServerGroupsInput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListGameServerGroupsInput listGameServerGroupsInput = (ListGameServerGroupsInput) o;
    return Objects.equals(this.limit, listGameServerGroupsInput.limit) &&
        Objects.equals(this.nextToken, listGameServerGroupsInput.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListGameServerGroupsInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListGameServerGroupsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListGameServerGroupsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListGameServerGroupsInput is not found in the empty JSON string", ListGameServerGroupsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListGameServerGroupsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListGameServerGroupsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListGameServerGroupsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListGameServerGroupsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListGameServerGroupsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListGameServerGroupsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListGameServerGroupsInput>() {
           @Override
           public void write(JsonWriter out, ListGameServerGroupsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListGameServerGroupsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListGameServerGroupsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListGameServerGroupsInput
   * @throws IOException if the JSON string is invalid with respect to ListGameServerGroupsInput
   */
  public static ListGameServerGroupsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListGameServerGroupsInput.class);
  }

  /**
   * Convert an instance of ListGameServerGroupsInput to an JSON string
   *
   * @return JSON string
   */
