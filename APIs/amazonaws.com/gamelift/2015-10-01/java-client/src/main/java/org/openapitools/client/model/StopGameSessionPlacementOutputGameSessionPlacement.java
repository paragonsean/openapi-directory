...
public class StopGameSessionPlacementOutputGameSessionPlacement {
  ...
  public StopGameSessionPlacementOutputGameSessionPlacement() {
  }

  public StopGameSessionPlacementOutputGameSessionPlacement placementId(String placementId) {
  ...
  public StopGameSessionPlacementOutputGameSessionPlacement gameSessionQueueName(String gameSessionQueueName) {
  ...
  public StopGameSessionPlacementOutputGameSessionPlacement status(GameSessionPlacementState status) {
    this.status = status;
    return this;
  }
  ...
  public StopGameSessionPlacementOutputGameSessionPlacement gameProperties(List gameProperties) {
  ...
  public StopGameSessionPlacementOutputGameSessionPlacement maximumPlayerSessionCount(Integer maximumPlayerSessionCount) {
  ...
  public StopGameSessionPlacementOutputGameSessionPlacement gameSessionName(String gameSessionName) {
  ...
  public StopGameSessionPlacementOutputGameSessionPlacement gameSessionId(String gameSessionId) {
  ...
  public StopGameSessionPlacementOutputGameSessionPlacement gameSessionArn(String gameSessionArn) {
  ...
  public StopGameSessionPlacementOutputGameSessionPlacement gameSessionRegion(String gameSessionRegion) {
  ...
  public StopGameSessionPlacementOutputGameSessionPlacement playerLatencies(List playerLatencies) {
  ...
  public StopGameSessionPlacementOutputGameSessionPlacement startTime(OffsetDateTime startTime) {
  ...
  public StopGameSessionPlacementOutputGameSessionPlacement endTime(OffsetDateTime endTime) {
  ...
  public StopGameSessionPlacementOutputGameSessionPlacement ipAddress(String ipAddress) {
  ...
  public StopGameSessionPlacementOutputGameSessionPlacement dnsName(String dnsName) {
  ...
  public StopGameSessionPlacementOutputGameSessionPlacement port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public StopGameSessionPlacementOutputGameSessionPlacement placedPlayerSessions(List placedPlayerSessions) {
  ...
  public StopGameSessionPlacementOutputGameSessionPlacement gameSessionData(String gameSessionData) {
  ...
  public StopGameSessionPlacementOutputGameSessionPlacement matchmakerData(String matchmakerData) {
  ...
  public boolean equals(Object o) {
    ...
    StopGameSessionPlacementOutputGameSessionPlacement stopGameSessionPlacementOutputGameSessionPlacement = (StopGameSessionPlacementOutputGameSessionPlacement) o;
    return Objects.equals(this.placementId, stopGameSessionPlacementOutputGameSessionPlacement.placementId) &&
        Objects.equals(this.gameSessionQueueName, stopGameSessionPlacementOutputGameSessionPlacement.gameSessionQueueName) &&
        Objects.equals(this.status, stopGameSessionPlacementOutputGameSessionPlacement.status) &&
        Objects.equals(this.gameProperties, stopGameSessionPlacementOutputGameSessionPlacement.gameProperties) &&
        Objects.equals(this.maximumPlayerSessionCount, stopGameSessionPlacementOutputGameSessionPlacement.maximumPlayerSessionCount) &&
        Objects.equals(this.gameSessionName, stopGameSessionPlacementOutputGameSessionPlacement.gameSessionName) &&
        Objects.equals(this.gameSessionId, stopGameSessionPlacementOutputGameSessionPlacement.gameSessionId) &&
        Objects.equals(this.gameSessionArn, stopGameSessionPlacementOutputGameSessionPlacement.gameSessionArn) &&
        Objects.equals(this.gameSessionRegion, stopGameSessionPlacementOutputGameSessionPlacement.gameSessionRegion) &&
        Objects.equals(this.playerLatencies, stopGameSessionPlacementOutputGameSessionPlacement.playerLatencies) &&
        Objects.equals(this.startTime, stopGameSessionPlacementOutputGameSessionPlacement.startTime) &&
        Objects.equals(this.endTime, stopGameSessionPlacementOutputGameSessionPlacement.endTime) &&
        Objects.equals(this.ipAddress, stopGameSessionPlacementOutputGameSessionPlacement.ipAddress) &&
        Objects.equals(this.dnsName, stopGameSessionPlacementOutputGameSessionPlacement.dnsName) &&
        Objects.equals(this.port, stopGameSessionPlacementOutputGameSessionPlacement.port) &&
        Objects.equals(this.placedPlayerSessions, stopGameSessionPlacementOutputGameSessionPlacement.placedPlayerSessions) &&
        Objects.equals(this.gameSessionData, stopGameSessionPlacementOutputGameSessionPlacement.gameSessionData) &&
        Objects.equals(this.matchmakerData, stopGameSessionPlacementOutputGameSessionPlacement.matchmakerData);
  }
  ...
  public String toString() {
    ...
    sb.append("class StopGameSessionPlacementOutputGameSessionPlacement {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StopGameSessionPlacementOutputGameSessionPlacement
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StopGameSessionPlacementOutputGameSessionPlacement.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StopGameSessionPlacementOutputGameSessionPlacement is not found in the empty JSON string", StopGameSessionPlacementOutputGameSessionPlacement.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StopGameSessionPlacementOutputGameSessionPlacement.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StopGameSessionPlacementOutputGameSessionPlacement` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StopGameSessionPlacementOutputGameSessionPlacement.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StopGameSessionPlacementOutputGameSessionPlacement' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StopGameSessionPlacementOutputGameSessionPlacement> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StopGameSessionPlacementOutputGameSessionPlacement.class));

       return (TypeAdapter<T>) new TypeAdapter<StopGameSessionPlacementOutputGameSessionPlacement>() {
           @Override
           public void write(JsonWriter out, StopGameSessionPlacementOutputGameSessionPlacement value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StopGameSessionPlacementOutputGameSessionPlacement read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StopGameSessionPlacementOutputGameSessionPlacement given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StopGameSessionPlacementOutputGameSessionPlacement
   * @throws IOException if the JSON string is invalid with respect to StopGameSessionPlacementOutputGameSessionPlacement
   */
  public static StopGameSessionPlacementOutputGameSessionPlacement fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StopGameSessionPlacementOutputGameSessionPlacement.class);
  }

  /**
   * Convert an instance of StopGameSessionPlacementOutputGameSessionPlacement to an JSON string
   *
   * @return JSON string
   */
