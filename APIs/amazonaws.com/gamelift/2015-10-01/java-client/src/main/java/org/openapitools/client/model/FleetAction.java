...
/**
 * Gets or Sets FleetAction
 */
@JsonAdapter(FleetAction.Adapter.class)
public enum FleetAction {
  ...
  public static FleetAction fromValue(String value) {
    for (FleetAction b : FleetAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<FleetAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final FleetAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FleetAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FleetAction.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FleetAction.fromValue(value);
  }
}
