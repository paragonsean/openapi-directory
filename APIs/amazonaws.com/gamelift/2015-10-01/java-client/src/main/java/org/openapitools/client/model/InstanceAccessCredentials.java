...
public class InstanceAccessCredentials {
  ...
  public InstanceAccessCredentials() {
  }

  public InstanceAccessCredentials userName(String userName) {
  ...
  public InstanceAccessCredentials secret(String secret) {
    this.secret = secret;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    InstanceAccessCredentials instanceAccessCredentials = (InstanceAccessCredentials) o;
    return Objects.equals(this.userName, instanceAccessCredentials.userName) &&
        Objects.equals(this.secret, instanceAccessCredentials.secret);
  }
  ...
  public String toString() {
    ...
    sb.append("class InstanceAccessCredentials {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InstanceAccessCredentials
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InstanceAccessCredentials.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InstanceAccessCredentials is not found in the empty JSON string", InstanceAccessCredentials.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InstanceAccessCredentials.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InstanceAccessCredentials` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InstanceAccessCredentials.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InstanceAccessCredentials' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InstanceAccessCredentials> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InstanceAccessCredentials.class));

       return (TypeAdapter<T>) new TypeAdapter<InstanceAccessCredentials>() {
           @Override
           public void write(JsonWriter out, InstanceAccessCredentials value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InstanceAccessCredentials read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InstanceAccessCredentials given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InstanceAccessCredentials
   * @throws IOException if the JSON string is invalid with respect to InstanceAccessCredentials
   */
  public static InstanceAccessCredentials fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InstanceAccessCredentials.class);
  }

  /**
   * Convert an instance of InstanceAccessCredentials to an JSON string
   *
   * @return JSON string
   */
