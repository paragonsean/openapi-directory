...
public class ListGameServersInput {
  ...
  public ListGameServersInput() {
  }

  public ListGameServersInput gameServerGroupName(String gameServerGroupName) {
  ...
  public ListGameServersInput sortOrder(SortOrder sortOrder) {
  ...
  public ListGameServersInput limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public ListGameServersInput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListGameServersInput listGameServersInput = (ListGameServersInput) o;
    return Objects.equals(this.gameServerGroupName, listGameServersInput.gameServerGroupName) &&
        Objects.equals(this.sortOrder, listGameServersInput.sortOrder) &&
        Objects.equals(this.limit, listGameServersInput.limit) &&
        Objects.equals(this.nextToken, listGameServersInput.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gameServerGroupName, sortOrder, limit, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListGameServersInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListGameServersInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListGameServersInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListGameServersInput is not found in the empty JSON string", ListGameServersInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListGameServersInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListGameServersInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListGameServersInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListGameServersInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListGameServersInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListGameServersInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListGameServersInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListGameServersInput>() {
           @Override
           public void write(JsonWriter out, ListGameServersInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListGameServersInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListGameServersInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListGameServersInput
   * @throws IOException if the JSON string is invalid with respect to ListGameServersInput
   */
  public static ListGameServersInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListGameServersInput.class);
  }

  /**
   * Convert an instance of ListGameServersInput to an JSON string
   *
   * @return JSON string
   */
