...
public class GetComputeAccessInput {
  ...
  public GetComputeAccessInput() {
  }

  public GetComputeAccessInput fleetId(String fleetId) {
  ...
  public GetComputeAccessInput computeName(String computeName) {
  ...
  public boolean equals(Object o) {
    ...
    GetComputeAccessInput getComputeAccessInput = (GetComputeAccessInput) o;
    return Objects.equals(this.fleetId, getComputeAccessInput.fleetId) &&
        Objects.equals(this.computeName, getComputeAccessInput.computeName);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetComputeAccessInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetComputeAccessInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetComputeAccessInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetComputeAccessInput is not found in the empty JSON string", GetComputeAccessInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetComputeAccessInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetComputeAccessInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetComputeAccessInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetComputeAccessInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetComputeAccessInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetComputeAccessInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetComputeAccessInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetComputeAccessInput>() {
           @Override
           public void write(JsonWriter out, GetComputeAccessInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetComputeAccessInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetComputeAccessInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetComputeAccessInput
   * @throws IOException if the JSON string is invalid with respect to GetComputeAccessInput
   */
  public static GetComputeAccessInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetComputeAccessInput.class);
  }

  /**
   * Convert an instance of GetComputeAccessInput to an JSON string
   *
   * @return JSON string
   */
