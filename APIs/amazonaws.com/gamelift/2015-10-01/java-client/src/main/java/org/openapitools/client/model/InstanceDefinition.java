...
public class InstanceDefinition {
  ...
  private GameServerGroupInstanceType instanceType;
  ...
  public InstanceDefinition instanceType(GameServerGroupInstanceType instanceType) {
  ...
  public GameServerGroupInstanceType getInstanceType() {
    return instanceType;
  }

  public void setInstanceType(GameServerGroupInstanceType instanceType) {
    this.instanceType = instanceType;
  }


  public InstanceDefinition weightedCapacity(String weightedCapacity) {
  ...
  public boolean equals(Object o) {
    ...
    InstanceDefinition instanceDefinition = (InstanceDefinition) o;
    return Objects.equals(this.instanceType, instanceDefinition.instanceType) &&
        Objects.equals(this.weightedCapacity, instanceDefinition.weightedCapacity);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InstanceDefinition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InstanceDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InstanceDefinition is not found in the empty JSON string", InstanceDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InstanceDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InstanceDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InstanceDefinition.openapiRequiredFields) {
      ...
      GameServerGroupInstanceType.validateJsonElement(jsonObj.get("InstanceType"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InstanceDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InstanceDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InstanceDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InstanceDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<InstanceDefinition>() {
           @Override
           public void write(JsonWriter out, InstanceDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InstanceDefinition read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InstanceDefinition given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InstanceDefinition
   * @throws IOException if the JSON string is invalid with respect to InstanceDefinition
   */
  public static InstanceDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InstanceDefinition.class);
  }

  /**
   * Convert an instance of InstanceDefinition to an JSON string
   *
   * @return JSON string
   */
