...
public class AnywhereConfiguration {
  ...
  public AnywhereConfiguration cost(String cost) {
    this.cost = cost;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AnywhereConfiguration anywhereConfiguration = (AnywhereConfiguration) o;
    return Objects.equals(this.cost, anywhereConfiguration.cost);
  }
  ...
  public String toString() {
    ...
    sb.append("class AnywhereConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AnywhereConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AnywhereConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AnywhereConfiguration is not found in the empty JSON string", AnywhereConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AnywhereConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AnywhereConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AnywhereConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AnywhereConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AnywhereConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AnywhereConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AnywhereConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<AnywhereConfiguration>() {
           @Override
           public void write(JsonWriter out, AnywhereConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AnywhereConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AnywhereConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AnywhereConfiguration
   * @throws IOException if the JSON string is invalid with respect to AnywhereConfiguration
   */
  public static AnywhereConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AnywhereConfiguration.class);
  }

  /**
   * Convert an instance of AnywhereConfiguration to an JSON string
   *
   * @return JSON string
   */
