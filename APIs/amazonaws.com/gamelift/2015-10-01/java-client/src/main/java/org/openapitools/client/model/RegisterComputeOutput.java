...
public class RegisterComputeOutput {
  ...
  public RegisterComputeOutput compute(DescribeComputeOutputCompute compute) {
  ...
  public boolean equals(Object o) {
    ...
    RegisterComputeOutput registerComputeOutput = (RegisterComputeOutput) o;
    return Objects.equals(this.compute, registerComputeOutput.compute);
  }
  ...
  public String toString() {
    ...
    sb.append("class RegisterComputeOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RegisterComputeOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RegisterComputeOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RegisterComputeOutput is not found in the empty JSON string", RegisterComputeOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RegisterComputeOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RegisterComputeOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RegisterComputeOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RegisterComputeOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RegisterComputeOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RegisterComputeOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<RegisterComputeOutput>() {
           @Override
           public void write(JsonWriter out, RegisterComputeOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RegisterComputeOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RegisterComputeOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RegisterComputeOutput
   * @throws IOException if the JSON string is invalid with respect to RegisterComputeOutput
   */
  public static RegisterComputeOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RegisterComputeOutput.class);
  }

  /**
   * Convert an instance of RegisterComputeOutput to an JSON string
   *
   * @return JSON string
   */
