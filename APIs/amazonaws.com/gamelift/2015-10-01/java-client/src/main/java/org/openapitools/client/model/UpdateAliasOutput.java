...
import org.openapitools.client.model.UpdateAliasOutputAlias;
...
public class UpdateAliasOutput {
  ...
  private UpdateAliasOutputAlias alias;

  public UpdateAliasOutput() {
  }

  public UpdateAliasOutput alias(UpdateAliasOutputAlias alias) {
    this.alias = alias;
    return this;
  }
  ...
  public UpdateAliasOutputAlias getAlias() {
    return alias;
  }

  public void setAlias(UpdateAliasOutputAlias alias) {
    this.alias = alias;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateAliasOutput updateAliasOutput = (UpdateAliasOutput) o;
    return Objects.equals(this.alias, updateAliasOutput.alias);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateAliasOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateAliasOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAliasOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateAliasOutput is not found in the empty JSON string", UpdateAliasOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateAliasOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateAliasOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Alias`
      if (jsonObj.get("Alias") != null && !jsonObj.get("Alias").isJsonNull()) {
        UpdateAliasOutputAlias.validateJsonElement(jsonObj.get("Alias"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateAliasOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateAliasOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateAliasOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateAliasOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateAliasOutput>() {
           @Override
           public void write(JsonWriter out, UpdateAliasOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateAliasOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateAliasOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateAliasOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateAliasOutput
   */
  public static UpdateAliasOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateAliasOutput.class);
  }

  /**
   * Convert an instance of UpdateAliasOutput to an JSON string
   *
   * @return JSON string
   */
