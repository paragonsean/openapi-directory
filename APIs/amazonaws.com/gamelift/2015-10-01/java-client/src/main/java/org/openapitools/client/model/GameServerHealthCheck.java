...
/**
 * Gets or Sets GameServerHealthCheck
 */
@JsonAdapter(GameServerHealthCheck.Adapter.class)
public enum GameServerHealthCheck {
  ...
  GameServerHealthCheck(String value) {
    this.value = value;
  }
  ...
  public static GameServerHealthCheck fromValue(String value) {
    for (GameServerHealthCheck b : GameServerHealthCheck.values()) {
  ...
  public static class Adapter extends TypeAdapter<GameServerHealthCheck> {
    @Override
    public void write(final JsonWriter jsonWriter, final GameServerHealthCheck enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public GameServerHealthCheck read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return GameServerHealthCheck.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    GameServerHealthCheck.fromValue(value);
  }
}
