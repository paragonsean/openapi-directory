...
public class DescribeGameServerInput {
  ...
  public DescribeGameServerInput() {
  }

  public DescribeGameServerInput gameServerGroupName(String gameServerGroupName) {
  ...
  public DescribeGameServerInput gameServerId(String gameServerId) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeGameServerInput describeGameServerInput = (DescribeGameServerInput) o;
    return Objects.equals(this.gameServerGroupName, describeGameServerInput.gameServerGroupName) &&
        Objects.equals(this.gameServerId, describeGameServerInput.gameServerId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeGameServerInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeGameServerInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeGameServerInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeGameServerInput is not found in the empty JSON string", DescribeGameServerInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeGameServerInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeGameServerInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeGameServerInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeGameServerInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeGameServerInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeGameServerInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeGameServerInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeGameServerInput>() {
           @Override
           public void write(JsonWriter out, DescribeGameServerInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeGameServerInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeGameServerInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeGameServerInput
   * @throws IOException if the JSON string is invalid with respect to DescribeGameServerInput
   */
  public static DescribeGameServerInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeGameServerInput.class);
  }

  /**
   * Convert an instance of DescribeGameServerInput to an JSON string
   *
   * @return JSON string
   */
