...
public class DescribeEC2InstanceLimitsInput {
  ...
  public DescribeEC2InstanceLimitsInput() {
  }

  public DescribeEC2InstanceLimitsInput ec2InstanceType(EC2InstanceType ec2InstanceType) {
  ...
  public DescribeEC2InstanceLimitsInput location(String location) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeEC2InstanceLimitsInput describeEC2InstanceLimitsInput = (DescribeEC2InstanceLimitsInput) o;
    return Objects.equals(this.ec2InstanceType, describeEC2InstanceLimitsInput.ec2InstanceType) &&
        Objects.equals(this.location, describeEC2InstanceLimitsInput.location);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ec2InstanceType, location);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeEC2InstanceLimitsInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeEC2InstanceLimitsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeEC2InstanceLimitsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeEC2InstanceLimitsInput is not found in the empty JSON string", DescribeEC2InstanceLimitsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeEC2InstanceLimitsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeEC2InstanceLimitsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeEC2InstanceLimitsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeEC2InstanceLimitsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeEC2InstanceLimitsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeEC2InstanceLimitsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeEC2InstanceLimitsInput>() {
           @Override
           public void write(JsonWriter out, DescribeEC2InstanceLimitsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeEC2InstanceLimitsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeEC2InstanceLimitsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeEC2InstanceLimitsInput
   * @throws IOException if the JSON string is invalid with respect to DescribeEC2InstanceLimitsInput
   */
  public static DescribeEC2InstanceLimitsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeEC2InstanceLimitsInput.class);
  }

  /**
   * Convert an instance of DescribeEC2InstanceLimitsInput to an JSON string
   *
   * @return JSON string
   */
