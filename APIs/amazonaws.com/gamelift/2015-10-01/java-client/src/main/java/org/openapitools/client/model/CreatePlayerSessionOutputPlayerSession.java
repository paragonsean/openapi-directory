...
public class CreatePlayerSessionOutputPlayerSession {
  ...
  public CreatePlayerSessionOutputPlayerSession() {
  }

  public CreatePlayerSessionOutputPlayerSession playerSessionId(String playerSessionId) {
  ...
  public CreatePlayerSessionOutputPlayerSession playerId(String playerId) {
  ...
  public CreatePlayerSessionOutputPlayerSession gameSessionId(String gameSessionId) {
  ...
  public CreatePlayerSessionOutputPlayerSession fleetId(String fleetId) {
  ...
  public CreatePlayerSessionOutputPlayerSession fleetArn(String fleetArn) {
  ...
  public CreatePlayerSessionOutputPlayerSession creationTime(OffsetDateTime creationTime) {
  ...
  public CreatePlayerSessionOutputPlayerSession terminationTime(OffsetDateTime terminationTime) {
  ...
  public CreatePlayerSessionOutputPlayerSession status(PlayerSessionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public CreatePlayerSessionOutputPlayerSession ipAddress(String ipAddress) {
  ...
  public CreatePlayerSessionOutputPlayerSession dnsName(String dnsName) {
  ...
  public CreatePlayerSessionOutputPlayerSession port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public CreatePlayerSessionOutputPlayerSession playerData(String playerData) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePlayerSessionOutputPlayerSession createPlayerSessionOutputPlayerSession = (CreatePlayerSessionOutputPlayerSession) o;
    return Objects.equals(this.playerSessionId, createPlayerSessionOutputPlayerSession.playerSessionId) &&
        Objects.equals(this.playerId, createPlayerSessionOutputPlayerSession.playerId) &&
        Objects.equals(this.gameSessionId, createPlayerSessionOutputPlayerSession.gameSessionId) &&
        Objects.equals(this.fleetId, createPlayerSessionOutputPlayerSession.fleetId) &&
        Objects.equals(this.fleetArn, createPlayerSessionOutputPlayerSession.fleetArn) &&
        Objects.equals(this.creationTime, createPlayerSessionOutputPlayerSession.creationTime) &&
        Objects.equals(this.terminationTime, createPlayerSessionOutputPlayerSession.terminationTime) &&
        Objects.equals(this.status, createPlayerSessionOutputPlayerSession.status) &&
        Objects.equals(this.ipAddress, createPlayerSessionOutputPlayerSession.ipAddress) &&
        Objects.equals(this.dnsName, createPlayerSessionOutputPlayerSession.dnsName) &&
        Objects.equals(this.port, createPlayerSessionOutputPlayerSession.port) &&
        Objects.equals(this.playerData, createPlayerSessionOutputPlayerSession.playerData);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreatePlayerSessionOutputPlayerSession {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePlayerSessionOutputPlayerSession
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePlayerSessionOutputPlayerSession.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePlayerSessionOutputPlayerSession is not found in the empty JSON string", CreatePlayerSessionOutputPlayerSession.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePlayerSessionOutputPlayerSession.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePlayerSessionOutputPlayerSession` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePlayerSessionOutputPlayerSession.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePlayerSessionOutputPlayerSession' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePlayerSessionOutputPlayerSession> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePlayerSessionOutputPlayerSession.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePlayerSessionOutputPlayerSession>() {
           @Override
           public void write(JsonWriter out, CreatePlayerSessionOutputPlayerSession value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePlayerSessionOutputPlayerSession read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePlayerSessionOutputPlayerSession given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePlayerSessionOutputPlayerSession
   * @throws IOException if the JSON string is invalid with respect to CreatePlayerSessionOutputPlayerSession
   */
  public static CreatePlayerSessionOutputPlayerSession fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePlayerSessionOutputPlayerSession.class);
  }

  /**
   * Convert an instance of CreatePlayerSessionOutputPlayerSession to an JSON string
   *
   * @return JSON string
   */
