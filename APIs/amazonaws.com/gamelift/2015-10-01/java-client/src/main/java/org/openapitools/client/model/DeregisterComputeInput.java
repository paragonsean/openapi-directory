...
public class DeregisterComputeInput {
  ...
  public DeregisterComputeInput() {
  }

  public DeregisterComputeInput fleetId(String fleetId) {
  ...
  public DeregisterComputeInput computeName(String computeName) {
  ...
  public boolean equals(Object o) {
    ...
    DeregisterComputeInput deregisterComputeInput = (DeregisterComputeInput) o;
    return Objects.equals(this.fleetId, deregisterComputeInput.fleetId) &&
        Objects.equals(this.computeName, deregisterComputeInput.computeName);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeregisterComputeInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeregisterComputeInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeregisterComputeInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeregisterComputeInput is not found in the empty JSON string", DeregisterComputeInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeregisterComputeInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeregisterComputeInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeregisterComputeInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeregisterComputeInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeregisterComputeInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeregisterComputeInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeregisterComputeInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeregisterComputeInput>() {
           @Override
           public void write(JsonWriter out, DeregisterComputeInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeregisterComputeInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeregisterComputeInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeregisterComputeInput
   * @throws IOException if the JSON string is invalid with respect to DeregisterComputeInput
   */
  public static DeregisterComputeInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeregisterComputeInput.class);
  }

  /**
   * Convert an instance of DeregisterComputeInput to an JSON string
   *
   * @return JSON string
   */
