...
public class StopFleetActionsOutput {
  ...
  public StopFleetActionsOutput() {
  }

  public StopFleetActionsOutput fleetId(String fleetId) {
  ...
  public StopFleetActionsOutput fleetArn(String fleetArn) {
  ...
  public boolean equals(Object o) {
    ...
    StopFleetActionsOutput stopFleetActionsOutput = (StopFleetActionsOutput) o;
    return Objects.equals(this.fleetId, stopFleetActionsOutput.fleetId) &&
        Objects.equals(this.fleetArn, stopFleetActionsOutput.fleetArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class StopFleetActionsOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StopFleetActionsOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StopFleetActionsOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StopFleetActionsOutput is not found in the empty JSON string", StopFleetActionsOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StopFleetActionsOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StopFleetActionsOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StopFleetActionsOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StopFleetActionsOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StopFleetActionsOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StopFleetActionsOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<StopFleetActionsOutput>() {
           @Override
           public void write(JsonWriter out, StopFleetActionsOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StopFleetActionsOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StopFleetActionsOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StopFleetActionsOutput
   * @throws IOException if the JSON string is invalid with respect to StopFleetActionsOutput
   */
  public static StopFleetActionsOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StopFleetActionsOutput.class);
  }

  /**
   * Convert an instance of StopFleetActionsOutput to an JSON string
   *
   * @return JSON string
   */
