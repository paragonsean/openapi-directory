...
public class DescribeAliasInput {
  ...
  public DescribeAliasInput() {
  }

  public DescribeAliasInput aliasId(String aliasId) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeAliasInput describeAliasInput = (DescribeAliasInput) o;
    return Objects.equals(this.aliasId, describeAliasInput.aliasId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeAliasInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeAliasInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeAliasInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeAliasInput is not found in the empty JSON string", DescribeAliasInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeAliasInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeAliasInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeAliasInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeAliasInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeAliasInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeAliasInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeAliasInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeAliasInput>() {
           @Override
           public void write(JsonWriter out, DescribeAliasInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeAliasInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeAliasInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeAliasInput
   * @throws IOException if the JSON string is invalid with respect to DescribeAliasInput
   */
  public static DescribeAliasInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeAliasInput.class);
  }

  /**
   * Convert an instance of DescribeAliasInput to an JSON string
   *
   * @return JSON string
   */
