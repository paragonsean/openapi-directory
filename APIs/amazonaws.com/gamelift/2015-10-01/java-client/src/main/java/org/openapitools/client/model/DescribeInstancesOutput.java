...
public class DescribeInstancesOutput {
  ...
  public DescribeInstancesOutput instances(List instances) {
  ...
  public DescribeInstancesOutput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeInstancesOutput describeInstancesOutput = (DescribeInstancesOutput) o;
    return Objects.equals(this.instances, describeInstancesOutput.instances) &&
        Objects.equals(this.nextToken, describeInstancesOutput.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeInstancesOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeInstancesOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeInstancesOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeInstancesOutput is not found in the empty JSON string", DescribeInstancesOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeInstancesOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeInstancesOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeInstancesOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeInstancesOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeInstancesOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeInstancesOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeInstancesOutput>() {
           @Override
           public void write(JsonWriter out, DescribeInstancesOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeInstancesOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeInstancesOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeInstancesOutput
   * @throws IOException if the JSON string is invalid with respect to DescribeInstancesOutput
   */
  public static DescribeInstancesOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeInstancesOutput.class);
  }

  /**
   * Convert an instance of DescribeInstancesOutput to an JSON string
   *
   * @return JSON string
   */
