...
public class DeleteAliasInput {
  ...
  public DeleteAliasInput() {
  }

  public DeleteAliasInput aliasId(String aliasId) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteAliasInput deleteAliasInput = (DeleteAliasInput) o;
    return Objects.equals(this.aliasId, deleteAliasInput.aliasId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteAliasInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteAliasInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteAliasInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteAliasInput is not found in the empty JSON string", DeleteAliasInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteAliasInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteAliasInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteAliasInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteAliasInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteAliasInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteAliasInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteAliasInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteAliasInput>() {
           @Override
           public void write(JsonWriter out, DeleteAliasInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteAliasInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteAliasInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteAliasInput
   * @throws IOException if the JSON string is invalid with respect to DeleteAliasInput
   */
  public static DeleteAliasInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteAliasInput.class);
  }

  /**
   * Convert an instance of DeleteAliasInput to an JSON string
   *
   * @return JSON string
   */
