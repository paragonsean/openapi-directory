...
public class FilterConfiguration {
  ...
  public FilterConfiguration allowedLocations(List allowedLocations) {
  ...
  public boolean equals(Object o) {
    ...
    FilterConfiguration filterConfiguration = (FilterConfiguration) o;
    return Objects.equals(this.allowedLocations, filterConfiguration.allowedLocations);
  }
  ...
  public String toString() {
    ...
    sb.append("class FilterConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FilterConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FilterConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FilterConfiguration is not found in the empty JSON string", FilterConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FilterConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FilterConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FilterConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FilterConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FilterConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FilterConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<FilterConfiguration>() {
           @Override
           public void write(JsonWriter out, FilterConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FilterConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FilterConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FilterConfiguration
   * @throws IOException if the JSON string is invalid with respect to FilterConfiguration
   */
  public static FilterConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FilterConfiguration.class);
  }

  /**
   * Convert an instance of FilterConfiguration to an JSON string
   *
   * @return JSON string
   */
