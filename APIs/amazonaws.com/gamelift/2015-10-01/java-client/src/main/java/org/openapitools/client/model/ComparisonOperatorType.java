...
/**
 * Gets or Sets ComparisonOperatorType
 */
@JsonAdapter(ComparisonOperatorType.Adapter.class)
public enum ComparisonOperatorType {
  ...
  ComparisonOperatorType(String value) {
    this.value = value;
  }
  ...
  public static ComparisonOperatorType fromValue(String value) {
    for (ComparisonOperatorType b : ComparisonOperatorType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ComparisonOperatorType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ComparisonOperatorType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ComparisonOperatorType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ComparisonOperatorType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ComparisonOperatorType.fromValue(value);
  }
}
