...
public class CreateGameSessionQueueInput {
  ...
  public CreateGameSessionQueueInput() {
  }

  public CreateGameSessionQueueInput name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateGameSessionQueueInput timeoutInSeconds(Integer timeoutInSeconds) {
  ...
  public CreateGameSessionQueueInput playerLatencyPolicies(List playerLatencyPolicies) {
  ...
  public CreateGameSessionQueueInput destinations(List destinations) {
  ...
  public CreateGameSessionQueueInput filterConfiguration(CreateGameSessionQueueInputFilterConfiguration filterConfiguration) {
  ...
  public CreateGameSessionQueueInput priorityConfiguration(CreateGameSessionQueueInputPriorityConfiguration priorityConfiguration) {
  ...
  public CreateGameSessionQueueInput customEventData(String customEventData) {
  ...
  public CreateGameSessionQueueInput notificationTarget(String notificationTarget) {
  ...
  public CreateGameSessionQueueInput tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateGameSessionQueueInput createGameSessionQueueInput = (CreateGameSessionQueueInput) o;
    return Objects.equals(this.name, createGameSessionQueueInput.name) &&
        Objects.equals(this.timeoutInSeconds, createGameSessionQueueInput.timeoutInSeconds) &&
        Objects.equals(this.playerLatencyPolicies, createGameSessionQueueInput.playerLatencyPolicies) &&
        Objects.equals(this.destinations, createGameSessionQueueInput.destinations) &&
        Objects.equals(this.filterConfiguration, createGameSessionQueueInput.filterConfiguration) &&
        Objects.equals(this.priorityConfiguration, createGameSessionQueueInput.priorityConfiguration) &&
        Objects.equals(this.customEventData, createGameSessionQueueInput.customEventData) &&
        Objects.equals(this.notificationTarget, createGameSessionQueueInput.notificationTarget) &&
        Objects.equals(this.tags, createGameSessionQueueInput.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, timeoutInSeconds, playerLatencyPolicies, destinations, filterConfiguration, priorityConfiguration, customEventData, notificationTarget, tags);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateGameSessionQueueInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateGameSessionQueueInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateGameSessionQueueInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateGameSessionQueueInput is not found in the empty JSON string", CreateGameSessionQueueInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateGameSessionQueueInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateGameSessionQueueInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateGameSessionQueueInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateGameSessionQueueInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateGameSessionQueueInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateGameSessionQueueInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateGameSessionQueueInput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateGameSessionQueueInput>() {
           @Override
           public void write(JsonWriter out, CreateGameSessionQueueInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateGameSessionQueueInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateGameSessionQueueInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateGameSessionQueueInput
   * @throws IOException if the JSON string is invalid with respect to CreateGameSessionQueueInput
   */
  public static CreateGameSessionQueueInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateGameSessionQueueInput.class);
  }

  /**
   * Convert an instance of CreateGameSessionQueueInput to an JSON string
   *
   * @return JSON string
   */
