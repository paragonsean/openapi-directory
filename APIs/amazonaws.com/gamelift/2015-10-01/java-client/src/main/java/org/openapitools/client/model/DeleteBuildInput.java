...
public class DeleteBuildInput {
  ...
  public DeleteBuildInput() {
  }

  public DeleteBuildInput buildId(String buildId) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteBuildInput deleteBuildInput = (DeleteBuildInput) o;
    return Objects.equals(this.buildId, deleteBuildInput.buildId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteBuildInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteBuildInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteBuildInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteBuildInput is not found in the empty JSON string", DeleteBuildInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteBuildInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteBuildInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteBuildInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteBuildInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteBuildInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteBuildInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteBuildInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteBuildInput>() {
           @Override
           public void write(JsonWriter out, DeleteBuildInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteBuildInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteBuildInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteBuildInput
   * @throws IOException if the JSON string is invalid with respect to DeleteBuildInput
   */
  public static DeleteBuildInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteBuildInput.class);
  }

  /**
   * Convert an instance of DeleteBuildInput to an JSON string
   *
   * @return JSON string
   */
