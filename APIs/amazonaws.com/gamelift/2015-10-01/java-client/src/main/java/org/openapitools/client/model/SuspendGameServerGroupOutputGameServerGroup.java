...
public class SuspendGameServerGroupOutputGameServerGroup {
  ...
  public SuspendGameServerGroupOutputGameServerGroup() {
  }

  public SuspendGameServerGroupOutputGameServerGroup gameServerGroupName(String gameServerGroupName) {
  ...
  public SuspendGameServerGroupOutputGameServerGroup gameServerGroupArn(String gameServerGroupArn) {
  ...
  public SuspendGameServerGroupOutputGameServerGroup roleArn(String roleArn) {
  ...
  public SuspendGameServerGroupOutputGameServerGroup instanceDefinitions(List instanceDefinitions) {
  ...
  public SuspendGameServerGroupOutputGameServerGroup balancingStrategy(BalancingStrategy balancingStrategy) {
  ...
  public SuspendGameServerGroupOutputGameServerGroup gameServerProtectionPolicy(GameServerProtectionPolicy gameServerProtectionPolicy) {
  ...
  public SuspendGameServerGroupOutputGameServerGroup autoScalingGroupArn(String autoScalingGroupArn) {
  ...
  public SuspendGameServerGroupOutputGameServerGroup status(GameServerGroupStatus status) {
    this.status = status;
    return this;
  }
  ...
  public SuspendGameServerGroupOutputGameServerGroup statusReason(String statusReason) {
  ...
  public SuspendGameServerGroupOutputGameServerGroup suspendedActions(List suspendedActions) {
  ...
  public SuspendGameServerGroupOutputGameServerGroup creationTime(OffsetDateTime creationTime) {
  ...
  public SuspendGameServerGroupOutputGameServerGroup lastUpdatedTime(OffsetDateTime lastUpdatedTime) {
  ...
  public boolean equals(Object o) {
    ...
    SuspendGameServerGroupOutputGameServerGroup suspendGameServerGroupOutputGameServerGroup = (SuspendGameServerGroupOutputGameServerGroup) o;
    return Objects.equals(this.gameServerGroupName, suspendGameServerGroupOutputGameServerGroup.gameServerGroupName) &&
        Objects.equals(this.gameServerGroupArn, suspendGameServerGroupOutputGameServerGroup.gameServerGroupArn) &&
        Objects.equals(this.roleArn, suspendGameServerGroupOutputGameServerGroup.roleArn) &&
        Objects.equals(this.instanceDefinitions, suspendGameServerGroupOutputGameServerGroup.instanceDefinitions) &&
        Objects.equals(this.balancingStrategy, suspendGameServerGroupOutputGameServerGroup.balancingStrategy) &&
        Objects.equals(this.gameServerProtectionPolicy, suspendGameServerGroupOutputGameServerGroup.gameServerProtectionPolicy) &&
        Objects.equals(this.autoScalingGroupArn, suspendGameServerGroupOutputGameServerGroup.autoScalingGroupArn) &&
        Objects.equals(this.status, suspendGameServerGroupOutputGameServerGroup.status) &&
        Objects.equals(this.statusReason, suspendGameServerGroupOutputGameServerGroup.statusReason) &&
        Objects.equals(this.suspendedActions, suspendGameServerGroupOutputGameServerGroup.suspendedActions) &&
        Objects.equals(this.creationTime, suspendGameServerGroupOutputGameServerGroup.creationTime) &&
        Objects.equals(this.lastUpdatedTime, suspendGameServerGroupOutputGameServerGroup.lastUpdatedTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class SuspendGameServerGroupOutputGameServerGroup {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SuspendGameServerGroupOutputGameServerGroup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SuspendGameServerGroupOutputGameServerGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SuspendGameServerGroupOutputGameServerGroup is not found in the empty JSON string", SuspendGameServerGroupOutputGameServerGroup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SuspendGameServerGroupOutputGameServerGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SuspendGameServerGroupOutputGameServerGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SuspendGameServerGroupOutputGameServerGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SuspendGameServerGroupOutputGameServerGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SuspendGameServerGroupOutputGameServerGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SuspendGameServerGroupOutputGameServerGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<SuspendGameServerGroupOutputGameServerGroup>() {
           @Override
           public void write(JsonWriter out, SuspendGameServerGroupOutputGameServerGroup value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SuspendGameServerGroupOutputGameServerGroup read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SuspendGameServerGroupOutputGameServerGroup given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SuspendGameServerGroupOutputGameServerGroup
   * @throws IOException if the JSON string is invalid with respect to SuspendGameServerGroupOutputGameServerGroup
   */
  public static SuspendGameServerGroupOutputGameServerGroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SuspendGameServerGroupOutputGameServerGroup.class);
  }

  /**
   * Convert an instance of SuspendGameServerGroupOutputGameServerGroup to an JSON string
   *
   * @return JSON string
   */
