...
public class GameSessionConnectionInfo {
  ...
  public GameSessionConnectionInfo gameSessionArn(String gameSessionArn) {
  ...
  public GameSessionConnectionInfo ipAddress(String ipAddress) {
  ...
  public GameSessionConnectionInfo dnsName(String dnsName) {
  ...
  public GameSessionConnectionInfo port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public GameSessionConnectionInfo matchedPlayerSessions(List matchedPlayerSessions) {
  ...
  public boolean equals(Object o) {
    ...
    GameSessionConnectionInfo gameSessionConnectionInfo = (GameSessionConnectionInfo) o;
    return Objects.equals(this.gameSessionArn, gameSessionConnectionInfo.gameSessionArn) &&
        Objects.equals(this.ipAddress, gameSessionConnectionInfo.ipAddress) &&
        Objects.equals(this.dnsName, gameSessionConnectionInfo.dnsName) &&
        Objects.equals(this.port, gameSessionConnectionInfo.port) &&
        Objects.equals(this.matchedPlayerSessions, gameSessionConnectionInfo.matchedPlayerSessions);
  }
  ...
  public String toString() {
    ...
    sb.append("class GameSessionConnectionInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GameSessionConnectionInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GameSessionConnectionInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GameSessionConnectionInfo is not found in the empty JSON string", GameSessionConnectionInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GameSessionConnectionInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GameSessionConnectionInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GameSessionConnectionInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GameSessionConnectionInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GameSessionConnectionInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GameSessionConnectionInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<GameSessionConnectionInfo>() {
           @Override
           public void write(JsonWriter out, GameSessionConnectionInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GameSessionConnectionInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GameSessionConnectionInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GameSessionConnectionInfo
   * @throws IOException if the JSON string is invalid with respect to GameSessionConnectionInfo
   */
  public static GameSessionConnectionInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GameSessionConnectionInfo.class);
  }

  /**
   * Convert an instance of GameSessionConnectionInfo to an JSON string
   *
   * @return JSON string
   */
