...
public class GameProperty {
  ...
  public GameProperty value(String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GameProperty gameProperty = (GameProperty) o;
    return Objects.equals(this.key, gameProperty.key) &&
        Objects.equals(this.value, gameProperty.value);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GameProperty
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GameProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GameProperty is not found in the empty JSON string", GameProperty.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GameProperty.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GameProperty` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GameProperty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GameProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GameProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GameProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GameProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<GameProperty>() {
           @Override
           public void write(JsonWriter out, GameProperty value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GameProperty read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GameProperty given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GameProperty
   * @throws IOException if the JSON string is invalid with respect to GameProperty
   */
  public static GameProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GameProperty.class);
  }

  /**
   * Convert an instance of GameProperty to an JSON string
   *
   * @return JSON string
   */
