...
/**
 * Gets or Sets FleetStatus
 */
@JsonAdapter(FleetStatus.Adapter.class)
public enum FleetStatus {
  ...
  public static FleetStatus fromValue(String value) {
    for (FleetStatus b : FleetStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<FleetStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final FleetStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FleetStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FleetStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FleetStatus.fromValue(value);
  }
}
