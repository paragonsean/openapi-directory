...
public class DescribeComputeInput {
  ...
  public DescribeComputeInput() {
  }

  public DescribeComputeInput fleetId(String fleetId) {
  ...
  public DescribeComputeInput computeName(String computeName) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeComputeInput describeComputeInput = (DescribeComputeInput) o;
    return Objects.equals(this.fleetId, describeComputeInput.fleetId) &&
        Objects.equals(this.computeName, describeComputeInput.computeName);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeComputeInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeComputeInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeComputeInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeComputeInput is not found in the empty JSON string", DescribeComputeInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeComputeInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeComputeInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeComputeInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeComputeInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeComputeInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeComputeInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeComputeInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeComputeInput>() {
           @Override
           public void write(JsonWriter out, DescribeComputeInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeComputeInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeComputeInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeComputeInput
   * @throws IOException if the JSON string is invalid with respect to DescribeComputeInput
   */
  public static DescribeComputeInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeComputeInput.class);
  }

  /**
   * Convert an instance of DescribeComputeInput to an JSON string
   *
   * @return JSON string
   */
