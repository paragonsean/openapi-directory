...
public class UpdateFleetCapacityOutput {
  ...
  public UpdateFleetCapacityOutput fleetId(String fleetId) {
  ...
  public UpdateFleetCapacityOutput fleetArn(String fleetArn) {
  ...
  public UpdateFleetCapacityOutput location(String location) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateFleetCapacityOutput updateFleetCapacityOutput = (UpdateFleetCapacityOutput) o;
    return Objects.equals(this.fleetId, updateFleetCapacityOutput.fleetId) &&
        Objects.equals(this.fleetArn, updateFleetCapacityOutput.fleetArn) &&
        Objects.equals(this.location, updateFleetCapacityOutput.location);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fleetId, fleetArn, location);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateFleetCapacityOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateFleetCapacityOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateFleetCapacityOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateFleetCapacityOutput is not found in the empty JSON string", UpdateFleetCapacityOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateFleetCapacityOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateFleetCapacityOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateFleetCapacityOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateFleetCapacityOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateFleetCapacityOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateFleetCapacityOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateFleetCapacityOutput>() {
           @Override
           public void write(JsonWriter out, UpdateFleetCapacityOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateFleetCapacityOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateFleetCapacityOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateFleetCapacityOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateFleetCapacityOutput
   */
  public static UpdateFleetCapacityOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateFleetCapacityOutput.class);
  }

  /**
   * Convert an instance of UpdateFleetCapacityOutput to an JSON string
   *
   * @return JSON string
   */
