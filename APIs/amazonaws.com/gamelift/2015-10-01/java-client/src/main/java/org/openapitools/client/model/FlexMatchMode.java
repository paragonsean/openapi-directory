...
/**
 * Gets or Sets FlexMatchMode
 */
@JsonAdapter(FlexMatchMode.Adapter.class)
public enum FlexMatchMode {
  ...
  public static FlexMatchMode fromValue(String value) {
    for (FlexMatchMode b : FlexMatchMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<FlexMatchMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final FlexMatchMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FlexMatchMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FlexMatchMode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FlexMatchMode.fromValue(value);
  }
}
