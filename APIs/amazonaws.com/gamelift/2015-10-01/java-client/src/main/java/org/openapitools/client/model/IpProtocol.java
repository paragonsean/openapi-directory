 ...
 */
@JsonAdapter(IpProtocol.Adapter.class)
public enum IpProtocol {
  ...
  public static IpProtocol fromValue(String value) {
    for (IpProtocol b : IpProtocol.values()) {
  ...
  public static class Adapter extends TypeAdapter<IpProtocol> {
    @Override
    public void write(final JsonWriter jsonWriter, final IpProtocol enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public IpProtocol read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return IpProtocol.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    IpProtocol.fromValue(value);
  }
}
