...
import org.openapitools.client.model.UpdateScriptOutputScript;
...
public class UpdateScriptOutput {
  ...
  private UpdateScriptOutputScript script;

  public UpdateScriptOutput() {
  }

  public UpdateScriptOutput script(UpdateScriptOutputScript script) {
    this.script = script;
    return this;
  }
  ...
  public UpdateScriptOutputScript getScript() {
    return script;
  }

  public void setScript(UpdateScriptOutputScript script) {
    this.script = script;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateScriptOutput updateScriptOutput = (UpdateScriptOutput) o;
    return Objects.equals(this.script, updateScriptOutput.script);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateScriptOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateScriptOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateScriptOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateScriptOutput is not found in the empty JSON string", UpdateScriptOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateScriptOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateScriptOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Script`
      if (jsonObj.get("Script") != null && !jsonObj.get("Script").isJsonNull()) {
        UpdateScriptOutputScript.validateJsonElement(jsonObj.get("Script"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateScriptOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateScriptOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateScriptOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateScriptOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateScriptOutput>() {
           @Override
           public void write(JsonWriter out, UpdateScriptOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateScriptOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateScriptOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateScriptOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateScriptOutput
   */
  public static UpdateScriptOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateScriptOutput.class);
  }

  /**
   * Convert an instance of UpdateScriptOutput to an JSON string
   *
   * @return JSON string
   */
