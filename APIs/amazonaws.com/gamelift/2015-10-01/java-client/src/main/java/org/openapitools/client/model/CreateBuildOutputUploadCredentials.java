...
public class CreateBuildOutputUploadCredentials {
  ...
  public CreateBuildOutputUploadCredentials() {
  }

  public CreateBuildOutputUploadCredentials accessKeyId(String accessKeyId) {
  ...
  public CreateBuildOutputUploadCredentials secretAccessKey(String secretAccessKey) {
  ...
  public CreateBuildOutputUploadCredentials sessionToken(String sessionToken) {
  ...
  public boolean equals(Object o) {
    ...
    CreateBuildOutputUploadCredentials createBuildOutputUploadCredentials = (CreateBuildOutputUploadCredentials) o;
    return Objects.equals(this.accessKeyId, createBuildOutputUploadCredentials.accessKeyId) &&
        Objects.equals(this.secretAccessKey, createBuildOutputUploadCredentials.secretAccessKey) &&
        Objects.equals(this.sessionToken, createBuildOutputUploadCredentials.sessionToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateBuildOutputUploadCredentials {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateBuildOutputUploadCredentials
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateBuildOutputUploadCredentials.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateBuildOutputUploadCredentials is not found in the empty JSON string", CreateBuildOutputUploadCredentials.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateBuildOutputUploadCredentials.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateBuildOutputUploadCredentials` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateBuildOutputUploadCredentials.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateBuildOutputUploadCredentials' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateBuildOutputUploadCredentials> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateBuildOutputUploadCredentials.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateBuildOutputUploadCredentials>() {
           @Override
           public void write(JsonWriter out, CreateBuildOutputUploadCredentials value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateBuildOutputUploadCredentials read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateBuildOutputUploadCredentials given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateBuildOutputUploadCredentials
   * @throws IOException if the JSON string is invalid with respect to CreateBuildOutputUploadCredentials
   */
  public static CreateBuildOutputUploadCredentials fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateBuildOutputUploadCredentials.class);
  }

  /**
   * Convert an instance of CreateBuildOutputUploadCredentials to an JSON string
   *
   * @return JSON string
   */
