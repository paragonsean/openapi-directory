...
public class DesiredPlayerSession {
  ...
  public DesiredPlayerSession playerId(String playerId) {
  ...
  public DesiredPlayerSession playerData(String playerData) {
  ...
  public boolean equals(Object o) {
    ...
    DesiredPlayerSession desiredPlayerSession = (DesiredPlayerSession) o;
    return Objects.equals(this.playerId, desiredPlayerSession.playerId) &&
        Objects.equals(this.playerData, desiredPlayerSession.playerData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(playerId, playerData);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DesiredPlayerSession {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DesiredPlayerSession
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DesiredPlayerSession.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DesiredPlayerSession is not found in the empty JSON string", DesiredPlayerSession.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DesiredPlayerSession.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DesiredPlayerSession` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DesiredPlayerSession.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DesiredPlayerSession' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DesiredPlayerSession> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DesiredPlayerSession.class));

       return (TypeAdapter<T>) new TypeAdapter<DesiredPlayerSession>() {
           @Override
           public void write(JsonWriter out, DesiredPlayerSession value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DesiredPlayerSession read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DesiredPlayerSession given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DesiredPlayerSession
   * @throws IOException if the JSON string is invalid with respect to DesiredPlayerSession
   */
  public static DesiredPlayerSession fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DesiredPlayerSession.class);
  }

  /**
   * Convert an instance of DesiredPlayerSession to an JSON string
   *
   * @return JSON string
   */
