 ...
 */
@JsonAdapter(ProtectionPolicy.Adapter.class)
public enum ProtectionPolicy {
  ...
  public static ProtectionPolicy fromValue(String value) {
    for (ProtectionPolicy b : ProtectionPolicy.values()) {
  ...
  public static class Adapter extends TypeAdapter<ProtectionPolicy> {
    @Override
    public void write(final JsonWriter jsonWriter, final ProtectionPolicy enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ProtectionPolicy read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ProtectionPolicy.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ProtectionPolicy.fromValue(value);
  }
}
