...
public class UpdateMatchmakingConfigurationInput {
  ...
  public UpdateMatchmakingConfigurationInput() {
  }

  public UpdateMatchmakingConfigurationInput name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateMatchmakingConfigurationInput description(String description) {
  ...
  public UpdateMatchmakingConfigurationInput gameSessionQueueArns(List gameSessionQueueArns) {
  ...
  public UpdateMatchmakingConfigurationInput requestTimeoutSeconds(Integer requestTimeoutSeconds) {
  ...
  public UpdateMatchmakingConfigurationInput acceptanceTimeoutSeconds(Integer acceptanceTimeoutSeconds) {
  ...
  public UpdateMatchmakingConfigurationInput acceptanceRequired(Boolean acceptanceRequired) {
  ...
  public UpdateMatchmakingConfigurationInput ruleSetName(String ruleSetName) {
  ...
  public UpdateMatchmakingConfigurationInput notificationTarget(String notificationTarget) {
  ...
  public UpdateMatchmakingConfigurationInput additionalPlayerCount(Integer additionalPlayerCount) {
  ...
  public UpdateMatchmakingConfigurationInput customEventData(String customEventData) {
  ...
  public UpdateMatchmakingConfigurationInput gameProperties(List gameProperties) {
  ...
  public UpdateMatchmakingConfigurationInput gameSessionData(String gameSessionData) {
  ...
  public UpdateMatchmakingConfigurationInput backfillMode(BackfillMode backfillMode) {
  ...
  public UpdateMatchmakingConfigurationInput flexMatchMode(FlexMatchMode flexMatchMode) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateMatchmakingConfigurationInput updateMatchmakingConfigurationInput = (UpdateMatchmakingConfigurationInput) o;
    return Objects.equals(this.name, updateMatchmakingConfigurationInput.name) &&
        Objects.equals(this.description, updateMatchmakingConfigurationInput.description) &&
        Objects.equals(this.gameSessionQueueArns, updateMatchmakingConfigurationInput.gameSessionQueueArns) &&
        Objects.equals(this.requestTimeoutSeconds, updateMatchmakingConfigurationInput.requestTimeoutSeconds) &&
        Objects.equals(this.acceptanceTimeoutSeconds, updateMatchmakingConfigurationInput.acceptanceTimeoutSeconds) &&
        Objects.equals(this.acceptanceRequired, updateMatchmakingConfigurationInput.acceptanceRequired) &&
        Objects.equals(this.ruleSetName, updateMatchmakingConfigurationInput.ruleSetName) &&
        Objects.equals(this.notificationTarget, updateMatchmakingConfigurationInput.notificationTarget) &&
        Objects.equals(this.additionalPlayerCount, updateMatchmakingConfigurationInput.additionalPlayerCount) &&
        Objects.equals(this.customEventData, updateMatchmakingConfigurationInput.customEventData) &&
        Objects.equals(this.gameProperties, updateMatchmakingConfigurationInput.gameProperties) &&
        Objects.equals(this.gameSessionData, updateMatchmakingConfigurationInput.gameSessionData) &&
        Objects.equals(this.backfillMode, updateMatchmakingConfigurationInput.backfillMode) &&
        Objects.equals(this.flexMatchMode, updateMatchmakingConfigurationInput.flexMatchMode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, gameSessionQueueArns, requestTimeoutSeconds, acceptanceTimeoutSeconds, acceptanceRequired, ruleSetName, notificationTarget, additionalPlayerCount, customEventData, gameProperties, gameSessionData, backfillMode, flexMatchMode);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateMatchmakingConfigurationInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateMatchmakingConfigurationInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateMatchmakingConfigurationInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateMatchmakingConfigurationInput is not found in the empty JSON string", UpdateMatchmakingConfigurationInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateMatchmakingConfigurationInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateMatchmakingConfigurationInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateMatchmakingConfigurationInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateMatchmakingConfigurationInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateMatchmakingConfigurationInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateMatchmakingConfigurationInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateMatchmakingConfigurationInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateMatchmakingConfigurationInput>() {
           @Override
           public void write(JsonWriter out, UpdateMatchmakingConfigurationInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateMatchmakingConfigurationInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateMatchmakingConfigurationInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateMatchmakingConfigurationInput
   * @throws IOException if the JSON string is invalid with respect to UpdateMatchmakingConfigurationInput
   */
  public static UpdateMatchmakingConfigurationInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateMatchmakingConfigurationInput.class);
  }

  /**
   * Convert an instance of UpdateMatchmakingConfigurationInput to an JSON string
   *
   * @return JSON string
   */
