...
/**
 * Gets or Sets ScalingAdjustmentType
 */
@JsonAdapter(ScalingAdjustmentType.Adapter.class)
public enum ScalingAdjustmentType {
  ...
  ScalingAdjustmentType(String value) {
    this.value = value;
  }
  ...
  public static ScalingAdjustmentType fromValue(String value) {
    for (ScalingAdjustmentType b : ScalingAdjustmentType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ScalingAdjustmentType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ScalingAdjustmentType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ScalingAdjustmentType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ScalingAdjustmentType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ScalingAdjustmentType.fromValue(value);
  }
}
