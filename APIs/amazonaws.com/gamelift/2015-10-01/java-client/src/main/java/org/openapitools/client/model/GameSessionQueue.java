...
public class GameSessionQueue {
  ...
  public GameSessionQueue name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GameSessionQueue gameSessionQueueArn(String gameSessionQueueArn) {
  ...
  public GameSessionQueue timeoutInSeconds(Integer timeoutInSeconds) {
  ...
  public GameSessionQueue playerLatencyPolicies(List playerLatencyPolicies) {
  ...
  public GameSessionQueue destinations(List destinations) {
  ...
  public GameSessionQueue filterConfiguration(CreateGameSessionQueueInputFilterConfiguration filterConfiguration) {
  ...
  public GameSessionQueue priorityConfiguration(CreateGameSessionQueueInputPriorityConfiguration priorityConfiguration) {
  ...
  public GameSessionQueue customEventData(String customEventData) {
  ...
  public GameSessionQueue notificationTarget(String notificationTarget) {
  ...
  public boolean equals(Object o) {
    ...
    GameSessionQueue gameSessionQueue = (GameSessionQueue) o;
    return Objects.equals(this.name, gameSessionQueue.name) &&
        Objects.equals(this.gameSessionQueueArn, gameSessionQueue.gameSessionQueueArn) &&
        Objects.equals(this.timeoutInSeconds, gameSessionQueue.timeoutInSeconds) &&
        Objects.equals(this.playerLatencyPolicies, gameSessionQueue.playerLatencyPolicies) &&
        Objects.equals(this.destinations, gameSessionQueue.destinations) &&
        Objects.equals(this.filterConfiguration, gameSessionQueue.filterConfiguration) &&
        Objects.equals(this.priorityConfiguration, gameSessionQueue.priorityConfiguration) &&
        Objects.equals(this.customEventData, gameSessionQueue.customEventData) &&
        Objects.equals(this.notificationTarget, gameSessionQueue.notificationTarget);
  }
  ...
  public String toString() {
    ...
    sb.append("class GameSessionQueue {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GameSessionQueue
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GameSessionQueue.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GameSessionQueue is not found in the empty JSON string", GameSessionQueue.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GameSessionQueue.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GameSessionQueue` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GameSessionQueue.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GameSessionQueue' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GameSessionQueue> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GameSessionQueue.class));

       return (TypeAdapter<T>) new TypeAdapter<GameSessionQueue>() {
           @Override
           public void write(JsonWriter out, GameSessionQueue value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GameSessionQueue read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GameSessionQueue given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GameSessionQueue
   * @throws IOException if the JSON string is invalid with respect to GameSessionQueue
   */
  public static GameSessionQueue fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GameSessionQueue.class);
  }

  /**
   * Convert an instance of GameSessionQueue to an JSON string
   *
   * @return JSON string
   */
