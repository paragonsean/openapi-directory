...
/**
 * Gets or Sets RoutingStrategyType
 */
@JsonAdapter(RoutingStrategyType.Adapter.class)
public enum RoutingStrategyType {
  ...
  public static RoutingStrategyType fromValue(String value) {
    for (RoutingStrategyType b : RoutingStrategyType.values()) {
  ...
  public static class Adapter extends TypeAdapter<RoutingStrategyType> {
    @Override
    public void write(final JsonWriter jsonWriter, final RoutingStrategyType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RoutingStrategyType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RoutingStrategyType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    RoutingStrategyType.fromValue(value);
  }
}
