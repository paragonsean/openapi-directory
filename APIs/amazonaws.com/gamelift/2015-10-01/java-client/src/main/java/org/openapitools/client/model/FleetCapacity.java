...
public class FleetCapacity {
  ...
  public static final String SERIALIZED_NAME_INSTANCE_COUNTS = "InstanceCounts";
  @SerializedName(SERIALIZED_NAME_INSTANCE_COUNTS)
  ...
  public FleetCapacity fleetId(String fleetId) {
  ...
  public FleetCapacity fleetArn(String fleetArn) {
  ...
  public FleetCapacity instanceType(EC2InstanceType instanceType) {
  ...
  public FleetCapacity instanceCounts(EC2InstanceCounts instanceCounts) {
  ...
  public FleetCapacity location(String location) {
  ...
  public boolean equals(Object o) {
    ...
    FleetCapacity fleetCapacity = (FleetCapacity) o;
    return Objects.equals(this.fleetId, fleetCapacity.fleetId) &&
        Objects.equals(this.fleetArn, fleetCapacity.fleetArn) &&
        Objects.equals(this.instanceType, fleetCapacity.instanceType) &&
        Objects.equals(this.instanceCounts, fleetCapacity.instanceCounts) &&
        Objects.equals(this.location, fleetCapacity.location);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fleetId, fleetArn, instanceType, instanceCounts, location);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FleetCapacity {\n");
    ...
    sb.append("    instanceCounts: ").append(toIndentedString(instanceCounts)).append("\n");
  ...
  static {
    ...
    openapiFields.add("InstanceCounts");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FleetCapacity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FleetCapacity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FleetCapacity is not found in the empty JSON string", FleetCapacity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FleetCapacity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FleetCapacity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `InstanceCounts`
      if (jsonObj.get("InstanceCounts") != null && !jsonObj.get("InstanceCounts").isJsonNull()) {
        EC2InstanceCounts.validateJsonElement(jsonObj.get("InstanceCounts"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FleetCapacity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FleetCapacity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FleetCapacity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FleetCapacity.class));

       return (TypeAdapter<T>) new TypeAdapter<FleetCapacity>() {
           @Override
           public void write(JsonWriter out, FleetCapacity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FleetCapacity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FleetCapacity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FleetCapacity
   * @throws IOException if the JSON string is invalid with respect to FleetCapacity
   */
  public static FleetCapacity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FleetCapacity.class);
  }

  /**
   * Convert an instance of FleetCapacity to an JSON string
   *
   * @return JSON string
   */
