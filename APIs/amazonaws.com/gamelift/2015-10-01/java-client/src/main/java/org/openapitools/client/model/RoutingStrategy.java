...
public class RoutingStrategy {
  ...
  public RoutingStrategy type(RoutingStrategyType type) {
    this.type = type;
    return this;
  }
  ...
  public RoutingStrategy fleetId(String fleetId) {
  ...
  public RoutingStrategy message(String message) {
  ...
  public boolean equals(Object o) {
    ...
    RoutingStrategy routingStrategy = (RoutingStrategy) o;
    return Objects.equals(this.type, routingStrategy.type) &&
        Objects.equals(this.fleetId, routingStrategy.fleetId) &&
        Objects.equals(this.message, routingStrategy.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class RoutingStrategy {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RoutingStrategy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RoutingStrategy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RoutingStrategy is not found in the empty JSON string", RoutingStrategy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RoutingStrategy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RoutingStrategy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RoutingStrategy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RoutingStrategy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RoutingStrategy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RoutingStrategy.class));

       return (TypeAdapter<T>) new TypeAdapter<RoutingStrategy>() {
           @Override
           public void write(JsonWriter out, RoutingStrategy value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RoutingStrategy read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RoutingStrategy given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RoutingStrategy
   * @throws IOException if the JSON string is invalid with respect to RoutingStrategy
   */
  public static RoutingStrategy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RoutingStrategy.class);
  }

  /**
   * Convert an instance of RoutingStrategy to an JSON string
   *
   * @return JSON string
   */
