...
public class LocationState {
  ...
  public LocationState location(String location) {
  ...
  public LocationState status(FleetStatus status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.location, locationState.location) &&
        Objects.equals(this.status, locationState.status);
  }
