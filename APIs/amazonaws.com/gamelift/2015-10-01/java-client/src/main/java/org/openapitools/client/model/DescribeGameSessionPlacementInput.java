...
public class DescribeGameSessionPlacementInput {
  ...
  public DescribeGameSessionPlacementInput() {
  }

  public DescribeGameSessionPlacementInput placementId(String placementId) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeGameSessionPlacementInput describeGameSessionPlacementInput = (DescribeGameSessionPlacementInput) o;
    return Objects.equals(this.placementId, describeGameSessionPlacementInput.placementId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeGameSessionPlacementInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeGameSessionPlacementInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeGameSessionPlacementInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeGameSessionPlacementInput is not found in the empty JSON string", DescribeGameSessionPlacementInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeGameSessionPlacementInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeGameSessionPlacementInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeGameSessionPlacementInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeGameSessionPlacementInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeGameSessionPlacementInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeGameSessionPlacementInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeGameSessionPlacementInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeGameSessionPlacementInput>() {
           @Override
           public void write(JsonWriter out, DescribeGameSessionPlacementInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeGameSessionPlacementInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeGameSessionPlacementInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeGameSessionPlacementInput
   * @throws IOException if the JSON string is invalid with respect to DescribeGameSessionPlacementInput
   */
  public static DescribeGameSessionPlacementInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeGameSessionPlacementInput.class);
  }

  /**
   * Convert an instance of DescribeGameSessionPlacementInput to an JSON string
   *
   * @return JSON string
   */
