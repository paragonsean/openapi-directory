...
/**
 * Gets or Sets GameSessionStatusReason
 */
@JsonAdapter(GameSessionStatusReason.Adapter.class)
public enum GameSessionStatusReason {
  ...
  GameSessionStatusReason(String value) {
    this.value = value;
  }
  ...
  public static GameSessionStatusReason fromValue(String value) {
    for (GameSessionStatusReason b : GameSessionStatusReason.values()) {
  ...
  public static class Adapter extends TypeAdapter<GameSessionStatusReason> {
    @Override
    public void write(final JsonWriter jsonWriter, final GameSessionStatusReason enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public GameSessionStatusReason read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return GameSessionStatusReason.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    GameSessionStatusReason.fromValue(value);
  }
}
