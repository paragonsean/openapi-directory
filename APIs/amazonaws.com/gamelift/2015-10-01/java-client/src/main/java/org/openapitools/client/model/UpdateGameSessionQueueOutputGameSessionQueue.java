...
public class UpdateGameSessionQueueOutputGameSessionQueue {
  ...
  public UpdateGameSessionQueueOutputGameSessionQueue() {
  }

  public UpdateGameSessionQueueOutputGameSessionQueue name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateGameSessionQueueOutputGameSessionQueue gameSessionQueueArn(String gameSessionQueueArn) {
  ...
  public UpdateGameSessionQueueOutputGameSessionQueue timeoutInSeconds(Integer timeoutInSeconds) {
  ...
  public UpdateGameSessionQueueOutputGameSessionQueue playerLatencyPolicies(List playerLatencyPolicies) {
  ...
  public UpdateGameSessionQueueOutputGameSessionQueue destinations(List destinations) {
  ...
  public UpdateGameSessionQueueOutputGameSessionQueue filterConfiguration(CreateGameSessionQueueInputFilterConfiguration filterConfiguration) {
  ...
  public UpdateGameSessionQueueOutputGameSessionQueue priorityConfiguration(CreateGameSessionQueueInputPriorityConfiguration priorityConfiguration) {
  ...
  public UpdateGameSessionQueueOutputGameSessionQueue customEventData(String customEventData) {
  ...
  public UpdateGameSessionQueueOutputGameSessionQueue notificationTarget(String notificationTarget) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateGameSessionQueueOutputGameSessionQueue updateGameSessionQueueOutputGameSessionQueue = (UpdateGameSessionQueueOutputGameSessionQueue) o;
    return Objects.equals(this.name, updateGameSessionQueueOutputGameSessionQueue.name) &&
        Objects.equals(this.gameSessionQueueArn, updateGameSessionQueueOutputGameSessionQueue.gameSessionQueueArn) &&
        Objects.equals(this.timeoutInSeconds, updateGameSessionQueueOutputGameSessionQueue.timeoutInSeconds) &&
        Objects.equals(this.playerLatencyPolicies, updateGameSessionQueueOutputGameSessionQueue.playerLatencyPolicies) &&
        Objects.equals(this.destinations, updateGameSessionQueueOutputGameSessionQueue.destinations) &&
        Objects.equals(this.filterConfiguration, updateGameSessionQueueOutputGameSessionQueue.filterConfiguration) &&
        Objects.equals(this.priorityConfiguration, updateGameSessionQueueOutputGameSessionQueue.priorityConfiguration) &&
        Objects.equals(this.customEventData, updateGameSessionQueueOutputGameSessionQueue.customEventData) &&
        Objects.equals(this.notificationTarget, updateGameSessionQueueOutputGameSessionQueue.notificationTarget);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateGameSessionQueueOutputGameSessionQueue {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateGameSessionQueueOutputGameSessionQueue
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateGameSessionQueueOutputGameSessionQueue.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateGameSessionQueueOutputGameSessionQueue is not found in the empty JSON string", UpdateGameSessionQueueOutputGameSessionQueue.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateGameSessionQueueOutputGameSessionQueue.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateGameSessionQueueOutputGameSessionQueue` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateGameSessionQueueOutputGameSessionQueue.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateGameSessionQueueOutputGameSessionQueue' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateGameSessionQueueOutputGameSessionQueue> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateGameSessionQueueOutputGameSessionQueue.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateGameSessionQueueOutputGameSessionQueue>() {
           @Override
           public void write(JsonWriter out, UpdateGameSessionQueueOutputGameSessionQueue value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateGameSessionQueueOutputGameSessionQueue read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateGameSessionQueueOutputGameSessionQueue given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateGameSessionQueueOutputGameSessionQueue
   * @throws IOException if the JSON string is invalid with respect to UpdateGameSessionQueueOutputGameSessionQueue
   */
  public static UpdateGameSessionQueueOutputGameSessionQueue fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateGameSessionQueueOutputGameSessionQueue.class);
  }

  /**
   * Convert an instance of UpdateGameSessionQueueOutputGameSessionQueue to an JSON string
   *
   * @return JSON string
   */
