...
/**
 * Gets or Sets GameServerGroupStatus
 */
@JsonAdapter(GameServerGroupStatus.Adapter.class)
public enum GameServerGroupStatus {
  ...
  GameServerGroupStatus(String value) {
    this.value = value;
  }
  ...
  public static GameServerGroupStatus fromValue(String value) {
    for (GameServerGroupStatus b : GameServerGroupStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<GameServerGroupStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final GameServerGroupStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public GameServerGroupStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return GameServerGroupStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    GameServerGroupStatus.fromValue(value);
  }
}
