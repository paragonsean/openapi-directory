...
public class PutScalingPolicyOutput {
  ...
  public PutScalingPolicyOutput name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PutScalingPolicyOutput putScalingPolicyOutput = (PutScalingPolicyOutput) o;
    return Objects.equals(this.name, putScalingPolicyOutput.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class PutScalingPolicyOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutScalingPolicyOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutScalingPolicyOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutScalingPolicyOutput is not found in the empty JSON string", PutScalingPolicyOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutScalingPolicyOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutScalingPolicyOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutScalingPolicyOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutScalingPolicyOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutScalingPolicyOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutScalingPolicyOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<PutScalingPolicyOutput>() {
           @Override
           public void write(JsonWriter out, PutScalingPolicyOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutScalingPolicyOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutScalingPolicyOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutScalingPolicyOutput
   * @throws IOException if the JSON string is invalid with respect to PutScalingPolicyOutput
   */
  public static PutScalingPolicyOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutScalingPolicyOutput.class);
  }

  /**
   * Convert an instance of PutScalingPolicyOutput to an JSON string
   *
   * @return JSON string
   */
