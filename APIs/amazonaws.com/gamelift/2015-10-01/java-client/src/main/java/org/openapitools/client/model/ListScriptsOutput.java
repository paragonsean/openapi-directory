...
public class ListScriptsOutput {
  ...
  public ListScriptsOutput scripts(List scripts) {
  ...
  public ListScriptsOutput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListScriptsOutput listScriptsOutput = (ListScriptsOutput) o;
    return Objects.equals(this.scripts, listScriptsOutput.scripts) &&
        Objects.equals(this.nextToken, listScriptsOutput.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(scripts, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListScriptsOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListScriptsOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListScriptsOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListScriptsOutput is not found in the empty JSON string", ListScriptsOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListScriptsOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListScriptsOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Scripts`
      if (jsonObj.get("Scripts") != null && !jsonObj.get("Scripts").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("Scripts"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListScriptsOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListScriptsOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListScriptsOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListScriptsOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListScriptsOutput>() {
           @Override
           public void write(JsonWriter out, ListScriptsOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListScriptsOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListScriptsOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListScriptsOutput
   * @throws IOException if the JSON string is invalid with respect to ListScriptsOutput
   */
  public static ListScriptsOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListScriptsOutput.class);
  }

  /**
   * Convert an instance of ListScriptsOutput to an JSON string
   *
   * @return JSON string
   */
