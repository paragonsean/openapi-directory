...
/**
 * Gets or Sets GameServerProtectionPolicy
 */
@JsonAdapter(GameServerProtectionPolicy.Adapter.class)
public enum GameServerProtectionPolicy {
  ...
  GameServerProtectionPolicy(String value) {
    this.value = value;
  }
  ...
  public static GameServerProtectionPolicy fromValue(String value) {
    for (GameServerProtectionPolicy b : GameServerProtectionPolicy.values()) {
  ...
  public static class Adapter extends TypeAdapter<GameServerProtectionPolicy> {
    @Override
    public void write(final JsonWriter jsonWriter, final GameServerProtectionPolicy enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public GameServerProtectionPolicy read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return GameServerProtectionPolicy.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    GameServerProtectionPolicy.fromValue(value);
  }
}
