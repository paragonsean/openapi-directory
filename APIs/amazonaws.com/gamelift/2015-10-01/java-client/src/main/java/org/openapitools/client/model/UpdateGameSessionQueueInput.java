...
import org.openapitools.client.model.UpdateGameSessionQueueInputFilterConfiguration;
import org.openapitools.client.model.UpdateGameSessionQueueInputPriorityConfiguration;
...
public class UpdateGameSessionQueueInput {
  ...
  private UpdateGameSessionQueueInputFilterConfiguration filterConfiguration;
  ...
  private UpdateGameSessionQueueInputPriorityConfiguration priorityConfiguration;
  ...
  public UpdateGameSessionQueueInput() {
  }

  public UpdateGameSessionQueueInput name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateGameSessionQueueInput timeoutInSeconds(Integer timeoutInSeconds) {
  ...
  public UpdateGameSessionQueueInput playerLatencyPolicies(List playerLatencyPolicies) {
  ...
  public UpdateGameSessionQueueInput destinations(List destinations) {
  ...
  public UpdateGameSessionQueueInput filterConfiguration(UpdateGameSessionQueueInputFilterConfiguration filterConfiguration) {
   ...
   */
  @javax.annotation.Nullable
  public UpdateGameSessionQueueInputFilterConfiguration getFilterConfiguration() {
    return filterConfiguration;
  }

  public void setFilterConfiguration(UpdateGameSessionQueueInputFilterConfiguration filterConfiguration) {
    this.filterConfiguration = filterConfiguration;
  }


  public UpdateGameSessionQueueInput priorityConfiguration(UpdateGameSessionQueueInputPriorityConfiguration priorityConfiguration) {
   ...
   */
  @javax.annotation.Nullable
  public UpdateGameSessionQueueInputPriorityConfiguration getPriorityConfiguration() {
    return priorityConfiguration;
  }

  public void setPriorityConfiguration(UpdateGameSessionQueueInputPriorityConfiguration priorityConfiguration) {
    this.priorityConfiguration = priorityConfiguration;
  }


  public UpdateGameSessionQueueInput customEventData(String customEventData) {
  ...
  public UpdateGameSessionQueueInput notificationTarget(String notificationTarget) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateGameSessionQueueInput updateGameSessionQueueInput = (UpdateGameSessionQueueInput) o;
    return Objects.equals(this.name, updateGameSessionQueueInput.name) &&
        Objects.equals(this.timeoutInSeconds, updateGameSessionQueueInput.timeoutInSeconds) &&
        Objects.equals(this.playerLatencyPolicies, updateGameSessionQueueInput.playerLatencyPolicies) &&
        Objects.equals(this.destinations, updateGameSessionQueueInput.destinations) &&
        Objects.equals(this.filterConfiguration, updateGameSessionQueueInput.filterConfiguration) &&
        Objects.equals(this.priorityConfiguration, updateGameSessionQueueInput.priorityConfiguration) &&
        Objects.equals(this.customEventData, updateGameSessionQueueInput.customEventData) &&
        Objects.equals(this.notificationTarget, updateGameSessionQueueInput.notificationTarget);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, timeoutInSeconds, playerLatencyPolicies, destinations, filterConfiguration, priorityConfiguration, customEventData, notificationTarget);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateGameSessionQueueInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateGameSessionQueueInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateGameSessionQueueInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateGameSessionQueueInput is not found in the empty JSON string", UpdateGameSessionQueueInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateGameSessionQueueInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateGameSessionQueueInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateGameSessionQueueInput.openapiRequiredFields) {
      ...
      if (jsonObj.get("FilterConfiguration") != null && !jsonObj.get("FilterConfiguration").isJsonNull()) {
        UpdateGameSessionQueueInputFilterConfiguration.validateJsonElement(jsonObj.get("FilterConfiguration"));
      }
      ...
      if (jsonObj.get("PriorityConfiguration") != null && !jsonObj.get("PriorityConfiguration").isJsonNull()) {
        UpdateGameSessionQueueInputPriorityConfiguration.validateJsonElement(jsonObj.get("PriorityConfiguration"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateGameSessionQueueInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateGameSessionQueueInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateGameSessionQueueInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateGameSessionQueueInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateGameSessionQueueInput>() {
           @Override
           public void write(JsonWriter out, UpdateGameSessionQueueInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateGameSessionQueueInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateGameSessionQueueInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateGameSessionQueueInput
   * @throws IOException if the JSON string is invalid with respect to UpdateGameSessionQueueInput
   */
  public static UpdateGameSessionQueueInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateGameSessionQueueInput.class);
  }

  /**
   * Convert an instance of UpdateGameSessionQueueInput to an JSON string
   *
   * @return JSON string
   */
