...
public class DescribeGameSessionPlacementOutputGameSessionPlacement {
  ...
  public DescribeGameSessionPlacementOutputGameSessionPlacement() {
  }

  public DescribeGameSessionPlacementOutputGameSessionPlacement placementId(String placementId) {
  ...
  public DescribeGameSessionPlacementOutputGameSessionPlacement gameSessionQueueName(String gameSessionQueueName) {
  ...
  public DescribeGameSessionPlacementOutputGameSessionPlacement status(GameSessionPlacementState status) {
    this.status = status;
    return this;
  }
  ...
  public DescribeGameSessionPlacementOutputGameSessionPlacement gameProperties(List gameProperties) {
  ...
  public DescribeGameSessionPlacementOutputGameSessionPlacement maximumPlayerSessionCount(Integer maximumPlayerSessionCount) {
  ...
  public DescribeGameSessionPlacementOutputGameSessionPlacement gameSessionName(String gameSessionName) {
  ...
  public DescribeGameSessionPlacementOutputGameSessionPlacement gameSessionId(String gameSessionId) {
  ...
  public DescribeGameSessionPlacementOutputGameSessionPlacement gameSessionArn(String gameSessionArn) {
  ...
  public DescribeGameSessionPlacementOutputGameSessionPlacement gameSessionRegion(String gameSessionRegion) {
  ...
  public DescribeGameSessionPlacementOutputGameSessionPlacement playerLatencies(List playerLatencies) {
  ...
  public DescribeGameSessionPlacementOutputGameSessionPlacement startTime(OffsetDateTime startTime) {
  ...
  public DescribeGameSessionPlacementOutputGameSessionPlacement endTime(OffsetDateTime endTime) {
  ...
  public DescribeGameSessionPlacementOutputGameSessionPlacement ipAddress(String ipAddress) {
  ...
  public DescribeGameSessionPlacementOutputGameSessionPlacement dnsName(String dnsName) {
  ...
  public DescribeGameSessionPlacementOutputGameSessionPlacement port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public DescribeGameSessionPlacementOutputGameSessionPlacement placedPlayerSessions(List placedPlayerSessions) {
  ...
  public DescribeGameSessionPlacementOutputGameSessionPlacement gameSessionData(String gameSessionData) {
  ...
  public DescribeGameSessionPlacementOutputGameSessionPlacement matchmakerData(String matchmakerData) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeGameSessionPlacementOutputGameSessionPlacement describeGameSessionPlacementOutputGameSessionPlacement = (DescribeGameSessionPlacementOutputGameSessionPlacement) o;
    return Objects.equals(this.placementId, describeGameSessionPlacementOutputGameSessionPlacement.placementId) &&
        Objects.equals(this.gameSessionQueueName, describeGameSessionPlacementOutputGameSessionPlacement.gameSessionQueueName) &&
        Objects.equals(this.status, describeGameSessionPlacementOutputGameSessionPlacement.status) &&
        Objects.equals(this.gameProperties, describeGameSessionPlacementOutputGameSessionPlacement.gameProperties) &&
        Objects.equals(this.maximumPlayerSessionCount, describeGameSessionPlacementOutputGameSessionPlacement.maximumPlayerSessionCount) &&
        Objects.equals(this.gameSessionName, describeGameSessionPlacementOutputGameSessionPlacement.gameSessionName) &&
        Objects.equals(this.gameSessionId, describeGameSessionPlacementOutputGameSessionPlacement.gameSessionId) &&
        Objects.equals(this.gameSessionArn, describeGameSessionPlacementOutputGameSessionPlacement.gameSessionArn) &&
        Objects.equals(this.gameSessionRegion, describeGameSessionPlacementOutputGameSessionPlacement.gameSessionRegion) &&
        Objects.equals(this.playerLatencies, describeGameSessionPlacementOutputGameSessionPlacement.playerLatencies) &&
        Objects.equals(this.startTime, describeGameSessionPlacementOutputGameSessionPlacement.startTime) &&
        Objects.equals(this.endTime, describeGameSessionPlacementOutputGameSessionPlacement.endTime) &&
        Objects.equals(this.ipAddress, describeGameSessionPlacementOutputGameSessionPlacement.ipAddress) &&
        Objects.equals(this.dnsName, describeGameSessionPlacementOutputGameSessionPlacement.dnsName) &&
        Objects.equals(this.port, describeGameSessionPlacementOutputGameSessionPlacement.port) &&
        Objects.equals(this.placedPlayerSessions, describeGameSessionPlacementOutputGameSessionPlacement.placedPlayerSessions) &&
        Objects.equals(this.gameSessionData, describeGameSessionPlacementOutputGameSessionPlacement.gameSessionData) &&
        Objects.equals(this.matchmakerData, describeGameSessionPlacementOutputGameSessionPlacement.matchmakerData);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeGameSessionPlacementOutputGameSessionPlacement {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeGameSessionPlacementOutputGameSessionPlacement
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeGameSessionPlacementOutputGameSessionPlacement.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeGameSessionPlacementOutputGameSessionPlacement is not found in the empty JSON string", DescribeGameSessionPlacementOutputGameSessionPlacement.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeGameSessionPlacementOutputGameSessionPlacement.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeGameSessionPlacementOutputGameSessionPlacement` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeGameSessionPlacementOutputGameSessionPlacement.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeGameSessionPlacementOutputGameSessionPlacement' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeGameSessionPlacementOutputGameSessionPlacement> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeGameSessionPlacementOutputGameSessionPlacement.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeGameSessionPlacementOutputGameSessionPlacement>() {
           @Override
           public void write(JsonWriter out, DescribeGameSessionPlacementOutputGameSessionPlacement value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeGameSessionPlacementOutputGameSessionPlacement read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeGameSessionPlacementOutputGameSessionPlacement given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeGameSessionPlacementOutputGameSessionPlacement
   * @throws IOException if the JSON string is invalid with respect to DescribeGameSessionPlacementOutputGameSessionPlacement
   */
  public static DescribeGameSessionPlacementOutputGameSessionPlacement fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeGameSessionPlacementOutputGameSessionPlacement.class);
  }

  /**
   * Convert an instance of DescribeGameSessionPlacementOutputGameSessionPlacement to an JSON string
   *
   * @return JSON string
   */
