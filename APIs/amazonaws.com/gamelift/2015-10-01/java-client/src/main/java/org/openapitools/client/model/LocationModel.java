...
public class LocationModel {
  ...
  public LocationModel locationArn(String locationArn) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.locationName, locationModel.locationName) &&
        Objects.equals(this.locationArn, locationModel.locationArn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(locationName, locationArn);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LocationModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LocationModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LocationModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LocationModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
