...
public class MatchedPlayerSession {
  ...
  public MatchedPlayerSession playerId(String playerId) {
  ...
  public MatchedPlayerSession playerSessionId(String playerSessionId) {
  ...
  public boolean equals(Object o) {
    ...
    MatchedPlayerSession matchedPlayerSession = (MatchedPlayerSession) o;
    return Objects.equals(this.playerId, matchedPlayerSession.playerId) &&
        Objects.equals(this.playerSessionId, matchedPlayerSession.playerSessionId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(playerId, playerSessionId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MatchedPlayerSession {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MatchedPlayerSession
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MatchedPlayerSession.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MatchedPlayerSession is not found in the empty JSON string", MatchedPlayerSession.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MatchedPlayerSession.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MatchedPlayerSession` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MatchedPlayerSession.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MatchedPlayerSession' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MatchedPlayerSession> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MatchedPlayerSession.class));

       return (TypeAdapter<T>) new TypeAdapter<MatchedPlayerSession>() {
           @Override
           public void write(JsonWriter out, MatchedPlayerSession value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MatchedPlayerSession read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MatchedPlayerSession given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MatchedPlayerSession
   * @throws IOException if the JSON string is invalid with respect to MatchedPlayerSession
   */
  public static MatchedPlayerSession fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MatchedPlayerSession.class);
  }

  /**
   * Convert an instance of MatchedPlayerSession to an JSON string
   *
   * @return JSON string
   */
