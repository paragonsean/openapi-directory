...
/**
 * Gets or Sets GameServerClaimStatus
 */
@JsonAdapter(GameServerClaimStatus.Adapter.class)
public enum GameServerClaimStatus {
  ...
  GameServerClaimStatus(String value) {
    this.value = value;
  }
  ...
  public static GameServerClaimStatus fromValue(String value) {
    for (GameServerClaimStatus b : GameServerClaimStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<GameServerClaimStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final GameServerClaimStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public GameServerClaimStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return GameServerClaimStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    GameServerClaimStatus.fromValue(value);
  }
}
