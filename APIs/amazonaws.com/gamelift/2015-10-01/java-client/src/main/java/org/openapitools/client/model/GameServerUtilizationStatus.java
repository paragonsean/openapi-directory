...
/**
 * Gets or Sets GameServerUtilizationStatus
 */
@JsonAdapter(GameServerUtilizationStatus.Adapter.class)
public enum GameServerUtilizationStatus {
  ...
  GameServerUtilizationStatus(String value) {
    this.value = value;
  }
  ...
  public static GameServerUtilizationStatus fromValue(String value) {
    for (GameServerUtilizationStatus b : GameServerUtilizationStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<GameServerUtilizationStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final GameServerUtilizationStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public GameServerUtilizationStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return GameServerUtilizationStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    GameServerUtilizationStatus.fromValue(value);
  }
}
