...
import org.openapitools.client.model.DescribeComputeOutputCompute;
...
public class DescribeComputeOutput {
  ...
  private DescribeComputeOutputCompute compute;

  public DescribeComputeOutput() {
  }

  public DescribeComputeOutput compute(DescribeComputeOutputCompute compute) {
  ...
  public DescribeComputeOutputCompute getCompute() {
    return compute;
  }

  public void setCompute(DescribeComputeOutputCompute compute) {
    this.compute = compute;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeComputeOutput describeComputeOutput = (DescribeComputeOutput) o;
    return Objects.equals(this.compute, describeComputeOutput.compute);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeComputeOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeComputeOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeComputeOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeComputeOutput is not found in the empty JSON string", DescribeComputeOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeComputeOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeComputeOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Compute`
      if (jsonObj.get("Compute") != null && !jsonObj.get("Compute").isJsonNull()) {
        DescribeComputeOutputCompute.validateJsonElement(jsonObj.get("Compute"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeComputeOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeComputeOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeComputeOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeComputeOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeComputeOutput>() {
           @Override
           public void write(JsonWriter out, DescribeComputeOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeComputeOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeComputeOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeComputeOutput
   * @throws IOException if the JSON string is invalid with respect to DescribeComputeOutput
   */
  public static DescribeComputeOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeComputeOutput.class);
  }

  /**
   * Convert an instance of DescribeComputeOutput to an JSON string
   *
   * @return JSON string
   */
