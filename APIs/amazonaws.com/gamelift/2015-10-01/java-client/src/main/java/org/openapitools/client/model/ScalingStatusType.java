...
/**
 * Gets or Sets ScalingStatusType
 */
@JsonAdapter(ScalingStatusType.Adapter.class)
public enum ScalingStatusType {
  ...
  ScalingStatusType(String value) {
    this.value = value;
  }
  ...
  public static ScalingStatusType fromValue(String value) {
    for (ScalingStatusType b : ScalingStatusType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ScalingStatusType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ScalingStatusType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ScalingStatusType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ScalingStatusType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ScalingStatusType.fromValue(value);
  }
}
