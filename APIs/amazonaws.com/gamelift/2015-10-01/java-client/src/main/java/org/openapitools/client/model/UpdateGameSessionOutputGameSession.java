...
public class UpdateGameSessionOutputGameSession {
  ...
  public UpdateGameSessionOutputGameSession() {
  }

  public UpdateGameSessionOutputGameSession gameSessionId(String gameSessionId) {
  ...
  public UpdateGameSessionOutputGameSession name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateGameSessionOutputGameSession fleetId(String fleetId) {
  ...
  public UpdateGameSessionOutputGameSession fleetArn(String fleetArn) {
  ...
  public UpdateGameSessionOutputGameSession creationTime(OffsetDateTime creationTime) {
  ...
  public UpdateGameSessionOutputGameSession terminationTime(OffsetDateTime terminationTime) {
  ...
  public UpdateGameSessionOutputGameSession currentPlayerSessionCount(Integer currentPlayerSessionCount) {
  ...
  public UpdateGameSessionOutputGameSession maximumPlayerSessionCount(Integer maximumPlayerSessionCount) {
  ...
  public UpdateGameSessionOutputGameSession status(GameSessionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public UpdateGameSessionOutputGameSession statusReason(GameSessionStatusReason statusReason) {
  ...
  public UpdateGameSessionOutputGameSession gameProperties(List gameProperties) {
  ...
  public UpdateGameSessionOutputGameSession ipAddress(String ipAddress) {
  ...
  public UpdateGameSessionOutputGameSession dnsName(String dnsName) {
  ...
  public UpdateGameSessionOutputGameSession port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public UpdateGameSessionOutputGameSession playerSessionCreationPolicy(PlayerSessionCreationPolicy playerSessionCreationPolicy) {
  ...
  public UpdateGameSessionOutputGameSession creatorId(String creatorId) {
  ...
  public UpdateGameSessionOutputGameSession gameSessionData(String gameSessionData) {
  ...
  public UpdateGameSessionOutputGameSession matchmakerData(String matchmakerData) {
  ...
  public UpdateGameSessionOutputGameSession location(String location) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateGameSessionOutputGameSession updateGameSessionOutputGameSession = (UpdateGameSessionOutputGameSession) o;
    return Objects.equals(this.gameSessionId, updateGameSessionOutputGameSession.gameSessionId) &&
        Objects.equals(this.name, updateGameSessionOutputGameSession.name) &&
        Objects.equals(this.fleetId, updateGameSessionOutputGameSession.fleetId) &&
        Objects.equals(this.fleetArn, updateGameSessionOutputGameSession.fleetArn) &&
        Objects.equals(this.creationTime, updateGameSessionOutputGameSession.creationTime) &&
        Objects.equals(this.terminationTime, updateGameSessionOutputGameSession.terminationTime) &&
        Objects.equals(this.currentPlayerSessionCount, updateGameSessionOutputGameSession.currentPlayerSessionCount) &&
        Objects.equals(this.maximumPlayerSessionCount, updateGameSessionOutputGameSession.maximumPlayerSessionCount) &&
        Objects.equals(this.status, updateGameSessionOutputGameSession.status) &&
        Objects.equals(this.statusReason, updateGameSessionOutputGameSession.statusReason) &&
        Objects.equals(this.gameProperties, updateGameSessionOutputGameSession.gameProperties) &&
        Objects.equals(this.ipAddress, updateGameSessionOutputGameSession.ipAddress) &&
        Objects.equals(this.dnsName, updateGameSessionOutputGameSession.dnsName) &&
        Objects.equals(this.port, updateGameSessionOutputGameSession.port) &&
        Objects.equals(this.playerSessionCreationPolicy, updateGameSessionOutputGameSession.playerSessionCreationPolicy) &&
        Objects.equals(this.creatorId, updateGameSessionOutputGameSession.creatorId) &&
        Objects.equals(this.gameSessionData, updateGameSessionOutputGameSession.gameSessionData) &&
        Objects.equals(this.matchmakerData, updateGameSessionOutputGameSession.matchmakerData) &&
        Objects.equals(this.location, updateGameSessionOutputGameSession.location);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateGameSessionOutputGameSession {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateGameSessionOutputGameSession
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateGameSessionOutputGameSession.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateGameSessionOutputGameSession is not found in the empty JSON string", UpdateGameSessionOutputGameSession.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateGameSessionOutputGameSession.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateGameSessionOutputGameSession` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateGameSessionOutputGameSession.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateGameSessionOutputGameSession' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateGameSessionOutputGameSession> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateGameSessionOutputGameSession.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateGameSessionOutputGameSession>() {
           @Override
           public void write(JsonWriter out, UpdateGameSessionOutputGameSession value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateGameSessionOutputGameSession read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateGameSessionOutputGameSession given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateGameSessionOutputGameSession
   * @throws IOException if the JSON string is invalid with respect to UpdateGameSessionOutputGameSession
   */
  public static UpdateGameSessionOutputGameSession fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateGameSessionOutputGameSession.class);
  }

  /**
   * Convert an instance of UpdateGameSessionOutputGameSession to an JSON string
   *
   * @return JSON string
   */
