...
public class InstanceAccess {
  ...
  public InstanceAccess fleetId(String fleetId) {
  ...
  public InstanceAccess instanceId(String instanceId) {
  ...
  public InstanceAccess ipAddress(String ipAddress) {
  ...
  public InstanceAccess operatingSystem(OperatingSystem operatingSystem) {
  ...
  public InstanceAccess credentials(InstanceAccessCredentials credentials) {
  ...
  public boolean equals(Object o) {
    ...
    InstanceAccess instanceAccess = (InstanceAccess) o;
    return Objects.equals(this.fleetId, instanceAccess.fleetId) &&
        Objects.equals(this.instanceId, instanceAccess.instanceId) &&
        Objects.equals(this.ipAddress, instanceAccess.ipAddress) &&
        Objects.equals(this.operatingSystem, instanceAccess.operatingSystem) &&
        Objects.equals(this.credentials, instanceAccess.credentials);
  }
  ...
  public String toString() {
    ...
    sb.append("class InstanceAccess {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InstanceAccess
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InstanceAccess.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InstanceAccess is not found in the empty JSON string", InstanceAccess.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InstanceAccess.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InstanceAccess` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InstanceAccess.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InstanceAccess' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InstanceAccess> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InstanceAccess.class));

       return (TypeAdapter<T>) new TypeAdapter<InstanceAccess>() {
           @Override
           public void write(JsonWriter out, InstanceAccess value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InstanceAccess read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InstanceAccess given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InstanceAccess
   * @throws IOException if the JSON string is invalid with respect to InstanceAccess
   */
  public static InstanceAccess fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InstanceAccess.class);
  }

  /**
   * Convert an instance of InstanceAccess to an JSON string
   *
   * @return JSON string
   */
