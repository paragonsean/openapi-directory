...
/**
 * Gets or Sets GameServerInstanceStatus
 */
@JsonAdapter(GameServerInstanceStatus.Adapter.class)
public enum GameServerInstanceStatus {
  ...
  GameServerInstanceStatus(String value) {
    this.value = value;
  }
  ...
  public static GameServerInstanceStatus fromValue(String value) {
    for (GameServerInstanceStatus b : GameServerInstanceStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<GameServerInstanceStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final GameServerInstanceStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public GameServerInstanceStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return GameServerInstanceStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    GameServerInstanceStatus.fromValue(value);
  }
}
