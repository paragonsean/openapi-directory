...
public class UpdateGameServerOutputGameServer {
  ...
  public UpdateGameServerOutputGameServer() {
  }

  public UpdateGameServerOutputGameServer gameServerGroupName(String gameServerGroupName) {
  ...
  public UpdateGameServerOutputGameServer gameServerGroupArn(String gameServerGroupArn) {
  ...
  public UpdateGameServerOutputGameServer gameServerId(String gameServerId) {
  ...
  public UpdateGameServerOutputGameServer instanceId(String instanceId) {
  ...
  public UpdateGameServerOutputGameServer connectionInfo(String connectionInfo) {
  ...
  public UpdateGameServerOutputGameServer gameServerData(String gameServerData) {
  ...
  public UpdateGameServerOutputGameServer claimStatus(GameServerClaimStatus claimStatus) {
  ...
  public UpdateGameServerOutputGameServer utilizationStatus(GameServerUtilizationStatus utilizationStatus) {
  ...
  public UpdateGameServerOutputGameServer registrationTime(OffsetDateTime registrationTime) {
  ...
  public UpdateGameServerOutputGameServer lastClaimTime(OffsetDateTime lastClaimTime) {
  ...
  public UpdateGameServerOutputGameServer lastHealthCheckTime(OffsetDateTime lastHealthCheckTime) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateGameServerOutputGameServer updateGameServerOutputGameServer = (UpdateGameServerOutputGameServer) o;
    return Objects.equals(this.gameServerGroupName, updateGameServerOutputGameServer.gameServerGroupName) &&
        Objects.equals(this.gameServerGroupArn, updateGameServerOutputGameServer.gameServerGroupArn) &&
        Objects.equals(this.gameServerId, updateGameServerOutputGameServer.gameServerId) &&
        Objects.equals(this.instanceId, updateGameServerOutputGameServer.instanceId) &&
        Objects.equals(this.connectionInfo, updateGameServerOutputGameServer.connectionInfo) &&
        Objects.equals(this.gameServerData, updateGameServerOutputGameServer.gameServerData) &&
        Objects.equals(this.claimStatus, updateGameServerOutputGameServer.claimStatus) &&
        Objects.equals(this.utilizationStatus, updateGameServerOutputGameServer.utilizationStatus) &&
        Objects.equals(this.registrationTime, updateGameServerOutputGameServer.registrationTime) &&
        Objects.equals(this.lastClaimTime, updateGameServerOutputGameServer.lastClaimTime) &&
        Objects.equals(this.lastHealthCheckTime, updateGameServerOutputGameServer.lastHealthCheckTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateGameServerOutputGameServer {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateGameServerOutputGameServer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateGameServerOutputGameServer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateGameServerOutputGameServer is not found in the empty JSON string", UpdateGameServerOutputGameServer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateGameServerOutputGameServer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateGameServerOutputGameServer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateGameServerOutputGameServer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateGameServerOutputGameServer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateGameServerOutputGameServer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateGameServerOutputGameServer.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateGameServerOutputGameServer>() {
           @Override
           public void write(JsonWriter out, UpdateGameServerOutputGameServer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateGameServerOutputGameServer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateGameServerOutputGameServer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateGameServerOutputGameServer
   * @throws IOException if the JSON string is invalid with respect to UpdateGameServerOutputGameServer
   */
  public static UpdateGameServerOutputGameServer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateGameServerOutputGameServer.class);
  }

  /**
   * Convert an instance of UpdateGameServerOutputGameServer to an JSON string
   *
   * @return JSON string
   */
