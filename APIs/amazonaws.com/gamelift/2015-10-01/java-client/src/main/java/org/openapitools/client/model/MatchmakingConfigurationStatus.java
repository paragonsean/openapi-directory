...
/**
 * Gets or Sets MatchmakingConfigurationStatus
 */
@JsonAdapter(MatchmakingConfigurationStatus.Adapter.class)
public enum MatchmakingConfigurationStatus {
  ...
  MatchmakingConfigurationStatus(String value) {
    this.value = value;
  }
  ...
  public static MatchmakingConfigurationStatus fromValue(String value) {
    for (MatchmakingConfigurationStatus b : MatchmakingConfigurationStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<MatchmakingConfigurationStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final MatchmakingConfigurationStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public MatchmakingConfigurationStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return MatchmakingConfigurationStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    MatchmakingConfigurationStatus.fromValue(value);
  }
}
