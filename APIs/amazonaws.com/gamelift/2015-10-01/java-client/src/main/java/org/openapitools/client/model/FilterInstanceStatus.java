...
/**
 * Gets or Sets FilterInstanceStatus
 */
@JsonAdapter(FilterInstanceStatus.Adapter.class)
public enum FilterInstanceStatus {
  ...
  FilterInstanceStatus(String value) {
    this.value = value;
  }
  ...
  public static FilterInstanceStatus fromValue(String value) {
    for (FilterInstanceStatus b : FilterInstanceStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<FilterInstanceStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final FilterInstanceStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FilterInstanceStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FilterInstanceStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FilterInstanceStatus.fromValue(value);
  }
}
