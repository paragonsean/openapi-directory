...
/**
 * Gets or Sets BackfillMode
 */
@JsonAdapter(BackfillMode.Adapter.class)
public enum BackfillMode {
  ...
  public static BackfillMode fromValue(String value) {
    for (BackfillMode b : BackfillMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<BackfillMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final BackfillMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public BackfillMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return BackfillMode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    BackfillMode.fromValue(value);
  }
}
