...
public class UpdateFleetAttributesOutput {
  ...
  public UpdateFleetAttributesOutput fleetId(String fleetId) {
  ...
  public UpdateFleetAttributesOutput fleetArn(String fleetArn) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateFleetAttributesOutput updateFleetAttributesOutput = (UpdateFleetAttributesOutput) o;
    return Objects.equals(this.fleetId, updateFleetAttributesOutput.fleetId) &&
        Objects.equals(this.fleetArn, updateFleetAttributesOutput.fleetArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateFleetAttributesOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateFleetAttributesOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateFleetAttributesOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateFleetAttributesOutput is not found in the empty JSON string", UpdateFleetAttributesOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateFleetAttributesOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateFleetAttributesOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateFleetAttributesOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateFleetAttributesOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateFleetAttributesOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateFleetAttributesOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateFleetAttributesOutput>() {
           @Override
           public void write(JsonWriter out, UpdateFleetAttributesOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateFleetAttributesOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateFleetAttributesOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateFleetAttributesOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateFleetAttributesOutput
   */
  public static UpdateFleetAttributesOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateFleetAttributesOutput.class);
  }

  /**
   * Convert an instance of UpdateFleetAttributesOutput to an JSON string
   *
   * @return JSON string
   */
