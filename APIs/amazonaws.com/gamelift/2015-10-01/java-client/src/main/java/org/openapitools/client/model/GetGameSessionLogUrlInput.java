...
public class GetGameSessionLogUrlInput {
  ...
  public GetGameSessionLogUrlInput() {
  }

  public GetGameSessionLogUrlInput gameSessionId(String gameSessionId) {
  ...
  public boolean equals(Object o) {
    ...
    GetGameSessionLogUrlInput getGameSessionLogUrlInput = (GetGameSessionLogUrlInput) o;
    return Objects.equals(this.gameSessionId, getGameSessionLogUrlInput.gameSessionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetGameSessionLogUrlInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetGameSessionLogUrlInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetGameSessionLogUrlInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetGameSessionLogUrlInput is not found in the empty JSON string", GetGameSessionLogUrlInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetGameSessionLogUrlInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetGameSessionLogUrlInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetGameSessionLogUrlInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetGameSessionLogUrlInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetGameSessionLogUrlInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetGameSessionLogUrlInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetGameSessionLogUrlInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetGameSessionLogUrlInput>() {
           @Override
           public void write(JsonWriter out, GetGameSessionLogUrlInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetGameSessionLogUrlInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetGameSessionLogUrlInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetGameSessionLogUrlInput
   * @throws IOException if the JSON string is invalid with respect to GetGameSessionLogUrlInput
   */
  public static GetGameSessionLogUrlInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetGameSessionLogUrlInput.class);
  }

  /**
   * Convert an instance of GetGameSessionLogUrlInput to an JSON string
   *
   * @return JSON string
   */
