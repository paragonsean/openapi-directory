...
/**
 * Gets or Sets ComputeStatus
 */
@JsonAdapter(ComputeStatus.Adapter.class)
public enum ComputeStatus {
  ...
  public static ComputeStatus fromValue(String value) {
    for (ComputeStatus b : ComputeStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<ComputeStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final ComputeStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ComputeStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ComputeStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ComputeStatus.fromValue(value);
  }
}
