...
public class SearchGameSessionsInput {
  ...
  public SearchGameSessionsInput fleetId(String fleetId) {
  ...
  public SearchGameSessionsInput aliasId(String aliasId) {
  ...
  public SearchGameSessionsInput location(String location) {
  ...
  public SearchGameSessionsInput filterExpression(String filterExpression) {
  ...
  public SearchGameSessionsInput sortExpression(String sortExpression) {
  ...
  public SearchGameSessionsInput limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public SearchGameSessionsInput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    SearchGameSessionsInput searchGameSessionsInput = (SearchGameSessionsInput) o;
    return Objects.equals(this.fleetId, searchGameSessionsInput.fleetId) &&
        Objects.equals(this.aliasId, searchGameSessionsInput.aliasId) &&
        Objects.equals(this.location, searchGameSessionsInput.location) &&
        Objects.equals(this.filterExpression, searchGameSessionsInput.filterExpression) &&
        Objects.equals(this.sortExpression, searchGameSessionsInput.sortExpression) &&
        Objects.equals(this.limit, searchGameSessionsInput.limit) &&
        Objects.equals(this.nextToken, searchGameSessionsInput.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fleetId, aliasId, location, filterExpression, sortExpression, limit, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SearchGameSessionsInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchGameSessionsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchGameSessionsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchGameSessionsInput is not found in the empty JSON string", SearchGameSessionsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchGameSessionsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchGameSessionsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchGameSessionsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchGameSessionsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchGameSessionsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchGameSessionsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchGameSessionsInput>() {
           @Override
           public void write(JsonWriter out, SearchGameSessionsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchGameSessionsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchGameSessionsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchGameSessionsInput
   * @throws IOException if the JSON string is invalid with respect to SearchGameSessionsInput
   */
  public static SearchGameSessionsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchGameSessionsInput.class);
  }

  /**
   * Convert an instance of SearchGameSessionsInput to an JSON string
   *
   * @return JSON string
   */
