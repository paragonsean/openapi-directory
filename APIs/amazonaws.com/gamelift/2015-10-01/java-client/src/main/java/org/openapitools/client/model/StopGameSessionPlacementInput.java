...
public class StopGameSessionPlacementInput {
  ...
  public StopGameSessionPlacementInput() {
  }

  public StopGameSessionPlacementInput placementId(String placementId) {
  ...
  public boolean equals(Object o) {
    ...
    StopGameSessionPlacementInput stopGameSessionPlacementInput = (StopGameSessionPlacementInput) o;
    return Objects.equals(this.placementId, stopGameSessionPlacementInput.placementId);
  }
  ...
  public String toString() {
    ...
    sb.append("class StopGameSessionPlacementInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StopGameSessionPlacementInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StopGameSessionPlacementInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StopGameSessionPlacementInput is not found in the empty JSON string", StopGameSessionPlacementInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StopGameSessionPlacementInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StopGameSessionPlacementInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StopGameSessionPlacementInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StopGameSessionPlacementInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StopGameSessionPlacementInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StopGameSessionPlacementInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StopGameSessionPlacementInput.class));

       return (TypeAdapter<T>) new TypeAdapter<StopGameSessionPlacementInput>() {
           @Override
           public void write(JsonWriter out, StopGameSessionPlacementInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StopGameSessionPlacementInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StopGameSessionPlacementInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StopGameSessionPlacementInput
   * @throws IOException if the JSON string is invalid with respect to StopGameSessionPlacementInput
   */
  public static StopGameSessionPlacementInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StopGameSessionPlacementInput.class);
  }

  /**
   * Convert an instance of StopGameSessionPlacementInput to an JSON string
   *
   * @return JSON string
   */
