...
public class StartMatchBackfillInput {
  ...
  public StartMatchBackfillInput() {
  }

  public StartMatchBackfillInput ticketId(String ticketId) {
  ...
  public StartMatchBackfillInput configurationName(String configurationName) {
  ...
  public StartMatchBackfillInput gameSessionArn(String gameSessionArn) {
  ...
  public StartMatchBackfillInput players(List players) {
  ...
  public boolean equals(Object o) {
    ...
    StartMatchBackfillInput startMatchBackfillInput = (StartMatchBackfillInput) o;
    return Objects.equals(this.ticketId, startMatchBackfillInput.ticketId) &&
        Objects.equals(this.configurationName, startMatchBackfillInput.configurationName) &&
        Objects.equals(this.gameSessionArn, startMatchBackfillInput.gameSessionArn) &&
        Objects.equals(this.players, startMatchBackfillInput.players);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ticketId, configurationName, gameSessionArn, players);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StartMatchBackfillInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartMatchBackfillInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartMatchBackfillInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartMatchBackfillInput is not found in the empty JSON string", StartMatchBackfillInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartMatchBackfillInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartMatchBackfillInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartMatchBackfillInput.openapiRequiredFields) {
      ...
      // validate the required field `ConfigurationName`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartMatchBackfillInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartMatchBackfillInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartMatchBackfillInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartMatchBackfillInput.class));

       return (TypeAdapter<T>) new TypeAdapter<StartMatchBackfillInput>() {
           @Override
           public void write(JsonWriter out, StartMatchBackfillInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartMatchBackfillInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartMatchBackfillInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartMatchBackfillInput
   * @throws IOException if the JSON string is invalid with respect to StartMatchBackfillInput
   */
  public static StartMatchBackfillInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartMatchBackfillInput.class);
  }

  /**
   * Convert an instance of StartMatchBackfillInput to an JSON string
   *
   * @return JSON string
   */
