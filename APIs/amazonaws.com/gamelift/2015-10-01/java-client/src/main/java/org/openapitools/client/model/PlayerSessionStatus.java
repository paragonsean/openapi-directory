...
/**
 * Gets or Sets PlayerSessionStatus
 */
@JsonAdapter(PlayerSessionStatus.Adapter.class)
public enum PlayerSessionStatus {
  ...
  public static PlayerSessionStatus fromValue(String value) {
    for (PlayerSessionStatus b : PlayerSessionStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<PlayerSessionStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final PlayerSessionStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PlayerSessionStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PlayerSessionStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PlayerSessionStatus.fromValue(value);
  }
}
