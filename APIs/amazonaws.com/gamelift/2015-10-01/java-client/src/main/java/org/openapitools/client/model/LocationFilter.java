...
/**
 * Gets or Sets LocationFilter
 */
@JsonAdapter(LocationFilter.Adapter.class)
public enum LocationFilter {
  ...
  public static LocationFilter fromValue(String value) {
    for (LocationFilter b : LocationFilter.values()) {
  ...
  public static class Adapter extends TypeAdapter<LocationFilter> {
    @Override
    public void write(final JsonWriter jsonWriter, final LocationFilter enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public LocationFilter read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return LocationFilter.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    LocationFilter.fromValue(value);
  }
}
