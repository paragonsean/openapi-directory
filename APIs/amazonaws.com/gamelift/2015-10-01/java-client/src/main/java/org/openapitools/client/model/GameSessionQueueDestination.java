...
public class GameSessionQueueDestination {
  ...
  public GameSessionQueueDestination destinationArn(String destinationArn) {
  ...
  public boolean equals(Object o) {
    ...
    GameSessionQueueDestination gameSessionQueueDestination = (GameSessionQueueDestination) o;
    return Objects.equals(this.destinationArn, gameSessionQueueDestination.destinationArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class GameSessionQueueDestination {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GameSessionQueueDestination
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GameSessionQueueDestination.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GameSessionQueueDestination is not found in the empty JSON string", GameSessionQueueDestination.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GameSessionQueueDestination.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GameSessionQueueDestination` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GameSessionQueueDestination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GameSessionQueueDestination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GameSessionQueueDestination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GameSessionQueueDestination.class));

       return (TypeAdapter<T>) new TypeAdapter<GameSessionQueueDestination>() {
           @Override
           public void write(JsonWriter out, GameSessionQueueDestination value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GameSessionQueueDestination read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GameSessionQueueDestination given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GameSessionQueueDestination
   * @throws IOException if the JSON string is invalid with respect to GameSessionQueueDestination
   */
  public static GameSessionQueueDestination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GameSessionQueueDestination.class);
  }

  /**
   * Convert an instance of GameSessionQueueDestination to an JSON string
   *
   * @return JSON string
   */
