...
public class GetComputeAccessOutputCredentials {
  ...
  public GetComputeAccessOutputCredentials() {
  }

  public GetComputeAccessOutputCredentials accessKeyId(String accessKeyId) {
  ...
  public GetComputeAccessOutputCredentials secretAccessKey(String secretAccessKey) {
  ...
  public GetComputeAccessOutputCredentials sessionToken(String sessionToken) {
  ...
  public boolean equals(Object o) {
    ...
    GetComputeAccessOutputCredentials getComputeAccessOutputCredentials = (GetComputeAccessOutputCredentials) o;
    return Objects.equals(this.accessKeyId, getComputeAccessOutputCredentials.accessKeyId) &&
        Objects.equals(this.secretAccessKey, getComputeAccessOutputCredentials.secretAccessKey) &&
        Objects.equals(this.sessionToken, getComputeAccessOutputCredentials.sessionToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetComputeAccessOutputCredentials {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetComputeAccessOutputCredentials
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetComputeAccessOutputCredentials.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetComputeAccessOutputCredentials is not found in the empty JSON string", GetComputeAccessOutputCredentials.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetComputeAccessOutputCredentials.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetComputeAccessOutputCredentials` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetComputeAccessOutputCredentials.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetComputeAccessOutputCredentials' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetComputeAccessOutputCredentials> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetComputeAccessOutputCredentials.class));

       return (TypeAdapter<T>) new TypeAdapter<GetComputeAccessOutputCredentials>() {
           @Override
           public void write(JsonWriter out, GetComputeAccessOutputCredentials value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetComputeAccessOutputCredentials read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetComputeAccessOutputCredentials given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetComputeAccessOutputCredentials
   * @throws IOException if the JSON string is invalid with respect to GetComputeAccessOutputCredentials
   */
  public static GetComputeAccessOutputCredentials fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetComputeAccessOutputCredentials.class);
  }

  /**
   * Convert an instance of GetComputeAccessOutputCredentials to an JSON string
   *
   * @return JSON string
   */
