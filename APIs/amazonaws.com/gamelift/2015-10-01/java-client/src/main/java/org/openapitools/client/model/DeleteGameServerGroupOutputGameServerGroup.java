...
public class DeleteGameServerGroupOutputGameServerGroup {
  ...
  public DeleteGameServerGroupOutputGameServerGroup() {
  }

  public DeleteGameServerGroupOutputGameServerGroup gameServerGroupName(String gameServerGroupName) {
  ...
  public DeleteGameServerGroupOutputGameServerGroup gameServerGroupArn(String gameServerGroupArn) {
  ...
  public DeleteGameServerGroupOutputGameServerGroup roleArn(String roleArn) {
  ...
  public DeleteGameServerGroupOutputGameServerGroup instanceDefinitions(List instanceDefinitions) {
  ...
  public DeleteGameServerGroupOutputGameServerGroup balancingStrategy(BalancingStrategy balancingStrategy) {
  ...
  public DeleteGameServerGroupOutputGameServerGroup gameServerProtectionPolicy(GameServerProtectionPolicy gameServerProtectionPolicy) {
  ...
  public DeleteGameServerGroupOutputGameServerGroup autoScalingGroupArn(String autoScalingGroupArn) {
  ...
  public DeleteGameServerGroupOutputGameServerGroup status(GameServerGroupStatus status) {
    this.status = status;
    return this;
  }
  ...
  public DeleteGameServerGroupOutputGameServerGroup statusReason(String statusReason) {
  ...
  public DeleteGameServerGroupOutputGameServerGroup suspendedActions(List suspendedActions) {
  ...
  public DeleteGameServerGroupOutputGameServerGroup creationTime(OffsetDateTime creationTime) {
  ...
  public DeleteGameServerGroupOutputGameServerGroup lastUpdatedTime(OffsetDateTime lastUpdatedTime) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteGameServerGroupOutputGameServerGroup deleteGameServerGroupOutputGameServerGroup = (DeleteGameServerGroupOutputGameServerGroup) o;
    return Objects.equals(this.gameServerGroupName, deleteGameServerGroupOutputGameServerGroup.gameServerGroupName) &&
        Objects.equals(this.gameServerGroupArn, deleteGameServerGroupOutputGameServerGroup.gameServerGroupArn) &&
        Objects.equals(this.roleArn, deleteGameServerGroupOutputGameServerGroup.roleArn) &&
        Objects.equals(this.instanceDefinitions, deleteGameServerGroupOutputGameServerGroup.instanceDefinitions) &&
        Objects.equals(this.balancingStrategy, deleteGameServerGroupOutputGameServerGroup.balancingStrategy) &&
        Objects.equals(this.gameServerProtectionPolicy, deleteGameServerGroupOutputGameServerGroup.gameServerProtectionPolicy) &&
        Objects.equals(this.autoScalingGroupArn, deleteGameServerGroupOutputGameServerGroup.autoScalingGroupArn) &&
        Objects.equals(this.status, deleteGameServerGroupOutputGameServerGroup.status) &&
        Objects.equals(this.statusReason, deleteGameServerGroupOutputGameServerGroup.statusReason) &&
        Objects.equals(this.suspendedActions, deleteGameServerGroupOutputGameServerGroup.suspendedActions) &&
        Objects.equals(this.creationTime, deleteGameServerGroupOutputGameServerGroup.creationTime) &&
        Objects.equals(this.lastUpdatedTime, deleteGameServerGroupOutputGameServerGroup.lastUpdatedTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteGameServerGroupOutputGameServerGroup {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteGameServerGroupOutputGameServerGroup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteGameServerGroupOutputGameServerGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteGameServerGroupOutputGameServerGroup is not found in the empty JSON string", DeleteGameServerGroupOutputGameServerGroup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteGameServerGroupOutputGameServerGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteGameServerGroupOutputGameServerGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteGameServerGroupOutputGameServerGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteGameServerGroupOutputGameServerGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteGameServerGroupOutputGameServerGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteGameServerGroupOutputGameServerGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteGameServerGroupOutputGameServerGroup>() {
           @Override
           public void write(JsonWriter out, DeleteGameServerGroupOutputGameServerGroup value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteGameServerGroupOutputGameServerGroup read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteGameServerGroupOutputGameServerGroup given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteGameServerGroupOutputGameServerGroup
   * @throws IOException if the JSON string is invalid with respect to DeleteGameServerGroupOutputGameServerGroup
   */
  public static DeleteGameServerGroupOutputGameServerGroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteGameServerGroupOutputGameServerGroup.class);
  }

  /**
   * Convert an instance of DeleteGameServerGroupOutputGameServerGroup to an JSON string
   *
   * @return JSON string
   */
