...
public class UpdateScriptInput {
  ...
  public UpdateScriptInput() {
  }

  public UpdateScriptInput scriptId(String scriptId) {
  ...
  public UpdateScriptInput name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateScriptInput version(String version) {
  ...
  public UpdateScriptInput storageLocation(CreateScriptInputStorageLocation storageLocation) {
  ...
  public UpdateScriptInput zipFile(String zipFile) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateScriptInput updateScriptInput = (UpdateScriptInput) o;
    return Objects.equals(this.scriptId, updateScriptInput.scriptId) &&
        Objects.equals(this.name, updateScriptInput.name) &&
        Objects.equals(this.version, updateScriptInput.version) &&
        Objects.equals(this.storageLocation, updateScriptInput.storageLocation) &&
        Objects.equals(this.zipFile, updateScriptInput.zipFile);
  }

  @Override
  public int hashCode() {
    return Objects.hash(scriptId, name, version, storageLocation, zipFile);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateScriptInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateScriptInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateScriptInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateScriptInput is not found in the empty JSON string", UpdateScriptInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateScriptInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateScriptInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateScriptInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateScriptInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateScriptInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateScriptInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateScriptInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateScriptInput>() {
           @Override
           public void write(JsonWriter out, UpdateScriptInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateScriptInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateScriptInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateScriptInput
   * @throws IOException if the JSON string is invalid with respect to UpdateScriptInput
   */
  public static UpdateScriptInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateScriptInput.class);
  }

  /**
   * Convert an instance of UpdateScriptInput to an JSON string
   *
   * @return JSON string
   */
