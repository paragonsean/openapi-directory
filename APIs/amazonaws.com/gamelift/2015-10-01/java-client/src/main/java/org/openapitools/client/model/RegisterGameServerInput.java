...
public class RegisterGameServerInput {
  ...
  public RegisterGameServerInput() {
  }

  public RegisterGameServerInput gameServerGroupName(String gameServerGroupName) {
  ...
  public RegisterGameServerInput gameServerId(String gameServerId) {
  ...
  public RegisterGameServerInput instanceId(String instanceId) {
  ...
  public RegisterGameServerInput connectionInfo(String connectionInfo) {
  ...
  public RegisterGameServerInput gameServerData(String gameServerData) {
  ...
  public boolean equals(Object o) {
    ...
    RegisterGameServerInput registerGameServerInput = (RegisterGameServerInput) o;
    return Objects.equals(this.gameServerGroupName, registerGameServerInput.gameServerGroupName) &&
        Objects.equals(this.gameServerId, registerGameServerInput.gameServerId) &&
        Objects.equals(this.instanceId, registerGameServerInput.instanceId) &&
        Objects.equals(this.connectionInfo, registerGameServerInput.connectionInfo) &&
        Objects.equals(this.gameServerData, registerGameServerInput.gameServerData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gameServerGroupName, gameServerId, instanceId, connectionInfo, gameServerData);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RegisterGameServerInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RegisterGameServerInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RegisterGameServerInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RegisterGameServerInput is not found in the empty JSON string", RegisterGameServerInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RegisterGameServerInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RegisterGameServerInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RegisterGameServerInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RegisterGameServerInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RegisterGameServerInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RegisterGameServerInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RegisterGameServerInput.class));

       return (TypeAdapter<T>) new TypeAdapter<RegisterGameServerInput>() {
           @Override
           public void write(JsonWriter out, RegisterGameServerInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RegisterGameServerInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RegisterGameServerInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RegisterGameServerInput
   * @throws IOException if the JSON string is invalid with respect to RegisterGameServerInput
   */
  public static RegisterGameServerInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RegisterGameServerInput.class);
  }

  /**
   * Convert an instance of RegisterGameServerInput to an JSON string
   *
   * @return JSON string
   */
