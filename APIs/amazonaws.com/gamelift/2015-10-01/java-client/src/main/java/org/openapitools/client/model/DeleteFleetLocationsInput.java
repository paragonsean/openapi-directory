...
public class DeleteFleetLocationsInput {
  ...
  public DeleteFleetLocationsInput() {
  }

  public DeleteFleetLocationsInput fleetId(String fleetId) {
  ...
  public DeleteFleetLocationsInput locations(List locations) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteFleetLocationsInput deleteFleetLocationsInput = (DeleteFleetLocationsInput) o;
    return Objects.equals(this.fleetId, deleteFleetLocationsInput.fleetId) &&
        Objects.equals(this.locations, deleteFleetLocationsInput.locations);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteFleetLocationsInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteFleetLocationsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteFleetLocationsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteFleetLocationsInput is not found in the empty JSON string", DeleteFleetLocationsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteFleetLocationsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteFleetLocationsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteFleetLocationsInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteFleetLocationsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteFleetLocationsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteFleetLocationsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteFleetLocationsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteFleetLocationsInput>() {
           @Override
           public void write(JsonWriter out, DeleteFleetLocationsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteFleetLocationsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteFleetLocationsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteFleetLocationsInput
   * @throws IOException if the JSON string is invalid with respect to DeleteFleetLocationsInput
   */
  public static DeleteFleetLocationsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteFleetLocationsInput.class);
  }

  /**
   * Convert an instance of DeleteFleetLocationsInput to an JSON string
   *
   * @return JSON string
   */
