...
public class StartFleetActionsInput {
  ...
  public StartFleetActionsInput() {
  }

  public StartFleetActionsInput fleetId(String fleetId) {
  ...
  public StartFleetActionsInput actions(List actions) {
  ...
  public StartFleetActionsInput location(String location) {
  ...
  public boolean equals(Object o) {
    ...
    StartFleetActionsInput startFleetActionsInput = (StartFleetActionsInput) o;
    return Objects.equals(this.fleetId, startFleetActionsInput.fleetId) &&
        Objects.equals(this.actions, startFleetActionsInput.actions) &&
        Objects.equals(this.location, startFleetActionsInput.location);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fleetId, actions, location);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StartFleetActionsInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartFleetActionsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartFleetActionsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartFleetActionsInput is not found in the empty JSON string", StartFleetActionsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartFleetActionsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartFleetActionsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartFleetActionsInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartFleetActionsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartFleetActionsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartFleetActionsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartFleetActionsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<StartFleetActionsInput>() {
           @Override
           public void write(JsonWriter out, StartFleetActionsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartFleetActionsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartFleetActionsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartFleetActionsInput
   * @throws IOException if the JSON string is invalid with respect to StartFleetActionsInput
   */
  public static StartFleetActionsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartFleetActionsInput.class);
  }

  /**
   * Convert an instance of StartFleetActionsInput to an JSON string
   *
   * @return JSON string
   */
