...
public class StopFleetActionsInput {
  ...
  public StopFleetActionsInput() {
  }

  public StopFleetActionsInput fleetId(String fleetId) {
  ...
  public StopFleetActionsInput actions(List actions) {
  ...
  public StopFleetActionsInput location(String location) {
  ...
  public boolean equals(Object o) {
    ...
    StopFleetActionsInput stopFleetActionsInput = (StopFleetActionsInput) o;
    return Objects.equals(this.fleetId, stopFleetActionsInput.fleetId) &&
        Objects.equals(this.actions, stopFleetActionsInput.actions) &&
        Objects.equals(this.location, stopFleetActionsInput.location);
  }
  ...
  public String toString() {
    ...
    sb.append("class StopFleetActionsInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StopFleetActionsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StopFleetActionsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StopFleetActionsInput is not found in the empty JSON string", StopFleetActionsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StopFleetActionsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StopFleetActionsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StopFleetActionsInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StopFleetActionsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StopFleetActionsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StopFleetActionsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StopFleetActionsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<StopFleetActionsInput>() {
           @Override
           public void write(JsonWriter out, StopFleetActionsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StopFleetActionsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StopFleetActionsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StopFleetActionsInput
   * @throws IOException if the JSON string is invalid with respect to StopFleetActionsInput
   */
  public static StopFleetActionsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StopFleetActionsInput.class);
  }

  /**
   * Convert an instance of StopFleetActionsInput to an JSON string
   *
   * @return JSON string
   */
