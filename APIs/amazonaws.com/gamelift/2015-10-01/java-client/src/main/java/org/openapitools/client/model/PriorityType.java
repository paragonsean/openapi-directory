 ...
 */
@JsonAdapter(PriorityType.Adapter.class)
public enum PriorityType {
  ...
  public static class Adapter extends TypeAdapter<PriorityType> {
    @Override
    public void write(final JsonWriter jsonWriter, final PriorityType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PriorityType read(final JsonReader jsonReader) throws IOException {
