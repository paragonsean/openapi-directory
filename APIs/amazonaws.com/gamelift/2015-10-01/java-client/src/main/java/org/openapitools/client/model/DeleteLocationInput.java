...
public class DeleteLocationInput {
  ...
  public DeleteLocationInput() {
  }

  public DeleteLocationInput locationName(String locationName) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteLocationInput deleteLocationInput = (DeleteLocationInput) o;
    return Objects.equals(this.locationName, deleteLocationInput.locationName);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteLocationInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteLocationInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteLocationInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteLocationInput is not found in the empty JSON string", DeleteLocationInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteLocationInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteLocationInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteLocationInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteLocationInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteLocationInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteLocationInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteLocationInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteLocationInput>() {
           @Override
           public void write(JsonWriter out, DeleteLocationInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteLocationInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteLocationInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteLocationInput
   * @throws IOException if the JSON string is invalid with respect to DeleteLocationInput
   */
  public static DeleteLocationInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteLocationInput.class);
  }

  /**
   * Convert an instance of DeleteLocationInput to an JSON string
   *
   * @return JSON string
   */
