...
public class CreateGameServerGroupOutputGameServerGroup {
  ...
  public CreateGameServerGroupOutputGameServerGroup() {
  }

  public CreateGameServerGroupOutputGameServerGroup gameServerGroupName(String gameServerGroupName) {
  ...
  public CreateGameServerGroupOutputGameServerGroup gameServerGroupArn(String gameServerGroupArn) {
  ...
  public CreateGameServerGroupOutputGameServerGroup roleArn(String roleArn) {
  ...
  public CreateGameServerGroupOutputGameServerGroup instanceDefinitions(List instanceDefinitions) {
  ...
  public CreateGameServerGroupOutputGameServerGroup balancingStrategy(BalancingStrategy balancingStrategy) {
  ...
  public CreateGameServerGroupOutputGameServerGroup gameServerProtectionPolicy(GameServerProtectionPolicy gameServerProtectionPolicy) {
  ...
  public CreateGameServerGroupOutputGameServerGroup autoScalingGroupArn(String autoScalingGroupArn) {
  ...
  public CreateGameServerGroupOutputGameServerGroup status(GameServerGroupStatus status) {
    this.status = status;
    return this;
  }
  ...
  public CreateGameServerGroupOutputGameServerGroup statusReason(String statusReason) {
  ...
  public CreateGameServerGroupOutputGameServerGroup suspendedActions(List suspendedActions) {
  ...
  public CreateGameServerGroupOutputGameServerGroup creationTime(OffsetDateTime creationTime) {
  ...
  public CreateGameServerGroupOutputGameServerGroup lastUpdatedTime(OffsetDateTime lastUpdatedTime) {
  ...
  public boolean equals(Object o) {
    ...
    CreateGameServerGroupOutputGameServerGroup createGameServerGroupOutputGameServerGroup = (CreateGameServerGroupOutputGameServerGroup) o;
    return Objects.equals(this.gameServerGroupName, createGameServerGroupOutputGameServerGroup.gameServerGroupName) &&
        Objects.equals(this.gameServerGroupArn, createGameServerGroupOutputGameServerGroup.gameServerGroupArn) &&
        Objects.equals(this.roleArn, createGameServerGroupOutputGameServerGroup.roleArn) &&
        Objects.equals(this.instanceDefinitions, createGameServerGroupOutputGameServerGroup.instanceDefinitions) &&
        Objects.equals(this.balancingStrategy, createGameServerGroupOutputGameServerGroup.balancingStrategy) &&
        Objects.equals(this.gameServerProtectionPolicy, createGameServerGroupOutputGameServerGroup.gameServerProtectionPolicy) &&
        Objects.equals(this.autoScalingGroupArn, createGameServerGroupOutputGameServerGroup.autoScalingGroupArn) &&
        Objects.equals(this.status, createGameServerGroupOutputGameServerGroup.status) &&
        Objects.equals(this.statusReason, createGameServerGroupOutputGameServerGroup.statusReason) &&
        Objects.equals(this.suspendedActions, createGameServerGroupOutputGameServerGroup.suspendedActions) &&
        Objects.equals(this.creationTime, createGameServerGroupOutputGameServerGroup.creationTime) &&
        Objects.equals(this.lastUpdatedTime, createGameServerGroupOutputGameServerGroup.lastUpdatedTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateGameServerGroupOutputGameServerGroup {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateGameServerGroupOutputGameServerGroup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateGameServerGroupOutputGameServerGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateGameServerGroupOutputGameServerGroup is not found in the empty JSON string", CreateGameServerGroupOutputGameServerGroup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateGameServerGroupOutputGameServerGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateGameServerGroupOutputGameServerGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateGameServerGroupOutputGameServerGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateGameServerGroupOutputGameServerGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateGameServerGroupOutputGameServerGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateGameServerGroupOutputGameServerGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateGameServerGroupOutputGameServerGroup>() {
           @Override
           public void write(JsonWriter out, CreateGameServerGroupOutputGameServerGroup value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateGameServerGroupOutputGameServerGroup read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateGameServerGroupOutputGameServerGroup given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateGameServerGroupOutputGameServerGroup
   * @throws IOException if the JSON string is invalid with respect to CreateGameServerGroupOutputGameServerGroup
   */
  public static CreateGameServerGroupOutputGameServerGroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateGameServerGroupOutputGameServerGroup.class);
  }

  /**
   * Convert an instance of CreateGameServerGroupOutputGameServerGroup to an JSON string
   *
   * @return JSON string
   */
