...
public class CreateMatchmakingConfigurationOutputConfiguration {
  ...
  public CreateMatchmakingConfigurationOutputConfiguration() {
  }

  public CreateMatchmakingConfigurationOutputConfiguration name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateMatchmakingConfigurationOutputConfiguration configurationArn(String configurationArn) {
  ...
  public CreateMatchmakingConfigurationOutputConfiguration description(String description) {
  ...
  public CreateMatchmakingConfigurationOutputConfiguration gameSessionQueueArns(List gameSessionQueueArns) {
  ...
  public CreateMatchmakingConfigurationOutputConfiguration requestTimeoutSeconds(Integer requestTimeoutSeconds) {
  ...
  public CreateMatchmakingConfigurationOutputConfiguration acceptanceTimeoutSeconds(Integer acceptanceTimeoutSeconds) {
  ...
  public CreateMatchmakingConfigurationOutputConfiguration acceptanceRequired(Boolean acceptanceRequired) {
  ...
  public CreateMatchmakingConfigurationOutputConfiguration ruleSetName(String ruleSetName) {
  ...
  public CreateMatchmakingConfigurationOutputConfiguration ruleSetArn(String ruleSetArn) {
  ...
  public CreateMatchmakingConfigurationOutputConfiguration notificationTarget(String notificationTarget) {
  ...
  public CreateMatchmakingConfigurationOutputConfiguration additionalPlayerCount(Integer additionalPlayerCount) {
  ...
  public CreateMatchmakingConfigurationOutputConfiguration customEventData(String customEventData) {
  ...
  public CreateMatchmakingConfigurationOutputConfiguration creationTime(OffsetDateTime creationTime) {
  ...
  public CreateMatchmakingConfigurationOutputConfiguration gameProperties(List gameProperties) {
  ...
  public CreateMatchmakingConfigurationOutputConfiguration gameSessionData(String gameSessionData) {
  ...
  public CreateMatchmakingConfigurationOutputConfiguration backfillMode(BackfillMode backfillMode) {
  ...
  public CreateMatchmakingConfigurationOutputConfiguration flexMatchMode(FlexMatchMode flexMatchMode) {
  ...
  public boolean equals(Object o) {
    ...
    CreateMatchmakingConfigurationOutputConfiguration createMatchmakingConfigurationOutputConfiguration = (CreateMatchmakingConfigurationOutputConfiguration) o;
    return Objects.equals(this.name, createMatchmakingConfigurationOutputConfiguration.name) &&
        Objects.equals(this.configurationArn, createMatchmakingConfigurationOutputConfiguration.configurationArn) &&
        Objects.equals(this.description, createMatchmakingConfigurationOutputConfiguration.description) &&
        Objects.equals(this.gameSessionQueueArns, createMatchmakingConfigurationOutputConfiguration.gameSessionQueueArns) &&
        Objects.equals(this.requestTimeoutSeconds, createMatchmakingConfigurationOutputConfiguration.requestTimeoutSeconds) &&
        Objects.equals(this.acceptanceTimeoutSeconds, createMatchmakingConfigurationOutputConfiguration.acceptanceTimeoutSeconds) &&
        Objects.equals(this.acceptanceRequired, createMatchmakingConfigurationOutputConfiguration.acceptanceRequired) &&
        Objects.equals(this.ruleSetName, createMatchmakingConfigurationOutputConfiguration.ruleSetName) &&
        Objects.equals(this.ruleSetArn, createMatchmakingConfigurationOutputConfiguration.ruleSetArn) &&
        Objects.equals(this.notificationTarget, createMatchmakingConfigurationOutputConfiguration.notificationTarget) &&
        Objects.equals(this.additionalPlayerCount, createMatchmakingConfigurationOutputConfiguration.additionalPlayerCount) &&
        Objects.equals(this.customEventData, createMatchmakingConfigurationOutputConfiguration.customEventData) &&
        Objects.equals(this.creationTime, createMatchmakingConfigurationOutputConfiguration.creationTime) &&
        Objects.equals(this.gameProperties, createMatchmakingConfigurationOutputConfiguration.gameProperties) &&
        Objects.equals(this.gameSessionData, createMatchmakingConfigurationOutputConfiguration.gameSessionData) &&
        Objects.equals(this.backfillMode, createMatchmakingConfigurationOutputConfiguration.backfillMode) &&
        Objects.equals(this.flexMatchMode, createMatchmakingConfigurationOutputConfiguration.flexMatchMode);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateMatchmakingConfigurationOutputConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateMatchmakingConfigurationOutputConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateMatchmakingConfigurationOutputConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateMatchmakingConfigurationOutputConfiguration is not found in the empty JSON string", CreateMatchmakingConfigurationOutputConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateMatchmakingConfigurationOutputConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateMatchmakingConfigurationOutputConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateMatchmakingConfigurationOutputConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateMatchmakingConfigurationOutputConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateMatchmakingConfigurationOutputConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateMatchmakingConfigurationOutputConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateMatchmakingConfigurationOutputConfiguration>() {
           @Override
           public void write(JsonWriter out, CreateMatchmakingConfigurationOutputConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateMatchmakingConfigurationOutputConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateMatchmakingConfigurationOutputConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateMatchmakingConfigurationOutputConfiguration
   * @throws IOException if the JSON string is invalid with respect to CreateMatchmakingConfigurationOutputConfiguration
   */
  public static CreateMatchmakingConfigurationOutputConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateMatchmakingConfigurationOutputConfiguration.class);
  }

  /**
   * Convert an instance of CreateMatchmakingConfigurationOutputConfiguration to an JSON string
   *
   * @return JSON string
   */
