...
public class ListFleetsInput {
  ...
  public ListFleetsInput buildId(String buildId) {
  ...
  public ListFleetsInput scriptId(String scriptId) {
  ...
  public ListFleetsInput limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public ListFleetsInput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListFleetsInput listFleetsInput = (ListFleetsInput) o;
    return Objects.equals(this.buildId, listFleetsInput.buildId) &&
        Objects.equals(this.scriptId, listFleetsInput.scriptId) &&
        Objects.equals(this.limit, listFleetsInput.limit) &&
        Objects.equals(this.nextToken, listFleetsInput.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(buildId, scriptId, limit, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListFleetsInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListFleetsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListFleetsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListFleetsInput is not found in the empty JSON string", ListFleetsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListFleetsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListFleetsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListFleetsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListFleetsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListFleetsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListFleetsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListFleetsInput>() {
           @Override
           public void write(JsonWriter out, ListFleetsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListFleetsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListFleetsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListFleetsInput
   * @throws IOException if the JSON string is invalid with respect to ListFleetsInput
   */
  public static ListFleetsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListFleetsInput.class);
  }

  /**
   * Convert an instance of ListFleetsInput to an JSON string
   *
   * @return JSON string
   */
