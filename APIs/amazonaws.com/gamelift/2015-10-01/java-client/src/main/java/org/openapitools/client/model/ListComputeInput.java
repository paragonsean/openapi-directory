...
public class ListComputeInput {
  ...
  public ListComputeInput() {
  }

  public ListComputeInput fleetId(String fleetId) {
  ...
  public ListComputeInput location(String location) {
  ...
  public ListComputeInput limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public ListComputeInput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListComputeInput listComputeInput = (ListComputeInput) o;
    return Objects.equals(this.fleetId, listComputeInput.fleetId) &&
        Objects.equals(this.location, listComputeInput.location) &&
        Objects.equals(this.limit, listComputeInput.limit) &&
        Objects.equals(this.nextToken, listComputeInput.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fleetId, location, limit, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListComputeInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListComputeInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListComputeInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListComputeInput is not found in the empty JSON string", ListComputeInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListComputeInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListComputeInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListComputeInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListComputeInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListComputeInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListComputeInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListComputeInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListComputeInput>() {
           @Override
           public void write(JsonWriter out, ListComputeInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListComputeInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListComputeInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListComputeInput
   * @throws IOException if the JSON string is invalid with respect to ListComputeInput
   */
  public static ListComputeInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListComputeInput.class);
  }

  /**
   * Convert an instance of ListComputeInput to an JSON string
   *
   * @return JSON string
   */
