...
/**
 * Gets or Sets BalancingStrategy
 */
@JsonAdapter(BalancingStrategy.Adapter.class)
public enum BalancingStrategy {
  ...
  BalancingStrategy(String value) {
    this.value = value;
  }
  ...
  public static BalancingStrategy fromValue(String value) {
    for (BalancingStrategy b : BalancingStrategy.values()) {
  ...
  public static class Adapter extends TypeAdapter<BalancingStrategy> {
    @Override
    public void write(final JsonWriter jsonWriter, final BalancingStrategy enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public BalancingStrategy read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return BalancingStrategy.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    BalancingStrategy.fromValue(value);
  }
}
