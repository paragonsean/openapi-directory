...
public class GameSessionPlacement {
  ...
  public GameSessionPlacement placementId(String placementId) {
  ...
  public GameSessionPlacement gameSessionQueueName(String gameSessionQueueName) {
  ...
  public GameSessionPlacement status(GameSessionPlacementState status) {
    this.status = status;
    return this;
  }
  ...
  public GameSessionPlacement gameProperties(List gameProperties) {
  ...
  public GameSessionPlacement maximumPlayerSessionCount(Integer maximumPlayerSessionCount) {
  ...
  public GameSessionPlacement gameSessionName(String gameSessionName) {
  ...
  public GameSessionPlacement gameSessionId(String gameSessionId) {
  ...
  public GameSessionPlacement gameSessionArn(String gameSessionArn) {
  ...
  public GameSessionPlacement gameSessionRegion(String gameSessionRegion) {
  ...
  public GameSessionPlacement playerLatencies(List playerLatencies) {
  ...
  public GameSessionPlacement startTime(OffsetDateTime startTime) {
  ...
  public GameSessionPlacement endTime(OffsetDateTime endTime) {
  ...
  public GameSessionPlacement ipAddress(String ipAddress) {
  ...
  public GameSessionPlacement dnsName(String dnsName) {
  ...
  public GameSessionPlacement port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public GameSessionPlacement placedPlayerSessions(List placedPlayerSessions) {
  ...
  public GameSessionPlacement gameSessionData(String gameSessionData) {
  ...
  public GameSessionPlacement matchmakerData(String matchmakerData) {
  ...
  public boolean equals(Object o) {
    ...
    GameSessionPlacement gameSessionPlacement = (GameSessionPlacement) o;
    return Objects.equals(this.placementId, gameSessionPlacement.placementId) &&
        Objects.equals(this.gameSessionQueueName, gameSessionPlacement.gameSessionQueueName) &&
        Objects.equals(this.status, gameSessionPlacement.status) &&
        Objects.equals(this.gameProperties, gameSessionPlacement.gameProperties) &&
        Objects.equals(this.maximumPlayerSessionCount, gameSessionPlacement.maximumPlayerSessionCount) &&
        Objects.equals(this.gameSessionName, gameSessionPlacement.gameSessionName) &&
        Objects.equals(this.gameSessionId, gameSessionPlacement.gameSessionId) &&
        Objects.equals(this.gameSessionArn, gameSessionPlacement.gameSessionArn) &&
        Objects.equals(this.gameSessionRegion, gameSessionPlacement.gameSessionRegion) &&
        Objects.equals(this.playerLatencies, gameSessionPlacement.playerLatencies) &&
        Objects.equals(this.startTime, gameSessionPlacement.startTime) &&
        Objects.equals(this.endTime, gameSessionPlacement.endTime) &&
        Objects.equals(this.ipAddress, gameSessionPlacement.ipAddress) &&
        Objects.equals(this.dnsName, gameSessionPlacement.dnsName) &&
        Objects.equals(this.port, gameSessionPlacement.port) &&
        Objects.equals(this.placedPlayerSessions, gameSessionPlacement.placedPlayerSessions) &&
        Objects.equals(this.gameSessionData, gameSessionPlacement.gameSessionData) &&
        Objects.equals(this.matchmakerData, gameSessionPlacement.matchmakerData);
  }
  ...
  public String toString() {
    ...
    sb.append("class GameSessionPlacement {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GameSessionPlacement
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GameSessionPlacement.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GameSessionPlacement is not found in the empty JSON string", GameSessionPlacement.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GameSessionPlacement.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GameSessionPlacement` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GameSessionPlacement.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GameSessionPlacement' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GameSessionPlacement> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GameSessionPlacement.class));

       return (TypeAdapter<T>) new TypeAdapter<GameSessionPlacement>() {
           @Override
           public void write(JsonWriter out, GameSessionPlacement value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GameSessionPlacement read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GameSessionPlacement given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GameSessionPlacement
   * @throws IOException if the JSON string is invalid with respect to GameSessionPlacement
   */
  public static GameSessionPlacement fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GameSessionPlacement.class);
  }

  /**
   * Convert an instance of GameSessionPlacement to an JSON string
   *
   * @return JSON string
   */
