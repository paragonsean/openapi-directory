...
public class DescribeBuildInput {
  ...
  public DescribeBuildInput() {
  }

  public DescribeBuildInput buildId(String buildId) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeBuildInput describeBuildInput = (DescribeBuildInput) o;
    return Objects.equals(this.buildId, describeBuildInput.buildId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeBuildInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeBuildInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeBuildInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeBuildInput is not found in the empty JSON string", DescribeBuildInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeBuildInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeBuildInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeBuildInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeBuildInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeBuildInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeBuildInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeBuildInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeBuildInput>() {
           @Override
           public void write(JsonWriter out, DescribeBuildInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeBuildInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeBuildInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeBuildInput
   * @throws IOException if the JSON string is invalid with respect to DescribeBuildInput
   */
  public static DescribeBuildInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeBuildInput.class);
  }

  /**
   * Convert an instance of DescribeBuildInput to an JSON string
   *
   * @return JSON string
   */
