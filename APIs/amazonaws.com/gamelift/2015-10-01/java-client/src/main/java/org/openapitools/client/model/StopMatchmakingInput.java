...
public class StopMatchmakingInput {
  ...
  public StopMatchmakingInput() {
  }

  public StopMatchmakingInput ticketId(String ticketId) {
  ...
  public boolean equals(Object o) {
    ...
    StopMatchmakingInput stopMatchmakingInput = (StopMatchmakingInput) o;
    return Objects.equals(this.ticketId, stopMatchmakingInput.ticketId);
  }
  ...
  public String toString() {
    ...
    sb.append("class StopMatchmakingInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StopMatchmakingInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StopMatchmakingInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StopMatchmakingInput is not found in the empty JSON string", StopMatchmakingInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StopMatchmakingInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StopMatchmakingInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StopMatchmakingInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StopMatchmakingInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StopMatchmakingInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StopMatchmakingInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StopMatchmakingInput.class));

       return (TypeAdapter<T>) new TypeAdapter<StopMatchmakingInput>() {
           @Override
           public void write(JsonWriter out, StopMatchmakingInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StopMatchmakingInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StopMatchmakingInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StopMatchmakingInput
   * @throws IOException if the JSON string is invalid with respect to StopMatchmakingInput
   */
  public static StopMatchmakingInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StopMatchmakingInput.class);
  }

  /**
   * Convert an instance of StopMatchmakingInput to an JSON string
   *
   * @return JSON string
   */
