...
public class CreateGameSessionOutputGameSession {
  ...
  public CreateGameSessionOutputGameSession() {
  }

  public CreateGameSessionOutputGameSession gameSessionId(String gameSessionId) {
  ...
  public CreateGameSessionOutputGameSession name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateGameSessionOutputGameSession fleetId(String fleetId) {
  ...
  public CreateGameSessionOutputGameSession fleetArn(String fleetArn) {
  ...
  public CreateGameSessionOutputGameSession creationTime(OffsetDateTime creationTime) {
  ...
  public CreateGameSessionOutputGameSession terminationTime(OffsetDateTime terminationTime) {
  ...
  public CreateGameSessionOutputGameSession currentPlayerSessionCount(Integer currentPlayerSessionCount) {
  ...
  public CreateGameSessionOutputGameSession maximumPlayerSessionCount(Integer maximumPlayerSessionCount) {
  ...
  public CreateGameSessionOutputGameSession status(GameSessionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public CreateGameSessionOutputGameSession statusReason(GameSessionStatusReason statusReason) {
  ...
  public CreateGameSessionOutputGameSession gameProperties(List gameProperties) {
  ...
  public CreateGameSessionOutputGameSession ipAddress(String ipAddress) {
  ...
  public CreateGameSessionOutputGameSession dnsName(String dnsName) {
  ...
  public CreateGameSessionOutputGameSession port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public CreateGameSessionOutputGameSession playerSessionCreationPolicy(PlayerSessionCreationPolicy playerSessionCreationPolicy) {
  ...
  public CreateGameSessionOutputGameSession creatorId(String creatorId) {
  ...
  public CreateGameSessionOutputGameSession gameSessionData(String gameSessionData) {
  ...
  public CreateGameSessionOutputGameSession matchmakerData(String matchmakerData) {
  ...
  public CreateGameSessionOutputGameSession location(String location) {
  ...
  public boolean equals(Object o) {
    ...
    CreateGameSessionOutputGameSession createGameSessionOutputGameSession = (CreateGameSessionOutputGameSession) o;
    return Objects.equals(this.gameSessionId, createGameSessionOutputGameSession.gameSessionId) &&
        Objects.equals(this.name, createGameSessionOutputGameSession.name) &&
        Objects.equals(this.fleetId, createGameSessionOutputGameSession.fleetId) &&
        Objects.equals(this.fleetArn, createGameSessionOutputGameSession.fleetArn) &&
        Objects.equals(this.creationTime, createGameSessionOutputGameSession.creationTime) &&
        Objects.equals(this.terminationTime, createGameSessionOutputGameSession.terminationTime) &&
        Objects.equals(this.currentPlayerSessionCount, createGameSessionOutputGameSession.currentPlayerSessionCount) &&
        Objects.equals(this.maximumPlayerSessionCount, createGameSessionOutputGameSession.maximumPlayerSessionCount) &&
        Objects.equals(this.status, createGameSessionOutputGameSession.status) &&
        Objects.equals(this.statusReason, createGameSessionOutputGameSession.statusReason) &&
        Objects.equals(this.gameProperties, createGameSessionOutputGameSession.gameProperties) &&
        Objects.equals(this.ipAddress, createGameSessionOutputGameSession.ipAddress) &&
        Objects.equals(this.dnsName, createGameSessionOutputGameSession.dnsName) &&
        Objects.equals(this.port, createGameSessionOutputGameSession.port) &&
        Objects.equals(this.playerSessionCreationPolicy, createGameSessionOutputGameSession.playerSessionCreationPolicy) &&
        Objects.equals(this.creatorId, createGameSessionOutputGameSession.creatorId) &&
        Objects.equals(this.gameSessionData, createGameSessionOutputGameSession.gameSessionData) &&
        Objects.equals(this.matchmakerData, createGameSessionOutputGameSession.matchmakerData) &&
        Objects.equals(this.location, createGameSessionOutputGameSession.location);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateGameSessionOutputGameSession {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateGameSessionOutputGameSession
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateGameSessionOutputGameSession.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateGameSessionOutputGameSession is not found in the empty JSON string", CreateGameSessionOutputGameSession.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateGameSessionOutputGameSession.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateGameSessionOutputGameSession` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateGameSessionOutputGameSession.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateGameSessionOutputGameSession' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateGameSessionOutputGameSession> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateGameSessionOutputGameSession.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateGameSessionOutputGameSession>() {
           @Override
           public void write(JsonWriter out, CreateGameSessionOutputGameSession value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateGameSessionOutputGameSession read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateGameSessionOutputGameSession given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateGameSessionOutputGameSession
   * @throws IOException if the JSON string is invalid with respect to CreateGameSessionOutputGameSession
   */
  public static CreateGameSessionOutputGameSession fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateGameSessionOutputGameSession.class);
  }

  /**
   * Convert an instance of CreateGameSessionOutputGameSession to an JSON string
   *
   * @return JSON string
   */
