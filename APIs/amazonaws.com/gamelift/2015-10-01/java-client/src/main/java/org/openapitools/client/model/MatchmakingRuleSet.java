...
public class MatchmakingRuleSet {
  ...
  public MatchmakingRuleSet ruleSetName(String ruleSetName) {
  ...
  public MatchmakingRuleSet ruleSetArn(String ruleSetArn) {
  ...
  public MatchmakingRuleSet ruleSetBody(String ruleSetBody) {
  ...
  public MatchmakingRuleSet creationTime(OffsetDateTime creationTime) {
  ...
  public boolean equals(Object o) {
    ...
    MatchmakingRuleSet matchmakingRuleSet = (MatchmakingRuleSet) o;
    return Objects.equals(this.ruleSetName, matchmakingRuleSet.ruleSetName) &&
        Objects.equals(this.ruleSetArn, matchmakingRuleSet.ruleSetArn) &&
        Objects.equals(this.ruleSetBody, matchmakingRuleSet.ruleSetBody) &&
        Objects.equals(this.creationTime, matchmakingRuleSet.creationTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class MatchmakingRuleSet {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MatchmakingRuleSet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MatchmakingRuleSet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MatchmakingRuleSet is not found in the empty JSON string", MatchmakingRuleSet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MatchmakingRuleSet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MatchmakingRuleSet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MatchmakingRuleSet.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MatchmakingRuleSet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MatchmakingRuleSet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MatchmakingRuleSet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MatchmakingRuleSet.class));

       return (TypeAdapter<T>) new TypeAdapter<MatchmakingRuleSet>() {
           @Override
           public void write(JsonWriter out, MatchmakingRuleSet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MatchmakingRuleSet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MatchmakingRuleSet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MatchmakingRuleSet
   * @throws IOException if the JSON string is invalid with respect to MatchmakingRuleSet
   */
  public static MatchmakingRuleSet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MatchmakingRuleSet.class);
  }

  /**
   * Convert an instance of MatchmakingRuleSet to an JSON string
   *
   * @return JSON string
   */
