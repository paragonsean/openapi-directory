...
public class GetComputeAuthTokenInput {
  ...
  public GetComputeAuthTokenInput() {
  }

  public GetComputeAuthTokenInput fleetId(String fleetId) {
  ...
  public GetComputeAuthTokenInput computeName(String computeName) {
  ...
  public boolean equals(Object o) {
    ...
    GetComputeAuthTokenInput getComputeAuthTokenInput = (GetComputeAuthTokenInput) o;
    return Objects.equals(this.fleetId, getComputeAuthTokenInput.fleetId) &&
        Objects.equals(this.computeName, getComputeAuthTokenInput.computeName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fleetId, computeName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetComputeAuthTokenInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetComputeAuthTokenInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetComputeAuthTokenInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetComputeAuthTokenInput is not found in the empty JSON string", GetComputeAuthTokenInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetComputeAuthTokenInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetComputeAuthTokenInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetComputeAuthTokenInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetComputeAuthTokenInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetComputeAuthTokenInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetComputeAuthTokenInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetComputeAuthTokenInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetComputeAuthTokenInput>() {
           @Override
           public void write(JsonWriter out, GetComputeAuthTokenInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetComputeAuthTokenInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetComputeAuthTokenInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetComputeAuthTokenInput
   * @throws IOException if the JSON string is invalid with respect to GetComputeAuthTokenInput
   */
  public static GetComputeAuthTokenInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetComputeAuthTokenInput.class);
  }

  /**
   * Convert an instance of GetComputeAuthTokenInput to an JSON string
   *
   * @return JSON string
   */
