...
public class InstanceCredentials {
  ...
  public InstanceCredentials userName(String userName) {
  ...
  public InstanceCredentials secret(String secret) {
    this.secret = secret;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    InstanceCredentials instanceCredentials = (InstanceCredentials) o;
    return Objects.equals(this.userName, instanceCredentials.userName) &&
        Objects.equals(this.secret, instanceCredentials.secret);
  }
  ...
  public String toString() {
    ...
    sb.append("class InstanceCredentials {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InstanceCredentials
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InstanceCredentials.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InstanceCredentials is not found in the empty JSON string", InstanceCredentials.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InstanceCredentials.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InstanceCredentials` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InstanceCredentials.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InstanceCredentials' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InstanceCredentials> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InstanceCredentials.class));

       return (TypeAdapter<T>) new TypeAdapter<InstanceCredentials>() {
           @Override
           public void write(JsonWriter out, InstanceCredentials value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InstanceCredentials read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InstanceCredentials given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InstanceCredentials
   * @throws IOException if the JSON string is invalid with respect to InstanceCredentials
   */
  public static InstanceCredentials fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InstanceCredentials.class);
  }

  /**
   * Convert an instance of InstanceCredentials to an JSON string
   *
   * @return JSON string
   */
