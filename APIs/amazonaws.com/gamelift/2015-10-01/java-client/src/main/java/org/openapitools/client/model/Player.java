...
public class Player {
  ...
  public static final String SERIALIZED_NAME_PLAYER_ATTRIBUTES = "PlayerAttributes";
  @SerializedName(SERIALIZED_NAME_PLAYER_ATTRIBUTES)
  private Map playerAttributes;

  public static final String SERIALIZED_NAME_TEAM = "Team";
  @SerializedName(SERIALIZED_NAME_TEAM)
  private String team;

  public static final String SERIALIZED_NAME_LATENCY_IN_MS = "LatencyInMs";
  @SerializedName(SERIALIZED_NAME_LATENCY_IN_MS)
  private Map latencyInMs;
  ...
  public Player playerAttributes(Map playerAttributes) {
   ...
   */
  @javax.annotation.Nullable
  public Map getPlayerAttributes() {
    return playerAttributes;
  }

  public void setPlayerAttributes(Map playerAttributes) {
    this.playerAttributes = playerAttributes;
  }
  ...
  public Player latencyInMs(Map latencyInMs) {
   ...
   */
  @javax.annotation.Nullable
  public Map getLatencyInMs() {
    return latencyInMs;
  }

  public void setLatencyInMs(Map latencyInMs) {
    this.latencyInMs = latencyInMs;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.playerId, player.playerId) &&
        Objects.equals(this.playerAttributes, player.playerAttributes) &&
        Objects.equals(this.team, player.team) &&
        Objects.equals(this.latencyInMs, player.latencyInMs);
  }

  @Override
  public int hashCode() {
    return Objects.hash(playerId, playerAttributes, team, latencyInMs);
  }
  ...
  public String toString() {
    ...
    sb.append("    playerAttributes: ").append(toIndentedString(playerAttributes)).append("\n");
    sb.append("    team: ").append(toIndentedString(team)).append("\n");
    sb.append("    latencyInMs: ").append(toIndentedString(latencyInMs)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("PlayerAttributes");
    openapiFields.add("Team");
    openapiFields.add("LatencyInMs");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `PlayerAttributes`
      if (jsonObj.get("PlayerAttributes") != null && !jsonObj.get("PlayerAttributes").isJsonNull()) {
        Map.validateJsonElement(jsonObj.get("PlayerAttributes"));
      }
      // validate the optional field `Team`
      if (jsonObj.get("Team") != null && !jsonObj.get("Team").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("Team"));
      }
      // validate the optional field `LatencyInMs`
      if (jsonObj.get("LatencyInMs") != null && !jsonObj.get("LatencyInMs").isJsonNull()) {
        Map.validateJsonElement(jsonObj.get("LatencyInMs"));
      }
  }
