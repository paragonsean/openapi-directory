...
/**
 * Gets or Sets GameServerGroupAction
 */
@JsonAdapter(GameServerGroupAction.Adapter.class)
public enum GameServerGroupAction {
  ...
  GameServerGroupAction(String value) {
    this.value = value;
  }
  ...
  public static GameServerGroupAction fromValue(String value) {
    for (GameServerGroupAction b : GameServerGroupAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<GameServerGroupAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final GameServerGroupAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public GameServerGroupAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return GameServerGroupAction.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    GameServerGroupAction.fromValue(value);
  }
}
