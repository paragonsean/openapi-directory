...
public class ListAliasesOutput {
  ...
  public ListAliasesOutput() {
  }

  public ListAliasesOutput aliases(List aliases) {
  ...
  public ListAliasesOutput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListAliasesOutput listAliasesOutput = (ListAliasesOutput) o;
    return Objects.equals(this.aliases, listAliasesOutput.aliases) &&
        Objects.equals(this.nextToken, listAliasesOutput.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListAliasesOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAliasesOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAliasesOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAliasesOutput is not found in the empty JSON string", ListAliasesOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAliasesOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAliasesOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAliasesOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAliasesOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAliasesOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAliasesOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAliasesOutput>() {
           @Override
           public void write(JsonWriter out, ListAliasesOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAliasesOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAliasesOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAliasesOutput
   * @throws IOException if the JSON string is invalid with respect to ListAliasesOutput
   */
  public static ListAliasesOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAliasesOutput.class);
  }

  /**
   * Convert an instance of ListAliasesOutput to an JSON string
   *
   * @return JSON string
   */
