...
public class DeleteFleetInput {
  ...
  public DeleteFleetInput() {
  }

  public DeleteFleetInput fleetId(String fleetId) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteFleetInput deleteFleetInput = (DeleteFleetInput) o;
    return Objects.equals(this.fleetId, deleteFleetInput.fleetId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteFleetInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteFleetInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteFleetInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteFleetInput is not found in the empty JSON string", DeleteFleetInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteFleetInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteFleetInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteFleetInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteFleetInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteFleetInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteFleetInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteFleetInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteFleetInput>() {
           @Override
           public void write(JsonWriter out, DeleteFleetInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteFleetInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteFleetInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteFleetInput
   * @throws IOException if the JSON string is invalid with respect to DeleteFleetInput
   */
  public static DeleteFleetInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteFleetInput.class);
  }

  /**
   * Convert an instance of DeleteFleetInput to an JSON string
   *
   * @return JSON string
   */
