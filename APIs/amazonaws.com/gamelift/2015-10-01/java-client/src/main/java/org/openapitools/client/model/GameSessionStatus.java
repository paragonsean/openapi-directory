...
/**
 * Gets or Sets GameSessionStatus
 */
@JsonAdapter(GameSessionStatus.Adapter.class)
public enum GameSessionStatus {
  ...
  GameSessionStatus(String value) {
    this.value = value;
  }
  ...
  public static GameSessionStatus fromValue(String value) {
    for (GameSessionStatus b : GameSessionStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<GameSessionStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final GameSessionStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public GameSessionStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return GameSessionStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    GameSessionStatus.fromValue(value);
  }
}
