...
/**
 * Gets or Sets FleetType
 */
@JsonAdapter(FleetType.Adapter.class)
public enum FleetType {
  ...
  public static FleetType fromValue(String value) {
    for (FleetType b : FleetType.values()) {
  ...
  public static class Adapter extends TypeAdapter<FleetType> {
    @Override
    public void write(final JsonWriter jsonWriter, final FleetType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FleetType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FleetType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FleetType.fromValue(value);
  }
}
