...
public class LocationAttributes {
  ...
  private LocationAttributesLocationState locationState;
  ...
  public LocationAttributes locationState(LocationAttributesLocationState locationState) {
  ...
  public LocationAttributesLocationState getLocationState() {
    return locationState;
  }

  public void setLocationState(LocationAttributesLocationState locationState) {
    this.locationState = locationState;
  }


  public LocationAttributes stoppedActions(List stoppedActions) {
  ...
  public LocationAttributes updateStatus(LocationUpdateStatus updateStatus) {
  ...
  public boolean equals(Object o) {
    ...
    LocationAttributes locationAttributes = (LocationAttributes) o;
    return Objects.equals(this.locationState, locationAttributes.locationState) &&
        Objects.equals(this.stoppedActions, locationAttributes.stoppedActions) &&
        Objects.equals(this.updateStatus, locationAttributes.updateStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(locationState, stoppedActions, updateStatus);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LocationAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LocationAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LocationAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LocationAttributes is not found in the empty JSON string", LocationAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LocationAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LocationAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `LocationState`
      if (jsonObj.get("LocationState") != null && !jsonObj.get("LocationState").isJsonNull()) {
        LocationAttributesLocationState.validateJsonElement(jsonObj.get("LocationState"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LocationAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LocationAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LocationAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LocationAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<LocationAttributes>() {
           @Override
           public void write(JsonWriter out, LocationAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LocationAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LocationAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LocationAttributes
   * @throws IOException if the JSON string is invalid with respect to LocationAttributes
   */
  public static LocationAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LocationAttributes.class);
  }

  /**
   * Convert an instance of LocationAttributes to an JSON string
   *
   * @return JSON string
   */
