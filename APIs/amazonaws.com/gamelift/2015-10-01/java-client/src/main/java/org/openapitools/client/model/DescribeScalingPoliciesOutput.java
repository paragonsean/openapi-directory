...
public class DescribeScalingPoliciesOutput {
  ...
  public DescribeScalingPoliciesOutput scalingPolicies(List scalingPolicies) {
  ...
  public DescribeScalingPoliciesOutput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeScalingPoliciesOutput describeScalingPoliciesOutput = (DescribeScalingPoliciesOutput) o;
    return Objects.equals(this.scalingPolicies, describeScalingPoliciesOutput.scalingPolicies) &&
        Objects.equals(this.nextToken, describeScalingPoliciesOutput.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeScalingPoliciesOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeScalingPoliciesOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeScalingPoliciesOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeScalingPoliciesOutput is not found in the empty JSON string", DescribeScalingPoliciesOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeScalingPoliciesOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeScalingPoliciesOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeScalingPoliciesOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeScalingPoliciesOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeScalingPoliciesOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeScalingPoliciesOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeScalingPoliciesOutput>() {
           @Override
           public void write(JsonWriter out, DescribeScalingPoliciesOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeScalingPoliciesOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeScalingPoliciesOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeScalingPoliciesOutput
   * @throws IOException if the JSON string is invalid with respect to DescribeScalingPoliciesOutput
   */
  public static DescribeScalingPoliciesOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeScalingPoliciesOutput.class);
  }

  /**
   * Convert an instance of DescribeScalingPoliciesOutput to an JSON string
   *
   * @return JSON string
   */
