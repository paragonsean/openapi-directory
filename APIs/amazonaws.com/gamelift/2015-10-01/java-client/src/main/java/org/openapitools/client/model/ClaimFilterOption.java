...
public class ClaimFilterOption {
  ...
  public ClaimFilterOption() {
  }

  public ClaimFilterOption instanceStatuses(List instanceStatuses) {
  ...
  public boolean equals(Object o) {
    ...
    ClaimFilterOption claimFilterOption = (ClaimFilterOption) o;
    return Objects.equals(this.instanceStatuses, claimFilterOption.instanceStatuses);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClaimFilterOption {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClaimFilterOption
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClaimFilterOption.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClaimFilterOption is not found in the empty JSON string", ClaimFilterOption.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClaimFilterOption.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ClaimFilterOption` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClaimFilterOption.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClaimFilterOption' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClaimFilterOption> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClaimFilterOption.class));

       return (TypeAdapter<T>) new TypeAdapter<ClaimFilterOption>() {
           @Override
           public void write(JsonWriter out, ClaimFilterOption value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ClaimFilterOption read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ClaimFilterOption given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ClaimFilterOption
   * @throws IOException if the JSON string is invalid with respect to ClaimFilterOption
   */
  public static ClaimFilterOption fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClaimFilterOption.class);
  }

  /**
   * Convert an instance of ClaimFilterOption to an JSON string
   *
   * @return JSON string
   */
