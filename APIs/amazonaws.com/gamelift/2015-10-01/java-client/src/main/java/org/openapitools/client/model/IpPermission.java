...
import org.openapitools.client.model.IpProtocol;
...
public class IpPermission {
  ...
  public IpPermission fromPort(Integer fromPort) {
  ...
  public IpPermission toPort(Integer toPort) {
    this.toPort = toPort;
    return this;
  }
  ...
  public IpPermission ipRange(String ipRange) {
  ...
  public IpPermission protocol(IpProtocol protocol) {
  ...
  public boolean equals(Object o) {
    ...
    IpPermission ipPermission = (IpPermission) o;
    return Objects.equals(this.fromPort, ipPermission.fromPort) &&
        Objects.equals(this.toPort, ipPermission.toPort) &&
        Objects.equals(this.ipRange, ipPermission.ipRange) &&
        Objects.equals(this.protocol, ipPermission.protocol);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fromPort, toPort, ipRange, protocol);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IpPermission {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IpPermission
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IpPermission.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IpPermission is not found in the empty JSON string", IpPermission.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IpPermission.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IpPermission` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IpPermission.openapiRequiredFields) {
      ...
      // validate the required field `IpRange`
      String.validateJsonElement(jsonObj.get("IpRange"));
      // validate the required field `Protocol`
      IpProtocol.validateJsonElement(jsonObj.get("Protocol"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IpPermission.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IpPermission' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IpPermission> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IpPermission.class));

       return (TypeAdapter<T>) new TypeAdapter<IpPermission>() {
           @Override
           public void write(JsonWriter out, IpPermission value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IpPermission read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IpPermission given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IpPermission
   * @throws IOException if the JSON string is invalid with respect to IpPermission
   */
  public static IpPermission fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IpPermission.class);
  }

  /**
   * Convert an instance of IpPermission to an JSON string
   *
   * @return JSON string
   */
