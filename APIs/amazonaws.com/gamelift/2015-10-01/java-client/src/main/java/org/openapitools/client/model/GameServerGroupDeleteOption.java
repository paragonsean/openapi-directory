...
/**
 * Gets or Sets GameServerGroupDeleteOption
 */
@JsonAdapter(GameServerGroupDeleteOption.Adapter.class)
public enum GameServerGroupDeleteOption {
  ...
  public static GameServerGroupDeleteOption fromValue(String value) {
    for (GameServerGroupDeleteOption b : GameServerGroupDeleteOption.values()) {
  ...
  public static class Adapter extends TypeAdapter<GameServerGroupDeleteOption> {
    @Override
    public void write(final JsonWriter jsonWriter, final GameServerGroupDeleteOption enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public GameServerGroupDeleteOption read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return GameServerGroupDeleteOption.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    GameServerGroupDeleteOption.fromValue(value);
  }
}
