...
public class GameSessionDetailGameSession {
  ...
  public GameSessionDetailGameSession() {
  }

  public GameSessionDetailGameSession gameSessionId(String gameSessionId) {
  ...
  public GameSessionDetailGameSession name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GameSessionDetailGameSession fleetId(String fleetId) {
  ...
  public GameSessionDetailGameSession fleetArn(String fleetArn) {
  ...
  public GameSessionDetailGameSession creationTime(OffsetDateTime creationTime) {
  ...
  public GameSessionDetailGameSession terminationTime(OffsetDateTime terminationTime) {
  ...
  public GameSessionDetailGameSession currentPlayerSessionCount(Integer currentPlayerSessionCount) {
  ...
  public GameSessionDetailGameSession maximumPlayerSessionCount(Integer maximumPlayerSessionCount) {
  ...
  public GameSessionDetailGameSession status(GameSessionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public GameSessionDetailGameSession statusReason(GameSessionStatusReason statusReason) {
  ...
  public GameSessionDetailGameSession gameProperties(List gameProperties) {
  ...
  public GameSessionDetailGameSession ipAddress(String ipAddress) {
  ...
  public GameSessionDetailGameSession dnsName(String dnsName) {
  ...
  public GameSessionDetailGameSession port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public GameSessionDetailGameSession playerSessionCreationPolicy(PlayerSessionCreationPolicy playerSessionCreationPolicy) {
  ...
  public GameSessionDetailGameSession creatorId(String creatorId) {
  ...
  public GameSessionDetailGameSession gameSessionData(String gameSessionData) {
  ...
  public GameSessionDetailGameSession matchmakerData(String matchmakerData) {
  ...
  public GameSessionDetailGameSession location(String location) {
  ...
  public boolean equals(Object o) {
    ...
    GameSessionDetailGameSession gameSessionDetailGameSession = (GameSessionDetailGameSession) o;
    return Objects.equals(this.gameSessionId, gameSessionDetailGameSession.gameSessionId) &&
        Objects.equals(this.name, gameSessionDetailGameSession.name) &&
        Objects.equals(this.fleetId, gameSessionDetailGameSession.fleetId) &&
        Objects.equals(this.fleetArn, gameSessionDetailGameSession.fleetArn) &&
        Objects.equals(this.creationTime, gameSessionDetailGameSession.creationTime) &&
        Objects.equals(this.terminationTime, gameSessionDetailGameSession.terminationTime) &&
        Objects.equals(this.currentPlayerSessionCount, gameSessionDetailGameSession.currentPlayerSessionCount) &&
        Objects.equals(this.maximumPlayerSessionCount, gameSessionDetailGameSession.maximumPlayerSessionCount) &&
        Objects.equals(this.status, gameSessionDetailGameSession.status) &&
        Objects.equals(this.statusReason, gameSessionDetailGameSession.statusReason) &&
        Objects.equals(this.gameProperties, gameSessionDetailGameSession.gameProperties) &&
        Objects.equals(this.ipAddress, gameSessionDetailGameSession.ipAddress) &&
        Objects.equals(this.dnsName, gameSessionDetailGameSession.dnsName) &&
        Objects.equals(this.port, gameSessionDetailGameSession.port) &&
        Objects.equals(this.playerSessionCreationPolicy, gameSessionDetailGameSession.playerSessionCreationPolicy) &&
        Objects.equals(this.creatorId, gameSessionDetailGameSession.creatorId) &&
        Objects.equals(this.gameSessionData, gameSessionDetailGameSession.gameSessionData) &&
        Objects.equals(this.matchmakerData, gameSessionDetailGameSession.matchmakerData) &&
        Objects.equals(this.location, gameSessionDetailGameSession.location);
  }
  ...
  public String toString() {
    ...
    sb.append("class GameSessionDetailGameSession {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GameSessionDetailGameSession
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GameSessionDetailGameSession.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GameSessionDetailGameSession is not found in the empty JSON string", GameSessionDetailGameSession.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GameSessionDetailGameSession.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GameSessionDetailGameSession` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GameSessionDetailGameSession.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GameSessionDetailGameSession' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GameSessionDetailGameSession> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GameSessionDetailGameSession.class));

       return (TypeAdapter<T>) new TypeAdapter<GameSessionDetailGameSession>() {
           @Override
           public void write(JsonWriter out, GameSessionDetailGameSession value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GameSessionDetailGameSession read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GameSessionDetailGameSession given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GameSessionDetailGameSession
   * @throws IOException if the JSON string is invalid with respect to GameSessionDetailGameSession
   */
  public static GameSessionDetailGameSession fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GameSessionDetailGameSession.class);
  }

  /**
   * Convert an instance of GameSessionDetailGameSession to an JSON string
   *
   * @return JSON string
   */
