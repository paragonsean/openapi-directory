...
/**
 * Gets or Sets PlayerSessionCreationPolicy
 */
@JsonAdapter(PlayerSessionCreationPolicy.Adapter.class)
public enum PlayerSessionCreationPolicy {
  ...
  PlayerSessionCreationPolicy(String value) {
    this.value = value;
  }
  ...
  public static PlayerSessionCreationPolicy fromValue(String value) {
    for (PlayerSessionCreationPolicy b : PlayerSessionCreationPolicy.values()) {
  ...
  public static class Adapter extends TypeAdapter<PlayerSessionCreationPolicy> {
    @Override
    public void write(final JsonWriter jsonWriter, final PlayerSessionCreationPolicy enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PlayerSessionCreationPolicy read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PlayerSessionCreationPolicy.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PlayerSessionCreationPolicy.fromValue(value);
  }
}
