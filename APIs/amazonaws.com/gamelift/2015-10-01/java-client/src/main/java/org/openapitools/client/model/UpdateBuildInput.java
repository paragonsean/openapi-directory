...
public class UpdateBuildInput {
  ...
  public UpdateBuildInput() {
  }

  public UpdateBuildInput buildId(String buildId) {
  ...
  public UpdateBuildInput name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateBuildInput version(String version) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateBuildInput updateBuildInput = (UpdateBuildInput) o;
    return Objects.equals(this.buildId, updateBuildInput.buildId) &&
        Objects.equals(this.name, updateBuildInput.name) &&
        Objects.equals(this.version, updateBuildInput.version);
  }

  @Override
  public int hashCode() {
    return Objects.hash(buildId, name, version);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateBuildInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateBuildInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateBuildInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateBuildInput is not found in the empty JSON string", UpdateBuildInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateBuildInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateBuildInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateBuildInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateBuildInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateBuildInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateBuildInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateBuildInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateBuildInput>() {
           @Override
           public void write(JsonWriter out, UpdateBuildInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateBuildInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateBuildInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateBuildInput
   * @throws IOException if the JSON string is invalid with respect to UpdateBuildInput
   */
  public static UpdateBuildInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateBuildInput.class);
  }

  /**
   * Convert an instance of UpdateBuildInput to an JSON string
   *
   * @return JSON string
   */
