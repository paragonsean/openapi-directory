...
public class StartMatchmakingInput {
  ...
  public StartMatchmakingInput() {
  }

  public StartMatchmakingInput ticketId(String ticketId) {
  ...
  public StartMatchmakingInput configurationName(String configurationName) {
  ...
  public StartMatchmakingInput players(List players) {
  ...
  public boolean equals(Object o) {
    ...
    StartMatchmakingInput startMatchmakingInput = (StartMatchmakingInput) o;
    return Objects.equals(this.ticketId, startMatchmakingInput.ticketId) &&
        Objects.equals(this.configurationName, startMatchmakingInput.configurationName) &&
        Objects.equals(this.players, startMatchmakingInput.players);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ticketId, configurationName, players);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StartMatchmakingInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartMatchmakingInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartMatchmakingInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartMatchmakingInput is not found in the empty JSON string", StartMatchmakingInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartMatchmakingInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartMatchmakingInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartMatchmakingInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartMatchmakingInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartMatchmakingInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartMatchmakingInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartMatchmakingInput.class));

       return (TypeAdapter<T>) new TypeAdapter<StartMatchmakingInput>() {
           @Override
           public void write(JsonWriter out, StartMatchmakingInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartMatchmakingInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartMatchmakingInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartMatchmakingInput
   * @throws IOException if the JSON string is invalid with respect to StartMatchmakingInput
   */
  public static StartMatchmakingInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartMatchmakingInput.class);
  }

  /**
   * Convert an instance of StartMatchmakingInput to an JSON string
   *
   * @return JSON string
   */
