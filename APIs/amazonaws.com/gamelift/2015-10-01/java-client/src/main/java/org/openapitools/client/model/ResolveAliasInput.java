...
public class ResolveAliasInput {
  ...
  public ResolveAliasInput() {
  }

  public ResolveAliasInput aliasId(String aliasId) {
  ...
  public boolean equals(Object o) {
    ...
    ResolveAliasInput resolveAliasInput = (ResolveAliasInput) o;
    return Objects.equals(this.aliasId, resolveAliasInput.aliasId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResolveAliasInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResolveAliasInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResolveAliasInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResolveAliasInput is not found in the empty JSON string", ResolveAliasInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResolveAliasInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResolveAliasInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResolveAliasInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResolveAliasInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResolveAliasInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResolveAliasInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResolveAliasInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ResolveAliasInput>() {
           @Override
           public void write(JsonWriter out, ResolveAliasInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResolveAliasInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResolveAliasInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResolveAliasInput
   * @throws IOException if the JSON string is invalid with respect to ResolveAliasInput
   */
  public static ResolveAliasInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResolveAliasInput.class);
  }

  /**
   * Convert an instance of ResolveAliasInput to an JSON string
   *
   * @return JSON string
   */
