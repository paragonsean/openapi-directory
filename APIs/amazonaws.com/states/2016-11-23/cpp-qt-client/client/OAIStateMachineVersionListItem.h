...
/*
 * OAIStateMachineVersionListItem.h
 *
 * Contains details about a specific state machine version.
 */

#ifndef OAIStateMachineVersionListItem_H
#define OAIStateMachineVersionListItem_H
...
class OAIStateMachineVersionListItem : public OAIObject {
public:
    OAIStateMachineVersionListItem();
    OAIStateMachineVersionListItem(QString json);
    ~OAIStateMachineVersionListItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStateMachineVersionListItem)

#endif // OAIStateMachineVersionListItem_H
