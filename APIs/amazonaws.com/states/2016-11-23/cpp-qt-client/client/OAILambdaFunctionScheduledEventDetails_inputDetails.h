...
/*
 * OAILambdaFunctionScheduledEventDetails_inputDetails.h
 *
 * 
 */

#ifndef OAILambdaFunctionScheduledEventDetails_inputDetails_H
#define OAILambdaFunctionScheduledEventDetails_inputDetails_H
...
class OAILambdaFunctionScheduledEventDetails_inputDetails : public OAIObject {
public:
    OAILambdaFunctionScheduledEventDetails_inputDetails();
    OAILambdaFunctionScheduledEventDetails_inputDetails(QString json);
    ~OAILambdaFunctionScheduledEventDetails_inputDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILambdaFunctionScheduledEventDetails_inputDetails)

#endif // OAILambdaFunctionScheduledEventDetails_inputDetails_H
