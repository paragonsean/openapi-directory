...
/*
 * OAIMapIterationEventDetails.h
 *
 * Contains details about an iteration of a Map state.
 */

#ifndef OAIMapIterationEventDetails_H
#define OAIMapIterationEventDetails_H
...
class OAIMapIterationEventDetails : public OAIObject {
public:
    OAIMapIterationEventDetails();
    OAIMapIterationEventDetails(QString json);
    ~OAIMapIterationEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMapIterationEventDetails)

#endif // OAIMapIterationEventDetails_H
