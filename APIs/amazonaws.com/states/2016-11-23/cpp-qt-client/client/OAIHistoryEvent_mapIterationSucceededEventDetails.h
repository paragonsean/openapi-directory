...
/*
 * OAIHistoryEvent_mapIterationSucceededEventDetails.h
 *
 * 
 */

#ifndef OAIHistoryEvent_mapIterationSucceededEventDetails_H
#define OAIHistoryEvent_mapIterationSucceededEventDetails_H
...
class OAIHistoryEvent_mapIterationSucceededEventDetails : public OAIObject {
public:
    OAIHistoryEvent_mapIterationSucceededEventDetails();
    OAIHistoryEvent_mapIterationSucceededEventDetails(QString json);
    ~OAIHistoryEvent_mapIterationSucceededEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistoryEvent_mapIterationSucceededEventDetails)

#endif // OAIHistoryEvent_mapIterationSucceededEventDetails_H
