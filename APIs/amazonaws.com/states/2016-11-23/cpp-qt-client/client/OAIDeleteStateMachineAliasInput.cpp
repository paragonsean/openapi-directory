...
OAIDeleteStateMachineAliasInput::OAIDeleteStateMachineAliasInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteStateMachineAliasInput::OAIDeleteStateMachineAliasInput() {
    this->initializeModel();
}

OAIDeleteStateMachineAliasInput::~OAIDeleteStateMachineAliasInput() {}

void OAIDeleteStateMachineAliasInput::initializeModel() {

    m_state_machine_alias_arn_isSet = false;
    m_state_machine_alias_arn_isValid = false;
}

void OAIDeleteStateMachineAliasInput::fromJson(QString jsonString) {
...
void OAIDeleteStateMachineAliasInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteStateMachineAliasInput::asJson() const {
...
QJsonObject OAIDeleteStateMachineAliasInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteStateMachineAliasInput::getStateMachineAliasArn() const {
    return m_state_machine_alias_arn;
}
void OAIDeleteStateMachineAliasInput::setStateMachineAliasArn(const QString &state_machine_alias_arn) {
    m_state_machine_alias_arn = state_machine_alias_arn;
    m_state_machine_alias_arn_isSet = true;
}

bool OAIDeleteStateMachineAliasInput::is_state_machine_alias_arn_Set() const{
    return m_state_machine_alias_arn_isSet;
}

bool OAIDeleteStateMachineAliasInput::is_state_machine_alias_arn_Valid() const{
    return m_state_machine_alias_arn_isValid;
}

bool OAIDeleteStateMachineAliasInput::isSet() const {
...
bool OAIDeleteStateMachineAliasInput::isValid() const {
