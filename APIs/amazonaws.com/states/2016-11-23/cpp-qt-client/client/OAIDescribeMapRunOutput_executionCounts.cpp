...
OAIDescribeMapRunOutput_executionCounts::OAIDescribeMapRunOutput_executionCounts(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeMapRunOutput_executionCounts::OAIDescribeMapRunOutput_executionCounts() {
    this->initializeModel();
}

OAIDescribeMapRunOutput_executionCounts::~OAIDescribeMapRunOutput_executionCounts() {}

void OAIDescribeMapRunOutput_executionCounts::initializeModel() {
...
void OAIDescribeMapRunOutput_executionCounts::fromJson(QString jsonString) {
...
void OAIDescribeMapRunOutput_executionCounts::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeMapRunOutput_executionCounts::asJson() const {
...
QJsonObject OAIDescribeMapRunOutput_executionCounts::asJsonObject() const {
    QJsonObject obj;
    if (m_pending_isSet) {
...
qint32 OAIDescribeMapRunOutput_executionCounts::getPending() const {
    return m_pending;
}
void OAIDescribeMapRunOutput_executionCounts::setPending(const qint32 &pending) {
    m_pending = pending;
    m_pending_isSet = true;
}

bool OAIDescribeMapRunOutput_executionCounts::is_pending_Set() const{
    return m_pending_isSet;
}

bool OAIDescribeMapRunOutput_executionCounts::is_pending_Valid() const{
    return m_pending_isValid;
}

qint32 OAIDescribeMapRunOutput_executionCounts::getRunning() const {
    return m_running;
}
void OAIDescribeMapRunOutput_executionCounts::setRunning(const qint32 &running) {
    m_running = running;
    m_running_isSet = true;
}

bool OAIDescribeMapRunOutput_executionCounts::is_running_Set() const{
    return m_running_isSet;
}

bool OAIDescribeMapRunOutput_executionCounts::is_running_Valid() const{
    return m_running_isValid;
}

qint32 OAIDescribeMapRunOutput_executionCounts::getSucceeded() const {
    return m_succeeded;
}
void OAIDescribeMapRunOutput_executionCounts::setSucceeded(const qint32 &succeeded) {
    m_succeeded = succeeded;
    m_succeeded_isSet = true;
}

bool OAIDescribeMapRunOutput_executionCounts::is_succeeded_Set() const{
    return m_succeeded_isSet;
}

bool OAIDescribeMapRunOutput_executionCounts::is_succeeded_Valid() const{
    return m_succeeded_isValid;
}

qint32 OAIDescribeMapRunOutput_executionCounts::getFailed() const {
    return m_failed;
}
void OAIDescribeMapRunOutput_executionCounts::setFailed(const qint32 &failed) {
    m_failed = failed;
    m_failed_isSet = true;
}

bool OAIDescribeMapRunOutput_executionCounts::is_failed_Set() const{
    return m_failed_isSet;
}

bool OAIDescribeMapRunOutput_executionCounts::is_failed_Valid() const{
    return m_failed_isValid;
}

qint32 OAIDescribeMapRunOutput_executionCounts::getTimedOut() const {
    return m_timed_out;
}
void OAIDescribeMapRunOutput_executionCounts::setTimedOut(const qint32 &timed_out) {
    m_timed_out = timed_out;
    m_timed_out_isSet = true;
}

bool OAIDescribeMapRunOutput_executionCounts::is_timed_out_Set() const{
    return m_timed_out_isSet;
}

bool OAIDescribeMapRunOutput_executionCounts::is_timed_out_Valid() const{
    return m_timed_out_isValid;
}

qint32 OAIDescribeMapRunOutput_executionCounts::getAborted() const {
    return m_aborted;
}
void OAIDescribeMapRunOutput_executionCounts::setAborted(const qint32 &aborted) {
    m_aborted = aborted;
    m_aborted_isSet = true;
}

bool OAIDescribeMapRunOutput_executionCounts::is_aborted_Set() const{
    return m_aborted_isSet;
}

bool OAIDescribeMapRunOutput_executionCounts::is_aborted_Valid() const{
    return m_aborted_isValid;
}

qint32 OAIDescribeMapRunOutput_executionCounts::getTotal() const {
    return m_total;
}
void OAIDescribeMapRunOutput_executionCounts::setTotal(const qint32 &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAIDescribeMapRunOutput_executionCounts::is_total_Set() const{
    return m_total_isSet;
}

bool OAIDescribeMapRunOutput_executionCounts::is_total_Valid() const{
    return m_total_isValid;
}

qint32 OAIDescribeMapRunOutput_executionCounts::getResultsWritten() const {
    return m_results_written;
}
void OAIDescribeMapRunOutput_executionCounts::setResultsWritten(const qint32 &results_written) {
    m_results_written = results_written;
    m_results_written_isSet = true;
}

bool OAIDescribeMapRunOutput_executionCounts::is_results_written_Set() const{
    return m_results_written_isSet;
}

bool OAIDescribeMapRunOutput_executionCounts::is_results_written_Valid() const{
    return m_results_written_isValid;
}

bool OAIDescribeMapRunOutput_executionCounts::isSet() const {
...
bool OAIDescribeMapRunOutput_executionCounts::isValid() const {
