...
/*
 * OAIHistoryEvent_mapIterationFailedEventDetails.h
 *
 * 
 */

#ifndef OAIHistoryEvent_mapIterationFailedEventDetails_H
#define OAIHistoryEvent_mapIterationFailedEventDetails_H
...
class OAIHistoryEvent_mapIterationFailedEventDetails : public OAIObject {
public:
    OAIHistoryEvent_mapIterationFailedEventDetails();
    OAIHistoryEvent_mapIterationFailedEventDetails(QString json);
    ~OAIHistoryEvent_mapIterationFailedEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistoryEvent_mapIterationFailedEventDetails)

#endif // OAIHistoryEvent_mapIterationFailedEventDetails_H
