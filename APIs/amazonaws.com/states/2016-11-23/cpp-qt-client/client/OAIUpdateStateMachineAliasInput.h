...
/*
 * OAIUpdateStateMachineAliasInput.h
 *
 * 
 */

#ifndef OAIUpdateStateMachineAliasInput_H
#define OAIUpdateStateMachineAliasInput_H
...
class OAIUpdateStateMachineAliasInput : public OAIObject {
public:
    OAIUpdateStateMachineAliasInput();
    OAIUpdateStateMachineAliasInput(QString json);
    ~OAIUpdateStateMachineAliasInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateStateMachineAliasInput)

#endif // OAIUpdateStateMachineAliasInput_H
