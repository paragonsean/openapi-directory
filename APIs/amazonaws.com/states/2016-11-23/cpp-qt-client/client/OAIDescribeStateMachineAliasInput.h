...
/*
 * OAIDescribeStateMachineAliasInput.h
 *
 * 
 */

#ifndef OAIDescribeStateMachineAliasInput_H
#define OAIDescribeStateMachineAliasInput_H
...
class OAIDescribeStateMachineAliasInput : public OAIObject {
public:
    OAIDescribeStateMachineAliasInput();
    OAIDescribeStateMachineAliasInput(QString json);
    ~OAIDescribeStateMachineAliasInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeStateMachineAliasInput)

#endif // OAIDescribeStateMachineAliasInput_H
