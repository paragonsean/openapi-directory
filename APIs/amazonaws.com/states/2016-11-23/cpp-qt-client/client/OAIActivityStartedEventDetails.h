...
/*
 * OAIActivityStartedEventDetails.h
 *
 * Contains details about the start of an activity during an execution.
 */

#ifndef OAIActivityStartedEventDetails_H
#define OAIActivityStartedEventDetails_H
...
class OAIActivityStartedEventDetails : public OAIObject {
public:
    OAIActivityStartedEventDetails();
    OAIActivityStartedEventDetails(QString json);
    ~OAIActivityStartedEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActivityStartedEventDetails)

#endif // OAIActivityStartedEventDetails_H
