...
/*
 * OAIActivityScheduledEventDetails.h
 *
 * Contains details about an activity scheduled during an execution.
 */

#ifndef OAIActivityScheduledEventDetails_H
#define OAIActivityScheduledEventDetails_H
...
class OAIActivityScheduledEventDetails : public OAIObject {
public:
    OAIActivityScheduledEventDetails();
    OAIActivityScheduledEventDetails(QString json);
    ~OAIActivityScheduledEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActivityScheduledEventDetails)

#endif // OAIActivityScheduledEventDetails_H
