...
/*
 * OAIDeleteStateMachineAliasInput.h
 *
 * 
 */

#ifndef OAIDeleteStateMachineAliasInput_H
#define OAIDeleteStateMachineAliasInput_H
...
class OAIDeleteStateMachineAliasInput : public OAIObject {
public:
    OAIDeleteStateMachineAliasInput();
    OAIDeleteStateMachineAliasInput(QString json);
    ~OAIDeleteStateMachineAliasInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteStateMachineAliasInput)

#endif // OAIDeleteStateMachineAliasInput_H
