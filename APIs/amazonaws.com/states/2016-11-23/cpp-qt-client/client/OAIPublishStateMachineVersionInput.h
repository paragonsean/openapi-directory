...
/*
 * OAIPublishStateMachineVersionInput.h
 *
 * 
 */

#ifndef OAIPublishStateMachineVersionInput_H
#define OAIPublishStateMachineVersionInput_H
...
class OAIPublishStateMachineVersionInput : public OAIObject {
public:
    OAIPublishStateMachineVersionInput();
    OAIPublishStateMachineVersionInput(QString json);
    ~OAIPublishStateMachineVersionInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPublishStateMachineVersionInput)

#endif // OAIPublishStateMachineVersionInput_H
