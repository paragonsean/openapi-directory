...
/*
 * OAIMapRunExecutionCounts.h
 *
 * Contains details about all of the child workflow executions started by a Map Run.
 */

#ifndef OAIMapRunExecutionCounts_H
#define OAIMapRunExecutionCounts_H
...
class OAIMapRunExecutionCounts : public OAIObject {
public:
    OAIMapRunExecutionCounts();
    OAIMapRunExecutionCounts(QString json);
    ~OAIMapRunExecutionCounts() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMapRunExecutionCounts)

#endif // OAIMapRunExecutionCounts_H
