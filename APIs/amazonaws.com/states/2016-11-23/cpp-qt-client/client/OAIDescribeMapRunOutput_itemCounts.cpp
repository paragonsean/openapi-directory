...
OAIDescribeMapRunOutput_itemCounts::OAIDescribeMapRunOutput_itemCounts(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeMapRunOutput_itemCounts::OAIDescribeMapRunOutput_itemCounts() {
    this->initializeModel();
}

OAIDescribeMapRunOutput_itemCounts::~OAIDescribeMapRunOutput_itemCounts() {}

void OAIDescribeMapRunOutput_itemCounts::initializeModel() {
...
void OAIDescribeMapRunOutput_itemCounts::fromJson(QString jsonString) {
...
void OAIDescribeMapRunOutput_itemCounts::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeMapRunOutput_itemCounts::asJson() const {
...
QJsonObject OAIDescribeMapRunOutput_itemCounts::asJsonObject() const {
    QJsonObject obj;
    if (m_pending_isSet) {
...
qint32 OAIDescribeMapRunOutput_itemCounts::getPending() const {
    return m_pending;
}
void OAIDescribeMapRunOutput_itemCounts::setPending(const qint32 &pending) {
    m_pending = pending;
    m_pending_isSet = true;
}

bool OAIDescribeMapRunOutput_itemCounts::is_pending_Set() const{
    return m_pending_isSet;
}

bool OAIDescribeMapRunOutput_itemCounts::is_pending_Valid() const{
    return m_pending_isValid;
}

qint32 OAIDescribeMapRunOutput_itemCounts::getRunning() const {
    return m_running;
}
void OAIDescribeMapRunOutput_itemCounts::setRunning(const qint32 &running) {
    m_running = running;
    m_running_isSet = true;
}

bool OAIDescribeMapRunOutput_itemCounts::is_running_Set() const{
    return m_running_isSet;
}

bool OAIDescribeMapRunOutput_itemCounts::is_running_Valid() const{
    return m_running_isValid;
}

qint32 OAIDescribeMapRunOutput_itemCounts::getSucceeded() const {
    return m_succeeded;
}
void OAIDescribeMapRunOutput_itemCounts::setSucceeded(const qint32 &succeeded) {
    m_succeeded = succeeded;
    m_succeeded_isSet = true;
}

bool OAIDescribeMapRunOutput_itemCounts::is_succeeded_Set() const{
    return m_succeeded_isSet;
}

bool OAIDescribeMapRunOutput_itemCounts::is_succeeded_Valid() const{
    return m_succeeded_isValid;
}

qint32 OAIDescribeMapRunOutput_itemCounts::getFailed() const {
    return m_failed;
}
void OAIDescribeMapRunOutput_itemCounts::setFailed(const qint32 &failed) {
    m_failed = failed;
    m_failed_isSet = true;
}

bool OAIDescribeMapRunOutput_itemCounts::is_failed_Set() const{
    return m_failed_isSet;
}

bool OAIDescribeMapRunOutput_itemCounts::is_failed_Valid() const{
    return m_failed_isValid;
}

qint32 OAIDescribeMapRunOutput_itemCounts::getTimedOut() const {
    return m_timed_out;
}
void OAIDescribeMapRunOutput_itemCounts::setTimedOut(const qint32 &timed_out) {
    m_timed_out = timed_out;
    m_timed_out_isSet = true;
}

bool OAIDescribeMapRunOutput_itemCounts::is_timed_out_Set() const{
    return m_timed_out_isSet;
}

bool OAIDescribeMapRunOutput_itemCounts::is_timed_out_Valid() const{
    return m_timed_out_isValid;
}

qint32 OAIDescribeMapRunOutput_itemCounts::getAborted() const {
    return m_aborted;
}
void OAIDescribeMapRunOutput_itemCounts::setAborted(const qint32 &aborted) {
    m_aborted = aborted;
    m_aborted_isSet = true;
}

bool OAIDescribeMapRunOutput_itemCounts::is_aborted_Set() const{
    return m_aborted_isSet;
}

bool OAIDescribeMapRunOutput_itemCounts::is_aborted_Valid() const{
    return m_aborted_isValid;
}

qint32 OAIDescribeMapRunOutput_itemCounts::getTotal() const {
    return m_total;
}
void OAIDescribeMapRunOutput_itemCounts::setTotal(const qint32 &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAIDescribeMapRunOutput_itemCounts::is_total_Set() const{
    return m_total_isSet;
}

bool OAIDescribeMapRunOutput_itemCounts::is_total_Valid() const{
    return m_total_isValid;
}

qint32 OAIDescribeMapRunOutput_itemCounts::getResultsWritten() const {
    return m_results_written;
}
void OAIDescribeMapRunOutput_itemCounts::setResultsWritten(const qint32 &results_written) {
    m_results_written = results_written;
    m_results_written_isSet = true;
}

bool OAIDescribeMapRunOutput_itemCounts::is_results_written_Set() const{
    return m_results_written_isSet;
}

bool OAIDescribeMapRunOutput_itemCounts::is_results_written_Valid() const{
    return m_results_written_isValid;
}

bool OAIDescribeMapRunOutput_itemCounts::isSet() const {
...
bool OAIDescribeMapRunOutput_itemCounts::isValid() const {
