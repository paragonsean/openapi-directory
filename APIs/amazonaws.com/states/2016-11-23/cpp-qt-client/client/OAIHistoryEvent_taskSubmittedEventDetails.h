...
/*
 * OAIHistoryEvent_taskSubmittedEventDetails.h
 *
 * 
 */

#ifndef OAIHistoryEvent_taskSubmittedEventDetails_H
#define OAIHistoryEvent_taskSubmittedEventDetails_H
...
class OAIHistoryEvent_taskSubmittedEventDetails : public OAIObject {
public:
    OAIHistoryEvent_taskSubmittedEventDetails();
    OAIHistoryEvent_taskSubmittedEventDetails(QString json);
    ~OAIHistoryEvent_taskSubmittedEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistoryEvent_taskSubmittedEventDetails)

#endif // OAIHistoryEvent_taskSubmittedEventDetails_H
