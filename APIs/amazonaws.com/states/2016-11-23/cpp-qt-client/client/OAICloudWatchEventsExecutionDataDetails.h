...
/*
 * OAICloudWatchEventsExecutionDataDetails.h
 *
 * Provides details about execution input or output.
 */

#ifndef OAICloudWatchEventsExecutionDataDetails_H
#define OAICloudWatchEventsExecutionDataDetails_H
...
class OAICloudWatchEventsExecutionDataDetails : public OAIObject {
public:
    OAICloudWatchEventsExecutionDataDetails();
    OAICloudWatchEventsExecutionDataDetails(QString json);
    ~OAICloudWatchEventsExecutionDataDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICloudWatchEventsExecutionDataDetails)

#endif // OAICloudWatchEventsExecutionDataDetails_H
