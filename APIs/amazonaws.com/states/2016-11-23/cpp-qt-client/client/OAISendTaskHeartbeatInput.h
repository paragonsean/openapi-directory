...
/*
 * OAISendTaskHeartbeatInput.h
 *
 * 
 */

#ifndef OAISendTaskHeartbeatInput_H
#define OAISendTaskHeartbeatInput_H
...
class OAISendTaskHeartbeatInput : public OAIObject {
public:
    OAISendTaskHeartbeatInput();
    OAISendTaskHeartbeatInput(QString json);
    ~OAISendTaskHeartbeatInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendTaskHeartbeatInput)

#endif // OAISendTaskHeartbeatInput_H
