...
class OAITracingConfiguration : public OAIObject {
public:
    OAITracingConfiguration();
    OAITracingConfiguration(QString json);
    ~OAITracingConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITracingConfiguration)

#endif // OAITracingConfiguration_H
