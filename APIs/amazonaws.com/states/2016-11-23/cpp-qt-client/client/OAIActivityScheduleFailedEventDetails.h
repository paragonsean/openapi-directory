...
/*
 * OAIActivityScheduleFailedEventDetails.h
 *
 * Contains details about an activity schedule failure that occurred during an execution.
 */

#ifndef OAIActivityScheduleFailedEventDetails_H
#define OAIActivityScheduleFailedEventDetails_H
...
class OAIActivityScheduleFailedEventDetails : public OAIObject {
public:
    OAIActivityScheduleFailedEventDetails();
    OAIActivityScheduleFailedEventDetails(QString json);
    ~OAIActivityScheduleFailedEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActivityScheduleFailedEventDetails)

#endif // OAIActivityScheduleFailedEventDetails_H
