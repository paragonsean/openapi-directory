...
/*
 * OAIActivityScheduledEventDetails_inputDetails.h
 *
 * 
 */

#ifndef OAIActivityScheduledEventDetails_inputDetails_H
#define OAIActivityScheduledEventDetails_inputDetails_H
...
class OAIActivityScheduledEventDetails_inputDetails : public OAIObject {
public:
    OAIActivityScheduledEventDetails_inputDetails();
    OAIActivityScheduledEventDetails_inputDetails(QString json);
    ~OAIActivityScheduledEventDetails_inputDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActivityScheduledEventDetails_inputDetails)

#endif // OAIActivityScheduledEventDetails_inputDetails_H
