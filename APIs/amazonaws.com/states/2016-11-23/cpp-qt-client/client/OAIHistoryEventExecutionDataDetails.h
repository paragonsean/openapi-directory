...
/*
 * OAIHistoryEventExecutionDataDetails.h
 *
 * Provides details about input or output in an execution history event.
 */

#ifndef OAIHistoryEventExecutionDataDetails_H
#define OAIHistoryEventExecutionDataDetails_H
...
class OAIHistoryEventExecutionDataDetails : public OAIObject {
public:
    OAIHistoryEventExecutionDataDetails();
    OAIHistoryEventExecutionDataDetails(QString json);
    ~OAIHistoryEventExecutionDataDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistoryEventExecutionDataDetails)

#endif // OAIHistoryEventExecutionDataDetails_H
