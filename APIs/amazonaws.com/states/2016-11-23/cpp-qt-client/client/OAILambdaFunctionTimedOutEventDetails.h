...
/*
 * OAILambdaFunctionTimedOutEventDetails.h
 *
 * Contains details about a Lambda function timeout that occurred during an execution.
 */

#ifndef OAILambdaFunctionTimedOutEventDetails_H
#define OAILambdaFunctionTimedOutEventDetails_H
...
class OAILambdaFunctionTimedOutEventDetails : public OAIObject {
public:
    OAILambdaFunctionTimedOutEventDetails();
    OAILambdaFunctionTimedOutEventDetails(QString json);
    ~OAILambdaFunctionTimedOutEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILambdaFunctionTimedOutEventDetails)

#endif // OAILambdaFunctionTimedOutEventDetails_H
