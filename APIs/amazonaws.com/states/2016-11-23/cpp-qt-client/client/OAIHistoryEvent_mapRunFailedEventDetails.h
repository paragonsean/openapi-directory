...
/*
 * OAIHistoryEvent_mapRunFailedEventDetails.h
 *
 * 
 */

#ifndef OAIHistoryEvent_mapRunFailedEventDetails_H
#define OAIHistoryEvent_mapRunFailedEventDetails_H
...
class OAIHistoryEvent_mapRunFailedEventDetails : public OAIObject {
public:
    OAIHistoryEvent_mapRunFailedEventDetails();
    OAIHistoryEvent_mapRunFailedEventDetails(QString json);
    ~OAIHistoryEvent_mapRunFailedEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistoryEvent_mapRunFailedEventDetails)

#endif // OAIHistoryEvent_mapRunFailedEventDetails_H
