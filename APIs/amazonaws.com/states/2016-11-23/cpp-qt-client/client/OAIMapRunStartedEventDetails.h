...
/*
 * OAIMapRunStartedEventDetails.h
 *
 * Contains details about a Map Run that was started during a state machine execution.
 */

#ifndef OAIMapRunStartedEventDetails_H
#define OAIMapRunStartedEventDetails_H
...
class OAIMapRunStartedEventDetails : public OAIObject {
public:
    OAIMapRunStartedEventDetails();
    OAIMapRunStartedEventDetails(QString json);
    ~OAIMapRunStartedEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMapRunStartedEventDetails)

#endif // OAIMapRunStartedEventDetails_H
