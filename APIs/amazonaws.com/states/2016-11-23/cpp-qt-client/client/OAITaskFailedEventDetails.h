...
/*
 * OAITaskFailedEventDetails.h
 *
 * Contains details about a task failure event.
 */

#ifndef OAITaskFailedEventDetails_H
#define OAITaskFailedEventDetails_H
...
class OAITaskFailedEventDetails : public OAIObject {
public:
    OAITaskFailedEventDetails();
    OAITaskFailedEventDetails(QString json);
    ~OAITaskFailedEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskFailedEventDetails)

#endif // OAITaskFailedEventDetails_H
