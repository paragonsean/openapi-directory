...
/*
 * OAITaskTimedOutEventDetails.h
 *
 * Contains details about a resource timeout that occurred during an execution.
 */

#ifndef OAITaskTimedOutEventDetails_H
#define OAITaskTimedOutEventDetails_H
...
class OAITaskTimedOutEventDetails : public OAIObject {
public:
    OAITaskTimedOutEventDetails();
    OAITaskTimedOutEventDetails(QString json);
    ~OAITaskTimedOutEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskTimedOutEventDetails)

#endif // OAITaskTimedOutEventDetails_H
