...
/*
 * OAIExecutionSucceededEventDetails.h
 *
 * Contains details about the successful termination of the execution.
 */

#ifndef OAIExecutionSucceededEventDetails_H
#define OAIExecutionSucceededEventDetails_H
...
class OAIExecutionSucceededEventDetails : public OAIObject {
public:
    OAIExecutionSucceededEventDetails();
    OAIExecutionSucceededEventDetails(QString json);
    ~OAIExecutionSucceededEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExecutionSucceededEventDetails)

#endif // OAIExecutionSucceededEventDetails_H
