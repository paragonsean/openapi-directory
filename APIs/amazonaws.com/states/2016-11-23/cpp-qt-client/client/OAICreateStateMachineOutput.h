...
/*
 * OAICreateStateMachineOutput.h
 *
 * 
 */

#ifndef OAICreateStateMachineOutput_H
#define OAICreateStateMachineOutput_H
...
class OAICreateStateMachineOutput : public OAIObject {
public:
    OAICreateStateMachineOutput();
    OAICreateStateMachineOutput(QString json);
    ~OAICreateStateMachineOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateStateMachineOutput)

#endif // OAICreateStateMachineOutput_H
