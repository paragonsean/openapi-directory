...
/*
 * OAIDescribeMapRunInput.h
 *
 * 
 */

#ifndef OAIDescribeMapRunInput_H
#define OAIDescribeMapRunInput_H
...
class OAIDescribeMapRunInput : public OAIObject {
public:
    OAIDescribeMapRunInput();
    OAIDescribeMapRunInput(QString json);
    ~OAIDescribeMapRunInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeMapRunInput)

#endif // OAIDescribeMapRunInput_H
