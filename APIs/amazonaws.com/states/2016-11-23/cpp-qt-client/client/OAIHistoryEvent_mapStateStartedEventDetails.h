...
/*
 * OAIHistoryEvent_mapStateStartedEventDetails.h
 *
 * 
 */

#ifndef OAIHistoryEvent_mapStateStartedEventDetails_H
#define OAIHistoryEvent_mapStateStartedEventDetails_H
...
class OAIHistoryEvent_mapStateStartedEventDetails : public OAIObject {
public:
    OAIHistoryEvent_mapStateStartedEventDetails();
    OAIHistoryEvent_mapStateStartedEventDetails(QString json);
    ~OAIHistoryEvent_mapStateStartedEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistoryEvent_mapStateStartedEventDetails)

#endif // OAIHistoryEvent_mapStateStartedEventDetails_H
