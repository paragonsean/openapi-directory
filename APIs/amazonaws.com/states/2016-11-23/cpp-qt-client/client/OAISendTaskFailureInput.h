...
/*
 * OAISendTaskFailureInput.h
 *
 * 
 */

#ifndef OAISendTaskFailureInput_H
#define OAISendTaskFailureInput_H
...
class OAISendTaskFailureInput : public OAIObject {
public:
    OAISendTaskFailureInput();
    OAISendTaskFailureInput(QString json);
    ~OAISendTaskFailureInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendTaskFailureInput)

#endif // OAISendTaskFailureInput_H
