...
/*
 * OAIStopExecutionOutput.h
 *
 * 
 */

#ifndef OAIStopExecutionOutput_H
#define OAIStopExecutionOutput_H
...
class OAIStopExecutionOutput : public OAIObject {
public:
    OAIStopExecutionOutput();
    OAIStopExecutionOutput(QString json);
    ~OAIStopExecutionOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopExecutionOutput)

#endif // OAIStopExecutionOutput_H
