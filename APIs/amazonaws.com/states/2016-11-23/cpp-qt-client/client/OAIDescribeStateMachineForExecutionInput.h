...
/*
 * OAIDescribeStateMachineForExecutionInput.h
 *
 * 
 */

#ifndef OAIDescribeStateMachineForExecutionInput_H
#define OAIDescribeStateMachineForExecutionInput_H
...
class OAIDescribeStateMachineForExecutionInput : public OAIObject {
public:
    OAIDescribeStateMachineForExecutionInput();
    OAIDescribeStateMachineForExecutionInput(QString json);
    ~OAIDescribeStateMachineForExecutionInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeStateMachineForExecutionInput)

#endif // OAIDescribeStateMachineForExecutionInput_H
