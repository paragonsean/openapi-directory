...
/*
 * OAIExecutionFailedEventDetails.h
 *
 * Contains details about an execution failure event.
 */

#ifndef OAIExecutionFailedEventDetails_H
#define OAIExecutionFailedEventDetails_H
...
class OAIExecutionFailedEventDetails : public OAIObject {
public:
    OAIExecutionFailedEventDetails();
    OAIExecutionFailedEventDetails(QString json);
    ~OAIExecutionFailedEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExecutionFailedEventDetails)

#endif // OAIExecutionFailedEventDetails_H
