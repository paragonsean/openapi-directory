...
/*
 * OAIGetActivityTaskOutput.h
 *
 * 
 */

#ifndef OAIGetActivityTaskOutput_H
#define OAIGetActivityTaskOutput_H
...
class OAIGetActivityTaskOutput : public OAIObject {
public:
    OAIGetActivityTaskOutput();
    OAIGetActivityTaskOutput(QString json);
    ~OAIGetActivityTaskOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetActivityTaskOutput)

#endif // OAIGetActivityTaskOutput_H
