...
/*
 * OAIListMapRunsInput.h
 *
 * 
 */

#ifndef OAIListMapRunsInput_H
#define OAIListMapRunsInput_H
...
class OAIListMapRunsInput : public OAIObject {
public:
    OAIListMapRunsInput();
    OAIListMapRunsInput(QString json);
    ~OAIListMapRunsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListMapRunsInput)

#endif // OAIListMapRunsInput_H
