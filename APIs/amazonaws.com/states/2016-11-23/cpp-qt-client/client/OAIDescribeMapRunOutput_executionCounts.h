...
/*
 * OAIDescribeMapRunOutput_executionCounts.h
 *
 * 
 */

#ifndef OAIDescribeMapRunOutput_executionCounts_H
#define OAIDescribeMapRunOutput_executionCounts_H
...
class OAIDescribeMapRunOutput_executionCounts : public OAIObject {
public:
    OAIDescribeMapRunOutput_executionCounts();
    OAIDescribeMapRunOutput_executionCounts(QString json);
    ~OAIDescribeMapRunOutput_executionCounts() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeMapRunOutput_executionCounts)

#endif // OAIDescribeMapRunOutput_executionCounts_H
