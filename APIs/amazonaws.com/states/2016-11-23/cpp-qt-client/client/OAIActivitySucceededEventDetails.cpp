...
OAIActivitySucceededEventDetails::OAIActivitySucceededEventDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActivitySucceededEventDetails::OAIActivitySucceededEventDetails() {
    this->initializeModel();
}

OAIActivitySucceededEventDetails::~OAIActivitySucceededEventDetails() {}

void OAIActivitySucceededEventDetails::initializeModel() {
...
void OAIActivitySucceededEventDetails::fromJson(QString jsonString) {
...
void OAIActivitySucceededEventDetails::fromJsonObject(QJsonObject json) {
...
QString OAIActivitySucceededEventDetails::asJson() const {
...
QJsonObject OAIActivitySucceededEventDetails::asJsonObject() const {
    QJsonObject obj;
    if (m_output_isSet) {
...
QString OAIActivitySucceededEventDetails::getOutput() const {
    return m_output;
}
void OAIActivitySucceededEventDetails::setOutput(const QString &output) {
    m_output = output;
    m_output_isSet = true;
}

bool OAIActivitySucceededEventDetails::is_output_Set() const{
    return m_output_isSet;
}

bool OAIActivitySucceededEventDetails::is_output_Valid() const{
    return m_output_isValid;
}

OAIActivitySucceededEventDetails_outputDetails OAIActivitySucceededEventDetails::getOutputDetails() const {
    return m_output_details;
}
void OAIActivitySucceededEventDetails::setOutputDetails(const OAIActivitySucceededEventDetails_outputDetails &output_details) {
    m_output_details = output_details;
    m_output_details_isSet = true;
}

bool OAIActivitySucceededEventDetails::is_output_details_Set() const{
    return m_output_details_isSet;
}

bool OAIActivitySucceededEventDetails::is_output_details_Valid() const{
    return m_output_details_isValid;
}

bool OAIActivitySucceededEventDetails::isSet() const {
...
bool OAIActivitySucceededEventDetails::isValid() const {
