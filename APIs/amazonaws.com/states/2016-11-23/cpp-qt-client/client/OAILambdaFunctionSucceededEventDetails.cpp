...
#include "OAILambdaFunctionSucceededEventDetails.h"
...
OAILambdaFunctionSucceededEventDetails::OAILambdaFunctionSucceededEventDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILambdaFunctionSucceededEventDetails::OAILambdaFunctionSucceededEventDetails() {
    this->initializeModel();
}

OAILambdaFunctionSucceededEventDetails::~OAILambdaFunctionSucceededEventDetails() {}

void OAILambdaFunctionSucceededEventDetails::initializeModel() {
...
void OAILambdaFunctionSucceededEventDetails::fromJson(QString jsonString) {
...
void OAILambdaFunctionSucceededEventDetails::fromJsonObject(QJsonObject json) {
...
QString OAILambdaFunctionSucceededEventDetails::asJson() const {
...
QJsonObject OAILambdaFunctionSucceededEventDetails::asJsonObject() const {
    QJsonObject obj;
    if (m_output_isSet) {
...
QString OAILambdaFunctionSucceededEventDetails::getOutput() const {
    return m_output;
}
void OAILambdaFunctionSucceededEventDetails::setOutput(const QString &output) {
    m_output = output;
    m_output_isSet = true;
}

bool OAILambdaFunctionSucceededEventDetails::is_output_Set() const{
    return m_output_isSet;
}

bool OAILambdaFunctionSucceededEventDetails::is_output_Valid() const{
    return m_output_isValid;
}

OAIActivitySucceededEventDetails_outputDetails OAILambdaFunctionSucceededEventDetails::getOutputDetails() const {
    return m_output_details;
}
void OAILambdaFunctionSucceededEventDetails::setOutputDetails(const OAIActivitySucceededEventDetails_outputDetails &output_details) {
    m_output_details = output_details;
    m_output_details_isSet = true;
}

bool OAILambdaFunctionSucceededEventDetails::is_output_details_Set() const{
    return m_output_details_isSet;
}

bool OAILambdaFunctionSucceededEventDetails::is_output_details_Valid() const{
    return m_output_details_isValid;
}

bool OAILambdaFunctionSucceededEventDetails::isSet() const {
...
bool OAILambdaFunctionSucceededEventDetails::isValid() const {
