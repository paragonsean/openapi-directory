...
/*
 * OAIStateMachineType.h
 *
 * 
 */

#ifndef OAIStateMachineType_H
#define OAIStateMachineType_H
...
class OAIStateMachineType : public OAIEnum {
public:
    OAIStateMachineType();
    OAIStateMachineType(QString json);
    ~OAIStateMachineType() override;
    ...
    enum class eOAIStateMachineType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        STANDARD, 
        EXPRESS
    };
    OAIStateMachineType::eOAIStateMachineType getValue() const;
    void setValue(const OAIStateMachineType::eOAIStateMachineType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIStateMachineType)

#endif // OAIStateMachineType_H
