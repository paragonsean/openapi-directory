...
/*
 * OAIDeleteActivityInput.h
 *
 * 
 */

#ifndef OAIDeleteActivityInput_H
#define OAIDeleteActivityInput_H
...
class OAIDeleteActivityInput : public OAIObject {
public:
    OAIDeleteActivityInput();
    OAIDeleteActivityInput(QString json);
    ~OAIDeleteActivityInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteActivityInput)

#endif // OAIDeleteActivityInput_H
