...
/*
 * OAIHistoryEvent_lambdaFunctionStartFailedEventDetails.h
 *
 * 
 */

#ifndef OAIHistoryEvent_lambdaFunctionStartFailedEventDetails_H
#define OAIHistoryEvent_lambdaFunctionStartFailedEventDetails_H
...
class OAIHistoryEvent_lambdaFunctionStartFailedEventDetails : public OAIObject {
public:
    OAIHistoryEvent_lambdaFunctionStartFailedEventDetails();
    OAIHistoryEvent_lambdaFunctionStartFailedEventDetails(QString json);
    ~OAIHistoryEvent_lambdaFunctionStartFailedEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistoryEvent_lambdaFunctionStartFailedEventDetails)

#endif // OAIHistoryEvent_lambdaFunctionStartFailedEventDetails_H
