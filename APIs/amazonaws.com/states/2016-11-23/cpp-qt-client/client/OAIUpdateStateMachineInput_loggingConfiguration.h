...
/*
 * OAIUpdateStateMachineInput_loggingConfiguration.h
 *
 * 
 */

#ifndef OAIUpdateStateMachineInput_loggingConfiguration_H
#define OAIUpdateStateMachineInput_loggingConfiguration_H
...
class OAIUpdateStateMachineInput_loggingConfiguration : public OAIObject {
public:
    OAIUpdateStateMachineInput_loggingConfiguration();
    OAIUpdateStateMachineInput_loggingConfiguration(QString json);
    ~OAIUpdateStateMachineInput_loggingConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateStateMachineInput_loggingConfiguration)

#endif // OAIUpdateStateMachineInput_loggingConfiguration_H
