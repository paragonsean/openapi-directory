...
/*
 * OAIHistoryEvent_taskStartedEventDetails.h
 *
 * 
 */

#ifndef OAIHistoryEvent_taskStartedEventDetails_H
#define OAIHistoryEvent_taskStartedEventDetails_H
...
class OAIHistoryEvent_taskStartedEventDetails : public OAIObject {
public:
    OAIHistoryEvent_taskStartedEventDetails();
    OAIHistoryEvent_taskStartedEventDetails(QString json);
    ~OAIHistoryEvent_taskStartedEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistoryEvent_taskStartedEventDetails)

#endif // OAIHistoryEvent_taskStartedEventDetails_H
