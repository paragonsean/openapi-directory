...
/*
 * OAIMapRunFailedEventDetails.h
 *
 * Contains details about a Map Run failure event that occurred during a state machine execution.
 */

#ifndef OAIMapRunFailedEventDetails_H
#define OAIMapRunFailedEventDetails_H
...
class OAIMapRunFailedEventDetails : public OAIObject {
public:
    OAIMapRunFailedEventDetails();
    OAIMapRunFailedEventDetails(QString json);
    ~OAIMapRunFailedEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMapRunFailedEventDetails)

#endif // OAIMapRunFailedEventDetails_H
