...
/*
 * OAICreateActivityOutput.h
 *
 * 
 */

#ifndef OAICreateActivityOutput_H
#define OAICreateActivityOutput_H
...
class OAICreateActivityOutput : public OAIObject {
public:
    OAICreateActivityOutput();
    OAICreateActivityOutput(QString json);
    ~OAICreateActivityOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateActivityOutput)

#endif // OAICreateActivityOutput_H
