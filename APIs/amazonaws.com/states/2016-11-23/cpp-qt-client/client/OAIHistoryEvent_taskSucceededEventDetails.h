...
/*
 * OAIHistoryEvent_taskSucceededEventDetails.h
 *
 * 
 */

#ifndef OAIHistoryEvent_taskSucceededEventDetails_H
#define OAIHistoryEvent_taskSucceededEventDetails_H
...
class OAIHistoryEvent_taskSucceededEventDetails : public OAIObject {
public:
    OAIHistoryEvent_taskSucceededEventDetails();
    OAIHistoryEvent_taskSucceededEventDetails(QString json);
    ~OAIHistoryEvent_taskSucceededEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistoryEvent_taskSucceededEventDetails)

#endif // OAIHistoryEvent_taskSucceededEventDetails_H
