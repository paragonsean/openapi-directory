...
/*
 * OAIDeleteStateMachineInput.h
 *
 * 
 */

#ifndef OAIDeleteStateMachineInput_H
#define OAIDeleteStateMachineInput_H
...
class OAIDeleteStateMachineInput : public OAIObject {
public:
    OAIDeleteStateMachineInput();
    OAIDeleteStateMachineInput(QString json);
    ~OAIDeleteStateMachineInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteStateMachineInput)

#endif // OAIDeleteStateMachineInput_H
