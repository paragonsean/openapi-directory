...
/*
 * OAILambdaFunctionSucceededEventDetails.h
 *
 * Contains details about a Lambda function that successfully terminated during an execution.
 */

#ifndef OAILambdaFunctionSucceededEventDetails_H
#define OAILambdaFunctionSucceededEventDetails_H
...
class OAILambdaFunctionSucceededEventDetails : public OAIObject {
public:
    OAILambdaFunctionSucceededEventDetails();
    OAILambdaFunctionSucceededEventDetails(QString json);
    ~OAILambdaFunctionSucceededEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILambdaFunctionSucceededEventDetails)

#endif // OAILambdaFunctionSucceededEventDetails_H
