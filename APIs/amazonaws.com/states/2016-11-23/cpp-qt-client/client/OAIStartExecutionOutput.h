...
/*
 * OAIStartExecutionOutput.h
 *
 * 
 */

#ifndef OAIStartExecutionOutput_H
#define OAIStartExecutionOutput_H
...
class OAIStartExecutionOutput : public OAIObject {
public:
    OAIStartExecutionOutput();
    OAIStartExecutionOutput(QString json);
    ~OAIStartExecutionOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartExecutionOutput)

#endif // OAIStartExecutionOutput_H
