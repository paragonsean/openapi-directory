...
/*
 * OAIActivitySucceededEventDetails.h
 *
 * Contains details about an activity that successfully terminated during an execution.
 */

#ifndef OAIActivitySucceededEventDetails_H
#define OAIActivitySucceededEventDetails_H
...
class OAIActivitySucceededEventDetails : public OAIObject {
public:
    OAIActivitySucceededEventDetails();
    OAIActivitySucceededEventDetails(QString json);
    ~OAIActivitySucceededEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActivitySucceededEventDetails)

#endif // OAIActivitySucceededEventDetails_H
