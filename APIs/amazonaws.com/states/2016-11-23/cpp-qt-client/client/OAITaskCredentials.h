...
/*
 * OAITaskCredentials.h
 *
 * Contains details about the credentials that Step Functions uses for a task.
 */

#ifndef OAITaskCredentials_H
#define OAITaskCredentials_H
...
class OAITaskCredentials : public OAIObject {
public:
    OAITaskCredentials();
    OAITaskCredentials(QString json);
    ~OAITaskCredentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskCredentials)

#endif // OAITaskCredentials_H
