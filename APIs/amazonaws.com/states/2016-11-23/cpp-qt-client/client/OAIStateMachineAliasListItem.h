...
/*
 * OAIStateMachineAliasListItem.h
 *
 * Contains details about a specific state machine alias.
 */

#ifndef OAIStateMachineAliasListItem_H
#define OAIStateMachineAliasListItem_H
...
class OAIStateMachineAliasListItem : public OAIObject {
public:
    OAIStateMachineAliasListItem();
    OAIStateMachineAliasListItem(QString json);
    ~OAIStateMachineAliasListItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStateMachineAliasListItem)

#endif // OAIStateMachineAliasListItem_H
