...
/*
 * OAICreateStateMachineAliasOutput.h
 *
 * 
 */

#ifndef OAICreateStateMachineAliasOutput_H
#define OAICreateStateMachineAliasOutput_H
...
class OAICreateStateMachineAliasOutput : public OAIObject {
public:
    OAICreateStateMachineAliasOutput();
    OAICreateStateMachineAliasOutput(QString json);
    ~OAICreateStateMachineAliasOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateStateMachineAliasOutput)

#endif // OAICreateStateMachineAliasOutput_H
