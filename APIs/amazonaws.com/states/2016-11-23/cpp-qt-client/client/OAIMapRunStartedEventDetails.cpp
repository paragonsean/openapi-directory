...
#include "OAIMapRunStartedEventDetails.h"
...
OAIMapRunStartedEventDetails::OAIMapRunStartedEventDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMapRunStartedEventDetails::OAIMapRunStartedEventDetails() {
    this->initializeModel();
}

OAIMapRunStartedEventDetails::~OAIMapRunStartedEventDetails() {}

void OAIMapRunStartedEventDetails::initializeModel() {

    m_map_run_arn_isSet = false;
    m_map_run_arn_isValid = false;
}

void OAIMapRunStartedEventDetails::fromJson(QString jsonString) {
...
void OAIMapRunStartedEventDetails::fromJsonObject(QJsonObject json) {
...
QString OAIMapRunStartedEventDetails::asJson() const {
...
QJsonObject OAIMapRunStartedEventDetails::asJsonObject() const {
    QJsonObject obj;
...
QString OAIMapRunStartedEventDetails::getMapRunArn() const {
    return m_map_run_arn;
}
void OAIMapRunStartedEventDetails::setMapRunArn(const QString &map_run_arn) {
    m_map_run_arn = map_run_arn;
    m_map_run_arn_isSet = true;
}

bool OAIMapRunStartedEventDetails::is_map_run_arn_Set() const{
    return m_map_run_arn_isSet;
}

bool OAIMapRunStartedEventDetails::is_map_run_arn_Valid() const{
    return m_map_run_arn_isValid;
}

bool OAIMapRunStartedEventDetails::isSet() const {
...
bool OAIMapRunStartedEventDetails::isValid() const {
