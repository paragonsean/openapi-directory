...
/*
 * OAIListActivitiesOutput.h
 *
 * 
 */

#ifndef OAIListActivitiesOutput_H
#define OAIListActivitiesOutput_H
...
class OAIListActivitiesOutput : public OAIObject {
public:
    OAIListActivitiesOutput();
    OAIListActivitiesOutput(QString json);
    ~OAIListActivitiesOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListActivitiesOutput)

#endif // OAIListActivitiesOutput_H
