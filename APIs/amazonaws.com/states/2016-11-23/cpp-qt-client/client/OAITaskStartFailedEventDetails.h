...
/*
 * OAITaskStartFailedEventDetails.h
 *
 * Contains details about a task that failed to start during an execution.
 */

#ifndef OAITaskStartFailedEventDetails_H
#define OAITaskStartFailedEventDetails_H
...
class OAITaskStartFailedEventDetails : public OAIObject {
public:
    OAITaskStartFailedEventDetails();
    OAITaskStartFailedEventDetails(QString json);
    ~OAITaskStartFailedEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskStartFailedEventDetails)

#endif // OAITaskStartFailedEventDetails_H
