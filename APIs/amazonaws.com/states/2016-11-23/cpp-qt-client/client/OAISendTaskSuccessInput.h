...
/*
 * OAISendTaskSuccessInput.h
 *
 * 
 */

#ifndef OAISendTaskSuccessInput_H
#define OAISendTaskSuccessInput_H
...
class OAISendTaskSuccessInput : public OAIObject {
public:
    OAISendTaskSuccessInput();
    OAISendTaskSuccessInput(QString json);
    ~OAISendTaskSuccessInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendTaskSuccessInput)

#endif // OAISendTaskSuccessInput_H
