...
/*
 * OAIStopExecutionInput.h
 *
 * 
 */

#ifndef OAIStopExecutionInput_H
#define OAIStopExecutionInput_H
...
class OAIStopExecutionInput : public OAIObject {
public:
    OAIStopExecutionInput();
    OAIStopExecutionInput(QString json);
    ~OAIStopExecutionInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopExecutionInput)

#endif // OAIStopExecutionInput_H
