...
/*
 * OAILambdaFunctionStartFailedEventDetails.h
 *
 * Contains details about a lambda function that failed to start during an execution.
 */

#ifndef OAILambdaFunctionStartFailedEventDetails_H
#define OAILambdaFunctionStartFailedEventDetails_H
...
class OAILambdaFunctionStartFailedEventDetails : public OAIObject {
public:
    OAILambdaFunctionStartFailedEventDetails();
    OAILambdaFunctionStartFailedEventDetails(QString json);
    ~OAILambdaFunctionStartFailedEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILambdaFunctionStartFailedEventDetails)

#endif // OAILambdaFunctionStartFailedEventDetails_H
