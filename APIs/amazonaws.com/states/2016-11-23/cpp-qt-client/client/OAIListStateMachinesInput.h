...
/*
 * OAIListStateMachinesInput.h
 *
 * 
 */

#ifndef OAIListStateMachinesInput_H
#define OAIListStateMachinesInput_H
...
class OAIListStateMachinesInput : public OAIObject {
public:
    OAIListStateMachinesInput();
    OAIListStateMachinesInput(QString json);
    ~OAIListStateMachinesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListStateMachinesInput)

#endif // OAIListStateMachinesInput_H
