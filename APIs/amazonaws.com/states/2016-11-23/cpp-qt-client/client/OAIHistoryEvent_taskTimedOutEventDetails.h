...
/*
 * OAIHistoryEvent_taskTimedOutEventDetails.h
 *
 * 
 */

#ifndef OAIHistoryEvent_taskTimedOutEventDetails_H
#define OAIHistoryEvent_taskTimedOutEventDetails_H
...
class OAIHistoryEvent_taskTimedOutEventDetails : public OAIObject {
public:
    OAIHistoryEvent_taskTimedOutEventDetails();
    OAIHistoryEvent_taskTimedOutEventDetails(QString json);
    ~OAIHistoryEvent_taskTimedOutEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistoryEvent_taskTimedOutEventDetails)

#endif // OAIHistoryEvent_taskTimedOutEventDetails_H
