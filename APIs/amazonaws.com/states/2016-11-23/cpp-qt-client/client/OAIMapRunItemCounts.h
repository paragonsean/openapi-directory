...
/*
 * OAIMapRunItemCounts.h
 *
 * Contains details about items that were processed in all of the child workflow executions that were started by a Map Run.
 */

#ifndef OAIMapRunItemCounts_H
#define OAIMapRunItemCounts_H
...
class OAIMapRunItemCounts : public OAIObject {
public:
    OAIMapRunItemCounts();
    OAIMapRunItemCounts(QString json);
    ~OAIMapRunItemCounts() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMapRunItemCounts)

#endif // OAIMapRunItemCounts_H
