...
#ifndef OAIMapRunListItem_H
#define OAIMapRunListItem_H
...
class OAIMapRunListItem : public OAIObject {
public:
    OAIMapRunListItem();
    OAIMapRunListItem(QString json);
    ~OAIMapRunListItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMapRunListItem)

#endif // OAIMapRunListItem_H
