...
OAICreateStateMachineAliasOutput::OAICreateStateMachineAliasOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateStateMachineAliasOutput::OAICreateStateMachineAliasOutput() {
    this->initializeModel();
}

OAICreateStateMachineAliasOutput::~OAICreateStateMachineAliasOutput() {}

void OAICreateStateMachineAliasOutput::initializeModel() {
...
void OAICreateStateMachineAliasOutput::fromJson(QString jsonString) {
...
void OAICreateStateMachineAliasOutput::fromJsonObject(QJsonObject json) {
...
QString OAICreateStateMachineAliasOutput::asJson() const {
...
QJsonObject OAICreateStateMachineAliasOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateStateMachineAliasOutput::getStateMachineAliasArn() const {
    return m_state_machine_alias_arn;
}
void OAICreateStateMachineAliasOutput::setStateMachineAliasArn(const QString &state_machine_alias_arn) {
    m_state_machine_alias_arn = state_machine_alias_arn;
    m_state_machine_alias_arn_isSet = true;
}

bool OAICreateStateMachineAliasOutput::is_state_machine_alias_arn_Set() const{
    return m_state_machine_alias_arn_isSet;
}

bool OAICreateStateMachineAliasOutput::is_state_machine_alias_arn_Valid() const{
    return m_state_machine_alias_arn_isValid;
}

QDateTime OAICreateStateMachineAliasOutput::getCreationDate() const {
    return m_creation_date;
}
void OAICreateStateMachineAliasOutput::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAICreateStateMachineAliasOutput::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAICreateStateMachineAliasOutput::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

bool OAICreateStateMachineAliasOutput::isSet() const {
...
bool OAICreateStateMachineAliasOutput::isValid() const {
