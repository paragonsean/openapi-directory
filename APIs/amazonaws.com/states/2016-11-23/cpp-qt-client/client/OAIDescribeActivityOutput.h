...
/*
 * OAIDescribeActivityOutput.h
 *
 * 
 */

#ifndef OAIDescribeActivityOutput_H
#define OAIDescribeActivityOutput_H
...
class OAIDescribeActivityOutput : public OAIObject {
public:
    OAIDescribeActivityOutput();
    OAIDescribeActivityOutput(QString json);
    ~OAIDescribeActivityOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeActivityOutput)

#endif // OAIDescribeActivityOutput_H
