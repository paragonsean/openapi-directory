...
/*
 * OAIDescribeStateMachineInput.h
 *
 * 
 */

#ifndef OAIDescribeStateMachineInput_H
#define OAIDescribeStateMachineInput_H
...
class OAIDescribeStateMachineInput : public OAIObject {
public:
    OAIDescribeStateMachineInput();
    OAIDescribeStateMachineInput(QString json);
    ~OAIDescribeStateMachineInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeStateMachineInput)

#endif // OAIDescribeStateMachineInput_H
