...
OAIMapRunItemCounts::OAIMapRunItemCounts(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMapRunItemCounts::OAIMapRunItemCounts() {
    this->initializeModel();
}

OAIMapRunItemCounts::~OAIMapRunItemCounts() {}

void OAIMapRunItemCounts::initializeModel() {
...
void OAIMapRunItemCounts::fromJson(QString jsonString) {
...
void OAIMapRunItemCounts::fromJsonObject(QJsonObject json) {
...
QString OAIMapRunItemCounts::asJson() const {
...
QJsonObject OAIMapRunItemCounts::asJsonObject() const {
    QJsonObject obj;
    if (m_pending_isSet) {
...
qint32 OAIMapRunItemCounts::getPending() const {
    return m_pending;
}
void OAIMapRunItemCounts::setPending(const qint32 &pending) {
    m_pending = pending;
    m_pending_isSet = true;
}

bool OAIMapRunItemCounts::is_pending_Set() const{
    return m_pending_isSet;
}

bool OAIMapRunItemCounts::is_pending_Valid() const{
    return m_pending_isValid;
}

qint32 OAIMapRunItemCounts::getRunning() const {
    return m_running;
}
void OAIMapRunItemCounts::setRunning(const qint32 &running) {
    m_running = running;
    m_running_isSet = true;
}

bool OAIMapRunItemCounts::is_running_Set() const{
    return m_running_isSet;
}

bool OAIMapRunItemCounts::is_running_Valid() const{
    return m_running_isValid;
}

qint32 OAIMapRunItemCounts::getSucceeded() const {
    return m_succeeded;
}
void OAIMapRunItemCounts::setSucceeded(const qint32 &succeeded) {
    m_succeeded = succeeded;
    m_succeeded_isSet = true;
}

bool OAIMapRunItemCounts::is_succeeded_Set() const{
    return m_succeeded_isSet;
}

bool OAIMapRunItemCounts::is_succeeded_Valid() const{
    return m_succeeded_isValid;
}

qint32 OAIMapRunItemCounts::getFailed() const {
    return m_failed;
}
void OAIMapRunItemCounts::setFailed(const qint32 &failed) {
    m_failed = failed;
    m_failed_isSet = true;
}

bool OAIMapRunItemCounts::is_failed_Set() const{
    return m_failed_isSet;
}

bool OAIMapRunItemCounts::is_failed_Valid() const{
    return m_failed_isValid;
}

qint32 OAIMapRunItemCounts::getTimedOut() const {
    return m_timed_out;
}
void OAIMapRunItemCounts::setTimedOut(const qint32 &timed_out) {
    m_timed_out = timed_out;
    m_timed_out_isSet = true;
}

bool OAIMapRunItemCounts::is_timed_out_Set() const{
    return m_timed_out_isSet;
}

bool OAIMapRunItemCounts::is_timed_out_Valid() const{
    return m_timed_out_isValid;
}

qint32 OAIMapRunItemCounts::getAborted() const {
    return m_aborted;
}
void OAIMapRunItemCounts::setAborted(const qint32 &aborted) {
    m_aborted = aborted;
    m_aborted_isSet = true;
}

bool OAIMapRunItemCounts::is_aborted_Set() const{
    return m_aborted_isSet;
}

bool OAIMapRunItemCounts::is_aborted_Valid() const{
    return m_aborted_isValid;
}

qint32 OAIMapRunItemCounts::getTotal() const {
    return m_total;
}
void OAIMapRunItemCounts::setTotal(const qint32 &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAIMapRunItemCounts::is_total_Set() const{
    return m_total_isSet;
}

bool OAIMapRunItemCounts::is_total_Valid() const{
    return m_total_isValid;
}

qint32 OAIMapRunItemCounts::getResultsWritten() const {
    return m_results_written;
}
void OAIMapRunItemCounts::setResultsWritten(const qint32 &results_written) {
    m_results_written = results_written;
    m_results_written_isSet = true;
}

bool OAIMapRunItemCounts::is_results_written_Set() const{
    return m_results_written_isSet;
}

bool OAIMapRunItemCounts::is_results_written_Valid() const{
    return m_results_written_isValid;
}

bool OAIMapRunItemCounts::isSet() const {
...
bool OAIMapRunItemCounts::isValid() const {
