...
#include "OAIHistoryEventExecutionDataDetails.h"
...
OAIHistoryEventExecutionDataDetails::OAIHistoryEventExecutionDataDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHistoryEventExecutionDataDetails::OAIHistoryEventExecutionDataDetails() {
    this->initializeModel();
}

OAIHistoryEventExecutionDataDetails::~OAIHistoryEventExecutionDataDetails() {}

void OAIHistoryEventExecutionDataDetails::initializeModel() {

    m_truncated_isSet = false;
    m_truncated_isValid = false;
}

void OAIHistoryEventExecutionDataDetails::fromJson(QString jsonString) {
...
void OAIHistoryEventExecutionDataDetails::fromJsonObject(QJsonObject json) {
...
QString OAIHistoryEventExecutionDataDetails::asJson() const {
...
QJsonObject OAIHistoryEventExecutionDataDetails::asJsonObject() const {
    QJsonObject obj;
...
bool OAIHistoryEventExecutionDataDetails::getTruncated() const {
    return m_truncated;
}
void OAIHistoryEventExecutionDataDetails::setTruncated(const bool &truncated) {
    m_truncated = truncated;
    m_truncated_isSet = true;
}

bool OAIHistoryEventExecutionDataDetails::is_truncated_Set() const{
    return m_truncated_isSet;
}

bool OAIHistoryEventExecutionDataDetails::is_truncated_Valid() const{
    return m_truncated_isValid;
}

bool OAIHistoryEventExecutionDataDetails::isSet() const {
...
bool OAIHistoryEventExecutionDataDetails::isValid() const {
