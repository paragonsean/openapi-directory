...
OAIDescribeMapRunInput::OAIDescribeMapRunInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeMapRunInput::OAIDescribeMapRunInput() {
    this->initializeModel();
}

OAIDescribeMapRunInput::~OAIDescribeMapRunInput() {}

void OAIDescribeMapRunInput::initializeModel() {

    m_map_run_arn_isSet = false;
    m_map_run_arn_isValid = false;
}

void OAIDescribeMapRunInput::fromJson(QString jsonString) {
...
void OAIDescribeMapRunInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeMapRunInput::asJson() const {
...
QJsonObject OAIDescribeMapRunInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeMapRunInput::getMapRunArn() const {
    return m_map_run_arn;
}
void OAIDescribeMapRunInput::setMapRunArn(const QString &map_run_arn) {
    m_map_run_arn = map_run_arn;
    m_map_run_arn_isSet = true;
}

bool OAIDescribeMapRunInput::is_map_run_arn_Set() const{
    return m_map_run_arn_isSet;
}

bool OAIDescribeMapRunInput::is_map_run_arn_Valid() const{
    return m_map_run_arn_isValid;
}

bool OAIDescribeMapRunInput::isSet() const {
...
bool OAIDescribeMapRunInput::isValid() const {
