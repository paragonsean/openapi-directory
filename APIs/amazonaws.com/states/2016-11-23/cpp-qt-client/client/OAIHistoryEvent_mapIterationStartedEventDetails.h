...
/*
 * OAIHistoryEvent_mapIterationStartedEventDetails.h
 *
 * 
 */

#ifndef OAIHistoryEvent_mapIterationStartedEventDetails_H
#define OAIHistoryEvent_mapIterationStartedEventDetails_H
...
class OAIHistoryEvent_mapIterationStartedEventDetails : public OAIObject {
public:
    OAIHistoryEvent_mapIterationStartedEventDetails();
    OAIHistoryEvent_mapIterationStartedEventDetails(QString json);
    ~OAIHistoryEvent_mapIterationStartedEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistoryEvent_mapIterationStartedEventDetails)

#endif // OAIHistoryEvent_mapIterationStartedEventDetails_H
