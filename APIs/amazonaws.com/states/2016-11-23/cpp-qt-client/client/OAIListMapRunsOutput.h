...
/*
 * OAIListMapRunsOutput.h
 *
 * 
 */

#ifndef OAIListMapRunsOutput_H
#define OAIListMapRunsOutput_H
...
class OAIListMapRunsOutput : public OAIObject {
public:
    OAIListMapRunsOutput();
    OAIListMapRunsOutput(QString json);
    ~OAIListMapRunsOutput() override;
    ...
    QList getMapRuns() const;
    void setMapRuns(const QList &map_runs);
    bool is_map_runs_Set() const;
    bool is_map_runs_Valid() const;
...
private:
    ...
    QList m_map_runs;
    bool m_map_runs_isSet;
    bool m_map_runs_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListMapRunsOutput)

#endif // OAIListMapRunsOutput_H
