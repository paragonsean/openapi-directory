...
/*
 * OAIHistoryEvent_lambdaFunctionSucceededEventDetails.h
 *
 * 
 */

#ifndef OAIHistoryEvent_lambdaFunctionSucceededEventDetails_H
#define OAIHistoryEvent_lambdaFunctionSucceededEventDetails_H
...
class OAIHistoryEvent_lambdaFunctionSucceededEventDetails : public OAIObject {
public:
    OAIHistoryEvent_lambdaFunctionSucceededEventDetails();
    OAIHistoryEvent_lambdaFunctionSucceededEventDetails(QString json);
    ~OAIHistoryEvent_lambdaFunctionSucceededEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistoryEvent_lambdaFunctionSucceededEventDetails)

#endif // OAIHistoryEvent_lambdaFunctionSucceededEventDetails_H
