...
/*
 * OAIDescribeExecutionInput.h
 *
 * 
 */

#ifndef OAIDescribeExecutionInput_H
#define OAIDescribeExecutionInput_H
...
class OAIDescribeExecutionInput : public OAIObject {
public:
    OAIDescribeExecutionInput();
    OAIDescribeExecutionInput(QString json);
    ~OAIDescribeExecutionInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeExecutionInput)

#endif // OAIDescribeExecutionInput_H
