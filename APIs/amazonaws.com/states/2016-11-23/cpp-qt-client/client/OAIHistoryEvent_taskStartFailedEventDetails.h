...
/*
 * OAIHistoryEvent_taskStartFailedEventDetails.h
 *
 * 
 */

#ifndef OAIHistoryEvent_taskStartFailedEventDetails_H
#define OAIHistoryEvent_taskStartFailedEventDetails_H
...
class OAIHistoryEvent_taskStartFailedEventDetails : public OAIObject {
public:
    OAIHistoryEvent_taskStartFailedEventDetails();
    OAIHistoryEvent_taskStartFailedEventDetails(QString json);
    ~OAIHistoryEvent_taskStartFailedEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistoryEvent_taskStartFailedEventDetails)

#endif // OAIHistoryEvent_taskStartFailedEventDetails_H
