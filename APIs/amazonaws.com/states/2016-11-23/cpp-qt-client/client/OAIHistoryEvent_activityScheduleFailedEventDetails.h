...
/*
 * OAIHistoryEvent_activityScheduleFailedEventDetails.h
 *
 * 
 */

#ifndef OAIHistoryEvent_activityScheduleFailedEventDetails_H
#define OAIHistoryEvent_activityScheduleFailedEventDetails_H
...
class OAIHistoryEvent_activityScheduleFailedEventDetails : public OAIObject {
public:
    OAIHistoryEvent_activityScheduleFailedEventDetails();
    OAIHistoryEvent_activityScheduleFailedEventDetails(QString json);
    ~OAIHistoryEvent_activityScheduleFailedEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistoryEvent_activityScheduleFailedEventDetails)

#endif // OAIHistoryEvent_activityScheduleFailedEventDetails_H
