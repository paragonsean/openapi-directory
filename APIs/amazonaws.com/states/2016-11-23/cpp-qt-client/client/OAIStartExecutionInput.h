...
/*
 * OAIStartExecutionInput.h
 *
 * 
 */

#ifndef OAIStartExecutionInput_H
#define OAIStartExecutionInput_H
...
class OAIStartExecutionInput : public OAIObject {
public:
    OAIStartExecutionInput();
    OAIStartExecutionInput(QString json);
    ~OAIStartExecutionInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartExecutionInput)

#endif // OAIStartExecutionInput_H
