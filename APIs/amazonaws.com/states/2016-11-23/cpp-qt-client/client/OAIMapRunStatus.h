...
#ifndef OAIMapRunStatus_H
#define OAIMapRunStatus_H
...
class OAIMapRunStatus : public OAIEnum {
public:
    OAIMapRunStatus();
    OAIMapRunStatus(QString json);
    ~OAIMapRunStatus() override;
    ...
    OAIMapRunStatus::eOAIMapRunStatus getValue() const;
    void setValue(const OAIMapRunStatus::eOAIMapRunStatus& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIMapRunStatus)

#endif // OAIMapRunStatus_H
