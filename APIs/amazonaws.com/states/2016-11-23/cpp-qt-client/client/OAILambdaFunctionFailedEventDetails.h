...
/*
 * OAILambdaFunctionFailedEventDetails.h
 *
 * Contains details about a Lambda function that failed during an execution.
 */

#ifndef OAILambdaFunctionFailedEventDetails_H
#define OAILambdaFunctionFailedEventDetails_H
...
class OAILambdaFunctionFailedEventDetails : public OAIObject {
public:
    OAILambdaFunctionFailedEventDetails();
    OAILambdaFunctionFailedEventDetails(QString json);
    ~OAILambdaFunctionFailedEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILambdaFunctionFailedEventDetails)

#endif // OAILambdaFunctionFailedEventDetails_H
