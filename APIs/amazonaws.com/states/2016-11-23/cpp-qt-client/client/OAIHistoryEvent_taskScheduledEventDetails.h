...
/*
 * OAIHistoryEvent_taskScheduledEventDetails.h
 *
 * 
 */

#ifndef OAIHistoryEvent_taskScheduledEventDetails_H
#define OAIHistoryEvent_taskScheduledEventDetails_H
...
class OAIHistoryEvent_taskScheduledEventDetails : public OAIObject {
public:
    OAIHistoryEvent_taskScheduledEventDetails();
    OAIHistoryEvent_taskScheduledEventDetails(QString json);
    ~OAIHistoryEvent_taskScheduledEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistoryEvent_taskScheduledEventDetails)

#endif // OAIHistoryEvent_taskScheduledEventDetails_H
