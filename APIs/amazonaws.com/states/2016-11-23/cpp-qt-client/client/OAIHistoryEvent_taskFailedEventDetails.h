...
/*
 * OAIHistoryEvent_taskFailedEventDetails.h
 *
 * 
 */

#ifndef OAIHistoryEvent_taskFailedEventDetails_H
#define OAIHistoryEvent_taskFailedEventDetails_H
...
class OAIHistoryEvent_taskFailedEventDetails : public OAIObject {
public:
    OAIHistoryEvent_taskFailedEventDetails();
    OAIHistoryEvent_taskFailedEventDetails(QString json);
    ~OAIHistoryEvent_taskFailedEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistoryEvent_taskFailedEventDetails)

#endif // OAIHistoryEvent_taskFailedEventDetails_H
