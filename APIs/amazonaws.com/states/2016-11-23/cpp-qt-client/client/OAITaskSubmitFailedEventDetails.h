...
/*
 * OAITaskSubmitFailedEventDetails.h
 *
 * Contains details about a task that failed to submit during an execution.
 */

#ifndef OAITaskSubmitFailedEventDetails_H
#define OAITaskSubmitFailedEventDetails_H
...
class OAITaskSubmitFailedEventDetails : public OAIObject {
public:
    OAITaskSubmitFailedEventDetails();
    OAITaskSubmitFailedEventDetails(QString json);
    ~OAITaskSubmitFailedEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskSubmitFailedEventDetails)

#endif // OAITaskSubmitFailedEventDetails_H
