...
/*
 * OAIListStateMachineAliasesInput.h
 *
 * 
 */

#ifndef OAIListStateMachineAliasesInput_H
#define OAIListStateMachineAliasesInput_H
...
class OAIListStateMachineAliasesInput : public OAIObject {
public:
    OAIListStateMachineAliasesInput();
    OAIListStateMachineAliasesInput(QString json);
    ~OAIListStateMachineAliasesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListStateMachineAliasesInput)

#endif // OAIListStateMachineAliasesInput_H
