...
/*
 * OAIGetExecutionHistoryOutput.h
 *
 * 
 */

#ifndef OAIGetExecutionHistoryOutput_H
#define OAIGetExecutionHistoryOutput_H
...
class OAIGetExecutionHistoryOutput : public OAIObject {
public:
    OAIGetExecutionHistoryOutput();
    OAIGetExecutionHistoryOutput(QString json);
    ~OAIGetExecutionHistoryOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetExecutionHistoryOutput)

#endif // OAIGetExecutionHistoryOutput_H
