...
/*
 * OAILambdaFunctionScheduleFailedEventDetails.h
 *
 * Contains details about a failed Lambda function schedule event that occurred during an execution.
 */

#ifndef OAILambdaFunctionScheduleFailedEventDetails_H
#define OAILambdaFunctionScheduleFailedEventDetails_H
...
class OAILambdaFunctionScheduleFailedEventDetails : public OAIObject {
public:
    OAILambdaFunctionScheduleFailedEventDetails();
    OAILambdaFunctionScheduleFailedEventDetails(QString json);
    ~OAILambdaFunctionScheduleFailedEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILambdaFunctionScheduleFailedEventDetails)

#endif // OAILambdaFunctionScheduleFailedEventDetails_H
