...
/*
 * OAIStateMachineListItem.h
 *
 * Contains details about the state machine.
 */

#ifndef OAIStateMachineListItem_H
#define OAIStateMachineListItem_H
...
class OAIStateMachineListItem : public OAIObject {
public:
    OAIStateMachineListItem();
    OAIStateMachineListItem(QString json);
    ~OAIStateMachineListItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStateMachineListItem)

#endif // OAIStateMachineListItem_H
