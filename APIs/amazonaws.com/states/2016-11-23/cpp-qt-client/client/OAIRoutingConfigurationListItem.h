...
/*
 * OAIRoutingConfigurationListItem.h
 *
 * Contains details about the routing configuration of a state machine alias. In a routing configuration, you define an array of objects that specify up to two state machine versions. You also specify the percentage of traffic to be routed to each version.
 */

#ifndef OAIRoutingConfigurationListItem_H
#define OAIRoutingConfigurationListItem_H
...
class OAIRoutingConfigurationListItem : public OAIObject {
public:
    OAIRoutingConfigurationListItem();
    OAIRoutingConfigurationListItem(QString json);
    ~OAIRoutingConfigurationListItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRoutingConfigurationListItem)

#endif // OAIRoutingConfigurationListItem_H
