...
/*
 * OAIExecutionTimedOutEventDetails.h
 *
 * Contains details about the execution timeout that occurred during the execution.
 */

#ifndef OAIExecutionTimedOutEventDetails_H
#define OAIExecutionTimedOutEventDetails_H
...
class OAIExecutionTimedOutEventDetails : public OAIObject {
public:
    OAIExecutionTimedOutEventDetails();
    OAIExecutionTimedOutEventDetails(QString json);
    ~OAIExecutionTimedOutEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExecutionTimedOutEventDetails)

#endif // OAIExecutionTimedOutEventDetails_H
