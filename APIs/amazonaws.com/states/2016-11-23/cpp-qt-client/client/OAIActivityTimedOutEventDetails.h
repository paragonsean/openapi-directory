...
/*
 * OAIActivityTimedOutEventDetails.h
 *
 * Contains details about an activity timeout that occurred during an execution.
 */

#ifndef OAIActivityTimedOutEventDetails_H
#define OAIActivityTimedOutEventDetails_H
...
class OAIActivityTimedOutEventDetails : public OAIObject {
public:
    OAIActivityTimedOutEventDetails();
    OAIActivityTimedOutEventDetails(QString json);
    ~OAIActivityTimedOutEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActivityTimedOutEventDetails)

#endif // OAIActivityTimedOutEventDetails_H
