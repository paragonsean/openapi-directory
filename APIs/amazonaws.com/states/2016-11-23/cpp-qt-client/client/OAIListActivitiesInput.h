...
/*
 * OAIListActivitiesInput.h
 *
 * 
 */

#ifndef OAIListActivitiesInput_H
#define OAIListActivitiesInput_H
...
class OAIListActivitiesInput : public OAIObject {
public:
    OAIListActivitiesInput();
    OAIListActivitiesInput(QString json);
    ~OAIListActivitiesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListActivitiesInput)

#endif // OAIListActivitiesInput_H
