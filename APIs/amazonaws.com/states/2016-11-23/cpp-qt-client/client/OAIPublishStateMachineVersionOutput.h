...
/*
 * OAIPublishStateMachineVersionOutput.h
 *
 * 
 */

#ifndef OAIPublishStateMachineVersionOutput_H
#define OAIPublishStateMachineVersionOutput_H
...
class OAIPublishStateMachineVersionOutput : public OAIObject {
public:
    OAIPublishStateMachineVersionOutput();
    OAIPublishStateMachineVersionOutput(QString json);
    ~OAIPublishStateMachineVersionOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPublishStateMachineVersionOutput)

#endif // OAIPublishStateMachineVersionOutput_H
