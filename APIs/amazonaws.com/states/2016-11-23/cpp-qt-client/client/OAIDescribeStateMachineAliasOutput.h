...
/*
 * OAIDescribeStateMachineAliasOutput.h
 *
 * 
 */

#ifndef OAIDescribeStateMachineAliasOutput_H
#define OAIDescribeStateMachineAliasOutput_H
...
class OAIDescribeStateMachineAliasOutput : public OAIObject {
public:
    OAIDescribeStateMachineAliasOutput();
    OAIDescribeStateMachineAliasOutput(QString json);
    ~OAIDescribeStateMachineAliasOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeStateMachineAliasOutput)

#endif // OAIDescribeStateMachineAliasOutput_H
