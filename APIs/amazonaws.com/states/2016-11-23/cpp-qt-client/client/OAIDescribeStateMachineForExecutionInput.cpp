...
OAIDescribeStateMachineForExecutionInput::OAIDescribeStateMachineForExecutionInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeStateMachineForExecutionInput::OAIDescribeStateMachineForExecutionInput() {
    this->initializeModel();
}

OAIDescribeStateMachineForExecutionInput::~OAIDescribeStateMachineForExecutionInput() {}

void OAIDescribeStateMachineForExecutionInput::initializeModel() {

    m_execution_arn_isSet = false;
    m_execution_arn_isValid = false;
}

void OAIDescribeStateMachineForExecutionInput::fromJson(QString jsonString) {
...
void OAIDescribeStateMachineForExecutionInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeStateMachineForExecutionInput::asJson() const {
...
QJsonObject OAIDescribeStateMachineForExecutionInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeStateMachineForExecutionInput::getExecutionArn() const {
    return m_execution_arn;
}
void OAIDescribeStateMachineForExecutionInput::setExecutionArn(const QString &execution_arn) {
    m_execution_arn = execution_arn;
    m_execution_arn_isSet = true;
}

bool OAIDescribeStateMachineForExecutionInput::is_execution_arn_Set() const{
    return m_execution_arn_isSet;
}

bool OAIDescribeStateMachineForExecutionInput::is_execution_arn_Valid() const{
    return m_execution_arn_isValid;
}

bool OAIDescribeStateMachineForExecutionInput::isSet() const {
...
bool OAIDescribeStateMachineForExecutionInput::isValid() const {
