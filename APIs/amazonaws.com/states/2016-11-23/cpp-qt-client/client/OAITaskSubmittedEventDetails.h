...
/*
 * OAITaskSubmittedEventDetails.h
 *
 * Contains details about a task submitted to a resource .
 */

#ifndef OAITaskSubmittedEventDetails_H
#define OAITaskSubmittedEventDetails_H
...
class OAITaskSubmittedEventDetails : public OAIObject {
public:
    OAITaskSubmittedEventDetails();
    OAITaskSubmittedEventDetails(QString json);
    ~OAITaskSubmittedEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskSubmittedEventDetails)

#endif // OAITaskSubmittedEventDetails_H
