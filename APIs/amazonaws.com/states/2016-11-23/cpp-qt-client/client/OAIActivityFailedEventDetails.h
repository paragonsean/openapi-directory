...
/*
 * OAIActivityFailedEventDetails.h
 *
 * Contains details about an activity that failed during an execution.
 */

#ifndef OAIActivityFailedEventDetails_H
#define OAIActivityFailedEventDetails_H
...
class OAIActivityFailedEventDetails : public OAIObject {
public:
    OAIActivityFailedEventDetails();
    OAIActivityFailedEventDetails(QString json);
    ~OAIActivityFailedEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActivityFailedEventDetails)

#endif // OAIActivityFailedEventDetails_H
