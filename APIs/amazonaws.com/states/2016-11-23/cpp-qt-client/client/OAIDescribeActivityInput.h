...
/*
 * OAIDescribeActivityInput.h
 *
 * 
 */

#ifndef OAIDescribeActivityInput_H
#define OAIDescribeActivityInput_H
...
class OAIDescribeActivityInput : public OAIObject {
public:
    OAIDescribeActivityInput();
    OAIDescribeActivityInput(QString json);
    ~OAIDescribeActivityInput() override;
    ...
    QString getActivityArn() const;
    void setActivityArn(const QString &activity_arn);
    bool is_activity_arn_Set() const;
    bool is_activity_arn_Valid() const;
...
private:
    ...
    QString m_activity_arn;
    bool m_activity_arn_isSet;
    bool m_activity_arn_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeActivityInput)

#endif // OAIDescribeActivityInput_H
