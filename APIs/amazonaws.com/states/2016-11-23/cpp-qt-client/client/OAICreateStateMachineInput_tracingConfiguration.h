...
/*
 * OAICreateStateMachineInput_tracingConfiguration.h
 *
 * 
 */

#ifndef OAICreateStateMachineInput_tracingConfiguration_H
#define OAICreateStateMachineInput_tracingConfiguration_H
...
class OAICreateStateMachineInput_tracingConfiguration : public OAIObject {
public:
    OAICreateStateMachineInput_tracingConfiguration();
    OAICreateStateMachineInput_tracingConfiguration(QString json);
    ~OAICreateStateMachineInput_tracingConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateStateMachineInput_tracingConfiguration)

#endif // OAICreateStateMachineInput_tracingConfiguration_H
