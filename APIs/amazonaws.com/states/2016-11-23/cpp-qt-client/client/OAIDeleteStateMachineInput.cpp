...
OAIDeleteStateMachineInput::OAIDeleteStateMachineInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteStateMachineInput::OAIDeleteStateMachineInput() {
    this->initializeModel();
}

OAIDeleteStateMachineInput::~OAIDeleteStateMachineInput() {}

void OAIDeleteStateMachineInput::initializeModel() {

    m_state_machine_arn_isSet = false;
    m_state_machine_arn_isValid = false;
}

void OAIDeleteStateMachineInput::fromJson(QString jsonString) {
...
void OAIDeleteStateMachineInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteStateMachineInput::asJson() const {
...
QJsonObject OAIDeleteStateMachineInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteStateMachineInput::getStateMachineArn() const {
    return m_state_machine_arn;
}
void OAIDeleteStateMachineInput::setStateMachineArn(const QString &state_machine_arn) {
    m_state_machine_arn = state_machine_arn;
    m_state_machine_arn_isSet = true;
}

bool OAIDeleteStateMachineInput::is_state_machine_arn_Set() const{
    return m_state_machine_arn_isSet;
}

bool OAIDeleteStateMachineInput::is_state_machine_arn_Valid() const{
    return m_state_machine_arn_isValid;
}

bool OAIDeleteStateMachineInput::isSet() const {
...
bool OAIDeleteStateMachineInput::isValid() const {
