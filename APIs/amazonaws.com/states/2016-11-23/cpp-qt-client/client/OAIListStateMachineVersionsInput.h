...
/*
 * OAIListStateMachineVersionsInput.h
 *
 * 
 */

#ifndef OAIListStateMachineVersionsInput_H
#define OAIListStateMachineVersionsInput_H
...
class OAIListStateMachineVersionsInput : public OAIObject {
public:
    OAIListStateMachineVersionsInput();
    OAIListStateMachineVersionsInput(QString json);
    ~OAIListStateMachineVersionsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListStateMachineVersionsInput)

#endif // OAIListStateMachineVersionsInput_H
