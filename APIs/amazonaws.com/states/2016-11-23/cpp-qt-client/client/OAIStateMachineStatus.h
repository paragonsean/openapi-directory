...
/*
 * OAIStateMachineStatus.h
 *
 * 
 */

#ifndef OAIStateMachineStatus_H
#define OAIStateMachineStatus_H
...
class OAIStateMachineStatus : public OAIEnum {
public:
    OAIStateMachineStatus();
    OAIStateMachineStatus(QString json);
    ~OAIStateMachineStatus() override;
    ...
    enum class eOAIStateMachineStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ACTIVE, 
        DELETING
    };
    OAIStateMachineStatus::eOAIStateMachineStatus getValue() const;
    void setValue(const OAIStateMachineStatus::eOAIStateMachineStatus& value);
...
private:
    ...
    eOAIStateMachineStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStateMachineStatus)

#endif // OAIStateMachineStatus_H
