...
/*
 * OAISyncExecutionStatus.h
 *
 * 
 */

#ifndef OAISyncExecutionStatus_H
#define OAISyncExecutionStatus_H
...
class OAISyncExecutionStatus : public OAIEnum {
public:
    OAISyncExecutionStatus();
    OAISyncExecutionStatus(QString json);
    ~OAISyncExecutionStatus() override;
    ...
    enum class eOAISyncExecutionStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        SUCCEEDED, 
        FAILED, 
        TIMED_OUT
    };
    OAISyncExecutionStatus::eOAISyncExecutionStatus getValue() const;
    void setValue(const OAISyncExecutionStatus::eOAISyncExecutionStatus& value);
...
private:
    ...
    eOAISyncExecutionStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAISyncExecutionStatus)

#endif // OAISyncExecutionStatus_H
