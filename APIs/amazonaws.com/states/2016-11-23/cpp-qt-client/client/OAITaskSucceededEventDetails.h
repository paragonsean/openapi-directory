...
/*
 * OAITaskSucceededEventDetails.h
 *
 * Contains details about the successful completion of a task state.
 */

#ifndef OAITaskSucceededEventDetails_H
#define OAITaskSucceededEventDetails_H
...
class OAITaskSucceededEventDetails : public OAIObject {
public:
    OAITaskSucceededEventDetails();
    OAITaskSucceededEventDetails(QString json);
    ~OAITaskSucceededEventDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskSucceededEventDetails)

#endif // OAITaskSucceededEventDetails_H
