...
public class MapRunExecutionCounts {
  ...
  public MapRunExecutionCounts pending(Integer pending) {
  ...
  public MapRunExecutionCounts running(Integer running) {
  ...
  public MapRunExecutionCounts succeeded(Integer succeeded) {
  ...
  public MapRunExecutionCounts failed(Integer failed) {
    this.failed = failed;
    return this;
  }
  ...
  public MapRunExecutionCounts timedOut(Integer timedOut) {
  ...
  public MapRunExecutionCounts aborted(Integer aborted) {
  ...
  public MapRunExecutionCounts total(Integer total) {
    this.total = total;
    return this;
  }
  ...
  public MapRunExecutionCounts resultsWritten(Integer resultsWritten) {
  ...
  public boolean equals(Object o) {
    ...
    MapRunExecutionCounts mapRunExecutionCounts = (MapRunExecutionCounts) o;
    return Objects.equals(this.pending, mapRunExecutionCounts.pending) &&
        Objects.equals(this.running, mapRunExecutionCounts.running) &&
        Objects.equals(this.succeeded, mapRunExecutionCounts.succeeded) &&
        Objects.equals(this.failed, mapRunExecutionCounts.failed) &&
        Objects.equals(this.timedOut, mapRunExecutionCounts.timedOut) &&
        Objects.equals(this.aborted, mapRunExecutionCounts.aborted) &&
        Objects.equals(this.total, mapRunExecutionCounts.total) &&
        Objects.equals(this.resultsWritten, mapRunExecutionCounts.resultsWritten);
  }
  ...
  public String toString() {
    ...
    sb.append("class MapRunExecutionCounts {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MapRunExecutionCounts
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MapRunExecutionCounts.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MapRunExecutionCounts is not found in the empty JSON string", MapRunExecutionCounts.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MapRunExecutionCounts.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MapRunExecutionCounts` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MapRunExecutionCounts.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MapRunExecutionCounts.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MapRunExecutionCounts' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MapRunExecutionCounts> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MapRunExecutionCounts.class));

       return (TypeAdapter<T>) new TypeAdapter<MapRunExecutionCounts>() {
           @Override
           public void write(JsonWriter out, MapRunExecutionCounts value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MapRunExecutionCounts read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MapRunExecutionCounts given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MapRunExecutionCounts
   * @throws IOException if the JSON string is invalid with respect to MapRunExecutionCounts
   */
  public static MapRunExecutionCounts fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MapRunExecutionCounts.class);
  }

  /**
   * Convert an instance of MapRunExecutionCounts to an JSON string
   *
   * @return JSON string
   */
