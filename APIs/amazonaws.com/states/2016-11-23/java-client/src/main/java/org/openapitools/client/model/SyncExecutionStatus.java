...
/**
 * Gets or Sets SyncExecutionStatus
 */
@JsonAdapter(SyncExecutionStatus.Adapter.class)
public enum SyncExecutionStatus {
  ...
  SyncExecutionStatus(String value) {
    this.value = value;
  }
  ...
  public static SyncExecutionStatus fromValue(String value) {
    for (SyncExecutionStatus b : SyncExecutionStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<SyncExecutionStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final SyncExecutionStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SyncExecutionStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SyncExecutionStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    SyncExecutionStatus.fromValue(value);
  }
}
