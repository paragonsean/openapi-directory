...
public class ApiClient {
    ...
    private String basePath = "http://states.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2016-11-23/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://states.us-east-1.amazonaws.com
