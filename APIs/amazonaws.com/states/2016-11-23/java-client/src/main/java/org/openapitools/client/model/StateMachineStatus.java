...
/**
 * Gets or Sets StateMachineStatus
 */
@JsonAdapter(StateMachineStatus.Adapter.class)
public enum StateMachineStatus {
  ...
  StateMachineStatus(String value) {
    this.value = value;
  }
  ...
  public static StateMachineStatus fromValue(String value) {
    for (StateMachineStatus b : StateMachineStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<StateMachineStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final StateMachineStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public StateMachineStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return StateMachineStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    StateMachineStatus.fromValue(value);
  }
}
