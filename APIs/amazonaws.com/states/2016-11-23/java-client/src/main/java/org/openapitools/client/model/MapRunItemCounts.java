...
public class MapRunItemCounts {
  ...
  public MapRunItemCounts pending(Integer pending) {
  ...
  public MapRunItemCounts running(Integer running) {
  ...
  public MapRunItemCounts succeeded(Integer succeeded) {
  ...
  public MapRunItemCounts failed(Integer failed) {
    this.failed = failed;
    return this;
  }
  ...
  public MapRunItemCounts timedOut(Integer timedOut) {
  ...
  public MapRunItemCounts aborted(Integer aborted) {
  ...
  public MapRunItemCounts total(Integer total) {
    this.total = total;
    return this;
  }
  ...
  public MapRunItemCounts resultsWritten(Integer resultsWritten) {
  ...
  public boolean equals(Object o) {
    ...
    MapRunItemCounts mapRunItemCounts = (MapRunItemCounts) o;
    return Objects.equals(this.pending, mapRunItemCounts.pending) &&
        Objects.equals(this.running, mapRunItemCounts.running) &&
        Objects.equals(this.succeeded, mapRunItemCounts.succeeded) &&
        Objects.equals(this.failed, mapRunItemCounts.failed) &&
        Objects.equals(this.timedOut, mapRunItemCounts.timedOut) &&
        Objects.equals(this.aborted, mapRunItemCounts.aborted) &&
        Objects.equals(this.total, mapRunItemCounts.total) &&
        Objects.equals(this.resultsWritten, mapRunItemCounts.resultsWritten);
  }
  ...
  public String toString() {
    ...
    sb.append("class MapRunItemCounts {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MapRunItemCounts
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MapRunItemCounts.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MapRunItemCounts is not found in the empty JSON string", MapRunItemCounts.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MapRunItemCounts.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MapRunItemCounts` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MapRunItemCounts.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MapRunItemCounts.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MapRunItemCounts' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MapRunItemCounts> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MapRunItemCounts.class));

       return (TypeAdapter<T>) new TypeAdapter<MapRunItemCounts>() {
           @Override
           public void write(JsonWriter out, MapRunItemCounts value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MapRunItemCounts read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MapRunItemCounts given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MapRunItemCounts
   * @throws IOException if the JSON string is invalid with respect to MapRunItemCounts
   */
  public static MapRunItemCounts fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MapRunItemCounts.class);
  }

  /**
   * Convert an instance of MapRunItemCounts to an JSON string
   *
   * @return JSON string
   */
