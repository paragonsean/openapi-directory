...
/**
 * The TracingConfiguration model module.
 * @module model/TracingConfiguration
 * @version 2016-11-23
 */
class TracingConfiguration {
    /**
     * Constructs a new <code>TracingConfiguration</code>.
     * Selects whether or not the state machine&#39;s X-Ray tracing is enabled. Default is &lt;code&gt;false&lt;/code&gt; 
     * @alias module:model/TracingConfiguration
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>TracingConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TracingConfiguration} obj Optional instance to populate.
     * @return {module:model/TracingConfiguration} The populated <code>TracingConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TracingConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>TracingConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TracingConfiguration</code>.
     */
