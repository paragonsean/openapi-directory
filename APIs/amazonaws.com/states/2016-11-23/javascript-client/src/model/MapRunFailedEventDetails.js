...
/**
 * The MapRunFailedEventDetails model module.
 * @module model/MapRunFailedEventDetails
 * @version 2016-11-23
 */
class MapRunFailedEventDetails {
    /**
     * Constructs a new <code>MapRunFailedEventDetails</code>.
     * Contains details about a Map Run failure event that occurred during a state machine execution.
     * @alias module:model/MapRunFailedEventDetails
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>MapRunFailedEventDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MapRunFailedEventDetails} obj Optional instance to populate.
     * @return {module:model/MapRunFailedEventDetails} The populated <code>MapRunFailedEventDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MapRunFailedEventDetails();
    ...
    /**
     * Validates the JSON data with respect to <code>MapRunFailedEventDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MapRunFailedEventDetails</code>.
     */
...
export default MapRunFailedEventDetails;
