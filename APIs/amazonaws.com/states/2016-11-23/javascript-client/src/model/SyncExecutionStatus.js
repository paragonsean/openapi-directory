...
* @readonly
*/
export default class SyncExecutionStatus {
    ...
    /**
    * Returns a <code>SyncExecutionStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SyncExecutionStatus} The enum <code>SyncExecutionStatus</code> value.
    */
