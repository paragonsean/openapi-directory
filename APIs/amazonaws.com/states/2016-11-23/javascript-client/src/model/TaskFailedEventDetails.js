...
/**
 * The TaskFailedEventDetails model module.
 * @module model/TaskFailedEventDetails
 * @version 2016-11-23
 */
class TaskFailedEventDetails {
    /**
     * Constructs a new <code>TaskFailedEventDetails</code>.
     * Contains details about a task failure event.
     * @alias module:model/TaskFailedEventDetails
    ...
    /**
     * Constructs a <code>TaskFailedEventDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TaskFailedEventDetails} obj Optional instance to populate.
     * @return {module:model/TaskFailedEventDetails} The populated <code>TaskFailedEventDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TaskFailedEventDetails();
    ...
    /**
     * Validates the JSON data with respect to <code>TaskFailedEventDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TaskFailedEventDetails</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TaskFailedEventDetails.RequiredProperties) {
...
TaskFailedEventDetails.RequiredProperties = ["resourceType", "resource"];
...
export default TaskFailedEventDetails;
