...
* @readonly
*/
export default class StateMachineStatus {
    ...
    /**
    * Returns a <code>StateMachineStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/StateMachineStatus} The enum <code>StateMachineStatus</code> value.
    */
