...
* @readonly
*/
export default class MapRunStatus {
    ...
    /**
    * Returns a <code>MapRunStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/MapRunStatus} The enum <code>MapRunStatus</code> value.
    */
