...
/**
 * The GetActivityTaskOutput model module.
 * @module model/GetActivityTaskOutput
 * @version 2016-11-23
 */
class GetActivityTaskOutput {
    /**
     * Constructs a new <code>GetActivityTaskOutput</code>.
     * @alias module:model/GetActivityTaskOutput
     */
    constructor() { 
        
        GetActivityTaskOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetActivityTaskOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetActivityTaskOutput} obj Optional instance to populate.
     * @return {module:model/GetActivityTaskOutput} The populated <code>GetActivityTaskOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetActivityTaskOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetActivityTaskOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetActivityTaskOutput</code>.
     */
 ...
 */
GetActivityTaskOutput.prototype['taskToken'] = undefined;

/**
 * @member {String} input
 */
GetActivityTaskOutput.prototype['input'] = undefined;
...
export default GetActivityTaskOutput;
