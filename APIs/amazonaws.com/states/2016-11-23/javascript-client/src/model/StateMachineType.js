...
* @readonly
*/
export default class StateMachineType {
    ...
    /**
    * Returns a <code>StateMachineType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/StateMachineType} The enum <code>StateMachineType</code> value.
    */
