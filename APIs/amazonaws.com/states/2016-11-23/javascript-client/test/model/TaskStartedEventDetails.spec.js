...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.TaskStartedEventDetails();
  });
  ...
  describe('TaskStartedEventDetails', function() {
    it('should create an instance of TaskStartedEventDetails', function() {
      // uncomment below and update the code to test TaskStartedEventDetails
      //var instance = new AwsStepFunctions.TaskStartedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.TaskStartedEventDetails);
    });
