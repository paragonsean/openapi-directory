...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.CloudWatchLogsLogGroup();
  });
  ...
  describe('CloudWatchLogsLogGroup', function() {
    it('should create an instance of CloudWatchLogsLogGroup', function() {
      ...
      //var instance = new AwsStepFunctions.CloudWatchLogsLogGroup();
      //expect(instance).to.be.a(AwsStepFunctions.CloudWatchLogsLogGroup);
    });
