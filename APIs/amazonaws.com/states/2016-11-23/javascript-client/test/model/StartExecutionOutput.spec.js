...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.StartExecutionOutput();
  });
  ...
  describe('StartExecutionOutput', function() {
    it('should create an instance of StartExecutionOutput', function() {
      // uncomment below and update the code to test StartExecutionOutput
      //var instance = new AwsStepFunctions.StartExecutionOutput();
      //expect(instance).to.be.a(AwsStepFunctions.StartExecutionOutput);
    });

    it('should have the property executionArn (base name: "executionArn")', function() {
      // uncomment below and update the code to test the property executionArn
      //var instance = new AwsStepFunctions.StartExecutionOutput();
