...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.GetActivityTaskOutput();
  });
  ...
  describe('GetActivityTaskOutput', function() {
    it('should create an instance of GetActivityTaskOutput', function() {
      // uncomment below and update the code to test GetActivityTaskOutput
      //var instance = new AwsStepFunctions.GetActivityTaskOutput();
      //expect(instance).to.be.a(AwsStepFunctions.GetActivityTaskOutput);
    });
