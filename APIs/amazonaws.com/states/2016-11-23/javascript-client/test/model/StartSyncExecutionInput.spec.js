...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.StartSyncExecutionInput();
  });
  ...
  describe('StartSyncExecutionInput', function() {
    it('should create an instance of StartSyncExecutionInput', function() {
      // uncomment below and update the code to test StartSyncExecutionInput
      //var instance = new AwsStepFunctions.StartSyncExecutionInput();
      //expect(instance).to.be.a(AwsStepFunctions.StartSyncExecutionInput);
    });
