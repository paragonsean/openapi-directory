...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.ListActivitiesInput();
  });
  ...
  describe('ListActivitiesInput', function() {
    it('should create an instance of ListActivitiesInput', function() {
      // uncomment below and update the code to test ListActivitiesInput
      //var instance = new AwsStepFunctions.ListActivitiesInput();
      //expect(instance).to.be.a(AwsStepFunctions.ListActivitiesInput);
    });
