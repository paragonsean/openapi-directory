...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.ActivityScheduledEventDetailsInputDetails();
  });
  ...
  describe('ActivityScheduledEventDetailsInputDetails', function() {
    it('should create an instance of ActivityScheduledEventDetailsInputDetails', function() {
      // uncomment below and update the code to test ActivityScheduledEventDetailsInputDetails
      //var instance = new AwsStepFunctions.ActivityScheduledEventDetailsInputDetails();
      //expect(instance).to.be.a(AwsStepFunctions.ActivityScheduledEventDetailsInputDetails);
    });
