...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.DescribeMapRunOutputItemCounts();
  });
  ...
  describe('DescribeMapRunOutputItemCounts', function() {
    it('should create an instance of DescribeMapRunOutputItemCounts', function() {
      // uncomment below and update the code to test DescribeMapRunOutputItemCounts
      //var instance = new AwsStepFunctions.DescribeMapRunOutputItemCounts();
      //expect(instance).to.be.a(AwsStepFunctions.DescribeMapRunOutputItemCounts);
    });
