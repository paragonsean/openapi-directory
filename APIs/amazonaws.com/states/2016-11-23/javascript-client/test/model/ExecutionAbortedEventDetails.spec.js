...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.ExecutionAbortedEventDetails();
  });
  ...
  describe('ExecutionAbortedEventDetails', function() {
    it('should create an instance of ExecutionAbortedEventDetails', function() {
      // uncomment below and update the code to test ExecutionAbortedEventDetails
      //var instance = new AwsStepFunctions.ExecutionAbortedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.ExecutionAbortedEventDetails);
    });
