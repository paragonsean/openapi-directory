...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.DescribeActivityInput();
  });
  ...
  describe('DescribeActivityInput', function() {
    it('should create an instance of DescribeActivityInput', function() {
      // uncomment below and update the code to test DescribeActivityInput
      //var instance = new AwsStepFunctions.DescribeActivityInput();
      //expect(instance).to.be.a(AwsStepFunctions.DescribeActivityInput);
    });
