...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.HistoryEventMapIterationSucceededEventDetails();
  });
  ...
  describe('HistoryEventMapIterationSucceededEventDetails', function() {
    it('should create an instance of HistoryEventMapIterationSucceededEventDetails', function() {
      // uncomment below and update the code to test HistoryEventMapIterationSucceededEventDetails
      //var instance = new AwsStepFunctions.HistoryEventMapIterationSucceededEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.HistoryEventMapIterationSucceededEventDetails);
    });
