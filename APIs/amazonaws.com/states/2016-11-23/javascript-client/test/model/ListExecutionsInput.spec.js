...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.ListExecutionsInput();
  });
  ...
  describe('ListExecutionsInput', function() {
    it('should create an instance of ListExecutionsInput', function() {
      // uncomment below and update the code to test ListExecutionsInput
      //var instance = new AwsStepFunctions.ListExecutionsInput();
      //expect(instance).to.be.a(AwsStepFunctions.ListExecutionsInput);
    });
