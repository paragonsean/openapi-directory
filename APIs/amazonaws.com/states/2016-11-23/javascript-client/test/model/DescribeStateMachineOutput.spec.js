...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.DescribeStateMachineOutput();
  });
  ...
  describe('DescribeStateMachineOutput', function() {
    it('should create an instance of DescribeStateMachineOutput', function() {
      // uncomment below and update the code to test DescribeStateMachineOutput
      //var instance = new AwsStepFunctions.DescribeStateMachineOutput();
      //expect(instance).to.be.a(AwsStepFunctions.DescribeStateMachineOutput);
    });
