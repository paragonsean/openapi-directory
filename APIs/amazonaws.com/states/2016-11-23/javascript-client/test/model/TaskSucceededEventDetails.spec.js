...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.TaskSucceededEventDetails();
  });
  ...
  describe('TaskSucceededEventDetails', function() {
    it('should create an instance of TaskSucceededEventDetails', function() {
      // uncomment below and update the code to test TaskSucceededEventDetails
      //var instance = new AwsStepFunctions.TaskSucceededEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.TaskSucceededEventDetails);
    });
