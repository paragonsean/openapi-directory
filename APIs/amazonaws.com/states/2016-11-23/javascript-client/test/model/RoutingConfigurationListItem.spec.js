...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.RoutingConfigurationListItem();
  });
  ...
  describe('RoutingConfigurationListItem', function() {
    it('should create an instance of RoutingConfigurationListItem', function() {
      // uncomment below and update the code to test RoutingConfigurationListItem
      //var instance = new AwsStepFunctions.RoutingConfigurationListItem();
      //expect(instance).to.be.a(AwsStepFunctions.RoutingConfigurationListItem);
    });

    it('should have the property stateMachineVersionArn (base name: "stateMachineVersionArn")', function() {
      // uncomment below and update the code to test the property stateMachineVersionArn
      //var instance = new AwsStepFunctions.RoutingConfigurationListItem();
