...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.TaskScheduledEventDetails();
  });
  ...
  describe('TaskScheduledEventDetails', function() {
    it('should create an instance of TaskScheduledEventDetails', function() {
      // uncomment below and update the code to test TaskScheduledEventDetails
      //var instance = new AwsStepFunctions.TaskScheduledEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.TaskScheduledEventDetails);
    });
    ...
    it('should have the property heartbeatInSeconds (base name: "heartbeatInSeconds")', function() {
      // uncomment below and update the code to test the property heartbeatInSeconds
      //var instance = new AwsStepFunctions.TaskScheduledEventDetails();
      //expect(instance).to.be();
    });

    it('should have the property taskCredentials (base name: "taskCredentials")', function() {
      // uncomment below and update the code to test the property taskCredentials
      //var instance = new AwsStepFunctions.TaskScheduledEventDetails();
      //expect(instance).to.be();
    });
