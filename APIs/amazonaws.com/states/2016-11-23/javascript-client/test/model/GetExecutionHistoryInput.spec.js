...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.GetExecutionHistoryInput();
  });
  ...
  describe('GetExecutionHistoryInput', function() {
    it('should create an instance of GetExecutionHistoryInput', function() {
      // uncomment below and update the code to test GetExecutionHistoryInput
      //var instance = new AwsStepFunctions.GetExecutionHistoryInput();
      //expect(instance).to.be.a(AwsStepFunctions.GetExecutionHistoryInput);
    });
