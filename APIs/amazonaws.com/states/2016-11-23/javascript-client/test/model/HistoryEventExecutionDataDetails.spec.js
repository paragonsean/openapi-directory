...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.HistoryEventExecutionDataDetails();
  });
  ...
  describe('HistoryEventExecutionDataDetails', function() {
    it('should create an instance of HistoryEventExecutionDataDetails', function() {
      // uncomment below and update the code to test HistoryEventExecutionDataDetails
      //var instance = new AwsStepFunctions.HistoryEventExecutionDataDetails();
      //expect(instance).to.be.a(AwsStepFunctions.HistoryEventExecutionDataDetails);
    });
