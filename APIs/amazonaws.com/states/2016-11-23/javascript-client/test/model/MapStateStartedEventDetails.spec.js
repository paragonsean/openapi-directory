...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.MapStateStartedEventDetails();
  });
  ...
  describe('MapStateStartedEventDetails', function() {
    it('should create an instance of MapStateStartedEventDetails', function() {
      // uncomment below and update the code to test MapStateStartedEventDetails
      //var instance = new AwsStepFunctions.MapStateStartedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.MapStateStartedEventDetails);
    });
