...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.StateExitedEventDetails();
  });
  ...
  describe('StateExitedEventDetails', function() {
    it('should create an instance of StateExitedEventDetails', function() {
      // uncomment below and update the code to test StateExitedEventDetails
      //var instance = new AwsStepFunctions.StateExitedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.StateExitedEventDetails);
    });
    ...
    it('should have the property outputDetails (base name: "outputDetails")', function() {
      // uncomment below and update the code to test the property outputDetails
      //var instance = new AwsStepFunctions.StateExitedEventDetails();
      //expect(instance).to.be();
    });
