...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.ExecutionTimedOutEventDetails();
  });
  ...
  describe('ExecutionTimedOutEventDetails', function() {
    it('should create an instance of ExecutionTimedOutEventDetails', function() {
      // uncomment below and update the code to test ExecutionTimedOutEventDetails
      //var instance = new AwsStepFunctions.ExecutionTimedOutEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.ExecutionTimedOutEventDetails);
    });
