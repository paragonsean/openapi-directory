...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.LambdaFunctionScheduledEventDetails();
  });
  ...
  describe('LambdaFunctionScheduledEventDetails', function() {
    it('should create an instance of LambdaFunctionScheduledEventDetails', function() {
      // uncomment below and update the code to test LambdaFunctionScheduledEventDetails
      //var instance = new AwsStepFunctions.LambdaFunctionScheduledEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.LambdaFunctionScheduledEventDetails);
    });
