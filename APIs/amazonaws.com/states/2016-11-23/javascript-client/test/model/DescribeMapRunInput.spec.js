...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.DescribeMapRunInput();
  });
  ...
  describe('DescribeMapRunInput', function() {
    it('should create an instance of DescribeMapRunInput', function() {
      // uncomment below and update the code to test DescribeMapRunInput
      //var instance = new AwsStepFunctions.DescribeMapRunInput();
      //expect(instance).to.be.a(AwsStepFunctions.DescribeMapRunInput);
    });
