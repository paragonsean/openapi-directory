...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.UpdateStateMachineAliasOutput();
  });
  ...
  describe('UpdateStateMachineAliasOutput', function() {
    it('should create an instance of UpdateStateMachineAliasOutput', function() {
      // uncomment below and update the code to test UpdateStateMachineAliasOutput
      //var instance = new AwsStepFunctions.UpdateStateMachineAliasOutput();
      //expect(instance).to.be.a(AwsStepFunctions.UpdateStateMachineAliasOutput);
    });
