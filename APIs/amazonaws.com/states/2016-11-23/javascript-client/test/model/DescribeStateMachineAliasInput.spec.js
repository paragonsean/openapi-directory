...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.DescribeStateMachineAliasInput();
  });
  ...
  describe('DescribeStateMachineAliasInput', function() {
    it('should create an instance of DescribeStateMachineAliasInput', function() {
      // uncomment below and update the code to test DescribeStateMachineAliasInput
      //var instance = new AwsStepFunctions.DescribeStateMachineAliasInput();
      //expect(instance).to.be.a(AwsStepFunctions.DescribeStateMachineAliasInput);
    });
