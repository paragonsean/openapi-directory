...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.ExecutionSucceededEventDetails();
  });
  ...
  describe('ExecutionSucceededEventDetails', function() {
    it('should create an instance of ExecutionSucceededEventDetails', function() {
      // uncomment below and update the code to test ExecutionSucceededEventDetails
      //var instance = new AwsStepFunctions.ExecutionSucceededEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.ExecutionSucceededEventDetails);
    });
