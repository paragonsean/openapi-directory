...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.LogDestinationCloudWatchLogsLogGroup();
  });
  ...
  describe('LogDestinationCloudWatchLogsLogGroup', function() {
    it('should create an instance of LogDestinationCloudWatchLogsLogGroup', function() {
      ...
      //var instance = new AwsStepFunctions.LogDestinationCloudWatchLogsLogGroup();
      //expect(instance).to.be.a(AwsStepFunctions.LogDestinationCloudWatchLogsLogGroup);
    });
