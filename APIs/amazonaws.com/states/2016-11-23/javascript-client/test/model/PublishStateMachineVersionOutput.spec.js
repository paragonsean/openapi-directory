...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.PublishStateMachineVersionOutput();
  });
  ...
  describe('PublishStateMachineVersionOutput', function() {
    it('should create an instance of PublishStateMachineVersionOutput', function() {
      // uncomment below and update the code to test PublishStateMachineVersionOutput
      //var instance = new AwsStepFunctions.PublishStateMachineVersionOutput();
      //expect(instance).to.be.a(AwsStepFunctions.PublishStateMachineVersionOutput);
    });
