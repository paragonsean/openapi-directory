...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.CreateStateMachineAliasInput();
  });
  ...
  describe('CreateStateMachineAliasInput', function() {
    it('should create an instance of CreateStateMachineAliasInput', function() {
      // uncomment below and update the code to test CreateStateMachineAliasInput
      //var instance = new AwsStepFunctions.CreateStateMachineAliasInput();
      //expect(instance).to.be.a(AwsStepFunctions.CreateStateMachineAliasInput);
    });
