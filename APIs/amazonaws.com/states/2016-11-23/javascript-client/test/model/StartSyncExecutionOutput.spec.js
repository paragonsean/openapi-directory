...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.StartSyncExecutionOutput();
  });
  ...
  describe('StartSyncExecutionOutput', function() {
    it('should create an instance of StartSyncExecutionOutput', function() {
      // uncomment below and update the code to test StartSyncExecutionOutput
      //var instance = new AwsStepFunctions.StartSyncExecutionOutput();
      //expect(instance).to.be.a(AwsStepFunctions.StartSyncExecutionOutput);
    });
    ...
    it('should have the property traceHeader (base name: "traceHeader")', function() {
      // uncomment below and update the code to test the property traceHeader
      //var instance = new AwsStepFunctions.StartSyncExecutionOutput();
      //expect(instance).to.be();
    });
