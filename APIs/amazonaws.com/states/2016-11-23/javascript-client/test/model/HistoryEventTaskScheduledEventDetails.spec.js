...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.HistoryEventTaskScheduledEventDetails();
  });
  ...
  describe('HistoryEventTaskScheduledEventDetails', function() {
    it('should create an instance of HistoryEventTaskScheduledEventDetails', function() {
      // uncomment below and update the code to test HistoryEventTaskScheduledEventDetails
      //var instance = new AwsStepFunctions.HistoryEventTaskScheduledEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.HistoryEventTaskScheduledEventDetails);
    });
