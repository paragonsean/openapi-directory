...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.ListStateMachineAliasesInput();
  });
  ...
  describe('ListStateMachineAliasesInput', function() {
    it('should create an instance of ListStateMachineAliasesInput', function() {
      // uncomment below and update the code to test ListStateMachineAliasesInput
      //var instance = new AwsStepFunctions.ListStateMachineAliasesInput();
      //expect(instance).to.be.a(AwsStepFunctions.ListStateMachineAliasesInput);
    });
