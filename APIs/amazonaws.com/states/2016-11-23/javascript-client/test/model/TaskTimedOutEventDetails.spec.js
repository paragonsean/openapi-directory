...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.TaskTimedOutEventDetails();
  });
  ...
  describe('TaskTimedOutEventDetails', function() {
    it('should create an instance of TaskTimedOutEventDetails', function() {
      // uncomment below and update the code to test TaskTimedOutEventDetails
      //var instance = new AwsStepFunctions.TaskTimedOutEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.TaskTimedOutEventDetails);
    });
