...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.DescribeStateMachineInput();
  });
  ...
  describe('DescribeStateMachineInput', function() {
    it('should create an instance of DescribeStateMachineInput', function() {
      // uncomment below and update the code to test DescribeStateMachineInput
      //var instance = new AwsStepFunctions.DescribeStateMachineInput();
      //expect(instance).to.be.a(AwsStepFunctions.DescribeStateMachineInput);
    });
