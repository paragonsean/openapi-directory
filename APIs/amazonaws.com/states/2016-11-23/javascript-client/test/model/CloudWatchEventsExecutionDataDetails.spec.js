...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.CloudWatchEventsExecutionDataDetails();
  });
  ...
  describe('CloudWatchEventsExecutionDataDetails', function() {
    it('should create an instance of CloudWatchEventsExecutionDataDetails', function() {
      // uncomment below and update the code to test CloudWatchEventsExecutionDataDetails
      //var instance = new AwsStepFunctions.CloudWatchEventsExecutionDataDetails();
      //expect(instance).to.be.a(AwsStepFunctions.CloudWatchEventsExecutionDataDetails);
    });
