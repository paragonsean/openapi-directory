...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.TaskSubmitFailedEventDetails();
  });
  ...
  describe('TaskSubmitFailedEventDetails', function() {
    it('should create an instance of TaskSubmitFailedEventDetails', function() {
      // uncomment below and update the code to test TaskSubmitFailedEventDetails
      //var instance = new AwsStepFunctions.TaskSubmitFailedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.TaskSubmitFailedEventDetails);
    });
