...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.StopExecutionInput();
  });
  ...
  describe('StopExecutionInput', function() {
    it('should create an instance of StopExecutionInput', function() {
      // uncomment below and update the code to test StopExecutionInput
      //var instance = new AwsStepFunctions.StopExecutionInput();
      //expect(instance).to.be.a(AwsStepFunctions.StopExecutionInput);
    });
