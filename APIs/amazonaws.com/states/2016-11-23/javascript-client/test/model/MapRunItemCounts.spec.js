...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.MapRunItemCounts();
  });
  ...
  describe('MapRunItemCounts', function() {
    it('should create an instance of MapRunItemCounts', function() {
      // uncomment below and update the code to test MapRunItemCounts
      //var instance = new AwsStepFunctions.MapRunItemCounts();
      //expect(instance).to.be.a(AwsStepFunctions.MapRunItemCounts);
    });
