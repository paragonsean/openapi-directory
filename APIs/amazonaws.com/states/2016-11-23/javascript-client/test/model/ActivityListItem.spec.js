...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.ActivityListItem();
  });
  ...
  describe('ActivityListItem', function() {
    it('should create an instance of ActivityListItem', function() {
      // uncomment below and update the code to test ActivityListItem
      //var instance = new AwsStepFunctions.ActivityListItem();
      //expect(instance).to.be.a(AwsStepFunctions.ActivityListItem);
    });
