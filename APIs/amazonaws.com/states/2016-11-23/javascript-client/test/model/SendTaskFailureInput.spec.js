...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.SendTaskFailureInput();
  });
  ...
  describe('SendTaskFailureInput', function() {
    it('should create an instance of SendTaskFailureInput', function() {
      // uncomment below and update the code to test SendTaskFailureInput
      //var instance = new AwsStepFunctions.SendTaskFailureInput();
      //expect(instance).to.be.a(AwsStepFunctions.SendTaskFailureInput);
    });
