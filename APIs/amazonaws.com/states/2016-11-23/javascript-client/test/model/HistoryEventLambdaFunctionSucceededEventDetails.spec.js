...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.HistoryEventLambdaFunctionSucceededEventDetails();
  });
  ...
  describe('HistoryEventLambdaFunctionSucceededEventDetails', function() {
    it('should create an instance of HistoryEventLambdaFunctionSucceededEventDetails', function() {
      // uncomment below and update the code to test HistoryEventLambdaFunctionSucceededEventDetails
      //var instance = new AwsStepFunctions.HistoryEventLambdaFunctionSucceededEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.HistoryEventLambdaFunctionSucceededEventDetails);
    });
