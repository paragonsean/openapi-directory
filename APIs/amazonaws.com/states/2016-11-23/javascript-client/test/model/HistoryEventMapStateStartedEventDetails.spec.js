...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.HistoryEventMapStateStartedEventDetails();
  });
  ...
  describe('HistoryEventMapStateStartedEventDetails', function() {
    it('should create an instance of HistoryEventMapStateStartedEventDetails', function() {
      // uncomment below and update the code to test HistoryEventMapStateStartedEventDetails
      //var instance = new AwsStepFunctions.HistoryEventMapStateStartedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.HistoryEventMapStateStartedEventDetails);
    });
