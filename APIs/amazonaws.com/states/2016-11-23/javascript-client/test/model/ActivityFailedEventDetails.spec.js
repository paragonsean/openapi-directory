...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.ActivityFailedEventDetails();
  });
  ...
  describe('ActivityFailedEventDetails', function() {
    it('should create an instance of ActivityFailedEventDetails', function() {
      // uncomment below and update the code to test ActivityFailedEventDetails
      //var instance = new AwsStepFunctions.ActivityFailedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.ActivityFailedEventDetails);
    });
