...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.HistoryEventLambdaFunctionStartFailedEventDetails();
  });
  ...
  describe('HistoryEventLambdaFunctionStartFailedEventDetails', function() {
    it('should create an instance of HistoryEventLambdaFunctionStartFailedEventDetails', function() {
      // uncomment below and update the code to test HistoryEventLambdaFunctionStartFailedEventDetails
      //var instance = new AwsStepFunctions.HistoryEventLambdaFunctionStartFailedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.HistoryEventLambdaFunctionStartFailedEventDetails);
    });
