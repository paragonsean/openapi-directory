...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.CreateStateMachineInputLoggingConfiguration();
  });
  ...
  describe('CreateStateMachineInputLoggingConfiguration', function() {
    it('should create an instance of CreateStateMachineInputLoggingConfiguration', function() {
      // uncomment below and update the code to test CreateStateMachineInputLoggingConfiguration
      //var instance = new AwsStepFunctions.CreateStateMachineInputLoggingConfiguration();
      //expect(instance).to.be.a(AwsStepFunctions.CreateStateMachineInputLoggingConfiguration);
    });
