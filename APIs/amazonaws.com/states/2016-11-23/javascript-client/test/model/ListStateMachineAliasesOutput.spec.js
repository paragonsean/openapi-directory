...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.ListStateMachineAliasesOutput();
  });
  ...
  describe('ListStateMachineAliasesOutput', function() {
    it('should create an instance of ListStateMachineAliasesOutput', function() {
      // uncomment below and update the code to test ListStateMachineAliasesOutput
      //var instance = new AwsStepFunctions.ListStateMachineAliasesOutput();
      //expect(instance).to.be.a(AwsStepFunctions.ListStateMachineAliasesOutput);
    });

    it('should have the property stateMachineAliases (base name: "stateMachineAliases")', function() {
      // uncomment below and update the code to test the property stateMachineAliases
      //var instance = new AwsStepFunctions.ListStateMachineAliasesOutput();
