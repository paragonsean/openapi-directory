...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.DeleteStateMachineInput();
  });
  ...
  describe('DeleteStateMachineInput', function() {
    it('should create an instance of DeleteStateMachineInput', function() {
      // uncomment below and update the code to test DeleteStateMachineInput
      //var instance = new AwsStepFunctions.DeleteStateMachineInput();
      //expect(instance).to.be.a(AwsStepFunctions.DeleteStateMachineInput);
    });
