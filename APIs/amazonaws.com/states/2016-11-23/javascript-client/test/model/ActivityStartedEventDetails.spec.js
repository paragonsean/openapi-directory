...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.ActivityStartedEventDetails();
  });
  ...
  describe('ActivityStartedEventDetails', function() {
    it('should create an instance of ActivityStartedEventDetails', function() {
      // uncomment below and update the code to test ActivityStartedEventDetails
      //var instance = new AwsStepFunctions.ActivityStartedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.ActivityStartedEventDetails);
    });

    it('should have the property workerName (base name: "workerName")', function() {
