...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.TaskSubmittedEventDetails();
  });
  ...
  describe('TaskSubmittedEventDetails', function() {
    it('should create an instance of TaskSubmittedEventDetails', function() {
      // uncomment below and update the code to test TaskSubmittedEventDetails
      //var instance = new AwsStepFunctions.TaskSubmittedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.TaskSubmittedEventDetails);
    });
