...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.HistoryEventMapIterationAbortedEventDetails();
  });
  ...
  describe('HistoryEventMapIterationAbortedEventDetails', function() {
    it('should create an instance of HistoryEventMapIterationAbortedEventDetails', function() {
      // uncomment below and update the code to test HistoryEventMapIterationAbortedEventDetails
      //var instance = new AwsStepFunctions.HistoryEventMapIterationAbortedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.HistoryEventMapIterationAbortedEventDetails);
    });
