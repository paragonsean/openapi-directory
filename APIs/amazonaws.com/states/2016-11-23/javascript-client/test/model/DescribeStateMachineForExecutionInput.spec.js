...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.DescribeStateMachineForExecutionInput();
  });
  ...
  describe('DescribeStateMachineForExecutionInput', function() {
    it('should create an instance of DescribeStateMachineForExecutionInput', function() {
      // uncomment below and update the code to test DescribeStateMachineForExecutionInput
      //var instance = new AwsStepFunctions.DescribeStateMachineForExecutionInput();
      //expect(instance).to.be.a(AwsStepFunctions.DescribeStateMachineForExecutionInput);
    });
