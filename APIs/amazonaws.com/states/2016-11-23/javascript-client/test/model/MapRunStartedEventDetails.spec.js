...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.MapRunStartedEventDetails();
  });
  ...
  describe('MapRunStartedEventDetails', function() {
    it('should create an instance of MapRunStartedEventDetails', function() {
      // uncomment below and update the code to test MapRunStartedEventDetails
      //var instance = new AwsStepFunctions.MapRunStartedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.MapRunStartedEventDetails);
    });
