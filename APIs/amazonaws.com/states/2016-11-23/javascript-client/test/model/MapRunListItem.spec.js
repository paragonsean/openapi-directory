...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.MapRunListItem();
  });
  ...
  describe('MapRunListItem', function() {
    it('should create an instance of MapRunListItem', function() {
      // uncomment below and update the code to test MapRunListItem
      //var instance = new AwsStepFunctions.MapRunListItem();
      //expect(instance).to.be.a(AwsStepFunctions.MapRunListItem);
    });
