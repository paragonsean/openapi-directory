...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.ActivityScheduledEventDetails();
  });
  ...
  describe('ActivityScheduledEventDetails', function() {
    it('should create an instance of ActivityScheduledEventDetails', function() {
      // uncomment below and update the code to test ActivityScheduledEventDetails
      //var instance = new AwsStepFunctions.ActivityScheduledEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.ActivityScheduledEventDetails);
    });
