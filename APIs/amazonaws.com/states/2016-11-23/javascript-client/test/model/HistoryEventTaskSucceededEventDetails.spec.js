...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.HistoryEventTaskSucceededEventDetails();
  });
  ...
  describe('HistoryEventTaskSucceededEventDetails', function() {
    it('should create an instance of HistoryEventTaskSucceededEventDetails', function() {
      // uncomment below and update the code to test HistoryEventTaskSucceededEventDetails
      //var instance = new AwsStepFunctions.HistoryEventTaskSucceededEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.HistoryEventTaskSucceededEventDetails);
    });
