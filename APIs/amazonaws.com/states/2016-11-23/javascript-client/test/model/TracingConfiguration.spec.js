...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.TracingConfiguration();
  });
  ...
  describe('TracingConfiguration', function() {
    it('should create an instance of TracingConfiguration', function() {
      // uncomment below and update the code to test TracingConfiguration
      //var instance = new AwsStepFunctions.TracingConfiguration();
      //expect(instance).to.be.a(AwsStepFunctions.TracingConfiguration);
    });
