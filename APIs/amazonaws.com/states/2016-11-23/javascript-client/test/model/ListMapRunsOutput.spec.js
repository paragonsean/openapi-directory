...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.ListMapRunsOutput();
  });
  ...
  describe('ListMapRunsOutput', function() {
    it('should create an instance of ListMapRunsOutput', function() {
      // uncomment below and update the code to test ListMapRunsOutput
      //var instance = new AwsStepFunctions.ListMapRunsOutput();
      //expect(instance).to.be.a(AwsStepFunctions.ListMapRunsOutput);
    });

    it('should have the property mapRuns (base name: "mapRuns")', function() {
      // uncomment below and update the code to test the property mapRuns
      //var instance = new AwsStepFunctions.ListMapRunsOutput();
