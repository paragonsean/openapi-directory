...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.ListTagsForResourceInput();
  });
  ...
  describe('ListTagsForResourceInput', function() {
    it('should create an instance of ListTagsForResourceInput', function() {
      ...
      //var instance = new AwsStepFunctions.ListTagsForResourceInput();
      //expect(instance).to.be.a(AwsStepFunctions.ListTagsForResourceInput);
    });
