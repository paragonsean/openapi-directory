...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.UpdateStateMachineOutput();
  });
  ...
  describe('UpdateStateMachineOutput', function() {
    it('should create an instance of UpdateStateMachineOutput', function() {
      // uncomment below and update the code to test UpdateStateMachineOutput
      //var instance = new AwsStepFunctions.UpdateStateMachineOutput();
      //expect(instance).to.be.a(AwsStepFunctions.UpdateStateMachineOutput);
    });
