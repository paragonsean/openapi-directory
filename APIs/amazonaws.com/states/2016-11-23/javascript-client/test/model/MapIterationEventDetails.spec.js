...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.MapIterationEventDetails();
  });
  ...
  describe('MapIterationEventDetails', function() {
    it('should create an instance of MapIterationEventDetails', function() {
      // uncomment below and update the code to test MapIterationEventDetails
      //var instance = new AwsStepFunctions.MapIterationEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.MapIterationEventDetails);
    });
