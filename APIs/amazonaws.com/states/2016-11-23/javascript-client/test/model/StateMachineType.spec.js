...
(function(root, factory) {
  ...
  describe('StateMachineType', function() {
    it('should create an instance of StateMachineType', function() {
      // uncomment below and update the code to test StateMachineType
      //var instance = new AwsStepFunctions.StateMachineType();
      //expect(instance).to.be.a(AwsStepFunctions.StateMachineType);
    });
