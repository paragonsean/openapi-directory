...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.LambdaFunctionStartFailedEventDetails();
  });
  ...
  describe('LambdaFunctionStartFailedEventDetails', function() {
    it('should create an instance of LambdaFunctionStartFailedEventDetails', function() {
      // uncomment below and update the code to test LambdaFunctionStartFailedEventDetails
      //var instance = new AwsStepFunctions.LambdaFunctionStartFailedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.LambdaFunctionStartFailedEventDetails);
    });
