...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.HistoryEventTaskSubmitFailedEventDetails();
  });
  ...
  describe('HistoryEventTaskSubmitFailedEventDetails', function() {
    it('should create an instance of HistoryEventTaskSubmitFailedEventDetails', function() {
      // uncomment below and update the code to test HistoryEventTaskSubmitFailedEventDetails
      //var instance = new AwsStepFunctions.HistoryEventTaskSubmitFailedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.HistoryEventTaskSubmitFailedEventDetails);
    });
