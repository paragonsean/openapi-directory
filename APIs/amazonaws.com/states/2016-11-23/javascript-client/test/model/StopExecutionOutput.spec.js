...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.StopExecutionOutput();
  });
  ...
  describe('StopExecutionOutput', function() {
    it('should create an instance of StopExecutionOutput', function() {
      // uncomment below and update the code to test StopExecutionOutput
      //var instance = new AwsStepFunctions.StopExecutionOutput();
      //expect(instance).to.be.a(AwsStepFunctions.StopExecutionOutput);
    });
