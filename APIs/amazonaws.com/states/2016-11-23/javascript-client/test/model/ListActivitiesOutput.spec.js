...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.ListActivitiesOutput();
  });
  ...
  describe('ListActivitiesOutput', function() {
    it('should create an instance of ListActivitiesOutput', function() {
      // uncomment below and update the code to test ListActivitiesOutput
      //var instance = new AwsStepFunctions.ListActivitiesOutput();
      //expect(instance).to.be.a(AwsStepFunctions.ListActivitiesOutput);
    });
