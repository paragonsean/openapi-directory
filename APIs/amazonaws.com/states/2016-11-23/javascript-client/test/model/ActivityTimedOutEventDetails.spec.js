...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.ActivityTimedOutEventDetails();
  });
  ...
  describe('ActivityTimedOutEventDetails', function() {
    it('should create an instance of ActivityTimedOutEventDetails', function() {
      // uncomment below and update the code to test ActivityTimedOutEventDetails
      //var instance = new AwsStepFunctions.ActivityTimedOutEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.ActivityTimedOutEventDetails);
    });
