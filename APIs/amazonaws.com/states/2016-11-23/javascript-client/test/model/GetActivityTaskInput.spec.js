...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.GetActivityTaskInput();
  });
  ...
  describe('GetActivityTaskInput', function() {
    it('should create an instance of GetActivityTaskInput', function() {
      // uncomment below and update the code to test GetActivityTaskInput
      //var instance = new AwsStepFunctions.GetActivityTaskInput();
      //expect(instance).to.be.a(AwsStepFunctions.GetActivityTaskInput);
    });
