...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.UpdateStateMachineInput();
  });
  ...
  describe('UpdateStateMachineInput', function() {
    it('should create an instance of UpdateStateMachineInput', function() {
      // uncomment below and update the code to test UpdateStateMachineInput
      //var instance = new AwsStepFunctions.UpdateStateMachineInput();
      //expect(instance).to.be.a(AwsStepFunctions.UpdateStateMachineInput);
    });
