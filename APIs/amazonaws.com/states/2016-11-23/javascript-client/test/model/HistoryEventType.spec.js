...
(function(root, factory) {
  ...
  describe('HistoryEventType', function() {
    it('should create an instance of HistoryEventType', function() {
      // uncomment below and update the code to test HistoryEventType
      //var instance = new AwsStepFunctions.HistoryEventType();
      //expect(instance).to.be.a(AwsStepFunctions.HistoryEventType);
    });
