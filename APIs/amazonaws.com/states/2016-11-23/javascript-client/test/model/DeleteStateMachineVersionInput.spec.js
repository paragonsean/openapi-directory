...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.DeleteStateMachineVersionInput();
  });
  ...
  describe('DeleteStateMachineVersionInput', function() {
    it('should create an instance of DeleteStateMachineVersionInput', function() {
      // uncomment below and update the code to test DeleteStateMachineVersionInput
      //var instance = new AwsStepFunctions.DeleteStateMachineVersionInput();
      //expect(instance).to.be.a(AwsStepFunctions.DeleteStateMachineVersionInput);
    });
