...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.HistoryEventTaskTimedOutEventDetails();
  });
  ...
  describe('HistoryEventTaskTimedOutEventDetails', function() {
    it('should create an instance of HistoryEventTaskTimedOutEventDetails', function() {
      // uncomment below and update the code to test HistoryEventTaskTimedOutEventDetails
      //var instance = new AwsStepFunctions.HistoryEventTaskTimedOutEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.HistoryEventTaskTimedOutEventDetails);
    });
