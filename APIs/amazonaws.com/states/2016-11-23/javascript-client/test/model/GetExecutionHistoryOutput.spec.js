...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.GetExecutionHistoryOutput();
  });
  ...
  describe('GetExecutionHistoryOutput', function() {
    it('should create an instance of GetExecutionHistoryOutput', function() {
      // uncomment below and update the code to test GetExecutionHistoryOutput
      //var instance = new AwsStepFunctions.GetExecutionHistoryOutput();
      //expect(instance).to.be.a(AwsStepFunctions.GetExecutionHistoryOutput);
    });
