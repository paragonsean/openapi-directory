...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.HistoryEventMapIterationStartedEventDetails();
  });
  ...
  describe('HistoryEventMapIterationStartedEventDetails', function() {
    it('should create an instance of HistoryEventMapIterationStartedEventDetails', function() {
      // uncomment below and update the code to test HistoryEventMapIterationStartedEventDetails
      //var instance = new AwsStepFunctions.HistoryEventMapIterationStartedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.HistoryEventMapIterationStartedEventDetails);
    });
