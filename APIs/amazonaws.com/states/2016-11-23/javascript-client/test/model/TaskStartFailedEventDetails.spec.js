...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.TaskStartFailedEventDetails();
  });
  ...
  describe('TaskStartFailedEventDetails', function() {
    it('should create an instance of TaskStartFailedEventDetails', function() {
      // uncomment below and update the code to test TaskStartFailedEventDetails
      //var instance = new AwsStepFunctions.TaskStartFailedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.TaskStartFailedEventDetails);
    });
