...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.DeleteActivityInput();
  });
  ...
  describe('DeleteActivityInput', function() {
    it('should create an instance of DeleteActivityInput', function() {
      // uncomment below and update the code to test DeleteActivityInput
      //var instance = new AwsStepFunctions.DeleteActivityInput();
      //expect(instance).to.be.a(AwsStepFunctions.DeleteActivityInput);
    });
