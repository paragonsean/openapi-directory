...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.UpdateMapRunInput();
  });
  ...
  describe('UpdateMapRunInput', function() {
    it('should create an instance of UpdateMapRunInput', function() {
      // uncomment below and update the code to test UpdateMapRunInput
      //var instance = new AwsStepFunctions.UpdateMapRunInput();
      //expect(instance).to.be.a(AwsStepFunctions.UpdateMapRunInput);
    });
