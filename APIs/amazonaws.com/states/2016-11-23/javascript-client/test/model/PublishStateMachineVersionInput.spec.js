...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.PublishStateMachineVersionInput();
  });
  ...
  describe('PublishStateMachineVersionInput', function() {
    it('should create an instance of PublishStateMachineVersionInput', function() {
      // uncomment below and update the code to test PublishStateMachineVersionInput
      //var instance = new AwsStepFunctions.PublishStateMachineVersionInput();
      //expect(instance).to.be.a(AwsStepFunctions.PublishStateMachineVersionInput);
    });
