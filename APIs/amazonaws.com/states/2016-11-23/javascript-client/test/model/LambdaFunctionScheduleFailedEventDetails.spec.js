...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.LambdaFunctionScheduleFailedEventDetails();
  });
  ...
  describe('LambdaFunctionScheduleFailedEventDetails', function() {
    it('should create an instance of LambdaFunctionScheduleFailedEventDetails', function() {
      // uncomment below and update the code to test LambdaFunctionScheduleFailedEventDetails
      //var instance = new AwsStepFunctions.LambdaFunctionScheduleFailedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.LambdaFunctionScheduleFailedEventDetails);
    });
