...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.TagResourceInput();
  });
  ...
  describe('TagResourceInput', function() {
    it('should create an instance of TagResourceInput', function() {
      ...
      //var instance = new AwsStepFunctions.TagResourceInput();
      //expect(instance).to.be.a(AwsStepFunctions.TagResourceInput);
    });
