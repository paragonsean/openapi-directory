...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.HistoryEventMapRunStartedEventDetails();
  });
  ...
  describe('HistoryEventMapRunStartedEventDetails', function() {
    it('should create an instance of HistoryEventMapRunStartedEventDetails', function() {
      // uncomment below and update the code to test HistoryEventMapRunStartedEventDetails
      //var instance = new AwsStepFunctions.HistoryEventMapRunStartedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.HistoryEventMapRunStartedEventDetails);
    });
