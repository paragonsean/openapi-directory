...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.ActivityScheduleFailedEventDetails();
  });
  ...
  describe('ActivityScheduleFailedEventDetails', function() {
    it('should create an instance of ActivityScheduleFailedEventDetails', function() {
      // uncomment below and update the code to test ActivityScheduleFailedEventDetails
      //var instance = new AwsStepFunctions.ActivityScheduleFailedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.ActivityScheduleFailedEventDetails);
    });
