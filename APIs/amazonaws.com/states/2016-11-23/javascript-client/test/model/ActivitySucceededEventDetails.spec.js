...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.ActivitySucceededEventDetails();
  });
  ...
  describe('ActivitySucceededEventDetails', function() {
    it('should create an instance of ActivitySucceededEventDetails', function() {
      // uncomment below and update the code to test ActivitySucceededEventDetails
      //var instance = new AwsStepFunctions.ActivitySucceededEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.ActivitySucceededEventDetails);
    });
