...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.TaskFailedEventDetails();
  });
  ...
  describe('TaskFailedEventDetails', function() {
    it('should create an instance of TaskFailedEventDetails', function() {
      // uncomment below and update the code to test TaskFailedEventDetails
      //var instance = new AwsStepFunctions.TaskFailedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.TaskFailedEventDetails);
    });
