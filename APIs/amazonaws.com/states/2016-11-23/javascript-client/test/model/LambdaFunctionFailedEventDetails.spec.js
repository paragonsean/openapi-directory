...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.LambdaFunctionFailedEventDetails();
  });
  ...
  describe('LambdaFunctionFailedEventDetails', function() {
    it('should create an instance of LambdaFunctionFailedEventDetails', function() {
      // uncomment below and update the code to test LambdaFunctionFailedEventDetails
      //var instance = new AwsStepFunctions.LambdaFunctionFailedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.LambdaFunctionFailedEventDetails);
    });
