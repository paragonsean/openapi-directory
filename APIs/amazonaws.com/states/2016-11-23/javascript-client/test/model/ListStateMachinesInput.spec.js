...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.ListStateMachinesInput();
  });
  ...
  describe('ListStateMachinesInput', function() {
    it('should create an instance of ListStateMachinesInput', function() {
      // uncomment below and update the code to test ListStateMachinesInput
      //var instance = new AwsStepFunctions.ListStateMachinesInput();
      //expect(instance).to.be.a(AwsStepFunctions.ListStateMachinesInput);
    });
