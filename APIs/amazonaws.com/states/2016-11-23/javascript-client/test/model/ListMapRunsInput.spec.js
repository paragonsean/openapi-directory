...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.ListMapRunsInput();
  });
  ...
  describe('ListMapRunsInput', function() {
    it('should create an instance of ListMapRunsInput', function() {
      // uncomment below and update the code to test ListMapRunsInput
      //var instance = new AwsStepFunctions.ListMapRunsInput();
      //expect(instance).to.be.a(AwsStepFunctions.ListMapRunsInput);
    });
