...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.ListStateMachinesOutput();
  });
  ...
  describe('ListStateMachinesOutput', function() {
    it('should create an instance of ListStateMachinesOutput', function() {
      // uncomment below and update the code to test ListStateMachinesOutput
      //var instance = new AwsStepFunctions.ListStateMachinesOutput();
      //expect(instance).to.be.a(AwsStepFunctions.ListStateMachinesOutput);
    });

    it('should have the property stateMachines (base name: "stateMachines")', function() {
      // uncomment below and update the code to test the property stateMachines
      //var instance = new AwsStepFunctions.ListStateMachinesOutput();
