...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.SendTaskSuccessInput();
  });
  ...
  describe('SendTaskSuccessInput', function() {
    it('should create an instance of SendTaskSuccessInput', function() {
      // uncomment below and update the code to test SendTaskSuccessInput
      //var instance = new AwsStepFunctions.SendTaskSuccessInput();
      //expect(instance).to.be.a(AwsStepFunctions.SendTaskSuccessInput);
    });
