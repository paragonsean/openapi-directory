...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.MapRunFailedEventDetails();
  });
  ...
  describe('MapRunFailedEventDetails', function() {
    it('should create an instance of MapRunFailedEventDetails', function() {
      // uncomment below and update the code to test MapRunFailedEventDetails
      //var instance = new AwsStepFunctions.MapRunFailedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.MapRunFailedEventDetails);
    });
