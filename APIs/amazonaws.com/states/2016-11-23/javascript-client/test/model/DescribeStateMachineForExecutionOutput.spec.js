...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.DescribeStateMachineForExecutionOutput();
  });
  ...
  describe('DescribeStateMachineForExecutionOutput', function() {
    it('should create an instance of DescribeStateMachineForExecutionOutput', function() {
      // uncomment below and update the code to test DescribeStateMachineForExecutionOutput
      //var instance = new AwsStepFunctions.DescribeStateMachineForExecutionOutput();
      //expect(instance).to.be.a(AwsStepFunctions.DescribeStateMachineForExecutionOutput);
    });

    it('should have the property stateMachineArn (base name: "stateMachineArn")', function() {
      // uncomment below and update the code to test the property stateMachineArn
      //var instance = new AwsStepFunctions.DescribeStateMachineForExecutionOutput();
    ...
    it('should have the property mapRunArn (base name: "mapRunArn")', function() {
      // uncomment below and update the code to test the property mapRunArn
      //var instance = new AwsStepFunctions.DescribeStateMachineForExecutionOutput();
      //expect(instance).to.be();
    });
