...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.SendTaskHeartbeatInput();
  });
  ...
  describe('SendTaskHeartbeatInput', function() {
    it('should create an instance of SendTaskHeartbeatInput', function() {
      // uncomment below and update the code to test SendTaskHeartbeatInput
      //var instance = new AwsStepFunctions.SendTaskHeartbeatInput();
      //expect(instance).to.be.a(AwsStepFunctions.SendTaskHeartbeatInput);
    });
