...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.LambdaFunctionTimedOutEventDetails();
  });
  ...
  describe('LambdaFunctionTimedOutEventDetails', function() {
    it('should create an instance of LambdaFunctionTimedOutEventDetails', function() {
      // uncomment below and update the code to test LambdaFunctionTimedOutEventDetails
      //var instance = new AwsStepFunctions.LambdaFunctionTimedOutEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.LambdaFunctionTimedOutEventDetails);
    });
