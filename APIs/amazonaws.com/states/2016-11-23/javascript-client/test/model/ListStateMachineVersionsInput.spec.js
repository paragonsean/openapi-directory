...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.ListStateMachineVersionsInput();
  });
  ...
  describe('ListStateMachineVersionsInput', function() {
    it('should create an instance of ListStateMachineVersionsInput', function() {
      // uncomment below and update the code to test ListStateMachineVersionsInput
      //var instance = new AwsStepFunctions.ListStateMachineVersionsInput();
      //expect(instance).to.be.a(AwsStepFunctions.ListStateMachineVersionsInput);
    });
