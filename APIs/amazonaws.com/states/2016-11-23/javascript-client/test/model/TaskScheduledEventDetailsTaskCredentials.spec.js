...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.TaskScheduledEventDetailsTaskCredentials();
  });
  ...
  describe('TaskScheduledEventDetailsTaskCredentials', function() {
    it('should create an instance of TaskScheduledEventDetailsTaskCredentials', function() {
      // uncomment below and update the code to test TaskScheduledEventDetailsTaskCredentials
      //var instance = new AwsStepFunctions.TaskScheduledEventDetailsTaskCredentials();
      //expect(instance).to.be.a(AwsStepFunctions.TaskScheduledEventDetailsTaskCredentials);
    });
