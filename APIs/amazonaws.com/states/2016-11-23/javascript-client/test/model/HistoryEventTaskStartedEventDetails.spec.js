...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.HistoryEventTaskStartedEventDetails();
  });
  ...
  describe('HistoryEventTaskStartedEventDetails', function() {
    it('should create an instance of HistoryEventTaskStartedEventDetails', function() {
      // uncomment below and update the code to test HistoryEventTaskStartedEventDetails
      //var instance = new AwsStepFunctions.HistoryEventTaskStartedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.HistoryEventTaskStartedEventDetails);
    });
