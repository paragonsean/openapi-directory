...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.ExecutionFailedEventDetails();
  });
  ...
  describe('ExecutionFailedEventDetails', function() {
    it('should create an instance of ExecutionFailedEventDetails', function() {
      // uncomment below and update the code to test ExecutionFailedEventDetails
      //var instance = new AwsStepFunctions.ExecutionFailedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.ExecutionFailedEventDetails);
    });
