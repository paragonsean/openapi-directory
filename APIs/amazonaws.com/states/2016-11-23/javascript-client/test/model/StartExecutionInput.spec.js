...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.StartExecutionInput();
  });
  ...
  describe('StartExecutionInput', function() {
    it('should create an instance of StartExecutionInput', function() {
      // uncomment below and update the code to test StartExecutionInput
      //var instance = new AwsStepFunctions.StartExecutionInput();
      //expect(instance).to.be.a(AwsStepFunctions.StartExecutionInput);
    });
