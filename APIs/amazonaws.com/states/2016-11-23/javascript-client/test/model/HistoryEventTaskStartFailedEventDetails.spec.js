...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.HistoryEventTaskStartFailedEventDetails();
  });
  ...
  describe('HistoryEventTaskStartFailedEventDetails', function() {
    it('should create an instance of HistoryEventTaskStartFailedEventDetails', function() {
      // uncomment below and update the code to test HistoryEventTaskStartFailedEventDetails
      //var instance = new AwsStepFunctions.HistoryEventTaskStartFailedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.HistoryEventTaskStartFailedEventDetails);
    });
