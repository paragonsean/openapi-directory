...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.DescribeActivityOutput();
  });
  ...
  describe('DescribeActivityOutput', function() {
    it('should create an instance of DescribeActivityOutput', function() {
      // uncomment below and update the code to test DescribeActivityOutput
      //var instance = new AwsStepFunctions.DescribeActivityOutput();
      //expect(instance).to.be.a(AwsStepFunctions.DescribeActivityOutput);
    });

    it('should have the property activityArn (base name: "activityArn")', function() {
      // uncomment below and update the code to test the property activityArn
      //var instance = new AwsStepFunctions.DescribeActivityOutput();
