...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.ListStateMachineVersionsOutput();
  });
  ...
  describe('ListStateMachineVersionsOutput', function() {
    it('should create an instance of ListStateMachineVersionsOutput', function() {
      // uncomment below and update the code to test ListStateMachineVersionsOutput
      //var instance = new AwsStepFunctions.ListStateMachineVersionsOutput();
      //expect(instance).to.be.a(AwsStepFunctions.ListStateMachineVersionsOutput);
    });

    it('should have the property stateMachineVersions (base name: "stateMachineVersions")', function() {
      // uncomment below and update the code to test the property stateMachineVersions
      //var instance = new AwsStepFunctions.ListStateMachineVersionsOutput();
