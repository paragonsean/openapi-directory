...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.ExecutionStartedEventDetails();
  });
  ...
  describe('ExecutionStartedEventDetails', function() {
    it('should create an instance of ExecutionStartedEventDetails', function() {
      // uncomment below and update the code to test ExecutionStartedEventDetails
      //var instance = new AwsStepFunctions.ExecutionStartedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.ExecutionStartedEventDetails);
    });
