...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.HistoryEventTaskFailedEventDetails();
  });
  ...
  describe('HistoryEventTaskFailedEventDetails', function() {
    it('should create an instance of HistoryEventTaskFailedEventDetails', function() {
      // uncomment below and update the code to test HistoryEventTaskFailedEventDetails
      //var instance = new AwsStepFunctions.HistoryEventTaskFailedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.HistoryEventTaskFailedEventDetails);
    });
