...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.DeleteStateMachineAliasInput();
  });
  ...
  describe('DeleteStateMachineAliasInput', function() {
    it('should create an instance of DeleteStateMachineAliasInput', function() {
      // uncomment below and update the code to test DeleteStateMachineAliasInput
      //var instance = new AwsStepFunctions.DeleteStateMachineAliasInput();
      //expect(instance).to.be.a(AwsStepFunctions.DeleteStateMachineAliasInput);
    });
