...
(function(root, factory) {
  ...
  describe('SyncExecutionStatus', function() {
    it('should create an instance of SyncExecutionStatus', function() {
      // uncomment below and update the code to test SyncExecutionStatus
      //var instance = new AwsStepFunctions.SyncExecutionStatus();
      //expect(instance).to.be.a(AwsStepFunctions.SyncExecutionStatus);
    });
