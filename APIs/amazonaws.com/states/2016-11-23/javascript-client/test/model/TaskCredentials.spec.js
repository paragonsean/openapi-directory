...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.TaskCredentials();
  });
  ...
  describe('TaskCredentials', function() {
    it('should create an instance of TaskCredentials', function() {
      // uncomment below and update the code to test TaskCredentials
      //var instance = new AwsStepFunctions.TaskCredentials();
      //expect(instance).to.be.a(AwsStepFunctions.TaskCredentials);
    });
