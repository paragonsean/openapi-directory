...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.StateMachineAliasListItem();
  });
  ...
  describe('StateMachineAliasListItem', function() {
    it('should create an instance of StateMachineAliasListItem', function() {
      // uncomment below and update the code to test StateMachineAliasListItem
      //var instance = new AwsStepFunctions.StateMachineAliasListItem();
      //expect(instance).to.be.a(AwsStepFunctions.StateMachineAliasListItem);
    });

    it('should have the property stateMachineAliasArn (base name: "stateMachineAliasArn")', function() {
      // uncomment below and update the code to test the property stateMachineAliasArn
      //var instance = new AwsStepFunctions.StateMachineAliasListItem();
