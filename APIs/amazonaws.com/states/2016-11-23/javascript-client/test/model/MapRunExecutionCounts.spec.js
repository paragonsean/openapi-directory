...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.MapRunExecutionCounts();
  });
  ...
  describe('MapRunExecutionCounts', function() {
    it('should create an instance of MapRunExecutionCounts', function() {
      // uncomment below and update the code to test MapRunExecutionCounts
      //var instance = new AwsStepFunctions.MapRunExecutionCounts();
      //expect(instance).to.be.a(AwsStepFunctions.MapRunExecutionCounts);
    });
    ...
    it('should have the property resultsWritten (base name: "resultsWritten")', function() {
      // uncomment below and update the code to test the property resultsWritten
      //var instance = new AwsStepFunctions.MapRunExecutionCounts();
      //expect(instance).to.be();
    });
