...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.CreateActivityOutput();
  });
  ...
  describe('CreateActivityOutput', function() {
    it('should create an instance of CreateActivityOutput', function() {
      // uncomment below and update the code to test CreateActivityOutput
      //var instance = new AwsStepFunctions.CreateActivityOutput();
      //expect(instance).to.be.a(AwsStepFunctions.CreateActivityOutput);
    });
