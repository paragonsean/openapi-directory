...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.HistoryEventTaskSubmittedEventDetails();
  });
  ...
  describe('HistoryEventTaskSubmittedEventDetails', function() {
    it('should create an instance of HistoryEventTaskSubmittedEventDetails', function() {
      // uncomment below and update the code to test HistoryEventTaskSubmittedEventDetails
      //var instance = new AwsStepFunctions.HistoryEventTaskSubmittedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.HistoryEventTaskSubmittedEventDetails);
    });
