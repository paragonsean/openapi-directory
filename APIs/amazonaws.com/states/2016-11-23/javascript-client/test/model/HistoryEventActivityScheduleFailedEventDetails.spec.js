...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.HistoryEventActivityScheduleFailedEventDetails();
  });
  ...
  describe('HistoryEventActivityScheduleFailedEventDetails', function() {
    it('should create an instance of HistoryEventActivityScheduleFailedEventDetails', function() {
      // uncomment below and update the code to test HistoryEventActivityScheduleFailedEventDetails
      //var instance = new AwsStepFunctions.HistoryEventActivityScheduleFailedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.HistoryEventActivityScheduleFailedEventDetails);
    });
