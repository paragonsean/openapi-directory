...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.DescribeMapRunOutputExecutionCounts();
  });
  ...
  describe('DescribeMapRunOutputExecutionCounts', function() {
    it('should create an instance of DescribeMapRunOutputExecutionCounts', function() {
      // uncomment below and update the code to test DescribeMapRunOutputExecutionCounts
      //var instance = new AwsStepFunctions.DescribeMapRunOutputExecutionCounts();
      //expect(instance).to.be.a(AwsStepFunctions.DescribeMapRunOutputExecutionCounts);
    });
