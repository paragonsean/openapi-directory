...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.CreateStateMachineInputTracingConfiguration();
  });
  ...
  describe('CreateStateMachineInputTracingConfiguration', function() {
    it('should create an instance of CreateStateMachineInputTracingConfiguration', function() {
      // uncomment below and update the code to test CreateStateMachineInputTracingConfiguration
      //var instance = new AwsStepFunctions.CreateStateMachineInputTracingConfiguration();
      //expect(instance).to.be.a(AwsStepFunctions.CreateStateMachineInputTracingConfiguration);
    });
