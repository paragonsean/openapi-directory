...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.CreateStateMachineAliasOutput();
  });
  ...
  describe('CreateStateMachineAliasOutput', function() {
    it('should create an instance of CreateStateMachineAliasOutput', function() {
      // uncomment below and update the code to test CreateStateMachineAliasOutput
      //var instance = new AwsStepFunctions.CreateStateMachineAliasOutput();
      //expect(instance).to.be.a(AwsStepFunctions.CreateStateMachineAliasOutput);
    });
