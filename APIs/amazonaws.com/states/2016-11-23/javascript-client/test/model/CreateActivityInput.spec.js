...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.CreateActivityInput();
  });
  ...
  describe('CreateActivityInput', function() {
    it('should create an instance of CreateActivityInput', function() {
      // uncomment below and update the code to test CreateActivityInput
      //var instance = new AwsStepFunctions.CreateActivityInput();
      //expect(instance).to.be.a(AwsStepFunctions.CreateActivityInput);
    });
