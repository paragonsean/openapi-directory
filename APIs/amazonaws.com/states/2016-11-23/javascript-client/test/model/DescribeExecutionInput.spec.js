...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.DescribeExecutionInput();
  });
  ...
  describe('DescribeExecutionInput', function() {
    it('should create an instance of DescribeExecutionInput', function() {
      // uncomment below and update the code to test DescribeExecutionInput
      //var instance = new AwsStepFunctions.DescribeExecutionInput();
      //expect(instance).to.be.a(AwsStepFunctions.DescribeExecutionInput);
    });
