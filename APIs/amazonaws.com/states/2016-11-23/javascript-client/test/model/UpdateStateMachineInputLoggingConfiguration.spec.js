...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.UpdateStateMachineInputLoggingConfiguration();
  });
  ...
  describe('UpdateStateMachineInputLoggingConfiguration', function() {
    it('should create an instance of UpdateStateMachineInputLoggingConfiguration', function() {
      // uncomment below and update the code to test UpdateStateMachineInputLoggingConfiguration
      //var instance = new AwsStepFunctions.UpdateStateMachineInputLoggingConfiguration();
      //expect(instance).to.be.a(AwsStepFunctions.UpdateStateMachineInputLoggingConfiguration);
    });
    ...
    it('should have the property includeExecutionData (base name: "includeExecutionData")', function() {
      // uncomment below and update the code to test the property includeExecutionData
      //var instance = new AwsStepFunctions.UpdateStateMachineInputLoggingConfiguration();
      //expect(instance).to.be();
    });
