...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.LambdaFunctionScheduledEventDetailsInputDetails();
  });
  ...
  describe('LambdaFunctionScheduledEventDetailsInputDetails', function() {
    it('should create an instance of LambdaFunctionScheduledEventDetailsInputDetails', function() {
      // uncomment below and update the code to test LambdaFunctionScheduledEventDetailsInputDetails
      //var instance = new AwsStepFunctions.LambdaFunctionScheduledEventDetailsInputDetails();
      //expect(instance).to.be.a(AwsStepFunctions.LambdaFunctionScheduledEventDetailsInputDetails);
    });
