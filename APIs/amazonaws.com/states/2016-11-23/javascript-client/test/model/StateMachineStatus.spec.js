...
(function(root, factory) {
  ...
  describe('StateMachineStatus', function() {
    it('should create an instance of StateMachineStatus', function() {
      // uncomment below and update the code to test StateMachineStatus
      //var instance = new AwsStepFunctions.StateMachineStatus();
      //expect(instance).to.be.a(AwsStepFunctions.StateMachineStatus);
    });
