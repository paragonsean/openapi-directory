...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.StateMachineVersionListItem();
  });
  ...
  describe('StateMachineVersionListItem', function() {
    it('should create an instance of StateMachineVersionListItem', function() {
      // uncomment below and update the code to test StateMachineVersionListItem
      //var instance = new AwsStepFunctions.StateMachineVersionListItem();
      //expect(instance).to.be.a(AwsStepFunctions.StateMachineVersionListItem);
    });
