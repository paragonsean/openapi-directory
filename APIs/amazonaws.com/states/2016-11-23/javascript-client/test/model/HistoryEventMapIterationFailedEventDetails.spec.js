...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.HistoryEventMapIterationFailedEventDetails();
  });
  ...
  describe('HistoryEventMapIterationFailedEventDetails', function() {
    it('should create an instance of HistoryEventMapIterationFailedEventDetails', function() {
      // uncomment below and update the code to test HistoryEventMapIterationFailedEventDetails
      //var instance = new AwsStepFunctions.HistoryEventMapIterationFailedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.HistoryEventMapIterationFailedEventDetails);
    });
