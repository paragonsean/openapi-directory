...
(function(root, factory) {
  ...
  describe('MapRunStatus', function() {
    it('should create an instance of MapRunStatus', function() {
      // uncomment below and update the code to test MapRunStatus
      //var instance = new AwsStepFunctions.MapRunStatus();
      //expect(instance).to.be.a(AwsStepFunctions.MapRunStatus);
    });
