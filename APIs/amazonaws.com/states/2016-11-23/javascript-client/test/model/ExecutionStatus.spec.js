...
(function(root, factory) {
  ...
  describe('ExecutionStatus', function() {
    it('should create an instance of ExecutionStatus', function() {
      // uncomment below and update the code to test ExecutionStatus
      //var instance = new AwsStepFunctions.ExecutionStatus();
      //expect(instance).to.be.a(AwsStepFunctions.ExecutionStatus);
    });
