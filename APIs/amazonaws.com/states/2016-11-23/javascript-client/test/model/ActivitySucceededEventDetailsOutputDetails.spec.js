...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.ActivitySucceededEventDetailsOutputDetails();
  });
  ...
  describe('ActivitySucceededEventDetailsOutputDetails', function() {
    it('should create an instance of ActivitySucceededEventDetailsOutputDetails', function() {
      // uncomment below and update the code to test ActivitySucceededEventDetailsOutputDetails
      //var instance = new AwsStepFunctions.ActivitySucceededEventDetailsOutputDetails();
      //expect(instance).to.be.a(AwsStepFunctions.ActivitySucceededEventDetailsOutputDetails);
    });
