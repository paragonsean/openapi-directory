...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.StateMachineListItem();
  });
  ...
  describe('StateMachineListItem', function() {
    it('should create an instance of StateMachineListItem', function() {
      // uncomment below and update the code to test StateMachineListItem
      //var instance = new AwsStepFunctions.StateMachineListItem();
      //expect(instance).to.be.a(AwsStepFunctions.StateMachineListItem);
    });
