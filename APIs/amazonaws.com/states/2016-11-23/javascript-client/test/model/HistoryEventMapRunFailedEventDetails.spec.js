...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsStepFunctions.HistoryEventMapRunFailedEventDetails();
  });
  ...
  describe('HistoryEventMapRunFailedEventDetails', function() {
    it('should create an instance of HistoryEventMapRunFailedEventDetails', function() {
      // uncomment below and update the code to test HistoryEventMapRunFailedEventDetails
      //var instance = new AwsStepFunctions.HistoryEventMapRunFailedEventDetails();
      //expect(instance).to.be.a(AwsStepFunctions.HistoryEventMapRunFailedEventDetails);
    });
