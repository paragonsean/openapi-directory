...
class StreamSelection(Model):
    ...
    def __init__(self, max_video_bits_per_second: int=None, min_video_bits_per_second: int=None, stream_order: StreamOrder=None):
        """StreamSelection - a model defined in OpenAPI

        :param max_video_bits_per_second: The max_video_bits_per_second of this StreamSelection.
        :param min_video_bits_per_second: The min_video_bits_per_second of this StreamSelection.
        :param stream_order: The stream_order of this StreamSelection.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'StreamSelection':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The StreamSelection of this StreamSelection.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def max_video_bits_per_second(self):
        """Gets the max_video_bits_per_second of this StreamSelection.


        :return: The max_video_bits_per_second of this StreamSelection.
        :rtype: int
        """
    ...
    def max_video_bits_per_second(self, max_video_bits_per_second):
        """Sets the max_video_bits_per_second of this StreamSelection.
    ...
    def min_video_bits_per_second(self):
        """Gets the min_video_bits_per_second of this StreamSelection.


        :return: The min_video_bits_per_second of this StreamSelection.
        :rtype: int
        """
    ...
    def min_video_bits_per_second(self, min_video_bits_per_second):
        """Sets the min_video_bits_per_second of this StreamSelection.
    ...
    def stream_order(self):
        """Gets the stream_order of this StreamSelection.


        :return: The stream_order of this StreamSelection.
        :rtype: StreamOrder
        """
    ...
    def stream_order(self, stream_order):
        """Sets the stream_order of this StreamSelection.
