...
public class ApiClient {
    ...
    private String basePath = "http://mediapackage.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://mediapackage.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "http://mediapackage.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://mediapackage.{region}.amazonaws.com.cn",
      "The MediaPackage endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2017-10-12/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://mediapackage.us-east-1.amazonaws.com
