...
public class ConfigureLogsResponse {
  ...
  public ConfigureLogsResponse() {
  }

  public ConfigureLogsResponse arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public ConfigureLogsResponse createdAt(String createdAt) {
  ...
  public ConfigureLogsResponse description(String description) {
  ...
  public ConfigureLogsResponse egressAccessLogs(ConfigureLogsResponseEgressAccessLogs egressAccessLogs) {
  ...
  public ConfigureLogsResponse hlsIngest(ConfigureLogsResponseHlsIngest hlsIngest) {
  ...
  public ConfigureLogsResponse id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ConfigureLogsResponse ingressAccessLogs(ConfigureLogsResponseIngressAccessLogs ingressAccessLogs) {
  ...
  public ConfigureLogsResponse tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ConfigureLogsResponse configureLogsResponse = (ConfigureLogsResponse) o;
    return Objects.equals(this.arn, configureLogsResponse.arn) &&
        Objects.equals(this.createdAt, configureLogsResponse.createdAt) &&
        Objects.equals(this.description, configureLogsResponse.description) &&
        Objects.equals(this.egressAccessLogs, configureLogsResponse.egressAccessLogs) &&
        Objects.equals(this.hlsIngest, configureLogsResponse.hlsIngest) &&
        Objects.equals(this.id, configureLogsResponse.id) &&
        Objects.equals(this.ingressAccessLogs, configureLogsResponse.ingressAccessLogs) &&
        Objects.equals(this.tags, configureLogsResponse.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConfigureLogsResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConfigureLogsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConfigureLogsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConfigureLogsResponse is not found in the empty JSON string", ConfigureLogsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConfigureLogsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConfigureLogsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConfigureLogsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConfigureLogsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConfigureLogsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConfigureLogsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ConfigureLogsResponse>() {
           @Override
           public void write(JsonWriter out, ConfigureLogsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConfigureLogsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConfigureLogsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConfigureLogsResponse
   * @throws IOException if the JSON string is invalid with respect to ConfigureLogsResponse
   */
  public static ConfigureLogsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConfigureLogsResponse.class);
  }

  /**
   * Convert an instance of ConfigureLogsResponse to an JSON string
   *
   * @return JSON string
   */
