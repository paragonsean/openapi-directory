...
public class HarvestJob {
  ...
  public HarvestJob arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public HarvestJob channelId(String channelId) {
  ...
  public HarvestJob createdAt(String createdAt) {
  ...
  public HarvestJob endTime(String endTime) {
  ...
  public HarvestJob originEndpointId(String originEndpointId) {
  ...
  public HarvestJob s3Destination(CreateHarvestJobResponseS3Destination s3Destination) {
  ...
  public HarvestJob startTime(String startTime) {
  ...
  public HarvestJob status(Status status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.arn, harvestJob.arn) &&
        Objects.equals(this.channelId, harvestJob.channelId) &&
        Objects.equals(this.createdAt, harvestJob.createdAt) &&
        Objects.equals(this.endTime, harvestJob.endTime) &&
        Objects.equals(this.id, harvestJob.id) &&
        Objects.equals(this.originEndpointId, harvestJob.originEndpointId) &&
        Objects.equals(this.s3Destination, harvestJob.s3Destination) &&
        Objects.equals(this.startTime, harvestJob.startTime) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to HarvestJob
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HarvestJob.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HarvestJob is not found in the empty JSON string", HarvestJob.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HarvestJob.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HarvestJob` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HarvestJob.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HarvestJob' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HarvestJob> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HarvestJob.class));

       return (TypeAdapter<T>) new TypeAdapter<HarvestJob>() {
           @Override
           public void write(JsonWriter out, HarvestJob value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HarvestJob read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of HarvestJob given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HarvestJob
   * @throws IOException if the JSON string is invalid with respect to HarvestJob
   */
  public static HarvestJob fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HarvestJob.class);
  }

  /**
   * Convert an instance of HarvestJob to an JSON string
   *
   * @return JSON string
   */
