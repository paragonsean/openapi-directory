# AwsElementalMediaPackage.CreateOriginEndpointRequest
...
**startoverWindowSeconds** | **Number** | Maximum duration (seconds) of content to retain for startover playback. If not specified, startover playback will be disabled for the OriginEndpoint.  | [optional] 
**tags** | **{String: String}** | A collection of tags associated with a resource | [optional] 
**timeDelaySeconds** | **Number** | Amount of delay (seconds) to enforce on the playback of live content. If not specified, there will be no time delay in effect for the OriginEndpoint.  | [optional] 
