...
class CmafEncryptionSpekeKeyProvider {
    ...
    constructor(resourceId, roleArn, systemIds, url) { 
        ...
        CmafEncryptionSpekeKeyProvider.initialize(this, resourceId, roleArn, systemIds, url);
    }
...
CmafEncryptionSpekeKeyProvider.RequiredProperties = ["ResourceId", "RoleArn", "SystemIds", "Url"];

/**
 * @member {String} CertificateArn
 */
CmafEncryptionSpekeKeyProvider.prototype['CertificateArn'] = undefined;
 ...
 */
CmafEncryptionSpekeKeyProvider.prototype['ResourceId'] = undefined;
