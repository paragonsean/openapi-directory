...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackage.ListChannelsResponse();
  });
  ...
  describe('ListChannelsResponse', function() {
    it('should create an instance of ListChannelsResponse', function() {
      ...
      //var instance = new AwsElementalMediaPackage.ListChannelsResponse();
      //expect(instance).to.be.a(AwsElementalMediaPackage.ListChannelsResponse);
    });
