...
/*
 * OAIHlsManifestCreateOrUpdateParameters.h
 *
 * A HTTP Live Streaming (HLS) manifest configuration.
 */

#ifndef OAIHlsManifestCreateOrUpdateParameters_H
#define OAIHlsManifestCreateOrUpdateParameters_H
...
class OAIHlsManifestCreateOrUpdateParameters : public OAIObject {
public:
    OAIHlsManifestCreateOrUpdateParameters();
    OAIHlsManifestCreateOrUpdateParameters(QString json);
    ~OAIHlsManifestCreateOrUpdateParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHlsManifestCreateOrUpdateParameters)

#endif // OAIHlsManifestCreateOrUpdateParameters_H
