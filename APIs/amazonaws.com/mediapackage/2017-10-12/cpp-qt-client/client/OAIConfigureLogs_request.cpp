...
OAIConfigureLogs_request_ingressAccessLogs OAIConfigureLogs_request::getIngressAccessLogs() const {
    return m_ingress_access_logs;
}
void OAIConfigureLogs_request::setIngressAccessLogs(const OAIConfigureLogs_request_ingressAccessLogs &ingress_access_logs) {
    m_ingress_access_logs = ingress_access_logs;
    m_ingress_access_logs_isSet = true;
}

bool OAIConfigureLogs_request::is_ingress_access_logs_Set() const{
    return m_ingress_access_logs_isSet;
}

bool OAIConfigureLogs_request::is_ingress_access_logs_Valid() const{
