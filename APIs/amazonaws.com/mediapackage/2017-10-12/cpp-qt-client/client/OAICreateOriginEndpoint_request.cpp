...
OAICreateOriginEndpoint_request_authorization OAICreateOriginEndpoint_request::getAuthorization() const {
    return m_authorization;
}
void OAICreateOriginEndpoint_request::setAuthorization(const OAICreateOriginEndpoint_request_authorization &authorization) {
    m_authorization = authorization;
    m_authorization_isSet = true;
}

bool OAICreateOriginEndpoint_request::is_authorization_Set() const{
    return m_authorization_isSet;
}

bool OAICreateOriginEndpoint_request::is_authorization_Valid() const{
    return m_authorization_isValid;
}

QString OAICreateOriginEndpoint_request::getChannelId() const {
    return m_channel_id;
}
void OAICreateOriginEndpoint_request::setChannelId(const QString &channel_id) {
    m_channel_id = channel_id;
    m_channel_id_isSet = true;
}

bool OAICreateOriginEndpoint_request::is_channel_id_Set() const{
    return m_channel_id_isSet;
}

bool OAICreateOriginEndpoint_request::is_channel_id_Valid() const{
    return m_channel_id_isValid;
}

OAICreateOriginEndpoint_request_cmafPackage OAICreateOriginEndpoint_request::getCmafPackage() const {
    return m_cmaf_package;
}
void OAICreateOriginEndpoint_request::setCmafPackage(const OAICreateOriginEndpoint_request_cmafPackage &cmaf_package) {
    m_cmaf_package = cmaf_package;
    m_cmaf_package_isSet = true;
}

bool OAICreateOriginEndpoint_request::is_cmaf_package_Set() const{
    return m_cmaf_package_isSet;
}

bool OAICreateOriginEndpoint_request::is_cmaf_package_Valid() const{
    return m_cmaf_package_isValid;
}

OAICreateOriginEndpoint_request_dashPackage OAICreateOriginEndpoint_request::getDashPackage() const {
    return m_dash_package;
}
void OAICreateOriginEndpoint_request::setDashPackage(const OAICreateOriginEndpoint_request_dashPackage &dash_package) {
    m_dash_package = dash_package;
    m_dash_package_isSet = true;
}

bool OAICreateOriginEndpoint_request::is_dash_package_Set() const{
    return m_dash_package_isSet;
}

bool OAICreateOriginEndpoint_request::is_dash_package_Valid() const{
...
OAICreateOriginEndpoint_request_hlsPackage OAICreateOriginEndpoint_request::getHlsPackage() const {
    return m_hls_package;
}
void OAICreateOriginEndpoint_request::setHlsPackage(const OAICreateOriginEndpoint_request_hlsPackage &hls_package) {
    m_hls_package = hls_package;
    m_hls_package_isSet = true;
}

bool OAICreateOriginEndpoint_request::is_hls_package_Set() const{
    return m_hls_package_isSet;
}

bool OAICreateOriginEndpoint_request::is_hls_package_Valid() const{
    return m_hls_package_isValid;
}

QString OAICreateOriginEndpoint_request::getId() const {
    return m_id;
}
void OAICreateOriginEndpoint_request::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICreateOriginEndpoint_request::is_id_Set() const{
    return m_id_isSet;
}

bool OAICreateOriginEndpoint_request::is_id_Valid() const{
    return m_id_isValid;
}

QString OAICreateOriginEndpoint_request::getManifestName() const {
    return m_manifest_name;
}
void OAICreateOriginEndpoint_request::setManifestName(const QString &manifest_name) {
    m_manifest_name = manifest_name;
    m_manifest_name_isSet = true;
}

bool OAICreateOriginEndpoint_request::is_manifest_name_Set() const{
    return m_manifest_name_isSet;
}

bool OAICreateOriginEndpoint_request::is_manifest_name_Valid() const{
    return m_manifest_name_isValid;
}

OAICreateOriginEndpoint_request_mssPackage OAICreateOriginEndpoint_request::getMssPackage() const {
    return m_mss_package;
}
void OAICreateOriginEndpoint_request::setMssPackage(const OAICreateOriginEndpoint_request_mssPackage &mss_package) {
    m_mss_package = mss_package;
    m_mss_package_isSet = true;
}

bool OAICreateOriginEndpoint_request::is_mss_package_Set() const{
    return m_mss_package_isSet;
}

bool OAICreateOriginEndpoint_request::is_mss_package_Valid() const{
    return m_mss_package_isValid;
}

QString OAICreateOriginEndpoint_request::getOrigination() const {
    return m_origination;
}
void OAICreateOriginEndpoint_request::setOrigination(const QString &origination) {
    m_origination = origination;
    m_origination_isSet = true;
}

bool OAICreateOriginEndpoint_request::is_origination_Set() const{
    return m_origination_isSet;
}

bool OAICreateOriginEndpoint_request::is_origination_Valid() const{
...
qint32 OAICreateOriginEndpoint_request::getTimeDelaySeconds() const {
    return m_time_delay_seconds;
}
void OAICreateOriginEndpoint_request::setTimeDelaySeconds(const qint32 &time_delay_seconds) {
    m_time_delay_seconds = time_delay_seconds;
    m_time_delay_seconds_isSet = true;
}

bool OAICreateOriginEndpoint_request::is_time_delay_seconds_Set() const{
    return m_time_delay_seconds_isSet;
}

bool OAICreateOriginEndpoint_request::is_time_delay_seconds_Valid() const{
    return m_time_delay_seconds_isValid;
}

QList<QString> OAICreateOriginEndpoint_request::getWhitelist() const {
    return m_whitelist;
}
void OAICreateOriginEndpoint_request::setWhitelist(const QList<QString> &whitelist) {
    m_whitelist = whitelist;
    m_whitelist_isSet = true;
}

bool OAICreateOriginEndpoint_request::is_whitelist_Set() const{
    return m_whitelist_isSet;
}

bool OAICreateOriginEndpoint_request::is_whitelist_Valid() const{
