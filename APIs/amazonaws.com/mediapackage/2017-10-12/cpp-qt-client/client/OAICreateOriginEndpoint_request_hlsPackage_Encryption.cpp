...
OAICreateOriginEndpoint_request_hlsPackage_Encryption::OAICreateOriginEndpoint_request_hlsPackage_Encryption(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateOriginEndpoint_request_hlsPackage_Encryption::OAICreateOriginEndpoint_request_hlsPackage_Encryption() {
    this->initializeModel();
}

OAICreateOriginEndpoint_request_hlsPackage_Encryption::~OAICreateOriginEndpoint_request_hlsPackage_Encryption() {}

void OAICreateOriginEndpoint_request_hlsPackage_Encryption::initializeModel() {
...
void OAICreateOriginEndpoint_request_hlsPackage_Encryption::fromJson(QString jsonString) {
...
void OAICreateOriginEndpoint_request_hlsPackage_Encryption::fromJsonObject(QJsonObject json) {
...
QString OAICreateOriginEndpoint_request_hlsPackage_Encryption::asJson() const {
...
QJsonObject OAICreateOriginEndpoint_request_hlsPackage_Encryption::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateOriginEndpoint_request_hlsPackage_Encryption::getConstantInitializationVector() const {
    return m_constant_initialization_vector;
}
void OAICreateOriginEndpoint_request_hlsPackage_Encryption::setConstantInitializationVector(const QString &constant_initialization_vector) {
    m_constant_initialization_vector = constant_initialization_vector;
    m_constant_initialization_vector_isSet = true;
}

bool OAICreateOriginEndpoint_request_hlsPackage_Encryption::is_constant_initialization_vector_Set() const{
    return m_constant_initialization_vector_isSet;
}

bool OAICreateOriginEndpoint_request_hlsPackage_Encryption::is_constant_initialization_vector_Valid() const{
    return m_constant_initialization_vector_isValid;
}

OAIEncryptionMethod OAICreateOriginEndpoint_request_hlsPackage_Encryption::getEncryptionMethod() const {
    return m_encryption_method;
}
void OAICreateOriginEndpoint_request_hlsPackage_Encryption::setEncryptionMethod(const OAIEncryptionMethod &encryption_method) {
    m_encryption_method = encryption_method;
    m_encryption_method_isSet = true;
}

bool OAICreateOriginEndpoint_request_hlsPackage_Encryption::is_encryption_method_Set() const{
    return m_encryption_method_isSet;
}

bool OAICreateOriginEndpoint_request_hlsPackage_Encryption::is_encryption_method_Valid() const{
    return m_encryption_method_isValid;
}

qint32 OAICreateOriginEndpoint_request_hlsPackage_Encryption::getKeyRotationIntervalSeconds() const {
    return m_key_rotation_interval_seconds;
}
void OAICreateOriginEndpoint_request_hlsPackage_Encryption::setKeyRotationIntervalSeconds(const qint32 &key_rotation_interval_seconds) {
    m_key_rotation_interval_seconds = key_rotation_interval_seconds;
    m_key_rotation_interval_seconds_isSet = true;
}

bool OAICreateOriginEndpoint_request_hlsPackage_Encryption::is_key_rotation_interval_seconds_Set() const{
    return m_key_rotation_interval_seconds_isSet;
}

bool OAICreateOriginEndpoint_request_hlsPackage_Encryption::is_key_rotation_interval_seconds_Valid() const{
    return m_key_rotation_interval_seconds_isValid;
}

bool OAICreateOriginEndpoint_request_hlsPackage_Encryption::getRepeatExtXKey() const {
    return m_repeat_ext_x_key;
}
void OAICreateOriginEndpoint_request_hlsPackage_Encryption::setRepeatExtXKey(const bool &repeat_ext_x_key) {
    m_repeat_ext_x_key = repeat_ext_x_key;
    m_repeat_ext_x_key_isSet = true;
}

bool OAICreateOriginEndpoint_request_hlsPackage_Encryption::is_repeat_ext_x_key_Set() const{
    return m_repeat_ext_x_key_isSet;
}

bool OAICreateOriginEndpoint_request_hlsPackage_Encryption::is_repeat_ext_x_key_Valid() const{
    return m_repeat_ext_x_key_isValid;
}

OAICmafEncryption_SpekeKeyProvider OAICreateOriginEndpoint_request_hlsPackage_Encryption::getSpekeKeyProvider() const {
    return m_speke_key_provider;
}
void OAICreateOriginEndpoint_request_hlsPackage_Encryption::setSpekeKeyProvider(const OAICmafEncryption_SpekeKeyProvider &speke_key_provider) {
    m_speke_key_provider = speke_key_provider;
    m_speke_key_provider_isSet = true;
}

bool OAICreateOriginEndpoint_request_hlsPackage_Encryption::is_speke_key_provider_Set() const{
    return m_speke_key_provider_isSet;
}

bool OAICreateOriginEndpoint_request_hlsPackage_Encryption::is_speke_key_provider_Valid() const{
    return m_speke_key_provider_isValid;
}

bool OAICreateOriginEndpoint_request_hlsPackage_Encryption::isSet() const {
...
bool OAICreateOriginEndpoint_request_hlsPackage_Encryption::isValid() const {
