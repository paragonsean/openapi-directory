...
QList OAIDashPackage::getAdTriggers() const {
    return m_ad_triggers;
}
void OAIDashPackage::setAdTriggers(const QList &ad_triggers) {
    m_ad_triggers = ad_triggers;
    m_ad_triggers_isSet = true;
}

bool OAIDashPackage::is_ad_triggers_Set() const{
    return m_ad_triggers_isSet;
}

bool OAIDashPackage::is_ad_triggers_Valid() const{
    return m_ad_triggers_isValid;
}

OAIAdsOnDeliveryRestrictions OAIDashPackage::getAdsOnDeliveryRestrictions() const {
    return m_ads_on_delivery_restrictions;
}
void OAIDashPackage::setAdsOnDeliveryRestrictions(const OAIAdsOnDeliveryRestrictions &ads_on_delivery_restrictions) {
    m_ads_on_delivery_restrictions = ads_on_delivery_restrictions;
    m_ads_on_delivery_restrictions_isSet = true;
}

bool OAIDashPackage::is_ads_on_delivery_restrictions_Set() const{
    return m_ads_on_delivery_restrictions_isSet;
}

bool OAIDashPackage::is_ads_on_delivery_restrictions_Valid() const{
    return m_ads_on_delivery_restrictions_isValid;
}

OAICreateOriginEndpoint_request_dashPackage_Encryption OAIDashPackage::getEncryption() const {
    return m_encryption;
}
void OAIDashPackage::setEncryption(const OAICreateOriginEndpoint_request_dashPackage_Encryption &encryption) {
...
OAIManifestLayout OAIDashPackage::getManifestLayout() const {
    return m_manifest_layout;
}
void OAIDashPackage::setManifestLayout(const OAIManifestLayout &manifest_layout) {
    m_manifest_layout = manifest_layout;
    m_manifest_layout_isSet = true;
}

bool OAIDashPackage::is_manifest_layout_Set() const{
    return m_manifest_layout_isSet;
}

bool OAIDashPackage::is_manifest_layout_Valid() const{
    return m_manifest_layout_isValid;
}

qint32 OAIDashPackage::getManifestWindowSeconds() const {
    return m_manifest_window_seconds;
}
void OAIDashPackage::setManifestWindowSeconds(const qint32 &manifest_window_seconds) {
    m_manifest_window_seconds = manifest_window_seconds;
    m_manifest_window_seconds_isSet = true;
}

bool OAIDashPackage::is_manifest_window_seconds_Set() const{
    return m_manifest_window_seconds_isSet;
}

bool OAIDashPackage::is_manifest_window_seconds_Valid() const{
    return m_manifest_window_seconds_isValid;
}

qint32 OAIDashPackage::getMinBufferTimeSeconds() const {
    return m_min_buffer_time_seconds;
}
void OAIDashPackage::setMinBufferTimeSeconds(const qint32 &min_buffer_time_seconds) {
    m_min_buffer_time_seconds = min_buffer_time_seconds;
    m_min_buffer_time_seconds_isSet = true;
}

bool OAIDashPackage::is_min_buffer_time_seconds_Set() const{
    return m_min_buffer_time_seconds_isSet;
}

bool OAIDashPackage::is_min_buffer_time_seconds_Valid() const{
    return m_min_buffer_time_seconds_isValid;
}

qint32 OAIDashPackage::getMinUpdatePeriodSeconds() const {
    return m_min_update_period_seconds;
}
void OAIDashPackage::setMinUpdatePeriodSeconds(const qint32 &min_update_period_seconds) {
    m_min_update_period_seconds = min_update_period_seconds;
    m_min_update_period_seconds_isSet = true;
}

bool OAIDashPackage::is_min_update_period_seconds_Set() const{
    return m_min_update_period_seconds_isSet;
}

bool OAIDashPackage::is_min_update_period_seconds_Valid() const{
...
OAIProfile OAIDashPackage::getProfile() const {
    return m_profile;
}
void OAIDashPackage::setProfile(const OAIProfile &profile) {
    m_profile = profile;
    m_profile_isSet = true;
}

bool OAIDashPackage::is_profile_Set() const{
    return m_profile_isSet;
}

bool OAIDashPackage::is_profile_Valid() const{
...
OAICreateOriginEndpoint_request_cmafPackage_StreamSelection OAIDashPackage::getStreamSelection() const {
    return m_stream_selection;
}
void OAIDashPackage::setStreamSelection(const OAICreateOriginEndpoint_request_cmafPackage_StreamSelection &stream_selection) {
    m_stream_selection = stream_selection;
    m_stream_selection_isSet = true;
}

bool OAIDashPackage::is_stream_selection_Set() const{
    return m_stream_selection_isSet;
}

bool OAIDashPackage::is_stream_selection_Valid() const{
    return m_stream_selection_isValid;
}

qint32 OAIDashPackage::getSuggestedPresentationDelaySeconds() const {
    return m_suggested_presentation_delay_seconds;
}
void OAIDashPackage::setSuggestedPresentationDelaySeconds(const qint32 &suggested_presentation_delay_seconds) {
...
bool OAIDashPackage::is_suggested_presentation_delay_seconds_Set() const{
    return m_suggested_presentation_delay_seconds_isSet;
}

bool OAIDashPackage::is_suggested_presentation_delay_seconds_Valid() const{
    return m_suggested_presentation_delay_seconds_isValid;
}

OAIUtcTiming OAIDashPackage::getUtcTiming() const {
    return m_utc_timing;
}
void OAIDashPackage::setUtcTiming(const OAIUtcTiming &utc_timing) {
    m_utc_timing = utc_timing;
    m_utc_timing_isSet = true;
}

bool OAIDashPackage::is_utc_timing_Set() const{
    return m_utc_timing_isSet;
}

bool OAIDashPackage::is_utc_timing_Valid() const{
    return m_utc_timing_isValid;
}

QString OAIDashPackage::getUtcTimingUri() const {
    return m_utc_timing_uri;
}
void OAIDashPackage::setUtcTimingUri(const QString &utc_timing_uri) {
    m_utc_timing_uri = utc_timing_uri;
    m_utc_timing_uri_isSet = true;
}

bool OAIDashPackage::is_utc_timing_uri_Set() const{
    return m_utc_timing_uri_isSet;
}

bool OAIDashPackage::is_utc_timing_uri_Valid() const{
