...
OAICreateOriginEndpointResponse_HlsPackage::OAICreateOriginEndpointResponse_HlsPackage(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateOriginEndpointResponse_HlsPackage::OAICreateOriginEndpointResponse_HlsPackage() {
    this->initializeModel();
}

OAICreateOriginEndpointResponse_HlsPackage::~OAICreateOriginEndpointResponse_HlsPackage() {}

void OAICreateOriginEndpointResponse_HlsPackage::initializeModel() {
...
void OAICreateOriginEndpointResponse_HlsPackage::fromJson(QString jsonString) {
...
void OAICreateOriginEndpointResponse_HlsPackage::fromJsonObject(QJsonObject json) {
...
QString OAICreateOriginEndpointResponse_HlsPackage::asJson() const {
...
QJsonObject OAICreateOriginEndpointResponse_HlsPackage::asJsonObject() const {
    QJsonObject obj;
...
OAIAdMarkers OAICreateOriginEndpointResponse_HlsPackage::getAdMarkers() const {
    return m_ad_markers;
}
void OAICreateOriginEndpointResponse_HlsPackage::setAdMarkers(const OAIAdMarkers &ad_markers) {
    m_ad_markers = ad_markers;
    m_ad_markers_isSet = true;
}

bool OAICreateOriginEndpointResponse_HlsPackage::is_ad_markers_Set() const{
    return m_ad_markers_isSet;
}

bool OAICreateOriginEndpointResponse_HlsPackage::is_ad_markers_Valid() const{
    return m_ad_markers_isValid;
}

QList OAICreateOriginEndpointResponse_HlsPackage::getAdTriggers() const {
    return m_ad_triggers;
}
void OAICreateOriginEndpointResponse_HlsPackage::setAdTriggers(const QList &ad_triggers) {
    m_ad_triggers = ad_triggers;
    m_ad_triggers_isSet = true;
}

bool OAICreateOriginEndpointResponse_HlsPackage::is_ad_triggers_Set() const{
    return m_ad_triggers_isSet;
}

bool OAICreateOriginEndpointResponse_HlsPackage::is_ad_triggers_Valid() const{
    return m_ad_triggers_isValid;
}

OAIAdsOnDeliveryRestrictions OAICreateOriginEndpointResponse_HlsPackage::getAdsOnDeliveryRestrictions() const {
    return m_ads_on_delivery_restrictions;
}
void OAICreateOriginEndpointResponse_HlsPackage::setAdsOnDeliveryRestrictions(const OAIAdsOnDeliveryRestrictions &ads_on_delivery_restrictions) {
    m_ads_on_delivery_restrictions = ads_on_delivery_restrictions;
    m_ads_on_delivery_restrictions_isSet = true;
}

bool OAICreateOriginEndpointResponse_HlsPackage::is_ads_on_delivery_restrictions_Set() const{
    return m_ads_on_delivery_restrictions_isSet;
}

bool OAICreateOriginEndpointResponse_HlsPackage::is_ads_on_delivery_restrictions_Valid() const{
    return m_ads_on_delivery_restrictions_isValid;
}

OAICreateOriginEndpoint_request_hlsPackage_Encryption OAICreateOriginEndpointResponse_HlsPackage::getEncryption() const {
    return m_encryption;
}
void OAICreateOriginEndpointResponse_HlsPackage::setEncryption(const OAICreateOriginEndpoint_request_hlsPackage_Encryption &encryption) {
    m_encryption = encryption;
    m_encryption_isSet = true;
}

bool OAICreateOriginEndpointResponse_HlsPackage::is_encryption_Set() const{
    return m_encryption_isSet;
}

bool OAICreateOriginEndpointResponse_HlsPackage::is_encryption_Valid() const{
    return m_encryption_isValid;
}

bool OAICreateOriginEndpointResponse_HlsPackage::getIncludeDvbSubtitles() const {
    return m_include_dvb_subtitles;
}
void OAICreateOriginEndpointResponse_HlsPackage::setIncludeDvbSubtitles(const bool &include_dvb_subtitles) {
    m_include_dvb_subtitles = include_dvb_subtitles;
    m_include_dvb_subtitles_isSet = true;
}

bool OAICreateOriginEndpointResponse_HlsPackage::is_include_dvb_subtitles_Set() const{
    return m_include_dvb_subtitles_isSet;
}

bool OAICreateOriginEndpointResponse_HlsPackage::is_include_dvb_subtitles_Valid() const{
    return m_include_dvb_subtitles_isValid;
}

bool OAICreateOriginEndpointResponse_HlsPackage::getIncludeIframeOnlyStream() const {
    return m_include_iframe_only_stream;
}
void OAICreateOriginEndpointResponse_HlsPackage::setIncludeIframeOnlyStream(const bool &include_iframe_only_stream) {
    m_include_iframe_only_stream = include_iframe_only_stream;
    m_include_iframe_only_stream_isSet = true;
}

bool OAICreateOriginEndpointResponse_HlsPackage::is_include_iframe_only_stream_Set() const{
    return m_include_iframe_only_stream_isSet;
}

bool OAICreateOriginEndpointResponse_HlsPackage::is_include_iframe_only_stream_Valid() const{
    return m_include_iframe_only_stream_isValid;
}

OAIPlaylistType OAICreateOriginEndpointResponse_HlsPackage::getPlaylistType() const {
    return m_playlist_type;
}
void OAICreateOriginEndpointResponse_HlsPackage::setPlaylistType(const OAIPlaylistType &playlist_type) {
    m_playlist_type = playlist_type;
    m_playlist_type_isSet = true;
}

bool OAICreateOriginEndpointResponse_HlsPackage::is_playlist_type_Set() const{
    return m_playlist_type_isSet;
}

bool OAICreateOriginEndpointResponse_HlsPackage::is_playlist_type_Valid() const{
    return m_playlist_type_isValid;
}

qint32 OAICreateOriginEndpointResponse_HlsPackage::getPlaylistWindowSeconds() const {
    return m_playlist_window_seconds;
}
void OAICreateOriginEndpointResponse_HlsPackage::setPlaylistWindowSeconds(const qint32 &playlist_window_seconds) {
    m_playlist_window_seconds = playlist_window_seconds;
    m_playlist_window_seconds_isSet = true;
}

bool OAICreateOriginEndpointResponse_HlsPackage::is_playlist_window_seconds_Set() const{
    return m_playlist_window_seconds_isSet;
}

bool OAICreateOriginEndpointResponse_HlsPackage::is_playlist_window_seconds_Valid() const{
    return m_playlist_window_seconds_isValid;
}

qint32 OAICreateOriginEndpointResponse_HlsPackage::getProgramDateTimeIntervalSeconds() const {
    return m_program_date_time_interval_seconds;
}
void OAICreateOriginEndpointResponse_HlsPackage::setProgramDateTimeIntervalSeconds(const qint32 &program_date_time_interval_seconds) {
    m_program_date_time_interval_seconds = program_date_time_interval_seconds;
    m_program_date_time_interval_seconds_isSet = true;
}

bool OAICreateOriginEndpointResponse_HlsPackage::is_program_date_time_interval_seconds_Set() const{
    return m_program_date_time_interval_seconds_isSet;
}

bool OAICreateOriginEndpointResponse_HlsPackage::is_program_date_time_interval_seconds_Valid() const{
    return m_program_date_time_interval_seconds_isValid;
}

qint32 OAICreateOriginEndpointResponse_HlsPackage::getSegmentDurationSeconds() const {
    return m_segment_duration_seconds;
}
void OAICreateOriginEndpointResponse_HlsPackage::setSegmentDurationSeconds(const qint32 &segment_duration_seconds) {
    m_segment_duration_seconds = segment_duration_seconds;
    m_segment_duration_seconds_isSet = true;
}

bool OAICreateOriginEndpointResponse_HlsPackage::is_segment_duration_seconds_Set() const{
    return m_segment_duration_seconds_isSet;
}

bool OAICreateOriginEndpointResponse_HlsPackage::is_segment_duration_seconds_Valid() const{
    return m_segment_duration_seconds_isValid;
}

OAICreateOriginEndpoint_request_cmafPackage_StreamSelection OAICreateOriginEndpointResponse_HlsPackage::getStreamSelection() const {
    return m_stream_selection;
}
void OAICreateOriginEndpointResponse_HlsPackage::setStreamSelection(const OAICreateOriginEndpoint_request_cmafPackage_StreamSelection &stream_selection) {
    m_stream_selection = stream_selection;
    m_stream_selection_isSet = true;
}

bool OAICreateOriginEndpointResponse_HlsPackage::is_stream_selection_Set() const{
    return m_stream_selection_isSet;
}

bool OAICreateOriginEndpointResponse_HlsPackage::is_stream_selection_Valid() const{
    return m_stream_selection_isValid;
}

bool OAICreateOriginEndpointResponse_HlsPackage::getUseAudioRenditionGroup() const {
    return m_use_audio_rendition_group;
}
void OAICreateOriginEndpointResponse_HlsPackage::setUseAudioRenditionGroup(const bool &use_audio_rendition_group) {
    m_use_audio_rendition_group = use_audio_rendition_group;
    m_use_audio_rendition_group_isSet = true;
}

bool OAICreateOriginEndpointResponse_HlsPackage::is_use_audio_rendition_group_Set() const{
    return m_use_audio_rendition_group_isSet;
}

bool OAICreateOriginEndpointResponse_HlsPackage::is_use_audio_rendition_group_Valid() const{
    return m_use_audio_rendition_group_isValid;
}

bool OAICreateOriginEndpointResponse_HlsPackage::isSet() const {
...
bool OAICreateOriginEndpointResponse_HlsPackage::isValid() const {
