...
OAICreateOriginEndpointResponse_DashPackage::OAICreateOriginEndpointResponse_DashPackage(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateOriginEndpointResponse_DashPackage::OAICreateOriginEndpointResponse_DashPackage() {
    this->initializeModel();
}

OAICreateOriginEndpointResponse_DashPackage::~OAICreateOriginEndpointResponse_DashPackage() {}

void OAICreateOriginEndpointResponse_DashPackage::initializeModel() {
...
void OAICreateOriginEndpointResponse_DashPackage::fromJson(QString jsonString) {
...
void OAICreateOriginEndpointResponse_DashPackage::fromJsonObject(QJsonObject json) {
...
QString OAICreateOriginEndpointResponse_DashPackage::asJson() const {
...
QJsonObject OAICreateOriginEndpointResponse_DashPackage::asJsonObject() const {
    QJsonObject obj;
...
QList OAICreateOriginEndpointResponse_DashPackage::getAdTriggers() const {
    return m_ad_triggers;
}
void OAICreateOriginEndpointResponse_DashPackage::setAdTriggers(const QList &ad_triggers) {
    m_ad_triggers = ad_triggers;
    m_ad_triggers_isSet = true;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_ad_triggers_Set() const{
    return m_ad_triggers_isSet;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_ad_triggers_Valid() const{
    return m_ad_triggers_isValid;
}

OAIAdsOnDeliveryRestrictions OAICreateOriginEndpointResponse_DashPackage::getAdsOnDeliveryRestrictions() const {
    return m_ads_on_delivery_restrictions;
}
void OAICreateOriginEndpointResponse_DashPackage::setAdsOnDeliveryRestrictions(const OAIAdsOnDeliveryRestrictions &ads_on_delivery_restrictions) {
    m_ads_on_delivery_restrictions = ads_on_delivery_restrictions;
    m_ads_on_delivery_restrictions_isSet = true;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_ads_on_delivery_restrictions_Set() const{
    return m_ads_on_delivery_restrictions_isSet;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_ads_on_delivery_restrictions_Valid() const{
    return m_ads_on_delivery_restrictions_isValid;
}

OAICreateOriginEndpoint_request_dashPackage_Encryption OAICreateOriginEndpointResponse_DashPackage::getEncryption() const {
    return m_encryption;
}
void OAICreateOriginEndpointResponse_DashPackage::setEncryption(const OAICreateOriginEndpoint_request_dashPackage_Encryption &encryption) {
    m_encryption = encryption;
    m_encryption_isSet = true;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_encryption_Set() const{
    return m_encryption_isSet;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_encryption_Valid() const{
    return m_encryption_isValid;
}

bool OAICreateOriginEndpointResponse_DashPackage::getIncludeIframeOnlyStream() const {
    return m_include_iframe_only_stream;
}
void OAICreateOriginEndpointResponse_DashPackage::setIncludeIframeOnlyStream(const bool &include_iframe_only_stream) {
    m_include_iframe_only_stream = include_iframe_only_stream;
    m_include_iframe_only_stream_isSet = true;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_include_iframe_only_stream_Set() const{
    return m_include_iframe_only_stream_isSet;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_include_iframe_only_stream_Valid() const{
    return m_include_iframe_only_stream_isValid;
}

OAIManifestLayout OAICreateOriginEndpointResponse_DashPackage::getManifestLayout() const {
    return m_manifest_layout;
}
void OAICreateOriginEndpointResponse_DashPackage::setManifestLayout(const OAIManifestLayout &manifest_layout) {
    m_manifest_layout = manifest_layout;
    m_manifest_layout_isSet = true;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_manifest_layout_Set() const{
    return m_manifest_layout_isSet;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_manifest_layout_Valid() const{
    return m_manifest_layout_isValid;
}

qint32 OAICreateOriginEndpointResponse_DashPackage::getManifestWindowSeconds() const {
    return m_manifest_window_seconds;
}
void OAICreateOriginEndpointResponse_DashPackage::setManifestWindowSeconds(const qint32 &manifest_window_seconds) {
    m_manifest_window_seconds = manifest_window_seconds;
    m_manifest_window_seconds_isSet = true;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_manifest_window_seconds_Set() const{
    return m_manifest_window_seconds_isSet;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_manifest_window_seconds_Valid() const{
    return m_manifest_window_seconds_isValid;
}

qint32 OAICreateOriginEndpointResponse_DashPackage::getMinBufferTimeSeconds() const {
    return m_min_buffer_time_seconds;
}
void OAICreateOriginEndpointResponse_DashPackage::setMinBufferTimeSeconds(const qint32 &min_buffer_time_seconds) {
    m_min_buffer_time_seconds = min_buffer_time_seconds;
    m_min_buffer_time_seconds_isSet = true;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_min_buffer_time_seconds_Set() const{
    return m_min_buffer_time_seconds_isSet;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_min_buffer_time_seconds_Valid() const{
    return m_min_buffer_time_seconds_isValid;
}

qint32 OAICreateOriginEndpointResponse_DashPackage::getMinUpdatePeriodSeconds() const {
    return m_min_update_period_seconds;
}
void OAICreateOriginEndpointResponse_DashPackage::setMinUpdatePeriodSeconds(const qint32 &min_update_period_seconds) {
    m_min_update_period_seconds = min_update_period_seconds;
    m_min_update_period_seconds_isSet = true;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_min_update_period_seconds_Set() const{
    return m_min_update_period_seconds_isSet;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_min_update_period_seconds_Valid() const{
    return m_min_update_period_seconds_isValid;
}

QList OAICreateOriginEndpointResponse_DashPackage::getPeriodTriggers() const {
    return m_period_triggers;
}
void OAICreateOriginEndpointResponse_DashPackage::setPeriodTriggers(const QList &period_triggers) {
    m_period_triggers = period_triggers;
    m_period_triggers_isSet = true;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_period_triggers_Set() const{
    return m_period_triggers_isSet;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_period_triggers_Valid() const{
    return m_period_triggers_isValid;
}

OAIProfile OAICreateOriginEndpointResponse_DashPackage::getProfile() const {
    return m_profile;
}
void OAICreateOriginEndpointResponse_DashPackage::setProfile(const OAIProfile &profile) {
    m_profile = profile;
    m_profile_isSet = true;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_profile_Set() const{
    return m_profile_isSet;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_profile_Valid() const{
    return m_profile_isValid;
}

qint32 OAICreateOriginEndpointResponse_DashPackage::getSegmentDurationSeconds() const {
    return m_segment_duration_seconds;
}
void OAICreateOriginEndpointResponse_DashPackage::setSegmentDurationSeconds(const qint32 &segment_duration_seconds) {
    m_segment_duration_seconds = segment_duration_seconds;
    m_segment_duration_seconds_isSet = true;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_segment_duration_seconds_Set() const{
    return m_segment_duration_seconds_isSet;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_segment_duration_seconds_Valid() const{
    return m_segment_duration_seconds_isValid;
}

OAISegmentTemplateFormat OAICreateOriginEndpointResponse_DashPackage::getSegmentTemplateFormat() const {
    return m_segment_template_format;
}
void OAICreateOriginEndpointResponse_DashPackage::setSegmentTemplateFormat(const OAISegmentTemplateFormat &segment_template_format) {
    m_segment_template_format = segment_template_format;
    m_segment_template_format_isSet = true;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_segment_template_format_Set() const{
    return m_segment_template_format_isSet;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_segment_template_format_Valid() const{
    return m_segment_template_format_isValid;
}

OAICreateOriginEndpoint_request_cmafPackage_StreamSelection OAICreateOriginEndpointResponse_DashPackage::getStreamSelection() const {
    return m_stream_selection;
}
void OAICreateOriginEndpointResponse_DashPackage::setStreamSelection(const OAICreateOriginEndpoint_request_cmafPackage_StreamSelection &stream_selection) {
    m_stream_selection = stream_selection;
    m_stream_selection_isSet = true;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_stream_selection_Set() const{
    return m_stream_selection_isSet;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_stream_selection_Valid() const{
    return m_stream_selection_isValid;
}

qint32 OAICreateOriginEndpointResponse_DashPackage::getSuggestedPresentationDelaySeconds() const {
    return m_suggested_presentation_delay_seconds;
}
void OAICreateOriginEndpointResponse_DashPackage::setSuggestedPresentationDelaySeconds(const qint32 &suggested_presentation_delay_seconds) {
...
bool OAICreateOriginEndpointResponse_DashPackage::is_suggested_presentation_delay_seconds_Set() const{
    return m_suggested_presentation_delay_seconds_isSet;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_suggested_presentation_delay_seconds_Valid() const{
    return m_suggested_presentation_delay_seconds_isValid;
}

OAIUtcTiming OAICreateOriginEndpointResponse_DashPackage::getUtcTiming() const {
    return m_utc_timing;
}
void OAICreateOriginEndpointResponse_DashPackage::setUtcTiming(const OAIUtcTiming &utc_timing) {
    m_utc_timing = utc_timing;
    m_utc_timing_isSet = true;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_utc_timing_Set() const{
    return m_utc_timing_isSet;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_utc_timing_Valid() const{
    return m_utc_timing_isValid;
}

QString OAICreateOriginEndpointResponse_DashPackage::getUtcTimingUri() const {
    return m_utc_timing_uri;
}
void OAICreateOriginEndpointResponse_DashPackage::setUtcTimingUri(const QString &utc_timing_uri) {
    m_utc_timing_uri = utc_timing_uri;
    m_utc_timing_uri_isSet = true;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_utc_timing_uri_Set() const{
    return m_utc_timing_uri_isSet;
}

bool OAICreateOriginEndpointResponse_DashPackage::is_utc_timing_uri_Valid() const{
    return m_utc_timing_uri_isValid;
}

bool OAICreateOriginEndpointResponse_DashPackage::isSet() const {
...
bool OAICreateOriginEndpointResponse_DashPackage::isValid() const {
