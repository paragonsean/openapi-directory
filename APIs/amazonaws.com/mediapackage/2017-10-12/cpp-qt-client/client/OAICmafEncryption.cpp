...
OAICmafEncryptionMethod OAICmafEncryption::getEncryptionMethod() const {
    return m_encryption_method;
}
void OAICmafEncryption::setEncryptionMethod(const OAICmafEncryptionMethod &encryption_method) {
    m_encryption_method = encryption_method;
    m_encryption_method_isSet = true;
}

bool OAICmafEncryption::is_encryption_method_Set() const{
    return m_encryption_method_isSet;
}

bool OAICmafEncryption::is_encryption_method_Valid() const{
    return m_encryption_method_isValid;
}

qint32 OAICmafEncryption::getKeyRotationIntervalSeconds() const {
    return m_key_rotation_interval_seconds;
}
void OAICmafEncryption::setKeyRotationIntervalSeconds(const qint32 &key_rotation_interval_seconds) {
    m_key_rotation_interval_seconds = key_rotation_interval_seconds;
    m_key_rotation_interval_seconds_isSet = true;
}

bool OAICmafEncryption::is_key_rotation_interval_seconds_Set() const{
    return m_key_rotation_interval_seconds_isSet;
}

bool OAICmafEncryption::is_key_rotation_interval_seconds_Valid() const{
