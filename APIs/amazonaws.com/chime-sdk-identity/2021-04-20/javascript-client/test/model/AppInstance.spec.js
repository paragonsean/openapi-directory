...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChimeSdkIdentity.AppInstance();
  });
  ...
  describe('AppInstance', function() {
    it('should create an instance of AppInstance', function() {
      ...
      //var instance = new AmazonChimeSdkIdentity.AppInstance();
      //expect(instance).to.be.a(AmazonChimeSdkIdentity.AppInstance);
    });
