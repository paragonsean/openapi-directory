...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChimeSdkIdentity.AppInstanceAdmin();
  });
  ...
  describe('AppInstanceAdmin', function() {
    it('should create an instance of AppInstanceAdmin', function() {
      // uncomment below and update the code to test AppInstanceAdmin
      //var instance = new AmazonChimeSdkIdentity.AppInstanceAdmin();
      //expect(instance).to.be.a(AmazonChimeSdkIdentity.AppInstanceAdmin);
    });
