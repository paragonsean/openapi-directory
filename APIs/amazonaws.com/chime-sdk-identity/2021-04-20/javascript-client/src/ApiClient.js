...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://identity-chime.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://identity-chime.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2021-04-20/Javascript'
        };
