# AmazonChimeSdkIdentity.RegisterAppInstanceUserEndpointRequest
...
**allowMessages** | **String** | Boolean that controls whether the AppInstanceUserEndpoint is opted in to receive messages. &lt;code&gt;ALL&lt;/code&gt; indicates the endpoint receives all messages. &lt;code&gt;NONE&lt;/code&gt; indicates the endpoint receives no messages. | [optional] 
