...
#ifndef OAIAppInstanceBot_H
#define OAIAppInstanceBot_H
...
namespace OpenAPI {
class OAIAppInstanceBot_Configuration;

class OAIAppInstanceBot : public OAIObject {
public:
    OAIAppInstanceBot();
    OAIAppInstanceBot(QString json);
    ~OAIAppInstanceBot() override;
    ...
    OAIAppInstanceBot_Configuration getConfiguration() const;
    void setConfiguration(const OAIAppInstanceBot_Configuration &configuration);
...
private:
    ...
    OAIAppInstanceBot_Configuration m_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppInstanceBot)

#endif // OAIAppInstanceBot_H
