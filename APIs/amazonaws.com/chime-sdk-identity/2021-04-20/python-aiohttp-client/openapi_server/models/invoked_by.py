...
class InvokedBy(Model):
    ...
    def __init__(self, standard_messages: StandardMessages=None, targeted_messages: TargetedMessages=None):
        """InvokedBy - a model defined in OpenAPI

        :param standard_messages: The standard_messages of this InvokedBy.
        :param targeted_messages: The targeted_messages of this InvokedBy.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'InvokedBy':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The InvokedBy of this InvokedBy.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def standard_messages(self):
        """Gets the standard_messages of this InvokedBy.


        :return: The standard_messages of this InvokedBy.
    ...
    def standard_messages(self, standard_messages):
        """Sets the standard_messages of this InvokedBy.
    ...
    def targeted_messages(self):
        """Gets the targeted_messages of this InvokedBy.


        :return: The targeted_messages of this InvokedBy.
    ...
    def targeted_messages(self, targeted_messages):
        """Sets the targeted_messages of this InvokedBy.
