...
class CreateAppInstanceUserRequest(Model):
    ...
    def __init__(self, app_instance_arn: str=None, app_instance_user_id: str=None, name: str=None, metadata: str=None, client_request_token: str=None, tags: List[Tag]=None, expiration_settings: CreateAppInstanceUserRequestExpirationSettings=None):
        ...
        :param expiration_settings: The expiration_settings of this CreateAppInstanceUserRequest.
        """
        self.openapi_types = {
    ...
    def expiration_settings(self):
        """Gets the expiration_settings of this CreateAppInstanceUserRequest.


        :return: The expiration_settings of this CreateAppInstanceUserRequest.
    ...
    def expiration_settings(self, expiration_settings):
        """Sets the expiration_settings of this CreateAppInstanceUserRequest.
