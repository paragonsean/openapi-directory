...
async def test_create_app_instance_bot(client):
    """Test case for create_app_instance_bot

    
    """
    body = {"ClientRequestToken":"","Configuration":{"Lex":{"LexBotAliasArn":"","InvokedBy":{"StandardMessages":"","TargetedMessages":""},"LocaleId":"","RespondsTo":"","WelcomeIntent":""}},"Metadata":"","AppInstanceArn":"","Tags":"","Name":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_app_instance_user(client):
    ...
    """
    body = {"ClientRequestToken":"","AppInstanceUserId":"","ExpirationSettings":{"ExpirationCriterion":"","ExpirationDays":""},"Metadata":"","AppInstanceArn":"","Tags":"","Name":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_delete_app_instance_bot(client):
    """Test case for delete_app_instance_bot
    ...
    response = await client.request(
        method='DELETE',
        path='/app-instance-bots/{app_instance_bot_arn}'.format(app_instance_bot_arn='app_instance_bot_arn_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_deregister_app_instance_user_endpoint(client):
    """Test case for deregister_app_instance_user_endpoint
    ...
    response = await client.request(
        method='DELETE',
        path='/app-instance-users/{app_instance_user_arn}/endpoints/{endpoint_id}'.format(app_instance_user_arn='app_instance_user_arn_example', endpoint_id='endpoint_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_app_instance_bot(client):
    """Test case for describe_app_instance_bot
...
async def test_describe_app_instance_user_endpoint(client):
    """Test case for describe_app_instance_user_endpoint
...
async def test_list_app_instance_bots(client):
    """Test case for list_app_instance_bots
...
async def test_list_app_instance_user_endpoints(client):
    """Test case for list_app_instance_user_endpoints
    ...
    response = await client.request(
        method='GET',
        path='/app-instance-users/{app_instance_user_arn}/endpoints'.format(app_instance_user_arn='app_instance_user_arn_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_put_app_instance_user_expiration_settings(client):
    """Test case for put_app_instance_user_expiration_settings
    ...
    response = await client.request(
        method='PUT',
        path='/app-instance-users/{app_instance_user_arn}/expiration-settings'.format(app_instance_user_arn='app_instance_user_arn_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_register_app_instance_user_endpoint(client):
    """Test case for register_app_instance_user_endpoint

    
    """
    body = {"ResourceArn":"","ClientRequestToken":"","Type":"","EndpointAttributes":{"DeviceToken":"","VoipDeviceToken":""},"AllowMessages":"","Name":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_app_instance_bot(client):
    """Test case for update_app_instance_bot

    
    """
    body = {"Configuration":{"Lex":{"LexBotAliasArn":"","InvokedBy":{"StandardMessages":"","TargetedMessages":""},"LocaleId":"","RespondsTo":"","WelcomeIntent":""}},"Metadata":"","Name":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_app_instance_user_endpoint(client):
    """Test case for update_app_instance_user_endpoint

    
    """
    body = {"AllowMessages":"","Name":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
