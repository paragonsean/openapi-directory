...
public class AppInstanceUserEndpoint {
  ...
  public AppInstanceUserEndpoint() {
  }

  public AppInstanceUserEndpoint appInstanceUserArn(String appInstanceUserArn) {
  ...
  public AppInstanceUserEndpoint endpointId(String endpointId) {
  ...
  public AppInstanceUserEndpoint name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AppInstanceUserEndpoint type(AppInstanceUserEndpointType type) {
    this.type = type;
    return this;
  }
  ...
  public AppInstanceUserEndpoint resourceArn(String resourceArn) {
  ...
  public AppInstanceUserEndpoint endpointAttributes(AppInstanceUserEndpointEndpointAttributes endpointAttributes) {
  ...
  public AppInstanceUserEndpoint createdTimestamp(OffsetDateTime createdTimestamp) {
  ...
  public AppInstanceUserEndpoint lastUpdatedTimestamp(OffsetDateTime lastUpdatedTimestamp) {
  ...
  public AppInstanceUserEndpoint allowMessages(AllowMessages allowMessages) {
  ...
  public AppInstanceUserEndpoint endpointState(AppInstanceUserEndpointEndpointState endpointState) {
  ...
  public boolean equals(Object o) {
    ...
    AppInstanceUserEndpoint appInstanceUserEndpoint = (AppInstanceUserEndpoint) o;
    return Objects.equals(this.appInstanceUserArn, appInstanceUserEndpoint.appInstanceUserArn) &&
        Objects.equals(this.endpointId, appInstanceUserEndpoint.endpointId) &&
        Objects.equals(this.name, appInstanceUserEndpoint.name) &&
        Objects.equals(this.type, appInstanceUserEndpoint.type) &&
        Objects.equals(this.resourceArn, appInstanceUserEndpoint.resourceArn) &&
        Objects.equals(this.endpointAttributes, appInstanceUserEndpoint.endpointAttributes) &&
        Objects.equals(this.createdTimestamp, appInstanceUserEndpoint.createdTimestamp) &&
        Objects.equals(this.lastUpdatedTimestamp, appInstanceUserEndpoint.lastUpdatedTimestamp) &&
        Objects.equals(this.allowMessages, appInstanceUserEndpoint.allowMessages) &&
        Objects.equals(this.endpointState, appInstanceUserEndpoint.endpointState);
  }
  ...
  public String toString() {
    ...
    sb.append("class AppInstanceUserEndpoint {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AppInstanceUserEndpoint
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AppInstanceUserEndpoint.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppInstanceUserEndpoint is not found in the empty JSON string", AppInstanceUserEndpoint.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AppInstanceUserEndpoint.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppInstanceUserEndpoint` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppInstanceUserEndpoint.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppInstanceUserEndpoint' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppInstanceUserEndpoint> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppInstanceUserEndpoint.class));

       return (TypeAdapter<T>) new TypeAdapter<AppInstanceUserEndpoint>() {
           @Override
           public void write(JsonWriter out, AppInstanceUserEndpoint value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AppInstanceUserEndpoint read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AppInstanceUserEndpoint given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AppInstanceUserEndpoint
   * @throws IOException if the JSON string is invalid with respect to AppInstanceUserEndpoint
   */
  public static AppInstanceUserEndpoint fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppInstanceUserEndpoint.class);
  }

  /**
   * Convert an instance of AppInstanceUserEndpoint to an JSON string
   *
   * @return JSON string
   */
