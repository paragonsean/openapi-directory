...
public class ApiClient {
    ...
    private String basePath = "http://identity-chime.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://identity-chime.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "https://identity-chime.{region}.amazonaws.com",
      "The Amazon Chime SDK Identity multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://identity-chime.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://identity-chime.{region}.amazonaws.com.cn",
      "The Amazon Chime SDK Identity endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2021-04-20/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://identity-chime.us-east-1.amazonaws.com
