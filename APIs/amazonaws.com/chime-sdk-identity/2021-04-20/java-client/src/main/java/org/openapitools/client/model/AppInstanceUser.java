...
public class AppInstanceUser {
  ...
  public AppInstanceUser() {
  }

  public AppInstanceUser appInstanceUserArn(String appInstanceUserArn) {
  ...
  public AppInstanceUser name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AppInstanceUser metadata(String metadata) {
  ...
  public AppInstanceUser createdTimestamp(OffsetDateTime createdTimestamp) {
  ...
  public AppInstanceUser lastUpdatedTimestamp(OffsetDateTime lastUpdatedTimestamp) {
  ...
  public AppInstanceUser expirationSettings(AppInstanceUserExpirationSettings expirationSettings) {
  ...
  public boolean equals(Object o) {
    ...
    AppInstanceUser appInstanceUser = (AppInstanceUser) o;
    return Objects.equals(this.appInstanceUserArn, appInstanceUser.appInstanceUserArn) &&
        Objects.equals(this.name, appInstanceUser.name) &&
        Objects.equals(this.metadata, appInstanceUser.metadata) &&
        Objects.equals(this.createdTimestamp, appInstanceUser.createdTimestamp) &&
        Objects.equals(this.lastUpdatedTimestamp, appInstanceUser.lastUpdatedTimestamp) &&
        Objects.equals(this.expirationSettings, appInstanceUser.expirationSettings);
  }
  ...
  public String toString() {
    ...
    sb.append("class AppInstanceUser {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AppInstanceUser
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AppInstanceUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppInstanceUser is not found in the empty JSON string", AppInstanceUser.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AppInstanceUser.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppInstanceUser` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppInstanceUser.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppInstanceUser' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppInstanceUser> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppInstanceUser.class));

       return (TypeAdapter<T>) new TypeAdapter<AppInstanceUser>() {
           @Override
           public void write(JsonWriter out, AppInstanceUser value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AppInstanceUser read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AppInstanceUser given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AppInstanceUser
   * @throws IOException if the JSON string is invalid with respect to AppInstanceUser
   */
  public static AppInstanceUser fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppInstanceUser.class);
  }

  /**
   * Convert an instance of AppInstanceUser to an JSON string
   *
   * @return JSON string
   */
