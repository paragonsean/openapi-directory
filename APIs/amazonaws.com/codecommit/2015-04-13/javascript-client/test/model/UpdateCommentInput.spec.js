...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.UpdateCommentInput();
  });
  ...
  describe('UpdateCommentInput', function() {
    it('should create an instance of UpdateCommentInput', function() {
      // uncomment below and update the code to test UpdateCommentInput
      //var instance = new AwsCodeCommit.UpdateCommentInput();
      //expect(instance).to.be.a(AwsCodeCommit.UpdateCommentInput);
    });
