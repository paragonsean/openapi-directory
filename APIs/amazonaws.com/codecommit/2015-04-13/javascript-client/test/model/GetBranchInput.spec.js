...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.GetBranchInput();
  });
  ...
  describe('GetBranchInput', function() {
    it('should create an instance of GetBranchInput', function() {
      // uncomment below and update the code to test GetBranchInput
      //var instance = new AwsCodeCommit.GetBranchInput();
      //expect(instance).to.be.a(AwsCodeCommit.GetBranchInput);
    });
