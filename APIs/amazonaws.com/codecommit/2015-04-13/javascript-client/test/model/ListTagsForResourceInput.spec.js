...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.ListTagsForResourceInput();
  });
  ...
  describe('ListTagsForResourceInput', function() {
    it('should create an instance of ListTagsForResourceInput', function() {
      ...
      //var instance = new AwsCodeCommit.ListTagsForResourceInput();
      //expect(instance).to.be.a(AwsCodeCommit.ListTagsForResourceInput);
    });
