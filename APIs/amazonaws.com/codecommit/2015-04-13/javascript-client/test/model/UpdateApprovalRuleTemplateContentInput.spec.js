...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.UpdateApprovalRuleTemplateContentInput();
  });
  ...
  describe('UpdateApprovalRuleTemplateContentInput', function() {
    it('should create an instance of UpdateApprovalRuleTemplateContentInput', function() {
      // uncomment below and update the code to test UpdateApprovalRuleTemplateContentInput
      //var instance = new AwsCodeCommit.UpdateApprovalRuleTemplateContentInput();
      //expect(instance).to.be.a(AwsCodeCommit.UpdateApprovalRuleTemplateContentInput);
    });
