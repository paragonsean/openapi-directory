...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.BatchDescribeMergeConflictsOutput();
  });
  ...
  describe('BatchDescribeMergeConflictsOutput', function() {
    it('should create an instance of BatchDescribeMergeConflictsOutput', function() {
      // uncomment below and update the code to test BatchDescribeMergeConflictsOutput
      //var instance = new AwsCodeCommit.BatchDescribeMergeConflictsOutput();
      //expect(instance).to.be.a(AwsCodeCommit.BatchDescribeMergeConflictsOutput);
    });
