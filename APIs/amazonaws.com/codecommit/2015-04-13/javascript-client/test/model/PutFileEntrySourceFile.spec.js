...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.PutFileEntrySourceFile();
  });
  ...
  describe('PutFileEntrySourceFile', function() {
    it('should create an instance of PutFileEntrySourceFile', function() {
      // uncomment below and update the code to test PutFileEntrySourceFile
      //var instance = new AwsCodeCommit.PutFileEntrySourceFile();
      //expect(instance).to.be.a(AwsCodeCommit.PutFileEntrySourceFile);
    });
    ...
    it('should have the property isMove (base name: "isMove")', function() {
      // uncomment below and update the code to test the property isMove
      //var instance = new AwsCodeCommit.PutFileEntrySourceFile();
      //expect(instance).to.be();
    });
