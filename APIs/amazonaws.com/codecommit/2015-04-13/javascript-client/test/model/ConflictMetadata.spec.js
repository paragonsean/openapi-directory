...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.ConflictMetadata();
  });
  ...
  describe('ConflictMetadata', function() {
    it('should create an instance of ConflictMetadata', function() {
      // uncomment below and update the code to test ConflictMetadata
      //var instance = new AwsCodeCommit.ConflictMetadata();
      //expect(instance).to.be.a(AwsCodeCommit.ConflictMetadata);
    });
