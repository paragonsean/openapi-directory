...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.PutRepositoryTriggersInput();
  });
  ...
  describe('PutRepositoryTriggersInput', function() {
    it('should create an instance of PutRepositoryTriggersInput', function() {
      // uncomment below and update the code to test PutRepositoryTriggersInput
      //var instance = new AwsCodeCommit.PutRepositoryTriggersInput();
      //expect(instance).to.be.a(AwsCodeCommit.PutRepositoryTriggersInput);
    });
