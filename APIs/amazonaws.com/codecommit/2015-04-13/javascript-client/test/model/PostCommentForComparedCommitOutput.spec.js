...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.PostCommentForComparedCommitOutput();
  });
  ...
  describe('PostCommentForComparedCommitOutput', function() {
    it('should create an instance of PostCommentForComparedCommitOutput', function() {
      // uncomment below and update the code to test PostCommentForComparedCommitOutput
      //var instance = new AwsCodeCommit.PostCommentForComparedCommitOutput();
      //expect(instance).to.be.a(AwsCodeCommit.PostCommentForComparedCommitOutput);
    });
