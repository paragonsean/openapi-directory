...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.UntagResourceInput();
  });
  ...
  describe('UntagResourceInput', function() {
    it('should create an instance of UntagResourceInput', function() {
      ...
      //var instance = new AwsCodeCommit.UntagResourceInput();
      //expect(instance).to.be.a(AwsCodeCommit.UntagResourceInput);
    });
