...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.PutFileInput();
  });
  ...
  describe('PutFileInput', function() {
    it('should create an instance of PutFileInput', function() {
      // uncomment below and update the code to test PutFileInput
      //var instance = new AwsCodeCommit.PutFileInput();
      //expect(instance).to.be.a(AwsCodeCommit.PutFileInput);
    });
