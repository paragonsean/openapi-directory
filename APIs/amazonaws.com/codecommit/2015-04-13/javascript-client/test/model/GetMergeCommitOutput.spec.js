...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.GetMergeCommitOutput();
  });
  ...
  describe('GetMergeCommitOutput', function() {
    it('should create an instance of GetMergeCommitOutput', function() {
      // uncomment below and update the code to test GetMergeCommitOutput
      //var instance = new AwsCodeCommit.GetMergeCommitOutput();
      //expect(instance).to.be.a(AwsCodeCommit.GetMergeCommitOutput);
    });
    ...
    it('should have the property mergedCommitId (base name: "mergedCommitId")', function() {
      // uncomment below and update the code to test the property mergedCommitId
      //var instance = new AwsCodeCommit.GetMergeCommitOutput();
      //expect(instance).to.be();
    });
