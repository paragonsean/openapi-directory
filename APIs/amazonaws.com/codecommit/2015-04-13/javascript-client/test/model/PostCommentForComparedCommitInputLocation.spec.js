...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.PostCommentForComparedCommitInputLocation();
  });
  ...
  describe('PostCommentForComparedCommitInputLocation', function() {
    it('should create an instance of PostCommentForComparedCommitInputLocation', function() {
      // uncomment below and update the code to test PostCommentForComparedCommitInputLocation
      //var instance = new AwsCodeCommit.PostCommentForComparedCommitInputLocation();
      //expect(instance).to.be.a(AwsCodeCommit.PostCommentForComparedCommitInputLocation);
    });
