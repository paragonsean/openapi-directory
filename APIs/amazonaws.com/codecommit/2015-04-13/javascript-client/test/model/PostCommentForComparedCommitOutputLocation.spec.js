...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.PostCommentForComparedCommitOutputLocation();
  });
  ...
  describe('PostCommentForComparedCommitOutputLocation', function() {
    it('should create an instance of PostCommentForComparedCommitOutputLocation', function() {
      // uncomment below and update the code to test PostCommentForComparedCommitOutputLocation
      //var instance = new AwsCodeCommit.PostCommentForComparedCommitOutputLocation();
      //expect(instance).to.be.a(AwsCodeCommit.PostCommentForComparedCommitOutputLocation);
    });
