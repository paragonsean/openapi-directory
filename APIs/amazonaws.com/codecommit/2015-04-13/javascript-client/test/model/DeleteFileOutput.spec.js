...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.DeleteFileOutput();
  });
  ...
  describe('DeleteFileOutput', function() {
    it('should create an instance of DeleteFileOutput', function() {
      // uncomment below and update the code to test DeleteFileOutput
      //var instance = new AwsCodeCommit.DeleteFileOutput();
      //expect(instance).to.be.a(AwsCodeCommit.DeleteFileOutput);
    });
