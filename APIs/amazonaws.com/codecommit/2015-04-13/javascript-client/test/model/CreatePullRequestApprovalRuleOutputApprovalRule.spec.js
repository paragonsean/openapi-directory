...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.CreatePullRequestApprovalRuleOutputApprovalRule();
  });
  ...
  describe('CreatePullRequestApprovalRuleOutputApprovalRule', function() {
    it('should create an instance of CreatePullRequestApprovalRuleOutputApprovalRule', function() {
      // uncomment below and update the code to test CreatePullRequestApprovalRuleOutputApprovalRule
      //var instance = new AwsCodeCommit.CreatePullRequestApprovalRuleOutputApprovalRule();
      //expect(instance).to.be.a(AwsCodeCommit.CreatePullRequestApprovalRuleOutputApprovalRule);
    });
