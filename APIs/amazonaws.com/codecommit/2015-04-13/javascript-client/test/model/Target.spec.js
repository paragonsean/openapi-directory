...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.Target();
  });
  ...
  describe('Target', function() {
    it('should create an instance of Target', function() {
      ...
      //var instance = new AwsCodeCommit.Target();
      //expect(instance).to.be.a(AwsCodeCommit.Target);
    });
    ...
    it('should have the property destinationReference (base name: "destinationReference")', function() {
      // uncomment below and update the code to test the property destinationReference
      //var instance = new AwsCodeCommit.Target();
      //expect(instance).to.be();
    });
