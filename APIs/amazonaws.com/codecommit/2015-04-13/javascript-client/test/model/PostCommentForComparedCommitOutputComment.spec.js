...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.PostCommentForComparedCommitOutputComment();
  });
  ...
  describe('PostCommentForComparedCommitOutputComment', function() {
    it('should create an instance of PostCommentForComparedCommitOutputComment', function() {
      // uncomment below and update the code to test PostCommentForComparedCommitOutputComment
      //var instance = new AwsCodeCommit.PostCommentForComparedCommitOutputComment();
      //expect(instance).to.be.a(AwsCodeCommit.PostCommentForComparedCommitOutputComment);
    });
