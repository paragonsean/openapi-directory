...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.ListTagsForResourceOutput();
  });
  ...
  describe('ListTagsForResourceOutput', function() {
    it('should create an instance of ListTagsForResourceOutput', function() {
      ...
      //var instance = new AwsCodeCommit.ListTagsForResourceOutput();
      //expect(instance).to.be.a(AwsCodeCommit.ListTagsForResourceOutput);
    });
