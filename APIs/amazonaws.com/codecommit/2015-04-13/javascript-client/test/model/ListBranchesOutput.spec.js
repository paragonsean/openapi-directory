...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.ListBranchesOutput();
  });
  ...
  describe('ListBranchesOutput', function() {
    it('should create an instance of ListBranchesOutput', function() {
      // uncomment below and update the code to test ListBranchesOutput
      //var instance = new AwsCodeCommit.ListBranchesOutput();
      //expect(instance).to.be.a(AwsCodeCommit.ListBranchesOutput);
    });
