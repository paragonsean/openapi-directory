...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.GetCommentReactionsInput();
  });
  ...
  describe('GetCommentReactionsInput', function() {
    it('should create an instance of GetCommentReactionsInput', function() {
      // uncomment below and update the code to test GetCommentReactionsInput
      //var instance = new AwsCodeCommit.GetCommentReactionsInput();
      //expect(instance).to.be.a(AwsCodeCommit.GetCommentReactionsInput);
    });
    ...
    it('should have the property reactionUserArn (base name: "reactionUserArn")', function() {
      // uncomment below and update the code to test the property reactionUserArn
      //var instance = new AwsCodeCommit.GetCommentReactionsInput();
      //expect(instance).to.be();
    });
