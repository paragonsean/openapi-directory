...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.ListRepositoriesInput();
  });
  ...
  describe('ListRepositoriesInput', function() {
    it('should create an instance of ListRepositoriesInput', function() {
      // uncomment below and update the code to test ListRepositoriesInput
      //var instance = new AwsCodeCommit.ListRepositoriesInput();
      //expect(instance).to.be.a(AwsCodeCommit.ListRepositoriesInput);
    });
