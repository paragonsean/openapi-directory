...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.GetDifferencesOutput();
  });
  ...
  describe('GetDifferencesOutput', function() {
    it('should create an instance of GetDifferencesOutput', function() {
      // uncomment below and update the code to test GetDifferencesOutput
      //var instance = new AwsCodeCommit.GetDifferencesOutput();
      //expect(instance).to.be.a(AwsCodeCommit.GetDifferencesOutput);
    });
