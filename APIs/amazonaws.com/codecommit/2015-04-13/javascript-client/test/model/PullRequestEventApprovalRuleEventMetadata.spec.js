...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.PullRequestEventApprovalRuleEventMetadata();
  });
  ...
  describe('PullRequestEventApprovalRuleEventMetadata', function() {
    it('should create an instance of PullRequestEventApprovalRuleEventMetadata', function() {
      // uncomment below and update the code to test PullRequestEventApprovalRuleEventMetadata
      //var instance = new AwsCodeCommit.PullRequestEventApprovalRuleEventMetadata();
      //expect(instance).to.be.a(AwsCodeCommit.PullRequestEventApprovalRuleEventMetadata);
    });
