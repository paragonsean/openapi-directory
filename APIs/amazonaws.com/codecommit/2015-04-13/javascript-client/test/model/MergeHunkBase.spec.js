...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.MergeHunkBase();
  });
  ...
  describe('MergeHunkBase', function() {
    it('should create an instance of MergeHunkBase', function() {
      // uncomment below and update the code to test MergeHunkBase
      //var instance = new AwsCodeCommit.MergeHunkBase();
      //expect(instance).to.be.a(AwsCodeCommit.MergeHunkBase);
    });
