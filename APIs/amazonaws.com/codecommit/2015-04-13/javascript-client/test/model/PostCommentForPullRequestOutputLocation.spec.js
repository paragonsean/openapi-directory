...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.PostCommentForPullRequestOutputLocation();
  });
  ...
  describe('PostCommentForPullRequestOutputLocation', function() {
    it('should create an instance of PostCommentForPullRequestOutputLocation', function() {
      // uncomment below and update the code to test PostCommentForPullRequestOutputLocation
      //var instance = new AwsCodeCommit.PostCommentForPullRequestOutputLocation();
      //expect(instance).to.be.a(AwsCodeCommit.PostCommentForPullRequestOutputLocation);
    });
    ...
    it('should have the property filePosition (base name: "filePosition")', function() {
      // uncomment below and update the code to test the property filePosition
      //var instance = new AwsCodeCommit.PostCommentForPullRequestOutputLocation();
      //expect(instance).to.be();
    });

    it('should have the property relativeFileVersion (base name: "relativeFileVersion")', function() {
      // uncomment below and update the code to test the property relativeFileVersion
      //var instance = new AwsCodeCommit.PostCommentForPullRequestOutputLocation();
      //expect(instance).to.be();
    });
