...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.UpdateRepositoryNameInput();
  });
  ...
  describe('UpdateRepositoryNameInput', function() {
    it('should create an instance of UpdateRepositoryNameInput', function() {
      // uncomment below and update the code to test UpdateRepositoryNameInput
      //var instance = new AwsCodeCommit.UpdateRepositoryNameInput();
      //expect(instance).to.be.a(AwsCodeCommit.UpdateRepositoryNameInput);
    });

    it('should have the property oldName (base name: "oldName")', function() {
