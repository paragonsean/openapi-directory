...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.PostCommentForPullRequestInput();
  });
  ...
  describe('PostCommentForPullRequestInput', function() {
    it('should create an instance of PostCommentForPullRequestInput', function() {
      // uncomment below and update the code to test PostCommentForPullRequestInput
      //var instance = new AwsCodeCommit.PostCommentForPullRequestInput();
      //expect(instance).to.be.a(AwsCodeCommit.PostCommentForPullRequestInput);
    });
