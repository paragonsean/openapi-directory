...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.ReactionValueFormats();
  });
  ...
  describe('ReactionValueFormats', function() {
    it('should create an instance of ReactionValueFormats', function() {
      // uncomment below and update the code to test ReactionValueFormats
      //var instance = new AwsCodeCommit.ReactionValueFormats();
      //expect(instance).to.be.a(AwsCodeCommit.ReactionValueFormats);
    });
