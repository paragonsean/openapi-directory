...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.GetRepositoryTriggersOutput();
  });
  ...
  describe('GetRepositoryTriggersOutput', function() {
    it('should create an instance of GetRepositoryTriggersOutput', function() {
      // uncomment below and update the code to test GetRepositoryTriggersOutput
      //var instance = new AwsCodeCommit.GetRepositoryTriggersOutput();
      //expect(instance).to.be.a(AwsCodeCommit.GetRepositoryTriggersOutput);
    });
