...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.BlobMetadata();
  });
  ...
  describe('BlobMetadata', function() {
    it('should create an instance of BlobMetadata', function() {
      // uncomment below and update the code to test BlobMetadata
      //var instance = new AwsCodeCommit.BlobMetadata();
      //expect(instance).to.be.a(AwsCodeCommit.BlobMetadata);
    });
