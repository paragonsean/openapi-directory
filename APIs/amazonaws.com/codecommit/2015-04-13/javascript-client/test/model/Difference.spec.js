...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.Difference();
  });
  ...
  describe('Difference', function() {
    it('should create an instance of Difference', function() {
      // uncomment below and update the code to test Difference
      //var instance = new AwsCodeCommit.Difference();
      //expect(instance).to.be.a(AwsCodeCommit.Difference);
    });

    it('should have the property beforeBlob (base name: "beforeBlob")', function() {
      // uncomment below and update the code to test the property beforeBlob
      //var instance = new AwsCodeCommit.Difference();
      //expect(instance).to.be();
    });

    it('should have the property afterBlob (base name: "afterBlob")', function() {
      // uncomment below and update the code to test the property afterBlob
      //var instance = new AwsCodeCommit.Difference();
      //expect(instance).to.be();
    });
