...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.CommitCommitter();
  });
  ...
  describe('CommitCommitter', function() {
    it('should create an instance of CommitCommitter', function() {
      // uncomment below and update the code to test CommitCommitter
      //var instance = new AwsCodeCommit.CommitCommitter();
      //expect(instance).to.be.a(AwsCodeCommit.CommitCommitter);
    });
