...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.GetMergeOptionsOutput();
  });
  ...
  describe('GetMergeOptionsOutput', function() {
    it('should create an instance of GetMergeOptionsOutput', function() {
      // uncomment below and update the code to test GetMergeOptionsOutput
      //var instance = new AwsCodeCommit.GetMergeOptionsOutput();
      //expect(instance).to.be.a(AwsCodeCommit.GetMergeOptionsOutput);
    });

    it('should have the property mergeOptions (base name: "mergeOptions")', function() {
      // uncomment below and update the code to test the property mergeOptions
      //var instance = new AwsCodeCommit.GetMergeOptionsOutput();
