...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.CreatePullRequestApprovalRuleInput();
  });
  ...
  describe('CreatePullRequestApprovalRuleInput', function() {
    it('should create an instance of CreatePullRequestApprovalRuleInput', function() {
      // uncomment below and update the code to test CreatePullRequestApprovalRuleInput
      //var instance = new AwsCodeCommit.CreatePullRequestApprovalRuleInput();
      //expect(instance).to.be.a(AwsCodeCommit.CreatePullRequestApprovalRuleInput);
    });
    ...
    it('should have the property approvalRuleName (base name: "approvalRuleName")', function() {
      // uncomment below and update the code to test the property approvalRuleName
      //var instance = new AwsCodeCommit.CreatePullRequestApprovalRuleInput();
      //expect(instance).to.be();
    });

    it('should have the property approvalRuleContent (base name: "approvalRuleContent")', function() {
      // uncomment below and update the code to test the property approvalRuleContent
      //var instance = new AwsCodeCommit.CreatePullRequestApprovalRuleInput();
      //expect(instance).to.be();
    });
