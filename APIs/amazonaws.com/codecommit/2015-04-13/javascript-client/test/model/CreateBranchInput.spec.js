...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.CreateBranchInput();
  });
  ...
  describe('CreateBranchInput', function() {
    it('should create an instance of CreateBranchInput', function() {
      // uncomment below and update the code to test CreateBranchInput
      //var instance = new AwsCodeCommit.CreateBranchInput();
      //expect(instance).to.be.a(AwsCodeCommit.CreateBranchInput);
    });
