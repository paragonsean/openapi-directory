...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.PullRequestMergedStateChangedEventMetadataMergeMetadata();
  });
  ...
  describe('PullRequestMergedStateChangedEventMetadataMergeMetadata', function() {
    it('should create an instance of PullRequestMergedStateChangedEventMetadataMergeMetadata', function() {
      // uncomment below and update the code to test PullRequestMergedStateChangedEventMetadataMergeMetadata
      //var instance = new AwsCodeCommit.PullRequestMergedStateChangedEventMetadataMergeMetadata();
      //expect(instance).to.be.a(AwsCodeCommit.PullRequestMergedStateChangedEventMetadataMergeMetadata);
    });
