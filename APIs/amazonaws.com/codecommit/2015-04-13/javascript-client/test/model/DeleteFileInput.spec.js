...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.DeleteFileInput();
  });
  ...
  describe('DeleteFileInput', function() {
    it('should create an instance of DeleteFileInput', function() {
      // uncomment below and update the code to test DeleteFileInput
      //var instance = new AwsCodeCommit.DeleteFileInput();
      //expect(instance).to.be.a(AwsCodeCommit.DeleteFileInput);
    });
    ...
    it('should have the property parentCommitId (base name: "parentCommitId")', function() {
      // uncomment below and update the code to test the property parentCommitId
      //var instance = new AwsCodeCommit.DeleteFileInput();
      //expect(instance).to.be();
    });
