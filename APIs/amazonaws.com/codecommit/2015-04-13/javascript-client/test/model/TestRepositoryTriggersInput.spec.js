...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.TestRepositoryTriggersInput();
  });
  ...
  describe('TestRepositoryTriggersInput', function() {
    it('should create an instance of TestRepositoryTriggersInput', function() {
      // uncomment below and update the code to test TestRepositoryTriggersInput
      //var instance = new AwsCodeCommit.TestRepositoryTriggersInput();
      //expect(instance).to.be.a(AwsCodeCommit.TestRepositoryTriggersInput);
    });
