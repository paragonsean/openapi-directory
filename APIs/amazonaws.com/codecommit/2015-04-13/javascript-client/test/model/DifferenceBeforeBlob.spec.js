...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.DifferenceBeforeBlob();
  });
  ...
  describe('DifferenceBeforeBlob', function() {
    it('should create an instance of DifferenceBeforeBlob', function() {
      // uncomment below and update the code to test DifferenceBeforeBlob
      //var instance = new AwsCodeCommit.DifferenceBeforeBlob();
      //expect(instance).to.be.a(AwsCodeCommit.DifferenceBeforeBlob);
    });
