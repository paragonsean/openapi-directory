...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.ConflictMetadataIsBinaryFile();
  });
  ...
  describe('ConflictMetadataIsBinaryFile', function() {
    it('should create an instance of ConflictMetadataIsBinaryFile', function() {
      // uncomment below and update the code to test ConflictMetadataIsBinaryFile
      //var instance = new AwsCodeCommit.ConflictMetadataIsBinaryFile();
      //expect(instance).to.be.a(AwsCodeCommit.ConflictMetadataIsBinaryFile);
    });
