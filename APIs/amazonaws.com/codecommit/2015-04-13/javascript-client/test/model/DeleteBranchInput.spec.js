...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.DeleteBranchInput();
  });
  ...
  describe('DeleteBranchInput', function() {
    it('should create an instance of DeleteBranchInput', function() {
      // uncomment below and update the code to test DeleteBranchInput
      //var instance = new AwsCodeCommit.DeleteBranchInput();
      //expect(instance).to.be.a(AwsCodeCommit.DeleteBranchInput);
    });
