...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.MergePullRequestByThreeWayInput();
  });
  ...
  describe('MergePullRequestByThreeWayInput', function() {
    it('should create an instance of MergePullRequestByThreeWayInput', function() {
      // uncomment below and update the code to test MergePullRequestByThreeWayInput
      //var instance = new AwsCodeCommit.MergePullRequestByThreeWayInput();
      //expect(instance).to.be.a(AwsCodeCommit.MergePullRequestByThreeWayInput);
    });
    ...
    it('should have the property sourceCommitId (base name: "sourceCommitId")', function() {
      // uncomment below and update the code to test the property sourceCommitId
      //var instance = new AwsCodeCommit.MergePullRequestByThreeWayInput();
      //expect(instance).to.be();
    });
