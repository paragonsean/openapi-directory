...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.BatchDescribeMergeConflictsError();
  });
  ...
  describe('BatchDescribeMergeConflictsError', function() {
    it('should create an instance of BatchDescribeMergeConflictsError', function() {
      // uncomment below and update the code to test BatchDescribeMergeConflictsError
      //var instance = new AwsCodeCommit.BatchDescribeMergeConflictsError();
      //expect(instance).to.be.a(AwsCodeCommit.BatchDescribeMergeConflictsError);
    });
    ...
    it('should have the property exceptionName (base name: "exceptionName")', function() {
      // uncomment below and update the code to test the property exceptionName
      //var instance = new AwsCodeCommit.BatchDescribeMergeConflictsError();
      //expect(instance).to.be();
    });
