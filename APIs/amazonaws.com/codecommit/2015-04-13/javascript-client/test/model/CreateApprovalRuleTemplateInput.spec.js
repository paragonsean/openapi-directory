...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.CreateApprovalRuleTemplateInput();
  });
  ...
  describe('CreateApprovalRuleTemplateInput', function() {
    it('should create an instance of CreateApprovalRuleTemplateInput', function() {
      // uncomment below and update the code to test CreateApprovalRuleTemplateInput
      //var instance = new AwsCodeCommit.CreateApprovalRuleTemplateInput();
      //expect(instance).to.be.a(AwsCodeCommit.CreateApprovalRuleTemplateInput);
    });
