...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.CreateRepositoryOutputRepositoryMetadata();
  });
  ...
  describe('CreateRepositoryOutputRepositoryMetadata', function() {
    it('should create an instance of CreateRepositoryOutputRepositoryMetadata', function() {
      // uncomment below and update the code to test CreateRepositoryOutputRepositoryMetadata
      //var instance = new AwsCodeCommit.CreateRepositoryOutputRepositoryMetadata();
      //expect(instance).to.be.a(AwsCodeCommit.CreateRepositoryOutputRepositoryMetadata);
    });
