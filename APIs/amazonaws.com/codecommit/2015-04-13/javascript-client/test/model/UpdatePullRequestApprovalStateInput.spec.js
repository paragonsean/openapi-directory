...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.UpdatePullRequestApprovalStateInput();
  });
  ...
  describe('UpdatePullRequestApprovalStateInput', function() {
    it('should create an instance of UpdatePullRequestApprovalStateInput', function() {
      // uncomment below and update the code to test UpdatePullRequestApprovalStateInput
      //var instance = new AwsCodeCommit.UpdatePullRequestApprovalStateInput();
      //expect(instance).to.be.a(AwsCodeCommit.UpdatePullRequestApprovalStateInput);
    });
