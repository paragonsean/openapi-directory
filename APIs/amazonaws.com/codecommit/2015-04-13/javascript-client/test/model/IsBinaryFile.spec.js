...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.IsBinaryFile();
  });
  ...
  describe('IsBinaryFile', function() {
    it('should create an instance of IsBinaryFile', function() {
      // uncomment below and update the code to test IsBinaryFile
      //var instance = new AwsCodeCommit.IsBinaryFile();
      //expect(instance).to.be.a(AwsCodeCommit.IsBinaryFile);
    });
