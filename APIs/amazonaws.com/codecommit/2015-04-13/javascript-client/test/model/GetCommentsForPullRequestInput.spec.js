...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.GetCommentsForPullRequestInput();
  });
  ...
  describe('GetCommentsForPullRequestInput', function() {
    it('should create an instance of GetCommentsForPullRequestInput', function() {
      // uncomment below and update the code to test GetCommentsForPullRequestInput
      //var instance = new AwsCodeCommit.GetCommentsForPullRequestInput();
      //expect(instance).to.be.a(AwsCodeCommit.GetCommentsForPullRequestInput);
    });
