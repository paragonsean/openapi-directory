...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.ApprovalRuleTemplate();
  });
  ...
  describe('ApprovalRuleTemplate', function() {
    it('should create an instance of ApprovalRuleTemplate', function() {
      // uncomment below and update the code to test ApprovalRuleTemplate
      //var instance = new AwsCodeCommit.ApprovalRuleTemplate();
      //expect(instance).to.be.a(AwsCodeCommit.ApprovalRuleTemplate);
    });
