...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.DescribeMergeConflictsOutputConflictMetadata();
  });
  ...
  describe('DescribeMergeConflictsOutputConflictMetadata', function() {
    it('should create an instance of DescribeMergeConflictsOutputConflictMetadata', function() {
      // uncomment below and update the code to test DescribeMergeConflictsOutputConflictMetadata
      //var instance = new AwsCodeCommit.DescribeMergeConflictsOutputConflictMetadata();
      //expect(instance).to.be.a(AwsCodeCommit.DescribeMergeConflictsOutputConflictMetadata);
    });
    ...
    it('should have the property fileSizes (base name: "fileSizes")', function() {
      // uncomment below and update the code to test the property fileSizes
      //var instance = new AwsCodeCommit.DescribeMergeConflictsOutputConflictMetadata();
      //expect(instance).to.be();
    });

    it('should have the property fileModes (base name: "fileModes")', function() {
      // uncomment below and update the code to test the property fileModes
      //var instance = new AwsCodeCommit.DescribeMergeConflictsOutputConflictMetadata();
      //expect(instance).to.be();
    });
    ...
    it('should have the property numberOfConflicts (base name: "numberOfConflicts")', function() {
      // uncomment below and update the code to test the property numberOfConflicts
      //var instance = new AwsCodeCommit.DescribeMergeConflictsOutputConflictMetadata();
      //expect(instance).to.be();
    });

    it('should have the property isBinaryFile (base name: "isBinaryFile")', function() {
      // uncomment below and update the code to test the property isBinaryFile
      //var instance = new AwsCodeCommit.DescribeMergeConflictsOutputConflictMetadata();
      //expect(instance).to.be();
    });

    it('should have the property contentConflict (base name: "contentConflict")', function() {
      // uncomment below and update the code to test the property contentConflict
      //var instance = new AwsCodeCommit.DescribeMergeConflictsOutputConflictMetadata();
      //expect(instance).to.be();
    });

    it('should have the property fileModeConflict (base name: "fileModeConflict")', function() {
      // uncomment below and update the code to test the property fileModeConflict
      //var instance = new AwsCodeCommit.DescribeMergeConflictsOutputConflictMetadata();
      //expect(instance).to.be();
    });

    it('should have the property objectTypeConflict (base name: "objectTypeConflict")', function() {
      // uncomment below and update the code to test the property objectTypeConflict
      //var instance = new AwsCodeCommit.DescribeMergeConflictsOutputConflictMetadata();
      //expect(instance).to.be();
    });

    it('should have the property mergeOperations (base name: "mergeOperations")', function() {
      // uncomment below and update the code to test the property mergeOperations
      //var instance = new AwsCodeCommit.DescribeMergeConflictsOutputConflictMetadata();
      //expect(instance).to.be();
    });
