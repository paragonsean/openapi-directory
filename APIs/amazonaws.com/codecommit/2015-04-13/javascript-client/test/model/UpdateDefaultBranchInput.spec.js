...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.UpdateDefaultBranchInput();
  });
  ...
  describe('UpdateDefaultBranchInput', function() {
    it('should create an instance of UpdateDefaultBranchInput', function() {
      // uncomment below and update the code to test UpdateDefaultBranchInput
      //var instance = new AwsCodeCommit.UpdateDefaultBranchInput();
      //expect(instance).to.be.a(AwsCodeCommit.UpdateDefaultBranchInput);
    });
    ...
    it('should have the property defaultBranchName (base name: "defaultBranchName")', function() {
      // uncomment below and update the code to test the property defaultBranchName
      //var instance = new AwsCodeCommit.UpdateDefaultBranchInput();
      //expect(instance).to.be();
    });
