...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.BatchGetCommitsInput();
  });
  ...
  describe('BatchGetCommitsInput', function() {
    it('should create an instance of BatchGetCommitsInput', function() {
      // uncomment below and update the code to test BatchGetCommitsInput
      //var instance = new AwsCodeCommit.BatchGetCommitsInput();
      //expect(instance).to.be.a(AwsCodeCommit.BatchGetCommitsInput);
    });

    it('should have the property commitIds (base name: "commitIds")', function() {
      // uncomment below and update the code to test the property commitIds
      //var instance = new AwsCodeCommit.BatchGetCommitsInput();
