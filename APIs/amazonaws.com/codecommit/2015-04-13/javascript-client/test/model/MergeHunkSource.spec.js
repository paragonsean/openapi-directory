...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.MergeHunkSource();
  });
  ...
  describe('MergeHunkSource', function() {
    it('should create an instance of MergeHunkSource', function() {
      // uncomment below and update the code to test MergeHunkSource
      //var instance = new AwsCodeCommit.MergeHunkSource();
      //expect(instance).to.be.a(AwsCodeCommit.MergeHunkSource);
    });
