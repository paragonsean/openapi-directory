...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.BatchDescribeMergeConflictsInput();
  });
  ...
  describe('BatchDescribeMergeConflictsInput', function() {
    it('should create an instance of BatchDescribeMergeConflictsInput', function() {
      // uncomment below and update the code to test BatchDescribeMergeConflictsInput
      //var instance = new AwsCodeCommit.BatchDescribeMergeConflictsInput();
      //expect(instance).to.be.a(AwsCodeCommit.BatchDescribeMergeConflictsInput);
    });
    ...
    it('should have the property maxMergeHunks (base name: "maxMergeHunks")', function() {
      // uncomment below and update the code to test the property maxMergeHunks
      //var instance = new AwsCodeCommit.BatchDescribeMergeConflictsInput();
      //expect(instance).to.be();
    });

    it('should have the property maxConflictFiles (base name: "maxConflictFiles")', function() {
      // uncomment below and update the code to test the property maxConflictFiles
      //var instance = new AwsCodeCommit.BatchDescribeMergeConflictsInput();
      //expect(instance).to.be();
    });
