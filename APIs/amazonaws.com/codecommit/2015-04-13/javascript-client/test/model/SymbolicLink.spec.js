...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.SymbolicLink();
  });
  ...
  describe('SymbolicLink', function() {
    it('should create an instance of SymbolicLink', function() {
      // uncomment below and update the code to test SymbolicLink
      //var instance = new AwsCodeCommit.SymbolicLink();
      //expect(instance).to.be.a(AwsCodeCommit.SymbolicLink);
    });
