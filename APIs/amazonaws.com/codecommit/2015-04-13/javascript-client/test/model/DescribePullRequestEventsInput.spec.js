...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.DescribePullRequestEventsInput();
  });
  ...
  describe('DescribePullRequestEventsInput', function() {
    it('should create an instance of DescribePullRequestEventsInput', function() {
      // uncomment below and update the code to test DescribePullRequestEventsInput
      //var instance = new AwsCodeCommit.DescribePullRequestEventsInput();
      //expect(instance).to.be.a(AwsCodeCommit.DescribePullRequestEventsInput);
    });
