...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.ApprovalRuleEventMetadata();
  });
  ...
  describe('ApprovalRuleEventMetadata', function() {
    it('should create an instance of ApprovalRuleEventMetadata', function() {
      // uncomment below and update the code to test ApprovalRuleEventMetadata
      //var instance = new AwsCodeCommit.ApprovalRuleEventMetadata();
      //expect(instance).to.be.a(AwsCodeCommit.ApprovalRuleEventMetadata);
    });
