...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.GetMergeOptionsInput();
  });
  ...
  describe('GetMergeOptionsInput', function() {
    it('should create an instance of GetMergeOptionsInput', function() {
      // uncomment below and update the code to test GetMergeOptionsInput
      //var instance = new AwsCodeCommit.GetMergeOptionsInput();
      //expect(instance).to.be.a(AwsCodeCommit.GetMergeOptionsInput);
    });
