...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.ReactionForComment();
  });
  ...
  describe('ReactionForComment', function() {
    it('should create an instance of ReactionForComment', function() {
      // uncomment below and update the code to test ReactionForComment
      //var instance = new AwsCodeCommit.ReactionForComment();
      //expect(instance).to.be.a(AwsCodeCommit.ReactionForComment);
    });
    ...
    it('should have the property reactionUsers (base name: "reactionUsers")', function() {
      // uncomment below and update the code to test the property reactionUsers
      //var instance = new AwsCodeCommit.ReactionForComment();
      //expect(instance).to.be();
    });

    it('should have the property reactionsFromDeletedUsersCount (base name: "reactionsFromDeletedUsersCount")', function() {
      // uncomment below and update the code to test the property reactionsFromDeletedUsersCount
      //var instance = new AwsCodeCommit.ReactionForComment();
      //expect(instance).to.be();
    });
