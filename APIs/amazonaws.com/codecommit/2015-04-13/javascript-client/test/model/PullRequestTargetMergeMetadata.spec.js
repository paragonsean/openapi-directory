...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.PullRequestTargetMergeMetadata();
  });
  ...
  describe('PullRequestTargetMergeMetadata', function() {
    it('should create an instance of PullRequestTargetMergeMetadata', function() {
      // uncomment below and update the code to test PullRequestTargetMergeMetadata
      //var instance = new AwsCodeCommit.PullRequestTargetMergeMetadata();
      //expect(instance).to.be.a(AwsCodeCommit.PullRequestTargetMergeMetadata);
    });

    it('should have the property isMerged (base name: "isMerged")', function() {
      // uncomment below and update the code to test the property isMerged
      //var instance = new AwsCodeCommit.PullRequestTargetMergeMetadata();
      //expect(instance).to.be();
    });

    it('should have the property mergedBy (base name: "mergedBy")', function() {
