...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.ListPullRequestsInput();
  });
  ...
  describe('ListPullRequestsInput', function() {
    it('should create an instance of ListPullRequestsInput', function() {
      // uncomment below and update the code to test ListPullRequestsInput
      //var instance = new AwsCodeCommit.ListPullRequestsInput();
      //expect(instance).to.be.a(AwsCodeCommit.ListPullRequestsInput);
    });
