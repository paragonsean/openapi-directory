...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.CommentsForPullRequest();
  });
  ...
  describe('CommentsForPullRequest', function() {
    it('should create an instance of CommentsForPullRequest', function() {
      // uncomment below and update the code to test CommentsForPullRequest
      //var instance = new AwsCodeCommit.CommentsForPullRequest();
      //expect(instance).to.be.a(AwsCodeCommit.CommentsForPullRequest);
    });
