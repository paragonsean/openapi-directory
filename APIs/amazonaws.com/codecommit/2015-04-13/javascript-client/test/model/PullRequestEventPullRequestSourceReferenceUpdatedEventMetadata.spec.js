...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata();
  });
  ...
  describe('PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata', function() {
    it('should create an instance of PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata', function() {
      // uncomment below and update the code to test PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata
      //var instance = new AwsCodeCommit.PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata();
      //expect(instance).to.be.a(AwsCodeCommit.PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata);
    });
    ...
    it('should have the property beforeCommitId (base name: "beforeCommitId")', function() {
      // uncomment below and update the code to test the property beforeCommitId
      //var instance = new AwsCodeCommit.PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata();
      //expect(instance).to.be();
    });

    it('should have the property afterCommitId (base name: "afterCommitId")', function() {
      // uncomment below and update the code to test the property afterCommitId
      //var instance = new AwsCodeCommit.PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata();
      //expect(instance).to.be();
    });

    it('should have the property mergeBase (base name: "mergeBase")', function() {
