...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.FileSizes();
  });
  ...
  describe('FileSizes', function() {
    it('should create an instance of FileSizes', function() {
      // uncomment below and update the code to test FileSizes
      //var instance = new AwsCodeCommit.FileSizes();
      //expect(instance).to.be.a(AwsCodeCommit.FileSizes);
    });
