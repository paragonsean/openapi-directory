...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.PostCommentForPullRequestInputLocation();
  });
  ...
  describe('PostCommentForPullRequestInputLocation', function() {
    it('should create an instance of PostCommentForPullRequestInputLocation', function() {
      // uncomment below and update the code to test PostCommentForPullRequestInputLocation
      //var instance = new AwsCodeCommit.PostCommentForPullRequestInputLocation();
      //expect(instance).to.be.a(AwsCodeCommit.PostCommentForPullRequestInputLocation);
    });
