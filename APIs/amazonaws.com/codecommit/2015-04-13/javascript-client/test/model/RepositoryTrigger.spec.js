...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.RepositoryTrigger();
  });
  ...
  describe('RepositoryTrigger', function() {
    it('should create an instance of RepositoryTrigger', function() {
      // uncomment below and update the code to test RepositoryTrigger
      //var instance = new AwsCodeCommit.RepositoryTrigger();
      //expect(instance).to.be.a(AwsCodeCommit.RepositoryTrigger);
    });
