...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.EvaluatePullRequestApprovalRulesOutputEvaluation();
  });
  ...
  describe('EvaluatePullRequestApprovalRulesOutputEvaluation', function() {
    it('should create an instance of EvaluatePullRequestApprovalRulesOutputEvaluation', function() {
      // uncomment below and update the code to test EvaluatePullRequestApprovalRulesOutputEvaluation
      //var instance = new AwsCodeCommit.EvaluatePullRequestApprovalRulesOutputEvaluation();
      //expect(instance).to.be.a(AwsCodeCommit.EvaluatePullRequestApprovalRulesOutputEvaluation);
    });
    ...
    it('should have the property approvalRulesSatisfied (base name: "approvalRulesSatisfied")', function() {
      // uncomment below and update the code to test the property approvalRulesSatisfied
      //var instance = new AwsCodeCommit.EvaluatePullRequestApprovalRulesOutputEvaluation();
      //expect(instance).to.be();
    });

    it('should have the property approvalRulesNotSatisfied (base name: "approvalRulesNotSatisfied")', function() {
      // uncomment below and update the code to test the property approvalRulesNotSatisfied
      //var instance = new AwsCodeCommit.EvaluatePullRequestApprovalRulesOutputEvaluation();
      //expect(instance).to.be();
    });
