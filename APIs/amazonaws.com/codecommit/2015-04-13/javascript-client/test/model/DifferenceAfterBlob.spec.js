...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.DifferenceAfterBlob();
  });
  ...
  describe('DifferenceAfterBlob', function() {
    it('should create an instance of DifferenceAfterBlob', function() {
      // uncomment below and update the code to test DifferenceAfterBlob
      //var instance = new AwsCodeCommit.DifferenceAfterBlob();
      //expect(instance).to.be.a(AwsCodeCommit.DifferenceAfterBlob);
    });
