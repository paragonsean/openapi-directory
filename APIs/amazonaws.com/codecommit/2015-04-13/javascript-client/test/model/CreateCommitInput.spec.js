...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.CreateCommitInput();
  });
  ...
  describe('CreateCommitInput', function() {
    it('should create an instance of CreateCommitInput', function() {
      // uncomment below and update the code to test CreateCommitInput
      //var instance = new AwsCodeCommit.CreateCommitInput();
      //expect(instance).to.be.a(AwsCodeCommit.CreateCommitInput);
    });
    ...
    it('should have the property putFiles (base name: "putFiles")', function() {
      // uncomment below and update the code to test the property putFiles
      //var instance = new AwsCodeCommit.CreateCommitInput();
      //expect(instance).to.be();
    });
