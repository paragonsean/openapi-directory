...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.PullRequestSourceReferenceUpdatedEventMetadata();
  });
  ...
  describe('PullRequestSourceReferenceUpdatedEventMetadata', function() {
    it('should create an instance of PullRequestSourceReferenceUpdatedEventMetadata', function() {
      // uncomment below and update the code to test PullRequestSourceReferenceUpdatedEventMetadata
      //var instance = new AwsCodeCommit.PullRequestSourceReferenceUpdatedEventMetadata();
      //expect(instance).to.be.a(AwsCodeCommit.PullRequestSourceReferenceUpdatedEventMetadata);
    });
