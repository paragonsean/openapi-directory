...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.ListApprovalRuleTemplatesInput();
  });
  ...
  describe('ListApprovalRuleTemplatesInput', function() {
    it('should create an instance of ListApprovalRuleTemplatesInput', function() {
      // uncomment below and update the code to test ListApprovalRuleTemplatesInput
      //var instance = new AwsCodeCommit.ListApprovalRuleTemplatesInput();
      //expect(instance).to.be.a(AwsCodeCommit.ListApprovalRuleTemplatesInput);
    });
