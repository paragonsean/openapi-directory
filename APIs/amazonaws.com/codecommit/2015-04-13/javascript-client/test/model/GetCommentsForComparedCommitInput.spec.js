...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.GetCommentsForComparedCommitInput();
  });
  ...
  describe('GetCommentsForComparedCommitInput', function() {
    it('should create an instance of GetCommentsForComparedCommitInput', function() {
      // uncomment below and update the code to test GetCommentsForComparedCommitInput
      //var instance = new AwsCodeCommit.GetCommentsForComparedCommitInput();
      //expect(instance).to.be.a(AwsCodeCommit.GetCommentsForComparedCommitInput);
    });
