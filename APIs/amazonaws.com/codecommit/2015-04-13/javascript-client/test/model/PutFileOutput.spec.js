...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.PutFileOutput();
  });
  ...
  describe('PutFileOutput', function() {
    it('should create an instance of PutFileOutput', function() {
      // uncomment below and update the code to test PutFileOutput
      //var instance = new AwsCodeCommit.PutFileOutput();
      //expect(instance).to.be.a(AwsCodeCommit.PutFileOutput);
    });
