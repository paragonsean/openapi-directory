...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.GetApprovalRuleTemplateOutputApprovalRuleTemplate();
  });
  ...
  describe('GetApprovalRuleTemplateOutputApprovalRuleTemplate', function() {
    it('should create an instance of GetApprovalRuleTemplateOutputApprovalRuleTemplate', function() {
      // uncomment below and update the code to test GetApprovalRuleTemplateOutputApprovalRuleTemplate
      //var instance = new AwsCodeCommit.GetApprovalRuleTemplateOutputApprovalRuleTemplate();
      //expect(instance).to.be.a(AwsCodeCommit.GetApprovalRuleTemplateOutputApprovalRuleTemplate);
    });
