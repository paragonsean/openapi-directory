...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.GetCommentOutputComment();
  });
  ...
  describe('GetCommentOutputComment', function() {
    it('should create an instance of GetCommentOutputComment', function() {
      // uncomment below and update the code to test GetCommentOutputComment
      //var instance = new AwsCodeCommit.GetCommentOutputComment();
      //expect(instance).to.be.a(AwsCodeCommit.GetCommentOutputComment);
    });
