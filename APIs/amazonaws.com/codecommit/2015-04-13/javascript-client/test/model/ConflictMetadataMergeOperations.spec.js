...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.ConflictMetadataMergeOperations();
  });
  ...
  describe('ConflictMetadataMergeOperations', function() {
    it('should create an instance of ConflictMetadataMergeOperations', function() {
      // uncomment below and update the code to test ConflictMetadataMergeOperations
      //var instance = new AwsCodeCommit.ConflictMetadataMergeOperations();
      //expect(instance).to.be.a(AwsCodeCommit.ConflictMetadataMergeOperations);
    });
