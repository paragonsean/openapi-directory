...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.PostCommentReplyInput();
  });
  ...
  describe('PostCommentReplyInput', function() {
    it('should create an instance of PostCommentReplyInput', function() {
      // uncomment below and update the code to test PostCommentReplyInput
      //var instance = new AwsCodeCommit.PostCommentReplyInput();
      //expect(instance).to.be.a(AwsCodeCommit.PostCommentReplyInput);
    });
