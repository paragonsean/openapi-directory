...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.RepositoryNameIdPair();
  });
  ...
  describe('RepositoryNameIdPair', function() {
    it('should create an instance of RepositoryNameIdPair', function() {
      // uncomment below and update the code to test RepositoryNameIdPair
      //var instance = new AwsCodeCommit.RepositoryNameIdPair();
      //expect(instance).to.be.a(AwsCodeCommit.RepositoryNameIdPair);
    });
