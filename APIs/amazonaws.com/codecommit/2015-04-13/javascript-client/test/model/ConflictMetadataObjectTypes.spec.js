...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.ConflictMetadataObjectTypes();
  });
  ...
  describe('ConflictMetadataObjectTypes', function() {
    it('should create an instance of ConflictMetadataObjectTypes', function() {
      // uncomment below and update the code to test ConflictMetadataObjectTypes
      //var instance = new AwsCodeCommit.ConflictMetadataObjectTypes();
      //expect(instance).to.be.a(AwsCodeCommit.ConflictMetadataObjectTypes);
    });
