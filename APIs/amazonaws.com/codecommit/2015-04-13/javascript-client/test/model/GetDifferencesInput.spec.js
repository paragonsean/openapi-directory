...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.GetDifferencesInput();
  });
  ...
  describe('GetDifferencesInput', function() {
    it('should create an instance of GetDifferencesInput', function() {
      // uncomment below and update the code to test GetDifferencesInput
      //var instance = new AwsCodeCommit.GetDifferencesInput();
      //expect(instance).to.be.a(AwsCodeCommit.GetDifferencesInput);
    });
    ...
    it('should have the property beforeCommitSpecifier (base name: "beforeCommitSpecifier")', function() {
      // uncomment below and update the code to test the property beforeCommitSpecifier
      //var instance = new AwsCodeCommit.GetDifferencesInput();
      //expect(instance).to.be();
    });

    it('should have the property afterCommitSpecifier (base name: "afterCommitSpecifier")', function() {
      // uncomment below and update the code to test the property afterCommitSpecifier
      //var instance = new AwsCodeCommit.GetDifferencesInput();
      //expect(instance).to.be();
    });

    it('should have the property beforePath (base name: "beforePath")', function() {
      // uncomment below and update the code to test the property beforePath
      //var instance = new AwsCodeCommit.GetDifferencesInput();
      //expect(instance).to.be();
    });

    it('should have the property afterPath (base name: "afterPath")', function() {
      // uncomment below and update the code to test the property afterPath
      //var instance = new AwsCodeCommit.GetDifferencesInput();
      //expect(instance).to.be();
    });
