...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.PullRequestMergedStateChangedEventMetadata();
  });
  ...
  describe('PullRequestMergedStateChangedEventMetadata', function() {
    it('should create an instance of PullRequestMergedStateChangedEventMetadata', function() {
      // uncomment below and update the code to test PullRequestMergedStateChangedEventMetadata
      //var instance = new AwsCodeCommit.PullRequestMergedStateChangedEventMetadata();
      //expect(instance).to.be.a(AwsCodeCommit.PullRequestMergedStateChangedEventMetadata);
    });
