...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.GetCommitInput();
  });
  ...
  describe('GetCommitInput', function() {
    it('should create an instance of GetCommitInput', function() {
      // uncomment below and update the code to test GetCommitInput
      //var instance = new AwsCodeCommit.GetCommitInput();
      //expect(instance).to.be.a(AwsCodeCommit.GetCommitInput);
    });
