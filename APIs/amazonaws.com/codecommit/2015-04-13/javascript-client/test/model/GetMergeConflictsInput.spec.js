...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.GetMergeConflictsInput();
  });
  ...
  describe('GetMergeConflictsInput', function() {
    it('should create an instance of GetMergeConflictsInput', function() {
      // uncomment below and update the code to test GetMergeConflictsInput
      //var instance = new AwsCodeCommit.GetMergeConflictsInput();
      //expect(instance).to.be.a(AwsCodeCommit.GetMergeConflictsInput);
    });
