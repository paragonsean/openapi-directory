...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.GetPullRequestOutputPullRequest();
  });
  ...
  describe('GetPullRequestOutputPullRequest', function() {
    it('should create an instance of GetPullRequestOutputPullRequest', function() {
      // uncomment below and update the code to test GetPullRequestOutputPullRequest
      //var instance = new AwsCodeCommit.GetPullRequestOutputPullRequest();
      //expect(instance).to.be.a(AwsCodeCommit.GetPullRequestOutputPullRequest);
    });
