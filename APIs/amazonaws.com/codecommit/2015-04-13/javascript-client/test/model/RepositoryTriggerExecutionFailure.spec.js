...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.RepositoryTriggerExecutionFailure();
  });
  ...
  describe('RepositoryTriggerExecutionFailure', function() {
    it('should create an instance of RepositoryTriggerExecutionFailure', function() {
      // uncomment below and update the code to test RepositoryTriggerExecutionFailure
      //var instance = new AwsCodeCommit.RepositoryTriggerExecutionFailure();
      //expect(instance).to.be.a(AwsCodeCommit.RepositoryTriggerExecutionFailure);
    });
