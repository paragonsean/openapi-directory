...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.MergeHunkDestination();
  });
  ...
  describe('MergeHunkDestination', function() {
    it('should create an instance of MergeHunkDestination', function() {
      // uncomment below and update the code to test MergeHunkDestination
      //var instance = new AwsCodeCommit.MergeHunkDestination();
      //expect(instance).to.be.a(AwsCodeCommit.MergeHunkDestination);
    });
    ...
    it('should have the property hunkContent (base name: "hunkContent")', function() {
      // uncomment below and update the code to test the property hunkContent
      //var instance = new AwsCodeCommit.MergeHunkDestination();
      //expect(instance).to.be();
    });
