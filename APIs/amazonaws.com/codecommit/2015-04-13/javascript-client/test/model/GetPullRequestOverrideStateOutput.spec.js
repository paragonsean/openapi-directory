...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.GetPullRequestOverrideStateOutput();
  });
  ...
  describe('GetPullRequestOverrideStateOutput', function() {
    it('should create an instance of GetPullRequestOverrideStateOutput', function() {
      // uncomment below and update the code to test GetPullRequestOverrideStateOutput
      //var instance = new AwsCodeCommit.GetPullRequestOverrideStateOutput();
      //expect(instance).to.be.a(AwsCodeCommit.GetPullRequestOverrideStateOutput);
    });
    ...
    it('should have the property overrider (base name: "overrider")', function() {
      // uncomment below and update the code to test the property overrider
      //var instance = new AwsCodeCommit.GetPullRequestOverrideStateOutput();
      //expect(instance).to.be();
    });
