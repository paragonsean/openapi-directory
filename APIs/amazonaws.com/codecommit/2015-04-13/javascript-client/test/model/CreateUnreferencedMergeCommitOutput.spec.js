...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.CreateUnreferencedMergeCommitOutput();
  });
  ...
  describe('CreateUnreferencedMergeCommitOutput', function() {
    it('should create an instance of CreateUnreferencedMergeCommitOutput', function() {
      // uncomment below and update the code to test CreateUnreferencedMergeCommitOutput
      //var instance = new AwsCodeCommit.CreateUnreferencedMergeCommitOutput();
      //expect(instance).to.be.a(AwsCodeCommit.CreateUnreferencedMergeCommitOutput);
    });
