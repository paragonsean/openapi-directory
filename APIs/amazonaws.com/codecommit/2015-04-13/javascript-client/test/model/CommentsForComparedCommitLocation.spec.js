...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.CommentsForComparedCommitLocation();
  });
  ...
  describe('CommentsForComparedCommitLocation', function() {
    it('should create an instance of CommentsForComparedCommitLocation', function() {
      // uncomment below and update the code to test CommentsForComparedCommitLocation
      //var instance = new AwsCodeCommit.CommentsForComparedCommitLocation();
      //expect(instance).to.be.a(AwsCodeCommit.CommentsForComparedCommitLocation);
    });
