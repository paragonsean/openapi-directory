...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.UpdateCommentOutputComment();
  });
  ...
  describe('UpdateCommentOutputComment', function() {
    it('should create an instance of UpdateCommentOutputComment', function() {
      // uncomment below and update the code to test UpdateCommentOutputComment
      //var instance = new AwsCodeCommit.UpdateCommentOutputComment();
      //expect(instance).to.be.a(AwsCodeCommit.UpdateCommentOutputComment);
    });
