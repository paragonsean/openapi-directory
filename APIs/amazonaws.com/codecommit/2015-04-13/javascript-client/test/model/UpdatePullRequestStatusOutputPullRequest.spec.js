...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.UpdatePullRequestStatusOutputPullRequest();
  });
  ...
  describe('UpdatePullRequestStatusOutputPullRequest', function() {
    it('should create an instance of UpdatePullRequestStatusOutputPullRequest', function() {
      // uncomment below and update the code to test UpdatePullRequestStatusOutputPullRequest
      //var instance = new AwsCodeCommit.UpdatePullRequestStatusOutputPullRequest();
      //expect(instance).to.be.a(AwsCodeCommit.UpdatePullRequestStatusOutputPullRequest);
    });
