...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.MergeOperations();
  });
  ...
  describe('MergeOperations', function() {
    it('should create an instance of MergeOperations', function() {
      // uncomment below and update the code to test MergeOperations
      //var instance = new AwsCodeCommit.MergeOperations();
      //expect(instance).to.be.a(AwsCodeCommit.MergeOperations);
    });
