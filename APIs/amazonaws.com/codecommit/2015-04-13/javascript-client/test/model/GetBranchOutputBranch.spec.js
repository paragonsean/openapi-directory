...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.GetBranchOutputBranch();
  });
  ...
  describe('GetBranchOutputBranch', function() {
    it('should create an instance of GetBranchOutputBranch', function() {
      // uncomment below and update the code to test GetBranchOutputBranch
      //var instance = new AwsCodeCommit.GetBranchOutputBranch();
      //expect(instance).to.be.a(AwsCodeCommit.GetBranchOutputBranch);
    });
