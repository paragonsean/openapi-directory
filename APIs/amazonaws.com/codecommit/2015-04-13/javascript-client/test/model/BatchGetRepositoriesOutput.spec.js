...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.BatchGetRepositoriesOutput();
  });
  ...
  describe('BatchGetRepositoriesOutput', function() {
    it('should create an instance of BatchGetRepositoriesOutput', function() {
      // uncomment below and update the code to test BatchGetRepositoriesOutput
      //var instance = new AwsCodeCommit.BatchGetRepositoriesOutput();
      //expect(instance).to.be.a(AwsCodeCommit.BatchGetRepositoriesOutput);
    });
    ...
    it('should have the property repositoriesNotFound (base name: "repositoriesNotFound")', function() {
      // uncomment below and update the code to test the property repositoriesNotFound
      //var instance = new AwsCodeCommit.BatchGetRepositoriesOutput();
      //expect(instance).to.be();
    });
