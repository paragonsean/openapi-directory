...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.GetCommitOutputCommit();
  });
  ...
  describe('GetCommitOutputCommit', function() {
    it('should create an instance of GetCommitOutputCommit', function() {
      // uncomment below and update the code to test GetCommitOutputCommit
      //var instance = new AwsCodeCommit.GetCommitOutputCommit();
      //expect(instance).to.be.a(AwsCodeCommit.GetCommitOutputCommit);
    });
