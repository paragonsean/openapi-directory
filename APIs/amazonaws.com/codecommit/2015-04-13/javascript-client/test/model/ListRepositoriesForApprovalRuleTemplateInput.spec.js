...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.ListRepositoriesForApprovalRuleTemplateInput();
  });
  ...
  describe('ListRepositoriesForApprovalRuleTemplateInput', function() {
    it('should create an instance of ListRepositoriesForApprovalRuleTemplateInput', function() {
      // uncomment below and update the code to test ListRepositoriesForApprovalRuleTemplateInput
      //var instance = new AwsCodeCommit.ListRepositoriesForApprovalRuleTemplateInput();
      //expect(instance).to.be.a(AwsCodeCommit.ListRepositoriesForApprovalRuleTemplateInput);
    });
