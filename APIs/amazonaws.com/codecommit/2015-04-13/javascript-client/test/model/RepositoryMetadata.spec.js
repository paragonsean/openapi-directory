...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.RepositoryMetadata();
  });
  ...
  describe('RepositoryMetadata', function() {
    it('should create an instance of RepositoryMetadata', function() {
      // uncomment below and update the code to test RepositoryMetadata
      //var instance = new AwsCodeCommit.RepositoryMetadata();
      //expect(instance).to.be.a(AwsCodeCommit.RepositoryMetadata);
    });
    ...
    it('should have the property repositoryDescription (base name: "repositoryDescription")', function() {
      // uncomment below and update the code to test the property repositoryDescription
      //var instance = new AwsCodeCommit.RepositoryMetadata();
      //expect(instance).to.be();
    });
    ...
    it('should have the property cloneUrlHttp (base name: "cloneUrlHttp")', function() {
      // uncomment below and update the code to test the property cloneUrlHttp
      //var instance = new AwsCodeCommit.RepositoryMetadata();
      //expect(instance).to.be();
    });

    it('should have the property cloneUrlSsh (base name: "cloneUrlSsh")', function() {
      // uncomment below and update the code to test the property cloneUrlSsh
      //var instance = new AwsCodeCommit.RepositoryMetadata();
      //expect(instance).to.be();
    });
