...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.ConflictMetadataFileModes();
  });
  ...
  describe('ConflictMetadataFileModes', function() {
    it('should create an instance of ConflictMetadataFileModes', function() {
      // uncomment below and update the code to test ConflictMetadataFileModes
      //var instance = new AwsCodeCommit.ConflictMetadataFileModes();
      //expect(instance).to.be.a(AwsCodeCommit.ConflictMetadataFileModes);
    });
