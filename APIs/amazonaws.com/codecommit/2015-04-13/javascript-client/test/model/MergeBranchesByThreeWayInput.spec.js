...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.MergeBranchesByThreeWayInput();
  });
  ...
  describe('MergeBranchesByThreeWayInput', function() {
    it('should create an instance of MergeBranchesByThreeWayInput', function() {
      // uncomment below and update the code to test MergeBranchesByThreeWayInput
      //var instance = new AwsCodeCommit.MergeBranchesByThreeWayInput();
      //expect(instance).to.be.a(AwsCodeCommit.MergeBranchesByThreeWayInput);
    });
