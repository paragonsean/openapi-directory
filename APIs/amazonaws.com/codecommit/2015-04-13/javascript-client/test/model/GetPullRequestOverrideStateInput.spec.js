...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.GetPullRequestOverrideStateInput();
  });
  ...
  describe('GetPullRequestOverrideStateInput', function() {
    it('should create an instance of GetPullRequestOverrideStateInput', function() {
      // uncomment below and update the code to test GetPullRequestOverrideStateInput
      //var instance = new AwsCodeCommit.GetPullRequestOverrideStateInput();
      //expect(instance).to.be.a(AwsCodeCommit.GetPullRequestOverrideStateInput);
    });
