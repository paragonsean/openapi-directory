...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.MergeBranchesByFastForwardOutput();
  });
  ...
  describe('MergeBranchesByFastForwardOutput', function() {
    it('should create an instance of MergeBranchesByFastForwardOutput', function() {
      // uncomment below and update the code to test MergeBranchesByFastForwardOutput
      //var instance = new AwsCodeCommit.MergeBranchesByFastForwardOutput();
      //expect(instance).to.be.a(AwsCodeCommit.MergeBranchesByFastForwardOutput);
    });
