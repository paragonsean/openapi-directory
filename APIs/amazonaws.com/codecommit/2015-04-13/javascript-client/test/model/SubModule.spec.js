...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.SubModule();
  });
  ...
  describe('SubModule', function() {
    it('should create an instance of SubModule', function() {
      // uncomment below and update the code to test SubModule
      //var instance = new AwsCodeCommit.SubModule();
      //expect(instance).to.be.a(AwsCodeCommit.SubModule);
    });
