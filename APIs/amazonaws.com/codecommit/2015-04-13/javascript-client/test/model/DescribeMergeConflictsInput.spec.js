...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.DescribeMergeConflictsInput();
  });
  ...
  describe('DescribeMergeConflictsInput', function() {
    it('should create an instance of DescribeMergeConflictsInput', function() {
      // uncomment below and update the code to test DescribeMergeConflictsInput
      //var instance = new AwsCodeCommit.DescribeMergeConflictsInput();
      //expect(instance).to.be.a(AwsCodeCommit.DescribeMergeConflictsInput);
    });
