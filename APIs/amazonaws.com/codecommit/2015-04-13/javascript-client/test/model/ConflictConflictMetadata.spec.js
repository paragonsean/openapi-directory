...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.ConflictConflictMetadata();
  });
  ...
  describe('ConflictConflictMetadata', function() {
    it('should create an instance of ConflictConflictMetadata', function() {
      // uncomment below and update the code to test ConflictConflictMetadata
      //var instance = new AwsCodeCommit.ConflictConflictMetadata();
      //expect(instance).to.be.a(AwsCodeCommit.ConflictConflictMetadata);
    });
