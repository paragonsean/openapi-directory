...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate();
  });
  ...
  describe('UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate', function() {
    it('should create an instance of UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate', function() {
      // uncomment below and update the code to test UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate
      //var instance = new AwsCodeCommit.UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate();
      //expect(instance).to.be.a(AwsCodeCommit.UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate);
    });

    it('should have the property approvalRuleTemplateId (base name: "approvalRuleTemplateId")', function() {
      // uncomment below and update the code to test the property approvalRuleTemplateId
      //var instance = new AwsCodeCommit.UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate();
      //expect(instance).to.be();
    });

    it('should have the property approvalRuleTemplateName (base name: "approvalRuleTemplateName")', function() {
      // uncomment below and update the code to test the property approvalRuleTemplateName
      //var instance = new AwsCodeCommit.UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate();
      //expect(instance).to.be();
    });

    it('should have the property approvalRuleTemplateDescription (base name: "approvalRuleTemplateDescription")', function() {
      // uncomment below and update the code to test the property approvalRuleTemplateDescription
      //var instance = new AwsCodeCommit.UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate();
      //expect(instance).to.be();
    });

    it('should have the property approvalRuleTemplateContent (base name: "approvalRuleTemplateContent")', function() {
      // uncomment below and update the code to test the property approvalRuleTemplateContent
      //var instance = new AwsCodeCommit.UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate();
      //expect(instance).to.be();
    });

    it('should have the property ruleContentSha256 (base name: "ruleContentSha256")', function() {
      // uncomment below and update the code to test the property ruleContentSha256
      //var instance = new AwsCodeCommit.UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate();
      //expect(instance).to.be();
    });
