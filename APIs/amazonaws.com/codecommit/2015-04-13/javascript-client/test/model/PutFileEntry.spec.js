...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.PutFileEntry();
  });
  ...
  describe('PutFileEntry', function() {
    it('should create an instance of PutFileEntry', function() {
      // uncomment below and update the code to test PutFileEntry
      //var instance = new AwsCodeCommit.PutFileEntry();
      //expect(instance).to.be.a(AwsCodeCommit.PutFileEntry);
    });
