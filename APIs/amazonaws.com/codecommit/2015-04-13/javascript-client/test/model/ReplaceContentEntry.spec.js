...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.ReplaceContentEntry();
  });
  ...
  describe('ReplaceContentEntry', function() {
    it('should create an instance of ReplaceContentEntry', function() {
      // uncomment below and update the code to test ReplaceContentEntry
      //var instance = new AwsCodeCommit.ReplaceContentEntry();
      //expect(instance).to.be.a(AwsCodeCommit.ReplaceContentEntry);
    });
