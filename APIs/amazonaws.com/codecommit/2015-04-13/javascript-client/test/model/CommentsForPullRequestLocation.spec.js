...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.CommentsForPullRequestLocation();
  });
  ...
  describe('CommentsForPullRequestLocation', function() {
    it('should create an instance of CommentsForPullRequestLocation', function() {
      // uncomment below and update the code to test CommentsForPullRequestLocation
      //var instance = new AwsCodeCommit.CommentsForPullRequestLocation();
      //expect(instance).to.be.a(AwsCodeCommit.CommentsForPullRequestLocation);
    });
