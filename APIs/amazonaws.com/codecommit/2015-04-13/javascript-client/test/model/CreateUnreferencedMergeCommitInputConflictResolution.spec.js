...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.CreateUnreferencedMergeCommitInputConflictResolution();
  });
  ...
  describe('CreateUnreferencedMergeCommitInputConflictResolution', function() {
    it('should create an instance of CreateUnreferencedMergeCommitInputConflictResolution', function() {
      // uncomment below and update the code to test CreateUnreferencedMergeCommitInputConflictResolution
      //var instance = new AwsCodeCommit.CreateUnreferencedMergeCommitInputConflictResolution();
      //expect(instance).to.be.a(AwsCodeCommit.CreateUnreferencedMergeCommitInputConflictResolution);
    });

    it('should have the property replaceContents (base name: "replaceContents")', function() {
      // uncomment below and update the code to test the property replaceContents
      //var instance = new AwsCodeCommit.CreateUnreferencedMergeCommitInputConflictResolution();
      //expect(instance).to.be();
    });

    it('should have the property deleteFiles (base name: "deleteFiles")', function() {
      // uncomment below and update the code to test the property deleteFiles
      //var instance = new AwsCodeCommit.CreateUnreferencedMergeCommitInputConflictResolution();
      //expect(instance).to.be();
    });

    it('should have the property setFileModes (base name: "setFileModes")', function() {
      // uncomment below and update the code to test the property setFileModes
      //var instance = new AwsCodeCommit.CreateUnreferencedMergeCommitInputConflictResolution();
      //expect(instance).to.be();
    });
