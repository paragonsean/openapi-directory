...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.PostCommentReplyOutputComment();
  });
  ...
  describe('PostCommentReplyOutputComment', function() {
    it('should create an instance of PostCommentReplyOutputComment', function() {
      // uncomment below and update the code to test PostCommentReplyOutputComment
      //var instance = new AwsCodeCommit.PostCommentReplyOutputComment();
      //expect(instance).to.be.a(AwsCodeCommit.PostCommentReplyOutputComment);
    });
    ...
    it('should have the property authorArn (base name: "authorArn")', function() {
      // uncomment below and update the code to test the property authorArn
      //var instance = new AwsCodeCommit.PostCommentReplyOutputComment();
      //expect(instance).to.be();
    });
    ...
    it('should have the property callerReactions (base name: "callerReactions")', function() {
      // uncomment below and update the code to test the property callerReactions
      //var instance = new AwsCodeCommit.PostCommentReplyOutputComment();
      //expect(instance).to.be();
    });

    it('should have the property reactionCounts (base name: "reactionCounts")', function() {
