...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.PostCommentForPullRequestOutput();
  });
  ...
  describe('PostCommentForPullRequestOutput', function() {
    it('should create an instance of PostCommentForPullRequestOutput', function() {
      // uncomment below and update the code to test PostCommentForPullRequestOutput
      //var instance = new AwsCodeCommit.PostCommentForPullRequestOutput();
      //expect(instance).to.be.a(AwsCodeCommit.PostCommentForPullRequestOutput);
    });
