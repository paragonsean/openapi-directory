...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.ListRepositoriesOutput();
  });
  ...
  describe('ListRepositoriesOutput', function() {
    it('should create an instance of ListRepositoriesOutput', function() {
      // uncomment below and update the code to test ListRepositoriesOutput
      //var instance = new AwsCodeCommit.ListRepositoriesOutput();
      //expect(instance).to.be.a(AwsCodeCommit.ListRepositoriesOutput);
    });
