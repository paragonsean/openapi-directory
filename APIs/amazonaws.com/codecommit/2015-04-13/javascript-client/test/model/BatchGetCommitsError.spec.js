...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.BatchGetCommitsError();
  });
  ...
  describe('BatchGetCommitsError', function() {
    it('should create an instance of BatchGetCommitsError', function() {
      // uncomment below and update the code to test BatchGetCommitsError
      //var instance = new AwsCodeCommit.BatchGetCommitsError();
      //expect(instance).to.be.a(AwsCodeCommit.BatchGetCommitsError);
    });
