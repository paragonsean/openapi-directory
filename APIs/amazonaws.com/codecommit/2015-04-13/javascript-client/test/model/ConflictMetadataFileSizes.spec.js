...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.ConflictMetadataFileSizes();
  });
  ...
  describe('ConflictMetadataFileSizes', function() {
    it('should create an instance of ConflictMetadataFileSizes', function() {
      // uncomment below and update the code to test ConflictMetadataFileSizes
      //var instance = new AwsCodeCommit.ConflictMetadataFileSizes();
      //expect(instance).to.be.a(AwsCodeCommit.ConflictMetadataFileSizes);
    });
