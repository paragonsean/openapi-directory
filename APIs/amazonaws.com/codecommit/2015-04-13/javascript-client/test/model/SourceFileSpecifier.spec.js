...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.SourceFileSpecifier();
  });
  ...
  describe('SourceFileSpecifier', function() {
    it('should create an instance of SourceFileSpecifier', function() {
      // uncomment below and update the code to test SourceFileSpecifier
      //var instance = new AwsCodeCommit.SourceFileSpecifier();
      //expect(instance).to.be.a(AwsCodeCommit.SourceFileSpecifier);
    });
