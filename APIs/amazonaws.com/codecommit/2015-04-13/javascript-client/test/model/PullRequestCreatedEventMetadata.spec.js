...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.PullRequestCreatedEventMetadata();
  });
  ...
  describe('PullRequestCreatedEventMetadata', function() {
    it('should create an instance of PullRequestCreatedEventMetadata', function() {
      // uncomment below and update the code to test PullRequestCreatedEventMetadata
      //var instance = new AwsCodeCommit.PullRequestCreatedEventMetadata();
      //expect(instance).to.be.a(AwsCodeCommit.PullRequestCreatedEventMetadata);
    });
