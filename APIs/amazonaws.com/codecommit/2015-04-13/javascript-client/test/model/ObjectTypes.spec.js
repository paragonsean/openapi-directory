...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.ObjectTypes();
  });
  ...
  describe('ObjectTypes', function() {
    it('should create an instance of ObjectTypes', function() {
      // uncomment below and update the code to test ObjectTypes
      //var instance = new AwsCodeCommit.ObjectTypes();
      //expect(instance).to.be.a(AwsCodeCommit.ObjectTypes);
    });
