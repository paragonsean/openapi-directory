...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.CreateCommitOutput();
  });
  ...
  describe('CreateCommitOutput', function() {
    it('should create an instance of CreateCommitOutput', function() {
      // uncomment below and update the code to test CreateCommitOutput
      //var instance = new AwsCodeCommit.CreateCommitOutput();
      //expect(instance).to.be.a(AwsCodeCommit.CreateCommitOutput);
    });
    ...
    it('should have the property filesUpdated (base name: "filesUpdated")', function() {
      // uncomment below and update the code to test the property filesUpdated
      //var instance = new AwsCodeCommit.CreateCommitOutput();
      //expect(instance).to.be();
    });

    it('should have the property filesDeleted (base name: "filesDeleted")', function() {
      // uncomment below and update the code to test the property filesDeleted
      //var instance = new AwsCodeCommit.CreateCommitOutput();
      //expect(instance).to.be();
    });
