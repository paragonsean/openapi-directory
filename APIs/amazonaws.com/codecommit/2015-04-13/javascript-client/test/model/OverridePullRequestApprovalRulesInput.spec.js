...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.OverridePullRequestApprovalRulesInput();
  });
  ...
  describe('OverridePullRequestApprovalRulesInput', function() {
    it('should create an instance of OverridePullRequestApprovalRulesInput', function() {
      // uncomment below and update the code to test OverridePullRequestApprovalRulesInput
      //var instance = new AwsCodeCommit.OverridePullRequestApprovalRulesInput();
      //expect(instance).to.be.a(AwsCodeCommit.OverridePullRequestApprovalRulesInput);
    });
    ...
    it('should have the property overrideStatus (base name: "overrideStatus")', function() {
      // uncomment below and update the code to test the property overrideStatus
      //var instance = new AwsCodeCommit.OverridePullRequestApprovalRulesInput();
      //expect(instance).to.be();
    });
