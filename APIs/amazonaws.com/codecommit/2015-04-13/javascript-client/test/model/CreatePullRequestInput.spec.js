...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.CreatePullRequestInput();
  });
  ...
  describe('CreatePullRequestInput', function() {
    it('should create an instance of CreatePullRequestInput', function() {
      // uncomment below and update the code to test CreatePullRequestInput
      //var instance = new AwsCodeCommit.CreatePullRequestInput();
      //expect(instance).to.be.a(AwsCodeCommit.CreatePullRequestInput);
    });
