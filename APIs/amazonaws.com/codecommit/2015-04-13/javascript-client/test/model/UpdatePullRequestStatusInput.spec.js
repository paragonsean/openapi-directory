...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.UpdatePullRequestStatusInput();
  });
  ...
  describe('UpdatePullRequestStatusInput', function() {
    it('should create an instance of UpdatePullRequestStatusInput', function() {
      // uncomment below and update the code to test UpdatePullRequestStatusInput
      //var instance = new AwsCodeCommit.UpdatePullRequestStatusInput();
      //expect(instance).to.be.a(AwsCodeCommit.UpdatePullRequestStatusInput);
    });
