...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.GetFileInput();
  });
  ...
  describe('GetFileInput', function() {
    it('should create an instance of GetFileInput', function() {
      // uncomment below and update the code to test GetFileInput
      //var instance = new AwsCodeCommit.GetFileInput();
      //expect(instance).to.be.a(AwsCodeCommit.GetFileInput);
    });
    ...
    it('should have the property commitSpecifier (base name: "commitSpecifier")', function() {
      // uncomment below and update the code to test the property commitSpecifier
      //var instance = new AwsCodeCommit.GetFileInput();
      //expect(instance).to.be();
    });
