...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.CreateUnreferencedMergeCommitInput();
  });
  ...
  describe('CreateUnreferencedMergeCommitInput', function() {
    it('should create an instance of CreateUnreferencedMergeCommitInput', function() {
      // uncomment below and update the code to test CreateUnreferencedMergeCommitInput
      //var instance = new AwsCodeCommit.CreateUnreferencedMergeCommitInput();
      //expect(instance).to.be.a(AwsCodeCommit.CreateUnreferencedMergeCommitInput);
    });
    ...
    it('should have the property sourceCommitSpecifier (base name: "sourceCommitSpecifier")', function() {
      // uncomment below and update the code to test the property sourceCommitSpecifier
      //var instance = new AwsCodeCommit.CreateUnreferencedMergeCommitInput();
      //expect(instance).to.be();
    });

    it('should have the property destinationCommitSpecifier (base name: "destinationCommitSpecifier")', function() {
      // uncomment below and update the code to test the property destinationCommitSpecifier
      //var instance = new AwsCodeCommit.CreateUnreferencedMergeCommitInput();
      //expect(instance).to.be();
    });

    it('should have the property mergeOption (base name: "mergeOption")', function() {
      // uncomment below and update the code to test the property mergeOption
      //var instance = new AwsCodeCommit.CreateUnreferencedMergeCommitInput();
      //expect(instance).to.be();
    });

    it('should have the property conflictDetailLevel (base name: "conflictDetailLevel")', function() {
      // uncomment below and update the code to test the property conflictDetailLevel
      //var instance = new AwsCodeCommit.CreateUnreferencedMergeCommitInput();
      //expect(instance).to.be();
    });

    it('should have the property conflictResolutionStrategy (base name: "conflictResolutionStrategy")', function() {
      // uncomment below and update the code to test the property conflictResolutionStrategy
      //var instance = new AwsCodeCommit.CreateUnreferencedMergeCommitInput();
      //expect(instance).to.be();
    });
    ...
    it('should have the property keepEmptyFolders (base name: "keepEmptyFolders")', function() {
      // uncomment below and update the code to test the property keepEmptyFolders
      //var instance = new AwsCodeCommit.CreateUnreferencedMergeCommitInput();
      //expect(instance).to.be();
    });
