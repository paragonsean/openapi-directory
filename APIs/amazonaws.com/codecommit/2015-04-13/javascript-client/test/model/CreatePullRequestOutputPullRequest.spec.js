...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.CreatePullRequestOutputPullRequest();
  });
  ...
  describe('CreatePullRequestOutputPullRequest', function() {
    it('should create an instance of CreatePullRequestOutputPullRequest', function() {
      // uncomment below and update the code to test CreatePullRequestOutputPullRequest
      //var instance = new AwsCodeCommit.CreatePullRequestOutputPullRequest();
      //expect(instance).to.be.a(AwsCodeCommit.CreatePullRequestOutputPullRequest);
    });
