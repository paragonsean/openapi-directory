...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.MergeBranchesBySquashInput();
  });
  ...
  describe('MergeBranchesBySquashInput', function() {
    it('should create an instance of MergeBranchesBySquashInput', function() {
      // uncomment below and update the code to test MergeBranchesBySquashInput
      //var instance = new AwsCodeCommit.MergeBranchesBySquashInput();
      //expect(instance).to.be.a(AwsCodeCommit.MergeBranchesBySquashInput);
    });
