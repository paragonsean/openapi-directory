...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.MergeBranchesByThreeWayOutput();
  });
  ...
  describe('MergeBranchesByThreeWayOutput', function() {
    it('should create an instance of MergeBranchesByThreeWayOutput', function() {
      // uncomment below and update the code to test MergeBranchesByThreeWayOutput
      //var instance = new AwsCodeCommit.MergeBranchesByThreeWayOutput();
      //expect(instance).to.be.a(AwsCodeCommit.MergeBranchesByThreeWayOutput);
    });
