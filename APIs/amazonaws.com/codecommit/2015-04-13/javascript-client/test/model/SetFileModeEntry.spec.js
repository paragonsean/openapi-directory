...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.SetFileModeEntry();
  });
  ...
  describe('SetFileModeEntry', function() {
    it('should create an instance of SetFileModeEntry', function() {
      // uncomment below and update the code to test SetFileModeEntry
      //var instance = new AwsCodeCommit.SetFileModeEntry();
      //expect(instance).to.be.a(AwsCodeCommit.SetFileModeEntry);
    });
