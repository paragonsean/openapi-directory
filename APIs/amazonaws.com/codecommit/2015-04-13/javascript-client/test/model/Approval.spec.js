...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.Approval();
  });
  ...
  describe('Approval', function() {
    it('should create an instance of Approval', function() {
      // uncomment below and update the code to test Approval
      //var instance = new AwsCodeCommit.Approval();
      //expect(instance).to.be.a(AwsCodeCommit.Approval);
    });

    it('should have the property userArn (base name: "userArn")', function() {
      // uncomment below and update the code to test the property userArn
      //var instance = new AwsCodeCommit.Approval();
