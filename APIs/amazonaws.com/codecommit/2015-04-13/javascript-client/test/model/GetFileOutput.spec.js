...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.GetFileOutput();
  });
  ...
  describe('GetFileOutput', function() {
    it('should create an instance of GetFileOutput', function() {
      // uncomment below and update the code to test GetFileOutput
      //var instance = new AwsCodeCommit.GetFileOutput();
      //expect(instance).to.be.a(AwsCodeCommit.GetFileOutput);
    });
