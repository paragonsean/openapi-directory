...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.ListBranchesInput();
  });
  ...
  describe('ListBranchesInput', function() {
    it('should create an instance of ListBranchesInput', function() {
      // uncomment below and update the code to test ListBranchesInput
      //var instance = new AwsCodeCommit.ListBranchesInput();
      //expect(instance).to.be.a(AwsCodeCommit.ListBranchesInput);
    });
