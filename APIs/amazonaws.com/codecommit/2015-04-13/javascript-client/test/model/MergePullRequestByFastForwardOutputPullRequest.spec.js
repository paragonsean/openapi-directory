...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.MergePullRequestByFastForwardOutputPullRequest();
  });
  ...
  describe('MergePullRequestByFastForwardOutputPullRequest', function() {
    it('should create an instance of MergePullRequestByFastForwardOutputPullRequest', function() {
      // uncomment below and update the code to test MergePullRequestByFastForwardOutputPullRequest
      //var instance = new AwsCodeCommit.MergePullRequestByFastForwardOutputPullRequest();
      //expect(instance).to.be.a(AwsCodeCommit.MergePullRequestByFastForwardOutputPullRequest);
    });
    ...
    it('should have the property pullRequestStatus (base name: "pullRequestStatus")', function() {
      // uncomment below and update the code to test the property pullRequestStatus
      //var instance = new AwsCodeCommit.MergePullRequestByFastForwardOutputPullRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property pullRequestTargets (base name: "pullRequestTargets")', function() {
      // uncomment below and update the code to test the property pullRequestTargets
      //var instance = new AwsCodeCommit.MergePullRequestByFastForwardOutputPullRequest();
      //expect(instance).to.be();
    });
