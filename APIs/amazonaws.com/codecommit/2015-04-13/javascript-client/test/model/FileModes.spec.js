...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.FileModes();
  });
  ...
  describe('FileModes', function() {
    it('should create an instance of FileModes', function() {
      // uncomment below and update the code to test FileModes
      //var instance = new AwsCodeCommit.FileModes();
      //expect(instance).to.be.a(AwsCodeCommit.FileModes);
    });
