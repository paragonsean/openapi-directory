...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.MergePullRequestBySquashInput();
  });
  ...
  describe('MergePullRequestBySquashInput', function() {
    it('should create an instance of MergePullRequestBySquashInput', function() {
      // uncomment below and update the code to test MergePullRequestBySquashInput
      //var instance = new AwsCodeCommit.MergePullRequestBySquashInput();
      //expect(instance).to.be.a(AwsCodeCommit.MergePullRequestBySquashInput);
    });
