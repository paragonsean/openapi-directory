...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.GetFolderOutput();
  });
  ...
  describe('GetFolderOutput', function() {
    it('should create an instance of GetFolderOutput', function() {
      ...
      //var instance = new AwsCodeCommit.GetFolderOutput();
      //expect(instance).to.be.a(AwsCodeCommit.GetFolderOutput);
    });
    ...
    it('should have the property symbolicLinks (base name: "symbolicLinks")', function() {
      // uncomment below and update the code to test the property symbolicLinks
      //var instance = new AwsCodeCommit.GetFolderOutput();
      //expect(instance).to.be();
    });

    it('should have the property subModules (base name: "subModules")', function() {
      // uncomment below and update the code to test the property subModules
      //var instance = new AwsCodeCommit.GetFolderOutput();
      //expect(instance).to.be();
    });
