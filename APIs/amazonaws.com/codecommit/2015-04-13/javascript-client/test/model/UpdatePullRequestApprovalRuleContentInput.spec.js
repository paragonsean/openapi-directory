...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.UpdatePullRequestApprovalRuleContentInput();
  });
  ...
  describe('UpdatePullRequestApprovalRuleContentInput', function() {
    it('should create an instance of UpdatePullRequestApprovalRuleContentInput', function() {
      // uncomment below and update the code to test UpdatePullRequestApprovalRuleContentInput
      //var instance = new AwsCodeCommit.UpdatePullRequestApprovalRuleContentInput();
      //expect(instance).to.be.a(AwsCodeCommit.UpdatePullRequestApprovalRuleContentInput);
    });
    ...
    it('should have the property existingRuleContentSha256 (base name: "existingRuleContentSha256")', function() {
      // uncomment below and update the code to test the property existingRuleContentSha256
      //var instance = new AwsCodeCommit.UpdatePullRequestApprovalRuleContentInput();
      //expect(instance).to.be();
    });

    it('should have the property newRuleContent (base name: "newRuleContent")', function() {
      // uncomment below and update the code to test the property newRuleContent
      //var instance = new AwsCodeCommit.UpdatePullRequestApprovalRuleContentInput();
      //expect(instance).to.be();
    });
