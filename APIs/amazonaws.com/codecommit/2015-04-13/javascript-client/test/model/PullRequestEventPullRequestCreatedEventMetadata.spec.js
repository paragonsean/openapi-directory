...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.PullRequestEventPullRequestCreatedEventMetadata();
  });
  ...
  describe('PullRequestEventPullRequestCreatedEventMetadata', function() {
    it('should create an instance of PullRequestEventPullRequestCreatedEventMetadata', function() {
      // uncomment below and update the code to test PullRequestEventPullRequestCreatedEventMetadata
      //var instance = new AwsCodeCommit.PullRequestEventPullRequestCreatedEventMetadata();
      //expect(instance).to.be.a(AwsCodeCommit.PullRequestEventPullRequestCreatedEventMetadata);
    });
