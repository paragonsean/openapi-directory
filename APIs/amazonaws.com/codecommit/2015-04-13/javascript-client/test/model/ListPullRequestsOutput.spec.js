...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.ListPullRequestsOutput();
  });
  ...
  describe('ListPullRequestsOutput', function() {
    it('should create an instance of ListPullRequestsOutput', function() {
      // uncomment below and update the code to test ListPullRequestsOutput
      //var instance = new AwsCodeCommit.ListPullRequestsOutput();
      //expect(instance).to.be.a(AwsCodeCommit.ListPullRequestsOutput);
    });

    it('should have the property pullRequestIds (base name: "pullRequestIds")', function() {
      // uncomment below and update the code to test the property pullRequestIds
      //var instance = new AwsCodeCommit.ListPullRequestsOutput();
