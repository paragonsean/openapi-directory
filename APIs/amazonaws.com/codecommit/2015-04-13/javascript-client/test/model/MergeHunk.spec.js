...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.MergeHunk();
  });
  ...
  describe('MergeHunk', function() {
    it('should create an instance of MergeHunk', function() {
      // uncomment below and update the code to test MergeHunk
      //var instance = new AwsCodeCommit.MergeHunk();
      //expect(instance).to.be.a(AwsCodeCommit.MergeHunk);
    });

    it('should have the property isConflict (base name: "isConflict")', function() {
      // uncomment below and update the code to test the property isConflict
      //var instance = new AwsCodeCommit.MergeHunk();
