...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.GetCommentReactionsOutput();
  });
  ...
  describe('GetCommentReactionsOutput', function() {
    it('should create an instance of GetCommentReactionsOutput', function() {
      // uncomment below and update the code to test GetCommentReactionsOutput
      //var instance = new AwsCodeCommit.GetCommentReactionsOutput();
      //expect(instance).to.be.a(AwsCodeCommit.GetCommentReactionsOutput);
    });

    it('should have the property reactionsForComment (base name: "reactionsForComment")', function() {
      // uncomment below and update the code to test the property reactionsForComment
      //var instance = new AwsCodeCommit.GetCommentReactionsOutput();
