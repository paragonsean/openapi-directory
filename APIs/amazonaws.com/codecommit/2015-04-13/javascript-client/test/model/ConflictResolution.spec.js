...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.ConflictResolution();
  });
  ...
  describe('ConflictResolution', function() {
    it('should create an instance of ConflictResolution', function() {
      // uncomment below and update the code to test ConflictResolution
      //var instance = new AwsCodeCommit.ConflictResolution();
      //expect(instance).to.be.a(AwsCodeCommit.ConflictResolution);
    });
