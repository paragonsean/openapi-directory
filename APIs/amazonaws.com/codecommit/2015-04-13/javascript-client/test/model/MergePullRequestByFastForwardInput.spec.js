...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.MergePullRequestByFastForwardInput();
  });
  ...
  describe('MergePullRequestByFastForwardInput', function() {
    it('should create an instance of MergePullRequestByFastForwardInput', function() {
      // uncomment below and update the code to test MergePullRequestByFastForwardInput
      //var instance = new AwsCodeCommit.MergePullRequestByFastForwardInput();
      //expect(instance).to.be.a(AwsCodeCommit.MergePullRequestByFastForwardInput);
    });
