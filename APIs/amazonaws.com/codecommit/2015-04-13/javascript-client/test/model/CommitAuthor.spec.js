...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.CommitAuthor();
  });
  ...
  describe('CommitAuthor', function() {
    it('should create an instance of CommitAuthor', function() {
      // uncomment below and update the code to test CommitAuthor
      //var instance = new AwsCodeCommit.CommitAuthor();
      //expect(instance).to.be.a(AwsCodeCommit.CommitAuthor);
    });
