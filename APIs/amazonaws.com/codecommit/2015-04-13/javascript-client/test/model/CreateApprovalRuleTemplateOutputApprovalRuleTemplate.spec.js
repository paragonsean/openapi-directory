...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.CreateApprovalRuleTemplateOutputApprovalRuleTemplate();
  });
  ...
  describe('CreateApprovalRuleTemplateOutputApprovalRuleTemplate', function() {
    it('should create an instance of CreateApprovalRuleTemplateOutputApprovalRuleTemplate', function() {
      // uncomment below and update the code to test CreateApprovalRuleTemplateOutputApprovalRuleTemplate
      //var instance = new AwsCodeCommit.CreateApprovalRuleTemplateOutputApprovalRuleTemplate();
      //expect(instance).to.be.a(AwsCodeCommit.CreateApprovalRuleTemplateOutputApprovalRuleTemplate);
    });
