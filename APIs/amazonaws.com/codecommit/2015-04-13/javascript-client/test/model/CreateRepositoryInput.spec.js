...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.CreateRepositoryInput();
  });
  ...
  describe('CreateRepositoryInput', function() {
    it('should create an instance of CreateRepositoryInput', function() {
      // uncomment below and update the code to test CreateRepositoryInput
      //var instance = new AwsCodeCommit.CreateRepositoryInput();
      //expect(instance).to.be.a(AwsCodeCommit.CreateRepositoryInput);
    });
