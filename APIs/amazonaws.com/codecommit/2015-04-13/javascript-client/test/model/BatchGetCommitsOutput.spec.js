...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.BatchGetCommitsOutput();
  });
  ...
  describe('BatchGetCommitsOutput', function() {
    it('should create an instance of BatchGetCommitsOutput', function() {
      // uncomment below and update the code to test BatchGetCommitsOutput
      //var instance = new AwsCodeCommit.BatchGetCommitsOutput();
      //expect(instance).to.be.a(AwsCodeCommit.BatchGetCommitsOutput);
    });
