...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.PullRequestEventPullRequestMergedStateChangedEventMetadata();
  });
  ...
  describe('PullRequestEventPullRequestMergedStateChangedEventMetadata', function() {
    it('should create an instance of PullRequestEventPullRequestMergedStateChangedEventMetadata', function() {
      // uncomment below and update the code to test PullRequestEventPullRequestMergedStateChangedEventMetadata
      //var instance = new AwsCodeCommit.PullRequestEventPullRequestMergedStateChangedEventMetadata();
      //expect(instance).to.be.a(AwsCodeCommit.PullRequestEventPullRequestMergedStateChangedEventMetadata);
    });
    ...
    it('should have the property mergeMetadata (base name: "mergeMetadata")', function() {
      // uncomment below and update the code to test the property mergeMetadata
      //var instance = new AwsCodeCommit.PullRequestEventPullRequestMergedStateChangedEventMetadata();
      //expect(instance).to.be();
    });
