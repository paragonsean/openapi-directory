...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.GetMergeConflictsOutput();
  });
  ...
  describe('GetMergeConflictsOutput', function() {
    it('should create an instance of GetMergeConflictsOutput', function() {
      // uncomment below and update the code to test GetMergeConflictsOutput
      //var instance = new AwsCodeCommit.GetMergeConflictsOutput();
      //expect(instance).to.be.a(AwsCodeCommit.GetMergeConflictsOutput);
    });
    ...
    it('should have the property destinationCommitId (base name: "destinationCommitId")', function() {
      // uncomment below and update the code to test the property destinationCommitId
      //var instance = new AwsCodeCommit.GetMergeConflictsOutput();
      //expect(instance).to.be();
    });
    ...
    it('should have the property baseCommitId (base name: "baseCommitId")', function() {
      // uncomment below and update the code to test the property baseCommitId
      //var instance = new AwsCodeCommit.GetMergeConflictsOutput();
      //expect(instance).to.be();
    });

    it('should have the property conflictMetadataList (base name: "conflictMetadataList")', function() {
      // uncomment below and update the code to test the property conflictMetadataList
      //var instance = new AwsCodeCommit.GetMergeConflictsOutput();
      //expect(instance).to.be();
    });
