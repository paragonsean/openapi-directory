...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.ListAssociatedApprovalRuleTemplatesForRepositoryInput();
  });
  ...
  describe('ListAssociatedApprovalRuleTemplatesForRepositoryInput', function() {
    it('should create an instance of ListAssociatedApprovalRuleTemplatesForRepositoryInput', function() {
      // uncomment below and update the code to test ListAssociatedApprovalRuleTemplatesForRepositoryInput
      //var instance = new AwsCodeCommit.ListAssociatedApprovalRuleTemplatesForRepositoryInput();
      //expect(instance).to.be.a(AwsCodeCommit.ListAssociatedApprovalRuleTemplatesForRepositoryInput);
    });
