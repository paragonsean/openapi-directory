...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.MergeBranchesByFastForwardInput();
  });
  ...
  describe('MergeBranchesByFastForwardInput', function() {
    it('should create an instance of MergeBranchesByFastForwardInput', function() {
      // uncomment below and update the code to test MergeBranchesByFastForwardInput
      //var instance = new AwsCodeCommit.MergeBranchesByFastForwardInput();
      //expect(instance).to.be.a(AwsCodeCommit.MergeBranchesByFastForwardInput);
    });
