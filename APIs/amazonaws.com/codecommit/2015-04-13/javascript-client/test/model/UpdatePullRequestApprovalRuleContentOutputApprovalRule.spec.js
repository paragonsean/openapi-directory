...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.UpdatePullRequestApprovalRuleContentOutputApprovalRule();
  });
  ...
  describe('UpdatePullRequestApprovalRuleContentOutputApprovalRule', function() {
    it('should create an instance of UpdatePullRequestApprovalRuleContentOutputApprovalRule', function() {
      // uncomment below and update the code to test UpdatePullRequestApprovalRuleContentOutputApprovalRule
      //var instance = new AwsCodeCommit.UpdatePullRequestApprovalRuleContentOutputApprovalRule();
      //expect(instance).to.be.a(AwsCodeCommit.UpdatePullRequestApprovalRuleContentOutputApprovalRule);
    });
    ...
    it('should have the property originApprovalRuleTemplate (base name: "originApprovalRuleTemplate")', function() {
      // uncomment below and update the code to test the property originApprovalRuleTemplate
      //var instance = new AwsCodeCommit.UpdatePullRequestApprovalRuleContentOutputApprovalRule();
      //expect(instance).to.be();
    });
