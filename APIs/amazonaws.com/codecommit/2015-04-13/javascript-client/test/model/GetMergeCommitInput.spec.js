...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.GetMergeCommitInput();
  });
  ...
  describe('GetMergeCommitInput', function() {
    it('should create an instance of GetMergeCommitInput', function() {
      // uncomment below and update the code to test GetMergeCommitInput
      //var instance = new AwsCodeCommit.GetMergeCommitInput();
      //expect(instance).to.be.a(AwsCodeCommit.GetMergeCommitInput);
    });
