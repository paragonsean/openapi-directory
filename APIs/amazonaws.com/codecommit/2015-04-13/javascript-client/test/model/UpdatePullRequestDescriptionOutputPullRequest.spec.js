...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.UpdatePullRequestDescriptionOutputPullRequest();
  });
  ...
  describe('UpdatePullRequestDescriptionOutputPullRequest', function() {
    it('should create an instance of UpdatePullRequestDescriptionOutputPullRequest', function() {
      // uncomment below and update the code to test UpdatePullRequestDescriptionOutputPullRequest
      //var instance = new AwsCodeCommit.UpdatePullRequestDescriptionOutputPullRequest();
      //expect(instance).to.be.a(AwsCodeCommit.UpdatePullRequestDescriptionOutputPullRequest);
    });
