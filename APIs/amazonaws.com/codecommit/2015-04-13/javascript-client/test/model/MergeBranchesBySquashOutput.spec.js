...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.MergeBranchesBySquashOutput();
  });
  ...
  describe('MergeBranchesBySquashOutput', function() {
    it('should create an instance of MergeBranchesBySquashOutput', function() {
      // uncomment below and update the code to test MergeBranchesBySquashOutput
      //var instance = new AwsCodeCommit.MergeBranchesBySquashOutput();
      //expect(instance).to.be.a(AwsCodeCommit.MergeBranchesBySquashOutput);
    });
