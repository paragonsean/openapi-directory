...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.DeleteCommentContentOutputComment();
  });
  ...
  describe('DeleteCommentContentOutputComment', function() {
    it('should create an instance of DeleteCommentContentOutputComment', function() {
      // uncomment below and update the code to test DeleteCommentContentOutputComment
      //var instance = new AwsCodeCommit.DeleteCommentContentOutputComment();
      //expect(instance).to.be.a(AwsCodeCommit.DeleteCommentContentOutputComment);
    });
