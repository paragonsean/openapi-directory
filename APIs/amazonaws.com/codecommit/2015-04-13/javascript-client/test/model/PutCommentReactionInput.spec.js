...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.PutCommentReactionInput();
  });
  ...
  describe('PutCommentReactionInput', function() {
    it('should create an instance of PutCommentReactionInput', function() {
      // uncomment below and update the code to test PutCommentReactionInput
      //var instance = new AwsCodeCommit.PutCommentReactionInput();
      //expect(instance).to.be.a(AwsCodeCommit.PutCommentReactionInput);
    });
    ...
    it('should have the property reactionValue (base name: "reactionValue")', function() {
      // uncomment below and update the code to test the property reactionValue
      //var instance = new AwsCodeCommit.PutCommentReactionInput();
      //expect(instance).to.be();
    });
