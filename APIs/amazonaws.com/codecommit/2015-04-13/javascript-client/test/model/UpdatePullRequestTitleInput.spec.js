...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.UpdatePullRequestTitleInput();
  });
  ...
  describe('UpdatePullRequestTitleInput', function() {
    it('should create an instance of UpdatePullRequestTitleInput', function() {
      // uncomment below and update the code to test UpdatePullRequestTitleInput
      //var instance = new AwsCodeCommit.UpdatePullRequestTitleInput();
      //expect(instance).to.be.a(AwsCodeCommit.UpdatePullRequestTitleInput);
    });
