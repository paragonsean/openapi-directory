...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.MergeHunkDetail();
  });
  ...
  describe('MergeHunkDetail', function() {
    it('should create an instance of MergeHunkDetail', function() {
      // uncomment below and update the code to test MergeHunkDetail
      //var instance = new AwsCodeCommit.MergeHunkDetail();
      //expect(instance).to.be.a(AwsCodeCommit.MergeHunkDetail);
    });
