...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.GetBlobInput();
  });
  ...
  describe('GetBlobInput', function() {
    it('should create an instance of GetBlobInput', function() {
      // uncomment below and update the code to test GetBlobInput
      //var instance = new AwsCodeCommit.GetBlobInput();
      //expect(instance).to.be.a(AwsCodeCommit.GetBlobInput);
    });
