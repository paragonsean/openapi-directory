...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.GetRepositoryOutputRepositoryMetadata();
  });
  ...
  describe('GetRepositoryOutputRepositoryMetadata', function() {
    it('should create an instance of GetRepositoryOutputRepositoryMetadata', function() {
      // uncomment below and update the code to test GetRepositoryOutputRepositoryMetadata
      //var instance = new AwsCodeCommit.GetRepositoryOutputRepositoryMetadata();
      //expect(instance).to.be.a(AwsCodeCommit.GetRepositoryOutputRepositoryMetadata);
    });
