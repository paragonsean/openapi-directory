...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.DeleteBranchOutputDeletedBranch();
  });
  ...
  describe('DeleteBranchOutputDeletedBranch', function() {
    it('should create an instance of DeleteBranchOutputDeletedBranch', function() {
      // uncomment below and update the code to test DeleteBranchOutputDeletedBranch
      //var instance = new AwsCodeCommit.DeleteBranchOutputDeletedBranch();
      //expect(instance).to.be.a(AwsCodeCommit.DeleteBranchOutputDeletedBranch);
    });
