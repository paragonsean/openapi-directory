...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.DescribeMergeConflictsOutput();
  });
  ...
  describe('DescribeMergeConflictsOutput', function() {
    it('should create an instance of DescribeMergeConflictsOutput', function() {
      // uncomment below and update the code to test DescribeMergeConflictsOutput
      //var instance = new AwsCodeCommit.DescribeMergeConflictsOutput();
      //expect(instance).to.be.a(AwsCodeCommit.DescribeMergeConflictsOutput);
    });

    it('should have the property conflictMetadata (base name: "conflictMetadata")', function() {
      // uncomment below and update the code to test the property conflictMetadata
      //var instance = new AwsCodeCommit.DescribeMergeConflictsOutput();
      //expect(instance).to.be();
    });

    it('should have the property mergeHunks (base name: "mergeHunks")', function() {
      // uncomment below and update the code to test the property mergeHunks
      //var instance = new AwsCodeCommit.DescribeMergeConflictsOutput();
      //expect(instance).to.be();
    });
