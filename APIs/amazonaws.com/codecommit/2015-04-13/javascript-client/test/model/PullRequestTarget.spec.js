...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.PullRequestTarget();
  });
  ...
  describe('PullRequestTarget', function() {
    it('should create an instance of PullRequestTarget', function() {
      // uncomment below and update the code to test PullRequestTarget
      //var instance = new AwsCodeCommit.PullRequestTarget();
      //expect(instance).to.be.a(AwsCodeCommit.PullRequestTarget);
    });
