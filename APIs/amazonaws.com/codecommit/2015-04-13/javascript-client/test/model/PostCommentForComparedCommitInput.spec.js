...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.PostCommentForComparedCommitInput();
  });
  ...
  describe('PostCommentForComparedCommitInput', function() {
    it('should create an instance of PostCommentForComparedCommitInput', function() {
      // uncomment below and update the code to test PostCommentForComparedCommitInput
      //var instance = new AwsCodeCommit.PostCommentForComparedCommitInput();
      //expect(instance).to.be.a(AwsCodeCommit.PostCommentForComparedCommitInput);
    });
