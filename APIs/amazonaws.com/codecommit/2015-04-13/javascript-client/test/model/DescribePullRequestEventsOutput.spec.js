...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.DescribePullRequestEventsOutput();
  });
  ...
  describe('DescribePullRequestEventsOutput', function() {
    it('should create an instance of DescribePullRequestEventsOutput', function() {
      // uncomment below and update the code to test DescribePullRequestEventsOutput
      //var instance = new AwsCodeCommit.DescribePullRequestEventsOutput();
      //expect(instance).to.be.a(AwsCodeCommit.DescribePullRequestEventsOutput);
    });

    it('should have the property pullRequestEvents (base name: "pullRequestEvents")', function() {
      // uncomment below and update the code to test the property pullRequestEvents
      //var instance = new AwsCodeCommit.DescribePullRequestEventsOutput();
