...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.BatchDisassociateApprovalRuleTemplateFromRepositoriesError();
  });
  ...
  describe('BatchDisassociateApprovalRuleTemplateFromRepositoriesError', function() {
    it('should create an instance of BatchDisassociateApprovalRuleTemplateFromRepositoriesError', function() {
      // uncomment below and update the code to test BatchDisassociateApprovalRuleTemplateFromRepositoriesError
      //var instance = new AwsCodeCommit.BatchDisassociateApprovalRuleTemplateFromRepositoriesError();
      //expect(instance).to.be.a(AwsCodeCommit.BatchDisassociateApprovalRuleTemplateFromRepositoriesError);
    });
