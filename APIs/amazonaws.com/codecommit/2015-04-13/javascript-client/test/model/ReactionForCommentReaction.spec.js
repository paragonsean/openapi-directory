...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.ReactionForCommentReaction();
  });
  ...
  describe('ReactionForCommentReaction', function() {
    it('should create an instance of ReactionForCommentReaction', function() {
      // uncomment below and update the code to test ReactionForCommentReaction
      //var instance = new AwsCodeCommit.ReactionForCommentReaction();
      //expect(instance).to.be.a(AwsCodeCommit.ReactionForCommentReaction);
    });
