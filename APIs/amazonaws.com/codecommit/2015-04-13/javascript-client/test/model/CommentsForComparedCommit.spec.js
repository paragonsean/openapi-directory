...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.CommentsForComparedCommit();
  });
  ...
  describe('CommentsForComparedCommit', function() {
    it('should create an instance of CommentsForComparedCommit', function() {
      // uncomment below and update the code to test CommentsForComparedCommit
      //var instance = new AwsCodeCommit.CommentsForComparedCommit();
      //expect(instance).to.be.a(AwsCodeCommit.CommentsForComparedCommit);
    });
    ...
    it('should have the property beforeBlobId (base name: "beforeBlobId")', function() {
      // uncomment below and update the code to test the property beforeBlobId
      //var instance = new AwsCodeCommit.CommentsForComparedCommit();
      //expect(instance).to.be();
    });

    it('should have the property afterBlobId (base name: "afterBlobId")', function() {
      // uncomment below and update the code to test the property afterBlobId
      //var instance = new AwsCodeCommit.CommentsForComparedCommit();
      //expect(instance).to.be();
    });
