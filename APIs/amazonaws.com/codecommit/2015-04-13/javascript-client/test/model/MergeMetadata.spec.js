...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCodeCommit.MergeMetadata();
  });
  ...
  describe('MergeMetadata', function() {
    it('should create an instance of MergeMetadata', function() {
      // uncomment below and update the code to test MergeMetadata
      //var instance = new AwsCodeCommit.MergeMetadata();
      //expect(instance).to.be.a(AwsCodeCommit.MergeMetadata);
    });
