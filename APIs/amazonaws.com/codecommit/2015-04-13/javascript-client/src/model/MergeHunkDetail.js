...
/**
 * The MergeHunkDetail model module.
 * @module model/MergeHunkDetail
 * @version 2015-04-13
 */
class MergeHunkDetail {
    /**
     * Constructs a new <code>MergeHunkDetail</code>.
     * Information about the details of a merge hunk that contains a conflict in a merge or pull request operation.
     * @alias module:model/MergeHunkDetail
     */
    constructor() { 
        
        MergeHunkDetail.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MergeHunkDetail</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MergeHunkDetail} obj Optional instance to populate.
     * @return {module:model/MergeHunkDetail} The populated <code>MergeHunkDetail</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MergeHunkDetail();
            ...
            if (data.hasOwnProperty('hunkContent')) {
                obj['hunkContent'] = ApiClient.convertToType(data['hunkContent'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MergeHunkDetail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MergeHunkDetail</code>.
     */
    static validateJSON(data) {
        ...
        if (data['hunkContent']) { // data not null
          String.validateJSON(data['hunkContent']);
        }
 ...
 */
MergeHunkDetail.prototype['startLine'] = undefined;

/**
 * @member {Number} endLine
 */
MergeHunkDetail.prototype['endLine'] = undefined;

/**
 * @member {String} hunkContent
 */
MergeHunkDetail.prototype['hunkContent'] = undefined;
...
export default MergeHunkDetail;
