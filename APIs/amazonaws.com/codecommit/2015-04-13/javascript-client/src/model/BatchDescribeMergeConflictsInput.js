...
/**
 * The BatchDescribeMergeConflictsInput model module.
 * @module model/BatchDescribeMergeConflictsInput
 * @version 2015-04-13
 */
class BatchDescribeMergeConflictsInput {
    /**
     * Constructs a new <code>BatchDescribeMergeConflictsInput</code>.
     * @alias module:model/BatchDescribeMergeConflictsInput
    ...
    constructor(repositoryName, destinationCommitSpecifier, sourceCommitSpecifier, mergeOption) { 
        ...
        BatchDescribeMergeConflictsInput.initialize(this, repositoryName, destinationCommitSpecifier, sourceCommitSpecifier, mergeOption);
    }
    ...
    /**
     * Constructs a <code>BatchDescribeMergeConflictsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchDescribeMergeConflictsInput} obj Optional instance to populate.
     * @return {module:model/BatchDescribeMergeConflictsInput} The populated <code>BatchDescribeMergeConflictsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchDescribeMergeConflictsInput();
            ...
            if (data.hasOwnProperty('maxMergeHunks')) {
                obj['maxMergeHunks'] = ApiClient.convertToType(data['maxMergeHunks'], 'Number');
            }
            ...
            if (data.hasOwnProperty('filePaths')) {
                obj['filePaths'] = ApiClient.convertToType(data['filePaths'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>BatchDescribeMergeConflictsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchDescribeMergeConflictsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BatchDescribeMergeConflictsInput.RequiredProperties) {
        ...
        if (data['maxMergeHunks']) { // data not null
          Number.validateJSON(data['maxMergeHunks']);
        }
        ...
        if (data['filePaths']) { // data not null
          Array.validateJSON(data['filePaths']);
        }
...
BatchDescribeMergeConflictsInput.RequiredProperties = ["repositoryName", "destinationCommitSpecifier", "sourceCommitSpecifier", "mergeOption"];

/**
 * @member {String} repositoryName
 */
BatchDescribeMergeConflictsInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} destinationCommitSpecifier
 */
BatchDescribeMergeConflictsInput.prototype['destinationCommitSpecifier'] = undefined;

/**
 * @member {String} sourceCommitSpecifier
 */
BatchDescribeMergeConflictsInput.prototype['sourceCommitSpecifier'] = undefined;

/**
 * @member {module:model/MergeOptionTypeEnum} mergeOption
 */
BatchDescribeMergeConflictsInput.prototype['mergeOption'] = undefined;

/**
 * @member {Number} maxMergeHunks
 */
BatchDescribeMergeConflictsInput.prototype['maxMergeHunks'] = undefined;

/**
 * @member {Number} maxConflictFiles
 */
BatchDescribeMergeConflictsInput.prototype['maxConflictFiles'] = undefined;

/**
 * @member {Array} filePaths
 */
BatchDescribeMergeConflictsInput.prototype['filePaths'] = undefined;

/**
 * @member {module:model/ConflictDetailLevelTypeEnum} conflictDetailLevel
 */
BatchDescribeMergeConflictsInput.prototype['conflictDetailLevel'] = undefined;

/**
 * @member {module:model/ConflictResolutionStrategyTypeEnum} conflictResolutionStrategy
 */
BatchDescribeMergeConflictsInput.prototype['conflictResolutionStrategy'] = undefined;

/**
 * @member {String} nextToken
 */
BatchDescribeMergeConflictsInput.prototype['nextToken'] = undefined;
...
export default BatchDescribeMergeConflictsInput;
