...
/**
 * The UpdateCommentOutputComment model module.
 * @module model/UpdateCommentOutputComment
 * @version 2015-04-13
 */
class UpdateCommentOutputComment {
    /**
     * Constructs a new <code>UpdateCommentOutputComment</code>.
     * @alias module:model/UpdateCommentOutputComment
     * @implements module:model/Comment
     */
    constructor() { 
        Comment.initialize(this);
        UpdateCommentOutputComment.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateCommentOutputComment</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateCommentOutputComment} obj Optional instance to populate.
     * @return {module:model/UpdateCommentOutputComment} The populated <code>UpdateCommentOutputComment</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateCommentOutputComment();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateCommentOutputComment</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateCommentOutputComment</code>.
     */
 ...
 */
UpdateCommentOutputComment.prototype['commentId'] = undefined;

/**
 * @member {String} content
 */
UpdateCommentOutputComment.prototype['content'] = undefined;

/**
 * @member {String} inReplyTo
 */
UpdateCommentOutputComment.prototype['inReplyTo'] = undefined;

/**
 * @member {Date} creationDate
 */
UpdateCommentOutputComment.prototype['creationDate'] = undefined;

/**
 * @member {Date} lastModifiedDate
 */
UpdateCommentOutputComment.prototype['lastModifiedDate'] = undefined;

/**
 * @member {String} authorArn
 */
UpdateCommentOutputComment.prototype['authorArn'] = undefined;

/**
 * @member {Boolean} deleted
 */
UpdateCommentOutputComment.prototype['deleted'] = undefined;

/**
 * @member {String} clientRequestToken
 */
UpdateCommentOutputComment.prototype['clientRequestToken'] = undefined;

/**
 * @member {Array} callerReactions
 */
UpdateCommentOutputComment.prototype['callerReactions'] = undefined;

/**
 * @member {Object} reactionCounts
 */
UpdateCommentOutputComment.prototype['reactionCounts'] = undefined;
...
export default UpdateCommentOutputComment;
