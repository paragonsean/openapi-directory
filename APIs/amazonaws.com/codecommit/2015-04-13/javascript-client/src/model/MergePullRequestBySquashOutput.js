...
/**
 * The MergePullRequestBySquashOutput model module.
 * @module model/MergePullRequestBySquashOutput
 * @version 2015-04-13
 */
class MergePullRequestBySquashOutput {
    /**
     * Constructs a new <code>MergePullRequestBySquashOutput</code>.
     * @alias module:model/MergePullRequestBySquashOutput
     */
    constructor() { 
        
        MergePullRequestBySquashOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MergePullRequestBySquashOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MergePullRequestBySquashOutput} obj Optional instance to populate.
     * @return {module:model/MergePullRequestBySquashOutput} The populated <code>MergePullRequestBySquashOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MergePullRequestBySquashOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>MergePullRequestBySquashOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MergePullRequestBySquashOutput</code>.
     */
 ...
 */
MergePullRequestBySquashOutput.prototype['pullRequest'] = undefined;
...
export default MergePullRequestBySquashOutput;
