...
import PullRequestTargetMergeMetadata from './PullRequestTargetMergeMetadata';

/**
 * The PullRequestTarget model module.
 * @module model/PullRequestTarget
 * @version 2015-04-13
 */
class PullRequestTarget {
    /**
     * Constructs a new <code>PullRequestTarget</code>.
     * Returns information about a pull request target.
     * @alias module:model/PullRequestTarget
     */
    constructor() { 
        
        PullRequestTarget.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PullRequestTarget</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PullRequestTarget} obj Optional instance to populate.
     * @return {module:model/PullRequestTarget} The populated <code>PullRequestTarget</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PullRequestTarget();
            ...
            if (data.hasOwnProperty('destinationReference')) {
                obj['destinationReference'] = ApiClient.convertToType(data['destinationReference'], 'String');
            }
            ...
            if (data.hasOwnProperty('mergeMetadata')) {
                obj['mergeMetadata'] = PullRequestTargetMergeMetadata.constructFromObject(data['mergeMetadata']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PullRequestTarget</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PullRequestTarget</code>.
     */
    static validateJSON(data) {
        ...
        // validate the optional field `sourceReference`
        if (data['sourceReference']) { // data not null
          String.validateJSON(data['sourceReference']);
        }
        // validate the optional field `destinationReference`
        if (data['destinationReference']) { // data not null
          String.validateJSON(data['destinationReference']);
        }
        ...
        // validate the optional field `mergeMetadata`
        if (data['mergeMetadata']) { // data not null
          PullRequestTargetMergeMetadata.validateJSON(data['mergeMetadata']);
        }
 ...
 */
PullRequestTarget.prototype['repositoryName'] = undefined;

/**
 * @member {String} sourceReference
 */
PullRequestTarget.prototype['sourceReference'] = undefined;

/**
 * @member {String} destinationReference
 */
PullRequestTarget.prototype['destinationReference'] = undefined;

/**
 * @member {String} destinationCommit
 */
PullRequestTarget.prototype['destinationCommit'] = undefined;

/**
 * @member {String} sourceCommit
 */
PullRequestTarget.prototype['sourceCommit'] = undefined;

/**
 * @member {String} mergeBase
 */
PullRequestTarget.prototype['mergeBase'] = undefined;

/**
 * @member {module:model/PullRequestTargetMergeMetadata} mergeMetadata
 */
PullRequestTarget.prototype['mergeMetadata'] = undefined;
...
export default PullRequestTarget;
