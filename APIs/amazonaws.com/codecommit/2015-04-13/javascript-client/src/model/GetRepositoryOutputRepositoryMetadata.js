...
/**
 * The GetRepositoryOutputRepositoryMetadata model module.
 * @module model/GetRepositoryOutputRepositoryMetadata
 * @version 2015-04-13
 */
class GetRepositoryOutputRepositoryMetadata {
    /**
     * Constructs a new <code>GetRepositoryOutputRepositoryMetadata</code>.
     * @alias module:model/GetRepositoryOutputRepositoryMetadata
     * @implements module:model/RepositoryMetadata
     */
    constructor() { 
        RepositoryMetadata.initialize(this);
        GetRepositoryOutputRepositoryMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetRepositoryOutputRepositoryMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetRepositoryOutputRepositoryMetadata} obj Optional instance to populate.
     * @return {module:model/GetRepositoryOutputRepositoryMetadata} The populated <code>GetRepositoryOutputRepositoryMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetRepositoryOutputRepositoryMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>GetRepositoryOutputRepositoryMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetRepositoryOutputRepositoryMetadata</code>.
     */
 ...
 */
GetRepositoryOutputRepositoryMetadata.prototype['accountId'] = undefined;

/**
 * @member {String} repositoryId
 */
GetRepositoryOutputRepositoryMetadata.prototype['repositoryId'] = undefined;

/**
 * @member {String} repositoryName
 */
GetRepositoryOutputRepositoryMetadata.prototype['repositoryName'] = undefined;

/**
 * @member {String} repositoryDescription
 */
GetRepositoryOutputRepositoryMetadata.prototype['repositoryDescription'] = undefined;

/**
 * @member {String} defaultBranch
 */
GetRepositoryOutputRepositoryMetadata.prototype['defaultBranch'] = undefined;

/**
 * @member {Date} lastModifiedDate
 */
GetRepositoryOutputRepositoryMetadata.prototype['lastModifiedDate'] = undefined;

/**
 * @member {Date} creationDate
 */
GetRepositoryOutputRepositoryMetadata.prototype['creationDate'] = undefined;

/**
 * @member {String} cloneUrlHttp
 */
GetRepositoryOutputRepositoryMetadata.prototype['cloneUrlHttp'] = undefined;

/**
 * @member {String} cloneUrlSsh
 */
GetRepositoryOutputRepositoryMetadata.prototype['cloneUrlSsh'] = undefined;

/**
 * @member {String} Arn
 */
GetRepositoryOutputRepositoryMetadata.prototype['Arn'] = undefined;
...
export default GetRepositoryOutputRepositoryMetadata;
