...
/**
 * The RepositoryMetadata model module.
 * @module model/RepositoryMetadata
 * @version 2015-04-13
 */
class RepositoryMetadata {
    /**
     * Constructs a new <code>RepositoryMetadata</code>.
     * Information about a repository.
     * @alias module:model/RepositoryMetadata
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>RepositoryMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RepositoryMetadata} obj Optional instance to populate.
     * @return {module:model/RepositoryMetadata} The populated <code>RepositoryMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RepositoryMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>RepositoryMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RepositoryMetadata</code>.
     */
