...
/**
 * The PutRepositoryTriggersInput model module.
 * @module model/PutRepositoryTriggersInput
 * @version 2015-04-13
 */
class PutRepositoryTriggersInput {
    /**
     * Constructs a new <code>PutRepositoryTriggersInput</code>.
     * Represents the input of a put repository triggers operation.
     * @alias module:model/PutRepositoryTriggersInput
     * @param repositoryName {String} 
     * @param triggers {Array} 
     */
    constructor(repositoryName, triggers) { 
        
        PutRepositoryTriggersInput.initialize(this, repositoryName, triggers);
    }
    ...
    /**
     * Constructs a <code>PutRepositoryTriggersInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutRepositoryTriggersInput} obj Optional instance to populate.
     * @return {module:model/PutRepositoryTriggersInput} The populated <code>PutRepositoryTriggersInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutRepositoryTriggersInput();
    ...
    /**
     * Validates the JSON data with respect to <code>PutRepositoryTriggersInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutRepositoryTriggersInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutRepositoryTriggersInput.RequiredProperties) {
...
PutRepositoryTriggersInput.RequiredProperties = ["repositoryName", "triggers"];

/**
 * @member {String} repositoryName
 */
PutRepositoryTriggersInput.prototype['repositoryName'] = undefined;

/**
 * @member {Array} triggers
 */
PutRepositoryTriggersInput.prototype['triggers'] = undefined;
...
export default PutRepositoryTriggersInput;
