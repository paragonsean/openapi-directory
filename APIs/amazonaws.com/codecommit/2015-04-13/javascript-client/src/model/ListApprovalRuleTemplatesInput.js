...
/**
 * The ListApprovalRuleTemplatesInput model module.
 * @module model/ListApprovalRuleTemplatesInput
 * @version 2015-04-13
 */
class ListApprovalRuleTemplatesInput {
    /**
     * Constructs a new <code>ListApprovalRuleTemplatesInput</code>.
     * @alias module:model/ListApprovalRuleTemplatesInput
     */
    constructor() { 
        
        ListApprovalRuleTemplatesInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListApprovalRuleTemplatesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListApprovalRuleTemplatesInput} obj Optional instance to populate.
     * @return {module:model/ListApprovalRuleTemplatesInput} The populated <code>ListApprovalRuleTemplatesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListApprovalRuleTemplatesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListApprovalRuleTemplatesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListApprovalRuleTemplatesInput</code>.
     */
 ...
 */
ListApprovalRuleTemplatesInput.prototype['nextToken'] = undefined;

/**
 * @member {Number} maxResults
 */
ListApprovalRuleTemplatesInput.prototype['maxResults'] = undefined;
...
export default ListApprovalRuleTemplatesInput;
