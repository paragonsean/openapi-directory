...
import ConflictConflictMetadata from './ConflictConflictMetadata';
...
class Conflict {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Conflict();

            if (data.hasOwnProperty('conflictMetadata')) {
                obj['conflictMetadata'] = ConflictConflictMetadata.constructFromObject(data['conflictMetadata']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Conflict</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Conflict</code>.
     */
    static validateJSON(data) {
        // validate the optional field `conflictMetadata`
        if (data['conflictMetadata']) { // data not null
          ConflictConflictMetadata.validateJSON(data['conflictMetadata']);
        }
...
/**
 * @member {module:model/ConflictConflictMetadata} conflictMetadata
 */
Conflict.prototype['conflictMetadata'] = undefined;

/**
 * @member {Array} mergeHunks
 */
Conflict.prototype['mergeHunks'] = undefined;
