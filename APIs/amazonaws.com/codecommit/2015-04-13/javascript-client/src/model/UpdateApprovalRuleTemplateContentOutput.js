...
/**
 * The UpdateApprovalRuleTemplateContentOutput model module.
 * @module model/UpdateApprovalRuleTemplateContentOutput
 * @version 2015-04-13
 */
class UpdateApprovalRuleTemplateContentOutput {
    /**
     * Constructs a new <code>UpdateApprovalRuleTemplateContentOutput</code>.
     * @alias module:model/UpdateApprovalRuleTemplateContentOutput
     * @param approvalRuleTemplate {module:model/ApprovalRuleTemplate} 
     */
    constructor(approvalRuleTemplate) { 
        
        UpdateApprovalRuleTemplateContentOutput.initialize(this, approvalRuleTemplate);
    }
    ...
    /**
     * Constructs a <code>UpdateApprovalRuleTemplateContentOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateApprovalRuleTemplateContentOutput} obj Optional instance to populate.
     * @return {module:model/UpdateApprovalRuleTemplateContentOutput} The populated <code>UpdateApprovalRuleTemplateContentOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateApprovalRuleTemplateContentOutput();

            if (data.hasOwnProperty('approvalRuleTemplate')) {
                obj['approvalRuleTemplate'] = ApprovalRuleTemplate.constructFromObject(data['approvalRuleTemplate']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateApprovalRuleTemplateContentOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateApprovalRuleTemplateContentOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateApprovalRuleTemplateContentOutput.RequiredProperties) {
        ...
        if (data['approvalRuleTemplate']) { // data not null
          ApprovalRuleTemplate.validateJSON(data['approvalRuleTemplate']);
        }
...
UpdateApprovalRuleTemplateContentOutput.RequiredProperties = ["approvalRuleTemplate"];

/**
 * @member {module:model/ApprovalRuleTemplate} approvalRuleTemplate
 */
UpdateApprovalRuleTemplateContentOutput.prototype['approvalRuleTemplate'] = undefined;
...
export default UpdateApprovalRuleTemplateContentOutput;
