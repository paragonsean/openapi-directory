...
/**
 * The PullRequestEventPullRequestCreatedEventMetadata model module.
 * @module model/PullRequestEventPullRequestCreatedEventMetadata
 * @version 2015-04-13
 */
class PullRequestEventPullRequestCreatedEventMetadata {
    /**
     * Constructs a new <code>PullRequestEventPullRequestCreatedEventMetadata</code>.
     * @alias module:model/PullRequestEventPullRequestCreatedEventMetadata
     * @implements module:model/PullRequestCreatedEventMetadata
     */
    constructor() { 
        PullRequestCreatedEventMetadata.initialize(this);
        PullRequestEventPullRequestCreatedEventMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PullRequestEventPullRequestCreatedEventMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PullRequestEventPullRequestCreatedEventMetadata} obj Optional instance to populate.
     * @return {module:model/PullRequestEventPullRequestCreatedEventMetadata} The populated <code>PullRequestEventPullRequestCreatedEventMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PullRequestEventPullRequestCreatedEventMetadata();
            PullRequestCreatedEventMetadata.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>PullRequestEventPullRequestCreatedEventMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PullRequestEventPullRequestCreatedEventMetadata</code>.
     */
 ...
 */
PullRequestEventPullRequestCreatedEventMetadata.prototype['repositoryName'] = undefined;

/**
 * @member {String} sourceCommitId
 */
PullRequestEventPullRequestCreatedEventMetadata.prototype['sourceCommitId'] = undefined;

/**
 * @member {String} destinationCommitId
 */
PullRequestEventPullRequestCreatedEventMetadata.prototype['destinationCommitId'] = undefined;

/**
 * @member {String} mergeBase
 */
PullRequestEventPullRequestCreatedEventMetadata.prototype['mergeBase'] = undefined;


// Implement PullRequestCreatedEventMetadata interface:
/**
 * @member {String} repositoryName
 */
PullRequestCreatedEventMetadata.prototype['repositoryName'] = undefined;
/**
 * @member {String} sourceCommitId
 */
PullRequestCreatedEventMetadata.prototype['sourceCommitId'] = undefined;
/**
 * @member {String} destinationCommitId
 */
PullRequestCreatedEventMetadata.prototype['destinationCommitId'] = undefined;
/**
 * @member {String} mergeBase
 */
PullRequestCreatedEventMetadata.prototype['mergeBase'] = undefined;




export default PullRequestEventPullRequestCreatedEventMetadata;
