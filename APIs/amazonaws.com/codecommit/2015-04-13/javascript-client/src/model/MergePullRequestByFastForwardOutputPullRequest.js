...
import PullRequestStatusEnum from './PullRequestStatusEnum';

/**
 * The MergePullRequestByFastForwardOutputPullRequest model module.
 * @module model/MergePullRequestByFastForwardOutputPullRequest
 * @version 2015-04-13
 */
class MergePullRequestByFastForwardOutputPullRequest {
    /**
     * Constructs a new <code>MergePullRequestByFastForwardOutputPullRequest</code>.
     * @alias module:model/MergePullRequestByFastForwardOutputPullRequest
     * @implements module:model/PullRequest
     */
    constructor() { 
        PullRequest.initialize(this);
        MergePullRequestByFastForwardOutputPullRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MergePullRequestByFastForwardOutputPullRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MergePullRequestByFastForwardOutputPullRequest} obj Optional instance to populate.
     * @return {module:model/MergePullRequestByFastForwardOutputPullRequest} The populated <code>MergePullRequestByFastForwardOutputPullRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MergePullRequestByFastForwardOutputPullRequest();
            ...
            if (data.hasOwnProperty('pullRequestStatus')) {
                obj['pullRequestStatus'] = ApiClient.convertToType(data['pullRequestStatus'], PullRequestStatusEnum);
            }
            if (data.hasOwnProperty('authorArn')) {
                obj['authorArn'] = ApiClient.convertToType(data['authorArn'], 'String');
            }
            if (data.hasOwnProperty('pullRequestTargets')) {
                obj['pullRequestTargets'] = ApiClient.convertToType(data['pullRequestTargets'], Array);
            }
            ...
            if (data.hasOwnProperty('approvalRules')) {
                obj['approvalRules'] = ApiClient.convertToType(data['approvalRules'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MergePullRequestByFastForwardOutputPullRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MergePullRequestByFastForwardOutputPullRequest</code>.
     */
    static validateJSON(data) {
        ...
        if (data['lastActivityDate']) { // data not null
          Date.validateJSON(data['lastActivityDate']);
        }
        ...
        if (data['pullRequestStatus']) { // data not null
          PullRequestStatusEnum.validateJSON(data['pullRequestStatus']);
        }
        // validate the optional field `authorArn`
        if (data['authorArn']) { // data not null
          String.validateJSON(data['authorArn']);
        }
        // validate the optional field `pullRequestTargets`
        if (data['pullRequestTargets']) { // data not null
          Array.validateJSON(data['pullRequestTargets']);
        }
        ...
        if (data['approvalRules']) { // data not null
          Array.validateJSON(data['approvalRules']);
        }
 ...
 */
MergePullRequestByFastForwardOutputPullRequest.prototype['pullRequestId'] = undefined;

/**
 * @member {String} title
 */
MergePullRequestByFastForwardOutputPullRequest.prototype['title'] = undefined;

/**
 * @member {String} description
 */
MergePullRequestByFastForwardOutputPullRequest.prototype['description'] = undefined;

/**
 * @member {Date} lastActivityDate
 */
MergePullRequestByFastForwardOutputPullRequest.prototype['lastActivityDate'] = undefined;

/**
 * @member {Date} creationDate
 */
MergePullRequestByFastForwardOutputPullRequest.prototype['creationDate'] = undefined;

/**
 * @member {module:model/PullRequestStatusEnum} pullRequestStatus
 */
MergePullRequestByFastForwardOutputPullRequest.prototype['pullRequestStatus'] = undefined;

/**
 * @member {String} authorArn
 */
MergePullRequestByFastForwardOutputPullRequest.prototype['authorArn'] = undefined;

/**
 * @member {Array} pullRequestTargets
 */
MergePullRequestByFastForwardOutputPullRequest.prototype['pullRequestTargets'] = undefined;

/**
 * @member {String} clientRequestToken
 */
MergePullRequestByFastForwardOutputPullRequest.prototype['clientRequestToken'] = undefined;

/**
 * @member {String} revisionId
 */
MergePullRequestByFastForwardOutputPullRequest.prototype['revisionId'] = undefined;

/**
 * @member {Array} approvalRules
 */
MergePullRequestByFastForwardOutputPullRequest.prototype['approvalRules'] = undefined;
 ...
 * @member {String} pullRequestId
 */
PullRequest.prototype['pullRequestId'] = undefined;
/**
 * @member {String} title
 */
 ...
 * @member {String} description
 */
PullRequest.prototype['description'] = undefined;
/**
 * @member {Date} lastActivityDate
 */
PullRequest.prototype['lastActivityDate'] = undefined;
/**
 * @member {Date} creationDate
 */
PullRequest.prototype['creationDate'] = undefined;
/**
 * @member {module:model/PullRequestStatusEnum} pullRequestStatus
 */
PullRequest.prototype['pullRequestStatus'] = undefined;
/**
 * @member {String} authorArn
 */
PullRequest.prototype['authorArn'] = undefined;
/**
 * @member {Array} pullRequestTargets
 */
PullRequest.prototype['pullRequestTargets'] = undefined;
/**
 * @member {String} clientRequestToken
 */
PullRequest.prototype['clientRequestToken'] = undefined;
/**
 * @member {String} revisionId
 */
PullRequest.prototype['revisionId'] = undefined;
/**
 * @member {Array} approvalRules
 */
PullRequest.prototype['approvalRules'] = undefined;




export default MergePullRequestByFastForwardOutputPullRequest;
