...
/**
 * The GetCommentReactionsInput model module.
 * @module model/GetCommentReactionsInput
 * @version 2015-04-13
 */
class GetCommentReactionsInput {
    /**
     * Constructs a new <code>GetCommentReactionsInput</code>.
     * @alias module:model/GetCommentReactionsInput
     * @param commentId {String} 
     */
    constructor(commentId) { 
        
        GetCommentReactionsInput.initialize(this, commentId);
    }
    ...
    /**
     * Constructs a <code>GetCommentReactionsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCommentReactionsInput} obj Optional instance to populate.
     * @return {module:model/GetCommentReactionsInput} The populated <code>GetCommentReactionsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCommentReactionsInput();

            if (data.hasOwnProperty('commentId')) {
                obj['commentId'] = ApiClient.convertToType(data['commentId'], 'String');
            }
            if (data.hasOwnProperty('reactionUserArn')) {
                obj['reactionUserArn'] = ApiClient.convertToType(data['reactionUserArn'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetCommentReactionsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCommentReactionsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetCommentReactionsInput.RequiredProperties) {
        ...
        if (data['reactionUserArn']) { // data not null
          String.validateJSON(data['reactionUserArn']);
        }
...
GetCommentReactionsInput.RequiredProperties = ["commentId"];

/**
 * @member {String} commentId
 */
GetCommentReactionsInput.prototype['commentId'] = undefined;

/**
 * @member {String} reactionUserArn
 */
GetCommentReactionsInput.prototype['reactionUserArn'] = undefined;

/**
 * @member {String} nextToken
 */
GetCommentReactionsInput.prototype['nextToken'] = undefined;

/**
 * @member {Number} maxResults
 */
GetCommentReactionsInput.prototype['maxResults'] = undefined;
...
export default GetCommentReactionsInput;
