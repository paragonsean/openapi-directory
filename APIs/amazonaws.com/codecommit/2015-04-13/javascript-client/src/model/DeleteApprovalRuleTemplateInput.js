...
/**
 * The DeleteApprovalRuleTemplateInput model module.
 * @module model/DeleteApprovalRuleTemplateInput
 * @version 2015-04-13
 */
class DeleteApprovalRuleTemplateInput {
    /**
     * Constructs a new <code>DeleteApprovalRuleTemplateInput</code>.
     * @alias module:model/DeleteApprovalRuleTemplateInput
     * @param approvalRuleTemplateName {String} 
     */
    constructor(approvalRuleTemplateName) { 
        
        DeleteApprovalRuleTemplateInput.initialize(this, approvalRuleTemplateName);
    }
    ...
    /**
     * Constructs a <code>DeleteApprovalRuleTemplateInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteApprovalRuleTemplateInput} obj Optional instance to populate.
     * @return {module:model/DeleteApprovalRuleTemplateInput} The populated <code>DeleteApprovalRuleTemplateInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteApprovalRuleTemplateInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteApprovalRuleTemplateInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteApprovalRuleTemplateInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteApprovalRuleTemplateInput.RequiredProperties) {
...
DeleteApprovalRuleTemplateInput.RequiredProperties = ["approvalRuleTemplateName"];

/**
 * @member {String} approvalRuleTemplateName
 */
DeleteApprovalRuleTemplateInput.prototype['approvalRuleTemplateName'] = undefined;
...
export default DeleteApprovalRuleTemplateInput;
