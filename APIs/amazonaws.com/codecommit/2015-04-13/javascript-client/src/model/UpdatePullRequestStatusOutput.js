...
import UpdatePullRequestStatusOutputPullRequest from './UpdatePullRequestStatusOutputPullRequest';

/**
 * The UpdatePullRequestStatusOutput model module.
 * @module model/UpdatePullRequestStatusOutput
 * @version 2015-04-13
 */
class UpdatePullRequestStatusOutput {
    /**
     * Constructs a new <code>UpdatePullRequestStatusOutput</code>.
     * @alias module:model/UpdatePullRequestStatusOutput
     * @param pullRequest {module:model/UpdatePullRequestStatusOutputPullRequest} 
     */
    constructor(pullRequest) { 
        
        UpdatePullRequestStatusOutput.initialize(this, pullRequest);
    }
    ...
    /**
     * Constructs a <code>UpdatePullRequestStatusOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePullRequestStatusOutput} obj Optional instance to populate.
     * @return {module:model/UpdatePullRequestStatusOutput} The populated <code>UpdatePullRequestStatusOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePullRequestStatusOutput();

            if (data.hasOwnProperty('pullRequest')) {
                obj['pullRequest'] = UpdatePullRequestStatusOutputPullRequest.constructFromObject(data['pullRequest']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePullRequestStatusOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePullRequestStatusOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdatePullRequestStatusOutput.RequiredProperties) {
        ...
        if (data['pullRequest']) { // data not null
          UpdatePullRequestStatusOutputPullRequest.validateJSON(data['pullRequest']);
        }
...
UpdatePullRequestStatusOutput.RequiredProperties = ["pullRequest"];

/**
 * @member {module:model/UpdatePullRequestStatusOutputPullRequest} pullRequest
 */
UpdatePullRequestStatusOutput.prototype['pullRequest'] = undefined;
...
export default UpdatePullRequestStatusOutput;
