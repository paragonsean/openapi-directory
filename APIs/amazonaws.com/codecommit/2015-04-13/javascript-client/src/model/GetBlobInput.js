...
/**
 * The GetBlobInput model module.
 * @module model/GetBlobInput
 * @version 2015-04-13
 */
class GetBlobInput {
    /**
     * Constructs a new <code>GetBlobInput</code>.
     * Represents the input of a get blob operation.
     * @alias module:model/GetBlobInput
     * @param repositoryName {String} 
     * @param blobId {String} 
     */
    constructor(repositoryName, blobId) { 
        
        GetBlobInput.initialize(this, repositoryName, blobId);
    }
     ...
     */
    static initialize(obj, repositoryName, blobId) { 
        obj['repositoryName'] = repositoryName;
        obj['blobId'] = blobId;
    }

    /**
     * Constructs a <code>GetBlobInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetBlobInput} obj Optional instance to populate.
     * @return {module:model/GetBlobInput} The populated <code>GetBlobInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetBlobInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetBlobInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBlobInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetBlobInput.RequiredProperties) {
...
GetBlobInput.RequiredProperties = ["repositoryName", "blobId"];

/**
 * @member {String} repositoryName
 */
GetBlobInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} blobId
 */
GetBlobInput.prototype['blobId'] = undefined;
