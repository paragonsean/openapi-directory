...
/**
 * The MergeBranchesByThreeWayOutput model module.
 * @module model/MergeBranchesByThreeWayOutput
 * @version 2015-04-13
 */
class MergeBranchesByThreeWayOutput {
    /**
     * Constructs a new <code>MergeBranchesByThreeWayOutput</code>.
     * @alias module:model/MergeBranchesByThreeWayOutput
     */
    constructor() { 
        
        MergeBranchesByThreeWayOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MergeBranchesByThreeWayOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MergeBranchesByThreeWayOutput} obj Optional instance to populate.
     * @return {module:model/MergeBranchesByThreeWayOutput} The populated <code>MergeBranchesByThreeWayOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MergeBranchesByThreeWayOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>MergeBranchesByThreeWayOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MergeBranchesByThreeWayOutput</code>.
     */
 ...
 */
MergeBranchesByThreeWayOutput.prototype['commitId'] = undefined;

/**
 * @member {String} treeId
 */
MergeBranchesByThreeWayOutput.prototype['treeId'] = undefined;
...
export default MergeBranchesByThreeWayOutput;
