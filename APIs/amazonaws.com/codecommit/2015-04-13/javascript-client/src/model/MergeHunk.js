...
import MergeHunkBase from './MergeHunkBase';
import MergeHunkDestination from './MergeHunkDestination';
import MergeHunkSource from './MergeHunkSource';

/**
 * The MergeHunk model module.
 * @module model/MergeHunk
 * @version 2015-04-13
 */
class MergeHunk {
    /**
     * Constructs a new <code>MergeHunk</code>.
     * Information about merge hunks in a merge or pull request operation.
     * @alias module:model/MergeHunk
     */
    constructor() { 
        
        MergeHunk.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MergeHunk</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MergeHunk} obj Optional instance to populate.
     * @return {module:model/MergeHunk} The populated <code>MergeHunk</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MergeHunk();

            if (data.hasOwnProperty('isConflict')) {
                obj['isConflict'] = ApiClient.convertToType(data['isConflict'], 'Boolean');
            }
            if (data.hasOwnProperty('source')) {
                obj['source'] = MergeHunkSource.constructFromObject(data['source']);
            }
            if (data.hasOwnProperty('destination')) {
                obj['destination'] = MergeHunkDestination.constructFromObject(data['destination']);
            }
            if (data.hasOwnProperty('base')) {
                obj['base'] = MergeHunkBase.constructFromObject(data['base']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MergeHunk</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MergeHunk</code>.
     */
    static validateJSON(data) {
        // validate the optional field `isConflict`
        if (data['isConflict']) { // data not null
          Boolean.validateJSON(data['isConflict']);
        }
        // validate the optional field `source`
        if (data['source']) { // data not null
          MergeHunkSource.validateJSON(data['source']);
        }
        // validate the optional field `destination`
        if (data['destination']) { // data not null
          MergeHunkDestination.validateJSON(data['destination']);
        }
        // validate the optional field `base`
        if (data['base']) { // data not null
          MergeHunkBase.validateJSON(data['base']);
        }
...
/**
 * @member {Boolean} isConflict
 */
MergeHunk.prototype['isConflict'] = undefined;

/**
 * @member {module:model/MergeHunkSource} source
 */
MergeHunk.prototype['source'] = undefined;

/**
 * @member {module:model/MergeHunkDestination} destination
 */
MergeHunk.prototype['destination'] = undefined;

/**
 * @member {module:model/MergeHunkBase} base
 */
MergeHunk.prototype['base'] = undefined;
