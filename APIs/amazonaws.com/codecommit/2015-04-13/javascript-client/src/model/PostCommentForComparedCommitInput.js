...
import PostCommentForComparedCommitInputLocation from './PostCommentForComparedCommitInputLocation';

/**
 * The PostCommentForComparedCommitInput model module.
 * @module model/PostCommentForComparedCommitInput
 * @version 2015-04-13
 */
class PostCommentForComparedCommitInput {
    /**
     * Constructs a new <code>PostCommentForComparedCommitInput</code>.
     * @alias module:model/PostCommentForComparedCommitInput
     * @param repositoryName {String} 
     * @param afterCommitId {String} 
     * @param content {String} 
     */
    constructor(repositoryName, afterCommitId, content) { 
        
        PostCommentForComparedCommitInput.initialize(this, repositoryName, afterCommitId, content);
    }
     ...
     */
    static initialize(obj, repositoryName, afterCommitId, content) { 
        obj['repositoryName'] = repositoryName;
        obj['afterCommitId'] = afterCommitId;
        obj['content'] = content;
    }

    /**
     * Constructs a <code>PostCommentForComparedCommitInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostCommentForComparedCommitInput} obj Optional instance to populate.
     * @return {module:model/PostCommentForComparedCommitInput} The populated <code>PostCommentForComparedCommitInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostCommentForComparedCommitInput();
            ...
            if (data.hasOwnProperty('location')) {
                obj['location'] = PostCommentForComparedCommitInputLocation.constructFromObject(data['location']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PostCommentForComparedCommitInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostCommentForComparedCommitInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PostCommentForComparedCommitInput.RequiredProperties) {
        ...
        if (data['location']) { // data not null
          PostCommentForComparedCommitInputLocation.validateJSON(data['location']);
        }
...
PostCommentForComparedCommitInput.RequiredProperties = ["repositoryName", "afterCommitId", "content"];

/**
 * @member {String} repositoryName
 */
PostCommentForComparedCommitInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} beforeCommitId
 */
PostCommentForComparedCommitInput.prototype['beforeCommitId'] = undefined;

/**
 * @member {String} afterCommitId
 */
PostCommentForComparedCommitInput.prototype['afterCommitId'] = undefined;

/**
 * @member {module:model/PostCommentForComparedCommitInputLocation} location
 */
PostCommentForComparedCommitInput.prototype['location'] = undefined;

/**
 * @member {String} content
 */
PostCommentForComparedCommitInput.prototype['content'] = undefined;

/**
 * @member {String} clientRequestToken
 */
PostCommentForComparedCommitInput.prototype['clientRequestToken'] = undefined;
...
export default PostCommentForComparedCommitInput;
