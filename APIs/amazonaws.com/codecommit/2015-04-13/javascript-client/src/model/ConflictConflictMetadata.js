...
/**
 * The ConflictConflictMetadata model module.
 * @module model/ConflictConflictMetadata
 * @version 2015-04-13
 */
class ConflictConflictMetadata {
    /**
     * Constructs a new <code>ConflictConflictMetadata</code>.
     * @alias module:model/ConflictConflictMetadata
     * @implements module:model/ConflictMetadata
     */
    constructor() { 
        ConflictMetadata.initialize(this);
        ConflictConflictMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ConflictConflictMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConflictConflictMetadata} obj Optional instance to populate.
     * @return {module:model/ConflictConflictMetadata} The populated <code>ConflictConflictMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConflictConflictMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>ConflictConflictMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConflictConflictMetadata</code>.
     */
 ...
 */
ConflictConflictMetadata.prototype['filePath'] = undefined;

/**
 * @member {module:model/ConflictMetadataFileSizes} fileSizes
 */
ConflictConflictMetadata.prototype['fileSizes'] = undefined;

/**
 * @member {module:model/ConflictMetadataFileModes} fileModes
 */
ConflictConflictMetadata.prototype['fileModes'] = undefined;

/**
 * @member {module:model/ConflictMetadataObjectTypes} objectTypes
 */
ConflictConflictMetadata.prototype['objectTypes'] = undefined;

/**
 * @member {Number} numberOfConflicts
 */
ConflictConflictMetadata.prototype['numberOfConflicts'] = undefined;

/**
 * @member {module:model/ConflictMetadataIsBinaryFile} isBinaryFile
 */
ConflictConflictMetadata.prototype['isBinaryFile'] = undefined;

/**
 * @member {Boolean} contentConflict
 */
ConflictConflictMetadata.prototype['contentConflict'] = undefined;

/**
 * @member {Boolean} fileModeConflict
 */
ConflictConflictMetadata.prototype['fileModeConflict'] = undefined;

/**
 * @member {Boolean} objectTypeConflict
 */
ConflictConflictMetadata.prototype['objectTypeConflict'] = undefined;

/**
 * @member {module:model/ConflictMetadataMergeOperations} mergeOperations
 */
ConflictConflictMetadata.prototype['mergeOperations'] = undefined;
...
export default ConflictConflictMetadata;
