...
/**
 * The ApprovalRuleOverriddenEventMetadata model module.
 * @module model/ApprovalRuleOverriddenEventMetadata
 * @version 2015-04-13
 */
class ApprovalRuleOverriddenEventMetadata {
    /**
     * Constructs a new <code>ApprovalRuleOverriddenEventMetadata</code>.
     * Returns information about an override event for approval rules for a pull request.
     * @alias module:model/ApprovalRuleOverriddenEventMetadata
     */
    constructor() { 
        
        ApprovalRuleOverriddenEventMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApprovalRuleOverriddenEventMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApprovalRuleOverriddenEventMetadata} obj Optional instance to populate.
     * @return {module:model/ApprovalRuleOverriddenEventMetadata} The populated <code>ApprovalRuleOverriddenEventMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApprovalRuleOverriddenEventMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>ApprovalRuleOverriddenEventMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApprovalRuleOverriddenEventMetadata</code>.
     */
 ...
 */
ApprovalRuleOverriddenEventMetadata.prototype['revisionId'] = undefined;

/**
 * @member {module:model/OverrideStatus} overrideStatus
 */
ApprovalRuleOverriddenEventMetadata.prototype['overrideStatus'] = undefined;
...
export default ApprovalRuleOverriddenEventMetadata;
