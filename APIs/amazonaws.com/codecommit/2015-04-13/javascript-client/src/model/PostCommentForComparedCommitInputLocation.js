...
/**
 * The PostCommentForComparedCommitInputLocation model module.
 * @module model/PostCommentForComparedCommitInputLocation
 * @version 2015-04-13
 */
class PostCommentForComparedCommitInputLocation {
    /**
     * Constructs a new <code>PostCommentForComparedCommitInputLocation</code>.
     * @alias module:model/PostCommentForComparedCommitInputLocation
     * @implements module:model/Location
     */
    constructor() { 
        Location.initialize(this);
        PostCommentForComparedCommitInputLocation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostCommentForComparedCommitInputLocation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostCommentForComparedCommitInputLocation} obj Optional instance to populate.
     * @return {module:model/PostCommentForComparedCommitInputLocation} The populated <code>PostCommentForComparedCommitInputLocation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostCommentForComparedCommitInputLocation();
    ...
    /**
     * Validates the JSON data with respect to <code>PostCommentForComparedCommitInputLocation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostCommentForComparedCommitInputLocation</code>.
     */
 ...
 */
PostCommentForComparedCommitInputLocation.prototype['filePath'] = undefined;

/**
 * @member {Number} filePosition
 */
PostCommentForComparedCommitInputLocation.prototype['filePosition'] = undefined;

/**
 * @member {module:model/RelativeFileVersionEnum} relativeFileVersion
 */
PostCommentForComparedCommitInputLocation.prototype['relativeFileVersion'] = undefined;
...
export default PostCommentForComparedCommitInputLocation;
