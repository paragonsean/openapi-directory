...
/**
 * The UpdateRepositoryNameInput model module.
 * @module model/UpdateRepositoryNameInput
 * @version 2015-04-13
 */
class UpdateRepositoryNameInput {
    /**
     * Constructs a new <code>UpdateRepositoryNameInput</code>.
     * Represents the input of an update repository description operation.
     * @alias module:model/UpdateRepositoryNameInput
     * @param oldName {String} 
     * @param newName {String} 
     */
    constructor(oldName, newName) { 
        
        UpdateRepositoryNameInput.initialize(this, oldName, newName);
    }
    ...
    /**
     * Constructs a <code>UpdateRepositoryNameInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateRepositoryNameInput} obj Optional instance to populate.
     * @return {module:model/UpdateRepositoryNameInput} The populated <code>UpdateRepositoryNameInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateRepositoryNameInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateRepositoryNameInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateRepositoryNameInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateRepositoryNameInput.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `oldName`
        if (data['oldName']) { // data not null
          String.validateJSON(data['oldName']);
        }
        // validate the optional field `newName`
        if (data['newName']) { // data not null
          String.validateJSON(data['newName']);
        }
...
UpdateRepositoryNameInput.RequiredProperties = ["oldName", "newName"];

/**
 * @member {String} oldName
 */
UpdateRepositoryNameInput.prototype['oldName'] = undefined;

/**
 * @member {String} newName
 */
UpdateRepositoryNameInput.prototype['newName'] = undefined;
...
export default UpdateRepositoryNameInput;
