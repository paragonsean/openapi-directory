...
/**
 * The GetRepositoryTriggersOutput model module.
 * @module model/GetRepositoryTriggersOutput
 * @version 2015-04-13
 */
class GetRepositoryTriggersOutput {
    /**
     * Constructs a new <code>GetRepositoryTriggersOutput</code>.
     * Represents the output of a get repository triggers operation.
     * @alias module:model/GetRepositoryTriggersOutput
     */
    constructor() { 
        
        GetRepositoryTriggersOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetRepositoryTriggersOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetRepositoryTriggersOutput} obj Optional instance to populate.
     * @return {module:model/GetRepositoryTriggersOutput} The populated <code>GetRepositoryTriggersOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetRepositoryTriggersOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetRepositoryTriggersOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetRepositoryTriggersOutput</code>.
     */
 ...
 */
GetRepositoryTriggersOutput.prototype['configurationId'] = undefined;

/**
 * @member {Array} triggers
 */
GetRepositoryTriggersOutput.prototype['triggers'] = undefined;
...
export default GetRepositoryTriggersOutput;
