...
/**
 * The PullRequestSourceReferenceUpdatedEventMetadata model module.
 * @module model/PullRequestSourceReferenceUpdatedEventMetadata
 * @version 2015-04-13
 */
class PullRequestSourceReferenceUpdatedEventMetadata {
    /**
     * Constructs a new <code>PullRequestSourceReferenceUpdatedEventMetadata</code>.
     * Information about an update to the source branch of a pull request.
     * @alias module:model/PullRequestSourceReferenceUpdatedEventMetadata
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>PullRequestSourceReferenceUpdatedEventMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PullRequestSourceReferenceUpdatedEventMetadata} obj Optional instance to populate.
     * @return {module:model/PullRequestSourceReferenceUpdatedEventMetadata} The populated <code>PullRequestSourceReferenceUpdatedEventMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PullRequestSourceReferenceUpdatedEventMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>PullRequestSourceReferenceUpdatedEventMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PullRequestSourceReferenceUpdatedEventMetadata</code>.
     */
...
export default PullRequestSourceReferenceUpdatedEventMetadata;
