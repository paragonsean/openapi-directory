...
/**
 * The PutCommentReactionInput model module.
 * @module model/PutCommentReactionInput
 * @version 2015-04-13
 */
class PutCommentReactionInput {
    /**
     * Constructs a new <code>PutCommentReactionInput</code>.
     * @alias module:model/PutCommentReactionInput
     * @param commentId {String} 
     * @param reactionValue {String} 
     */
    constructor(commentId, reactionValue) { 
        
        PutCommentReactionInput.initialize(this, commentId, reactionValue);
    }
     ...
     */
    static initialize(obj, commentId, reactionValue) { 
        obj['commentId'] = commentId;
        obj['reactionValue'] = reactionValue;
    }

    /**
     * Constructs a <code>PutCommentReactionInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutCommentReactionInput} obj Optional instance to populate.
     * @return {module:model/PutCommentReactionInput} The populated <code>PutCommentReactionInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutCommentReactionInput();

            if (data.hasOwnProperty('commentId')) {
                obj['commentId'] = ApiClient.convertToType(data['commentId'], 'String');
            }
            if (data.hasOwnProperty('reactionValue')) {
                obj['reactionValue'] = ApiClient.convertToType(data['reactionValue'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PutCommentReactionInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutCommentReactionInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutCommentReactionInput.RequiredProperties) {
        ...
        // validate the optional field `reactionValue`
        if (data['reactionValue']) { // data not null
          String.validateJSON(data['reactionValue']);
        }
...
PutCommentReactionInput.RequiredProperties = ["commentId", "reactionValue"];

/**
 * @member {String} commentId
 */
PutCommentReactionInput.prototype['commentId'] = undefined;

/**
 * @member {String} reactionValue
 */
PutCommentReactionInput.prototype['reactionValue'] = undefined;
...
export default PutCommentReactionInput;
