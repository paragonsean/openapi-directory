...
import CommentsForPullRequestLocation from './CommentsForPullRequestLocation';

/**
 * The CommentsForPullRequest model module.
 * @module model/CommentsForPullRequest
 * @version 2015-04-13
 */
class CommentsForPullRequest {
    /**
     * Constructs a new <code>CommentsForPullRequest</code>.
     * Returns information about comments on a pull request.
     * @alias module:model/CommentsForPullRequest
     */
    constructor() { 
        
        CommentsForPullRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CommentsForPullRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CommentsForPullRequest} obj Optional instance to populate.
     * @return {module:model/CommentsForPullRequest} The populated <code>CommentsForPullRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CommentsForPullRequest();
            ...
            if (data.hasOwnProperty('location')) {
                obj['location'] = CommentsForPullRequestLocation.constructFromObject(data['location']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CommentsForPullRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CommentsForPullRequest</code>.
     */
    static validateJSON(data) {
        ...
        if (data['location']) { // data not null
          CommentsForPullRequestLocation.validateJSON(data['location']);
        }
 ...
 */
CommentsForPullRequest.prototype['pullRequestId'] = undefined;

/**
 * @member {String} repositoryName
 */
CommentsForPullRequest.prototype['repositoryName'] = undefined;

/**
 * @member {String} beforeCommitId
 */
CommentsForPullRequest.prototype['beforeCommitId'] = undefined;

/**
 * @member {String} afterCommitId
 */
CommentsForPullRequest.prototype['afterCommitId'] = undefined;

/**
 * @member {String} beforeBlobId
 */
CommentsForPullRequest.prototype['beforeBlobId'] = undefined;

/**
 * @member {String} afterBlobId
 */
CommentsForPullRequest.prototype['afterBlobId'] = undefined;

/**
 * @member {module:model/CommentsForPullRequestLocation} location
 */
CommentsForPullRequest.prototype['location'] = undefined;

/**
 * @member {Array} comments
 */
CommentsForPullRequest.prototype['comments'] = undefined;
...
export default CommentsForPullRequest;
