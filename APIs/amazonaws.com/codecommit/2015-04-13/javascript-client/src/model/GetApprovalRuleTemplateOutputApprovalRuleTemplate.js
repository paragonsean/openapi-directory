...
/**
 * The GetApprovalRuleTemplateOutputApprovalRuleTemplate model module.
 * @module model/GetApprovalRuleTemplateOutputApprovalRuleTemplate
 * @version 2015-04-13
 */
class GetApprovalRuleTemplateOutputApprovalRuleTemplate {
    /**
     * Constructs a new <code>GetApprovalRuleTemplateOutputApprovalRuleTemplate</code>.
     * @alias module:model/GetApprovalRuleTemplateOutputApprovalRuleTemplate
     * @implements module:model/ApprovalRuleTemplate
     */
    constructor() { 
        ApprovalRuleTemplate.initialize(this);
        GetApprovalRuleTemplateOutputApprovalRuleTemplate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetApprovalRuleTemplateOutputApprovalRuleTemplate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetApprovalRuleTemplateOutputApprovalRuleTemplate} obj Optional instance to populate.
     * @return {module:model/GetApprovalRuleTemplateOutputApprovalRuleTemplate} The populated <code>GetApprovalRuleTemplateOutputApprovalRuleTemplate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetApprovalRuleTemplateOutputApprovalRuleTemplate();
    ...
    /**
     * Validates the JSON data with respect to <code>GetApprovalRuleTemplateOutputApprovalRuleTemplate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetApprovalRuleTemplateOutputApprovalRuleTemplate</code>.
     */
 ...
 */
GetApprovalRuleTemplateOutputApprovalRuleTemplate.prototype['approvalRuleTemplateId'] = undefined;

/**
 * @member {String} approvalRuleTemplateName
 */
GetApprovalRuleTemplateOutputApprovalRuleTemplate.prototype['approvalRuleTemplateName'] = undefined;

/**
 * @member {String} approvalRuleTemplateDescription
 */
GetApprovalRuleTemplateOutputApprovalRuleTemplate.prototype['approvalRuleTemplateDescription'] = undefined;

/**
 * @member {String} approvalRuleTemplateContent
 */
GetApprovalRuleTemplateOutputApprovalRuleTemplate.prototype['approvalRuleTemplateContent'] = undefined;

/**
 * @member {String} ruleContentSha256
 */
GetApprovalRuleTemplateOutputApprovalRuleTemplate.prototype['ruleContentSha256'] = undefined;

/**
 * @member {Date} lastModifiedDate
 */
GetApprovalRuleTemplateOutputApprovalRuleTemplate.prototype['lastModifiedDate'] = undefined;

/**
 * @member {Date} creationDate
 */
GetApprovalRuleTemplateOutputApprovalRuleTemplate.prototype['creationDate'] = undefined;

/**
 * @member {String} lastModifiedUser
 */
GetApprovalRuleTemplateOutputApprovalRuleTemplate.prototype['lastModifiedUser'] = undefined;
...
export default GetApprovalRuleTemplateOutputApprovalRuleTemplate;
