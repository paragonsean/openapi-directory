...
/**
 * The PutRepositoryTriggersOutput model module.
 * @module model/PutRepositoryTriggersOutput
 * @version 2015-04-13
 */
class PutRepositoryTriggersOutput {
    /**
     * Constructs a new <code>PutRepositoryTriggersOutput</code>.
     * Represents the output of a put repository triggers operation.
     * @alias module:model/PutRepositoryTriggersOutput
     */
    constructor() { 
        
        PutRepositoryTriggersOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutRepositoryTriggersOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutRepositoryTriggersOutput} obj Optional instance to populate.
     * @return {module:model/PutRepositoryTriggersOutput} The populated <code>PutRepositoryTriggersOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutRepositoryTriggersOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>PutRepositoryTriggersOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutRepositoryTriggersOutput</code>.
     */
 ...
 */
PutRepositoryTriggersOutput.prototype['configurationId'] = undefined;
...
export default PutRepositoryTriggersOutput;
