...
/**
 * The ListRepositoriesForApprovalRuleTemplateOutput model module.
 * @module model/ListRepositoriesForApprovalRuleTemplateOutput
 * @version 2015-04-13
 */
class ListRepositoriesForApprovalRuleTemplateOutput {
    /**
     * Constructs a new <code>ListRepositoriesForApprovalRuleTemplateOutput</code>.
     * @alias module:model/ListRepositoriesForApprovalRuleTemplateOutput
     */
    constructor() { 
        
        ListRepositoriesForApprovalRuleTemplateOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListRepositoriesForApprovalRuleTemplateOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListRepositoriesForApprovalRuleTemplateOutput} obj Optional instance to populate.
     * @return {module:model/ListRepositoriesForApprovalRuleTemplateOutput} The populated <code>ListRepositoriesForApprovalRuleTemplateOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListRepositoriesForApprovalRuleTemplateOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListRepositoriesForApprovalRuleTemplateOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListRepositoriesForApprovalRuleTemplateOutput</code>.
     */
 ...
 */
ListRepositoriesForApprovalRuleTemplateOutput.prototype['repositoryNames'] = undefined;

/**
 * @member {String} nextToken
 */
ListRepositoriesForApprovalRuleTemplateOutput.prototype['nextToken'] = undefined;
...
export default ListRepositoriesForApprovalRuleTemplateOutput;
