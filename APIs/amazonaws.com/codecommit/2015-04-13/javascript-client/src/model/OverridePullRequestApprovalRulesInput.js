...
/**
 * The OverridePullRequestApprovalRulesInput model module.
 * @module model/OverridePullRequestApprovalRulesInput
 * @version 2015-04-13
 */
class OverridePullRequestApprovalRulesInput {
    /**
     * Constructs a new <code>OverridePullRequestApprovalRulesInput</code>.
     * @alias module:model/OverridePullRequestApprovalRulesInput
     * @param pullRequestId {String} 
     * @param revisionId {String} 
     * @param overrideStatus {module:model/OverrideStatus} 
     */
    constructor(pullRequestId, revisionId, overrideStatus) { 
        
        OverridePullRequestApprovalRulesInput.initialize(this, pullRequestId, revisionId, overrideStatus);
    }
     ...
     */
    static initialize(obj, pullRequestId, revisionId, overrideStatus) { 
        obj['pullRequestId'] = pullRequestId;
        obj['revisionId'] = revisionId;
        obj['overrideStatus'] = overrideStatus;
    }

    /**
     * Constructs a <code>OverridePullRequestApprovalRulesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OverridePullRequestApprovalRulesInput} obj Optional instance to populate.
     * @return {module:model/OverridePullRequestApprovalRulesInput} The populated <code>OverridePullRequestApprovalRulesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OverridePullRequestApprovalRulesInput();
            ...
            if (data.hasOwnProperty('overrideStatus')) {
                obj['overrideStatus'] = ApiClient.convertToType(data['overrideStatus'], OverrideStatus);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>OverridePullRequestApprovalRulesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OverridePullRequestApprovalRulesInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OverridePullRequestApprovalRulesInput.RequiredProperties) {
        ...
        // validate the optional field `overrideStatus`
        if (data['overrideStatus']) { // data not null
          OverrideStatus.validateJSON(data['overrideStatus']);
        }
...
OverridePullRequestApprovalRulesInput.RequiredProperties = ["pullRequestId", "revisionId", "overrideStatus"];

/**
 * @member {String} pullRequestId
 */
OverridePullRequestApprovalRulesInput.prototype['pullRequestId'] = undefined;

/**
 * @member {String} revisionId
 */
OverridePullRequestApprovalRulesInput.prototype['revisionId'] = undefined;

/**
 * @member {module:model/OverrideStatus} overrideStatus
 */
OverridePullRequestApprovalRulesInput.prototype['overrideStatus'] = undefined;
...
export default OverridePullRequestApprovalRulesInput;
