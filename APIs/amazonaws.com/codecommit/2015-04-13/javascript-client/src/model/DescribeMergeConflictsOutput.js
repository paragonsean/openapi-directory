...
import DescribeMergeConflictsOutputConflictMetadata from './DescribeMergeConflictsOutputConflictMetadata';

/**
 * The DescribeMergeConflictsOutput model module.
 * @module model/DescribeMergeConflictsOutput
 * @version 2015-04-13
 */
class DescribeMergeConflictsOutput {
    /**
     * Constructs a new <code>DescribeMergeConflictsOutput</code>.
     * @alias module:model/DescribeMergeConflictsOutput
     * @param conflictMetadata {module:model/DescribeMergeConflictsOutputConflictMetadata} 
     * @param mergeHunks {Array} 
     * @param destinationCommitId {String} 
     * @param sourceCommitId {String} 
     */
    constructor(conflictMetadata, mergeHunks, destinationCommitId, sourceCommitId) { 
        
        DescribeMergeConflictsOutput.initialize(this, conflictMetadata, mergeHunks, destinationCommitId, sourceCommitId);
    }
     ...
     */
    static initialize(obj, conflictMetadata, mergeHunks, destinationCommitId, sourceCommitId) { 
        obj['conflictMetadata'] = conflictMetadata;
        obj['mergeHunks'] = mergeHunks;
        obj['destinationCommitId'] = destinationCommitId;
        obj['sourceCommitId'] = sourceCommitId;
    }

    /**
     * Constructs a <code>DescribeMergeConflictsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeMergeConflictsOutput} obj Optional instance to populate.
     * @return {module:model/DescribeMergeConflictsOutput} The populated <code>DescribeMergeConflictsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeMergeConflictsOutput();

            if (data.hasOwnProperty('conflictMetadata')) {
                obj['conflictMetadata'] = DescribeMergeConflictsOutputConflictMetadata.constructFromObject(data['conflictMetadata']);
            }
            if (data.hasOwnProperty('mergeHunks')) {
                obj['mergeHunks'] = ApiClient.convertToType(data['mergeHunks'], Array);
            }
            if (data.hasOwnProperty('nextToken')) {
                obj['nextToken'] = ApiClient.convertToType(data['nextToken'], 'String');
            }
            if (data.hasOwnProperty('destinationCommitId')) {
                obj['destinationCommitId'] = ApiClient.convertToType(data['destinationCommitId'], 'String');
            }
            if (data.hasOwnProperty('sourceCommitId')) {
                obj['sourceCommitId'] = ApiClient.convertToType(data['sourceCommitId'], 'String');
            }
            if (data.hasOwnProperty('baseCommitId')) {
                obj['baseCommitId'] = ApiClient.convertToType(data['baseCommitId'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeMergeConflictsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeMergeConflictsOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeMergeConflictsOutput.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `conflictMetadata`
        if (data['conflictMetadata']) { // data not null
          DescribeMergeConflictsOutputConflictMetadata.validateJSON(data['conflictMetadata']);
        }
        // validate the optional field `mergeHunks`
        if (data['mergeHunks']) { // data not null
          Array.validateJSON(data['mergeHunks']);
        }
        // validate the optional field `nextToken`
        if (data['nextToken']) { // data not null
          String.validateJSON(data['nextToken']);
        }
        // validate the optional field `destinationCommitId`
        if (data['destinationCommitId']) { // data not null
          String.validateJSON(data['destinationCommitId']);
        }
        ...
        if (data['baseCommitId']) { // data not null
          String.validateJSON(data['baseCommitId']);
        }
...
DescribeMergeConflictsOutput.RequiredProperties = ["conflictMetadata", "mergeHunks", "destinationCommitId", "sourceCommitId"];

/**
 * @member {module:model/DescribeMergeConflictsOutputConflictMetadata} conflictMetadata
 */
DescribeMergeConflictsOutput.prototype['conflictMetadata'] = undefined;

/**
 * @member {Array} mergeHunks
 */
DescribeMergeConflictsOutput.prototype['mergeHunks'] = undefined;

/**
 * @member {String} nextToken
 */
DescribeMergeConflictsOutput.prototype['nextToken'] = undefined;

/**
 * @member {String} destinationCommitId
 */
DescribeMergeConflictsOutput.prototype['destinationCommitId'] = undefined;

/**
 * @member {String} sourceCommitId
 */
DescribeMergeConflictsOutput.prototype['sourceCommitId'] = undefined;

/**
 * @member {String} baseCommitId
 */
DescribeMergeConflictsOutput.prototype['baseCommitId'] = undefined;
...
export default DescribeMergeConflictsOutput;
