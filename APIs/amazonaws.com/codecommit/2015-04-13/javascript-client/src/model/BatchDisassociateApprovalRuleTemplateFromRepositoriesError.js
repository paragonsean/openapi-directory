...
/**
 * The BatchDisassociateApprovalRuleTemplateFromRepositoriesError model module.
 * @module model/BatchDisassociateApprovalRuleTemplateFromRepositoriesError
 * @version 2015-04-13
 */
class BatchDisassociateApprovalRuleTemplateFromRepositoriesError {
    /**
     * Constructs a new <code>BatchDisassociateApprovalRuleTemplateFromRepositoriesError</code>.
     * Returns information about errors in a BatchDisassociateApprovalRuleTemplateFromRepositories operation.
     * @alias module:model/BatchDisassociateApprovalRuleTemplateFromRepositoriesError
     */
    constructor() { 
        
        BatchDisassociateApprovalRuleTemplateFromRepositoriesError.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchDisassociateApprovalRuleTemplateFromRepositoriesError</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchDisassociateApprovalRuleTemplateFromRepositoriesError} obj Optional instance to populate.
     * @return {module:model/BatchDisassociateApprovalRuleTemplateFromRepositoriesError} The populated <code>BatchDisassociateApprovalRuleTemplateFromRepositoriesError</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchDisassociateApprovalRuleTemplateFromRepositoriesError();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchDisassociateApprovalRuleTemplateFromRepositoriesError</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchDisassociateApprovalRuleTemplateFromRepositoriesError</code>.
     */
 ...
 */
BatchDisassociateApprovalRuleTemplateFromRepositoriesError.prototype['repositoryName'] = undefined;

/**
 * @member {String} errorCode
 */
BatchDisassociateApprovalRuleTemplateFromRepositoriesError.prototype['errorCode'] = undefined;

/**
 * @member {String} errorMessage
 */
BatchDisassociateApprovalRuleTemplateFromRepositoriesError.prototype['errorMessage'] = undefined;
...
export default BatchDisassociateApprovalRuleTemplateFromRepositoriesError;
