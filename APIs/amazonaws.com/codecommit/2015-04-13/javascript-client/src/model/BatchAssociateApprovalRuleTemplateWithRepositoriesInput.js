...
/**
 * The BatchAssociateApprovalRuleTemplateWithRepositoriesInput model module.
 * @module model/BatchAssociateApprovalRuleTemplateWithRepositoriesInput
 * @version 2015-04-13
 */
class BatchAssociateApprovalRuleTemplateWithRepositoriesInput {
    /**
     * Constructs a new <code>BatchAssociateApprovalRuleTemplateWithRepositoriesInput</code>.
     * @alias module:model/BatchAssociateApprovalRuleTemplateWithRepositoriesInput
     * @param approvalRuleTemplateName {String} 
     * @param repositoryNames {Array} 
     */
    constructor(approvalRuleTemplateName, repositoryNames) { 
        
        BatchAssociateApprovalRuleTemplateWithRepositoriesInput.initialize(this, approvalRuleTemplateName, repositoryNames);
    }
    ...
    /**
     * Constructs a <code>BatchAssociateApprovalRuleTemplateWithRepositoriesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchAssociateApprovalRuleTemplateWithRepositoriesInput} obj Optional instance to populate.
     * @return {module:model/BatchAssociateApprovalRuleTemplateWithRepositoriesInput} The populated <code>BatchAssociateApprovalRuleTemplateWithRepositoriesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchAssociateApprovalRuleTemplateWithRepositoriesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchAssociateApprovalRuleTemplateWithRepositoriesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchAssociateApprovalRuleTemplateWithRepositoriesInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BatchAssociateApprovalRuleTemplateWithRepositoriesInput.RequiredProperties) {
...
BatchAssociateApprovalRuleTemplateWithRepositoriesInput.RequiredProperties = ["approvalRuleTemplateName", "repositoryNames"];

/**
 * @member {String} approvalRuleTemplateName
 */
BatchAssociateApprovalRuleTemplateWithRepositoriesInput.prototype['approvalRuleTemplateName'] = undefined;

/**
 * @member {Array} repositoryNames
 */
BatchAssociateApprovalRuleTemplateWithRepositoriesInput.prototype['repositoryNames'] = undefined;
...
export default BatchAssociateApprovalRuleTemplateWithRepositoriesInput;
