...
import GetBranchOutputBranch from './GetBranchOutputBranch';

/**
 * The GetBranchOutput model module.
 * @module model/GetBranchOutput
 * @version 2015-04-13
 */
class GetBranchOutput {
    /**
     * Constructs a new <code>GetBranchOutput</code>.
     * Represents the output of a get branch operation.
     * @alias module:model/GetBranchOutput
     */
    constructor() { 
        
        GetBranchOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetBranchOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetBranchOutput} obj Optional instance to populate.
     * @return {module:model/GetBranchOutput} The populated <code>GetBranchOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetBranchOutput();

            if (data.hasOwnProperty('branch')) {
                obj['branch'] = GetBranchOutputBranch.constructFromObject(data['branch']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetBranchOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBranchOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `branch`
        if (data['branch']) { // data not null
          GetBranchOutputBranch.validateJSON(data['branch']);
        }
...
/**
 * @member {module:model/GetBranchOutputBranch} branch
 */
GetBranchOutput.prototype['branch'] = undefined;
...
export default GetBranchOutput;
