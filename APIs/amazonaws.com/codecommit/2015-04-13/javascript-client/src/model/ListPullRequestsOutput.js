...
/**
 * The ListPullRequestsOutput model module.
 * @module model/ListPullRequestsOutput
 * @version 2015-04-13
 */
class ListPullRequestsOutput {
    /**
     * Constructs a new <code>ListPullRequestsOutput</code>.
     * @alias module:model/ListPullRequestsOutput
     * @param pullRequestIds {Array} 
     */
    constructor(pullRequestIds) { 
        
        ListPullRequestsOutput.initialize(this, pullRequestIds);
    }
     ...
     */
    static initialize(obj, pullRequestIds) { 
        obj['pullRequestIds'] = pullRequestIds;
    }

    /**
     * Constructs a <code>ListPullRequestsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListPullRequestsOutput} obj Optional instance to populate.
     * @return {module:model/ListPullRequestsOutput} The populated <code>ListPullRequestsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListPullRequestsOutput();

            if (data.hasOwnProperty('pullRequestIds')) {
                obj['pullRequestIds'] = ApiClient.convertToType(data['pullRequestIds'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListPullRequestsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListPullRequestsOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListPullRequestsOutput.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `pullRequestIds`
        if (data['pullRequestIds']) { // data not null
          Array.validateJSON(data['pullRequestIds']);
        }
...
ListPullRequestsOutput.RequiredProperties = ["pullRequestIds"];

/**
 * @member {Array} pullRequestIds
 */
ListPullRequestsOutput.prototype['pullRequestIds'] = undefined;

/**
 * @member {String} nextToken
 */
ListPullRequestsOutput.prototype['nextToken'] = undefined;
...
export default ListPullRequestsOutput;
