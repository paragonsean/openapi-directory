...
/**
 * The ConflictMetadataIsBinaryFile model module.
 * @module model/ConflictMetadataIsBinaryFile
 * @version 2015-04-13
 */
class ConflictMetadataIsBinaryFile {
    /**
     * Constructs a new <code>ConflictMetadataIsBinaryFile</code>.
     * @alias module:model/ConflictMetadataIsBinaryFile
     * @implements module:model/IsBinaryFile
     */
    constructor() { 
        IsBinaryFile.initialize(this);
        ConflictMetadataIsBinaryFile.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ConflictMetadataIsBinaryFile</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConflictMetadataIsBinaryFile} obj Optional instance to populate.
     * @return {module:model/ConflictMetadataIsBinaryFile} The populated <code>ConflictMetadataIsBinaryFile</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConflictMetadataIsBinaryFile();
            IsBinaryFile.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ConflictMetadataIsBinaryFile</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConflictMetadataIsBinaryFile</code>.
     */
 ...
 */
ConflictMetadataIsBinaryFile.prototype['source'] = undefined;

/**
 * @member {Boolean} destination
 */
ConflictMetadataIsBinaryFile.prototype['destination'] = undefined;

/**
 * @member {Boolean} base
 */
ConflictMetadataIsBinaryFile.prototype['base'] = undefined;


// Implement IsBinaryFile interface:
/**
 * @member {Boolean} source
 */
...
export default ConflictMetadataIsBinaryFile;
