...
import ReactionForCommentReaction from './ReactionForCommentReaction';

/**
 * The ReactionForComment model module.
 * @module model/ReactionForComment
 * @version 2015-04-13
 */
class ReactionForComment {
    /**
     * Constructs a new <code>ReactionForComment</code>.
     * Information about the reaction values provided by users on a comment.
     * @alias module:model/ReactionForComment
     */
    constructor() { 
        
        ReactionForComment.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ReactionForComment</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReactionForComment} obj Optional instance to populate.
     * @return {module:model/ReactionForComment} The populated <code>ReactionForComment</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReactionForComment();

            if (data.hasOwnProperty('reaction')) {
                obj['reaction'] = ReactionForCommentReaction.constructFromObject(data['reaction']);
            }
            if (data.hasOwnProperty('reactionUsers')) {
                obj['reactionUsers'] = ApiClient.convertToType(data['reactionUsers'], Array);
            }
            if (data.hasOwnProperty('reactionsFromDeletedUsersCount')) {
                obj['reactionsFromDeletedUsersCount'] = ApiClient.convertToType(data['reactionsFromDeletedUsersCount'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ReactionForComment</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReactionForComment</code>.
     */
    static validateJSON(data) {
        // validate the optional field `reaction`
        if (data['reaction']) { // data not null
          ReactionForCommentReaction.validateJSON(data['reaction']);
        }
        // validate the optional field `reactionUsers`
        if (data['reactionUsers']) { // data not null
          Array.validateJSON(data['reactionUsers']);
        }
        // validate the optional field `reactionsFromDeletedUsersCount`
        if (data['reactionsFromDeletedUsersCount']) { // data not null
          Number.validateJSON(data['reactionsFromDeletedUsersCount']);
        }
...
/**
 * @member {module:model/ReactionForCommentReaction} reaction
 */
ReactionForComment.prototype['reaction'] = undefined;

/**
 * @member {Array} reactionUsers
 */
ReactionForComment.prototype['reactionUsers'] = undefined;

/**
 * @member {Number} reactionsFromDeletedUsersCount
 */
ReactionForComment.prototype['reactionsFromDeletedUsersCount'] = undefined;
...
export default ReactionForComment;
