...
/**
 * The UpdatePullRequestApprovalRuleContentInput model module.
 * @module model/UpdatePullRequestApprovalRuleContentInput
 * @version 2015-04-13
 */
class UpdatePullRequestApprovalRuleContentInput {
    /**
     * Constructs a new <code>UpdatePullRequestApprovalRuleContentInput</code>.
     * @alias module:model/UpdatePullRequestApprovalRuleContentInput
     * @param pullRequestId {String} 
     * @param approvalRuleName {String} 
     * @param newRuleContent {String} 
     */
    constructor(pullRequestId, approvalRuleName, newRuleContent) { 
        
        UpdatePullRequestApprovalRuleContentInput.initialize(this, pullRequestId, approvalRuleName, newRuleContent);
    }
     ...
     */
    static initialize(obj, pullRequestId, approvalRuleName, newRuleContent) { 
        obj['pullRequestId'] = pullRequestId;
        obj['approvalRuleName'] = approvalRuleName;
        obj['newRuleContent'] = newRuleContent;
    }

    /**
     * Constructs a <code>UpdatePullRequestApprovalRuleContentInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePullRequestApprovalRuleContentInput} obj Optional instance to populate.
     * @return {module:model/UpdatePullRequestApprovalRuleContentInput} The populated <code>UpdatePullRequestApprovalRuleContentInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePullRequestApprovalRuleContentInput();
            ...
            if (data.hasOwnProperty('existingRuleContentSha256')) {
                obj['existingRuleContentSha256'] = ApiClient.convertToType(data['existingRuleContentSha256'], 'String');
            }
            if (data.hasOwnProperty('newRuleContent')) {
                obj['newRuleContent'] = ApiClient.convertToType(data['newRuleContent'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePullRequestApprovalRuleContentInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePullRequestApprovalRuleContentInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdatePullRequestApprovalRuleContentInput.RequiredProperties) {
        ...
        if (data['existingRuleContentSha256']) { // data not null
          String.validateJSON(data['existingRuleContentSha256']);
        }
        // validate the optional field `newRuleContent`
        if (data['newRuleContent']) { // data not null
          String.validateJSON(data['newRuleContent']);
        }
...
UpdatePullRequestApprovalRuleContentInput.RequiredProperties = ["pullRequestId", "approvalRuleName", "newRuleContent"];

/**
 * @member {String} pullRequestId
 */
UpdatePullRequestApprovalRuleContentInput.prototype['pullRequestId'] = undefined;

/**
 * @member {String} approvalRuleName
 */
UpdatePullRequestApprovalRuleContentInput.prototype['approvalRuleName'] = undefined;

/**
 * @member {String} existingRuleContentSha256
 */
UpdatePullRequestApprovalRuleContentInput.prototype['existingRuleContentSha256'] = undefined;

/**
 * @member {String} newRuleContent
 */
UpdatePullRequestApprovalRuleContentInput.prototype['newRuleContent'] = undefined;
...
export default UpdatePullRequestApprovalRuleContentInput;
