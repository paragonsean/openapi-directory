...
/**
 * The CreateApprovalRuleTemplateOutputApprovalRuleTemplate model module.
 * @module model/CreateApprovalRuleTemplateOutputApprovalRuleTemplate
 * @version 2015-04-13
 */
class CreateApprovalRuleTemplateOutputApprovalRuleTemplate {
    /**
     * Constructs a new <code>CreateApprovalRuleTemplateOutputApprovalRuleTemplate</code>.
     * @alias module:model/CreateApprovalRuleTemplateOutputApprovalRuleTemplate
     * @implements module:model/ApprovalRuleTemplate
     */
    constructor() { 
        ApprovalRuleTemplate.initialize(this);
        CreateApprovalRuleTemplateOutputApprovalRuleTemplate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateApprovalRuleTemplateOutputApprovalRuleTemplate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateApprovalRuleTemplateOutputApprovalRuleTemplate} obj Optional instance to populate.
     * @return {module:model/CreateApprovalRuleTemplateOutputApprovalRuleTemplate} The populated <code>CreateApprovalRuleTemplateOutputApprovalRuleTemplate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateApprovalRuleTemplateOutputApprovalRuleTemplate();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateApprovalRuleTemplateOutputApprovalRuleTemplate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateApprovalRuleTemplateOutputApprovalRuleTemplate</code>.
     */
 ...
 */
CreateApprovalRuleTemplateOutputApprovalRuleTemplate.prototype['approvalRuleTemplateId'] = undefined;

/**
 * @member {String} approvalRuleTemplateName
 */
CreateApprovalRuleTemplateOutputApprovalRuleTemplate.prototype['approvalRuleTemplateName'] = undefined;

/**
 * @member {String} approvalRuleTemplateDescription
 */
CreateApprovalRuleTemplateOutputApprovalRuleTemplate.prototype['approvalRuleTemplateDescription'] = undefined;

/**
 * @member {String} approvalRuleTemplateContent
 */
CreateApprovalRuleTemplateOutputApprovalRuleTemplate.prototype['approvalRuleTemplateContent'] = undefined;

/**
 * @member {String} ruleContentSha256
 */
CreateApprovalRuleTemplateOutputApprovalRuleTemplate.prototype['ruleContentSha256'] = undefined;

/**
 * @member {Date} lastModifiedDate
 */
CreateApprovalRuleTemplateOutputApprovalRuleTemplate.prototype['lastModifiedDate'] = undefined;

/**
 * @member {Date} creationDate
 */
CreateApprovalRuleTemplateOutputApprovalRuleTemplate.prototype['creationDate'] = undefined;

/**
 * @member {String} lastModifiedUser
 */
CreateApprovalRuleTemplateOutputApprovalRuleTemplate.prototype['lastModifiedUser'] = undefined;
...
export default CreateApprovalRuleTemplateOutputApprovalRuleTemplate;
