...
/**
 * The DeleteApprovalRuleTemplateOutput model module.
 * @module model/DeleteApprovalRuleTemplateOutput
 * @version 2015-04-13
 */
class DeleteApprovalRuleTemplateOutput {
    /**
     * Constructs a new <code>DeleteApprovalRuleTemplateOutput</code>.
     * @alias module:model/DeleteApprovalRuleTemplateOutput
     * @param approvalRuleTemplateId {String} 
     */
    constructor(approvalRuleTemplateId) { 
        
        DeleteApprovalRuleTemplateOutput.initialize(this, approvalRuleTemplateId);
    }
     ...
     */
    static initialize(obj, approvalRuleTemplateId) { 
        obj['approvalRuleTemplateId'] = approvalRuleTemplateId;
    }

    /**
     * Constructs a <code>DeleteApprovalRuleTemplateOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteApprovalRuleTemplateOutput} obj Optional instance to populate.
     * @return {module:model/DeleteApprovalRuleTemplateOutput} The populated <code>DeleteApprovalRuleTemplateOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteApprovalRuleTemplateOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteApprovalRuleTemplateOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteApprovalRuleTemplateOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteApprovalRuleTemplateOutput.RequiredProperties) {
...
DeleteApprovalRuleTemplateOutput.RequiredProperties = ["approvalRuleTemplateId"];

/**
 * @member {String} approvalRuleTemplateId
 */
DeleteApprovalRuleTemplateOutput.prototype['approvalRuleTemplateId'] = undefined;
...
export default DeleteApprovalRuleTemplateOutput;
