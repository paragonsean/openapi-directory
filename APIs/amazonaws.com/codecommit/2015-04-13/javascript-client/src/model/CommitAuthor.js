...
/**
 * The CommitAuthor model module.
 * @module model/CommitAuthor
 * @version 2015-04-13
 */
class CommitAuthor {
    /**
     * Constructs a new <code>CommitAuthor</code>.
     * @alias module:model/CommitAuthor
     * @implements module:model/UserInfo
     */
    constructor() { 
        UserInfo.initialize(this);
        CommitAuthor.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CommitAuthor</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CommitAuthor} obj Optional instance to populate.
     * @return {module:model/CommitAuthor} The populated <code>CommitAuthor</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CommitAuthor();
            UserInfo.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CommitAuthor</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CommitAuthor</code>.
     */
 ...
 * @member {String} name
 */
CommitAuthor.prototype['name'] = undefined;

/**
 * @member {String} email
 */
CommitAuthor.prototype['email'] = undefined;

/**
 * @member {String} date
 */
CommitAuthor.prototype['date'] = undefined;
 ...
 * @member {String} date
 */
UserInfo.prototype['date'] = undefined;
