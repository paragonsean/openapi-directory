...
/**
 * The GetPullRequestOverrideStateInput model module.
 * @module model/GetPullRequestOverrideStateInput
 * @version 2015-04-13
 */
class GetPullRequestOverrideStateInput {
    /**
     * Constructs a new <code>GetPullRequestOverrideStateInput</code>.
     * @alias module:model/GetPullRequestOverrideStateInput
     * @param pullRequestId {String} 
     * @param revisionId {String} 
     */
    constructor(pullRequestId, revisionId) { 
        
        GetPullRequestOverrideStateInput.initialize(this, pullRequestId, revisionId);
    }
    ...
    /**
     * Constructs a <code>GetPullRequestOverrideStateInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPullRequestOverrideStateInput} obj Optional instance to populate.
     * @return {module:model/GetPullRequestOverrideStateInput} The populated <code>GetPullRequestOverrideStateInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPullRequestOverrideStateInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetPullRequestOverrideStateInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPullRequestOverrideStateInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetPullRequestOverrideStateInput.RequiredProperties) {
...
GetPullRequestOverrideStateInput.RequiredProperties = ["pullRequestId", "revisionId"];

/**
 * @member {String} pullRequestId
 */
GetPullRequestOverrideStateInput.prototype['pullRequestId'] = undefined;

/**
 * @member {String} revisionId
 */
GetPullRequestOverrideStateInput.prototype['revisionId'] = undefined;
...
export default GetPullRequestOverrideStateInput;
