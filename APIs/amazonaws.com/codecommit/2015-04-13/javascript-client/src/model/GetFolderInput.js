...
/**
 * The GetFolderInput model module.
 * @module model/GetFolderInput
 * @version 2015-04-13
 */
class GetFolderInput {
    /**
     * Constructs a new <code>GetFolderInput</code>.
     * @alias module:model/GetFolderInput
     * @param repositoryName {String} 
     * @param folderPath {String} 
     */
    constructor(repositoryName, folderPath) { 
        
        GetFolderInput.initialize(this, repositoryName, folderPath);
    }
     ...
     */
    static initialize(obj, repositoryName, folderPath) { 
        obj['repositoryName'] = repositoryName;
        obj['folderPath'] = folderPath;
    }

    /**
     * Constructs a <code>GetFolderInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetFolderInput} obj Optional instance to populate.
     * @return {module:model/GetFolderInput} The populated <code>GetFolderInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetFolderInput();

            if (data.hasOwnProperty('repositoryName')) {
                obj['repositoryName'] = ApiClient.convertToType(data['repositoryName'], 'String');
            }
            if (data.hasOwnProperty('commitSpecifier')) {
                obj['commitSpecifier'] = ApiClient.convertToType(data['commitSpecifier'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetFolderInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetFolderInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetFolderInput.RequiredProperties) {
        ...
        if (data['commitSpecifier']) { // data not null
          String.validateJSON(data['commitSpecifier']);
        }
...
GetFolderInput.RequiredProperties = ["repositoryName", "folderPath"];

/**
 * @member {String} repositoryName
 */
GetFolderInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} commitSpecifier
 */
GetFolderInput.prototype['commitSpecifier'] = undefined;

/**
 * @member {String} folderPath
 */
GetFolderInput.prototype['folderPath'] = undefined;
