...
/**
 * The CreateBranchInput model module.
 * @module model/CreateBranchInput
 * @version 2015-04-13
 */
class CreateBranchInput {
    /**
     * Constructs a new <code>CreateBranchInput</code>.
     * Represents the input of a create branch operation.
     * @alias module:model/CreateBranchInput
     * @param repositoryName {String} 
     * @param branchName {String} 
     * @param commitId {String} 
     */
    constructor(repositoryName, branchName, commitId) { 
        
        CreateBranchInput.initialize(this, repositoryName, branchName, commitId);
    }
     ...
     */
    static initialize(obj, repositoryName, branchName, commitId) { 
    ...
    /**
     * Constructs a <code>CreateBranchInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateBranchInput} obj Optional instance to populate.
     * @return {module:model/CreateBranchInput} The populated <code>CreateBranchInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateBranchInput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateBranchInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateBranchInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateBranchInput.RequiredProperties) {
...
CreateBranchInput.RequiredProperties = ["repositoryName", "branchName", "commitId"];

/**
 * @member {String} repositoryName
 */
CreateBranchInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} branchName
 */
CreateBranchInput.prototype['branchName'] = undefined;

/**
 * @member {String} commitId
 */
CreateBranchInput.prototype['commitId'] = undefined;
