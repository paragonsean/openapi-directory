...
/**
 * The GetCommentsForComparedCommitOutput model module.
 * @module model/GetCommentsForComparedCommitOutput
 * @version 2015-04-13
 */
class GetCommentsForComparedCommitOutput {
    /**
     * Constructs a new <code>GetCommentsForComparedCommitOutput</code>.
     * @alias module:model/GetCommentsForComparedCommitOutput
     */
    constructor() { 
        
        GetCommentsForComparedCommitOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetCommentsForComparedCommitOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCommentsForComparedCommitOutput} obj Optional instance to populate.
     * @return {module:model/GetCommentsForComparedCommitOutput} The populated <code>GetCommentsForComparedCommitOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCommentsForComparedCommitOutput();

            if (data.hasOwnProperty('commentsForComparedCommitData')) {
                obj['commentsForComparedCommitData'] = ApiClient.convertToType(data['commentsForComparedCommitData'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetCommentsForComparedCommitOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCommentsForComparedCommitOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `commentsForComparedCommitData`
        if (data['commentsForComparedCommitData']) { // data not null
          Array.validateJSON(data['commentsForComparedCommitData']);
        }
...
/**
 * @member {Array} commentsForComparedCommitData
 */
GetCommentsForComparedCommitOutput.prototype['commentsForComparedCommitData'] = undefined;

/**
 * @member {String} nextToken
 */
GetCommentsForComparedCommitOutput.prototype['nextToken'] = undefined;
...
export default GetCommentsForComparedCommitOutput;
