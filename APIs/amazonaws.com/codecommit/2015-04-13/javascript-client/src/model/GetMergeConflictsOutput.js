...
/**
 * The GetMergeConflictsOutput model module.
 * @module model/GetMergeConflictsOutput
 * @version 2015-04-13
 */
class GetMergeConflictsOutput {
    /**
     * Constructs a new <code>GetMergeConflictsOutput</code>.
     * @alias module:model/GetMergeConflictsOutput
     * @param mergeable {Boolean} 
     * @param destinationCommitId {String} 
     * @param sourceCommitId {String} 
     * @param conflictMetadataList {Array} 
     */
    constructor(mergeable, destinationCommitId, sourceCommitId, conflictMetadataList) { 
        
        GetMergeConflictsOutput.initialize(this, mergeable, destinationCommitId, sourceCommitId, conflictMetadataList);
    }
     ...
     */
    static initialize(obj, mergeable, destinationCommitId, sourceCommitId, conflictMetadataList) { 
        obj['mergeable'] = mergeable;
        obj['destinationCommitId'] = destinationCommitId;
        obj['sourceCommitId'] = sourceCommitId;
        obj['conflictMetadataList'] = conflictMetadataList;
    }

    /**
     * Constructs a <code>GetMergeConflictsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetMergeConflictsOutput} obj Optional instance to populate.
     * @return {module:model/GetMergeConflictsOutput} The populated <code>GetMergeConflictsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetMergeConflictsOutput();
            ...
            if (data.hasOwnProperty('conflictMetadataList')) {
                obj['conflictMetadataList'] = ApiClient.convertToType(data['conflictMetadataList'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetMergeConflictsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetMergeConflictsOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetMergeConflictsOutput.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `mergeable`
        if (data['mergeable']) { // data not null
          Boolean.validateJSON(data['mergeable']);
        }
        ...
        // validate the optional field `conflictMetadataList`
        if (data['conflictMetadataList']) { // data not null
          Array.validateJSON(data['conflictMetadataList']);
        }
...
GetMergeConflictsOutput.RequiredProperties = ["mergeable", "destinationCommitId", "sourceCommitId", "conflictMetadataList"];

/**
 * @member {Boolean} mergeable
 */
GetMergeConflictsOutput.prototype['mergeable'] = undefined;

/**
 * @member {String} destinationCommitId
 */
GetMergeConflictsOutput.prototype['destinationCommitId'] = undefined;

/**
 * @member {String} sourceCommitId
 */
GetMergeConflictsOutput.prototype['sourceCommitId'] = undefined;

/**
 * @member {String} baseCommitId
 */
GetMergeConflictsOutput.prototype['baseCommitId'] = undefined;

/**
 * @member {Array} conflictMetadataList
 */
GetMergeConflictsOutput.prototype['conflictMetadataList'] = undefined;

/**
 * @member {String} nextToken
 */
GetMergeConflictsOutput.prototype['nextToken'] = undefined;
...
export default GetMergeConflictsOutput;
