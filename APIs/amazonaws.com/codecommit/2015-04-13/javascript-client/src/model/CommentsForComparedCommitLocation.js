...
/**
 * The CommentsForComparedCommitLocation model module.
 * @module model/CommentsForComparedCommitLocation
 * @version 2015-04-13
 */
class CommentsForComparedCommitLocation {
    /**
     * Constructs a new <code>CommentsForComparedCommitLocation</code>.
     * @alias module:model/CommentsForComparedCommitLocation
     * @implements module:model/Location
     */
    constructor() { 
        Location.initialize(this);
        CommentsForComparedCommitLocation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CommentsForComparedCommitLocation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CommentsForComparedCommitLocation} obj Optional instance to populate.
     * @return {module:model/CommentsForComparedCommitLocation} The populated <code>CommentsForComparedCommitLocation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CommentsForComparedCommitLocation();
    ...
    /**
     * Validates the JSON data with respect to <code>CommentsForComparedCommitLocation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CommentsForComparedCommitLocation</code>.
     */
 ...
 */
CommentsForComparedCommitLocation.prototype['filePath'] = undefined;

/**
 * @member {Number} filePosition
 */
CommentsForComparedCommitLocation.prototype['filePosition'] = undefined;

/**
 * @member {module:model/RelativeFileVersionEnum} relativeFileVersion
 */
CommentsForComparedCommitLocation.prototype['relativeFileVersion'] = undefined;
...
export default CommentsForComparedCommitLocation;
