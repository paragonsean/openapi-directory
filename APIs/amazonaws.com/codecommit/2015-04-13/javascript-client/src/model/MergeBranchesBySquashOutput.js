...
/**
 * The MergeBranchesBySquashOutput model module.
 * @module model/MergeBranchesBySquashOutput
 * @version 2015-04-13
 */
class MergeBranchesBySquashOutput {
    /**
     * Constructs a new <code>MergeBranchesBySquashOutput</code>.
     * @alias module:model/MergeBranchesBySquashOutput
     */
    constructor() { 
        
        MergeBranchesBySquashOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MergeBranchesBySquashOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MergeBranchesBySquashOutput} obj Optional instance to populate.
     * @return {module:model/MergeBranchesBySquashOutput} The populated <code>MergeBranchesBySquashOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MergeBranchesBySquashOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>MergeBranchesBySquashOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MergeBranchesBySquashOutput</code>.
     */
 ...
 */
MergeBranchesBySquashOutput.prototype['commitId'] = undefined;

/**
 * @member {String} treeId
 */
MergeBranchesBySquashOutput.prototype['treeId'] = undefined;
...
export default MergeBranchesBySquashOutput;
