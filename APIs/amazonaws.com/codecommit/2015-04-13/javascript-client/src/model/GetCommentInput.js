...
/**
 * The GetCommentInput model module.
 * @module model/GetCommentInput
 * @version 2015-04-13
 */
class GetCommentInput {
    /**
     * Constructs a new <code>GetCommentInput</code>.
     * @alias module:model/GetCommentInput
     * @param commentId {String} 
     */
    constructor(commentId) { 
        
        GetCommentInput.initialize(this, commentId);
    }
    ...
    /**
     * Constructs a <code>GetCommentInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCommentInput} obj Optional instance to populate.
     * @return {module:model/GetCommentInput} The populated <code>GetCommentInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCommentInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetCommentInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCommentInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetCommentInput.RequiredProperties) {
...
GetCommentInput.RequiredProperties = ["commentId"];

/**
 * @member {String} commentId
 */
GetCommentInput.prototype['commentId'] = undefined;
...
export default GetCommentInput;
