...
import PostCommentForPullRequestOutputLocation from './PostCommentForPullRequestOutputLocation';

/**
 * The PostCommentForPullRequestOutput model module.
 * @module model/PostCommentForPullRequestOutput
 * @version 2015-04-13
 */
class PostCommentForPullRequestOutput {
    /**
     * Constructs a new <code>PostCommentForPullRequestOutput</code>.
     * @alias module:model/PostCommentForPullRequestOutput
     */
    constructor() { 
        
        PostCommentForPullRequestOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostCommentForPullRequestOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostCommentForPullRequestOutput} obj Optional instance to populate.
     * @return {module:model/PostCommentForPullRequestOutput} The populated <code>PostCommentForPullRequestOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostCommentForPullRequestOutput();
            ...
            if (data.hasOwnProperty('location')) {
                obj['location'] = PostCommentForPullRequestOutputLocation.constructFromObject(data['location']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PostCommentForPullRequestOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostCommentForPullRequestOutput</code>.
     */
    static validateJSON(data) {
        ...
        if (data['location']) { // data not null
          PostCommentForPullRequestOutputLocation.validateJSON(data['location']);
        }
 ...
 */
PostCommentForPullRequestOutput.prototype['repositoryName'] = undefined;

/**
 * @member {String} pullRequestId
 */
PostCommentForPullRequestOutput.prototype['pullRequestId'] = undefined;

/**
 * @member {String} beforeCommitId
 */
PostCommentForPullRequestOutput.prototype['beforeCommitId'] = undefined;

/**
 * @member {String} afterCommitId
 */
PostCommentForPullRequestOutput.prototype['afterCommitId'] = undefined;

/**
 * @member {String} beforeBlobId
 */
PostCommentForPullRequestOutput.prototype['beforeBlobId'] = undefined;

/**
 * @member {String} afterBlobId
 */
PostCommentForPullRequestOutput.prototype['afterBlobId'] = undefined;

/**
 * @member {module:model/PostCommentForPullRequestOutputLocation} location
 */
PostCommentForPullRequestOutput.prototype['location'] = undefined;

/**
 * @member {module:model/PostCommentForComparedCommitOutputComment} comment
 */
PostCommentForPullRequestOutput.prototype['comment'] = undefined;
...
export default PostCommentForPullRequestOutput;
