...
/**
 * The EvaluatePullRequestApprovalRulesOutputEvaluation model module.
 * @module model/EvaluatePullRequestApprovalRulesOutputEvaluation
 * @version 2015-04-13
 */
class EvaluatePullRequestApprovalRulesOutputEvaluation {
    /**
     * Constructs a new <code>EvaluatePullRequestApprovalRulesOutputEvaluation</code>.
     * @alias module:model/EvaluatePullRequestApprovalRulesOutputEvaluation
     * @implements module:model/Evaluation
     */
    constructor() { 
        Evaluation.initialize(this);
        EvaluatePullRequestApprovalRulesOutputEvaluation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EvaluatePullRequestApprovalRulesOutputEvaluation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EvaluatePullRequestApprovalRulesOutputEvaluation} obj Optional instance to populate.
     * @return {module:model/EvaluatePullRequestApprovalRulesOutputEvaluation} The populated <code>EvaluatePullRequestApprovalRulesOutputEvaluation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EvaluatePullRequestApprovalRulesOutputEvaluation();
    ...
    /**
     * Validates the JSON data with respect to <code>EvaluatePullRequestApprovalRulesOutputEvaluation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EvaluatePullRequestApprovalRulesOutputEvaluation</code>.
     */
 ...
 */
EvaluatePullRequestApprovalRulesOutputEvaluation.prototype['approved'] = undefined;

/**
 * @member {Boolean} overridden
 */
EvaluatePullRequestApprovalRulesOutputEvaluation.prototype['overridden'] = undefined;

/**
 * @member {Array} approvalRulesSatisfied
 */
EvaluatePullRequestApprovalRulesOutputEvaluation.prototype['approvalRulesSatisfied'] = undefined;

/**
 * @member {Array} approvalRulesNotSatisfied
 */
EvaluatePullRequestApprovalRulesOutputEvaluation.prototype['approvalRulesNotSatisfied'] = undefined;
...
export default EvaluatePullRequestApprovalRulesOutputEvaluation;
