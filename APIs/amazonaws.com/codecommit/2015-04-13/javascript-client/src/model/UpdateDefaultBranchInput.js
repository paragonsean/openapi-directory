...
/**
 * The UpdateDefaultBranchInput model module.
 * @module model/UpdateDefaultBranchInput
 * @version 2015-04-13
 */
class UpdateDefaultBranchInput {
    /**
     * Constructs a new <code>UpdateDefaultBranchInput</code>.
     * Represents the input of an update default branch operation.
     * @alias module:model/UpdateDefaultBranchInput
     * @param repositoryName {String} 
     * @param defaultBranchName {String} 
     */
    constructor(repositoryName, defaultBranchName) { 
        
        UpdateDefaultBranchInput.initialize(this, repositoryName, defaultBranchName);
    }
     ...
     */
    static initialize(obj, repositoryName, defaultBranchName) { 
        obj['repositoryName'] = repositoryName;
        obj['defaultBranchName'] = defaultBranchName;
    }

    /**
     * Constructs a <code>UpdateDefaultBranchInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateDefaultBranchInput} obj Optional instance to populate.
     * @return {module:model/UpdateDefaultBranchInput} The populated <code>UpdateDefaultBranchInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateDefaultBranchInput();

            if (data.hasOwnProperty('repositoryName')) {
                obj['repositoryName'] = ApiClient.convertToType(data['repositoryName'], 'String');
            }
            if (data.hasOwnProperty('defaultBranchName')) {
                obj['defaultBranchName'] = ApiClient.convertToType(data['defaultBranchName'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateDefaultBranchInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateDefaultBranchInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateDefaultBranchInput.RequiredProperties) {
        ...
        // validate the optional field `defaultBranchName`
        if (data['defaultBranchName']) { // data not null
          String.validateJSON(data['defaultBranchName']);
        }
...
UpdateDefaultBranchInput.RequiredProperties = ["repositoryName", "defaultBranchName"];

/**
 * @member {String} repositoryName
 */
UpdateDefaultBranchInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} defaultBranchName
 */
UpdateDefaultBranchInput.prototype['defaultBranchName'] = undefined;
...
export default UpdateDefaultBranchInput;
