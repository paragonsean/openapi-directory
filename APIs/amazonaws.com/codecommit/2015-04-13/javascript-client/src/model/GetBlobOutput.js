...
/**
 * The GetBlobOutput model module.
 * @module model/GetBlobOutput
 * @version 2015-04-13
 */
class GetBlobOutput {
    /**
     * Constructs a new <code>GetBlobOutput</code>.
     * Represents the output of a get blob operation.
     * @alias module:model/GetBlobOutput
     * @param content {String} 
     */
    constructor(content) { 
        
        GetBlobOutput.initialize(this, content);
    }
    ...
    /**
     * Constructs a <code>GetBlobOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetBlobOutput} obj Optional instance to populate.
     * @return {module:model/GetBlobOutput} The populated <code>GetBlobOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetBlobOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetBlobOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBlobOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetBlobOutput.RequiredProperties) {
...
GetBlobOutput.RequiredProperties = ["content"];

/**
 * @member {String} content
 */
GetBlobOutput.prototype['content'] = undefined;
