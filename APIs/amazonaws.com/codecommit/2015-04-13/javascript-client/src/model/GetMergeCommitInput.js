...
/**
 * The GetMergeCommitInput model module.
 * @module model/GetMergeCommitInput
 * @version 2015-04-13
 */
class GetMergeCommitInput {
    /**
     * Constructs a new <code>GetMergeCommitInput</code>.
     * @alias module:model/GetMergeCommitInput
    ...
    constructor(repositoryName, sourceCommitSpecifier, destinationCommitSpecifier) { 
        ...
        GetMergeCommitInput.initialize(this, repositoryName, sourceCommitSpecifier, destinationCommitSpecifier);
    }
    ...
    /**
     * Constructs a <code>GetMergeCommitInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetMergeCommitInput} obj Optional instance to populate.
     * @return {module:model/GetMergeCommitInput} The populated <code>GetMergeCommitInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetMergeCommitInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetMergeCommitInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetMergeCommitInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetMergeCommitInput.RequiredProperties) {
...
GetMergeCommitInput.RequiredProperties = ["repositoryName", "sourceCommitSpecifier", "destinationCommitSpecifier"];

/**
 * @member {String} repositoryName
 */
GetMergeCommitInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} sourceCommitSpecifier
 */
GetMergeCommitInput.prototype['sourceCommitSpecifier'] = undefined;

/**
 * @member {String} destinationCommitSpecifier
 */
GetMergeCommitInput.prototype['destinationCommitSpecifier'] = undefined;

/**
 * @member {module:model/ConflictDetailLevelTypeEnum} conflictDetailLevel
 */
GetMergeCommitInput.prototype['conflictDetailLevel'] = undefined;

/**
 * @member {module:model/ConflictResolutionStrategyTypeEnum} conflictResolutionStrategy
 */
GetMergeCommitInput.prototype['conflictResolutionStrategy'] = undefined;
...
export default GetMergeCommitInput;
