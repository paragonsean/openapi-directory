...
import CommentsForComparedCommitLocation from './CommentsForComparedCommitLocation';

/**
 * The CommentsForComparedCommit model module.
 * @module model/CommentsForComparedCommit
 * @version 2015-04-13
 */
class CommentsForComparedCommit {
    /**
     * Constructs a new <code>CommentsForComparedCommit</code>.
     * Returns information about comments on the comparison between two commits.
     * @alias module:model/CommentsForComparedCommit
     */
    constructor() { 
        
        CommentsForComparedCommit.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CommentsForComparedCommit</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CommentsForComparedCommit} obj Optional instance to populate.
     * @return {module:model/CommentsForComparedCommit} The populated <code>CommentsForComparedCommit</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CommentsForComparedCommit();
            ...
            if (data.hasOwnProperty('location')) {
                obj['location'] = CommentsForComparedCommitLocation.constructFromObject(data['location']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CommentsForComparedCommit</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CommentsForComparedCommit</code>.
     */
    static validateJSON(data) {
        ...
        if (data['location']) { // data not null
          CommentsForComparedCommitLocation.validateJSON(data['location']);
        }
 ...
 */
CommentsForComparedCommit.prototype['repositoryName'] = undefined;

/**
 * @member {String} beforeCommitId
 */
CommentsForComparedCommit.prototype['beforeCommitId'] = undefined;

/**
 * @member {String} afterCommitId
 */
CommentsForComparedCommit.prototype['afterCommitId'] = undefined;

/**
 * @member {String} beforeBlobId
 */
CommentsForComparedCommit.prototype['beforeBlobId'] = undefined;

/**
 * @member {String} afterBlobId
 */
CommentsForComparedCommit.prototype['afterBlobId'] = undefined;

/**
 * @member {module:model/CommentsForComparedCommitLocation} location
 */
CommentsForComparedCommit.prototype['location'] = undefined;

/**
 * @member {Array} comments
 */
CommentsForComparedCommit.prototype['comments'] = undefined;
...
export default CommentsForComparedCommit;
