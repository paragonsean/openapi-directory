...
import UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate from './UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate';

/**
 * The UpdateApprovalRuleTemplateDescriptionOutput model module.
 * @module model/UpdateApprovalRuleTemplateDescriptionOutput
 * @version 2015-04-13
 */
class UpdateApprovalRuleTemplateDescriptionOutput {
    /**
     * Constructs a new <code>UpdateApprovalRuleTemplateDescriptionOutput</code>.
     * @alias module:model/UpdateApprovalRuleTemplateDescriptionOutput
     * @param approvalRuleTemplate {module:model/UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate} 
     */
    constructor(approvalRuleTemplate) { 
        
        UpdateApprovalRuleTemplateDescriptionOutput.initialize(this, approvalRuleTemplate);
    }
     ...
     */
    static initialize(obj, approvalRuleTemplate) { 
        obj['approvalRuleTemplate'] = approvalRuleTemplate;
    }

    /**
     * Constructs a <code>UpdateApprovalRuleTemplateDescriptionOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateApprovalRuleTemplateDescriptionOutput} obj Optional instance to populate.
     * @return {module:model/UpdateApprovalRuleTemplateDescriptionOutput} The populated <code>UpdateApprovalRuleTemplateDescriptionOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateApprovalRuleTemplateDescriptionOutput();

            if (data.hasOwnProperty('approvalRuleTemplate')) {
                obj['approvalRuleTemplate'] = UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate.constructFromObject(data['approvalRuleTemplate']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateApprovalRuleTemplateDescriptionOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateApprovalRuleTemplateDescriptionOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateApprovalRuleTemplateDescriptionOutput.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `approvalRuleTemplate`
        if (data['approvalRuleTemplate']) { // data not null
          UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate.validateJSON(data['approvalRuleTemplate']);
        }
...
UpdateApprovalRuleTemplateDescriptionOutput.RequiredProperties = ["approvalRuleTemplate"];

/**
 * @member {module:model/UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate} approvalRuleTemplate
 */
UpdateApprovalRuleTemplateDescriptionOutput.prototype['approvalRuleTemplate'] = undefined;
...
export default UpdateApprovalRuleTemplateDescriptionOutput;
