...
/**
 * The BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput model module.
 * @module model/BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput
 * @version 2015-04-13
 */
class BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput {
    /**
     * Constructs a new <code>BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput</code>.
     * @alias module:model/BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput
     * @param disassociatedRepositoryNames {Array} 
     * @param errors {Array} 
     */
    constructor(disassociatedRepositoryNames, errors) { 
        
        BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput.initialize(this, disassociatedRepositoryNames, errors);
    }
     ...
     */
    static initialize(obj, disassociatedRepositoryNames, errors) { 
        obj['disassociatedRepositoryNames'] = disassociatedRepositoryNames;
        obj['errors'] = errors;
    }

    /**
     * Constructs a <code>BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput} obj Optional instance to populate.
     * @return {module:model/BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput} The populated <code>BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput();

            if (data.hasOwnProperty('disassociatedRepositoryNames')) {
                obj['disassociatedRepositoryNames'] = ApiClient.convertToType(data['disassociatedRepositoryNames'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `disassociatedRepositoryNames`
        if (data['disassociatedRepositoryNames']) { // data not null
          Array.validateJSON(data['disassociatedRepositoryNames']);
        }
...
BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput.RequiredProperties = ["disassociatedRepositoryNames", "errors"];

/**
 * @member {Array} disassociatedRepositoryNames
 */
BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput.prototype['disassociatedRepositoryNames'] = undefined;

/**
 * @member {Array} errors
 */
BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput.prototype['errors'] = undefined;
...
export default BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput;
