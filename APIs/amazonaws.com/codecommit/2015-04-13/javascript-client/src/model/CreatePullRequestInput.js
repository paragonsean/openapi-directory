...
/**
 * The CreatePullRequestInput model module.
 * @module model/CreatePullRequestInput
 * @version 2015-04-13
 */
class CreatePullRequestInput {
    /**
     * Constructs a new <code>CreatePullRequestInput</code>.
     * @alias module:model/CreatePullRequestInput
     * @param title {String} 
     * @param targets {Array} 
     */
    constructor(title, targets) { 
        
        CreatePullRequestInput.initialize(this, title, targets);
    }
     ...
     */
    static initialize(obj, title, targets) { 
        obj['title'] = title;
        obj['targets'] = targets;
    }

    /**
     * Constructs a <code>CreatePullRequestInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePullRequestInput} obj Optional instance to populate.
     * @return {module:model/CreatePullRequestInput} The populated <code>CreatePullRequestInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePullRequestInput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePullRequestInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePullRequestInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreatePullRequestInput.RequiredProperties) {
...
CreatePullRequestInput.RequiredProperties = ["title", "targets"];

/**
 * @member {String} title
 */
CreatePullRequestInput.prototype['title'] = undefined;

/**
 * @member {String} description
 */
CreatePullRequestInput.prototype['description'] = undefined;

/**
 * @member {Array} targets
 */
CreatePullRequestInput.prototype['targets'] = undefined;

/**
 * @member {String} clientRequestToken
 */
CreatePullRequestInput.prototype['clientRequestToken'] = undefined;
...
export default CreatePullRequestInput;
