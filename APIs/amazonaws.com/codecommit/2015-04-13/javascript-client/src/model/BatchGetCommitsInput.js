...
/**
 * The BatchGetCommitsInput model module.
 * @module model/BatchGetCommitsInput
 * @version 2015-04-13
 */
class BatchGetCommitsInput {
    /**
     * Constructs a new <code>BatchGetCommitsInput</code>.
     * @alias module:model/BatchGetCommitsInput
     * @param commitIds {Array} 
     * @param repositoryName {String} 
     */
    constructor(commitIds, repositoryName) { 
        
        BatchGetCommitsInput.initialize(this, commitIds, repositoryName);
    }
     ...
     */
    static initialize(obj, commitIds, repositoryName) { 
        obj['commitIds'] = commitIds;
        obj['repositoryName'] = repositoryName;
    }

    /**
     * Constructs a <code>BatchGetCommitsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchGetCommitsInput} obj Optional instance to populate.
     * @return {module:model/BatchGetCommitsInput} The populated <code>BatchGetCommitsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchGetCommitsInput();

            if (data.hasOwnProperty('commitIds')) {
                obj['commitIds'] = ApiClient.convertToType(data['commitIds'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>BatchGetCommitsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchGetCommitsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BatchGetCommitsInput.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `commitIds`
        if (data['commitIds']) { // data not null
          Array.validateJSON(data['commitIds']);
        }
...
BatchGetCommitsInput.RequiredProperties = ["commitIds", "repositoryName"];

/**
 * @member {Array} commitIds
 */
BatchGetCommitsInput.prototype['commitIds'] = undefined;

/**
 * @member {String} repositoryName
 */
BatchGetCommitsInput.prototype['repositoryName'] = undefined;
...
export default BatchGetCommitsInput;
