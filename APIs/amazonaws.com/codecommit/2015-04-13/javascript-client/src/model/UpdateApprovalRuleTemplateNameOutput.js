...
/**
 * The UpdateApprovalRuleTemplateNameOutput model module.
 * @module model/UpdateApprovalRuleTemplateNameOutput
 * @version 2015-04-13
 */
class UpdateApprovalRuleTemplateNameOutput {
    /**
     * Constructs a new <code>UpdateApprovalRuleTemplateNameOutput</code>.
     * @alias module:model/UpdateApprovalRuleTemplateNameOutput
    ...
    constructor(approvalRuleTemplate) { 
        ...
        UpdateApprovalRuleTemplateNameOutput.initialize(this, approvalRuleTemplate);
    }
    ...
    /**
     * Constructs a <code>UpdateApprovalRuleTemplateNameOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateApprovalRuleTemplateNameOutput} obj Optional instance to populate.
     * @return {module:model/UpdateApprovalRuleTemplateNameOutput} The populated <code>UpdateApprovalRuleTemplateNameOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateApprovalRuleTemplateNameOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateApprovalRuleTemplateNameOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateApprovalRuleTemplateNameOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateApprovalRuleTemplateNameOutput.RequiredProperties) {
...
UpdateApprovalRuleTemplateNameOutput.RequiredProperties = ["approvalRuleTemplate"];

/**
 * @member {module:model/UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate} approvalRuleTemplate
 */
UpdateApprovalRuleTemplateNameOutput.prototype['approvalRuleTemplate'] = undefined;
...
export default UpdateApprovalRuleTemplateNameOutput;
