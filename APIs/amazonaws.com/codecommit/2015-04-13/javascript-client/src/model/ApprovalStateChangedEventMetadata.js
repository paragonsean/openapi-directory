...
/**
 * The ApprovalStateChangedEventMetadata model module.
 * @module model/ApprovalStateChangedEventMetadata
 * @version 2015-04-13
 */
class ApprovalStateChangedEventMetadata {
    /**
     * Constructs a new <code>ApprovalStateChangedEventMetadata</code>.
     * Returns information about a change in the approval state for a pull request.
     * @alias module:model/ApprovalStateChangedEventMetadata
     */
    constructor() { 
        
        ApprovalStateChangedEventMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApprovalStateChangedEventMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApprovalStateChangedEventMetadata} obj Optional instance to populate.
     * @return {module:model/ApprovalStateChangedEventMetadata} The populated <code>ApprovalStateChangedEventMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApprovalStateChangedEventMetadata();
            ...
            if (data.hasOwnProperty('approvalStatus')) {
                obj['approvalStatus'] = ApiClient.convertToType(data['approvalStatus'], ApprovalState);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApprovalStateChangedEventMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApprovalStateChangedEventMetadata</code>.
     */
    static validateJSON(data) {
        ...
        if (data['approvalStatus']) { // data not null
          ApprovalState.validateJSON(data['approvalStatus']);
        }
 ...
 */
ApprovalStateChangedEventMetadata.prototype['revisionId'] = undefined;

/**
 * @member {module:model/ApprovalState} approvalStatus
 */
ApprovalStateChangedEventMetadata.prototype['approvalStatus'] = undefined;
...
export default ApprovalStateChangedEventMetadata;
