...
/**
 * The GetFileInput model module.
 * @module model/GetFileInput
 * @version 2015-04-13
 */
class GetFileInput {
    /**
     * Constructs a new <code>GetFileInput</code>.
     * @alias module:model/GetFileInput
     * @param repositoryName {String} 
     * @param filePath {String} 
     */
    constructor(repositoryName, filePath) { 
        
        GetFileInput.initialize(this, repositoryName, filePath);
    }
     ...
     */
    static initialize(obj, repositoryName, filePath) { 
        obj['repositoryName'] = repositoryName;
        obj['filePath'] = filePath;
    }

    /**
     * Constructs a <code>GetFileInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetFileInput} obj Optional instance to populate.
     * @return {module:model/GetFileInput} The populated <code>GetFileInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetFileInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetFileInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetFileInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetFileInput.RequiredProperties) {
...
GetFileInput.RequiredProperties = ["repositoryName", "filePath"];

/**
 * @member {String} repositoryName
 */
GetFileInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} commitSpecifier
 */
GetFileInput.prototype['commitSpecifier'] = undefined;

/**
 * @member {String} filePath
 */
GetFileInput.prototype['filePath'] = undefined;
