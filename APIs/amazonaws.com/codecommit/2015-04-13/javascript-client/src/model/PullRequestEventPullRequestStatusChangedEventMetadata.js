...
/**
 * The PullRequestEventPullRequestStatusChangedEventMetadata model module.
 * @module model/PullRequestEventPullRequestStatusChangedEventMetadata
 * @version 2015-04-13
 */
class PullRequestEventPullRequestStatusChangedEventMetadata {
    /**
     * Constructs a new <code>PullRequestEventPullRequestStatusChangedEventMetadata</code>.
     * @alias module:model/PullRequestEventPullRequestStatusChangedEventMetadata
     * @implements module:model/PullRequestStatusChangedEventMetadata
     */
    constructor() { 
        PullRequestStatusChangedEventMetadata.initialize(this);
        PullRequestEventPullRequestStatusChangedEventMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PullRequestEventPullRequestStatusChangedEventMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PullRequestEventPullRequestStatusChangedEventMetadata} obj Optional instance to populate.
     * @return {module:model/PullRequestEventPullRequestStatusChangedEventMetadata} The populated <code>PullRequestEventPullRequestStatusChangedEventMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PullRequestEventPullRequestStatusChangedEventMetadata();
            PullRequestStatusChangedEventMetadata.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>PullRequestEventPullRequestStatusChangedEventMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PullRequestEventPullRequestStatusChangedEventMetadata</code>.
     */
 ...
 */
PullRequestEventPullRequestStatusChangedEventMetadata.prototype['pullRequestStatus'] = undefined;


// Implement PullRequestStatusChangedEventMetadata interface:
/**
 * @member {module:model/PullRequestStatusEnum} pullRequestStatus
 */
...
export default PullRequestEventPullRequestStatusChangedEventMetadata;
