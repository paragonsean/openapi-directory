...
/**
 * The UpdateApprovalRuleTemplateDescriptionInput model module.
 * @module model/UpdateApprovalRuleTemplateDescriptionInput
 * @version 2015-04-13
 */
class UpdateApprovalRuleTemplateDescriptionInput {
    /**
     * Constructs a new <code>UpdateApprovalRuleTemplateDescriptionInput</code>.
     * @alias module:model/UpdateApprovalRuleTemplateDescriptionInput
     * @param approvalRuleTemplateName {String} 
     * @param approvalRuleTemplateDescription {String} 
     */
    constructor(approvalRuleTemplateName, approvalRuleTemplateDescription) { 
        
        UpdateApprovalRuleTemplateDescriptionInput.initialize(this, approvalRuleTemplateName, approvalRuleTemplateDescription);
    }
     ...
     */
    static initialize(obj, approvalRuleTemplateName, approvalRuleTemplateDescription) { 
        obj['approvalRuleTemplateName'] = approvalRuleTemplateName;
        obj['approvalRuleTemplateDescription'] = approvalRuleTemplateDescription;
    }

    /**
     * Constructs a <code>UpdateApprovalRuleTemplateDescriptionInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateApprovalRuleTemplateDescriptionInput} obj Optional instance to populate.
     * @return {module:model/UpdateApprovalRuleTemplateDescriptionInput} The populated <code>UpdateApprovalRuleTemplateDescriptionInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateApprovalRuleTemplateDescriptionInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateApprovalRuleTemplateDescriptionInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateApprovalRuleTemplateDescriptionInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateApprovalRuleTemplateDescriptionInput.RequiredProperties) {
...
UpdateApprovalRuleTemplateDescriptionInput.RequiredProperties = ["approvalRuleTemplateName", "approvalRuleTemplateDescription"];

/**
 * @member {String} approvalRuleTemplateName
 */
UpdateApprovalRuleTemplateDescriptionInput.prototype['approvalRuleTemplateName'] = undefined;

/**
 * @member {String} approvalRuleTemplateDescription
 */
UpdateApprovalRuleTemplateDescriptionInput.prototype['approvalRuleTemplateDescription'] = undefined;
...
export default UpdateApprovalRuleTemplateDescriptionInput;
