...
/**
 * The CreateUnreferencedMergeCommitOutput model module.
 * @module model/CreateUnreferencedMergeCommitOutput
 * @version 2015-04-13
 */
class CreateUnreferencedMergeCommitOutput {
    /**
     * Constructs a new <code>CreateUnreferencedMergeCommitOutput</code>.
     * @alias module:model/CreateUnreferencedMergeCommitOutput
     */
    constructor() { 
        
        CreateUnreferencedMergeCommitOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateUnreferencedMergeCommitOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateUnreferencedMergeCommitOutput} obj Optional instance to populate.
     * @return {module:model/CreateUnreferencedMergeCommitOutput} The populated <code>CreateUnreferencedMergeCommitOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateUnreferencedMergeCommitOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateUnreferencedMergeCommitOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateUnreferencedMergeCommitOutput</code>.
     */
 ...
 */
CreateUnreferencedMergeCommitOutput.prototype['commitId'] = undefined;

/**
 * @member {String} treeId
 */
CreateUnreferencedMergeCommitOutput.prototype['treeId'] = undefined;
...
export default CreateUnreferencedMergeCommitOutput;
