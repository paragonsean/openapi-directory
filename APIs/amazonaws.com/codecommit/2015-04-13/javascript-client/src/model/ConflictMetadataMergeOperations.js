...
/**
 * The ConflictMetadataMergeOperations model module.
 * @module model/ConflictMetadataMergeOperations
 * @version 2015-04-13
 */
class ConflictMetadataMergeOperations {
    /**
     * Constructs a new <code>ConflictMetadataMergeOperations</code>.
     * @alias module:model/ConflictMetadataMergeOperations
     * @implements module:model/MergeOperations
     */
    constructor() { 
        MergeOperations.initialize(this);
        ConflictMetadataMergeOperations.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ConflictMetadataMergeOperations</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConflictMetadataMergeOperations} obj Optional instance to populate.
     * @return {module:model/ConflictMetadataMergeOperations} The populated <code>ConflictMetadataMergeOperations</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConflictMetadataMergeOperations();
            MergeOperations.constructFromObject(data, obj);

            if (data.hasOwnProperty('source')) {
                obj['source'] = ApiClient.convertToType(data['source'], ChangeTypeEnum);
            }
            if (data.hasOwnProperty('destination')) {
                obj['destination'] = ApiClient.convertToType(data['destination'], ChangeTypeEnum);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ConflictMetadataMergeOperations</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConflictMetadataMergeOperations</code>.
     */
    static validateJSON(data) {
        // validate the optional field `source`
        if (data['source']) { // data not null
          ChangeTypeEnum.validateJSON(data['source']);
        }
        // validate the optional field `destination`
        if (data['destination']) { // data not null
          ChangeTypeEnum.validateJSON(data['destination']);
        }
...
/**
 * @member {module:model/ChangeTypeEnum} source
 */
ConflictMetadataMergeOperations.prototype['source'] = undefined;

/**
 * @member {module:model/ChangeTypeEnum} destination
 */
ConflictMetadataMergeOperations.prototype['destination'] = undefined;


// Implement MergeOperations interface:
/**
 * @member {module:model/ChangeTypeEnum} source
 */
MergeOperations.prototype['source'] = undefined;
/**
 * @member {module:model/ChangeTypeEnum} destination
 */
MergeOperations.prototype['destination'] = undefined;




export default ConflictMetadataMergeOperations;
