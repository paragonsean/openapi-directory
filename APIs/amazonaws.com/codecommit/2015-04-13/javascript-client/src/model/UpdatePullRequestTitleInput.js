...
/**
 * The UpdatePullRequestTitleInput model module.
 * @module model/UpdatePullRequestTitleInput
 * @version 2015-04-13
 */
class UpdatePullRequestTitleInput {
    /**
     * Constructs a new <code>UpdatePullRequestTitleInput</code>.
     * @alias module:model/UpdatePullRequestTitleInput
     * @param pullRequestId {String} 
     * @param title {String} 
     */
    constructor(pullRequestId, title) { 
        
        UpdatePullRequestTitleInput.initialize(this, pullRequestId, title);
    }
     ...
     */
    static initialize(obj, pullRequestId, title) { 
        obj['pullRequestId'] = pullRequestId;
        obj['title'] = title;
    }

    /**
     * Constructs a <code>UpdatePullRequestTitleInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePullRequestTitleInput} obj Optional instance to populate.
     * @return {module:model/UpdatePullRequestTitleInput} The populated <code>UpdatePullRequestTitleInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePullRequestTitleInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePullRequestTitleInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePullRequestTitleInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdatePullRequestTitleInput.RequiredProperties) {
...
UpdatePullRequestTitleInput.RequiredProperties = ["pullRequestId", "title"];

/**
 * @member {String} pullRequestId
 */
UpdatePullRequestTitleInput.prototype['pullRequestId'] = undefined;

/**
 * @member {String} title
 */
UpdatePullRequestTitleInput.prototype['title'] = undefined;
...
export default UpdatePullRequestTitleInput;
