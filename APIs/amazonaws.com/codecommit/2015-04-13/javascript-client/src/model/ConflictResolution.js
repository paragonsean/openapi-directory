...
/**
 * The ConflictResolution model module.
 * @module model/ConflictResolution
 * @version 2015-04-13
 */
class ConflictResolution {
    /**
     * Constructs a new <code>ConflictResolution</code>.
     * If AUTOMERGE is the conflict resolution strategy, a list of inputs to use when resolving conflicts during a merge.
     * @alias module:model/ConflictResolution
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ConflictResolution</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConflictResolution} obj Optional instance to populate.
     * @return {module:model/ConflictResolution} The populated <code>ConflictResolution</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConflictResolution();
    ...
    /**
     * Validates the JSON data with respect to <code>ConflictResolution</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConflictResolution</code>.
     */
