...
/**
 * The ConflictMetadataFileModes model module.
 * @module model/ConflictMetadataFileModes
 * @version 2015-04-13
 */
class ConflictMetadataFileModes {
    /**
     * Constructs a new <code>ConflictMetadataFileModes</code>.
     * @alias module:model/ConflictMetadataFileModes
     * @implements module:model/FileModes
     */
    constructor() { 
        FileModes.initialize(this);
        ConflictMetadataFileModes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ConflictMetadataFileModes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConflictMetadataFileModes} obj Optional instance to populate.
     * @return {module:model/ConflictMetadataFileModes} The populated <code>ConflictMetadataFileModes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConflictMetadataFileModes();
            FileModes.constructFromObject(data, obj);

            if (data.hasOwnProperty('source')) {
                obj['source'] = ApiClient.convertToType(data['source'], FileModeTypeEnum);
            }
            if (data.hasOwnProperty('destination')) {
                obj['destination'] = ApiClient.convertToType(data['destination'], FileModeTypeEnum);
            }
            if (data.hasOwnProperty('base')) {
                obj['base'] = ApiClient.convertToType(data['base'], FileModeTypeEnum);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ConflictMetadataFileModes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConflictMetadataFileModes</code>.
     */
    static validateJSON(data) {
        // validate the optional field `source`
        if (data['source']) { // data not null
          FileModeTypeEnum.validateJSON(data['source']);
        }
        // validate the optional field `destination`
        if (data['destination']) { // data not null
          FileModeTypeEnum.validateJSON(data['destination']);
        }
        // validate the optional field `base`
        if (data['base']) { // data not null
          FileModeTypeEnum.validateJSON(data['base']);
        }
...
/**
 * @member {module:model/FileModeTypeEnum} source
 */
ConflictMetadataFileModes.prototype['source'] = undefined;

/**
 * @member {module:model/FileModeTypeEnum} destination
 */
ConflictMetadataFileModes.prototype['destination'] = undefined;

/**
 * @member {module:model/FileModeTypeEnum} base
 */
ConflictMetadataFileModes.prototype['base'] = undefined;


// Implement FileModes interface:
/**
 * @member {module:model/FileModeTypeEnum} source
 */
FileModes.prototype['source'] = undefined;
/**
 * @member {module:model/FileModeTypeEnum} destination
 */
FileModes.prototype['destination'] = undefined;
/**
 * @member {module:model/FileModeTypeEnum} base
 */
FileModes.prototype['base'] = undefined;




export default ConflictMetadataFileModes;
