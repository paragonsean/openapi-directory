...
/**
 * The GetDifferencesInput model module.
 * @module model/GetDifferencesInput
 * @version 2015-04-13
 */
class GetDifferencesInput {
    /**
     * Constructs a new <code>GetDifferencesInput</code>.
     * @alias module:model/GetDifferencesInput
     * @param repositoryName {String} 
     * @param afterCommitSpecifier {String} 
     */
    constructor(repositoryName, afterCommitSpecifier) { 
        
        GetDifferencesInput.initialize(this, repositoryName, afterCommitSpecifier);
    }
     ...
     */
    static initialize(obj, repositoryName, afterCommitSpecifier) { 
        obj['repositoryName'] = repositoryName;
        obj['afterCommitSpecifier'] = afterCommitSpecifier;
    }

    /**
     * Constructs a <code>GetDifferencesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetDifferencesInput} obj Optional instance to populate.
     * @return {module:model/GetDifferencesInput} The populated <code>GetDifferencesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDifferencesInput();

            if (data.hasOwnProperty('repositoryName')) {
                obj['repositoryName'] = ApiClient.convertToType(data['repositoryName'], 'String');
            }
            if (data.hasOwnProperty('beforeCommitSpecifier')) {
                obj['beforeCommitSpecifier'] = ApiClient.convertToType(data['beforeCommitSpecifier'], 'String');
            }
            if (data.hasOwnProperty('afterCommitSpecifier')) {
                obj['afterCommitSpecifier'] = ApiClient.convertToType(data['afterCommitSpecifier'], 'String');
            }
            if (data.hasOwnProperty('beforePath')) {
                obj['beforePath'] = ApiClient.convertToType(data['beforePath'], 'String');
            }
            if (data.hasOwnProperty('afterPath')) {
                obj['afterPath'] = ApiClient.convertToType(data['afterPath'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetDifferencesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDifferencesInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetDifferencesInput.RequiredProperties) {
        ...
        // validate the optional field `beforeCommitSpecifier`
        if (data['beforeCommitSpecifier']) { // data not null
          String.validateJSON(data['beforeCommitSpecifier']);
        }
        // validate the optional field `afterCommitSpecifier`
        if (data['afterCommitSpecifier']) { // data not null
          String.validateJSON(data['afterCommitSpecifier']);
        }
        // validate the optional field `beforePath`
        if (data['beforePath']) { // data not null
          String.validateJSON(data['beforePath']);
        }
        // validate the optional field `afterPath`
        if (data['afterPath']) { // data not null
          String.validateJSON(data['afterPath']);
        }
...
GetDifferencesInput.RequiredProperties = ["repositoryName", "afterCommitSpecifier"];

/**
 * @member {String} repositoryName
 */
GetDifferencesInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} beforeCommitSpecifier
 */
GetDifferencesInput.prototype['beforeCommitSpecifier'] = undefined;

/**
 * @member {String} afterCommitSpecifier
 */
GetDifferencesInput.prototype['afterCommitSpecifier'] = undefined;

/**
 * @member {String} beforePath
 */
GetDifferencesInput.prototype['beforePath'] = undefined;

/**
 * @member {String} afterPath
 */
GetDifferencesInput.prototype['afterPath'] = undefined;

/**
 * @member {Number} MaxResults
 */
GetDifferencesInput.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
GetDifferencesInput.prototype['NextToken'] = undefined;
...
export default GetDifferencesInput;
