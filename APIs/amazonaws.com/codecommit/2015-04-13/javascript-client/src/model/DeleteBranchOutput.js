...
import DeleteBranchOutputDeletedBranch from './DeleteBranchOutputDeletedBranch';

/**
 * The DeleteBranchOutput model module.
 * @module model/DeleteBranchOutput
 * @version 2015-04-13
 */
class DeleteBranchOutput {
    /**
     * Constructs a new <code>DeleteBranchOutput</code>.
     * Represents the output of a delete branch operation.
     * @alias module:model/DeleteBranchOutput
     */
    constructor() { 
        
        DeleteBranchOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteBranchOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteBranchOutput} obj Optional instance to populate.
     * @return {module:model/DeleteBranchOutput} The populated <code>DeleteBranchOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteBranchOutput();

            if (data.hasOwnProperty('deletedBranch')) {
                obj['deletedBranch'] = DeleteBranchOutputDeletedBranch.constructFromObject(data['deletedBranch']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteBranchOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteBranchOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `deletedBranch`
        if (data['deletedBranch']) { // data not null
          DeleteBranchOutputDeletedBranch.validateJSON(data['deletedBranch']);
        }
...
/**
 * @member {module:model/DeleteBranchOutputDeletedBranch} deletedBranch
 */
DeleteBranchOutput.prototype['deletedBranch'] = undefined;
...
export default DeleteBranchOutput;
