...
import MergePullRequestByFastForwardOutputPullRequest from './MergePullRequestByFastForwardOutputPullRequest';

/**
 * The MergePullRequestByFastForwardOutput model module.
 * @module model/MergePullRequestByFastForwardOutput
 * @version 2015-04-13
 */
class MergePullRequestByFastForwardOutput {
    /**
     * Constructs a new <code>MergePullRequestByFastForwardOutput</code>.
     * @alias module:model/MergePullRequestByFastForwardOutput
     */
    constructor() { 
        
        MergePullRequestByFastForwardOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MergePullRequestByFastForwardOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MergePullRequestByFastForwardOutput} obj Optional instance to populate.
     * @return {module:model/MergePullRequestByFastForwardOutput} The populated <code>MergePullRequestByFastForwardOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MergePullRequestByFastForwardOutput();

            if (data.hasOwnProperty('pullRequest')) {
                obj['pullRequest'] = MergePullRequestByFastForwardOutputPullRequest.constructFromObject(data['pullRequest']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MergePullRequestByFastForwardOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MergePullRequestByFastForwardOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `pullRequest`
        if (data['pullRequest']) { // data not null
          MergePullRequestByFastForwardOutputPullRequest.validateJSON(data['pullRequest']);
        }
...
/**
 * @member {module:model/MergePullRequestByFastForwardOutputPullRequest} pullRequest
 */
MergePullRequestByFastForwardOutput.prototype['pullRequest'] = undefined;
...
export default MergePullRequestByFastForwardOutput;
