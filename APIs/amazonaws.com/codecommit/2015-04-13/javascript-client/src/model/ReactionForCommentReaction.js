...
/**
 * The ReactionForCommentReaction model module.
 * @module model/ReactionForCommentReaction
 * @version 2015-04-13
 */
class ReactionForCommentReaction {
    /**
     * Constructs a new <code>ReactionForCommentReaction</code>.
     * @alias module:model/ReactionForCommentReaction
     * @implements module:model/ReactionValueFormats
     */
    constructor() { 
        ReactionValueFormats.initialize(this);
        ReactionForCommentReaction.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ReactionForCommentReaction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReactionForCommentReaction} obj Optional instance to populate.
     * @return {module:model/ReactionForCommentReaction} The populated <code>ReactionForCommentReaction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReactionForCommentReaction();
            ReactionValueFormats.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ReactionForCommentReaction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReactionForCommentReaction</code>.
     */
 ...
 * @member {String} emoji
 */
ReactionForCommentReaction.prototype['emoji'] = undefined;

/**
 * @member {String} shortCode
 */
ReactionForCommentReaction.prototype['shortCode'] = undefined;

/**
 * @member {String} unicode
 */
ReactionForCommentReaction.prototype['unicode'] = undefined;


// Implement ReactionValueFormats interface:
/**
 * @member {String} emoji
 */
...
export default ReactionForCommentReaction;
