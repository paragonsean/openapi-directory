...
/**
 * The OriginApprovalRuleTemplate model module.
 * @module model/OriginApprovalRuleTemplate
 * @version 2015-04-13
 */
class OriginApprovalRuleTemplate {
    /**
     * Constructs a new <code>OriginApprovalRuleTemplate</code>.
     * Returns information about the template that created the approval rule for a pull request.
     * @alias module:model/OriginApprovalRuleTemplate
     */
    constructor() { 
        
        OriginApprovalRuleTemplate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OriginApprovalRuleTemplate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OriginApprovalRuleTemplate} obj Optional instance to populate.
     * @return {module:model/OriginApprovalRuleTemplate} The populated <code>OriginApprovalRuleTemplate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OriginApprovalRuleTemplate();
    ...
    /**
     * Validates the JSON data with respect to <code>OriginApprovalRuleTemplate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OriginApprovalRuleTemplate</code>.
     */
 ...
 */
OriginApprovalRuleTemplate.prototype['approvalRuleTemplateId'] = undefined;

/**
 * @member {String} approvalRuleTemplateName
 */
OriginApprovalRuleTemplate.prototype['approvalRuleTemplateName'] = undefined;
...
export default OriginApprovalRuleTemplate;
