...
/**
 * The PullRequestMergedStateChangedEventMetadata model module.
 * @module model/PullRequestMergedStateChangedEventMetadata
 * @version 2015-04-13
 */
class PullRequestMergedStateChangedEventMetadata {
    /**
     * Constructs a new <code>PullRequestMergedStateChangedEventMetadata</code>.
     * Returns information about the change in the merge state for a pull request event. 
     * @alias module:model/PullRequestMergedStateChangedEventMetadata
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>PullRequestMergedStateChangedEventMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PullRequestMergedStateChangedEventMetadata} obj Optional instance to populate.
     * @return {module:model/PullRequestMergedStateChangedEventMetadata} The populated <code>PullRequestMergedStateChangedEventMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PullRequestMergedStateChangedEventMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>PullRequestMergedStateChangedEventMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PullRequestMergedStateChangedEventMetadata</code>.
     */
...
export default PullRequestMergedStateChangedEventMetadata;
