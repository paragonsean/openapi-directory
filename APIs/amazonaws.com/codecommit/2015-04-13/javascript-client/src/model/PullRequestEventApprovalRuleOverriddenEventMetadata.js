...
/**
 * The PullRequestEventApprovalRuleOverriddenEventMetadata model module.
 * @module model/PullRequestEventApprovalRuleOverriddenEventMetadata
 * @version 2015-04-13
 */
class PullRequestEventApprovalRuleOverriddenEventMetadata {
    /**
     * Constructs a new <code>PullRequestEventApprovalRuleOverriddenEventMetadata</code>.
     * @alias module:model/PullRequestEventApprovalRuleOverriddenEventMetadata
     * @implements module:model/ApprovalRuleOverriddenEventMetadata
     */
    constructor() { 
        ApprovalRuleOverriddenEventMetadata.initialize(this);
        PullRequestEventApprovalRuleOverriddenEventMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PullRequestEventApprovalRuleOverriddenEventMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PullRequestEventApprovalRuleOverriddenEventMetadata} obj Optional instance to populate.
     * @return {module:model/PullRequestEventApprovalRuleOverriddenEventMetadata} The populated <code>PullRequestEventApprovalRuleOverriddenEventMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PullRequestEventApprovalRuleOverriddenEventMetadata();
            ApprovalRuleOverriddenEventMetadata.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>PullRequestEventApprovalRuleOverriddenEventMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PullRequestEventApprovalRuleOverriddenEventMetadata</code>.
     */
 ...
 */
PullRequestEventApprovalRuleOverriddenEventMetadata.prototype['revisionId'] = undefined;

/**
 * @member {module:model/OverrideStatus} overrideStatus
 */
PullRequestEventApprovalRuleOverriddenEventMetadata.prototype['overrideStatus'] = undefined;


// Implement ApprovalRuleOverriddenEventMetadata interface:
/**
 * @member {String} revisionId
 */
...
export default PullRequestEventApprovalRuleOverriddenEventMetadata;
