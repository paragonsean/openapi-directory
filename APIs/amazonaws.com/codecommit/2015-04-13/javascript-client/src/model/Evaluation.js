...
class Evaluation {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('approvalRulesSatisfied')) {
                obj['approvalRulesSatisfied'] = ApiClient.convertToType(data['approvalRulesSatisfied'], Array);
            }
            if (data.hasOwnProperty('approvalRulesNotSatisfied')) {
                obj['approvalRulesNotSatisfied'] = ApiClient.convertToType(data['approvalRulesNotSatisfied'], Array);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['approved']) { // data not null
          Boolean.validateJSON(data['approved']);
        }
        ...
        if (data['approvalRulesSatisfied']) { // data not null
          Array.validateJSON(data['approvalRulesSatisfied']);
        }
        // validate the optional field `approvalRulesNotSatisfied`
        if (data['approvalRulesNotSatisfied']) { // data not null
          Array.validateJSON(data['approvalRulesNotSatisfied']);
        }
 ...
 */
Evaluation.prototype['approved'] = undefined;

/**
 * @member {Boolean} overridden
 */
Evaluation.prototype['overridden'] = undefined;

/**
 * @member {Array} approvalRulesSatisfied
 */
Evaluation.prototype['approvalRulesSatisfied'] = undefined;

/**
 * @member {Array} approvalRulesNotSatisfied
 */
Evaluation.prototype['approvalRulesNotSatisfied'] = undefined;
