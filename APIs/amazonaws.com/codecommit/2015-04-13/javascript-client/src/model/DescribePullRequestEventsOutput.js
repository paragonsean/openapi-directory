...
/**
 * The DescribePullRequestEventsOutput model module.
 * @module model/DescribePullRequestEventsOutput
 * @version 2015-04-13
 */
class DescribePullRequestEventsOutput {
    /**
     * Constructs a new <code>DescribePullRequestEventsOutput</code>.
     * @alias module:model/DescribePullRequestEventsOutput
     * @param pullRequestEvents {Array} 
     */
    constructor(pullRequestEvents) { 
        
        DescribePullRequestEventsOutput.initialize(this, pullRequestEvents);
    }
     ...
     */
    static initialize(obj, pullRequestEvents) { 
        obj['pullRequestEvents'] = pullRequestEvents;
    }

    /**
     * Constructs a <code>DescribePullRequestEventsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribePullRequestEventsOutput} obj Optional instance to populate.
     * @return {module:model/DescribePullRequestEventsOutput} The populated <code>DescribePullRequestEventsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribePullRequestEventsOutput();

            if (data.hasOwnProperty('pullRequestEvents')) {
                obj['pullRequestEvents'] = ApiClient.convertToType(data['pullRequestEvents'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribePullRequestEventsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribePullRequestEventsOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribePullRequestEventsOutput.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `pullRequestEvents`
        if (data['pullRequestEvents']) { // data not null
          Array.validateJSON(data['pullRequestEvents']);
        }
...
DescribePullRequestEventsOutput.RequiredProperties = ["pullRequestEvents"];

/**
 * @member {Array} pullRequestEvents
 */
DescribePullRequestEventsOutput.prototype['pullRequestEvents'] = undefined;

/**
 * @member {String} nextToken
 */
DescribePullRequestEventsOutput.prototype['nextToken'] = undefined;
...
export default DescribePullRequestEventsOutput;
