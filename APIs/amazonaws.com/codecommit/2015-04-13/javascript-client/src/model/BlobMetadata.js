...
/**
 * The BlobMetadata model module.
 * @module model/BlobMetadata
 * @version 2015-04-13
 */
class BlobMetadata {
    /**
     * Constructs a new <code>BlobMetadata</code>.
     * Returns information about a specific Git blob object.
     * @alias module:model/BlobMetadata
     */
    constructor() { 
        
        BlobMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BlobMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BlobMetadata} obj Optional instance to populate.
     * @return {module:model/BlobMetadata} The populated <code>BlobMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BlobMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>BlobMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BlobMetadata</code>.
     */
 ...
 */
BlobMetadata.prototype['blobId'] = undefined;

/**
 * @member {String} path
 */
BlobMetadata.prototype['path'] = undefined;

/**
 * @member {String} mode
 */
BlobMetadata.prototype['mode'] = undefined;
