...
/**
 * The DescribePullRequestEventsInput model module.
 * @module model/DescribePullRequestEventsInput
 * @version 2015-04-13
 */
class DescribePullRequestEventsInput {
    /**
     * Constructs a new <code>DescribePullRequestEventsInput</code>.
     * @alias module:model/DescribePullRequestEventsInput
     * @param pullRequestId {String} 
     */
    constructor(pullRequestId) { 
        
        DescribePullRequestEventsInput.initialize(this, pullRequestId);
    }
    ...
    /**
     * Constructs a <code>DescribePullRequestEventsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribePullRequestEventsInput} obj Optional instance to populate.
     * @return {module:model/DescribePullRequestEventsInput} The populated <code>DescribePullRequestEventsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribePullRequestEventsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribePullRequestEventsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribePullRequestEventsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribePullRequestEventsInput.RequiredProperties) {
...
DescribePullRequestEventsInput.RequiredProperties = ["pullRequestId"];

/**
 * @member {String} pullRequestId
 */
DescribePullRequestEventsInput.prototype['pullRequestId'] = undefined;

/**
 * @member {module:model/PullRequestEventType} pullRequestEventType
 */
DescribePullRequestEventsInput.prototype['pullRequestEventType'] = undefined;

/**
 * @member {String} actorArn
 */
DescribePullRequestEventsInput.prototype['actorArn'] = undefined;

/**
 * @member {String} nextToken
 */
DescribePullRequestEventsInput.prototype['nextToken'] = undefined;

/**
 * @member {Number} maxResults
 */
DescribePullRequestEventsInput.prototype['maxResults'] = undefined;
...
export default DescribePullRequestEventsInput;
