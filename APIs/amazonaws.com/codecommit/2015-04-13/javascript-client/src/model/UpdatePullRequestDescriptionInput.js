...
/**
 * The UpdatePullRequestDescriptionInput model module.
 * @module model/UpdatePullRequestDescriptionInput
 * @version 2015-04-13
 */
class UpdatePullRequestDescriptionInput {
    /**
     * Constructs a new <code>UpdatePullRequestDescriptionInput</code>.
     * @alias module:model/UpdatePullRequestDescriptionInput
     * @param pullRequestId {String} 
     * @param description {String} 
     */
    constructor(pullRequestId, description) { 
        
        UpdatePullRequestDescriptionInput.initialize(this, pullRequestId, description);
    }
     ...
     */
    static initialize(obj, pullRequestId, description) { 
        obj['pullRequestId'] = pullRequestId;
        obj['description'] = description;
    }

    /**
     * Constructs a <code>UpdatePullRequestDescriptionInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePullRequestDescriptionInput} obj Optional instance to populate.
     * @return {module:model/UpdatePullRequestDescriptionInput} The populated <code>UpdatePullRequestDescriptionInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePullRequestDescriptionInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePullRequestDescriptionInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePullRequestDescriptionInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdatePullRequestDescriptionInput.RequiredProperties) {
...
UpdatePullRequestDescriptionInput.RequiredProperties = ["pullRequestId", "description"];

/**
 * @member {String} pullRequestId
 */
UpdatePullRequestDescriptionInput.prototype['pullRequestId'] = undefined;

/**
 * @member {String} description
 */
UpdatePullRequestDescriptionInput.prototype['description'] = undefined;
...
export default UpdatePullRequestDescriptionInput;
