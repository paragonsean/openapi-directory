...
import CreatePullRequestApprovalRuleOutputApprovalRule from './CreatePullRequestApprovalRuleOutputApprovalRule';

/**
 * The CreatePullRequestApprovalRuleOutput model module.
 * @module model/CreatePullRequestApprovalRuleOutput
 * @version 2015-04-13
 */
class CreatePullRequestApprovalRuleOutput {
    /**
     * Constructs a new <code>CreatePullRequestApprovalRuleOutput</code>.
     * @alias module:model/CreatePullRequestApprovalRuleOutput
     * @param approvalRule {module:model/CreatePullRequestApprovalRuleOutputApprovalRule} 
     */
    constructor(approvalRule) { 
        
        CreatePullRequestApprovalRuleOutput.initialize(this, approvalRule);
    }
     ...
     */
    static initialize(obj, approvalRule) { 
        obj['approvalRule'] = approvalRule;
    }

    /**
     * Constructs a <code>CreatePullRequestApprovalRuleOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePullRequestApprovalRuleOutput} obj Optional instance to populate.
     * @return {module:model/CreatePullRequestApprovalRuleOutput} The populated <code>CreatePullRequestApprovalRuleOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePullRequestApprovalRuleOutput();

            if (data.hasOwnProperty('approvalRule')) {
                obj['approvalRule'] = CreatePullRequestApprovalRuleOutputApprovalRule.constructFromObject(data['approvalRule']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePullRequestApprovalRuleOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePullRequestApprovalRuleOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreatePullRequestApprovalRuleOutput.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `approvalRule`
        if (data['approvalRule']) { // data not null
          CreatePullRequestApprovalRuleOutputApprovalRule.validateJSON(data['approvalRule']);
        }
...
CreatePullRequestApprovalRuleOutput.RequiredProperties = ["approvalRule"];

/**
 * @member {module:model/CreatePullRequestApprovalRuleOutputApprovalRule} approvalRule
 */
CreatePullRequestApprovalRuleOutput.prototype['approvalRule'] = undefined;
...
export default CreatePullRequestApprovalRuleOutput;
