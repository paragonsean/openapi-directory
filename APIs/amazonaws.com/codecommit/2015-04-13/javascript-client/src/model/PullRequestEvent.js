...
import PullRequestEventApprovalRuleEventMetadata from './PullRequestEventApprovalRuleEventMetadata';
import PullRequestEventApprovalRuleOverriddenEventMetadata from './PullRequestEventApprovalRuleOverriddenEventMetadata';
import PullRequestEventApprovalStateChangedEventMetadata from './PullRequestEventApprovalStateChangedEventMetadata';
import PullRequestEventPullRequestCreatedEventMetadata from './PullRequestEventPullRequestCreatedEventMetadata';
import PullRequestEventPullRequestMergedStateChangedEventMetadata from './PullRequestEventPullRequestMergedStateChangedEventMetadata';
import PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata from './PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata';
import PullRequestEventPullRequestStatusChangedEventMetadata from './PullRequestEventPullRequestStatusChangedEventMetadata';
import PullRequestEventType from './PullRequestEventType';

/**
 * The PullRequestEvent model module.
 * @module model/PullRequestEvent
 * @version 2015-04-13
 */
class PullRequestEvent {
    /**
     * Constructs a new <code>PullRequestEvent</code>.
     * Returns information about a pull request event.
     * @alias module:model/PullRequestEvent
     */
    constructor() { 
        
        PullRequestEvent.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PullRequestEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PullRequestEvent} obj Optional instance to populate.
     * @return {module:model/PullRequestEvent} The populated <code>PullRequestEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PullRequestEvent();
            ...
            if (data.hasOwnProperty('pullRequestEventType')) {
                obj['pullRequestEventType'] = ApiClient.convertToType(data['pullRequestEventType'], PullRequestEventType);
            }
            if (data.hasOwnProperty('actorArn')) {
                obj['actorArn'] = ApiClient.convertToType(data['actorArn'], 'String');
            }
            if (data.hasOwnProperty('pullRequestCreatedEventMetadata')) {
                obj['pullRequestCreatedEventMetadata'] = PullRequestEventPullRequestCreatedEventMetadata.constructFromObject(data['pullRequestCreatedEventMetadata']);
            }
            if (data.hasOwnProperty('pullRequestStatusChangedEventMetadata')) {
                obj['pullRequestStatusChangedEventMetadata'] = PullRequestEventPullRequestStatusChangedEventMetadata.constructFromObject(data['pullRequestStatusChangedEventMetadata']);
            }
            if (data.hasOwnProperty('pullRequestSourceReferenceUpdatedEventMetadata')) {
                obj['pullRequestSourceReferenceUpdatedEventMetadata'] = PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata.constructFromObject(data['pullRequestSourceReferenceUpdatedEventMetadata']);
            }
            if (data.hasOwnProperty('pullRequestMergedStateChangedEventMetadata')) {
                obj['pullRequestMergedStateChangedEventMetadata'] = PullRequestEventPullRequestMergedStateChangedEventMetadata.constructFromObject(data['pullRequestMergedStateChangedEventMetadata']);
            }
            if (data.hasOwnProperty('approvalRuleEventMetadata')) {
                obj['approvalRuleEventMetadata'] = PullRequestEventApprovalRuleEventMetadata.constructFromObject(data['approvalRuleEventMetadata']);
            }
            if (data.hasOwnProperty('approvalStateChangedEventMetadata')) {
                obj['approvalStateChangedEventMetadata'] = PullRequestEventApprovalStateChangedEventMetadata.constructFromObject(data['approvalStateChangedEventMetadata']);
            }
            if (data.hasOwnProperty('approvalRuleOverriddenEventMetadata')) {
                obj['approvalRuleOverriddenEventMetadata'] = PullRequestEventApprovalRuleOverriddenEventMetadata.constructFromObject(data['approvalRuleOverriddenEventMetadata']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PullRequestEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PullRequestEvent</code>.
     */
    static validateJSON(data) {
        ...
        if (data['pullRequestEventType']) { // data not null
          PullRequestEventType.validateJSON(data['pullRequestEventType']);
        }
        // validate the optional field `actorArn`
        if (data['actorArn']) { // data not null
          String.validateJSON(data['actorArn']);
        }
        // validate the optional field `pullRequestCreatedEventMetadata`
        if (data['pullRequestCreatedEventMetadata']) { // data not null
          PullRequestEventPullRequestCreatedEventMetadata.validateJSON(data['pullRequestCreatedEventMetadata']);
        }
        // validate the optional field `pullRequestStatusChangedEventMetadata`
        if (data['pullRequestStatusChangedEventMetadata']) { // data not null
          PullRequestEventPullRequestStatusChangedEventMetadata.validateJSON(data['pullRequestStatusChangedEventMetadata']);
        }
        // validate the optional field `pullRequestSourceReferenceUpdatedEventMetadata`
        if (data['pullRequestSourceReferenceUpdatedEventMetadata']) { // data not null
          PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata.validateJSON(data['pullRequestSourceReferenceUpdatedEventMetadata']);
        }
        // validate the optional field `pullRequestMergedStateChangedEventMetadata`
        if (data['pullRequestMergedStateChangedEventMetadata']) { // data not null
          PullRequestEventPullRequestMergedStateChangedEventMetadata.validateJSON(data['pullRequestMergedStateChangedEventMetadata']);
        }
        // validate the optional field `approvalRuleEventMetadata`
        if (data['approvalRuleEventMetadata']) { // data not null
          PullRequestEventApprovalRuleEventMetadata.validateJSON(data['approvalRuleEventMetadata']);
        }
        // validate the optional field `approvalStateChangedEventMetadata`
        if (data['approvalStateChangedEventMetadata']) { // data not null
          PullRequestEventApprovalStateChangedEventMetadata.validateJSON(data['approvalStateChangedEventMetadata']);
        }
        // validate the optional field `approvalRuleOverriddenEventMetadata`
        if (data['approvalRuleOverriddenEventMetadata']) { // data not null
          PullRequestEventApprovalRuleOverriddenEventMetadata.validateJSON(data['approvalRuleOverriddenEventMetadata']);
        }
 ...
 */
PullRequestEvent.prototype['pullRequestId'] = undefined;

/**
 * @member {Date} eventDate
 */
PullRequestEvent.prototype['eventDate'] = undefined;

/**
 * @member {module:model/PullRequestEventType} pullRequestEventType
 */
PullRequestEvent.prototype['pullRequestEventType'] = undefined;

/**
 * @member {String} actorArn
 */
PullRequestEvent.prototype['actorArn'] = undefined;

/**
 * @member {module:model/PullRequestEventPullRequestCreatedEventMetadata} pullRequestCreatedEventMetadata
 */
PullRequestEvent.prototype['pullRequestCreatedEventMetadata'] = undefined;

/**
 * @member {module:model/PullRequestEventPullRequestStatusChangedEventMetadata} pullRequestStatusChangedEventMetadata
 */
PullRequestEvent.prototype['pullRequestStatusChangedEventMetadata'] = undefined;

/**
 * @member {module:model/PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata} pullRequestSourceReferenceUpdatedEventMetadata
 */
PullRequestEvent.prototype['pullRequestSourceReferenceUpdatedEventMetadata'] = undefined;

/**
 * @member {module:model/PullRequestEventPullRequestMergedStateChangedEventMetadata} pullRequestMergedStateChangedEventMetadata
 */
PullRequestEvent.prototype['pullRequestMergedStateChangedEventMetadata'] = undefined;

/**
 * @member {module:model/PullRequestEventApprovalRuleEventMetadata} approvalRuleEventMetadata
 */
PullRequestEvent.prototype['approvalRuleEventMetadata'] = undefined;

/**
 * @member {module:model/PullRequestEventApprovalStateChangedEventMetadata} approvalStateChangedEventMetadata
 */
PullRequestEvent.prototype['approvalStateChangedEventMetadata'] = undefined;

/**
 * @member {module:model/PullRequestEventApprovalRuleOverriddenEventMetadata} approvalRuleOverriddenEventMetadata
 */
PullRequestEvent.prototype['approvalRuleOverriddenEventMetadata'] = undefined;
