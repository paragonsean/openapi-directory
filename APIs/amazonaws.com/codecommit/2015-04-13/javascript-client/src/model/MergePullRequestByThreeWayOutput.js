...
/**
 * The MergePullRequestByThreeWayOutput model module.
 * @module model/MergePullRequestByThreeWayOutput
 * @version 2015-04-13
 */
class MergePullRequestByThreeWayOutput {
    /**
     * Constructs a new <code>MergePullRequestByThreeWayOutput</code>.
     * @alias module:model/MergePullRequestByThreeWayOutput
     */
    constructor() { 
        
        MergePullRequestByThreeWayOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MergePullRequestByThreeWayOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MergePullRequestByThreeWayOutput} obj Optional instance to populate.
     * @return {module:model/MergePullRequestByThreeWayOutput} The populated <code>MergePullRequestByThreeWayOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MergePullRequestByThreeWayOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>MergePullRequestByThreeWayOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MergePullRequestByThreeWayOutput</code>.
     */
 ...
 */
MergePullRequestByThreeWayOutput.prototype['pullRequest'] = undefined;
...
export default MergePullRequestByThreeWayOutput;
