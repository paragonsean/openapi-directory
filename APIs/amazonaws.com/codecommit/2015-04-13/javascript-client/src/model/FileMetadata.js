...
class FileMetadata {
    ...
    static validateJSON(data) {
        ...
        if (data['absolutePath']) { // data not null
          String.validateJSON(data['absolutePath']);
        }
 ...
 */
FileMetadata.prototype['absolutePath'] = undefined;

/**
 * @member {String} blobId
 */
FileMetadata.prototype['blobId'] = undefined;

/**
 * @member {module:model/FileModeTypeEnum} fileMode
 */
FileMetadata.prototype['fileMode'] = undefined;
