...
/**
 * The BatchDescribeMergeConflictsOutput model module.
 * @module model/BatchDescribeMergeConflictsOutput
 * @version 2015-04-13
 */
class BatchDescribeMergeConflictsOutput {
    /**
     * Constructs a new <code>BatchDescribeMergeConflictsOutput</code>.
     * @alias module:model/BatchDescribeMergeConflictsOutput
     * @param conflicts {Array} 
     * @param destinationCommitId {String} 
     * @param sourceCommitId {String} 
     */
    constructor(conflicts, destinationCommitId, sourceCommitId) { 
        
        BatchDescribeMergeConflictsOutput.initialize(this, conflicts, destinationCommitId, sourceCommitId);
    }
     ...
     */
    static initialize(obj, conflicts, destinationCommitId, sourceCommitId) { 
    ...
    /**
     * Constructs a <code>BatchDescribeMergeConflictsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchDescribeMergeConflictsOutput} obj Optional instance to populate.
     * @return {module:model/BatchDescribeMergeConflictsOutput} The populated <code>BatchDescribeMergeConflictsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchDescribeMergeConflictsOutput();

            if (data.hasOwnProperty('conflicts')) {
                obj['conflicts'] = ApiClient.convertToType(data['conflicts'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>BatchDescribeMergeConflictsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchDescribeMergeConflictsOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BatchDescribeMergeConflictsOutput.RequiredProperties) {
        ...
        if (data['conflicts']) { // data not null
          Array.validateJSON(data['conflicts']);
        }
...
BatchDescribeMergeConflictsOutput.RequiredProperties = ["conflicts", "destinationCommitId", "sourceCommitId"];

/**
 * @member {Array} conflicts
 */
BatchDescribeMergeConflictsOutput.prototype['conflicts'] = undefined;

/**
 * @member {String} nextToken
 */
BatchDescribeMergeConflictsOutput.prototype['nextToken'] = undefined;

/**
 * @member {Array} errors
 */
BatchDescribeMergeConflictsOutput.prototype['errors'] = undefined;

/**
 * @member {String} destinationCommitId
 */
BatchDescribeMergeConflictsOutput.prototype['destinationCommitId'] = undefined;

/**
 * @member {String} sourceCommitId
 */
BatchDescribeMergeConflictsOutput.prototype['sourceCommitId'] = undefined;

/**
 * @member {String} baseCommitId
 */
BatchDescribeMergeConflictsOutput.prototype['baseCommitId'] = undefined;
...
export default BatchDescribeMergeConflictsOutput;
