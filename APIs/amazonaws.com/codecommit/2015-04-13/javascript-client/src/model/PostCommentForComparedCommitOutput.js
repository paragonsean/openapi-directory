...
import PostCommentForComparedCommitOutputComment from './PostCommentForComparedCommitOutputComment';
import PostCommentForComparedCommitOutputLocation from './PostCommentForComparedCommitOutputLocation';

/**
 * The PostCommentForComparedCommitOutput model module.
 * @module model/PostCommentForComparedCommitOutput
 * @version 2015-04-13
 */
class PostCommentForComparedCommitOutput {
    /**
     * Constructs a new <code>PostCommentForComparedCommitOutput</code>.
     * @alias module:model/PostCommentForComparedCommitOutput
     */
    constructor() { 
        
        PostCommentForComparedCommitOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostCommentForComparedCommitOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostCommentForComparedCommitOutput} obj Optional instance to populate.
     * @return {module:model/PostCommentForComparedCommitOutput} The populated <code>PostCommentForComparedCommitOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostCommentForComparedCommitOutput();
            ...
            if (data.hasOwnProperty('beforeBlobId')) {
                obj['beforeBlobId'] = ApiClient.convertToType(data['beforeBlobId'], 'String');
            }
            if (data.hasOwnProperty('afterBlobId')) {
                obj['afterBlobId'] = ApiClient.convertToType(data['afterBlobId'], 'String');
            }
            if (data.hasOwnProperty('location')) {
                obj['location'] = PostCommentForComparedCommitOutputLocation.constructFromObject(data['location']);
            }
            if (data.hasOwnProperty('comment')) {
                obj['comment'] = PostCommentForComparedCommitOutputComment.constructFromObject(data['comment']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PostCommentForComparedCommitOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostCommentForComparedCommitOutput</code>.
     */
    static validateJSON(data) {
        ...
        if (data['beforeBlobId']) { // data not null
          String.validateJSON(data['beforeBlobId']);
        }
        // validate the optional field `afterBlobId`
        if (data['afterBlobId']) { // data not null
          String.validateJSON(data['afterBlobId']);
        }
        // validate the optional field `location`
        if (data['location']) { // data not null
          PostCommentForComparedCommitOutputLocation.validateJSON(data['location']);
        }
        // validate the optional field `comment`
        if (data['comment']) { // data not null
          PostCommentForComparedCommitOutputComment.validateJSON(data['comment']);
        }
 ...
 */
PostCommentForComparedCommitOutput.prototype['repositoryName'] = undefined;

/**
 * @member {String} beforeCommitId
 */
PostCommentForComparedCommitOutput.prototype['beforeCommitId'] = undefined;

/**
 * @member {String} afterCommitId
 */
PostCommentForComparedCommitOutput.prototype['afterCommitId'] = undefined;

/**
 * @member {String} beforeBlobId
 */
PostCommentForComparedCommitOutput.prototype['beforeBlobId'] = undefined;

/**
 * @member {String} afterBlobId
 */
PostCommentForComparedCommitOutput.prototype['afterBlobId'] = undefined;

/**
 * @member {module:model/PostCommentForComparedCommitOutputLocation} location
 */
PostCommentForComparedCommitOutput.prototype['location'] = undefined;

/**
 * @member {module:model/PostCommentForComparedCommitOutputComment} comment
 */
PostCommentForComparedCommitOutput.prototype['comment'] = undefined;
...
export default PostCommentForComparedCommitOutput;
