...
/**
 * The CreatePullRequestApprovalRuleInput model module.
 * @module model/CreatePullRequestApprovalRuleInput
 * @version 2015-04-13
 */
class CreatePullRequestApprovalRuleInput {
    /**
     * Constructs a new <code>CreatePullRequestApprovalRuleInput</code>.
     * @alias module:model/CreatePullRequestApprovalRuleInput
     * @param pullRequestId {String} 
     * @param approvalRuleName {String} 
     * @param approvalRuleContent {String} 
     */
    constructor(pullRequestId, approvalRuleName, approvalRuleContent) { 
        
        CreatePullRequestApprovalRuleInput.initialize(this, pullRequestId, approvalRuleName, approvalRuleContent);
    }
     ...
     */
    static initialize(obj, pullRequestId, approvalRuleName, approvalRuleContent) { 
        obj['pullRequestId'] = pullRequestId;
        obj['approvalRuleName'] = approvalRuleName;
        obj['approvalRuleContent'] = approvalRuleContent;
    }

    /**
     * Constructs a <code>CreatePullRequestApprovalRuleInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePullRequestApprovalRuleInput} obj Optional instance to populate.
     * @return {module:model/CreatePullRequestApprovalRuleInput} The populated <code>CreatePullRequestApprovalRuleInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePullRequestApprovalRuleInput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePullRequestApprovalRuleInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePullRequestApprovalRuleInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreatePullRequestApprovalRuleInput.RequiredProperties) {
...
CreatePullRequestApprovalRuleInput.RequiredProperties = ["pullRequestId", "approvalRuleName", "approvalRuleContent"];

/**
 * @member {String} pullRequestId
 */
CreatePullRequestApprovalRuleInput.prototype['pullRequestId'] = undefined;

/**
 * @member {String} approvalRuleName
 */
CreatePullRequestApprovalRuleInput.prototype['approvalRuleName'] = undefined;

/**
 * @member {String} approvalRuleContent
 */
CreatePullRequestApprovalRuleInput.prototype['approvalRuleContent'] = undefined;
...
export default CreatePullRequestApprovalRuleInput;
