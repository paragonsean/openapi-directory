...
/**
 * The GetCommentsForPullRequestOutput model module.
 * @module model/GetCommentsForPullRequestOutput
 * @version 2015-04-13
 */
class GetCommentsForPullRequestOutput {
    /**
     * Constructs a new <code>GetCommentsForPullRequestOutput</code>.
     * @alias module:model/GetCommentsForPullRequestOutput
     */
    constructor() { 
        
        GetCommentsForPullRequestOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetCommentsForPullRequestOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCommentsForPullRequestOutput} obj Optional instance to populate.
     * @return {module:model/GetCommentsForPullRequestOutput} The populated <code>GetCommentsForPullRequestOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCommentsForPullRequestOutput();

            if (data.hasOwnProperty('commentsForPullRequestData')) {
                obj['commentsForPullRequestData'] = ApiClient.convertToType(data['commentsForPullRequestData'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetCommentsForPullRequestOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCommentsForPullRequestOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `commentsForPullRequestData`
        if (data['commentsForPullRequestData']) { // data not null
          Array.validateJSON(data['commentsForPullRequestData']);
        }
...
/**
 * @member {Array} commentsForPullRequestData
 */
GetCommentsForPullRequestOutput.prototype['commentsForPullRequestData'] = undefined;

/**
 * @member {String} nextToken
 */
GetCommentsForPullRequestOutput.prototype['nextToken'] = undefined;
...
export default GetCommentsForPullRequestOutput;
