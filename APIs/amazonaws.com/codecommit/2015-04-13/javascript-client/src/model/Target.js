...
class Target {
     ...
     */
    constructor(repositoryName, sourceReference) { 
        
        Target.initialize(this, repositoryName, sourceReference);
    }
     ...
     */
    static initialize(obj, repositoryName, sourceReference) { 
...
Target.RequiredProperties = ["repositoryName", "sourceReference"];

/**
 * @member {String} repositoryName
 */
Target.prototype['repositoryName'] = undefined;

/**
 * @member {String} sourceReference
 */
Target.prototype['sourceReference'] = undefined;

/**
 * @member {String} destinationReference
 */
Target.prototype['destinationReference'] = undefined;
