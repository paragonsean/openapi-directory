...
/**
 * The DeleteCommentContentInput model module.
 * @module model/DeleteCommentContentInput
 * @version 2015-04-13
 */
class DeleteCommentContentInput {
    /**
     * Constructs a new <code>DeleteCommentContentInput</code>.
     * @alias module:model/DeleteCommentContentInput
     * @param commentId {String} 
     */
    constructor(commentId) { 
        
        DeleteCommentContentInput.initialize(this, commentId);
    }
     ...
     */
    static initialize(obj, commentId) { 
        obj['commentId'] = commentId;
    }

    /**
     * Constructs a <code>DeleteCommentContentInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteCommentContentInput} obj Optional instance to populate.
     * @return {module:model/DeleteCommentContentInput} The populated <code>DeleteCommentContentInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteCommentContentInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteCommentContentInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteCommentContentInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteCommentContentInput.RequiredProperties) {
...
DeleteCommentContentInput.RequiredProperties = ["commentId"];

/**
 * @member {String} commentId
 */
DeleteCommentContentInput.prototype['commentId'] = undefined;
...
export default DeleteCommentContentInput;
