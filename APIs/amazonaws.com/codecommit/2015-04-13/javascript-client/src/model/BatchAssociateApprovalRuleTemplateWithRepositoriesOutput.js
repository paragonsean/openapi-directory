...
/**
 * The BatchAssociateApprovalRuleTemplateWithRepositoriesOutput model module.
 * @module model/BatchAssociateApprovalRuleTemplateWithRepositoriesOutput
 * @version 2015-04-13
 */
class BatchAssociateApprovalRuleTemplateWithRepositoriesOutput {
    /**
     * Constructs a new <code>BatchAssociateApprovalRuleTemplateWithRepositoriesOutput</code>.
     * @alias module:model/BatchAssociateApprovalRuleTemplateWithRepositoriesOutput
     * @param associatedRepositoryNames {Array} 
     * @param errors {Array} 
     */
    constructor(associatedRepositoryNames, errors) { 
        
        BatchAssociateApprovalRuleTemplateWithRepositoriesOutput.initialize(this, associatedRepositoryNames, errors);
    }
     ...
     */
    static initialize(obj, associatedRepositoryNames, errors) { 
        obj['associatedRepositoryNames'] = associatedRepositoryNames;
        obj['errors'] = errors;
    }

    /**
     * Constructs a <code>BatchAssociateApprovalRuleTemplateWithRepositoriesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchAssociateApprovalRuleTemplateWithRepositoriesOutput} obj Optional instance to populate.
     * @return {module:model/BatchAssociateApprovalRuleTemplateWithRepositoriesOutput} The populated <code>BatchAssociateApprovalRuleTemplateWithRepositoriesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchAssociateApprovalRuleTemplateWithRepositoriesOutput();

            if (data.hasOwnProperty('associatedRepositoryNames')) {
                obj['associatedRepositoryNames'] = ApiClient.convertToType(data['associatedRepositoryNames'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>BatchAssociateApprovalRuleTemplateWithRepositoriesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchAssociateApprovalRuleTemplateWithRepositoriesOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BatchAssociateApprovalRuleTemplateWithRepositoriesOutput.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `associatedRepositoryNames`
        if (data['associatedRepositoryNames']) { // data not null
          Array.validateJSON(data['associatedRepositoryNames']);
        }
...
BatchAssociateApprovalRuleTemplateWithRepositoriesOutput.RequiredProperties = ["associatedRepositoryNames", "errors"];

/**
 * @member {Array} associatedRepositoryNames
 */
BatchAssociateApprovalRuleTemplateWithRepositoriesOutput.prototype['associatedRepositoryNames'] = undefined;

/**
 * @member {Array} errors
 */
BatchAssociateApprovalRuleTemplateWithRepositoriesOutput.prototype['errors'] = undefined;
...
export default BatchAssociateApprovalRuleTemplateWithRepositoriesOutput;
