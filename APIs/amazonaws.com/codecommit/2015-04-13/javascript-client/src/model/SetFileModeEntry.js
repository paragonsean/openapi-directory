...
/**
 * The SetFileModeEntry model module.
 * @module model/SetFileModeEntry
 * @version 2015-04-13
 */
class SetFileModeEntry {
    /**
     * Constructs a new <code>SetFileModeEntry</code>.
     * Information about the file mode changes.
     * @alias module:model/SetFileModeEntry
     * @param filePath {String} 
     * @param fileMode {module:model/FileModeTypeEnum} 
     */
    constructor(filePath, fileMode) { 
        
        SetFileModeEntry.initialize(this, filePath, fileMode);
    }
     ...
     */
    static initialize(obj, filePath, fileMode) { 
        obj['filePath'] = filePath;
        obj['fileMode'] = fileMode;
    }

    /**
     * Constructs a <code>SetFileModeEntry</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetFileModeEntry} obj Optional instance to populate.
     * @return {module:model/SetFileModeEntry} The populated <code>SetFileModeEntry</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetFileModeEntry();
    ...
    /**
     * Validates the JSON data with respect to <code>SetFileModeEntry</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetFileModeEntry</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SetFileModeEntry.RequiredProperties) {
...
SetFileModeEntry.RequiredProperties = ["filePath", "fileMode"];

/**
 * @member {String} filePath
 */
SetFileModeEntry.prototype['filePath'] = undefined;

/**
 * @member {module:model/FileModeTypeEnum} fileMode
 */
SetFileModeEntry.prototype['fileMode'] = undefined;
...
export default SetFileModeEntry;
