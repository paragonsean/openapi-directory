...
/**
 * The MergeBranchesByFastForwardOutput model module.
 * @module model/MergeBranchesByFastForwardOutput
 * @version 2015-04-13
 */
class MergeBranchesByFastForwardOutput {
    /**
     * Constructs a new <code>MergeBranchesByFastForwardOutput</code>.
     * @alias module:model/MergeBranchesByFastForwardOutput
     */
    constructor() { 
        
        MergeBranchesByFastForwardOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MergeBranchesByFastForwardOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MergeBranchesByFastForwardOutput} obj Optional instance to populate.
     * @return {module:model/MergeBranchesByFastForwardOutput} The populated <code>MergeBranchesByFastForwardOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MergeBranchesByFastForwardOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>MergeBranchesByFastForwardOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MergeBranchesByFastForwardOutput</code>.
     */
 ...
 */
MergeBranchesByFastForwardOutput.prototype['commitId'] = undefined;

/**
 * @member {String} treeId
 */
MergeBranchesByFastForwardOutput.prototype['treeId'] = undefined;
...
export default MergeBranchesByFastForwardOutput;
