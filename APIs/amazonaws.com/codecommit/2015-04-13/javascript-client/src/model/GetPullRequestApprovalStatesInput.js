...
/**
 * The GetPullRequestApprovalStatesInput model module.
 * @module model/GetPullRequestApprovalStatesInput
 * @version 2015-04-13
 */
class GetPullRequestApprovalStatesInput {
    /**
     * Constructs a new <code>GetPullRequestApprovalStatesInput</code>.
     * @alias module:model/GetPullRequestApprovalStatesInput
     * @param pullRequestId {String} 
     * @param revisionId {String} 
     */
    constructor(pullRequestId, revisionId) { 
        
        GetPullRequestApprovalStatesInput.initialize(this, pullRequestId, revisionId);
    }
    ...
    /**
     * Constructs a <code>GetPullRequestApprovalStatesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPullRequestApprovalStatesInput} obj Optional instance to populate.
     * @return {module:model/GetPullRequestApprovalStatesInput} The populated <code>GetPullRequestApprovalStatesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPullRequestApprovalStatesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetPullRequestApprovalStatesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPullRequestApprovalStatesInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetPullRequestApprovalStatesInput.RequiredProperties) {
...
GetPullRequestApprovalStatesInput.RequiredProperties = ["pullRequestId", "revisionId"];

/**
 * @member {String} pullRequestId
 */
GetPullRequestApprovalStatesInput.prototype['pullRequestId'] = undefined;

/**
 * @member {String} revisionId
 */
GetPullRequestApprovalStatesInput.prototype['revisionId'] = undefined;
...
export default GetPullRequestApprovalStatesInput;
