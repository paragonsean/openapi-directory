...
import RelativeFileVersionEnum from './RelativeFileVersionEnum';

/**
 * The CommentsForPullRequestLocation model module.
 * @module model/CommentsForPullRequestLocation
 * @version 2015-04-13
 */
class CommentsForPullRequestLocation {
    /**
     * Constructs a new <code>CommentsForPullRequestLocation</code>.
     * @alias module:model/CommentsForPullRequestLocation
     * @implements module:model/Location
     */
    constructor() { 
        Location.initialize(this);
        CommentsForPullRequestLocation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CommentsForPullRequestLocation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CommentsForPullRequestLocation} obj Optional instance to populate.
     * @return {module:model/CommentsForPullRequestLocation} The populated <code>CommentsForPullRequestLocation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CommentsForPullRequestLocation();
            ...
            if (data.hasOwnProperty('filePosition')) {
                obj['filePosition'] = ApiClient.convertToType(data['filePosition'], 'Number');
            }
            if (data.hasOwnProperty('relativeFileVersion')) {
                obj['relativeFileVersion'] = ApiClient.convertToType(data['relativeFileVersion'], RelativeFileVersionEnum);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CommentsForPullRequestLocation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CommentsForPullRequestLocation</code>.
     */
    static validateJSON(data) {
        ...
        // validate the optional field `filePosition`
        if (data['filePosition']) { // data not null
          Number.validateJSON(data['filePosition']);
        }
        // validate the optional field `relativeFileVersion`
        if (data['relativeFileVersion']) { // data not null
          RelativeFileVersionEnum.validateJSON(data['relativeFileVersion']);
        }
 ...
 */
CommentsForPullRequestLocation.prototype['filePath'] = undefined;

/**
 * @member {Number} filePosition
 */
CommentsForPullRequestLocation.prototype['filePosition'] = undefined;

/**
 * @member {module:model/RelativeFileVersionEnum} relativeFileVersion
 */
CommentsForPullRequestLocation.prototype['relativeFileVersion'] = undefined;
 ...
 * @member {String} filePath
 */
Location.prototype['filePath'] = undefined;
/**
 * @member {Number} filePosition
 */
Location.prototype['filePosition'] = undefined;
/**
 * @member {module:model/RelativeFileVersionEnum} relativeFileVersion
 */
Location.prototype['relativeFileVersion'] = undefined;




export default CommentsForPullRequestLocation;
