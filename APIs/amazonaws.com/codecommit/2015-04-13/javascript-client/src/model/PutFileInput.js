...
import FileModeTypeEnum from './FileModeTypeEnum';

/**
 * The PutFileInput model module.
 * @module model/PutFileInput
 * @version 2015-04-13
 */
class PutFileInput {
    /**
     * Constructs a new <code>PutFileInput</code>.
     * @alias module:model/PutFileInput
     * @param repositoryName {String} 
     * @param branchName {String} 
     * @param fileContent {String} 
     * @param filePath {String} 
     */
    constructor(repositoryName, branchName, fileContent, filePath) { 
        
        PutFileInput.initialize(this, repositoryName, branchName, fileContent, filePath);
    }
     ...
     */
    static initialize(obj, repositoryName, branchName, fileContent, filePath) { 
    ...
    /**
     * Constructs a <code>PutFileInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutFileInput} obj Optional instance to populate.
     * @return {module:model/PutFileInput} The populated <code>PutFileInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutFileInput();
            ...
            if (data.hasOwnProperty('fileMode')) {
                obj['fileMode'] = ApiClient.convertToType(data['fileMode'], FileModeTypeEnum);
            }
            if (data.hasOwnProperty('parentCommitId')) {
                obj['parentCommitId'] = ApiClient.convertToType(data['parentCommitId'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PutFileInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutFileInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutFileInput.RequiredProperties) {
        ...
        // validate the optional field `fileContent`
        if (data['fileContent']) { // data not null
          String.validateJSON(data['fileContent']);
        }
        ...
        if (data['fileMode']) { // data not null
          FileModeTypeEnum.validateJSON(data['fileMode']);
        }
        // validate the optional field `parentCommitId`
        if (data['parentCommitId']) { // data not null
          String.validateJSON(data['parentCommitId']);
        }
...
PutFileInput.RequiredProperties = ["repositoryName", "branchName", "fileContent", "filePath"];

/**
 * @member {String} repositoryName
 */
PutFileInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} branchName
 */
PutFileInput.prototype['branchName'] = undefined;

/**
 * @member {String} fileContent
 */
PutFileInput.prototype['fileContent'] = undefined;

/**
 * @member {String} filePath
 */
PutFileInput.prototype['filePath'] = undefined;

/**
 * @member {module:model/FileModeTypeEnum} fileMode
 */
PutFileInput.prototype['fileMode'] = undefined;

/**
 * @member {String} parentCommitId
 */
PutFileInput.prototype['parentCommitId'] = undefined;

/**
 * @member {String} commitMessage
 */
PutFileInput.prototype['commitMessage'] = undefined;

/**
 * @member {String} name
 */
PutFileInput.prototype['name'] = undefined;

/**
 * @member {String} email
 */
PutFileInput.prototype['email'] = undefined;
