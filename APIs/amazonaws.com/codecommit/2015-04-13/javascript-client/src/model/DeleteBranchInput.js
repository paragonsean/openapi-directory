...
/**
 * The DeleteBranchInput model module.
 * @module model/DeleteBranchInput
 * @version 2015-04-13
 */
class DeleteBranchInput {
    /**
     * Constructs a new <code>DeleteBranchInput</code>.
     * Represents the input of a delete branch operation.
     * @alias module:model/DeleteBranchInput
     * @param repositoryName {String} 
     * @param branchName {String} 
     */
    constructor(repositoryName, branchName) { 
        
        DeleteBranchInput.initialize(this, repositoryName, branchName);
    }
     ...
     */
    static initialize(obj, repositoryName, branchName) { 
        obj['repositoryName'] = repositoryName;
        obj['branchName'] = branchName;
    }

    /**
     * Constructs a <code>DeleteBranchInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteBranchInput} obj Optional instance to populate.
     * @return {module:model/DeleteBranchInput} The populated <code>DeleteBranchInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteBranchInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteBranchInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteBranchInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteBranchInput.RequiredProperties) {
...
DeleteBranchInput.RequiredProperties = ["repositoryName", "branchName"];

/**
 * @member {String} repositoryName
 */
DeleteBranchInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} branchName
 */
DeleteBranchInput.prototype['branchName'] = undefined;
...
export default DeleteBranchInput;
