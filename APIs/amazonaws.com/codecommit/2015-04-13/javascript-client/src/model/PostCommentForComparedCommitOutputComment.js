...
/**
 * The PostCommentForComparedCommitOutputComment model module.
 * @module model/PostCommentForComparedCommitOutputComment
 * @version 2015-04-13
 */
class PostCommentForComparedCommitOutputComment {
    /**
     * Constructs a new <code>PostCommentForComparedCommitOutputComment</code>.
     * @alias module:model/PostCommentForComparedCommitOutputComment
     * @implements module:model/Comment
     */
    constructor() { 
        Comment.initialize(this);
        PostCommentForComparedCommitOutputComment.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostCommentForComparedCommitOutputComment</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostCommentForComparedCommitOutputComment} obj Optional instance to populate.
     * @return {module:model/PostCommentForComparedCommitOutputComment} The populated <code>PostCommentForComparedCommitOutputComment</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostCommentForComparedCommitOutputComment();
    ...
    /**
     * Validates the JSON data with respect to <code>PostCommentForComparedCommitOutputComment</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostCommentForComparedCommitOutputComment</code>.
     */
 ...
 */
PostCommentForComparedCommitOutputComment.prototype['commentId'] = undefined;

/**
 * @member {String} content
 */
PostCommentForComparedCommitOutputComment.prototype['content'] = undefined;

/**
 * @member {String} inReplyTo
 */
PostCommentForComparedCommitOutputComment.prototype['inReplyTo'] = undefined;

/**
 * @member {Date} creationDate
 */
PostCommentForComparedCommitOutputComment.prototype['creationDate'] = undefined;

/**
 * @member {Date} lastModifiedDate
 */
PostCommentForComparedCommitOutputComment.prototype['lastModifiedDate'] = undefined;

/**
 * @member {String} authorArn
 */
PostCommentForComparedCommitOutputComment.prototype['authorArn'] = undefined;

/**
 * @member {Boolean} deleted
 */
PostCommentForComparedCommitOutputComment.prototype['deleted'] = undefined;

/**
 * @member {String} clientRequestToken
 */
PostCommentForComparedCommitOutputComment.prototype['clientRequestToken'] = undefined;

/**
 * @member {Array} callerReactions
 */
PostCommentForComparedCommitOutputComment.prototype['callerReactions'] = undefined;

/**
 * @member {Object} reactionCounts
 */
PostCommentForComparedCommitOutputComment.prototype['reactionCounts'] = undefined;
...
export default PostCommentForComparedCommitOutputComment;
