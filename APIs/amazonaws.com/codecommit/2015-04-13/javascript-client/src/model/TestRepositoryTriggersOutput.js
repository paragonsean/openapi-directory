...
/**
 * The TestRepositoryTriggersOutput model module.
 * @module model/TestRepositoryTriggersOutput
 * @version 2015-04-13
 */
class TestRepositoryTriggersOutput {
    /**
     * Constructs a new <code>TestRepositoryTriggersOutput</code>.
     * Represents the output of a test repository triggers operation.
     * @alias module:model/TestRepositoryTriggersOutput
     */
    constructor() { 
        
        TestRepositoryTriggersOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TestRepositoryTriggersOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TestRepositoryTriggersOutput} obj Optional instance to populate.
     * @return {module:model/TestRepositoryTriggersOutput} The populated <code>TestRepositoryTriggersOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TestRepositoryTriggersOutput();

            if (data.hasOwnProperty('successfulExecutions')) {
                obj['successfulExecutions'] = ApiClient.convertToType(data['successfulExecutions'], Array);
            }
            if (data.hasOwnProperty('failedExecutions')) {
                obj['failedExecutions'] = ApiClient.convertToType(data['failedExecutions'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TestRepositoryTriggersOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TestRepositoryTriggersOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `successfulExecutions`
        if (data['successfulExecutions']) { // data not null
          Array.validateJSON(data['successfulExecutions']);
        }
        // validate the optional field `failedExecutions`
        if (data['failedExecutions']) { // data not null
          Array.validateJSON(data['failedExecutions']);
        }
...
/**
 * @member {Array} successfulExecutions
 */
TestRepositoryTriggersOutput.prototype['successfulExecutions'] = undefined;

/**
 * @member {Array} failedExecutions
 */
TestRepositoryTriggersOutput.prototype['failedExecutions'] = undefined;
...
export default TestRepositoryTriggersOutput;
