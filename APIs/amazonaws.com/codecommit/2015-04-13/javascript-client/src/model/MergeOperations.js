...
/**
 * The MergeOperations model module.
 * @module model/MergeOperations
 * @version 2015-04-13
 */
class MergeOperations {
    /**
     * Constructs a new <code>MergeOperations</code>.
     * Information about the file operation conflicts in a merge operation.
     * @alias module:model/MergeOperations
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>MergeOperations</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MergeOperations} obj Optional instance to populate.
     * @return {module:model/MergeOperations} The populated <code>MergeOperations</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MergeOperations();
    ...
    /**
     * Validates the JSON data with respect to <code>MergeOperations</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MergeOperations</code>.
     */
