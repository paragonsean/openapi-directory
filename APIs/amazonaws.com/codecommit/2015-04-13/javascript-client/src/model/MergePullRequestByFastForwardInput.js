...
/**
 * The MergePullRequestByFastForwardInput model module.
 * @module model/MergePullRequestByFastForwardInput
 * @version 2015-04-13
 */
class MergePullRequestByFastForwardInput {
    /**
     * Constructs a new <code>MergePullRequestByFastForwardInput</code>.
     * @alias module:model/MergePullRequestByFastForwardInput
     * @param pullRequestId {String} 
     * @param repositoryName {String} 
     */
    constructor(pullRequestId, repositoryName) { 
        
        MergePullRequestByFastForwardInput.initialize(this, pullRequestId, repositoryName);
    }
    ...
    /**
     * Constructs a <code>MergePullRequestByFastForwardInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MergePullRequestByFastForwardInput} obj Optional instance to populate.
     * @return {module:model/MergePullRequestByFastForwardInput} The populated <code>MergePullRequestByFastForwardInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MergePullRequestByFastForwardInput();
    ...
    /**
     * Validates the JSON data with respect to <code>MergePullRequestByFastForwardInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MergePullRequestByFastForwardInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MergePullRequestByFastForwardInput.RequiredProperties) {
...
MergePullRequestByFastForwardInput.RequiredProperties = ["pullRequestId", "repositoryName"];

/**
 * @member {String} pullRequestId
 */
MergePullRequestByFastForwardInput.prototype['pullRequestId'] = undefined;

/**
 * @member {String} repositoryName
 */
MergePullRequestByFastForwardInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} sourceCommitId
 */
MergePullRequestByFastForwardInput.prototype['sourceCommitId'] = undefined;
...
export default MergePullRequestByFastForwardInput;
