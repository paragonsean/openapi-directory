...
/**
 * The GetDifferencesOutput model module.
 * @module model/GetDifferencesOutput
 * @version 2015-04-13
 */
class GetDifferencesOutput {
    /**
     * Constructs a new <code>GetDifferencesOutput</code>.
     * @alias module:model/GetDifferencesOutput
     */
    constructor() { 
        
        GetDifferencesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetDifferencesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetDifferencesOutput} obj Optional instance to populate.
     * @return {module:model/GetDifferencesOutput} The populated <code>GetDifferencesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDifferencesOutput();

            if (data.hasOwnProperty('differences')) {
                obj['differences'] = ApiClient.convertToType(data['differences'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetDifferencesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDifferencesOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `differences`
        if (data['differences']) { // data not null
          Array.validateJSON(data['differences']);
        }
...
/**
 * @member {Array} differences
 */
GetDifferencesOutput.prototype['differences'] = undefined;

/**
 * @member {String} NextToken
 */
GetDifferencesOutput.prototype['NextToken'] = undefined;
...
export default GetDifferencesOutput;
