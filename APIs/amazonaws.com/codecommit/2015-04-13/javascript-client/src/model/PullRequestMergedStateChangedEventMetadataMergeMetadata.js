...
/**
 * The PullRequestMergedStateChangedEventMetadataMergeMetadata model module.
 * @module model/PullRequestMergedStateChangedEventMetadataMergeMetadata
 * @version 2015-04-13
 */
class PullRequestMergedStateChangedEventMetadataMergeMetadata {
    /**
     * Constructs a new <code>PullRequestMergedStateChangedEventMetadataMergeMetadata</code>.
     * @alias module:model/PullRequestMergedStateChangedEventMetadataMergeMetadata
     * @implements module:model/MergeMetadata
     */
    constructor() { 
        MergeMetadata.initialize(this);
        PullRequestMergedStateChangedEventMetadataMergeMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PullRequestMergedStateChangedEventMetadataMergeMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PullRequestMergedStateChangedEventMetadataMergeMetadata} obj Optional instance to populate.
     * @return {module:model/PullRequestMergedStateChangedEventMetadataMergeMetadata} The populated <code>PullRequestMergedStateChangedEventMetadataMergeMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PullRequestMergedStateChangedEventMetadataMergeMetadata();
            MergeMetadata.constructFromObject(data, obj);

            if (data.hasOwnProperty('isMerged')) {
                obj['isMerged'] = ApiClient.convertToType(data['isMerged'], 'Boolean');
            }
            if (data.hasOwnProperty('mergedBy')) {
                obj['mergedBy'] = ApiClient.convertToType(data['mergedBy'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PullRequestMergedStateChangedEventMetadataMergeMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PullRequestMergedStateChangedEventMetadataMergeMetadata</code>.
     */
    static validateJSON(data) {
        // validate the optional field `isMerged`
        if (data['isMerged']) { // data not null
          Boolean.validateJSON(data['isMerged']);
        }
        // validate the optional field `mergedBy`
        if (data['mergedBy']) { // data not null
          String.validateJSON(data['mergedBy']);
        }
        // validate the optional field `mergeCommitId`
        if (data['mergeCommitId']) { // data not null
          String.validateJSON(data['mergeCommitId']);
        }
...
/**
 * @member {Boolean} isMerged
 */
PullRequestMergedStateChangedEventMetadataMergeMetadata.prototype['isMerged'] = undefined;

/**
 * @member {String} mergedBy
 */
PullRequestMergedStateChangedEventMetadataMergeMetadata.prototype['mergedBy'] = undefined;

/**
 * @member {String} mergeCommitId
 */
PullRequestMergedStateChangedEventMetadataMergeMetadata.prototype['mergeCommitId'] = undefined;

/**
 * @member {module:model/MergeOptionTypeEnum} mergeOption
 */
PullRequestMergedStateChangedEventMetadataMergeMetadata.prototype['mergeOption'] = undefined;


// Implement MergeMetadata interface:
/**
 * @member {Boolean} isMerged
 */
MergeMetadata.prototype['isMerged'] = undefined;
/**
 * @member {String} mergedBy
 */
MergeMetadata.prototype['mergedBy'] = undefined;
/**
 * @member {String} mergeCommitId
 */
MergeMetadata.prototype['mergeCommitId'] = undefined;
/**
 * @member {module:model/MergeOptionTypeEnum} mergeOption
 */
MergeMetadata.prototype['mergeOption'] = undefined;




export default PullRequestMergedStateChangedEventMetadataMergeMetadata;
