...
/**
 * The DescribeMergeConflictsInput model module.
 * @module model/DescribeMergeConflictsInput
 * @version 2015-04-13
 */
class DescribeMergeConflictsInput {
    /**
     * Constructs a new <code>DescribeMergeConflictsInput</code>.
     * @alias module:model/DescribeMergeConflictsInput
     ...
     */
    constructor(repositoryName, destinationCommitSpecifier, sourceCommitSpecifier, mergeOption, filePath) { 
        
        DescribeMergeConflictsInput.initialize(this, repositoryName, destinationCommitSpecifier, sourceCommitSpecifier, mergeOption, filePath);
    }
     ...
     */
    static initialize(obj, repositoryName, destinationCommitSpecifier, sourceCommitSpecifier, mergeOption, filePath) { 
    ...
    /**
     * Constructs a <code>DescribeMergeConflictsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeMergeConflictsInput} obj Optional instance to populate.
     * @return {module:model/DescribeMergeConflictsInput} The populated <code>DescribeMergeConflictsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeMergeConflictsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeMergeConflictsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeMergeConflictsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeMergeConflictsInput.RequiredProperties) {
...
DescribeMergeConflictsInput.RequiredProperties = ["repositoryName", "destinationCommitSpecifier", "sourceCommitSpecifier", "mergeOption", "filePath"];

/**
 * @member {String} repositoryName
 */
DescribeMergeConflictsInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} destinationCommitSpecifier
 */
DescribeMergeConflictsInput.prototype['destinationCommitSpecifier'] = undefined;

/**
 * @member {String} sourceCommitSpecifier
 */
DescribeMergeConflictsInput.prototype['sourceCommitSpecifier'] = undefined;

/**
 * @member {module:model/MergeOptionTypeEnum} mergeOption
 */
DescribeMergeConflictsInput.prototype['mergeOption'] = undefined;

/**
 * @member {Number} maxMergeHunks
 */
DescribeMergeConflictsInput.prototype['maxMergeHunks'] = undefined;

/**
 * @member {String} filePath
 */
DescribeMergeConflictsInput.prototype['filePath'] = undefined;

/**
 * @member {module:model/ConflictDetailLevelTypeEnum} conflictDetailLevel
 */
DescribeMergeConflictsInput.prototype['conflictDetailLevel'] = undefined;

/**
 * @member {module:model/ConflictResolutionStrategyTypeEnum} conflictResolutionStrategy
 */
DescribeMergeConflictsInput.prototype['conflictResolutionStrategy'] = undefined;

/**
 * @member {String} nextToken
 */
DescribeMergeConflictsInput.prototype['nextToken'] = undefined;
...
export default DescribeMergeConflictsInput;
