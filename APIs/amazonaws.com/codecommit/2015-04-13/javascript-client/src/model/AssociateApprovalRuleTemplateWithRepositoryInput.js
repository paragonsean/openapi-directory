...
/**
 * The AssociateApprovalRuleTemplateWithRepositoryInput model module.
 * @module model/AssociateApprovalRuleTemplateWithRepositoryInput
 * @version 2015-04-13
 */
class AssociateApprovalRuleTemplateWithRepositoryInput {
    /**
     * Constructs a new <code>AssociateApprovalRuleTemplateWithRepositoryInput</code>.
     * @alias module:model/AssociateApprovalRuleTemplateWithRepositoryInput
     * @param approvalRuleTemplateName {String} 
     * @param repositoryName {String} 
     */
    constructor(approvalRuleTemplateName, repositoryName) { 
        
        AssociateApprovalRuleTemplateWithRepositoryInput.initialize(this, approvalRuleTemplateName, repositoryName);
    }
     ...
     */
    static initialize(obj, approvalRuleTemplateName, repositoryName) { 
        obj['approvalRuleTemplateName'] = approvalRuleTemplateName;
        obj['repositoryName'] = repositoryName;
    }

    /**
     * Constructs a <code>AssociateApprovalRuleTemplateWithRepositoryInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssociateApprovalRuleTemplateWithRepositoryInput} obj Optional instance to populate.
     * @return {module:model/AssociateApprovalRuleTemplateWithRepositoryInput} The populated <code>AssociateApprovalRuleTemplateWithRepositoryInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssociateApprovalRuleTemplateWithRepositoryInput();
    ...
    /**
     * Validates the JSON data with respect to <code>AssociateApprovalRuleTemplateWithRepositoryInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssociateApprovalRuleTemplateWithRepositoryInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AssociateApprovalRuleTemplateWithRepositoryInput.RequiredProperties) {
...
AssociateApprovalRuleTemplateWithRepositoryInput.RequiredProperties = ["approvalRuleTemplateName", "repositoryName"];

/**
 * @member {String} approvalRuleTemplateName
 */
AssociateApprovalRuleTemplateWithRepositoryInput.prototype['approvalRuleTemplateName'] = undefined;

/**
 * @member {String} repositoryName
 */
AssociateApprovalRuleTemplateWithRepositoryInput.prototype['repositoryName'] = undefined;
...
export default AssociateApprovalRuleTemplateWithRepositoryInput;
