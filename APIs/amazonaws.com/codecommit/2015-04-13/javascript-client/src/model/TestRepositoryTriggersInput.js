...
/**
 * The TestRepositoryTriggersInput model module.
 * @module model/TestRepositoryTriggersInput
 * @version 2015-04-13
 */
class TestRepositoryTriggersInput {
    /**
     * Constructs a new <code>TestRepositoryTriggersInput</code>.
     * Represents the input of a test repository triggers operation.
     * @alias module:model/TestRepositoryTriggersInput
     * @param repositoryName {String} 
     * @param triggers {Array} 
     */
    constructor(repositoryName, triggers) { 
        
        TestRepositoryTriggersInput.initialize(this, repositoryName, triggers);
    }
     ...
     */
    static initialize(obj, repositoryName, triggers) { 
        obj['repositoryName'] = repositoryName;
        obj['triggers'] = triggers;
    }

    /**
     * Constructs a <code>TestRepositoryTriggersInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TestRepositoryTriggersInput} obj Optional instance to populate.
     * @return {module:model/TestRepositoryTriggersInput} The populated <code>TestRepositoryTriggersInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TestRepositoryTriggersInput();
    ...
    /**
     * Validates the JSON data with respect to <code>TestRepositoryTriggersInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TestRepositoryTriggersInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TestRepositoryTriggersInput.RequiredProperties) {
...
TestRepositoryTriggersInput.RequiredProperties = ["repositoryName", "triggers"];

/**
 * @member {String} repositoryName
 */
TestRepositoryTriggersInput.prototype['repositoryName'] = undefined;

/**
 * @member {Array} triggers
 */
TestRepositoryTriggersInput.prototype['triggers'] = undefined;
...
export default TestRepositoryTriggersInput;
