...
/**
 * The GetCommitOutputCommit model module.
 * @module model/GetCommitOutputCommit
 * @version 2015-04-13
 */
class GetCommitOutputCommit {
    /**
     * Constructs a new <code>GetCommitOutputCommit</code>.
     * @alias module:model/GetCommitOutputCommit
     * @implements module:model/Commit
     */
    constructor() { 
        Commit.initialize(this);
        GetCommitOutputCommit.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetCommitOutputCommit</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCommitOutputCommit} obj Optional instance to populate.
     * @return {module:model/GetCommitOutputCommit} The populated <code>GetCommitOutputCommit</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCommitOutputCommit();
            Commit.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('committer')) {
                obj['committer'] = CommitCommitter.constructFromObject(data['committer']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetCommitOutputCommit</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCommitOutputCommit</code>.
     */
    static validateJSON(data) {
        ...
        if (data['committer']) { // data not null
          CommitCommitter.validateJSON(data['committer']);
        }
        // validate the optional field `additionalData`
        if (data['additionalData']) { // data not null
          String.validateJSON(data['additionalData']);
        }
 ...
 */
GetCommitOutputCommit.prototype['commitId'] = undefined;

/**
 * @member {String} treeId
 */
GetCommitOutputCommit.prototype['treeId'] = undefined;

/**
 * @member {Array} parents
 */
GetCommitOutputCommit.prototype['parents'] = undefined;

/**
 * @member {String} message
 */
GetCommitOutputCommit.prototype['message'] = undefined;

/**
 * @member {module:model/CommitAuthor} author
 */
GetCommitOutputCommit.prototype['author'] = undefined;

/**
 * @member {module:model/CommitCommitter} committer
 */
GetCommitOutputCommit.prototype['committer'] = undefined;

/**
 * @member {String} additionalData
 */
GetCommitOutputCommit.prototype['additionalData'] = undefined;


// Implement Commit interface:
/**
 * @member {String} commitId
 */
Commit.prototype['commitId'] = undefined;
/**
 * @member {String} treeId
 */
Commit.prototype['treeId'] = undefined;
/**
 * @member {Array} parents
 */
 ...
 * @member {String} additionalData
 */
Commit.prototype['additionalData'] = undefined;




export default GetCommitOutputCommit;
