...
/**
 * The ListBranchesOutput model module.
 * @module model/ListBranchesOutput
 * @version 2015-04-13
 */
class ListBranchesOutput {
    /**
     * Constructs a new <code>ListBranchesOutput</code>.
     * Represents the output of a list branches operation.
     * @alias module:model/ListBranchesOutput
     */
    constructor() { 
        
        ListBranchesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListBranchesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListBranchesOutput} obj Optional instance to populate.
     * @return {module:model/ListBranchesOutput} The populated <code>ListBranchesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListBranchesOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListBranchesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListBranchesOutput</code>.
     */
 ...
 */
ListBranchesOutput.prototype['branches'] = undefined;

/**
 * @member {String} nextToken
 */
ListBranchesOutput.prototype['nextToken'] = undefined;
...
export default ListBranchesOutput;
