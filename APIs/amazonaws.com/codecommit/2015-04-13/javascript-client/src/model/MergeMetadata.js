...
/**
 * The MergeMetadata model module.
 * @module model/MergeMetadata
 * @version 2015-04-13
 */
class MergeMetadata {
    /**
     * Constructs a new <code>MergeMetadata</code>.
     * Returns information about a merge or potential merge between a source reference and a destination reference in a pull request.
     * @alias module:model/MergeMetadata
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>MergeMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MergeMetadata} obj Optional instance to populate.
     * @return {module:model/MergeMetadata} The populated <code>MergeMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MergeMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>MergeMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MergeMetadata</code>.
     */
