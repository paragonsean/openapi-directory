...
/**
 * The UpdateCommentInput model module.
 * @module model/UpdateCommentInput
 * @version 2015-04-13
 */
class UpdateCommentInput {
    /**
     * Constructs a new <code>UpdateCommentInput</code>.
     * @alias module:model/UpdateCommentInput
     * @param commentId {String} 
     * @param content {String} 
     */
    constructor(commentId, content) { 
        
        UpdateCommentInput.initialize(this, commentId, content);
    }
     ...
     */
    static initialize(obj, commentId, content) { 
        obj['commentId'] = commentId;
        obj['content'] = content;
    }

    /**
     * Constructs a <code>UpdateCommentInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateCommentInput} obj Optional instance to populate.
     * @return {module:model/UpdateCommentInput} The populated <code>UpdateCommentInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateCommentInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateCommentInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateCommentInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateCommentInput.RequiredProperties) {
...
UpdateCommentInput.RequiredProperties = ["commentId", "content"];

/**
 * @member {String} commentId
 */
UpdateCommentInput.prototype['commentId'] = undefined;

/**
 * @member {String} content
 */
UpdateCommentInput.prototype['content'] = undefined;
