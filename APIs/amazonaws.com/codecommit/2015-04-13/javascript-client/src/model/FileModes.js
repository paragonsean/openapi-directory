...
/**
 * The FileModes model module.
 * @module model/FileModes
 * @version 2015-04-13
 */
class FileModes {
    /**
     * Constructs a new <code>FileModes</code>.
     * Information about file modes in a merge or pull request.
     * @alias module:model/FileModes
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>FileModes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FileModes} obj Optional instance to populate.
     * @return {module:model/FileModes} The populated <code>FileModes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FileModes();
    ...
    /**
     * Validates the JSON data with respect to <code>FileModes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FileModes</code>.
     */
