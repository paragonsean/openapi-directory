...
/**
 * The ListPullRequestsInput model module.
 * @module model/ListPullRequestsInput
 * @version 2015-04-13
 */
class ListPullRequestsInput {
    /**
     * Constructs a new <code>ListPullRequestsInput</code>.
     * @alias module:model/ListPullRequestsInput
     * @param repositoryName {String} 
     */
    constructor(repositoryName) { 
        
        ListPullRequestsInput.initialize(this, repositoryName);
    }
    ...
    /**
     * Constructs a <code>ListPullRequestsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListPullRequestsInput} obj Optional instance to populate.
     * @return {module:model/ListPullRequestsInput} The populated <code>ListPullRequestsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListPullRequestsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListPullRequestsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListPullRequestsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListPullRequestsInput.RequiredProperties) {
...
ListPullRequestsInput.RequiredProperties = ["repositoryName"];

/**
 * @member {String} repositoryName
 */
ListPullRequestsInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} authorArn
 */
ListPullRequestsInput.prototype['authorArn'] = undefined;

/**
 * @member {module:model/PullRequestStatusEnum} pullRequestStatus
 */
ListPullRequestsInput.prototype['pullRequestStatus'] = undefined;

/**
 * @member {String} nextToken
 */
ListPullRequestsInput.prototype['nextToken'] = undefined;

/**
 * @member {Number} maxResults
 */
ListPullRequestsInput.prototype['maxResults'] = undefined;
...
export default ListPullRequestsInput;
