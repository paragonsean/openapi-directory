...
/**
 * The PullRequestEventApprovalRuleEventMetadata model module.
 * @module model/PullRequestEventApprovalRuleEventMetadata
 * @version 2015-04-13
 */
class PullRequestEventApprovalRuleEventMetadata {
    /**
     * Constructs a new <code>PullRequestEventApprovalRuleEventMetadata</code>.
     * @alias module:model/PullRequestEventApprovalRuleEventMetadata
     * @implements module:model/ApprovalRuleEventMetadata
     */
    constructor() { 
        ApprovalRuleEventMetadata.initialize(this);
        PullRequestEventApprovalRuleEventMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PullRequestEventApprovalRuleEventMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PullRequestEventApprovalRuleEventMetadata} obj Optional instance to populate.
     * @return {module:model/PullRequestEventApprovalRuleEventMetadata} The populated <code>PullRequestEventApprovalRuleEventMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PullRequestEventApprovalRuleEventMetadata();
            ApprovalRuleEventMetadata.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>PullRequestEventApprovalRuleEventMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PullRequestEventApprovalRuleEventMetadata</code>.
     */
 ...
 */
PullRequestEventApprovalRuleEventMetadata.prototype['approvalRuleName'] = undefined;

/**
 * @member {String} approvalRuleId
 */
PullRequestEventApprovalRuleEventMetadata.prototype['approvalRuleId'] = undefined;

/**
 * @member {String} approvalRuleContent
 */
PullRequestEventApprovalRuleEventMetadata.prototype['approvalRuleContent'] = undefined;


// Implement ApprovalRuleEventMetadata interface:
/**
 * @member {String} approvalRuleName
 */
...
export default PullRequestEventApprovalRuleEventMetadata;
