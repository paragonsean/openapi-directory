...
/**
 * The UpdateApprovalRuleTemplateContentInput model module.
 * @module model/UpdateApprovalRuleTemplateContentInput
 * @version 2015-04-13
 */
class UpdateApprovalRuleTemplateContentInput {
    /**
     * Constructs a new <code>UpdateApprovalRuleTemplateContentInput</code>.
     * @alias module:model/UpdateApprovalRuleTemplateContentInput
     * @param approvalRuleTemplateName {String} 
     * @param newRuleContent {String} 
     */
    constructor(approvalRuleTemplateName, newRuleContent) { 
        
        UpdateApprovalRuleTemplateContentInput.initialize(this, approvalRuleTemplateName, newRuleContent);
    }
     ...
     */
    static initialize(obj, approvalRuleTemplateName, newRuleContent) { 
        obj['approvalRuleTemplateName'] = approvalRuleTemplateName;
        obj['newRuleContent'] = newRuleContent;
    }

    /**
     * Constructs a <code>UpdateApprovalRuleTemplateContentInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateApprovalRuleTemplateContentInput} obj Optional instance to populate.
     * @return {module:model/UpdateApprovalRuleTemplateContentInput} The populated <code>UpdateApprovalRuleTemplateContentInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateApprovalRuleTemplateContentInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateApprovalRuleTemplateContentInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateApprovalRuleTemplateContentInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateApprovalRuleTemplateContentInput.RequiredProperties) {
...
UpdateApprovalRuleTemplateContentInput.RequiredProperties = ["approvalRuleTemplateName", "newRuleContent"];

/**
 * @member {String} approvalRuleTemplateName
 */
UpdateApprovalRuleTemplateContentInput.prototype['approvalRuleTemplateName'] = undefined;

/**
 * @member {String} newRuleContent
 */
UpdateApprovalRuleTemplateContentInput.prototype['newRuleContent'] = undefined;

/**
 * @member {String} existingRuleContentSha256
 */
UpdateApprovalRuleTemplateContentInput.prototype['existingRuleContentSha256'] = undefined;
...
export default UpdateApprovalRuleTemplateContentInput;
