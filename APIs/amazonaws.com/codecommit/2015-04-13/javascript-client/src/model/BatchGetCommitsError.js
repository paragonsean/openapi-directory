...
/**
 * The BatchGetCommitsError model module.
 * @module model/BatchGetCommitsError
 * @version 2015-04-13
 */
class BatchGetCommitsError {
    /**
     * Constructs a new <code>BatchGetCommitsError</code>.
     * Returns information about errors in a BatchGetCommits operation.
     * @alias module:model/BatchGetCommitsError
     */
    constructor() { 
        
        BatchGetCommitsError.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchGetCommitsError</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchGetCommitsError} obj Optional instance to populate.
     * @return {module:model/BatchGetCommitsError} The populated <code>BatchGetCommitsError</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchGetCommitsError();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchGetCommitsError</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchGetCommitsError</code>.
     */
 ...
 */
BatchGetCommitsError.prototype['commitId'] = undefined;

/**
 * @member {String} errorCode
 */
BatchGetCommitsError.prototype['errorCode'] = undefined;

/**
 * @member {String} errorMessage
 */
BatchGetCommitsError.prototype['errorMessage'] = undefined;
...
export default BatchGetCommitsError;
