...
/**
 * The CreatePullRequestOutputPullRequest model module.
 * @module model/CreatePullRequestOutputPullRequest
 * @version 2015-04-13
 */
class CreatePullRequestOutputPullRequest {
    /**
     * Constructs a new <code>CreatePullRequestOutputPullRequest</code>.
     * @alias module:model/CreatePullRequestOutputPullRequest
     * @implements module:model/PullRequest
     */
    constructor() { 
        PullRequest.initialize(this);
        CreatePullRequestOutputPullRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreatePullRequestOutputPullRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePullRequestOutputPullRequest} obj Optional instance to populate.
     * @return {module:model/CreatePullRequestOutputPullRequest} The populated <code>CreatePullRequestOutputPullRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePullRequestOutputPullRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePullRequestOutputPullRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePullRequestOutputPullRequest</code>.
     */
 ...
 */
CreatePullRequestOutputPullRequest.prototype['pullRequestId'] = undefined;

/**
 * @member {String} title
 */
CreatePullRequestOutputPullRequest.prototype['title'] = undefined;

/**
 * @member {String} description
 */
CreatePullRequestOutputPullRequest.prototype['description'] = undefined;

/**
 * @member {Date} lastActivityDate
 */
CreatePullRequestOutputPullRequest.prototype['lastActivityDate'] = undefined;

/**
 * @member {Date} creationDate
 */
CreatePullRequestOutputPullRequest.prototype['creationDate'] = undefined;

/**
 * @member {module:model/PullRequestStatusEnum} pullRequestStatus
 */
CreatePullRequestOutputPullRequest.prototype['pullRequestStatus'] = undefined;

/**
 * @member {String} authorArn
 */
CreatePullRequestOutputPullRequest.prototype['authorArn'] = undefined;

/**
 * @member {Array} pullRequestTargets
 */
CreatePullRequestOutputPullRequest.prototype['pullRequestTargets'] = undefined;

/**
 * @member {String} clientRequestToken
 */
CreatePullRequestOutputPullRequest.prototype['clientRequestToken'] = undefined;

/**
 * @member {String} revisionId
 */
CreatePullRequestOutputPullRequest.prototype['revisionId'] = undefined;

/**
 * @member {Array} approvalRules
 */
CreatePullRequestOutputPullRequest.prototype['approvalRules'] = undefined;
...
export default CreatePullRequestOutputPullRequest;
