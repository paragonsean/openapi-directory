...
/**
 * The DeletePullRequestApprovalRuleInput model module.
 * @module model/DeletePullRequestApprovalRuleInput
 * @version 2015-04-13
 */
class DeletePullRequestApprovalRuleInput {
    /**
     * Constructs a new <code>DeletePullRequestApprovalRuleInput</code>.
     * @alias module:model/DeletePullRequestApprovalRuleInput
     * @param pullRequestId {String} 
     * @param approvalRuleName {String} 
     */
    constructor(pullRequestId, approvalRuleName) { 
        
        DeletePullRequestApprovalRuleInput.initialize(this, pullRequestId, approvalRuleName);
    }
     ...
     */
    static initialize(obj, pullRequestId, approvalRuleName) { 
        obj['pullRequestId'] = pullRequestId;
        obj['approvalRuleName'] = approvalRuleName;
    }

    /**
     * Constructs a <code>DeletePullRequestApprovalRuleInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeletePullRequestApprovalRuleInput} obj Optional instance to populate.
     * @return {module:model/DeletePullRequestApprovalRuleInput} The populated <code>DeletePullRequestApprovalRuleInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeletePullRequestApprovalRuleInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeletePullRequestApprovalRuleInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeletePullRequestApprovalRuleInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeletePullRequestApprovalRuleInput.RequiredProperties) {
...
DeletePullRequestApprovalRuleInput.RequiredProperties = ["pullRequestId", "approvalRuleName"];

/**
 * @member {String} pullRequestId
 */
DeletePullRequestApprovalRuleInput.prototype['pullRequestId'] = undefined;

/**
 * @member {String} approvalRuleName
 */
DeletePullRequestApprovalRuleInput.prototype['approvalRuleName'] = undefined;
...
export default DeletePullRequestApprovalRuleInput;
