...
/**
 * The GetPullRequestOutputPullRequest model module.
 * @module model/GetPullRequestOutputPullRequest
 * @version 2015-04-13
 */
class GetPullRequestOutputPullRequest {
    /**
     * Constructs a new <code>GetPullRequestOutputPullRequest</code>.
     * @alias module:model/GetPullRequestOutputPullRequest
     * @implements module:model/PullRequest
     */
    constructor() { 
        PullRequest.initialize(this);
        GetPullRequestOutputPullRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetPullRequestOutputPullRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPullRequestOutputPullRequest} obj Optional instance to populate.
     * @return {module:model/GetPullRequestOutputPullRequest} The populated <code>GetPullRequestOutputPullRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPullRequestOutputPullRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetPullRequestOutputPullRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPullRequestOutputPullRequest</code>.
     */
 ...
 */
GetPullRequestOutputPullRequest.prototype['pullRequestId'] = undefined;

/**
 * @member {String} title
 */
GetPullRequestOutputPullRequest.prototype['title'] = undefined;

/**
 * @member {String} description
 */
GetPullRequestOutputPullRequest.prototype['description'] = undefined;

/**
 * @member {Date} lastActivityDate
 */
GetPullRequestOutputPullRequest.prototype['lastActivityDate'] = undefined;

/**
 * @member {Date} creationDate
 */
GetPullRequestOutputPullRequest.prototype['creationDate'] = undefined;

/**
 * @member {module:model/PullRequestStatusEnum} pullRequestStatus
 */
GetPullRequestOutputPullRequest.prototype['pullRequestStatus'] = undefined;

/**
 * @member {String} authorArn
 */
GetPullRequestOutputPullRequest.prototype['authorArn'] = undefined;

/**
 * @member {Array} pullRequestTargets
 */
GetPullRequestOutputPullRequest.prototype['pullRequestTargets'] = undefined;

/**
 * @member {String} clientRequestToken
 */
GetPullRequestOutputPullRequest.prototype['clientRequestToken'] = undefined;

/**
 * @member {String} revisionId
 */
GetPullRequestOutputPullRequest.prototype['revisionId'] = undefined;

/**
 * @member {Array} approvalRules
 */
GetPullRequestOutputPullRequest.prototype['approvalRules'] = undefined;
...
export default GetPullRequestOutputPullRequest;
