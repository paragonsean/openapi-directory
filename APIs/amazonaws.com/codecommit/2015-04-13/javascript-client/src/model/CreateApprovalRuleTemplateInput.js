...
/**
 * The CreateApprovalRuleTemplateInput model module.
 * @module model/CreateApprovalRuleTemplateInput
 * @version 2015-04-13
 */
class CreateApprovalRuleTemplateInput {
    /**
     * Constructs a new <code>CreateApprovalRuleTemplateInput</code>.
     * @alias module:model/CreateApprovalRuleTemplateInput
     * @param approvalRuleTemplateName {String} 
     * @param approvalRuleTemplateContent {String} 
     */
    constructor(approvalRuleTemplateName, approvalRuleTemplateContent) { 
        
        CreateApprovalRuleTemplateInput.initialize(this, approvalRuleTemplateName, approvalRuleTemplateContent);
    }
     ...
     */
    static initialize(obj, approvalRuleTemplateName, approvalRuleTemplateContent) { 
        obj['approvalRuleTemplateName'] = approvalRuleTemplateName;
        obj['approvalRuleTemplateContent'] = approvalRuleTemplateContent;
    }

    /**
     * Constructs a <code>CreateApprovalRuleTemplateInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateApprovalRuleTemplateInput} obj Optional instance to populate.
     * @return {module:model/CreateApprovalRuleTemplateInput} The populated <code>CreateApprovalRuleTemplateInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateApprovalRuleTemplateInput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateApprovalRuleTemplateInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateApprovalRuleTemplateInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateApprovalRuleTemplateInput.RequiredProperties) {
...
CreateApprovalRuleTemplateInput.RequiredProperties = ["approvalRuleTemplateName", "approvalRuleTemplateContent"];

/**
 * @member {String} approvalRuleTemplateName
 */
CreateApprovalRuleTemplateInput.prototype['approvalRuleTemplateName'] = undefined;

/**
 * @member {String} approvalRuleTemplateContent
 */
CreateApprovalRuleTemplateInput.prototype['approvalRuleTemplateContent'] = undefined;

/**
 * @member {String} approvalRuleTemplateDescription
 */
CreateApprovalRuleTemplateInput.prototype['approvalRuleTemplateDescription'] = undefined;
...
export default CreateApprovalRuleTemplateInput;
