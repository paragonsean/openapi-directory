...
/**
 * The SourceFileSpecifier model module.
 * @module model/SourceFileSpecifier
 * @version 2015-04-13
 */
class SourceFileSpecifier {
    /**
     * Constructs a new <code>SourceFileSpecifier</code>.
     * Information about a source file that is part of changes made in a commit.
     * @alias module:model/SourceFileSpecifier
     * @param filePath {String} 
     */
    constructor(filePath) { 
        
        SourceFileSpecifier.initialize(this, filePath);
    }
     ...
     */
    static initialize(obj, filePath) { 
        obj['filePath'] = filePath;
    }

    /**
     * Constructs a <code>SourceFileSpecifier</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SourceFileSpecifier} obj Optional instance to populate.
     * @return {module:model/SourceFileSpecifier} The populated <code>SourceFileSpecifier</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SourceFileSpecifier();

            if (data.hasOwnProperty('filePath')) {
                obj['filePath'] = ApiClient.convertToType(data['filePath'], 'String');
            }
            if (data.hasOwnProperty('isMove')) {
                obj['isMove'] = ApiClient.convertToType(data['isMove'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SourceFileSpecifier</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SourceFileSpecifier</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SourceFileSpecifier.RequiredProperties) {
        ...
        // validate the optional field `isMove`
        if (data['isMove']) { // data not null
          Boolean.validateJSON(data['isMove']);
        }
...
SourceFileSpecifier.RequiredProperties = ["filePath"];

/**
 * @member {String} filePath
 */
SourceFileSpecifier.prototype['filePath'] = undefined;

/**
 * @member {Boolean} isMove
 */
SourceFileSpecifier.prototype['isMove'] = undefined;
...
export default SourceFileSpecifier;
