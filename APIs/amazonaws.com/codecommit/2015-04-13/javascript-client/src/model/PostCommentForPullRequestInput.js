...
import PostCommentForPullRequestInputLocation from './PostCommentForPullRequestInputLocation';

/**
 * The PostCommentForPullRequestInput model module.
 * @module model/PostCommentForPullRequestInput
 * @version 2015-04-13
 */
class PostCommentForPullRequestInput {
    /**
     * Constructs a new <code>PostCommentForPullRequestInput</code>.
     * @alias module:model/PostCommentForPullRequestInput
     * @param pullRequestId {String} 
     * @param repositoryName {String} 
     * @param beforeCommitId {String} 
     * @param afterCommitId {String} 
     * @param content {String} 
     */
    constructor(pullRequestId, repositoryName, beforeCommitId, afterCommitId, content) { 
        
        PostCommentForPullRequestInput.initialize(this, pullRequestId, repositoryName, beforeCommitId, afterCommitId, content);
    }
     ...
     */
    static initialize(obj, pullRequestId, repositoryName, beforeCommitId, afterCommitId, content) { 
        obj['pullRequestId'] = pullRequestId;
        obj['repositoryName'] = repositoryName;
        obj['beforeCommitId'] = beforeCommitId;
        obj['afterCommitId'] = afterCommitId;
        obj['content'] = content;
    }

    /**
     * Constructs a <code>PostCommentForPullRequestInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostCommentForPullRequestInput} obj Optional instance to populate.
     * @return {module:model/PostCommentForPullRequestInput} The populated <code>PostCommentForPullRequestInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostCommentForPullRequestInput();
            ...
            if (data.hasOwnProperty('location')) {
                obj['location'] = PostCommentForPullRequestInputLocation.constructFromObject(data['location']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PostCommentForPullRequestInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostCommentForPullRequestInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PostCommentForPullRequestInput.RequiredProperties) {
        ...
        if (data['location']) { // data not null
          PostCommentForPullRequestInputLocation.validateJSON(data['location']);
        }
...
PostCommentForPullRequestInput.RequiredProperties = ["pullRequestId", "repositoryName", "beforeCommitId", "afterCommitId", "content"];

/**
 * @member {String} pullRequestId
 */
PostCommentForPullRequestInput.prototype['pullRequestId'] = undefined;

/**
 * @member {String} repositoryName
 */
PostCommentForPullRequestInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} beforeCommitId
 */
PostCommentForPullRequestInput.prototype['beforeCommitId'] = undefined;

/**
 * @member {String} afterCommitId
 */
PostCommentForPullRequestInput.prototype['afterCommitId'] = undefined;

/**
 * @member {module:model/PostCommentForPullRequestInputLocation} location
 */
PostCommentForPullRequestInput.prototype['location'] = undefined;

/**
 * @member {String} content
 */
PostCommentForPullRequestInput.prototype['content'] = undefined;

/**
 * @member {String} clientRequestToken
 */
PostCommentForPullRequestInput.prototype['clientRequestToken'] = undefined;
...
export default PostCommentForPullRequestInput;
