...
/**
 * The GetPullRequestOverrideStateOutput model module.
 * @module model/GetPullRequestOverrideStateOutput
 * @version 2015-04-13
 */
class GetPullRequestOverrideStateOutput {
    /**
     * Constructs a new <code>GetPullRequestOverrideStateOutput</code>.
     * @alias module:model/GetPullRequestOverrideStateOutput
     */
    constructor() { 
        
        GetPullRequestOverrideStateOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetPullRequestOverrideStateOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPullRequestOverrideStateOutput} obj Optional instance to populate.
     * @return {module:model/GetPullRequestOverrideStateOutput} The populated <code>GetPullRequestOverrideStateOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPullRequestOverrideStateOutput();

            if (data.hasOwnProperty('overridden')) {
                obj['overridden'] = ApiClient.convertToType(data['overridden'], 'Boolean');
            }
            if (data.hasOwnProperty('overrider')) {
                obj['overrider'] = ApiClient.convertToType(data['overrider'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetPullRequestOverrideStateOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPullRequestOverrideStateOutput</code>.
     */
    static validateJSON(data) {
        ...
        // validate the optional field `overrider`
        if (data['overrider']) { // data not null
          String.validateJSON(data['overrider']);
        }
 ...
 */
GetPullRequestOverrideStateOutput.prototype['overridden'] = undefined;

/**
 * @member {String} overrider
 */
GetPullRequestOverrideStateOutput.prototype['overrider'] = undefined;
...
export default GetPullRequestOverrideStateOutput;
