...
/**
 * The DisassociateApprovalRuleTemplateFromRepositoryInput model module.
 * @module model/DisassociateApprovalRuleTemplateFromRepositoryInput
 * @version 2015-04-13
 */
class DisassociateApprovalRuleTemplateFromRepositoryInput {
    /**
     * Constructs a new <code>DisassociateApprovalRuleTemplateFromRepositoryInput</code>.
     * @alias module:model/DisassociateApprovalRuleTemplateFromRepositoryInput
     * @param approvalRuleTemplateName {String} 
     * @param repositoryName {String} 
     */
    constructor(approvalRuleTemplateName, repositoryName) { 
        
        DisassociateApprovalRuleTemplateFromRepositoryInput.initialize(this, approvalRuleTemplateName, repositoryName);
    }
    ...
    /**
     * Constructs a <code>DisassociateApprovalRuleTemplateFromRepositoryInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisassociateApprovalRuleTemplateFromRepositoryInput} obj Optional instance to populate.
     * @return {module:model/DisassociateApprovalRuleTemplateFromRepositoryInput} The populated <code>DisassociateApprovalRuleTemplateFromRepositoryInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisassociateApprovalRuleTemplateFromRepositoryInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DisassociateApprovalRuleTemplateFromRepositoryInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisassociateApprovalRuleTemplateFromRepositoryInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DisassociateApprovalRuleTemplateFromRepositoryInput.RequiredProperties) {
...
DisassociateApprovalRuleTemplateFromRepositoryInput.RequiredProperties = ["approvalRuleTemplateName", "repositoryName"];

/**
 * @member {String} approvalRuleTemplateName
 */
DisassociateApprovalRuleTemplateFromRepositoryInput.prototype['approvalRuleTemplateName'] = undefined;

/**
 * @member {String} repositoryName
 */
DisassociateApprovalRuleTemplateFromRepositoryInput.prototype['repositoryName'] = undefined;
...
export default DisassociateApprovalRuleTemplateFromRepositoryInput;
