...
import GetCommitOutputCommit from './GetCommitOutputCommit';

/**
 * The GetCommitOutput model module.
 * @module model/GetCommitOutput
 * @version 2015-04-13
 */
class GetCommitOutput {
    /**
     * Constructs a new <code>GetCommitOutput</code>.
     * Represents the output of a get commit operation.
     * @alias module:model/GetCommitOutput
     * @param commit {module:model/GetCommitOutputCommit} 
     */
    constructor(commit) { 
        
        GetCommitOutput.initialize(this, commit);
    }
     ...
     */
    static initialize(obj, commit) { 
        obj['commit'] = commit;
    }

    /**
     * Constructs a <code>GetCommitOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCommitOutput} obj Optional instance to populate.
     * @return {module:model/GetCommitOutput} The populated <code>GetCommitOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCommitOutput();

            if (data.hasOwnProperty('commit')) {
                obj['commit'] = GetCommitOutputCommit.constructFromObject(data['commit']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetCommitOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCommitOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetCommitOutput.RequiredProperties) {
        ...
        if (data['commit']) { // data not null
          GetCommitOutputCommit.validateJSON(data['commit']);
        }
...
GetCommitOutput.RequiredProperties = ["commit"];

/**
 * @member {module:model/GetCommitOutputCommit} commit
 */
GetCommitOutput.prototype['commit'] = undefined;
...
export default GetCommitOutput;
