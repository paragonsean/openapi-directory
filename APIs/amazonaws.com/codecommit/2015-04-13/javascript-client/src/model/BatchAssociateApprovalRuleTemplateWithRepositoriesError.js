...
/**
 * The BatchAssociateApprovalRuleTemplateWithRepositoriesError model module.
 * @module model/BatchAssociateApprovalRuleTemplateWithRepositoriesError
 * @version 2015-04-13
 */
class BatchAssociateApprovalRuleTemplateWithRepositoriesError {
    /**
     * Constructs a new <code>BatchAssociateApprovalRuleTemplateWithRepositoriesError</code>.
     * Returns information about errors in a BatchAssociateApprovalRuleTemplateWithRepositories operation.
     * @alias module:model/BatchAssociateApprovalRuleTemplateWithRepositoriesError
     */
    constructor() { 
        
        BatchAssociateApprovalRuleTemplateWithRepositoriesError.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchAssociateApprovalRuleTemplateWithRepositoriesError</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchAssociateApprovalRuleTemplateWithRepositoriesError} obj Optional instance to populate.
     * @return {module:model/BatchAssociateApprovalRuleTemplateWithRepositoriesError} The populated <code>BatchAssociateApprovalRuleTemplateWithRepositoriesError</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchAssociateApprovalRuleTemplateWithRepositoriesError();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchAssociateApprovalRuleTemplateWithRepositoriesError</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchAssociateApprovalRuleTemplateWithRepositoriesError</code>.
     */
 ...
 */
BatchAssociateApprovalRuleTemplateWithRepositoriesError.prototype['repositoryName'] = undefined;

/**
 * @member {String} errorCode
 */
BatchAssociateApprovalRuleTemplateWithRepositoriesError.prototype['errorCode'] = undefined;

/**
 * @member {String} errorMessage
 */
BatchAssociateApprovalRuleTemplateWithRepositoriesError.prototype['errorMessage'] = undefined;
...
export default BatchAssociateApprovalRuleTemplateWithRepositoriesError;
