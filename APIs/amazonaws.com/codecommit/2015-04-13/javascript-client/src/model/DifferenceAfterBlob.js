...
/**
 * The DifferenceAfterBlob model module.
 * @module model/DifferenceAfterBlob
 * @version 2015-04-13
 */
class DifferenceAfterBlob {
    /**
     * Constructs a new <code>DifferenceAfterBlob</code>.
     * @alias module:model/DifferenceAfterBlob
     * @implements module:model/BlobMetadata
     */
    constructor() { 
        BlobMetadata.initialize(this);
        DifferenceAfterBlob.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DifferenceAfterBlob</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DifferenceAfterBlob} obj Optional instance to populate.
     * @return {module:model/DifferenceAfterBlob} The populated <code>DifferenceAfterBlob</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DifferenceAfterBlob();
            BlobMetadata.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DifferenceAfterBlob</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DifferenceAfterBlob</code>.
     */
 ...
 */
DifferenceAfterBlob.prototype['blobId'] = undefined;

/**
 * @member {String} path
 */
DifferenceAfterBlob.prototype['path'] = undefined;

/**
 * @member {String} mode
 */
DifferenceAfterBlob.prototype['mode'] = undefined;


// Implement BlobMetadata interface:
/**
 * @member {String} blobId
 */
...
export default DifferenceAfterBlob;
