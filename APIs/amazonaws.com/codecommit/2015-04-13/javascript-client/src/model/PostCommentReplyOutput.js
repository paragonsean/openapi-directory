...
import PostCommentReplyOutputComment from './PostCommentReplyOutputComment';

/**
 * The PostCommentReplyOutput model module.
 * @module model/PostCommentReplyOutput
 * @version 2015-04-13
 */
class PostCommentReplyOutput {
    /**
     * Constructs a new <code>PostCommentReplyOutput</code>.
     * @alias module:model/PostCommentReplyOutput
     */
    constructor() { 
        
        PostCommentReplyOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostCommentReplyOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostCommentReplyOutput} obj Optional instance to populate.
     * @return {module:model/PostCommentReplyOutput} The populated <code>PostCommentReplyOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostCommentReplyOutput();

            if (data.hasOwnProperty('comment')) {
                obj['comment'] = PostCommentReplyOutputComment.constructFromObject(data['comment']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PostCommentReplyOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostCommentReplyOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `comment`
        if (data['comment']) { // data not null
          PostCommentReplyOutputComment.validateJSON(data['comment']);
        }
...
/**
 * @member {module:model/PostCommentReplyOutputComment} comment
 */
PostCommentReplyOutput.prototype['comment'] = undefined;
...
export default PostCommentReplyOutput;
