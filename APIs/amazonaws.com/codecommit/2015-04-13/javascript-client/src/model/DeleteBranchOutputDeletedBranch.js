...
/**
 * The DeleteBranchOutputDeletedBranch model module.
 * @module model/DeleteBranchOutputDeletedBranch
 * @version 2015-04-13
 */
class DeleteBranchOutputDeletedBranch {
    /**
     * Constructs a new <code>DeleteBranchOutputDeletedBranch</code>.
     * @alias module:model/DeleteBranchOutputDeletedBranch
     * @implements module:model/BranchInfo
     */
    constructor() { 
        BranchInfo.initialize(this);
        DeleteBranchOutputDeletedBranch.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteBranchOutputDeletedBranch</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteBranchOutputDeletedBranch} obj Optional instance to populate.
     * @return {module:model/DeleteBranchOutputDeletedBranch} The populated <code>DeleteBranchOutputDeletedBranch</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteBranchOutputDeletedBranch();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteBranchOutputDeletedBranch</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteBranchOutputDeletedBranch</code>.
     */
 ...
 */
DeleteBranchOutputDeletedBranch.prototype['branchName'] = undefined;

/**
 * @member {String} commitId
 */
DeleteBranchOutputDeletedBranch.prototype['commitId'] = undefined;
...
export default DeleteBranchOutputDeletedBranch;
