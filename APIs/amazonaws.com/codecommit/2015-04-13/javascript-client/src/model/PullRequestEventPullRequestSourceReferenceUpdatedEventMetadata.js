...
/**
 * The PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata model module.
 * @module model/PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata
 * @version 2015-04-13
 */
class PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata {
    /**
     * Constructs a new <code>PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata</code>.
     * @alias module:model/PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata
     * @implements module:model/PullRequestSourceReferenceUpdatedEventMetadata
     */
    constructor() { 
        PullRequestSourceReferenceUpdatedEventMetadata.initialize(this);
        PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata} obj Optional instance to populate.
     * @return {module:model/PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata} The populated <code>PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata();
            PullRequestSourceReferenceUpdatedEventMetadata.constructFromObject(data, obj);

            if (data.hasOwnProperty('repositoryName')) {
                obj['repositoryName'] = ApiClient.convertToType(data['repositoryName'], 'String');
            }
            if (data.hasOwnProperty('beforeCommitId')) {
                obj['beforeCommitId'] = ApiClient.convertToType(data['beforeCommitId'], 'String');
            }
            if (data.hasOwnProperty('afterCommitId')) {
                obj['afterCommitId'] = ApiClient.convertToType(data['afterCommitId'], 'String');
            }
            if (data.hasOwnProperty('mergeBase')) {
                obj['mergeBase'] = ApiClient.convertToType(data['mergeBase'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata</code>.
     */
    static validateJSON(data) {
        ...
        if (data['beforeCommitId']) { // data not null
          String.validateJSON(data['beforeCommitId']);
        }
        // validate the optional field `afterCommitId`
        if (data['afterCommitId']) { // data not null
          String.validateJSON(data['afterCommitId']);
        }
        // validate the optional field `mergeBase`
        if (data['mergeBase']) { // data not null
          String.validateJSON(data['mergeBase']);
        }
 ...
 */
PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata.prototype['repositoryName'] = undefined;

/**
 * @member {String} beforeCommitId
 */
PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata.prototype['beforeCommitId'] = undefined;

/**
 * @member {String} afterCommitId
 */
PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata.prototype['afterCommitId'] = undefined;

/**
 * @member {String} mergeBase
 */
PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata.prototype['mergeBase'] = undefined;


// Implement PullRequestSourceReferenceUpdatedEventMetadata interface:
/**
 * @member {String} repositoryName
 */
PullRequestSourceReferenceUpdatedEventMetadata.prototype['repositoryName'] = undefined;
/**
 * @member {String} beforeCommitId
 */
PullRequestSourceReferenceUpdatedEventMetadata.prototype['beforeCommitId'] = undefined;
/**
 * @member {String} afterCommitId
 */
PullRequestSourceReferenceUpdatedEventMetadata.prototype['afterCommitId'] = undefined;
/**
 * @member {String} mergeBase
 */
PullRequestSourceReferenceUpdatedEventMetadata.prototype['mergeBase'] = undefined;




export default PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata;
