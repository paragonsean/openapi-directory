...
/**
 * The PutFileOutput model module.
 * @module model/PutFileOutput
 * @version 2015-04-13
 */
class PutFileOutput {
    /**
     * Constructs a new <code>PutFileOutput</code>.
     * @alias module:model/PutFileOutput
     * @param commitId {String} 
     * @param blobId {String} 
     * @param treeId {String} 
     */
    constructor(commitId, blobId, treeId) { 
        
        PutFileOutput.initialize(this, commitId, blobId, treeId);
    }
     ...
     */
    static initialize(obj, commitId, blobId, treeId) { 
    ...
    /**
     * Constructs a <code>PutFileOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutFileOutput} obj Optional instance to populate.
     * @return {module:model/PutFileOutput} The populated <code>PutFileOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutFileOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>PutFileOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutFileOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutFileOutput.RequiredProperties) {
        ...
        if (data['blobId']) { // data not null
          String.validateJSON(data['blobId']);
        }
        // validate the optional field `treeId`
        if (data['treeId']) { // data not null
          String.validateJSON(data['treeId']);
        }
...
PutFileOutput.RequiredProperties = ["commitId", "blobId", "treeId"];

/**
 * @member {String} commitId
 */
PutFileOutput.prototype['commitId'] = undefined;

/**
 * @member {String} blobId
 */
PutFileOutput.prototype['blobId'] = undefined;

/**
 * @member {String} treeId
 */
PutFileOutput.prototype['treeId'] = undefined;
