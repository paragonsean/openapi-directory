...
/**
 * The ListBranchesInput model module.
 * @module model/ListBranchesInput
 * @version 2015-04-13
 */
class ListBranchesInput {
    /**
     * Constructs a new <code>ListBranchesInput</code>.
     * Represents the input of a list branches operation.
     * @alias module:model/ListBranchesInput
     * @param repositoryName {String} 
     */
    constructor(repositoryName) { 
        
        ListBranchesInput.initialize(this, repositoryName);
    }
    ...
    /**
     * Constructs a <code>ListBranchesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListBranchesInput} obj Optional instance to populate.
     * @return {module:model/ListBranchesInput} The populated <code>ListBranchesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListBranchesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListBranchesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListBranchesInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListBranchesInput.RequiredProperties) {
...
ListBranchesInput.RequiredProperties = ["repositoryName"];

/**
 * @member {String} repositoryName
 */
ListBranchesInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} nextToken
 */
ListBranchesInput.prototype['nextToken'] = undefined;
...
export default ListBranchesInput;
