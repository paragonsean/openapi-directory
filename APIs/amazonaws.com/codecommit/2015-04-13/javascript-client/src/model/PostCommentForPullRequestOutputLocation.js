...
/**
 * The PostCommentForPullRequestOutputLocation model module.
 * @module model/PostCommentForPullRequestOutputLocation
 * @version 2015-04-13
 */
class PostCommentForPullRequestOutputLocation {
    /**
     * Constructs a new <code>PostCommentForPullRequestOutputLocation</code>.
     * @alias module:model/PostCommentForPullRequestOutputLocation
     * @implements module:model/Location
     */
    constructor() { 
        Location.initialize(this);
        PostCommentForPullRequestOutputLocation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostCommentForPullRequestOutputLocation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostCommentForPullRequestOutputLocation} obj Optional instance to populate.
     * @return {module:model/PostCommentForPullRequestOutputLocation} The populated <code>PostCommentForPullRequestOutputLocation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostCommentForPullRequestOutputLocation();
    ...
    /**
     * Validates the JSON data with respect to <code>PostCommentForPullRequestOutputLocation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostCommentForPullRequestOutputLocation</code>.
     */
 ...
 */
PostCommentForPullRequestOutputLocation.prototype['filePath'] = undefined;

/**
 * @member {Number} filePosition
 */
PostCommentForPullRequestOutputLocation.prototype['filePosition'] = undefined;

/**
 * @member {module:model/RelativeFileVersionEnum} relativeFileVersion
 */
PostCommentForPullRequestOutputLocation.prototype['relativeFileVersion'] = undefined;
...
export default PostCommentForPullRequestOutputLocation;
