...
/**
 * The ConflictMetadataFileSizes model module.
 * @module model/ConflictMetadataFileSizes
 * @version 2015-04-13
 */
class ConflictMetadataFileSizes {
    /**
     * Constructs a new <code>ConflictMetadataFileSizes</code>.
     * @alias module:model/ConflictMetadataFileSizes
     * @implements module:model/FileSizes
     */
    constructor() { 
        FileSizes.initialize(this);
        ConflictMetadataFileSizes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ConflictMetadataFileSizes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConflictMetadataFileSizes} obj Optional instance to populate.
     * @return {module:model/ConflictMetadataFileSizes} The populated <code>ConflictMetadataFileSizes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConflictMetadataFileSizes();
            FileSizes.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ConflictMetadataFileSizes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConflictMetadataFileSizes</code>.
     */
    static validateJSON(data) {
        // validate the optional field `source`
        if (data['source']) { // data not null
          Number.validateJSON(data['source']);
        }
        // validate the optional field `destination`
        if (data['destination']) { // data not null
          Number.validateJSON(data['destination']);
        }
 ...
 */
ConflictMetadataFileSizes.prototype['source'] = undefined;

/**
 * @member {Number} destination
 */
ConflictMetadataFileSizes.prototype['destination'] = undefined;

/**
 * @member {Number} base
 */
ConflictMetadataFileSizes.prototype['base'] = undefined;


// Implement FileSizes interface:
/**
 * @member {Number} source
 */
FileSizes.prototype['source'] = undefined;
/**
 * @member {Number} destination
 */
FileSizes.prototype['destination'] = undefined;
/**
 * @member {Number} base
 */
FileSizes.prototype['base'] = undefined;




export default ConflictMetadataFileSizes;
