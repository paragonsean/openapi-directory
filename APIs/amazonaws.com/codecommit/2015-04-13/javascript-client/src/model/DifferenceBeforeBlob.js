...
/**
 * The DifferenceBeforeBlob model module.
 * @module model/DifferenceBeforeBlob
 * @version 2015-04-13
 */
class DifferenceBeforeBlob {
    /**
     * Constructs a new <code>DifferenceBeforeBlob</code>.
     * @alias module:model/DifferenceBeforeBlob
     * @implements module:model/BlobMetadata
     */
    constructor() { 
        BlobMetadata.initialize(this);
        DifferenceBeforeBlob.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DifferenceBeforeBlob</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DifferenceBeforeBlob} obj Optional instance to populate.
     * @return {module:model/DifferenceBeforeBlob} The populated <code>DifferenceBeforeBlob</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DifferenceBeforeBlob();
    ...
    /**
     * Validates the JSON data with respect to <code>DifferenceBeforeBlob</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DifferenceBeforeBlob</code>.
     */
 ...
 */
DifferenceBeforeBlob.prototype['blobId'] = undefined;

/**
 * @member {String} path
 */
DifferenceBeforeBlob.prototype['path'] = undefined;

/**
 * @member {String} mode
 */
DifferenceBeforeBlob.prototype['mode'] = undefined;
...
export default DifferenceBeforeBlob;
