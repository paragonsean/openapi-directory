...
import UpdatePullRequestDescriptionOutputPullRequest from './UpdatePullRequestDescriptionOutputPullRequest';

/**
 * The UpdatePullRequestTitleOutput model module.
 * @module model/UpdatePullRequestTitleOutput
 * @version 2015-04-13
 */
class UpdatePullRequestTitleOutput {
    /**
     * Constructs a new <code>UpdatePullRequestTitleOutput</code>.
     * @alias module:model/UpdatePullRequestTitleOutput
     * @param pullRequest {module:model/UpdatePullRequestDescriptionOutputPullRequest} 
     */
    constructor(pullRequest) { 
        
        UpdatePullRequestTitleOutput.initialize(this, pullRequest);
    }
    ...
    static initialize(obj, pullRequest) { 
        obj['pullRequest'] = pullRequest;
    }

    /**
     * Constructs a <code>UpdatePullRequestTitleOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePullRequestTitleOutput} obj Optional instance to populate.
     * @return {module:model/UpdatePullRequestTitleOutput} The populated <code>UpdatePullRequestTitleOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePullRequestTitleOutput();

            if (data.hasOwnProperty('pullRequest')) {
                obj['pullRequest'] = UpdatePullRequestDescriptionOutputPullRequest.constructFromObject(data['pullRequest']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePullRequestTitleOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePullRequestTitleOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdatePullRequestTitleOutput.RequiredProperties) {
        ...
        if (data['pullRequest']) { // data not null
          UpdatePullRequestDescriptionOutputPullRequest.validateJSON(data['pullRequest']);
        }
...
UpdatePullRequestTitleOutput.RequiredProperties = ["pullRequest"];

/**
 * @member {module:model/UpdatePullRequestDescriptionOutputPullRequest} pullRequest
 */
UpdatePullRequestTitleOutput.prototype['pullRequest'] = undefined;
...
export default UpdatePullRequestTitleOutput;
