...
/**
 * The ApprovalRuleTemplate model module.
 * @module model/ApprovalRuleTemplate
 * @version 2015-04-13
 */
class ApprovalRuleTemplate {
    /**
     * Constructs a new <code>ApprovalRuleTemplate</code>.
     * Returns information about an approval rule template.
     * @alias module:model/ApprovalRuleTemplate
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ApprovalRuleTemplate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApprovalRuleTemplate} obj Optional instance to populate.
     * @return {module:model/ApprovalRuleTemplate} The populated <code>ApprovalRuleTemplate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApprovalRuleTemplate();
    ...
    /**
     * Validates the JSON data with respect to <code>ApprovalRuleTemplate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApprovalRuleTemplate</code>.
     */
...
export default ApprovalRuleTemplate;
