...
/**
 * The RepositoryTrigger model module.
 * @module model/RepositoryTrigger
 * @version 2015-04-13
 */
class RepositoryTrigger {
    /**
     * Constructs a new <code>RepositoryTrigger</code>.
     * Information about a trigger for a repository.
     * @alias module:model/RepositoryTrigger
     * @param name {String} 
     * @param destinationArn {String} 
     * @param events {Array} 
     */
    constructor(name, destinationArn, events) { 
        
        RepositoryTrigger.initialize(this, name, destinationArn, events);
    }
     ...
     */
    static initialize(obj, name, destinationArn, events) { 
        obj['name'] = name;
    ...
    /**
     * Constructs a <code>RepositoryTrigger</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RepositoryTrigger} obj Optional instance to populate.
     * @return {module:model/RepositoryTrigger} The populated <code>RepositoryTrigger</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RepositoryTrigger();
    ...
    /**
     * Validates the JSON data with respect to <code>RepositoryTrigger</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RepositoryTrigger</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RepositoryTrigger.RequiredProperties) {
        ...
        if (data['customData']) { // data not null
          String.validateJSON(data['customData']);
        }
...
RepositoryTrigger.RequiredProperties = ["name", "destinationArn", "events"];

/**
 * @member {String} name
 */
RepositoryTrigger.prototype['name'] = undefined;

/**
 * @member {String} destinationArn
 */
RepositoryTrigger.prototype['destinationArn'] = undefined;

/**
 * @member {String} customData
 */
RepositoryTrigger.prototype['customData'] = undefined;

/**
 * @member {Array} branches
 */
RepositoryTrigger.prototype['branches'] = undefined;

/**
 * @member {Array} events
 */
RepositoryTrigger.prototype['events'] = undefined;
...
export default RepositoryTrigger;
