...
/**
 * The UpdatePullRequestStatusInput model module.
 * @module model/UpdatePullRequestStatusInput
 * @version 2015-04-13
 */
class UpdatePullRequestStatusInput {
    /**
     * Constructs a new <code>UpdatePullRequestStatusInput</code>.
     * @alias module:model/UpdatePullRequestStatusInput
     * @param pullRequestId {String} 
     * @param pullRequestStatus {module:model/PullRequestStatusEnum} 
     */
    constructor(pullRequestId, pullRequestStatus) { 
        
        UpdatePullRequestStatusInput.initialize(this, pullRequestId, pullRequestStatus);
    }
     ...
     */
    static initialize(obj, pullRequestId, pullRequestStatus) { 
        obj['pullRequestId'] = pullRequestId;
        obj['pullRequestStatus'] = pullRequestStatus;
    }

    /**
     * Constructs a <code>UpdatePullRequestStatusInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePullRequestStatusInput} obj Optional instance to populate.
     * @return {module:model/UpdatePullRequestStatusInput} The populated <code>UpdatePullRequestStatusInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePullRequestStatusInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePullRequestStatusInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePullRequestStatusInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdatePullRequestStatusInput.RequiredProperties) {
...
UpdatePullRequestStatusInput.RequiredProperties = ["pullRequestId", "pullRequestStatus"];

/**
 * @member {String} pullRequestId
 */
UpdatePullRequestStatusInput.prototype['pullRequestId'] = undefined;

/**
 * @member {module:model/PullRequestStatusEnum} pullRequestStatus
 */
UpdatePullRequestStatusInput.prototype['pullRequestStatus'] = undefined;
...
export default UpdatePullRequestStatusInput;
