...
/**
 * The GetRepositoryTriggersInput model module.
 * @module model/GetRepositoryTriggersInput
 * @version 2015-04-13
 */
class GetRepositoryTriggersInput {
    /**
     * Constructs a new <code>GetRepositoryTriggersInput</code>.
     * Represents the input of a get repository triggers operation.
     * @alias module:model/GetRepositoryTriggersInput
     * @param repositoryName {String} 
     */
    constructor(repositoryName) { 
        
        GetRepositoryTriggersInput.initialize(this, repositoryName);
    }
    ...
    /**
     * Constructs a <code>GetRepositoryTriggersInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetRepositoryTriggersInput} obj Optional instance to populate.
     * @return {module:model/GetRepositoryTriggersInput} The populated <code>GetRepositoryTriggersInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetRepositoryTriggersInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetRepositoryTriggersInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetRepositoryTriggersInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetRepositoryTriggersInput.RequiredProperties) {
...
GetRepositoryTriggersInput.RequiredProperties = ["repositoryName"];

/**
 * @member {String} repositoryName
 */
GetRepositoryTriggersInput.prototype['repositoryName'] = undefined;
...
export default GetRepositoryTriggersInput;
