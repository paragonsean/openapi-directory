...
/**
 * The GetCommentsForPullRequestInput model module.
 * @module model/GetCommentsForPullRequestInput
 * @version 2015-04-13
 */
class GetCommentsForPullRequestInput {
    /**
     * Constructs a new <code>GetCommentsForPullRequestInput</code>.
     * @alias module:model/GetCommentsForPullRequestInput
     * @param pullRequestId {String} 
     */
    constructor(pullRequestId) { 
        
        GetCommentsForPullRequestInput.initialize(this, pullRequestId);
    }
    ...
    /**
     * Constructs a <code>GetCommentsForPullRequestInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCommentsForPullRequestInput} obj Optional instance to populate.
     * @return {module:model/GetCommentsForPullRequestInput} The populated <code>GetCommentsForPullRequestInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCommentsForPullRequestInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetCommentsForPullRequestInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCommentsForPullRequestInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetCommentsForPullRequestInput.RequiredProperties) {
...
GetCommentsForPullRequestInput.RequiredProperties = ["pullRequestId"];

/**
 * @member {String} pullRequestId
 */
GetCommentsForPullRequestInput.prototype['pullRequestId'] = undefined;

/**
 * @member {String} repositoryName
 */
GetCommentsForPullRequestInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} beforeCommitId
 */
GetCommentsForPullRequestInput.prototype['beforeCommitId'] = undefined;

/**
 * @member {String} afterCommitId
 */
GetCommentsForPullRequestInput.prototype['afterCommitId'] = undefined;

/**
 * @member {String} nextToken
 */
GetCommentsForPullRequestInput.prototype['nextToken'] = undefined;

/**
 * @member {Number} maxResults
 */
GetCommentsForPullRequestInput.prototype['maxResults'] = undefined;
...
export default GetCommentsForPullRequestInput;
