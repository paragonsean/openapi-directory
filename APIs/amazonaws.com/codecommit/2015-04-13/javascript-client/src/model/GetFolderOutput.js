...
class GetFolderOutput {
     ...
     */
    constructor(commitId, folderPath) { 
        
        GetFolderOutput.initialize(this, commitId, folderPath);
    }
     ...
     */
    static initialize(obj, commitId, folderPath) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('subFolders')) {
                obj['subFolders'] = ApiClient.convertToType(data['subFolders'], Array);
            }
            if (data.hasOwnProperty('files')) {
                obj['files'] = ApiClient.convertToType(data['files'], Array);
            }
            if (data.hasOwnProperty('symbolicLinks')) {
                obj['symbolicLinks'] = ApiClient.convertToType(data['symbolicLinks'], Array);
            }
            if (data.hasOwnProperty('subModules')) {
                obj['subModules'] = ApiClient.convertToType(data['subModules'], Array);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of GetFolderOutput.RequiredProperties) {
        ...
        // validate the optional field `subFolders`
        if (data['subFolders']) { // data not null
          Array.validateJSON(data['subFolders']);
        }
        // validate the optional field `files`
        if (data['files']) { // data not null
          Array.validateJSON(data['files']);
        }
        // validate the optional field `symbolicLinks`
        if (data['symbolicLinks']) { // data not null
          Array.validateJSON(data['symbolicLinks']);
        }
        // validate the optional field `subModules`
        if (data['subModules']) { // data not null
          Array.validateJSON(data['subModules']);
        }
...
GetFolderOutput.RequiredProperties = ["commitId", "folderPath"];

/**
 * @member {String} commitId
 */
GetFolderOutput.prototype['commitId'] = undefined;

/**
 * @member {String} folderPath
 */
GetFolderOutput.prototype['folderPath'] = undefined;

/**
 * @member {String} treeId
 */
GetFolderOutput.prototype['treeId'] = undefined;

/**
 * @member {Array} subFolders
 */
GetFolderOutput.prototype['subFolders'] = undefined;

/**
 * @member {Array} files
 */
GetFolderOutput.prototype['files'] = undefined;

/**
 * @member {Array} symbolicLinks
 */
GetFolderOutput.prototype['symbolicLinks'] = undefined;

/**
 * @member {Array} subModules
 */
GetFolderOutput.prototype['subModules'] = undefined;
