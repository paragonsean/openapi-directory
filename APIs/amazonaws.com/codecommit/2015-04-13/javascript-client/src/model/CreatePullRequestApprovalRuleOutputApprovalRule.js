...
import ApprovalRuleOriginApprovalRuleTemplate from './ApprovalRuleOriginApprovalRuleTemplate';

/**
 * The CreatePullRequestApprovalRuleOutputApprovalRule model module.
 * @module model/CreatePullRequestApprovalRuleOutputApprovalRule
 * @version 2015-04-13
 */
class CreatePullRequestApprovalRuleOutputApprovalRule {
    /**
     * Constructs a new <code>CreatePullRequestApprovalRuleOutputApprovalRule</code>.
     * @alias module:model/CreatePullRequestApprovalRuleOutputApprovalRule
     * @implements module:model/ApprovalRule
     */
    constructor() { 
        ApprovalRule.initialize(this);
        CreatePullRequestApprovalRuleOutputApprovalRule.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreatePullRequestApprovalRuleOutputApprovalRule</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePullRequestApprovalRuleOutputApprovalRule} obj Optional instance to populate.
     * @return {module:model/CreatePullRequestApprovalRuleOutputApprovalRule} The populated <code>CreatePullRequestApprovalRuleOutputApprovalRule</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePullRequestApprovalRuleOutputApprovalRule();
            ApprovalRule.constructFromObject(data, obj);

            if (data.hasOwnProperty('approvalRuleId')) {
                obj['approvalRuleId'] = ApiClient.convertToType(data['approvalRuleId'], 'String');
            }
            if (data.hasOwnProperty('approvalRuleName')) {
                obj['approvalRuleName'] = ApiClient.convertToType(data['approvalRuleName'], 'String');
            }
            if (data.hasOwnProperty('approvalRuleContent')) {
                obj['approvalRuleContent'] = ApiClient.convertToType(data['approvalRuleContent'], 'String');
            }
            ...
            if (data.hasOwnProperty('originApprovalRuleTemplate')) {
                obj['originApprovalRuleTemplate'] = ApprovalRuleOriginApprovalRuleTemplate.constructFromObject(data['originApprovalRuleTemplate']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePullRequestApprovalRuleOutputApprovalRule</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePullRequestApprovalRuleOutputApprovalRule</code>.
     */
    static validateJSON(data) {
        // validate the optional field `approvalRuleId`
        if (data['approvalRuleId']) { // data not null
          String.validateJSON(data['approvalRuleId']);
        }
        // validate the optional field `approvalRuleName`
        if (data['approvalRuleName']) { // data not null
          String.validateJSON(data['approvalRuleName']);
        }
        // validate the optional field `approvalRuleContent`
        if (data['approvalRuleContent']) { // data not null
          String.validateJSON(data['approvalRuleContent']);
        }
        ...
        if (data['originApprovalRuleTemplate']) { // data not null
          ApprovalRuleOriginApprovalRuleTemplate.validateJSON(data['originApprovalRuleTemplate']);
        }
 ...
 */
CreatePullRequestApprovalRuleOutputApprovalRule.prototype['approvalRuleId'] = undefined;

/**
 * @member {String} approvalRuleName
 */
CreatePullRequestApprovalRuleOutputApprovalRule.prototype['approvalRuleName'] = undefined;

/**
 * @member {String} approvalRuleContent
 */
CreatePullRequestApprovalRuleOutputApprovalRule.prototype['approvalRuleContent'] = undefined;

/**
 * @member {String} ruleContentSha256
 */
CreatePullRequestApprovalRuleOutputApprovalRule.prototype['ruleContentSha256'] = undefined;

/**
 * @member {Date} lastModifiedDate
 */
CreatePullRequestApprovalRuleOutputApprovalRule.prototype['lastModifiedDate'] = undefined;

/**
 * @member {Date} creationDate
 */
CreatePullRequestApprovalRuleOutputApprovalRule.prototype['creationDate'] = undefined;

/**
 * @member {String} lastModifiedUser
 */
CreatePullRequestApprovalRuleOutputApprovalRule.prototype['lastModifiedUser'] = undefined;

/**
 * @member {module:model/ApprovalRuleOriginApprovalRuleTemplate} originApprovalRuleTemplate
 */
CreatePullRequestApprovalRuleOutputApprovalRule.prototype['originApprovalRuleTemplate'] = undefined;


// Implement ApprovalRule interface:
/**
 * @member {String} approvalRuleId
 */
ApprovalRule.prototype['approvalRuleId'] = undefined;
/**
 * @member {String} approvalRuleName
 */
ApprovalRule.prototype['approvalRuleName'] = undefined;
/**
 * @member {String} approvalRuleContent
 */
ApprovalRule.prototype['approvalRuleContent'] = undefined;
/**
 * @member {String} ruleContentSha256
 */
ApprovalRule.prototype['ruleContentSha256'] = undefined;
/**
 * @member {Date} lastModifiedDate
 */
ApprovalRule.prototype['lastModifiedDate'] = undefined;
/**
 * @member {Date} creationDate
 */
ApprovalRule.prototype['creationDate'] = undefined;
/**
 * @member {String} lastModifiedUser
 */
ApprovalRule.prototype['lastModifiedUser'] = undefined;
/**
 * @member {module:model/ApprovalRuleOriginApprovalRuleTemplate} originApprovalRuleTemplate
 */
ApprovalRule.prototype['originApprovalRuleTemplate'] = undefined;




export default CreatePullRequestApprovalRuleOutputApprovalRule;
