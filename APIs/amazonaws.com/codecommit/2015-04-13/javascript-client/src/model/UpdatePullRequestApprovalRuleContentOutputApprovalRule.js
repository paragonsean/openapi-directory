...
/**
 * The UpdatePullRequestApprovalRuleContentOutputApprovalRule model module.
 * @module model/UpdatePullRequestApprovalRuleContentOutputApprovalRule
 * @version 2015-04-13
 */
class UpdatePullRequestApprovalRuleContentOutputApprovalRule {
    /**
     * Constructs a new <code>UpdatePullRequestApprovalRuleContentOutputApprovalRule</code>.
     * @alias module:model/UpdatePullRequestApprovalRuleContentOutputApprovalRule
     * @implements module:model/ApprovalRule
     */
    constructor() { 
        ApprovalRule.initialize(this);
        UpdatePullRequestApprovalRuleContentOutputApprovalRule.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdatePullRequestApprovalRuleContentOutputApprovalRule</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePullRequestApprovalRuleContentOutputApprovalRule} obj Optional instance to populate.
     * @return {module:model/UpdatePullRequestApprovalRuleContentOutputApprovalRule} The populated <code>UpdatePullRequestApprovalRuleContentOutputApprovalRule</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePullRequestApprovalRuleContentOutputApprovalRule();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePullRequestApprovalRuleContentOutputApprovalRule</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePullRequestApprovalRuleContentOutputApprovalRule</code>.
     */
 ...
 */
UpdatePullRequestApprovalRuleContentOutputApprovalRule.prototype['approvalRuleId'] = undefined;

/**
 * @member {String} approvalRuleName
 */
UpdatePullRequestApprovalRuleContentOutputApprovalRule.prototype['approvalRuleName'] = undefined;

/**
 * @member {String} approvalRuleContent
 */
UpdatePullRequestApprovalRuleContentOutputApprovalRule.prototype['approvalRuleContent'] = undefined;

/**
 * @member {String} ruleContentSha256
 */
UpdatePullRequestApprovalRuleContentOutputApprovalRule.prototype['ruleContentSha256'] = undefined;

/**
 * @member {Date} lastModifiedDate
 */
UpdatePullRequestApprovalRuleContentOutputApprovalRule.prototype['lastModifiedDate'] = undefined;

/**
 * @member {Date} creationDate
 */
UpdatePullRequestApprovalRuleContentOutputApprovalRule.prototype['creationDate'] = undefined;

/**
 * @member {String} lastModifiedUser
 */
UpdatePullRequestApprovalRuleContentOutputApprovalRule.prototype['lastModifiedUser'] = undefined;

/**
 * @member {module:model/ApprovalRuleOriginApprovalRuleTemplate} originApprovalRuleTemplate
 */
UpdatePullRequestApprovalRuleContentOutputApprovalRule.prototype['originApprovalRuleTemplate'] = undefined;
...
export default UpdatePullRequestApprovalRuleContentOutputApprovalRule;
