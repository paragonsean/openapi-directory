...
import ConflictDetailLevelTypeEnum from './ConflictDetailLevelTypeEnum';
import ConflictResolutionStrategyTypeEnum from './ConflictResolutionStrategyTypeEnum';
import MergeOptionTypeEnum from './MergeOptionTypeEnum';

/**
 * The GetMergeConflictsInput model module.
 * @module model/GetMergeConflictsInput
 * @version 2015-04-13
 */
class GetMergeConflictsInput {
    /**
     * Constructs a new <code>GetMergeConflictsInput</code>.
     * @alias module:model/GetMergeConflictsInput
     * @param repositoryName {String} 
     * @param destinationCommitSpecifier {String} 
     * @param sourceCommitSpecifier {String} 
     * @param mergeOption {module:model/MergeOptionTypeEnum} 
     */
    constructor(repositoryName, destinationCommitSpecifier, sourceCommitSpecifier, mergeOption) { 
        
        GetMergeConflictsInput.initialize(this, repositoryName, destinationCommitSpecifier, sourceCommitSpecifier, mergeOption);
    }
     ...
     */
    static initialize(obj, repositoryName, destinationCommitSpecifier, sourceCommitSpecifier, mergeOption) { 
        obj['repositoryName'] = repositoryName;
        obj['destinationCommitSpecifier'] = destinationCommitSpecifier;
        obj['sourceCommitSpecifier'] = sourceCommitSpecifier;
        obj['mergeOption'] = mergeOption;
    }

    /**
     * Constructs a <code>GetMergeConflictsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetMergeConflictsInput} obj Optional instance to populate.
     * @return {module:model/GetMergeConflictsInput} The populated <code>GetMergeConflictsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetMergeConflictsInput();

            if (data.hasOwnProperty('repositoryName')) {
                obj['repositoryName'] = ApiClient.convertToType(data['repositoryName'], 'String');
            }
            if (data.hasOwnProperty('destinationCommitSpecifier')) {
                obj['destinationCommitSpecifier'] = ApiClient.convertToType(data['destinationCommitSpecifier'], 'String');
            }
            if (data.hasOwnProperty('sourceCommitSpecifier')) {
                obj['sourceCommitSpecifier'] = ApiClient.convertToType(data['sourceCommitSpecifier'], 'String');
            }
            if (data.hasOwnProperty('mergeOption')) {
                obj['mergeOption'] = ApiClient.convertToType(data['mergeOption'], MergeOptionTypeEnum);
            }
            if (data.hasOwnProperty('conflictDetailLevel')) {
                obj['conflictDetailLevel'] = ApiClient.convertToType(data['conflictDetailLevel'], ConflictDetailLevelTypeEnum);
            }
            if (data.hasOwnProperty('maxConflictFiles')) {
                obj['maxConflictFiles'] = ApiClient.convertToType(data['maxConflictFiles'], 'Number');
            }
            if (data.hasOwnProperty('conflictResolutionStrategy')) {
                obj['conflictResolutionStrategy'] = ApiClient.convertToType(data['conflictResolutionStrategy'], ConflictResolutionStrategyTypeEnum);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetMergeConflictsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetMergeConflictsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetMergeConflictsInput.RequiredProperties) {
        ...
        // validate the optional field `destinationCommitSpecifier`
        if (data['destinationCommitSpecifier']) { // data not null
          String.validateJSON(data['destinationCommitSpecifier']);
        }
        // validate the optional field `sourceCommitSpecifier`
        if (data['sourceCommitSpecifier']) { // data not null
          String.validateJSON(data['sourceCommitSpecifier']);
        }
        // validate the optional field `mergeOption`
        if (data['mergeOption']) { // data not null
          MergeOptionTypeEnum.validateJSON(data['mergeOption']);
        }
        // validate the optional field `conflictDetailLevel`
        if (data['conflictDetailLevel']) { // data not null
          ConflictDetailLevelTypeEnum.validateJSON(data['conflictDetailLevel']);
        }
        // validate the optional field `maxConflictFiles`
        if (data['maxConflictFiles']) { // data not null
          Number.validateJSON(data['maxConflictFiles']);
        }
        // validate the optional field `conflictResolutionStrategy`
        if (data['conflictResolutionStrategy']) { // data not null
          ConflictResolutionStrategyTypeEnum.validateJSON(data['conflictResolutionStrategy']);
        }
...
GetMergeConflictsInput.RequiredProperties = ["repositoryName", "destinationCommitSpecifier", "sourceCommitSpecifier", "mergeOption"];

/**
 * @member {String} repositoryName
 */
GetMergeConflictsInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} destinationCommitSpecifier
 */
GetMergeConflictsInput.prototype['destinationCommitSpecifier'] = undefined;

/**
 * @member {String} sourceCommitSpecifier
 */
GetMergeConflictsInput.prototype['sourceCommitSpecifier'] = undefined;

/**
 * @member {module:model/MergeOptionTypeEnum} mergeOption
 */
GetMergeConflictsInput.prototype['mergeOption'] = undefined;

/**
 * @member {module:model/ConflictDetailLevelTypeEnum} conflictDetailLevel
 */
GetMergeConflictsInput.prototype['conflictDetailLevel'] = undefined;

/**
 * @member {Number} maxConflictFiles
 */
GetMergeConflictsInput.prototype['maxConflictFiles'] = undefined;

/**
 * @member {module:model/ConflictResolutionStrategyTypeEnum} conflictResolutionStrategy
 */
GetMergeConflictsInput.prototype['conflictResolutionStrategy'] = undefined;

/**
 * @member {String} nextToken
 */
GetMergeConflictsInput.prototype['nextToken'] = undefined;
...
export default GetMergeConflictsInput;
