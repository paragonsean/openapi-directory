...
/**
 * The DeleteFileInput model module.
 * @module model/DeleteFileInput
 * @version 2015-04-13
 */
class DeleteFileInput {
    /**
     * Constructs a new <code>DeleteFileInput</code>.
     * @alias module:model/DeleteFileInput
     * @param repositoryName {String} 
     * @param branchName {String} 
     * @param filePath {String} 
     * @param parentCommitId {String} 
     */
    constructor(repositoryName, branchName, filePath, parentCommitId) { 
        
        DeleteFileInput.initialize(this, repositoryName, branchName, filePath, parentCommitId);
    }
     ...
     */
    static initialize(obj, repositoryName, branchName, filePath, parentCommitId) { 
        obj['repositoryName'] = repositoryName;
        obj['branchName'] = branchName;
        obj['filePath'] = filePath;
        obj['parentCommitId'] = parentCommitId;
    }

    /**
     * Constructs a <code>DeleteFileInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteFileInput} obj Optional instance to populate.
     * @return {module:model/DeleteFileInput} The populated <code>DeleteFileInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteFileInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteFileInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteFileInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteFileInput.RequiredProperties) {
...
DeleteFileInput.RequiredProperties = ["repositoryName", "branchName", "filePath", "parentCommitId"];

/**
 * @member {String} repositoryName
 */
DeleteFileInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} branchName
 */
DeleteFileInput.prototype['branchName'] = undefined;

/**
 * @member {String} filePath
 */
DeleteFileInput.prototype['filePath'] = undefined;

/**
 * @member {String} parentCommitId
 */
DeleteFileInput.prototype['parentCommitId'] = undefined;

/**
 * @member {Boolean} keepEmptyFolders
 */
DeleteFileInput.prototype['keepEmptyFolders'] = undefined;

/**
 * @member {String} commitMessage
 */
DeleteFileInput.prototype['commitMessage'] = undefined;

/**
 * @member {String} name
 */
DeleteFileInput.prototype['name'] = undefined;

/**
 * @member {String} email
 */
DeleteFileInput.prototype['email'] = undefined;
...
export default DeleteFileInput;
