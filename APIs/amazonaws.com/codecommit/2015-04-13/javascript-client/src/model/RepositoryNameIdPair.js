...
/**
 * The RepositoryNameIdPair model module.
 * @module model/RepositoryNameIdPair
 * @version 2015-04-13
 */
class RepositoryNameIdPair {
    /**
     * Constructs a new <code>RepositoryNameIdPair</code>.
     * Information about a repository name and ID.
     * @alias module:model/RepositoryNameIdPair
     */
    constructor() { 
        
        RepositoryNameIdPair.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RepositoryNameIdPair</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RepositoryNameIdPair} obj Optional instance to populate.
     * @return {module:model/RepositoryNameIdPair} The populated <code>RepositoryNameIdPair</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RepositoryNameIdPair();
    ...
    /**
     * Validates the JSON data with respect to <code>RepositoryNameIdPair</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RepositoryNameIdPair</code>.
     */
 ...
 */
RepositoryNameIdPair.prototype['repositoryName'] = undefined;

/**
 * @member {String} repositoryId
 */
RepositoryNameIdPair.prototype['repositoryId'] = undefined;
...
export default RepositoryNameIdPair;
