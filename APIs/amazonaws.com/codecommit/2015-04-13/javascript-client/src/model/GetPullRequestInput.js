...
/**
 * The GetPullRequestInput model module.
 * @module model/GetPullRequestInput
 * @version 2015-04-13
 */
class GetPullRequestInput {
    /**
     * Constructs a new <code>GetPullRequestInput</code>.
     * @alias module:model/GetPullRequestInput
     * @param pullRequestId {String} 
     */
    constructor(pullRequestId) { 
        
        GetPullRequestInput.initialize(this, pullRequestId);
    }
     ...
     */
    static initialize(obj, pullRequestId) { 
        obj['pullRequestId'] = pullRequestId;
    }

    /**
     * Constructs a <code>GetPullRequestInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPullRequestInput} obj Optional instance to populate.
     * @return {module:model/GetPullRequestInput} The populated <code>GetPullRequestInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPullRequestInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetPullRequestInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPullRequestInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetPullRequestInput.RequiredProperties) {
...
GetPullRequestInput.RequiredProperties = ["pullRequestId"];

/**
 * @member {String} pullRequestId
 */
GetPullRequestInput.prototype['pullRequestId'] = undefined;
...
export default GetPullRequestInput;
