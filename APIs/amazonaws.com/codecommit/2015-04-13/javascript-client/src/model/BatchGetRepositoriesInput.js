...
/**
 * The BatchGetRepositoriesInput model module.
 * @module model/BatchGetRepositoriesInput
 * @version 2015-04-13
 */
class BatchGetRepositoriesInput {
    /**
     * Constructs a new <code>BatchGetRepositoriesInput</code>.
     * Represents the input of a batch get repositories operation.
     * @alias module:model/BatchGetRepositoriesInput
     * @param repositoryNames {Array} 
     */
    constructor(repositoryNames) { 
        
        BatchGetRepositoriesInput.initialize(this, repositoryNames);
    }
    ...
    /**
     * Constructs a <code>BatchGetRepositoriesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchGetRepositoriesInput} obj Optional instance to populate.
     * @return {module:model/BatchGetRepositoriesInput} The populated <code>BatchGetRepositoriesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchGetRepositoriesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchGetRepositoriesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchGetRepositoriesInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BatchGetRepositoriesInput.RequiredProperties) {
...
BatchGetRepositoriesInput.RequiredProperties = ["repositoryNames"];

/**
 * @member {Array} repositoryNames
 */
BatchGetRepositoriesInput.prototype['repositoryNames'] = undefined;
...
export default BatchGetRepositoriesInput;
