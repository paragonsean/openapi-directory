...
/**
 * The SymbolicLink model module.
 * @module model/SymbolicLink
 * @version 2015-04-13
 */
class SymbolicLink {
    /**
     * Constructs a new <code>SymbolicLink</code>.
     * Returns information about a symbolic link in a repository folder.
     * @alias module:model/SymbolicLink
     */
    constructor() { 
        
        SymbolicLink.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SymbolicLink</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SymbolicLink} obj Optional instance to populate.
     * @return {module:model/SymbolicLink} The populated <code>SymbolicLink</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SymbolicLink();
    ...
    /**
     * Validates the JSON data with respect to <code>SymbolicLink</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SymbolicLink</code>.
     */
 ...
 */
SymbolicLink.prototype['blobId'] = undefined;

/**
 * @member {String} absolutePath
 */
SymbolicLink.prototype['absolutePath'] = undefined;

/**
 * @member {String} relativePath
 */
SymbolicLink.prototype['relativePath'] = undefined;

/**
 * @member {module:model/FileModeTypeEnum} fileMode
 */
SymbolicLink.prototype['fileMode'] = undefined;
