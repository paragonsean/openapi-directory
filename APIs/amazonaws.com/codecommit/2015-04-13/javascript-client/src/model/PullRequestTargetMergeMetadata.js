...
/**
 * The PullRequestTargetMergeMetadata model module.
 * @module model/PullRequestTargetMergeMetadata
 * @version 2015-04-13
 */
class PullRequestTargetMergeMetadata {
    /**
     * Constructs a new <code>PullRequestTargetMergeMetadata</code>.
     * @alias module:model/PullRequestTargetMergeMetadata
     * @implements module:model/MergeMetadata
     */
    constructor() { 
        MergeMetadata.initialize(this);
        PullRequestTargetMergeMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PullRequestTargetMergeMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PullRequestTargetMergeMetadata} obj Optional instance to populate.
     * @return {module:model/PullRequestTargetMergeMetadata} The populated <code>PullRequestTargetMergeMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PullRequestTargetMergeMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>PullRequestTargetMergeMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PullRequestTargetMergeMetadata</code>.
     */
 ...
 */
PullRequestTargetMergeMetadata.prototype['isMerged'] = undefined;

/**
 * @member {String} mergedBy
 */
PullRequestTargetMergeMetadata.prototype['mergedBy'] = undefined;

/**
 * @member {String} mergeCommitId
 */
PullRequestTargetMergeMetadata.prototype['mergeCommitId'] = undefined;

/**
 * @member {module:model/MergeOptionTypeEnum} mergeOption
 */
PullRequestTargetMergeMetadata.prototype['mergeOption'] = undefined;
...
export default PullRequestTargetMergeMetadata;
