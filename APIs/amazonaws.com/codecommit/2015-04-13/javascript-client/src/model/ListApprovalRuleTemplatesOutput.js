...
/**
 * The ListApprovalRuleTemplatesOutput model module.
 * @module model/ListApprovalRuleTemplatesOutput
 * @version 2015-04-13
 */
class ListApprovalRuleTemplatesOutput {
    /**
     * Constructs a new <code>ListApprovalRuleTemplatesOutput</code>.
     * @alias module:model/ListApprovalRuleTemplatesOutput
     */
    constructor() { 
        
        ListApprovalRuleTemplatesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListApprovalRuleTemplatesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListApprovalRuleTemplatesOutput} obj Optional instance to populate.
     * @return {module:model/ListApprovalRuleTemplatesOutput} The populated <code>ListApprovalRuleTemplatesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListApprovalRuleTemplatesOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListApprovalRuleTemplatesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListApprovalRuleTemplatesOutput</code>.
     */
 ...
 */
ListApprovalRuleTemplatesOutput.prototype['approvalRuleTemplateNames'] = undefined;

/**
 * @member {String} nextToken
 */
ListApprovalRuleTemplatesOutput.prototype['nextToken'] = undefined;
...
export default ListApprovalRuleTemplatesOutput;
