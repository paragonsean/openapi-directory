...
/**
 * The UpdatePullRequestApprovalStateInput model module.
 * @module model/UpdatePullRequestApprovalStateInput
 * @version 2015-04-13
 */
class UpdatePullRequestApprovalStateInput {
    /**
     * Constructs a new <code>UpdatePullRequestApprovalStateInput</code>.
     * @alias module:model/UpdatePullRequestApprovalStateInput
     * @param pullRequestId {String} 
     * @param revisionId {String} 
     * @param approvalState {module:model/ApprovalState} 
     */
    constructor(pullRequestId, revisionId, approvalState) { 
        
        UpdatePullRequestApprovalStateInput.initialize(this, pullRequestId, revisionId, approvalState);
    }
     ...
     */
    static initialize(obj, pullRequestId, revisionId, approvalState) { 
        obj['pullRequestId'] = pullRequestId;
        obj['revisionId'] = revisionId;
        obj['approvalState'] = approvalState;
    }

    /**
     * Constructs a <code>UpdatePullRequestApprovalStateInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePullRequestApprovalStateInput} obj Optional instance to populate.
     * @return {module:model/UpdatePullRequestApprovalStateInput} The populated <code>UpdatePullRequestApprovalStateInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePullRequestApprovalStateInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePullRequestApprovalStateInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePullRequestApprovalStateInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdatePullRequestApprovalStateInput.RequiredProperties) {
...
UpdatePullRequestApprovalStateInput.RequiredProperties = ["pullRequestId", "revisionId", "approvalState"];

/**
 * @member {String} pullRequestId
 */
UpdatePullRequestApprovalStateInput.prototype['pullRequestId'] = undefined;

/**
 * @member {String} revisionId
 */
UpdatePullRequestApprovalStateInput.prototype['revisionId'] = undefined;

/**
 * @member {module:model/ApprovalState} approvalState
 */
UpdatePullRequestApprovalStateInput.prototype['approvalState'] = undefined;
...
export default UpdatePullRequestApprovalStateInput;
