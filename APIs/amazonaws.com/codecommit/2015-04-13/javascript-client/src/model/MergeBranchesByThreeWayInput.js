...
/**
 * The MergeBranchesByThreeWayInput model module.
 * @module model/MergeBranchesByThreeWayInput
 * @version 2015-04-13
 */
class MergeBranchesByThreeWayInput {
    /**
     * Constructs a new <code>MergeBranchesByThreeWayInput</code>.
     * @alias module:model/MergeBranchesByThreeWayInput
    ...
    constructor(repositoryName, sourceCommitSpecifier, destinationCommitSpecifier) { 
        ...
        MergeBranchesByThreeWayInput.initialize(this, repositoryName, sourceCommitSpecifier, destinationCommitSpecifier);
    }
    ...
    /**
     * Constructs a <code>MergeBranchesByThreeWayInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MergeBranchesByThreeWayInput} obj Optional instance to populate.
     * @return {module:model/MergeBranchesByThreeWayInput} The populated <code>MergeBranchesByThreeWayInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MergeBranchesByThreeWayInput();
    ...
    /**
     * Validates the JSON data with respect to <code>MergeBranchesByThreeWayInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MergeBranchesByThreeWayInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MergeBranchesByThreeWayInput.RequiredProperties) {
...
MergeBranchesByThreeWayInput.RequiredProperties = ["repositoryName", "sourceCommitSpecifier", "destinationCommitSpecifier"];

/**
 * @member {String} repositoryName
 */
MergeBranchesByThreeWayInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} sourceCommitSpecifier
 */
MergeBranchesByThreeWayInput.prototype['sourceCommitSpecifier'] = undefined;

/**
 * @member {String} destinationCommitSpecifier
 */
MergeBranchesByThreeWayInput.prototype['destinationCommitSpecifier'] = undefined;

/**
 * @member {String} targetBranch
 */
MergeBranchesByThreeWayInput.prototype['targetBranch'] = undefined;

/**
 * @member {module:model/ConflictDetailLevelTypeEnum} conflictDetailLevel
 */
MergeBranchesByThreeWayInput.prototype['conflictDetailLevel'] = undefined;

/**
 * @member {module:model/ConflictResolutionStrategyTypeEnum} conflictResolutionStrategy
 */
MergeBranchesByThreeWayInput.prototype['conflictResolutionStrategy'] = undefined;

/**
 * @member {String} authorName
 */
MergeBranchesByThreeWayInput.prototype['authorName'] = undefined;

/**
 * @member {String} email
 */
MergeBranchesByThreeWayInput.prototype['email'] = undefined;

/**
 * @member {String} commitMessage
 */
MergeBranchesByThreeWayInput.prototype['commitMessage'] = undefined;

/**
 * @member {Boolean} keepEmptyFolders
 */
MergeBranchesByThreeWayInput.prototype['keepEmptyFolders'] = undefined;

/**
 * @member {module:model/CreateUnreferencedMergeCommitInputConflictResolution} conflictResolution
 */
MergeBranchesByThreeWayInput.prototype['conflictResolution'] = undefined;
...
export default MergeBranchesByThreeWayInput;
