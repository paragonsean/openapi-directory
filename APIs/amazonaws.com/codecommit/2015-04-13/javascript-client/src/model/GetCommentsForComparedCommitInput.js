...
/**
 * The GetCommentsForComparedCommitInput model module.
 * @module model/GetCommentsForComparedCommitInput
 * @version 2015-04-13
 */
class GetCommentsForComparedCommitInput {
    /**
     * Constructs a new <code>GetCommentsForComparedCommitInput</code>.
     * @alias module:model/GetCommentsForComparedCommitInput
     * @param repositoryName {String} 
     * @param afterCommitId {String} 
     */
    constructor(repositoryName, afterCommitId) { 
        
        GetCommentsForComparedCommitInput.initialize(this, repositoryName, afterCommitId);
    }
     ...
     */
    static initialize(obj, repositoryName, afterCommitId) { 
        obj['repositoryName'] = repositoryName;
        obj['afterCommitId'] = afterCommitId;
    }

    /**
     * Constructs a <code>GetCommentsForComparedCommitInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCommentsForComparedCommitInput} obj Optional instance to populate.
     * @return {module:model/GetCommentsForComparedCommitInput} The populated <code>GetCommentsForComparedCommitInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCommentsForComparedCommitInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetCommentsForComparedCommitInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCommentsForComparedCommitInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetCommentsForComparedCommitInput.RequiredProperties) {
...
GetCommentsForComparedCommitInput.RequiredProperties = ["repositoryName", "afterCommitId"];

/**
 * @member {String} repositoryName
 */
GetCommentsForComparedCommitInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} beforeCommitId
 */
GetCommentsForComparedCommitInput.prototype['beforeCommitId'] = undefined;

/**
 * @member {String} afterCommitId
 */
GetCommentsForComparedCommitInput.prototype['afterCommitId'] = undefined;

/**
 * @member {String} nextToken
 */
GetCommentsForComparedCommitInput.prototype['nextToken'] = undefined;

/**
 * @member {Number} maxResults
 */
GetCommentsForComparedCommitInput.prototype['maxResults'] = undefined;
...
export default GetCommentsForComparedCommitInput;
