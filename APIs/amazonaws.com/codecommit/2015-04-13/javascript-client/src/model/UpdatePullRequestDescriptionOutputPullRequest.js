...
/**
 * The UpdatePullRequestDescriptionOutputPullRequest model module.
 * @module model/UpdatePullRequestDescriptionOutputPullRequest
 * @version 2015-04-13
 */
class UpdatePullRequestDescriptionOutputPullRequest {
    /**
     * Constructs a new <code>UpdatePullRequestDescriptionOutputPullRequest</code>.
     * @alias module:model/UpdatePullRequestDescriptionOutputPullRequest
     * @implements module:model/PullRequest
     */
    constructor() { 
        PullRequest.initialize(this);
        UpdatePullRequestDescriptionOutputPullRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdatePullRequestDescriptionOutputPullRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePullRequestDescriptionOutputPullRequest} obj Optional instance to populate.
     * @return {module:model/UpdatePullRequestDescriptionOutputPullRequest} The populated <code>UpdatePullRequestDescriptionOutputPullRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePullRequestDescriptionOutputPullRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePullRequestDescriptionOutputPullRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePullRequestDescriptionOutputPullRequest</code>.
     */
 ...
 */
UpdatePullRequestDescriptionOutputPullRequest.prototype['pullRequestId'] = undefined;

/**
 * @member {String} title
 */
UpdatePullRequestDescriptionOutputPullRequest.prototype['title'] = undefined;

/**
 * @member {String} description
 */
UpdatePullRequestDescriptionOutputPullRequest.prototype['description'] = undefined;

/**
 * @member {Date} lastActivityDate
 */
UpdatePullRequestDescriptionOutputPullRequest.prototype['lastActivityDate'] = undefined;

/**
 * @member {Date} creationDate
 */
UpdatePullRequestDescriptionOutputPullRequest.prototype['creationDate'] = undefined;

/**
 * @member {module:model/PullRequestStatusEnum} pullRequestStatus
 */
UpdatePullRequestDescriptionOutputPullRequest.prototype['pullRequestStatus'] = undefined;

/**
 * @member {String} authorArn
 */
UpdatePullRequestDescriptionOutputPullRequest.prototype['authorArn'] = undefined;

/**
 * @member {Array} pullRequestTargets
 */
UpdatePullRequestDescriptionOutputPullRequest.prototype['pullRequestTargets'] = undefined;

/**
 * @member {String} clientRequestToken
 */
UpdatePullRequestDescriptionOutputPullRequest.prototype['clientRequestToken'] = undefined;

/**
 * @member {String} revisionId
 */
UpdatePullRequestDescriptionOutputPullRequest.prototype['revisionId'] = undefined;

/**
 * @member {Array} approvalRules
 */
UpdatePullRequestDescriptionOutputPullRequest.prototype['approvalRules'] = undefined;
...
export default UpdatePullRequestDescriptionOutputPullRequest;
