...
/**
 * The GetCommitInput model module.
 * @module model/GetCommitInput
 * @version 2015-04-13
 */
class GetCommitInput {
    /**
     * Constructs a new <code>GetCommitInput</code>.
     * Represents the input of a get commit operation.
     * @alias module:model/GetCommitInput
     * @param repositoryName {String} 
     * @param commitId {String} 
     */
    constructor(repositoryName, commitId) { 
        
        GetCommitInput.initialize(this, repositoryName, commitId);
    }
     ...
     */
    static initialize(obj, repositoryName, commitId) { 
        obj['repositoryName'] = repositoryName;
        obj['commitId'] = commitId;
    }

    /**
     * Constructs a <code>GetCommitInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCommitInput} obj Optional instance to populate.
     * @return {module:model/GetCommitInput} The populated <code>GetCommitInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCommitInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetCommitInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCommitInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetCommitInput.RequiredProperties) {
...
GetCommitInput.RequiredProperties = ["repositoryName", "commitId"];

/**
 * @member {String} repositoryName
 */
GetCommitInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} commitId
 */
GetCommitInput.prototype['commitId'] = undefined;
