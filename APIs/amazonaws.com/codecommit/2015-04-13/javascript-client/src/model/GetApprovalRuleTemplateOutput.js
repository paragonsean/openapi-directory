...
import GetApprovalRuleTemplateOutputApprovalRuleTemplate from './GetApprovalRuleTemplateOutputApprovalRuleTemplate';

/**
 * The GetApprovalRuleTemplateOutput model module.
 * @module model/GetApprovalRuleTemplateOutput
 * @version 2015-04-13
 */
class GetApprovalRuleTemplateOutput {
    /**
     * Constructs a new <code>GetApprovalRuleTemplateOutput</code>.
     * @alias module:model/GetApprovalRuleTemplateOutput
     * @param approvalRuleTemplate {module:model/GetApprovalRuleTemplateOutputApprovalRuleTemplate} 
     */
    constructor(approvalRuleTemplate) { 
        
        GetApprovalRuleTemplateOutput.initialize(this, approvalRuleTemplate);
    }
    ...
    /**
     * Constructs a <code>GetApprovalRuleTemplateOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetApprovalRuleTemplateOutput} obj Optional instance to populate.
     * @return {module:model/GetApprovalRuleTemplateOutput} The populated <code>GetApprovalRuleTemplateOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetApprovalRuleTemplateOutput();

            if (data.hasOwnProperty('approvalRuleTemplate')) {
                obj['approvalRuleTemplate'] = GetApprovalRuleTemplateOutputApprovalRuleTemplate.constructFromObject(data['approvalRuleTemplate']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetApprovalRuleTemplateOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetApprovalRuleTemplateOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetApprovalRuleTemplateOutput.RequiredProperties) {
        ...
        if (data['approvalRuleTemplate']) { // data not null
          GetApprovalRuleTemplateOutputApprovalRuleTemplate.validateJSON(data['approvalRuleTemplate']);
        }
...
GetApprovalRuleTemplateOutput.RequiredProperties = ["approvalRuleTemplate"];

/**
 * @member {module:model/GetApprovalRuleTemplateOutputApprovalRuleTemplate} approvalRuleTemplate
 */
GetApprovalRuleTemplateOutput.prototype['approvalRuleTemplate'] = undefined;
...
export default GetApprovalRuleTemplateOutput;
