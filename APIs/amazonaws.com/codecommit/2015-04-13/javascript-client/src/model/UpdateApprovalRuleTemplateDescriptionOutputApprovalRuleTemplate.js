...
/**
 * The UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate model module.
 * @module model/UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate
 * @version 2015-04-13
 */
class UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate {
    /**
     * Constructs a new <code>UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate</code>.
     * @alias module:model/UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate
     * @implements module:model/ApprovalRuleTemplate
     */
    constructor() { 
        ApprovalRuleTemplate.initialize(this);
        UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate} obj Optional instance to populate.
     * @return {module:model/UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate} The populated <code>UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate();
            ApprovalRuleTemplate.constructFromObject(data, obj);

            if (data.hasOwnProperty('approvalRuleTemplateId')) {
                obj['approvalRuleTemplateId'] = ApiClient.convertToType(data['approvalRuleTemplateId'], 'String');
            }
            if (data.hasOwnProperty('approvalRuleTemplateName')) {
                obj['approvalRuleTemplateName'] = ApiClient.convertToType(data['approvalRuleTemplateName'], 'String');
            }
            if (data.hasOwnProperty('approvalRuleTemplateDescription')) {
                obj['approvalRuleTemplateDescription'] = ApiClient.convertToType(data['approvalRuleTemplateDescription'], 'String');
            }
            if (data.hasOwnProperty('approvalRuleTemplateContent')) {
                obj['approvalRuleTemplateContent'] = ApiClient.convertToType(data['approvalRuleTemplateContent'], 'String');
            }
            if (data.hasOwnProperty('ruleContentSha256')) {
                obj['ruleContentSha256'] = ApiClient.convertToType(data['ruleContentSha256'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate</code>.
     */
    static validateJSON(data) {
        // validate the optional field `approvalRuleTemplateId`
        if (data['approvalRuleTemplateId']) { // data not null
          String.validateJSON(data['approvalRuleTemplateId']);
        }
        // validate the optional field `approvalRuleTemplateName`
        if (data['approvalRuleTemplateName']) { // data not null
          String.validateJSON(data['approvalRuleTemplateName']);
        }
        // validate the optional field `approvalRuleTemplateDescription`
        if (data['approvalRuleTemplateDescription']) { // data not null
          String.validateJSON(data['approvalRuleTemplateDescription']);
        }
        // validate the optional field `approvalRuleTemplateContent`
        if (data['approvalRuleTemplateContent']) { // data not null
          String.validateJSON(data['approvalRuleTemplateContent']);
        }
        // validate the optional field `ruleContentSha256`
        if (data['ruleContentSha256']) { // data not null
          String.validateJSON(data['ruleContentSha256']);
        }
...
/**
 * @member {String} approvalRuleTemplateId
 */
UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate.prototype['approvalRuleTemplateId'] = undefined;

/**
 * @member {String} approvalRuleTemplateName
 */
UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate.prototype['approvalRuleTemplateName'] = undefined;

/**
 * @member {String} approvalRuleTemplateDescription
 */
UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate.prototype['approvalRuleTemplateDescription'] = undefined;

/**
 * @member {String} approvalRuleTemplateContent
 */
UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate.prototype['approvalRuleTemplateContent'] = undefined;

/**
 * @member {String} ruleContentSha256
 */
UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate.prototype['ruleContentSha256'] = undefined;

/**
 * @member {Date} lastModifiedDate
 */
UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate.prototype['lastModifiedDate'] = undefined;

/**
 * @member {Date} creationDate
 */
UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate.prototype['creationDate'] = undefined;

/**
 * @member {String} lastModifiedUser
 */
UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate.prototype['lastModifiedUser'] = undefined;


// Implement ApprovalRuleTemplate interface:
/**
 * @member {String} approvalRuleTemplateId
 */
ApprovalRuleTemplate.prototype['approvalRuleTemplateId'] = undefined;
/**
 * @member {String} approvalRuleTemplateName
 */
ApprovalRuleTemplate.prototype['approvalRuleTemplateName'] = undefined;
/**
 * @member {String} approvalRuleTemplateDescription
 */
ApprovalRuleTemplate.prototype['approvalRuleTemplateDescription'] = undefined;
/**
 * @member {String} approvalRuleTemplateContent
 */
ApprovalRuleTemplate.prototype['approvalRuleTemplateContent'] = undefined;
/**
 * @member {String} ruleContentSha256
 */
ApprovalRuleTemplate.prototype['ruleContentSha256'] = undefined;
/**
 * @member {Date} lastModifiedDate
 */
ApprovalRuleTemplate.prototype['lastModifiedDate'] = undefined;
/**
 * @member {Date} creationDate
 */
ApprovalRuleTemplate.prototype['creationDate'] = undefined;
/**
 * @member {String} lastModifiedUser
 */
ApprovalRuleTemplate.prototype['lastModifiedUser'] = undefined;




export default UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate;
