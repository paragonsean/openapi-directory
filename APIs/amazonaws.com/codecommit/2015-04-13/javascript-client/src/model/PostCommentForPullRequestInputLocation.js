...
/**
 * The PostCommentForPullRequestInputLocation model module.
 * @module model/PostCommentForPullRequestInputLocation
 * @version 2015-04-13
 */
class PostCommentForPullRequestInputLocation {
    /**
     * Constructs a new <code>PostCommentForPullRequestInputLocation</code>.
     * @alias module:model/PostCommentForPullRequestInputLocation
     * @implements module:model/Location
     */
    constructor() { 
        Location.initialize(this);
        PostCommentForPullRequestInputLocation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostCommentForPullRequestInputLocation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostCommentForPullRequestInputLocation} obj Optional instance to populate.
     * @return {module:model/PostCommentForPullRequestInputLocation} The populated <code>PostCommentForPullRequestInputLocation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostCommentForPullRequestInputLocation();
    ...
    /**
     * Validates the JSON data with respect to <code>PostCommentForPullRequestInputLocation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostCommentForPullRequestInputLocation</code>.
     */
 ...
 */
PostCommentForPullRequestInputLocation.prototype['filePath'] = undefined;

/**
 * @member {Number} filePosition
 */
PostCommentForPullRequestInputLocation.prototype['filePosition'] = undefined;

/**
 * @member {module:model/RelativeFileVersionEnum} relativeFileVersion
 */
PostCommentForPullRequestInputLocation.prototype['relativeFileVersion'] = undefined;
...
export default PostCommentForPullRequestInputLocation;
