...
/**
 * The BatchDescribeMergeConflictsError model module.
 * @module model/BatchDescribeMergeConflictsError
 * @version 2015-04-13
 */
class BatchDescribeMergeConflictsError {
    /**
     * Constructs a new <code>BatchDescribeMergeConflictsError</code>.
     * Returns information about errors in a BatchDescribeMergeConflicts operation.
     * @alias module:model/BatchDescribeMergeConflictsError
     * @param filePath {String} 
     * @param exceptionName {String} 
     * @param message {String} 
     */
    constructor(filePath, exceptionName, message) { 
        
        BatchDescribeMergeConflictsError.initialize(this, filePath, exceptionName, message);
    }
     ...
     */
    static initialize(obj, filePath, exceptionName, message) { 
    ...
    /**
     * Constructs a <code>BatchDescribeMergeConflictsError</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchDescribeMergeConflictsError} obj Optional instance to populate.
     * @return {module:model/BatchDescribeMergeConflictsError} The populated <code>BatchDescribeMergeConflictsError</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchDescribeMergeConflictsError();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchDescribeMergeConflictsError</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchDescribeMergeConflictsError</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BatchDescribeMergeConflictsError.RequiredProperties) {
...
BatchDescribeMergeConflictsError.RequiredProperties = ["filePath", "exceptionName", "message"];

/**
 * @member {String} filePath
 */
BatchDescribeMergeConflictsError.prototype['filePath'] = undefined;

/**
 * @member {String} exceptionName
 */
BatchDescribeMergeConflictsError.prototype['exceptionName'] = undefined;

/**
 * @member {String} message
 */
BatchDescribeMergeConflictsError.prototype['message'] = undefined;
...
export default BatchDescribeMergeConflictsError;
