...
/**
 * The PutFileEntrySourceFile model module.
 * @module model/PutFileEntrySourceFile
 * @version 2015-04-13
 */
class PutFileEntrySourceFile {
    /**
     * Constructs a new <code>PutFileEntrySourceFile</code>.
     * @alias module:model/PutFileEntrySourceFile
     * @implements module:model/SourceFileSpecifier
     * @param filePath {String} 
     */
    constructor(filePath) { 
        SourceFileSpecifier.initialize(this, filePath);
        PutFileEntrySourceFile.initialize(this, filePath);
    }
    ...
    /**
     * Constructs a <code>PutFileEntrySourceFile</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutFileEntrySourceFile} obj Optional instance to populate.
     * @return {module:model/PutFileEntrySourceFile} The populated <code>PutFileEntrySourceFile</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutFileEntrySourceFile();
            SourceFileSpecifier.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>PutFileEntrySourceFile</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutFileEntrySourceFile</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutFileEntrySourceFile.RequiredProperties) {
...
PutFileEntrySourceFile.RequiredProperties = ["filePath"];

/**
 * @member {String} filePath
 */
PutFileEntrySourceFile.prototype['filePath'] = undefined;

/**
 * @member {Boolean} isMove
 */
PutFileEntrySourceFile.prototype['isMove'] = undefined;


// Implement SourceFileSpecifier interface:
/**
 * @member {String} filePath
 */
...
export default PutFileEntrySourceFile;
