...
/**
 * The PullRequestStatusChangedEventMetadata model module.
 * @module model/PullRequestStatusChangedEventMetadata
 * @version 2015-04-13
 */
class PullRequestStatusChangedEventMetadata {
    /**
     * Constructs a new <code>PullRequestStatusChangedEventMetadata</code>.
     * Information about a change to the status of a pull request.
     * @alias module:model/PullRequestStatusChangedEventMetadata
     */
    constructor() { 
        
        PullRequestStatusChangedEventMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PullRequestStatusChangedEventMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PullRequestStatusChangedEventMetadata} obj Optional instance to populate.
     * @return {module:model/PullRequestStatusChangedEventMetadata} The populated <code>PullRequestStatusChangedEventMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PullRequestStatusChangedEventMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>PullRequestStatusChangedEventMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PullRequestStatusChangedEventMetadata</code>.
     */
 ...
 */
PullRequestStatusChangedEventMetadata.prototype['pullRequestStatus'] = undefined;
...
export default PullRequestStatusChangedEventMetadata;
