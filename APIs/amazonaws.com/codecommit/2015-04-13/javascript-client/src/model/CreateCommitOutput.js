...
/**
 * The CreateCommitOutput model module.
 * @module model/CreateCommitOutput
 * @version 2015-04-13
 */
class CreateCommitOutput {
    /**
     * Constructs a new <code>CreateCommitOutput</code>.
     * @alias module:model/CreateCommitOutput
     */
    constructor() { 
        
        CreateCommitOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateCommitOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateCommitOutput} obj Optional instance to populate.
     * @return {module:model/CreateCommitOutput} The populated <code>CreateCommitOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateCommitOutput();
            ...
            if (data.hasOwnProperty('filesAdded')) {
                obj['filesAdded'] = ApiClient.convertToType(data['filesAdded'], Array);
            }
            if (data.hasOwnProperty('filesUpdated')) {
                obj['filesUpdated'] = ApiClient.convertToType(data['filesUpdated'], Array);
            }
            if (data.hasOwnProperty('filesDeleted')) {
                obj['filesDeleted'] = ApiClient.convertToType(data['filesDeleted'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCommitOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCommitOutput</code>.
     */
    static validateJSON(data) {
        ...
        // validate the optional field `filesAdded`
        if (data['filesAdded']) { // data not null
          Array.validateJSON(data['filesAdded']);
        }
        // validate the optional field `filesUpdated`
        if (data['filesUpdated']) { // data not null
          Array.validateJSON(data['filesUpdated']);
        }
        // validate the optional field `filesDeleted`
        if (data['filesDeleted']) { // data not null
          Array.validateJSON(data['filesDeleted']);
        }
 ...
 */
CreateCommitOutput.prototype['commitId'] = undefined;

/**
 * @member {String} treeId
 */
CreateCommitOutput.prototype['treeId'] = undefined;

/**
 * @member {Array} filesAdded
 */
CreateCommitOutput.prototype['filesAdded'] = undefined;

/**
 * @member {Array} filesUpdated
 */
CreateCommitOutput.prototype['filesUpdated'] = undefined;

/**
 * @member {Array} filesDeleted
 */
CreateCommitOutput.prototype['filesDeleted'] = undefined;
...
export default CreateCommitOutput;
