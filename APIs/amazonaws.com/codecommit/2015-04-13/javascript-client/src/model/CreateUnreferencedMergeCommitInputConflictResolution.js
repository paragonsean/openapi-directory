...
/**
 * The CreateUnreferencedMergeCommitInputConflictResolution model module.
 * @module model/CreateUnreferencedMergeCommitInputConflictResolution
 * @version 2015-04-13
 */
class CreateUnreferencedMergeCommitInputConflictResolution {
    /**
     * Constructs a new <code>CreateUnreferencedMergeCommitInputConflictResolution</code>.
     * @alias module:model/CreateUnreferencedMergeCommitInputConflictResolution
     * @implements module:model/ConflictResolution
     */
    constructor() { 
        ConflictResolution.initialize(this);
        CreateUnreferencedMergeCommitInputConflictResolution.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateUnreferencedMergeCommitInputConflictResolution</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateUnreferencedMergeCommitInputConflictResolution} obj Optional instance to populate.
     * @return {module:model/CreateUnreferencedMergeCommitInputConflictResolution} The populated <code>CreateUnreferencedMergeCommitInputConflictResolution</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateUnreferencedMergeCommitInputConflictResolution();
            ConflictResolution.constructFromObject(data, obj);

            if (data.hasOwnProperty('replaceContents')) {
                obj['replaceContents'] = ApiClient.convertToType(data['replaceContents'], Array);
            }
            if (data.hasOwnProperty('deleteFiles')) {
                obj['deleteFiles'] = ApiClient.convertToType(data['deleteFiles'], Array);
            }
            if (data.hasOwnProperty('setFileModes')) {
                obj['setFileModes'] = ApiClient.convertToType(data['setFileModes'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateUnreferencedMergeCommitInputConflictResolution</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateUnreferencedMergeCommitInputConflictResolution</code>.
     */
    static validateJSON(data) {
        // validate the optional field `replaceContents`
        if (data['replaceContents']) { // data not null
          Array.validateJSON(data['replaceContents']);
        }
        // validate the optional field `deleteFiles`
        if (data['deleteFiles']) { // data not null
          Array.validateJSON(data['deleteFiles']);
        }
        // validate the optional field `setFileModes`
        if (data['setFileModes']) { // data not null
          Array.validateJSON(data['setFileModes']);
        }
...
/**
 * @member {Array} replaceContents
 */
CreateUnreferencedMergeCommitInputConflictResolution.prototype['replaceContents'] = undefined;

/**
 * @member {Array} deleteFiles
 */
CreateUnreferencedMergeCommitInputConflictResolution.prototype['deleteFiles'] = undefined;

/**
 * @member {Array} setFileModes
 */
CreateUnreferencedMergeCommitInputConflictResolution.prototype['setFileModes'] = undefined;
 ...
 * @member {Array} replaceContents
 */
ConflictResolution.prototype['replaceContents'] = undefined;
/**
 * @member {Array} deleteFiles
 */
ConflictResolution.prototype['deleteFiles'] = undefined;
/**
 * @member {Array} setFileModes
 */
ConflictResolution.prototype['setFileModes'] = undefined;




export default CreateUnreferencedMergeCommitInputConflictResolution;
