...
/**
 * The DeleteFileEntry model module.
 * @module model/DeleteFileEntry
 * @version 2015-04-13
 */
class DeleteFileEntry {
    /**
     * Constructs a new <code>DeleteFileEntry</code>.
     * A file that is deleted as part of a commit.
     * @alias module:model/DeleteFileEntry
     * @param filePath {String} 
     */
    constructor(filePath) { 
        
        DeleteFileEntry.initialize(this, filePath);
    }
    ...
    /**
     * Constructs a <code>DeleteFileEntry</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteFileEntry} obj Optional instance to populate.
     * @return {module:model/DeleteFileEntry} The populated <code>DeleteFileEntry</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteFileEntry();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteFileEntry</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteFileEntry</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteFileEntry.RequiredProperties) {
...
DeleteFileEntry.RequiredProperties = ["filePath"];

/**
 * @member {String} filePath
 */
DeleteFileEntry.prototype['filePath'] = undefined;
...
export default DeleteFileEntry;
