...
/**
 * The DeleteRepositoryInput model module.
 * @module model/DeleteRepositoryInput
 * @version 2015-04-13
 */
class DeleteRepositoryInput {
    /**
     * Constructs a new <code>DeleteRepositoryInput</code>.
     * Represents the input of a delete repository operation.
     * @alias module:model/DeleteRepositoryInput
     * @param repositoryName {String} 
     */
    constructor(repositoryName) { 
        
        DeleteRepositoryInput.initialize(this, repositoryName);
    }
    ...
    /**
     * Constructs a <code>DeleteRepositoryInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteRepositoryInput} obj Optional instance to populate.
     * @return {module:model/DeleteRepositoryInput} The populated <code>DeleteRepositoryInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteRepositoryInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteRepositoryInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteRepositoryInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteRepositoryInput.RequiredProperties) {
...
DeleteRepositoryInput.RequiredProperties = ["repositoryName"];

/**
 * @member {String} repositoryName
 */
DeleteRepositoryInput.prototype['repositoryName'] = undefined;
...
export default DeleteRepositoryInput;
