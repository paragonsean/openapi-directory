...
/**
 * The DeleteCommentContentOutputComment model module.
 * @module model/DeleteCommentContentOutputComment
 * @version 2015-04-13
 */
class DeleteCommentContentOutputComment {
    /**
     * Constructs a new <code>DeleteCommentContentOutputComment</code>.
     * @alias module:model/DeleteCommentContentOutputComment
     * @implements module:model/Comment
     */
    constructor() { 
        Comment.initialize(this);
        DeleteCommentContentOutputComment.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteCommentContentOutputComment</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteCommentContentOutputComment} obj Optional instance to populate.
     * @return {module:model/DeleteCommentContentOutputComment} The populated <code>DeleteCommentContentOutputComment</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteCommentContentOutputComment();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteCommentContentOutputComment</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteCommentContentOutputComment</code>.
     */
 ...
 */
DeleteCommentContentOutputComment.prototype['commentId'] = undefined;

/**
 * @member {String} content
 */
DeleteCommentContentOutputComment.prototype['content'] = undefined;

/**
 * @member {String} inReplyTo
 */
DeleteCommentContentOutputComment.prototype['inReplyTo'] = undefined;

/**
 * @member {Date} creationDate
 */
DeleteCommentContentOutputComment.prototype['creationDate'] = undefined;

/**
 * @member {Date} lastModifiedDate
 */
DeleteCommentContentOutputComment.prototype['lastModifiedDate'] = undefined;

/**
 * @member {String} authorArn
 */
DeleteCommentContentOutputComment.prototype['authorArn'] = undefined;

/**
 * @member {Boolean} deleted
 */
DeleteCommentContentOutputComment.prototype['deleted'] = undefined;

/**
 * @member {String} clientRequestToken
 */
DeleteCommentContentOutputComment.prototype['clientRequestToken'] = undefined;

/**
 * @member {Array} callerReactions
 */
DeleteCommentContentOutputComment.prototype['callerReactions'] = undefined;

/**
 * @member {Object} reactionCounts
 */
DeleteCommentContentOutputComment.prototype['reactionCounts'] = undefined;
...
export default DeleteCommentContentOutputComment;
