...
/**
 * The CreateUnreferencedMergeCommitInput model module.
 * @module model/CreateUnreferencedMergeCommitInput
 * @version 2015-04-13
 */
class CreateUnreferencedMergeCommitInput {
    /**
     * Constructs a new <code>CreateUnreferencedMergeCommitInput</code>.
     * @alias module:model/CreateUnreferencedMergeCommitInput
     ...
     */
    constructor(repositoryName, sourceCommitSpecifier, destinationCommitSpecifier, mergeOption) { 
        
        CreateUnreferencedMergeCommitInput.initialize(this, repositoryName, sourceCommitSpecifier, destinationCommitSpecifier, mergeOption);
    }
     ...
     */
    static initialize(obj, repositoryName, sourceCommitSpecifier, destinationCommitSpecifier, mergeOption) { 
    ...
    /**
     * Constructs a <code>CreateUnreferencedMergeCommitInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateUnreferencedMergeCommitInput} obj Optional instance to populate.
     * @return {module:model/CreateUnreferencedMergeCommitInput} The populated <code>CreateUnreferencedMergeCommitInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateUnreferencedMergeCommitInput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateUnreferencedMergeCommitInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateUnreferencedMergeCommitInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateUnreferencedMergeCommitInput.RequiredProperties) {
...
CreateUnreferencedMergeCommitInput.RequiredProperties = ["repositoryName", "sourceCommitSpecifier", "destinationCommitSpecifier", "mergeOption"];

/**
 * @member {String} repositoryName
 */
CreateUnreferencedMergeCommitInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} sourceCommitSpecifier
 */
CreateUnreferencedMergeCommitInput.prototype['sourceCommitSpecifier'] = undefined;

/**
 * @member {String} destinationCommitSpecifier
 */
CreateUnreferencedMergeCommitInput.prototype['destinationCommitSpecifier'] = undefined;

/**
 * @member {module:model/MergeOptionTypeEnum} mergeOption
 */
CreateUnreferencedMergeCommitInput.prototype['mergeOption'] = undefined;

/**
 * @member {module:model/ConflictDetailLevelTypeEnum} conflictDetailLevel
 */
CreateUnreferencedMergeCommitInput.prototype['conflictDetailLevel'] = undefined;

/**
 * @member {module:model/ConflictResolutionStrategyTypeEnum} conflictResolutionStrategy
 */
CreateUnreferencedMergeCommitInput.prototype['conflictResolutionStrategy'] = undefined;

/**
 * @member {String} authorName
 */
CreateUnreferencedMergeCommitInput.prototype['authorName'] = undefined;

/**
 * @member {String} email
 */
CreateUnreferencedMergeCommitInput.prototype['email'] = undefined;

/**
 * @member {String} commitMessage
 */
CreateUnreferencedMergeCommitInput.prototype['commitMessage'] = undefined;

/**
 * @member {Boolean} keepEmptyFolders
 */
CreateUnreferencedMergeCommitInput.prototype['keepEmptyFolders'] = undefined;

/**
 * @member {module:model/CreateUnreferencedMergeCommitInputConflictResolution} conflictResolution
 */
CreateUnreferencedMergeCommitInput.prototype['conflictResolution'] = undefined;
...
export default CreateUnreferencedMergeCommitInput;
