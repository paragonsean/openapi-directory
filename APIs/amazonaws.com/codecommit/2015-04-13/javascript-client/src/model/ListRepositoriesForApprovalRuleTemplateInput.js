...
/**
 * The ListRepositoriesForApprovalRuleTemplateInput model module.
 * @module model/ListRepositoriesForApprovalRuleTemplateInput
 * @version 2015-04-13
 */
class ListRepositoriesForApprovalRuleTemplateInput {
    /**
     * Constructs a new <code>ListRepositoriesForApprovalRuleTemplateInput</code>.
     * @alias module:model/ListRepositoriesForApprovalRuleTemplateInput
     * @param approvalRuleTemplateName {String} 
     */
    constructor(approvalRuleTemplateName) { 
        
        ListRepositoriesForApprovalRuleTemplateInput.initialize(this, approvalRuleTemplateName);
    }
     ...
     */
    static initialize(obj, approvalRuleTemplateName) { 
        obj['approvalRuleTemplateName'] = approvalRuleTemplateName;
    }

    /**
     * Constructs a <code>ListRepositoriesForApprovalRuleTemplateInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListRepositoriesForApprovalRuleTemplateInput} obj Optional instance to populate.
     * @return {module:model/ListRepositoriesForApprovalRuleTemplateInput} The populated <code>ListRepositoriesForApprovalRuleTemplateInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListRepositoriesForApprovalRuleTemplateInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListRepositoriesForApprovalRuleTemplateInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListRepositoriesForApprovalRuleTemplateInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListRepositoriesForApprovalRuleTemplateInput.RequiredProperties) {
...
ListRepositoriesForApprovalRuleTemplateInput.RequiredProperties = ["approvalRuleTemplateName"];

/**
 * @member {String} approvalRuleTemplateName
 */
ListRepositoriesForApprovalRuleTemplateInput.prototype['approvalRuleTemplateName'] = undefined;

/**
 * @member {String} nextToken
 */
ListRepositoriesForApprovalRuleTemplateInput.prototype['nextToken'] = undefined;

/**
 * @member {Number} maxResults
 */
ListRepositoriesForApprovalRuleTemplateInput.prototype['maxResults'] = undefined;
...
export default ListRepositoriesForApprovalRuleTemplateInput;
