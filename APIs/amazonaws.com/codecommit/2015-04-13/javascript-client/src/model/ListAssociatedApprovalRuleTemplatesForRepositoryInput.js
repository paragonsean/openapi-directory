...
/**
 * The ListAssociatedApprovalRuleTemplatesForRepositoryInput model module.
 * @module model/ListAssociatedApprovalRuleTemplatesForRepositoryInput
 * @version 2015-04-13
 */
class ListAssociatedApprovalRuleTemplatesForRepositoryInput {
    /**
     * Constructs a new <code>ListAssociatedApprovalRuleTemplatesForRepositoryInput</code>.
     * @alias module:model/ListAssociatedApprovalRuleTemplatesForRepositoryInput
     * @param repositoryName {String} 
     */
    constructor(repositoryName) { 
        
        ListAssociatedApprovalRuleTemplatesForRepositoryInput.initialize(this, repositoryName);
    }
    ...
    /**
     * Constructs a <code>ListAssociatedApprovalRuleTemplatesForRepositoryInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAssociatedApprovalRuleTemplatesForRepositoryInput} obj Optional instance to populate.
     * @return {module:model/ListAssociatedApprovalRuleTemplatesForRepositoryInput} The populated <code>ListAssociatedApprovalRuleTemplatesForRepositoryInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListAssociatedApprovalRuleTemplatesForRepositoryInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListAssociatedApprovalRuleTemplatesForRepositoryInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListAssociatedApprovalRuleTemplatesForRepositoryInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListAssociatedApprovalRuleTemplatesForRepositoryInput.RequiredProperties) {
...
ListAssociatedApprovalRuleTemplatesForRepositoryInput.RequiredProperties = ["repositoryName"];

/**
 * @member {String} repositoryName
 */
ListAssociatedApprovalRuleTemplatesForRepositoryInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} nextToken
 */
ListAssociatedApprovalRuleTemplatesForRepositoryInput.prototype['nextToken'] = undefined;

/**
 * @member {Number} maxResults
 */
ListAssociatedApprovalRuleTemplatesForRepositoryInput.prototype['maxResults'] = undefined;
...
export default ListAssociatedApprovalRuleTemplatesForRepositoryInput;
