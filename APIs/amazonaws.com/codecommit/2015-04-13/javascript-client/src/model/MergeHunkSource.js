...
/**
 * The MergeHunkSource model module.
 * @module model/MergeHunkSource
 * @version 2015-04-13
 */
class MergeHunkSource {
    /**
     * Constructs a new <code>MergeHunkSource</code>.
     * @alias module:model/MergeHunkSource
     * @implements module:model/MergeHunkDetail
     */
    constructor() { 
        MergeHunkDetail.initialize(this);
        MergeHunkSource.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MergeHunkSource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MergeHunkSource} obj Optional instance to populate.
     * @return {module:model/MergeHunkSource} The populated <code>MergeHunkSource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MergeHunkSource();
            MergeHunkDetail.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>MergeHunkSource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MergeHunkSource</code>.
     */
 ...
 */
MergeHunkSource.prototype['startLine'] = undefined;

/**
 * @member {Number} endLine
 */
MergeHunkSource.prototype['endLine'] = undefined;

/**
 * @member {String} hunkContent
 */
MergeHunkSource.prototype['hunkContent'] = undefined;


// Implement MergeHunkDetail interface:
/**
 * @member {Number} startLine
 */
...
export default MergeHunkSource;
