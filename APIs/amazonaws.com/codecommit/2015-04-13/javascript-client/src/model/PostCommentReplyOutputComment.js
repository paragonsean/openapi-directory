...
/**
 * The PostCommentReplyOutputComment model module.
 * @module model/PostCommentReplyOutputComment
 * @version 2015-04-13
 */
class PostCommentReplyOutputComment {
    /**
     * Constructs a new <code>PostCommentReplyOutputComment</code>.
     * @alias module:model/PostCommentReplyOutputComment
     * @implements module:model/Comment
     */
    constructor() { 
        Comment.initialize(this);
        PostCommentReplyOutputComment.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostCommentReplyOutputComment</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostCommentReplyOutputComment} obj Optional instance to populate.
     * @return {module:model/PostCommentReplyOutputComment} The populated <code>PostCommentReplyOutputComment</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostCommentReplyOutputComment();
            ...
            if (data.hasOwnProperty('inReplyTo')) {
                obj['inReplyTo'] = ApiClient.convertToType(data['inReplyTo'], 'String');
            }
            ...
            if (data.hasOwnProperty('callerReactions')) {
                obj['callerReactions'] = ApiClient.convertToType(data['callerReactions'], Array);
            }
            if (data.hasOwnProperty('reactionCounts')) {
                obj['reactionCounts'] = ApiClient.convertToType(data['reactionCounts'], Object);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PostCommentReplyOutputComment</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostCommentReplyOutputComment</code>.
     */
    static validateJSON(data) {
        // validate the optional field `commentId`
        if (data['commentId']) { // data not null
          String.validateJSON(data['commentId']);
        }
        ...
        if (data['inReplyTo']) { // data not null
          String.validateJSON(data['inReplyTo']);
        }
        ...
        if (data['callerReactions']) { // data not null
          Array.validateJSON(data['callerReactions']);
        }
        // validate the optional field `reactionCounts`
        if (data['reactionCounts']) { // data not null
          Object.validateJSON(data['reactionCounts']);
        }
 ...
 */
PostCommentReplyOutputComment.prototype['commentId'] = undefined;

/**
 * @member {String} content
 */
PostCommentReplyOutputComment.prototype['content'] = undefined;

/**
 * @member {String} inReplyTo
 */
PostCommentReplyOutputComment.prototype['inReplyTo'] = undefined;

/**
 * @member {Date} creationDate
 */
PostCommentReplyOutputComment.prototype['creationDate'] = undefined;

/**
 * @member {Date} lastModifiedDate
 */
PostCommentReplyOutputComment.prototype['lastModifiedDate'] = undefined;

/**
 * @member {String} authorArn
 */
PostCommentReplyOutputComment.prototype['authorArn'] = undefined;

/**
 * @member {Boolean} deleted
 */
PostCommentReplyOutputComment.prototype['deleted'] = undefined;

/**
 * @member {String} clientRequestToken
 */
PostCommentReplyOutputComment.prototype['clientRequestToken'] = undefined;

/**
 * @member {Array} callerReactions
 */
PostCommentReplyOutputComment.prototype['callerReactions'] = undefined;

/**
 * @member {Object} reactionCounts
 */
PostCommentReplyOutputComment.prototype['reactionCounts'] = undefined;
 ...
 * @member {Date} lastModifiedDate
 */
Comment.prototype['lastModifiedDate'] = undefined;
/**
 * @member {String} authorArn
 */
Comment.prototype['authorArn'] = undefined;
/**
 * @member {Boolean} deleted
 */
 ...
 * @member {String} clientRequestToken
 */
Comment.prototype['clientRequestToken'] = undefined;
/**
 * @member {Array} callerReactions
 */
Comment.prototype['callerReactions'] = undefined;
/**
 * @member {Object} reactionCounts
 */
Comment.prototype['reactionCounts'] = undefined;




export default PostCommentReplyOutputComment;
