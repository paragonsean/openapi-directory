...
/**
 * The GetMergeOptionsOutput model module.
 * @module model/GetMergeOptionsOutput
 * @version 2015-04-13
 */
class GetMergeOptionsOutput {
    /**
     * Constructs a new <code>GetMergeOptionsOutput</code>.
     * @alias module:model/GetMergeOptionsOutput
     * @param mergeOptions {Array} 
     * @param sourceCommitId {String} 
     * @param destinationCommitId {String} 
     * @param baseCommitId {String} 
     */
    constructor(mergeOptions, sourceCommitId, destinationCommitId, baseCommitId) { 
        
        GetMergeOptionsOutput.initialize(this, mergeOptions, sourceCommitId, destinationCommitId, baseCommitId);
    }
     ...
     */
    static initialize(obj, mergeOptions, sourceCommitId, destinationCommitId, baseCommitId) { 
        obj['mergeOptions'] = mergeOptions;
        obj['sourceCommitId'] = sourceCommitId;
        obj['destinationCommitId'] = destinationCommitId;
        obj['baseCommitId'] = baseCommitId;
    }

    /**
     * Constructs a <code>GetMergeOptionsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetMergeOptionsOutput} obj Optional instance to populate.
     * @return {module:model/GetMergeOptionsOutput} The populated <code>GetMergeOptionsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetMergeOptionsOutput();

            if (data.hasOwnProperty('mergeOptions')) {
                obj['mergeOptions'] = ApiClient.convertToType(data['mergeOptions'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetMergeOptionsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetMergeOptionsOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetMergeOptionsOutput.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `mergeOptions`
        if (data['mergeOptions']) { // data not null
          Array.validateJSON(data['mergeOptions']);
        }
...
GetMergeOptionsOutput.RequiredProperties = ["mergeOptions", "sourceCommitId", "destinationCommitId", "baseCommitId"];

/**
 * @member {Array} mergeOptions
 */
GetMergeOptionsOutput.prototype['mergeOptions'] = undefined;

/**
 * @member {String} sourceCommitId
 */
GetMergeOptionsOutput.prototype['sourceCommitId'] = undefined;

/**
 * @member {String} destinationCommitId
 */
GetMergeOptionsOutput.prototype['destinationCommitId'] = undefined;

/**
 * @member {String} baseCommitId
 */
GetMergeOptionsOutput.prototype['baseCommitId'] = undefined;
...
export default GetMergeOptionsOutput;
