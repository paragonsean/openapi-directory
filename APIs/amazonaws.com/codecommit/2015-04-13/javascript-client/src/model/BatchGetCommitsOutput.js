...
/**
 * The BatchGetCommitsOutput model module.
 * @module model/BatchGetCommitsOutput
 * @version 2015-04-13
 */
class BatchGetCommitsOutput {
    /**
     * Constructs a new <code>BatchGetCommitsOutput</code>.
     * @alias module:model/BatchGetCommitsOutput
     */
    constructor() { 
        
        BatchGetCommitsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchGetCommitsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchGetCommitsOutput} obj Optional instance to populate.
     * @return {module:model/BatchGetCommitsOutput} The populated <code>BatchGetCommitsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchGetCommitsOutput();

            if (data.hasOwnProperty('commits')) {
                obj['commits'] = ApiClient.convertToType(data['commits'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>BatchGetCommitsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchGetCommitsOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `commits`
        if (data['commits']) { // data not null
          Array.validateJSON(data['commits']);
        }
 ...
 */
BatchGetCommitsOutput.prototype['commits'] = undefined;

/**
 * @member {Array} errors
 */
BatchGetCommitsOutput.prototype['errors'] = undefined;
...
export default BatchGetCommitsOutput;
