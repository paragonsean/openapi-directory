...
/**
 * The MergeHunkDestination model module.
 * @module model/MergeHunkDestination
 * @version 2015-04-13
 */
class MergeHunkDestination {
    /**
     * Constructs a new <code>MergeHunkDestination</code>.
     * @alias module:model/MergeHunkDestination
     * @implements module:model/MergeHunkDetail
     */
    constructor() { 
        MergeHunkDetail.initialize(this);
        MergeHunkDestination.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MergeHunkDestination</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MergeHunkDestination} obj Optional instance to populate.
     * @return {module:model/MergeHunkDestination} The populated <code>MergeHunkDestination</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MergeHunkDestination();
    ...
    /**
     * Validates the JSON data with respect to <code>MergeHunkDestination</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MergeHunkDestination</code>.
     */
 ...
 */
MergeHunkDestination.prototype['startLine'] = undefined;

/**
 * @member {Number} endLine
 */
MergeHunkDestination.prototype['endLine'] = undefined;

/**
 * @member {String} hunkContent
 */
MergeHunkDestination.prototype['hunkContent'] = undefined;
...
export default MergeHunkDestination;
