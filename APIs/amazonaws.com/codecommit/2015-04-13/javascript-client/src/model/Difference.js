...
import DifferenceAfterBlob from './DifferenceAfterBlob';
import DifferenceBeforeBlob from './DifferenceBeforeBlob';

/**
 * The Difference model module.
 * @module model/Difference
 * @version 2015-04-13
 */
class Difference {
    /**
     * Constructs a new <code>Difference</code>.
     * Returns information about a set of differences for a commit specifier.
     * @alias module:model/Difference
     */
    constructor() { 
        
        Difference.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Difference</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Difference} obj Optional instance to populate.
     * @return {module:model/Difference} The populated <code>Difference</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Difference();

            if (data.hasOwnProperty('beforeBlob')) {
                obj['beforeBlob'] = DifferenceBeforeBlob.constructFromObject(data['beforeBlob']);
            }
            if (data.hasOwnProperty('afterBlob')) {
                obj['afterBlob'] = DifferenceAfterBlob.constructFromObject(data['afterBlob']);
            }
            if (data.hasOwnProperty('changeType')) {
                obj['changeType'] = ApiClient.convertToType(data['changeType'], ChangeTypeEnum);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Difference</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Difference</code>.
     */
    static validateJSON(data) {
        // validate the optional field `beforeBlob`
        if (data['beforeBlob']) { // data not null
          DifferenceBeforeBlob.validateJSON(data['beforeBlob']);
        }
        // validate the optional field `afterBlob`
        if (data['afterBlob']) { // data not null
          DifferenceAfterBlob.validateJSON(data['afterBlob']);
        }
        // validate the optional field `changeType`
        if (data['changeType']) { // data not null
          ChangeTypeEnum.validateJSON(data['changeType']);
        }
...
/**
 * @member {module:model/DifferenceBeforeBlob} beforeBlob
 */
Difference.prototype['beforeBlob'] = undefined;

/**
 * @member {module:model/DifferenceAfterBlob} afterBlob
 */
Difference.prototype['afterBlob'] = undefined;

/**
 * @member {module:model/ChangeTypeEnum} changeType
 */
Difference.prototype['changeType'] = undefined;
