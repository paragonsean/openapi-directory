...
/**
 * The MergePullRequestByThreeWayInput model module.
 * @module model/MergePullRequestByThreeWayInput
 * @version 2015-04-13
 */
class MergePullRequestByThreeWayInput {
    /**
     * Constructs a new <code>MergePullRequestByThreeWayInput</code>.
     * @alias module:model/MergePullRequestByThreeWayInput
     * @param pullRequestId {String} 
     * @param repositoryName {String} 
     */
    constructor(pullRequestId, repositoryName) { 
        
        MergePullRequestByThreeWayInput.initialize(this, pullRequestId, repositoryName);
    }
    ...
    /**
     * Constructs a <code>MergePullRequestByThreeWayInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MergePullRequestByThreeWayInput} obj Optional instance to populate.
     * @return {module:model/MergePullRequestByThreeWayInput} The populated <code>MergePullRequestByThreeWayInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MergePullRequestByThreeWayInput();
    ...
    /**
     * Validates the JSON data with respect to <code>MergePullRequestByThreeWayInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MergePullRequestByThreeWayInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MergePullRequestByThreeWayInput.RequiredProperties) {
...
MergePullRequestByThreeWayInput.RequiredProperties = ["pullRequestId", "repositoryName"];

/**
 * @member {String} pullRequestId
 */
MergePullRequestByThreeWayInput.prototype['pullRequestId'] = undefined;

/**
 * @member {String} repositoryName
 */
MergePullRequestByThreeWayInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} sourceCommitId
 */
MergePullRequestByThreeWayInput.prototype['sourceCommitId'] = undefined;

/**
 * @member {module:model/ConflictDetailLevelTypeEnum} conflictDetailLevel
 */
MergePullRequestByThreeWayInput.prototype['conflictDetailLevel'] = undefined;

/**
 * @member {module:model/ConflictResolutionStrategyTypeEnum} conflictResolutionStrategy
 */
MergePullRequestByThreeWayInput.prototype['conflictResolutionStrategy'] = undefined;

/**
 * @member {String} commitMessage
 */
MergePullRequestByThreeWayInput.prototype['commitMessage'] = undefined;

/**
 * @member {String} authorName
 */
MergePullRequestByThreeWayInput.prototype['authorName'] = undefined;

/**
 * @member {String} email
 */
MergePullRequestByThreeWayInput.prototype['email'] = undefined;

/**
 * @member {Boolean} keepEmptyFolders
 */
MergePullRequestByThreeWayInput.prototype['keepEmptyFolders'] = undefined;

/**
 * @member {module:model/CreateUnreferencedMergeCommitInputConflictResolution} conflictResolution
 */
MergePullRequestByThreeWayInput.prototype['conflictResolution'] = undefined;
...
export default MergePullRequestByThreeWayInput;
