...
/**
 * The DeletePullRequestApprovalRuleOutput model module.
 * @module model/DeletePullRequestApprovalRuleOutput
 * @version 2015-04-13
 */
class DeletePullRequestApprovalRuleOutput {
    /**
     * Constructs a new <code>DeletePullRequestApprovalRuleOutput</code>.
     * @alias module:model/DeletePullRequestApprovalRuleOutput
     * @param approvalRuleId {String} 
     */
    constructor(approvalRuleId) { 
        
        DeletePullRequestApprovalRuleOutput.initialize(this, approvalRuleId);
    }
     ...
     */
    static initialize(obj, approvalRuleId) { 
        obj['approvalRuleId'] = approvalRuleId;
    }

    /**
     * Constructs a <code>DeletePullRequestApprovalRuleOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeletePullRequestApprovalRuleOutput} obj Optional instance to populate.
     * @return {module:model/DeletePullRequestApprovalRuleOutput} The populated <code>DeletePullRequestApprovalRuleOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeletePullRequestApprovalRuleOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeletePullRequestApprovalRuleOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeletePullRequestApprovalRuleOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeletePullRequestApprovalRuleOutput.RequiredProperties) {
...
DeletePullRequestApprovalRuleOutput.RequiredProperties = ["approvalRuleId"];

/**
 * @member {String} approvalRuleId
 */
DeletePullRequestApprovalRuleOutput.prototype['approvalRuleId'] = undefined;
...
export default DeletePullRequestApprovalRuleOutput;
