...
class Approval {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('approvalState')) {
                obj['approvalState'] = ApiClient.convertToType(data['approvalState'], ApprovalState);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['approvalState']) { // data not null
          ApprovalState.validateJSON(data['approvalState']);
        }
 ...
 */
Approval.prototype['userArn'] = undefined;

/**
 * @member {module:model/ApprovalState} approvalState
 */
Approval.prototype['approvalState'] = undefined;
