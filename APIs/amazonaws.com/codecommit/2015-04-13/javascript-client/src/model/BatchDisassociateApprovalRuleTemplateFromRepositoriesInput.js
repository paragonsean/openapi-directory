...
/**
 * The BatchDisassociateApprovalRuleTemplateFromRepositoriesInput model module.
 * @module model/BatchDisassociateApprovalRuleTemplateFromRepositoriesInput
 * @version 2015-04-13
 */
class BatchDisassociateApprovalRuleTemplateFromRepositoriesInput {
    /**
     * Constructs a new <code>BatchDisassociateApprovalRuleTemplateFromRepositoriesInput</code>.
     * @alias module:model/BatchDisassociateApprovalRuleTemplateFromRepositoriesInput
     * @param approvalRuleTemplateName {String} 
     * @param repositoryNames {Array} 
     */
    constructor(approvalRuleTemplateName, repositoryNames) { 
        
        BatchDisassociateApprovalRuleTemplateFromRepositoriesInput.initialize(this, approvalRuleTemplateName, repositoryNames);
    }
     ...
     */
    static initialize(obj, approvalRuleTemplateName, repositoryNames) { 
        obj['approvalRuleTemplateName'] = approvalRuleTemplateName;
        obj['repositoryNames'] = repositoryNames;
    }

    /**
     * Constructs a <code>BatchDisassociateApprovalRuleTemplateFromRepositoriesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchDisassociateApprovalRuleTemplateFromRepositoriesInput} obj Optional instance to populate.
     * @return {module:model/BatchDisassociateApprovalRuleTemplateFromRepositoriesInput} The populated <code>BatchDisassociateApprovalRuleTemplateFromRepositoriesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchDisassociateApprovalRuleTemplateFromRepositoriesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchDisassociateApprovalRuleTemplateFromRepositoriesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchDisassociateApprovalRuleTemplateFromRepositoriesInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BatchDisassociateApprovalRuleTemplateFromRepositoriesInput.RequiredProperties) {
...
BatchDisassociateApprovalRuleTemplateFromRepositoriesInput.RequiredProperties = ["approvalRuleTemplateName", "repositoryNames"];

/**
 * @member {String} approvalRuleTemplateName
 */
BatchDisassociateApprovalRuleTemplateFromRepositoriesInput.prototype['approvalRuleTemplateName'] = undefined;

/**
 * @member {Array} repositoryNames
 */
BatchDisassociateApprovalRuleTemplateFromRepositoriesInput.prototype['repositoryNames'] = undefined;
...
export default BatchDisassociateApprovalRuleTemplateFromRepositoriesInput;
