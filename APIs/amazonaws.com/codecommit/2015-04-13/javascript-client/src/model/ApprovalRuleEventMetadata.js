...
/**
 * The ApprovalRuleEventMetadata model module.
 * @module model/ApprovalRuleEventMetadata
 * @version 2015-04-13
 */
class ApprovalRuleEventMetadata {
    /**
     * Constructs a new <code>ApprovalRuleEventMetadata</code>.
     * Returns information about an event for an approval rule.
     * @alias module:model/ApprovalRuleEventMetadata
     */
    constructor() { 
        
        ApprovalRuleEventMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApprovalRuleEventMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApprovalRuleEventMetadata} obj Optional instance to populate.
     * @return {module:model/ApprovalRuleEventMetadata} The populated <code>ApprovalRuleEventMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApprovalRuleEventMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>ApprovalRuleEventMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApprovalRuleEventMetadata</code>.
     */
 ...
 */
ApprovalRuleEventMetadata.prototype['approvalRuleName'] = undefined;

/**
 * @member {String} approvalRuleId
 */
ApprovalRuleEventMetadata.prototype['approvalRuleId'] = undefined;

/**
 * @member {String} approvalRuleContent
 */
ApprovalRuleEventMetadata.prototype['approvalRuleContent'] = undefined;
...
export default ApprovalRuleEventMetadata;
