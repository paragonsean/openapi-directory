...
/**
 * The PostCommentReplyInput model module.
 * @module model/PostCommentReplyInput
 * @version 2015-04-13
 */
class PostCommentReplyInput {
    /**
     * Constructs a new <code>PostCommentReplyInput</code>.
     * @alias module:model/PostCommentReplyInput
     * @param inReplyTo {String} 
     * @param content {String} 
     */
    constructor(inReplyTo, content) { 
        
        PostCommentReplyInput.initialize(this, inReplyTo, content);
    }
     ...
     */
    static initialize(obj, inReplyTo, content) { 
        obj['inReplyTo'] = inReplyTo;
        obj['content'] = content;
    }

    /**
     * Constructs a <code>PostCommentReplyInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostCommentReplyInput} obj Optional instance to populate.
     * @return {module:model/PostCommentReplyInput} The populated <code>PostCommentReplyInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostCommentReplyInput();
    ...
    /**
     * Validates the JSON data with respect to <code>PostCommentReplyInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostCommentReplyInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PostCommentReplyInput.RequiredProperties) {
...
PostCommentReplyInput.RequiredProperties = ["inReplyTo", "content"];

/**
 * @member {String} inReplyTo
 */
PostCommentReplyInput.prototype['inReplyTo'] = undefined;

/**
 * @member {String} clientRequestToken
 */
PostCommentReplyInput.prototype['clientRequestToken'] = undefined;

/**
 * @member {String} content
 */
PostCommentReplyInput.prototype['content'] = undefined;
...
export default PostCommentReplyInput;
