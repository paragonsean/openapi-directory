...
/**
 * The GetRepositoryInput model module.
 * @module model/GetRepositoryInput
 * @version 2015-04-13
 */
class GetRepositoryInput {
    /**
     * Constructs a new <code>GetRepositoryInput</code>.
     * Represents the input of a get repository operation.
     * @alias module:model/GetRepositoryInput
     * @param repositoryName {String} 
     */
    constructor(repositoryName) { 
        
        GetRepositoryInput.initialize(this, repositoryName);
    }
    ...
    /**
     * Constructs a <code>GetRepositoryInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetRepositoryInput} obj Optional instance to populate.
     * @return {module:model/GetRepositoryInput} The populated <code>GetRepositoryInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetRepositoryInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetRepositoryInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetRepositoryInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetRepositoryInput.RequiredProperties) {
...
GetRepositoryInput.RequiredProperties = ["repositoryName"];

/**
 * @member {String} repositoryName
 */
GetRepositoryInput.prototype['repositoryName'] = undefined;
...
export default GetRepositoryInput;
