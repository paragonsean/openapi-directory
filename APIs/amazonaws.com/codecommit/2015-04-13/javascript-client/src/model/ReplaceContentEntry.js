...
import ReplacementTypeEnum from './ReplacementTypeEnum';

/**
 * The ReplaceContentEntry model module.
 * @module model/ReplaceContentEntry
 * @version 2015-04-13
 */
class ReplaceContentEntry {
    /**
     * Constructs a new <code>ReplaceContentEntry</code>.
     * Information about a replacement content entry in the conflict of a merge or pull request operation.
     * @alias module:model/ReplaceContentEntry
     * @param filePath {String} 
     * @param replacementType {module:model/ReplacementTypeEnum} 
     */
    constructor(filePath, replacementType) { 
        
        ReplaceContentEntry.initialize(this, filePath, replacementType);
    }
     ...
     */
    static initialize(obj, filePath, replacementType) { 
        obj['filePath'] = filePath;
        obj['replacementType'] = replacementType;
    }

    /**
     * Constructs a <code>ReplaceContentEntry</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReplaceContentEntry} obj Optional instance to populate.
     * @return {module:model/ReplaceContentEntry} The populated <code>ReplaceContentEntry</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReplaceContentEntry();
            ...
            if (data.hasOwnProperty('replacementType')) {
                obj['replacementType'] = ApiClient.convertToType(data['replacementType'], ReplacementTypeEnum);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ReplaceContentEntry</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReplaceContentEntry</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ReplaceContentEntry.RequiredProperties) {
        ...
        // validate the optional field `replacementType`
        if (data['replacementType']) { // data not null
          ReplacementTypeEnum.validateJSON(data['replacementType']);
        }
...
ReplaceContentEntry.RequiredProperties = ["filePath", "replacementType"];

/**
 * @member {String} filePath
 */
ReplaceContentEntry.prototype['filePath'] = undefined;

/**
 * @member {module:model/ReplacementTypeEnum} replacementType
 */
ReplaceContentEntry.prototype['replacementType'] = undefined;

/**
 * @member {String} content
 */
ReplaceContentEntry.prototype['content'] = undefined;

/**
 * @member {module:model/FileModeTypeEnum} fileMode
 */
ReplaceContentEntry.prototype['fileMode'] = undefined;
...
export default ReplaceContentEntry;
