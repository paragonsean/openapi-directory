...
import PullRequestMergedStateChangedEventMetadataMergeMetadata from './PullRequestMergedStateChangedEventMetadataMergeMetadata';

/**
 * The PullRequestEventPullRequestMergedStateChangedEventMetadata model module.
 * @module model/PullRequestEventPullRequestMergedStateChangedEventMetadata
 * @version 2015-04-13
 */
class PullRequestEventPullRequestMergedStateChangedEventMetadata {
    /**
     * Constructs a new <code>PullRequestEventPullRequestMergedStateChangedEventMetadata</code>.
     * @alias module:model/PullRequestEventPullRequestMergedStateChangedEventMetadata
     * @implements module:model/PullRequestMergedStateChangedEventMetadata
     */
    constructor() { 
        PullRequestMergedStateChangedEventMetadata.initialize(this);
        PullRequestEventPullRequestMergedStateChangedEventMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PullRequestEventPullRequestMergedStateChangedEventMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PullRequestEventPullRequestMergedStateChangedEventMetadata} obj Optional instance to populate.
     * @return {module:model/PullRequestEventPullRequestMergedStateChangedEventMetadata} The populated <code>PullRequestEventPullRequestMergedStateChangedEventMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PullRequestEventPullRequestMergedStateChangedEventMetadata();
            PullRequestMergedStateChangedEventMetadata.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('mergeMetadata')) {
                obj['mergeMetadata'] = PullRequestMergedStateChangedEventMetadataMergeMetadata.constructFromObject(data['mergeMetadata']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PullRequestEventPullRequestMergedStateChangedEventMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PullRequestEventPullRequestMergedStateChangedEventMetadata</code>.
     */
    static validateJSON(data) {
        ...
        if (data['mergeMetadata']) { // data not null
          PullRequestMergedStateChangedEventMetadataMergeMetadata.validateJSON(data['mergeMetadata']);
        }
 ...
 */
PullRequestEventPullRequestMergedStateChangedEventMetadata.prototype['repositoryName'] = undefined;

/**
 * @member {String} destinationReference
 */
PullRequestEventPullRequestMergedStateChangedEventMetadata.prototype['destinationReference'] = undefined;

/**
 * @member {module:model/PullRequestMergedStateChangedEventMetadataMergeMetadata} mergeMetadata
 */
PullRequestEventPullRequestMergedStateChangedEventMetadata.prototype['mergeMetadata'] = undefined;


// Implement PullRequestMergedStateChangedEventMetadata interface:
/**
 * @member {String} repositoryName
 */
PullRequestMergedStateChangedEventMetadata.prototype['repositoryName'] = undefined;
/**
 * @member {String} destinationReference
 */
PullRequestMergedStateChangedEventMetadata.prototype['destinationReference'] = undefined;
/**
 * @member {module:model/PullRequestMergedStateChangedEventMetadataMergeMetadata} mergeMetadata
 */
PullRequestMergedStateChangedEventMetadata.prototype['mergeMetadata'] = undefined;




export default PullRequestEventPullRequestMergedStateChangedEventMetadata;
