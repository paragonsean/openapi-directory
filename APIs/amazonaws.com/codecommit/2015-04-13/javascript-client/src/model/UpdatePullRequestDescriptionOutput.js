...
/**
 * The UpdatePullRequestDescriptionOutput model module.
 * @module model/UpdatePullRequestDescriptionOutput
 * @version 2015-04-13
 */
class UpdatePullRequestDescriptionOutput {
    /**
     * Constructs a new <code>UpdatePullRequestDescriptionOutput</code>.
     * @alias module:model/UpdatePullRequestDescriptionOutput
     * @param pullRequest {module:model/UpdatePullRequestDescriptionOutputPullRequest} 
     */
    constructor(pullRequest) { 
        
        UpdatePullRequestDescriptionOutput.initialize(this, pullRequest);
    }
    ...
    /**
     * Constructs a <code>UpdatePullRequestDescriptionOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePullRequestDescriptionOutput} obj Optional instance to populate.
     * @return {module:model/UpdatePullRequestDescriptionOutput} The populated <code>UpdatePullRequestDescriptionOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePullRequestDescriptionOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePullRequestDescriptionOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePullRequestDescriptionOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdatePullRequestDescriptionOutput.RequiredProperties) {
...
UpdatePullRequestDescriptionOutput.RequiredProperties = ["pullRequest"];

/**
 * @member {module:model/UpdatePullRequestDescriptionOutputPullRequest} pullRequest
 */
UpdatePullRequestDescriptionOutput.prototype['pullRequest'] = undefined;
...
export default UpdatePullRequestDescriptionOutput;
