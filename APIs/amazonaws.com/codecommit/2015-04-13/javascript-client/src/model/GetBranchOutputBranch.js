...
/**
 * The GetBranchOutputBranch model module.
 * @module model/GetBranchOutputBranch
 * @version 2015-04-13
 */
class GetBranchOutputBranch {
    /**
     * Constructs a new <code>GetBranchOutputBranch</code>.
     * @alias module:model/GetBranchOutputBranch
     * @implements module:model/BranchInfo
     */
    constructor() { 
        BranchInfo.initialize(this);
        GetBranchOutputBranch.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetBranchOutputBranch</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetBranchOutputBranch} obj Optional instance to populate.
     * @return {module:model/GetBranchOutputBranch} The populated <code>GetBranchOutputBranch</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetBranchOutputBranch();
            BranchInfo.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>GetBranchOutputBranch</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBranchOutputBranch</code>.
     */
 ...
 */
GetBranchOutputBranch.prototype['branchName'] = undefined;

/**
 * @member {String} commitId
 */
GetBranchOutputBranch.prototype['commitId'] = undefined;


// Implement BranchInfo interface:
/**
 * @member {String} branchName
 */
BranchInfo.prototype['branchName'] = undefined;
/**
 * @member {String} commitId
 */
BranchInfo.prototype['commitId'] = undefined;




export default GetBranchOutputBranch;
