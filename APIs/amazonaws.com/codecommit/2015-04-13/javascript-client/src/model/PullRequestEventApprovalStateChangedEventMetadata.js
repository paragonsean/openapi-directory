...
/**
 * The PullRequestEventApprovalStateChangedEventMetadata model module.
 * @module model/PullRequestEventApprovalStateChangedEventMetadata
 * @version 2015-04-13
 */
class PullRequestEventApprovalStateChangedEventMetadata {
    /**
     * Constructs a new <code>PullRequestEventApprovalStateChangedEventMetadata</code>.
     * @alias module:model/PullRequestEventApprovalStateChangedEventMetadata
     * @implements module:model/ApprovalStateChangedEventMetadata
     */
    constructor() { 
        ApprovalStateChangedEventMetadata.initialize(this);
        PullRequestEventApprovalStateChangedEventMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PullRequestEventApprovalStateChangedEventMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PullRequestEventApprovalStateChangedEventMetadata} obj Optional instance to populate.
     * @return {module:model/PullRequestEventApprovalStateChangedEventMetadata} The populated <code>PullRequestEventApprovalStateChangedEventMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PullRequestEventApprovalStateChangedEventMetadata();
            ApprovalStateChangedEventMetadata.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>PullRequestEventApprovalStateChangedEventMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PullRequestEventApprovalStateChangedEventMetadata</code>.
     */
 ...
 */
PullRequestEventApprovalStateChangedEventMetadata.prototype['revisionId'] = undefined;

/**
 * @member {module:model/ApprovalState} approvalStatus
 */
PullRequestEventApprovalStateChangedEventMetadata.prototype['approvalStatus'] = undefined;


// Implement ApprovalStateChangedEventMetadata interface:
/**
 * @member {String} revisionId
 */
...
export default PullRequestEventApprovalStateChangedEventMetadata;
