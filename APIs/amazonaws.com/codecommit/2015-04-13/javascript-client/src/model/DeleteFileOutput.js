...
/**
 * The DeleteFileOutput model module.
 * @module model/DeleteFileOutput
 * @version 2015-04-13
 */
class DeleteFileOutput {
    /**
     * Constructs a new <code>DeleteFileOutput</code>.
     * @alias module:model/DeleteFileOutput
     * @param commitId {String} 
     * @param blobId {String} 
     * @param treeId {String} 
     * @param filePath {String} 
     */
    constructor(commitId, blobId, treeId, filePath) { 
        
        DeleteFileOutput.initialize(this, commitId, blobId, treeId, filePath);
    }
     ...
     */
    static initialize(obj, commitId, blobId, treeId, filePath) { 
    ...
    /**
     * Constructs a <code>DeleteFileOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteFileOutput} obj Optional instance to populate.
     * @return {module:model/DeleteFileOutput} The populated <code>DeleteFileOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteFileOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteFileOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteFileOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteFileOutput.RequiredProperties) {
...
DeleteFileOutput.RequiredProperties = ["commitId", "blobId", "treeId", "filePath"];

/**
 * @member {String} commitId
 */
DeleteFileOutput.prototype['commitId'] = undefined;

/**
 * @member {String} blobId
 */
DeleteFileOutput.prototype['blobId'] = undefined;

/**
 * @member {String} treeId
 */
DeleteFileOutput.prototype['treeId'] = undefined;

/**
 * @member {String} filePath
 */
DeleteFileOutput.prototype['filePath'] = undefined;
...
export default DeleteFileOutput;
