...
/**
 * The MergeBranchesBySquashInput model module.
 * @module model/MergeBranchesBySquashInput
 * @version 2015-04-13
 */
class MergeBranchesBySquashInput {
    /**
     * Constructs a new <code>MergeBranchesBySquashInput</code>.
     * @alias module:model/MergeBranchesBySquashInput
    ...
    constructor(repositoryName, sourceCommitSpecifier, destinationCommitSpecifier) { 
        ...
        MergeBranchesBySquashInput.initialize(this, repositoryName, sourceCommitSpecifier, destinationCommitSpecifier);
    }
    ...
    /**
     * Constructs a <code>MergeBranchesBySquashInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MergeBranchesBySquashInput} obj Optional instance to populate.
     * @return {module:model/MergeBranchesBySquashInput} The populated <code>MergeBranchesBySquashInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MergeBranchesBySquashInput();
    ...
    /**
     * Validates the JSON data with respect to <code>MergeBranchesBySquashInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MergeBranchesBySquashInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MergeBranchesBySquashInput.RequiredProperties) {
...
MergeBranchesBySquashInput.RequiredProperties = ["repositoryName", "sourceCommitSpecifier", "destinationCommitSpecifier"];

/**
 * @member {String} repositoryName
 */
MergeBranchesBySquashInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} sourceCommitSpecifier
 */
MergeBranchesBySquashInput.prototype['sourceCommitSpecifier'] = undefined;

/**
 * @member {String} destinationCommitSpecifier
 */
MergeBranchesBySquashInput.prototype['destinationCommitSpecifier'] = undefined;

/**
 * @member {String} targetBranch
 */
MergeBranchesBySquashInput.prototype['targetBranch'] = undefined;

/**
 * @member {module:model/ConflictDetailLevelTypeEnum} conflictDetailLevel
 */
MergeBranchesBySquashInput.prototype['conflictDetailLevel'] = undefined;

/**
 * @member {module:model/ConflictResolutionStrategyTypeEnum} conflictResolutionStrategy
 */
MergeBranchesBySquashInput.prototype['conflictResolutionStrategy'] = undefined;

/**
 * @member {String} authorName
 */
MergeBranchesBySquashInput.prototype['authorName'] = undefined;

/**
 * @member {String} email
 */
MergeBranchesBySquashInput.prototype['email'] = undefined;

/**
 * @member {String} commitMessage
 */
MergeBranchesBySquashInput.prototype['commitMessage'] = undefined;

/**
 * @member {Boolean} keepEmptyFolders
 */
MergeBranchesBySquashInput.prototype['keepEmptyFolders'] = undefined;

/**
 * @member {module:model/CreateUnreferencedMergeCommitInputConflictResolution} conflictResolution
 */
MergeBranchesBySquashInput.prototype['conflictResolution'] = undefined;
...
export default MergeBranchesBySquashInput;
