...
import GetCommentOutputComment from './GetCommentOutputComment';

/**
 * The GetCommentOutput model module.
 * @module model/GetCommentOutput
 * @version 2015-04-13
 */
class GetCommentOutput {
    /**
     * Constructs a new <code>GetCommentOutput</code>.
     * @alias module:model/GetCommentOutput
     */
    constructor() { 
        
        GetCommentOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetCommentOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCommentOutput} obj Optional instance to populate.
     * @return {module:model/GetCommentOutput} The populated <code>GetCommentOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCommentOutput();

            if (data.hasOwnProperty('comment')) {
                obj['comment'] = GetCommentOutputComment.constructFromObject(data['comment']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetCommentOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCommentOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `comment`
        if (data['comment']) { // data not null
          GetCommentOutputComment.validateJSON(data['comment']);
        }
...
/**
 * @member {module:model/GetCommentOutputComment} comment
 */
GetCommentOutput.prototype['comment'] = undefined;
...
export default GetCommentOutput;
