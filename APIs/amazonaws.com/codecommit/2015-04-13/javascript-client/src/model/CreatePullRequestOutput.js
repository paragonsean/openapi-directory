...
import CreatePullRequestOutputPullRequest from './CreatePullRequestOutputPullRequest';

/**
 * The CreatePullRequestOutput model module.
 * @module model/CreatePullRequestOutput
 * @version 2015-04-13
 */
class CreatePullRequestOutput {
    /**
     * Constructs a new <code>CreatePullRequestOutput</code>.
     * @alias module:model/CreatePullRequestOutput
     * @param pullRequest {module:model/CreatePullRequestOutputPullRequest} 
     */
    constructor(pullRequest) { 
        
        CreatePullRequestOutput.initialize(this, pullRequest);
    }
    ...
    /**
     * Constructs a <code>CreatePullRequestOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePullRequestOutput} obj Optional instance to populate.
     * @return {module:model/CreatePullRequestOutput} The populated <code>CreatePullRequestOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePullRequestOutput();

            if (data.hasOwnProperty('pullRequest')) {
                obj['pullRequest'] = CreatePullRequestOutputPullRequest.constructFromObject(data['pullRequest']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePullRequestOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePullRequestOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreatePullRequestOutput.RequiredProperties) {
        ...
        if (data['pullRequest']) { // data not null
          CreatePullRequestOutputPullRequest.validateJSON(data['pullRequest']);
        }
...
CreatePullRequestOutput.RequiredProperties = ["pullRequest"];

/**
 * @member {module:model/CreatePullRequestOutputPullRequest} pullRequest
 */
CreatePullRequestOutput.prototype['pullRequest'] = undefined;
...
export default CreatePullRequestOutput;
