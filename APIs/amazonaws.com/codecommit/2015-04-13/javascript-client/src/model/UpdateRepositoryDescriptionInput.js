...
/**
 * The UpdateRepositoryDescriptionInput model module.
 * @module model/UpdateRepositoryDescriptionInput
 * @version 2015-04-13
 */
class UpdateRepositoryDescriptionInput {
    /**
     * Constructs a new <code>UpdateRepositoryDescriptionInput</code>.
     * Represents the input of an update repository description operation.
     * @alias module:model/UpdateRepositoryDescriptionInput
     * @param repositoryName {String} 
     */
    constructor(repositoryName) { 
        
        UpdateRepositoryDescriptionInput.initialize(this, repositoryName);
    }
    ...
    /**
     * Constructs a <code>UpdateRepositoryDescriptionInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateRepositoryDescriptionInput} obj Optional instance to populate.
     * @return {module:model/UpdateRepositoryDescriptionInput} The populated <code>UpdateRepositoryDescriptionInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateRepositoryDescriptionInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateRepositoryDescriptionInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateRepositoryDescriptionInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateRepositoryDescriptionInput.RequiredProperties) {
...
UpdateRepositoryDescriptionInput.RequiredProperties = ["repositoryName"];

/**
 * @member {String} repositoryName
 */
UpdateRepositoryDescriptionInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} repositoryDescription
 */
UpdateRepositoryDescriptionInput.prototype['repositoryDescription'] = undefined;
...
export default UpdateRepositoryDescriptionInput;
