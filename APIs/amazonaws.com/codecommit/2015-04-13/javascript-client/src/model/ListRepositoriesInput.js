...
/**
 * The ListRepositoriesInput model module.
 * @module model/ListRepositoriesInput
 * @version 2015-04-13
 */
class ListRepositoriesInput {
    /**
     * Constructs a new <code>ListRepositoriesInput</code>.
     * Represents the input of a list repositories operation.
     * @alias module:model/ListRepositoriesInput
     */
    constructor() { 
        
        ListRepositoriesInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListRepositoriesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListRepositoriesInput} obj Optional instance to populate.
     * @return {module:model/ListRepositoriesInput} The populated <code>ListRepositoriesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListRepositoriesInput();

            if (data.hasOwnProperty('nextToken')) {
                obj['nextToken'] = ApiClient.convertToType(data['nextToken'], 'String');
            }
            if (data.hasOwnProperty('sortBy')) {
                obj['sortBy'] = ApiClient.convertToType(data['sortBy'], SortByEnum);
            }
            if (data.hasOwnProperty('order')) {
                obj['order'] = ApiClient.convertToType(data['order'], OrderEnum);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListRepositoriesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListRepositoriesInput</code>.
     */
    static validateJSON(data) {
        ...
        if (data['sortBy']) { // data not null
          SortByEnum.validateJSON(data['sortBy']);
        }
        // validate the optional field `order`
        if (data['order']) { // data not null
          OrderEnum.validateJSON(data['order']);
        }
 ...
 */
ListRepositoriesInput.prototype['nextToken'] = undefined;

/**
 * @member {module:model/SortByEnum} sortBy
 */
ListRepositoriesInput.prototype['sortBy'] = undefined;

/**
 * @member {module:model/OrderEnum} order
 */
ListRepositoriesInput.prototype['order'] = undefined;
...
export default ListRepositoriesInput;
