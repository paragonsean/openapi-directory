...
import GetRepositoryOutputRepositoryMetadata from './GetRepositoryOutputRepositoryMetadata';

/**
 * The GetRepositoryOutput model module.
 * @module model/GetRepositoryOutput
 * @version 2015-04-13
 */
class GetRepositoryOutput {
    /**
     * Constructs a new <code>GetRepositoryOutput</code>.
     * Represents the output of a get repository operation.
     * @alias module:model/GetRepositoryOutput
     */
    constructor() { 
        
        GetRepositoryOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetRepositoryOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetRepositoryOutput} obj Optional instance to populate.
     * @return {module:model/GetRepositoryOutput} The populated <code>GetRepositoryOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetRepositoryOutput();

            if (data.hasOwnProperty('repositoryMetadata')) {
                obj['repositoryMetadata'] = GetRepositoryOutputRepositoryMetadata.constructFromObject(data['repositoryMetadata']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetRepositoryOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetRepositoryOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `repositoryMetadata`
        if (data['repositoryMetadata']) { // data not null
          GetRepositoryOutputRepositoryMetadata.validateJSON(data['repositoryMetadata']);
        }
...
/**
 * @member {module:model/GetRepositoryOutputRepositoryMetadata} repositoryMetadata
 */
GetRepositoryOutput.prototype['repositoryMetadata'] = undefined;
...
export default GetRepositoryOutput;
