...
/**
 * The GetFileOutput model module.
 * @module model/GetFileOutput
 * @version 2015-04-13
 */
class GetFileOutput {
    /**
     * Constructs a new <code>GetFileOutput</code>.
     * @alias module:model/GetFileOutput
     ...
     */
    constructor(commitId, blobId, filePath, fileMode, fileSize, fileContent) { 
        
        GetFileOutput.initialize(this, commitId, blobId, filePath, fileMode, fileSize, fileContent);
    }
     ...
     */
    static initialize(obj, commitId, blobId, filePath, fileMode, fileSize, fileContent) { 
    ...
    /**
     * Constructs a <code>GetFileOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetFileOutput} obj Optional instance to populate.
     * @return {module:model/GetFileOutput} The populated <code>GetFileOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetFileOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetFileOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetFileOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetFileOutput.RequiredProperties) {
        ...
        // validate the optional field `fileSize`
        if (data['fileSize']) { // data not null
          Number.validateJSON(data['fileSize']);
        }
...
GetFileOutput.RequiredProperties = ["commitId", "blobId", "filePath", "fileMode", "fileSize", "fileContent"];

/**
 * @member {String} commitId
 */
GetFileOutput.prototype['commitId'] = undefined;

/**
 * @member {String} blobId
 */
GetFileOutput.prototype['blobId'] = undefined;

/**
 * @member {String} filePath
 */
GetFileOutput.prototype['filePath'] = undefined;

/**
 * @member {module:model/FileModeTypeEnum} fileMode
 */
GetFileOutput.prototype['fileMode'] = undefined;

/**
 * @member {Number} fileSize
 */
GetFileOutput.prototype['fileSize'] = undefined;

/**
 * @member {String} fileContent
 */
GetFileOutput.prototype['fileContent'] = undefined;
