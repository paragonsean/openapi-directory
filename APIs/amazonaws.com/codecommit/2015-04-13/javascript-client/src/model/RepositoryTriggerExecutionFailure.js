...
/**
 * The RepositoryTriggerExecutionFailure model module.
 * @module model/RepositoryTriggerExecutionFailure
 * @version 2015-04-13
 */
class RepositoryTriggerExecutionFailure {
    /**
     * Constructs a new <code>RepositoryTriggerExecutionFailure</code>.
     * A trigger failed to run.
     * @alias module:model/RepositoryTriggerExecutionFailure
     */
    constructor() { 
        
        RepositoryTriggerExecutionFailure.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RepositoryTriggerExecutionFailure</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RepositoryTriggerExecutionFailure} obj Optional instance to populate.
     * @return {module:model/RepositoryTriggerExecutionFailure} The populated <code>RepositoryTriggerExecutionFailure</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RepositoryTriggerExecutionFailure();
    ...
    /**
     * Validates the JSON data with respect to <code>RepositoryTriggerExecutionFailure</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RepositoryTriggerExecutionFailure</code>.
     */
    static validateJSON(data) {
        // validate the optional field `trigger`
        if (data['trigger']) { // data not null
          String.validateJSON(data['trigger']);
        }
 ...
 */
RepositoryTriggerExecutionFailure.prototype['trigger'] = undefined;

/**
 * @member {String} failureMessage
 */
RepositoryTriggerExecutionFailure.prototype['failureMessage'] = undefined;
...
export default RepositoryTriggerExecutionFailure;
