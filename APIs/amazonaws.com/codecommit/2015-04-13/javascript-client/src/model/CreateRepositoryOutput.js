...
import CreateRepositoryOutputRepositoryMetadata from './CreateRepositoryOutputRepositoryMetadata';
...
class CreateRepositoryOutput {
    ...
    constructor() { 
        ...
        CreateRepositoryOutput.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('repositoryMetadata')) {
                obj['repositoryMetadata'] = CreateRepositoryOutputRepositoryMetadata.constructFromObject(data['repositoryMetadata']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['repositoryMetadata']) { // data not null
          CreateRepositoryOutputRepositoryMetadata.validateJSON(data['repositoryMetadata']);
        }
...
/**
 * @member {module:model/CreateRepositoryOutputRepositoryMetadata} repositoryMetadata
 */
CreateRepositoryOutput.prototype['repositoryMetadata'] = undefined;
