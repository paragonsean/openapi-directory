...
/**
 * The GetCommentReactionsOutput model module.
 * @module model/GetCommentReactionsOutput
 * @version 2015-04-13
 */
class GetCommentReactionsOutput {
    /**
     * Constructs a new <code>GetCommentReactionsOutput</code>.
     * @alias module:model/GetCommentReactionsOutput
     * @param reactionsForComment {Array} 
     */
    constructor(reactionsForComment) { 
        
        GetCommentReactionsOutput.initialize(this, reactionsForComment);
    }
     ...
     */
    static initialize(obj, reactionsForComment) { 
        obj['reactionsForComment'] = reactionsForComment;
    }

    /**
     * Constructs a <code>GetCommentReactionsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCommentReactionsOutput} obj Optional instance to populate.
     * @return {module:model/GetCommentReactionsOutput} The populated <code>GetCommentReactionsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCommentReactionsOutput();

            if (data.hasOwnProperty('reactionsForComment')) {
                obj['reactionsForComment'] = ApiClient.convertToType(data['reactionsForComment'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetCommentReactionsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCommentReactionsOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetCommentReactionsOutput.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `reactionsForComment`
        if (data['reactionsForComment']) { // data not null
          Array.validateJSON(data['reactionsForComment']);
        }
...
GetCommentReactionsOutput.RequiredProperties = ["reactionsForComment"];

/**
 * @member {Array} reactionsForComment
 */
GetCommentReactionsOutput.prototype['reactionsForComment'] = undefined;

/**
 * @member {String} nextToken
 */
GetCommentReactionsOutput.prototype['nextToken'] = undefined;
...
export default GetCommentReactionsOutput;
