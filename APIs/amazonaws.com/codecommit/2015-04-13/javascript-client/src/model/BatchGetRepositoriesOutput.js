...
/**
 * The BatchGetRepositoriesOutput model module.
 * @module model/BatchGetRepositoriesOutput
 * @version 2015-04-13
 */
class BatchGetRepositoriesOutput {
    /**
     * Constructs a new <code>BatchGetRepositoriesOutput</code>.
     * Represents the output of a batch get repositories operation.
     * @alias module:model/BatchGetRepositoriesOutput
     */
    constructor() { 
        
        BatchGetRepositoriesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchGetRepositoriesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchGetRepositoriesOutput} obj Optional instance to populate.
     * @return {module:model/BatchGetRepositoriesOutput} The populated <code>BatchGetRepositoriesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchGetRepositoriesOutput();

            if (data.hasOwnProperty('repositories')) {
                obj['repositories'] = ApiClient.convertToType(data['repositories'], Array);
            }
            if (data.hasOwnProperty('repositoriesNotFound')) {
                obj['repositoriesNotFound'] = ApiClient.convertToType(data['repositoriesNotFound'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BatchGetRepositoriesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchGetRepositoriesOutput</code>.
     */
    static validateJSON(data) {
        ...
        if (data['repositoriesNotFound']) { // data not null
          Array.validateJSON(data['repositoriesNotFound']);
        }
 ...
 */
BatchGetRepositoriesOutput.prototype['repositories'] = undefined;

/**
 * @member {Array} repositoriesNotFound
 */
BatchGetRepositoriesOutput.prototype['repositoriesNotFound'] = undefined;
...
export default BatchGetRepositoriesOutput;
