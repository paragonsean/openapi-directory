...
/**
 * The ObjectTypes model module.
 * @module model/ObjectTypes
 * @version 2015-04-13
 */
class ObjectTypes {
    /**
     * Constructs a new <code>ObjectTypes</code>.
     * Information about the type of an object in a merge operation.
     * @alias module:model/ObjectTypes
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ObjectTypes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ObjectTypes} obj Optional instance to populate.
     * @return {module:model/ObjectTypes} The populated <code>ObjectTypes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ObjectTypes();
    ...
    /**
     * Validates the JSON data with respect to <code>ObjectTypes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ObjectTypes</code>.
     */
