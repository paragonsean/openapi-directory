...
/**
 * The ConflictMetadata model module.
 * @module model/ConflictMetadata
 * @version 2015-04-13
 */
class ConflictMetadata {
    /**
     * Constructs a new <code>ConflictMetadata</code>.
     * Information about the metadata for a conflict in a merge operation.
     * @alias module:model/ConflictMetadata
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ConflictMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConflictMetadata} obj Optional instance to populate.
     * @return {module:model/ConflictMetadata} The populated <code>ConflictMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConflictMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>ConflictMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConflictMetadata</code>.
     */
...
export default ConflictMetadata;
