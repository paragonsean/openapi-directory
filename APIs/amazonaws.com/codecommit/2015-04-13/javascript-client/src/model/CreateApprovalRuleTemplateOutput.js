...
import CreateApprovalRuleTemplateOutputApprovalRuleTemplate from './CreateApprovalRuleTemplateOutputApprovalRuleTemplate';

/**
 * The CreateApprovalRuleTemplateOutput model module.
 * @module model/CreateApprovalRuleTemplateOutput
 * @version 2015-04-13
 */
class CreateApprovalRuleTemplateOutput {
    /**
     * Constructs a new <code>CreateApprovalRuleTemplateOutput</code>.
     * @alias module:model/CreateApprovalRuleTemplateOutput
     * @param approvalRuleTemplate {module:model/CreateApprovalRuleTemplateOutputApprovalRuleTemplate} 
     */
    constructor(approvalRuleTemplate) { 
        
        CreateApprovalRuleTemplateOutput.initialize(this, approvalRuleTemplate);
    }
    ...
    /**
     * Constructs a <code>CreateApprovalRuleTemplateOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateApprovalRuleTemplateOutput} obj Optional instance to populate.
     * @return {module:model/CreateApprovalRuleTemplateOutput} The populated <code>CreateApprovalRuleTemplateOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateApprovalRuleTemplateOutput();

            if (data.hasOwnProperty('approvalRuleTemplate')) {
                obj['approvalRuleTemplate'] = CreateApprovalRuleTemplateOutputApprovalRuleTemplate.constructFromObject(data['approvalRuleTemplate']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateApprovalRuleTemplateOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateApprovalRuleTemplateOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateApprovalRuleTemplateOutput.RequiredProperties) {
        ...
        if (data['approvalRuleTemplate']) { // data not null
          CreateApprovalRuleTemplateOutputApprovalRuleTemplate.validateJSON(data['approvalRuleTemplate']);
        }
...
CreateApprovalRuleTemplateOutput.RequiredProperties = ["approvalRuleTemplate"];

/**
 * @member {module:model/CreateApprovalRuleTemplateOutputApprovalRuleTemplate} approvalRuleTemplate
 */
CreateApprovalRuleTemplateOutput.prototype['approvalRuleTemplate'] = undefined;
...
export default CreateApprovalRuleTemplateOutput;
