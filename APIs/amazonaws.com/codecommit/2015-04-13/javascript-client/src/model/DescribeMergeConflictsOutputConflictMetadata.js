...
import ConflictMetadataFileModes from './ConflictMetadataFileModes';
import ConflictMetadataFileSizes from './ConflictMetadataFileSizes';
import ConflictMetadataIsBinaryFile from './ConflictMetadataIsBinaryFile';
import ConflictMetadataMergeOperations from './ConflictMetadataMergeOperations';
import ConflictMetadataObjectTypes from './ConflictMetadataObjectTypes';

/**
 * The DescribeMergeConflictsOutputConflictMetadata model module.
 * @module model/DescribeMergeConflictsOutputConflictMetadata
 * @version 2015-04-13
 */
class DescribeMergeConflictsOutputConflictMetadata {
    /**
     * Constructs a new <code>DescribeMergeConflictsOutputConflictMetadata</code>.
     * @alias module:model/DescribeMergeConflictsOutputConflictMetadata
     * @implements module:model/ConflictMetadata
     */
    constructor() { 
        ConflictMetadata.initialize(this);
        DescribeMergeConflictsOutputConflictMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeMergeConflictsOutputConflictMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeMergeConflictsOutputConflictMetadata} obj Optional instance to populate.
     * @return {module:model/DescribeMergeConflictsOutputConflictMetadata} The populated <code>DescribeMergeConflictsOutputConflictMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeMergeConflictsOutputConflictMetadata();
            ConflictMetadata.constructFromObject(data, obj);

            if (data.hasOwnProperty('filePath')) {
                obj['filePath'] = ApiClient.convertToType(data['filePath'], 'String');
            }
            if (data.hasOwnProperty('fileSizes')) {
                obj['fileSizes'] = ConflictMetadataFileSizes.constructFromObject(data['fileSizes']);
            }
            if (data.hasOwnProperty('fileModes')) {
                obj['fileModes'] = ConflictMetadataFileModes.constructFromObject(data['fileModes']);
            }
            if (data.hasOwnProperty('objectTypes')) {
                obj['objectTypes'] = ConflictMetadataObjectTypes.constructFromObject(data['objectTypes']);
            }
            if (data.hasOwnProperty('numberOfConflicts')) {
                obj['numberOfConflicts'] = ApiClient.convertToType(data['numberOfConflicts'], 'Number');
            }
            if (data.hasOwnProperty('isBinaryFile')) {
                obj['isBinaryFile'] = ConflictMetadataIsBinaryFile.constructFromObject(data['isBinaryFile']);
            }
            if (data.hasOwnProperty('contentConflict')) {
                obj['contentConflict'] = ApiClient.convertToType(data['contentConflict'], 'Boolean');
            }
            if (data.hasOwnProperty('fileModeConflict')) {
                obj['fileModeConflict'] = ApiClient.convertToType(data['fileModeConflict'], 'Boolean');
            }
            if (data.hasOwnProperty('objectTypeConflict')) {
                obj['objectTypeConflict'] = ApiClient.convertToType(data['objectTypeConflict'], 'Boolean');
            }
            if (data.hasOwnProperty('mergeOperations')) {
                obj['mergeOperations'] = ConflictMetadataMergeOperations.constructFromObject(data['mergeOperations']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeMergeConflictsOutputConflictMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeMergeConflictsOutputConflictMetadata</code>.
     */
    static validateJSON(data) {
        ...
        if (data['fileSizes']) { // data not null
          ConflictMetadataFileSizes.validateJSON(data['fileSizes']);
        }
        // validate the optional field `fileModes`
        if (data['fileModes']) { // data not null
          ConflictMetadataFileModes.validateJSON(data['fileModes']);
        }
        // validate the optional field `objectTypes`
        if (data['objectTypes']) { // data not null
          ConflictMetadataObjectTypes.validateJSON(data['objectTypes']);
        }
        // validate the optional field `numberOfConflicts`
        if (data['numberOfConflicts']) { // data not null
          Number.validateJSON(data['numberOfConflicts']);
        }
        // validate the optional field `isBinaryFile`
        if (data['isBinaryFile']) { // data not null
          ConflictMetadataIsBinaryFile.validateJSON(data['isBinaryFile']);
        }
        // validate the optional field `contentConflict`
        if (data['contentConflict']) { // data not null
          Boolean.validateJSON(data['contentConflict']);
        }
        // validate the optional field `fileModeConflict`
        if (data['fileModeConflict']) { // data not null
          Boolean.validateJSON(data['fileModeConflict']);
        }
        // validate the optional field `objectTypeConflict`
        if (data['objectTypeConflict']) { // data not null
          Boolean.validateJSON(data['objectTypeConflict']);
        }
        // validate the optional field `mergeOperations`
        if (data['mergeOperations']) { // data not null
          ConflictMetadataMergeOperations.validateJSON(data['mergeOperations']);
        }
 ...
 */
DescribeMergeConflictsOutputConflictMetadata.prototype['filePath'] = undefined;

/**
 * @member {module:model/ConflictMetadataFileSizes} fileSizes
 */
DescribeMergeConflictsOutputConflictMetadata.prototype['fileSizes'] = undefined;

/**
 * @member {module:model/ConflictMetadataFileModes} fileModes
 */
DescribeMergeConflictsOutputConflictMetadata.prototype['fileModes'] = undefined;

/**
 * @member {module:model/ConflictMetadataObjectTypes} objectTypes
 */
DescribeMergeConflictsOutputConflictMetadata.prototype['objectTypes'] = undefined;

/**
 * @member {Number} numberOfConflicts
 */
DescribeMergeConflictsOutputConflictMetadata.prototype['numberOfConflicts'] = undefined;

/**
 * @member {module:model/ConflictMetadataIsBinaryFile} isBinaryFile
 */
DescribeMergeConflictsOutputConflictMetadata.prototype['isBinaryFile'] = undefined;

/**
 * @member {Boolean} contentConflict
 */
DescribeMergeConflictsOutputConflictMetadata.prototype['contentConflict'] = undefined;

/**
 * @member {Boolean} fileModeConflict
 */
DescribeMergeConflictsOutputConflictMetadata.prototype['fileModeConflict'] = undefined;

/**
 * @member {Boolean} objectTypeConflict
 */
DescribeMergeConflictsOutputConflictMetadata.prototype['objectTypeConflict'] = undefined;

/**
 * @member {module:model/ConflictMetadataMergeOperations} mergeOperations
 */
DescribeMergeConflictsOutputConflictMetadata.prototype['mergeOperations'] = undefined;


// Implement ConflictMetadata interface:
/**
 * @member {String} filePath
 */
ConflictMetadata.prototype['filePath'] = undefined;
/**
 * @member {module:model/ConflictMetadataFileSizes} fileSizes
 */
ConflictMetadata.prototype['fileSizes'] = undefined;
/**
 * @member {module:model/ConflictMetadataFileModes} fileModes
 */
ConflictMetadata.prototype['fileModes'] = undefined;
/**
 * @member {module:model/ConflictMetadataObjectTypes} objectTypes
 */
ConflictMetadata.prototype['objectTypes'] = undefined;
/**
 * @member {Number} numberOfConflicts
 */
ConflictMetadata.prototype['numberOfConflicts'] = undefined;
/**
 * @member {module:model/ConflictMetadataIsBinaryFile} isBinaryFile
 */
ConflictMetadata.prototype['isBinaryFile'] = undefined;
/**
 * @member {Boolean} contentConflict
 */
ConflictMetadata.prototype['contentConflict'] = undefined;
/**
 * @member {Boolean} fileModeConflict
 */
ConflictMetadata.prototype['fileModeConflict'] = undefined;
/**
 * @member {Boolean} objectTypeConflict
 */
ConflictMetadata.prototype['objectTypeConflict'] = undefined;
/**
 * @member {module:model/ConflictMetadataMergeOperations} mergeOperations
 */
ConflictMetadata.prototype['mergeOperations'] = undefined;




export default DescribeMergeConflictsOutputConflictMetadata;
