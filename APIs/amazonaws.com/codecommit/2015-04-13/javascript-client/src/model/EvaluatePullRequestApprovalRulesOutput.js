...
import EvaluatePullRequestApprovalRulesOutputEvaluation from './EvaluatePullRequestApprovalRulesOutputEvaluation';

/**
 * The EvaluatePullRequestApprovalRulesOutput model module.
 * @module model/EvaluatePullRequestApprovalRulesOutput
 * @version 2015-04-13
 */
class EvaluatePullRequestApprovalRulesOutput {
    /**
     * Constructs a new <code>EvaluatePullRequestApprovalRulesOutput</code>.
     * @alias module:model/EvaluatePullRequestApprovalRulesOutput
     * @param evaluation {module:model/EvaluatePullRequestApprovalRulesOutputEvaluation} 
     */
    constructor(evaluation) { 
        
        EvaluatePullRequestApprovalRulesOutput.initialize(this, evaluation);
    }
     ...
     */
    static initialize(obj, evaluation) { 
        obj['evaluation'] = evaluation;
    }

    /**
     * Constructs a <code>EvaluatePullRequestApprovalRulesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EvaluatePullRequestApprovalRulesOutput} obj Optional instance to populate.
     * @return {module:model/EvaluatePullRequestApprovalRulesOutput} The populated <code>EvaluatePullRequestApprovalRulesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EvaluatePullRequestApprovalRulesOutput();

            if (data.hasOwnProperty('evaluation')) {
                obj['evaluation'] = EvaluatePullRequestApprovalRulesOutputEvaluation.constructFromObject(data['evaluation']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EvaluatePullRequestApprovalRulesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EvaluatePullRequestApprovalRulesOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EvaluatePullRequestApprovalRulesOutput.RequiredProperties) {
        ...
        if (data['evaluation']) { // data not null
          EvaluatePullRequestApprovalRulesOutputEvaluation.validateJSON(data['evaluation']);
        }
...
EvaluatePullRequestApprovalRulesOutput.RequiredProperties = ["evaluation"];

/**
 * @member {module:model/EvaluatePullRequestApprovalRulesOutputEvaluation} evaluation
 */
EvaluatePullRequestApprovalRulesOutput.prototype['evaluation'] = undefined;
...
export default EvaluatePullRequestApprovalRulesOutput;
