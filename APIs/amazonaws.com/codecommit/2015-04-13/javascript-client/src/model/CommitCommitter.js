...
/**
 * The CommitCommitter model module.
 * @module model/CommitCommitter
 * @version 2015-04-13
 */
class CommitCommitter {
    /**
     * Constructs a new <code>CommitCommitter</code>.
     * @alias module:model/CommitCommitter
     * @implements module:model/UserInfo
     */
    constructor() { 
        UserInfo.initialize(this);
        CommitCommitter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CommitCommitter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CommitCommitter} obj Optional instance to populate.
     * @return {module:model/CommitCommitter} The populated <code>CommitCommitter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CommitCommitter();
    ...
    /**
     * Validates the JSON data with respect to <code>CommitCommitter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CommitCommitter</code>.
     */
 ...
 * @member {String} name
 */
CommitCommitter.prototype['name'] = undefined;

/**
 * @member {String} email
 */
CommitCommitter.prototype['email'] = undefined;

/**
 * @member {String} date
 */
CommitCommitter.prototype['date'] = undefined;
...
export default CommitCommitter;
