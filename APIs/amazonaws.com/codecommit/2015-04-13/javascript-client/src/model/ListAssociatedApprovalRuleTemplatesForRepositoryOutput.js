...
/**
 * The ListAssociatedApprovalRuleTemplatesForRepositoryOutput model module.
 * @module model/ListAssociatedApprovalRuleTemplatesForRepositoryOutput
 * @version 2015-04-13
 */
class ListAssociatedApprovalRuleTemplatesForRepositoryOutput {
    /**
     * Constructs a new <code>ListAssociatedApprovalRuleTemplatesForRepositoryOutput</code>.
     * @alias module:model/ListAssociatedApprovalRuleTemplatesForRepositoryOutput
     */
    constructor() { 
        
        ListAssociatedApprovalRuleTemplatesForRepositoryOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListAssociatedApprovalRuleTemplatesForRepositoryOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAssociatedApprovalRuleTemplatesForRepositoryOutput} obj Optional instance to populate.
     * @return {module:model/ListAssociatedApprovalRuleTemplatesForRepositoryOutput} The populated <code>ListAssociatedApprovalRuleTemplatesForRepositoryOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListAssociatedApprovalRuleTemplatesForRepositoryOutput();

            if (data.hasOwnProperty('approvalRuleTemplateNames')) {
                obj['approvalRuleTemplateNames'] = ApiClient.convertToType(data['approvalRuleTemplateNames'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListAssociatedApprovalRuleTemplatesForRepositoryOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListAssociatedApprovalRuleTemplatesForRepositoryOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `approvalRuleTemplateNames`
        if (data['approvalRuleTemplateNames']) { // data not null
          Array.validateJSON(data['approvalRuleTemplateNames']);
        }
...
/**
 * @member {Array} approvalRuleTemplateNames
 */
ListAssociatedApprovalRuleTemplatesForRepositoryOutput.prototype['approvalRuleTemplateNames'] = undefined;

/**
 * @member {String} nextToken
 */
ListAssociatedApprovalRuleTemplatesForRepositoryOutput.prototype['nextToken'] = undefined;
...
export default ListAssociatedApprovalRuleTemplatesForRepositoryOutput;
