...
/**
 * The ConflictMetadataObjectTypes model module.
 * @module model/ConflictMetadataObjectTypes
 * @version 2015-04-13
 */
class ConflictMetadataObjectTypes {
    /**
     * Constructs a new <code>ConflictMetadataObjectTypes</code>.
     * @alias module:model/ConflictMetadataObjectTypes
     * @implements module:model/ObjectTypes
     */
    constructor() { 
        ObjectTypes.initialize(this);
        ConflictMetadataObjectTypes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ConflictMetadataObjectTypes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConflictMetadataObjectTypes} obj Optional instance to populate.
     * @return {module:model/ConflictMetadataObjectTypes} The populated <code>ConflictMetadataObjectTypes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConflictMetadataObjectTypes();
            ObjectTypes.constructFromObject(data, obj);

            if (data.hasOwnProperty('source')) {
                obj['source'] = ApiClient.convertToType(data['source'], ObjectTypeEnum);
            }
            if (data.hasOwnProperty('destination')) {
                obj['destination'] = ApiClient.convertToType(data['destination'], ObjectTypeEnum);
            }
            if (data.hasOwnProperty('base')) {
                obj['base'] = ApiClient.convertToType(data['base'], ObjectTypeEnum);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ConflictMetadataObjectTypes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConflictMetadataObjectTypes</code>.
     */
    static validateJSON(data) {
        // validate the optional field `source`
        if (data['source']) { // data not null
          ObjectTypeEnum.validateJSON(data['source']);
        }
        // validate the optional field `destination`
        if (data['destination']) { // data not null
          ObjectTypeEnum.validateJSON(data['destination']);
        }
        // validate the optional field `base`
        if (data['base']) { // data not null
          ObjectTypeEnum.validateJSON(data['base']);
        }
...
/**
 * @member {module:model/ObjectTypeEnum} source
 */
ConflictMetadataObjectTypes.prototype['source'] = undefined;

/**
 * @member {module:model/ObjectTypeEnum} destination
 */
ConflictMetadataObjectTypes.prototype['destination'] = undefined;

/**
 * @member {module:model/ObjectTypeEnum} base
 */
ConflictMetadataObjectTypes.prototype['base'] = undefined;


// Implement ObjectTypes interface:
/**
 * @member {module:model/ObjectTypeEnum} source
 */
ObjectTypes.prototype['source'] = undefined;
/**
 * @member {module:model/ObjectTypeEnum} destination
 */
ObjectTypes.prototype['destination'] = undefined;
/**
 * @member {module:model/ObjectTypeEnum} base
 */
ObjectTypes.prototype['base'] = undefined;




export default ConflictMetadataObjectTypes;
