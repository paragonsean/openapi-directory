...
/**
 * The MergeHunkBase model module.
 * @module model/MergeHunkBase
 * @version 2015-04-13
 */
class MergeHunkBase {
    /**
     * Constructs a new <code>MergeHunkBase</code>.
     * @alias module:model/MergeHunkBase
     * @implements module:model/MergeHunkDetail
     */
    constructor() { 
        MergeHunkDetail.initialize(this);
        MergeHunkBase.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MergeHunkBase</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MergeHunkBase} obj Optional instance to populate.
     * @return {module:model/MergeHunkBase} The populated <code>MergeHunkBase</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MergeHunkBase();
    ...
    /**
     * Validates the JSON data with respect to <code>MergeHunkBase</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MergeHunkBase</code>.
     */
 ...
 */
MergeHunkBase.prototype['startLine'] = undefined;

/**
 * @member {Number} endLine
 */
MergeHunkBase.prototype['endLine'] = undefined;

/**
 * @member {String} hunkContent
 */
MergeHunkBase.prototype['hunkContent'] = undefined;
