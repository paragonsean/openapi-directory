...
import UpdatePullRequestApprovalRuleContentOutputApprovalRule from './UpdatePullRequestApprovalRuleContentOutputApprovalRule';

/**
 * The UpdatePullRequestApprovalRuleContentOutput model module.
 * @module model/UpdatePullRequestApprovalRuleContentOutput
 * @version 2015-04-13
 */
class UpdatePullRequestApprovalRuleContentOutput {
    /**
     * Constructs a new <code>UpdatePullRequestApprovalRuleContentOutput</code>.
     * @alias module:model/UpdatePullRequestApprovalRuleContentOutput
     * @param approvalRule {module:model/UpdatePullRequestApprovalRuleContentOutputApprovalRule} 
     */
    constructor(approvalRule) { 
        
        UpdatePullRequestApprovalRuleContentOutput.initialize(this, approvalRule);
    }
    ...
    /**
     * Constructs a <code>UpdatePullRequestApprovalRuleContentOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePullRequestApprovalRuleContentOutput} obj Optional instance to populate.
     * @return {module:model/UpdatePullRequestApprovalRuleContentOutput} The populated <code>UpdatePullRequestApprovalRuleContentOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePullRequestApprovalRuleContentOutput();

            if (data.hasOwnProperty('approvalRule')) {
                obj['approvalRule'] = UpdatePullRequestApprovalRuleContentOutputApprovalRule.constructFromObject(data['approvalRule']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePullRequestApprovalRuleContentOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePullRequestApprovalRuleContentOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdatePullRequestApprovalRuleContentOutput.RequiredProperties) {
        ...
        if (data['approvalRule']) { // data not null
          UpdatePullRequestApprovalRuleContentOutputApprovalRule.validateJSON(data['approvalRule']);
        }
...
UpdatePullRequestApprovalRuleContentOutput.RequiredProperties = ["approvalRule"];

/**
 * @member {module:model/UpdatePullRequestApprovalRuleContentOutputApprovalRule} approvalRule
 */
UpdatePullRequestApprovalRuleContentOutput.prototype['approvalRule'] = undefined;
...
export default UpdatePullRequestApprovalRuleContentOutput;
