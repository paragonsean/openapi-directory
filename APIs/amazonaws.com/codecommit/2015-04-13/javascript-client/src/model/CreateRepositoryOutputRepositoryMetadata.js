...
/**
 * The CreateRepositoryOutputRepositoryMetadata model module.
 * @module model/CreateRepositoryOutputRepositoryMetadata
 * @version 2015-04-13
 */
class CreateRepositoryOutputRepositoryMetadata {
    /**
     * Constructs a new <code>CreateRepositoryOutputRepositoryMetadata</code>.
     * @alias module:model/CreateRepositoryOutputRepositoryMetadata
     * @implements module:model/RepositoryMetadata
     */
    constructor() { 
        RepositoryMetadata.initialize(this);
        CreateRepositoryOutputRepositoryMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateRepositoryOutputRepositoryMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateRepositoryOutputRepositoryMetadata} obj Optional instance to populate.
     * @return {module:model/CreateRepositoryOutputRepositoryMetadata} The populated <code>CreateRepositoryOutputRepositoryMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateRepositoryOutputRepositoryMetadata();
            RepositoryMetadata.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('repositoryDescription')) {
                obj['repositoryDescription'] = ApiClient.convertToType(data['repositoryDescription'], 'String');
            }
            ...
            if (data.hasOwnProperty('cloneUrlHttp')) {
                obj['cloneUrlHttp'] = ApiClient.convertToType(data['cloneUrlHttp'], 'String');
            }
            if (data.hasOwnProperty('cloneUrlSsh')) {
                obj['cloneUrlSsh'] = ApiClient.convertToType(data['cloneUrlSsh'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateRepositoryOutputRepositoryMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateRepositoryOutputRepositoryMetadata</code>.
     */
    static validateJSON(data) {
        ...
        if (data['repositoryId']) { // data not null
          String.validateJSON(data['repositoryId']);
        }
        ...
        if (data['repositoryDescription']) { // data not null
          String.validateJSON(data['repositoryDescription']);
        }
        // validate the optional field `defaultBranch`
        if (data['defaultBranch']) { // data not null
          String.validateJSON(data['defaultBranch']);
        }
        ...
        if (data['cloneUrlHttp']) { // data not null
          String.validateJSON(data['cloneUrlHttp']);
        }
        // validate the optional field `cloneUrlSsh`
        if (data['cloneUrlSsh']) { // data not null
          String.validateJSON(data['cloneUrlSsh']);
        }
 ...
 */
CreateRepositoryOutputRepositoryMetadata.prototype['accountId'] = undefined;

/**
 * @member {String} repositoryId
 */
CreateRepositoryOutputRepositoryMetadata.prototype['repositoryId'] = undefined;

/**
 * @member {String} repositoryName
 */
CreateRepositoryOutputRepositoryMetadata.prototype['repositoryName'] = undefined;

/**
 * @member {String} repositoryDescription
 */
CreateRepositoryOutputRepositoryMetadata.prototype['repositoryDescription'] = undefined;

/**
 * @member {String} defaultBranch
 */
CreateRepositoryOutputRepositoryMetadata.prototype['defaultBranch'] = undefined;

/**
 * @member {Date} lastModifiedDate
 */
CreateRepositoryOutputRepositoryMetadata.prototype['lastModifiedDate'] = undefined;

/**
 * @member {Date} creationDate
 */
CreateRepositoryOutputRepositoryMetadata.prototype['creationDate'] = undefined;

/**
 * @member {String} cloneUrlHttp
 */
CreateRepositoryOutputRepositoryMetadata.prototype['cloneUrlHttp'] = undefined;

/**
 * @member {String} cloneUrlSsh
 */
CreateRepositoryOutputRepositoryMetadata.prototype['cloneUrlSsh'] = undefined;

/**
 * @member {String} Arn
 */
CreateRepositoryOutputRepositoryMetadata.prototype['Arn'] = undefined;


// Implement RepositoryMetadata interface:
/**
 * @member {String} accountId
 */
RepositoryMetadata.prototype['accountId'] = undefined;
/**
 * @member {String} repositoryId
 */
RepositoryMetadata.prototype['repositoryId'] = undefined;
/**
 * @member {String} repositoryName
 */
RepositoryMetadata.prototype['repositoryName'] = undefined;
/**
 * @member {String} repositoryDescription
 */
RepositoryMetadata.prototype['repositoryDescription'] = undefined;
/**
 * @member {String} defaultBranch
 */
RepositoryMetadata.prototype['defaultBranch'] = undefined;
/**
 * @member {Date} lastModifiedDate
 */
RepositoryMetadata.prototype['lastModifiedDate'] = undefined;
/**
 * @member {Date} creationDate
 */
RepositoryMetadata.prototype['creationDate'] = undefined;
/**
 * @member {String} cloneUrlHttp
 */
RepositoryMetadata.prototype['cloneUrlHttp'] = undefined;
/**
 * @member {String} cloneUrlSsh
 */
RepositoryMetadata.prototype['cloneUrlSsh'] = undefined;
/**
 * @member {String} Arn
 */
RepositoryMetadata.prototype['Arn'] = undefined;




export default CreateRepositoryOutputRepositoryMetadata;
