...
import UpdateCommentOutputComment from './UpdateCommentOutputComment';

/**
 * The UpdateCommentOutput model module.
 * @module model/UpdateCommentOutput
 * @version 2015-04-13
 */
class UpdateCommentOutput {
    /**
     * Constructs a new <code>UpdateCommentOutput</code>.
     * @alias module:model/UpdateCommentOutput
     */
    constructor() { 
        
        UpdateCommentOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateCommentOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateCommentOutput} obj Optional instance to populate.
     * @return {module:model/UpdateCommentOutput} The populated <code>UpdateCommentOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateCommentOutput();

            if (data.hasOwnProperty('comment')) {
                obj['comment'] = UpdateCommentOutputComment.constructFromObject(data['comment']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateCommentOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateCommentOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `comment`
        if (data['comment']) { // data not null
          UpdateCommentOutputComment.validateJSON(data['comment']);
        }
...
/**
 * @member {module:model/UpdateCommentOutputComment} comment
 */
UpdateCommentOutput.prototype['comment'] = undefined;
...
export default UpdateCommentOutput;
