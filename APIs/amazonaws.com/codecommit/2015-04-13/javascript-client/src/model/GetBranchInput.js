...
/**
 * The GetBranchInput model module.
 * @module model/GetBranchInput
 * @version 2015-04-13
 */
class GetBranchInput {
    /**
     * Constructs a new <code>GetBranchInput</code>.
     * Represents the input of a get branch operation.
     * @alias module:model/GetBranchInput
     */
    constructor() { 
        
        GetBranchInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetBranchInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetBranchInput} obj Optional instance to populate.
     * @return {module:model/GetBranchInput} The populated <code>GetBranchInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetBranchInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetBranchInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBranchInput</code>.
     */
 ...
 */
GetBranchInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} branchName
 */
GetBranchInput.prototype['branchName'] = undefined;
