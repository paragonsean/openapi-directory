...
/**
 * The ApprovalRuleOriginApprovalRuleTemplate model module.
 * @module model/ApprovalRuleOriginApprovalRuleTemplate
 * @version 2015-04-13
 */
class ApprovalRuleOriginApprovalRuleTemplate {
    /**
     * Constructs a new <code>ApprovalRuleOriginApprovalRuleTemplate</code>.
     * @alias module:model/ApprovalRuleOriginApprovalRuleTemplate
     * @implements module:model/OriginApprovalRuleTemplate
     */
    constructor() { 
        OriginApprovalRuleTemplate.initialize(this);
        ApprovalRuleOriginApprovalRuleTemplate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApprovalRuleOriginApprovalRuleTemplate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApprovalRuleOriginApprovalRuleTemplate} obj Optional instance to populate.
     * @return {module:model/ApprovalRuleOriginApprovalRuleTemplate} The populated <code>ApprovalRuleOriginApprovalRuleTemplate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApprovalRuleOriginApprovalRuleTemplate();
            OriginApprovalRuleTemplate.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ApprovalRuleOriginApprovalRuleTemplate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApprovalRuleOriginApprovalRuleTemplate</code>.
     */
 ...
 */
ApprovalRuleOriginApprovalRuleTemplate.prototype['approvalRuleTemplateId'] = undefined;

/**
 * @member {String} approvalRuleTemplateName
 */
ApprovalRuleOriginApprovalRuleTemplate.prototype['approvalRuleTemplateName'] = undefined;


// Implement OriginApprovalRuleTemplate interface:
/**
 * @member {String} approvalRuleTemplateId
 */
...
export default ApprovalRuleOriginApprovalRuleTemplate;
