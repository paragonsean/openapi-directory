...
/**
 * The UpdateApprovalRuleTemplateNameInput model module.
 * @module model/UpdateApprovalRuleTemplateNameInput
 * @version 2015-04-13
 */
class UpdateApprovalRuleTemplateNameInput {
    /**
     * Constructs a new <code>UpdateApprovalRuleTemplateNameInput</code>.
     * @alias module:model/UpdateApprovalRuleTemplateNameInput
     * @param oldApprovalRuleTemplateName {String} 
     * @param newApprovalRuleTemplateName {String} 
     */
    constructor(oldApprovalRuleTemplateName, newApprovalRuleTemplateName) { 
        
        UpdateApprovalRuleTemplateNameInput.initialize(this, oldApprovalRuleTemplateName, newApprovalRuleTemplateName);
    }
     ...
     */
    static initialize(obj, oldApprovalRuleTemplateName, newApprovalRuleTemplateName) { 
        obj['oldApprovalRuleTemplateName'] = oldApprovalRuleTemplateName;
        obj['newApprovalRuleTemplateName'] = newApprovalRuleTemplateName;
    }

    /**
     * Constructs a <code>UpdateApprovalRuleTemplateNameInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateApprovalRuleTemplateNameInput} obj Optional instance to populate.
     * @return {module:model/UpdateApprovalRuleTemplateNameInput} The populated <code>UpdateApprovalRuleTemplateNameInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateApprovalRuleTemplateNameInput();

            if (data.hasOwnProperty('oldApprovalRuleTemplateName')) {
                obj['oldApprovalRuleTemplateName'] = ApiClient.convertToType(data['oldApprovalRuleTemplateName'], 'String');
            }
            if (data.hasOwnProperty('newApprovalRuleTemplateName')) {
                obj['newApprovalRuleTemplateName'] = ApiClient.convertToType(data['newApprovalRuleTemplateName'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateApprovalRuleTemplateNameInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateApprovalRuleTemplateNameInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateApprovalRuleTemplateNameInput.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `oldApprovalRuleTemplateName`
        if (data['oldApprovalRuleTemplateName']) { // data not null
          String.validateJSON(data['oldApprovalRuleTemplateName']);
        }
        // validate the optional field `newApprovalRuleTemplateName`
        if (data['newApprovalRuleTemplateName']) { // data not null
          String.validateJSON(data['newApprovalRuleTemplateName']);
        }
...
UpdateApprovalRuleTemplateNameInput.RequiredProperties = ["oldApprovalRuleTemplateName", "newApprovalRuleTemplateName"];

/**
 * @member {String} oldApprovalRuleTemplateName
 */
UpdateApprovalRuleTemplateNameInput.prototype['oldApprovalRuleTemplateName'] = undefined;

/**
 * @member {String} newApprovalRuleTemplateName
 */
UpdateApprovalRuleTemplateNameInput.prototype['newApprovalRuleTemplateName'] = undefined;
...
export default UpdateApprovalRuleTemplateNameInput;
