...
/**
 * The ReactionValueFormats model module.
 * @module model/ReactionValueFormats
 * @version 2015-04-13
 */
class ReactionValueFormats {
    /**
     * Constructs a new <code>ReactionValueFormats</code>.
     * Information about the values for reactions to a comment. AWS CodeCommit supports a limited set of reactions.
     * @alias module:model/ReactionValueFormats
     */
    constructor() { 
        
        ReactionValueFormats.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ReactionValueFormats</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReactionValueFormats} obj Optional instance to populate.
     * @return {module:model/ReactionValueFormats} The populated <code>ReactionValueFormats</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReactionValueFormats();
    ...
    /**
     * Validates the JSON data with respect to <code>ReactionValueFormats</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReactionValueFormats</code>.
     */
    static validateJSON(data) {
        // validate the optional field `emoji`
        if (data['emoji']) { // data not null
          String.validateJSON(data['emoji']);
        }
        ...
        if (data['unicode']) { // data not null
          String.validateJSON(data['unicode']);
        }
 ...
 * @member {String} emoji
 */
ReactionValueFormats.prototype['emoji'] = undefined;

/**
 * @member {String} shortCode
 */
ReactionValueFormats.prototype['shortCode'] = undefined;

/**
 * @member {String} unicode
 */
ReactionValueFormats.prototype['unicode'] = undefined;
...
export default ReactionValueFormats;
