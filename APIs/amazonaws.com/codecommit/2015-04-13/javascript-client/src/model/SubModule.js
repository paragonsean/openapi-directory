...
/**
 * The SubModule model module.
 * @module model/SubModule
 * @version 2015-04-13
 */
class SubModule {
    /**
     * Constructs a new <code>SubModule</code>.
     * Returns information about a submodule reference in a repository folder.
     * @alias module:model/SubModule
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>SubModule</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SubModule} obj Optional instance to populate.
     * @return {module:model/SubModule} The populated <code>SubModule</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SubModule();
    ...
    /**
     * Validates the JSON data with respect to <code>SubModule</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SubModule</code>.
     */
 ...
 */
SubModule.prototype['commitId'] = undefined;

/**
 * @member {String} absolutePath
 */
SubModule.prototype['absolutePath'] = undefined;

/**
 * @member {String} relativePath
 */
SubModule.prototype['relativePath'] = undefined;
