...
/**
 * The CreateCommitInput model module.
 * @module model/CreateCommitInput
 * @version 2015-04-13
 */
class CreateCommitInput {
    /**
     * Constructs a new <code>CreateCommitInput</code>.
     * @alias module:model/CreateCommitInput
     * @param repositoryName {String} 
     * @param branchName {String} 
     */
    constructor(repositoryName, branchName) { 
        
        CreateCommitInput.initialize(this, repositoryName, branchName);
    }
    ...
    /**
     * Constructs a <code>CreateCommitInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateCommitInput} obj Optional instance to populate.
     * @return {module:model/CreateCommitInput} The populated <code>CreateCommitInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateCommitInput();
            ...
            if (data.hasOwnProperty('putFiles')) {
                obj['putFiles'] = ApiClient.convertToType(data['putFiles'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCommitInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCommitInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateCommitInput.RequiredProperties) {
        ...
        if (data['putFiles']) { // data not null
          Array.validateJSON(data['putFiles']);
        }
...
CreateCommitInput.RequiredProperties = ["repositoryName", "branchName"];

/**
 * @member {String} repositoryName
 */
CreateCommitInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} branchName
 */
CreateCommitInput.prototype['branchName'] = undefined;

/**
 * @member {String} parentCommitId
 */
CreateCommitInput.prototype['parentCommitId'] = undefined;

/**
 * @member {String} authorName
 */
CreateCommitInput.prototype['authorName'] = undefined;

/**
 * @member {String} email
 */
CreateCommitInput.prototype['email'] = undefined;

/**
 * @member {String} commitMessage
 */
CreateCommitInput.prototype['commitMessage'] = undefined;

/**
 * @member {Boolean} keepEmptyFolders
 */
CreateCommitInput.prototype['keepEmptyFolders'] = undefined;

/**
 * @member {Array} putFiles
 */
CreateCommitInput.prototype['putFiles'] = undefined;

/**
 * @member {Array} deleteFiles
 */
CreateCommitInput.prototype['deleteFiles'] = undefined;

/**
 * @member {Array} setFileModes
 */
CreateCommitInput.prototype['setFileModes'] = undefined;
...
export default CreateCommitInput;
