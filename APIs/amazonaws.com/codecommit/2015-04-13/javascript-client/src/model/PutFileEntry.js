...
import PutFileEntrySourceFile from './PutFileEntrySourceFile';

/**
 * The PutFileEntry model module.
 * @module model/PutFileEntry
 * @version 2015-04-13
 */
class PutFileEntry {
    /**
     * Constructs a new <code>PutFileEntry</code>.
     * Information about a file added or updated as part of a commit.
     * @alias module:model/PutFileEntry
     * @param filePath {String} 
     */
    constructor(filePath) { 
        
        PutFileEntry.initialize(this, filePath);
    }
    ...
    /**
     * Constructs a <code>PutFileEntry</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutFileEntry} obj Optional instance to populate.
     * @return {module:model/PutFileEntry} The populated <code>PutFileEntry</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutFileEntry();
            ...
            if (data.hasOwnProperty('sourceFile')) {
                obj['sourceFile'] = PutFileEntrySourceFile.constructFromObject(data['sourceFile']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PutFileEntry</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutFileEntry</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutFileEntry.RequiredProperties) {
        ...
        if (data['sourceFile']) { // data not null
          PutFileEntrySourceFile.validateJSON(data['sourceFile']);
        }
...
PutFileEntry.RequiredProperties = ["filePath"];

/**
 * @member {String} filePath
 */
PutFileEntry.prototype['filePath'] = undefined;

/**
 * @member {module:model/FileModeTypeEnum} fileMode
 */
PutFileEntry.prototype['fileMode'] = undefined;

/**
 * @member {String} fileContent
 */
PutFileEntry.prototype['fileContent'] = undefined;

/**
 * @member {module:model/PutFileEntrySourceFile} sourceFile
 */
PutFileEntry.prototype['sourceFile'] = undefined;
