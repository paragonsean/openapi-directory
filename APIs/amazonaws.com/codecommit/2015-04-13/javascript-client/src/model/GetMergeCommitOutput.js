...
/**
 * The GetMergeCommitOutput model module.
 * @module model/GetMergeCommitOutput
 * @version 2015-04-13
 */
class GetMergeCommitOutput {
    /**
     * Constructs a new <code>GetMergeCommitOutput</code>.
     * @alias module:model/GetMergeCommitOutput
     */
    constructor() { 
        
        GetMergeCommitOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetMergeCommitOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetMergeCommitOutput} obj Optional instance to populate.
     * @return {module:model/GetMergeCommitOutput} The populated <code>GetMergeCommitOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetMergeCommitOutput();
            ...
            if (data.hasOwnProperty('mergedCommitId')) {
                obj['mergedCommitId'] = ApiClient.convertToType(data['mergedCommitId'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetMergeCommitOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetMergeCommitOutput</code>.
     */
    static validateJSON(data) {
        ...
        if (data['mergedCommitId']) { // data not null
          String.validateJSON(data['mergedCommitId']);
        }
 ...
 */
GetMergeCommitOutput.prototype['sourceCommitId'] = undefined;

/**
 * @member {String} destinationCommitId
 */
GetMergeCommitOutput.prototype['destinationCommitId'] = undefined;

/**
 * @member {String} baseCommitId
 */
GetMergeCommitOutput.prototype['baseCommitId'] = undefined;

/**
 * @member {String} mergedCommitId
 */
GetMergeCommitOutput.prototype['mergedCommitId'] = undefined;
...
export default GetMergeCommitOutput;
