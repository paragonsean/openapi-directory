...
import CreateUnreferencedMergeCommitInputConflictResolution from './CreateUnreferencedMergeCommitInputConflictResolution';

/**
 * The MergePullRequestBySquashInput model module.
 * @module model/MergePullRequestBySquashInput
 * @version 2015-04-13
 */
class MergePullRequestBySquashInput {
    /**
     * Constructs a new <code>MergePullRequestBySquashInput</code>.
     * @alias module:model/MergePullRequestBySquashInput
     * @param pullRequestId {String} 
     * @param repositoryName {String} 
     */
    constructor(pullRequestId, repositoryName) { 
        
        MergePullRequestBySquashInput.initialize(this, pullRequestId, repositoryName);
    }
     ...
     */
    static initialize(obj, pullRequestId, repositoryName) { 
        obj['pullRequestId'] = pullRequestId;
        obj['repositoryName'] = repositoryName;
    }

    /**
     * Constructs a <code>MergePullRequestBySquashInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MergePullRequestBySquashInput} obj Optional instance to populate.
     * @return {module:model/MergePullRequestBySquashInput} The populated <code>MergePullRequestBySquashInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MergePullRequestBySquashInput();
            ...
            if (data.hasOwnProperty('sourceCommitId')) {
                obj['sourceCommitId'] = ApiClient.convertToType(data['sourceCommitId'], 'String');
            }
            ...
            if (data.hasOwnProperty('keepEmptyFolders')) {
                obj['keepEmptyFolders'] = ApiClient.convertToType(data['keepEmptyFolders'], 'Boolean');
            }
            if (data.hasOwnProperty('conflictResolution')) {
                obj['conflictResolution'] = CreateUnreferencedMergeCommitInputConflictResolution.constructFromObject(data['conflictResolution']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MergePullRequestBySquashInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MergePullRequestBySquashInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MergePullRequestBySquashInput.RequiredProperties) {
        ...
        // validate the optional field `sourceCommitId`
        if (data['sourceCommitId']) { // data not null
          String.validateJSON(data['sourceCommitId']);
        }
        ...
        if (data['authorName']) { // data not null
          String.validateJSON(data['authorName']);
        }
        // validate the optional field `email`
        if (data['email']) { // data not null
          String.validateJSON(data['email']);
        }
        // validate the optional field `keepEmptyFolders`
        if (data['keepEmptyFolders']) { // data not null
          Boolean.validateJSON(data['keepEmptyFolders']);
        }
        // validate the optional field `conflictResolution`
        if (data['conflictResolution']) { // data not null
          CreateUnreferencedMergeCommitInputConflictResolution.validateJSON(data['conflictResolution']);
        }
...
MergePullRequestBySquashInput.RequiredProperties = ["pullRequestId", "repositoryName"];

/**
 * @member {String} pullRequestId
 */
MergePullRequestBySquashInput.prototype['pullRequestId'] = undefined;

/**
 * @member {String} repositoryName
 */
MergePullRequestBySquashInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} sourceCommitId
 */
MergePullRequestBySquashInput.prototype['sourceCommitId'] = undefined;

/**
 * @member {module:model/ConflictDetailLevelTypeEnum} conflictDetailLevel
 */
MergePullRequestBySquashInput.prototype['conflictDetailLevel'] = undefined;

/**
 * @member {module:model/ConflictResolutionStrategyTypeEnum} conflictResolutionStrategy
 */
MergePullRequestBySquashInput.prototype['conflictResolutionStrategy'] = undefined;

/**
 * @member {String} commitMessage
 */
MergePullRequestBySquashInput.prototype['commitMessage'] = undefined;

/**
 * @member {String} authorName
 */
MergePullRequestBySquashInput.prototype['authorName'] = undefined;

/**
 * @member {String} email
 */
MergePullRequestBySquashInput.prototype['email'] = undefined;

/**
 * @member {Boolean} keepEmptyFolders
 */
MergePullRequestBySquashInput.prototype['keepEmptyFolders'] = undefined;

/**
 * @member {module:model/CreateUnreferencedMergeCommitInputConflictResolution} conflictResolution
 */
MergePullRequestBySquashInput.prototype['conflictResolution'] = undefined;
...
export default MergePullRequestBySquashInput;
