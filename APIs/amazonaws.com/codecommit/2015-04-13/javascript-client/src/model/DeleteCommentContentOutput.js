...
import DeleteCommentContentOutputComment from './DeleteCommentContentOutputComment';

/**
 * The DeleteCommentContentOutput model module.
 * @module model/DeleteCommentContentOutput
 * @version 2015-04-13
 */
class DeleteCommentContentOutput {
    /**
     * Constructs a new <code>DeleteCommentContentOutput</code>.
     * @alias module:model/DeleteCommentContentOutput
     */
    constructor() { 
        
        DeleteCommentContentOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteCommentContentOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteCommentContentOutput} obj Optional instance to populate.
     * @return {module:model/DeleteCommentContentOutput} The populated <code>DeleteCommentContentOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteCommentContentOutput();

            if (data.hasOwnProperty('comment')) {
                obj['comment'] = DeleteCommentContentOutputComment.constructFromObject(data['comment']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteCommentContentOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteCommentContentOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `comment`
        if (data['comment']) { // data not null
          DeleteCommentContentOutputComment.validateJSON(data['comment']);
        }
...
/**
 * @member {module:model/DeleteCommentContentOutputComment} comment
 */
DeleteCommentContentOutput.prototype['comment'] = undefined;
...
export default DeleteCommentContentOutput;
