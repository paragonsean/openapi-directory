...
import GetPullRequestOutputPullRequest from './GetPullRequestOutputPullRequest';

/**
 * The GetPullRequestOutput model module.
 * @module model/GetPullRequestOutput
 * @version 2015-04-13
 */
class GetPullRequestOutput {
    /**
     * Constructs a new <code>GetPullRequestOutput</code>.
     * @alias module:model/GetPullRequestOutput
     * @param pullRequest {module:model/GetPullRequestOutputPullRequest} 
     */
    constructor(pullRequest) { 
        
        GetPullRequestOutput.initialize(this, pullRequest);
    }
    ...
    /**
     * Constructs a <code>GetPullRequestOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPullRequestOutput} obj Optional instance to populate.
     * @return {module:model/GetPullRequestOutput} The populated <code>GetPullRequestOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPullRequestOutput();

            if (data.hasOwnProperty('pullRequest')) {
                obj['pullRequest'] = GetPullRequestOutputPullRequest.constructFromObject(data['pullRequest']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetPullRequestOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPullRequestOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetPullRequestOutput.RequiredProperties) {
        ...
        if (data['pullRequest']) { // data not null
          GetPullRequestOutputPullRequest.validateJSON(data['pullRequest']);
        }
...
GetPullRequestOutput.RequiredProperties = ["pullRequest"];

/**
 * @member {module:model/GetPullRequestOutputPullRequest} pullRequest
 */
GetPullRequestOutput.prototype['pullRequest'] = undefined;
...
export default GetPullRequestOutput;
