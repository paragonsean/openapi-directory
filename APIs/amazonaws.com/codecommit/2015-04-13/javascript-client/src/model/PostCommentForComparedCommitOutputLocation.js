...
/**
 * The PostCommentForComparedCommitOutputLocation model module.
 * @module model/PostCommentForComparedCommitOutputLocation
 * @version 2015-04-13
 */
class PostCommentForComparedCommitOutputLocation {
    /**
     * Constructs a new <code>PostCommentForComparedCommitOutputLocation</code>.
     * @alias module:model/PostCommentForComparedCommitOutputLocation
     * @implements module:model/Location
     */
    constructor() { 
        Location.initialize(this);
        PostCommentForComparedCommitOutputLocation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostCommentForComparedCommitOutputLocation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostCommentForComparedCommitOutputLocation} obj Optional instance to populate.
     * @return {module:model/PostCommentForComparedCommitOutputLocation} The populated <code>PostCommentForComparedCommitOutputLocation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostCommentForComparedCommitOutputLocation();
    ...
    /**
     * Validates the JSON data with respect to <code>PostCommentForComparedCommitOutputLocation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostCommentForComparedCommitOutputLocation</code>.
     */
 ...
 */
PostCommentForComparedCommitOutputLocation.prototype['filePath'] = undefined;

/**
 * @member {Number} filePosition
 */
PostCommentForComparedCommitOutputLocation.prototype['filePosition'] = undefined;

/**
 * @member {module:model/RelativeFileVersionEnum} relativeFileVersion
 */
PostCommentForComparedCommitOutputLocation.prototype['relativeFileVersion'] = undefined;
...
export default PostCommentForComparedCommitOutputLocation;
