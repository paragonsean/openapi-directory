...
/**
 * The IsBinaryFile model module.
 * @module model/IsBinaryFile
 * @version 2015-04-13
 */
class IsBinaryFile {
    /**
     * Constructs a new <code>IsBinaryFile</code>.
     * Information about whether a file is binary or textual in a merge or pull request operation.
     * @alias module:model/IsBinaryFile
     */
    constructor() { 
        
        IsBinaryFile.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IsBinaryFile</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IsBinaryFile} obj Optional instance to populate.
     * @return {module:model/IsBinaryFile} The populated <code>IsBinaryFile</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IsBinaryFile();
    ...
    /**
     * Validates the JSON data with respect to <code>IsBinaryFile</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IsBinaryFile</code>.
     */
    static validateJSON(data) {
        // validate the optional field `source`
        if (data['source']) { // data not null
          Boolean.validateJSON(data['source']);
        }
        // validate the optional field `destination`
        if (data['destination']) { // data not null
          Boolean.validateJSON(data['destination']);
        }
        // validate the optional field `base`
        if (data['base']) { // data not null
          Boolean.validateJSON(data['base']);
        }
 ...
 */
IsBinaryFile.prototype['source'] = undefined;

/**
 * @member {Boolean} destination
 */
IsBinaryFile.prototype['destination'] = undefined;

/**
 * @member {Boolean} base
 */
IsBinaryFile.prototype['base'] = undefined;
