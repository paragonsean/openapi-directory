...
/**
 * The MergeBranchesByFastForwardInput model module.
 * @module model/MergeBranchesByFastForwardInput
 * @version 2015-04-13
 */
class MergeBranchesByFastForwardInput {
    /**
     * Constructs a new <code>MergeBranchesByFastForwardInput</code>.
     * @alias module:model/MergeBranchesByFastForwardInput
     * @param repositoryName {String} 
     * @param sourceCommitSpecifier {String} 
     * @param destinationCommitSpecifier {String} 
     */
    constructor(repositoryName, sourceCommitSpecifier, destinationCommitSpecifier) { 
        
        MergeBranchesByFastForwardInput.initialize(this, repositoryName, sourceCommitSpecifier, destinationCommitSpecifier);
    }
     ...
     */
    static initialize(obj, repositoryName, sourceCommitSpecifier, destinationCommitSpecifier) { 
    ...
    /**
     * Constructs a <code>MergeBranchesByFastForwardInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MergeBranchesByFastForwardInput} obj Optional instance to populate.
     * @return {module:model/MergeBranchesByFastForwardInput} The populated <code>MergeBranchesByFastForwardInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MergeBranchesByFastForwardInput();
    ...
    /**
     * Validates the JSON data with respect to <code>MergeBranchesByFastForwardInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MergeBranchesByFastForwardInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MergeBranchesByFastForwardInput.RequiredProperties) {
        ...
        // validate the optional field `targetBranch`
        if (data['targetBranch']) { // data not null
          String.validateJSON(data['targetBranch']);
        }
...
MergeBranchesByFastForwardInput.RequiredProperties = ["repositoryName", "sourceCommitSpecifier", "destinationCommitSpecifier"];

/**
 * @member {String} repositoryName
 */
MergeBranchesByFastForwardInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} sourceCommitSpecifier
 */
MergeBranchesByFastForwardInput.prototype['sourceCommitSpecifier'] = undefined;

/**
 * @member {String} destinationCommitSpecifier
 */
MergeBranchesByFastForwardInput.prototype['destinationCommitSpecifier'] = undefined;

/**
 * @member {String} targetBranch
 */
MergeBranchesByFastForwardInput.prototype['targetBranch'] = undefined;
...
export default MergeBranchesByFastForwardInput;
