...
/**
 * The GetCommentOutputComment model module.
 * @module model/GetCommentOutputComment
 * @version 2015-04-13
 */
class GetCommentOutputComment {
    /**
     * Constructs a new <code>GetCommentOutputComment</code>.
     * @alias module:model/GetCommentOutputComment
     * @implements module:model/Comment
     */
    constructor() { 
        Comment.initialize(this);
        GetCommentOutputComment.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetCommentOutputComment</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCommentOutputComment} obj Optional instance to populate.
     * @return {module:model/GetCommentOutputComment} The populated <code>GetCommentOutputComment</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCommentOutputComment();
    ...
    /**
     * Validates the JSON data with respect to <code>GetCommentOutputComment</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCommentOutputComment</code>.
     */
 ...
 */
GetCommentOutputComment.prototype['commentId'] = undefined;

/**
 * @member {String} content
 */
GetCommentOutputComment.prototype['content'] = undefined;

/**
 * @member {String} inReplyTo
 */
GetCommentOutputComment.prototype['inReplyTo'] = undefined;

/**
 * @member {Date} creationDate
 */
GetCommentOutputComment.prototype['creationDate'] = undefined;

/**
 * @member {Date} lastModifiedDate
 */
GetCommentOutputComment.prototype['lastModifiedDate'] = undefined;

/**
 * @member {String} authorArn
 */
GetCommentOutputComment.prototype['authorArn'] = undefined;

/**
 * @member {Boolean} deleted
 */
GetCommentOutputComment.prototype['deleted'] = undefined;

/**
 * @member {String} clientRequestToken
 */
GetCommentOutputComment.prototype['clientRequestToken'] = undefined;

/**
 * @member {Array} callerReactions
 */
GetCommentOutputComment.prototype['callerReactions'] = undefined;

/**
 * @member {Object} reactionCounts
 */
GetCommentOutputComment.prototype['reactionCounts'] = undefined;
...
export default GetCommentOutputComment;
