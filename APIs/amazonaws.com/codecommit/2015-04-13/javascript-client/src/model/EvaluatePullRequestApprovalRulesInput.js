...
/**
 * The EvaluatePullRequestApprovalRulesInput model module.
 * @module model/EvaluatePullRequestApprovalRulesInput
 * @version 2015-04-13
 */
class EvaluatePullRequestApprovalRulesInput {
    /**
     * Constructs a new <code>EvaluatePullRequestApprovalRulesInput</code>.
     * @alias module:model/EvaluatePullRequestApprovalRulesInput
     * @param pullRequestId {String} 
     * @param revisionId {String} 
     */
    constructor(pullRequestId, revisionId) { 
        
        EvaluatePullRequestApprovalRulesInput.initialize(this, pullRequestId, revisionId);
    }
     ...
     */
    static initialize(obj, pullRequestId, revisionId) { 
        obj['pullRequestId'] = pullRequestId;
        obj['revisionId'] = revisionId;
    }

    /**
     * Constructs a <code>EvaluatePullRequestApprovalRulesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EvaluatePullRequestApprovalRulesInput} obj Optional instance to populate.
     * @return {module:model/EvaluatePullRequestApprovalRulesInput} The populated <code>EvaluatePullRequestApprovalRulesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EvaluatePullRequestApprovalRulesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>EvaluatePullRequestApprovalRulesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EvaluatePullRequestApprovalRulesInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EvaluatePullRequestApprovalRulesInput.RequiredProperties) {
...
EvaluatePullRequestApprovalRulesInput.RequiredProperties = ["pullRequestId", "revisionId"];

/**
 * @member {String} pullRequestId
 */
EvaluatePullRequestApprovalRulesInput.prototype['pullRequestId'] = undefined;

/**
 * @member {String} revisionId
 */
EvaluatePullRequestApprovalRulesInput.prototype['revisionId'] = undefined;
...
export default EvaluatePullRequestApprovalRulesInput;
