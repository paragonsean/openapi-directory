...
/**
 * The FileSizes model module.
 * @module model/FileSizes
 * @version 2015-04-13
 */
class FileSizes {
    /**
     * Constructs a new <code>FileSizes</code>.
     * Information about the size of files in a merge or pull request.
     * @alias module:model/FileSizes
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>FileSizes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FileSizes} obj Optional instance to populate.
     * @return {module:model/FileSizes} The populated <code>FileSizes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FileSizes();
    ...
    /**
     * Validates the JSON data with respect to <code>FileSizes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FileSizes</code>.
     */
