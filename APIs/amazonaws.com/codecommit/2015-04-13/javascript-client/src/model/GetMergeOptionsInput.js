...
/**
 * The GetMergeOptionsInput model module.
 * @module model/GetMergeOptionsInput
 * @version 2015-04-13
 */
class GetMergeOptionsInput {
    /**
     * Constructs a new <code>GetMergeOptionsInput</code>.
     * @alias module:model/GetMergeOptionsInput
    ...
    constructor(repositoryName, sourceCommitSpecifier, destinationCommitSpecifier) { 
        ...
        GetMergeOptionsInput.initialize(this, repositoryName, sourceCommitSpecifier, destinationCommitSpecifier);
    }
    ...
    /**
     * Constructs a <code>GetMergeOptionsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetMergeOptionsInput} obj Optional instance to populate.
     * @return {module:model/GetMergeOptionsInput} The populated <code>GetMergeOptionsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetMergeOptionsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetMergeOptionsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetMergeOptionsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetMergeOptionsInput.RequiredProperties) {
...
GetMergeOptionsInput.RequiredProperties = ["repositoryName", "sourceCommitSpecifier", "destinationCommitSpecifier"];

/**
 * @member {String} repositoryName
 */
GetMergeOptionsInput.prototype['repositoryName'] = undefined;

/**
 * @member {String} sourceCommitSpecifier
 */
GetMergeOptionsInput.prototype['sourceCommitSpecifier'] = undefined;

/**
 * @member {String} destinationCommitSpecifier
 */
GetMergeOptionsInput.prototype['destinationCommitSpecifier'] = undefined;

/**
 * @member {module:model/ConflictDetailLevelTypeEnum} conflictDetailLevel
 */
GetMergeOptionsInput.prototype['conflictDetailLevel'] = undefined;

/**
 * @member {module:model/ConflictResolutionStrategyTypeEnum} conflictResolutionStrategy
 */
GetMergeOptionsInput.prototype['conflictResolutionStrategy'] = undefined;
...
export default GetMergeOptionsInput;
