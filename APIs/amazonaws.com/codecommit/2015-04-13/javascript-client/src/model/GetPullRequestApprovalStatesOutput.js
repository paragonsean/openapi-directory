...
/**
 * The GetPullRequestApprovalStatesOutput model module.
 * @module model/GetPullRequestApprovalStatesOutput
 * @version 2015-04-13
 */
class GetPullRequestApprovalStatesOutput {
    /**
     * Constructs a new <code>GetPullRequestApprovalStatesOutput</code>.
     * @alias module:model/GetPullRequestApprovalStatesOutput
     */
    constructor() { 
        
        GetPullRequestApprovalStatesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetPullRequestApprovalStatesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPullRequestApprovalStatesOutput} obj Optional instance to populate.
     * @return {module:model/GetPullRequestApprovalStatesOutput} The populated <code>GetPullRequestApprovalStatesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPullRequestApprovalStatesOutput();

            if (data.hasOwnProperty('approvals')) {
                obj['approvals'] = ApiClient.convertToType(data['approvals'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetPullRequestApprovalStatesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPullRequestApprovalStatesOutput</code>.
     */
    static validateJSON(data) {
        // validate the optional field `approvals`
        if (data['approvals']) { // data not null
          Array.validateJSON(data['approvals']);
        }
 ...
 */
GetPullRequestApprovalStatesOutput.prototype['approvals'] = undefined;
...
export default GetPullRequestApprovalStatesOutput;
