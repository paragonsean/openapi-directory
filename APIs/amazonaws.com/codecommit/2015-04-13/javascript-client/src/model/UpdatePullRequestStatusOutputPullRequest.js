...
/**
 * The UpdatePullRequestStatusOutputPullRequest model module.
 * @module model/UpdatePullRequestStatusOutputPullRequest
 * @version 2015-04-13
 */
class UpdatePullRequestStatusOutputPullRequest {
    /**
     * Constructs a new <code>UpdatePullRequestStatusOutputPullRequest</code>.
     * @alias module:model/UpdatePullRequestStatusOutputPullRequest
     * @implements module:model/PullRequest
     */
    constructor() { 
        PullRequest.initialize(this);
        UpdatePullRequestStatusOutputPullRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdatePullRequestStatusOutputPullRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePullRequestStatusOutputPullRequest} obj Optional instance to populate.
     * @return {module:model/UpdatePullRequestStatusOutputPullRequest} The populated <code>UpdatePullRequestStatusOutputPullRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePullRequestStatusOutputPullRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePullRequestStatusOutputPullRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePullRequestStatusOutputPullRequest</code>.
     */
 ...
 */
UpdatePullRequestStatusOutputPullRequest.prototype['pullRequestId'] = undefined;

/**
 * @member {String} title
 */
UpdatePullRequestStatusOutputPullRequest.prototype['title'] = undefined;

/**
 * @member {String} description
 */
UpdatePullRequestStatusOutputPullRequest.prototype['description'] = undefined;

/**
 * @member {Date} lastActivityDate
 */
UpdatePullRequestStatusOutputPullRequest.prototype['lastActivityDate'] = undefined;

/**
 * @member {Date} creationDate
 */
UpdatePullRequestStatusOutputPullRequest.prototype['creationDate'] = undefined;

/**
 * @member {module:model/PullRequestStatusEnum} pullRequestStatus
 */
UpdatePullRequestStatusOutputPullRequest.prototype['pullRequestStatus'] = undefined;

/**
 * @member {String} authorArn
 */
UpdatePullRequestStatusOutputPullRequest.prototype['authorArn'] = undefined;

/**
 * @member {Array} pullRequestTargets
 */
UpdatePullRequestStatusOutputPullRequest.prototype['pullRequestTargets'] = undefined;

/**
 * @member {String} clientRequestToken
 */
UpdatePullRequestStatusOutputPullRequest.prototype['clientRequestToken'] = undefined;

/**
 * @member {String} revisionId
 */
UpdatePullRequestStatusOutputPullRequest.prototype['revisionId'] = undefined;

/**
 * @member {Array} approvalRules
 */
UpdatePullRequestStatusOutputPullRequest.prototype['approvalRules'] = undefined;
...
export default UpdatePullRequestStatusOutputPullRequest;
