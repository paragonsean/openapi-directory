...
public class UpdatePullRequestDescriptionInput {
  ...
  public UpdatePullRequestDescriptionInput() {
  }

  public UpdatePullRequestDescriptionInput pullRequestId(String pullRequestId) {
  ...
  public UpdatePullRequestDescriptionInput description(String description) {
  ...
  public boolean equals(Object o) {
    ...
    UpdatePullRequestDescriptionInput updatePullRequestDescriptionInput = (UpdatePullRequestDescriptionInput) o;
    return Objects.equals(this.pullRequestId, updatePullRequestDescriptionInput.pullRequestId) &&
        Objects.equals(this.description, updatePullRequestDescriptionInput.description);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pullRequestId, description);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdatePullRequestDescriptionInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePullRequestDescriptionInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePullRequestDescriptionInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePullRequestDescriptionInput is not found in the empty JSON string", UpdatePullRequestDescriptionInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePullRequestDescriptionInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePullRequestDescriptionInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdatePullRequestDescriptionInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePullRequestDescriptionInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePullRequestDescriptionInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePullRequestDescriptionInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePullRequestDescriptionInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePullRequestDescriptionInput>() {
           @Override
           public void write(JsonWriter out, UpdatePullRequestDescriptionInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePullRequestDescriptionInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePullRequestDescriptionInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePullRequestDescriptionInput
   * @throws IOException if the JSON string is invalid with respect to UpdatePullRequestDescriptionInput
   */
  public static UpdatePullRequestDescriptionInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePullRequestDescriptionInput.class);
  }

  /**
   * Convert an instance of UpdatePullRequestDescriptionInput to an JSON string
   *
   * @return JSON string
   */
