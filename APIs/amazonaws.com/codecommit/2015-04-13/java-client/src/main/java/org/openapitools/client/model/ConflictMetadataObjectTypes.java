...
public class ConflictMetadataObjectTypes {
  public static final String SERIALIZED_NAME_SOURCE = "source";
  @SerializedName(SERIALIZED_NAME_SOURCE)
  private ObjectTypeEnum source;

  public static final String SERIALIZED_NAME_DESTINATION = "destination";
  @SerializedName(SERIALIZED_NAME_DESTINATION)
  private ObjectTypeEnum destination;

  public static final String SERIALIZED_NAME_BASE = "base";
  @SerializedName(SERIALIZED_NAME_BASE)
  private ObjectTypeEnum base;

  public ConflictMetadataObjectTypes() {
  }

  public ConflictMetadataObjectTypes source(ObjectTypeEnum source) {
    this.source = source;
    return this;
  }
  ...
  public ObjectTypeEnum getSource() {
    return source;
  }
  ...
  public ConflictMetadataObjectTypes destination(ObjectTypeEnum destination) {
   ...
   */
  @javax.annotation.Nullable
  public ObjectTypeEnum getDestination() {
    return destination;
  }
  ...
  public ConflictMetadataObjectTypes base(ObjectTypeEnum base) {
    this.base = base;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ConflictMetadataObjectTypes conflictMetadataObjectTypes = (ConflictMetadataObjectTypes) o;
    return Objects.equals(this.source, conflictMetadataObjectTypes.source) &&
        Objects.equals(this.destination, conflictMetadataObjectTypes.destination) &&
        Objects.equals(this.base, conflictMetadataObjectTypes.base);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConflictMetadataObjectTypes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConflictMetadataObjectTypes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConflictMetadataObjectTypes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConflictMetadataObjectTypes is not found in the empty JSON string", ConflictMetadataObjectTypes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConflictMetadataObjectTypes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConflictMetadataObjectTypes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `source`
      if (jsonObj.get("source") != null && !jsonObj.get("source").isJsonNull()) {
        ObjectTypeEnum.validateJsonElement(jsonObj.get("source"));
      }
      // validate the optional field `destination`
      if (jsonObj.get("destination") != null && !jsonObj.get("destination").isJsonNull()) {
        ObjectTypeEnum.validateJsonElement(jsonObj.get("destination"));
      }
      // validate the optional field `base`
      if (jsonObj.get("base") != null && !jsonObj.get("base").isJsonNull()) {
        ObjectTypeEnum.validateJsonElement(jsonObj.get("base"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConflictMetadataObjectTypes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConflictMetadataObjectTypes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConflictMetadataObjectTypes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConflictMetadataObjectTypes.class));

       return (TypeAdapter<T>) new TypeAdapter<ConflictMetadataObjectTypes>() {
           @Override
           public void write(JsonWriter out, ConflictMetadataObjectTypes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConflictMetadataObjectTypes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConflictMetadataObjectTypes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConflictMetadataObjectTypes
   * @throws IOException if the JSON string is invalid with respect to ConflictMetadataObjectTypes
   */
  public static ConflictMetadataObjectTypes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConflictMetadataObjectTypes.class);
  }

  /**
   * Convert an instance of ConflictMetadataObjectTypes to an JSON string
   *
   * @return JSON string
   */
