...
public class IsBinaryFile {
  ...
  public IsBinaryFile source(Boolean source) {
    this.source = source;
    return this;
  }
  ...
  public IsBinaryFile destination(Boolean destination) {
  ...
  public IsBinaryFile base(Boolean base) {
    this.base = base;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    IsBinaryFile isBinaryFile = (IsBinaryFile) o;
    return Objects.equals(this.source, isBinaryFile.source) &&
        Objects.equals(this.destination, isBinaryFile.destination) &&
        Objects.equals(this.base, isBinaryFile.base);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to IsBinaryFile
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IsBinaryFile.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IsBinaryFile is not found in the empty JSON string", IsBinaryFile.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IsBinaryFile.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IsBinaryFile` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `source`
      if (jsonObj.get("source") != null && !jsonObj.get("source").isJsonNull()) {
        Boolean.validateJsonElement(jsonObj.get("source"));
      }
      // validate the optional field `destination`
      if (jsonObj.get("destination") != null && !jsonObj.get("destination").isJsonNull()) {
        Boolean.validateJsonElement(jsonObj.get("destination"));
      }
      // validate the optional field `base`
      if (jsonObj.get("base") != null && !jsonObj.get("base").isJsonNull()) {
        Boolean.validateJsonElement(jsonObj.get("base"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IsBinaryFile.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IsBinaryFile' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IsBinaryFile> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IsBinaryFile.class));

       return (TypeAdapter<T>) new TypeAdapter<IsBinaryFile>() {
           @Override
           public void write(JsonWriter out, IsBinaryFile value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IsBinaryFile read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IsBinaryFile given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IsBinaryFile
   * @throws IOException if the JSON string is invalid with respect to IsBinaryFile
   */
  public static IsBinaryFile fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IsBinaryFile.class);
  }

  /**
   * Convert an instance of IsBinaryFile to an JSON string
   *
   * @return JSON string
   */
