...
public class DeleteFileInput {
  ...
  public static final String SERIALIZED_NAME_PARENT_COMMIT_ID = "parentCommitId";
  @SerializedName(SERIALIZED_NAME_PARENT_COMMIT_ID)
  ...
  public DeleteFileInput() {
  }

  public DeleteFileInput repositoryName(String repositoryName) {
  ...
  public DeleteFileInput branchName(String branchName) {
  ...
  public DeleteFileInput filePath(String filePath) {
  ...
  public DeleteFileInput parentCommitId(String parentCommitId) {
  ...
  public DeleteFileInput keepEmptyFolders(Boolean keepEmptyFolders) {
  ...
  public DeleteFileInput commitMessage(String commitMessage) {
  ...
  public DeleteFileInput name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DeleteFileInput email(String email) {
    this.email = email;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteFileInput deleteFileInput = (DeleteFileInput) o;
    return Objects.equals(this.repositoryName, deleteFileInput.repositoryName) &&
        Objects.equals(this.branchName, deleteFileInput.branchName) &&
        Objects.equals(this.filePath, deleteFileInput.filePath) &&
        Objects.equals(this.parentCommitId, deleteFileInput.parentCommitId) &&
        Objects.equals(this.keepEmptyFolders, deleteFileInput.keepEmptyFolders) &&
        Objects.equals(this.commitMessage, deleteFileInput.commitMessage) &&
        Objects.equals(this.name, deleteFileInput.name) &&
        Objects.equals(this.email, deleteFileInput.email);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, branchName, filePath, parentCommitId, keepEmptyFolders, commitMessage, name, email);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteFileInput {\n");
    sb.append("    repositoryName: ").append(toIndentedString(repositoryName)).append("\n");
    sb.append("    branchName: ").append(toIndentedString(branchName)).append("\n");
    sb.append("    filePath: ").append(toIndentedString(filePath)).append("\n");
    sb.append("    parentCommitId: ").append(toIndentedString(parentCommitId)).append("\n");
  ...
  static {
    ...
    openapiFields.add("parentCommitId");
    ...
    openapiRequiredFields.add("parentCommitId");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteFileInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteFileInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteFileInput is not found in the empty JSON string", DeleteFileInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteFileInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteFileInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteFileInput.openapiRequiredFields) {
      ...
      // validate the required field `parentCommitId`
      String.validateJsonElement(jsonObj.get("parentCommitId"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteFileInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteFileInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteFileInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteFileInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteFileInput>() {
           @Override
           public void write(JsonWriter out, DeleteFileInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteFileInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteFileInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteFileInput
   * @throws IOException if the JSON string is invalid with respect to DeleteFileInput
   */
  public static DeleteFileInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteFileInput.class);
  }

  /**
   * Convert an instance of DeleteFileInput to an JSON string
   *
   * @return JSON string
   */
