...
public class DeletePullRequestApprovalRuleOutput {
  ...
  public DeletePullRequestApprovalRuleOutput() {
  }

  public DeletePullRequestApprovalRuleOutput approvalRuleId(String approvalRuleId) {
  ...
  public boolean equals(Object o) {
    ...
    DeletePullRequestApprovalRuleOutput deletePullRequestApprovalRuleOutput = (DeletePullRequestApprovalRuleOutput) o;
    return Objects.equals(this.approvalRuleId, deletePullRequestApprovalRuleOutput.approvalRuleId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(approvalRuleId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeletePullRequestApprovalRuleOutput {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("approvalRuleId");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeletePullRequestApprovalRuleOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeletePullRequestApprovalRuleOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeletePullRequestApprovalRuleOutput is not found in the empty JSON string", DeletePullRequestApprovalRuleOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeletePullRequestApprovalRuleOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeletePullRequestApprovalRuleOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeletePullRequestApprovalRuleOutput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `approvalRuleId`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeletePullRequestApprovalRuleOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeletePullRequestApprovalRuleOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeletePullRequestApprovalRuleOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeletePullRequestApprovalRuleOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeletePullRequestApprovalRuleOutput>() {
           @Override
           public void write(JsonWriter out, DeletePullRequestApprovalRuleOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeletePullRequestApprovalRuleOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeletePullRequestApprovalRuleOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeletePullRequestApprovalRuleOutput
   * @throws IOException if the JSON string is invalid with respect to DeletePullRequestApprovalRuleOutput
   */
  public static DeletePullRequestApprovalRuleOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeletePullRequestApprovalRuleOutput.class);
  }

  /**
   * Convert an instance of DeletePullRequestApprovalRuleOutput to an JSON string
   *
   * @return JSON string
   */
