...
public class ListApprovalRuleTemplatesInput {
  ...
  public ListApprovalRuleTemplatesInput() {
  }

  public ListApprovalRuleTemplatesInput nextToken(String nextToken) {
  ...
  public ListApprovalRuleTemplatesInput maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    ListApprovalRuleTemplatesInput listApprovalRuleTemplatesInput = (ListApprovalRuleTemplatesInput) o;
    return Objects.equals(this.nextToken, listApprovalRuleTemplatesInput.nextToken) &&
        Objects.equals(this.maxResults, listApprovalRuleTemplatesInput.maxResults);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListApprovalRuleTemplatesInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListApprovalRuleTemplatesInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListApprovalRuleTemplatesInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListApprovalRuleTemplatesInput is not found in the empty JSON string", ListApprovalRuleTemplatesInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListApprovalRuleTemplatesInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListApprovalRuleTemplatesInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListApprovalRuleTemplatesInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListApprovalRuleTemplatesInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListApprovalRuleTemplatesInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListApprovalRuleTemplatesInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListApprovalRuleTemplatesInput>() {
           @Override
           public void write(JsonWriter out, ListApprovalRuleTemplatesInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListApprovalRuleTemplatesInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListApprovalRuleTemplatesInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListApprovalRuleTemplatesInput
   * @throws IOException if the JSON string is invalid with respect to ListApprovalRuleTemplatesInput
   */
  public static ListApprovalRuleTemplatesInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListApprovalRuleTemplatesInput.class);
  }

  /**
   * Convert an instance of ListApprovalRuleTemplatesInput to an JSON string
   *
   * @return JSON string
   */
