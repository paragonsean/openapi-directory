...
import org.openapitools.client.model.DeleteCommentContentOutputComment;
...
public class DeleteCommentContentOutput {
  ...
  private DeleteCommentContentOutputComment comment;

  public DeleteCommentContentOutput() {
  }

  public DeleteCommentContentOutput comment(DeleteCommentContentOutputComment comment) {
  ...
  public DeleteCommentContentOutputComment getComment() {
    return comment;
  }

  public void setComment(DeleteCommentContentOutputComment comment) {
    this.comment = comment;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteCommentContentOutput deleteCommentContentOutput = (DeleteCommentContentOutput) o;
    return Objects.equals(this.comment, deleteCommentContentOutput.comment);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteCommentContentOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteCommentContentOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteCommentContentOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteCommentContentOutput is not found in the empty JSON string", DeleteCommentContentOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteCommentContentOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteCommentContentOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `comment`
      if (jsonObj.get("comment") != null && !jsonObj.get("comment").isJsonNull()) {
        DeleteCommentContentOutputComment.validateJsonElement(jsonObj.get("comment"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteCommentContentOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteCommentContentOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteCommentContentOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteCommentContentOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteCommentContentOutput>() {
           @Override
           public void write(JsonWriter out, DeleteCommentContentOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteCommentContentOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteCommentContentOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteCommentContentOutput
   * @throws IOException if the JSON string is invalid with respect to DeleteCommentContentOutput
   */
  public static DeleteCommentContentOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteCommentContentOutput.class);
  }

  /**
   * Convert an instance of DeleteCommentContentOutput to an JSON string
   *
   * @return JSON string
   */
