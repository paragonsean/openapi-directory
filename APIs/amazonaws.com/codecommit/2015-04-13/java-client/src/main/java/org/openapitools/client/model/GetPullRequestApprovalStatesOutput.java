...
public class GetPullRequestApprovalStatesOutput {
  ...
  public GetPullRequestApprovalStatesOutput approvals(List approvals) {
  ...
  public boolean equals(Object o) {
    ...
    GetPullRequestApprovalStatesOutput getPullRequestApprovalStatesOutput = (GetPullRequestApprovalStatesOutput) o;
    return Objects.equals(this.approvals, getPullRequestApprovalStatesOutput.approvals);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetPullRequestApprovalStatesOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPullRequestApprovalStatesOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPullRequestApprovalStatesOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPullRequestApprovalStatesOutput is not found in the empty JSON string", GetPullRequestApprovalStatesOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPullRequestApprovalStatesOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPullRequestApprovalStatesOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `approvals`
      if (jsonObj.get("approvals") != null && !jsonObj.get("approvals").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("approvals"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPullRequestApprovalStatesOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPullRequestApprovalStatesOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPullRequestApprovalStatesOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPullRequestApprovalStatesOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPullRequestApprovalStatesOutput>() {
           @Override
           public void write(JsonWriter out, GetPullRequestApprovalStatesOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPullRequestApprovalStatesOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPullRequestApprovalStatesOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPullRequestApprovalStatesOutput
   * @throws IOException if the JSON string is invalid with respect to GetPullRequestApprovalStatesOutput
   */
  public static GetPullRequestApprovalStatesOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPullRequestApprovalStatesOutput.class);
  }

  /**
   * Convert an instance of GetPullRequestApprovalStatesOutput to an JSON string
   *
   * @return JSON string
   */
