...
public class RepositoryMetadata {
  ...
  public RepositoryMetadata accountId(String accountId) {
  ...
  public RepositoryMetadata repositoryId(String repositoryId) {
  ...
  public RepositoryMetadata repositoryName(String repositoryName) {
  ...
  public RepositoryMetadata repositoryDescription(String repositoryDescription) {
  ...
  public RepositoryMetadata defaultBranch(String defaultBranch) {
  ...
  public RepositoryMetadata creationDate(OffsetDateTime creationDate) {
  ...
  public RepositoryMetadata cloneUrlHttp(String cloneUrlHttp) {
  ...
  public RepositoryMetadata cloneUrlSsh(String cloneUrlSsh) {
  ...
  public RepositoryMetadata arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, repositoryMetadata.accountId) &&
        ...
        Objects.equals(this.repositoryDescription, repositoryMetadata.repositoryDescription) &&
        Objects.equals(this.defaultBranch, repositoryMetadata.defaultBranch) &&
        Objects.equals(this.lastModifiedDate, repositoryMetadata.lastModifiedDate) &&
        Objects.equals(this.creationDate, repositoryMetadata.creationDate) &&
        Objects.equals(this.cloneUrlHttp, repositoryMetadata.cloneUrlHttp) &&
        Objects.equals(this.cloneUrlSsh, repositoryMetadata.cloneUrlSsh) &&
        Objects.equals(this.arn, repositoryMetadata.arn);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RepositoryMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RepositoryMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RepositoryMetadata is not found in the empty JSON string", RepositoryMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RepositoryMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RepositoryMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RepositoryMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RepositoryMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RepositoryMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RepositoryMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<RepositoryMetadata>() {
           @Override
           public void write(JsonWriter out, RepositoryMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RepositoryMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RepositoryMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RepositoryMetadata
   * @throws IOException if the JSON string is invalid with respect to RepositoryMetadata
   */
  public static RepositoryMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RepositoryMetadata.class);
  }

  /**
   * Convert an instance of RepositoryMetadata to an JSON string
   *
   * @return JSON string
   */
