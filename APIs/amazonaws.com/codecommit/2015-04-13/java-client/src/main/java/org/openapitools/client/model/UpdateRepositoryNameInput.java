...
public class UpdateRepositoryNameInput {
  ...
  public UpdateRepositoryNameInput() {
  }

  public UpdateRepositoryNameInput oldName(String oldName) {
  ...
  public UpdateRepositoryNameInput newName(String newName) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateRepositoryNameInput updateRepositoryNameInput = (UpdateRepositoryNameInput) o;
    return Objects.equals(this.oldName, updateRepositoryNameInput.oldName) &&
        Objects.equals(this.newName, updateRepositoryNameInput.newName);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateRepositoryNameInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateRepositoryNameInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateRepositoryNameInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateRepositoryNameInput is not found in the empty JSON string", UpdateRepositoryNameInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateRepositoryNameInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateRepositoryNameInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateRepositoryNameInput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `oldName`
      String.validateJsonElement(jsonObj.get("oldName"));
      // validate the required field `newName`
      String.validateJsonElement(jsonObj.get("newName"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateRepositoryNameInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateRepositoryNameInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateRepositoryNameInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateRepositoryNameInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateRepositoryNameInput>() {
           @Override
           public void write(JsonWriter out, UpdateRepositoryNameInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateRepositoryNameInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateRepositoryNameInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateRepositoryNameInput
   * @throws IOException if the JSON string is invalid with respect to UpdateRepositoryNameInput
   */
  public static UpdateRepositoryNameInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateRepositoryNameInput.class);
  }

  /**
   * Convert an instance of UpdateRepositoryNameInput to an JSON string
   *
   * @return JSON string
   */
