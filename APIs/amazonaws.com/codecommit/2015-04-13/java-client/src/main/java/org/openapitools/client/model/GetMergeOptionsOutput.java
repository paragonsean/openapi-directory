...
public class GetMergeOptionsOutput {
  public static final String SERIALIZED_NAME_MERGE_OPTIONS = "mergeOptions";
  @SerializedName(SERIALIZED_NAME_MERGE_OPTIONS)
  private List mergeOptions;
  ...
  public GetMergeOptionsOutput() {
  }

  public GetMergeOptionsOutput mergeOptions(List mergeOptions) {
  ...
  public List getMergeOptions() {
    return mergeOptions;
  }

  public void setMergeOptions(List mergeOptions) {
    this.mergeOptions = mergeOptions;
  }


  public GetMergeOptionsOutput sourceCommitId(String sourceCommitId) {
  ...
  public GetMergeOptionsOutput destinationCommitId(String destinationCommitId) {
  ...
  public GetMergeOptionsOutput baseCommitId(String baseCommitId) {
  ...
  public boolean equals(Object o) {
    ...
    GetMergeOptionsOutput getMergeOptionsOutput = (GetMergeOptionsOutput) o;
    return Objects.equals(this.mergeOptions, getMergeOptionsOutput.mergeOptions) &&
        Objects.equals(this.sourceCommitId, getMergeOptionsOutput.sourceCommitId) &&
        Objects.equals(this.destinationCommitId, getMergeOptionsOutput.destinationCommitId) &&
        Objects.equals(this.baseCommitId, getMergeOptionsOutput.baseCommitId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(mergeOptions, sourceCommitId, destinationCommitId, baseCommitId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetMergeOptionsOutput {\n");
  ...
  static {
    ...
    openapiFields.add("mergeOptions");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetMergeOptionsOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetMergeOptionsOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetMergeOptionsOutput is not found in the empty JSON string", GetMergeOptionsOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetMergeOptionsOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetMergeOptionsOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetMergeOptionsOutput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `mergeOptions`
      List.validateJsonElement(jsonObj.get("mergeOptions"));
      ...
      // validate the required field `baseCommitId`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetMergeOptionsOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetMergeOptionsOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetMergeOptionsOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetMergeOptionsOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetMergeOptionsOutput>() {
           @Override
           public void write(JsonWriter out, GetMergeOptionsOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetMergeOptionsOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetMergeOptionsOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetMergeOptionsOutput
   * @throws IOException if the JSON string is invalid with respect to GetMergeOptionsOutput
   */
  public static GetMergeOptionsOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetMergeOptionsOutput.class);
  }

  /**
   * Convert an instance of GetMergeOptionsOutput to an JSON string
   *
   * @return JSON string
   */
