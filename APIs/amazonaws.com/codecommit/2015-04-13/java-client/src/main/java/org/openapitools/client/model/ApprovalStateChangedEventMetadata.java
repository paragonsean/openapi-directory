...
import org.openapitools.client.model.ApprovalState;
...
public class ApprovalStateChangedEventMetadata {
  ...
  public ApprovalStateChangedEventMetadata revisionId(String revisionId) {
  ...
  public ApprovalStateChangedEventMetadata approvalStatus(ApprovalState approvalStatus) {
  ...
  public boolean equals(Object o) {
    ...
    ApprovalStateChangedEventMetadata approvalStateChangedEventMetadata = (ApprovalStateChangedEventMetadata) o;
    return Objects.equals(this.revisionId, approvalStateChangedEventMetadata.revisionId) &&
        Objects.equals(this.approvalStatus, approvalStateChangedEventMetadata.approvalStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(revisionId, approvalStatus);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApprovalStateChangedEventMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApprovalStateChangedEventMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApprovalStateChangedEventMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApprovalStateChangedEventMetadata is not found in the empty JSON string", ApprovalStateChangedEventMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApprovalStateChangedEventMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApprovalStateChangedEventMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("approvalStatus") != null && !jsonObj.get("approvalStatus").isJsonNull()) {
        ApprovalState.validateJsonElement(jsonObj.get("approvalStatus"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApprovalStateChangedEventMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApprovalStateChangedEventMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApprovalStateChangedEventMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApprovalStateChangedEventMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<ApprovalStateChangedEventMetadata>() {
           @Override
           public void write(JsonWriter out, ApprovalStateChangedEventMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApprovalStateChangedEventMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApprovalStateChangedEventMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApprovalStateChangedEventMetadata
   * @throws IOException if the JSON string is invalid with respect to ApprovalStateChangedEventMetadata
   */
  public static ApprovalStateChangedEventMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApprovalStateChangedEventMetadata.class);
  }

  /**
   * Convert an instance of ApprovalStateChangedEventMetadata to an JSON string
   *
   * @return JSON string
   */
