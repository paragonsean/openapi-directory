...
public class ListAssociatedApprovalRuleTemplatesForRepositoryOutput {
  public static final String SERIALIZED_NAME_APPROVAL_RULE_TEMPLATE_NAMES = "approvalRuleTemplateNames";
  @SerializedName(SERIALIZED_NAME_APPROVAL_RULE_TEMPLATE_NAMES)
  private List approvalRuleTemplateNames;
  ...
  public ListAssociatedApprovalRuleTemplatesForRepositoryOutput approvalRuleTemplateNames(List approvalRuleTemplateNames) {
    this.approvalRuleTemplateNames = approvalRuleTemplateNames;
    return this;
  }

  /**
   * Get approvalRuleTemplateNames
   * @return approvalRuleTemplateNames
   */
  @javax.annotation.Nullable
  public List getApprovalRuleTemplateNames() {
    return approvalRuleTemplateNames;
  }

  public void setApprovalRuleTemplateNames(List approvalRuleTemplateNames) {
    this.approvalRuleTemplateNames = approvalRuleTemplateNames;
  }


  public ListAssociatedApprovalRuleTemplatesForRepositoryOutput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListAssociatedApprovalRuleTemplatesForRepositoryOutput listAssociatedApprovalRuleTemplatesForRepositoryOutput = (ListAssociatedApprovalRuleTemplatesForRepositoryOutput) o;
    return Objects.equals(this.approvalRuleTemplateNames, listAssociatedApprovalRuleTemplatesForRepositoryOutput.approvalRuleTemplateNames) &&
        Objects.equals(this.nextToken, listAssociatedApprovalRuleTemplatesForRepositoryOutput.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(approvalRuleTemplateNames, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListAssociatedApprovalRuleTemplatesForRepositoryOutput {\n");
    sb.append("    approvalRuleTemplateNames: ").append(toIndentedString(approvalRuleTemplateNames)).append("\n");
  ...
  static {
    ...
    openapiFields.add("approvalRuleTemplateNames");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAssociatedApprovalRuleTemplatesForRepositoryOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAssociatedApprovalRuleTemplatesForRepositoryOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAssociatedApprovalRuleTemplatesForRepositoryOutput is not found in the empty JSON string", ListAssociatedApprovalRuleTemplatesForRepositoryOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAssociatedApprovalRuleTemplatesForRepositoryOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAssociatedApprovalRuleTemplatesForRepositoryOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `approvalRuleTemplateNames`
      if (jsonObj.get("approvalRuleTemplateNames") != null && !jsonObj.get("approvalRuleTemplateNames").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("approvalRuleTemplateNames"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAssociatedApprovalRuleTemplatesForRepositoryOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAssociatedApprovalRuleTemplatesForRepositoryOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAssociatedApprovalRuleTemplatesForRepositoryOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAssociatedApprovalRuleTemplatesForRepositoryOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAssociatedApprovalRuleTemplatesForRepositoryOutput>() {
           @Override
           public void write(JsonWriter out, ListAssociatedApprovalRuleTemplatesForRepositoryOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAssociatedApprovalRuleTemplatesForRepositoryOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAssociatedApprovalRuleTemplatesForRepositoryOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAssociatedApprovalRuleTemplatesForRepositoryOutput
   * @throws IOException if the JSON string is invalid with respect to ListAssociatedApprovalRuleTemplatesForRepositoryOutput
   */
  public static ListAssociatedApprovalRuleTemplatesForRepositoryOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAssociatedApprovalRuleTemplatesForRepositoryOutput.class);
  }

  /**
   * Convert an instance of ListAssociatedApprovalRuleTemplatesForRepositoryOutput to an JSON string
   *
   * @return JSON string
   */
