...
public class UpdateDefaultBranchInput {
  ...
  public static final String SERIALIZED_NAME_DEFAULT_BRANCH_NAME = "defaultBranchName";
  @SerializedName(SERIALIZED_NAME_DEFAULT_BRANCH_NAME)
  private String defaultBranchName;

  public UpdateDefaultBranchInput() {
  }

  public UpdateDefaultBranchInput repositoryName(String repositoryName) {
  ...
  public UpdateDefaultBranchInput defaultBranchName(String defaultBranchName) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateDefaultBranchInput updateDefaultBranchInput = (UpdateDefaultBranchInput) o;
    return Objects.equals(this.repositoryName, updateDefaultBranchInput.repositoryName) &&
        Objects.equals(this.defaultBranchName, updateDefaultBranchInput.defaultBranchName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, defaultBranchName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateDefaultBranchInput {\n");
  ...
  static {
    ...
    openapiFields.add("defaultBranchName");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("repositoryName");
    openapiRequiredFields.add("defaultBranchName");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateDefaultBranchInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateDefaultBranchInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateDefaultBranchInput is not found in the empty JSON string", UpdateDefaultBranchInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateDefaultBranchInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateDefaultBranchInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateDefaultBranchInput.openapiRequiredFields) {
      ...
      // validate the required field `defaultBranchName`
      String.validateJsonElement(jsonObj.get("defaultBranchName"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateDefaultBranchInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateDefaultBranchInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateDefaultBranchInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateDefaultBranchInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateDefaultBranchInput>() {
           @Override
           public void write(JsonWriter out, UpdateDefaultBranchInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateDefaultBranchInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateDefaultBranchInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateDefaultBranchInput
   * @throws IOException if the JSON string is invalid with respect to UpdateDefaultBranchInput
   */
  public static UpdateDefaultBranchInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateDefaultBranchInput.class);
  }

  /**
   * Convert an instance of UpdateDefaultBranchInput to an JSON string
   *
   * @return JSON string
   */
