...
public class UpdatePullRequestTitleInput {
  ...
  public UpdatePullRequestTitleInput() {
  }

  public UpdatePullRequestTitleInput pullRequestId(String pullRequestId) {
  ...
  public UpdatePullRequestTitleInput title(String title) {
    this.title = title;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdatePullRequestTitleInput updatePullRequestTitleInput = (UpdatePullRequestTitleInput) o;
    return Objects.equals(this.pullRequestId, updatePullRequestTitleInput.pullRequestId) &&
        Objects.equals(this.title, updatePullRequestTitleInput.title);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pullRequestId, title);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdatePullRequestTitleInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePullRequestTitleInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePullRequestTitleInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePullRequestTitleInput is not found in the empty JSON string", UpdatePullRequestTitleInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePullRequestTitleInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePullRequestTitleInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdatePullRequestTitleInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePullRequestTitleInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePullRequestTitleInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePullRequestTitleInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePullRequestTitleInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePullRequestTitleInput>() {
           @Override
           public void write(JsonWriter out, UpdatePullRequestTitleInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePullRequestTitleInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePullRequestTitleInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePullRequestTitleInput
   * @throws IOException if the JSON string is invalid with respect to UpdatePullRequestTitleInput
   */
  public static UpdatePullRequestTitleInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePullRequestTitleInput.class);
  }

  /**
   * Convert an instance of UpdatePullRequestTitleInput to an JSON string
   *
   * @return JSON string
   */
