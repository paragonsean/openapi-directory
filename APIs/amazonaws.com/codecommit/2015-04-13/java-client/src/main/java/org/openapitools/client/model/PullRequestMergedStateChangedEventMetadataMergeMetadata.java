...
public class PullRequestMergedStateChangedEventMetadataMergeMetadata {
  ...
  public PullRequestMergedStateChangedEventMetadataMergeMetadata() {
  }

  public PullRequestMergedStateChangedEventMetadataMergeMetadata isMerged(Boolean isMerged) {
  ...
  public PullRequestMergedStateChangedEventMetadataMergeMetadata mergedBy(String mergedBy) {
  ...
  public PullRequestMergedStateChangedEventMetadataMergeMetadata mergeCommitId(String mergeCommitId) {
  ...
  public PullRequestMergedStateChangedEventMetadataMergeMetadata mergeOption(MergeOptionTypeEnum mergeOption) {
  ...
  public boolean equals(Object o) {
    ...
    PullRequestMergedStateChangedEventMetadataMergeMetadata pullRequestMergedStateChangedEventMetadataMergeMetadata = (PullRequestMergedStateChangedEventMetadataMergeMetadata) o;
    return Objects.equals(this.isMerged, pullRequestMergedStateChangedEventMetadataMergeMetadata.isMerged) &&
        Objects.equals(this.mergedBy, pullRequestMergedStateChangedEventMetadataMergeMetadata.mergedBy) &&
        Objects.equals(this.mergeCommitId, pullRequestMergedStateChangedEventMetadataMergeMetadata.mergeCommitId) &&
        Objects.equals(this.mergeOption, pullRequestMergedStateChangedEventMetadataMergeMetadata.mergeOption);
  }
  ...
  public String toString() {
    ...
    sb.append("class PullRequestMergedStateChangedEventMetadataMergeMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PullRequestMergedStateChangedEventMetadataMergeMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PullRequestMergedStateChangedEventMetadataMergeMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PullRequestMergedStateChangedEventMetadataMergeMetadata is not found in the empty JSON string", PullRequestMergedStateChangedEventMetadataMergeMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PullRequestMergedStateChangedEventMetadataMergeMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PullRequestMergedStateChangedEventMetadataMergeMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PullRequestMergedStateChangedEventMetadataMergeMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PullRequestMergedStateChangedEventMetadataMergeMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PullRequestMergedStateChangedEventMetadataMergeMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PullRequestMergedStateChangedEventMetadataMergeMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<PullRequestMergedStateChangedEventMetadataMergeMetadata>() {
           @Override
           public void write(JsonWriter out, PullRequestMergedStateChangedEventMetadataMergeMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PullRequestMergedStateChangedEventMetadataMergeMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PullRequestMergedStateChangedEventMetadataMergeMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PullRequestMergedStateChangedEventMetadataMergeMetadata
   * @throws IOException if the JSON string is invalid with respect to PullRequestMergedStateChangedEventMetadataMergeMetadata
   */
  public static PullRequestMergedStateChangedEventMetadataMergeMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PullRequestMergedStateChangedEventMetadataMergeMetadata.class);
  }

  /**
   * Convert an instance of PullRequestMergedStateChangedEventMetadataMergeMetadata to an JSON string
   *
   * @return JSON string
   */
