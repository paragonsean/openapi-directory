...
public class DeleteApprovalRuleTemplateOutput {
  ...
  public DeleteApprovalRuleTemplateOutput() {
  }

  public DeleteApprovalRuleTemplateOutput approvalRuleTemplateId(String approvalRuleTemplateId) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteApprovalRuleTemplateOutput deleteApprovalRuleTemplateOutput = (DeleteApprovalRuleTemplateOutput) o;
    return Objects.equals(this.approvalRuleTemplateId, deleteApprovalRuleTemplateOutput.approvalRuleTemplateId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(approvalRuleTemplateId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteApprovalRuleTemplateOutput {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("approvalRuleTemplateId");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteApprovalRuleTemplateOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteApprovalRuleTemplateOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteApprovalRuleTemplateOutput is not found in the empty JSON string", DeleteApprovalRuleTemplateOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteApprovalRuleTemplateOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteApprovalRuleTemplateOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteApprovalRuleTemplateOutput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `approvalRuleTemplateId`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteApprovalRuleTemplateOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteApprovalRuleTemplateOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteApprovalRuleTemplateOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteApprovalRuleTemplateOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteApprovalRuleTemplateOutput>() {
           @Override
           public void write(JsonWriter out, DeleteApprovalRuleTemplateOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteApprovalRuleTemplateOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteApprovalRuleTemplateOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteApprovalRuleTemplateOutput
   * @throws IOException if the JSON string is invalid with respect to DeleteApprovalRuleTemplateOutput
   */
  public static DeleteApprovalRuleTemplateOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteApprovalRuleTemplateOutput.class);
  }

  /**
   * Convert an instance of DeleteApprovalRuleTemplateOutput to an JSON string
   *
   * @return JSON string
   */
