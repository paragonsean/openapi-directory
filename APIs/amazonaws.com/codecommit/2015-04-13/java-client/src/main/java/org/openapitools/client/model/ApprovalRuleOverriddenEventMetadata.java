...
public class ApprovalRuleOverriddenEventMetadata {
  ...
  public ApprovalRuleOverriddenEventMetadata revisionId(String revisionId) {
  ...
  public ApprovalRuleOverriddenEventMetadata overrideStatus(OverrideStatus overrideStatus) {
  ...
  public boolean equals(Object o) {
    ...
    ApprovalRuleOverriddenEventMetadata approvalRuleOverriddenEventMetadata = (ApprovalRuleOverriddenEventMetadata) o;
    return Objects.equals(this.revisionId, approvalRuleOverriddenEventMetadata.revisionId) &&
        Objects.equals(this.overrideStatus, approvalRuleOverriddenEventMetadata.overrideStatus);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApprovalRuleOverriddenEventMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApprovalRuleOverriddenEventMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApprovalRuleOverriddenEventMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApprovalRuleOverriddenEventMetadata is not found in the empty JSON string", ApprovalRuleOverriddenEventMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApprovalRuleOverriddenEventMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApprovalRuleOverriddenEventMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApprovalRuleOverriddenEventMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApprovalRuleOverriddenEventMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApprovalRuleOverriddenEventMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApprovalRuleOverriddenEventMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<ApprovalRuleOverriddenEventMetadata>() {
           @Override
           public void write(JsonWriter out, ApprovalRuleOverriddenEventMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApprovalRuleOverriddenEventMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApprovalRuleOverriddenEventMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApprovalRuleOverriddenEventMetadata
   * @throws IOException if the JSON string is invalid with respect to ApprovalRuleOverriddenEventMetadata
   */
  public static ApprovalRuleOverriddenEventMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApprovalRuleOverriddenEventMetadata.class);
  }

  /**
   * Convert an instance of ApprovalRuleOverriddenEventMetadata to an JSON string
   *
   * @return JSON string
   */
