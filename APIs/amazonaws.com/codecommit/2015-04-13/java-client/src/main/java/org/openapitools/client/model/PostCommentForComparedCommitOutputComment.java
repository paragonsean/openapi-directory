...
public class PostCommentForComparedCommitOutputComment {
  ...
  public PostCommentForComparedCommitOutputComment() {
  }

  public PostCommentForComparedCommitOutputComment commentId(String commentId) {
  ...
  public PostCommentForComparedCommitOutputComment content(String content) {
  ...
  public PostCommentForComparedCommitOutputComment inReplyTo(String inReplyTo) {
  ...
  public PostCommentForComparedCommitOutputComment creationDate(OffsetDateTime creationDate) {
  ...
  public PostCommentForComparedCommitOutputComment lastModifiedDate(OffsetDateTime lastModifiedDate) {
  ...
  public PostCommentForComparedCommitOutputComment authorArn(String authorArn) {
  ...
  public PostCommentForComparedCommitOutputComment deleted(Boolean deleted) {
  ...
  public PostCommentForComparedCommitOutputComment clientRequestToken(String clientRequestToken) {
  ...
  public PostCommentForComparedCommitOutputComment callerReactions(List callerReactions) {
  ...
  public PostCommentForComparedCommitOutputComment reactionCounts(Map reactionCounts) {
  ...
  public boolean equals(Object o) {
    ...
    PostCommentForComparedCommitOutputComment postCommentForComparedCommitOutputComment = (PostCommentForComparedCommitOutputComment) o;
    return Objects.equals(this.commentId, postCommentForComparedCommitOutputComment.commentId) &&
        Objects.equals(this.content, postCommentForComparedCommitOutputComment.content) &&
        Objects.equals(this.inReplyTo, postCommentForComparedCommitOutputComment.inReplyTo) &&
        Objects.equals(this.creationDate, postCommentForComparedCommitOutputComment.creationDate) &&
        Objects.equals(this.lastModifiedDate, postCommentForComparedCommitOutputComment.lastModifiedDate) &&
        Objects.equals(this.authorArn, postCommentForComparedCommitOutputComment.authorArn) &&
        Objects.equals(this.deleted, postCommentForComparedCommitOutputComment.deleted) &&
        Objects.equals(this.clientRequestToken, postCommentForComparedCommitOutputComment.clientRequestToken) &&
        Objects.equals(this.callerReactions, postCommentForComparedCommitOutputComment.callerReactions) &&
        Objects.equals(this.reactionCounts, postCommentForComparedCommitOutputComment.reactionCounts);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostCommentForComparedCommitOutputComment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostCommentForComparedCommitOutputComment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostCommentForComparedCommitOutputComment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostCommentForComparedCommitOutputComment is not found in the empty JSON string", PostCommentForComparedCommitOutputComment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostCommentForComparedCommitOutputComment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostCommentForComparedCommitOutputComment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostCommentForComparedCommitOutputComment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostCommentForComparedCommitOutputComment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostCommentForComparedCommitOutputComment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostCommentForComparedCommitOutputComment.class));

       return (TypeAdapter<T>) new TypeAdapter<PostCommentForComparedCommitOutputComment>() {
           @Override
           public void write(JsonWriter out, PostCommentForComparedCommitOutputComment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostCommentForComparedCommitOutputComment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostCommentForComparedCommitOutputComment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostCommentForComparedCommitOutputComment
   * @throws IOException if the JSON string is invalid with respect to PostCommentForComparedCommitOutputComment
   */
  public static PostCommentForComparedCommitOutputComment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostCommentForComparedCommitOutputComment.class);
  }

  /**
   * Convert an instance of PostCommentForComparedCommitOutputComment to an JSON string
   *
   * @return JSON string
   */
