...
import org.openapitools.client.model.UpdatePullRequestApprovalRuleContentOutputApprovalRule;
...
public class UpdatePullRequestApprovalRuleContentOutput {
  ...
  private UpdatePullRequestApprovalRuleContentOutputApprovalRule approvalRule;

  public UpdatePullRequestApprovalRuleContentOutput() {
  }

  public UpdatePullRequestApprovalRuleContentOutput approvalRule(UpdatePullRequestApprovalRuleContentOutputApprovalRule approvalRule) {
  ...
  public UpdatePullRequestApprovalRuleContentOutputApprovalRule getApprovalRule() {
    return approvalRule;
  }

  public void setApprovalRule(UpdatePullRequestApprovalRuleContentOutputApprovalRule approvalRule) {
    this.approvalRule = approvalRule;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdatePullRequestApprovalRuleContentOutput updatePullRequestApprovalRuleContentOutput = (UpdatePullRequestApprovalRuleContentOutput) o;
    return Objects.equals(this.approvalRule, updatePullRequestApprovalRuleContentOutput.approvalRule);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdatePullRequestApprovalRuleContentOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePullRequestApprovalRuleContentOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePullRequestApprovalRuleContentOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePullRequestApprovalRuleContentOutput is not found in the empty JSON string", UpdatePullRequestApprovalRuleContentOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePullRequestApprovalRuleContentOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePullRequestApprovalRuleContentOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdatePullRequestApprovalRuleContentOutput.openapiRequiredFields) {
      ...
      UpdatePullRequestApprovalRuleContentOutputApprovalRule.validateJsonElement(jsonObj.get("approvalRule"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePullRequestApprovalRuleContentOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePullRequestApprovalRuleContentOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePullRequestApprovalRuleContentOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePullRequestApprovalRuleContentOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePullRequestApprovalRuleContentOutput>() {
           @Override
           public void write(JsonWriter out, UpdatePullRequestApprovalRuleContentOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePullRequestApprovalRuleContentOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePullRequestApprovalRuleContentOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePullRequestApprovalRuleContentOutput
   * @throws IOException if the JSON string is invalid with respect to UpdatePullRequestApprovalRuleContentOutput
   */
  public static UpdatePullRequestApprovalRuleContentOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePullRequestApprovalRuleContentOutput.class);
  }

  /**
   * Convert an instance of UpdatePullRequestApprovalRuleContentOutput to an JSON string
   *
   * @return JSON string
   */
