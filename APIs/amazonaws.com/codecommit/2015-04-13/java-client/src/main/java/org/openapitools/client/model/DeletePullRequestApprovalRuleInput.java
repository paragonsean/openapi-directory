...
public class DeletePullRequestApprovalRuleInput {
  ...
  public DeletePullRequestApprovalRuleInput() {
  }

  public DeletePullRequestApprovalRuleInput pullRequestId(String pullRequestId) {
  ...
  public DeletePullRequestApprovalRuleInput approvalRuleName(String approvalRuleName) {
  ...
  public boolean equals(Object o) {
    ...
    DeletePullRequestApprovalRuleInput deletePullRequestApprovalRuleInput = (DeletePullRequestApprovalRuleInput) o;
    return Objects.equals(this.pullRequestId, deletePullRequestApprovalRuleInput.pullRequestId) &&
        Objects.equals(this.approvalRuleName, deletePullRequestApprovalRuleInput.approvalRuleName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pullRequestId, approvalRuleName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeletePullRequestApprovalRuleInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeletePullRequestApprovalRuleInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeletePullRequestApprovalRuleInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeletePullRequestApprovalRuleInput is not found in the empty JSON string", DeletePullRequestApprovalRuleInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeletePullRequestApprovalRuleInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeletePullRequestApprovalRuleInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeletePullRequestApprovalRuleInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeletePullRequestApprovalRuleInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeletePullRequestApprovalRuleInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeletePullRequestApprovalRuleInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeletePullRequestApprovalRuleInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeletePullRequestApprovalRuleInput>() {
           @Override
           public void write(JsonWriter out, DeletePullRequestApprovalRuleInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeletePullRequestApprovalRuleInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeletePullRequestApprovalRuleInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeletePullRequestApprovalRuleInput
   * @throws IOException if the JSON string is invalid with respect to DeletePullRequestApprovalRuleInput
   */
  public static DeletePullRequestApprovalRuleInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeletePullRequestApprovalRuleInput.class);
  }

  /**
   * Convert an instance of DeletePullRequestApprovalRuleInput to an JSON string
   *
   * @return JSON string
   */
