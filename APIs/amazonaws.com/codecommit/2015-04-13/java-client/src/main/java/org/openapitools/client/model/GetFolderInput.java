...
public class GetFolderInput {
  ...
  public static final String SERIALIZED_NAME_COMMIT_SPECIFIER = "commitSpecifier";
  @SerializedName(SERIALIZED_NAME_COMMIT_SPECIFIER)
  ...
  public GetFolderInput() {
  }

  public GetFolderInput repositoryName(String repositoryName) {
  ...
  public GetFolderInput commitSpecifier(String commitSpecifier) {
  ...
  public GetFolderInput folderPath(String folderPath) {
  ...
  public boolean equals(Object o) {
    ...
    GetFolderInput getFolderInput = (GetFolderInput) o;
    return Objects.equals(this.repositoryName, getFolderInput.repositoryName) &&
        Objects.equals(this.commitSpecifier, getFolderInput.commitSpecifier) &&
        Objects.equals(this.folderPath, getFolderInput.folderPath);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, commitSpecifier, folderPath);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetFolderInput {\n");
    sb.append("    repositoryName: ").append(toIndentedString(repositoryName)).append("\n");
    sb.append("    commitSpecifier: ").append(toIndentedString(commitSpecifier)).append("\n");
  ...
  static {
    ...
    openapiFields.add("commitSpecifier");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetFolderInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetFolderInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetFolderInput is not found in the empty JSON string", GetFolderInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetFolderInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetFolderInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetFolderInput.openapiRequiredFields) {
      ...
      // validate the optional field `commitSpecifier`
      if (jsonObj.get("commitSpecifier") != null && !jsonObj.get("commitSpecifier").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("commitSpecifier"));
      }
      // validate the required field `folderPath`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetFolderInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetFolderInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetFolderInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetFolderInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetFolderInput>() {
           @Override
           public void write(JsonWriter out, GetFolderInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetFolderInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetFolderInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetFolderInput
   * @throws IOException if the JSON string is invalid with respect to GetFolderInput
   */
  public static GetFolderInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetFolderInput.class);
  }

  /**
   * Convert an instance of GetFolderInput to an JSON string
   *
   * @return JSON string
   */
