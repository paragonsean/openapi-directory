...
public class SymbolicLink {
  ...
  public SymbolicLink blobId(String blobId) {
    this.blobId = blobId;
    return this;
  }
  ...
  public SymbolicLink absolutePath(String absolutePath) {
  ...
  public SymbolicLink relativePath(String relativePath) {
  ...
  public SymbolicLink fileMode(FileModeTypeEnum fileMode) {
  ...
  public boolean equals(Object o) {
    ...
    SymbolicLink symbolicLink = (SymbolicLink) o;
    return Objects.equals(this.blobId, symbolicLink.blobId) &&
        Objects.equals(this.absolutePath, symbolicLink.absolutePath) &&
        Objects.equals(this.relativePath, symbolicLink.relativePath) &&
        Objects.equals(this.fileMode, symbolicLink.fileMode);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SymbolicLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SymbolicLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SymbolicLink is not found in the empty JSON string", SymbolicLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SymbolicLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SymbolicLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SymbolicLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SymbolicLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SymbolicLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SymbolicLink.class));

       return (TypeAdapter<T>) new TypeAdapter<SymbolicLink>() {
           @Override
           public void write(JsonWriter out, SymbolicLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SymbolicLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SymbolicLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SymbolicLink
   * @throws IOException if the JSON string is invalid with respect to SymbolicLink
   */
  public static SymbolicLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SymbolicLink.class);
  }

  /**
   * Convert an instance of SymbolicLink to an JSON string
   *
   * @return JSON string
   */
