...
public class ListPullRequestsInput {
  ...
  public ListPullRequestsInput() {
  }

  public ListPullRequestsInput repositoryName(String repositoryName) {
  ...
  public ListPullRequestsInput authorArn(String authorArn) {
  ...
  public ListPullRequestsInput pullRequestStatus(PullRequestStatusEnum pullRequestStatus) {
  ...
  public ListPullRequestsInput nextToken(String nextToken) {
  ...
  public ListPullRequestsInput maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    ListPullRequestsInput listPullRequestsInput = (ListPullRequestsInput) o;
    return Objects.equals(this.repositoryName, listPullRequestsInput.repositoryName) &&
        Objects.equals(this.authorArn, listPullRequestsInput.authorArn) &&
        Objects.equals(this.pullRequestStatus, listPullRequestsInput.pullRequestStatus) &&
        Objects.equals(this.nextToken, listPullRequestsInput.nextToken) &&
        Objects.equals(this.maxResults, listPullRequestsInput.maxResults);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, authorArn, pullRequestStatus, nextToken, maxResults);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListPullRequestsInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListPullRequestsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListPullRequestsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListPullRequestsInput is not found in the empty JSON string", ListPullRequestsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListPullRequestsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListPullRequestsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListPullRequestsInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListPullRequestsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListPullRequestsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListPullRequestsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListPullRequestsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListPullRequestsInput>() {
           @Override
           public void write(JsonWriter out, ListPullRequestsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListPullRequestsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListPullRequestsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListPullRequestsInput
   * @throws IOException if the JSON string is invalid with respect to ListPullRequestsInput
   */
  public static ListPullRequestsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListPullRequestsInput.class);
  }

  /**
   * Convert an instance of ListPullRequestsInput to an JSON string
   *
   * @return JSON string
   */
