...
public class GetBranchOutputBranch {
  ...
  public GetBranchOutputBranch() {
  }

  public GetBranchOutputBranch branchName(String branchName) {
  ...
  public GetBranchOutputBranch commitId(String commitId) {
  ...
  public boolean equals(Object o) {
    ...
    GetBranchOutputBranch getBranchOutputBranch = (GetBranchOutputBranch) o;
    return Objects.equals(this.branchName, getBranchOutputBranch.branchName) &&
        Objects.equals(this.commitId, getBranchOutputBranch.commitId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetBranchOutputBranch {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetBranchOutputBranch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetBranchOutputBranch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetBranchOutputBranch is not found in the empty JSON string", GetBranchOutputBranch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetBranchOutputBranch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetBranchOutputBranch` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetBranchOutputBranch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetBranchOutputBranch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetBranchOutputBranch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetBranchOutputBranch.class));

       return (TypeAdapter<T>) new TypeAdapter<GetBranchOutputBranch>() {
           @Override
           public void write(JsonWriter out, GetBranchOutputBranch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetBranchOutputBranch read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetBranchOutputBranch given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetBranchOutputBranch
   * @throws IOException if the JSON string is invalid with respect to GetBranchOutputBranch
   */
  public static GetBranchOutputBranch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetBranchOutputBranch.class);
  }

  /**
   * Convert an instance of GetBranchOutputBranch to an JSON string
   *
   * @return JSON string
   */
