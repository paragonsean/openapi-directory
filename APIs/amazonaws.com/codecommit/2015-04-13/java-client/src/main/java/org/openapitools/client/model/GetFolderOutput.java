...
public class GetFolderOutput {
  ...
  public static final String SERIALIZED_NAME_SYMBOLIC_LINKS = "symbolicLinks";
  @SerializedName(SERIALIZED_NAME_SYMBOLIC_LINKS)
  private List symbolicLinks;

  public static final String SERIALIZED_NAME_SUB_MODULES = "subModules";
  @SerializedName(SERIALIZED_NAME_SUB_MODULES)
  private List subModules;

  public GetFolderOutput() {
  }

  public GetFolderOutput commitId(String commitId) {
  ...
  public GetFolderOutput folderPath(String folderPath) {
  ...
  public GetFolderOutput treeId(String treeId) {
    this.treeId = treeId;
    return this;
  }
  ...
  public GetFolderOutput subFolders(List subFolders) {
  ...
  public GetFolderOutput files(List files) {
    this.files = files;
    return this;
  }
  ...
  public GetFolderOutput symbolicLinks(List symbolicLinks) {
   ...
   */
  @javax.annotation.Nullable
  public List getSymbolicLinks() {
    return symbolicLinks;
  }

  public void setSymbolicLinks(List symbolicLinks) {
    this.symbolicLinks = symbolicLinks;
  }


  public GetFolderOutput subModules(List subModules) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.commitId, getFolderOutput.commitId) &&
        Objects.equals(this.folderPath, getFolderOutput.folderPath) &&
        Objects.equals(this.treeId, getFolderOutput.treeId) &&
        Objects.equals(this.subFolders, getFolderOutput.subFolders) &&
        Objects.equals(this.files, getFolderOutput.files) &&
        Objects.equals(this.symbolicLinks, getFolderOutput.symbolicLinks) &&
        Objects.equals(this.subModules, getFolderOutput.subModules);
  }

  @Override
  public int hashCode() {
    return Objects.hash(commitId, folderPath, treeId, subFolders, files, symbolicLinks, subModules);
  }
  ...
  public String toString() {
    ...
    sb.append("    symbolicLinks: ").append(toIndentedString(symbolicLinks)).append("\n");
  ...
  static {
    ...
    openapiFields.add("symbolicLinks");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : GetFolderOutput.openapiRequiredFields) {
      ...
      if (jsonObj.get("subFolders") != null && !jsonObj.get("subFolders").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("subFolders"));
      }
      ...
      if (jsonObj.get("symbolicLinks") != null && !jsonObj.get("symbolicLinks").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("symbolicLinks"));
      }
      // validate the optional field `subModules`
      if (jsonObj.get("subModules") != null && !jsonObj.get("subModules").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("subModules"));
      }
  }
