...
public class ConflictMetadataMergeOperations {
  public static final String SERIALIZED_NAME_SOURCE = "source";
  @SerializedName(SERIALIZED_NAME_SOURCE)
  private ChangeTypeEnum source;

  public static final String SERIALIZED_NAME_DESTINATION = "destination";
  @SerializedName(SERIALIZED_NAME_DESTINATION)
  private ChangeTypeEnum destination;

  public ConflictMetadataMergeOperations() {
  }

  public ConflictMetadataMergeOperations source(ChangeTypeEnum source) {
    this.source = source;
    return this;
  }
  ...
  public ChangeTypeEnum getSource() {
    return source;
  }
  ...
  public ConflictMetadataMergeOperations destination(ChangeTypeEnum destination) {
   ...
   */
  @javax.annotation.Nullable
  public ChangeTypeEnum getDestination() {
    return destination;
  }
  ...
  public boolean equals(Object o) {
    ...
    ConflictMetadataMergeOperations conflictMetadataMergeOperations = (ConflictMetadataMergeOperations) o;
    return Objects.equals(this.source, conflictMetadataMergeOperations.source) &&
        Objects.equals(this.destination, conflictMetadataMergeOperations.destination);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConflictMetadataMergeOperations {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConflictMetadataMergeOperations
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConflictMetadataMergeOperations.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConflictMetadataMergeOperations is not found in the empty JSON string", ConflictMetadataMergeOperations.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConflictMetadataMergeOperations.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConflictMetadataMergeOperations` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `source`
      if (jsonObj.get("source") != null && !jsonObj.get("source").isJsonNull()) {
        ChangeTypeEnum.validateJsonElement(jsonObj.get("source"));
      }
      // validate the optional field `destination`
      if (jsonObj.get("destination") != null && !jsonObj.get("destination").isJsonNull()) {
        ChangeTypeEnum.validateJsonElement(jsonObj.get("destination"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConflictMetadataMergeOperations.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConflictMetadataMergeOperations' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConflictMetadataMergeOperations> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConflictMetadataMergeOperations.class));

       return (TypeAdapter<T>) new TypeAdapter<ConflictMetadataMergeOperations>() {
           @Override
           public void write(JsonWriter out, ConflictMetadataMergeOperations value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConflictMetadataMergeOperations read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConflictMetadataMergeOperations given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConflictMetadataMergeOperations
   * @throws IOException if the JSON string is invalid with respect to ConflictMetadataMergeOperations
   */
  public static ConflictMetadataMergeOperations fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConflictMetadataMergeOperations.class);
  }

  /**
   * Convert an instance of ConflictMetadataMergeOperations to an JSON string
   *
   * @return JSON string
   */
