...
public class UpdatePullRequestApprovalStateInput {
  ...
  public UpdatePullRequestApprovalStateInput() {
  }

  public UpdatePullRequestApprovalStateInput pullRequestId(String pullRequestId) {
  ...
  public UpdatePullRequestApprovalStateInput revisionId(String revisionId) {
  ...
  public UpdatePullRequestApprovalStateInput approvalState(ApprovalState approvalState) {
  ...
  public boolean equals(Object o) {
    ...
    UpdatePullRequestApprovalStateInput updatePullRequestApprovalStateInput = (UpdatePullRequestApprovalStateInput) o;
    return Objects.equals(this.pullRequestId, updatePullRequestApprovalStateInput.pullRequestId) &&
        Objects.equals(this.revisionId, updatePullRequestApprovalStateInput.revisionId) &&
        Objects.equals(this.approvalState, updatePullRequestApprovalStateInput.approvalState);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pullRequestId, revisionId, approvalState);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdatePullRequestApprovalStateInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePullRequestApprovalStateInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePullRequestApprovalStateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePullRequestApprovalStateInput is not found in the empty JSON string", UpdatePullRequestApprovalStateInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePullRequestApprovalStateInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePullRequestApprovalStateInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdatePullRequestApprovalStateInput.openapiRequiredFields) {
      ...
      // validate the required field `approvalState`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePullRequestApprovalStateInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePullRequestApprovalStateInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePullRequestApprovalStateInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePullRequestApprovalStateInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePullRequestApprovalStateInput>() {
           @Override
           public void write(JsonWriter out, UpdatePullRequestApprovalStateInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePullRequestApprovalStateInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePullRequestApprovalStateInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePullRequestApprovalStateInput
   * @throws IOException if the JSON string is invalid with respect to UpdatePullRequestApprovalStateInput
   */
  public static UpdatePullRequestApprovalStateInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePullRequestApprovalStateInput.class);
  }

  /**
   * Convert an instance of UpdatePullRequestApprovalStateInput to an JSON string
   *
   * @return JSON string
   */
