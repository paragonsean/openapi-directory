...
public class PullRequestEventApprovalRuleEventMetadata {
  ...
  public PullRequestEventApprovalRuleEventMetadata() {
  }

  public PullRequestEventApprovalRuleEventMetadata approvalRuleName(String approvalRuleName) {
  ...
  public PullRequestEventApprovalRuleEventMetadata approvalRuleId(String approvalRuleId) {
  ...
  public PullRequestEventApprovalRuleEventMetadata approvalRuleContent(String approvalRuleContent) {
  ...
  public boolean equals(Object o) {
    ...
    PullRequestEventApprovalRuleEventMetadata pullRequestEventApprovalRuleEventMetadata = (PullRequestEventApprovalRuleEventMetadata) o;
    return Objects.equals(this.approvalRuleName, pullRequestEventApprovalRuleEventMetadata.approvalRuleName) &&
        Objects.equals(this.approvalRuleId, pullRequestEventApprovalRuleEventMetadata.approvalRuleId) &&
        Objects.equals(this.approvalRuleContent, pullRequestEventApprovalRuleEventMetadata.approvalRuleContent);
  }

  @Override
  public int hashCode() {
    return Objects.hash(approvalRuleName, approvalRuleId, approvalRuleContent);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PullRequestEventApprovalRuleEventMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PullRequestEventApprovalRuleEventMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PullRequestEventApprovalRuleEventMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PullRequestEventApprovalRuleEventMetadata is not found in the empty JSON string", PullRequestEventApprovalRuleEventMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PullRequestEventApprovalRuleEventMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PullRequestEventApprovalRuleEventMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PullRequestEventApprovalRuleEventMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PullRequestEventApprovalRuleEventMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PullRequestEventApprovalRuleEventMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PullRequestEventApprovalRuleEventMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<PullRequestEventApprovalRuleEventMetadata>() {
           @Override
           public void write(JsonWriter out, PullRequestEventApprovalRuleEventMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PullRequestEventApprovalRuleEventMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PullRequestEventApprovalRuleEventMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PullRequestEventApprovalRuleEventMetadata
   * @throws IOException if the JSON string is invalid with respect to PullRequestEventApprovalRuleEventMetadata
   */
  public static PullRequestEventApprovalRuleEventMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PullRequestEventApprovalRuleEventMetadata.class);
  }

  /**
   * Convert an instance of PullRequestEventApprovalRuleEventMetadata to an JSON string
   *
   * @return JSON string
   */
