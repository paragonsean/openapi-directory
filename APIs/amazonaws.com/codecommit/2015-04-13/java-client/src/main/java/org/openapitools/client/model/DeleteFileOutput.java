...
public class DeleteFileOutput {
  ...
  public DeleteFileOutput commitId(String commitId) {
  ...
  public DeleteFileOutput blobId(String blobId) {
    this.blobId = blobId;
    return this;
  }
  ...
  public DeleteFileOutput treeId(String treeId) {
    this.treeId = treeId;
    return this;
  }
  ...
  public DeleteFileOutput filePath(String filePath) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteFileOutput deleteFileOutput = (DeleteFileOutput) o;
    return Objects.equals(this.commitId, deleteFileOutput.commitId) &&
        Objects.equals(this.blobId, deleteFileOutput.blobId) &&
        Objects.equals(this.treeId, deleteFileOutput.treeId) &&
        Objects.equals(this.filePath, deleteFileOutput.filePath);
  }

  @Override
  public int hashCode() {
    return Objects.hash(commitId, blobId, treeId, filePath);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteFileOutput {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("treeId");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteFileOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteFileOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteFileOutput is not found in the empty JSON string", DeleteFileOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteFileOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteFileOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteFileOutput.openapiRequiredFields) {
      ...
      // validate the required field `treeId`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteFileOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteFileOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteFileOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteFileOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteFileOutput>() {
           @Override
           public void write(JsonWriter out, DeleteFileOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteFileOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteFileOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteFileOutput
   * @throws IOException if the JSON string is invalid with respect to DeleteFileOutput
   */
  public static DeleteFileOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteFileOutput.class);
  }

  /**
   * Convert an instance of DeleteFileOutput to an JSON string
   *
   * @return JSON string
   */
