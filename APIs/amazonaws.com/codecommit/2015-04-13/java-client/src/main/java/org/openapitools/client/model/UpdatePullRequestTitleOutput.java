...
public class UpdatePullRequestTitleOutput {
  ...
  public UpdatePullRequestTitleOutput() {
  }

  public UpdatePullRequestTitleOutput pullRequest(UpdatePullRequestDescriptionOutputPullRequest pullRequest) {
  ...
  public boolean equals(Object o) {
    ...
    UpdatePullRequestTitleOutput updatePullRequestTitleOutput = (UpdatePullRequestTitleOutput) o;
    return Objects.equals(this.pullRequest, updatePullRequestTitleOutput.pullRequest);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdatePullRequestTitleOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePullRequestTitleOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePullRequestTitleOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePullRequestTitleOutput is not found in the empty JSON string", UpdatePullRequestTitleOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePullRequestTitleOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePullRequestTitleOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdatePullRequestTitleOutput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePullRequestTitleOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePullRequestTitleOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePullRequestTitleOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePullRequestTitleOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePullRequestTitleOutput>() {
           @Override
           public void write(JsonWriter out, UpdatePullRequestTitleOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePullRequestTitleOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePullRequestTitleOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePullRequestTitleOutput
   * @throws IOException if the JSON string is invalid with respect to UpdatePullRequestTitleOutput
   */
  public static UpdatePullRequestTitleOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePullRequestTitleOutput.class);
  }

  /**
   * Convert an instance of UpdatePullRequestTitleOutput to an JSON string
   *
   * @return JSON string
   */
