...
public class PullRequestTarget {
  ...
  private PullRequestTargetMergeMetadata mergeMetadata;

  public PullRequestTarget() {
  }

  public PullRequestTarget repositoryName(String repositoryName) {
  ...
  public PullRequestTarget sourceReference(String sourceReference) {
  ...
  public PullRequestTarget destinationReference(String destinationReference) {
  ...
  public PullRequestTarget destinationCommit(String destinationCommit) {
  ...
  public PullRequestTarget sourceCommit(String sourceCommit) {
  ...
  public PullRequestTarget mergeBase(String mergeBase) {
  ...
  public PullRequestTarget mergeMetadata(PullRequestTargetMergeMetadata mergeMetadata) {
   ...
   */
  @javax.annotation.Nullable
  public PullRequestTargetMergeMetadata getMergeMetadata() {
    return mergeMetadata;
  }

  public void setMergeMetadata(PullRequestTargetMergeMetadata mergeMetadata) {
    this.mergeMetadata = mergeMetadata;
  }
  ...
  public boolean equals(Object o) {
    ...
    PullRequestTarget pullRequestTarget = (PullRequestTarget) o;
    return Objects.equals(this.repositoryName, pullRequestTarget.repositoryName) &&
        Objects.equals(this.sourceReference, pullRequestTarget.sourceReference) &&
        Objects.equals(this.destinationReference, pullRequestTarget.destinationReference) &&
        Objects.equals(this.destinationCommit, pullRequestTarget.destinationCommit) &&
        Objects.equals(this.sourceCommit, pullRequestTarget.sourceCommit) &&
        Objects.equals(this.mergeBase, pullRequestTarget.mergeBase) &&
        Objects.equals(this.mergeMetadata, pullRequestTarget.mergeMetadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, sourceReference, destinationReference, destinationCommit, sourceCommit, mergeBase, mergeMetadata);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PullRequestTarget {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PullRequestTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PullRequestTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PullRequestTarget is not found in the empty JSON string", PullRequestTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PullRequestTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PullRequestTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("mergeMetadata") != null && !jsonObj.get("mergeMetadata").isJsonNull()) {
        PullRequestTargetMergeMetadata.validateJsonElement(jsonObj.get("mergeMetadata"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PullRequestTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PullRequestTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PullRequestTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PullRequestTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<PullRequestTarget>() {
           @Override
           public void write(JsonWriter out, PullRequestTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PullRequestTarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PullRequestTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PullRequestTarget
   * @throws IOException if the JSON string is invalid with respect to PullRequestTarget
   */
  public static PullRequestTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PullRequestTarget.class);
  }

  /**
   * Convert an instance of PullRequestTarget to an JSON string
   *
   * @return JSON string
   */
