...
public class GetCommentInput {
  ...
  public GetCommentInput commentId(String commentId) {
  ...
  public boolean equals(Object o) {
    ...
    GetCommentInput getCommentInput = (GetCommentInput) o;
    return Objects.equals(this.commentId, getCommentInput.commentId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetCommentInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCommentInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCommentInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCommentInput is not found in the empty JSON string", GetCommentInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCommentInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCommentInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetCommentInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCommentInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCommentInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCommentInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCommentInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCommentInput>() {
           @Override
           public void write(JsonWriter out, GetCommentInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCommentInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCommentInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCommentInput
   * @throws IOException if the JSON string is invalid with respect to GetCommentInput
   */
  public static GetCommentInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCommentInput.class);
  }

  /**
   * Convert an instance of GetCommentInput to an JSON string
   *
   * @return JSON string
   */
