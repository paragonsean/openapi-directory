...
public class GetPullRequestInput {
  ...
  public GetPullRequestInput() {
  }

  public GetPullRequestInput pullRequestId(String pullRequestId) {
  ...
  public boolean equals(Object o) {
    ...
    GetPullRequestInput getPullRequestInput = (GetPullRequestInput) o;
    return Objects.equals(this.pullRequestId, getPullRequestInput.pullRequestId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetPullRequestInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPullRequestInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPullRequestInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPullRequestInput is not found in the empty JSON string", GetPullRequestInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPullRequestInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPullRequestInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetPullRequestInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPullRequestInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPullRequestInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPullRequestInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPullRequestInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPullRequestInput>() {
           @Override
           public void write(JsonWriter out, GetPullRequestInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPullRequestInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPullRequestInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPullRequestInput
   * @throws IOException if the JSON string is invalid with respect to GetPullRequestInput
   */
  public static GetPullRequestInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPullRequestInput.class);
  }

  /**
   * Convert an instance of GetPullRequestInput to an JSON string
   *
   * @return JSON string
   */
