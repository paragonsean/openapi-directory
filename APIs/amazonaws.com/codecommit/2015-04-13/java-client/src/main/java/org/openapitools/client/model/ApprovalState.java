 ...
 */
@JsonAdapter(ApprovalState.Adapter.class)
public enum ApprovalState {
  ...
  public static class Adapter extends TypeAdapter<ApprovalState> {
    @Override
    public void write(final JsonWriter jsonWriter, final ApprovalState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ApprovalState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ApprovalState.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ApprovalState.fromValue(value);
  }
}
