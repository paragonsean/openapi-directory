...
public class UpdatePullRequestApprovalRuleContentInput {
  ...
  public static final String SERIALIZED_NAME_EXISTING_RULE_CONTENT_SHA256 = "existingRuleContentSha256";
  @SerializedName(SERIALIZED_NAME_EXISTING_RULE_CONTENT_SHA256)
  private String existingRuleContentSha256;

  public static final String SERIALIZED_NAME_NEW_RULE_CONTENT = "newRuleContent";
  @SerializedName(SERIALIZED_NAME_NEW_RULE_CONTENT)
  private String newRuleContent;

  public UpdatePullRequestApprovalRuleContentInput() {
  }

  public UpdatePullRequestApprovalRuleContentInput pullRequestId(String pullRequestId) {
  ...
  public UpdatePullRequestApprovalRuleContentInput approvalRuleName(String approvalRuleName) {
  ...
  public UpdatePullRequestApprovalRuleContentInput existingRuleContentSha256(String existingRuleContentSha256) {
    this.existingRuleContentSha256 = existingRuleContentSha256;
    return this;
  }

  /**
   * Get existingRuleContentSha256
  ...
  public UpdatePullRequestApprovalRuleContentInput newRuleContent(String newRuleContent) {
  ...
  public boolean equals(Object o) {
    ...
    UpdatePullRequestApprovalRuleContentInput updatePullRequestApprovalRuleContentInput = (UpdatePullRequestApprovalRuleContentInput) o;
    return Objects.equals(this.pullRequestId, updatePullRequestApprovalRuleContentInput.pullRequestId) &&
        Objects.equals(this.approvalRuleName, updatePullRequestApprovalRuleContentInput.approvalRuleName) &&
        Objects.equals(this.existingRuleContentSha256, updatePullRequestApprovalRuleContentInput.existingRuleContentSha256) &&
        Objects.equals(this.newRuleContent, updatePullRequestApprovalRuleContentInput.newRuleContent);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pullRequestId, approvalRuleName, existingRuleContentSha256, newRuleContent);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdatePullRequestApprovalRuleContentInput {\n");
    ...
    sb.append("    existingRuleContentSha256: ").append(toIndentedString(existingRuleContentSha256)).append("\n");
    sb.append("    newRuleContent: ").append(toIndentedString(newRuleContent)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("existingRuleContentSha256");
    openapiFields.add("newRuleContent");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("pullRequestId");
    openapiRequiredFields.add("approvalRuleName");
    openapiRequiredFields.add("newRuleContent");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePullRequestApprovalRuleContentInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePullRequestApprovalRuleContentInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePullRequestApprovalRuleContentInput is not found in the empty JSON string", UpdatePullRequestApprovalRuleContentInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePullRequestApprovalRuleContentInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePullRequestApprovalRuleContentInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdatePullRequestApprovalRuleContentInput.openapiRequiredFields) {
      ...
      // validate the required field `approvalRuleName`
      String.validateJsonElement(jsonObj.get("approvalRuleName"));
      // validate the optional field `existingRuleContentSha256`
      if (jsonObj.get("existingRuleContentSha256") != null && !jsonObj.get("existingRuleContentSha256").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("existingRuleContentSha256"));
      }
      // validate the required field `newRuleContent`
      String.validateJsonElement(jsonObj.get("newRuleContent"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePullRequestApprovalRuleContentInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePullRequestApprovalRuleContentInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePullRequestApprovalRuleContentInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePullRequestApprovalRuleContentInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePullRequestApprovalRuleContentInput>() {
           @Override
           public void write(JsonWriter out, UpdatePullRequestApprovalRuleContentInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePullRequestApprovalRuleContentInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePullRequestApprovalRuleContentInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePullRequestApprovalRuleContentInput
   * @throws IOException if the JSON string is invalid with respect to UpdatePullRequestApprovalRuleContentInput
   */
  public static UpdatePullRequestApprovalRuleContentInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePullRequestApprovalRuleContentInput.class);
  }

  /**
   * Convert an instance of UpdatePullRequestApprovalRuleContentInput to an JSON string
   *
   * @return JSON string
   */
