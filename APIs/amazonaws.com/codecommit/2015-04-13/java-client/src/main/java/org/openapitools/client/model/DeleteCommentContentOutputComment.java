...
public class DeleteCommentContentOutputComment {
  ...
  public DeleteCommentContentOutputComment() {
  }

  public DeleteCommentContentOutputComment commentId(String commentId) {
  ...
  public DeleteCommentContentOutputComment content(String content) {
  ...
  public DeleteCommentContentOutputComment inReplyTo(String inReplyTo) {
  ...
  public DeleteCommentContentOutputComment creationDate(OffsetDateTime creationDate) {
  ...
  public DeleteCommentContentOutputComment lastModifiedDate(OffsetDateTime lastModifiedDate) {
  ...
  public DeleteCommentContentOutputComment authorArn(String authorArn) {
  ...
  public DeleteCommentContentOutputComment deleted(Boolean deleted) {
  ...
  public DeleteCommentContentOutputComment clientRequestToken(String clientRequestToken) {
  ...
  public DeleteCommentContentOutputComment callerReactions(List callerReactions) {
  ...
  public DeleteCommentContentOutputComment reactionCounts(Map reactionCounts) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteCommentContentOutputComment deleteCommentContentOutputComment = (DeleteCommentContentOutputComment) o;
    return Objects.equals(this.commentId, deleteCommentContentOutputComment.commentId) &&
        Objects.equals(this.content, deleteCommentContentOutputComment.content) &&
        Objects.equals(this.inReplyTo, deleteCommentContentOutputComment.inReplyTo) &&
        Objects.equals(this.creationDate, deleteCommentContentOutputComment.creationDate) &&
        Objects.equals(this.lastModifiedDate, deleteCommentContentOutputComment.lastModifiedDate) &&
        Objects.equals(this.authorArn, deleteCommentContentOutputComment.authorArn) &&
        Objects.equals(this.deleted, deleteCommentContentOutputComment.deleted) &&
        Objects.equals(this.clientRequestToken, deleteCommentContentOutputComment.clientRequestToken) &&
        Objects.equals(this.callerReactions, deleteCommentContentOutputComment.callerReactions) &&
        Objects.equals(this.reactionCounts, deleteCommentContentOutputComment.reactionCounts);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteCommentContentOutputComment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteCommentContentOutputComment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteCommentContentOutputComment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteCommentContentOutputComment is not found in the empty JSON string", DeleteCommentContentOutputComment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteCommentContentOutputComment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteCommentContentOutputComment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteCommentContentOutputComment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteCommentContentOutputComment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteCommentContentOutputComment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteCommentContentOutputComment.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteCommentContentOutputComment>() {
           @Override
           public void write(JsonWriter out, DeleteCommentContentOutputComment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteCommentContentOutputComment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteCommentContentOutputComment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteCommentContentOutputComment
   * @throws IOException if the JSON string is invalid with respect to DeleteCommentContentOutputComment
   */
  public static DeleteCommentContentOutputComment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteCommentContentOutputComment.class);
  }

  /**
   * Convert an instance of DeleteCommentContentOutputComment to an JSON string
   *
   * @return JSON string
   */
