...
import org.openapitools.client.model.GetApprovalRuleTemplateOutputApprovalRuleTemplate;
...
public class GetApprovalRuleTemplateOutput {
  ...
  private GetApprovalRuleTemplateOutputApprovalRuleTemplate approvalRuleTemplate;

  public GetApprovalRuleTemplateOutput() {
  }

  public GetApprovalRuleTemplateOutput approvalRuleTemplate(GetApprovalRuleTemplateOutputApprovalRuleTemplate approvalRuleTemplate) {
  ...
  public GetApprovalRuleTemplateOutputApprovalRuleTemplate getApprovalRuleTemplate() {
    return approvalRuleTemplate;
  }

  public void setApprovalRuleTemplate(GetApprovalRuleTemplateOutputApprovalRuleTemplate approvalRuleTemplate) {
    this.approvalRuleTemplate = approvalRuleTemplate;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetApprovalRuleTemplateOutput getApprovalRuleTemplateOutput = (GetApprovalRuleTemplateOutput) o;
    return Objects.equals(this.approvalRuleTemplate, getApprovalRuleTemplateOutput.approvalRuleTemplate);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetApprovalRuleTemplateOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetApprovalRuleTemplateOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetApprovalRuleTemplateOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetApprovalRuleTemplateOutput is not found in the empty JSON string", GetApprovalRuleTemplateOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetApprovalRuleTemplateOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetApprovalRuleTemplateOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetApprovalRuleTemplateOutput.openapiRequiredFields) {
      ...
      GetApprovalRuleTemplateOutputApprovalRuleTemplate.validateJsonElement(jsonObj.get("approvalRuleTemplate"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetApprovalRuleTemplateOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetApprovalRuleTemplateOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetApprovalRuleTemplateOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetApprovalRuleTemplateOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetApprovalRuleTemplateOutput>() {
           @Override
           public void write(JsonWriter out, GetApprovalRuleTemplateOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetApprovalRuleTemplateOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetApprovalRuleTemplateOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetApprovalRuleTemplateOutput
   * @throws IOException if the JSON string is invalid with respect to GetApprovalRuleTemplateOutput
   */
  public static GetApprovalRuleTemplateOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetApprovalRuleTemplateOutput.class);
  }

  /**
   * Convert an instance of GetApprovalRuleTemplateOutput to an JSON string
   *
   * @return JSON string
   */
