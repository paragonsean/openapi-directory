...
public class MergeHunkDestination {
  ...
  public static final String SERIALIZED_NAME_HUNK_CONTENT = "hunkContent";
  @SerializedName(SERIALIZED_NAME_HUNK_CONTENT)
  private String hunkContent;

  public MergeHunkDestination() {
  }

  public MergeHunkDestination startLine(Integer startLine) {
  ...
  public MergeHunkDestination endLine(Integer endLine) {
  ...
  public MergeHunkDestination hunkContent(String hunkContent) {
  ...
  public boolean equals(Object o) {
    ...
    MergeHunkDestination mergeHunkDestination = (MergeHunkDestination) o;
    return Objects.equals(this.startLine, mergeHunkDestination.startLine) &&
        Objects.equals(this.endLine, mergeHunkDestination.endLine) &&
        Objects.equals(this.hunkContent, mergeHunkDestination.hunkContent);
  }

  @Override
  public int hashCode() {
    return Objects.hash(startLine, endLine, hunkContent);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MergeHunkDestination {\n");
    sb.append("    startLine: ").append(toIndentedString(startLine)).append("\n");
    sb.append("    endLine: ").append(toIndentedString(endLine)).append("\n");
    sb.append("    hunkContent: ").append(toIndentedString(hunkContent)).append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MergeHunkDestination
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MergeHunkDestination.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MergeHunkDestination is not found in the empty JSON string", MergeHunkDestination.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MergeHunkDestination.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MergeHunkDestination` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `hunkContent`
      if (jsonObj.get("hunkContent") != null && !jsonObj.get("hunkContent").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("hunkContent"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MergeHunkDestination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MergeHunkDestination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MergeHunkDestination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MergeHunkDestination.class));

       return (TypeAdapter<T>) new TypeAdapter<MergeHunkDestination>() {
           @Override
           public void write(JsonWriter out, MergeHunkDestination value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MergeHunkDestination read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MergeHunkDestination given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MergeHunkDestination
   * @throws IOException if the JSON string is invalid with respect to MergeHunkDestination
   */
  public static MergeHunkDestination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MergeHunkDestination.class);
  }

  /**
   * Convert an instance of MergeHunkDestination to an JSON string
   *
   * @return JSON string
   */
