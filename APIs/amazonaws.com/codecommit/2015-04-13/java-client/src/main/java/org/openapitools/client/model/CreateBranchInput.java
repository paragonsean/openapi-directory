...
public class CreateBranchInput {
  ...
  public CreateBranchInput repositoryName(String repositoryName) {
  ...
  public CreateBranchInput branchName(String branchName) {
  ...
  public CreateBranchInput commitId(String commitId) {
  ...
  public boolean equals(Object o) {
    ...
    CreateBranchInput createBranchInput = (CreateBranchInput) o;
    return Objects.equals(this.repositoryName, createBranchInput.repositoryName) &&
        Objects.equals(this.branchName, createBranchInput.branchName) &&
        Objects.equals(this.commitId, createBranchInput.commitId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, branchName, commitId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateBranchInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateBranchInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateBranchInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateBranchInput is not found in the empty JSON string", CreateBranchInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateBranchInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateBranchInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateBranchInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateBranchInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateBranchInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateBranchInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateBranchInput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateBranchInput>() {
           @Override
           public void write(JsonWriter out, CreateBranchInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateBranchInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateBranchInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateBranchInput
   * @throws IOException if the JSON string is invalid with respect to CreateBranchInput
   */
  public static CreateBranchInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateBranchInput.class);
  }

  /**
   * Convert an instance of CreateBranchInput to an JSON string
   *
   * @return JSON string
   */
