...
public class ListAssociatedApprovalRuleTemplatesForRepositoryInput {
  ...
  public ListAssociatedApprovalRuleTemplatesForRepositoryInput() {
  }

  public ListAssociatedApprovalRuleTemplatesForRepositoryInput repositoryName(String repositoryName) {
  ...
  public ListAssociatedApprovalRuleTemplatesForRepositoryInput nextToken(String nextToken) {
  ...
  public ListAssociatedApprovalRuleTemplatesForRepositoryInput maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    ListAssociatedApprovalRuleTemplatesForRepositoryInput listAssociatedApprovalRuleTemplatesForRepositoryInput = (ListAssociatedApprovalRuleTemplatesForRepositoryInput) o;
    return Objects.equals(this.repositoryName, listAssociatedApprovalRuleTemplatesForRepositoryInput.repositoryName) &&
        Objects.equals(this.nextToken, listAssociatedApprovalRuleTemplatesForRepositoryInput.nextToken) &&
        Objects.equals(this.maxResults, listAssociatedApprovalRuleTemplatesForRepositoryInput.maxResults);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, nextToken, maxResults);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListAssociatedApprovalRuleTemplatesForRepositoryInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAssociatedApprovalRuleTemplatesForRepositoryInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAssociatedApprovalRuleTemplatesForRepositoryInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAssociatedApprovalRuleTemplatesForRepositoryInput is not found in the empty JSON string", ListAssociatedApprovalRuleTemplatesForRepositoryInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAssociatedApprovalRuleTemplatesForRepositoryInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAssociatedApprovalRuleTemplatesForRepositoryInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListAssociatedApprovalRuleTemplatesForRepositoryInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAssociatedApprovalRuleTemplatesForRepositoryInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAssociatedApprovalRuleTemplatesForRepositoryInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAssociatedApprovalRuleTemplatesForRepositoryInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAssociatedApprovalRuleTemplatesForRepositoryInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAssociatedApprovalRuleTemplatesForRepositoryInput>() {
           @Override
           public void write(JsonWriter out, ListAssociatedApprovalRuleTemplatesForRepositoryInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAssociatedApprovalRuleTemplatesForRepositoryInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAssociatedApprovalRuleTemplatesForRepositoryInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAssociatedApprovalRuleTemplatesForRepositoryInput
   * @throws IOException if the JSON string is invalid with respect to ListAssociatedApprovalRuleTemplatesForRepositoryInput
   */
  public static ListAssociatedApprovalRuleTemplatesForRepositoryInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAssociatedApprovalRuleTemplatesForRepositoryInput.class);
  }

  /**
   * Convert an instance of ListAssociatedApprovalRuleTemplatesForRepositoryInput to an JSON string
   *
   * @return JSON string
   */
