...
import org.openapitools.client.model.MergePullRequestByFastForwardOutputPullRequest;
...
public class MergePullRequestByFastForwardOutput {
  ...
  private MergePullRequestByFastForwardOutputPullRequest pullRequest;

  public MergePullRequestByFastForwardOutput() {
  }

  public MergePullRequestByFastForwardOutput pullRequest(MergePullRequestByFastForwardOutputPullRequest pullRequest) {
  ...
  public MergePullRequestByFastForwardOutputPullRequest getPullRequest() {
    return pullRequest;
  }

  public void setPullRequest(MergePullRequestByFastForwardOutputPullRequest pullRequest) {
    this.pullRequest = pullRequest;
  }
  ...
  public boolean equals(Object o) {
    ...
    MergePullRequestByFastForwardOutput mergePullRequestByFastForwardOutput = (MergePullRequestByFastForwardOutput) o;
    return Objects.equals(this.pullRequest, mergePullRequestByFastForwardOutput.pullRequest);
  }
  ...
  public String toString() {
    ...
    sb.append("class MergePullRequestByFastForwardOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MergePullRequestByFastForwardOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MergePullRequestByFastForwardOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MergePullRequestByFastForwardOutput is not found in the empty JSON string", MergePullRequestByFastForwardOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MergePullRequestByFastForwardOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MergePullRequestByFastForwardOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `pullRequest`
      if (jsonObj.get("pullRequest") != null && !jsonObj.get("pullRequest").isJsonNull()) {
        MergePullRequestByFastForwardOutputPullRequest.validateJsonElement(jsonObj.get("pullRequest"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MergePullRequestByFastForwardOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MergePullRequestByFastForwardOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MergePullRequestByFastForwardOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MergePullRequestByFastForwardOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<MergePullRequestByFastForwardOutput>() {
           @Override
           public void write(JsonWriter out, MergePullRequestByFastForwardOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MergePullRequestByFastForwardOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MergePullRequestByFastForwardOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MergePullRequestByFastForwardOutput
   * @throws IOException if the JSON string is invalid with respect to MergePullRequestByFastForwardOutput
   */
  public static MergePullRequestByFastForwardOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MergePullRequestByFastForwardOutput.class);
  }

  /**
   * Convert an instance of MergePullRequestByFastForwardOutput to an JSON string
   *
   * @return JSON string
   */
