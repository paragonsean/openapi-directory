...
public class BatchGetCommitsError {
  ...
  public BatchGetCommitsError commitId(String commitId) {
  ...
  public BatchGetCommitsError errorCode(String errorCode) {
  ...
  public BatchGetCommitsError errorMessage(String errorMessage) {
  ...
  public boolean equals(Object o) {
    ...
    BatchGetCommitsError batchGetCommitsError = (BatchGetCommitsError) o;
    return Objects.equals(this.commitId, batchGetCommitsError.commitId) &&
        Objects.equals(this.errorCode, batchGetCommitsError.errorCode) &&
        Objects.equals(this.errorMessage, batchGetCommitsError.errorMessage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(commitId, errorCode, errorMessage);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BatchGetCommitsError {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchGetCommitsError
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchGetCommitsError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchGetCommitsError is not found in the empty JSON string", BatchGetCommitsError.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchGetCommitsError.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchGetCommitsError` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchGetCommitsError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchGetCommitsError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchGetCommitsError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchGetCommitsError.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchGetCommitsError>() {
           @Override
           public void write(JsonWriter out, BatchGetCommitsError value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchGetCommitsError read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchGetCommitsError given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchGetCommitsError
   * @throws IOException if the JSON string is invalid with respect to BatchGetCommitsError
   */
  public static BatchGetCommitsError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchGetCommitsError.class);
  }

  /**
   * Convert an instance of BatchGetCommitsError to an JSON string
   *
   * @return JSON string
   */
