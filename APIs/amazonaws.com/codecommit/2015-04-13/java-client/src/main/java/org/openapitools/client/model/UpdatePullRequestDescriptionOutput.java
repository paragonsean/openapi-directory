...
import org.openapitools.client.model.UpdatePullRequestDescriptionOutputPullRequest;
...
public class UpdatePullRequestDescriptionOutput {
  ...
  private UpdatePullRequestDescriptionOutputPullRequest pullRequest;

  public UpdatePullRequestDescriptionOutput() {
  }

  public UpdatePullRequestDescriptionOutput pullRequest(UpdatePullRequestDescriptionOutputPullRequest pullRequest) {
  ...
  public UpdatePullRequestDescriptionOutputPullRequest getPullRequest() {
    return pullRequest;
  }

  public void setPullRequest(UpdatePullRequestDescriptionOutputPullRequest pullRequest) {
    this.pullRequest = pullRequest;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdatePullRequestDescriptionOutput updatePullRequestDescriptionOutput = (UpdatePullRequestDescriptionOutput) o;
    return Objects.equals(this.pullRequest, updatePullRequestDescriptionOutput.pullRequest);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdatePullRequestDescriptionOutput {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("pullRequest");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePullRequestDescriptionOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePullRequestDescriptionOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePullRequestDescriptionOutput is not found in the empty JSON string", UpdatePullRequestDescriptionOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePullRequestDescriptionOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePullRequestDescriptionOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdatePullRequestDescriptionOutput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `pullRequest`
      UpdatePullRequestDescriptionOutputPullRequest.validateJsonElement(jsonObj.get("pullRequest"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePullRequestDescriptionOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePullRequestDescriptionOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePullRequestDescriptionOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePullRequestDescriptionOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePullRequestDescriptionOutput>() {
           @Override
           public void write(JsonWriter out, UpdatePullRequestDescriptionOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePullRequestDescriptionOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePullRequestDescriptionOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePullRequestDescriptionOutput
   * @throws IOException if the JSON string is invalid with respect to UpdatePullRequestDescriptionOutput
   */
  public static UpdatePullRequestDescriptionOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePullRequestDescriptionOutput.class);
  }

  /**
   * Convert an instance of UpdatePullRequestDescriptionOutput to an JSON string
   *
   * @return JSON string
   */
