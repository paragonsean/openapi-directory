...
import org.openapitools.client.model.GetCommentOutputComment;
...
public class GetCommentOutput {
  ...
  private GetCommentOutputComment comment;

  public GetCommentOutput() {
  }

  public GetCommentOutput comment(GetCommentOutputComment comment) {
  ...
  public GetCommentOutputComment getComment() {
    return comment;
  }

  public void setComment(GetCommentOutputComment comment) {
    this.comment = comment;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetCommentOutput getCommentOutput = (GetCommentOutput) o;
    return Objects.equals(this.comment, getCommentOutput.comment);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetCommentOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCommentOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCommentOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCommentOutput is not found in the empty JSON string", GetCommentOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCommentOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCommentOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `comment`
      if (jsonObj.get("comment") != null && !jsonObj.get("comment").isJsonNull()) {
        GetCommentOutputComment.validateJsonElement(jsonObj.get("comment"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCommentOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCommentOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCommentOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCommentOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCommentOutput>() {
           @Override
           public void write(JsonWriter out, GetCommentOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCommentOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCommentOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCommentOutput
   * @throws IOException if the JSON string is invalid with respect to GetCommentOutput
   */
  public static GetCommentOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCommentOutput.class);
  }

  /**
   * Convert an instance of GetCommentOutput to an JSON string
   *
   * @return JSON string
   */
