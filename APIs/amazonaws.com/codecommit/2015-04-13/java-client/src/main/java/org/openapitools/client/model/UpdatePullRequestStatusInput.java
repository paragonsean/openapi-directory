...
public class UpdatePullRequestStatusInput {
  ...
  public UpdatePullRequestStatusInput() {
  }

  public UpdatePullRequestStatusInput pullRequestId(String pullRequestId) {
  ...
  public UpdatePullRequestStatusInput pullRequestStatus(PullRequestStatusEnum pullRequestStatus) {
  ...
  public boolean equals(Object o) {
    ...
    UpdatePullRequestStatusInput updatePullRequestStatusInput = (UpdatePullRequestStatusInput) o;
    return Objects.equals(this.pullRequestId, updatePullRequestStatusInput.pullRequestId) &&
        Objects.equals(this.pullRequestStatus, updatePullRequestStatusInput.pullRequestStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pullRequestId, pullRequestStatus);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdatePullRequestStatusInput {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("pullRequestStatus");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePullRequestStatusInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePullRequestStatusInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePullRequestStatusInput is not found in the empty JSON string", UpdatePullRequestStatusInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePullRequestStatusInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePullRequestStatusInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdatePullRequestStatusInput.openapiRequiredFields) {
      ...
      // validate the required field `pullRequestStatus`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePullRequestStatusInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePullRequestStatusInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePullRequestStatusInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePullRequestStatusInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePullRequestStatusInput>() {
           @Override
           public void write(JsonWriter out, UpdatePullRequestStatusInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePullRequestStatusInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePullRequestStatusInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePullRequestStatusInput
   * @throws IOException if the JSON string is invalid with respect to UpdatePullRequestStatusInput
   */
  public static UpdatePullRequestStatusInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePullRequestStatusInput.class);
  }

  /**
   * Convert an instance of UpdatePullRequestStatusInput to an JSON string
   *
   * @return JSON string
   */
