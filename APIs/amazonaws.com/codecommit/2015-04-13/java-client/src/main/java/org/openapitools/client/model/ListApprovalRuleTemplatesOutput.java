...
public class ListApprovalRuleTemplatesOutput {
  ...
  public ListApprovalRuleTemplatesOutput approvalRuleTemplateNames(List approvalRuleTemplateNames) {
  ...
  public ListApprovalRuleTemplatesOutput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListApprovalRuleTemplatesOutput listApprovalRuleTemplatesOutput = (ListApprovalRuleTemplatesOutput) o;
    return Objects.equals(this.approvalRuleTemplateNames, listApprovalRuleTemplatesOutput.approvalRuleTemplateNames) &&
        Objects.equals(this.nextToken, listApprovalRuleTemplatesOutput.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListApprovalRuleTemplatesOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListApprovalRuleTemplatesOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListApprovalRuleTemplatesOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListApprovalRuleTemplatesOutput is not found in the empty JSON string", ListApprovalRuleTemplatesOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListApprovalRuleTemplatesOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListApprovalRuleTemplatesOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListApprovalRuleTemplatesOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListApprovalRuleTemplatesOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListApprovalRuleTemplatesOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListApprovalRuleTemplatesOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListApprovalRuleTemplatesOutput>() {
           @Override
           public void write(JsonWriter out, ListApprovalRuleTemplatesOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListApprovalRuleTemplatesOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListApprovalRuleTemplatesOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListApprovalRuleTemplatesOutput
   * @throws IOException if the JSON string is invalid with respect to ListApprovalRuleTemplatesOutput
   */
  public static ListApprovalRuleTemplatesOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListApprovalRuleTemplatesOutput.class);
  }

  /**
   * Convert an instance of ListApprovalRuleTemplatesOutput to an JSON string
   *
   * @return JSON string
   */
