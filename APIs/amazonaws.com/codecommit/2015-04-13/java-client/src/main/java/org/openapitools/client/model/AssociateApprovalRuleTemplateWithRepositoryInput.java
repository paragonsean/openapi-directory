...
public class AssociateApprovalRuleTemplateWithRepositoryInput {
  ...
  public AssociateApprovalRuleTemplateWithRepositoryInput() {
  }

  public AssociateApprovalRuleTemplateWithRepositoryInput approvalRuleTemplateName(String approvalRuleTemplateName) {
  ...
  public AssociateApprovalRuleTemplateWithRepositoryInput repositoryName(String repositoryName) {
  ...
  public boolean equals(Object o) {
    ...
    AssociateApprovalRuleTemplateWithRepositoryInput associateApprovalRuleTemplateWithRepositoryInput = (AssociateApprovalRuleTemplateWithRepositoryInput) o;
    return Objects.equals(this.approvalRuleTemplateName, associateApprovalRuleTemplateWithRepositoryInput.approvalRuleTemplateName) &&
        Objects.equals(this.repositoryName, associateApprovalRuleTemplateWithRepositoryInput.repositoryName);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssociateApprovalRuleTemplateWithRepositoryInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssociateApprovalRuleTemplateWithRepositoryInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssociateApprovalRuleTemplateWithRepositoryInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssociateApprovalRuleTemplateWithRepositoryInput is not found in the empty JSON string", AssociateApprovalRuleTemplateWithRepositoryInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssociateApprovalRuleTemplateWithRepositoryInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssociateApprovalRuleTemplateWithRepositoryInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AssociateApprovalRuleTemplateWithRepositoryInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssociateApprovalRuleTemplateWithRepositoryInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssociateApprovalRuleTemplateWithRepositoryInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssociateApprovalRuleTemplateWithRepositoryInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssociateApprovalRuleTemplateWithRepositoryInput.class));

       return (TypeAdapter<T>) new TypeAdapter<AssociateApprovalRuleTemplateWithRepositoryInput>() {
           @Override
           public void write(JsonWriter out, AssociateApprovalRuleTemplateWithRepositoryInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssociateApprovalRuleTemplateWithRepositoryInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssociateApprovalRuleTemplateWithRepositoryInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssociateApprovalRuleTemplateWithRepositoryInput
   * @throws IOException if the JSON string is invalid with respect to AssociateApprovalRuleTemplateWithRepositoryInput
   */
  public static AssociateApprovalRuleTemplateWithRepositoryInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssociateApprovalRuleTemplateWithRepositoryInput.class);
  }

  /**
   * Convert an instance of AssociateApprovalRuleTemplateWithRepositoryInput to an JSON string
   *
   * @return JSON string
   */
