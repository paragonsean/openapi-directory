...
public class PostCommentForComparedCommitInput {
  ...
  private PostCommentForComparedCommitInputLocation location;
  ...
  public PostCommentForComparedCommitInput() {
  }

  public PostCommentForComparedCommitInput repositoryName(String repositoryName) {
  ...
  public PostCommentForComparedCommitInput beforeCommitId(String beforeCommitId) {
  ...
  public PostCommentForComparedCommitInput afterCommitId(String afterCommitId) {
  ...
  public PostCommentForComparedCommitInput location(PostCommentForComparedCommitInputLocation location) {
   ...
   */
  @javax.annotation.Nullable
  public PostCommentForComparedCommitInputLocation getLocation() {
    return location;
  }

  public void setLocation(PostCommentForComparedCommitInputLocation location) {
    this.location = location;
  }


  public PostCommentForComparedCommitInput content(String content) {
  ...
  public PostCommentForComparedCommitInput clientRequestToken(String clientRequestToken) {
  ...
  public boolean equals(Object o) {
    ...
    PostCommentForComparedCommitInput postCommentForComparedCommitInput = (PostCommentForComparedCommitInput) o;
    return Objects.equals(this.repositoryName, postCommentForComparedCommitInput.repositoryName) &&
        Objects.equals(this.beforeCommitId, postCommentForComparedCommitInput.beforeCommitId) &&
        Objects.equals(this.afterCommitId, postCommentForComparedCommitInput.afterCommitId) &&
        Objects.equals(this.location, postCommentForComparedCommitInput.location) &&
        Objects.equals(this.content, postCommentForComparedCommitInput.content) &&
        Objects.equals(this.clientRequestToken, postCommentForComparedCommitInput.clientRequestToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, beforeCommitId, afterCommitId, location, content, clientRequestToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostCommentForComparedCommitInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostCommentForComparedCommitInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostCommentForComparedCommitInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostCommentForComparedCommitInput is not found in the empty JSON string", PostCommentForComparedCommitInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostCommentForComparedCommitInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostCommentForComparedCommitInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostCommentForComparedCommitInput.openapiRequiredFields) {
      ...
      if (jsonObj.get("location") != null && !jsonObj.get("location").isJsonNull()) {
        PostCommentForComparedCommitInputLocation.validateJsonElement(jsonObj.get("location"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostCommentForComparedCommitInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostCommentForComparedCommitInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostCommentForComparedCommitInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostCommentForComparedCommitInput.class));

       return (TypeAdapter<T>) new TypeAdapter<PostCommentForComparedCommitInput>() {
           @Override
           public void write(JsonWriter out, PostCommentForComparedCommitInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostCommentForComparedCommitInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostCommentForComparedCommitInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostCommentForComparedCommitInput
   * @throws IOException if the JSON string is invalid with respect to PostCommentForComparedCommitInput
   */
  public static PostCommentForComparedCommitInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostCommentForComparedCommitInput.class);
  }

  /**
   * Convert an instance of PostCommentForComparedCommitInput to an JSON string
   *
   * @return JSON string
   */
