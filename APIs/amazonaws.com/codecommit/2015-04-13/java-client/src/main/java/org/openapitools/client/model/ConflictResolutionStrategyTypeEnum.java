...
/**
 * Gets or Sets ConflictResolutionStrategyTypeEnum
 */
@JsonAdapter(ConflictResolutionStrategyTypeEnum.Adapter.class)
public enum ConflictResolutionStrategyTypeEnum {
  ...
  ConflictResolutionStrategyTypeEnum(String value) {
    this.value = value;
  }
  ...
  public static ConflictResolutionStrategyTypeEnum fromValue(String value) {
    for (ConflictResolutionStrategyTypeEnum b : ConflictResolutionStrategyTypeEnum.values()) {
  ...
  public static class Adapter extends TypeAdapter<ConflictResolutionStrategyTypeEnum> {
    @Override
    public void write(final JsonWriter jsonWriter, final ConflictResolutionStrategyTypeEnum enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ConflictResolutionStrategyTypeEnum read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ConflictResolutionStrategyTypeEnum.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ConflictResolutionStrategyTypeEnum.fromValue(value);
  }
}
