...
import org.openapitools.client.model.RelativeFileVersionEnum;
...
public class PostCommentForComparedCommitOutputLocation {
  public static final String SERIALIZED_NAME_FILE_PATH = "filePath";
  @SerializedName(SERIALIZED_NAME_FILE_PATH)
  private String filePath;

  public static final String SERIALIZED_NAME_FILE_POSITION = "filePosition";
  @SerializedName(SERIALIZED_NAME_FILE_POSITION)
  private Integer filePosition;

  public static final String SERIALIZED_NAME_RELATIVE_FILE_VERSION = "relativeFileVersion";
  @SerializedName(SERIALIZED_NAME_RELATIVE_FILE_VERSION)
  private RelativeFileVersionEnum relativeFileVersion;

  public PostCommentForComparedCommitOutputLocation() {
  }

  public PostCommentForComparedCommitOutputLocation filePath(String filePath) {
  ...
  public PostCommentForComparedCommitOutputLocation filePosition(Integer filePosition) {
  ...
  public PostCommentForComparedCommitOutputLocation relativeFileVersion(RelativeFileVersionEnum relativeFileVersion) {
    this.relativeFileVersion = relativeFileVersion;
    return this;
  }

  /**
   * Get relativeFileVersion
   * @return relativeFileVersion
   */
  @javax.annotation.Nullable
  public RelativeFileVersionEnum getRelativeFileVersion() {
    return relativeFileVersion;
  }
  ...
  public boolean equals(Object o) {
    ...
    PostCommentForComparedCommitOutputLocation postCommentForComparedCommitOutputLocation = (PostCommentForComparedCommitOutputLocation) o;
    return Objects.equals(this.filePath, postCommentForComparedCommitOutputLocation.filePath) &&
        Objects.equals(this.filePosition, postCommentForComparedCommitOutputLocation.filePosition) &&
        Objects.equals(this.relativeFileVersion, postCommentForComparedCommitOutputLocation.relativeFileVersion);
  }

  @Override
  public int hashCode() {
    return Objects.hash(filePath, filePosition, relativeFileVersion);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostCommentForComparedCommitOutputLocation {\n");
    sb.append("    filePath: ").append(toIndentedString(filePath)).append("\n");
    sb.append("    filePosition: ").append(toIndentedString(filePosition)).append("\n");
    sb.append("    relativeFileVersion: ").append(toIndentedString(relativeFileVersion)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("filePosition");
    openapiFields.add("relativeFileVersion");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostCommentForComparedCommitOutputLocation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostCommentForComparedCommitOutputLocation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostCommentForComparedCommitOutputLocation is not found in the empty JSON string", PostCommentForComparedCommitOutputLocation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostCommentForComparedCommitOutputLocation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostCommentForComparedCommitOutputLocation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("filePosition") != null && !jsonObj.get("filePosition").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("filePosition"));
      }
      // validate the optional field `relativeFileVersion`
      if (jsonObj.get("relativeFileVersion") != null && !jsonObj.get("relativeFileVersion").isJsonNull()) {
        RelativeFileVersionEnum.validateJsonElement(jsonObj.get("relativeFileVersion"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostCommentForComparedCommitOutputLocation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostCommentForComparedCommitOutputLocation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostCommentForComparedCommitOutputLocation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostCommentForComparedCommitOutputLocation.class));

       return (TypeAdapter<T>) new TypeAdapter<PostCommentForComparedCommitOutputLocation>() {
           @Override
           public void write(JsonWriter out, PostCommentForComparedCommitOutputLocation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostCommentForComparedCommitOutputLocation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostCommentForComparedCommitOutputLocation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostCommentForComparedCommitOutputLocation
   * @throws IOException if the JSON string is invalid with respect to PostCommentForComparedCommitOutputLocation
   */
  public static PostCommentForComparedCommitOutputLocation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostCommentForComparedCommitOutputLocation.class);
  }

  /**
   * Convert an instance of PostCommentForComparedCommitOutputLocation to an JSON string
   *
   * @return JSON string
   */
