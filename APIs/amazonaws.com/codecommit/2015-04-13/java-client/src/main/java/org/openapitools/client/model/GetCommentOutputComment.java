...
public class GetCommentOutputComment {
  ...
  public GetCommentOutputComment() {
  }

  public GetCommentOutputComment commentId(String commentId) {
  ...
  public GetCommentOutputComment content(String content) {
  ...
  public GetCommentOutputComment inReplyTo(String inReplyTo) {
  ...
  public GetCommentOutputComment creationDate(OffsetDateTime creationDate) {
  ...
  public GetCommentOutputComment lastModifiedDate(OffsetDateTime lastModifiedDate) {
  ...
  public GetCommentOutputComment authorArn(String authorArn) {
  ...
  public GetCommentOutputComment deleted(Boolean deleted) {
  ...
  public GetCommentOutputComment clientRequestToken(String clientRequestToken) {
  ...
  public GetCommentOutputComment callerReactions(List callerReactions) {
  ...
  public GetCommentOutputComment reactionCounts(Map reactionCounts) {
  ...
  public boolean equals(Object o) {
    ...
    GetCommentOutputComment getCommentOutputComment = (GetCommentOutputComment) o;
    return Objects.equals(this.commentId, getCommentOutputComment.commentId) &&
        Objects.equals(this.content, getCommentOutputComment.content) &&
        Objects.equals(this.inReplyTo, getCommentOutputComment.inReplyTo) &&
        Objects.equals(this.creationDate, getCommentOutputComment.creationDate) &&
        Objects.equals(this.lastModifiedDate, getCommentOutputComment.lastModifiedDate) &&
        Objects.equals(this.authorArn, getCommentOutputComment.authorArn) &&
        Objects.equals(this.deleted, getCommentOutputComment.deleted) &&
        Objects.equals(this.clientRequestToken, getCommentOutputComment.clientRequestToken) &&
        Objects.equals(this.callerReactions, getCommentOutputComment.callerReactions) &&
        Objects.equals(this.reactionCounts, getCommentOutputComment.reactionCounts);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetCommentOutputComment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCommentOutputComment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCommentOutputComment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCommentOutputComment is not found in the empty JSON string", GetCommentOutputComment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCommentOutputComment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCommentOutputComment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCommentOutputComment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCommentOutputComment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCommentOutputComment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCommentOutputComment.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCommentOutputComment>() {
           @Override
           public void write(JsonWriter out, GetCommentOutputComment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCommentOutputComment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCommentOutputComment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCommentOutputComment
   * @throws IOException if the JSON string is invalid with respect to GetCommentOutputComment
   */
  public static GetCommentOutputComment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCommentOutputComment.class);
  }

  /**
   * Convert an instance of GetCommentOutputComment to an JSON string
   *
   * @return JSON string
   */
