...
public class EvaluatePullRequestApprovalRulesOutputEvaluation {
  ...
  public static final String SERIALIZED_NAME_APPROVAL_RULES_SATISFIED = "approvalRulesSatisfied";
  @SerializedName(SERIALIZED_NAME_APPROVAL_RULES_SATISFIED)
  private List approvalRulesSatisfied;

  public static final String SERIALIZED_NAME_APPROVAL_RULES_NOT_SATISFIED = "approvalRulesNotSatisfied";
  @SerializedName(SERIALIZED_NAME_APPROVAL_RULES_NOT_SATISFIED)
  private List approvalRulesNotSatisfied;

  public EvaluatePullRequestApprovalRulesOutputEvaluation() {
  }

  public EvaluatePullRequestApprovalRulesOutputEvaluation approved(Boolean approved) {
  ...
  public EvaluatePullRequestApprovalRulesOutputEvaluation overridden(Boolean overridden) {
  ...
  public EvaluatePullRequestApprovalRulesOutputEvaluation approvalRulesSatisfied(List approvalRulesSatisfied) {
    this.approvalRulesSatisfied = approvalRulesSatisfied;
    return this;
  }

  /**
   * Get approvalRulesSatisfied
   * @return approvalRulesSatisfied
   */
  @javax.annotation.Nullable
  public List getApprovalRulesSatisfied() {
    return approvalRulesSatisfied;
  }

  public void setApprovalRulesSatisfied(List approvalRulesSatisfied) {
    this.approvalRulesSatisfied = approvalRulesSatisfied;
  }


  public EvaluatePullRequestApprovalRulesOutputEvaluation approvalRulesNotSatisfied(List approvalRulesNotSatisfied) {
    this.approvalRulesNotSatisfied = approvalRulesNotSatisfied;
    return this;
  }

  /**
   * Get approvalRulesNotSatisfied
   * @return approvalRulesNotSatisfied
   */
  @javax.annotation.Nullable
  public List getApprovalRulesNotSatisfied() {
    return approvalRulesNotSatisfied;
  }

  public void setApprovalRulesNotSatisfied(List approvalRulesNotSatisfied) {
    this.approvalRulesNotSatisfied = approvalRulesNotSatisfied;
  }
  ...
  public boolean equals(Object o) {
    ...
    EvaluatePullRequestApprovalRulesOutputEvaluation evaluatePullRequestApprovalRulesOutputEvaluation = (EvaluatePullRequestApprovalRulesOutputEvaluation) o;
    return Objects.equals(this.approved, evaluatePullRequestApprovalRulesOutputEvaluation.approved) &&
        Objects.equals(this.overridden, evaluatePullRequestApprovalRulesOutputEvaluation.overridden) &&
        Objects.equals(this.approvalRulesSatisfied, evaluatePullRequestApprovalRulesOutputEvaluation.approvalRulesSatisfied) &&
        Objects.equals(this.approvalRulesNotSatisfied, evaluatePullRequestApprovalRulesOutputEvaluation.approvalRulesNotSatisfied);
  }

  @Override
  public int hashCode() {
    return Objects.hash(approved, overridden, approvalRulesSatisfied, approvalRulesNotSatisfied);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EvaluatePullRequestApprovalRulesOutputEvaluation {\n");
    sb.append("    approved: ").append(toIndentedString(approved)).append("\n");
    sb.append("    overridden: ").append(toIndentedString(overridden)).append("\n");
    sb.append("    approvalRulesSatisfied: ").append(toIndentedString(approvalRulesSatisfied)).append("\n");
    sb.append("    approvalRulesNotSatisfied: ").append(toIndentedString(approvalRulesNotSatisfied)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("approvalRulesSatisfied");
    openapiFields.add("approvalRulesNotSatisfied");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EvaluatePullRequestApprovalRulesOutputEvaluation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EvaluatePullRequestApprovalRulesOutputEvaluation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EvaluatePullRequestApprovalRulesOutputEvaluation is not found in the empty JSON string", EvaluatePullRequestApprovalRulesOutputEvaluation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EvaluatePullRequestApprovalRulesOutputEvaluation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EvaluatePullRequestApprovalRulesOutputEvaluation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `approved`
      if (jsonObj.get("approved") != null && !jsonObj.get("approved").isJsonNull()) {
        Boolean.validateJsonElement(jsonObj.get("approved"));
      }
      // validate the optional field `overridden`
      if (jsonObj.get("overridden") != null && !jsonObj.get("overridden").isJsonNull()) {
        Boolean.validateJsonElement(jsonObj.get("overridden"));
      }
      // validate the optional field `approvalRulesSatisfied`
      if (jsonObj.get("approvalRulesSatisfied") != null && !jsonObj.get("approvalRulesSatisfied").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("approvalRulesSatisfied"));
      }
      // validate the optional field `approvalRulesNotSatisfied`
      if (jsonObj.get("approvalRulesNotSatisfied") != null && !jsonObj.get("approvalRulesNotSatisfied").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("approvalRulesNotSatisfied"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EvaluatePullRequestApprovalRulesOutputEvaluation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EvaluatePullRequestApprovalRulesOutputEvaluation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EvaluatePullRequestApprovalRulesOutputEvaluation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EvaluatePullRequestApprovalRulesOutputEvaluation.class));

       return (TypeAdapter<T>) new TypeAdapter<EvaluatePullRequestApprovalRulesOutputEvaluation>() {
           @Override
           public void write(JsonWriter out, EvaluatePullRequestApprovalRulesOutputEvaluation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EvaluatePullRequestApprovalRulesOutputEvaluation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EvaluatePullRequestApprovalRulesOutputEvaluation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EvaluatePullRequestApprovalRulesOutputEvaluation
   * @throws IOException if the JSON string is invalid with respect to EvaluatePullRequestApprovalRulesOutputEvaluation
   */
  public static EvaluatePullRequestApprovalRulesOutputEvaluation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EvaluatePullRequestApprovalRulesOutputEvaluation.class);
  }

  /**
   * Convert an instance of EvaluatePullRequestApprovalRulesOutputEvaluation to an JSON string
   *
   * @return JSON string
   */
