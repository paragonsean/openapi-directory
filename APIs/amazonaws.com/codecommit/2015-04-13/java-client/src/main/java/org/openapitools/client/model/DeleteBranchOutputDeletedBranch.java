...
public class DeleteBranchOutputDeletedBranch {
  ...
  public DeleteBranchOutputDeletedBranch() {
  }

  public DeleteBranchOutputDeletedBranch branchName(String branchName) {
  ...
  public DeleteBranchOutputDeletedBranch commitId(String commitId) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteBranchOutputDeletedBranch deleteBranchOutputDeletedBranch = (DeleteBranchOutputDeletedBranch) o;
    return Objects.equals(this.branchName, deleteBranchOutputDeletedBranch.branchName) &&
        Objects.equals(this.commitId, deleteBranchOutputDeletedBranch.commitId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteBranchOutputDeletedBranch {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteBranchOutputDeletedBranch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteBranchOutputDeletedBranch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteBranchOutputDeletedBranch is not found in the empty JSON string", DeleteBranchOutputDeletedBranch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteBranchOutputDeletedBranch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteBranchOutputDeletedBranch` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteBranchOutputDeletedBranch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteBranchOutputDeletedBranch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteBranchOutputDeletedBranch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteBranchOutputDeletedBranch.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteBranchOutputDeletedBranch>() {
           @Override
           public void write(JsonWriter out, DeleteBranchOutputDeletedBranch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteBranchOutputDeletedBranch read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteBranchOutputDeletedBranch given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteBranchOutputDeletedBranch
   * @throws IOException if the JSON string is invalid with respect to DeleteBranchOutputDeletedBranch
   */
  public static DeleteBranchOutputDeletedBranch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteBranchOutputDeletedBranch.class);
  }

  /**
   * Convert an instance of DeleteBranchOutputDeletedBranch to an JSON string
   *
   * @return JSON string
   */
