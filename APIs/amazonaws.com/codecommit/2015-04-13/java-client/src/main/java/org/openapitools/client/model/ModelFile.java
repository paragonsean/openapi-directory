...
public class ModelFile {
  ...
  private FileModeTypeEnum fileMode;

  public ModelFile() {
  }

  public ModelFile blobId(String blobId) {
    this.blobId = blobId;
    return this;
  }
  ...
  public ModelFile fileMode(FileModeTypeEnum fileMode) {
   ...
   */
  @javax.annotation.Nullable
  public FileModeTypeEnum getFileMode() {
    return fileMode;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.blobId, _file.blobId) &&
        Objects.equals(this.absolutePath, _file.absolutePath) &&
        Objects.equals(this.relativePath, _file.relativePath) &&
        Objects.equals(this.fileMode, _file.fileMode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(blobId, absolutePath, relativePath, fileMode);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `absolutePath`
      if (jsonObj.get("absolutePath") != null && !jsonObj.get("absolutePath").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("absolutePath"));
      }
      ...
      if (jsonObj.get("fileMode") != null && !jsonObj.get("fileMode").isJsonNull()) {
        FileModeTypeEnum.validateJsonElement(jsonObj.get("fileMode"));
      }
  }
