...
import org.openapitools.client.model.PostCommentForPullRequestInputLocation;
...
public class PostCommentForPullRequestInput {
  ...
  public static final String SERIALIZED_NAME_BEFORE_COMMIT_ID = "beforeCommitId";
  @SerializedName(SERIALIZED_NAME_BEFORE_COMMIT_ID)
  private String beforeCommitId;

  public static final String SERIALIZED_NAME_AFTER_COMMIT_ID = "afterCommitId";
  @SerializedName(SERIALIZED_NAME_AFTER_COMMIT_ID)
  private String afterCommitId;

  public static final String SERIALIZED_NAME_LOCATION = "location";
  @SerializedName(SERIALIZED_NAME_LOCATION)
  private PostCommentForPullRequestInputLocation location;
  ...
  public PostCommentForPullRequestInput() {
  }

  public PostCommentForPullRequestInput pullRequestId(String pullRequestId) {
  ...
  public PostCommentForPullRequestInput repositoryName(String repositoryName) {
  ...
  public PostCommentForPullRequestInput beforeCommitId(String beforeCommitId) {
  ...
  public PostCommentForPullRequestInput afterCommitId(String afterCommitId) {
  ...
  public PostCommentForPullRequestInput location(PostCommentForPullRequestInputLocation location) {
  ...
  public PostCommentForPullRequestInputLocation getLocation() {
    return location;
  }

  public void setLocation(PostCommentForPullRequestInputLocation location) {
    this.location = location;
  }


  public PostCommentForPullRequestInput content(String content) {
  ...
  public PostCommentForPullRequestInput clientRequestToken(String clientRequestToken) {
  ...
  public boolean equals(Object o) {
    ...
    PostCommentForPullRequestInput postCommentForPullRequestInput = (PostCommentForPullRequestInput) o;
    return Objects.equals(this.pullRequestId, postCommentForPullRequestInput.pullRequestId) &&
        Objects.equals(this.repositoryName, postCommentForPullRequestInput.repositoryName) &&
        Objects.equals(this.beforeCommitId, postCommentForPullRequestInput.beforeCommitId) &&
        Objects.equals(this.afterCommitId, postCommentForPullRequestInput.afterCommitId) &&
        Objects.equals(this.location, postCommentForPullRequestInput.location) &&
        Objects.equals(this.content, postCommentForPullRequestInput.content) &&
        Objects.equals(this.clientRequestToken, postCommentForPullRequestInput.clientRequestToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pullRequestId, repositoryName, beforeCommitId, afterCommitId, location, content, clientRequestToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostCommentForPullRequestInput {\n");
    sb.append("    pullRequestId: ").append(toIndentedString(pullRequestId)).append("\n");
    sb.append("    repositoryName: ").append(toIndentedString(repositoryName)).append("\n");
    sb.append("    beforeCommitId: ").append(toIndentedString(beforeCommitId)).append("\n");
    sb.append("    afterCommitId: ").append(toIndentedString(afterCommitId)).append("\n");
  ...
  static {
    ...
    openapiFields.add("beforeCommitId");
    openapiFields.add("afterCommitId");
    ...
    openapiRequiredFields.add("pullRequestId");
    openapiRequiredFields.add("repositoryName");
    openapiRequiredFields.add("beforeCommitId");
    openapiRequiredFields.add("afterCommitId");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostCommentForPullRequestInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostCommentForPullRequestInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostCommentForPullRequestInput is not found in the empty JSON string", PostCommentForPullRequestInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostCommentForPullRequestInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostCommentForPullRequestInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostCommentForPullRequestInput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `pullRequestId`
      ...
      // validate the required field `beforeCommitId`
      String.validateJsonElement(jsonObj.get("beforeCommitId"));
      // validate the required field `afterCommitId`
      String.validateJsonElement(jsonObj.get("afterCommitId"));
      // validate the optional field `location`
      if (jsonObj.get("location") != null && !jsonObj.get("location").isJsonNull()) {
        PostCommentForPullRequestInputLocation.validateJsonElement(jsonObj.get("location"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostCommentForPullRequestInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostCommentForPullRequestInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostCommentForPullRequestInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostCommentForPullRequestInput.class));

       return (TypeAdapter<T>) new TypeAdapter<PostCommentForPullRequestInput>() {
           @Override
           public void write(JsonWriter out, PostCommentForPullRequestInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostCommentForPullRequestInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostCommentForPullRequestInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostCommentForPullRequestInput
   * @throws IOException if the JSON string is invalid with respect to PostCommentForPullRequestInput
   */
  public static PostCommentForPullRequestInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostCommentForPullRequestInput.class);
  }

  /**
   * Convert an instance of PostCommentForPullRequestInput to an JSON string
   *
   * @return JSON string
   */
