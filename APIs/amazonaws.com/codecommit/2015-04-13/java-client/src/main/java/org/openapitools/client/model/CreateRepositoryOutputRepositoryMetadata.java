...
public class CreateRepositoryOutputRepositoryMetadata {
  ...
  public static final String SERIALIZED_NAME_REPOSITORY_DESCRIPTION = "repositoryDescription";
  @SerializedName(SERIALIZED_NAME_REPOSITORY_DESCRIPTION)
  ...
  public static final String SERIALIZED_NAME_CLONE_URL_HTTP = "cloneUrlHttp";
  @SerializedName(SERIALIZED_NAME_CLONE_URL_HTTP)
  private String cloneUrlHttp;

  public static final String SERIALIZED_NAME_CLONE_URL_SSH = "cloneUrlSsh";
  @SerializedName(SERIALIZED_NAME_CLONE_URL_SSH)
  ...
  public CreateRepositoryOutputRepositoryMetadata() {
  }

  public CreateRepositoryOutputRepositoryMetadata accountId(String accountId) {
  ...
  public CreateRepositoryOutputRepositoryMetadata repositoryId(String repositoryId) {
  ...
  public CreateRepositoryOutputRepositoryMetadata repositoryName(String repositoryName) {
  ...
  public CreateRepositoryOutputRepositoryMetadata repositoryDescription(String repositoryDescription) {
  ...
  public CreateRepositoryOutputRepositoryMetadata defaultBranch(String defaultBranch) {
  ...
  public CreateRepositoryOutputRepositoryMetadata lastModifiedDate(OffsetDateTime lastModifiedDate) {
  ...
  public CreateRepositoryOutputRepositoryMetadata creationDate(OffsetDateTime creationDate) {
  ...
  public CreateRepositoryOutputRepositoryMetadata cloneUrlHttp(String cloneUrlHttp) {
  ...
  public CreateRepositoryOutputRepositoryMetadata cloneUrlSsh(String cloneUrlSsh) {
  ...
  public CreateRepositoryOutputRepositoryMetadata arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateRepositoryOutputRepositoryMetadata createRepositoryOutputRepositoryMetadata = (CreateRepositoryOutputRepositoryMetadata) o;
    return Objects.equals(this.accountId, createRepositoryOutputRepositoryMetadata.accountId) &&
        Objects.equals(this.repositoryId, createRepositoryOutputRepositoryMetadata.repositoryId) &&
        Objects.equals(this.repositoryName, createRepositoryOutputRepositoryMetadata.repositoryName) &&
        Objects.equals(this.repositoryDescription, createRepositoryOutputRepositoryMetadata.repositoryDescription) &&
        Objects.equals(this.defaultBranch, createRepositoryOutputRepositoryMetadata.defaultBranch) &&
        Objects.equals(this.lastModifiedDate, createRepositoryOutputRepositoryMetadata.lastModifiedDate) &&
        Objects.equals(this.creationDate, createRepositoryOutputRepositoryMetadata.creationDate) &&
        Objects.equals(this.cloneUrlHttp, createRepositoryOutputRepositoryMetadata.cloneUrlHttp) &&
        Objects.equals(this.cloneUrlSsh, createRepositoryOutputRepositoryMetadata.cloneUrlSsh) &&
        Objects.equals(this.arn, createRepositoryOutputRepositoryMetadata.arn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, repositoryId, repositoryName, repositoryDescription, defaultBranch, lastModifiedDate, creationDate, cloneUrlHttp, cloneUrlSsh, arn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateRepositoryOutputRepositoryMetadata {\n");
    sb.append("    accountId: ").append(toIndentedString(accountId)).append("\n");
    sb.append("    repositoryId: ").append(toIndentedString(repositoryId)).append("\n");
    sb.append("    repositoryName: ").append(toIndentedString(repositoryName)).append("\n");
    sb.append("    repositoryDescription: ").append(toIndentedString(repositoryDescription)).append("\n");
    sb.append("    defaultBranch: ").append(toIndentedString(defaultBranch)).append("\n");
    sb.append("    lastModifiedDate: ").append(toIndentedString(lastModifiedDate)).append("\n");
    sb.append("    creationDate: ").append(toIndentedString(creationDate)).append("\n");
    sb.append("    cloneUrlHttp: ").append(toIndentedString(cloneUrlHttp)).append("\n");
    sb.append("    cloneUrlSsh: ").append(toIndentedString(cloneUrlSsh)).append("\n");
  ...
  static {
    ...
    openapiFields.add("repositoryDescription");
    openapiFields.add("defaultBranch");
    openapiFields.add("lastModifiedDate");
    openapiFields.add("creationDate");
    openapiFields.add("cloneUrlHttp");
    openapiFields.add("cloneUrlSsh");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateRepositoryOutputRepositoryMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateRepositoryOutputRepositoryMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateRepositoryOutputRepositoryMetadata is not found in the empty JSON string", CreateRepositoryOutputRepositoryMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateRepositoryOutputRepositoryMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateRepositoryOutputRepositoryMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `repositoryDescription`
      if (jsonObj.get("repositoryDescription") != null && !jsonObj.get("repositoryDescription").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("repositoryDescription"));
      }
      // validate the optional field `defaultBranch`
      if (jsonObj.get("defaultBranch") != null && !jsonObj.get("defaultBranch").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("defaultBranch"));
      }
      ...
      // validate the optional field `cloneUrlHttp`
      if (jsonObj.get("cloneUrlHttp") != null && !jsonObj.get("cloneUrlHttp").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("cloneUrlHttp"));
      }
      // validate the optional field `cloneUrlSsh`
      if (jsonObj.get("cloneUrlSsh") != null && !jsonObj.get("cloneUrlSsh").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("cloneUrlSsh"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateRepositoryOutputRepositoryMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateRepositoryOutputRepositoryMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateRepositoryOutputRepositoryMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateRepositoryOutputRepositoryMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateRepositoryOutputRepositoryMetadata>() {
           @Override
           public void write(JsonWriter out, CreateRepositoryOutputRepositoryMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateRepositoryOutputRepositoryMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateRepositoryOutputRepositoryMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateRepositoryOutputRepositoryMetadata
   * @throws IOException if the JSON string is invalid with respect to CreateRepositoryOutputRepositoryMetadata
   */
  public static CreateRepositoryOutputRepositoryMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateRepositoryOutputRepositoryMetadata.class);
  }

  /**
   * Convert an instance of CreateRepositoryOutputRepositoryMetadata to an JSON string
   *
   * @return JSON string
   */
