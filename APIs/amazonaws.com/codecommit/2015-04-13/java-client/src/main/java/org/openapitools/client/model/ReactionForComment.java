...
import org.openapitools.client.model.ReactionForCommentReaction;
...
public class ReactionForComment {
  ...
  private ReactionForCommentReaction reaction;

  public static final String SERIALIZED_NAME_REACTION_USERS = "reactionUsers";
  @SerializedName(SERIALIZED_NAME_REACTION_USERS)
  private List reactionUsers;

  public static final String SERIALIZED_NAME_REACTIONS_FROM_DELETED_USERS_COUNT = "reactionsFromDeletedUsersCount";
  @SerializedName(SERIALIZED_NAME_REACTIONS_FROM_DELETED_USERS_COUNT)
  private Integer reactionsFromDeletedUsersCount;

  public ReactionForComment() {
  }

  public ReactionForComment reaction(ReactionForCommentReaction reaction) {
  ...
  public ReactionForCommentReaction getReaction() {
    return reaction;
  }

  public void setReaction(ReactionForCommentReaction reaction) {
    this.reaction = reaction;
  }


  public ReactionForComment reactionUsers(List reactionUsers) {
   ...
   */
  @javax.annotation.Nullable
  public List getReactionUsers() {
    return reactionUsers;
  }

  public void setReactionUsers(List reactionUsers) {
    this.reactionUsers = reactionUsers;
  }


  public ReactionForComment reactionsFromDeletedUsersCount(Integer reactionsFromDeletedUsersCount) {
    this.reactionsFromDeletedUsersCount = reactionsFromDeletedUsersCount;
    return this;
  }

  /**
   * Get reactionsFromDeletedUsersCount
  ...
  public boolean equals(Object o) {
    ...
    ReactionForComment reactionForComment = (ReactionForComment) o;
    return Objects.equals(this.reaction, reactionForComment.reaction) &&
        Objects.equals(this.reactionUsers, reactionForComment.reactionUsers) &&
        Objects.equals(this.reactionsFromDeletedUsersCount, reactionForComment.reactionsFromDeletedUsersCount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(reaction, reactionUsers, reactionsFromDeletedUsersCount);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ReactionForComment {\n");
    sb.append("    reaction: ").append(toIndentedString(reaction)).append("\n");
    sb.append("    reactionUsers: ").append(toIndentedString(reactionUsers)).append("\n");
    sb.append("    reactionsFromDeletedUsersCount: ").append(toIndentedString(reactionsFromDeletedUsersCount)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("reactionUsers");
    openapiFields.add("reactionsFromDeletedUsersCount");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReactionForComment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReactionForComment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReactionForComment is not found in the empty JSON string", ReactionForComment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReactionForComment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReactionForComment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `reaction`
      if (jsonObj.get("reaction") != null && !jsonObj.get("reaction").isJsonNull()) {
        ReactionForCommentReaction.validateJsonElement(jsonObj.get("reaction"));
      }
      // validate the optional field `reactionUsers`
      if (jsonObj.get("reactionUsers") != null && !jsonObj.get("reactionUsers").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("reactionUsers"));
      }
      // validate the optional field `reactionsFromDeletedUsersCount`
      if (jsonObj.get("reactionsFromDeletedUsersCount") != null && !jsonObj.get("reactionsFromDeletedUsersCount").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("reactionsFromDeletedUsersCount"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReactionForComment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReactionForComment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReactionForComment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReactionForComment.class));

       return (TypeAdapter<T>) new TypeAdapter<ReactionForComment>() {
           @Override
           public void write(JsonWriter out, ReactionForComment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReactionForComment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReactionForComment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReactionForComment
   * @throws IOException if the JSON string is invalid with respect to ReactionForComment
   */
  public static ReactionForComment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReactionForComment.class);
  }

  /**
   * Convert an instance of ReactionForComment to an JSON string
   *
   * @return JSON string
   */
