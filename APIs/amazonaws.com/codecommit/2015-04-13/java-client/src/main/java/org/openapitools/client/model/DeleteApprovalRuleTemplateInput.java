...
public class DeleteApprovalRuleTemplateInput {
  ...
  public DeleteApprovalRuleTemplateInput() {
  }

  public DeleteApprovalRuleTemplateInput approvalRuleTemplateName(String approvalRuleTemplateName) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteApprovalRuleTemplateInput deleteApprovalRuleTemplateInput = (DeleteApprovalRuleTemplateInput) o;
    return Objects.equals(this.approvalRuleTemplateName, deleteApprovalRuleTemplateInput.approvalRuleTemplateName);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteApprovalRuleTemplateInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteApprovalRuleTemplateInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteApprovalRuleTemplateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteApprovalRuleTemplateInput is not found in the empty JSON string", DeleteApprovalRuleTemplateInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteApprovalRuleTemplateInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteApprovalRuleTemplateInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteApprovalRuleTemplateInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteApprovalRuleTemplateInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteApprovalRuleTemplateInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteApprovalRuleTemplateInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteApprovalRuleTemplateInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteApprovalRuleTemplateInput>() {
           @Override
           public void write(JsonWriter out, DeleteApprovalRuleTemplateInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteApprovalRuleTemplateInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteApprovalRuleTemplateInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteApprovalRuleTemplateInput
   * @throws IOException if the JSON string is invalid with respect to DeleteApprovalRuleTemplateInput
   */
  public static DeleteApprovalRuleTemplateInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteApprovalRuleTemplateInput.class);
  }

  /**
   * Convert an instance of DeleteApprovalRuleTemplateInput to an JSON string
   *
   * @return JSON string
   */
