...
public class DeleteBranchInput {
  ...
  public DeleteBranchInput() {
  }

  public DeleteBranchInput repositoryName(String repositoryName) {
  ...
  public DeleteBranchInput branchName(String branchName) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteBranchInput deleteBranchInput = (DeleteBranchInput) o;
    return Objects.equals(this.repositoryName, deleteBranchInput.repositoryName) &&
        Objects.equals(this.branchName, deleteBranchInput.branchName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, branchName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteBranchInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteBranchInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteBranchInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteBranchInput is not found in the empty JSON string", DeleteBranchInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteBranchInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteBranchInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteBranchInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteBranchInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteBranchInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteBranchInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteBranchInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteBranchInput>() {
           @Override
           public void write(JsonWriter out, DeleteBranchInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteBranchInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteBranchInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteBranchInput
   * @throws IOException if the JSON string is invalid with respect to DeleteBranchInput
   */
  public static DeleteBranchInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteBranchInput.class);
  }

  /**
   * Convert an instance of DeleteBranchInput to an JSON string
   *
   * @return JSON string
   */
