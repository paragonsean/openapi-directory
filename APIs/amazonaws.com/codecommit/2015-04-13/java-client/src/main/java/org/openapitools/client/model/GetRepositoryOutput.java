...
import org.openapitools.client.model.GetRepositoryOutputRepositoryMetadata;
...
public class GetRepositoryOutput {
  ...
  private GetRepositoryOutputRepositoryMetadata repositoryMetadata;

  public GetRepositoryOutput() {
  }

  public GetRepositoryOutput repositoryMetadata(GetRepositoryOutputRepositoryMetadata repositoryMetadata) {
  ...
  public GetRepositoryOutputRepositoryMetadata getRepositoryMetadata() {
    return repositoryMetadata;
  }

  public void setRepositoryMetadata(GetRepositoryOutputRepositoryMetadata repositoryMetadata) {
    this.repositoryMetadata = repositoryMetadata;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetRepositoryOutput getRepositoryOutput = (GetRepositoryOutput) o;
    return Objects.equals(this.repositoryMetadata, getRepositoryOutput.repositoryMetadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetRepositoryOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetRepositoryOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetRepositoryOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetRepositoryOutput is not found in the empty JSON string", GetRepositoryOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetRepositoryOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetRepositoryOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("repositoryMetadata") != null && !jsonObj.get("repositoryMetadata").isJsonNull()) {
        GetRepositoryOutputRepositoryMetadata.validateJsonElement(jsonObj.get("repositoryMetadata"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetRepositoryOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetRepositoryOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetRepositoryOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetRepositoryOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetRepositoryOutput>() {
           @Override
           public void write(JsonWriter out, GetRepositoryOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetRepositoryOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetRepositoryOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetRepositoryOutput
   * @throws IOException if the JSON string is invalid with respect to GetRepositoryOutput
   */
  public static GetRepositoryOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetRepositoryOutput.class);
  }

  /**
   * Convert an instance of GetRepositoryOutput to an JSON string
   *
   * @return JSON string
   */
