...
public class BatchDescribeMergeConflictsError {
  ...
  public BatchDescribeMergeConflictsError() {
  }

  public BatchDescribeMergeConflictsError filePath(String filePath) {
  ...
  public BatchDescribeMergeConflictsError exceptionName(String exceptionName) {
  ...
  public BatchDescribeMergeConflictsError message(String message) {
  ...
  public boolean equals(Object o) {
    ...
    BatchDescribeMergeConflictsError batchDescribeMergeConflictsError = (BatchDescribeMergeConflictsError) o;
    return Objects.equals(this.filePath, batchDescribeMergeConflictsError.filePath) &&
        Objects.equals(this.exceptionName, batchDescribeMergeConflictsError.exceptionName) &&
        Objects.equals(this.message, batchDescribeMergeConflictsError.message);
  }

  @Override
  public int hashCode() {
    return Objects.hash(filePath, exceptionName, message);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BatchDescribeMergeConflictsError {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("exceptionName");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchDescribeMergeConflictsError
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchDescribeMergeConflictsError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchDescribeMergeConflictsError is not found in the empty JSON string", BatchDescribeMergeConflictsError.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchDescribeMergeConflictsError.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchDescribeMergeConflictsError` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BatchDescribeMergeConflictsError.openapiRequiredFields) {
      ...
      // validate the required field `exceptionName`
      String.validateJsonElement(jsonObj.get("exceptionName"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchDescribeMergeConflictsError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchDescribeMergeConflictsError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchDescribeMergeConflictsError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchDescribeMergeConflictsError.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchDescribeMergeConflictsError>() {
           @Override
           public void write(JsonWriter out, BatchDescribeMergeConflictsError value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchDescribeMergeConflictsError read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchDescribeMergeConflictsError given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchDescribeMergeConflictsError
   * @throws IOException if the JSON string is invalid with respect to BatchDescribeMergeConflictsError
   */
  public static BatchDescribeMergeConflictsError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchDescribeMergeConflictsError.class);
  }

  /**
   * Convert an instance of BatchDescribeMergeConflictsError to an JSON string
   *
   * @return JSON string
   */
