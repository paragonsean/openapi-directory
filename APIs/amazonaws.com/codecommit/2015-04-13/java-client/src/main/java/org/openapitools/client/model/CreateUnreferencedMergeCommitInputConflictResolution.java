...
public class CreateUnreferencedMergeCommitInputConflictResolution {
  ...
  public CreateUnreferencedMergeCommitInputConflictResolution() {
  }

  public CreateUnreferencedMergeCommitInputConflictResolution replaceContents(List replaceContents) {
  ...
  public CreateUnreferencedMergeCommitInputConflictResolution deleteFiles(List deleteFiles) {
  ...
  public CreateUnreferencedMergeCommitInputConflictResolution setFileModes(List setFileModes) {
  ...
  public boolean equals(Object o) {
    ...
    CreateUnreferencedMergeCommitInputConflictResolution createUnreferencedMergeCommitInputConflictResolution = (CreateUnreferencedMergeCommitInputConflictResolution) o;
    return Objects.equals(this.replaceContents, createUnreferencedMergeCommitInputConflictResolution.replaceContents) &&
        Objects.equals(this.deleteFiles, createUnreferencedMergeCommitInputConflictResolution.deleteFiles) &&
        Objects.equals(this.setFileModes, createUnreferencedMergeCommitInputConflictResolution.setFileModes);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateUnreferencedMergeCommitInputConflictResolution {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateUnreferencedMergeCommitInputConflictResolution
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateUnreferencedMergeCommitInputConflictResolution.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateUnreferencedMergeCommitInputConflictResolution is not found in the empty JSON string", CreateUnreferencedMergeCommitInputConflictResolution.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateUnreferencedMergeCommitInputConflictResolution.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateUnreferencedMergeCommitInputConflictResolution` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateUnreferencedMergeCommitInputConflictResolution.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateUnreferencedMergeCommitInputConflictResolution' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateUnreferencedMergeCommitInputConflictResolution> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateUnreferencedMergeCommitInputConflictResolution.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateUnreferencedMergeCommitInputConflictResolution>() {
           @Override
           public void write(JsonWriter out, CreateUnreferencedMergeCommitInputConflictResolution value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateUnreferencedMergeCommitInputConflictResolution read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateUnreferencedMergeCommitInputConflictResolution given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateUnreferencedMergeCommitInputConflictResolution
   * @throws IOException if the JSON string is invalid with respect to CreateUnreferencedMergeCommitInputConflictResolution
   */
  public static CreateUnreferencedMergeCommitInputConflictResolution fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateUnreferencedMergeCommitInputConflictResolution.class);
  }

  /**
   * Convert an instance of CreateUnreferencedMergeCommitInputConflictResolution to an JSON string
   *
   * @return JSON string
   */
