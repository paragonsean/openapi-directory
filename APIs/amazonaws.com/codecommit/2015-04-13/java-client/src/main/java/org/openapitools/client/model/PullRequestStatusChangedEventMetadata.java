...
public class PullRequestStatusChangedEventMetadata {
  ...
  public PullRequestStatusChangedEventMetadata pullRequestStatus(PullRequestStatusEnum pullRequestStatus) {
  ...
  public boolean equals(Object o) {
    ...
    PullRequestStatusChangedEventMetadata pullRequestStatusChangedEventMetadata = (PullRequestStatusChangedEventMetadata) o;
    return Objects.equals(this.pullRequestStatus, pullRequestStatusChangedEventMetadata.pullRequestStatus);
  }
  ...
  public String toString() {
    ...
    sb.append("class PullRequestStatusChangedEventMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PullRequestStatusChangedEventMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PullRequestStatusChangedEventMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PullRequestStatusChangedEventMetadata is not found in the empty JSON string", PullRequestStatusChangedEventMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PullRequestStatusChangedEventMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PullRequestStatusChangedEventMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PullRequestStatusChangedEventMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PullRequestStatusChangedEventMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PullRequestStatusChangedEventMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PullRequestStatusChangedEventMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<PullRequestStatusChangedEventMetadata>() {
           @Override
           public void write(JsonWriter out, PullRequestStatusChangedEventMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PullRequestStatusChangedEventMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PullRequestStatusChangedEventMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PullRequestStatusChangedEventMetadata
   * @throws IOException if the JSON string is invalid with respect to PullRequestStatusChangedEventMetadata
   */
  public static PullRequestStatusChangedEventMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PullRequestStatusChangedEventMetadata.class);
  }

  /**
   * Convert an instance of PullRequestStatusChangedEventMetadata to an JSON string
   *
   * @return JSON string
   */
