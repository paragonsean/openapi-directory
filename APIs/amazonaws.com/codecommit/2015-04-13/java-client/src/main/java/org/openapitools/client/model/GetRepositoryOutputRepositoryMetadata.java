...
public class GetRepositoryOutputRepositoryMetadata {
  ...
  public GetRepositoryOutputRepositoryMetadata() {
  }

  public GetRepositoryOutputRepositoryMetadata accountId(String accountId) {
  ...
  public GetRepositoryOutputRepositoryMetadata repositoryId(String repositoryId) {
  ...
  public GetRepositoryOutputRepositoryMetadata repositoryName(String repositoryName) {
  ...
  public GetRepositoryOutputRepositoryMetadata repositoryDescription(String repositoryDescription) {
  ...
  public GetRepositoryOutputRepositoryMetadata defaultBranch(String defaultBranch) {
  ...
  public GetRepositoryOutputRepositoryMetadata lastModifiedDate(OffsetDateTime lastModifiedDate) {
  ...
  public GetRepositoryOutputRepositoryMetadata creationDate(OffsetDateTime creationDate) {
  ...
  public GetRepositoryOutputRepositoryMetadata cloneUrlHttp(String cloneUrlHttp) {
  ...
  public GetRepositoryOutputRepositoryMetadata cloneUrlSsh(String cloneUrlSsh) {
  ...
  public GetRepositoryOutputRepositoryMetadata arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetRepositoryOutputRepositoryMetadata getRepositoryOutputRepositoryMetadata = (GetRepositoryOutputRepositoryMetadata) o;
    return Objects.equals(this.accountId, getRepositoryOutputRepositoryMetadata.accountId) &&
        Objects.equals(this.repositoryId, getRepositoryOutputRepositoryMetadata.repositoryId) &&
        Objects.equals(this.repositoryName, getRepositoryOutputRepositoryMetadata.repositoryName) &&
        Objects.equals(this.repositoryDescription, getRepositoryOutputRepositoryMetadata.repositoryDescription) &&
        Objects.equals(this.defaultBranch, getRepositoryOutputRepositoryMetadata.defaultBranch) &&
        Objects.equals(this.lastModifiedDate, getRepositoryOutputRepositoryMetadata.lastModifiedDate) &&
        Objects.equals(this.creationDate, getRepositoryOutputRepositoryMetadata.creationDate) &&
        Objects.equals(this.cloneUrlHttp, getRepositoryOutputRepositoryMetadata.cloneUrlHttp) &&
        Objects.equals(this.cloneUrlSsh, getRepositoryOutputRepositoryMetadata.cloneUrlSsh) &&
        Objects.equals(this.arn, getRepositoryOutputRepositoryMetadata.arn);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetRepositoryOutputRepositoryMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetRepositoryOutputRepositoryMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetRepositoryOutputRepositoryMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetRepositoryOutputRepositoryMetadata is not found in the empty JSON string", GetRepositoryOutputRepositoryMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetRepositoryOutputRepositoryMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetRepositoryOutputRepositoryMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetRepositoryOutputRepositoryMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetRepositoryOutputRepositoryMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetRepositoryOutputRepositoryMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetRepositoryOutputRepositoryMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<GetRepositoryOutputRepositoryMetadata>() {
           @Override
           public void write(JsonWriter out, GetRepositoryOutputRepositoryMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetRepositoryOutputRepositoryMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetRepositoryOutputRepositoryMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetRepositoryOutputRepositoryMetadata
   * @throws IOException if the JSON string is invalid with respect to GetRepositoryOutputRepositoryMetadata
   */
  public static GetRepositoryOutputRepositoryMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetRepositoryOutputRepositoryMetadata.class);
  }

  /**
   * Convert an instance of GetRepositoryOutputRepositoryMetadata to an JSON string
   *
   * @return JSON string
   */
