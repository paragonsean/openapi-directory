...
public class DeleteFileEntry {
  ...
  public DeleteFileEntry filePath(String filePath) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteFileEntry deleteFileEntry = (DeleteFileEntry) o;
    return Objects.equals(this.filePath, deleteFileEntry.filePath);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteFileEntry {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteFileEntry
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteFileEntry.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteFileEntry is not found in the empty JSON string", DeleteFileEntry.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteFileEntry.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteFileEntry` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteFileEntry.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteFileEntry.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteFileEntry' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteFileEntry> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteFileEntry.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteFileEntry>() {
           @Override
           public void write(JsonWriter out, DeleteFileEntry value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteFileEntry read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteFileEntry given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteFileEntry
   * @throws IOException if the JSON string is invalid with respect to DeleteFileEntry
   */
  public static DeleteFileEntry fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteFileEntry.class);
  }

  /**
   * Convert an instance of DeleteFileEntry to an JSON string
   *
   * @return JSON string
   */
