...
public class GetPullRequestOverrideStateOutput {
  ...
  public static final String SERIALIZED_NAME_OVERRIDER = "overrider";
  @SerializedName(SERIALIZED_NAME_OVERRIDER)
  private String overrider;

  public GetPullRequestOverrideStateOutput() {
  }

  public GetPullRequestOverrideStateOutput overridden(Boolean overridden) {
  ...
  public GetPullRequestOverrideStateOutput overrider(String overrider) {
  ...
  public boolean equals(Object o) {
    ...
    GetPullRequestOverrideStateOutput getPullRequestOverrideStateOutput = (GetPullRequestOverrideStateOutput) o;
    return Objects.equals(this.overridden, getPullRequestOverrideStateOutput.overridden) &&
        Objects.equals(this.overrider, getPullRequestOverrideStateOutput.overrider);
  }

  @Override
  public int hashCode() {
    return Objects.hash(overridden, overrider);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetPullRequestOverrideStateOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPullRequestOverrideStateOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPullRequestOverrideStateOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPullRequestOverrideStateOutput is not found in the empty JSON string", GetPullRequestOverrideStateOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPullRequestOverrideStateOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPullRequestOverrideStateOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("overrider") != null && !jsonObj.get("overrider").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("overrider"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPullRequestOverrideStateOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPullRequestOverrideStateOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPullRequestOverrideStateOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPullRequestOverrideStateOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPullRequestOverrideStateOutput>() {
           @Override
           public void write(JsonWriter out, GetPullRequestOverrideStateOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPullRequestOverrideStateOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPullRequestOverrideStateOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPullRequestOverrideStateOutput
   * @throws IOException if the JSON string is invalid with respect to GetPullRequestOverrideStateOutput
   */
  public static GetPullRequestOverrideStateOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPullRequestOverrideStateOutput.class);
  }

  /**
   * Convert an instance of GetPullRequestOverrideStateOutput to an JSON string
   *
   * @return JSON string
   */
