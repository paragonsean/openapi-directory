...
public class DifferenceAfterBlob {
  ...
  public DifferenceAfterBlob() {
  }

  public DifferenceAfterBlob blobId(String blobId) {
    this.blobId = blobId;
    return this;
  }
  ...
  public DifferenceAfterBlob path(String path) {
    this.path = path;
    return this;
  }
  ...
  public DifferenceAfterBlob mode(String mode) {
    this.mode = mode;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DifferenceAfterBlob differenceAfterBlob = (DifferenceAfterBlob) o;
    return Objects.equals(this.blobId, differenceAfterBlob.blobId) &&
        Objects.equals(this.path, differenceAfterBlob.path) &&
        Objects.equals(this.mode, differenceAfterBlob.mode);
  }
  ...
  public String toString() {
    ...
    sb.append("class DifferenceAfterBlob {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DifferenceAfterBlob
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DifferenceAfterBlob.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DifferenceAfterBlob is not found in the empty JSON string", DifferenceAfterBlob.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DifferenceAfterBlob.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DifferenceAfterBlob` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DifferenceAfterBlob.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DifferenceAfterBlob' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DifferenceAfterBlob> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DifferenceAfterBlob.class));

       return (TypeAdapter<T>) new TypeAdapter<DifferenceAfterBlob>() {
           @Override
           public void write(JsonWriter out, DifferenceAfterBlob value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DifferenceAfterBlob read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DifferenceAfterBlob given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DifferenceAfterBlob
   * @throws IOException if the JSON string is invalid with respect to DifferenceAfterBlob
   */
  public static DifferenceAfterBlob fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DifferenceAfterBlob.class);
  }

  /**
   * Convert an instance of DifferenceAfterBlob to an JSON string
   *
   * @return JSON string
   */
