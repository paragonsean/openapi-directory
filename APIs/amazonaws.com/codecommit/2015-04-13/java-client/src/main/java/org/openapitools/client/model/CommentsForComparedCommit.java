...
import org.openapitools.client.model.CommentsForComparedCommitLocation;
...
public class CommentsForComparedCommit {
  ...
  private CommentsForComparedCommitLocation location;
  ...
  public CommentsForComparedCommit repositoryName(String repositoryName) {
  ...
  public CommentsForComparedCommit beforeCommitId(String beforeCommitId) {
  ...
  public CommentsForComparedCommit afterCommitId(String afterCommitId) {
  ...
  public CommentsForComparedCommit beforeBlobId(String beforeBlobId) {
  ...
  public CommentsForComparedCommit afterBlobId(String afterBlobId) {
  ...
  public CommentsForComparedCommit location(CommentsForComparedCommitLocation location) {
   ...
   */
  @javax.annotation.Nullable
  public CommentsForComparedCommitLocation getLocation() {
    return location;
  }

  public void setLocation(CommentsForComparedCommitLocation location) {
    this.location = location;
  }


  public CommentsForComparedCommit comments(List comments) {
  ...
  public boolean equals(Object o) {
    ...
    CommentsForComparedCommit commentsForComparedCommit = (CommentsForComparedCommit) o;
    return Objects.equals(this.repositoryName, commentsForComparedCommit.repositoryName) &&
        Objects.equals(this.beforeCommitId, commentsForComparedCommit.beforeCommitId) &&
        Objects.equals(this.afterCommitId, commentsForComparedCommit.afterCommitId) &&
        Objects.equals(this.beforeBlobId, commentsForComparedCommit.beforeBlobId) &&
        Objects.equals(this.afterBlobId, commentsForComparedCommit.afterBlobId) &&
        Objects.equals(this.location, commentsForComparedCommit.location) &&
        Objects.equals(this.comments, commentsForComparedCommit.comments);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, beforeCommitId, afterCommitId, beforeBlobId, afterBlobId, location, comments);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CommentsForComparedCommit {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CommentsForComparedCommit
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommentsForComparedCommit.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CommentsForComparedCommit is not found in the empty JSON string", CommentsForComparedCommit.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CommentsForComparedCommit.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CommentsForComparedCommit` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("location") != null && !jsonObj.get("location").isJsonNull()) {
        CommentsForComparedCommitLocation.validateJsonElement(jsonObj.get("location"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CommentsForComparedCommit.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CommentsForComparedCommit' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CommentsForComparedCommit> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CommentsForComparedCommit.class));

       return (TypeAdapter<T>) new TypeAdapter<CommentsForComparedCommit>() {
           @Override
           public void write(JsonWriter out, CommentsForComparedCommit value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CommentsForComparedCommit read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CommentsForComparedCommit given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CommentsForComparedCommit
   * @throws IOException if the JSON string is invalid with respect to CommentsForComparedCommit
   */
  public static CommentsForComparedCommit fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CommentsForComparedCommit.class);
  }

  /**
   * Convert an instance of CommentsForComparedCommit to an JSON string
   *
   * @return JSON string
   */
