...
public class BatchAssociateApprovalRuleTemplateWithRepositoriesOutput {
  public static final String SERIALIZED_NAME_ASSOCIATED_REPOSITORY_NAMES = "associatedRepositoryNames";
  @SerializedName(SERIALIZED_NAME_ASSOCIATED_REPOSITORY_NAMES)
  private List associatedRepositoryNames;
  ...
  public BatchAssociateApprovalRuleTemplateWithRepositoriesOutput associatedRepositoryNames(List associatedRepositoryNames) {
    this.associatedRepositoryNames = associatedRepositoryNames;
    return this;
  }

  /**
   * Get associatedRepositoryNames
   * @return associatedRepositoryNames
   */
  @javax.annotation.Nonnull
  public List getAssociatedRepositoryNames() {
    return associatedRepositoryNames;
  }

  public void setAssociatedRepositoryNames(List associatedRepositoryNames) {
    this.associatedRepositoryNames = associatedRepositoryNames;
  }


  public BatchAssociateApprovalRuleTemplateWithRepositoriesOutput errors(List errors) {
    this.errors = errors;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    BatchAssociateApprovalRuleTemplateWithRepositoriesOutput batchAssociateApprovalRuleTemplateWithRepositoriesOutput = (BatchAssociateApprovalRuleTemplateWithRepositoriesOutput) o;
    return Objects.equals(this.associatedRepositoryNames, batchAssociateApprovalRuleTemplateWithRepositoriesOutput.associatedRepositoryNames) &&
        Objects.equals(this.errors, batchAssociateApprovalRuleTemplateWithRepositoriesOutput.errors);
  }

  @Override
  public int hashCode() {
    return Objects.hash(associatedRepositoryNames, errors);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BatchAssociateApprovalRuleTemplateWithRepositoriesOutput {\n");
    sb.append("    associatedRepositoryNames: ").append(toIndentedString(associatedRepositoryNames)).append("\n");
  ...
  static {
    ...
    openapiFields.add("associatedRepositoryNames");
    openapiFields.add("errors");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("associatedRepositoryNames");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchAssociateApprovalRuleTemplateWithRepositoriesOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchAssociateApprovalRuleTemplateWithRepositoriesOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchAssociateApprovalRuleTemplateWithRepositoriesOutput is not found in the empty JSON string", BatchAssociateApprovalRuleTemplateWithRepositoriesOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchAssociateApprovalRuleTemplateWithRepositoriesOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchAssociateApprovalRuleTemplateWithRepositoriesOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BatchAssociateApprovalRuleTemplateWithRepositoriesOutput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `associatedRepositoryNames`
      List.validateJsonElement(jsonObj.get("associatedRepositoryNames"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchAssociateApprovalRuleTemplateWithRepositoriesOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchAssociateApprovalRuleTemplateWithRepositoriesOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchAssociateApprovalRuleTemplateWithRepositoriesOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchAssociateApprovalRuleTemplateWithRepositoriesOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchAssociateApprovalRuleTemplateWithRepositoriesOutput>() {
           @Override
           public void write(JsonWriter out, BatchAssociateApprovalRuleTemplateWithRepositoriesOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchAssociateApprovalRuleTemplateWithRepositoriesOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchAssociateApprovalRuleTemplateWithRepositoriesOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchAssociateApprovalRuleTemplateWithRepositoriesOutput
   * @throws IOException if the JSON string is invalid with respect to BatchAssociateApprovalRuleTemplateWithRepositoriesOutput
   */
  public static BatchAssociateApprovalRuleTemplateWithRepositoriesOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchAssociateApprovalRuleTemplateWithRepositoriesOutput.class);
  }

  /**
   * Convert an instance of BatchAssociateApprovalRuleTemplateWithRepositoriesOutput to an JSON string
   *
   * @return JSON string
   */
