...
public class GetApprovalRuleTemplateOutputApprovalRuleTemplate {
  ...
  public GetApprovalRuleTemplateOutputApprovalRuleTemplate() {
  }

  public GetApprovalRuleTemplateOutputApprovalRuleTemplate approvalRuleTemplateId(String approvalRuleTemplateId) {
  ...
  public GetApprovalRuleTemplateOutputApprovalRuleTemplate approvalRuleTemplateName(String approvalRuleTemplateName) {
  ...
  public GetApprovalRuleTemplateOutputApprovalRuleTemplate approvalRuleTemplateDescription(String approvalRuleTemplateDescription) {
  ...
  public GetApprovalRuleTemplateOutputApprovalRuleTemplate approvalRuleTemplateContent(String approvalRuleTemplateContent) {
  ...
  public GetApprovalRuleTemplateOutputApprovalRuleTemplate ruleContentSha256(String ruleContentSha256) {
  ...
  public GetApprovalRuleTemplateOutputApprovalRuleTemplate lastModifiedDate(OffsetDateTime lastModifiedDate) {
  ...
  public GetApprovalRuleTemplateOutputApprovalRuleTemplate creationDate(OffsetDateTime creationDate) {
  ...
  public GetApprovalRuleTemplateOutputApprovalRuleTemplate lastModifiedUser(String lastModifiedUser) {
  ...
  public boolean equals(Object o) {
    ...
    GetApprovalRuleTemplateOutputApprovalRuleTemplate getApprovalRuleTemplateOutputApprovalRuleTemplate = (GetApprovalRuleTemplateOutputApprovalRuleTemplate) o;
    return Objects.equals(this.approvalRuleTemplateId, getApprovalRuleTemplateOutputApprovalRuleTemplate.approvalRuleTemplateId) &&
        Objects.equals(this.approvalRuleTemplateName, getApprovalRuleTemplateOutputApprovalRuleTemplate.approvalRuleTemplateName) &&
        Objects.equals(this.approvalRuleTemplateDescription, getApprovalRuleTemplateOutputApprovalRuleTemplate.approvalRuleTemplateDescription) &&
        Objects.equals(this.approvalRuleTemplateContent, getApprovalRuleTemplateOutputApprovalRuleTemplate.approvalRuleTemplateContent) &&
        Objects.equals(this.ruleContentSha256, getApprovalRuleTemplateOutputApprovalRuleTemplate.ruleContentSha256) &&
        Objects.equals(this.lastModifiedDate, getApprovalRuleTemplateOutputApprovalRuleTemplate.lastModifiedDate) &&
        Objects.equals(this.creationDate, getApprovalRuleTemplateOutputApprovalRuleTemplate.creationDate) &&
        Objects.equals(this.lastModifiedUser, getApprovalRuleTemplateOutputApprovalRuleTemplate.lastModifiedUser);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetApprovalRuleTemplateOutputApprovalRuleTemplate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetApprovalRuleTemplateOutputApprovalRuleTemplate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetApprovalRuleTemplateOutputApprovalRuleTemplate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetApprovalRuleTemplateOutputApprovalRuleTemplate is not found in the empty JSON string", GetApprovalRuleTemplateOutputApprovalRuleTemplate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetApprovalRuleTemplateOutputApprovalRuleTemplate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetApprovalRuleTemplateOutputApprovalRuleTemplate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetApprovalRuleTemplateOutputApprovalRuleTemplate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetApprovalRuleTemplateOutputApprovalRuleTemplate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetApprovalRuleTemplateOutputApprovalRuleTemplate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetApprovalRuleTemplateOutputApprovalRuleTemplate.class));

       return (TypeAdapter<T>) new TypeAdapter<GetApprovalRuleTemplateOutputApprovalRuleTemplate>() {
           @Override
           public void write(JsonWriter out, GetApprovalRuleTemplateOutputApprovalRuleTemplate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetApprovalRuleTemplateOutputApprovalRuleTemplate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetApprovalRuleTemplateOutputApprovalRuleTemplate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetApprovalRuleTemplateOutputApprovalRuleTemplate
   * @throws IOException if the JSON string is invalid with respect to GetApprovalRuleTemplateOutputApprovalRuleTemplate
   */
  public static GetApprovalRuleTemplateOutputApprovalRuleTemplate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetApprovalRuleTemplateOutputApprovalRuleTemplate.class);
  }

  /**
   * Convert an instance of GetApprovalRuleTemplateOutputApprovalRuleTemplate to an JSON string
   *
   * @return JSON string
   */
