...
public class PutFileInput {
  ...
  public PutFileInput repositoryName(String repositoryName) {
  ...
  public PutFileInput branchName(String branchName) {
  ...
  public PutFileInput fileContent(String fileContent) {
  ...
  public PutFileInput filePath(String filePath) {
  ...
  public PutFileInput fileMode(FileModeTypeEnum fileMode) {
  ...
  public PutFileInput parentCommitId(String parentCommitId) {
  ...
  public PutFileInput commitMessage(String commitMessage) {
  ...
  public PutFileInput name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PutFileInput email(String email) {
    this.email = email;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PutFileInput putFileInput = (PutFileInput) o;
    return Objects.equals(this.repositoryName, putFileInput.repositoryName) &&
        Objects.equals(this.branchName, putFileInput.branchName) &&
        Objects.equals(this.fileContent, putFileInput.fileContent) &&
        Objects.equals(this.filePath, putFileInput.filePath) &&
        Objects.equals(this.fileMode, putFileInput.fileMode) &&
        Objects.equals(this.parentCommitId, putFileInput.parentCommitId) &&
        Objects.equals(this.commitMessage, putFileInput.commitMessage) &&
        Objects.equals(this.name, putFileInput.name) &&
        Objects.equals(this.email, putFileInput.email);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, branchName, fileContent, filePath, fileMode, parentCommitId, commitMessage, name, email);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutFileInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutFileInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutFileInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutFileInput is not found in the empty JSON string", PutFileInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutFileInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutFileInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PutFileInput.openapiRequiredFields) {
      ...
      // validate the required field `fileContent`
      String.validateJsonElement(jsonObj.get("fileContent"));
      ...
      if (jsonObj.get("parentCommitId") != null && !jsonObj.get("parentCommitId").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutFileInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutFileInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutFileInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutFileInput.class));

       return (TypeAdapter<T>) new TypeAdapter<PutFileInput>() {
           @Override
           public void write(JsonWriter out, PutFileInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutFileInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutFileInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutFileInput
   * @throws IOException if the JSON string is invalid with respect to PutFileInput
   */
  public static PutFileInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutFileInput.class);
  }

  /**
   * Convert an instance of PutFileInput to an JSON string
   *
   * @return JSON string
   */
