...
import org.openapitools.client.model.PostCommentReplyOutputComment;
...
public class PostCommentReplyOutput {
  ...
  private PostCommentReplyOutputComment comment;

  public PostCommentReplyOutput() {
  }

  public PostCommentReplyOutput comment(PostCommentReplyOutputComment comment) {
  ...
  public PostCommentReplyOutputComment getComment() {
    return comment;
  }

  public void setComment(PostCommentReplyOutputComment comment) {
    this.comment = comment;
  }
  ...
  public boolean equals(Object o) {
    ...
    PostCommentReplyOutput postCommentReplyOutput = (PostCommentReplyOutput) o;
    return Objects.equals(this.comment, postCommentReplyOutput.comment);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostCommentReplyOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostCommentReplyOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostCommentReplyOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostCommentReplyOutput is not found in the empty JSON string", PostCommentReplyOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostCommentReplyOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostCommentReplyOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `comment`
      if (jsonObj.get("comment") != null && !jsonObj.get("comment").isJsonNull()) {
        PostCommentReplyOutputComment.validateJsonElement(jsonObj.get("comment"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostCommentReplyOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostCommentReplyOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostCommentReplyOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostCommentReplyOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<PostCommentReplyOutput>() {
           @Override
           public void write(JsonWriter out, PostCommentReplyOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostCommentReplyOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostCommentReplyOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostCommentReplyOutput
   * @throws IOException if the JSON string is invalid with respect to PostCommentReplyOutput
   */
  public static PostCommentReplyOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostCommentReplyOutput.class);
  }

  /**
   * Convert an instance of PostCommentReplyOutput to an JSON string
   *
   * @return JSON string
   */
