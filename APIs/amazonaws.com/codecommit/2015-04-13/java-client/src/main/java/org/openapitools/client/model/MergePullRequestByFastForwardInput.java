...
public class MergePullRequestByFastForwardInput {
  ...
  public MergePullRequestByFastForwardInput() {
  }

  public MergePullRequestByFastForwardInput pullRequestId(String pullRequestId) {
  ...
  public MergePullRequestByFastForwardInput repositoryName(String repositoryName) {
  ...
  public MergePullRequestByFastForwardInput sourceCommitId(String sourceCommitId) {
  ...
  public boolean equals(Object o) {
    ...
    MergePullRequestByFastForwardInput mergePullRequestByFastForwardInput = (MergePullRequestByFastForwardInput) o;
    return Objects.equals(this.pullRequestId, mergePullRequestByFastForwardInput.pullRequestId) &&
        Objects.equals(this.repositoryName, mergePullRequestByFastForwardInput.repositoryName) &&
        Objects.equals(this.sourceCommitId, mergePullRequestByFastForwardInput.sourceCommitId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pullRequestId, repositoryName, sourceCommitId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MergePullRequestByFastForwardInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MergePullRequestByFastForwardInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MergePullRequestByFastForwardInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MergePullRequestByFastForwardInput is not found in the empty JSON string", MergePullRequestByFastForwardInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MergePullRequestByFastForwardInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MergePullRequestByFastForwardInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MergePullRequestByFastForwardInput.openapiRequiredFields) {
      ...
      if (jsonObj.get("sourceCommitId") != null && !jsonObj.get("sourceCommitId").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MergePullRequestByFastForwardInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MergePullRequestByFastForwardInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MergePullRequestByFastForwardInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MergePullRequestByFastForwardInput.class));

       return (TypeAdapter<T>) new TypeAdapter<MergePullRequestByFastForwardInput>() {
           @Override
           public void write(JsonWriter out, MergePullRequestByFastForwardInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MergePullRequestByFastForwardInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MergePullRequestByFastForwardInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MergePullRequestByFastForwardInput
   * @throws IOException if the JSON string is invalid with respect to MergePullRequestByFastForwardInput
   */
  public static MergePullRequestByFastForwardInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MergePullRequestByFastForwardInput.class);
  }

  /**
   * Convert an instance of MergePullRequestByFastForwardInput to an JSON string
   *
   * @return JSON string
   */
