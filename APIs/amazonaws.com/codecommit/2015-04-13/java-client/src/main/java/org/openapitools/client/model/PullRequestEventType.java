...
/**
 * Gets or Sets PullRequestEventType
 */
@JsonAdapter(PullRequestEventType.Adapter.class)
public enum PullRequestEventType {
  
  CREATED("PULL_REQUEST_CREATED"),
  
  STATUS_CHANGED("PULL_REQUEST_STATUS_CHANGED"),
  
  SOURCE_REFERENCE_UPDATED("PULL_REQUEST_SOURCE_REFERENCE_UPDATED"),
  
  MERGE_STATE_CHANGED("PULL_REQUEST_MERGE_STATE_CHANGED"),
  
  APPROVAL_RULE_CREATED("PULL_REQUEST_APPROVAL_RULE_CREATED"),
  
  APPROVAL_RULE_UPDATED("PULL_REQUEST_APPROVAL_RULE_UPDATED"),
  
  APPROVAL_RULE_DELETED("PULL_REQUEST_APPROVAL_RULE_DELETED"),
  
  APPROVAL_RULE_OVERRIDDEN("PULL_REQUEST_APPROVAL_RULE_OVERRIDDEN"),
  
  APPROVAL_STATE_CHANGED("PULL_REQUEST_APPROVAL_STATE_CHANGED");

  private String value;

  PullRequestEventType(String value) {
    this.value = value;
  }
  ...
  public static PullRequestEventType fromValue(String value) {
    for (PullRequestEventType b : PullRequestEventType.values()) {
  ...
  public static class Adapter extends TypeAdapter<PullRequestEventType> {
    @Override
    public void write(final JsonWriter jsonWriter, final PullRequestEventType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PullRequestEventType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PullRequestEventType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PullRequestEventType.fromValue(value);
  }
}
