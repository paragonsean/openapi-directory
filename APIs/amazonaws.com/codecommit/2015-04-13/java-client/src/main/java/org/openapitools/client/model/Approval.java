...
public class Approval {
  ...
  public Approval userArn(String userArn) {
  ...
  public Approval approvalState(ApprovalState approvalState) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userArn, approval.userArn) &&
        Objects.equals(this.approvalState, approval.approvalState);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userArn, approvalState);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("approvalState") != null && !jsonObj.get("approvalState").isJsonNull()) {
        ApprovalState.validateJsonElement(jsonObj.get("approvalState"));
      }
  }
