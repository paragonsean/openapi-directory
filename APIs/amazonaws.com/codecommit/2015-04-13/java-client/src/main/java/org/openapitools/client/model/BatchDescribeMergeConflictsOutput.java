...
public class BatchDescribeMergeConflictsOutput {
  ...
  public BatchDescribeMergeConflictsOutput() {
  }

  public BatchDescribeMergeConflictsOutput conflicts(List conflicts) {
  ...
  public BatchDescribeMergeConflictsOutput nextToken(String nextToken) {
  ...
  public BatchDescribeMergeConflictsOutput errors(List errors) {
    this.errors = errors;
    return this;
  }
  ...
  public BatchDescribeMergeConflictsOutput destinationCommitId(String destinationCommitId) {
  ...
  public BatchDescribeMergeConflictsOutput sourceCommitId(String sourceCommitId) {
  ...
  public BatchDescribeMergeConflictsOutput baseCommitId(String baseCommitId) {
  ...
  public boolean equals(Object o) {
    ...
    BatchDescribeMergeConflictsOutput batchDescribeMergeConflictsOutput = (BatchDescribeMergeConflictsOutput) o;
    return Objects.equals(this.conflicts, batchDescribeMergeConflictsOutput.conflicts) &&
        Objects.equals(this.nextToken, batchDescribeMergeConflictsOutput.nextToken) &&
        Objects.equals(this.errors, batchDescribeMergeConflictsOutput.errors) &&
        Objects.equals(this.destinationCommitId, batchDescribeMergeConflictsOutput.destinationCommitId) &&
        Objects.equals(this.sourceCommitId, batchDescribeMergeConflictsOutput.sourceCommitId) &&
        Objects.equals(this.baseCommitId, batchDescribeMergeConflictsOutput.baseCommitId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(conflicts, nextToken, errors, destinationCommitId, sourceCommitId, baseCommitId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BatchDescribeMergeConflictsOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchDescribeMergeConflictsOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchDescribeMergeConflictsOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchDescribeMergeConflictsOutput is not found in the empty JSON string", BatchDescribeMergeConflictsOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchDescribeMergeConflictsOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchDescribeMergeConflictsOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BatchDescribeMergeConflictsOutput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `conflicts`
      List.validateJsonElement(jsonObj.get("conflicts"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchDescribeMergeConflictsOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchDescribeMergeConflictsOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchDescribeMergeConflictsOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchDescribeMergeConflictsOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchDescribeMergeConflictsOutput>() {
           @Override
           public void write(JsonWriter out, BatchDescribeMergeConflictsOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchDescribeMergeConflictsOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchDescribeMergeConflictsOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchDescribeMergeConflictsOutput
   * @throws IOException if the JSON string is invalid with respect to BatchDescribeMergeConflictsOutput
   */
  public static BatchDescribeMergeConflictsOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchDescribeMergeConflictsOutput.class);
  }

  /**
   * Convert an instance of BatchDescribeMergeConflictsOutput to an JSON string
   *
   * @return JSON string
   */
