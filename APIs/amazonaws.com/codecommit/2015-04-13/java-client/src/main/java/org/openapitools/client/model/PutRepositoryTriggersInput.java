...
public class PutRepositoryTriggersInput {
  ...
  public PutRepositoryTriggersInput() {
  }

  public PutRepositoryTriggersInput repositoryName(String repositoryName) {
  ...
  public PutRepositoryTriggersInput triggers(List triggers) {
  ...
  public boolean equals(Object o) {
    ...
    PutRepositoryTriggersInput putRepositoryTriggersInput = (PutRepositoryTriggersInput) o;
    return Objects.equals(this.repositoryName, putRepositoryTriggersInput.repositoryName) &&
        Objects.equals(this.triggers, putRepositoryTriggersInput.triggers);
  }
  ...
  public String toString() {
    ...
    sb.append("class PutRepositoryTriggersInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutRepositoryTriggersInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutRepositoryTriggersInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutRepositoryTriggersInput is not found in the empty JSON string", PutRepositoryTriggersInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutRepositoryTriggersInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutRepositoryTriggersInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PutRepositoryTriggersInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutRepositoryTriggersInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutRepositoryTriggersInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutRepositoryTriggersInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutRepositoryTriggersInput.class));

       return (TypeAdapter<T>) new TypeAdapter<PutRepositoryTriggersInput>() {
           @Override
           public void write(JsonWriter out, PutRepositoryTriggersInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutRepositoryTriggersInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutRepositoryTriggersInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutRepositoryTriggersInput
   * @throws IOException if the JSON string is invalid with respect to PutRepositoryTriggersInput
   */
  public static PutRepositoryTriggersInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutRepositoryTriggersInput.class);
  }

  /**
   * Convert an instance of PutRepositoryTriggersInput to an JSON string
   *
   * @return JSON string
   */
