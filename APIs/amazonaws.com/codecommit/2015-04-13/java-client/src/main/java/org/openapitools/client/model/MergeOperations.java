...
public class MergeOperations {
  ...
  public MergeOperations source(ChangeTypeEnum source) {
    this.source = source;
    return this;
  }
  ...
  public MergeOperations destination(ChangeTypeEnum destination) {
  ...
  public boolean equals(Object o) {
    ...
    MergeOperations mergeOperations = (MergeOperations) o;
    return Objects.equals(this.source, mergeOperations.source) &&
        Objects.equals(this.destination, mergeOperations.destination);
  }
  ...
  public String toString() {
    ...
    sb.append("class MergeOperations {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MergeOperations
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MergeOperations.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MergeOperations is not found in the empty JSON string", MergeOperations.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MergeOperations.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MergeOperations` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MergeOperations.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MergeOperations' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MergeOperations> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MergeOperations.class));

       return (TypeAdapter<T>) new TypeAdapter<MergeOperations>() {
           @Override
           public void write(JsonWriter out, MergeOperations value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MergeOperations read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MergeOperations given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MergeOperations
   * @throws IOException if the JSON string is invalid with respect to MergeOperations
   */
  public static MergeOperations fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MergeOperations.class);
  }

  /**
   * Convert an instance of MergeOperations to an JSON string
   *
   * @return JSON string
   */
