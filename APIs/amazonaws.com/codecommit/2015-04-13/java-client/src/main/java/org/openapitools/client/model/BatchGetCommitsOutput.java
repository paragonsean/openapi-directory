...
public class BatchGetCommitsOutput {
  ...
  public BatchGetCommitsOutput commits(List commits) {
  ...
  public BatchGetCommitsOutput errors(List errors) {
    this.errors = errors;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    BatchGetCommitsOutput batchGetCommitsOutput = (BatchGetCommitsOutput) o;
    return Objects.equals(this.commits, batchGetCommitsOutput.commits) &&
        Objects.equals(this.errors, batchGetCommitsOutput.errors);
  }

  @Override
  public int hashCode() {
    return Objects.hash(commits, errors);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BatchGetCommitsOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchGetCommitsOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchGetCommitsOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchGetCommitsOutput is not found in the empty JSON string", BatchGetCommitsOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchGetCommitsOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchGetCommitsOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `commits`
      if (jsonObj.get("commits") != null && !jsonObj.get("commits").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("commits"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchGetCommitsOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchGetCommitsOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchGetCommitsOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchGetCommitsOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchGetCommitsOutput>() {
           @Override
           public void write(JsonWriter out, BatchGetCommitsOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchGetCommitsOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchGetCommitsOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchGetCommitsOutput
   * @throws IOException if the JSON string is invalid with respect to BatchGetCommitsOutput
   */
  public static BatchGetCommitsOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchGetCommitsOutput.class);
  }

  /**
   * Convert an instance of BatchGetCommitsOutput to an JSON string
   *
   * @return JSON string
   */
