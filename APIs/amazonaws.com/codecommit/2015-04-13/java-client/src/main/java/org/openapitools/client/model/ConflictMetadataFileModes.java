...
import org.openapitools.client.model.FileModeTypeEnum;
...
public class ConflictMetadataFileModes {
  public static final String SERIALIZED_NAME_SOURCE = "source";
  @SerializedName(SERIALIZED_NAME_SOURCE)
  private FileModeTypeEnum source;

  public static final String SERIALIZED_NAME_DESTINATION = "destination";
  @SerializedName(SERIALIZED_NAME_DESTINATION)
  private FileModeTypeEnum destination;

  public static final String SERIALIZED_NAME_BASE = "base";
  @SerializedName(SERIALIZED_NAME_BASE)
  private FileModeTypeEnum base;

  public ConflictMetadataFileModes() {
  }

  public ConflictMetadataFileModes source(FileModeTypeEnum source) {
    this.source = source;
    return this;
  }
  ...
  public FileModeTypeEnum getSource() {
    return source;
  }
  ...
  public ConflictMetadataFileModes destination(FileModeTypeEnum destination) {
   ...
   */
  @javax.annotation.Nullable
  public FileModeTypeEnum getDestination() {
    return destination;
  }
  ...
  public ConflictMetadataFileModes base(FileModeTypeEnum base) {
    this.base = base;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public FileModeTypeEnum getBase() {
    return base;
  }
  ...
  public boolean equals(Object o) {
    ...
    ConflictMetadataFileModes conflictMetadataFileModes = (ConflictMetadataFileModes) o;
    return Objects.equals(this.source, conflictMetadataFileModes.source) &&
        Objects.equals(this.destination, conflictMetadataFileModes.destination) &&
        Objects.equals(this.base, conflictMetadataFileModes.base);
  }

  @Override
  public int hashCode() {
    return Objects.hash(source, destination, base);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConflictMetadataFileModes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConflictMetadataFileModes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConflictMetadataFileModes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConflictMetadataFileModes is not found in the empty JSON string", ConflictMetadataFileModes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConflictMetadataFileModes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConflictMetadataFileModes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `source`
      if (jsonObj.get("source") != null && !jsonObj.get("source").isJsonNull()) {
        FileModeTypeEnum.validateJsonElement(jsonObj.get("source"));
      }
      // validate the optional field `destination`
      if (jsonObj.get("destination") != null && !jsonObj.get("destination").isJsonNull()) {
        FileModeTypeEnum.validateJsonElement(jsonObj.get("destination"));
      }
      // validate the optional field `base`
      if (jsonObj.get("base") != null && !jsonObj.get("base").isJsonNull()) {
        FileModeTypeEnum.validateJsonElement(jsonObj.get("base"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConflictMetadataFileModes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConflictMetadataFileModes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConflictMetadataFileModes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConflictMetadataFileModes.class));

       return (TypeAdapter<T>) new TypeAdapter<ConflictMetadataFileModes>() {
           @Override
           public void write(JsonWriter out, ConflictMetadataFileModes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConflictMetadataFileModes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConflictMetadataFileModes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConflictMetadataFileModes
   * @throws IOException if the JSON string is invalid with respect to ConflictMetadataFileModes
   */
  public static ConflictMetadataFileModes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConflictMetadataFileModes.class);
  }

  /**
   * Convert an instance of ConflictMetadataFileModes to an JSON string
   *
   * @return JSON string
   */
