...
public class GetCommentReactionsOutput {
  public static final String SERIALIZED_NAME_REACTIONS_FOR_COMMENT = "reactionsForComment";
  @SerializedName(SERIALIZED_NAME_REACTIONS_FOR_COMMENT)
  private List reactionsForComment;

  public static final String SERIALIZED_NAME_NEXT_TOKEN = "nextToken";
  @SerializedName(SERIALIZED_NAME_NEXT_TOKEN)
  private String nextToken;

  public GetCommentReactionsOutput() {
  }

  public GetCommentReactionsOutput reactionsForComment(List reactionsForComment) {
    this.reactionsForComment = reactionsForComment;
    return this;
  }

  /**
   * Get reactionsForComment
   * @return reactionsForComment
   */
  @javax.annotation.Nonnull
  public List getReactionsForComment() {
    return reactionsForComment;
  }

  public void setReactionsForComment(List reactionsForComment) {
    this.reactionsForComment = reactionsForComment;
  }


  public GetCommentReactionsOutput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    GetCommentReactionsOutput getCommentReactionsOutput = (GetCommentReactionsOutput) o;
    return Objects.equals(this.reactionsForComment, getCommentReactionsOutput.reactionsForComment) &&
        Objects.equals(this.nextToken, getCommentReactionsOutput.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(reactionsForComment, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetCommentReactionsOutput {\n");
    sb.append("    reactionsForComment: ").append(toIndentedString(reactionsForComment)).append("\n");
  ...
  static {
    ...
    openapiFields.add("reactionsForComment");
    openapiFields.add("nextToken");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("reactionsForComment");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCommentReactionsOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCommentReactionsOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCommentReactionsOutput is not found in the empty JSON string", GetCommentReactionsOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCommentReactionsOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCommentReactionsOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetCommentReactionsOutput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `reactionsForComment`
      List.validateJsonElement(jsonObj.get("reactionsForComment"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCommentReactionsOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCommentReactionsOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCommentReactionsOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCommentReactionsOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCommentReactionsOutput>() {
           @Override
           public void write(JsonWriter out, GetCommentReactionsOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCommentReactionsOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCommentReactionsOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCommentReactionsOutput
   * @throws IOException if the JSON string is invalid with respect to GetCommentReactionsOutput
   */
  public static GetCommentReactionsOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCommentReactionsOutput.class);
  }

  /**
   * Convert an instance of GetCommentReactionsOutput to an JSON string
   *
   * @return JSON string
   */
