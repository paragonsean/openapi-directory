...
public class CreatePullRequestApprovalRuleInput {
  ...
  public CreatePullRequestApprovalRuleInput() {
  }

  public CreatePullRequestApprovalRuleInput pullRequestId(String pullRequestId) {
  ...
  public CreatePullRequestApprovalRuleInput approvalRuleName(String approvalRuleName) {
  ...
  public CreatePullRequestApprovalRuleInput approvalRuleContent(String approvalRuleContent) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePullRequestApprovalRuleInput createPullRequestApprovalRuleInput = (CreatePullRequestApprovalRuleInput) o;
    return Objects.equals(this.pullRequestId, createPullRequestApprovalRuleInput.pullRequestId) &&
        Objects.equals(this.approvalRuleName, createPullRequestApprovalRuleInput.approvalRuleName) &&
        Objects.equals(this.approvalRuleContent, createPullRequestApprovalRuleInput.approvalRuleContent);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pullRequestId, approvalRuleName, approvalRuleContent);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreatePullRequestApprovalRuleInput {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("approvalRuleContent");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePullRequestApprovalRuleInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePullRequestApprovalRuleInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePullRequestApprovalRuleInput is not found in the empty JSON string", CreatePullRequestApprovalRuleInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePullRequestApprovalRuleInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePullRequestApprovalRuleInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreatePullRequestApprovalRuleInput.openapiRequiredFields) {
      ...
      // validate the required field `approvalRuleContent`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePullRequestApprovalRuleInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePullRequestApprovalRuleInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePullRequestApprovalRuleInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePullRequestApprovalRuleInput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePullRequestApprovalRuleInput>() {
           @Override
           public void write(JsonWriter out, CreatePullRequestApprovalRuleInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePullRequestApprovalRuleInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePullRequestApprovalRuleInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePullRequestApprovalRuleInput
   * @throws IOException if the JSON string is invalid with respect to CreatePullRequestApprovalRuleInput
   */
  public static CreatePullRequestApprovalRuleInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePullRequestApprovalRuleInput.class);
  }

  /**
   * Convert an instance of CreatePullRequestApprovalRuleInput to an JSON string
   *
   * @return JSON string
   */
