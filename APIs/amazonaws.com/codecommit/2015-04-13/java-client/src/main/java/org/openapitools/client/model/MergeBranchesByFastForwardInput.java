...
public class MergeBranchesByFastForwardInput {
  ...
  public MergeBranchesByFastForwardInput() {
  }

  public MergeBranchesByFastForwardInput repositoryName(String repositoryName) {
  ...
  public MergeBranchesByFastForwardInput sourceCommitSpecifier(String sourceCommitSpecifier) {
  ...
  public MergeBranchesByFastForwardInput destinationCommitSpecifier(String destinationCommitSpecifier) {
  ...
  public MergeBranchesByFastForwardInput targetBranch(String targetBranch) {
  ...
  public boolean equals(Object o) {
    ...
    MergeBranchesByFastForwardInput mergeBranchesByFastForwardInput = (MergeBranchesByFastForwardInput) o;
    return Objects.equals(this.repositoryName, mergeBranchesByFastForwardInput.repositoryName) &&
        Objects.equals(this.sourceCommitSpecifier, mergeBranchesByFastForwardInput.sourceCommitSpecifier) &&
        Objects.equals(this.destinationCommitSpecifier, mergeBranchesByFastForwardInput.destinationCommitSpecifier) &&
        Objects.equals(this.targetBranch, mergeBranchesByFastForwardInput.targetBranch);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, sourceCommitSpecifier, destinationCommitSpecifier, targetBranch);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MergeBranchesByFastForwardInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MergeBranchesByFastForwardInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MergeBranchesByFastForwardInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MergeBranchesByFastForwardInput is not found in the empty JSON string", MergeBranchesByFastForwardInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MergeBranchesByFastForwardInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MergeBranchesByFastForwardInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MergeBranchesByFastForwardInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MergeBranchesByFastForwardInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MergeBranchesByFastForwardInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MergeBranchesByFastForwardInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MergeBranchesByFastForwardInput.class));

       return (TypeAdapter<T>) new TypeAdapter<MergeBranchesByFastForwardInput>() {
           @Override
           public void write(JsonWriter out, MergeBranchesByFastForwardInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MergeBranchesByFastForwardInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MergeBranchesByFastForwardInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MergeBranchesByFastForwardInput
   * @throws IOException if the JSON string is invalid with respect to MergeBranchesByFastForwardInput
   */
  public static MergeBranchesByFastForwardInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MergeBranchesByFastForwardInput.class);
  }

  /**
   * Convert an instance of MergeBranchesByFastForwardInput to an JSON string
   *
   * @return JSON string
   */
