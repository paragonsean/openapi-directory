...
public class TestRepositoryTriggersInput {
  ...
  public TestRepositoryTriggersInput() {
  }

  public TestRepositoryTriggersInput repositoryName(String repositoryName) {
  ...
  public TestRepositoryTriggersInput triggers(List triggers) {
  ...
  public boolean equals(Object o) {
    ...
    TestRepositoryTriggersInput testRepositoryTriggersInput = (TestRepositoryTriggersInput) o;
    return Objects.equals(this.repositoryName, testRepositoryTriggersInput.repositoryName) &&
        Objects.equals(this.triggers, testRepositoryTriggersInput.triggers);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, triggers);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TestRepositoryTriggersInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestRepositoryTriggersInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestRepositoryTriggersInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestRepositoryTriggersInput is not found in the empty JSON string", TestRepositoryTriggersInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestRepositoryTriggersInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestRepositoryTriggersInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestRepositoryTriggersInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestRepositoryTriggersInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestRepositoryTriggersInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestRepositoryTriggersInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestRepositoryTriggersInput.class));

       return (TypeAdapter<T>) new TypeAdapter<TestRepositoryTriggersInput>() {
           @Override
           public void write(JsonWriter out, TestRepositoryTriggersInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestRepositoryTriggersInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestRepositoryTriggersInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestRepositoryTriggersInput
   * @throws IOException if the JSON string is invalid with respect to TestRepositoryTriggersInput
   */
  public static TestRepositoryTriggersInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestRepositoryTriggersInput.class);
  }

  /**
   * Convert an instance of TestRepositoryTriggersInput to an JSON string
   *
   * @return JSON string
   */
