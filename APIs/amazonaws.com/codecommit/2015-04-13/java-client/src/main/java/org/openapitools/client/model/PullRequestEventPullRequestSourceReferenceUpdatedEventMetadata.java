...
public class PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata {
  ...
  public PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata() {
  }

  public PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata repositoryName(String repositoryName) {
  ...
  public PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata beforeCommitId(String beforeCommitId) {
  ...
  public PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata afterCommitId(String afterCommitId) {
  ...
  public PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata mergeBase(String mergeBase) {
  ...
  public boolean equals(Object o) {
    ...
    PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata pullRequestEventPullRequestSourceReferenceUpdatedEventMetadata = (PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata) o;
    return Objects.equals(this.repositoryName, pullRequestEventPullRequestSourceReferenceUpdatedEventMetadata.repositoryName) &&
        Objects.equals(this.beforeCommitId, pullRequestEventPullRequestSourceReferenceUpdatedEventMetadata.beforeCommitId) &&
        Objects.equals(this.afterCommitId, pullRequestEventPullRequestSourceReferenceUpdatedEventMetadata.afterCommitId) &&
        Objects.equals(this.mergeBase, pullRequestEventPullRequestSourceReferenceUpdatedEventMetadata.mergeBase);
  }
  ...
  public String toString() {
    ...
    sb.append("class PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata is not found in the empty JSON string", PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata>() {
           @Override
           public void write(JsonWriter out, PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata
   * @throws IOException if the JSON string is invalid with respect to PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata
   */
  public static PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata.class);
  }

  /**
   * Convert an instance of PullRequestEventPullRequestSourceReferenceUpdatedEventMetadata to an JSON string
   *
   * @return JSON string
   */
