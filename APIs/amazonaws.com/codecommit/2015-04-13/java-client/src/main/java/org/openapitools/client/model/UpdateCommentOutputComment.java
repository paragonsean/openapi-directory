...
public class UpdateCommentOutputComment {
  ...
  public UpdateCommentOutputComment() {
  }

  public UpdateCommentOutputComment commentId(String commentId) {
  ...
  public UpdateCommentOutputComment content(String content) {
  ...
  public UpdateCommentOutputComment inReplyTo(String inReplyTo) {
  ...
  public UpdateCommentOutputComment creationDate(OffsetDateTime creationDate) {
  ...
  public UpdateCommentOutputComment lastModifiedDate(OffsetDateTime lastModifiedDate) {
  ...
  public UpdateCommentOutputComment authorArn(String authorArn) {
  ...
  public UpdateCommentOutputComment deleted(Boolean deleted) {
  ...
  public UpdateCommentOutputComment clientRequestToken(String clientRequestToken) {
  ...
  public UpdateCommentOutputComment callerReactions(List callerReactions) {
  ...
  public UpdateCommentOutputComment reactionCounts(Map reactionCounts) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateCommentOutputComment updateCommentOutputComment = (UpdateCommentOutputComment) o;
    return Objects.equals(this.commentId, updateCommentOutputComment.commentId) &&
        Objects.equals(this.content, updateCommentOutputComment.content) &&
        Objects.equals(this.inReplyTo, updateCommentOutputComment.inReplyTo) &&
        Objects.equals(this.creationDate, updateCommentOutputComment.creationDate) &&
        Objects.equals(this.lastModifiedDate, updateCommentOutputComment.lastModifiedDate) &&
        Objects.equals(this.authorArn, updateCommentOutputComment.authorArn) &&
        Objects.equals(this.deleted, updateCommentOutputComment.deleted) &&
        Objects.equals(this.clientRequestToken, updateCommentOutputComment.clientRequestToken) &&
        Objects.equals(this.callerReactions, updateCommentOutputComment.callerReactions) &&
        Objects.equals(this.reactionCounts, updateCommentOutputComment.reactionCounts);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateCommentOutputComment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateCommentOutputComment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateCommentOutputComment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateCommentOutputComment is not found in the empty JSON string", UpdateCommentOutputComment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateCommentOutputComment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateCommentOutputComment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateCommentOutputComment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateCommentOutputComment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateCommentOutputComment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateCommentOutputComment.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateCommentOutputComment>() {
           @Override
           public void write(JsonWriter out, UpdateCommentOutputComment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateCommentOutputComment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateCommentOutputComment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateCommentOutputComment
   * @throws IOException if the JSON string is invalid with respect to UpdateCommentOutputComment
   */
  public static UpdateCommentOutputComment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateCommentOutputComment.class);
  }

  /**
   * Convert an instance of UpdateCommentOutputComment to an JSON string
   *
   * @return JSON string
   */
