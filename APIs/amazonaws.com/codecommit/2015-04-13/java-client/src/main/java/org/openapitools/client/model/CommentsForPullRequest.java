...
public class CommentsForPullRequest {
  ...
  private CommentsForPullRequestLocation location;

  public static final String SERIALIZED_NAME_COMMENTS = "comments";
  @SerializedName(SERIALIZED_NAME_COMMENTS)
  private List comments;

  public CommentsForPullRequest() {
  }

  public CommentsForPullRequest pullRequestId(String pullRequestId) {
  ...
  public CommentsForPullRequest repositoryName(String repositoryName) {
  ...
  public CommentsForPullRequest beforeCommitId(String beforeCommitId) {
  ...
  public CommentsForPullRequest afterCommitId(String afterCommitId) {
  ...
  public CommentsForPullRequest beforeBlobId(String beforeBlobId) {
  ...
  public CommentsForPullRequest afterBlobId(String afterBlobId) {
  ...
  public CommentsForPullRequest location(CommentsForPullRequestLocation location) {
   ...
   */
  @javax.annotation.Nullable
  public CommentsForPullRequestLocation getLocation() {
    return location;
  }

  public void setLocation(CommentsForPullRequestLocation location) {
    this.location = location;
  }


  public CommentsForPullRequest comments(List comments) {
  ...
  public boolean equals(Object o) {
    ...
    CommentsForPullRequest commentsForPullRequest = (CommentsForPullRequest) o;
    return Objects.equals(this.pullRequestId, commentsForPullRequest.pullRequestId) &&
        Objects.equals(this.repositoryName, commentsForPullRequest.repositoryName) &&
        Objects.equals(this.beforeCommitId, commentsForPullRequest.beforeCommitId) &&
        Objects.equals(this.afterCommitId, commentsForPullRequest.afterCommitId) &&
        Objects.equals(this.beforeBlobId, commentsForPullRequest.beforeBlobId) &&
        Objects.equals(this.afterBlobId, commentsForPullRequest.afterBlobId) &&
        Objects.equals(this.location, commentsForPullRequest.location) &&
        Objects.equals(this.comments, commentsForPullRequest.comments);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pullRequestId, repositoryName, beforeCommitId, afterCommitId, beforeBlobId, afterBlobId, location, comments);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CommentsForPullRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CommentsForPullRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommentsForPullRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CommentsForPullRequest is not found in the empty JSON string", CommentsForPullRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CommentsForPullRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CommentsForPullRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("location") != null && !jsonObj.get("location").isJsonNull()) {
        CommentsForPullRequestLocation.validateJsonElement(jsonObj.get("location"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CommentsForPullRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CommentsForPullRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CommentsForPullRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CommentsForPullRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CommentsForPullRequest>() {
           @Override
           public void write(JsonWriter out, CommentsForPullRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CommentsForPullRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CommentsForPullRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CommentsForPullRequest
   * @throws IOException if the JSON string is invalid with respect to CommentsForPullRequest
   */
  public static CommentsForPullRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CommentsForPullRequest.class);
  }

  /**
   * Convert an instance of CommentsForPullRequest to an JSON string
   *
   * @return JSON string
   */
