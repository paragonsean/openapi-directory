...
public class RepositoryNameIdPair {
  ...
  public RepositoryNameIdPair repositoryName(String repositoryName) {
  ...
  public RepositoryNameIdPair repositoryId(String repositoryId) {
  ...
  public boolean equals(Object o) {
    ...
    RepositoryNameIdPair repositoryNameIdPair = (RepositoryNameIdPair) o;
    return Objects.equals(this.repositoryName, repositoryNameIdPair.repositoryName) &&
        Objects.equals(this.repositoryId, repositoryNameIdPair.repositoryId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, repositoryId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RepositoryNameIdPair {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RepositoryNameIdPair
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RepositoryNameIdPair.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RepositoryNameIdPair is not found in the empty JSON string", RepositoryNameIdPair.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RepositoryNameIdPair.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RepositoryNameIdPair` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RepositoryNameIdPair.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RepositoryNameIdPair' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RepositoryNameIdPair> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RepositoryNameIdPair.class));

       return (TypeAdapter<T>) new TypeAdapter<RepositoryNameIdPair>() {
           @Override
           public void write(JsonWriter out, RepositoryNameIdPair value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RepositoryNameIdPair read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RepositoryNameIdPair given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RepositoryNameIdPair
   * @throws IOException if the JSON string is invalid with respect to RepositoryNameIdPair
   */
  public static RepositoryNameIdPair fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RepositoryNameIdPair.class);
  }

  /**
   * Convert an instance of RepositoryNameIdPair to an JSON string
   *
   * @return JSON string
   */
