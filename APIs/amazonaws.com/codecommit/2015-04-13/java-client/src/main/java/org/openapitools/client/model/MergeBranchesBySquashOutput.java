...
public class MergeBranchesBySquashOutput {
  ...
  public static final String SERIALIZED_NAME_TREE_ID = "treeId";
  ...
  public MergeBranchesBySquashOutput commitId(String commitId) {
  ...
  public MergeBranchesBySquashOutput treeId(String treeId) {
    this.treeId = treeId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MergeBranchesBySquashOutput mergeBranchesBySquashOutput = (MergeBranchesBySquashOutput) o;
    return Objects.equals(this.commitId, mergeBranchesBySquashOutput.commitId) &&
        Objects.equals(this.treeId, mergeBranchesBySquashOutput.treeId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(commitId, treeId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MergeBranchesBySquashOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MergeBranchesBySquashOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MergeBranchesBySquashOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MergeBranchesBySquashOutput is not found in the empty JSON string", MergeBranchesBySquashOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MergeBranchesBySquashOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MergeBranchesBySquashOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `treeId`
      if (jsonObj.get("treeId") != null && !jsonObj.get("treeId").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("treeId"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MergeBranchesBySquashOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MergeBranchesBySquashOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MergeBranchesBySquashOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MergeBranchesBySquashOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<MergeBranchesBySquashOutput>() {
           @Override
           public void write(JsonWriter out, MergeBranchesBySquashOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MergeBranchesBySquashOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MergeBranchesBySquashOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MergeBranchesBySquashOutput
   * @throws IOException if the JSON string is invalid with respect to MergeBranchesBySquashOutput
   */
  public static MergeBranchesBySquashOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MergeBranchesBySquashOutput.class);
  }

  /**
   * Convert an instance of MergeBranchesBySquashOutput to an JSON string
   *
   * @return JSON string
   */
