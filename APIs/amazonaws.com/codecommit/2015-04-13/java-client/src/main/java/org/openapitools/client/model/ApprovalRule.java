...
public class ApprovalRule {
  ...
  public ApprovalRule approvalRuleId(String approvalRuleId) {
  ...
  public ApprovalRule approvalRuleName(String approvalRuleName) {
  ...
  public ApprovalRule approvalRuleContent(String approvalRuleContent) {
  ...
  public ApprovalRule ruleContentSha256(String ruleContentSha256) {
  ...
  public ApprovalRule lastModifiedDate(OffsetDateTime lastModifiedDate) {
  ...
  public ApprovalRule creationDate(OffsetDateTime creationDate) {
  ...
  public ApprovalRule lastModifiedUser(String lastModifiedUser) {
  ...
  public ApprovalRule originApprovalRuleTemplate(ApprovalRuleOriginApprovalRuleTemplate originApprovalRuleTemplate) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.approvalRuleId, approvalRule.approvalRuleId) &&
        Objects.equals(this.approvalRuleName, approvalRule.approvalRuleName) &&
        Objects.equals(this.approvalRuleContent, approvalRule.approvalRuleContent) &&
        Objects.equals(this.ruleContentSha256, approvalRule.ruleContentSha256) &&
        Objects.equals(this.lastModifiedDate, approvalRule.lastModifiedDate) &&
        Objects.equals(this.creationDate, approvalRule.creationDate) &&
        Objects.equals(this.lastModifiedUser, approvalRule.lastModifiedUser) &&
        Objects.equals(this.originApprovalRuleTemplate, approvalRule.originApprovalRuleTemplate);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApprovalRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApprovalRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApprovalRule is not found in the empty JSON string", ApprovalRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApprovalRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApprovalRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApprovalRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApprovalRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApprovalRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApprovalRule.class));

       return (TypeAdapter<T>) new TypeAdapter<ApprovalRule>() {
           @Override
           public void write(JsonWriter out, ApprovalRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApprovalRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApprovalRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApprovalRule
   * @throws IOException if the JSON string is invalid with respect to ApprovalRule
   */
  public static ApprovalRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApprovalRule.class);
  }

  /**
   * Convert an instance of ApprovalRule to an JSON string
   *
   * @return JSON string
   */
