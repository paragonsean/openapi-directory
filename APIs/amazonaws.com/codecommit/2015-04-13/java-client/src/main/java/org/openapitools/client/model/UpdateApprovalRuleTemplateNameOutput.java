...
import org.openapitools.client.model.UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate;
...
public class UpdateApprovalRuleTemplateNameOutput {
  ...
  private UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate approvalRuleTemplate;

  public UpdateApprovalRuleTemplateNameOutput() {
  }

  public UpdateApprovalRuleTemplateNameOutput approvalRuleTemplate(UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate approvalRuleTemplate) {
  ...
  public UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate getApprovalRuleTemplate() {
    return approvalRuleTemplate;
  }

  public void setApprovalRuleTemplate(UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate approvalRuleTemplate) {
    this.approvalRuleTemplate = approvalRuleTemplate;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateApprovalRuleTemplateNameOutput updateApprovalRuleTemplateNameOutput = (UpdateApprovalRuleTemplateNameOutput) o;
    return Objects.equals(this.approvalRuleTemplate, updateApprovalRuleTemplateNameOutput.approvalRuleTemplate);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateApprovalRuleTemplateNameOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateApprovalRuleTemplateNameOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateApprovalRuleTemplateNameOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateApprovalRuleTemplateNameOutput is not found in the empty JSON string", UpdateApprovalRuleTemplateNameOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateApprovalRuleTemplateNameOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateApprovalRuleTemplateNameOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateApprovalRuleTemplateNameOutput.openapiRequiredFields) {
      ...
      UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate.validateJsonElement(jsonObj.get("approvalRuleTemplate"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateApprovalRuleTemplateNameOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateApprovalRuleTemplateNameOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateApprovalRuleTemplateNameOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateApprovalRuleTemplateNameOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateApprovalRuleTemplateNameOutput>() {
           @Override
           public void write(JsonWriter out, UpdateApprovalRuleTemplateNameOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateApprovalRuleTemplateNameOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateApprovalRuleTemplateNameOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateApprovalRuleTemplateNameOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateApprovalRuleTemplateNameOutput
   */
  public static UpdateApprovalRuleTemplateNameOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateApprovalRuleTemplateNameOutput.class);
  }

  /**
   * Convert an instance of UpdateApprovalRuleTemplateNameOutput to an JSON string
   *
   * @return JSON string
   */
