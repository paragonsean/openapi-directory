...
public class PullRequestEventPullRequestStatusChangedEventMetadata {
  ...
  public PullRequestEventPullRequestStatusChangedEventMetadata() {
  }

  public PullRequestEventPullRequestStatusChangedEventMetadata pullRequestStatus(PullRequestStatusEnum pullRequestStatus) {
  ...
  public boolean equals(Object o) {
    ...
    PullRequestEventPullRequestStatusChangedEventMetadata pullRequestEventPullRequestStatusChangedEventMetadata = (PullRequestEventPullRequestStatusChangedEventMetadata) o;
    return Objects.equals(this.pullRequestStatus, pullRequestEventPullRequestStatusChangedEventMetadata.pullRequestStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pullRequestStatus);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PullRequestEventPullRequestStatusChangedEventMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PullRequestEventPullRequestStatusChangedEventMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PullRequestEventPullRequestStatusChangedEventMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PullRequestEventPullRequestStatusChangedEventMetadata is not found in the empty JSON string", PullRequestEventPullRequestStatusChangedEventMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PullRequestEventPullRequestStatusChangedEventMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PullRequestEventPullRequestStatusChangedEventMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PullRequestEventPullRequestStatusChangedEventMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PullRequestEventPullRequestStatusChangedEventMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PullRequestEventPullRequestStatusChangedEventMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PullRequestEventPullRequestStatusChangedEventMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<PullRequestEventPullRequestStatusChangedEventMetadata>() {
           @Override
           public void write(JsonWriter out, PullRequestEventPullRequestStatusChangedEventMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PullRequestEventPullRequestStatusChangedEventMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PullRequestEventPullRequestStatusChangedEventMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PullRequestEventPullRequestStatusChangedEventMetadata
   * @throws IOException if the JSON string is invalid with respect to PullRequestEventPullRequestStatusChangedEventMetadata
   */
  public static PullRequestEventPullRequestStatusChangedEventMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PullRequestEventPullRequestStatusChangedEventMetadata.class);
  }

  /**
   * Convert an instance of PullRequestEventPullRequestStatusChangedEventMetadata to an JSON string
   *
   * @return JSON string
   */
