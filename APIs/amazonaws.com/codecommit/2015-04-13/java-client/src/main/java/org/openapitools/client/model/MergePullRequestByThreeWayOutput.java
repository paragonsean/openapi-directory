...
public class MergePullRequestByThreeWayOutput {
  ...
  public MergePullRequestByThreeWayOutput pullRequest(PullRequest pullRequest) {
  ...
  public boolean equals(Object o) {
    ...
    MergePullRequestByThreeWayOutput mergePullRequestByThreeWayOutput = (MergePullRequestByThreeWayOutput) o;
    return Objects.equals(this.pullRequest, mergePullRequestByThreeWayOutput.pullRequest);
  }
  ...
  public String toString() {
    ...
    sb.append("class MergePullRequestByThreeWayOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MergePullRequestByThreeWayOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MergePullRequestByThreeWayOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MergePullRequestByThreeWayOutput is not found in the empty JSON string", MergePullRequestByThreeWayOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MergePullRequestByThreeWayOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MergePullRequestByThreeWayOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `pullRequest`
      if (jsonObj.get("pullRequest") != null && !jsonObj.get("pullRequest").isJsonNull()) {
        PullRequest.validateJsonElement(jsonObj.get("pullRequest"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MergePullRequestByThreeWayOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MergePullRequestByThreeWayOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MergePullRequestByThreeWayOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MergePullRequestByThreeWayOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<MergePullRequestByThreeWayOutput>() {
           @Override
           public void write(JsonWriter out, MergePullRequestByThreeWayOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MergePullRequestByThreeWayOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MergePullRequestByThreeWayOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MergePullRequestByThreeWayOutput
   * @throws IOException if the JSON string is invalid with respect to MergePullRequestByThreeWayOutput
   */
  public static MergePullRequestByThreeWayOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MergePullRequestByThreeWayOutput.class);
  }

  /**
   * Convert an instance of MergePullRequestByThreeWayOutput to an JSON string
   *
   * @return JSON string
   */
