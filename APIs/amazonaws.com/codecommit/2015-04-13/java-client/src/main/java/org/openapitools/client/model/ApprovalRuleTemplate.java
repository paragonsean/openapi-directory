...
public class ApprovalRuleTemplate {
  ...
  public ApprovalRuleTemplate approvalRuleTemplateId(String approvalRuleTemplateId) {
  ...
  public ApprovalRuleTemplate approvalRuleTemplateName(String approvalRuleTemplateName) {
  ...
  public ApprovalRuleTemplate approvalRuleTemplateDescription(String approvalRuleTemplateDescription) {
  ...
  public ApprovalRuleTemplate approvalRuleTemplateContent(String approvalRuleTemplateContent) {
  ...
  public ApprovalRuleTemplate ruleContentSha256(String ruleContentSha256) {
  ...
  public ApprovalRuleTemplate lastModifiedDate(OffsetDateTime lastModifiedDate) {
  ...
  public ApprovalRuleTemplate creationDate(OffsetDateTime creationDate) {
  ...
  public ApprovalRuleTemplate lastModifiedUser(String lastModifiedUser) {
  ...
  public boolean equals(Object o) {
    ...
    ApprovalRuleTemplate approvalRuleTemplate = (ApprovalRuleTemplate) o;
    return Objects.equals(this.approvalRuleTemplateId, approvalRuleTemplate.approvalRuleTemplateId) &&
        Objects.equals(this.approvalRuleTemplateName, approvalRuleTemplate.approvalRuleTemplateName) &&
        Objects.equals(this.approvalRuleTemplateDescription, approvalRuleTemplate.approvalRuleTemplateDescription) &&
        Objects.equals(this.approvalRuleTemplateContent, approvalRuleTemplate.approvalRuleTemplateContent) &&
        Objects.equals(this.ruleContentSha256, approvalRuleTemplate.ruleContentSha256) &&
        Objects.equals(this.lastModifiedDate, approvalRuleTemplate.lastModifiedDate) &&
        Objects.equals(this.creationDate, approvalRuleTemplate.creationDate) &&
        Objects.equals(this.lastModifiedUser, approvalRuleTemplate.lastModifiedUser);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApprovalRuleTemplate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApprovalRuleTemplate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApprovalRuleTemplate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApprovalRuleTemplate is not found in the empty JSON string", ApprovalRuleTemplate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApprovalRuleTemplate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApprovalRuleTemplate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApprovalRuleTemplate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApprovalRuleTemplate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApprovalRuleTemplate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApprovalRuleTemplate.class));

       return (TypeAdapter<T>) new TypeAdapter<ApprovalRuleTemplate>() {
           @Override
           public void write(JsonWriter out, ApprovalRuleTemplate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApprovalRuleTemplate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApprovalRuleTemplate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApprovalRuleTemplate
   * @throws IOException if the JSON string is invalid with respect to ApprovalRuleTemplate
   */
  public static ApprovalRuleTemplate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApprovalRuleTemplate.class);
  }

  /**
   * Convert an instance of ApprovalRuleTemplate to an JSON string
   *
   * @return JSON string
   */
