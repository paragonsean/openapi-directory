...
public class ListRepositoriesForApprovalRuleTemplateOutput {
  ...
  public ListRepositoriesForApprovalRuleTemplateOutput repositoryNames(List repositoryNames) {
  ...
  public ListRepositoriesForApprovalRuleTemplateOutput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListRepositoriesForApprovalRuleTemplateOutput listRepositoriesForApprovalRuleTemplateOutput = (ListRepositoriesForApprovalRuleTemplateOutput) o;
    return Objects.equals(this.repositoryNames, listRepositoriesForApprovalRuleTemplateOutput.repositoryNames) &&
        Objects.equals(this.nextToken, listRepositoriesForApprovalRuleTemplateOutput.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryNames, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListRepositoriesForApprovalRuleTemplateOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListRepositoriesForApprovalRuleTemplateOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListRepositoriesForApprovalRuleTemplateOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListRepositoriesForApprovalRuleTemplateOutput is not found in the empty JSON string", ListRepositoriesForApprovalRuleTemplateOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListRepositoriesForApprovalRuleTemplateOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListRepositoriesForApprovalRuleTemplateOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListRepositoriesForApprovalRuleTemplateOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListRepositoriesForApprovalRuleTemplateOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListRepositoriesForApprovalRuleTemplateOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListRepositoriesForApprovalRuleTemplateOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListRepositoriesForApprovalRuleTemplateOutput>() {
           @Override
           public void write(JsonWriter out, ListRepositoriesForApprovalRuleTemplateOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListRepositoriesForApprovalRuleTemplateOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListRepositoriesForApprovalRuleTemplateOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListRepositoriesForApprovalRuleTemplateOutput
   * @throws IOException if the JSON string is invalid with respect to ListRepositoriesForApprovalRuleTemplateOutput
   */
  public static ListRepositoriesForApprovalRuleTemplateOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListRepositoriesForApprovalRuleTemplateOutput.class);
  }

  /**
   * Convert an instance of ListRepositoriesForApprovalRuleTemplateOutput to an JSON string
   *
   * @return JSON string
   */
