...
public class FileModes {
  ...
  public FileModes source(FileModeTypeEnum source) {
    this.source = source;
    return this;
  }
  ...
  public FileModes destination(FileModeTypeEnum destination) {
  ...
  public FileModes base(FileModeTypeEnum base) {
    this.base = base;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FileModes fileModes = (FileModes) o;
    return Objects.equals(this.source, fileModes.source) &&
        Objects.equals(this.destination, fileModes.destination) &&
        Objects.equals(this.base, fileModes.base);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FileModes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FileModes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileModes is not found in the empty JSON string", FileModes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FileModes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FileModes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileModes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileModes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileModes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileModes.class));

       return (TypeAdapter<T>) new TypeAdapter<FileModes>() {
           @Override
           public void write(JsonWriter out, FileModes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FileModes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FileModes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FileModes
   * @throws IOException if the JSON string is invalid with respect to FileModes
   */
  public static FileModes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileModes.class);
  }

  /**
   * Convert an instance of FileModes to an JSON string
   *
   * @return JSON string
   */
