...
public class DifferenceBeforeBlob {
  ...
  public DifferenceBeforeBlob() {
  }

  public DifferenceBeforeBlob blobId(String blobId) {
    this.blobId = blobId;
    return this;
  }
  ...
  public DifferenceBeforeBlob path(String path) {
    this.path = path;
    return this;
  }
  ...
  public DifferenceBeforeBlob mode(String mode) {
    this.mode = mode;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DifferenceBeforeBlob differenceBeforeBlob = (DifferenceBeforeBlob) o;
    return Objects.equals(this.blobId, differenceBeforeBlob.blobId) &&
        Objects.equals(this.path, differenceBeforeBlob.path) &&
        Objects.equals(this.mode, differenceBeforeBlob.mode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(blobId, path, mode);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DifferenceBeforeBlob {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DifferenceBeforeBlob
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DifferenceBeforeBlob.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DifferenceBeforeBlob is not found in the empty JSON string", DifferenceBeforeBlob.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DifferenceBeforeBlob.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DifferenceBeforeBlob` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `blobId`
      if (jsonObj.get("blobId") != null && !jsonObj.get("blobId").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("blobId"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DifferenceBeforeBlob.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DifferenceBeforeBlob' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DifferenceBeforeBlob> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DifferenceBeforeBlob.class));

       return (TypeAdapter<T>) new TypeAdapter<DifferenceBeforeBlob>() {
           @Override
           public void write(JsonWriter out, DifferenceBeforeBlob value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DifferenceBeforeBlob read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DifferenceBeforeBlob given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DifferenceBeforeBlob
   * @throws IOException if the JSON string is invalid with respect to DifferenceBeforeBlob
   */
  public static DifferenceBeforeBlob fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DifferenceBeforeBlob.class);
  }

  /**
   * Convert an instance of DifferenceBeforeBlob to an JSON string
   *
   * @return JSON string
   */
