...
public class PutFileOutput {
  ...
  public PutFileOutput() {
  }

  public PutFileOutput commitId(String commitId) {
  ...
  public PutFileOutput blobId(String blobId) {
    this.blobId = blobId;
    return this;
  }
  ...
  public PutFileOutput treeId(String treeId) {
    this.treeId = treeId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PutFileOutput putFileOutput = (PutFileOutput) o;
    return Objects.equals(this.commitId, putFileOutput.commitId) &&
        Objects.equals(this.blobId, putFileOutput.blobId) &&
        Objects.equals(this.treeId, putFileOutput.treeId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(commitId, blobId, treeId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutFileOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutFileOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutFileOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutFileOutput is not found in the empty JSON string", PutFileOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutFileOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutFileOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PutFileOutput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutFileOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutFileOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutFileOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutFileOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<PutFileOutput>() {
           @Override
           public void write(JsonWriter out, PutFileOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutFileOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutFileOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutFileOutput
   * @throws IOException if the JSON string is invalid with respect to PutFileOutput
   */
  public static PutFileOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutFileOutput.class);
  }

  /**
   * Convert an instance of PutFileOutput to an JSON string
   *
   * @return JSON string
   */
