...
public class CreateUnreferencedMergeCommitOutput {
  ...
  public CreateUnreferencedMergeCommitOutput commitId(String commitId) {
  ...
  public CreateUnreferencedMergeCommitOutput treeId(String treeId) {
    this.treeId = treeId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateUnreferencedMergeCommitOutput createUnreferencedMergeCommitOutput = (CreateUnreferencedMergeCommitOutput) o;
    return Objects.equals(this.commitId, createUnreferencedMergeCommitOutput.commitId) &&
        Objects.equals(this.treeId, createUnreferencedMergeCommitOutput.treeId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateUnreferencedMergeCommitOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateUnreferencedMergeCommitOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateUnreferencedMergeCommitOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateUnreferencedMergeCommitOutput is not found in the empty JSON string", CreateUnreferencedMergeCommitOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateUnreferencedMergeCommitOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateUnreferencedMergeCommitOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateUnreferencedMergeCommitOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateUnreferencedMergeCommitOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateUnreferencedMergeCommitOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateUnreferencedMergeCommitOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateUnreferencedMergeCommitOutput>() {
           @Override
           public void write(JsonWriter out, CreateUnreferencedMergeCommitOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateUnreferencedMergeCommitOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateUnreferencedMergeCommitOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateUnreferencedMergeCommitOutput
   * @throws IOException if the JSON string is invalid with respect to CreateUnreferencedMergeCommitOutput
   */
  public static CreateUnreferencedMergeCommitOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateUnreferencedMergeCommitOutput.class);
  }

  /**
   * Convert an instance of CreateUnreferencedMergeCommitOutput to an JSON string
   *
   * @return JSON string
   */
