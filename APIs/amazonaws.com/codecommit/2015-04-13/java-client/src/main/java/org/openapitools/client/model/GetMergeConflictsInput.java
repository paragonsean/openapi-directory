...
public class GetMergeConflictsInput {
  ...
  public static final String SERIALIZED_NAME_MAX_CONFLICT_FILES = "maxConflictFiles";
  @SerializedName(SERIALIZED_NAME_MAX_CONFLICT_FILES)
  ...
  public GetMergeConflictsInput() {
  }

  public GetMergeConflictsInput repositoryName(String repositoryName) {
  ...
  public GetMergeConflictsInput destinationCommitSpecifier(String destinationCommitSpecifier) {
  ...
  public GetMergeConflictsInput sourceCommitSpecifier(String sourceCommitSpecifier) {
  ...
  public GetMergeConflictsInput mergeOption(MergeOptionTypeEnum mergeOption) {
  ...
  public GetMergeConflictsInput conflictDetailLevel(ConflictDetailLevelTypeEnum conflictDetailLevel) {
  ...
  public GetMergeConflictsInput maxConflictFiles(Integer maxConflictFiles) {
  ...
  public GetMergeConflictsInput conflictResolutionStrategy(ConflictResolutionStrategyTypeEnum conflictResolutionStrategy) {
  ...
  public GetMergeConflictsInput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    GetMergeConflictsInput getMergeConflictsInput = (GetMergeConflictsInput) o;
    return Objects.equals(this.repositoryName, getMergeConflictsInput.repositoryName) &&
        Objects.equals(this.destinationCommitSpecifier, getMergeConflictsInput.destinationCommitSpecifier) &&
        Objects.equals(this.sourceCommitSpecifier, getMergeConflictsInput.sourceCommitSpecifier) &&
        Objects.equals(this.mergeOption, getMergeConflictsInput.mergeOption) &&
        Objects.equals(this.conflictDetailLevel, getMergeConflictsInput.conflictDetailLevel) &&
        Objects.equals(this.maxConflictFiles, getMergeConflictsInput.maxConflictFiles) &&
        Objects.equals(this.conflictResolutionStrategy, getMergeConflictsInput.conflictResolutionStrategy) &&
        Objects.equals(this.nextToken, getMergeConflictsInput.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, destinationCommitSpecifier, sourceCommitSpecifier, mergeOption, conflictDetailLevel, maxConflictFiles, conflictResolutionStrategy, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetMergeConflictsInput {\n");
    ...
    sb.append("    maxConflictFiles: ").append(toIndentedString(maxConflictFiles)).append("\n");
  ...
  static {
    ...
    openapiFields.add("maxConflictFiles");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetMergeConflictsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetMergeConflictsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetMergeConflictsInput is not found in the empty JSON string", GetMergeConflictsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetMergeConflictsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetMergeConflictsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetMergeConflictsInput.openapiRequiredFields) {
      ...
      if (jsonObj.get("maxConflictFiles") != null && !jsonObj.get("maxConflictFiles").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("maxConflictFiles"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetMergeConflictsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetMergeConflictsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetMergeConflictsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetMergeConflictsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetMergeConflictsInput>() {
           @Override
           public void write(JsonWriter out, GetMergeConflictsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetMergeConflictsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetMergeConflictsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetMergeConflictsInput
   * @throws IOException if the JSON string is invalid with respect to GetMergeConflictsInput
   */
  public static GetMergeConflictsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetMergeConflictsInput.class);
  }

  /**
   * Convert an instance of GetMergeConflictsInput to an JSON string
   *
   * @return JSON string
   */
