...
public class GetMergeCommitInput {
  ...
  public GetMergeCommitInput() {
  }

  public GetMergeCommitInput repositoryName(String repositoryName) {
  ...
  public GetMergeCommitInput sourceCommitSpecifier(String sourceCommitSpecifier) {
  ...
  public GetMergeCommitInput destinationCommitSpecifier(String destinationCommitSpecifier) {
  ...
  public GetMergeCommitInput conflictDetailLevel(ConflictDetailLevelTypeEnum conflictDetailLevel) {
  ...
  public GetMergeCommitInput conflictResolutionStrategy(ConflictResolutionStrategyTypeEnum conflictResolutionStrategy) {
  ...
  public boolean equals(Object o) {
    ...
    GetMergeCommitInput getMergeCommitInput = (GetMergeCommitInput) o;
    return Objects.equals(this.repositoryName, getMergeCommitInput.repositoryName) &&
        Objects.equals(this.sourceCommitSpecifier, getMergeCommitInput.sourceCommitSpecifier) &&
        Objects.equals(this.destinationCommitSpecifier, getMergeCommitInput.destinationCommitSpecifier) &&
        Objects.equals(this.conflictDetailLevel, getMergeCommitInput.conflictDetailLevel) &&
        Objects.equals(this.conflictResolutionStrategy, getMergeCommitInput.conflictResolutionStrategy);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetMergeCommitInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetMergeCommitInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetMergeCommitInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetMergeCommitInput is not found in the empty JSON string", GetMergeCommitInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetMergeCommitInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetMergeCommitInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetMergeCommitInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetMergeCommitInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetMergeCommitInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetMergeCommitInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetMergeCommitInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetMergeCommitInput>() {
           @Override
           public void write(JsonWriter out, GetMergeCommitInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetMergeCommitInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetMergeCommitInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetMergeCommitInput
   * @throws IOException if the JSON string is invalid with respect to GetMergeCommitInput
   */
  public static GetMergeCommitInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetMergeCommitInput.class);
  }

  /**
   * Convert an instance of GetMergeCommitInput to an JSON string
   *
   * @return JSON string
   */
