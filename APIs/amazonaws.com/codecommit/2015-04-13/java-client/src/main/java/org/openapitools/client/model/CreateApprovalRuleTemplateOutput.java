...
import org.openapitools.client.model.CreateApprovalRuleTemplateOutputApprovalRuleTemplate;
...
public class CreateApprovalRuleTemplateOutput {
  public static final String SERIALIZED_NAME_APPROVAL_RULE_TEMPLATE = "approvalRuleTemplate";
  @SerializedName(SERIALIZED_NAME_APPROVAL_RULE_TEMPLATE)
  private CreateApprovalRuleTemplateOutputApprovalRuleTemplate approvalRuleTemplate;

  public CreateApprovalRuleTemplateOutput() {
  }

  public CreateApprovalRuleTemplateOutput approvalRuleTemplate(CreateApprovalRuleTemplateOutputApprovalRuleTemplate approvalRuleTemplate) {
    this.approvalRuleTemplate = approvalRuleTemplate;
    return this;
  }

  /**
   * Get approvalRuleTemplate
   * @return approvalRuleTemplate
   */
  @javax.annotation.Nonnull
  public CreateApprovalRuleTemplateOutputApprovalRuleTemplate getApprovalRuleTemplate() {
    return approvalRuleTemplate;
  }

  public void setApprovalRuleTemplate(CreateApprovalRuleTemplateOutputApprovalRuleTemplate approvalRuleTemplate) {
    this.approvalRuleTemplate = approvalRuleTemplate;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateApprovalRuleTemplateOutput createApprovalRuleTemplateOutput = (CreateApprovalRuleTemplateOutput) o;
    return Objects.equals(this.approvalRuleTemplate, createApprovalRuleTemplateOutput.approvalRuleTemplate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(approvalRuleTemplate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateApprovalRuleTemplateOutput {\n");
    sb.append("    approvalRuleTemplate: ").append(toIndentedString(approvalRuleTemplate)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("approvalRuleTemplate");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("approvalRuleTemplate");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateApprovalRuleTemplateOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateApprovalRuleTemplateOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateApprovalRuleTemplateOutput is not found in the empty JSON string", CreateApprovalRuleTemplateOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateApprovalRuleTemplateOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateApprovalRuleTemplateOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateApprovalRuleTemplateOutput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `approvalRuleTemplate`
      CreateApprovalRuleTemplateOutputApprovalRuleTemplate.validateJsonElement(jsonObj.get("approvalRuleTemplate"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateApprovalRuleTemplateOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateApprovalRuleTemplateOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateApprovalRuleTemplateOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateApprovalRuleTemplateOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateApprovalRuleTemplateOutput>() {
           @Override
           public void write(JsonWriter out, CreateApprovalRuleTemplateOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateApprovalRuleTemplateOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateApprovalRuleTemplateOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateApprovalRuleTemplateOutput
   * @throws IOException if the JSON string is invalid with respect to CreateApprovalRuleTemplateOutput
   */
  public static CreateApprovalRuleTemplateOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateApprovalRuleTemplateOutput.class);
  }

  /**
   * Convert an instance of CreateApprovalRuleTemplateOutput to an JSON string
   *
   * @return JSON string
   */
