...
public class CommentsForComparedCommitLocation {
  ...
  public CommentsForComparedCommitLocation() {
  }

  public CommentsForComparedCommitLocation filePath(String filePath) {
  ...
  public CommentsForComparedCommitLocation filePosition(Integer filePosition) {
  ...
  public CommentsForComparedCommitLocation relativeFileVersion(RelativeFileVersionEnum relativeFileVersion) {
  ...
  public boolean equals(Object o) {
    ...
    CommentsForComparedCommitLocation commentsForComparedCommitLocation = (CommentsForComparedCommitLocation) o;
    return Objects.equals(this.filePath, commentsForComparedCommitLocation.filePath) &&
        Objects.equals(this.filePosition, commentsForComparedCommitLocation.filePosition) &&
        Objects.equals(this.relativeFileVersion, commentsForComparedCommitLocation.relativeFileVersion);
  }
  ...
  public String toString() {
    ...
    sb.append("class CommentsForComparedCommitLocation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CommentsForComparedCommitLocation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommentsForComparedCommitLocation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CommentsForComparedCommitLocation is not found in the empty JSON string", CommentsForComparedCommitLocation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CommentsForComparedCommitLocation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CommentsForComparedCommitLocation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CommentsForComparedCommitLocation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CommentsForComparedCommitLocation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CommentsForComparedCommitLocation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CommentsForComparedCommitLocation.class));

       return (TypeAdapter<T>) new TypeAdapter<CommentsForComparedCommitLocation>() {
           @Override
           public void write(JsonWriter out, CommentsForComparedCommitLocation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CommentsForComparedCommitLocation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CommentsForComparedCommitLocation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CommentsForComparedCommitLocation
   * @throws IOException if the JSON string is invalid with respect to CommentsForComparedCommitLocation
   */
  public static CommentsForComparedCommitLocation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CommentsForComparedCommitLocation.class);
  }

  /**
   * Convert an instance of CommentsForComparedCommitLocation to an JSON string
   *
   * @return JSON string
   */
