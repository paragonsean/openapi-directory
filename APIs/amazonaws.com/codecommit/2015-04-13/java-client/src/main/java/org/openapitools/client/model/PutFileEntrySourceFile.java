...
public class PutFileEntrySourceFile {
  public static final String SERIALIZED_NAME_FILE_PATH = "filePath";
  @SerializedName(SERIALIZED_NAME_FILE_PATH)
  private String filePath;

  public static final String SERIALIZED_NAME_IS_MOVE = "isMove";
  @SerializedName(SERIALIZED_NAME_IS_MOVE)
  private Boolean isMove;

  public PutFileEntrySourceFile() {
  }

  public PutFileEntrySourceFile filePath(String filePath) {
  ...
  public PutFileEntrySourceFile isMove(Boolean isMove) {
    this.isMove = isMove;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PutFileEntrySourceFile putFileEntrySourceFile = (PutFileEntrySourceFile) o;
    return Objects.equals(this.filePath, putFileEntrySourceFile.filePath) &&
        Objects.equals(this.isMove, putFileEntrySourceFile.isMove);
  }

  @Override
  public int hashCode() {
    return Objects.hash(filePath, isMove);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutFileEntrySourceFile {\n");
    sb.append("    filePath: ").append(toIndentedString(filePath)).append("\n");
    sb.append("    isMove: ").append(toIndentedString(isMove)).append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutFileEntrySourceFile
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutFileEntrySourceFile.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutFileEntrySourceFile is not found in the empty JSON string", PutFileEntrySourceFile.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutFileEntrySourceFile.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutFileEntrySourceFile` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PutFileEntrySourceFile.openapiRequiredFields) {
      ...
      if (jsonObj.get("isMove") != null && !jsonObj.get("isMove").isJsonNull()) {
        Boolean.validateJsonElement(jsonObj.get("isMove"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutFileEntrySourceFile.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutFileEntrySourceFile' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutFileEntrySourceFile> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutFileEntrySourceFile.class));

       return (TypeAdapter<T>) new TypeAdapter<PutFileEntrySourceFile>() {
           @Override
           public void write(JsonWriter out, PutFileEntrySourceFile value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutFileEntrySourceFile read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutFileEntrySourceFile given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutFileEntrySourceFile
   * @throws IOException if the JSON string is invalid with respect to PutFileEntrySourceFile
   */
  public static PutFileEntrySourceFile fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutFileEntrySourceFile.class);
  }

  /**
   * Convert an instance of PutFileEntrySourceFile to an JSON string
   *
   * @return JSON string
   */
