...
import org.openapitools.client.model.PullRequestMergedStateChangedEventMetadataMergeMetadata;
...
public class PullRequestEventPullRequestMergedStateChangedEventMetadata {
  ...
  public static final String SERIALIZED_NAME_DESTINATION_REFERENCE = "destinationReference";
  @SerializedName(SERIALIZED_NAME_DESTINATION_REFERENCE)
  private String destinationReference;

  public static final String SERIALIZED_NAME_MERGE_METADATA = "mergeMetadata";
  @SerializedName(SERIALIZED_NAME_MERGE_METADATA)
  private PullRequestMergedStateChangedEventMetadataMergeMetadata mergeMetadata;

  public PullRequestEventPullRequestMergedStateChangedEventMetadata() {
  }

  public PullRequestEventPullRequestMergedStateChangedEventMetadata repositoryName(String repositoryName) {
  ...
  public PullRequestEventPullRequestMergedStateChangedEventMetadata destinationReference(String destinationReference) {
  ...
  public PullRequestEventPullRequestMergedStateChangedEventMetadata mergeMetadata(PullRequestMergedStateChangedEventMetadataMergeMetadata mergeMetadata) {
   ...
   */
  @javax.annotation.Nullable
  public PullRequestMergedStateChangedEventMetadataMergeMetadata getMergeMetadata() {
    return mergeMetadata;
  }

  public void setMergeMetadata(PullRequestMergedStateChangedEventMetadataMergeMetadata mergeMetadata) {
    this.mergeMetadata = mergeMetadata;
  }
  ...
  public boolean equals(Object o) {
    ...
    PullRequestEventPullRequestMergedStateChangedEventMetadata pullRequestEventPullRequestMergedStateChangedEventMetadata = (PullRequestEventPullRequestMergedStateChangedEventMetadata) o;
    return Objects.equals(this.repositoryName, pullRequestEventPullRequestMergedStateChangedEventMetadata.repositoryName) &&
        Objects.equals(this.destinationReference, pullRequestEventPullRequestMergedStateChangedEventMetadata.destinationReference) &&
        Objects.equals(this.mergeMetadata, pullRequestEventPullRequestMergedStateChangedEventMetadata.mergeMetadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, destinationReference, mergeMetadata);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PullRequestEventPullRequestMergedStateChangedEventMetadata {\n");
    sb.append("    repositoryName: ").append(toIndentedString(repositoryName)).append("\n");
    sb.append("    destinationReference: ").append(toIndentedString(destinationReference)).append("\n");
    sb.append("    mergeMetadata: ").append(toIndentedString(mergeMetadata)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("destinationReference");
    openapiFields.add("mergeMetadata");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PullRequestEventPullRequestMergedStateChangedEventMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PullRequestEventPullRequestMergedStateChangedEventMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PullRequestEventPullRequestMergedStateChangedEventMetadata is not found in the empty JSON string", PullRequestEventPullRequestMergedStateChangedEventMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PullRequestEventPullRequestMergedStateChangedEventMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PullRequestEventPullRequestMergedStateChangedEventMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("destinationReference") != null && !jsonObj.get("destinationReference").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("destinationReference"));
      }
      // validate the optional field `mergeMetadata`
      if (jsonObj.get("mergeMetadata") != null && !jsonObj.get("mergeMetadata").isJsonNull()) {
        PullRequestMergedStateChangedEventMetadataMergeMetadata.validateJsonElement(jsonObj.get("mergeMetadata"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PullRequestEventPullRequestMergedStateChangedEventMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PullRequestEventPullRequestMergedStateChangedEventMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PullRequestEventPullRequestMergedStateChangedEventMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PullRequestEventPullRequestMergedStateChangedEventMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<PullRequestEventPullRequestMergedStateChangedEventMetadata>() {
           @Override
           public void write(JsonWriter out, PullRequestEventPullRequestMergedStateChangedEventMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PullRequestEventPullRequestMergedStateChangedEventMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PullRequestEventPullRequestMergedStateChangedEventMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PullRequestEventPullRequestMergedStateChangedEventMetadata
   * @throws IOException if the JSON string is invalid with respect to PullRequestEventPullRequestMergedStateChangedEventMetadata
   */
  public static PullRequestEventPullRequestMergedStateChangedEventMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PullRequestEventPullRequestMergedStateChangedEventMetadata.class);
  }

  /**
   * Convert an instance of PullRequestEventPullRequestMergedStateChangedEventMetadata to an JSON string
   *
   * @return JSON string
   */
