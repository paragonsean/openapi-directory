...
public class MergeHunkDetail {
  ...
  public MergeHunkDetail startLine(Integer startLine) {
  ...
  public MergeHunkDetail endLine(Integer endLine) {
  ...
  public MergeHunkDetail hunkContent(String hunkContent) {
  ...
  public boolean equals(Object o) {
    ...
    MergeHunkDetail mergeHunkDetail = (MergeHunkDetail) o;
    return Objects.equals(this.startLine, mergeHunkDetail.startLine) &&
        Objects.equals(this.endLine, mergeHunkDetail.endLine) &&
        Objects.equals(this.hunkContent, mergeHunkDetail.hunkContent);
  }
  ...
  public String toString() {
    ...
    sb.append("class MergeHunkDetail {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MergeHunkDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MergeHunkDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MergeHunkDetail is not found in the empty JSON string", MergeHunkDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MergeHunkDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MergeHunkDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MergeHunkDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MergeHunkDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MergeHunkDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MergeHunkDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<MergeHunkDetail>() {
           @Override
           public void write(JsonWriter out, MergeHunkDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MergeHunkDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MergeHunkDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MergeHunkDetail
   * @throws IOException if the JSON string is invalid with respect to MergeHunkDetail
   */
  public static MergeHunkDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MergeHunkDetail.class);
  }

  /**
   * Convert an instance of MergeHunkDetail to an JSON string
   *
   * @return JSON string
   */
