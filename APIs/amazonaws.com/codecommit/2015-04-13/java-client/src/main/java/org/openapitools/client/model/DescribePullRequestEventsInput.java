...
public class DescribePullRequestEventsInput {
  ...
  public DescribePullRequestEventsInput() {
  }

  public DescribePullRequestEventsInput pullRequestId(String pullRequestId) {
  ...
  public DescribePullRequestEventsInput pullRequestEventType(PullRequestEventType pullRequestEventType) {
  ...
  public DescribePullRequestEventsInput actorArn(String actorArn) {
  ...
  public DescribePullRequestEventsInput nextToken(String nextToken) {
  ...
  public DescribePullRequestEventsInput maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    DescribePullRequestEventsInput describePullRequestEventsInput = (DescribePullRequestEventsInput) o;
    return Objects.equals(this.pullRequestId, describePullRequestEventsInput.pullRequestId) &&
        Objects.equals(this.pullRequestEventType, describePullRequestEventsInput.pullRequestEventType) &&
        Objects.equals(this.actorArn, describePullRequestEventsInput.actorArn) &&
        Objects.equals(this.nextToken, describePullRequestEventsInput.nextToken) &&
        Objects.equals(this.maxResults, describePullRequestEventsInput.maxResults);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pullRequestId, pullRequestEventType, actorArn, nextToken, maxResults);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribePullRequestEventsInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribePullRequestEventsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribePullRequestEventsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribePullRequestEventsInput is not found in the empty JSON string", DescribePullRequestEventsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribePullRequestEventsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribePullRequestEventsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribePullRequestEventsInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribePullRequestEventsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribePullRequestEventsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribePullRequestEventsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribePullRequestEventsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribePullRequestEventsInput>() {
           @Override
           public void write(JsonWriter out, DescribePullRequestEventsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribePullRequestEventsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribePullRequestEventsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribePullRequestEventsInput
   * @throws IOException if the JSON string is invalid with respect to DescribePullRequestEventsInput
   */
  public static DescribePullRequestEventsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribePullRequestEventsInput.class);
  }

  /**
   * Convert an instance of DescribePullRequestEventsInput to an JSON string
   *
   * @return JSON string
   */
