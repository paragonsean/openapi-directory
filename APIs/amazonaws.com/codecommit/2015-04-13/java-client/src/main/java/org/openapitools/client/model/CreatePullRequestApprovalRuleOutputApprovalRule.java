...
public class CreatePullRequestApprovalRuleOutputApprovalRule {
  ...
  public CreatePullRequestApprovalRuleOutputApprovalRule() {
  }

  public CreatePullRequestApprovalRuleOutputApprovalRule approvalRuleId(String approvalRuleId) {
  ...
  public CreatePullRequestApprovalRuleOutputApprovalRule approvalRuleName(String approvalRuleName) {
  ...
  public CreatePullRequestApprovalRuleOutputApprovalRule approvalRuleContent(String approvalRuleContent) {
  ...
  public CreatePullRequestApprovalRuleOutputApprovalRule ruleContentSha256(String ruleContentSha256) {
  ...
  public CreatePullRequestApprovalRuleOutputApprovalRule lastModifiedDate(OffsetDateTime lastModifiedDate) {
  ...
  public CreatePullRequestApprovalRuleOutputApprovalRule creationDate(OffsetDateTime creationDate) {
  ...
  public CreatePullRequestApprovalRuleOutputApprovalRule lastModifiedUser(String lastModifiedUser) {
  ...
  public CreatePullRequestApprovalRuleOutputApprovalRule originApprovalRuleTemplate(ApprovalRuleOriginApprovalRuleTemplate originApprovalRuleTemplate) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePullRequestApprovalRuleOutputApprovalRule createPullRequestApprovalRuleOutputApprovalRule = (CreatePullRequestApprovalRuleOutputApprovalRule) o;
    return Objects.equals(this.approvalRuleId, createPullRequestApprovalRuleOutputApprovalRule.approvalRuleId) &&
        Objects.equals(this.approvalRuleName, createPullRequestApprovalRuleOutputApprovalRule.approvalRuleName) &&
        Objects.equals(this.approvalRuleContent, createPullRequestApprovalRuleOutputApprovalRule.approvalRuleContent) &&
        Objects.equals(this.ruleContentSha256, createPullRequestApprovalRuleOutputApprovalRule.ruleContentSha256) &&
        Objects.equals(this.lastModifiedDate, createPullRequestApprovalRuleOutputApprovalRule.lastModifiedDate) &&
        Objects.equals(this.creationDate, createPullRequestApprovalRuleOutputApprovalRule.creationDate) &&
        Objects.equals(this.lastModifiedUser, createPullRequestApprovalRuleOutputApprovalRule.lastModifiedUser) &&
        Objects.equals(this.originApprovalRuleTemplate, createPullRequestApprovalRuleOutputApprovalRule.originApprovalRuleTemplate);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreatePullRequestApprovalRuleOutputApprovalRule {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePullRequestApprovalRuleOutputApprovalRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePullRequestApprovalRuleOutputApprovalRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePullRequestApprovalRuleOutputApprovalRule is not found in the empty JSON string", CreatePullRequestApprovalRuleOutputApprovalRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePullRequestApprovalRuleOutputApprovalRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePullRequestApprovalRuleOutputApprovalRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePullRequestApprovalRuleOutputApprovalRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePullRequestApprovalRuleOutputApprovalRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePullRequestApprovalRuleOutputApprovalRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePullRequestApprovalRuleOutputApprovalRule.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePullRequestApprovalRuleOutputApprovalRule>() {
           @Override
           public void write(JsonWriter out, CreatePullRequestApprovalRuleOutputApprovalRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePullRequestApprovalRuleOutputApprovalRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePullRequestApprovalRuleOutputApprovalRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePullRequestApprovalRuleOutputApprovalRule
   * @throws IOException if the JSON string is invalid with respect to CreatePullRequestApprovalRuleOutputApprovalRule
   */
  public static CreatePullRequestApprovalRuleOutputApprovalRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePullRequestApprovalRuleOutputApprovalRule.class);
  }

  /**
   * Convert an instance of CreatePullRequestApprovalRuleOutputApprovalRule to an JSON string
   *
   * @return JSON string
   */
