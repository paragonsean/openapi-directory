...
public class CreatePullRequestOutputPullRequest {
  ...
  public CreatePullRequestOutputPullRequest() {
  }

  public CreatePullRequestOutputPullRequest pullRequestId(String pullRequestId) {
  ...
  public CreatePullRequestOutputPullRequest title(String title) {
    this.title = title;
    return this;
  }
  ...
  public CreatePullRequestOutputPullRequest description(String description) {
  ...
  public CreatePullRequestOutputPullRequest lastActivityDate(OffsetDateTime lastActivityDate) {
  ...
  public CreatePullRequestOutputPullRequest creationDate(OffsetDateTime creationDate) {
  ...
  public CreatePullRequestOutputPullRequest pullRequestStatus(PullRequestStatusEnum pullRequestStatus) {
  ...
  public CreatePullRequestOutputPullRequest authorArn(String authorArn) {
  ...
  public CreatePullRequestOutputPullRequest pullRequestTargets(List pullRequestTargets) {
  ...
  public CreatePullRequestOutputPullRequest clientRequestToken(String clientRequestToken) {
  ...
  public CreatePullRequestOutputPullRequest revisionId(String revisionId) {
  ...
  public CreatePullRequestOutputPullRequest approvalRules(List approvalRules) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePullRequestOutputPullRequest createPullRequestOutputPullRequest = (CreatePullRequestOutputPullRequest) o;
    return Objects.equals(this.pullRequestId, createPullRequestOutputPullRequest.pullRequestId) &&
        Objects.equals(this.title, createPullRequestOutputPullRequest.title) &&
        Objects.equals(this.description, createPullRequestOutputPullRequest.description) &&
        Objects.equals(this.lastActivityDate, createPullRequestOutputPullRequest.lastActivityDate) &&
        Objects.equals(this.creationDate, createPullRequestOutputPullRequest.creationDate) &&
        Objects.equals(this.pullRequestStatus, createPullRequestOutputPullRequest.pullRequestStatus) &&
        Objects.equals(this.authorArn, createPullRequestOutputPullRequest.authorArn) &&
        Objects.equals(this.pullRequestTargets, createPullRequestOutputPullRequest.pullRequestTargets) &&
        Objects.equals(this.clientRequestToken, createPullRequestOutputPullRequest.clientRequestToken) &&
        Objects.equals(this.revisionId, createPullRequestOutputPullRequest.revisionId) &&
        Objects.equals(this.approvalRules, createPullRequestOutputPullRequest.approvalRules);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreatePullRequestOutputPullRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePullRequestOutputPullRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePullRequestOutputPullRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePullRequestOutputPullRequest is not found in the empty JSON string", CreatePullRequestOutputPullRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePullRequestOutputPullRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePullRequestOutputPullRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePullRequestOutputPullRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePullRequestOutputPullRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePullRequestOutputPullRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePullRequestOutputPullRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePullRequestOutputPullRequest>() {
           @Override
           public void write(JsonWriter out, CreatePullRequestOutputPullRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePullRequestOutputPullRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePullRequestOutputPullRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePullRequestOutputPullRequest
   * @throws IOException if the JSON string is invalid with respect to CreatePullRequestOutputPullRequest
   */
  public static CreatePullRequestOutputPullRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePullRequestOutputPullRequest.class);
  }

  /**
   * Convert an instance of CreatePullRequestOutputPullRequest to an JSON string
   *
   * @return JSON string
   */
