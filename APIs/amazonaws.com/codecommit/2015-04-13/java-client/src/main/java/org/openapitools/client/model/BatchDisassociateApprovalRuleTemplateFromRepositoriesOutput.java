...
public class BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput {
  public static final String SERIALIZED_NAME_DISASSOCIATED_REPOSITORY_NAMES = "disassociatedRepositoryNames";
  @SerializedName(SERIALIZED_NAME_DISASSOCIATED_REPOSITORY_NAMES)
  private List disassociatedRepositoryNames;
  ...
  public BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput disassociatedRepositoryNames(List disassociatedRepositoryNames) {
    this.disassociatedRepositoryNames = disassociatedRepositoryNames;
    return this;
  }

  /**
   * Get disassociatedRepositoryNames
   * @return disassociatedRepositoryNames
   */
  @javax.annotation.Nonnull
  public List getDisassociatedRepositoryNames() {
    return disassociatedRepositoryNames;
  }

  public void setDisassociatedRepositoryNames(List disassociatedRepositoryNames) {
    this.disassociatedRepositoryNames = disassociatedRepositoryNames;
  }


  public BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput errors(List errors) {
    this.errors = errors;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput batchDisassociateApprovalRuleTemplateFromRepositoriesOutput = (BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput) o;
    return Objects.equals(this.disassociatedRepositoryNames, batchDisassociateApprovalRuleTemplateFromRepositoriesOutput.disassociatedRepositoryNames) &&
        Objects.equals(this.errors, batchDisassociateApprovalRuleTemplateFromRepositoriesOutput.errors);
  }

  @Override
  public int hashCode() {
    return Objects.hash(disassociatedRepositoryNames, errors);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput {\n");
    sb.append("    disassociatedRepositoryNames: ").append(toIndentedString(disassociatedRepositoryNames)).append("\n");
  ...
  static {
    ...
    openapiFields.add("disassociatedRepositoryNames");
    openapiFields.add("errors");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("disassociatedRepositoryNames");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput is not found in the empty JSON string", BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `disassociatedRepositoryNames`
      List.validateJsonElement(jsonObj.get("disassociatedRepositoryNames"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput>() {
           @Override
           public void write(JsonWriter out, BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput
   * @throws IOException if the JSON string is invalid with respect to BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput
   */
  public static BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput.class);
  }

  /**
   * Convert an instance of BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput to an JSON string
   *
   * @return JSON string
   */
