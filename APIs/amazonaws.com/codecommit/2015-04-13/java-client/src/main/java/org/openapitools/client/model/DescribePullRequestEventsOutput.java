...
public class DescribePullRequestEventsOutput {
  public static final String SERIALIZED_NAME_PULL_REQUEST_EVENTS = "pullRequestEvents";
  @SerializedName(SERIALIZED_NAME_PULL_REQUEST_EVENTS)
  private List pullRequestEvents;

  public static final String SERIALIZED_NAME_NEXT_TOKEN = "nextToken";
  @SerializedName(SERIALIZED_NAME_NEXT_TOKEN)
  private String nextToken;

  public DescribePullRequestEventsOutput() {
  }

  public DescribePullRequestEventsOutput pullRequestEvents(List pullRequestEvents) {
    this.pullRequestEvents = pullRequestEvents;
    return this;
  }

  /**
   * Get pullRequestEvents
   * @return pullRequestEvents
   */
  @javax.annotation.Nonnull
  public List getPullRequestEvents() {
    return pullRequestEvents;
  }

  public void setPullRequestEvents(List pullRequestEvents) {
    this.pullRequestEvents = pullRequestEvents;
  }


  public DescribePullRequestEventsOutput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    DescribePullRequestEventsOutput describePullRequestEventsOutput = (DescribePullRequestEventsOutput) o;
    return Objects.equals(this.pullRequestEvents, describePullRequestEventsOutput.pullRequestEvents) &&
        Objects.equals(this.nextToken, describePullRequestEventsOutput.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pullRequestEvents, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribePullRequestEventsOutput {\n");
    sb.append("    pullRequestEvents: ").append(toIndentedString(pullRequestEvents)).append("\n");
  ...
  static {
    ...
    openapiFields.add("pullRequestEvents");
    openapiFields.add("nextToken");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("pullRequestEvents");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribePullRequestEventsOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribePullRequestEventsOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribePullRequestEventsOutput is not found in the empty JSON string", DescribePullRequestEventsOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribePullRequestEventsOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribePullRequestEventsOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribePullRequestEventsOutput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `pullRequestEvents`
      List.validateJsonElement(jsonObj.get("pullRequestEvents"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribePullRequestEventsOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribePullRequestEventsOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribePullRequestEventsOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribePullRequestEventsOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribePullRequestEventsOutput>() {
           @Override
           public void write(JsonWriter out, DescribePullRequestEventsOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribePullRequestEventsOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribePullRequestEventsOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribePullRequestEventsOutput
   * @throws IOException if the JSON string is invalid with respect to DescribePullRequestEventsOutput
   */
  public static DescribePullRequestEventsOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribePullRequestEventsOutput.class);
  }

  /**
   * Convert an instance of DescribePullRequestEventsOutput to an JSON string
   *
   * @return JSON string
   */
