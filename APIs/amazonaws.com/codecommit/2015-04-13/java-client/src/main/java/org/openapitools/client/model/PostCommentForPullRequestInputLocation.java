...
public class PostCommentForPullRequestInputLocation {
  ...
  public PostCommentForPullRequestInputLocation() {
  }

  public PostCommentForPullRequestInputLocation filePath(String filePath) {
  ...
  public PostCommentForPullRequestInputLocation filePosition(Integer filePosition) {
  ...
  public PostCommentForPullRequestInputLocation relativeFileVersion(RelativeFileVersionEnum relativeFileVersion) {
  ...
  public boolean equals(Object o) {
    ...
    PostCommentForPullRequestInputLocation postCommentForPullRequestInputLocation = (PostCommentForPullRequestInputLocation) o;
    return Objects.equals(this.filePath, postCommentForPullRequestInputLocation.filePath) &&
        Objects.equals(this.filePosition, postCommentForPullRequestInputLocation.filePosition) &&
        Objects.equals(this.relativeFileVersion, postCommentForPullRequestInputLocation.relativeFileVersion);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostCommentForPullRequestInputLocation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostCommentForPullRequestInputLocation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostCommentForPullRequestInputLocation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostCommentForPullRequestInputLocation is not found in the empty JSON string", PostCommentForPullRequestInputLocation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostCommentForPullRequestInputLocation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostCommentForPullRequestInputLocation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostCommentForPullRequestInputLocation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostCommentForPullRequestInputLocation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostCommentForPullRequestInputLocation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostCommentForPullRequestInputLocation.class));

       return (TypeAdapter<T>) new TypeAdapter<PostCommentForPullRequestInputLocation>() {
           @Override
           public void write(JsonWriter out, PostCommentForPullRequestInputLocation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostCommentForPullRequestInputLocation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostCommentForPullRequestInputLocation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostCommentForPullRequestInputLocation
   * @throws IOException if the JSON string is invalid with respect to PostCommentForPullRequestInputLocation
   */
  public static PostCommentForPullRequestInputLocation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostCommentForPullRequestInputLocation.class);
  }

  /**
   * Convert an instance of PostCommentForPullRequestInputLocation to an JSON string
   *
   * @return JSON string
   */
