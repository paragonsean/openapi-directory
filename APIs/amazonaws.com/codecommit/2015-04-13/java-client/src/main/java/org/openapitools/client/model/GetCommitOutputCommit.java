...
import org.openapitools.client.model.CommitCommitter;
...
public class GetCommitOutputCommit {
  ...
  public GetCommitOutputCommit() {
  }

  public GetCommitOutputCommit commitId(String commitId) {
  ...
  public GetCommitOutputCommit treeId(String treeId) {
    this.treeId = treeId;
    return this;
  }
  ...
  public GetCommitOutputCommit parents(List parents) {
  ...
  public GetCommitOutputCommit message(String message) {
  ...
  public GetCommitOutputCommit author(CommitAuthor author) {
    this.author = author;
    return this;
  }
  ...
  public GetCommitOutputCommit committer(CommitCommitter committer) {
  ...
  public GetCommitOutputCommit additionalData(String additionalData) {
  ...
  public boolean equals(Object o) {
    ...
    GetCommitOutputCommit getCommitOutputCommit = (GetCommitOutputCommit) o;
    return Objects.equals(this.commitId, getCommitOutputCommit.commitId) &&
        Objects.equals(this.treeId, getCommitOutputCommit.treeId) &&
        Objects.equals(this.parents, getCommitOutputCommit.parents) &&
        Objects.equals(this.message, getCommitOutputCommit.message) &&
        Objects.equals(this.author, getCommitOutputCommit.author) &&
        Objects.equals(this.committer, getCommitOutputCommit.committer) &&
        Objects.equals(this.additionalData, getCommitOutputCommit.additionalData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(commitId, treeId, parents, message, author, committer, additionalData);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetCommitOutputCommit {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCommitOutputCommit
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCommitOutputCommit.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCommitOutputCommit is not found in the empty JSON string", GetCommitOutputCommit.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCommitOutputCommit.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCommitOutputCommit` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCommitOutputCommit.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCommitOutputCommit' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCommitOutputCommit> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCommitOutputCommit.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCommitOutputCommit>() {
           @Override
           public void write(JsonWriter out, GetCommitOutputCommit value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCommitOutputCommit read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCommitOutputCommit given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCommitOutputCommit
   * @throws IOException if the JSON string is invalid with respect to GetCommitOutputCommit
   */
  public static GetCommitOutputCommit fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCommitOutputCommit.class);
  }

  /**
   * Convert an instance of GetCommitOutputCommit to an JSON string
   *
   * @return JSON string
   */
