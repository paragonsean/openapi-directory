...
public class PullRequestCreatedEventMetadata {
  ...
  public PullRequestCreatedEventMetadata repositoryName(String repositoryName) {
  ...
  public PullRequestCreatedEventMetadata sourceCommitId(String sourceCommitId) {
  ...
  public PullRequestCreatedEventMetadata destinationCommitId(String destinationCommitId) {
  ...
  public PullRequestCreatedEventMetadata mergeBase(String mergeBase) {
  ...
  public boolean equals(Object o) {
    ...
    PullRequestCreatedEventMetadata pullRequestCreatedEventMetadata = (PullRequestCreatedEventMetadata) o;
    return Objects.equals(this.repositoryName, pullRequestCreatedEventMetadata.repositoryName) &&
        Objects.equals(this.sourceCommitId, pullRequestCreatedEventMetadata.sourceCommitId) &&
        Objects.equals(this.destinationCommitId, pullRequestCreatedEventMetadata.destinationCommitId) &&
        Objects.equals(this.mergeBase, pullRequestCreatedEventMetadata.mergeBase);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, sourceCommitId, destinationCommitId, mergeBase);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PullRequestCreatedEventMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PullRequestCreatedEventMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PullRequestCreatedEventMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PullRequestCreatedEventMetadata is not found in the empty JSON string", PullRequestCreatedEventMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PullRequestCreatedEventMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PullRequestCreatedEventMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PullRequestCreatedEventMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PullRequestCreatedEventMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PullRequestCreatedEventMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PullRequestCreatedEventMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<PullRequestCreatedEventMetadata>() {
           @Override
           public void write(JsonWriter out, PullRequestCreatedEventMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PullRequestCreatedEventMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PullRequestCreatedEventMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PullRequestCreatedEventMetadata
   * @throws IOException if the JSON string is invalid with respect to PullRequestCreatedEventMetadata
   */
  public static PullRequestCreatedEventMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PullRequestCreatedEventMetadata.class);
  }

  /**
   * Convert an instance of PullRequestCreatedEventMetadata to an JSON string
   *
   * @return JSON string
   */
