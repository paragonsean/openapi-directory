...
public class ListRepositoriesForApprovalRuleTemplateInput {
  ...
  public ListRepositoriesForApprovalRuleTemplateInput() {
  }

  public ListRepositoriesForApprovalRuleTemplateInput approvalRuleTemplateName(String approvalRuleTemplateName) {
  ...
  public ListRepositoriesForApprovalRuleTemplateInput nextToken(String nextToken) {
  ...
  public ListRepositoriesForApprovalRuleTemplateInput maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    ListRepositoriesForApprovalRuleTemplateInput listRepositoriesForApprovalRuleTemplateInput = (ListRepositoriesForApprovalRuleTemplateInput) o;
    return Objects.equals(this.approvalRuleTemplateName, listRepositoriesForApprovalRuleTemplateInput.approvalRuleTemplateName) &&
        Objects.equals(this.nextToken, listRepositoriesForApprovalRuleTemplateInput.nextToken) &&
        Objects.equals(this.maxResults, listRepositoriesForApprovalRuleTemplateInput.maxResults);
  }

  @Override
  public int hashCode() {
    return Objects.hash(approvalRuleTemplateName, nextToken, maxResults);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListRepositoriesForApprovalRuleTemplateInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListRepositoriesForApprovalRuleTemplateInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListRepositoriesForApprovalRuleTemplateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListRepositoriesForApprovalRuleTemplateInput is not found in the empty JSON string", ListRepositoriesForApprovalRuleTemplateInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListRepositoriesForApprovalRuleTemplateInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListRepositoriesForApprovalRuleTemplateInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListRepositoriesForApprovalRuleTemplateInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListRepositoriesForApprovalRuleTemplateInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListRepositoriesForApprovalRuleTemplateInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListRepositoriesForApprovalRuleTemplateInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListRepositoriesForApprovalRuleTemplateInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListRepositoriesForApprovalRuleTemplateInput>() {
           @Override
           public void write(JsonWriter out, ListRepositoriesForApprovalRuleTemplateInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListRepositoriesForApprovalRuleTemplateInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListRepositoriesForApprovalRuleTemplateInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListRepositoriesForApprovalRuleTemplateInput
   * @throws IOException if the JSON string is invalid with respect to ListRepositoriesForApprovalRuleTemplateInput
   */
  public static ListRepositoriesForApprovalRuleTemplateInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListRepositoriesForApprovalRuleTemplateInput.class);
  }

  /**
   * Convert an instance of ListRepositoriesForApprovalRuleTemplateInput to an JSON string
   *
   * @return JSON string
   */
