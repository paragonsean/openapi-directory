...
public class CreatePullRequestInput {
  ...
  public CreatePullRequestInput title(String title) {
    this.title = title;
    return this;
  }
  ...
  public CreatePullRequestInput description(String description) {
  ...
  public CreatePullRequestInput targets(List targets) {
  ...
  public CreatePullRequestInput clientRequestToken(String clientRequestToken) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePullRequestInput createPullRequestInput = (CreatePullRequestInput) o;
    return Objects.equals(this.title, createPullRequestInput.title) &&
        Objects.equals(this.description, createPullRequestInput.description) &&
        Objects.equals(this.targets, createPullRequestInput.targets) &&
        Objects.equals(this.clientRequestToken, createPullRequestInput.clientRequestToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, description, targets, clientRequestToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreatePullRequestInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePullRequestInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePullRequestInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePullRequestInput is not found in the empty JSON string", CreatePullRequestInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePullRequestInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePullRequestInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreatePullRequestInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePullRequestInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePullRequestInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePullRequestInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePullRequestInput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePullRequestInput>() {
           @Override
           public void write(JsonWriter out, CreatePullRequestInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePullRequestInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePullRequestInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePullRequestInput
   * @throws IOException if the JSON string is invalid with respect to CreatePullRequestInput
   */
  public static CreatePullRequestInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePullRequestInput.class);
  }

  /**
   * Convert an instance of CreatePullRequestInput to an JSON string
   *
   * @return JSON string
   */
