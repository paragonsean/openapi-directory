...
public class GetBlobInput {
  ...
  public GetBlobInput repositoryName(String repositoryName) {
  ...
  public GetBlobInput blobId(String blobId) {
    this.blobId = blobId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetBlobInput getBlobInput = (GetBlobInput) o;
    return Objects.equals(this.repositoryName, getBlobInput.repositoryName) &&
        Objects.equals(this.blobId, getBlobInput.blobId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, blobId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetBlobInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetBlobInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetBlobInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetBlobInput is not found in the empty JSON string", GetBlobInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetBlobInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetBlobInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetBlobInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetBlobInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetBlobInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetBlobInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetBlobInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetBlobInput>() {
           @Override
           public void write(JsonWriter out, GetBlobInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetBlobInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetBlobInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetBlobInput
   * @throws IOException if the JSON string is invalid with respect to GetBlobInput
   */
  public static GetBlobInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetBlobInput.class);
  }

  /**
   * Convert an instance of GetBlobInput to an JSON string
   *
   * @return JSON string
   */
