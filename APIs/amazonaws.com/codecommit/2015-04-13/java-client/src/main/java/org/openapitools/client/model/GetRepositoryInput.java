...
public class GetRepositoryInput {
  ...
  public GetRepositoryInput() {
  }

  public GetRepositoryInput repositoryName(String repositoryName) {
  ...
  public boolean equals(Object o) {
    ...
    GetRepositoryInput getRepositoryInput = (GetRepositoryInput) o;
    return Objects.equals(this.repositoryName, getRepositoryInput.repositoryName);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetRepositoryInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetRepositoryInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetRepositoryInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetRepositoryInput is not found in the empty JSON string", GetRepositoryInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetRepositoryInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetRepositoryInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetRepositoryInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetRepositoryInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetRepositoryInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetRepositoryInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetRepositoryInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetRepositoryInput>() {
           @Override
           public void write(JsonWriter out, GetRepositoryInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetRepositoryInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetRepositoryInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetRepositoryInput
   * @throws IOException if the JSON string is invalid with respect to GetRepositoryInput
   */
  public static GetRepositoryInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetRepositoryInput.class);
  }

  /**
   * Convert an instance of GetRepositoryInput to an JSON string
   *
   * @return JSON string
   */
