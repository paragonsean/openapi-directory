...
public class ListBranchesInput {
  ...
  public ListBranchesInput() {
  }

  public ListBranchesInput repositoryName(String repositoryName) {
  ...
  public ListBranchesInput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListBranchesInput listBranchesInput = (ListBranchesInput) o;
    return Objects.equals(this.repositoryName, listBranchesInput.repositoryName) &&
        Objects.equals(this.nextToken, listBranchesInput.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListBranchesInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListBranchesInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListBranchesInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListBranchesInput is not found in the empty JSON string", ListBranchesInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListBranchesInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListBranchesInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListBranchesInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListBranchesInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListBranchesInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListBranchesInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListBranchesInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListBranchesInput>() {
           @Override
           public void write(JsonWriter out, ListBranchesInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListBranchesInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListBranchesInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListBranchesInput
   * @throws IOException if the JSON string is invalid with respect to ListBranchesInput
   */
  public static ListBranchesInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListBranchesInput.class);
  }

  /**
   * Convert an instance of ListBranchesInput to an JSON string
   *
   * @return JSON string
   */
