...
public class MergeBranchesByThreeWayOutput {
  ...
  public MergeBranchesByThreeWayOutput commitId(String commitId) {
  ...
  public MergeBranchesByThreeWayOutput treeId(String treeId) {
    this.treeId = treeId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MergeBranchesByThreeWayOutput mergeBranchesByThreeWayOutput = (MergeBranchesByThreeWayOutput) o;
    return Objects.equals(this.commitId, mergeBranchesByThreeWayOutput.commitId) &&
        Objects.equals(this.treeId, mergeBranchesByThreeWayOutput.treeId);
  }
  ...
  public String toString() {
    ...
    sb.append("class MergeBranchesByThreeWayOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MergeBranchesByThreeWayOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MergeBranchesByThreeWayOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MergeBranchesByThreeWayOutput is not found in the empty JSON string", MergeBranchesByThreeWayOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MergeBranchesByThreeWayOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MergeBranchesByThreeWayOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MergeBranchesByThreeWayOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MergeBranchesByThreeWayOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MergeBranchesByThreeWayOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MergeBranchesByThreeWayOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<MergeBranchesByThreeWayOutput>() {
           @Override
           public void write(JsonWriter out, MergeBranchesByThreeWayOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MergeBranchesByThreeWayOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MergeBranchesByThreeWayOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MergeBranchesByThreeWayOutput
   * @throws IOException if the JSON string is invalid with respect to MergeBranchesByThreeWayOutput
   */
  public static MergeBranchesByThreeWayOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MergeBranchesByThreeWayOutput.class);
  }

  /**
   * Convert an instance of MergeBranchesByThreeWayOutput to an JSON string
   *
   * @return JSON string
   */
