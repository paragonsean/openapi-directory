...
public class PullRequestMergedStateChangedEventMetadata {
  ...
  public PullRequestMergedStateChangedEventMetadata repositoryName(String repositoryName) {
  ...
  public PullRequestMergedStateChangedEventMetadata destinationReference(String destinationReference) {
  ...
  public PullRequestMergedStateChangedEventMetadata mergeMetadata(PullRequestMergedStateChangedEventMetadataMergeMetadata mergeMetadata) {
  ...
  public boolean equals(Object o) {
    ...
    PullRequestMergedStateChangedEventMetadata pullRequestMergedStateChangedEventMetadata = (PullRequestMergedStateChangedEventMetadata) o;
    return Objects.equals(this.repositoryName, pullRequestMergedStateChangedEventMetadata.repositoryName) &&
        Objects.equals(this.destinationReference, pullRequestMergedStateChangedEventMetadata.destinationReference) &&
        Objects.equals(this.mergeMetadata, pullRequestMergedStateChangedEventMetadata.mergeMetadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class PullRequestMergedStateChangedEventMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PullRequestMergedStateChangedEventMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PullRequestMergedStateChangedEventMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PullRequestMergedStateChangedEventMetadata is not found in the empty JSON string", PullRequestMergedStateChangedEventMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PullRequestMergedStateChangedEventMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PullRequestMergedStateChangedEventMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PullRequestMergedStateChangedEventMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PullRequestMergedStateChangedEventMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PullRequestMergedStateChangedEventMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PullRequestMergedStateChangedEventMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<PullRequestMergedStateChangedEventMetadata>() {
           @Override
           public void write(JsonWriter out, PullRequestMergedStateChangedEventMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PullRequestMergedStateChangedEventMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PullRequestMergedStateChangedEventMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PullRequestMergedStateChangedEventMetadata
   * @throws IOException if the JSON string is invalid with respect to PullRequestMergedStateChangedEventMetadata
   */
  public static PullRequestMergedStateChangedEventMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PullRequestMergedStateChangedEventMetadata.class);
  }

  /**
   * Convert an instance of PullRequestMergedStateChangedEventMetadata to an JSON string
   *
   * @return JSON string
   */
