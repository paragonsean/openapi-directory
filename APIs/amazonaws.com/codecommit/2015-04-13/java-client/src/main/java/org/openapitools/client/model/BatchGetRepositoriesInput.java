...
public class BatchGetRepositoriesInput {
  ...
  public BatchGetRepositoriesInput() {
  }

  public BatchGetRepositoriesInput repositoryNames(List repositoryNames) {
  ...
  public boolean equals(Object o) {
    ...
    BatchGetRepositoriesInput batchGetRepositoriesInput = (BatchGetRepositoriesInput) o;
    return Objects.equals(this.repositoryNames, batchGetRepositoriesInput.repositoryNames);
  }
  ...
  public String toString() {
    ...
    sb.append("class BatchGetRepositoriesInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchGetRepositoriesInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchGetRepositoriesInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchGetRepositoriesInput is not found in the empty JSON string", BatchGetRepositoriesInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchGetRepositoriesInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchGetRepositoriesInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BatchGetRepositoriesInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchGetRepositoriesInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchGetRepositoriesInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchGetRepositoriesInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchGetRepositoriesInput.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchGetRepositoriesInput>() {
           @Override
           public void write(JsonWriter out, BatchGetRepositoriesInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchGetRepositoriesInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchGetRepositoriesInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchGetRepositoriesInput
   * @throws IOException if the JSON string is invalid with respect to BatchGetRepositoriesInput
   */
  public static BatchGetRepositoriesInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchGetRepositoriesInput.class);
  }

  /**
   * Convert an instance of BatchGetRepositoriesInput to an JSON string
   *
   * @return JSON string
   */
