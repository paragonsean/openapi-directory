...
public class PostCommentForComparedCommitInputLocation {
  ...
  public PostCommentForComparedCommitInputLocation() {
  }

  public PostCommentForComparedCommitInputLocation filePath(String filePath) {
  ...
  public PostCommentForComparedCommitInputLocation filePosition(Integer filePosition) {
  ...
  public PostCommentForComparedCommitInputLocation relativeFileVersion(RelativeFileVersionEnum relativeFileVersion) {
  ...
  public boolean equals(Object o) {
    ...
    PostCommentForComparedCommitInputLocation postCommentForComparedCommitInputLocation = (PostCommentForComparedCommitInputLocation) o;
    return Objects.equals(this.filePath, postCommentForComparedCommitInputLocation.filePath) &&
        Objects.equals(this.filePosition, postCommentForComparedCommitInputLocation.filePosition) &&
        Objects.equals(this.relativeFileVersion, postCommentForComparedCommitInputLocation.relativeFileVersion);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostCommentForComparedCommitInputLocation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostCommentForComparedCommitInputLocation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostCommentForComparedCommitInputLocation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostCommentForComparedCommitInputLocation is not found in the empty JSON string", PostCommentForComparedCommitInputLocation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostCommentForComparedCommitInputLocation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostCommentForComparedCommitInputLocation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostCommentForComparedCommitInputLocation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostCommentForComparedCommitInputLocation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostCommentForComparedCommitInputLocation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostCommentForComparedCommitInputLocation.class));

       return (TypeAdapter<T>) new TypeAdapter<PostCommentForComparedCommitInputLocation>() {
           @Override
           public void write(JsonWriter out, PostCommentForComparedCommitInputLocation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostCommentForComparedCommitInputLocation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostCommentForComparedCommitInputLocation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostCommentForComparedCommitInputLocation
   * @throws IOException if the JSON string is invalid with respect to PostCommentForComparedCommitInputLocation
   */
  public static PostCommentForComparedCommitInputLocation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostCommentForComparedCommitInputLocation.class);
  }

  /**
   * Convert an instance of PostCommentForComparedCommitInputLocation to an JSON string
   *
   * @return JSON string
   */
