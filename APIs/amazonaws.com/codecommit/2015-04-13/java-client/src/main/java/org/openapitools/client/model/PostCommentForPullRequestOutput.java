...
import org.openapitools.client.model.PostCommentForComparedCommitOutputComment;
import org.openapitools.client.model.PostCommentForPullRequestOutputLocation;
...
public class PostCommentForPullRequestOutput {
  ...
  public static final String SERIALIZED_NAME_BEFORE_BLOB_ID = "beforeBlobId";
  @SerializedName(SERIALIZED_NAME_BEFORE_BLOB_ID)
  private String beforeBlobId;

  public static final String SERIALIZED_NAME_AFTER_BLOB_ID = "afterBlobId";
  @SerializedName(SERIALIZED_NAME_AFTER_BLOB_ID)
  private String afterBlobId;

  public static final String SERIALIZED_NAME_LOCATION = "location";
  @SerializedName(SERIALIZED_NAME_LOCATION)
  private PostCommentForPullRequestOutputLocation location;

  public static final String SERIALIZED_NAME_COMMENT = "comment";
  @SerializedName(SERIALIZED_NAME_COMMENT)
  private PostCommentForComparedCommitOutputComment comment;

  public PostCommentForPullRequestOutput() {
  }

  public PostCommentForPullRequestOutput repositoryName(String repositoryName) {
  ...
  public PostCommentForPullRequestOutput pullRequestId(String pullRequestId) {
  ...
  public PostCommentForPullRequestOutput beforeCommitId(String beforeCommitId) {
  ...
  public PostCommentForPullRequestOutput afterCommitId(String afterCommitId) {
  ...
  public PostCommentForPullRequestOutput beforeBlobId(String beforeBlobId) {
  ...
  public PostCommentForPullRequestOutput afterBlobId(String afterBlobId) {
  ...
  public PostCommentForPullRequestOutput location(PostCommentForPullRequestOutputLocation location) {
   ...
   */
  @javax.annotation.Nullable
  public PostCommentForPullRequestOutputLocation getLocation() {
    return location;
  }

  public void setLocation(PostCommentForPullRequestOutputLocation location) {
    this.location = location;
  }


  public PostCommentForPullRequestOutput comment(PostCommentForComparedCommitOutputComment comment) {
   ...
   */
  @javax.annotation.Nullable
  public PostCommentForComparedCommitOutputComment getComment() {
    return comment;
  }

  public void setComment(PostCommentForComparedCommitOutputComment comment) {
    this.comment = comment;
  }
  ...
  public boolean equals(Object o) {
    ...
    PostCommentForPullRequestOutput postCommentForPullRequestOutput = (PostCommentForPullRequestOutput) o;
    return Objects.equals(this.repositoryName, postCommentForPullRequestOutput.repositoryName) &&
        Objects.equals(this.pullRequestId, postCommentForPullRequestOutput.pullRequestId) &&
        Objects.equals(this.beforeCommitId, postCommentForPullRequestOutput.beforeCommitId) &&
        Objects.equals(this.afterCommitId, postCommentForPullRequestOutput.afterCommitId) &&
        Objects.equals(this.beforeBlobId, postCommentForPullRequestOutput.beforeBlobId) &&
        Objects.equals(this.afterBlobId, postCommentForPullRequestOutput.afterBlobId) &&
        Objects.equals(this.location, postCommentForPullRequestOutput.location) &&
        Objects.equals(this.comment, postCommentForPullRequestOutput.comment);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, pullRequestId, beforeCommitId, afterCommitId, beforeBlobId, afterBlobId, location, comment);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostCommentForPullRequestOutput {\n");
    ...
    sb.append("    beforeBlobId: ").append(toIndentedString(beforeBlobId)).append("\n");
    sb.append("    afterBlobId: ").append(toIndentedString(afterBlobId)).append("\n");
  ...
  static {
    ...
    openapiFields.add("beforeBlobId");
    openapiFields.add("afterBlobId");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostCommentForPullRequestOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostCommentForPullRequestOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostCommentForPullRequestOutput is not found in the empty JSON string", PostCommentForPullRequestOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostCommentForPullRequestOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostCommentForPullRequestOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("afterCommitId") != null && !jsonObj.get("afterCommitId").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("afterCommitId"));
      }
      // validate the optional field `beforeBlobId`
      if (jsonObj.get("beforeBlobId") != null && !jsonObj.get("beforeBlobId").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("beforeBlobId"));
      }
      // validate the optional field `afterBlobId`
      if (jsonObj.get("afterBlobId") != null && !jsonObj.get("afterBlobId").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("afterBlobId"));
      }
      // validate the optional field `location`
      if (jsonObj.get("location") != null && !jsonObj.get("location").isJsonNull()) {
        PostCommentForPullRequestOutputLocation.validateJsonElement(jsonObj.get("location"));
      }
      // validate the optional field `comment`
      if (jsonObj.get("comment") != null && !jsonObj.get("comment").isJsonNull()) {
        PostCommentForComparedCommitOutputComment.validateJsonElement(jsonObj.get("comment"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostCommentForPullRequestOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostCommentForPullRequestOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostCommentForPullRequestOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostCommentForPullRequestOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<PostCommentForPullRequestOutput>() {
           @Override
           public void write(JsonWriter out, PostCommentForPullRequestOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostCommentForPullRequestOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostCommentForPullRequestOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostCommentForPullRequestOutput
   * @throws IOException if the JSON string is invalid with respect to PostCommentForPullRequestOutput
   */
  public static PostCommentForPullRequestOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostCommentForPullRequestOutput.class);
  }

  /**
   * Convert an instance of PostCommentForPullRequestOutput to an JSON string
   *
   * @return JSON string
   */
