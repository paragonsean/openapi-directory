...
public class PullRequestSourceReferenceUpdatedEventMetadata {
  ...
  public static final String SERIALIZED_NAME_MERGE_BASE = "mergeBase";
  ...
  public PullRequestSourceReferenceUpdatedEventMetadata repositoryName(String repositoryName) {
  ...
  public PullRequestSourceReferenceUpdatedEventMetadata beforeCommitId(String beforeCommitId) {
  ...
  public PullRequestSourceReferenceUpdatedEventMetadata afterCommitId(String afterCommitId) {
  ...
  public PullRequestSourceReferenceUpdatedEventMetadata mergeBase(String mergeBase) {
  ...
  public boolean equals(Object o) {
    ...
    PullRequestSourceReferenceUpdatedEventMetadata pullRequestSourceReferenceUpdatedEventMetadata = (PullRequestSourceReferenceUpdatedEventMetadata) o;
    return Objects.equals(this.repositoryName, pullRequestSourceReferenceUpdatedEventMetadata.repositoryName) &&
        Objects.equals(this.beforeCommitId, pullRequestSourceReferenceUpdatedEventMetadata.beforeCommitId) &&
        Objects.equals(this.afterCommitId, pullRequestSourceReferenceUpdatedEventMetadata.afterCommitId) &&
        Objects.equals(this.mergeBase, pullRequestSourceReferenceUpdatedEventMetadata.mergeBase);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, beforeCommitId, afterCommitId, mergeBase);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PullRequestSourceReferenceUpdatedEventMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PullRequestSourceReferenceUpdatedEventMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PullRequestSourceReferenceUpdatedEventMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PullRequestSourceReferenceUpdatedEventMetadata is not found in the empty JSON string", PullRequestSourceReferenceUpdatedEventMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PullRequestSourceReferenceUpdatedEventMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PullRequestSourceReferenceUpdatedEventMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("mergeBase") != null && !jsonObj.get("mergeBase").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("mergeBase"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PullRequestSourceReferenceUpdatedEventMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PullRequestSourceReferenceUpdatedEventMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PullRequestSourceReferenceUpdatedEventMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PullRequestSourceReferenceUpdatedEventMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<PullRequestSourceReferenceUpdatedEventMetadata>() {
           @Override
           public void write(JsonWriter out, PullRequestSourceReferenceUpdatedEventMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PullRequestSourceReferenceUpdatedEventMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PullRequestSourceReferenceUpdatedEventMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PullRequestSourceReferenceUpdatedEventMetadata
   * @throws IOException if the JSON string is invalid with respect to PullRequestSourceReferenceUpdatedEventMetadata
   */
  public static PullRequestSourceReferenceUpdatedEventMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PullRequestSourceReferenceUpdatedEventMetadata.class);
  }

  /**
   * Convert an instance of PullRequestSourceReferenceUpdatedEventMetadata to an JSON string
   *
   * @return JSON string
   */
