...
public class ReactionValueFormats {
  ...
  public ReactionValueFormats emoji(String emoji) {
    this.emoji = emoji;
    return this;
  }
  ...
  public ReactionValueFormats shortCode(String shortCode) {
  ...
  public ReactionValueFormats unicode(String unicode) {
  ...
  public boolean equals(Object o) {
    ...
    ReactionValueFormats reactionValueFormats = (ReactionValueFormats) o;
    return Objects.equals(this.emoji, reactionValueFormats.emoji) &&
        Objects.equals(this.shortCode, reactionValueFormats.shortCode) &&
        Objects.equals(this.unicode, reactionValueFormats.unicode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(emoji, shortCode, unicode);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ReactionValueFormats {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReactionValueFormats
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReactionValueFormats.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReactionValueFormats is not found in the empty JSON string", ReactionValueFormats.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReactionValueFormats.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReactionValueFormats` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `emoji`
      if (jsonObj.get("emoji") != null && !jsonObj.get("emoji").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("emoji"));
      }
      ...
      // validate the optional field `unicode`
      if (jsonObj.get("unicode") != null && !jsonObj.get("unicode").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("unicode"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReactionValueFormats.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReactionValueFormats' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReactionValueFormats> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReactionValueFormats.class));

       return (TypeAdapter<T>) new TypeAdapter<ReactionValueFormats>() {
           @Override
           public void write(JsonWriter out, ReactionValueFormats value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReactionValueFormats read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReactionValueFormats given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReactionValueFormats
   * @throws IOException if the JSON string is invalid with respect to ReactionValueFormats
   */
  public static ReactionValueFormats fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReactionValueFormats.class);
  }

  /**
   * Convert an instance of ReactionValueFormats to an JSON string
   *
   * @return JSON string
   */
