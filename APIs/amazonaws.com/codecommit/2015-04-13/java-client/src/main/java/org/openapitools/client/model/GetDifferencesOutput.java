...
public class GetDifferencesOutput {
  ...
  public GetDifferencesOutput() {
  }

  public GetDifferencesOutput differences(List differences) {
  ...
  public GetDifferencesOutput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    GetDifferencesOutput getDifferencesOutput = (GetDifferencesOutput) o;
    return Objects.equals(this.differences, getDifferencesOutput.differences) &&
        Objects.equals(this.nextToken, getDifferencesOutput.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(differences, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetDifferencesOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDifferencesOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDifferencesOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetDifferencesOutput is not found in the empty JSON string", GetDifferencesOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDifferencesOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetDifferencesOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `differences`
      if (jsonObj.get("differences") != null && !jsonObj.get("differences").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("differences"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDifferencesOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDifferencesOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDifferencesOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDifferencesOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDifferencesOutput>() {
           @Override
           public void write(JsonWriter out, GetDifferencesOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDifferencesOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetDifferencesOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetDifferencesOutput
   * @throws IOException if the JSON string is invalid with respect to GetDifferencesOutput
   */
  public static GetDifferencesOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDifferencesOutput.class);
  }

  /**
   * Convert an instance of GetDifferencesOutput to an JSON string
   *
   * @return JSON string
   */
