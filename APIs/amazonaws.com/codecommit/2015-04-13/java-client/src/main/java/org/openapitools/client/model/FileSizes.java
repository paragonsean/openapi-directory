...
public class FileSizes {
  ...
  public FileSizes source(Integer source) {
    this.source = source;
    return this;
  }
  ...
  public FileSizes destination(Integer destination) {
  ...
  public FileSizes base(Integer base) {
    this.base = base;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FileSizes fileSizes = (FileSizes) o;
    return Objects.equals(this.source, fileSizes.source) &&
        Objects.equals(this.destination, fileSizes.destination) &&
        Objects.equals(this.base, fileSizes.base);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FileSizes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FileSizes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileSizes is not found in the empty JSON string", FileSizes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FileSizes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FileSizes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileSizes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileSizes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileSizes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileSizes.class));

       return (TypeAdapter<T>) new TypeAdapter<FileSizes>() {
           @Override
           public void write(JsonWriter out, FileSizes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FileSizes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FileSizes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FileSizes
   * @throws IOException if the JSON string is invalid with respect to FileSizes
   */
  public static FileSizes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileSizes.class);
  }

  /**
   * Convert an instance of FileSizes to an JSON string
   *
   * @return JSON string
   */
