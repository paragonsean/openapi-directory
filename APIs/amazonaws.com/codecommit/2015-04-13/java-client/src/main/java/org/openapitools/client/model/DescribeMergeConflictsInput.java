...
public class DescribeMergeConflictsInput {
  ...
  public static final String SERIALIZED_NAME_MAX_MERGE_HUNKS = "maxMergeHunks";
  @SerializedName(SERIALIZED_NAME_MAX_MERGE_HUNKS)
  ...
  public DescribeMergeConflictsInput() {
  }

  public DescribeMergeConflictsInput repositoryName(String repositoryName) {
  ...
  public DescribeMergeConflictsInput destinationCommitSpecifier(String destinationCommitSpecifier) {
  ...
  public DescribeMergeConflictsInput sourceCommitSpecifier(String sourceCommitSpecifier) {
  ...
  public DescribeMergeConflictsInput mergeOption(MergeOptionTypeEnum mergeOption) {
  ...
  public DescribeMergeConflictsInput maxMergeHunks(Integer maxMergeHunks) {
  ...
  public DescribeMergeConflictsInput filePath(String filePath) {
  ...
  public DescribeMergeConflictsInput conflictDetailLevel(ConflictDetailLevelTypeEnum conflictDetailLevel) {
  ...
  public DescribeMergeConflictsInput conflictResolutionStrategy(ConflictResolutionStrategyTypeEnum conflictResolutionStrategy) {
  ...
  public DescribeMergeConflictsInput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeMergeConflictsInput describeMergeConflictsInput = (DescribeMergeConflictsInput) o;
    return Objects.equals(this.repositoryName, describeMergeConflictsInput.repositoryName) &&
        Objects.equals(this.destinationCommitSpecifier, describeMergeConflictsInput.destinationCommitSpecifier) &&
        Objects.equals(this.sourceCommitSpecifier, describeMergeConflictsInput.sourceCommitSpecifier) &&
        Objects.equals(this.mergeOption, describeMergeConflictsInput.mergeOption) &&
        Objects.equals(this.maxMergeHunks, describeMergeConflictsInput.maxMergeHunks) &&
        Objects.equals(this.filePath, describeMergeConflictsInput.filePath) &&
        Objects.equals(this.conflictDetailLevel, describeMergeConflictsInput.conflictDetailLevel) &&
        Objects.equals(this.conflictResolutionStrategy, describeMergeConflictsInput.conflictResolutionStrategy) &&
        Objects.equals(this.nextToken, describeMergeConflictsInput.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, destinationCommitSpecifier, sourceCommitSpecifier, mergeOption, maxMergeHunks, filePath, conflictDetailLevel, conflictResolutionStrategy, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeMergeConflictsInput {\n");
    ...
    sb.append("    maxMergeHunks: ").append(toIndentedString(maxMergeHunks)).append("\n");
  ...
  static {
    ...
    openapiFields.add("maxMergeHunks");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeMergeConflictsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeMergeConflictsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeMergeConflictsInput is not found in the empty JSON string", DescribeMergeConflictsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeMergeConflictsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeMergeConflictsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeMergeConflictsInput.openapiRequiredFields) {
      ...
      // validate the optional field `maxMergeHunks`
      if (jsonObj.get("maxMergeHunks") != null && !jsonObj.get("maxMergeHunks").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("maxMergeHunks"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeMergeConflictsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeMergeConflictsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeMergeConflictsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeMergeConflictsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeMergeConflictsInput>() {
           @Override
           public void write(JsonWriter out, DescribeMergeConflictsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeMergeConflictsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeMergeConflictsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeMergeConflictsInput
   * @throws IOException if the JSON string is invalid with respect to DescribeMergeConflictsInput
   */
  public static DescribeMergeConflictsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeMergeConflictsInput.class);
  }

  /**
   * Convert an instance of DescribeMergeConflictsInput to an JSON string
   *
   * @return JSON string
   */
