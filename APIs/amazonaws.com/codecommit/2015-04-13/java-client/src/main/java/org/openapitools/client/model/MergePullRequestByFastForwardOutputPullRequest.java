...
public class MergePullRequestByFastForwardOutputPullRequest {
  ...
  public MergePullRequestByFastForwardOutputPullRequest() {
  }

  public MergePullRequestByFastForwardOutputPullRequest pullRequestId(String pullRequestId) {
  ...
  public MergePullRequestByFastForwardOutputPullRequest title(String title) {
    this.title = title;
    return this;
  }
  ...
  public MergePullRequestByFastForwardOutputPullRequest description(String description) {
  ...
  public MergePullRequestByFastForwardOutputPullRequest lastActivityDate(OffsetDateTime lastActivityDate) {
  ...
  public MergePullRequestByFastForwardOutputPullRequest creationDate(OffsetDateTime creationDate) {
  ...
  public MergePullRequestByFastForwardOutputPullRequest pullRequestStatus(PullRequestStatusEnum pullRequestStatus) {
  ...
  public MergePullRequestByFastForwardOutputPullRequest authorArn(String authorArn) {
  ...
  public MergePullRequestByFastForwardOutputPullRequest pullRequestTargets(List pullRequestTargets) {
  ...
  public MergePullRequestByFastForwardOutputPullRequest clientRequestToken(String clientRequestToken) {
  ...
  public MergePullRequestByFastForwardOutputPullRequest revisionId(String revisionId) {
  ...
  public MergePullRequestByFastForwardOutputPullRequest approvalRules(List approvalRules) {
  ...
  public boolean equals(Object o) {
    ...
    MergePullRequestByFastForwardOutputPullRequest mergePullRequestByFastForwardOutputPullRequest = (MergePullRequestByFastForwardOutputPullRequest) o;
    return Objects.equals(this.pullRequestId, mergePullRequestByFastForwardOutputPullRequest.pullRequestId) &&
        Objects.equals(this.title, mergePullRequestByFastForwardOutputPullRequest.title) &&
        Objects.equals(this.description, mergePullRequestByFastForwardOutputPullRequest.description) &&
        Objects.equals(this.lastActivityDate, mergePullRequestByFastForwardOutputPullRequest.lastActivityDate) &&
        Objects.equals(this.creationDate, mergePullRequestByFastForwardOutputPullRequest.creationDate) &&
        Objects.equals(this.pullRequestStatus, mergePullRequestByFastForwardOutputPullRequest.pullRequestStatus) &&
        Objects.equals(this.authorArn, mergePullRequestByFastForwardOutputPullRequest.authorArn) &&
        Objects.equals(this.pullRequestTargets, mergePullRequestByFastForwardOutputPullRequest.pullRequestTargets) &&
        Objects.equals(this.clientRequestToken, mergePullRequestByFastForwardOutputPullRequest.clientRequestToken) &&
        Objects.equals(this.revisionId, mergePullRequestByFastForwardOutputPullRequest.revisionId) &&
        Objects.equals(this.approvalRules, mergePullRequestByFastForwardOutputPullRequest.approvalRules);
  }
  ...
  public String toString() {
    ...
    sb.append("class MergePullRequestByFastForwardOutputPullRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MergePullRequestByFastForwardOutputPullRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MergePullRequestByFastForwardOutputPullRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MergePullRequestByFastForwardOutputPullRequest is not found in the empty JSON string", MergePullRequestByFastForwardOutputPullRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MergePullRequestByFastForwardOutputPullRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MergePullRequestByFastForwardOutputPullRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MergePullRequestByFastForwardOutputPullRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MergePullRequestByFastForwardOutputPullRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MergePullRequestByFastForwardOutputPullRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MergePullRequestByFastForwardOutputPullRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<MergePullRequestByFastForwardOutputPullRequest>() {
           @Override
           public void write(JsonWriter out, MergePullRequestByFastForwardOutputPullRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MergePullRequestByFastForwardOutputPullRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MergePullRequestByFastForwardOutputPullRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MergePullRequestByFastForwardOutputPullRequest
   * @throws IOException if the JSON string is invalid with respect to MergePullRequestByFastForwardOutputPullRequest
   */
  public static MergePullRequestByFastForwardOutputPullRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MergePullRequestByFastForwardOutputPullRequest.class);
  }

  /**
   * Convert an instance of MergePullRequestByFastForwardOutputPullRequest to an JSON string
   *
   * @return JSON string
   */
