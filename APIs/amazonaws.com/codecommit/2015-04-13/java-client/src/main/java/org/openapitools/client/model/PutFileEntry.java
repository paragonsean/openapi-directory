...
public class PutFileEntry {
  ...
  private PutFileEntrySourceFile sourceFile;

  public PutFileEntry() {
  }

  public PutFileEntry filePath(String filePath) {
  ...
  public PutFileEntry fileMode(FileModeTypeEnum fileMode) {
  ...
  public PutFileEntry fileContent(String fileContent) {
  ...
  public PutFileEntry sourceFile(PutFileEntrySourceFile sourceFile) {
   ...
   */
  @javax.annotation.Nullable
  public PutFileEntrySourceFile getSourceFile() {
    return sourceFile;
  }

  public void setSourceFile(PutFileEntrySourceFile sourceFile) {
    this.sourceFile = sourceFile;
  }
  ...
  public boolean equals(Object o) {
    ...
    PutFileEntry putFileEntry = (PutFileEntry) o;
    return Objects.equals(this.filePath, putFileEntry.filePath) &&
        Objects.equals(this.fileMode, putFileEntry.fileMode) &&
        Objects.equals(this.fileContent, putFileEntry.fileContent) &&
        Objects.equals(this.sourceFile, putFileEntry.sourceFile);
  }

  @Override
  public int hashCode() {
    return Objects.hash(filePath, fileMode, fileContent, sourceFile);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutFileEntry {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutFileEntry
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutFileEntry.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutFileEntry is not found in the empty JSON string", PutFileEntry.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutFileEntry.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutFileEntry` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PutFileEntry.openapiRequiredFields) {
      ...
      if (jsonObj.get("fileContent") != null && !jsonObj.get("fileContent").isJsonNull()) {
      ...
      if (jsonObj.get("sourceFile") != null && !jsonObj.get("sourceFile").isJsonNull()) {
        PutFileEntrySourceFile.validateJsonElement(jsonObj.get("sourceFile"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutFileEntry.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutFileEntry' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutFileEntry> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutFileEntry.class));

       return (TypeAdapter<T>) new TypeAdapter<PutFileEntry>() {
           @Override
           public void write(JsonWriter out, PutFileEntry value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutFileEntry read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutFileEntry given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutFileEntry
   * @throws IOException if the JSON string is invalid with respect to PutFileEntry
   */
  public static PutFileEntry fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutFileEntry.class);
  }

  /**
   * Convert an instance of PutFileEntry to an JSON string
   *
   * @return JSON string
   */
