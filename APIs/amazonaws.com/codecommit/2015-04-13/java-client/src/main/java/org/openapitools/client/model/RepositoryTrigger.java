...
public class RepositoryTrigger {
  ...
  public RepositoryTrigger name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RepositoryTrigger destinationArn(String destinationArn) {
  ...
  public RepositoryTrigger customData(String customData) {
  ...
  public RepositoryTrigger branches(List branches) {
  ...
  public RepositoryTrigger events(List events) {
    this.events = events;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RepositoryTrigger repositoryTrigger = (RepositoryTrigger) o;
    return Objects.equals(this.name, repositoryTrigger.name) &&
        Objects.equals(this.destinationArn, repositoryTrigger.destinationArn) &&
        Objects.equals(this.customData, repositoryTrigger.customData) &&
        Objects.equals(this.branches, repositoryTrigger.branches) &&
        Objects.equals(this.events, repositoryTrigger.events);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, destinationArn, customData, branches, events);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RepositoryTrigger {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RepositoryTrigger
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RepositoryTrigger.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RepositoryTrigger is not found in the empty JSON string", RepositoryTrigger.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RepositoryTrigger.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RepositoryTrigger` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RepositoryTrigger.openapiRequiredFields) {
      ...
      // validate the optional field `customData`
      if (jsonObj.get("customData") != null && !jsonObj.get("customData").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("customData"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RepositoryTrigger.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RepositoryTrigger' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RepositoryTrigger> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RepositoryTrigger.class));

       return (TypeAdapter<T>) new TypeAdapter<RepositoryTrigger>() {
           @Override
           public void write(JsonWriter out, RepositoryTrigger value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RepositoryTrigger read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RepositoryTrigger given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RepositoryTrigger
   * @throws IOException if the JSON string is invalid with respect to RepositoryTrigger
   */
  public static RepositoryTrigger fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RepositoryTrigger.class);
  }

  /**
   * Convert an instance of RepositoryTrigger to an JSON string
   *
   * @return JSON string
   */
