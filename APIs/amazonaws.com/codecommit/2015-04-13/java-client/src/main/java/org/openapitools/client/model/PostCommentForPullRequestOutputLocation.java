...
public class PostCommentForPullRequestOutputLocation {
  ...
  public PostCommentForPullRequestOutputLocation() {
  }

  public PostCommentForPullRequestOutputLocation filePath(String filePath) {
  ...
  public PostCommentForPullRequestOutputLocation filePosition(Integer filePosition) {
  ...
  public PostCommentForPullRequestOutputLocation relativeFileVersion(RelativeFileVersionEnum relativeFileVersion) {
  ...
  public boolean equals(Object o) {
    ...
    PostCommentForPullRequestOutputLocation postCommentForPullRequestOutputLocation = (PostCommentForPullRequestOutputLocation) o;
    return Objects.equals(this.filePath, postCommentForPullRequestOutputLocation.filePath) &&
        Objects.equals(this.filePosition, postCommentForPullRequestOutputLocation.filePosition) &&
        Objects.equals(this.relativeFileVersion, postCommentForPullRequestOutputLocation.relativeFileVersion);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostCommentForPullRequestOutputLocation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostCommentForPullRequestOutputLocation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostCommentForPullRequestOutputLocation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostCommentForPullRequestOutputLocation is not found in the empty JSON string", PostCommentForPullRequestOutputLocation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostCommentForPullRequestOutputLocation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostCommentForPullRequestOutputLocation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostCommentForPullRequestOutputLocation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostCommentForPullRequestOutputLocation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostCommentForPullRequestOutputLocation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostCommentForPullRequestOutputLocation.class));

       return (TypeAdapter<T>) new TypeAdapter<PostCommentForPullRequestOutputLocation>() {
           @Override
           public void write(JsonWriter out, PostCommentForPullRequestOutputLocation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostCommentForPullRequestOutputLocation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostCommentForPullRequestOutputLocation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostCommentForPullRequestOutputLocation
   * @throws IOException if the JSON string is invalid with respect to PostCommentForPullRequestOutputLocation
   */
  public static PostCommentForPullRequestOutputLocation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostCommentForPullRequestOutputLocation.class);
  }

  /**
   * Convert an instance of PostCommentForPullRequestOutputLocation to an JSON string
   *
   * @return JSON string
   */
