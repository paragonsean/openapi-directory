...
public class MergePullRequestByThreeWayInput {
  ...
  public MergePullRequestByThreeWayInput() {
  }

  public MergePullRequestByThreeWayInput pullRequestId(String pullRequestId) {
  ...
  public MergePullRequestByThreeWayInput repositoryName(String repositoryName) {
  ...
  public MergePullRequestByThreeWayInput sourceCommitId(String sourceCommitId) {
  ...
  public MergePullRequestByThreeWayInput conflictDetailLevel(ConflictDetailLevelTypeEnum conflictDetailLevel) {
  ...
  public MergePullRequestByThreeWayInput conflictResolutionStrategy(ConflictResolutionStrategyTypeEnum conflictResolutionStrategy) {
  ...
  public MergePullRequestByThreeWayInput commitMessage(String commitMessage) {
  ...
  public MergePullRequestByThreeWayInput authorName(String authorName) {
  ...
  public MergePullRequestByThreeWayInput email(String email) {
    this.email = email;
    return this;
  }
  ...
  public MergePullRequestByThreeWayInput keepEmptyFolders(Boolean keepEmptyFolders) {
  ...
  public MergePullRequestByThreeWayInput conflictResolution(CreateUnreferencedMergeCommitInputConflictResolution conflictResolution) {
  ...
  public boolean equals(Object o) {
    ...
    MergePullRequestByThreeWayInput mergePullRequestByThreeWayInput = (MergePullRequestByThreeWayInput) o;
    return Objects.equals(this.pullRequestId, mergePullRequestByThreeWayInput.pullRequestId) &&
        Objects.equals(this.repositoryName, mergePullRequestByThreeWayInput.repositoryName) &&
        Objects.equals(this.sourceCommitId, mergePullRequestByThreeWayInput.sourceCommitId) &&
        Objects.equals(this.conflictDetailLevel, mergePullRequestByThreeWayInput.conflictDetailLevel) &&
        Objects.equals(this.conflictResolutionStrategy, mergePullRequestByThreeWayInput.conflictResolutionStrategy) &&
        Objects.equals(this.commitMessage, mergePullRequestByThreeWayInput.commitMessage) &&
        Objects.equals(this.authorName, mergePullRequestByThreeWayInput.authorName) &&
        Objects.equals(this.email, mergePullRequestByThreeWayInput.email) &&
        Objects.equals(this.keepEmptyFolders, mergePullRequestByThreeWayInput.keepEmptyFolders) &&
        Objects.equals(this.conflictResolution, mergePullRequestByThreeWayInput.conflictResolution);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pullRequestId, repositoryName, sourceCommitId, conflictDetailLevel, conflictResolutionStrategy, commitMessage, authorName, email, keepEmptyFolders, conflictResolution);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MergePullRequestByThreeWayInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MergePullRequestByThreeWayInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MergePullRequestByThreeWayInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MergePullRequestByThreeWayInput is not found in the empty JSON string", MergePullRequestByThreeWayInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MergePullRequestByThreeWayInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MergePullRequestByThreeWayInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MergePullRequestByThreeWayInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MergePullRequestByThreeWayInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MergePullRequestByThreeWayInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MergePullRequestByThreeWayInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MergePullRequestByThreeWayInput.class));

       return (TypeAdapter<T>) new TypeAdapter<MergePullRequestByThreeWayInput>() {
           @Override
           public void write(JsonWriter out, MergePullRequestByThreeWayInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MergePullRequestByThreeWayInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MergePullRequestByThreeWayInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MergePullRequestByThreeWayInput
   * @throws IOException if the JSON string is invalid with respect to MergePullRequestByThreeWayInput
   */
  public static MergePullRequestByThreeWayInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MergePullRequestByThreeWayInput.class);
  }

  /**
   * Convert an instance of MergePullRequestByThreeWayInput to an JSON string
   *
   * @return JSON string
   */
