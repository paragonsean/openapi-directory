...
public class PostCommentReplyInput {
  ...
  public PostCommentReplyInput() {
  }

  public PostCommentReplyInput inReplyTo(String inReplyTo) {
  ...
  public PostCommentReplyInput clientRequestToken(String clientRequestToken) {
  ...
  public PostCommentReplyInput content(String content) {
  ...
  public boolean equals(Object o) {
    ...
    PostCommentReplyInput postCommentReplyInput = (PostCommentReplyInput) o;
    return Objects.equals(this.inReplyTo, postCommentReplyInput.inReplyTo) &&
        Objects.equals(this.clientRequestToken, postCommentReplyInput.clientRequestToken) &&
        Objects.equals(this.content, postCommentReplyInput.content);
  }

  @Override
  public int hashCode() {
    return Objects.hash(inReplyTo, clientRequestToken, content);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostCommentReplyInput {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("inReplyTo");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostCommentReplyInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostCommentReplyInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostCommentReplyInput is not found in the empty JSON string", PostCommentReplyInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostCommentReplyInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostCommentReplyInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostCommentReplyInput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `inReplyTo`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostCommentReplyInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostCommentReplyInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostCommentReplyInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostCommentReplyInput.class));

       return (TypeAdapter<T>) new TypeAdapter<PostCommentReplyInput>() {
           @Override
           public void write(JsonWriter out, PostCommentReplyInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostCommentReplyInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostCommentReplyInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostCommentReplyInput
   * @throws IOException if the JSON string is invalid with respect to PostCommentReplyInput
   */
  public static PostCommentReplyInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostCommentReplyInput.class);
  }

  /**
   * Convert an instance of PostCommentReplyInput to an JSON string
   *
   * @return JSON string
   */
