...
import org.openapitools.client.model.CreatePullRequestApprovalRuleOutputApprovalRule;
...
public class CreatePullRequestApprovalRuleOutput {
  public static final String SERIALIZED_NAME_APPROVAL_RULE = "approvalRule";
  @SerializedName(SERIALIZED_NAME_APPROVAL_RULE)
  private CreatePullRequestApprovalRuleOutputApprovalRule approvalRule;

  public CreatePullRequestApprovalRuleOutput() {
  }

  public CreatePullRequestApprovalRuleOutput approvalRule(CreatePullRequestApprovalRuleOutputApprovalRule approvalRule) {
  ...
  public CreatePullRequestApprovalRuleOutputApprovalRule getApprovalRule() {
    return approvalRule;
  }

  public void setApprovalRule(CreatePullRequestApprovalRuleOutputApprovalRule approvalRule) {
    this.approvalRule = approvalRule;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreatePullRequestApprovalRuleOutput createPullRequestApprovalRuleOutput = (CreatePullRequestApprovalRuleOutput) o;
    return Objects.equals(this.approvalRule, createPullRequestApprovalRuleOutput.approvalRule);
  }

  @Override
  public int hashCode() {
    return Objects.hash(approvalRule);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreatePullRequestApprovalRuleOutput {\n");
    sb.append("    approvalRule: ").append(toIndentedString(approvalRule)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("approvalRule");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("approvalRule");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePullRequestApprovalRuleOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePullRequestApprovalRuleOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePullRequestApprovalRuleOutput is not found in the empty JSON string", CreatePullRequestApprovalRuleOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePullRequestApprovalRuleOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePullRequestApprovalRuleOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreatePullRequestApprovalRuleOutput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `approvalRule`
      CreatePullRequestApprovalRuleOutputApprovalRule.validateJsonElement(jsonObj.get("approvalRule"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePullRequestApprovalRuleOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePullRequestApprovalRuleOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePullRequestApprovalRuleOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePullRequestApprovalRuleOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePullRequestApprovalRuleOutput>() {
           @Override
           public void write(JsonWriter out, CreatePullRequestApprovalRuleOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePullRequestApprovalRuleOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePullRequestApprovalRuleOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePullRequestApprovalRuleOutput
   * @throws IOException if the JSON string is invalid with respect to CreatePullRequestApprovalRuleOutput
   */
  public static CreatePullRequestApprovalRuleOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePullRequestApprovalRuleOutput.class);
  }

  /**
   * Convert an instance of CreatePullRequestApprovalRuleOutput to an JSON string
   *
   * @return JSON string
   */
