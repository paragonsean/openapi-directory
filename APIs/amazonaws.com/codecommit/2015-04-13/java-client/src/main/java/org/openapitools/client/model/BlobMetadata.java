...
public class BlobMetadata {
  ...
  public BlobMetadata blobId(String blobId) {
    this.blobId = blobId;
    return this;
  }
  ...
  public BlobMetadata path(String path) {
    this.path = path;
    return this;
  }
  ...
  public BlobMetadata mode(String mode) {
    this.mode = mode;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    BlobMetadata blobMetadata = (BlobMetadata) o;
    return Objects.equals(this.blobId, blobMetadata.blobId) &&
        Objects.equals(this.path, blobMetadata.path) &&
        Objects.equals(this.mode, blobMetadata.mode);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BlobMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BlobMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BlobMetadata is not found in the empty JSON string", BlobMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BlobMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BlobMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BlobMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BlobMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BlobMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BlobMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<BlobMetadata>() {
           @Override
           public void write(JsonWriter out, BlobMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BlobMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BlobMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BlobMetadata
   * @throws IOException if the JSON string is invalid with respect to BlobMetadata
   */
  public static BlobMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BlobMetadata.class);
  }

  /**
   * Convert an instance of BlobMetadata to an JSON string
   *
   * @return JSON string
   */
