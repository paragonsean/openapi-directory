...
public class SubModule {
  ...
  public SubModule commitId(String commitId) {
  ...
  public SubModule absolutePath(String absolutePath) {
  ...
  public SubModule relativePath(String relativePath) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.commitId, subModule.commitId) &&
        Objects.equals(this.absolutePath, subModule.absolutePath) &&
        Objects.equals(this.relativePath, subModule.relativePath);
  }

  @Override
  public int hashCode() {
    return Objects.hash(commitId, absolutePath, relativePath);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SubModule {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SubModule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SubModule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SubModule is not found in the empty JSON string", SubModule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SubModule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SubModule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SubModule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SubModule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SubModule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SubModule.class));

       return (TypeAdapter<T>) new TypeAdapter<SubModule>() {
           @Override
           public void write(JsonWriter out, SubModule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SubModule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SubModule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SubModule
   * @throws IOException if the JSON string is invalid with respect to SubModule
   */
  public static SubModule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SubModule.class);
  }

  /**
   * Convert an instance of SubModule to an JSON string
   *
   * @return JSON string
   */
