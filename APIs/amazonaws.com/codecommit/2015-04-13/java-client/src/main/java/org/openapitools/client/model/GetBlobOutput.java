...
public class GetBlobOutput {
  ...
  public GetBlobOutput() {
  }

  public GetBlobOutput content(String content) {
  ...
  public boolean equals(Object o) {
    ...
    GetBlobOutput getBlobOutput = (GetBlobOutput) o;
    return Objects.equals(this.content, getBlobOutput.content);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetBlobOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetBlobOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetBlobOutput is not found in the empty JSON string", GetBlobOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetBlobOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetBlobOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetBlobOutput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetBlobOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetBlobOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetBlobOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetBlobOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetBlobOutput>() {
           @Override
           public void write(JsonWriter out, GetBlobOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetBlobOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetBlobOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetBlobOutput
   * @throws IOException if the JSON string is invalid with respect to GetBlobOutput
   */
  public static GetBlobOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetBlobOutput.class);
  }

  /**
   * Convert an instance of GetBlobOutput to an JSON string
   *
   * @return JSON string
   */
