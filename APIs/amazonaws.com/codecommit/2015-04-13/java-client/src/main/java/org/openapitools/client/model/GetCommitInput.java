...
public class GetCommitInput {
  ...
  public GetCommitInput() {
  }

  public GetCommitInput repositoryName(String repositoryName) {
  ...
  public GetCommitInput commitId(String commitId) {
  ...
  public boolean equals(Object o) {
    ...
    GetCommitInput getCommitInput = (GetCommitInput) o;
    return Objects.equals(this.repositoryName, getCommitInput.repositoryName) &&
        Objects.equals(this.commitId, getCommitInput.commitId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, commitId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetCommitInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCommitInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCommitInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCommitInput is not found in the empty JSON string", GetCommitInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCommitInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCommitInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetCommitInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCommitInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCommitInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCommitInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCommitInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCommitInput>() {
           @Override
           public void write(JsonWriter out, GetCommitInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCommitInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCommitInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCommitInput
   * @throws IOException if the JSON string is invalid with respect to GetCommitInput
   */
  public static GetCommitInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCommitInput.class);
  }

  /**
   * Convert an instance of GetCommitInput to an JSON string
   *
   * @return JSON string
   */
