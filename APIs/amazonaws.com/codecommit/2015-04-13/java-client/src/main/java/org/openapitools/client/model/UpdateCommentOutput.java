...
import org.openapitools.client.model.UpdateCommentOutputComment;
...
public class UpdateCommentOutput {
  ...
  private UpdateCommentOutputComment comment;

  public UpdateCommentOutput() {
  }

  public UpdateCommentOutput comment(UpdateCommentOutputComment comment) {
  ...
  public UpdateCommentOutputComment getComment() {
    return comment;
  }

  public void setComment(UpdateCommentOutputComment comment) {
    this.comment = comment;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateCommentOutput updateCommentOutput = (UpdateCommentOutput) o;
    return Objects.equals(this.comment, updateCommentOutput.comment);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateCommentOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateCommentOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateCommentOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateCommentOutput is not found in the empty JSON string", UpdateCommentOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateCommentOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateCommentOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `comment`
      if (jsonObj.get("comment") != null && !jsonObj.get("comment").isJsonNull()) {
        UpdateCommentOutputComment.validateJsonElement(jsonObj.get("comment"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateCommentOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateCommentOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateCommentOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateCommentOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateCommentOutput>() {
           @Override
           public void write(JsonWriter out, UpdateCommentOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateCommentOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateCommentOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateCommentOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateCommentOutput
   */
  public static UpdateCommentOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateCommentOutput.class);
  }

  /**
   * Convert an instance of UpdateCommentOutput to an JSON string
   *
   * @return JSON string
   */
