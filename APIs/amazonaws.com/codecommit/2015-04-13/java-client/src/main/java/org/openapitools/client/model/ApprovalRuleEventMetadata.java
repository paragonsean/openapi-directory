...
public class ApprovalRuleEventMetadata {
  ...
  public ApprovalRuleEventMetadata approvalRuleName(String approvalRuleName) {
  ...
  public ApprovalRuleEventMetadata approvalRuleId(String approvalRuleId) {
  ...
  public ApprovalRuleEventMetadata approvalRuleContent(String approvalRuleContent) {
  ...
  public boolean equals(Object o) {
    ...
    ApprovalRuleEventMetadata approvalRuleEventMetadata = (ApprovalRuleEventMetadata) o;
    return Objects.equals(this.approvalRuleName, approvalRuleEventMetadata.approvalRuleName) &&
        Objects.equals(this.approvalRuleId, approvalRuleEventMetadata.approvalRuleId) &&
        Objects.equals(this.approvalRuleContent, approvalRuleEventMetadata.approvalRuleContent);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApprovalRuleEventMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApprovalRuleEventMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApprovalRuleEventMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApprovalRuleEventMetadata is not found in the empty JSON string", ApprovalRuleEventMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApprovalRuleEventMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApprovalRuleEventMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApprovalRuleEventMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApprovalRuleEventMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApprovalRuleEventMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApprovalRuleEventMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<ApprovalRuleEventMetadata>() {
           @Override
           public void write(JsonWriter out, ApprovalRuleEventMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApprovalRuleEventMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApprovalRuleEventMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApprovalRuleEventMetadata
   * @throws IOException if the JSON string is invalid with respect to ApprovalRuleEventMetadata
   */
  public static ApprovalRuleEventMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApprovalRuleEventMetadata.class);
  }

  /**
   * Convert an instance of ApprovalRuleEventMetadata to an JSON string
   *
   * @return JSON string
   */
