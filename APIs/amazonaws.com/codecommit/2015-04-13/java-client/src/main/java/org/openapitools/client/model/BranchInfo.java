...
public class BranchInfo {
  ...
  public BranchInfo branchName(String branchName) {
  ...
  public BranchInfo commitId(String commitId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.branchName, branchInfo.branchName) &&
        Objects.equals(this.commitId, branchInfo.commitId);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BranchInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BranchInfo is not found in the empty JSON string", BranchInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BranchInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BranchInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
