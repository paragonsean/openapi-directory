...
public class PostCommentForComparedCommitOutput {
  ...
  private PostCommentForComparedCommitOutputLocation location;
  ...
  public PostCommentForComparedCommitOutput repositoryName(String repositoryName) {
  ...
  public PostCommentForComparedCommitOutput beforeCommitId(String beforeCommitId) {
  ...
  public PostCommentForComparedCommitOutput afterCommitId(String afterCommitId) {
  ...
  public PostCommentForComparedCommitOutput beforeBlobId(String beforeBlobId) {
  ...
  public PostCommentForComparedCommitOutput afterBlobId(String afterBlobId) {
  ...
  public PostCommentForComparedCommitOutput location(PostCommentForComparedCommitOutputLocation location) {
   ...
   */
  @javax.annotation.Nullable
  public PostCommentForComparedCommitOutputLocation getLocation() {
    return location;
  }

  public void setLocation(PostCommentForComparedCommitOutputLocation location) {
    this.location = location;
  }


  public PostCommentForComparedCommitOutput comment(PostCommentForComparedCommitOutputComment comment) {
  ...
  public boolean equals(Object o) {
    ...
    PostCommentForComparedCommitOutput postCommentForComparedCommitOutput = (PostCommentForComparedCommitOutput) o;
    return Objects.equals(this.repositoryName, postCommentForComparedCommitOutput.repositoryName) &&
        Objects.equals(this.beforeCommitId, postCommentForComparedCommitOutput.beforeCommitId) &&
        Objects.equals(this.afterCommitId, postCommentForComparedCommitOutput.afterCommitId) &&
        Objects.equals(this.beforeBlobId, postCommentForComparedCommitOutput.beforeBlobId) &&
        Objects.equals(this.afterBlobId, postCommentForComparedCommitOutput.afterBlobId) &&
        Objects.equals(this.location, postCommentForComparedCommitOutput.location) &&
        Objects.equals(this.comment, postCommentForComparedCommitOutput.comment);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, beforeCommitId, afterCommitId, beforeBlobId, afterBlobId, location, comment);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostCommentForComparedCommitOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostCommentForComparedCommitOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostCommentForComparedCommitOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostCommentForComparedCommitOutput is not found in the empty JSON string", PostCommentForComparedCommitOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostCommentForComparedCommitOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostCommentForComparedCommitOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("location") != null && !jsonObj.get("location").isJsonNull()) {
        PostCommentForComparedCommitOutputLocation.validateJsonElement(jsonObj.get("location"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostCommentForComparedCommitOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostCommentForComparedCommitOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostCommentForComparedCommitOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostCommentForComparedCommitOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<PostCommentForComparedCommitOutput>() {
           @Override
           public void write(JsonWriter out, PostCommentForComparedCommitOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostCommentForComparedCommitOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostCommentForComparedCommitOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostCommentForComparedCommitOutput
   * @throws IOException if the JSON string is invalid with respect to PostCommentForComparedCommitOutput
   */
  public static PostCommentForComparedCommitOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostCommentForComparedCommitOutput.class);
  }

  /**
   * Convert an instance of PostCommentForComparedCommitOutput to an JSON string
   *
   * @return JSON string
   */
