...
import org.openapitools.client.model.GetPullRequestOutputPullRequest;
...
public class GetPullRequestOutput {
  ...
  private GetPullRequestOutputPullRequest pullRequest;

  public GetPullRequestOutput() {
  }

  public GetPullRequestOutput pullRequest(GetPullRequestOutputPullRequest pullRequest) {
  ...
  public GetPullRequestOutputPullRequest getPullRequest() {
    return pullRequest;
  }

  public void setPullRequest(GetPullRequestOutputPullRequest pullRequest) {
    this.pullRequest = pullRequest;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetPullRequestOutput getPullRequestOutput = (GetPullRequestOutput) o;
    return Objects.equals(this.pullRequest, getPullRequestOutput.pullRequest);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetPullRequestOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPullRequestOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPullRequestOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPullRequestOutput is not found in the empty JSON string", GetPullRequestOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPullRequestOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPullRequestOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetPullRequestOutput.openapiRequiredFields) {
      ...
      GetPullRequestOutputPullRequest.validateJsonElement(jsonObj.get("pullRequest"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPullRequestOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPullRequestOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPullRequestOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPullRequestOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPullRequestOutput>() {
           @Override
           public void write(JsonWriter out, GetPullRequestOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPullRequestOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPullRequestOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPullRequestOutput
   * @throws IOException if the JSON string is invalid with respect to GetPullRequestOutput
   */
  public static GetPullRequestOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPullRequestOutput.class);
  }

  /**
   * Convert an instance of GetPullRequestOutput to an JSON string
   *
   * @return JSON string
   */
