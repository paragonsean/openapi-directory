...
public class ObjectTypes {
  ...
  public ObjectTypes source(ObjectTypeEnum source) {
    this.source = source;
    return this;
  }
  ...
  public ObjectTypes destination(ObjectTypeEnum destination) {
  ...
  public ObjectTypes base(ObjectTypeEnum base) {
    this.base = base;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ObjectTypes objectTypes = (ObjectTypes) o;
    return Objects.equals(this.source, objectTypes.source) &&
        Objects.equals(this.destination, objectTypes.destination) &&
        Objects.equals(this.base, objectTypes.base);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ObjectTypes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ObjectTypes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ObjectTypes is not found in the empty JSON string", ObjectTypes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ObjectTypes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ObjectTypes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ObjectTypes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ObjectTypes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ObjectTypes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ObjectTypes.class));

       return (TypeAdapter<T>) new TypeAdapter<ObjectTypes>() {
           @Override
           public void write(JsonWriter out, ObjectTypes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ObjectTypes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ObjectTypes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ObjectTypes
   * @throws IOException if the JSON string is invalid with respect to ObjectTypes
   */
  public static ObjectTypes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ObjectTypes.class);
  }

  /**
   * Convert an instance of ObjectTypes to an JSON string
   *
   * @return JSON string
   */
