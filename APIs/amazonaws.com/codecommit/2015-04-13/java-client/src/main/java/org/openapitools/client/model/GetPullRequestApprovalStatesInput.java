...
public class GetPullRequestApprovalStatesInput {
  ...
  public GetPullRequestApprovalStatesInput() {
  }

  public GetPullRequestApprovalStatesInput pullRequestId(String pullRequestId) {
  ...
  public GetPullRequestApprovalStatesInput revisionId(String revisionId) {
  ...
  public boolean equals(Object o) {
    ...
    GetPullRequestApprovalStatesInput getPullRequestApprovalStatesInput = (GetPullRequestApprovalStatesInput) o;
    return Objects.equals(this.pullRequestId, getPullRequestApprovalStatesInput.pullRequestId) &&
        Objects.equals(this.revisionId, getPullRequestApprovalStatesInput.revisionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetPullRequestApprovalStatesInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPullRequestApprovalStatesInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPullRequestApprovalStatesInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPullRequestApprovalStatesInput is not found in the empty JSON string", GetPullRequestApprovalStatesInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPullRequestApprovalStatesInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPullRequestApprovalStatesInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetPullRequestApprovalStatesInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPullRequestApprovalStatesInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPullRequestApprovalStatesInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPullRequestApprovalStatesInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPullRequestApprovalStatesInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPullRequestApprovalStatesInput>() {
           @Override
           public void write(JsonWriter out, GetPullRequestApprovalStatesInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPullRequestApprovalStatesInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPullRequestApprovalStatesInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPullRequestApprovalStatesInput
   * @throws IOException if the JSON string is invalid with respect to GetPullRequestApprovalStatesInput
   */
  public static GetPullRequestApprovalStatesInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPullRequestApprovalStatesInput.class);
  }

  /**
   * Convert an instance of GetPullRequestApprovalStatesInput to an JSON string
   *
   * @return JSON string
   */
