...
/**
 * Gets or Sets RelativeFileVersionEnum
 */
@JsonAdapter(RelativeFileVersionEnum.Adapter.class)
public enum RelativeFileVersionEnum {
  ...
  RelativeFileVersionEnum(String value) {
    this.value = value;
  }
  ...
  public static RelativeFileVersionEnum fromValue(String value) {
    for (RelativeFileVersionEnum b : RelativeFileVersionEnum.values()) {
  ...
  public static class Adapter extends TypeAdapter<RelativeFileVersionEnum> {
    @Override
    public void write(final JsonWriter jsonWriter, final RelativeFileVersionEnum enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RelativeFileVersionEnum read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RelativeFileVersionEnum.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    RelativeFileVersionEnum.fromValue(value);
  }
}
