...
public class UpdateApprovalRuleTemplateContentInput {
  ...
  public UpdateApprovalRuleTemplateContentInput() {
  }

  public UpdateApprovalRuleTemplateContentInput approvalRuleTemplateName(String approvalRuleTemplateName) {
  ...
  public UpdateApprovalRuleTemplateContentInput newRuleContent(String newRuleContent) {
  ...
  public UpdateApprovalRuleTemplateContentInput existingRuleContentSha256(String existingRuleContentSha256) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateApprovalRuleTemplateContentInput updateApprovalRuleTemplateContentInput = (UpdateApprovalRuleTemplateContentInput) o;
    return Objects.equals(this.approvalRuleTemplateName, updateApprovalRuleTemplateContentInput.approvalRuleTemplateName) &&
        Objects.equals(this.newRuleContent, updateApprovalRuleTemplateContentInput.newRuleContent) &&
        Objects.equals(this.existingRuleContentSha256, updateApprovalRuleTemplateContentInput.existingRuleContentSha256);
  }

  @Override
  public int hashCode() {
    return Objects.hash(approvalRuleTemplateName, newRuleContent, existingRuleContentSha256);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateApprovalRuleTemplateContentInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateApprovalRuleTemplateContentInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateApprovalRuleTemplateContentInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateApprovalRuleTemplateContentInput is not found in the empty JSON string", UpdateApprovalRuleTemplateContentInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateApprovalRuleTemplateContentInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateApprovalRuleTemplateContentInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateApprovalRuleTemplateContentInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateApprovalRuleTemplateContentInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateApprovalRuleTemplateContentInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateApprovalRuleTemplateContentInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateApprovalRuleTemplateContentInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateApprovalRuleTemplateContentInput>() {
           @Override
           public void write(JsonWriter out, UpdateApprovalRuleTemplateContentInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateApprovalRuleTemplateContentInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateApprovalRuleTemplateContentInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateApprovalRuleTemplateContentInput
   * @throws IOException if the JSON string is invalid with respect to UpdateApprovalRuleTemplateContentInput
   */
  public static UpdateApprovalRuleTemplateContentInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateApprovalRuleTemplateContentInput.class);
  }

  /**
   * Convert an instance of UpdateApprovalRuleTemplateContentInput to an JSON string
   *
   * @return JSON string
   */
