...
public class UpdatePullRequestStatusOutputPullRequest {
  ...
  public UpdatePullRequestStatusOutputPullRequest() {
  }

  public UpdatePullRequestStatusOutputPullRequest pullRequestId(String pullRequestId) {
  ...
  public UpdatePullRequestStatusOutputPullRequest title(String title) {
    this.title = title;
    return this;
  }
  ...
  public UpdatePullRequestStatusOutputPullRequest description(String description) {
  ...
  public UpdatePullRequestStatusOutputPullRequest lastActivityDate(OffsetDateTime lastActivityDate) {
  ...
  public UpdatePullRequestStatusOutputPullRequest creationDate(OffsetDateTime creationDate) {
  ...
  public UpdatePullRequestStatusOutputPullRequest pullRequestStatus(PullRequestStatusEnum pullRequestStatus) {
  ...
  public UpdatePullRequestStatusOutputPullRequest authorArn(String authorArn) {
  ...
  public UpdatePullRequestStatusOutputPullRequest pullRequestTargets(List pullRequestTargets) {
  ...
  public UpdatePullRequestStatusOutputPullRequest clientRequestToken(String clientRequestToken) {
  ...
  public UpdatePullRequestStatusOutputPullRequest revisionId(String revisionId) {
  ...
  public UpdatePullRequestStatusOutputPullRequest approvalRules(List approvalRules) {
  ...
  public boolean equals(Object o) {
    ...
    UpdatePullRequestStatusOutputPullRequest updatePullRequestStatusOutputPullRequest = (UpdatePullRequestStatusOutputPullRequest) o;
    return Objects.equals(this.pullRequestId, updatePullRequestStatusOutputPullRequest.pullRequestId) &&
        Objects.equals(this.title, updatePullRequestStatusOutputPullRequest.title) &&
        Objects.equals(this.description, updatePullRequestStatusOutputPullRequest.description) &&
        Objects.equals(this.lastActivityDate, updatePullRequestStatusOutputPullRequest.lastActivityDate) &&
        Objects.equals(this.creationDate, updatePullRequestStatusOutputPullRequest.creationDate) &&
        Objects.equals(this.pullRequestStatus, updatePullRequestStatusOutputPullRequest.pullRequestStatus) &&
        Objects.equals(this.authorArn, updatePullRequestStatusOutputPullRequest.authorArn) &&
        Objects.equals(this.pullRequestTargets, updatePullRequestStatusOutputPullRequest.pullRequestTargets) &&
        Objects.equals(this.clientRequestToken, updatePullRequestStatusOutputPullRequest.clientRequestToken) &&
        Objects.equals(this.revisionId, updatePullRequestStatusOutputPullRequest.revisionId) &&
        Objects.equals(this.approvalRules, updatePullRequestStatusOutputPullRequest.approvalRules);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdatePullRequestStatusOutputPullRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePullRequestStatusOutputPullRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePullRequestStatusOutputPullRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePullRequestStatusOutputPullRequest is not found in the empty JSON string", UpdatePullRequestStatusOutputPullRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePullRequestStatusOutputPullRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePullRequestStatusOutputPullRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePullRequestStatusOutputPullRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePullRequestStatusOutputPullRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePullRequestStatusOutputPullRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePullRequestStatusOutputPullRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePullRequestStatusOutputPullRequest>() {
           @Override
           public void write(JsonWriter out, UpdatePullRequestStatusOutputPullRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePullRequestStatusOutputPullRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePullRequestStatusOutputPullRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePullRequestStatusOutputPullRequest
   * @throws IOException if the JSON string is invalid with respect to UpdatePullRequestStatusOutputPullRequest
   */
  public static UpdatePullRequestStatusOutputPullRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePullRequestStatusOutputPullRequest.class);
  }

  /**
   * Convert an instance of UpdatePullRequestStatusOutputPullRequest to an JSON string
   *
   * @return JSON string
   */
