...
public class SetFileModeEntry {
  ...
  public SetFileModeEntry() {
  }

  public SetFileModeEntry filePath(String filePath) {
  ...
  public SetFileModeEntry fileMode(FileModeTypeEnum fileMode) {
  ...
  public boolean equals(Object o) {
    ...
    SetFileModeEntry setFileModeEntry = (SetFileModeEntry) o;
    return Objects.equals(this.filePath, setFileModeEntry.filePath) &&
        Objects.equals(this.fileMode, setFileModeEntry.fileMode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(filePath, fileMode);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SetFileModeEntry {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetFileModeEntry
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetFileModeEntry.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetFileModeEntry is not found in the empty JSON string", SetFileModeEntry.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetFileModeEntry.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SetFileModeEntry` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SetFileModeEntry.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetFileModeEntry.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetFileModeEntry' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SetFileModeEntry> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SetFileModeEntry.class));

       return (TypeAdapter<T>) new TypeAdapter<SetFileModeEntry>() {
           @Override
           public void write(JsonWriter out, SetFileModeEntry value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SetFileModeEntry read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SetFileModeEntry given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SetFileModeEntry
   * @throws IOException if the JSON string is invalid with respect to SetFileModeEntry
   */
  public static SetFileModeEntry fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SetFileModeEntry.class);
  }

  /**
   * Convert an instance of SetFileModeEntry to an JSON string
   *
   * @return JSON string
   */
