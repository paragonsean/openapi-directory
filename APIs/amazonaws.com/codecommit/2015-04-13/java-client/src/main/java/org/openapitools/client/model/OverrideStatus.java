...
/**
 * Gets or Sets OverrideStatus
 */
@JsonAdapter(OverrideStatus.Adapter.class)
public enum OverrideStatus {
  ...
  public static OverrideStatus fromValue(String value) {
    for (OverrideStatus b : OverrideStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<OverrideStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final OverrideStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OverrideStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OverrideStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    OverrideStatus.fromValue(value);
  }
}
