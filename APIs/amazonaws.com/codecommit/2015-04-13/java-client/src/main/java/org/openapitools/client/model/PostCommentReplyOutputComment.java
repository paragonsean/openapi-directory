...
public class PostCommentReplyOutputComment {
  ...
  public PostCommentReplyOutputComment() {
  }

  public PostCommentReplyOutputComment commentId(String commentId) {
  ...
  public PostCommentReplyOutputComment content(String content) {
  ...
  public PostCommentReplyOutputComment inReplyTo(String inReplyTo) {
  ...
  public PostCommentReplyOutputComment creationDate(OffsetDateTime creationDate) {
  ...
  public PostCommentReplyOutputComment lastModifiedDate(OffsetDateTime lastModifiedDate) {
  ...
  public PostCommentReplyOutputComment authorArn(String authorArn) {
  ...
  public PostCommentReplyOutputComment deleted(Boolean deleted) {
  ...
  public PostCommentReplyOutputComment clientRequestToken(String clientRequestToken) {
  ...
  public PostCommentReplyOutputComment callerReactions(List callerReactions) {
  ...
  public PostCommentReplyOutputComment reactionCounts(Map reactionCounts) {
  ...
  public boolean equals(Object o) {
    ...
    PostCommentReplyOutputComment postCommentReplyOutputComment = (PostCommentReplyOutputComment) o;
    return Objects.equals(this.commentId, postCommentReplyOutputComment.commentId) &&
        Objects.equals(this.content, postCommentReplyOutputComment.content) &&
        Objects.equals(this.inReplyTo, postCommentReplyOutputComment.inReplyTo) &&
        Objects.equals(this.creationDate, postCommentReplyOutputComment.creationDate) &&
        Objects.equals(this.lastModifiedDate, postCommentReplyOutputComment.lastModifiedDate) &&
        Objects.equals(this.authorArn, postCommentReplyOutputComment.authorArn) &&
        Objects.equals(this.deleted, postCommentReplyOutputComment.deleted) &&
        Objects.equals(this.clientRequestToken, postCommentReplyOutputComment.clientRequestToken) &&
        Objects.equals(this.callerReactions, postCommentReplyOutputComment.callerReactions) &&
        Objects.equals(this.reactionCounts, postCommentReplyOutputComment.reactionCounts);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostCommentReplyOutputComment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostCommentReplyOutputComment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostCommentReplyOutputComment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostCommentReplyOutputComment is not found in the empty JSON string", PostCommentReplyOutputComment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostCommentReplyOutputComment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostCommentReplyOutputComment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostCommentReplyOutputComment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostCommentReplyOutputComment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostCommentReplyOutputComment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostCommentReplyOutputComment.class));

       return (TypeAdapter<T>) new TypeAdapter<PostCommentReplyOutputComment>() {
           @Override
           public void write(JsonWriter out, PostCommentReplyOutputComment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostCommentReplyOutputComment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostCommentReplyOutputComment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostCommentReplyOutputComment
   * @throws IOException if the JSON string is invalid with respect to PostCommentReplyOutputComment
   */
  public static PostCommentReplyOutputComment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostCommentReplyOutputComment.class);
  }

  /**
   * Convert an instance of PostCommentReplyOutputComment to an JSON string
   *
   * @return JSON string
   */
