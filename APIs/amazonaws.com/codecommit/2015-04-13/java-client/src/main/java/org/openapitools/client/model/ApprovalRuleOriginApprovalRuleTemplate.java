...
public class ApprovalRuleOriginApprovalRuleTemplate {
  public static final String SERIALIZED_NAME_APPROVAL_RULE_TEMPLATE_ID = "approvalRuleTemplateId";
  @SerializedName(SERIALIZED_NAME_APPROVAL_RULE_TEMPLATE_ID)
  private String approvalRuleTemplateId;

  public static final String SERIALIZED_NAME_APPROVAL_RULE_TEMPLATE_NAME = "approvalRuleTemplateName";
  @SerializedName(SERIALIZED_NAME_APPROVAL_RULE_TEMPLATE_NAME)
  private String approvalRuleTemplateName;

  public ApprovalRuleOriginApprovalRuleTemplate() {
  }

  public ApprovalRuleOriginApprovalRuleTemplate approvalRuleTemplateId(String approvalRuleTemplateId) {
  ...
  public ApprovalRuleOriginApprovalRuleTemplate approvalRuleTemplateName(String approvalRuleTemplateName) {
  ...
  public boolean equals(Object o) {
    ...
    ApprovalRuleOriginApprovalRuleTemplate approvalRuleOriginApprovalRuleTemplate = (ApprovalRuleOriginApprovalRuleTemplate) o;
    return Objects.equals(this.approvalRuleTemplateId, approvalRuleOriginApprovalRuleTemplate.approvalRuleTemplateId) &&
        Objects.equals(this.approvalRuleTemplateName, approvalRuleOriginApprovalRuleTemplate.approvalRuleTemplateName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(approvalRuleTemplateId, approvalRuleTemplateName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApprovalRuleOriginApprovalRuleTemplate {\n");
    sb.append("    approvalRuleTemplateId: ").append(toIndentedString(approvalRuleTemplateId)).append("\n");
    sb.append("    approvalRuleTemplateName: ").append(toIndentedString(approvalRuleTemplateName)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("approvalRuleTemplateId");
    openapiFields.add("approvalRuleTemplateName");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApprovalRuleOriginApprovalRuleTemplate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApprovalRuleOriginApprovalRuleTemplate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApprovalRuleOriginApprovalRuleTemplate is not found in the empty JSON string", ApprovalRuleOriginApprovalRuleTemplate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApprovalRuleOriginApprovalRuleTemplate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApprovalRuleOriginApprovalRuleTemplate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `approvalRuleTemplateId`
      if (jsonObj.get("approvalRuleTemplateId") != null && !jsonObj.get("approvalRuleTemplateId").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("approvalRuleTemplateId"));
      }
      // validate the optional field `approvalRuleTemplateName`
      if (jsonObj.get("approvalRuleTemplateName") != null && !jsonObj.get("approvalRuleTemplateName").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("approvalRuleTemplateName"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApprovalRuleOriginApprovalRuleTemplate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApprovalRuleOriginApprovalRuleTemplate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApprovalRuleOriginApprovalRuleTemplate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApprovalRuleOriginApprovalRuleTemplate.class));

       return (TypeAdapter<T>) new TypeAdapter<ApprovalRuleOriginApprovalRuleTemplate>() {
           @Override
           public void write(JsonWriter out, ApprovalRuleOriginApprovalRuleTemplate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApprovalRuleOriginApprovalRuleTemplate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApprovalRuleOriginApprovalRuleTemplate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApprovalRuleOriginApprovalRuleTemplate
   * @throws IOException if the JSON string is invalid with respect to ApprovalRuleOriginApprovalRuleTemplate
   */
  public static ApprovalRuleOriginApprovalRuleTemplate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApprovalRuleOriginApprovalRuleTemplate.class);
  }

  /**
   * Convert an instance of ApprovalRuleOriginApprovalRuleTemplate to an JSON string
   *
   * @return JSON string
   */
