...
public class GetRepositoryTriggersInput {
  ...
  public GetRepositoryTriggersInput() {
  }

  public GetRepositoryTriggersInput repositoryName(String repositoryName) {
  ...
  public boolean equals(Object o) {
    ...
    GetRepositoryTriggersInput getRepositoryTriggersInput = (GetRepositoryTriggersInput) o;
    return Objects.equals(this.repositoryName, getRepositoryTriggersInput.repositoryName);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetRepositoryTriggersInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetRepositoryTriggersInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetRepositoryTriggersInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetRepositoryTriggersInput is not found in the empty JSON string", GetRepositoryTriggersInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetRepositoryTriggersInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetRepositoryTriggersInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetRepositoryTriggersInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetRepositoryTriggersInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetRepositoryTriggersInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetRepositoryTriggersInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetRepositoryTriggersInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetRepositoryTriggersInput>() {
           @Override
           public void write(JsonWriter out, GetRepositoryTriggersInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetRepositoryTriggersInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetRepositoryTriggersInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetRepositoryTriggersInput
   * @throws IOException if the JSON string is invalid with respect to GetRepositoryTriggersInput
   */
  public static GetRepositoryTriggersInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetRepositoryTriggersInput.class);
  }

  /**
   * Convert an instance of GetRepositoryTriggersInput to an JSON string
   *
   * @return JSON string
   */
