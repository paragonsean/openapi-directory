...
import org.openapitools.client.model.EvaluatePullRequestApprovalRulesOutputEvaluation;
...
public class EvaluatePullRequestApprovalRulesOutput {
  ...
  private EvaluatePullRequestApprovalRulesOutputEvaluation evaluation;

  public EvaluatePullRequestApprovalRulesOutput() {
  }

  public EvaluatePullRequestApprovalRulesOutput evaluation(EvaluatePullRequestApprovalRulesOutputEvaluation evaluation) {
  ...
  public EvaluatePullRequestApprovalRulesOutputEvaluation getEvaluation() {
    return evaluation;
  }

  public void setEvaluation(EvaluatePullRequestApprovalRulesOutputEvaluation evaluation) {
    this.evaluation = evaluation;
  }
  ...
  public boolean equals(Object o) {
    ...
    EvaluatePullRequestApprovalRulesOutput evaluatePullRequestApprovalRulesOutput = (EvaluatePullRequestApprovalRulesOutput) o;
    return Objects.equals(this.evaluation, evaluatePullRequestApprovalRulesOutput.evaluation);
  }
  ...
  public String toString() {
    ...
    sb.append("class EvaluatePullRequestApprovalRulesOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EvaluatePullRequestApprovalRulesOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EvaluatePullRequestApprovalRulesOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EvaluatePullRequestApprovalRulesOutput is not found in the empty JSON string", EvaluatePullRequestApprovalRulesOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EvaluatePullRequestApprovalRulesOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EvaluatePullRequestApprovalRulesOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EvaluatePullRequestApprovalRulesOutput.openapiRequiredFields) {
      ...
      EvaluatePullRequestApprovalRulesOutputEvaluation.validateJsonElement(jsonObj.get("evaluation"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EvaluatePullRequestApprovalRulesOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EvaluatePullRequestApprovalRulesOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EvaluatePullRequestApprovalRulesOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EvaluatePullRequestApprovalRulesOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<EvaluatePullRequestApprovalRulesOutput>() {
           @Override
           public void write(JsonWriter out, EvaluatePullRequestApprovalRulesOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EvaluatePullRequestApprovalRulesOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EvaluatePullRequestApprovalRulesOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EvaluatePullRequestApprovalRulesOutput
   * @throws IOException if the JSON string is invalid with respect to EvaluatePullRequestApprovalRulesOutput
   */
  public static EvaluatePullRequestApprovalRulesOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EvaluatePullRequestApprovalRulesOutput.class);
  }

  /**
   * Convert an instance of EvaluatePullRequestApprovalRulesOutput to an JSON string
   *
   * @return JSON string
   */
