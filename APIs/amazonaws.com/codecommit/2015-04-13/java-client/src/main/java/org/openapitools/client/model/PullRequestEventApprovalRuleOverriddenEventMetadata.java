...
public class PullRequestEventApprovalRuleOverriddenEventMetadata {
  ...
  public PullRequestEventApprovalRuleOverriddenEventMetadata() {
  }

  public PullRequestEventApprovalRuleOverriddenEventMetadata revisionId(String revisionId) {
  ...
  public PullRequestEventApprovalRuleOverriddenEventMetadata overrideStatus(OverrideStatus overrideStatus) {
  ...
  public boolean equals(Object o) {
    ...
    PullRequestEventApprovalRuleOverriddenEventMetadata pullRequestEventApprovalRuleOverriddenEventMetadata = (PullRequestEventApprovalRuleOverriddenEventMetadata) o;
    return Objects.equals(this.revisionId, pullRequestEventApprovalRuleOverriddenEventMetadata.revisionId) &&
        Objects.equals(this.overrideStatus, pullRequestEventApprovalRuleOverriddenEventMetadata.overrideStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(revisionId, overrideStatus);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PullRequestEventApprovalRuleOverriddenEventMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PullRequestEventApprovalRuleOverriddenEventMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PullRequestEventApprovalRuleOverriddenEventMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PullRequestEventApprovalRuleOverriddenEventMetadata is not found in the empty JSON string", PullRequestEventApprovalRuleOverriddenEventMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PullRequestEventApprovalRuleOverriddenEventMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PullRequestEventApprovalRuleOverriddenEventMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("overrideStatus") != null && !jsonObj.get("overrideStatus").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PullRequestEventApprovalRuleOverriddenEventMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PullRequestEventApprovalRuleOverriddenEventMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PullRequestEventApprovalRuleOverriddenEventMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PullRequestEventApprovalRuleOverriddenEventMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<PullRequestEventApprovalRuleOverriddenEventMetadata>() {
           @Override
           public void write(JsonWriter out, PullRequestEventApprovalRuleOverriddenEventMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PullRequestEventApprovalRuleOverriddenEventMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PullRequestEventApprovalRuleOverriddenEventMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PullRequestEventApprovalRuleOverriddenEventMetadata
   * @throws IOException if the JSON string is invalid with respect to PullRequestEventApprovalRuleOverriddenEventMetadata
   */
  public static PullRequestEventApprovalRuleOverriddenEventMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PullRequestEventApprovalRuleOverriddenEventMetadata.class);
  }

  /**
   * Convert an instance of PullRequestEventApprovalRuleOverriddenEventMetadata to an JSON string
   *
   * @return JSON string
   */
