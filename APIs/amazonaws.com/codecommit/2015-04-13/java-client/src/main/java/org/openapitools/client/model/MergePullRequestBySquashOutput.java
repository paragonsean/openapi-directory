...
public class MergePullRequestBySquashOutput {
  ...
  public MergePullRequestBySquashOutput pullRequest(PullRequest pullRequest) {
  ...
  public boolean equals(Object o) {
    ...
    MergePullRequestBySquashOutput mergePullRequestBySquashOutput = (MergePullRequestBySquashOutput) o;
    return Objects.equals(this.pullRequest, mergePullRequestBySquashOutput.pullRequest);
  }
  ...
  public String toString() {
    ...
    sb.append("class MergePullRequestBySquashOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MergePullRequestBySquashOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MergePullRequestBySquashOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MergePullRequestBySquashOutput is not found in the empty JSON string", MergePullRequestBySquashOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MergePullRequestBySquashOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MergePullRequestBySquashOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MergePullRequestBySquashOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MergePullRequestBySquashOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MergePullRequestBySquashOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MergePullRequestBySquashOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<MergePullRequestBySquashOutput>() {
           @Override
           public void write(JsonWriter out, MergePullRequestBySquashOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MergePullRequestBySquashOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MergePullRequestBySquashOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MergePullRequestBySquashOutput
   * @throws IOException if the JSON string is invalid with respect to MergePullRequestBySquashOutput
   */
  public static MergePullRequestBySquashOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MergePullRequestBySquashOutput.class);
  }

  /**
   * Convert an instance of MergePullRequestBySquashOutput to an JSON string
   *
   * @return JSON string
   */
