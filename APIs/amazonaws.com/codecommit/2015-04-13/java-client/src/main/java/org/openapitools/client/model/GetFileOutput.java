...
public class GetFileOutput {
  ...
  public GetFileOutput() {
  }

  public GetFileOutput commitId(String commitId) {
  ...
  public GetFileOutput blobId(String blobId) {
    this.blobId = blobId;
    return this;
  }
  ...
  public GetFileOutput filePath(String filePath) {
  ...
  public GetFileOutput fileMode(FileModeTypeEnum fileMode) {
  ...
  public GetFileOutput fileSize(Integer fileSize) {
  ...
  public GetFileOutput fileContent(String fileContent) {
  ...
  public boolean equals(Object o) {
    ...
    GetFileOutput getFileOutput = (GetFileOutput) o;
    return Objects.equals(this.commitId, getFileOutput.commitId) &&
        Objects.equals(this.blobId, getFileOutput.blobId) &&
        Objects.equals(this.filePath, getFileOutput.filePath) &&
        Objects.equals(this.fileMode, getFileOutput.fileMode) &&
        Objects.equals(this.fileSize, getFileOutput.fileSize) &&
        Objects.equals(this.fileContent, getFileOutput.fileContent);
  }

  @Override
  public int hashCode() {
    return Objects.hash(commitId, blobId, filePath, fileMode, fileSize, fileContent);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetFileOutput {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("blobId");
    openapiRequiredFields.add("filePath");
    openapiRequiredFields.add("fileMode");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetFileOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetFileOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetFileOutput is not found in the empty JSON string", GetFileOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetFileOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetFileOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetFileOutput.openapiRequiredFields) {
      ...
      // validate the required field `blobId`
      ...
      // validate the required field `fileMode`
      FileModeTypeEnum.validateJsonElement(jsonObj.get("fileMode"));
      // validate the required field `fileSize`
      Integer.validateJsonElement(jsonObj.get("fileSize"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetFileOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetFileOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetFileOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetFileOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetFileOutput>() {
           @Override
           public void write(JsonWriter out, GetFileOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetFileOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetFileOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetFileOutput
   * @throws IOException if the JSON string is invalid with respect to GetFileOutput
   */
  public static GetFileOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetFileOutput.class);
  }

  /**
   * Convert an instance of GetFileOutput to an JSON string
   *
   * @return JSON string
   */
