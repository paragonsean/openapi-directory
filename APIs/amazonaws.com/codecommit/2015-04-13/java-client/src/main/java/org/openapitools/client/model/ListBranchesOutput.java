...
public class ListBranchesOutput {
  ...
  public ListBranchesOutput branches(List branches) {
  ...
  public ListBranchesOutput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListBranchesOutput listBranchesOutput = (ListBranchesOutput) o;
    return Objects.equals(this.branches, listBranchesOutput.branches) &&
        Objects.equals(this.nextToken, listBranchesOutput.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(branches, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListBranchesOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListBranchesOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListBranchesOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListBranchesOutput is not found in the empty JSON string", ListBranchesOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListBranchesOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListBranchesOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListBranchesOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListBranchesOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListBranchesOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListBranchesOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListBranchesOutput>() {
           @Override
           public void write(JsonWriter out, ListBranchesOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListBranchesOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListBranchesOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListBranchesOutput
   * @throws IOException if the JSON string is invalid with respect to ListBranchesOutput
   */
  public static ListBranchesOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListBranchesOutput.class);
  }

  /**
   * Convert an instance of ListBranchesOutput to an JSON string
   *
   * @return JSON string
   */
