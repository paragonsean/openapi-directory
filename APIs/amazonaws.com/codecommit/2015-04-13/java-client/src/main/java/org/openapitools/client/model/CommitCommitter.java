...
public class CommitCommitter {
  ...
  public CommitCommitter name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CommitCommitter email(String email) {
    this.email = email;
    return this;
  }
  ...
  public CommitCommitter date(String date) {
    this.date = date;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CommitCommitter commitCommitter = (CommitCommitter) o;
    return Objects.equals(this.name, commitCommitter.name) &&
        Objects.equals(this.email, commitCommitter.email) &&
        Objects.equals(this.date, commitCommitter.date);
  }
  ...
  public String toString() {
    ...
    sb.append("class CommitCommitter {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CommitCommitter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommitCommitter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CommitCommitter is not found in the empty JSON string", CommitCommitter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CommitCommitter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CommitCommitter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CommitCommitter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CommitCommitter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CommitCommitter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CommitCommitter.class));

       return (TypeAdapter<T>) new TypeAdapter<CommitCommitter>() {
           @Override
           public void write(JsonWriter out, CommitCommitter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CommitCommitter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CommitCommitter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CommitCommitter
   * @throws IOException if the JSON string is invalid with respect to CommitCommitter
   */
  public static CommitCommitter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CommitCommitter.class);
  }

  /**
   * Convert an instance of CommitCommitter to an JSON string
   *
   * @return JSON string
   */
