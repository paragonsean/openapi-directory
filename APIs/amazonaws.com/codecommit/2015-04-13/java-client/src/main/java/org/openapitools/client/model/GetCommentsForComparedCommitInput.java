...
public class GetCommentsForComparedCommitInput {
  ...
  public GetCommentsForComparedCommitInput() {
  }

  public GetCommentsForComparedCommitInput repositoryName(String repositoryName) {
  ...
  public GetCommentsForComparedCommitInput beforeCommitId(String beforeCommitId) {
  ...
  public GetCommentsForComparedCommitInput afterCommitId(String afterCommitId) {
  ...
  public GetCommentsForComparedCommitInput nextToken(String nextToken) {
  ...
  public GetCommentsForComparedCommitInput maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    GetCommentsForComparedCommitInput getCommentsForComparedCommitInput = (GetCommentsForComparedCommitInput) o;
    return Objects.equals(this.repositoryName, getCommentsForComparedCommitInput.repositoryName) &&
        Objects.equals(this.beforeCommitId, getCommentsForComparedCommitInput.beforeCommitId) &&
        Objects.equals(this.afterCommitId, getCommentsForComparedCommitInput.afterCommitId) &&
        Objects.equals(this.nextToken, getCommentsForComparedCommitInput.nextToken) &&
        Objects.equals(this.maxResults, getCommentsForComparedCommitInput.maxResults);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, beforeCommitId, afterCommitId, nextToken, maxResults);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetCommentsForComparedCommitInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCommentsForComparedCommitInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCommentsForComparedCommitInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCommentsForComparedCommitInput is not found in the empty JSON string", GetCommentsForComparedCommitInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCommentsForComparedCommitInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCommentsForComparedCommitInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetCommentsForComparedCommitInput.openapiRequiredFields) {
      ...
      // validate the optional field `beforeCommitId`
      if (jsonObj.get("beforeCommitId") != null && !jsonObj.get("beforeCommitId").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCommentsForComparedCommitInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCommentsForComparedCommitInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCommentsForComparedCommitInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCommentsForComparedCommitInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCommentsForComparedCommitInput>() {
           @Override
           public void write(JsonWriter out, GetCommentsForComparedCommitInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCommentsForComparedCommitInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCommentsForComparedCommitInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCommentsForComparedCommitInput
   * @throws IOException if the JSON string is invalid with respect to GetCommentsForComparedCommitInput
   */
  public static GetCommentsForComparedCommitInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCommentsForComparedCommitInput.class);
  }

  /**
   * Convert an instance of GetCommentsForComparedCommitInput to an JSON string
   *
   * @return JSON string
   */
