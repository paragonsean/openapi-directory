...
public class ConflictResolution {
  public static final String SERIALIZED_NAME_REPLACE_CONTENTS = "replaceContents";
  @SerializedName(SERIALIZED_NAME_REPLACE_CONTENTS)
  private List replaceContents;
  ...
  public static final String SERIALIZED_NAME_SET_FILE_MODES = "setFileModes";
  @SerializedName(SERIALIZED_NAME_SET_FILE_MODES)
  private List setFileModes;

  public ConflictResolution() {
  }

  public ConflictResolution replaceContents(List replaceContents) {
  ...
  public List getReplaceContents() {
    return replaceContents;
  }

  public void setReplaceContents(List replaceContents) {
    this.replaceContents = replaceContents;
  }


  public ConflictResolution deleteFiles(List deleteFiles) {
  ...
  public void setDeleteFiles(List deleteFiles) {
    this.deleteFiles = deleteFiles;
  }


  public ConflictResolution setFileModes(List setFileModes) {
   ...
   */
  @javax.annotation.Nullable
  public List getSetFileModes() {
    return setFileModes;
  }

  public void setSetFileModes(List setFileModes) {
    this.setFileModes = setFileModes;
  }
  ...
  public boolean equals(Object o) {
    ...
    ConflictResolution conflictResolution = (ConflictResolution) o;
    return Objects.equals(this.replaceContents, conflictResolution.replaceContents) &&
        Objects.equals(this.deleteFiles, conflictResolution.deleteFiles) &&
        Objects.equals(this.setFileModes, conflictResolution.setFileModes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(replaceContents, deleteFiles, setFileModes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConflictResolution {\n");
    sb.append("    replaceContents: ").append(toIndentedString(replaceContents)).append("\n");
    sb.append("    deleteFiles: ").append(toIndentedString(deleteFiles)).append("\n");
    sb.append("    setFileModes: ").append(toIndentedString(setFileModes)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("replaceContents");
    openapiFields.add("deleteFiles");
    openapiFields.add("setFileModes");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConflictResolution
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConflictResolution.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConflictResolution is not found in the empty JSON string", ConflictResolution.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConflictResolution.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConflictResolution` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `replaceContents`
      if (jsonObj.get("replaceContents") != null && !jsonObj.get("replaceContents").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("replaceContents"));
      }
      // validate the optional field `deleteFiles`
      if (jsonObj.get("deleteFiles") != null && !jsonObj.get("deleteFiles").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("deleteFiles"));
      }
      // validate the optional field `setFileModes`
      if (jsonObj.get("setFileModes") != null && !jsonObj.get("setFileModes").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("setFileModes"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConflictResolution.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConflictResolution' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConflictResolution> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConflictResolution.class));

       return (TypeAdapter<T>) new TypeAdapter<ConflictResolution>() {
           @Override
           public void write(JsonWriter out, ConflictResolution value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConflictResolution read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConflictResolution given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConflictResolution
   * @throws IOException if the JSON string is invalid with respect to ConflictResolution
   */
  public static ConflictResolution fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConflictResolution.class);
  }

  /**
   * Convert an instance of ConflictResolution to an JSON string
   *
   * @return JSON string
   */
