...
public class BatchDescribeMergeConflictsInput {
  ...
  public BatchDescribeMergeConflictsInput() {
  }

  public BatchDescribeMergeConflictsInput repositoryName(String repositoryName) {
  ...
  public BatchDescribeMergeConflictsInput destinationCommitSpecifier(String destinationCommitSpecifier) {
  ...
  public BatchDescribeMergeConflictsInput sourceCommitSpecifier(String sourceCommitSpecifier) {
  ...
  public BatchDescribeMergeConflictsInput mergeOption(MergeOptionTypeEnum mergeOption) {
  ...
  public BatchDescribeMergeConflictsInput maxMergeHunks(Integer maxMergeHunks) {
  ...
  public BatchDescribeMergeConflictsInput maxConflictFiles(Integer maxConflictFiles) {
  ...
  public BatchDescribeMergeConflictsInput filePaths(List filePaths) {
  ...
  public BatchDescribeMergeConflictsInput conflictDetailLevel(ConflictDetailLevelTypeEnum conflictDetailLevel) {
  ...
  public BatchDescribeMergeConflictsInput conflictResolutionStrategy(ConflictResolutionStrategyTypeEnum conflictResolutionStrategy) {
  ...
  public BatchDescribeMergeConflictsInput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    BatchDescribeMergeConflictsInput batchDescribeMergeConflictsInput = (BatchDescribeMergeConflictsInput) o;
    return Objects.equals(this.repositoryName, batchDescribeMergeConflictsInput.repositoryName) &&
        Objects.equals(this.destinationCommitSpecifier, batchDescribeMergeConflictsInput.destinationCommitSpecifier) &&
        Objects.equals(this.sourceCommitSpecifier, batchDescribeMergeConflictsInput.sourceCommitSpecifier) &&
        Objects.equals(this.mergeOption, batchDescribeMergeConflictsInput.mergeOption) &&
        Objects.equals(this.maxMergeHunks, batchDescribeMergeConflictsInput.maxMergeHunks) &&
        Objects.equals(this.maxConflictFiles, batchDescribeMergeConflictsInput.maxConflictFiles) &&
        Objects.equals(this.filePaths, batchDescribeMergeConflictsInput.filePaths) &&
        Objects.equals(this.conflictDetailLevel, batchDescribeMergeConflictsInput.conflictDetailLevel) &&
        Objects.equals(this.conflictResolutionStrategy, batchDescribeMergeConflictsInput.conflictResolutionStrategy) &&
        Objects.equals(this.nextToken, batchDescribeMergeConflictsInput.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, destinationCommitSpecifier, sourceCommitSpecifier, mergeOption, maxMergeHunks, maxConflictFiles, filePaths, conflictDetailLevel, conflictResolutionStrategy, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BatchDescribeMergeConflictsInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchDescribeMergeConflictsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchDescribeMergeConflictsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchDescribeMergeConflictsInput is not found in the empty JSON string", BatchDescribeMergeConflictsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchDescribeMergeConflictsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchDescribeMergeConflictsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BatchDescribeMergeConflictsInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchDescribeMergeConflictsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchDescribeMergeConflictsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchDescribeMergeConflictsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchDescribeMergeConflictsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchDescribeMergeConflictsInput>() {
           @Override
           public void write(JsonWriter out, BatchDescribeMergeConflictsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchDescribeMergeConflictsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchDescribeMergeConflictsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchDescribeMergeConflictsInput
   * @throws IOException if the JSON string is invalid with respect to BatchDescribeMergeConflictsInput
   */
  public static BatchDescribeMergeConflictsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchDescribeMergeConflictsInput.class);
  }

  /**
   * Convert an instance of BatchDescribeMergeConflictsInput to an JSON string
   *
   * @return JSON string
   */
