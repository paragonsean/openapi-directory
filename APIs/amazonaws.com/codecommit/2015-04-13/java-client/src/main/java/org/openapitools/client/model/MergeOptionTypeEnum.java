...
/**
 * Gets or Sets MergeOptionTypeEnum
 */
@JsonAdapter(MergeOptionTypeEnum.Adapter.class)
public enum MergeOptionTypeEnum {
  ...
  MergeOptionTypeEnum(String value) {
    this.value = value;
  }
  ...
  public static MergeOptionTypeEnum fromValue(String value) {
    for (MergeOptionTypeEnum b : MergeOptionTypeEnum.values()) {
  ...
  public static class Adapter extends TypeAdapter<MergeOptionTypeEnum> {
    @Override
    public void write(final JsonWriter jsonWriter, final MergeOptionTypeEnum enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public MergeOptionTypeEnum read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return MergeOptionTypeEnum.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    MergeOptionTypeEnum.fromValue(value);
  }
}
