...
import org.openapitools.client.model.ConflictConflictMetadata;
...
public class Conflict {
  ...
  private ConflictConflictMetadata conflictMetadata;
  ...
  public Conflict conflictMetadata(ConflictConflictMetadata conflictMetadata) {
  ...
  public ConflictConflictMetadata getConflictMetadata() {
    return conflictMetadata;
  }

  public void setConflictMetadata(ConflictConflictMetadata conflictMetadata) {
    this.conflictMetadata = conflictMetadata;
  }


  public Conflict mergeHunks(List mergeHunks) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.conflictMetadata, conflict.conflictMetadata) &&
        Objects.equals(this.mergeHunks, conflict.mergeHunks);
  }

  @Override
  public int hashCode() {
    return Objects.hash(conflictMetadata, mergeHunks);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Conflict
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Conflict.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Conflict.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Conflict` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `conflictMetadata`
      if (jsonObj.get("conflictMetadata") != null && !jsonObj.get("conflictMetadata").isJsonNull()) {
        ConflictConflictMetadata.validateJsonElement(jsonObj.get("conflictMetadata"));
      }
      // validate the optional field `mergeHunks`
      if (jsonObj.get("mergeHunks") != null && !jsonObj.get("mergeHunks").isJsonNull()) {
