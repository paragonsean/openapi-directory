...
public class ReactionForCommentReaction {
  ...
  public ReactionForCommentReaction() {
  }

  public ReactionForCommentReaction emoji(String emoji) {
    this.emoji = emoji;
    return this;
  }
  ...
  public ReactionForCommentReaction shortCode(String shortCode) {
  ...
  public ReactionForCommentReaction unicode(String unicode) {
  ...
  public boolean equals(Object o) {
    ...
    ReactionForCommentReaction reactionForCommentReaction = (ReactionForCommentReaction) o;
    return Objects.equals(this.emoji, reactionForCommentReaction.emoji) &&
        Objects.equals(this.shortCode, reactionForCommentReaction.shortCode) &&
        Objects.equals(this.unicode, reactionForCommentReaction.unicode);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReactionForCommentReaction {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReactionForCommentReaction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReactionForCommentReaction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReactionForCommentReaction is not found in the empty JSON string", ReactionForCommentReaction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReactionForCommentReaction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReactionForCommentReaction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReactionForCommentReaction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReactionForCommentReaction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReactionForCommentReaction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReactionForCommentReaction.class));

       return (TypeAdapter<T>) new TypeAdapter<ReactionForCommentReaction>() {
           @Override
           public void write(JsonWriter out, ReactionForCommentReaction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReactionForCommentReaction read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReactionForCommentReaction given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReactionForCommentReaction
   * @throws IOException if the JSON string is invalid with respect to ReactionForCommentReaction
   */
  public static ReactionForCommentReaction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReactionForCommentReaction.class);
  }

  /**
   * Convert an instance of ReactionForCommentReaction to an JSON string
   *
   * @return JSON string
   */
