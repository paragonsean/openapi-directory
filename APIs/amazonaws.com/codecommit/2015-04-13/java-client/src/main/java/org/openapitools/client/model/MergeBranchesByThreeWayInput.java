...
public class MergeBranchesByThreeWayInput {
  ...
  public MergeBranchesByThreeWayInput() {
  }

  public MergeBranchesByThreeWayInput repositoryName(String repositoryName) {
  ...
  public MergeBranchesByThreeWayInput sourceCommitSpecifier(String sourceCommitSpecifier) {
  ...
  public MergeBranchesByThreeWayInput destinationCommitSpecifier(String destinationCommitSpecifier) {
  ...
  public MergeBranchesByThreeWayInput targetBranch(String targetBranch) {
  ...
  public MergeBranchesByThreeWayInput conflictDetailLevel(ConflictDetailLevelTypeEnum conflictDetailLevel) {
  ...
  public MergeBranchesByThreeWayInput conflictResolutionStrategy(ConflictResolutionStrategyTypeEnum conflictResolutionStrategy) {
  ...
  public MergeBranchesByThreeWayInput authorName(String authorName) {
  ...
  public MergeBranchesByThreeWayInput email(String email) {
    this.email = email;
    return this;
  }
  ...
  public MergeBranchesByThreeWayInput commitMessage(String commitMessage) {
  ...
  public MergeBranchesByThreeWayInput keepEmptyFolders(Boolean keepEmptyFolders) {
  ...
  public MergeBranchesByThreeWayInput conflictResolution(CreateUnreferencedMergeCommitInputConflictResolution conflictResolution) {
  ...
  public boolean equals(Object o) {
    ...
    MergeBranchesByThreeWayInput mergeBranchesByThreeWayInput = (MergeBranchesByThreeWayInput) o;
    return Objects.equals(this.repositoryName, mergeBranchesByThreeWayInput.repositoryName) &&
        Objects.equals(this.sourceCommitSpecifier, mergeBranchesByThreeWayInput.sourceCommitSpecifier) &&
        Objects.equals(this.destinationCommitSpecifier, mergeBranchesByThreeWayInput.destinationCommitSpecifier) &&
        Objects.equals(this.targetBranch, mergeBranchesByThreeWayInput.targetBranch) &&
        Objects.equals(this.conflictDetailLevel, mergeBranchesByThreeWayInput.conflictDetailLevel) &&
        Objects.equals(this.conflictResolutionStrategy, mergeBranchesByThreeWayInput.conflictResolutionStrategy) &&
        Objects.equals(this.authorName, mergeBranchesByThreeWayInput.authorName) &&
        Objects.equals(this.email, mergeBranchesByThreeWayInput.email) &&
        Objects.equals(this.commitMessage, mergeBranchesByThreeWayInput.commitMessage) &&
        Objects.equals(this.keepEmptyFolders, mergeBranchesByThreeWayInput.keepEmptyFolders) &&
        Objects.equals(this.conflictResolution, mergeBranchesByThreeWayInput.conflictResolution);
  }
  ...
  public String toString() {
    ...
    sb.append("class MergeBranchesByThreeWayInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MergeBranchesByThreeWayInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MergeBranchesByThreeWayInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MergeBranchesByThreeWayInput is not found in the empty JSON string", MergeBranchesByThreeWayInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MergeBranchesByThreeWayInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MergeBranchesByThreeWayInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MergeBranchesByThreeWayInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MergeBranchesByThreeWayInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MergeBranchesByThreeWayInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MergeBranchesByThreeWayInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MergeBranchesByThreeWayInput.class));

       return (TypeAdapter<T>) new TypeAdapter<MergeBranchesByThreeWayInput>() {
           @Override
           public void write(JsonWriter out, MergeBranchesByThreeWayInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MergeBranchesByThreeWayInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MergeBranchesByThreeWayInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MergeBranchesByThreeWayInput
   * @throws IOException if the JSON string is invalid with respect to MergeBranchesByThreeWayInput
   */
  public static MergeBranchesByThreeWayInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MergeBranchesByThreeWayInput.class);
  }

  /**
   * Convert an instance of MergeBranchesByThreeWayInput to an JSON string
   *
   * @return JSON string
   */
