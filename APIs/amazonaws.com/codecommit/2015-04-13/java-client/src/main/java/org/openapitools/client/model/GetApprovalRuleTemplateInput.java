...
public class GetApprovalRuleTemplateInput {
  ...
  public GetApprovalRuleTemplateInput() {
  }

  public GetApprovalRuleTemplateInput approvalRuleTemplateName(String approvalRuleTemplateName) {
  ...
  public boolean equals(Object o) {
    ...
    GetApprovalRuleTemplateInput getApprovalRuleTemplateInput = (GetApprovalRuleTemplateInput) o;
    return Objects.equals(this.approvalRuleTemplateName, getApprovalRuleTemplateInput.approvalRuleTemplateName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(approvalRuleTemplateName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetApprovalRuleTemplateInput {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("approvalRuleTemplateName");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetApprovalRuleTemplateInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetApprovalRuleTemplateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetApprovalRuleTemplateInput is not found in the empty JSON string", GetApprovalRuleTemplateInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetApprovalRuleTemplateInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetApprovalRuleTemplateInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetApprovalRuleTemplateInput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `approvalRuleTemplateName`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetApprovalRuleTemplateInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetApprovalRuleTemplateInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetApprovalRuleTemplateInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetApprovalRuleTemplateInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetApprovalRuleTemplateInput>() {
           @Override
           public void write(JsonWriter out, GetApprovalRuleTemplateInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetApprovalRuleTemplateInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetApprovalRuleTemplateInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetApprovalRuleTemplateInput
   * @throws IOException if the JSON string is invalid with respect to GetApprovalRuleTemplateInput
   */
  public static GetApprovalRuleTemplateInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetApprovalRuleTemplateInput.class);
  }

  /**
   * Convert an instance of GetApprovalRuleTemplateInput to an JSON string
   *
   * @return JSON string
   */
