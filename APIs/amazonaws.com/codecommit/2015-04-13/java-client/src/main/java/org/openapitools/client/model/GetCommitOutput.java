...
import org.openapitools.client.model.GetCommitOutputCommit;
...
public class GetCommitOutput {
  ...
  private GetCommitOutputCommit commit;

  public GetCommitOutput() {
  }

  public GetCommitOutput commit(GetCommitOutputCommit commit) {
    this.commit = commit;
    return this;
  }
  ...
  public GetCommitOutputCommit getCommit() {
    return commit;
  }

  public void setCommit(GetCommitOutputCommit commit) {
    this.commit = commit;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetCommitOutput getCommitOutput = (GetCommitOutput) o;
    return Objects.equals(this.commit, getCommitOutput.commit);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetCommitOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCommitOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCommitOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCommitOutput is not found in the empty JSON string", GetCommitOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCommitOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCommitOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetCommitOutput.openapiRequiredFields) {
      ...
      GetCommitOutputCommit.validateJsonElement(jsonObj.get("commit"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCommitOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCommitOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCommitOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCommitOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCommitOutput>() {
           @Override
           public void write(JsonWriter out, GetCommitOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCommitOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCommitOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCommitOutput
   * @throws IOException if the JSON string is invalid with respect to GetCommitOutput
   */
  public static GetCommitOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCommitOutput.class);
  }

  /**
   * Convert an instance of GetCommitOutput to an JSON string
   *
   * @return JSON string
   */
