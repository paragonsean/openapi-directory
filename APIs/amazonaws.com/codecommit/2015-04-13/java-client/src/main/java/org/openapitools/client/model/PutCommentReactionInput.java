...
public class PutCommentReactionInput {
  ...
  public PutCommentReactionInput() {
  }

  public PutCommentReactionInput commentId(String commentId) {
  ...
  public PutCommentReactionInput reactionValue(String reactionValue) {
  ...
  public boolean equals(Object o) {
    ...
    PutCommentReactionInput putCommentReactionInput = (PutCommentReactionInput) o;
    return Objects.equals(this.commentId, putCommentReactionInput.commentId) &&
        Objects.equals(this.reactionValue, putCommentReactionInput.reactionValue);
  }

  @Override
  public int hashCode() {
    return Objects.hash(commentId, reactionValue);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutCommentReactionInput {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("reactionValue");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutCommentReactionInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutCommentReactionInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutCommentReactionInput is not found in the empty JSON string", PutCommentReactionInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutCommentReactionInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutCommentReactionInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PutCommentReactionInput.openapiRequiredFields) {
      ...
      // validate the required field `reactionValue`
      String.validateJsonElement(jsonObj.get("reactionValue"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutCommentReactionInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutCommentReactionInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutCommentReactionInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutCommentReactionInput.class));

       return (TypeAdapter<T>) new TypeAdapter<PutCommentReactionInput>() {
           @Override
           public void write(JsonWriter out, PutCommentReactionInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutCommentReactionInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutCommentReactionInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutCommentReactionInput
   * @throws IOException if the JSON string is invalid with respect to PutCommentReactionInput
   */
  public static PutCommentReactionInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutCommentReactionInput.class);
  }

  /**
   * Convert an instance of PutCommentReactionInput to an JSON string
   *
   * @return JSON string
   */
