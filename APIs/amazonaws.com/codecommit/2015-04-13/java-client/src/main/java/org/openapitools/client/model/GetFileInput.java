...
public class GetFileInput {
  ...
  public GetFileInput repositoryName(String repositoryName) {
  ...
  public GetFileInput commitSpecifier(String commitSpecifier) {
  ...
  public GetFileInput filePath(String filePath) {
  ...
  public boolean equals(Object o) {
    ...
    GetFileInput getFileInput = (GetFileInput) o;
    return Objects.equals(this.repositoryName, getFileInput.repositoryName) &&
        Objects.equals(this.commitSpecifier, getFileInput.commitSpecifier) &&
        Objects.equals(this.filePath, getFileInput.filePath);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, commitSpecifier, filePath);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetFileInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetFileInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetFileInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetFileInput is not found in the empty JSON string", GetFileInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetFileInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetFileInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetFileInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetFileInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetFileInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetFileInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetFileInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetFileInput>() {
           @Override
           public void write(JsonWriter out, GetFileInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetFileInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetFileInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetFileInput
   * @throws IOException if the JSON string is invalid with respect to GetFileInput
   */
  public static GetFileInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetFileInput.class);
  }

  /**
   * Convert an instance of GetFileInput to an JSON string
   *
   * @return JSON string
   */
