...
public class CreateApprovalRuleTemplateInput {
  ...
  public CreateApprovalRuleTemplateInput() {
  }

  public CreateApprovalRuleTemplateInput approvalRuleTemplateName(String approvalRuleTemplateName) {
  ...
  public CreateApprovalRuleTemplateInput approvalRuleTemplateContent(String approvalRuleTemplateContent) {
  ...
  public CreateApprovalRuleTemplateInput approvalRuleTemplateDescription(String approvalRuleTemplateDescription) {
  ...
  public boolean equals(Object o) {
    ...
    CreateApprovalRuleTemplateInput createApprovalRuleTemplateInput = (CreateApprovalRuleTemplateInput) o;
    return Objects.equals(this.approvalRuleTemplateName, createApprovalRuleTemplateInput.approvalRuleTemplateName) &&
        Objects.equals(this.approvalRuleTemplateContent, createApprovalRuleTemplateInput.approvalRuleTemplateContent) &&
        Objects.equals(this.approvalRuleTemplateDescription, createApprovalRuleTemplateInput.approvalRuleTemplateDescription);
  }

  @Override
  public int hashCode() {
    return Objects.hash(approvalRuleTemplateName, approvalRuleTemplateContent, approvalRuleTemplateDescription);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateApprovalRuleTemplateInput {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("approvalRuleTemplateContent");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateApprovalRuleTemplateInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateApprovalRuleTemplateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateApprovalRuleTemplateInput is not found in the empty JSON string", CreateApprovalRuleTemplateInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateApprovalRuleTemplateInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateApprovalRuleTemplateInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateApprovalRuleTemplateInput.openapiRequiredFields) {
      ...
      // validate the required field `approvalRuleTemplateContent`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateApprovalRuleTemplateInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateApprovalRuleTemplateInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateApprovalRuleTemplateInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateApprovalRuleTemplateInput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateApprovalRuleTemplateInput>() {
           @Override
           public void write(JsonWriter out, CreateApprovalRuleTemplateInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateApprovalRuleTemplateInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateApprovalRuleTemplateInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateApprovalRuleTemplateInput
   * @throws IOException if the JSON string is invalid with respect to CreateApprovalRuleTemplateInput
   */
  public static CreateApprovalRuleTemplateInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateApprovalRuleTemplateInput.class);
  }

  /**
   * Convert an instance of CreateApprovalRuleTemplateInput to an JSON string
   *
   * @return JSON string
   */
