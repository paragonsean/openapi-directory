...
public class GetMergeCommitOutput {
  ...
  public static final String SERIALIZED_NAME_MERGED_COMMIT_ID = "mergedCommitId";
  ...
  public GetMergeCommitOutput sourceCommitId(String sourceCommitId) {
  ...
  public GetMergeCommitOutput destinationCommitId(String destinationCommitId) {
  ...
  public GetMergeCommitOutput baseCommitId(String baseCommitId) {
  ...
  public GetMergeCommitOutput mergedCommitId(String mergedCommitId) {
  ...
  public boolean equals(Object o) {
    ...
    GetMergeCommitOutput getMergeCommitOutput = (GetMergeCommitOutput) o;
    return Objects.equals(this.sourceCommitId, getMergeCommitOutput.sourceCommitId) &&
        Objects.equals(this.destinationCommitId, getMergeCommitOutput.destinationCommitId) &&
        Objects.equals(this.baseCommitId, getMergeCommitOutput.baseCommitId) &&
        Objects.equals(this.mergedCommitId, getMergeCommitOutput.mergedCommitId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sourceCommitId, destinationCommitId, baseCommitId, mergedCommitId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetMergeCommitOutput {\n");
  ...
  static {
    ...
    openapiFields.add("mergedCommitId");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetMergeCommitOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetMergeCommitOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetMergeCommitOutput is not found in the empty JSON string", GetMergeCommitOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetMergeCommitOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetMergeCommitOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("destinationCommitId") != null && !jsonObj.get("destinationCommitId").isJsonNull()) {
      ...
      // validate the optional field `mergedCommitId`
      if (jsonObj.get("mergedCommitId") != null && !jsonObj.get("mergedCommitId").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("mergedCommitId"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetMergeCommitOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetMergeCommitOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetMergeCommitOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetMergeCommitOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetMergeCommitOutput>() {
           @Override
           public void write(JsonWriter out, GetMergeCommitOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetMergeCommitOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetMergeCommitOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetMergeCommitOutput
   * @throws IOException if the JSON string is invalid with respect to GetMergeCommitOutput
   */
  public static GetMergeCommitOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetMergeCommitOutput.class);
  }

  /**
   * Convert an instance of GetMergeCommitOutput to an JSON string
   *
   * @return JSON string
   */
