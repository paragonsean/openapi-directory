...
public class DeleteRepositoryInput {
  ...
  public DeleteRepositoryInput() {
  }

  public DeleteRepositoryInput repositoryName(String repositoryName) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteRepositoryInput deleteRepositoryInput = (DeleteRepositoryInput) o;
    return Objects.equals(this.repositoryName, deleteRepositoryInput.repositoryName);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteRepositoryInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteRepositoryInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteRepositoryInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteRepositoryInput is not found in the empty JSON string", DeleteRepositoryInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteRepositoryInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteRepositoryInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteRepositoryInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteRepositoryInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteRepositoryInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteRepositoryInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteRepositoryInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteRepositoryInput>() {
           @Override
           public void write(JsonWriter out, DeleteRepositoryInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteRepositoryInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteRepositoryInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteRepositoryInput
   * @throws IOException if the JSON string is invalid with respect to DeleteRepositoryInput
   */
  public static DeleteRepositoryInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteRepositoryInput.class);
  }

  /**
   * Convert an instance of DeleteRepositoryInput to an JSON string
   *
   * @return JSON string
   */
