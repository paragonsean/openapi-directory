...
public class ApiClient {
    ...
    private String basePath = "http://codecommit.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2015-04-13/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://codecommit.us-east-1.amazonaws.com
