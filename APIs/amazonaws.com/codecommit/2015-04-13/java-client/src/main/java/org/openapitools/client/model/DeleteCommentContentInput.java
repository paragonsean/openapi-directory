...
public class DeleteCommentContentInput {
  ...
  public DeleteCommentContentInput() {
  }

  public DeleteCommentContentInput commentId(String commentId) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteCommentContentInput deleteCommentContentInput = (DeleteCommentContentInput) o;
    return Objects.equals(this.commentId, deleteCommentContentInput.commentId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteCommentContentInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteCommentContentInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteCommentContentInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteCommentContentInput is not found in the empty JSON string", DeleteCommentContentInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteCommentContentInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteCommentContentInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteCommentContentInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteCommentContentInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteCommentContentInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteCommentContentInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteCommentContentInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteCommentContentInput>() {
           @Override
           public void write(JsonWriter out, DeleteCommentContentInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteCommentContentInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteCommentContentInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteCommentContentInput
   * @throws IOException if the JSON string is invalid with respect to DeleteCommentContentInput
   */
  public static DeleteCommentContentInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteCommentContentInput.class);
  }

  /**
   * Convert an instance of DeleteCommentContentInput to an JSON string
   *
   * @return JSON string
   */
