...
public class MergeBranchesBySquashInput {
  ...
  public static final String SERIALIZED_NAME_TARGET_BRANCH = "targetBranch";
  ...
  public MergeBranchesBySquashInput() {
  }

  public MergeBranchesBySquashInput repositoryName(String repositoryName) {
  ...
  public MergeBranchesBySquashInput sourceCommitSpecifier(String sourceCommitSpecifier) {
  ...
  public MergeBranchesBySquashInput destinationCommitSpecifier(String destinationCommitSpecifier) {
  ...
  public MergeBranchesBySquashInput targetBranch(String targetBranch) {
  ...
  public MergeBranchesBySquashInput conflictDetailLevel(ConflictDetailLevelTypeEnum conflictDetailLevel) {
  ...
  public MergeBranchesBySquashInput conflictResolutionStrategy(ConflictResolutionStrategyTypeEnum conflictResolutionStrategy) {
  ...
  public MergeBranchesBySquashInput authorName(String authorName) {
  ...
  public MergeBranchesBySquashInput email(String email) {
    this.email = email;
    return this;
  }
  ...
  public MergeBranchesBySquashInput commitMessage(String commitMessage) {
  ...
  public MergeBranchesBySquashInput keepEmptyFolders(Boolean keepEmptyFolders) {
  ...
  public MergeBranchesBySquashInput conflictResolution(CreateUnreferencedMergeCommitInputConflictResolution conflictResolution) {
  ...
  public boolean equals(Object o) {
    ...
    MergeBranchesBySquashInput mergeBranchesBySquashInput = (MergeBranchesBySquashInput) o;
    return Objects.equals(this.repositoryName, mergeBranchesBySquashInput.repositoryName) &&
        Objects.equals(this.sourceCommitSpecifier, mergeBranchesBySquashInput.sourceCommitSpecifier) &&
        Objects.equals(this.destinationCommitSpecifier, mergeBranchesBySquashInput.destinationCommitSpecifier) &&
        Objects.equals(this.targetBranch, mergeBranchesBySquashInput.targetBranch) &&
        Objects.equals(this.conflictDetailLevel, mergeBranchesBySquashInput.conflictDetailLevel) &&
        Objects.equals(this.conflictResolutionStrategy, mergeBranchesBySquashInput.conflictResolutionStrategy) &&
        Objects.equals(this.authorName, mergeBranchesBySquashInput.authorName) &&
        Objects.equals(this.email, mergeBranchesBySquashInput.email) &&
        Objects.equals(this.commitMessage, mergeBranchesBySquashInput.commitMessage) &&
        Objects.equals(this.keepEmptyFolders, mergeBranchesBySquashInput.keepEmptyFolders) &&
        Objects.equals(this.conflictResolution, mergeBranchesBySquashInput.conflictResolution);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, sourceCommitSpecifier, destinationCommitSpecifier, targetBranch, conflictDetailLevel, conflictResolutionStrategy, authorName, email, commitMessage, keepEmptyFolders, conflictResolution);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MergeBranchesBySquashInput {\n");
  ...
  static {
    ...
    openapiFields.add("targetBranch");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MergeBranchesBySquashInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MergeBranchesBySquashInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MergeBranchesBySquashInput is not found in the empty JSON string", MergeBranchesBySquashInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MergeBranchesBySquashInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MergeBranchesBySquashInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MergeBranchesBySquashInput.openapiRequiredFields) {
      ...
      if (jsonObj.get("targetBranch") != null && !jsonObj.get("targetBranch").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("targetBranch"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MergeBranchesBySquashInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MergeBranchesBySquashInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MergeBranchesBySquashInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MergeBranchesBySquashInput.class));

       return (TypeAdapter<T>) new TypeAdapter<MergeBranchesBySquashInput>() {
           @Override
           public void write(JsonWriter out, MergeBranchesBySquashInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MergeBranchesBySquashInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MergeBranchesBySquashInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MergeBranchesBySquashInput
   * @throws IOException if the JSON string is invalid with respect to MergeBranchesBySquashInput
   */
  public static MergeBranchesBySquashInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MergeBranchesBySquashInput.class);
  }

  /**
   * Convert an instance of MergeBranchesBySquashInput to an JSON string
   *
   * @return JSON string
   */
