...
import org.openapitools.client.model.ApprovalRuleTemplate;
...
public class UpdateApprovalRuleTemplateContentOutput {
  ...
  public UpdateApprovalRuleTemplateContentOutput() {
  }

  public UpdateApprovalRuleTemplateContentOutput approvalRuleTemplate(ApprovalRuleTemplate approvalRuleTemplate) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateApprovalRuleTemplateContentOutput updateApprovalRuleTemplateContentOutput = (UpdateApprovalRuleTemplateContentOutput) o;
    return Objects.equals(this.approvalRuleTemplate, updateApprovalRuleTemplateContentOutput.approvalRuleTemplate);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateApprovalRuleTemplateContentOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateApprovalRuleTemplateContentOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateApprovalRuleTemplateContentOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateApprovalRuleTemplateContentOutput is not found in the empty JSON string", UpdateApprovalRuleTemplateContentOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateApprovalRuleTemplateContentOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateApprovalRuleTemplateContentOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateApprovalRuleTemplateContentOutput.openapiRequiredFields) {
      ...
      ApprovalRuleTemplate.validateJsonElement(jsonObj.get("approvalRuleTemplate"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateApprovalRuleTemplateContentOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateApprovalRuleTemplateContentOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateApprovalRuleTemplateContentOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateApprovalRuleTemplateContentOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateApprovalRuleTemplateContentOutput>() {
           @Override
           public void write(JsonWriter out, UpdateApprovalRuleTemplateContentOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateApprovalRuleTemplateContentOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateApprovalRuleTemplateContentOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateApprovalRuleTemplateContentOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateApprovalRuleTemplateContentOutput
   */
  public static UpdateApprovalRuleTemplateContentOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateApprovalRuleTemplateContentOutput.class);
  }

  /**
   * Convert an instance of UpdateApprovalRuleTemplateContentOutput to an JSON string
   *
   * @return JSON string
   */
