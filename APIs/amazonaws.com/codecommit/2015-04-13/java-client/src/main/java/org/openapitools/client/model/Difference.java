...
public class Difference {
  public static final String SERIALIZED_NAME_BEFORE_BLOB = "beforeBlob";
  @SerializedName(SERIALIZED_NAME_BEFORE_BLOB)
  private DifferenceBeforeBlob beforeBlob;

  public static final String SERIALIZED_NAME_AFTER_BLOB = "afterBlob";
  @SerializedName(SERIALIZED_NAME_AFTER_BLOB)
  private DifferenceAfterBlob afterBlob;
  ...
  public Difference beforeBlob(DifferenceBeforeBlob beforeBlob) {
  ...
  public DifferenceBeforeBlob getBeforeBlob() {
    return beforeBlob;
  }

  public void setBeforeBlob(DifferenceBeforeBlob beforeBlob) {
    this.beforeBlob = beforeBlob;
  }


  public Difference afterBlob(DifferenceAfterBlob afterBlob) {
   ...
   */
  @javax.annotation.Nullable
  public DifferenceAfterBlob getAfterBlob() {
    return afterBlob;
  }

  public void setAfterBlob(DifferenceAfterBlob afterBlob) {
    this.afterBlob = afterBlob;
  }


  public Difference changeType(ChangeTypeEnum changeType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.beforeBlob, difference.beforeBlob) &&
        Objects.equals(this.afterBlob, difference.afterBlob) &&
        Objects.equals(this.changeType, difference.changeType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(beforeBlob, afterBlob, changeType);
  }
  ...
  public String toString() {
    ...
    sb.append("    beforeBlob: ").append(toIndentedString(beforeBlob)).append("\n");
    sb.append("    afterBlob: ").append(toIndentedString(afterBlob)).append("\n");
  ...
  static {
    ...
    openapiFields.add("beforeBlob");
    openapiFields.add("afterBlob");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Difference
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Difference.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Difference is not found in the empty JSON string", Difference.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Difference.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Difference` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `beforeBlob`
      if (jsonObj.get("beforeBlob") != null && !jsonObj.get("beforeBlob").isJsonNull()) {
        DifferenceBeforeBlob.validateJsonElement(jsonObj.get("beforeBlob"));
      }
      // validate the optional field `afterBlob`
      if (jsonObj.get("afterBlob") != null && !jsonObj.get("afterBlob").isJsonNull()) {
        DifferenceAfterBlob.validateJsonElement(jsonObj.get("afterBlob"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Difference.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Difference' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Difference> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Difference.class));

       return (TypeAdapter<T>) new TypeAdapter<Difference>() {
           @Override
           public void write(JsonWriter out, Difference value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Difference read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Difference given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Difference
   * @throws IOException if the JSON string is invalid with respect to Difference
   */
  public static Difference fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Difference.class);
  }

  /**
   * Convert an instance of Difference to an JSON string
   *
   * @return JSON string
   */
