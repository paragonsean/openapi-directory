...
public class BatchAssociateApprovalRuleTemplateWithRepositoriesError {
  ...
  public BatchAssociateApprovalRuleTemplateWithRepositoriesError repositoryName(String repositoryName) {
  ...
  public BatchAssociateApprovalRuleTemplateWithRepositoriesError errorCode(String errorCode) {
  ...
  public BatchAssociateApprovalRuleTemplateWithRepositoriesError errorMessage(String errorMessage) {
  ...
  public boolean equals(Object o) {
    ...
    BatchAssociateApprovalRuleTemplateWithRepositoriesError batchAssociateApprovalRuleTemplateWithRepositoriesError = (BatchAssociateApprovalRuleTemplateWithRepositoriesError) o;
    return Objects.equals(this.repositoryName, batchAssociateApprovalRuleTemplateWithRepositoriesError.repositoryName) &&
        Objects.equals(this.errorCode, batchAssociateApprovalRuleTemplateWithRepositoriesError.errorCode) &&
        Objects.equals(this.errorMessage, batchAssociateApprovalRuleTemplateWithRepositoriesError.errorMessage);
  }
  ...
  public String toString() {
    ...
    sb.append("class BatchAssociateApprovalRuleTemplateWithRepositoriesError {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchAssociateApprovalRuleTemplateWithRepositoriesError
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchAssociateApprovalRuleTemplateWithRepositoriesError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchAssociateApprovalRuleTemplateWithRepositoriesError is not found in the empty JSON string", BatchAssociateApprovalRuleTemplateWithRepositoriesError.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchAssociateApprovalRuleTemplateWithRepositoriesError.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchAssociateApprovalRuleTemplateWithRepositoriesError` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchAssociateApprovalRuleTemplateWithRepositoriesError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchAssociateApprovalRuleTemplateWithRepositoriesError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchAssociateApprovalRuleTemplateWithRepositoriesError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchAssociateApprovalRuleTemplateWithRepositoriesError.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchAssociateApprovalRuleTemplateWithRepositoriesError>() {
           @Override
           public void write(JsonWriter out, BatchAssociateApprovalRuleTemplateWithRepositoriesError value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchAssociateApprovalRuleTemplateWithRepositoriesError read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchAssociateApprovalRuleTemplateWithRepositoriesError given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchAssociateApprovalRuleTemplateWithRepositoriesError
   * @throws IOException if the JSON string is invalid with respect to BatchAssociateApprovalRuleTemplateWithRepositoriesError
   */
  public static BatchAssociateApprovalRuleTemplateWithRepositoriesError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchAssociateApprovalRuleTemplateWithRepositoriesError.class);
  }

  /**
   * Convert an instance of BatchAssociateApprovalRuleTemplateWithRepositoriesError to an JSON string
   *
   * @return JSON string
   */
