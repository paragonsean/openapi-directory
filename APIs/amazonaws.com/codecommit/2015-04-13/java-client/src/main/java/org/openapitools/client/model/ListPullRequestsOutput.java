...
public class ListPullRequestsOutput {
  public static final String SERIALIZED_NAME_PULL_REQUEST_IDS = "pullRequestIds";
  @SerializedName(SERIALIZED_NAME_PULL_REQUEST_IDS)
  private List pullRequestIds;
  ...
  public ListPullRequestsOutput pullRequestIds(List pullRequestIds) {
  ...
  public List getPullRequestIds() {
    return pullRequestIds;
  }

  public void setPullRequestIds(List pullRequestIds) {
    this.pullRequestIds = pullRequestIds;
  }


  public ListPullRequestsOutput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListPullRequestsOutput listPullRequestsOutput = (ListPullRequestsOutput) o;
    return Objects.equals(this.pullRequestIds, listPullRequestsOutput.pullRequestIds) &&
        Objects.equals(this.nextToken, listPullRequestsOutput.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pullRequestIds, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListPullRequestsOutput {\n");
    sb.append("    pullRequestIds: ").append(toIndentedString(pullRequestIds)).append("\n");
  ...
  static {
    ...
    openapiFields.add("pullRequestIds");
    openapiFields.add("nextToken");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("pullRequestIds");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListPullRequestsOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListPullRequestsOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListPullRequestsOutput is not found in the empty JSON string", ListPullRequestsOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListPullRequestsOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListPullRequestsOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListPullRequestsOutput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `pullRequestIds`
      List.validateJsonElement(jsonObj.get("pullRequestIds"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListPullRequestsOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListPullRequestsOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListPullRequestsOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListPullRequestsOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListPullRequestsOutput>() {
           @Override
           public void write(JsonWriter out, ListPullRequestsOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListPullRequestsOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListPullRequestsOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListPullRequestsOutput
   * @throws IOException if the JSON string is invalid with respect to ListPullRequestsOutput
   */
  public static ListPullRequestsOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListPullRequestsOutput.class);
  }

  /**
   * Convert an instance of ListPullRequestsOutput to an JSON string
   *
   * @return JSON string
   */
