...
public class SourceFileSpecifier {
  ...
  public SourceFileSpecifier() {
  }

  public SourceFileSpecifier filePath(String filePath) {
  ...
  public SourceFileSpecifier isMove(Boolean isMove) {
    this.isMove = isMove;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SourceFileSpecifier sourceFileSpecifier = (SourceFileSpecifier) o;
    return Objects.equals(this.filePath, sourceFileSpecifier.filePath) &&
        Objects.equals(this.isMove, sourceFileSpecifier.isMove);
  }
  ...
  public String toString() {
    ...
    sb.append("class SourceFileSpecifier {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SourceFileSpecifier
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SourceFileSpecifier.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SourceFileSpecifier is not found in the empty JSON string", SourceFileSpecifier.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SourceFileSpecifier.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SourceFileSpecifier` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SourceFileSpecifier.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SourceFileSpecifier.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SourceFileSpecifier' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SourceFileSpecifier> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SourceFileSpecifier.class));

       return (TypeAdapter<T>) new TypeAdapter<SourceFileSpecifier>() {
           @Override
           public void write(JsonWriter out, SourceFileSpecifier value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SourceFileSpecifier read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SourceFileSpecifier given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SourceFileSpecifier
   * @throws IOException if the JSON string is invalid with respect to SourceFileSpecifier
   */
  public static SourceFileSpecifier fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SourceFileSpecifier.class);
  }

  /**
   * Convert an instance of SourceFileSpecifier to an JSON string
   *
   * @return JSON string
   */
