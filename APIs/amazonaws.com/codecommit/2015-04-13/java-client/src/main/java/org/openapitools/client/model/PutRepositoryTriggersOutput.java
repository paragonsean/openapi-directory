...
public class PutRepositoryTriggersOutput {
  ...
  public PutRepositoryTriggersOutput configurationId(String configurationId) {
  ...
  public boolean equals(Object o) {
    ...
    PutRepositoryTriggersOutput putRepositoryTriggersOutput = (PutRepositoryTriggersOutput) o;
    return Objects.equals(this.configurationId, putRepositoryTriggersOutput.configurationId);
  }
  ...
  public String toString() {
    ...
    sb.append("class PutRepositoryTriggersOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutRepositoryTriggersOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutRepositoryTriggersOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutRepositoryTriggersOutput is not found in the empty JSON string", PutRepositoryTriggersOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutRepositoryTriggersOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutRepositoryTriggersOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutRepositoryTriggersOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutRepositoryTriggersOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutRepositoryTriggersOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutRepositoryTriggersOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<PutRepositoryTriggersOutput>() {
           @Override
           public void write(JsonWriter out, PutRepositoryTriggersOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutRepositoryTriggersOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutRepositoryTriggersOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutRepositoryTriggersOutput
   * @throws IOException if the JSON string is invalid with respect to PutRepositoryTriggersOutput
   */
  public static PutRepositoryTriggersOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutRepositoryTriggersOutput.class);
  }

  /**
   * Convert an instance of PutRepositoryTriggersOutput to an JSON string
   *
   * @return JSON string
   */
