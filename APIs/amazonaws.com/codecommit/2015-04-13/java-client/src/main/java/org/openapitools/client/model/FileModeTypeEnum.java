...
/**
 * Gets or Sets FileModeTypeEnum
 */
@JsonAdapter(FileModeTypeEnum.Adapter.class)
public enum FileModeTypeEnum {
  ...
  public static FileModeTypeEnum fromValue(String value) {
    for (FileModeTypeEnum b : FileModeTypeEnum.values()) {
  ...
  public static class Adapter extends TypeAdapter<FileModeTypeEnum> {
    @Override
    public void write(final JsonWriter jsonWriter, final FileModeTypeEnum enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FileModeTypeEnum read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FileModeTypeEnum.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FileModeTypeEnum.fromValue(value);
  }
}
