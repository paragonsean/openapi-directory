...
public class GetCommentsForComparedCommitOutput {
  public static final String SERIALIZED_NAME_COMMENTS_FOR_COMPARED_COMMIT_DATA = "commentsForComparedCommitData";
  @SerializedName(SERIALIZED_NAME_COMMENTS_FOR_COMPARED_COMMIT_DATA)
  private List commentsForComparedCommitData;
  ...
  public GetCommentsForComparedCommitOutput commentsForComparedCommitData(List commentsForComparedCommitData) {
    this.commentsForComparedCommitData = commentsForComparedCommitData;
    return this;
  }

  /**
   * Get commentsForComparedCommitData
   * @return commentsForComparedCommitData
   */
  @javax.annotation.Nullable
  public List getCommentsForComparedCommitData() {
    return commentsForComparedCommitData;
  }

  public void setCommentsForComparedCommitData(List commentsForComparedCommitData) {
    this.commentsForComparedCommitData = commentsForComparedCommitData;
  }


  public GetCommentsForComparedCommitOutput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    GetCommentsForComparedCommitOutput getCommentsForComparedCommitOutput = (GetCommentsForComparedCommitOutput) o;
    return Objects.equals(this.commentsForComparedCommitData, getCommentsForComparedCommitOutput.commentsForComparedCommitData) &&
        Objects.equals(this.nextToken, getCommentsForComparedCommitOutput.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(commentsForComparedCommitData, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetCommentsForComparedCommitOutput {\n");
    sb.append("    commentsForComparedCommitData: ").append(toIndentedString(commentsForComparedCommitData)).append("\n");
  ...
  static {
    ...
    openapiFields.add("commentsForComparedCommitData");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCommentsForComparedCommitOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCommentsForComparedCommitOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCommentsForComparedCommitOutput is not found in the empty JSON string", GetCommentsForComparedCommitOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCommentsForComparedCommitOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCommentsForComparedCommitOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `commentsForComparedCommitData`
      if (jsonObj.get("commentsForComparedCommitData") != null && !jsonObj.get("commentsForComparedCommitData").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("commentsForComparedCommitData"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCommentsForComparedCommitOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCommentsForComparedCommitOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCommentsForComparedCommitOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCommentsForComparedCommitOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCommentsForComparedCommitOutput>() {
           @Override
           public void write(JsonWriter out, GetCommentsForComparedCommitOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCommentsForComparedCommitOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCommentsForComparedCommitOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCommentsForComparedCommitOutput
   * @throws IOException if the JSON string is invalid with respect to GetCommentsForComparedCommitOutput
   */
  public static GetCommentsForComparedCommitOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCommentsForComparedCommitOutput.class);
  }

  /**
   * Convert an instance of GetCommentsForComparedCommitOutput to an JSON string
   *
   * @return JSON string
   */
