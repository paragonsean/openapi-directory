...
public class BatchDisassociateApprovalRuleTemplateFromRepositoriesError {
  ...
  public BatchDisassociateApprovalRuleTemplateFromRepositoriesError repositoryName(String repositoryName) {
  ...
  public BatchDisassociateApprovalRuleTemplateFromRepositoriesError errorCode(String errorCode) {
  ...
  public BatchDisassociateApprovalRuleTemplateFromRepositoriesError errorMessage(String errorMessage) {
  ...
  public boolean equals(Object o) {
    ...
    BatchDisassociateApprovalRuleTemplateFromRepositoriesError batchDisassociateApprovalRuleTemplateFromRepositoriesError = (BatchDisassociateApprovalRuleTemplateFromRepositoriesError) o;
    return Objects.equals(this.repositoryName, batchDisassociateApprovalRuleTemplateFromRepositoriesError.repositoryName) &&
        Objects.equals(this.errorCode, batchDisassociateApprovalRuleTemplateFromRepositoriesError.errorCode) &&
        Objects.equals(this.errorMessage, batchDisassociateApprovalRuleTemplateFromRepositoriesError.errorMessage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, errorCode, errorMessage);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BatchDisassociateApprovalRuleTemplateFromRepositoriesError {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchDisassociateApprovalRuleTemplateFromRepositoriesError
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchDisassociateApprovalRuleTemplateFromRepositoriesError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchDisassociateApprovalRuleTemplateFromRepositoriesError is not found in the empty JSON string", BatchDisassociateApprovalRuleTemplateFromRepositoriesError.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchDisassociateApprovalRuleTemplateFromRepositoriesError.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchDisassociateApprovalRuleTemplateFromRepositoriesError` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchDisassociateApprovalRuleTemplateFromRepositoriesError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchDisassociateApprovalRuleTemplateFromRepositoriesError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchDisassociateApprovalRuleTemplateFromRepositoriesError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchDisassociateApprovalRuleTemplateFromRepositoriesError.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchDisassociateApprovalRuleTemplateFromRepositoriesError>() {
           @Override
           public void write(JsonWriter out, BatchDisassociateApprovalRuleTemplateFromRepositoriesError value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchDisassociateApprovalRuleTemplateFromRepositoriesError read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchDisassociateApprovalRuleTemplateFromRepositoriesError given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchDisassociateApprovalRuleTemplateFromRepositoriesError
   * @throws IOException if the JSON string is invalid with respect to BatchDisassociateApprovalRuleTemplateFromRepositoriesError
   */
  public static BatchDisassociateApprovalRuleTemplateFromRepositoriesError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchDisassociateApprovalRuleTemplateFromRepositoriesError.class);
  }

  /**
   * Convert an instance of BatchDisassociateApprovalRuleTemplateFromRepositoriesError to an JSON string
   *
   * @return JSON string
   */
