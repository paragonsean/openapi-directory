...
public class GetDifferencesInput {
  ...
  public static final String SERIALIZED_NAME_BEFORE_COMMIT_SPECIFIER = "beforeCommitSpecifier";
  @SerializedName(SERIALIZED_NAME_BEFORE_COMMIT_SPECIFIER)
  private String beforeCommitSpecifier;

  public static final String SERIALIZED_NAME_AFTER_COMMIT_SPECIFIER = "afterCommitSpecifier";
  @SerializedName(SERIALIZED_NAME_AFTER_COMMIT_SPECIFIER)
  private String afterCommitSpecifier;

  public static final String SERIALIZED_NAME_BEFORE_PATH = "beforePath";
  @SerializedName(SERIALIZED_NAME_BEFORE_PATH)
  private String beforePath;

  public static final String SERIALIZED_NAME_AFTER_PATH = "afterPath";
  @SerializedName(SERIALIZED_NAME_AFTER_PATH)
  ...
  public GetDifferencesInput() {
  }

  public GetDifferencesInput repositoryName(String repositoryName) {
  ...
  public GetDifferencesInput beforeCommitSpecifier(String beforeCommitSpecifier) {
    this.beforeCommitSpecifier = beforeCommitSpecifier;
    return this;
  }

  /**
   * Get beforeCommitSpecifier
  ...
  public GetDifferencesInput afterCommitSpecifier(String afterCommitSpecifier) {
    this.afterCommitSpecifier = afterCommitSpecifier;
    return this;
  }

  /**
   * Get afterCommitSpecifier
  ...
  public GetDifferencesInput beforePath(String beforePath) {
  ...
  public GetDifferencesInput afterPath(String afterPath) {
  ...
  public GetDifferencesInput maxResults(Integer maxResults) {
  ...
  public GetDifferencesInput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    GetDifferencesInput getDifferencesInput = (GetDifferencesInput) o;
    return Objects.equals(this.repositoryName, getDifferencesInput.repositoryName) &&
        Objects.equals(this.beforeCommitSpecifier, getDifferencesInput.beforeCommitSpecifier) &&
        Objects.equals(this.afterCommitSpecifier, getDifferencesInput.afterCommitSpecifier) &&
        Objects.equals(this.beforePath, getDifferencesInput.beforePath) &&
        Objects.equals(this.afterPath, getDifferencesInput.afterPath) &&
        Objects.equals(this.maxResults, getDifferencesInput.maxResults) &&
        Objects.equals(this.nextToken, getDifferencesInput.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, beforeCommitSpecifier, afterCommitSpecifier, beforePath, afterPath, maxResults, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetDifferencesInput {\n");
    sb.append("    repositoryName: ").append(toIndentedString(repositoryName)).append("\n");
    sb.append("    beforeCommitSpecifier: ").append(toIndentedString(beforeCommitSpecifier)).append("\n");
    sb.append("    afterCommitSpecifier: ").append(toIndentedString(afterCommitSpecifier)).append("\n");
    sb.append("    beforePath: ").append(toIndentedString(beforePath)).append("\n");
    sb.append("    afterPath: ").append(toIndentedString(afterPath)).append("\n");
  ...
  static {
    ...
    openapiFields.add("beforeCommitSpecifier");
    openapiFields.add("afterCommitSpecifier");
    openapiFields.add("beforePath");
    openapiFields.add("afterPath");
    ...
    openapiRequiredFields.add("afterCommitSpecifier");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDifferencesInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDifferencesInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetDifferencesInput is not found in the empty JSON string", GetDifferencesInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDifferencesInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetDifferencesInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetDifferencesInput.openapiRequiredFields) {
      ...
      if (jsonObj.get("beforeCommitSpecifier") != null && !jsonObj.get("beforeCommitSpecifier").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("beforeCommitSpecifier"));
      }
      // validate the required field `afterCommitSpecifier`
      String.validateJsonElement(jsonObj.get("afterCommitSpecifier"));
      // validate the optional field `beforePath`
      if (jsonObj.get("beforePath") != null && !jsonObj.get("beforePath").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("beforePath"));
      }
      // validate the optional field `afterPath`
      if (jsonObj.get("afterPath") != null && !jsonObj.get("afterPath").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("afterPath"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDifferencesInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDifferencesInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDifferencesInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDifferencesInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDifferencesInput>() {
           @Override
           public void write(JsonWriter out, GetDifferencesInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDifferencesInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetDifferencesInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetDifferencesInput
   * @throws IOException if the JSON string is invalid with respect to GetDifferencesInput
   */
  public static GetDifferencesInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDifferencesInput.class);
  }

  /**
   * Convert an instance of GetDifferencesInput to an JSON string
   *
   * @return JSON string
   */
