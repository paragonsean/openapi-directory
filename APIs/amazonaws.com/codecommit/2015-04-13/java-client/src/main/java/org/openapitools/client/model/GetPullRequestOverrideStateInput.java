...
public class GetPullRequestOverrideStateInput {
  ...
  public GetPullRequestOverrideStateInput() {
  }

  public GetPullRequestOverrideStateInput pullRequestId(String pullRequestId) {
  ...
  public GetPullRequestOverrideStateInput revisionId(String revisionId) {
  ...
  public boolean equals(Object o) {
    ...
    GetPullRequestOverrideStateInput getPullRequestOverrideStateInput = (GetPullRequestOverrideStateInput) o;
    return Objects.equals(this.pullRequestId, getPullRequestOverrideStateInput.pullRequestId) &&
        Objects.equals(this.revisionId, getPullRequestOverrideStateInput.revisionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetPullRequestOverrideStateInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPullRequestOverrideStateInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPullRequestOverrideStateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPullRequestOverrideStateInput is not found in the empty JSON string", GetPullRequestOverrideStateInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPullRequestOverrideStateInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPullRequestOverrideStateInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetPullRequestOverrideStateInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPullRequestOverrideStateInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPullRequestOverrideStateInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPullRequestOverrideStateInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPullRequestOverrideStateInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPullRequestOverrideStateInput>() {
           @Override
           public void write(JsonWriter out, GetPullRequestOverrideStateInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPullRequestOverrideStateInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPullRequestOverrideStateInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPullRequestOverrideStateInput
   * @throws IOException if the JSON string is invalid with respect to GetPullRequestOverrideStateInput
   */
  public static GetPullRequestOverrideStateInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPullRequestOverrideStateInput.class);
  }

  /**
   * Convert an instance of GetPullRequestOverrideStateInput to an JSON string
   *
   * @return JSON string
   */
