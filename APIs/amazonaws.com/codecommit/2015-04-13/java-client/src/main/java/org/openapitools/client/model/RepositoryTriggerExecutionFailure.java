...
public class RepositoryTriggerExecutionFailure {
  ...
  public RepositoryTriggerExecutionFailure trigger(String trigger) {
  ...
  public RepositoryTriggerExecutionFailure failureMessage(String failureMessage) {
  ...
  public boolean equals(Object o) {
    ...
    RepositoryTriggerExecutionFailure repositoryTriggerExecutionFailure = (RepositoryTriggerExecutionFailure) o;
    return Objects.equals(this.trigger, repositoryTriggerExecutionFailure.trigger) &&
        Objects.equals(this.failureMessage, repositoryTriggerExecutionFailure.failureMessage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(trigger, failureMessage);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RepositoryTriggerExecutionFailure {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RepositoryTriggerExecutionFailure
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RepositoryTriggerExecutionFailure.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RepositoryTriggerExecutionFailure is not found in the empty JSON string", RepositoryTriggerExecutionFailure.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RepositoryTriggerExecutionFailure.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RepositoryTriggerExecutionFailure` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `trigger`
      if (jsonObj.get("trigger") != null && !jsonObj.get("trigger").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("trigger"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RepositoryTriggerExecutionFailure.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RepositoryTriggerExecutionFailure' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RepositoryTriggerExecutionFailure> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RepositoryTriggerExecutionFailure.class));

       return (TypeAdapter<T>) new TypeAdapter<RepositoryTriggerExecutionFailure>() {
           @Override
           public void write(JsonWriter out, RepositoryTriggerExecutionFailure value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RepositoryTriggerExecutionFailure read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RepositoryTriggerExecutionFailure given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RepositoryTriggerExecutionFailure
   * @throws IOException if the JSON string is invalid with respect to RepositoryTriggerExecutionFailure
   */
  public static RepositoryTriggerExecutionFailure fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RepositoryTriggerExecutionFailure.class);
  }

  /**
   * Convert an instance of RepositoryTriggerExecutionFailure to an JSON string
   *
   * @return JSON string
   */
