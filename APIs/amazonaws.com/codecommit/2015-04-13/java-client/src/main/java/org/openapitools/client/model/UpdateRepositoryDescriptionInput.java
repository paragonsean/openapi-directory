...
public class UpdateRepositoryDescriptionInput {
  ...
  public UpdateRepositoryDescriptionInput() {
  }

  public UpdateRepositoryDescriptionInput repositoryName(String repositoryName) {
  ...
  public UpdateRepositoryDescriptionInput repositoryDescription(String repositoryDescription) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateRepositoryDescriptionInput updateRepositoryDescriptionInput = (UpdateRepositoryDescriptionInput) o;
    return Objects.equals(this.repositoryName, updateRepositoryDescriptionInput.repositoryName) &&
        Objects.equals(this.repositoryDescription, updateRepositoryDescriptionInput.repositoryDescription);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, repositoryDescription);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateRepositoryDescriptionInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateRepositoryDescriptionInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateRepositoryDescriptionInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateRepositoryDescriptionInput is not found in the empty JSON string", UpdateRepositoryDescriptionInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateRepositoryDescriptionInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateRepositoryDescriptionInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateRepositoryDescriptionInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateRepositoryDescriptionInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateRepositoryDescriptionInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateRepositoryDescriptionInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateRepositoryDescriptionInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateRepositoryDescriptionInput>() {
           @Override
           public void write(JsonWriter out, UpdateRepositoryDescriptionInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateRepositoryDescriptionInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateRepositoryDescriptionInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateRepositoryDescriptionInput
   * @throws IOException if the JSON string is invalid with respect to UpdateRepositoryDescriptionInput
   */
  public static UpdateRepositoryDescriptionInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateRepositoryDescriptionInput.class);
  }

  /**
   * Convert an instance of UpdateRepositoryDescriptionInput to an JSON string
   *
   * @return JSON string
   */
