...
/**
 * Gets or Sets RepositoryTriggerEventEnum
 */
@JsonAdapter(RepositoryTriggerEventEnum.Adapter.class)
public enum RepositoryTriggerEventEnum {
  ...
  RepositoryTriggerEventEnum(String value) {
    this.value = value;
  }
  ...
  public static RepositoryTriggerEventEnum fromValue(String value) {
    for (RepositoryTriggerEventEnum b : RepositoryTriggerEventEnum.values()) {
  ...
  public static class Adapter extends TypeAdapter<RepositoryTriggerEventEnum> {
    @Override
    public void write(final JsonWriter jsonWriter, final RepositoryTriggerEventEnum enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RepositoryTriggerEventEnum read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RepositoryTriggerEventEnum.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    RepositoryTriggerEventEnum.fromValue(value);
  }
}
