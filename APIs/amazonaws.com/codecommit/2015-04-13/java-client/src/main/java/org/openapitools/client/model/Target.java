...
public class Target {
  ...
  public Target repositoryName(String repositoryName) {
  ...
  public Target sourceReference(String sourceReference) {
  ...
  public Target destinationReference(String destinationReference) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.repositoryName, target.repositoryName) &&
        Objects.equals(this.sourceReference, target.sourceReference) &&
        Objects.equals(this.destinationReference, target.destinationReference);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, sourceReference, destinationReference);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("sourceReference");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the required field `sourceReference`
      String.validateJsonElement(jsonObj.get("sourceReference"));
