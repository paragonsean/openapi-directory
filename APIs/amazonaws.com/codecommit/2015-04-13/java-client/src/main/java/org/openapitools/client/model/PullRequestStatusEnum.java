...
/**
 * Gets or Sets PullRequestStatusEnum
 */
@JsonAdapter(PullRequestStatusEnum.Adapter.class)
public enum PullRequestStatusEnum {
  ...
  PullRequestStatusEnum(String value) {
    this.value = value;
  }
  ...
  public static PullRequestStatusEnum fromValue(String value) {
    for (PullRequestStatusEnum b : PullRequestStatusEnum.values()) {
  ...
  public static class Adapter extends TypeAdapter<PullRequestStatusEnum> {
    @Override
    public void write(final JsonWriter jsonWriter, final PullRequestStatusEnum enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PullRequestStatusEnum read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PullRequestStatusEnum.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PullRequestStatusEnum.fromValue(value);
  }
}
