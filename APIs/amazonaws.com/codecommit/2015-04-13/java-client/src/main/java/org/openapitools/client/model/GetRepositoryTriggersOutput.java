...
public class GetRepositoryTriggersOutput {
  ...
  public GetRepositoryTriggersOutput configurationId(String configurationId) {
  ...
  public GetRepositoryTriggersOutput triggers(List triggers) {
  ...
  public boolean equals(Object o) {
    ...
    GetRepositoryTriggersOutput getRepositoryTriggersOutput = (GetRepositoryTriggersOutput) o;
    return Objects.equals(this.configurationId, getRepositoryTriggersOutput.configurationId) &&
        Objects.equals(this.triggers, getRepositoryTriggersOutput.triggers);
  }

  @Override
  public int hashCode() {
    return Objects.hash(configurationId, triggers);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetRepositoryTriggersOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetRepositoryTriggersOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetRepositoryTriggersOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetRepositoryTriggersOutput is not found in the empty JSON string", GetRepositoryTriggersOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetRepositoryTriggersOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetRepositoryTriggersOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetRepositoryTriggersOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetRepositoryTriggersOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetRepositoryTriggersOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetRepositoryTriggersOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetRepositoryTriggersOutput>() {
           @Override
           public void write(JsonWriter out, GetRepositoryTriggersOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetRepositoryTriggersOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetRepositoryTriggersOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetRepositoryTriggersOutput
   * @throws IOException if the JSON string is invalid with respect to GetRepositoryTriggersOutput
   */
  public static GetRepositoryTriggersOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetRepositoryTriggersOutput.class);
  }

  /**
   * Convert an instance of GetRepositoryTriggersOutput to an JSON string
   *
   * @return JSON string
   */
