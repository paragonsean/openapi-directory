...
import org.openapitools.client.model.MergeHunkBase;
import org.openapitools.client.model.MergeHunkDestination;
import org.openapitools.client.model.MergeHunkSource;
...
public class MergeHunk {
  public static final String SERIALIZED_NAME_IS_CONFLICT = "isConflict";
  @SerializedName(SERIALIZED_NAME_IS_CONFLICT)
  private Boolean isConflict;

  public static final String SERIALIZED_NAME_SOURCE = "source";
  @SerializedName(SERIALIZED_NAME_SOURCE)
  private MergeHunkSource source;

  public static final String SERIALIZED_NAME_DESTINATION = "destination";
  @SerializedName(SERIALIZED_NAME_DESTINATION)
  private MergeHunkDestination destination;

  public static final String SERIALIZED_NAME_BASE = "base";
  @SerializedName(SERIALIZED_NAME_BASE)
  private MergeHunkBase base;

  public MergeHunk() {
  }

  public MergeHunk isConflict(Boolean isConflict) {
  ...
  public MergeHunk source(MergeHunkSource source) {
    this.source = source;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public MergeHunkSource getSource() {
    return source;
  }

  public void setSource(MergeHunkSource source) {
    this.source = source;
  }


  public MergeHunk destination(MergeHunkDestination destination) {
   ...
   */
  @javax.annotation.Nullable
  public MergeHunkDestination getDestination() {
    return destination;
  }

  public void setDestination(MergeHunkDestination destination) {
    this.destination = destination;
  }


  public MergeHunk base(MergeHunkBase base) {
    this.base = base;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public MergeHunkBase getBase() {
    return base;
  }

  public void setBase(MergeHunkBase base) {
    this.base = base;
  }
  ...
  public boolean equals(Object o) {
    ...
    MergeHunk mergeHunk = (MergeHunk) o;
    return Objects.equals(this.isConflict, mergeHunk.isConflict) &&
        Objects.equals(this.source, mergeHunk.source) &&
        Objects.equals(this.destination, mergeHunk.destination) &&
        Objects.equals(this.base, mergeHunk.base);
  }

  @Override
  public int hashCode() {
    return Objects.hash(isConflict, source, destination, base);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MergeHunk {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MergeHunk
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MergeHunk.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MergeHunk is not found in the empty JSON string", MergeHunk.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MergeHunk.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MergeHunk` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `isConflict`
      if (jsonObj.get("isConflict") != null && !jsonObj.get("isConflict").isJsonNull()) {
        Boolean.validateJsonElement(jsonObj.get("isConflict"));
      }
      // validate the optional field `source`
      if (jsonObj.get("source") != null && !jsonObj.get("source").isJsonNull()) {
        MergeHunkSource.validateJsonElement(jsonObj.get("source"));
      }
      // validate the optional field `destination`
      if (jsonObj.get("destination") != null && !jsonObj.get("destination").isJsonNull()) {
        MergeHunkDestination.validateJsonElement(jsonObj.get("destination"));
      }
      // validate the optional field `base`
      if (jsonObj.get("base") != null && !jsonObj.get("base").isJsonNull()) {
        MergeHunkBase.validateJsonElement(jsonObj.get("base"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MergeHunk.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MergeHunk' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MergeHunk> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MergeHunk.class));

       return (TypeAdapter<T>) new TypeAdapter<MergeHunk>() {
           @Override
           public void write(JsonWriter out, MergeHunk value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MergeHunk read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MergeHunk given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MergeHunk
   * @throws IOException if the JSON string is invalid with respect to MergeHunk
   */
  public static MergeHunk fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MergeHunk.class);
  }

  /**
   * Convert an instance of MergeHunk to an JSON string
   *
   * @return JSON string
   */
