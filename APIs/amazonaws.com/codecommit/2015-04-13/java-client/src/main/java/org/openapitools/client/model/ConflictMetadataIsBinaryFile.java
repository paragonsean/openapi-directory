...
public class ConflictMetadataIsBinaryFile {
  ...
  public ConflictMetadataIsBinaryFile() {
  }

  public ConflictMetadataIsBinaryFile source(Boolean source) {
    this.source = source;
    return this;
  }
  ...
  public ConflictMetadataIsBinaryFile destination(Boolean destination) {
  ...
  public ConflictMetadataIsBinaryFile base(Boolean base) {
    this.base = base;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ConflictMetadataIsBinaryFile conflictMetadataIsBinaryFile = (ConflictMetadataIsBinaryFile) o;
    return Objects.equals(this.source, conflictMetadataIsBinaryFile.source) &&
        Objects.equals(this.destination, conflictMetadataIsBinaryFile.destination) &&
        Objects.equals(this.base, conflictMetadataIsBinaryFile.base);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConflictMetadataIsBinaryFile {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConflictMetadataIsBinaryFile
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConflictMetadataIsBinaryFile.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConflictMetadataIsBinaryFile is not found in the empty JSON string", ConflictMetadataIsBinaryFile.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConflictMetadataIsBinaryFile.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConflictMetadataIsBinaryFile` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConflictMetadataIsBinaryFile.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConflictMetadataIsBinaryFile' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConflictMetadataIsBinaryFile> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConflictMetadataIsBinaryFile.class));

       return (TypeAdapter<T>) new TypeAdapter<ConflictMetadataIsBinaryFile>() {
           @Override
           public void write(JsonWriter out, ConflictMetadataIsBinaryFile value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConflictMetadataIsBinaryFile read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConflictMetadataIsBinaryFile given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConflictMetadataIsBinaryFile
   * @throws IOException if the JSON string is invalid with respect to ConflictMetadataIsBinaryFile
   */
  public static ConflictMetadataIsBinaryFile fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConflictMetadataIsBinaryFile.class);
  }

  /**
   * Convert an instance of ConflictMetadataIsBinaryFile to an JSON string
   *
   * @return JSON string
   */
