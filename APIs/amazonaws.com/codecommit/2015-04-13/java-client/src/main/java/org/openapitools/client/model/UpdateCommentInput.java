...
public class UpdateCommentInput {
  ...
  public UpdateCommentInput commentId(String commentId) {
  ...
  public UpdateCommentInput content(String content) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateCommentInput updateCommentInput = (UpdateCommentInput) o;
    return Objects.equals(this.commentId, updateCommentInput.commentId) &&
        Objects.equals(this.content, updateCommentInput.content);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateCommentInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateCommentInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateCommentInput is not found in the empty JSON string", UpdateCommentInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateCommentInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateCommentInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateCommentInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateCommentInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateCommentInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateCommentInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateCommentInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateCommentInput>() {
           @Override
           public void write(JsonWriter out, UpdateCommentInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateCommentInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateCommentInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateCommentInput
   * @throws IOException if the JSON string is invalid with respect to UpdateCommentInput
   */
  public static UpdateCommentInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateCommentInput.class);
  }

  /**
   * Convert an instance of UpdateCommentInput to an JSON string
   *
   * @return JSON string
   */
