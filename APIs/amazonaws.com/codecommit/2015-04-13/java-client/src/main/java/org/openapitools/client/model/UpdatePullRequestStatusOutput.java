...
import org.openapitools.client.model.UpdatePullRequestStatusOutputPullRequest;
...
public class UpdatePullRequestStatusOutput {
  ...
  private UpdatePullRequestStatusOutputPullRequest pullRequest;

  public UpdatePullRequestStatusOutput() {
  }

  public UpdatePullRequestStatusOutput pullRequest(UpdatePullRequestStatusOutputPullRequest pullRequest) {
  ...
  public UpdatePullRequestStatusOutputPullRequest getPullRequest() {
    return pullRequest;
  }

  public void setPullRequest(UpdatePullRequestStatusOutputPullRequest pullRequest) {
    this.pullRequest = pullRequest;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdatePullRequestStatusOutput updatePullRequestStatusOutput = (UpdatePullRequestStatusOutput) o;
    return Objects.equals(this.pullRequest, updatePullRequestStatusOutput.pullRequest);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdatePullRequestStatusOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePullRequestStatusOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePullRequestStatusOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePullRequestStatusOutput is not found in the empty JSON string", UpdatePullRequestStatusOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePullRequestStatusOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePullRequestStatusOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdatePullRequestStatusOutput.openapiRequiredFields) {
      ...
      UpdatePullRequestStatusOutputPullRequest.validateJsonElement(jsonObj.get("pullRequest"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePullRequestStatusOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePullRequestStatusOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePullRequestStatusOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePullRequestStatusOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePullRequestStatusOutput>() {
           @Override
           public void write(JsonWriter out, UpdatePullRequestStatusOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePullRequestStatusOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePullRequestStatusOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePullRequestStatusOutput
   * @throws IOException if the JSON string is invalid with respect to UpdatePullRequestStatusOutput
   */
  public static UpdatePullRequestStatusOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePullRequestStatusOutput.class);
  }

  /**
   * Convert an instance of UpdatePullRequestStatusOutput to an JSON string
   *
   * @return JSON string
   */
