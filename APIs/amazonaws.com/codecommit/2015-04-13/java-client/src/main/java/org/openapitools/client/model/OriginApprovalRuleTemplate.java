...
public class OriginApprovalRuleTemplate {
  ...
  public OriginApprovalRuleTemplate approvalRuleTemplateId(String approvalRuleTemplateId) {
  ...
  public OriginApprovalRuleTemplate approvalRuleTemplateName(String approvalRuleTemplateName) {
  ...
  public boolean equals(Object o) {
    ...
    OriginApprovalRuleTemplate originApprovalRuleTemplate = (OriginApprovalRuleTemplate) o;
    return Objects.equals(this.approvalRuleTemplateId, originApprovalRuleTemplate.approvalRuleTemplateId) &&
        Objects.equals(this.approvalRuleTemplateName, originApprovalRuleTemplate.approvalRuleTemplateName);
  }
  ...
  public String toString() {
    ...
    sb.append("class OriginApprovalRuleTemplate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OriginApprovalRuleTemplate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OriginApprovalRuleTemplate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OriginApprovalRuleTemplate is not found in the empty JSON string", OriginApprovalRuleTemplate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OriginApprovalRuleTemplate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OriginApprovalRuleTemplate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OriginApprovalRuleTemplate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OriginApprovalRuleTemplate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OriginApprovalRuleTemplate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OriginApprovalRuleTemplate.class));

       return (TypeAdapter<T>) new TypeAdapter<OriginApprovalRuleTemplate>() {
           @Override
           public void write(JsonWriter out, OriginApprovalRuleTemplate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OriginApprovalRuleTemplate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OriginApprovalRuleTemplate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OriginApprovalRuleTemplate
   * @throws IOException if the JSON string is invalid with respect to OriginApprovalRuleTemplate
   */
  public static OriginApprovalRuleTemplate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OriginApprovalRuleTemplate.class);
  }

  /**
   * Convert an instance of OriginApprovalRuleTemplate to an JSON string
   *
   * @return JSON string
   */
