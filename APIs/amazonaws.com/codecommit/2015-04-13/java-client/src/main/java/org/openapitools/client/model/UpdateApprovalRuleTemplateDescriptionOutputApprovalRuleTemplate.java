...
public class UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate {
  ...
  public static final String SERIALIZED_NAME_APPROVAL_RULE_TEMPLATE_DESCRIPTION = "approvalRuleTemplateDescription";
  @SerializedName(SERIALIZED_NAME_APPROVAL_RULE_TEMPLATE_DESCRIPTION)
  private String approvalRuleTemplateDescription;

  public static final String SERIALIZED_NAME_APPROVAL_RULE_TEMPLATE_CONTENT = "approvalRuleTemplateContent";
  @SerializedName(SERIALIZED_NAME_APPROVAL_RULE_TEMPLATE_CONTENT)
  ...
  public UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate() {
  }

  public UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate approvalRuleTemplateId(String approvalRuleTemplateId) {
  ...
  public UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate approvalRuleTemplateName(String approvalRuleTemplateName) {
  ...
  public UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate approvalRuleTemplateDescription(String approvalRuleTemplateDescription) {
    this.approvalRuleTemplateDescription = approvalRuleTemplateDescription;
    return this;
  }

  /**
   * Get approvalRuleTemplateDescription
  ...
  public UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate approvalRuleTemplateContent(String approvalRuleTemplateContent) {
  ...
  public UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate ruleContentSha256(String ruleContentSha256) {
  ...
  public UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate lastModifiedDate(OffsetDateTime lastModifiedDate) {
  ...
  public UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate creationDate(OffsetDateTime creationDate) {
  ...
  public UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate lastModifiedUser(String lastModifiedUser) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate updateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate = (UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate) o;
    return Objects.equals(this.approvalRuleTemplateId, updateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate.approvalRuleTemplateId) &&
        Objects.equals(this.approvalRuleTemplateName, updateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate.approvalRuleTemplateName) &&
        Objects.equals(this.approvalRuleTemplateDescription, updateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate.approvalRuleTemplateDescription) &&
        Objects.equals(this.approvalRuleTemplateContent, updateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate.approvalRuleTemplateContent) &&
        Objects.equals(this.ruleContentSha256, updateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate.ruleContentSha256) &&
        Objects.equals(this.lastModifiedDate, updateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate.lastModifiedDate) &&
        Objects.equals(this.creationDate, updateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate.creationDate) &&
        Objects.equals(this.lastModifiedUser, updateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate.lastModifiedUser);
  }

  @Override
  public int hashCode() {
    return Objects.hash(approvalRuleTemplateId, approvalRuleTemplateName, approvalRuleTemplateDescription, approvalRuleTemplateContent, ruleContentSha256, lastModifiedDate, creationDate, lastModifiedUser);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate {\n");
    ...
    sb.append("    approvalRuleTemplateDescription: ").append(toIndentedString(approvalRuleTemplateDescription)).append("\n");
    sb.append("    approvalRuleTemplateContent: ").append(toIndentedString(approvalRuleTemplateContent)).append("\n");
  ...
  static {
    ...
    openapiFields.add("approvalRuleTemplateDescription");
    openapiFields.add("approvalRuleTemplateContent");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate is not found in the empty JSON string", UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("approvalRuleTemplateDescription") != null && !jsonObj.get("approvalRuleTemplateDescription").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("approvalRuleTemplateDescription"));
      }
      // validate the optional field `approvalRuleTemplateContent`
      if (jsonObj.get("approvalRuleTemplateContent") != null && !jsonObj.get("approvalRuleTemplateContent").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("approvalRuleTemplateContent"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate>() {
           @Override
           public void write(JsonWriter out, UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate
   * @throws IOException if the JSON string is invalid with respect to UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate
   */
  public static UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate.class);
  }

  /**
   * Convert an instance of UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate to an JSON string
   *
   * @return JSON string
   */
