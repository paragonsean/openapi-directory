...
public class GetCommentsForPullRequestInput {
  ...
  public GetCommentsForPullRequestInput() {
  }

  public GetCommentsForPullRequestInput pullRequestId(String pullRequestId) {
  ...
  public GetCommentsForPullRequestInput repositoryName(String repositoryName) {
  ...
  public GetCommentsForPullRequestInput beforeCommitId(String beforeCommitId) {
  ...
  public GetCommentsForPullRequestInput afterCommitId(String afterCommitId) {
  ...
  public GetCommentsForPullRequestInput nextToken(String nextToken) {
  ...
  public GetCommentsForPullRequestInput maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    GetCommentsForPullRequestInput getCommentsForPullRequestInput = (GetCommentsForPullRequestInput) o;
    return Objects.equals(this.pullRequestId, getCommentsForPullRequestInput.pullRequestId) &&
        Objects.equals(this.repositoryName, getCommentsForPullRequestInput.repositoryName) &&
        Objects.equals(this.beforeCommitId, getCommentsForPullRequestInput.beforeCommitId) &&
        Objects.equals(this.afterCommitId, getCommentsForPullRequestInput.afterCommitId) &&
        Objects.equals(this.nextToken, getCommentsForPullRequestInput.nextToken) &&
        Objects.equals(this.maxResults, getCommentsForPullRequestInput.maxResults);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pullRequestId, repositoryName, beforeCommitId, afterCommitId, nextToken, maxResults);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetCommentsForPullRequestInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCommentsForPullRequestInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCommentsForPullRequestInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCommentsForPullRequestInput is not found in the empty JSON string", GetCommentsForPullRequestInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCommentsForPullRequestInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCommentsForPullRequestInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetCommentsForPullRequestInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCommentsForPullRequestInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCommentsForPullRequestInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCommentsForPullRequestInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCommentsForPullRequestInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCommentsForPullRequestInput>() {
           @Override
           public void write(JsonWriter out, GetCommentsForPullRequestInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCommentsForPullRequestInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCommentsForPullRequestInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCommentsForPullRequestInput
   * @throws IOException if the JSON string is invalid with respect to GetCommentsForPullRequestInput
   */
  public static GetCommentsForPullRequestInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCommentsForPullRequestInput.class);
  }

  /**
   * Convert an instance of GetCommentsForPullRequestInput to an JSON string
   *
   * @return JSON string
   */
