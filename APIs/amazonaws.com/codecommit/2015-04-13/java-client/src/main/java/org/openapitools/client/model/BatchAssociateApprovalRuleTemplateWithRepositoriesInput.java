...
public class BatchAssociateApprovalRuleTemplateWithRepositoriesInput {
  ...
  public BatchAssociateApprovalRuleTemplateWithRepositoriesInput() {
  }

  public BatchAssociateApprovalRuleTemplateWithRepositoriesInput approvalRuleTemplateName(String approvalRuleTemplateName) {
  ...
  public BatchAssociateApprovalRuleTemplateWithRepositoriesInput repositoryNames(List repositoryNames) {
  ...
  public boolean equals(Object o) {
    ...
    BatchAssociateApprovalRuleTemplateWithRepositoriesInput batchAssociateApprovalRuleTemplateWithRepositoriesInput = (BatchAssociateApprovalRuleTemplateWithRepositoriesInput) o;
    return Objects.equals(this.approvalRuleTemplateName, batchAssociateApprovalRuleTemplateWithRepositoriesInput.approvalRuleTemplateName) &&
        Objects.equals(this.repositoryNames, batchAssociateApprovalRuleTemplateWithRepositoriesInput.repositoryNames);
  }
  ...
  public String toString() {
    ...
    sb.append("class BatchAssociateApprovalRuleTemplateWithRepositoriesInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchAssociateApprovalRuleTemplateWithRepositoriesInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchAssociateApprovalRuleTemplateWithRepositoriesInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchAssociateApprovalRuleTemplateWithRepositoriesInput is not found in the empty JSON string", BatchAssociateApprovalRuleTemplateWithRepositoriesInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchAssociateApprovalRuleTemplateWithRepositoriesInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchAssociateApprovalRuleTemplateWithRepositoriesInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BatchAssociateApprovalRuleTemplateWithRepositoriesInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchAssociateApprovalRuleTemplateWithRepositoriesInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchAssociateApprovalRuleTemplateWithRepositoriesInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchAssociateApprovalRuleTemplateWithRepositoriesInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchAssociateApprovalRuleTemplateWithRepositoriesInput.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchAssociateApprovalRuleTemplateWithRepositoriesInput>() {
           @Override
           public void write(JsonWriter out, BatchAssociateApprovalRuleTemplateWithRepositoriesInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchAssociateApprovalRuleTemplateWithRepositoriesInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchAssociateApprovalRuleTemplateWithRepositoriesInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchAssociateApprovalRuleTemplateWithRepositoriesInput
   * @throws IOException if the JSON string is invalid with respect to BatchAssociateApprovalRuleTemplateWithRepositoriesInput
   */
  public static BatchAssociateApprovalRuleTemplateWithRepositoriesInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchAssociateApprovalRuleTemplateWithRepositoriesInput.class);
  }

  /**
   * Convert an instance of BatchAssociateApprovalRuleTemplateWithRepositoriesInput to an JSON string
   *
   * @return JSON string
   */
