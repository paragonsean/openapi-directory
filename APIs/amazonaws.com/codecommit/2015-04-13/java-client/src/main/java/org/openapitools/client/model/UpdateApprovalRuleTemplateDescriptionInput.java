...
public class UpdateApprovalRuleTemplateDescriptionInput {
  ...
  public UpdateApprovalRuleTemplateDescriptionInput() {
  }

  public UpdateApprovalRuleTemplateDescriptionInput approvalRuleTemplateName(String approvalRuleTemplateName) {
  ...
  public UpdateApprovalRuleTemplateDescriptionInput approvalRuleTemplateDescription(String approvalRuleTemplateDescription) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateApprovalRuleTemplateDescriptionInput updateApprovalRuleTemplateDescriptionInput = (UpdateApprovalRuleTemplateDescriptionInput) o;
    return Objects.equals(this.approvalRuleTemplateName, updateApprovalRuleTemplateDescriptionInput.approvalRuleTemplateName) &&
        Objects.equals(this.approvalRuleTemplateDescription, updateApprovalRuleTemplateDescriptionInput.approvalRuleTemplateDescription);
  }

  @Override
  public int hashCode() {
    return Objects.hash(approvalRuleTemplateName, approvalRuleTemplateDescription);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateApprovalRuleTemplateDescriptionInput {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("approvalRuleTemplateDescription");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateApprovalRuleTemplateDescriptionInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateApprovalRuleTemplateDescriptionInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateApprovalRuleTemplateDescriptionInput is not found in the empty JSON string", UpdateApprovalRuleTemplateDescriptionInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateApprovalRuleTemplateDescriptionInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateApprovalRuleTemplateDescriptionInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateApprovalRuleTemplateDescriptionInput.openapiRequiredFields) {
      ...
      // validate the required field `approvalRuleTemplateDescription`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateApprovalRuleTemplateDescriptionInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateApprovalRuleTemplateDescriptionInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateApprovalRuleTemplateDescriptionInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateApprovalRuleTemplateDescriptionInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateApprovalRuleTemplateDescriptionInput>() {
           @Override
           public void write(JsonWriter out, UpdateApprovalRuleTemplateDescriptionInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateApprovalRuleTemplateDescriptionInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateApprovalRuleTemplateDescriptionInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateApprovalRuleTemplateDescriptionInput
   * @throws IOException if the JSON string is invalid with respect to UpdateApprovalRuleTemplateDescriptionInput
   */
  public static UpdateApprovalRuleTemplateDescriptionInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateApprovalRuleTemplateDescriptionInput.class);
  }

  /**
   * Convert an instance of UpdateApprovalRuleTemplateDescriptionInput to an JSON string
   *
   * @return JSON string
   */
