...
public class BatchGetRepositoriesOutput {
  ...
  public static final String SERIALIZED_NAME_REPOSITORIES_NOT_FOUND = "repositoriesNotFound";
  @SerializedName(SERIALIZED_NAME_REPOSITORIES_NOT_FOUND)
  private List repositoriesNotFound;

  public BatchGetRepositoriesOutput() {
  }

  public BatchGetRepositoriesOutput repositories(List repositories) {
  ...
  public BatchGetRepositoriesOutput repositoriesNotFound(List repositoriesNotFound) {
    this.repositoriesNotFound = repositoriesNotFound;
    return this;
  }

  /**
   * Get repositoriesNotFound
   * @return repositoriesNotFound
   */
  @javax.annotation.Nullable
  public List getRepositoriesNotFound() {
    return repositoriesNotFound;
  }

  public void setRepositoriesNotFound(List repositoriesNotFound) {
    this.repositoriesNotFound = repositoriesNotFound;
  }
  ...
  public boolean equals(Object o) {
    ...
    BatchGetRepositoriesOutput batchGetRepositoriesOutput = (BatchGetRepositoriesOutput) o;
    return Objects.equals(this.repositories, batchGetRepositoriesOutput.repositories) &&
        Objects.equals(this.repositoriesNotFound, batchGetRepositoriesOutput.repositoriesNotFound);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositories, repositoriesNotFound);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BatchGetRepositoriesOutput {\n");
    sb.append("    repositories: ").append(toIndentedString(repositories)).append("\n");
    sb.append("    repositoriesNotFound: ").append(toIndentedString(repositoriesNotFound)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("repositoriesNotFound");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchGetRepositoriesOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchGetRepositoriesOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchGetRepositoriesOutput is not found in the empty JSON string", BatchGetRepositoriesOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchGetRepositoriesOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchGetRepositoriesOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `repositoriesNotFound`
      if (jsonObj.get("repositoriesNotFound") != null && !jsonObj.get("repositoriesNotFound").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("repositoriesNotFound"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchGetRepositoriesOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchGetRepositoriesOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchGetRepositoriesOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchGetRepositoriesOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchGetRepositoriesOutput>() {
           @Override
           public void write(JsonWriter out, BatchGetRepositoriesOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchGetRepositoriesOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchGetRepositoriesOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchGetRepositoriesOutput
   * @throws IOException if the JSON string is invalid with respect to BatchGetRepositoriesOutput
   */
  public static BatchGetRepositoriesOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchGetRepositoriesOutput.class);
  }

  /**
   * Convert an instance of BatchGetRepositoriesOutput to an JSON string
   *
   * @return JSON string
   */
