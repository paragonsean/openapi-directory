...
public class BatchGetCommitsInput {
  public static final String SERIALIZED_NAME_COMMIT_IDS = "commitIds";
  @SerializedName(SERIALIZED_NAME_COMMIT_IDS)
  private List commitIds;
  ...
  public BatchGetCommitsInput() {
  }

  public BatchGetCommitsInput commitIds(List commitIds) {
  ...
  public List getCommitIds() {
    return commitIds;
  }

  public void setCommitIds(List commitIds) {
    this.commitIds = commitIds;
  }


  public BatchGetCommitsInput repositoryName(String repositoryName) {
  ...
  public boolean equals(Object o) {
    ...
    BatchGetCommitsInput batchGetCommitsInput = (BatchGetCommitsInput) o;
    return Objects.equals(this.commitIds, batchGetCommitsInput.commitIds) &&
        Objects.equals(this.repositoryName, batchGetCommitsInput.repositoryName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(commitIds, repositoryName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BatchGetCommitsInput {\n");
  ...
  static {
    ...
    openapiFields.add("commitIds");
    openapiFields.add("repositoryName");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("commitIds");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchGetCommitsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchGetCommitsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchGetCommitsInput is not found in the empty JSON string", BatchGetCommitsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchGetCommitsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchGetCommitsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BatchGetCommitsInput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `commitIds`
      List.validateJsonElement(jsonObj.get("commitIds"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchGetCommitsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchGetCommitsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchGetCommitsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchGetCommitsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchGetCommitsInput>() {
           @Override
           public void write(JsonWriter out, BatchGetCommitsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchGetCommitsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchGetCommitsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchGetCommitsInput
   * @throws IOException if the JSON string is invalid with respect to BatchGetCommitsInput
   */
  public static BatchGetCommitsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchGetCommitsInput.class);
  }

  /**
   * Convert an instance of BatchGetCommitsInput to an JSON string
   *
   * @return JSON string
   */
