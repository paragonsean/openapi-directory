...
import org.openapitools.client.model.OverrideStatus;
...
public class OverridePullRequestApprovalRulesInput {
  ...
  public static final String SERIALIZED_NAME_OVERRIDE_STATUS = "overrideStatus";
  @SerializedName(SERIALIZED_NAME_OVERRIDE_STATUS)
  private OverrideStatus overrideStatus;

  public OverridePullRequestApprovalRulesInput() {
  }

  public OverridePullRequestApprovalRulesInput pullRequestId(String pullRequestId) {
  ...
  public OverridePullRequestApprovalRulesInput revisionId(String revisionId) {
  ...
  public OverridePullRequestApprovalRulesInput overrideStatus(OverrideStatus overrideStatus) {
   ...
   */
  @javax.annotation.Nonnull
  public OverrideStatus getOverrideStatus() {
    return overrideStatus;
  }
  ...
  public boolean equals(Object o) {
    ...
    OverridePullRequestApprovalRulesInput overridePullRequestApprovalRulesInput = (OverridePullRequestApprovalRulesInput) o;
    return Objects.equals(this.pullRequestId, overridePullRequestApprovalRulesInput.pullRequestId) &&
        Objects.equals(this.revisionId, overridePullRequestApprovalRulesInput.revisionId) &&
        Objects.equals(this.overrideStatus, overridePullRequestApprovalRulesInput.overrideStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pullRequestId, revisionId, overrideStatus);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OverridePullRequestApprovalRulesInput {\n");
    sb.append("    pullRequestId: ").append(toIndentedString(pullRequestId)).append("\n");
    sb.append("    revisionId: ").append(toIndentedString(revisionId)).append("\n");
    sb.append("    overrideStatus: ").append(toIndentedString(overrideStatus)).append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to OverridePullRequestApprovalRulesInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OverridePullRequestApprovalRulesInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OverridePullRequestApprovalRulesInput is not found in the empty JSON string", OverridePullRequestApprovalRulesInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OverridePullRequestApprovalRulesInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OverridePullRequestApprovalRulesInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OverridePullRequestApprovalRulesInput.openapiRequiredFields) {
      ...
      // validate the required field `overrideStatus`
      OverrideStatus.validateJsonElement(jsonObj.get("overrideStatus"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OverridePullRequestApprovalRulesInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OverridePullRequestApprovalRulesInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OverridePullRequestApprovalRulesInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OverridePullRequestApprovalRulesInput.class));

       return (TypeAdapter<T>) new TypeAdapter<OverridePullRequestApprovalRulesInput>() {
           @Override
           public void write(JsonWriter out, OverridePullRequestApprovalRulesInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OverridePullRequestApprovalRulesInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OverridePullRequestApprovalRulesInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OverridePullRequestApprovalRulesInput
   * @throws IOException if the JSON string is invalid with respect to OverridePullRequestApprovalRulesInput
   */
  public static OverridePullRequestApprovalRulesInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OverridePullRequestApprovalRulesInput.class);
  }

  /**
   * Convert an instance of OverridePullRequestApprovalRulesInput to an JSON string
   *
   * @return JSON string
   */
