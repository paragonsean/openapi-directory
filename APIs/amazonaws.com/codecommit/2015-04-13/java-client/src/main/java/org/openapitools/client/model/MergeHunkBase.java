...
public class MergeHunkBase {
  ...
  public MergeHunkBase() {
  }

  public MergeHunkBase startLine(Integer startLine) {
  ...
  public MergeHunkBase endLine(Integer endLine) {
  ...
  public MergeHunkBase hunkContent(String hunkContent) {
  ...
  public boolean equals(Object o) {
    ...
    MergeHunkBase mergeHunkBase = (MergeHunkBase) o;
    return Objects.equals(this.startLine, mergeHunkBase.startLine) &&
        Objects.equals(this.endLine, mergeHunkBase.endLine) &&
        Objects.equals(this.hunkContent, mergeHunkBase.hunkContent);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MergeHunkBase
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MergeHunkBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MergeHunkBase is not found in the empty JSON string", MergeHunkBase.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MergeHunkBase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MergeHunkBase` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MergeHunkBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MergeHunkBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MergeHunkBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MergeHunkBase.class));

       return (TypeAdapter<T>) new TypeAdapter<MergeHunkBase>() {
           @Override
           public void write(JsonWriter out, MergeHunkBase value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MergeHunkBase read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MergeHunkBase given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MergeHunkBase
   * @throws IOException if the JSON string is invalid with respect to MergeHunkBase
   */
  public static MergeHunkBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MergeHunkBase.class);
  }

  /**
   * Convert an instance of MergeHunkBase to an JSON string
   *
   * @return JSON string
   */
