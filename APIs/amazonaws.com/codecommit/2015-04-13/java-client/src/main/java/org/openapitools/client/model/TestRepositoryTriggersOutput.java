...
public class TestRepositoryTriggersOutput {
  ...
  private List successfulExecutions;
  ...
  private List failedExecutions;

  public TestRepositoryTriggersOutput() {
  }

  public TestRepositoryTriggersOutput successfulExecutions(List successfulExecutions) {
  ...
  public List getSuccessfulExecutions() {
    return successfulExecutions;
  }

  public void setSuccessfulExecutions(List successfulExecutions) {
    this.successfulExecutions = successfulExecutions;
  }


  public TestRepositoryTriggersOutput failedExecutions(List failedExecutions) {
   ...
   */
  @javax.annotation.Nullable
  public List getFailedExecutions() {
    return failedExecutions;
  }

  public void setFailedExecutions(List failedExecutions) {
    this.failedExecutions = failedExecutions;
  }
  ...
  public boolean equals(Object o) {
    ...
    TestRepositoryTriggersOutput testRepositoryTriggersOutput = (TestRepositoryTriggersOutput) o;
    return Objects.equals(this.successfulExecutions, testRepositoryTriggersOutput.successfulExecutions) &&
        Objects.equals(this.failedExecutions, testRepositoryTriggersOutput.failedExecutions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(successfulExecutions, failedExecutions);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TestRepositoryTriggersOutput {\n");
  ...
  static {
    ...
    openapiFields.add("successfulExecutions");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestRepositoryTriggersOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestRepositoryTriggersOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestRepositoryTriggersOutput is not found in the empty JSON string", TestRepositoryTriggersOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestRepositoryTriggersOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestRepositoryTriggersOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `successfulExecutions`
      if (jsonObj.get("successfulExecutions") != null && !jsonObj.get("successfulExecutions").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("successfulExecutions"));
      }
      // validate the optional field `failedExecutions`
      if (jsonObj.get("failedExecutions") != null && !jsonObj.get("failedExecutions").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("failedExecutions"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestRepositoryTriggersOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestRepositoryTriggersOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestRepositoryTriggersOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestRepositoryTriggersOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<TestRepositoryTriggersOutput>() {
           @Override
           public void write(JsonWriter out, TestRepositoryTriggersOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestRepositoryTriggersOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestRepositoryTriggersOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestRepositoryTriggersOutput
   * @throws IOException if the JSON string is invalid with respect to TestRepositoryTriggersOutput
   */
  public static TestRepositoryTriggersOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestRepositoryTriggersOutput.class);
  }

  /**
   * Convert an instance of TestRepositoryTriggersOutput to an JSON string
   *
   * @return JSON string
   */
