...
import org.openapitools.client.model.MergeOptionTypeEnum;
...
public class MergeMetadata {
  public static final String SERIALIZED_NAME_IS_MERGED = "isMerged";
  @SerializedName(SERIALIZED_NAME_IS_MERGED)
  private Boolean isMerged;

  public static final String SERIALIZED_NAME_MERGED_BY = "mergedBy";
  @SerializedName(SERIALIZED_NAME_MERGED_BY)
  private String mergedBy;

  public static final String SERIALIZED_NAME_MERGE_COMMIT_ID = "mergeCommitId";
  @SerializedName(SERIALIZED_NAME_MERGE_COMMIT_ID)
  ...
  private MergeOptionTypeEnum mergeOption;

  public MergeMetadata() {
  }

  public MergeMetadata isMerged(Boolean isMerged) {
  ...
  public MergeMetadata mergedBy(String mergedBy) {
  ...
  public MergeMetadata mergeCommitId(String mergeCommitId) {
  ...
  public MergeMetadata mergeOption(MergeOptionTypeEnum mergeOption) {
   ...
   */
  @javax.annotation.Nullable
  public MergeOptionTypeEnum getMergeOption() {
    return mergeOption;
  }
  ...
  public boolean equals(Object o) {
    ...
    MergeMetadata mergeMetadata = (MergeMetadata) o;
    return Objects.equals(this.isMerged, mergeMetadata.isMerged) &&
        Objects.equals(this.mergedBy, mergeMetadata.mergedBy) &&
        Objects.equals(this.mergeCommitId, mergeMetadata.mergeCommitId) &&
        Objects.equals(this.mergeOption, mergeMetadata.mergeOption);
  }

  @Override
  public int hashCode() {
    return Objects.hash(isMerged, mergedBy, mergeCommitId, mergeOption);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MergeMetadata {\n");
  ...
  static {
    ...
    openapiFields.add("isMerged");
    openapiFields.add("mergedBy");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MergeMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MergeMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MergeMetadata is not found in the empty JSON string", MergeMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MergeMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MergeMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `isMerged`
      if (jsonObj.get("isMerged") != null && !jsonObj.get("isMerged").isJsonNull()) {
        Boolean.validateJsonElement(jsonObj.get("isMerged"));
      }
      // validate the optional field `mergedBy`
      if (jsonObj.get("mergedBy") != null && !jsonObj.get("mergedBy").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("mergedBy"));
      }
      // validate the optional field `mergeCommitId`
      if (jsonObj.get("mergeCommitId") != null && !jsonObj.get("mergeCommitId").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("mergeCommitId"));
      }
      // validate the optional field `mergeOption`
      if (jsonObj.get("mergeOption") != null && !jsonObj.get("mergeOption").isJsonNull()) {
        MergeOptionTypeEnum.validateJsonElement(jsonObj.get("mergeOption"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MergeMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MergeMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MergeMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MergeMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<MergeMetadata>() {
           @Override
           public void write(JsonWriter out, MergeMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MergeMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MergeMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MergeMetadata
   * @throws IOException if the JSON string is invalid with respect to MergeMetadata
   */
  public static MergeMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MergeMetadata.class);
  }

  /**
   * Convert an instance of MergeMetadata to an JSON string
   *
   * @return JSON string
   */
