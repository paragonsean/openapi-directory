...
public class PullRequestEventApprovalStateChangedEventMetadata {
  ...
  public PullRequestEventApprovalStateChangedEventMetadata() {
  }

  public PullRequestEventApprovalStateChangedEventMetadata revisionId(String revisionId) {
  ...
  public PullRequestEventApprovalStateChangedEventMetadata approvalStatus(ApprovalState approvalStatus) {
  ...
  public boolean equals(Object o) {
    ...
    PullRequestEventApprovalStateChangedEventMetadata pullRequestEventApprovalStateChangedEventMetadata = (PullRequestEventApprovalStateChangedEventMetadata) o;
    return Objects.equals(this.revisionId, pullRequestEventApprovalStateChangedEventMetadata.revisionId) &&
        Objects.equals(this.approvalStatus, pullRequestEventApprovalStateChangedEventMetadata.approvalStatus);
  }
  ...
  public String toString() {
    ...
    sb.append("class PullRequestEventApprovalStateChangedEventMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PullRequestEventApprovalStateChangedEventMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PullRequestEventApprovalStateChangedEventMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PullRequestEventApprovalStateChangedEventMetadata is not found in the empty JSON string", PullRequestEventApprovalStateChangedEventMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PullRequestEventApprovalStateChangedEventMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PullRequestEventApprovalStateChangedEventMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PullRequestEventApprovalStateChangedEventMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PullRequestEventApprovalStateChangedEventMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PullRequestEventApprovalStateChangedEventMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PullRequestEventApprovalStateChangedEventMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<PullRequestEventApprovalStateChangedEventMetadata>() {
           @Override
           public void write(JsonWriter out, PullRequestEventApprovalStateChangedEventMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PullRequestEventApprovalStateChangedEventMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PullRequestEventApprovalStateChangedEventMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PullRequestEventApprovalStateChangedEventMetadata
   * @throws IOException if the JSON string is invalid with respect to PullRequestEventApprovalStateChangedEventMetadata
   */
  public static PullRequestEventApprovalStateChangedEventMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PullRequestEventApprovalStateChangedEventMetadata.class);
  }

  /**
   * Convert an instance of PullRequestEventApprovalStateChangedEventMetadata to an JSON string
   *
   * @return JSON string
   */
