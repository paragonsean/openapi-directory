...
public class MergeHunkSource {
  ...
  public MergeHunkSource() {
  }

  public MergeHunkSource startLine(Integer startLine) {
  ...
  public MergeHunkSource endLine(Integer endLine) {
  ...
  public MergeHunkSource hunkContent(String hunkContent) {
  ...
  public boolean equals(Object o) {
    ...
    MergeHunkSource mergeHunkSource = (MergeHunkSource) o;
    return Objects.equals(this.startLine, mergeHunkSource.startLine) &&
        Objects.equals(this.endLine, mergeHunkSource.endLine) &&
        Objects.equals(this.hunkContent, mergeHunkSource.hunkContent);
  }
  ...
  public String toString() {
    ...
    sb.append("class MergeHunkSource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MergeHunkSource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MergeHunkSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MergeHunkSource is not found in the empty JSON string", MergeHunkSource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MergeHunkSource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MergeHunkSource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MergeHunkSource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MergeHunkSource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MergeHunkSource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MergeHunkSource.class));

       return (TypeAdapter<T>) new TypeAdapter<MergeHunkSource>() {
           @Override
           public void write(JsonWriter out, MergeHunkSource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MergeHunkSource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MergeHunkSource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MergeHunkSource
   * @throws IOException if the JSON string is invalid with respect to MergeHunkSource
   */
  public static MergeHunkSource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MergeHunkSource.class);
  }

  /**
   * Convert an instance of MergeHunkSource to an JSON string
   *
   * @return JSON string
   */
