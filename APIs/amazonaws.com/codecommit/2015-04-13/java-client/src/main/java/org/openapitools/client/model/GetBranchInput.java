...
public class GetBranchInput {
  ...
  public GetBranchInput repositoryName(String repositoryName) {
  ...
  public GetBranchInput branchName(String branchName) {
  ...
  public boolean equals(Object o) {
    ...
    GetBranchInput getBranchInput = (GetBranchInput) o;
    return Objects.equals(this.repositoryName, getBranchInput.repositoryName) &&
        Objects.equals(this.branchName, getBranchInput.branchName);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetBranchInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetBranchInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetBranchInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetBranchInput is not found in the empty JSON string", GetBranchInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetBranchInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetBranchInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetBranchInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetBranchInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetBranchInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetBranchInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetBranchInput>() {
           @Override
           public void write(JsonWriter out, GetBranchInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetBranchInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetBranchInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetBranchInput
   * @throws IOException if the JSON string is invalid with respect to GetBranchInput
   */
  public static GetBranchInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetBranchInput.class);
  }

  /**
   * Convert an instance of GetBranchInput to an JSON string
   *
   * @return JSON string
   */
