...
public class GetCommentsForPullRequestOutput {
  public static final String SERIALIZED_NAME_COMMENTS_FOR_PULL_REQUEST_DATA = "commentsForPullRequestData";
  @SerializedName(SERIALIZED_NAME_COMMENTS_FOR_PULL_REQUEST_DATA)
  private List commentsForPullRequestData;
  ...
  public GetCommentsForPullRequestOutput commentsForPullRequestData(List commentsForPullRequestData) {
    this.commentsForPullRequestData = commentsForPullRequestData;
    return this;
  }

  /**
   * Get commentsForPullRequestData
   * @return commentsForPullRequestData
   */
  @javax.annotation.Nullable
  public List getCommentsForPullRequestData() {
    return commentsForPullRequestData;
  }

  public void setCommentsForPullRequestData(List commentsForPullRequestData) {
    this.commentsForPullRequestData = commentsForPullRequestData;
  }


  public GetCommentsForPullRequestOutput nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    GetCommentsForPullRequestOutput getCommentsForPullRequestOutput = (GetCommentsForPullRequestOutput) o;
    return Objects.equals(this.commentsForPullRequestData, getCommentsForPullRequestOutput.commentsForPullRequestData) &&
        Objects.equals(this.nextToken, getCommentsForPullRequestOutput.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(commentsForPullRequestData, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetCommentsForPullRequestOutput {\n");
    sb.append("    commentsForPullRequestData: ").append(toIndentedString(commentsForPullRequestData)).append("\n");
  ...
  static {
    ...
    openapiFields.add("commentsForPullRequestData");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCommentsForPullRequestOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCommentsForPullRequestOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCommentsForPullRequestOutput is not found in the empty JSON string", GetCommentsForPullRequestOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCommentsForPullRequestOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCommentsForPullRequestOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `commentsForPullRequestData`
      if (jsonObj.get("commentsForPullRequestData") != null && !jsonObj.get("commentsForPullRequestData").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("commentsForPullRequestData"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCommentsForPullRequestOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCommentsForPullRequestOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCommentsForPullRequestOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCommentsForPullRequestOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCommentsForPullRequestOutput>() {
           @Override
           public void write(JsonWriter out, GetCommentsForPullRequestOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCommentsForPullRequestOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCommentsForPullRequestOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCommentsForPullRequestOutput
   * @throws IOException if the JSON string is invalid with respect to GetCommentsForPullRequestOutput
   */
  public static GetCommentsForPullRequestOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCommentsForPullRequestOutput.class);
  }

  /**
   * Convert an instance of GetCommentsForPullRequestOutput to an JSON string
   *
   * @return JSON string
   */
