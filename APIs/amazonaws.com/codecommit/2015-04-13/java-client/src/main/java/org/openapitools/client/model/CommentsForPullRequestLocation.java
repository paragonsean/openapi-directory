...
public class CommentsForPullRequestLocation {
  ...
  public CommentsForPullRequestLocation() {
  }

  public CommentsForPullRequestLocation filePath(String filePath) {
  ...
  public CommentsForPullRequestLocation filePosition(Integer filePosition) {
  ...
  public CommentsForPullRequestLocation relativeFileVersion(RelativeFileVersionEnum relativeFileVersion) {
  ...
  public boolean equals(Object o) {
    ...
    CommentsForPullRequestLocation commentsForPullRequestLocation = (CommentsForPullRequestLocation) o;
    return Objects.equals(this.filePath, commentsForPullRequestLocation.filePath) &&
        Objects.equals(this.filePosition, commentsForPullRequestLocation.filePosition) &&
        Objects.equals(this.relativeFileVersion, commentsForPullRequestLocation.relativeFileVersion);
  }
  ...
  public String toString() {
    ...
    sb.append("class CommentsForPullRequestLocation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CommentsForPullRequestLocation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommentsForPullRequestLocation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CommentsForPullRequestLocation is not found in the empty JSON string", CommentsForPullRequestLocation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CommentsForPullRequestLocation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CommentsForPullRequestLocation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CommentsForPullRequestLocation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CommentsForPullRequestLocation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CommentsForPullRequestLocation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CommentsForPullRequestLocation.class));

       return (TypeAdapter<T>) new TypeAdapter<CommentsForPullRequestLocation>() {
           @Override
           public void write(JsonWriter out, CommentsForPullRequestLocation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CommentsForPullRequestLocation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CommentsForPullRequestLocation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CommentsForPullRequestLocation
   * @throws IOException if the JSON string is invalid with respect to CommentsForPullRequestLocation
   */
  public static CommentsForPullRequestLocation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CommentsForPullRequestLocation.class);
  }

  /**
   * Convert an instance of CommentsForPullRequestLocation to an JSON string
   *
   * @return JSON string
   */
