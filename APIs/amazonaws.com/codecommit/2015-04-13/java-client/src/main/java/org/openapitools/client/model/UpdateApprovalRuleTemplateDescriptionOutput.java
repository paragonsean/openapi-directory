...
public class UpdateApprovalRuleTemplateDescriptionOutput {
  ...
  public UpdateApprovalRuleTemplateDescriptionOutput approvalRuleTemplate(UpdateApprovalRuleTemplateDescriptionOutputApprovalRuleTemplate approvalRuleTemplate) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateApprovalRuleTemplateDescriptionOutput updateApprovalRuleTemplateDescriptionOutput = (UpdateApprovalRuleTemplateDescriptionOutput) o;
    return Objects.equals(this.approvalRuleTemplate, updateApprovalRuleTemplateDescriptionOutput.approvalRuleTemplate);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateApprovalRuleTemplateDescriptionOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateApprovalRuleTemplateDescriptionOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateApprovalRuleTemplateDescriptionOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateApprovalRuleTemplateDescriptionOutput is not found in the empty JSON string", UpdateApprovalRuleTemplateDescriptionOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateApprovalRuleTemplateDescriptionOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateApprovalRuleTemplateDescriptionOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateApprovalRuleTemplateDescriptionOutput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateApprovalRuleTemplateDescriptionOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateApprovalRuleTemplateDescriptionOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateApprovalRuleTemplateDescriptionOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateApprovalRuleTemplateDescriptionOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateApprovalRuleTemplateDescriptionOutput>() {
           @Override
           public void write(JsonWriter out, UpdateApprovalRuleTemplateDescriptionOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateApprovalRuleTemplateDescriptionOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateApprovalRuleTemplateDescriptionOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateApprovalRuleTemplateDescriptionOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateApprovalRuleTemplateDescriptionOutput
   */
  public static UpdateApprovalRuleTemplateDescriptionOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateApprovalRuleTemplateDescriptionOutput.class);
  }

  /**
   * Convert an instance of UpdateApprovalRuleTemplateDescriptionOutput to an JSON string
   *
   * @return JSON string
   */
