...
public class GetCommentReactionsInput {
  ...
  public static final String SERIALIZED_NAME_REACTION_USER_ARN = "reactionUserArn";
  @SerializedName(SERIALIZED_NAME_REACTION_USER_ARN)
  ...
  public GetCommentReactionsInput() {
  }

  public GetCommentReactionsInput commentId(String commentId) {
  ...
  public GetCommentReactionsInput reactionUserArn(String reactionUserArn) {
  ...
  public GetCommentReactionsInput nextToken(String nextToken) {
  ...
  public GetCommentReactionsInput maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    GetCommentReactionsInput getCommentReactionsInput = (GetCommentReactionsInput) o;
    return Objects.equals(this.commentId, getCommentReactionsInput.commentId) &&
        Objects.equals(this.reactionUserArn, getCommentReactionsInput.reactionUserArn) &&
        Objects.equals(this.nextToken, getCommentReactionsInput.nextToken) &&
        Objects.equals(this.maxResults, getCommentReactionsInput.maxResults);
  }

  @Override
  public int hashCode() {
    return Objects.hash(commentId, reactionUserArn, nextToken, maxResults);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetCommentReactionsInput {\n");
    sb.append("    commentId: ").append(toIndentedString(commentId)).append("\n");
    sb.append("    reactionUserArn: ").append(toIndentedString(reactionUserArn)).append("\n");
  ...
  static {
    ...
    openapiFields.add("reactionUserArn");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCommentReactionsInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCommentReactionsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCommentReactionsInput is not found in the empty JSON string", GetCommentReactionsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCommentReactionsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCommentReactionsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetCommentReactionsInput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `commentId`
      String.validateJsonElement(jsonObj.get("commentId"));
      // validate the optional field `reactionUserArn`
      if (jsonObj.get("reactionUserArn") != null && !jsonObj.get("reactionUserArn").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("reactionUserArn"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCommentReactionsInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCommentReactionsInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCommentReactionsInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCommentReactionsInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCommentReactionsInput>() {
           @Override
           public void write(JsonWriter out, GetCommentReactionsInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCommentReactionsInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCommentReactionsInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCommentReactionsInput
   * @throws IOException if the JSON string is invalid with respect to GetCommentReactionsInput
   */
  public static GetCommentReactionsInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCommentReactionsInput.class);
  }

  /**
   * Convert an instance of GetCommentReactionsInput to an JSON string
   *
   * @return JSON string
   */
