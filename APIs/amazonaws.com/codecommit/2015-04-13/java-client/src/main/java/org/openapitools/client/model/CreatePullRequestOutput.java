...
import org.openapitools.client.model.CreatePullRequestOutputPullRequest;
...
public class CreatePullRequestOutput {
  ...
  private CreatePullRequestOutputPullRequest pullRequest;

  public CreatePullRequestOutput() {
  }

  public CreatePullRequestOutput pullRequest(CreatePullRequestOutputPullRequest pullRequest) {
  ...
  public CreatePullRequestOutputPullRequest getPullRequest() {
    return pullRequest;
  }

  public void setPullRequest(CreatePullRequestOutputPullRequest pullRequest) {
    this.pullRequest = pullRequest;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreatePullRequestOutput createPullRequestOutput = (CreatePullRequestOutput) o;
    return Objects.equals(this.pullRequest, createPullRequestOutput.pullRequest);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreatePullRequestOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePullRequestOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePullRequestOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePullRequestOutput is not found in the empty JSON string", CreatePullRequestOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePullRequestOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePullRequestOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreatePullRequestOutput.openapiRequiredFields) {
      ...
      CreatePullRequestOutputPullRequest.validateJsonElement(jsonObj.get("pullRequest"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePullRequestOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePullRequestOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePullRequestOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePullRequestOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePullRequestOutput>() {
           @Override
           public void write(JsonWriter out, CreatePullRequestOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePullRequestOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePullRequestOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePullRequestOutput
   * @throws IOException if the JSON string is invalid with respect to CreatePullRequestOutput
   */
  public static CreatePullRequestOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePullRequestOutput.class);
  }

  /**
   * Convert an instance of CreatePullRequestOutput to an JSON string
   *
   * @return JSON string
   */
