...
public class MergeBranchesByFastForwardOutput {
  ...
  public MergeBranchesByFastForwardOutput commitId(String commitId) {
  ...
  public MergeBranchesByFastForwardOutput treeId(String treeId) {
    this.treeId = treeId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MergeBranchesByFastForwardOutput mergeBranchesByFastForwardOutput = (MergeBranchesByFastForwardOutput) o;
    return Objects.equals(this.commitId, mergeBranchesByFastForwardOutput.commitId) &&
        Objects.equals(this.treeId, mergeBranchesByFastForwardOutput.treeId);
  }
  ...
  public String toString() {
    ...
    sb.append("class MergeBranchesByFastForwardOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MergeBranchesByFastForwardOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MergeBranchesByFastForwardOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MergeBranchesByFastForwardOutput is not found in the empty JSON string", MergeBranchesByFastForwardOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MergeBranchesByFastForwardOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MergeBranchesByFastForwardOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MergeBranchesByFastForwardOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MergeBranchesByFastForwardOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MergeBranchesByFastForwardOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MergeBranchesByFastForwardOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<MergeBranchesByFastForwardOutput>() {
           @Override
           public void write(JsonWriter out, MergeBranchesByFastForwardOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MergeBranchesByFastForwardOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MergeBranchesByFastForwardOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MergeBranchesByFastForwardOutput
   * @throws IOException if the JSON string is invalid with respect to MergeBranchesByFastForwardOutput
   */
  public static MergeBranchesByFastForwardOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MergeBranchesByFastForwardOutput.class);
  }

  /**
   * Convert an instance of MergeBranchesByFastForwardOutput to an JSON string
   *
   * @return JSON string
   */
