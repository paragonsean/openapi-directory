...
public class ConflictMetadataFileSizes {
  ...
  public ConflictMetadataFileSizes() {
  }

  public ConflictMetadataFileSizes source(Integer source) {
    this.source = source;
    return this;
  }
  ...
  public ConflictMetadataFileSizes destination(Integer destination) {
  ...
  public ConflictMetadataFileSizes base(Integer base) {
    this.base = base;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ConflictMetadataFileSizes conflictMetadataFileSizes = (ConflictMetadataFileSizes) o;
    return Objects.equals(this.source, conflictMetadataFileSizes.source) &&
        Objects.equals(this.destination, conflictMetadataFileSizes.destination) &&
        Objects.equals(this.base, conflictMetadataFileSizes.base);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConflictMetadataFileSizes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConflictMetadataFileSizes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConflictMetadataFileSizes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConflictMetadataFileSizes is not found in the empty JSON string", ConflictMetadataFileSizes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConflictMetadataFileSizes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConflictMetadataFileSizes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `source`
      if (jsonObj.get("source") != null && !jsonObj.get("source").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("source"));
      }
      // validate the optional field `destination`
      if (jsonObj.get("destination") != null && !jsonObj.get("destination").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("destination"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConflictMetadataFileSizes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConflictMetadataFileSizes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConflictMetadataFileSizes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConflictMetadataFileSizes.class));

       return (TypeAdapter<T>) new TypeAdapter<ConflictMetadataFileSizes>() {
           @Override
           public void write(JsonWriter out, ConflictMetadataFileSizes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConflictMetadataFileSizes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConflictMetadataFileSizes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConflictMetadataFileSizes
   * @throws IOException if the JSON string is invalid with respect to ConflictMetadataFileSizes
   */
  public static ConflictMetadataFileSizes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConflictMetadataFileSizes.class);
  }

  /**
   * Convert an instance of ConflictMetadataFileSizes to an JSON string
   *
   * @return JSON string
   */
