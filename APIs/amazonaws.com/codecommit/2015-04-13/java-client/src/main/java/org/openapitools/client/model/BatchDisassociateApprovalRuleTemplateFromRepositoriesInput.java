...
public class BatchDisassociateApprovalRuleTemplateFromRepositoriesInput {
  ...
  public BatchDisassociateApprovalRuleTemplateFromRepositoriesInput() {
  }

  public BatchDisassociateApprovalRuleTemplateFromRepositoriesInput approvalRuleTemplateName(String approvalRuleTemplateName) {
  ...
  public BatchDisassociateApprovalRuleTemplateFromRepositoriesInput repositoryNames(List repositoryNames) {
  ...
  public boolean equals(Object o) {
    ...
    BatchDisassociateApprovalRuleTemplateFromRepositoriesInput batchDisassociateApprovalRuleTemplateFromRepositoriesInput = (BatchDisassociateApprovalRuleTemplateFromRepositoriesInput) o;
    return Objects.equals(this.approvalRuleTemplateName, batchDisassociateApprovalRuleTemplateFromRepositoriesInput.approvalRuleTemplateName) &&
        Objects.equals(this.repositoryNames, batchDisassociateApprovalRuleTemplateFromRepositoriesInput.repositoryNames);
  }

  @Override
  public int hashCode() {
    return Objects.hash(approvalRuleTemplateName, repositoryNames);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BatchDisassociateApprovalRuleTemplateFromRepositoriesInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchDisassociateApprovalRuleTemplateFromRepositoriesInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchDisassociateApprovalRuleTemplateFromRepositoriesInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchDisassociateApprovalRuleTemplateFromRepositoriesInput is not found in the empty JSON string", BatchDisassociateApprovalRuleTemplateFromRepositoriesInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchDisassociateApprovalRuleTemplateFromRepositoriesInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchDisassociateApprovalRuleTemplateFromRepositoriesInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BatchDisassociateApprovalRuleTemplateFromRepositoriesInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchDisassociateApprovalRuleTemplateFromRepositoriesInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchDisassociateApprovalRuleTemplateFromRepositoriesInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchDisassociateApprovalRuleTemplateFromRepositoriesInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchDisassociateApprovalRuleTemplateFromRepositoriesInput.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchDisassociateApprovalRuleTemplateFromRepositoriesInput>() {
           @Override
           public void write(JsonWriter out, BatchDisassociateApprovalRuleTemplateFromRepositoriesInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchDisassociateApprovalRuleTemplateFromRepositoriesInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchDisassociateApprovalRuleTemplateFromRepositoriesInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchDisassociateApprovalRuleTemplateFromRepositoriesInput
   * @throws IOException if the JSON string is invalid with respect to BatchDisassociateApprovalRuleTemplateFromRepositoriesInput
   */
  public static BatchDisassociateApprovalRuleTemplateFromRepositoriesInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchDisassociateApprovalRuleTemplateFromRepositoriesInput.class);
  }

  /**
   * Convert an instance of BatchDisassociateApprovalRuleTemplateFromRepositoriesInput to an JSON string
   *
   * @return JSON string
   */
