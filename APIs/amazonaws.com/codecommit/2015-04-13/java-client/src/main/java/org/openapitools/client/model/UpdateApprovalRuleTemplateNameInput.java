...
public class UpdateApprovalRuleTemplateNameInput {
  public static final String SERIALIZED_NAME_OLD_APPROVAL_RULE_TEMPLATE_NAME = "oldApprovalRuleTemplateName";
  @SerializedName(SERIALIZED_NAME_OLD_APPROVAL_RULE_TEMPLATE_NAME)
  private String oldApprovalRuleTemplateName;

  public static final String SERIALIZED_NAME_NEW_APPROVAL_RULE_TEMPLATE_NAME = "newApprovalRuleTemplateName";
  @SerializedName(SERIALIZED_NAME_NEW_APPROVAL_RULE_TEMPLATE_NAME)
  private String newApprovalRuleTemplateName;

  public UpdateApprovalRuleTemplateNameInput() {
  }

  public UpdateApprovalRuleTemplateNameInput oldApprovalRuleTemplateName(String oldApprovalRuleTemplateName) {
    this.oldApprovalRuleTemplateName = oldApprovalRuleTemplateName;
    return this;
  }

  /**
   * Get oldApprovalRuleTemplateName
  ...
  public UpdateApprovalRuleTemplateNameInput newApprovalRuleTemplateName(String newApprovalRuleTemplateName) {
    this.newApprovalRuleTemplateName = newApprovalRuleTemplateName;
    return this;
  }

  /**
   * Get newApprovalRuleTemplateName
  ...
  public boolean equals(Object o) {
    ...
    UpdateApprovalRuleTemplateNameInput updateApprovalRuleTemplateNameInput = (UpdateApprovalRuleTemplateNameInput) o;
    return Objects.equals(this.oldApprovalRuleTemplateName, updateApprovalRuleTemplateNameInput.oldApprovalRuleTemplateName) &&
        Objects.equals(this.newApprovalRuleTemplateName, updateApprovalRuleTemplateNameInput.newApprovalRuleTemplateName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(oldApprovalRuleTemplateName, newApprovalRuleTemplateName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateApprovalRuleTemplateNameInput {\n");
    sb.append("    oldApprovalRuleTemplateName: ").append(toIndentedString(oldApprovalRuleTemplateName)).append("\n");
    sb.append("    newApprovalRuleTemplateName: ").append(toIndentedString(newApprovalRuleTemplateName)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("oldApprovalRuleTemplateName");
    openapiFields.add("newApprovalRuleTemplateName");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("oldApprovalRuleTemplateName");
    openapiRequiredFields.add("newApprovalRuleTemplateName");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateApprovalRuleTemplateNameInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateApprovalRuleTemplateNameInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateApprovalRuleTemplateNameInput is not found in the empty JSON string", UpdateApprovalRuleTemplateNameInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateApprovalRuleTemplateNameInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateApprovalRuleTemplateNameInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateApprovalRuleTemplateNameInput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `oldApprovalRuleTemplateName`
      String.validateJsonElement(jsonObj.get("oldApprovalRuleTemplateName"));
      // validate the required field `newApprovalRuleTemplateName`
      String.validateJsonElement(jsonObj.get("newApprovalRuleTemplateName"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateApprovalRuleTemplateNameInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateApprovalRuleTemplateNameInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateApprovalRuleTemplateNameInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateApprovalRuleTemplateNameInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateApprovalRuleTemplateNameInput>() {
           @Override
           public void write(JsonWriter out, UpdateApprovalRuleTemplateNameInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateApprovalRuleTemplateNameInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateApprovalRuleTemplateNameInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateApprovalRuleTemplateNameInput
   * @throws IOException if the JSON string is invalid with respect to UpdateApprovalRuleTemplateNameInput
   */
  public static UpdateApprovalRuleTemplateNameInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateApprovalRuleTemplateNameInput.class);
  }

  /**
   * Convert an instance of UpdateApprovalRuleTemplateNameInput to an JSON string
   *
   * @return JSON string
   */
