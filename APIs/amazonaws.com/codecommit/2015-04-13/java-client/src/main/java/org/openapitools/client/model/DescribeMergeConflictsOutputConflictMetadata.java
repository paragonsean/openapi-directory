...
public class DescribeMergeConflictsOutputConflictMetadata {
  ...
  public DescribeMergeConflictsOutputConflictMetadata() {
  }

  public DescribeMergeConflictsOutputConflictMetadata filePath(String filePath) {
  ...
  public DescribeMergeConflictsOutputConflictMetadata fileSizes(ConflictMetadataFileSizes fileSizes) {
  ...
  public DescribeMergeConflictsOutputConflictMetadata fileModes(ConflictMetadataFileModes fileModes) {
  ...
  public DescribeMergeConflictsOutputConflictMetadata objectTypes(ConflictMetadataObjectTypes objectTypes) {
  ...
  public DescribeMergeConflictsOutputConflictMetadata numberOfConflicts(Integer numberOfConflicts) {
  ...
  public DescribeMergeConflictsOutputConflictMetadata isBinaryFile(ConflictMetadataIsBinaryFile isBinaryFile) {
  ...
  public DescribeMergeConflictsOutputConflictMetadata contentConflict(Boolean contentConflict) {
  ...
  public DescribeMergeConflictsOutputConflictMetadata fileModeConflict(Boolean fileModeConflict) {
  ...
  public DescribeMergeConflictsOutputConflictMetadata objectTypeConflict(Boolean objectTypeConflict) {
  ...
  public DescribeMergeConflictsOutputConflictMetadata mergeOperations(ConflictMetadataMergeOperations mergeOperations) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeMergeConflictsOutputConflictMetadata describeMergeConflictsOutputConflictMetadata = (DescribeMergeConflictsOutputConflictMetadata) o;
    return Objects.equals(this.filePath, describeMergeConflictsOutputConflictMetadata.filePath) &&
        Objects.equals(this.fileSizes, describeMergeConflictsOutputConflictMetadata.fileSizes) &&
        Objects.equals(this.fileModes, describeMergeConflictsOutputConflictMetadata.fileModes) &&
        Objects.equals(this.objectTypes, describeMergeConflictsOutputConflictMetadata.objectTypes) &&
        Objects.equals(this.numberOfConflicts, describeMergeConflictsOutputConflictMetadata.numberOfConflicts) &&
        Objects.equals(this.isBinaryFile, describeMergeConflictsOutputConflictMetadata.isBinaryFile) &&
        Objects.equals(this.contentConflict, describeMergeConflictsOutputConflictMetadata.contentConflict) &&
        Objects.equals(this.fileModeConflict, describeMergeConflictsOutputConflictMetadata.fileModeConflict) &&
        Objects.equals(this.objectTypeConflict, describeMergeConflictsOutputConflictMetadata.objectTypeConflict) &&
        Objects.equals(this.mergeOperations, describeMergeConflictsOutputConflictMetadata.mergeOperations);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeMergeConflictsOutputConflictMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeMergeConflictsOutputConflictMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeMergeConflictsOutputConflictMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeMergeConflictsOutputConflictMetadata is not found in the empty JSON string", DescribeMergeConflictsOutputConflictMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeMergeConflictsOutputConflictMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeMergeConflictsOutputConflictMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeMergeConflictsOutputConflictMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeMergeConflictsOutputConflictMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeMergeConflictsOutputConflictMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeMergeConflictsOutputConflictMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeMergeConflictsOutputConflictMetadata>() {
           @Override
           public void write(JsonWriter out, DescribeMergeConflictsOutputConflictMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeMergeConflictsOutputConflictMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeMergeConflictsOutputConflictMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeMergeConflictsOutputConflictMetadata
   * @throws IOException if the JSON string is invalid with respect to DescribeMergeConflictsOutputConflictMetadata
   */
  public static DescribeMergeConflictsOutputConflictMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeMergeConflictsOutputConflictMetadata.class);
  }

  /**
   * Convert an instance of DescribeMergeConflictsOutputConflictMetadata to an JSON string
   *
   * @return JSON string
   */
