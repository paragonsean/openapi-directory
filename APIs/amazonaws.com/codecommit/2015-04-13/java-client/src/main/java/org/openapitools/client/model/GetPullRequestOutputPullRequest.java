...
public class GetPullRequestOutputPullRequest {
  ...
  public GetPullRequestOutputPullRequest() {
  }

  public GetPullRequestOutputPullRequest pullRequestId(String pullRequestId) {
  ...
  public GetPullRequestOutputPullRequest title(String title) {
    this.title = title;
    return this;
  }
  ...
  public GetPullRequestOutputPullRequest description(String description) {
  ...
  public GetPullRequestOutputPullRequest lastActivityDate(OffsetDateTime lastActivityDate) {
  ...
  public GetPullRequestOutputPullRequest creationDate(OffsetDateTime creationDate) {
  ...
  public GetPullRequestOutputPullRequest pullRequestStatus(PullRequestStatusEnum pullRequestStatus) {
  ...
  public GetPullRequestOutputPullRequest authorArn(String authorArn) {
  ...
  public GetPullRequestOutputPullRequest pullRequestTargets(List pullRequestTargets) {
  ...
  public GetPullRequestOutputPullRequest clientRequestToken(String clientRequestToken) {
  ...
  public GetPullRequestOutputPullRequest revisionId(String revisionId) {
  ...
  public GetPullRequestOutputPullRequest approvalRules(List approvalRules) {
  ...
  public boolean equals(Object o) {
    ...
    GetPullRequestOutputPullRequest getPullRequestOutputPullRequest = (GetPullRequestOutputPullRequest) o;
    return Objects.equals(this.pullRequestId, getPullRequestOutputPullRequest.pullRequestId) &&
        Objects.equals(this.title, getPullRequestOutputPullRequest.title) &&
        Objects.equals(this.description, getPullRequestOutputPullRequest.description) &&
        Objects.equals(this.lastActivityDate, getPullRequestOutputPullRequest.lastActivityDate) &&
        Objects.equals(this.creationDate, getPullRequestOutputPullRequest.creationDate) &&
        Objects.equals(this.pullRequestStatus, getPullRequestOutputPullRequest.pullRequestStatus) &&
        Objects.equals(this.authorArn, getPullRequestOutputPullRequest.authorArn) &&
        Objects.equals(this.pullRequestTargets, getPullRequestOutputPullRequest.pullRequestTargets) &&
        Objects.equals(this.clientRequestToken, getPullRequestOutputPullRequest.clientRequestToken) &&
        Objects.equals(this.revisionId, getPullRequestOutputPullRequest.revisionId) &&
        Objects.equals(this.approvalRules, getPullRequestOutputPullRequest.approvalRules);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetPullRequestOutputPullRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPullRequestOutputPullRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPullRequestOutputPullRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPullRequestOutputPullRequest is not found in the empty JSON string", GetPullRequestOutputPullRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPullRequestOutputPullRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPullRequestOutputPullRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPullRequestOutputPullRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPullRequestOutputPullRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPullRequestOutputPullRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPullRequestOutputPullRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPullRequestOutputPullRequest>() {
           @Override
           public void write(JsonWriter out, GetPullRequestOutputPullRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPullRequestOutputPullRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPullRequestOutputPullRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPullRequestOutputPullRequest
   * @throws IOException if the JSON string is invalid with respect to GetPullRequestOutputPullRequest
   */
  public static GetPullRequestOutputPullRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPullRequestOutputPullRequest.class);
  }

  /**
   * Convert an instance of GetPullRequestOutputPullRequest to an JSON string
   *
   * @return JSON string
   */
