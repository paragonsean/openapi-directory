...
/**
 * Gets or Sets ConflictDetailLevelTypeEnum
 */
@JsonAdapter(ConflictDetailLevelTypeEnum.Adapter.class)
public enum ConflictDetailLevelTypeEnum {
  ...
  ConflictDetailLevelTypeEnum(String value) {
    this.value = value;
  }
  ...
  public static ConflictDetailLevelTypeEnum fromValue(String value) {
    for (ConflictDetailLevelTypeEnum b : ConflictDetailLevelTypeEnum.values()) {
  ...
  public static class Adapter extends TypeAdapter<ConflictDetailLevelTypeEnum> {
    @Override
    public void write(final JsonWriter jsonWriter, final ConflictDetailLevelTypeEnum enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ConflictDetailLevelTypeEnum read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ConflictDetailLevelTypeEnum.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ConflictDetailLevelTypeEnum.fromValue(value);
  }
}
