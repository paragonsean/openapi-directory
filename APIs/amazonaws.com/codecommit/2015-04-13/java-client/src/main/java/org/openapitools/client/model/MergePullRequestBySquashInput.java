...
public class MergePullRequestBySquashInput {
  ...
  public MergePullRequestBySquashInput() {
  }

  public MergePullRequestBySquashInput pullRequestId(String pullRequestId) {
  ...
  public MergePullRequestBySquashInput repositoryName(String repositoryName) {
  ...
  public MergePullRequestBySquashInput sourceCommitId(String sourceCommitId) {
  ...
  public MergePullRequestBySquashInput conflictDetailLevel(ConflictDetailLevelTypeEnum conflictDetailLevel) {
  ...
  public MergePullRequestBySquashInput conflictResolutionStrategy(ConflictResolutionStrategyTypeEnum conflictResolutionStrategy) {
  ...
  public MergePullRequestBySquashInput commitMessage(String commitMessage) {
  ...
  public MergePullRequestBySquashInput authorName(String authorName) {
  ...
  public MergePullRequestBySquashInput email(String email) {
    this.email = email;
    return this;
  }
  ...
  public MergePullRequestBySquashInput keepEmptyFolders(Boolean keepEmptyFolders) {
  ...
  public MergePullRequestBySquashInput conflictResolution(CreateUnreferencedMergeCommitInputConflictResolution conflictResolution) {
  ...
  public boolean equals(Object o) {
    ...
    MergePullRequestBySquashInput mergePullRequestBySquashInput = (MergePullRequestBySquashInput) o;
    return Objects.equals(this.pullRequestId, mergePullRequestBySquashInput.pullRequestId) &&
        Objects.equals(this.repositoryName, mergePullRequestBySquashInput.repositoryName) &&
        Objects.equals(this.sourceCommitId, mergePullRequestBySquashInput.sourceCommitId) &&
        Objects.equals(this.conflictDetailLevel, mergePullRequestBySquashInput.conflictDetailLevel) &&
        Objects.equals(this.conflictResolutionStrategy, mergePullRequestBySquashInput.conflictResolutionStrategy) &&
        Objects.equals(this.commitMessage, mergePullRequestBySquashInput.commitMessage) &&
        Objects.equals(this.authorName, mergePullRequestBySquashInput.authorName) &&
        Objects.equals(this.email, mergePullRequestBySquashInput.email) &&
        Objects.equals(this.keepEmptyFolders, mergePullRequestBySquashInput.keepEmptyFolders) &&
        Objects.equals(this.conflictResolution, mergePullRequestBySquashInput.conflictResolution);
  }
  ...
  public String toString() {
    ...
    sb.append("class MergePullRequestBySquashInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MergePullRequestBySquashInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MergePullRequestBySquashInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MergePullRequestBySquashInput is not found in the empty JSON string", MergePullRequestBySquashInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MergePullRequestBySquashInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MergePullRequestBySquashInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MergePullRequestBySquashInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MergePullRequestBySquashInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MergePullRequestBySquashInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MergePullRequestBySquashInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MergePullRequestBySquashInput.class));

       return (TypeAdapter<T>) new TypeAdapter<MergePullRequestBySquashInput>() {
           @Override
           public void write(JsonWriter out, MergePullRequestBySquashInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MergePullRequestBySquashInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MergePullRequestBySquashInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MergePullRequestBySquashInput
   * @throws IOException if the JSON string is invalid with respect to MergePullRequestBySquashInput
   */
  public static MergePullRequestBySquashInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MergePullRequestBySquashInput.class);
  }

  /**
   * Convert an instance of MergePullRequestBySquashInput to an JSON string
   *
   * @return JSON string
   */
