...
public class CreateCommitInput {
  ...
  public static final String SERIALIZED_NAME_PUT_FILES = "putFiles";
  @SerializedName(SERIALIZED_NAME_PUT_FILES)
  private List putFiles;
  ...
  public CreateCommitInput repositoryName(String repositoryName) {
  ...
  public CreateCommitInput branchName(String branchName) {
  ...
  public CreateCommitInput parentCommitId(String parentCommitId) {
  ...
  public CreateCommitInput authorName(String authorName) {
  ...
  public CreateCommitInput email(String email) {
    this.email = email;
    return this;
  }
  ...
  public CreateCommitInput commitMessage(String commitMessage) {
  ...
  public CreateCommitInput keepEmptyFolders(Boolean keepEmptyFolders) {
  ...
  public CreateCommitInput putFiles(List putFiles) {
   ...
   */
  @javax.annotation.Nullable
  public List getPutFiles() {
    return putFiles;
  }

  public void setPutFiles(List putFiles) {
    this.putFiles = putFiles;
  }


  public CreateCommitInput deleteFiles(List deleteFiles) {
  ...
  public CreateCommitInput setFileModes(List setFileModes) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.repositoryName, createCommitInput.repositoryName) &&
        Objects.equals(this.branchName, createCommitInput.branchName) &&
        Objects.equals(this.parentCommitId, createCommitInput.parentCommitId) &&
        Objects.equals(this.authorName, createCommitInput.authorName) &&
        Objects.equals(this.email, createCommitInput.email) &&
        Objects.equals(this.commitMessage, createCommitInput.commitMessage) &&
        Objects.equals(this.keepEmptyFolders, createCommitInput.keepEmptyFolders) &&
        Objects.equals(this.putFiles, createCommitInput.putFiles) &&
        Objects.equals(this.deleteFiles, createCommitInput.deleteFiles) &&
        Objects.equals(this.setFileModes, createCommitInput.setFileModes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, branchName, parentCommitId, authorName, email, commitMessage, keepEmptyFolders, putFiles, deleteFiles, setFileModes);
  }
  ...
  public String toString() {
    ...
    sb.append("    putFiles: ").append(toIndentedString(putFiles)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCommitInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateCommitInput is not found in the empty JSON string", CreateCommitInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateCommitInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateCommitInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateCommitInput.openapiRequiredFields) {
      ...
      // validate the optional field `putFiles`
      if (jsonObj.get("putFiles") != null && !jsonObj.get("putFiles").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("putFiles"));
      }
