...
import org.openapitools.client.model.ReplacementTypeEnum;
...
public class ReplaceContentEntry {
  ...
  public ReplaceContentEntry() {
  }

  public ReplaceContentEntry filePath(String filePath) {
  ...
  public ReplaceContentEntry replacementType(ReplacementTypeEnum replacementType) {
  ...
  public ReplaceContentEntry content(String content) {
  ...
  public ReplaceContentEntry fileMode(FileModeTypeEnum fileMode) {
  ...
  public boolean equals(Object o) {
    ...
    ReplaceContentEntry replaceContentEntry = (ReplaceContentEntry) o;
    return Objects.equals(this.filePath, replaceContentEntry.filePath) &&
        Objects.equals(this.replacementType, replaceContentEntry.replacementType) &&
        Objects.equals(this.content, replaceContentEntry.content) &&
        Objects.equals(this.fileMode, replaceContentEntry.fileMode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(filePath, replacementType, content, fileMode);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ReplaceContentEntry {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("replacementType");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReplaceContentEntry
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReplaceContentEntry.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReplaceContentEntry is not found in the empty JSON string", ReplaceContentEntry.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReplaceContentEntry.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReplaceContentEntry` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReplaceContentEntry.openapiRequiredFields) {
      ...
      // validate the required field `replacementType`
      ReplacementTypeEnum.validateJsonElement(jsonObj.get("replacementType"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReplaceContentEntry.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReplaceContentEntry' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReplaceContentEntry> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReplaceContentEntry.class));

       return (TypeAdapter<T>) new TypeAdapter<ReplaceContentEntry>() {
           @Override
           public void write(JsonWriter out, ReplaceContentEntry value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReplaceContentEntry read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReplaceContentEntry given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReplaceContentEntry
   * @throws IOException if the JSON string is invalid with respect to ReplaceContentEntry
   */
  public static ReplaceContentEntry fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReplaceContentEntry.class);
  }

  /**
   * Convert an instance of ReplaceContentEntry to an JSON string
   *
   * @return JSON string
   */
