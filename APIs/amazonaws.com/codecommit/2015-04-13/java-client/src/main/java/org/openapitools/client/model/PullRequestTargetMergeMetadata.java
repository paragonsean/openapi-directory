...
public class PullRequestTargetMergeMetadata {
  ...
  public PullRequestTargetMergeMetadata() {
  }

  public PullRequestTargetMergeMetadata isMerged(Boolean isMerged) {
  ...
  public PullRequestTargetMergeMetadata mergedBy(String mergedBy) {
  ...
  public PullRequestTargetMergeMetadata mergeCommitId(String mergeCommitId) {
  ...
  public PullRequestTargetMergeMetadata mergeOption(MergeOptionTypeEnum mergeOption) {
  ...
  public boolean equals(Object o) {
    ...
    PullRequestTargetMergeMetadata pullRequestTargetMergeMetadata = (PullRequestTargetMergeMetadata) o;
    return Objects.equals(this.isMerged, pullRequestTargetMergeMetadata.isMerged) &&
        Objects.equals(this.mergedBy, pullRequestTargetMergeMetadata.mergedBy) &&
        Objects.equals(this.mergeCommitId, pullRequestTargetMergeMetadata.mergeCommitId) &&
        Objects.equals(this.mergeOption, pullRequestTargetMergeMetadata.mergeOption);
  }
  ...
  public String toString() {
    ...
    sb.append("class PullRequestTargetMergeMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PullRequestTargetMergeMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PullRequestTargetMergeMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PullRequestTargetMergeMetadata is not found in the empty JSON string", PullRequestTargetMergeMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PullRequestTargetMergeMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PullRequestTargetMergeMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PullRequestTargetMergeMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PullRequestTargetMergeMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PullRequestTargetMergeMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PullRequestTargetMergeMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<PullRequestTargetMergeMetadata>() {
           @Override
           public void write(JsonWriter out, PullRequestTargetMergeMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PullRequestTargetMergeMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PullRequestTargetMergeMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PullRequestTargetMergeMetadata
   * @throws IOException if the JSON string is invalid with respect to PullRequestTargetMergeMetadata
   */
  public static PullRequestTargetMergeMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PullRequestTargetMergeMetadata.class);
  }

  /**
   * Convert an instance of PullRequestTargetMergeMetadata to an JSON string
   *
   * @return JSON string
   */
