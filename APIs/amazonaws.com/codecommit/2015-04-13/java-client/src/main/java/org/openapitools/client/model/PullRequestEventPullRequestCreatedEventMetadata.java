...
public class PullRequestEventPullRequestCreatedEventMetadata {
  ...
  public PullRequestEventPullRequestCreatedEventMetadata() {
  }

  public PullRequestEventPullRequestCreatedEventMetadata repositoryName(String repositoryName) {
  ...
  public PullRequestEventPullRequestCreatedEventMetadata sourceCommitId(String sourceCommitId) {
  ...
  public PullRequestEventPullRequestCreatedEventMetadata destinationCommitId(String destinationCommitId) {
  ...
  public PullRequestEventPullRequestCreatedEventMetadata mergeBase(String mergeBase) {
  ...
  public boolean equals(Object o) {
    ...
    PullRequestEventPullRequestCreatedEventMetadata pullRequestEventPullRequestCreatedEventMetadata = (PullRequestEventPullRequestCreatedEventMetadata) o;
    return Objects.equals(this.repositoryName, pullRequestEventPullRequestCreatedEventMetadata.repositoryName) &&
        Objects.equals(this.sourceCommitId, pullRequestEventPullRequestCreatedEventMetadata.sourceCommitId) &&
        Objects.equals(this.destinationCommitId, pullRequestEventPullRequestCreatedEventMetadata.destinationCommitId) &&
        Objects.equals(this.mergeBase, pullRequestEventPullRequestCreatedEventMetadata.mergeBase);
  }
  ...
  public String toString() {
    ...
    sb.append("class PullRequestEventPullRequestCreatedEventMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PullRequestEventPullRequestCreatedEventMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PullRequestEventPullRequestCreatedEventMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PullRequestEventPullRequestCreatedEventMetadata is not found in the empty JSON string", PullRequestEventPullRequestCreatedEventMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PullRequestEventPullRequestCreatedEventMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PullRequestEventPullRequestCreatedEventMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PullRequestEventPullRequestCreatedEventMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PullRequestEventPullRequestCreatedEventMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PullRequestEventPullRequestCreatedEventMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PullRequestEventPullRequestCreatedEventMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<PullRequestEventPullRequestCreatedEventMetadata>() {
           @Override
           public void write(JsonWriter out, PullRequestEventPullRequestCreatedEventMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PullRequestEventPullRequestCreatedEventMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PullRequestEventPullRequestCreatedEventMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PullRequestEventPullRequestCreatedEventMetadata
   * @throws IOException if the JSON string is invalid with respect to PullRequestEventPullRequestCreatedEventMetadata
   */
  public static PullRequestEventPullRequestCreatedEventMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PullRequestEventPullRequestCreatedEventMetadata.class);
  }

  /**
   * Convert an instance of PullRequestEventPullRequestCreatedEventMetadata to an JSON string
   *
   * @return JSON string
   */
