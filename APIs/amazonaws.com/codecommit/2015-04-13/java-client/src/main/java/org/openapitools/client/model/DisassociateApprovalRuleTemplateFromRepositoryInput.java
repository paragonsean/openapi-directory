...
public class DisassociateApprovalRuleTemplateFromRepositoryInput {
  ...
  public DisassociateApprovalRuleTemplateFromRepositoryInput() {
  }

  public DisassociateApprovalRuleTemplateFromRepositoryInput approvalRuleTemplateName(String approvalRuleTemplateName) {
  ...
  public DisassociateApprovalRuleTemplateFromRepositoryInput repositoryName(String repositoryName) {
  ...
  public boolean equals(Object o) {
    ...
    DisassociateApprovalRuleTemplateFromRepositoryInput disassociateApprovalRuleTemplateFromRepositoryInput = (DisassociateApprovalRuleTemplateFromRepositoryInput) o;
    return Objects.equals(this.approvalRuleTemplateName, disassociateApprovalRuleTemplateFromRepositoryInput.approvalRuleTemplateName) &&
        Objects.equals(this.repositoryName, disassociateApprovalRuleTemplateFromRepositoryInput.repositoryName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(approvalRuleTemplateName, repositoryName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DisassociateApprovalRuleTemplateFromRepositoryInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisassociateApprovalRuleTemplateFromRepositoryInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisassociateApprovalRuleTemplateFromRepositoryInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisassociateApprovalRuleTemplateFromRepositoryInput is not found in the empty JSON string", DisassociateApprovalRuleTemplateFromRepositoryInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisassociateApprovalRuleTemplateFromRepositoryInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisassociateApprovalRuleTemplateFromRepositoryInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DisassociateApprovalRuleTemplateFromRepositoryInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisassociateApprovalRuleTemplateFromRepositoryInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisassociateApprovalRuleTemplateFromRepositoryInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisassociateApprovalRuleTemplateFromRepositoryInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisassociateApprovalRuleTemplateFromRepositoryInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DisassociateApprovalRuleTemplateFromRepositoryInput>() {
           @Override
           public void write(JsonWriter out, DisassociateApprovalRuleTemplateFromRepositoryInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisassociateApprovalRuleTemplateFromRepositoryInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisassociateApprovalRuleTemplateFromRepositoryInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisassociateApprovalRuleTemplateFromRepositoryInput
   * @throws IOException if the JSON string is invalid with respect to DisassociateApprovalRuleTemplateFromRepositoryInput
   */
  public static DisassociateApprovalRuleTemplateFromRepositoryInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisassociateApprovalRuleTemplateFromRepositoryInput.class);
  }

  /**
   * Convert an instance of DisassociateApprovalRuleTemplateFromRepositoryInput to an JSON string
   *
   * @return JSON string
   */
