...
public class CreateCommitOutput {
  ...
  public static final String SERIALIZED_NAME_FILES_UPDATED = "filesUpdated";
  @SerializedName(SERIALIZED_NAME_FILES_UPDATED)
  private List filesUpdated;

  public static final String SERIALIZED_NAME_FILES_DELETED = "filesDeleted";
  @SerializedName(SERIALIZED_NAME_FILES_DELETED)
  private List filesDeleted;

  public CreateCommitOutput() {
  }

  public CreateCommitOutput commitId(String commitId) {
  ...
  public CreateCommitOutput treeId(String treeId) {
    this.treeId = treeId;
    return this;
  }
  ...
  public CreateCommitOutput filesAdded(List filesAdded) {
  ...
  public CreateCommitOutput filesUpdated(List filesUpdated) {
   ...
   */
  @javax.annotation.Nullable
  public List getFilesUpdated() {
    return filesUpdated;
  }

  public void setFilesUpdated(List filesUpdated) {
    this.filesUpdated = filesUpdated;
  }


  public CreateCommitOutput filesDeleted(List filesDeleted) {
   ...
   */
  @javax.annotation.Nullable
  public List getFilesDeleted() {
    return filesDeleted;
  }

  public void setFilesDeleted(List filesDeleted) {
    this.filesDeleted = filesDeleted;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateCommitOutput createCommitOutput = (CreateCommitOutput) o;
    return Objects.equals(this.commitId, createCommitOutput.commitId) &&
        Objects.equals(this.treeId, createCommitOutput.treeId) &&
        Objects.equals(this.filesAdded, createCommitOutput.filesAdded) &&
        Objects.equals(this.filesUpdated, createCommitOutput.filesUpdated) &&
        Objects.equals(this.filesDeleted, createCommitOutput.filesDeleted);
  }

  @Override
  public int hashCode() {
    return Objects.hash(commitId, treeId, filesAdded, filesUpdated, filesDeleted);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateCommitOutput {\n");
    ...
    sb.append("    filesUpdated: ").append(toIndentedString(filesUpdated)).append("\n");
    sb.append("    filesDeleted: ").append(toIndentedString(filesDeleted)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("filesUpdated");
    openapiFields.add("filesDeleted");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateCommitOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCommitOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateCommitOutput is not found in the empty JSON string", CreateCommitOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateCommitOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateCommitOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("filesAdded") != null && !jsonObj.get("filesAdded").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("filesAdded"));
      }
      // validate the optional field `filesUpdated`
      if (jsonObj.get("filesUpdated") != null && !jsonObj.get("filesUpdated").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("filesUpdated"));
      }
      // validate the optional field `filesDeleted`
      if (jsonObj.get("filesDeleted") != null && !jsonObj.get("filesDeleted").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("filesDeleted"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateCommitOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateCommitOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateCommitOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateCommitOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateCommitOutput>() {
           @Override
           public void write(JsonWriter out, CreateCommitOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateCommitOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateCommitOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateCommitOutput
   * @throws IOException if the JSON string is invalid with respect to CreateCommitOutput
   */
  public static CreateCommitOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCommitOutput.class);
  }

  /**
   * Convert an instance of CreateCommitOutput to an JSON string
   *
   * @return JSON string
   */
