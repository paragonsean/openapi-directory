...
import org.openapitools.client.model.GetBranchOutputBranch;
...
public class GetBranchOutput {
  ...
  private GetBranchOutputBranch branch;

  public GetBranchOutput() {
  }

  public GetBranchOutput branch(GetBranchOutputBranch branch) {
    this.branch = branch;
    return this;
  }
  ...
  public GetBranchOutputBranch getBranch() {
    return branch;
  }

  public void setBranch(GetBranchOutputBranch branch) {
    this.branch = branch;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetBranchOutput getBranchOutput = (GetBranchOutput) o;
    return Objects.equals(this.branch, getBranchOutput.branch);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetBranchOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetBranchOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetBranchOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetBranchOutput is not found in the empty JSON string", GetBranchOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetBranchOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetBranchOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `branch`
      if (jsonObj.get("branch") != null && !jsonObj.get("branch").isJsonNull()) {
        GetBranchOutputBranch.validateJsonElement(jsonObj.get("branch"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetBranchOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetBranchOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetBranchOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetBranchOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetBranchOutput>() {
           @Override
           public void write(JsonWriter out, GetBranchOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetBranchOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetBranchOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetBranchOutput
   * @throws IOException if the JSON string is invalid with respect to GetBranchOutput
   */
  public static GetBranchOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetBranchOutput.class);
  }

  /**
   * Convert an instance of GetBranchOutput to an JSON string
   *
   * @return JSON string
   */
