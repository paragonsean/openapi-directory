...
import org.openapitools.client.model.DescribeMergeConflictsOutputConflictMetadata;
...
public class DescribeMergeConflictsOutput {
  public static final String SERIALIZED_NAME_CONFLICT_METADATA = "conflictMetadata";
  @SerializedName(SERIALIZED_NAME_CONFLICT_METADATA)
  private DescribeMergeConflictsOutputConflictMetadata conflictMetadata;

  public static final String SERIALIZED_NAME_MERGE_HUNKS = "mergeHunks";
  @SerializedName(SERIALIZED_NAME_MERGE_HUNKS)
  private List mergeHunks;
  ...
  public DescribeMergeConflictsOutput() {
  }

  public DescribeMergeConflictsOutput conflictMetadata(DescribeMergeConflictsOutputConflictMetadata conflictMetadata) {
    this.conflictMetadata = conflictMetadata;
    return this;
  }

  /**
   * Get conflictMetadata
   * @return conflictMetadata
   */
  @javax.annotation.Nonnull
  public DescribeMergeConflictsOutputConflictMetadata getConflictMetadata() {
    return conflictMetadata;
  }

  public void setConflictMetadata(DescribeMergeConflictsOutputConflictMetadata conflictMetadata) {
    this.conflictMetadata = conflictMetadata;
  }


  public DescribeMergeConflictsOutput mergeHunks(List mergeHunks) {
   ...
   */
  @javax.annotation.Nonnull
  public List getMergeHunks() {
    return mergeHunks;
  }

  public void setMergeHunks(List mergeHunks) {
    this.mergeHunks = mergeHunks;
  }


  public DescribeMergeConflictsOutput nextToken(String nextToken) {
  ...
  public DescribeMergeConflictsOutput destinationCommitId(String destinationCommitId) {
  ...
  public DescribeMergeConflictsOutput sourceCommitId(String sourceCommitId) {
  ...
  public DescribeMergeConflictsOutput baseCommitId(String baseCommitId) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeMergeConflictsOutput describeMergeConflictsOutput = (DescribeMergeConflictsOutput) o;
    return Objects.equals(this.conflictMetadata, describeMergeConflictsOutput.conflictMetadata) &&
        Objects.equals(this.mergeHunks, describeMergeConflictsOutput.mergeHunks) &&
        Objects.equals(this.nextToken, describeMergeConflictsOutput.nextToken) &&
        Objects.equals(this.destinationCommitId, describeMergeConflictsOutput.destinationCommitId) &&
        Objects.equals(this.sourceCommitId, describeMergeConflictsOutput.sourceCommitId) &&
        Objects.equals(this.baseCommitId, describeMergeConflictsOutput.baseCommitId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(conflictMetadata, mergeHunks, nextToken, destinationCommitId, sourceCommitId, baseCommitId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeMergeConflictsOutput {\n");
    sb.append("    conflictMetadata: ").append(toIndentedString(conflictMetadata)).append("\n");
    sb.append("    mergeHunks: ").append(toIndentedString(mergeHunks)).append("\n");
  ...
  static {
    ...
    openapiFields.add("conflictMetadata");
    openapiFields.add("mergeHunks");
    ...
    openapiRequiredFields.add("conflictMetadata");
    openapiRequiredFields.add("mergeHunks");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeMergeConflictsOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeMergeConflictsOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeMergeConflictsOutput is not found in the empty JSON string", DescribeMergeConflictsOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeMergeConflictsOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeMergeConflictsOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeMergeConflictsOutput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `conflictMetadata`
      DescribeMergeConflictsOutputConflictMetadata.validateJsonElement(jsonObj.get("conflictMetadata"));
      // validate the required field `mergeHunks`
      List.validateJsonElement(jsonObj.get("mergeHunks"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeMergeConflictsOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeMergeConflictsOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeMergeConflictsOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeMergeConflictsOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeMergeConflictsOutput>() {
           @Override
           public void write(JsonWriter out, DescribeMergeConflictsOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeMergeConflictsOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeMergeConflictsOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeMergeConflictsOutput
   * @throws IOException if the JSON string is invalid with respect to DescribeMergeConflictsOutput
   */
  public static DescribeMergeConflictsOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeMergeConflictsOutput.class);
  }

  /**
   * Convert an instance of DescribeMergeConflictsOutput to an JSON string
   *
   * @return JSON string
   */
