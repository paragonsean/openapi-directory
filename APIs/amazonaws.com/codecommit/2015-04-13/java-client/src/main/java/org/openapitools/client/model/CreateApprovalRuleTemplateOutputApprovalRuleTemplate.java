...
public class CreateApprovalRuleTemplateOutputApprovalRuleTemplate {
  ...
  public CreateApprovalRuleTemplateOutputApprovalRuleTemplate() {
  }

  public CreateApprovalRuleTemplateOutputApprovalRuleTemplate approvalRuleTemplateId(String approvalRuleTemplateId) {
  ...
  public CreateApprovalRuleTemplateOutputApprovalRuleTemplate approvalRuleTemplateName(String approvalRuleTemplateName) {
  ...
  public CreateApprovalRuleTemplateOutputApprovalRuleTemplate approvalRuleTemplateDescription(String approvalRuleTemplateDescription) {
  ...
  public CreateApprovalRuleTemplateOutputApprovalRuleTemplate approvalRuleTemplateContent(String approvalRuleTemplateContent) {
  ...
  public CreateApprovalRuleTemplateOutputApprovalRuleTemplate ruleContentSha256(String ruleContentSha256) {
  ...
  public CreateApprovalRuleTemplateOutputApprovalRuleTemplate lastModifiedDate(OffsetDateTime lastModifiedDate) {
  ...
  public CreateApprovalRuleTemplateOutputApprovalRuleTemplate creationDate(OffsetDateTime creationDate) {
  ...
  public CreateApprovalRuleTemplateOutputApprovalRuleTemplate lastModifiedUser(String lastModifiedUser) {
  ...
  public boolean equals(Object o) {
    ...
    CreateApprovalRuleTemplateOutputApprovalRuleTemplate createApprovalRuleTemplateOutputApprovalRuleTemplate = (CreateApprovalRuleTemplateOutputApprovalRuleTemplate) o;
    return Objects.equals(this.approvalRuleTemplateId, createApprovalRuleTemplateOutputApprovalRuleTemplate.approvalRuleTemplateId) &&
        Objects.equals(this.approvalRuleTemplateName, createApprovalRuleTemplateOutputApprovalRuleTemplate.approvalRuleTemplateName) &&
        Objects.equals(this.approvalRuleTemplateDescription, createApprovalRuleTemplateOutputApprovalRuleTemplate.approvalRuleTemplateDescription) &&
        Objects.equals(this.approvalRuleTemplateContent, createApprovalRuleTemplateOutputApprovalRuleTemplate.approvalRuleTemplateContent) &&
        Objects.equals(this.ruleContentSha256, createApprovalRuleTemplateOutputApprovalRuleTemplate.ruleContentSha256) &&
        Objects.equals(this.lastModifiedDate, createApprovalRuleTemplateOutputApprovalRuleTemplate.lastModifiedDate) &&
        Objects.equals(this.creationDate, createApprovalRuleTemplateOutputApprovalRuleTemplate.creationDate) &&
        Objects.equals(this.lastModifiedUser, createApprovalRuleTemplateOutputApprovalRuleTemplate.lastModifiedUser);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateApprovalRuleTemplateOutputApprovalRuleTemplate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateApprovalRuleTemplateOutputApprovalRuleTemplate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateApprovalRuleTemplateOutputApprovalRuleTemplate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateApprovalRuleTemplateOutputApprovalRuleTemplate is not found in the empty JSON string", CreateApprovalRuleTemplateOutputApprovalRuleTemplate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateApprovalRuleTemplateOutputApprovalRuleTemplate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateApprovalRuleTemplateOutputApprovalRuleTemplate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateApprovalRuleTemplateOutputApprovalRuleTemplate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateApprovalRuleTemplateOutputApprovalRuleTemplate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateApprovalRuleTemplateOutputApprovalRuleTemplate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateApprovalRuleTemplateOutputApprovalRuleTemplate.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateApprovalRuleTemplateOutputApprovalRuleTemplate>() {
           @Override
           public void write(JsonWriter out, CreateApprovalRuleTemplateOutputApprovalRuleTemplate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateApprovalRuleTemplateOutputApprovalRuleTemplate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateApprovalRuleTemplateOutputApprovalRuleTemplate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateApprovalRuleTemplateOutputApprovalRuleTemplate
   * @throws IOException if the JSON string is invalid with respect to CreateApprovalRuleTemplateOutputApprovalRuleTemplate
   */
  public static CreateApprovalRuleTemplateOutputApprovalRuleTemplate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateApprovalRuleTemplateOutputApprovalRuleTemplate.class);
  }

  /**
   * Convert an instance of CreateApprovalRuleTemplateOutputApprovalRuleTemplate to an JSON string
   *
   * @return JSON string
   */
