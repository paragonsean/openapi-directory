...
public class EvaluatePullRequestApprovalRulesInput {
  ...
  public EvaluatePullRequestApprovalRulesInput() {
  }

  public EvaluatePullRequestApprovalRulesInput pullRequestId(String pullRequestId) {
  ...
  public EvaluatePullRequestApprovalRulesInput revisionId(String revisionId) {
  ...
  public boolean equals(Object o) {
    ...
    EvaluatePullRequestApprovalRulesInput evaluatePullRequestApprovalRulesInput = (EvaluatePullRequestApprovalRulesInput) o;
    return Objects.equals(this.pullRequestId, evaluatePullRequestApprovalRulesInput.pullRequestId) &&
        Objects.equals(this.revisionId, evaluatePullRequestApprovalRulesInput.revisionId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pullRequestId, revisionId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EvaluatePullRequestApprovalRulesInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EvaluatePullRequestApprovalRulesInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EvaluatePullRequestApprovalRulesInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EvaluatePullRequestApprovalRulesInput is not found in the empty JSON string", EvaluatePullRequestApprovalRulesInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EvaluatePullRequestApprovalRulesInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EvaluatePullRequestApprovalRulesInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EvaluatePullRequestApprovalRulesInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EvaluatePullRequestApprovalRulesInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EvaluatePullRequestApprovalRulesInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EvaluatePullRequestApprovalRulesInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EvaluatePullRequestApprovalRulesInput.class));

       return (TypeAdapter<T>) new TypeAdapter<EvaluatePullRequestApprovalRulesInput>() {
           @Override
           public void write(JsonWriter out, EvaluatePullRequestApprovalRulesInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EvaluatePullRequestApprovalRulesInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EvaluatePullRequestApprovalRulesInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EvaluatePullRequestApprovalRulesInput
   * @throws IOException if the JSON string is invalid with respect to EvaluatePullRequestApprovalRulesInput
   */
  public static EvaluatePullRequestApprovalRulesInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EvaluatePullRequestApprovalRulesInput.class);
  }

  /**
   * Convert an instance of EvaluatePullRequestApprovalRulesInput to an JSON string
   *
   * @return JSON string
   */
