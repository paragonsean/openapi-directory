...
class Example : public QObject {
    Q_OBJECT
    QString create();
    OAIAssociateApprovalRuleTemplateWithRepositoryInput create();
    QString create();
    QString create();
    QString create();
    QString create();
...
QString Example::create(){
    QString obj;
OAIAssociateApprovalRuleTemplateWithRepositoryInput Example::create(){
    OAIAssociateApprovalRuleTemplateWithRepositoryInput obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::associateApprovalRuleTemplateWithRepositorySignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::associateApprovalRuleTemplateWithRepositorySignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAIAssociateApprovalRuleTemplateWithRepositoryInput oai_associate_approval_rule_template_with_repository_input = create(); // OAIAssociateApprovalRuleTemplateWithRepositoryInput | 
      ...
      apiInstance.associateApprovalRuleTemplateWithRepository(x_amz_targetoai_associate_approval_rule_template_with_repository_inputx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
