...
/*
 * OAIConflictResolution.h
 *
 * If AUTOMERGE is the conflict resolution strategy, a list of inputs to use when resolving conflicts during a merge.
 */

#ifndef OAIConflictResolution_H
#define OAIConflictResolution_H
...
class OAIConflictResolution : public OAIObject {
public:
    OAIConflictResolution();
    OAIConflictResolution(QString json);
    ~OAIConflictResolution() override;
    ...
    QList getReplaceContents() const;
    void setReplaceContents(const QList &replace_contents);
    bool is_replace_contents_Set() const;
    bool is_replace_contents_Valid() const;

    QList getDeleteFiles() const;
    void setDeleteFiles(const QList &delete_files);
    bool is_delete_files_Set() const;
    bool is_delete_files_Valid() const;

    QList getSetFileModes() const;
    void setSetFileModes(const QList &set_file_modes);
    bool is_set_file_modes_Set() const;
    bool is_set_file_modes_Valid() const;
...
private:
    ...
    QList m_replace_contents;
    bool m_replace_contents_isSet;
    bool m_replace_contents_isValid;

    QList m_delete_files;
    bool m_delete_files_isSet;
    bool m_delete_files_isValid;

    QList m_set_file_modes;
    bool m_set_file_modes_isSet;
    bool m_set_file_modes_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIConflictResolution)

#endif // OAIConflictResolution_H
