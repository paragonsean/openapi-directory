...
/*
 * OAICreatePullRequestOutput_pullRequest.h
 *
 * 
 */

#ifndef OAICreatePullRequestOutput_pullRequest_H
#define OAICreatePullRequestOutput_pullRequest_H
...
class OAICreatePullRequestOutput_pullRequest : public OAIObject {
public:
    OAICreatePullRequestOutput_pullRequest();
    OAICreatePullRequestOutput_pullRequest(QString json);
    ~OAICreatePullRequestOutput_pullRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePullRequestOutput_pullRequest)

#endif // OAICreatePullRequestOutput_pullRequest_H
