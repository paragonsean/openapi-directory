...
/*
 * OAIListBranchesInput.h
 *
 * Represents the input of a list branches operation.
 */

#ifndef OAIListBranchesInput_H
#define OAIListBranchesInput_H
...
class OAIListBranchesInput : public OAIObject {
public:
    OAIListBranchesInput();
    OAIListBranchesInput(QString json);
    ~OAIListBranchesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListBranchesInput)

#endif // OAIListBranchesInput_H
