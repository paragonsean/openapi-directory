...
/*
 * OAIConflictMetadata_isBinaryFile.h
 *
 * 
 */

#ifndef OAIConflictMetadata_isBinaryFile_H
#define OAIConflictMetadata_isBinaryFile_H
...
class OAIConflictMetadata_isBinaryFile : public OAIObject {
public:
    OAIConflictMetadata_isBinaryFile();
    OAIConflictMetadata_isBinaryFile(QString json);
    ~OAIConflictMetadata_isBinaryFile() override;
    ...
    void setSource(const bool &source);
    bool is_source_Set() const;
    bool is_source_Valid() const;

    bool getDestination() const;
    void setDestination(const bool &destination);
...
Q_DECLARE_METATYPE(OpenAPI::OAIConflictMetadata_isBinaryFile)

#endif // OAIConflictMetadata_isBinaryFile_H
