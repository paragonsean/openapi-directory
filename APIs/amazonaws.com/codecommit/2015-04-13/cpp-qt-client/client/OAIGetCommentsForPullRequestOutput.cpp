...
OAIGetCommentsForPullRequestOutput::OAIGetCommentsForPullRequestOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetCommentsForPullRequestOutput::OAIGetCommentsForPullRequestOutput() {
    this->initializeModel();
}

OAIGetCommentsForPullRequestOutput::~OAIGetCommentsForPullRequestOutput() {}

void OAIGetCommentsForPullRequestOutput::initializeModel() {

    m_comments_for_pull_request_data_isSet = false;
    m_comments_for_pull_request_data_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIGetCommentsForPullRequestOutput::fromJson(QString jsonString) {
...
void OAIGetCommentsForPullRequestOutput::fromJsonObject(QJsonObject json) {

    m_comments_for_pull_request_data_isValid = ::OpenAPI::fromJsonValue(m_comments_for_pull_request_data, json[QString("commentsForPullRequestData")]);
    m_comments_for_pull_request_data_isSet = !json[QString("commentsForPullRequestData")].isNull() && m_comments_for_pull_request_data_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("nextToken")]);
    m_next_token_isSet = !json[QString("nextToken")].isNull() && m_next_token_isValid;
}

QString OAIGetCommentsForPullRequestOutput::asJson() const {
...
QJsonObject OAIGetCommentsForPullRequestOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_comments_for_pull_request_data.isSet()) {
        obj.insert(QString("commentsForPullRequestData"), ::OpenAPI::toJsonValue(m_comments_for_pull_request_data));
    }
...
QList OAIGetCommentsForPullRequestOutput::getCommentsForPullRequestData() const {
    return m_comments_for_pull_request_data;
}
void OAIGetCommentsForPullRequestOutput::setCommentsForPullRequestData(const QList &comments_for_pull_request_data) {
    m_comments_for_pull_request_data = comments_for_pull_request_data;
    m_comments_for_pull_request_data_isSet = true;
}

bool OAIGetCommentsForPullRequestOutput::is_comments_for_pull_request_data_Set() const{
    return m_comments_for_pull_request_data_isSet;
}

bool OAIGetCommentsForPullRequestOutput::is_comments_for_pull_request_data_Valid() const{
    return m_comments_for_pull_request_data_isValid;
}

QString OAIGetCommentsForPullRequestOutput::getNextToken() const {
    return m_next_token;
}
void OAIGetCommentsForPullRequestOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIGetCommentsForPullRequestOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIGetCommentsForPullRequestOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIGetCommentsForPullRequestOutput::isSet() const {
...
bool OAIGetCommentsForPullRequestOutput::isValid() const {
