...
OAITestRepositoryTriggersOutput::OAITestRepositoryTriggersOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITestRepositoryTriggersOutput::OAITestRepositoryTriggersOutput() {
    this->initializeModel();
}

OAITestRepositoryTriggersOutput::~OAITestRepositoryTriggersOutput() {}

void OAITestRepositoryTriggersOutput::initializeModel() {

    m_successful_executions_isSet = false;
    m_successful_executions_isValid = false;

    m_failed_executions_isSet = false;
    m_failed_executions_isValid = false;
}

void OAITestRepositoryTriggersOutput::fromJson(QString jsonString) {
...
void OAITestRepositoryTriggersOutput::fromJsonObject(QJsonObject json) {

    m_successful_executions_isValid = ::OpenAPI::fromJsonValue(m_successful_executions, json[QString("successfulExecutions")]);
    m_successful_executions_isSet = !json[QString("successfulExecutions")].isNull() && m_successful_executions_isValid;
...
QString OAITestRepositoryTriggersOutput::asJson() const {
...
QJsonObject OAITestRepositoryTriggersOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_successful_executions.isSet()) {
        obj.insert(QString("successfulExecutions"), ::OpenAPI::toJsonValue(m_successful_executions));
    }
    if (m_failed_executions.isSet()) {
        obj.insert(QString("failedExecutions"), ::OpenAPI::toJsonValue(m_failed_executions));
    }
    return obj;
}

QList OAITestRepositoryTriggersOutput::getSuccessfulExecutions() const {
    return m_successful_executions;
}
void OAITestRepositoryTriggersOutput::setSuccessfulExecutions(const QList &successful_executions) {
    m_successful_executions = successful_executions;
    m_successful_executions_isSet = true;
}

bool OAITestRepositoryTriggersOutput::is_successful_executions_Set() const{
    return m_successful_executions_isSet;
}

bool OAITestRepositoryTriggersOutput::is_successful_executions_Valid() const{
    return m_successful_executions_isValid;
}

QList OAITestRepositoryTriggersOutput::getFailedExecutions() const {
    return m_failed_executions;
}
void OAITestRepositoryTriggersOutput::setFailedExecutions(const QList &failed_executions) {
    m_failed_executions = failed_executions;
    m_failed_executions_isSet = true;
}

bool OAITestRepositoryTriggersOutput::is_failed_executions_Set() const{
    return m_failed_executions_isSet;
}

bool OAITestRepositoryTriggersOutput::is_failed_executions_Valid() const{
    return m_failed_executions_isValid;
}

bool OAITestRepositoryTriggersOutput::isSet() const {
...
bool OAITestRepositoryTriggersOutput::isValid() const {
