...
OAIBatchDescribeMergeConflictsOutput::OAIBatchDescribeMergeConflictsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchDescribeMergeConflictsOutput::OAIBatchDescribeMergeConflictsOutput() {
    this->initializeModel();
}

OAIBatchDescribeMergeConflictsOutput::~OAIBatchDescribeMergeConflictsOutput() {}

void OAIBatchDescribeMergeConflictsOutput::initializeModel() {

    m_conflicts_isSet = false;
    m_conflicts_isValid = false;
...
void OAIBatchDescribeMergeConflictsOutput::fromJson(QString jsonString) {
...
void OAIBatchDescribeMergeConflictsOutput::fromJsonObject(QJsonObject json) {

    m_conflicts_isValid = ::OpenAPI::fromJsonValue(m_conflicts, json[QString("conflicts")]);
    m_conflicts_isSet = !json[QString("conflicts")].isNull() && m_conflicts_isValid;
...
QString OAIBatchDescribeMergeConflictsOutput::asJson() const {
...
QJsonObject OAIBatchDescribeMergeConflictsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_conflicts.isSet()) {
        obj.insert(QString("conflicts"), ::OpenAPI::toJsonValue(m_conflicts));
    }
...
QList OAIBatchDescribeMergeConflictsOutput::getConflicts() const {
    return m_conflicts;
}
void OAIBatchDescribeMergeConflictsOutput::setConflicts(const QList &conflicts) {
    m_conflicts = conflicts;
    m_conflicts_isSet = true;
}

bool OAIBatchDescribeMergeConflictsOutput::is_conflicts_Set() const{
    return m_conflicts_isSet;
}

bool OAIBatchDescribeMergeConflictsOutput::is_conflicts_Valid() const{
    return m_conflicts_isValid;
}

QString OAIBatchDescribeMergeConflictsOutput::getNextToken() const {
    return m_next_token;
}
void OAIBatchDescribeMergeConflictsOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIBatchDescribeMergeConflictsOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIBatchDescribeMergeConflictsOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAIBatchDescribeMergeConflictsOutput::getErrors() const {
    return m_errors;
}
void OAIBatchDescribeMergeConflictsOutput::setErrors(const QList &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIBatchDescribeMergeConflictsOutput::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIBatchDescribeMergeConflictsOutput::is_errors_Valid() const{
    return m_errors_isValid;
}

QString OAIBatchDescribeMergeConflictsOutput::getDestinationCommitId() const {
    return m_destination_commit_id;
}
void OAIBatchDescribeMergeConflictsOutput::setDestinationCommitId(const QString &destination_commit_id) {
    m_destination_commit_id = destination_commit_id;
    m_destination_commit_id_isSet = true;
}

bool OAIBatchDescribeMergeConflictsOutput::is_destination_commit_id_Set() const{
    return m_destination_commit_id_isSet;
}

bool OAIBatchDescribeMergeConflictsOutput::is_destination_commit_id_Valid() const{
    return m_destination_commit_id_isValid;
}

QString OAIBatchDescribeMergeConflictsOutput::getSourceCommitId() const {
    return m_source_commit_id;
}
void OAIBatchDescribeMergeConflictsOutput::setSourceCommitId(const QString &source_commit_id) {
    m_source_commit_id = source_commit_id;
    m_source_commit_id_isSet = true;
}

bool OAIBatchDescribeMergeConflictsOutput::is_source_commit_id_Set() const{
    return m_source_commit_id_isSet;
}

bool OAIBatchDescribeMergeConflictsOutput::is_source_commit_id_Valid() const{
    return m_source_commit_id_isValid;
}

QString OAIBatchDescribeMergeConflictsOutput::getBaseCommitId() const {
    return m_base_commit_id;
}
void OAIBatchDescribeMergeConflictsOutput::setBaseCommitId(const QString &base_commit_id) {
    m_base_commit_id = base_commit_id;
    m_base_commit_id_isSet = true;
}

bool OAIBatchDescribeMergeConflictsOutput::is_base_commit_id_Set() const{
    return m_base_commit_id_isSet;
}

bool OAIBatchDescribeMergeConflictsOutput::is_base_commit_id_Valid() const{
    return m_base_commit_id_isValid;
}

bool OAIBatchDescribeMergeConflictsOutput::isSet() const {
...
bool OAIBatchDescribeMergeConflictsOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_conflicts_isValid && m_destination_commit_id_isValid && m_source_commit_id_isValid && true;
}
