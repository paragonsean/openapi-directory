...
OAICreatePullRequestInput::OAICreatePullRequestInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreatePullRequestInput::OAICreatePullRequestInput() {
    this->initializeModel();
}

OAICreatePullRequestInput::~OAICreatePullRequestInput() {}

void OAICreatePullRequestInput::initializeModel() {
...
void OAICreatePullRequestInput::fromJson(QString jsonString) {
...
void OAICreatePullRequestInput::fromJsonObject(QJsonObject json) {
...
QString OAICreatePullRequestInput::asJson() const {
...
QJsonObject OAICreatePullRequestInput::asJsonObject() const {
    QJsonObject obj;
    if (m_title_isSet) {
...
QString OAICreatePullRequestInput::getTitle() const {
    return m_title;
}
void OAICreatePullRequestInput::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAICreatePullRequestInput::is_title_Set() const{
    return m_title_isSet;
}

bool OAICreatePullRequestInput::is_title_Valid() const{
    return m_title_isValid;
}

QString OAICreatePullRequestInput::getDescription() const {
    return m_description;
}
void OAICreatePullRequestInput::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreatePullRequestInput::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreatePullRequestInput::is_description_Valid() const{
    return m_description_isValid;
}

QList OAICreatePullRequestInput::getTargets() const {
    return m_targets;
}
void OAICreatePullRequestInput::setTargets(const QList &targets) {
    m_targets = targets;
    m_targets_isSet = true;
}

bool OAICreatePullRequestInput::is_targets_Set() const{
    return m_targets_isSet;
}

bool OAICreatePullRequestInput::is_targets_Valid() const{
    return m_targets_isValid;
}

QString OAICreatePullRequestInput::getClientRequestToken() const {
    return m_client_request_token;
}
void OAICreatePullRequestInput::setClientRequestToken(const QString &client_request_token) {
    m_client_request_token = client_request_token;
    m_client_request_token_isSet = true;
}

bool OAICreatePullRequestInput::is_client_request_token_Set() const{
    return m_client_request_token_isSet;
}

bool OAICreatePullRequestInput::is_client_request_token_Valid() const{
    return m_client_request_token_isValid;
}

bool OAICreatePullRequestInput::isSet() const {
...
bool OAICreatePullRequestInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_title_isValid && m_targets_isValid && true;
}
