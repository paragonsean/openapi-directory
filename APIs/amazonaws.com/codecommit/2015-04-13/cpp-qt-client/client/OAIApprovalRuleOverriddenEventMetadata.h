...
/*
 * OAIApprovalRuleOverriddenEventMetadata.h
 *
 * Returns information about an override event for approval rules for a pull request.
 */

#ifndef OAIApprovalRuleOverriddenEventMetadata_H
#define OAIApprovalRuleOverriddenEventMetadata_H
...
class OAIApprovalRuleOverriddenEventMetadata : public OAIObject {
public:
    OAIApprovalRuleOverriddenEventMetadata();
    OAIApprovalRuleOverriddenEventMetadata(QString json);
    ~OAIApprovalRuleOverriddenEventMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApprovalRuleOverriddenEventMetadata)

#endif // OAIApprovalRuleOverriddenEventMetadata_H
