...
/*
 * OAIPullRequestEvent_approvalRuleEventMetadata.h
 *
 * 
 */

#ifndef OAIPullRequestEvent_approvalRuleEventMetadata_H
#define OAIPullRequestEvent_approvalRuleEventMetadata_H
...
class OAIPullRequestEvent_approvalRuleEventMetadata : public OAIObject {
public:
    OAIPullRequestEvent_approvalRuleEventMetadata();
    OAIPullRequestEvent_approvalRuleEventMetadata(QString json);
    ~OAIPullRequestEvent_approvalRuleEventMetadata() override;
    ...
    QString getApprovalRuleName() const;
    void setApprovalRuleName(const QString &approval_rule_name);
    bool is_approval_rule_name_Set() const;
    bool is_approval_rule_name_Valid() const;

    QString getApprovalRuleId() const;
    void setApprovalRuleId(const QString &approval_rule_id);
    bool is_approval_rule_id_Set() const;
    bool is_approval_rule_id_Valid() const;

    QString getApprovalRuleContent() const;
    void setApprovalRuleContent(const QString &approval_rule_content);
    bool is_approval_rule_content_Set() const;
    bool is_approval_rule_content_Valid() const;
...
private:
    ...
    QString m_approval_rule_name;
    bool m_approval_rule_name_isSet;
    bool m_approval_rule_name_isValid;

    QString m_approval_rule_id;
    bool m_approval_rule_id_isSet;
    bool m_approval_rule_id_isValid;

    QString m_approval_rule_content;
    bool m_approval_rule_content_isSet;
    bool m_approval_rule_content_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPullRequestEvent_approvalRuleEventMetadata)

#endif // OAIPullRequestEvent_approvalRuleEventMetadata_H
