...
OAIUpdateCommentOutput::OAIUpdateCommentOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateCommentOutput::OAIUpdateCommentOutput() {
    this->initializeModel();
}

OAIUpdateCommentOutput::~OAIUpdateCommentOutput() {}

void OAIUpdateCommentOutput::initializeModel() {

    m_comment_isSet = false;
    m_comment_isValid = false;
}

void OAIUpdateCommentOutput::fromJson(QString jsonString) {
...
void OAIUpdateCommentOutput::fromJsonObject(QJsonObject json) {

    m_comment_isValid = ::OpenAPI::fromJsonValue(m_comment, json[QString("comment")]);
    m_comment_isSet = !json[QString("comment")].isNull() && m_comment_isValid;
}

QString OAIUpdateCommentOutput::asJson() const {
...
QJsonObject OAIUpdateCommentOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_comment.isSet()) {
...
OAIUpdateCommentOutput_comment OAIUpdateCommentOutput::getComment() const {
    return m_comment;
}
void OAIUpdateCommentOutput::setComment(const OAIUpdateCommentOutput_comment &comment) {
    m_comment = comment;
    m_comment_isSet = true;
}

bool OAIUpdateCommentOutput::is_comment_Set() const{
    return m_comment_isSet;
}

bool OAIUpdateCommentOutput::is_comment_Valid() const{
    return m_comment_isValid;
}

bool OAIUpdateCommentOutput::isSet() const {
...
bool OAIUpdateCommentOutput::isValid() const {
