...
OAISortByEnum OAIListRepositoriesInput::getSortBy() const {
    return m_sort_by;
}
void OAIListRepositoriesInput::setSortBy(const OAISortByEnum &sort_by) {
    m_sort_by = sort_by;
    m_sort_by_isSet = true;
}

bool OAIListRepositoriesInput::is_sort_by_Set() const{
    return m_sort_by_isSet;
}

bool OAIListRepositoriesInput::is_sort_by_Valid() const{
    return m_sort_by_isValid;
}

OAIOrderEnum OAIListRepositoriesInput::getOrder() const {
    return m_order;
}
void OAIListRepositoriesInput::setOrder(const OAIOrderEnum &order) {
    m_order = order;
    m_order_isSet = true;
}

bool OAIListRepositoriesInput::is_order_Set() const{
    return m_order_isSet;
}

bool OAIListRepositoriesInput::is_order_Valid() const{
