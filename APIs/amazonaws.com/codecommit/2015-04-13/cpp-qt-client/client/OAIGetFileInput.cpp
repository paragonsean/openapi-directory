...
OAIGetFileInput::OAIGetFileInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetFileInput::OAIGetFileInput() {
    this->initializeModel();
}

OAIGetFileInput::~OAIGetFileInput() {}

void OAIGetFileInput::initializeModel() {

    m_repository_name_isSet = false;
    m_repository_name_isValid = false;

    m_commit_specifier_isSet = false;
    m_commit_specifier_isValid = false;

    m_file_path_isSet = false;
    m_file_path_isValid = false;
}

void OAIGetFileInput::fromJson(QString jsonString) {
...
void OAIGetFileInput::fromJsonObject(QJsonObject json) {
    ...
    m_commit_specifier_isValid = ::OpenAPI::fromJsonValue(m_commit_specifier, json[QString("commitSpecifier")]);
    m_commit_specifier_isSet = !json[QString("commitSpecifier")].isNull() && m_commit_specifier_isValid;
...
QString OAIGetFileInput::asJson() const {
...
QJsonObject OAIGetFileInput::asJsonObject() const {
    QJsonObject obj;
    if (m_repository_name_isSet) {
        obj.insert(QString("repositoryName"), ::OpenAPI::toJsonValue(m_repository_name));
    }
    if (m_commit_specifier_isSet) {
        obj.insert(QString("commitSpecifier"), ::OpenAPI::toJsonValue(m_commit_specifier));
    }
...
QString OAIGetFileInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIGetFileInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIGetFileInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIGetFileInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIGetFileInput::getCommitSpecifier() const {
    return m_commit_specifier;
}
void OAIGetFileInput::setCommitSpecifier(const QString &commit_specifier) {
    m_commit_specifier = commit_specifier;
    m_commit_specifier_isSet = true;
}

bool OAIGetFileInput::is_commit_specifier_Set() const{
    return m_commit_specifier_isSet;
}

bool OAIGetFileInput::is_commit_specifier_Valid() const{
    return m_commit_specifier_isValid;
}

QString OAIGetFileInput::getFilePath() const {
    return m_file_path;
}
void OAIGetFileInput::setFilePath(const QString &file_path) {
    m_file_path = file_path;
    m_file_path_isSet = true;
}

bool OAIGetFileInput::is_file_path_Set() const{
    return m_file_path_isSet;
}

bool OAIGetFileInput::is_file_path_Valid() const{
    return m_file_path_isValid;
}

bool OAIGetFileInput::isSet() const {
...
bool OAIGetFileInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_repository_name_isValid && m_file_path_isValid && true;
}
