...
OAIListAssociatedApprovalRuleTemplatesForRepositoryInput::OAIListAssociatedApprovalRuleTemplatesForRepositoryInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListAssociatedApprovalRuleTemplatesForRepositoryInput::OAIListAssociatedApprovalRuleTemplatesForRepositoryInput() {
    this->initializeModel();
}

OAIListAssociatedApprovalRuleTemplatesForRepositoryInput::~OAIListAssociatedApprovalRuleTemplatesForRepositoryInput() {}

void OAIListAssociatedApprovalRuleTemplatesForRepositoryInput::initializeModel() {
...
void OAIListAssociatedApprovalRuleTemplatesForRepositoryInput::fromJson(QString jsonString) {
...
void OAIListAssociatedApprovalRuleTemplatesForRepositoryInput::fromJsonObject(QJsonObject json) {
...
QString OAIListAssociatedApprovalRuleTemplatesForRepositoryInput::asJson() const {
...
QJsonObject OAIListAssociatedApprovalRuleTemplatesForRepositoryInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListAssociatedApprovalRuleTemplatesForRepositoryInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIListAssociatedApprovalRuleTemplatesForRepositoryInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIListAssociatedApprovalRuleTemplatesForRepositoryInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIListAssociatedApprovalRuleTemplatesForRepositoryInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIListAssociatedApprovalRuleTemplatesForRepositoryInput::getNextToken() const {
    return m_next_token;
}
void OAIListAssociatedApprovalRuleTemplatesForRepositoryInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListAssociatedApprovalRuleTemplatesForRepositoryInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListAssociatedApprovalRuleTemplatesForRepositoryInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListAssociatedApprovalRuleTemplatesForRepositoryInput::getMaxResults() const {
    return m_max_results;
}
void OAIListAssociatedApprovalRuleTemplatesForRepositoryInput::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListAssociatedApprovalRuleTemplatesForRepositoryInput::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListAssociatedApprovalRuleTemplatesForRepositoryInput::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListAssociatedApprovalRuleTemplatesForRepositoryInput::isSet() const {
...
bool OAIListAssociatedApprovalRuleTemplatesForRepositoryInput::isValid() const {
