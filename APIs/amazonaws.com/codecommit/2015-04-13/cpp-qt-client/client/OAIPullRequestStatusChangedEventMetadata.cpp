...
#include "OAIPullRequestStatusChangedEventMetadata.h"
...
OAIPullRequestStatusChangedEventMetadata::OAIPullRequestStatusChangedEventMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPullRequestStatusChangedEventMetadata::OAIPullRequestStatusChangedEventMetadata() {
    this->initializeModel();
}

OAIPullRequestStatusChangedEventMetadata::~OAIPullRequestStatusChangedEventMetadata() {}

void OAIPullRequestStatusChangedEventMetadata::initializeModel() {

    m_pull_request_status_isSet = false;
    m_pull_request_status_isValid = false;
}

void OAIPullRequestStatusChangedEventMetadata::fromJson(QString jsonString) {
...
void OAIPullRequestStatusChangedEventMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIPullRequestStatusChangedEventMetadata::asJson() const {
...
QJsonObject OAIPullRequestStatusChangedEventMetadata::asJsonObject() const {
    QJsonObject obj;
...
OAIPullRequestStatusEnum OAIPullRequestStatusChangedEventMetadata::getPullRequestStatus() const {
    return m_pull_request_status;
}
void OAIPullRequestStatusChangedEventMetadata::setPullRequestStatus(const OAIPullRequestStatusEnum &pull_request_status) {
    m_pull_request_status = pull_request_status;
    m_pull_request_status_isSet = true;
}

bool OAIPullRequestStatusChangedEventMetadata::is_pull_request_status_Set() const{
    return m_pull_request_status_isSet;
}

bool OAIPullRequestStatusChangedEventMetadata::is_pull_request_status_Valid() const{
    return m_pull_request_status_isValid;
}

bool OAIPullRequestStatusChangedEventMetadata::isSet() const {
...
bool OAIPullRequestStatusChangedEventMetadata::isValid() const {
