...
/*
 * OAIGetCommentsForPullRequestInput.h
 *
 * 
 */

#ifndef OAIGetCommentsForPullRequestInput_H
#define OAIGetCommentsForPullRequestInput_H
...
class OAIGetCommentsForPullRequestInput : public OAIObject {
public:
    OAIGetCommentsForPullRequestInput();
    OAIGetCommentsForPullRequestInput(QString json);
    ~OAIGetCommentsForPullRequestInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCommentsForPullRequestInput)

#endif // OAIGetCommentsForPullRequestInput_H
