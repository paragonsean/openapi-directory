...
OAIReplacementTypeEnum::OAIReplacementTypeEnum(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReplacementTypeEnum::OAIReplacementTypeEnum() {
    this->initializeModel();
}

OAIReplacementTypeEnum::~OAIReplacementTypeEnum() {}

void OAIReplacementTypeEnum::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIReplacementTypeEnum::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIReplacementTypeEnum::fromJson(QString jsonString) {
    
    if ( jsonString.compare("KEEP_BASE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIReplacementTypeEnum::KEEP_BASE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("KEEP_SOURCE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIReplacementTypeEnum::KEEP_SOURCE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("KEEP_DESTINATION", Qt::CaseInsensitive) == 0) {
        m_value = eOAIReplacementTypeEnum::KEEP_DESTINATION;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("USE_NEW_CONTENT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIReplacementTypeEnum::USE_NEW_CONTENT;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIReplacementTypeEnum::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIReplacementTypeEnum::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIReplacementTypeEnum::KEEP_BASE:
            val = "KEEP_BASE";
            break;
        case eOAIReplacementTypeEnum::KEEP_SOURCE:
            val = "KEEP_SOURCE";
            break;
        case eOAIReplacementTypeEnum::KEEP_DESTINATION:
            val = "KEEP_DESTINATION";
            break;
        case eOAIReplacementTypeEnum::USE_NEW_CONTENT:
            val = "USE_NEW_CONTENT";
            break;
        default:
            break;
...
QJsonValue OAIReplacementTypeEnum::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIReplacementTypeEnum::eOAIReplacementTypeEnum OAIReplacementTypeEnum::getValue() const {
    return m_value;
}

void OAIReplacementTypeEnum::setValue(const OAIReplacementTypeEnum::eOAIReplacementTypeEnum& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIReplacementTypeEnum::isSet() const {
    
    return m_value_isSet;
}

bool OAIReplacementTypeEnum::isValid() const {
