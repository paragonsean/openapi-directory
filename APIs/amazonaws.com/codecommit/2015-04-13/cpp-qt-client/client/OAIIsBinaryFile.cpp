...
OAIIsBinaryFile::OAIIsBinaryFile(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIsBinaryFile::OAIIsBinaryFile() {
    this->initializeModel();
}

OAIIsBinaryFile::~OAIIsBinaryFile() {}

void OAIIsBinaryFile::initializeModel() {
...
void OAIIsBinaryFile::fromJson(QString jsonString) {
...
void OAIIsBinaryFile::fromJsonObject(QJsonObject json) {
...
QString OAIIsBinaryFile::asJson() const {
...
QJsonObject OAIIsBinaryFile::asJsonObject() const {
    QJsonObject obj;
    if (m_source_isSet) {
...
bool OAIIsBinaryFile::getSource() const {
    return m_source;
}
void OAIIsBinaryFile::setSource(const bool &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAIIsBinaryFile::is_source_Set() const{
    return m_source_isSet;
}

bool OAIIsBinaryFile::is_source_Valid() const{
    return m_source_isValid;
}

bool OAIIsBinaryFile::getDestination() const {
    return m_destination;
}
void OAIIsBinaryFile::setDestination(const bool &destination) {
    m_destination = destination;
    m_destination_isSet = true;
}

bool OAIIsBinaryFile::is_destination_Set() const{
    return m_destination_isSet;
}

bool OAIIsBinaryFile::is_destination_Valid() const{
    return m_destination_isValid;
}

bool OAIIsBinaryFile::getBase() const {
    return m_base;
}
void OAIIsBinaryFile::setBase(const bool &base) {
    m_base = base;
    m_base_isSet = true;
}

bool OAIIsBinaryFile::is_base_Set() const{
    return m_base_isSet;
}

bool OAIIsBinaryFile::is_base_Valid() const{
    return m_base_isValid;
}

bool OAIIsBinaryFile::isSet() const {
...
bool OAIIsBinaryFile::isValid() const {
