...
#include "OAIPutFileEntry_sourceFile.h"
...
OAIPutFileEntry_sourceFile::OAIPutFileEntry_sourceFile(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutFileEntry_sourceFile::OAIPutFileEntry_sourceFile() {
    this->initializeModel();
}

OAIPutFileEntry_sourceFile::~OAIPutFileEntry_sourceFile() {}

void OAIPutFileEntry_sourceFile::initializeModel() {

    m_file_path_isSet = false;
    m_file_path_isValid = false;

    m_is_move_isSet = false;
    m_is_move_isValid = false;
}

void OAIPutFileEntry_sourceFile::fromJson(QString jsonString) {
...
void OAIPutFileEntry_sourceFile::fromJsonObject(QJsonObject json) {
    ...
    m_is_move_isValid = ::OpenAPI::fromJsonValue(m_is_move, json[QString("isMove")]);
    m_is_move_isSet = !json[QString("isMove")].isNull() && m_is_move_isValid;
}

QString OAIPutFileEntry_sourceFile::asJson() const {
...
QJsonObject OAIPutFileEntry_sourceFile::asJsonObject() const {
    QJsonObject obj;
    if (m_file_path_isSet) {
        obj.insert(QString("filePath"), ::OpenAPI::toJsonValue(m_file_path));
    }
    if (m_is_move_isSet) {
        obj.insert(QString("isMove"), ::OpenAPI::toJsonValue(m_is_move));
    }
    return obj;
}

QString OAIPutFileEntry_sourceFile::getFilePath() const {
    return m_file_path;
}
void OAIPutFileEntry_sourceFile::setFilePath(const QString &file_path) {
    m_file_path = file_path;
    m_file_path_isSet = true;
}

bool OAIPutFileEntry_sourceFile::is_file_path_Set() const{
    return m_file_path_isSet;
}

bool OAIPutFileEntry_sourceFile::is_file_path_Valid() const{
    return m_file_path_isValid;
}

bool OAIPutFileEntry_sourceFile::getIsMove() const {
    return m_is_move;
}
void OAIPutFileEntry_sourceFile::setIsMove(const bool &is_move) {
    m_is_move = is_move;
    m_is_move_isSet = true;
}

bool OAIPutFileEntry_sourceFile::is_is_move_Set() const{
    return m_is_move_isSet;
}

bool OAIPutFileEntry_sourceFile::is_is_move_Valid() const{
    return m_is_move_isValid;
}

bool OAIPutFileEntry_sourceFile::isSet() const {
...
bool OAIPutFileEntry_sourceFile::isValid() const {
