...
/*
 * OAIPullRequestEvent_pullRequestCreatedEventMetadata.h
 *
 * 
 */

#ifndef OAIPullRequestEvent_pullRequestCreatedEventMetadata_H
#define OAIPullRequestEvent_pullRequestCreatedEventMetadata_H
...
class OAIPullRequestEvent_pullRequestCreatedEventMetadata : public OAIObject {
public:
    OAIPullRequestEvent_pullRequestCreatedEventMetadata();
    OAIPullRequestEvent_pullRequestCreatedEventMetadata(QString json);
    ~OAIPullRequestEvent_pullRequestCreatedEventMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPullRequestEvent_pullRequestCreatedEventMetadata)

#endif // OAIPullRequestEvent_pullRequestCreatedEventMetadata_H
