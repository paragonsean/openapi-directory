...
OAIListPullRequestsInput::OAIListPullRequestsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListPullRequestsInput::OAIListPullRequestsInput() {
    this->initializeModel();
}

OAIListPullRequestsInput::~OAIListPullRequestsInput() {}

void OAIListPullRequestsInput::initializeModel() {
...
void OAIListPullRequestsInput::fromJson(QString jsonString) {
...
void OAIListPullRequestsInput::fromJsonObject(QJsonObject json) {
...
QString OAIListPullRequestsInput::asJson() const {
...
QJsonObject OAIListPullRequestsInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListPullRequestsInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIListPullRequestsInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIListPullRequestsInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIListPullRequestsInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIListPullRequestsInput::getAuthorArn() const {
    return m_author_arn;
}
void OAIListPullRequestsInput::setAuthorArn(const QString &author_arn) {
    m_author_arn = author_arn;
    m_author_arn_isSet = true;
}

bool OAIListPullRequestsInput::is_author_arn_Set() const{
    return m_author_arn_isSet;
}

bool OAIListPullRequestsInput::is_author_arn_Valid() const{
    return m_author_arn_isValid;
}

OAIPullRequestStatusEnum OAIListPullRequestsInput::getPullRequestStatus() const {
    return m_pull_request_status;
}
void OAIListPullRequestsInput::setPullRequestStatus(const OAIPullRequestStatusEnum &pull_request_status) {
    m_pull_request_status = pull_request_status;
    m_pull_request_status_isSet = true;
}

bool OAIListPullRequestsInput::is_pull_request_status_Set() const{
    return m_pull_request_status_isSet;
}

bool OAIListPullRequestsInput::is_pull_request_status_Valid() const{
    return m_pull_request_status_isValid;
}

QString OAIListPullRequestsInput::getNextToken() const {
    return m_next_token;
}
void OAIListPullRequestsInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListPullRequestsInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListPullRequestsInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListPullRequestsInput::getMaxResults() const {
    return m_max_results;
}
void OAIListPullRequestsInput::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListPullRequestsInput::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListPullRequestsInput::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListPullRequestsInput::isSet() const {
...
bool OAIListPullRequestsInput::isValid() const {
