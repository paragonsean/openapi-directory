...
#include "OAIApprovalStateChangedEventMetadata.h"
...
OAIApprovalStateChangedEventMetadata::OAIApprovalStateChangedEventMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIApprovalStateChangedEventMetadata::OAIApprovalStateChangedEventMetadata() {
    this->initializeModel();
}

OAIApprovalStateChangedEventMetadata::~OAIApprovalStateChangedEventMetadata() {}

void OAIApprovalStateChangedEventMetadata::initializeModel() {
...
void OAIApprovalStateChangedEventMetadata::fromJson(QString jsonString) {
...
void OAIApprovalStateChangedEventMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIApprovalStateChangedEventMetadata::asJson() const {
...
QJsonObject OAIApprovalStateChangedEventMetadata::asJsonObject() const {
    QJsonObject obj;
...
QString OAIApprovalStateChangedEventMetadata::getRevisionId() const {
    return m_revision_id;
}
void OAIApprovalStateChangedEventMetadata::setRevisionId(const QString &revision_id) {
    m_revision_id = revision_id;
    m_revision_id_isSet = true;
}

bool OAIApprovalStateChangedEventMetadata::is_revision_id_Set() const{
    return m_revision_id_isSet;
}

bool OAIApprovalStateChangedEventMetadata::is_revision_id_Valid() const{
    return m_revision_id_isValid;
}

OAIApprovalState OAIApprovalStateChangedEventMetadata::getApprovalStatus() const {
    return m_approval_status;
}
void OAIApprovalStateChangedEventMetadata::setApprovalStatus(const OAIApprovalState &approval_status) {
    m_approval_status = approval_status;
    m_approval_status_isSet = true;
}

bool OAIApprovalStateChangedEventMetadata::is_approval_status_Set() const{
    return m_approval_status_isSet;
}

bool OAIApprovalStateChangedEventMetadata::is_approval_status_Valid() const{
    return m_approval_status_isValid;
}

bool OAIApprovalStateChangedEventMetadata::isSet() const {
...
bool OAIApprovalStateChangedEventMetadata::isValid() const {
