...
QString OAIGetRepositoryInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIGetRepositoryInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIGetRepositoryInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIGetRepositoryInput::is_repository_name_Valid() const{
