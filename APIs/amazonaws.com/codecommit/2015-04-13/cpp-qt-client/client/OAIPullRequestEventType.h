...
/*
 * OAIPullRequestEventType.h
 *
 * 
 */

#ifndef OAIPullRequestEventType_H
#define OAIPullRequestEventType_H
...
class OAIPullRequestEventType : public OAIEnum {
public:
    OAIPullRequestEventType();
    OAIPullRequestEventType(QString json);
    ~OAIPullRequestEventType() override;
    ...
    enum class eOAIPullRequestEventType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        CREATED, 
        STATUS_CHANGED, 
        SOURCE_REFERENCE_UPDATED, 
        MERGE_STATE_CHANGED, 
    ...
    OAIPullRequestEventType::eOAIPullRequestEventType getValue() const;
    void setValue(const OAIPullRequestEventType::eOAIPullRequestEventType& value);
...
private:
    ...
    eOAIPullRequestEventType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPullRequestEventType)

#endif // OAIPullRequestEventType_H
