...
OAIUpdatePullRequestDescriptionOutput::OAIUpdatePullRequestDescriptionOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePullRequestDescriptionOutput::OAIUpdatePullRequestDescriptionOutput() {
    this->initializeModel();
}

OAIUpdatePullRequestDescriptionOutput::~OAIUpdatePullRequestDescriptionOutput() {}

void OAIUpdatePullRequestDescriptionOutput::initializeModel() {

    m_pull_request_isSet = false;
    m_pull_request_isValid = false;
}

void OAIUpdatePullRequestDescriptionOutput::fromJson(QString jsonString) {
...
void OAIUpdatePullRequestDescriptionOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdatePullRequestDescriptionOutput::asJson() const {
...
QJsonObject OAIUpdatePullRequestDescriptionOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdatePullRequestDescriptionOutput_pullRequest OAIUpdatePullRequestDescriptionOutput::getPullRequest() const {
    return m_pull_request;
}
void OAIUpdatePullRequestDescriptionOutput::setPullRequest(const OAIUpdatePullRequestDescriptionOutput_pullRequest &pull_request) {
    m_pull_request = pull_request;
    m_pull_request_isSet = true;
}

bool OAIUpdatePullRequestDescriptionOutput::is_pull_request_Set() const{
    return m_pull_request_isSet;
}

bool OAIUpdatePullRequestDescriptionOutput::is_pull_request_Valid() const{
    return m_pull_request_isValid;
}

bool OAIUpdatePullRequestDescriptionOutput::isSet() const {
...
bool OAIUpdatePullRequestDescriptionOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_pull_request_isValid && true;
}
