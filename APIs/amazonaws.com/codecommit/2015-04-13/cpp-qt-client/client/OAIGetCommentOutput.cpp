...
OAIGetCommentOutput::OAIGetCommentOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetCommentOutput::OAIGetCommentOutput() {
    this->initializeModel();
}

OAIGetCommentOutput::~OAIGetCommentOutput() {}

void OAIGetCommentOutput::initializeModel() {

    m_comment_isSet = false;
    m_comment_isValid = false;
}

void OAIGetCommentOutput::fromJson(QString jsonString) {
...
void OAIGetCommentOutput::fromJsonObject(QJsonObject json) {

    m_comment_isValid = ::OpenAPI::fromJsonValue(m_comment, json[QString("comment")]);
    m_comment_isSet = !json[QString("comment")].isNull() && m_comment_isValid;
}

QString OAIGetCommentOutput::asJson() const {
...
QJsonObject OAIGetCommentOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_comment.isSet()) {
...
OAIGetCommentOutput_comment OAIGetCommentOutput::getComment() const {
    return m_comment;
}
void OAIGetCommentOutput::setComment(const OAIGetCommentOutput_comment &comment) {
    m_comment = comment;
    m_comment_isSet = true;
}

bool OAIGetCommentOutput::is_comment_Set() const{
    return m_comment_isSet;
}

bool OAIGetCommentOutput::is_comment_Valid() const{
    return m_comment_isValid;
}

bool OAIGetCommentOutput::isSet() const {
...
bool OAIGetCommentOutput::isValid() const {
