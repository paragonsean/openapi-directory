...
OAIPostCommentForComparedCommitInput::OAIPostCommentForComparedCommitInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPostCommentForComparedCommitInput::OAIPostCommentForComparedCommitInput() {
    this->initializeModel();
}

OAIPostCommentForComparedCommitInput::~OAIPostCommentForComparedCommitInput() {}

void OAIPostCommentForComparedCommitInput::initializeModel() {
...
void OAIPostCommentForComparedCommitInput::fromJson(QString jsonString) {
...
void OAIPostCommentForComparedCommitInput::fromJsonObject(QJsonObject json) {
...
QString OAIPostCommentForComparedCommitInput::asJson() const {
...
QJsonObject OAIPostCommentForComparedCommitInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPostCommentForComparedCommitInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIPostCommentForComparedCommitInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIPostCommentForComparedCommitInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIPostCommentForComparedCommitInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIPostCommentForComparedCommitInput::getBeforeCommitId() const {
    return m_before_commit_id;
}
void OAIPostCommentForComparedCommitInput::setBeforeCommitId(const QString &before_commit_id) {
    m_before_commit_id = before_commit_id;
    m_before_commit_id_isSet = true;
}

bool OAIPostCommentForComparedCommitInput::is_before_commit_id_Set() const{
    return m_before_commit_id_isSet;
}

bool OAIPostCommentForComparedCommitInput::is_before_commit_id_Valid() const{
    return m_before_commit_id_isValid;
}

QString OAIPostCommentForComparedCommitInput::getAfterCommitId() const {
    return m_after_commit_id;
}
void OAIPostCommentForComparedCommitInput::setAfterCommitId(const QString &after_commit_id) {
    m_after_commit_id = after_commit_id;
    m_after_commit_id_isSet = true;
}

bool OAIPostCommentForComparedCommitInput::is_after_commit_id_Set() const{
    return m_after_commit_id_isSet;
}

bool OAIPostCommentForComparedCommitInput::is_after_commit_id_Valid() const{
    return m_after_commit_id_isValid;
}

OAIPostCommentForComparedCommitInput_location OAIPostCommentForComparedCommitInput::getLocation() const {
    return m_location;
}
void OAIPostCommentForComparedCommitInput::setLocation(const OAIPostCommentForComparedCommitInput_location &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIPostCommentForComparedCommitInput::is_location_Set() const{
    return m_location_isSet;
}

bool OAIPostCommentForComparedCommitInput::is_location_Valid() const{
    return m_location_isValid;
}

QString OAIPostCommentForComparedCommitInput::getContent() const {
    return m_content;
}
void OAIPostCommentForComparedCommitInput::setContent(const QString &content) {
    m_content = content;
    m_content_isSet = true;
}

bool OAIPostCommentForComparedCommitInput::is_content_Set() const{
    return m_content_isSet;
}

bool OAIPostCommentForComparedCommitInput::is_content_Valid() const{
    return m_content_isValid;
}

QString OAIPostCommentForComparedCommitInput::getClientRequestToken() const {
    return m_client_request_token;
}
void OAIPostCommentForComparedCommitInput::setClientRequestToken(const QString &client_request_token) {
    m_client_request_token = client_request_token;
    m_client_request_token_isSet = true;
}

bool OAIPostCommentForComparedCommitInput::is_client_request_token_Set() const{
    return m_client_request_token_isSet;
}

bool OAIPostCommentForComparedCommitInput::is_client_request_token_Valid() const{
    return m_client_request_token_isValid;
}

bool OAIPostCommentForComparedCommitInput::isSet() const {
...
bool OAIPostCommentForComparedCommitInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_repository_name_isValid && m_after_commit_id_isValid && m_content_isValid && true;
}
