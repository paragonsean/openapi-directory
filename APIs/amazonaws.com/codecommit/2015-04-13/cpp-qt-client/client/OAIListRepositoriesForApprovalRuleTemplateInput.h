...
/*
 * OAIListRepositoriesForApprovalRuleTemplateInput.h
 *
 * 
 */

#ifndef OAIListRepositoriesForApprovalRuleTemplateInput_H
#define OAIListRepositoriesForApprovalRuleTemplateInput_H
...
class OAIListRepositoriesForApprovalRuleTemplateInput : public OAIObject {
public:
    OAIListRepositoriesForApprovalRuleTemplateInput();
    OAIListRepositoriesForApprovalRuleTemplateInput(QString json);
    ~OAIListRepositoriesForApprovalRuleTemplateInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListRepositoriesForApprovalRuleTemplateInput)

#endif // OAIListRepositoriesForApprovalRuleTemplateInput_H
