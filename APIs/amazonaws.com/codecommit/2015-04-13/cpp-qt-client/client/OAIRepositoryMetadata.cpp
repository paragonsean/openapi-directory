...
#include "OAIRepositoryMetadata.h"
...
OAIRepositoryMetadata::OAIRepositoryMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRepositoryMetadata::OAIRepositoryMetadata() {
    this->initializeModel();
}

OAIRepositoryMetadata::~OAIRepositoryMetadata() {}

void OAIRepositoryMetadata::initializeModel() {
...
void OAIRepositoryMetadata::fromJson(QString jsonString) {
...
void OAIRepositoryMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIRepositoryMetadata::asJson() const {
...
QJsonObject OAIRepositoryMetadata::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRepositoryMetadata::getAccountId() const {
    return m_account_id;
}
void OAIRepositoryMetadata::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIRepositoryMetadata::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIRepositoryMetadata::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAIRepositoryMetadata::getRepositoryId() const {
    return m_repository_id;
}
void OAIRepositoryMetadata::setRepositoryId(const QString &repository_id) {
    m_repository_id = repository_id;
    m_repository_id_isSet = true;
}

bool OAIRepositoryMetadata::is_repository_id_Set() const{
    return m_repository_id_isSet;
}

bool OAIRepositoryMetadata::is_repository_id_Valid() const{
    return m_repository_id_isValid;
}

QString OAIRepositoryMetadata::getRepositoryName() const {
    return m_repository_name;
}
void OAIRepositoryMetadata::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIRepositoryMetadata::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIRepositoryMetadata::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIRepositoryMetadata::getRepositoryDescription() const {
    return m_repository_description;
}
void OAIRepositoryMetadata::setRepositoryDescription(const QString &repository_description) {
    m_repository_description = repository_description;
    m_repository_description_isSet = true;
}

bool OAIRepositoryMetadata::is_repository_description_Set() const{
    return m_repository_description_isSet;
}

bool OAIRepositoryMetadata::is_repository_description_Valid() const{
    return m_repository_description_isValid;
}

QString OAIRepositoryMetadata::getDefaultBranch() const {
    return m_default_branch;
}
void OAIRepositoryMetadata::setDefaultBranch(const QString &default_branch) {
    m_default_branch = default_branch;
    m_default_branch_isSet = true;
}

bool OAIRepositoryMetadata::is_default_branch_Set() const{
    return m_default_branch_isSet;
}

bool OAIRepositoryMetadata::is_default_branch_Valid() const{
    return m_default_branch_isValid;
}

QDateTime OAIRepositoryMetadata::getLastModifiedDate() const {
    return m_last_modified_date;
}
void OAIRepositoryMetadata::setLastModifiedDate(const QDateTime &last_modified_date) {
    m_last_modified_date = last_modified_date;
    m_last_modified_date_isSet = true;
}

bool OAIRepositoryMetadata::is_last_modified_date_Set() const{
    return m_last_modified_date_isSet;
}

bool OAIRepositoryMetadata::is_last_modified_date_Valid() const{
    return m_last_modified_date_isValid;
}

QDateTime OAIRepositoryMetadata::getCreationDate() const {
    return m_creation_date;
}
void OAIRepositoryMetadata::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAIRepositoryMetadata::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAIRepositoryMetadata::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

QString OAIRepositoryMetadata::getCloneUrlHttp() const {
    return m_clone_url_http;
}
void OAIRepositoryMetadata::setCloneUrlHttp(const QString &clone_url_http) {
    m_clone_url_http = clone_url_http;
    m_clone_url_http_isSet = true;
}

bool OAIRepositoryMetadata::is_clone_url_http_Set() const{
    return m_clone_url_http_isSet;
}

bool OAIRepositoryMetadata::is_clone_url_http_Valid() const{
    return m_clone_url_http_isValid;
}

QString OAIRepositoryMetadata::getCloneUrlSsh() const {
    return m_clone_url_ssh;
}
void OAIRepositoryMetadata::setCloneUrlSsh(const QString &clone_url_ssh) {
    m_clone_url_ssh = clone_url_ssh;
    m_clone_url_ssh_isSet = true;
}

bool OAIRepositoryMetadata::is_clone_url_ssh_Set() const{
    return m_clone_url_ssh_isSet;
}

bool OAIRepositoryMetadata::is_clone_url_ssh_Valid() const{
    return m_clone_url_ssh_isValid;
}

QString OAIRepositoryMetadata::getArn() const {
    return m_arn;
}
void OAIRepositoryMetadata::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIRepositoryMetadata::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIRepositoryMetadata::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIRepositoryMetadata::isSet() const {
...
bool OAIRepositoryMetadata::isValid() const {
