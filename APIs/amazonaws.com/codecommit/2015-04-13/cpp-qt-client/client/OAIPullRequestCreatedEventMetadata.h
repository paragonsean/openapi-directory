...
/*
 * OAIPullRequestCreatedEventMetadata.h
 *
 * Metadata about the pull request that is used when comparing the pull request source with its destination.
 */

#ifndef OAIPullRequestCreatedEventMetadata_H
#define OAIPullRequestCreatedEventMetadata_H
...
class OAIPullRequestCreatedEventMetadata : public OAIObject {
public:
    OAIPullRequestCreatedEventMetadata();
    OAIPullRequestCreatedEventMetadata(QString json);
    ~OAIPullRequestCreatedEventMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPullRequestCreatedEventMetadata)

#endif // OAIPullRequestCreatedEventMetadata_H
