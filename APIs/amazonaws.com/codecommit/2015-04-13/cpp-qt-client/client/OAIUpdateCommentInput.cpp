...
OAIUpdateCommentInput::OAIUpdateCommentInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateCommentInput::OAIUpdateCommentInput() {
    this->initializeModel();
}

OAIUpdateCommentInput::~OAIUpdateCommentInput() {}

void OAIUpdateCommentInput::initializeModel() {
...
void OAIUpdateCommentInput::fromJson(QString jsonString) {
...
void OAIUpdateCommentInput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateCommentInput::asJson() const {
...
QJsonObject OAIUpdateCommentInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateCommentInput::getCommentId() const {
    return m_comment_id;
}
void OAIUpdateCommentInput::setCommentId(const QString &comment_id) {
    m_comment_id = comment_id;
    m_comment_id_isSet = true;
}

bool OAIUpdateCommentInput::is_comment_id_Set() const{
    return m_comment_id_isSet;
}

bool OAIUpdateCommentInput::is_comment_id_Valid() const{
    return m_comment_id_isValid;
}

QString OAIUpdateCommentInput::getContent() const {
    return m_content;
}
void OAIUpdateCommentInput::setContent(const QString &content) {
    m_content = content;
    m_content_isSet = true;
}

bool OAIUpdateCommentInput::is_content_Set() const{
    return m_content_isSet;
}

bool OAIUpdateCommentInput::is_content_Valid() const{
    return m_content_isValid;
}

bool OAIUpdateCommentInput::isSet() const {
...
bool OAIUpdateCommentInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_comment_id_isValid && m_content_isValid && true;
}
