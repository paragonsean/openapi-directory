...
/*
 * OAIListRepositoriesForApprovalRuleTemplateOutput.h
 *
 * 
 */

#ifndef OAIListRepositoriesForApprovalRuleTemplateOutput_H
#define OAIListRepositoriesForApprovalRuleTemplateOutput_H
...
class OAIListRepositoriesForApprovalRuleTemplateOutput : public OAIObject {
public:
    OAIListRepositoriesForApprovalRuleTemplateOutput();
    OAIListRepositoriesForApprovalRuleTemplateOutput(QString json);
    ~OAIListRepositoriesForApprovalRuleTemplateOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListRepositoriesForApprovalRuleTemplateOutput)

#endif // OAIListRepositoriesForApprovalRuleTemplateOutput_H
