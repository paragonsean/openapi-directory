...
#include "OAIGetRepositoryOutput_repositoryMetadata.h"
...
OAIGetRepositoryOutput_repositoryMetadata::OAIGetRepositoryOutput_repositoryMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetRepositoryOutput_repositoryMetadata::OAIGetRepositoryOutput_repositoryMetadata() {
    this->initializeModel();
}

OAIGetRepositoryOutput_repositoryMetadata::~OAIGetRepositoryOutput_repositoryMetadata() {}

void OAIGetRepositoryOutput_repositoryMetadata::initializeModel() {
    ...
    m_repository_description_isSet = false;
    m_repository_description_isValid = false;
    ...
    m_clone_url_http_isSet = false;
    m_clone_url_http_isValid = false;

    m_clone_url_ssh_isSet = false;
    m_clone_url_ssh_isValid = false;

    m_arn_isSet = false;
    m_arn_isValid = false;
}

void OAIGetRepositoryOutput_repositoryMetadata::fromJson(QString jsonString) {
...
void OAIGetRepositoryOutput_repositoryMetadata::fromJsonObject(QJsonObject json) {
    ...
    m_repository_description_isValid = ::OpenAPI::fromJsonValue(m_repository_description, json[QString("repositoryDescription")]);
    m_repository_description_isSet = !json[QString("repositoryDescription")].isNull() && m_repository_description_isValid;
    ...
    m_clone_url_http_isValid = ::OpenAPI::fromJsonValue(m_clone_url_http, json[QString("cloneUrlHttp")]);
    m_clone_url_http_isSet = !json[QString("cloneUrlHttp")].isNull() && m_clone_url_http_isValid;

    m_clone_url_ssh_isValid = ::OpenAPI::fromJsonValue(m_clone_url_ssh, json[QString("cloneUrlSsh")]);
    m_clone_url_ssh_isSet = !json[QString("cloneUrlSsh")].isNull() && m_clone_url_ssh_isValid;

    m_arn_isValid = ::OpenAPI::fromJsonValue(m_arn, json[QString("Arn")]);
    m_arn_isSet = !json[QString("Arn")].isNull() && m_arn_isValid;
}

QString OAIGetRepositoryOutput_repositoryMetadata::asJson() const {
...
QJsonObject OAIGetRepositoryOutput_repositoryMetadata::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_repository_description_isSet) {
        obj.insert(QString("repositoryDescription"), ::OpenAPI::toJsonValue(m_repository_description));
    }
    ...
    if (m_clone_url_http_isSet) {
        obj.insert(QString("cloneUrlHttp"), ::OpenAPI::toJsonValue(m_clone_url_http));
    }
    if (m_clone_url_ssh_isSet) {
        obj.insert(QString("cloneUrlSsh"), ::OpenAPI::toJsonValue(m_clone_url_ssh));
    }
    if (m_arn_isSet) {
...
QString OAIGetRepositoryOutput_repositoryMetadata::getAccountId() const {
    return m_account_id;
}
void OAIGetRepositoryOutput_repositoryMetadata::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIGetRepositoryOutput_repositoryMetadata::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIGetRepositoryOutput_repositoryMetadata::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAIGetRepositoryOutput_repositoryMetadata::getRepositoryId() const {
    return m_repository_id;
}
void OAIGetRepositoryOutput_repositoryMetadata::setRepositoryId(const QString &repository_id) {
    m_repository_id = repository_id;
    m_repository_id_isSet = true;
}

bool OAIGetRepositoryOutput_repositoryMetadata::is_repository_id_Set() const{
    return m_repository_id_isSet;
}

bool OAIGetRepositoryOutput_repositoryMetadata::is_repository_id_Valid() const{
    return m_repository_id_isValid;
}

QString OAIGetRepositoryOutput_repositoryMetadata::getRepositoryName() const {
    return m_repository_name;
}
void OAIGetRepositoryOutput_repositoryMetadata::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIGetRepositoryOutput_repositoryMetadata::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIGetRepositoryOutput_repositoryMetadata::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIGetRepositoryOutput_repositoryMetadata::getRepositoryDescription() const {
    return m_repository_description;
}
void OAIGetRepositoryOutput_repositoryMetadata::setRepositoryDescription(const QString &repository_description) {
    m_repository_description = repository_description;
    m_repository_description_isSet = true;
}

bool OAIGetRepositoryOutput_repositoryMetadata::is_repository_description_Set() const{
    return m_repository_description_isSet;
}

bool OAIGetRepositoryOutput_repositoryMetadata::is_repository_description_Valid() const{
    return m_repository_description_isValid;
}

QString OAIGetRepositoryOutput_repositoryMetadata::getDefaultBranch() const {
    return m_default_branch;
}
void OAIGetRepositoryOutput_repositoryMetadata::setDefaultBranch(const QString &default_branch) {
    m_default_branch = default_branch;
    m_default_branch_isSet = true;
}

bool OAIGetRepositoryOutput_repositoryMetadata::is_default_branch_Set() const{
    return m_default_branch_isSet;
}

bool OAIGetRepositoryOutput_repositoryMetadata::is_default_branch_Valid() const{
    return m_default_branch_isValid;
}

QDateTime OAIGetRepositoryOutput_repositoryMetadata::getLastModifiedDate() const {
    return m_last_modified_date;
}
void OAIGetRepositoryOutput_repositoryMetadata::setLastModifiedDate(const QDateTime &last_modified_date) {
    m_last_modified_date = last_modified_date;
    m_last_modified_date_isSet = true;
}

bool OAIGetRepositoryOutput_repositoryMetadata::is_last_modified_date_Set() const{
    return m_last_modified_date_isSet;
}

bool OAIGetRepositoryOutput_repositoryMetadata::is_last_modified_date_Valid() const{
    return m_last_modified_date_isValid;
}

QDateTime OAIGetRepositoryOutput_repositoryMetadata::getCreationDate() const {
    return m_creation_date;
}
void OAIGetRepositoryOutput_repositoryMetadata::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAIGetRepositoryOutput_repositoryMetadata::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAIGetRepositoryOutput_repositoryMetadata::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

QString OAIGetRepositoryOutput_repositoryMetadata::getCloneUrlHttp() const {
    return m_clone_url_http;
}
void OAIGetRepositoryOutput_repositoryMetadata::setCloneUrlHttp(const QString &clone_url_http) {
    m_clone_url_http = clone_url_http;
    m_clone_url_http_isSet = true;
}

bool OAIGetRepositoryOutput_repositoryMetadata::is_clone_url_http_Set() const{
    return m_clone_url_http_isSet;
}

bool OAIGetRepositoryOutput_repositoryMetadata::is_clone_url_http_Valid() const{
    return m_clone_url_http_isValid;
}

QString OAIGetRepositoryOutput_repositoryMetadata::getCloneUrlSsh() const {
    return m_clone_url_ssh;
}
void OAIGetRepositoryOutput_repositoryMetadata::setCloneUrlSsh(const QString &clone_url_ssh) {
    m_clone_url_ssh = clone_url_ssh;
    m_clone_url_ssh_isSet = true;
}

bool OAIGetRepositoryOutput_repositoryMetadata::is_clone_url_ssh_Set() const{
    return m_clone_url_ssh_isSet;
}

bool OAIGetRepositoryOutput_repositoryMetadata::is_clone_url_ssh_Valid() const{
    return m_clone_url_ssh_isValid;
}

QString OAIGetRepositoryOutput_repositoryMetadata::getArn() const {
    return m_arn;
}
void OAIGetRepositoryOutput_repositoryMetadata::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIGetRepositoryOutput_repositoryMetadata::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIGetRepositoryOutput_repositoryMetadata::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIGetRepositoryOutput_repositoryMetadata::isSet() const {
...
bool OAIGetRepositoryOutput_repositoryMetadata::isValid() const {
