...
OAIDifference_afterBlob::OAIDifference_afterBlob(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDifference_afterBlob::OAIDifference_afterBlob() {
    this->initializeModel();
}

OAIDifference_afterBlob::~OAIDifference_afterBlob() {}

void OAIDifference_afterBlob::initializeModel() {
...
void OAIDifference_afterBlob::fromJson(QString jsonString) {
...
void OAIDifference_afterBlob::fromJsonObject(QJsonObject json) {
...
QString OAIDifference_afterBlob::asJson() const {
...
QJsonObject OAIDifference_afterBlob::asJsonObject() const {
    QJsonObject obj;
    if (m_blob_id_isSet) {
...
QString OAIDifference_afterBlob::getBlobId() const {
    return m_blob_id;
}
void OAIDifference_afterBlob::setBlobId(const QString &blob_id) {
    m_blob_id = blob_id;
    m_blob_id_isSet = true;
}

bool OAIDifference_afterBlob::is_blob_id_Set() const{
    return m_blob_id_isSet;
}

bool OAIDifference_afterBlob::is_blob_id_Valid() const{
    return m_blob_id_isValid;
}

QString OAIDifference_afterBlob::getPath() const {
    return m_path;
}
void OAIDifference_afterBlob::setPath(const QString &path) {
    m_path = path;
    m_path_isSet = true;
}

bool OAIDifference_afterBlob::is_path_Set() const{
    return m_path_isSet;
}

bool OAIDifference_afterBlob::is_path_Valid() const{
    return m_path_isValid;
}

QString OAIDifference_afterBlob::getMode() const {
    return m_mode;
}
void OAIDifference_afterBlob::setMode(const QString &mode) {
    m_mode = mode;
    m_mode_isSet = true;
}

bool OAIDifference_afterBlob::is_mode_Set() const{
    return m_mode_isSet;
}

bool OAIDifference_afterBlob::is_mode_Valid() const{
    return m_mode_isValid;
}

bool OAIDifference_afterBlob::isSet() const {
...
bool OAIDifference_afterBlob::isValid() const {
