...
/*
 * OAIDeleteFileInput.h
 *
 * 
 */

#ifndef OAIDeleteFileInput_H
#define OAIDeleteFileInput_H
...
class OAIDeleteFileInput : public OAIObject {
public:
    OAIDeleteFileInput();
    OAIDeleteFileInput(QString json);
    ~OAIDeleteFileInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteFileInput)

#endif // OAIDeleteFileInput_H
