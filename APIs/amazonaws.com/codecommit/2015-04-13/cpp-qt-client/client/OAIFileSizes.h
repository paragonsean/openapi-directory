...
#ifndef OAIFileSizes_H
#define OAIFileSizes_H
...
class OAIFileSizes : public OAIObject {
public:
    OAIFileSizes();
    OAIFileSizes(QString json);
    ~OAIFileSizes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFileSizes)

#endif // OAIFileSizes_H
