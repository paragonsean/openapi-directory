...
/*
 * OAIDisassociateApprovalRuleTemplateFromRepositoryInput.h
 *
 * 
 */

#ifndef OAIDisassociateApprovalRuleTemplateFromRepositoryInput_H
#define OAIDisassociateApprovalRuleTemplateFromRepositoryInput_H
...
class OAIDisassociateApprovalRuleTemplateFromRepositoryInput : public OAIObject {
public:
    OAIDisassociateApprovalRuleTemplateFromRepositoryInput();
    OAIDisassociateApprovalRuleTemplateFromRepositoryInput(QString json);
    ~OAIDisassociateApprovalRuleTemplateFromRepositoryInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateApprovalRuleTemplateFromRepositoryInput)

#endif // OAIDisassociateApprovalRuleTemplateFromRepositoryInput_H
