...
OAIListApprovalRuleTemplatesOutput::OAIListApprovalRuleTemplatesOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListApprovalRuleTemplatesOutput::OAIListApprovalRuleTemplatesOutput() {
    this->initializeModel();
}

OAIListApprovalRuleTemplatesOutput::~OAIListApprovalRuleTemplatesOutput() {}

void OAIListApprovalRuleTemplatesOutput::initializeModel() {
...
void OAIListApprovalRuleTemplatesOutput::fromJson(QString jsonString) {
...
void OAIListApprovalRuleTemplatesOutput::fromJsonObject(QJsonObject json) {
...
QString OAIListApprovalRuleTemplatesOutput::asJson() const {
...
QJsonObject OAIListApprovalRuleTemplatesOutput::asJsonObject() const {
    QJsonObject obj;
...
QList OAIListApprovalRuleTemplatesOutput::getApprovalRuleTemplateNames() const {
    return m_approval_rule_template_names;
}
void OAIListApprovalRuleTemplatesOutput::setApprovalRuleTemplateNames(const QList &approval_rule_template_names) {
    m_approval_rule_template_names = approval_rule_template_names;
    m_approval_rule_template_names_isSet = true;
}

bool OAIListApprovalRuleTemplatesOutput::is_approval_rule_template_names_Set() const{
    return m_approval_rule_template_names_isSet;
}

bool OAIListApprovalRuleTemplatesOutput::is_approval_rule_template_names_Valid() const{
    return m_approval_rule_template_names_isValid;
}

QString OAIListApprovalRuleTemplatesOutput::getNextToken() const {
    return m_next_token;
}
void OAIListApprovalRuleTemplatesOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListApprovalRuleTemplatesOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListApprovalRuleTemplatesOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListApprovalRuleTemplatesOutput::isSet() const {
...
bool OAIListApprovalRuleTemplatesOutput::isValid() const {
