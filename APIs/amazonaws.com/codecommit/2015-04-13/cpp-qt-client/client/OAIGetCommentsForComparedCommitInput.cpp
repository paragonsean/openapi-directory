...
OAIGetCommentsForComparedCommitInput::OAIGetCommentsForComparedCommitInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetCommentsForComparedCommitInput::OAIGetCommentsForComparedCommitInput() {
    this->initializeModel();
}

OAIGetCommentsForComparedCommitInput::~OAIGetCommentsForComparedCommitInput() {}

void OAIGetCommentsForComparedCommitInput::initializeModel() {
...
void OAIGetCommentsForComparedCommitInput::fromJson(QString jsonString) {
...
void OAIGetCommentsForComparedCommitInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetCommentsForComparedCommitInput::asJson() const {
...
QJsonObject OAIGetCommentsForComparedCommitInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetCommentsForComparedCommitInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIGetCommentsForComparedCommitInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIGetCommentsForComparedCommitInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIGetCommentsForComparedCommitInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIGetCommentsForComparedCommitInput::getBeforeCommitId() const {
    return m_before_commit_id;
}
void OAIGetCommentsForComparedCommitInput::setBeforeCommitId(const QString &before_commit_id) {
    m_before_commit_id = before_commit_id;
    m_before_commit_id_isSet = true;
}

bool OAIGetCommentsForComparedCommitInput::is_before_commit_id_Set() const{
    return m_before_commit_id_isSet;
}

bool OAIGetCommentsForComparedCommitInput::is_before_commit_id_Valid() const{
    return m_before_commit_id_isValid;
}

QString OAIGetCommentsForComparedCommitInput::getAfterCommitId() const {
    return m_after_commit_id;
}
void OAIGetCommentsForComparedCommitInput::setAfterCommitId(const QString &after_commit_id) {
    m_after_commit_id = after_commit_id;
    m_after_commit_id_isSet = true;
}

bool OAIGetCommentsForComparedCommitInput::is_after_commit_id_Set() const{
    return m_after_commit_id_isSet;
}

bool OAIGetCommentsForComparedCommitInput::is_after_commit_id_Valid() const{
    return m_after_commit_id_isValid;
}

QString OAIGetCommentsForComparedCommitInput::getNextToken() const {
    return m_next_token;
}
void OAIGetCommentsForComparedCommitInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIGetCommentsForComparedCommitInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIGetCommentsForComparedCommitInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIGetCommentsForComparedCommitInput::getMaxResults() const {
    return m_max_results;
}
void OAIGetCommentsForComparedCommitInput::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIGetCommentsForComparedCommitInput::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIGetCommentsForComparedCommitInput::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIGetCommentsForComparedCommitInput::isSet() const {
...
bool OAIGetCommentsForComparedCommitInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_repository_name_isValid && m_after_commit_id_isValid && true;
}
