...
OAIPutRepositoryTriggersInput::OAIPutRepositoryTriggersInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutRepositoryTriggersInput::OAIPutRepositoryTriggersInput() {
    this->initializeModel();
}

OAIPutRepositoryTriggersInput::~OAIPutRepositoryTriggersInput() {}

void OAIPutRepositoryTriggersInput::initializeModel() {
...
void OAIPutRepositoryTriggersInput::fromJson(QString jsonString) {
...
void OAIPutRepositoryTriggersInput::fromJsonObject(QJsonObject json) {
...
QString OAIPutRepositoryTriggersInput::asJson() const {
...
QJsonObject OAIPutRepositoryTriggersInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPutRepositoryTriggersInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIPutRepositoryTriggersInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIPutRepositoryTriggersInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIPutRepositoryTriggersInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QList OAIPutRepositoryTriggersInput::getTriggers() const {
    return m_triggers;
}
void OAIPutRepositoryTriggersInput::setTriggers(const QList &triggers) {
    m_triggers = triggers;
    m_triggers_isSet = true;
}

bool OAIPutRepositoryTriggersInput::is_triggers_Set() const{
    return m_triggers_isSet;
}

bool OAIPutRepositoryTriggersInput::is_triggers_Valid() const{
    return m_triggers_isValid;
}

bool OAIPutRepositoryTriggersInput::isSet() const {
...
bool OAIPutRepositoryTriggersInput::isValid() const {
