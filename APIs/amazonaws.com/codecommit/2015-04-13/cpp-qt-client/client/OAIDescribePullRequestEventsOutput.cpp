...
OAIDescribePullRequestEventsOutput::OAIDescribePullRequestEventsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribePullRequestEventsOutput::OAIDescribePullRequestEventsOutput() {
    this->initializeModel();
}

OAIDescribePullRequestEventsOutput::~OAIDescribePullRequestEventsOutput() {}

void OAIDescribePullRequestEventsOutput::initializeModel() {

    m_pull_request_events_isSet = false;
    m_pull_request_events_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIDescribePullRequestEventsOutput::fromJson(QString jsonString) {
...
void OAIDescribePullRequestEventsOutput::fromJsonObject(QJsonObject json) {

    m_pull_request_events_isValid = ::OpenAPI::fromJsonValue(m_pull_request_events, json[QString("pullRequestEvents")]);
    m_pull_request_events_isSet = !json[QString("pullRequestEvents")].isNull() && m_pull_request_events_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("nextToken")]);
    m_next_token_isSet = !json[QString("nextToken")].isNull() && m_next_token_isValid;
}

QString OAIDescribePullRequestEventsOutput::asJson() const {
...
QJsonObject OAIDescribePullRequestEventsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_pull_request_events.isSet()) {
        obj.insert(QString("pullRequestEvents"), ::OpenAPI::toJsonValue(m_pull_request_events));
    }
...
QList OAIDescribePullRequestEventsOutput::getPullRequestEvents() const {
    return m_pull_request_events;
}
void OAIDescribePullRequestEventsOutput::setPullRequestEvents(const QList &pull_request_events) {
    m_pull_request_events = pull_request_events;
    m_pull_request_events_isSet = true;
}

bool OAIDescribePullRequestEventsOutput::is_pull_request_events_Set() const{
    return m_pull_request_events_isSet;
}

bool OAIDescribePullRequestEventsOutput::is_pull_request_events_Valid() const{
    return m_pull_request_events_isValid;
}

QString OAIDescribePullRequestEventsOutput::getNextToken() const {
    return m_next_token;
}
void OAIDescribePullRequestEventsOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribePullRequestEventsOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribePullRequestEventsOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribePullRequestEventsOutput::isSet() const {
...
bool OAIDescribePullRequestEventsOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_pull_request_events_isValid && true;
}
