...
OAIPostCommentReplyOutput::OAIPostCommentReplyOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPostCommentReplyOutput::OAIPostCommentReplyOutput() {
    this->initializeModel();
}

OAIPostCommentReplyOutput::~OAIPostCommentReplyOutput() {}

void OAIPostCommentReplyOutput::initializeModel() {

    m_comment_isSet = false;
    m_comment_isValid = false;
}

void OAIPostCommentReplyOutput::fromJson(QString jsonString) {
...
void OAIPostCommentReplyOutput::fromJsonObject(QJsonObject json) {

    m_comment_isValid = ::OpenAPI::fromJsonValue(m_comment, json[QString("comment")]);
    m_comment_isSet = !json[QString("comment")].isNull() && m_comment_isValid;
}

QString OAIPostCommentReplyOutput::asJson() const {
...
QJsonObject OAIPostCommentReplyOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_comment.isSet()) {
...
OAIPostCommentReplyOutput_comment OAIPostCommentReplyOutput::getComment() const {
    return m_comment;
}
void OAIPostCommentReplyOutput::setComment(const OAIPostCommentReplyOutput_comment &comment) {
    m_comment = comment;
    m_comment_isSet = true;
}

bool OAIPostCommentReplyOutput::is_comment_Set() const{
    return m_comment_isSet;
}

bool OAIPostCommentReplyOutput::is_comment_Valid() const{
    return m_comment_isValid;
}

bool OAIPostCommentReplyOutput::isSet() const {
...
bool OAIPostCommentReplyOutput::isValid() const {
