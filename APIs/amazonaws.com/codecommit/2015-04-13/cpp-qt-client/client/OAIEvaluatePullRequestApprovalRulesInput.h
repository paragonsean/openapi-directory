...
/*
 * OAIEvaluatePullRequestApprovalRulesInput.h
 *
 * 
 */

#ifndef OAIEvaluatePullRequestApprovalRulesInput_H
#define OAIEvaluatePullRequestApprovalRulesInput_H
...
class OAIEvaluatePullRequestApprovalRulesInput : public OAIObject {
public:
    OAIEvaluatePullRequestApprovalRulesInput();
    OAIEvaluatePullRequestApprovalRulesInput(QString json);
    ~OAIEvaluatePullRequestApprovalRulesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEvaluatePullRequestApprovalRulesInput)

#endif // OAIEvaluatePullRequestApprovalRulesInput_H
