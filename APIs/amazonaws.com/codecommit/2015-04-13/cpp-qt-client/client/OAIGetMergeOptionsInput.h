...
/*
 * OAIGetMergeOptionsInput.h
 *
 * 
 */

#ifndef OAIGetMergeOptionsInput_H
#define OAIGetMergeOptionsInput_H

#include <QJsonObject>

#include "OAIConflictDetailLevelTypeEnum.h"
#include "OAIConflictResolutionStrategyTypeEnum.h"
#include <QString>
...
class OAIGetMergeOptionsInput : public OAIObject {
public:
    OAIGetMergeOptionsInput();
    OAIGetMergeOptionsInput(QString json);
    ~OAIGetMergeOptionsInput() override;
    ...
    QString getSourceCommitSpecifier() const;
    void setSourceCommitSpecifier(const QString &source_commit_specifier);
    bool is_source_commit_specifier_Set() const;
    bool is_source_commit_specifier_Valid() const;

    QString getDestinationCommitSpecifier() const;
    void setDestinationCommitSpecifier(const QString &destination_commit_specifier);
    bool is_destination_commit_specifier_Set() const;
    bool is_destination_commit_specifier_Valid() const;

    OAIConflictDetailLevelTypeEnum getConflictDetailLevel() const;
    void setConflictDetailLevel(const OAIConflictDetailLevelTypeEnum &conflict_detail_level);
    bool is_conflict_detail_level_Set() const;
    bool is_conflict_detail_level_Valid() const;

    OAIConflictResolutionStrategyTypeEnum getConflictResolutionStrategy() const;
    void setConflictResolutionStrategy(const OAIConflictResolutionStrategyTypeEnum &conflict_resolution_strategy);
    bool is_conflict_resolution_strategy_Set() const;
    bool is_conflict_resolution_strategy_Valid() const;
...
private:
    ...
    QString m_source_commit_specifier;
    bool m_source_commit_specifier_isSet;
    bool m_source_commit_specifier_isValid;

    QString m_destination_commit_specifier;
    bool m_destination_commit_specifier_isSet;
    bool m_destination_commit_specifier_isValid;

    OAIConflictDetailLevelTypeEnum m_conflict_detail_level;
    bool m_conflict_detail_level_isSet;
    bool m_conflict_detail_level_isValid;

    OAIConflictResolutionStrategyTypeEnum m_conflict_resolution_strategy;
    bool m_conflict_resolution_strategy_isSet;
    bool m_conflict_resolution_strategy_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetMergeOptionsInput)

#endif // OAIGetMergeOptionsInput_H
