...
#include "OAIBatchGetCommitsError.h"
...
OAIBatchGetCommitsError::OAIBatchGetCommitsError(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchGetCommitsError::OAIBatchGetCommitsError() {
    this->initializeModel();
}

OAIBatchGetCommitsError::~OAIBatchGetCommitsError() {}

void OAIBatchGetCommitsError::initializeModel() {
...
void OAIBatchGetCommitsError::fromJson(QString jsonString) {
...
void OAIBatchGetCommitsError::fromJsonObject(QJsonObject json) {
...
QString OAIBatchGetCommitsError::asJson() const {
...
QJsonObject OAIBatchGetCommitsError::asJsonObject() const {
    QJsonObject obj;
...
QString OAIBatchGetCommitsError::getCommitId() const {
    return m_commit_id;
}
void OAIBatchGetCommitsError::setCommitId(const QString &commit_id) {
    m_commit_id = commit_id;
    m_commit_id_isSet = true;
}

bool OAIBatchGetCommitsError::is_commit_id_Set() const{
    return m_commit_id_isSet;
}

bool OAIBatchGetCommitsError::is_commit_id_Valid() const{
    return m_commit_id_isValid;
}

QString OAIBatchGetCommitsError::getErrorCode() const {
    return m_error_code;
}
void OAIBatchGetCommitsError::setErrorCode(const QString &error_code) {
    m_error_code = error_code;
    m_error_code_isSet = true;
}

bool OAIBatchGetCommitsError::is_error_code_Set() const{
    return m_error_code_isSet;
}

bool OAIBatchGetCommitsError::is_error_code_Valid() const{
    return m_error_code_isValid;
}

QString OAIBatchGetCommitsError::getErrorMessage() const {
    return m_error_message;
}
void OAIBatchGetCommitsError::setErrorMessage(const QString &error_message) {
    m_error_message = error_message;
    m_error_message_isSet = true;
}

bool OAIBatchGetCommitsError::is_error_message_Set() const{
    return m_error_message_isSet;
}

bool OAIBatchGetCommitsError::is_error_message_Valid() const{
    return m_error_message_isValid;
}

bool OAIBatchGetCommitsError::isSet() const {
...
bool OAIBatchGetCommitsError::isValid() const {
