...
OAIListApprovalRuleTemplatesInput::OAIListApprovalRuleTemplatesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListApprovalRuleTemplatesInput::OAIListApprovalRuleTemplatesInput() {
    this->initializeModel();
}

OAIListApprovalRuleTemplatesInput::~OAIListApprovalRuleTemplatesInput() {}

void OAIListApprovalRuleTemplatesInput::initializeModel() {
...
void OAIListApprovalRuleTemplatesInput::fromJson(QString jsonString) {
...
void OAIListApprovalRuleTemplatesInput::fromJsonObject(QJsonObject json) {
...
QString OAIListApprovalRuleTemplatesInput::asJson() const {
...
QJsonObject OAIListApprovalRuleTemplatesInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListApprovalRuleTemplatesInput::getNextToken() const {
    return m_next_token;
}
void OAIListApprovalRuleTemplatesInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListApprovalRuleTemplatesInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListApprovalRuleTemplatesInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListApprovalRuleTemplatesInput::getMaxResults() const {
    return m_max_results;
}
void OAIListApprovalRuleTemplatesInput::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListApprovalRuleTemplatesInput::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListApprovalRuleTemplatesInput::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListApprovalRuleTemplatesInput::isSet() const {
...
bool OAIListApprovalRuleTemplatesInput::isValid() const {
