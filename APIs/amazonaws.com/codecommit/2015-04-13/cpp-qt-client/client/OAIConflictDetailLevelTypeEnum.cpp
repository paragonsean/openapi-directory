...
OAIConflictDetailLevelTypeEnum::OAIConflictDetailLevelTypeEnum(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConflictDetailLevelTypeEnum::OAIConflictDetailLevelTypeEnum() {
    this->initializeModel();
}

OAIConflictDetailLevelTypeEnum::~OAIConflictDetailLevelTypeEnum() {}

void OAIConflictDetailLevelTypeEnum::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIConflictDetailLevelTypeEnum::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIConflictDetailLevelTypeEnum::fromJson(QString jsonString) {
    
    if ( jsonString.compare("FILE_LEVEL", Qt::CaseInsensitive) == 0) {
        m_value = eOAIConflictDetailLevelTypeEnum::FILE_LEVEL;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("LINE_LEVEL", Qt::CaseInsensitive) == 0) {
        m_value = eOAIConflictDetailLevelTypeEnum::LINE_LEVEL;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIConflictDetailLevelTypeEnum::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIConflictDetailLevelTypeEnum::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIConflictDetailLevelTypeEnum::FILE_LEVEL:
            val = "FILE_LEVEL";
            break;
        case eOAIConflictDetailLevelTypeEnum::LINE_LEVEL:
            val = "LINE_LEVEL";
            break;
        default:
            break;
...
QJsonValue OAIConflictDetailLevelTypeEnum::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIConflictDetailLevelTypeEnum::eOAIConflictDetailLevelTypeEnum OAIConflictDetailLevelTypeEnum::getValue() const {
    return m_value;
}

void OAIConflictDetailLevelTypeEnum::setValue(const OAIConflictDetailLevelTypeEnum::eOAIConflictDetailLevelTypeEnum& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIConflictDetailLevelTypeEnum::isSet() const {
    
    return m_value_isSet;
}

bool OAIConflictDetailLevelTypeEnum::isValid() const {
