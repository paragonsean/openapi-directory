...
OAIListPullRequestsOutput::OAIListPullRequestsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListPullRequestsOutput::OAIListPullRequestsOutput() {
    this->initializeModel();
}

OAIListPullRequestsOutput::~OAIListPullRequestsOutput() {}

void OAIListPullRequestsOutput::initializeModel() {

    m_pull_request_ids_isSet = false;
    m_pull_request_ids_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIListPullRequestsOutput::fromJson(QString jsonString) {
...
void OAIListPullRequestsOutput::fromJsonObject(QJsonObject json) {

    m_pull_request_ids_isValid = ::OpenAPI::fromJsonValue(m_pull_request_ids, json[QString("pullRequestIds")]);
    m_pull_request_ids_isSet = !json[QString("pullRequestIds")].isNull() && m_pull_request_ids_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("nextToken")]);
    m_next_token_isSet = !json[QString("nextToken")].isNull() && m_next_token_isValid;
}

QString OAIListPullRequestsOutput::asJson() const {
...
QJsonObject OAIListPullRequestsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_pull_request_ids.isSet()) {
        obj.insert(QString("pullRequestIds"), ::OpenAPI::toJsonValue(m_pull_request_ids));
    }
...
QList OAIListPullRequestsOutput::getPullRequestIds() const {
    return m_pull_request_ids;
}
void OAIListPullRequestsOutput::setPullRequestIds(const QList &pull_request_ids) {
    m_pull_request_ids = pull_request_ids;
    m_pull_request_ids_isSet = true;
}

bool OAIListPullRequestsOutput::is_pull_request_ids_Set() const{
    return m_pull_request_ids_isSet;
}

bool OAIListPullRequestsOutput::is_pull_request_ids_Valid() const{
    return m_pull_request_ids_isValid;
}

QString OAIListPullRequestsOutput::getNextToken() const {
    return m_next_token;
}
void OAIListPullRequestsOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListPullRequestsOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListPullRequestsOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListPullRequestsOutput::isSet() const {
...
bool OAIListPullRequestsOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_pull_request_ids_isValid && true;
}
