...
OAIMergePullRequestBySquashOutput::OAIMergePullRequestBySquashOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMergePullRequestBySquashOutput::OAIMergePullRequestBySquashOutput() {
    this->initializeModel();
}

OAIMergePullRequestBySquashOutput::~OAIMergePullRequestBySquashOutput() {}

void OAIMergePullRequestBySquashOutput::initializeModel() {

    m_pull_request_isSet = false;
    m_pull_request_isValid = false;
}

void OAIMergePullRequestBySquashOutput::fromJson(QString jsonString) {
...
void OAIMergePullRequestBySquashOutput::fromJsonObject(QJsonObject json) {
...
QString OAIMergePullRequestBySquashOutput::asJson() const {
...
QJsonObject OAIMergePullRequestBySquashOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIPullRequest OAIMergePullRequestBySquashOutput::getPullRequest() const {
    return m_pull_request;
}
void OAIMergePullRequestBySquashOutput::setPullRequest(const OAIPullRequest &pull_request) {
    m_pull_request = pull_request;
    m_pull_request_isSet = true;
}

bool OAIMergePullRequestBySquashOutput::is_pull_request_Set() const{
    return m_pull_request_isSet;
}

bool OAIMergePullRequestBySquashOutput::is_pull_request_Valid() const{
    return m_pull_request_isValid;
}

bool OAIMergePullRequestBySquashOutput::isSet() const {
...
bool OAIMergePullRequestBySquashOutput::isValid() const {
