...
OAIUpdateApprovalRuleTemplateDescriptionInput::OAIUpdateApprovalRuleTemplateDescriptionInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateApprovalRuleTemplateDescriptionInput::OAIUpdateApprovalRuleTemplateDescriptionInput() {
    this->initializeModel();
}

OAIUpdateApprovalRuleTemplateDescriptionInput::~OAIUpdateApprovalRuleTemplateDescriptionInput() {}

void OAIUpdateApprovalRuleTemplateDescriptionInput::initializeModel() {
...
void OAIUpdateApprovalRuleTemplateDescriptionInput::fromJson(QString jsonString) {
...
void OAIUpdateApprovalRuleTemplateDescriptionInput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateApprovalRuleTemplateDescriptionInput::asJson() const {
...
QJsonObject OAIUpdateApprovalRuleTemplateDescriptionInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateApprovalRuleTemplateDescriptionInput::getApprovalRuleTemplateName() const {
    return m_approval_rule_template_name;
}
void OAIUpdateApprovalRuleTemplateDescriptionInput::setApprovalRuleTemplateName(const QString &approval_rule_template_name) {
    m_approval_rule_template_name = approval_rule_template_name;
    m_approval_rule_template_name_isSet = true;
}

bool OAIUpdateApprovalRuleTemplateDescriptionInput::is_approval_rule_template_name_Set() const{
    return m_approval_rule_template_name_isSet;
}

bool OAIUpdateApprovalRuleTemplateDescriptionInput::is_approval_rule_template_name_Valid() const{
    return m_approval_rule_template_name_isValid;
}

QString OAIUpdateApprovalRuleTemplateDescriptionInput::getApprovalRuleTemplateDescription() const {
    return m_approval_rule_template_description;
}
void OAIUpdateApprovalRuleTemplateDescriptionInput::setApprovalRuleTemplateDescription(const QString &approval_rule_template_description) {
    m_approval_rule_template_description = approval_rule_template_description;
    m_approval_rule_template_description_isSet = true;
}

bool OAIUpdateApprovalRuleTemplateDescriptionInput::is_approval_rule_template_description_Set() const{
    return m_approval_rule_template_description_isSet;
}

bool OAIUpdateApprovalRuleTemplateDescriptionInput::is_approval_rule_template_description_Valid() const{
    return m_approval_rule_template_description_isValid;
}

bool OAIUpdateApprovalRuleTemplateDescriptionInput::isSet() const {
...
bool OAIUpdateApprovalRuleTemplateDescriptionInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_approval_rule_template_name_isValid && m_approval_rule_template_description_isValid && true;
}
