...
/*
 * OAIPostCommentForPullRequestOutput.h
 *
 * 
 */

#ifndef OAIPostCommentForPullRequestOutput_H
#define OAIPostCommentForPullRequestOutput_H
...
namespace OpenAPI {
class OAIPostCommentForPullRequestOutput_location;
class OAIPostCommentForComparedCommitOutput_comment;

class OAIPostCommentForPullRequestOutput : public OAIObject {
public:
    OAIPostCommentForPullRequestOutput();
    OAIPostCommentForPullRequestOutput(QString json);
    ~OAIPostCommentForPullRequestOutput() override;
    ...
    OAIPostCommentForPullRequestOutput_location getLocation() const;
    void setLocation(const OAIPostCommentForPullRequestOutput_location &location);
...
private:
    ...
    OAIPostCommentForPullRequestOutput_location m_location;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostCommentForPullRequestOutput)

#endif // OAIPostCommentForPullRequestOutput_H
