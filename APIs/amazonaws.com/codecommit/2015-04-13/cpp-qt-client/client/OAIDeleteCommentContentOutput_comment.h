...
/*
 * OAIDeleteCommentContentOutput_comment.h
 *
 * 
 */

#ifndef OAIDeleteCommentContentOutput_comment_H
#define OAIDeleteCommentContentOutput_comment_H
...
class OAIDeleteCommentContentOutput_comment : public OAIObject {
public:
    OAIDeleteCommentContentOutput_comment();
    OAIDeleteCommentContentOutput_comment(QString json);
    ~OAIDeleteCommentContentOutput_comment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteCommentContentOutput_comment)

#endif // OAIDeleteCommentContentOutput_comment_H
