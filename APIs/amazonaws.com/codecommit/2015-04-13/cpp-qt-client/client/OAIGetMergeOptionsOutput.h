...
/*
 * OAIGetMergeOptionsOutput.h
 *
 * 
 */

#ifndef OAIGetMergeOptionsOutput_H
#define OAIGetMergeOptionsOutput_H
...
class OAIGetMergeOptionsOutput : public OAIObject {
public:
    OAIGetMergeOptionsOutput();
    OAIGetMergeOptionsOutput(QString json);
    ~OAIGetMergeOptionsOutput() override;
    ...
    QList getMergeOptions() const;
    void setMergeOptions(const QList &merge_options);
    bool is_merge_options_Set() const;
    bool is_merge_options_Valid() const;
...
private:
    ...
    QList m_merge_options;
    bool m_merge_options_isSet;
    bool m_merge_options_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetMergeOptionsOutput)

#endif // OAIGetMergeOptionsOutput_H
