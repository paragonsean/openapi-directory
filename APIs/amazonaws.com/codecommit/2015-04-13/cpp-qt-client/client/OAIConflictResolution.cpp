...
QList OAIConflictResolution::getReplaceContents() const {
    return m_replace_contents;
}
void OAIConflictResolution::setReplaceContents(const QList &replace_contents) {
    m_replace_contents = replace_contents;
    m_replace_contents_isSet = true;
}

bool OAIConflictResolution::is_replace_contents_Set() const{
    return m_replace_contents_isSet;
}

bool OAIConflictResolution::is_replace_contents_Valid() const{
    return m_replace_contents_isValid;
}

QList OAIConflictResolution::getDeleteFiles() const {
    return m_delete_files;
}
void OAIConflictResolution::setDeleteFiles(const QList &delete_files) {
    m_delete_files = delete_files;
    m_delete_files_isSet = true;
}

bool OAIConflictResolution::is_delete_files_Set() const{
    return m_delete_files_isSet;
}

bool OAIConflictResolution::is_delete_files_Valid() const{
    return m_delete_files_isValid;
}

QList OAIConflictResolution::getSetFileModes() const {
    return m_set_file_modes;
}
void OAIConflictResolution::setSetFileModes(const QList &set_file_modes) {
    m_set_file_modes = set_file_modes;
    m_set_file_modes_isSet = true;
}

bool OAIConflictResolution::is_set_file_modes_Set() const{
    return m_set_file_modes_isSet;
}

bool OAIConflictResolution::is_set_file_modes_Valid() const{
