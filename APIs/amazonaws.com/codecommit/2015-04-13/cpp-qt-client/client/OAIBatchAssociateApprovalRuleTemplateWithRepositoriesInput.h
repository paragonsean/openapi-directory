...
/*
 * OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput.h
 *
 * 
 */

#ifndef OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput_H
#define OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput_H
...
class OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput : public OAIObject {
public:
    OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput();
    OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput(QString json);
    ~OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput)

#endif // OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput_H
