...
/*
 * OAIPostCommentForPullRequestOutput_location.h
 *
 * 
 */

#ifndef OAIPostCommentForPullRequestOutput_location_H
#define OAIPostCommentForPullRequestOutput_location_H
...
class OAIPostCommentForPullRequestOutput_location : public OAIObject {
public:
    OAIPostCommentForPullRequestOutput_location();
    OAIPostCommentForPullRequestOutput_location(QString json);
    ~OAIPostCommentForPullRequestOutput_location() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostCommentForPullRequestOutput_location)

#endif // OAIPostCommentForPullRequestOutput_location_H
