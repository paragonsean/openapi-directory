...
/*
 * OAIListRepositoriesOutput.h
 *
 * Represents the output of a list repositories operation.
 */

#ifndef OAIListRepositoriesOutput_H
#define OAIListRepositoriesOutput_H
...
class OAIListRepositoriesOutput : public OAIObject {
public:
    OAIListRepositoriesOutput();
    OAIListRepositoriesOutput(QString json);
    ~OAIListRepositoriesOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListRepositoriesOutput)

#endif // OAIListRepositoriesOutput_H
