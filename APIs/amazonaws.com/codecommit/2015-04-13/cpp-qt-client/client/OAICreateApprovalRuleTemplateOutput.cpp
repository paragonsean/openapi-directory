...
OAICreateApprovalRuleTemplateOutput::OAICreateApprovalRuleTemplateOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateApprovalRuleTemplateOutput::OAICreateApprovalRuleTemplateOutput() {
    this->initializeModel();
}

OAICreateApprovalRuleTemplateOutput::~OAICreateApprovalRuleTemplateOutput() {}

void OAICreateApprovalRuleTemplateOutput::initializeModel() {

    m_approval_rule_template_isSet = false;
    m_approval_rule_template_isValid = false;
}

void OAICreateApprovalRuleTemplateOutput::fromJson(QString jsonString) {
...
void OAICreateApprovalRuleTemplateOutput::fromJsonObject(QJsonObject json) {
...
QString OAICreateApprovalRuleTemplateOutput::asJson() const {
...
QJsonObject OAICreateApprovalRuleTemplateOutput::asJsonObject() const {
    QJsonObject obj;
...
OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate OAICreateApprovalRuleTemplateOutput::getApprovalRuleTemplate() const {
    return m_approval_rule_template;
}
void OAICreateApprovalRuleTemplateOutput::setApprovalRuleTemplate(const OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate &approval_rule_template) {
    m_approval_rule_template = approval_rule_template;
    m_approval_rule_template_isSet = true;
}

bool OAICreateApprovalRuleTemplateOutput::is_approval_rule_template_Set() const{
    return m_approval_rule_template_isSet;
}

bool OAICreateApprovalRuleTemplateOutput::is_approval_rule_template_Valid() const{
    return m_approval_rule_template_isValid;
}

bool OAICreateApprovalRuleTemplateOutput::isSet() const {
...
bool OAICreateApprovalRuleTemplateOutput::isValid() const {
