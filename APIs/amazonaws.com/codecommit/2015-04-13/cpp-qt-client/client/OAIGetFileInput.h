...
#ifndef OAIGetFileInput_H
#define OAIGetFileInput_H
...
class OAIGetFileInput : public OAIObject {
public:
    OAIGetFileInput();
    OAIGetFileInput(QString json);
    ~OAIGetFileInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetFileInput)

#endif // OAIGetFileInput_H
