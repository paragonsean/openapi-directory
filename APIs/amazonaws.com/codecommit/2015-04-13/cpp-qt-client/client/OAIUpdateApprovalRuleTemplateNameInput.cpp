...
OAIUpdateApprovalRuleTemplateNameInput::OAIUpdateApprovalRuleTemplateNameInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateApprovalRuleTemplateNameInput::OAIUpdateApprovalRuleTemplateNameInput() {
    this->initializeModel();
}

OAIUpdateApprovalRuleTemplateNameInput::~OAIUpdateApprovalRuleTemplateNameInput() {}

void OAIUpdateApprovalRuleTemplateNameInput::initializeModel() {

    m_old_approval_rule_template_name_isSet = false;
    m_old_approval_rule_template_name_isValid = false;

    m_new_approval_rule_template_name_isSet = false;
    m_new_approval_rule_template_name_isValid = false;
}

void OAIUpdateApprovalRuleTemplateNameInput::fromJson(QString jsonString) {
...
void OAIUpdateApprovalRuleTemplateNameInput::fromJsonObject(QJsonObject json) {

    m_old_approval_rule_template_name_isValid = ::OpenAPI::fromJsonValue(m_old_approval_rule_template_name, json[QString("oldApprovalRuleTemplateName")]);
    m_old_approval_rule_template_name_isSet = !json[QString("oldApprovalRuleTemplateName")].isNull() && m_old_approval_rule_template_name_isValid;

    m_new_approval_rule_template_name_isValid = ::OpenAPI::fromJsonValue(m_new_approval_rule_template_name, json[QString("newApprovalRuleTemplateName")]);
    m_new_approval_rule_template_name_isSet = !json[QString("newApprovalRuleTemplateName")].isNull() && m_new_approval_rule_template_name_isValid;
}

QString OAIUpdateApprovalRuleTemplateNameInput::asJson() const {
...
QJsonObject OAIUpdateApprovalRuleTemplateNameInput::asJsonObject() const {
    QJsonObject obj;
    if (m_old_approval_rule_template_name_isSet) {
        obj.insert(QString("oldApprovalRuleTemplateName"), ::OpenAPI::toJsonValue(m_old_approval_rule_template_name));
    }
    if (m_new_approval_rule_template_name_isSet) {
        obj.insert(QString("newApprovalRuleTemplateName"), ::OpenAPI::toJsonValue(m_new_approval_rule_template_name));
    }
    return obj;
}

QString OAIUpdateApprovalRuleTemplateNameInput::getOldApprovalRuleTemplateName() const {
    return m_old_approval_rule_template_name;
}
void OAIUpdateApprovalRuleTemplateNameInput::setOldApprovalRuleTemplateName(const QString &old_approval_rule_template_name) {
    m_old_approval_rule_template_name = old_approval_rule_template_name;
    m_old_approval_rule_template_name_isSet = true;
}

bool OAIUpdateApprovalRuleTemplateNameInput::is_old_approval_rule_template_name_Set() const{
    return m_old_approval_rule_template_name_isSet;
}

bool OAIUpdateApprovalRuleTemplateNameInput::is_old_approval_rule_template_name_Valid() const{
    return m_old_approval_rule_template_name_isValid;
}

QString OAIUpdateApprovalRuleTemplateNameInput::getNewApprovalRuleTemplateName() const {
    return m_new_approval_rule_template_name;
}
void OAIUpdateApprovalRuleTemplateNameInput::setNewApprovalRuleTemplateName(const QString &new_approval_rule_template_name) {
    m_new_approval_rule_template_name = new_approval_rule_template_name;
    m_new_approval_rule_template_name_isSet = true;
}

bool OAIUpdateApprovalRuleTemplateNameInput::is_new_approval_rule_template_name_Set() const{
    return m_new_approval_rule_template_name_isSet;
}

bool OAIUpdateApprovalRuleTemplateNameInput::is_new_approval_rule_template_name_Valid() const{
    return m_new_approval_rule_template_name_isValid;
}

bool OAIUpdateApprovalRuleTemplateNameInput::isSet() const {
...
bool OAIUpdateApprovalRuleTemplateNameInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_old_approval_rule_template_name_isValid && m_new_approval_rule_template_name_isValid && true;
}
