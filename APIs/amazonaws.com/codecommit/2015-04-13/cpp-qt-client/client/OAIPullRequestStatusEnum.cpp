...
OAIPullRequestStatusEnum::OAIPullRequestStatusEnum(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPullRequestStatusEnum::OAIPullRequestStatusEnum() {
    this->initializeModel();
}

OAIPullRequestStatusEnum::~OAIPullRequestStatusEnum() {}

void OAIPullRequestStatusEnum::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIPullRequestStatusEnum::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIPullRequestStatusEnum::fromJson(QString jsonString) {
    
    if ( jsonString.compare("OPEN", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPullRequestStatusEnum::OPEN;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CLOSED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPullRequestStatusEnum::CLOSED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIPullRequestStatusEnum::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIPullRequestStatusEnum::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIPullRequestStatusEnum::OPEN:
            val = "OPEN";
            break;
        case eOAIPullRequestStatusEnum::CLOSED:
            val = "CLOSED";
            break;
        default:
            break;
...
QJsonValue OAIPullRequestStatusEnum::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIPullRequestStatusEnum::eOAIPullRequestStatusEnum OAIPullRequestStatusEnum::getValue() const {
    return m_value;
}

void OAIPullRequestStatusEnum::setValue(const OAIPullRequestStatusEnum::eOAIPullRequestStatusEnum& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIPullRequestStatusEnum::isSet() const {
    
    return m_value_isSet;
}

bool OAIPullRequestStatusEnum::isValid() const {
