...
#include "OAIBatchDescribeMergeConflictsError.h"
...
OAIBatchDescribeMergeConflictsError::OAIBatchDescribeMergeConflictsError(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchDescribeMergeConflictsError::OAIBatchDescribeMergeConflictsError() {
    this->initializeModel();
}

OAIBatchDescribeMergeConflictsError::~OAIBatchDescribeMergeConflictsError() {}

void OAIBatchDescribeMergeConflictsError::initializeModel() {
...
void OAIBatchDescribeMergeConflictsError::fromJson(QString jsonString) {
...
void OAIBatchDescribeMergeConflictsError::fromJsonObject(QJsonObject json) {
...
QString OAIBatchDescribeMergeConflictsError::asJson() const {
...
QJsonObject OAIBatchDescribeMergeConflictsError::asJsonObject() const {
    QJsonObject obj;
...
QString OAIBatchDescribeMergeConflictsError::getFilePath() const {
    return m_file_path;
}
void OAIBatchDescribeMergeConflictsError::setFilePath(const QString &file_path) {
    m_file_path = file_path;
    m_file_path_isSet = true;
}

bool OAIBatchDescribeMergeConflictsError::is_file_path_Set() const{
    return m_file_path_isSet;
}

bool OAIBatchDescribeMergeConflictsError::is_file_path_Valid() const{
    return m_file_path_isValid;
}

QString OAIBatchDescribeMergeConflictsError::getExceptionName() const {
    return m_exception_name;
}
void OAIBatchDescribeMergeConflictsError::setExceptionName(const QString &exception_name) {
    m_exception_name = exception_name;
    m_exception_name_isSet = true;
}

bool OAIBatchDescribeMergeConflictsError::is_exception_name_Set() const{
    return m_exception_name_isSet;
}

bool OAIBatchDescribeMergeConflictsError::is_exception_name_Valid() const{
    return m_exception_name_isValid;
}

QString OAIBatchDescribeMergeConflictsError::getMessage() const {
    return m_message;
}
void OAIBatchDescribeMergeConflictsError::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIBatchDescribeMergeConflictsError::is_message_Set() const{
    return m_message_isSet;
}

bool OAIBatchDescribeMergeConflictsError::is_message_Valid() const{
    return m_message_isValid;
}

bool OAIBatchDescribeMergeConflictsError::isSet() const {
...
bool OAIBatchDescribeMergeConflictsError::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_file_path_isValid && m_exception_name_isValid && m_message_isValid && true;
}
