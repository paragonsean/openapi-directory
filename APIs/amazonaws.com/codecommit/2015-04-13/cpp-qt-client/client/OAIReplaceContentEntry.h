...
/*
 * OAIReplaceContentEntry.h
 *
 * Information about a replacement content entry in the conflict of a merge or pull request operation.
 */

#ifndef OAIReplaceContentEntry_H
#define OAIReplaceContentEntry_H

#include <QJsonObject>

#include "OAIFileModeTypeEnum.h"
#include "OAIReplacementTypeEnum.h"
#include <QString>
...
class OAIReplaceContentEntry : public OAIObject {
public:
    OAIReplaceContentEntry();
    OAIReplaceContentEntry(QString json);
    ~OAIReplaceContentEntry() override;
    ...
    OAIReplacementTypeEnum getReplacementType() const;
    void setReplacementType(const OAIReplacementTypeEnum &replacement_type);
...
private:
    ...
    OAIReplacementTypeEnum m_replacement_type;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReplaceContentEntry)

#endif // OAIReplaceContentEntry_H
