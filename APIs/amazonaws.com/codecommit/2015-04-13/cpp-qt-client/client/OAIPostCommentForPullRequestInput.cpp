...
OAIPostCommentForPullRequestInput::OAIPostCommentForPullRequestInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPostCommentForPullRequestInput::OAIPostCommentForPullRequestInput() {
    this->initializeModel();
}

OAIPostCommentForPullRequestInput::~OAIPostCommentForPullRequestInput() {}

void OAIPostCommentForPullRequestInput::initializeModel() {
...
void OAIPostCommentForPullRequestInput::fromJson(QString jsonString) {
...
void OAIPostCommentForPullRequestInput::fromJsonObject(QJsonObject json) {
...
QString OAIPostCommentForPullRequestInput::asJson() const {
...
QJsonObject OAIPostCommentForPullRequestInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPostCommentForPullRequestInput::getPullRequestId() const {
    return m_pull_request_id;
}
void OAIPostCommentForPullRequestInput::setPullRequestId(const QString &pull_request_id) {
    m_pull_request_id = pull_request_id;
    m_pull_request_id_isSet = true;
}

bool OAIPostCommentForPullRequestInput::is_pull_request_id_Set() const{
    return m_pull_request_id_isSet;
}

bool OAIPostCommentForPullRequestInput::is_pull_request_id_Valid() const{
    return m_pull_request_id_isValid;
}

QString OAIPostCommentForPullRequestInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIPostCommentForPullRequestInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIPostCommentForPullRequestInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIPostCommentForPullRequestInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIPostCommentForPullRequestInput::getBeforeCommitId() const {
    return m_before_commit_id;
}
void OAIPostCommentForPullRequestInput::setBeforeCommitId(const QString &before_commit_id) {
    m_before_commit_id = before_commit_id;
    m_before_commit_id_isSet = true;
}

bool OAIPostCommentForPullRequestInput::is_before_commit_id_Set() const{
    return m_before_commit_id_isSet;
}

bool OAIPostCommentForPullRequestInput::is_before_commit_id_Valid() const{
    return m_before_commit_id_isValid;
}

QString OAIPostCommentForPullRequestInput::getAfterCommitId() const {
    return m_after_commit_id;
}
void OAIPostCommentForPullRequestInput::setAfterCommitId(const QString &after_commit_id) {
    m_after_commit_id = after_commit_id;
    m_after_commit_id_isSet = true;
}

bool OAIPostCommentForPullRequestInput::is_after_commit_id_Set() const{
    return m_after_commit_id_isSet;
}

bool OAIPostCommentForPullRequestInput::is_after_commit_id_Valid() const{
    return m_after_commit_id_isValid;
}

OAIPostCommentForPullRequestInput_location OAIPostCommentForPullRequestInput::getLocation() const {
    return m_location;
}
void OAIPostCommentForPullRequestInput::setLocation(const OAIPostCommentForPullRequestInput_location &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIPostCommentForPullRequestInput::is_location_Set() const{
    return m_location_isSet;
}

bool OAIPostCommentForPullRequestInput::is_location_Valid() const{
    return m_location_isValid;
}

QString OAIPostCommentForPullRequestInput::getContent() const {
    return m_content;
}
void OAIPostCommentForPullRequestInput::setContent(const QString &content) {
    m_content = content;
    m_content_isSet = true;
}

bool OAIPostCommentForPullRequestInput::is_content_Set() const{
    return m_content_isSet;
}

bool OAIPostCommentForPullRequestInput::is_content_Valid() const{
    return m_content_isValid;
}

QString OAIPostCommentForPullRequestInput::getClientRequestToken() const {
    return m_client_request_token;
}
void OAIPostCommentForPullRequestInput::setClientRequestToken(const QString &client_request_token) {
    m_client_request_token = client_request_token;
    m_client_request_token_isSet = true;
}

bool OAIPostCommentForPullRequestInput::is_client_request_token_Set() const{
    return m_client_request_token_isSet;
}

bool OAIPostCommentForPullRequestInput::is_client_request_token_Valid() const{
    return m_client_request_token_isValid;
}

bool OAIPostCommentForPullRequestInput::isSet() const {
...
bool OAIPostCommentForPullRequestInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_pull_request_id_isValid && m_repository_name_isValid && m_before_commit_id_isValid && m_after_commit_id_isValid && m_content_isValid && true;
}
