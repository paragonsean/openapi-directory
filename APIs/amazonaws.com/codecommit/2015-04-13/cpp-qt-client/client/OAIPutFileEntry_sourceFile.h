...
/*
 * OAIPutFileEntry_sourceFile.h
 *
 * 
 */

#ifndef OAIPutFileEntry_sourceFile_H
#define OAIPutFileEntry_sourceFile_H
...
class OAIPutFileEntry_sourceFile : public OAIObject {
public:
    OAIPutFileEntry_sourceFile();
    OAIPutFileEntry_sourceFile(QString json);
    ~OAIPutFileEntry_sourceFile() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutFileEntry_sourceFile)

#endif // OAIPutFileEntry_sourceFile_H
