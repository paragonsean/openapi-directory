...
OAIGetFileOutput::OAIGetFileOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetFileOutput::OAIGetFileOutput() {
    this->initializeModel();
}

OAIGetFileOutput::~OAIGetFileOutput() {}

void OAIGetFileOutput::initializeModel() {
...
void OAIGetFileOutput::fromJson(QString jsonString) {
...
void OAIGetFileOutput::fromJsonObject(QJsonObject json) {
...
QString OAIGetFileOutput::asJson() const {
...
QJsonObject OAIGetFileOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetFileOutput::getCommitId() const {
    return m_commit_id;
}
void OAIGetFileOutput::setCommitId(const QString &commit_id) {
    m_commit_id = commit_id;
    m_commit_id_isSet = true;
}

bool OAIGetFileOutput::is_commit_id_Set() const{
    return m_commit_id_isSet;
}

bool OAIGetFileOutput::is_commit_id_Valid() const{
    return m_commit_id_isValid;
}

QString OAIGetFileOutput::getBlobId() const {
    return m_blob_id;
}
void OAIGetFileOutput::setBlobId(const QString &blob_id) {
    m_blob_id = blob_id;
    m_blob_id_isSet = true;
}

bool OAIGetFileOutput::is_blob_id_Set() const{
    return m_blob_id_isSet;
}

bool OAIGetFileOutput::is_blob_id_Valid() const{
    return m_blob_id_isValid;
}

QString OAIGetFileOutput::getFilePath() const {
    return m_file_path;
}
void OAIGetFileOutput::setFilePath(const QString &file_path) {
    m_file_path = file_path;
    m_file_path_isSet = true;
}

bool OAIGetFileOutput::is_file_path_Set() const{
    return m_file_path_isSet;
}

bool OAIGetFileOutput::is_file_path_Valid() const{
    return m_file_path_isValid;
}

OAIFileModeTypeEnum OAIGetFileOutput::getFileMode() const {
    return m_file_mode;
}
void OAIGetFileOutput::setFileMode(const OAIFileModeTypeEnum &file_mode) {
    m_file_mode = file_mode;
    m_file_mode_isSet = true;
}

bool OAIGetFileOutput::is_file_mode_Set() const{
    return m_file_mode_isSet;
}

bool OAIGetFileOutput::is_file_mode_Valid() const{
    return m_file_mode_isValid;
}

qint32 OAIGetFileOutput::getFileSize() const {
    return m_file_size;
}
void OAIGetFileOutput::setFileSize(const qint32 &file_size) {
    m_file_size = file_size;
    m_file_size_isSet = true;
}

bool OAIGetFileOutput::is_file_size_Set() const{
    return m_file_size_isSet;
}

bool OAIGetFileOutput::is_file_size_Valid() const{
    return m_file_size_isValid;
}

QString OAIGetFileOutput::getFileContent() const {
    return m_file_content;
}
void OAIGetFileOutput::setFileContent(const QString &file_content) {
    m_file_content = file_content;
    m_file_content_isSet = true;
}

bool OAIGetFileOutput::is_file_content_Set() const{
    return m_file_content_isSet;
}

bool OAIGetFileOutput::is_file_content_Valid() const{
    return m_file_content_isValid;
}

bool OAIGetFileOutput::isSet() const {
...
bool OAIGetFileOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_commit_id_isValid && m_blob_id_isValid && m_file_path_isValid && m_file_mode_isValid && m_file_size_isValid && m_file_content_isValid && true;
}
