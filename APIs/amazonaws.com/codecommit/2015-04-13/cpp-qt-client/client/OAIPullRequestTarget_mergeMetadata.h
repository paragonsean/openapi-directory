...
/*
 * OAIPullRequestTarget_mergeMetadata.h
 *
 * 
 */

#ifndef OAIPullRequestTarget_mergeMetadata_H
#define OAIPullRequestTarget_mergeMetadata_H
...
class OAIPullRequestTarget_mergeMetadata : public OAIObject {
public:
    OAIPullRequestTarget_mergeMetadata();
    OAIPullRequestTarget_mergeMetadata(QString json);
    ~OAIPullRequestTarget_mergeMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPullRequestTarget_mergeMetadata)

#endif // OAIPullRequestTarget_mergeMetadata_H
