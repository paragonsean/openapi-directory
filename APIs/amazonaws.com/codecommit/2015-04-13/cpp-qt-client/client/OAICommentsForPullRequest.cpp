...
#include "OAICommentsForPullRequest.h"
...
OAICommentsForPullRequest::OAICommentsForPullRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICommentsForPullRequest::OAICommentsForPullRequest() {
    this->initializeModel();
}

OAICommentsForPullRequest::~OAICommentsForPullRequest() {}

void OAICommentsForPullRequest::initializeModel() {
...
void OAICommentsForPullRequest::fromJson(QString jsonString) {
...
void OAICommentsForPullRequest::fromJsonObject(QJsonObject json) {
...
QString OAICommentsForPullRequest::asJson() const {
...
QJsonObject OAICommentsForPullRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAICommentsForPullRequest::getPullRequestId() const {
    return m_pull_request_id;
}
void OAICommentsForPullRequest::setPullRequestId(const QString &pull_request_id) {
    m_pull_request_id = pull_request_id;
    m_pull_request_id_isSet = true;
}

bool OAICommentsForPullRequest::is_pull_request_id_Set() const{
    return m_pull_request_id_isSet;
}

bool OAICommentsForPullRequest::is_pull_request_id_Valid() const{
    return m_pull_request_id_isValid;
}

QString OAICommentsForPullRequest::getRepositoryName() const {
    return m_repository_name;
}
void OAICommentsForPullRequest::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAICommentsForPullRequest::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAICommentsForPullRequest::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAICommentsForPullRequest::getBeforeCommitId() const {
    return m_before_commit_id;
}
void OAICommentsForPullRequest::setBeforeCommitId(const QString &before_commit_id) {
    m_before_commit_id = before_commit_id;
    m_before_commit_id_isSet = true;
}

bool OAICommentsForPullRequest::is_before_commit_id_Set() const{
    return m_before_commit_id_isSet;
}

bool OAICommentsForPullRequest::is_before_commit_id_Valid() const{
    return m_before_commit_id_isValid;
}

QString OAICommentsForPullRequest::getAfterCommitId() const {
    return m_after_commit_id;
}
void OAICommentsForPullRequest::setAfterCommitId(const QString &after_commit_id) {
    m_after_commit_id = after_commit_id;
    m_after_commit_id_isSet = true;
}

bool OAICommentsForPullRequest::is_after_commit_id_Set() const{
    return m_after_commit_id_isSet;
}

bool OAICommentsForPullRequest::is_after_commit_id_Valid() const{
    return m_after_commit_id_isValid;
}

QString OAICommentsForPullRequest::getBeforeBlobId() const {
    return m_before_blob_id;
}
void OAICommentsForPullRequest::setBeforeBlobId(const QString &before_blob_id) {
    m_before_blob_id = before_blob_id;
    m_before_blob_id_isSet = true;
}

bool OAICommentsForPullRequest::is_before_blob_id_Set() const{
    return m_before_blob_id_isSet;
}

bool OAICommentsForPullRequest::is_before_blob_id_Valid() const{
    return m_before_blob_id_isValid;
}

QString OAICommentsForPullRequest::getAfterBlobId() const {
    return m_after_blob_id;
}
void OAICommentsForPullRequest::setAfterBlobId(const QString &after_blob_id) {
    m_after_blob_id = after_blob_id;
    m_after_blob_id_isSet = true;
}

bool OAICommentsForPullRequest::is_after_blob_id_Set() const{
    return m_after_blob_id_isSet;
}

bool OAICommentsForPullRequest::is_after_blob_id_Valid() const{
    return m_after_blob_id_isValid;
}

OAICommentsForPullRequest_location OAICommentsForPullRequest::getLocation() const {
    return m_location;
}
void OAICommentsForPullRequest::setLocation(const OAICommentsForPullRequest_location &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAICommentsForPullRequest::is_location_Set() const{
    return m_location_isSet;
}

bool OAICommentsForPullRequest::is_location_Valid() const{
    return m_location_isValid;
}

QList OAICommentsForPullRequest::getComments() const {
    return m_comments;
}
void OAICommentsForPullRequest::setComments(const QList &comments) {
    m_comments = comments;
    m_comments_isSet = true;
}

bool OAICommentsForPullRequest::is_comments_Set() const{
    return m_comments_isSet;
}

bool OAICommentsForPullRequest::is_comments_Valid() const{
    return m_comments_isValid;
}

bool OAICommentsForPullRequest::isSet() const {
...
bool OAICommentsForPullRequest::isValid() const {
