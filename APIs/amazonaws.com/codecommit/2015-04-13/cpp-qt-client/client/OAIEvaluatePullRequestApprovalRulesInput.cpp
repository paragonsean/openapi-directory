...
OAIEvaluatePullRequestApprovalRulesInput::OAIEvaluatePullRequestApprovalRulesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEvaluatePullRequestApprovalRulesInput::OAIEvaluatePullRequestApprovalRulesInput() {
    this->initializeModel();
}

OAIEvaluatePullRequestApprovalRulesInput::~OAIEvaluatePullRequestApprovalRulesInput() {}

void OAIEvaluatePullRequestApprovalRulesInput::initializeModel() {
...
void OAIEvaluatePullRequestApprovalRulesInput::fromJson(QString jsonString) {
...
void OAIEvaluatePullRequestApprovalRulesInput::fromJsonObject(QJsonObject json) {
...
QString OAIEvaluatePullRequestApprovalRulesInput::asJson() const {
...
QJsonObject OAIEvaluatePullRequestApprovalRulesInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIEvaluatePullRequestApprovalRulesInput::getPullRequestId() const {
    return m_pull_request_id;
}
void OAIEvaluatePullRequestApprovalRulesInput::setPullRequestId(const QString &pull_request_id) {
    m_pull_request_id = pull_request_id;
    m_pull_request_id_isSet = true;
}

bool OAIEvaluatePullRequestApprovalRulesInput::is_pull_request_id_Set() const{
    return m_pull_request_id_isSet;
}

bool OAIEvaluatePullRequestApprovalRulesInput::is_pull_request_id_Valid() const{
    return m_pull_request_id_isValid;
}

QString OAIEvaluatePullRequestApprovalRulesInput::getRevisionId() const {
    return m_revision_id;
}
void OAIEvaluatePullRequestApprovalRulesInput::setRevisionId(const QString &revision_id) {
    m_revision_id = revision_id;
    m_revision_id_isSet = true;
}

bool OAIEvaluatePullRequestApprovalRulesInput::is_revision_id_Set() const{
    return m_revision_id_isSet;
}

bool OAIEvaluatePullRequestApprovalRulesInput::is_revision_id_Valid() const{
    return m_revision_id_isValid;
}

bool OAIEvaluatePullRequestApprovalRulesInput::isSet() const {
...
bool OAIEvaluatePullRequestApprovalRulesInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_pull_request_id_isValid && m_revision_id_isValid && true;
}
