...
#ifndef OAIGetBranchInput_H
#define OAIGetBranchInput_H
...
class OAIGetBranchInput : public OAIObject {
public:
    OAIGetBranchInput();
    OAIGetBranchInput(QString json);
    ~OAIGetBranchInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetBranchInput)

#endif // OAIGetBranchInput_H
