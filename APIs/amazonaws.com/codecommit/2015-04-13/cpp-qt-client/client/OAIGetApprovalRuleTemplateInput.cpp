...
OAIGetApprovalRuleTemplateInput::OAIGetApprovalRuleTemplateInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetApprovalRuleTemplateInput::OAIGetApprovalRuleTemplateInput() {
    this->initializeModel();
}

OAIGetApprovalRuleTemplateInput::~OAIGetApprovalRuleTemplateInput() {}

void OAIGetApprovalRuleTemplateInput::initializeModel() {

    m_approval_rule_template_name_isSet = false;
    m_approval_rule_template_name_isValid = false;
}

void OAIGetApprovalRuleTemplateInput::fromJson(QString jsonString) {
...
void OAIGetApprovalRuleTemplateInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetApprovalRuleTemplateInput::asJson() const {
...
QJsonObject OAIGetApprovalRuleTemplateInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetApprovalRuleTemplateInput::getApprovalRuleTemplateName() const {
    return m_approval_rule_template_name;
}
void OAIGetApprovalRuleTemplateInput::setApprovalRuleTemplateName(const QString &approval_rule_template_name) {
    m_approval_rule_template_name = approval_rule_template_name;
    m_approval_rule_template_name_isSet = true;
}

bool OAIGetApprovalRuleTemplateInput::is_approval_rule_template_name_Set() const{
    return m_approval_rule_template_name_isSet;
}

bool OAIGetApprovalRuleTemplateInput::is_approval_rule_template_name_Valid() const{
    return m_approval_rule_template_name_isValid;
}

bool OAIGetApprovalRuleTemplateInput::isSet() const {
...
bool OAIGetApprovalRuleTemplateInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_approval_rule_template_name_isValid && true;
}
