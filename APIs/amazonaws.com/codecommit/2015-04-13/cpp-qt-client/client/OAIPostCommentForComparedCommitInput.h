...
/*
 * OAIPostCommentForComparedCommitInput.h
 *
 * 
 */

#ifndef OAIPostCommentForComparedCommitInput_H
#define OAIPostCommentForComparedCommitInput_H

#include <QJsonObject>

#include "OAIPostCommentForComparedCommitInput_location.h"
#include <QString>
...
namespace OpenAPI {
class OAIPostCommentForComparedCommitInput_location;

class OAIPostCommentForComparedCommitInput : public OAIObject {
public:
    OAIPostCommentForComparedCommitInput();
    OAIPostCommentForComparedCommitInput(QString json);
    ~OAIPostCommentForComparedCommitInput() override;
    ...
    QString getBeforeCommitId() const;
    void setBeforeCommitId(const QString &before_commit_id);
    bool is_before_commit_id_Set() const;
    bool is_before_commit_id_Valid() const;

    QString getAfterCommitId() const;
    void setAfterCommitId(const QString &after_commit_id);
    bool is_after_commit_id_Set() const;
    bool is_after_commit_id_Valid() const;

    OAIPostCommentForComparedCommitInput_location getLocation() const;
    void setLocation(const OAIPostCommentForComparedCommitInput_location &location);
...
private:
    ...
    QString m_before_commit_id;
    bool m_before_commit_id_isSet;
    bool m_before_commit_id_isValid;

    QString m_after_commit_id;
    bool m_after_commit_id_isSet;
    bool m_after_commit_id_isValid;

    OAIPostCommentForComparedCommitInput_location m_location;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostCommentForComparedCommitInput)

#endif // OAIPostCommentForComparedCommitInput_H
