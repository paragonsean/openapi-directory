...
/*
 * OAIListPullRequestsOutput.h
 *
 * 
 */

#ifndef OAIListPullRequestsOutput_H
#define OAIListPullRequestsOutput_H
...
class OAIListPullRequestsOutput : public OAIObject {
public:
    OAIListPullRequestsOutput();
    OAIListPullRequestsOutput(QString json);
    ~OAIListPullRequestsOutput() override;
    ...
    QList getPullRequestIds() const;
    void setPullRequestIds(const QList &pull_request_ids);
    bool is_pull_request_ids_Set() const;
    bool is_pull_request_ids_Valid() const;
...
private:
    ...
    QList m_pull_request_ids;
    bool m_pull_request_ids_isSet;
    bool m_pull_request_ids_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPullRequestsOutput)

#endif // OAIListPullRequestsOutput_H
