...
#ifndef OAIBranchInfo_H
#define OAIBranchInfo_H
...
class OAIBranchInfo : public OAIObject {
public:
    OAIBranchInfo();
    OAIBranchInfo(QString json);
    ~OAIBranchInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBranchInfo)

#endif // OAIBranchInfo_H
