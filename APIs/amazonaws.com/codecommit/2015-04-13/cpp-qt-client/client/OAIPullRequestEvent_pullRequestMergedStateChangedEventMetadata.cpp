...
OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata::OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata::OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata() {
    this->initializeModel();
}

OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata::~OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata() {}

void OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata::initializeModel() {
...
void OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata::fromJson(QString jsonString) {
...
void OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata::asJson() const {
...
QJsonObject OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata::getRepositoryName() const {
    return m_repository_name;
}
void OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata::getDestinationReference() const {
    return m_destination_reference;
}
void OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata::setDestinationReference(const QString &destination_reference) {
    m_destination_reference = destination_reference;
    m_destination_reference_isSet = true;
}

bool OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata::is_destination_reference_Set() const{
    return m_destination_reference_isSet;
}

bool OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata::is_destination_reference_Valid() const{
    return m_destination_reference_isValid;
}

OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata::getMergeMetadata() const {
    return m_merge_metadata;
}
void OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata::setMergeMetadata(const OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata &merge_metadata) {
    m_merge_metadata = merge_metadata;
    m_merge_metadata_isSet = true;
}

bool OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata::is_merge_metadata_Set() const{
    return m_merge_metadata_isSet;
}

bool OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata::is_merge_metadata_Valid() const{
    return m_merge_metadata_isValid;
}

bool OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata::isSet() const {
...
bool OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata::isValid() const {
