...
/*
 * OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput.h
 *
 * 
 */

#ifndef OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput_H
#define OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput_H
...
class OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput : public OAIObject {
public:
    OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput();
    OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput(QString json);
    ~OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput() override;
    ...
    QList getAssociatedRepositoryNames() const;
    void setAssociatedRepositoryNames(const QList &associated_repository_names);
    bool is_associated_repository_names_Set() const;
    bool is_associated_repository_names_Valid() const;
...
private:
    ...
    QList m_associated_repository_names;
    bool m_associated_repository_names_isSet;
    bool m_associated_repository_names_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput)

#endif // OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput_H
