...
/*
 * OAIGetPullRequestApprovalStatesInput.h
 *
 * 
 */

#ifndef OAIGetPullRequestApprovalStatesInput_H
#define OAIGetPullRequestApprovalStatesInput_H
...
class OAIGetPullRequestApprovalStatesInput : public OAIObject {
public:
    OAIGetPullRequestApprovalStatesInput();
    OAIGetPullRequestApprovalStatesInput(QString json);
    ~OAIGetPullRequestApprovalStatesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPullRequestApprovalStatesInput)

#endif // OAIGetPullRequestApprovalStatesInput_H
