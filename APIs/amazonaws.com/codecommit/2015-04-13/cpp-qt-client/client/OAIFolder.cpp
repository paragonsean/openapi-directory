...
QString OAIFolder::getTreeId() const {
    return m_tree_id;
}
void OAIFolder::setTreeId(const QString &tree_id) {
    m_tree_id = tree_id;
    m_tree_id_isSet = true;
}

bool OAIFolder::is_tree_id_Set() const{
    return m_tree_id_isSet;
}

bool OAIFolder::is_tree_id_Valid() const{
    return m_tree_id_isValid;
}

QString OAIFolder::getAbsolutePath() const {
    return m_absolute_path;
}
void OAIFolder::setAbsolutePath(const QString &absolute_path) {
    m_absolute_path = absolute_path;
    m_absolute_path_isSet = true;
}

bool OAIFolder::is_absolute_path_Set() const{
    return m_absolute_path_isSet;
}

bool OAIFolder::is_absolute_path_Valid() const{
    return m_absolute_path_isValid;
}

QString OAIFolder::getRelativePath() const {
    return m_relative_path;
}
void OAIFolder::setRelativePath(const QString &relative_path) {
    m_relative_path = relative_path;
    m_relative_path_isSet = true;
}

bool OAIFolder::is_relative_path_Set() const{
    return m_relative_path_isSet;
}

bool OAIFolder::is_relative_path_Valid() const{
