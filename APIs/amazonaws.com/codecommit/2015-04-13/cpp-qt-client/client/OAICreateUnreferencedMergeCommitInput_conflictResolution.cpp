...
OAICreateUnreferencedMergeCommitInput_conflictResolution::OAICreateUnreferencedMergeCommitInput_conflictResolution(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateUnreferencedMergeCommitInput_conflictResolution::OAICreateUnreferencedMergeCommitInput_conflictResolution() {
    this->initializeModel();
}

OAICreateUnreferencedMergeCommitInput_conflictResolution::~OAICreateUnreferencedMergeCommitInput_conflictResolution() {}

void OAICreateUnreferencedMergeCommitInput_conflictResolution::initializeModel() {

    m_replace_contents_isSet = false;
    m_replace_contents_isValid = false;
...
void OAICreateUnreferencedMergeCommitInput_conflictResolution::fromJson(QString jsonString) {
...
void OAICreateUnreferencedMergeCommitInput_conflictResolution::fromJsonObject(QJsonObject json) {

    m_replace_contents_isValid = ::OpenAPI::fromJsonValue(m_replace_contents, json[QString("replaceContents")]);
    m_replace_contents_isSet = !json[QString("replaceContents")].isNull() && m_replace_contents_isValid;
...
QString OAICreateUnreferencedMergeCommitInput_conflictResolution::asJson() const {
...
QJsonObject OAICreateUnreferencedMergeCommitInput_conflictResolution::asJsonObject() const {
    QJsonObject obj;
    if (m_replace_contents.isSet()) {
        obj.insert(QString("replaceContents"), ::OpenAPI::toJsonValue(m_replace_contents));
    }
...
QList OAICreateUnreferencedMergeCommitInput_conflictResolution::getReplaceContents() const {
    return m_replace_contents;
}
void OAICreateUnreferencedMergeCommitInput_conflictResolution::setReplaceContents(const QList &replace_contents) {
    m_replace_contents = replace_contents;
    m_replace_contents_isSet = true;
}

bool OAICreateUnreferencedMergeCommitInput_conflictResolution::is_replace_contents_Set() const{
    return m_replace_contents_isSet;
}

bool OAICreateUnreferencedMergeCommitInput_conflictResolution::is_replace_contents_Valid() const{
    return m_replace_contents_isValid;
}

QList OAICreateUnreferencedMergeCommitInput_conflictResolution::getDeleteFiles() const {
    return m_delete_files;
}
void OAICreateUnreferencedMergeCommitInput_conflictResolution::setDeleteFiles(const QList &delete_files) {
    m_delete_files = delete_files;
    m_delete_files_isSet = true;
}

bool OAICreateUnreferencedMergeCommitInput_conflictResolution::is_delete_files_Set() const{
    return m_delete_files_isSet;
}

bool OAICreateUnreferencedMergeCommitInput_conflictResolution::is_delete_files_Valid() const{
    return m_delete_files_isValid;
}

QList OAICreateUnreferencedMergeCommitInput_conflictResolution::getSetFileModes() const {
    return m_set_file_modes;
}
void OAICreateUnreferencedMergeCommitInput_conflictResolution::setSetFileModes(const QList &set_file_modes) {
    m_set_file_modes = set_file_modes;
    m_set_file_modes_isSet = true;
}

bool OAICreateUnreferencedMergeCommitInput_conflictResolution::is_set_file_modes_Set() const{
    return m_set_file_modes_isSet;
}

bool OAICreateUnreferencedMergeCommitInput_conflictResolution::is_set_file_modes_Valid() const{
    return m_set_file_modes_isValid;
}

bool OAICreateUnreferencedMergeCommitInput_conflictResolution::isSet() const {
...
bool OAICreateUnreferencedMergeCommitInput_conflictResolution::isValid() const {
