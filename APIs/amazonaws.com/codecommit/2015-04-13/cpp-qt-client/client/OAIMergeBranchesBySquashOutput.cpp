...
OAIMergeBranchesBySquashOutput::OAIMergeBranchesBySquashOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMergeBranchesBySquashOutput::OAIMergeBranchesBySquashOutput() {
    this->initializeModel();
}

OAIMergeBranchesBySquashOutput::~OAIMergeBranchesBySquashOutput() {}

void OAIMergeBranchesBySquashOutput::initializeModel() {
...
void OAIMergeBranchesBySquashOutput::fromJson(QString jsonString) {
...
void OAIMergeBranchesBySquashOutput::fromJsonObject(QJsonObject json) {
...
QString OAIMergeBranchesBySquashOutput::asJson() const {
...
QJsonObject OAIMergeBranchesBySquashOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIMergeBranchesBySquashOutput::getCommitId() const {
    return m_commit_id;
}
void OAIMergeBranchesBySquashOutput::setCommitId(const QString &commit_id) {
    m_commit_id = commit_id;
    m_commit_id_isSet = true;
}

bool OAIMergeBranchesBySquashOutput::is_commit_id_Set() const{
    return m_commit_id_isSet;
}

bool OAIMergeBranchesBySquashOutput::is_commit_id_Valid() const{
    return m_commit_id_isValid;
}

QString OAIMergeBranchesBySquashOutput::getTreeId() const {
    return m_tree_id;
}
void OAIMergeBranchesBySquashOutput::setTreeId(const QString &tree_id) {
    m_tree_id = tree_id;
    m_tree_id_isSet = true;
}

bool OAIMergeBranchesBySquashOutput::is_tree_id_Set() const{
    return m_tree_id_isSet;
}

bool OAIMergeBranchesBySquashOutput::is_tree_id_Valid() const{
    return m_tree_id_isValid;
}

bool OAIMergeBranchesBySquashOutput::isSet() const {
...
bool OAIMergeBranchesBySquashOutput::isValid() const {
