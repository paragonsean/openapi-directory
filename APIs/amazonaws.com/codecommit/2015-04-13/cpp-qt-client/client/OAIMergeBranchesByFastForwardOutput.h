...
/*
 * OAIMergeBranchesByFastForwardOutput.h
 *
 * 
 */

#ifndef OAIMergeBranchesByFastForwardOutput_H
#define OAIMergeBranchesByFastForwardOutput_H
...
class OAIMergeBranchesByFastForwardOutput : public OAIObject {
public:
    OAIMergeBranchesByFastForwardOutput();
    OAIMergeBranchesByFastForwardOutput(QString json);
    ~OAIMergeBranchesByFastForwardOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMergeBranchesByFastForwardOutput)

#endif // OAIMergeBranchesByFastForwardOutput_H
