...
/*
 * OAIPostCommentReplyInput.h
 *
 * 
 */

#ifndef OAIPostCommentReplyInput_H
#define OAIPostCommentReplyInput_H
...
class OAIPostCommentReplyInput : public OAIObject {
public:
    OAIPostCommentReplyInput();
    OAIPostCommentReplyInput(QString json);
    ~OAIPostCommentReplyInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostCommentReplyInput)

#endif // OAIPostCommentReplyInput_H
