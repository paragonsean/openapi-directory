...
OAIPostCommentForComparedCommitOutput_comment::OAIPostCommentForComparedCommitOutput_comment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPostCommentForComparedCommitOutput_comment::OAIPostCommentForComparedCommitOutput_comment() {
    this->initializeModel();
}

OAIPostCommentForComparedCommitOutput_comment::~OAIPostCommentForComparedCommitOutput_comment() {}

void OAIPostCommentForComparedCommitOutput_comment::initializeModel() {
...
void OAIPostCommentForComparedCommitOutput_comment::fromJson(QString jsonString) {
...
void OAIPostCommentForComparedCommitOutput_comment::fromJsonObject(QJsonObject json) {
...
QString OAIPostCommentForComparedCommitOutput_comment::asJson() const {
...
QJsonObject OAIPostCommentForComparedCommitOutput_comment::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPostCommentForComparedCommitOutput_comment::getCommentId() const {
    return m_comment_id;
}
void OAIPostCommentForComparedCommitOutput_comment::setCommentId(const QString &comment_id) {
    m_comment_id = comment_id;
    m_comment_id_isSet = true;
}

bool OAIPostCommentForComparedCommitOutput_comment::is_comment_id_Set() const{
    return m_comment_id_isSet;
}

bool OAIPostCommentForComparedCommitOutput_comment::is_comment_id_Valid() const{
    return m_comment_id_isValid;
}

QString OAIPostCommentForComparedCommitOutput_comment::getContent() const {
    return m_content;
}
void OAIPostCommentForComparedCommitOutput_comment::setContent(const QString &content) {
    m_content = content;
    m_content_isSet = true;
}

bool OAIPostCommentForComparedCommitOutput_comment::is_content_Set() const{
    return m_content_isSet;
}

bool OAIPostCommentForComparedCommitOutput_comment::is_content_Valid() const{
    return m_content_isValid;
}

QString OAIPostCommentForComparedCommitOutput_comment::getInReplyTo() const {
    return m_in_reply_to;
}
void OAIPostCommentForComparedCommitOutput_comment::setInReplyTo(const QString &in_reply_to) {
    m_in_reply_to = in_reply_to;
    m_in_reply_to_isSet = true;
}

bool OAIPostCommentForComparedCommitOutput_comment::is_in_reply_to_Set() const{
    return m_in_reply_to_isSet;
}

bool OAIPostCommentForComparedCommitOutput_comment::is_in_reply_to_Valid() const{
    return m_in_reply_to_isValid;
}

QDateTime OAIPostCommentForComparedCommitOutput_comment::getCreationDate() const {
    return m_creation_date;
}
void OAIPostCommentForComparedCommitOutput_comment::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAIPostCommentForComparedCommitOutput_comment::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAIPostCommentForComparedCommitOutput_comment::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

QDateTime OAIPostCommentForComparedCommitOutput_comment::getLastModifiedDate() const {
    return m_last_modified_date;
}
void OAIPostCommentForComparedCommitOutput_comment::setLastModifiedDate(const QDateTime &last_modified_date) {
    m_last_modified_date = last_modified_date;
    m_last_modified_date_isSet = true;
}

bool OAIPostCommentForComparedCommitOutput_comment::is_last_modified_date_Set() const{
    return m_last_modified_date_isSet;
}

bool OAIPostCommentForComparedCommitOutput_comment::is_last_modified_date_Valid() const{
    return m_last_modified_date_isValid;
}

QString OAIPostCommentForComparedCommitOutput_comment::getAuthorArn() const {
    return m_author_arn;
}
void OAIPostCommentForComparedCommitOutput_comment::setAuthorArn(const QString &author_arn) {
    m_author_arn = author_arn;
    m_author_arn_isSet = true;
}

bool OAIPostCommentForComparedCommitOutput_comment::is_author_arn_Set() const{
    return m_author_arn_isSet;
}

bool OAIPostCommentForComparedCommitOutput_comment::is_author_arn_Valid() const{
    return m_author_arn_isValid;
}

bool OAIPostCommentForComparedCommitOutput_comment::getDeleted() const {
    return m_deleted;
}
void OAIPostCommentForComparedCommitOutput_comment::setDeleted(const bool &deleted) {
    m_deleted = deleted;
    m_deleted_isSet = true;
}

bool OAIPostCommentForComparedCommitOutput_comment::is_deleted_Set() const{
    return m_deleted_isSet;
}

bool OAIPostCommentForComparedCommitOutput_comment::is_deleted_Valid() const{
    return m_deleted_isValid;
}

QString OAIPostCommentForComparedCommitOutput_comment::getClientRequestToken() const {
    return m_client_request_token;
}
void OAIPostCommentForComparedCommitOutput_comment::setClientRequestToken(const QString &client_request_token) {
    m_client_request_token = client_request_token;
    m_client_request_token_isSet = true;
}

bool OAIPostCommentForComparedCommitOutput_comment::is_client_request_token_Set() const{
    return m_client_request_token_isSet;
}

bool OAIPostCommentForComparedCommitOutput_comment::is_client_request_token_Valid() const{
    return m_client_request_token_isValid;
}

QList OAIPostCommentForComparedCommitOutput_comment::getCallerReactions() const {
    return m_caller_reactions;
}
void OAIPostCommentForComparedCommitOutput_comment::setCallerReactions(const QList &caller_reactions) {
    m_caller_reactions = caller_reactions;
    m_caller_reactions_isSet = true;
}

bool OAIPostCommentForComparedCommitOutput_comment::is_caller_reactions_Set() const{
    return m_caller_reactions_isSet;
}

bool OAIPostCommentForComparedCommitOutput_comment::is_caller_reactions_Valid() const{
    return m_caller_reactions_isValid;
}

QMap OAIPostCommentForComparedCommitOutput_comment::getReactionCounts() const {
    return m_reaction_counts;
}
void OAIPostCommentForComparedCommitOutput_comment::setReactionCounts(const QMap &reaction_counts) {
    m_reaction_counts = reaction_counts;
    m_reaction_counts_isSet = true;
}

bool OAIPostCommentForComparedCommitOutput_comment::is_reaction_counts_Set() const{
    return m_reaction_counts_isSet;
}

bool OAIPostCommentForComparedCommitOutput_comment::is_reaction_counts_Valid() const{
    return m_reaction_counts_isValid;
}

bool OAIPostCommentForComparedCommitOutput_comment::isSet() const {
...
bool OAIPostCommentForComparedCommitOutput_comment::isValid() const {
