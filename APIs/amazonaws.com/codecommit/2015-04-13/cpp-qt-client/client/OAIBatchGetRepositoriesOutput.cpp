...
OAIBatchGetRepositoriesOutput::OAIBatchGetRepositoriesOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchGetRepositoriesOutput::OAIBatchGetRepositoriesOutput() {
    this->initializeModel();
}

OAIBatchGetRepositoriesOutput::~OAIBatchGetRepositoriesOutput() {}

void OAIBatchGetRepositoriesOutput::initializeModel() {

    m_repositories_isSet = false;
    m_repositories_isValid = false;

    m_repositories_not_found_isSet = false;
    m_repositories_not_found_isValid = false;
}

void OAIBatchGetRepositoriesOutput::fromJson(QString jsonString) {
...
void OAIBatchGetRepositoriesOutput::fromJsonObject(QJsonObject json) {
    ...
    m_repositories_not_found_isValid = ::OpenAPI::fromJsonValue(m_repositories_not_found, json[QString("repositoriesNotFound")]);
    m_repositories_not_found_isSet = !json[QString("repositoriesNotFound")].isNull() && m_repositories_not_found_isValid;
}

QString OAIBatchGetRepositoriesOutput::asJson() const {
...
QJsonObject OAIBatchGetRepositoriesOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_repositories.isSet()) {
        obj.insert(QString("repositories"), ::OpenAPI::toJsonValue(m_repositories));
    }
    if (m_repositories_not_found.isSet()) {
        obj.insert(QString("repositoriesNotFound"), ::OpenAPI::toJsonValue(m_repositories_not_found));
    }
    return obj;
}

QList OAIBatchGetRepositoriesOutput::getRepositories() const {
    return m_repositories;
}
void OAIBatchGetRepositoriesOutput::setRepositories(const QList &repositories) {
    m_repositories = repositories;
    m_repositories_isSet = true;
}

bool OAIBatchGetRepositoriesOutput::is_repositories_Set() const{
    return m_repositories_isSet;
}

bool OAIBatchGetRepositoriesOutput::is_repositories_Valid() const{
    return m_repositories_isValid;
}

QList OAIBatchGetRepositoriesOutput::getRepositoriesNotFound() const {
    return m_repositories_not_found;
}
void OAIBatchGetRepositoriesOutput::setRepositoriesNotFound(const QList &repositories_not_found) {
    m_repositories_not_found = repositories_not_found;
    m_repositories_not_found_isSet = true;
}

bool OAIBatchGetRepositoriesOutput::is_repositories_not_found_Set() const{
    return m_repositories_not_found_isSet;
}

bool OAIBatchGetRepositoriesOutput::is_repositories_not_found_Valid() const{
    return m_repositories_not_found_isValid;
}

bool OAIBatchGetRepositoriesOutput::isSet() const {
...
bool OAIBatchGetRepositoriesOutput::isValid() const {
