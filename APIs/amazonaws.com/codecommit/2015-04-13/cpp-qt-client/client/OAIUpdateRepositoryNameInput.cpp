...
OAIUpdateRepositoryNameInput::OAIUpdateRepositoryNameInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateRepositoryNameInput::OAIUpdateRepositoryNameInput() {
    this->initializeModel();
}

OAIUpdateRepositoryNameInput::~OAIUpdateRepositoryNameInput() {}

void OAIUpdateRepositoryNameInput::initializeModel() {
...
void OAIUpdateRepositoryNameInput::fromJson(QString jsonString) {
...
void OAIUpdateRepositoryNameInput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateRepositoryNameInput::asJson() const {
...
QJsonObject OAIUpdateRepositoryNameInput::asJsonObject() const {
    QJsonObject obj;
    if (m_old_name_isSet) {
...
QString OAIUpdateRepositoryNameInput::getOldName() const {
    return m_old_name;
}
void OAIUpdateRepositoryNameInput::setOldName(const QString &old_name) {
    m_old_name = old_name;
    m_old_name_isSet = true;
}

bool OAIUpdateRepositoryNameInput::is_old_name_Set() const{
    return m_old_name_isSet;
}

bool OAIUpdateRepositoryNameInput::is_old_name_Valid() const{
    return m_old_name_isValid;
}

QString OAIUpdateRepositoryNameInput::getNewName() const {
    return m_new_name;
}
void OAIUpdateRepositoryNameInput::setNewName(const QString &new_name) {
    m_new_name = new_name;
    m_new_name_isSet = true;
}

bool OAIUpdateRepositoryNameInput::is_new_name_Set() const{
    return m_new_name_isSet;
}

bool OAIUpdateRepositoryNameInput::is_new_name_Valid() const{
    return m_new_name_isValid;
}

bool OAIUpdateRepositoryNameInput::isSet() const {
...
bool OAIUpdateRepositoryNameInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_old_name_isValid && m_new_name_isValid && true;
}
