...
OAIEvaluatePullRequestApprovalRulesOutput::OAIEvaluatePullRequestApprovalRulesOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEvaluatePullRequestApprovalRulesOutput::OAIEvaluatePullRequestApprovalRulesOutput() {
    this->initializeModel();
}

OAIEvaluatePullRequestApprovalRulesOutput::~OAIEvaluatePullRequestApprovalRulesOutput() {}

void OAIEvaluatePullRequestApprovalRulesOutput::initializeModel() {

    m_evaluation_isSet = false;
    m_evaluation_isValid = false;
}

void OAIEvaluatePullRequestApprovalRulesOutput::fromJson(QString jsonString) {
...
void OAIEvaluatePullRequestApprovalRulesOutput::fromJsonObject(QJsonObject json) {
...
QString OAIEvaluatePullRequestApprovalRulesOutput::asJson() const {
...
QJsonObject OAIEvaluatePullRequestApprovalRulesOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIEvaluatePullRequestApprovalRulesOutput_evaluation OAIEvaluatePullRequestApprovalRulesOutput::getEvaluation() const {
    return m_evaluation;
}
void OAIEvaluatePullRequestApprovalRulesOutput::setEvaluation(const OAIEvaluatePullRequestApprovalRulesOutput_evaluation &evaluation) {
    m_evaluation = evaluation;
    m_evaluation_isSet = true;
}

bool OAIEvaluatePullRequestApprovalRulesOutput::is_evaluation_Set() const{
    return m_evaluation_isSet;
}

bool OAIEvaluatePullRequestApprovalRulesOutput::is_evaluation_Valid() const{
    return m_evaluation_isValid;
}

bool OAIEvaluatePullRequestApprovalRulesOutput::isSet() const {
...
bool OAIEvaluatePullRequestApprovalRulesOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_evaluation_isValid && true;
}
