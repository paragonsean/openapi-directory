...
/*
 * OAIGetPullRequestOverrideStateInput.h
 *
 * 
 */

#ifndef OAIGetPullRequestOverrideStateInput_H
#define OAIGetPullRequestOverrideStateInput_H
...
class OAIGetPullRequestOverrideStateInput : public OAIObject {
public:
    OAIGetPullRequestOverrideStateInput();
    OAIGetPullRequestOverrideStateInput(QString json);
    ~OAIGetPullRequestOverrideStateInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPullRequestOverrideStateInput)

#endif // OAIGetPullRequestOverrideStateInput_H
