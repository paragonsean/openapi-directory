...
OAIFileModeTypeEnum::OAIFileModeTypeEnum(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFileModeTypeEnum::OAIFileModeTypeEnum() {
    this->initializeModel();
}

OAIFileModeTypeEnum::~OAIFileModeTypeEnum() {}

void OAIFileModeTypeEnum::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFileModeTypeEnum::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFileModeTypeEnum::fromJson(QString jsonString) {
    
    if ( jsonString.compare("EXECUTABLE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFileModeTypeEnum::EXECUTABLE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("NORMAL", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFileModeTypeEnum::NORMAL;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SYMLINK", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFileModeTypeEnum::SYMLINK;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFileModeTypeEnum::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFileModeTypeEnum::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFileModeTypeEnum::EXECUTABLE:
            val = "EXECUTABLE";
            break;
        case eOAIFileModeTypeEnum::NORMAL:
            val = "NORMAL";
            break;
        case eOAIFileModeTypeEnum::SYMLINK:
            val = "SYMLINK";
            break;
        default:
            break;
...
QJsonValue OAIFileModeTypeEnum::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFileModeTypeEnum::eOAIFileModeTypeEnum OAIFileModeTypeEnum::getValue() const {
    return m_value;
}

void OAIFileModeTypeEnum::setValue(const OAIFileModeTypeEnum::eOAIFileModeTypeEnum& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFileModeTypeEnum::isSet() const {
    
    return m_value_isSet;
}

bool OAIFileModeTypeEnum::isValid() const {
