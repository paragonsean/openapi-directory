...
OAIGetPullRequestOverrideStateOutput::OAIGetPullRequestOverrideStateOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPullRequestOverrideStateOutput::OAIGetPullRequestOverrideStateOutput() {
    this->initializeModel();
}

OAIGetPullRequestOverrideStateOutput::~OAIGetPullRequestOverrideStateOutput() {}

void OAIGetPullRequestOverrideStateOutput::initializeModel() {

    m_overridden_isSet = false;
    m_overridden_isValid = false;

    m_overrider_isSet = false;
    m_overrider_isValid = false;
}

void OAIGetPullRequestOverrideStateOutput::fromJson(QString jsonString) {
...
void OAIGetPullRequestOverrideStateOutput::fromJsonObject(QJsonObject json) {
    ...
    m_overrider_isValid = ::OpenAPI::fromJsonValue(m_overrider, json[QString("overrider")]);
    m_overrider_isSet = !json[QString("overrider")].isNull() && m_overrider_isValid;
}

QString OAIGetPullRequestOverrideStateOutput::asJson() const {
...
QJsonObject OAIGetPullRequestOverrideStateOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_overridden_isSet) {
        obj.insert(QString("overridden"), ::OpenAPI::toJsonValue(m_overridden));
    }
    if (m_overrider_isSet) {
        obj.insert(QString("overrider"), ::OpenAPI::toJsonValue(m_overrider));
    }
    return obj;
}

bool OAIGetPullRequestOverrideStateOutput::getOverridden() const {
    return m_overridden;
}
void OAIGetPullRequestOverrideStateOutput::setOverridden(const bool &overridden) {
    m_overridden = overridden;
    m_overridden_isSet = true;
}

bool OAIGetPullRequestOverrideStateOutput::is_overridden_Set() const{
    return m_overridden_isSet;
}

bool OAIGetPullRequestOverrideStateOutput::is_overridden_Valid() const{
    return m_overridden_isValid;
}

QString OAIGetPullRequestOverrideStateOutput::getOverrider() const {
    return m_overrider;
}
void OAIGetPullRequestOverrideStateOutput::setOverrider(const QString &overrider) {
    m_overrider = overrider;
    m_overrider_isSet = true;
}

bool OAIGetPullRequestOverrideStateOutput::is_overrider_Set() const{
    return m_overrider_isSet;
}

bool OAIGetPullRequestOverrideStateOutput::is_overrider_Valid() const{
    return m_overrider_isValid;
}

bool OAIGetPullRequestOverrideStateOutput::isSet() const {
...
bool OAIGetPullRequestOverrideStateOutput::isValid() const {
