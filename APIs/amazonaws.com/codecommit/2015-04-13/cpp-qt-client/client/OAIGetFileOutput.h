...
#ifndef OAIGetFileOutput_H
#define OAIGetFileOutput_H
...
class OAIGetFileOutput : public OAIObject {
public:
    OAIGetFileOutput();
    OAIGetFileOutput(QString json);
    ~OAIGetFileOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetFileOutput)

#endif // OAIGetFileOutput_H
