...
/*
 * OAIPullRequestMergedStateChangedEventMetadata.h
 *
 * Returns information about the change in the merge state for a pull request event. 
 */

#ifndef OAIPullRequestMergedStateChangedEventMetadata_H
#define OAIPullRequestMergedStateChangedEventMetadata_H
...
class OAIPullRequestMergedStateChangedEventMetadata : public OAIObject {
public:
    OAIPullRequestMergedStateChangedEventMetadata();
    OAIPullRequestMergedStateChangedEventMetadata(QString json);
    ~OAIPullRequestMergedStateChangedEventMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPullRequestMergedStateChangedEventMetadata)

#endif // OAIPullRequestMergedStateChangedEventMetadata_H
