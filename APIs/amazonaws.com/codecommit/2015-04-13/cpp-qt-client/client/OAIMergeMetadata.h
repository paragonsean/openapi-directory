...
#ifndef OAIMergeMetadata_H
#define OAIMergeMetadata_H
...
class OAIMergeMetadata : public OAIObject {
public:
    OAIMergeMetadata();
    OAIMergeMetadata(QString json);
    ~OAIMergeMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMergeMetadata)

#endif // OAIMergeMetadata_H
