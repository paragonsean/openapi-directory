...
OAIDisassociateApprovalRuleTemplateFromRepositoryInput::OAIDisassociateApprovalRuleTemplateFromRepositoryInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDisassociateApprovalRuleTemplateFromRepositoryInput::OAIDisassociateApprovalRuleTemplateFromRepositoryInput() {
    this->initializeModel();
}

OAIDisassociateApprovalRuleTemplateFromRepositoryInput::~OAIDisassociateApprovalRuleTemplateFromRepositoryInput() {}

void OAIDisassociateApprovalRuleTemplateFromRepositoryInput::initializeModel() {
...
void OAIDisassociateApprovalRuleTemplateFromRepositoryInput::fromJson(QString jsonString) {
...
void OAIDisassociateApprovalRuleTemplateFromRepositoryInput::fromJsonObject(QJsonObject json) {
...
QString OAIDisassociateApprovalRuleTemplateFromRepositoryInput::asJson() const {
...
QJsonObject OAIDisassociateApprovalRuleTemplateFromRepositoryInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDisassociateApprovalRuleTemplateFromRepositoryInput::getApprovalRuleTemplateName() const {
    return m_approval_rule_template_name;
}
void OAIDisassociateApprovalRuleTemplateFromRepositoryInput::setApprovalRuleTemplateName(const QString &approval_rule_template_name) {
    m_approval_rule_template_name = approval_rule_template_name;
    m_approval_rule_template_name_isSet = true;
}

bool OAIDisassociateApprovalRuleTemplateFromRepositoryInput::is_approval_rule_template_name_Set() const{
    return m_approval_rule_template_name_isSet;
}

bool OAIDisassociateApprovalRuleTemplateFromRepositoryInput::is_approval_rule_template_name_Valid() const{
    return m_approval_rule_template_name_isValid;
}

QString OAIDisassociateApprovalRuleTemplateFromRepositoryInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIDisassociateApprovalRuleTemplateFromRepositoryInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIDisassociateApprovalRuleTemplateFromRepositoryInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIDisassociateApprovalRuleTemplateFromRepositoryInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

bool OAIDisassociateApprovalRuleTemplateFromRepositoryInput::isSet() const {
...
bool OAIDisassociateApprovalRuleTemplateFromRepositoryInput::isValid() const {
