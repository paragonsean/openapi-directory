...
/*
 * OAIMergeHunkDetail.h
 *
 * Information about the details of a merge hunk that contains a conflict in a merge or pull request operation.
 */

#ifndef OAIMergeHunkDetail_H
#define OAIMergeHunkDetail_H
...
class OAIMergeHunkDetail : public OAIObject {
public:
    OAIMergeHunkDetail();
    OAIMergeHunkDetail(QString json);
    ~OAIMergeHunkDetail() override;
    ...
    QString getHunkContent() const;
    void setHunkContent(const QString &hunk_content);
    bool is_hunk_content_Set() const;
    bool is_hunk_content_Valid() const;
...
private:
    ...
    QString m_hunk_content;
    bool m_hunk_content_isSet;
    bool m_hunk_content_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIMergeHunkDetail)

#endif // OAIMergeHunkDetail_H
