...
OAICreateUnreferencedMergeCommitOutput::OAICreateUnreferencedMergeCommitOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateUnreferencedMergeCommitOutput::OAICreateUnreferencedMergeCommitOutput() {
    this->initializeModel();
}

OAICreateUnreferencedMergeCommitOutput::~OAICreateUnreferencedMergeCommitOutput() {}

void OAICreateUnreferencedMergeCommitOutput::initializeModel() {
...
void OAICreateUnreferencedMergeCommitOutput::fromJson(QString jsonString) {
...
void OAICreateUnreferencedMergeCommitOutput::fromJsonObject(QJsonObject json) {
...
QString OAICreateUnreferencedMergeCommitOutput::asJson() const {
...
QJsonObject OAICreateUnreferencedMergeCommitOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateUnreferencedMergeCommitOutput::getCommitId() const {
    return m_commit_id;
}
void OAICreateUnreferencedMergeCommitOutput::setCommitId(const QString &commit_id) {
    m_commit_id = commit_id;
    m_commit_id_isSet = true;
}

bool OAICreateUnreferencedMergeCommitOutput::is_commit_id_Set() const{
    return m_commit_id_isSet;
}

bool OAICreateUnreferencedMergeCommitOutput::is_commit_id_Valid() const{
    return m_commit_id_isValid;
}

QString OAICreateUnreferencedMergeCommitOutput::getTreeId() const {
    return m_tree_id;
}
void OAICreateUnreferencedMergeCommitOutput::setTreeId(const QString &tree_id) {
    m_tree_id = tree_id;
    m_tree_id_isSet = true;
}

bool OAICreateUnreferencedMergeCommitOutput::is_tree_id_Set() const{
    return m_tree_id_isSet;
}

bool OAICreateUnreferencedMergeCommitOutput::is_tree_id_Valid() const{
    return m_tree_id_isValid;
}

bool OAICreateUnreferencedMergeCommitOutput::isSet() const {
...
bool OAICreateUnreferencedMergeCommitOutput::isValid() const {
