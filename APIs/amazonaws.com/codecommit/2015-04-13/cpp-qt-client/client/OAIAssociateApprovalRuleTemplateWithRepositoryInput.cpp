...
OAIAssociateApprovalRuleTemplateWithRepositoryInput::OAIAssociateApprovalRuleTemplateWithRepositoryInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssociateApprovalRuleTemplateWithRepositoryInput::OAIAssociateApprovalRuleTemplateWithRepositoryInput() {
    this->initializeModel();
}

OAIAssociateApprovalRuleTemplateWithRepositoryInput::~OAIAssociateApprovalRuleTemplateWithRepositoryInput() {}

void OAIAssociateApprovalRuleTemplateWithRepositoryInput::initializeModel() {
...
void OAIAssociateApprovalRuleTemplateWithRepositoryInput::fromJson(QString jsonString) {
...
void OAIAssociateApprovalRuleTemplateWithRepositoryInput::fromJsonObject(QJsonObject json) {
...
QString OAIAssociateApprovalRuleTemplateWithRepositoryInput::asJson() const {
...
QJsonObject OAIAssociateApprovalRuleTemplateWithRepositoryInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAssociateApprovalRuleTemplateWithRepositoryInput::getApprovalRuleTemplateName() const {
    return m_approval_rule_template_name;
}
void OAIAssociateApprovalRuleTemplateWithRepositoryInput::setApprovalRuleTemplateName(const QString &approval_rule_template_name) {
    m_approval_rule_template_name = approval_rule_template_name;
    m_approval_rule_template_name_isSet = true;
}

bool OAIAssociateApprovalRuleTemplateWithRepositoryInput::is_approval_rule_template_name_Set() const{
    return m_approval_rule_template_name_isSet;
}

bool OAIAssociateApprovalRuleTemplateWithRepositoryInput::is_approval_rule_template_name_Valid() const{
    return m_approval_rule_template_name_isValid;
}

QString OAIAssociateApprovalRuleTemplateWithRepositoryInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIAssociateApprovalRuleTemplateWithRepositoryInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIAssociateApprovalRuleTemplateWithRepositoryInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIAssociateApprovalRuleTemplateWithRepositoryInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

bool OAIAssociateApprovalRuleTemplateWithRepositoryInput::isSet() const {
...
bool OAIAssociateApprovalRuleTemplateWithRepositoryInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_approval_rule_template_name_isValid && m_repository_name_isValid && true;
}
