...
OAIGetCommentsForComparedCommitOutput::OAIGetCommentsForComparedCommitOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetCommentsForComparedCommitOutput::OAIGetCommentsForComparedCommitOutput() {
    this->initializeModel();
}

OAIGetCommentsForComparedCommitOutput::~OAIGetCommentsForComparedCommitOutput() {}

void OAIGetCommentsForComparedCommitOutput::initializeModel() {

    m_comments_for_compared_commit_data_isSet = false;
    m_comments_for_compared_commit_data_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIGetCommentsForComparedCommitOutput::fromJson(QString jsonString) {
...
void OAIGetCommentsForComparedCommitOutput::fromJsonObject(QJsonObject json) {

    m_comments_for_compared_commit_data_isValid = ::OpenAPI::fromJsonValue(m_comments_for_compared_commit_data, json[QString("commentsForComparedCommitData")]);
    m_comments_for_compared_commit_data_isSet = !json[QString("commentsForComparedCommitData")].isNull() && m_comments_for_compared_commit_data_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("nextToken")]);
    m_next_token_isSet = !json[QString("nextToken")].isNull() && m_next_token_isValid;
}

QString OAIGetCommentsForComparedCommitOutput::asJson() const {
...
QJsonObject OAIGetCommentsForComparedCommitOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_comments_for_compared_commit_data.isSet()) {
        obj.insert(QString("commentsForComparedCommitData"), ::OpenAPI::toJsonValue(m_comments_for_compared_commit_data));
    }
...
QList OAIGetCommentsForComparedCommitOutput::getCommentsForComparedCommitData() const {
    return m_comments_for_compared_commit_data;
}
void OAIGetCommentsForComparedCommitOutput::setCommentsForComparedCommitData(const QList &comments_for_compared_commit_data) {
    m_comments_for_compared_commit_data = comments_for_compared_commit_data;
    m_comments_for_compared_commit_data_isSet = true;
}

bool OAIGetCommentsForComparedCommitOutput::is_comments_for_compared_commit_data_Set() const{
    return m_comments_for_compared_commit_data_isSet;
}

bool OAIGetCommentsForComparedCommitOutput::is_comments_for_compared_commit_data_Valid() const{
    return m_comments_for_compared_commit_data_isValid;
}

QString OAIGetCommentsForComparedCommitOutput::getNextToken() const {
    return m_next_token;
}
void OAIGetCommentsForComparedCommitOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIGetCommentsForComparedCommitOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIGetCommentsForComparedCommitOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIGetCommentsForComparedCommitOutput::isSet() const {
...
bool OAIGetCommentsForComparedCommitOutput::isValid() const {
