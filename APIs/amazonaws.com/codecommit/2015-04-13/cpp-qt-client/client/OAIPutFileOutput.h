...
#ifndef OAIPutFileOutput_H
#define OAIPutFileOutput_H
...
class OAIPutFileOutput : public OAIObject {
public:
    OAIPutFileOutput();
    OAIPutFileOutput(QString json);
    ~OAIPutFileOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutFileOutput)

#endif // OAIPutFileOutput_H
