...
/*
 * OAICreateUnreferencedMergeCommitInput.h
 *
 * 
 */

#ifndef OAICreateUnreferencedMergeCommitInput_H
#define OAICreateUnreferencedMergeCommitInput_H

#include <QJsonObject>

#include "OAIConflictDetailLevelTypeEnum.h"
#include "OAIConflictResolutionStrategyTypeEnum.h"
#include "OAICreateUnreferencedMergeCommitInput_conflictResolution.h"
#include "OAIMergeOptionTypeEnum.h"
#include <QString>
...
namespace OpenAPI {
class OAICreateUnreferencedMergeCommitInput_conflictResolution;

class OAICreateUnreferencedMergeCommitInput : public OAIObject {
public:
    OAICreateUnreferencedMergeCommitInput();
    OAICreateUnreferencedMergeCommitInput(QString json);
    ~OAICreateUnreferencedMergeCommitInput() override;
    ...
    OAIMergeOptionTypeEnum getMergeOption() const;
    void setMergeOption(const OAIMergeOptionTypeEnum &merge_option);
    ...
    void setKeepEmptyFolders(const bool &keep_empty_folders);
    bool is_keep_empty_folders_Set() const;
    bool is_keep_empty_folders_Valid() const;

    OAICreateUnreferencedMergeCommitInput_conflictResolution getConflictResolution() const;
    void setConflictResolution(const OAICreateUnreferencedMergeCommitInput_conflictResolution &conflict_resolution);
...
private:
    ...
    OAIMergeOptionTypeEnum m_merge_option;
    ...
    bool m_keep_empty_folders;
    bool m_keep_empty_folders_isSet;
    bool m_keep_empty_folders_isValid;

    OAICreateUnreferencedMergeCommitInput_conflictResolution m_conflict_resolution;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUnreferencedMergeCommitInput)

#endif // OAICreateUnreferencedMergeCommitInput_H
