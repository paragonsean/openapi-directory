...
OAIGetPullRequestOutput::OAIGetPullRequestOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPullRequestOutput::OAIGetPullRequestOutput() {
    this->initializeModel();
}

OAIGetPullRequestOutput::~OAIGetPullRequestOutput() {}

void OAIGetPullRequestOutput::initializeModel() {

    m_pull_request_isSet = false;
    m_pull_request_isValid = false;
}

void OAIGetPullRequestOutput::fromJson(QString jsonString) {
...
void OAIGetPullRequestOutput::fromJsonObject(QJsonObject json) {
...
QString OAIGetPullRequestOutput::asJson() const {
...
QJsonObject OAIGetPullRequestOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIGetPullRequestOutput_pullRequest OAIGetPullRequestOutput::getPullRequest() const {
    return m_pull_request;
}
void OAIGetPullRequestOutput::setPullRequest(const OAIGetPullRequestOutput_pullRequest &pull_request) {
    m_pull_request = pull_request;
    m_pull_request_isSet = true;
}

bool OAIGetPullRequestOutput::is_pull_request_Set() const{
    return m_pull_request_isSet;
}

bool OAIGetPullRequestOutput::is_pull_request_Valid() const{
    return m_pull_request_isValid;
}

bool OAIGetPullRequestOutput::isSet() const {
...
bool OAIGetPullRequestOutput::isValid() const {
