...
/*
 * OAIRepositoryTriggerExecutionFailure.h
 *
 * A trigger failed to run.
 */

#ifndef OAIRepositoryTriggerExecutionFailure_H
#define OAIRepositoryTriggerExecutionFailure_H
...
class OAIRepositoryTriggerExecutionFailure : public OAIObject {
public:
    OAIRepositoryTriggerExecutionFailure();
    OAIRepositoryTriggerExecutionFailure(QString json);
    ~OAIRepositoryTriggerExecutionFailure() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRepositoryTriggerExecutionFailure)

#endif // OAIRepositoryTriggerExecutionFailure_H
