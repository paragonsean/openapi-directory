...
/*
 * OAICreateRepositoryOutput_repositoryMetadata.h
 *
 * 
 */

#ifndef OAICreateRepositoryOutput_repositoryMetadata_H
#define OAICreateRepositoryOutput_repositoryMetadata_H
...
class OAICreateRepositoryOutput_repositoryMetadata : public OAIObject {
public:
    OAICreateRepositoryOutput_repositoryMetadata();
    OAICreateRepositoryOutput_repositoryMetadata(QString json);
    ~OAICreateRepositoryOutput_repositoryMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRepositoryOutput_repositoryMetadata)

#endif // OAICreateRepositoryOutput_repositoryMetadata_H
