...
#ifndef OAIConflict_H
#define OAIConflict_H

#include <QJsonObject>

#include "OAIConflict_conflictMetadata.h"
#include <QList>
...
namespace OpenAPI {
class OAIConflict_conflictMetadata;

class OAIConflict : public OAIObject {
public:
    OAIConflict();
    OAIConflict(QString json);
    ~OAIConflict() override;
    ...
    OAIConflict_conflictMetadata getConflictMetadata() const;
    void setConflictMetadata(const OAIConflict_conflictMetadata &conflict_metadata);
...
private:
    ...
    OAIConflict_conflictMetadata m_conflict_metadata;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConflict)
