...
/*
 * OAIDifference_afterBlob.h
 *
 * 
 */

#ifndef OAIDifference_afterBlob_H
#define OAIDifference_afterBlob_H
...
class OAIDifference_afterBlob : public OAIObject {
public:
    OAIDifference_afterBlob();
    OAIDifference_afterBlob(QString json);
    ~OAIDifference_afterBlob() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDifference_afterBlob)

#endif // OAIDifference_afterBlob_H
