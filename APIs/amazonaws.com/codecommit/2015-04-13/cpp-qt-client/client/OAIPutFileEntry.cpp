...
OAIPutFileEntry::OAIPutFileEntry(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutFileEntry::OAIPutFileEntry() {
    this->initializeModel();
}

OAIPutFileEntry::~OAIPutFileEntry() {}

void OAIPutFileEntry::initializeModel() {
...
void OAIPutFileEntry::fromJson(QString jsonString) {
...
void OAIPutFileEntry::fromJsonObject(QJsonObject json) {
    ...
    m_file_content_isValid = ::OpenAPI::fromJsonValue(m_file_content, json[QString("fileContent")]);
    m_file_content_isSet = !json[QString("fileContent")].isNull() && m_file_content_isValid;
...
QString OAIPutFileEntry::asJson() const {
...
QJsonObject OAIPutFileEntry::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_file_content_isSet) {
        obj.insert(QString("fileContent"), ::OpenAPI::toJsonValue(m_file_content));
    }
    if (m_source_file.isSet()) {
        obj.insert(QString("sourceFile"), ::OpenAPI::toJsonValue(m_source_file));
    }
    return obj;
}

QString OAIPutFileEntry::getFilePath() const {
    return m_file_path;
}
void OAIPutFileEntry::setFilePath(const QString &file_path) {
    m_file_path = file_path;
    m_file_path_isSet = true;
}

bool OAIPutFileEntry::is_file_path_Set() const{
    return m_file_path_isSet;
}

bool OAIPutFileEntry::is_file_path_Valid() const{
    return m_file_path_isValid;
}

OAIFileModeTypeEnum OAIPutFileEntry::getFileMode() const {
    return m_file_mode;
}
void OAIPutFileEntry::setFileMode(const OAIFileModeTypeEnum &file_mode) {
    m_file_mode = file_mode;
    m_file_mode_isSet = true;
}

bool OAIPutFileEntry::is_file_mode_Set() const{
    return m_file_mode_isSet;
}

bool OAIPutFileEntry::is_file_mode_Valid() const{
    return m_file_mode_isValid;
}

QString OAIPutFileEntry::getFileContent() const {
    return m_file_content;
}
void OAIPutFileEntry::setFileContent(const QString &file_content) {
    m_file_content = file_content;
    m_file_content_isSet = true;
}

bool OAIPutFileEntry::is_file_content_Set() const{
    return m_file_content_isSet;
}

bool OAIPutFileEntry::is_file_content_Valid() const{
    return m_file_content_isValid;
}

OAIPutFileEntry_sourceFile OAIPutFileEntry::getSourceFile() const {
    return m_source_file;
}
void OAIPutFileEntry::setSourceFile(const OAIPutFileEntry_sourceFile &source_file) {
    m_source_file = source_file;
    m_source_file_isSet = true;
}

bool OAIPutFileEntry::is_source_file_Set() const{
    return m_source_file_isSet;
}

bool OAIPutFileEntry::is_source_file_Valid() const{
    return m_source_file_isValid;
}

bool OAIPutFileEntry::isSet() const {
...
bool OAIPutFileEntry::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_file_path_isValid && true;
}
