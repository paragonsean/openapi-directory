...
#include "OAIPullRequestTarget_mergeMetadata.h"
...
OAIPullRequestTarget_mergeMetadata::OAIPullRequestTarget_mergeMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPullRequestTarget_mergeMetadata::OAIPullRequestTarget_mergeMetadata() {
    this->initializeModel();
}

OAIPullRequestTarget_mergeMetadata::~OAIPullRequestTarget_mergeMetadata() {}

void OAIPullRequestTarget_mergeMetadata::initializeModel() {

    m_is_merged_isSet = false;
    m_is_merged_isValid = false;
...
void OAIPullRequestTarget_mergeMetadata::fromJson(QString jsonString) {
...
void OAIPullRequestTarget_mergeMetadata::fromJsonObject(QJsonObject json) {

    m_is_merged_isValid = ::OpenAPI::fromJsonValue(m_is_merged, json[QString("isMerged")]);
    m_is_merged_isSet = !json[QString("isMerged")].isNull() && m_is_merged_isValid;

    m_merged_by_isValid = ::OpenAPI::fromJsonValue(m_merged_by, json[QString("mergedBy")]);
    m_merged_by_isSet = !json[QString("mergedBy")].isNull() && m_merged_by_isValid;
...
QString OAIPullRequestTarget_mergeMetadata::asJson() const {
...
QJsonObject OAIPullRequestTarget_mergeMetadata::asJsonObject() const {
    QJsonObject obj;
    if (m_is_merged_isSet) {
        obj.insert(QString("isMerged"), ::OpenAPI::toJsonValue(m_is_merged));
    }
    if (m_merged_by_isSet) {
        obj.insert(QString("mergedBy"), ::OpenAPI::toJsonValue(m_merged_by));
    }
...
bool OAIPullRequestTarget_mergeMetadata::getIsMerged() const {
    return m_is_merged;
}
void OAIPullRequestTarget_mergeMetadata::setIsMerged(const bool &is_merged) {
    m_is_merged = is_merged;
    m_is_merged_isSet = true;
}

bool OAIPullRequestTarget_mergeMetadata::is_is_merged_Set() const{
    return m_is_merged_isSet;
}

bool OAIPullRequestTarget_mergeMetadata::is_is_merged_Valid() const{
    return m_is_merged_isValid;
}

QString OAIPullRequestTarget_mergeMetadata::getMergedBy() const {
    return m_merged_by;
}
void OAIPullRequestTarget_mergeMetadata::setMergedBy(const QString &merged_by) {
    m_merged_by = merged_by;
    m_merged_by_isSet = true;
}

bool OAIPullRequestTarget_mergeMetadata::is_merged_by_Set() const{
    return m_merged_by_isSet;
}

bool OAIPullRequestTarget_mergeMetadata::is_merged_by_Valid() const{
    return m_merged_by_isValid;
}

QString OAIPullRequestTarget_mergeMetadata::getMergeCommitId() const {
    return m_merge_commit_id;
}
void OAIPullRequestTarget_mergeMetadata::setMergeCommitId(const QString &merge_commit_id) {
    m_merge_commit_id = merge_commit_id;
    m_merge_commit_id_isSet = true;
}

bool OAIPullRequestTarget_mergeMetadata::is_merge_commit_id_Set() const{
    return m_merge_commit_id_isSet;
}

bool OAIPullRequestTarget_mergeMetadata::is_merge_commit_id_Valid() const{
    return m_merge_commit_id_isValid;
}

OAIMergeOptionTypeEnum OAIPullRequestTarget_mergeMetadata::getMergeOption() const {
    return m_merge_option;
}
void OAIPullRequestTarget_mergeMetadata::setMergeOption(const OAIMergeOptionTypeEnum &merge_option) {
    m_merge_option = merge_option;
    m_merge_option_isSet = true;
}

bool OAIPullRequestTarget_mergeMetadata::is_merge_option_Set() const{
    return m_merge_option_isSet;
}

bool OAIPullRequestTarget_mergeMetadata::is_merge_option_Valid() const{
    return m_merge_option_isValid;
}

bool OAIPullRequestTarget_mergeMetadata::isSet() const {
...
bool OAIPullRequestTarget_mergeMetadata::isValid() const {
