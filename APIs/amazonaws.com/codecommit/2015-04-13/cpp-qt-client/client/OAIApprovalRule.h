...
#ifndef OAIApprovalRule_H
#define OAIApprovalRule_H
...
class OAIApprovalRule : public OAIObject {
public:
    OAIApprovalRule();
    OAIApprovalRule(QString json);
    ~OAIApprovalRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApprovalRule)

#endif // OAIApprovalRule_H
