...
/*
 * OAIMergePullRequestByThreeWayInput.h
 *
 * 
 */

#ifndef OAIMergePullRequestByThreeWayInput_H
#define OAIMergePullRequestByThreeWayInput_H
...
class OAIMergePullRequestByThreeWayInput : public OAIObject {
public:
    OAIMergePullRequestByThreeWayInput();
    OAIMergePullRequestByThreeWayInput(QString json);
    ~OAIMergePullRequestByThreeWayInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMergePullRequestByThreeWayInput)

#endif // OAIMergePullRequestByThreeWayInput_H
