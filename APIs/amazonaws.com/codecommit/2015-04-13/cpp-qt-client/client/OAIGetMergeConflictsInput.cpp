...
OAIGetMergeConflictsInput::OAIGetMergeConflictsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetMergeConflictsInput::OAIGetMergeConflictsInput() {
    this->initializeModel();
}

OAIGetMergeConflictsInput::~OAIGetMergeConflictsInput() {}

void OAIGetMergeConflictsInput::initializeModel() {
...
void OAIGetMergeConflictsInput::fromJson(QString jsonString) {
...
void OAIGetMergeConflictsInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetMergeConflictsInput::asJson() const {
...
QJsonObject OAIGetMergeConflictsInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetMergeConflictsInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIGetMergeConflictsInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIGetMergeConflictsInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIGetMergeConflictsInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIGetMergeConflictsInput::getDestinationCommitSpecifier() const {
    return m_destination_commit_specifier;
}
void OAIGetMergeConflictsInput::setDestinationCommitSpecifier(const QString &destination_commit_specifier) {
    m_destination_commit_specifier = destination_commit_specifier;
    m_destination_commit_specifier_isSet = true;
}

bool OAIGetMergeConflictsInput::is_destination_commit_specifier_Set() const{
    return m_destination_commit_specifier_isSet;
}

bool OAIGetMergeConflictsInput::is_destination_commit_specifier_Valid() const{
    return m_destination_commit_specifier_isValid;
}

QString OAIGetMergeConflictsInput::getSourceCommitSpecifier() const {
    return m_source_commit_specifier;
}
void OAIGetMergeConflictsInput::setSourceCommitSpecifier(const QString &source_commit_specifier) {
    m_source_commit_specifier = source_commit_specifier;
    m_source_commit_specifier_isSet = true;
}

bool OAIGetMergeConflictsInput::is_source_commit_specifier_Set() const{
    return m_source_commit_specifier_isSet;
}

bool OAIGetMergeConflictsInput::is_source_commit_specifier_Valid() const{
    return m_source_commit_specifier_isValid;
}

OAIMergeOptionTypeEnum OAIGetMergeConflictsInput::getMergeOption() const {
    return m_merge_option;
}
void OAIGetMergeConflictsInput::setMergeOption(const OAIMergeOptionTypeEnum &merge_option) {
    m_merge_option = merge_option;
    m_merge_option_isSet = true;
}

bool OAIGetMergeConflictsInput::is_merge_option_Set() const{
    return m_merge_option_isSet;
}

bool OAIGetMergeConflictsInput::is_merge_option_Valid() const{
    return m_merge_option_isValid;
}

OAIConflictDetailLevelTypeEnum OAIGetMergeConflictsInput::getConflictDetailLevel() const {
    return m_conflict_detail_level;
}
void OAIGetMergeConflictsInput::setConflictDetailLevel(const OAIConflictDetailLevelTypeEnum &conflict_detail_level) {
    m_conflict_detail_level = conflict_detail_level;
    m_conflict_detail_level_isSet = true;
}

bool OAIGetMergeConflictsInput::is_conflict_detail_level_Set() const{
    return m_conflict_detail_level_isSet;
}

bool OAIGetMergeConflictsInput::is_conflict_detail_level_Valid() const{
    return m_conflict_detail_level_isValid;
}

qint32 OAIGetMergeConflictsInput::getMaxConflictFiles() const {
    return m_max_conflict_files;
}
void OAIGetMergeConflictsInput::setMaxConflictFiles(const qint32 &max_conflict_files) {
    m_max_conflict_files = max_conflict_files;
    m_max_conflict_files_isSet = true;
}

bool OAIGetMergeConflictsInput::is_max_conflict_files_Set() const{
    return m_max_conflict_files_isSet;
}

bool OAIGetMergeConflictsInput::is_max_conflict_files_Valid() const{
    return m_max_conflict_files_isValid;
}

OAIConflictResolutionStrategyTypeEnum OAIGetMergeConflictsInput::getConflictResolutionStrategy() const {
    return m_conflict_resolution_strategy;
}
void OAIGetMergeConflictsInput::setConflictResolutionStrategy(const OAIConflictResolutionStrategyTypeEnum &conflict_resolution_strategy) {
    m_conflict_resolution_strategy = conflict_resolution_strategy;
    m_conflict_resolution_strategy_isSet = true;
}

bool OAIGetMergeConflictsInput::is_conflict_resolution_strategy_Set() const{
    return m_conflict_resolution_strategy_isSet;
}

bool OAIGetMergeConflictsInput::is_conflict_resolution_strategy_Valid() const{
    return m_conflict_resolution_strategy_isValid;
}

QString OAIGetMergeConflictsInput::getNextToken() const {
    return m_next_token;
}
void OAIGetMergeConflictsInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIGetMergeConflictsInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIGetMergeConflictsInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIGetMergeConflictsInput::isSet() const {
...
bool OAIGetMergeConflictsInput::isValid() const {
