...
#ifndef OAIFileModes_H
#define OAIFileModes_H
...
class OAIFileModes : public OAIObject {
public:
    OAIFileModes();
    OAIFileModes(QString json);
    ~OAIFileModes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFileModes)

#endif // OAIFileModes_H
