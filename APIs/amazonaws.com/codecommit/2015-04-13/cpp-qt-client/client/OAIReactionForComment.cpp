...
#include "OAIReactionForComment.h"
...
OAIReactionForComment::OAIReactionForComment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReactionForComment::OAIReactionForComment() {
    this->initializeModel();
}

OAIReactionForComment::~OAIReactionForComment() {}

void OAIReactionForComment::initializeModel() {

    m_reaction_isSet = false;
    m_reaction_isValid = false;

    m_reaction_users_isSet = false;
    m_reaction_users_isValid = false;

    m_reactions_from_deleted_users_count_isSet = false;
    m_reactions_from_deleted_users_count_isValid = false;
}

void OAIReactionForComment::fromJson(QString jsonString) {
...
void OAIReactionForComment::fromJsonObject(QJsonObject json) {
    ...
    m_reaction_users_isValid = ::OpenAPI::fromJsonValue(m_reaction_users, json[QString("reactionUsers")]);
    m_reaction_users_isSet = !json[QString("reactionUsers")].isNull() && m_reaction_users_isValid;

    m_reactions_from_deleted_users_count_isValid = ::OpenAPI::fromJsonValue(m_reactions_from_deleted_users_count, json[QString("reactionsFromDeletedUsersCount")]);
    m_reactions_from_deleted_users_count_isSet = !json[QString("reactionsFromDeletedUsersCount")].isNull() && m_reactions_from_deleted_users_count_isValid;
}

QString OAIReactionForComment::asJson() const {
...
QJsonObject OAIReactionForComment::asJsonObject() const {
    QJsonObject obj;
    if (m_reaction.isSet()) {
        obj.insert(QString("reaction"), ::OpenAPI::toJsonValue(m_reaction));
    }
    if (m_reaction_users.isSet()) {
        obj.insert(QString("reactionUsers"), ::OpenAPI::toJsonValue(m_reaction_users));
    }
    if (m_reactions_from_deleted_users_count_isSet) {
        obj.insert(QString("reactionsFromDeletedUsersCount"), ::OpenAPI::toJsonValue(m_reactions_from_deleted_users_count));
    }
    return obj;
}

OAIReactionForComment_reaction OAIReactionForComment::getReaction() const {
    return m_reaction;
}
void OAIReactionForComment::setReaction(const OAIReactionForComment_reaction &reaction) {
    m_reaction = reaction;
    m_reaction_isSet = true;
}

bool OAIReactionForComment::is_reaction_Set() const{
    return m_reaction_isSet;
}

bool OAIReactionForComment::is_reaction_Valid() const{
    return m_reaction_isValid;
}

QList OAIReactionForComment::getReactionUsers() const {
    return m_reaction_users;
}
void OAIReactionForComment::setReactionUsers(const QList &reaction_users) {
    m_reaction_users = reaction_users;
    m_reaction_users_isSet = true;
}

bool OAIReactionForComment::is_reaction_users_Set() const{
    return m_reaction_users_isSet;
}

bool OAIReactionForComment::is_reaction_users_Valid() const{
    return m_reaction_users_isValid;
}

qint32 OAIReactionForComment::getReactionsFromDeletedUsersCount() const {
    return m_reactions_from_deleted_users_count;
}
void OAIReactionForComment::setReactionsFromDeletedUsersCount(const qint32 &reactions_from_deleted_users_count) {
    m_reactions_from_deleted_users_count = reactions_from_deleted_users_count;
    m_reactions_from_deleted_users_count_isSet = true;
}

bool OAIReactionForComment::is_reactions_from_deleted_users_count_Set() const{
    return m_reactions_from_deleted_users_count_isSet;
}

bool OAIReactionForComment::is_reactions_from_deleted_users_count_Valid() const{
    return m_reactions_from_deleted_users_count_isValid;
}

bool OAIReactionForComment::isSet() const {
...
bool OAIReactionForComment::isValid() const {
