...
/*
 * OAIGetMergeCommitOutput.h
 *
 * 
 */

#ifndef OAIGetMergeCommitOutput_H
#define OAIGetMergeCommitOutput_H
...
class OAIGetMergeCommitOutput : public OAIObject {
public:
    OAIGetMergeCommitOutput();
    OAIGetMergeCommitOutput(QString json);
    ~OAIGetMergeCommitOutput() override;
    ...
    QString getMergedCommitId() const;
    void setMergedCommitId(const QString &merged_commit_id);
    bool is_merged_commit_id_Set() const;
    bool is_merged_commit_id_Valid() const;
...
private:
    ...
    QString m_merged_commit_id;
    bool m_merged_commit_id_isSet;
    bool m_merged_commit_id_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetMergeCommitOutput)

#endif // OAIGetMergeCommitOutput_H
