...
/*
 * OAIUpdatePullRequestApprovalRuleContentInput.h
 *
 * 
 */

#ifndef OAIUpdatePullRequestApprovalRuleContentInput_H
#define OAIUpdatePullRequestApprovalRuleContentInput_H
...
class OAIUpdatePullRequestApprovalRuleContentInput : public OAIObject {
public:
    OAIUpdatePullRequestApprovalRuleContentInput();
    OAIUpdatePullRequestApprovalRuleContentInput(QString json);
    ~OAIUpdatePullRequestApprovalRuleContentInput() override;
    ...
    QString getExistingRuleContentSha256() const;
    void setExistingRuleContentSha256(const QString &existing_rule_content_sha256);
    bool is_existing_rule_content_sha256_Set() const;
    bool is_existing_rule_content_sha256_Valid() const;

    QString getNewRuleContent() const;
    void setNewRuleContent(const QString &new_rule_content);
    bool is_new_rule_content_Set() const;
    bool is_new_rule_content_Valid() const;
...
private:
    ...
    QString m_existing_rule_content_sha256;
    bool m_existing_rule_content_sha256_isSet;
    bool m_existing_rule_content_sha256_isValid;

    QString m_new_rule_content;
    bool m_new_rule_content_isSet;
    bool m_new_rule_content_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePullRequestApprovalRuleContentInput)

#endif // OAIUpdatePullRequestApprovalRuleContentInput_H
