...
#include "OAIPullRequestCreatedEventMetadata.h"
...
OAIPullRequestCreatedEventMetadata::OAIPullRequestCreatedEventMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPullRequestCreatedEventMetadata::OAIPullRequestCreatedEventMetadata() {
    this->initializeModel();
}

OAIPullRequestCreatedEventMetadata::~OAIPullRequestCreatedEventMetadata() {}

void OAIPullRequestCreatedEventMetadata::initializeModel() {
...
void OAIPullRequestCreatedEventMetadata::fromJson(QString jsonString) {
...
void OAIPullRequestCreatedEventMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIPullRequestCreatedEventMetadata::asJson() const {
...
QJsonObject OAIPullRequestCreatedEventMetadata::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPullRequestCreatedEventMetadata::getRepositoryName() const {
    return m_repository_name;
}
void OAIPullRequestCreatedEventMetadata::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIPullRequestCreatedEventMetadata::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIPullRequestCreatedEventMetadata::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIPullRequestCreatedEventMetadata::getSourceCommitId() const {
    return m_source_commit_id;
}
void OAIPullRequestCreatedEventMetadata::setSourceCommitId(const QString &source_commit_id) {
    m_source_commit_id = source_commit_id;
    m_source_commit_id_isSet = true;
}

bool OAIPullRequestCreatedEventMetadata::is_source_commit_id_Set() const{
    return m_source_commit_id_isSet;
}

bool OAIPullRequestCreatedEventMetadata::is_source_commit_id_Valid() const{
    return m_source_commit_id_isValid;
}

QString OAIPullRequestCreatedEventMetadata::getDestinationCommitId() const {
    return m_destination_commit_id;
}
void OAIPullRequestCreatedEventMetadata::setDestinationCommitId(const QString &destination_commit_id) {
    m_destination_commit_id = destination_commit_id;
    m_destination_commit_id_isSet = true;
}

bool OAIPullRequestCreatedEventMetadata::is_destination_commit_id_Set() const{
    return m_destination_commit_id_isSet;
}

bool OAIPullRequestCreatedEventMetadata::is_destination_commit_id_Valid() const{
    return m_destination_commit_id_isValid;
}

QString OAIPullRequestCreatedEventMetadata::getMergeBase() const {
    return m_merge_base;
}
void OAIPullRequestCreatedEventMetadata::setMergeBase(const QString &merge_base) {
    m_merge_base = merge_base;
    m_merge_base_isSet = true;
}

bool OAIPullRequestCreatedEventMetadata::is_merge_base_Set() const{
    return m_merge_base_isSet;
}

bool OAIPullRequestCreatedEventMetadata::is_merge_base_Valid() const{
    return m_merge_base_isValid;
}

bool OAIPullRequestCreatedEventMetadata::isSet() const {
...
bool OAIPullRequestCreatedEventMetadata::isValid() const {
