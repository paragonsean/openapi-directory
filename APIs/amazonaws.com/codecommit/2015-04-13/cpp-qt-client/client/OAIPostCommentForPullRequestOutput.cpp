...
OAIPostCommentForPullRequestOutput::OAIPostCommentForPullRequestOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPostCommentForPullRequestOutput::OAIPostCommentForPullRequestOutput() {
    this->initializeModel();
}

OAIPostCommentForPullRequestOutput::~OAIPostCommentForPullRequestOutput() {}

void OAIPostCommentForPullRequestOutput::initializeModel() {
    ...
    m_before_blob_id_isSet = false;
    m_before_blob_id_isValid = false;

    m_after_blob_id_isSet = false;
    m_after_blob_id_isValid = false;
...
void OAIPostCommentForPullRequestOutput::fromJson(QString jsonString) {
...
void OAIPostCommentForPullRequestOutput::fromJsonObject(QJsonObject json) {
    ...
    m_before_blob_id_isValid = ::OpenAPI::fromJsonValue(m_before_blob_id, json[QString("beforeBlobId")]);
    m_before_blob_id_isSet = !json[QString("beforeBlobId")].isNull() && m_before_blob_id_isValid;

    m_after_blob_id_isValid = ::OpenAPI::fromJsonValue(m_after_blob_id, json[QString("afterBlobId")]);
    m_after_blob_id_isSet = !json[QString("afterBlobId")].isNull() && m_after_blob_id_isValid;
...
QString OAIPostCommentForPullRequestOutput::asJson() const {
...
QJsonObject OAIPostCommentForPullRequestOutput::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_before_blob_id_isSet) {
        obj.insert(QString("beforeBlobId"), ::OpenAPI::toJsonValue(m_before_blob_id));
    }
    if (m_after_blob_id_isSet) {
        obj.insert(QString("afterBlobId"), ::OpenAPI::toJsonValue(m_after_blob_id));
    }
    if (m_location.isSet()) {
...
QString OAIPostCommentForPullRequestOutput::getRepositoryName() const {
    return m_repository_name;
}
void OAIPostCommentForPullRequestOutput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIPostCommentForPullRequestOutput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIPostCommentForPullRequestOutput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIPostCommentForPullRequestOutput::getPullRequestId() const {
    return m_pull_request_id;
}
void OAIPostCommentForPullRequestOutput::setPullRequestId(const QString &pull_request_id) {
    m_pull_request_id = pull_request_id;
    m_pull_request_id_isSet = true;
}

bool OAIPostCommentForPullRequestOutput::is_pull_request_id_Set() const{
    return m_pull_request_id_isSet;
}

bool OAIPostCommentForPullRequestOutput::is_pull_request_id_Valid() const{
    return m_pull_request_id_isValid;
}

QString OAIPostCommentForPullRequestOutput::getBeforeCommitId() const {
    return m_before_commit_id;
}
void OAIPostCommentForPullRequestOutput::setBeforeCommitId(const QString &before_commit_id) {
    m_before_commit_id = before_commit_id;
    m_before_commit_id_isSet = true;
}

bool OAIPostCommentForPullRequestOutput::is_before_commit_id_Set() const{
    return m_before_commit_id_isSet;
}

bool OAIPostCommentForPullRequestOutput::is_before_commit_id_Valid() const{
    return m_before_commit_id_isValid;
}

QString OAIPostCommentForPullRequestOutput::getAfterCommitId() const {
    return m_after_commit_id;
}
void OAIPostCommentForPullRequestOutput::setAfterCommitId(const QString &after_commit_id) {
    m_after_commit_id = after_commit_id;
    m_after_commit_id_isSet = true;
}

bool OAIPostCommentForPullRequestOutput::is_after_commit_id_Set() const{
    return m_after_commit_id_isSet;
}

bool OAIPostCommentForPullRequestOutput::is_after_commit_id_Valid() const{
    return m_after_commit_id_isValid;
}

QString OAIPostCommentForPullRequestOutput::getBeforeBlobId() const {
    return m_before_blob_id;
}
void OAIPostCommentForPullRequestOutput::setBeforeBlobId(const QString &before_blob_id) {
    m_before_blob_id = before_blob_id;
    m_before_blob_id_isSet = true;
}

bool OAIPostCommentForPullRequestOutput::is_before_blob_id_Set() const{
    return m_before_blob_id_isSet;
}

bool OAIPostCommentForPullRequestOutput::is_before_blob_id_Valid() const{
    return m_before_blob_id_isValid;
}

QString OAIPostCommentForPullRequestOutput::getAfterBlobId() const {
    return m_after_blob_id;
}
void OAIPostCommentForPullRequestOutput::setAfterBlobId(const QString &after_blob_id) {
    m_after_blob_id = after_blob_id;
    m_after_blob_id_isSet = true;
}

bool OAIPostCommentForPullRequestOutput::is_after_blob_id_Set() const{
    return m_after_blob_id_isSet;
}

bool OAIPostCommentForPullRequestOutput::is_after_blob_id_Valid() const{
    return m_after_blob_id_isValid;
}

OAIPostCommentForPullRequestOutput_location OAIPostCommentForPullRequestOutput::getLocation() const {
    return m_location;
}
void OAIPostCommentForPullRequestOutput::setLocation(const OAIPostCommentForPullRequestOutput_location &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIPostCommentForPullRequestOutput::is_location_Set() const{
    return m_location_isSet;
}

bool OAIPostCommentForPullRequestOutput::is_location_Valid() const{
    return m_location_isValid;
}

OAIPostCommentForComparedCommitOutput_comment OAIPostCommentForPullRequestOutput::getComment() const {
    return m_comment;
}
void OAIPostCommentForPullRequestOutput::setComment(const OAIPostCommentForComparedCommitOutput_comment &comment) {
    m_comment = comment;
    m_comment_isSet = true;
}

bool OAIPostCommentForPullRequestOutput::is_comment_Set() const{
    return m_comment_isSet;
}

bool OAIPostCommentForPullRequestOutput::is_comment_Valid() const{
    return m_comment_isValid;
}

bool OAIPostCommentForPullRequestOutput::isSet() const {
...
bool OAIPostCommentForPullRequestOutput::isValid() const {
