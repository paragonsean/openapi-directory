...
OAIPostCommentForComparedCommitInput_location::OAIPostCommentForComparedCommitInput_location(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPostCommentForComparedCommitInput_location::OAIPostCommentForComparedCommitInput_location() {
    this->initializeModel();
}

OAIPostCommentForComparedCommitInput_location::~OAIPostCommentForComparedCommitInput_location() {}

void OAIPostCommentForComparedCommitInput_location::initializeModel() {
...
void OAIPostCommentForComparedCommitInput_location::fromJson(QString jsonString) {
...
void OAIPostCommentForComparedCommitInput_location::fromJsonObject(QJsonObject json) {
...
QString OAIPostCommentForComparedCommitInput_location::asJson() const {
...
QJsonObject OAIPostCommentForComparedCommitInput_location::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPostCommentForComparedCommitInput_location::getFilePath() const {
    return m_file_path;
}
void OAIPostCommentForComparedCommitInput_location::setFilePath(const QString &file_path) {
    m_file_path = file_path;
    m_file_path_isSet = true;
}

bool OAIPostCommentForComparedCommitInput_location::is_file_path_Set() const{
    return m_file_path_isSet;
}

bool OAIPostCommentForComparedCommitInput_location::is_file_path_Valid() const{
    return m_file_path_isValid;
}

qint32 OAIPostCommentForComparedCommitInput_location::getFilePosition() const {
    return m_file_position;
}
void OAIPostCommentForComparedCommitInput_location::setFilePosition(const qint32 &file_position) {
    m_file_position = file_position;
    m_file_position_isSet = true;
}

bool OAIPostCommentForComparedCommitInput_location::is_file_position_Set() const{
    return m_file_position_isSet;
}

bool OAIPostCommentForComparedCommitInput_location::is_file_position_Valid() const{
    return m_file_position_isValid;
}

OAIRelativeFileVersionEnum OAIPostCommentForComparedCommitInput_location::getRelativeFileVersion() const {
    return m_relative_file_version;
}
void OAIPostCommentForComparedCommitInput_location::setRelativeFileVersion(const OAIRelativeFileVersionEnum &relative_file_version) {
    m_relative_file_version = relative_file_version;
    m_relative_file_version_isSet = true;
}

bool OAIPostCommentForComparedCommitInput_location::is_relative_file_version_Set() const{
    return m_relative_file_version_isSet;
}

bool OAIPostCommentForComparedCommitInput_location::is_relative_file_version_Valid() const{
    return m_relative_file_version_isValid;
}

bool OAIPostCommentForComparedCommitInput_location::isSet() const {
...
bool OAIPostCommentForComparedCommitInput_location::isValid() const {
