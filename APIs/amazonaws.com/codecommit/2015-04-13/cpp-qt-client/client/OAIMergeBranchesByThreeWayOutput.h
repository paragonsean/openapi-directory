...
/*
 * OAIMergeBranchesByThreeWayOutput.h
 *
 * 
 */

#ifndef OAIMergeBranchesByThreeWayOutput_H
#define OAIMergeBranchesByThreeWayOutput_H
...
class OAIMergeBranchesByThreeWayOutput : public OAIObject {
public:
    OAIMergeBranchesByThreeWayOutput();
    OAIMergeBranchesByThreeWayOutput(QString json);
    ~OAIMergeBranchesByThreeWayOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMergeBranchesByThreeWayOutput)

#endif // OAIMergeBranchesByThreeWayOutput_H
