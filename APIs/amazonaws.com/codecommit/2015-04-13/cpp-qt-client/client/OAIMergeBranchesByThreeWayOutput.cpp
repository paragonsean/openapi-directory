...
OAIMergeBranchesByThreeWayOutput::OAIMergeBranchesByThreeWayOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMergeBranchesByThreeWayOutput::OAIMergeBranchesByThreeWayOutput() {
    this->initializeModel();
}

OAIMergeBranchesByThreeWayOutput::~OAIMergeBranchesByThreeWayOutput() {}

void OAIMergeBranchesByThreeWayOutput::initializeModel() {
...
void OAIMergeBranchesByThreeWayOutput::fromJson(QString jsonString) {
...
void OAIMergeBranchesByThreeWayOutput::fromJsonObject(QJsonObject json) {
...
QString OAIMergeBranchesByThreeWayOutput::asJson() const {
...
QJsonObject OAIMergeBranchesByThreeWayOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIMergeBranchesByThreeWayOutput::getCommitId() const {
    return m_commit_id;
}
void OAIMergeBranchesByThreeWayOutput::setCommitId(const QString &commit_id) {
    m_commit_id = commit_id;
    m_commit_id_isSet = true;
}

bool OAIMergeBranchesByThreeWayOutput::is_commit_id_Set() const{
    return m_commit_id_isSet;
}

bool OAIMergeBranchesByThreeWayOutput::is_commit_id_Valid() const{
    return m_commit_id_isValid;
}

QString OAIMergeBranchesByThreeWayOutput::getTreeId() const {
    return m_tree_id;
}
void OAIMergeBranchesByThreeWayOutput::setTreeId(const QString &tree_id) {
    m_tree_id = tree_id;
    m_tree_id_isSet = true;
}

bool OAIMergeBranchesByThreeWayOutput::is_tree_id_Set() const{
    return m_tree_id_isSet;
}

bool OAIMergeBranchesByThreeWayOutput::is_tree_id_Valid() const{
    return m_tree_id_isValid;
}

bool OAIMergeBranchesByThreeWayOutput::isSet() const {
...
bool OAIMergeBranchesByThreeWayOutput::isValid() const {
