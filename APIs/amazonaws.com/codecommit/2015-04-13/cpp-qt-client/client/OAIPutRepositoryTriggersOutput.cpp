...
OAIPutRepositoryTriggersOutput::OAIPutRepositoryTriggersOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutRepositoryTriggersOutput::OAIPutRepositoryTriggersOutput() {
    this->initializeModel();
}

OAIPutRepositoryTriggersOutput::~OAIPutRepositoryTriggersOutput() {}

void OAIPutRepositoryTriggersOutput::initializeModel() {

    m_configuration_id_isSet = false;
    m_configuration_id_isValid = false;
}

void OAIPutRepositoryTriggersOutput::fromJson(QString jsonString) {
...
void OAIPutRepositoryTriggersOutput::fromJsonObject(QJsonObject json) {
...
QString OAIPutRepositoryTriggersOutput::asJson() const {
...
QJsonObject OAIPutRepositoryTriggersOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPutRepositoryTriggersOutput::getConfigurationId() const {
    return m_configuration_id;
}
void OAIPutRepositoryTriggersOutput::setConfigurationId(const QString &configuration_id) {
    m_configuration_id = configuration_id;
    m_configuration_id_isSet = true;
}

bool OAIPutRepositoryTriggersOutput::is_configuration_id_Set() const{
    return m_configuration_id_isSet;
}

bool OAIPutRepositoryTriggersOutput::is_configuration_id_Valid() const{
    return m_configuration_id_isValid;
}

bool OAIPutRepositoryTriggersOutput::isSet() const {
...
bool OAIPutRepositoryTriggersOutput::isValid() const {
