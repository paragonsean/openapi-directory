...
/*
 * OAIMergeBranchesBySquashOutput.h
 *
 * 
 */

#ifndef OAIMergeBranchesBySquashOutput_H
#define OAIMergeBranchesBySquashOutput_H
...
class OAIMergeBranchesBySquashOutput : public OAIObject {
public:
    OAIMergeBranchesBySquashOutput();
    OAIMergeBranchesBySquashOutput(QString json);
    ~OAIMergeBranchesBySquashOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMergeBranchesBySquashOutput)

#endif // OAIMergeBranchesBySquashOutput_H
