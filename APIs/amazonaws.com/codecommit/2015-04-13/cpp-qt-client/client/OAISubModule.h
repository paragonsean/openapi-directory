...
#ifndef OAISubModule_H
#define OAISubModule_H
...
class OAISubModule : public OAIObject {
public:
    OAISubModule();
    OAISubModule(QString json);
    ~OAISubModule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubModule)

#endif // OAISubModule_H
