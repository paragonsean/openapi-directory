...
OAIPostCommentReplyInput::OAIPostCommentReplyInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPostCommentReplyInput::OAIPostCommentReplyInput() {
    this->initializeModel();
}

OAIPostCommentReplyInput::~OAIPostCommentReplyInput() {}

void OAIPostCommentReplyInput::initializeModel() {
...
void OAIPostCommentReplyInput::fromJson(QString jsonString) {
...
void OAIPostCommentReplyInput::fromJsonObject(QJsonObject json) {
...
QString OAIPostCommentReplyInput::asJson() const {
...
QJsonObject OAIPostCommentReplyInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPostCommentReplyInput::getInReplyTo() const {
    return m_in_reply_to;
}
void OAIPostCommentReplyInput::setInReplyTo(const QString &in_reply_to) {
    m_in_reply_to = in_reply_to;
    m_in_reply_to_isSet = true;
}

bool OAIPostCommentReplyInput::is_in_reply_to_Set() const{
    return m_in_reply_to_isSet;
}

bool OAIPostCommentReplyInput::is_in_reply_to_Valid() const{
    return m_in_reply_to_isValid;
}

QString OAIPostCommentReplyInput::getClientRequestToken() const {
    return m_client_request_token;
}
void OAIPostCommentReplyInput::setClientRequestToken(const QString &client_request_token) {
    m_client_request_token = client_request_token;
    m_client_request_token_isSet = true;
}

bool OAIPostCommentReplyInput::is_client_request_token_Set() const{
    return m_client_request_token_isSet;
}

bool OAIPostCommentReplyInput::is_client_request_token_Valid() const{
    return m_client_request_token_isValid;
}

QString OAIPostCommentReplyInput::getContent() const {
    return m_content;
}
void OAIPostCommentReplyInput::setContent(const QString &content) {
    m_content = content;
    m_content_isSet = true;
}

bool OAIPostCommentReplyInput::is_content_Set() const{
    return m_content_isSet;
}

bool OAIPostCommentReplyInput::is_content_Valid() const{
    return m_content_isValid;
}

bool OAIPostCommentReplyInput::isSet() const {
...
bool OAIPostCommentReplyInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_in_reply_to_isValid && m_content_isValid && true;
}
