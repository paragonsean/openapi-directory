...
/*
 * OAIConflictMetadata_fileSizes.h
 *
 * 
 */

#ifndef OAIConflictMetadata_fileSizes_H
#define OAIConflictMetadata_fileSizes_H
...
class OAIConflictMetadata_fileSizes : public OAIObject {
public:
    OAIConflictMetadata_fileSizes();
    OAIConflictMetadata_fileSizes(QString json);
    ~OAIConflictMetadata_fileSizes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConflictMetadata_fileSizes)

#endif // OAIConflictMetadata_fileSizes_H
