...
#include "OAIDeleteBranchOutput_deletedBranch.h"
...
OAIDeleteBranchOutput_deletedBranch::OAIDeleteBranchOutput_deletedBranch(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteBranchOutput_deletedBranch::OAIDeleteBranchOutput_deletedBranch() {
    this->initializeModel();
}

OAIDeleteBranchOutput_deletedBranch::~OAIDeleteBranchOutput_deletedBranch() {}

void OAIDeleteBranchOutput_deletedBranch::initializeModel() {
...
void OAIDeleteBranchOutput_deletedBranch::fromJson(QString jsonString) {
...
void OAIDeleteBranchOutput_deletedBranch::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteBranchOutput_deletedBranch::asJson() const {
...
QJsonObject OAIDeleteBranchOutput_deletedBranch::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteBranchOutput_deletedBranch::getBranchName() const {
    return m_branch_name;
}
void OAIDeleteBranchOutput_deletedBranch::setBranchName(const QString &branch_name) {
    m_branch_name = branch_name;
    m_branch_name_isSet = true;
}

bool OAIDeleteBranchOutput_deletedBranch::is_branch_name_Set() const{
    return m_branch_name_isSet;
}

bool OAIDeleteBranchOutput_deletedBranch::is_branch_name_Valid() const{
    return m_branch_name_isValid;
}

QString OAIDeleteBranchOutput_deletedBranch::getCommitId() const {
    return m_commit_id;
}
void OAIDeleteBranchOutput_deletedBranch::setCommitId(const QString &commit_id) {
    m_commit_id = commit_id;
    m_commit_id_isSet = true;
}

bool OAIDeleteBranchOutput_deletedBranch::is_commit_id_Set() const{
    return m_commit_id_isSet;
}

bool OAIDeleteBranchOutput_deletedBranch::is_commit_id_Valid() const{
    return m_commit_id_isValid;
}

bool OAIDeleteBranchOutput_deletedBranch::isSet() const {
...
bool OAIDeleteBranchOutput_deletedBranch::isValid() const {
