...
QString OAIDeleteRepositoryInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIDeleteRepositoryInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIDeleteRepositoryInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIDeleteRepositoryInput::is_repository_name_Valid() const{
