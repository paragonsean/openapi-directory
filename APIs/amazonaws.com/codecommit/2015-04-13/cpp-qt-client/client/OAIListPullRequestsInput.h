...
/*
 * OAIListPullRequestsInput.h
 *
 * 
 */

#ifndef OAIListPullRequestsInput_H
#define OAIListPullRequestsInput_H
...
class OAIListPullRequestsInput : public OAIObject {
public:
    OAIListPullRequestsInput();
    OAIListPullRequestsInput(QString json);
    ~OAIListPullRequestsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPullRequestsInput)

#endif // OAIListPullRequestsInput_H
