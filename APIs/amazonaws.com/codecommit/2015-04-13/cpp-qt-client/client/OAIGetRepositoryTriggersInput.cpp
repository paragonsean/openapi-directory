...
OAIGetRepositoryTriggersInput::OAIGetRepositoryTriggersInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetRepositoryTriggersInput::OAIGetRepositoryTriggersInput() {
    this->initializeModel();
}

OAIGetRepositoryTriggersInput::~OAIGetRepositoryTriggersInput() {}

void OAIGetRepositoryTriggersInput::initializeModel() {

    m_repository_name_isSet = false;
    m_repository_name_isValid = false;
}

void OAIGetRepositoryTriggersInput::fromJson(QString jsonString) {
...
void OAIGetRepositoryTriggersInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetRepositoryTriggersInput::asJson() const {
...
QJsonObject OAIGetRepositoryTriggersInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetRepositoryTriggersInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIGetRepositoryTriggersInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIGetRepositoryTriggersInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIGetRepositoryTriggersInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

bool OAIGetRepositoryTriggersInput::isSet() const {
...
bool OAIGetRepositoryTriggersInput::isValid() const {
