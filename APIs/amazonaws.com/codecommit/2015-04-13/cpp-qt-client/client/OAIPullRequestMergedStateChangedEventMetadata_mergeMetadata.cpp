...
OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata::OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata::OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata() {
    this->initializeModel();
}

OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata::~OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata() {}

void OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata::initializeModel() {
...
void OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata::fromJson(QString jsonString) {
...
void OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata::asJson() const {
...
QJsonObject OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata::asJsonObject() const {
    QJsonObject obj;
...
bool OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata::getIsMerged() const {
    return m_is_merged;
}
void OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata::setIsMerged(const bool &is_merged) {
    m_is_merged = is_merged;
    m_is_merged_isSet = true;
}

bool OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata::is_is_merged_Set() const{
    return m_is_merged_isSet;
}

bool OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata::is_is_merged_Valid() const{
    return m_is_merged_isValid;
}

QString OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata::getMergedBy() const {
    return m_merged_by;
}
void OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata::setMergedBy(const QString &merged_by) {
    m_merged_by = merged_by;
    m_merged_by_isSet = true;
}

bool OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata::is_merged_by_Set() const{
    return m_merged_by_isSet;
}

bool OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata::is_merged_by_Valid() const{
    return m_merged_by_isValid;
}

QString OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata::getMergeCommitId() const {
    return m_merge_commit_id;
}
void OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata::setMergeCommitId(const QString &merge_commit_id) {
    m_merge_commit_id = merge_commit_id;
    m_merge_commit_id_isSet = true;
}

bool OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata::is_merge_commit_id_Set() const{
    return m_merge_commit_id_isSet;
}

bool OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata::is_merge_commit_id_Valid() const{
    return m_merge_commit_id_isValid;
}

OAIMergeOptionTypeEnum OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata::getMergeOption() const {
    return m_merge_option;
}
void OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata::setMergeOption(const OAIMergeOptionTypeEnum &merge_option) {
    m_merge_option = merge_option;
    m_merge_option_isSet = true;
}

bool OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata::is_merge_option_Set() const{
    return m_merge_option_isSet;
}

bool OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata::is_merge_option_Valid() const{
    return m_merge_option_isValid;
}

bool OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata::isSet() const {
...
bool OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata::isValid() const {
