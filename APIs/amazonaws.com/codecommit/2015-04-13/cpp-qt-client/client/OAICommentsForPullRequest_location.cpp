...
#include "OAICommentsForPullRequest_location.h"
...
OAICommentsForPullRequest_location::OAICommentsForPullRequest_location(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICommentsForPullRequest_location::OAICommentsForPullRequest_location() {
    this->initializeModel();
}

OAICommentsForPullRequest_location::~OAICommentsForPullRequest_location() {}

void OAICommentsForPullRequest_location::initializeModel() {
...
void OAICommentsForPullRequest_location::fromJson(QString jsonString) {
...
void OAICommentsForPullRequest_location::fromJsonObject(QJsonObject json) {
...
QString OAICommentsForPullRequest_location::asJson() const {
...
QJsonObject OAICommentsForPullRequest_location::asJsonObject() const {
    QJsonObject obj;
...
QString OAICommentsForPullRequest_location::getFilePath() const {
    return m_file_path;
}
void OAICommentsForPullRequest_location::setFilePath(const QString &file_path) {
    m_file_path = file_path;
    m_file_path_isSet = true;
}

bool OAICommentsForPullRequest_location::is_file_path_Set() const{
    return m_file_path_isSet;
}

bool OAICommentsForPullRequest_location::is_file_path_Valid() const{
    return m_file_path_isValid;
}

qint32 OAICommentsForPullRequest_location::getFilePosition() const {
    return m_file_position;
}
void OAICommentsForPullRequest_location::setFilePosition(const qint32 &file_position) {
    m_file_position = file_position;
    m_file_position_isSet = true;
}

bool OAICommentsForPullRequest_location::is_file_position_Set() const{
    return m_file_position_isSet;
}

bool OAICommentsForPullRequest_location::is_file_position_Valid() const{
    return m_file_position_isValid;
}

OAIRelativeFileVersionEnum OAICommentsForPullRequest_location::getRelativeFileVersion() const {
    return m_relative_file_version;
}
void OAICommentsForPullRequest_location::setRelativeFileVersion(const OAIRelativeFileVersionEnum &relative_file_version) {
    m_relative_file_version = relative_file_version;
    m_relative_file_version_isSet = true;
}

bool OAICommentsForPullRequest_location::is_relative_file_version_Set() const{
    return m_relative_file_version_isSet;
}

bool OAICommentsForPullRequest_location::is_relative_file_version_Valid() const{
    return m_relative_file_version_isValid;
}

bool OAICommentsForPullRequest_location::isSet() const {
...
bool OAICommentsForPullRequest_location::isValid() const {
