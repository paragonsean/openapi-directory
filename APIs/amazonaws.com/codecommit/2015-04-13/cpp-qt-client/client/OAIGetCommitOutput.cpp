...
OAIGetCommitOutput::OAIGetCommitOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetCommitOutput::OAIGetCommitOutput() {
    this->initializeModel();
}

OAIGetCommitOutput::~OAIGetCommitOutput() {}

void OAIGetCommitOutput::initializeModel() {

    m_commit_isSet = false;
    m_commit_isValid = false;
}

void OAIGetCommitOutput::fromJson(QString jsonString) {
...
void OAIGetCommitOutput::fromJsonObject(QJsonObject json) {
...
QString OAIGetCommitOutput::asJson() const {
...
QJsonObject OAIGetCommitOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_commit.isSet()) {
...
OAIGetCommitOutput_commit OAIGetCommitOutput::getCommit() const {
    return m_commit;
}
void OAIGetCommitOutput::setCommit(const OAIGetCommitOutput_commit &commit) {
    m_commit = commit;
    m_commit_isSet = true;
}

bool OAIGetCommitOutput::is_commit_Set() const{
    return m_commit_isSet;
}

bool OAIGetCommitOutput::is_commit_Valid() const{
    return m_commit_isValid;
}

bool OAIGetCommitOutput::isSet() const {
...
bool OAIGetCommitOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_commit_isValid && true;
}
