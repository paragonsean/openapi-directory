...
/*
 * OAIApprovalRuleEventMetadata.h
 *
 * Returns information about an event for an approval rule.
 */

#ifndef OAIApprovalRuleEventMetadata_H
#define OAIApprovalRuleEventMetadata_H
...
class OAIApprovalRuleEventMetadata : public OAIObject {
public:
    OAIApprovalRuleEventMetadata();
    OAIApprovalRuleEventMetadata(QString json);
    ~OAIApprovalRuleEventMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApprovalRuleEventMetadata)

#endif // OAIApprovalRuleEventMetadata_H
