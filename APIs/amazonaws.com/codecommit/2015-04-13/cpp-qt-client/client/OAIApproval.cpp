...
QString OAIApproval::getUserArn() const {
    return m_user_arn;
}
void OAIApproval::setUserArn(const QString &user_arn) {
    m_user_arn = user_arn;
    m_user_arn_isSet = true;
}

bool OAIApproval::is_user_arn_Set() const{
    return m_user_arn_isSet;
}

bool OAIApproval::is_user_arn_Valid() const{
    return m_user_arn_isValid;
}

OAIApprovalState OAIApproval::getApprovalState() const {
    return m_approval_state;
}
void OAIApproval::setApprovalState(const OAIApprovalState &approval_state) {
    m_approval_state = approval_state;
    m_approval_state_isSet = true;
}

bool OAIApproval::is_approval_state_Set() const{
    return m_approval_state_isSet;
}

bool OAIApproval::is_approval_state_Valid() const{
