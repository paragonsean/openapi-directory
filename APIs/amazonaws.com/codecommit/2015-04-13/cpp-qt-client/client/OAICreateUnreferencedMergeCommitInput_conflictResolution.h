...
/*
 * OAICreateUnreferencedMergeCommitInput_conflictResolution.h
 *
 * 
 */

#ifndef OAICreateUnreferencedMergeCommitInput_conflictResolution_H
#define OAICreateUnreferencedMergeCommitInput_conflictResolution_H
...
class OAICreateUnreferencedMergeCommitInput_conflictResolution : public OAIObject {
public:
    OAICreateUnreferencedMergeCommitInput_conflictResolution();
    OAICreateUnreferencedMergeCommitInput_conflictResolution(QString json);
    ~OAICreateUnreferencedMergeCommitInput_conflictResolution() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUnreferencedMergeCommitInput_conflictResolution)

#endif // OAICreateUnreferencedMergeCommitInput_conflictResolution_H
