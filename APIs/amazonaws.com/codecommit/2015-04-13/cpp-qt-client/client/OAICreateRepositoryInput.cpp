...
QString OAICreateRepositoryInput::getRepositoryName() const {
    return m_repository_name;
}
void OAICreateRepositoryInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAICreateRepositoryInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAICreateRepositoryInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAICreateRepositoryInput::getRepositoryDescription() const {
    return m_repository_description;
}
void OAICreateRepositoryInput::setRepositoryDescription(const QString &repository_description) {
    m_repository_description = repository_description;
    m_repository_description_isSet = true;
}

bool OAICreateRepositoryInput::is_repository_description_Set() const{
    return m_repository_description_isSet;
}

bool OAICreateRepositoryInput::is_repository_description_Valid() const{
    return m_repository_description_isValid;
}

QMap OAICreateRepositoryInput::getTags() const {
    return m_tags;
}
void OAICreateRepositoryInput::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
