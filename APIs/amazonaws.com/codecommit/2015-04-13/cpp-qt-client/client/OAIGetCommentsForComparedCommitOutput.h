...
/*
 * OAIGetCommentsForComparedCommitOutput.h
 *
 * 
 */

#ifndef OAIGetCommentsForComparedCommitOutput_H
#define OAIGetCommentsForComparedCommitOutput_H
...
class OAIGetCommentsForComparedCommitOutput : public OAIObject {
public:
    OAIGetCommentsForComparedCommitOutput();
    OAIGetCommentsForComparedCommitOutput(QString json);
    ~OAIGetCommentsForComparedCommitOutput() override;
    ...
    QList getCommentsForComparedCommitData() const;
    void setCommentsForComparedCommitData(const QList &comments_for_compared_commit_data);
    bool is_comments_for_compared_commit_data_Set() const;
    bool is_comments_for_compared_commit_data_Valid() const;
...
private:
    ...
    QList m_comments_for_compared_commit_data;
    bool m_comments_for_compared_commit_data_isSet;
    bool m_comments_for_compared_commit_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCommentsForComparedCommitOutput)

#endif // OAIGetCommentsForComparedCommitOutput_H
