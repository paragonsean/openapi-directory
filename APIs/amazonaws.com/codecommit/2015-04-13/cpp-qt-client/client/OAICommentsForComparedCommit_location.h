...
/*
 * OAICommentsForComparedCommit_location.h
 *
 * 
 */

#ifndef OAICommentsForComparedCommit_location_H
#define OAICommentsForComparedCommit_location_H
...
class OAICommentsForComparedCommit_location : public OAIObject {
public:
    OAICommentsForComparedCommit_location();
    OAICommentsForComparedCommit_location(QString json);
    ~OAICommentsForComparedCommit_location() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommentsForComparedCommit_location)

#endif // OAICommentsForComparedCommit_location_H
