...
OAIGetMergeCommitInput::OAIGetMergeCommitInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetMergeCommitInput::OAIGetMergeCommitInput() {
    this->initializeModel();
}

OAIGetMergeCommitInput::~OAIGetMergeCommitInput() {}

void OAIGetMergeCommitInput::initializeModel() {
...
void OAIGetMergeCommitInput::fromJson(QString jsonString) {
...
void OAIGetMergeCommitInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetMergeCommitInput::asJson() const {
...
QJsonObject OAIGetMergeCommitInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetMergeCommitInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIGetMergeCommitInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIGetMergeCommitInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIGetMergeCommitInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIGetMergeCommitInput::getSourceCommitSpecifier() const {
    return m_source_commit_specifier;
}
void OAIGetMergeCommitInput::setSourceCommitSpecifier(const QString &source_commit_specifier) {
    m_source_commit_specifier = source_commit_specifier;
    m_source_commit_specifier_isSet = true;
}

bool OAIGetMergeCommitInput::is_source_commit_specifier_Set() const{
    return m_source_commit_specifier_isSet;
}

bool OAIGetMergeCommitInput::is_source_commit_specifier_Valid() const{
    return m_source_commit_specifier_isValid;
}

QString OAIGetMergeCommitInput::getDestinationCommitSpecifier() const {
    return m_destination_commit_specifier;
}
void OAIGetMergeCommitInput::setDestinationCommitSpecifier(const QString &destination_commit_specifier) {
    m_destination_commit_specifier = destination_commit_specifier;
    m_destination_commit_specifier_isSet = true;
}

bool OAIGetMergeCommitInput::is_destination_commit_specifier_Set() const{
    return m_destination_commit_specifier_isSet;
}

bool OAIGetMergeCommitInput::is_destination_commit_specifier_Valid() const{
    return m_destination_commit_specifier_isValid;
}

OAIConflictDetailLevelTypeEnum OAIGetMergeCommitInput::getConflictDetailLevel() const {
    return m_conflict_detail_level;
}
void OAIGetMergeCommitInput::setConflictDetailLevel(const OAIConflictDetailLevelTypeEnum &conflict_detail_level) {
    m_conflict_detail_level = conflict_detail_level;
    m_conflict_detail_level_isSet = true;
}

bool OAIGetMergeCommitInput::is_conflict_detail_level_Set() const{
    return m_conflict_detail_level_isSet;
}

bool OAIGetMergeCommitInput::is_conflict_detail_level_Valid() const{
    return m_conflict_detail_level_isValid;
}

OAIConflictResolutionStrategyTypeEnum OAIGetMergeCommitInput::getConflictResolutionStrategy() const {
    return m_conflict_resolution_strategy;
}
void OAIGetMergeCommitInput::setConflictResolutionStrategy(const OAIConflictResolutionStrategyTypeEnum &conflict_resolution_strategy) {
    m_conflict_resolution_strategy = conflict_resolution_strategy;
    m_conflict_resolution_strategy_isSet = true;
}

bool OAIGetMergeCommitInput::is_conflict_resolution_strategy_Set() const{
    return m_conflict_resolution_strategy_isSet;
}

bool OAIGetMergeCommitInput::is_conflict_resolution_strategy_Valid() const{
    return m_conflict_resolution_strategy_isValid;
}

bool OAIGetMergeCommitInput::isSet() const {
...
bool OAIGetMergeCommitInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_repository_name_isValid && m_source_commit_specifier_isValid && m_destination_commit_specifier_isValid && true;
}
