...
/*
 * OAIApprovalRule_originApprovalRuleTemplate.h
 *
 * 
 */

#ifndef OAIApprovalRule_originApprovalRuleTemplate_H
#define OAIApprovalRule_originApprovalRuleTemplate_H
...
class OAIApprovalRule_originApprovalRuleTemplate : public OAIObject {
public:
    OAIApprovalRule_originApprovalRuleTemplate();
    OAIApprovalRule_originApprovalRuleTemplate(QString json);
    ~OAIApprovalRule_originApprovalRuleTemplate() override;
    ...
    QString getApprovalRuleTemplateId() const;
    void setApprovalRuleTemplateId(const QString &approval_rule_template_id);
    bool is_approval_rule_template_id_Set() const;
    bool is_approval_rule_template_id_Valid() const;

    QString getApprovalRuleTemplateName() const;
    void setApprovalRuleTemplateName(const QString &approval_rule_template_name);
    bool is_approval_rule_template_name_Set() const;
    bool is_approval_rule_template_name_Valid() const;
...
private:
    ...
    QString m_approval_rule_template_id;
    bool m_approval_rule_template_id_isSet;
    bool m_approval_rule_template_id_isValid;

    QString m_approval_rule_template_name;
    bool m_approval_rule_template_name_isSet;
    bool m_approval_rule_template_name_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIApprovalRule_originApprovalRuleTemplate)

#endif // OAIApprovalRule_originApprovalRuleTemplate_H
