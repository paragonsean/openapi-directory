...
OAIDescribeMergeConflictsOutput_conflictMetadata::OAIDescribeMergeConflictsOutput_conflictMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeMergeConflictsOutput_conflictMetadata::OAIDescribeMergeConflictsOutput_conflictMetadata() {
    this->initializeModel();
}

OAIDescribeMergeConflictsOutput_conflictMetadata::~OAIDescribeMergeConflictsOutput_conflictMetadata() {}

void OAIDescribeMergeConflictsOutput_conflictMetadata::initializeModel() {
...
void OAIDescribeMergeConflictsOutput_conflictMetadata::fromJson(QString jsonString) {
...
void OAIDescribeMergeConflictsOutput_conflictMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeMergeConflictsOutput_conflictMetadata::asJson() const {
...
QJsonObject OAIDescribeMergeConflictsOutput_conflictMetadata::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeMergeConflictsOutput_conflictMetadata::getFilePath() const {
    return m_file_path;
}
void OAIDescribeMergeConflictsOutput_conflictMetadata::setFilePath(const QString &file_path) {
    m_file_path = file_path;
    m_file_path_isSet = true;
}

bool OAIDescribeMergeConflictsOutput_conflictMetadata::is_file_path_Set() const{
    return m_file_path_isSet;
}

bool OAIDescribeMergeConflictsOutput_conflictMetadata::is_file_path_Valid() const{
    return m_file_path_isValid;
}

OAIConflictMetadata_fileSizes OAIDescribeMergeConflictsOutput_conflictMetadata::getFileSizes() const {
    return m_file_sizes;
}
void OAIDescribeMergeConflictsOutput_conflictMetadata::setFileSizes(const OAIConflictMetadata_fileSizes &file_sizes) {
    m_file_sizes = file_sizes;
    m_file_sizes_isSet = true;
}

bool OAIDescribeMergeConflictsOutput_conflictMetadata::is_file_sizes_Set() const{
    return m_file_sizes_isSet;
}

bool OAIDescribeMergeConflictsOutput_conflictMetadata::is_file_sizes_Valid() const{
    return m_file_sizes_isValid;
}

OAIConflictMetadata_fileModes OAIDescribeMergeConflictsOutput_conflictMetadata::getFileModes() const {
    return m_file_modes;
}
void OAIDescribeMergeConflictsOutput_conflictMetadata::setFileModes(const OAIConflictMetadata_fileModes &file_modes) {
    m_file_modes = file_modes;
    m_file_modes_isSet = true;
}

bool OAIDescribeMergeConflictsOutput_conflictMetadata::is_file_modes_Set() const{
    return m_file_modes_isSet;
}

bool OAIDescribeMergeConflictsOutput_conflictMetadata::is_file_modes_Valid() const{
    return m_file_modes_isValid;
}

OAIConflictMetadata_objectTypes OAIDescribeMergeConflictsOutput_conflictMetadata::getObjectTypes() const {
    return m_object_types;
}
void OAIDescribeMergeConflictsOutput_conflictMetadata::setObjectTypes(const OAIConflictMetadata_objectTypes &object_types) {
    m_object_types = object_types;
    m_object_types_isSet = true;
}

bool OAIDescribeMergeConflictsOutput_conflictMetadata::is_object_types_Set() const{
    return m_object_types_isSet;
}

bool OAIDescribeMergeConflictsOutput_conflictMetadata::is_object_types_Valid() const{
    return m_object_types_isValid;
}

qint32 OAIDescribeMergeConflictsOutput_conflictMetadata::getNumberOfConflicts() const {
    return m_number_of_conflicts;
}
void OAIDescribeMergeConflictsOutput_conflictMetadata::setNumberOfConflicts(const qint32 &number_of_conflicts) {
    m_number_of_conflicts = number_of_conflicts;
    m_number_of_conflicts_isSet = true;
}

bool OAIDescribeMergeConflictsOutput_conflictMetadata::is_number_of_conflicts_Set() const{
    return m_number_of_conflicts_isSet;
}

bool OAIDescribeMergeConflictsOutput_conflictMetadata::is_number_of_conflicts_Valid() const{
    return m_number_of_conflicts_isValid;
}

OAIConflictMetadata_isBinaryFile OAIDescribeMergeConflictsOutput_conflictMetadata::getIsBinaryFile() const {
    return m_is_binary_file;
}
void OAIDescribeMergeConflictsOutput_conflictMetadata::setIsBinaryFile(const OAIConflictMetadata_isBinaryFile &is_binary_file) {
    m_is_binary_file = is_binary_file;
    m_is_binary_file_isSet = true;
}

bool OAIDescribeMergeConflictsOutput_conflictMetadata::is_is_binary_file_Set() const{
    return m_is_binary_file_isSet;
}

bool OAIDescribeMergeConflictsOutput_conflictMetadata::is_is_binary_file_Valid() const{
    return m_is_binary_file_isValid;
}

bool OAIDescribeMergeConflictsOutput_conflictMetadata::getContentConflict() const {
    return m_content_conflict;
}
void OAIDescribeMergeConflictsOutput_conflictMetadata::setContentConflict(const bool &content_conflict) {
    m_content_conflict = content_conflict;
    m_content_conflict_isSet = true;
}

bool OAIDescribeMergeConflictsOutput_conflictMetadata::is_content_conflict_Set() const{
    return m_content_conflict_isSet;
}

bool OAIDescribeMergeConflictsOutput_conflictMetadata::is_content_conflict_Valid() const{
    return m_content_conflict_isValid;
}

bool OAIDescribeMergeConflictsOutput_conflictMetadata::getFileModeConflict() const {
    return m_file_mode_conflict;
}
void OAIDescribeMergeConflictsOutput_conflictMetadata::setFileModeConflict(const bool &file_mode_conflict) {
    m_file_mode_conflict = file_mode_conflict;
    m_file_mode_conflict_isSet = true;
}

bool OAIDescribeMergeConflictsOutput_conflictMetadata::is_file_mode_conflict_Set() const{
    return m_file_mode_conflict_isSet;
}

bool OAIDescribeMergeConflictsOutput_conflictMetadata::is_file_mode_conflict_Valid() const{
    return m_file_mode_conflict_isValid;
}

bool OAIDescribeMergeConflictsOutput_conflictMetadata::getObjectTypeConflict() const {
    return m_object_type_conflict;
}
void OAIDescribeMergeConflictsOutput_conflictMetadata::setObjectTypeConflict(const bool &object_type_conflict) {
    m_object_type_conflict = object_type_conflict;
    m_object_type_conflict_isSet = true;
}

bool OAIDescribeMergeConflictsOutput_conflictMetadata::is_object_type_conflict_Set() const{
    return m_object_type_conflict_isSet;
}

bool OAIDescribeMergeConflictsOutput_conflictMetadata::is_object_type_conflict_Valid() const{
    return m_object_type_conflict_isValid;
}

OAIConflictMetadata_mergeOperations OAIDescribeMergeConflictsOutput_conflictMetadata::getMergeOperations() const {
    return m_merge_operations;
}
void OAIDescribeMergeConflictsOutput_conflictMetadata::setMergeOperations(const OAIConflictMetadata_mergeOperations &merge_operations) {
    m_merge_operations = merge_operations;
    m_merge_operations_isSet = true;
}

bool OAIDescribeMergeConflictsOutput_conflictMetadata::is_merge_operations_Set() const{
    return m_merge_operations_isSet;
}

bool OAIDescribeMergeConflictsOutput_conflictMetadata::is_merge_operations_Valid() const{
    return m_merge_operations_isValid;
}

bool OAIDescribeMergeConflictsOutput_conflictMetadata::isSet() const {
...
bool OAIDescribeMergeConflictsOutput_conflictMetadata::isValid() const {
