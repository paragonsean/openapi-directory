...
OAIPullRequestEvent_approvalRuleOverriddenEventMetadata::OAIPullRequestEvent_approvalRuleOverriddenEventMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPullRequestEvent_approvalRuleOverriddenEventMetadata::OAIPullRequestEvent_approvalRuleOverriddenEventMetadata() {
    this->initializeModel();
}

OAIPullRequestEvent_approvalRuleOverriddenEventMetadata::~OAIPullRequestEvent_approvalRuleOverriddenEventMetadata() {}

void OAIPullRequestEvent_approvalRuleOverriddenEventMetadata::initializeModel() {
...
void OAIPullRequestEvent_approvalRuleOverriddenEventMetadata::fromJson(QString jsonString) {
...
void OAIPullRequestEvent_approvalRuleOverriddenEventMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIPullRequestEvent_approvalRuleOverriddenEventMetadata::asJson() const {
...
QJsonObject OAIPullRequestEvent_approvalRuleOverriddenEventMetadata::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPullRequestEvent_approvalRuleOverriddenEventMetadata::getRevisionId() const {
    return m_revision_id;
}
void OAIPullRequestEvent_approvalRuleOverriddenEventMetadata::setRevisionId(const QString &revision_id) {
    m_revision_id = revision_id;
    m_revision_id_isSet = true;
}

bool OAIPullRequestEvent_approvalRuleOverriddenEventMetadata::is_revision_id_Set() const{
    return m_revision_id_isSet;
}

bool OAIPullRequestEvent_approvalRuleOverriddenEventMetadata::is_revision_id_Valid() const{
    return m_revision_id_isValid;
}

OAIOverrideStatus OAIPullRequestEvent_approvalRuleOverriddenEventMetadata::getOverrideStatus() const {
    return m_override_status;
}
void OAIPullRequestEvent_approvalRuleOverriddenEventMetadata::setOverrideStatus(const OAIOverrideStatus &override_status) {
    m_override_status = override_status;
    m_override_status_isSet = true;
}

bool OAIPullRequestEvent_approvalRuleOverriddenEventMetadata::is_override_status_Set() const{
    return m_override_status_isSet;
}

bool OAIPullRequestEvent_approvalRuleOverriddenEventMetadata::is_override_status_Valid() const{
    return m_override_status_isValid;
}

bool OAIPullRequestEvent_approvalRuleOverriddenEventMetadata::isSet() const {
...
bool OAIPullRequestEvent_approvalRuleOverriddenEventMetadata::isValid() const {
