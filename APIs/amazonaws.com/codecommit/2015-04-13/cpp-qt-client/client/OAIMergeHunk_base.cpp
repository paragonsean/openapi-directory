...
OAIMergeHunk_base::OAIMergeHunk_base(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMergeHunk_base::OAIMergeHunk_base() {
    this->initializeModel();
}

OAIMergeHunk_base::~OAIMergeHunk_base() {}

void OAIMergeHunk_base::initializeModel() {
...
void OAIMergeHunk_base::fromJson(QString jsonString) {
...
void OAIMergeHunk_base::fromJsonObject(QJsonObject json) {
...
QString OAIMergeHunk_base::asJson() const {
...
QJsonObject OAIMergeHunk_base::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIMergeHunk_base::getStartLine() const {
    return m_start_line;
}
void OAIMergeHunk_base::setStartLine(const qint32 &start_line) {
    m_start_line = start_line;
    m_start_line_isSet = true;
}

bool OAIMergeHunk_base::is_start_line_Set() const{
    return m_start_line_isSet;
}

bool OAIMergeHunk_base::is_start_line_Valid() const{
    return m_start_line_isValid;
}

qint32 OAIMergeHunk_base::getEndLine() const {
    return m_end_line;
}
void OAIMergeHunk_base::setEndLine(const qint32 &end_line) {
    m_end_line = end_line;
    m_end_line_isSet = true;
}

bool OAIMergeHunk_base::is_end_line_Set() const{
    return m_end_line_isSet;
}

bool OAIMergeHunk_base::is_end_line_Valid() const{
    return m_end_line_isValid;
}

QString OAIMergeHunk_base::getHunkContent() const {
    return m_hunk_content;
}
void OAIMergeHunk_base::setHunkContent(const QString &hunk_content) {
    m_hunk_content = hunk_content;
    m_hunk_content_isSet = true;
}

bool OAIMergeHunk_base::is_hunk_content_Set() const{
    return m_hunk_content_isSet;
}

bool OAIMergeHunk_base::is_hunk_content_Valid() const{
    return m_hunk_content_isValid;
}

bool OAIMergeHunk_base::isSet() const {
...
bool OAIMergeHunk_base::isValid() const {
