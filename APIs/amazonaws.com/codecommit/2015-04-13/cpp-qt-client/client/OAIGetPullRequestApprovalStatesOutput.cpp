...
OAIGetPullRequestApprovalStatesOutput::OAIGetPullRequestApprovalStatesOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPullRequestApprovalStatesOutput::OAIGetPullRequestApprovalStatesOutput() {
    this->initializeModel();
}

OAIGetPullRequestApprovalStatesOutput::~OAIGetPullRequestApprovalStatesOutput() {}

void OAIGetPullRequestApprovalStatesOutput::initializeModel() {

    m_approvals_isSet = false;
    m_approvals_isValid = false;
}

void OAIGetPullRequestApprovalStatesOutput::fromJson(QString jsonString) {
...
void OAIGetPullRequestApprovalStatesOutput::fromJsonObject(QJsonObject json) {
...
QString OAIGetPullRequestApprovalStatesOutput::asJson() const {
...
QJsonObject OAIGetPullRequestApprovalStatesOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_approvals.isSet()) {
        obj.insert(QString("approvals"), ::OpenAPI::toJsonValue(m_approvals));
    }
    return obj;
}

QList OAIGetPullRequestApprovalStatesOutput::getApprovals() const {
    return m_approvals;
}
void OAIGetPullRequestApprovalStatesOutput::setApprovals(const QList &approvals) {
    m_approvals = approvals;
    m_approvals_isSet = true;
}

bool OAIGetPullRequestApprovalStatesOutput::is_approvals_Set() const{
    return m_approvals_isSet;
}

bool OAIGetPullRequestApprovalStatesOutput::is_approvals_Valid() const{
    return m_approvals_isValid;
}

bool OAIGetPullRequestApprovalStatesOutput::isSet() const {
...
bool OAIGetPullRequestApprovalStatesOutput::isValid() const {
