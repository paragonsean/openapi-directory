...
QString OAIPullRequest::getPullRequestId() const {
    return m_pull_request_id;
}
void OAIPullRequest::setPullRequestId(const QString &pull_request_id) {
    m_pull_request_id = pull_request_id;
    m_pull_request_id_isSet = true;
}

bool OAIPullRequest::is_pull_request_id_Set() const{
    return m_pull_request_id_isSet;
}

bool OAIPullRequest::is_pull_request_id_Valid() const{
...
QString OAIPullRequest::getDescription() const {
    return m_description;
}
void OAIPullRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIPullRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAIPullRequest::is_description_Valid() const{
    return m_description_isValid;
}

QDateTime OAIPullRequest::getLastActivityDate() const {
    return m_last_activity_date;
}
void OAIPullRequest::setLastActivityDate(const QDateTime &last_activity_date) {
    m_last_activity_date = last_activity_date;
    m_last_activity_date_isSet = true;
}

bool OAIPullRequest::is_last_activity_date_Set() const{
    return m_last_activity_date_isSet;
}

bool OAIPullRequest::is_last_activity_date_Valid() const{
    return m_last_activity_date_isValid;
}

QDateTime OAIPullRequest::getCreationDate() const {
    return m_creation_date;
}
void OAIPullRequest::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAIPullRequest::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAIPullRequest::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

OAIPullRequestStatusEnum OAIPullRequest::getPullRequestStatus() const {
    return m_pull_request_status;
}
void OAIPullRequest::setPullRequestStatus(const OAIPullRequestStatusEnum &pull_request_status) {
    m_pull_request_status = pull_request_status;
    m_pull_request_status_isSet = true;
}

bool OAIPullRequest::is_pull_request_status_Set() const{
    return m_pull_request_status_isSet;
}

bool OAIPullRequest::is_pull_request_status_Valid() const{
    return m_pull_request_status_isValid;
}

QString OAIPullRequest::getAuthorArn() const {
    return m_author_arn;
}
void OAIPullRequest::setAuthorArn(const QString &author_arn) {
    m_author_arn = author_arn;
    m_author_arn_isSet = true;
}

bool OAIPullRequest::is_author_arn_Set() const{
    return m_author_arn_isSet;
}

bool OAIPullRequest::is_author_arn_Valid() const{
    return m_author_arn_isValid;
}

QList OAIPullRequest::getPullRequestTargets() const {
    return m_pull_request_targets;
}
void OAIPullRequest::setPullRequestTargets(const QList &pull_request_targets) {
    m_pull_request_targets = pull_request_targets;
    m_pull_request_targets_isSet = true;
}

bool OAIPullRequest::is_pull_request_targets_Set() const{
    return m_pull_request_targets_isSet;
}

bool OAIPullRequest::is_pull_request_targets_Valid() const{
    return m_pull_request_targets_isValid;
}

QString OAIPullRequest::getClientRequestToken() const {
    return m_client_request_token;
}
void OAIPullRequest::setClientRequestToken(const QString &client_request_token) {
    m_client_request_token = client_request_token;
    m_client_request_token_isSet = true;
}

bool OAIPullRequest::is_client_request_token_Set() const{
    return m_client_request_token_isSet;
}

bool OAIPullRequest::is_client_request_token_Valid() const{
    return m_client_request_token_isValid;
}

QString OAIPullRequest::getRevisionId() const {
    return m_revision_id;
}
void OAIPullRequest::setRevisionId(const QString &revision_id) {
    m_revision_id = revision_id;
    m_revision_id_isSet = true;
}

bool OAIPullRequest::is_revision_id_Set() const{
    return m_revision_id_isSet;
}

bool OAIPullRequest::is_revision_id_Valid() const{
    return m_revision_id_isValid;
}

QList OAIPullRequest::getApprovalRules() const {
    return m_approval_rules;
}
void OAIPullRequest::setApprovalRules(const QList &approval_rules) {
    m_approval_rules = approval_rules;
    m_approval_rules_isSet = true;
}

bool OAIPullRequest::is_approval_rules_Set() const{
    return m_approval_rules_isSet;
}

bool OAIPullRequest::is_approval_rules_Valid() const{
