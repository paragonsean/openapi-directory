...
/*
 * OAITestRepositoryTriggersOutput.h
 *
 * Represents the output of a test repository triggers operation.
 */

#ifndef OAITestRepositoryTriggersOutput_H
#define OAITestRepositoryTriggersOutput_H
...
class OAITestRepositoryTriggersOutput : public OAIObject {
public:
    OAITestRepositoryTriggersOutput();
    OAITestRepositoryTriggersOutput(QString json);
    ~OAITestRepositoryTriggersOutput() override;
    ...
    QList getSuccessfulExecutions() const;
    void setSuccessfulExecutions(const QList &successful_executions);
    bool is_successful_executions_Set() const;
    bool is_successful_executions_Valid() const;

    QList getFailedExecutions() const;
    void setFailedExecutions(const QList &failed_executions);
...
private:
    ...
    QList m_successful_executions;
    bool m_successful_executions_isSet;
    bool m_successful_executions_isValid;

    QList m_failed_executions;
...
Q_DECLARE_METATYPE(OpenAPI::OAITestRepositoryTriggersOutput)

#endif // OAITestRepositoryTriggersOutput_H
