...
/*
 * OAICommentsForPullRequest_location.h
 *
 * 
 */

#ifndef OAICommentsForPullRequest_location_H
#define OAICommentsForPullRequest_location_H
...
class OAICommentsForPullRequest_location : public OAIObject {
public:
    OAICommentsForPullRequest_location();
    OAICommentsForPullRequest_location(QString json);
    ~OAICommentsForPullRequest_location() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommentsForPullRequest_location)

#endif // OAICommentsForPullRequest_location_H
