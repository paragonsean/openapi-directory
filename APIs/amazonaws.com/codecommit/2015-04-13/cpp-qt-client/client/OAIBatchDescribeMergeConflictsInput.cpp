...
OAIBatchDescribeMergeConflictsInput::OAIBatchDescribeMergeConflictsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchDescribeMergeConflictsInput::OAIBatchDescribeMergeConflictsInput() {
    this->initializeModel();
}

OAIBatchDescribeMergeConflictsInput::~OAIBatchDescribeMergeConflictsInput() {}

void OAIBatchDescribeMergeConflictsInput::initializeModel() {
    ...
    m_max_conflict_files_isSet = false;
    m_max_conflict_files_isValid = false;
...
void OAIBatchDescribeMergeConflictsInput::fromJson(QString jsonString) {
...
void OAIBatchDescribeMergeConflictsInput::fromJsonObject(QJsonObject json) {
    ...
    m_max_conflict_files_isValid = ::OpenAPI::fromJsonValue(m_max_conflict_files, json[QString("maxConflictFiles")]);
    m_max_conflict_files_isSet = !json[QString("maxConflictFiles")].isNull() && m_max_conflict_files_isValid;
...
QString OAIBatchDescribeMergeConflictsInput::asJson() const {
...
QJsonObject OAIBatchDescribeMergeConflictsInput::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_max_conflict_files_isSet) {
        obj.insert(QString("maxConflictFiles"), ::OpenAPI::toJsonValue(m_max_conflict_files));
    }
    if (m_file_paths.isSet()) {
...
QString OAIBatchDescribeMergeConflictsInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIBatchDescribeMergeConflictsInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIBatchDescribeMergeConflictsInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIBatchDescribeMergeConflictsInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIBatchDescribeMergeConflictsInput::getDestinationCommitSpecifier() const {
    return m_destination_commit_specifier;
}
void OAIBatchDescribeMergeConflictsInput::setDestinationCommitSpecifier(const QString &destination_commit_specifier) {
    m_destination_commit_specifier = destination_commit_specifier;
    m_destination_commit_specifier_isSet = true;
}

bool OAIBatchDescribeMergeConflictsInput::is_destination_commit_specifier_Set() const{
    return m_destination_commit_specifier_isSet;
}

bool OAIBatchDescribeMergeConflictsInput::is_destination_commit_specifier_Valid() const{
    return m_destination_commit_specifier_isValid;
}

QString OAIBatchDescribeMergeConflictsInput::getSourceCommitSpecifier() const {
    return m_source_commit_specifier;
}
void OAIBatchDescribeMergeConflictsInput::setSourceCommitSpecifier(const QString &source_commit_specifier) {
    m_source_commit_specifier = source_commit_specifier;
    m_source_commit_specifier_isSet = true;
}

bool OAIBatchDescribeMergeConflictsInput::is_source_commit_specifier_Set() const{
    return m_source_commit_specifier_isSet;
}

bool OAIBatchDescribeMergeConflictsInput::is_source_commit_specifier_Valid() const{
    return m_source_commit_specifier_isValid;
}

OAIMergeOptionTypeEnum OAIBatchDescribeMergeConflictsInput::getMergeOption() const {
    return m_merge_option;
}
void OAIBatchDescribeMergeConflictsInput::setMergeOption(const OAIMergeOptionTypeEnum &merge_option) {
    m_merge_option = merge_option;
    m_merge_option_isSet = true;
}

bool OAIBatchDescribeMergeConflictsInput::is_merge_option_Set() const{
    return m_merge_option_isSet;
}

bool OAIBatchDescribeMergeConflictsInput::is_merge_option_Valid() const{
    return m_merge_option_isValid;
}

qint32 OAIBatchDescribeMergeConflictsInput::getMaxMergeHunks() const {
    return m_max_merge_hunks;
}
void OAIBatchDescribeMergeConflictsInput::setMaxMergeHunks(const qint32 &max_merge_hunks) {
    m_max_merge_hunks = max_merge_hunks;
    m_max_merge_hunks_isSet = true;
}

bool OAIBatchDescribeMergeConflictsInput::is_max_merge_hunks_Set() const{
    return m_max_merge_hunks_isSet;
}

bool OAIBatchDescribeMergeConflictsInput::is_max_merge_hunks_Valid() const{
    return m_max_merge_hunks_isValid;
}

qint32 OAIBatchDescribeMergeConflictsInput::getMaxConflictFiles() const {
    return m_max_conflict_files;
}
void OAIBatchDescribeMergeConflictsInput::setMaxConflictFiles(const qint32 &max_conflict_files) {
    m_max_conflict_files = max_conflict_files;
    m_max_conflict_files_isSet = true;
}

bool OAIBatchDescribeMergeConflictsInput::is_max_conflict_files_Set() const{
    return m_max_conflict_files_isSet;
}

bool OAIBatchDescribeMergeConflictsInput::is_max_conflict_files_Valid() const{
    return m_max_conflict_files_isValid;
}

QList OAIBatchDescribeMergeConflictsInput::getFilePaths() const {
    return m_file_paths;
}
void OAIBatchDescribeMergeConflictsInput::setFilePaths(const QList &file_paths) {
    m_file_paths = file_paths;
    m_file_paths_isSet = true;
}

bool OAIBatchDescribeMergeConflictsInput::is_file_paths_Set() const{
    return m_file_paths_isSet;
}

bool OAIBatchDescribeMergeConflictsInput::is_file_paths_Valid() const{
    return m_file_paths_isValid;
}

OAIConflictDetailLevelTypeEnum OAIBatchDescribeMergeConflictsInput::getConflictDetailLevel() const {
    return m_conflict_detail_level;
}
void OAIBatchDescribeMergeConflictsInput::setConflictDetailLevel(const OAIConflictDetailLevelTypeEnum &conflict_detail_level) {
    m_conflict_detail_level = conflict_detail_level;
    m_conflict_detail_level_isSet = true;
}

bool OAIBatchDescribeMergeConflictsInput::is_conflict_detail_level_Set() const{
    return m_conflict_detail_level_isSet;
}

bool OAIBatchDescribeMergeConflictsInput::is_conflict_detail_level_Valid() const{
    return m_conflict_detail_level_isValid;
}

OAIConflictResolutionStrategyTypeEnum OAIBatchDescribeMergeConflictsInput::getConflictResolutionStrategy() const {
    return m_conflict_resolution_strategy;
}
void OAIBatchDescribeMergeConflictsInput::setConflictResolutionStrategy(const OAIConflictResolutionStrategyTypeEnum &conflict_resolution_strategy) {
    m_conflict_resolution_strategy = conflict_resolution_strategy;
    m_conflict_resolution_strategy_isSet = true;
}

bool OAIBatchDescribeMergeConflictsInput::is_conflict_resolution_strategy_Set() const{
    return m_conflict_resolution_strategy_isSet;
}

bool OAIBatchDescribeMergeConflictsInput::is_conflict_resolution_strategy_Valid() const{
    return m_conflict_resolution_strategy_isValid;
}

QString OAIBatchDescribeMergeConflictsInput::getNextToken() const {
    return m_next_token;
}
void OAIBatchDescribeMergeConflictsInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIBatchDescribeMergeConflictsInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIBatchDescribeMergeConflictsInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIBatchDescribeMergeConflictsInput::isSet() const {
...
bool OAIBatchDescribeMergeConflictsInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_repository_name_isValid && m_destination_commit_specifier_isValid && m_source_commit_specifier_isValid && m_merge_option_isValid && true;
}
