...
/*
 * OAISourceFileSpecifier.h
 *
 * Information about a source file that is part of changes made in a commit.
 */

#ifndef OAISourceFileSpecifier_H
#define OAISourceFileSpecifier_H
...
class OAISourceFileSpecifier : public OAIObject {
public:
    OAISourceFileSpecifier();
    OAISourceFileSpecifier(QString json);
    ~OAISourceFileSpecifier() override;
    ...
    void setIsMove(const bool &is_move);
    bool is_is_move_Set() const;
    bool is_is_move_Valid() const;
...
private:
    ...
    bool m_is_move;
    bool m_is_move_isSet;
    bool m_is_move_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAISourceFileSpecifier)

#endif // OAISourceFileSpecifier_H
