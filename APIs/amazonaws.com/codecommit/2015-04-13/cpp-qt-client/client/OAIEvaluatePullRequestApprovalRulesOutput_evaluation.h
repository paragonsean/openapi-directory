...
/*
 * OAIEvaluatePullRequestApprovalRulesOutput_evaluation.h
 *
 * 
 */

#ifndef OAIEvaluatePullRequestApprovalRulesOutput_evaluation_H
#define OAIEvaluatePullRequestApprovalRulesOutput_evaluation_H
...
class OAIEvaluatePullRequestApprovalRulesOutput_evaluation : public OAIObject {
public:
    OAIEvaluatePullRequestApprovalRulesOutput_evaluation();
    OAIEvaluatePullRequestApprovalRulesOutput_evaluation(QString json);
    ~OAIEvaluatePullRequestApprovalRulesOutput_evaluation() override;
    ...
    QList getApprovalRulesSatisfied() const;
    void setApprovalRulesSatisfied(const QList &approval_rules_satisfied);
    bool is_approval_rules_satisfied_Set() const;
    bool is_approval_rules_satisfied_Valid() const;

    QList getApprovalRulesNotSatisfied() const;
    void setApprovalRulesNotSatisfied(const QList &approval_rules_not_satisfied);
    bool is_approval_rules_not_satisfied_Set() const;
    bool is_approval_rules_not_satisfied_Valid() const;
...
private:
    ...
    QList m_approval_rules_satisfied;
    bool m_approval_rules_satisfied_isSet;
    bool m_approval_rules_satisfied_isValid;

    QList m_approval_rules_not_satisfied;
    bool m_approval_rules_not_satisfied_isSet;
    bool m_approval_rules_not_satisfied_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIEvaluatePullRequestApprovalRulesOutput_evaluation)

#endif // OAIEvaluatePullRequestApprovalRulesOutput_evaluation_H
