...
/*
 * OAIListApprovalRuleTemplatesOutput.h
 *
 * 
 */

#ifndef OAIListApprovalRuleTemplatesOutput_H
#define OAIListApprovalRuleTemplatesOutput_H
...
class OAIListApprovalRuleTemplatesOutput : public OAIObject {
public:
    OAIListApprovalRuleTemplatesOutput();
    OAIListApprovalRuleTemplatesOutput(QString json);
    ~OAIListApprovalRuleTemplatesOutput() override;
    ...
    QList getApprovalRuleTemplateNames() const;
    void setApprovalRuleTemplateNames(const QList &approval_rule_template_names);
    bool is_approval_rule_template_names_Set() const;
    bool is_approval_rule_template_names_Valid() const;
...
private:
    ...
    QList m_approval_rule_template_names;
    bool m_approval_rule_template_names_isSet;
    bool m_approval_rule_template_names_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListApprovalRuleTemplatesOutput)

#endif // OAIListApprovalRuleTemplatesOutput_H
