...
OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput::OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput::OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput() {
    this->initializeModel();
}

OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput::~OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput() {}

void OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput::initializeModel() {
...
void OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput::fromJson(QString jsonString) {
...
void OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput::fromJsonObject(QJsonObject json) {
...
QString OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput::asJson() const {
...
QJsonObject OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput::getApprovalRuleTemplateName() const {
    return m_approval_rule_template_name;
}
void OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput::setApprovalRuleTemplateName(const QString &approval_rule_template_name) {
    m_approval_rule_template_name = approval_rule_template_name;
    m_approval_rule_template_name_isSet = true;
}

bool OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput::is_approval_rule_template_name_Set() const{
    return m_approval_rule_template_name_isSet;
}

bool OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput::is_approval_rule_template_name_Valid() const{
    return m_approval_rule_template_name_isValid;
}

QList OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput::getRepositoryNames() const {
    return m_repository_names;
}
void OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput::setRepositoryNames(const QList &repository_names) {
    m_repository_names = repository_names;
    m_repository_names_isSet = true;
}

bool OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput::is_repository_names_Set() const{
    return m_repository_names_isSet;
}

bool OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput::is_repository_names_Valid() const{
    return m_repository_names_isValid;
}

bool OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput::isSet() const {
...
bool OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_approval_rule_template_name_isValid && m_repository_names_isValid && true;
}
