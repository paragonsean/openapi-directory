...
/*
 * OAIGetMergeCommitInput.h
 *
 * 
 */

#ifndef OAIGetMergeCommitInput_H
#define OAIGetMergeCommitInput_H
...
class OAIGetMergeCommitInput : public OAIObject {
public:
    OAIGetMergeCommitInput();
    OAIGetMergeCommitInput(QString json);
    ~OAIGetMergeCommitInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetMergeCommitInput)

#endif // OAIGetMergeCommitInput_H
