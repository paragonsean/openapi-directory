...
OAIConflict::OAIConflict(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConflict::OAIConflict() {
    this->initializeModel();
}

OAIConflict::~OAIConflict() {}

void OAIConflict::initializeModel() {
...
void OAIConflict::fromJson(QString jsonString) {
...
void OAIConflict::fromJsonObject(QJsonObject json) {
...
QString OAIConflict::asJson() const {
...
QJsonObject OAIConflict::asJsonObject() const {
    QJsonObject obj;
...
OAIConflict_conflictMetadata OAIConflict::getConflictMetadata() const {
    return m_conflict_metadata;
}
void OAIConflict::setConflictMetadata(const OAIConflict_conflictMetadata &conflict_metadata) {
    m_conflict_metadata = conflict_metadata;
    m_conflict_metadata_isSet = true;
}

bool OAIConflict::is_conflict_metadata_Set() const{
    return m_conflict_metadata_isSet;
}

bool OAIConflict::is_conflict_metadata_Valid() const{
    return m_conflict_metadata_isValid;
}

QList OAIConflict::getMergeHunks() const {
    return m_merge_hunks;
}
void OAIConflict::setMergeHunks(const QList &merge_hunks) {
    m_merge_hunks = merge_hunks;
    m_merge_hunks_isSet = true;
}

bool OAIConflict::is_merge_hunks_Set() const{
    return m_merge_hunks_isSet;
}

bool OAIConflict::is_merge_hunks_Valid() const{
    return m_merge_hunks_isValid;
}

bool OAIConflict::isSet() const {
...
bool OAIConflict::isValid() const {
