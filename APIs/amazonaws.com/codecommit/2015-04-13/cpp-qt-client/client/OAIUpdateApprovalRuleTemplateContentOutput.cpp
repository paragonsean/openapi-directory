...
OAIUpdateApprovalRuleTemplateContentOutput::OAIUpdateApprovalRuleTemplateContentOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateApprovalRuleTemplateContentOutput::OAIUpdateApprovalRuleTemplateContentOutput() {
    this->initializeModel();
}

OAIUpdateApprovalRuleTemplateContentOutput::~OAIUpdateApprovalRuleTemplateContentOutput() {}

void OAIUpdateApprovalRuleTemplateContentOutput::initializeModel() {

    m_approval_rule_template_isSet = false;
    m_approval_rule_template_isValid = false;
}

void OAIUpdateApprovalRuleTemplateContentOutput::fromJson(QString jsonString) {
...
void OAIUpdateApprovalRuleTemplateContentOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateApprovalRuleTemplateContentOutput::asJson() const {
...
QJsonObject OAIUpdateApprovalRuleTemplateContentOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIApprovalRuleTemplate OAIUpdateApprovalRuleTemplateContentOutput::getApprovalRuleTemplate() const {
    return m_approval_rule_template;
}
void OAIUpdateApprovalRuleTemplateContentOutput::setApprovalRuleTemplate(const OAIApprovalRuleTemplate &approval_rule_template) {
    m_approval_rule_template = approval_rule_template;
    m_approval_rule_template_isSet = true;
}

bool OAIUpdateApprovalRuleTemplateContentOutput::is_approval_rule_template_Set() const{
    return m_approval_rule_template_isSet;
}

bool OAIUpdateApprovalRuleTemplateContentOutput::is_approval_rule_template_Valid() const{
    return m_approval_rule_template_isValid;
}

bool OAIUpdateApprovalRuleTemplateContentOutput::isSet() const {
...
bool OAIUpdateApprovalRuleTemplateContentOutput::isValid() const {
