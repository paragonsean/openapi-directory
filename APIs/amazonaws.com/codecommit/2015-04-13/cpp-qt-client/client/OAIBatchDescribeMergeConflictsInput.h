...
/*
 * OAIBatchDescribeMergeConflictsInput.h
 *
 * 
 */

#ifndef OAIBatchDescribeMergeConflictsInput_H
#define OAIBatchDescribeMergeConflictsInput_H
...
class OAIBatchDescribeMergeConflictsInput : public OAIObject {
public:
    OAIBatchDescribeMergeConflictsInput();
    OAIBatchDescribeMergeConflictsInput(QString json);
    ~OAIBatchDescribeMergeConflictsInput() override;
    ...
    qint32 getMaxMergeHunks() const;
    void setMaxMergeHunks(const qint32 &max_merge_hunks);
    bool is_max_merge_hunks_Set() const;
    bool is_max_merge_hunks_Valid() const;

    qint32 getMaxConflictFiles() const;
    void setMaxConflictFiles(const qint32 &max_conflict_files);
    bool is_max_conflict_files_Set() const;
    bool is_max_conflict_files_Valid() const;

    QList getFilePaths() const;
    void setFilePaths(const QList &file_paths);
...
private:
    ...
    qint32 m_max_merge_hunks;
    bool m_max_merge_hunks_isSet;
    bool m_max_merge_hunks_isValid;

    qint32 m_max_conflict_files;
    bool m_max_conflict_files_isSet;
    bool m_max_conflict_files_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchDescribeMergeConflictsInput)

#endif // OAIBatchDescribeMergeConflictsInput_H
