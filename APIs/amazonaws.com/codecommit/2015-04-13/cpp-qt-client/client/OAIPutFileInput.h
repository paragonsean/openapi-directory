...
#ifndef OAIPutFileInput_H
#define OAIPutFileInput_H
...
class OAIPutFileInput : public OAIObject {
public:
    OAIPutFileInput();
    OAIPutFileInput(QString json);
    ~OAIPutFileInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutFileInput)

#endif // OAIPutFileInput_H
