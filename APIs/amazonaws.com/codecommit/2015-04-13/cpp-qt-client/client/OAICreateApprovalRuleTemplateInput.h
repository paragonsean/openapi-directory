...
/*
 * OAICreateApprovalRuleTemplateInput.h
 *
 * 
 */

#ifndef OAICreateApprovalRuleTemplateInput_H
#define OAICreateApprovalRuleTemplateInput_H
...
class OAICreateApprovalRuleTemplateInput : public OAIObject {
public:
    OAICreateApprovalRuleTemplateInput();
    OAICreateApprovalRuleTemplateInput(QString json);
    ~OAICreateApprovalRuleTemplateInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateApprovalRuleTemplateInput)

#endif // OAICreateApprovalRuleTemplateInput_H
