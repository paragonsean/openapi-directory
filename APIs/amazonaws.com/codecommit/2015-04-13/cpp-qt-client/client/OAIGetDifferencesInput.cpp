...
OAIGetDifferencesInput::OAIGetDifferencesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetDifferencesInput::OAIGetDifferencesInput() {
    this->initializeModel();
}

OAIGetDifferencesInput::~OAIGetDifferencesInput() {}

void OAIGetDifferencesInput::initializeModel() {

    m_repository_name_isSet = false;
    m_repository_name_isValid = false;

    m_before_commit_specifier_isSet = false;
    m_before_commit_specifier_isValid = false;

    m_after_commit_specifier_isSet = false;
    m_after_commit_specifier_isValid = false;

    m_before_path_isSet = false;
    m_before_path_isValid = false;

    m_after_path_isSet = false;
    m_after_path_isValid = false;
...
void OAIGetDifferencesInput::fromJson(QString jsonString) {
...
void OAIGetDifferencesInput::fromJsonObject(QJsonObject json) {
    ...
    m_before_commit_specifier_isValid = ::OpenAPI::fromJsonValue(m_before_commit_specifier, json[QString("beforeCommitSpecifier")]);
    m_before_commit_specifier_isSet = !json[QString("beforeCommitSpecifier")].isNull() && m_before_commit_specifier_isValid;

    m_after_commit_specifier_isValid = ::OpenAPI::fromJsonValue(m_after_commit_specifier, json[QString("afterCommitSpecifier")]);
    m_after_commit_specifier_isSet = !json[QString("afterCommitSpecifier")].isNull() && m_after_commit_specifier_isValid;

    m_before_path_isValid = ::OpenAPI::fromJsonValue(m_before_path, json[QString("beforePath")]);
    m_before_path_isSet = !json[QString("beforePath")].isNull() && m_before_path_isValid;

    m_after_path_isValid = ::OpenAPI::fromJsonValue(m_after_path, json[QString("afterPath")]);
    m_after_path_isSet = !json[QString("afterPath")].isNull() && m_after_path_isValid;
...
QString OAIGetDifferencesInput::asJson() const {
...
QJsonObject OAIGetDifferencesInput::asJsonObject() const {
    QJsonObject obj;
    if (m_repository_name_isSet) {
        obj.insert(QString("repositoryName"), ::OpenAPI::toJsonValue(m_repository_name));
    }
    if (m_before_commit_specifier_isSet) {
        obj.insert(QString("beforeCommitSpecifier"), ::OpenAPI::toJsonValue(m_before_commit_specifier));
    }
    if (m_after_commit_specifier_isSet) {
        obj.insert(QString("afterCommitSpecifier"), ::OpenAPI::toJsonValue(m_after_commit_specifier));
    }
    if (m_before_path_isSet) {
        obj.insert(QString("beforePath"), ::OpenAPI::toJsonValue(m_before_path));
    }
    if (m_after_path_isSet) {
        obj.insert(QString("afterPath"), ::OpenAPI::toJsonValue(m_after_path));
    }
...
QString OAIGetDifferencesInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIGetDifferencesInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIGetDifferencesInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIGetDifferencesInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIGetDifferencesInput::getBeforeCommitSpecifier() const {
    return m_before_commit_specifier;
}
void OAIGetDifferencesInput::setBeforeCommitSpecifier(const QString &before_commit_specifier) {
    m_before_commit_specifier = before_commit_specifier;
    m_before_commit_specifier_isSet = true;
}

bool OAIGetDifferencesInput::is_before_commit_specifier_Set() const{
    return m_before_commit_specifier_isSet;
}

bool OAIGetDifferencesInput::is_before_commit_specifier_Valid() const{
    return m_before_commit_specifier_isValid;
}

QString OAIGetDifferencesInput::getAfterCommitSpecifier() const {
    return m_after_commit_specifier;
}
void OAIGetDifferencesInput::setAfterCommitSpecifier(const QString &after_commit_specifier) {
    m_after_commit_specifier = after_commit_specifier;
    m_after_commit_specifier_isSet = true;
}

bool OAIGetDifferencesInput::is_after_commit_specifier_Set() const{
    return m_after_commit_specifier_isSet;
}

bool OAIGetDifferencesInput::is_after_commit_specifier_Valid() const{
    return m_after_commit_specifier_isValid;
}

QString OAIGetDifferencesInput::getBeforePath() const {
    return m_before_path;
}
void OAIGetDifferencesInput::setBeforePath(const QString &before_path) {
    m_before_path = before_path;
    m_before_path_isSet = true;
}

bool OAIGetDifferencesInput::is_before_path_Set() const{
    return m_before_path_isSet;
}

bool OAIGetDifferencesInput::is_before_path_Valid() const{
    return m_before_path_isValid;
}

QString OAIGetDifferencesInput::getAfterPath() const {
    return m_after_path;
}
void OAIGetDifferencesInput::setAfterPath(const QString &after_path) {
    m_after_path = after_path;
    m_after_path_isSet = true;
}

bool OAIGetDifferencesInput::is_after_path_Set() const{
    return m_after_path_isSet;
}

bool OAIGetDifferencesInput::is_after_path_Valid() const{
    return m_after_path_isValid;
}

qint32 OAIGetDifferencesInput::getMaxResults() const {
    return m_max_results;
}
void OAIGetDifferencesInput::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIGetDifferencesInput::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIGetDifferencesInput::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIGetDifferencesInput::getNextToken() const {
    return m_next_token;
}
void OAIGetDifferencesInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIGetDifferencesInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIGetDifferencesInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIGetDifferencesInput::isSet() const {
...
bool OAIGetDifferencesInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_repository_name_isValid && m_after_commit_specifier_isValid && true;
}
