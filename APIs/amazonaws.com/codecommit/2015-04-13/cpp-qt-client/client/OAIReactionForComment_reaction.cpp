...
OAIReactionForComment_reaction::OAIReactionForComment_reaction(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReactionForComment_reaction::OAIReactionForComment_reaction() {
    this->initializeModel();
}

OAIReactionForComment_reaction::~OAIReactionForComment_reaction() {}

void OAIReactionForComment_reaction::initializeModel() {
...
void OAIReactionForComment_reaction::fromJson(QString jsonString) {
...
void OAIReactionForComment_reaction::fromJsonObject(QJsonObject json) {
...
QString OAIReactionForComment_reaction::asJson() const {
...
QJsonObject OAIReactionForComment_reaction::asJsonObject() const {
    QJsonObject obj;
    if (m_emoji_isSet) {
...
QString OAIReactionForComment_reaction::getEmoji() const {
    return m_emoji;
}
void OAIReactionForComment_reaction::setEmoji(const QString &emoji) {
    m_emoji = emoji;
    m_emoji_isSet = true;
}

bool OAIReactionForComment_reaction::is_emoji_Set() const{
    return m_emoji_isSet;
}

bool OAIReactionForComment_reaction::is_emoji_Valid() const{
    return m_emoji_isValid;
}

QString OAIReactionForComment_reaction::getShortCode() const {
    return m_short_code;
}
void OAIReactionForComment_reaction::setShortCode(const QString &short_code) {
    m_short_code = short_code;
    m_short_code_isSet = true;
}

bool OAIReactionForComment_reaction::is_short_code_Set() const{
    return m_short_code_isSet;
}

bool OAIReactionForComment_reaction::is_short_code_Valid() const{
    return m_short_code_isValid;
}

QString OAIReactionForComment_reaction::getUnicode() const {
    return m_unicode;
}
void OAIReactionForComment_reaction::setUnicode(const QString &unicode) {
    m_unicode = unicode;
    m_unicode_isSet = true;
}

bool OAIReactionForComment_reaction::is_unicode_Set() const{
    return m_unicode_isSet;
}

bool OAIReactionForComment_reaction::is_unicode_Valid() const{
    return m_unicode_isValid;
}

bool OAIReactionForComment_reaction::isSet() const {
...
bool OAIReactionForComment_reaction::isValid() const {
