...
#include "OAIGetBranchOutput_branch.h"
...
OAIGetBranchOutput_branch::OAIGetBranchOutput_branch(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetBranchOutput_branch::OAIGetBranchOutput_branch() {
    this->initializeModel();
}

OAIGetBranchOutput_branch::~OAIGetBranchOutput_branch() {}

void OAIGetBranchOutput_branch::initializeModel() {
...
void OAIGetBranchOutput_branch::fromJson(QString jsonString) {
...
void OAIGetBranchOutput_branch::fromJsonObject(QJsonObject json) {
...
QString OAIGetBranchOutput_branch::asJson() const {
...
QJsonObject OAIGetBranchOutput_branch::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetBranchOutput_branch::getBranchName() const {
    return m_branch_name;
}
void OAIGetBranchOutput_branch::setBranchName(const QString &branch_name) {
    m_branch_name = branch_name;
    m_branch_name_isSet = true;
}

bool OAIGetBranchOutput_branch::is_branch_name_Set() const{
    return m_branch_name_isSet;
}

bool OAIGetBranchOutput_branch::is_branch_name_Valid() const{
    return m_branch_name_isValid;
}

QString OAIGetBranchOutput_branch::getCommitId() const {
    return m_commit_id;
}
void OAIGetBranchOutput_branch::setCommitId(const QString &commit_id) {
    m_commit_id = commit_id;
    m_commit_id_isSet = true;
}

bool OAIGetBranchOutput_branch::is_commit_id_Set() const{
    return m_commit_id_isSet;
}

bool OAIGetBranchOutput_branch::is_commit_id_Valid() const{
    return m_commit_id_isValid;
}

bool OAIGetBranchOutput_branch::isSet() const {
...
bool OAIGetBranchOutput_branch::isValid() const {
