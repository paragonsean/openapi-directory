...
OAICreateCommitOutput::OAICreateCommitOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateCommitOutput::OAICreateCommitOutput() {
    this->initializeModel();
}

OAICreateCommitOutput::~OAICreateCommitOutput() {}

void OAICreateCommitOutput::initializeModel() {
    ...
    m_files_updated_isSet = false;
    m_files_updated_isValid = false;

    m_files_deleted_isSet = false;
    m_files_deleted_isValid = false;
}

void OAICreateCommitOutput::fromJson(QString jsonString) {
...
void OAICreateCommitOutput::fromJsonObject(QJsonObject json) {
    ...
    m_files_updated_isValid = ::OpenAPI::fromJsonValue(m_files_updated, json[QString("filesUpdated")]);
    m_files_updated_isSet = !json[QString("filesUpdated")].isNull() && m_files_updated_isValid;

    m_files_deleted_isValid = ::OpenAPI::fromJsonValue(m_files_deleted, json[QString("filesDeleted")]);
    m_files_deleted_isSet = !json[QString("filesDeleted")].isNull() && m_files_deleted_isValid;
}

QString OAICreateCommitOutput::asJson() const {
...
QJsonObject OAICreateCommitOutput::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_files_added.isSet()) {
        obj.insert(QString("filesAdded"), ::OpenAPI::toJsonValue(m_files_added));
    }
    if (m_files_updated.isSet()) {
        obj.insert(QString("filesUpdated"), ::OpenAPI::toJsonValue(m_files_updated));
    }
    if (m_files_deleted.isSet()) {
        obj.insert(QString("filesDeleted"), ::OpenAPI::toJsonValue(m_files_deleted));
    }
    return obj;
}

QString OAICreateCommitOutput::getCommitId() const {
    return m_commit_id;
}
void OAICreateCommitOutput::setCommitId(const QString &commit_id) {
    m_commit_id = commit_id;
    m_commit_id_isSet = true;
}

bool OAICreateCommitOutput::is_commit_id_Set() const{
    return m_commit_id_isSet;
}

bool OAICreateCommitOutput::is_commit_id_Valid() const{
    return m_commit_id_isValid;
}

QString OAICreateCommitOutput::getTreeId() const {
    return m_tree_id;
}
void OAICreateCommitOutput::setTreeId(const QString &tree_id) {
    m_tree_id = tree_id;
    m_tree_id_isSet = true;
}

bool OAICreateCommitOutput::is_tree_id_Set() const{
    return m_tree_id_isSet;
}

bool OAICreateCommitOutput::is_tree_id_Valid() const{
    return m_tree_id_isValid;
}

QList OAICreateCommitOutput::getFilesAdded() const {
    return m_files_added;
}
void OAICreateCommitOutput::setFilesAdded(const QList &files_added) {
    m_files_added = files_added;
    m_files_added_isSet = true;
}

bool OAICreateCommitOutput::is_files_added_Set() const{
    return m_files_added_isSet;
}

bool OAICreateCommitOutput::is_files_added_Valid() const{
    return m_files_added_isValid;
}

QList OAICreateCommitOutput::getFilesUpdated() const {
    return m_files_updated;
}
void OAICreateCommitOutput::setFilesUpdated(const QList &files_updated) {
    m_files_updated = files_updated;
    m_files_updated_isSet = true;
}

bool OAICreateCommitOutput::is_files_updated_Set() const{
    return m_files_updated_isSet;
}

bool OAICreateCommitOutput::is_files_updated_Valid() const{
    return m_files_updated_isValid;
}

QList OAICreateCommitOutput::getFilesDeleted() const {
    return m_files_deleted;
}
void OAICreateCommitOutput::setFilesDeleted(const QList &files_deleted) {
    m_files_deleted = files_deleted;
    m_files_deleted_isSet = true;
}

bool OAICreateCommitOutput::is_files_deleted_Set() const{
    return m_files_deleted_isSet;
}

bool OAICreateCommitOutput::is_files_deleted_Valid() const{
    return m_files_deleted_isValid;
}

bool OAICreateCommitOutput::isSet() const {
...
bool OAICreateCommitOutput::isValid() const {
