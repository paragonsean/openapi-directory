...
#ifndef OAIGetBlobInput_H
#define OAIGetBlobInput_H
...
class OAIGetBlobInput : public OAIObject {
public:
    OAIGetBlobInput();
    OAIGetBlobInput(QString json);
    ~OAIGetBlobInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetBlobInput)

#endif // OAIGetBlobInput_H
