...
#ifndef OAIDifference_H
#define OAIDifference_H

#include <QJsonObject>

#include "OAIChangeTypeEnum.h"
#include "OAIDifference_afterBlob.h"
...
namespace OpenAPI {
class OAIDifference_beforeBlob;
class OAIDifference_afterBlob;

class OAIDifference : public OAIObject {
public:
    OAIDifference();
    OAIDifference(QString json);
    ~OAIDifference() override;
    ...
    OAIDifference_beforeBlob getBeforeBlob() const;
    void setBeforeBlob(const OAIDifference_beforeBlob &before_blob);
    bool is_before_blob_Set() const;
    bool is_before_blob_Valid() const;

    OAIDifference_afterBlob getAfterBlob() const;
    void setAfterBlob(const OAIDifference_afterBlob &after_blob);
    bool is_after_blob_Set() const;
    bool is_after_blob_Valid() const;

    OAIChangeTypeEnum getChangeType() const;
    void setChangeType(const OAIChangeTypeEnum &change_type);
...
private:
    ...
    OAIDifference_beforeBlob m_before_blob;
    bool m_before_blob_isSet;
    bool m_before_blob_isValid;

    OAIDifference_afterBlob m_after_blob;
    bool m_after_blob_isSet;
    bool m_after_blob_isValid;

    OAIChangeTypeEnum m_change_type;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDifference)

#endif // OAIDifference_H
