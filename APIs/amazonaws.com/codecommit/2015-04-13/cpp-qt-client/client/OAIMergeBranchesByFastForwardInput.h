...
/*
 * OAIMergeBranchesByFastForwardInput.h
 *
 * 
 */

#ifndef OAIMergeBranchesByFastForwardInput_H
#define OAIMergeBranchesByFastForwardInput_H
...
class OAIMergeBranchesByFastForwardInput : public OAIObject {
public:
    OAIMergeBranchesByFastForwardInput();
    OAIMergeBranchesByFastForwardInput(QString json);
    ~OAIMergeBranchesByFastForwardInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMergeBranchesByFastForwardInput)

#endif // OAIMergeBranchesByFastForwardInput_H
