...
OAIGetCommentReactionsInput::OAIGetCommentReactionsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetCommentReactionsInput::OAIGetCommentReactionsInput() {
    this->initializeModel();
}

OAIGetCommentReactionsInput::~OAIGetCommentReactionsInput() {}

void OAIGetCommentReactionsInput::initializeModel() {

    m_comment_id_isSet = false;
    m_comment_id_isValid = false;

    m_reaction_user_arn_isSet = false;
    m_reaction_user_arn_isValid = false;
...
void OAIGetCommentReactionsInput::fromJson(QString jsonString) {
...
void OAIGetCommentReactionsInput::fromJsonObject(QJsonObject json) {
    ...
    m_reaction_user_arn_isValid = ::OpenAPI::fromJsonValue(m_reaction_user_arn, json[QString("reactionUserArn")]);
    m_reaction_user_arn_isSet = !json[QString("reactionUserArn")].isNull() && m_reaction_user_arn_isValid;
...
QString OAIGetCommentReactionsInput::asJson() const {
...
QJsonObject OAIGetCommentReactionsInput::asJsonObject() const {
    QJsonObject obj;
    if (m_comment_id_isSet) {
        obj.insert(QString("commentId"), ::OpenAPI::toJsonValue(m_comment_id));
    }
    if (m_reaction_user_arn_isSet) {
        obj.insert(QString("reactionUserArn"), ::OpenAPI::toJsonValue(m_reaction_user_arn));
    }
...
QString OAIGetCommentReactionsInput::getCommentId() const {
    return m_comment_id;
}
void OAIGetCommentReactionsInput::setCommentId(const QString &comment_id) {
    m_comment_id = comment_id;
    m_comment_id_isSet = true;
}

bool OAIGetCommentReactionsInput::is_comment_id_Set() const{
    return m_comment_id_isSet;
}

bool OAIGetCommentReactionsInput::is_comment_id_Valid() const{
    return m_comment_id_isValid;
}

QString OAIGetCommentReactionsInput::getReactionUserArn() const {
    return m_reaction_user_arn;
}
void OAIGetCommentReactionsInput::setReactionUserArn(const QString &reaction_user_arn) {
    m_reaction_user_arn = reaction_user_arn;
    m_reaction_user_arn_isSet = true;
}

bool OAIGetCommentReactionsInput::is_reaction_user_arn_Set() const{
    return m_reaction_user_arn_isSet;
}

bool OAIGetCommentReactionsInput::is_reaction_user_arn_Valid() const{
    return m_reaction_user_arn_isValid;
}

QString OAIGetCommentReactionsInput::getNextToken() const {
    return m_next_token;
}
void OAIGetCommentReactionsInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIGetCommentReactionsInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIGetCommentReactionsInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIGetCommentReactionsInput::getMaxResults() const {
    return m_max_results;
}
void OAIGetCommentReactionsInput::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIGetCommentReactionsInput::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIGetCommentReactionsInput::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIGetCommentReactionsInput::isSet() const {
...
bool OAIGetCommentReactionsInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_comment_id_isValid && true;
}
