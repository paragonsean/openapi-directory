...
/*
 * OAIMergeHunk_destination.h
 *
 * 
 */

#ifndef OAIMergeHunk_destination_H
#define OAIMergeHunk_destination_H
...
class OAIMergeHunk_destination : public OAIObject {
public:
    OAIMergeHunk_destination();
    OAIMergeHunk_destination(QString json);
    ~OAIMergeHunk_destination() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMergeHunk_destination)

#endif // OAIMergeHunk_destination_H
