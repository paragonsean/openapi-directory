...
OAIDeleteApprovalRuleTemplateOutput::OAIDeleteApprovalRuleTemplateOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteApprovalRuleTemplateOutput::OAIDeleteApprovalRuleTemplateOutput() {
    this->initializeModel();
}

OAIDeleteApprovalRuleTemplateOutput::~OAIDeleteApprovalRuleTemplateOutput() {}

void OAIDeleteApprovalRuleTemplateOutput::initializeModel() {

    m_approval_rule_template_id_isSet = false;
    m_approval_rule_template_id_isValid = false;
}

void OAIDeleteApprovalRuleTemplateOutput::fromJson(QString jsonString) {
...
void OAIDeleteApprovalRuleTemplateOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteApprovalRuleTemplateOutput::asJson() const {
...
QJsonObject OAIDeleteApprovalRuleTemplateOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteApprovalRuleTemplateOutput::getApprovalRuleTemplateId() const {
    return m_approval_rule_template_id;
}
void OAIDeleteApprovalRuleTemplateOutput::setApprovalRuleTemplateId(const QString &approval_rule_template_id) {
    m_approval_rule_template_id = approval_rule_template_id;
    m_approval_rule_template_id_isSet = true;
}

bool OAIDeleteApprovalRuleTemplateOutput::is_approval_rule_template_id_Set() const{
    return m_approval_rule_template_id_isSet;
}

bool OAIDeleteApprovalRuleTemplateOutput::is_approval_rule_template_id_Valid() const{
    return m_approval_rule_template_id_isValid;
}

bool OAIDeleteApprovalRuleTemplateOutput::isSet() const {
...
bool OAIDeleteApprovalRuleTemplateOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_approval_rule_template_id_isValid && true;
}
