...
OAICommit_author::OAICommit_author(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICommit_author::OAICommit_author() {
    this->initializeModel();
}

OAICommit_author::~OAICommit_author() {}

void OAICommit_author::initializeModel() {
...
void OAICommit_author::fromJson(QString jsonString) {
...
void OAICommit_author::fromJsonObject(QJsonObject json) {
...
QString OAICommit_author::asJson() const {
...
QJsonObject OAICommit_author::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAICommit_author::getName() const {
    return m_name;
}
void OAICommit_author::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICommit_author::is_name_Set() const{
    return m_name_isSet;
}

bool OAICommit_author::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICommit_author::getEmail() const {
    return m_email;
}
void OAICommit_author::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAICommit_author::is_email_Set() const{
    return m_email_isSet;
}

bool OAICommit_author::is_email_Valid() const{
    return m_email_isValid;
}

QString OAICommit_author::getDate() const {
    return m_date;
}
void OAICommit_author::setDate(const QString &date) {
    m_date = date;
    m_date_isSet = true;
}

bool OAICommit_author::is_date_Set() const{
    return m_date_isSet;
}

bool OAICommit_author::is_date_Valid() const{
    return m_date_isValid;
}

bool OAICommit_author::isSet() const {
...
bool OAICommit_author::isValid() const {
