...
/*
 * OAIUpdatePullRequestStatusOutput_pullRequest.h
 *
 * 
 */

#ifndef OAIUpdatePullRequestStatusOutput_pullRequest_H
#define OAIUpdatePullRequestStatusOutput_pullRequest_H
...
class OAIUpdatePullRequestStatusOutput_pullRequest : public OAIObject {
public:
    OAIUpdatePullRequestStatusOutput_pullRequest();
    OAIUpdatePullRequestStatusOutput_pullRequest(QString json);
    ~OAIUpdatePullRequestStatusOutput_pullRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePullRequestStatusOutput_pullRequest)

#endif // OAIUpdatePullRequestStatusOutput_pullRequest_H
