...
OAICreatePullRequestApprovalRuleOutput::OAICreatePullRequestApprovalRuleOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreatePullRequestApprovalRuleOutput::OAICreatePullRequestApprovalRuleOutput() {
    this->initializeModel();
}

OAICreatePullRequestApprovalRuleOutput::~OAICreatePullRequestApprovalRuleOutput() {}

void OAICreatePullRequestApprovalRuleOutput::initializeModel() {

    m_approval_rule_isSet = false;
    m_approval_rule_isValid = false;
}

void OAICreatePullRequestApprovalRuleOutput::fromJson(QString jsonString) {
...
void OAICreatePullRequestApprovalRuleOutput::fromJsonObject(QJsonObject json) {
...
QString OAICreatePullRequestApprovalRuleOutput::asJson() const {
...
QJsonObject OAICreatePullRequestApprovalRuleOutput::asJsonObject() const {
    QJsonObject obj;
...
OAICreatePullRequestApprovalRuleOutput_approvalRule OAICreatePullRequestApprovalRuleOutput::getApprovalRule() const {
    return m_approval_rule;
}
void OAICreatePullRequestApprovalRuleOutput::setApprovalRule(const OAICreatePullRequestApprovalRuleOutput_approvalRule &approval_rule) {
    m_approval_rule = approval_rule;
    m_approval_rule_isSet = true;
}

bool OAICreatePullRequestApprovalRuleOutput::is_approval_rule_Set() const{
    return m_approval_rule_isSet;
}

bool OAICreatePullRequestApprovalRuleOutput::is_approval_rule_Valid() const{
    return m_approval_rule_isValid;
}

bool OAICreatePullRequestApprovalRuleOutput::isSet() const {
...
bool OAICreatePullRequestApprovalRuleOutput::isValid() const {
