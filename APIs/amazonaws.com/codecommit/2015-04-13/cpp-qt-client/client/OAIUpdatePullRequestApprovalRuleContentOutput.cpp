...
OAIUpdatePullRequestApprovalRuleContentOutput::OAIUpdatePullRequestApprovalRuleContentOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePullRequestApprovalRuleContentOutput::OAIUpdatePullRequestApprovalRuleContentOutput() {
    this->initializeModel();
}

OAIUpdatePullRequestApprovalRuleContentOutput::~OAIUpdatePullRequestApprovalRuleContentOutput() {}

void OAIUpdatePullRequestApprovalRuleContentOutput::initializeModel() {

    m_approval_rule_isSet = false;
    m_approval_rule_isValid = false;
}

void OAIUpdatePullRequestApprovalRuleContentOutput::fromJson(QString jsonString) {
...
void OAIUpdatePullRequestApprovalRuleContentOutput::fromJsonObject(QJsonObject json) {

    m_approval_rule_isValid = ::OpenAPI::fromJsonValue(m_approval_rule, json[QString("approvalRule")]);
    m_approval_rule_isSet = !json[QString("approvalRule")].isNull() && m_approval_rule_isValid;
}

QString OAIUpdatePullRequestApprovalRuleContentOutput::asJson() const {
...
QJsonObject OAIUpdatePullRequestApprovalRuleContentOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_approval_rule.isSet()) {
        obj.insert(QString("approvalRule"), ::OpenAPI::toJsonValue(m_approval_rule));
    }
    return obj;
}

OAIUpdatePullRequestApprovalRuleContentOutput_approvalRule OAIUpdatePullRequestApprovalRuleContentOutput::getApprovalRule() const {
    return m_approval_rule;
}
void OAIUpdatePullRequestApprovalRuleContentOutput::setApprovalRule(const OAIUpdatePullRequestApprovalRuleContentOutput_approvalRule &approval_rule) {
    m_approval_rule = approval_rule;
    m_approval_rule_isSet = true;
}

bool OAIUpdatePullRequestApprovalRuleContentOutput::is_approval_rule_Set() const{
    return m_approval_rule_isSet;
}

bool OAIUpdatePullRequestApprovalRuleContentOutput::is_approval_rule_Valid() const{
    return m_approval_rule_isValid;
}

bool OAIUpdatePullRequestApprovalRuleContentOutput::isSet() const {
...
bool OAIUpdatePullRequestApprovalRuleContentOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_approval_rule_isValid && true;
}
