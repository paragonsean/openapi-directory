...
/*
 * OAIGetCommitOutput_commit.h
 *
 * 
 */

#ifndef OAIGetCommitOutput_commit_H
#define OAIGetCommitOutput_commit_H

#include <QJsonObject>

#include "OAICommit_author.h"
#include "OAICommit_committer.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAICommit_author;
class OAICommit_committer;

class OAIGetCommitOutput_commit : public OAIObject {
public:
    OAIGetCommitOutput_commit();
    OAIGetCommitOutput_commit(QString json);
    ~OAIGetCommitOutput_commit() override;
    ...
    OAICommit_author getAuthor() const;
    void setAuthor(const OAICommit_author &author);
    bool is_author_Set() const;
    bool is_author_Valid() const;

    OAICommit_committer getCommitter() const;
    void setCommitter(const OAICommit_committer &committer);
...
private:
    ...
    OAICommit_author m_author;
    bool m_author_isSet;
    bool m_author_isValid;

    OAICommit_committer m_committer;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCommitOutput_commit)

#endif // OAIGetCommitOutput_commit_H
