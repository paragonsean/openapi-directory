...
/*
 * OAIPostCommentReplyOutput_comment.h
 *
 * 
 */

#ifndef OAIPostCommentReplyOutput_comment_H
#define OAIPostCommentReplyOutput_comment_H
...
class OAIPostCommentReplyOutput_comment : public OAIObject {
public:
    OAIPostCommentReplyOutput_comment();
    OAIPostCommentReplyOutput_comment(QString json);
    ~OAIPostCommentReplyOutput_comment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostCommentReplyOutput_comment)

#endif // OAIPostCommentReplyOutput_comment_H
