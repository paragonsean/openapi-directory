...
QString OAITarget::getRepositoryName() const {
    return m_repository_name;
}
void OAITarget::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAITarget::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAITarget::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAITarget::getSourceReference() const {
    return m_source_reference;
}
void OAITarget::setSourceReference(const QString &source_reference) {
    m_source_reference = source_reference;
    m_source_reference_isSet = true;
}

bool OAITarget::is_source_reference_Set() const{
    return m_source_reference_isSet;
}

bool OAITarget::is_source_reference_Valid() const{
    return m_source_reference_isValid;
}

QString OAITarget::getDestinationReference() const {
    return m_destination_reference;
}
void OAITarget::setDestinationReference(const QString &destination_reference) {
    m_destination_reference = destination_reference;
    m_destination_reference_isSet = true;
}

bool OAITarget::is_destination_reference_Set() const{
    return m_destination_reference_isSet;
}

bool OAITarget::is_destination_reference_Valid() const{
...
bool OAITarget::isValid() const {
    ...
    return m_repository_name_isValid && m_source_reference_isValid && true;
}
