...
/*
 * OAIUpdatePullRequestStatusInput.h
 *
 * 
 */

#ifndef OAIUpdatePullRequestStatusInput_H
#define OAIUpdatePullRequestStatusInput_H
...
class OAIUpdatePullRequestStatusInput : public OAIObject {
public:
    OAIUpdatePullRequestStatusInput();
    OAIUpdatePullRequestStatusInput(QString json);
    ~OAIUpdatePullRequestStatusInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePullRequestStatusInput)

#endif // OAIUpdatePullRequestStatusInput_H
