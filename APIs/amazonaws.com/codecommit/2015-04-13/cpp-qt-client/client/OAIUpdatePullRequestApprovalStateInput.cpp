...
OAIUpdatePullRequestApprovalStateInput::OAIUpdatePullRequestApprovalStateInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePullRequestApprovalStateInput::OAIUpdatePullRequestApprovalStateInput() {
    this->initializeModel();
}

OAIUpdatePullRequestApprovalStateInput::~OAIUpdatePullRequestApprovalStateInput() {}

void OAIUpdatePullRequestApprovalStateInput::initializeModel() {
...
void OAIUpdatePullRequestApprovalStateInput::fromJson(QString jsonString) {
...
void OAIUpdatePullRequestApprovalStateInput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdatePullRequestApprovalStateInput::asJson() const {
...
QJsonObject OAIUpdatePullRequestApprovalStateInput::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_approval_state.isSet()) {
        obj.insert(QString("approvalState"), ::OpenAPI::toJsonValue(m_approval_state));
    }
    return obj;
}

QString OAIUpdatePullRequestApprovalStateInput::getPullRequestId() const {
    return m_pull_request_id;
}
void OAIUpdatePullRequestApprovalStateInput::setPullRequestId(const QString &pull_request_id) {
    m_pull_request_id = pull_request_id;
    m_pull_request_id_isSet = true;
}

bool OAIUpdatePullRequestApprovalStateInput::is_pull_request_id_Set() const{
    return m_pull_request_id_isSet;
}

bool OAIUpdatePullRequestApprovalStateInput::is_pull_request_id_Valid() const{
    return m_pull_request_id_isValid;
}

QString OAIUpdatePullRequestApprovalStateInput::getRevisionId() const {
    return m_revision_id;
}
void OAIUpdatePullRequestApprovalStateInput::setRevisionId(const QString &revision_id) {
    m_revision_id = revision_id;
    m_revision_id_isSet = true;
}

bool OAIUpdatePullRequestApprovalStateInput::is_revision_id_Set() const{
    return m_revision_id_isSet;
}

bool OAIUpdatePullRequestApprovalStateInput::is_revision_id_Valid() const{
    return m_revision_id_isValid;
}

OAIApprovalState OAIUpdatePullRequestApprovalStateInput::getApprovalState() const {
    return m_approval_state;
}
void OAIUpdatePullRequestApprovalStateInput::setApprovalState(const OAIApprovalState &approval_state) {
    m_approval_state = approval_state;
    m_approval_state_isSet = true;
}

bool OAIUpdatePullRequestApprovalStateInput::is_approval_state_Set() const{
    return m_approval_state_isSet;
}

bool OAIUpdatePullRequestApprovalStateInput::is_approval_state_Valid() const{
    return m_approval_state_isValid;
}

bool OAIUpdatePullRequestApprovalStateInput::isSet() const {
...
bool OAIUpdatePullRequestApprovalStateInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_pull_request_id_isValid && m_revision_id_isValid && m_approval_state_isValid && true;
}
