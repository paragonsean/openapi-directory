...
OAIPullRequestEvent_pullRequestStatusChangedEventMetadata::OAIPullRequestEvent_pullRequestStatusChangedEventMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPullRequestEvent_pullRequestStatusChangedEventMetadata::OAIPullRequestEvent_pullRequestStatusChangedEventMetadata() {
    this->initializeModel();
}

OAIPullRequestEvent_pullRequestStatusChangedEventMetadata::~OAIPullRequestEvent_pullRequestStatusChangedEventMetadata() {}

void OAIPullRequestEvent_pullRequestStatusChangedEventMetadata::initializeModel() {

    m_pull_request_status_isSet = false;
    m_pull_request_status_isValid = false;
}

void OAIPullRequestEvent_pullRequestStatusChangedEventMetadata::fromJson(QString jsonString) {
...
void OAIPullRequestEvent_pullRequestStatusChangedEventMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIPullRequestEvent_pullRequestStatusChangedEventMetadata::asJson() const {
...
QJsonObject OAIPullRequestEvent_pullRequestStatusChangedEventMetadata::asJsonObject() const {
    QJsonObject obj;
...
OAIPullRequestStatusEnum OAIPullRequestEvent_pullRequestStatusChangedEventMetadata::getPullRequestStatus() const {
    return m_pull_request_status;
}
void OAIPullRequestEvent_pullRequestStatusChangedEventMetadata::setPullRequestStatus(const OAIPullRequestStatusEnum &pull_request_status) {
    m_pull_request_status = pull_request_status;
    m_pull_request_status_isSet = true;
}

bool OAIPullRequestEvent_pullRequestStatusChangedEventMetadata::is_pull_request_status_Set() const{
    return m_pull_request_status_isSet;
}

bool OAIPullRequestEvent_pullRequestStatusChangedEventMetadata::is_pull_request_status_Valid() const{
    return m_pull_request_status_isValid;
}

bool OAIPullRequestEvent_pullRequestStatusChangedEventMetadata::isSet() const {
...
bool OAIPullRequestEvent_pullRequestStatusChangedEventMetadata::isValid() const {
