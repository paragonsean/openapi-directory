...
/*
 * OAIBatchGetCommitsOutput.h
 *
 * 
 */

#ifndef OAIBatchGetCommitsOutput_H
#define OAIBatchGetCommitsOutput_H
...
class OAIBatchGetCommitsOutput : public OAIObject {
public:
    OAIBatchGetCommitsOutput();
    OAIBatchGetCommitsOutput(QString json);
    ~OAIBatchGetCommitsOutput() override;
    ...
    QList getCommits() const;
    void setCommits(const QList &commits);
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchGetCommitsOutput)

#endif // OAIBatchGetCommitsOutput_H
