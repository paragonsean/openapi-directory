...
OAIDeleteApprovalRuleTemplateInput::OAIDeleteApprovalRuleTemplateInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteApprovalRuleTemplateInput::OAIDeleteApprovalRuleTemplateInput() {
    this->initializeModel();
}

OAIDeleteApprovalRuleTemplateInput::~OAIDeleteApprovalRuleTemplateInput() {}

void OAIDeleteApprovalRuleTemplateInput::initializeModel() {

    m_approval_rule_template_name_isSet = false;
    m_approval_rule_template_name_isValid = false;
}

void OAIDeleteApprovalRuleTemplateInput::fromJson(QString jsonString) {
...
void OAIDeleteApprovalRuleTemplateInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteApprovalRuleTemplateInput::asJson() const {
...
QJsonObject OAIDeleteApprovalRuleTemplateInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteApprovalRuleTemplateInput::getApprovalRuleTemplateName() const {
    return m_approval_rule_template_name;
}
void OAIDeleteApprovalRuleTemplateInput::setApprovalRuleTemplateName(const QString &approval_rule_template_name) {
    m_approval_rule_template_name = approval_rule_template_name;
    m_approval_rule_template_name_isSet = true;
}

bool OAIDeleteApprovalRuleTemplateInput::is_approval_rule_template_name_Set() const{
    return m_approval_rule_template_name_isSet;
}

bool OAIDeleteApprovalRuleTemplateInput::is_approval_rule_template_name_Valid() const{
    return m_approval_rule_template_name_isValid;
}

bool OAIDeleteApprovalRuleTemplateInput::isSet() const {
...
bool OAIDeleteApprovalRuleTemplateInput::isValid() const {
