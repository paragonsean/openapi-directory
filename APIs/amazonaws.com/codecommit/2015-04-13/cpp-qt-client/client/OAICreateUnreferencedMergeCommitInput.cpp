...
OAICreateUnreferencedMergeCommitInput::OAICreateUnreferencedMergeCommitInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateUnreferencedMergeCommitInput::OAICreateUnreferencedMergeCommitInput() {
    this->initializeModel();
}

OAICreateUnreferencedMergeCommitInput::~OAICreateUnreferencedMergeCommitInput() {}

void OAICreateUnreferencedMergeCommitInput::initializeModel() {
...
void OAICreateUnreferencedMergeCommitInput::fromJson(QString jsonString) {
...
void OAICreateUnreferencedMergeCommitInput::fromJsonObject(QJsonObject json) {
...
QString OAICreateUnreferencedMergeCommitInput::asJson() const {
...
QJsonObject OAICreateUnreferencedMergeCommitInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateUnreferencedMergeCommitInput::getRepositoryName() const {
    return m_repository_name;
}
void OAICreateUnreferencedMergeCommitInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAICreateUnreferencedMergeCommitInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAICreateUnreferencedMergeCommitInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAICreateUnreferencedMergeCommitInput::getSourceCommitSpecifier() const {
    return m_source_commit_specifier;
}
void OAICreateUnreferencedMergeCommitInput::setSourceCommitSpecifier(const QString &source_commit_specifier) {
    m_source_commit_specifier = source_commit_specifier;
    m_source_commit_specifier_isSet = true;
}

bool OAICreateUnreferencedMergeCommitInput::is_source_commit_specifier_Set() const{
    return m_source_commit_specifier_isSet;
}

bool OAICreateUnreferencedMergeCommitInput::is_source_commit_specifier_Valid() const{
    return m_source_commit_specifier_isValid;
}

QString OAICreateUnreferencedMergeCommitInput::getDestinationCommitSpecifier() const {
    return m_destination_commit_specifier;
}
void OAICreateUnreferencedMergeCommitInput::setDestinationCommitSpecifier(const QString &destination_commit_specifier) {
    m_destination_commit_specifier = destination_commit_specifier;
    m_destination_commit_specifier_isSet = true;
}

bool OAICreateUnreferencedMergeCommitInput::is_destination_commit_specifier_Set() const{
    return m_destination_commit_specifier_isSet;
}

bool OAICreateUnreferencedMergeCommitInput::is_destination_commit_specifier_Valid() const{
    return m_destination_commit_specifier_isValid;
}

OAIMergeOptionTypeEnum OAICreateUnreferencedMergeCommitInput::getMergeOption() const {
    return m_merge_option;
}
void OAICreateUnreferencedMergeCommitInput::setMergeOption(const OAIMergeOptionTypeEnum &merge_option) {
    m_merge_option = merge_option;
    m_merge_option_isSet = true;
}

bool OAICreateUnreferencedMergeCommitInput::is_merge_option_Set() const{
    return m_merge_option_isSet;
}

bool OAICreateUnreferencedMergeCommitInput::is_merge_option_Valid() const{
    return m_merge_option_isValid;
}

OAIConflictDetailLevelTypeEnum OAICreateUnreferencedMergeCommitInput::getConflictDetailLevel() const {
    return m_conflict_detail_level;
}
void OAICreateUnreferencedMergeCommitInput::setConflictDetailLevel(const OAIConflictDetailLevelTypeEnum &conflict_detail_level) {
    m_conflict_detail_level = conflict_detail_level;
    m_conflict_detail_level_isSet = true;
}

bool OAICreateUnreferencedMergeCommitInput::is_conflict_detail_level_Set() const{
    return m_conflict_detail_level_isSet;
}

bool OAICreateUnreferencedMergeCommitInput::is_conflict_detail_level_Valid() const{
    return m_conflict_detail_level_isValid;
}

OAIConflictResolutionStrategyTypeEnum OAICreateUnreferencedMergeCommitInput::getConflictResolutionStrategy() const {
    return m_conflict_resolution_strategy;
}
void OAICreateUnreferencedMergeCommitInput::setConflictResolutionStrategy(const OAIConflictResolutionStrategyTypeEnum &conflict_resolution_strategy) {
    m_conflict_resolution_strategy = conflict_resolution_strategy;
    m_conflict_resolution_strategy_isSet = true;
}

bool OAICreateUnreferencedMergeCommitInput::is_conflict_resolution_strategy_Set() const{
    return m_conflict_resolution_strategy_isSet;
}

bool OAICreateUnreferencedMergeCommitInput::is_conflict_resolution_strategy_Valid() const{
    return m_conflict_resolution_strategy_isValid;
}

QString OAICreateUnreferencedMergeCommitInput::getAuthorName() const {
    return m_author_name;
}
void OAICreateUnreferencedMergeCommitInput::setAuthorName(const QString &author_name) {
    m_author_name = author_name;
    m_author_name_isSet = true;
}

bool OAICreateUnreferencedMergeCommitInput::is_author_name_Set() const{
    return m_author_name_isSet;
}

bool OAICreateUnreferencedMergeCommitInput::is_author_name_Valid() const{
    return m_author_name_isValid;
}

QString OAICreateUnreferencedMergeCommitInput::getEmail() const {
    return m_email;
}
void OAICreateUnreferencedMergeCommitInput::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAICreateUnreferencedMergeCommitInput::is_email_Set() const{
    return m_email_isSet;
}

bool OAICreateUnreferencedMergeCommitInput::is_email_Valid() const{
    return m_email_isValid;
}

QString OAICreateUnreferencedMergeCommitInput::getCommitMessage() const {
    return m_commit_message;
}
void OAICreateUnreferencedMergeCommitInput::setCommitMessage(const QString &commit_message) {
    m_commit_message = commit_message;
    m_commit_message_isSet = true;
}

bool OAICreateUnreferencedMergeCommitInput::is_commit_message_Set() const{
    return m_commit_message_isSet;
}

bool OAICreateUnreferencedMergeCommitInput::is_commit_message_Valid() const{
    return m_commit_message_isValid;
}

bool OAICreateUnreferencedMergeCommitInput::getKeepEmptyFolders() const {
    return m_keep_empty_folders;
}
void OAICreateUnreferencedMergeCommitInput::setKeepEmptyFolders(const bool &keep_empty_folders) {
    m_keep_empty_folders = keep_empty_folders;
    m_keep_empty_folders_isSet = true;
}

bool OAICreateUnreferencedMergeCommitInput::is_keep_empty_folders_Set() const{
    return m_keep_empty_folders_isSet;
}

bool OAICreateUnreferencedMergeCommitInput::is_keep_empty_folders_Valid() const{
    return m_keep_empty_folders_isValid;
}

OAICreateUnreferencedMergeCommitInput_conflictResolution OAICreateUnreferencedMergeCommitInput::getConflictResolution() const {
    return m_conflict_resolution;
}
void OAICreateUnreferencedMergeCommitInput::setConflictResolution(const OAICreateUnreferencedMergeCommitInput_conflictResolution &conflict_resolution) {
    m_conflict_resolution = conflict_resolution;
    m_conflict_resolution_isSet = true;
}

bool OAICreateUnreferencedMergeCommitInput::is_conflict_resolution_Set() const{
    return m_conflict_resolution_isSet;
}

bool OAICreateUnreferencedMergeCommitInput::is_conflict_resolution_Valid() const{
    return m_conflict_resolution_isValid;
}

bool OAICreateUnreferencedMergeCommitInput::isSet() const {
...
bool OAICreateUnreferencedMergeCommitInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_repository_name_isValid && m_source_commit_specifier_isValid && m_destination_commit_specifier_isValid && m_merge_option_isValid && true;
}
