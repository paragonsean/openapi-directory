...
OAISortByEnum::OAISortByEnum(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISortByEnum::OAISortByEnum() {
    this->initializeModel();
}

OAISortByEnum::~OAISortByEnum() {}

void OAISortByEnum::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAISortByEnum::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAISortByEnum::fromJson(QString jsonString) {
    
    if ( jsonString.compare("repositoryName", Qt::CaseInsensitive) == 0) {
        m_value = eOAISortByEnum::REPOSITORYNAME;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("lastModifiedDate", Qt::CaseInsensitive) == 0) {
        m_value = eOAISortByEnum::LASTMODIFIEDDATE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAISortByEnum::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAISortByEnum::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAISortByEnum::REPOSITORYNAME:
            val = "repositoryName";
            break;
        case eOAISortByEnum::LASTMODIFIEDDATE:
...
QJsonValue OAISortByEnum::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAISortByEnum::eOAISortByEnum OAISortByEnum::getValue() const {
    return m_value;
}

void OAISortByEnum::setValue(const OAISortByEnum::eOAISortByEnum& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAISortByEnum::isSet() const {
    
    return m_value_isSet;
}

bool OAISortByEnum::isValid() const {
