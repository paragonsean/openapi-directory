...
OAIOverridePullRequestApprovalRulesInput::OAIOverridePullRequestApprovalRulesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOverridePullRequestApprovalRulesInput::OAIOverridePullRequestApprovalRulesInput() {
    this->initializeModel();
}

OAIOverridePullRequestApprovalRulesInput::~OAIOverridePullRequestApprovalRulesInput() {}

void OAIOverridePullRequestApprovalRulesInput::initializeModel() {
    ...
    m_override_status_isSet = false;
    m_override_status_isValid = false;
}

void OAIOverridePullRequestApprovalRulesInput::fromJson(QString jsonString) {
...
void OAIOverridePullRequestApprovalRulesInput::fromJsonObject(QJsonObject json) {
    ...
    m_override_status_isValid = ::OpenAPI::fromJsonValue(m_override_status, json[QString("overrideStatus")]);
    m_override_status_isSet = !json[QString("overrideStatus")].isNull() && m_override_status_isValid;
}

QString OAIOverridePullRequestApprovalRulesInput::asJson() const {
...
QJsonObject OAIOverridePullRequestApprovalRulesInput::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_override_status.isSet()) {
        obj.insert(QString("overrideStatus"), ::OpenAPI::toJsonValue(m_override_status));
    }
    return obj;
}

QString OAIOverridePullRequestApprovalRulesInput::getPullRequestId() const {
    return m_pull_request_id;
}
void OAIOverridePullRequestApprovalRulesInput::setPullRequestId(const QString &pull_request_id) {
    m_pull_request_id = pull_request_id;
    m_pull_request_id_isSet = true;
}

bool OAIOverridePullRequestApprovalRulesInput::is_pull_request_id_Set() const{
    return m_pull_request_id_isSet;
}

bool OAIOverridePullRequestApprovalRulesInput::is_pull_request_id_Valid() const{
    return m_pull_request_id_isValid;
}

QString OAIOverridePullRequestApprovalRulesInput::getRevisionId() const {
    return m_revision_id;
}
void OAIOverridePullRequestApprovalRulesInput::setRevisionId(const QString &revision_id) {
    m_revision_id = revision_id;
    m_revision_id_isSet = true;
}

bool OAIOverridePullRequestApprovalRulesInput::is_revision_id_Set() const{
    return m_revision_id_isSet;
}

bool OAIOverridePullRequestApprovalRulesInput::is_revision_id_Valid() const{
    return m_revision_id_isValid;
}

OAIOverrideStatus OAIOverridePullRequestApprovalRulesInput::getOverrideStatus() const {
    return m_override_status;
}
void OAIOverridePullRequestApprovalRulesInput::setOverrideStatus(const OAIOverrideStatus &override_status) {
    m_override_status = override_status;
    m_override_status_isSet = true;
}

bool OAIOverridePullRequestApprovalRulesInput::is_override_status_Set() const{
    return m_override_status_isSet;
}

bool OAIOverridePullRequestApprovalRulesInput::is_override_status_Valid() const{
    return m_override_status_isValid;
}

bool OAIOverridePullRequestApprovalRulesInput::isSet() const {
...
bool OAIOverridePullRequestApprovalRulesInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_pull_request_id_isValid && m_revision_id_isValid && m_override_status_isValid && true;
}
