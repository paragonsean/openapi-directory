...
#include "OAIPullRequestTarget.h"
...
OAIPullRequestTarget::OAIPullRequestTarget(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPullRequestTarget::OAIPullRequestTarget() {
    this->initializeModel();
}

OAIPullRequestTarget::~OAIPullRequestTarget() {}

void OAIPullRequestTarget::initializeModel() {
    ...
    m_destination_reference_isSet = false;
    m_destination_reference_isValid = false;
    ...
    m_merge_metadata_isSet = false;
    m_merge_metadata_isValid = false;
}

void OAIPullRequestTarget::fromJson(QString jsonString) {
...
void OAIPullRequestTarget::fromJsonObject(QJsonObject json) {
    ...
    m_destination_reference_isValid = ::OpenAPI::fromJsonValue(m_destination_reference, json[QString("destinationReference")]);
    m_destination_reference_isSet = !json[QString("destinationReference")].isNull() && m_destination_reference_isValid;
    ...
    m_merge_metadata_isValid = ::OpenAPI::fromJsonValue(m_merge_metadata, json[QString("mergeMetadata")]);
    m_merge_metadata_isSet = !json[QString("mergeMetadata")].isNull() && m_merge_metadata_isValid;
}

QString OAIPullRequestTarget::asJson() const {
...
QJsonObject OAIPullRequestTarget::asJsonObject() const {
    QJsonObject obj;
    if (m_repository_name_isSet) {
        obj.insert(QString("repositoryName"), ::OpenAPI::toJsonValue(m_repository_name));
    }
    if (m_source_reference_isSet) {
        obj.insert(QString("sourceReference"), ::OpenAPI::toJsonValue(m_source_reference));
    }
    if (m_destination_reference_isSet) {
        obj.insert(QString("destinationReference"), ::OpenAPI::toJsonValue(m_destination_reference));
    }
    ...
    if (m_merge_metadata.isSet()) {
        obj.insert(QString("mergeMetadata"), ::OpenAPI::toJsonValue(m_merge_metadata));
    }
    return obj;
}

QString OAIPullRequestTarget::getRepositoryName() const {
    return m_repository_name;
}
void OAIPullRequestTarget::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIPullRequestTarget::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIPullRequestTarget::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIPullRequestTarget::getSourceReference() const {
    return m_source_reference;
}
void OAIPullRequestTarget::setSourceReference(const QString &source_reference) {
    m_source_reference = source_reference;
    m_source_reference_isSet = true;
}

bool OAIPullRequestTarget::is_source_reference_Set() const{
    return m_source_reference_isSet;
}

bool OAIPullRequestTarget::is_source_reference_Valid() const{
    return m_source_reference_isValid;
}

QString OAIPullRequestTarget::getDestinationReference() const {
    return m_destination_reference;
}
void OAIPullRequestTarget::setDestinationReference(const QString &destination_reference) {
    m_destination_reference = destination_reference;
    m_destination_reference_isSet = true;
}

bool OAIPullRequestTarget::is_destination_reference_Set() const{
    return m_destination_reference_isSet;
}

bool OAIPullRequestTarget::is_destination_reference_Valid() const{
    return m_destination_reference_isValid;
}

QString OAIPullRequestTarget::getDestinationCommit() const {
    return m_destination_commit;
}
void OAIPullRequestTarget::setDestinationCommit(const QString &destination_commit) {
    m_destination_commit = destination_commit;
    m_destination_commit_isSet = true;
}

bool OAIPullRequestTarget::is_destination_commit_Set() const{
    return m_destination_commit_isSet;
}

bool OAIPullRequestTarget::is_destination_commit_Valid() const{
    return m_destination_commit_isValid;
}

QString OAIPullRequestTarget::getSourceCommit() const {
    return m_source_commit;
}
void OAIPullRequestTarget::setSourceCommit(const QString &source_commit) {
    m_source_commit = source_commit;
    m_source_commit_isSet = true;
}

bool OAIPullRequestTarget::is_source_commit_Set() const{
    return m_source_commit_isSet;
}

bool OAIPullRequestTarget::is_source_commit_Valid() const{
    return m_source_commit_isValid;
}

QString OAIPullRequestTarget::getMergeBase() const {
    return m_merge_base;
}
void OAIPullRequestTarget::setMergeBase(const QString &merge_base) {
    m_merge_base = merge_base;
    m_merge_base_isSet = true;
}

bool OAIPullRequestTarget::is_merge_base_Set() const{
    return m_merge_base_isSet;
}

bool OAIPullRequestTarget::is_merge_base_Valid() const{
    return m_merge_base_isValid;
}

OAIPullRequestTarget_mergeMetadata OAIPullRequestTarget::getMergeMetadata() const {
    return m_merge_metadata;
}
void OAIPullRequestTarget::setMergeMetadata(const OAIPullRequestTarget_mergeMetadata &merge_metadata) {
    m_merge_metadata = merge_metadata;
    m_merge_metadata_isSet = true;
}

bool OAIPullRequestTarget::is_merge_metadata_Set() const{
    return m_merge_metadata_isSet;
}

bool OAIPullRequestTarget::is_merge_metadata_Valid() const{
    return m_merge_metadata_isValid;
}

bool OAIPullRequestTarget::isSet() const {
...
bool OAIPullRequestTarget::isValid() const {
