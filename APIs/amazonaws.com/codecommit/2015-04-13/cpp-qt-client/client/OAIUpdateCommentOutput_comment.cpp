...
#include "OAIUpdateCommentOutput_comment.h"
...
OAIUpdateCommentOutput_comment::OAIUpdateCommentOutput_comment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateCommentOutput_comment::OAIUpdateCommentOutput_comment() {
    this->initializeModel();
}

OAIUpdateCommentOutput_comment::~OAIUpdateCommentOutput_comment() {}

void OAIUpdateCommentOutput_comment::initializeModel() {
...
void OAIUpdateCommentOutput_comment::fromJson(QString jsonString) {
...
void OAIUpdateCommentOutput_comment::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateCommentOutput_comment::asJson() const {
...
QJsonObject OAIUpdateCommentOutput_comment::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateCommentOutput_comment::getCommentId() const {
    return m_comment_id;
}
void OAIUpdateCommentOutput_comment::setCommentId(const QString &comment_id) {
    m_comment_id = comment_id;
    m_comment_id_isSet = true;
}

bool OAIUpdateCommentOutput_comment::is_comment_id_Set() const{
    return m_comment_id_isSet;
}

bool OAIUpdateCommentOutput_comment::is_comment_id_Valid() const{
    return m_comment_id_isValid;
}

QString OAIUpdateCommentOutput_comment::getContent() const {
    return m_content;
}
void OAIUpdateCommentOutput_comment::setContent(const QString &content) {
    m_content = content;
    m_content_isSet = true;
}

bool OAIUpdateCommentOutput_comment::is_content_Set() const{
    return m_content_isSet;
}

bool OAIUpdateCommentOutput_comment::is_content_Valid() const{
    return m_content_isValid;
}

QString OAIUpdateCommentOutput_comment::getInReplyTo() const {
    return m_in_reply_to;
}
void OAIUpdateCommentOutput_comment::setInReplyTo(const QString &in_reply_to) {
    m_in_reply_to = in_reply_to;
    m_in_reply_to_isSet = true;
}

bool OAIUpdateCommentOutput_comment::is_in_reply_to_Set() const{
    return m_in_reply_to_isSet;
}

bool OAIUpdateCommentOutput_comment::is_in_reply_to_Valid() const{
    return m_in_reply_to_isValid;
}

QDateTime OAIUpdateCommentOutput_comment::getCreationDate() const {
    return m_creation_date;
}
void OAIUpdateCommentOutput_comment::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAIUpdateCommentOutput_comment::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAIUpdateCommentOutput_comment::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

QDateTime OAIUpdateCommentOutput_comment::getLastModifiedDate() const {
    return m_last_modified_date;
}
void OAIUpdateCommentOutput_comment::setLastModifiedDate(const QDateTime &last_modified_date) {
    m_last_modified_date = last_modified_date;
    m_last_modified_date_isSet = true;
}

bool OAIUpdateCommentOutput_comment::is_last_modified_date_Set() const{
    return m_last_modified_date_isSet;
}

bool OAIUpdateCommentOutput_comment::is_last_modified_date_Valid() const{
    return m_last_modified_date_isValid;
}

QString OAIUpdateCommentOutput_comment::getAuthorArn() const {
    return m_author_arn;
}
void OAIUpdateCommentOutput_comment::setAuthorArn(const QString &author_arn) {
    m_author_arn = author_arn;
    m_author_arn_isSet = true;
}

bool OAIUpdateCommentOutput_comment::is_author_arn_Set() const{
    return m_author_arn_isSet;
}

bool OAIUpdateCommentOutput_comment::is_author_arn_Valid() const{
    return m_author_arn_isValid;
}

bool OAIUpdateCommentOutput_comment::getDeleted() const {
    return m_deleted;
}
void OAIUpdateCommentOutput_comment::setDeleted(const bool &deleted) {
    m_deleted = deleted;
    m_deleted_isSet = true;
}

bool OAIUpdateCommentOutput_comment::is_deleted_Set() const{
    return m_deleted_isSet;
}

bool OAIUpdateCommentOutput_comment::is_deleted_Valid() const{
    return m_deleted_isValid;
}

QString OAIUpdateCommentOutput_comment::getClientRequestToken() const {
    return m_client_request_token;
}
void OAIUpdateCommentOutput_comment::setClientRequestToken(const QString &client_request_token) {
    m_client_request_token = client_request_token;
    m_client_request_token_isSet = true;
}

bool OAIUpdateCommentOutput_comment::is_client_request_token_Set() const{
    return m_client_request_token_isSet;
}

bool OAIUpdateCommentOutput_comment::is_client_request_token_Valid() const{
    return m_client_request_token_isValid;
}

QList OAIUpdateCommentOutput_comment::getCallerReactions() const {
    return m_caller_reactions;
}
void OAIUpdateCommentOutput_comment::setCallerReactions(const QList &caller_reactions) {
    m_caller_reactions = caller_reactions;
    m_caller_reactions_isSet = true;
}

bool OAIUpdateCommentOutput_comment::is_caller_reactions_Set() const{
    return m_caller_reactions_isSet;
}

bool OAIUpdateCommentOutput_comment::is_caller_reactions_Valid() const{
    return m_caller_reactions_isValid;
}

QMap OAIUpdateCommentOutput_comment::getReactionCounts() const {
    return m_reaction_counts;
}
void OAIUpdateCommentOutput_comment::setReactionCounts(const QMap &reaction_counts) {
    m_reaction_counts = reaction_counts;
    m_reaction_counts_isSet = true;
}

bool OAIUpdateCommentOutput_comment::is_reaction_counts_Set() const{
    return m_reaction_counts_isSet;
}

bool OAIUpdateCommentOutput_comment::is_reaction_counts_Valid() const{
    return m_reaction_counts_isValid;
}

bool OAIUpdateCommentOutput_comment::isSet() const {
...
bool OAIUpdateCommentOutput_comment::isValid() const {
