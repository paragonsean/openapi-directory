...
/*
 * OAIGetPullRequestOutput_pullRequest.h
 *
 * 
 */

#ifndef OAIGetPullRequestOutput_pullRequest_H
#define OAIGetPullRequestOutput_pullRequest_H
...
class OAIGetPullRequestOutput_pullRequest : public OAIObject {
public:
    OAIGetPullRequestOutput_pullRequest();
    OAIGetPullRequestOutput_pullRequest(QString json);
    ~OAIGetPullRequestOutput_pullRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPullRequestOutput_pullRequest)

#endif // OAIGetPullRequestOutput_pullRequest_H
