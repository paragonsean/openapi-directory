...
/*
 * OAIListBranchesOutput.h
 *
 * Represents the output of a list branches operation.
 */

#ifndef OAIListBranchesOutput_H
#define OAIListBranchesOutput_H
...
class OAIListBranchesOutput : public OAIObject {
public:
    OAIListBranchesOutput();
    OAIListBranchesOutput(QString json);
    ~OAIListBranchesOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListBranchesOutput)

#endif // OAIListBranchesOutput_H
