...
/*
 * OAIReactionForComment.h
 *
 * Information about the reaction values provided by users on a comment.
 */

#ifndef OAIReactionForComment_H
#define OAIReactionForComment_H

#include <QJsonObject>

#include "OAIReactionForComment_reaction.h"
#include <QList>
...
namespace OpenAPI {
class OAIReactionForComment_reaction;

class OAIReactionForComment : public OAIObject {
public:
    OAIReactionForComment();
    OAIReactionForComment(QString json);
    ~OAIReactionForComment() override;
    ...
    OAIReactionForComment_reaction getReaction() const;
    void setReaction(const OAIReactionForComment_reaction &reaction);
    bool is_reaction_Set() const;
    bool is_reaction_Valid() const;

    QList getReactionUsers() const;
    void setReactionUsers(const QList &reaction_users);
    bool is_reaction_users_Set() const;
    bool is_reaction_users_Valid() const;

    qint32 getReactionsFromDeletedUsersCount() const;
    void setReactionsFromDeletedUsersCount(const qint32 &reactions_from_deleted_users_count);
    bool is_reactions_from_deleted_users_count_Set() const;
    bool is_reactions_from_deleted_users_count_Valid() const;
...
private:
    ...
    OAIReactionForComment_reaction m_reaction;
    bool m_reaction_isSet;
    bool m_reaction_isValid;

    QList m_reaction_users;
    bool m_reaction_users_isSet;
    bool m_reaction_users_isValid;

    qint32 m_reactions_from_deleted_users_count;
    bool m_reactions_from_deleted_users_count_isSet;
    bool m_reactions_from_deleted_users_count_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIReactionForComment)

#endif // OAIReactionForComment_H
