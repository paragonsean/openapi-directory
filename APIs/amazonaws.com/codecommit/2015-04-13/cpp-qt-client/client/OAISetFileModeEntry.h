...
/*
 * OAISetFileModeEntry.h
 *
 * Information about the file mode changes.
 */

#ifndef OAISetFileModeEntry_H
#define OAISetFileModeEntry_H
...
class OAISetFileModeEntry : public OAIObject {
public:
    OAISetFileModeEntry();
    OAISetFileModeEntry(QString json);
    ~OAISetFileModeEntry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetFileModeEntry)

#endif // OAISetFileModeEntry_H
