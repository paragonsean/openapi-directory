...
#ifndef OAICommit_author_H
#define OAICommit_author_H
...
class OAICommit_author : public OAIObject {
public:
    OAICommit_author();
    OAICommit_author(QString json);
    ~OAICommit_author() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommit_author)

#endif // OAICommit_author_H
