...
/*
 * OAIDeleteBranchInput.h
 *
 * Represents the input of a delete branch operation.
 */

#ifndef OAIDeleteBranchInput_H
#define OAIDeleteBranchInput_H
...
class OAIDeleteBranchInput : public OAIObject {
public:
    OAIDeleteBranchInput();
    OAIDeleteBranchInput(QString json);
    ~OAIDeleteBranchInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteBranchInput)

#endif // OAIDeleteBranchInput_H
