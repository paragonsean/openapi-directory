...
OAICommentsForComparedCommit_location::OAICommentsForComparedCommit_location(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICommentsForComparedCommit_location::OAICommentsForComparedCommit_location() {
    this->initializeModel();
}

OAICommentsForComparedCommit_location::~OAICommentsForComparedCommit_location() {}

void OAICommentsForComparedCommit_location::initializeModel() {
...
void OAICommentsForComparedCommit_location::fromJson(QString jsonString) {
...
void OAICommentsForComparedCommit_location::fromJsonObject(QJsonObject json) {
...
QString OAICommentsForComparedCommit_location::asJson() const {
...
QJsonObject OAICommentsForComparedCommit_location::asJsonObject() const {
    QJsonObject obj;
...
QString OAICommentsForComparedCommit_location::getFilePath() const {
    return m_file_path;
}
void OAICommentsForComparedCommit_location::setFilePath(const QString &file_path) {
    m_file_path = file_path;
    m_file_path_isSet = true;
}

bool OAICommentsForComparedCommit_location::is_file_path_Set() const{
    return m_file_path_isSet;
}

bool OAICommentsForComparedCommit_location::is_file_path_Valid() const{
    return m_file_path_isValid;
}

qint32 OAICommentsForComparedCommit_location::getFilePosition() const {
    return m_file_position;
}
void OAICommentsForComparedCommit_location::setFilePosition(const qint32 &file_position) {
    m_file_position = file_position;
    m_file_position_isSet = true;
}

bool OAICommentsForComparedCommit_location::is_file_position_Set() const{
    return m_file_position_isSet;
}

bool OAICommentsForComparedCommit_location::is_file_position_Valid() const{
    return m_file_position_isValid;
}

OAIRelativeFileVersionEnum OAICommentsForComparedCommit_location::getRelativeFileVersion() const {
    return m_relative_file_version;
}
void OAICommentsForComparedCommit_location::setRelativeFileVersion(const OAIRelativeFileVersionEnum &relative_file_version) {
    m_relative_file_version = relative_file_version;
    m_relative_file_version_isSet = true;
}

bool OAICommentsForComparedCommit_location::is_relative_file_version_Set() const{
    return m_relative_file_version_isSet;
}

bool OAICommentsForComparedCommit_location::is_relative_file_version_Valid() const{
    return m_relative_file_version_isValid;
}

bool OAICommentsForComparedCommit_location::isSet() const {
...
bool OAICommentsForComparedCommit_location::isValid() const {
