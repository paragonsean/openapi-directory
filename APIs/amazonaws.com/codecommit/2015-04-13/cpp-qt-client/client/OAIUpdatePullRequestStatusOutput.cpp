...
OAIUpdatePullRequestStatusOutput::OAIUpdatePullRequestStatusOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePullRequestStatusOutput::OAIUpdatePullRequestStatusOutput() {
    this->initializeModel();
}

OAIUpdatePullRequestStatusOutput::~OAIUpdatePullRequestStatusOutput() {}

void OAIUpdatePullRequestStatusOutput::initializeModel() {

    m_pull_request_isSet = false;
    m_pull_request_isValid = false;
}

void OAIUpdatePullRequestStatusOutput::fromJson(QString jsonString) {
...
void OAIUpdatePullRequestStatusOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdatePullRequestStatusOutput::asJson() const {
...
QJsonObject OAIUpdatePullRequestStatusOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdatePullRequestStatusOutput_pullRequest OAIUpdatePullRequestStatusOutput::getPullRequest() const {
    return m_pull_request;
}
void OAIUpdatePullRequestStatusOutput::setPullRequest(const OAIUpdatePullRequestStatusOutput_pullRequest &pull_request) {
    m_pull_request = pull_request;
    m_pull_request_isSet = true;
}

bool OAIUpdatePullRequestStatusOutput::is_pull_request_Set() const{
    return m_pull_request_isSet;
}

bool OAIUpdatePullRequestStatusOutput::is_pull_request_Valid() const{
    return m_pull_request_isValid;
}

bool OAIUpdatePullRequestStatusOutput::isSet() const {
...
bool OAIUpdatePullRequestStatusOutput::isValid() const {
