...
/*
 * OAIDescribeMergeConflictsOutput_conflictMetadata.h
 *
 * 
 */

#ifndef OAIDescribeMergeConflictsOutput_conflictMetadata_H
#define OAIDescribeMergeConflictsOutput_conflictMetadata_H

#include <QJsonObject>

#include "OAIConflictMetadata_fileModes.h"
#include "OAIConflictMetadata_fileSizes.h"
#include "OAIConflictMetadata_isBinaryFile.h"
#include "OAIConflictMetadata_mergeOperations.h"
#include "OAIConflictMetadata_objectTypes.h"
#include <QString>
...
namespace OpenAPI {
class OAIConflictMetadata_fileSizes;
class OAIConflictMetadata_fileModes;
class OAIConflictMetadata_objectTypes;
class OAIConflictMetadata_isBinaryFile;
class OAIConflictMetadata_mergeOperations;

class OAIDescribeMergeConflictsOutput_conflictMetadata : public OAIObject {
public:
    OAIDescribeMergeConflictsOutput_conflictMetadata();
    OAIDescribeMergeConflictsOutput_conflictMetadata(QString json);
    ~OAIDescribeMergeConflictsOutput_conflictMetadata() override;
    ...
    OAIConflictMetadata_fileSizes getFileSizes() const;
    void setFileSizes(const OAIConflictMetadata_fileSizes &file_sizes);
    bool is_file_sizes_Set() const;
    bool is_file_sizes_Valid() const;

    OAIConflictMetadata_fileModes getFileModes() const;
    void setFileModes(const OAIConflictMetadata_fileModes &file_modes);
    bool is_file_modes_Set() const;
    bool is_file_modes_Valid() const;

    OAIConflictMetadata_objectTypes getObjectTypes() const;
    void setObjectTypes(const OAIConflictMetadata_objectTypes &object_types);
    bool is_object_types_Set() const;
    bool is_object_types_Valid() const;

    qint32 getNumberOfConflicts() const;
    void setNumberOfConflicts(const qint32 &number_of_conflicts);
    bool is_number_of_conflicts_Set() const;
    bool is_number_of_conflicts_Valid() const;

    OAIConflictMetadata_isBinaryFile getIsBinaryFile() const;
    void setIsBinaryFile(const OAIConflictMetadata_isBinaryFile &is_binary_file);
    bool is_is_binary_file_Set() const;
    bool is_is_binary_file_Valid() const;

    bool getContentConflict() const;
    void setContentConflict(const bool &content_conflict);
    bool is_content_conflict_Set() const;
    bool is_content_conflict_Valid() const;

    bool getFileModeConflict() const;
    void setFileModeConflict(const bool &file_mode_conflict);
    bool is_file_mode_conflict_Set() const;
    bool is_file_mode_conflict_Valid() const;

    bool getObjectTypeConflict() const;
    void setObjectTypeConflict(const bool &object_type_conflict);
    bool is_object_type_conflict_Set() const;
    bool is_object_type_conflict_Valid() const;

    OAIConflictMetadata_mergeOperations getMergeOperations() const;
    void setMergeOperations(const OAIConflictMetadata_mergeOperations &merge_operations);
    bool is_merge_operations_Set() const;
    bool is_merge_operations_Valid() const;
...
private:
    ...
    OAIConflictMetadata_fileSizes m_file_sizes;
    bool m_file_sizes_isSet;
    bool m_file_sizes_isValid;

    OAIConflictMetadata_fileModes m_file_modes;
    bool m_file_modes_isSet;
    bool m_file_modes_isValid;

    OAIConflictMetadata_objectTypes m_object_types;
    bool m_object_types_isSet;
    bool m_object_types_isValid;

    qint32 m_number_of_conflicts;
    bool m_number_of_conflicts_isSet;
    bool m_number_of_conflicts_isValid;

    OAIConflictMetadata_isBinaryFile m_is_binary_file;
    bool m_is_binary_file_isSet;
    bool m_is_binary_file_isValid;

    bool m_content_conflict;
    bool m_content_conflict_isSet;
    bool m_content_conflict_isValid;

    bool m_file_mode_conflict;
    bool m_file_mode_conflict_isSet;
    bool m_file_mode_conflict_isValid;

    bool m_object_type_conflict;
    bool m_object_type_conflict_isSet;
    bool m_object_type_conflict_isValid;

    OAIConflictMetadata_mergeOperations m_merge_operations;
    bool m_merge_operations_isSet;
    bool m_merge_operations_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeMergeConflictsOutput_conflictMetadata)

#endif // OAIDescribeMergeConflictsOutput_conflictMetadata_H
