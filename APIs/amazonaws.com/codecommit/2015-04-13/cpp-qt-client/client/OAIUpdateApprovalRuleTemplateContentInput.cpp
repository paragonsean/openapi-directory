...
OAIUpdateApprovalRuleTemplateContentInput::OAIUpdateApprovalRuleTemplateContentInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateApprovalRuleTemplateContentInput::OAIUpdateApprovalRuleTemplateContentInput() {
    this->initializeModel();
}

OAIUpdateApprovalRuleTemplateContentInput::~OAIUpdateApprovalRuleTemplateContentInput() {}

void OAIUpdateApprovalRuleTemplateContentInput::initializeModel() {
...
void OAIUpdateApprovalRuleTemplateContentInput::fromJson(QString jsonString) {
...
void OAIUpdateApprovalRuleTemplateContentInput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateApprovalRuleTemplateContentInput::asJson() const {
...
QJsonObject OAIUpdateApprovalRuleTemplateContentInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateApprovalRuleTemplateContentInput::getApprovalRuleTemplateName() const {
    return m_approval_rule_template_name;
}
void OAIUpdateApprovalRuleTemplateContentInput::setApprovalRuleTemplateName(const QString &approval_rule_template_name) {
    m_approval_rule_template_name = approval_rule_template_name;
    m_approval_rule_template_name_isSet = true;
}

bool OAIUpdateApprovalRuleTemplateContentInput::is_approval_rule_template_name_Set() const{
    return m_approval_rule_template_name_isSet;
}

bool OAIUpdateApprovalRuleTemplateContentInput::is_approval_rule_template_name_Valid() const{
    return m_approval_rule_template_name_isValid;
}

QString OAIUpdateApprovalRuleTemplateContentInput::getNewRuleContent() const {
    return m_new_rule_content;
}
void OAIUpdateApprovalRuleTemplateContentInput::setNewRuleContent(const QString &new_rule_content) {
    m_new_rule_content = new_rule_content;
    m_new_rule_content_isSet = true;
}

bool OAIUpdateApprovalRuleTemplateContentInput::is_new_rule_content_Set() const{
    return m_new_rule_content_isSet;
}

bool OAIUpdateApprovalRuleTemplateContentInput::is_new_rule_content_Valid() const{
    return m_new_rule_content_isValid;
}

QString OAIUpdateApprovalRuleTemplateContentInput::getExistingRuleContentSha256() const {
    return m_existing_rule_content_sha256;
}
void OAIUpdateApprovalRuleTemplateContentInput::setExistingRuleContentSha256(const QString &existing_rule_content_sha256) {
    m_existing_rule_content_sha256 = existing_rule_content_sha256;
    m_existing_rule_content_sha256_isSet = true;
}

bool OAIUpdateApprovalRuleTemplateContentInput::is_existing_rule_content_sha256_Set() const{
    return m_existing_rule_content_sha256_isSet;
}

bool OAIUpdateApprovalRuleTemplateContentInput::is_existing_rule_content_sha256_Valid() const{
    return m_existing_rule_content_sha256_isValid;
}

bool OAIUpdateApprovalRuleTemplateContentInput::isSet() const {
...
bool OAIUpdateApprovalRuleTemplateContentInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_approval_rule_template_name_isValid && m_new_rule_content_isValid && true;
}
