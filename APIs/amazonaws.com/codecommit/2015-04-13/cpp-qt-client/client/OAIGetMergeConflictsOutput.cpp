...
OAIGetMergeConflictsOutput::OAIGetMergeConflictsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetMergeConflictsOutput::OAIGetMergeConflictsOutput() {
    this->initializeModel();
}

OAIGetMergeConflictsOutput::~OAIGetMergeConflictsOutput() {}

void OAIGetMergeConflictsOutput::initializeModel() {

    m_mergeable_isSet = false;
    m_mergeable_isValid = false;

    m_destination_commit_id_isSet = false;
    m_destination_commit_id_isValid = false;

    m_source_commit_id_isSet = false;
    m_source_commit_id_isValid = false;

    m_base_commit_id_isSet = false;
    m_base_commit_id_isValid = false;

    m_conflict_metadata_list_isSet = false;
    m_conflict_metadata_list_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIGetMergeConflictsOutput::fromJson(QString jsonString) {
...
void OAIGetMergeConflictsOutput::fromJsonObject(QJsonObject json) {
    ...
    m_destination_commit_id_isValid = ::OpenAPI::fromJsonValue(m_destination_commit_id, json[QString("destinationCommitId")]);
    m_destination_commit_id_isSet = !json[QString("destinationCommitId")].isNull() && m_destination_commit_id_isValid;

    m_source_commit_id_isValid = ::OpenAPI::fromJsonValue(m_source_commit_id, json[QString("sourceCommitId")]);
    m_source_commit_id_isSet = !json[QString("sourceCommitId")].isNull() && m_source_commit_id_isValid;

    m_base_commit_id_isValid = ::OpenAPI::fromJsonValue(m_base_commit_id, json[QString("baseCommitId")]);
    m_base_commit_id_isSet = !json[QString("baseCommitId")].isNull() && m_base_commit_id_isValid;

    m_conflict_metadata_list_isValid = ::OpenAPI::fromJsonValue(m_conflict_metadata_list, json[QString("conflictMetadataList")]);
    m_conflict_metadata_list_isSet = !json[QString("conflictMetadataList")].isNull() && m_conflict_metadata_list_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("nextToken")]);
    m_next_token_isSet = !json[QString("nextToken")].isNull() && m_next_token_isValid;
}

QString OAIGetMergeConflictsOutput::asJson() const {
...
QJsonObject OAIGetMergeConflictsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_mergeable_isSet) {
        obj.insert(QString("mergeable"), ::OpenAPI::toJsonValue(m_mergeable));
    }
    if (m_destination_commit_id_isSet) {
        obj.insert(QString("destinationCommitId"), ::OpenAPI::toJsonValue(m_destination_commit_id));
    }
    if (m_source_commit_id_isSet) {
        obj.insert(QString("sourceCommitId"), ::OpenAPI::toJsonValue(m_source_commit_id));
    }
    if (m_base_commit_id_isSet) {
        obj.insert(QString("baseCommitId"), ::OpenAPI::toJsonValue(m_base_commit_id));
    }
    if (m_conflict_metadata_list.isSet()) {
        obj.insert(QString("conflictMetadataList"), ::OpenAPI::toJsonValue(m_conflict_metadata_list));
    }
...
bool OAIGetMergeConflictsOutput::getMergeable() const {
    return m_mergeable;
}
void OAIGetMergeConflictsOutput::setMergeable(const bool &mergeable) {
    m_mergeable = mergeable;
    m_mergeable_isSet = true;
}

bool OAIGetMergeConflictsOutput::is_mergeable_Set() const{
    return m_mergeable_isSet;
}

bool OAIGetMergeConflictsOutput::is_mergeable_Valid() const{
    return m_mergeable_isValid;
}

QString OAIGetMergeConflictsOutput::getDestinationCommitId() const {
    return m_destination_commit_id;
}
void OAIGetMergeConflictsOutput::setDestinationCommitId(const QString &destination_commit_id) {
    m_destination_commit_id = destination_commit_id;
    m_destination_commit_id_isSet = true;
}

bool OAIGetMergeConflictsOutput::is_destination_commit_id_Set() const{
    return m_destination_commit_id_isSet;
}

bool OAIGetMergeConflictsOutput::is_destination_commit_id_Valid() const{
    return m_destination_commit_id_isValid;
}

QString OAIGetMergeConflictsOutput::getSourceCommitId() const {
    return m_source_commit_id;
}
void OAIGetMergeConflictsOutput::setSourceCommitId(const QString &source_commit_id) {
    m_source_commit_id = source_commit_id;
    m_source_commit_id_isSet = true;
}

bool OAIGetMergeConflictsOutput::is_source_commit_id_Set() const{
    return m_source_commit_id_isSet;
}

bool OAIGetMergeConflictsOutput::is_source_commit_id_Valid() const{
    return m_source_commit_id_isValid;
}

QString OAIGetMergeConflictsOutput::getBaseCommitId() const {
    return m_base_commit_id;
}
void OAIGetMergeConflictsOutput::setBaseCommitId(const QString &base_commit_id) {
    m_base_commit_id = base_commit_id;
    m_base_commit_id_isSet = true;
}

bool OAIGetMergeConflictsOutput::is_base_commit_id_Set() const{
    return m_base_commit_id_isSet;
}

bool OAIGetMergeConflictsOutput::is_base_commit_id_Valid() const{
    return m_base_commit_id_isValid;
}

QList OAIGetMergeConflictsOutput::getConflictMetadataList() const {
    return m_conflict_metadata_list;
}
void OAIGetMergeConflictsOutput::setConflictMetadataList(const QList &conflict_metadata_list) {
    m_conflict_metadata_list = conflict_metadata_list;
    m_conflict_metadata_list_isSet = true;
}

bool OAIGetMergeConflictsOutput::is_conflict_metadata_list_Set() const{
    return m_conflict_metadata_list_isSet;
}

bool OAIGetMergeConflictsOutput::is_conflict_metadata_list_Valid() const{
    return m_conflict_metadata_list_isValid;
}

QString OAIGetMergeConflictsOutput::getNextToken() const {
    return m_next_token;
}
void OAIGetMergeConflictsOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIGetMergeConflictsOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIGetMergeConflictsOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIGetMergeConflictsOutput::isSet() const {
...
bool OAIGetMergeConflictsOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_mergeable_isValid && m_destination_commit_id_isValid && m_source_commit_id_isValid && m_conflict_metadata_list_isValid && true;
}
