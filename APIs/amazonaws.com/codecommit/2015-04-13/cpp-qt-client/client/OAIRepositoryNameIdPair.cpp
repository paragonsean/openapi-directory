...
#include "OAIRepositoryNameIdPair.h"
...
OAIRepositoryNameIdPair::OAIRepositoryNameIdPair(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRepositoryNameIdPair::OAIRepositoryNameIdPair() {
    this->initializeModel();
}

OAIRepositoryNameIdPair::~OAIRepositoryNameIdPair() {}

void OAIRepositoryNameIdPair::initializeModel() {
...
void OAIRepositoryNameIdPair::fromJson(QString jsonString) {
...
void OAIRepositoryNameIdPair::fromJsonObject(QJsonObject json) {
...
QString OAIRepositoryNameIdPair::asJson() const {
...
QJsonObject OAIRepositoryNameIdPair::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRepositoryNameIdPair::getRepositoryName() const {
    return m_repository_name;
}
void OAIRepositoryNameIdPair::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIRepositoryNameIdPair::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIRepositoryNameIdPair::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIRepositoryNameIdPair::getRepositoryId() const {
    return m_repository_id;
}
void OAIRepositoryNameIdPair::setRepositoryId(const QString &repository_id) {
    m_repository_id = repository_id;
    m_repository_id_isSet = true;
}

bool OAIRepositoryNameIdPair::is_repository_id_Set() const{
    return m_repository_id_isSet;
}

bool OAIRepositoryNameIdPair::is_repository_id_Valid() const{
    return m_repository_id_isValid;
}

bool OAIRepositoryNameIdPair::isSet() const {
...
bool OAIRepositoryNameIdPair::isValid() const {
