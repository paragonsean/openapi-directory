...
/*
 * OAICreateRepositoryInput.h
 *
 * Represents the input of a create repository operation.
 */

#ifndef OAICreateRepositoryInput_H
#define OAICreateRepositoryInput_H
...
class OAICreateRepositoryInput : public OAIObject {
public:
    OAICreateRepositoryInput();
    OAICreateRepositoryInput(QString json);
    ~OAICreateRepositoryInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRepositoryInput)

#endif // OAICreateRepositoryInput_H
