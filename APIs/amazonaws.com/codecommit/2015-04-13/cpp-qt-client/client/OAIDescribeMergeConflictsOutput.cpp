...
OAIDescribeMergeConflictsOutput::OAIDescribeMergeConflictsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeMergeConflictsOutput::OAIDescribeMergeConflictsOutput() {
    this->initializeModel();
}

OAIDescribeMergeConflictsOutput::~OAIDescribeMergeConflictsOutput() {}

void OAIDescribeMergeConflictsOutput::initializeModel() {

    m_conflict_metadata_isSet = false;
    m_conflict_metadata_isValid = false;

    m_merge_hunks_isSet = false;
    m_merge_hunks_isValid = false;
...
void OAIDescribeMergeConflictsOutput::fromJson(QString jsonString) {
...
void OAIDescribeMergeConflictsOutput::fromJsonObject(QJsonObject json) {

    m_conflict_metadata_isValid = ::OpenAPI::fromJsonValue(m_conflict_metadata, json[QString("conflictMetadata")]);
    m_conflict_metadata_isSet = !json[QString("conflictMetadata")].isNull() && m_conflict_metadata_isValid;

    m_merge_hunks_isValid = ::OpenAPI::fromJsonValue(m_merge_hunks, json[QString("mergeHunks")]);
    m_merge_hunks_isSet = !json[QString("mergeHunks")].isNull() && m_merge_hunks_isValid;
...
QString OAIDescribeMergeConflictsOutput::asJson() const {
...
QJsonObject OAIDescribeMergeConflictsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_conflict_metadata.isSet()) {
        obj.insert(QString("conflictMetadata"), ::OpenAPI::toJsonValue(m_conflict_metadata));
    }
    if (m_merge_hunks.isSet()) {
        obj.insert(QString("mergeHunks"), ::OpenAPI::toJsonValue(m_merge_hunks));
    }
...
OAIDescribeMergeConflictsOutput_conflictMetadata OAIDescribeMergeConflictsOutput::getConflictMetadata() const {
    return m_conflict_metadata;
}
void OAIDescribeMergeConflictsOutput::setConflictMetadata(const OAIDescribeMergeConflictsOutput_conflictMetadata &conflict_metadata) {
    m_conflict_metadata = conflict_metadata;
    m_conflict_metadata_isSet = true;
}

bool OAIDescribeMergeConflictsOutput::is_conflict_metadata_Set() const{
    return m_conflict_metadata_isSet;
}

bool OAIDescribeMergeConflictsOutput::is_conflict_metadata_Valid() const{
    return m_conflict_metadata_isValid;
}

QList OAIDescribeMergeConflictsOutput::getMergeHunks() const {
    return m_merge_hunks;
}
void OAIDescribeMergeConflictsOutput::setMergeHunks(const QList &merge_hunks) {
    m_merge_hunks = merge_hunks;
    m_merge_hunks_isSet = true;
}

bool OAIDescribeMergeConflictsOutput::is_merge_hunks_Set() const{
    return m_merge_hunks_isSet;
}

bool OAIDescribeMergeConflictsOutput::is_merge_hunks_Valid() const{
    return m_merge_hunks_isValid;
}

QString OAIDescribeMergeConflictsOutput::getNextToken() const {
    return m_next_token;
}
void OAIDescribeMergeConflictsOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeMergeConflictsOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeMergeConflictsOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QString OAIDescribeMergeConflictsOutput::getDestinationCommitId() const {
    return m_destination_commit_id;
}
void OAIDescribeMergeConflictsOutput::setDestinationCommitId(const QString &destination_commit_id) {
    m_destination_commit_id = destination_commit_id;
    m_destination_commit_id_isSet = true;
}

bool OAIDescribeMergeConflictsOutput::is_destination_commit_id_Set() const{
    return m_destination_commit_id_isSet;
}

bool OAIDescribeMergeConflictsOutput::is_destination_commit_id_Valid() const{
    return m_destination_commit_id_isValid;
}

QString OAIDescribeMergeConflictsOutput::getSourceCommitId() const {
    return m_source_commit_id;
}
void OAIDescribeMergeConflictsOutput::setSourceCommitId(const QString &source_commit_id) {
    m_source_commit_id = source_commit_id;
    m_source_commit_id_isSet = true;
}

bool OAIDescribeMergeConflictsOutput::is_source_commit_id_Set() const{
    return m_source_commit_id_isSet;
}

bool OAIDescribeMergeConflictsOutput::is_source_commit_id_Valid() const{
    return m_source_commit_id_isValid;
}

QString OAIDescribeMergeConflictsOutput::getBaseCommitId() const {
    return m_base_commit_id;
}
void OAIDescribeMergeConflictsOutput::setBaseCommitId(const QString &base_commit_id) {
    m_base_commit_id = base_commit_id;
    m_base_commit_id_isSet = true;
}

bool OAIDescribeMergeConflictsOutput::is_base_commit_id_Set() const{
    return m_base_commit_id_isSet;
}

bool OAIDescribeMergeConflictsOutput::is_base_commit_id_Valid() const{
    return m_base_commit_id_isValid;
}

bool OAIDescribeMergeConflictsOutput::isSet() const {
...
bool OAIDescribeMergeConflictsOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_conflict_metadata_isValid && m_merge_hunks_isValid && m_destination_commit_id_isValid && m_source_commit_id_isValid && true;
}
