...
#ifndef OAIPutFileEntry_H
#define OAIPutFileEntry_H
...
namespace OpenAPI {
class OAIPutFileEntry_sourceFile;

class OAIPutFileEntry : public OAIObject {
public:
    OAIPutFileEntry();
    OAIPutFileEntry(QString json);
    ~OAIPutFileEntry() override;
    ...
    OAIPutFileEntry_sourceFile getSourceFile() const;
    void setSourceFile(const OAIPutFileEntry_sourceFile &source_file);
...
private:
    ...
    OAIPutFileEntry_sourceFile m_source_file;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutFileEntry)

#endif // OAIPutFileEntry_H
