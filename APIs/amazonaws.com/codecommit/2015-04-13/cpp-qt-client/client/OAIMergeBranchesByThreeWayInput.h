...
/*
 * OAIMergeBranchesByThreeWayInput.h
 *
 * 
 */

#ifndef OAIMergeBranchesByThreeWayInput_H
#define OAIMergeBranchesByThreeWayInput_H
...
class OAIMergeBranchesByThreeWayInput : public OAIObject {
public:
    OAIMergeBranchesByThreeWayInput();
    OAIMergeBranchesByThreeWayInput(QString json);
    ~OAIMergeBranchesByThreeWayInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMergeBranchesByThreeWayInput)

#endif // OAIMergeBranchesByThreeWayInput_H
