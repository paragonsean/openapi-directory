...
OAIMergeBranchesByFastForwardInput::OAIMergeBranchesByFastForwardInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMergeBranchesByFastForwardInput::OAIMergeBranchesByFastForwardInput() {
    this->initializeModel();
}

OAIMergeBranchesByFastForwardInput::~OAIMergeBranchesByFastForwardInput() {}

void OAIMergeBranchesByFastForwardInput::initializeModel() {
...
void OAIMergeBranchesByFastForwardInput::fromJson(QString jsonString) {
...
void OAIMergeBranchesByFastForwardInput::fromJsonObject(QJsonObject json) {
    ...
    m_target_branch_isValid = ::OpenAPI::fromJsonValue(m_target_branch, json[QString("targetBranch")]);
    m_target_branch_isSet = !json[QString("targetBranch")].isNull() && m_target_branch_isValid;
}

QString OAIMergeBranchesByFastForwardInput::asJson() const {
...
QJsonObject OAIMergeBranchesByFastForwardInput::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_target_branch_isSet) {
        obj.insert(QString("targetBranch"), ::OpenAPI::toJsonValue(m_target_branch));
    }
    return obj;
}

QString OAIMergeBranchesByFastForwardInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIMergeBranchesByFastForwardInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIMergeBranchesByFastForwardInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIMergeBranchesByFastForwardInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIMergeBranchesByFastForwardInput::getSourceCommitSpecifier() const {
    return m_source_commit_specifier;
}
void OAIMergeBranchesByFastForwardInput::setSourceCommitSpecifier(const QString &source_commit_specifier) {
    m_source_commit_specifier = source_commit_specifier;
    m_source_commit_specifier_isSet = true;
}

bool OAIMergeBranchesByFastForwardInput::is_source_commit_specifier_Set() const{
    return m_source_commit_specifier_isSet;
}

bool OAIMergeBranchesByFastForwardInput::is_source_commit_specifier_Valid() const{
    return m_source_commit_specifier_isValid;
}

QString OAIMergeBranchesByFastForwardInput::getDestinationCommitSpecifier() const {
    return m_destination_commit_specifier;
}
void OAIMergeBranchesByFastForwardInput::setDestinationCommitSpecifier(const QString &destination_commit_specifier) {
    m_destination_commit_specifier = destination_commit_specifier;
    m_destination_commit_specifier_isSet = true;
}

bool OAIMergeBranchesByFastForwardInput::is_destination_commit_specifier_Set() const{
    return m_destination_commit_specifier_isSet;
}

bool OAIMergeBranchesByFastForwardInput::is_destination_commit_specifier_Valid() const{
    return m_destination_commit_specifier_isValid;
}

QString OAIMergeBranchesByFastForwardInput::getTargetBranch() const {
    return m_target_branch;
}
void OAIMergeBranchesByFastForwardInput::setTargetBranch(const QString &target_branch) {
    m_target_branch = target_branch;
    m_target_branch_isSet = true;
}

bool OAIMergeBranchesByFastForwardInput::is_target_branch_Set() const{
    return m_target_branch_isSet;
}

bool OAIMergeBranchesByFastForwardInput::is_target_branch_Valid() const{
    return m_target_branch_isValid;
}

bool OAIMergeBranchesByFastForwardInput::isSet() const {
...
bool OAIMergeBranchesByFastForwardInput::isValid() const {
