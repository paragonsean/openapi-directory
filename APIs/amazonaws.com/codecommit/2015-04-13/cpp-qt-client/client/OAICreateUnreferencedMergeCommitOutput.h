...
/*
 * OAICreateUnreferencedMergeCommitOutput.h
 *
 * 
 */

#ifndef OAICreateUnreferencedMergeCommitOutput_H
#define OAICreateUnreferencedMergeCommitOutput_H
...
class OAICreateUnreferencedMergeCommitOutput : public OAIObject {
public:
    OAICreateUnreferencedMergeCommitOutput();
    OAICreateUnreferencedMergeCommitOutput(QString json);
    ~OAICreateUnreferencedMergeCommitOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUnreferencedMergeCommitOutput)

#endif // OAICreateUnreferencedMergeCommitOutput_H
