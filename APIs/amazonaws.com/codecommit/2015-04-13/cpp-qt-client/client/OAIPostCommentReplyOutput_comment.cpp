...
#include "OAIPostCommentReplyOutput_comment.h"
...
OAIPostCommentReplyOutput_comment::OAIPostCommentReplyOutput_comment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPostCommentReplyOutput_comment::OAIPostCommentReplyOutput_comment() {
    this->initializeModel();
}

OAIPostCommentReplyOutput_comment::~OAIPostCommentReplyOutput_comment() {}

void OAIPostCommentReplyOutput_comment::initializeModel() {
...
void OAIPostCommentReplyOutput_comment::fromJson(QString jsonString) {
...
void OAIPostCommentReplyOutput_comment::fromJsonObject(QJsonObject json) {
...
QString OAIPostCommentReplyOutput_comment::asJson() const {
...
QJsonObject OAIPostCommentReplyOutput_comment::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPostCommentReplyOutput_comment::getCommentId() const {
    return m_comment_id;
}
void OAIPostCommentReplyOutput_comment::setCommentId(const QString &comment_id) {
    m_comment_id = comment_id;
    m_comment_id_isSet = true;
}

bool OAIPostCommentReplyOutput_comment::is_comment_id_Set() const{
    return m_comment_id_isSet;
}

bool OAIPostCommentReplyOutput_comment::is_comment_id_Valid() const{
    return m_comment_id_isValid;
}

QString OAIPostCommentReplyOutput_comment::getContent() const {
    return m_content;
}
void OAIPostCommentReplyOutput_comment::setContent(const QString &content) {
    m_content = content;
    m_content_isSet = true;
}

bool OAIPostCommentReplyOutput_comment::is_content_Set() const{
    return m_content_isSet;
}

bool OAIPostCommentReplyOutput_comment::is_content_Valid() const{
    return m_content_isValid;
}

QString OAIPostCommentReplyOutput_comment::getInReplyTo() const {
    return m_in_reply_to;
}
void OAIPostCommentReplyOutput_comment::setInReplyTo(const QString &in_reply_to) {
    m_in_reply_to = in_reply_to;
    m_in_reply_to_isSet = true;
}

bool OAIPostCommentReplyOutput_comment::is_in_reply_to_Set() const{
    return m_in_reply_to_isSet;
}

bool OAIPostCommentReplyOutput_comment::is_in_reply_to_Valid() const{
    return m_in_reply_to_isValid;
}

QDateTime OAIPostCommentReplyOutput_comment::getCreationDate() const {
    return m_creation_date;
}
void OAIPostCommentReplyOutput_comment::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAIPostCommentReplyOutput_comment::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAIPostCommentReplyOutput_comment::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

QDateTime OAIPostCommentReplyOutput_comment::getLastModifiedDate() const {
    return m_last_modified_date;
}
void OAIPostCommentReplyOutput_comment::setLastModifiedDate(const QDateTime &last_modified_date) {
    m_last_modified_date = last_modified_date;
    m_last_modified_date_isSet = true;
}

bool OAIPostCommentReplyOutput_comment::is_last_modified_date_Set() const{
    return m_last_modified_date_isSet;
}

bool OAIPostCommentReplyOutput_comment::is_last_modified_date_Valid() const{
    return m_last_modified_date_isValid;
}

QString OAIPostCommentReplyOutput_comment::getAuthorArn() const {
    return m_author_arn;
}
void OAIPostCommentReplyOutput_comment::setAuthorArn(const QString &author_arn) {
    m_author_arn = author_arn;
    m_author_arn_isSet = true;
}

bool OAIPostCommentReplyOutput_comment::is_author_arn_Set() const{
    return m_author_arn_isSet;
}

bool OAIPostCommentReplyOutput_comment::is_author_arn_Valid() const{
    return m_author_arn_isValid;
}

bool OAIPostCommentReplyOutput_comment::getDeleted() const {
    return m_deleted;
}
void OAIPostCommentReplyOutput_comment::setDeleted(const bool &deleted) {
    m_deleted = deleted;
    m_deleted_isSet = true;
}

bool OAIPostCommentReplyOutput_comment::is_deleted_Set() const{
    return m_deleted_isSet;
}

bool OAIPostCommentReplyOutput_comment::is_deleted_Valid() const{
    return m_deleted_isValid;
}

QString OAIPostCommentReplyOutput_comment::getClientRequestToken() const {
    return m_client_request_token;
}
void OAIPostCommentReplyOutput_comment::setClientRequestToken(const QString &client_request_token) {
    m_client_request_token = client_request_token;
    m_client_request_token_isSet = true;
}

bool OAIPostCommentReplyOutput_comment::is_client_request_token_Set() const{
    return m_client_request_token_isSet;
}

bool OAIPostCommentReplyOutput_comment::is_client_request_token_Valid() const{
    return m_client_request_token_isValid;
}

QList OAIPostCommentReplyOutput_comment::getCallerReactions() const {
    return m_caller_reactions;
}
void OAIPostCommentReplyOutput_comment::setCallerReactions(const QList &caller_reactions) {
    m_caller_reactions = caller_reactions;
    m_caller_reactions_isSet = true;
}

bool OAIPostCommentReplyOutput_comment::is_caller_reactions_Set() const{
    return m_caller_reactions_isSet;
}

bool OAIPostCommentReplyOutput_comment::is_caller_reactions_Valid() const{
    return m_caller_reactions_isValid;
}

QMap OAIPostCommentReplyOutput_comment::getReactionCounts() const {
    return m_reaction_counts;
}
void OAIPostCommentReplyOutput_comment::setReactionCounts(const QMap &reaction_counts) {
    m_reaction_counts = reaction_counts;
    m_reaction_counts_isSet = true;
}

bool OAIPostCommentReplyOutput_comment::is_reaction_counts_Set() const{
    return m_reaction_counts_isSet;
}

bool OAIPostCommentReplyOutput_comment::is_reaction_counts_Valid() const{
    return m_reaction_counts_isValid;
}

bool OAIPostCommentReplyOutput_comment::isSet() const {
...
bool OAIPostCommentReplyOutput_comment::isValid() const {
