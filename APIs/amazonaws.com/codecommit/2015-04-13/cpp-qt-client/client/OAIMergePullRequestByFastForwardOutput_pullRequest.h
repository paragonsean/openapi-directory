...
/*
 * OAIMergePullRequestByFastForwardOutput_pullRequest.h
 *
 * 
 */

#ifndef OAIMergePullRequestByFastForwardOutput_pullRequest_H
#define OAIMergePullRequestByFastForwardOutput_pullRequest_H

#include <QJsonObject>

#include "OAIPullRequestStatusEnum.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
class OAIMergePullRequestByFastForwardOutput_pullRequest : public OAIObject {
public:
    OAIMergePullRequestByFastForwardOutput_pullRequest();
    OAIMergePullRequestByFastForwardOutput_pullRequest(QString json);
    ~OAIMergePullRequestByFastForwardOutput_pullRequest() override;
    ...
    OAIPullRequestStatusEnum getPullRequestStatus() const;
    void setPullRequestStatus(const OAIPullRequestStatusEnum &pull_request_status);
    bool is_pull_request_status_Set() const;
    bool is_pull_request_status_Valid() const;

    QString getAuthorArn() const;
    void setAuthorArn(const QString &author_arn);
    bool is_author_arn_Set() const;
    bool is_author_arn_Valid() const;

    QList getPullRequestTargets() const;
    void setPullRequestTargets(const QList &pull_request_targets);
    bool is_pull_request_targets_Set() const;
    bool is_pull_request_targets_Valid() const;
    ...
    QList getApprovalRules() const;
    void setApprovalRules(const QList &approval_rules);
    bool is_approval_rules_Set() const;
    bool is_approval_rules_Valid() const;
...
private:
    ...
    OAIPullRequestStatusEnum m_pull_request_status;
    bool m_pull_request_status_isSet;
    bool m_pull_request_status_isValid;

    QString m_author_arn;
    bool m_author_arn_isSet;
    bool m_author_arn_isValid;

    QList m_pull_request_targets;
    bool m_pull_request_targets_isSet;
    bool m_pull_request_targets_isValid;
    ...
    QList m_approval_rules;
    bool m_approval_rules_isSet;
    bool m_approval_rules_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIMergePullRequestByFastForwardOutput_pullRequest)

#endif // OAIMergePullRequestByFastForwardOutput_pullRequest_H
