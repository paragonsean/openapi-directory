...
OAISymbolicLink::OAISymbolicLink(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISymbolicLink::OAISymbolicLink() {
    this->initializeModel();
}

OAISymbolicLink::~OAISymbolicLink() {}

void OAISymbolicLink::initializeModel() {
...
void OAISymbolicLink::fromJson(QString jsonString) {
...
void OAISymbolicLink::fromJsonObject(QJsonObject json) {
...
QString OAISymbolicLink::asJson() const {
...
QJsonObject OAISymbolicLink::asJsonObject() const {
    QJsonObject obj;
    if (m_blob_id_isSet) {
...
QString OAISymbolicLink::getBlobId() const {
    return m_blob_id;
}
void OAISymbolicLink::setBlobId(const QString &blob_id) {
    m_blob_id = blob_id;
    m_blob_id_isSet = true;
}

bool OAISymbolicLink::is_blob_id_Set() const{
    return m_blob_id_isSet;
}

bool OAISymbolicLink::is_blob_id_Valid() const{
    return m_blob_id_isValid;
}

QString OAISymbolicLink::getAbsolutePath() const {
    return m_absolute_path;
}
void OAISymbolicLink::setAbsolutePath(const QString &absolute_path) {
    m_absolute_path = absolute_path;
    m_absolute_path_isSet = true;
}

bool OAISymbolicLink::is_absolute_path_Set() const{
    return m_absolute_path_isSet;
}

bool OAISymbolicLink::is_absolute_path_Valid() const{
    return m_absolute_path_isValid;
}

QString OAISymbolicLink::getRelativePath() const {
    return m_relative_path;
}
void OAISymbolicLink::setRelativePath(const QString &relative_path) {
    m_relative_path = relative_path;
    m_relative_path_isSet = true;
}

bool OAISymbolicLink::is_relative_path_Set() const{
    return m_relative_path_isSet;
}

bool OAISymbolicLink::is_relative_path_Valid() const{
    return m_relative_path_isValid;
}

OAIFileModeTypeEnum OAISymbolicLink::getFileMode() const {
    return m_file_mode;
}
void OAISymbolicLink::setFileMode(const OAIFileModeTypeEnum &file_mode) {
    m_file_mode = file_mode;
    m_file_mode_isSet = true;
}

bool OAISymbolicLink::is_file_mode_Set() const{
    return m_file_mode_isSet;
}

bool OAISymbolicLink::is_file_mode_Valid() const{
    return m_file_mode_isValid;
}

bool OAISymbolicLink::isSet() const {
...
bool OAISymbolicLink::isValid() const {
