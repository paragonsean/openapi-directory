...
#include "OAIRepositoryTrigger.h"
...
OAIRepositoryTrigger::OAIRepositoryTrigger(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRepositoryTrigger::OAIRepositoryTrigger() {
    this->initializeModel();
}

OAIRepositoryTrigger::~OAIRepositoryTrigger() {}

void OAIRepositoryTrigger::initializeModel() {
...
void OAIRepositoryTrigger::fromJson(QString jsonString) {
...
void OAIRepositoryTrigger::fromJsonObject(QJsonObject json) {
...
QString OAIRepositoryTrigger::asJson() const {
...
QJsonObject OAIRepositoryTrigger::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIRepositoryTrigger::getName() const {
    return m_name;
}
void OAIRepositoryTrigger::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIRepositoryTrigger::is_name_Set() const{
    return m_name_isSet;
}

bool OAIRepositoryTrigger::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIRepositoryTrigger::getDestinationArn() const {
    return m_destination_arn;
}
void OAIRepositoryTrigger::setDestinationArn(const QString &destination_arn) {
    m_destination_arn = destination_arn;
    m_destination_arn_isSet = true;
}

bool OAIRepositoryTrigger::is_destination_arn_Set() const{
    return m_destination_arn_isSet;
}

bool OAIRepositoryTrigger::is_destination_arn_Valid() const{
    return m_destination_arn_isValid;
}

QString OAIRepositoryTrigger::getCustomData() const {
    return m_custom_data;
}
void OAIRepositoryTrigger::setCustomData(const QString &custom_data) {
    m_custom_data = custom_data;
    m_custom_data_isSet = true;
}

bool OAIRepositoryTrigger::is_custom_data_Set() const{
    return m_custom_data_isSet;
}

bool OAIRepositoryTrigger::is_custom_data_Valid() const{
    return m_custom_data_isValid;
}

QList OAIRepositoryTrigger::getBranches() const {
    return m_branches;
}
void OAIRepositoryTrigger::setBranches(const QList &branches) {
    m_branches = branches;
    m_branches_isSet = true;
}

bool OAIRepositoryTrigger::is_branches_Set() const{
    return m_branches_isSet;
}

bool OAIRepositoryTrigger::is_branches_Valid() const{
    return m_branches_isValid;
}

QList OAIRepositoryTrigger::getEvents() const {
    return m_events;
}
void OAIRepositoryTrigger::setEvents(const QList &events) {
    m_events = events;
    m_events_isSet = true;
}

bool OAIRepositoryTrigger::is_events_Set() const{
    return m_events_isSet;
}

bool OAIRepositoryTrigger::is_events_Valid() const{
    return m_events_isValid;
}

bool OAIRepositoryTrigger::isSet() const {
...
bool OAIRepositoryTrigger::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_name_isValid && m_destination_arn_isValid && m_events_isValid && true;
}
