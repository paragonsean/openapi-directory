...
/*
 * OAIConflict_conflictMetadata.h
 *
 * 
 */

#ifndef OAIConflict_conflictMetadata_H
#define OAIConflict_conflictMetadata_H
...
class OAIConflict_conflictMetadata : public OAIObject {
public:
    OAIConflict_conflictMetadata();
    OAIConflict_conflictMetadata(QString json);
    ~OAIConflict_conflictMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConflict_conflictMetadata)

#endif // OAIConflict_conflictMetadata_H
