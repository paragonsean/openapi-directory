...
/*
 * OAITestRepositoryTriggersInput.h
 *
 * Represents the input of a test repository triggers operation.
 */

#ifndef OAITestRepositoryTriggersInput_H
#define OAITestRepositoryTriggersInput_H
...
class OAITestRepositoryTriggersInput : public OAIObject {
public:
    OAITestRepositoryTriggersInput();
    OAITestRepositoryTriggersInput(QString json);
    ~OAITestRepositoryTriggersInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITestRepositoryTriggersInput)

#endif // OAITestRepositoryTriggersInput_H
