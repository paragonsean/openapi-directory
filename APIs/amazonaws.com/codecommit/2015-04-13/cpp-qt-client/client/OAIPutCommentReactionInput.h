...
/*
 * OAIPutCommentReactionInput.h
 *
 * 
 */

#ifndef OAIPutCommentReactionInput_H
#define OAIPutCommentReactionInput_H
...
class OAIPutCommentReactionInput : public OAIObject {
public:
    OAIPutCommentReactionInput();
    OAIPutCommentReactionInput(QString json);
    ~OAIPutCommentReactionInput() override;
    ...
    QString getReactionValue() const;
    void setReactionValue(const QString &reaction_value);
    bool is_reaction_value_Set() const;
    bool is_reaction_value_Valid() const;
...
private:
    ...
    QString m_reaction_value;
    bool m_reaction_value_isSet;
    bool m_reaction_value_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPutCommentReactionInput)

#endif // OAIPutCommentReactionInput_H
