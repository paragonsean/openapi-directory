...
OAIUpdateApprovalRuleTemplateNameOutput::OAIUpdateApprovalRuleTemplateNameOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateApprovalRuleTemplateNameOutput::OAIUpdateApprovalRuleTemplateNameOutput() {
    this->initializeModel();
}

OAIUpdateApprovalRuleTemplateNameOutput::~OAIUpdateApprovalRuleTemplateNameOutput() {}

void OAIUpdateApprovalRuleTemplateNameOutput::initializeModel() {

    m_approval_rule_template_isSet = false;
    m_approval_rule_template_isValid = false;
}

void OAIUpdateApprovalRuleTemplateNameOutput::fromJson(QString jsonString) {
...
void OAIUpdateApprovalRuleTemplateNameOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateApprovalRuleTemplateNameOutput::asJson() const {
...
QJsonObject OAIUpdateApprovalRuleTemplateNameOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdateApprovalRuleTemplateDescriptionOutput_approvalRuleTemplate OAIUpdateApprovalRuleTemplateNameOutput::getApprovalRuleTemplate() const {
    return m_approval_rule_template;
}
void OAIUpdateApprovalRuleTemplateNameOutput::setApprovalRuleTemplate(const OAIUpdateApprovalRuleTemplateDescriptionOutput_approvalRuleTemplate &approval_rule_template) {
    m_approval_rule_template = approval_rule_template;
    m_approval_rule_template_isSet = true;
}

bool OAIUpdateApprovalRuleTemplateNameOutput::is_approval_rule_template_Set() const{
    return m_approval_rule_template_isSet;
}

bool OAIUpdateApprovalRuleTemplateNameOutput::is_approval_rule_template_Valid() const{
    return m_approval_rule_template_isValid;
}

bool OAIUpdateApprovalRuleTemplateNameOutput::isSet() const {
...
bool OAIUpdateApprovalRuleTemplateNameOutput::isValid() const {
