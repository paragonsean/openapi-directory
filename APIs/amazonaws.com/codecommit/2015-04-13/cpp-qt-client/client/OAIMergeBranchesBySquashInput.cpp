...
OAIMergeBranchesBySquashInput::OAIMergeBranchesBySquashInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMergeBranchesBySquashInput::OAIMergeBranchesBySquashInput() {
    this->initializeModel();
}

OAIMergeBranchesBySquashInput::~OAIMergeBranchesBySquashInput() {}

void OAIMergeBranchesBySquashInput::initializeModel() {
...
void OAIMergeBranchesBySquashInput::fromJson(QString jsonString) {
...
void OAIMergeBranchesBySquashInput::fromJsonObject(QJsonObject json) {
...
QString OAIMergeBranchesBySquashInput::asJson() const {
...
QJsonObject OAIMergeBranchesBySquashInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIMergeBranchesBySquashInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIMergeBranchesBySquashInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIMergeBranchesBySquashInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIMergeBranchesBySquashInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIMergeBranchesBySquashInput::getSourceCommitSpecifier() const {
    return m_source_commit_specifier;
}
void OAIMergeBranchesBySquashInput::setSourceCommitSpecifier(const QString &source_commit_specifier) {
    m_source_commit_specifier = source_commit_specifier;
    m_source_commit_specifier_isSet = true;
}

bool OAIMergeBranchesBySquashInput::is_source_commit_specifier_Set() const{
    return m_source_commit_specifier_isSet;
}

bool OAIMergeBranchesBySquashInput::is_source_commit_specifier_Valid() const{
    return m_source_commit_specifier_isValid;
}

QString OAIMergeBranchesBySquashInput::getDestinationCommitSpecifier() const {
    return m_destination_commit_specifier;
}
void OAIMergeBranchesBySquashInput::setDestinationCommitSpecifier(const QString &destination_commit_specifier) {
    m_destination_commit_specifier = destination_commit_specifier;
    m_destination_commit_specifier_isSet = true;
}

bool OAIMergeBranchesBySquashInput::is_destination_commit_specifier_Set() const{
    return m_destination_commit_specifier_isSet;
}

bool OAIMergeBranchesBySquashInput::is_destination_commit_specifier_Valid() const{
    return m_destination_commit_specifier_isValid;
}

QString OAIMergeBranchesBySquashInput::getTargetBranch() const {
    return m_target_branch;
}
void OAIMergeBranchesBySquashInput::setTargetBranch(const QString &target_branch) {
    m_target_branch = target_branch;
    m_target_branch_isSet = true;
}

bool OAIMergeBranchesBySquashInput::is_target_branch_Set() const{
    return m_target_branch_isSet;
}

bool OAIMergeBranchesBySquashInput::is_target_branch_Valid() const{
    return m_target_branch_isValid;
}

OAIConflictDetailLevelTypeEnum OAIMergeBranchesBySquashInput::getConflictDetailLevel() const {
    return m_conflict_detail_level;
}
void OAIMergeBranchesBySquashInput::setConflictDetailLevel(const OAIConflictDetailLevelTypeEnum &conflict_detail_level) {
    m_conflict_detail_level = conflict_detail_level;
    m_conflict_detail_level_isSet = true;
}

bool OAIMergeBranchesBySquashInput::is_conflict_detail_level_Set() const{
    return m_conflict_detail_level_isSet;
}

bool OAIMergeBranchesBySquashInput::is_conflict_detail_level_Valid() const{
    return m_conflict_detail_level_isValid;
}

OAIConflictResolutionStrategyTypeEnum OAIMergeBranchesBySquashInput::getConflictResolutionStrategy() const {
    return m_conflict_resolution_strategy;
}
void OAIMergeBranchesBySquashInput::setConflictResolutionStrategy(const OAIConflictResolutionStrategyTypeEnum &conflict_resolution_strategy) {
    m_conflict_resolution_strategy = conflict_resolution_strategy;
    m_conflict_resolution_strategy_isSet = true;
}

bool OAIMergeBranchesBySquashInput::is_conflict_resolution_strategy_Set() const{
    return m_conflict_resolution_strategy_isSet;
}

bool OAIMergeBranchesBySquashInput::is_conflict_resolution_strategy_Valid() const{
    return m_conflict_resolution_strategy_isValid;
}

QString OAIMergeBranchesBySquashInput::getAuthorName() const {
    return m_author_name;
}
void OAIMergeBranchesBySquashInput::setAuthorName(const QString &author_name) {
    m_author_name = author_name;
    m_author_name_isSet = true;
}

bool OAIMergeBranchesBySquashInput::is_author_name_Set() const{
    return m_author_name_isSet;
}

bool OAIMergeBranchesBySquashInput::is_author_name_Valid() const{
    return m_author_name_isValid;
}

QString OAIMergeBranchesBySquashInput::getEmail() const {
    return m_email;
}
void OAIMergeBranchesBySquashInput::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAIMergeBranchesBySquashInput::is_email_Set() const{
    return m_email_isSet;
}

bool OAIMergeBranchesBySquashInput::is_email_Valid() const{
    return m_email_isValid;
}

QString OAIMergeBranchesBySquashInput::getCommitMessage() const {
    return m_commit_message;
}
void OAIMergeBranchesBySquashInput::setCommitMessage(const QString &commit_message) {
    m_commit_message = commit_message;
    m_commit_message_isSet = true;
}

bool OAIMergeBranchesBySquashInput::is_commit_message_Set() const{
    return m_commit_message_isSet;
}

bool OAIMergeBranchesBySquashInput::is_commit_message_Valid() const{
    return m_commit_message_isValid;
}

bool OAIMergeBranchesBySquashInput::getKeepEmptyFolders() const {
    return m_keep_empty_folders;
}
void OAIMergeBranchesBySquashInput::setKeepEmptyFolders(const bool &keep_empty_folders) {
    m_keep_empty_folders = keep_empty_folders;
    m_keep_empty_folders_isSet = true;
}

bool OAIMergeBranchesBySquashInput::is_keep_empty_folders_Set() const{
    return m_keep_empty_folders_isSet;
}

bool OAIMergeBranchesBySquashInput::is_keep_empty_folders_Valid() const{
    return m_keep_empty_folders_isValid;
}

OAICreateUnreferencedMergeCommitInput_conflictResolution OAIMergeBranchesBySquashInput::getConflictResolution() const {
    return m_conflict_resolution;
}
void OAIMergeBranchesBySquashInput::setConflictResolution(const OAICreateUnreferencedMergeCommitInput_conflictResolution &conflict_resolution) {
    m_conflict_resolution = conflict_resolution;
    m_conflict_resolution_isSet = true;
}

bool OAIMergeBranchesBySquashInput::is_conflict_resolution_Set() const{
    return m_conflict_resolution_isSet;
}

bool OAIMergeBranchesBySquashInput::is_conflict_resolution_Valid() const{
    return m_conflict_resolution_isValid;
}

bool OAIMergeBranchesBySquashInput::isSet() const {
...
bool OAIMergeBranchesBySquashInput::isValid() const {
