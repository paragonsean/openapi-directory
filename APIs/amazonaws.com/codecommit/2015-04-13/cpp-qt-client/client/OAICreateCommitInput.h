...
/*
 * OAICreateCommitInput.h
 *
 * 
 */

#ifndef OAICreateCommitInput_H
#define OAICreateCommitInput_H
...
class OAICreateCommitInput : public OAIObject {
public:
    OAICreateCommitInput();
    OAICreateCommitInput(QString json);
    ~OAICreateCommitInput() override;
    ...
    QString getParentCommitId() const;
    void setParentCommitId(const QString &parent_commit_id);
    bool is_parent_commit_id_Set() const;
    bool is_parent_commit_id_Valid() const;
    ...
    QList getPutFiles() const;
    void setPutFiles(const QList &put_files);
    bool is_put_files_Set() const;
    bool is_put_files_Valid() const;
...
private:
    ...
    QString m_parent_commit_id;
    bool m_parent_commit_id_isSet;
    bool m_parent_commit_id_isValid;
    ...
    QList m_put_files;
    bool m_put_files_isSet;
    bool m_put_files_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCommitInput)

#endif // OAICreateCommitInput_H
