...
OAIMergeOperations::OAIMergeOperations(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMergeOperations::OAIMergeOperations() {
    this->initializeModel();
}

OAIMergeOperations::~OAIMergeOperations() {}

void OAIMergeOperations::initializeModel() {
...
void OAIMergeOperations::fromJson(QString jsonString) {
...
void OAIMergeOperations::fromJsonObject(QJsonObject json) {
...
QString OAIMergeOperations::asJson() const {
...
QJsonObject OAIMergeOperations::asJsonObject() const {
    QJsonObject obj;
    if (m_source.isSet()) {
...
OAIChangeTypeEnum OAIMergeOperations::getSource() const {
    return m_source;
}
void OAIMergeOperations::setSource(const OAIChangeTypeEnum &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAIMergeOperations::is_source_Set() const{
    return m_source_isSet;
}

bool OAIMergeOperations::is_source_Valid() const{
    return m_source_isValid;
}

OAIChangeTypeEnum OAIMergeOperations::getDestination() const {
    return m_destination;
}
void OAIMergeOperations::setDestination(const OAIChangeTypeEnum &destination) {
    m_destination = destination;
    m_destination_isSet = true;
}

bool OAIMergeOperations::is_destination_Set() const{
    return m_destination_isSet;
}

bool OAIMergeOperations::is_destination_Valid() const{
    return m_destination_isValid;
}

bool OAIMergeOperations::isSet() const {
...
bool OAIMergeOperations::isValid() const {
