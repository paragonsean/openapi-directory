...
/*
 * OAIDifference_beforeBlob.h
 *
 * 
 */

#ifndef OAIDifference_beforeBlob_H
#define OAIDifference_beforeBlob_H
...
class OAIDifference_beforeBlob : public OAIObject {
public:
    OAIDifference_beforeBlob();
    OAIDifference_beforeBlob(QString json);
    ~OAIDifference_beforeBlob() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDifference_beforeBlob)

#endif // OAIDifference_beforeBlob_H
