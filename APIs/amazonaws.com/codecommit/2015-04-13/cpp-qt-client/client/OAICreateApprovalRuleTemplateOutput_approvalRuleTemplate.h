...
/*
 * OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate.h
 *
 * 
 */

#ifndef OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate_H
#define OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate_H
...
class OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate : public OAIObject {
public:
    OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate();
    OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate(QString json);
    ~OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate() override;
    ...
    QString getApprovalRuleTemplateDescription() const;
    void setApprovalRuleTemplateDescription(const QString &approval_rule_template_description);
    bool is_approval_rule_template_description_Set() const;
    bool is_approval_rule_template_description_Valid() const;

    QString getApprovalRuleTemplateContent() const;
    void setApprovalRuleTemplateContent(const QString &approval_rule_template_content);
    bool is_approval_rule_template_content_Set() const;
    bool is_approval_rule_template_content_Valid() const;

    QString getRuleContentSha256() const;
    void setRuleContentSha256(const QString &rule_content_sha256);
    bool is_rule_content_sha256_Set() const;
    bool is_rule_content_sha256_Valid() const;
...
private:
    ...
    QString m_approval_rule_template_description;
    bool m_approval_rule_template_description_isSet;
    bool m_approval_rule_template_description_isValid;

    QString m_approval_rule_template_content;
    bool m_approval_rule_template_content_isSet;
    bool m_approval_rule_template_content_isValid;

    QString m_rule_content_sha256;
    bool m_rule_content_sha256_isSet;
    bool m_rule_content_sha256_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate)

#endif // OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate_H
