...
#include "OAIApprovalRuleOverriddenEventMetadata.h"
...
OAIApprovalRuleOverriddenEventMetadata::OAIApprovalRuleOverriddenEventMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIApprovalRuleOverriddenEventMetadata::OAIApprovalRuleOverriddenEventMetadata() {
    this->initializeModel();
}

OAIApprovalRuleOverriddenEventMetadata::~OAIApprovalRuleOverriddenEventMetadata() {}

void OAIApprovalRuleOverriddenEventMetadata::initializeModel() {
...
void OAIApprovalRuleOverriddenEventMetadata::fromJson(QString jsonString) {
...
void OAIApprovalRuleOverriddenEventMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIApprovalRuleOverriddenEventMetadata::asJson() const {
...
QJsonObject OAIApprovalRuleOverriddenEventMetadata::asJsonObject() const {
    QJsonObject obj;
...
QString OAIApprovalRuleOverriddenEventMetadata::getRevisionId() const {
    return m_revision_id;
}
void OAIApprovalRuleOverriddenEventMetadata::setRevisionId(const QString &revision_id) {
    m_revision_id = revision_id;
    m_revision_id_isSet = true;
}

bool OAIApprovalRuleOverriddenEventMetadata::is_revision_id_Set() const{
    return m_revision_id_isSet;
}

bool OAIApprovalRuleOverriddenEventMetadata::is_revision_id_Valid() const{
    return m_revision_id_isValid;
}

OAIOverrideStatus OAIApprovalRuleOverriddenEventMetadata::getOverrideStatus() const {
    return m_override_status;
}
void OAIApprovalRuleOverriddenEventMetadata::setOverrideStatus(const OAIOverrideStatus &override_status) {
    m_override_status = override_status;
    m_override_status_isSet = true;
}

bool OAIApprovalRuleOverriddenEventMetadata::is_override_status_Set() const{
    return m_override_status_isSet;
}

bool OAIApprovalRuleOverriddenEventMetadata::is_override_status_Valid() const{
    return m_override_status_isValid;
}

bool OAIApprovalRuleOverriddenEventMetadata::isSet() const {
...
bool OAIApprovalRuleOverriddenEventMetadata::isValid() const {
