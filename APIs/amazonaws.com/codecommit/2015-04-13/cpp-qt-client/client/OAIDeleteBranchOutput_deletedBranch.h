...
/*
 * OAIDeleteBranchOutput_deletedBranch.h
 *
 * 
 */

#ifndef OAIDeleteBranchOutput_deletedBranch_H
#define OAIDeleteBranchOutput_deletedBranch_H
...
class OAIDeleteBranchOutput_deletedBranch : public OAIObject {
public:
    OAIDeleteBranchOutput_deletedBranch();
    OAIDeleteBranchOutput_deletedBranch(QString json);
    ~OAIDeleteBranchOutput_deletedBranch() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteBranchOutput_deletedBranch)

#endif // OAIDeleteBranchOutput_deletedBranch_H
