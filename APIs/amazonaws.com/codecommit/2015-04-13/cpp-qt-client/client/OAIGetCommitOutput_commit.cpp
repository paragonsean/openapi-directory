...
#include "OAIGetCommitOutput_commit.h"
...
OAIGetCommitOutput_commit::OAIGetCommitOutput_commit(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetCommitOutput_commit::OAIGetCommitOutput_commit() {
    this->initializeModel();
}

OAIGetCommitOutput_commit::~OAIGetCommitOutput_commit() {}

void OAIGetCommitOutput_commit::initializeModel() {
...
void OAIGetCommitOutput_commit::fromJson(QString jsonString) {
...
void OAIGetCommitOutput_commit::fromJsonObject(QJsonObject json) {
...
QString OAIGetCommitOutput_commit::asJson() const {
...
QJsonObject OAIGetCommitOutput_commit::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetCommitOutput_commit::getCommitId() const {
    return m_commit_id;
}
void OAIGetCommitOutput_commit::setCommitId(const QString &commit_id) {
    m_commit_id = commit_id;
    m_commit_id_isSet = true;
}

bool OAIGetCommitOutput_commit::is_commit_id_Set() const{
    return m_commit_id_isSet;
}

bool OAIGetCommitOutput_commit::is_commit_id_Valid() const{
    return m_commit_id_isValid;
}

QString OAIGetCommitOutput_commit::getTreeId() const {
    return m_tree_id;
}
void OAIGetCommitOutput_commit::setTreeId(const QString &tree_id) {
    m_tree_id = tree_id;
    m_tree_id_isSet = true;
}

bool OAIGetCommitOutput_commit::is_tree_id_Set() const{
    return m_tree_id_isSet;
}

bool OAIGetCommitOutput_commit::is_tree_id_Valid() const{
    return m_tree_id_isValid;
}

QList OAIGetCommitOutput_commit::getParents() const {
    return m_parents;
}
void OAIGetCommitOutput_commit::setParents(const QList &parents) {
    m_parents = parents;
    m_parents_isSet = true;
}

bool OAIGetCommitOutput_commit::is_parents_Set() const{
    return m_parents_isSet;
}

bool OAIGetCommitOutput_commit::is_parents_Valid() const{
    return m_parents_isValid;
}

QString OAIGetCommitOutput_commit::getMessage() const {
    return m_message;
}
void OAIGetCommitOutput_commit::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIGetCommitOutput_commit::is_message_Set() const{
    return m_message_isSet;
}

bool OAIGetCommitOutput_commit::is_message_Valid() const{
    return m_message_isValid;
}

OAICommit_author OAIGetCommitOutput_commit::getAuthor() const {
    return m_author;
}
void OAIGetCommitOutput_commit::setAuthor(const OAICommit_author &author) {
    m_author = author;
    m_author_isSet = true;
}

bool OAIGetCommitOutput_commit::is_author_Set() const{
    return m_author_isSet;
}

bool OAIGetCommitOutput_commit::is_author_Valid() const{
    return m_author_isValid;
}

OAICommit_committer OAIGetCommitOutput_commit::getCommitter() const {
    return m_committer;
}
void OAIGetCommitOutput_commit::setCommitter(const OAICommit_committer &committer) {
    m_committer = committer;
    m_committer_isSet = true;
}

bool OAIGetCommitOutput_commit::is_committer_Set() const{
    return m_committer_isSet;
}

bool OAIGetCommitOutput_commit::is_committer_Valid() const{
    return m_committer_isValid;
}

QString OAIGetCommitOutput_commit::getAdditionalData() const {
    return m_additional_data;
}
void OAIGetCommitOutput_commit::setAdditionalData(const QString &additional_data) {
    m_additional_data = additional_data;
    m_additional_data_isSet = true;
}

bool OAIGetCommitOutput_commit::is_additional_data_Set() const{
    return m_additional_data_isSet;
}

bool OAIGetCommitOutput_commit::is_additional_data_Valid() const{
    return m_additional_data_isValid;
}

bool OAIGetCommitOutput_commit::isSet() const {
...
bool OAIGetCommitOutput_commit::isValid() const {
