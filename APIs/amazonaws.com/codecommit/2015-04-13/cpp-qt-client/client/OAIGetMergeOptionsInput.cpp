...
OAIGetMergeOptionsInput::OAIGetMergeOptionsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetMergeOptionsInput::OAIGetMergeOptionsInput() {
    this->initializeModel();
}

OAIGetMergeOptionsInput::~OAIGetMergeOptionsInput() {}

void OAIGetMergeOptionsInput::initializeModel() {
...
void OAIGetMergeOptionsInput::fromJson(QString jsonString) {
...
void OAIGetMergeOptionsInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetMergeOptionsInput::asJson() const {
...
QJsonObject OAIGetMergeOptionsInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetMergeOptionsInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIGetMergeOptionsInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIGetMergeOptionsInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIGetMergeOptionsInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIGetMergeOptionsInput::getSourceCommitSpecifier() const {
    return m_source_commit_specifier;
}
void OAIGetMergeOptionsInput::setSourceCommitSpecifier(const QString &source_commit_specifier) {
    m_source_commit_specifier = source_commit_specifier;
    m_source_commit_specifier_isSet = true;
}

bool OAIGetMergeOptionsInput::is_source_commit_specifier_Set() const{
    return m_source_commit_specifier_isSet;
}

bool OAIGetMergeOptionsInput::is_source_commit_specifier_Valid() const{
    return m_source_commit_specifier_isValid;
}

QString OAIGetMergeOptionsInput::getDestinationCommitSpecifier() const {
    return m_destination_commit_specifier;
}
void OAIGetMergeOptionsInput::setDestinationCommitSpecifier(const QString &destination_commit_specifier) {
    m_destination_commit_specifier = destination_commit_specifier;
    m_destination_commit_specifier_isSet = true;
}

bool OAIGetMergeOptionsInput::is_destination_commit_specifier_Set() const{
    return m_destination_commit_specifier_isSet;
}

bool OAIGetMergeOptionsInput::is_destination_commit_specifier_Valid() const{
    return m_destination_commit_specifier_isValid;
}

OAIConflictDetailLevelTypeEnum OAIGetMergeOptionsInput::getConflictDetailLevel() const {
    return m_conflict_detail_level;
}
void OAIGetMergeOptionsInput::setConflictDetailLevel(const OAIConflictDetailLevelTypeEnum &conflict_detail_level) {
    m_conflict_detail_level = conflict_detail_level;
    m_conflict_detail_level_isSet = true;
}

bool OAIGetMergeOptionsInput::is_conflict_detail_level_Set() const{
    return m_conflict_detail_level_isSet;
}

bool OAIGetMergeOptionsInput::is_conflict_detail_level_Valid() const{
    return m_conflict_detail_level_isValid;
}

OAIConflictResolutionStrategyTypeEnum OAIGetMergeOptionsInput::getConflictResolutionStrategy() const {
    return m_conflict_resolution_strategy;
}
void OAIGetMergeOptionsInput::setConflictResolutionStrategy(const OAIConflictResolutionStrategyTypeEnum &conflict_resolution_strategy) {
    m_conflict_resolution_strategy = conflict_resolution_strategy;
    m_conflict_resolution_strategy_isSet = true;
}

bool OAIGetMergeOptionsInput::is_conflict_resolution_strategy_Set() const{
    return m_conflict_resolution_strategy_isSet;
}

bool OAIGetMergeOptionsInput::is_conflict_resolution_strategy_Valid() const{
    return m_conflict_resolution_strategy_isValid;
}

bool OAIGetMergeOptionsInput::isSet() const {
...
bool OAIGetMergeOptionsInput::isValid() const {
