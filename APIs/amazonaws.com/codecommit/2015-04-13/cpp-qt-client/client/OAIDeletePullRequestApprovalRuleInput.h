...
/*
 * OAIDeletePullRequestApprovalRuleInput.h
 *
 * 
 */

#ifndef OAIDeletePullRequestApprovalRuleInput_H
#define OAIDeletePullRequestApprovalRuleInput_H
...
class OAIDeletePullRequestApprovalRuleInput : public OAIObject {
public:
    OAIDeletePullRequestApprovalRuleInput();
    OAIDeletePullRequestApprovalRuleInput(QString json);
    ~OAIDeletePullRequestApprovalRuleInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeletePullRequestApprovalRuleInput)

#endif // OAIDeletePullRequestApprovalRuleInput_H
