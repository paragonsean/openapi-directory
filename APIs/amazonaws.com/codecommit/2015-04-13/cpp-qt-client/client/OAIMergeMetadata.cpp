...
OAIMergeMetadata::OAIMergeMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMergeMetadata::OAIMergeMetadata() {
    this->initializeModel();
}

OAIMergeMetadata::~OAIMergeMetadata() {}

void OAIMergeMetadata::initializeModel() {
...
void OAIMergeMetadata::fromJson(QString jsonString) {
...
void OAIMergeMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIMergeMetadata::asJson() const {
...
QJsonObject OAIMergeMetadata::asJsonObject() const {
    QJsonObject obj;
...
bool OAIMergeMetadata::getIsMerged() const {
    return m_is_merged;
}
void OAIMergeMetadata::setIsMerged(const bool &is_merged) {
    m_is_merged = is_merged;
    m_is_merged_isSet = true;
}

bool OAIMergeMetadata::is_is_merged_Set() const{
    return m_is_merged_isSet;
}

bool OAIMergeMetadata::is_is_merged_Valid() const{
    return m_is_merged_isValid;
}

QString OAIMergeMetadata::getMergedBy() const {
    return m_merged_by;
}
void OAIMergeMetadata::setMergedBy(const QString &merged_by) {
    m_merged_by = merged_by;
    m_merged_by_isSet = true;
}

bool OAIMergeMetadata::is_merged_by_Set() const{
    return m_merged_by_isSet;
}

bool OAIMergeMetadata::is_merged_by_Valid() const{
    return m_merged_by_isValid;
}

QString OAIMergeMetadata::getMergeCommitId() const {
    return m_merge_commit_id;
}
void OAIMergeMetadata::setMergeCommitId(const QString &merge_commit_id) {
    m_merge_commit_id = merge_commit_id;
    m_merge_commit_id_isSet = true;
}

bool OAIMergeMetadata::is_merge_commit_id_Set() const{
    return m_merge_commit_id_isSet;
}

bool OAIMergeMetadata::is_merge_commit_id_Valid() const{
    return m_merge_commit_id_isValid;
}

OAIMergeOptionTypeEnum OAIMergeMetadata::getMergeOption() const {
    return m_merge_option;
}
void OAIMergeMetadata::setMergeOption(const OAIMergeOptionTypeEnum &merge_option) {
    m_merge_option = merge_option;
    m_merge_option_isSet = true;
}

bool OAIMergeMetadata::is_merge_option_Set() const{
    return m_merge_option_isSet;
}

bool OAIMergeMetadata::is_merge_option_Valid() const{
    return m_merge_option_isValid;
}

bool OAIMergeMetadata::isSet() const {
...
bool OAIMergeMetadata::isValid() const {
