...
/*
 * OAIDeleteFileOutput.h
 *
 * 
 */

#ifndef OAIDeleteFileOutput_H
#define OAIDeleteFileOutput_H
...
class OAIDeleteFileOutput : public OAIObject {
public:
    OAIDeleteFileOutput();
    OAIDeleteFileOutput(QString json);
    ~OAIDeleteFileOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteFileOutput)

#endif // OAIDeleteFileOutput_H
