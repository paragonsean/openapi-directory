...
#include "OAIMergePullRequestByFastForwardOutput_pullRequest.h"
...
OAIMergePullRequestByFastForwardOutput_pullRequest::OAIMergePullRequestByFastForwardOutput_pullRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMergePullRequestByFastForwardOutput_pullRequest::OAIMergePullRequestByFastForwardOutput_pullRequest() {
    this->initializeModel();
}

OAIMergePullRequestByFastForwardOutput_pullRequest::~OAIMergePullRequestByFastForwardOutput_pullRequest() {}

void OAIMergePullRequestByFastForwardOutput_pullRequest::initializeModel() {
    ...
    m_pull_request_status_isSet = false;
    m_pull_request_status_isValid = false;

    m_author_arn_isSet = false;
    m_author_arn_isValid = false;

    m_pull_request_targets_isSet = false;
    m_pull_request_targets_isValid = false;
    ...
    m_approval_rules_isSet = false;
    m_approval_rules_isValid = false;
}

void OAIMergePullRequestByFastForwardOutput_pullRequest::fromJson(QString jsonString) {
...
void OAIMergePullRequestByFastForwardOutput_pullRequest::fromJsonObject(QJsonObject json) {
    ...
    m_pull_request_status_isValid = ::OpenAPI::fromJsonValue(m_pull_request_status, json[QString("pullRequestStatus")]);
    m_pull_request_status_isSet = !json[QString("pullRequestStatus")].isNull() && m_pull_request_status_isValid;
    ...
    m_pull_request_targets_isValid = ::OpenAPI::fromJsonValue(m_pull_request_targets, json[QString("pullRequestTargets")]);
    m_pull_request_targets_isSet = !json[QString("pullRequestTargets")].isNull() && m_pull_request_targets_isValid;
    ...
    m_approval_rules_isValid = ::OpenAPI::fromJsonValue(m_approval_rules, json[QString("approvalRules")]);
    m_approval_rules_isSet = !json[QString("approvalRules")].isNull() && m_approval_rules_isValid;
}

QString OAIMergePullRequestByFastForwardOutput_pullRequest::asJson() const {
...
QJsonObject OAIMergePullRequestByFastForwardOutput_pullRequest::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_pull_request_status.isSet()) {
        obj.insert(QString("pullRequestStatus"), ::OpenAPI::toJsonValue(m_pull_request_status));
    }
    if (m_author_arn_isSet) {
        obj.insert(QString("authorArn"), ::OpenAPI::toJsonValue(m_author_arn));
    }
    if (m_pull_request_targets.isSet()) {
        obj.insert(QString("pullRequestTargets"), ::OpenAPI::toJsonValue(m_pull_request_targets));
    }
    ...
    if (m_approval_rules.isSet()) {
        obj.insert(QString("approvalRules"), ::OpenAPI::toJsonValue(m_approval_rules));
    }
    return obj;
}

QString OAIMergePullRequestByFastForwardOutput_pullRequest::getPullRequestId() const {
    return m_pull_request_id;
}
void OAIMergePullRequestByFastForwardOutput_pullRequest::setPullRequestId(const QString &pull_request_id) {
    m_pull_request_id = pull_request_id;
    m_pull_request_id_isSet = true;
}

bool OAIMergePullRequestByFastForwardOutput_pullRequest::is_pull_request_id_Set() const{
    return m_pull_request_id_isSet;
}

bool OAIMergePullRequestByFastForwardOutput_pullRequest::is_pull_request_id_Valid() const{
    return m_pull_request_id_isValid;
}

QString OAIMergePullRequestByFastForwardOutput_pullRequest::getTitle() const {
    return m_title;
}
void OAIMergePullRequestByFastForwardOutput_pullRequest::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIMergePullRequestByFastForwardOutput_pullRequest::is_title_Set() const{
    return m_title_isSet;
}

bool OAIMergePullRequestByFastForwardOutput_pullRequest::is_title_Valid() const{
    return m_title_isValid;
}

QString OAIMergePullRequestByFastForwardOutput_pullRequest::getDescription() const {
    return m_description;
}
void OAIMergePullRequestByFastForwardOutput_pullRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIMergePullRequestByFastForwardOutput_pullRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAIMergePullRequestByFastForwardOutput_pullRequest::is_description_Valid() const{
    return m_description_isValid;
}

QDateTime OAIMergePullRequestByFastForwardOutput_pullRequest::getLastActivityDate() const {
    return m_last_activity_date;
}
void OAIMergePullRequestByFastForwardOutput_pullRequest::setLastActivityDate(const QDateTime &last_activity_date) {
    m_last_activity_date = last_activity_date;
    m_last_activity_date_isSet = true;
}

bool OAIMergePullRequestByFastForwardOutput_pullRequest::is_last_activity_date_Set() const{
    return m_last_activity_date_isSet;
}

bool OAIMergePullRequestByFastForwardOutput_pullRequest::is_last_activity_date_Valid() const{
    return m_last_activity_date_isValid;
}

QDateTime OAIMergePullRequestByFastForwardOutput_pullRequest::getCreationDate() const {
    return m_creation_date;
}
void OAIMergePullRequestByFastForwardOutput_pullRequest::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAIMergePullRequestByFastForwardOutput_pullRequest::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAIMergePullRequestByFastForwardOutput_pullRequest::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

OAIPullRequestStatusEnum OAIMergePullRequestByFastForwardOutput_pullRequest::getPullRequestStatus() const {
    return m_pull_request_status;
}
void OAIMergePullRequestByFastForwardOutput_pullRequest::setPullRequestStatus(const OAIPullRequestStatusEnum &pull_request_status) {
    m_pull_request_status = pull_request_status;
    m_pull_request_status_isSet = true;
}

bool OAIMergePullRequestByFastForwardOutput_pullRequest::is_pull_request_status_Set() const{
    return m_pull_request_status_isSet;
}

bool OAIMergePullRequestByFastForwardOutput_pullRequest::is_pull_request_status_Valid() const{
    return m_pull_request_status_isValid;
}

QString OAIMergePullRequestByFastForwardOutput_pullRequest::getAuthorArn() const {
    return m_author_arn;
}
void OAIMergePullRequestByFastForwardOutput_pullRequest::setAuthorArn(const QString &author_arn) {
    m_author_arn = author_arn;
    m_author_arn_isSet = true;
}

bool OAIMergePullRequestByFastForwardOutput_pullRequest::is_author_arn_Set() const{
    return m_author_arn_isSet;
}

bool OAIMergePullRequestByFastForwardOutput_pullRequest::is_author_arn_Valid() const{
    return m_author_arn_isValid;
}

QList OAIMergePullRequestByFastForwardOutput_pullRequest::getPullRequestTargets() const {
    return m_pull_request_targets;
}
void OAIMergePullRequestByFastForwardOutput_pullRequest::setPullRequestTargets(const QList &pull_request_targets) {
    m_pull_request_targets = pull_request_targets;
    m_pull_request_targets_isSet = true;
}

bool OAIMergePullRequestByFastForwardOutput_pullRequest::is_pull_request_targets_Set() const{
    return m_pull_request_targets_isSet;
}

bool OAIMergePullRequestByFastForwardOutput_pullRequest::is_pull_request_targets_Valid() const{
    return m_pull_request_targets_isValid;
}

QString OAIMergePullRequestByFastForwardOutput_pullRequest::getClientRequestToken() const {
    return m_client_request_token;
}
void OAIMergePullRequestByFastForwardOutput_pullRequest::setClientRequestToken(const QString &client_request_token) {
    m_client_request_token = client_request_token;
    m_client_request_token_isSet = true;
}

bool OAIMergePullRequestByFastForwardOutput_pullRequest::is_client_request_token_Set() const{
    return m_client_request_token_isSet;
}

bool OAIMergePullRequestByFastForwardOutput_pullRequest::is_client_request_token_Valid() const{
    return m_client_request_token_isValid;
}

QString OAIMergePullRequestByFastForwardOutput_pullRequest::getRevisionId() const {
    return m_revision_id;
}
void OAIMergePullRequestByFastForwardOutput_pullRequest::setRevisionId(const QString &revision_id) {
    m_revision_id = revision_id;
    m_revision_id_isSet = true;
}

bool OAIMergePullRequestByFastForwardOutput_pullRequest::is_revision_id_Set() const{
    return m_revision_id_isSet;
}

bool OAIMergePullRequestByFastForwardOutput_pullRequest::is_revision_id_Valid() const{
    return m_revision_id_isValid;
}

QList OAIMergePullRequestByFastForwardOutput_pullRequest::getApprovalRules() const {
    return m_approval_rules;
}
void OAIMergePullRequestByFastForwardOutput_pullRequest::setApprovalRules(const QList &approval_rules) {
    m_approval_rules = approval_rules;
    m_approval_rules_isSet = true;
}

bool OAIMergePullRequestByFastForwardOutput_pullRequest::is_approval_rules_Set() const{
    return m_approval_rules_isSet;
}

bool OAIMergePullRequestByFastForwardOutput_pullRequest::is_approval_rules_Valid() const{
    return m_approval_rules_isValid;
}

bool OAIMergePullRequestByFastForwardOutput_pullRequest::isSet() const {
...
bool OAIMergePullRequestByFastForwardOutput_pullRequest::isValid() const {
