...
OAIGetPullRequestInput::OAIGetPullRequestInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPullRequestInput::OAIGetPullRequestInput() {
    this->initializeModel();
}

OAIGetPullRequestInput::~OAIGetPullRequestInput() {}

void OAIGetPullRequestInput::initializeModel() {

    m_pull_request_id_isSet = false;
    m_pull_request_id_isValid = false;
}

void OAIGetPullRequestInput::fromJson(QString jsonString) {
...
void OAIGetPullRequestInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetPullRequestInput::asJson() const {
...
QJsonObject OAIGetPullRequestInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetPullRequestInput::getPullRequestId() const {
    return m_pull_request_id;
}
void OAIGetPullRequestInput::setPullRequestId(const QString &pull_request_id) {
    m_pull_request_id = pull_request_id;
    m_pull_request_id_isSet = true;
}

bool OAIGetPullRequestInput::is_pull_request_id_Set() const{
    return m_pull_request_id_isSet;
}

bool OAIGetPullRequestInput::is_pull_request_id_Valid() const{
    return m_pull_request_id_isValid;
}

bool OAIGetPullRequestInput::isSet() const {
...
bool OAIGetPullRequestInput::isValid() const {
