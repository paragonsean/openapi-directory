...
OAIGetPullRequestApprovalStatesInput::OAIGetPullRequestApprovalStatesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPullRequestApprovalStatesInput::OAIGetPullRequestApprovalStatesInput() {
    this->initializeModel();
}

OAIGetPullRequestApprovalStatesInput::~OAIGetPullRequestApprovalStatesInput() {}

void OAIGetPullRequestApprovalStatesInput::initializeModel() {
...
void OAIGetPullRequestApprovalStatesInput::fromJson(QString jsonString) {
...
void OAIGetPullRequestApprovalStatesInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetPullRequestApprovalStatesInput::asJson() const {
...
QJsonObject OAIGetPullRequestApprovalStatesInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetPullRequestApprovalStatesInput::getPullRequestId() const {
    return m_pull_request_id;
}
void OAIGetPullRequestApprovalStatesInput::setPullRequestId(const QString &pull_request_id) {
    m_pull_request_id = pull_request_id;
    m_pull_request_id_isSet = true;
}

bool OAIGetPullRequestApprovalStatesInput::is_pull_request_id_Set() const{
    return m_pull_request_id_isSet;
}

bool OAIGetPullRequestApprovalStatesInput::is_pull_request_id_Valid() const{
    return m_pull_request_id_isValid;
}

QString OAIGetPullRequestApprovalStatesInput::getRevisionId() const {
    return m_revision_id;
}
void OAIGetPullRequestApprovalStatesInput::setRevisionId(const QString &revision_id) {
    m_revision_id = revision_id;
    m_revision_id_isSet = true;
}

bool OAIGetPullRequestApprovalStatesInput::is_revision_id_Set() const{
    return m_revision_id_isSet;
}

bool OAIGetPullRequestApprovalStatesInput::is_revision_id_Valid() const{
    return m_revision_id_isValid;
}

bool OAIGetPullRequestApprovalStatesInput::isSet() const {
...
bool OAIGetPullRequestApprovalStatesInput::isValid() const {
