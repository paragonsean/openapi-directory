...
OAIUpdateApprovalRuleTemplateDescriptionOutput::OAIUpdateApprovalRuleTemplateDescriptionOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateApprovalRuleTemplateDescriptionOutput::OAIUpdateApprovalRuleTemplateDescriptionOutput() {
    this->initializeModel();
}

OAIUpdateApprovalRuleTemplateDescriptionOutput::~OAIUpdateApprovalRuleTemplateDescriptionOutput() {}

void OAIUpdateApprovalRuleTemplateDescriptionOutput::initializeModel() {

    m_approval_rule_template_isSet = false;
    m_approval_rule_template_isValid = false;
}

void OAIUpdateApprovalRuleTemplateDescriptionOutput::fromJson(QString jsonString) {
...
void OAIUpdateApprovalRuleTemplateDescriptionOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateApprovalRuleTemplateDescriptionOutput::asJson() const {
...
QJsonObject OAIUpdateApprovalRuleTemplateDescriptionOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdateApprovalRuleTemplateDescriptionOutput_approvalRuleTemplate OAIUpdateApprovalRuleTemplateDescriptionOutput::getApprovalRuleTemplate() const {
    return m_approval_rule_template;
}
void OAIUpdateApprovalRuleTemplateDescriptionOutput::setApprovalRuleTemplate(const OAIUpdateApprovalRuleTemplateDescriptionOutput_approvalRuleTemplate &approval_rule_template) {
    m_approval_rule_template = approval_rule_template;
    m_approval_rule_template_isSet = true;
}

bool OAIUpdateApprovalRuleTemplateDescriptionOutput::is_approval_rule_template_Set() const{
    return m_approval_rule_template_isSet;
}

bool OAIUpdateApprovalRuleTemplateDescriptionOutput::is_approval_rule_template_Valid() const{
    return m_approval_rule_template_isValid;
}

bool OAIUpdateApprovalRuleTemplateDescriptionOutput::isSet() const {
...
bool OAIUpdateApprovalRuleTemplateDescriptionOutput::isValid() const {
