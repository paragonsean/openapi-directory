...
/*
 * OAIGetCommentReactionsOutput.h
 *
 * 
 */

#ifndef OAIGetCommentReactionsOutput_H
#define OAIGetCommentReactionsOutput_H
...
class OAIGetCommentReactionsOutput : public OAIObject {
public:
    OAIGetCommentReactionsOutput();
    OAIGetCommentReactionsOutput(QString json);
    ~OAIGetCommentReactionsOutput() override;
    ...
    QList getReactionsForComment() const;
    void setReactionsForComment(const QList &reactions_for_comment);
    bool is_reactions_for_comment_Set() const;
    bool is_reactions_for_comment_Valid() const;
...
private:
    ...
    QList m_reactions_for_comment;
    bool m_reactions_for_comment_isSet;
    bool m_reactions_for_comment_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCommentReactionsOutput)

#endif // OAIGetCommentReactionsOutput_H
