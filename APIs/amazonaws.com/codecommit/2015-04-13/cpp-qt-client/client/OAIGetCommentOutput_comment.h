...
/*
 * OAIGetCommentOutput_comment.h
 *
 * 
 */

#ifndef OAIGetCommentOutput_comment_H
#define OAIGetCommentOutput_comment_H
...
class OAIGetCommentOutput_comment : public OAIObject {
public:
    OAIGetCommentOutput_comment();
    OAIGetCommentOutput_comment(QString json);
    ~OAIGetCommentOutput_comment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCommentOutput_comment)

#endif // OAIGetCommentOutput_comment_H
