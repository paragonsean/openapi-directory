...
/*
 * OAIListApprovalRuleTemplatesInput.h
 *
 * 
 */

#ifndef OAIListApprovalRuleTemplatesInput_H
#define OAIListApprovalRuleTemplatesInput_H
...
class OAIListApprovalRuleTemplatesInput : public OAIObject {
public:
    OAIListApprovalRuleTemplatesInput();
    OAIListApprovalRuleTemplatesInput(QString json);
    ~OAIListApprovalRuleTemplatesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListApprovalRuleTemplatesInput)

#endif // OAIListApprovalRuleTemplatesInput_H
