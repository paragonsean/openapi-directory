...
OAIMergePullRequestByFastForwardOutput::OAIMergePullRequestByFastForwardOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMergePullRequestByFastForwardOutput::OAIMergePullRequestByFastForwardOutput() {
    this->initializeModel();
}

OAIMergePullRequestByFastForwardOutput::~OAIMergePullRequestByFastForwardOutput() {}

void OAIMergePullRequestByFastForwardOutput::initializeModel() {

    m_pull_request_isSet = false;
    m_pull_request_isValid = false;
}

void OAIMergePullRequestByFastForwardOutput::fromJson(QString jsonString) {
...
void OAIMergePullRequestByFastForwardOutput::fromJsonObject(QJsonObject json) {
...
QString OAIMergePullRequestByFastForwardOutput::asJson() const {
...
QJsonObject OAIMergePullRequestByFastForwardOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIMergePullRequestByFastForwardOutput_pullRequest OAIMergePullRequestByFastForwardOutput::getPullRequest() const {
    return m_pull_request;
}
void OAIMergePullRequestByFastForwardOutput::setPullRequest(const OAIMergePullRequestByFastForwardOutput_pullRequest &pull_request) {
    m_pull_request = pull_request;
    m_pull_request_isSet = true;
}

bool OAIMergePullRequestByFastForwardOutput::is_pull_request_Set() const{
    return m_pull_request_isSet;
}

bool OAIMergePullRequestByFastForwardOutput::is_pull_request_Valid() const{
    return m_pull_request_isValid;
}

bool OAIMergePullRequestByFastForwardOutput::isSet() const {
...
bool OAIMergePullRequestByFastForwardOutput::isValid() const {
