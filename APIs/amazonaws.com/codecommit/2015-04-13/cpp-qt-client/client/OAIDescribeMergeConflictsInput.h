...
/*
 * OAIDescribeMergeConflictsInput.h
 *
 * 
 */

#ifndef OAIDescribeMergeConflictsInput_H
#define OAIDescribeMergeConflictsInput_H
...
class OAIDescribeMergeConflictsInput : public OAIObject {
public:
    OAIDescribeMergeConflictsInput();
    OAIDescribeMergeConflictsInput(QString json);
    ~OAIDescribeMergeConflictsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeMergeConflictsInput)

#endif // OAIDescribeMergeConflictsInput_H
