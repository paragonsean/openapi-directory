...
#include "OAICommentsForComparedCommit.h"
...
OAICommentsForComparedCommit::OAICommentsForComparedCommit(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICommentsForComparedCommit::OAICommentsForComparedCommit() {
    this->initializeModel();
}

OAICommentsForComparedCommit::~OAICommentsForComparedCommit() {}

void OAICommentsForComparedCommit::initializeModel() {
...
void OAICommentsForComparedCommit::fromJson(QString jsonString) {
...
void OAICommentsForComparedCommit::fromJsonObject(QJsonObject json) {
...
QString OAICommentsForComparedCommit::asJson() const {
...
QJsonObject OAICommentsForComparedCommit::asJsonObject() const {
    QJsonObject obj;
...
QString OAICommentsForComparedCommit::getRepositoryName() const {
    return m_repository_name;
}
void OAICommentsForComparedCommit::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAICommentsForComparedCommit::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAICommentsForComparedCommit::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAICommentsForComparedCommit::getBeforeCommitId() const {
    return m_before_commit_id;
}
void OAICommentsForComparedCommit::setBeforeCommitId(const QString &before_commit_id) {
    m_before_commit_id = before_commit_id;
    m_before_commit_id_isSet = true;
}

bool OAICommentsForComparedCommit::is_before_commit_id_Set() const{
    return m_before_commit_id_isSet;
}

bool OAICommentsForComparedCommit::is_before_commit_id_Valid() const{
    return m_before_commit_id_isValid;
}

QString OAICommentsForComparedCommit::getAfterCommitId() const {
    return m_after_commit_id;
}
void OAICommentsForComparedCommit::setAfterCommitId(const QString &after_commit_id) {
    m_after_commit_id = after_commit_id;
    m_after_commit_id_isSet = true;
}

bool OAICommentsForComparedCommit::is_after_commit_id_Set() const{
    return m_after_commit_id_isSet;
}

bool OAICommentsForComparedCommit::is_after_commit_id_Valid() const{
    return m_after_commit_id_isValid;
}

QString OAICommentsForComparedCommit::getBeforeBlobId() const {
    return m_before_blob_id;
}
void OAICommentsForComparedCommit::setBeforeBlobId(const QString &before_blob_id) {
    m_before_blob_id = before_blob_id;
    m_before_blob_id_isSet = true;
}

bool OAICommentsForComparedCommit::is_before_blob_id_Set() const{
    return m_before_blob_id_isSet;
}

bool OAICommentsForComparedCommit::is_before_blob_id_Valid() const{
    return m_before_blob_id_isValid;
}

QString OAICommentsForComparedCommit::getAfterBlobId() const {
    return m_after_blob_id;
}
void OAICommentsForComparedCommit::setAfterBlobId(const QString &after_blob_id) {
    m_after_blob_id = after_blob_id;
    m_after_blob_id_isSet = true;
}

bool OAICommentsForComparedCommit::is_after_blob_id_Set() const{
    return m_after_blob_id_isSet;
}

bool OAICommentsForComparedCommit::is_after_blob_id_Valid() const{
    return m_after_blob_id_isValid;
}

OAICommentsForComparedCommit_location OAICommentsForComparedCommit::getLocation() const {
    return m_location;
}
void OAICommentsForComparedCommit::setLocation(const OAICommentsForComparedCommit_location &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAICommentsForComparedCommit::is_location_Set() const{
    return m_location_isSet;
}

bool OAICommentsForComparedCommit::is_location_Valid() const{
    return m_location_isValid;
}

QList OAICommentsForComparedCommit::getComments() const {
    return m_comments;
}
void OAICommentsForComparedCommit::setComments(const QList &comments) {
    m_comments = comments;
    m_comments_isSet = true;
}

bool OAICommentsForComparedCommit::is_comments_Set() const{
    return m_comments_isSet;
}

bool OAICommentsForComparedCommit::is_comments_Valid() const{
    return m_comments_isValid;
}

bool OAICommentsForComparedCommit::isSet() const {
...
bool OAICommentsForComparedCommit::isValid() const {
