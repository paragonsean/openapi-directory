...
OAIPostCommentForPullRequestInput_location::OAIPostCommentForPullRequestInput_location(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPostCommentForPullRequestInput_location::OAIPostCommentForPullRequestInput_location() {
    this->initializeModel();
}

OAIPostCommentForPullRequestInput_location::~OAIPostCommentForPullRequestInput_location() {}

void OAIPostCommentForPullRequestInput_location::initializeModel() {
...
void OAIPostCommentForPullRequestInput_location::fromJson(QString jsonString) {
...
void OAIPostCommentForPullRequestInput_location::fromJsonObject(QJsonObject json) {
...
QString OAIPostCommentForPullRequestInput_location::asJson() const {
...
QJsonObject OAIPostCommentForPullRequestInput_location::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPostCommentForPullRequestInput_location::getFilePath() const {
    return m_file_path;
}
void OAIPostCommentForPullRequestInput_location::setFilePath(const QString &file_path) {
    m_file_path = file_path;
    m_file_path_isSet = true;
}

bool OAIPostCommentForPullRequestInput_location::is_file_path_Set() const{
    return m_file_path_isSet;
}

bool OAIPostCommentForPullRequestInput_location::is_file_path_Valid() const{
    return m_file_path_isValid;
}

qint32 OAIPostCommentForPullRequestInput_location::getFilePosition() const {
    return m_file_position;
}
void OAIPostCommentForPullRequestInput_location::setFilePosition(const qint32 &file_position) {
    m_file_position = file_position;
    m_file_position_isSet = true;
}

bool OAIPostCommentForPullRequestInput_location::is_file_position_Set() const{
    return m_file_position_isSet;
}

bool OAIPostCommentForPullRequestInput_location::is_file_position_Valid() const{
    return m_file_position_isValid;
}

OAIRelativeFileVersionEnum OAIPostCommentForPullRequestInput_location::getRelativeFileVersion() const {
    return m_relative_file_version;
}
void OAIPostCommentForPullRequestInput_location::setRelativeFileVersion(const OAIRelativeFileVersionEnum &relative_file_version) {
    m_relative_file_version = relative_file_version;
    m_relative_file_version_isSet = true;
}

bool OAIPostCommentForPullRequestInput_location::is_relative_file_version_Set() const{
    return m_relative_file_version_isSet;
}

bool OAIPostCommentForPullRequestInput_location::is_relative_file_version_Valid() const{
    return m_relative_file_version_isValid;
}

bool OAIPostCommentForPullRequestInput_location::isSet() const {
...
bool OAIPostCommentForPullRequestInput_location::isValid() const {
