...
void OAIObjectTypeEnum::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("FILE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIObjectTypeEnum::FILE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DIRECTORY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIObjectTypeEnum::DIRECTORY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("GIT_LINK", Qt::CaseInsensitive) == 0) {
        m_value = eOAIObjectTypeEnum::GIT_LINK;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SYMBOLIC_LINK", Qt::CaseInsensitive) == 0) {
        m_value = eOAIObjectTypeEnum::SYMBOLIC_LINK;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIObjectTypeEnum::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIObjectTypeEnum::FILE:
            val = "FILE";
            break;
        case eOAIObjectTypeEnum::DIRECTORY:
            val = "DIRECTORY";
            break;
        case eOAIObjectTypeEnum::GIT_LINK:
            val = "GIT_LINK";
            break;
        case eOAIObjectTypeEnum::SYMBOLIC_LINK:
            val = "SYMBOLIC_LINK";
            break;
        default:
            break;
