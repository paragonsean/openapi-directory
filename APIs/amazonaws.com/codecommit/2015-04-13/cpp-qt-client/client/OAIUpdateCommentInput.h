...
/*
 * OAIUpdateCommentInput.h
 *
 * 
 */

#ifndef OAIUpdateCommentInput_H
#define OAIUpdateCommentInput_H
...
class OAIUpdateCommentInput : public OAIObject {
public:
    OAIUpdateCommentInput();
    OAIUpdateCommentInput(QString json);
    ~OAIUpdateCommentInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateCommentInput)

#endif // OAIUpdateCommentInput_H
