...
/*
 * OAIGetPullRequestOverrideStateOutput.h
 *
 * 
 */

#ifndef OAIGetPullRequestOverrideStateOutput_H
#define OAIGetPullRequestOverrideStateOutput_H
...
class OAIGetPullRequestOverrideStateOutput : public OAIObject {
public:
    OAIGetPullRequestOverrideStateOutput();
    OAIGetPullRequestOverrideStateOutput(QString json);
    ~OAIGetPullRequestOverrideStateOutput() override;
    ...
    QString getOverrider() const;
    void setOverrider(const QString &overrider);
    bool is_overrider_Set() const;
    bool is_overrider_Valid() const;
...
private:
    ...
    QString m_overrider;
    bool m_overrider_isSet;
    bool m_overrider_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetPullRequestOverrideStateOutput)

#endif // OAIGetPullRequestOverrideStateOutput_H
