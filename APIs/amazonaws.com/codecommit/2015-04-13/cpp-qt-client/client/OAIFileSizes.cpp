...
OAIFileSizes::OAIFileSizes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFileSizes::OAIFileSizes() {
    this->initializeModel();
}

OAIFileSizes::~OAIFileSizes() {}

void OAIFileSizes::initializeModel() {
...
void OAIFileSizes::fromJson(QString jsonString) {
...
void OAIFileSizes::fromJsonObject(QJsonObject json) {
...
QString OAIFileSizes::asJson() const {
...
QJsonObject OAIFileSizes::asJsonObject() const {
    QJsonObject obj;
    if (m_source_isSet) {
...
qint32 OAIFileSizes::getSource() const {
    return m_source;
}
void OAIFileSizes::setSource(const qint32 &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAIFileSizes::is_source_Set() const{
    return m_source_isSet;
}

bool OAIFileSizes::is_source_Valid() const{
    return m_source_isValid;
}

qint32 OAIFileSizes::getDestination() const {
    return m_destination;
}
void OAIFileSizes::setDestination(const qint32 &destination) {
    m_destination = destination;
    m_destination_isSet = true;
}

bool OAIFileSizes::is_destination_Set() const{
    return m_destination_isSet;
}

bool OAIFileSizes::is_destination_Valid() const{
    return m_destination_isValid;
}

qint32 OAIFileSizes::getBase() const {
    return m_base;
}
void OAIFileSizes::setBase(const qint32 &base) {
    m_base = base;
    m_base_isSet = true;
}

bool OAIFileSizes::is_base_Set() const{
    return m_base_isSet;
}

bool OAIFileSizes::is_base_Valid() const{
    return m_base_isValid;
}

bool OAIFileSizes::isSet() const {
...
bool OAIFileSizes::isValid() const {
