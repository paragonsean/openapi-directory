...
/*
 * OAIGetFolderOutput.h
 *
 * 
 */

#ifndef OAIGetFolderOutput_H
#define OAIGetFolderOutput_H
...
class OAIGetFolderOutput : public OAIObject {
public:
    OAIGetFolderOutput();
    OAIGetFolderOutput(QString json);
    ~OAIGetFolderOutput() override;
    ...
    QList getSubFolders() const;
    void setSubFolders(const QList &sub_folders);
    bool is_sub_folders_Set() const;
    bool is_sub_folders_Valid() const;
    ...
    QList getSymbolicLinks() const;
    void setSymbolicLinks(const QList &symbolic_links);
    bool is_symbolic_links_Set() const;
    bool is_symbolic_links_Valid() const;

    QList getSubModules() const;
    void setSubModules(const QList &sub_modules);
    bool is_sub_modules_Set() const;
    bool is_sub_modules_Valid() const;
...
private:
    ...
    QList m_sub_folders;
    bool m_sub_folders_isSet;
    bool m_sub_folders_isValid;

    QList m_files;
    bool m_files_isSet;
    bool m_files_isValid;

    QList m_symbolic_links;
    bool m_symbolic_links_isSet;
    bool m_symbolic_links_isValid;

    QList m_sub_modules;
    bool m_sub_modules_isSet;
    bool m_sub_modules_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetFolderOutput)

#endif // OAIGetFolderOutput_H
