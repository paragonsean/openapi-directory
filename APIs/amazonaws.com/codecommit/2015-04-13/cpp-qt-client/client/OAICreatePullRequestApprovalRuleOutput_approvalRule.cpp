...
#include "OAICreatePullRequestApprovalRuleOutput_approvalRule.h"
...
OAICreatePullRequestApprovalRuleOutput_approvalRule::OAICreatePullRequestApprovalRuleOutput_approvalRule(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreatePullRequestApprovalRuleOutput_approvalRule::OAICreatePullRequestApprovalRuleOutput_approvalRule() {
    this->initializeModel();
}

OAICreatePullRequestApprovalRuleOutput_approvalRule::~OAICreatePullRequestApprovalRuleOutput_approvalRule() {}

void OAICreatePullRequestApprovalRuleOutput_approvalRule::initializeModel() {
    ...
    m_origin_approval_rule_template_isSet = false;
    m_origin_approval_rule_template_isValid = false;
}

void OAICreatePullRequestApprovalRuleOutput_approvalRule::fromJson(QString jsonString) {
...
void OAICreatePullRequestApprovalRuleOutput_approvalRule::fromJsonObject(QJsonObject json) {
    ...
    m_origin_approval_rule_template_isValid = ::OpenAPI::fromJsonValue(m_origin_approval_rule_template, json[QString("originApprovalRuleTemplate")]);
    m_origin_approval_rule_template_isSet = !json[QString("originApprovalRuleTemplate")].isNull() && m_origin_approval_rule_template_isValid;
}

QString OAICreatePullRequestApprovalRuleOutput_approvalRule::asJson() const {
...
QJsonObject OAICreatePullRequestApprovalRuleOutput_approvalRule::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_origin_approval_rule_template.isSet()) {
        obj.insert(QString("originApprovalRuleTemplate"), ::OpenAPI::toJsonValue(m_origin_approval_rule_template));
    }
    return obj;
}

QString OAICreatePullRequestApprovalRuleOutput_approvalRule::getApprovalRuleId() const {
    return m_approval_rule_id;
}
void OAICreatePullRequestApprovalRuleOutput_approvalRule::setApprovalRuleId(const QString &approval_rule_id) {
    m_approval_rule_id = approval_rule_id;
    m_approval_rule_id_isSet = true;
}

bool OAICreatePullRequestApprovalRuleOutput_approvalRule::is_approval_rule_id_Set() const{
    return m_approval_rule_id_isSet;
}

bool OAICreatePullRequestApprovalRuleOutput_approvalRule::is_approval_rule_id_Valid() const{
    return m_approval_rule_id_isValid;
}

QString OAICreatePullRequestApprovalRuleOutput_approvalRule::getApprovalRuleName() const {
    return m_approval_rule_name;
}
void OAICreatePullRequestApprovalRuleOutput_approvalRule::setApprovalRuleName(const QString &approval_rule_name) {
    m_approval_rule_name = approval_rule_name;
    m_approval_rule_name_isSet = true;
}

bool OAICreatePullRequestApprovalRuleOutput_approvalRule::is_approval_rule_name_Set() const{
    return m_approval_rule_name_isSet;
}

bool OAICreatePullRequestApprovalRuleOutput_approvalRule::is_approval_rule_name_Valid() const{
    return m_approval_rule_name_isValid;
}

QString OAICreatePullRequestApprovalRuleOutput_approvalRule::getApprovalRuleContent() const {
    return m_approval_rule_content;
}
void OAICreatePullRequestApprovalRuleOutput_approvalRule::setApprovalRuleContent(const QString &approval_rule_content) {
    m_approval_rule_content = approval_rule_content;
    m_approval_rule_content_isSet = true;
}

bool OAICreatePullRequestApprovalRuleOutput_approvalRule::is_approval_rule_content_Set() const{
    return m_approval_rule_content_isSet;
}

bool OAICreatePullRequestApprovalRuleOutput_approvalRule::is_approval_rule_content_Valid() const{
    return m_approval_rule_content_isValid;
}

QString OAICreatePullRequestApprovalRuleOutput_approvalRule::getRuleContentSha256() const {
    return m_rule_content_sha256;
}
void OAICreatePullRequestApprovalRuleOutput_approvalRule::setRuleContentSha256(const QString &rule_content_sha256) {
    m_rule_content_sha256 = rule_content_sha256;
    m_rule_content_sha256_isSet = true;
}

bool OAICreatePullRequestApprovalRuleOutput_approvalRule::is_rule_content_sha256_Set() const{
    return m_rule_content_sha256_isSet;
}

bool OAICreatePullRequestApprovalRuleOutput_approvalRule::is_rule_content_sha256_Valid() const{
    return m_rule_content_sha256_isValid;
}

QDateTime OAICreatePullRequestApprovalRuleOutput_approvalRule::getLastModifiedDate() const {
    return m_last_modified_date;
}
void OAICreatePullRequestApprovalRuleOutput_approvalRule::setLastModifiedDate(const QDateTime &last_modified_date) {
    m_last_modified_date = last_modified_date;
    m_last_modified_date_isSet = true;
}

bool OAICreatePullRequestApprovalRuleOutput_approvalRule::is_last_modified_date_Set() const{
    return m_last_modified_date_isSet;
}

bool OAICreatePullRequestApprovalRuleOutput_approvalRule::is_last_modified_date_Valid() const{
    return m_last_modified_date_isValid;
}

QDateTime OAICreatePullRequestApprovalRuleOutput_approvalRule::getCreationDate() const {
    return m_creation_date;
}
void OAICreatePullRequestApprovalRuleOutput_approvalRule::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAICreatePullRequestApprovalRuleOutput_approvalRule::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAICreatePullRequestApprovalRuleOutput_approvalRule::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

QString OAICreatePullRequestApprovalRuleOutput_approvalRule::getLastModifiedUser() const {
    return m_last_modified_user;
}
void OAICreatePullRequestApprovalRuleOutput_approvalRule::setLastModifiedUser(const QString &last_modified_user) {
    m_last_modified_user = last_modified_user;
    m_last_modified_user_isSet = true;
}

bool OAICreatePullRequestApprovalRuleOutput_approvalRule::is_last_modified_user_Set() const{
    return m_last_modified_user_isSet;
}

bool OAICreatePullRequestApprovalRuleOutput_approvalRule::is_last_modified_user_Valid() const{
    return m_last_modified_user_isValid;
}

OAIApprovalRule_originApprovalRuleTemplate OAICreatePullRequestApprovalRuleOutput_approvalRule::getOriginApprovalRuleTemplate() const {
    return m_origin_approval_rule_template;
}
void OAICreatePullRequestApprovalRuleOutput_approvalRule::setOriginApprovalRuleTemplate(const OAIApprovalRule_originApprovalRuleTemplate &origin_approval_rule_template) {
    m_origin_approval_rule_template = origin_approval_rule_template;
    m_origin_approval_rule_template_isSet = true;
}

bool OAICreatePullRequestApprovalRuleOutput_approvalRule::is_origin_approval_rule_template_Set() const{
    return m_origin_approval_rule_template_isSet;
}

bool OAICreatePullRequestApprovalRuleOutput_approvalRule::is_origin_approval_rule_template_Valid() const{
    return m_origin_approval_rule_template_isValid;
}

bool OAICreatePullRequestApprovalRuleOutput_approvalRule::isSet() const {
...
bool OAICreatePullRequestApprovalRuleOutput_approvalRule::isValid() const {
