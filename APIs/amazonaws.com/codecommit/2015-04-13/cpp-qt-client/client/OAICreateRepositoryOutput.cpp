...
OAICreateRepositoryOutput::OAICreateRepositoryOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRepositoryOutput::OAICreateRepositoryOutput() {
    this->initializeModel();
}

OAICreateRepositoryOutput::~OAICreateRepositoryOutput() {}

void OAICreateRepositoryOutput::initializeModel() {

    m_repository_metadata_isSet = false;
    m_repository_metadata_isValid = false;
}

void OAICreateRepositoryOutput::fromJson(QString jsonString) {
...
void OAICreateRepositoryOutput::fromJsonObject(QJsonObject json) {

    m_repository_metadata_isValid = ::OpenAPI::fromJsonValue(m_repository_metadata, json[QString("repositoryMetadata")]);
    m_repository_metadata_isSet = !json[QString("repositoryMetadata")].isNull() && m_repository_metadata_isValid;
}

QString OAICreateRepositoryOutput::asJson() const {
...
QJsonObject OAICreateRepositoryOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_repository_metadata.isSet()) {
        obj.insert(QString("repositoryMetadata"), ::OpenAPI::toJsonValue(m_repository_metadata));
    }
    return obj;
}

OAICreateRepositoryOutput_repositoryMetadata OAICreateRepositoryOutput::getRepositoryMetadata() const {
    return m_repository_metadata;
}
void OAICreateRepositoryOutput::setRepositoryMetadata(const OAICreateRepositoryOutput_repositoryMetadata &repository_metadata) {
    m_repository_metadata = repository_metadata;
    m_repository_metadata_isSet = true;
}

bool OAICreateRepositoryOutput::is_repository_metadata_Set() const{
    return m_repository_metadata_isSet;
}

bool OAICreateRepositoryOutput::is_repository_metadata_Valid() const{
    return m_repository_metadata_isValid;
}

bool OAICreateRepositoryOutput::isSet() const {
...
bool OAICreateRepositoryOutput::isValid() const {
