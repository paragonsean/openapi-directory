...
#ifndef OAIMergeHunk_base_H
#define OAIMergeHunk_base_H
...
class OAIMergeHunk_base : public OAIObject {
public:
    OAIMergeHunk_base();
    OAIMergeHunk_base(QString json);
    ~OAIMergeHunk_base() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMergeHunk_base)

#endif // OAIMergeHunk_base_H
