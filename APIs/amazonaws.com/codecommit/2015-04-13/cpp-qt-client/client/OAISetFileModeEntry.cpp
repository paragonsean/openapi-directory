...
OAISetFileModeEntry::OAISetFileModeEntry(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetFileModeEntry::OAISetFileModeEntry() {
    this->initializeModel();
}

OAISetFileModeEntry::~OAISetFileModeEntry() {}

void OAISetFileModeEntry::initializeModel() {
...
void OAISetFileModeEntry::fromJson(QString jsonString) {
...
void OAISetFileModeEntry::fromJsonObject(QJsonObject json) {
...
QString OAISetFileModeEntry::asJson() const {
...
QJsonObject OAISetFileModeEntry::asJsonObject() const {
    QJsonObject obj;
...
QString OAISetFileModeEntry::getFilePath() const {
    return m_file_path;
}
void OAISetFileModeEntry::setFilePath(const QString &file_path) {
    m_file_path = file_path;
    m_file_path_isSet = true;
}

bool OAISetFileModeEntry::is_file_path_Set() const{
    return m_file_path_isSet;
}

bool OAISetFileModeEntry::is_file_path_Valid() const{
    return m_file_path_isValid;
}

OAIFileModeTypeEnum OAISetFileModeEntry::getFileMode() const {
    return m_file_mode;
}
void OAISetFileModeEntry::setFileMode(const OAIFileModeTypeEnum &file_mode) {
    m_file_mode = file_mode;
    m_file_mode_isSet = true;
}

bool OAISetFileModeEntry::is_file_mode_Set() const{
    return m_file_mode_isSet;
}

bool OAISetFileModeEntry::is_file_mode_Valid() const{
    return m_file_mode_isValid;
}

bool OAISetFileModeEntry::isSet() const {
...
bool OAISetFileModeEntry::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_file_path_isValid && m_file_mode_isValid && true;
}
