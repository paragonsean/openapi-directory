...
#ifndef OAIMergeHunk_H
#define OAIMergeHunk_H
...
namespace OpenAPI {
class OAIMergeHunk_source;
class OAIMergeHunk_destination;
class OAIMergeHunk_base;

class OAIMergeHunk : public OAIObject {
public:
    OAIMergeHunk();
    OAIMergeHunk(QString json);
    ~OAIMergeHunk() override;
    ...
    void setIsConflict(const bool &is_conflict);
    bool is_is_conflict_Set() const;
    bool is_is_conflict_Valid() const;

    OAIMergeHunk_source getSource() const;
    void setSource(const OAIMergeHunk_source &source);
    bool is_source_Set() const;
    bool is_source_Valid() const;

    OAIMergeHunk_destination getDestination() const;
    void setDestination(const OAIMergeHunk_destination &destination);
    bool is_destination_Set() const;
    bool is_destination_Valid() const;

    OAIMergeHunk_base getBase() const;
    void setBase(const OAIMergeHunk_base &base);
...
private:
    ...
    bool m_is_conflict;
    bool m_is_conflict_isSet;
    bool m_is_conflict_isValid;

    OAIMergeHunk_source m_source;
    bool m_source_isSet;
    bool m_source_isValid;

    OAIMergeHunk_destination m_destination;
    bool m_destination_isSet;
    bool m_destination_isValid;

    OAIMergeHunk_base m_base;
    bool m_base_isSet;
    bool m_base_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIMergeHunk)

#endif // OAIMergeHunk_H
