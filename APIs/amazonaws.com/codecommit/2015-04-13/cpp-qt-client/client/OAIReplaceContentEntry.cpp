...
#include "OAIReplaceContentEntry.h"
...
OAIReplaceContentEntry::OAIReplaceContentEntry(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReplaceContentEntry::OAIReplaceContentEntry() {
    this->initializeModel();
}

OAIReplaceContentEntry::~OAIReplaceContentEntry() {}

void OAIReplaceContentEntry::initializeModel() {
...
void OAIReplaceContentEntry::fromJson(QString jsonString) {
...
void OAIReplaceContentEntry::fromJsonObject(QJsonObject json) {
    ...
    m_replacement_type_isValid = ::OpenAPI::fromJsonValue(m_replacement_type, json[QString("replacementType")]);
    m_replacement_type_isSet = !json[QString("replacementType")].isNull() && m_replacement_type_isValid;
...
QString OAIReplaceContentEntry::asJson() const {
...
QJsonObject OAIReplaceContentEntry::asJsonObject() const {
    QJsonObject obj;
    if (m_file_path_isSet) {
        obj.insert(QString("filePath"), ::OpenAPI::toJsonValue(m_file_path));
    }
    if (m_replacement_type.isSet()) {
        obj.insert(QString("replacementType"), ::OpenAPI::toJsonValue(m_replacement_type));
    }
    if (m_content_isSet) {
        obj.insert(QString("content"), ::OpenAPI::toJsonValue(m_content));
    }
    if (m_file_mode.isSet()) {
        obj.insert(QString("fileMode"), ::OpenAPI::toJsonValue(m_file_mode));
    }
    return obj;
}

QString OAIReplaceContentEntry::getFilePath() const {
    return m_file_path;
}
void OAIReplaceContentEntry::setFilePath(const QString &file_path) {
    m_file_path = file_path;
    m_file_path_isSet = true;
}

bool OAIReplaceContentEntry::is_file_path_Set() const{
    return m_file_path_isSet;
}

bool OAIReplaceContentEntry::is_file_path_Valid() const{
    return m_file_path_isValid;
}

OAIReplacementTypeEnum OAIReplaceContentEntry::getReplacementType() const {
    return m_replacement_type;
}
void OAIReplaceContentEntry::setReplacementType(const OAIReplacementTypeEnum &replacement_type) {
    m_replacement_type = replacement_type;
    m_replacement_type_isSet = true;
}

bool OAIReplaceContentEntry::is_replacement_type_Set() const{
    return m_replacement_type_isSet;
}

bool OAIReplaceContentEntry::is_replacement_type_Valid() const{
    return m_replacement_type_isValid;
}

QString OAIReplaceContentEntry::getContent() const {
    return m_content;
}
void OAIReplaceContentEntry::setContent(const QString &content) {
    m_content = content;
    m_content_isSet = true;
}

bool OAIReplaceContentEntry::is_content_Set() const{
    return m_content_isSet;
}

bool OAIReplaceContentEntry::is_content_Valid() const{
    return m_content_isValid;
}

OAIFileModeTypeEnum OAIReplaceContentEntry::getFileMode() const {
    return m_file_mode;
}
void OAIReplaceContentEntry::setFileMode(const OAIFileModeTypeEnum &file_mode) {
    m_file_mode = file_mode;
    m_file_mode_isSet = true;
}

bool OAIReplaceContentEntry::is_file_mode_Set() const{
    return m_file_mode_isSet;
}

bool OAIReplaceContentEntry::is_file_mode_Valid() const{
    return m_file_mode_isValid;
}

bool OAIReplaceContentEntry::isSet() const {
...
bool OAIReplaceContentEntry::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_file_path_isValid && m_replacement_type_isValid && true;
}
