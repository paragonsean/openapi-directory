...
#include "OAIPullRequestEvent_approvalRuleEventMetadata.h"
...
OAIPullRequestEvent_approvalRuleEventMetadata::OAIPullRequestEvent_approvalRuleEventMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPullRequestEvent_approvalRuleEventMetadata::OAIPullRequestEvent_approvalRuleEventMetadata() {
    this->initializeModel();
}

OAIPullRequestEvent_approvalRuleEventMetadata::~OAIPullRequestEvent_approvalRuleEventMetadata() {}

void OAIPullRequestEvent_approvalRuleEventMetadata::initializeModel() {
    ...
    m_approval_rule_content_isSet = false;
    m_approval_rule_content_isValid = false;
}

void OAIPullRequestEvent_approvalRuleEventMetadata::fromJson(QString jsonString) {
...
void OAIPullRequestEvent_approvalRuleEventMetadata::fromJsonObject(QJsonObject json) {
    ...
    m_approval_rule_content_isValid = ::OpenAPI::fromJsonValue(m_approval_rule_content, json[QString("approvalRuleContent")]);
    m_approval_rule_content_isSet = !json[QString("approvalRuleContent")].isNull() && m_approval_rule_content_isValid;
}

QString OAIPullRequestEvent_approvalRuleEventMetadata::asJson() const {
...
QJsonObject OAIPullRequestEvent_approvalRuleEventMetadata::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_approval_rule_content_isSet) {
        obj.insert(QString("approvalRuleContent"), ::OpenAPI::toJsonValue(m_approval_rule_content));
    }
    return obj;
}

QString OAIPullRequestEvent_approvalRuleEventMetadata::getApprovalRuleName() const {
    return m_approval_rule_name;
}
void OAIPullRequestEvent_approvalRuleEventMetadata::setApprovalRuleName(const QString &approval_rule_name) {
    m_approval_rule_name = approval_rule_name;
    m_approval_rule_name_isSet = true;
}

bool OAIPullRequestEvent_approvalRuleEventMetadata::is_approval_rule_name_Set() const{
    return m_approval_rule_name_isSet;
}

bool OAIPullRequestEvent_approvalRuleEventMetadata::is_approval_rule_name_Valid() const{
    return m_approval_rule_name_isValid;
}

QString OAIPullRequestEvent_approvalRuleEventMetadata::getApprovalRuleId() const {
    return m_approval_rule_id;
}
void OAIPullRequestEvent_approvalRuleEventMetadata::setApprovalRuleId(const QString &approval_rule_id) {
    m_approval_rule_id = approval_rule_id;
    m_approval_rule_id_isSet = true;
}

bool OAIPullRequestEvent_approvalRuleEventMetadata::is_approval_rule_id_Set() const{
    return m_approval_rule_id_isSet;
}

bool OAIPullRequestEvent_approvalRuleEventMetadata::is_approval_rule_id_Valid() const{
    return m_approval_rule_id_isValid;
}

QString OAIPullRequestEvent_approvalRuleEventMetadata::getApprovalRuleContent() const {
    return m_approval_rule_content;
}
void OAIPullRequestEvent_approvalRuleEventMetadata::setApprovalRuleContent(const QString &approval_rule_content) {
    m_approval_rule_content = approval_rule_content;
    m_approval_rule_content_isSet = true;
}

bool OAIPullRequestEvent_approvalRuleEventMetadata::is_approval_rule_content_Set() const{
    return m_approval_rule_content_isSet;
}

bool OAIPullRequestEvent_approvalRuleEventMetadata::is_approval_rule_content_Valid() const{
    return m_approval_rule_content_isValid;
}

bool OAIPullRequestEvent_approvalRuleEventMetadata::isSet() const {
...
bool OAIPullRequestEvent_approvalRuleEventMetadata::isValid() const {
