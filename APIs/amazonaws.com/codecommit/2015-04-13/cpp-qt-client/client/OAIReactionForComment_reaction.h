...
/*
 * OAIReactionForComment_reaction.h
 *
 * 
 */

#ifndef OAIReactionForComment_reaction_H
#define OAIReactionForComment_reaction_H
...
class OAIReactionForComment_reaction : public OAIObject {
public:
    OAIReactionForComment_reaction();
    OAIReactionForComment_reaction(QString json);
    ~OAIReactionForComment_reaction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReactionForComment_reaction)

#endif // OAIReactionForComment_reaction_H
