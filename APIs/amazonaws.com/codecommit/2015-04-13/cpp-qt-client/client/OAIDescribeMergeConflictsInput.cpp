...
OAIDescribeMergeConflictsInput::OAIDescribeMergeConflictsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeMergeConflictsInput::OAIDescribeMergeConflictsInput() {
    this->initializeModel();
}

OAIDescribeMergeConflictsInput::~OAIDescribeMergeConflictsInput() {}

void OAIDescribeMergeConflictsInput::initializeModel() {

    m_repository_name_isSet = false;
    m_repository_name_isValid = false;

    m_destination_commit_specifier_isSet = false;
    m_destination_commit_specifier_isValid = false;

    m_source_commit_specifier_isSet = false;
    m_source_commit_specifier_isValid = false;

    m_merge_option_isSet = false;
    m_merge_option_isValid = false;

    m_max_merge_hunks_isSet = false;
    m_max_merge_hunks_isValid = false;

    m_file_path_isSet = false;
    m_file_path_isValid = false;

    m_conflict_detail_level_isSet = false;
    m_conflict_detail_level_isValid = false;

    m_conflict_resolution_strategy_isSet = false;
    m_conflict_resolution_strategy_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIDescribeMergeConflictsInput::fromJson(QString jsonString) {
...
void OAIDescribeMergeConflictsInput::fromJsonObject(QJsonObject json) {
    ...
    m_destination_commit_specifier_isValid = ::OpenAPI::fromJsonValue(m_destination_commit_specifier, json[QString("destinationCommitSpecifier")]);
    m_destination_commit_specifier_isSet = !json[QString("destinationCommitSpecifier")].isNull() && m_destination_commit_specifier_isValid;

    m_source_commit_specifier_isValid = ::OpenAPI::fromJsonValue(m_source_commit_specifier, json[QString("sourceCommitSpecifier")]);
    m_source_commit_specifier_isSet = !json[QString("sourceCommitSpecifier")].isNull() && m_source_commit_specifier_isValid;
    ...
    m_max_merge_hunks_isValid = ::OpenAPI::fromJsonValue(m_max_merge_hunks, json[QString("maxMergeHunks")]);
    m_max_merge_hunks_isSet = !json[QString("maxMergeHunks")].isNull() && m_max_merge_hunks_isValid;
    ...
    m_conflict_detail_level_isValid = ::OpenAPI::fromJsonValue(m_conflict_detail_level, json[QString("conflictDetailLevel")]);
    m_conflict_detail_level_isSet = !json[QString("conflictDetailLevel")].isNull() && m_conflict_detail_level_isValid;

    m_conflict_resolution_strategy_isValid = ::OpenAPI::fromJsonValue(m_conflict_resolution_strategy, json[QString("conflictResolutionStrategy")]);
    m_conflict_resolution_strategy_isSet = !json[QString("conflictResolutionStrategy")].isNull() && m_conflict_resolution_strategy_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("nextToken")]);
    m_next_token_isSet = !json[QString("nextToken")].isNull() && m_next_token_isValid;
}

QString OAIDescribeMergeConflictsInput::asJson() const {
...
QJsonObject OAIDescribeMergeConflictsInput::asJsonObject() const {
    QJsonObject obj;
    if (m_repository_name_isSet) {
        obj.insert(QString("repositoryName"), ::OpenAPI::toJsonValue(m_repository_name));
    }
    if (m_destination_commit_specifier_isSet) {
        obj.insert(QString("destinationCommitSpecifier"), ::OpenAPI::toJsonValue(m_destination_commit_specifier));
    }
    if (m_source_commit_specifier_isSet) {
        obj.insert(QString("sourceCommitSpecifier"), ::OpenAPI::toJsonValue(m_source_commit_specifier));
    }
    if (m_merge_option.isSet()) {
        obj.insert(QString("mergeOption"), ::OpenAPI::toJsonValue(m_merge_option));
    }
    if (m_max_merge_hunks_isSet) {
        obj.insert(QString("maxMergeHunks"), ::OpenAPI::toJsonValue(m_max_merge_hunks));
    }
    if (m_file_path_isSet) {
        obj.insert(QString("filePath"), ::OpenAPI::toJsonValue(m_file_path));
    }
    if (m_conflict_detail_level.isSet()) {
        obj.insert(QString("conflictDetailLevel"), ::OpenAPI::toJsonValue(m_conflict_detail_level));
    }
    if (m_conflict_resolution_strategy.isSet()) {
        obj.insert(QString("conflictResolutionStrategy"), ::OpenAPI::toJsonValue(m_conflict_resolution_strategy));
    }
...
QString OAIDescribeMergeConflictsInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIDescribeMergeConflictsInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIDescribeMergeConflictsInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIDescribeMergeConflictsInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIDescribeMergeConflictsInput::getDestinationCommitSpecifier() const {
    return m_destination_commit_specifier;
}
void OAIDescribeMergeConflictsInput::setDestinationCommitSpecifier(const QString &destination_commit_specifier) {
    m_destination_commit_specifier = destination_commit_specifier;
    m_destination_commit_specifier_isSet = true;
}

bool OAIDescribeMergeConflictsInput::is_destination_commit_specifier_Set() const{
    return m_destination_commit_specifier_isSet;
}

bool OAIDescribeMergeConflictsInput::is_destination_commit_specifier_Valid() const{
    return m_destination_commit_specifier_isValid;
}

QString OAIDescribeMergeConflictsInput::getSourceCommitSpecifier() const {
    return m_source_commit_specifier;
}
void OAIDescribeMergeConflictsInput::setSourceCommitSpecifier(const QString &source_commit_specifier) {
    m_source_commit_specifier = source_commit_specifier;
    m_source_commit_specifier_isSet = true;
}

bool OAIDescribeMergeConflictsInput::is_source_commit_specifier_Set() const{
    return m_source_commit_specifier_isSet;
}

bool OAIDescribeMergeConflictsInput::is_source_commit_specifier_Valid() const{
    return m_source_commit_specifier_isValid;
}

OAIMergeOptionTypeEnum OAIDescribeMergeConflictsInput::getMergeOption() const {
    return m_merge_option;
}
void OAIDescribeMergeConflictsInput::setMergeOption(const OAIMergeOptionTypeEnum &merge_option) {
    m_merge_option = merge_option;
    m_merge_option_isSet = true;
}

bool OAIDescribeMergeConflictsInput::is_merge_option_Set() const{
    return m_merge_option_isSet;
}

bool OAIDescribeMergeConflictsInput::is_merge_option_Valid() const{
    return m_merge_option_isValid;
}

qint32 OAIDescribeMergeConflictsInput::getMaxMergeHunks() const {
    return m_max_merge_hunks;
}
void OAIDescribeMergeConflictsInput::setMaxMergeHunks(const qint32 &max_merge_hunks) {
    m_max_merge_hunks = max_merge_hunks;
    m_max_merge_hunks_isSet = true;
}

bool OAIDescribeMergeConflictsInput::is_max_merge_hunks_Set() const{
    return m_max_merge_hunks_isSet;
}

bool OAIDescribeMergeConflictsInput::is_max_merge_hunks_Valid() const{
    return m_max_merge_hunks_isValid;
}

QString OAIDescribeMergeConflictsInput::getFilePath() const {
    return m_file_path;
}
void OAIDescribeMergeConflictsInput::setFilePath(const QString &file_path) {
    m_file_path = file_path;
    m_file_path_isSet = true;
}

bool OAIDescribeMergeConflictsInput::is_file_path_Set() const{
    return m_file_path_isSet;
}

bool OAIDescribeMergeConflictsInput::is_file_path_Valid() const{
    return m_file_path_isValid;
}

OAIConflictDetailLevelTypeEnum OAIDescribeMergeConflictsInput::getConflictDetailLevel() const {
    return m_conflict_detail_level;
}
void OAIDescribeMergeConflictsInput::setConflictDetailLevel(const OAIConflictDetailLevelTypeEnum &conflict_detail_level) {
    m_conflict_detail_level = conflict_detail_level;
    m_conflict_detail_level_isSet = true;
}

bool OAIDescribeMergeConflictsInput::is_conflict_detail_level_Set() const{
    return m_conflict_detail_level_isSet;
}

bool OAIDescribeMergeConflictsInput::is_conflict_detail_level_Valid() const{
    return m_conflict_detail_level_isValid;
}

OAIConflictResolutionStrategyTypeEnum OAIDescribeMergeConflictsInput::getConflictResolutionStrategy() const {
    return m_conflict_resolution_strategy;
}
void OAIDescribeMergeConflictsInput::setConflictResolutionStrategy(const OAIConflictResolutionStrategyTypeEnum &conflict_resolution_strategy) {
    m_conflict_resolution_strategy = conflict_resolution_strategy;
    m_conflict_resolution_strategy_isSet = true;
}

bool OAIDescribeMergeConflictsInput::is_conflict_resolution_strategy_Set() const{
    return m_conflict_resolution_strategy_isSet;
}

bool OAIDescribeMergeConflictsInput::is_conflict_resolution_strategy_Valid() const{
    return m_conflict_resolution_strategy_isValid;
}

QString OAIDescribeMergeConflictsInput::getNextToken() const {
    return m_next_token;
}
void OAIDescribeMergeConflictsInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeMergeConflictsInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeMergeConflictsInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeMergeConflictsInput::isSet() const {
...
bool OAIDescribeMergeConflictsInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_repository_name_isValid && m_destination_commit_specifier_isValid && m_source_commit_specifier_isValid && m_merge_option_isValid && m_file_path_isValid && true;
}
