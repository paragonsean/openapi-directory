...
/*
 * OAIApprovalRuleTemplate.h
 *
 * Returns information about an approval rule template.
 */

#ifndef OAIApprovalRuleTemplate_H
#define OAIApprovalRuleTemplate_H
...
class OAIApprovalRuleTemplate : public OAIObject {
public:
    OAIApprovalRuleTemplate();
    OAIApprovalRuleTemplate(QString json);
    ~OAIApprovalRuleTemplate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApprovalRuleTemplate)

#endif // OAIApprovalRuleTemplate_H
