...
/*
 * OAIMergeBranchesBySquashInput.h
 *
 * 
 */

#ifndef OAIMergeBranchesBySquashInput_H
#define OAIMergeBranchesBySquashInput_H
...
class OAIMergeBranchesBySquashInput : public OAIObject {
public:
    OAIMergeBranchesBySquashInput();
    OAIMergeBranchesBySquashInput(QString json);
    ~OAIMergeBranchesBySquashInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMergeBranchesBySquashInput)

#endif // OAIMergeBranchesBySquashInput_H
