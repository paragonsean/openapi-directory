...
#ifndef OAISymbolicLink_H
#define OAISymbolicLink_H
...
class OAISymbolicLink : public OAIObject {
public:
    OAISymbolicLink();
    OAISymbolicLink(QString json);
    ~OAISymbolicLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISymbolicLink)

#endif // OAISymbolicLink_H
