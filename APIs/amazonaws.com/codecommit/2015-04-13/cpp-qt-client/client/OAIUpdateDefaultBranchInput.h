...
/*
 * OAIUpdateDefaultBranchInput.h
 *
 * Represents the input of an update default branch operation.
 */

#ifndef OAIUpdateDefaultBranchInput_H
#define OAIUpdateDefaultBranchInput_H
...
class OAIUpdateDefaultBranchInput : public OAIObject {
public:
    OAIUpdateDefaultBranchInput();
    OAIUpdateDefaultBranchInput(QString json);
    ~OAIUpdateDefaultBranchInput() override;
    ...
    QString getDefaultBranchName() const;
    void setDefaultBranchName(const QString &default_branch_name);
    bool is_default_branch_name_Set() const;
    bool is_default_branch_name_Valid() const;
...
private:
    ...
    QString m_default_branch_name;
    bool m_default_branch_name_isSet;
    bool m_default_branch_name_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDefaultBranchInput)

#endif // OAIUpdateDefaultBranchInput_H
