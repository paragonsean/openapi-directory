...
/*
 * OAIUpdatePullRequestDescriptionInput.h
 *
 * 
 */

#ifndef OAIUpdatePullRequestDescriptionInput_H
#define OAIUpdatePullRequestDescriptionInput_H
...
class OAIUpdatePullRequestDescriptionInput : public OAIObject {
public:
    OAIUpdatePullRequestDescriptionInput();
    OAIUpdatePullRequestDescriptionInput(QString json);
    ~OAIUpdatePullRequestDescriptionInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePullRequestDescriptionInput)

#endif // OAIUpdatePullRequestDescriptionInput_H
