...
OAIMergePullRequestBySquashInput::OAIMergePullRequestBySquashInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMergePullRequestBySquashInput::OAIMergePullRequestBySquashInput() {
    this->initializeModel();
}

OAIMergePullRequestBySquashInput::~OAIMergePullRequestBySquashInput() {}

void OAIMergePullRequestBySquashInput::initializeModel() {
...
void OAIMergePullRequestBySquashInput::fromJson(QString jsonString) {
...
void OAIMergePullRequestBySquashInput::fromJsonObject(QJsonObject json) {
...
QString OAIMergePullRequestBySquashInput::asJson() const {
...
QJsonObject OAIMergePullRequestBySquashInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIMergePullRequestBySquashInput::getPullRequestId() const {
    return m_pull_request_id;
}
void OAIMergePullRequestBySquashInput::setPullRequestId(const QString &pull_request_id) {
    m_pull_request_id = pull_request_id;
    m_pull_request_id_isSet = true;
}

bool OAIMergePullRequestBySquashInput::is_pull_request_id_Set() const{
    return m_pull_request_id_isSet;
}

bool OAIMergePullRequestBySquashInput::is_pull_request_id_Valid() const{
    return m_pull_request_id_isValid;
}

QString OAIMergePullRequestBySquashInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIMergePullRequestBySquashInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIMergePullRequestBySquashInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIMergePullRequestBySquashInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIMergePullRequestBySquashInput::getSourceCommitId() const {
    return m_source_commit_id;
}
void OAIMergePullRequestBySquashInput::setSourceCommitId(const QString &source_commit_id) {
    m_source_commit_id = source_commit_id;
    m_source_commit_id_isSet = true;
}

bool OAIMergePullRequestBySquashInput::is_source_commit_id_Set() const{
    return m_source_commit_id_isSet;
}

bool OAIMergePullRequestBySquashInput::is_source_commit_id_Valid() const{
    return m_source_commit_id_isValid;
}

OAIConflictDetailLevelTypeEnum OAIMergePullRequestBySquashInput::getConflictDetailLevel() const {
    return m_conflict_detail_level;
}
void OAIMergePullRequestBySquashInput::setConflictDetailLevel(const OAIConflictDetailLevelTypeEnum &conflict_detail_level) {
    m_conflict_detail_level = conflict_detail_level;
    m_conflict_detail_level_isSet = true;
}

bool OAIMergePullRequestBySquashInput::is_conflict_detail_level_Set() const{
    return m_conflict_detail_level_isSet;
}

bool OAIMergePullRequestBySquashInput::is_conflict_detail_level_Valid() const{
    return m_conflict_detail_level_isValid;
}

OAIConflictResolutionStrategyTypeEnum OAIMergePullRequestBySquashInput::getConflictResolutionStrategy() const {
    return m_conflict_resolution_strategy;
}
void OAIMergePullRequestBySquashInput::setConflictResolutionStrategy(const OAIConflictResolutionStrategyTypeEnum &conflict_resolution_strategy) {
    m_conflict_resolution_strategy = conflict_resolution_strategy;
    m_conflict_resolution_strategy_isSet = true;
}

bool OAIMergePullRequestBySquashInput::is_conflict_resolution_strategy_Set() const{
    return m_conflict_resolution_strategy_isSet;
}

bool OAIMergePullRequestBySquashInput::is_conflict_resolution_strategy_Valid() const{
    return m_conflict_resolution_strategy_isValid;
}

QString OAIMergePullRequestBySquashInput::getCommitMessage() const {
    return m_commit_message;
}
void OAIMergePullRequestBySquashInput::setCommitMessage(const QString &commit_message) {
    m_commit_message = commit_message;
    m_commit_message_isSet = true;
}

bool OAIMergePullRequestBySquashInput::is_commit_message_Set() const{
    return m_commit_message_isSet;
}

bool OAIMergePullRequestBySquashInput::is_commit_message_Valid() const{
    return m_commit_message_isValid;
}

QString OAIMergePullRequestBySquashInput::getAuthorName() const {
    return m_author_name;
}
void OAIMergePullRequestBySquashInput::setAuthorName(const QString &author_name) {
    m_author_name = author_name;
    m_author_name_isSet = true;
}

bool OAIMergePullRequestBySquashInput::is_author_name_Set() const{
    return m_author_name_isSet;
}

bool OAIMergePullRequestBySquashInput::is_author_name_Valid() const{
    return m_author_name_isValid;
}

QString OAIMergePullRequestBySquashInput::getEmail() const {
    return m_email;
}
void OAIMergePullRequestBySquashInput::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAIMergePullRequestBySquashInput::is_email_Set() const{
    return m_email_isSet;
}

bool OAIMergePullRequestBySquashInput::is_email_Valid() const{
    return m_email_isValid;
}

bool OAIMergePullRequestBySquashInput::getKeepEmptyFolders() const {
    return m_keep_empty_folders;
}
void OAIMergePullRequestBySquashInput::setKeepEmptyFolders(const bool &keep_empty_folders) {
    m_keep_empty_folders = keep_empty_folders;
    m_keep_empty_folders_isSet = true;
}

bool OAIMergePullRequestBySquashInput::is_keep_empty_folders_Set() const{
    return m_keep_empty_folders_isSet;
}

bool OAIMergePullRequestBySquashInput::is_keep_empty_folders_Valid() const{
    return m_keep_empty_folders_isValid;
}

OAICreateUnreferencedMergeCommitInput_conflictResolution OAIMergePullRequestBySquashInput::getConflictResolution() const {
    return m_conflict_resolution;
}
void OAIMergePullRequestBySquashInput::setConflictResolution(const OAICreateUnreferencedMergeCommitInput_conflictResolution &conflict_resolution) {
    m_conflict_resolution = conflict_resolution;
    m_conflict_resolution_isSet = true;
}

bool OAIMergePullRequestBySquashInput::is_conflict_resolution_Set() const{
    return m_conflict_resolution_isSet;
}

bool OAIMergePullRequestBySquashInput::is_conflict_resolution_Valid() const{
    return m_conflict_resolution_isValid;
}

bool OAIMergePullRequestBySquashInput::isSet() const {
...
bool OAIMergePullRequestBySquashInput::isValid() const {
