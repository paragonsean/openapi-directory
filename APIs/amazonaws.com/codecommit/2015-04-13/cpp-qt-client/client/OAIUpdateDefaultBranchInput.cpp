...
OAIUpdateDefaultBranchInput::OAIUpdateDefaultBranchInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateDefaultBranchInput::OAIUpdateDefaultBranchInput() {
    this->initializeModel();
}

OAIUpdateDefaultBranchInput::~OAIUpdateDefaultBranchInput() {}

void OAIUpdateDefaultBranchInput::initializeModel() {

    m_repository_name_isSet = false;
    m_repository_name_isValid = false;

    m_default_branch_name_isSet = false;
    m_default_branch_name_isValid = false;
}

void OAIUpdateDefaultBranchInput::fromJson(QString jsonString) {
...
void OAIUpdateDefaultBranchInput::fromJsonObject(QJsonObject json) {
    ...
    m_default_branch_name_isValid = ::OpenAPI::fromJsonValue(m_default_branch_name, json[QString("defaultBranchName")]);
    m_default_branch_name_isSet = !json[QString("defaultBranchName")].isNull() && m_default_branch_name_isValid;
}

QString OAIUpdateDefaultBranchInput::asJson() const {
...
QJsonObject OAIUpdateDefaultBranchInput::asJsonObject() const {
    QJsonObject obj;
    if (m_repository_name_isSet) {
        obj.insert(QString("repositoryName"), ::OpenAPI::toJsonValue(m_repository_name));
    }
    if (m_default_branch_name_isSet) {
        obj.insert(QString("defaultBranchName"), ::OpenAPI::toJsonValue(m_default_branch_name));
    }
    return obj;
}

QString OAIUpdateDefaultBranchInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIUpdateDefaultBranchInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIUpdateDefaultBranchInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIUpdateDefaultBranchInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIUpdateDefaultBranchInput::getDefaultBranchName() const {
    return m_default_branch_name;
}
void OAIUpdateDefaultBranchInput::setDefaultBranchName(const QString &default_branch_name) {
    m_default_branch_name = default_branch_name;
    m_default_branch_name_isSet = true;
}

bool OAIUpdateDefaultBranchInput::is_default_branch_name_Set() const{
    return m_default_branch_name_isSet;
}

bool OAIUpdateDefaultBranchInput::is_default_branch_name_Valid() const{
    return m_default_branch_name_isValid;
}

bool OAIUpdateDefaultBranchInput::isSet() const {
...
bool OAIUpdateDefaultBranchInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_repository_name_isValid && m_default_branch_name_isValid && true;
}
