...
/*
 * OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput.h
 *
 * 
 */

#ifndef OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput_H
#define OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput_H
...
class OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput : public OAIObject {
public:
    OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput();
    OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput(QString json);
    ~OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput)

#endif // OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesInput_H
