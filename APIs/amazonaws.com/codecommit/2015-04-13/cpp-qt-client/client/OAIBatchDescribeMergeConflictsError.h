...
/*
 * OAIBatchDescribeMergeConflictsError.h
 *
 * Returns information about errors in a BatchDescribeMergeConflicts operation.
 */

#ifndef OAIBatchDescribeMergeConflictsError_H
#define OAIBatchDescribeMergeConflictsError_H
...
class OAIBatchDescribeMergeConflictsError : public OAIObject {
public:
    OAIBatchDescribeMergeConflictsError();
    OAIBatchDescribeMergeConflictsError(QString json);
    ~OAIBatchDescribeMergeConflictsError() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchDescribeMergeConflictsError)

#endif // OAIBatchDescribeMergeConflictsError_H
