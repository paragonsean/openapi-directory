...
#include "OAIPostCommentForPullRequestOutput_location.h"
...
OAIPostCommentForPullRequestOutput_location::OAIPostCommentForPullRequestOutput_location(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPostCommentForPullRequestOutput_location::OAIPostCommentForPullRequestOutput_location() {
    this->initializeModel();
}

OAIPostCommentForPullRequestOutput_location::~OAIPostCommentForPullRequestOutput_location() {}

void OAIPostCommentForPullRequestOutput_location::initializeModel() {

    m_file_path_isSet = false;
    m_file_path_isValid = false;

    m_file_position_isSet = false;
    m_file_position_isValid = false;

    m_relative_file_version_isSet = false;
    m_relative_file_version_isValid = false;
}

void OAIPostCommentForPullRequestOutput_location::fromJson(QString jsonString) {
...
void OAIPostCommentForPullRequestOutput_location::fromJsonObject(QJsonObject json) {
    ...
    m_file_position_isValid = ::OpenAPI::fromJsonValue(m_file_position, json[QString("filePosition")]);
    m_file_position_isSet = !json[QString("filePosition")].isNull() && m_file_position_isValid;

    m_relative_file_version_isValid = ::OpenAPI::fromJsonValue(m_relative_file_version, json[QString("relativeFileVersion")]);
    m_relative_file_version_isSet = !json[QString("relativeFileVersion")].isNull() && m_relative_file_version_isValid;
}

QString OAIPostCommentForPullRequestOutput_location::asJson() const {
...
QJsonObject OAIPostCommentForPullRequestOutput_location::asJsonObject() const {
    QJsonObject obj;
    if (m_file_path_isSet) {
        obj.insert(QString("filePath"), ::OpenAPI::toJsonValue(m_file_path));
    }
    if (m_file_position_isSet) {
        obj.insert(QString("filePosition"), ::OpenAPI::toJsonValue(m_file_position));
    }
    if (m_relative_file_version.isSet()) {
        obj.insert(QString("relativeFileVersion"), ::OpenAPI::toJsonValue(m_relative_file_version));
    }
    return obj;
}

QString OAIPostCommentForPullRequestOutput_location::getFilePath() const {
    return m_file_path;
}
void OAIPostCommentForPullRequestOutput_location::setFilePath(const QString &file_path) {
    m_file_path = file_path;
    m_file_path_isSet = true;
}

bool OAIPostCommentForPullRequestOutput_location::is_file_path_Set() const{
    return m_file_path_isSet;
}

bool OAIPostCommentForPullRequestOutput_location::is_file_path_Valid() const{
    return m_file_path_isValid;
}

qint32 OAIPostCommentForPullRequestOutput_location::getFilePosition() const {
    return m_file_position;
}
void OAIPostCommentForPullRequestOutput_location::setFilePosition(const qint32 &file_position) {
    m_file_position = file_position;
    m_file_position_isSet = true;
}

bool OAIPostCommentForPullRequestOutput_location::is_file_position_Set() const{
    return m_file_position_isSet;
}

bool OAIPostCommentForPullRequestOutput_location::is_file_position_Valid() const{
    return m_file_position_isValid;
}

OAIRelativeFileVersionEnum OAIPostCommentForPullRequestOutput_location::getRelativeFileVersion() const {
    return m_relative_file_version;
}
void OAIPostCommentForPullRequestOutput_location::setRelativeFileVersion(const OAIRelativeFileVersionEnum &relative_file_version) {
    m_relative_file_version = relative_file_version;
    m_relative_file_version_isSet = true;
}

bool OAIPostCommentForPullRequestOutput_location::is_relative_file_version_Set() const{
    return m_relative_file_version_isSet;
}

bool OAIPostCommentForPullRequestOutput_location::is_relative_file_version_Valid() const{
    return m_relative_file_version_isValid;
}

bool OAIPostCommentForPullRequestOutput_location::isSet() const {
...
bool OAIPostCommentForPullRequestOutput_location::isValid() const {
