...
#include "OAIOriginApprovalRuleTemplate.h"
...
OAIOriginApprovalRuleTemplate::OAIOriginApprovalRuleTemplate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOriginApprovalRuleTemplate::OAIOriginApprovalRuleTemplate() {
    this->initializeModel();
}

OAIOriginApprovalRuleTemplate::~OAIOriginApprovalRuleTemplate() {}

void OAIOriginApprovalRuleTemplate::initializeModel() {
...
void OAIOriginApprovalRuleTemplate::fromJson(QString jsonString) {
...
void OAIOriginApprovalRuleTemplate::fromJsonObject(QJsonObject json) {
...
QString OAIOriginApprovalRuleTemplate::asJson() const {
...
QJsonObject OAIOriginApprovalRuleTemplate::asJsonObject() const {
    QJsonObject obj;
...
QString OAIOriginApprovalRuleTemplate::getApprovalRuleTemplateId() const {
    return m_approval_rule_template_id;
}
void OAIOriginApprovalRuleTemplate::setApprovalRuleTemplateId(const QString &approval_rule_template_id) {
    m_approval_rule_template_id = approval_rule_template_id;
    m_approval_rule_template_id_isSet = true;
}

bool OAIOriginApprovalRuleTemplate::is_approval_rule_template_id_Set() const{
    return m_approval_rule_template_id_isSet;
}

bool OAIOriginApprovalRuleTemplate::is_approval_rule_template_id_Valid() const{
    return m_approval_rule_template_id_isValid;
}

QString OAIOriginApprovalRuleTemplate::getApprovalRuleTemplateName() const {
    return m_approval_rule_template_name;
}
void OAIOriginApprovalRuleTemplate::setApprovalRuleTemplateName(const QString &approval_rule_template_name) {
    m_approval_rule_template_name = approval_rule_template_name;
    m_approval_rule_template_name_isSet = true;
}

bool OAIOriginApprovalRuleTemplate::is_approval_rule_template_name_Set() const{
    return m_approval_rule_template_name_isSet;
}

bool OAIOriginApprovalRuleTemplate::is_approval_rule_template_name_Valid() const{
    return m_approval_rule_template_name_isValid;
}

bool OAIOriginApprovalRuleTemplate::isSet() const {
...
bool OAIOriginApprovalRuleTemplate::isValid() const {
