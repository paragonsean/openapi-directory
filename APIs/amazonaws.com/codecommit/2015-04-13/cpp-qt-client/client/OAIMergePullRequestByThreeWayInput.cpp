...
OAIMergePullRequestByThreeWayInput::OAIMergePullRequestByThreeWayInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMergePullRequestByThreeWayInput::OAIMergePullRequestByThreeWayInput() {
    this->initializeModel();
}

OAIMergePullRequestByThreeWayInput::~OAIMergePullRequestByThreeWayInput() {}

void OAIMergePullRequestByThreeWayInput::initializeModel() {
...
void OAIMergePullRequestByThreeWayInput::fromJson(QString jsonString) {
...
void OAIMergePullRequestByThreeWayInput::fromJsonObject(QJsonObject json) {
...
QString OAIMergePullRequestByThreeWayInput::asJson() const {
...
QJsonObject OAIMergePullRequestByThreeWayInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIMergePullRequestByThreeWayInput::getPullRequestId() const {
    return m_pull_request_id;
}
void OAIMergePullRequestByThreeWayInput::setPullRequestId(const QString &pull_request_id) {
    m_pull_request_id = pull_request_id;
    m_pull_request_id_isSet = true;
}

bool OAIMergePullRequestByThreeWayInput::is_pull_request_id_Set() const{
    return m_pull_request_id_isSet;
}

bool OAIMergePullRequestByThreeWayInput::is_pull_request_id_Valid() const{
    return m_pull_request_id_isValid;
}

QString OAIMergePullRequestByThreeWayInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIMergePullRequestByThreeWayInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIMergePullRequestByThreeWayInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIMergePullRequestByThreeWayInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIMergePullRequestByThreeWayInput::getSourceCommitId() const {
    return m_source_commit_id;
}
void OAIMergePullRequestByThreeWayInput::setSourceCommitId(const QString &source_commit_id) {
    m_source_commit_id = source_commit_id;
    m_source_commit_id_isSet = true;
}

bool OAIMergePullRequestByThreeWayInput::is_source_commit_id_Set() const{
    return m_source_commit_id_isSet;
}

bool OAIMergePullRequestByThreeWayInput::is_source_commit_id_Valid() const{
    return m_source_commit_id_isValid;
}

OAIConflictDetailLevelTypeEnum OAIMergePullRequestByThreeWayInput::getConflictDetailLevel() const {
    return m_conflict_detail_level;
}
void OAIMergePullRequestByThreeWayInput::setConflictDetailLevel(const OAIConflictDetailLevelTypeEnum &conflict_detail_level) {
    m_conflict_detail_level = conflict_detail_level;
    m_conflict_detail_level_isSet = true;
}

bool OAIMergePullRequestByThreeWayInput::is_conflict_detail_level_Set() const{
    return m_conflict_detail_level_isSet;
}

bool OAIMergePullRequestByThreeWayInput::is_conflict_detail_level_Valid() const{
    return m_conflict_detail_level_isValid;
}

OAIConflictResolutionStrategyTypeEnum OAIMergePullRequestByThreeWayInput::getConflictResolutionStrategy() const {
    return m_conflict_resolution_strategy;
}
void OAIMergePullRequestByThreeWayInput::setConflictResolutionStrategy(const OAIConflictResolutionStrategyTypeEnum &conflict_resolution_strategy) {
    m_conflict_resolution_strategy = conflict_resolution_strategy;
    m_conflict_resolution_strategy_isSet = true;
}

bool OAIMergePullRequestByThreeWayInput::is_conflict_resolution_strategy_Set() const{
    return m_conflict_resolution_strategy_isSet;
}

bool OAIMergePullRequestByThreeWayInput::is_conflict_resolution_strategy_Valid() const{
    return m_conflict_resolution_strategy_isValid;
}

QString OAIMergePullRequestByThreeWayInput::getCommitMessage() const {
    return m_commit_message;
}
void OAIMergePullRequestByThreeWayInput::setCommitMessage(const QString &commit_message) {
    m_commit_message = commit_message;
    m_commit_message_isSet = true;
}

bool OAIMergePullRequestByThreeWayInput::is_commit_message_Set() const{
    return m_commit_message_isSet;
}

bool OAIMergePullRequestByThreeWayInput::is_commit_message_Valid() const{
    return m_commit_message_isValid;
}

QString OAIMergePullRequestByThreeWayInput::getAuthorName() const {
    return m_author_name;
}
void OAIMergePullRequestByThreeWayInput::setAuthorName(const QString &author_name) {
    m_author_name = author_name;
    m_author_name_isSet = true;
}

bool OAIMergePullRequestByThreeWayInput::is_author_name_Set() const{
    return m_author_name_isSet;
}

bool OAIMergePullRequestByThreeWayInput::is_author_name_Valid() const{
    return m_author_name_isValid;
}

QString OAIMergePullRequestByThreeWayInput::getEmail() const {
    return m_email;
}
void OAIMergePullRequestByThreeWayInput::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAIMergePullRequestByThreeWayInput::is_email_Set() const{
    return m_email_isSet;
}

bool OAIMergePullRequestByThreeWayInput::is_email_Valid() const{
    return m_email_isValid;
}

bool OAIMergePullRequestByThreeWayInput::getKeepEmptyFolders() const {
    return m_keep_empty_folders;
}
void OAIMergePullRequestByThreeWayInput::setKeepEmptyFolders(const bool &keep_empty_folders) {
    m_keep_empty_folders = keep_empty_folders;
    m_keep_empty_folders_isSet = true;
}

bool OAIMergePullRequestByThreeWayInput::is_keep_empty_folders_Set() const{
    return m_keep_empty_folders_isSet;
}

bool OAIMergePullRequestByThreeWayInput::is_keep_empty_folders_Valid() const{
    return m_keep_empty_folders_isValid;
}

OAICreateUnreferencedMergeCommitInput_conflictResolution OAIMergePullRequestByThreeWayInput::getConflictResolution() const {
    return m_conflict_resolution;
}
void OAIMergePullRequestByThreeWayInput::setConflictResolution(const OAICreateUnreferencedMergeCommitInput_conflictResolution &conflict_resolution) {
    m_conflict_resolution = conflict_resolution;
    m_conflict_resolution_isSet = true;
}

bool OAIMergePullRequestByThreeWayInput::is_conflict_resolution_Set() const{
    return m_conflict_resolution_isSet;
}

bool OAIMergePullRequestByThreeWayInput::is_conflict_resolution_Valid() const{
    return m_conflict_resolution_isValid;
}

bool OAIMergePullRequestByThreeWayInput::isSet() const {
...
bool OAIMergePullRequestByThreeWayInput::isValid() const {
