...
OAIMergeHunkDetail::OAIMergeHunkDetail(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMergeHunkDetail::OAIMergeHunkDetail() {
    this->initializeModel();
}

OAIMergeHunkDetail::~OAIMergeHunkDetail() {}

void OAIMergeHunkDetail::initializeModel() {
...
void OAIMergeHunkDetail::fromJson(QString jsonString) {
...
void OAIMergeHunkDetail::fromJsonObject(QJsonObject json) {
...
QString OAIMergeHunkDetail::asJson() const {
...
QJsonObject OAIMergeHunkDetail::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIMergeHunkDetail::getStartLine() const {
    return m_start_line;
}
void OAIMergeHunkDetail::setStartLine(const qint32 &start_line) {
    m_start_line = start_line;
    m_start_line_isSet = true;
}

bool OAIMergeHunkDetail::is_start_line_Set() const{
    return m_start_line_isSet;
}

bool OAIMergeHunkDetail::is_start_line_Valid() const{
    return m_start_line_isValid;
}

qint32 OAIMergeHunkDetail::getEndLine() const {
    return m_end_line;
}
void OAIMergeHunkDetail::setEndLine(const qint32 &end_line) {
    m_end_line = end_line;
    m_end_line_isSet = true;
}

bool OAIMergeHunkDetail::is_end_line_Set() const{
    return m_end_line_isSet;
}

bool OAIMergeHunkDetail::is_end_line_Valid() const{
    return m_end_line_isValid;
}

QString OAIMergeHunkDetail::getHunkContent() const {
    return m_hunk_content;
}
void OAIMergeHunkDetail::setHunkContent(const QString &hunk_content) {
    m_hunk_content = hunk_content;
    m_hunk_content_isSet = true;
}

bool OAIMergeHunkDetail::is_hunk_content_Set() const{
    return m_hunk_content_isSet;
}

bool OAIMergeHunkDetail::is_hunk_content_Valid() const{
    return m_hunk_content_isValid;
}

bool OAIMergeHunkDetail::isSet() const {
...
bool OAIMergeHunkDetail::isValid() const {
