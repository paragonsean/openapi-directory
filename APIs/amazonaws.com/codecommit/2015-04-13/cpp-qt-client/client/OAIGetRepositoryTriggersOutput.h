...
/*
 * OAIGetRepositoryTriggersOutput.h
 *
 * Represents the output of a get repository triggers operation.
 */

#ifndef OAIGetRepositoryTriggersOutput_H
#define OAIGetRepositoryTriggersOutput_H
...
class OAIGetRepositoryTriggersOutput : public OAIObject {
public:
    OAIGetRepositoryTriggersOutput();
    OAIGetRepositoryTriggersOutput(QString json);
    ~OAIGetRepositoryTriggersOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRepositoryTriggersOutput)

#endif // OAIGetRepositoryTriggersOutput_H
