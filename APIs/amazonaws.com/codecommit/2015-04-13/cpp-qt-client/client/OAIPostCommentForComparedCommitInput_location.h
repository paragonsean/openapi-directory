...
/*
 * OAIPostCommentForComparedCommitInput_location.h
 *
 * 
 */

#ifndef OAIPostCommentForComparedCommitInput_location_H
#define OAIPostCommentForComparedCommitInput_location_H

#include <QJsonObject>

#include "OAIRelativeFileVersionEnum.h"
#include <QString>
...
class OAIPostCommentForComparedCommitInput_location : public OAIObject {
public:
    OAIPostCommentForComparedCommitInput_location();
    OAIPostCommentForComparedCommitInput_location(QString json);
    ~OAIPostCommentForComparedCommitInput_location() override;
    ...
    qint32 getFilePosition() const;
    void setFilePosition(const qint32 &file_position);
    bool is_file_position_Set() const;
    bool is_file_position_Valid() const;

    OAIRelativeFileVersionEnum getRelativeFileVersion() const;
    void setRelativeFileVersion(const OAIRelativeFileVersionEnum &relative_file_version);
    bool is_relative_file_version_Set() const;
    bool is_relative_file_version_Valid() const;
...
private:
    ...
    qint32 m_file_position;
    bool m_file_position_isSet;
    bool m_file_position_isValid;

    OAIRelativeFileVersionEnum m_relative_file_version;
    bool m_relative_file_version_isSet;
    bool m_relative_file_version_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPostCommentForComparedCommitInput_location)

#endif // OAIPostCommentForComparedCommitInput_location_H
