...
/*
 * OAIPostCommentForComparedCommitOutput_comment.h
 *
 * 
 */

#ifndef OAIPostCommentForComparedCommitOutput_comment_H
#define OAIPostCommentForComparedCommitOutput_comment_H
...
class OAIPostCommentForComparedCommitOutput_comment : public OAIObject {
public:
    OAIPostCommentForComparedCommitOutput_comment();
    OAIPostCommentForComparedCommitOutput_comment(QString json);
    ~OAIPostCommentForComparedCommitOutput_comment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostCommentForComparedCommitOutput_comment)

#endif // OAIPostCommentForComparedCommitOutput_comment_H
