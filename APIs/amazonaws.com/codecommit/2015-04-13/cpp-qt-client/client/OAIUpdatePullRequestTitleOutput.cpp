...
OAIUpdatePullRequestTitleOutput::OAIUpdatePullRequestTitleOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePullRequestTitleOutput::OAIUpdatePullRequestTitleOutput() {
    this->initializeModel();
}

OAIUpdatePullRequestTitleOutput::~OAIUpdatePullRequestTitleOutput() {}

void OAIUpdatePullRequestTitleOutput::initializeModel() {

    m_pull_request_isSet = false;
    m_pull_request_isValid = false;
}

void OAIUpdatePullRequestTitleOutput::fromJson(QString jsonString) {
...
void OAIUpdatePullRequestTitleOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdatePullRequestTitleOutput::asJson() const {
...
QJsonObject OAIUpdatePullRequestTitleOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdatePullRequestDescriptionOutput_pullRequest OAIUpdatePullRequestTitleOutput::getPullRequest() const {
    return m_pull_request;
}
void OAIUpdatePullRequestTitleOutput::setPullRequest(const OAIUpdatePullRequestDescriptionOutput_pullRequest &pull_request) {
    m_pull_request = pull_request;
    m_pull_request_isSet = true;
}

bool OAIUpdatePullRequestTitleOutput::is_pull_request_Set() const{
    return m_pull_request_isSet;
}

bool OAIUpdatePullRequestTitleOutput::is_pull_request_Valid() const{
    return m_pull_request_isValid;
}

bool OAIUpdatePullRequestTitleOutput::isSet() const {
...
bool OAIUpdatePullRequestTitleOutput::isValid() const {
