...
OAIConflictMetadata_mergeOperations::OAIConflictMetadata_mergeOperations(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConflictMetadata_mergeOperations::OAIConflictMetadata_mergeOperations() {
    this->initializeModel();
}

OAIConflictMetadata_mergeOperations::~OAIConflictMetadata_mergeOperations() {}

void OAIConflictMetadata_mergeOperations::initializeModel() {
...
void OAIConflictMetadata_mergeOperations::fromJson(QString jsonString) {
...
void OAIConflictMetadata_mergeOperations::fromJsonObject(QJsonObject json) {
...
QString OAIConflictMetadata_mergeOperations::asJson() const {
...
QJsonObject OAIConflictMetadata_mergeOperations::asJsonObject() const {
    QJsonObject obj;
    if (m_source.isSet()) {
...
OAIChangeTypeEnum OAIConflictMetadata_mergeOperations::getSource() const {
    return m_source;
}
void OAIConflictMetadata_mergeOperations::setSource(const OAIChangeTypeEnum &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAIConflictMetadata_mergeOperations::is_source_Set() const{
    return m_source_isSet;
}

bool OAIConflictMetadata_mergeOperations::is_source_Valid() const{
    return m_source_isValid;
}

OAIChangeTypeEnum OAIConflictMetadata_mergeOperations::getDestination() const {
    return m_destination;
}
void OAIConflictMetadata_mergeOperations::setDestination(const OAIChangeTypeEnum &destination) {
    m_destination = destination;
    m_destination_isSet = true;
}

bool OAIConflictMetadata_mergeOperations::is_destination_Set() const{
    return m_destination_isSet;
}

bool OAIConflictMetadata_mergeOperations::is_destination_Valid() const{
    return m_destination_isValid;
}

bool OAIConflictMetadata_mergeOperations::isSet() const {
...
bool OAIConflictMetadata_mergeOperations::isValid() const {
