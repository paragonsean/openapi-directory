...
/*
 * OAICreatePullRequestInput.h
 *
 * 
 */

#ifndef OAICreatePullRequestInput_H
#define OAICreatePullRequestInput_H
...
class OAICreatePullRequestInput : public OAIObject {
public:
    OAICreatePullRequestInput();
    OAICreatePullRequestInput(QString json);
    ~OAICreatePullRequestInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePullRequestInput)

#endif // OAICreatePullRequestInput_H
