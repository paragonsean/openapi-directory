...
void OAIEvaluation::initializeModel() {
    ...
    m_approval_rules_satisfied_isSet = false;
    m_approval_rules_satisfied_isValid = false;

    m_approval_rules_not_satisfied_isSet = false;
    m_approval_rules_not_satisfied_isValid = false;
}
...
void OAIEvaluation::fromJsonObject(QJsonObject json) {
    ...
    m_approval_rules_satisfied_isValid = ::OpenAPI::fromJsonValue(m_approval_rules_satisfied, json[QString("approvalRulesSatisfied")]);
    m_approval_rules_satisfied_isSet = !json[QString("approvalRulesSatisfied")].isNull() && m_approval_rules_satisfied_isValid;

    m_approval_rules_not_satisfied_isValid = ::OpenAPI::fromJsonValue(m_approval_rules_not_satisfied, json[QString("approvalRulesNotSatisfied")]);
    m_approval_rules_not_satisfied_isSet = !json[QString("approvalRulesNotSatisfied")].isNull() && m_approval_rules_not_satisfied_isValid;
}
...
QJsonObject OAIEvaluation::asJsonObject() const {
    ...
    if (m_approval_rules_satisfied.isSet()) {
        obj.insert(QString("approvalRulesSatisfied"), ::OpenAPI::toJsonValue(m_approval_rules_satisfied));
    }
    if (m_approval_rules_not_satisfied.isSet()) {
        obj.insert(QString("approvalRulesNotSatisfied"), ::OpenAPI::toJsonValue(m_approval_rules_not_satisfied));
    }
    return obj;
}

bool OAIEvaluation::getApproved() const {
    return m_approved;
}
void OAIEvaluation::setApproved(const bool &approved) {
    m_approved = approved;
    m_approved_isSet = true;
}

bool OAIEvaluation::is_approved_Set() const{
    return m_approved_isSet;
}

bool OAIEvaluation::is_approved_Valid() const{
    return m_approved_isValid;
}

bool OAIEvaluation::getOverridden() const {
    return m_overridden;
}
void OAIEvaluation::setOverridden(const bool &overridden) {
    m_overridden = overridden;
    m_overridden_isSet = true;
}

bool OAIEvaluation::is_overridden_Set() const{
    return m_overridden_isSet;
}

bool OAIEvaluation::is_overridden_Valid() const{
    return m_overridden_isValid;
}

QList OAIEvaluation::getApprovalRulesSatisfied() const {
    return m_approval_rules_satisfied;
}
void OAIEvaluation::setApprovalRulesSatisfied(const QList &approval_rules_satisfied) {
    m_approval_rules_satisfied = approval_rules_satisfied;
    m_approval_rules_satisfied_isSet = true;
}

bool OAIEvaluation::is_approval_rules_satisfied_Set() const{
    return m_approval_rules_satisfied_isSet;
}

bool OAIEvaluation::is_approval_rules_satisfied_Valid() const{
    return m_approval_rules_satisfied_isValid;
}

QList OAIEvaluation::getApprovalRulesNotSatisfied() const {
    return m_approval_rules_not_satisfied;
}
void OAIEvaluation::setApprovalRulesNotSatisfied(const QList &approval_rules_not_satisfied) {
    m_approval_rules_not_satisfied = approval_rules_not_satisfied;
    m_approval_rules_not_satisfied_isSet = true;
}

bool OAIEvaluation::is_approval_rules_not_satisfied_Set() const{
    return m_approval_rules_not_satisfied_isSet;
}

bool OAIEvaluation::is_approval_rules_not_satisfied_Valid() const{
    return m_approval_rules_not_satisfied_isValid;
}
