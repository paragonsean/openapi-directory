...
/*
 * OAIGetCommentReactionsInput.h
 *
 * 
 */

#ifndef OAIGetCommentReactionsInput_H
#define OAIGetCommentReactionsInput_H
...
class OAIGetCommentReactionsInput : public OAIObject {
public:
    OAIGetCommentReactionsInput();
    OAIGetCommentReactionsInput(QString json);
    ~OAIGetCommentReactionsInput() override;
    ...
    QString getReactionUserArn() const;
    void setReactionUserArn(const QString &reaction_user_arn);
    bool is_reaction_user_arn_Set() const;
    bool is_reaction_user_arn_Valid() const;
...
private:
    ...
    QString m_reaction_user_arn;
    bool m_reaction_user_arn_isSet;
    bool m_reaction_user_arn_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCommentReactionsInput)

#endif // OAIGetCommentReactionsInput_H
