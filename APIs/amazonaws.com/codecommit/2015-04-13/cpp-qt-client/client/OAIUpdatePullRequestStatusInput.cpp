...
OAIUpdatePullRequestStatusInput::OAIUpdatePullRequestStatusInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePullRequestStatusInput::OAIUpdatePullRequestStatusInput() {
    this->initializeModel();
}

OAIUpdatePullRequestStatusInput::~OAIUpdatePullRequestStatusInput() {}

void OAIUpdatePullRequestStatusInput::initializeModel() {
...
void OAIUpdatePullRequestStatusInput::fromJson(QString jsonString) {
...
void OAIUpdatePullRequestStatusInput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdatePullRequestStatusInput::asJson() const {
...
QJsonObject OAIUpdatePullRequestStatusInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdatePullRequestStatusInput::getPullRequestId() const {
    return m_pull_request_id;
}
void OAIUpdatePullRequestStatusInput::setPullRequestId(const QString &pull_request_id) {
    m_pull_request_id = pull_request_id;
    m_pull_request_id_isSet = true;
}

bool OAIUpdatePullRequestStatusInput::is_pull_request_id_Set() const{
    return m_pull_request_id_isSet;
}

bool OAIUpdatePullRequestStatusInput::is_pull_request_id_Valid() const{
    return m_pull_request_id_isValid;
}

OAIPullRequestStatusEnum OAIUpdatePullRequestStatusInput::getPullRequestStatus() const {
    return m_pull_request_status;
}
void OAIUpdatePullRequestStatusInput::setPullRequestStatus(const OAIPullRequestStatusEnum &pull_request_status) {
    m_pull_request_status = pull_request_status;
    m_pull_request_status_isSet = true;
}

bool OAIUpdatePullRequestStatusInput::is_pull_request_status_Set() const{
    return m_pull_request_status_isSet;
}

bool OAIUpdatePullRequestStatusInput::is_pull_request_status_Valid() const{
    return m_pull_request_status_isValid;
}

bool OAIUpdatePullRequestStatusInput::isSet() const {
...
bool OAIUpdatePullRequestStatusInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_pull_request_id_isValid && m_pull_request_status_isValid && true;
}
