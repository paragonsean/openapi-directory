...
/*
 * OAIPullRequestEvent.h
 *
 * Returns information about a pull request event.
 */

#ifndef OAIPullRequestEvent_H
#define OAIPullRequestEvent_H

#include <QJsonObject>

#include "OAIPullRequestEventType.h"
#include "OAIPullRequestEvent_approvalRuleEventMetadata.h"
#include "OAIPullRequestEvent_approvalRuleOverriddenEventMetadata.h"
#include "OAIPullRequestEvent_approvalStateChangedEventMetadata.h"
#include "OAIPullRequestEvent_pullRequestCreatedEventMetadata.h"
#include "OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata.h"
#include "OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata.h"
#include "OAIPullRequestEvent_pullRequestStatusChangedEventMetadata.h"
#include <QDateTime>
#include <QString>
...
namespace OpenAPI {
class OAIPullRequestEvent_pullRequestCreatedEventMetadata;
class OAIPullRequestEvent_pullRequestStatusChangedEventMetadata;
class OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata;
class OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata;
class OAIPullRequestEvent_approvalRuleEventMetadata;
class OAIPullRequestEvent_approvalStateChangedEventMetadata;
class OAIPullRequestEvent_approvalRuleOverriddenEventMetadata;

class OAIPullRequestEvent : public OAIObject {
public:
    OAIPullRequestEvent();
    OAIPullRequestEvent(QString json);
    ~OAIPullRequestEvent() override;
    ...
    OAIPullRequestEventType getPullRequestEventType() const;
    void setPullRequestEventType(const OAIPullRequestEventType &pull_request_event_type);
    bool is_pull_request_event_type_Set() const;
    bool is_pull_request_event_type_Valid() const;

    QString getActorArn() const;
    void setActorArn(const QString &actor_arn);
    bool is_actor_arn_Set() const;
    bool is_actor_arn_Valid() const;

    OAIPullRequestEvent_pullRequestCreatedEventMetadata getPullRequestCreatedEventMetadata() const;
    void setPullRequestCreatedEventMetadata(const OAIPullRequestEvent_pullRequestCreatedEventMetadata &pull_request_created_event_metadata);
    bool is_pull_request_created_event_metadata_Set() const;
    bool is_pull_request_created_event_metadata_Valid() const;

    OAIPullRequestEvent_pullRequestStatusChangedEventMetadata getPullRequestStatusChangedEventMetadata() const;
    void setPullRequestStatusChangedEventMetadata(const OAIPullRequestEvent_pullRequestStatusChangedEventMetadata &pull_request_status_changed_event_metadata);
    bool is_pull_request_status_changed_event_metadata_Set() const;
    bool is_pull_request_status_changed_event_metadata_Valid() const;

    OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata getPullRequestSourceReferenceUpdatedEventMetadata() const;
    void setPullRequestSourceReferenceUpdatedEventMetadata(const OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata &pull_request_source_reference_updated_event_metadata);
    bool is_pull_request_source_reference_updated_event_metadata_Set() const;
    bool is_pull_request_source_reference_updated_event_metadata_Valid() const;

    OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata getPullRequestMergedStateChangedEventMetadata() const;
    void setPullRequestMergedStateChangedEventMetadata(const OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata &pull_request_merged_state_changed_event_metadata);
    bool is_pull_request_merged_state_changed_event_metadata_Set() const;
    bool is_pull_request_merged_state_changed_event_metadata_Valid() const;

    OAIPullRequestEvent_approvalRuleEventMetadata getApprovalRuleEventMetadata() const;
    void setApprovalRuleEventMetadata(const OAIPullRequestEvent_approvalRuleEventMetadata &approval_rule_event_metadata);
    bool is_approval_rule_event_metadata_Set() const;
    bool is_approval_rule_event_metadata_Valid() const;

    OAIPullRequestEvent_approvalStateChangedEventMetadata getApprovalStateChangedEventMetadata() const;
    void setApprovalStateChangedEventMetadata(const OAIPullRequestEvent_approvalStateChangedEventMetadata &approval_state_changed_event_metadata);
    bool is_approval_state_changed_event_metadata_Set() const;
    bool is_approval_state_changed_event_metadata_Valid() const;

    OAIPullRequestEvent_approvalRuleOverriddenEventMetadata getApprovalRuleOverriddenEventMetadata() const;
    void setApprovalRuleOverriddenEventMetadata(const OAIPullRequestEvent_approvalRuleOverriddenEventMetadata &approval_rule_overridden_event_metadata);
    bool is_approval_rule_overridden_event_metadata_Set() const;
    bool is_approval_rule_overridden_event_metadata_Valid() const;
...
private:
    ...
    OAIPullRequestEventType m_pull_request_event_type;
    bool m_pull_request_event_type_isSet;
    bool m_pull_request_event_type_isValid;

    QString m_actor_arn;
    bool m_actor_arn_isSet;
    bool m_actor_arn_isValid;

    OAIPullRequestEvent_pullRequestCreatedEventMetadata m_pull_request_created_event_metadata;
    bool m_pull_request_created_event_metadata_isSet;
    bool m_pull_request_created_event_metadata_isValid;

    OAIPullRequestEvent_pullRequestStatusChangedEventMetadata m_pull_request_status_changed_event_metadata;
    bool m_pull_request_status_changed_event_metadata_isSet;
    bool m_pull_request_status_changed_event_metadata_isValid;

    OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata m_pull_request_source_reference_updated_event_metadata;
    bool m_pull_request_source_reference_updated_event_metadata_isSet;
    bool m_pull_request_source_reference_updated_event_metadata_isValid;

    OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata m_pull_request_merged_state_changed_event_metadata;
    bool m_pull_request_merged_state_changed_event_metadata_isSet;
    bool m_pull_request_merged_state_changed_event_metadata_isValid;

    OAIPullRequestEvent_approvalRuleEventMetadata m_approval_rule_event_metadata;
    bool m_approval_rule_event_metadata_isSet;
    bool m_approval_rule_event_metadata_isValid;

    OAIPullRequestEvent_approvalStateChangedEventMetadata m_approval_state_changed_event_metadata;
    bool m_approval_state_changed_event_metadata_isSet;
    bool m_approval_state_changed_event_metadata_isValid;

    OAIPullRequestEvent_approvalRuleOverriddenEventMetadata m_approval_rule_overridden_event_metadata;
    bool m_approval_rule_overridden_event_metadata_isSet;
    bool m_approval_rule_overridden_event_metadata_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPullRequestEvent)

#endif // OAIPullRequestEvent_H
