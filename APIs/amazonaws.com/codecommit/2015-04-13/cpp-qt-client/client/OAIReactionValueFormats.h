...
class OAIReactionValueFormats : public OAIObject {
public:
    OAIReactionValueFormats();
    OAIReactionValueFormats(QString json);
    ~OAIReactionValueFormats() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReactionValueFormats)

#endif // OAIReactionValueFormats_H
