...
OAICreatePullRequestOutput::OAICreatePullRequestOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreatePullRequestOutput::OAICreatePullRequestOutput() {
    this->initializeModel();
}

OAICreatePullRequestOutput::~OAICreatePullRequestOutput() {}

void OAICreatePullRequestOutput::initializeModel() {

    m_pull_request_isSet = false;
    m_pull_request_isValid = false;
}

void OAICreatePullRequestOutput::fromJson(QString jsonString) {
...
void OAICreatePullRequestOutput::fromJsonObject(QJsonObject json) {
...
QString OAICreatePullRequestOutput::asJson() const {
...
QJsonObject OAICreatePullRequestOutput::asJsonObject() const {
    QJsonObject obj;
...
OAICreatePullRequestOutput_pullRequest OAICreatePullRequestOutput::getPullRequest() const {
    return m_pull_request;
}
void OAICreatePullRequestOutput::setPullRequest(const OAICreatePullRequestOutput_pullRequest &pull_request) {
    m_pull_request = pull_request;
    m_pull_request_isSet = true;
}

bool OAICreatePullRequestOutput::is_pull_request_Set() const{
    return m_pull_request_isSet;
}

bool OAICreatePullRequestOutput::is_pull_request_Valid() const{
    return m_pull_request_isValid;
}

bool OAICreatePullRequestOutput::isSet() const {
...
bool OAICreatePullRequestOutput::isValid() const {
