...
/*
 * OAICreateCommitOutput.h
 *
 * 
 */

#ifndef OAICreateCommitOutput_H
#define OAICreateCommitOutput_H
...
class OAICreateCommitOutput : public OAIObject {
public:
    OAICreateCommitOutput();
    OAICreateCommitOutput(QString json);
    ~OAICreateCommitOutput() override;
    ...
    QList getFilesAdded() const;
    void setFilesAdded(const QList &files_added);
    bool is_files_added_Set() const;
    bool is_files_added_Valid() const;

    QList getFilesUpdated() const;
    void setFilesUpdated(const QList &files_updated);
    bool is_files_updated_Set() const;
    bool is_files_updated_Valid() const;

    QList getFilesDeleted() const;
    void setFilesDeleted(const QList &files_deleted);
    bool is_files_deleted_Set() const;
    bool is_files_deleted_Valid() const;
...
private:
    ...
    QList m_files_updated;
    bool m_files_updated_isSet;
    bool m_files_updated_isValid;

    QList m_files_deleted;
    bool m_files_deleted_isSet;
    bool m_files_deleted_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateCommitOutput)

#endif // OAICreateCommitOutput_H
