...
#include "OAIApprovalRule_originApprovalRuleTemplate.h"
...
OAIApprovalRule_originApprovalRuleTemplate::OAIApprovalRule_originApprovalRuleTemplate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIApprovalRule_originApprovalRuleTemplate::OAIApprovalRule_originApprovalRuleTemplate() {
    this->initializeModel();
}

OAIApprovalRule_originApprovalRuleTemplate::~OAIApprovalRule_originApprovalRuleTemplate() {}

void OAIApprovalRule_originApprovalRuleTemplate::initializeModel() {
...
void OAIApprovalRule_originApprovalRuleTemplate::fromJson(QString jsonString) {
...
void OAIApprovalRule_originApprovalRuleTemplate::fromJsonObject(QJsonObject json) {
...
QString OAIApprovalRule_originApprovalRuleTemplate::asJson() const {
...
QJsonObject OAIApprovalRule_originApprovalRuleTemplate::asJsonObject() const {
    QJsonObject obj;
...
QString OAIApprovalRule_originApprovalRuleTemplate::getApprovalRuleTemplateId() const {
    return m_approval_rule_template_id;
}
void OAIApprovalRule_originApprovalRuleTemplate::setApprovalRuleTemplateId(const QString &approval_rule_template_id) {
    m_approval_rule_template_id = approval_rule_template_id;
    m_approval_rule_template_id_isSet = true;
}

bool OAIApprovalRule_originApprovalRuleTemplate::is_approval_rule_template_id_Set() const{
    return m_approval_rule_template_id_isSet;
}

bool OAIApprovalRule_originApprovalRuleTemplate::is_approval_rule_template_id_Valid() const{
    return m_approval_rule_template_id_isValid;
}

QString OAIApprovalRule_originApprovalRuleTemplate::getApprovalRuleTemplateName() const {
    return m_approval_rule_template_name;
}
void OAIApprovalRule_originApprovalRuleTemplate::setApprovalRuleTemplateName(const QString &approval_rule_template_name) {
    m_approval_rule_template_name = approval_rule_template_name;
    m_approval_rule_template_name_isSet = true;
}

bool OAIApprovalRule_originApprovalRuleTemplate::is_approval_rule_template_name_Set() const{
    return m_approval_rule_template_name_isSet;
}

bool OAIApprovalRule_originApprovalRuleTemplate::is_approval_rule_template_name_Valid() const{
    return m_approval_rule_template_name_isValid;
}

bool OAIApprovalRule_originApprovalRuleTemplate::isSet() const {
...
bool OAIApprovalRule_originApprovalRuleTemplate::isValid() const {
