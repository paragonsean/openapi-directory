...
QString OAIFile::getBlobId() const {
    return m_blob_id;
}
void OAIFile::setBlobId(const QString &blob_id) {
    m_blob_id = blob_id;
    m_blob_id_isSet = true;
}

bool OAIFile::is_blob_id_Set() const{
    return m_blob_id_isSet;
}

bool OAIFile::is_blob_id_Valid() const{
...
OAIFileModeTypeEnum OAIFile::getFileMode() const {
    return m_file_mode;
}
void OAIFile::setFileMode(const OAIFileModeTypeEnum &file_mode) {
    m_file_mode = file_mode;
    m_file_mode_isSet = true;
}

bool OAIFile::is_file_mode_Set() const{
    return m_file_mode_isSet;
}

bool OAIFile::is_file_mode_Valid() const{
