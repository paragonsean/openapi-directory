...
OAIBatchGetRepositoriesInput::OAIBatchGetRepositoriesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchGetRepositoriesInput::OAIBatchGetRepositoriesInput() {
    this->initializeModel();
}

OAIBatchGetRepositoriesInput::~OAIBatchGetRepositoriesInput() {}

void OAIBatchGetRepositoriesInput::initializeModel() {

    m_repository_names_isSet = false;
    m_repository_names_isValid = false;
}

void OAIBatchGetRepositoriesInput::fromJson(QString jsonString) {
...
void OAIBatchGetRepositoriesInput::fromJsonObject(QJsonObject json) {
...
QString OAIBatchGetRepositoriesInput::asJson() const {
...
QJsonObject OAIBatchGetRepositoriesInput::asJsonObject() const {
    QJsonObject obj;
...
QList OAIBatchGetRepositoriesInput::getRepositoryNames() const {
    return m_repository_names;
}
void OAIBatchGetRepositoriesInput::setRepositoryNames(const QList &repository_names) {
    m_repository_names = repository_names;
    m_repository_names_isSet = true;
}

bool OAIBatchGetRepositoriesInput::is_repository_names_Set() const{
    return m_repository_names_isSet;
}

bool OAIBatchGetRepositoriesInput::is_repository_names_Valid() const{
    return m_repository_names_isValid;
}

bool OAIBatchGetRepositoriesInput::isSet() const {
...
bool OAIBatchGetRepositoriesInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_repository_names_isValid && true;
}
