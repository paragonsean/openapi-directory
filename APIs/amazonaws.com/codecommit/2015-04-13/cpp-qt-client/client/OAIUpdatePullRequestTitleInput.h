...
/*
 * OAIUpdatePullRequestTitleInput.h
 *
 * 
 */

#ifndef OAIUpdatePullRequestTitleInput_H
#define OAIUpdatePullRequestTitleInput_H
...
class OAIUpdatePullRequestTitleInput : public OAIObject {
public:
    OAIUpdatePullRequestTitleInput();
    OAIUpdatePullRequestTitleInput(QString json);
    ~OAIUpdatePullRequestTitleInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePullRequestTitleInput)

#endif // OAIUpdatePullRequestTitleInput_H
