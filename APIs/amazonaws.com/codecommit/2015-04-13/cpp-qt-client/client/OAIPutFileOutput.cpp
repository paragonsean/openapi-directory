...
OAIPutFileOutput::OAIPutFileOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutFileOutput::OAIPutFileOutput() {
    this->initializeModel();
}

OAIPutFileOutput::~OAIPutFileOutput() {}

void OAIPutFileOutput::initializeModel() {
...
void OAIPutFileOutput::fromJson(QString jsonString) {
...
void OAIPutFileOutput::fromJsonObject(QJsonObject json) {
...
QString OAIPutFileOutput::asJson() const {
...
QJsonObject OAIPutFileOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPutFileOutput::getCommitId() const {
    return m_commit_id;
}
void OAIPutFileOutput::setCommitId(const QString &commit_id) {
    m_commit_id = commit_id;
    m_commit_id_isSet = true;
}

bool OAIPutFileOutput::is_commit_id_Set() const{
    return m_commit_id_isSet;
}

bool OAIPutFileOutput::is_commit_id_Valid() const{
    return m_commit_id_isValid;
}

QString OAIPutFileOutput::getBlobId() const {
    return m_blob_id;
}
void OAIPutFileOutput::setBlobId(const QString &blob_id) {
    m_blob_id = blob_id;
    m_blob_id_isSet = true;
}

bool OAIPutFileOutput::is_blob_id_Set() const{
    return m_blob_id_isSet;
}

bool OAIPutFileOutput::is_blob_id_Valid() const{
    return m_blob_id_isValid;
}

QString OAIPutFileOutput::getTreeId() const {
    return m_tree_id;
}
void OAIPutFileOutput::setTreeId(const QString &tree_id) {
    m_tree_id = tree_id;
    m_tree_id_isSet = true;
}

bool OAIPutFileOutput::is_tree_id_Set() const{
    return m_tree_id_isSet;
}

bool OAIPutFileOutput::is_tree_id_Valid() const{
    return m_tree_id_isValid;
}

bool OAIPutFileOutput::isSet() const {
...
bool OAIPutFileOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_commit_id_isValid && m_blob_id_isValid && m_tree_id_isValid && true;
}
