...
OAIDeleteFileEntry::OAIDeleteFileEntry(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteFileEntry::OAIDeleteFileEntry() {
    this->initializeModel();
}

OAIDeleteFileEntry::~OAIDeleteFileEntry() {}

void OAIDeleteFileEntry::initializeModel() {

    m_file_path_isSet = false;
    m_file_path_isValid = false;
}

void OAIDeleteFileEntry::fromJson(QString jsonString) {
...
void OAIDeleteFileEntry::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteFileEntry::asJson() const {
...
QJsonObject OAIDeleteFileEntry::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteFileEntry::getFilePath() const {
    return m_file_path;
}
void OAIDeleteFileEntry::setFilePath(const QString &file_path) {
    m_file_path = file_path;
    m_file_path_isSet = true;
}

bool OAIDeleteFileEntry::is_file_path_Set() const{
    return m_file_path_isSet;
}

bool OAIDeleteFileEntry::is_file_path_Valid() const{
    return m_file_path_isValid;
}

bool OAIDeleteFileEntry::isSet() const {
...
bool OAIDeleteFileEntry::isValid() const {
