...
OAIListBranchesOutput::OAIListBranchesOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListBranchesOutput::OAIListBranchesOutput() {
    this->initializeModel();
}

OAIListBranchesOutput::~OAIListBranchesOutput() {}

void OAIListBranchesOutput::initializeModel() {
...
void OAIListBranchesOutput::fromJson(QString jsonString) {
...
void OAIListBranchesOutput::fromJsonObject(QJsonObject json) {
...
QString OAIListBranchesOutput::asJson() const {
...
QJsonObject OAIListBranchesOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_branches.isSet()) {
...
QList OAIListBranchesOutput::getBranches() const {
    return m_branches;
}
void OAIListBranchesOutput::setBranches(const QList &branches) {
    m_branches = branches;
    m_branches_isSet = true;
}

bool OAIListBranchesOutput::is_branches_Set() const{
    return m_branches_isSet;
}

bool OAIListBranchesOutput::is_branches_Valid() const{
    return m_branches_isValid;
}

QString OAIListBranchesOutput::getNextToken() const {
    return m_next_token;
}
void OAIListBranchesOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListBranchesOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListBranchesOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListBranchesOutput::isSet() const {
...
bool OAIListBranchesOutput::isValid() const {
