...
OAIListAssociatedApprovalRuleTemplatesForRepositoryOutput::OAIListAssociatedApprovalRuleTemplatesForRepositoryOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListAssociatedApprovalRuleTemplatesForRepositoryOutput::OAIListAssociatedApprovalRuleTemplatesForRepositoryOutput() {
    this->initializeModel();
}

OAIListAssociatedApprovalRuleTemplatesForRepositoryOutput::~OAIListAssociatedApprovalRuleTemplatesForRepositoryOutput() {}

void OAIListAssociatedApprovalRuleTemplatesForRepositoryOutput::initializeModel() {

    m_approval_rule_template_names_isSet = false;
    m_approval_rule_template_names_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIListAssociatedApprovalRuleTemplatesForRepositoryOutput::fromJson(QString jsonString) {
...
void OAIListAssociatedApprovalRuleTemplatesForRepositoryOutput::fromJsonObject(QJsonObject json) {

    m_approval_rule_template_names_isValid = ::OpenAPI::fromJsonValue(m_approval_rule_template_names, json[QString("approvalRuleTemplateNames")]);
    m_approval_rule_template_names_isSet = !json[QString("approvalRuleTemplateNames")].isNull() && m_approval_rule_template_names_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("nextToken")]);
    m_next_token_isSet = !json[QString("nextToken")].isNull() && m_next_token_isValid;
}

QString OAIListAssociatedApprovalRuleTemplatesForRepositoryOutput::asJson() const {
...
QJsonObject OAIListAssociatedApprovalRuleTemplatesForRepositoryOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_approval_rule_template_names.isSet()) {
        obj.insert(QString("approvalRuleTemplateNames"), ::OpenAPI::toJsonValue(m_approval_rule_template_names));
    }
...
QList OAIListAssociatedApprovalRuleTemplatesForRepositoryOutput::getApprovalRuleTemplateNames() const {
    return m_approval_rule_template_names;
}
void OAIListAssociatedApprovalRuleTemplatesForRepositoryOutput::setApprovalRuleTemplateNames(const QList &approval_rule_template_names) {
    m_approval_rule_template_names = approval_rule_template_names;
    m_approval_rule_template_names_isSet = true;
}

bool OAIListAssociatedApprovalRuleTemplatesForRepositoryOutput::is_approval_rule_template_names_Set() const{
    return m_approval_rule_template_names_isSet;
}

bool OAIListAssociatedApprovalRuleTemplatesForRepositoryOutput::is_approval_rule_template_names_Valid() const{
    return m_approval_rule_template_names_isValid;
}

QString OAIListAssociatedApprovalRuleTemplatesForRepositoryOutput::getNextToken() const {
    return m_next_token;
}
void OAIListAssociatedApprovalRuleTemplatesForRepositoryOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListAssociatedApprovalRuleTemplatesForRepositoryOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListAssociatedApprovalRuleTemplatesForRepositoryOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListAssociatedApprovalRuleTemplatesForRepositoryOutput::isSet() const {
...
bool OAIListAssociatedApprovalRuleTemplatesForRepositoryOutput::isValid() const {
