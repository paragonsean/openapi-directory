...
/*
 * OAIMergePullRequestBySquashInput.h
 *
 * 
 */

#ifndef OAIMergePullRequestBySquashInput_H
#define OAIMergePullRequestBySquashInput_H
...
class OAIMergePullRequestBySquashInput : public OAIObject {
public:
    OAIMergePullRequestBySquashInput();
    OAIMergePullRequestBySquashInput(QString json);
    ~OAIMergePullRequestBySquashInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMergePullRequestBySquashInput)

#endif // OAIMergePullRequestBySquashInput_H
