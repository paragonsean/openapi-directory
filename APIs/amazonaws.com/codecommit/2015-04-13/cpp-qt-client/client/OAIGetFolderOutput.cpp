...
OAIGetFolderOutput::OAIGetFolderOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetFolderOutput::OAIGetFolderOutput() {
    this->initializeModel();
}

OAIGetFolderOutput::~OAIGetFolderOutput() {}

void OAIGetFolderOutput::initializeModel() {
    ...
    m_sub_folders_isSet = false;
    m_sub_folders_isValid = false;

    m_files_isSet = false;
    m_files_isValid = false;

    m_symbolic_links_isSet = false;
    m_symbolic_links_isValid = false;

    m_sub_modules_isSet = false;
    m_sub_modules_isValid = false;
}

void OAIGetFolderOutput::fromJson(QString jsonString) {
...
void OAIGetFolderOutput::fromJsonObject(QJsonObject json) {
    ...
    m_tree_id_isValid = ::OpenAPI::fromJsonValue(m_tree_id, json[QString("treeId")]);
    m_tree_id_isSet = !json[QString("treeId")].isNull() && m_tree_id_isValid;

    m_sub_folders_isValid = ::OpenAPI::fromJsonValue(m_sub_folders, json[QString("subFolders")]);
    m_sub_folders_isSet = !json[QString("subFolders")].isNull() && m_sub_folders_isValid;

    m_files_isValid = ::OpenAPI::fromJsonValue(m_files, json[QString("files")]);
    m_files_isSet = !json[QString("files")].isNull() && m_files_isValid;

    m_symbolic_links_isValid = ::OpenAPI::fromJsonValue(m_symbolic_links, json[QString("symbolicLinks")]);
    m_symbolic_links_isSet = !json[QString("symbolicLinks")].isNull() && m_symbolic_links_isValid;

    m_sub_modules_isValid = ::OpenAPI::fromJsonValue(m_sub_modules, json[QString("subModules")]);
    m_sub_modules_isSet = !json[QString("subModules")].isNull() && m_sub_modules_isValid;
}

QString OAIGetFolderOutput::asJson() const {
...
QJsonObject OAIGetFolderOutput::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_tree_id_isSet) {
        obj.insert(QString("treeId"), ::OpenAPI::toJsonValue(m_tree_id));
    }
    if (m_sub_folders.isSet()) {
        obj.insert(QString("subFolders"), ::OpenAPI::toJsonValue(m_sub_folders));
    }
    if (m_files.isSet()) {
        obj.insert(QString("files"), ::OpenAPI::toJsonValue(m_files));
    }
    if (m_symbolic_links.isSet()) {
        obj.insert(QString("symbolicLinks"), ::OpenAPI::toJsonValue(m_symbolic_links));
    }
    if (m_sub_modules.isSet()) {
        obj.insert(QString("subModules"), ::OpenAPI::toJsonValue(m_sub_modules));
    }
    return obj;
}

QString OAIGetFolderOutput::getCommitId() const {
    return m_commit_id;
}
void OAIGetFolderOutput::setCommitId(const QString &commit_id) {
    m_commit_id = commit_id;
    m_commit_id_isSet = true;
}

bool OAIGetFolderOutput::is_commit_id_Set() const{
    return m_commit_id_isSet;
}

bool OAIGetFolderOutput::is_commit_id_Valid() const{
    return m_commit_id_isValid;
}

QString OAIGetFolderOutput::getFolderPath() const {
    return m_folder_path;
}
void OAIGetFolderOutput::setFolderPath(const QString &folder_path) {
    m_folder_path = folder_path;
    m_folder_path_isSet = true;
}

bool OAIGetFolderOutput::is_folder_path_Set() const{
    return m_folder_path_isSet;
}

bool OAIGetFolderOutput::is_folder_path_Valid() const{
    return m_folder_path_isValid;
}

QString OAIGetFolderOutput::getTreeId() const {
    return m_tree_id;
}
void OAIGetFolderOutput::setTreeId(const QString &tree_id) {
    m_tree_id = tree_id;
    m_tree_id_isSet = true;
}

bool OAIGetFolderOutput::is_tree_id_Set() const{
    return m_tree_id_isSet;
}

bool OAIGetFolderOutput::is_tree_id_Valid() const{
    return m_tree_id_isValid;
}

QList OAIGetFolderOutput::getSubFolders() const {
    return m_sub_folders;
}
void OAIGetFolderOutput::setSubFolders(const QList &sub_folders) {
    m_sub_folders = sub_folders;
    m_sub_folders_isSet = true;
}

bool OAIGetFolderOutput::is_sub_folders_Set() const{
    return m_sub_folders_isSet;
}

bool OAIGetFolderOutput::is_sub_folders_Valid() const{
    return m_sub_folders_isValid;
}

QList OAIGetFolderOutput::getFiles() const {
    return m_files;
}
void OAIGetFolderOutput::setFiles(const QList &files) {
    m_files = files;
    m_files_isSet = true;
}

bool OAIGetFolderOutput::is_files_Set() const{
    return m_files_isSet;
}

bool OAIGetFolderOutput::is_files_Valid() const{
    return m_files_isValid;
}

QList OAIGetFolderOutput::getSymbolicLinks() const {
    return m_symbolic_links;
}
void OAIGetFolderOutput::setSymbolicLinks(const QList &symbolic_links) {
    m_symbolic_links = symbolic_links;
    m_symbolic_links_isSet = true;
}

bool OAIGetFolderOutput::is_symbolic_links_Set() const{
    return m_symbolic_links_isSet;
}

bool OAIGetFolderOutput::is_symbolic_links_Valid() const{
    return m_symbolic_links_isValid;
}

QList OAIGetFolderOutput::getSubModules() const {
    return m_sub_modules;
}
void OAIGetFolderOutput::setSubModules(const QList &sub_modules) {
    m_sub_modules = sub_modules;
    m_sub_modules_isSet = true;
}

bool OAIGetFolderOutput::is_sub_modules_Set() const{
    return m_sub_modules_isSet;
}

bool OAIGetFolderOutput::is_sub_modules_Valid() const{
    return m_sub_modules_isValid;
}

bool OAIGetFolderOutput::isSet() const {
...
bool OAIGetFolderOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_commit_id_isValid && m_folder_path_isValid && true;
}
