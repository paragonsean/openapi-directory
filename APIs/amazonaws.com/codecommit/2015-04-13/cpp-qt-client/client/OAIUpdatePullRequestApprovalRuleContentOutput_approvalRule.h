...
/*
 * OAIUpdatePullRequestApprovalRuleContentOutput_approvalRule.h
 *
 * 
 */

#ifndef OAIUpdatePullRequestApprovalRuleContentOutput_approvalRule_H
#define OAIUpdatePullRequestApprovalRuleContentOutput_approvalRule_H
...
namespace OpenAPI {
class OAIApprovalRule_originApprovalRuleTemplate;

class OAIUpdatePullRequestApprovalRuleContentOutput_approvalRule : public OAIObject {
public:
    OAIUpdatePullRequestApprovalRuleContentOutput_approvalRule();
    OAIUpdatePullRequestApprovalRuleContentOutput_approvalRule(QString json);
    ~OAIUpdatePullRequestApprovalRuleContentOutput_approvalRule() override;
    ...
    OAIApprovalRule_originApprovalRuleTemplate getOriginApprovalRuleTemplate() const;
    void setOriginApprovalRuleTemplate(const OAIApprovalRule_originApprovalRuleTemplate &origin_approval_rule_template);
    bool is_origin_approval_rule_template_Set() const;
    bool is_origin_approval_rule_template_Valid() const;
...
private:
    ...
    OAIApprovalRule_originApprovalRuleTemplate m_origin_approval_rule_template;
    bool m_origin_approval_rule_template_isSet;
    bool m_origin_approval_rule_template_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePullRequestApprovalRuleContentOutput_approvalRule)

#endif // OAIUpdatePullRequestApprovalRuleContentOutput_approvalRule_H
