...
/*
 * OAIMergePullRequestByFastForwardInput.h
 *
 * 
 */

#ifndef OAIMergePullRequestByFastForwardInput_H
#define OAIMergePullRequestByFastForwardInput_H
...
class OAIMergePullRequestByFastForwardInput : public OAIObject {
public:
    OAIMergePullRequestByFastForwardInput();
    OAIMergePullRequestByFastForwardInput(QString json);
    ~OAIMergePullRequestByFastForwardInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMergePullRequestByFastForwardInput)

#endif // OAIMergePullRequestByFastForwardInput_H
