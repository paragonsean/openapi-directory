...
OAIGetCommentReactionsOutput::OAIGetCommentReactionsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetCommentReactionsOutput::OAIGetCommentReactionsOutput() {
    this->initializeModel();
}

OAIGetCommentReactionsOutput::~OAIGetCommentReactionsOutput() {}

void OAIGetCommentReactionsOutput::initializeModel() {

    m_reactions_for_comment_isSet = false;
    m_reactions_for_comment_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIGetCommentReactionsOutput::fromJson(QString jsonString) {
...
void OAIGetCommentReactionsOutput::fromJsonObject(QJsonObject json) {

    m_reactions_for_comment_isValid = ::OpenAPI::fromJsonValue(m_reactions_for_comment, json[QString("reactionsForComment")]);
    m_reactions_for_comment_isSet = !json[QString("reactionsForComment")].isNull() && m_reactions_for_comment_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("nextToken")]);
    m_next_token_isSet = !json[QString("nextToken")].isNull() && m_next_token_isValid;
}

QString OAIGetCommentReactionsOutput::asJson() const {
...
QJsonObject OAIGetCommentReactionsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_reactions_for_comment.isSet()) {
        obj.insert(QString("reactionsForComment"), ::OpenAPI::toJsonValue(m_reactions_for_comment));
    }
...
QList OAIGetCommentReactionsOutput::getReactionsForComment() const {
    return m_reactions_for_comment;
}
void OAIGetCommentReactionsOutput::setReactionsForComment(const QList &reactions_for_comment) {
    m_reactions_for_comment = reactions_for_comment;
    m_reactions_for_comment_isSet = true;
}

bool OAIGetCommentReactionsOutput::is_reactions_for_comment_Set() const{
    return m_reactions_for_comment_isSet;
}

bool OAIGetCommentReactionsOutput::is_reactions_for_comment_Valid() const{
    return m_reactions_for_comment_isValid;
}

QString OAIGetCommentReactionsOutput::getNextToken() const {
    return m_next_token;
}
void OAIGetCommentReactionsOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIGetCommentReactionsOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIGetCommentReactionsOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIGetCommentReactionsOutput::isSet() const {
...
bool OAIGetCommentReactionsOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_reactions_for_comment_isValid && true;
}
