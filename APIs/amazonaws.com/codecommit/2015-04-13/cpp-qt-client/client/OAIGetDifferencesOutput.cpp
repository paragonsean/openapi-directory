...
OAIGetDifferencesOutput::OAIGetDifferencesOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetDifferencesOutput::OAIGetDifferencesOutput() {
    this->initializeModel();
}

OAIGetDifferencesOutput::~OAIGetDifferencesOutput() {}

void OAIGetDifferencesOutput::initializeModel() {
...
void OAIGetDifferencesOutput::fromJson(QString jsonString) {
...
void OAIGetDifferencesOutput::fromJsonObject(QJsonObject json) {
...
QString OAIGetDifferencesOutput::asJson() const {
...
QJsonObject OAIGetDifferencesOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_differences.isSet()) {
...
QList OAIGetDifferencesOutput::getDifferences() const {
    return m_differences;
}
void OAIGetDifferencesOutput::setDifferences(const QList &differences) {
    m_differences = differences;
    m_differences_isSet = true;
}

bool OAIGetDifferencesOutput::is_differences_Set() const{
    return m_differences_isSet;
}

bool OAIGetDifferencesOutput::is_differences_Valid() const{
    return m_differences_isValid;
}

QString OAIGetDifferencesOutput::getNextToken() const {
    return m_next_token;
}
void OAIGetDifferencesOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIGetDifferencesOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIGetDifferencesOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIGetDifferencesOutput::isSet() const {
...
bool OAIGetDifferencesOutput::isValid() const {
