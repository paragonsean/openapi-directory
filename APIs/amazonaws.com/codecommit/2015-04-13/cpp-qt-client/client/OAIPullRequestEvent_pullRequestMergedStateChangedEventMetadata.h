...
/*
 * OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata.h
 *
 * 
 */

#ifndef OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata_H
#define OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata_H

#include <QJsonObject>

#include "OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata.h"
#include <QString>
...
namespace OpenAPI {
class OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata;

class OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata : public OAIObject {
public:
    OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata();
    OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata(QString json);
    ~OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata() override;
    ...
    QString getDestinationReference() const;
    void setDestinationReference(const QString &destination_reference);
    bool is_destination_reference_Set() const;
    bool is_destination_reference_Valid() const;

    OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata getMergeMetadata() const;
    void setMergeMetadata(const OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata &merge_metadata);
    bool is_merge_metadata_Set() const;
    bool is_merge_metadata_Valid() const;
...
private:
    ...
    QString m_destination_reference;
    bool m_destination_reference_isSet;
    bool m_destination_reference_isValid;

    OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata m_merge_metadata;
    bool m_merge_metadata_isSet;
    bool m_merge_metadata_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata)

#endif // OAIPullRequestEvent_pullRequestMergedStateChangedEventMetadata_H
