...
OAIChangeTypeEnum::OAIChangeTypeEnum(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChangeTypeEnum::OAIChangeTypeEnum() {
    this->initializeModel();
}

OAIChangeTypeEnum::~OAIChangeTypeEnum() {}

void OAIChangeTypeEnum::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIChangeTypeEnum::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIChangeTypeEnum::fromJson(QString jsonString) {
    
    if ( jsonString.compare("A", Qt::CaseInsensitive) == 0) {
        m_value = eOAIChangeTypeEnum::A;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("M", Qt::CaseInsensitive) == 0) {
        m_value = eOAIChangeTypeEnum::M;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("D", Qt::CaseInsensitive) == 0) {
        m_value = eOAIChangeTypeEnum::D;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIChangeTypeEnum::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIChangeTypeEnum::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIChangeTypeEnum::A:
            val = "A";
            break;
        case eOAIChangeTypeEnum::M:
            val = "M";
            break;
        case eOAIChangeTypeEnum::D:
            val = "D";
            break;
        default:
            break;
...
QJsonValue OAIChangeTypeEnum::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIChangeTypeEnum::eOAIChangeTypeEnum OAIChangeTypeEnum::getValue() const {
    return m_value;
}

void OAIChangeTypeEnum::setValue(const OAIChangeTypeEnum::eOAIChangeTypeEnum& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIChangeTypeEnum::isSet() const {
    
    return m_value_isSet;
}

bool OAIChangeTypeEnum::isValid() const {
