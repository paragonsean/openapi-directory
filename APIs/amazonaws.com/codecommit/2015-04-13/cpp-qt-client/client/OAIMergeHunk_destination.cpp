...
#include "OAIMergeHunk_destination.h"
...
OAIMergeHunk_destination::OAIMergeHunk_destination(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMergeHunk_destination::OAIMergeHunk_destination() {
    this->initializeModel();
}

OAIMergeHunk_destination::~OAIMergeHunk_destination() {}

void OAIMergeHunk_destination::initializeModel() {
...
void OAIMergeHunk_destination::fromJson(QString jsonString) {
...
void OAIMergeHunk_destination::fromJsonObject(QJsonObject json) {
...
QString OAIMergeHunk_destination::asJson() const {
...
QJsonObject OAIMergeHunk_destination::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIMergeHunk_destination::getStartLine() const {
    return m_start_line;
}
void OAIMergeHunk_destination::setStartLine(const qint32 &start_line) {
    m_start_line = start_line;
    m_start_line_isSet = true;
}

bool OAIMergeHunk_destination::is_start_line_Set() const{
    return m_start_line_isSet;
}

bool OAIMergeHunk_destination::is_start_line_Valid() const{
    return m_start_line_isValid;
}

qint32 OAIMergeHunk_destination::getEndLine() const {
    return m_end_line;
}
void OAIMergeHunk_destination::setEndLine(const qint32 &end_line) {
    m_end_line = end_line;
    m_end_line_isSet = true;
}

bool OAIMergeHunk_destination::is_end_line_Set() const{
    return m_end_line_isSet;
}

bool OAIMergeHunk_destination::is_end_line_Valid() const{
    return m_end_line_isValid;
}

QString OAIMergeHunk_destination::getHunkContent() const {
    return m_hunk_content;
}
void OAIMergeHunk_destination::setHunkContent(const QString &hunk_content) {
    m_hunk_content = hunk_content;
    m_hunk_content_isSet = true;
}

bool OAIMergeHunk_destination::is_hunk_content_Set() const{
    return m_hunk_content_isSet;
}

bool OAIMergeHunk_destination::is_hunk_content_Valid() const{
    return m_hunk_content_isValid;
}

bool OAIMergeHunk_destination::isSet() const {
...
bool OAIMergeHunk_destination::isValid() const {
