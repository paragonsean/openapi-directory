...
/*
 * OAIRepositoryNameIdPair.h
 *
 * Information about a repository name and ID.
 */

#ifndef OAIRepositoryNameIdPair_H
#define OAIRepositoryNameIdPair_H
...
class OAIRepositoryNameIdPair : public OAIObject {
public:
    OAIRepositoryNameIdPair();
    OAIRepositoryNameIdPair(QString json);
    ~OAIRepositoryNameIdPair() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRepositoryNameIdPair)

#endif // OAIRepositoryNameIdPair_H
