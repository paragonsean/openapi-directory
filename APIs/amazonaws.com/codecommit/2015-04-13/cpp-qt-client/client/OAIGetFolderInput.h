...
#ifndef OAIGetFolderInput_H
#define OAIGetFolderInput_H
...
class OAIGetFolderInput : public OAIObject {
public:
    OAIGetFolderInput();
    OAIGetFolderInput(QString json);
    ~OAIGetFolderInput() override;
    ...
    QString getCommitSpecifier() const;
    void setCommitSpecifier(const QString &commit_specifier);
    bool is_commit_specifier_Set() const;
    bool is_commit_specifier_Valid() const;
...
private:
    ...
    QString m_commit_specifier;
    bool m_commit_specifier_isSet;
    bool m_commit_specifier_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetFolderInput)

#endif // OAIGetFolderInput_H
