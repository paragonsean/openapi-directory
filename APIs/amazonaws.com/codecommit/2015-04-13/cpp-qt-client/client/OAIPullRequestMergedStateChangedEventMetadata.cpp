...
#include "OAIPullRequestMergedStateChangedEventMetadata.h"
...
OAIPullRequestMergedStateChangedEventMetadata::OAIPullRequestMergedStateChangedEventMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPullRequestMergedStateChangedEventMetadata::OAIPullRequestMergedStateChangedEventMetadata() {
    this->initializeModel();
}

OAIPullRequestMergedStateChangedEventMetadata::~OAIPullRequestMergedStateChangedEventMetadata() {}

void OAIPullRequestMergedStateChangedEventMetadata::initializeModel() {
...
void OAIPullRequestMergedStateChangedEventMetadata::fromJson(QString jsonString) {
...
void OAIPullRequestMergedStateChangedEventMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIPullRequestMergedStateChangedEventMetadata::asJson() const {
...
QJsonObject OAIPullRequestMergedStateChangedEventMetadata::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPullRequestMergedStateChangedEventMetadata::getRepositoryName() const {
    return m_repository_name;
}
void OAIPullRequestMergedStateChangedEventMetadata::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIPullRequestMergedStateChangedEventMetadata::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIPullRequestMergedStateChangedEventMetadata::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIPullRequestMergedStateChangedEventMetadata::getDestinationReference() const {
    return m_destination_reference;
}
void OAIPullRequestMergedStateChangedEventMetadata::setDestinationReference(const QString &destination_reference) {
    m_destination_reference = destination_reference;
    m_destination_reference_isSet = true;
}

bool OAIPullRequestMergedStateChangedEventMetadata::is_destination_reference_Set() const{
    return m_destination_reference_isSet;
}

bool OAIPullRequestMergedStateChangedEventMetadata::is_destination_reference_Valid() const{
    return m_destination_reference_isValid;
}

OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata OAIPullRequestMergedStateChangedEventMetadata::getMergeMetadata() const {
    return m_merge_metadata;
}
void OAIPullRequestMergedStateChangedEventMetadata::setMergeMetadata(const OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata &merge_metadata) {
    m_merge_metadata = merge_metadata;
    m_merge_metadata_isSet = true;
}

bool OAIPullRequestMergedStateChangedEventMetadata::is_merge_metadata_Set() const{
    return m_merge_metadata_isSet;
}

bool OAIPullRequestMergedStateChangedEventMetadata::is_merge_metadata_Valid() const{
    return m_merge_metadata_isValid;
}

bool OAIPullRequestMergedStateChangedEventMetadata::isSet() const {
...
bool OAIPullRequestMergedStateChangedEventMetadata::isValid() const {
