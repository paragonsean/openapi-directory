...
OAIGetPullRequestOverrideStateInput::OAIGetPullRequestOverrideStateInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPullRequestOverrideStateInput::OAIGetPullRequestOverrideStateInput() {
    this->initializeModel();
}

OAIGetPullRequestOverrideStateInput::~OAIGetPullRequestOverrideStateInput() {}

void OAIGetPullRequestOverrideStateInput::initializeModel() {
...
void OAIGetPullRequestOverrideStateInput::fromJson(QString jsonString) {
...
void OAIGetPullRequestOverrideStateInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetPullRequestOverrideStateInput::asJson() const {
...
QJsonObject OAIGetPullRequestOverrideStateInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetPullRequestOverrideStateInput::getPullRequestId() const {
    return m_pull_request_id;
}
void OAIGetPullRequestOverrideStateInput::setPullRequestId(const QString &pull_request_id) {
    m_pull_request_id = pull_request_id;
    m_pull_request_id_isSet = true;
}

bool OAIGetPullRequestOverrideStateInput::is_pull_request_id_Set() const{
    return m_pull_request_id_isSet;
}

bool OAIGetPullRequestOverrideStateInput::is_pull_request_id_Valid() const{
    return m_pull_request_id_isValid;
}

QString OAIGetPullRequestOverrideStateInput::getRevisionId() const {
    return m_revision_id;
}
void OAIGetPullRequestOverrideStateInput::setRevisionId(const QString &revision_id) {
    m_revision_id = revision_id;
    m_revision_id_isSet = true;
}

bool OAIGetPullRequestOverrideStateInput::is_revision_id_Set() const{
    return m_revision_id_isSet;
}

bool OAIGetPullRequestOverrideStateInput::is_revision_id_Valid() const{
    return m_revision_id_isValid;
}

bool OAIGetPullRequestOverrideStateInput::isSet() const {
...
bool OAIGetPullRequestOverrideStateInput::isValid() const {
