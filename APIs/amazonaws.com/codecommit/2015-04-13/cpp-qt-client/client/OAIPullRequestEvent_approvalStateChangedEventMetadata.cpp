...
OAIPullRequestEvent_approvalStateChangedEventMetadata::OAIPullRequestEvent_approvalStateChangedEventMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPullRequestEvent_approvalStateChangedEventMetadata::OAIPullRequestEvent_approvalStateChangedEventMetadata() {
    this->initializeModel();
}

OAIPullRequestEvent_approvalStateChangedEventMetadata::~OAIPullRequestEvent_approvalStateChangedEventMetadata() {}

void OAIPullRequestEvent_approvalStateChangedEventMetadata::initializeModel() {
...
void OAIPullRequestEvent_approvalStateChangedEventMetadata::fromJson(QString jsonString) {
...
void OAIPullRequestEvent_approvalStateChangedEventMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIPullRequestEvent_approvalStateChangedEventMetadata::asJson() const {
...
QJsonObject OAIPullRequestEvent_approvalStateChangedEventMetadata::asJsonObject() const {
    QJsonObject obj;
    if (m_revision_id_isSet) {
        obj.insert(QString("revisionId"), ::OpenAPI::toJsonValue(m_revision_id));
    }
    if (m_approval_status.isSet()) {
        obj.insert(QString("approvalStatus"), ::OpenAPI::toJsonValue(m_approval_status));
    }
    return obj;
}

QString OAIPullRequestEvent_approvalStateChangedEventMetadata::getRevisionId() const {
    return m_revision_id;
}
void OAIPullRequestEvent_approvalStateChangedEventMetadata::setRevisionId(const QString &revision_id) {
    m_revision_id = revision_id;
    m_revision_id_isSet = true;
}

bool OAIPullRequestEvent_approvalStateChangedEventMetadata::is_revision_id_Set() const{
    return m_revision_id_isSet;
}

bool OAIPullRequestEvent_approvalStateChangedEventMetadata::is_revision_id_Valid() const{
    return m_revision_id_isValid;
}

OAIApprovalState OAIPullRequestEvent_approvalStateChangedEventMetadata::getApprovalStatus() const {
    return m_approval_status;
}
void OAIPullRequestEvent_approvalStateChangedEventMetadata::setApprovalStatus(const OAIApprovalState &approval_status) {
    m_approval_status = approval_status;
    m_approval_status_isSet = true;
}

bool OAIPullRequestEvent_approvalStateChangedEventMetadata::is_approval_status_Set() const{
    return m_approval_status_isSet;
}

bool OAIPullRequestEvent_approvalStateChangedEventMetadata::is_approval_status_Valid() const{
    return m_approval_status_isValid;
}

bool OAIPullRequestEvent_approvalStateChangedEventMetadata::isSet() const {
...
bool OAIPullRequestEvent_approvalStateChangedEventMetadata::isValid() const {
