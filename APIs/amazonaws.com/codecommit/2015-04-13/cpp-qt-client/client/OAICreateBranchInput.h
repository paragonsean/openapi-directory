...
/*
 * OAICreateBranchInput.h
 *
 * Represents the input of a create branch operation.
 */

#ifndef OAICreateBranchInput_H
#define OAICreateBranchInput_H
...
class OAICreateBranchInput : public OAIObject {
public:
    OAICreateBranchInput();
    OAICreateBranchInput(QString json);
    ~OAICreateBranchInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateBranchInput)

#endif // OAICreateBranchInput_H
