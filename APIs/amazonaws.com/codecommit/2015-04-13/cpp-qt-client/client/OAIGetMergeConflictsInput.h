...
/*
 * OAIGetMergeConflictsInput.h
 *
 * 
 */

#ifndef OAIGetMergeConflictsInput_H
#define OAIGetMergeConflictsInput_H
...
class OAIGetMergeConflictsInput : public OAIObject {
public:
    OAIGetMergeConflictsInput();
    OAIGetMergeConflictsInput(QString json);
    ~OAIGetMergeConflictsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetMergeConflictsInput)

#endif // OAIGetMergeConflictsInput_H
