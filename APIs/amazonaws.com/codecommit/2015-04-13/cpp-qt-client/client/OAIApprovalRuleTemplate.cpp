...
#include "OAIApprovalRuleTemplate.h"
...
OAIApprovalRuleTemplate::OAIApprovalRuleTemplate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIApprovalRuleTemplate::OAIApprovalRuleTemplate() {
    this->initializeModel();
}

OAIApprovalRuleTemplate::~OAIApprovalRuleTemplate() {}

void OAIApprovalRuleTemplate::initializeModel() {
...
void OAIApprovalRuleTemplate::fromJson(QString jsonString) {
...
void OAIApprovalRuleTemplate::fromJsonObject(QJsonObject json) {
...
QString OAIApprovalRuleTemplate::asJson() const {
...
QJsonObject OAIApprovalRuleTemplate::asJsonObject() const {
    QJsonObject obj;
...
QString OAIApprovalRuleTemplate::getApprovalRuleTemplateId() const {
    return m_approval_rule_template_id;
}
void OAIApprovalRuleTemplate::setApprovalRuleTemplateId(const QString &approval_rule_template_id) {
    m_approval_rule_template_id = approval_rule_template_id;
    m_approval_rule_template_id_isSet = true;
}

bool OAIApprovalRuleTemplate::is_approval_rule_template_id_Set() const{
    return m_approval_rule_template_id_isSet;
}

bool OAIApprovalRuleTemplate::is_approval_rule_template_id_Valid() const{
    return m_approval_rule_template_id_isValid;
}

QString OAIApprovalRuleTemplate::getApprovalRuleTemplateName() const {
    return m_approval_rule_template_name;
}
void OAIApprovalRuleTemplate::setApprovalRuleTemplateName(const QString &approval_rule_template_name) {
    m_approval_rule_template_name = approval_rule_template_name;
    m_approval_rule_template_name_isSet = true;
}

bool OAIApprovalRuleTemplate::is_approval_rule_template_name_Set() const{
    return m_approval_rule_template_name_isSet;
}

bool OAIApprovalRuleTemplate::is_approval_rule_template_name_Valid() const{
    return m_approval_rule_template_name_isValid;
}

QString OAIApprovalRuleTemplate::getApprovalRuleTemplateDescription() const {
    return m_approval_rule_template_description;
}
void OAIApprovalRuleTemplate::setApprovalRuleTemplateDescription(const QString &approval_rule_template_description) {
    m_approval_rule_template_description = approval_rule_template_description;
    m_approval_rule_template_description_isSet = true;
}

bool OAIApprovalRuleTemplate::is_approval_rule_template_description_Set() const{
    return m_approval_rule_template_description_isSet;
}

bool OAIApprovalRuleTemplate::is_approval_rule_template_description_Valid() const{
    return m_approval_rule_template_description_isValid;
}

QString OAIApprovalRuleTemplate::getApprovalRuleTemplateContent() const {
    return m_approval_rule_template_content;
}
void OAIApprovalRuleTemplate::setApprovalRuleTemplateContent(const QString &approval_rule_template_content) {
    m_approval_rule_template_content = approval_rule_template_content;
    m_approval_rule_template_content_isSet = true;
}

bool OAIApprovalRuleTemplate::is_approval_rule_template_content_Set() const{
    return m_approval_rule_template_content_isSet;
}

bool OAIApprovalRuleTemplate::is_approval_rule_template_content_Valid() const{
    return m_approval_rule_template_content_isValid;
}

QString OAIApprovalRuleTemplate::getRuleContentSha256() const {
    return m_rule_content_sha256;
}
void OAIApprovalRuleTemplate::setRuleContentSha256(const QString &rule_content_sha256) {
    m_rule_content_sha256 = rule_content_sha256;
    m_rule_content_sha256_isSet = true;
}

bool OAIApprovalRuleTemplate::is_rule_content_sha256_Set() const{
    return m_rule_content_sha256_isSet;
}

bool OAIApprovalRuleTemplate::is_rule_content_sha256_Valid() const{
    return m_rule_content_sha256_isValid;
}

QDateTime OAIApprovalRuleTemplate::getLastModifiedDate() const {
    return m_last_modified_date;
}
void OAIApprovalRuleTemplate::setLastModifiedDate(const QDateTime &last_modified_date) {
    m_last_modified_date = last_modified_date;
    m_last_modified_date_isSet = true;
}

bool OAIApprovalRuleTemplate::is_last_modified_date_Set() const{
    return m_last_modified_date_isSet;
}

bool OAIApprovalRuleTemplate::is_last_modified_date_Valid() const{
    return m_last_modified_date_isValid;
}

QDateTime OAIApprovalRuleTemplate::getCreationDate() const {
    return m_creation_date;
}
void OAIApprovalRuleTemplate::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAIApprovalRuleTemplate::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAIApprovalRuleTemplate::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

QString OAIApprovalRuleTemplate::getLastModifiedUser() const {
    return m_last_modified_user;
}
void OAIApprovalRuleTemplate::setLastModifiedUser(const QString &last_modified_user) {
    m_last_modified_user = last_modified_user;
    m_last_modified_user_isSet = true;
}

bool OAIApprovalRuleTemplate::is_last_modified_user_Set() const{
    return m_last_modified_user_isSet;
}

bool OAIApprovalRuleTemplate::is_last_modified_user_Valid() const{
    return m_last_modified_user_isValid;
}

bool OAIApprovalRuleTemplate::isSet() const {
...
bool OAIApprovalRuleTemplate::isValid() const {
