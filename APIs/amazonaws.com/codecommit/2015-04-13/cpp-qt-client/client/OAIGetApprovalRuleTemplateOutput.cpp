...
OAIGetApprovalRuleTemplateOutput::OAIGetApprovalRuleTemplateOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetApprovalRuleTemplateOutput::OAIGetApprovalRuleTemplateOutput() {
    this->initializeModel();
}

OAIGetApprovalRuleTemplateOutput::~OAIGetApprovalRuleTemplateOutput() {}

void OAIGetApprovalRuleTemplateOutput::initializeModel() {

    m_approval_rule_template_isSet = false;
    m_approval_rule_template_isValid = false;
}

void OAIGetApprovalRuleTemplateOutput::fromJson(QString jsonString) {
...
void OAIGetApprovalRuleTemplateOutput::fromJsonObject(QJsonObject json) {

    m_approval_rule_template_isValid = ::OpenAPI::fromJsonValue(m_approval_rule_template, json[QString("approvalRuleTemplate")]);
    m_approval_rule_template_isSet = !json[QString("approvalRuleTemplate")].isNull() && m_approval_rule_template_isValid;
}

QString OAIGetApprovalRuleTemplateOutput::asJson() const {
...
QJsonObject OAIGetApprovalRuleTemplateOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_approval_rule_template.isSet()) {
        obj.insert(QString("approvalRuleTemplate"), ::OpenAPI::toJsonValue(m_approval_rule_template));
    }
    return obj;
}

OAIGetApprovalRuleTemplateOutput_approvalRuleTemplate OAIGetApprovalRuleTemplateOutput::getApprovalRuleTemplate() const {
    return m_approval_rule_template;
}
void OAIGetApprovalRuleTemplateOutput::setApprovalRuleTemplate(const OAIGetApprovalRuleTemplateOutput_approvalRuleTemplate &approval_rule_template) {
    m_approval_rule_template = approval_rule_template;
    m_approval_rule_template_isSet = true;
}

bool OAIGetApprovalRuleTemplateOutput::is_approval_rule_template_Set() const{
    return m_approval_rule_template_isSet;
}

bool OAIGetApprovalRuleTemplateOutput::is_approval_rule_template_Valid() const{
    return m_approval_rule_template_isValid;
}

bool OAIGetApprovalRuleTemplateOutput::isSet() const {
...
bool OAIGetApprovalRuleTemplateOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_approval_rule_template_isValid && true;
}
