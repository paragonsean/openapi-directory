...
OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput::OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput::OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput() {
    this->initializeModel();
}

OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput::~OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput() {}

void OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput::initializeModel() {

    m_associated_repository_names_isSet = false;
    m_associated_repository_names_isValid = false;

    m_errors_isSet = false;
    m_errors_isValid = false;
}

void OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput::fromJson(QString jsonString) {
...
void OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput::fromJsonObject(QJsonObject json) {

    m_associated_repository_names_isValid = ::OpenAPI::fromJsonValue(m_associated_repository_names, json[QString("associatedRepositoryNames")]);
    m_associated_repository_names_isSet = !json[QString("associatedRepositoryNames")].isNull() && m_associated_repository_names_isValid;

    m_errors_isValid = ::OpenAPI::fromJsonValue(m_errors, json[QString("errors")]);
    m_errors_isSet = !json[QString("errors")].isNull() && m_errors_isValid;
}

QString OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput::asJson() const {
...
QJsonObject OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_associated_repository_names.isSet()) {
        obj.insert(QString("associatedRepositoryNames"), ::OpenAPI::toJsonValue(m_associated_repository_names));
    }
    if (m_errors.isSet()) {
...
QList OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput::getAssociatedRepositoryNames() const {
    return m_associated_repository_names;
}
void OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput::setAssociatedRepositoryNames(const QList &associated_repository_names) {
    m_associated_repository_names = associated_repository_names;
    m_associated_repository_names_isSet = true;
}

bool OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput::is_associated_repository_names_Set() const{
    return m_associated_repository_names_isSet;
}

bool OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput::is_associated_repository_names_Valid() const{
    return m_associated_repository_names_isValid;
}

QList OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput::getErrors() const {
    return m_errors;
}
void OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput::setErrors(const QList &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput::is_errors_Valid() const{
    return m_errors_isValid;
}

bool OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput::isSet() const {
...
bool OAIBatchAssociateApprovalRuleTemplateWithRepositoriesOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_associated_repository_names_isValid && m_errors_isValid && true;
}
