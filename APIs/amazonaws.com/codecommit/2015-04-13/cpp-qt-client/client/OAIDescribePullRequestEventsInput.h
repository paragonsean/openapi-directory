...
/*
 * OAIDescribePullRequestEventsInput.h
 *
 * 
 */

#ifndef OAIDescribePullRequestEventsInput_H
#define OAIDescribePullRequestEventsInput_H
...
class OAIDescribePullRequestEventsInput : public OAIObject {
public:
    OAIDescribePullRequestEventsInput();
    OAIDescribePullRequestEventsInput(QString json);
    ~OAIDescribePullRequestEventsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribePullRequestEventsInput)

#endif // OAIDescribePullRequestEventsInput_H
