...
/*
 * OAIPullRequestEvent_approvalRuleOverriddenEventMetadata.h
 *
 * 
 */

#ifndef OAIPullRequestEvent_approvalRuleOverriddenEventMetadata_H
#define OAIPullRequestEvent_approvalRuleOverriddenEventMetadata_H

#include <QJsonObject>

#include "OAIOverrideStatus.h"
#include <QString>
...
class OAIPullRequestEvent_approvalRuleOverriddenEventMetadata : public OAIObject {
public:
    OAIPullRequestEvent_approvalRuleOverriddenEventMetadata();
    OAIPullRequestEvent_approvalRuleOverriddenEventMetadata(QString json);
    ~OAIPullRequestEvent_approvalRuleOverriddenEventMetadata() override;
    ...
    OAIOverrideStatus getOverrideStatus() const;
    void setOverrideStatus(const OAIOverrideStatus &override_status);
    bool is_override_status_Set() const;
    bool is_override_status_Valid() const;
...
private:
    ...
    OAIOverrideStatus m_override_status;
    bool m_override_status_isSet;
    bool m_override_status_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPullRequestEvent_approvalRuleOverriddenEventMetadata)

#endif // OAIPullRequestEvent_approvalRuleOverriddenEventMetadata_H
