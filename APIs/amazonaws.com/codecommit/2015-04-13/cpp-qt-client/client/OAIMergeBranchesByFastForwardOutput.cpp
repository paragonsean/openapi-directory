...
OAIMergeBranchesByFastForwardOutput::OAIMergeBranchesByFastForwardOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMergeBranchesByFastForwardOutput::OAIMergeBranchesByFastForwardOutput() {
    this->initializeModel();
}

OAIMergeBranchesByFastForwardOutput::~OAIMergeBranchesByFastForwardOutput() {}

void OAIMergeBranchesByFastForwardOutput::initializeModel() {
...
void OAIMergeBranchesByFastForwardOutput::fromJson(QString jsonString) {
...
void OAIMergeBranchesByFastForwardOutput::fromJsonObject(QJsonObject json) {
...
QString OAIMergeBranchesByFastForwardOutput::asJson() const {
...
QJsonObject OAIMergeBranchesByFastForwardOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIMergeBranchesByFastForwardOutput::getCommitId() const {
    return m_commit_id;
}
void OAIMergeBranchesByFastForwardOutput::setCommitId(const QString &commit_id) {
    m_commit_id = commit_id;
    m_commit_id_isSet = true;
}

bool OAIMergeBranchesByFastForwardOutput::is_commit_id_Set() const{
    return m_commit_id_isSet;
}

bool OAIMergeBranchesByFastForwardOutput::is_commit_id_Valid() const{
    return m_commit_id_isValid;
}

QString OAIMergeBranchesByFastForwardOutput::getTreeId() const {
    return m_tree_id;
}
void OAIMergeBranchesByFastForwardOutput::setTreeId(const QString &tree_id) {
    m_tree_id = tree_id;
    m_tree_id_isSet = true;
}

bool OAIMergeBranchesByFastForwardOutput::is_tree_id_Set() const{
    return m_tree_id_isSet;
}

bool OAIMergeBranchesByFastForwardOutput::is_tree_id_Valid() const{
    return m_tree_id_isValid;
}

bool OAIMergeBranchesByFastForwardOutput::isSet() const {
...
bool OAIMergeBranchesByFastForwardOutput::isValid() const {
