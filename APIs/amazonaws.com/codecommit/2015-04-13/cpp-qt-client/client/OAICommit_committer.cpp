...
OAICommit_committer::OAICommit_committer(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICommit_committer::OAICommit_committer() {
    this->initializeModel();
}

OAICommit_committer::~OAICommit_committer() {}

void OAICommit_committer::initializeModel() {
...
void OAICommit_committer::fromJson(QString jsonString) {
...
void OAICommit_committer::fromJsonObject(QJsonObject json) {
...
QString OAICommit_committer::asJson() const {
...
QJsonObject OAICommit_committer::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAICommit_committer::getName() const {
    return m_name;
}
void OAICommit_committer::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICommit_committer::is_name_Set() const{
    return m_name_isSet;
}

bool OAICommit_committer::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICommit_committer::getEmail() const {
    return m_email;
}
void OAICommit_committer::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAICommit_committer::is_email_Set() const{
    return m_email_isSet;
}

bool OAICommit_committer::is_email_Valid() const{
    return m_email_isValid;
}

QString OAICommit_committer::getDate() const {
    return m_date;
}
void OAICommit_committer::setDate(const QString &date) {
    m_date = date;
    m_date_isSet = true;
}

bool OAICommit_committer::is_date_Set() const{
    return m_date_isSet;
}

bool OAICommit_committer::is_date_Valid() const{
    return m_date_isValid;
}

bool OAICommit_committer::isSet() const {
...
bool OAICommit_committer::isValid() const {
