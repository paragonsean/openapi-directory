...
OAIUpdateRepositoryDescriptionInput::OAIUpdateRepositoryDescriptionInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateRepositoryDescriptionInput::OAIUpdateRepositoryDescriptionInput() {
    this->initializeModel();
}

OAIUpdateRepositoryDescriptionInput::~OAIUpdateRepositoryDescriptionInput() {}

void OAIUpdateRepositoryDescriptionInput::initializeModel() {
...
void OAIUpdateRepositoryDescriptionInput::fromJson(QString jsonString) {
...
void OAIUpdateRepositoryDescriptionInput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateRepositoryDescriptionInput::asJson() const {
...
QJsonObject OAIUpdateRepositoryDescriptionInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateRepositoryDescriptionInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIUpdateRepositoryDescriptionInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIUpdateRepositoryDescriptionInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIUpdateRepositoryDescriptionInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIUpdateRepositoryDescriptionInput::getRepositoryDescription() const {
    return m_repository_description;
}
void OAIUpdateRepositoryDescriptionInput::setRepositoryDescription(const QString &repository_description) {
    m_repository_description = repository_description;
    m_repository_description_isSet = true;
}

bool OAIUpdateRepositoryDescriptionInput::is_repository_description_Set() const{
    return m_repository_description_isSet;
}

bool OAIUpdateRepositoryDescriptionInput::is_repository_description_Valid() const{
    return m_repository_description_isValid;
}

bool OAIUpdateRepositoryDescriptionInput::isSet() const {
...
bool OAIUpdateRepositoryDescriptionInput::isValid() const {
