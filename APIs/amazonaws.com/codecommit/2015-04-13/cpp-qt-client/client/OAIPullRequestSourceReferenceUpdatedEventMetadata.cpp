...
#include "OAIPullRequestSourceReferenceUpdatedEventMetadata.h"
...
OAIPullRequestSourceReferenceUpdatedEventMetadata::OAIPullRequestSourceReferenceUpdatedEventMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPullRequestSourceReferenceUpdatedEventMetadata::OAIPullRequestSourceReferenceUpdatedEventMetadata() {
    this->initializeModel();
}

OAIPullRequestSourceReferenceUpdatedEventMetadata::~OAIPullRequestSourceReferenceUpdatedEventMetadata() {}

void OAIPullRequestSourceReferenceUpdatedEventMetadata::initializeModel() {
...
void OAIPullRequestSourceReferenceUpdatedEventMetadata::fromJson(QString jsonString) {
...
void OAIPullRequestSourceReferenceUpdatedEventMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIPullRequestSourceReferenceUpdatedEventMetadata::asJson() const {
...
QJsonObject OAIPullRequestSourceReferenceUpdatedEventMetadata::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPullRequestSourceReferenceUpdatedEventMetadata::getRepositoryName() const {
    return m_repository_name;
}
void OAIPullRequestSourceReferenceUpdatedEventMetadata::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIPullRequestSourceReferenceUpdatedEventMetadata::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIPullRequestSourceReferenceUpdatedEventMetadata::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIPullRequestSourceReferenceUpdatedEventMetadata::getBeforeCommitId() const {
    return m_before_commit_id;
}
void OAIPullRequestSourceReferenceUpdatedEventMetadata::setBeforeCommitId(const QString &before_commit_id) {
    m_before_commit_id = before_commit_id;
    m_before_commit_id_isSet = true;
}

bool OAIPullRequestSourceReferenceUpdatedEventMetadata::is_before_commit_id_Set() const{
    return m_before_commit_id_isSet;
}

bool OAIPullRequestSourceReferenceUpdatedEventMetadata::is_before_commit_id_Valid() const{
    return m_before_commit_id_isValid;
}

QString OAIPullRequestSourceReferenceUpdatedEventMetadata::getAfterCommitId() const {
    return m_after_commit_id;
}
void OAIPullRequestSourceReferenceUpdatedEventMetadata::setAfterCommitId(const QString &after_commit_id) {
    m_after_commit_id = after_commit_id;
    m_after_commit_id_isSet = true;
}

bool OAIPullRequestSourceReferenceUpdatedEventMetadata::is_after_commit_id_Set() const{
    return m_after_commit_id_isSet;
}

bool OAIPullRequestSourceReferenceUpdatedEventMetadata::is_after_commit_id_Valid() const{
    return m_after_commit_id_isValid;
}

QString OAIPullRequestSourceReferenceUpdatedEventMetadata::getMergeBase() const {
    return m_merge_base;
}
void OAIPullRequestSourceReferenceUpdatedEventMetadata::setMergeBase(const QString &merge_base) {
    m_merge_base = merge_base;
    m_merge_base_isSet = true;
}

bool OAIPullRequestSourceReferenceUpdatedEventMetadata::is_merge_base_Set() const{
    return m_merge_base_isSet;
}

bool OAIPullRequestSourceReferenceUpdatedEventMetadata::is_merge_base_Valid() const{
    return m_merge_base_isValid;
}

bool OAIPullRequestSourceReferenceUpdatedEventMetadata::isSet() const {
...
bool OAIPullRequestSourceReferenceUpdatedEventMetadata::isValid() const {
