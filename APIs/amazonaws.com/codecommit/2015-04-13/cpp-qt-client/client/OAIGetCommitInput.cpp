...
OAIGetCommitInput::OAIGetCommitInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetCommitInput::OAIGetCommitInput() {
    this->initializeModel();
}

OAIGetCommitInput::~OAIGetCommitInput() {}

void OAIGetCommitInput::initializeModel() {
...
void OAIGetCommitInput::fromJson(QString jsonString) {
...
void OAIGetCommitInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetCommitInput::asJson() const {
...
QJsonObject OAIGetCommitInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetCommitInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIGetCommitInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIGetCommitInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIGetCommitInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIGetCommitInput::getCommitId() const {
    return m_commit_id;
}
void OAIGetCommitInput::setCommitId(const QString &commit_id) {
    m_commit_id = commit_id;
    m_commit_id_isSet = true;
}

bool OAIGetCommitInput::is_commit_id_Set() const{
    return m_commit_id_isSet;
}

bool OAIGetCommitInput::is_commit_id_Valid() const{
    return m_commit_id_isValid;
}

bool OAIGetCommitInput::isSet() const {
...
bool OAIGetCommitInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_repository_name_isValid && m_commit_id_isValid && true;
}
