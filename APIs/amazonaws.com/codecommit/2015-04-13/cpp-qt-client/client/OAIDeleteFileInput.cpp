...
OAIDeleteFileInput::OAIDeleteFileInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteFileInput::OAIDeleteFileInput() {
    this->initializeModel();
}

OAIDeleteFileInput::~OAIDeleteFileInput() {}

void OAIDeleteFileInput::initializeModel() {
...
void OAIDeleteFileInput::fromJson(QString jsonString) {
...
void OAIDeleteFileInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteFileInput::asJson() const {
...
QJsonObject OAIDeleteFileInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteFileInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIDeleteFileInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIDeleteFileInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIDeleteFileInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIDeleteFileInput::getBranchName() const {
    return m_branch_name;
}
void OAIDeleteFileInput::setBranchName(const QString &branch_name) {
    m_branch_name = branch_name;
    m_branch_name_isSet = true;
}

bool OAIDeleteFileInput::is_branch_name_Set() const{
    return m_branch_name_isSet;
}

bool OAIDeleteFileInput::is_branch_name_Valid() const{
    return m_branch_name_isValid;
}

QString OAIDeleteFileInput::getFilePath() const {
    return m_file_path;
}
void OAIDeleteFileInput::setFilePath(const QString &file_path) {
    m_file_path = file_path;
    m_file_path_isSet = true;
}

bool OAIDeleteFileInput::is_file_path_Set() const{
    return m_file_path_isSet;
}

bool OAIDeleteFileInput::is_file_path_Valid() const{
    return m_file_path_isValid;
}

QString OAIDeleteFileInput::getParentCommitId() const {
    return m_parent_commit_id;
}
void OAIDeleteFileInput::setParentCommitId(const QString &parent_commit_id) {
    m_parent_commit_id = parent_commit_id;
    m_parent_commit_id_isSet = true;
}

bool OAIDeleteFileInput::is_parent_commit_id_Set() const{
    return m_parent_commit_id_isSet;
}

bool OAIDeleteFileInput::is_parent_commit_id_Valid() const{
    return m_parent_commit_id_isValid;
}

bool OAIDeleteFileInput::getKeepEmptyFolders() const {
    return m_keep_empty_folders;
}
void OAIDeleteFileInput::setKeepEmptyFolders(const bool &keep_empty_folders) {
    m_keep_empty_folders = keep_empty_folders;
    m_keep_empty_folders_isSet = true;
}

bool OAIDeleteFileInput::is_keep_empty_folders_Set() const{
    return m_keep_empty_folders_isSet;
}

bool OAIDeleteFileInput::is_keep_empty_folders_Valid() const{
    return m_keep_empty_folders_isValid;
}

QString OAIDeleteFileInput::getCommitMessage() const {
    return m_commit_message;
}
void OAIDeleteFileInput::setCommitMessage(const QString &commit_message) {
    m_commit_message = commit_message;
    m_commit_message_isSet = true;
}

bool OAIDeleteFileInput::is_commit_message_Set() const{
    return m_commit_message_isSet;
}

bool OAIDeleteFileInput::is_commit_message_Valid() const{
    return m_commit_message_isValid;
}

QString OAIDeleteFileInput::getName() const {
    return m_name;
}
void OAIDeleteFileInput::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDeleteFileInput::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDeleteFileInput::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIDeleteFileInput::getEmail() const {
    return m_email;
}
void OAIDeleteFileInput::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAIDeleteFileInput::is_email_Set() const{
    return m_email_isSet;
}

bool OAIDeleteFileInput::is_email_Valid() const{
    return m_email_isValid;
}

bool OAIDeleteFileInput::isSet() const {
...
bool OAIDeleteFileInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_repository_name_isValid && m_branch_name_isValid && m_file_path_isValid && m_parent_commit_id_isValid && true;
}
