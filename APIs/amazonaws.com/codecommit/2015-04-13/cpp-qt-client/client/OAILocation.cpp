...
QString OAILocation::getFilePath() const {
    return m_file_path;
}
void OAILocation::setFilePath(const QString &file_path) {
    m_file_path = file_path;
    m_file_path_isSet = true;
}

bool OAILocation::is_file_path_Set() const{
    return m_file_path_isSet;
}

bool OAILocation::is_file_path_Valid() const{
    return m_file_path_isValid;
}

qint32 OAILocation::getFilePosition() const {
    return m_file_position;
}
void OAILocation::setFilePosition(const qint32 &file_position) {
    m_file_position = file_position;
    m_file_position_isSet = true;
}

bool OAILocation::is_file_position_Set() const{
    return m_file_position_isSet;
}

bool OAILocation::is_file_position_Valid() const{
    return m_file_position_isValid;
}

OAIRelativeFileVersionEnum OAILocation::getRelativeFileVersion() const {
    return m_relative_file_version;
}
void OAILocation::setRelativeFileVersion(const OAIRelativeFileVersionEnum &relative_file_version) {
    m_relative_file_version = relative_file_version;
    m_relative_file_version_isSet = true;
}

bool OAILocation::is_relative_file_version_Set() const{
    return m_relative_file_version_isSet;
}

bool OAILocation::is_relative_file_version_Valid() const{
