...
OAIGetFolderInput::OAIGetFolderInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetFolderInput::OAIGetFolderInput() {
    this->initializeModel();
}

OAIGetFolderInput::~OAIGetFolderInput() {}

void OAIGetFolderInput::initializeModel() {
...
void OAIGetFolderInput::fromJson(QString jsonString) {
...
void OAIGetFolderInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetFolderInput::asJson() const {
...
QJsonObject OAIGetFolderInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetFolderInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIGetFolderInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIGetFolderInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIGetFolderInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIGetFolderInput::getCommitSpecifier() const {
    return m_commit_specifier;
}
void OAIGetFolderInput::setCommitSpecifier(const QString &commit_specifier) {
    m_commit_specifier = commit_specifier;
    m_commit_specifier_isSet = true;
}

bool OAIGetFolderInput::is_commit_specifier_Set() const{
    return m_commit_specifier_isSet;
}

bool OAIGetFolderInput::is_commit_specifier_Valid() const{
    return m_commit_specifier_isValid;
}

QString OAIGetFolderInput::getFolderPath() const {
    return m_folder_path;
}
void OAIGetFolderInput::setFolderPath(const QString &folder_path) {
    m_folder_path = folder_path;
    m_folder_path_isSet = true;
}

bool OAIGetFolderInput::is_folder_path_Set() const{
    return m_folder_path_isSet;
}

bool OAIGetFolderInput::is_folder_path_Valid() const{
    return m_folder_path_isValid;
}

bool OAIGetFolderInput::isSet() const {
...
bool OAIGetFolderInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_repository_name_isValid && m_folder_path_isValid && true;
}
