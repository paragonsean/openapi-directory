...
/*
 * OAIGetRepositoryOutput_repositoryMetadata.h
 *
 * 
 */

#ifndef OAIGetRepositoryOutput_repositoryMetadata_H
#define OAIGetRepositoryOutput_repositoryMetadata_H
...
class OAIGetRepositoryOutput_repositoryMetadata : public OAIObject {
public:
    OAIGetRepositoryOutput_repositoryMetadata();
    OAIGetRepositoryOutput_repositoryMetadata(QString json);
    ~OAIGetRepositoryOutput_repositoryMetadata() override;
    ...
    QString getCloneUrlHttp() const;
    void setCloneUrlHttp(const QString &clone_url_http);
    bool is_clone_url_http_Set() const;
    bool is_clone_url_http_Valid() const;

    QString getCloneUrlSsh() const;
    void setCloneUrlSsh(const QString &clone_url_ssh);
    bool is_clone_url_ssh_Set() const;
    bool is_clone_url_ssh_Valid() const;
...
private:
    ...
    QString m_clone_url_http;
    bool m_clone_url_http_isSet;
    bool m_clone_url_http_isValid;

    QString m_clone_url_ssh;
    bool m_clone_url_ssh_isSet;
    bool m_clone_url_ssh_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRepositoryOutput_repositoryMetadata)

#endif // OAIGetRepositoryOutput_repositoryMetadata_H
