...
OAIPutFileInput::OAIPutFileInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutFileInput::OAIPutFileInput() {
    this->initializeModel();
}

OAIPutFileInput::~OAIPutFileInput() {}

void OAIPutFileInput::initializeModel() {
...
void OAIPutFileInput::fromJson(QString jsonString) {
...
void OAIPutFileInput::fromJsonObject(QJsonObject json) {
...
QString OAIPutFileInput::asJson() const {
...
QJsonObject OAIPutFileInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPutFileInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIPutFileInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIPutFileInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIPutFileInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIPutFileInput::getBranchName() const {
    return m_branch_name;
}
void OAIPutFileInput::setBranchName(const QString &branch_name) {
    m_branch_name = branch_name;
    m_branch_name_isSet = true;
}

bool OAIPutFileInput::is_branch_name_Set() const{
    return m_branch_name_isSet;
}

bool OAIPutFileInput::is_branch_name_Valid() const{
    return m_branch_name_isValid;
}

QString OAIPutFileInput::getFileContent() const {
    return m_file_content;
}
void OAIPutFileInput::setFileContent(const QString &file_content) {
    m_file_content = file_content;
    m_file_content_isSet = true;
}

bool OAIPutFileInput::is_file_content_Set() const{
    return m_file_content_isSet;
}

bool OAIPutFileInput::is_file_content_Valid() const{
    return m_file_content_isValid;
}

QString OAIPutFileInput::getFilePath() const {
    return m_file_path;
}
void OAIPutFileInput::setFilePath(const QString &file_path) {
    m_file_path = file_path;
    m_file_path_isSet = true;
}

bool OAIPutFileInput::is_file_path_Set() const{
    return m_file_path_isSet;
}

bool OAIPutFileInput::is_file_path_Valid() const{
    return m_file_path_isValid;
}

OAIFileModeTypeEnum OAIPutFileInput::getFileMode() const {
    return m_file_mode;
}
void OAIPutFileInput::setFileMode(const OAIFileModeTypeEnum &file_mode) {
    m_file_mode = file_mode;
    m_file_mode_isSet = true;
}

bool OAIPutFileInput::is_file_mode_Set() const{
    return m_file_mode_isSet;
}

bool OAIPutFileInput::is_file_mode_Valid() const{
    return m_file_mode_isValid;
}

QString OAIPutFileInput::getParentCommitId() const {
    return m_parent_commit_id;
}
void OAIPutFileInput::setParentCommitId(const QString &parent_commit_id) {
    m_parent_commit_id = parent_commit_id;
    m_parent_commit_id_isSet = true;
}

bool OAIPutFileInput::is_parent_commit_id_Set() const{
    return m_parent_commit_id_isSet;
}

bool OAIPutFileInput::is_parent_commit_id_Valid() const{
    return m_parent_commit_id_isValid;
}

QString OAIPutFileInput::getCommitMessage() const {
    return m_commit_message;
}
void OAIPutFileInput::setCommitMessage(const QString &commit_message) {
    m_commit_message = commit_message;
    m_commit_message_isSet = true;
}

bool OAIPutFileInput::is_commit_message_Set() const{
    return m_commit_message_isSet;
}

bool OAIPutFileInput::is_commit_message_Valid() const{
    return m_commit_message_isValid;
}

QString OAIPutFileInput::getName() const {
    return m_name;
}
void OAIPutFileInput::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIPutFileInput::is_name_Set() const{
    return m_name_isSet;
}

bool OAIPutFileInput::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIPutFileInput::getEmail() const {
    return m_email;
}
void OAIPutFileInput::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAIPutFileInput::is_email_Set() const{
    return m_email_isSet;
}

bool OAIPutFileInput::is_email_Valid() const{
    return m_email_isValid;
}

bool OAIPutFileInput::isSet() const {
...
bool OAIPutFileInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_repository_name_isValid && m_branch_name_isValid && m_file_content_isValid && m_file_path_isValid && true;
}
