...
OAIOrderEnum::OAIOrderEnum(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrderEnum::OAIOrderEnum() {
    this->initializeModel();
}

OAIOrderEnum::~OAIOrderEnum() {}

void OAIOrderEnum::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIOrderEnum::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIOrderEnum::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ascending", Qt::CaseInsensitive) == 0) {
        m_value = eOAIOrderEnum::ASCENDING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("descending", Qt::CaseInsensitive) == 0) {
        m_value = eOAIOrderEnum::DESCENDING;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIOrderEnum::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIOrderEnum::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIOrderEnum::ASCENDING:
            val = "ascending";
            break;
        case eOAIOrderEnum::DESCENDING:
            val = "descending";
            break;
        default:
            break;
...
QJsonValue OAIOrderEnum::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIOrderEnum::eOAIOrderEnum OAIOrderEnum::getValue() const {
    return m_value;
}

void OAIOrderEnum::setValue(const OAIOrderEnum::eOAIOrderEnum& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIOrderEnum::isSet() const {
    
    return m_value_isSet;
}

bool OAIOrderEnum::isValid() const {
