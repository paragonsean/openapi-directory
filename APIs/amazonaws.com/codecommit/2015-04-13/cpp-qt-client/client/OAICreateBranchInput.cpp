...
OAICreateBranchInput::OAICreateBranchInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateBranchInput::OAICreateBranchInput() {
    this->initializeModel();
}

OAICreateBranchInput::~OAICreateBranchInput() {}

void OAICreateBranchInput::initializeModel() {
...
void OAICreateBranchInput::fromJson(QString jsonString) {
...
void OAICreateBranchInput::fromJsonObject(QJsonObject json) {
...
QString OAICreateBranchInput::asJson() const {
...
QJsonObject OAICreateBranchInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateBranchInput::getRepositoryName() const {
    return m_repository_name;
}
void OAICreateBranchInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAICreateBranchInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAICreateBranchInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAICreateBranchInput::getBranchName() const {
    return m_branch_name;
}
void OAICreateBranchInput::setBranchName(const QString &branch_name) {
    m_branch_name = branch_name;
    m_branch_name_isSet = true;
}

bool OAICreateBranchInput::is_branch_name_Set() const{
    return m_branch_name_isSet;
}

bool OAICreateBranchInput::is_branch_name_Valid() const{
    return m_branch_name_isValid;
}

QString OAICreateBranchInput::getCommitId() const {
    return m_commit_id;
}
void OAICreateBranchInput::setCommitId(const QString &commit_id) {
    m_commit_id = commit_id;
    m_commit_id_isSet = true;
}

bool OAICreateBranchInput::is_commit_id_Set() const{
    return m_commit_id_isSet;
}

bool OAICreateBranchInput::is_commit_id_Valid() const{
    return m_commit_id_isValid;
}

bool OAICreateBranchInput::isSet() const {
...
bool OAICreateBranchInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_repository_name_isValid && m_branch_name_isValid && m_commit_id_isValid && true;
}
