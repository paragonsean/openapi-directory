...
#ifndef OAIObjectTypes_H
#define OAIObjectTypes_H
...
class OAIObjectTypes : public OAIObject {
public:
    OAIObjectTypes();
    OAIObjectTypes(QString json);
    ~OAIObjectTypes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIObjectTypes)

#endif // OAIObjectTypes_H
