...
/*
 * OAIPostCommentForComparedCommitOutput.h
 *
 * 
 */

#ifndef OAIPostCommentForComparedCommitOutput_H
#define OAIPostCommentForComparedCommitOutput_H

#include <QJsonObject>

#include "OAIPostCommentForComparedCommitOutput_comment.h"
#include "OAIPostCommentForComparedCommitOutput_location.h"
#include <QString>
...
namespace OpenAPI {
class OAIPostCommentForComparedCommitOutput_location;
class OAIPostCommentForComparedCommitOutput_comment;

class OAIPostCommentForComparedCommitOutput : public OAIObject {
public:
    OAIPostCommentForComparedCommitOutput();
    OAIPostCommentForComparedCommitOutput(QString json);
    ~OAIPostCommentForComparedCommitOutput() override;
    ...
    QString getBeforeBlobId() const;
    void setBeforeBlobId(const QString &before_blob_id);
    bool is_before_blob_id_Set() const;
    bool is_before_blob_id_Valid() const;

    QString getAfterBlobId() const;
    void setAfterBlobId(const QString &after_blob_id);
    bool is_after_blob_id_Set() const;
    bool is_after_blob_id_Valid() const;

    OAIPostCommentForComparedCommitOutput_location getLocation() const;
    void setLocation(const OAIPostCommentForComparedCommitOutput_location &location);
    bool is_location_Set() const;
    bool is_location_Valid() const;

    OAIPostCommentForComparedCommitOutput_comment getComment() const;
    void setComment(const OAIPostCommentForComparedCommitOutput_comment &comment);
...
private:
    ...
    QString m_before_blob_id;
    bool m_before_blob_id_isSet;
    bool m_before_blob_id_isValid;

    QString m_after_blob_id;
    bool m_after_blob_id_isSet;
    bool m_after_blob_id_isValid;

    OAIPostCommentForComparedCommitOutput_location m_location;
    bool m_location_isSet;
    bool m_location_isValid;

    OAIPostCommentForComparedCommitOutput_comment m_comment;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostCommentForComparedCommitOutput)

#endif // OAIPostCommentForComparedCommitOutput_H
