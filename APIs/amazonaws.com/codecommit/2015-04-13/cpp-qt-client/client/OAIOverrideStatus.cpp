...
OAIOverrideStatus::OAIOverrideStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOverrideStatus::OAIOverrideStatus() {
    this->initializeModel();
}

OAIOverrideStatus::~OAIOverrideStatus() {}

void OAIOverrideStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIOverrideStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIOverrideStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("OVERRIDE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIOverrideStatus::OVERRIDE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("REVOKE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIOverrideStatus::REVOKE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIOverrideStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIOverrideStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIOverrideStatus::OVERRIDE:
            val = "OVERRIDE";
            break;
        case eOAIOverrideStatus::REVOKE:
            val = "REVOKE";
            break;
        default:
            break;
...
QJsonValue OAIOverrideStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIOverrideStatus::eOAIOverrideStatus OAIOverrideStatus::getValue() const {
    return m_value;
}

void OAIOverrideStatus::setValue(const OAIOverrideStatus::eOAIOverrideStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIOverrideStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIOverrideStatus::isValid() const {
