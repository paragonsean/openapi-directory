...
QString OAICommit::getCommitId() const {
    return m_commit_id;
}
void OAICommit::setCommitId(const QString &commit_id) {
    m_commit_id = commit_id;
    m_commit_id_isSet = true;
}

bool OAICommit::is_commit_id_Set() const{
    return m_commit_id_isSet;
}

bool OAICommit::is_commit_id_Valid() const{
    return m_commit_id_isValid;
}

QString OAICommit::getTreeId() const {
    return m_tree_id;
}
void OAICommit::setTreeId(const QString &tree_id) {
    m_tree_id = tree_id;
    m_tree_id_isSet = true;
}

bool OAICommit::is_tree_id_Set() const{
    return m_tree_id_isSet;
}

bool OAICommit::is_tree_id_Valid() const{
    return m_tree_id_isValid;
}

QList OAICommit::getParents() const {
    return m_parents;
}
void OAICommit::setParents(const QList &parents) {
    m_parents = parents;
...
OAICommit_author OAICommit::getAuthor() const {
    return m_author;
}
void OAICommit::setAuthor(const OAICommit_author &author) {
    m_author = author;
    m_author_isSet = true;
}
...
OAICommit_committer OAICommit::getCommitter() const {
    return m_committer;
}
void OAICommit::setCommitter(const OAICommit_committer &committer) {
...
QString OAICommit::getAdditionalData() const {
    return m_additional_data;
}
void OAICommit::setAdditionalData(const QString &additional_data) {
    m_additional_data = additional_data;
    m_additional_data_isSet = true;
}

bool OAICommit::is_additional_data_Set() const{
    return m_additional_data_isSet;
}

bool OAICommit::is_additional_data_Valid() const{
