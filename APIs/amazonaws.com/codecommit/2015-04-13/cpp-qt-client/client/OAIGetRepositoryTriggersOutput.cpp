...
OAIGetRepositoryTriggersOutput::OAIGetRepositoryTriggersOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetRepositoryTriggersOutput::OAIGetRepositoryTriggersOutput() {
    this->initializeModel();
}

OAIGetRepositoryTriggersOutput::~OAIGetRepositoryTriggersOutput() {}

void OAIGetRepositoryTriggersOutput::initializeModel() {
...
void OAIGetRepositoryTriggersOutput::fromJson(QString jsonString) {
...
void OAIGetRepositoryTriggersOutput::fromJsonObject(QJsonObject json) {
...
QString OAIGetRepositoryTriggersOutput::asJson() const {
...
QJsonObject OAIGetRepositoryTriggersOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetRepositoryTriggersOutput::getConfigurationId() const {
    return m_configuration_id;
}
void OAIGetRepositoryTriggersOutput::setConfigurationId(const QString &configuration_id) {
    m_configuration_id = configuration_id;
    m_configuration_id_isSet = true;
}

bool OAIGetRepositoryTriggersOutput::is_configuration_id_Set() const{
    return m_configuration_id_isSet;
}

bool OAIGetRepositoryTriggersOutput::is_configuration_id_Valid() const{
    return m_configuration_id_isValid;
}

QList OAIGetRepositoryTriggersOutput::getTriggers() const {
    return m_triggers;
}
void OAIGetRepositoryTriggersOutput::setTriggers(const QList &triggers) {
    m_triggers = triggers;
    m_triggers_isSet = true;
}

bool OAIGetRepositoryTriggersOutput::is_triggers_Set() const{
    return m_triggers_isSet;
}

bool OAIGetRepositoryTriggersOutput::is_triggers_Valid() const{
    return m_triggers_isValid;
}

bool OAIGetRepositoryTriggersOutput::isSet() const {
...
bool OAIGetRepositoryTriggersOutput::isValid() const {
