...
#include "OAIDifference_beforeBlob.h"
...
OAIDifference_beforeBlob::OAIDifference_beforeBlob(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDifference_beforeBlob::OAIDifference_beforeBlob() {
    this->initializeModel();
}

OAIDifference_beforeBlob::~OAIDifference_beforeBlob() {}

void OAIDifference_beforeBlob::initializeModel() {
...
void OAIDifference_beforeBlob::fromJson(QString jsonString) {
...
void OAIDifference_beforeBlob::fromJsonObject(QJsonObject json) {
...
QString OAIDifference_beforeBlob::asJson() const {
...
QJsonObject OAIDifference_beforeBlob::asJsonObject() const {
    QJsonObject obj;
    if (m_blob_id_isSet) {
...
QString OAIDifference_beforeBlob::getBlobId() const {
    return m_blob_id;
}
void OAIDifference_beforeBlob::setBlobId(const QString &blob_id) {
    m_blob_id = blob_id;
    m_blob_id_isSet = true;
}

bool OAIDifference_beforeBlob::is_blob_id_Set() const{
    return m_blob_id_isSet;
}

bool OAIDifference_beforeBlob::is_blob_id_Valid() const{
    return m_blob_id_isValid;
}

QString OAIDifference_beforeBlob::getPath() const {
    return m_path;
}
void OAIDifference_beforeBlob::setPath(const QString &path) {
    m_path = path;
    m_path_isSet = true;
}

bool OAIDifference_beforeBlob::is_path_Set() const{
    return m_path_isSet;
}

bool OAIDifference_beforeBlob::is_path_Valid() const{
    return m_path_isValid;
}

QString OAIDifference_beforeBlob::getMode() const {
    return m_mode;
}
void OAIDifference_beforeBlob::setMode(const QString &mode) {
    m_mode = mode;
    m_mode_isSet = true;
}

bool OAIDifference_beforeBlob::is_mode_Set() const{
    return m_mode_isSet;
}

bool OAIDifference_beforeBlob::is_mode_Valid() const{
    return m_mode_isValid;
}

bool OAIDifference_beforeBlob::isSet() const {
...
bool OAIDifference_beforeBlob::isValid() const {
