...
OAIDeleteBranchInput::OAIDeleteBranchInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteBranchInput::OAIDeleteBranchInput() {
    this->initializeModel();
}

OAIDeleteBranchInput::~OAIDeleteBranchInput() {}

void OAIDeleteBranchInput::initializeModel() {
...
void OAIDeleteBranchInput::fromJson(QString jsonString) {
...
void OAIDeleteBranchInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteBranchInput::asJson() const {
...
QJsonObject OAIDeleteBranchInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteBranchInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIDeleteBranchInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIDeleteBranchInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIDeleteBranchInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIDeleteBranchInput::getBranchName() const {
    return m_branch_name;
}
void OAIDeleteBranchInput::setBranchName(const QString &branch_name) {
    m_branch_name = branch_name;
    m_branch_name_isSet = true;
}

bool OAIDeleteBranchInput::is_branch_name_Set() const{
    return m_branch_name_isSet;
}

bool OAIDeleteBranchInput::is_branch_name_Valid() const{
    return m_branch_name_isValid;
}

bool OAIDeleteBranchInput::isSet() const {
...
bool OAIDeleteBranchInput::isValid() const {
