...
OAIPullRequestEventType::OAIPullRequestEventType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPullRequestEventType::OAIPullRequestEventType() {
    this->initializeModel();
}

OAIPullRequestEventType::~OAIPullRequestEventType() {}

void OAIPullRequestEventType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIPullRequestEventType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIPullRequestEventType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("PULL_REQUEST_CREATED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPullRequestEventType::CREATED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("PULL_REQUEST_STATUS_CHANGED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPullRequestEventType::STATUS_CHANGED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("PULL_REQUEST_SOURCE_REFERENCE_UPDATED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPullRequestEventType::SOURCE_REFERENCE_UPDATED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("PULL_REQUEST_MERGE_STATE_CHANGED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPullRequestEventType::MERGE_STATE_CHANGED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("PULL_REQUEST_APPROVAL_RULE_CREATED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPullRequestEventType::APPROVAL_RULE_CREATED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("PULL_REQUEST_APPROVAL_RULE_UPDATED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPullRequestEventType::APPROVAL_RULE_UPDATED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("PULL_REQUEST_APPROVAL_RULE_DELETED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPullRequestEventType::APPROVAL_RULE_DELETED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("PULL_REQUEST_APPROVAL_RULE_OVERRIDDEN", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPullRequestEventType::APPROVAL_RULE_OVERRIDDEN;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("PULL_REQUEST_APPROVAL_STATE_CHANGED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPullRequestEventType::APPROVAL_STATE_CHANGED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIPullRequestEventType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIPullRequestEventType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIPullRequestEventType::CREATED:
            val = "PULL_REQUEST_CREATED";
            break;
        case eOAIPullRequestEventType::STATUS_CHANGED:
            val = "PULL_REQUEST_STATUS_CHANGED";
            break;
        case eOAIPullRequestEventType::SOURCE_REFERENCE_UPDATED:
            val = "PULL_REQUEST_SOURCE_REFERENCE_UPDATED";
            break;
        case eOAIPullRequestEventType::MERGE_STATE_CHANGED:
            val = "PULL_REQUEST_MERGE_STATE_CHANGED";
            break;
        case eOAIPullRequestEventType::APPROVAL_RULE_CREATED:
            val = "PULL_REQUEST_APPROVAL_RULE_CREATED";
            break;
        case eOAIPullRequestEventType::APPROVAL_RULE_UPDATED:
            val = "PULL_REQUEST_APPROVAL_RULE_UPDATED";
            break;
        case eOAIPullRequestEventType::APPROVAL_RULE_DELETED:
            val = "PULL_REQUEST_APPROVAL_RULE_DELETED";
            break;
        case eOAIPullRequestEventType::APPROVAL_RULE_OVERRIDDEN:
            val = "PULL_REQUEST_APPROVAL_RULE_OVERRIDDEN";
            break;
        case eOAIPullRequestEventType::APPROVAL_STATE_CHANGED:
            val = "PULL_REQUEST_APPROVAL_STATE_CHANGED";
            break;
        default:
            break;
    }
...
QJsonValue OAIPullRequestEventType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIPullRequestEventType::eOAIPullRequestEventType OAIPullRequestEventType::getValue() const {
    return m_value;
}

void OAIPullRequestEventType::setValue(const OAIPullRequestEventType::eOAIPullRequestEventType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIPullRequestEventType::isSet() const {
    
    return m_value_isSet;
}

bool OAIPullRequestEventType::isValid() const {
