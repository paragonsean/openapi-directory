...
#include "OAIRepositoryTriggerEventEnum.h"
...
OAIRepositoryTriggerEventEnum::OAIRepositoryTriggerEventEnum(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRepositoryTriggerEventEnum::OAIRepositoryTriggerEventEnum() {
    this->initializeModel();
}

OAIRepositoryTriggerEventEnum::~OAIRepositoryTriggerEventEnum() {}

void OAIRepositoryTriggerEventEnum::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIRepositoryTriggerEventEnum::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIRepositoryTriggerEventEnum::fromJson(QString jsonString) {
    
    if ( jsonString.compare("all", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRepositoryTriggerEventEnum::ALL;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("updateReference", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRepositoryTriggerEventEnum::UPDATEREFERENCE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("createReference", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRepositoryTriggerEventEnum::CREATEREFERENCE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("deleteReference", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRepositoryTriggerEventEnum::DELETEREFERENCE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIRepositoryTriggerEventEnum::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIRepositoryTriggerEventEnum::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIRepositoryTriggerEventEnum::ALL:
            val = "all";
            break;
        case eOAIRepositoryTriggerEventEnum::UPDATEREFERENCE:
            val = "updateReference";
            break;
        case eOAIRepositoryTriggerEventEnum::CREATEREFERENCE:
            val = "createReference";
            break;
        case eOAIRepositoryTriggerEventEnum::DELETEREFERENCE:
            val = "deleteReference";
            break;
        default:
            break;
...
QJsonValue OAIRepositoryTriggerEventEnum::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIRepositoryTriggerEventEnum::eOAIRepositoryTriggerEventEnum OAIRepositoryTriggerEventEnum::getValue() const {
    return m_value;
}

void OAIRepositoryTriggerEventEnum::setValue(const OAIRepositoryTriggerEventEnum::eOAIRepositoryTriggerEventEnum& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIRepositoryTriggerEventEnum::isSet() const {
    
    return m_value_isSet;
}

bool OAIRepositoryTriggerEventEnum::isValid() const {
