...
/*
 * OAIBatchGetCommitsError.h
 *
 * Returns information about errors in a BatchGetCommits operation.
 */

#ifndef OAIBatchGetCommitsError_H
#define OAIBatchGetCommitsError_H
...
class OAIBatchGetCommitsError : public OAIObject {
public:
    OAIBatchGetCommitsError();
    OAIBatchGetCommitsError(QString json);
    ~OAIBatchGetCommitsError() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchGetCommitsError)

#endif // OAIBatchGetCommitsError_H
