...
/*
 * OAICommentsForPullRequest.h
 *
 * Returns information about comments on a pull request.
 */

#ifndef OAICommentsForPullRequest_H
#define OAICommentsForPullRequest_H
...
namespace OpenAPI {
class OAICommentsForPullRequest_location;

class OAICommentsForPullRequest : public OAIObject {
public:
    OAICommentsForPullRequest();
    OAICommentsForPullRequest(QString json);
    ~OAICommentsForPullRequest() override;
    ...
    OAICommentsForPullRequest_location getLocation() const;
    void setLocation(const OAICommentsForPullRequest_location &location);
...
private:
    ...
    OAICommentsForPullRequest_location m_location;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommentsForPullRequest)

#endif // OAICommentsForPullRequest_H
