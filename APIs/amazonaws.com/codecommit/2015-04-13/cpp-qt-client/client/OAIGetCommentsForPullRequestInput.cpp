...
OAIGetCommentsForPullRequestInput::OAIGetCommentsForPullRequestInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetCommentsForPullRequestInput::OAIGetCommentsForPullRequestInput() {
    this->initializeModel();
}

OAIGetCommentsForPullRequestInput::~OAIGetCommentsForPullRequestInput() {}

void OAIGetCommentsForPullRequestInput::initializeModel() {
...
void OAIGetCommentsForPullRequestInput::fromJson(QString jsonString) {
...
void OAIGetCommentsForPullRequestInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetCommentsForPullRequestInput::asJson() const {
...
QJsonObject OAIGetCommentsForPullRequestInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetCommentsForPullRequestInput::getPullRequestId() const {
    return m_pull_request_id;
}
void OAIGetCommentsForPullRequestInput::setPullRequestId(const QString &pull_request_id) {
    m_pull_request_id = pull_request_id;
    m_pull_request_id_isSet = true;
}

bool OAIGetCommentsForPullRequestInput::is_pull_request_id_Set() const{
    return m_pull_request_id_isSet;
}

bool OAIGetCommentsForPullRequestInput::is_pull_request_id_Valid() const{
    return m_pull_request_id_isValid;
}

QString OAIGetCommentsForPullRequestInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIGetCommentsForPullRequestInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIGetCommentsForPullRequestInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIGetCommentsForPullRequestInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIGetCommentsForPullRequestInput::getBeforeCommitId() const {
    return m_before_commit_id;
}
void OAIGetCommentsForPullRequestInput::setBeforeCommitId(const QString &before_commit_id) {
    m_before_commit_id = before_commit_id;
    m_before_commit_id_isSet = true;
}

bool OAIGetCommentsForPullRequestInput::is_before_commit_id_Set() const{
    return m_before_commit_id_isSet;
}

bool OAIGetCommentsForPullRequestInput::is_before_commit_id_Valid() const{
    return m_before_commit_id_isValid;
}

QString OAIGetCommentsForPullRequestInput::getAfterCommitId() const {
    return m_after_commit_id;
}
void OAIGetCommentsForPullRequestInput::setAfterCommitId(const QString &after_commit_id) {
    m_after_commit_id = after_commit_id;
    m_after_commit_id_isSet = true;
}

bool OAIGetCommentsForPullRequestInput::is_after_commit_id_Set() const{
    return m_after_commit_id_isSet;
}

bool OAIGetCommentsForPullRequestInput::is_after_commit_id_Valid() const{
    return m_after_commit_id_isValid;
}

QString OAIGetCommentsForPullRequestInput::getNextToken() const {
    return m_next_token;
}
void OAIGetCommentsForPullRequestInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIGetCommentsForPullRequestInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIGetCommentsForPullRequestInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIGetCommentsForPullRequestInput::getMaxResults() const {
    return m_max_results;
}
void OAIGetCommentsForPullRequestInput::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIGetCommentsForPullRequestInput::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIGetCommentsForPullRequestInput::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIGetCommentsForPullRequestInput::isSet() const {
...
bool OAIGetCommentsForPullRequestInput::isValid() const {
