...
#ifndef OAIIsBinaryFile_H
#define OAIIsBinaryFile_H
...
class OAIIsBinaryFile : public OAIObject {
public:
    OAIIsBinaryFile();
    OAIIsBinaryFile(QString json);
    ~OAIIsBinaryFile() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIsBinaryFile)

#endif // OAIIsBinaryFile_H
