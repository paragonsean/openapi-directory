...
OAIBlobMetadata::OAIBlobMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBlobMetadata::OAIBlobMetadata() {
    this->initializeModel();
}

OAIBlobMetadata::~OAIBlobMetadata() {}

void OAIBlobMetadata::initializeModel() {
...
void OAIBlobMetadata::fromJson(QString jsonString) {
...
void OAIBlobMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIBlobMetadata::asJson() const {
...
QJsonObject OAIBlobMetadata::asJsonObject() const {
    QJsonObject obj;
    if (m_blob_id_isSet) {
...
QString OAIBlobMetadata::getBlobId() const {
    return m_blob_id;
}
void OAIBlobMetadata::setBlobId(const QString &blob_id) {
    m_blob_id = blob_id;
    m_blob_id_isSet = true;
}

bool OAIBlobMetadata::is_blob_id_Set() const{
    return m_blob_id_isSet;
}

bool OAIBlobMetadata::is_blob_id_Valid() const{
    return m_blob_id_isValid;
}

QString OAIBlobMetadata::getPath() const {
    return m_path;
}
void OAIBlobMetadata::setPath(const QString &path) {
    m_path = path;
    m_path_isSet = true;
}

bool OAIBlobMetadata::is_path_Set() const{
    return m_path_isSet;
}

bool OAIBlobMetadata::is_path_Valid() const{
    return m_path_isValid;
}

QString OAIBlobMetadata::getMode() const {
    return m_mode;
}
void OAIBlobMetadata::setMode(const QString &mode) {
    m_mode = mode;
    m_mode_isSet = true;
}

bool OAIBlobMetadata::is_mode_Set() const{
    return m_mode_isSet;
}

bool OAIBlobMetadata::is_mode_Valid() const{
    return m_mode_isValid;
}

bool OAIBlobMetadata::isSet() const {
...
bool OAIBlobMetadata::isValid() const {
