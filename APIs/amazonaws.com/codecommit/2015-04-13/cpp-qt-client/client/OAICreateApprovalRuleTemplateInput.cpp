...
OAICreateApprovalRuleTemplateInput::OAICreateApprovalRuleTemplateInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateApprovalRuleTemplateInput::OAICreateApprovalRuleTemplateInput() {
    this->initializeModel();
}

OAICreateApprovalRuleTemplateInput::~OAICreateApprovalRuleTemplateInput() {}

void OAICreateApprovalRuleTemplateInput::initializeModel() {
...
void OAICreateApprovalRuleTemplateInput::fromJson(QString jsonString) {
...
void OAICreateApprovalRuleTemplateInput::fromJsonObject(QJsonObject json) {
...
QString OAICreateApprovalRuleTemplateInput::asJson() const {
...
QJsonObject OAICreateApprovalRuleTemplateInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateApprovalRuleTemplateInput::getApprovalRuleTemplateName() const {
    return m_approval_rule_template_name;
}
void OAICreateApprovalRuleTemplateInput::setApprovalRuleTemplateName(const QString &approval_rule_template_name) {
    m_approval_rule_template_name = approval_rule_template_name;
    m_approval_rule_template_name_isSet = true;
}

bool OAICreateApprovalRuleTemplateInput::is_approval_rule_template_name_Set() const{
    return m_approval_rule_template_name_isSet;
}

bool OAICreateApprovalRuleTemplateInput::is_approval_rule_template_name_Valid() const{
    return m_approval_rule_template_name_isValid;
}

QString OAICreateApprovalRuleTemplateInput::getApprovalRuleTemplateContent() const {
    return m_approval_rule_template_content;
}
void OAICreateApprovalRuleTemplateInput::setApprovalRuleTemplateContent(const QString &approval_rule_template_content) {
    m_approval_rule_template_content = approval_rule_template_content;
    m_approval_rule_template_content_isSet = true;
}

bool OAICreateApprovalRuleTemplateInput::is_approval_rule_template_content_Set() const{
    return m_approval_rule_template_content_isSet;
}

bool OAICreateApprovalRuleTemplateInput::is_approval_rule_template_content_Valid() const{
    return m_approval_rule_template_content_isValid;
}

QString OAICreateApprovalRuleTemplateInput::getApprovalRuleTemplateDescription() const {
    return m_approval_rule_template_description;
}
void OAICreateApprovalRuleTemplateInput::setApprovalRuleTemplateDescription(const QString &approval_rule_template_description) {
    m_approval_rule_template_description = approval_rule_template_description;
    m_approval_rule_template_description_isSet = true;
}

bool OAICreateApprovalRuleTemplateInput::is_approval_rule_template_description_Set() const{
    return m_approval_rule_template_description_isSet;
}

bool OAICreateApprovalRuleTemplateInput::is_approval_rule_template_description_Valid() const{
    return m_approval_rule_template_description_isValid;
}

bool OAICreateApprovalRuleTemplateInput::isSet() const {
...
bool OAICreateApprovalRuleTemplateInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_approval_rule_template_name_isValid && m_approval_rule_template_content_isValid && true;
}
