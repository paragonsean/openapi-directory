...
OAIBranchInfo::OAIBranchInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBranchInfo::OAIBranchInfo() {
    this->initializeModel();
}

OAIBranchInfo::~OAIBranchInfo() {}

void OAIBranchInfo::initializeModel() {
...
void OAIBranchInfo::fromJson(QString jsonString) {
...
void OAIBranchInfo::fromJsonObject(QJsonObject json) {
...
QString OAIBranchInfo::asJson() const {
...
QJsonObject OAIBranchInfo::asJsonObject() const {
    QJsonObject obj;
...
QString OAIBranchInfo::getBranchName() const {
    return m_branch_name;
}
void OAIBranchInfo::setBranchName(const QString &branch_name) {
    m_branch_name = branch_name;
    m_branch_name_isSet = true;
}

bool OAIBranchInfo::is_branch_name_Set() const{
    return m_branch_name_isSet;
}

bool OAIBranchInfo::is_branch_name_Valid() const{
    return m_branch_name_isValid;
}

QString OAIBranchInfo::getCommitId() const {
    return m_commit_id;
}
void OAIBranchInfo::setCommitId(const QString &commit_id) {
    m_commit_id = commit_id;
    m_commit_id_isSet = true;
}

bool OAIBranchInfo::is_commit_id_Set() const{
    return m_commit_id_isSet;
}

bool OAIBranchInfo::is_commit_id_Valid() const{
    return m_commit_id_isValid;
}

bool OAIBranchInfo::isSet() const {
...
bool OAIBranchInfo::isValid() const {
