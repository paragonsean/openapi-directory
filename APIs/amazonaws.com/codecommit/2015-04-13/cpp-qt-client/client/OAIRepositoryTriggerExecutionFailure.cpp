...
#include "OAIRepositoryTriggerExecutionFailure.h"
...
OAIRepositoryTriggerExecutionFailure::OAIRepositoryTriggerExecutionFailure(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRepositoryTriggerExecutionFailure::OAIRepositoryTriggerExecutionFailure() {
    this->initializeModel();
}

OAIRepositoryTriggerExecutionFailure::~OAIRepositoryTriggerExecutionFailure() {}

void OAIRepositoryTriggerExecutionFailure::initializeModel() {
...
void OAIRepositoryTriggerExecutionFailure::fromJson(QString jsonString) {
...
void OAIRepositoryTriggerExecutionFailure::fromJsonObject(QJsonObject json) {
...
QString OAIRepositoryTriggerExecutionFailure::asJson() const {
...
QJsonObject OAIRepositoryTriggerExecutionFailure::asJsonObject() const {
    QJsonObject obj;
    if (m_trigger_isSet) {
...
QString OAIRepositoryTriggerExecutionFailure::getTrigger() const {
    return m_trigger;
}
void OAIRepositoryTriggerExecutionFailure::setTrigger(const QString &trigger) {
    m_trigger = trigger;
    m_trigger_isSet = true;
}

bool OAIRepositoryTriggerExecutionFailure::is_trigger_Set() const{
    return m_trigger_isSet;
}

bool OAIRepositoryTriggerExecutionFailure::is_trigger_Valid() const{
    return m_trigger_isValid;
}

QString OAIRepositoryTriggerExecutionFailure::getFailureMessage() const {
    return m_failure_message;
}
void OAIRepositoryTriggerExecutionFailure::setFailureMessage(const QString &failure_message) {
    m_failure_message = failure_message;
    m_failure_message_isSet = true;
}

bool OAIRepositoryTriggerExecutionFailure::is_failure_message_Set() const{
    return m_failure_message_isSet;
}

bool OAIRepositoryTriggerExecutionFailure::is_failure_message_Valid() const{
    return m_failure_message_isValid;
}

bool OAIRepositoryTriggerExecutionFailure::isSet() const {
...
bool OAIRepositoryTriggerExecutionFailure::isValid() const {
