...
OAIPutCommentReactionInput::OAIPutCommentReactionInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutCommentReactionInput::OAIPutCommentReactionInput() {
    this->initializeModel();
}

OAIPutCommentReactionInput::~OAIPutCommentReactionInput() {}

void OAIPutCommentReactionInput::initializeModel() {

    m_comment_id_isSet = false;
    m_comment_id_isValid = false;

    m_reaction_value_isSet = false;
    m_reaction_value_isValid = false;
}

void OAIPutCommentReactionInput::fromJson(QString jsonString) {
...
void OAIPutCommentReactionInput::fromJsonObject(QJsonObject json) {
    ...
    m_reaction_value_isValid = ::OpenAPI::fromJsonValue(m_reaction_value, json[QString("reactionValue")]);
    m_reaction_value_isSet = !json[QString("reactionValue")].isNull() && m_reaction_value_isValid;
}

QString OAIPutCommentReactionInput::asJson() const {
...
QJsonObject OAIPutCommentReactionInput::asJsonObject() const {
    QJsonObject obj;
    if (m_comment_id_isSet) {
        obj.insert(QString("commentId"), ::OpenAPI::toJsonValue(m_comment_id));
    }
    if (m_reaction_value_isSet) {
        obj.insert(QString("reactionValue"), ::OpenAPI::toJsonValue(m_reaction_value));
    }
    return obj;
}

QString OAIPutCommentReactionInput::getCommentId() const {
    return m_comment_id;
}
void OAIPutCommentReactionInput::setCommentId(const QString &comment_id) {
    m_comment_id = comment_id;
    m_comment_id_isSet = true;
}

bool OAIPutCommentReactionInput::is_comment_id_Set() const{
    return m_comment_id_isSet;
}

bool OAIPutCommentReactionInput::is_comment_id_Valid() const{
    return m_comment_id_isValid;
}

QString OAIPutCommentReactionInput::getReactionValue() const {
    return m_reaction_value;
}
void OAIPutCommentReactionInput::setReactionValue(const QString &reaction_value) {
    m_reaction_value = reaction_value;
    m_reaction_value_isSet = true;
}

bool OAIPutCommentReactionInput::is_reaction_value_Set() const{
    return m_reaction_value_isSet;
}

bool OAIPutCommentReactionInput::is_reaction_value_Valid() const{
    return m_reaction_value_isValid;
}

bool OAIPutCommentReactionInput::isSet() const {
...
bool OAIPutCommentReactionInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_comment_id_isValid && m_reaction_value_isValid && true;
}
