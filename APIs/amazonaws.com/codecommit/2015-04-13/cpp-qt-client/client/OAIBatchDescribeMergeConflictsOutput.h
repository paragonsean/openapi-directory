...
/*
 * OAIBatchDescribeMergeConflictsOutput.h
 *
 * 
 */

#ifndef OAIBatchDescribeMergeConflictsOutput_H
#define OAIBatchDescribeMergeConflictsOutput_H
...
class OAIBatchDescribeMergeConflictsOutput : public OAIObject {
public:
    OAIBatchDescribeMergeConflictsOutput();
    OAIBatchDescribeMergeConflictsOutput(QString json);
    ~OAIBatchDescribeMergeConflictsOutput() override;
    ...
    QList getConflicts() const;
    void setConflicts(const QList &conflicts);
    bool is_conflicts_Set() const;
    bool is_conflicts_Valid() const;
...
private:
    ...
    QList m_conflicts;
    bool m_conflicts_isSet;
    bool m_conflicts_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchDescribeMergeConflictsOutput)

#endif // OAIBatchDescribeMergeConflictsOutput_H
