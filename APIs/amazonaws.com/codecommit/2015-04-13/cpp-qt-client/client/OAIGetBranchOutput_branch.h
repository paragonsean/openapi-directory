...
/*
 * OAIGetBranchOutput_branch.h
 *
 * 
 */

#ifndef OAIGetBranchOutput_branch_H
#define OAIGetBranchOutput_branch_H
...
class OAIGetBranchOutput_branch : public OAIObject {
public:
    OAIGetBranchOutput_branch();
    OAIGetBranchOutput_branch(QString json);
    ~OAIGetBranchOutput_branch() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetBranchOutput_branch)

#endif // OAIGetBranchOutput_branch_H
