...
OAITestRepositoryTriggersInput::OAITestRepositoryTriggersInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITestRepositoryTriggersInput::OAITestRepositoryTriggersInput() {
    this->initializeModel();
}

OAITestRepositoryTriggersInput::~OAITestRepositoryTriggersInput() {}

void OAITestRepositoryTriggersInput::initializeModel() {
...
void OAITestRepositoryTriggersInput::fromJson(QString jsonString) {
...
void OAITestRepositoryTriggersInput::fromJsonObject(QJsonObject json) {
...
QString OAITestRepositoryTriggersInput::asJson() const {
...
QJsonObject OAITestRepositoryTriggersInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAITestRepositoryTriggersInput::getRepositoryName() const {
    return m_repository_name;
}
void OAITestRepositoryTriggersInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAITestRepositoryTriggersInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAITestRepositoryTriggersInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QList OAITestRepositoryTriggersInput::getTriggers() const {
    return m_triggers;
}
void OAITestRepositoryTriggersInput::setTriggers(const QList &triggers) {
    m_triggers = triggers;
    m_triggers_isSet = true;
}

bool OAITestRepositoryTriggersInput::is_triggers_Set() const{
    return m_triggers_isSet;
}

bool OAITestRepositoryTriggersInput::is_triggers_Valid() const{
    return m_triggers_isValid;
}

bool OAITestRepositoryTriggersInput::isSet() const {
...
bool OAITestRepositoryTriggersInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_repository_name_isValid && m_triggers_isValid && true;
}
