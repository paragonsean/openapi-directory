...
/*
 * OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata.h
 *
 * 
 */

#ifndef OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata_H
#define OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata_H
...
class OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata : public OAIObject {
public:
    OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata();
    OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata(QString json);
    ~OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata() override;
    ...
    void setIsMerged(const bool &is_merged);
    bool is_is_merged_Set() const;
    bool is_is_merged_Valid() const;

    QString getMergedBy() const;
    void setMergedBy(const QString &merged_by);
...
private:
    ...
    bool m_is_merged;
    bool m_is_merged_isSet;
    bool m_is_merged_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata)

#endif // OAIPullRequestMergedStateChangedEventMetadata_mergeMetadata_H
