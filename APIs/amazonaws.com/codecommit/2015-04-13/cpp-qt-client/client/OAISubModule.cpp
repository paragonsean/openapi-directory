...
OAISubModule::OAISubModule(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISubModule::OAISubModule() {
    this->initializeModel();
}

OAISubModule::~OAISubModule() {}

void OAISubModule::initializeModel() {
...
void OAISubModule::fromJson(QString jsonString) {
...
void OAISubModule::fromJsonObject(QJsonObject json) {
...
QString OAISubModule::asJson() const {
...
QJsonObject OAISubModule::asJsonObject() const {
    QJsonObject obj;
...
QString OAISubModule::getCommitId() const {
    return m_commit_id;
}
void OAISubModule::setCommitId(const QString &commit_id) {
    m_commit_id = commit_id;
    m_commit_id_isSet = true;
}

bool OAISubModule::is_commit_id_Set() const{
    return m_commit_id_isSet;
}

bool OAISubModule::is_commit_id_Valid() const{
    return m_commit_id_isValid;
}

QString OAISubModule::getAbsolutePath() const {
    return m_absolute_path;
}
void OAISubModule::setAbsolutePath(const QString &absolute_path) {
    m_absolute_path = absolute_path;
    m_absolute_path_isSet = true;
}

bool OAISubModule::is_absolute_path_Set() const{
    return m_absolute_path_isSet;
}

bool OAISubModule::is_absolute_path_Valid() const{
    return m_absolute_path_isValid;
}

QString OAISubModule::getRelativePath() const {
    return m_relative_path;
}
void OAISubModule::setRelativePath(const QString &relative_path) {
    m_relative_path = relative_path;
    m_relative_path_isSet = true;
}

bool OAISubModule::is_relative_path_Set() const{
    return m_relative_path_isSet;
}

bool OAISubModule::is_relative_path_Valid() const{
    return m_relative_path_isValid;
}

bool OAISubModule::isSet() const {
...
bool OAISubModule::isValid() const {
