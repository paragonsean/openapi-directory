...
OAIDeleteCommentContentOutput::OAIDeleteCommentContentOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteCommentContentOutput::OAIDeleteCommentContentOutput() {
    this->initializeModel();
}

OAIDeleteCommentContentOutput::~OAIDeleteCommentContentOutput() {}

void OAIDeleteCommentContentOutput::initializeModel() {

    m_comment_isSet = false;
    m_comment_isValid = false;
}

void OAIDeleteCommentContentOutput::fromJson(QString jsonString) {
...
void OAIDeleteCommentContentOutput::fromJsonObject(QJsonObject json) {

    m_comment_isValid = ::OpenAPI::fromJsonValue(m_comment, json[QString("comment")]);
    m_comment_isSet = !json[QString("comment")].isNull() && m_comment_isValid;
}

QString OAIDeleteCommentContentOutput::asJson() const {
...
QJsonObject OAIDeleteCommentContentOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_comment.isSet()) {
...
OAIDeleteCommentContentOutput_comment OAIDeleteCommentContentOutput::getComment() const {
    return m_comment;
}
void OAIDeleteCommentContentOutput::setComment(const OAIDeleteCommentContentOutput_comment &comment) {
    m_comment = comment;
    m_comment_isSet = true;
}

bool OAIDeleteCommentContentOutput::is_comment_Set() const{
    return m_comment_isSet;
}

bool OAIDeleteCommentContentOutput::is_comment_Valid() const{
    return m_comment_isValid;
}

bool OAIDeleteCommentContentOutput::isSet() const {
...
bool OAIDeleteCommentContentOutput::isValid() const {
