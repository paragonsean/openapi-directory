...
/*
 * OAIRepositoryTrigger.h
 *
 * Information about a trigger for a repository.
 */

#ifndef OAIRepositoryTrigger_H
#define OAIRepositoryTrigger_H
...
class OAIRepositoryTrigger : public OAIObject {
public:
    OAIRepositoryTrigger();
    OAIRepositoryTrigger(QString json);
    ~OAIRepositoryTrigger() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRepositoryTrigger)

#endif // OAIRepositoryTrigger_H
