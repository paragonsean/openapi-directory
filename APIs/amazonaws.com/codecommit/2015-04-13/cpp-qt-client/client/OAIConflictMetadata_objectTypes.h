...
/*
 * OAIConflictMetadata_objectTypes.h
 *
 * 
 */

#ifndef OAIConflictMetadata_objectTypes_H
#define OAIConflictMetadata_objectTypes_H
...
class OAIConflictMetadata_objectTypes : public OAIObject {
public:
    OAIConflictMetadata_objectTypes();
    OAIConflictMetadata_objectTypes(QString json);
    ~OAIConflictMetadata_objectTypes() override;
    ...
    OAIObjectTypeEnum getSource() const;
    void setSource(const OAIObjectTypeEnum &source);
    bool is_source_Set() const;
    bool is_source_Valid() const;

    OAIObjectTypeEnum getDestination() const;
    void setDestination(const OAIObjectTypeEnum &destination);
    bool is_destination_Set() const;
    bool is_destination_Valid() const;

    OAIObjectTypeEnum getBase() const;
    void setBase(const OAIObjectTypeEnum &base);
...
private:
    ...
    OAIObjectTypeEnum m_source;
    bool m_source_isSet;
    bool m_source_isValid;

    OAIObjectTypeEnum m_destination;
    bool m_destination_isSet;
    bool m_destination_isValid;

    OAIObjectTypeEnum m_base;
    bool m_base_isSet;
    bool m_base_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIConflictMetadata_objectTypes)

#endif // OAIConflictMetadata_objectTypes_H
