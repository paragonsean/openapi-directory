...
OAIConflictResolutionStrategyTypeEnum::OAIConflictResolutionStrategyTypeEnum(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConflictResolutionStrategyTypeEnum::OAIConflictResolutionStrategyTypeEnum() {
    this->initializeModel();
}

OAIConflictResolutionStrategyTypeEnum::~OAIConflictResolutionStrategyTypeEnum() {}

void OAIConflictResolutionStrategyTypeEnum::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIConflictResolutionStrategyTypeEnum::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIConflictResolutionStrategyTypeEnum::fromJson(QString jsonString) {
    
    if ( jsonString.compare("NONE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIConflictResolutionStrategyTypeEnum::NONE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ACCEPT_SOURCE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIConflictResolutionStrategyTypeEnum::ACCEPT_SOURCE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ACCEPT_DESTINATION", Qt::CaseInsensitive) == 0) {
        m_value = eOAIConflictResolutionStrategyTypeEnum::ACCEPT_DESTINATION;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("AUTOMERGE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIConflictResolutionStrategyTypeEnum::AUTOMERGE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIConflictResolutionStrategyTypeEnum::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIConflictResolutionStrategyTypeEnum::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIConflictResolutionStrategyTypeEnum::NONE:
            val = "NONE";
            break;
        case eOAIConflictResolutionStrategyTypeEnum::ACCEPT_SOURCE:
            val = "ACCEPT_SOURCE";
            break;
        case eOAIConflictResolutionStrategyTypeEnum::ACCEPT_DESTINATION:
            val = "ACCEPT_DESTINATION";
            break;
        case eOAIConflictResolutionStrategyTypeEnum::AUTOMERGE:
            val = "AUTOMERGE";
            break;
        default:
            break;
...
QJsonValue OAIConflictResolutionStrategyTypeEnum::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIConflictResolutionStrategyTypeEnum::eOAIConflictResolutionStrategyTypeEnum OAIConflictResolutionStrategyTypeEnum::getValue() const {
    return m_value;
}

void OAIConflictResolutionStrategyTypeEnum::setValue(const OAIConflictResolutionStrategyTypeEnum::eOAIConflictResolutionStrategyTypeEnum& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIConflictResolutionStrategyTypeEnum::isSet() const {
    
    return m_value_isSet;
}

bool OAIConflictResolutionStrategyTypeEnum::isValid() const {
