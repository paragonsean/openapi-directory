...
#include "OAICreatePullRequestOutput_pullRequest.h"
...
OAICreatePullRequestOutput_pullRequest::OAICreatePullRequestOutput_pullRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreatePullRequestOutput_pullRequest::OAICreatePullRequestOutput_pullRequest() {
    this->initializeModel();
}

OAICreatePullRequestOutput_pullRequest::~OAICreatePullRequestOutput_pullRequest() {}

void OAICreatePullRequestOutput_pullRequest::initializeModel() {
...
void OAICreatePullRequestOutput_pullRequest::fromJson(QString jsonString) {
...
void OAICreatePullRequestOutput_pullRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreatePullRequestOutput_pullRequest::asJson() const {
...
QJsonObject OAICreatePullRequestOutput_pullRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreatePullRequestOutput_pullRequest::getPullRequestId() const {
    return m_pull_request_id;
}
void OAICreatePullRequestOutput_pullRequest::setPullRequestId(const QString &pull_request_id) {
    m_pull_request_id = pull_request_id;
    m_pull_request_id_isSet = true;
}

bool OAICreatePullRequestOutput_pullRequest::is_pull_request_id_Set() const{
    return m_pull_request_id_isSet;
}

bool OAICreatePullRequestOutput_pullRequest::is_pull_request_id_Valid() const{
    return m_pull_request_id_isValid;
}

QString OAICreatePullRequestOutput_pullRequest::getTitle() const {
    return m_title;
}
void OAICreatePullRequestOutput_pullRequest::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAICreatePullRequestOutput_pullRequest::is_title_Set() const{
    return m_title_isSet;
}

bool OAICreatePullRequestOutput_pullRequest::is_title_Valid() const{
    return m_title_isValid;
}

QString OAICreatePullRequestOutput_pullRequest::getDescription() const {
    return m_description;
}
void OAICreatePullRequestOutput_pullRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreatePullRequestOutput_pullRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreatePullRequestOutput_pullRequest::is_description_Valid() const{
    return m_description_isValid;
}

QDateTime OAICreatePullRequestOutput_pullRequest::getLastActivityDate() const {
    return m_last_activity_date;
}
void OAICreatePullRequestOutput_pullRequest::setLastActivityDate(const QDateTime &last_activity_date) {
    m_last_activity_date = last_activity_date;
    m_last_activity_date_isSet = true;
}

bool OAICreatePullRequestOutput_pullRequest::is_last_activity_date_Set() const{
    return m_last_activity_date_isSet;
}

bool OAICreatePullRequestOutput_pullRequest::is_last_activity_date_Valid() const{
    return m_last_activity_date_isValid;
}

QDateTime OAICreatePullRequestOutput_pullRequest::getCreationDate() const {
    return m_creation_date;
}
void OAICreatePullRequestOutput_pullRequest::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAICreatePullRequestOutput_pullRequest::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAICreatePullRequestOutput_pullRequest::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

OAIPullRequestStatusEnum OAICreatePullRequestOutput_pullRequest::getPullRequestStatus() const {
    return m_pull_request_status;
}
void OAICreatePullRequestOutput_pullRequest::setPullRequestStatus(const OAIPullRequestStatusEnum &pull_request_status) {
    m_pull_request_status = pull_request_status;
    m_pull_request_status_isSet = true;
}

bool OAICreatePullRequestOutput_pullRequest::is_pull_request_status_Set() const{
    return m_pull_request_status_isSet;
}

bool OAICreatePullRequestOutput_pullRequest::is_pull_request_status_Valid() const{
    return m_pull_request_status_isValid;
}

QString OAICreatePullRequestOutput_pullRequest::getAuthorArn() const {
    return m_author_arn;
}
void OAICreatePullRequestOutput_pullRequest::setAuthorArn(const QString &author_arn) {
    m_author_arn = author_arn;
    m_author_arn_isSet = true;
}

bool OAICreatePullRequestOutput_pullRequest::is_author_arn_Set() const{
    return m_author_arn_isSet;
}

bool OAICreatePullRequestOutput_pullRequest::is_author_arn_Valid() const{
    return m_author_arn_isValid;
}

QList OAICreatePullRequestOutput_pullRequest::getPullRequestTargets() const {
    return m_pull_request_targets;
}
void OAICreatePullRequestOutput_pullRequest::setPullRequestTargets(const QList &pull_request_targets) {
    m_pull_request_targets = pull_request_targets;
    m_pull_request_targets_isSet = true;
}

bool OAICreatePullRequestOutput_pullRequest::is_pull_request_targets_Set() const{
    return m_pull_request_targets_isSet;
}

bool OAICreatePullRequestOutput_pullRequest::is_pull_request_targets_Valid() const{
    return m_pull_request_targets_isValid;
}

QString OAICreatePullRequestOutput_pullRequest::getClientRequestToken() const {
    return m_client_request_token;
}
void OAICreatePullRequestOutput_pullRequest::setClientRequestToken(const QString &client_request_token) {
    m_client_request_token = client_request_token;
    m_client_request_token_isSet = true;
}

bool OAICreatePullRequestOutput_pullRequest::is_client_request_token_Set() const{
    return m_client_request_token_isSet;
}

bool OAICreatePullRequestOutput_pullRequest::is_client_request_token_Valid() const{
    return m_client_request_token_isValid;
}

QString OAICreatePullRequestOutput_pullRequest::getRevisionId() const {
    return m_revision_id;
}
void OAICreatePullRequestOutput_pullRequest::setRevisionId(const QString &revision_id) {
    m_revision_id = revision_id;
    m_revision_id_isSet = true;
}

bool OAICreatePullRequestOutput_pullRequest::is_revision_id_Set() const{
    return m_revision_id_isSet;
}

bool OAICreatePullRequestOutput_pullRequest::is_revision_id_Valid() const{
    return m_revision_id_isValid;
}

QList OAICreatePullRequestOutput_pullRequest::getApprovalRules() const {
    return m_approval_rules;
}
void OAICreatePullRequestOutput_pullRequest::setApprovalRules(const QList &approval_rules) {
    m_approval_rules = approval_rules;
    m_approval_rules_isSet = true;
}

bool OAICreatePullRequestOutput_pullRequest::is_approval_rules_Set() const{
    return m_approval_rules_isSet;
}

bool OAICreatePullRequestOutput_pullRequest::is_approval_rules_Valid() const{
    return m_approval_rules_isValid;
}

bool OAICreatePullRequestOutput_pullRequest::isSet() const {
...
bool OAICreatePullRequestOutput_pullRequest::isValid() const {
