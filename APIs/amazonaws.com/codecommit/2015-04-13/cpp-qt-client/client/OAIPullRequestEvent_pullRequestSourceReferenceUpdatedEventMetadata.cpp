...
#include "OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata.h"
...
OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata::OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata::OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata() {
    this->initializeModel();
}

OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata::~OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata() {}

void OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata::initializeModel() {

    m_repository_name_isSet = false;
    m_repository_name_isValid = false;

    m_before_commit_id_isSet = false;
    m_before_commit_id_isValid = false;

    m_after_commit_id_isSet = false;
    m_after_commit_id_isValid = false;

    m_merge_base_isSet = false;
    m_merge_base_isValid = false;
}

void OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata::fromJson(QString jsonString) {
...
void OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata::fromJsonObject(QJsonObject json) {
    ...
    m_before_commit_id_isValid = ::OpenAPI::fromJsonValue(m_before_commit_id, json[QString("beforeCommitId")]);
    m_before_commit_id_isSet = !json[QString("beforeCommitId")].isNull() && m_before_commit_id_isValid;

    m_after_commit_id_isValid = ::OpenAPI::fromJsonValue(m_after_commit_id, json[QString("afterCommitId")]);
    m_after_commit_id_isSet = !json[QString("afterCommitId")].isNull() && m_after_commit_id_isValid;

    m_merge_base_isValid = ::OpenAPI::fromJsonValue(m_merge_base, json[QString("mergeBase")]);
    m_merge_base_isSet = !json[QString("mergeBase")].isNull() && m_merge_base_isValid;
}

QString OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata::asJson() const {
...
QJsonObject OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata::asJsonObject() const {
    QJsonObject obj;
    if (m_repository_name_isSet) {
        obj.insert(QString("repositoryName"), ::OpenAPI::toJsonValue(m_repository_name));
    }
    if (m_before_commit_id_isSet) {
        obj.insert(QString("beforeCommitId"), ::OpenAPI::toJsonValue(m_before_commit_id));
    }
    if (m_after_commit_id_isSet) {
        obj.insert(QString("afterCommitId"), ::OpenAPI::toJsonValue(m_after_commit_id));
    }
    if (m_merge_base_isSet) {
        obj.insert(QString("mergeBase"), ::OpenAPI::toJsonValue(m_merge_base));
    }
    return obj;
}

QString OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata::getRepositoryName() const {
    return m_repository_name;
}
void OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata::getBeforeCommitId() const {
    return m_before_commit_id;
}
void OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata::setBeforeCommitId(const QString &before_commit_id) {
    m_before_commit_id = before_commit_id;
    m_before_commit_id_isSet = true;
}

bool OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata::is_before_commit_id_Set() const{
    return m_before_commit_id_isSet;
}

bool OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata::is_before_commit_id_Valid() const{
    return m_before_commit_id_isValid;
}

QString OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata::getAfterCommitId() const {
    return m_after_commit_id;
}
void OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata::setAfterCommitId(const QString &after_commit_id) {
    m_after_commit_id = after_commit_id;
    m_after_commit_id_isSet = true;
}

bool OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata::is_after_commit_id_Set() const{
    return m_after_commit_id_isSet;
}

bool OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata::is_after_commit_id_Valid() const{
    return m_after_commit_id_isValid;
}

QString OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata::getMergeBase() const {
    return m_merge_base;
}
void OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata::setMergeBase(const QString &merge_base) {
    m_merge_base = merge_base;
    m_merge_base_isSet = true;
}

bool OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata::is_merge_base_Set() const{
    return m_merge_base_isSet;
}

bool OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata::is_merge_base_Valid() const{
    return m_merge_base_isValid;
}

bool OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata::isSet() const {
...
bool OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata::isValid() const {
