...
/*
 * OAIConflictMetadata.h
 *
 * Information about the metadata for a conflict in a merge operation.
 */

#ifndef OAIConflictMetadata_H
#define OAIConflictMetadata_H
...
class OAIConflictMetadata : public OAIObject {
public:
    OAIConflictMetadata();
    OAIConflictMetadata(QString json);
    ~OAIConflictMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConflictMetadata)

#endif // OAIConflictMetadata_H
