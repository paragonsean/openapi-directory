...
#ifndef OAIGetCommitInput_H
#define OAIGetCommitInput_H
...
class OAIGetCommitInput : public OAIObject {
public:
    OAIGetCommitInput();
    OAIGetCommitInput(QString json);
    ~OAIGetCommitInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCommitInput)

#endif // OAIGetCommitInput_H
