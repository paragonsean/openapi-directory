...
OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput::OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput::OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput() {
    this->initializeModel();
}

OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput::~OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput() {}

void OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput::initializeModel() {
...
void OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput::fromJson(QString jsonString) {
...
void OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput::fromJsonObject(QJsonObject json) {
...
QString OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput::asJson() const {
...
QJsonObject OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput::getApprovalRuleTemplateName() const {
    return m_approval_rule_template_name;
}
void OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput::setApprovalRuleTemplateName(const QString &approval_rule_template_name) {
    m_approval_rule_template_name = approval_rule_template_name;
    m_approval_rule_template_name_isSet = true;
}

bool OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput::is_approval_rule_template_name_Set() const{
    return m_approval_rule_template_name_isSet;
}

bool OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput::is_approval_rule_template_name_Valid() const{
    return m_approval_rule_template_name_isValid;
}

QList OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput::getRepositoryNames() const {
    return m_repository_names;
}
void OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput::setRepositoryNames(const QList &repository_names) {
    m_repository_names = repository_names;
    m_repository_names_isSet = true;
}

bool OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput::is_repository_names_Set() const{
    return m_repository_names_isSet;
}

bool OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput::is_repository_names_Valid() const{
    return m_repository_names_isValid;
}

bool OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput::isSet() const {
...
bool OAIBatchAssociateApprovalRuleTemplateWithRepositoriesInput::isValid() const {
