...
OAIMergeBranchesByThreeWayInput::OAIMergeBranchesByThreeWayInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMergeBranchesByThreeWayInput::OAIMergeBranchesByThreeWayInput() {
    this->initializeModel();
}

OAIMergeBranchesByThreeWayInput::~OAIMergeBranchesByThreeWayInput() {}

void OAIMergeBranchesByThreeWayInput::initializeModel() {
...
void OAIMergeBranchesByThreeWayInput::fromJson(QString jsonString) {
...
void OAIMergeBranchesByThreeWayInput::fromJsonObject(QJsonObject json) {
...
QString OAIMergeBranchesByThreeWayInput::asJson() const {
...
QJsonObject OAIMergeBranchesByThreeWayInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIMergeBranchesByThreeWayInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIMergeBranchesByThreeWayInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIMergeBranchesByThreeWayInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIMergeBranchesByThreeWayInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIMergeBranchesByThreeWayInput::getSourceCommitSpecifier() const {
    return m_source_commit_specifier;
}
void OAIMergeBranchesByThreeWayInput::setSourceCommitSpecifier(const QString &source_commit_specifier) {
    m_source_commit_specifier = source_commit_specifier;
    m_source_commit_specifier_isSet = true;
}

bool OAIMergeBranchesByThreeWayInput::is_source_commit_specifier_Set() const{
    return m_source_commit_specifier_isSet;
}

bool OAIMergeBranchesByThreeWayInput::is_source_commit_specifier_Valid() const{
    return m_source_commit_specifier_isValid;
}

QString OAIMergeBranchesByThreeWayInput::getDestinationCommitSpecifier() const {
    return m_destination_commit_specifier;
}
void OAIMergeBranchesByThreeWayInput::setDestinationCommitSpecifier(const QString &destination_commit_specifier) {
    m_destination_commit_specifier = destination_commit_specifier;
    m_destination_commit_specifier_isSet = true;
}

bool OAIMergeBranchesByThreeWayInput::is_destination_commit_specifier_Set() const{
    return m_destination_commit_specifier_isSet;
}

bool OAIMergeBranchesByThreeWayInput::is_destination_commit_specifier_Valid() const{
    return m_destination_commit_specifier_isValid;
}

QString OAIMergeBranchesByThreeWayInput::getTargetBranch() const {
    return m_target_branch;
}
void OAIMergeBranchesByThreeWayInput::setTargetBranch(const QString &target_branch) {
    m_target_branch = target_branch;
    m_target_branch_isSet = true;
}

bool OAIMergeBranchesByThreeWayInput::is_target_branch_Set() const{
    return m_target_branch_isSet;
}

bool OAIMergeBranchesByThreeWayInput::is_target_branch_Valid() const{
    return m_target_branch_isValid;
}

OAIConflictDetailLevelTypeEnum OAIMergeBranchesByThreeWayInput::getConflictDetailLevel() const {
    return m_conflict_detail_level;
}
void OAIMergeBranchesByThreeWayInput::setConflictDetailLevel(const OAIConflictDetailLevelTypeEnum &conflict_detail_level) {
    m_conflict_detail_level = conflict_detail_level;
    m_conflict_detail_level_isSet = true;
}

bool OAIMergeBranchesByThreeWayInput::is_conflict_detail_level_Set() const{
    return m_conflict_detail_level_isSet;
}

bool OAIMergeBranchesByThreeWayInput::is_conflict_detail_level_Valid() const{
    return m_conflict_detail_level_isValid;
}

OAIConflictResolutionStrategyTypeEnum OAIMergeBranchesByThreeWayInput::getConflictResolutionStrategy() const {
    return m_conflict_resolution_strategy;
}
void OAIMergeBranchesByThreeWayInput::setConflictResolutionStrategy(const OAIConflictResolutionStrategyTypeEnum &conflict_resolution_strategy) {
    m_conflict_resolution_strategy = conflict_resolution_strategy;
    m_conflict_resolution_strategy_isSet = true;
}

bool OAIMergeBranchesByThreeWayInput::is_conflict_resolution_strategy_Set() const{
    return m_conflict_resolution_strategy_isSet;
}

bool OAIMergeBranchesByThreeWayInput::is_conflict_resolution_strategy_Valid() const{
    return m_conflict_resolution_strategy_isValid;
}

QString OAIMergeBranchesByThreeWayInput::getAuthorName() const {
    return m_author_name;
}
void OAIMergeBranchesByThreeWayInput::setAuthorName(const QString &author_name) {
    m_author_name = author_name;
    m_author_name_isSet = true;
}

bool OAIMergeBranchesByThreeWayInput::is_author_name_Set() const{
    return m_author_name_isSet;
}

bool OAIMergeBranchesByThreeWayInput::is_author_name_Valid() const{
    return m_author_name_isValid;
}

QString OAIMergeBranchesByThreeWayInput::getEmail() const {
    return m_email;
}
void OAIMergeBranchesByThreeWayInput::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAIMergeBranchesByThreeWayInput::is_email_Set() const{
    return m_email_isSet;
}

bool OAIMergeBranchesByThreeWayInput::is_email_Valid() const{
    return m_email_isValid;
}

QString OAIMergeBranchesByThreeWayInput::getCommitMessage() const {
    return m_commit_message;
}
void OAIMergeBranchesByThreeWayInput::setCommitMessage(const QString &commit_message) {
    m_commit_message = commit_message;
    m_commit_message_isSet = true;
}

bool OAIMergeBranchesByThreeWayInput::is_commit_message_Set() const{
    return m_commit_message_isSet;
}

bool OAIMergeBranchesByThreeWayInput::is_commit_message_Valid() const{
    return m_commit_message_isValid;
}

bool OAIMergeBranchesByThreeWayInput::getKeepEmptyFolders() const {
    return m_keep_empty_folders;
}
void OAIMergeBranchesByThreeWayInput::setKeepEmptyFolders(const bool &keep_empty_folders) {
    m_keep_empty_folders = keep_empty_folders;
    m_keep_empty_folders_isSet = true;
}

bool OAIMergeBranchesByThreeWayInput::is_keep_empty_folders_Set() const{
    return m_keep_empty_folders_isSet;
}

bool OAIMergeBranchesByThreeWayInput::is_keep_empty_folders_Valid() const{
    return m_keep_empty_folders_isValid;
}

OAICreateUnreferencedMergeCommitInput_conflictResolution OAIMergeBranchesByThreeWayInput::getConflictResolution() const {
    return m_conflict_resolution;
}
void OAIMergeBranchesByThreeWayInput::setConflictResolution(const OAICreateUnreferencedMergeCommitInput_conflictResolution &conflict_resolution) {
    m_conflict_resolution = conflict_resolution;
    m_conflict_resolution_isSet = true;
}

bool OAIMergeBranchesByThreeWayInput::is_conflict_resolution_Set() const{
    return m_conflict_resolution_isSet;
}

bool OAIMergeBranchesByThreeWayInput::is_conflict_resolution_Valid() const{
    return m_conflict_resolution_isValid;
}

bool OAIMergeBranchesByThreeWayInput::isSet() const {
...
bool OAIMergeBranchesByThreeWayInput::isValid() const {
