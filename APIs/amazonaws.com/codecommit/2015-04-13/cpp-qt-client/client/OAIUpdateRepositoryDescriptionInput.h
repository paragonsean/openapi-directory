...
/*
 * OAIUpdateRepositoryDescriptionInput.h
 *
 * Represents the input of an update repository description operation.
 */

#ifndef OAIUpdateRepositoryDescriptionInput_H
#define OAIUpdateRepositoryDescriptionInput_H
...
class OAIUpdateRepositoryDescriptionInput : public OAIObject {
public:
    OAIUpdateRepositoryDescriptionInput();
    OAIUpdateRepositoryDescriptionInput(QString json);
    ~OAIUpdateRepositoryDescriptionInput() override;
    ...
    QString getRepositoryDescription() const;
    void setRepositoryDescription(const QString &repository_description);
    bool is_repository_description_Set() const;
    bool is_repository_description_Valid() const;
...
private:
    ...
    QString m_repository_description;
    bool m_repository_description_isSet;
    bool m_repository_description_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRepositoryDescriptionInput)

#endif // OAIUpdateRepositoryDescriptionInput_H
