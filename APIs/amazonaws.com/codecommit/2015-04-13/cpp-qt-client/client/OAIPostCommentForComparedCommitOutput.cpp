...
OAIPostCommentForComparedCommitOutput::OAIPostCommentForComparedCommitOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPostCommentForComparedCommitOutput::OAIPostCommentForComparedCommitOutput() {
    this->initializeModel();
}

OAIPostCommentForComparedCommitOutput::~OAIPostCommentForComparedCommitOutput() {}

void OAIPostCommentForComparedCommitOutput::initializeModel() {
...
void OAIPostCommentForComparedCommitOutput::fromJson(QString jsonString) {
...
void OAIPostCommentForComparedCommitOutput::fromJsonObject(QJsonObject json) {
...
QString OAIPostCommentForComparedCommitOutput::asJson() const {
...
QJsonObject OAIPostCommentForComparedCommitOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPostCommentForComparedCommitOutput::getRepositoryName() const {
    return m_repository_name;
}
void OAIPostCommentForComparedCommitOutput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIPostCommentForComparedCommitOutput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIPostCommentForComparedCommitOutput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIPostCommentForComparedCommitOutput::getBeforeCommitId() const {
    return m_before_commit_id;
}
void OAIPostCommentForComparedCommitOutput::setBeforeCommitId(const QString &before_commit_id) {
    m_before_commit_id = before_commit_id;
    m_before_commit_id_isSet = true;
}

bool OAIPostCommentForComparedCommitOutput::is_before_commit_id_Set() const{
    return m_before_commit_id_isSet;
}

bool OAIPostCommentForComparedCommitOutput::is_before_commit_id_Valid() const{
    return m_before_commit_id_isValid;
}

QString OAIPostCommentForComparedCommitOutput::getAfterCommitId() const {
    return m_after_commit_id;
}
void OAIPostCommentForComparedCommitOutput::setAfterCommitId(const QString &after_commit_id) {
    m_after_commit_id = after_commit_id;
    m_after_commit_id_isSet = true;
}

bool OAIPostCommentForComparedCommitOutput::is_after_commit_id_Set() const{
    return m_after_commit_id_isSet;
}

bool OAIPostCommentForComparedCommitOutput::is_after_commit_id_Valid() const{
    return m_after_commit_id_isValid;
}

QString OAIPostCommentForComparedCommitOutput::getBeforeBlobId() const {
    return m_before_blob_id;
}
void OAIPostCommentForComparedCommitOutput::setBeforeBlobId(const QString &before_blob_id) {
    m_before_blob_id = before_blob_id;
    m_before_blob_id_isSet = true;
}

bool OAIPostCommentForComparedCommitOutput::is_before_blob_id_Set() const{
    return m_before_blob_id_isSet;
}

bool OAIPostCommentForComparedCommitOutput::is_before_blob_id_Valid() const{
    return m_before_blob_id_isValid;
}

QString OAIPostCommentForComparedCommitOutput::getAfterBlobId() const {
    return m_after_blob_id;
}
void OAIPostCommentForComparedCommitOutput::setAfterBlobId(const QString &after_blob_id) {
    m_after_blob_id = after_blob_id;
    m_after_blob_id_isSet = true;
}

bool OAIPostCommentForComparedCommitOutput::is_after_blob_id_Set() const{
    return m_after_blob_id_isSet;
}

bool OAIPostCommentForComparedCommitOutput::is_after_blob_id_Valid() const{
    return m_after_blob_id_isValid;
}

OAIPostCommentForComparedCommitOutput_location OAIPostCommentForComparedCommitOutput::getLocation() const {
    return m_location;
}
void OAIPostCommentForComparedCommitOutput::setLocation(const OAIPostCommentForComparedCommitOutput_location &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIPostCommentForComparedCommitOutput::is_location_Set() const{
    return m_location_isSet;
}

bool OAIPostCommentForComparedCommitOutput::is_location_Valid() const{
    return m_location_isValid;
}

OAIPostCommentForComparedCommitOutput_comment OAIPostCommentForComparedCommitOutput::getComment() const {
    return m_comment;
}
void OAIPostCommentForComparedCommitOutput::setComment(const OAIPostCommentForComparedCommitOutput_comment &comment) {
    m_comment = comment;
    m_comment_isSet = true;
}

bool OAIPostCommentForComparedCommitOutput::is_comment_Set() const{
    return m_comment_isSet;
}

bool OAIPostCommentForComparedCommitOutput::is_comment_Valid() const{
    return m_comment_isValid;
}

bool OAIPostCommentForComparedCommitOutput::isSet() const {
...
bool OAIPostCommentForComparedCommitOutput::isValid() const {
