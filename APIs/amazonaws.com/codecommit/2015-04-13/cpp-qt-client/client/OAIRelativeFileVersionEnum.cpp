...
OAIRelativeFileVersionEnum::OAIRelativeFileVersionEnum(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRelativeFileVersionEnum::OAIRelativeFileVersionEnum() {
    this->initializeModel();
}

OAIRelativeFileVersionEnum::~OAIRelativeFileVersionEnum() {}

void OAIRelativeFileVersionEnum::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIRelativeFileVersionEnum::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIRelativeFileVersionEnum::fromJson(QString jsonString) {
    
    if ( jsonString.compare("BEFORE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRelativeFileVersionEnum::BEFORE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("AFTER", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRelativeFileVersionEnum::AFTER;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIRelativeFileVersionEnum::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIRelativeFileVersionEnum::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIRelativeFileVersionEnum::BEFORE:
            val = "BEFORE";
            break;
        case eOAIRelativeFileVersionEnum::AFTER:
            val = "AFTER";
            break;
        default:
            break;
...
QJsonValue OAIRelativeFileVersionEnum::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIRelativeFileVersionEnum::eOAIRelativeFileVersionEnum OAIRelativeFileVersionEnum::getValue() const {
    return m_value;
}

void OAIRelativeFileVersionEnum::setValue(const OAIRelativeFileVersionEnum::eOAIRelativeFileVersionEnum& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIRelativeFileVersionEnum::isSet() const {
    
    return m_value_isSet;
}

bool OAIRelativeFileVersionEnum::isValid() const {
