...
/*
 * OAIUpdateCommentOutput_comment.h
 *
 * 
 */

#ifndef OAIUpdateCommentOutput_comment_H
#define OAIUpdateCommentOutput_comment_H
...
class OAIUpdateCommentOutput_comment : public OAIObject {
public:
    OAIUpdateCommentOutput_comment();
    OAIUpdateCommentOutput_comment(QString json);
    ~OAIUpdateCommentOutput_comment() override;
    ...
    QString getInReplyTo() const;
    void setInReplyTo(const QString &in_reply_to);
    ...
    QList getCallerReactions() const;
    void setCallerReactions(const QList &caller_reactions);
    bool is_caller_reactions_Set() const;
    bool is_caller_reactions_Valid() const;

    QMap getReactionCounts() const;
    void setReactionCounts(const QMap &reaction_counts);
...
private:
    ...
    QList m_caller_reactions;
    bool m_caller_reactions_isSet;
    bool m_caller_reactions_isValid;

    QMap m_reaction_counts;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateCommentOutput_comment)

#endif // OAIUpdateCommentOutput_comment_H
