...
/*
 * OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput.h
 *
 * 
 */

#ifndef OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput_H
#define OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput_H
...
class OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput : public OAIObject {
public:
    OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput();
    OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput(QString json);
    ~OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput() override;
    ...
    QList getDisassociatedRepositoryNames() const;
    void setDisassociatedRepositoryNames(const QList &disassociated_repository_names);
    bool is_disassociated_repository_names_Set() const;
    bool is_disassociated_repository_names_Valid() const;
...
private:
    ...
    QList m_disassociated_repository_names;
    bool m_disassociated_repository_names_isSet;
    bool m_disassociated_repository_names_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput)

#endif // OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput_H
