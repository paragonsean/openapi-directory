...
#ifndef OAIFileMetadata_H
#define OAIFileMetadata_H

#include <QJsonObject>

#include "OAIFileModeTypeEnum.h"
#include <QString>
...
class OAIFileMetadata : public OAIObject {
public:
    OAIFileMetadata();
    OAIFileMetadata(QString json);
    ~OAIFileMetadata() override;
    ...
    OAIFileModeTypeEnum getFileMode() const;
    void setFileMode(const OAIFileModeTypeEnum &file_mode);
...
private:
    ...
    OAIFileModeTypeEnum m_file_mode;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFileMetadata)

#endif // OAIFileMetadata_H
