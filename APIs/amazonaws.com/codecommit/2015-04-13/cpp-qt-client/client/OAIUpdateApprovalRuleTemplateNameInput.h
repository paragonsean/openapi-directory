...
/*
 * OAIUpdateApprovalRuleTemplateNameInput.h
 *
 * 
 */

#ifndef OAIUpdateApprovalRuleTemplateNameInput_H
#define OAIUpdateApprovalRuleTemplateNameInput_H
...
class OAIUpdateApprovalRuleTemplateNameInput : public OAIObject {
public:
    OAIUpdateApprovalRuleTemplateNameInput();
    OAIUpdateApprovalRuleTemplateNameInput(QString json);
    ~OAIUpdateApprovalRuleTemplateNameInput() override;
    ...
    QString getOldApprovalRuleTemplateName() const;
    void setOldApprovalRuleTemplateName(const QString &old_approval_rule_template_name);
    bool is_old_approval_rule_template_name_Set() const;
    bool is_old_approval_rule_template_name_Valid() const;

    QString getNewApprovalRuleTemplateName() const;
    void setNewApprovalRuleTemplateName(const QString &new_approval_rule_template_name);
    bool is_new_approval_rule_template_name_Set() const;
    bool is_new_approval_rule_template_name_Valid() const;
...
private:
    ...
    QString m_old_approval_rule_template_name;
    bool m_old_approval_rule_template_name_isSet;
    bool m_old_approval_rule_template_name_isValid;

    QString m_new_approval_rule_template_name;
    bool m_new_approval_rule_template_name_isSet;
    bool m_new_approval_rule_template_name_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUpdateApprovalRuleTemplateNameInput)

#endif // OAIUpdateApprovalRuleTemplateNameInput_H
