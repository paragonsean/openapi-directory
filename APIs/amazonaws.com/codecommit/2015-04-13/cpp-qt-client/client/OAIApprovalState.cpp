...
OAIApprovalState::OAIApprovalState(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIApprovalState::OAIApprovalState() {
    this->initializeModel();
}

OAIApprovalState::~OAIApprovalState() {}

void OAIApprovalState::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIApprovalState::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIApprovalState::fromJson(QString jsonString) {
    
    if ( jsonString.compare("APPROVE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIApprovalState::APPROVE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("REVOKE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIApprovalState::REVOKE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIApprovalState::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIApprovalState::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIApprovalState::APPROVE:
            val = "APPROVE";
            break;
        case eOAIApprovalState::REVOKE:
            val = "REVOKE";
            break;
        default:
            break;
...
QJsonValue OAIApprovalState::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIApprovalState::eOAIApprovalState OAIApprovalState::getValue() const {
    return m_value;
}

void OAIApprovalState::setValue(const OAIApprovalState::eOAIApprovalState& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIApprovalState::isSet() const {
    
    return m_value_isSet;
}

bool OAIApprovalState::isValid() const {
