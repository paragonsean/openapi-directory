...
QString OAIComment::getInReplyTo() const {
    return m_in_reply_to;
}
void OAIComment::setInReplyTo(const QString &in_reply_to) {
...
QDateTime OAIComment::getCreationDate() const {
    return m_creation_date;
}
void OAIComment::setCreationDate(const QDateTime &creation_date) {
...
QDateTime OAIComment::getLastModifiedDate() const {
    return m_last_modified_date;
}
void OAIComment::setLastModifiedDate(const QDateTime &last_modified_date) {
    m_last_modified_date = last_modified_date;
    m_last_modified_date_isSet = true;
}

bool OAIComment::is_last_modified_date_Set() const{
    return m_last_modified_date_isSet;
}

bool OAIComment::is_last_modified_date_Valid() const{
    return m_last_modified_date_isValid;
}

QString OAIComment::getAuthorArn() const {
    return m_author_arn;
}
void OAIComment::setAuthorArn(const QString &author_arn) {
    m_author_arn = author_arn;
    m_author_arn_isSet = true;
}

bool OAIComment::is_author_arn_Set() const{
    return m_author_arn_isSet;
}

bool OAIComment::is_author_arn_Valid() const{
    return m_author_arn_isValid;
}

bool OAIComment::getDeleted() const {
    return m_deleted;
}
...
QString OAIComment::getClientRequestToken() const {
    return m_client_request_token;
}
void OAIComment::setClientRequestToken(const QString &client_request_token) {
    m_client_request_token = client_request_token;
    m_client_request_token_isSet = true;
}

bool OAIComment::is_client_request_token_Set() const{
    return m_client_request_token_isSet;
}

bool OAIComment::is_client_request_token_Valid() const{
    return m_client_request_token_isValid;
}

QList OAIComment::getCallerReactions() const {
    return m_caller_reactions;
}
void OAIComment::setCallerReactions(const QList &caller_reactions) {
    m_caller_reactions = caller_reactions;
    m_caller_reactions_isSet = true;
}

bool OAIComment::is_caller_reactions_Set() const{
    return m_caller_reactions_isSet;
}

bool OAIComment::is_caller_reactions_Valid() const{
    return m_caller_reactions_isValid;
}

QMap OAIComment::getReactionCounts() const {
    return m_reaction_counts;
}
void OAIComment::setReactionCounts(const QMap &reaction_counts) {
    m_reaction_counts = reaction_counts;
    m_reaction_counts_isSet = true;
}

bool OAIComment::is_reaction_counts_Set() const{
    return m_reaction_counts_isSet;
}

bool OAIComment::is_reaction_counts_Valid() const{
