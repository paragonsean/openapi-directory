...
OAIListRepositoriesForApprovalRuleTemplateInput::OAIListRepositoriesForApprovalRuleTemplateInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListRepositoriesForApprovalRuleTemplateInput::OAIListRepositoriesForApprovalRuleTemplateInput() {
    this->initializeModel();
}

OAIListRepositoriesForApprovalRuleTemplateInput::~OAIListRepositoriesForApprovalRuleTemplateInput() {}

void OAIListRepositoriesForApprovalRuleTemplateInput::initializeModel() {
...
void OAIListRepositoriesForApprovalRuleTemplateInput::fromJson(QString jsonString) {
...
void OAIListRepositoriesForApprovalRuleTemplateInput::fromJsonObject(QJsonObject json) {
...
QString OAIListRepositoriesForApprovalRuleTemplateInput::asJson() const {
...
QJsonObject OAIListRepositoriesForApprovalRuleTemplateInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListRepositoriesForApprovalRuleTemplateInput::getApprovalRuleTemplateName() const {
    return m_approval_rule_template_name;
}
void OAIListRepositoriesForApprovalRuleTemplateInput::setApprovalRuleTemplateName(const QString &approval_rule_template_name) {
    m_approval_rule_template_name = approval_rule_template_name;
    m_approval_rule_template_name_isSet = true;
}

bool OAIListRepositoriesForApprovalRuleTemplateInput::is_approval_rule_template_name_Set() const{
    return m_approval_rule_template_name_isSet;
}

bool OAIListRepositoriesForApprovalRuleTemplateInput::is_approval_rule_template_name_Valid() const{
    return m_approval_rule_template_name_isValid;
}

QString OAIListRepositoriesForApprovalRuleTemplateInput::getNextToken() const {
    return m_next_token;
}
void OAIListRepositoriesForApprovalRuleTemplateInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListRepositoriesForApprovalRuleTemplateInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListRepositoriesForApprovalRuleTemplateInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListRepositoriesForApprovalRuleTemplateInput::getMaxResults() const {
    return m_max_results;
}
void OAIListRepositoriesForApprovalRuleTemplateInput::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListRepositoriesForApprovalRuleTemplateInput::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListRepositoriesForApprovalRuleTemplateInput::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListRepositoriesForApprovalRuleTemplateInput::isSet() const {
...
bool OAIListRepositoriesForApprovalRuleTemplateInput::isValid() const {
