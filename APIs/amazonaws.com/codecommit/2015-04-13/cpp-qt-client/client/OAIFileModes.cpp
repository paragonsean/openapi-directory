...
OAIFileModes::OAIFileModes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFileModes::OAIFileModes() {
    this->initializeModel();
}

OAIFileModes::~OAIFileModes() {}

void OAIFileModes::initializeModel() {
...
void OAIFileModes::fromJson(QString jsonString) {
...
void OAIFileModes::fromJsonObject(QJsonObject json) {
...
QString OAIFileModes::asJson() const {
...
QJsonObject OAIFileModes::asJsonObject() const {
    QJsonObject obj;
    if (m_source.isSet()) {
...
OAIFileModeTypeEnum OAIFileModes::getSource() const {
    return m_source;
}
void OAIFileModes::setSource(const OAIFileModeTypeEnum &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAIFileModes::is_source_Set() const{
    return m_source_isSet;
}

bool OAIFileModes::is_source_Valid() const{
    return m_source_isValid;
}

OAIFileModeTypeEnum OAIFileModes::getDestination() const {
    return m_destination;
}
void OAIFileModes::setDestination(const OAIFileModeTypeEnum &destination) {
    m_destination = destination;
    m_destination_isSet = true;
}

bool OAIFileModes::is_destination_Set() const{
    return m_destination_isSet;
}

bool OAIFileModes::is_destination_Valid() const{
    return m_destination_isValid;
}

OAIFileModeTypeEnum OAIFileModes::getBase() const {
    return m_base;
}
void OAIFileModes::setBase(const OAIFileModeTypeEnum &base) {
    m_base = base;
    m_base_isSet = true;
}

bool OAIFileModes::is_base_Set() const{
    return m_base_isSet;
}

bool OAIFileModes::is_base_Valid() const{
    return m_base_isValid;
}

bool OAIFileModes::isSet() const {
...
bool OAIFileModes::isValid() const {
