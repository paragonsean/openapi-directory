...
/*
 * OAIPutRepositoryTriggersInput.h
 *
 * Represents the input of a put repository triggers operation.
 */

#ifndef OAIPutRepositoryTriggersInput_H
#define OAIPutRepositoryTriggersInput_H
...
class OAIPutRepositoryTriggersInput : public OAIObject {
public:
    OAIPutRepositoryTriggersInput();
    OAIPutRepositoryTriggersInput(QString json);
    ~OAIPutRepositoryTriggersInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutRepositoryTriggersInput)

#endif // OAIPutRepositoryTriggersInput_H
