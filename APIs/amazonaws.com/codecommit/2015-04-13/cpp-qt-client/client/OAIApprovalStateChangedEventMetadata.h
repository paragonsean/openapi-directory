...
/*
 * OAIApprovalStateChangedEventMetadata.h
 *
 * Returns information about a change in the approval state for a pull request.
 */

#ifndef OAIApprovalStateChangedEventMetadata_H
#define OAIApprovalStateChangedEventMetadata_H
...
class OAIApprovalStateChangedEventMetadata : public OAIObject {
public:
    OAIApprovalStateChangedEventMetadata();
    OAIApprovalStateChangedEventMetadata(QString json);
    ~OAIApprovalStateChangedEventMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApprovalStateChangedEventMetadata)

#endif // OAIApprovalStateChangedEventMetadata_H
