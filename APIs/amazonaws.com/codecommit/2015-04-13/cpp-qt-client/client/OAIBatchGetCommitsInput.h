...
/*
 * OAIBatchGetCommitsInput.h
 *
 * 
 */

#ifndef OAIBatchGetCommitsInput_H
#define OAIBatchGetCommitsInput_H
...
class OAIBatchGetCommitsInput : public OAIObject {
public:
    OAIBatchGetCommitsInput();
    OAIBatchGetCommitsInput(QString json);
    ~OAIBatchGetCommitsInput() override;
    ...
    QList getCommitIds() const;
    void setCommitIds(const QList &commit_ids);
    bool is_commit_ids_Set() const;
    bool is_commit_ids_Valid() const;
...
private:
    ...
    QList m_commit_ids;
    bool m_commit_ids_isSet;
    bool m_commit_ids_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchGetCommitsInput)

#endif // OAIBatchGetCommitsInput_H
