...
OAIPostCommentForComparedCommitOutput_location::OAIPostCommentForComparedCommitOutput_location(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPostCommentForComparedCommitOutput_location::OAIPostCommentForComparedCommitOutput_location() {
    this->initializeModel();
}

OAIPostCommentForComparedCommitOutput_location::~OAIPostCommentForComparedCommitOutput_location() {}

void OAIPostCommentForComparedCommitOutput_location::initializeModel() {
...
void OAIPostCommentForComparedCommitOutput_location::fromJson(QString jsonString) {
...
void OAIPostCommentForComparedCommitOutput_location::fromJsonObject(QJsonObject json) {
...
QString OAIPostCommentForComparedCommitOutput_location::asJson() const {
...
QJsonObject OAIPostCommentForComparedCommitOutput_location::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPostCommentForComparedCommitOutput_location::getFilePath() const {
    return m_file_path;
}
void OAIPostCommentForComparedCommitOutput_location::setFilePath(const QString &file_path) {
    m_file_path = file_path;
    m_file_path_isSet = true;
}

bool OAIPostCommentForComparedCommitOutput_location::is_file_path_Set() const{
    return m_file_path_isSet;
}

bool OAIPostCommentForComparedCommitOutput_location::is_file_path_Valid() const{
    return m_file_path_isValid;
}

qint32 OAIPostCommentForComparedCommitOutput_location::getFilePosition() const {
    return m_file_position;
}
void OAIPostCommentForComparedCommitOutput_location::setFilePosition(const qint32 &file_position) {
    m_file_position = file_position;
    m_file_position_isSet = true;
}

bool OAIPostCommentForComparedCommitOutput_location::is_file_position_Set() const{
    return m_file_position_isSet;
}

bool OAIPostCommentForComparedCommitOutput_location::is_file_position_Valid() const{
    return m_file_position_isValid;
}

OAIRelativeFileVersionEnum OAIPostCommentForComparedCommitOutput_location::getRelativeFileVersion() const {
    return m_relative_file_version;
}
void OAIPostCommentForComparedCommitOutput_location::setRelativeFileVersion(const OAIRelativeFileVersionEnum &relative_file_version) {
    m_relative_file_version = relative_file_version;
    m_relative_file_version_isSet = true;
}

bool OAIPostCommentForComparedCommitOutput_location::is_relative_file_version_Set() const{
    return m_relative_file_version_isSet;
}

bool OAIPostCommentForComparedCommitOutput_location::is_relative_file_version_Valid() const{
    return m_relative_file_version_isValid;
}

bool OAIPostCommentForComparedCommitOutput_location::isSet() const {
...
bool OAIPostCommentForComparedCommitOutput_location::isValid() const {
