...
/*
 * OAIUpdateRepositoryNameInput.h
 *
 * Represents the input of an update repository description operation.
 */

#ifndef OAIUpdateRepositoryNameInput_H
#define OAIUpdateRepositoryNameInput_H
...
class OAIUpdateRepositoryNameInput : public OAIObject {
public:
    OAIUpdateRepositoryNameInput();
    OAIUpdateRepositoryNameInput(QString json);
    ~OAIUpdateRepositoryNameInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRepositoryNameInput)

#endif // OAIUpdateRepositoryNameInput_H
