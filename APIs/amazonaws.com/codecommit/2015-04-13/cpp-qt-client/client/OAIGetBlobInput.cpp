...
OAIGetBlobInput::OAIGetBlobInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetBlobInput::OAIGetBlobInput() {
    this->initializeModel();
}

OAIGetBlobInput::~OAIGetBlobInput() {}

void OAIGetBlobInput::initializeModel() {
...
void OAIGetBlobInput::fromJson(QString jsonString) {
...
void OAIGetBlobInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetBlobInput::asJson() const {
...
QJsonObject OAIGetBlobInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetBlobInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIGetBlobInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIGetBlobInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIGetBlobInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIGetBlobInput::getBlobId() const {
    return m_blob_id;
}
void OAIGetBlobInput::setBlobId(const QString &blob_id) {
    m_blob_id = blob_id;
    m_blob_id_isSet = true;
}

bool OAIGetBlobInput::is_blob_id_Set() const{
    return m_blob_id_isSet;
}

bool OAIGetBlobInput::is_blob_id_Valid() const{
    return m_blob_id_isValid;
}

bool OAIGetBlobInput::isSet() const {
...
bool OAIGetBlobInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_repository_name_isValid && m_blob_id_isValid && true;
}
