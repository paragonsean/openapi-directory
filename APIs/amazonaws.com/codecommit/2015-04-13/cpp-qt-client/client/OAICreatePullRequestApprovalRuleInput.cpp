...
OAICreatePullRequestApprovalRuleInput::OAICreatePullRequestApprovalRuleInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreatePullRequestApprovalRuleInput::OAICreatePullRequestApprovalRuleInput() {
    this->initializeModel();
}

OAICreatePullRequestApprovalRuleInput::~OAICreatePullRequestApprovalRuleInput() {}

void OAICreatePullRequestApprovalRuleInput::initializeModel() {
...
void OAICreatePullRequestApprovalRuleInput::fromJson(QString jsonString) {
...
void OAICreatePullRequestApprovalRuleInput::fromJsonObject(QJsonObject json) {
...
QString OAICreatePullRequestApprovalRuleInput::asJson() const {
...
QJsonObject OAICreatePullRequestApprovalRuleInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreatePullRequestApprovalRuleInput::getPullRequestId() const {
    return m_pull_request_id;
}
void OAICreatePullRequestApprovalRuleInput::setPullRequestId(const QString &pull_request_id) {
    m_pull_request_id = pull_request_id;
    m_pull_request_id_isSet = true;
}

bool OAICreatePullRequestApprovalRuleInput::is_pull_request_id_Set() const{
    return m_pull_request_id_isSet;
}

bool OAICreatePullRequestApprovalRuleInput::is_pull_request_id_Valid() const{
    return m_pull_request_id_isValid;
}

QString OAICreatePullRequestApprovalRuleInput::getApprovalRuleName() const {
    return m_approval_rule_name;
}
void OAICreatePullRequestApprovalRuleInput::setApprovalRuleName(const QString &approval_rule_name) {
    m_approval_rule_name = approval_rule_name;
    m_approval_rule_name_isSet = true;
}

bool OAICreatePullRequestApprovalRuleInput::is_approval_rule_name_Set() const{
    return m_approval_rule_name_isSet;
}

bool OAICreatePullRequestApprovalRuleInput::is_approval_rule_name_Valid() const{
    return m_approval_rule_name_isValid;
}

QString OAICreatePullRequestApprovalRuleInput::getApprovalRuleContent() const {
    return m_approval_rule_content;
}
void OAICreatePullRequestApprovalRuleInput::setApprovalRuleContent(const QString &approval_rule_content) {
    m_approval_rule_content = approval_rule_content;
    m_approval_rule_content_isSet = true;
}

bool OAICreatePullRequestApprovalRuleInput::is_approval_rule_content_Set() const{
    return m_approval_rule_content_isSet;
}

bool OAICreatePullRequestApprovalRuleInput::is_approval_rule_content_Valid() const{
    return m_approval_rule_content_isValid;
}

bool OAICreatePullRequestApprovalRuleInput::isSet() const {
...
bool OAICreatePullRequestApprovalRuleInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_pull_request_id_isValid && m_approval_rule_name_isValid && m_approval_rule_content_isValid && true;
}
