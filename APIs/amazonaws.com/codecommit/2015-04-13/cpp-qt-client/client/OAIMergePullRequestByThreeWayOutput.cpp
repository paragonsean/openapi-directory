...
OAIMergePullRequestByThreeWayOutput::OAIMergePullRequestByThreeWayOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMergePullRequestByThreeWayOutput::OAIMergePullRequestByThreeWayOutput() {
    this->initializeModel();
}

OAIMergePullRequestByThreeWayOutput::~OAIMergePullRequestByThreeWayOutput() {}

void OAIMergePullRequestByThreeWayOutput::initializeModel() {

    m_pull_request_isSet = false;
    m_pull_request_isValid = false;
}

void OAIMergePullRequestByThreeWayOutput::fromJson(QString jsonString) {
...
void OAIMergePullRequestByThreeWayOutput::fromJsonObject(QJsonObject json) {
...
QString OAIMergePullRequestByThreeWayOutput::asJson() const {
...
QJsonObject OAIMergePullRequestByThreeWayOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIPullRequest OAIMergePullRequestByThreeWayOutput::getPullRequest() const {
    return m_pull_request;
}
void OAIMergePullRequestByThreeWayOutput::setPullRequest(const OAIPullRequest &pull_request) {
    m_pull_request = pull_request;
    m_pull_request_isSet = true;
}

bool OAIMergePullRequestByThreeWayOutput::is_pull_request_Set() const{
    return m_pull_request_isSet;
}

bool OAIMergePullRequestByThreeWayOutput::is_pull_request_Valid() const{
    return m_pull_request_isValid;
}

bool OAIMergePullRequestByThreeWayOutput::isSet() const {
...
bool OAIMergePullRequestByThreeWayOutput::isValid() const {
