...
QString OAIDeleteRepositoryOutput::getRepositoryId() const {
    return m_repository_id;
}
void OAIDeleteRepositoryOutput::setRepositoryId(const QString &repository_id) {
    m_repository_id = repository_id;
    m_repository_id_isSet = true;
}

bool OAIDeleteRepositoryOutput::is_repository_id_Set() const{
    return m_repository_id_isSet;
}

bool OAIDeleteRepositoryOutput::is_repository_id_Valid() const{
