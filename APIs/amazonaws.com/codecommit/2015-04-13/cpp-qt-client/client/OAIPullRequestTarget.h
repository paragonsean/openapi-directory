...
/*
 * OAIPullRequestTarget.h
 *
 * Returns information about a pull request target.
 */

#ifndef OAIPullRequestTarget_H
#define OAIPullRequestTarget_H
...
namespace OpenAPI {
class OAIPullRequestTarget_mergeMetadata;

class OAIPullRequestTarget : public OAIObject {
public:
    OAIPullRequestTarget();
    OAIPullRequestTarget(QString json);
    ~OAIPullRequestTarget() override;
    ...
    QString getSourceReference() const;
    void setSourceReference(const QString &source_reference);
    ...
    OAIPullRequestTarget_mergeMetadata getMergeMetadata() const;
    void setMergeMetadata(const OAIPullRequestTarget_mergeMetadata &merge_metadata);
...
private:
    ...
    OAIPullRequestTarget_mergeMetadata m_merge_metadata;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPullRequestTarget)

#endif // OAIPullRequestTarget_H
