...
/*
 * OAIGetDifferencesOutput.h
 *
 * 
 */

#ifndef OAIGetDifferencesOutput_H
#define OAIGetDifferencesOutput_H
...
class OAIGetDifferencesOutput : public OAIObject {
public:
    OAIGetDifferencesOutput();
    OAIGetDifferencesOutput(QString json);
    ~OAIGetDifferencesOutput() override;
    ...
    QList getDifferences() const;
    void setDifferences(const QList &differences);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDifferencesOutput)

#endif // OAIGetDifferencesOutput_H
