...
/*
 * OAIGetCommentsForPullRequestOutput.h
 *
 * 
 */

#ifndef OAIGetCommentsForPullRequestOutput_H
#define OAIGetCommentsForPullRequestOutput_H
...
class OAIGetCommentsForPullRequestOutput : public OAIObject {
public:
    OAIGetCommentsForPullRequestOutput();
    OAIGetCommentsForPullRequestOutput(QString json);
    ~OAIGetCommentsForPullRequestOutput() override;
    ...
    QList getCommentsForPullRequestData() const;
    void setCommentsForPullRequestData(const QList &comments_for_pull_request_data);
    bool is_comments_for_pull_request_data_Set() const;
    bool is_comments_for_pull_request_data_Valid() const;
...
private:
    ...
    QList m_comments_for_pull_request_data;
    bool m_comments_for_pull_request_data_isSet;
    bool m_comments_for_pull_request_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCommentsForPullRequestOutput)

#endif // OAIGetCommentsForPullRequestOutput_H
