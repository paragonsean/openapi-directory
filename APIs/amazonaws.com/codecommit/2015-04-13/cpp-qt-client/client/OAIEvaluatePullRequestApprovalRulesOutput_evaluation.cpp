...
#include "OAIEvaluatePullRequestApprovalRulesOutput_evaluation.h"
...
OAIEvaluatePullRequestApprovalRulesOutput_evaluation::OAIEvaluatePullRequestApprovalRulesOutput_evaluation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEvaluatePullRequestApprovalRulesOutput_evaluation::OAIEvaluatePullRequestApprovalRulesOutput_evaluation() {
    this->initializeModel();
}

OAIEvaluatePullRequestApprovalRulesOutput_evaluation::~OAIEvaluatePullRequestApprovalRulesOutput_evaluation() {}

void OAIEvaluatePullRequestApprovalRulesOutput_evaluation::initializeModel() {
...
void OAIEvaluatePullRequestApprovalRulesOutput_evaluation::fromJson(QString jsonString) {
...
void OAIEvaluatePullRequestApprovalRulesOutput_evaluation::fromJsonObject(QJsonObject json) {
...
QString OAIEvaluatePullRequestApprovalRulesOutput_evaluation::asJson() const {
...
QJsonObject OAIEvaluatePullRequestApprovalRulesOutput_evaluation::asJsonObject() const {
    QJsonObject obj;
    if (m_approved_isSet) {
...
bool OAIEvaluatePullRequestApprovalRulesOutput_evaluation::getApproved() const {
    return m_approved;
}
void OAIEvaluatePullRequestApprovalRulesOutput_evaluation::setApproved(const bool &approved) {
    m_approved = approved;
    m_approved_isSet = true;
}

bool OAIEvaluatePullRequestApprovalRulesOutput_evaluation::is_approved_Set() const{
    return m_approved_isSet;
}

bool OAIEvaluatePullRequestApprovalRulesOutput_evaluation::is_approved_Valid() const{
    return m_approved_isValid;
}

bool OAIEvaluatePullRequestApprovalRulesOutput_evaluation::getOverridden() const {
    return m_overridden;
}
void OAIEvaluatePullRequestApprovalRulesOutput_evaluation::setOverridden(const bool &overridden) {
    m_overridden = overridden;
    m_overridden_isSet = true;
}

bool OAIEvaluatePullRequestApprovalRulesOutput_evaluation::is_overridden_Set() const{
    return m_overridden_isSet;
}

bool OAIEvaluatePullRequestApprovalRulesOutput_evaluation::is_overridden_Valid() const{
    return m_overridden_isValid;
}

QList OAIEvaluatePullRequestApprovalRulesOutput_evaluation::getApprovalRulesSatisfied() const {
    return m_approval_rules_satisfied;
}
void OAIEvaluatePullRequestApprovalRulesOutput_evaluation::setApprovalRulesSatisfied(const QList &approval_rules_satisfied) {
    m_approval_rules_satisfied = approval_rules_satisfied;
    m_approval_rules_satisfied_isSet = true;
}

bool OAIEvaluatePullRequestApprovalRulesOutput_evaluation::is_approval_rules_satisfied_Set() const{
    return m_approval_rules_satisfied_isSet;
}

bool OAIEvaluatePullRequestApprovalRulesOutput_evaluation::is_approval_rules_satisfied_Valid() const{
    return m_approval_rules_satisfied_isValid;
}

QList OAIEvaluatePullRequestApprovalRulesOutput_evaluation::getApprovalRulesNotSatisfied() const {
    return m_approval_rules_not_satisfied;
}
void OAIEvaluatePullRequestApprovalRulesOutput_evaluation::setApprovalRulesNotSatisfied(const QList &approval_rules_not_satisfied) {
    m_approval_rules_not_satisfied = approval_rules_not_satisfied;
    m_approval_rules_not_satisfied_isSet = true;
}

bool OAIEvaluatePullRequestApprovalRulesOutput_evaluation::is_approval_rules_not_satisfied_Set() const{
    return m_approval_rules_not_satisfied_isSet;
}

bool OAIEvaluatePullRequestApprovalRulesOutput_evaluation::is_approval_rules_not_satisfied_Valid() const{
    return m_approval_rules_not_satisfied_isValid;
}

bool OAIEvaluatePullRequestApprovalRulesOutput_evaluation::isSet() const {
...
bool OAIEvaluatePullRequestApprovalRulesOutput_evaluation::isValid() const {
