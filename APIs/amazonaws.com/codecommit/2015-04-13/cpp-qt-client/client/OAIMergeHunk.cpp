...
OAIMergeHunk::OAIMergeHunk(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMergeHunk::OAIMergeHunk() {
    this->initializeModel();
}

OAIMergeHunk::~OAIMergeHunk() {}

void OAIMergeHunk::initializeModel() {

    m_is_conflict_isSet = false;
    m_is_conflict_isValid = false;
...
void OAIMergeHunk::fromJson(QString jsonString) {
...
void OAIMergeHunk::fromJsonObject(QJsonObject json) {

    m_is_conflict_isValid = ::OpenAPI::fromJsonValue(m_is_conflict, json[QString("isConflict")]);
    m_is_conflict_isSet = !json[QString("isConflict")].isNull() && m_is_conflict_isValid;
...
QString OAIMergeHunk::asJson() const {
...
QJsonObject OAIMergeHunk::asJsonObject() const {
    QJsonObject obj;
    if (m_is_conflict_isSet) {
        obj.insert(QString("isConflict"), ::OpenAPI::toJsonValue(m_is_conflict));
    }
    if (m_source.isSet()) {
...
bool OAIMergeHunk::getIsConflict() const {
    return m_is_conflict;
}
void OAIMergeHunk::setIsConflict(const bool &is_conflict) {
    m_is_conflict = is_conflict;
    m_is_conflict_isSet = true;
}

bool OAIMergeHunk::is_is_conflict_Set() const{
    return m_is_conflict_isSet;
}

bool OAIMergeHunk::is_is_conflict_Valid() const{
    return m_is_conflict_isValid;
}

OAIMergeHunk_source OAIMergeHunk::getSource() const {
    return m_source;
}
void OAIMergeHunk::setSource(const OAIMergeHunk_source &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAIMergeHunk::is_source_Set() const{
    return m_source_isSet;
}

bool OAIMergeHunk::is_source_Valid() const{
    return m_source_isValid;
}

OAIMergeHunk_destination OAIMergeHunk::getDestination() const {
    return m_destination;
}
void OAIMergeHunk::setDestination(const OAIMergeHunk_destination &destination) {
    m_destination = destination;
    m_destination_isSet = true;
}

bool OAIMergeHunk::is_destination_Set() const{
    return m_destination_isSet;
}

bool OAIMergeHunk::is_destination_Valid() const{
    return m_destination_isValid;
}

OAIMergeHunk_base OAIMergeHunk::getBase() const {
    return m_base;
}
void OAIMergeHunk::setBase(const OAIMergeHunk_base &base) {
    m_base = base;
    m_base_isSet = true;
}

bool OAIMergeHunk::is_base_Set() const{
    return m_base_isSet;
}

bool OAIMergeHunk::is_base_Valid() const{
    return m_base_isValid;
}

bool OAIMergeHunk::isSet() const {
...
bool OAIMergeHunk::isValid() const {
