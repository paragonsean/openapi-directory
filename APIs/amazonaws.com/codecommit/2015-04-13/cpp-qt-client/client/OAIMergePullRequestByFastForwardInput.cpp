...
OAIMergePullRequestByFastForwardInput::OAIMergePullRequestByFastForwardInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMergePullRequestByFastForwardInput::OAIMergePullRequestByFastForwardInput() {
    this->initializeModel();
}

OAIMergePullRequestByFastForwardInput::~OAIMergePullRequestByFastForwardInput() {}

void OAIMergePullRequestByFastForwardInput::initializeModel() {
...
void OAIMergePullRequestByFastForwardInput::fromJson(QString jsonString) {
...
void OAIMergePullRequestByFastForwardInput::fromJsonObject(QJsonObject json) {
...
QString OAIMergePullRequestByFastForwardInput::asJson() const {
...
QJsonObject OAIMergePullRequestByFastForwardInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIMergePullRequestByFastForwardInput::getPullRequestId() const {
    return m_pull_request_id;
}
void OAIMergePullRequestByFastForwardInput::setPullRequestId(const QString &pull_request_id) {
    m_pull_request_id = pull_request_id;
    m_pull_request_id_isSet = true;
}

bool OAIMergePullRequestByFastForwardInput::is_pull_request_id_Set() const{
    return m_pull_request_id_isSet;
}

bool OAIMergePullRequestByFastForwardInput::is_pull_request_id_Valid() const{
    return m_pull_request_id_isValid;
}

QString OAIMergePullRequestByFastForwardInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIMergePullRequestByFastForwardInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIMergePullRequestByFastForwardInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIMergePullRequestByFastForwardInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIMergePullRequestByFastForwardInput::getSourceCommitId() const {
    return m_source_commit_id;
}
void OAIMergePullRequestByFastForwardInput::setSourceCommitId(const QString &source_commit_id) {
    m_source_commit_id = source_commit_id;
    m_source_commit_id_isSet = true;
}

bool OAIMergePullRequestByFastForwardInput::is_source_commit_id_Set() const{
    return m_source_commit_id_isSet;
}

bool OAIMergePullRequestByFastForwardInput::is_source_commit_id_Valid() const{
    return m_source_commit_id_isValid;
}

bool OAIMergePullRequestByFastForwardInput::isSet() const {
...
bool OAIMergePullRequestByFastForwardInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_pull_request_id_isValid && m_repository_name_isValid && true;
}
