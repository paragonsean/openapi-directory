...
/*
 * OAIPostCommentForPullRequestInput.h
 *
 * 
 */

#ifndef OAIPostCommentForPullRequestInput_H
#define OAIPostCommentForPullRequestInput_H

#include <QJsonObject>

#include "OAIPostCommentForPullRequestInput_location.h"
#include <QString>
...
namespace OpenAPI {
class OAIPostCommentForPullRequestInput_location;

class OAIPostCommentForPullRequestInput : public OAIObject {
public:
    OAIPostCommentForPullRequestInput();
    OAIPostCommentForPullRequestInput(QString json);
    ~OAIPostCommentForPullRequestInput() override;
    ...
    OAIPostCommentForPullRequestInput_location getLocation() const;
    void setLocation(const OAIPostCommentForPullRequestInput_location &location);
...
private:
    ...
    OAIPostCommentForPullRequestInput_location m_location;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostCommentForPullRequestInput)

#endif // OAIPostCommentForPullRequestInput_H
