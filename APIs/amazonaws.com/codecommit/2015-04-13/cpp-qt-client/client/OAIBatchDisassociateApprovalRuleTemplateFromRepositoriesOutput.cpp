...
OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput::OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput::OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput() {
    this->initializeModel();
}

OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput::~OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput() {}

void OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput::initializeModel() {

    m_disassociated_repository_names_isSet = false;
    m_disassociated_repository_names_isValid = false;

    m_errors_isSet = false;
    m_errors_isValid = false;
}

void OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput::fromJson(QString jsonString) {
...
void OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput::fromJsonObject(QJsonObject json) {

    m_disassociated_repository_names_isValid = ::OpenAPI::fromJsonValue(m_disassociated_repository_names, json[QString("disassociatedRepositoryNames")]);
    m_disassociated_repository_names_isSet = !json[QString("disassociatedRepositoryNames")].isNull() && m_disassociated_repository_names_isValid;

    m_errors_isValid = ::OpenAPI::fromJsonValue(m_errors, json[QString("errors")]);
    m_errors_isSet = !json[QString("errors")].isNull() && m_errors_isValid;
}

QString OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput::asJson() const {
...
QJsonObject OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_disassociated_repository_names.isSet()) {
        obj.insert(QString("disassociatedRepositoryNames"), ::OpenAPI::toJsonValue(m_disassociated_repository_names));
    }
    if (m_errors.isSet()) {
...
QList OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput::getDisassociatedRepositoryNames() const {
    return m_disassociated_repository_names;
}
void OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput::setDisassociatedRepositoryNames(const QList &disassociated_repository_names) {
    m_disassociated_repository_names = disassociated_repository_names;
    m_disassociated_repository_names_isSet = true;
}

bool OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput::is_disassociated_repository_names_Set() const{
    return m_disassociated_repository_names_isSet;
}

bool OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput::is_disassociated_repository_names_Valid() const{
    return m_disassociated_repository_names_isValid;
}

QList OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput::getErrors() const {
    return m_errors;
}
void OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput::setErrors(const QList &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput::is_errors_Valid() const{
    return m_errors_isValid;
}

bool OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput::isSet() const {
...
bool OAIBatchDisassociateApprovalRuleTemplateFromRepositoriesOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_disassociated_repository_names_isValid && m_errors_isValid && true;
}
