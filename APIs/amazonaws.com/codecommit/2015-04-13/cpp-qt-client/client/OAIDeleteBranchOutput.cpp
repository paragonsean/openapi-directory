...
OAIDeleteBranchOutput::OAIDeleteBranchOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteBranchOutput::OAIDeleteBranchOutput() {
    this->initializeModel();
}

OAIDeleteBranchOutput::~OAIDeleteBranchOutput() {}

void OAIDeleteBranchOutput::initializeModel() {

    m_deleted_branch_isSet = false;
    m_deleted_branch_isValid = false;
}

void OAIDeleteBranchOutput::fromJson(QString jsonString) {
...
void OAIDeleteBranchOutput::fromJsonObject(QJsonObject json) {

    m_deleted_branch_isValid = ::OpenAPI::fromJsonValue(m_deleted_branch, json[QString("deletedBranch")]);
    m_deleted_branch_isSet = !json[QString("deletedBranch")].isNull() && m_deleted_branch_isValid;
}

QString OAIDeleteBranchOutput::asJson() const {
...
QJsonObject OAIDeleteBranchOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_deleted_branch.isSet()) {
        obj.insert(QString("deletedBranch"), ::OpenAPI::toJsonValue(m_deleted_branch));
    }
    return obj;
}

OAIDeleteBranchOutput_deletedBranch OAIDeleteBranchOutput::getDeletedBranch() const {
    return m_deleted_branch;
}
void OAIDeleteBranchOutput::setDeletedBranch(const OAIDeleteBranchOutput_deletedBranch &deleted_branch) {
    m_deleted_branch = deleted_branch;
    m_deleted_branch_isSet = true;
}

bool OAIDeleteBranchOutput::is_deleted_branch_Set() const{
    return m_deleted_branch_isSet;
}

bool OAIDeleteBranchOutput::is_deleted_branch_Valid() const{
    return m_deleted_branch_isValid;
}

bool OAIDeleteBranchOutput::isSet() const {
...
bool OAIDeleteBranchOutput::isValid() const {
