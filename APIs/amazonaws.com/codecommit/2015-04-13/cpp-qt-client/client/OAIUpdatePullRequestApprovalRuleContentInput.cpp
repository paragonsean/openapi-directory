...
OAIUpdatePullRequestApprovalRuleContentInput::OAIUpdatePullRequestApprovalRuleContentInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePullRequestApprovalRuleContentInput::OAIUpdatePullRequestApprovalRuleContentInput() {
    this->initializeModel();
}

OAIUpdatePullRequestApprovalRuleContentInput::~OAIUpdatePullRequestApprovalRuleContentInput() {}

void OAIUpdatePullRequestApprovalRuleContentInput::initializeModel() {
    ...
    m_existing_rule_content_sha256_isSet = false;
    m_existing_rule_content_sha256_isValid = false;

    m_new_rule_content_isSet = false;
    m_new_rule_content_isValid = false;
}

void OAIUpdatePullRequestApprovalRuleContentInput::fromJson(QString jsonString) {
...
void OAIUpdatePullRequestApprovalRuleContentInput::fromJsonObject(QJsonObject json) {
    ...
    m_existing_rule_content_sha256_isValid = ::OpenAPI::fromJsonValue(m_existing_rule_content_sha256, json[QString("existingRuleContentSha256")]);
    m_existing_rule_content_sha256_isSet = !json[QString("existingRuleContentSha256")].isNull() && m_existing_rule_content_sha256_isValid;

    m_new_rule_content_isValid = ::OpenAPI::fromJsonValue(m_new_rule_content, json[QString("newRuleContent")]);
    m_new_rule_content_isSet = !json[QString("newRuleContent")].isNull() && m_new_rule_content_isValid;
}

QString OAIUpdatePullRequestApprovalRuleContentInput::asJson() const {
...
QJsonObject OAIUpdatePullRequestApprovalRuleContentInput::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_existing_rule_content_sha256_isSet) {
        obj.insert(QString("existingRuleContentSha256"), ::OpenAPI::toJsonValue(m_existing_rule_content_sha256));
    }
    if (m_new_rule_content_isSet) {
        obj.insert(QString("newRuleContent"), ::OpenAPI::toJsonValue(m_new_rule_content));
    }
    return obj;
}

QString OAIUpdatePullRequestApprovalRuleContentInput::getPullRequestId() const {
    return m_pull_request_id;
}
void OAIUpdatePullRequestApprovalRuleContentInput::setPullRequestId(const QString &pull_request_id) {
    m_pull_request_id = pull_request_id;
    m_pull_request_id_isSet = true;
}

bool OAIUpdatePullRequestApprovalRuleContentInput::is_pull_request_id_Set() const{
    return m_pull_request_id_isSet;
}

bool OAIUpdatePullRequestApprovalRuleContentInput::is_pull_request_id_Valid() const{
    return m_pull_request_id_isValid;
}

QString OAIUpdatePullRequestApprovalRuleContentInput::getApprovalRuleName() const {
    return m_approval_rule_name;
}
void OAIUpdatePullRequestApprovalRuleContentInput::setApprovalRuleName(const QString &approval_rule_name) {
    m_approval_rule_name = approval_rule_name;
    m_approval_rule_name_isSet = true;
}

bool OAIUpdatePullRequestApprovalRuleContentInput::is_approval_rule_name_Set() const{
    return m_approval_rule_name_isSet;
}

bool OAIUpdatePullRequestApprovalRuleContentInput::is_approval_rule_name_Valid() const{
    return m_approval_rule_name_isValid;
}

QString OAIUpdatePullRequestApprovalRuleContentInput::getExistingRuleContentSha256() const {
    return m_existing_rule_content_sha256;
}
void OAIUpdatePullRequestApprovalRuleContentInput::setExistingRuleContentSha256(const QString &existing_rule_content_sha256) {
    m_existing_rule_content_sha256 = existing_rule_content_sha256;
    m_existing_rule_content_sha256_isSet = true;
}

bool OAIUpdatePullRequestApprovalRuleContentInput::is_existing_rule_content_sha256_Set() const{
    return m_existing_rule_content_sha256_isSet;
}

bool OAIUpdatePullRequestApprovalRuleContentInput::is_existing_rule_content_sha256_Valid() const{
    return m_existing_rule_content_sha256_isValid;
}

QString OAIUpdatePullRequestApprovalRuleContentInput::getNewRuleContent() const {
    return m_new_rule_content;
}
void OAIUpdatePullRequestApprovalRuleContentInput::setNewRuleContent(const QString &new_rule_content) {
    m_new_rule_content = new_rule_content;
    m_new_rule_content_isSet = true;
}

bool OAIUpdatePullRequestApprovalRuleContentInput::is_new_rule_content_Set() const{
    return m_new_rule_content_isSet;
}

bool OAIUpdatePullRequestApprovalRuleContentInput::is_new_rule_content_Valid() const{
    return m_new_rule_content_isValid;
}

bool OAIUpdatePullRequestApprovalRuleContentInput::isSet() const {
...
bool OAIUpdatePullRequestApprovalRuleContentInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_pull_request_id_isValid && m_approval_rule_name_isValid && m_new_rule_content_isValid && true;
}
