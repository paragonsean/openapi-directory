...
/*
 * OAIPullRequestSourceReferenceUpdatedEventMetadata.h
 *
 * Information about an update to the source branch of a pull request.
 */

#ifndef OAIPullRequestSourceReferenceUpdatedEventMetadata_H
#define OAIPullRequestSourceReferenceUpdatedEventMetadata_H
...
class OAIPullRequestSourceReferenceUpdatedEventMetadata : public OAIObject {
public:
    OAIPullRequestSourceReferenceUpdatedEventMetadata();
    OAIPullRequestSourceReferenceUpdatedEventMetadata(QString json);
    ~OAIPullRequestSourceReferenceUpdatedEventMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPullRequestSourceReferenceUpdatedEventMetadata)

#endif // OAIPullRequestSourceReferenceUpdatedEventMetadata_H
