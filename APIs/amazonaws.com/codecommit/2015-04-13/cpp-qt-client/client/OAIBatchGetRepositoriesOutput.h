...
/*
 * OAIBatchGetRepositoriesOutput.h
 *
 * Represents the output of a batch get repositories operation.
 */

#ifndef OAIBatchGetRepositoriesOutput_H
#define OAIBatchGetRepositoriesOutput_H
...
class OAIBatchGetRepositoriesOutput : public OAIObject {
public:
    OAIBatchGetRepositoriesOutput();
    OAIBatchGetRepositoriesOutput(QString json);
    ~OAIBatchGetRepositoriesOutput() override;
    ...
    QList getRepositoriesNotFound() const;
    void setRepositoriesNotFound(const QList &repositories_not_found);
    bool is_repositories_not_found_Set() const;
    bool is_repositories_not_found_Valid() const;
...
private:
    ...
    QList m_repositories_not_found;
    bool m_repositories_not_found_isSet;
    bool m_repositories_not_found_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIBatchGetRepositoriesOutput)

#endif // OAIBatchGetRepositoriesOutput_H
