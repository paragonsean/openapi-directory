...
#include "OAISourceFileSpecifier.h"
...
OAISourceFileSpecifier::OAISourceFileSpecifier(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISourceFileSpecifier::OAISourceFileSpecifier() {
    this->initializeModel();
}

OAISourceFileSpecifier::~OAISourceFileSpecifier() {}

void OAISourceFileSpecifier::initializeModel() {
...
void OAISourceFileSpecifier::fromJson(QString jsonString) {
...
void OAISourceFileSpecifier::fromJsonObject(QJsonObject json) {
...
QString OAISourceFileSpecifier::asJson() const {
...
QJsonObject OAISourceFileSpecifier::asJsonObject() const {
    QJsonObject obj;
...
QString OAISourceFileSpecifier::getFilePath() const {
    return m_file_path;
}
void OAISourceFileSpecifier::setFilePath(const QString &file_path) {
    m_file_path = file_path;
    m_file_path_isSet = true;
}

bool OAISourceFileSpecifier::is_file_path_Set() const{
    return m_file_path_isSet;
}

bool OAISourceFileSpecifier::is_file_path_Valid() const{
    return m_file_path_isValid;
}

bool OAISourceFileSpecifier::getIsMove() const {
    return m_is_move;
}
void OAISourceFileSpecifier::setIsMove(const bool &is_move) {
    m_is_move = is_move;
    m_is_move_isSet = true;
}

bool OAISourceFileSpecifier::is_is_move_Set() const{
    return m_is_move_isSet;
}

bool OAISourceFileSpecifier::is_is_move_Valid() const{
    return m_is_move_isValid;
}

bool OAISourceFileSpecifier::isSet() const {
...
bool OAISourceFileSpecifier::isValid() const {
