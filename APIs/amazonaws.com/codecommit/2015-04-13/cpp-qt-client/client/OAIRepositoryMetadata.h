...
/*
 * OAIRepositoryMetadata.h
 *
 * Information about a repository.
 */

#ifndef OAIRepositoryMetadata_H
#define OAIRepositoryMetadata_H
...
class OAIRepositoryMetadata : public OAIObject {
public:
    OAIRepositoryMetadata();
    OAIRepositoryMetadata(QString json);
    ~OAIRepositoryMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRepositoryMetadata)

#endif // OAIRepositoryMetadata_H
