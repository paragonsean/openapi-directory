...
#include "OAIReactionValueFormats.h"
...
OAIReactionValueFormats::OAIReactionValueFormats(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReactionValueFormats::OAIReactionValueFormats() {
    this->initializeModel();
}

OAIReactionValueFormats::~OAIReactionValueFormats() {}

void OAIReactionValueFormats::initializeModel() {
...
void OAIReactionValueFormats::fromJson(QString jsonString) {
...
void OAIReactionValueFormats::fromJsonObject(QJsonObject json) {
...
QString OAIReactionValueFormats::asJson() const {
...
QJsonObject OAIReactionValueFormats::asJsonObject() const {
    QJsonObject obj;
    if (m_emoji_isSet) {
...
QString OAIReactionValueFormats::getEmoji() const {
    return m_emoji;
}
void OAIReactionValueFormats::setEmoji(const QString &emoji) {
    m_emoji = emoji;
    m_emoji_isSet = true;
}

bool OAIReactionValueFormats::is_emoji_Set() const{
    return m_emoji_isSet;
}

bool OAIReactionValueFormats::is_emoji_Valid() const{
    return m_emoji_isValid;
}

QString OAIReactionValueFormats::getShortCode() const {
    return m_short_code;
}
void OAIReactionValueFormats::setShortCode(const QString &short_code) {
    m_short_code = short_code;
    m_short_code_isSet = true;
}

bool OAIReactionValueFormats::is_short_code_Set() const{
    return m_short_code_isSet;
}

bool OAIReactionValueFormats::is_short_code_Valid() const{
    return m_short_code_isValid;
}

QString OAIReactionValueFormats::getUnicode() const {
    return m_unicode;
}
void OAIReactionValueFormats::setUnicode(const QString &unicode) {
    m_unicode = unicode;
    m_unicode_isSet = true;
}

bool OAIReactionValueFormats::is_unicode_Set() const{
    return m_unicode_isSet;
}

bool OAIReactionValueFormats::is_unicode_Valid() const{
    return m_unicode_isValid;
}

bool OAIReactionValueFormats::isSet() const {
...
bool OAIReactionValueFormats::isValid() const {
