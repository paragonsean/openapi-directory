...
/*
 * OAIOriginApprovalRuleTemplate.h
 *
 * Returns information about the template that created the approval rule for a pull request.
 */

#ifndef OAIOriginApprovalRuleTemplate_H
#define OAIOriginApprovalRuleTemplate_H
...
class OAIOriginApprovalRuleTemplate : public OAIObject {
public:
    OAIOriginApprovalRuleTemplate();
    OAIOriginApprovalRuleTemplate(QString json);
    ~OAIOriginApprovalRuleTemplate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOriginApprovalRuleTemplate)

#endif // OAIOriginApprovalRuleTemplate_H
