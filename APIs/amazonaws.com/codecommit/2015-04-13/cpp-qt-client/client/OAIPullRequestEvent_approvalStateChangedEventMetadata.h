...
/*
 * OAIPullRequestEvent_approvalStateChangedEventMetadata.h
 *
 * 
 */

#ifndef OAIPullRequestEvent_approvalStateChangedEventMetadata_H
#define OAIPullRequestEvent_approvalStateChangedEventMetadata_H
...
class OAIPullRequestEvent_approvalStateChangedEventMetadata : public OAIObject {
public:
    OAIPullRequestEvent_approvalStateChangedEventMetadata();
    OAIPullRequestEvent_approvalStateChangedEventMetadata(QString json);
    ~OAIPullRequestEvent_approvalStateChangedEventMetadata() override;
    ...
    OAIApprovalState getApprovalStatus() const;
    void setApprovalStatus(const OAIApprovalState &approval_status);
...
private:
    ...
    OAIApprovalState m_approval_status;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPullRequestEvent_approvalStateChangedEventMetadata)

#endif // OAIPullRequestEvent_approvalStateChangedEventMetadata_H
