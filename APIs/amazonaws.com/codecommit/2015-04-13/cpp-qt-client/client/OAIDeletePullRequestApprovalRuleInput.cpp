...
OAIDeletePullRequestApprovalRuleInput::OAIDeletePullRequestApprovalRuleInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeletePullRequestApprovalRuleInput::OAIDeletePullRequestApprovalRuleInput() {
    this->initializeModel();
}

OAIDeletePullRequestApprovalRuleInput::~OAIDeletePullRequestApprovalRuleInput() {}

void OAIDeletePullRequestApprovalRuleInput::initializeModel() {

    m_pull_request_id_isSet = false;
    m_pull_request_id_isValid = false;

    m_approval_rule_name_isSet = false;
    m_approval_rule_name_isValid = false;
}

void OAIDeletePullRequestApprovalRuleInput::fromJson(QString jsonString) {
...
void OAIDeletePullRequestApprovalRuleInput::fromJsonObject(QJsonObject json) {
    ...
    m_approval_rule_name_isValid = ::OpenAPI::fromJsonValue(m_approval_rule_name, json[QString("approvalRuleName")]);
    m_approval_rule_name_isSet = !json[QString("approvalRuleName")].isNull() && m_approval_rule_name_isValid;
}

QString OAIDeletePullRequestApprovalRuleInput::asJson() const {
...
QJsonObject OAIDeletePullRequestApprovalRuleInput::asJsonObject() const {
    QJsonObject obj;
    if (m_pull_request_id_isSet) {
        obj.insert(QString("pullRequestId"), ::OpenAPI::toJsonValue(m_pull_request_id));
    }
    if (m_approval_rule_name_isSet) {
        obj.insert(QString("approvalRuleName"), ::OpenAPI::toJsonValue(m_approval_rule_name));
    }
    return obj;
}

QString OAIDeletePullRequestApprovalRuleInput::getPullRequestId() const {
    return m_pull_request_id;
}
void OAIDeletePullRequestApprovalRuleInput::setPullRequestId(const QString &pull_request_id) {
    m_pull_request_id = pull_request_id;
    m_pull_request_id_isSet = true;
}

bool OAIDeletePullRequestApprovalRuleInput::is_pull_request_id_Set() const{
    return m_pull_request_id_isSet;
}

bool OAIDeletePullRequestApprovalRuleInput::is_pull_request_id_Valid() const{
    return m_pull_request_id_isValid;
}

QString OAIDeletePullRequestApprovalRuleInput::getApprovalRuleName() const {
    return m_approval_rule_name;
}
void OAIDeletePullRequestApprovalRuleInput::setApprovalRuleName(const QString &approval_rule_name) {
    m_approval_rule_name = approval_rule_name;
    m_approval_rule_name_isSet = true;
}

bool OAIDeletePullRequestApprovalRuleInput::is_approval_rule_name_Set() const{
    return m_approval_rule_name_isSet;
}

bool OAIDeletePullRequestApprovalRuleInput::is_approval_rule_name_Valid() const{
    return m_approval_rule_name_isValid;
}

bool OAIDeletePullRequestApprovalRuleInput::isSet() const {
...
bool OAIDeletePullRequestApprovalRuleInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_pull_request_id_isValid && m_approval_rule_name_isValid && true;
}
