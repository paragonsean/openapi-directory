...
OAIConflictMetadata_fileModes::OAIConflictMetadata_fileModes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConflictMetadata_fileModes::OAIConflictMetadata_fileModes() {
    this->initializeModel();
}

OAIConflictMetadata_fileModes::~OAIConflictMetadata_fileModes() {}

void OAIConflictMetadata_fileModes::initializeModel() {
...
void OAIConflictMetadata_fileModes::fromJson(QString jsonString) {
...
void OAIConflictMetadata_fileModes::fromJsonObject(QJsonObject json) {
...
QString OAIConflictMetadata_fileModes::asJson() const {
...
QJsonObject OAIConflictMetadata_fileModes::asJsonObject() const {
    QJsonObject obj;
    if (m_source.isSet()) {
...
OAIFileModeTypeEnum OAIConflictMetadata_fileModes::getSource() const {
    return m_source;
}
void OAIConflictMetadata_fileModes::setSource(const OAIFileModeTypeEnum &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAIConflictMetadata_fileModes::is_source_Set() const{
    return m_source_isSet;
}

bool OAIConflictMetadata_fileModes::is_source_Valid() const{
    return m_source_isValid;
}

OAIFileModeTypeEnum OAIConflictMetadata_fileModes::getDestination() const {
    return m_destination;
}
void OAIConflictMetadata_fileModes::setDestination(const OAIFileModeTypeEnum &destination) {
    m_destination = destination;
    m_destination_isSet = true;
}

bool OAIConflictMetadata_fileModes::is_destination_Set() const{
    return m_destination_isSet;
}

bool OAIConflictMetadata_fileModes::is_destination_Valid() const{
    return m_destination_isValid;
}

OAIFileModeTypeEnum OAIConflictMetadata_fileModes::getBase() const {
    return m_base;
}
void OAIConflictMetadata_fileModes::setBase(const OAIFileModeTypeEnum &base) {
    m_base = base;
    m_base_isSet = true;
}

bool OAIConflictMetadata_fileModes::is_base_Set() const{
    return m_base_isSet;
}

bool OAIConflictMetadata_fileModes::is_base_Valid() const{
    return m_base_isValid;
}

bool OAIConflictMetadata_fileModes::isSet() const {
...
bool OAIConflictMetadata_fileModes::isValid() const {
