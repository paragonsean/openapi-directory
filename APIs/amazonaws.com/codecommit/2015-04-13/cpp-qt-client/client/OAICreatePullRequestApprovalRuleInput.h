...
/*
 * OAICreatePullRequestApprovalRuleInput.h
 *
 * 
 */

#ifndef OAICreatePullRequestApprovalRuleInput_H
#define OAICreatePullRequestApprovalRuleInput_H
...
class OAICreatePullRequestApprovalRuleInput : public OAIObject {
public:
    OAICreatePullRequestApprovalRuleInput();
    OAICreatePullRequestApprovalRuleInput(QString json);
    ~OAICreatePullRequestApprovalRuleInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePullRequestApprovalRuleInput)

#endif // OAICreatePullRequestApprovalRuleInput_H
