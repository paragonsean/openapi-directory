...
/*
 * OAIPostCommentForComparedCommitOutput_location.h
 *
 * 
 */

#ifndef OAIPostCommentForComparedCommitOutput_location_H
#define OAIPostCommentForComparedCommitOutput_location_H
...
class OAIPostCommentForComparedCommitOutput_location : public OAIObject {
public:
    OAIPostCommentForComparedCommitOutput_location();
    OAIPostCommentForComparedCommitOutput_location(QString json);
    ~OAIPostCommentForComparedCommitOutput_location() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostCommentForComparedCommitOutput_location)

#endif // OAIPostCommentForComparedCommitOutput_location_H
