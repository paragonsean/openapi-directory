...
#include "OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate.h"
...
OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate() {
    this->initializeModel();
}

OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::~OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate() {}

void OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::initializeModel() {
...
void OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::fromJson(QString jsonString) {
...
void OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::fromJsonObject(QJsonObject json) {
...
QString OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::asJson() const {
...
QJsonObject OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::getApprovalRuleTemplateId() const {
    return m_approval_rule_template_id;
}
void OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::setApprovalRuleTemplateId(const QString &approval_rule_template_id) {
    m_approval_rule_template_id = approval_rule_template_id;
    m_approval_rule_template_id_isSet = true;
}

bool OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::is_approval_rule_template_id_Set() const{
    return m_approval_rule_template_id_isSet;
}

bool OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::is_approval_rule_template_id_Valid() const{
    return m_approval_rule_template_id_isValid;
}

QString OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::getApprovalRuleTemplateName() const {
    return m_approval_rule_template_name;
}
void OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::setApprovalRuleTemplateName(const QString &approval_rule_template_name) {
    m_approval_rule_template_name = approval_rule_template_name;
    m_approval_rule_template_name_isSet = true;
}

bool OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::is_approval_rule_template_name_Set() const{
    return m_approval_rule_template_name_isSet;
}

bool OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::is_approval_rule_template_name_Valid() const{
    return m_approval_rule_template_name_isValid;
}

QString OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::getApprovalRuleTemplateDescription() const {
    return m_approval_rule_template_description;
}
void OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::setApprovalRuleTemplateDescription(const QString &approval_rule_template_description) {
    m_approval_rule_template_description = approval_rule_template_description;
    m_approval_rule_template_description_isSet = true;
}

bool OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::is_approval_rule_template_description_Set() const{
    return m_approval_rule_template_description_isSet;
}

bool OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::is_approval_rule_template_description_Valid() const{
    return m_approval_rule_template_description_isValid;
}

QString OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::getApprovalRuleTemplateContent() const {
    return m_approval_rule_template_content;
}
void OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::setApprovalRuleTemplateContent(const QString &approval_rule_template_content) {
    m_approval_rule_template_content = approval_rule_template_content;
    m_approval_rule_template_content_isSet = true;
}

bool OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::is_approval_rule_template_content_Set() const{
    return m_approval_rule_template_content_isSet;
}

bool OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::is_approval_rule_template_content_Valid() const{
    return m_approval_rule_template_content_isValid;
}

QString OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::getRuleContentSha256() const {
    return m_rule_content_sha256;
}
void OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::setRuleContentSha256(const QString &rule_content_sha256) {
    m_rule_content_sha256 = rule_content_sha256;
    m_rule_content_sha256_isSet = true;
}

bool OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::is_rule_content_sha256_Set() const{
    return m_rule_content_sha256_isSet;
}

bool OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::is_rule_content_sha256_Valid() const{
    return m_rule_content_sha256_isValid;
}

QDateTime OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::getLastModifiedDate() const {
    return m_last_modified_date;
}
void OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::setLastModifiedDate(const QDateTime &last_modified_date) {
    m_last_modified_date = last_modified_date;
    m_last_modified_date_isSet = true;
}

bool OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::is_last_modified_date_Set() const{
    return m_last_modified_date_isSet;
}

bool OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::is_last_modified_date_Valid() const{
    return m_last_modified_date_isValid;
}

QDateTime OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::getCreationDate() const {
    return m_creation_date;
}
void OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

QString OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::getLastModifiedUser() const {
    return m_last_modified_user;
}
void OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::setLastModifiedUser(const QString &last_modified_user) {
    m_last_modified_user = last_modified_user;
    m_last_modified_user_isSet = true;
}

bool OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::is_last_modified_user_Set() const{
    return m_last_modified_user_isSet;
}

bool OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::is_last_modified_user_Valid() const{
    return m_last_modified_user_isValid;
}

bool OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::isSet() const {
...
bool OAICreateApprovalRuleTemplateOutput_approvalRuleTemplate::isValid() const {
