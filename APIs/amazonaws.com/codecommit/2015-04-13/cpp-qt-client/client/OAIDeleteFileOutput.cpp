...
OAIDeleteFileOutput::OAIDeleteFileOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteFileOutput::OAIDeleteFileOutput() {
    this->initializeModel();
}

OAIDeleteFileOutput::~OAIDeleteFileOutput() {}

void OAIDeleteFileOutput::initializeModel() {
...
void OAIDeleteFileOutput::fromJson(QString jsonString) {
...
void OAIDeleteFileOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteFileOutput::asJson() const {
...
QJsonObject OAIDeleteFileOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteFileOutput::getCommitId() const {
    return m_commit_id;
}
void OAIDeleteFileOutput::setCommitId(const QString &commit_id) {
    m_commit_id = commit_id;
    m_commit_id_isSet = true;
}

bool OAIDeleteFileOutput::is_commit_id_Set() const{
    return m_commit_id_isSet;
}

bool OAIDeleteFileOutput::is_commit_id_Valid() const{
    return m_commit_id_isValid;
}

QString OAIDeleteFileOutput::getBlobId() const {
    return m_blob_id;
}
void OAIDeleteFileOutput::setBlobId(const QString &blob_id) {
    m_blob_id = blob_id;
    m_blob_id_isSet = true;
}

bool OAIDeleteFileOutput::is_blob_id_Set() const{
    return m_blob_id_isSet;
}

bool OAIDeleteFileOutput::is_blob_id_Valid() const{
    return m_blob_id_isValid;
}

QString OAIDeleteFileOutput::getTreeId() const {
    return m_tree_id;
}
void OAIDeleteFileOutput::setTreeId(const QString &tree_id) {
    m_tree_id = tree_id;
    m_tree_id_isSet = true;
}

bool OAIDeleteFileOutput::is_tree_id_Set() const{
    return m_tree_id_isSet;
}

bool OAIDeleteFileOutput::is_tree_id_Valid() const{
    return m_tree_id_isValid;
}

QString OAIDeleteFileOutput::getFilePath() const {
    return m_file_path;
}
void OAIDeleteFileOutput::setFilePath(const QString &file_path) {
    m_file_path = file_path;
    m_file_path_isSet = true;
}

bool OAIDeleteFileOutput::is_file_path_Set() const{
    return m_file_path_isSet;
}

bool OAIDeleteFileOutput::is_file_path_Valid() const{
    return m_file_path_isValid;
}

bool OAIDeleteFileOutput::isSet() const {
...
bool OAIDeleteFileOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_commit_id_isValid && m_blob_id_isValid && m_tree_id_isValid && m_file_path_isValid && true;
}
