...
/*
 * OAIGetDifferencesInput.h
 *
 * 
 */

#ifndef OAIGetDifferencesInput_H
#define OAIGetDifferencesInput_H
...
class OAIGetDifferencesInput : public OAIObject {
public:
    OAIGetDifferencesInput();
    OAIGetDifferencesInput(QString json);
    ~OAIGetDifferencesInput() override;
    ...
    QString getBeforeCommitSpecifier() const;
    void setBeforeCommitSpecifier(const QString &before_commit_specifier);
    bool is_before_commit_specifier_Set() const;
    bool is_before_commit_specifier_Valid() const;

    QString getAfterCommitSpecifier() const;
    void setAfterCommitSpecifier(const QString &after_commit_specifier);
    bool is_after_commit_specifier_Set() const;
    bool is_after_commit_specifier_Valid() const;

    QString getBeforePath() const;
    void setBeforePath(const QString &before_path);
    bool is_before_path_Set() const;
    bool is_before_path_Valid() const;

    QString getAfterPath() const;
    void setAfterPath(const QString &after_path);
    bool is_after_path_Set() const;
    bool is_after_path_Valid() const;
...
private:
    ...
    QString m_before_commit_specifier;
    bool m_before_commit_specifier_isSet;
    bool m_before_commit_specifier_isValid;

    QString m_after_commit_specifier;
    bool m_after_commit_specifier_isSet;
    bool m_after_commit_specifier_isValid;

    QString m_before_path;
    bool m_before_path_isSet;
    bool m_before_path_isValid;

    QString m_after_path;
    bool m_after_path_isSet;
    bool m_after_path_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDifferencesInput)

#endif // OAIGetDifferencesInput_H
