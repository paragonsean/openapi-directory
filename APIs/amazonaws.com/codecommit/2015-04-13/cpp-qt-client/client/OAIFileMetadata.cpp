...
OAIFileMetadata::OAIFileMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFileMetadata::OAIFileMetadata() {
    this->initializeModel();
}

OAIFileMetadata::~OAIFileMetadata() {}

void OAIFileMetadata::initializeModel() {
...
void OAIFileMetadata::fromJson(QString jsonString) {
...
void OAIFileMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIFileMetadata::asJson() const {
...
QJsonObject OAIFileMetadata::asJsonObject() const {
    QJsonObject obj;
...
QString OAIFileMetadata::getAbsolutePath() const {
    return m_absolute_path;
}
void OAIFileMetadata::setAbsolutePath(const QString &absolute_path) {
    m_absolute_path = absolute_path;
    m_absolute_path_isSet = true;
}

bool OAIFileMetadata::is_absolute_path_Set() const{
    return m_absolute_path_isSet;
}

bool OAIFileMetadata::is_absolute_path_Valid() const{
    return m_absolute_path_isValid;
}

QString OAIFileMetadata::getBlobId() const {
    return m_blob_id;
}
void OAIFileMetadata::setBlobId(const QString &blob_id) {
    m_blob_id = blob_id;
    m_blob_id_isSet = true;
}

bool OAIFileMetadata::is_blob_id_Set() const{
    return m_blob_id_isSet;
}

bool OAIFileMetadata::is_blob_id_Valid() const{
    return m_blob_id_isValid;
}

OAIFileModeTypeEnum OAIFileMetadata::getFileMode() const {
    return m_file_mode;
}
void OAIFileMetadata::setFileMode(const OAIFileModeTypeEnum &file_mode) {
    m_file_mode = file_mode;
    m_file_mode_isSet = true;
}

bool OAIFileMetadata::is_file_mode_Set() const{
    return m_file_mode_isSet;
}

bool OAIFileMetadata::is_file_mode_Valid() const{
    return m_file_mode_isValid;
}

bool OAIFileMetadata::isSet() const {
...
bool OAIFileMetadata::isValid() const {
