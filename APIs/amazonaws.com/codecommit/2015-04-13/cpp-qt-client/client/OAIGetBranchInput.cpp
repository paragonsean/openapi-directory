...
OAIGetBranchInput::OAIGetBranchInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetBranchInput::OAIGetBranchInput() {
    this->initializeModel();
}

OAIGetBranchInput::~OAIGetBranchInput() {}

void OAIGetBranchInput::initializeModel() {
...
void OAIGetBranchInput::fromJson(QString jsonString) {
...
void OAIGetBranchInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetBranchInput::asJson() const {
...
QJsonObject OAIGetBranchInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetBranchInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIGetBranchInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIGetBranchInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIGetBranchInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIGetBranchInput::getBranchName() const {
    return m_branch_name;
}
void OAIGetBranchInput::setBranchName(const QString &branch_name) {
    m_branch_name = branch_name;
    m_branch_name_isSet = true;
}

bool OAIGetBranchInput::is_branch_name_Set() const{
    return m_branch_name_isSet;
}

bool OAIGetBranchInput::is_branch_name_Valid() const{
    return m_branch_name_isValid;
}

bool OAIGetBranchInput::isSet() const {
...
bool OAIGetBranchInput::isValid() const {
