...
OAIApprovalRule::OAIApprovalRule(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIApprovalRule::OAIApprovalRule() {
    this->initializeModel();
}

OAIApprovalRule::~OAIApprovalRule() {}

void OAIApprovalRule::initializeModel() {
...
void OAIApprovalRule::fromJson(QString jsonString) {
...
void OAIApprovalRule::fromJsonObject(QJsonObject json) {
...
QString OAIApprovalRule::asJson() const {
...
QJsonObject OAIApprovalRule::asJsonObject() const {
    QJsonObject obj;
...
QString OAIApprovalRule::getApprovalRuleId() const {
    return m_approval_rule_id;
}
void OAIApprovalRule::setApprovalRuleId(const QString &approval_rule_id) {
    m_approval_rule_id = approval_rule_id;
    m_approval_rule_id_isSet = true;
}

bool OAIApprovalRule::is_approval_rule_id_Set() const{
    return m_approval_rule_id_isSet;
}

bool OAIApprovalRule::is_approval_rule_id_Valid() const{
    return m_approval_rule_id_isValid;
}

QString OAIApprovalRule::getApprovalRuleName() const {
    return m_approval_rule_name;
}
void OAIApprovalRule::setApprovalRuleName(const QString &approval_rule_name) {
    m_approval_rule_name = approval_rule_name;
    m_approval_rule_name_isSet = true;
}

bool OAIApprovalRule::is_approval_rule_name_Set() const{
    return m_approval_rule_name_isSet;
}

bool OAIApprovalRule::is_approval_rule_name_Valid() const{
    return m_approval_rule_name_isValid;
}

QString OAIApprovalRule::getApprovalRuleContent() const {
    return m_approval_rule_content;
}
void OAIApprovalRule::setApprovalRuleContent(const QString &approval_rule_content) {
    m_approval_rule_content = approval_rule_content;
    m_approval_rule_content_isSet = true;
}

bool OAIApprovalRule::is_approval_rule_content_Set() const{
    return m_approval_rule_content_isSet;
}

bool OAIApprovalRule::is_approval_rule_content_Valid() const{
    return m_approval_rule_content_isValid;
}

QString OAIApprovalRule::getRuleContentSha256() const {
    return m_rule_content_sha256;
}
void OAIApprovalRule::setRuleContentSha256(const QString &rule_content_sha256) {
    m_rule_content_sha256 = rule_content_sha256;
    m_rule_content_sha256_isSet = true;
}

bool OAIApprovalRule::is_rule_content_sha256_Set() const{
    return m_rule_content_sha256_isSet;
}

bool OAIApprovalRule::is_rule_content_sha256_Valid() const{
    return m_rule_content_sha256_isValid;
}

QDateTime OAIApprovalRule::getLastModifiedDate() const {
    return m_last_modified_date;
}
void OAIApprovalRule::setLastModifiedDate(const QDateTime &last_modified_date) {
    m_last_modified_date = last_modified_date;
    m_last_modified_date_isSet = true;
}

bool OAIApprovalRule::is_last_modified_date_Set() const{
    return m_last_modified_date_isSet;
}

bool OAIApprovalRule::is_last_modified_date_Valid() const{
    return m_last_modified_date_isValid;
}

QDateTime OAIApprovalRule::getCreationDate() const {
    return m_creation_date;
}
void OAIApprovalRule::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAIApprovalRule::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAIApprovalRule::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

QString OAIApprovalRule::getLastModifiedUser() const {
    return m_last_modified_user;
}
void OAIApprovalRule::setLastModifiedUser(const QString &last_modified_user) {
    m_last_modified_user = last_modified_user;
    m_last_modified_user_isSet = true;
}

bool OAIApprovalRule::is_last_modified_user_Set() const{
    return m_last_modified_user_isSet;
}

bool OAIApprovalRule::is_last_modified_user_Valid() const{
    return m_last_modified_user_isValid;
}

OAIApprovalRule_originApprovalRuleTemplate OAIApprovalRule::getOriginApprovalRuleTemplate() const {
    return m_origin_approval_rule_template;
}
void OAIApprovalRule::setOriginApprovalRuleTemplate(const OAIApprovalRule_originApprovalRuleTemplate &origin_approval_rule_template) {
    m_origin_approval_rule_template = origin_approval_rule_template;
    m_origin_approval_rule_template_isSet = true;
}

bool OAIApprovalRule::is_origin_approval_rule_template_Set() const{
    return m_origin_approval_rule_template_isSet;
}

bool OAIApprovalRule::is_origin_approval_rule_template_Valid() const{
    return m_origin_approval_rule_template_isValid;
}

bool OAIApprovalRule::isSet() const {
...
bool OAIApprovalRule::isValid() const {
