...
OAIBatchGetCommitsOutput::OAIBatchGetCommitsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchGetCommitsOutput::OAIBatchGetCommitsOutput() {
    this->initializeModel();
}

OAIBatchGetCommitsOutput::~OAIBatchGetCommitsOutput() {}

void OAIBatchGetCommitsOutput::initializeModel() {
...
void OAIBatchGetCommitsOutput::fromJson(QString jsonString) {
...
void OAIBatchGetCommitsOutput::fromJsonObject(QJsonObject json) {
...
QString OAIBatchGetCommitsOutput::asJson() const {
...
QJsonObject OAIBatchGetCommitsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_commits.isSet()) {
...
QList OAIBatchGetCommitsOutput::getCommits() const {
    return m_commits;
}
void OAIBatchGetCommitsOutput::setCommits(const QList &commits) {
    m_commits = commits;
    m_commits_isSet = true;
}

bool OAIBatchGetCommitsOutput::is_commits_Set() const{
    return m_commits_isSet;
}

bool OAIBatchGetCommitsOutput::is_commits_Valid() const{
    return m_commits_isValid;
}

QList OAIBatchGetCommitsOutput::getErrors() const {
    return m_errors;
}
void OAIBatchGetCommitsOutput::setErrors(const QList &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIBatchGetCommitsOutput::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIBatchGetCommitsOutput::is_errors_Valid() const{
    return m_errors_isValid;
}

bool OAIBatchGetCommitsOutput::isSet() const {
...
bool OAIBatchGetCommitsOutput::isValid() const {
