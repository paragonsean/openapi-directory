...
OAIGetMergeCommitOutput::OAIGetMergeCommitOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetMergeCommitOutput::OAIGetMergeCommitOutput() {
    this->initializeModel();
}

OAIGetMergeCommitOutput::~OAIGetMergeCommitOutput() {}

void OAIGetMergeCommitOutput::initializeModel() {
    ...
    m_merged_commit_id_isSet = false;
    m_merged_commit_id_isValid = false;
}

void OAIGetMergeCommitOutput::fromJson(QString jsonString) {
...
void OAIGetMergeCommitOutput::fromJsonObject(QJsonObject json) {
    ...
    m_merged_commit_id_isValid = ::OpenAPI::fromJsonValue(m_merged_commit_id, json[QString("mergedCommitId")]);
    m_merged_commit_id_isSet = !json[QString("mergedCommitId")].isNull() && m_merged_commit_id_isValid;
}

QString OAIGetMergeCommitOutput::asJson() const {
...
QJsonObject OAIGetMergeCommitOutput::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_merged_commit_id_isSet) {
        obj.insert(QString("mergedCommitId"), ::OpenAPI::toJsonValue(m_merged_commit_id));
    }
    return obj;
}

QString OAIGetMergeCommitOutput::getSourceCommitId() const {
    return m_source_commit_id;
}
void OAIGetMergeCommitOutput::setSourceCommitId(const QString &source_commit_id) {
    m_source_commit_id = source_commit_id;
    m_source_commit_id_isSet = true;
}

bool OAIGetMergeCommitOutput::is_source_commit_id_Set() const{
    return m_source_commit_id_isSet;
}

bool OAIGetMergeCommitOutput::is_source_commit_id_Valid() const{
    return m_source_commit_id_isValid;
}

QString OAIGetMergeCommitOutput::getDestinationCommitId() const {
    return m_destination_commit_id;
}
void OAIGetMergeCommitOutput::setDestinationCommitId(const QString &destination_commit_id) {
    m_destination_commit_id = destination_commit_id;
    m_destination_commit_id_isSet = true;
}

bool OAIGetMergeCommitOutput::is_destination_commit_id_Set() const{
    return m_destination_commit_id_isSet;
}

bool OAIGetMergeCommitOutput::is_destination_commit_id_Valid() const{
    return m_destination_commit_id_isValid;
}

QString OAIGetMergeCommitOutput::getBaseCommitId() const {
    return m_base_commit_id;
}
void OAIGetMergeCommitOutput::setBaseCommitId(const QString &base_commit_id) {
    m_base_commit_id = base_commit_id;
    m_base_commit_id_isSet = true;
}

bool OAIGetMergeCommitOutput::is_base_commit_id_Set() const{
    return m_base_commit_id_isSet;
}

bool OAIGetMergeCommitOutput::is_base_commit_id_Valid() const{
    return m_base_commit_id_isValid;
}

QString OAIGetMergeCommitOutput::getMergedCommitId() const {
    return m_merged_commit_id;
}
void OAIGetMergeCommitOutput::setMergedCommitId(const QString &merged_commit_id) {
    m_merged_commit_id = merged_commit_id;
    m_merged_commit_id_isSet = true;
}

bool OAIGetMergeCommitOutput::is_merged_commit_id_Set() const{
    return m_merged_commit_id_isSet;
}

bool OAIGetMergeCommitOutput::is_merged_commit_id_Valid() const{
    return m_merged_commit_id_isValid;
}

bool OAIGetMergeCommitOutput::isSet() const {
...
bool OAIGetMergeCommitOutput::isValid() const {
