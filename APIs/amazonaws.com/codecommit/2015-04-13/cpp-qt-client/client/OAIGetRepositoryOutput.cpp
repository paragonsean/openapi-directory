...
OAIGetRepositoryOutput_repositoryMetadata OAIGetRepositoryOutput::getRepositoryMetadata() const {
    return m_repository_metadata;
}
void OAIGetRepositoryOutput::setRepositoryMetadata(const OAIGetRepositoryOutput_repositoryMetadata &repository_metadata) {
    m_repository_metadata = repository_metadata;
    m_repository_metadata_isSet = true;
}

bool OAIGetRepositoryOutput::is_repository_metadata_Set() const{
    return m_repository_metadata_isSet;
}

bool OAIGetRepositoryOutput::is_repository_metadata_Valid() const{
