...
OAIMergeOptionTypeEnum::OAIMergeOptionTypeEnum(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMergeOptionTypeEnum::OAIMergeOptionTypeEnum() {
    this->initializeModel();
}

OAIMergeOptionTypeEnum::~OAIMergeOptionTypeEnum() {}

void OAIMergeOptionTypeEnum::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIMergeOptionTypeEnum::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIMergeOptionTypeEnum::fromJson(QString jsonString) {
    
    if ( jsonString.compare("FAST_FORWARD_MERGE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIMergeOptionTypeEnum::FAST_FORWARD_MERGE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SQUASH_MERGE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIMergeOptionTypeEnum::SQUASH_MERGE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("THREE_WAY_MERGE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIMergeOptionTypeEnum::THREE_WAY_MERGE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIMergeOptionTypeEnum::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIMergeOptionTypeEnum::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIMergeOptionTypeEnum::FAST_FORWARD_MERGE:
            val = "FAST_FORWARD_MERGE";
            break;
        case eOAIMergeOptionTypeEnum::SQUASH_MERGE:
            val = "SQUASH_MERGE";
            break;
        case eOAIMergeOptionTypeEnum::THREE_WAY_MERGE:
            val = "THREE_WAY_MERGE";
            break;
        default:
            break;
...
QJsonValue OAIMergeOptionTypeEnum::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIMergeOptionTypeEnum::eOAIMergeOptionTypeEnum OAIMergeOptionTypeEnum::getValue() const {
    return m_value;
}

void OAIMergeOptionTypeEnum::setValue(const OAIMergeOptionTypeEnum::eOAIMergeOptionTypeEnum& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIMergeOptionTypeEnum::isSet() const {
    
    return m_value_isSet;
}

bool OAIMergeOptionTypeEnum::isValid() const {
