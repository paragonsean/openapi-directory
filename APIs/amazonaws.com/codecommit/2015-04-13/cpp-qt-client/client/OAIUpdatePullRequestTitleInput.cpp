...
OAIUpdatePullRequestTitleInput::OAIUpdatePullRequestTitleInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePullRequestTitleInput::OAIUpdatePullRequestTitleInput() {
    this->initializeModel();
}

OAIUpdatePullRequestTitleInput::~OAIUpdatePullRequestTitleInput() {}

void OAIUpdatePullRequestTitleInput::initializeModel() {
...
void OAIUpdatePullRequestTitleInput::fromJson(QString jsonString) {
...
void OAIUpdatePullRequestTitleInput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdatePullRequestTitleInput::asJson() const {
...
QJsonObject OAIUpdatePullRequestTitleInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdatePullRequestTitleInput::getPullRequestId() const {
    return m_pull_request_id;
}
void OAIUpdatePullRequestTitleInput::setPullRequestId(const QString &pull_request_id) {
    m_pull_request_id = pull_request_id;
    m_pull_request_id_isSet = true;
}

bool OAIUpdatePullRequestTitleInput::is_pull_request_id_Set() const{
    return m_pull_request_id_isSet;
}

bool OAIUpdatePullRequestTitleInput::is_pull_request_id_Valid() const{
    return m_pull_request_id_isValid;
}

QString OAIUpdatePullRequestTitleInput::getTitle() const {
    return m_title;
}
void OAIUpdatePullRequestTitleInput::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIUpdatePullRequestTitleInput::is_title_Set() const{
    return m_title_isSet;
}

bool OAIUpdatePullRequestTitleInput::is_title_Valid() const{
    return m_title_isValid;
}

bool OAIUpdatePullRequestTitleInput::isSet() const {
...
bool OAIUpdatePullRequestTitleInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_pull_request_id_isValid && m_title_isValid && true;
}
