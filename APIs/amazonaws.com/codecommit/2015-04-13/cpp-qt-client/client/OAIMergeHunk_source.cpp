...
OAIMergeHunk_source::OAIMergeHunk_source(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMergeHunk_source::OAIMergeHunk_source() {
    this->initializeModel();
}

OAIMergeHunk_source::~OAIMergeHunk_source() {}

void OAIMergeHunk_source::initializeModel() {
    ...
    m_hunk_content_isSet = false;
    m_hunk_content_isValid = false;
}

void OAIMergeHunk_source::fromJson(QString jsonString) {
...
void OAIMergeHunk_source::fromJsonObject(QJsonObject json) {
    ...
    m_hunk_content_isValid = ::OpenAPI::fromJsonValue(m_hunk_content, json[QString("hunkContent")]);
    m_hunk_content_isSet = !json[QString("hunkContent")].isNull() && m_hunk_content_isValid;
}

QString OAIMergeHunk_source::asJson() const {
...
QJsonObject OAIMergeHunk_source::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_hunk_content_isSet) {
        obj.insert(QString("hunkContent"), ::OpenAPI::toJsonValue(m_hunk_content));
    }
    return obj;
}

qint32 OAIMergeHunk_source::getStartLine() const {
    return m_start_line;
}
void OAIMergeHunk_source::setStartLine(const qint32 &start_line) {
    m_start_line = start_line;
    m_start_line_isSet = true;
}

bool OAIMergeHunk_source::is_start_line_Set() const{
    return m_start_line_isSet;
}

bool OAIMergeHunk_source::is_start_line_Valid() const{
    return m_start_line_isValid;
}

qint32 OAIMergeHunk_source::getEndLine() const {
    return m_end_line;
}
void OAIMergeHunk_source::setEndLine(const qint32 &end_line) {
    m_end_line = end_line;
    m_end_line_isSet = true;
}

bool OAIMergeHunk_source::is_end_line_Set() const{
    return m_end_line_isSet;
}

bool OAIMergeHunk_source::is_end_line_Valid() const{
    return m_end_line_isValid;
}

QString OAIMergeHunk_source::getHunkContent() const {
    return m_hunk_content;
}
void OAIMergeHunk_source::setHunkContent(const QString &hunk_content) {
    m_hunk_content = hunk_content;
    m_hunk_content_isSet = true;
}

bool OAIMergeHunk_source::is_hunk_content_Set() const{
    return m_hunk_content_isSet;
}

bool OAIMergeHunk_source::is_hunk_content_Valid() const{
    return m_hunk_content_isValid;
}

bool OAIMergeHunk_source::isSet() const {
...
bool OAIMergeHunk_source::isValid() const {
