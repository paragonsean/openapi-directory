...
/*
 * OAIOverridePullRequestApprovalRulesInput.h
 *
 * 
 */

#ifndef OAIOverridePullRequestApprovalRulesInput_H
#define OAIOverridePullRequestApprovalRulesInput_H
...
class OAIOverridePullRequestApprovalRulesInput : public OAIObject {
public:
    OAIOverridePullRequestApprovalRulesInput();
    OAIOverridePullRequestApprovalRulesInput(QString json);
    ~OAIOverridePullRequestApprovalRulesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOverridePullRequestApprovalRulesInput)

#endif // OAIOverridePullRequestApprovalRulesInput_H
