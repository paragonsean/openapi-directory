...
#include "OAIUpdatePullRequestStatusOutput_pullRequest.h"
...
OAIUpdatePullRequestStatusOutput_pullRequest::OAIUpdatePullRequestStatusOutput_pullRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePullRequestStatusOutput_pullRequest::OAIUpdatePullRequestStatusOutput_pullRequest() {
    this->initializeModel();
}

OAIUpdatePullRequestStatusOutput_pullRequest::~OAIUpdatePullRequestStatusOutput_pullRequest() {}

void OAIUpdatePullRequestStatusOutput_pullRequest::initializeModel() {
...
void OAIUpdatePullRequestStatusOutput_pullRequest::fromJson(QString jsonString) {
...
void OAIUpdatePullRequestStatusOutput_pullRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdatePullRequestStatusOutput_pullRequest::asJson() const {
...
QJsonObject OAIUpdatePullRequestStatusOutput_pullRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdatePullRequestStatusOutput_pullRequest::getPullRequestId() const {
    return m_pull_request_id;
}
void OAIUpdatePullRequestStatusOutput_pullRequest::setPullRequestId(const QString &pull_request_id) {
    m_pull_request_id = pull_request_id;
    m_pull_request_id_isSet = true;
}

bool OAIUpdatePullRequestStatusOutput_pullRequest::is_pull_request_id_Set() const{
    return m_pull_request_id_isSet;
}

bool OAIUpdatePullRequestStatusOutput_pullRequest::is_pull_request_id_Valid() const{
    return m_pull_request_id_isValid;
}

QString OAIUpdatePullRequestStatusOutput_pullRequest::getTitle() const {
    return m_title;
}
void OAIUpdatePullRequestStatusOutput_pullRequest::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIUpdatePullRequestStatusOutput_pullRequest::is_title_Set() const{
    return m_title_isSet;
}

bool OAIUpdatePullRequestStatusOutput_pullRequest::is_title_Valid() const{
    return m_title_isValid;
}

QString OAIUpdatePullRequestStatusOutput_pullRequest::getDescription() const {
    return m_description;
}
void OAIUpdatePullRequestStatusOutput_pullRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdatePullRequestStatusOutput_pullRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdatePullRequestStatusOutput_pullRequest::is_description_Valid() const{
    return m_description_isValid;
}

QDateTime OAIUpdatePullRequestStatusOutput_pullRequest::getLastActivityDate() const {
    return m_last_activity_date;
}
void OAIUpdatePullRequestStatusOutput_pullRequest::setLastActivityDate(const QDateTime &last_activity_date) {
    m_last_activity_date = last_activity_date;
    m_last_activity_date_isSet = true;
}

bool OAIUpdatePullRequestStatusOutput_pullRequest::is_last_activity_date_Set() const{
    return m_last_activity_date_isSet;
}

bool OAIUpdatePullRequestStatusOutput_pullRequest::is_last_activity_date_Valid() const{
    return m_last_activity_date_isValid;
}

QDateTime OAIUpdatePullRequestStatusOutput_pullRequest::getCreationDate() const {
    return m_creation_date;
}
void OAIUpdatePullRequestStatusOutput_pullRequest::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAIUpdatePullRequestStatusOutput_pullRequest::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAIUpdatePullRequestStatusOutput_pullRequest::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

OAIPullRequestStatusEnum OAIUpdatePullRequestStatusOutput_pullRequest::getPullRequestStatus() const {
    return m_pull_request_status;
}
void OAIUpdatePullRequestStatusOutput_pullRequest::setPullRequestStatus(const OAIPullRequestStatusEnum &pull_request_status) {
    m_pull_request_status = pull_request_status;
    m_pull_request_status_isSet = true;
}

bool OAIUpdatePullRequestStatusOutput_pullRequest::is_pull_request_status_Set() const{
    return m_pull_request_status_isSet;
}

bool OAIUpdatePullRequestStatusOutput_pullRequest::is_pull_request_status_Valid() const{
    return m_pull_request_status_isValid;
}

QString OAIUpdatePullRequestStatusOutput_pullRequest::getAuthorArn() const {
    return m_author_arn;
}
void OAIUpdatePullRequestStatusOutput_pullRequest::setAuthorArn(const QString &author_arn) {
    m_author_arn = author_arn;
    m_author_arn_isSet = true;
}

bool OAIUpdatePullRequestStatusOutput_pullRequest::is_author_arn_Set() const{
    return m_author_arn_isSet;
}

bool OAIUpdatePullRequestStatusOutput_pullRequest::is_author_arn_Valid() const{
    return m_author_arn_isValid;
}

QList OAIUpdatePullRequestStatusOutput_pullRequest::getPullRequestTargets() const {
    return m_pull_request_targets;
}
void OAIUpdatePullRequestStatusOutput_pullRequest::setPullRequestTargets(const QList &pull_request_targets) {
    m_pull_request_targets = pull_request_targets;
    m_pull_request_targets_isSet = true;
}

bool OAIUpdatePullRequestStatusOutput_pullRequest::is_pull_request_targets_Set() const{
    return m_pull_request_targets_isSet;
}

bool OAIUpdatePullRequestStatusOutput_pullRequest::is_pull_request_targets_Valid() const{
    return m_pull_request_targets_isValid;
}

QString OAIUpdatePullRequestStatusOutput_pullRequest::getClientRequestToken() const {
    return m_client_request_token;
}
void OAIUpdatePullRequestStatusOutput_pullRequest::setClientRequestToken(const QString &client_request_token) {
    m_client_request_token = client_request_token;
    m_client_request_token_isSet = true;
}

bool OAIUpdatePullRequestStatusOutput_pullRequest::is_client_request_token_Set() const{
    return m_client_request_token_isSet;
}

bool OAIUpdatePullRequestStatusOutput_pullRequest::is_client_request_token_Valid() const{
    return m_client_request_token_isValid;
}

QString OAIUpdatePullRequestStatusOutput_pullRequest::getRevisionId() const {
    return m_revision_id;
}
void OAIUpdatePullRequestStatusOutput_pullRequest::setRevisionId(const QString &revision_id) {
    m_revision_id = revision_id;
    m_revision_id_isSet = true;
}

bool OAIUpdatePullRequestStatusOutput_pullRequest::is_revision_id_Set() const{
    return m_revision_id_isSet;
}

bool OAIUpdatePullRequestStatusOutput_pullRequest::is_revision_id_Valid() const{
    return m_revision_id_isValid;
}

QList OAIUpdatePullRequestStatusOutput_pullRequest::getApprovalRules() const {
    return m_approval_rules;
}
void OAIUpdatePullRequestStatusOutput_pullRequest::setApprovalRules(const QList &approval_rules) {
    m_approval_rules = approval_rules;
    m_approval_rules_isSet = true;
}

bool OAIUpdatePullRequestStatusOutput_pullRequest::is_approval_rules_Set() const{
    return m_approval_rules_isSet;
}

bool OAIUpdatePullRequestStatusOutput_pullRequest::is_approval_rules_Valid() const{
    return m_approval_rules_isValid;
}

bool OAIUpdatePullRequestStatusOutput_pullRequest::isSet() const {
...
bool OAIUpdatePullRequestStatusOutput_pullRequest::isValid() const {
