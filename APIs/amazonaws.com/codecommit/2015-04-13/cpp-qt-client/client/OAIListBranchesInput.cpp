...
OAIListBranchesInput::OAIListBranchesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListBranchesInput::OAIListBranchesInput() {
    this->initializeModel();
}

OAIListBranchesInput::~OAIListBranchesInput() {}

void OAIListBranchesInput::initializeModel() {
...
void OAIListBranchesInput::fromJson(QString jsonString) {
...
void OAIListBranchesInput::fromJsonObject(QJsonObject json) {
...
QString OAIListBranchesInput::asJson() const {
...
QJsonObject OAIListBranchesInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListBranchesInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIListBranchesInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIListBranchesInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIListBranchesInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIListBranchesInput::getNextToken() const {
    return m_next_token;
}
void OAIListBranchesInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListBranchesInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListBranchesInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListBranchesInput::isSet() const {
...
bool OAIListBranchesInput::isValid() const {
