...
OAIGetMergeOptionsOutput::OAIGetMergeOptionsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetMergeOptionsOutput::OAIGetMergeOptionsOutput() {
    this->initializeModel();
}

OAIGetMergeOptionsOutput::~OAIGetMergeOptionsOutput() {}

void OAIGetMergeOptionsOutput::initializeModel() {

    m_merge_options_isSet = false;
    m_merge_options_isValid = false;
...
void OAIGetMergeOptionsOutput::fromJson(QString jsonString) {
...
void OAIGetMergeOptionsOutput::fromJsonObject(QJsonObject json) {

    m_merge_options_isValid = ::OpenAPI::fromJsonValue(m_merge_options, json[QString("mergeOptions")]);
    m_merge_options_isSet = !json[QString("mergeOptions")].isNull() && m_merge_options_isValid;
...
QString OAIGetMergeOptionsOutput::asJson() const {
...
QJsonObject OAIGetMergeOptionsOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_merge_options.isSet()) {
        obj.insert(QString("mergeOptions"), ::OpenAPI::toJsonValue(m_merge_options));
    }
...
QList OAIGetMergeOptionsOutput::getMergeOptions() const {
    return m_merge_options;
}
void OAIGetMergeOptionsOutput::setMergeOptions(const QList &merge_options) {
    m_merge_options = merge_options;
    m_merge_options_isSet = true;
}

bool OAIGetMergeOptionsOutput::is_merge_options_Set() const{
    return m_merge_options_isSet;
}

bool OAIGetMergeOptionsOutput::is_merge_options_Valid() const{
    return m_merge_options_isValid;
}

QString OAIGetMergeOptionsOutput::getSourceCommitId() const {
    return m_source_commit_id;
}
void OAIGetMergeOptionsOutput::setSourceCommitId(const QString &source_commit_id) {
    m_source_commit_id = source_commit_id;
    m_source_commit_id_isSet = true;
}

bool OAIGetMergeOptionsOutput::is_source_commit_id_Set() const{
    return m_source_commit_id_isSet;
}

bool OAIGetMergeOptionsOutput::is_source_commit_id_Valid() const{
    return m_source_commit_id_isValid;
}

QString OAIGetMergeOptionsOutput::getDestinationCommitId() const {
    return m_destination_commit_id;
}
void OAIGetMergeOptionsOutput::setDestinationCommitId(const QString &destination_commit_id) {
    m_destination_commit_id = destination_commit_id;
    m_destination_commit_id_isSet = true;
}

bool OAIGetMergeOptionsOutput::is_destination_commit_id_Set() const{
    return m_destination_commit_id_isSet;
}

bool OAIGetMergeOptionsOutput::is_destination_commit_id_Valid() const{
    return m_destination_commit_id_isValid;
}

QString OAIGetMergeOptionsOutput::getBaseCommitId() const {
    return m_base_commit_id;
}
void OAIGetMergeOptionsOutput::setBaseCommitId(const QString &base_commit_id) {
    m_base_commit_id = base_commit_id;
    m_base_commit_id_isSet = true;
}

bool OAIGetMergeOptionsOutput::is_base_commit_id_Set() const{
    return m_base_commit_id_isSet;
}

bool OAIGetMergeOptionsOutput::is_base_commit_id_Valid() const{
    return m_base_commit_id_isValid;
}

bool OAIGetMergeOptionsOutput::isSet() const {
...
bool OAIGetMergeOptionsOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_merge_options_isValid && m_source_commit_id_isValid && m_destination_commit_id_isValid && m_base_commit_id_isValid && true;
}
