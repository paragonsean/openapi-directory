...
/*
 * OAIMergeHunk_source.h
 *
 * 
 */

#ifndef OAIMergeHunk_source_H
#define OAIMergeHunk_source_H
...
class OAIMergeHunk_source : public OAIObject {
public:
    OAIMergeHunk_source();
    OAIMergeHunk_source(QString json);
    ~OAIMergeHunk_source() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMergeHunk_source)

#endif // OAIMergeHunk_source_H
