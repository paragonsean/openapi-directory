...
/*
 * OAICommentsForComparedCommit.h
 *
 * Returns information about comments on the comparison between two commits.
 */

#ifndef OAICommentsForComparedCommit_H
#define OAICommentsForComparedCommit_H

#include <QJsonObject>

#include "OAICommentsForComparedCommit_location.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAICommentsForComparedCommit_location;

class OAICommentsForComparedCommit : public OAIObject {
public:
    OAICommentsForComparedCommit();
    OAICommentsForComparedCommit(QString json);
    ~OAICommentsForComparedCommit() override;
    ...
    OAICommentsForComparedCommit_location getLocation() const;
    void setLocation(const OAICommentsForComparedCommit_location &location);
...
private:
    ...
    OAICommentsForComparedCommit_location m_location;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommentsForComparedCommit)

#endif // OAICommentsForComparedCommit_H
