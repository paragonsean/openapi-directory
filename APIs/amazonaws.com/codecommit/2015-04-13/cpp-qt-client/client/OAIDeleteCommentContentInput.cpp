...
OAIDeleteCommentContentInput::OAIDeleteCommentContentInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteCommentContentInput::OAIDeleteCommentContentInput() {
    this->initializeModel();
}

OAIDeleteCommentContentInput::~OAIDeleteCommentContentInput() {}

void OAIDeleteCommentContentInput::initializeModel() {

    m_comment_id_isSet = false;
    m_comment_id_isValid = false;
}

void OAIDeleteCommentContentInput::fromJson(QString jsonString) {
...
void OAIDeleteCommentContentInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteCommentContentInput::asJson() const {
...
QJsonObject OAIDeleteCommentContentInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteCommentContentInput::getCommentId() const {
    return m_comment_id;
}
void OAIDeleteCommentContentInput::setCommentId(const QString &comment_id) {
    m_comment_id = comment_id;
    m_comment_id_isSet = true;
}

bool OAIDeleteCommentContentInput::is_comment_id_Set() const{
    return m_comment_id_isSet;
}

bool OAIDeleteCommentContentInput::is_comment_id_Valid() const{
    return m_comment_id_isValid;
}

bool OAIDeleteCommentContentInput::isSet() const {
...
bool OAIDeleteCommentContentInput::isValid() const {
