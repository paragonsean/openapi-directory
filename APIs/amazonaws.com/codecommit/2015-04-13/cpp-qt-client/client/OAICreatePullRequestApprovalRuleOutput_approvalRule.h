...
/*
 * OAICreatePullRequestApprovalRuleOutput_approvalRule.h
 *
 * 
 */

#ifndef OAICreatePullRequestApprovalRuleOutput_approvalRule_H
#define OAICreatePullRequestApprovalRuleOutput_approvalRule_H
...
class OAICreatePullRequestApprovalRuleOutput_approvalRule : public OAIObject {
public:
    OAICreatePullRequestApprovalRuleOutput_approvalRule();
    OAICreatePullRequestApprovalRuleOutput_approvalRule(QString json);
    ~OAICreatePullRequestApprovalRuleOutput_approvalRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePullRequestApprovalRuleOutput_approvalRule)

#endif // OAICreatePullRequestApprovalRuleOutput_approvalRule_H
