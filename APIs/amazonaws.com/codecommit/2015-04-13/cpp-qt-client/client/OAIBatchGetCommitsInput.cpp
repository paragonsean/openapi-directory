...
OAIBatchGetCommitsInput::OAIBatchGetCommitsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchGetCommitsInput::OAIBatchGetCommitsInput() {
    this->initializeModel();
}

OAIBatchGetCommitsInput::~OAIBatchGetCommitsInput() {}

void OAIBatchGetCommitsInput::initializeModel() {

    m_commit_ids_isSet = false;
    m_commit_ids_isValid = false;

    m_repository_name_isSet = false;
    m_repository_name_isValid = false;
}

void OAIBatchGetCommitsInput::fromJson(QString jsonString) {
...
void OAIBatchGetCommitsInput::fromJsonObject(QJsonObject json) {

    m_commit_ids_isValid = ::OpenAPI::fromJsonValue(m_commit_ids, json[QString("commitIds")]);
    m_commit_ids_isSet = !json[QString("commitIds")].isNull() && m_commit_ids_isValid;
...
QString OAIBatchGetCommitsInput::asJson() const {
...
QJsonObject OAIBatchGetCommitsInput::asJsonObject() const {
    QJsonObject obj;
    if (m_commit_ids.isSet()) {
        obj.insert(QString("commitIds"), ::OpenAPI::toJsonValue(m_commit_ids));
    }
...
QList OAIBatchGetCommitsInput::getCommitIds() const {
    return m_commit_ids;
}
void OAIBatchGetCommitsInput::setCommitIds(const QList &commit_ids) {
    m_commit_ids = commit_ids;
    m_commit_ids_isSet = true;
}

bool OAIBatchGetCommitsInput::is_commit_ids_Set() const{
    return m_commit_ids_isSet;
}

bool OAIBatchGetCommitsInput::is_commit_ids_Valid() const{
    return m_commit_ids_isValid;
}

QString OAIBatchGetCommitsInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIBatchGetCommitsInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIBatchGetCommitsInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIBatchGetCommitsInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

bool OAIBatchGetCommitsInput::isSet() const {
...
bool OAIBatchGetCommitsInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_commit_ids_isValid && m_repository_name_isValid && true;
}
