...
OAIDeletePullRequestApprovalRuleOutput::OAIDeletePullRequestApprovalRuleOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeletePullRequestApprovalRuleOutput::OAIDeletePullRequestApprovalRuleOutput() {
    this->initializeModel();
}

OAIDeletePullRequestApprovalRuleOutput::~OAIDeletePullRequestApprovalRuleOutput() {}

void OAIDeletePullRequestApprovalRuleOutput::initializeModel() {

    m_approval_rule_id_isSet = false;
    m_approval_rule_id_isValid = false;
}

void OAIDeletePullRequestApprovalRuleOutput::fromJson(QString jsonString) {
...
void OAIDeletePullRequestApprovalRuleOutput::fromJsonObject(QJsonObject json) {

    m_approval_rule_id_isValid = ::OpenAPI::fromJsonValue(m_approval_rule_id, json[QString("approvalRuleId")]);
    m_approval_rule_id_isSet = !json[QString("approvalRuleId")].isNull() && m_approval_rule_id_isValid;
}

QString OAIDeletePullRequestApprovalRuleOutput::asJson() const {
...
QJsonObject OAIDeletePullRequestApprovalRuleOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_approval_rule_id_isSet) {
        obj.insert(QString("approvalRuleId"), ::OpenAPI::toJsonValue(m_approval_rule_id));
    }
    return obj;
}

QString OAIDeletePullRequestApprovalRuleOutput::getApprovalRuleId() const {
    return m_approval_rule_id;
}
void OAIDeletePullRequestApprovalRuleOutput::setApprovalRuleId(const QString &approval_rule_id) {
    m_approval_rule_id = approval_rule_id;
    m_approval_rule_id_isSet = true;
}

bool OAIDeletePullRequestApprovalRuleOutput::is_approval_rule_id_Set() const{
    return m_approval_rule_id_isSet;
}

bool OAIDeletePullRequestApprovalRuleOutput::is_approval_rule_id_Valid() const{
    return m_approval_rule_id_isValid;
}

bool OAIDeletePullRequestApprovalRuleOutput::isSet() const {
...
bool OAIDeletePullRequestApprovalRuleOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_approval_rule_id_isValid && true;
}
