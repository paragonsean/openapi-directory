...
/*
 * OAIDescribeMergeConflictsOutput.h
 *
 * 
 */

#ifndef OAIDescribeMergeConflictsOutput_H
#define OAIDescribeMergeConflictsOutput_H

#include <QJsonObject>

#include "OAIDescribeMergeConflictsOutput_conflictMetadata.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIDescribeMergeConflictsOutput_conflictMetadata;

class OAIDescribeMergeConflictsOutput : public OAIObject {
public:
    OAIDescribeMergeConflictsOutput();
    OAIDescribeMergeConflictsOutput(QString json);
    ~OAIDescribeMergeConflictsOutput() override;
    ...
    OAIDescribeMergeConflictsOutput_conflictMetadata getConflictMetadata() const;
    void setConflictMetadata(const OAIDescribeMergeConflictsOutput_conflictMetadata &conflict_metadata);
    bool is_conflict_metadata_Set() const;
    bool is_conflict_metadata_Valid() const;

    QList getMergeHunks() const;
    void setMergeHunks(const QList &merge_hunks);
    bool is_merge_hunks_Set() const;
    bool is_merge_hunks_Valid() const;
...
private:
    ...
    OAIDescribeMergeConflictsOutput_conflictMetadata m_conflict_metadata;
    bool m_conflict_metadata_isSet;
    bool m_conflict_metadata_isValid;

    QList m_merge_hunks;
    bool m_merge_hunks_isSet;
    bool m_merge_hunks_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeMergeConflictsOutput)

#endif // OAIDescribeMergeConflictsOutput_H
