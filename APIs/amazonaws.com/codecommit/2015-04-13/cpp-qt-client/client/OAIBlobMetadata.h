...
#ifndef OAIBlobMetadata_H
#define OAIBlobMetadata_H
...
class OAIBlobMetadata : public OAIObject {
public:
    OAIBlobMetadata();
    OAIBlobMetadata(QString json);
    ~OAIBlobMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBlobMetadata)

#endif // OAIBlobMetadata_H
