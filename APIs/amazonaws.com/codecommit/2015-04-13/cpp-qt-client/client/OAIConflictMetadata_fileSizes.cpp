...
OAIConflictMetadata_fileSizes::OAIConflictMetadata_fileSizes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConflictMetadata_fileSizes::OAIConflictMetadata_fileSizes() {
    this->initializeModel();
}

OAIConflictMetadata_fileSizes::~OAIConflictMetadata_fileSizes() {}

void OAIConflictMetadata_fileSizes::initializeModel() {
...
void OAIConflictMetadata_fileSizes::fromJson(QString jsonString) {
...
void OAIConflictMetadata_fileSizes::fromJsonObject(QJsonObject json) {
...
QString OAIConflictMetadata_fileSizes::asJson() const {
...
QJsonObject OAIConflictMetadata_fileSizes::asJsonObject() const {
    QJsonObject obj;
    if (m_source_isSet) {
...
qint32 OAIConflictMetadata_fileSizes::getSource() const {
    return m_source;
}
void OAIConflictMetadata_fileSizes::setSource(const qint32 &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAIConflictMetadata_fileSizes::is_source_Set() const{
    return m_source_isSet;
}

bool OAIConflictMetadata_fileSizes::is_source_Valid() const{
    return m_source_isValid;
}

qint32 OAIConflictMetadata_fileSizes::getDestination() const {
    return m_destination;
}
void OAIConflictMetadata_fileSizes::setDestination(const qint32 &destination) {
    m_destination = destination;
    m_destination_isSet = true;
}

bool OAIConflictMetadata_fileSizes::is_destination_Set() const{
    return m_destination_isSet;
}

bool OAIConflictMetadata_fileSizes::is_destination_Valid() const{
    return m_destination_isValid;
}

qint32 OAIConflictMetadata_fileSizes::getBase() const {
    return m_base;
}
void OAIConflictMetadata_fileSizes::setBase(const qint32 &base) {
    m_base = base;
    m_base_isSet = true;
}

bool OAIConflictMetadata_fileSizes::is_base_Set() const{
    return m_base_isSet;
}

bool OAIConflictMetadata_fileSizes::is_base_Valid() const{
    return m_base_isValid;
}

bool OAIConflictMetadata_fileSizes::isSet() const {
...
bool OAIConflictMetadata_fileSizes::isValid() const {
