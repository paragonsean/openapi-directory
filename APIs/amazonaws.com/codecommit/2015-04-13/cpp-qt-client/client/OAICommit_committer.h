...
/*
 * OAICommit_committer.h
 *
 * 
 */

#ifndef OAICommit_committer_H
#define OAICommit_committer_H
...
class OAICommit_committer : public OAIObject {
public:
    OAICommit_committer();
    OAICommit_committer(QString json);
    ~OAICommit_committer() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommit_committer)

#endif // OAICommit_committer_H
