...
/*
 * OAIGetMergeConflictsOutput.h
 *
 * 
 */

#ifndef OAIGetMergeConflictsOutput_H
#define OAIGetMergeConflictsOutput_H
...
class OAIGetMergeConflictsOutput : public OAIObject {
public:
    OAIGetMergeConflictsOutput();
    OAIGetMergeConflictsOutput(QString json);
    ~OAIGetMergeConflictsOutput() override;
    ...
    QString getDestinationCommitId() const;
    void setDestinationCommitId(const QString &destination_commit_id);
    bool is_destination_commit_id_Set() const;
    bool is_destination_commit_id_Valid() const;

    QString getSourceCommitId() const;
    void setSourceCommitId(const QString &source_commit_id);
    bool is_source_commit_id_Set() const;
    bool is_source_commit_id_Valid() const;

    QString getBaseCommitId() const;
    void setBaseCommitId(const QString &base_commit_id);
    bool is_base_commit_id_Set() const;
    bool is_base_commit_id_Valid() const;

    QList getConflictMetadataList() const;
    void setConflictMetadataList(const QList &conflict_metadata_list);
    bool is_conflict_metadata_list_Set() const;
    bool is_conflict_metadata_list_Valid() const;
...
private:
    ...
    QString m_destination_commit_id;
    bool m_destination_commit_id_isSet;
    bool m_destination_commit_id_isValid;

    QString m_source_commit_id;
    bool m_source_commit_id_isSet;
    bool m_source_commit_id_isValid;

    QString m_base_commit_id;
    bool m_base_commit_id_isSet;
    bool m_base_commit_id_isValid;

    QList m_conflict_metadata_list;
    bool m_conflict_metadata_list_isSet;
    bool m_conflict_metadata_list_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetMergeConflictsOutput)

#endif // OAIGetMergeConflictsOutput_H
