...
/*
 * OAIConflictMetadata_fileModes.h
 *
 * 
 */

#ifndef OAIConflictMetadata_fileModes_H
#define OAIConflictMetadata_fileModes_H
...
class OAIConflictMetadata_fileModes : public OAIObject {
public:
    OAIConflictMetadata_fileModes();
    OAIConflictMetadata_fileModes(QString json);
    ~OAIConflictMetadata_fileModes() override;
    ...
    OAIFileModeTypeEnum getSource() const;
    void setSource(const OAIFileModeTypeEnum &source);
    bool is_source_Set() const;
    bool is_source_Valid() const;

    OAIFileModeTypeEnum getDestination() const;
    void setDestination(const OAIFileModeTypeEnum &destination);
    bool is_destination_Set() const;
    bool is_destination_Valid() const;

    OAIFileModeTypeEnum getBase() const;
    void setBase(const OAIFileModeTypeEnum &base);
...
private:
    ...
    OAIFileModeTypeEnum m_source;
    bool m_source_isSet;
    bool m_source_isValid;

    OAIFileModeTypeEnum m_destination;
    bool m_destination_isSet;
    bool m_destination_isValid;

    OAIFileModeTypeEnum m_base;
    bool m_base_isSet;
    bool m_base_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIConflictMetadata_fileModes)

#endif // OAIConflictMetadata_fileModes_H
