...
/*
 * OAIUpdatePullRequestApprovalStateInput.h
 *
 * 
 */

#ifndef OAIUpdatePullRequestApprovalStateInput_H
#define OAIUpdatePullRequestApprovalStateInput_H
...
class OAIUpdatePullRequestApprovalStateInput : public OAIObject {
public:
    OAIUpdatePullRequestApprovalStateInput();
    OAIUpdatePullRequestApprovalStateInput(QString json);
    ~OAIUpdatePullRequestApprovalStateInput() override;
    ...
    OAIApprovalState getApprovalState() const;
    void setApprovalState(const OAIApprovalState &approval_state);
...
private:
    ...
    OAIApprovalState m_approval_state;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePullRequestApprovalStateInput)

#endif // OAIUpdatePullRequestApprovalStateInput_H
