...
OAIPullRequestEvent_pullRequestCreatedEventMetadata::OAIPullRequestEvent_pullRequestCreatedEventMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPullRequestEvent_pullRequestCreatedEventMetadata::OAIPullRequestEvent_pullRequestCreatedEventMetadata() {
    this->initializeModel();
}

OAIPullRequestEvent_pullRequestCreatedEventMetadata::~OAIPullRequestEvent_pullRequestCreatedEventMetadata() {}

void OAIPullRequestEvent_pullRequestCreatedEventMetadata::initializeModel() {
...
void OAIPullRequestEvent_pullRequestCreatedEventMetadata::fromJson(QString jsonString) {
...
void OAIPullRequestEvent_pullRequestCreatedEventMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIPullRequestEvent_pullRequestCreatedEventMetadata::asJson() const {
...
QJsonObject OAIPullRequestEvent_pullRequestCreatedEventMetadata::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPullRequestEvent_pullRequestCreatedEventMetadata::getRepositoryName() const {
    return m_repository_name;
}
void OAIPullRequestEvent_pullRequestCreatedEventMetadata::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIPullRequestEvent_pullRequestCreatedEventMetadata::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIPullRequestEvent_pullRequestCreatedEventMetadata::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIPullRequestEvent_pullRequestCreatedEventMetadata::getSourceCommitId() const {
    return m_source_commit_id;
}
void OAIPullRequestEvent_pullRequestCreatedEventMetadata::setSourceCommitId(const QString &source_commit_id) {
    m_source_commit_id = source_commit_id;
    m_source_commit_id_isSet = true;
}

bool OAIPullRequestEvent_pullRequestCreatedEventMetadata::is_source_commit_id_Set() const{
    return m_source_commit_id_isSet;
}

bool OAIPullRequestEvent_pullRequestCreatedEventMetadata::is_source_commit_id_Valid() const{
    return m_source_commit_id_isValid;
}

QString OAIPullRequestEvent_pullRequestCreatedEventMetadata::getDestinationCommitId() const {
    return m_destination_commit_id;
}
void OAIPullRequestEvent_pullRequestCreatedEventMetadata::setDestinationCommitId(const QString &destination_commit_id) {
    m_destination_commit_id = destination_commit_id;
    m_destination_commit_id_isSet = true;
}

bool OAIPullRequestEvent_pullRequestCreatedEventMetadata::is_destination_commit_id_Set() const{
    return m_destination_commit_id_isSet;
}

bool OAIPullRequestEvent_pullRequestCreatedEventMetadata::is_destination_commit_id_Valid() const{
    return m_destination_commit_id_isValid;
}

QString OAIPullRequestEvent_pullRequestCreatedEventMetadata::getMergeBase() const {
    return m_merge_base;
}
void OAIPullRequestEvent_pullRequestCreatedEventMetadata::setMergeBase(const QString &merge_base) {
    m_merge_base = merge_base;
    m_merge_base_isSet = true;
}

bool OAIPullRequestEvent_pullRequestCreatedEventMetadata::is_merge_base_Set() const{
    return m_merge_base_isSet;
}

bool OAIPullRequestEvent_pullRequestCreatedEventMetadata::is_merge_base_Valid() const{
    return m_merge_base_isValid;
}

bool OAIPullRequestEvent_pullRequestCreatedEventMetadata::isSet() const {
...
bool OAIPullRequestEvent_pullRequestCreatedEventMetadata::isValid() const {
