...
/*
 * OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata.h
 *
 * 
 */

#ifndef OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata_H
#define OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata_H
...
class OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata : public OAIObject {
public:
    OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata();
    OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata(QString json);
    ~OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata)

#endif // OAIPullRequestEvent_pullRequestSourceReferenceUpdatedEventMetadata_H
