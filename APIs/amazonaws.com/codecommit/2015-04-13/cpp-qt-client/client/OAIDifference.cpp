...
OAIDifference::OAIDifference(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDifference::OAIDifference() {
    this->initializeModel();
}

OAIDifference::~OAIDifference() {}

void OAIDifference::initializeModel() {

    m_before_blob_isSet = false;
    m_before_blob_isValid = false;

    m_after_blob_isSet = false;
    m_after_blob_isValid = false;

    m_change_type_isSet = false;
    m_change_type_isValid = false;
}

void OAIDifference::fromJson(QString jsonString) {
...
void OAIDifference::fromJsonObject(QJsonObject json) {

    m_before_blob_isValid = ::OpenAPI::fromJsonValue(m_before_blob, json[QString("beforeBlob")]);
    m_before_blob_isSet = !json[QString("beforeBlob")].isNull() && m_before_blob_isValid;

    m_after_blob_isValid = ::OpenAPI::fromJsonValue(m_after_blob, json[QString("afterBlob")]);
    m_after_blob_isSet = !json[QString("afterBlob")].isNull() && m_after_blob_isValid;
...
QString OAIDifference::asJson() const {
...
QJsonObject OAIDifference::asJsonObject() const {
    QJsonObject obj;
    if (m_before_blob.isSet()) {
        obj.insert(QString("beforeBlob"), ::OpenAPI::toJsonValue(m_before_blob));
    }
    if (m_after_blob.isSet()) {
        obj.insert(QString("afterBlob"), ::OpenAPI::toJsonValue(m_after_blob));
    }
...
OAIDifference_beforeBlob OAIDifference::getBeforeBlob() const {
    return m_before_blob;
}
void OAIDifference::setBeforeBlob(const OAIDifference_beforeBlob &before_blob) {
    m_before_blob = before_blob;
    m_before_blob_isSet = true;
}

bool OAIDifference::is_before_blob_Set() const{
    return m_before_blob_isSet;
}

bool OAIDifference::is_before_blob_Valid() const{
    return m_before_blob_isValid;
}

OAIDifference_afterBlob OAIDifference::getAfterBlob() const {
    return m_after_blob;
}
void OAIDifference::setAfterBlob(const OAIDifference_afterBlob &after_blob) {
    m_after_blob = after_blob;
    m_after_blob_isSet = true;
}

bool OAIDifference::is_after_blob_Set() const{
    return m_after_blob_isSet;
}

bool OAIDifference::is_after_blob_Valid() const{
    return m_after_blob_isValid;
}

OAIChangeTypeEnum OAIDifference::getChangeType() const {
    return m_change_type;
}
void OAIDifference::setChangeType(const OAIChangeTypeEnum &change_type) {
    m_change_type = change_type;
    m_change_type_isSet = true;
}

bool OAIDifference::is_change_type_Set() const{
    return m_change_type_isSet;
}

bool OAIDifference::is_change_type_Valid() const{
    return m_change_type_isValid;
}

bool OAIDifference::isSet() const {
...
bool OAIDifference::isValid() const {
