...
OAIObjectTypes::OAIObjectTypes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIObjectTypes::OAIObjectTypes() {
    this->initializeModel();
}

OAIObjectTypes::~OAIObjectTypes() {}

void OAIObjectTypes::initializeModel() {
...
void OAIObjectTypes::fromJson(QString jsonString) {
...
void OAIObjectTypes::fromJsonObject(QJsonObject json) {
...
QString OAIObjectTypes::asJson() const {
...
QJsonObject OAIObjectTypes::asJsonObject() const {
    QJsonObject obj;
    if (m_source.isSet()) {
...
OAIObjectTypeEnum OAIObjectTypes::getSource() const {
    return m_source;
}
void OAIObjectTypes::setSource(const OAIObjectTypeEnum &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAIObjectTypes::is_source_Set() const{
    return m_source_isSet;
}

bool OAIObjectTypes::is_source_Valid() const{
    return m_source_isValid;
}

OAIObjectTypeEnum OAIObjectTypes::getDestination() const {
    return m_destination;
}
void OAIObjectTypes::setDestination(const OAIObjectTypeEnum &destination) {
    m_destination = destination;
    m_destination_isSet = true;
}

bool OAIObjectTypes::is_destination_Set() const{
    return m_destination_isSet;
}

bool OAIObjectTypes::is_destination_Valid() const{
    return m_destination_isValid;
}

OAIObjectTypeEnum OAIObjectTypes::getBase() const {
    return m_base;
}
void OAIObjectTypes::setBase(const OAIObjectTypeEnum &base) {
    m_base = base;
    m_base_isSet = true;
}

bool OAIObjectTypes::is_base_Set() const{
    return m_base_isSet;
}

bool OAIObjectTypes::is_base_Valid() const{
    return m_base_isValid;
}

bool OAIObjectTypes::isSet() const {
...
bool OAIObjectTypes::isValid() const {
