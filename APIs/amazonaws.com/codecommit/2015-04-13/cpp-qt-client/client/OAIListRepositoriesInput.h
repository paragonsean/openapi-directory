...
public:
    ...
    OAISortByEnum getSortBy() const;
    void setSortBy(const OAISortByEnum &sort_by);
    bool is_sort_by_Set() const;
    bool is_sort_by_Valid() const;

    OAIOrderEnum getOrder() const;
    void setOrder(const OAIOrderEnum &order);
...
private:
    ...
    OAISortByEnum m_sort_by;
    bool m_sort_by_isSet;
    bool m_sort_by_isValid;

    OAIOrderEnum m_order;
    bool m_order_isSet;
