...
/*
 * OAIGetCommentsForComparedCommitInput.h
 *
 * 
 */

#ifndef OAIGetCommentsForComparedCommitInput_H
#define OAIGetCommentsForComparedCommitInput_H
...
class OAIGetCommentsForComparedCommitInput : public OAIObject {
public:
    OAIGetCommentsForComparedCommitInput();
    OAIGetCommentsForComparedCommitInput(QString json);
    ~OAIGetCommentsForComparedCommitInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCommentsForComparedCommitInput)

#endif // OAIGetCommentsForComparedCommitInput_H
