...
/*
 * OAIPostCommentForPullRequestInput_location.h
 *
 * 
 */

#ifndef OAIPostCommentForPullRequestInput_location_H
#define OAIPostCommentForPullRequestInput_location_H
...
class OAIPostCommentForPullRequestInput_location : public OAIObject {
public:
    OAIPostCommentForPullRequestInput_location();
    OAIPostCommentForPullRequestInput_location(QString json);
    ~OAIPostCommentForPullRequestInput_location() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostCommentForPullRequestInput_location)

#endif // OAIPostCommentForPullRequestInput_location_H
