...
/*
 * OAIDescribePullRequestEventsOutput.h
 *
 * 
 */

#ifndef OAIDescribePullRequestEventsOutput_H
#define OAIDescribePullRequestEventsOutput_H
...
class OAIDescribePullRequestEventsOutput : public OAIObject {
public:
    OAIDescribePullRequestEventsOutput();
    OAIDescribePullRequestEventsOutput(QString json);
    ~OAIDescribePullRequestEventsOutput() override;
    ...
    QList getPullRequestEvents() const;
    void setPullRequestEvents(const QList &pull_request_events);
    bool is_pull_request_events_Set() const;
    bool is_pull_request_events_Valid() const;
...
private:
    ...
    QList m_pull_request_events;
    bool m_pull_request_events_isSet;
    bool m_pull_request_events_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribePullRequestEventsOutput)

#endif // OAIDescribePullRequestEventsOutput_H
