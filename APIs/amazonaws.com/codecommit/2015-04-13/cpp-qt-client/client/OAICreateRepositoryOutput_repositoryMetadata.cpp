...
#include "OAICreateRepositoryOutput_repositoryMetadata.h"
...
OAICreateRepositoryOutput_repositoryMetadata::OAICreateRepositoryOutput_repositoryMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRepositoryOutput_repositoryMetadata::OAICreateRepositoryOutput_repositoryMetadata() {
    this->initializeModel();
}

OAICreateRepositoryOutput_repositoryMetadata::~OAICreateRepositoryOutput_repositoryMetadata() {}

void OAICreateRepositoryOutput_repositoryMetadata::initializeModel() {
...
void OAICreateRepositoryOutput_repositoryMetadata::fromJson(QString jsonString) {
...
void OAICreateRepositoryOutput_repositoryMetadata::fromJsonObject(QJsonObject json) {
...
QString OAICreateRepositoryOutput_repositoryMetadata::asJson() const {
...
QJsonObject OAICreateRepositoryOutput_repositoryMetadata::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateRepositoryOutput_repositoryMetadata::getAccountId() const {
    return m_account_id;
}
void OAICreateRepositoryOutput_repositoryMetadata::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAICreateRepositoryOutput_repositoryMetadata::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAICreateRepositoryOutput_repositoryMetadata::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAICreateRepositoryOutput_repositoryMetadata::getRepositoryId() const {
    return m_repository_id;
}
void OAICreateRepositoryOutput_repositoryMetadata::setRepositoryId(const QString &repository_id) {
    m_repository_id = repository_id;
    m_repository_id_isSet = true;
}

bool OAICreateRepositoryOutput_repositoryMetadata::is_repository_id_Set() const{
    return m_repository_id_isSet;
}

bool OAICreateRepositoryOutput_repositoryMetadata::is_repository_id_Valid() const{
    return m_repository_id_isValid;
}

QString OAICreateRepositoryOutput_repositoryMetadata::getRepositoryName() const {
    return m_repository_name;
}
void OAICreateRepositoryOutput_repositoryMetadata::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAICreateRepositoryOutput_repositoryMetadata::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAICreateRepositoryOutput_repositoryMetadata::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAICreateRepositoryOutput_repositoryMetadata::getRepositoryDescription() const {
    return m_repository_description;
}
void OAICreateRepositoryOutput_repositoryMetadata::setRepositoryDescription(const QString &repository_description) {
    m_repository_description = repository_description;
    m_repository_description_isSet = true;
}

bool OAICreateRepositoryOutput_repositoryMetadata::is_repository_description_Set() const{
    return m_repository_description_isSet;
}

bool OAICreateRepositoryOutput_repositoryMetadata::is_repository_description_Valid() const{
    return m_repository_description_isValid;
}

QString OAICreateRepositoryOutput_repositoryMetadata::getDefaultBranch() const {
    return m_default_branch;
}
void OAICreateRepositoryOutput_repositoryMetadata::setDefaultBranch(const QString &default_branch) {
    m_default_branch = default_branch;
    m_default_branch_isSet = true;
}

bool OAICreateRepositoryOutput_repositoryMetadata::is_default_branch_Set() const{
    return m_default_branch_isSet;
}

bool OAICreateRepositoryOutput_repositoryMetadata::is_default_branch_Valid() const{
    return m_default_branch_isValid;
}

QDateTime OAICreateRepositoryOutput_repositoryMetadata::getLastModifiedDate() const {
    return m_last_modified_date;
}
void OAICreateRepositoryOutput_repositoryMetadata::setLastModifiedDate(const QDateTime &last_modified_date) {
    m_last_modified_date = last_modified_date;
    m_last_modified_date_isSet = true;
}

bool OAICreateRepositoryOutput_repositoryMetadata::is_last_modified_date_Set() const{
    return m_last_modified_date_isSet;
}

bool OAICreateRepositoryOutput_repositoryMetadata::is_last_modified_date_Valid() const{
    return m_last_modified_date_isValid;
}

QDateTime OAICreateRepositoryOutput_repositoryMetadata::getCreationDate() const {
    return m_creation_date;
}
void OAICreateRepositoryOutput_repositoryMetadata::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAICreateRepositoryOutput_repositoryMetadata::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAICreateRepositoryOutput_repositoryMetadata::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

QString OAICreateRepositoryOutput_repositoryMetadata::getCloneUrlHttp() const {
    return m_clone_url_http;
}
void OAICreateRepositoryOutput_repositoryMetadata::setCloneUrlHttp(const QString &clone_url_http) {
    m_clone_url_http = clone_url_http;
    m_clone_url_http_isSet = true;
}

bool OAICreateRepositoryOutput_repositoryMetadata::is_clone_url_http_Set() const{
    return m_clone_url_http_isSet;
}

bool OAICreateRepositoryOutput_repositoryMetadata::is_clone_url_http_Valid() const{
    return m_clone_url_http_isValid;
}

QString OAICreateRepositoryOutput_repositoryMetadata::getCloneUrlSsh() const {
    return m_clone_url_ssh;
}
void OAICreateRepositoryOutput_repositoryMetadata::setCloneUrlSsh(const QString &clone_url_ssh) {
    m_clone_url_ssh = clone_url_ssh;
    m_clone_url_ssh_isSet = true;
}

bool OAICreateRepositoryOutput_repositoryMetadata::is_clone_url_ssh_Set() const{
    return m_clone_url_ssh_isSet;
}

bool OAICreateRepositoryOutput_repositoryMetadata::is_clone_url_ssh_Valid() const{
    return m_clone_url_ssh_isValid;
}

QString OAICreateRepositoryOutput_repositoryMetadata::getArn() const {
    return m_arn;
}
void OAICreateRepositoryOutput_repositoryMetadata::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAICreateRepositoryOutput_repositoryMetadata::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAICreateRepositoryOutput_repositoryMetadata::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAICreateRepositoryOutput_repositoryMetadata::isSet() const {
...
bool OAICreateRepositoryOutput_repositoryMetadata::isValid() const {
