...
OAIGetCommentInput::OAIGetCommentInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetCommentInput::OAIGetCommentInput() {
    this->initializeModel();
}

OAIGetCommentInput::~OAIGetCommentInput() {}

void OAIGetCommentInput::initializeModel() {

    m_comment_id_isSet = false;
    m_comment_id_isValid = false;
}

void OAIGetCommentInput::fromJson(QString jsonString) {
...
void OAIGetCommentInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetCommentInput::asJson() const {
...
QJsonObject OAIGetCommentInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetCommentInput::getCommentId() const {
    return m_comment_id;
}
void OAIGetCommentInput::setCommentId(const QString &comment_id) {
    m_comment_id = comment_id;
    m_comment_id_isSet = true;
}

bool OAIGetCommentInput::is_comment_id_Set() const{
    return m_comment_id_isSet;
}

bool OAIGetCommentInput::is_comment_id_Valid() const{
    return m_comment_id_isValid;
}

bool OAIGetCommentInput::isSet() const {
...
bool OAIGetCommentInput::isValid() const {
