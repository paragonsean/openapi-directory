...
/*
 * OAIConflictMetadata_mergeOperations.h
 *
 * 
 */

#ifndef OAIConflictMetadata_mergeOperations_H
#define OAIConflictMetadata_mergeOperations_H
...
class OAIConflictMetadata_mergeOperations : public OAIObject {
public:
    OAIConflictMetadata_mergeOperations();
    OAIConflictMetadata_mergeOperations(QString json);
    ~OAIConflictMetadata_mergeOperations() override;
    ...
    OAIChangeTypeEnum getSource() const;
    void setSource(const OAIChangeTypeEnum &source);
    bool is_source_Set() const;
    bool is_source_Valid() const;

    OAIChangeTypeEnum getDestination() const;
    void setDestination(const OAIChangeTypeEnum &destination);
...
private:
    ...
    OAIChangeTypeEnum m_source;
    bool m_source_isSet;
    bool m_source_isValid;

    OAIChangeTypeEnum m_destination;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConflictMetadata_mergeOperations)

#endif // OAIConflictMetadata_mergeOperations_H
