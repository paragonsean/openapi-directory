...
/*
 * OAIUpdatePullRequestDescriptionOutput_pullRequest.h
 *
 * 
 */

#ifndef OAIUpdatePullRequestDescriptionOutput_pullRequest_H
#define OAIUpdatePullRequestDescriptionOutput_pullRequest_H
...
class OAIUpdatePullRequestDescriptionOutput_pullRequest : public OAIObject {
public:
    OAIUpdatePullRequestDescriptionOutput_pullRequest();
    OAIUpdatePullRequestDescriptionOutput_pullRequest(QString json);
    ~OAIUpdatePullRequestDescriptionOutput_pullRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePullRequestDescriptionOutput_pullRequest)

#endif // OAIUpdatePullRequestDescriptionOutput_pullRequest_H
