...
OAIConflictMetadata_isBinaryFile::OAIConflictMetadata_isBinaryFile(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConflictMetadata_isBinaryFile::OAIConflictMetadata_isBinaryFile() {
    this->initializeModel();
}

OAIConflictMetadata_isBinaryFile::~OAIConflictMetadata_isBinaryFile() {}

void OAIConflictMetadata_isBinaryFile::initializeModel() {
...
void OAIConflictMetadata_isBinaryFile::fromJson(QString jsonString) {
...
void OAIConflictMetadata_isBinaryFile::fromJsonObject(QJsonObject json) {
...
QString OAIConflictMetadata_isBinaryFile::asJson() const {
...
QJsonObject OAIConflictMetadata_isBinaryFile::asJsonObject() const {
    QJsonObject obj;
    if (m_source_isSet) {
...
bool OAIConflictMetadata_isBinaryFile::getSource() const {
    return m_source;
}
void OAIConflictMetadata_isBinaryFile::setSource(const bool &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAIConflictMetadata_isBinaryFile::is_source_Set() const{
    return m_source_isSet;
}

bool OAIConflictMetadata_isBinaryFile::is_source_Valid() const{
    return m_source_isValid;
}

bool OAIConflictMetadata_isBinaryFile::getDestination() const {
    return m_destination;
}
void OAIConflictMetadata_isBinaryFile::setDestination(const bool &destination) {
    m_destination = destination;
    m_destination_isSet = true;
}

bool OAIConflictMetadata_isBinaryFile::is_destination_Set() const{
    return m_destination_isSet;
}

bool OAIConflictMetadata_isBinaryFile::is_destination_Valid() const{
    return m_destination_isValid;
}

bool OAIConflictMetadata_isBinaryFile::getBase() const {
    return m_base;
}
void OAIConflictMetadata_isBinaryFile::setBase(const bool &base) {
    m_base = base;
    m_base_isSet = true;
}

bool OAIConflictMetadata_isBinaryFile::is_base_Set() const{
    return m_base_isSet;
}

bool OAIConflictMetadata_isBinaryFile::is_base_Valid() const{
    return m_base_isValid;
}

bool OAIConflictMetadata_isBinaryFile::isSet() const {
...
bool OAIConflictMetadata_isBinaryFile::isValid() const {
