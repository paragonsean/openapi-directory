...
/*
 * OAIMergeOperations.h
 *
 * Information about the file operation conflicts in a merge operation.
 */

#ifndef OAIMergeOperations_H
#define OAIMergeOperations_H
...
class OAIMergeOperations : public OAIObject {
public:
    OAIMergeOperations();
    OAIMergeOperations(QString json);
    ~OAIMergeOperations() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMergeOperations)

#endif // OAIMergeOperations_H
