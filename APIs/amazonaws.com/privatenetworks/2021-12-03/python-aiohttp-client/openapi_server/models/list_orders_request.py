...
class ListOrdersRequest(Model):
    ...
    def __init__(self, filters: Dict[str, List[str]]=None, max_results: int=None, network_arn: str=None, start_token: str=None):
        """ListOrdersRequest - a model defined in OpenAPI

        :param filters: The filters of this ListOrdersRequest.
        :param max_results: The max_results of this ListOrdersRequest.
        :param network_arn: The network_arn of this ListOrdersRequest.
        :param start_token: The start_token of this ListOrdersRequest.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ListOrdersRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ListOrders_request of this ListOrdersRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def filters(self):
        """Gets the filters of this ListOrdersRequest.
        ...
        :return: The filters of this ListOrdersRequest.
    ...
    def filters(self, filters):
        """Sets the filters of this ListOrdersRequest.
    ...
    def max_results(self):
        """Gets the max_results of this ListOrdersRequest.

        The maximum number of results to return.

        :return: The max_results of this ListOrdersRequest.
        :rtype: int
        """
    ...
    def network_arn(self):
        """Gets the network_arn of this ListOrdersRequest.

        The Amazon Resource Name (ARN) of the network.

        :return: The network_arn of this ListOrdersRequest.
        :rtype: str
        """
    ...
    def network_arn(self, network_arn):
        """Sets the network_arn of this ListOrdersRequest.
    ...
    def start_token(self):
        """Gets the start_token of this ListOrdersRequest.

        The token for the next page of results.

        :return: The start_token of this ListOrdersRequest.
        :rtype: str
        """
    ...
    def start_token(self, start_token):
        """Sets the start_token of this ListOrdersRequest.
