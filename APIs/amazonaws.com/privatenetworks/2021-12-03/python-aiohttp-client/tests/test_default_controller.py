...
async def test_acknowledge_order_receipt(client):
    """Test case for acknowledge_order_receipt
...
async def test_activate_device_identifier(client):
    """Test case for activate_device_identifier

    
    """
    body = {"deviceIdentifierArn":"","clientToken":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_activate_network_site(client):
    """Test case for activate_network_site

    
    """
    body = {"clientToken":"","networkSiteArn":"","commitmentConfiguration":{"commitmentLength":"","automaticRenewal":""},"shippingAddress":{"country":"","emailAddress":"","phoneNumber":"","stateOrProvince":"","street3":"","city":"","postalCode":"","name":"","company":"","street1":"","street2":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_configure_access_point(client):
    """Test case for configure_access_point

    
    """
    body = {"accessPointArn":"","cpiUserId":"","cpiUsername":"","position":{"elevation":"","latitude":"","elevationReference":"","elevationUnit":"","longitude":""},"cpiUserPassword":"","cpiSecretKey":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_network(client):
    ...
    """
    body = {"clientToken":"","networkName":"","description":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_network_site(client):
    """Test case for create_network_site

    
    """
    body = {"networkArn":"","availabilityZoneId":"","clientToken":"","description":"","networkSiteName":"","pendingPlan":{"options":"","resourceDefinitions":""},"availabilityZone":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_deactivate_device_identifier(client):
    """Test case for deactivate_device_identifier
...
async def test_delete_network(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v1/networks/{network_arn}'.format(network_arn='network_arn_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_network_site(client):
    """Test case for delete_network_site
    ...
    response = await client.request(
        method='DELETE',
        path='/v1/network-sites/{network_site_arn}'.format(network_site_arn='network_site_arn_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_device_identifier(client):
    """Test case for get_device_identifier
    ...
    response = await client.request(
        method='GET',
        path='/v1/device-identifiers/{device_identifier_arn}'.format(device_identifier_arn='device_identifier_arn_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_network_resource(client):
    """Test case for get_network_resource
    ...
    response = await client.request(
        method='GET',
        path='/v1/network-resources/{network_resource_arn}'.format(network_resource_arn='network_resource_arn_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_network_site(client):
    """Test case for get_network_site
...
async def test_get_order(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/orders/{order_arn}'.format(order_arn='order_arn_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_device_identifiers(client):
    """Test case for list_device_identifiers

    
    """
    body = {"networkArn":"","maxResults":"","startToken":"","filters":""}
    params = [('maxResults', 'max_results_example'),
                    ('startToken', 'start_token_example')]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_list_network_resources(client):
    """Test case for list_network_resources
...
async def test_list_network_sites(client):
    """Test case for list_network_sites
...
async def test_list_networks(client):
    ...
    """
    body = {"maxResults":"","startToken":"","filters":""}
    params = [('maxResults', 'max_results_example'),
                    ('startToken', 'start_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_start_network_resource_update(client):
    """Test case for start_network_resource_update

    
    """
    body = {"returnReason":"","commitmentConfiguration":{"commitmentLength":"","automaticRenewal":""},"shippingAddress":{"country":"","emailAddress":"","phoneNumber":"","stateOrProvince":"","street3":"","city":"","postalCode":"","name":"","company":"","street1":"","street2":""},"networkResourceArn":"","updateType":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_network_site(client):
    """Test case for update_network_site

    
    """
    body = {"clientToken":"","networkSiteArn":"","description":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_network_site_plan(client):
    """Test case for update_network_site_plan

    
    """
    body = {"clientToken":"","networkSiteArn":"","pendingPlan":{"options":"","resourceDefinitions":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
