...
/*
 * OAIListOrders_request.h
 *
 * 
 */

#ifndef OAIListOrders_request_H
#define OAIListOrders_request_H
...
class OAIListOrders_request : public OAIObject {
public:
    OAIListOrders_request();
    OAIListOrders_request(QString json);
    ~OAIListOrders_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListOrders_request)

#endif // OAIListOrders_request_H
