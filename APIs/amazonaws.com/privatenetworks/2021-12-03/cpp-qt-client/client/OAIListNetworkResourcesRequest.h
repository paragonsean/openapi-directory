...
/*
 * OAIListNetworkResourcesRequest.h
 *
 * 
 */

#ifndef OAIListNetworkResourcesRequest_H
#define OAIListNetworkResourcesRequest_H
...
class OAIListNetworkResourcesRequest : public OAIObject {
public:
    OAIListNetworkResourcesRequest();
    OAIListNetworkResourcesRequest(QString json);
    ~OAIListNetworkResourcesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListNetworkResourcesRequest)

#endif // OAIListNetworkResourcesRequest_H
