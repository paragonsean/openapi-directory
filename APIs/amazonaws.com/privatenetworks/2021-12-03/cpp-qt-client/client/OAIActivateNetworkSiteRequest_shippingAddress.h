...
/*
 * OAIActivateNetworkSiteRequest_shippingAddress.h
 *
 * 
 */

#ifndef OAIActivateNetworkSiteRequest_shippingAddress_H
#define OAIActivateNetworkSiteRequest_shippingAddress_H
...
class OAIActivateNetworkSiteRequest_shippingAddress : public OAIObject {
public:
    OAIActivateNetworkSiteRequest_shippingAddress();
    OAIActivateNetworkSiteRequest_shippingAddress(QString json);
    ~OAIActivateNetworkSiteRequest_shippingAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActivateNetworkSiteRequest_shippingAddress)

#endif // OAIActivateNetworkSiteRequest_shippingAddress_H
