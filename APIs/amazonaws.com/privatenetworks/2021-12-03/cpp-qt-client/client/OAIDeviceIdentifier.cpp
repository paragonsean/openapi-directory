...
QDateTime OAIDeviceIdentifier::getCreatedAt() const {
    return m_created_at;
}
void OAIDeviceIdentifier::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIDeviceIdentifier::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIDeviceIdentifier::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAIDeviceIdentifier::getDeviceIdentifierArn() const {
    return m_device_identifier_arn;
}
void OAIDeviceIdentifier::setDeviceIdentifierArn(const QString &device_identifier_arn) {
    m_device_identifier_arn = device_identifier_arn;
    m_device_identifier_arn_isSet = true;
}

bool OAIDeviceIdentifier::is_device_identifier_arn_Set() const{
    return m_device_identifier_arn_isSet;
}

bool OAIDeviceIdentifier::is_device_identifier_arn_Valid() const{
    return m_device_identifier_arn_isValid;
}

QString OAIDeviceIdentifier::getIccid() const {
    return m_iccid;
}
void OAIDeviceIdentifier::setIccid(const QString &iccid) {
    m_iccid = iccid;
    m_iccid_isSet = true;
}

bool OAIDeviceIdentifier::is_iccid_Set() const{
    return m_iccid_isSet;
}

bool OAIDeviceIdentifier::is_iccid_Valid() const{
    return m_iccid_isValid;
}

QString OAIDeviceIdentifier::getImsi() const {
    return m_imsi;
}
void OAIDeviceIdentifier::setImsi(const QString &imsi) {
    m_imsi = imsi;
    m_imsi_isSet = true;
}

bool OAIDeviceIdentifier::is_imsi_Set() const{
    return m_imsi_isSet;
}

bool OAIDeviceIdentifier::is_imsi_Valid() const{
    return m_imsi_isValid;
}

QString OAIDeviceIdentifier::getNetworkArn() const {
    return m_network_arn;
}
void OAIDeviceIdentifier::setNetworkArn(const QString &network_arn) {
    m_network_arn = network_arn;
    m_network_arn_isSet = true;
}

bool OAIDeviceIdentifier::is_network_arn_Set() const{
    return m_network_arn_isSet;
}

bool OAIDeviceIdentifier::is_network_arn_Valid() const{
    return m_network_arn_isValid;
}

QString OAIDeviceIdentifier::getOrderArn() const {
    return m_order_arn;
}
void OAIDeviceIdentifier::setOrderArn(const QString &order_arn) {
    m_order_arn = order_arn;
    m_order_arn_isSet = true;
}

bool OAIDeviceIdentifier::is_order_arn_Set() const{
    return m_order_arn_isSet;
}

bool OAIDeviceIdentifier::is_order_arn_Valid() const{
    return m_order_arn_isValid;
}

OAIDeviceIdentifierStatus OAIDeviceIdentifier::getStatus() const {
    return m_status;
}
void OAIDeviceIdentifier::setStatus(const OAIDeviceIdentifierStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDeviceIdentifier::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDeviceIdentifier::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIDeviceIdentifier::getTrafficGroupArn() const {
    return m_traffic_group_arn;
}
void OAIDeviceIdentifier::setTrafficGroupArn(const QString &traffic_group_arn) {
    m_traffic_group_arn = traffic_group_arn;
    m_traffic_group_arn_isSet = true;
}

bool OAIDeviceIdentifier::is_traffic_group_arn_Set() const{
    return m_traffic_group_arn_isSet;
}

bool OAIDeviceIdentifier::is_traffic_group_arn_Valid() const{
    return m_traffic_group_arn_isValid;
}

QString OAIDeviceIdentifier::getVendor() const {
    return m_vendor;
}
void OAIDeviceIdentifier::setVendor(const QString &vendor) {
    m_vendor = vendor;
    m_vendor_isSet = true;
}

bool OAIDeviceIdentifier::is_vendor_Set() const{
    return m_vendor_isSet;
}

bool OAIDeviceIdentifier::is_vendor_Valid() const{
