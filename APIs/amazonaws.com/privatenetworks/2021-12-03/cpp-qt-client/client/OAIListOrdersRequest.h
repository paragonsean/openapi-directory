...
/*
 * OAIListOrdersRequest.h
 *
 * 
 */

#ifndef OAIListOrdersRequest_H
#define OAIListOrdersRequest_H
...
class OAIListOrdersRequest : public OAIObject {
public:
    OAIListOrdersRequest();
    OAIListOrdersRequest(QString json);
    ~OAIListOrdersRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListOrdersRequest)

#endif // OAIListOrdersRequest_H
