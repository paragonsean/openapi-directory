...
#include "OAICommitmentInformation.h"
...
OAICommitmentInformation::OAICommitmentInformation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICommitmentInformation::OAICommitmentInformation() {
    this->initializeModel();
}

OAICommitmentInformation::~OAICommitmentInformation() {}

void OAICommitmentInformation::initializeModel() {
...
void OAICommitmentInformation::fromJson(QString jsonString) {
...
void OAICommitmentInformation::fromJsonObject(QJsonObject json) {
...
QString OAICommitmentInformation::asJson() const {
...
QJsonObject OAICommitmentInformation::asJsonObject() const {
    QJsonObject obj;
...
OAICommitmentInformation_commitmentConfiguration OAICommitmentInformation::getCommitmentConfiguration() const {
    return m_commitment_configuration;
}
void OAICommitmentInformation::setCommitmentConfiguration(const OAICommitmentInformation_commitmentConfiguration &commitment_configuration) {
    m_commitment_configuration = commitment_configuration;
    m_commitment_configuration_isSet = true;
}

bool OAICommitmentInformation::is_commitment_configuration_Set() const{
    return m_commitment_configuration_isSet;
}

bool OAICommitmentInformation::is_commitment_configuration_Valid() const{
    return m_commitment_configuration_isValid;
}

QDateTime OAICommitmentInformation::getExpiresOn() const {
    return m_expires_on;
}
void OAICommitmentInformation::setExpiresOn(const QDateTime &expires_on) {
    m_expires_on = expires_on;
    m_expires_on_isSet = true;
}

bool OAICommitmentInformation::is_expires_on_Set() const{
    return m_expires_on_isSet;
}

bool OAICommitmentInformation::is_expires_on_Valid() const{
    return m_expires_on_isValid;
}

QDateTime OAICommitmentInformation::getStartAt() const {
    return m_start_at;
}
void OAICommitmentInformation::setStartAt(const QDateTime &start_at) {
    m_start_at = start_at;
    m_start_at_isSet = true;
}

bool OAICommitmentInformation::is_start_at_Set() const{
    return m_start_at_isSet;
}

bool OAICommitmentInformation::is_start_at_Valid() const{
    return m_start_at_isValid;
}

bool OAICommitmentInformation::isSet() const {
...
bool OAICommitmentInformation::isValid() const {
