...
/*
 * OAIActivateNetworkSite_request_shippingAddress.h
 *
 * Information about an address.
 */

#ifndef OAIActivateNetworkSite_request_shippingAddress_H
#define OAIActivateNetworkSite_request_shippingAddress_H
...
class OAIActivateNetworkSite_request_shippingAddress : public OAIObject {
public:
    OAIActivateNetworkSite_request_shippingAddress();
    OAIActivateNetworkSite_request_shippingAddress(QString json);
    ~OAIActivateNetworkSite_request_shippingAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActivateNetworkSite_request_shippingAddress)

#endif // OAIActivateNetworkSite_request_shippingAddress_H
