...
/*
 * OAIListNetworksRequest.h
 *
 * 
 */

#ifndef OAIListNetworksRequest_H
#define OAIListNetworksRequest_H
...
class OAIListNetworksRequest : public OAIObject {
public:
    OAIListNetworksRequest();
    OAIListNetworksRequest(QString json);
    ~OAIListNetworksRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListNetworksRequest)

#endif // OAIListNetworksRequest_H
