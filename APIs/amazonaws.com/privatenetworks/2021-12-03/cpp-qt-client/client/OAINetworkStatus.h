...
class OAINetworkStatus : public OAIEnum {
public:
    OAINetworkStatus();
    ...
    OAINetworkStatus::eOAINetworkStatus getValue() const;
    void setValue(const OAINetworkStatus::eOAINetworkStatus& value);
