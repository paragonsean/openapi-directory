...
/*
 * OAICreateNetworkRequest.h
 *
 * 
 */

#ifndef OAICreateNetworkRequest_H
#define OAICreateNetworkRequest_H
...
class OAICreateNetworkRequest : public OAIObject {
public:
    OAICreateNetworkRequest();
    OAICreateNetworkRequest(QString json);
    ~OAICreateNetworkRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateNetworkRequest)

#endif // OAICreateNetworkRequest_H
