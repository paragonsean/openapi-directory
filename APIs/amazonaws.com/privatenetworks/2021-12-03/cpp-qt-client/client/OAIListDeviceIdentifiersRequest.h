...
/*
 * OAIListDeviceIdentifiersRequest.h
 *
 * 
 */

#ifndef OAIListDeviceIdentifiersRequest_H
#define OAIListDeviceIdentifiersRequest_H
...
class OAIListDeviceIdentifiersRequest : public OAIObject {
public:
    OAIListDeviceIdentifiersRequest();
    OAIListDeviceIdentifiersRequest(QString json);
    ~OAIListDeviceIdentifiersRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDeviceIdentifiersRequest)

#endif // OAIListDeviceIdentifiersRequest_H
