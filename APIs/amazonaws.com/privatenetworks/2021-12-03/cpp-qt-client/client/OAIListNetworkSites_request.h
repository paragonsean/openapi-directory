...
/*
 * OAIListNetworkSites_request.h
 *
 * 
 */

#ifndef OAIListNetworkSites_request_H
#define OAIListNetworkSites_request_H
...
class OAIListNetworkSites_request : public OAIObject {
public:
    OAIListNetworkSites_request();
    OAIListNetworkSites_request(QString json);
    ~OAIListNetworkSites_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListNetworkSites_request)

#endif // OAIListNetworkSites_request_H
