...
/*
 * OAIReturnInformation_shippingAddress.h
 *
 * 
 */

#ifndef OAIReturnInformation_shippingAddress_H
#define OAIReturnInformation_shippingAddress_H
...
class OAIReturnInformation_shippingAddress : public OAIObject {
public:
    OAIReturnInformation_shippingAddress();
    OAIReturnInformation_shippingAddress(QString json);
    ~OAIReturnInformation_shippingAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReturnInformation_shippingAddress)

#endif // OAIReturnInformation_shippingAddress_H
