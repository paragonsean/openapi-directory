...
/*
 * OAICreateNetworkResponse_network.h
 *
 * 
 */

#ifndef OAICreateNetworkResponse_network_H
#define OAICreateNetworkResponse_network_H
...
class OAICreateNetworkResponse_network : public OAIObject {
public:
    OAICreateNetworkResponse_network();
    OAICreateNetworkResponse_network(QString json);
    ~OAICreateNetworkResponse_network() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateNetworkResponse_network)

#endif // OAICreateNetworkResponse_network_H
