...
/*
 * OAICreateNetwork_request.h
 *
 * 
 */

#ifndef OAICreateNetwork_request_H
#define OAICreateNetwork_request_H
...
class OAICreateNetwork_request : public OAIObject {
public:
    OAICreateNetwork_request();
    OAICreateNetwork_request(QString json);
    ~OAICreateNetwork_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateNetwork_request)

#endif // OAICreateNetwork_request_H
