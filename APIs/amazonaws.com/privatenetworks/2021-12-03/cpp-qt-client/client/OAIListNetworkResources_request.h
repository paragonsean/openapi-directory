...
/*
 * OAIListNetworkResources_request.h
 *
 * 
 */

#ifndef OAIListNetworkResources_request_H
#define OAIListNetworkResources_request_H
...
class OAIListNetworkResources_request : public OAIObject {
public:
    OAIListNetworkResources_request();
    OAIListNetworkResources_request(QString json);
    ~OAIListNetworkResources_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListNetworkResources_request)

#endif // OAIListNetworkResources_request_H
