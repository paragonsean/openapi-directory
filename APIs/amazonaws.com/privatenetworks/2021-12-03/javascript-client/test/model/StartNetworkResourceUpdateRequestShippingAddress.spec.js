...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPrivate5G.StartNetworkResourceUpdateRequestShippingAddress();
  });
  ...
  describe('StartNetworkResourceUpdateRequestShippingAddress', function() {
    it('should create an instance of StartNetworkResourceUpdateRequestShippingAddress', function() {
      // uncomment below and update the code to test StartNetworkResourceUpdateRequestShippingAddress
      //var instance = new AwsPrivate5G.StartNetworkResourceUpdateRequestShippingAddress();
      //expect(instance).to.be.a(AwsPrivate5G.StartNetworkResourceUpdateRequestShippingAddress);
    });
