...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPrivate5G.ListNetworksResponse();
  });
  ...
  describe('ListNetworksResponse', function() {
    it('should create an instance of ListNetworksResponse', function() {
      // uncomment below and update the code to test ListNetworksResponse
      //var instance = new AwsPrivate5G.ListNetworksResponse();
      //expect(instance).to.be.a(AwsPrivate5G.ListNetworksResponse);
    });
