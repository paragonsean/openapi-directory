...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPrivate5G.TrackingInformation();
  });
  ...
  describe('TrackingInformation', function() {
    it('should create an instance of TrackingInformation', function() {
      ...
      //var instance = new AwsPrivate5G.TrackingInformation();
      //expect(instance).to.be.a(AwsPrivate5G.TrackingInformation);
    });
