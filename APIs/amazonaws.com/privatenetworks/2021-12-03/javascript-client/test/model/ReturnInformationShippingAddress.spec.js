...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPrivate5G.ReturnInformationShippingAddress();
  });
  ...
  describe('ReturnInformationShippingAddress', function() {
    it('should create an instance of ReturnInformationShippingAddress', function() {
      // uncomment below and update the code to test ReturnInformationShippingAddress
      //var instance = new AwsPrivate5G.ReturnInformationShippingAddress();
      //expect(instance).to.be.a(AwsPrivate5G.ReturnInformationShippingAddress);
    });
