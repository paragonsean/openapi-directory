...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPrivate5G.ActivateNetworkSiteRequestShippingAddress();
  });
  ...
  describe('ActivateNetworkSiteRequestShippingAddress', function() {
    it('should create an instance of ActivateNetworkSiteRequestShippingAddress', function() {
      // uncomment below and update the code to test ActivateNetworkSiteRequestShippingAddress
      //var instance = new AwsPrivate5G.ActivateNetworkSiteRequestShippingAddress();
      //expect(instance).to.be.a(AwsPrivate5G.ActivateNetworkSiteRequestShippingAddress);
    });
