...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPrivate5G.OrderShippingAddress();
  });
  ...
  describe('OrderShippingAddress', function() {
    it('should create an instance of OrderShippingAddress', function() {
      // uncomment below and update the code to test OrderShippingAddress
      //var instance = new AwsPrivate5G.OrderShippingAddress();
      //expect(instance).to.be.a(AwsPrivate5G.OrderShippingAddress);
    });
