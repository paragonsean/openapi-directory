...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPrivate5G.CreateNetworkRequest();
  });
  ...
  describe('CreateNetworkRequest', function() {
    it('should create an instance of CreateNetworkRequest', function() {
      // uncomment below and update the code to test CreateNetworkRequest
      //var instance = new AwsPrivate5G.CreateNetworkRequest();
      //expect(instance).to.be.a(AwsPrivate5G.CreateNetworkRequest);
    });
