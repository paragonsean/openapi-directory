...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPrivate5G.ListOrdersResponse();
  });
  ...
  describe('ListOrdersResponse', function() {
    it('should create an instance of ListOrdersResponse', function() {
      // uncomment below and update the code to test ListOrdersResponse
      //var instance = new AwsPrivate5G.ListOrdersResponse();
      //expect(instance).to.be.a(AwsPrivate5G.ListOrdersResponse);
    });
