...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsPrivate5G.NetworkResourceReturnInformation();
  });
  ...
  describe('NetworkResourceReturnInformation', function() {
    it('should create an instance of NetworkResourceReturnInformation', function() {
      // uncomment below and update the code to test NetworkResourceReturnInformation
      //var instance = new AwsPrivate5G.NetworkResourceReturnInformation();
      //expect(instance).to.be.a(AwsPrivate5G.NetworkResourceReturnInformation);
    });

    it('should have the property replacementOrderArn (base name: "replacementOrderArn")', function() {
      // uncomment below and update the code to test the property replacementOrderArn
      //var instance = new AwsPrivate5G.NetworkResourceReturnInformation();
