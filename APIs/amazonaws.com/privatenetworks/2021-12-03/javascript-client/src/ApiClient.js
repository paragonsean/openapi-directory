...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://private-networks.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://private-networks.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2021-12-03/Javascript'
        };
