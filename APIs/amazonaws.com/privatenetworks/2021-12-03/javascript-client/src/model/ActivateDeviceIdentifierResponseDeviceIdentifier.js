...
/**
 * The ActivateDeviceIdentifierResponseDeviceIdentifier model module.
 * @module model/ActivateDeviceIdentifierResponseDeviceIdentifier
 * @version 2021-12-03
 */
class ActivateDeviceIdentifierResponseDeviceIdentifier {
    /**
     * Constructs a new <code>ActivateDeviceIdentifierResponseDeviceIdentifier</code>.
     * @alias module:model/ActivateDeviceIdentifierResponseDeviceIdentifier
     * @implements module:model/DeviceIdentifier
     */
    constructor() { 
        DeviceIdentifier.initialize(this);
        ActivateDeviceIdentifierResponseDeviceIdentifier.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ActivateDeviceIdentifierResponseDeviceIdentifier</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActivateDeviceIdentifierResponseDeviceIdentifier} obj Optional instance to populate.
     * @return {module:model/ActivateDeviceIdentifierResponseDeviceIdentifier} The populated <code>ActivateDeviceIdentifierResponseDeviceIdentifier</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActivateDeviceIdentifierResponseDeviceIdentifier();
            DeviceIdentifier.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ActivateDeviceIdentifierResponseDeviceIdentifier</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActivateDeviceIdentifierResponseDeviceIdentifier</code>.
     */
 ...
 */
ActivateDeviceIdentifierResponseDeviceIdentifier.prototype['createdAt'] = undefined;

/**
 * @member {String} deviceIdentifierArn
 */
ActivateDeviceIdentifierResponseDeviceIdentifier.prototype['deviceIdentifierArn'] = undefined;

/**
 * @member {String} iccid
 */
ActivateDeviceIdentifierResponseDeviceIdentifier.prototype['iccid'] = undefined;

/**
 * @member {String} imsi
 */
ActivateDeviceIdentifierResponseDeviceIdentifier.prototype['imsi'] = undefined;

/**
 * @member {String} networkArn
 */
ActivateDeviceIdentifierResponseDeviceIdentifier.prototype['networkArn'] = undefined;

/**
 * @member {String} orderArn
 */
ActivateDeviceIdentifierResponseDeviceIdentifier.prototype['orderArn'] = undefined;

/**
 * @member {module:model/DeviceIdentifierStatus} status
 */
ActivateDeviceIdentifierResponseDeviceIdentifier.prototype['status'] = undefined;

/**
 * @member {String} trafficGroupArn
 */
ActivateDeviceIdentifierResponseDeviceIdentifier.prototype['trafficGroupArn'] = undefined;

/**
 * @member {String} vendor
 */
ActivateDeviceIdentifierResponseDeviceIdentifier.prototype['vendor'] = undefined;


// Implement DeviceIdentifier interface:
/**
 * @member {Date} createdAt
 */
...
export default ActivateDeviceIdentifierResponseDeviceIdentifier;
