...
/**
 * The ActivateNetworkSiteRequestShippingAddress model module.
 * @module model/ActivateNetworkSiteRequestShippingAddress
 * @version 2021-12-03
 */
class ActivateNetworkSiteRequestShippingAddress {
    /**
     * Constructs a new <code>ActivateNetworkSiteRequestShippingAddress</code>.
     * @alias module:model/ActivateNetworkSiteRequestShippingAddress
    ...
    constructor(city, country, name, postalCode, stateOrProvince, street1) { 
        ...
        ActivateNetworkSiteRequestShippingAddress.initialize(this, city, country, name, postalCode, stateOrProvince, street1);
    }
    ...
    /**
     * Constructs a <code>ActivateNetworkSiteRequestShippingAddress</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActivateNetworkSiteRequestShippingAddress} obj Optional instance to populate.
     * @return {module:model/ActivateNetworkSiteRequestShippingAddress} The populated <code>ActivateNetworkSiteRequestShippingAddress</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActivateNetworkSiteRequestShippingAddress();
    ...
    /**
     * Validates the JSON data with respect to <code>ActivateNetworkSiteRequestShippingAddress</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActivateNetworkSiteRequestShippingAddress</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ActivateNetworkSiteRequestShippingAddress.RequiredProperties) {
...
ActivateNetworkSiteRequestShippingAddress.RequiredProperties = ["city", "country", "name", "postalCode", "stateOrProvince", "street1"];

/**
 * @member {String} city
 */
ActivateNetworkSiteRequestShippingAddress.prototype['city'] = undefined;

/**
 * @member {String} company
 */
ActivateNetworkSiteRequestShippingAddress.prototype['company'] = undefined;

/**
 * @member {String} country
 */
ActivateNetworkSiteRequestShippingAddress.prototype['country'] = undefined;

/**
 * @member {String} emailAddress
 */
ActivateNetworkSiteRequestShippingAddress.prototype['emailAddress'] = undefined;

/**
 * @member {String} name
 */
ActivateNetworkSiteRequestShippingAddress.prototype['name'] = undefined;

/**
 * @member {String} phoneNumber
 */
ActivateNetworkSiteRequestShippingAddress.prototype['phoneNumber'] = undefined;

/**
 * @member {String} postalCode
 */
ActivateNetworkSiteRequestShippingAddress.prototype['postalCode'] = undefined;

/**
 * @member {String} stateOrProvince
 */
ActivateNetworkSiteRequestShippingAddress.prototype['stateOrProvince'] = undefined;

/**
 * @member {String} street1
 */
ActivateNetworkSiteRequestShippingAddress.prototype['street1'] = undefined;

/**
 * @member {String} street2
 */
ActivateNetworkSiteRequestShippingAddress.prototype['street2'] = undefined;

/**
 * @member {String} street3
 */
ActivateNetworkSiteRequestShippingAddress.prototype['street3'] = undefined;
...
export default ActivateNetworkSiteRequestShippingAddress;
