...
/**
 * The ReturnInformationShippingAddress model module.
 * @module model/ReturnInformationShippingAddress
 * @version 2021-12-03
 */
class ReturnInformationShippingAddress {
    /**
     * Constructs a new <code>ReturnInformationShippingAddress</code>.
     * @alias module:model/ReturnInformationShippingAddress
    ...
    constructor(city, country, name, postalCode, stateOrProvince, street1) { 
        ...
        ReturnInformationShippingAddress.initialize(this, city, country, name, postalCode, stateOrProvince, street1);
    }
    ...
    /**
     * Constructs a <code>ReturnInformationShippingAddress</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReturnInformationShippingAddress} obj Optional instance to populate.
     * @return {module:model/ReturnInformationShippingAddress} The populated <code>ReturnInformationShippingAddress</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReturnInformationShippingAddress();
    ...
    /**
     * Validates the JSON data with respect to <code>ReturnInformationShippingAddress</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReturnInformationShippingAddress</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ReturnInformationShippingAddress.RequiredProperties) {
...
ReturnInformationShippingAddress.RequiredProperties = ["city", "country", "name", "postalCode", "stateOrProvince", "street1"];

/**
 * @member {String} city
 */
ReturnInformationShippingAddress.prototype['city'] = undefined;

/**
 * @member {String} company
 */
ReturnInformationShippingAddress.prototype['company'] = undefined;

/**
 * @member {String} country
 */
ReturnInformationShippingAddress.prototype['country'] = undefined;

/**
 * @member {String} emailAddress
 */
ReturnInformationShippingAddress.prototype['emailAddress'] = undefined;

/**
 * @member {String} name
 */
ReturnInformationShippingAddress.prototype['name'] = undefined;

/**
 * @member {String} phoneNumber
 */
ReturnInformationShippingAddress.prototype['phoneNumber'] = undefined;

/**
 * @member {String} postalCode
 */
ReturnInformationShippingAddress.prototype['postalCode'] = undefined;

/**
 * @member {String} stateOrProvince
 */
ReturnInformationShippingAddress.prototype['stateOrProvince'] = undefined;

/**
 * @member {String} street1
 */
ReturnInformationShippingAddress.prototype['street1'] = undefined;

/**
 * @member {String} street2
 */
ReturnInformationShippingAddress.prototype['street2'] = undefined;

/**
 * @member {String} street3
 */
ReturnInformationShippingAddress.prototype['street3'] = undefined;
...
export default ReturnInformationShippingAddress;
