...
/**
 * The ActivateNetworkSiteResponseNetworkSite model module.
 * @module model/ActivateNetworkSiteResponseNetworkSite
 * @version 2021-12-03
 */
class ActivateNetworkSiteResponseNetworkSite {
    /**
     * Constructs a new <code>ActivateNetworkSiteResponseNetworkSite</code>.
     * @alias module:model/ActivateNetworkSiteResponseNetworkSite
     * @implements module:model/NetworkSite
    ...
    constructor(networkArn, networkSiteArn, networkSiteName, status) { 
        ...
        ActivateNetworkSiteResponseNetworkSite.initialize(this, networkArn, networkSiteArn, networkSiteName, status);
    }
    ...
    /**
     * Constructs a <code>ActivateNetworkSiteResponseNetworkSite</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActivateNetworkSiteResponseNetworkSite} obj Optional instance to populate.
     * @return {module:model/ActivateNetworkSiteResponseNetworkSite} The populated <code>ActivateNetworkSiteResponseNetworkSite</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActivateNetworkSiteResponseNetworkSite();
            NetworkSite.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ActivateNetworkSiteResponseNetworkSite</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActivateNetworkSiteResponseNetworkSite</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ActivateNetworkSiteResponseNetworkSite.RequiredProperties) {
...
ActivateNetworkSiteResponseNetworkSite.RequiredProperties = ["networkArn", "networkSiteArn", "networkSiteName", "status"];

/**
 * @member {String} availabilityZone
 */
ActivateNetworkSiteResponseNetworkSite.prototype['availabilityZone'] = undefined;

/**
 * @member {String} availabilityZoneId
 */
ActivateNetworkSiteResponseNetworkSite.prototype['availabilityZoneId'] = undefined;

/**
 * @member {Date} createdAt
 */
ActivateNetworkSiteResponseNetworkSite.prototype['createdAt'] = undefined;

/**
 * @member {module:model/NetworkSiteCurrentPlan} currentPlan
 */
ActivateNetworkSiteResponseNetworkSite.prototype['currentPlan'] = undefined;

/**
 * @member {String} description
 */
ActivateNetworkSiteResponseNetworkSite.prototype['description'] = undefined;

/**
 * @member {String} networkArn
 */
ActivateNetworkSiteResponseNetworkSite.prototype['networkArn'] = undefined;

/**
 * @member {String} networkSiteArn
 */
ActivateNetworkSiteResponseNetworkSite.prototype['networkSiteArn'] = undefined;

/**
 * @member {String} networkSiteName
 */
ActivateNetworkSiteResponseNetworkSite.prototype['networkSiteName'] = undefined;

/**
 * @member {module:model/NetworkSitePendingPlan} pendingPlan
 */
ActivateNetworkSiteResponseNetworkSite.prototype['pendingPlan'] = undefined;

/**
 * @member {module:model/NetworkSiteStatus} status
 */
ActivateNetworkSiteResponseNetworkSite.prototype['status'] = undefined;

/**
 * @member {String} statusReason
 */
ActivateNetworkSiteResponseNetworkSite.prototype['statusReason'] = undefined;


// Implement NetworkSite interface:
/**
 * @member {String} availabilityZone
 */
...
export default ActivateNetworkSiteResponseNetworkSite;
