...
public class NetworkSite {
  ...
  public NetworkSite availabilityZone(String availabilityZone) {
  ...
  public NetworkSite availabilityZoneId(String availabilityZoneId) {
  ...
  public NetworkSite createdAt(OffsetDateTime createdAt) {
  ...
  public NetworkSite currentPlan(NetworkSiteCurrentPlan currentPlan) {
  ...
  public NetworkSite description(String description) {
  ...
  public NetworkSite networkArn(String networkArn) {
  ...
  public NetworkSite networkSiteArn(String networkSiteArn) {
  ...
  public NetworkSite networkSiteName(String networkSiteName) {
  ...
  public NetworkSite pendingPlan(NetworkSitePendingPlan pendingPlan) {
  ...
  public NetworkSite status(NetworkSiteStatus status) {
    this.status = status;
    return this;
  }
  ...
  public NetworkSite statusReason(String statusReason) {
  ...
  public boolean equals(Object o) {
    ...
    NetworkSite networkSite = (NetworkSite) o;
    return Objects.equals(this.availabilityZone, networkSite.availabilityZone) &&
        Objects.equals(this.availabilityZoneId, networkSite.availabilityZoneId) &&
        Objects.equals(this.createdAt, networkSite.createdAt) &&
        Objects.equals(this.currentPlan, networkSite.currentPlan) &&
        Objects.equals(this.description, networkSite.description) &&
        Objects.equals(this.networkArn, networkSite.networkArn) &&
        Objects.equals(this.networkSiteArn, networkSite.networkSiteArn) &&
        Objects.equals(this.networkSiteName, networkSite.networkSiteName) &&
        Objects.equals(this.pendingPlan, networkSite.pendingPlan) &&
        Objects.equals(this.status, networkSite.status) &&
        Objects.equals(this.statusReason, networkSite.statusReason);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NetworkSite
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NetworkSite.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworkSite is not found in the empty JSON string", NetworkSite.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NetworkSite.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NetworkSite` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NetworkSite.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworkSite.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworkSite' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworkSite> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworkSite.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworkSite>() {
           @Override
           public void write(JsonWriter out, NetworkSite value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NetworkSite read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NetworkSite given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NetworkSite
   * @throws IOException if the JSON string is invalid with respect to NetworkSite
   */
  public static NetworkSite fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworkSite.class);
  }

  /**
   * Convert an instance of NetworkSite to an JSON string
   *
   * @return JSON string
   */
