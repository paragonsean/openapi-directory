...
public class ListOrdersRequest {
  ...
  public ListOrdersRequest filters(Map<String, List<String>> filters) {
    this.filters = filters;
    return this;
  }

  public ListOrdersRequest putFiltersItem(String key, List<String> filtersItem) {
  ...
  public ListOrdersRequest networkArn(String networkArn) {
  ...
  public ListOrdersRequest startToken(String startToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.filters, listOrdersRequest.filters) &&
        Objects.equals(this.maxResults, listOrdersRequest.maxResults) &&
        Objects.equals(this.networkArn, listOrdersRequest.networkArn) &&
        Objects.equals(this.startToken, listOrdersRequest.startToken);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListOrdersRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListOrdersRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListOrdersRequest is not found in the empty JSON string", ListOrdersRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListOrdersRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListOrdersRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListOrdersRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListOrdersRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListOrdersRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListOrdersRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListOrdersRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListOrdersRequest>() {
           @Override
           public void write(JsonWriter out, ListOrdersRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListOrdersRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListOrdersRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListOrdersRequest
   * @throws IOException if the JSON string is invalid with respect to ListOrdersRequest
   */
  public static ListOrdersRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListOrdersRequest.class);
  }

  /**
   * Convert an instance of ListOrdersRequest to an JSON string
   *
   * @return JSON string
   */
