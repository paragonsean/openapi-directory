...
* @readonly
*/
export default class ChangeTokenStatus {
    ...
    /**
    * Returns a <code>ChangeTokenStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ChangeTokenStatus} The enum <code>ChangeTokenStatus</code> value.
    */
