...
* @readonly
*/
export default class MatchFieldType {
    ...
    /**
    * Returns a <code>MatchFieldType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/MatchFieldType} The enum <code>MatchFieldType</code> value.
    */
