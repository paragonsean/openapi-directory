...
/**
 * The ListXssMatchSetsRequest model module.
 * @module model/ListXssMatchSetsRequest
 * @version 2015-08-24
 */
class ListXssMatchSetsRequest {
    /**
     * Constructs a new <code>ListXssMatchSetsRequest</code>.
     * A request to list the &lt;a&gt;XssMatchSet&lt;/a&gt; objects created by the current AWS account.
     * @alias module:model/ListXssMatchSetsRequest
     */
    constructor() { 
        
        ListXssMatchSetsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListXssMatchSetsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListXssMatchSetsRequest} obj Optional instance to populate.
     * @return {module:model/ListXssMatchSetsRequest} The populated <code>ListXssMatchSetsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListXssMatchSetsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListXssMatchSetsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListXssMatchSetsRequest</code>.
     */
 ...
 */
ListXssMatchSetsRequest.prototype['NextMarker'] = undefined;

/**
 * @member {Number} Limit
 */
ListXssMatchSetsRequest.prototype['Limit'] = undefined;
...
export default ListXssMatchSetsRequest;
