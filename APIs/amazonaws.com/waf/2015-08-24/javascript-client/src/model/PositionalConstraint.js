...
* @readonly
*/
export default class PositionalConstraint {
    ...
    /**
    * Returns a <code>PositionalConstraint</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PositionalConstraint} The enum <code>PositionalConstraint</code> value.
    */
