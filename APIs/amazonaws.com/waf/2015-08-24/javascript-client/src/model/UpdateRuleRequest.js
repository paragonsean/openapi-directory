...
class UpdateRuleRequest {
     ...
     * @param updates {Array} 
     */
    constructor(ruleId, changeToken, updates) { 
        
        UpdateRuleRequest.initialize(this, ruleId, changeToken, updates);
    }
     ...
     */
    static initialize(obj, ruleId, changeToken, updates) { 
        obj['RuleId'] = ruleId;
...
UpdateRuleRequest.RequiredProperties = ["RuleId", "ChangeToken", "Updates"];

/**
 * @member {String} RuleId
 */
UpdateRuleRequest.prototype['RuleId'] = undefined;

/**
 * @member {String} ChangeToken
 */
UpdateRuleRequest.prototype['ChangeToken'] = undefined;

/**
 * @member {Array} Updates
 */
UpdateRuleRequest.prototype['Updates'] = undefined;
