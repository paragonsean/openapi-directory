...
* @readonly
*/
export default class PredicateType {
    ...
    /**
    * Returns a <code>PredicateType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PredicateType} The enum <code>PredicateType</code> value.
    */
