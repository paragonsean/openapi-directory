...
* @readonly
*/
export default class GeoMatchConstraintValue {
    ...
    /**
    * Returns a <code>GeoMatchConstraintValue</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/GeoMatchConstraintValue} The enum <code>GeoMatchConstraintValue</code> value.
    */
