...
/**
 * The TagInfoForResource model module.
 * @module model/TagInfoForResource
 * @version 2015-08-24
 */
class TagInfoForResource {
    /**
     * Constructs a new <code>TagInfoForResource</code>.
     ...
     * @alias module:model/TagInfoForResource
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>TagInfoForResource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TagInfoForResource} obj Optional instance to populate.
     * @return {module:model/TagInfoForResource} The populated <code>TagInfoForResource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TagInfoForResource();
    ...
    /**
     * Validates the JSON data with respect to <code>TagInfoForResource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TagInfoForResource</code>.
     */
...
export default TagInfoForResource;
