...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.GetSampledRequestsRequest();
  });
  ...
  describe('GetSampledRequestsRequest', function() {
    it('should create an instance of GetSampledRequestsRequest', function() {
      // uncomment below and update the code to test GetSampledRequestsRequest
      //var instance = new AwsWaf.GetSampledRequestsRequest();
      //expect(instance).to.be.a(AwsWaf.GetSampledRequestsRequest);
    });
