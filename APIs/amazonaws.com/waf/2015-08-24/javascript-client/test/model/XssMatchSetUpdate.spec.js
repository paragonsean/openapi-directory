...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.XssMatchSetUpdate();
  });
  ...
  describe('XssMatchSetUpdate', function() {
    it('should create an instance of XssMatchSetUpdate', function() {
      // uncomment below and update the code to test XssMatchSetUpdate
      //var instance = new AwsWaf.XssMatchSetUpdate();
      //expect(instance).to.be.a(AwsWaf.XssMatchSetUpdate);
    });
    ...
    it('should have the property xssMatchTuple (base name: "XssMatchTuple")', function() {
      // uncomment below and update the code to test the property xssMatchTuple
      //var instance = new AwsWaf.XssMatchSetUpdate();
      //expect(instance).to.be();
    });
