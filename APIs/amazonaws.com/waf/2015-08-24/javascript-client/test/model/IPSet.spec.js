...
(function(root, factory) {
  ...
  describe('IPSet', function() {
    it('should create an instance of IPSet', function() {
      // uncomment below and update the code to test IPSet
      //var instance = new AwsWaf.IPSet();
      //expect(instance).to.be.a(AwsWaf.IPSet);
    });
