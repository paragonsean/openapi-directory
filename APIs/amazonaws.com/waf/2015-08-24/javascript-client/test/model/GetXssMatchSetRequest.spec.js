...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.GetXssMatchSetRequest();
  });
  ...
  describe('GetXssMatchSetRequest', function() {
    it('should create an instance of GetXssMatchSetRequest', function() {
      // uncomment below and update the code to test GetXssMatchSetRequest
      //var instance = new AwsWaf.GetXssMatchSetRequest();
      //expect(instance).to.be.a(AwsWaf.GetXssMatchSetRequest);
    });
