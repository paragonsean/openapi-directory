...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.ListSubscribedRuleGroupsResponse();
  });
  ...
  describe('ListSubscribedRuleGroupsResponse', function() {
    it('should create an instance of ListSubscribedRuleGroupsResponse', function() {
      // uncomment below and update the code to test ListSubscribedRuleGroupsResponse
      //var instance = new AwsWaf.ListSubscribedRuleGroupsResponse();
      //expect(instance).to.be.a(AwsWaf.ListSubscribedRuleGroupsResponse);
    });
