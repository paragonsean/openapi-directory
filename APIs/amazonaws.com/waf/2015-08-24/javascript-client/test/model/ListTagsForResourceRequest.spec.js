...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.ListTagsForResourceRequest();
  });
  ...
  describe('ListTagsForResourceRequest', function() {
    it('should create an instance of ListTagsForResourceRequest', function() {
      // uncomment below and update the code to test ListTagsForResourceRequest
      //var instance = new AwsWaf.ListTagsForResourceRequest();
      //expect(instance).to.be.a(AwsWaf.ListTagsForResourceRequest);
    });
