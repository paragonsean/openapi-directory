...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.SampledHTTPRequestRequest();
  });
  ...
  describe('SampledHTTPRequestRequest', function() {
    it('should create an instance of SampledHTTPRequestRequest', function() {
      // uncomment below and update the code to test SampledHTTPRequestRequest
      //var instance = new AwsWaf.SampledHTTPRequestRequest();
      //expect(instance).to.be.a(AwsWaf.SampledHTTPRequestRequest);
    });
