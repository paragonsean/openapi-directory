...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.CreateWebACLResponseWebACL();
  });
  ...
  describe('CreateWebACLResponseWebACL', function() {
    it('should create an instance of CreateWebACLResponseWebACL', function() {
      // uncomment below and update the code to test CreateWebACLResponseWebACL
      //var instance = new AwsWaf.CreateWebACLResponseWebACL();
      //expect(instance).to.be.a(AwsWaf.CreateWebACLResponseWebACL);
    });
