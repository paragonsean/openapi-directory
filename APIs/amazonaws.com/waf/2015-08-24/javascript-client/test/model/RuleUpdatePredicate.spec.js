...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.RuleUpdatePredicate();
  });
  ...
  describe('RuleUpdatePredicate', function() {
    it('should create an instance of RuleUpdatePredicate', function() {
      // uncomment below and update the code to test RuleUpdatePredicate
      //var instance = new AwsWaf.RuleUpdatePredicate();
      //expect(instance).to.be.a(AwsWaf.RuleUpdatePredicate);
    });
