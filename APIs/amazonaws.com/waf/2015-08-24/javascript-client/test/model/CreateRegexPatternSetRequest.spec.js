...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.CreateRegexPatternSetRequest();
  });
  ...
  describe('CreateRegexPatternSetRequest', function() {
    it('should create an instance of CreateRegexPatternSetRequest', function() {
      // uncomment below and update the code to test CreateRegexPatternSetRequest
      //var instance = new AwsWaf.CreateRegexPatternSetRequest();
      //expect(instance).to.be.a(AwsWaf.CreateRegexPatternSetRequest);
    });
