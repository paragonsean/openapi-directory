...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.DeleteRegexMatchSetResponse();
  });
  ...
  describe('DeleteRegexMatchSetResponse', function() {
    it('should create an instance of DeleteRegexMatchSetResponse', function() {
      // uncomment below and update the code to test DeleteRegexMatchSetResponse
      //var instance = new AwsWaf.DeleteRegexMatchSetResponse();
      //expect(instance).to.be.a(AwsWaf.DeleteRegexMatchSetResponse);
    });
