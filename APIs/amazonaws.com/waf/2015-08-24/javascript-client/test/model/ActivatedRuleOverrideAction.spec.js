...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.ActivatedRuleOverrideAction();
  });
  ...
  describe('ActivatedRuleOverrideAction', function() {
    it('should create an instance of ActivatedRuleOverrideAction', function() {
      // uncomment below and update the code to test ActivatedRuleOverrideAction
      //var instance = new AwsWaf.ActivatedRuleOverrideAction();
      //expect(instance).to.be.a(AwsWaf.ActivatedRuleOverrideAction);
    });
