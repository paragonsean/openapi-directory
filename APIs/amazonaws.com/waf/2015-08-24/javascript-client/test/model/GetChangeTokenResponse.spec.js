...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.GetChangeTokenResponse();
  });
  ...
  describe('GetChangeTokenResponse', function() {
    it('should create an instance of GetChangeTokenResponse', function() {
      // uncomment below and update the code to test GetChangeTokenResponse
      //var instance = new AwsWaf.GetChangeTokenResponse();
      //expect(instance).to.be.a(AwsWaf.GetChangeTokenResponse);
    });
