...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.DeleteIPSetResponse();
  });
  ...
  describe('DeleteIPSetResponse', function() {
    it('should create an instance of DeleteIPSetResponse', function() {
      // uncomment below and update the code to test DeleteIPSetResponse
      //var instance = new AwsWaf.DeleteIPSetResponse();
      //expect(instance).to.be.a(AwsWaf.DeleteIPSetResponse);
    });
