...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.GetChangeTokenStatusRequest();
  });
  ...
  describe('GetChangeTokenStatusRequest', function() {
    it('should create an instance of GetChangeTokenStatusRequest', function() {
      // uncomment below and update the code to test GetChangeTokenStatusRequest
      //var instance = new AwsWaf.GetChangeTokenStatusRequest();
      //expect(instance).to.be.a(AwsWaf.GetChangeTokenStatusRequest);
    });
