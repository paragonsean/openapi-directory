...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.IPSetDescriptor();
  });
  ...
  describe('IPSetDescriptor', function() {
    it('should create an instance of IPSetDescriptor', function() {
      // uncomment below and update the code to test IPSetDescriptor
      //var instance = new AwsWaf.IPSetDescriptor();
      //expect(instance).to.be.a(AwsWaf.IPSetDescriptor);
    });
