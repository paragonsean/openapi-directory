...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.UpdateGeoMatchSetRequest();
  });
  ...
  describe('UpdateGeoMatchSetRequest', function() {
    it('should create an instance of UpdateGeoMatchSetRequest', function() {
      // uncomment below and update the code to test UpdateGeoMatchSetRequest
      //var instance = new AwsWaf.UpdateGeoMatchSetRequest();
      //expect(instance).to.be.a(AwsWaf.UpdateGeoMatchSetRequest);
    });
