...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.TagInfoForResource();
  });
  ...
  describe('TagInfoForResource', function() {
    it('should create an instance of TagInfoForResource', function() {
      // uncomment below and update the code to test TagInfoForResource
      //var instance = new AwsWaf.TagInfoForResource();
      //expect(instance).to.be.a(AwsWaf.TagInfoForResource);
    });
