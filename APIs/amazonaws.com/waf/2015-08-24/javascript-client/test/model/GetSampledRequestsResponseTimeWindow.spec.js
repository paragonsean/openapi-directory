...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.GetSampledRequestsResponseTimeWindow();
  });
  ...
  describe('GetSampledRequestsResponseTimeWindow', function() {
    it('should create an instance of GetSampledRequestsResponseTimeWindow', function() {
      // uncomment below and update the code to test GetSampledRequestsResponseTimeWindow
      //var instance = new AwsWaf.GetSampledRequestsResponseTimeWindow();
      //expect(instance).to.be.a(AwsWaf.GetSampledRequestsResponseTimeWindow);
    });
