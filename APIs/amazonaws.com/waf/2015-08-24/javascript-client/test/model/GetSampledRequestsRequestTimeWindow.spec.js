...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.GetSampledRequestsRequestTimeWindow();
  });
  ...
  describe('GetSampledRequestsRequestTimeWindow', function() {
    it('should create an instance of GetSampledRequestsRequestTimeWindow', function() {
      // uncomment below and update the code to test GetSampledRequestsRequestTimeWindow
      //var instance = new AwsWaf.GetSampledRequestsRequestTimeWindow();
      //expect(instance).to.be.a(AwsWaf.GetSampledRequestsRequestTimeWindow);
    });
