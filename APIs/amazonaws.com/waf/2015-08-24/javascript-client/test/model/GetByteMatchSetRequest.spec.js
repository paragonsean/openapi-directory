...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.GetByteMatchSetRequest();
  });
  ...
  describe('GetByteMatchSetRequest', function() {
    it('should create an instance of GetByteMatchSetRequest', function() {
      // uncomment below and update the code to test GetByteMatchSetRequest
      //var instance = new AwsWaf.GetByteMatchSetRequest();
      //expect(instance).to.be.a(AwsWaf.GetByteMatchSetRequest);
    });
