...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.UpdateIPSetResponse();
  });
  ...
  describe('UpdateIPSetResponse', function() {
    it('should create an instance of UpdateIPSetResponse', function() {
      // uncomment below and update the code to test UpdateIPSetResponse
      //var instance = new AwsWaf.UpdateIPSetResponse();
      //expect(instance).to.be.a(AwsWaf.UpdateIPSetResponse);
    });
