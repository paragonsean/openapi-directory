...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.SampledHTTPRequest();
  });
  ...
  describe('SampledHTTPRequest', function() {
    it('should create an instance of SampledHTTPRequest', function() {
      // uncomment below and update the code to test SampledHTTPRequest
      //var instance = new AwsWaf.SampledHTTPRequest();
      //expect(instance).to.be.a(AwsWaf.SampledHTTPRequest);
    });
    ...
    it('should have the property ruleWithinRuleGroup (base name: "RuleWithinRuleGroup")', function() {
      // uncomment below and update the code to test the property ruleWithinRuleGroup
      //var instance = new AwsWaf.SampledHTTPRequest();
      //expect(instance).to.be();
    });
