...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.DeleteByteMatchSetResponse();
  });
  ...
  describe('DeleteByteMatchSetResponse', function() {
    it('should create an instance of DeleteByteMatchSetResponse', function() {
      // uncomment below and update the code to test DeleteByteMatchSetResponse
      //var instance = new AwsWaf.DeleteByteMatchSetResponse();
      //expect(instance).to.be.a(AwsWaf.DeleteByteMatchSetResponse);
    });
