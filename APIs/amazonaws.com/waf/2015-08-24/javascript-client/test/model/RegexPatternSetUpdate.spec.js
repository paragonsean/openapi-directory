...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.RegexPatternSetUpdate();
  });
  ...
  describe('RegexPatternSetUpdate', function() {
    it('should create an instance of RegexPatternSetUpdate', function() {
      // uncomment below and update the code to test RegexPatternSetUpdate
      //var instance = new AwsWaf.RegexPatternSetUpdate();
      //expect(instance).to.be.a(AwsWaf.RegexPatternSetUpdate);
    });
    ...
    it('should have the property regexPatternString (base name: "RegexPatternString")', function() {
      // uncomment below and update the code to test the property regexPatternString
      //var instance = new AwsWaf.RegexPatternSetUpdate();
      //expect(instance).to.be();
    });
