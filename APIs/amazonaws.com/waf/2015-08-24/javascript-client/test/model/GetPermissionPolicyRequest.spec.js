...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.GetPermissionPolicyRequest();
  });
  ...
  describe('GetPermissionPolicyRequest', function() {
    it('should create an instance of GetPermissionPolicyRequest', function() {
      // uncomment below and update the code to test GetPermissionPolicyRequest
      //var instance = new AwsWaf.GetPermissionPolicyRequest();
      //expect(instance).to.be.a(AwsWaf.GetPermissionPolicyRequest);
    });
