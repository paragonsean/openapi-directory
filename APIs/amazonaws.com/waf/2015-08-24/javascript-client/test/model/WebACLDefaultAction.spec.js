...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.WebACLDefaultAction();
  });
  ...
  describe('WebACLDefaultAction', function() {
    it('should create an instance of WebACLDefaultAction', function() {
      // uncomment below and update the code to test WebACLDefaultAction
      //var instance = new AwsWaf.WebACLDefaultAction();
      //expect(instance).to.be.a(AwsWaf.WebACLDefaultAction);
    });
