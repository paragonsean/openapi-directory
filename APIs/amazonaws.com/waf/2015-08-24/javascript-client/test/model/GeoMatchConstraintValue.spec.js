...
(function(root, factory) {
  ...
  describe('GeoMatchConstraintValue', function() {
    it('should create an instance of GeoMatchConstraintValue', function() {
      // uncomment below and update the code to test GeoMatchConstraintValue
      //var instance = new AwsWaf.GeoMatchConstraintValue();
      //expect(instance).to.be.a(AwsWaf.GeoMatchConstraintValue);
    });
