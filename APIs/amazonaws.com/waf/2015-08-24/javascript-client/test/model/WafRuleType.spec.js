...
(function(root, factory) {
  ...
  describe('WafRuleType', function() {
    it('should create an instance of WafRuleType', function() {
      // uncomment below and update the code to test WafRuleType
      //var instance = new AwsWaf.WafRuleType();
      //expect(instance).to.be.a(AwsWaf.WafRuleType);
    });
