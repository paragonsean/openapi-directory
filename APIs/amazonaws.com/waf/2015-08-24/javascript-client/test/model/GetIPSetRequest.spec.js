...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.GetIPSetRequest();
  });
  ...
  describe('GetIPSetRequest', function() {
    it('should create an instance of GetIPSetRequest', function() {
      // uncomment below and update the code to test GetIPSetRequest
      //var instance = new AwsWaf.GetIPSetRequest();
      //expect(instance).to.be.a(AwsWaf.GetIPSetRequest);
    });
