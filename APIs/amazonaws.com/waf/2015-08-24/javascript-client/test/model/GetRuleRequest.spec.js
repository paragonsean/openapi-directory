...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.GetRuleRequest();
  });
  ...
  describe('GetRuleRequest', function() {
    it('should create an instance of GetRuleRequest', function() {
      // uncomment below and update the code to test GetRuleRequest
      //var instance = new AwsWaf.GetRuleRequest();
      //expect(instance).to.be.a(AwsWaf.GetRuleRequest);
    });
