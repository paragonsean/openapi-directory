...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.GeoMatchSetUpdateGeoMatchConstraint();
  });
  ...
  describe('GeoMatchSetUpdateGeoMatchConstraint', function() {
    it('should create an instance of GeoMatchSetUpdateGeoMatchConstraint', function() {
      // uncomment below and update the code to test GeoMatchSetUpdateGeoMatchConstraint
      //var instance = new AwsWaf.GeoMatchSetUpdateGeoMatchConstraint();
      //expect(instance).to.be.a(AwsWaf.GeoMatchSetUpdateGeoMatchConstraint);
    });
