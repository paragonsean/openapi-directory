...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.GetRuleResponseRule();
  });
  ...
  describe('GetRuleResponseRule', function() {
    it('should create an instance of GetRuleResponseRule', function() {
      // uncomment below and update the code to test GetRuleResponseRule
      //var instance = new AwsWaf.GetRuleResponseRule();
      //expect(instance).to.be.a(AwsWaf.GetRuleResponseRule);
    });
