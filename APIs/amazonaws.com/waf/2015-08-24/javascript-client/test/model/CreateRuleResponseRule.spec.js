...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.CreateRuleResponseRule();
  });
  ...
  describe('CreateRuleResponseRule', function() {
    it('should create an instance of CreateRuleResponseRule', function() {
      // uncomment below and update the code to test CreateRuleResponseRule
      //var instance = new AwsWaf.CreateRuleResponseRule();
      //expect(instance).to.be.a(AwsWaf.CreateRuleResponseRule);
    });
