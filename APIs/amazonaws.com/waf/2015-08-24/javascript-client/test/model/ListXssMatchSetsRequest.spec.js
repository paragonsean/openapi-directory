...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.ListXssMatchSetsRequest();
  });
  ...
  describe('ListXssMatchSetsRequest', function() {
    it('should create an instance of ListXssMatchSetsRequest', function() {
      // uncomment below and update the code to test ListXssMatchSetsRequest
      //var instance = new AwsWaf.ListXssMatchSetsRequest();
      //expect(instance).to.be.a(AwsWaf.ListXssMatchSetsRequest);
    });
