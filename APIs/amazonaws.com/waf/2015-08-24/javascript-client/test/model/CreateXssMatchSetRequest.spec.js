...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.CreateXssMatchSetRequest();
  });
  ...
  describe('CreateXssMatchSetRequest', function() {
    it('should create an instance of CreateXssMatchSetRequest', function() {
      // uncomment below and update the code to test CreateXssMatchSetRequest
      //var instance = new AwsWaf.CreateXssMatchSetRequest();
      //expect(instance).to.be.a(AwsWaf.CreateXssMatchSetRequest);
    });
