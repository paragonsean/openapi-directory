...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.UpdateRateBasedRuleResponse();
  });
  ...
  describe('UpdateRateBasedRuleResponse', function() {
    it('should create an instance of UpdateRateBasedRuleResponse', function() {
      // uncomment below and update the code to test UpdateRateBasedRuleResponse
      //var instance = new AwsWaf.UpdateRateBasedRuleResponse();
      //expect(instance).to.be.a(AwsWaf.UpdateRateBasedRuleResponse);
    });
