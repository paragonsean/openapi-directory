...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.ActivatedRule();
  });
  ...
  describe('ActivatedRule', function() {
    it('should create an instance of ActivatedRule', function() {
      // uncomment below and update the code to test ActivatedRule
      //var instance = new AwsWaf.ActivatedRule();
      //expect(instance).to.be.a(AwsWaf.ActivatedRule);
    });
