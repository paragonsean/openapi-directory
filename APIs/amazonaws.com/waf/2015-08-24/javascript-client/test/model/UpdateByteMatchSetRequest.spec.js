...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.UpdateByteMatchSetRequest();
  });
  ...
  describe('UpdateByteMatchSetRequest', function() {
    it('should create an instance of UpdateByteMatchSetRequest', function() {
      // uncomment below and update the code to test UpdateByteMatchSetRequest
      //var instance = new AwsWaf.UpdateByteMatchSetRequest();
      //expect(instance).to.be.a(AwsWaf.UpdateByteMatchSetRequest);
    });
