...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.DeleteRuleResponse();
  });
  ...
  describe('DeleteRuleResponse', function() {
    it('should create an instance of DeleteRuleResponse', function() {
      // uncomment below and update the code to test DeleteRuleResponse
      //var instance = new AwsWaf.DeleteRuleResponse();
      //expect(instance).to.be.a(AwsWaf.DeleteRuleResponse);
    });
