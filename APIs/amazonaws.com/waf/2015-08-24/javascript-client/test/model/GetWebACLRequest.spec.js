...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.GetWebACLRequest();
  });
  ...
  describe('GetWebACLRequest', function() {
    it('should create an instance of GetWebACLRequest', function() {
      // uncomment below and update the code to test GetWebACLRequest
      //var instance = new AwsWaf.GetWebACLRequest();
      //expect(instance).to.be.a(AwsWaf.GetWebACLRequest);
    });
