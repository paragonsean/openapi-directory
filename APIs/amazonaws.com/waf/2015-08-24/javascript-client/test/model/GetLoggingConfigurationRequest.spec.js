...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.GetLoggingConfigurationRequest();
  });
  ...
  describe('GetLoggingConfigurationRequest', function() {
    it('should create an instance of GetLoggingConfigurationRequest', function() {
      ...
      //var instance = new AwsWaf.GetLoggingConfigurationRequest();
      //expect(instance).to.be.a(AwsWaf.GetLoggingConfigurationRequest);
    });
