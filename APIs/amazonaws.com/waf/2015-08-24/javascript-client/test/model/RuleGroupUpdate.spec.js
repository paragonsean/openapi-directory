...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.RuleGroupUpdate();
  });
  ...
  describe('RuleGroupUpdate', function() {
    it('should create an instance of RuleGroupUpdate', function() {
      // uncomment below and update the code to test RuleGroupUpdate
      //var instance = new AwsWaf.RuleGroupUpdate();
      //expect(instance).to.be.a(AwsWaf.RuleGroupUpdate);
    });
    ...
    it('should have the property activatedRule (base name: "ActivatedRule")', function() {
      // uncomment below and update the code to test the property activatedRule
      //var instance = new AwsWaf.RuleGroupUpdate();
      //expect(instance).to.be();
    });
