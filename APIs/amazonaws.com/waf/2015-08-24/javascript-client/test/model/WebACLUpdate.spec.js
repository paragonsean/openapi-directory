...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.WebACLUpdate();
  });
  ...
  describe('WebACLUpdate', function() {
    it('should create an instance of WebACLUpdate', function() {
      // uncomment below and update the code to test WebACLUpdate
      //var instance = new AwsWaf.WebACLUpdate();
      //expect(instance).to.be.a(AwsWaf.WebACLUpdate);
    });
