...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.SizeConstraintSetUpdate();
  });
  ...
  describe('SizeConstraintSetUpdate', function() {
    it('should create an instance of SizeConstraintSetUpdate', function() {
      // uncomment below and update the code to test SizeConstraintSetUpdate
      //var instance = new AwsWaf.SizeConstraintSetUpdate();
      //expect(instance).to.be.a(AwsWaf.SizeConstraintSetUpdate);
    });
    ...
    it('should have the property sizeConstraint (base name: "SizeConstraint")', function() {
      // uncomment below and update the code to test the property sizeConstraint
      //var instance = new AwsWaf.SizeConstraintSetUpdate();
      //expect(instance).to.be();
    });
