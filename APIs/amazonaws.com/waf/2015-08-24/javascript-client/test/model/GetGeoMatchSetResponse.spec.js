...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.GetGeoMatchSetResponse();
  });
  ...
  describe('GetGeoMatchSetResponse', function() {
    it('should create an instance of GetGeoMatchSetResponse', function() {
      // uncomment below and update the code to test GetGeoMatchSetResponse
      //var instance = new AwsWaf.GetGeoMatchSetResponse();
      //expect(instance).to.be.a(AwsWaf.GetGeoMatchSetResponse);
    });
