...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.UpdateWebACLResponse();
  });
  ...
  describe('UpdateWebACLResponse', function() {
    it('should create an instance of UpdateWebACLResponse', function() {
      // uncomment below and update the code to test UpdateWebACLResponse
      //var instance = new AwsWaf.UpdateWebACLResponse();
      //expect(instance).to.be.a(AwsWaf.UpdateWebACLResponse);
    });
