...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.ListRegexPatternSetsRequest();
  });
  ...
  describe('ListRegexPatternSetsRequest', function() {
    it('should create an instance of ListRegexPatternSetsRequest', function() {
      // uncomment below and update the code to test ListRegexPatternSetsRequest
      //var instance = new AwsWaf.ListRegexPatternSetsRequest();
      //expect(instance).to.be.a(AwsWaf.ListRegexPatternSetsRequest);
    });
