...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.CreateRateBasedRuleRequest();
  });
  ...
  describe('CreateRateBasedRuleRequest', function() {
    it('should create an instance of CreateRateBasedRuleRequest', function() {
      // uncomment below and update the code to test CreateRateBasedRuleRequest
      //var instance = new AwsWaf.CreateRateBasedRuleRequest();
      //expect(instance).to.be.a(AwsWaf.CreateRateBasedRuleRequest);
    });
