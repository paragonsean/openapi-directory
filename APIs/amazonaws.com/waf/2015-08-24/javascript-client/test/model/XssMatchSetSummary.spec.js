...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.XssMatchSetSummary();
  });
  ...
  describe('XssMatchSetSummary', function() {
    it('should create an instance of XssMatchSetSummary', function() {
      // uncomment below and update the code to test XssMatchSetSummary
      //var instance = new AwsWaf.XssMatchSetSummary();
      //expect(instance).to.be.a(AwsWaf.XssMatchSetSummary);
    });
