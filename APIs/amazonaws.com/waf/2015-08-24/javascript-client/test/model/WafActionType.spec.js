...
(function(root, factory) {
  ...
  describe('WafActionType', function() {
    it('should create an instance of WafActionType', function() {
      // uncomment below and update the code to test WafActionType
      //var instance = new AwsWaf.WafActionType();
      //expect(instance).to.be.a(AwsWaf.WafActionType);
    });
