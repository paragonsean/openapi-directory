...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.ListGeoMatchSetsRequest();
  });
  ...
  describe('ListGeoMatchSetsRequest', function() {
    it('should create an instance of ListGeoMatchSetsRequest', function() {
      // uncomment below and update the code to test ListGeoMatchSetsRequest
      //var instance = new AwsWaf.ListGeoMatchSetsRequest();
      //expect(instance).to.be.a(AwsWaf.ListGeoMatchSetsRequest);
    });
