...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.RegexMatchSetSummary();
  });
  ...
  describe('RegexMatchSetSummary', function() {
    it('should create an instance of RegexMatchSetSummary', function() {
      // uncomment below and update the code to test RegexMatchSetSummary
      //var instance = new AwsWaf.RegexMatchSetSummary();
      //expect(instance).to.be.a(AwsWaf.RegexMatchSetSummary);
    });
