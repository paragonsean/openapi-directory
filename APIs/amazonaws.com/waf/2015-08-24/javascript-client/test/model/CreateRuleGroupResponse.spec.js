...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.CreateRuleGroupResponse();
  });
  ...
  describe('CreateRuleGroupResponse', function() {
    it('should create an instance of CreateRuleGroupResponse', function() {
      // uncomment below and update the code to test CreateRuleGroupResponse
      //var instance = new AwsWaf.CreateRuleGroupResponse();
      //expect(instance).to.be.a(AwsWaf.CreateRuleGroupResponse);
    });
