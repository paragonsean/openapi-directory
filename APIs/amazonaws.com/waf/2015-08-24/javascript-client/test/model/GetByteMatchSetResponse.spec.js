...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.GetByteMatchSetResponse();
  });
  ...
  describe('GetByteMatchSetResponse', function() {
    it('should create an instance of GetByteMatchSetResponse', function() {
      // uncomment below and update the code to test GetByteMatchSetResponse
      //var instance = new AwsWaf.GetByteMatchSetResponse();
      //expect(instance).to.be.a(AwsWaf.GetByteMatchSetResponse);
    });
