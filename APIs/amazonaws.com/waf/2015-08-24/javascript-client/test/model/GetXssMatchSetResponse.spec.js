...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.GetXssMatchSetResponse();
  });
  ...
  describe('GetXssMatchSetResponse', function() {
    it('should create an instance of GetXssMatchSetResponse', function() {
      // uncomment below and update the code to test GetXssMatchSetResponse
      //var instance = new AwsWaf.GetXssMatchSetResponse();
      //expect(instance).to.be.a(AwsWaf.GetXssMatchSetResponse);
    });

    it('should have the property xssMatchSet (base name: "XssMatchSet")', function() {
      // uncomment below and update the code to test the property xssMatchSet
      //var instance = new AwsWaf.GetXssMatchSetResponse();
