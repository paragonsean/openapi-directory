...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.DeleteRegexPatternSetResponse();
  });
  ...
  describe('DeleteRegexPatternSetResponse', function() {
    it('should create an instance of DeleteRegexPatternSetResponse', function() {
      // uncomment below and update the code to test DeleteRegexPatternSetResponse
      //var instance = new AwsWaf.DeleteRegexPatternSetResponse();
      //expect(instance).to.be.a(AwsWaf.DeleteRegexPatternSetResponse);
    });
