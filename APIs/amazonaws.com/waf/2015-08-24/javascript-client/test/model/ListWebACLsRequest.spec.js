...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.ListWebACLsRequest();
  });
  ...
  describe('ListWebACLsRequest', function() {
    it('should create an instance of ListWebACLsRequest', function() {
      // uncomment below and update the code to test ListWebACLsRequest
      //var instance = new AwsWaf.ListWebACLsRequest();
      //expect(instance).to.be.a(AwsWaf.ListWebACLsRequest);
    });
