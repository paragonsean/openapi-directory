...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.GetRateBasedRuleRequest();
  });
  ...
  describe('GetRateBasedRuleRequest', function() {
    it('should create an instance of GetRateBasedRuleRequest', function() {
      // uncomment below and update the code to test GetRateBasedRuleRequest
      //var instance = new AwsWaf.GetRateBasedRuleRequest();
      //expect(instance).to.be.a(AwsWaf.GetRateBasedRuleRequest);
    });
