...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.CreateIPSetRequest();
  });
  ...
  describe('CreateIPSetRequest', function() {
    it('should create an instance of CreateIPSetRequest', function() {
      // uncomment below and update the code to test CreateIPSetRequest
      //var instance = new AwsWaf.CreateIPSetRequest();
      //expect(instance).to.be.a(AwsWaf.CreateIPSetRequest);
    });
