...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.GetPermissionPolicyResponse();
  });
  ...
  describe('GetPermissionPolicyResponse', function() {
    it('should create an instance of GetPermissionPolicyResponse', function() {
      ...
      //var instance = new AwsWaf.GetPermissionPolicyResponse();
      //expect(instance).to.be.a(AwsWaf.GetPermissionPolicyResponse);
    });
