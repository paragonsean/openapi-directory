...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.GetRegexPatternSetResponse();
  });
  ...
  describe('GetRegexPatternSetResponse', function() {
    it('should create an instance of GetRegexPatternSetResponse', function() {
      // uncomment below and update the code to test GetRegexPatternSetResponse
      //var instance = new AwsWaf.GetRegexPatternSetResponse();
      //expect(instance).to.be.a(AwsWaf.GetRegexPatternSetResponse);
    });

    it('should have the property regexPatternSet (base name: "RegexPatternSet")', function() {
      // uncomment below and update the code to test the property regexPatternSet
      //var instance = new AwsWaf.GetRegexPatternSetResponse();
