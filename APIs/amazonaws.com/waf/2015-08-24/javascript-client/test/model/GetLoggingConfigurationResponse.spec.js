...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.GetLoggingConfigurationResponse();
  });
  ...
  describe('GetLoggingConfigurationResponse', function() {
    it('should create an instance of GetLoggingConfigurationResponse', function() {
      // uncomment below and update the code to test GetLoggingConfigurationResponse
      //var instance = new AwsWaf.GetLoggingConfigurationResponse();
      //expect(instance).to.be.a(AwsWaf.GetLoggingConfigurationResponse);
    });
