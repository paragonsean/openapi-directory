...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.PutPermissionPolicyRequest();
  });
  ...
  describe('PutPermissionPolicyRequest', function() {
    it('should create an instance of PutPermissionPolicyRequest', function() {
      // uncomment below and update the code to test PutPermissionPolicyRequest
      //var instance = new AwsWaf.PutPermissionPolicyRequest();
      //expect(instance).to.be.a(AwsWaf.PutPermissionPolicyRequest);
    });
