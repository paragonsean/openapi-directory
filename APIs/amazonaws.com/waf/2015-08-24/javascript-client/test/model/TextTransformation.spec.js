...
(function(root, factory) {
  ...
  describe('TextTransformation', function() {
    it('should create an instance of TextTransformation', function() {
      // uncomment below and update the code to test TextTransformation
      //var instance = new AwsWaf.TextTransformation();
      //expect(instance).to.be.a(AwsWaf.TextTransformation);
    });
