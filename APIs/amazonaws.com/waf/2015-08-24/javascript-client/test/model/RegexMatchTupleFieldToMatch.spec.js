...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.RegexMatchTupleFieldToMatch();
  });
  ...
  describe('RegexMatchTupleFieldToMatch', function() {
    it('should create an instance of RegexMatchTupleFieldToMatch', function() {
      ...
      //var instance = new AwsWaf.RegexMatchTupleFieldToMatch();
      //expect(instance).to.be.a(AwsWaf.RegexMatchTupleFieldToMatch);
    });
