...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.GetRuleGroupResponseRuleGroup();
  });
  ...
  describe('GetRuleGroupResponseRuleGroup', function() {
    it('should create an instance of GetRuleGroupResponseRuleGroup', function() {
      // uncomment below and update the code to test GetRuleGroupResponseRuleGroup
      //var instance = new AwsWaf.GetRuleGroupResponseRuleGroup();
      //expect(instance).to.be.a(AwsWaf.GetRuleGroupResponseRuleGroup);
    });
