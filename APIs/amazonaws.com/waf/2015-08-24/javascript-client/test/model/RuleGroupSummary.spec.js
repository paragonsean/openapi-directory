...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.RuleGroupSummary();
  });
  ...
  describe('RuleGroupSummary', function() {
    it('should create an instance of RuleGroupSummary', function() {
      // uncomment below and update the code to test RuleGroupSummary
      //var instance = new AwsWaf.RuleGroupSummary();
      //expect(instance).to.be.a(AwsWaf.RuleGroupSummary);
    });
