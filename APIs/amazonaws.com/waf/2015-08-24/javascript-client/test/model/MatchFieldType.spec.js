...
(function(root, factory) {
  ...
  describe('MatchFieldType', function() {
    it('should create an instance of MatchFieldType', function() {
      // uncomment below and update the code to test MatchFieldType
      //var instance = new AwsWaf.MatchFieldType();
      //expect(instance).to.be.a(AwsWaf.MatchFieldType);
    });
