...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.DeleteRateBasedRuleRequest();
  });
  ...
  describe('DeleteRateBasedRuleRequest', function() {
    it('should create an instance of DeleteRateBasedRuleRequest', function() {
      // uncomment below and update the code to test DeleteRateBasedRuleRequest
      //var instance = new AwsWaf.DeleteRateBasedRuleRequest();
      //expect(instance).to.be.a(AwsWaf.DeleteRateBasedRuleRequest);
    });
