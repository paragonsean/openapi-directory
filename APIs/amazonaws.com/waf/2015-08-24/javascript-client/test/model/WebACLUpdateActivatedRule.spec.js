...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.WebACLUpdateActivatedRule();
  });
  ...
  describe('WebACLUpdateActivatedRule', function() {
    it('should create an instance of WebACLUpdateActivatedRule', function() {
      // uncomment below and update the code to test WebACLUpdateActivatedRule
      //var instance = new AwsWaf.WebACLUpdateActivatedRule();
      //expect(instance).to.be.a(AwsWaf.WebACLUpdateActivatedRule);
    });
    ...
    it('should have the property overrideAction (base name: "OverrideAction")', function() {
      // uncomment below and update the code to test the property overrideAction
      //var instance = new AwsWaf.WebACLUpdateActivatedRule();
      //expect(instance).to.be();
    });
    ...
    it('should have the property excludedRules (base name: "ExcludedRules")', function() {
      // uncomment below and update the code to test the property excludedRules
      //var instance = new AwsWaf.WebACLUpdateActivatedRule();
      //expect(instance).to.be();
    });
