...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.ListTagsForResourceResponseTagInfoForResource();
  });
  ...
  describe('ListTagsForResourceResponseTagInfoForResource', function() {
    it('should create an instance of ListTagsForResourceResponseTagInfoForResource', function() {
      // uncomment below and update the code to test ListTagsForResourceResponseTagInfoForResource
      //var instance = new AwsWaf.ListTagsForResourceResponseTagInfoForResource();
      //expect(instance).to.be.a(AwsWaf.ListTagsForResourceResponseTagInfoForResource);
    });
