...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.UpdateRegexMatchSetRequest();
  });
  ...
  describe('UpdateRegexMatchSetRequest', function() {
    it('should create an instance of UpdateRegexMatchSetRequest', function() {
      // uncomment below and update the code to test UpdateRegexMatchSetRequest
      //var instance = new AwsWaf.UpdateRegexMatchSetRequest();
      //expect(instance).to.be.a(AwsWaf.UpdateRegexMatchSetRequest);
    });
