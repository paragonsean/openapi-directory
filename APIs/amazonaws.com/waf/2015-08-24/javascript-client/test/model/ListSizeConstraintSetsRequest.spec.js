...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWaf.ListSizeConstraintSetsRequest();
  });
  ...
  describe('ListSizeConstraintSetsRequest', function() {
    it('should create an instance of ListSizeConstraintSetsRequest', function() {
      // uncomment below and update the code to test ListSizeConstraintSetsRequest
      //var instance = new AwsWaf.ListSizeConstraintSetsRequest();
      //expect(instance).to.be.a(AwsWaf.ListSizeConstraintSetsRequest);
    });
