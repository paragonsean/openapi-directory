 ...
 */
@JsonAdapter(RateKey.Adapter.class)
public enum RateKey {
  ...
  public static RateKey fromValue(String value) {
    for (RateKey b : RateKey.values()) {
  ...
  public static class Adapter extends TypeAdapter<RateKey> {
    @Override
    public void write(final JsonWriter jsonWriter, final RateKey enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RateKey read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RateKey.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    RateKey.fromValue(value);
  }
}
