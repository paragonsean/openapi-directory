...
public class ApiClient {
    ...
    private String basePath = "https://waf.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2015-08-24/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://waf.amazonaws.com
