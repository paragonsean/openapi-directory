...
/**
 * Gets or Sets WafRuleType
 */
@JsonAdapter(WafRuleType.Adapter.class)
public enum WafRuleType {
  ...
  public static WafRuleType fromValue(String value) {
    for (WafRuleType b : WafRuleType.values()) {
  ...
  public static class Adapter extends TypeAdapter<WafRuleType> {
    @Override
    public void write(final JsonWriter jsonWriter, final WafRuleType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public WafRuleType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return WafRuleType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    WafRuleType.fromValue(value);
  }
}
