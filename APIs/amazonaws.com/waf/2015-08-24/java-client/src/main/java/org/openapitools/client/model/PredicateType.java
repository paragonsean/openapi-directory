...
/**
 * Gets or Sets PredicateType
 */
@JsonAdapter(PredicateType.Adapter.class)
public enum PredicateType {
  ...
  public static PredicateType fromValue(String value) {
    for (PredicateType b : PredicateType.values()) {
  ...
  public static class Adapter extends TypeAdapter<PredicateType> {
    @Override
    public void write(final JsonWriter jsonWriter, final PredicateType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PredicateType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PredicateType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PredicateType.fromValue(value);
  }
}
