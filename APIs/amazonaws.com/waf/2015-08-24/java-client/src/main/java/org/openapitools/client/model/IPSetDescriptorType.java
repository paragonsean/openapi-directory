...
/**
 * Gets or Sets IPSetDescriptorType
 */
@JsonAdapter(IPSetDescriptorType.Adapter.class)
public enum IPSetDescriptorType {
  ...
  public static IPSetDescriptorType fromValue(String value) {
    for (IPSetDescriptorType b : IPSetDescriptorType.values()) {
  ...
  public static class Adapter extends TypeAdapter<IPSetDescriptorType> {
    @Override
    public void write(final JsonWriter jsonWriter, final IPSetDescriptorType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public IPSetDescriptorType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return IPSetDescriptorType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    IPSetDescriptorType.fromValue(value);
  }
}
