...
QString OAIRule::getMetricName() const {
    return m_metric_name;
}
void OAIRule::setMetricName(const QString &metric_name) {
    m_metric_name = metric_name;
    m_metric_name_isSet = true;
}

bool OAIRule::is_metric_name_Set() const{
    return m_metric_name_isSet;
}

bool OAIRule::is_metric_name_Valid() const{
    return m_metric_name_isValid;
}

QList OAIRule::getPredicates() const {
    return m_predicates;
}
void OAIRule::setPredicates(const QList &predicates) {
    m_predicates = predicates;
    m_predicates_isSet = true;
}

bool OAIRule::is_predicates_Set() const{
    return m_predicates_isSet;
}

bool OAIRule::is_predicates_Valid() const{
