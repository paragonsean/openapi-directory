...
/*
 * OAICreateWebACLMigrationStackRequest.h
 *
 * 
 */

#ifndef OAICreateWebACLMigrationStackRequest_H
#define OAICreateWebACLMigrationStackRequest_H
...
class OAICreateWebACLMigrationStackRequest : public OAIObject {
public:
    OAICreateWebACLMigrationStackRequest();
    OAICreateWebACLMigrationStackRequest(QString json);
    ~OAICreateWebACLMigrationStackRequest() override;
    ...
    void setIgnoreUnsupportedType(const bool &ignore_unsupported_type);
    bool is_ignore_unsupported_type_Set() const;
    bool is_ignore_unsupported_type_Valid() const;
...
private:
    ...
    bool m_ignore_unsupported_type;
    bool m_ignore_unsupported_type_isSet;
    bool m_ignore_unsupported_type_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateWebACLMigrationStackRequest)

#endif // OAICreateWebACLMigrationStackRequest_H
