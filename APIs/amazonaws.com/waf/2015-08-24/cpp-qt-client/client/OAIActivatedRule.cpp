...
OAIActivatedRule::OAIActivatedRule(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActivatedRule::OAIActivatedRule() {
    this->initializeModel();
}

OAIActivatedRule::~OAIActivatedRule() {}

void OAIActivatedRule::initializeModel() {
...
void OAIActivatedRule::fromJson(QString jsonString) {
...
void OAIActivatedRule::fromJsonObject(QJsonObject json) {
...
QString OAIActivatedRule::asJson() const {
...
QJsonObject OAIActivatedRule::asJsonObject() const {
    QJsonObject obj;
    if (m_priority_isSet) {
...
qint32 OAIActivatedRule::getPriority() const {
    return m_priority;
}
void OAIActivatedRule::setPriority(const qint32 &priority) {
    m_priority = priority;
    m_priority_isSet = true;
}

bool OAIActivatedRule::is_priority_Set() const{
    return m_priority_isSet;
}

bool OAIActivatedRule::is_priority_Valid() const{
    return m_priority_isValid;
}

QString OAIActivatedRule::getRuleId() const {
    return m_rule_id;
}
void OAIActivatedRule::setRuleId(const QString &rule_id) {
    m_rule_id = rule_id;
    m_rule_id_isSet = true;
}

bool OAIActivatedRule::is_rule_id_Set() const{
    return m_rule_id_isSet;
}

bool OAIActivatedRule::is_rule_id_Valid() const{
    return m_rule_id_isValid;
}

OAIActivatedRule_Action OAIActivatedRule::getAction() const {
    return m_action;
}
void OAIActivatedRule::setAction(const OAIActivatedRule_Action &action) {
    m_action = action;
    m_action_isSet = true;
}

bool OAIActivatedRule::is_action_Set() const{
    return m_action_isSet;
}

bool OAIActivatedRule::is_action_Valid() const{
    return m_action_isValid;
}

OAIActivatedRule_OverrideAction OAIActivatedRule::getOverrideAction() const {
    return m_override_action;
}
void OAIActivatedRule::setOverrideAction(const OAIActivatedRule_OverrideAction &override_action) {
    m_override_action = override_action;
    m_override_action_isSet = true;
}

bool OAIActivatedRule::is_override_action_Set() const{
    return m_override_action_isSet;
}

bool OAIActivatedRule::is_override_action_Valid() const{
    return m_override_action_isValid;
}

OAIWafRuleType OAIActivatedRule::getType() const {
    return m_type;
}
void OAIActivatedRule::setType(const OAIWafRuleType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIActivatedRule::is_type_Set() const{
    return m_type_isSet;
}

bool OAIActivatedRule::is_type_Valid() const{
    return m_type_isValid;
}

QList OAIActivatedRule::getExcludedRules() const {
    return m_excluded_rules;
}
void OAIActivatedRule::setExcludedRules(const QList &excluded_rules) {
    m_excluded_rules = excluded_rules;
    m_excluded_rules_isSet = true;
}

bool OAIActivatedRule::is_excluded_rules_Set() const{
    return m_excluded_rules_isSet;
}

bool OAIActivatedRule::is_excluded_rules_Valid() const{
    return m_excluded_rules_isValid;
}

bool OAIActivatedRule::isSet() const {
...
bool OAIActivatedRule::isValid() const {
