...
OAIGetRateBasedRuleManagedKeysRequest::OAIGetRateBasedRuleManagedKeysRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetRateBasedRuleManagedKeysRequest::OAIGetRateBasedRuleManagedKeysRequest() {
    this->initializeModel();
}

OAIGetRateBasedRuleManagedKeysRequest::~OAIGetRateBasedRuleManagedKeysRequest() {}

void OAIGetRateBasedRuleManagedKeysRequest::initializeModel() {
...
void OAIGetRateBasedRuleManagedKeysRequest::fromJson(QString jsonString) {
...
void OAIGetRateBasedRuleManagedKeysRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetRateBasedRuleManagedKeysRequest::asJson() const {
...
QJsonObject OAIGetRateBasedRuleManagedKeysRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_rule_id_isSet) {
...
QString OAIGetRateBasedRuleManagedKeysRequest::getRuleId() const {
    return m_rule_id;
}
void OAIGetRateBasedRuleManagedKeysRequest::setRuleId(const QString &rule_id) {
    m_rule_id = rule_id;
    m_rule_id_isSet = true;
}

bool OAIGetRateBasedRuleManagedKeysRequest::is_rule_id_Set() const{
    return m_rule_id_isSet;
}

bool OAIGetRateBasedRuleManagedKeysRequest::is_rule_id_Valid() const{
    return m_rule_id_isValid;
}

QString OAIGetRateBasedRuleManagedKeysRequest::getNextMarker() const {
    return m_next_marker;
}
void OAIGetRateBasedRuleManagedKeysRequest::setNextMarker(const QString &next_marker) {
    m_next_marker = next_marker;
    m_next_marker_isSet = true;
}

bool OAIGetRateBasedRuleManagedKeysRequest::is_next_marker_Set() const{
    return m_next_marker_isSet;
}

bool OAIGetRateBasedRuleManagedKeysRequest::is_next_marker_Valid() const{
    return m_next_marker_isValid;
}

bool OAIGetRateBasedRuleManagedKeysRequest::isSet() const {
...
bool OAIGetRateBasedRuleManagedKeysRequest::isValid() const {
