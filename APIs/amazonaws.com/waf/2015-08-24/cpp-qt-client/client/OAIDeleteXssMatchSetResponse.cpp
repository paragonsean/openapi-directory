...
OAIDeleteXssMatchSetResponse::OAIDeleteXssMatchSetResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteXssMatchSetResponse::OAIDeleteXssMatchSetResponse() {
    this->initializeModel();
}

OAIDeleteXssMatchSetResponse::~OAIDeleteXssMatchSetResponse() {}

void OAIDeleteXssMatchSetResponse::initializeModel() {

    m_change_token_isSet = false;
    m_change_token_isValid = false;
}

void OAIDeleteXssMatchSetResponse::fromJson(QString jsonString) {
...
void OAIDeleteXssMatchSetResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteXssMatchSetResponse::asJson() const {
...
QJsonObject OAIDeleteXssMatchSetResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteXssMatchSetResponse::getChangeToken() const {
    return m_change_token;
}
void OAIDeleteXssMatchSetResponse::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAIDeleteXssMatchSetResponse::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAIDeleteXssMatchSetResponse::is_change_token_Valid() const{
    return m_change_token_isValid;
}

bool OAIDeleteXssMatchSetResponse::isSet() const {
...
bool OAIDeleteXssMatchSetResponse::isValid() const {
