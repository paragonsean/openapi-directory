...
/*
 * OAIDeleteRateBasedRuleRequest.h
 *
 * 
 */

#ifndef OAIDeleteRateBasedRuleRequest_H
#define OAIDeleteRateBasedRuleRequest_H
...
class OAIDeleteRateBasedRuleRequest : public OAIObject {
public:
    OAIDeleteRateBasedRuleRequest();
    OAIDeleteRateBasedRuleRequest(QString json);
    ~OAIDeleteRateBasedRuleRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteRateBasedRuleRequest)

#endif // OAIDeleteRateBasedRuleRequest_H
