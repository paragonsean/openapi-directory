...
#ifndef OAIWafAction_H
#define OAIWafAction_H
...
class OAIWafAction : public OAIObject {
public:
    OAIWafAction();
    OAIWafAction(QString json);
    ~OAIWafAction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWafAction)

#endif // OAIWafAction_H
