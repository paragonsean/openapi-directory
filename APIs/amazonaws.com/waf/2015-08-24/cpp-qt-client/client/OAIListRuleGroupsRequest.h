...
/*
 * OAIListRuleGroupsRequest.h
 *
 * 
 */

#ifndef OAIListRuleGroupsRequest_H
#define OAIListRuleGroupsRequest_H
...
class OAIListRuleGroupsRequest : public OAIObject {
public:
    OAIListRuleGroupsRequest();
    OAIListRuleGroupsRequest(QString json);
    ~OAIListRuleGroupsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListRuleGroupsRequest)

#endif // OAIListRuleGroupsRequest_H
