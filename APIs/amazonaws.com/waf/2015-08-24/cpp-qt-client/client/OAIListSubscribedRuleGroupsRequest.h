...
/*
 * OAIListSubscribedRuleGroupsRequest.h
 *
 * 
 */

#ifndef OAIListSubscribedRuleGroupsRequest_H
#define OAIListSubscribedRuleGroupsRequest_H
...
class OAIListSubscribedRuleGroupsRequest : public OAIObject {
public:
    OAIListSubscribedRuleGroupsRequest();
    OAIListSubscribedRuleGroupsRequest(QString json);
    ~OAIListSubscribedRuleGroupsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListSubscribedRuleGroupsRequest)

#endif // OAIListSubscribedRuleGroupsRequest_H
