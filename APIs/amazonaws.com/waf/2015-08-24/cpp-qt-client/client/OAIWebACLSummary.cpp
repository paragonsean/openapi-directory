...
OAIWebACLSummary::OAIWebACLSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWebACLSummary::OAIWebACLSummary() {
    this->initializeModel();
}

OAIWebACLSummary::~OAIWebACLSummary() {}

void OAIWebACLSummary::initializeModel() {
...
void OAIWebACLSummary::fromJson(QString jsonString) {
...
void OAIWebACLSummary::fromJsonObject(QJsonObject json) {
...
QString OAIWebACLSummary::asJson() const {
...
QJsonObject OAIWebACLSummary::asJsonObject() const {
    QJsonObject obj;
...
QString OAIWebACLSummary::getWebAclid() const {
    return m_web_aclid;
}
void OAIWebACLSummary::setWebAclid(const QString &web_aclid) {
    m_web_aclid = web_aclid;
    m_web_aclid_isSet = true;
}

bool OAIWebACLSummary::is_web_aclid_Set() const{
    return m_web_aclid_isSet;
}

bool OAIWebACLSummary::is_web_aclid_Valid() const{
    return m_web_aclid_isValid;
}

QString OAIWebACLSummary::getName() const {
    return m_name;
}
void OAIWebACLSummary::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIWebACLSummary::is_name_Set() const{
    return m_name_isSet;
}

bool OAIWebACLSummary::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIWebACLSummary::isSet() const {
...
bool OAIWebACLSummary::isValid() const {
