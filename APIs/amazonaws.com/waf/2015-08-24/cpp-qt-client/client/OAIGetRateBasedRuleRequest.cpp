...
OAIGetRateBasedRuleRequest::OAIGetRateBasedRuleRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetRateBasedRuleRequest::OAIGetRateBasedRuleRequest() {
    this->initializeModel();
}

OAIGetRateBasedRuleRequest::~OAIGetRateBasedRuleRequest() {}

void OAIGetRateBasedRuleRequest::initializeModel() {

    m_rule_id_isSet = false;
    m_rule_id_isValid = false;
}

void OAIGetRateBasedRuleRequest::fromJson(QString jsonString) {
...
void OAIGetRateBasedRuleRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetRateBasedRuleRequest::asJson() const {
...
QJsonObject OAIGetRateBasedRuleRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_rule_id_isSet) {
...
QString OAIGetRateBasedRuleRequest::getRuleId() const {
    return m_rule_id;
}
void OAIGetRateBasedRuleRequest::setRuleId(const QString &rule_id) {
    m_rule_id = rule_id;
    m_rule_id_isSet = true;
}

bool OAIGetRateBasedRuleRequest::is_rule_id_Set() const{
    return m_rule_id_isSet;
}

bool OAIGetRateBasedRuleRequest::is_rule_id_Valid() const{
    return m_rule_id_isValid;
}

bool OAIGetRateBasedRuleRequest::isSet() const {
...
bool OAIGetRateBasedRuleRequest::isValid() const {
