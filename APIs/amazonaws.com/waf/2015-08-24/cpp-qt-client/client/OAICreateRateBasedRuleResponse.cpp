...
OAICreateRateBasedRuleResponse::OAICreateRateBasedRuleResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRateBasedRuleResponse::OAICreateRateBasedRuleResponse() {
    this->initializeModel();
}

OAICreateRateBasedRuleResponse::~OAICreateRateBasedRuleResponse() {}

void OAICreateRateBasedRuleResponse::initializeModel() {
...
void OAICreateRateBasedRuleResponse::fromJson(QString jsonString) {
...
void OAICreateRateBasedRuleResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateRateBasedRuleResponse::asJson() const {
...
QJsonObject OAICreateRateBasedRuleResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_rule.isSet()) {
...
OAICreateRateBasedRuleResponse_Rule OAICreateRateBasedRuleResponse::getRule() const {
    return m_rule;
}
void OAICreateRateBasedRuleResponse::setRule(const OAICreateRateBasedRuleResponse_Rule &rule) {
    m_rule = rule;
    m_rule_isSet = true;
}

bool OAICreateRateBasedRuleResponse::is_rule_Set() const{
    return m_rule_isSet;
}

bool OAICreateRateBasedRuleResponse::is_rule_Valid() const{
    return m_rule_isValid;
}

QString OAICreateRateBasedRuleResponse::getChangeToken() const {
    return m_change_token;
}
void OAICreateRateBasedRuleResponse::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAICreateRateBasedRuleResponse::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAICreateRateBasedRuleResponse::is_change_token_Valid() const{
    return m_change_token_isValid;
}

bool OAICreateRateBasedRuleResponse::isSet() const {
...
bool OAICreateRateBasedRuleResponse::isValid() const {
