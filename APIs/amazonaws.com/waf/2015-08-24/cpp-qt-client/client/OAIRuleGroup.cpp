...
OAIRuleGroup::OAIRuleGroup(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRuleGroup::OAIRuleGroup() {
    this->initializeModel();
}

OAIRuleGroup::~OAIRuleGroup() {}

void OAIRuleGroup::initializeModel() {
...
void OAIRuleGroup::fromJson(QString jsonString) {
...
void OAIRuleGroup::fromJsonObject(QJsonObject json) {
...
QString OAIRuleGroup::asJson() const {
...
QJsonObject OAIRuleGroup::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRuleGroup::getRuleGroupId() const {
    return m_rule_group_id;
}
void OAIRuleGroup::setRuleGroupId(const QString &rule_group_id) {
    m_rule_group_id = rule_group_id;
    m_rule_group_id_isSet = true;
}

bool OAIRuleGroup::is_rule_group_id_Set() const{
    return m_rule_group_id_isSet;
}

bool OAIRuleGroup::is_rule_group_id_Valid() const{
    return m_rule_group_id_isValid;
}

QString OAIRuleGroup::getName() const {
    return m_name;
}
void OAIRuleGroup::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIRuleGroup::is_name_Set() const{
    return m_name_isSet;
}

bool OAIRuleGroup::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIRuleGroup::getMetricName() const {
    return m_metric_name;
}
void OAIRuleGroup::setMetricName(const QString &metric_name) {
    m_metric_name = metric_name;
    m_metric_name_isSet = true;
}

bool OAIRuleGroup::is_metric_name_Set() const{
    return m_metric_name_isSet;
}

bool OAIRuleGroup::is_metric_name_Valid() const{
    return m_metric_name_isValid;
}

bool OAIRuleGroup::isSet() const {
...
bool OAIRuleGroup::isValid() const {
