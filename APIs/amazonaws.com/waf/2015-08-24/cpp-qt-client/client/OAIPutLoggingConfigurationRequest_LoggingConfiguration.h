...
/*
 * OAIPutLoggingConfigurationRequest_LoggingConfiguration.h
 *
 * 
 */

#ifndef OAIPutLoggingConfigurationRequest_LoggingConfiguration_H
#define OAIPutLoggingConfigurationRequest_LoggingConfiguration_H
...
class OAIPutLoggingConfigurationRequest_LoggingConfiguration : public OAIObject {
public:
    OAIPutLoggingConfigurationRequest_LoggingConfiguration();
    OAIPutLoggingConfigurationRequest_LoggingConfiguration(QString json);
    ~OAIPutLoggingConfigurationRequest_LoggingConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutLoggingConfigurationRequest_LoggingConfiguration)

#endif // OAIPutLoggingConfigurationRequest_LoggingConfiguration_H
