...
/*
 * OAIListSizeConstraintSetsRequest.h
 *
 * 
 */

#ifndef OAIListSizeConstraintSetsRequest_H
#define OAIListSizeConstraintSetsRequest_H
...
class OAIListSizeConstraintSetsRequest : public OAIObject {
public:
    OAIListSizeConstraintSetsRequest();
    OAIListSizeConstraintSetsRequest(QString json);
    ~OAIListSizeConstraintSetsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListSizeConstraintSetsRequest)

#endif // OAIListSizeConstraintSetsRequest_H
