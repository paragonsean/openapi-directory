...
#ifndef OAIByteMatchSetSummary_H
#define OAIByteMatchSetSummary_H
...
class OAIByteMatchSetSummary : public OAIObject {
public:
    OAIByteMatchSetSummary();
    OAIByteMatchSetSummary(QString json);
    ~OAIByteMatchSetSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIByteMatchSetSummary)

#endif // OAIByteMatchSetSummary_H
