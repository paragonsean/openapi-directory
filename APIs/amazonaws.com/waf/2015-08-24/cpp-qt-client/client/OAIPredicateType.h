...
#ifndef OAIPredicateType_H
#define OAIPredicateType_H
...
class OAIPredicateType : public OAIEnum {
public:
    OAIPredicateType();
    OAIPredicateType(QString json);
    ~OAIPredicateType() override;
    ...
    OAIPredicateType::eOAIPredicateType getValue() const;
    void setValue(const OAIPredicateType::eOAIPredicateType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPredicateType)

#endif // OAIPredicateType_H
