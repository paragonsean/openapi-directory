...
OAIUpdateRateBasedRuleResponse::OAIUpdateRateBasedRuleResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateRateBasedRuleResponse::OAIUpdateRateBasedRuleResponse() {
    this->initializeModel();
}

OAIUpdateRateBasedRuleResponse::~OAIUpdateRateBasedRuleResponse() {}

void OAIUpdateRateBasedRuleResponse::initializeModel() {

    m_change_token_isSet = false;
    m_change_token_isValid = false;
}

void OAIUpdateRateBasedRuleResponse::fromJson(QString jsonString) {
...
void OAIUpdateRateBasedRuleResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateRateBasedRuleResponse::asJson() const {
...
QJsonObject OAIUpdateRateBasedRuleResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateRateBasedRuleResponse::getChangeToken() const {
    return m_change_token;
}
void OAIUpdateRateBasedRuleResponse::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAIUpdateRateBasedRuleResponse::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAIUpdateRateBasedRuleResponse::is_change_token_Valid() const{
    return m_change_token_isValid;
}

bool OAIUpdateRateBasedRuleResponse::isSet() const {
...
bool OAIUpdateRateBasedRuleResponse::isValid() const {
