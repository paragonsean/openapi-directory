...
/*
 * OAIGetIPSetRequest.h
 *
 * 
 */

#ifndef OAIGetIPSetRequest_H
#define OAIGetIPSetRequest_H
...
class OAIGetIPSetRequest : public OAIObject {
public:
    OAIGetIPSetRequest();
    OAIGetIPSetRequest(QString json);
    ~OAIGetIPSetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetIPSetRequest)

#endif // OAIGetIPSetRequest_H
