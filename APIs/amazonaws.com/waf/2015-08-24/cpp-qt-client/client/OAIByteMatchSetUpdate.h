...
#ifndef OAIByteMatchSetUpdate_H
#define OAIByteMatchSetUpdate_H
...
namespace OpenAPI {
class OAIByteMatchSetUpdate_ByteMatchTuple;

class OAIByteMatchSetUpdate : public OAIObject {
public:
    OAIByteMatchSetUpdate();
    OAIByteMatchSetUpdate(QString json);
    ~OAIByteMatchSetUpdate() override;
    ...
    OAIByteMatchSetUpdate_ByteMatchTuple getByteMatchTuple() const;
    void setByteMatchTuple(const OAIByteMatchSetUpdate_ByteMatchTuple &byte_match_tuple);
    bool is_byte_match_tuple_Set() const;
    bool is_byte_match_tuple_Valid() const;
...
private:
    ...
    OAIByteMatchSetUpdate_ByteMatchTuple m_byte_match_tuple;
    bool m_byte_match_tuple_isSet;
    bool m_byte_match_tuple_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIByteMatchSetUpdate)

#endif // OAIByteMatchSetUpdate_H
