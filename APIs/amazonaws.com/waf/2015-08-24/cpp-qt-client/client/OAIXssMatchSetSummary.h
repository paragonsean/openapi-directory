...
class OAIXssMatchSetSummary : public OAIObject {
public:
    OAIXssMatchSetSummary();
    OAIXssMatchSetSummary(QString json);
    ~OAIXssMatchSetSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIXssMatchSetSummary)

#endif // OAIXssMatchSetSummary_H
