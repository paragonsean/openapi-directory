...
/*
 * OAICreateRuleGroupResponse_RuleGroup.h
 *
 * 
 */

#ifndef OAICreateRuleGroupResponse_RuleGroup_H
#define OAICreateRuleGroupResponse_RuleGroup_H
...
class OAICreateRuleGroupResponse_RuleGroup : public OAIObject {
public:
    OAICreateRuleGroupResponse_RuleGroup();
    OAICreateRuleGroupResponse_RuleGroup(QString json);
    ~OAICreateRuleGroupResponse_RuleGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRuleGroupResponse_RuleGroup)

#endif // OAICreateRuleGroupResponse_RuleGroup_H
