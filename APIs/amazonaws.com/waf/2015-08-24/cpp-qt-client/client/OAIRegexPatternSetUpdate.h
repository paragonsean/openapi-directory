...
#ifndef OAIRegexPatternSetUpdate_H
#define OAIRegexPatternSetUpdate_H
...
class OAIRegexPatternSetUpdate : public OAIObject {
public:
    OAIRegexPatternSetUpdate();
    OAIRegexPatternSetUpdate(QString json);
    ~OAIRegexPatternSetUpdate() override;
    ...
    QString getRegexPatternString() const;
    void setRegexPatternString(const QString &regex_pattern_string);
    bool is_regex_pattern_string_Set() const;
    bool is_regex_pattern_string_Valid() const;
...
private:
    ...
    QString m_regex_pattern_string;
    bool m_regex_pattern_string_isSet;
    bool m_regex_pattern_string_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIRegexPatternSetUpdate)

#endif // OAIRegexPatternSetUpdate_H
