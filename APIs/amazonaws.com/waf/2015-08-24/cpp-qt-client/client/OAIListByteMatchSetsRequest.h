...
/*
 * OAIListByteMatchSetsRequest.h
 *
 * 
 */

#ifndef OAIListByteMatchSetsRequest_H
#define OAIListByteMatchSetsRequest_H
...
class OAIListByteMatchSetsRequest : public OAIObject {
public:
    OAIListByteMatchSetsRequest();
    OAIListByteMatchSetsRequest(QString json);
    ~OAIListByteMatchSetsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListByteMatchSetsRequest)

#endif // OAIListByteMatchSetsRequest_H
