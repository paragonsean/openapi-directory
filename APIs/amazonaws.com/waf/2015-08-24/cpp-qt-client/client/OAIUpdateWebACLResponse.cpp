...
OAIUpdateWebACLResponse::OAIUpdateWebACLResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateWebACLResponse::OAIUpdateWebACLResponse() {
    this->initializeModel();
}

OAIUpdateWebACLResponse::~OAIUpdateWebACLResponse() {}

void OAIUpdateWebACLResponse::initializeModel() {

    m_change_token_isSet = false;
    m_change_token_isValid = false;
}

void OAIUpdateWebACLResponse::fromJson(QString jsonString) {
...
void OAIUpdateWebACLResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateWebACLResponse::asJson() const {
...
QJsonObject OAIUpdateWebACLResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateWebACLResponse::getChangeToken() const {
    return m_change_token;
}
void OAIUpdateWebACLResponse::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAIUpdateWebACLResponse::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAIUpdateWebACLResponse::is_change_token_Valid() const{
    return m_change_token_isValid;
}

bool OAIUpdateWebACLResponse::isSet() const {
...
bool OAIUpdateWebACLResponse::isValid() const {
