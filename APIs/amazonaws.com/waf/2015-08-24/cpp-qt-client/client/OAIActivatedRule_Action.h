...
/*
 * OAIActivatedRule_Action.h
 *
 * 
 */

#ifndef OAIActivatedRule_Action_H
#define OAIActivatedRule_Action_H
...
class OAIActivatedRule_Action : public OAIObject {
public:
    OAIActivatedRule_Action();
    OAIActivatedRule_Action(QString json);
    ~OAIActivatedRule_Action() override;
    ...
    OAIWafActionType getType() const;
    void setType(const OAIWafActionType &type);
...
Q_DECLARE_METATYPE(OpenAPI::OAIActivatedRule_Action)

#endif // OAIActivatedRule_Action_H
