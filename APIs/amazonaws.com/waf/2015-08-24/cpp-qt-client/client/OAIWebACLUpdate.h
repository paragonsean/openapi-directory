...
#ifndef OAIWebACLUpdate_H
#define OAIWebACLUpdate_H
...
namespace OpenAPI {
class OAIWebACLUpdate_ActivatedRule;

class OAIWebACLUpdate : public OAIObject {
public:
    OAIWebACLUpdate();
    OAIWebACLUpdate(QString json);
    ~OAIWebACLUpdate() override;
    ...
    OAIWebACLUpdate_ActivatedRule getActivatedRule() const;
    void setActivatedRule(const OAIWebACLUpdate_ActivatedRule &activated_rule);
    bool is_activated_rule_Set() const;
    bool is_activated_rule_Valid() const;
...
private:
    ...
    OAIWebACLUpdate_ActivatedRule m_activated_rule;
    bool m_activated_rule_isSet;
    bool m_activated_rule_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIWebACLUpdate)

#endif // OAIWebACLUpdate_H
