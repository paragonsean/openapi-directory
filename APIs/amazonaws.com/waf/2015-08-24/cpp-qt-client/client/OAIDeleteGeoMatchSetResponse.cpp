...
OAIDeleteGeoMatchSetResponse::OAIDeleteGeoMatchSetResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteGeoMatchSetResponse::OAIDeleteGeoMatchSetResponse() {
    this->initializeModel();
}

OAIDeleteGeoMatchSetResponse::~OAIDeleteGeoMatchSetResponse() {}

void OAIDeleteGeoMatchSetResponse::initializeModel() {

    m_change_token_isSet = false;
    m_change_token_isValid = false;
}

void OAIDeleteGeoMatchSetResponse::fromJson(QString jsonString) {
...
void OAIDeleteGeoMatchSetResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteGeoMatchSetResponse::asJson() const {
...
QJsonObject OAIDeleteGeoMatchSetResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteGeoMatchSetResponse::getChangeToken() const {
    return m_change_token;
}
void OAIDeleteGeoMatchSetResponse::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAIDeleteGeoMatchSetResponse::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAIDeleteGeoMatchSetResponse::is_change_token_Valid() const{
    return m_change_token_isValid;
}

bool OAIDeleteGeoMatchSetResponse::isSet() const {
...
bool OAIDeleteGeoMatchSetResponse::isValid() const {
