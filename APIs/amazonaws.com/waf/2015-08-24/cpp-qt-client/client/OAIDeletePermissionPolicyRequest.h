...
/*
 * OAIDeletePermissionPolicyRequest.h
 *
 * 
 */

#ifndef OAIDeletePermissionPolicyRequest_H
#define OAIDeletePermissionPolicyRequest_H
...
class OAIDeletePermissionPolicyRequest : public OAIObject {
public:
    OAIDeletePermissionPolicyRequest();
    OAIDeletePermissionPolicyRequest(QString json);
    ~OAIDeletePermissionPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeletePermissionPolicyRequest)

#endif // OAIDeletePermissionPolicyRequest_H
