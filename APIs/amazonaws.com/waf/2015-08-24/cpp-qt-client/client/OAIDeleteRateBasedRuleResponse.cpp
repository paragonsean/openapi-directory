...
OAIDeleteRateBasedRuleResponse::OAIDeleteRateBasedRuleResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteRateBasedRuleResponse::OAIDeleteRateBasedRuleResponse() {
    this->initializeModel();
}

OAIDeleteRateBasedRuleResponse::~OAIDeleteRateBasedRuleResponse() {}

void OAIDeleteRateBasedRuleResponse::initializeModel() {

    m_change_token_isSet = false;
    m_change_token_isValid = false;
}

void OAIDeleteRateBasedRuleResponse::fromJson(QString jsonString) {
...
void OAIDeleteRateBasedRuleResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteRateBasedRuleResponse::asJson() const {
...
QJsonObject OAIDeleteRateBasedRuleResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteRateBasedRuleResponse::getChangeToken() const {
    return m_change_token;
}
void OAIDeleteRateBasedRuleResponse::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAIDeleteRateBasedRuleResponse::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAIDeleteRateBasedRuleResponse::is_change_token_Valid() const{
    return m_change_token_isValid;
}

bool OAIDeleteRateBasedRuleResponse::isSet() const {
...
bool OAIDeleteRateBasedRuleResponse::isValid() const {
