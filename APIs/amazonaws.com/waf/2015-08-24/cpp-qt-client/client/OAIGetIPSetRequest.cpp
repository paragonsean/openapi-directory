...
OAIGetIPSetRequest::OAIGetIPSetRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetIPSetRequest::OAIGetIPSetRequest() {
    this->initializeModel();
}

OAIGetIPSetRequest::~OAIGetIPSetRequest() {}

void OAIGetIPSetRequest::initializeModel() {

    m_ip_set_id_isSet = false;
    m_ip_set_id_isValid = false;
}

void OAIGetIPSetRequest::fromJson(QString jsonString) {
...
void OAIGetIPSetRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetIPSetRequest::asJson() const {
...
QJsonObject OAIGetIPSetRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetIPSetRequest::getIpSetId() const {
    return m_ip_set_id;
}
void OAIGetIPSetRequest::setIpSetId(const QString &ip_set_id) {
    m_ip_set_id = ip_set_id;
    m_ip_set_id_isSet = true;
}

bool OAIGetIPSetRequest::is_ip_set_id_Set() const{
    return m_ip_set_id_isSet;
}

bool OAIGetIPSetRequest::is_ip_set_id_Valid() const{
    return m_ip_set_id_isValid;
}

bool OAIGetIPSetRequest::isSet() const {
...
bool OAIGetIPSetRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_ip_set_id_isValid && true;
}
