...
OAIGetWebACLRequest::OAIGetWebACLRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetWebACLRequest::OAIGetWebACLRequest() {
    this->initializeModel();
}

OAIGetWebACLRequest::~OAIGetWebACLRequest() {}

void OAIGetWebACLRequest::initializeModel() {

    m_web_aclid_isSet = false;
    m_web_aclid_isValid = false;
}

void OAIGetWebACLRequest::fromJson(QString jsonString) {
...
void OAIGetWebACLRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetWebACLRequest::asJson() const {
...
QJsonObject OAIGetWebACLRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetWebACLRequest::getWebAclid() const {
    return m_web_aclid;
}
void OAIGetWebACLRequest::setWebAclid(const QString &web_aclid) {
    m_web_aclid = web_aclid;
    m_web_aclid_isSet = true;
}

bool OAIGetWebACLRequest::is_web_aclid_Set() const{
    return m_web_aclid_isSet;
}

bool OAIGetWebACLRequest::is_web_aclid_Valid() const{
    return m_web_aclid_isValid;
}

bool OAIGetWebACLRequest::isSet() const {
...
bool OAIGetWebACLRequest::isValid() const {
