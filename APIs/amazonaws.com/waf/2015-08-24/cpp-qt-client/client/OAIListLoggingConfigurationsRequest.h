...
/*
 * OAIListLoggingConfigurationsRequest.h
 *
 * 
 */

#ifndef OAIListLoggingConfigurationsRequest_H
#define OAIListLoggingConfigurationsRequest_H
...
class OAIListLoggingConfigurationsRequest : public OAIObject {
public:
    OAIListLoggingConfigurationsRequest();
    OAIListLoggingConfigurationsRequest(QString json);
    ~OAIListLoggingConfigurationsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListLoggingConfigurationsRequest)

#endif // OAIListLoggingConfigurationsRequest_H
