...
OAIExcludedRule::OAIExcludedRule(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExcludedRule::OAIExcludedRule() {
    this->initializeModel();
}

OAIExcludedRule::~OAIExcludedRule() {}

void OAIExcludedRule::initializeModel() {

    m_rule_id_isSet = false;
    m_rule_id_isValid = false;
}

void OAIExcludedRule::fromJson(QString jsonString) {
...
void OAIExcludedRule::fromJsonObject(QJsonObject json) {
...
QString OAIExcludedRule::asJson() const {
...
QJsonObject OAIExcludedRule::asJsonObject() const {
    QJsonObject obj;
    if (m_rule_id_isSet) {
...
QString OAIExcludedRule::getRuleId() const {
    return m_rule_id;
}
void OAIExcludedRule::setRuleId(const QString &rule_id) {
    m_rule_id = rule_id;
    m_rule_id_isSet = true;
}

bool OAIExcludedRule::is_rule_id_Set() const{
    return m_rule_id_isSet;
}

bool OAIExcludedRule::is_rule_id_Valid() const{
    return m_rule_id_isValid;
}

bool OAIExcludedRule::isSet() const {
...
bool OAIExcludedRule::isValid() const {
