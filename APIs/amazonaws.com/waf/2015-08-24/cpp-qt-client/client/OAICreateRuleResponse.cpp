...
OAICreateRuleResponse_Rule OAICreateRuleResponse::getRule() const {
    return m_rule;
}
void OAICreateRuleResponse::setRule(const OAICreateRuleResponse_Rule &rule) {
    m_rule = rule;
    m_rule_isSet = true;
}

bool OAICreateRuleResponse::is_rule_Set() const{
    return m_rule_isSet;
}

bool OAICreateRuleResponse::is_rule_Valid() const{
    return m_rule_isValid;
}

QString OAICreateRuleResponse::getChangeToken() const {
    return m_change_token;
}
void OAICreateRuleResponse::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAICreateRuleResponse::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAICreateRuleResponse::is_change_token_Valid() const{
