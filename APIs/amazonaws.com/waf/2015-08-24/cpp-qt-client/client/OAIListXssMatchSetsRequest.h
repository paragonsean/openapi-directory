...
/*
 * OAIListXssMatchSetsRequest.h
 *
 * A request to list the &lt;a&gt;XssMatchSet&lt;/a&gt; objects created by the current AWS account.
 */

#ifndef OAIListXssMatchSetsRequest_H
#define OAIListXssMatchSetsRequest_H
...
class OAIListXssMatchSetsRequest : public OAIObject {
public:
    OAIListXssMatchSetsRequest();
    OAIListXssMatchSetsRequest(QString json);
    ~OAIListXssMatchSetsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListXssMatchSetsRequest)

#endif // OAIListXssMatchSetsRequest_H
