...
#ifndef OAIRegexMatchSet_H
#define OAIRegexMatchSet_H
...
class OAIRegexMatchSet : public OAIObject {
public:
    OAIRegexMatchSet();
    OAIRegexMatchSet(QString json);
    ~OAIRegexMatchSet() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegexMatchSet)

#endif // OAIRegexMatchSet_H
