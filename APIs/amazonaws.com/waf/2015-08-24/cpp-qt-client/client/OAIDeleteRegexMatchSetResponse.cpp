...
OAIDeleteRegexMatchSetResponse::OAIDeleteRegexMatchSetResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteRegexMatchSetResponse::OAIDeleteRegexMatchSetResponse() {
    this->initializeModel();
}

OAIDeleteRegexMatchSetResponse::~OAIDeleteRegexMatchSetResponse() {}

void OAIDeleteRegexMatchSetResponse::initializeModel() {

    m_change_token_isSet = false;
    m_change_token_isValid = false;
}

void OAIDeleteRegexMatchSetResponse::fromJson(QString jsonString) {
...
void OAIDeleteRegexMatchSetResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteRegexMatchSetResponse::asJson() const {
...
QJsonObject OAIDeleteRegexMatchSetResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteRegexMatchSetResponse::getChangeToken() const {
    return m_change_token;
}
void OAIDeleteRegexMatchSetResponse::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAIDeleteRegexMatchSetResponse::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAIDeleteRegexMatchSetResponse::is_change_token_Valid() const{
    return m_change_token_isValid;
}

bool OAIDeleteRegexMatchSetResponse::isSet() const {
...
bool OAIDeleteRegexMatchSetResponse::isValid() const {
