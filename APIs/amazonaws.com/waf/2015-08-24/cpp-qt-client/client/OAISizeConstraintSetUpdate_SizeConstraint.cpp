...
OAISizeConstraintSetUpdate_SizeConstraint::OAISizeConstraintSetUpdate_SizeConstraint(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISizeConstraintSetUpdate_SizeConstraint::OAISizeConstraintSetUpdate_SizeConstraint() {
    this->initializeModel();
}

OAISizeConstraintSetUpdate_SizeConstraint::~OAISizeConstraintSetUpdate_SizeConstraint() {}

void OAISizeConstraintSetUpdate_SizeConstraint::initializeModel() {
...
void OAISizeConstraintSetUpdate_SizeConstraint::fromJson(QString jsonString) {
...
void OAISizeConstraintSetUpdate_SizeConstraint::fromJsonObject(QJsonObject json) {
...
QString OAISizeConstraintSetUpdate_SizeConstraint::asJson() const {
...
QJsonObject OAISizeConstraintSetUpdate_SizeConstraint::asJsonObject() const {
    QJsonObject obj;
...
OAISizeConstraint_FieldToMatch OAISizeConstraintSetUpdate_SizeConstraint::getFieldToMatch() const {
    return m_field_to_match;
}
void OAISizeConstraintSetUpdate_SizeConstraint::setFieldToMatch(const OAISizeConstraint_FieldToMatch &field_to_match) {
    m_field_to_match = field_to_match;
    m_field_to_match_isSet = true;
}

bool OAISizeConstraintSetUpdate_SizeConstraint::is_field_to_match_Set() const{
    return m_field_to_match_isSet;
}

bool OAISizeConstraintSetUpdate_SizeConstraint::is_field_to_match_Valid() const{
    return m_field_to_match_isValid;
}

OAITextTransformation OAISizeConstraintSetUpdate_SizeConstraint::getTextTransformation() const {
    return m_text_transformation;
}
void OAISizeConstraintSetUpdate_SizeConstraint::setTextTransformation(const OAITextTransformation &text_transformation) {
    m_text_transformation = text_transformation;
    m_text_transformation_isSet = true;
}

bool OAISizeConstraintSetUpdate_SizeConstraint::is_text_transformation_Set() const{
    return m_text_transformation_isSet;
}

bool OAISizeConstraintSetUpdate_SizeConstraint::is_text_transformation_Valid() const{
    return m_text_transformation_isValid;
}

OAIComparisonOperator OAISizeConstraintSetUpdate_SizeConstraint::getComparisonOperator() const {
    return m_comparison_operator;
}
void OAISizeConstraintSetUpdate_SizeConstraint::setComparisonOperator(const OAIComparisonOperator &comparison_operator) {
    m_comparison_operator = comparison_operator;
    m_comparison_operator_isSet = true;
}

bool OAISizeConstraintSetUpdate_SizeConstraint::is_comparison_operator_Set() const{
    return m_comparison_operator_isSet;
}

bool OAISizeConstraintSetUpdate_SizeConstraint::is_comparison_operator_Valid() const{
    return m_comparison_operator_isValid;
}

qint32 OAISizeConstraintSetUpdate_SizeConstraint::getSize() const {
    return m_size;
}
void OAISizeConstraintSetUpdate_SizeConstraint::setSize(const qint32 &size) {
    m_size = size;
    m_size_isSet = true;
}

bool OAISizeConstraintSetUpdate_SizeConstraint::is_size_Set() const{
    return m_size_isSet;
}

bool OAISizeConstraintSetUpdate_SizeConstraint::is_size_Valid() const{
    return m_size_isValid;
}

bool OAISizeConstraintSetUpdate_SizeConstraint::isSet() const {
...
bool OAISizeConstraintSetUpdate_SizeConstraint::isValid() const {
