...
OAICreateIPSetRequest::OAICreateIPSetRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateIPSetRequest::OAICreateIPSetRequest() {
    this->initializeModel();
}

OAICreateIPSetRequest::~OAICreateIPSetRequest() {}

void OAICreateIPSetRequest::initializeModel() {
...
void OAICreateIPSetRequest::fromJson(QString jsonString) {
...
void OAICreateIPSetRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateIPSetRequest::asJson() const {
...
QJsonObject OAICreateIPSetRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAICreateIPSetRequest::getName() const {
    return m_name;
}
void OAICreateIPSetRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateIPSetRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateIPSetRequest::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICreateIPSetRequest::getChangeToken() const {
    return m_change_token;
}
void OAICreateIPSetRequest::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAICreateIPSetRequest::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAICreateIPSetRequest::is_change_token_Valid() const{
    return m_change_token_isValid;
}

bool OAICreateIPSetRequest::isSet() const {
...
bool OAICreateIPSetRequest::isValid() const {
