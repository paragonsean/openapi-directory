...
OAIDeleteIPSetRequest::OAIDeleteIPSetRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteIPSetRequest::OAIDeleteIPSetRequest() {
    this->initializeModel();
}

OAIDeleteIPSetRequest::~OAIDeleteIPSetRequest() {}

void OAIDeleteIPSetRequest::initializeModel() {
...
void OAIDeleteIPSetRequest::fromJson(QString jsonString) {
...
void OAIDeleteIPSetRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteIPSetRequest::asJson() const {
...
QJsonObject OAIDeleteIPSetRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteIPSetRequest::getIpSetId() const {
    return m_ip_set_id;
}
void OAIDeleteIPSetRequest::setIpSetId(const QString &ip_set_id) {
    m_ip_set_id = ip_set_id;
    m_ip_set_id_isSet = true;
}

bool OAIDeleteIPSetRequest::is_ip_set_id_Set() const{
    return m_ip_set_id_isSet;
}

bool OAIDeleteIPSetRequest::is_ip_set_id_Valid() const{
    return m_ip_set_id_isValid;
}

QString OAIDeleteIPSetRequest::getChangeToken() const {
    return m_change_token;
}
void OAIDeleteIPSetRequest::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAIDeleteIPSetRequest::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAIDeleteIPSetRequest::is_change_token_Valid() const{
    return m_change_token_isValid;
}

bool OAIDeleteIPSetRequest::isSet() const {
...
bool OAIDeleteIPSetRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_ip_set_id_isValid && m_change_token_isValid && true;
}
