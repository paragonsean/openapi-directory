...
/*
 * OAICreateWebACLRequest.h
 *
 * 
 */

#ifndef OAICreateWebACLRequest_H
#define OAICreateWebACLRequest_H
...
namespace OpenAPI {
class OAICreateWebACLRequest_DefaultAction;

class OAICreateWebACLRequest : public OAIObject {
public:
    OAICreateWebACLRequest();
    OAICreateWebACLRequest(QString json);
    ~OAICreateWebACLRequest() override;
    ...
    OAICreateWebACLRequest_DefaultAction getDefaultAction() const;
    void setDefaultAction(const OAICreateWebACLRequest_DefaultAction &default_action);
...
private:
    ...
    OAICreateWebACLRequest_DefaultAction m_default_action;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateWebACLRequest)

#endif // OAICreateWebACLRequest_H
