...
/*
 * OAIListRegexPatternSetsRequest.h
 *
 * 
 */

#ifndef OAIListRegexPatternSetsRequest_H
#define OAIListRegexPatternSetsRequest_H
...
class OAIListRegexPatternSetsRequest : public OAIObject {
public:
    OAIListRegexPatternSetsRequest();
    OAIListRegexPatternSetsRequest(QString json);
    ~OAIListRegexPatternSetsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListRegexPatternSetsRequest)

#endif // OAIListRegexPatternSetsRequest_H
