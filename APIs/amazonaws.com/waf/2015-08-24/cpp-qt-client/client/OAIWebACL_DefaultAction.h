...
/*
 * OAIWebACL_DefaultAction.h
 *
 * 
 */

#ifndef OAIWebACL_DefaultAction_H
#define OAIWebACL_DefaultAction_H
...
class OAIWebACL_DefaultAction : public OAIObject {
public:
    OAIWebACL_DefaultAction();
    OAIWebACL_DefaultAction(QString json);
    ~OAIWebACL_DefaultAction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebACL_DefaultAction)

#endif // OAIWebACL_DefaultAction_H
