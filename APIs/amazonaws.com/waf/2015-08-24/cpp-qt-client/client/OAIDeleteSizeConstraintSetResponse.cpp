...
OAIDeleteSizeConstraintSetResponse::OAIDeleteSizeConstraintSetResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteSizeConstraintSetResponse::OAIDeleteSizeConstraintSetResponse() {
    this->initializeModel();
}

OAIDeleteSizeConstraintSetResponse::~OAIDeleteSizeConstraintSetResponse() {}

void OAIDeleteSizeConstraintSetResponse::initializeModel() {

    m_change_token_isSet = false;
    m_change_token_isValid = false;
}

void OAIDeleteSizeConstraintSetResponse::fromJson(QString jsonString) {
...
void OAIDeleteSizeConstraintSetResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteSizeConstraintSetResponse::asJson() const {
...
QJsonObject OAIDeleteSizeConstraintSetResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteSizeConstraintSetResponse::getChangeToken() const {
    return m_change_token;
}
void OAIDeleteSizeConstraintSetResponse::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAIDeleteSizeConstraintSetResponse::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAIDeleteSizeConstraintSetResponse::is_change_token_Valid() const{
    return m_change_token_isValid;
}

bool OAIDeleteSizeConstraintSetResponse::isSet() const {
...
bool OAIDeleteSizeConstraintSetResponse::isValid() const {
