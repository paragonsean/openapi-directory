...
#ifndef OAIWafRuleType_H
#define OAIWafRuleType_H
...
class OAIWafRuleType : public OAIEnum {
public:
    OAIWafRuleType();
    OAIWafRuleType(QString json);
    ~OAIWafRuleType() override;
    ...
    enum class eOAIWafRuleType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        REGULAR, 
        RATE_BASED, 
        GROUP
    };
    OAIWafRuleType::eOAIWafRuleType getValue() const;
    void setValue(const OAIWafRuleType::eOAIWafRuleType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIWafRuleType)

#endif // OAIWafRuleType_H
