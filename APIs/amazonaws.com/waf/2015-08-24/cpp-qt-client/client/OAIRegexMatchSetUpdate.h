...
#ifndef OAIRegexMatchSetUpdate_H
#define OAIRegexMatchSetUpdate_H
...
namespace OpenAPI {
class OAIRegexMatchSetUpdate_RegexMatchTuple;

class OAIRegexMatchSetUpdate : public OAIObject {
public:
    OAIRegexMatchSetUpdate();
    OAIRegexMatchSetUpdate(QString json);
    ~OAIRegexMatchSetUpdate() override;
    ...
    OAIRegexMatchSetUpdate_RegexMatchTuple getRegexMatchTuple() const;
    void setRegexMatchTuple(const OAIRegexMatchSetUpdate_RegexMatchTuple &regex_match_tuple);
    bool is_regex_match_tuple_Set() const;
    bool is_regex_match_tuple_Valid() const;
...
private:
    ...
    OAIRegexMatchSetUpdate_RegexMatchTuple m_regex_match_tuple;
    bool m_regex_match_tuple_isSet;
    bool m_regex_match_tuple_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIRegexMatchSetUpdate)

#endif // OAIRegexMatchSetUpdate_H
