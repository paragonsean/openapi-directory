...
/*
 * OAIListIPSetsRequest.h
 *
 * 
 */

#ifndef OAIListIPSetsRequest_H
#define OAIListIPSetsRequest_H
...
class OAIListIPSetsRequest : public OAIObject {
public:
    OAIListIPSetsRequest();
    OAIListIPSetsRequest(QString json);
    ~OAIListIPSetsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListIPSetsRequest)

#endif // OAIListIPSetsRequest_H
