...
#ifndef OAIWebACLSummary_H
#define OAIWebACLSummary_H
...
class OAIWebACLSummary : public OAIObject {
public:
    OAIWebACLSummary();
    OAIWebACLSummary(QString json);
    ~OAIWebACLSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebACLSummary)

#endif // OAIWebACLSummary_H
