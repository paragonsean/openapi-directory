...
/*
 * OAIListGeoMatchSetsResponse.h
 *
 * 
 */

#ifndef OAIListGeoMatchSetsResponse_H
#define OAIListGeoMatchSetsResponse_H
...
class OAIListGeoMatchSetsResponse : public OAIObject {
public:
    OAIListGeoMatchSetsResponse();
    OAIListGeoMatchSetsResponse(QString json);
    ~OAIListGeoMatchSetsResponse() override;
    ...
    QList getGeoMatchSets() const;
    void setGeoMatchSets(const QList &geo_match_sets);
    bool is_geo_match_sets_Set() const;
    bool is_geo_match_sets_Valid() const;
...
private:
    ...
    QList m_geo_match_sets;
    bool m_geo_match_sets_isSet;
    bool m_geo_match_sets_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListGeoMatchSetsResponse)

#endif // OAIListGeoMatchSetsResponse_H
