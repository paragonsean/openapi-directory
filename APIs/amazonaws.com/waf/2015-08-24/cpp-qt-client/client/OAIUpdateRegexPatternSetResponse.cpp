...
OAIUpdateRegexPatternSetResponse::OAIUpdateRegexPatternSetResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateRegexPatternSetResponse::OAIUpdateRegexPatternSetResponse() {
    this->initializeModel();
}

OAIUpdateRegexPatternSetResponse::~OAIUpdateRegexPatternSetResponse() {}

void OAIUpdateRegexPatternSetResponse::initializeModel() {

    m_change_token_isSet = false;
    m_change_token_isValid = false;
}

void OAIUpdateRegexPatternSetResponse::fromJson(QString jsonString) {
...
void OAIUpdateRegexPatternSetResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateRegexPatternSetResponse::asJson() const {
...
QJsonObject OAIUpdateRegexPatternSetResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateRegexPatternSetResponse::getChangeToken() const {
    return m_change_token;
}
void OAIUpdateRegexPatternSetResponse::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAIUpdateRegexPatternSetResponse::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAIUpdateRegexPatternSetResponse::is_change_token_Valid() const{
    return m_change_token_isValid;
}

bool OAIUpdateRegexPatternSetResponse::isSet() const {
...
bool OAIUpdateRegexPatternSetResponse::isValid() const {
