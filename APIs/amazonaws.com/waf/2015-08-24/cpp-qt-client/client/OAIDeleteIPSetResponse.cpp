...
OAIDeleteIPSetResponse::OAIDeleteIPSetResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteIPSetResponse::OAIDeleteIPSetResponse() {
    this->initializeModel();
}

OAIDeleteIPSetResponse::~OAIDeleteIPSetResponse() {}

void OAIDeleteIPSetResponse::initializeModel() {

    m_change_token_isSet = false;
    m_change_token_isValid = false;
}

void OAIDeleteIPSetResponse::fromJson(QString jsonString) {
...
void OAIDeleteIPSetResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteIPSetResponse::asJson() const {
...
QJsonObject OAIDeleteIPSetResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteIPSetResponse::getChangeToken() const {
    return m_change_token;
}
void OAIDeleteIPSetResponse::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAIDeleteIPSetResponse::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAIDeleteIPSetResponse::is_change_token_Valid() const{
    return m_change_token_isValid;
}

bool OAIDeleteIPSetResponse::isSet() const {
...
bool OAIDeleteIPSetResponse::isValid() const {
