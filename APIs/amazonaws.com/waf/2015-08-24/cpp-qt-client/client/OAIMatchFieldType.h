...
#ifndef OAIMatchFieldType_H
#define OAIMatchFieldType_H
...
class OAIMatchFieldType : public OAIEnum {
public:
    OAIMatchFieldType();
    OAIMatchFieldType(QString json);
    ~OAIMatchFieldType() override;
    ...
    OAIMatchFieldType::eOAIMatchFieldType getValue() const;
    void setValue(const OAIMatchFieldType::eOAIMatchFieldType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIMatchFieldType)

#endif // OAIMatchFieldType_H
