...
/*
 * OAIGetRateBasedRuleRequest.h
 *
 * 
 */

#ifndef OAIGetRateBasedRuleRequest_H
#define OAIGetRateBasedRuleRequest_H
...
class OAIGetRateBasedRuleRequest : public OAIObject {
public:
    OAIGetRateBasedRuleRequest();
    OAIGetRateBasedRuleRequest(QString json);
    ~OAIGetRateBasedRuleRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRateBasedRuleRequest)

#endif // OAIGetRateBasedRuleRequest_H
