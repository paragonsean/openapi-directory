...
OAIUpdateRegexMatchSetResponse::OAIUpdateRegexMatchSetResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateRegexMatchSetResponse::OAIUpdateRegexMatchSetResponse() {
    this->initializeModel();
}

OAIUpdateRegexMatchSetResponse::~OAIUpdateRegexMatchSetResponse() {}

void OAIUpdateRegexMatchSetResponse::initializeModel() {

    m_change_token_isSet = false;
    m_change_token_isValid = false;
}

void OAIUpdateRegexMatchSetResponse::fromJson(QString jsonString) {
...
void OAIUpdateRegexMatchSetResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateRegexMatchSetResponse::asJson() const {
...
QJsonObject OAIUpdateRegexMatchSetResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateRegexMatchSetResponse::getChangeToken() const {
    return m_change_token;
}
void OAIUpdateRegexMatchSetResponse::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAIUpdateRegexMatchSetResponse::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAIUpdateRegexMatchSetResponse::is_change_token_Valid() const{
    return m_change_token_isValid;
}

bool OAIUpdateRegexMatchSetResponse::isSet() const {
...
bool OAIUpdateRegexMatchSetResponse::isValid() const {
