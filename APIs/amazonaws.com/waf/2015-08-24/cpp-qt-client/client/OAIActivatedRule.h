...
#ifndef OAIActivatedRule_H
#define OAIActivatedRule_H
...
class OAIActivatedRule : public OAIObject {
public:
    OAIActivatedRule();
    OAIActivatedRule(QString json);
    ~OAIActivatedRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActivatedRule)

#endif // OAIActivatedRule_H
