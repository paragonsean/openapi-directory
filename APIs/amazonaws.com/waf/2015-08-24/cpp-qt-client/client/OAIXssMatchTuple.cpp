...
OAIXssMatchTuple::OAIXssMatchTuple(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIXssMatchTuple::OAIXssMatchTuple() {
    this->initializeModel();
}

OAIXssMatchTuple::~OAIXssMatchTuple() {}

void OAIXssMatchTuple::initializeModel() {
...
void OAIXssMatchTuple::fromJson(QString jsonString) {
...
void OAIXssMatchTuple::fromJsonObject(QJsonObject json) {
...
QString OAIXssMatchTuple::asJson() const {
...
QJsonObject OAIXssMatchTuple::asJsonObject() const {
    QJsonObject obj;
...
OAIXssMatchTuple_FieldToMatch OAIXssMatchTuple::getFieldToMatch() const {
    return m_field_to_match;
}
void OAIXssMatchTuple::setFieldToMatch(const OAIXssMatchTuple_FieldToMatch &field_to_match) {
    m_field_to_match = field_to_match;
    m_field_to_match_isSet = true;
}

bool OAIXssMatchTuple::is_field_to_match_Set() const{
    return m_field_to_match_isSet;
}

bool OAIXssMatchTuple::is_field_to_match_Valid() const{
    return m_field_to_match_isValid;
}

OAITextTransformation OAIXssMatchTuple::getTextTransformation() const {
    return m_text_transformation;
}
void OAIXssMatchTuple::setTextTransformation(const OAITextTransformation &text_transformation) {
    m_text_transformation = text_transformation;
    m_text_transformation_isSet = true;
}

bool OAIXssMatchTuple::is_text_transformation_Set() const{
    return m_text_transformation_isSet;
}

bool OAIXssMatchTuple::is_text_transformation_Valid() const{
    return m_text_transformation_isValid;
}

bool OAIXssMatchTuple::isSet() const {
...
bool OAIXssMatchTuple::isValid() const {
