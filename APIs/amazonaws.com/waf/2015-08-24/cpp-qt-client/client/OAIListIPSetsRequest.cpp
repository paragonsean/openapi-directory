...
OAIListIPSetsRequest::OAIListIPSetsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListIPSetsRequest::OAIListIPSetsRequest() {
    this->initializeModel();
}

OAIListIPSetsRequest::~OAIListIPSetsRequest() {}

void OAIListIPSetsRequest::initializeModel() {
...
void OAIListIPSetsRequest::fromJson(QString jsonString) {
...
void OAIListIPSetsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListIPSetsRequest::asJson() const {
...
QJsonObject OAIListIPSetsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListIPSetsRequest::getNextMarker() const {
    return m_next_marker;
}
void OAIListIPSetsRequest::setNextMarker(const QString &next_marker) {
    m_next_marker = next_marker;
    m_next_marker_isSet = true;
}

bool OAIListIPSetsRequest::is_next_marker_Set() const{
    return m_next_marker_isSet;
}

bool OAIListIPSetsRequest::is_next_marker_Valid() const{
    return m_next_marker_isValid;
}

qint32 OAIListIPSetsRequest::getLimit() const {
    return m_limit;
}
void OAIListIPSetsRequest::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIListIPSetsRequest::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIListIPSetsRequest::is_limit_Valid() const{
    return m_limit_isValid;
}

bool OAIListIPSetsRequest::isSet() const {
...
bool OAIListIPSetsRequest::isValid() const {
