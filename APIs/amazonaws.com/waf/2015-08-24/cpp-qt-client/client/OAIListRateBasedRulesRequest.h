...
/*
 * OAIListRateBasedRulesRequest.h
 *
 * 
 */

#ifndef OAIListRateBasedRulesRequest_H
#define OAIListRateBasedRulesRequest_H
...
class OAIListRateBasedRulesRequest : public OAIObject {
public:
    OAIListRateBasedRulesRequest();
    OAIListRateBasedRulesRequest(QString json);
    ~OAIListRateBasedRulesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListRateBasedRulesRequest)

#endif // OAIListRateBasedRulesRequest_H
