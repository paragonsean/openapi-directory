...
#ifndef OAIRegexMatchSetSummary_H
#define OAIRegexMatchSetSummary_H
...
class OAIRegexMatchSetSummary : public OAIObject {
public:
    OAIRegexMatchSetSummary();
    OAIRegexMatchSetSummary(QString json);
    ~OAIRegexMatchSetSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegexMatchSetSummary)

#endif // OAIRegexMatchSetSummary_H
