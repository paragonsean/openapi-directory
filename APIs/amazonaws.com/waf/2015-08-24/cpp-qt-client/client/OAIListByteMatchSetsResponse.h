...
/*
 * OAIListByteMatchSetsResponse.h
 *
 * 
 */

#ifndef OAIListByteMatchSetsResponse_H
#define OAIListByteMatchSetsResponse_H
...
class OAIListByteMatchSetsResponse : public OAIObject {
public:
    OAIListByteMatchSetsResponse();
    OAIListByteMatchSetsResponse(QString json);
    ~OAIListByteMatchSetsResponse() override;
    ...
    QList getByteMatchSets() const;
    void setByteMatchSets(const QList &byte_match_sets);
    bool is_byte_match_sets_Set() const;
    bool is_byte_match_sets_Valid() const;
...
private:
    ...
    QList m_byte_match_sets;
    bool m_byte_match_sets_isSet;
    bool m_byte_match_sets_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListByteMatchSetsResponse)

#endif // OAIListByteMatchSetsResponse_H
