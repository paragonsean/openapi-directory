...
OAIListRateBasedRulesResponse::OAIListRateBasedRulesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListRateBasedRulesResponse::OAIListRateBasedRulesResponse() {
    this->initializeModel();
}

OAIListRateBasedRulesResponse::~OAIListRateBasedRulesResponse() {}

void OAIListRateBasedRulesResponse::initializeModel() {
...
void OAIListRateBasedRulesResponse::fromJson(QString jsonString) {
...
void OAIListRateBasedRulesResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListRateBasedRulesResponse::asJson() const {
...
QJsonObject OAIListRateBasedRulesResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListRateBasedRulesResponse::getNextMarker() const {
    return m_next_marker;
}
void OAIListRateBasedRulesResponse::setNextMarker(const QString &next_marker) {
    m_next_marker = next_marker;
    m_next_marker_isSet = true;
}

bool OAIListRateBasedRulesResponse::is_next_marker_Set() const{
    return m_next_marker_isSet;
}

bool OAIListRateBasedRulesResponse::is_next_marker_Valid() const{
    return m_next_marker_isValid;
}

QList OAIListRateBasedRulesResponse::getRules() const {
    return m_rules;
}
void OAIListRateBasedRulesResponse::setRules(const QList &rules) {
    m_rules = rules;
    m_rules_isSet = true;
}

bool OAIListRateBasedRulesResponse::is_rules_Set() const{
    return m_rules_isSet;
}

bool OAIListRateBasedRulesResponse::is_rules_Valid() const{
    return m_rules_isValid;
}

bool OAIListRateBasedRulesResponse::isSet() const {
...
bool OAIListRateBasedRulesResponse::isValid() const {
