...
#ifndef OAIExcludedRule_H
#define OAIExcludedRule_H
...
class OAIExcludedRule : public OAIObject {
public:
    OAIExcludedRule();
    OAIExcludedRule(QString json);
    ~OAIExcludedRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExcludedRule)

#endif // OAIExcludedRule_H
