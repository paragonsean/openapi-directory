...
OAIUpdateSqlInjectionMatchSetResponse::OAIUpdateSqlInjectionMatchSetResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateSqlInjectionMatchSetResponse::OAIUpdateSqlInjectionMatchSetResponse() {
    this->initializeModel();
}

OAIUpdateSqlInjectionMatchSetResponse::~OAIUpdateSqlInjectionMatchSetResponse() {}

void OAIUpdateSqlInjectionMatchSetResponse::initializeModel() {

    m_change_token_isSet = false;
    m_change_token_isValid = false;
}

void OAIUpdateSqlInjectionMatchSetResponse::fromJson(QString jsonString) {
...
void OAIUpdateSqlInjectionMatchSetResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateSqlInjectionMatchSetResponse::asJson() const {
...
QJsonObject OAIUpdateSqlInjectionMatchSetResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateSqlInjectionMatchSetResponse::getChangeToken() const {
    return m_change_token;
}
void OAIUpdateSqlInjectionMatchSetResponse::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAIUpdateSqlInjectionMatchSetResponse::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAIUpdateSqlInjectionMatchSetResponse::is_change_token_Valid() const{
    return m_change_token_isValid;
}

bool OAIUpdateSqlInjectionMatchSetResponse::isSet() const {
...
bool OAIUpdateSqlInjectionMatchSetResponse::isValid() const {
