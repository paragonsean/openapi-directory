...
/*
 * OAIListSqlInjectionMatchSetsRequest.h
 *
 * A request to list the &lt;a&gt;SqlInjectionMatchSet&lt;/a&gt; objects created by the current AWS account.
 */

#ifndef OAIListSqlInjectionMatchSetsRequest_H
#define OAIListSqlInjectionMatchSetsRequest_H
...
class OAIListSqlInjectionMatchSetsRequest : public OAIObject {
public:
    OAIListSqlInjectionMatchSetsRequest();
    OAIListSqlInjectionMatchSetsRequest(QString json);
    ~OAIListSqlInjectionMatchSetsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListSqlInjectionMatchSetsRequest)

#endif // OAIListSqlInjectionMatchSetsRequest_H
