...
class Example : public QObject {
    Q_OBJECT
    QString create();
    OAICreateByteMatchSetRequest create();
    QString create();
    QString create();
    QString create();
    QString create();
...
QString Example::create(){
    QString obj;
OAICreateByteMatchSetRequest Example::create(){
    OAICreateByteMatchSetRequest obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::createByteMatchSetSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::createByteMatchSetSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAICreateByteMatchSetRequest oai_create_byte_match_set_request = create(); // OAICreateByteMatchSetRequest | 
      ...
      apiInstance.createByteMatchSet(x_amz_targetoai_create_byte_match_set_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
