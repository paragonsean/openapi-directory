...
/*
 * OAIDisableControlOutput.h
 *
 * 
 */

#ifndef OAIDisableControlOutput_H
#define OAIDisableControlOutput_H
...
class OAIDisableControlOutput : public OAIObject {
public:
    OAIDisableControlOutput();
    OAIDisableControlOutput(QString json);
    ~OAIDisableControlOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisableControlOutput)

#endif // OAIDisableControlOutput_H
