...
/*
 * OAIListEnabledControls_request.h
 *
 * 
 */

#ifndef OAIListEnabledControls_request_H
#define OAIListEnabledControls_request_H
...
class OAIListEnabledControls_request : public OAIObject {
public:
    OAIListEnabledControls_request();
    OAIListEnabledControls_request(QString json);
    ~OAIListEnabledControls_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListEnabledControls_request)

#endif // OAIListEnabledControls_request_H
