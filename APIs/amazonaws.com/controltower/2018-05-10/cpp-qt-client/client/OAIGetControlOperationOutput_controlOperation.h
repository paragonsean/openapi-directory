...
/*
 * OAIGetControlOperationOutput_controlOperation.h
 *
 * 
 */

#ifndef OAIGetControlOperationOutput_controlOperation_H
#define OAIGetControlOperationOutput_controlOperation_H
...
class OAIGetControlOperationOutput_controlOperation : public OAIObject {
public:
    OAIGetControlOperationOutput_controlOperation();
    OAIGetControlOperationOutput_controlOperation(QString json);
    ~OAIGetControlOperationOutput_controlOperation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetControlOperationOutput_controlOperation)

#endif // OAIGetControlOperationOutput_controlOperation_H
