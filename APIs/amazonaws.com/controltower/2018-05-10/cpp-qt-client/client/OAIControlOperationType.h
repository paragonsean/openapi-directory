...
/*
 * OAIControlOperationType.h
 *
 * 
 */

#ifndef OAIControlOperationType_H
#define OAIControlOperationType_H
...
class OAIControlOperationType : public OAIEnum {
public:
    OAIControlOperationType();
    OAIControlOperationType(QString json);
    ~OAIControlOperationType() override;
    ...
    enum class eOAIControlOperationType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ENABLE_CONTROL, 
        DISABLE_CONTROL
    };
    OAIControlOperationType::eOAIControlOperationType getValue() const;
    void setValue(const OAIControlOperationType::eOAIControlOperationType& value);
...
private:
    ...
    eOAIControlOperationType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIControlOperationType)

#endif // OAIControlOperationType_H
