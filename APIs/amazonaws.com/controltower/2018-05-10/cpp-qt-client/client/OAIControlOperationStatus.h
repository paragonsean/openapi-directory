...
/*
 * OAIControlOperationStatus.h
 *
 * 
 */

#ifndef OAIControlOperationStatus_H
#define OAIControlOperationStatus_H
...
class OAIControlOperationStatus : public OAIEnum {
public:
    OAIControlOperationStatus();
    OAIControlOperationStatus(QString json);
    ~OAIControlOperationStatus() override;
    ...
    enum class eOAIControlOperationStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        SUCCEEDED, 
        FAILED, 
        IN_PROGRESS
    };
    OAIControlOperationStatus::eOAIControlOperationStatus getValue() const;
    void setValue(const OAIControlOperationStatus::eOAIControlOperationStatus& value);
...
private:
    ...
    eOAIControlOperationStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIControlOperationStatus)

#endif // OAIControlOperationStatus_H
