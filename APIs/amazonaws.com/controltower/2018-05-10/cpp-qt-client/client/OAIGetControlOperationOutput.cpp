...
OAIGetControlOperationOutput::OAIGetControlOperationOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetControlOperationOutput::OAIGetControlOperationOutput() {
    this->initializeModel();
}

OAIGetControlOperationOutput::~OAIGetControlOperationOutput() {}

void OAIGetControlOperationOutput::initializeModel() {

    m_control_operation_isSet = false;
    m_control_operation_isValid = false;
}

void OAIGetControlOperationOutput::fromJson(QString jsonString) {
...
void OAIGetControlOperationOutput::fromJsonObject(QJsonObject json) {

    m_control_operation_isValid = ::OpenAPI::fromJsonValue(m_control_operation, json[QString("controlOperation")]);
    m_control_operation_isSet = !json[QString("controlOperation")].isNull() && m_control_operation_isValid;
}

QString OAIGetControlOperationOutput::asJson() const {
...
QJsonObject OAIGetControlOperationOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_control_operation.isSet()) {
        obj.insert(QString("controlOperation"), ::OpenAPI::toJsonValue(m_control_operation));
    }
    return obj;
}

OAIGetControlOperationOutput_controlOperation OAIGetControlOperationOutput::getControlOperation() const {
    return m_control_operation;
}
void OAIGetControlOperationOutput::setControlOperation(const OAIGetControlOperationOutput_controlOperation &control_operation) {
    m_control_operation = control_operation;
    m_control_operation_isSet = true;
}

bool OAIGetControlOperationOutput::is_control_operation_Set() const{
    return m_control_operation_isSet;
}

bool OAIGetControlOperationOutput::is_control_operation_Valid() const{
    return m_control_operation_isValid;
}

bool OAIGetControlOperationOutput::isSet() const {
...
bool OAIGetControlOperationOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_control_operation_isValid && true;
}
