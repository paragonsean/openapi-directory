...
/*
 * OAIGetControlOperationInput.h
 *
 * 
 */

#ifndef OAIGetControlOperationInput_H
#define OAIGetControlOperationInput_H
...
class OAIGetControlOperationInput : public OAIObject {
public:
    OAIGetControlOperationInput();
    OAIGetControlOperationInput(QString json);
    ~OAIGetControlOperationInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetControlOperationInput)

#endif // OAIGetControlOperationInput_H
