...
/*
 * OAIDisableControlInput.h
 *
 * 
 */

#ifndef OAIDisableControlInput_H
#define OAIDisableControlInput_H
...
class OAIDisableControlInput : public OAIObject {
public:
    OAIDisableControlInput();
    OAIDisableControlInput(QString json);
    ~OAIDisableControlInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisableControlInput)

#endif // OAIDisableControlInput_H
