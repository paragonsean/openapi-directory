...
#include "OAIGetControlOperationInput.h"
...
OAIGetControlOperationInput::OAIGetControlOperationInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetControlOperationInput::OAIGetControlOperationInput() {
    this->initializeModel();
}

OAIGetControlOperationInput::~OAIGetControlOperationInput() {}

void OAIGetControlOperationInput::initializeModel() {

    m_operation_identifier_isSet = false;
    m_operation_identifier_isValid = false;
}

void OAIGetControlOperationInput::fromJson(QString jsonString) {
...
void OAIGetControlOperationInput::fromJsonObject(QJsonObject json) {

    m_operation_identifier_isValid = ::OpenAPI::fromJsonValue(m_operation_identifier, json[QString("operationIdentifier")]);
    m_operation_identifier_isSet = !json[QString("operationIdentifier")].isNull() && m_operation_identifier_isValid;
}

QString OAIGetControlOperationInput::asJson() const {
...
QJsonObject OAIGetControlOperationInput::asJsonObject() const {
    QJsonObject obj;
    if (m_operation_identifier_isSet) {
        obj.insert(QString("operationIdentifier"), ::OpenAPI::toJsonValue(m_operation_identifier));
    }
    return obj;
}

QString OAIGetControlOperationInput::getOperationIdentifier() const {
    return m_operation_identifier;
}
void OAIGetControlOperationInput::setOperationIdentifier(const QString &operation_identifier) {
    m_operation_identifier = operation_identifier;
    m_operation_identifier_isSet = true;
}

bool OAIGetControlOperationInput::is_operation_identifier_Set() const{
    return m_operation_identifier_isSet;
}

bool OAIGetControlOperationInput::is_operation_identifier_Valid() const{
    return m_operation_identifier_isValid;
}

bool OAIGetControlOperationInput::isSet() const {
...
bool OAIGetControlOperationInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_operation_identifier_isValid && true;
}
