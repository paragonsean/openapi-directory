...
#include "OAIEnableControlInput.h"
...
OAIEnableControlInput::OAIEnableControlInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEnableControlInput::OAIEnableControlInput() {
    this->initializeModel();
}

OAIEnableControlInput::~OAIEnableControlInput() {}

void OAIEnableControlInput::initializeModel() {
...
void OAIEnableControlInput::fromJson(QString jsonString) {
...
void OAIEnableControlInput::fromJsonObject(QJsonObject json) {
...
QString OAIEnableControlInput::asJson() const {
...
QJsonObject OAIEnableControlInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIEnableControlInput::getControlIdentifier() const {
    return m_control_identifier;
}
void OAIEnableControlInput::setControlIdentifier(const QString &control_identifier) {
    m_control_identifier = control_identifier;
    m_control_identifier_isSet = true;
}

bool OAIEnableControlInput::is_control_identifier_Set() const{
    return m_control_identifier_isSet;
}

bool OAIEnableControlInput::is_control_identifier_Valid() const{
    return m_control_identifier_isValid;
}

QString OAIEnableControlInput::getTargetIdentifier() const {
    return m_target_identifier;
}
void OAIEnableControlInput::setTargetIdentifier(const QString &target_identifier) {
    m_target_identifier = target_identifier;
    m_target_identifier_isSet = true;
}

bool OAIEnableControlInput::is_target_identifier_Set() const{
    return m_target_identifier_isSet;
}

bool OAIEnableControlInput::is_target_identifier_Valid() const{
    return m_target_identifier_isValid;
}

bool OAIEnableControlInput::isSet() const {
...
bool OAIEnableControlInput::isValid() const {
