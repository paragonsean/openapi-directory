...
/*
 * OAIListEnabledControlsOutput.h
 *
 * 
 */

#ifndef OAIListEnabledControlsOutput_H
#define OAIListEnabledControlsOutput_H
...
class OAIListEnabledControlsOutput : public OAIObject {
public:
    OAIListEnabledControlsOutput();
    OAIListEnabledControlsOutput(QString json);
    ~OAIListEnabledControlsOutput() override;
    ...
    QList getEnabledControls() const;
    void setEnabledControls(const QList &enabled_controls);
    bool is_enabled_controls_Set() const;
    bool is_enabled_controls_Valid() const;
...
private:
    ...
    QList m_enabled_controls;
    bool m_enabled_controls_isSet;
    bool m_enabled_controls_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListEnabledControlsOutput)

#endif // OAIListEnabledControlsOutput_H
