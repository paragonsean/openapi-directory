...
OAIDisableControlOutput::OAIDisableControlOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDisableControlOutput::OAIDisableControlOutput() {
    this->initializeModel();
}

OAIDisableControlOutput::~OAIDisableControlOutput() {}

void OAIDisableControlOutput::initializeModel() {

    m_operation_identifier_isSet = false;
    m_operation_identifier_isValid = false;
}

void OAIDisableControlOutput::fromJson(QString jsonString) {
...
void OAIDisableControlOutput::fromJsonObject(QJsonObject json) {
...
QString OAIDisableControlOutput::asJson() const {
...
QJsonObject OAIDisableControlOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDisableControlOutput::getOperationIdentifier() const {
    return m_operation_identifier;
}
void OAIDisableControlOutput::setOperationIdentifier(const QString &operation_identifier) {
    m_operation_identifier = operation_identifier;
    m_operation_identifier_isSet = true;
}

bool OAIDisableControlOutput::is_operation_identifier_Set() const{
    return m_operation_identifier_isSet;
}

bool OAIDisableControlOutput::is_operation_identifier_Valid() const{
    return m_operation_identifier_isValid;
}

bool OAIDisableControlOutput::isSet() const {
...
bool OAIDisableControlOutput::isValid() const {
