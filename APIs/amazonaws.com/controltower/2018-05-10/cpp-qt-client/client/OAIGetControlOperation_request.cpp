...
OAIGetControlOperation_request::OAIGetControlOperation_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetControlOperation_request::OAIGetControlOperation_request() {
    this->initializeModel();
}

OAIGetControlOperation_request::~OAIGetControlOperation_request() {}

void OAIGetControlOperation_request::initializeModel() {

    m_operation_identifier_isSet = false;
    m_operation_identifier_isValid = false;
}

void OAIGetControlOperation_request::fromJson(QString jsonString) {
...
void OAIGetControlOperation_request::fromJsonObject(QJsonObject json) {
...
QString OAIGetControlOperation_request::asJson() const {
...
QJsonObject OAIGetControlOperation_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetControlOperation_request::getOperationIdentifier() const {
    return m_operation_identifier;
}
void OAIGetControlOperation_request::setOperationIdentifier(const QString &operation_identifier) {
    m_operation_identifier = operation_identifier;
    m_operation_identifier_isSet = true;
}

bool OAIGetControlOperation_request::is_operation_identifier_Set() const{
    return m_operation_identifier_isSet;
}

bool OAIGetControlOperation_request::is_operation_identifier_Valid() const{
    return m_operation_identifier_isValid;
}

bool OAIGetControlOperation_request::isSet() const {
...
bool OAIGetControlOperation_request::isValid() const {
