...
#include "OAIGetControlOperationOutput_controlOperation.h"
...
OAIGetControlOperationOutput_controlOperation::OAIGetControlOperationOutput_controlOperation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetControlOperationOutput_controlOperation::OAIGetControlOperationOutput_controlOperation() {
    this->initializeModel();
}

OAIGetControlOperationOutput_controlOperation::~OAIGetControlOperationOutput_controlOperation() {}

void OAIGetControlOperationOutput_controlOperation::initializeModel() {
...
void OAIGetControlOperationOutput_controlOperation::fromJson(QString jsonString) {
...
void OAIGetControlOperationOutput_controlOperation::fromJsonObject(QJsonObject json) {
...
QString OAIGetControlOperationOutput_controlOperation::asJson() const {
...
QJsonObject OAIGetControlOperationOutput_controlOperation::asJsonObject() const {
    QJsonObject obj;
    if (m_end_time_isSet) {
...
QDateTime OAIGetControlOperationOutput_controlOperation::getEndTime() const {
    return m_end_time;
}
void OAIGetControlOperationOutput_controlOperation::setEndTime(const QDateTime &end_time) {
    m_end_time = end_time;
    m_end_time_isSet = true;
}

bool OAIGetControlOperationOutput_controlOperation::is_end_time_Set() const{
    return m_end_time_isSet;
}

bool OAIGetControlOperationOutput_controlOperation::is_end_time_Valid() const{
    return m_end_time_isValid;
}

OAIControlOperationType OAIGetControlOperationOutput_controlOperation::getOperationType() const {
    return m_operation_type;
}
void OAIGetControlOperationOutput_controlOperation::setOperationType(const OAIControlOperationType &operation_type) {
    m_operation_type = operation_type;
    m_operation_type_isSet = true;
}

bool OAIGetControlOperationOutput_controlOperation::is_operation_type_Set() const{
    return m_operation_type_isSet;
}

bool OAIGetControlOperationOutput_controlOperation::is_operation_type_Valid() const{
    return m_operation_type_isValid;
}

QDateTime OAIGetControlOperationOutput_controlOperation::getStartTime() const {
    return m_start_time;
}
void OAIGetControlOperationOutput_controlOperation::setStartTime(const QDateTime &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIGetControlOperationOutput_controlOperation::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIGetControlOperationOutput_controlOperation::is_start_time_Valid() const{
    return m_start_time_isValid;
}

OAIControlOperationStatus OAIGetControlOperationOutput_controlOperation::getStatus() const {
    return m_status;
}
void OAIGetControlOperationOutput_controlOperation::setStatus(const OAIControlOperationStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGetControlOperationOutput_controlOperation::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGetControlOperationOutput_controlOperation::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIGetControlOperationOutput_controlOperation::getStatusMessage() const {
    return m_status_message;
}
void OAIGetControlOperationOutput_controlOperation::setStatusMessage(const QString &status_message) {
    m_status_message = status_message;
    m_status_message_isSet = true;
}

bool OAIGetControlOperationOutput_controlOperation::is_status_message_Set() const{
    return m_status_message_isSet;
}

bool OAIGetControlOperationOutput_controlOperation::is_status_message_Valid() const{
    return m_status_message_isValid;
}

bool OAIGetControlOperationOutput_controlOperation::isSet() const {
...
bool OAIGetControlOperationOutput_controlOperation::isValid() const {
