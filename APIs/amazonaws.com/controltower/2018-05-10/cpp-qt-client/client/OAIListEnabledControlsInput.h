...
/*
 * OAIListEnabledControlsInput.h
 *
 * 
 */

#ifndef OAIListEnabledControlsInput_H
#define OAIListEnabledControlsInput_H
...
class OAIListEnabledControlsInput : public OAIObject {
public:
    OAIListEnabledControlsInput();
    OAIListEnabledControlsInput(QString json);
    ~OAIListEnabledControlsInput() override;
    ...
    void setTargetIdentifier(const QString &target_identifier);
    bool is_target_identifier_Set() const;
    bool is_target_identifier_Valid() const;
...
private:
    ...
    QString m_target_identifier;
    bool m_target_identifier_isSet;
    bool m_target_identifier_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListEnabledControlsInput)

#endif // OAIListEnabledControlsInput_H
