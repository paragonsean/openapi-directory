...
#include "OAIListEnabledControlsInput.h"
...
OAIListEnabledControlsInput::OAIListEnabledControlsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListEnabledControlsInput::OAIListEnabledControlsInput() {
    this->initializeModel();
}

OAIListEnabledControlsInput::~OAIListEnabledControlsInput() {}

void OAIListEnabledControlsInput::initializeModel() {
...
void OAIListEnabledControlsInput::fromJson(QString jsonString) {
...
void OAIListEnabledControlsInput::fromJsonObject(QJsonObject json) {
...
QString OAIListEnabledControlsInput::asJson() const {
...
QJsonObject OAIListEnabledControlsInput::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIListEnabledControlsInput::getMaxResults() const {
    return m_max_results;
}
void OAIListEnabledControlsInput::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListEnabledControlsInput::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListEnabledControlsInput::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListEnabledControlsInput::getNextToken() const {
    return m_next_token;
}
void OAIListEnabledControlsInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListEnabledControlsInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListEnabledControlsInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QString OAIListEnabledControlsInput::getTargetIdentifier() const {
    return m_target_identifier;
}
void OAIListEnabledControlsInput::setTargetIdentifier(const QString &target_identifier) {
    m_target_identifier = target_identifier;
    m_target_identifier_isSet = true;
}

bool OAIListEnabledControlsInput::is_target_identifier_Set() const{
    return m_target_identifier_isSet;
}

bool OAIListEnabledControlsInput::is_target_identifier_Valid() const{
    return m_target_identifier_isValid;
}

bool OAIListEnabledControlsInput::isSet() const {
...
bool OAIListEnabledControlsInput::isValid() const {
