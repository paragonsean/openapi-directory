...
#include "OAIEnabledControlSummary.h"
...
OAIEnabledControlSummary::OAIEnabledControlSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEnabledControlSummary::OAIEnabledControlSummary() {
    this->initializeModel();
}

OAIEnabledControlSummary::~OAIEnabledControlSummary() {}

void OAIEnabledControlSummary::initializeModel() {

    m_control_identifier_isSet = false;
    m_control_identifier_isValid = false;
}

void OAIEnabledControlSummary::fromJson(QString jsonString) {
...
void OAIEnabledControlSummary::fromJsonObject(QJsonObject json) {
...
QString OAIEnabledControlSummary::asJson() const {
...
QJsonObject OAIEnabledControlSummary::asJsonObject() const {
    QJsonObject obj;
...
QString OAIEnabledControlSummary::getControlIdentifier() const {
    return m_control_identifier;
}
void OAIEnabledControlSummary::setControlIdentifier(const QString &control_identifier) {
    m_control_identifier = control_identifier;
    m_control_identifier_isSet = true;
}

bool OAIEnabledControlSummary::is_control_identifier_Set() const{
    return m_control_identifier_isSet;
}

bool OAIEnabledControlSummary::is_control_identifier_Valid() const{
    return m_control_identifier_isValid;
}

bool OAIEnabledControlSummary::isSet() const {
...
bool OAIEnabledControlSummary::isValid() const {
