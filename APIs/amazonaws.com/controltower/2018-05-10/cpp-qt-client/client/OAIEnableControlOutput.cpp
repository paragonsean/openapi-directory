...
OAIEnableControlOutput::OAIEnableControlOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEnableControlOutput::OAIEnableControlOutput() {
    this->initializeModel();
}

OAIEnableControlOutput::~OAIEnableControlOutput() {}

void OAIEnableControlOutput::initializeModel() {

    m_operation_identifier_isSet = false;
    m_operation_identifier_isValid = false;
}

void OAIEnableControlOutput::fromJson(QString jsonString) {
...
void OAIEnableControlOutput::fromJsonObject(QJsonObject json) {
...
QString OAIEnableControlOutput::asJson() const {
...
QJsonObject OAIEnableControlOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIEnableControlOutput::getOperationIdentifier() const {
    return m_operation_identifier;
}
void OAIEnableControlOutput::setOperationIdentifier(const QString &operation_identifier) {
    m_operation_identifier = operation_identifier;
    m_operation_identifier_isSet = true;
}

bool OAIEnableControlOutput::is_operation_identifier_Set() const{
    return m_operation_identifier_isSet;
}

bool OAIEnableControlOutput::is_operation_identifier_Valid() const{
    return m_operation_identifier_isValid;
}

bool OAIEnableControlOutput::isSet() const {
...
bool OAIEnableControlOutput::isValid() const {
