...
#include "OAIDisableControlInput.h"
...
OAIDisableControlInput::OAIDisableControlInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDisableControlInput::OAIDisableControlInput() {
    this->initializeModel();
}

OAIDisableControlInput::~OAIDisableControlInput() {}

void OAIDisableControlInput::initializeModel() {
...
void OAIDisableControlInput::fromJson(QString jsonString) {
...
void OAIDisableControlInput::fromJsonObject(QJsonObject json) {
...
QString OAIDisableControlInput::asJson() const {
...
QJsonObject OAIDisableControlInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDisableControlInput::getControlIdentifier() const {
    return m_control_identifier;
}
void OAIDisableControlInput::setControlIdentifier(const QString &control_identifier) {
    m_control_identifier = control_identifier;
    m_control_identifier_isSet = true;
}

bool OAIDisableControlInput::is_control_identifier_Set() const{
    return m_control_identifier_isSet;
}

bool OAIDisableControlInput::is_control_identifier_Valid() const{
    return m_control_identifier_isValid;
}

QString OAIDisableControlInput::getTargetIdentifier() const {
    return m_target_identifier;
}
void OAIDisableControlInput::setTargetIdentifier(const QString &target_identifier) {
    m_target_identifier = target_identifier;
    m_target_identifier_isSet = true;
}

bool OAIDisableControlInput::is_target_identifier_Set() const{
    return m_target_identifier_isSet;
}

bool OAIDisableControlInput::is_target_identifier_Valid() const{
    return m_target_identifier_isValid;
}

bool OAIDisableControlInput::isSet() const {
...
bool OAIDisableControlInput::isValid() const {
