...
/*
 * OAIGetControlOperationOutput.h
 *
 * 
 */

#ifndef OAIGetControlOperationOutput_H
#define OAIGetControlOperationOutput_H
...
namespace OpenAPI {
class OAIGetControlOperationOutput_controlOperation;

class OAIGetControlOperationOutput : public OAIObject {
public:
    OAIGetControlOperationOutput();
    OAIGetControlOperationOutput(QString json);
    ~OAIGetControlOperationOutput() override;
    ...
    OAIGetControlOperationOutput_controlOperation getControlOperation() const;
    void setControlOperation(const OAIGetControlOperationOutput_controlOperation &control_operation);
    bool is_control_operation_Set() const;
    bool is_control_operation_Valid() const;
...
private:
    ...
    OAIGetControlOperationOutput_controlOperation m_control_operation;
    bool m_control_operation_isSet;
    bool m_control_operation_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetControlOperationOutput)

#endif // OAIGetControlOperationOutput_H
