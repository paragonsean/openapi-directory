...
/*
 * OAIEnableControlOutput.h
 *
 * 
 */

#ifndef OAIEnableControlOutput_H
#define OAIEnableControlOutput_H
...
class OAIEnableControlOutput : public OAIObject {
public:
    OAIEnableControlOutput();
    OAIEnableControlOutput(QString json);
    ~OAIEnableControlOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnableControlOutput)

#endif // OAIEnableControlOutput_H
