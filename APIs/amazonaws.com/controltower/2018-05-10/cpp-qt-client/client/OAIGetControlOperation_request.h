...
/*
 * OAIGetControlOperation_request.h
 *
 * 
 */

#ifndef OAIGetControlOperation_request_H
#define OAIGetControlOperation_request_H
...
class OAIGetControlOperation_request : public OAIObject {
public:
    OAIGetControlOperation_request();
    OAIGetControlOperation_request(QString json);
    ~OAIGetControlOperation_request() override;
    ...
    QString getOperationIdentifier() const;
    void setOperationIdentifier(const QString &operation_identifier);
    bool is_operation_identifier_Set() const;
    bool is_operation_identifier_Valid() const;
...
private:
    ...
    QString m_operation_identifier;
    bool m_operation_identifier_isSet;
    bool m_operation_identifier_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetControlOperation_request)

#endif // OAIGetControlOperation_request_H
