...
/*
 * OAIEnableControlInput.h
 *
 * 
 */

#ifndef OAIEnableControlInput_H
#define OAIEnableControlInput_H
...
class OAIEnableControlInput : public OAIObject {
public:
    OAIEnableControlInput();
    OAIEnableControlInput(QString json);
    ~OAIEnableControlInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnableControlInput)

#endif // OAIEnableControlInput_H
