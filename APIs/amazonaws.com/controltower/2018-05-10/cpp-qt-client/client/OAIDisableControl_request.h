...
/*
 * OAIDisableControl_request.h
 *
 * 
 */

#ifndef OAIDisableControl_request_H
#define OAIDisableControl_request_H
...
class OAIDisableControl_request : public OAIObject {
public:
    OAIDisableControl_request();
    OAIDisableControl_request(QString json);
    ~OAIDisableControl_request() override;
    ...
    QString getControlIdentifier() const;
    void setControlIdentifier(const QString &control_identifier);
    bool is_control_identifier_Set() const;
    bool is_control_identifier_Valid() const;
...
private:
    ...
    QString m_control_identifier;
    bool m_control_identifier_isSet;
    bool m_control_identifier_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisableControl_request)

#endif // OAIDisableControl_request_H
