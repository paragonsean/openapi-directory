...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsControlTower.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    describe('disableControl', function() {
      it('should call disableControl successfully', function(done) {
        //uncomment below and update the code to test disableControl
        //instance.disableControl(function(error) {
    ...
    describe('enableControl', function() {
      it('should call enableControl successfully', function(done) {
        //uncomment below and update the code to test enableControl
        //instance.enableControl(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getControlOperation', function() {
      it('should call getControlOperation successfully', function(done) {
        //uncomment below and update the code to test getControlOperation
        //instance.getControlOperation(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('listEnabledControls', function() {
      it('should call listEnabledControls successfully', function(done) {
        //uncomment below and update the code to test listEnabledControls
        //instance.listEnabledControls(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
