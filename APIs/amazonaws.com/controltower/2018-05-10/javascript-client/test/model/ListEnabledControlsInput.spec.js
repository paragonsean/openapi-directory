...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsControlTower.ListEnabledControlsInput();
  });
  ...
  describe('ListEnabledControlsInput', function() {
    it('should create an instance of ListEnabledControlsInput', function() {
      // uncomment below and update the code to test ListEnabledControlsInput
      //var instance = new AwsControlTower.ListEnabledControlsInput();
      //expect(instance).to.be.a(AwsControlTower.ListEnabledControlsInput);
    });
