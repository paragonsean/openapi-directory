...
(function(root, factory) {
  ...
  describe('ControlOperationStatus', function() {
    it('should create an instance of ControlOperationStatus', function() {
      // uncomment below and update the code to test ControlOperationStatus
      //var instance = new AwsControlTower.ControlOperationStatus();
      //expect(instance).to.be.a(AwsControlTower.ControlOperationStatus);
    });
