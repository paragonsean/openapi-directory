...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsControlTower.ListEnabledControlsOutput();
  });
  ...
  describe('ListEnabledControlsOutput', function() {
    it('should create an instance of ListEnabledControlsOutput', function() {
      // uncomment below and update the code to test ListEnabledControlsOutput
      //var instance = new AwsControlTower.ListEnabledControlsOutput();
      //expect(instance).to.be.a(AwsControlTower.ListEnabledControlsOutput);
    });

    it('should have the property enabledControls (base name: "enabledControls")', function() {
      // uncomment below and update the code to test the property enabledControls
      //var instance = new AwsControlTower.ListEnabledControlsOutput();
