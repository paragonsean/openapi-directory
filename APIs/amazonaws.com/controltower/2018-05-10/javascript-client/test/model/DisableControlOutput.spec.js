...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsControlTower.DisableControlOutput();
  });
  ...
  describe('DisableControlOutput', function() {
    it('should create an instance of DisableControlOutput', function() {
      // uncomment below and update the code to test DisableControlOutput
      //var instance = new AwsControlTower.DisableControlOutput();
      //expect(instance).to.be.a(AwsControlTower.DisableControlOutput);
    });
