...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsControlTower.EnabledControlSummary();
  });
  ...
  describe('EnabledControlSummary', function() {
    it('should create an instance of EnabledControlSummary', function() {
      // uncomment below and update the code to test EnabledControlSummary
      //var instance = new AwsControlTower.EnabledControlSummary();
      //expect(instance).to.be.a(AwsControlTower.EnabledControlSummary);
    });
