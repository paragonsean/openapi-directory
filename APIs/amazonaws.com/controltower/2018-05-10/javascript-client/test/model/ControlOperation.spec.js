...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsControlTower.ControlOperation();
  });
  ...
  describe('ControlOperation', function() {
    it('should create an instance of ControlOperation', function() {
      // uncomment below and update the code to test ControlOperation
      //var instance = new AwsControlTower.ControlOperation();
      //expect(instance).to.be.a(AwsControlTower.ControlOperation);
    });
