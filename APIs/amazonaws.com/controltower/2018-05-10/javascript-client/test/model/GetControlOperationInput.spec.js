...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsControlTower.GetControlOperationInput();
  });
  ...
  describe('GetControlOperationInput', function() {
    it('should create an instance of GetControlOperationInput', function() {
      // uncomment below and update the code to test GetControlOperationInput
      //var instance = new AwsControlTower.GetControlOperationInput();
      //expect(instance).to.be.a(AwsControlTower.GetControlOperationInput);
    });
