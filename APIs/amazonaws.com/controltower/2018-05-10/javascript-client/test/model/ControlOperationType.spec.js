...
(function(root, factory) {
  ...
  describe('ControlOperationType', function() {
    it('should create an instance of ControlOperationType', function() {
      // uncomment below and update the code to test ControlOperationType
      //var instance = new AwsControlTower.ControlOperationType();
      //expect(instance).to.be.a(AwsControlTower.ControlOperationType);
    });
