...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsControlTower.GetControlOperationOutput();
  });
  ...
  describe('GetControlOperationOutput', function() {
    it('should create an instance of GetControlOperationOutput', function() {
      // uncomment below and update the code to test GetControlOperationOutput
      //var instance = new AwsControlTower.GetControlOperationOutput();
      //expect(instance).to.be.a(AwsControlTower.GetControlOperationOutput);
    });

    it('should have the property controlOperation (base name: "controlOperation")', function() {
      // uncomment below and update the code to test the property controlOperation
      //var instance = new AwsControlTower.GetControlOperationOutput();
