...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsControlTower.ListEnabledControlsRequest();
  });
  ...
  describe('ListEnabledControlsRequest', function() {
    it('should create an instance of ListEnabledControlsRequest', function() {
      // uncomment below and update the code to test ListEnabledControlsRequest
      //var instance = new AwsControlTower.ListEnabledControlsRequest();
      //expect(instance).to.be.a(AwsControlTower.ListEnabledControlsRequest);
    });
