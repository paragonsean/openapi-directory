...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsControlTower.DisableControlRequest();
  });
  ...
  describe('DisableControlRequest', function() {
    it('should create an instance of DisableControlRequest', function() {
      // uncomment below and update the code to test DisableControlRequest
      //var instance = new AwsControlTower.DisableControlRequest();
      //expect(instance).to.be.a(AwsControlTower.DisableControlRequest);
    });

    it('should have the property controlIdentifier (base name: "controlIdentifier")', function() {
      // uncomment below and update the code to test the property controlIdentifier
      //var instance = new AwsControlTower.DisableControlRequest();
      //expect(instance).to.be();
    });

    it('should have the property targetIdentifier (base name: "targetIdentifier")', function() {
      // uncomment below and update the code to test the property targetIdentifier
      //var instance = new AwsControlTower.DisableControlRequest();
      //expect(instance).to.be();
    });
