...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsControlTower.DisableControlInput();
  });
  ...
  describe('DisableControlInput', function() {
    it('should create an instance of DisableControlInput', function() {
      // uncomment below and update the code to test DisableControlInput
      //var instance = new AwsControlTower.DisableControlInput();
      //expect(instance).to.be.a(AwsControlTower.DisableControlInput);
    });
