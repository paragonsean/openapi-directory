...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsControlTower.EnableControlInput();
  });
  ...
  describe('EnableControlInput', function() {
    it('should create an instance of EnableControlInput', function() {
      // uncomment below and update the code to test EnableControlInput
      //var instance = new AwsControlTower.EnableControlInput();
      //expect(instance).to.be.a(AwsControlTower.EnableControlInput);
    });
