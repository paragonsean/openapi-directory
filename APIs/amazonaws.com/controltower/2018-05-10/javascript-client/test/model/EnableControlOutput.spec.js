...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsControlTower.EnableControlOutput();
  });
  ...
  describe('EnableControlOutput', function() {
    it('should create an instance of EnableControlOutput', function() {
      // uncomment below and update the code to test EnableControlOutput
      //var instance = new AwsControlTower.EnableControlOutput();
      //expect(instance).to.be.a(AwsControlTower.EnableControlOutput);
    });
