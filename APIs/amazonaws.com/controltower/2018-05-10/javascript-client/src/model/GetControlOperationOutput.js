...
import GetControlOperationOutputControlOperation from './GetControlOperationOutputControlOperation';

/**
 * The GetControlOperationOutput model module.
 * @module model/GetControlOperationOutput
 * @version 2018-05-10
 */
class GetControlOperationOutput {
    /**
     * Constructs a new <code>GetControlOperationOutput</code>.
     * @alias module:model/GetControlOperationOutput
     * @param controlOperation {module:model/GetControlOperationOutputControlOperation} 
     */
    constructor(controlOperation) { 
        
        GetControlOperationOutput.initialize(this, controlOperation);
    }
     ...
     */
    static initialize(obj, controlOperation) { 
        obj['controlOperation'] = controlOperation;
    }

    /**
     * Constructs a <code>GetControlOperationOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetControlOperationOutput} obj Optional instance to populate.
     * @return {module:model/GetControlOperationOutput} The populated <code>GetControlOperationOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetControlOperationOutput();

            if (data.hasOwnProperty('controlOperation')) {
                obj['controlOperation'] = GetControlOperationOutputControlOperation.constructFromObject(data['controlOperation']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetControlOperationOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetControlOperationOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetControlOperationOutput.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `controlOperation`
        if (data['controlOperation']) { // data not null
          GetControlOperationOutputControlOperation.validateJSON(data['controlOperation']);
        }
...
GetControlOperationOutput.RequiredProperties = ["controlOperation"];

/**
 * @member {module:model/GetControlOperationOutputControlOperation} controlOperation
 */
GetControlOperationOutput.prototype['controlOperation'] = undefined;
...
export default GetControlOperationOutput;
