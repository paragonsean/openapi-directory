...
* @readonly
*/
export default class ControlOperationType {
    ...
    /**
    * Returns a <code>ControlOperationType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ControlOperationType} The enum <code>ControlOperationType</code> value.
    */
