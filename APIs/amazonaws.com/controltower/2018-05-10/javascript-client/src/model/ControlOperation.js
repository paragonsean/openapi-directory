...
import ControlOperationStatus from './ControlOperationStatus';
import ControlOperationType from './ControlOperationType';

/**
 * The ControlOperation model module.
 * @module model/ControlOperation
 * @version 2018-05-10
 */
class ControlOperation {
    /**
     * Constructs a new <code>ControlOperation</code>.
     * An operation performed by the control.
     * @alias module:model/ControlOperation
     */
    constructor() { 
        
        ControlOperation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ControlOperation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ControlOperation} obj Optional instance to populate.
     * @return {module:model/ControlOperation} The populated <code>ControlOperation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ControlOperation();

            if (data.hasOwnProperty('endTime')) {
                obj['endTime'] = ApiClient.convertToType(data['endTime'], 'Date');
            }
            if (data.hasOwnProperty('operationType')) {
                obj['operationType'] = ApiClient.convertToType(data['operationType'], ControlOperationType);
            }
            if (data.hasOwnProperty('startTime')) {
                obj['startTime'] = ApiClient.convertToType(data['startTime'], 'Date');
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = ApiClient.convertToType(data['status'], ControlOperationStatus);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ControlOperation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ControlOperation</code>.
     */
    static validateJSON(data) {
        ...
        if (data['operationType']) { // data not null
          ControlOperationType.validateJSON(data['operationType']);
        }
        ...
        if (data['status']) { // data not null
          ControlOperationStatus.validateJSON(data['status']);
        }
 ...
 * @member {Date} endTime
 */
ControlOperation.prototype['endTime'] = undefined;

/**
 * @member {module:model/ControlOperationType} operationType
 */
ControlOperation.prototype['operationType'] = undefined;

/**
 * @member {Date} startTime
 */
ControlOperation.prototype['startTime'] = undefined;

/**
 * @member {module:model/ControlOperationStatus} status
 */
ControlOperation.prototype['status'] = undefined;

/**
 * @member {String} statusMessage
 */
ControlOperation.prototype['statusMessage'] = undefined;
