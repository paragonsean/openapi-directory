...
/**
 * The GetControlOperationOutputControlOperation model module.
 * @module model/GetControlOperationOutputControlOperation
 * @version 2018-05-10
 */
class GetControlOperationOutputControlOperation {
    /**
     * Constructs a new <code>GetControlOperationOutputControlOperation</code>.
     * @alias module:model/GetControlOperationOutputControlOperation
     * @implements module:model/ControlOperation
     */
    constructor() { 
        ControlOperation.initialize(this);
        GetControlOperationOutputControlOperation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetControlOperationOutputControlOperation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetControlOperationOutputControlOperation} obj Optional instance to populate.
     * @return {module:model/GetControlOperationOutputControlOperation} The populated <code>GetControlOperationOutputControlOperation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetControlOperationOutputControlOperation();
            ControlOperation.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>GetControlOperationOutputControlOperation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetControlOperationOutputControlOperation</code>.
     */
 ...
 * @member {Date} endTime
 */
GetControlOperationOutputControlOperation.prototype['endTime'] = undefined;

/**
 * @member {module:model/ControlOperationType} operationType
 */
GetControlOperationOutputControlOperation.prototype['operationType'] = undefined;

/**
 * @member {Date} startTime
 */
GetControlOperationOutputControlOperation.prototype['startTime'] = undefined;

/**
 * @member {module:model/ControlOperationStatus} status
 */
GetControlOperationOutputControlOperation.prototype['status'] = undefined;

/**
 * @member {String} statusMessage
 */
GetControlOperationOutputControlOperation.prototype['statusMessage'] = undefined;


// Implement ControlOperation interface:
/**
 * @member {Date} endTime
 */
...
export default GetControlOperationOutputControlOperation;
