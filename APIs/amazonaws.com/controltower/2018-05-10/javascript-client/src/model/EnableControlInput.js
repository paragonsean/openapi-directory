...
/**
 * The EnableControlInput model module.
 * @module model/EnableControlInput
 * @version 2018-05-10
 */
class EnableControlInput {
    /**
     * Constructs a new <code>EnableControlInput</code>.
     * @alias module:model/EnableControlInput
     * @param controlIdentifier {String} 
     * @param targetIdentifier {String} 
     */
    constructor(controlIdentifier, targetIdentifier) { 
        
        EnableControlInput.initialize(this, controlIdentifier, targetIdentifier);
    }
    ...
    /**
     * Constructs a <code>EnableControlInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EnableControlInput} obj Optional instance to populate.
     * @return {module:model/EnableControlInput} The populated <code>EnableControlInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EnableControlInput();
    ...
    /**
     * Validates the JSON data with respect to <code>EnableControlInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EnableControlInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EnableControlInput.RequiredProperties) {
...
EnableControlInput.RequiredProperties = ["controlIdentifier", "targetIdentifier"];

/**
 * @member {String} controlIdentifier
 */
EnableControlInput.prototype['controlIdentifier'] = undefined;

/**
 * @member {String} targetIdentifier
 */
EnableControlInput.prototype['targetIdentifier'] = undefined;
...
export default EnableControlInput;
