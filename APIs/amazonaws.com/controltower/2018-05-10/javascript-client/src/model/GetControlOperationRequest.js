...
/**
 * The GetControlOperationRequest model module.
 * @module model/GetControlOperationRequest
 * @version 2018-05-10
 */
class GetControlOperationRequest {
    /**
     * Constructs a new <code>GetControlOperationRequest</code>.
     * @alias module:model/GetControlOperationRequest
     * @param operationIdentifier {String} The ID of the asynchronous operation, which is used to track status. The operation is available for 90 days.
     */
    constructor(operationIdentifier) { 
        
        GetControlOperationRequest.initialize(this, operationIdentifier);
    }
    ...
    /**
     * Constructs a <code>GetControlOperationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetControlOperationRequest} obj Optional instance to populate.
     * @return {module:model/GetControlOperationRequest} The populated <code>GetControlOperationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetControlOperationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetControlOperationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetControlOperationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetControlOperationRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['operationIdentifier'] && !(typeof data['operationIdentifier'] === 'string' || data['operationIdentifier'] instanceof String)) {
            throw new Error("Expected the field `operationIdentifier` to be a primitive type in the JSON string but got " + data['operationIdentifier']);
        }
...
GetControlOperationRequest.RequiredProperties = ["operationIdentifier"];

/**
 * The ID of the asynchronous operation, which is used to track status. The operation is available for 90 days.
 * @member {String} operationIdentifier
 */
GetControlOperationRequest.prototype['operationIdentifier'] = undefined;
...
export default GetControlOperationRequest;
