...
/**
 * The EnableControlOutput model module.
 * @module model/EnableControlOutput
 * @version 2018-05-10
 */
class EnableControlOutput {
    /**
     * Constructs a new <code>EnableControlOutput</code>.
     * @alias module:model/EnableControlOutput
     * @param operationIdentifier {String} 
     */
    constructor(operationIdentifier) { 
        
        EnableControlOutput.initialize(this, operationIdentifier);
    }
    ...
    /**
     * Constructs a <code>EnableControlOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EnableControlOutput} obj Optional instance to populate.
     * @return {module:model/EnableControlOutput} The populated <code>EnableControlOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EnableControlOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>EnableControlOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EnableControlOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EnableControlOutput.RequiredProperties) {
...
EnableControlOutput.RequiredProperties = ["operationIdentifier"];

/**
 * @member {String} operationIdentifier
 */
EnableControlOutput.prototype['operationIdentifier'] = undefined;
...
export default EnableControlOutput;
