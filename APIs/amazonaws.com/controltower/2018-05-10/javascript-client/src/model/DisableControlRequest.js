...
/**
 * The DisableControlRequest model module.
 * @module model/DisableControlRequest
 * @version 2018-05-10
 */
class DisableControlRequest {
    /**
     * Constructs a new <code>DisableControlRequest</code>.
     * @alias module:model/DisableControlRequest
     * @param controlIdentifier {String} The ARN of the control. Only <b>Strongly recommended</b> and <b>Elective</b> controls are permitted, with the exception of the <b>Region deny</b> guardrail.
     * @param targetIdentifier {String} The ARN of the organizational unit.
     */
    constructor(controlIdentifier, targetIdentifier) { 
        
        DisableControlRequest.initialize(this, controlIdentifier, targetIdentifier);
    }
     ...
     */
    static initialize(obj, controlIdentifier, targetIdentifier) { 
        obj['controlIdentifier'] = controlIdentifier;
        obj['targetIdentifier'] = targetIdentifier;
    }

    /**
     * Constructs a <code>DisableControlRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisableControlRequest} obj Optional instance to populate.
     * @return {module:model/DisableControlRequest} The populated <code>DisableControlRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisableControlRequest();

            if (data.hasOwnProperty('controlIdentifier')) {
                obj['controlIdentifier'] = ApiClient.convertToType(data['controlIdentifier'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DisableControlRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisableControlRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DisableControlRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['controlIdentifier'] && !(typeof data['controlIdentifier'] === 'string' || data['controlIdentifier'] instanceof String)) {
            throw new Error("Expected the field `controlIdentifier` to be a primitive type in the JSON string but got " + data['controlIdentifier']);
        }
        // ensure the json data is a string
...
DisableControlRequest.RequiredProperties = ["controlIdentifier", "targetIdentifier"];
 ...
 */
DisableControlRequest.prototype['controlIdentifier'] = undefined;

/**
 * The ARN of the organizational unit.
 * @member {String} targetIdentifier
 */
DisableControlRequest.prototype['targetIdentifier'] = undefined;
...
export default DisableControlRequest;
