...
/**
 * The GetControlOperationInput model module.
 * @module model/GetControlOperationInput
 * @version 2018-05-10
 */
class GetControlOperationInput {
    /**
     * Constructs a new <code>GetControlOperationInput</code>.
     * @alias module:model/GetControlOperationInput
     * @param operationIdentifier {String} 
     */
    constructor(operationIdentifier) { 
        
        GetControlOperationInput.initialize(this, operationIdentifier);
    }
    ...
    /**
     * Constructs a <code>GetControlOperationInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetControlOperationInput} obj Optional instance to populate.
     * @return {module:model/GetControlOperationInput} The populated <code>GetControlOperationInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetControlOperationInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetControlOperationInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetControlOperationInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetControlOperationInput.RequiredProperties) {
...
GetControlOperationInput.RequiredProperties = ["operationIdentifier"];

/**
 * @member {String} operationIdentifier
 */
GetControlOperationInput.prototype['operationIdentifier'] = undefined;
...
export default GetControlOperationInput;
