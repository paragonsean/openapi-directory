...
/**
 * The ListEnabledControlsOutput model module.
 * @module model/ListEnabledControlsOutput
 * @version 2018-05-10
 */
class ListEnabledControlsOutput {
    /**
     * Constructs a new <code>ListEnabledControlsOutput</code>.
     * @alias module:model/ListEnabledControlsOutput
     * @param enabledControls {Array} 
     */
    constructor(enabledControls) { 
        
        ListEnabledControlsOutput.initialize(this, enabledControls);
    }
     ...
     */
    static initialize(obj, enabledControls) { 
        obj['enabledControls'] = enabledControls;
    }

    /**
     * Constructs a <code>ListEnabledControlsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListEnabledControlsOutput} obj Optional instance to populate.
     * @return {module:model/ListEnabledControlsOutput} The populated <code>ListEnabledControlsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListEnabledControlsOutput();

            if (data.hasOwnProperty('enabledControls')) {
                obj['enabledControls'] = ApiClient.convertToType(data['enabledControls'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListEnabledControlsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListEnabledControlsOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListEnabledControlsOutput.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `enabledControls`
        if (data['enabledControls']) { // data not null
          Array.validateJSON(data['enabledControls']);
        }
...
ListEnabledControlsOutput.RequiredProperties = ["enabledControls"];

/**
 * @member {Array} enabledControls
 */
ListEnabledControlsOutput.prototype['enabledControls'] = undefined;

/**
 * @member {String} nextToken
 */
ListEnabledControlsOutput.prototype['nextToken'] = undefined;
...
export default ListEnabledControlsOutput;
