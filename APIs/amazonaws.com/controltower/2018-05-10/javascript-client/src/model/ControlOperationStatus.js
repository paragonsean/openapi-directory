...
* @readonly
*/
export default class ControlOperationStatus {
    ...
    /**
    * Returns a <code>ControlOperationStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ControlOperationStatus} The enum <code>ControlOperationStatus</code> value.
    */
