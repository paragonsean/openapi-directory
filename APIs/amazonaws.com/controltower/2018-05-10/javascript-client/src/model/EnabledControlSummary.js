...
/**
 * The EnabledControlSummary model module.
 * @module model/EnabledControlSummary
 * @version 2018-05-10
 */
class EnabledControlSummary {
    /**
     * Constructs a new <code>EnabledControlSummary</code>.
     * A summary of enabled controls.
     * @alias module:model/EnabledControlSummary
     */
    constructor() { 
        
        EnabledControlSummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EnabledControlSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EnabledControlSummary} obj Optional instance to populate.
     * @return {module:model/EnabledControlSummary} The populated <code>EnabledControlSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EnabledControlSummary();
    ...
    /**
     * Validates the JSON data with respect to <code>EnabledControlSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EnabledControlSummary</code>.
     */
    static validateJSON(data) {
        // validate the optional field `controlIdentifier`
        if (data['controlIdentifier']) { // data not null
          String.validateJSON(data['controlIdentifier']);
        }
 ...
 */
EnabledControlSummary.prototype['controlIdentifier'] = undefined;
...
export default EnabledControlSummary;
