...
/**
 * The DisableControlInput model module.
 * @module model/DisableControlInput
 * @version 2018-05-10
 */
class DisableControlInput {
    /**
     * Constructs a new <code>DisableControlInput</code>.
     * @alias module:model/DisableControlInput
     * @param controlIdentifier {String} 
     * @param targetIdentifier {String} 
     */
    constructor(controlIdentifier, targetIdentifier) { 
        
        DisableControlInput.initialize(this, controlIdentifier, targetIdentifier);
    }
    ...
    /**
     * Constructs a <code>DisableControlInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisableControlInput} obj Optional instance to populate.
     * @return {module:model/DisableControlInput} The populated <code>DisableControlInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisableControlInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DisableControlInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisableControlInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DisableControlInput.RequiredProperties) {
...
DisableControlInput.RequiredProperties = ["controlIdentifier", "targetIdentifier"];

/**
 * @member {String} controlIdentifier
 */
DisableControlInput.prototype['controlIdentifier'] = undefined;

/**
 * @member {String} targetIdentifier
 */
DisableControlInput.prototype['targetIdentifier'] = undefined;
...
export default DisableControlInput;
