...
public class ControlOperation {
  ...
  public ControlOperation endTime(OffsetDateTime endTime) {
  ...
  public ControlOperation operationType(ControlOperationType operationType) {
  ...
  public ControlOperation startTime(OffsetDateTime startTime) {
  ...
  public ControlOperation status(ControlOperationStatus status) {
    this.status = status;
    return this;
  }
  ...
  public ControlOperation statusMessage(String statusMessage) {
  ...
  public boolean equals(Object o) {
    ...
    ControlOperation controlOperation = (ControlOperation) o;
    return Objects.equals(this.endTime, controlOperation.endTime) &&
        Objects.equals(this.operationType, controlOperation.operationType) &&
        Objects.equals(this.startTime, controlOperation.startTime) &&
        Objects.equals(this.status, controlOperation.status) &&
        Objects.equals(this.statusMessage, controlOperation.statusMessage);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ControlOperation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ControlOperation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ControlOperation is not found in the empty JSON string", ControlOperation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ControlOperation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ControlOperation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ControlOperation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ControlOperation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ControlOperation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ControlOperation.class));

       return (TypeAdapter<T>) new TypeAdapter<ControlOperation>() {
           @Override
           public void write(JsonWriter out, ControlOperation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ControlOperation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ControlOperation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ControlOperation
   * @throws IOException if the JSON string is invalid with respect to ControlOperation
   */
  public static ControlOperation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ControlOperation.class);
  }

  /**
   * Convert an instance of ControlOperation to an JSON string
   *
   * @return JSON string
   */
