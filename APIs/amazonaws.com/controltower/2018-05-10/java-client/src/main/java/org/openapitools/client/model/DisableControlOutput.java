...
public class DisableControlOutput {
  ...
  public DisableControlOutput() {
  }

  public DisableControlOutput operationIdentifier(String operationIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    DisableControlOutput disableControlOutput = (DisableControlOutput) o;
    return Objects.equals(this.operationIdentifier, disableControlOutput.operationIdentifier);
  }
  ...
  public String toString() {
    ...
    sb.append("class DisableControlOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisableControlOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisableControlOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisableControlOutput is not found in the empty JSON string", DisableControlOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisableControlOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisableControlOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DisableControlOutput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisableControlOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisableControlOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisableControlOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisableControlOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<DisableControlOutput>() {
           @Override
           public void write(JsonWriter out, DisableControlOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisableControlOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisableControlOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisableControlOutput
   * @throws IOException if the JSON string is invalid with respect to DisableControlOutput
   */
  public static DisableControlOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisableControlOutput.class);
  }

  /**
   * Convert an instance of DisableControlOutput to an JSON string
   *
   * @return JSON string
   */
