...
/**
 * Gets or Sets ControlOperationType
 */
@JsonAdapter(ControlOperationType.Adapter.class)
public enum ControlOperationType {
  ...
  ControlOperationType(String value) {
    this.value = value;
  }
  ...
  public static ControlOperationType fromValue(String value) {
    for (ControlOperationType b : ControlOperationType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ControlOperationType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ControlOperationType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ControlOperationType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ControlOperationType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ControlOperationType.fromValue(value);
  }
}
