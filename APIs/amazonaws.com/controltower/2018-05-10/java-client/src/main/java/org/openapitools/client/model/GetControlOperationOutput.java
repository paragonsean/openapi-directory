...
public class GetControlOperationOutput {
  public static final String SERIALIZED_NAME_CONTROL_OPERATION = "controlOperation";
  @SerializedName(SERIALIZED_NAME_CONTROL_OPERATION)
  private GetControlOperationOutputControlOperation controlOperation;

  public GetControlOperationOutput() {
  }

  public GetControlOperationOutput controlOperation(GetControlOperationOutputControlOperation controlOperation) {
  ...
  public GetControlOperationOutputControlOperation getControlOperation() {
    return controlOperation;
  }

  public void setControlOperation(GetControlOperationOutputControlOperation controlOperation) {
    this.controlOperation = controlOperation;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetControlOperationOutput getControlOperationOutput = (GetControlOperationOutput) o;
    return Objects.equals(this.controlOperation, getControlOperationOutput.controlOperation);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetControlOperationOutput {\n");
  ...
  static {
    ...
    openapiFields.add("controlOperation");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("controlOperation");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetControlOperationOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetControlOperationOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetControlOperationOutput is not found in the empty JSON string", GetControlOperationOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetControlOperationOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetControlOperationOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetControlOperationOutput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `controlOperation`
      GetControlOperationOutputControlOperation.validateJsonElement(jsonObj.get("controlOperation"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetControlOperationOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetControlOperationOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetControlOperationOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetControlOperationOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetControlOperationOutput>() {
           @Override
           public void write(JsonWriter out, GetControlOperationOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetControlOperationOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetControlOperationOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetControlOperationOutput
   * @throws IOException if the JSON string is invalid with respect to GetControlOperationOutput
   */
  public static GetControlOperationOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetControlOperationOutput.class);
  }

  /**
   * Convert an instance of GetControlOperationOutput to an JSON string
   *
   * @return JSON string
   */
