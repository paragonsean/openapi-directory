...
public class DisableControlRequest {
  ...
  public DisableControlRequest() {
  }

  public DisableControlRequest controlIdentifier(String controlIdentifier) {
  ...
  public DisableControlRequest targetIdentifier(String targetIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    DisableControlRequest disableControlRequest = (DisableControlRequest) o;
    return Objects.equals(this.controlIdentifier, disableControlRequest.controlIdentifier) &&
        Objects.equals(this.targetIdentifier, disableControlRequest.targetIdentifier);
  }

  @Override
  public int hashCode() {
    return Objects.hash(controlIdentifier, targetIdentifier);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("controlIdentifier");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisableControlRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisableControlRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisableControlRequest is not found in the empty JSON string", DisableControlRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisableControlRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisableControlRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DisableControlRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("controlIdentifier").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `controlIdentifier` to be a primitive type in the JSON string but got `%s`", jsonObj.get("controlIdentifier").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisableControlRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisableControlRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisableControlRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisableControlRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DisableControlRequest>() {
           @Override
           public void write(JsonWriter out, DisableControlRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisableControlRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisableControlRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisableControlRequest
   * @throws IOException if the JSON string is invalid with respect to DisableControlRequest
   */
  public static DisableControlRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisableControlRequest.class);
  }

  /**
   * Convert an instance of DisableControlRequest to an JSON string
   *
   * @return JSON string
   */
