...
public class DisableControlInput {
  ...
  public DisableControlInput() {
  }

  public DisableControlInput controlIdentifier(String controlIdentifier) {
  ...
  public DisableControlInput targetIdentifier(String targetIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    DisableControlInput disableControlInput = (DisableControlInput) o;
    return Objects.equals(this.controlIdentifier, disableControlInput.controlIdentifier) &&
        Objects.equals(this.targetIdentifier, disableControlInput.targetIdentifier);
  }
  ...
  public String toString() {
    ...
    sb.append("class DisableControlInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisableControlInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisableControlInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisableControlInput is not found in the empty JSON string", DisableControlInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisableControlInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisableControlInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DisableControlInput.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `controlIdentifier`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisableControlInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisableControlInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisableControlInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisableControlInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DisableControlInput>() {
           @Override
           public void write(JsonWriter out, DisableControlInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisableControlInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisableControlInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisableControlInput
   * @throws IOException if the JSON string is invalid with respect to DisableControlInput
   */
  public static DisableControlInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisableControlInput.class);
  }

  /**
   * Convert an instance of DisableControlInput to an JSON string
   *
   * @return JSON string
   */
