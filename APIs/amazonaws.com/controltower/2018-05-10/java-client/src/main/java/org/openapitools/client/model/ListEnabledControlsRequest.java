...
public class ListEnabledControlsRequest {
  ...
  public ListEnabledControlsRequest() {
  }

  public ListEnabledControlsRequest maxResults(Integer maxResults) {
  ...
  public ListEnabledControlsRequest nextToken(String nextToken) {
  ...
  public ListEnabledControlsRequest targetIdentifier(String targetIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    ListEnabledControlsRequest listEnabledControlsRequest = (ListEnabledControlsRequest) o;
    return Objects.equals(this.maxResults, listEnabledControlsRequest.maxResults) &&
        Objects.equals(this.nextToken, listEnabledControlsRequest.nextToken) &&
        Objects.equals(this.targetIdentifier, listEnabledControlsRequest.targetIdentifier);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListEnabledControlsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListEnabledControlsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListEnabledControlsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListEnabledControlsRequest is not found in the empty JSON string", ListEnabledControlsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListEnabledControlsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListEnabledControlsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListEnabledControlsRequest.openapiRequiredFields) {
      ...
      if (!jsonObj.get("targetIdentifier").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `targetIdentifier` to be a primitive type in the JSON string but got `%s`", jsonObj.get("targetIdentifier").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListEnabledControlsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListEnabledControlsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListEnabledControlsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListEnabledControlsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListEnabledControlsRequest>() {
           @Override
           public void write(JsonWriter out, ListEnabledControlsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListEnabledControlsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListEnabledControlsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListEnabledControlsRequest
   * @throws IOException if the JSON string is invalid with respect to ListEnabledControlsRequest
   */
  public static ListEnabledControlsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListEnabledControlsRequest.class);
  }

  /**
   * Convert an instance of ListEnabledControlsRequest to an JSON string
   *
   * @return JSON string
   */
