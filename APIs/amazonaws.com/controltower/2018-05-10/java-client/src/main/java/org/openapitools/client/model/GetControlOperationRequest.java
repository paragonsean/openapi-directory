...
public class GetControlOperationRequest {
  ...
  public GetControlOperationRequest() {
  }

  public GetControlOperationRequest operationIdentifier(String operationIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    GetControlOperationRequest getControlOperationRequest = (GetControlOperationRequest) o;
    return Objects.equals(this.operationIdentifier, getControlOperationRequest.operationIdentifier);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetControlOperationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetControlOperationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetControlOperationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetControlOperationRequest is not found in the empty JSON string", GetControlOperationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetControlOperationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetControlOperationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetControlOperationRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("operationIdentifier").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetControlOperationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetControlOperationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetControlOperationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetControlOperationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetControlOperationRequest>() {
           @Override
           public void write(JsonWriter out, GetControlOperationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetControlOperationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetControlOperationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetControlOperationRequest
   * @throws IOException if the JSON string is invalid with respect to GetControlOperationRequest
   */
  public static GetControlOperationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetControlOperationRequest.class);
  }

  /**
   * Convert an instance of GetControlOperationRequest to an JSON string
   *
   * @return JSON string
   */
