...
public class EnableControlInput {
  ...
  public EnableControlInput() {
  }

  public EnableControlInput controlIdentifier(String controlIdentifier) {
  ...
  public EnableControlInput targetIdentifier(String targetIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    EnableControlInput enableControlInput = (EnableControlInput) o;
    return Objects.equals(this.controlIdentifier, enableControlInput.controlIdentifier) &&
        Objects.equals(this.targetIdentifier, enableControlInput.targetIdentifier);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnableControlInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EnableControlInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EnableControlInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EnableControlInput is not found in the empty JSON string", EnableControlInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EnableControlInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EnableControlInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EnableControlInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EnableControlInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EnableControlInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EnableControlInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EnableControlInput.class));

       return (TypeAdapter<T>) new TypeAdapter<EnableControlInput>() {
           @Override
           public void write(JsonWriter out, EnableControlInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EnableControlInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EnableControlInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EnableControlInput
   * @throws IOException if the JSON string is invalid with respect to EnableControlInput
   */
  public static EnableControlInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EnableControlInput.class);
  }

  /**
   * Convert an instance of EnableControlInput to an JSON string
   *
   * @return JSON string
   */
