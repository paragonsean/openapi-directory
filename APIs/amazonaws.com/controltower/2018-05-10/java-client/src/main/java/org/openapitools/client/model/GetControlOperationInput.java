...
public class GetControlOperationInput {
  ...
  public GetControlOperationInput() {
  }

  public GetControlOperationInput operationIdentifier(String operationIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    GetControlOperationInput getControlOperationInput = (GetControlOperationInput) o;
    return Objects.equals(this.operationIdentifier, getControlOperationInput.operationIdentifier);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetControlOperationInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetControlOperationInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetControlOperationInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetControlOperationInput is not found in the empty JSON string", GetControlOperationInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetControlOperationInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetControlOperationInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetControlOperationInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetControlOperationInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetControlOperationInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetControlOperationInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetControlOperationInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetControlOperationInput>() {
           @Override
           public void write(JsonWriter out, GetControlOperationInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetControlOperationInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetControlOperationInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetControlOperationInput
   * @throws IOException if the JSON string is invalid with respect to GetControlOperationInput
   */
  public static GetControlOperationInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetControlOperationInput.class);
  }

  /**
   * Convert an instance of GetControlOperationInput to an JSON string
   *
   * @return JSON string
   */
