 ...
 */
@JsonAdapter(PeriodUnit.Adapter.class)
public enum PeriodUnit {
  ...
  public static class Adapter extends TypeAdapter<PeriodUnit> {
    @Override
    public void write(final JsonWriter jsonWriter, final PeriodUnit enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PeriodUnit read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PeriodUnit.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PeriodUnit.fromValue(value);
  }
}
