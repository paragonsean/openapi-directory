...
public class GetAWSDefaultServiceQuotaResponseQuota {
  ...
  public GetAWSDefaultServiceQuotaResponseQuota() {
  }

  public GetAWSDefaultServiceQuotaResponseQuota serviceCode(String serviceCode) {
  ...
  public GetAWSDefaultServiceQuotaResponseQuota serviceName(String serviceName) {
  ...
  public GetAWSDefaultServiceQuotaResponseQuota quotaArn(String quotaArn) {
  ...
  public GetAWSDefaultServiceQuotaResponseQuota quotaCode(String quotaCode) {
  ...
  public GetAWSDefaultServiceQuotaResponseQuota quotaName(String quotaName) {
  ...
  public GetAWSDefaultServiceQuotaResponseQuota value(Double value) {
    this.value = value;
    return this;
  }
  ...
  public GetAWSDefaultServiceQuotaResponseQuota unit(String unit) {
    this.unit = unit;
    return this;
  }
  ...
  public GetAWSDefaultServiceQuotaResponseQuota adjustable(Boolean adjustable) {
  ...
  public GetAWSDefaultServiceQuotaResponseQuota globalQuota(Boolean globalQuota) {
  ...
  public GetAWSDefaultServiceQuotaResponseQuota usageMetric(ServiceQuotaUsageMetric usageMetric) {
  ...
  public GetAWSDefaultServiceQuotaResponseQuota period(ServiceQuotaPeriod period) {
    this.period = period;
    return this;
  }
  ...
  public GetAWSDefaultServiceQuotaResponseQuota errorReason(ServiceQuotaErrorReason errorReason) {
  ...
  public boolean equals(Object o) {
    ...
    GetAWSDefaultServiceQuotaResponseQuota getAWSDefaultServiceQuotaResponseQuota = (GetAWSDefaultServiceQuotaResponseQuota) o;
    return Objects.equals(this.serviceCode, getAWSDefaultServiceQuotaResponseQuota.serviceCode) &&
        Objects.equals(this.serviceName, getAWSDefaultServiceQuotaResponseQuota.serviceName) &&
        Objects.equals(this.quotaArn, getAWSDefaultServiceQuotaResponseQuota.quotaArn) &&
        Objects.equals(this.quotaCode, getAWSDefaultServiceQuotaResponseQuota.quotaCode) &&
        Objects.equals(this.quotaName, getAWSDefaultServiceQuotaResponseQuota.quotaName) &&
        Objects.equals(this.value, getAWSDefaultServiceQuotaResponseQuota.value) &&
        Objects.equals(this.unit, getAWSDefaultServiceQuotaResponseQuota.unit) &&
        Objects.equals(this.adjustable, getAWSDefaultServiceQuotaResponseQuota.adjustable) &&
        Objects.equals(this.globalQuota, getAWSDefaultServiceQuotaResponseQuota.globalQuota) &&
        Objects.equals(this.usageMetric, getAWSDefaultServiceQuotaResponseQuota.usageMetric) &&
        Objects.equals(this.period, getAWSDefaultServiceQuotaResponseQuota.period) &&
        Objects.equals(this.errorReason, getAWSDefaultServiceQuotaResponseQuota.errorReason);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetAWSDefaultServiceQuotaResponseQuota {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetAWSDefaultServiceQuotaResponseQuota
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetAWSDefaultServiceQuotaResponseQuota.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetAWSDefaultServiceQuotaResponseQuota is not found in the empty JSON string", GetAWSDefaultServiceQuotaResponseQuota.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetAWSDefaultServiceQuotaResponseQuota.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetAWSDefaultServiceQuotaResponseQuota` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetAWSDefaultServiceQuotaResponseQuota.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetAWSDefaultServiceQuotaResponseQuota' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetAWSDefaultServiceQuotaResponseQuota> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetAWSDefaultServiceQuotaResponseQuota.class));

       return (TypeAdapter<T>) new TypeAdapter<GetAWSDefaultServiceQuotaResponseQuota>() {
           @Override
           public void write(JsonWriter out, GetAWSDefaultServiceQuotaResponseQuota value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetAWSDefaultServiceQuotaResponseQuota read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetAWSDefaultServiceQuotaResponseQuota given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetAWSDefaultServiceQuotaResponseQuota
   * @throws IOException if the JSON string is invalid with respect to GetAWSDefaultServiceQuotaResponseQuota
   */
  public static GetAWSDefaultServiceQuotaResponseQuota fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAWSDefaultServiceQuotaResponseQuota.class);
  }

  /**
   * Convert an instance of GetAWSDefaultServiceQuotaResponseQuota to an JSON string
   *
   * @return JSON string
   */
