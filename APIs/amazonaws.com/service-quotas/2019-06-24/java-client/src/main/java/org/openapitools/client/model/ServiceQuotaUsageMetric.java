...
public class ServiceQuotaUsageMetric {
  ...
  public ServiceQuotaUsageMetric() {
  }

  public ServiceQuotaUsageMetric metricNamespace(String metricNamespace) {
  ...
  public ServiceQuotaUsageMetric metricName(String metricName) {
  ...
  public ServiceQuotaUsageMetric metricDimensions(Map metricDimensions) {
  ...
  public ServiceQuotaUsageMetric metricStatisticRecommendation(String metricStatisticRecommendation) {
  ...
  public boolean equals(Object o) {
    ...
    ServiceQuotaUsageMetric serviceQuotaUsageMetric = (ServiceQuotaUsageMetric) o;
    return Objects.equals(this.metricNamespace, serviceQuotaUsageMetric.metricNamespace) &&
        Objects.equals(this.metricName, serviceQuotaUsageMetric.metricName) &&
        Objects.equals(this.metricDimensions, serviceQuotaUsageMetric.metricDimensions) &&
        Objects.equals(this.metricStatisticRecommendation, serviceQuotaUsageMetric.metricStatisticRecommendation);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceQuotaUsageMetric {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServiceQuotaUsageMetric
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServiceQuotaUsageMetric.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServiceQuotaUsageMetric is not found in the empty JSON string", ServiceQuotaUsageMetric.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServiceQuotaUsageMetric.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServiceQuotaUsageMetric` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServiceQuotaUsageMetric.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServiceQuotaUsageMetric' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServiceQuotaUsageMetric> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServiceQuotaUsageMetric.class));

       return (TypeAdapter<T>) new TypeAdapter<ServiceQuotaUsageMetric>() {
           @Override
           public void write(JsonWriter out, ServiceQuotaUsageMetric value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServiceQuotaUsageMetric read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServiceQuotaUsageMetric given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServiceQuotaUsageMetric
   * @throws IOException if the JSON string is invalid with respect to ServiceQuotaUsageMetric
   */
  public static ServiceQuotaUsageMetric fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServiceQuotaUsageMetric.class);
  }

  /**
   * Convert an instance of ServiceQuotaUsageMetric to an JSON string
   *
   * @return JSON string
   */
