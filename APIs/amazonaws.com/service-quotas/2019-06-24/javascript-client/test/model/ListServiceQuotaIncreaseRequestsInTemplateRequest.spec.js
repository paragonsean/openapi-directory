...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceQuotas.ListServiceQuotaIncreaseRequestsInTemplateRequest();
  });
  ...
  describe('ListServiceQuotaIncreaseRequestsInTemplateRequest', function() {
    it('should create an instance of ListServiceQuotaIncreaseRequestsInTemplateRequest', function() {
      // uncomment below and update the code to test ListServiceQuotaIncreaseRequestsInTemplateRequest
      //var instance = new ServiceQuotas.ListServiceQuotaIncreaseRequestsInTemplateRequest();
      //expect(instance).to.be.a(ServiceQuotas.ListServiceQuotaIncreaseRequestsInTemplateRequest);
    });
