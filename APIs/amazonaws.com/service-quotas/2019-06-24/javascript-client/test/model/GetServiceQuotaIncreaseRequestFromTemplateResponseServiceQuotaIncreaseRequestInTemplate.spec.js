...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceQuotas.GetServiceQuotaIncreaseRequestFromTemplateResponseServiceQuotaIncreaseRequestInTemplate();
  });
  ...
  describe('GetServiceQuotaIncreaseRequestFromTemplateResponseServiceQuotaIncreaseRequestInTemplate', function() {
    it('should create an instance of GetServiceQuotaIncreaseRequestFromTemplateResponseServiceQuotaIncreaseRequestInTemplate', function() {
      // uncomment below and update the code to test GetServiceQuotaIncreaseRequestFromTemplateResponseServiceQuotaIncreaseRequestInTemplate
      //var instance = new ServiceQuotas.GetServiceQuotaIncreaseRequestFromTemplateResponseServiceQuotaIncreaseRequestInTemplate();
      //expect(instance).to.be.a(ServiceQuotas.GetServiceQuotaIncreaseRequestFromTemplateResponseServiceQuotaIncreaseRequestInTemplate);
    });
