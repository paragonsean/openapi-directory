...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceQuotas.ServiceQuota();
  });
  ...
  describe('ServiceQuota', function() {
    it('should create an instance of ServiceQuota', function() {
      // uncomment below and update the code to test ServiceQuota
      //var instance = new ServiceQuotas.ServiceQuota();
      //expect(instance).to.be.a(ServiceQuotas.ServiceQuota);
    });
