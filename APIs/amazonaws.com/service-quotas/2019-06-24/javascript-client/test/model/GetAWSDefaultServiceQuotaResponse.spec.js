...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceQuotas.GetAWSDefaultServiceQuotaResponse();
  });
  ...
  describe('GetAWSDefaultServiceQuotaResponse', function() {
    it('should create an instance of GetAWSDefaultServiceQuotaResponse', function() {
      // uncomment below and update the code to test GetAWSDefaultServiceQuotaResponse
      //var instance = new ServiceQuotas.GetAWSDefaultServiceQuotaResponse();
      //expect(instance).to.be.a(ServiceQuotas.GetAWSDefaultServiceQuotaResponse);
    });
