...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceQuotas.GetServiceQuotaRequest();
  });
  ...
  describe('GetServiceQuotaRequest', function() {
    it('should create an instance of GetServiceQuotaRequest', function() {
      // uncomment below and update the code to test GetServiceQuotaRequest
      //var instance = new ServiceQuotas.GetServiceQuotaRequest();
      //expect(instance).to.be.a(ServiceQuotas.GetServiceQuotaRequest);
    });
