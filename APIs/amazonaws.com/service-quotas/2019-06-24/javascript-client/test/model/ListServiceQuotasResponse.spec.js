...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceQuotas.ListServiceQuotasResponse();
  });
  ...
  describe('ListServiceQuotasResponse', function() {
    it('should create an instance of ListServiceQuotasResponse', function() {
      // uncomment below and update the code to test ListServiceQuotasResponse
      //var instance = new ServiceQuotas.ListServiceQuotasResponse();
      //expect(instance).to.be.a(ServiceQuotas.ListServiceQuotasResponse);
    });
