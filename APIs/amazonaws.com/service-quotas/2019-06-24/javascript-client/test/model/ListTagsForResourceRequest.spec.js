...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceQuotas.ListTagsForResourceRequest();
  });
  ...
  describe('ListTagsForResourceRequest', function() {
    it('should create an instance of ListTagsForResourceRequest', function() {
      ...
      //var instance = new ServiceQuotas.ListTagsForResourceRequest();
      //expect(instance).to.be.a(ServiceQuotas.ListTagsForResourceRequest);
    });
