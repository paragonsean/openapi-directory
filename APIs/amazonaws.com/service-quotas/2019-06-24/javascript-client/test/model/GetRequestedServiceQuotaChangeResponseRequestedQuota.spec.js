...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceQuotas.GetRequestedServiceQuotaChangeResponseRequestedQuota();
  });
  ...
  describe('GetRequestedServiceQuotaChangeResponseRequestedQuota', function() {
    it('should create an instance of GetRequestedServiceQuotaChangeResponseRequestedQuota', function() {
      // uncomment below and update the code to test GetRequestedServiceQuotaChangeResponseRequestedQuota
      //var instance = new ServiceQuotas.GetRequestedServiceQuotaChangeResponseRequestedQuota();
      //expect(instance).to.be.a(ServiceQuotas.GetRequestedServiceQuotaChangeResponseRequestedQuota);
    });
