...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceQuotas.ListServicesResponse();
  });
  ...
  describe('ListServicesResponse', function() {
    it('should create an instance of ListServicesResponse', function() {
      ...
      //var instance = new ServiceQuotas.ListServicesResponse();
      //expect(instance).to.be.a(ServiceQuotas.ListServicesResponse);
    });
