...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceQuotas.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new ServiceQuotas.TagResourceRequest();
      //expect(instance).to.be.a(ServiceQuotas.TagResourceRequest);
    });
