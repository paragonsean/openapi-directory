...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceQuotas.ListTagsForResourceResponse();
  });
  ...
  describe('ListTagsForResourceResponse', function() {
    it('should create an instance of ListTagsForResourceResponse', function() {
      ...
      //var instance = new ServiceQuotas.ListTagsForResourceResponse();
      //expect(instance).to.be.a(ServiceQuotas.ListTagsForResourceResponse);
    });
