...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceQuotas.ListServiceQuotasRequest();
  });
  ...
  describe('ListServiceQuotasRequest', function() {
    it('should create an instance of ListServiceQuotasRequest', function() {
      // uncomment below and update the code to test ListServiceQuotasRequest
      //var instance = new ServiceQuotas.ListServiceQuotasRequest();
      //expect(instance).to.be.a(ServiceQuotas.ListServiceQuotasRequest);
    });
