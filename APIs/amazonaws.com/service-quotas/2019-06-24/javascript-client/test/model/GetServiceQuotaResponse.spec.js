...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceQuotas.GetServiceQuotaResponse();
  });
  ...
  describe('GetServiceQuotaResponse', function() {
    it('should create an instance of GetServiceQuotaResponse', function() {
      // uncomment below and update the code to test GetServiceQuotaResponse
      //var instance = new ServiceQuotas.GetServiceQuotaResponse();
      //expect(instance).to.be.a(ServiceQuotas.GetServiceQuotaResponse);
    });
