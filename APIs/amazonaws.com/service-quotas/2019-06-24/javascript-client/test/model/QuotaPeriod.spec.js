...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceQuotas.QuotaPeriod();
  });
  ...
  describe('QuotaPeriod', function() {
    it('should create an instance of QuotaPeriod', function() {
      // uncomment below and update the code to test QuotaPeriod
      //var instance = new ServiceQuotas.QuotaPeriod();
      //expect(instance).to.be.a(ServiceQuotas.QuotaPeriod);
    });
