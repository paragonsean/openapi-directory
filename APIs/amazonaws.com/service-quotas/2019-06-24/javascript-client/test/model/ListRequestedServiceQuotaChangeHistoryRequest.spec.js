...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceQuotas.ListRequestedServiceQuotaChangeHistoryRequest();
  });
  ...
  describe('ListRequestedServiceQuotaChangeHistoryRequest', function() {
    it('should create an instance of ListRequestedServiceQuotaChangeHistoryRequest', function() {
      // uncomment below and update the code to test ListRequestedServiceQuotaChangeHistoryRequest
      //var instance = new ServiceQuotas.ListRequestedServiceQuotaChangeHistoryRequest();
      //expect(instance).to.be.a(ServiceQuotas.ListRequestedServiceQuotaChangeHistoryRequest);
    });
