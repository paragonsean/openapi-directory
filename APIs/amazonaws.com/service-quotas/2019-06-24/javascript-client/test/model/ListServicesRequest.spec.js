...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceQuotas.ListServicesRequest();
  });
  ...
  describe('ListServicesRequest', function() {
    it('should create an instance of ListServicesRequest', function() {
      ...
      //var instance = new ServiceQuotas.ListServicesRequest();
      //expect(instance).to.be.a(ServiceQuotas.ListServicesRequest);
    });
