...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceQuotas.GetRequestedServiceQuotaChangeRequest();
  });
  ...
  describe('GetRequestedServiceQuotaChangeRequest', function() {
    it('should create an instance of GetRequestedServiceQuotaChangeRequest', function() {
      // uncomment below and update the code to test GetRequestedServiceQuotaChangeRequest
      //var instance = new ServiceQuotas.GetRequestedServiceQuotaChangeRequest();
      //expect(instance).to.be.a(ServiceQuotas.GetRequestedServiceQuotaChangeRequest);
    });
