...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceQuotas.DeleteServiceQuotaIncreaseRequestFromTemplateRequest();
  });
  ...
  describe('DeleteServiceQuotaIncreaseRequestFromTemplateRequest', function() {
    it('should create an instance of DeleteServiceQuotaIncreaseRequestFromTemplateRequest', function() {
      // uncomment below and update the code to test DeleteServiceQuotaIncreaseRequestFromTemplateRequest
      //var instance = new ServiceQuotas.DeleteServiceQuotaIncreaseRequestFromTemplateRequest();
      //expect(instance).to.be.a(ServiceQuotas.DeleteServiceQuotaIncreaseRequestFromTemplateRequest);
    });
