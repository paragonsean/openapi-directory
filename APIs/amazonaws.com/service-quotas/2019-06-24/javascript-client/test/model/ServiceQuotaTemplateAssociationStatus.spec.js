...
(function(root, factory) {
  ...
  describe('ServiceQuotaTemplateAssociationStatus', function() {
    it('should create an instance of ServiceQuotaTemplateAssociationStatus', function() {
      // uncomment below and update the code to test ServiceQuotaTemplateAssociationStatus
      //var instance = new ServiceQuotas.ServiceQuotaTemplateAssociationStatus();
      //expect(instance).to.be.a(ServiceQuotas.ServiceQuotaTemplateAssociationStatus);
    });
