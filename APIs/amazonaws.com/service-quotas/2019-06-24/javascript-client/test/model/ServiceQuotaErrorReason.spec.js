...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceQuotas.ServiceQuotaErrorReason();
  });
  ...
  describe('ServiceQuotaErrorReason', function() {
    it('should create an instance of ServiceQuotaErrorReason', function() {
      // uncomment below and update the code to test ServiceQuotaErrorReason
      //var instance = new ServiceQuotas.ServiceQuotaErrorReason();
      //expect(instance).to.be.a(ServiceQuotas.ServiceQuotaErrorReason);
    });
