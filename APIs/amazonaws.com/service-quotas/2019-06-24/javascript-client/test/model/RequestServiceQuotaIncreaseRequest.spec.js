...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceQuotas.RequestServiceQuotaIncreaseRequest();
  });
  ...
  describe('RequestServiceQuotaIncreaseRequest', function() {
    it('should create an instance of RequestServiceQuotaIncreaseRequest', function() {
      // uncomment below and update the code to test RequestServiceQuotaIncreaseRequest
      //var instance = new ServiceQuotas.RequestServiceQuotaIncreaseRequest();
      //expect(instance).to.be.a(ServiceQuotas.RequestServiceQuotaIncreaseRequest);
    });
