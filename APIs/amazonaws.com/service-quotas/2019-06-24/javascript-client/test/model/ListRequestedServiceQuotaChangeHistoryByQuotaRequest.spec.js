...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceQuotas.ListRequestedServiceQuotaChangeHistoryByQuotaRequest();
  });
  ...
  describe('ListRequestedServiceQuotaChangeHistoryByQuotaRequest', function() {
    it('should create an instance of ListRequestedServiceQuotaChangeHistoryByQuotaRequest', function() {
      // uncomment below and update the code to test ListRequestedServiceQuotaChangeHistoryByQuotaRequest
      //var instance = new ServiceQuotas.ListRequestedServiceQuotaChangeHistoryByQuotaRequest();
      //expect(instance).to.be.a(ServiceQuotas.ListRequestedServiceQuotaChangeHistoryByQuotaRequest);
    });
