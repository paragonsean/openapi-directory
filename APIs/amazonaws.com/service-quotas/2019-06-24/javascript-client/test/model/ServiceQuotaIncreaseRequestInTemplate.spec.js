...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceQuotas.ServiceQuotaIncreaseRequestInTemplate();
  });
  ...
  describe('ServiceQuotaIncreaseRequestInTemplate', function() {
    it('should create an instance of ServiceQuotaIncreaseRequestInTemplate', function() {
      // uncomment below and update the code to test ServiceQuotaIncreaseRequestInTemplate
      //var instance = new ServiceQuotas.ServiceQuotaIncreaseRequestInTemplate();
      //expect(instance).to.be.a(ServiceQuotas.ServiceQuotaIncreaseRequestInTemplate);
    });
