...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceQuotas.PutServiceQuotaIncreaseRequestIntoTemplateRequest();
  });
  ...
  describe('PutServiceQuotaIncreaseRequestIntoTemplateRequest', function() {
    it('should create an instance of PutServiceQuotaIncreaseRequestIntoTemplateRequest', function() {
      // uncomment below and update the code to test PutServiceQuotaIncreaseRequestIntoTemplateRequest
      //var instance = new ServiceQuotas.PutServiceQuotaIncreaseRequestIntoTemplateRequest();
      //expect(instance).to.be.a(ServiceQuotas.PutServiceQuotaIncreaseRequestIntoTemplateRequest);
    });
