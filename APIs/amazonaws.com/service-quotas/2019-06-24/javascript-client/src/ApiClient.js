...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://servicequotas.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://servicequotas.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2019-06-24/Javascript'
        };
