...
/**
 * The ErrorReason model module.
 * @module model/ErrorReason
 * @version 2019-06-24
 */
class ErrorReason {
    /**
     * Constructs a new <code>ErrorReason</code>.
     * An error that explains why an action did not succeed.
     * @alias module:model/ErrorReason
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ErrorReason</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ErrorReason} obj Optional instance to populate.
     * @return {module:model/ErrorReason} The populated <code>ErrorReason</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ErrorReason();
    ...
    /**
     * Validates the JSON data with respect to <code>ErrorReason</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ErrorReason</code>.
     */
