...
async def test_associate_service_quota_template(client):
    """Test case for associate_service_quota_template
...
async def test_delete_service_quota_increase_request_from_template(client):
    """Test case for delete_service_quota_increase_request_from_template

    
    """
    body = {"ServiceCode":"","AwsRegion":"","QuotaCode":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_disassociate_service_quota_template(client):
    """Test case for disassociate_service_quota_template
...
async def test_get_association_for_service_quota_template(client):
    """Test case for get_association_for_service_quota_template
...
async def test_get_aws_default_service_quota(client):
    """Test case for get_aws_default_service_quota

    
    """
    body = {"ServiceCode":"","QuotaCode":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_get_requested_service_quota_change(client):
    """Test case for get_requested_service_quota_change
...
async def test_get_service_quota(client):
    """Test case for get_service_quota
...
async def test_get_service_quota_increase_request_from_template(client):
    """Test case for get_service_quota_increase_request_from_template
...
async def test_list_aws_default_service_quotas(client):
    """Test case for list_aws_default_service_quotas

    
    """
    body = {"ServiceCode":"","NextToken":"","MaxResults":""}
...
async def test_list_requested_service_quota_change_history(client):
    """Test case for list_requested_service_quota_change_history

    
    """
    body = {"Status":"","ServiceCode":"","NextToken":"","MaxResults":""}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_requested_service_quota_change_history_by_quota(client):
    """Test case for list_requested_service_quota_change_history_by_quota

    
    """
    body = {"Status":"","ServiceCode":"","NextToken":"","MaxResults":"","QuotaCode":""}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_service_quota_increase_requests_in_template(client):
    """Test case for list_service_quota_increase_requests_in_template

    
    """
    body = {"ServiceCode":"","AwsRegion":"","NextToken":"","MaxResults":""}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_service_quotas(client):
    """Test case for list_service_quotas
...
async def test_put_service_quota_increase_request_into_template(client):
    """Test case for put_service_quota_increase_request_into_template

    
    """
    body = {"ServiceCode":"","AwsRegion":"","DesiredValue":"","QuotaCode":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_request_service_quota_increase(client):
    """Test case for request_service_quota_increase

    
    """
    body = {"ServiceCode":"","DesiredValue":"","QuotaCode":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
