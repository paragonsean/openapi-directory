...
OAIMetricInfo::OAIMetricInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMetricInfo::OAIMetricInfo() {
    this->initializeModel();
}

OAIMetricInfo::~OAIMetricInfo() {}

void OAIMetricInfo::initializeModel() {
...
void OAIMetricInfo::fromJson(QString jsonString) {
...
void OAIMetricInfo::fromJsonObject(QJsonObject json) {
...
QString OAIMetricInfo::asJson() const {
...
QJsonObject OAIMetricInfo::asJsonObject() const {
    QJsonObject obj;
...
QString OAIMetricInfo::getMetricNamespace() const {
    return m_metric_namespace;
}
void OAIMetricInfo::setMetricNamespace(const QString &metric_namespace) {
    m_metric_namespace = metric_namespace;
    m_metric_namespace_isSet = true;
}

bool OAIMetricInfo::is_metric_namespace_Set() const{
    return m_metric_namespace_isSet;
}

bool OAIMetricInfo::is_metric_namespace_Valid() const{
    return m_metric_namespace_isValid;
}

QString OAIMetricInfo::getMetricName() const {
    return m_metric_name;
}
void OAIMetricInfo::setMetricName(const QString &metric_name) {
    m_metric_name = metric_name;
    m_metric_name_isSet = true;
}

bool OAIMetricInfo::is_metric_name_Set() const{
    return m_metric_name_isSet;
}

bool OAIMetricInfo::is_metric_name_Valid() const{
    return m_metric_name_isValid;
}

QMap OAIMetricInfo::getMetricDimensions() const {
    return m_metric_dimensions;
}
void OAIMetricInfo::setMetricDimensions(const QMap &metric_dimensions) {
    m_metric_dimensions = metric_dimensions;
    m_metric_dimensions_isSet = true;
}

bool OAIMetricInfo::is_metric_dimensions_Set() const{
    return m_metric_dimensions_isSet;
}

bool OAIMetricInfo::is_metric_dimensions_Valid() const{
    return m_metric_dimensions_isValid;
}

QString OAIMetricInfo::getMetricStatisticRecommendation() const {
    return m_metric_statistic_recommendation;
}
void OAIMetricInfo::setMetricStatisticRecommendation(const QString &metric_statistic_recommendation) {
    m_metric_statistic_recommendation = metric_statistic_recommendation;
    m_metric_statistic_recommendation_isSet = true;
}

bool OAIMetricInfo::is_metric_statistic_recommendation_Set() const{
    return m_metric_statistic_recommendation_isSet;
}

bool OAIMetricInfo::is_metric_statistic_recommendation_Valid() const{
    return m_metric_statistic_recommendation_isValid;
}

bool OAIMetricInfo::isSet() const {
...
bool OAIMetricInfo::isValid() const {
