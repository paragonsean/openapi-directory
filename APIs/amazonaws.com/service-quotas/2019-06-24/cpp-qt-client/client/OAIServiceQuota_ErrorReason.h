...
/*
 * OAIServiceQuota_ErrorReason.h
 *
 * 
 */

#ifndef OAIServiceQuota_ErrorReason_H
#define OAIServiceQuota_ErrorReason_H
...
class OAIServiceQuota_ErrorReason : public OAIObject {
public:
    OAIServiceQuota_ErrorReason();
    OAIServiceQuota_ErrorReason(QString json);
    ~OAIServiceQuota_ErrorReason() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServiceQuota_ErrorReason)

#endif // OAIServiceQuota_ErrorReason_H
