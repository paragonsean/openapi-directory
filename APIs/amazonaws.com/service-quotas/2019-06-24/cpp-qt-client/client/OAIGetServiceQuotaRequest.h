...
/*
 * OAIGetServiceQuotaRequest.h
 *
 * 
 */

#ifndef OAIGetServiceQuotaRequest_H
#define OAIGetServiceQuotaRequest_H
...
class OAIGetServiceQuotaRequest : public OAIObject {
public:
    OAIGetServiceQuotaRequest();
    OAIGetServiceQuotaRequest(QString json);
    ~OAIGetServiceQuotaRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetServiceQuotaRequest)

#endif // OAIGetServiceQuotaRequest_H
