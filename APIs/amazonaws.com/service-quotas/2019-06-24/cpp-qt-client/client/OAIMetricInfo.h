...
#ifndef OAIMetricInfo_H
#define OAIMetricInfo_H
...
class OAIMetricInfo : public OAIObject {
public:
    OAIMetricInfo();
    OAIMetricInfo(QString json);
    ~OAIMetricInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMetricInfo)

#endif // OAIMetricInfo_H
