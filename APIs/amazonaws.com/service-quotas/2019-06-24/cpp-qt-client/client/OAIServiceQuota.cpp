...
OAIServiceQuota::OAIServiceQuota(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIServiceQuota::OAIServiceQuota() {
    this->initializeModel();
}

OAIServiceQuota::~OAIServiceQuota() {}

void OAIServiceQuota::initializeModel() {
...
void OAIServiceQuota::fromJson(QString jsonString) {
...
void OAIServiceQuota::fromJsonObject(QJsonObject json) {
...
QString OAIServiceQuota::asJson() const {
...
QJsonObject OAIServiceQuota::asJsonObject() const {
    QJsonObject obj;
...
QString OAIServiceQuota::getServiceCode() const {
    return m_service_code;
}
void OAIServiceQuota::setServiceCode(const QString &service_code) {
    m_service_code = service_code;
    m_service_code_isSet = true;
}

bool OAIServiceQuota::is_service_code_Set() const{
    return m_service_code_isSet;
}

bool OAIServiceQuota::is_service_code_Valid() const{
    return m_service_code_isValid;
}

QString OAIServiceQuota::getServiceName() const {
    return m_service_name;
}
void OAIServiceQuota::setServiceName(const QString &service_name) {
    m_service_name = service_name;
    m_service_name_isSet = true;
}

bool OAIServiceQuota::is_service_name_Set() const{
    return m_service_name_isSet;
}

bool OAIServiceQuota::is_service_name_Valid() const{
    return m_service_name_isValid;
}

QString OAIServiceQuota::getQuotaArn() const {
    return m_quota_arn;
}
void OAIServiceQuota::setQuotaArn(const QString &quota_arn) {
    m_quota_arn = quota_arn;
    m_quota_arn_isSet = true;
}

bool OAIServiceQuota::is_quota_arn_Set() const{
    return m_quota_arn_isSet;
}

bool OAIServiceQuota::is_quota_arn_Valid() const{
    return m_quota_arn_isValid;
}

QString OAIServiceQuota::getQuotaCode() const {
    return m_quota_code;
}
void OAIServiceQuota::setQuotaCode(const QString &quota_code) {
    m_quota_code = quota_code;
    m_quota_code_isSet = true;
}

bool OAIServiceQuota::is_quota_code_Set() const{
    return m_quota_code_isSet;
}

bool OAIServiceQuota::is_quota_code_Valid() const{
    return m_quota_code_isValid;
}

QString OAIServiceQuota::getQuotaName() const {
    return m_quota_name;
}
void OAIServiceQuota::setQuotaName(const QString &quota_name) {
    m_quota_name = quota_name;
    m_quota_name_isSet = true;
}

bool OAIServiceQuota::is_quota_name_Set() const{
    return m_quota_name_isSet;
}

bool OAIServiceQuota::is_quota_name_Valid() const{
    return m_quota_name_isValid;
}

double OAIServiceQuota::getValue() const {
    return m_value;
}
void OAIServiceQuota::setValue(const double &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIServiceQuota::is_value_Set() const{
    return m_value_isSet;
}

bool OAIServiceQuota::is_value_Valid() const{
    return m_value_isValid;
}

QString OAIServiceQuota::getUnit() const {
    return m_unit;
}
void OAIServiceQuota::setUnit(const QString &unit) {
    m_unit = unit;
    m_unit_isSet = true;
}

bool OAIServiceQuota::is_unit_Set() const{
    return m_unit_isSet;
}

bool OAIServiceQuota::is_unit_Valid() const{
    return m_unit_isValid;
}

bool OAIServiceQuota::getAdjustable() const {
    return m_adjustable;
}
void OAIServiceQuota::setAdjustable(const bool &adjustable) {
    m_adjustable = adjustable;
    m_adjustable_isSet = true;
}

bool OAIServiceQuota::is_adjustable_Set() const{
    return m_adjustable_isSet;
}

bool OAIServiceQuota::is_adjustable_Valid() const{
    return m_adjustable_isValid;
}

bool OAIServiceQuota::getGlobalQuota() const {
    return m_global_quota;
}
void OAIServiceQuota::setGlobalQuota(const bool &global_quota) {
    m_global_quota = global_quota;
    m_global_quota_isSet = true;
}

bool OAIServiceQuota::is_global_quota_Set() const{
    return m_global_quota_isSet;
}

bool OAIServiceQuota::is_global_quota_Valid() const{
    return m_global_quota_isValid;
}

OAIServiceQuota_UsageMetric OAIServiceQuota::getUsageMetric() const {
    return m_usage_metric;
}
void OAIServiceQuota::setUsageMetric(const OAIServiceQuota_UsageMetric &usage_metric) {
    m_usage_metric = usage_metric;
    m_usage_metric_isSet = true;
}

bool OAIServiceQuota::is_usage_metric_Set() const{
    return m_usage_metric_isSet;
}

bool OAIServiceQuota::is_usage_metric_Valid() const{
    return m_usage_metric_isValid;
}

OAIServiceQuota_Period OAIServiceQuota::getPeriod() const {
    return m_period;
}
void OAIServiceQuota::setPeriod(const OAIServiceQuota_Period &period) {
    m_period = period;
    m_period_isSet = true;
}

bool OAIServiceQuota::is_period_Set() const{
    return m_period_isSet;
}

bool OAIServiceQuota::is_period_Valid() const{
    return m_period_isValid;
}

OAIServiceQuota_ErrorReason OAIServiceQuota::getErrorReason() const {
    return m_error_reason;
}
void OAIServiceQuota::setErrorReason(const OAIServiceQuota_ErrorReason &error_reason) {
    m_error_reason = error_reason;
    m_error_reason_isSet = true;
}

bool OAIServiceQuota::is_error_reason_Set() const{
    return m_error_reason_isSet;
}

bool OAIServiceQuota::is_error_reason_Valid() const{
    return m_error_reason_isValid;
}

bool OAIServiceQuota::isSet() const {
...
bool OAIServiceQuota::isValid() const {
