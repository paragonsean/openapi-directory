...
/*
 * OAIListAWSDefaultServiceQuotasRequest.h
 *
 * 
 */

#ifndef OAIListAWSDefaultServiceQuotasRequest_H
#define OAIListAWSDefaultServiceQuotasRequest_H
...
class OAIListAWSDefaultServiceQuotasRequest : public OAIObject {
public:
    OAIListAWSDefaultServiceQuotasRequest();
    OAIListAWSDefaultServiceQuotasRequest(QString json);
    ~OAIListAWSDefaultServiceQuotasRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAWSDefaultServiceQuotasRequest)

#endif // OAIListAWSDefaultServiceQuotasRequest_H
