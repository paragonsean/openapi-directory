...
/*
 * OAIServiceQuota_Period.h
 *
 * 
 */

#ifndef OAIServiceQuota_Period_H
#define OAIServiceQuota_Period_H
...
class OAIServiceQuota_Period : public OAIObject {
public:
    OAIServiceQuota_Period();
    OAIServiceQuota_Period(QString json);
    ~OAIServiceQuota_Period() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServiceQuota_Period)

#endif // OAIServiceQuota_Period_H
