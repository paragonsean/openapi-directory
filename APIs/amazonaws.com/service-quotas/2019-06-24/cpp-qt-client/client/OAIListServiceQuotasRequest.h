...
/*
 * OAIListServiceQuotasRequest.h
 *
 * 
 */

#ifndef OAIListServiceQuotasRequest_H
#define OAIListServiceQuotasRequest_H
...
class OAIListServiceQuotasRequest : public OAIObject {
public:
    OAIListServiceQuotasRequest();
    OAIListServiceQuotasRequest(QString json);
    ~OAIListServiceQuotasRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListServiceQuotasRequest)

#endif // OAIListServiceQuotasRequest_H
