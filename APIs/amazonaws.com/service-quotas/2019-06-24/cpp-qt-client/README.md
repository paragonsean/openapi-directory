...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::associateServiceQuotaTemplateSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::associateServiceQuotaTemplateSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      apiInstance.associateServiceQuotaTemplate(x_amz_targetbodyx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
