...
QString OAIControlPanel::getClusterArn() const {
    return m_cluster_arn;
}
void OAIControlPanel::setClusterArn(const QString &cluster_arn) {
    m_cluster_arn = cluster_arn;
    m_cluster_arn_isSet = true;
}

bool OAIControlPanel::is_cluster_arn_Set() const{
    return m_cluster_arn_isSet;
}

bool OAIControlPanel::is_cluster_arn_Valid() const{
    return m_cluster_arn_isValid;
}

QString OAIControlPanel::getControlPanelArn() const {
    return m_control_panel_arn;
}
void OAIControlPanel::setControlPanelArn(const QString &control_panel_arn) {
    m_control_panel_arn = control_panel_arn;
    m_control_panel_arn_isSet = true;
}

bool OAIControlPanel::is_control_panel_arn_Set() const{
    return m_control_panel_arn_isSet;
}

bool OAIControlPanel::is_control_panel_arn_Valid() const{
    return m_control_panel_arn_isValid;
}

bool OAIControlPanel::getDefaultControlPanel() const {
    return m_default_control_panel;
}
void OAIControlPanel::setDefaultControlPanel(const bool &default_control_panel) {
    m_default_control_panel = default_control_panel;
    m_default_control_panel_isSet = true;
}

bool OAIControlPanel::is_default_control_panel_Set() const{
    return m_default_control_panel_isSet;
}

bool OAIControlPanel::is_default_control_panel_Valid() const{
    return m_default_control_panel_isValid;
}

QString OAIControlPanel::getName() const {
    return m_name;
}
void OAIControlPanel::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIControlPanel::is_name_Set() const{
    return m_name_isSet;
}

bool OAIControlPanel::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAIControlPanel::getRoutingControlCount() const {
    return m_routing_control_count;
}
void OAIControlPanel::setRoutingControlCount(const qint32 &routing_control_count) {
    m_routing_control_count = routing_control_count;
    m_routing_control_count_isSet = true;
}

bool OAIControlPanel::is_routing_control_count_Set() const{
    return m_routing_control_count_isSet;
}

bool OAIControlPanel::is_routing_control_count_Valid() const{
    return m_routing_control_count_isValid;
}

OAIStatus OAIControlPanel::getStatus() const {
    return m_status;
}
void OAIControlPanel::setStatus(const OAIStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIControlPanel::is_status_Set() const{
    return m_status_isSet;
}

bool OAIControlPanel::is_status_Valid() const{
