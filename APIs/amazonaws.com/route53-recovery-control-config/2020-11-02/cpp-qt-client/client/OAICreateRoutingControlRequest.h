...
/*
 * OAICreateRoutingControlRequest.h
 *
 * The details of the routing control that you&#39;re creating.
 */

#ifndef OAICreateRoutingControlRequest_H
#define OAICreateRoutingControlRequest_H
...
class OAICreateRoutingControlRequest : public OAIObject {
public:
    OAICreateRoutingControlRequest();
    OAICreateRoutingControlRequest(QString json);
    ~OAICreateRoutingControlRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRoutingControlRequest)

#endif // OAICreateRoutingControlRequest_H
