...
#ifndef OAIAssertionRule_H
#define OAIAssertionRule_H
...
class OAIAssertionRule : public OAIObject {
public:
    OAIAssertionRule();
    OAIAssertionRule(QString json);
    ~OAIAssertionRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssertionRule)

#endif // OAIAssertionRule_H
