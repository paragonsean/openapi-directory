...
#ifndef OAIRule_ASSERTION_H
#define OAIRule_ASSERTION_H
...
class OAIRule_ASSERTION : public OAIObject {
public:
    OAIRule_ASSERTION();
    OAIRule_ASSERTION(QString json);
    ~OAIRule_ASSERTION() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRule_ASSERTION)

#endif // OAIRule_ASSERTION_H
