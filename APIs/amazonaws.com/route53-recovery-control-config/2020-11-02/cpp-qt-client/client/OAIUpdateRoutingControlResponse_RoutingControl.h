...
/*
 * OAIUpdateRoutingControlResponse_RoutingControl.h
 *
 * 
 */

#ifndef OAIUpdateRoutingControlResponse_RoutingControl_H
#define OAIUpdateRoutingControlResponse_RoutingControl_H
...
class OAIUpdateRoutingControlResponse_RoutingControl : public OAIObject {
public:
    OAIUpdateRoutingControlResponse_RoutingControl();
    OAIUpdateRoutingControlResponse_RoutingControl(QString json);
    ~OAIUpdateRoutingControlResponse_RoutingControl() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRoutingControlResponse_RoutingControl)

#endif // OAIUpdateRoutingControlResponse_RoutingControl_H
