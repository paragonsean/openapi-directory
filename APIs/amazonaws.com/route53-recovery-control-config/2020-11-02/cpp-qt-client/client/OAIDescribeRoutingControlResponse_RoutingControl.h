...
/*
 * OAIDescribeRoutingControlResponse_RoutingControl.h
 *
 * 
 */

#ifndef OAIDescribeRoutingControlResponse_RoutingControl_H
#define OAIDescribeRoutingControlResponse_RoutingControl_H
...
class OAIDescribeRoutingControlResponse_RoutingControl : public OAIObject {
public:
    OAIDescribeRoutingControlResponse_RoutingControl();
    OAIDescribeRoutingControlResponse_RoutingControl(QString json);
    ~OAIDescribeRoutingControlResponse_RoutingControl() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeRoutingControlResponse_RoutingControl)

#endif // OAIDescribeRoutingControlResponse_RoutingControl_H
