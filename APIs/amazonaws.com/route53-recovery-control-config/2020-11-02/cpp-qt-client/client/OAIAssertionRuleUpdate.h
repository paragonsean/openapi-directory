...
#ifndef OAIAssertionRuleUpdate_H
#define OAIAssertionRuleUpdate_H
...
class OAIAssertionRuleUpdate : public OAIObject {
public:
    OAIAssertionRuleUpdate();
    OAIAssertionRuleUpdate(QString json);
    ~OAIAssertionRuleUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssertionRuleUpdate)

#endif // OAIAssertionRuleUpdate_H
