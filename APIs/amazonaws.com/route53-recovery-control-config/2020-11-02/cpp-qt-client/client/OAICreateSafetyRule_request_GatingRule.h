...
/*
 * OAICreateSafetyRule_request_GatingRule.h
 *
 * A new gating rule for a control panel.
 */

#ifndef OAICreateSafetyRule_request_GatingRule_H
#define OAICreateSafetyRule_request_GatingRule_H
...
class OAICreateSafetyRule_request_GatingRule : public OAIObject {
public:
    OAICreateSafetyRule_request_GatingRule();
    OAICreateSafetyRule_request_GatingRule(QString json);
    ~OAICreateSafetyRule_request_GatingRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSafetyRule_request_GatingRule)

#endif // OAICreateSafetyRule_request_GatingRule_H
