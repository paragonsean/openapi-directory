...
/*
 * OAIUpdateSafetyRule_request_AssertionRuleUpdate.h
 *
...
#ifndef OAIUpdateSafetyRule_request_AssertionRuleUpdate_H
#define OAIUpdateSafetyRule_request_AssertionRuleUpdate_H
...
class OAIUpdateSafetyRule_request_AssertionRuleUpdate : public OAIObject {
public:
    OAIUpdateSafetyRule_request_AssertionRuleUpdate();
    OAIUpdateSafetyRule_request_AssertionRuleUpdate(QString json);
    ~OAIUpdateSafetyRule_request_AssertionRuleUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSafetyRule_request_AssertionRuleUpdate)

#endif // OAIUpdateSafetyRule_request_AssertionRuleUpdate_H
