...
/*
 * OAICreateSafetyRuleRequest_GatingRule.h
 *
 * 
 */

#ifndef OAICreateSafetyRuleRequest_GatingRule_H
#define OAICreateSafetyRuleRequest_GatingRule_H
...
class OAICreateSafetyRuleRequest_GatingRule : public OAIObject {
public:
    OAICreateSafetyRuleRequest_GatingRule();
    OAICreateSafetyRuleRequest_GatingRule(QString json);
    ~OAICreateSafetyRuleRequest_GatingRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSafetyRuleRequest_GatingRule)

#endif // OAICreateSafetyRuleRequest_GatingRule_H
