...
/*
 * OAIDescribeSafetyRuleResponse_GatingRule.h
 *
 * 
 */

#ifndef OAIDescribeSafetyRuleResponse_GatingRule_H
#define OAIDescribeSafetyRuleResponse_GatingRule_H
...
class OAIDescribeSafetyRuleResponse_GatingRule : public OAIObject {
public:
    OAIDescribeSafetyRuleResponse_GatingRule();
    OAIDescribeSafetyRuleResponse_GatingRule(QString json);
    ~OAIDescribeSafetyRuleResponse_GatingRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSafetyRuleResponse_GatingRule)

#endif // OAIDescribeSafetyRuleResponse_GatingRule_H
