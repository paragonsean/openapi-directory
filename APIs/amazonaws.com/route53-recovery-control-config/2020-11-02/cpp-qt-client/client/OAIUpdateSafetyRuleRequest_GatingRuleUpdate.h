...
/*
 * OAIUpdateSafetyRuleRequest_GatingRuleUpdate.h
 *
 * 
 */

#ifndef OAIUpdateSafetyRuleRequest_GatingRuleUpdate_H
#define OAIUpdateSafetyRuleRequest_GatingRuleUpdate_H
...
class OAIUpdateSafetyRuleRequest_GatingRuleUpdate : public OAIObject {
public:
    OAIUpdateSafetyRuleRequest_GatingRuleUpdate();
    OAIUpdateSafetyRuleRequest_GatingRuleUpdate(QString json);
    ~OAIUpdateSafetyRuleRequest_GatingRuleUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSafetyRuleRequest_GatingRuleUpdate)

#endif // OAIUpdateSafetyRuleRequest_GatingRuleUpdate_H
