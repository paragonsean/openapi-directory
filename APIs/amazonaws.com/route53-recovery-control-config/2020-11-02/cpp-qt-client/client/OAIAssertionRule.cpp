...
OAIAssertionRule::OAIAssertionRule(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssertionRule::OAIAssertionRule() {
    this->initializeModel();
}

OAIAssertionRule::~OAIAssertionRule() {}

void OAIAssertionRule::initializeModel() {
...
void OAIAssertionRule::fromJson(QString jsonString) {
...
void OAIAssertionRule::fromJsonObject(QJsonObject json) {
...
QString OAIAssertionRule::asJson() const {
...
QJsonObject OAIAssertionRule::asJsonObject() const {
    QJsonObject obj;
...
QList OAIAssertionRule::getAssertedControls() const {
    return m_asserted_controls;
}
void OAIAssertionRule::setAssertedControls(const QList &asserted_controls) {
    m_asserted_controls = asserted_controls;
    m_asserted_controls_isSet = true;
}

bool OAIAssertionRule::is_asserted_controls_Set() const{
    return m_asserted_controls_isSet;
}

bool OAIAssertionRule::is_asserted_controls_Valid() const{
    return m_asserted_controls_isValid;
}

QString OAIAssertionRule::getControlPanelArn() const {
    return m_control_panel_arn;
}
void OAIAssertionRule::setControlPanelArn(const QString &control_panel_arn) {
    m_control_panel_arn = control_panel_arn;
    m_control_panel_arn_isSet = true;
}

bool OAIAssertionRule::is_control_panel_arn_Set() const{
    return m_control_panel_arn_isSet;
}

bool OAIAssertionRule::is_control_panel_arn_Valid() const{
    return m_control_panel_arn_isValid;
}

QString OAIAssertionRule::getName() const {
    return m_name;
}
void OAIAssertionRule::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIAssertionRule::is_name_Set() const{
    return m_name_isSet;
}

bool OAIAssertionRule::is_name_Valid() const{
    return m_name_isValid;
}

OAIAssertionRule_RuleConfig OAIAssertionRule::getRuleConfig() const {
    return m_rule_config;
}
void OAIAssertionRule::setRuleConfig(const OAIAssertionRule_RuleConfig &rule_config) {
    m_rule_config = rule_config;
    m_rule_config_isSet = true;
}

bool OAIAssertionRule::is_rule_config_Set() const{
    return m_rule_config_isSet;
}

bool OAIAssertionRule::is_rule_config_Valid() const{
    return m_rule_config_isValid;
}

QString OAIAssertionRule::getSafetyRuleArn() const {
    return m_safety_rule_arn;
}
void OAIAssertionRule::setSafetyRuleArn(const QString &safety_rule_arn) {
    m_safety_rule_arn = safety_rule_arn;
    m_safety_rule_arn_isSet = true;
}

bool OAIAssertionRule::is_safety_rule_arn_Set() const{
    return m_safety_rule_arn_isSet;
}

bool OAIAssertionRule::is_safety_rule_arn_Valid() const{
    return m_safety_rule_arn_isValid;
}

OAIStatus OAIAssertionRule::getStatus() const {
    return m_status;
}
void OAIAssertionRule::setStatus(const OAIStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIAssertionRule::is_status_Set() const{
    return m_status_isSet;
}

bool OAIAssertionRule::is_status_Valid() const{
    return m_status_isValid;
}

qint32 OAIAssertionRule::getWaitPeriodMs() const {
    return m_wait_period_ms;
}
void OAIAssertionRule::setWaitPeriodMs(const qint32 &wait_period_ms) {
    m_wait_period_ms = wait_period_ms;
    m_wait_period_ms_isSet = true;
}

bool OAIAssertionRule::is_wait_period_ms_Set() const{
    return m_wait_period_ms_isSet;
}

bool OAIAssertionRule::is_wait_period_ms_Valid() const{
    return m_wait_period_ms_isValid;
}

bool OAIAssertionRule::isSet() const {
...
bool OAIAssertionRule::isValid() const {
