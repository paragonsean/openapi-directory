...
#ifndef OAIRule_GATING_H
#define OAIRule_GATING_H
...
class OAIRule_GATING : public OAIObject {
public:
    OAIRule_GATING();
    OAIRule_GATING(QString json);
    ~OAIRule_GATING() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRule_GATING)

#endif // OAIRule_GATING_H
