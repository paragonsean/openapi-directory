...
/*
 * OAIUpdateSafetyRule_request_GatingRuleUpdate.h
 *
...
#ifndef OAIUpdateSafetyRule_request_GatingRuleUpdate_H
#define OAIUpdateSafetyRule_request_GatingRuleUpdate_H
...
class OAIUpdateSafetyRule_request_GatingRuleUpdate : public OAIObject {
public:
    OAIUpdateSafetyRule_request_GatingRuleUpdate();
    OAIUpdateSafetyRule_request_GatingRuleUpdate(QString json);
    ~OAIUpdateSafetyRule_request_GatingRuleUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSafetyRule_request_GatingRuleUpdate)

#endif // OAIUpdateSafetyRule_request_GatingRuleUpdate_H
