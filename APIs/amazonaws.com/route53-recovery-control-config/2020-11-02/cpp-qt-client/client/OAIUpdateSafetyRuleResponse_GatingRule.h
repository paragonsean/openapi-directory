...
/*
 * OAIUpdateSafetyRuleResponse_GatingRule.h
 *
 * 
 */

#ifndef OAIUpdateSafetyRuleResponse_GatingRule_H
#define OAIUpdateSafetyRuleResponse_GatingRule_H
...
class OAIUpdateSafetyRuleResponse_GatingRule : public OAIObject {
public:
    OAIUpdateSafetyRuleResponse_GatingRule();
    OAIUpdateSafetyRuleResponse_GatingRule(QString json);
    ~OAIUpdateSafetyRuleResponse_GatingRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSafetyRuleResponse_GatingRule)

#endif // OAIUpdateSafetyRuleResponse_GatingRule_H
