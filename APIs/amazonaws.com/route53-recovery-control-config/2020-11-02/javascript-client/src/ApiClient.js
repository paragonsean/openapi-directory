...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://route53-recovery-control-config.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://route53-recovery-control-config.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2020-11-02/Javascript'
        };
