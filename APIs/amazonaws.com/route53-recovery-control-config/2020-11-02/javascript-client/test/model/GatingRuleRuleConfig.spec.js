...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsRoute53RecoveryControlConfig.GatingRuleRuleConfig();
  });
  ...
  describe('GatingRuleRuleConfig', function() {
    it('should create an instance of GatingRuleRuleConfig', function() {
      // uncomment below and update the code to test GatingRuleRuleConfig
      //var instance = new AwsRoute53RecoveryControlConfig.GatingRuleRuleConfig();
      //expect(instance).to.be.a(AwsRoute53RecoveryControlConfig.GatingRuleRuleConfig);
    });
