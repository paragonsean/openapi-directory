...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsRoute53RecoveryControlConfig.Cluster();
  });
  ...
  describe('Cluster', function() {
    it('should create an instance of Cluster', function() {
      ...
      //var instance = new AwsRoute53RecoveryControlConfig.Cluster();
      //expect(instance).to.be.a(AwsRoute53RecoveryControlConfig.Cluster);
    });
