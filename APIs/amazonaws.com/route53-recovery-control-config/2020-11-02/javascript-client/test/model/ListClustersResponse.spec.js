...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsRoute53RecoveryControlConfig.ListClustersResponse();
  });
  ...
  describe('ListClustersResponse', function() {
    it('should create an instance of ListClustersResponse', function() {
      // uncomment below and update the code to test ListClustersResponse
      //var instance = new AwsRoute53RecoveryControlConfig.ListClustersResponse();
      //expect(instance).to.be.a(AwsRoute53RecoveryControlConfig.ListClustersResponse);
    });
