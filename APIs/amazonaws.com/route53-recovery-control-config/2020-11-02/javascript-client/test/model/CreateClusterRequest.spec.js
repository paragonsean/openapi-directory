...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsRoute53RecoveryControlConfig.CreateClusterRequest();
  });
  ...
  describe('CreateClusterRequest', function() {
    it('should create an instance of CreateClusterRequest', function() {
      ...
      //var instance = new AwsRoute53RecoveryControlConfig.CreateClusterRequest();
      //expect(instance).to.be.a(AwsRoute53RecoveryControlConfig.CreateClusterRequest);
    });
