...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsRoute53RecoveryControlConfig.AssertionRuleRuleConfig();
  });
  ...
  describe('AssertionRuleRuleConfig', function() {
    it('should create an instance of AssertionRuleRuleConfig', function() {
      // uncomment below and update the code to test AssertionRuleRuleConfig
      //var instance = new AwsRoute53RecoveryControlConfig.AssertionRuleRuleConfig();
      //expect(instance).to.be.a(AwsRoute53RecoveryControlConfig.AssertionRuleRuleConfig);
    });
