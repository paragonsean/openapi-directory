...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::claimDevicesByClaimCodeSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::claimDevicesByClaimCodeSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString claim_code = create(); // QString | The claim code, starting with \"C-\", as provided by the device manufacturer.
      ...
      apiInstance.claimDevicesByClaimCode(claim_codex_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
