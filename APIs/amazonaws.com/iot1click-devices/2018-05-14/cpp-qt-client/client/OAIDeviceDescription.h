...
/*
 * OAIDeviceDescription.h
 *
 * 
 */

#ifndef OAIDeviceDescription_H
#define OAIDeviceDescription_H
...
class OAIDeviceDescription : public OAIObject {
public:
    OAIDeviceDescription();
    OAIDeviceDescription(QString json);
    ~OAIDeviceDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeviceDescription)

#endif // OAIDeviceDescription_H
