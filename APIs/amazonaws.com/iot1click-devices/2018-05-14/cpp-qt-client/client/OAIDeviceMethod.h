...
#ifndef OAIDeviceMethod_H
#define OAIDeviceMethod_H
...
class OAIDeviceMethod : public OAIObject {
public:
    OAIDeviceMethod();
    OAIDeviceMethod(QString json);
    ~OAIDeviceMethod() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeviceMethod)

#endif // OAIDeviceMethod_H
