...
async def test_claim_devices_by_claim_code(client):
    ...
    response = await client.request(
        method='PUT',
        path='/claims/{claim_code}'.format(claim_code='claim_code_example'),
        headers=headers,
        )
...
async def test_finalize_device_claim(client):
    ...
    response = await client.request(
        method='PUT',
        path='/devices/{device_id}/finalize-claim'.format(device_id='device_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_device_methods(client):
    ...
    response = await client.request(
        method='GET',
        path='/devices/{device_id}/methods'.format(device_id='device_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_initiate_device_claim(client):
    ...
    response = await client.request(
        method='PUT',
        path='/devices/{device_id}/initiate-claim'.format(device_id='device_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_invoke_device_method(client):
    """Test case for invoke_device_method

    
    """
    body = {"DeviceMethodParameters":"","DeviceMethod":{"DeviceType":"","MethodName":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_list_device_events(client):
    """Test case for list_device_events

    
    """
    params = [('fromTimeStamp', '2013-10-20T19:20:30+01:00'),
                    ('maxResults', 56),
                    ('nextToken', 'next_token_example'),
                    ('toTimeStamp', '2013-10-20T19:20:30+01:00')]
    headers = { 
        'Accept': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
        'x_amz_date': 'x_amz_date_example',
    ...
    response = await client.request(
        method='GET',
        path='/devices/{device_id}/events#fromTimeStamp&toTimeStamp'.format(device_id='device_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_unclaim_device(client):
    ...
    response = await client.request(
        method='PUT',
        path='/devices/{device_id}/unclaim'.format(device_id='device_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_device_state(client):
    ...
    response = await client.request(
        method='PUT',
        path='/devices/{device_id}/state'.format(device_id='device_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
