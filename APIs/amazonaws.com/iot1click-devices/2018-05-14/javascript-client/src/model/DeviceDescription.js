...
/**
 * The DeviceDescription model module.
 * @module model/DeviceDescription
 * @version 2018-05-14
 */
class DeviceDescription {
    /**
     * Constructs a new <code>DeviceDescription</code>.
     * @alias module:model/DeviceDescription
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>DeviceDescription</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeviceDescription} obj Optional instance to populate.
     * @return {module:model/DeviceDescription} The populated <code>DeviceDescription</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeviceDescription();
    ...
    /**
     * Validates the JSON data with respect to <code>DeviceDescription</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeviceDescription</code>.
     */
