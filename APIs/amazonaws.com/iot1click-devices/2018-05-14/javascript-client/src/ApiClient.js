...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://devices.iot1click.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://devices.iot1click.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2018-05-14/Javascript'
        };
