...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoT1ClickDevicesService.Device();
  });
  ...
  describe('Device', function() {
    it('should create an instance of Device', function() {
      ...
      //var instance = new AwsIoT1ClickDevicesService.Device();
      //expect(instance).to.be.a(AwsIoT1ClickDevicesService.Device);
    });
