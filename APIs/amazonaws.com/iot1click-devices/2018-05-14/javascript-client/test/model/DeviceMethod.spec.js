...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoT1ClickDevicesService.DeviceMethod();
  });
  ...
  describe('DeviceMethod', function() {
    it('should create an instance of DeviceMethod', function() {
      // uncomment below and update the code to test DeviceMethod
      //var instance = new AwsIoT1ClickDevicesService.DeviceMethod();
      //expect(instance).to.be.a(AwsIoT1ClickDevicesService.DeviceMethod);
    });
