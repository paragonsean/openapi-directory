...
class PutStorageConfigurationRequestMultiLayerStorage(Model):
    ...
    def __init__(self, customer_managed_s3_storage: PutStorageConfigurationRequestMultiLayerStorageCustomerManagedS3Storage=None):
        """PutStorageConfigurationRequestMultiLayerStorage - a model defined in OpenAPI

        :param customer_managed_s3_storage: The customer_managed_s3_storage of this PutStorageConfigurationRequestMultiLayerStorage.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PutStorageConfigurationRequestMultiLayerStorage':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The PutStorageConfigurationRequest_multiLayerStorage of this PutStorageConfigurationRequestMultiLayerStorage.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def customer_managed_s3_storage(self):
        """Gets the customer_managed_s3_storage of this PutStorageConfigurationRequestMultiLayerStorage.


        :return: The customer_managed_s3_storage of this PutStorageConfigurationRequestMultiLayerStorage.
    ...
    def customer_managed_s3_storage(self, customer_managed_s3_storage):
        """Sets the customer_managed_s3_storage of this PutStorageConfigurationRequestMultiLayerStorage.
