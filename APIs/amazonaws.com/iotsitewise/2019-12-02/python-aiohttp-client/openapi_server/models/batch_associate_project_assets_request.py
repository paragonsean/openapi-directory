...
class BatchAssociateProjectAssetsRequest(Model):
    ...
    def __init__(self, asset_ids: List[str]=None, client_token: str=None):
        """BatchAssociateProjectAssetsRequest - a model defined in OpenAPI

        :param asset_ids: The asset_ids of this BatchAssociateProjectAssetsRequest.
        :param client_token: The client_token of this BatchAssociateProjectAssetsRequest.
        """
        self.openapi_types = {
            'asset_ids': List[str],
            'client_token': str
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'BatchAssociateProjectAssetsRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The BatchAssociateProjectAssets_request of this BatchAssociateProjectAssetsRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def asset_ids(self):
        """Gets the asset_ids of this BatchAssociateProjectAssetsRequest.

        The IDs of the assets to be associated to the project.

        :return: The asset_ids of this BatchAssociateProjectAssetsRequest.
        :rtype: List[str]
        """
    ...
    def asset_ids(self, asset_ids):
        """Sets the asset_ids of this BatchAssociateProjectAssetsRequest.
    ...
    def client_token(self):
        """Gets the client_token of this BatchAssociateProjectAssetsRequest.

        A unique case-sensitive identifier that you can provide to ensure the idempotency of the request. Don't reuse this client token if a new idempotent request is required.

        :return: The client_token of this BatchAssociateProjectAssetsRequest.
        :rtype: str
        """
    ...
    def client_token(self, client_token):
        """Sets the client_token of this BatchAssociateProjectAssetsRequest.
