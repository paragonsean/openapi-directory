...
class GreengrassV2(Model):
    ...
    def __init__(self, core_device_thing_name: str=None):
        """GreengrassV2 - a model defined in OpenAPI

        :param core_device_thing_name: The core_device_thing_name of this GreengrassV2.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GreengrassV2':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GreengrassV2 of this GreengrassV2.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def core_device_thing_name(self):
        """Gets the core_device_thing_name of this GreengrassV2.


        :return: The core_device_thing_name of this GreengrassV2.
        :rtype: str
        """
    ...
    def core_device_thing_name(self, core_device_thing_name):
        """Sets the core_device_thing_name of this GreengrassV2.
