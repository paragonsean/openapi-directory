...
class DescribeAccessPolicyResponseAccessPolicyIdentity(Model):
    ...
    def __init__(self, user: CreateAccessPolicyRequestAccessPolicyIdentityUser=None, group: CreateAccessPolicyRequestAccessPolicyIdentityGroup=None, iam_user: CreateAccessPolicyRequestAccessPolicyIdentityIamUser=None, iam_role: CreateAccessPolicyRequestAccessPolicyIdentityIamRole=None):
        """DescribeAccessPolicyResponseAccessPolicyIdentity - a model defined in OpenAPI

        :param user: The user of this DescribeAccessPolicyResponseAccessPolicyIdentity.
        :param group: The group of this DescribeAccessPolicyResponseAccessPolicyIdentity.
        :param iam_user: The iam_user of this DescribeAccessPolicyResponseAccessPolicyIdentity.
        :param iam_role: The iam_role of this DescribeAccessPolicyResponseAccessPolicyIdentity.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DescribeAccessPolicyResponseAccessPolicyIdentity':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DescribeAccessPolicyResponse_accessPolicyIdentity of this DescribeAccessPolicyResponseAccessPolicyIdentity.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def user(self):
        """Gets the user of this DescribeAccessPolicyResponseAccessPolicyIdentity.


        :return: The user of this DescribeAccessPolicyResponseAccessPolicyIdentity.
    ...
    @user.setter
    def user(self, user):
        """Sets the user of this DescribeAccessPolicyResponseAccessPolicyIdentity.
    ...
    @property
    def group(self):
        """Gets the group of this DescribeAccessPolicyResponseAccessPolicyIdentity.


        :return: The group of this DescribeAccessPolicyResponseAccessPolicyIdentity.
    ...
    def group(self, group):
        """Sets the group of this DescribeAccessPolicyResponseAccessPolicyIdentity.
    ...
    @property
    def iam_user(self):
        """Gets the iam_user of this DescribeAccessPolicyResponseAccessPolicyIdentity.


        :return: The iam_user of this DescribeAccessPolicyResponseAccessPolicyIdentity.
    ...
    def iam_user(self, iam_user):
        """Sets the iam_user of this DescribeAccessPolicyResponseAccessPolicyIdentity.
    ...
    @property
    def iam_role(self):
        """Gets the iam_role of this DescribeAccessPolicyResponseAccessPolicyIdentity.


        :return: The iam_role of this DescribeAccessPolicyResponseAccessPolicyIdentity.
    ...
    def iam_role(self, iam_role):
        """Sets the iam_role of this DescribeAccessPolicyResponseAccessPolicyIdentity.
