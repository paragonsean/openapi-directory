...
class MultiLayerStorage(Model):
    ...
    def __init__(self, customer_managed_s3_storage: PutStorageConfigurationRequestMultiLayerStorageCustomerManagedS3Storage=None):
        """MultiLayerStorage - a model defined in OpenAPI

        :param customer_managed_s3_storage: The customer_managed_s3_storage of this MultiLayerStorage.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'MultiLayerStorage':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The MultiLayerStorage of this MultiLayerStorage.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def customer_managed_s3_storage(self):
        """Gets the customer_managed_s3_storage of this MultiLayerStorage.


        :return: The customer_managed_s3_storage of this MultiLayerStorage.
    ...
    def customer_managed_s3_storage(self, customer_managed_s3_storage):
        """Sets the customer_managed_s3_storage of this MultiLayerStorage.
