...
class CreateAccessPolicyRequestAccessPolicyIdentity(Model):
    ...
    def __init__(self, user: CreateAccessPolicyRequestAccessPolicyIdentityUser=None, group: CreateAccessPolicyRequestAccessPolicyIdentityGroup=None, iam_user: CreateAccessPolicyRequestAccessPolicyIdentityIamUser=None, iam_role: CreateAccessPolicyRequestAccessPolicyIdentityIamRole=None):
        """CreateAccessPolicyRequestAccessPolicyIdentity - a model defined in OpenAPI

        :param user: The user of this CreateAccessPolicyRequestAccessPolicyIdentity.
        :param group: The group of this CreateAccessPolicyRequestAccessPolicyIdentity.
        :param iam_user: The iam_user of this CreateAccessPolicyRequestAccessPolicyIdentity.
        :param iam_role: The iam_role of this CreateAccessPolicyRequestAccessPolicyIdentity.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateAccessPolicyRequestAccessPolicyIdentity':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateAccessPolicyRequest_accessPolicyIdentity of this CreateAccessPolicyRequestAccessPolicyIdentity.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def user(self):
        """Gets the user of this CreateAccessPolicyRequestAccessPolicyIdentity.


        :return: The user of this CreateAccessPolicyRequestAccessPolicyIdentity.
    ...
    @user.setter
    def user(self, user):
        """Sets the user of this CreateAccessPolicyRequestAccessPolicyIdentity.
    ...
    @property
    def group(self):
        """Gets the group of this CreateAccessPolicyRequestAccessPolicyIdentity.


        :return: The group of this CreateAccessPolicyRequestAccessPolicyIdentity.
    ...
    def group(self, group):
        """Sets the group of this CreateAccessPolicyRequestAccessPolicyIdentity.
    ...
    @property
    def iam_user(self):
        """Gets the iam_user of this CreateAccessPolicyRequestAccessPolicyIdentity.


        :return: The iam_user of this CreateAccessPolicyRequestAccessPolicyIdentity.
    ...
    def iam_user(self, iam_user):
        """Sets the iam_user of this CreateAccessPolicyRequestAccessPolicyIdentity.
    ...
    @property
    def iam_role(self):
        """Gets the iam_role of this CreateAccessPolicyRequestAccessPolicyIdentity.


        :return: The iam_role of this CreateAccessPolicyRequestAccessPolicyIdentity.
    ...
    def iam_role(self, iam_role):
        """Sets the iam_role of this CreateAccessPolicyRequestAccessPolicyIdentity.
