...
async def test_associate_assets(client):
    """Test case for associate_assets

    
    """
    body = {"hierarchyId":"","clientToken":"","childAssetId":""}
    headers = { 
    ...
    response = await client.request(
        method='POST',
        path='/assets/{asset_id}/associate'.format(asset_id='asset_id_example'),
        headers=headers,
        json=body,
        )
...
async def test_associate_time_series_to_asset_property(client):
    """Test case for associate_time_series_to_asset_property
...
async def test_batch_associate_project_assets(client):
    """Test case for batch_associate_project_assets

    
    """
    body = {"clientToken":"","assetIds":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/projects/{project_id}/assets/associate'.format(project_id='project_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_batch_disassociate_project_assets(client):
    """Test case for batch_disassociate_project_assets
    ...
    response = await client.request(
        method='POST',
        path='/projects/{project_id}/assets/disassociate'.format(project_id='project_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_batch_get_asset_property_aggregates(client):
    """Test case for batch_get_asset_property_aggregates

    
    """
    body = {"entries":"","nextToken":"","maxResults":""}
...
async def test_batch_get_asset_property_value(client):
    """Test case for batch_get_asset_property_value

    
    """
    body = {"entries":"","nextToken":""}
...
async def test_batch_get_asset_property_value_history(client):
    """Test case for batch_get_asset_property_value_history
...
async def test_batch_put_asset_property_value(client):
    """Test case for batch_put_asset_property_value
...
async def test_create_access_policy(client):
    ...
    """
    body = {"clientToken":"","accessPolicyPermission":"","accessPolicyIdentity":{"iamRole":{"arn":""},"iamUser":{"arn":""},"user":{"id":""},"group":{"id":""}},"accessPolicyResource":{"project":{"id":""},"portal":{"id":""}},"tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_asset(client):
    ...
    """
    body = {"clientToken":"","assetModelId":"","assetName":"","assetDescription":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_asset_model(client):
    """Test case for create_asset_model

    
    """
    body = {"assetModelDescription":"","assetModelProperties":"","clientToken":"","assetModelHierarchies":"","assetModelCompositeModels":"","assetModelName":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_bulk_import_job(client):
    """Test case for create_bulk_import_job

    
    """
    body = {"jobName":"","errorReportLocation":{"bucket":"","prefix":""},"files":"","jobRoleArn":"","jobConfiguration":{"fileFormat":{"csv":{"columnNames":""}}}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_dashboard(client):
    ...
    """
    body = {"clientToken":"","dashboardDefinition":"","dashboardDescription":"","projectId":"","dashboardName":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_gateway(client):
    ...
    """
    body = {"gatewayName":"","gatewayPlatform":{"greengrass":{"groupArn":""},"greengrassV2":{"coreDeviceThingName":""}},"tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_portal(client):
    """Test case for create_portal

    
    """
    body = {"notificationSenderEmail":"","portalName":"","clientToken":"","roleArn":"","alarms":{"alarmRoleArn":"","notificationLambdaArn":""},"portalContactEmail":"","portalLogoImageFile":{"data":"","type":""},"portalAuthMode":"","portalDescription":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_project(client):
    ...
    """
    body = {"clientToken":"","portalId":"","projectDescription":"","projectName":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_delete_access_policy(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/access-policies/{access_policy_id}'.format(access_policy_id='access_policy_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_asset(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/assets/{asset_id}'.format(asset_id='asset_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_asset_model(client):
    """Test case for delete_asset_model
    ...
    response = await client.request(
        method='DELETE',
        path='/asset-models/{asset_model_id}'.format(asset_model_id='asset_model_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_dashboard(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/dashboards/{dashboard_id}'.format(dashboard_id='dashboard_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_gateway(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/20200301/gateways/{gateway_id}'.format(gateway_id='gateway_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_portal(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/portals/{portal_id}'.format(portal_id='portal_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_time_series(client):
    """Test case for delete_time_series
...
async def test_describe_access_policy(client):
    """Test case for describe_access_policy
...
async def test_describe_asset_model(client):
    """Test case for describe_asset_model
...
async def test_describe_asset_property(client):
    """Test case for describe_asset_property
    ...
    response = await client.request(
        method='GET',
        path='/assets/{asset_id}/properties/{property_id}'.format(asset_id='asset_id_example', property_id='property_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_bulk_import_job(client):
    """Test case for describe_bulk_import_job
...
async def test_describe_dashboard(client):
    """Test case for describe_dashboard
...
async def test_describe_default_encryption_configuration(client):
    """Test case for describe_default_encryption_configuration
...
async def test_describe_gateway_capability_configuration(client):
    """Test case for describe_gateway_capability_configuration
    ...
    response = await client.request(
        method='GET',
        path='/20200301/gateways/{gateway_id}/capability/{capability_namespace}'.format(gateway_id='gateway_id_example', capability_namespace='capability_namespace_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_logging_options(client):
    """Test case for describe_logging_options
...
async def test_describe_portal(client):
    """Test case for describe_portal
...
async def test_describe_storage_configuration(client):
    """Test case for describe_storage_configuration
...
async def test_describe_time_series(client):
    """Test case for describe_time_series
...
async def test_disassociate_assets(client):
    """Test case for disassociate_assets
    ...
    response = await client.request(
        method='POST',
        path='/assets/{asset_id}/disassociate'.format(asset_id='asset_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_disassociate_time_series_from_asset_property(client):
    """Test case for disassociate_time_series_from_asset_property
...
async def test_get_asset_property_aggregates(client):
    """Test case for get_asset_property_aggregates

    
    """
    params = [('assetId', 'asset_id_example'),
                    ('propertyId', 'property_id_example'),
                    ('propertyAlias', 'property_alias_example'),
                    ('aggregateTypes', [openapi_server.AggregateType()]),
                    ('resolution', 'resolution_example'),
                    ('qualities', [openapi_server.Quality()]),
                    ('startDate', '2013-10-20T19:20:30+01:00'),
                    ('endDate', '2013-10-20T19:20:30+01:00'),
                    ('timeOrdering', 'time_ordering_example'),
                    ('nextToken', 'next_token_example'),
                    ('maxResults', 56)]
    headers = { 
        'Accept': 'application/json',
...
async def test_get_asset_property_value(client):
    """Test case for get_asset_property_value
...
async def test_get_asset_property_value_history(client):
    """Test case for get_asset_property_value_history
...
async def test_get_interpolated_asset_property_values(client):
    """Test case for get_interpolated_asset_property_values
    ...
    params = [('assetId', 'asset_id_example'),
                    ...
                    ('startTimeOffsetInNanos', 56),
                    ('endTimeInSeconds', 56),
                    ('endTimeOffsetInNanos', 56),
                    ('quality', 'quality_example'),
                    ('intervalInSeconds', 56),
                    ('nextToken', 'next_token_example'),
                    ('maxResults', 56),
                    ('type', 'type_example'),
                    ('intervalWindowInSeconds', 56)]
    headers = { 
        'Accept': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
        'x_amz_date': 'x_amz_date_example',
...
async def test_list_asset_model_properties(client):
    """Test case for list_asset_model_properties
    ...
    response = await client.request(
        method='GET',
        path='/asset-models/{asset_model_id}/properties'.format(asset_model_id='asset_model_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_asset_models(client):
    """Test case for list_asset_models
...
async def test_list_asset_properties(client):
    """Test case for list_asset_properties
    ...
    response = await client.request(
        method='GET',
        path='/assets/{asset_id}/properties'.format(asset_id='asset_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_asset_relationships(client):
    """Test case for list_asset_relationships

    
    """
    params = [('traversalType', 'traversal_type_example'),
                    ('nextToken', 'next_token_example'),
                    ('maxResults', 56)]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='GET',
        path='/assets/{asset_id}/assetRelationships#traversalType'.format(asset_id='asset_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_assets(client):
    ...
    params = [('nextToken', 'next_token_example'),
                    ('maxResults', 56),
                    ('assetModelId', 'asset_model_id_example'),
                    ('filter', 'filter_example')]
    headers = { 
        'Accept': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_list_associated_assets(client):
    """Test case for list_associated_assets

    
    """
    params = [('hierarchyId', 'hierarchy_id_example'),
                    ('traversalDirection', 'traversal_direction_example'),
                    ('nextToken', 'next_token_example'),
                    ('maxResults', 56)]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='GET',
        path='/assets/{asset_id}/hierarchies'.format(asset_id='asset_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_bulk_import_jobs(client):
    """Test case for list_bulk_import_jobs
...
async def test_list_portals(client):
    """Test case for list_portals
...
async def test_list_project_assets(client):
    """Test case for list_project_assets
    ...
    response = await client.request(
        method='GET',
        path='/projects/{project_id}/assets'.format(project_id='project_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_projects(client):
    ...
    """
    params = [('portalId', 'portal_id_example'),
                    ('nextToken', 'next_token_example'),
                    ('maxResults', 56)]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_time_series(client):
    ...
    params = [('nextToken', 'next_token_example'),
                    ('maxResults', 56),
                    ('assetId', 'asset_id_example'),
                    ('aliasPrefix', 'alias_prefix_example'),
                    ('timeSeriesType', 'time_series_type_example')]
    headers = { 
        'Accept': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
        'x_amz_date': 'x_amz_date_example',
...
async def test_put_default_encryption_configuration(client):
    """Test case for put_default_encryption_configuration
...
async def test_put_logging_options(client):
    """Test case for put_logging_options
...
async def test_put_storage_configuration(client):
    """Test case for put_storage_configuration

    
    """
    body = {"multiLayerStorage":{"customerManagedS3Storage":{"s3ResourceArn":"","roleArn":""}},"storageType":"","disassociatedDataStorage":"","retentionPeriod":{"unlimited":"","numberOfDays":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_access_policy(client):
    ...
    """
    body = {"clientToken":"","accessPolicyPermission":"","accessPolicyIdentity":{"iamRole":{"arn":""},"iamUser":{"arn":""},"user":{"id":""},"group":{"id":""}},"accessPolicyResource":{"project":{"id":""},"portal":{"id":""}}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_asset(client):
    ...
    """
    body = {"clientToken":"","assetName":"","assetDescription":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_asset_model(client):
    """Test case for update_asset_model

    
    """
    body = {"assetModelDescription":"","assetModelProperties":"","clientToken":"","assetModelHierarchies":"","assetModelCompositeModels":"","assetModelName":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_asset_property(client):
    """Test case for update_asset_property

    
    """
    body = {"propertyUnit":"","propertyNotificationState":"","clientToken":"","propertyAlias":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_dashboard(client):
    ...
    """
    body = {"clientToken":"","dashboardDefinition":"","dashboardDescription":"","dashboardName":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_gateway(client):
...
async def test_update_gateway_capability_configuration(client):
    """Test case for update_gateway_capability_configuration
    ...
    response = await client.request(
        method='POST',
        path='/20200301/gateways/{gateway_id}/capability'.format(gateway_id='gateway_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_portal(client):
    """Test case for update_portal

    
    """
    body = {"notificationSenderEmail":"","portalName":"","roleArn":"","clientToken":"","alarms":{"alarmRoleArn":"","notificationLambdaArn":""},"portalContactEmail":"","portalDescription":"","portalLogoImage":{"file":{"data":"","type":""},"id":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_project(client):
    ...
    """
    body = {"clientToken":"","projectDescription":"","projectName":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
