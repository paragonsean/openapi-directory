...
#ifndef OAIProperty_type_H
#define OAIProperty_type_H
...
class OAIProperty_type : public OAIObject {
public:
    OAIProperty_type();
    OAIProperty_type(QString json);
    ~OAIProperty_type() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProperty_type)

#endif // OAIProperty_type_H
