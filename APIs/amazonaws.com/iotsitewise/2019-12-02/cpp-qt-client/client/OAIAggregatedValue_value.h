...
/*
 * OAIAggregatedValue_value.h
 *
 * 
 */

#ifndef OAIAggregatedValue_value_H
#define OAIAggregatedValue_value_H
...
class OAIAggregatedValue_value : public OAIObject {
public:
    OAIAggregatedValue_value();
    OAIAggregatedValue_value(QString json);
    ~OAIAggregatedValue_value() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAggregatedValue_value)

#endif // OAIAggregatedValue_value_H
