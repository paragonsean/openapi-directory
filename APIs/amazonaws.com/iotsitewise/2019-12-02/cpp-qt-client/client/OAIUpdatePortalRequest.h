...
/*
 * OAIUpdatePortalRequest.h
 *
 * 
 */

#ifndef OAIUpdatePortalRequest_H
#define OAIUpdatePortalRequest_H
...
class OAIUpdatePortalRequest : public OAIObject {
public:
    OAIUpdatePortalRequest();
    OAIUpdatePortalRequest(QString json);
    ~OAIUpdatePortalRequest() override;
    ...
    OAIImage getPortalLogoImage() const;
    void setPortalLogoImage(const OAIImage &portal_logo_image);
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePortalRequest)

#endif // OAIUpdatePortalRequest_H
