...
/*
 * OAIAssetModelPropertyDefinition_type.h
 *
 * 
 */

#ifndef OAIAssetModelPropertyDefinition_type_H
#define OAIAssetModelPropertyDefinition_type_H
...
class OAIAssetModelPropertyDefinition_type : public OAIObject {
public:
    OAIAssetModelPropertyDefinition_type();
    OAIAssetModelPropertyDefinition_type(QString json);
    ~OAIAssetModelPropertyDefinition_type() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssetModelPropertyDefinition_type)

#endif // OAIAssetModelPropertyDefinition_type_H
