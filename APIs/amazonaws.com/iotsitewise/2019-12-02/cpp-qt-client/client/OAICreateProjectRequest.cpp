...
QString OAICreateProjectRequest::getPortalId() const {
    return m_portal_id;
}
void OAICreateProjectRequest::setPortalId(const QString &portal_id) {
    m_portal_id = portal_id;
    m_portal_id_isSet = true;
}

bool OAICreateProjectRequest::is_portal_id_Set() const{
    return m_portal_id_isSet;
}

bool OAICreateProjectRequest::is_portal_id_Valid() const{
...
QString OAICreateProjectRequest::getProjectDescription() const {
    return m_project_description;
}
void OAICreateProjectRequest::setProjectDescription(const QString &project_description) {
    m_project_description = project_description;
    m_project_description_isSet = true;
}

bool OAICreateProjectRequest::is_project_description_Set() const{
    return m_project_description_isSet;
}

bool OAICreateProjectRequest::is_project_description_Valid() const{
    return m_project_description_isValid;
}

QString OAICreateProjectRequest::getClientToken() const {
    return m_client_token;
}
void OAICreateProjectRequest::setClientToken(const QString &client_token) {
    m_client_token = client_token;
    m_client_token_isSet = true;
}

bool OAICreateProjectRequest::is_client_token_Set() const{
    return m_client_token_isSet;
}

bool OAICreateProjectRequest::is_client_token_Valid() const{
