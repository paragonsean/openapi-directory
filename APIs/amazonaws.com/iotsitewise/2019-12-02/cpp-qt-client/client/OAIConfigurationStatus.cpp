...
OAIConfigurationState OAIConfigurationStatus::getState() const {
    return m_state;
}
void OAIConfigurationStatus::setState(const OAIConfigurationState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIConfigurationStatus::is_state_Set() const{
    return m_state_isSet;
}

bool OAIConfigurationStatus::is_state_Valid() const{
    return m_state_isValid;
}

OAIConfigurationStatus_error OAIConfigurationStatus::getError() const {
    return m_error;
}
void OAIConfigurationStatus::setError(const OAIConfigurationStatus_error &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIConfigurationStatus::is_error_Set() const{
    return m_error_isSet;
}

bool OAIConfigurationStatus::is_error_Valid() const{
