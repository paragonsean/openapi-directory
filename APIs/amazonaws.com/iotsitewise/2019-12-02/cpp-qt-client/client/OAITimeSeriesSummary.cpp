...
#include "OAITimeSeriesSummary.h"
...
OAITimeSeriesSummary::OAITimeSeriesSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITimeSeriesSummary::OAITimeSeriesSummary() {
    this->initializeModel();
}

OAITimeSeriesSummary::~OAITimeSeriesSummary() {}

void OAITimeSeriesSummary::initializeModel() {
...
void OAITimeSeriesSummary::fromJson(QString jsonString) {
...
void OAITimeSeriesSummary::fromJsonObject(QJsonObject json) {
...
QString OAITimeSeriesSummary::asJson() const {
...
QJsonObject OAITimeSeriesSummary::asJsonObject() const {
    QJsonObject obj;
    if (m_asset_id_isSet) {
...
QString OAITimeSeriesSummary::getAssetId() const {
    return m_asset_id;
}
void OAITimeSeriesSummary::setAssetId(const QString &asset_id) {
    m_asset_id = asset_id;
    m_asset_id_isSet = true;
}

bool OAITimeSeriesSummary::is_asset_id_Set() const{
    return m_asset_id_isSet;
}

bool OAITimeSeriesSummary::is_asset_id_Valid() const{
    return m_asset_id_isValid;
}

QString OAITimeSeriesSummary::getPropertyId() const {
    return m_property_id;
}
void OAITimeSeriesSummary::setPropertyId(const QString &property_id) {
    m_property_id = property_id;
    m_property_id_isSet = true;
}

bool OAITimeSeriesSummary::is_property_id_Set() const{
    return m_property_id_isSet;
}

bool OAITimeSeriesSummary::is_property_id_Valid() const{
    return m_property_id_isValid;
}

QString OAITimeSeriesSummary::getAlias() const {
    return m_alias;
}
void OAITimeSeriesSummary::setAlias(const QString &alias) {
    m_alias = alias;
    m_alias_isSet = true;
}

bool OAITimeSeriesSummary::is_alias_Set() const{
    return m_alias_isSet;
}

bool OAITimeSeriesSummary::is_alias_Valid() const{
    return m_alias_isValid;
}

QString OAITimeSeriesSummary::getTimeSeriesId() const {
    return m_time_series_id;
}
void OAITimeSeriesSummary::setTimeSeriesId(const QString &time_series_id) {
    m_time_series_id = time_series_id;
    m_time_series_id_isSet = true;
}

bool OAITimeSeriesSummary::is_time_series_id_Set() const{
    return m_time_series_id_isSet;
}

bool OAITimeSeriesSummary::is_time_series_id_Valid() const{
    return m_time_series_id_isValid;
}

OAIPropertyDataType OAITimeSeriesSummary::getDataType() const {
    return m_data_type;
}
void OAITimeSeriesSummary::setDataType(const OAIPropertyDataType &data_type) {
    m_data_type = data_type;
    m_data_type_isSet = true;
}

bool OAITimeSeriesSummary::is_data_type_Set() const{
    return m_data_type_isSet;
}

bool OAITimeSeriesSummary::is_data_type_Valid() const{
    return m_data_type_isValid;
}

QString OAITimeSeriesSummary::getDataTypeSpec() const {
    return m_data_type_spec;
}
void OAITimeSeriesSummary::setDataTypeSpec(const QString &data_type_spec) {
    m_data_type_spec = data_type_spec;
    m_data_type_spec_isSet = true;
}

bool OAITimeSeriesSummary::is_data_type_spec_Set() const{
    return m_data_type_spec_isSet;
}

bool OAITimeSeriesSummary::is_data_type_spec_Valid() const{
    return m_data_type_spec_isValid;
}

QDateTime OAITimeSeriesSummary::getTimeSeriesCreationDate() const {
    return m_time_series_creation_date;
}
void OAITimeSeriesSummary::setTimeSeriesCreationDate(const QDateTime &time_series_creation_date) {
    m_time_series_creation_date = time_series_creation_date;
    m_time_series_creation_date_isSet = true;
}

bool OAITimeSeriesSummary::is_time_series_creation_date_Set() const{
    return m_time_series_creation_date_isSet;
}

bool OAITimeSeriesSummary::is_time_series_creation_date_Valid() const{
    return m_time_series_creation_date_isValid;
}

QDateTime OAITimeSeriesSummary::getTimeSeriesLastUpdateDate() const {
    return m_time_series_last_update_date;
}
void OAITimeSeriesSummary::setTimeSeriesLastUpdateDate(const QDateTime &time_series_last_update_date) {
    m_time_series_last_update_date = time_series_last_update_date;
    m_time_series_last_update_date_isSet = true;
}

bool OAITimeSeriesSummary::is_time_series_last_update_date_Set() const{
    return m_time_series_last_update_date_isSet;
}

bool OAITimeSeriesSummary::is_time_series_last_update_date_Valid() const{
    return m_time_series_last_update_date_isValid;
}

QString OAITimeSeriesSummary::getTimeSeriesArn() const {
    return m_time_series_arn;
}
void OAITimeSeriesSummary::setTimeSeriesArn(const QString &time_series_arn) {
    m_time_series_arn = time_series_arn;
    m_time_series_arn_isSet = true;
}

bool OAITimeSeriesSummary::is_time_series_arn_Set() const{
    return m_time_series_arn_isSet;
}

bool OAITimeSeriesSummary::is_time_series_arn_Valid() const{
    return m_time_series_arn_isValid;
}

bool OAITimeSeriesSummary::isSet() const {
...
bool OAITimeSeriesSummary::isValid() const {
