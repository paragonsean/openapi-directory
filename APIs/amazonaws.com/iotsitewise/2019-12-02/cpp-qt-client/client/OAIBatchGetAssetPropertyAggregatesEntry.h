...
/*
 * OAIBatchGetAssetPropertyAggregatesEntry.h
 *
...
#ifndef OAIBatchGetAssetPropertyAggregatesEntry_H
#define OAIBatchGetAssetPropertyAggregatesEntry_H
...
class OAIBatchGetAssetPropertyAggregatesEntry : public OAIObject {
public:
    OAIBatchGetAssetPropertyAggregatesEntry();
    OAIBatchGetAssetPropertyAggregatesEntry(QString json);
    ~OAIBatchGetAssetPropertyAggregatesEntry() override;
    ...
    QList getAggregateTypes() const;
    void setAggregateTypes(const QList &aggregate_types);
    bool is_aggregate_types_Set() const;
    bool is_aggregate_types_Valid() const;
...
private:
    ...
    QList m_aggregate_types;
    bool m_aggregate_types_isSet;
    bool m_aggregate_types_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchGetAssetPropertyAggregatesEntry)

#endif // OAIBatchGetAssetPropertyAggregatesEntry_H
