...
OAIProperty_type::OAIProperty_type(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProperty_type::OAIProperty_type() {
    this->initializeModel();
}

OAIProperty_type::~OAIProperty_type() {}

void OAIProperty_type::initializeModel() {
...
void OAIProperty_type::fromJson(QString jsonString) {
...
void OAIProperty_type::fromJsonObject(QJsonObject json) {
...
QString OAIProperty_type::asJson() const {
...
QJsonObject OAIProperty_type::asJsonObject() const {
    QJsonObject obj;
...
OAIPropertyType_attribute OAIProperty_type::getAttribute() const {
    return m_attribute;
}
void OAIProperty_type::setAttribute(const OAIPropertyType_attribute &attribute) {
    m_attribute = attribute;
    m_attribute_isSet = true;
}

bool OAIProperty_type::is_attribute_Set() const{
    return m_attribute_isSet;
}

bool OAIProperty_type::is_attribute_Valid() const{
    return m_attribute_isValid;
}

OAIPropertyType_measurement OAIProperty_type::getMeasurement() const {
    return m_measurement;
}
void OAIProperty_type::setMeasurement(const OAIPropertyType_measurement &measurement) {
    m_measurement = measurement;
    m_measurement_isSet = true;
}

bool OAIProperty_type::is_measurement_Set() const{
    return m_measurement_isSet;
}

bool OAIProperty_type::is_measurement_Valid() const{
    return m_measurement_isValid;
}

OAIPropertyType_transform OAIProperty_type::getTransform() const {
    return m_transform;
}
void OAIProperty_type::setTransform(const OAIPropertyType_transform &transform) {
    m_transform = transform;
    m_transform_isSet = true;
}

bool OAIProperty_type::is_transform_Set() const{
    return m_transform_isSet;
}

bool OAIProperty_type::is_transform_Valid() const{
    return m_transform_isValid;
}

OAIPropertyType_metric OAIProperty_type::getMetric() const {
    return m_metric;
}
void OAIProperty_type::setMetric(const OAIPropertyType_metric &metric) {
    m_metric = metric;
    m_metric_isSet = true;
}

bool OAIProperty_type::is_metric_Set() const{
    return m_metric_isSet;
}

bool OAIProperty_type::is_metric_Valid() const{
    return m_metric_isValid;
}

bool OAIProperty_type::isSet() const {
...
bool OAIProperty_type::isValid() const {
