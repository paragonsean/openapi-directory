...
/*
 * OAIUpdateAccessPolicyRequest.h
 *
 * 
 */

#ifndef OAIUpdateAccessPolicyRequest_H
#define OAIUpdateAccessPolicyRequest_H
...
class OAIUpdateAccessPolicyRequest : public OAIObject {
public:
    OAIUpdateAccessPolicyRequest();
    OAIUpdateAccessPolicyRequest(QString json);
    ~OAIUpdateAccessPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAccessPolicyRequest)

#endif // OAIUpdateAccessPolicyRequest_H
