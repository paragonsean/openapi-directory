...
QList OAIMetric::getVariables() const {
    return m_variables;
}
void OAIMetric::setVariables(const QList &variables) {
    m_variables = variables;
    m_variables_isSet = true;
}

bool OAIMetric::is_variables_Set() const{
    return m_variables_isSet;
}

bool OAIMetric::is_variables_Valid() const{
    return m_variables_isValid;
}

OAIMetric_window OAIMetric::getWindow() const {
    return m_window;
}
void OAIMetric::setWindow(const OAIMetric_window &window) {
    m_window = window;
    m_window_isSet = true;
}

bool OAIMetric::is_window_Set() const{
    return m_window_isSet;
}

bool OAIMetric::is_window_Valid() const{
    return m_window_isValid;
}

OAIMetric_processingConfig OAIMetric::getProcessingConfig() const {
    return m_processing_config;
}
void OAIMetric::setProcessingConfig(const OAIMetric_processingConfig &processing_config) {
    m_processing_config = processing_config;
    m_processing_config_isSet = true;
}

bool OAIMetric::is_processing_config_Set() const{
    return m_processing_config_isSet;
}

bool OAIMetric::is_processing_config_Valid() const{
