...
|------------ | ------------- | ------------- | -------------|
|**entries** | [**List&lt;BatchGetAssetPropertyAggregatesEntry&gt;**](BatchGetAssetPropertyAggregatesEntry.md) | The list of asset property aggregate entries for the batch get request. You can specify up to 16 entries per request. |  |
