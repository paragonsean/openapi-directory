...
|------------ | ------------- | ------------- | -------------|
|**entries** | [**List&lt;BatchGetAssetPropertyValueHistoryEntry&gt;**](BatchGetAssetPropertyValueHistoryEntry.md) | The list of asset property historical value entries for the batch get request. You can specify up to 16 entries per request. |  |
