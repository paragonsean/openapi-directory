...
public class ListTimeSeriesResponse {
  public static final String SERIALIZED_NAME_TIME_SERIES_SUMMARIES = "TimeSeriesSummaries";
  @SerializedName(SERIALIZED_NAME_TIME_SERIES_SUMMARIES)
  private List timeSeriesSummaries;
  ...
  public ListTimeSeriesResponse timeSeriesSummaries(List timeSeriesSummaries) {
    this.timeSeriesSummaries = timeSeriesSummaries;
    return this;
  }

  /**
   * Get timeSeriesSummaries
   * @return timeSeriesSummaries
   */
  @javax.annotation.Nonnull
  public List getTimeSeriesSummaries() {
    return timeSeriesSummaries;
  }

  public void setTimeSeriesSummaries(List timeSeriesSummaries) {
    this.timeSeriesSummaries = timeSeriesSummaries;
  }


  public ListTimeSeriesResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.timeSeriesSummaries, listTimeSeriesResponse.timeSeriesSummaries) &&
        Objects.equals(this.nextToken, listTimeSeriesResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(timeSeriesSummaries, nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("    timeSeriesSummaries: ").append(toIndentedString(timeSeriesSummaries)).append("\n");
  ...
  static {
    ...
    openapiFields.add("TimeSeriesSummaries");
    openapiFields.add("nextToken");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("TimeSeriesSummaries");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : ListTimeSeriesResponse.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `TimeSeriesSummaries`
      List.validateJsonElement(jsonObj.get("TimeSeriesSummaries"));
