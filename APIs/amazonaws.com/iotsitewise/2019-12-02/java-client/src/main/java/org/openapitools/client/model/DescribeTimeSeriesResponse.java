...
public class DescribeTimeSeriesResponse {
  ...
  public DescribeTimeSeriesResponse() {
  }

  public DescribeTimeSeriesResponse assetId(String assetId) {
  ...
  public DescribeTimeSeriesResponse propertyId(String propertyId) {
  ...
  public DescribeTimeSeriesResponse alias(String alias) {
    this.alias = alias;
    return this;
  }
  ...
  public DescribeTimeSeriesResponse timeSeriesId(String timeSeriesId) {
  ...
  public DescribeTimeSeriesResponse dataType(PropertyDataType dataType) {
  ...
  public DescribeTimeSeriesResponse dataTypeSpec(String dataTypeSpec) {
  ...
  public DescribeTimeSeriesResponse timeSeriesCreationDate(OffsetDateTime timeSeriesCreationDate) {
  ...
  public DescribeTimeSeriesResponse timeSeriesLastUpdateDate(OffsetDateTime timeSeriesLastUpdateDate) {
  ...
  public DescribeTimeSeriesResponse timeSeriesArn(String timeSeriesArn) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeTimeSeriesResponse describeTimeSeriesResponse = (DescribeTimeSeriesResponse) o;
    return Objects.equals(this.assetId, describeTimeSeriesResponse.assetId) &&
        Objects.equals(this.propertyId, describeTimeSeriesResponse.propertyId) &&
        Objects.equals(this.alias, describeTimeSeriesResponse.alias) &&
        Objects.equals(this.timeSeriesId, describeTimeSeriesResponse.timeSeriesId) &&
        Objects.equals(this.dataType, describeTimeSeriesResponse.dataType) &&
        Objects.equals(this.dataTypeSpec, describeTimeSeriesResponse.dataTypeSpec) &&
        Objects.equals(this.timeSeriesCreationDate, describeTimeSeriesResponse.timeSeriesCreationDate) &&
        Objects.equals(this.timeSeriesLastUpdateDate, describeTimeSeriesResponse.timeSeriesLastUpdateDate) &&
        Objects.equals(this.timeSeriesArn, describeTimeSeriesResponse.timeSeriesArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeTimeSeriesResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeTimeSeriesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeTimeSeriesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeTimeSeriesResponse is not found in the empty JSON string", DescribeTimeSeriesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeTimeSeriesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeTimeSeriesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeTimeSeriesResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeTimeSeriesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeTimeSeriesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeTimeSeriesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeTimeSeriesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeTimeSeriesResponse>() {
           @Override
           public void write(JsonWriter out, DescribeTimeSeriesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeTimeSeriesResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeTimeSeriesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeTimeSeriesResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeTimeSeriesResponse
   */
  public static DescribeTimeSeriesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeTimeSeriesResponse.class);
  }

  /**
   * Convert an instance of DescribeTimeSeriesResponse to an JSON string
   *
   * @return JSON string
   */
