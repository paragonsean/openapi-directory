...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTSiteWise.AssetModelSummary();
  });
  ...
  describe('AssetModelSummary', function() {
    it('should create an instance of AssetModelSummary', function() {
      // uncomment below and update the code to test AssetModelSummary
      //var instance = new AwsIoTSiteWise.AssetModelSummary();
      //expect(instance).to.be.a(AwsIoTSiteWise.AssetModelSummary);
    });
