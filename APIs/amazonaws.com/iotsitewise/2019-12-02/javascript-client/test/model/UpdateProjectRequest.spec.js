...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTSiteWise.UpdateProjectRequest();
  });
  ...
  describe('UpdateProjectRequest', function() {
    it('should create an instance of UpdateProjectRequest', function() {
      ...
      //var instance = new AwsIoTSiteWise.UpdateProjectRequest();
      //expect(instance).to.be.a(AwsIoTSiteWise.UpdateProjectRequest);
    });
