...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTSiteWise.AssetPropertyValueValue();
  });
  ...
  describe('AssetPropertyValueValue', function() {
    it('should create an instance of AssetPropertyValueValue', function() {
      // uncomment below and update the code to test AssetPropertyValueValue
      //var instance = new AwsIoTSiteWise.AssetPropertyValueValue();
      //expect(instance).to.be.a(AwsIoTSiteWise.AssetPropertyValueValue);
    });
