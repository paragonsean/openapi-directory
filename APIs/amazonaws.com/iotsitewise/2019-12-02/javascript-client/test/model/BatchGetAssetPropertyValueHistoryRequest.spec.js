...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTSiteWise.BatchGetAssetPropertyValueHistoryRequest();
  });
  ...
  describe('BatchGetAssetPropertyValueHistoryRequest', function() {
    it('should create an instance of BatchGetAssetPropertyValueHistoryRequest', function() {
      // uncomment below and update the code to test BatchGetAssetPropertyValueHistoryRequest
      //var instance = new AwsIoTSiteWise.BatchGetAssetPropertyValueHistoryRequest();
      //expect(instance).to.be.a(AwsIoTSiteWise.BatchGetAssetPropertyValueHistoryRequest);
    });
