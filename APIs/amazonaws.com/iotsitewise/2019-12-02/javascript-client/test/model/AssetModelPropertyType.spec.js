...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTSiteWise.AssetModelPropertyType();
  });
  ...
  describe('AssetModelPropertyType', function() {
    it('should create an instance of AssetModelPropertyType', function() {
      // uncomment below and update the code to test AssetModelPropertyType
      //var instance = new AwsIoTSiteWise.AssetModelPropertyType();
      //expect(instance).to.be.a(AwsIoTSiteWise.AssetModelPropertyType);
    });
