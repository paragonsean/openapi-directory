...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTSiteWise.UpdateDashboardRequest();
  });
  ...
  describe('UpdateDashboardRequest', function() {
    it('should create an instance of UpdateDashboardRequest', function() {
      // uncomment below and update the code to test UpdateDashboardRequest
      //var instance = new AwsIoTSiteWise.UpdateDashboardRequest();
      //expect(instance).to.be.a(AwsIoTSiteWise.UpdateDashboardRequest);
    });
