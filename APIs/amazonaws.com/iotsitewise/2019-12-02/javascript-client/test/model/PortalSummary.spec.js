...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTSiteWise.PortalSummary();
  });
  ...
  describe('PortalSummary', function() {
    it('should create an instance of PortalSummary', function() {
      // uncomment below and update the code to test PortalSummary
      //var instance = new AwsIoTSiteWise.PortalSummary();
      //expect(instance).to.be.a(AwsIoTSiteWise.PortalSummary);
    });
