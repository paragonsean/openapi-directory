...
(function(root, factory) {
  ...
  describe('DetailedErrorCode', function() {
    it('should create an instance of DetailedErrorCode', function() {
      // uncomment below and update the code to test DetailedErrorCode
      //var instance = new AwsIoTSiteWise.DetailedErrorCode();
      //expect(instance).to.be.a(AwsIoTSiteWise.DetailedErrorCode);
    });
