...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTSiteWise.CreateBulkImportJobResponse();
  });
  ...
  describe('CreateBulkImportJobResponse', function() {
    it('should create an instance of CreateBulkImportJobResponse', function() {
      // uncomment below and update the code to test CreateBulkImportJobResponse
      //var instance = new AwsIoTSiteWise.CreateBulkImportJobResponse();
      //expect(instance).to.be.a(AwsIoTSiteWise.CreateBulkImportJobResponse);
    });
