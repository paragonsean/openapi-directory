...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTSiteWise.Aggregates();
  });
  ...
  describe('Aggregates', function() {
    it('should create an instance of Aggregates', function() {
      // uncomment below and update the code to test Aggregates
      //var instance = new AwsIoTSiteWise.Aggregates();
      //expect(instance).to.be.a(AwsIoTSiteWise.Aggregates);
    });
