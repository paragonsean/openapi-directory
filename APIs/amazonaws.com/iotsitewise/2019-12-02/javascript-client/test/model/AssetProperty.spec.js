...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTSiteWise.AssetProperty();
  });
  ...
  describe('AssetProperty', function() {
    it('should create an instance of AssetProperty', function() {
      // uncomment below and update the code to test AssetProperty
      //var instance = new AwsIoTSiteWise.AssetProperty();
      //expect(instance).to.be.a(AwsIoTSiteWise.AssetProperty);
    });
