...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTSiteWise.DescribeAssetPropertyResponseAssetProperty();
  });
  ...
  describe('DescribeAssetPropertyResponseAssetProperty', function() {
    it('should create an instance of DescribeAssetPropertyResponseAssetProperty', function() {
      // uncomment below and update the code to test DescribeAssetPropertyResponseAssetProperty
      //var instance = new AwsIoTSiteWise.DescribeAssetPropertyResponseAssetProperty();
      //expect(instance).to.be.a(AwsIoTSiteWise.DescribeAssetPropertyResponseAssetProperty);
    });
