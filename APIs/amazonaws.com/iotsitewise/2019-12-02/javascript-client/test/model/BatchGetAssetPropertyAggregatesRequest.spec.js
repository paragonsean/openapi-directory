...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTSiteWise.BatchGetAssetPropertyAggregatesRequest();
  });
  ...
  describe('BatchGetAssetPropertyAggregatesRequest', function() {
    it('should create an instance of BatchGetAssetPropertyAggregatesRequest', function() {
      // uncomment below and update the code to test BatchGetAssetPropertyAggregatesRequest
      //var instance = new AwsIoTSiteWise.BatchGetAssetPropertyAggregatesRequest();
      //expect(instance).to.be.a(AwsIoTSiteWise.BatchGetAssetPropertyAggregatesRequest);
    });
