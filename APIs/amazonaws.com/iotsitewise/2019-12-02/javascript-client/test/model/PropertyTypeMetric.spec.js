...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTSiteWise.PropertyTypeMetric();
  });
  ...
  describe('PropertyTypeMetric', function() {
    it('should create an instance of PropertyTypeMetric', function() {
      // uncomment below and update the code to test PropertyTypeMetric
      //var instance = new AwsIoTSiteWise.PropertyTypeMetric();
      //expect(instance).to.be.a(AwsIoTSiteWise.PropertyTypeMetric);
    });
