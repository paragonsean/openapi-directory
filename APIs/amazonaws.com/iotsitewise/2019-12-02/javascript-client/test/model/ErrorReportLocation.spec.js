...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTSiteWise.ErrorReportLocation();
  });
  ...
  describe('ErrorReportLocation', function() {
    it('should create an instance of ErrorReportLocation', function() {
      // uncomment below and update the code to test ErrorReportLocation
      //var instance = new AwsIoTSiteWise.ErrorReportLocation();
      //expect(instance).to.be.a(AwsIoTSiteWise.ErrorReportLocation);
    });
