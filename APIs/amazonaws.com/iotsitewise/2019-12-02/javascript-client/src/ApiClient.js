...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://iotsitewise.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://iotsitewise.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2019-12-02/Javascript'
        };
