...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.CreateAccessPointInput();
  });
  ...
  describe('CreateAccessPointInput', function() {
    it('should create an instance of CreateAccessPointInput', function() {
      // uncomment below and update the code to test CreateAccessPointInput
      //var instance = new ElasticLoadBalancing.CreateAccessPointInput();
      //expect(instance).to.be.a(ElasticLoadBalancing.CreateAccessPointInput);
    });
