...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.ConfigureHealthCheckInputHealthCheck();
  });
  ...
  describe('ConfigureHealthCheckInputHealthCheck', function() {
    it('should create an instance of ConfigureHealthCheckInputHealthCheck', function() {
      // uncomment below and update the code to test ConfigureHealthCheckInputHealthCheck
      //var instance = new ElasticLoadBalancing.ConfigureHealthCheckInputHealthCheck();
      //expect(instance).to.be.a(ElasticLoadBalancing.ConfigureHealthCheckInputHealthCheck);
    });
