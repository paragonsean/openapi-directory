...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.Policies();
  });
  ...
  describe('Policies', function() {
    it('should create an instance of Policies', function() {
      ...
      //var instance = new ElasticLoadBalancing.Policies();
      //expect(instance).to.be.a(ElasticLoadBalancing.Policies);
    });

    it('should have the property appCookieStickinessPolicies (base name: "AppCookieStickinessPolicies")', function() {
      // uncomment below and update the code to test the property appCookieStickinessPolicies
      //var instance = new ElasticLoadBalancing.Policies();
      //expect(instance).to.be();
    });

    it('should have the property lBCookieStickinessPolicies (base name: "LBCookieStickinessPolicies")', function() {
      // uncomment below and update the code to test the property lBCookieStickinessPolicies
      //var instance = new ElasticLoadBalancing.Policies();
      //expect(instance).to.be();
    });

    it('should have the property otherPolicies (base name: "OtherPolicies")', function() {
      // uncomment below and update the code to test the property otherPolicies
      //var instance = new ElasticLoadBalancing.Policies();
      //expect(instance).to.be();
    });
