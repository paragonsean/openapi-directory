...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.CreateAccessPointOutput();
  });
  ...
  describe('CreateAccessPointOutput', function() {
    it('should create an instance of CreateAccessPointOutput', function() {
      // uncomment below and update the code to test CreateAccessPointOutput
      //var instance = new ElasticLoadBalancing.CreateAccessPointOutput();
      //expect(instance).to.be.a(ElasticLoadBalancing.CreateAccessPointOutput);
    });
