...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.AttachLoadBalancerToSubnetsOutput();
  });
  ...
  describe('AttachLoadBalancerToSubnetsOutput', function() {
    it('should create an instance of AttachLoadBalancerToSubnetsOutput', function() {
      // uncomment below and update the code to test AttachLoadBalancerToSubnetsOutput
      //var instance = new ElasticLoadBalancing.AttachLoadBalancerToSubnetsOutput();
      //expect(instance).to.be.a(ElasticLoadBalancing.AttachLoadBalancerToSubnetsOutput);
    });
