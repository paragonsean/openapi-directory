...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.LoadBalancerDescriptionPolicies();
  });
  ...
  describe('LoadBalancerDescriptionPolicies', function() {
    it('should create an instance of LoadBalancerDescriptionPolicies', function() {
      // uncomment below and update the code to test LoadBalancerDescriptionPolicies
      //var instance = new ElasticLoadBalancing.LoadBalancerDescriptionPolicies();
      //expect(instance).to.be.a(ElasticLoadBalancing.LoadBalancerDescriptionPolicies);
    });
