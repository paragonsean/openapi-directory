...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.LoadBalancerAttributes();
  });
  ...
  describe('LoadBalancerAttributes', function() {
    it('should create an instance of LoadBalancerAttributes', function() {
      // uncomment below and update the code to test LoadBalancerAttributes
      //var instance = new ElasticLoadBalancing.LoadBalancerAttributes();
      //expect(instance).to.be.a(ElasticLoadBalancing.LoadBalancerAttributes);
    });
