...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.LoadBalancerDescriptionSourceSecurityGroup();
  });
  ...
  describe('LoadBalancerDescriptionSourceSecurityGroup', function() {
    it('should create an instance of LoadBalancerDescriptionSourceSecurityGroup', function() {
      // uncomment below and update the code to test LoadBalancerDescriptionSourceSecurityGroup
      //var instance = new ElasticLoadBalancing.LoadBalancerDescriptionSourceSecurityGroup();
      //expect(instance).to.be.a(ElasticLoadBalancing.LoadBalancerDescriptionSourceSecurityGroup);
    });
