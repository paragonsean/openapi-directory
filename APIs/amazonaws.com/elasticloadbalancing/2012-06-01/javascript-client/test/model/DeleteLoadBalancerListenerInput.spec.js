...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.DeleteLoadBalancerListenerInput();
  });
  ...
  describe('DeleteLoadBalancerListenerInput', function() {
    it('should create an instance of DeleteLoadBalancerListenerInput', function() {
      // uncomment below and update the code to test DeleteLoadBalancerListenerInput
      //var instance = new ElasticLoadBalancing.DeleteLoadBalancerListenerInput();
      //expect(instance).to.be.a(ElasticLoadBalancing.DeleteLoadBalancerListenerInput);
    });
    ...
    it('should have the property loadBalancerPorts (base name: "LoadBalancerPorts")', function() {
      // uncomment below and update the code to test the property loadBalancerPorts
      //var instance = new ElasticLoadBalancing.DeleteLoadBalancerListenerInput();
      //expect(instance).to.be();
    });
