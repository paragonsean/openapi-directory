...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.DescribeLoadBalancerAttributesOutput();
  });
  ...
  describe('DescribeLoadBalancerAttributesOutput', function() {
    it('should create an instance of DescribeLoadBalancerAttributesOutput', function() {
      // uncomment below and update the code to test DescribeLoadBalancerAttributesOutput
      //var instance = new ElasticLoadBalancing.DescribeLoadBalancerAttributesOutput();
      //expect(instance).to.be.a(ElasticLoadBalancing.DescribeLoadBalancerAttributesOutput);
    });

    it('should have the property loadBalancerAttributes (base name: "LoadBalancerAttributes")', function() {
      // uncomment below and update the code to test the property loadBalancerAttributes
      //var instance = new ElasticLoadBalancing.DescribeLoadBalancerAttributesOutput();
