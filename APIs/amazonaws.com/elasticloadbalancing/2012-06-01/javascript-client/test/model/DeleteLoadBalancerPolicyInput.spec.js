...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.DeleteLoadBalancerPolicyInput();
  });
  ...
  describe('DeleteLoadBalancerPolicyInput', function() {
    it('should create an instance of DeleteLoadBalancerPolicyInput', function() {
      // uncomment below and update the code to test DeleteLoadBalancerPolicyInput
      //var instance = new ElasticLoadBalancing.DeleteLoadBalancerPolicyInput();
      //expect(instance).to.be.a(ElasticLoadBalancing.DeleteLoadBalancerPolicyInput);
    });
