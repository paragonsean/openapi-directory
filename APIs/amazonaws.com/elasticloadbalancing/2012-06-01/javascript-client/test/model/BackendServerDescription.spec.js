...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.BackendServerDescription();
  });
  ...
  describe('BackendServerDescription', function() {
    it('should create an instance of BackendServerDescription', function() {
      // uncomment below and update the code to test BackendServerDescription
      //var instance = new ElasticLoadBalancing.BackendServerDescription();
      //expect(instance).to.be.a(ElasticLoadBalancing.BackendServerDescription);
    });
