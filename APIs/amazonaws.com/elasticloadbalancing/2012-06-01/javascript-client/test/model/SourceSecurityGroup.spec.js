...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.SourceSecurityGroup();
  });
  ...
  describe('SourceSecurityGroup', function() {
    it('should create an instance of SourceSecurityGroup', function() {
      // uncomment below and update the code to test SourceSecurityGroup
      //var instance = new ElasticLoadBalancing.SourceSecurityGroup();
      //expect(instance).to.be.a(ElasticLoadBalancing.SourceSecurityGroup);
    });
