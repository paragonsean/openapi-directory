...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.SetLoadBalancerPoliciesOfListenerInput();
  });
  ...
  describe('SetLoadBalancerPoliciesOfListenerInput', function() {
    it('should create an instance of SetLoadBalancerPoliciesOfListenerInput', function() {
      // uncomment below and update the code to test SetLoadBalancerPoliciesOfListenerInput
      //var instance = new ElasticLoadBalancing.SetLoadBalancerPoliciesOfListenerInput();
      //expect(instance).to.be.a(ElasticLoadBalancing.SetLoadBalancerPoliciesOfListenerInput);
    });
