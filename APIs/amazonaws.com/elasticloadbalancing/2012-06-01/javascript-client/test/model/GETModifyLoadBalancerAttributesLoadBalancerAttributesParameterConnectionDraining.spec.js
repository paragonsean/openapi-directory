...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterConnectionDraining();
  });
  ...
  describe('GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterConnectionDraining', function() {
    it('should create an instance of GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterConnectionDraining', function() {
      // uncomment below and update the code to test GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterConnectionDraining
      //var instance = new ElasticLoadBalancing.GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterConnectionDraining();
      //expect(instance).to.be.a(ElasticLoadBalancing.GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterConnectionDraining);
    });
