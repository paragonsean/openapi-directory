...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.CrossZoneLoadBalancing();
  });
  ...
  describe('CrossZoneLoadBalancing', function() {
    it('should create an instance of CrossZoneLoadBalancing', function() {
      // uncomment below and update the code to test CrossZoneLoadBalancing
      //var instance = new ElasticLoadBalancing.CrossZoneLoadBalancing();
      //expect(instance).to.be.a(ElasticLoadBalancing.CrossZoneLoadBalancing);
    });
