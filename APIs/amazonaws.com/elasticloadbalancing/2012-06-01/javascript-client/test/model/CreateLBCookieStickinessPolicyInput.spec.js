...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.CreateLBCookieStickinessPolicyInput();
  });
  ...
  describe('CreateLBCookieStickinessPolicyInput', function() {
    it('should create an instance of CreateLBCookieStickinessPolicyInput', function() {
      // uncomment below and update the code to test CreateLBCookieStickinessPolicyInput
      //var instance = new ElasticLoadBalancing.CreateLBCookieStickinessPolicyInput();
      //expect(instance).to.be.a(ElasticLoadBalancing.CreateLBCookieStickinessPolicyInput);
    });
