...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.DescribeEndPointStateInput();
  });
  ...
  describe('DescribeEndPointStateInput', function() {
    it('should create an instance of DescribeEndPointStateInput', function() {
      // uncomment below and update the code to test DescribeEndPointStateInput
      //var instance = new ElasticLoadBalancing.DescribeEndPointStateInput();
      //expect(instance).to.be.a(ElasticLoadBalancing.DescribeEndPointStateInput);
    });
