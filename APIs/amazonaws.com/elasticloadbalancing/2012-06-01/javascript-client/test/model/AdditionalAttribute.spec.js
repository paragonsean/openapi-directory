...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.AdditionalAttribute();
  });
  ...
  describe('AdditionalAttribute', function() {
    it('should create an instance of AdditionalAttribute', function() {
      // uncomment below and update the code to test AdditionalAttribute
      //var instance = new ElasticLoadBalancing.AdditionalAttribute();
      //expect(instance).to.be.a(ElasticLoadBalancing.AdditionalAttribute);
    });
