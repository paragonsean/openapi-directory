...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.PolicyAttribute();
  });
  ...
  describe('PolicyAttribute', function() {
    it('should create an instance of PolicyAttribute', function() {
      // uncomment below and update the code to test PolicyAttribute
      //var instance = new ElasticLoadBalancing.PolicyAttribute();
      //expect(instance).to.be.a(ElasticLoadBalancing.PolicyAttribute);
    });
