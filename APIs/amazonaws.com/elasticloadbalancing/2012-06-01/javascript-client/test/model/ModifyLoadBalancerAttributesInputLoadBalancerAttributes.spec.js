...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.ModifyLoadBalancerAttributesInputLoadBalancerAttributes();
  });
  ...
  describe('ModifyLoadBalancerAttributesInputLoadBalancerAttributes', function() {
    it('should create an instance of ModifyLoadBalancerAttributesInputLoadBalancerAttributes', function() {
      // uncomment below and update the code to test ModifyLoadBalancerAttributesInputLoadBalancerAttributes
      //var instance = new ElasticLoadBalancing.ModifyLoadBalancerAttributesInputLoadBalancerAttributes();
      //expect(instance).to.be.a(ElasticLoadBalancing.ModifyLoadBalancerAttributesInputLoadBalancerAttributes);
    });
