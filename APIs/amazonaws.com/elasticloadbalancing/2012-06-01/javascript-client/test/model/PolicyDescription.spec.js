...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.PolicyDescription();
  });
  ...
  describe('PolicyDescription', function() {
    it('should create an instance of PolicyDescription', function() {
      // uncomment below and update the code to test PolicyDescription
      //var instance = new ElasticLoadBalancing.PolicyDescription();
      //expect(instance).to.be.a(ElasticLoadBalancing.PolicyDescription);
    });
    ...
    it('should have the property policyAttributeDescriptions (base name: "PolicyAttributeDescriptions")', function() {
      // uncomment below and update the code to test the property policyAttributeDescriptions
      //var instance = new ElasticLoadBalancing.PolicyDescription();
      //expect(instance).to.be();
    });
