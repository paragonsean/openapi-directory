...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.ConfigureHealthCheckInput();
  });
  ...
  describe('ConfigureHealthCheckInput', function() {
    it('should create an instance of ConfigureHealthCheckInput', function() {
      // uncomment below and update the code to test ConfigureHealthCheckInput
      //var instance = new ElasticLoadBalancing.ConfigureHealthCheckInput();
      //expect(instance).to.be.a(ElasticLoadBalancing.ConfigureHealthCheckInput);
    });
