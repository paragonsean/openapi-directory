...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.DeregisterEndPointsInput();
  });
  ...
  describe('DeregisterEndPointsInput', function() {
    it('should create an instance of DeregisterEndPointsInput', function() {
      // uncomment below and update the code to test DeregisterEndPointsInput
      //var instance = new ElasticLoadBalancing.DeregisterEndPointsInput();
      //expect(instance).to.be.a(ElasticLoadBalancing.DeregisterEndPointsInput);
    });
