...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.ApplySecurityGroupsToLoadBalancerOutput();
  });
  ...
  describe('ApplySecurityGroupsToLoadBalancerOutput', function() {
    it('should create an instance of ApplySecurityGroupsToLoadBalancerOutput', function() {
      // uncomment below and update the code to test ApplySecurityGroupsToLoadBalancerOutput
      //var instance = new ElasticLoadBalancing.ApplySecurityGroupsToLoadBalancerOutput();
      //expect(instance).to.be.a(ElasticLoadBalancing.ApplySecurityGroupsToLoadBalancerOutput);
    });
