...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.DescribeTagsInput();
  });
  ...
  describe('DescribeTagsInput', function() {
    it('should create an instance of DescribeTagsInput', function() {
      // uncomment below and update the code to test DescribeTagsInput
      //var instance = new ElasticLoadBalancing.DescribeTagsInput();
      //expect(instance).to.be.a(ElasticLoadBalancing.DescribeTagsInput);
    });
