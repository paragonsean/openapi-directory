...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.AddAvailabilityZonesOutput();
  });
  ...
  describe('AddAvailabilityZonesOutput', function() {
    it('should create an instance of AddAvailabilityZonesOutput', function() {
      // uncomment below and update the code to test AddAvailabilityZonesOutput
      //var instance = new ElasticLoadBalancing.AddAvailabilityZonesOutput();
      //expect(instance).to.be.a(ElasticLoadBalancing.AddAvailabilityZonesOutput);
    });
