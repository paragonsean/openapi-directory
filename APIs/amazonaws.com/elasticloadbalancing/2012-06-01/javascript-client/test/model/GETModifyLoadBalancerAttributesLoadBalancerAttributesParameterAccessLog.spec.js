...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterAccessLog();
  });
  ...
  describe('GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterAccessLog', function() {
    it('should create an instance of GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterAccessLog', function() {
      // uncomment below and update the code to test GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterAccessLog
      //var instance = new ElasticLoadBalancing.GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterAccessLog();
      //expect(instance).to.be.a(ElasticLoadBalancing.GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterAccessLog);
    });
    ...
    it('should have the property emitInterval (base name: "EmitInterval")', function() {
      // uncomment below and update the code to test the property emitInterval
      //var instance = new ElasticLoadBalancing.GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterAccessLog();
      //expect(instance).to.be();
    });

    it('should have the property s3BucketPrefix (base name: "S3BucketPrefix")', function() {
      // uncomment below and update the code to test the property s3BucketPrefix
      //var instance = new ElasticLoadBalancing.GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterAccessLog();
      //expect(instance).to.be();
    });
