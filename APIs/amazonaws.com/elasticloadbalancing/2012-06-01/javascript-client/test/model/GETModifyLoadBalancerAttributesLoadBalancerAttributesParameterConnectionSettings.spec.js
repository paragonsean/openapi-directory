...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterConnectionSettings();
  });
  ...
  describe('GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterConnectionSettings', function() {
    it('should create an instance of GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterConnectionSettings', function() {
      // uncomment below and update the code to test GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterConnectionSettings
      //var instance = new ElasticLoadBalancing.GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterConnectionSettings();
      //expect(instance).to.be.a(ElasticLoadBalancing.GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterConnectionSettings);
    });
