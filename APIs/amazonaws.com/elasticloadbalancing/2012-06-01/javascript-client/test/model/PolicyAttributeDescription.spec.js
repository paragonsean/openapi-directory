...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.PolicyAttributeDescription();
  });
  ...
  describe('PolicyAttributeDescription', function() {
    it('should create an instance of PolicyAttributeDescription', function() {
      // uncomment below and update the code to test PolicyAttributeDescription
      //var instance = new ElasticLoadBalancing.PolicyAttributeDescription();
      //expect(instance).to.be.a(ElasticLoadBalancing.PolicyAttributeDescription);
    });
