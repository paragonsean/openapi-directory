...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.RegisterEndPointsInput();
  });
  ...
  describe('RegisterEndPointsInput', function() {
    it('should create an instance of RegisterEndPointsInput', function() {
      // uncomment below and update the code to test RegisterEndPointsInput
      //var instance = new ElasticLoadBalancing.RegisterEndPointsInput();
      //expect(instance).to.be.a(ElasticLoadBalancing.RegisterEndPointsInput);
    });
