...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.Listener();
  });
  ...
  describe('Listener', function() {
    it('should create an instance of Listener', function() {
      // uncomment below and update the code to test Listener
      //var instance = new ElasticLoadBalancing.Listener();
      //expect(instance).to.be.a(ElasticLoadBalancing.Listener);
    });
    ...
    it('should have the property loadBalancerPort (base name: "LoadBalancerPort")', function() {
      // uncomment below and update the code to test the property loadBalancerPort
      //var instance = new ElasticLoadBalancing.Listener();
      //expect(instance).to.be();
    });

    it('should have the property instanceProtocol (base name: "InstanceProtocol")', function() {
      // uncomment below and update the code to test the property instanceProtocol
      //var instance = new ElasticLoadBalancing.Listener();
      //expect(instance).to.be();
    });

    it('should have the property instancePort (base name: "InstancePort")', function() {
      // uncomment below and update the code to test the property instancePort
      //var instance = new ElasticLoadBalancing.Listener();
      //expect(instance).to.be();
    });

    it('should have the property sSLCertificateId (base name: "SSLCertificateId")', function() {
      // uncomment below and update the code to test the property sSLCertificateId
      //var instance = new ElasticLoadBalancing.Listener();
      //expect(instance).to.be();
    });
