...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.ConfigureHealthCheckOutputHealthCheck();
  });
  ...
  describe('ConfigureHealthCheckOutputHealthCheck', function() {
    it('should create an instance of ConfigureHealthCheckOutputHealthCheck', function() {
      // uncomment below and update the code to test ConfigureHealthCheckOutputHealthCheck
      //var instance = new ElasticLoadBalancing.ConfigureHealthCheckOutputHealthCheck();
      //expect(instance).to.be.a(ElasticLoadBalancing.ConfigureHealthCheckOutputHealthCheck);
    });
