...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.TagDescription();
  });
  ...
  describe('TagDescription', function() {
    it('should create an instance of TagDescription', function() {
      ...
      //var instance = new ElasticLoadBalancing.TagDescription();
      //expect(instance).to.be.a(ElasticLoadBalancing.TagDescription);
    });
