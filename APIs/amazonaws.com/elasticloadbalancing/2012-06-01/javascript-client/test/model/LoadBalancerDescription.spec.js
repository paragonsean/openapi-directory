...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.LoadBalancerDescription();
  });
  ...
  describe('LoadBalancerDescription', function() {
    it('should create an instance of LoadBalancerDescription', function() {
      // uncomment below and update the code to test LoadBalancerDescription
      //var instance = new ElasticLoadBalancing.LoadBalancerDescription();
      //expect(instance).to.be.a(ElasticLoadBalancing.LoadBalancerDescription);
    });
    ...
    it('should have the property canonicalHostedZoneName (base name: "CanonicalHostedZoneName")', function() {
      // uncomment below and update the code to test the property canonicalHostedZoneName
      //var instance = new ElasticLoadBalancing.LoadBalancerDescription();
      //expect(instance).to.be();
    });

    it('should have the property canonicalHostedZoneNameID (base name: "CanonicalHostedZoneNameID")', function() {
      // uncomment below and update the code to test the property canonicalHostedZoneNameID
      //var instance = new ElasticLoadBalancing.LoadBalancerDescription();
      //expect(instance).to.be();
    });

    it('should have the property listenerDescriptions (base name: "ListenerDescriptions")', function() {
      // uncomment below and update the code to test the property listenerDescriptions
      //var instance = new ElasticLoadBalancing.LoadBalancerDescription();
      //expect(instance).to.be();
    });
    ...
    it('should have the property backendServerDescriptions (base name: "BackendServerDescriptions")', function() {
      // uncomment below and update the code to test the property backendServerDescriptions
      //var instance = new ElasticLoadBalancing.LoadBalancerDescription();
      //expect(instance).to.be();
    });
    ...
    it('should have the property sourceSecurityGroup (base name: "SourceSecurityGroup")', function() {
      // uncomment below and update the code to test the property sourceSecurityGroup
      //var instance = new ElasticLoadBalancing.LoadBalancerDescription();
      //expect(instance).to.be();
    });
