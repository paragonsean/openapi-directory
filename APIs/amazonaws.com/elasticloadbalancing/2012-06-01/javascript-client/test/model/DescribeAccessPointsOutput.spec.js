...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.DescribeAccessPointsOutput();
  });
  ...
  describe('DescribeAccessPointsOutput', function() {
    it('should create an instance of DescribeAccessPointsOutput', function() {
      // uncomment below and update the code to test DescribeAccessPointsOutput
      //var instance = new ElasticLoadBalancing.DescribeAccessPointsOutput();
      //expect(instance).to.be.a(ElasticLoadBalancing.DescribeAccessPointsOutput);
    });

    it('should have the property loadBalancerDescriptions (base name: "LoadBalancerDescriptions")', function() {
      // uncomment below and update the code to test the property loadBalancerDescriptions
      //var instance = new ElasticLoadBalancing.DescribeAccessPointsOutput();
