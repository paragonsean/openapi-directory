...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.DescribeLoadBalancerAttributesOutputLoadBalancerAttributes();
  });
  ...
  describe('DescribeLoadBalancerAttributesOutputLoadBalancerAttributes', function() {
    it('should create an instance of DescribeLoadBalancerAttributesOutputLoadBalancerAttributes', function() {
      // uncomment below and update the code to test DescribeLoadBalancerAttributesOutputLoadBalancerAttributes
      //var instance = new ElasticLoadBalancing.DescribeLoadBalancerAttributesOutputLoadBalancerAttributes();
      //expect(instance).to.be.a(ElasticLoadBalancing.DescribeLoadBalancerAttributesOutputLoadBalancerAttributes);
    });

    it('should have the property crossZoneLoadBalancing (base name: "CrossZoneLoadBalancing")', function() {
      // uncomment below and update the code to test the property crossZoneLoadBalancing
      //var instance = new ElasticLoadBalancing.DescribeLoadBalancerAttributesOutputLoadBalancerAttributes();
    ...
    it('should have the property connectionSettings (base name: "ConnectionSettings")', function() {
      // uncomment below and update the code to test the property connectionSettings
      //var instance = new ElasticLoadBalancing.DescribeLoadBalancerAttributesOutputLoadBalancerAttributes();
      //expect(instance).to.be();
    });
