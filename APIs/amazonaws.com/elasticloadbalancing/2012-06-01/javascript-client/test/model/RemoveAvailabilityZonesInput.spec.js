...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.RemoveAvailabilityZonesInput();
  });
  ...
  describe('RemoveAvailabilityZonesInput', function() {
    it('should create an instance of RemoveAvailabilityZonesInput', function() {
      // uncomment below and update the code to test RemoveAvailabilityZonesInput
      //var instance = new ElasticLoadBalancing.RemoveAvailabilityZonesInput();
      //expect(instance).to.be.a(ElasticLoadBalancing.RemoveAvailabilityZonesInput);
    });
