...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.ApplySecurityGroupsToLoadBalancerInput();
  });
  ...
  describe('ApplySecurityGroupsToLoadBalancerInput', function() {
    it('should create an instance of ApplySecurityGroupsToLoadBalancerInput', function() {
      // uncomment below and update the code to test ApplySecurityGroupsToLoadBalancerInput
      //var instance = new ElasticLoadBalancing.ApplySecurityGroupsToLoadBalancerInput();
      //expect(instance).to.be.a(ElasticLoadBalancing.ApplySecurityGroupsToLoadBalancerInput);
    });
