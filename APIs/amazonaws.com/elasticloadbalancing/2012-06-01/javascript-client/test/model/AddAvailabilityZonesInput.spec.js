...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.AddAvailabilityZonesInput();
  });
  ...
  describe('AddAvailabilityZonesInput', function() {
    it('should create an instance of AddAvailabilityZonesInput', function() {
      // uncomment below and update the code to test AddAvailabilityZonesInput
      //var instance = new ElasticLoadBalancing.AddAvailabilityZonesInput();
      //expect(instance).to.be.a(ElasticLoadBalancing.AddAvailabilityZonesInput);
    });
