...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.SetLoadBalancerListenerSSLCertificateInput();
  });
  ...
  describe('SetLoadBalancerListenerSSLCertificateInput', function() {
    it('should create an instance of SetLoadBalancerListenerSSLCertificateInput', function() {
      // uncomment below and update the code to test SetLoadBalancerListenerSSLCertificateInput
      //var instance = new ElasticLoadBalancing.SetLoadBalancerListenerSSLCertificateInput();
      //expect(instance).to.be.a(ElasticLoadBalancing.SetLoadBalancerListenerSSLCertificateInput);
    });
