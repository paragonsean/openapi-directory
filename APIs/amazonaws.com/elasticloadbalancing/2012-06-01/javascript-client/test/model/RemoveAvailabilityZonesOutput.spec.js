...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.RemoveAvailabilityZonesOutput();
  });
  ...
  describe('RemoveAvailabilityZonesOutput', function() {
    it('should create an instance of RemoveAvailabilityZonesOutput', function() {
      // uncomment below and update the code to test RemoveAvailabilityZonesOutput
      //var instance = new ElasticLoadBalancing.RemoveAvailabilityZonesOutput();
      //expect(instance).to.be.a(ElasticLoadBalancing.RemoveAvailabilityZonesOutput);
    });
