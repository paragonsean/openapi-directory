...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.DescribeAccessPointsInput();
  });
  ...
  describe('DescribeAccessPointsInput', function() {
    it('should create an instance of DescribeAccessPointsInput', function() {
      // uncomment below and update the code to test DescribeAccessPointsInput
      //var instance = new ElasticLoadBalancing.DescribeAccessPointsInput();
      //expect(instance).to.be.a(ElasticLoadBalancing.DescribeAccessPointsInput);
    });
