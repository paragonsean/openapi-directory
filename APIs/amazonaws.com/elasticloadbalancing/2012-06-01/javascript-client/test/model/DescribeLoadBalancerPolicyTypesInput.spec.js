...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.DescribeLoadBalancerPolicyTypesInput();
  });
  ...
  describe('DescribeLoadBalancerPolicyTypesInput', function() {
    it('should create an instance of DescribeLoadBalancerPolicyTypesInput', function() {
      // uncomment below and update the code to test DescribeLoadBalancerPolicyTypesInput
      //var instance = new ElasticLoadBalancing.DescribeLoadBalancerPolicyTypesInput();
      //expect(instance).to.be.a(ElasticLoadBalancing.DescribeLoadBalancerPolicyTypesInput);
    });

    it('should have the property policyTypeNames (base name: "PolicyTypeNames")', function() {
      // uncomment below and update the code to test the property policyTypeNames
      //var instance = new ElasticLoadBalancing.DescribeLoadBalancerPolicyTypesInput();
