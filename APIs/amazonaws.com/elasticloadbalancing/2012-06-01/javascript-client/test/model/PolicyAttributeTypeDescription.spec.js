...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.PolicyAttributeTypeDescription();
  });
  ...
  describe('PolicyAttributeTypeDescription', function() {
    it('should create an instance of PolicyAttributeTypeDescription', function() {
      // uncomment below and update the code to test PolicyAttributeTypeDescription
      //var instance = new ElasticLoadBalancing.PolicyAttributeTypeDescription();
      //expect(instance).to.be.a(ElasticLoadBalancing.PolicyAttributeTypeDescription);
    });
