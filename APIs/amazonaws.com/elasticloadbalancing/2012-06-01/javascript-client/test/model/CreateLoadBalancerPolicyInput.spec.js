...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.CreateLoadBalancerPolicyInput();
  });
  ...
  describe('CreateLoadBalancerPolicyInput', function() {
    it('should create an instance of CreateLoadBalancerPolicyInput', function() {
      // uncomment below and update the code to test CreateLoadBalancerPolicyInput
      //var instance = new ElasticLoadBalancing.CreateLoadBalancerPolicyInput();
      //expect(instance).to.be.a(ElasticLoadBalancing.CreateLoadBalancerPolicyInput);
    });
    ...
    it('should have the property policyAttributes (base name: "PolicyAttributes")', function() {
      // uncomment below and update the code to test the property policyAttributes
      //var instance = new ElasticLoadBalancing.CreateLoadBalancerPolicyInput();
      //expect(instance).to.be();
    });
