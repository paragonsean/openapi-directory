...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.ListenerDescriptionListener();
  });
  ...
  describe('ListenerDescriptionListener', function() {
    it('should create an instance of ListenerDescriptionListener', function() {
      // uncomment below and update the code to test ListenerDescriptionListener
      //var instance = new ElasticLoadBalancing.ListenerDescriptionListener();
      //expect(instance).to.be.a(ElasticLoadBalancing.ListenerDescriptionListener);
    });
