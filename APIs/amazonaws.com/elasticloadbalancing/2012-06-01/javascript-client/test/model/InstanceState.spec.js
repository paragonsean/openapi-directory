...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.InstanceState();
  });
  ...
  describe('InstanceState', function() {
    it('should create an instance of InstanceState', function() {
      ...
      //var instance = new ElasticLoadBalancing.InstanceState();
      //expect(instance).to.be.a(ElasticLoadBalancing.InstanceState);
    });
