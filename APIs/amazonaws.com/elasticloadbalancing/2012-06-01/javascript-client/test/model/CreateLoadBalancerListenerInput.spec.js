...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.CreateLoadBalancerListenerInput();
  });
  ...
  describe('CreateLoadBalancerListenerInput', function() {
    it('should create an instance of CreateLoadBalancerListenerInput', function() {
      // uncomment below and update the code to test CreateLoadBalancerListenerInput
      //var instance = new ElasticLoadBalancing.CreateLoadBalancerListenerInput();
      //expect(instance).to.be.a(ElasticLoadBalancing.CreateLoadBalancerListenerInput);
    });
