...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.AppCookieStickinessPolicy();
  });
  ...
  describe('AppCookieStickinessPolicy', function() {
    it('should create an instance of AppCookieStickinessPolicy', function() {
      // uncomment below and update the code to test AppCookieStickinessPolicy
      //var instance = new ElasticLoadBalancing.AppCookieStickinessPolicy();
      //expect(instance).to.be.a(ElasticLoadBalancing.AppCookieStickinessPolicy);
    });
