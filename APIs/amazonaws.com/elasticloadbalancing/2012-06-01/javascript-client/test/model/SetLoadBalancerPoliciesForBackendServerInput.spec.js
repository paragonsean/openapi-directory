...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.SetLoadBalancerPoliciesForBackendServerInput();
  });
  ...
  describe('SetLoadBalancerPoliciesForBackendServerInput', function() {
    it('should create an instance of SetLoadBalancerPoliciesForBackendServerInput', function() {
      // uncomment below and update the code to test SetLoadBalancerPoliciesForBackendServerInput
      //var instance = new ElasticLoadBalancing.SetLoadBalancerPoliciesForBackendServerInput();
      //expect(instance).to.be.a(ElasticLoadBalancing.SetLoadBalancerPoliciesForBackendServerInput);
    });
