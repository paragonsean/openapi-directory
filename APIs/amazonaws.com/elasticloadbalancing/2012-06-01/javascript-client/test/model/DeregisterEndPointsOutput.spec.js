...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.DeregisterEndPointsOutput();
  });
  ...
  describe('DeregisterEndPointsOutput', function() {
    it('should create an instance of DeregisterEndPointsOutput', function() {
      // uncomment below and update the code to test DeregisterEndPointsOutput
      //var instance = new ElasticLoadBalancing.DeregisterEndPointsOutput();
      //expect(instance).to.be.a(ElasticLoadBalancing.DeregisterEndPointsOutput);
    });
