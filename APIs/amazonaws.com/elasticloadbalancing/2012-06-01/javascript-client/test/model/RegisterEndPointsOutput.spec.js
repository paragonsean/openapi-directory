...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.RegisterEndPointsOutput();
  });
  ...
  describe('RegisterEndPointsOutput', function() {
    it('should create an instance of RegisterEndPointsOutput', function() {
      // uncomment below and update the code to test RegisterEndPointsOutput
      //var instance = new ElasticLoadBalancing.RegisterEndPointsOutput();
      //expect(instance).to.be.a(ElasticLoadBalancing.RegisterEndPointsOutput);
    });
