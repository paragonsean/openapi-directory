...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.CreateAppCookieStickinessPolicyInput();
  });
  ...
  describe('CreateAppCookieStickinessPolicyInput', function() {
    it('should create an instance of CreateAppCookieStickinessPolicyInput', function() {
      // uncomment below and update the code to test CreateAppCookieStickinessPolicyInput
      //var instance = new ElasticLoadBalancing.CreateAppCookieStickinessPolicyInput();
      //expect(instance).to.be.a(ElasticLoadBalancing.CreateAppCookieStickinessPolicyInput);
    });
    ...
    it('should have the property cookieName (base name: "CookieName")', function() {
      // uncomment below and update the code to test the property cookieName
      //var instance = new ElasticLoadBalancing.CreateAppCookieStickinessPolicyInput();
      //expect(instance).to.be();
    });
