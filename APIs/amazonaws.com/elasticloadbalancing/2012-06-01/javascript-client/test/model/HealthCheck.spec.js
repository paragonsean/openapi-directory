...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.HealthCheck();
  });
  ...
  describe('HealthCheck', function() {
    it('should create an instance of HealthCheck', function() {
      ...
      //var instance = new ElasticLoadBalancing.HealthCheck();
      //expect(instance).to.be.a(ElasticLoadBalancing.HealthCheck);
    });
