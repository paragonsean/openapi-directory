...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.LoadBalancerDescriptionHealthCheck();
  });
  ...
  describe('LoadBalancerDescriptionHealthCheck', function() {
    it('should create an instance of LoadBalancerDescriptionHealthCheck', function() {
      // uncomment below and update the code to test LoadBalancerDescriptionHealthCheck
      //var instance = new ElasticLoadBalancing.LoadBalancerDescriptionHealthCheck();
      //expect(instance).to.be.a(ElasticLoadBalancing.LoadBalancerDescriptionHealthCheck);
    });
