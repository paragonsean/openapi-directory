...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.ConfigureHealthCheckOutput();
  });
  ...
  describe('ConfigureHealthCheckOutput', function() {
    it('should create an instance of ConfigureHealthCheckOutput', function() {
      // uncomment below and update the code to test ConfigureHealthCheckOutput
      //var instance = new ElasticLoadBalancing.ConfigureHealthCheckOutput();
      //expect(instance).to.be.a(ElasticLoadBalancing.ConfigureHealthCheckOutput);
    });
