...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.ConnectionDraining();
  });
  ...
  describe('ConnectionDraining', function() {
    it('should create an instance of ConnectionDraining', function() {
      // uncomment below and update the code to test ConnectionDraining
      //var instance = new ElasticLoadBalancing.ConnectionDraining();
      //expect(instance).to.be.a(ElasticLoadBalancing.ConnectionDraining);
    });
