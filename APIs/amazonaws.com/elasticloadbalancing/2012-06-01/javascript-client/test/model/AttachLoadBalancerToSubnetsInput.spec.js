...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.AttachLoadBalancerToSubnetsInput();
  });
  ...
  describe('AttachLoadBalancerToSubnetsInput', function() {
    it('should create an instance of AttachLoadBalancerToSubnetsInput', function() {
      // uncomment below and update the code to test AttachLoadBalancerToSubnetsInput
      //var instance = new ElasticLoadBalancing.AttachLoadBalancerToSubnetsInput();
      //expect(instance).to.be.a(ElasticLoadBalancing.AttachLoadBalancerToSubnetsInput);
    });
