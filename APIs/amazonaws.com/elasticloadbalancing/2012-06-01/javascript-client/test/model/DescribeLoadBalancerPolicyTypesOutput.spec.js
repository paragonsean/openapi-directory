...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.DescribeLoadBalancerPolicyTypesOutput();
  });
  ...
  describe('DescribeLoadBalancerPolicyTypesOutput', function() {
    it('should create an instance of DescribeLoadBalancerPolicyTypesOutput', function() {
      // uncomment below and update the code to test DescribeLoadBalancerPolicyTypesOutput
      //var instance = new ElasticLoadBalancing.DescribeLoadBalancerPolicyTypesOutput();
      //expect(instance).to.be.a(ElasticLoadBalancing.DescribeLoadBalancerPolicyTypesOutput);
    });

    it('should have the property policyTypeDescriptions (base name: "PolicyTypeDescriptions")', function() {
      // uncomment below and update the code to test the property policyTypeDescriptions
      //var instance = new ElasticLoadBalancing.DescribeLoadBalancerPolicyTypesOutput();
