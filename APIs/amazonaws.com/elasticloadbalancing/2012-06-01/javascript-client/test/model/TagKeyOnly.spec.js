...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.TagKeyOnly();
  });
  ...
  describe('TagKeyOnly', function() {
    it('should create an instance of TagKeyOnly', function() {
      // uncomment below and update the code to test TagKeyOnly
      //var instance = new ElasticLoadBalancing.TagKeyOnly();
      //expect(instance).to.be.a(ElasticLoadBalancing.TagKeyOnly);
    });
