...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterCrossZoneLoadBalancing();
  });
  ...
  describe('GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterCrossZoneLoadBalancing', function() {
    it('should create an instance of GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterCrossZoneLoadBalancing', function() {
      // uncomment below and update the code to test GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterCrossZoneLoadBalancing
      //var instance = new ElasticLoadBalancing.GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterCrossZoneLoadBalancing();
      //expect(instance).to.be.a(ElasticLoadBalancing.GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterCrossZoneLoadBalancing);
    });
