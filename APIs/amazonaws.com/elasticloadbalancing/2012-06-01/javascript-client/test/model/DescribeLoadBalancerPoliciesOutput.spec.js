...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.DescribeLoadBalancerPoliciesOutput();
  });
  ...
  describe('DescribeLoadBalancerPoliciesOutput', function() {
    it('should create an instance of DescribeLoadBalancerPoliciesOutput', function() {
      // uncomment below and update the code to test DescribeLoadBalancerPoliciesOutput
      //var instance = new ElasticLoadBalancing.DescribeLoadBalancerPoliciesOutput();
      //expect(instance).to.be.a(ElasticLoadBalancing.DescribeLoadBalancerPoliciesOutput);
    });

    it('should have the property policyDescriptions (base name: "PolicyDescriptions")', function() {
      // uncomment below and update the code to test the property policyDescriptions
      //var instance = new ElasticLoadBalancing.DescribeLoadBalancerPoliciesOutput();
