...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.GETModifyLoadBalancerAttributesLoadBalancerAttributesParameter();
  });
  ...
  describe('GETModifyLoadBalancerAttributesLoadBalancerAttributesParameter', function() {
    it('should create an instance of GETModifyLoadBalancerAttributesLoadBalancerAttributesParameter', function() {
      // uncomment below and update the code to test GETModifyLoadBalancerAttributesLoadBalancerAttributesParameter
      //var instance = new ElasticLoadBalancing.GETModifyLoadBalancerAttributesLoadBalancerAttributesParameter();
      //expect(instance).to.be.a(ElasticLoadBalancing.GETModifyLoadBalancerAttributesLoadBalancerAttributesParameter);
    });
