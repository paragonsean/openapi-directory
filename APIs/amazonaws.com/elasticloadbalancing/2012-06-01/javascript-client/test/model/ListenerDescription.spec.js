...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.ListenerDescription();
  });
  ...
  describe('ListenerDescription', function() {
    it('should create an instance of ListenerDescription', function() {
      // uncomment below and update the code to test ListenerDescription
      //var instance = new ElasticLoadBalancing.ListenerDescription();
      //expect(instance).to.be.a(ElasticLoadBalancing.ListenerDescription);
    });
