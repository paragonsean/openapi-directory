...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.DescribeEndPointStateOutput();
  });
  ...
  describe('DescribeEndPointStateOutput', function() {
    it('should create an instance of DescribeEndPointStateOutput', function() {
      // uncomment below and update the code to test DescribeEndPointStateOutput
      //var instance = new ElasticLoadBalancing.DescribeEndPointStateOutput();
      //expect(instance).to.be.a(ElasticLoadBalancing.DescribeEndPointStateOutput);
    });

    it('should have the property instanceStates (base name: "InstanceStates")', function() {
      // uncomment below and update the code to test the property instanceStates
      //var instance = new ElasticLoadBalancing.DescribeEndPointStateOutput();
