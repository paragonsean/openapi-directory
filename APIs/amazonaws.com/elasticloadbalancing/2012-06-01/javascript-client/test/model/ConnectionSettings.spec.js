...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.ConnectionSettings();
  });
  ...
  describe('ConnectionSettings', function() {
    it('should create an instance of ConnectionSettings', function() {
      // uncomment below and update the code to test ConnectionSettings
      //var instance = new ElasticLoadBalancing.ConnectionSettings();
      //expect(instance).to.be.a(ElasticLoadBalancing.ConnectionSettings);
    });
