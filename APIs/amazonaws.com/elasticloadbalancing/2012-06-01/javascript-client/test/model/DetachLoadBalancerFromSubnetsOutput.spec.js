...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.DetachLoadBalancerFromSubnetsOutput();
  });
  ...
  describe('DetachLoadBalancerFromSubnetsOutput', function() {
    it('should create an instance of DetachLoadBalancerFromSubnetsOutput', function() {
      // uncomment below and update the code to test DetachLoadBalancerFromSubnetsOutput
      //var instance = new ElasticLoadBalancing.DetachLoadBalancerFromSubnetsOutput();
      //expect(instance).to.be.a(ElasticLoadBalancing.DetachLoadBalancerFromSubnetsOutput);
    });
