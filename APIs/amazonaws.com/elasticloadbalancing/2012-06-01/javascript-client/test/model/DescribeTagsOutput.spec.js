...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.DescribeTagsOutput();
  });
  ...
  describe('DescribeTagsOutput', function() {
    it('should create an instance of DescribeTagsOutput', function() {
      // uncomment below and update the code to test DescribeTagsOutput
      //var instance = new ElasticLoadBalancing.DescribeTagsOutput();
      //expect(instance).to.be.a(ElasticLoadBalancing.DescribeTagsOutput);
    });

    it('should have the property tagDescriptions (base name: "TagDescriptions")', function() {
      // uncomment below and update the code to test the property tagDescriptions
      //var instance = new ElasticLoadBalancing.DescribeTagsOutput();
