...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.DetachLoadBalancerFromSubnetsInput();
  });
  ...
  describe('DetachLoadBalancerFromSubnetsInput', function() {
    it('should create an instance of DetachLoadBalancerFromSubnetsInput', function() {
      // uncomment below and update the code to test DetachLoadBalancerFromSubnetsInput
      //var instance = new ElasticLoadBalancing.DetachLoadBalancerFromSubnetsInput();
      //expect(instance).to.be.a(ElasticLoadBalancing.DetachLoadBalancerFromSubnetsInput);
    });
