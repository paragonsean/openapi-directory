...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.DescribeLoadBalancerPoliciesInput();
  });
  ...
  describe('DescribeLoadBalancerPoliciesInput', function() {
    it('should create an instance of DescribeLoadBalancerPoliciesInput', function() {
      // uncomment below and update the code to test DescribeLoadBalancerPoliciesInput
      //var instance = new ElasticLoadBalancing.DescribeLoadBalancerPoliciesInput();
      //expect(instance).to.be.a(ElasticLoadBalancing.DescribeLoadBalancerPoliciesInput);
    });
    ...
    it('should have the property policyNames (base name: "PolicyNames")', function() {
      // uncomment below and update the code to test the property policyNames
      //var instance = new ElasticLoadBalancing.DescribeLoadBalancerPoliciesInput();
      //expect(instance).to.be();
    });
