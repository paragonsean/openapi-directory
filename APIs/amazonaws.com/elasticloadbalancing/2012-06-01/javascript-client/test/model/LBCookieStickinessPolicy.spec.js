...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.LBCookieStickinessPolicy();
  });
  ...
  describe('LBCookieStickinessPolicy', function() {
    it('should create an instance of LBCookieStickinessPolicy', function() {
      // uncomment below and update the code to test LBCookieStickinessPolicy
      //var instance = new ElasticLoadBalancing.LBCookieStickinessPolicy();
      //expect(instance).to.be.a(ElasticLoadBalancing.LBCookieStickinessPolicy);
    });
    ...
    it('should have the property cookieExpirationPeriod (base name: "CookieExpirationPeriod")', function() {
      // uncomment below and update the code to test the property cookieExpirationPeriod
      //var instance = new ElasticLoadBalancing.LBCookieStickinessPolicy();
      //expect(instance).to.be();
    });
