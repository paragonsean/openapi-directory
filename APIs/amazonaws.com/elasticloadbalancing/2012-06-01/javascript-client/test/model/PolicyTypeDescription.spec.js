...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.PolicyTypeDescription();
  });
  ...
  describe('PolicyTypeDescription', function() {
    it('should create an instance of PolicyTypeDescription', function() {
      // uncomment below and update the code to test PolicyTypeDescription
      //var instance = new ElasticLoadBalancing.PolicyTypeDescription();
      //expect(instance).to.be.a(ElasticLoadBalancing.PolicyTypeDescription);
    });

    it('should have the property policyTypeName (base name: "PolicyTypeName")', function() {
      // uncomment below and update the code to test the property policyTypeName
      //var instance = new ElasticLoadBalancing.PolicyTypeDescription();
    ...
    it('should have the property policyAttributeTypeDescriptions (base name: "PolicyAttributeTypeDescriptions")', function() {
      // uncomment below and update the code to test the property policyAttributeTypeDescriptions
      //var instance = new ElasticLoadBalancing.PolicyTypeDescription();
      //expect(instance).to.be();
    });
