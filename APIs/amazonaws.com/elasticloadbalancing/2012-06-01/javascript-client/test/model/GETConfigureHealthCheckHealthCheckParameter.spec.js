...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElasticLoadBalancing.GETConfigureHealthCheckHealthCheckParameter();
  });
  ...
  describe('GETConfigureHealthCheckHealthCheckParameter', function() {
    it('should create an instance of GETConfigureHealthCheckHealthCheckParameter', function() {
      // uncomment below and update the code to test GETConfigureHealthCheckHealthCheckParameter
      //var instance = new ElasticLoadBalancing.GETConfigureHealthCheckHealthCheckParameter();
      //expect(instance).to.be.a(ElasticLoadBalancing.GETConfigureHealthCheckHealthCheckParameter);
    });
