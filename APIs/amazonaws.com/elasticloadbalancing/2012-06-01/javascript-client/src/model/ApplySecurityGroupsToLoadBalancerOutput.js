...
/**
 * The ApplySecurityGroupsToLoadBalancerOutput model module.
 * @module model/ApplySecurityGroupsToLoadBalancerOutput
 * @version 2012-06-01
 */
class ApplySecurityGroupsToLoadBalancerOutput {
    /**
     * Constructs a new <code>ApplySecurityGroupsToLoadBalancerOutput</code>.
     * Contains the output of ApplySecurityGroupsToLoadBalancer.
     * @alias module:model/ApplySecurityGroupsToLoadBalancerOutput
     */
    constructor() { 
        
        ApplySecurityGroupsToLoadBalancerOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApplySecurityGroupsToLoadBalancerOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApplySecurityGroupsToLoadBalancerOutput} obj Optional instance to populate.
     * @return {module:model/ApplySecurityGroupsToLoadBalancerOutput} The populated <code>ApplySecurityGroupsToLoadBalancerOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApplySecurityGroupsToLoadBalancerOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>ApplySecurityGroupsToLoadBalancerOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApplySecurityGroupsToLoadBalancerOutput</code>.
     */
 ...
 */
ApplySecurityGroupsToLoadBalancerOutput.prototype['SecurityGroups'] = undefined;
...
export default ApplySecurityGroupsToLoadBalancerOutput;
