...
/**
 * The ConnectionDraining model module.
 * @module model/ConnectionDraining
 * @version 2012-06-01
 */
class ConnectionDraining {
    /**
     * Constructs a new <code>ConnectionDraining</code>.
     * Information about the &lt;code&gt;ConnectionDraining&lt;/code&gt; attribute.
     * @alias module:model/ConnectionDraining
     * @param enabled {Boolean} 
     */
    constructor(enabled) { 
        
        ConnectionDraining.initialize(this, enabled);
    }
    ...
    /**
     * Constructs a <code>ConnectionDraining</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConnectionDraining} obj Optional instance to populate.
     * @return {module:model/ConnectionDraining} The populated <code>ConnectionDraining</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConnectionDraining();
    ...
    /**
     * Validates the JSON data with respect to <code>ConnectionDraining</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConnectionDraining</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ConnectionDraining.RequiredProperties) {
...
ConnectionDraining.RequiredProperties = ["Enabled"];

/**
 * @member {Boolean} Enabled
 */
ConnectionDraining.prototype['Enabled'] = undefined;

/**
 * @member {Number} Timeout
 */
ConnectionDraining.prototype['Timeout'] = undefined;
...
export default ConnectionDraining;
