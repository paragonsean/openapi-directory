...
/**
 * The CreateAccessPointInput model module.
 * @module model/CreateAccessPointInput
 * @version 2012-06-01
 */
class CreateAccessPointInput {
    /**
     * Constructs a new <code>CreateAccessPointInput</code>.
     * Contains the parameters for CreateLoadBalancer.
     * @alias module:model/CreateAccessPointInput
     * @param loadBalancerName {String} 
     * @param listeners {Array} 
     */
    constructor(loadBalancerName, listeners) { 
        
        CreateAccessPointInput.initialize(this, loadBalancerName, listeners);
    }
     ...
     */
    static initialize(obj, loadBalancerName, listeners) { 
        obj['LoadBalancerName'] = loadBalancerName;
        obj['Listeners'] = listeners;
    }

    /**
     * Constructs a <code>CreateAccessPointInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateAccessPointInput} obj Optional instance to populate.
     * @return {module:model/CreateAccessPointInput} The populated <code>CreateAccessPointInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateAccessPointInput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateAccessPointInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateAccessPointInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateAccessPointInput.RequiredProperties) {
...
CreateAccessPointInput.RequiredProperties = ["LoadBalancerName", "Listeners"];

/**
 * @member {String} LoadBalancerName
 */
CreateAccessPointInput.prototype['LoadBalancerName'] = undefined;

/**
 * @member {Array} Listeners
 */
CreateAccessPointInput.prototype['Listeners'] = undefined;

/**
 * @member {Array} AvailabilityZones
 */
CreateAccessPointInput.prototype['AvailabilityZones'] = undefined;

/**
 * @member {Array} Subnets
 */
CreateAccessPointInput.prototype['Subnets'] = undefined;

/**
 * @member {Array} SecurityGroups
 */
CreateAccessPointInput.prototype['SecurityGroups'] = undefined;

/**
 * @member {String} Scheme
 */
CreateAccessPointInput.prototype['Scheme'] = undefined;

/**
 * @member {Array} Tags
 */
CreateAccessPointInput.prototype['Tags'] = undefined;
...
export default CreateAccessPointInput;
