...
/**
 * The ApplySecurityGroupsToLoadBalancerInput model module.
 * @module model/ApplySecurityGroupsToLoadBalancerInput
 * @version 2012-06-01
 */
class ApplySecurityGroupsToLoadBalancerInput {
    /**
     * Constructs a new <code>ApplySecurityGroupsToLoadBalancerInput</code>.
     * Contains the parameters for ApplySecurityGroupsToLoadBalancer.
     * @alias module:model/ApplySecurityGroupsToLoadBalancerInput
     * @param loadBalancerName {String} 
     * @param securityGroups {Array} 
     */
    constructor(loadBalancerName, securityGroups) { 
        
        ApplySecurityGroupsToLoadBalancerInput.initialize(this, loadBalancerName, securityGroups);
    }
     ...
     */
    static initialize(obj, loadBalancerName, securityGroups) { 
        obj['LoadBalancerName'] = loadBalancerName;
        obj['SecurityGroups'] = securityGroups;
    }

    /**
     * Constructs a <code>ApplySecurityGroupsToLoadBalancerInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApplySecurityGroupsToLoadBalancerInput} obj Optional instance to populate.
     * @return {module:model/ApplySecurityGroupsToLoadBalancerInput} The populated <code>ApplySecurityGroupsToLoadBalancerInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApplySecurityGroupsToLoadBalancerInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ApplySecurityGroupsToLoadBalancerInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApplySecurityGroupsToLoadBalancerInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApplySecurityGroupsToLoadBalancerInput.RequiredProperties) {
...
ApplySecurityGroupsToLoadBalancerInput.RequiredProperties = ["LoadBalancerName", "SecurityGroups"];

/**
 * @member {String} LoadBalancerName
 */
ApplySecurityGroupsToLoadBalancerInput.prototype['LoadBalancerName'] = undefined;

/**
 * @member {Array} SecurityGroups
 */
ApplySecurityGroupsToLoadBalancerInput.prototype['SecurityGroups'] = undefined;
...
export default ApplySecurityGroupsToLoadBalancerInput;
