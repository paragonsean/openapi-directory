...
/**
 * The DescribeLoadBalancerPoliciesInput model module.
 * @module model/DescribeLoadBalancerPoliciesInput
 * @version 2012-06-01
 */
class DescribeLoadBalancerPoliciesInput {
    /**
     * Constructs a new <code>DescribeLoadBalancerPoliciesInput</code>.
     * Contains the parameters for DescribeLoadBalancerPolicies.
     * @alias module:model/DescribeLoadBalancerPoliciesInput
     */
    constructor() { 
        
        DescribeLoadBalancerPoliciesInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeLoadBalancerPoliciesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeLoadBalancerPoliciesInput} obj Optional instance to populate.
     * @return {module:model/DescribeLoadBalancerPoliciesInput} The populated <code>DescribeLoadBalancerPoliciesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeLoadBalancerPoliciesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeLoadBalancerPoliciesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeLoadBalancerPoliciesInput</code>.
     */
 ...
 */
DescribeLoadBalancerPoliciesInput.prototype['LoadBalancerName'] = undefined;

/**
 * @member {Array} PolicyNames
 */
DescribeLoadBalancerPoliciesInput.prototype['PolicyNames'] = undefined;
...
export default DescribeLoadBalancerPoliciesInput;
