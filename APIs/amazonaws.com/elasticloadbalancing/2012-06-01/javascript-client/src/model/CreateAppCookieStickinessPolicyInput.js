...
/**
 * The CreateAppCookieStickinessPolicyInput model module.
 * @module model/CreateAppCookieStickinessPolicyInput
 * @version 2012-06-01
 */
class CreateAppCookieStickinessPolicyInput {
    /**
     * Constructs a new <code>CreateAppCookieStickinessPolicyInput</code>.
     * Contains the parameters for CreateAppCookieStickinessPolicy.
     * @alias module:model/CreateAppCookieStickinessPolicyInput
     * @param loadBalancerName {String} 
     * @param policyName {String} 
     * @param cookieName {String} 
     */
    constructor(loadBalancerName, policyName, cookieName) { 
        
        CreateAppCookieStickinessPolicyInput.initialize(this, loadBalancerName, policyName, cookieName);
    }
     ...
     */
    static initialize(obj, loadBalancerName, policyName, cookieName) { 
    ...
    /**
     * Constructs a <code>CreateAppCookieStickinessPolicyInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateAppCookieStickinessPolicyInput} obj Optional instance to populate.
     * @return {module:model/CreateAppCookieStickinessPolicyInput} The populated <code>CreateAppCookieStickinessPolicyInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateAppCookieStickinessPolicyInput();
            ...
            if (data.hasOwnProperty('CookieName')) {
                obj['CookieName'] = ApiClient.convertToType(data['CookieName'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateAppCookieStickinessPolicyInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateAppCookieStickinessPolicyInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateAppCookieStickinessPolicyInput.RequiredProperties) {
        ...
        if (data['CookieName']) { // data not null
          String.validateJSON(data['CookieName']);
        }
...
CreateAppCookieStickinessPolicyInput.RequiredProperties = ["LoadBalancerName", "PolicyName", "CookieName"];

/**
 * @member {String} LoadBalancerName
 */
CreateAppCookieStickinessPolicyInput.prototype['LoadBalancerName'] = undefined;

/**
 * @member {String} PolicyName
 */
CreateAppCookieStickinessPolicyInput.prototype['PolicyName'] = undefined;

/**
 * @member {String} CookieName
 */
CreateAppCookieStickinessPolicyInput.prototype['CookieName'] = undefined;
...
export default CreateAppCookieStickinessPolicyInput;
