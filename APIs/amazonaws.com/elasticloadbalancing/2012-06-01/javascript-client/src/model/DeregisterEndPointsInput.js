...
/**
 * The DeregisterEndPointsInput model module.
 * @module model/DeregisterEndPointsInput
 * @version 2012-06-01
 */
class DeregisterEndPointsInput {
    /**
     * Constructs a new <code>DeregisterEndPointsInput</code>.
     * Contains the parameters for DeregisterInstancesFromLoadBalancer.
     * @alias module:model/DeregisterEndPointsInput
     * @param loadBalancerName {String} 
     * @param instances {Array} 
     */
    constructor(loadBalancerName, instances) { 
        
        DeregisterEndPointsInput.initialize(this, loadBalancerName, instances);
    }
     ...
     */
    static initialize(obj, loadBalancerName, instances) { 
        obj['LoadBalancerName'] = loadBalancerName;
        obj['Instances'] = instances;
    }

    /**
     * Constructs a <code>DeregisterEndPointsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeregisterEndPointsInput} obj Optional instance to populate.
     * @return {module:model/DeregisterEndPointsInput} The populated <code>DeregisterEndPointsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeregisterEndPointsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeregisterEndPointsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeregisterEndPointsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeregisterEndPointsInput.RequiredProperties) {
...
DeregisterEndPointsInput.RequiredProperties = ["LoadBalancerName", "Instances"];

/**
 * @member {String} LoadBalancerName
 */
DeregisterEndPointsInput.prototype['LoadBalancerName'] = undefined;

/**
 * @member {Array} Instances
 */
DeregisterEndPointsInput.prototype['Instances'] = undefined;
...
export default DeregisterEndPointsInput;
