...
/**
 * The CreateAccessPointOutput model module.
 * @module model/CreateAccessPointOutput
 * @version 2012-06-01
 */
class CreateAccessPointOutput {
    /**
     * Constructs a new <code>CreateAccessPointOutput</code>.
     * Contains the output for CreateLoadBalancer.
     * @alias module:model/CreateAccessPointOutput
     */
    constructor() { 
        
        CreateAccessPointOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateAccessPointOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateAccessPointOutput} obj Optional instance to populate.
     * @return {module:model/CreateAccessPointOutput} The populated <code>CreateAccessPointOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateAccessPointOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateAccessPointOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateAccessPointOutput</code>.
     */
 ...
 */
CreateAccessPointOutput.prototype['DNSName'] = undefined;
...
export default CreateAccessPointOutput;
