...
/**
 * The AttachLoadBalancerToSubnetsInput model module.
 * @module model/AttachLoadBalancerToSubnetsInput
 * @version 2012-06-01
 */
class AttachLoadBalancerToSubnetsInput {
    /**
     * Constructs a new <code>AttachLoadBalancerToSubnetsInput</code>.
     * Contains the parameters for AttachLoaBalancerToSubnets.
     * @alias module:model/AttachLoadBalancerToSubnetsInput
     * @param loadBalancerName {String} 
     * @param subnets {Array} 
     */
    constructor(loadBalancerName, subnets) { 
        
        AttachLoadBalancerToSubnetsInput.initialize(this, loadBalancerName, subnets);
    }
    ...
    /**
     * Constructs a <code>AttachLoadBalancerToSubnetsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AttachLoadBalancerToSubnetsInput} obj Optional instance to populate.
     * @return {module:model/AttachLoadBalancerToSubnetsInput} The populated <code>AttachLoadBalancerToSubnetsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AttachLoadBalancerToSubnetsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>AttachLoadBalancerToSubnetsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AttachLoadBalancerToSubnetsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AttachLoadBalancerToSubnetsInput.RequiredProperties) {
...
AttachLoadBalancerToSubnetsInput.RequiredProperties = ["LoadBalancerName", "Subnets"];

/**
 * @member {String} LoadBalancerName
 */
AttachLoadBalancerToSubnetsInput.prototype['LoadBalancerName'] = undefined;

/**
 * @member {Array} Subnets
 */
AttachLoadBalancerToSubnetsInput.prototype['Subnets'] = undefined;
...
export default AttachLoadBalancerToSubnetsInput;
