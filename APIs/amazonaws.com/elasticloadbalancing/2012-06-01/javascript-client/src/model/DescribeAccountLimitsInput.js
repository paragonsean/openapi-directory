...
/**
 * The DescribeAccountLimitsInput model module.
 * @module model/DescribeAccountLimitsInput
 * @version 2012-06-01
 */
class DescribeAccountLimitsInput {
    /**
     * Constructs a new <code>DescribeAccountLimitsInput</code>.
     * @alias module:model/DescribeAccountLimitsInput
     */
    constructor() { 
        
        DescribeAccountLimitsInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeAccountLimitsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeAccountLimitsInput} obj Optional instance to populate.
     * @return {module:model/DescribeAccountLimitsInput} The populated <code>DescribeAccountLimitsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeAccountLimitsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeAccountLimitsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeAccountLimitsInput</code>.
     */
 ...
 */
DescribeAccountLimitsInput.prototype['Marker'] = undefined;

/**
 * @member {Number} PageSize
 */
DescribeAccountLimitsInput.prototype['PageSize'] = undefined;
...
export default DescribeAccountLimitsInput;
