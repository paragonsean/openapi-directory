...
/**
 * The RegisterEndPointsInput model module.
 * @module model/RegisterEndPointsInput
 * @version 2012-06-01
 */
class RegisterEndPointsInput {
     ...
     * @alias module:model/RegisterEndPointsInput
     * @param loadBalancerName {String} 
     * @param instances {Array} 
     */
    constructor(loadBalancerName, instances) { 
        
        RegisterEndPointsInput.initialize(this, loadBalancerName, instances);
    }
    ...
    /**
     * Constructs a <code>RegisterEndPointsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RegisterEndPointsInput} obj Optional instance to populate.
     * @return {module:model/RegisterEndPointsInput} The populated <code>RegisterEndPointsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RegisterEndPointsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>RegisterEndPointsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RegisterEndPointsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RegisterEndPointsInput.RequiredProperties) {
...
RegisterEndPointsInput.RequiredProperties = ["LoadBalancerName", "Instances"];

/**
 * @member {String} LoadBalancerName
 */
RegisterEndPointsInput.prototype['LoadBalancerName'] = undefined;

/**
 * @member {Array} Instances
 */
RegisterEndPointsInput.prototype['Instances'] = undefined;
...
export default RegisterEndPointsInput;
