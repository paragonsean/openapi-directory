...
/**
 * The AddAvailabilityZonesInput model module.
 * @module model/AddAvailabilityZonesInput
 * @version 2012-06-01
 */
class AddAvailabilityZonesInput {
    /**
     * Constructs a new <code>AddAvailabilityZonesInput</code>.
     * Contains the parameters for EnableAvailabilityZonesForLoadBalancer.
     * @alias module:model/AddAvailabilityZonesInput
     * @param loadBalancerName {String} 
     * @param availabilityZones {Array} 
     */
    constructor(loadBalancerName, availabilityZones) { 
        
        AddAvailabilityZonesInput.initialize(this, loadBalancerName, availabilityZones);
    }
    ...
    /**
     * Constructs a <code>AddAvailabilityZonesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddAvailabilityZonesInput} obj Optional instance to populate.
     * @return {module:model/AddAvailabilityZonesInput} The populated <code>AddAvailabilityZonesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddAvailabilityZonesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>AddAvailabilityZonesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddAvailabilityZonesInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddAvailabilityZonesInput.RequiredProperties) {
...
AddAvailabilityZonesInput.RequiredProperties = ["LoadBalancerName", "AvailabilityZones"];

/**
 * @member {String} LoadBalancerName
 */
AddAvailabilityZonesInput.prototype['LoadBalancerName'] = undefined;

/**
 * @member {Array} AvailabilityZones
 */
AddAvailabilityZonesInput.prototype['AvailabilityZones'] = undefined;
...
export default AddAvailabilityZonesInput;
