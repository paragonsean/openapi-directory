...
/**
 * The DetachLoadBalancerFromSubnetsInput model module.
 * @module model/DetachLoadBalancerFromSubnetsInput
 * @version 2012-06-01
 */
class DetachLoadBalancerFromSubnetsInput {
    /**
     * Constructs a new <code>DetachLoadBalancerFromSubnetsInput</code>.
     * Contains the parameters for DetachLoadBalancerFromSubnets.
     * @alias module:model/DetachLoadBalancerFromSubnetsInput
     * @param loadBalancerName {String} 
     * @param subnets {Array} 
     */
    constructor(loadBalancerName, subnets) { 
        
        DetachLoadBalancerFromSubnetsInput.initialize(this, loadBalancerName, subnets);
    }
     ...
     */
    static initialize(obj, loadBalancerName, subnets) { 
        obj['LoadBalancerName'] = loadBalancerName;
        obj['Subnets'] = subnets;
    }

    /**
     * Constructs a <code>DetachLoadBalancerFromSubnetsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetachLoadBalancerFromSubnetsInput} obj Optional instance to populate.
     * @return {module:model/DetachLoadBalancerFromSubnetsInput} The populated <code>DetachLoadBalancerFromSubnetsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetachLoadBalancerFromSubnetsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DetachLoadBalancerFromSubnetsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetachLoadBalancerFromSubnetsInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DetachLoadBalancerFromSubnetsInput.RequiredProperties) {
...
DetachLoadBalancerFromSubnetsInput.RequiredProperties = ["LoadBalancerName", "Subnets"];

/**
 * @member {String} LoadBalancerName
 */
DetachLoadBalancerFromSubnetsInput.prototype['LoadBalancerName'] = undefined;

/**
 * @member {Array} Subnets
 */
DetachLoadBalancerFromSubnetsInput.prototype['Subnets'] = undefined;
...
export default DetachLoadBalancerFromSubnetsInput;
