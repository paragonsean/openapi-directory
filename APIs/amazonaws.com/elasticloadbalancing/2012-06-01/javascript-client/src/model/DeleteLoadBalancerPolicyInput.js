...
/**
 * The DeleteLoadBalancerPolicyInput model module.
 * @module model/DeleteLoadBalancerPolicyInput
 * @version 2012-06-01
 */
class DeleteLoadBalancerPolicyInput {
    /**
     * Constructs a new <code>DeleteLoadBalancerPolicyInput</code>.
     * Contains the parameters for DeleteLoadBalancerPolicy.
     * @alias module:model/DeleteLoadBalancerPolicyInput
     * @param loadBalancerName {String} 
     * @param policyName {String} 
     */
    constructor(loadBalancerName, policyName) { 
        
        DeleteLoadBalancerPolicyInput.initialize(this, loadBalancerName, policyName);
    }
    ...
    /**
     * Constructs a <code>DeleteLoadBalancerPolicyInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteLoadBalancerPolicyInput} obj Optional instance to populate.
     * @return {module:model/DeleteLoadBalancerPolicyInput} The populated <code>DeleteLoadBalancerPolicyInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteLoadBalancerPolicyInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteLoadBalancerPolicyInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteLoadBalancerPolicyInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteLoadBalancerPolicyInput.RequiredProperties) {
...
DeleteLoadBalancerPolicyInput.RequiredProperties = ["LoadBalancerName", "PolicyName"];

/**
 * @member {String} LoadBalancerName
 */
DeleteLoadBalancerPolicyInput.prototype['LoadBalancerName'] = undefined;

/**
 * @member {String} PolicyName
 */
DeleteLoadBalancerPolicyInput.prototype['PolicyName'] = undefined;
...
export default DeleteLoadBalancerPolicyInput;
