...
/**
 * The SourceSecurityGroup model module.
 * @module model/SourceSecurityGroup
 * @version 2012-06-01
 */
class SourceSecurityGroup {
    /**
     * Constructs a new <code>SourceSecurityGroup</code>.
     * Information about a source security group.
     * @alias module:model/SourceSecurityGroup
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>SourceSecurityGroup</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SourceSecurityGroup} obj Optional instance to populate.
     * @return {module:model/SourceSecurityGroup} The populated <code>SourceSecurityGroup</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SourceSecurityGroup();
    ...
    /**
     * Validates the JSON data with respect to <code>SourceSecurityGroup</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SourceSecurityGroup</code>.
     */
...
export default SourceSecurityGroup;
