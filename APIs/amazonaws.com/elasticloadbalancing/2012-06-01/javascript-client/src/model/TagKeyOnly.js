...
/**
 * The TagKeyOnly model module.
 * @module model/TagKeyOnly
 * @version 2012-06-01
 */
class TagKeyOnly {
    /**
     * Constructs a new <code>TagKeyOnly</code>.
     * The key of a tag.
     * @alias module:model/TagKeyOnly
     */
    constructor() { 
        
        TagKeyOnly.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TagKeyOnly</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TagKeyOnly} obj Optional instance to populate.
     * @return {module:model/TagKeyOnly} The populated <code>TagKeyOnly</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TagKeyOnly();
    ...
    /**
     * Validates the JSON data with respect to <code>TagKeyOnly</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TagKeyOnly</code>.
     */
 ...
 * @member {String} Key
 */
TagKeyOnly.prototype['Key'] = undefined;
