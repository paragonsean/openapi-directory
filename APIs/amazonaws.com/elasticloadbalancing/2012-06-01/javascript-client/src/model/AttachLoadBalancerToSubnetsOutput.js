...
/**
 * The AttachLoadBalancerToSubnetsOutput model module.
 * @module model/AttachLoadBalancerToSubnetsOutput
 * @version 2012-06-01
 */
class AttachLoadBalancerToSubnetsOutput {
    /**
     * Constructs a new <code>AttachLoadBalancerToSubnetsOutput</code>.
     * Contains the output of AttachLoadBalancerToSubnets.
     * @alias module:model/AttachLoadBalancerToSubnetsOutput
     */
    constructor() { 
        
        AttachLoadBalancerToSubnetsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AttachLoadBalancerToSubnetsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AttachLoadBalancerToSubnetsOutput} obj Optional instance to populate.
     * @return {module:model/AttachLoadBalancerToSubnetsOutput} The populated <code>AttachLoadBalancerToSubnetsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AttachLoadBalancerToSubnetsOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>AttachLoadBalancerToSubnetsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AttachLoadBalancerToSubnetsOutput</code>.
     */
 ...
 */
AttachLoadBalancerToSubnetsOutput.prototype['Subnets'] = undefined;
...
export default AttachLoadBalancerToSubnetsOutput;
