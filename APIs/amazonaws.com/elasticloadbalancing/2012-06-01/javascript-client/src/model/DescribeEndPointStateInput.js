...
/**
 * The DescribeEndPointStateInput model module.
 * @module model/DescribeEndPointStateInput
 * @version 2012-06-01
 */
class DescribeEndPointStateInput {
    /**
     * Constructs a new <code>DescribeEndPointStateInput</code>.
     * Contains the parameters for DescribeInstanceHealth.
     * @alias module:model/DescribeEndPointStateInput
     * @param loadBalancerName {String} 
     */
    constructor(loadBalancerName) { 
        
        DescribeEndPointStateInput.initialize(this, loadBalancerName);
    }
     ...
     */
    static initialize(obj, loadBalancerName) { 
        obj['LoadBalancerName'] = loadBalancerName;
    }

    /**
     * Constructs a <code>DescribeEndPointStateInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeEndPointStateInput} obj Optional instance to populate.
     * @return {module:model/DescribeEndPointStateInput} The populated <code>DescribeEndPointStateInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeEndPointStateInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeEndPointStateInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeEndPointStateInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeEndPointStateInput.RequiredProperties) {
...
DescribeEndPointStateInput.RequiredProperties = ["LoadBalancerName"];

/**
 * @member {String} LoadBalancerName
 */
DescribeEndPointStateInput.prototype['LoadBalancerName'] = undefined;

/**
 * @member {Array} Instances
 */
DescribeEndPointStateInput.prototype['Instances'] = undefined;
...
export default DescribeEndPointStateInput;
