...
/**
 * The AppCookieStickinessPolicy model module.
 * @module model/AppCookieStickinessPolicy
 * @version 2012-06-01
 */
class AppCookieStickinessPolicy {
    /**
     * Constructs a new <code>AppCookieStickinessPolicy</code>.
     * Information about a policy for application-controlled session stickiness.
     * @alias module:model/AppCookieStickinessPolicy
     */
    constructor() { 
        
        AppCookieStickinessPolicy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AppCookieStickinessPolicy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AppCookieStickinessPolicy} obj Optional instance to populate.
     * @return {module:model/AppCookieStickinessPolicy} The populated <code>AppCookieStickinessPolicy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AppCookieStickinessPolicy();
    ...
    /**
     * Validates the JSON data with respect to <code>AppCookieStickinessPolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AppCookieStickinessPolicy</code>.
     */
 ...
 */
AppCookieStickinessPolicy.prototype['PolicyName'] = undefined;

/**
 * @member {String} CookieName
 */
AppCookieStickinessPolicy.prototype['CookieName'] = undefined;
...
export default AppCookieStickinessPolicy;
