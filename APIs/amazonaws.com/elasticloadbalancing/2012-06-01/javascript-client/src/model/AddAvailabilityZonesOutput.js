...
/**
 * The AddAvailabilityZonesOutput model module.
 * @module model/AddAvailabilityZonesOutput
 * @version 2012-06-01
 */
class AddAvailabilityZonesOutput {
    /**
     * Constructs a new <code>AddAvailabilityZonesOutput</code>.
     * Contains the output of EnableAvailabilityZonesForLoadBalancer.
     * @alias module:model/AddAvailabilityZonesOutput
     */
    constructor() { 
        
        AddAvailabilityZonesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddAvailabilityZonesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddAvailabilityZonesOutput} obj Optional instance to populate.
     * @return {module:model/AddAvailabilityZonesOutput} The populated <code>AddAvailabilityZonesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddAvailabilityZonesOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>AddAvailabilityZonesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddAvailabilityZonesOutput</code>.
     */
 ...
 */
AddAvailabilityZonesOutput.prototype['AvailabilityZones'] = undefined;
...
export default AddAvailabilityZonesOutput;
