...
/**
 * The RemoveAvailabilityZonesInput model module.
 * @module model/RemoveAvailabilityZonesInput
 * @version 2012-06-01
 */
class RemoveAvailabilityZonesInput {
    /**
     * Constructs a new <code>RemoveAvailabilityZonesInput</code>.
     * Contains the parameters for DisableAvailabilityZonesForLoadBalancer.
     * @alias module:model/RemoveAvailabilityZonesInput
     * @param loadBalancerName {String} 
     * @param availabilityZones {Array} 
     */
    constructor(loadBalancerName, availabilityZones) { 
        
        RemoveAvailabilityZonesInput.initialize(this, loadBalancerName, availabilityZones);
    }
     ...
     */
    static initialize(obj, loadBalancerName, availabilityZones) { 
        obj['LoadBalancerName'] = loadBalancerName;
        obj['AvailabilityZones'] = availabilityZones;
    }

    /**
     * Constructs a <code>RemoveAvailabilityZonesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RemoveAvailabilityZonesInput} obj Optional instance to populate.
     * @return {module:model/RemoveAvailabilityZonesInput} The populated <code>RemoveAvailabilityZonesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RemoveAvailabilityZonesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>RemoveAvailabilityZonesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RemoveAvailabilityZonesInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RemoveAvailabilityZonesInput.RequiredProperties) {
...
RemoveAvailabilityZonesInput.RequiredProperties = ["LoadBalancerName", "AvailabilityZones"];

/**
 * @member {String} LoadBalancerName
 */
RemoveAvailabilityZonesInput.prototype['LoadBalancerName'] = undefined;

/**
 * @member {Array} AvailabilityZones
 */
RemoveAvailabilityZonesInput.prototype['AvailabilityZones'] = undefined;
...
export default RemoveAvailabilityZonesInput;
