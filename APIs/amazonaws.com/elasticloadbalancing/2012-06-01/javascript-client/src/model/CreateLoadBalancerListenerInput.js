...
/**
 * The CreateLoadBalancerListenerInput model module.
 * @module model/CreateLoadBalancerListenerInput
 * @version 2012-06-01
 */
class CreateLoadBalancerListenerInput {
    /**
     * Constructs a new <code>CreateLoadBalancerListenerInput</code>.
     * Contains the parameters for CreateLoadBalancerListeners.
     * @alias module:model/CreateLoadBalancerListenerInput
     * @param loadBalancerName {String} 
     * @param listeners {Array} 
     */
    constructor(loadBalancerName, listeners) { 
        
        CreateLoadBalancerListenerInput.initialize(this, loadBalancerName, listeners);
    }
    ...
    /**
     * Constructs a <code>CreateLoadBalancerListenerInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateLoadBalancerListenerInput} obj Optional instance to populate.
     * @return {module:model/CreateLoadBalancerListenerInput} The populated <code>CreateLoadBalancerListenerInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateLoadBalancerListenerInput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateLoadBalancerListenerInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateLoadBalancerListenerInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateLoadBalancerListenerInput.RequiredProperties) {
...
CreateLoadBalancerListenerInput.RequiredProperties = ["LoadBalancerName", "Listeners"];

/**
 * @member {String} LoadBalancerName
 */
CreateLoadBalancerListenerInput.prototype['LoadBalancerName'] = undefined;

/**
 * @member {Array} Listeners
 */
CreateLoadBalancerListenerInput.prototype['Listeners'] = undefined;
...
export default CreateLoadBalancerListenerInput;
