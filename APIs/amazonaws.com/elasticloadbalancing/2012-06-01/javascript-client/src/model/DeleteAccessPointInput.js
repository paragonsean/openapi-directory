...
/**
 * The DeleteAccessPointInput model module.
 * @module model/DeleteAccessPointInput
 * @version 2012-06-01
 */
class DeleteAccessPointInput {
    /**
     * Constructs a new <code>DeleteAccessPointInput</code>.
     * Contains the parameters for DeleteLoadBalancer.
     * @alias module:model/DeleteAccessPointInput
     * @param loadBalancerName {String} 
     */
    constructor(loadBalancerName) { 
        
        DeleteAccessPointInput.initialize(this, loadBalancerName);
    }
    ...
    /**
     * Constructs a <code>DeleteAccessPointInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteAccessPointInput} obj Optional instance to populate.
     * @return {module:model/DeleteAccessPointInput} The populated <code>DeleteAccessPointInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteAccessPointInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteAccessPointInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteAccessPointInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteAccessPointInput.RequiredProperties) {
...
DeleteAccessPointInput.RequiredProperties = ["LoadBalancerName"];

/**
 * @member {String} LoadBalancerName
 */
DeleteAccessPointInput.prototype['LoadBalancerName'] = undefined;
...
export default DeleteAccessPointInput;
