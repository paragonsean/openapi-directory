...
/**
 * The RegisterEndPointsOutput model module.
 * @module model/RegisterEndPointsOutput
 * @version 2012-06-01
 */
class RegisterEndPointsOutput {
    /**
     * Constructs a new <code>RegisterEndPointsOutput</code>.
     * Contains the output of RegisterInstancesWithLoadBalancer.
     * @alias module:model/RegisterEndPointsOutput
     */
    constructor() { 
        
        RegisterEndPointsOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RegisterEndPointsOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RegisterEndPointsOutput} obj Optional instance to populate.
     * @return {module:model/RegisterEndPointsOutput} The populated <code>RegisterEndPointsOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RegisterEndPointsOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>RegisterEndPointsOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RegisterEndPointsOutput</code>.
     */
 ...
 */
RegisterEndPointsOutput.prototype['Instances'] = undefined;
...
export default RegisterEndPointsOutput;
