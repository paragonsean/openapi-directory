...
/**
 * The PolicyAttribute model module.
 * @module model/PolicyAttribute
 * @version 2012-06-01
 */
class PolicyAttribute {
    /**
     * Constructs a new <code>PolicyAttribute</code>.
     * Information about a policy attribute.
     * @alias module:model/PolicyAttribute
     */
    constructor() { 
        
        PolicyAttribute.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PolicyAttribute</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PolicyAttribute} obj Optional instance to populate.
     * @return {module:model/PolicyAttribute} The populated <code>PolicyAttribute</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PolicyAttribute();
    ...
    /**
     * Validates the JSON data with respect to <code>PolicyAttribute</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PolicyAttribute</code>.
     */
 ...
 */
PolicyAttribute.prototype['AttributeName'] = undefined;

/**
 * @member {String} AttributeValue
 */
PolicyAttribute.prototype['AttributeValue'] = undefined;
...
export default PolicyAttribute;
