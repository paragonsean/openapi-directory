...
class DescribeTagsOutput {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('TagDescriptions')) {
                obj['TagDescriptions'] = ApiClient.convertToType(data['TagDescriptions'], Array);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['TagDescriptions']) { // data not null
          Array.validateJSON(data['TagDescriptions']);
        }
...
/**
 * @member {Array} TagDescriptions
 */
DescribeTagsOutput.prototype['TagDescriptions'] = undefined;
