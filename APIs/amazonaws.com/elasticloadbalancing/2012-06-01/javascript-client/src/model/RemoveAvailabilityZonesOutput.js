...
/**
 * The RemoveAvailabilityZonesOutput model module.
 * @module model/RemoveAvailabilityZonesOutput
 * @version 2012-06-01
 */
class RemoveAvailabilityZonesOutput {
    /**
     * Constructs a new <code>RemoveAvailabilityZonesOutput</code>.
     * Contains the output for DisableAvailabilityZonesForLoadBalancer.
     * @alias module:model/RemoveAvailabilityZonesOutput
     */
    constructor() { 
        
        RemoveAvailabilityZonesOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RemoveAvailabilityZonesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RemoveAvailabilityZonesOutput} obj Optional instance to populate.
     * @return {module:model/RemoveAvailabilityZonesOutput} The populated <code>RemoveAvailabilityZonesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RemoveAvailabilityZonesOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>RemoveAvailabilityZonesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RemoveAvailabilityZonesOutput</code>.
     */
 ...
 */
RemoveAvailabilityZonesOutput.prototype['AvailabilityZones'] = undefined;
...
export default RemoveAvailabilityZonesOutput;
