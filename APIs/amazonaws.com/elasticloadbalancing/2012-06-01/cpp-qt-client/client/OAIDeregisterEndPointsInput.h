...
/*
 * OAIDeregisterEndPointsInput.h
 *
 * Contains the parameters for DeregisterInstancesFromLoadBalancer.
 */

#ifndef OAIDeregisterEndPointsInput_H
#define OAIDeregisterEndPointsInput_H
...
class OAIDeregisterEndPointsInput : public OAIObject {
public:
    OAIDeregisterEndPointsInput();
    OAIDeregisterEndPointsInput(QString json);
    ~OAIDeregisterEndPointsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeregisterEndPointsInput)

#endif // OAIDeregisterEndPointsInput_H
