...
/*
 * OAIPolicyDescription.h
 *
 * Information about a policy.
 */

#ifndef OAIPolicyDescription_H
#define OAIPolicyDescription_H
...
class OAIPolicyDescription : public OAIObject {
public:
    OAIPolicyDescription();
    OAIPolicyDescription(QString json);
    ~OAIPolicyDescription() override;
    ...
    QList getPolicyAttributeDescriptions() const;
    void setPolicyAttributeDescriptions(const QList &policy_attribute_descriptions);
    bool is_policy_attribute_descriptions_Set() const;
    bool is_policy_attribute_descriptions_Valid() const;
...
private:
    ...
    QList m_policy_attribute_descriptions;
    bool m_policy_attribute_descriptions_isSet;
    bool m_policy_attribute_descriptions_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPolicyDescription)

#endif // OAIPolicyDescription_H
