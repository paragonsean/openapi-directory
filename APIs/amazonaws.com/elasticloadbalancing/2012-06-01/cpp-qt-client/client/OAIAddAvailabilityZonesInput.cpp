...
OAIAddAvailabilityZonesInput::OAIAddAvailabilityZonesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddAvailabilityZonesInput::OAIAddAvailabilityZonesInput() {
    this->initializeModel();
}

OAIAddAvailabilityZonesInput::~OAIAddAvailabilityZonesInput() {}

void OAIAddAvailabilityZonesInput::initializeModel() {
...
void OAIAddAvailabilityZonesInput::fromJson(QString jsonString) {
...
void OAIAddAvailabilityZonesInput::fromJsonObject(QJsonObject json) {
...
QString OAIAddAvailabilityZonesInput::asJson() const {
...
QJsonObject OAIAddAvailabilityZonesInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAddAvailabilityZonesInput::getLoadBalancerName() const {
    return m_load_balancer_name;
}
void OAIAddAvailabilityZonesInput::setLoadBalancerName(const QString &load_balancer_name) {
    m_load_balancer_name = load_balancer_name;
    m_load_balancer_name_isSet = true;
}

bool OAIAddAvailabilityZonesInput::is_load_balancer_name_Set() const{
    return m_load_balancer_name_isSet;
}

bool OAIAddAvailabilityZonesInput::is_load_balancer_name_Valid() const{
    return m_load_balancer_name_isValid;
}

QList OAIAddAvailabilityZonesInput::getAvailabilityZones() const {
    return m_availability_zones;
}
void OAIAddAvailabilityZonesInput::setAvailabilityZones(const QList &availability_zones) {
    m_availability_zones = availability_zones;
    m_availability_zones_isSet = true;
}

bool OAIAddAvailabilityZonesInput::is_availability_zones_Set() const{
    return m_availability_zones_isSet;
}

bool OAIAddAvailabilityZonesInput::is_availability_zones_Valid() const{
    return m_availability_zones_isValid;
}

bool OAIAddAvailabilityZonesInput::isSet() const {
...
bool OAIAddAvailabilityZonesInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_load_balancer_name_isValid && m_availability_zones_isValid && true;
}
