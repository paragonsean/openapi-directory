...
OAIRemoveAvailabilityZonesInput::OAIRemoveAvailabilityZonesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRemoveAvailabilityZonesInput::OAIRemoveAvailabilityZonesInput() {
    this->initializeModel();
}

OAIRemoveAvailabilityZonesInput::~OAIRemoveAvailabilityZonesInput() {}

void OAIRemoveAvailabilityZonesInput::initializeModel() {
...
void OAIRemoveAvailabilityZonesInput::fromJson(QString jsonString) {
...
void OAIRemoveAvailabilityZonesInput::fromJsonObject(QJsonObject json) {
...
QString OAIRemoveAvailabilityZonesInput::asJson() const {
...
QJsonObject OAIRemoveAvailabilityZonesInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRemoveAvailabilityZonesInput::getLoadBalancerName() const {
    return m_load_balancer_name;
}
void OAIRemoveAvailabilityZonesInput::setLoadBalancerName(const QString &load_balancer_name) {
    m_load_balancer_name = load_balancer_name;
    m_load_balancer_name_isSet = true;
}

bool OAIRemoveAvailabilityZonesInput::is_load_balancer_name_Set() const{
    return m_load_balancer_name_isSet;
}

bool OAIRemoveAvailabilityZonesInput::is_load_balancer_name_Valid() const{
    return m_load_balancer_name_isValid;
}

QList OAIRemoveAvailabilityZonesInput::getAvailabilityZones() const {
    return m_availability_zones;
}
void OAIRemoveAvailabilityZonesInput::setAvailabilityZones(const QList &availability_zones) {
    m_availability_zones = availability_zones;
    m_availability_zones_isSet = true;
}

bool OAIRemoveAvailabilityZonesInput::is_availability_zones_Set() const{
    return m_availability_zones_isSet;
}

bool OAIRemoveAvailabilityZonesInput::is_availability_zones_Valid() const{
    return m_availability_zones_isValid;
}

bool OAIRemoveAvailabilityZonesInput::isSet() const {
...
bool OAIRemoveAvailabilityZonesInput::isValid() const {
