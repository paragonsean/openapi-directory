...
/*
 * OAIApplySecurityGroupsToLoadBalancerOutput.h
 *
 * Contains the output of ApplySecurityGroupsToLoadBalancer.
 */

#ifndef OAIApplySecurityGroupsToLoadBalancerOutput_H
#define OAIApplySecurityGroupsToLoadBalancerOutput_H
...
class OAIApplySecurityGroupsToLoadBalancerOutput : public OAIObject {
public:
    OAIApplySecurityGroupsToLoadBalancerOutput();
    OAIApplySecurityGroupsToLoadBalancerOutput(QString json);
    ~OAIApplySecurityGroupsToLoadBalancerOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplySecurityGroupsToLoadBalancerOutput)

#endif // OAIApplySecurityGroupsToLoadBalancerOutput_H
