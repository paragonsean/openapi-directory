...
/*
 * OAIAppCookieStickinessPolicy.h
 *
 * Information about a policy for application-controlled session stickiness.
 */

#ifndef OAIAppCookieStickinessPolicy_H
#define OAIAppCookieStickinessPolicy_H
...
class OAIAppCookieStickinessPolicy : public OAIObject {
public:
    OAIAppCookieStickinessPolicy();
    OAIAppCookieStickinessPolicy(QString json);
    ~OAIAppCookieStickinessPolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppCookieStickinessPolicy)

#endif // OAIAppCookieStickinessPolicy_H
