...
#include "OAICrossZoneLoadBalancing.h"
...
OAICrossZoneLoadBalancing::OAICrossZoneLoadBalancing(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICrossZoneLoadBalancing::OAICrossZoneLoadBalancing() {
    this->initializeModel();
}

OAICrossZoneLoadBalancing::~OAICrossZoneLoadBalancing() {}

void OAICrossZoneLoadBalancing::initializeModel() {

    m_enabled_isSet = false;
    m_enabled_isValid = false;
}

void OAICrossZoneLoadBalancing::fromJson(QString jsonString) {
...
void OAICrossZoneLoadBalancing::fromJsonObject(QJsonObject json) {

    m_enabled_isValid = ::OpenAPI::fromJsonValue(m_enabled, json[QString("Enabled")]);
    m_enabled_isSet = !json[QString("Enabled")].isNull() && m_enabled_isValid;
}

QString OAICrossZoneLoadBalancing::asJson() const {
...
QJsonObject OAICrossZoneLoadBalancing::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAICrossZoneLoadBalancing::getEnabled() const {
    return m_enabled;
}
void OAICrossZoneLoadBalancing::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAICrossZoneLoadBalancing::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAICrossZoneLoadBalancing::is_enabled_Valid() const{
    return m_enabled_isValid;
}

bool OAICrossZoneLoadBalancing::isSet() const {
...
bool OAICrossZoneLoadBalancing::isValid() const {
