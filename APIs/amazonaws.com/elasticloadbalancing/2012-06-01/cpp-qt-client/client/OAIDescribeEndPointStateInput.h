...
/*
 * OAIDescribeEndPointStateInput.h
 *
 * Contains the parameters for DescribeInstanceHealth.
 */

#ifndef OAIDescribeEndPointStateInput_H
#define OAIDescribeEndPointStateInput_H
...
class OAIDescribeEndPointStateInput : public OAIObject {
public:
    OAIDescribeEndPointStateInput();
    OAIDescribeEndPointStateInput(QString json);
    ~OAIDescribeEndPointStateInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEndPointStateInput)

#endif // OAIDescribeEndPointStateInput_H
