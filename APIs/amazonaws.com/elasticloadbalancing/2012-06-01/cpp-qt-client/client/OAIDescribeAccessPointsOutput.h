...
/*
 * OAIDescribeAccessPointsOutput.h
 *
 * Contains the parameters for DescribeLoadBalancers.
 */

#ifndef OAIDescribeAccessPointsOutput_H
#define OAIDescribeAccessPointsOutput_H
...
class OAIDescribeAccessPointsOutput : public OAIObject {
public:
    OAIDescribeAccessPointsOutput();
    OAIDescribeAccessPointsOutput(QString json);
    ~OAIDescribeAccessPointsOutput() override;
    ...
    QList getLoadBalancerDescriptions() const;
    void setLoadBalancerDescriptions(const QList &load_balancer_descriptions);
    bool is_load_balancer_descriptions_Set() const;
    bool is_load_balancer_descriptions_Valid() const;
...
private:
    ...
    QList m_load_balancer_descriptions;
    bool m_load_balancer_descriptions_isSet;
    bool m_load_balancer_descriptions_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAccessPointsOutput)

#endif // OAIDescribeAccessPointsOutput_H
