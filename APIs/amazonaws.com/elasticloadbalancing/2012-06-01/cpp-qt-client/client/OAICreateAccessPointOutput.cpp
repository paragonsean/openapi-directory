...
OAICreateAccessPointOutput::OAICreateAccessPointOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateAccessPointOutput::OAICreateAccessPointOutput() {
    this->initializeModel();
}

OAICreateAccessPointOutput::~OAICreateAccessPointOutput() {}

void OAICreateAccessPointOutput::initializeModel() {

    m_dns_name_isSet = false;
    m_dns_name_isValid = false;
}

void OAICreateAccessPointOutput::fromJson(QString jsonString) {
...
void OAICreateAccessPointOutput::fromJsonObject(QJsonObject json) {
...
QString OAICreateAccessPointOutput::asJson() const {
...
QJsonObject OAICreateAccessPointOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_dns_name_isSet) {
...
QString OAICreateAccessPointOutput::getDnsName() const {
    return m_dns_name;
}
void OAICreateAccessPointOutput::setDnsName(const QString &dns_name) {
    m_dns_name = dns_name;
    m_dns_name_isSet = true;
}

bool OAICreateAccessPointOutput::is_dns_name_Set() const{
    return m_dns_name_isSet;
}

bool OAICreateAccessPointOutput::is_dns_name_Valid() const{
    return m_dns_name_isValid;
}

bool OAICreateAccessPointOutput::isSet() const {
...
bool OAICreateAccessPointOutput::isValid() const {
