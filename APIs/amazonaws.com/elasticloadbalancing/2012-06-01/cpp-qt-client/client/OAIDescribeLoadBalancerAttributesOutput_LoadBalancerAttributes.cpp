...
OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes() {
    this->initializeModel();
}

OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::~OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes() {}

void OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::initializeModel() {
...
void OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::fromJson(QString jsonString) {
...
void OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::asJson() const {
...
QJsonObject OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::asJsonObject() const {
    QJsonObject obj;
...
OAIGET_ModifyLoadBalancerAttributes_LoadBalancerAttributes_parameter_CrossZoneLoadBalancing OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::getCrossZoneLoadBalancing() const {
    return m_cross_zone_load_balancing;
}
void OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::setCrossZoneLoadBalancing(const OAIGET_ModifyLoadBalancerAttributes_LoadBalancerAttributes_parameter_CrossZoneLoadBalancing &cross_zone_load_balancing) {
    m_cross_zone_load_balancing = cross_zone_load_balancing;
    m_cross_zone_load_balancing_isSet = true;
}

bool OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::is_cross_zone_load_balancing_Set() const{
    return m_cross_zone_load_balancing_isSet;
}

bool OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::is_cross_zone_load_balancing_Valid() const{
    return m_cross_zone_load_balancing_isValid;
}

OAIGET_ModifyLoadBalancerAttributes_LoadBalancerAttributes_parameter_AccessLog OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::getAccessLog() const {
    return m_access_log;
}
void OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::setAccessLog(const OAIGET_ModifyLoadBalancerAttributes_LoadBalancerAttributes_parameter_AccessLog &access_log) {
    m_access_log = access_log;
    m_access_log_isSet = true;
}

bool OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::is_access_log_Set() const{
    return m_access_log_isSet;
}

bool OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::is_access_log_Valid() const{
    return m_access_log_isValid;
}

OAIGET_ModifyLoadBalancerAttributes_LoadBalancerAttributes_parameter_ConnectionDraining OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::getConnectionDraining() const {
    return m_connection_draining;
}
void OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::setConnectionDraining(const OAIGET_ModifyLoadBalancerAttributes_LoadBalancerAttributes_parameter_ConnectionDraining &connection_draining) {
    m_connection_draining = connection_draining;
    m_connection_draining_isSet = true;
}

bool OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::is_connection_draining_Set() const{
    return m_connection_draining_isSet;
}

bool OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::is_connection_draining_Valid() const{
    return m_connection_draining_isValid;
}

OAIGET_ModifyLoadBalancerAttributes_LoadBalancerAttributes_parameter_ConnectionSettings OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::getConnectionSettings() const {
    return m_connection_settings;
}
void OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::setConnectionSettings(const OAIGET_ModifyLoadBalancerAttributes_LoadBalancerAttributes_parameter_ConnectionSettings &connection_settings) {
    m_connection_settings = connection_settings;
    m_connection_settings_isSet = true;
}

bool OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::is_connection_settings_Set() const{
    return m_connection_settings_isSet;
}

bool OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::is_connection_settings_Valid() const{
    return m_connection_settings_isValid;
}

QList OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::getAdditionalAttributes() const {
    return m_additional_attributes;
}
void OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::setAdditionalAttributes(const QList &additional_attributes) {
    m_additional_attributes = additional_attributes;
    m_additional_attributes_isSet = true;
}

bool OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::is_additional_attributes_Set() const{
    return m_additional_attributes_isSet;
}

bool OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::is_additional_attributes_Valid() const{
    return m_additional_attributes_isValid;
}

bool OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::isSet() const {
...
bool OAIDescribeLoadBalancerAttributesOutput_LoadBalancerAttributes::isValid() const {
