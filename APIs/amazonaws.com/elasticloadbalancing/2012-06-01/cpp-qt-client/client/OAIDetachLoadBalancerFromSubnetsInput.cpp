...
OAIDetachLoadBalancerFromSubnetsInput::OAIDetachLoadBalancerFromSubnetsInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetachLoadBalancerFromSubnetsInput::OAIDetachLoadBalancerFromSubnetsInput() {
    this->initializeModel();
}

OAIDetachLoadBalancerFromSubnetsInput::~OAIDetachLoadBalancerFromSubnetsInput() {}

void OAIDetachLoadBalancerFromSubnetsInput::initializeModel() {
...
void OAIDetachLoadBalancerFromSubnetsInput::fromJson(QString jsonString) {
...
void OAIDetachLoadBalancerFromSubnetsInput::fromJsonObject(QJsonObject json) {
...
QString OAIDetachLoadBalancerFromSubnetsInput::asJson() const {
...
QJsonObject OAIDetachLoadBalancerFromSubnetsInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDetachLoadBalancerFromSubnetsInput::getLoadBalancerName() const {
    return m_load_balancer_name;
}
void OAIDetachLoadBalancerFromSubnetsInput::setLoadBalancerName(const QString &load_balancer_name) {
    m_load_balancer_name = load_balancer_name;
    m_load_balancer_name_isSet = true;
}

bool OAIDetachLoadBalancerFromSubnetsInput::is_load_balancer_name_Set() const{
    return m_load_balancer_name_isSet;
}

bool OAIDetachLoadBalancerFromSubnetsInput::is_load_balancer_name_Valid() const{
    return m_load_balancer_name_isValid;
}

QList OAIDetachLoadBalancerFromSubnetsInput::getSubnets() const {
    return m_subnets;
}
void OAIDetachLoadBalancerFromSubnetsInput::setSubnets(const QList &subnets) {
    m_subnets = subnets;
    m_subnets_isSet = true;
}

bool OAIDetachLoadBalancerFromSubnetsInput::is_subnets_Set() const{
    return m_subnets_isSet;
}

bool OAIDetachLoadBalancerFromSubnetsInput::is_subnets_Valid() const{
    return m_subnets_isValid;
}

bool OAIDetachLoadBalancerFromSubnetsInput::isSet() const {
...
bool OAIDetachLoadBalancerFromSubnetsInput::isValid() const {
