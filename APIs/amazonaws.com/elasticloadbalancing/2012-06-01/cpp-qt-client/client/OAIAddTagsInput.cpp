...
QList OAIAddTagsInput::getLoadBalancerNames() const {
    return m_load_balancer_names;
}
void OAIAddTagsInput::setLoadBalancerNames(const QList &load_balancer_names) {
    m_load_balancer_names = load_balancer_names;
    m_load_balancer_names_isSet = true;
}

bool OAIAddTagsInput::is_load_balancer_names_Set() const{
    return m_load_balancer_names_isSet;
}

bool OAIAddTagsInput::is_load_balancer_names_Valid() const{
