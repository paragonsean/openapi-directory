...
/*
 * OAIDeleteLoadBalancerPolicyInput.h
 *
 * Contains the parameters for DeleteLoadBalancerPolicy.
 */

#ifndef OAIDeleteLoadBalancerPolicyInput_H
#define OAIDeleteLoadBalancerPolicyInput_H
...
class OAIDeleteLoadBalancerPolicyInput : public OAIObject {
public:
    OAIDeleteLoadBalancerPolicyInput();
    OAIDeleteLoadBalancerPolicyInput(QString json);
    ~OAIDeleteLoadBalancerPolicyInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteLoadBalancerPolicyInput)

#endif // OAIDeleteLoadBalancerPolicyInput_H
