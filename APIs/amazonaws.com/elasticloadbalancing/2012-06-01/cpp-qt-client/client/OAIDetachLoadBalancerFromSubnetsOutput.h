...
/*
 * OAIDetachLoadBalancerFromSubnetsOutput.h
 *
 * Contains the output of DetachLoadBalancerFromSubnets.
 */

#ifndef OAIDetachLoadBalancerFromSubnetsOutput_H
#define OAIDetachLoadBalancerFromSubnetsOutput_H
...
class OAIDetachLoadBalancerFromSubnetsOutput : public OAIObject {
public:
    OAIDetachLoadBalancerFromSubnetsOutput();
    OAIDetachLoadBalancerFromSubnetsOutput(QString json);
    ~OAIDetachLoadBalancerFromSubnetsOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetachLoadBalancerFromSubnetsOutput)

#endif // OAIDetachLoadBalancerFromSubnetsOutput_H
