...
OAIRegisterEndPointsOutput::OAIRegisterEndPointsOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRegisterEndPointsOutput::OAIRegisterEndPointsOutput() {
    this->initializeModel();
}

OAIRegisterEndPointsOutput::~OAIRegisterEndPointsOutput() {}

void OAIRegisterEndPointsOutput::initializeModel() {

    m_instances_isSet = false;
    m_instances_isValid = false;
}

void OAIRegisterEndPointsOutput::fromJson(QString jsonString) {
...
void OAIRegisterEndPointsOutput::fromJsonObject(QJsonObject json) {
...
QString OAIRegisterEndPointsOutput::asJson() const {
...
QJsonObject OAIRegisterEndPointsOutput::asJsonObject() const {
    QJsonObject obj;
...
QList OAIRegisterEndPointsOutput::getInstances() const {
    return m_instances;
}
void OAIRegisterEndPointsOutput::setInstances(const QList &instances) {
    m_instances = instances;
    m_instances_isSet = true;
}

bool OAIRegisterEndPointsOutput::is_instances_Set() const{
    return m_instances_isSet;
}

bool OAIRegisterEndPointsOutput::is_instances_Valid() const{
    return m_instances_isValid;
}

bool OAIRegisterEndPointsOutput::isSet() const {
...
bool OAIRegisterEndPointsOutput::isValid() const {
