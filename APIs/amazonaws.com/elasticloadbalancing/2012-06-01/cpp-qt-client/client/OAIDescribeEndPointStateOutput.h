...
/*
 * OAIDescribeEndPointStateOutput.h
 *
 * Contains the output for DescribeInstanceHealth.
 */

#ifndef OAIDescribeEndPointStateOutput_H
#define OAIDescribeEndPointStateOutput_H
...
class OAIDescribeEndPointStateOutput : public OAIObject {
public:
    OAIDescribeEndPointStateOutput();
    OAIDescribeEndPointStateOutput(QString json);
    ~OAIDescribeEndPointStateOutput() override;
    ...
    QList getInstanceStates() const;
    void setInstanceStates(const QList &instance_states);
    bool is_instance_states_Set() const;
    bool is_instance_states_Valid() const;
...
private:
    ...
    QList m_instance_states;
    bool m_instance_states_isSet;
    bool m_instance_states_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEndPointStateOutput)

#endif // OAIDescribeEndPointStateOutput_H
