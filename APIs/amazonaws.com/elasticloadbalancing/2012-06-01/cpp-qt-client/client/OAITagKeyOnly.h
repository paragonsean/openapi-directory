...
#ifndef OAITagKeyOnly_H
#define OAITagKeyOnly_H
...
class OAITagKeyOnly : public OAIObject {
public:
    OAITagKeyOnly();
    OAITagKeyOnly(QString json);
    ~OAITagKeyOnly() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITagKeyOnly)

#endif // OAITagKeyOnly_H
