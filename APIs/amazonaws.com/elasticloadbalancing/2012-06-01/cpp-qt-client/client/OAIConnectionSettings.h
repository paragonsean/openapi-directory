...
/*
 * OAIConnectionSettings.h
 *
 * Information about the &lt;code&gt;ConnectionSettings&lt;/code&gt; attribute.
 */

#ifndef OAIConnectionSettings_H
#define OAIConnectionSettings_H
...
class OAIConnectionSettings : public OAIObject {
public:
    OAIConnectionSettings();
    OAIConnectionSettings(QString json);
    ~OAIConnectionSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnectionSettings)

#endif // OAIConnectionSettings_H
