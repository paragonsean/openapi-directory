...
/*
 * OAILoadBalancerDescription_HealthCheck.h
 *
 * 
 */

#ifndef OAILoadBalancerDescription_HealthCheck_H
#define OAILoadBalancerDescription_HealthCheck_H
...
class OAILoadBalancerDescription_HealthCheck : public OAIObject {
public:
    OAILoadBalancerDescription_HealthCheck();
    OAILoadBalancerDescription_HealthCheck(QString json);
    ~OAILoadBalancerDescription_HealthCheck() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILoadBalancerDescription_HealthCheck)

#endif // OAILoadBalancerDescription_HealthCheck_H
