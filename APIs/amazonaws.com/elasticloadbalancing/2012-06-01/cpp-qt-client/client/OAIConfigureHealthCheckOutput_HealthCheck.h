...
/*
 * OAIConfigureHealthCheckOutput_HealthCheck.h
 *
 * 
 */

#ifndef OAIConfigureHealthCheckOutput_HealthCheck_H
#define OAIConfigureHealthCheckOutput_HealthCheck_H
...
class OAIConfigureHealthCheckOutput_HealthCheck : public OAIObject {
public:
    OAIConfigureHealthCheckOutput_HealthCheck();
    OAIConfigureHealthCheckOutput_HealthCheck(QString json);
    ~OAIConfigureHealthCheckOutput_HealthCheck() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConfigureHealthCheckOutput_HealthCheck)

#endif // OAIConfigureHealthCheckOutput_HealthCheck_H
