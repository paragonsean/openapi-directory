...
/*
 * OAICreateLoadBalancerPolicyInput.h
 *
 * Contains the parameters for CreateLoadBalancerPolicy.
 */

#ifndef OAICreateLoadBalancerPolicyInput_H
#define OAICreateLoadBalancerPolicyInput_H
...
class OAICreateLoadBalancerPolicyInput : public OAIObject {
public:
    OAICreateLoadBalancerPolicyInput();
    OAICreateLoadBalancerPolicyInput(QString json);
    ~OAICreateLoadBalancerPolicyInput() override;
    ...
    QList getPolicyAttributes() const;
    void setPolicyAttributes(const QList &policy_attributes);
    bool is_policy_attributes_Set() const;
    bool is_policy_attributes_Valid() const;
...
private:
    ...
    QList m_policy_attributes;
    bool m_policy_attributes_isSet;
    bool m_policy_attributes_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateLoadBalancerPolicyInput)

#endif // OAICreateLoadBalancerPolicyInput_H
