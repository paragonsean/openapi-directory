...
/*
 * OAIAttachLoadBalancerToSubnetsOutput.h
 *
 * Contains the output of AttachLoadBalancerToSubnets.
 */

#ifndef OAIAttachLoadBalancerToSubnetsOutput_H
#define OAIAttachLoadBalancerToSubnetsOutput_H
...
class OAIAttachLoadBalancerToSubnetsOutput : public OAIObject {
public:
    OAIAttachLoadBalancerToSubnetsOutput();
    OAIAttachLoadBalancerToSubnetsOutput(QString json);
    ~OAIAttachLoadBalancerToSubnetsOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttachLoadBalancerToSubnetsOutput)

#endif // OAIAttachLoadBalancerToSubnetsOutput_H
