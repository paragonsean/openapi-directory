...
QString OAIHealthCheck::getTarget() const {
    return m_target;
}
void OAIHealthCheck::setTarget(const QString &target) {
    m_target = target;
    m_target_isSet = true;
}

bool OAIHealthCheck::is_target_Set() const{
    return m_target_isSet;
}

bool OAIHealthCheck::is_target_Valid() const{
    return m_target_isValid;
}

qint32 OAIHealthCheck::getInterval() const {
    return m_interval;
}
void OAIHealthCheck::setInterval(const qint32 &interval) {
    m_interval = interval;
    m_interval_isSet = true;
}

bool OAIHealthCheck::is_interval_Set() const{
    return m_interval_isSet;
}

bool OAIHealthCheck::is_interval_Valid() const{
    return m_interval_isValid;
}

qint32 OAIHealthCheck::getTimeout() const {
    return m_timeout;
}
void OAIHealthCheck::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIHealthCheck::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIHealthCheck::is_timeout_Valid() const{
