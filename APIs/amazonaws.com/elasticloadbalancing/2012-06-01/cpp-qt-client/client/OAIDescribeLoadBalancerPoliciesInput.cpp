...
OAIDescribeLoadBalancerPoliciesInput::OAIDescribeLoadBalancerPoliciesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeLoadBalancerPoliciesInput::OAIDescribeLoadBalancerPoliciesInput() {
    this->initializeModel();
}

OAIDescribeLoadBalancerPoliciesInput::~OAIDescribeLoadBalancerPoliciesInput() {}

void OAIDescribeLoadBalancerPoliciesInput::initializeModel() {
...
void OAIDescribeLoadBalancerPoliciesInput::fromJson(QString jsonString) {
...
void OAIDescribeLoadBalancerPoliciesInput::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeLoadBalancerPoliciesInput::asJson() const {
...
QJsonObject OAIDescribeLoadBalancerPoliciesInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeLoadBalancerPoliciesInput::getLoadBalancerName() const {
    return m_load_balancer_name;
}
void OAIDescribeLoadBalancerPoliciesInput::setLoadBalancerName(const QString &load_balancer_name) {
    m_load_balancer_name = load_balancer_name;
    m_load_balancer_name_isSet = true;
}

bool OAIDescribeLoadBalancerPoliciesInput::is_load_balancer_name_Set() const{
    return m_load_balancer_name_isSet;
}

bool OAIDescribeLoadBalancerPoliciesInput::is_load_balancer_name_Valid() const{
    return m_load_balancer_name_isValid;
}

QList OAIDescribeLoadBalancerPoliciesInput::getPolicyNames() const {
    return m_policy_names;
}
void OAIDescribeLoadBalancerPoliciesInput::setPolicyNames(const QList &policy_names) {
    m_policy_names = policy_names;
    m_policy_names_isSet = true;
}

bool OAIDescribeLoadBalancerPoliciesInput::is_policy_names_Set() const{
    return m_policy_names_isSet;
}

bool OAIDescribeLoadBalancerPoliciesInput::is_policy_names_Valid() const{
    return m_policy_names_isValid;
}

bool OAIDescribeLoadBalancerPoliciesInput::isSet() const {
...
bool OAIDescribeLoadBalancerPoliciesInput::isValid() const {
