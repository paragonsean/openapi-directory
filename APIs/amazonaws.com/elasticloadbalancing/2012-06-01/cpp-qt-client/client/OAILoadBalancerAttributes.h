...
/*
 * OAILoadBalancerAttributes.h
 *
 * The attributes for a load balancer.
 */

#ifndef OAILoadBalancerAttributes_H
#define OAILoadBalancerAttributes_H
...
class OAILoadBalancerAttributes : public OAIObject {
public:
    OAILoadBalancerAttributes();
    OAILoadBalancerAttributes(QString json);
    ~OAILoadBalancerAttributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILoadBalancerAttributes)

#endif // OAILoadBalancerAttributes_H
