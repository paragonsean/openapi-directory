...
/*
 * OAIModifyLoadBalancerAttributesInput.h
 *
 * Contains the parameters for ModifyLoadBalancerAttributes.
 */

#ifndef OAIModifyLoadBalancerAttributesInput_H
#define OAIModifyLoadBalancerAttributesInput_H

#include <QJsonObject>

#include "OAIModifyLoadBalancerAttributesInput_LoadBalancerAttributes.h"
#include <QString>
...
namespace OpenAPI {
class OAIModifyLoadBalancerAttributesInput_LoadBalancerAttributes;

class OAIModifyLoadBalancerAttributesInput : public OAIObject {
public:
    OAIModifyLoadBalancerAttributesInput();
    OAIModifyLoadBalancerAttributesInput(QString json);
    ~OAIModifyLoadBalancerAttributesInput() override;
    ...
    OAIModifyLoadBalancerAttributesInput_LoadBalancerAttributes getLoadBalancerAttributes() const;
    void setLoadBalancerAttributes(const OAIModifyLoadBalancerAttributesInput_LoadBalancerAttributes &load_balancer_attributes);
...
private:
    ...
    OAIModifyLoadBalancerAttributesInput_LoadBalancerAttributes m_load_balancer_attributes;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModifyLoadBalancerAttributesInput)

#endif // OAIModifyLoadBalancerAttributesInput_H
