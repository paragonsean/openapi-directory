...
/*
 * OAIDeleteAccessPointInput.h
 *
 * Contains the parameters for DeleteLoadBalancer.
 */

#ifndef OAIDeleteAccessPointInput_H
#define OAIDeleteAccessPointInput_H
...
class OAIDeleteAccessPointInput : public OAIObject {
public:
    OAIDeleteAccessPointInput();
    OAIDeleteAccessPointInput(QString json);
    ~OAIDeleteAccessPointInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteAccessPointInput)

#endif // OAIDeleteAccessPointInput_H
