...
/*
 * OAIDescribeLoadBalancerPolicyTypesOutput.h
 *
 * Contains the output of DescribeLoadBalancerPolicyTypes.
 */

#ifndef OAIDescribeLoadBalancerPolicyTypesOutput_H
#define OAIDescribeLoadBalancerPolicyTypesOutput_H
...
class OAIDescribeLoadBalancerPolicyTypesOutput : public OAIObject {
public:
    OAIDescribeLoadBalancerPolicyTypesOutput();
    OAIDescribeLoadBalancerPolicyTypesOutput(QString json);
    ~OAIDescribeLoadBalancerPolicyTypesOutput() override;
    ...
    QList getPolicyTypeDescriptions() const;
    void setPolicyTypeDescriptions(const QList &policy_type_descriptions);
    bool is_policy_type_descriptions_Set() const;
    bool is_policy_type_descriptions_Valid() const;
...
private:
    ...
    QList m_policy_type_descriptions;
    bool m_policy_type_descriptions_isSet;
    bool m_policy_type_descriptions_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeLoadBalancerPolicyTypesOutput)

#endif // OAIDescribeLoadBalancerPolicyTypesOutput_H
