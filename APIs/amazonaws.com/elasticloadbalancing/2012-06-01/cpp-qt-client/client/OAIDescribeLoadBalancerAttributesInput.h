...
/*
 * OAIDescribeLoadBalancerAttributesInput.h
 *
 * Contains the parameters for DescribeLoadBalancerAttributes.
 */

#ifndef OAIDescribeLoadBalancerAttributesInput_H
#define OAIDescribeLoadBalancerAttributesInput_H
...
class OAIDescribeLoadBalancerAttributesInput : public OAIObject {
public:
    OAIDescribeLoadBalancerAttributesInput();
    OAIDescribeLoadBalancerAttributesInput(QString json);
    ~OAIDescribeLoadBalancerAttributesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeLoadBalancerAttributesInput)

#endif // OAIDescribeLoadBalancerAttributesInput_H
