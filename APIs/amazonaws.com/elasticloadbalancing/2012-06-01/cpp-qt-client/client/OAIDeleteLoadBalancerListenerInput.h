...
/*
 * OAIDeleteLoadBalancerListenerInput.h
 *
 * Contains the parameters for DeleteLoadBalancerListeners.
 */

#ifndef OAIDeleteLoadBalancerListenerInput_H
#define OAIDeleteLoadBalancerListenerInput_H
...
class OAIDeleteLoadBalancerListenerInput : public OAIObject {
public:
    OAIDeleteLoadBalancerListenerInput();
    OAIDeleteLoadBalancerListenerInput(QString json);
    ~OAIDeleteLoadBalancerListenerInput() override;
    ...
    QList getLoadBalancerPorts() const;
    void setLoadBalancerPorts(const QList &load_balancer_ports);
    bool is_load_balancer_ports_Set() const;
    bool is_load_balancer_ports_Valid() const;
...
private:
    ...
    QList m_load_balancer_ports;
    bool m_load_balancer_ports_isSet;
    bool m_load_balancer_ports_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDeleteLoadBalancerListenerInput)

#endif // OAIDeleteLoadBalancerListenerInput_H
