...
QString OAITagDescription::getLoadBalancerName() const {
    return m_load_balancer_name;
}
void OAITagDescription::setLoadBalancerName(const QString &load_balancer_name) {
    m_load_balancer_name = load_balancer_name;
    m_load_balancer_name_isSet = true;
}

bool OAITagDescription::is_load_balancer_name_Set() const{
    return m_load_balancer_name_isSet;
}

bool OAITagDescription::is_load_balancer_name_Valid() const{
