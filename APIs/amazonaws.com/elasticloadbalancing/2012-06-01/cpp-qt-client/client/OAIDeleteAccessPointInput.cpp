...
OAIDeleteAccessPointInput::OAIDeleteAccessPointInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteAccessPointInput::OAIDeleteAccessPointInput() {
    this->initializeModel();
}

OAIDeleteAccessPointInput::~OAIDeleteAccessPointInput() {}

void OAIDeleteAccessPointInput::initializeModel() {

    m_load_balancer_name_isSet = false;
    m_load_balancer_name_isValid = false;
}

void OAIDeleteAccessPointInput::fromJson(QString jsonString) {
...
void OAIDeleteAccessPointInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteAccessPointInput::asJson() const {
...
QJsonObject OAIDeleteAccessPointInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteAccessPointInput::getLoadBalancerName() const {
    return m_load_balancer_name;
}
void OAIDeleteAccessPointInput::setLoadBalancerName(const QString &load_balancer_name) {
    m_load_balancer_name = load_balancer_name;
    m_load_balancer_name_isSet = true;
}

bool OAIDeleteAccessPointInput::is_load_balancer_name_Set() const{
    return m_load_balancer_name_isSet;
}

bool OAIDeleteAccessPointInput::is_load_balancer_name_Valid() const{
    return m_load_balancer_name_isValid;
}

bool OAIDeleteAccessPointInput::isSet() const {
...
bool OAIDeleteAccessPointInput::isValid() const {
