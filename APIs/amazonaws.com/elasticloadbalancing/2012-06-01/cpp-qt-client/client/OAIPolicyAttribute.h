...
/*
 * OAIPolicyAttribute.h
 *
 * Information about a policy attribute.
 */

#ifndef OAIPolicyAttribute_H
#define OAIPolicyAttribute_H
...
class OAIPolicyAttribute : public OAIObject {
public:
    OAIPolicyAttribute();
    OAIPolicyAttribute(QString json);
    ~OAIPolicyAttribute() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPolicyAttribute)

#endif // OAIPolicyAttribute_H
