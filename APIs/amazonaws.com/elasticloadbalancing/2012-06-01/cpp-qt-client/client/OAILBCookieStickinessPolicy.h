...
/*
 * OAILBCookieStickinessPolicy.h
 *
 * Information about a policy for duration-based session stickiness.
 */

#ifndef OAILBCookieStickinessPolicy_H
#define OAILBCookieStickinessPolicy_H
...
class OAILBCookieStickinessPolicy : public OAIObject {
public:
    OAILBCookieStickinessPolicy();
    OAILBCookieStickinessPolicy(QString json);
    ~OAILBCookieStickinessPolicy() override;
    ...
    qint32 getCookieExpirationPeriod() const;
    void setCookieExpirationPeriod(const qint32 &cookie_expiration_period);
    bool is_cookie_expiration_period_Set() const;
    bool is_cookie_expiration_period_Valid() const;
...
private:
    ...
    qint32 m_cookie_expiration_period;
    bool m_cookie_expiration_period_isSet;
    bool m_cookie_expiration_period_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAILBCookieStickinessPolicy)

#endif // OAILBCookieStickinessPolicy_H
