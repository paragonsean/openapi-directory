...
/*
 * OAILoadBalancerDescription_SourceSecurityGroup.h
 *
 * 
 */

#ifndef OAILoadBalancerDescription_SourceSecurityGroup_H
#define OAILoadBalancerDescription_SourceSecurityGroup_H
...
class OAILoadBalancerDescription_SourceSecurityGroup : public OAIObject {
public:
    OAILoadBalancerDescription_SourceSecurityGroup();
    OAILoadBalancerDescription_SourceSecurityGroup(QString json);
    ~OAILoadBalancerDescription_SourceSecurityGroup() override;
    ...
    QString getOwnerAlias() const;
    void setOwnerAlias(const QString &owner_alias);
    bool is_owner_alias_Set() const;
    bool is_owner_alias_Valid() const;
...
private:
    ...
    QString m_owner_alias;
    bool m_owner_alias_isSet;
    bool m_owner_alias_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAILoadBalancerDescription_SourceSecurityGroup)

#endif // OAILoadBalancerDescription_SourceSecurityGroup_H
