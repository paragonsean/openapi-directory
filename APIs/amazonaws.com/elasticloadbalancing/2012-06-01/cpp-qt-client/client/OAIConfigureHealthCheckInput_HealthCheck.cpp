...
#include "OAIConfigureHealthCheckInput_HealthCheck.h"
...
OAIConfigureHealthCheckInput_HealthCheck::OAIConfigureHealthCheckInput_HealthCheck(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConfigureHealthCheckInput_HealthCheck::OAIConfigureHealthCheckInput_HealthCheck() {
    this->initializeModel();
}

OAIConfigureHealthCheckInput_HealthCheck::~OAIConfigureHealthCheckInput_HealthCheck() {}

void OAIConfigureHealthCheckInput_HealthCheck::initializeModel() {
...
void OAIConfigureHealthCheckInput_HealthCheck::fromJson(QString jsonString) {
...
void OAIConfigureHealthCheckInput_HealthCheck::fromJsonObject(QJsonObject json) {
...
QString OAIConfigureHealthCheckInput_HealthCheck::asJson() const {
...
QJsonObject OAIConfigureHealthCheckInput_HealthCheck::asJsonObject() const {
    QJsonObject obj;
    if (m_target_isSet) {
...
QString OAIConfigureHealthCheckInput_HealthCheck::getTarget() const {
    return m_target;
}
void OAIConfigureHealthCheckInput_HealthCheck::setTarget(const QString &target) {
    m_target = target;
    m_target_isSet = true;
}

bool OAIConfigureHealthCheckInput_HealthCheck::is_target_Set() const{
    return m_target_isSet;
}

bool OAIConfigureHealthCheckInput_HealthCheck::is_target_Valid() const{
    return m_target_isValid;
}

qint32 OAIConfigureHealthCheckInput_HealthCheck::getInterval() const {
    return m_interval;
}
void OAIConfigureHealthCheckInput_HealthCheck::setInterval(const qint32 &interval) {
    m_interval = interval;
    m_interval_isSet = true;
}

bool OAIConfigureHealthCheckInput_HealthCheck::is_interval_Set() const{
    return m_interval_isSet;
}

bool OAIConfigureHealthCheckInput_HealthCheck::is_interval_Valid() const{
    return m_interval_isValid;
}

qint32 OAIConfigureHealthCheckInput_HealthCheck::getTimeout() const {
    return m_timeout;
}
void OAIConfigureHealthCheckInput_HealthCheck::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAIConfigureHealthCheckInput_HealthCheck::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAIConfigureHealthCheckInput_HealthCheck::is_timeout_Valid() const{
    return m_timeout_isValid;
}

qint32 OAIConfigureHealthCheckInput_HealthCheck::getUnhealthyThreshold() const {
    return m_unhealthy_threshold;
}
void OAIConfigureHealthCheckInput_HealthCheck::setUnhealthyThreshold(const qint32 &unhealthy_threshold) {
    m_unhealthy_threshold = unhealthy_threshold;
    m_unhealthy_threshold_isSet = true;
}

bool OAIConfigureHealthCheckInput_HealthCheck::is_unhealthy_threshold_Set() const{
    return m_unhealthy_threshold_isSet;
}

bool OAIConfigureHealthCheckInput_HealthCheck::is_unhealthy_threshold_Valid() const{
    return m_unhealthy_threshold_isValid;
}

qint32 OAIConfigureHealthCheckInput_HealthCheck::getHealthyThreshold() const {
    return m_healthy_threshold;
}
void OAIConfigureHealthCheckInput_HealthCheck::setHealthyThreshold(const qint32 &healthy_threshold) {
    m_healthy_threshold = healthy_threshold;
    m_healthy_threshold_isSet = true;
}

bool OAIConfigureHealthCheckInput_HealthCheck::is_healthy_threshold_Set() const{
    return m_healthy_threshold_isSet;
}

bool OAIConfigureHealthCheckInput_HealthCheck::is_healthy_threshold_Valid() const{
    return m_healthy_threshold_isValid;
}

bool OAIConfigureHealthCheckInput_HealthCheck::isSet() const {
...
bool OAIConfigureHealthCheckInput_HealthCheck::isValid() const {
