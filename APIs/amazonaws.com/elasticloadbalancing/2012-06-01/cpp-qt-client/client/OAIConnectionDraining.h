...
/*
 * OAIConnectionDraining.h
 *
 * Information about the &lt;code&gt;ConnectionDraining&lt;/code&gt; attribute.
 */

#ifndef OAIConnectionDraining_H
#define OAIConnectionDraining_H
...
class OAIConnectionDraining : public OAIObject {
public:
    OAIConnectionDraining();
    OAIConnectionDraining(QString json);
    ~OAIConnectionDraining() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnectionDraining)

#endif // OAIConnectionDraining_H
