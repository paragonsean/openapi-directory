...
OAIDeleteLoadBalancerPolicyInput::OAIDeleteLoadBalancerPolicyInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteLoadBalancerPolicyInput::OAIDeleteLoadBalancerPolicyInput() {
    this->initializeModel();
}

OAIDeleteLoadBalancerPolicyInput::~OAIDeleteLoadBalancerPolicyInput() {}

void OAIDeleteLoadBalancerPolicyInput::initializeModel() {
...
void OAIDeleteLoadBalancerPolicyInput::fromJson(QString jsonString) {
...
void OAIDeleteLoadBalancerPolicyInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteLoadBalancerPolicyInput::asJson() const {
...
QJsonObject OAIDeleteLoadBalancerPolicyInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteLoadBalancerPolicyInput::getLoadBalancerName() const {
    return m_load_balancer_name;
}
void OAIDeleteLoadBalancerPolicyInput::setLoadBalancerName(const QString &load_balancer_name) {
    m_load_balancer_name = load_balancer_name;
    m_load_balancer_name_isSet = true;
}

bool OAIDeleteLoadBalancerPolicyInput::is_load_balancer_name_Set() const{
    return m_load_balancer_name_isSet;
}

bool OAIDeleteLoadBalancerPolicyInput::is_load_balancer_name_Valid() const{
    return m_load_balancer_name_isValid;
}

QString OAIDeleteLoadBalancerPolicyInput::getPolicyName() const {
    return m_policy_name;
}
void OAIDeleteLoadBalancerPolicyInput::setPolicyName(const QString &policy_name) {
    m_policy_name = policy_name;
    m_policy_name_isSet = true;
}

bool OAIDeleteLoadBalancerPolicyInput::is_policy_name_Set() const{
    return m_policy_name_isSet;
}

bool OAIDeleteLoadBalancerPolicyInput::is_policy_name_Valid() const{
    return m_policy_name_isValid;
}

bool OAIDeleteLoadBalancerPolicyInput::isSet() const {
...
bool OAIDeleteLoadBalancerPolicyInput::isValid() const {
