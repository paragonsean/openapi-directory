...
#include "OAISourceSecurityGroup.h"
...
OAISourceSecurityGroup::OAISourceSecurityGroup(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISourceSecurityGroup::OAISourceSecurityGroup() {
    this->initializeModel();
}

OAISourceSecurityGroup::~OAISourceSecurityGroup() {}

void OAISourceSecurityGroup::initializeModel() {
...
void OAISourceSecurityGroup::fromJson(QString jsonString) {
...
void OAISourceSecurityGroup::fromJsonObject(QJsonObject json) {
...
QString OAISourceSecurityGroup::asJson() const {
...
QJsonObject OAISourceSecurityGroup::asJsonObject() const {
    QJsonObject obj;
...
QString OAISourceSecurityGroup::getOwnerAlias() const {
    return m_owner_alias;
}
void OAISourceSecurityGroup::setOwnerAlias(const QString &owner_alias) {
    m_owner_alias = owner_alias;
    m_owner_alias_isSet = true;
}

bool OAISourceSecurityGroup::is_owner_alias_Set() const{
    return m_owner_alias_isSet;
}

bool OAISourceSecurityGroup::is_owner_alias_Valid() const{
    return m_owner_alias_isValid;
}

QString OAISourceSecurityGroup::getGroupName() const {
    return m_group_name;
}
void OAISourceSecurityGroup::setGroupName(const QString &group_name) {
    m_group_name = group_name;
    m_group_name_isSet = true;
}

bool OAISourceSecurityGroup::is_group_name_Set() const{
    return m_group_name_isSet;
}

bool OAISourceSecurityGroup::is_group_name_Valid() const{
    return m_group_name_isValid;
}

bool OAISourceSecurityGroup::isSet() const {
...
bool OAISourceSecurityGroup::isValid() const {
