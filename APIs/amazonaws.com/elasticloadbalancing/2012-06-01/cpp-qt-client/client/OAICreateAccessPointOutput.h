...
/*
 * OAICreateAccessPointOutput.h
 *
 * Contains the output for CreateLoadBalancer.
 */

#ifndef OAICreateAccessPointOutput_H
#define OAICreateAccessPointOutput_H
...
class OAICreateAccessPointOutput : public OAIObject {
public:
    OAICreateAccessPointOutput();
    OAICreateAccessPointOutput(QString json);
    ~OAICreateAccessPointOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAccessPointOutput)

#endif // OAICreateAccessPointOutput_H
