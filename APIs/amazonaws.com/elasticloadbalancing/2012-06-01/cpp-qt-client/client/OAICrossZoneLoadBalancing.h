...
/*
 * OAICrossZoneLoadBalancing.h
 *
 * Information about the &lt;code&gt;CrossZoneLoadBalancing&lt;/code&gt; attribute.
 */

#ifndef OAICrossZoneLoadBalancing_H
#define OAICrossZoneLoadBalancing_H
...
class OAICrossZoneLoadBalancing : public OAIObject {
public:
    OAICrossZoneLoadBalancing();
    OAICrossZoneLoadBalancing(QString json);
    ~OAICrossZoneLoadBalancing() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICrossZoneLoadBalancing)

#endif // OAICrossZoneLoadBalancing_H
