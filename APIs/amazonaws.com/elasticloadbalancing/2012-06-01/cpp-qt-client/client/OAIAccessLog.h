...
#ifndef OAIAccessLog_H
#define OAIAccessLog_H
...
class OAIAccessLog : public OAIObject {
public:
    OAIAccessLog();
    OAIAccessLog(QString json);
    ~OAIAccessLog() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccessLog)

#endif // OAIAccessLog_H
