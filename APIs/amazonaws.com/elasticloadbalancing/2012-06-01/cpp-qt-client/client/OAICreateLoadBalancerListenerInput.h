...
/*
 * OAICreateLoadBalancerListenerInput.h
 *
 * Contains the parameters for CreateLoadBalancerListeners.
 */

#ifndef OAICreateLoadBalancerListenerInput_H
#define OAICreateLoadBalancerListenerInput_H
...
class OAICreateLoadBalancerListenerInput : public OAIObject {
public:
    OAICreateLoadBalancerListenerInput();
    OAICreateLoadBalancerListenerInput(QString json);
    ~OAICreateLoadBalancerListenerInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLoadBalancerListenerInput)

#endif // OAICreateLoadBalancerListenerInput_H
