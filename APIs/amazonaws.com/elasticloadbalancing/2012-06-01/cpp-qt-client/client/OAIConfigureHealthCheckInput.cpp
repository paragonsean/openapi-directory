...
OAIConfigureHealthCheckInput::OAIConfigureHealthCheckInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConfigureHealthCheckInput::OAIConfigureHealthCheckInput() {
    this->initializeModel();
}

OAIConfigureHealthCheckInput::~OAIConfigureHealthCheckInput() {}

void OAIConfigureHealthCheckInput::initializeModel() {
...
void OAIConfigureHealthCheckInput::fromJson(QString jsonString) {
...
void OAIConfigureHealthCheckInput::fromJsonObject(QJsonObject json) {
...
QString OAIConfigureHealthCheckInput::asJson() const {
...
QJsonObject OAIConfigureHealthCheckInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIConfigureHealthCheckInput::getLoadBalancerName() const {
    return m_load_balancer_name;
}
void OAIConfigureHealthCheckInput::setLoadBalancerName(const QString &load_balancer_name) {
    m_load_balancer_name = load_balancer_name;
    m_load_balancer_name_isSet = true;
}

bool OAIConfigureHealthCheckInput::is_load_balancer_name_Set() const{
    return m_load_balancer_name_isSet;
}

bool OAIConfigureHealthCheckInput::is_load_balancer_name_Valid() const{
    return m_load_balancer_name_isValid;
}

OAIConfigureHealthCheckInput_HealthCheck OAIConfigureHealthCheckInput::getHealthCheck() const {
    return m_health_check;
}
void OAIConfigureHealthCheckInput::setHealthCheck(const OAIConfigureHealthCheckInput_HealthCheck &health_check) {
    m_health_check = health_check;
    m_health_check_isSet = true;
}

bool OAIConfigureHealthCheckInput::is_health_check_Set() const{
    return m_health_check_isSet;
}

bool OAIConfigureHealthCheckInput::is_health_check_Valid() const{
    return m_health_check_isValid;
}

bool OAIConfigureHealthCheckInput::isSet() const {
...
bool OAIConfigureHealthCheckInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_load_balancer_name_isValid && m_health_check_isValid && true;
}
