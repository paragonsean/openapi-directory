...
/*
 * OAIDescribeAccessPointsInput.h
 *
 * Contains the parameters for DescribeLoadBalancers.
 */

#ifndef OAIDescribeAccessPointsInput_H
#define OAIDescribeAccessPointsInput_H
...
class OAIDescribeAccessPointsInput : public OAIObject {
public:
    OAIDescribeAccessPointsInput();
    OAIDescribeAccessPointsInput(QString json);
    ~OAIDescribeAccessPointsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAccessPointsInput)

#endif // OAIDescribeAccessPointsInput_H
