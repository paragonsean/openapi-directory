...
/*
 * OAIConfigureHealthCheckInput_HealthCheck.h
 *
 * 
 */

#ifndef OAIConfigureHealthCheckInput_HealthCheck_H
#define OAIConfigureHealthCheckInput_HealthCheck_H
...
class OAIConfigureHealthCheckInput_HealthCheck : public OAIObject {
public:
    OAIConfigureHealthCheckInput_HealthCheck();
    OAIConfigureHealthCheckInput_HealthCheck(QString json);
    ~OAIConfigureHealthCheckInput_HealthCheck() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConfigureHealthCheckInput_HealthCheck)

#endif // OAIConfigureHealthCheckInput_HealthCheck_H
