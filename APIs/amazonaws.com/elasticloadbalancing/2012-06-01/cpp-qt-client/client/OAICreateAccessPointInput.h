...
/*
 * OAICreateAccessPointInput.h
 *
 * Contains the parameters for CreateLoadBalancer.
 */

#ifndef OAICreateAccessPointInput_H
#define OAICreateAccessPointInput_H
...
class OAICreateAccessPointInput : public OAIObject {
public:
    OAICreateAccessPointInput();
    OAICreateAccessPointInput(QString json);
    ~OAICreateAccessPointInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAccessPointInput)

#endif // OAICreateAccessPointInput_H
