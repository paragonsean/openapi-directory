...
/*
 * OAISourceSecurityGroup.h
 *
 * Information about a source security group.
 */

#ifndef OAISourceSecurityGroup_H
#define OAISourceSecurityGroup_H
...
class OAISourceSecurityGroup : public OAIObject {
public:
    OAISourceSecurityGroup();
    OAISourceSecurityGroup(QString json);
    ~OAISourceSecurityGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISourceSecurityGroup)

#endif // OAISourceSecurityGroup_H
