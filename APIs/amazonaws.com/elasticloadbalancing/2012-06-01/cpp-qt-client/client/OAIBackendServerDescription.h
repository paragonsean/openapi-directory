...
/*
 * OAIBackendServerDescription.h
 *
 * Information about the configuration of an EC2 instance.
 */

#ifndef OAIBackendServerDescription_H
#define OAIBackendServerDescription_H
...
class OAIBackendServerDescription : public OAIObject {
public:
    OAIBackendServerDescription();
    OAIBackendServerDescription(QString json);
    ~OAIBackendServerDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBackendServerDescription)

#endif // OAIBackendServerDescription_H
