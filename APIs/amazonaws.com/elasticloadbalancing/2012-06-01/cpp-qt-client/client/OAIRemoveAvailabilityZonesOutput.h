...
/*
 * OAIRemoveAvailabilityZonesOutput.h
 *
 * Contains the output for DisableAvailabilityZonesForLoadBalancer.
 */

#ifndef OAIRemoveAvailabilityZonesOutput_H
#define OAIRemoveAvailabilityZonesOutput_H
...
class OAIRemoveAvailabilityZonesOutput : public OAIObject {
public:
    OAIRemoveAvailabilityZonesOutput();
    OAIRemoveAvailabilityZonesOutput(QString json);
    ~OAIRemoveAvailabilityZonesOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRemoveAvailabilityZonesOutput)

#endif // OAIRemoveAvailabilityZonesOutput_H
