...
OAILoadBalancerDescription_HealthCheck::OAILoadBalancerDescription_HealthCheck(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILoadBalancerDescription_HealthCheck::OAILoadBalancerDescription_HealthCheck() {
    this->initializeModel();
}

OAILoadBalancerDescription_HealthCheck::~OAILoadBalancerDescription_HealthCheck() {}

void OAILoadBalancerDescription_HealthCheck::initializeModel() {
...
void OAILoadBalancerDescription_HealthCheck::fromJson(QString jsonString) {
...
void OAILoadBalancerDescription_HealthCheck::fromJsonObject(QJsonObject json) {
...
QString OAILoadBalancerDescription_HealthCheck::asJson() const {
...
QJsonObject OAILoadBalancerDescription_HealthCheck::asJsonObject() const {
    QJsonObject obj;
    if (m_target_isSet) {
...
QString OAILoadBalancerDescription_HealthCheck::getTarget() const {
    return m_target;
}
void OAILoadBalancerDescription_HealthCheck::setTarget(const QString &target) {
    m_target = target;
    m_target_isSet = true;
}

bool OAILoadBalancerDescription_HealthCheck::is_target_Set() const{
    return m_target_isSet;
}

bool OAILoadBalancerDescription_HealthCheck::is_target_Valid() const{
    return m_target_isValid;
}

qint32 OAILoadBalancerDescription_HealthCheck::getInterval() const {
    return m_interval;
}
void OAILoadBalancerDescription_HealthCheck::setInterval(const qint32 &interval) {
    m_interval = interval;
    m_interval_isSet = true;
}

bool OAILoadBalancerDescription_HealthCheck::is_interval_Set() const{
    return m_interval_isSet;
}

bool OAILoadBalancerDescription_HealthCheck::is_interval_Valid() const{
    return m_interval_isValid;
}

qint32 OAILoadBalancerDescription_HealthCheck::getTimeout() const {
    return m_timeout;
}
void OAILoadBalancerDescription_HealthCheck::setTimeout(const qint32 &timeout) {
    m_timeout = timeout;
    m_timeout_isSet = true;
}

bool OAILoadBalancerDescription_HealthCheck::is_timeout_Set() const{
    return m_timeout_isSet;
}

bool OAILoadBalancerDescription_HealthCheck::is_timeout_Valid() const{
    return m_timeout_isValid;
}

qint32 OAILoadBalancerDescription_HealthCheck::getUnhealthyThreshold() const {
    return m_unhealthy_threshold;
}
void OAILoadBalancerDescription_HealthCheck::setUnhealthyThreshold(const qint32 &unhealthy_threshold) {
    m_unhealthy_threshold = unhealthy_threshold;
    m_unhealthy_threshold_isSet = true;
}

bool OAILoadBalancerDescription_HealthCheck::is_unhealthy_threshold_Set() const{
    return m_unhealthy_threshold_isSet;
}

bool OAILoadBalancerDescription_HealthCheck::is_unhealthy_threshold_Valid() const{
    return m_unhealthy_threshold_isValid;
}

qint32 OAILoadBalancerDescription_HealthCheck::getHealthyThreshold() const {
    return m_healthy_threshold;
}
void OAILoadBalancerDescription_HealthCheck::setHealthyThreshold(const qint32 &healthy_threshold) {
    m_healthy_threshold = healthy_threshold;
    m_healthy_threshold_isSet = true;
}

bool OAILoadBalancerDescription_HealthCheck::is_healthy_threshold_Set() const{
    return m_healthy_threshold_isSet;
}

bool OAILoadBalancerDescription_HealthCheck::is_healthy_threshold_Valid() const{
    return m_healthy_threshold_isValid;
}

bool OAILoadBalancerDescription_HealthCheck::isSet() const {
...
bool OAILoadBalancerDescription_HealthCheck::isValid() const {
