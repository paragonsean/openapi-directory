...
OAIRemoveAvailabilityZonesOutput::OAIRemoveAvailabilityZonesOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRemoveAvailabilityZonesOutput::OAIRemoveAvailabilityZonesOutput() {
    this->initializeModel();
}

OAIRemoveAvailabilityZonesOutput::~OAIRemoveAvailabilityZonesOutput() {}

void OAIRemoveAvailabilityZonesOutput::initializeModel() {

    m_availability_zones_isSet = false;
    m_availability_zones_isValid = false;
}

void OAIRemoveAvailabilityZonesOutput::fromJson(QString jsonString) {
...
void OAIRemoveAvailabilityZonesOutput::fromJsonObject(QJsonObject json) {
...
QString OAIRemoveAvailabilityZonesOutput::asJson() const {
...
QJsonObject OAIRemoveAvailabilityZonesOutput::asJsonObject() const {
    QJsonObject obj;
...
QList OAIRemoveAvailabilityZonesOutput::getAvailabilityZones() const {
    return m_availability_zones;
}
void OAIRemoveAvailabilityZonesOutput::setAvailabilityZones(const QList &availability_zones) {
    m_availability_zones = availability_zones;
    m_availability_zones_isSet = true;
}

bool OAIRemoveAvailabilityZonesOutput::is_availability_zones_Set() const{
    return m_availability_zones_isSet;
}

bool OAIRemoveAvailabilityZonesOutput::is_availability_zones_Valid() const{
    return m_availability_zones_isValid;
}

bool OAIRemoveAvailabilityZonesOutput::isSet() const {
...
bool OAIRemoveAvailabilityZonesOutput::isValid() const {
