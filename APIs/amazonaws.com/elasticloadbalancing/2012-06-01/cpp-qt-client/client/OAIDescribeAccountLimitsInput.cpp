...
QString OAIDescribeAccountLimitsInput::getMarker() const {
    return m_marker;
}
void OAIDescribeAccountLimitsInput::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIDescribeAccountLimitsInput::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIDescribeAccountLimitsInput::is_marker_Valid() const{
    return m_marker_isValid;
}

qint32 OAIDescribeAccountLimitsInput::getPageSize() const {
    return m_page_size;
}
void OAIDescribeAccountLimitsInput::setPageSize(const qint32 &page_size) {
    m_page_size = page_size;
    m_page_size_isSet = true;
}

bool OAIDescribeAccountLimitsInput::is_page_size_Set() const{
    return m_page_size_isSet;
}

bool OAIDescribeAccountLimitsInput::is_page_size_Valid() const{
