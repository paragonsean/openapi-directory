...
/*
 * OAIDeregisterEndPointsOutput.h
 *
 * Contains the output of DeregisterInstancesFromLoadBalancer.
 */

#ifndef OAIDeregisterEndPointsOutput_H
#define OAIDeregisterEndPointsOutput_H
...
class OAIDeregisterEndPointsOutput : public OAIObject {
public:
    OAIDeregisterEndPointsOutput();
    OAIDeregisterEndPointsOutput(QString json);
    ~OAIDeregisterEndPointsOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeregisterEndPointsOutput)

#endif // OAIDeregisterEndPointsOutput_H
