...
/*
 * OAIConfigureHealthCheckInput.h
 *
 * Contains the parameters for ConfigureHealthCheck.
 */

#ifndef OAIConfigureHealthCheckInput_H
#define OAIConfigureHealthCheckInput_H
...
namespace OpenAPI {
class OAIConfigureHealthCheckInput_HealthCheck;

class OAIConfigureHealthCheckInput : public OAIObject {
public:
    OAIConfigureHealthCheckInput();
    OAIConfigureHealthCheckInput(QString json);
    ~OAIConfigureHealthCheckInput() override;
    ...
    OAIConfigureHealthCheckInput_HealthCheck getHealthCheck() const;
    void setHealthCheck(const OAIConfigureHealthCheckInput_HealthCheck &health_check);
...
private:
    ...
    OAIConfigureHealthCheckInput_HealthCheck m_health_check;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConfigureHealthCheckInput)

#endif // OAIConfigureHealthCheckInput_H
