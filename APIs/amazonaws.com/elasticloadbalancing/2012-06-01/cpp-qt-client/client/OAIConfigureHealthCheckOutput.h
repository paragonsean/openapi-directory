...
/*
 * OAIConfigureHealthCheckOutput.h
 *
 * Contains the output of ConfigureHealthCheck.
 */

#ifndef OAIConfigureHealthCheckOutput_H
#define OAIConfigureHealthCheckOutput_H
...
namespace OpenAPI {
class OAIConfigureHealthCheckOutput_HealthCheck;

class OAIConfigureHealthCheckOutput : public OAIObject {
public:
    OAIConfigureHealthCheckOutput();
    OAIConfigureHealthCheckOutput(QString json);
    ~OAIConfigureHealthCheckOutput() override;
    ...
    OAIConfigureHealthCheckOutput_HealthCheck getHealthCheck() const;
    void setHealthCheck(const OAIConfigureHealthCheckOutput_HealthCheck &health_check);
...
private:
    ...
    OAIConfigureHealthCheckOutput_HealthCheck m_health_check;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConfigureHealthCheckOutput)

#endif // OAIConfigureHealthCheckOutput_H
