...
/*
 * OAIRegisterEndPointsInput.h
 *
 * Contains the parameters for RegisterInstancesWithLoadBalancer.
 */

#ifndef OAIRegisterEndPointsInput_H
#define OAIRegisterEndPointsInput_H
...
class OAIRegisterEndPointsInput : public OAIObject {
public:
    OAIRegisterEndPointsInput();
    OAIRegisterEndPointsInput(QString json);
    ~OAIRegisterEndPointsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegisterEndPointsInput)

#endif // OAIRegisterEndPointsInput_H
