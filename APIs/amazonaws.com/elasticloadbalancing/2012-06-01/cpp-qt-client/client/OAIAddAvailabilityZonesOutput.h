...
/*
 * OAIAddAvailabilityZonesOutput.h
 *
 * Contains the output of EnableAvailabilityZonesForLoadBalancer.
 */

#ifndef OAIAddAvailabilityZonesOutput_H
#define OAIAddAvailabilityZonesOutput_H
...
class OAIAddAvailabilityZonesOutput : public OAIObject {
public:
    OAIAddAvailabilityZonesOutput();
    OAIAddAvailabilityZonesOutput(QString json);
    ~OAIAddAvailabilityZonesOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddAvailabilityZonesOutput)

#endif // OAIAddAvailabilityZonesOutput_H
