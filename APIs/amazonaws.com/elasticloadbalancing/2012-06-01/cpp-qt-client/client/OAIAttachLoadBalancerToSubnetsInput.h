...
/*
 * OAIAttachLoadBalancerToSubnetsInput.h
 *
 * Contains the parameters for AttachLoaBalancerToSubnets.
 */

#ifndef OAIAttachLoadBalancerToSubnetsInput_H
#define OAIAttachLoadBalancerToSubnetsInput_H
...
class OAIAttachLoadBalancerToSubnetsInput : public OAIObject {
public:
    OAIAttachLoadBalancerToSubnetsInput();
    OAIAttachLoadBalancerToSubnetsInput(QString json);
    ~OAIAttachLoadBalancerToSubnetsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttachLoadBalancerToSubnetsInput)

#endif // OAIAttachLoadBalancerToSubnetsInput_H
