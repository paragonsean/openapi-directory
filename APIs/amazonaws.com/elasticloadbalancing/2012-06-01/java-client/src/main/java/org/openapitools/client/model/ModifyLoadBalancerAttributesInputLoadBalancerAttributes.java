...
public class ModifyLoadBalancerAttributesInputLoadBalancerAttributes {
  ...
  public ModifyLoadBalancerAttributesInputLoadBalancerAttributes() {
  }

  public ModifyLoadBalancerAttributesInputLoadBalancerAttributes crossZoneLoadBalancing(GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterCrossZoneLoadBalancing crossZoneLoadBalancing) {
  ...
  public ModifyLoadBalancerAttributesInputLoadBalancerAttributes accessLog(GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterAccessLog accessLog) {
  ...
  public ModifyLoadBalancerAttributesInputLoadBalancerAttributes connectionDraining(GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterConnectionDraining connectionDraining) {
  ...
  public ModifyLoadBalancerAttributesInputLoadBalancerAttributes connectionSettings(GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterConnectionSettings connectionSettings) {
  ...
  public ModifyLoadBalancerAttributesInputLoadBalancerAttributes additionalAttributes(List additionalAttributes) {
  ...
  public boolean equals(Object o) {
    ...
    ModifyLoadBalancerAttributesInputLoadBalancerAttributes modifyLoadBalancerAttributesInputLoadBalancerAttributes = (ModifyLoadBalancerAttributesInputLoadBalancerAttributes) o;
    return Objects.equals(this.crossZoneLoadBalancing, modifyLoadBalancerAttributesInputLoadBalancerAttributes.crossZoneLoadBalancing) &&
        Objects.equals(this.accessLog, modifyLoadBalancerAttributesInputLoadBalancerAttributes.accessLog) &&
        Objects.equals(this.connectionDraining, modifyLoadBalancerAttributesInputLoadBalancerAttributes.connectionDraining) &&
        Objects.equals(this.connectionSettings, modifyLoadBalancerAttributesInputLoadBalancerAttributes.connectionSettings) &&
        Objects.equals(this.additionalAttributes, modifyLoadBalancerAttributesInputLoadBalancerAttributes.additionalAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModifyLoadBalancerAttributesInputLoadBalancerAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ModifyLoadBalancerAttributesInputLoadBalancerAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModifyLoadBalancerAttributesInputLoadBalancerAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModifyLoadBalancerAttributesInputLoadBalancerAttributes is not found in the empty JSON string", ModifyLoadBalancerAttributesInputLoadBalancerAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModifyLoadBalancerAttributesInputLoadBalancerAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModifyLoadBalancerAttributesInputLoadBalancerAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModifyLoadBalancerAttributesInputLoadBalancerAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModifyLoadBalancerAttributesInputLoadBalancerAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModifyLoadBalancerAttributesInputLoadBalancerAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModifyLoadBalancerAttributesInputLoadBalancerAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<ModifyLoadBalancerAttributesInputLoadBalancerAttributes>() {
           @Override
           public void write(JsonWriter out, ModifyLoadBalancerAttributesInputLoadBalancerAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModifyLoadBalancerAttributesInputLoadBalancerAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ModifyLoadBalancerAttributesInputLoadBalancerAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ModifyLoadBalancerAttributesInputLoadBalancerAttributes
   * @throws IOException if the JSON string is invalid with respect to ModifyLoadBalancerAttributesInputLoadBalancerAttributes
   */
  public static ModifyLoadBalancerAttributesInputLoadBalancerAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModifyLoadBalancerAttributesInputLoadBalancerAttributes.class);
  }

  /**
   * Convert an instance of ModifyLoadBalancerAttributesInputLoadBalancerAttributes to an JSON string
   *
   * @return JSON string
   */
