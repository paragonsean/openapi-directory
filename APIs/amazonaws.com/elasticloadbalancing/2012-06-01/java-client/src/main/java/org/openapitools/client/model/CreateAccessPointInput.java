...
public class CreateAccessPointInput {
  ...
  public CreateAccessPointInput loadBalancerName(String loadBalancerName) {
  ...
  public CreateAccessPointInput listeners(List listeners) {
  ...
  public CreateAccessPointInput availabilityZones(List availabilityZones) {
  ...
  public CreateAccessPointInput subnets(List subnets) {
  ...
  public CreateAccessPointInput securityGroups(List securityGroups) {
  ...
  public CreateAccessPointInput scheme(String scheme) {
    this.scheme = scheme;
    return this;
  }
  ...
  public CreateAccessPointInput tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateAccessPointInput createAccessPointInput = (CreateAccessPointInput) o;
    return Objects.equals(this.loadBalancerName, createAccessPointInput.loadBalancerName) &&
        Objects.equals(this.listeners, createAccessPointInput.listeners) &&
        Objects.equals(this.availabilityZones, createAccessPointInput.availabilityZones) &&
        Objects.equals(this.subnets, createAccessPointInput.subnets) &&
        Objects.equals(this.securityGroups, createAccessPointInput.securityGroups) &&
        Objects.equals(this.scheme, createAccessPointInput.scheme) &&
        Objects.equals(this.tags, createAccessPointInput.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(loadBalancerName, listeners, availabilityZones, subnets, securityGroups, scheme, tags);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateAccessPointInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateAccessPointInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAccessPointInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateAccessPointInput is not found in the empty JSON string", CreateAccessPointInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateAccessPointInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateAccessPointInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateAccessPointInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAccessPointInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAccessPointInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAccessPointInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAccessPointInput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAccessPointInput>() {
           @Override
           public void write(JsonWriter out, CreateAccessPointInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateAccessPointInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateAccessPointInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateAccessPointInput
   * @throws IOException if the JSON string is invalid with respect to CreateAccessPointInput
   */
  public static CreateAccessPointInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAccessPointInput.class);
  }

  /**
   * Convert an instance of CreateAccessPointInput to an JSON string
   *
   * @return JSON string
   */
