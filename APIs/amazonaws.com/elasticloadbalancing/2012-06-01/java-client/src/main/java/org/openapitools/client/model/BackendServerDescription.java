...
public class BackendServerDescription {
  ...
  public BackendServerDescription instancePort(Integer instancePort) {
  ...
  public BackendServerDescription policyNames(List policyNames) {
  ...
  public boolean equals(Object o) {
    ...
    BackendServerDescription backendServerDescription = (BackendServerDescription) o;
    return Objects.equals(this.instancePort, backendServerDescription.instancePort) &&
        Objects.equals(this.policyNames, backendServerDescription.policyNames);
  }
  ...
  public String toString() {
    ...
    sb.append("class BackendServerDescription {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BackendServerDescription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BackendServerDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BackendServerDescription is not found in the empty JSON string", BackendServerDescription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BackendServerDescription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BackendServerDescription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BackendServerDescription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BackendServerDescription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BackendServerDescription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BackendServerDescription.class));

       return (TypeAdapter<T>) new TypeAdapter<BackendServerDescription>() {
           @Override
           public void write(JsonWriter out, BackendServerDescription value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BackendServerDescription read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BackendServerDescription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BackendServerDescription
   * @throws IOException if the JSON string is invalid with respect to BackendServerDescription
   */
  public static BackendServerDescription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BackendServerDescription.class);
  }

  /**
   * Convert an instance of BackendServerDescription to an JSON string
   *
   * @return JSON string
   */
