...
public class DescribeLoadBalancerAttributesOutputLoadBalancerAttributes {
  ...
  public DescribeLoadBalancerAttributesOutputLoadBalancerAttributes() {
  }

  public DescribeLoadBalancerAttributesOutputLoadBalancerAttributes crossZoneLoadBalancing(GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterCrossZoneLoadBalancing crossZoneLoadBalancing) {
  ...
  public DescribeLoadBalancerAttributesOutputLoadBalancerAttributes accessLog(GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterAccessLog accessLog) {
  ...
  public DescribeLoadBalancerAttributesOutputLoadBalancerAttributes connectionDraining(GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterConnectionDraining connectionDraining) {
  ...
  public DescribeLoadBalancerAttributesOutputLoadBalancerAttributes connectionSettings(GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterConnectionSettings connectionSettings) {
  ...
  public DescribeLoadBalancerAttributesOutputLoadBalancerAttributes additionalAttributes(List additionalAttributes) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeLoadBalancerAttributesOutputLoadBalancerAttributes describeLoadBalancerAttributesOutputLoadBalancerAttributes = (DescribeLoadBalancerAttributesOutputLoadBalancerAttributes) o;
    return Objects.equals(this.crossZoneLoadBalancing, describeLoadBalancerAttributesOutputLoadBalancerAttributes.crossZoneLoadBalancing) &&
        Objects.equals(this.accessLog, describeLoadBalancerAttributesOutputLoadBalancerAttributes.accessLog) &&
        Objects.equals(this.connectionDraining, describeLoadBalancerAttributesOutputLoadBalancerAttributes.connectionDraining) &&
        Objects.equals(this.connectionSettings, describeLoadBalancerAttributesOutputLoadBalancerAttributes.connectionSettings) &&
        Objects.equals(this.additionalAttributes, describeLoadBalancerAttributesOutputLoadBalancerAttributes.additionalAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeLoadBalancerAttributesOutputLoadBalancerAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeLoadBalancerAttributesOutputLoadBalancerAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeLoadBalancerAttributesOutputLoadBalancerAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeLoadBalancerAttributesOutputLoadBalancerAttributes is not found in the empty JSON string", DescribeLoadBalancerAttributesOutputLoadBalancerAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeLoadBalancerAttributesOutputLoadBalancerAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeLoadBalancerAttributesOutputLoadBalancerAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeLoadBalancerAttributesOutputLoadBalancerAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeLoadBalancerAttributesOutputLoadBalancerAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeLoadBalancerAttributesOutputLoadBalancerAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeLoadBalancerAttributesOutputLoadBalancerAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeLoadBalancerAttributesOutputLoadBalancerAttributes>() {
           @Override
           public void write(JsonWriter out, DescribeLoadBalancerAttributesOutputLoadBalancerAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeLoadBalancerAttributesOutputLoadBalancerAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeLoadBalancerAttributesOutputLoadBalancerAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeLoadBalancerAttributesOutputLoadBalancerAttributes
   * @throws IOException if the JSON string is invalid with respect to DescribeLoadBalancerAttributesOutputLoadBalancerAttributes
   */
  public static DescribeLoadBalancerAttributesOutputLoadBalancerAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeLoadBalancerAttributesOutputLoadBalancerAttributes.class);
  }

  /**
   * Convert an instance of DescribeLoadBalancerAttributesOutputLoadBalancerAttributes to an JSON string
   *
   * @return JSON string
   */
