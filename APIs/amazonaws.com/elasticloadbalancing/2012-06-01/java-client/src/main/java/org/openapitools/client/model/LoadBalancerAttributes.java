...
public class LoadBalancerAttributes {
  ...
  public LoadBalancerAttributes crossZoneLoadBalancing(GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterCrossZoneLoadBalancing crossZoneLoadBalancing) {
  ...
  public LoadBalancerAttributes accessLog(GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterAccessLog accessLog) {
  ...
  public LoadBalancerAttributes connectionDraining(GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterConnectionDraining connectionDraining) {
  ...
  public LoadBalancerAttributes connectionSettings(GETModifyLoadBalancerAttributesLoadBalancerAttributesParameterConnectionSettings connectionSettings) {
  ...
  public LoadBalancerAttributes additionalAttributes(List additionalAttributes) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancerAttributes loadBalancerAttributes = (LoadBalancerAttributes) o;
    return Objects.equals(this.crossZoneLoadBalancing, loadBalancerAttributes.crossZoneLoadBalancing) &&
        Objects.equals(this.accessLog, loadBalancerAttributes.accessLog) &&
        Objects.equals(this.connectionDraining, loadBalancerAttributes.connectionDraining) &&
        Objects.equals(this.connectionSettings, loadBalancerAttributes.connectionSettings) &&
        Objects.equals(this.additionalAttributes, loadBalancerAttributes.additionalAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancerAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LoadBalancerAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoadBalancerAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerAttributes is not found in the empty JSON string", LoadBalancerAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoadBalancerAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoadBalancerAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerAttributes>() {
           @Override
           public void write(JsonWriter out, LoadBalancerAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LoadBalancerAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LoadBalancerAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LoadBalancerAttributes
   * @throws IOException if the JSON string is invalid with respect to LoadBalancerAttributes
   */
  public static LoadBalancerAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerAttributes.class);
  }

  /**
   * Convert an instance of LoadBalancerAttributes to an JSON string
   *
   * @return JSON string
   */
