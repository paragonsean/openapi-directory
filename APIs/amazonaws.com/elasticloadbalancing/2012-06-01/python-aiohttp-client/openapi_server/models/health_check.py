...
class HealthCheck(Model):
    ...
    def __init__(self, target: str=None, interval: int=None, timeout: int=None, unhealthy_threshold: int=None, healthy_threshold: int=None):
        ...
        :param target: The target of this HealthCheck.
    ...
    @property
    def target(self):
        """Gets the target of this HealthCheck.


        :return: The target of this HealthCheck.
        :rtype: str
        """
        return self._target
    ...
    def target(self, target):
        """Sets the target of this HealthCheck.
