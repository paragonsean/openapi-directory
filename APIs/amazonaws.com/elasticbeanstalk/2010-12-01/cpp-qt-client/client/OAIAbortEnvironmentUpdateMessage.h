...
/*
 * OAIAbortEnvironmentUpdateMessage.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIAbortEnvironmentUpdateMessage_H
#define OAIAbortEnvironmentUpdateMessage_H
...
class OAIAbortEnvironmentUpdateMessage : public OAIObject {
public:
    OAIAbortEnvironmentUpdateMessage();
    OAIAbortEnvironmentUpdateMessage(QString json);
    ~OAIAbortEnvironmentUpdateMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAbortEnvironmentUpdateMessage)

#endif // OAIAbortEnvironmentUpdateMessage_H
