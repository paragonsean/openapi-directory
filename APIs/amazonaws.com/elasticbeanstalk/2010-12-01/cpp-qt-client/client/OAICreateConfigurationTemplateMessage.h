...
/*
 * OAICreateConfigurationTemplateMessage.h
 *
 * Request to create a configuration template.
 */

#ifndef OAICreateConfigurationTemplateMessage_H
#define OAICreateConfigurationTemplateMessage_H

#include <QJsonObject>

#include "OAICreateConfigurationTemplateMessage_SourceConfiguration.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAICreateConfigurationTemplateMessage_SourceConfiguration;

class OAICreateConfigurationTemplateMessage : public OAIObject {
public:
    OAICreateConfigurationTemplateMessage();
    OAICreateConfigurationTemplateMessage(QString json);
    ~OAICreateConfigurationTemplateMessage() override;
    ...
    OAICreateConfigurationTemplateMessage_SourceConfiguration getSourceConfiguration() const;
    void setSourceConfiguration(const OAICreateConfigurationTemplateMessage_SourceConfiguration &source_configuration);
...
private:
    ...
    OAICreateConfigurationTemplateMessage_SourceConfiguration m_source_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateConfigurationTemplateMessage)

#endif // OAICreateConfigurationTemplateMessage_H
