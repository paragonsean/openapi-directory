...
/*
 * OAICreateApplicationVersionMessage_SourceBuildInformation.h
 *
 * 
 */

#ifndef OAICreateApplicationVersionMessage_SourceBuildInformation_H
#define OAICreateApplicationVersionMessage_SourceBuildInformation_H
...
class OAICreateApplicationVersionMessage_SourceBuildInformation : public OAIObject {
public:
    OAICreateApplicationVersionMessage_SourceBuildInformation();
    OAICreateApplicationVersionMessage_SourceBuildInformation(QString json);
    ~OAICreateApplicationVersionMessage_SourceBuildInformation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateApplicationVersionMessage_SourceBuildInformation)

#endif // OAICreateApplicationVersionMessage_SourceBuildInformation_H
