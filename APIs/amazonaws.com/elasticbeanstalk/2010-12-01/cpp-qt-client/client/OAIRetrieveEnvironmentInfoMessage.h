...
/*
 * OAIRetrieveEnvironmentInfoMessage.h
 *
 * Request to download logs retrieved with &lt;a&gt;RequestEnvironmentInfo&lt;/a&gt;.
 */

#ifndef OAIRetrieveEnvironmentInfoMessage_H
#define OAIRetrieveEnvironmentInfoMessage_H
...
class OAIRetrieveEnvironmentInfoMessage : public OAIObject {
public:
    OAIRetrieveEnvironmentInfoMessage();
    OAIRetrieveEnvironmentInfoMessage(QString json);
    ~OAIRetrieveEnvironmentInfoMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRetrieveEnvironmentInfoMessage)

#endif // OAIRetrieveEnvironmentInfoMessage_H
