...
/*
 * OAIRestartAppServerMessage.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIRestartAppServerMessage_H
#define OAIRestartAppServerMessage_H
...
class OAIRestartAppServerMessage : public OAIObject {
public:
    OAIRestartAppServerMessage();
    OAIRestartAppServerMessage(QString json);
    ~OAIRestartAppServerMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRestartAppServerMessage)

#endif // OAIRestartAppServerMessage_H
