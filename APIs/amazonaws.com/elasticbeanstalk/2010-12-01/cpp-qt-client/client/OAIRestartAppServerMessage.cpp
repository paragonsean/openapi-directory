...
OAIRestartAppServerMessage::OAIRestartAppServerMessage(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRestartAppServerMessage::OAIRestartAppServerMessage() {
    this->initializeModel();
}

OAIRestartAppServerMessage::~OAIRestartAppServerMessage() {}

void OAIRestartAppServerMessage::initializeModel() {
...
void OAIRestartAppServerMessage::fromJson(QString jsonString) {
...
void OAIRestartAppServerMessage::fromJsonObject(QJsonObject json) {
...
QString OAIRestartAppServerMessage::asJson() const {
...
QJsonObject OAIRestartAppServerMessage::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRestartAppServerMessage::getEnvironmentId() const {
    return m_environment_id;
}
void OAIRestartAppServerMessage::setEnvironmentId(const QString &environment_id) {
    m_environment_id = environment_id;
    m_environment_id_isSet = true;
}

bool OAIRestartAppServerMessage::is_environment_id_Set() const{
    return m_environment_id_isSet;
}

bool OAIRestartAppServerMessage::is_environment_id_Valid() const{
    return m_environment_id_isValid;
}

QString OAIRestartAppServerMessage::getEnvironmentName() const {
    return m_environment_name;
}
void OAIRestartAppServerMessage::setEnvironmentName(const QString &environment_name) {
    m_environment_name = environment_name;
    m_environment_name_isSet = true;
}

bool OAIRestartAppServerMessage::is_environment_name_Set() const{
    return m_environment_name_isSet;
}

bool OAIRestartAppServerMessage::is_environment_name_Valid() const{
    return m_environment_name_isValid;
}

bool OAIRestartAppServerMessage::isSet() const {
...
bool OAIRestartAppServerMessage::isValid() const {
