...
/*
 * OAIEnvironmentResourceDescription.h
 *
 * Describes the AWS resources in use by this environment. This data is live.
 */

#ifndef OAIEnvironmentResourceDescription_H
#define OAIEnvironmentResourceDescription_H
...
class OAIEnvironmentResourceDescription : public OAIObject {
public:
    OAIEnvironmentResourceDescription();
    OAIEnvironmentResourceDescription(QString json);
    ~OAIEnvironmentResourceDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnvironmentResourceDescription)

#endif // OAIEnvironmentResourceDescription_H
