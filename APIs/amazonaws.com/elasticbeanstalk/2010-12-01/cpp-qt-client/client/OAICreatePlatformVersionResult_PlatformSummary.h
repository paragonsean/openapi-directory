...
/*
 * OAICreatePlatformVersionResult_PlatformSummary.h
 *
 * 
 */

#ifndef OAICreatePlatformVersionResult_PlatformSummary_H
#define OAICreatePlatformVersionResult_PlatformSummary_H
...
class OAICreatePlatformVersionResult_PlatformSummary : public OAIObject {
public:
    OAICreatePlatformVersionResult_PlatformSummary();
    OAICreatePlatformVersionResult_PlatformSummary(QString json);
    ~OAICreatePlatformVersionResult_PlatformSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePlatformVersionResult_PlatformSummary)

#endif // OAICreatePlatformVersionResult_PlatformSummary_H
