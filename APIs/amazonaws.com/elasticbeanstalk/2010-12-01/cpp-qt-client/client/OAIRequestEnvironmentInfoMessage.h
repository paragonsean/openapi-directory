...
/*
 * OAIRequestEnvironmentInfoMessage.h
 *
 * Request to retrieve logs from an environment and store them in your Elastic Beanstalk storage bucket.
 */

#ifndef OAIRequestEnvironmentInfoMessage_H
#define OAIRequestEnvironmentInfoMessage_H
...
class OAIRequestEnvironmentInfoMessage : public OAIObject {
public:
    OAIRequestEnvironmentInfoMessage();
    OAIRequestEnvironmentInfoMessage(QString json);
    ~OAIRequestEnvironmentInfoMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRequestEnvironmentInfoMessage)

#endif // OAIRequestEnvironmentInfoMessage_H
