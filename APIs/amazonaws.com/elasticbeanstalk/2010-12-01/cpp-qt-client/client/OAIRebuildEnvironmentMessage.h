...
/*
 * OAIRebuildEnvironmentMessage.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIRebuildEnvironmentMessage_H
#define OAIRebuildEnvironmentMessage_H
...
class OAIRebuildEnvironmentMessage : public OAIObject {
public:
    OAIRebuildEnvironmentMessage();
    OAIRebuildEnvironmentMessage(QString json);
    ~OAIRebuildEnvironmentMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRebuildEnvironmentMessage)

#endif // OAIRebuildEnvironmentMessage_H
