...
#include "OAIEnvironmentResourceDescription.h"
...
OAIEnvironmentResourceDescription::OAIEnvironmentResourceDescription(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEnvironmentResourceDescription::OAIEnvironmentResourceDescription() {
    this->initializeModel();
}

OAIEnvironmentResourceDescription::~OAIEnvironmentResourceDescription() {}

void OAIEnvironmentResourceDescription::initializeModel() {
...
void OAIEnvironmentResourceDescription::fromJson(QString jsonString) {
...
void OAIEnvironmentResourceDescription::fromJsonObject(QJsonObject json) {
...
QString OAIEnvironmentResourceDescription::asJson() const {
...
QJsonObject OAIEnvironmentResourceDescription::asJsonObject() const {
    QJsonObject obj;
...
QString OAIEnvironmentResourceDescription::getEnvironmentName() const {
    return m_environment_name;
}
void OAIEnvironmentResourceDescription::setEnvironmentName(const QString &environment_name) {
    m_environment_name = environment_name;
    m_environment_name_isSet = true;
}

bool OAIEnvironmentResourceDescription::is_environment_name_Set() const{
    return m_environment_name_isSet;
}

bool OAIEnvironmentResourceDescription::is_environment_name_Valid() const{
    return m_environment_name_isValid;
}

QList OAIEnvironmentResourceDescription::getAutoScalingGroups() const {
    return m_auto_scaling_groups;
}
void OAIEnvironmentResourceDescription::setAutoScalingGroups(const QList &auto_scaling_groups) {
    m_auto_scaling_groups = auto_scaling_groups;
    m_auto_scaling_groups_isSet = true;
}

bool OAIEnvironmentResourceDescription::is_auto_scaling_groups_Set() const{
    return m_auto_scaling_groups_isSet;
}

bool OAIEnvironmentResourceDescription::is_auto_scaling_groups_Valid() const{
    return m_auto_scaling_groups_isValid;
}

QList OAIEnvironmentResourceDescription::getInstances() const {
    return m_instances;
}
void OAIEnvironmentResourceDescription::setInstances(const QList &instances) {
    m_instances = instances;
    m_instances_isSet = true;
}

bool OAIEnvironmentResourceDescription::is_instances_Set() const{
    return m_instances_isSet;
}

bool OAIEnvironmentResourceDescription::is_instances_Valid() const{
    return m_instances_isValid;
}

QList OAIEnvironmentResourceDescription::getLaunchConfigurations() const {
    return m_launch_configurations;
}
void OAIEnvironmentResourceDescription::setLaunchConfigurations(const QList &launch_configurations) {
    m_launch_configurations = launch_configurations;
    m_launch_configurations_isSet = true;
}

bool OAIEnvironmentResourceDescription::is_launch_configurations_Set() const{
    return m_launch_configurations_isSet;
}

bool OAIEnvironmentResourceDescription::is_launch_configurations_Valid() const{
    return m_launch_configurations_isValid;
}

QList OAIEnvironmentResourceDescription::getLaunchTemplates() const {
    return m_launch_templates;
}
void OAIEnvironmentResourceDescription::setLaunchTemplates(const QList &launch_templates) {
    m_launch_templates = launch_templates;
    m_launch_templates_isSet = true;
}

bool OAIEnvironmentResourceDescription::is_launch_templates_Set() const{
    return m_launch_templates_isSet;
}

bool OAIEnvironmentResourceDescription::is_launch_templates_Valid() const{
    return m_launch_templates_isValid;
}

QList OAIEnvironmentResourceDescription::getLoadBalancers() const {
    return m_load_balancers;
}
void OAIEnvironmentResourceDescription::setLoadBalancers(const QList &load_balancers) {
    m_load_balancers = load_balancers;
    m_load_balancers_isSet = true;
}

bool OAIEnvironmentResourceDescription::is_load_balancers_Set() const{
    return m_load_balancers_isSet;
}

bool OAIEnvironmentResourceDescription::is_load_balancers_Valid() const{
    return m_load_balancers_isValid;
}

QList OAIEnvironmentResourceDescription::getTriggers() const {
    return m_triggers;
}
void OAIEnvironmentResourceDescription::setTriggers(const QList &triggers) {
    m_triggers = triggers;
    m_triggers_isSet = true;
}

bool OAIEnvironmentResourceDescription::is_triggers_Set() const{
    return m_triggers_isSet;
}

bool OAIEnvironmentResourceDescription::is_triggers_Valid() const{
    return m_triggers_isValid;
}

QList OAIEnvironmentResourceDescription::getQueues() const {
    return m_queues;
}
void OAIEnvironmentResourceDescription::setQueues(const QList &queues) {
    m_queues = queues;
    m_queues_isSet = true;
}

bool OAIEnvironmentResourceDescription::is_queues_Set() const{
    return m_queues_isSet;
}

bool OAIEnvironmentResourceDescription::is_queues_Valid() const{
    return m_queues_isValid;
}

bool OAIEnvironmentResourceDescription::isSet() const {
...
bool OAIEnvironmentResourceDescription::isValid() const {
