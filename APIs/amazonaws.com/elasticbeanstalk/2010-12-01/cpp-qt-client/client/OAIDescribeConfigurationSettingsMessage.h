...
/*
 * OAIDescribeConfigurationSettingsMessage.h
 *
 * Result message containing all of the configuration settings for a specified solution stack or configuration template.
 */

#ifndef OAIDescribeConfigurationSettingsMessage_H
#define OAIDescribeConfigurationSettingsMessage_H
...
class OAIDescribeConfigurationSettingsMessage : public OAIObject {
public:
    OAIDescribeConfigurationSettingsMessage();
    OAIDescribeConfigurationSettingsMessage(QString json);
    ~OAIDescribeConfigurationSettingsMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeConfigurationSettingsMessage)

#endif // OAIDescribeConfigurationSettingsMessage_H
