...
/*
 * OAIDescribeEnvironmentHealthRequest.h
 *
 * See the example below to learn how to create a request body.
 */

#ifndef OAIDescribeEnvironmentHealthRequest_H
#define OAIDescribeEnvironmentHealthRequest_H
...
class OAIDescribeEnvironmentHealthRequest : public OAIObject {
public:
    OAIDescribeEnvironmentHealthRequest();
    OAIDescribeEnvironmentHealthRequest(QString json);
    ~OAIDescribeEnvironmentHealthRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEnvironmentHealthRequest)

#endif // OAIDescribeEnvironmentHealthRequest_H
