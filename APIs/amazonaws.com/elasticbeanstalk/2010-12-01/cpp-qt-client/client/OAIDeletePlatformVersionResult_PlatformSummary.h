...
/*
 * OAIDeletePlatformVersionResult_PlatformSummary.h
 *
 * 
 */

#ifndef OAIDeletePlatformVersionResult_PlatformSummary_H
#define OAIDeletePlatformVersionResult_PlatformSummary_H
...
class OAIDeletePlatformVersionResult_PlatformSummary : public OAIObject {
public:
    OAIDeletePlatformVersionResult_PlatformSummary();
    OAIDeletePlatformVersionResult_PlatformSummary(QString json);
    ~OAIDeletePlatformVersionResult_PlatformSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeletePlatformVersionResult_PlatformSummary)

#endif // OAIDeletePlatformVersionResult_PlatformSummary_H
