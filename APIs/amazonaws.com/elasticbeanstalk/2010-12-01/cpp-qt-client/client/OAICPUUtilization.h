...
#ifndef OAICPUUtilization_H
#define OAICPUUtilization_H
...
class OAICPUUtilization : public OAIObject {
public:
    OAICPUUtilization();
    OAICPUUtilization(QString json);
    ~OAICPUUtilization() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICPUUtilization)

#endif // OAICPUUtilization_H
