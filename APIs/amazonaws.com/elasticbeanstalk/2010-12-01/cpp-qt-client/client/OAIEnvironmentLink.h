...
#ifndef OAIEnvironmentLink_H
#define OAIEnvironmentLink_H
...
class OAIEnvironmentLink : public OAIObject {
public:
    OAIEnvironmentLink();
    OAIEnvironmentLink(QString json);
    ~OAIEnvironmentLink() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnvironmentLink)

#endif // OAIEnvironmentLink_H
