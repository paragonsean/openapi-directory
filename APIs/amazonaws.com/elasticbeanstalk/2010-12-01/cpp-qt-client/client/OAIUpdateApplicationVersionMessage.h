...
/*
 * OAIUpdateApplicationVersionMessage.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIUpdateApplicationVersionMessage_H
#define OAIUpdateApplicationVersionMessage_H
...
class OAIUpdateApplicationVersionMessage : public OAIObject {
public:
    OAIUpdateApplicationVersionMessage();
    OAIUpdateApplicationVersionMessage(QString json);
    ~OAIUpdateApplicationVersionMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateApplicationVersionMessage)

#endif // OAIUpdateApplicationVersionMessage_H
