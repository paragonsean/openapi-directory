...
#ifndef OAIPlatformFilter_H
#define OAIPlatformFilter_H
...
class OAIPlatformFilter : public OAIObject {
public:
    OAIPlatformFilter();
    OAIPlatformFilter(QString json);
    ~OAIPlatformFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlatformFilter)

#endif // OAIPlatformFilter_H
