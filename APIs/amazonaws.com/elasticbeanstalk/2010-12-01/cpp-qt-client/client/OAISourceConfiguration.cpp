...
QString OAISourceConfiguration::getApplicationName() const {
    return m_application_name;
}
void OAISourceConfiguration::setApplicationName(const QString &application_name) {
    m_application_name = application_name;
    m_application_name_isSet = true;
}

bool OAISourceConfiguration::is_application_name_Set() const{
    return m_application_name_isSet;
}

bool OAISourceConfiguration::is_application_name_Valid() const{
    return m_application_name_isValid;
}

QString OAISourceConfiguration::getTemplateName() const {
    return m_template_name;
}
void OAISourceConfiguration::setTemplateName(const QString &template_name) {
    m_template_name = template_name;
    m_template_name_isSet = true;
}

bool OAISourceConfiguration::is_template_name_Set() const{
    return m_template_name_isSet;
}

bool OAISourceConfiguration::is_template_name_Valid() const{
