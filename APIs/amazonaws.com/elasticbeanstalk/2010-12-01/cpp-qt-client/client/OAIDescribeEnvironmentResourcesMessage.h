...
/*
 * OAIDescribeEnvironmentResourcesMessage.h
 *
 * Request to describe the resources in an environment.
 */

#ifndef OAIDescribeEnvironmentResourcesMessage_H
#define OAIDescribeEnvironmentResourcesMessage_H
...
class OAIDescribeEnvironmentResourcesMessage : public OAIObject {
public:
    OAIDescribeEnvironmentResourcesMessage();
    OAIDescribeEnvironmentResourcesMessage(QString json);
    ~OAIDescribeEnvironmentResourcesMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEnvironmentResourcesMessage)

#endif // OAIDescribeEnvironmentResourcesMessage_H
