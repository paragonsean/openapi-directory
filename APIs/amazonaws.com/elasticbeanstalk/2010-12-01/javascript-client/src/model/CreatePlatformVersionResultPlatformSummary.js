...
/**
 * The CreatePlatformVersionResultPlatformSummary model module.
 * @module model/CreatePlatformVersionResultPlatformSummary
 * @version 2010-12-01
 */
class CreatePlatformVersionResultPlatformSummary {
    /**
     * Constructs a new <code>CreatePlatformVersionResultPlatformSummary</code>.
     * @alias module:model/CreatePlatformVersionResultPlatformSummary
     * @implements module:model/PlatformSummary
     */
    constructor() { 
        PlatformSummary.initialize(this);
        CreatePlatformVersionResultPlatformSummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreatePlatformVersionResultPlatformSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePlatformVersionResultPlatformSummary} obj Optional instance to populate.
     * @return {module:model/CreatePlatformVersionResultPlatformSummary} The populated <code>CreatePlatformVersionResultPlatformSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePlatformVersionResultPlatformSummary();
            PlatformSummary.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePlatformVersionResultPlatformSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePlatformVersionResultPlatformSummary</code>.
     */
 ...
 */
CreatePlatformVersionResultPlatformSummary.prototype['PlatformArn'] = undefined;

/**
 * @member {String} PlatformOwner
 */
CreatePlatformVersionResultPlatformSummary.prototype['PlatformOwner'] = undefined;

/**
 * @member {module:model/PlatformStatus} PlatformStatus
 */
CreatePlatformVersionResultPlatformSummary.prototype['PlatformStatus'] = undefined;

/**
 * @member {String} PlatformCategory
 */
CreatePlatformVersionResultPlatformSummary.prototype['PlatformCategory'] = undefined;

/**
 * @member {String} OperatingSystemName
 */
CreatePlatformVersionResultPlatformSummary.prototype['OperatingSystemName'] = undefined;

/**
 * @member {String} OperatingSystemVersion
 */
CreatePlatformVersionResultPlatformSummary.prototype['OperatingSystemVersion'] = undefined;

/**
 * @member {Array} SupportedTierList
 */
CreatePlatformVersionResultPlatformSummary.prototype['SupportedTierList'] = undefined;

/**
 * @member {Array} SupportedAddonList
 */
CreatePlatformVersionResultPlatformSummary.prototype['SupportedAddonList'] = undefined;

/**
 * @member {String} PlatformLifecycleState
 */
CreatePlatformVersionResultPlatformSummary.prototype['PlatformLifecycleState'] = undefined;

/**
 * @member {String} PlatformVersion
 */
CreatePlatformVersionResultPlatformSummary.prototype['PlatformVersion'] = undefined;

/**
 * @member {String} PlatformBranchName
 */
CreatePlatformVersionResultPlatformSummary.prototype['PlatformBranchName'] = undefined;

/**
 * @member {String} PlatformBranchLifecycleState
 */
CreatePlatformVersionResultPlatformSummary.prototype['PlatformBranchLifecycleState'] = undefined;


// Implement PlatformSummary interface:
/**
 * @member {String} PlatformArn
 */
...
export default CreatePlatformVersionResultPlatformSummary;
