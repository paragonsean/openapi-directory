...
/**
 * The CPUUtilization model module.
 * @module model/CPUUtilization
 * @version 2010-12-01
 */
class CPUUtilization {
    /**
     * Constructs a new <code>CPUUtilization</code>.
     * CPU utilization metrics for an instance.
     * @alias module:model/CPUUtilization
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>CPUUtilization</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CPUUtilization} obj Optional instance to populate.
     * @return {module:model/CPUUtilization} The populated <code>CPUUtilization</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CPUUtilization();
    ...
    /**
     * Validates the JSON data with respect to <code>CPUUtilization</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CPUUtilization</code>.
     */
