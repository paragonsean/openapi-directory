...
/**
 * The DeletePlatformVersionResultPlatformSummary model module.
 * @module model/DeletePlatformVersionResultPlatformSummary
 * @version 2010-12-01
 */
class DeletePlatformVersionResultPlatformSummary {
    /**
     * Constructs a new <code>DeletePlatformVersionResultPlatformSummary</code>.
     * @alias module:model/DeletePlatformVersionResultPlatformSummary
     * @implements module:model/PlatformSummary
     */
    constructor() { 
        PlatformSummary.initialize(this);
        DeletePlatformVersionResultPlatformSummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeletePlatformVersionResultPlatformSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeletePlatformVersionResultPlatformSummary} obj Optional instance to populate.
     * @return {module:model/DeletePlatformVersionResultPlatformSummary} The populated <code>DeletePlatformVersionResultPlatformSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeletePlatformVersionResultPlatformSummary();
    ...
    /**
     * Validates the JSON data with respect to <code>DeletePlatformVersionResultPlatformSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeletePlatformVersionResultPlatformSummary</code>.
     */
 ...
 */
DeletePlatformVersionResultPlatformSummary.prototype['PlatformArn'] = undefined;

/**
 * @member {String} PlatformOwner
 */
DeletePlatformVersionResultPlatformSummary.prototype['PlatformOwner'] = undefined;

/**
 * @member {module:model/PlatformStatus} PlatformStatus
 */
DeletePlatformVersionResultPlatformSummary.prototype['PlatformStatus'] = undefined;

/**
 * @member {String} PlatformCategory
 */
DeletePlatformVersionResultPlatformSummary.prototype['PlatformCategory'] = undefined;

/**
 * @member {String} OperatingSystemName
 */
DeletePlatformVersionResultPlatformSummary.prototype['OperatingSystemName'] = undefined;

/**
 * @member {String} OperatingSystemVersion
 */
DeletePlatformVersionResultPlatformSummary.prototype['OperatingSystemVersion'] = undefined;

/**
 * @member {Array} SupportedTierList
 */
DeletePlatformVersionResultPlatformSummary.prototype['SupportedTierList'] = undefined;

/**
 * @member {Array} SupportedAddonList
 */
DeletePlatformVersionResultPlatformSummary.prototype['SupportedAddonList'] = undefined;

/**
 * @member {String} PlatformLifecycleState
 */
DeletePlatformVersionResultPlatformSummary.prototype['PlatformLifecycleState'] = undefined;

/**
 * @member {String} PlatformVersion
 */
DeletePlatformVersionResultPlatformSummary.prototype['PlatformVersion'] = undefined;

/**
 * @member {String} PlatformBranchName
 */
DeletePlatformVersionResultPlatformSummary.prototype['PlatformBranchName'] = undefined;

/**
 * @member {String} PlatformBranchLifecycleState
 */
DeletePlatformVersionResultPlatformSummary.prototype['PlatformBranchLifecycleState'] = undefined;
...
export default DeletePlatformVersionResultPlatformSummary;
