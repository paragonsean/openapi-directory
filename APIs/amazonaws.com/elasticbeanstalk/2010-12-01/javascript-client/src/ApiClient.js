...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://elasticbeanstalk.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://elasticbeanstalk.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2010-12-01/Javascript'
        };
