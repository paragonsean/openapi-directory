...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElasticBeanstalk.DescribeInstancesHealthRequest();
  });
  ...
  describe('DescribeInstancesHealthRequest', function() {
    it('should create an instance of DescribeInstancesHealthRequest', function() {
      // uncomment below and update the code to test DescribeInstancesHealthRequest
      //var instance = new AwsElasticBeanstalk.DescribeInstancesHealthRequest();
      //expect(instance).to.be.a(AwsElasticBeanstalk.DescribeInstancesHealthRequest);
    });
