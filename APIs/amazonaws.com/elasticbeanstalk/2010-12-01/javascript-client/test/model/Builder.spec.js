...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElasticBeanstalk.Builder();
  });
  ...
  describe('Builder', function() {
    it('should create an instance of Builder', function() {
      // uncomment below and update the code to test Builder
      //var instance = new AwsElasticBeanstalk.Builder();
      //expect(instance).to.be.a(AwsElasticBeanstalk.Builder);
    });
