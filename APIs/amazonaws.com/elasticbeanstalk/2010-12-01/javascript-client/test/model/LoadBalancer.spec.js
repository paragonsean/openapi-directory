...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElasticBeanstalk.LoadBalancer();
  });
  ...
  describe('LoadBalancer', function() {
    it('should create an instance of LoadBalancer', function() {
      ...
      //var instance = new AwsElasticBeanstalk.LoadBalancer();
      //expect(instance).to.be.a(AwsElasticBeanstalk.LoadBalancer);
    });
