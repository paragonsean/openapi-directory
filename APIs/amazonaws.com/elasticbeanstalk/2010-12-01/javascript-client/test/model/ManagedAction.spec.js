...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElasticBeanstalk.ManagedAction();
  });
  ...
  describe('ManagedAction', function() {
    it('should create an instance of ManagedAction', function() {
      // uncomment below and update the code to test ManagedAction
      //var instance = new AwsElasticBeanstalk.ManagedAction();
      //expect(instance).to.be.a(AwsElasticBeanstalk.ManagedAction);
    });
