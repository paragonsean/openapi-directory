...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElasticBeanstalk.ConfigurationOptionDescription();
  });
  ...
  describe('ConfigurationOptionDescription', function() {
    it('should create an instance of ConfigurationOptionDescription', function() {
      // uncomment below and update the code to test ConfigurationOptionDescription
      //var instance = new AwsElasticBeanstalk.ConfigurationOptionDescription();
      //expect(instance).to.be.a(AwsElasticBeanstalk.ConfigurationOptionDescription);
    });
    ...
    it('should have the property changeSeverity (base name: "ChangeSeverity")', function() {
      // uncomment below and update the code to test the property changeSeverity
      //var instance = new AwsElasticBeanstalk.ConfigurationOptionDescription();
      //expect(instance).to.be();
    });
    ...
    it('should have the property valueOptions (base name: "ValueOptions")', function() {
      // uncomment below and update the code to test the property valueOptions
      //var instance = new AwsElasticBeanstalk.ConfigurationOptionDescription();
      //expect(instance).to.be();
    });
