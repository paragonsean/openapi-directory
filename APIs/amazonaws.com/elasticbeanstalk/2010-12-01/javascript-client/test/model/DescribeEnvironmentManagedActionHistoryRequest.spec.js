...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElasticBeanstalk.DescribeEnvironmentManagedActionHistoryRequest();
  });
  ...
  describe('DescribeEnvironmentManagedActionHistoryRequest', function() {
    it('should create an instance of DescribeEnvironmentManagedActionHistoryRequest', function() {
      // uncomment below and update the code to test DescribeEnvironmentManagedActionHistoryRequest
      //var instance = new AwsElasticBeanstalk.DescribeEnvironmentManagedActionHistoryRequest();
      //expect(instance).to.be.a(AwsElasticBeanstalk.DescribeEnvironmentManagedActionHistoryRequest);
    });
