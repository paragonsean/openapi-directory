...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElasticBeanstalk.ConfigurationOptionSetting();
  });
  ...
  describe('ConfigurationOptionSetting', function() {
    it('should create an instance of ConfigurationOptionSetting', function() {
      // uncomment below and update the code to test ConfigurationOptionSetting
      //var instance = new AwsElasticBeanstalk.ConfigurationOptionSetting();
      //expect(instance).to.be.a(AwsElasticBeanstalk.ConfigurationOptionSetting);
    });
