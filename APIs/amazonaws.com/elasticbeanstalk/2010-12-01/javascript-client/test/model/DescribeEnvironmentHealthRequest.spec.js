...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElasticBeanstalk.DescribeEnvironmentHealthRequest();
  });
  ...
  describe('DescribeEnvironmentHealthRequest', function() {
    it('should create an instance of DescribeEnvironmentHealthRequest', function() {
      // uncomment below and update the code to test DescribeEnvironmentHealthRequest
      //var instance = new AwsElasticBeanstalk.DescribeEnvironmentHealthRequest();
      //expect(instance).to.be.a(AwsElasticBeanstalk.DescribeEnvironmentHealthRequest);
    });
