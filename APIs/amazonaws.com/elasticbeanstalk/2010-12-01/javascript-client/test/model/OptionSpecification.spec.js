...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElasticBeanstalk.OptionSpecification();
  });
  ...
  describe('OptionSpecification', function() {
    it('should create an instance of OptionSpecification', function() {
      // uncomment below and update the code to test OptionSpecification
      //var instance = new AwsElasticBeanstalk.OptionSpecification();
      //expect(instance).to.be.a(AwsElasticBeanstalk.OptionSpecification);
    });
