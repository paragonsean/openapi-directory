...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElasticBeanstalk.ApplyEnvironmentManagedActionResult();
  });
  ...
  describe('ApplyEnvironmentManagedActionResult', function() {
    it('should create an instance of ApplyEnvironmentManagedActionResult', function() {
      // uncomment below and update the code to test ApplyEnvironmentManagedActionResult
      //var instance = new AwsElasticBeanstalk.ApplyEnvironmentManagedActionResult();
      //expect(instance).to.be.a(AwsElasticBeanstalk.ApplyEnvironmentManagedActionResult);
    });
