...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElasticBeanstalk.DescribeConfigurationSettingsMessage();
  });
  ...
  describe('DescribeConfigurationSettingsMessage', function() {
    it('should create an instance of DescribeConfigurationSettingsMessage', function() {
      // uncomment below and update the code to test DescribeConfigurationSettingsMessage
      //var instance = new AwsElasticBeanstalk.DescribeConfigurationSettingsMessage();
      //expect(instance).to.be.a(AwsElasticBeanstalk.DescribeConfigurationSettingsMessage);
    });
