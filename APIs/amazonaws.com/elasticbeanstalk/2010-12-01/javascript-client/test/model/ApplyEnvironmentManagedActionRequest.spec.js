...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElasticBeanstalk.ApplyEnvironmentManagedActionRequest();
  });
  ...
  describe('ApplyEnvironmentManagedActionRequest', function() {
    it('should create an instance of ApplyEnvironmentManagedActionRequest', function() {
      // uncomment below and update the code to test ApplyEnvironmentManagedActionRequest
      //var instance = new AwsElasticBeanstalk.ApplyEnvironmentManagedActionRequest();
      //expect(instance).to.be.a(AwsElasticBeanstalk.ApplyEnvironmentManagedActionRequest);
    });
