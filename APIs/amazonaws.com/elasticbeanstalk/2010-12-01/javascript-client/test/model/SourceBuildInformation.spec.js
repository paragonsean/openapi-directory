...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElasticBeanstalk.SourceBuildInformation();
  });
  ...
  describe('SourceBuildInformation', function() {
    it('should create an instance of SourceBuildInformation', function() {
      // uncomment below and update the code to test SourceBuildInformation
      //var instance = new AwsElasticBeanstalk.SourceBuildInformation();
      //expect(instance).to.be.a(AwsElasticBeanstalk.SourceBuildInformation);
    });
