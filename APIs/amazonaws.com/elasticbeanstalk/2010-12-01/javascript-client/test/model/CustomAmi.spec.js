...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElasticBeanstalk.CustomAmi();
  });
  ...
  describe('CustomAmi', function() {
    it('should create an instance of CustomAmi', function() {
      // uncomment below and update the code to test CustomAmi
      //var instance = new AwsElasticBeanstalk.CustomAmi();
      //expect(instance).to.be.a(AwsElasticBeanstalk.CustomAmi);
    });
