...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElasticBeanstalk.RestartAppServerMessage();
  });
  ...
  describe('RestartAppServerMessage', function() {
    it('should create an instance of RestartAppServerMessage', function() {
      // uncomment below and update the code to test RestartAppServerMessage
      //var instance = new AwsElasticBeanstalk.RestartAppServerMessage();
      //expect(instance).to.be.a(AwsElasticBeanstalk.RestartAppServerMessage);
    });
