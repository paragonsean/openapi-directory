...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElasticBeanstalk.SearchFilter();
  });
  ...
  describe('SearchFilter', function() {
    it('should create an instance of SearchFilter', function() {
      ...
      //var instance = new AwsElasticBeanstalk.SearchFilter();
      //expect(instance).to.be.a(AwsElasticBeanstalk.SearchFilter);
    });
