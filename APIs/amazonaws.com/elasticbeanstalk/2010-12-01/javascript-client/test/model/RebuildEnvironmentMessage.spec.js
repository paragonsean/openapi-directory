...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElasticBeanstalk.RebuildEnvironmentMessage();
  });
  ...
  describe('RebuildEnvironmentMessage', function() {
    it('should create an instance of RebuildEnvironmentMessage', function() {
      // uncomment below and update the code to test RebuildEnvironmentMessage
      //var instance = new AwsElasticBeanstalk.RebuildEnvironmentMessage();
      //expect(instance).to.be.a(AwsElasticBeanstalk.RebuildEnvironmentMessage);
    });
