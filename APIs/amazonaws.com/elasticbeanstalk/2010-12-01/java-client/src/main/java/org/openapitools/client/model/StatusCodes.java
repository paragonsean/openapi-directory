...
public class StatusCodes {
  ...
  public StatusCodes status2xx(Integer status2xx) {
  ...
  public StatusCodes status3xx(Integer status3xx) {
  ...
  public StatusCodes status4xx(Integer status4xx) {
  ...
  public StatusCodes status5xx(Integer status5xx) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status2xx, statusCodes.status2xx) &&
        Objects.equals(this.status3xx, statusCodes.status3xx) &&
        Objects.equals(this.status4xx, statusCodes.status4xx) &&
        Objects.equals(this.status5xx, statusCodes.status5xx);
  }
