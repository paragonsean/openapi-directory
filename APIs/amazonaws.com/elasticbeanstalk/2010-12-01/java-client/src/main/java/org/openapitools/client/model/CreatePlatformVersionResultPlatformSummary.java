...
public class CreatePlatformVersionResultPlatformSummary {
  ...
  public CreatePlatformVersionResultPlatformSummary() {
  }

  public CreatePlatformVersionResultPlatformSummary platformArn(String platformArn) {
  ...
  public CreatePlatformVersionResultPlatformSummary platformOwner(String platformOwner) {
  ...
  public CreatePlatformVersionResultPlatformSummary platformStatus(PlatformStatus platformStatus) {
  ...
  public CreatePlatformVersionResultPlatformSummary platformCategory(String platformCategory) {
  ...
  public CreatePlatformVersionResultPlatformSummary operatingSystemName(String operatingSystemName) {
  ...
  public CreatePlatformVersionResultPlatformSummary operatingSystemVersion(String operatingSystemVersion) {
  ...
  public CreatePlatformVersionResultPlatformSummary supportedTierList(List supportedTierList) {
  ...
  public CreatePlatformVersionResultPlatformSummary supportedAddonList(List supportedAddonList) {
  ...
  public CreatePlatformVersionResultPlatformSummary platformLifecycleState(String platformLifecycleState) {
  ...
  public CreatePlatformVersionResultPlatformSummary platformVersion(String platformVersion) {
  ...
  public CreatePlatformVersionResultPlatformSummary platformBranchName(String platformBranchName) {
  ...
  public CreatePlatformVersionResultPlatformSummary platformBranchLifecycleState(String platformBranchLifecycleState) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePlatformVersionResultPlatformSummary createPlatformVersionResultPlatformSummary = (CreatePlatformVersionResultPlatformSummary) o;
    return Objects.equals(this.platformArn, createPlatformVersionResultPlatformSummary.platformArn) &&
        Objects.equals(this.platformOwner, createPlatformVersionResultPlatformSummary.platformOwner) &&
        Objects.equals(this.platformStatus, createPlatformVersionResultPlatformSummary.platformStatus) &&
        Objects.equals(this.platformCategory, createPlatformVersionResultPlatformSummary.platformCategory) &&
        Objects.equals(this.operatingSystemName, createPlatformVersionResultPlatformSummary.operatingSystemName) &&
        Objects.equals(this.operatingSystemVersion, createPlatformVersionResultPlatformSummary.operatingSystemVersion) &&
        Objects.equals(this.supportedTierList, createPlatformVersionResultPlatformSummary.supportedTierList) &&
        Objects.equals(this.supportedAddonList, createPlatformVersionResultPlatformSummary.supportedAddonList) &&
        Objects.equals(this.platformLifecycleState, createPlatformVersionResultPlatformSummary.platformLifecycleState) &&
        Objects.equals(this.platformVersion, createPlatformVersionResultPlatformSummary.platformVersion) &&
        Objects.equals(this.platformBranchName, createPlatformVersionResultPlatformSummary.platformBranchName) &&
        Objects.equals(this.platformBranchLifecycleState, createPlatformVersionResultPlatformSummary.platformBranchLifecycleState);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreatePlatformVersionResultPlatformSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePlatformVersionResultPlatformSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePlatformVersionResultPlatformSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePlatformVersionResultPlatformSummary is not found in the empty JSON string", CreatePlatformVersionResultPlatformSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePlatformVersionResultPlatformSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePlatformVersionResultPlatformSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePlatformVersionResultPlatformSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePlatformVersionResultPlatformSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePlatformVersionResultPlatformSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePlatformVersionResultPlatformSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePlatformVersionResultPlatformSummary>() {
           @Override
           public void write(JsonWriter out, CreatePlatformVersionResultPlatformSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePlatformVersionResultPlatformSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePlatformVersionResultPlatformSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePlatformVersionResultPlatformSummary
   * @throws IOException if the JSON string is invalid with respect to CreatePlatformVersionResultPlatformSummary
   */
  public static CreatePlatformVersionResultPlatformSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePlatformVersionResultPlatformSummary.class);
  }

  /**
   * Convert an instance of CreatePlatformVersionResultPlatformSummary to an JSON string
   *
   * @return JSON string
   */
