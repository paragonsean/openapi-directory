...
public class DescribePlatformVersionResultPlatformDescription {
  ...
  public DescribePlatformVersionResultPlatformDescription() {
  }

  public DescribePlatformVersionResultPlatformDescription platformArn(String platformArn) {
  ...
  public DescribePlatformVersionResultPlatformDescription platformOwner(String platformOwner) {
  ...
  public DescribePlatformVersionResultPlatformDescription platformName(String platformName) {
  ...
  public DescribePlatformVersionResultPlatformDescription platformVersion(String platformVersion) {
  ...
  public DescribePlatformVersionResultPlatformDescription solutionStackName(String solutionStackName) {
  ...
  public DescribePlatformVersionResultPlatformDescription platformStatus(PlatformStatus platformStatus) {
  ...
  public DescribePlatformVersionResultPlatformDescription dateCreated(OffsetDateTime dateCreated) {
  ...
  public DescribePlatformVersionResultPlatformDescription dateUpdated(OffsetDateTime dateUpdated) {
  ...
  public DescribePlatformVersionResultPlatformDescription platformCategory(String platformCategory) {
  ...
  public DescribePlatformVersionResultPlatformDescription description(String description) {
  ...
  public DescribePlatformVersionResultPlatformDescription maintainer(String maintainer) {
  ...
  public DescribePlatformVersionResultPlatformDescription operatingSystemName(String operatingSystemName) {
  ...
  public DescribePlatformVersionResultPlatformDescription operatingSystemVersion(String operatingSystemVersion) {
  ...
  public DescribePlatformVersionResultPlatformDescription programmingLanguages(List programmingLanguages) {
  ...
  public DescribePlatformVersionResultPlatformDescription frameworks(List frameworks) {
  ...
  public DescribePlatformVersionResultPlatformDescription customAmiList(List customAmiList) {
  ...
  public DescribePlatformVersionResultPlatformDescription supportedTierList(List supportedTierList) {
  ...
  public DescribePlatformVersionResultPlatformDescription supportedAddonList(List supportedAddonList) {
  ...
  public DescribePlatformVersionResultPlatformDescription platformLifecycleState(String platformLifecycleState) {
  ...
  public DescribePlatformVersionResultPlatformDescription platformBranchName(String platformBranchName) {
  ...
  public DescribePlatformVersionResultPlatformDescription platformBranchLifecycleState(String platformBranchLifecycleState) {
  ...
  public boolean equals(Object o) {
    ...
    DescribePlatformVersionResultPlatformDescription describePlatformVersionResultPlatformDescription = (DescribePlatformVersionResultPlatformDescription) o;
    return Objects.equals(this.platformArn, describePlatformVersionResultPlatformDescription.platformArn) &&
        Objects.equals(this.platformOwner, describePlatformVersionResultPlatformDescription.platformOwner) &&
        Objects.equals(this.platformName, describePlatformVersionResultPlatformDescription.platformName) &&
        Objects.equals(this.platformVersion, describePlatformVersionResultPlatformDescription.platformVersion) &&
        Objects.equals(this.solutionStackName, describePlatformVersionResultPlatformDescription.solutionStackName) &&
        Objects.equals(this.platformStatus, describePlatformVersionResultPlatformDescription.platformStatus) &&
        Objects.equals(this.dateCreated, describePlatformVersionResultPlatformDescription.dateCreated) &&
        Objects.equals(this.dateUpdated, describePlatformVersionResultPlatformDescription.dateUpdated) &&
        Objects.equals(this.platformCategory, describePlatformVersionResultPlatformDescription.platformCategory) &&
        Objects.equals(this.description, describePlatformVersionResultPlatformDescription.description) &&
        Objects.equals(this.maintainer, describePlatformVersionResultPlatformDescription.maintainer) &&
        Objects.equals(this.operatingSystemName, describePlatformVersionResultPlatformDescription.operatingSystemName) &&
        Objects.equals(this.operatingSystemVersion, describePlatformVersionResultPlatformDescription.operatingSystemVersion) &&
        Objects.equals(this.programmingLanguages, describePlatformVersionResultPlatformDescription.programmingLanguages) &&
        Objects.equals(this.frameworks, describePlatformVersionResultPlatformDescription.frameworks) &&
        Objects.equals(this.customAmiList, describePlatformVersionResultPlatformDescription.customAmiList) &&
        Objects.equals(this.supportedTierList, describePlatformVersionResultPlatformDescription.supportedTierList) &&
        Objects.equals(this.supportedAddonList, describePlatformVersionResultPlatformDescription.supportedAddonList) &&
        Objects.equals(this.platformLifecycleState, describePlatformVersionResultPlatformDescription.platformLifecycleState) &&
        Objects.equals(this.platformBranchName, describePlatformVersionResultPlatformDescription.platformBranchName) &&
        Objects.equals(this.platformBranchLifecycleState, describePlatformVersionResultPlatformDescription.platformBranchLifecycleState);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribePlatformVersionResultPlatformDescription {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribePlatformVersionResultPlatformDescription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribePlatformVersionResultPlatformDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribePlatformVersionResultPlatformDescription is not found in the empty JSON string", DescribePlatformVersionResultPlatformDescription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribePlatformVersionResultPlatformDescription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribePlatformVersionResultPlatformDescription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribePlatformVersionResultPlatformDescription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribePlatformVersionResultPlatformDescription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribePlatformVersionResultPlatformDescription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribePlatformVersionResultPlatformDescription.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribePlatformVersionResultPlatformDescription>() {
           @Override
           public void write(JsonWriter out, DescribePlatformVersionResultPlatformDescription value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribePlatformVersionResultPlatformDescription read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribePlatformVersionResultPlatformDescription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribePlatformVersionResultPlatformDescription
   * @throws IOException if the JSON string is invalid with respect to DescribePlatformVersionResultPlatformDescription
   */
  public static DescribePlatformVersionResultPlatformDescription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribePlatformVersionResultPlatformDescription.class);
  }

  /**
   * Convert an instance of DescribePlatformVersionResultPlatformDescription to an JSON string
   *
   * @return JSON string
   */
