...
class Example : public QObject {
    Q_OBJECT
    QString create();
    OAIGetEntitlementsRequest create();
    QString create();
    QString create();
    QString create();
    QString create();
...
QString Example::create(){
    QString obj;
OAIGetEntitlementsRequest Example::create(){
    OAIGetEntitlementsRequest obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::getEntitlementsSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::getEntitlementsSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAIGetEntitlementsRequest oai_get_entitlements_request = create(); // OAIGetEntitlementsRequest | 
      ...
      apiInstance.getEntitlements(x_amz_targetoai_get_entitlements_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
