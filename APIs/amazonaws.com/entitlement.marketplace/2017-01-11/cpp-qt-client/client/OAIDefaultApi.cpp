...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("http://entitlement.marketplace.{region}.amazonaws.com"),
    ...
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://entitlement.marketplace.{region}.amazonaws.com"),
    "The AWS Marketplace Entitlement Service multi-region endpoint",
    QMap<QString, OAIServerVariable>{ 
    {"region", OAIServerVariable("The AWS region","us-east-1",
    QSet<QString>{ {"us-east-1"},{"us-east-2"},{"us-west-1"},{"us-west-2"},{"us-gov-west-1"},{"us-gov-east-1"},{"ca-central-1"},{"eu-north-1"},{"eu-west-1"},{"eu-west-2"},{"eu-west-3"},{"eu-central-1"},{"eu-south-1"},{"af-south-1"},{"ap-northeast-1"},{"ap-northeast-2"},{"ap-northeast-3"},{"ap-southeast-1"},{"ap-southeast-2"},{"ap-east-1"},{"ap-south-1"},{"sa-east-1"},{"me-south-1"} })}, }));
    ...
    defaultConf.append(OAIServerConfiguration(
    QUrl("http://entitlement.marketplace.{region}.amazonaws.com.cn"),
    ...
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://entitlement.marketplace.{region}.amazonaws.com.cn"),
    "The AWS Marketplace Entitlement Service endpoint for China (Beijing) and China (Ningxia)",
    QMap<QString, OAIServerVariable>{ 
    {"region", OAIServerVariable("The AWS region","cn-north-1",
    QSet<QString>{ {"cn-north-1"},{"cn-northwest-1"} })}, }));
...
void OAIDefaultApi::getEntitlements(const QString &x_amz_target, const OAIGetEntitlementsRequest &oai_get_entitlements_request, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256, const ::OpenAPI::OptionalParam<QString> &x_amz_date, const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm, const ::OpenAPI::OptionalParam<QString> &x_amz_credential, const ::OpenAPI::OptionalParam<QString> &x_amz_security_token, const ::OpenAPI::OptionalParam<QString> &x_amz_signature, const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers) {
    QString fullPath = QString(_serverConfigs["getEntitlements"][_serverIndices.value("getEntitlements")].URL()+"/#X-Amz-Target=AWSMPEntitlementService.GetEntitlements");
...

    {
        ...
        QByteArray output = oai_get_entitlements_request.asJson().toUtf8();
...
void OAIDefaultApi::getEntitlementsCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGetEntitlementsResult output(QString(worker->response));
    worker->deleteLater();
