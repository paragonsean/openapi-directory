...
/*
 * OAIEntitlement_Value.h
 *
 * 
 */

#ifndef OAIEntitlement_Value_H
#define OAIEntitlement_Value_H
...
class OAIEntitlement_Value : public OAIObject {
public:
    OAIEntitlement_Value();
    OAIEntitlement_Value(QString json);
    ~OAIEntitlement_Value() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEntitlement_Value)

#endif // OAIEntitlement_Value_H
