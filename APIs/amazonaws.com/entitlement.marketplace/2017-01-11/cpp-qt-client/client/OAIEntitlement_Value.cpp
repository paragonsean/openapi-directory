...
OAIEntitlement_Value::OAIEntitlement_Value(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEntitlement_Value::OAIEntitlement_Value() {
    this->initializeModel();
}

OAIEntitlement_Value::~OAIEntitlement_Value() {}

void OAIEntitlement_Value::initializeModel() {
...
void OAIEntitlement_Value::fromJson(QString jsonString) {
...
void OAIEntitlement_Value::fromJsonObject(QJsonObject json) {
...
QString OAIEntitlement_Value::asJson() const {
...
QJsonObject OAIEntitlement_Value::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIEntitlement_Value::getIntegerValue() const {
    return m_integer_value;
}
void OAIEntitlement_Value::setIntegerValue(const qint32 &integer_value) {
    m_integer_value = integer_value;
    m_integer_value_isSet = true;
}

bool OAIEntitlement_Value::is_integer_value_Set() const{
    return m_integer_value_isSet;
}

bool OAIEntitlement_Value::is_integer_value_Valid() const{
    return m_integer_value_isValid;
}

double OAIEntitlement_Value::getDoubleValue() const {
    return m_double_value;
}
void OAIEntitlement_Value::setDoubleValue(const double &double_value) {
    m_double_value = double_value;
    m_double_value_isSet = true;
}

bool OAIEntitlement_Value::is_double_value_Set() const{
    return m_double_value_isSet;
}

bool OAIEntitlement_Value::is_double_value_Valid() const{
    return m_double_value_isValid;
}

bool OAIEntitlement_Value::getBooleanValue() const {
    return m_boolean_value;
}
void OAIEntitlement_Value::setBooleanValue(const bool &boolean_value) {
    m_boolean_value = boolean_value;
    m_boolean_value_isSet = true;
}

bool OAIEntitlement_Value::is_boolean_value_Set() const{
    return m_boolean_value_isSet;
}

bool OAIEntitlement_Value::is_boolean_value_Valid() const{
    return m_boolean_value_isValid;
}

QString OAIEntitlement_Value::getStringValue() const {
    return m_string_value;
}
void OAIEntitlement_Value::setStringValue(const QString &string_value) {
    m_string_value = string_value;
    m_string_value_isSet = true;
}

bool OAIEntitlement_Value::is_string_value_Set() const{
    return m_string_value_isSet;
}

bool OAIEntitlement_Value::is_string_value_Valid() const{
    return m_string_value_isValid;
}

bool OAIEntitlement_Value::isSet() const {
...
bool OAIEntitlement_Value::isValid() const {
