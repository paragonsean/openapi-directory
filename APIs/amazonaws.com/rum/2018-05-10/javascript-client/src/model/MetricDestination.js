...
* @readonly
*/
export default class MetricDestination {
    ...
    /**
    * Returns a <code>MetricDestination</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/MetricDestination} The enum <code>MetricDestination</code> value.
    */
