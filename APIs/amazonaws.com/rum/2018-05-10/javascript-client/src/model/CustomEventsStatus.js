...
* @readonly
*/
export default class CustomEventsStatus {
    ...
    /**
    * Returns a <code>CustomEventsStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CustomEventsStatus} The enum <code>CustomEventsStatus</code> value.
    */
