# CloudWatchRum.BatchCreateRumMetricDefinitionsRequest
...
**metricDefinitions** | [**[MetricDefinitionRequest]**](MetricDefinitionRequest.md) | An array of structures which define the metrics that you want to send. | 
