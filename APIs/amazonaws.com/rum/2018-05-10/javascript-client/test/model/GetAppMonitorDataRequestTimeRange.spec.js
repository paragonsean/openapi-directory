...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchRum.GetAppMonitorDataRequestTimeRange();
  });
  ...
  describe('GetAppMonitorDataRequestTimeRange', function() {
    it('should create an instance of GetAppMonitorDataRequestTimeRange', function() {
      // uncomment below and update the code to test GetAppMonitorDataRequestTimeRange
      //var instance = new CloudWatchRum.GetAppMonitorDataRequestTimeRange();
      //expect(instance).to.be.a(CloudWatchRum.GetAppMonitorDataRequestTimeRange);
    });
