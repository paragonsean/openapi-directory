...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchRum.PutRumEventsRequest();
  });
  ...
  describe('PutRumEventsRequest', function() {
    it('should create an instance of PutRumEventsRequest', function() {
      // uncomment below and update the code to test PutRumEventsRequest
      //var instance = new CloudWatchRum.PutRumEventsRequest();
      //expect(instance).to.be.a(CloudWatchRum.PutRumEventsRequest);
    });

    it('should have the property appMonitorDetails (base name: "AppMonitorDetails")', function() {
      // uncomment below and update the code to test the property appMonitorDetails
      //var instance = new CloudWatchRum.PutRumEventsRequest();
    ...
    it('should have the property rumEvents (base name: "RumEvents")', function() {
      // uncomment below and update the code to test the property rumEvents
      //var instance = new CloudWatchRum.PutRumEventsRequest();
      //expect(instance).to.be();
    });
