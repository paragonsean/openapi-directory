...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchRum.PutRumMetricsDestinationRequest();
  });
  ...
  describe('PutRumMetricsDestinationRequest', function() {
    it('should create an instance of PutRumMetricsDestinationRequest', function() {
      // uncomment below and update the code to test PutRumMetricsDestinationRequest
      //var instance = new CloudWatchRum.PutRumMetricsDestinationRequest();
      //expect(instance).to.be.a(CloudWatchRum.PutRumMetricsDestinationRequest);
    });
