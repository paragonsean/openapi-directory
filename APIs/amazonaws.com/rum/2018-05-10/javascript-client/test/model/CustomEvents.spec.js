...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchRum.CustomEvents();
  });
  ...
  describe('CustomEvents', function() {
    it('should create an instance of CustomEvents', function() {
      // uncomment below and update the code to test CustomEvents
      //var instance = new CloudWatchRum.CustomEvents();
      //expect(instance).to.be.a(CloudWatchRum.CustomEvents);
    });
