...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchRum.AppMonitorCustomEvents();
  });
  ...
  describe('AppMonitorCustomEvents', function() {
    it('should create an instance of AppMonitorCustomEvents', function() {
      // uncomment below and update the code to test AppMonitorCustomEvents
      //var instance = new CloudWatchRum.AppMonitorCustomEvents();
      //expect(instance).to.be.a(CloudWatchRum.AppMonitorCustomEvents);
    });
