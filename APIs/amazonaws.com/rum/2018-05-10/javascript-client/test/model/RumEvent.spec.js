...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchRum.RumEvent();
  });
  ...
  describe('RumEvent', function() {
    it('should create an instance of RumEvent', function() {
      // uncomment below and update the code to test RumEvent
      //var instance = new CloudWatchRum.RumEvent();
      //expect(instance).to.be.a(CloudWatchRum.RumEvent);
    });
