...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchRum.GetAppMonitorDataRequest();
  });
  ...
  describe('GetAppMonitorDataRequest', function() {
    it('should create an instance of GetAppMonitorDataRequest', function() {
      // uncomment below and update the code to test GetAppMonitorDataRequest
      //var instance = new CloudWatchRum.GetAppMonitorDataRequest();
      //expect(instance).to.be.a(CloudWatchRum.GetAppMonitorDataRequest);
    });
