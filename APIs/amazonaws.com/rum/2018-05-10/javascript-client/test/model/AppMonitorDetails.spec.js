...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchRum.AppMonitorDetails();
  });
  ...
  describe('AppMonitorDetails', function() {
    it('should create an instance of AppMonitorDetails', function() {
      // uncomment below and update the code to test AppMonitorDetails
      //var instance = new CloudWatchRum.AppMonitorDetails();
      //expect(instance).to.be.a(CloudWatchRum.AppMonitorDetails);
    });
