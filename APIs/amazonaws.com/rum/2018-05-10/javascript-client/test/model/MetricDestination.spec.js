...
(function(root, factory) {
  ...
  describe('MetricDestination', function() {
    it('should create an instance of MetricDestination', function() {
      // uncomment below and update the code to test MetricDestination
      //var instance = new CloudWatchRum.MetricDestination();
      //expect(instance).to.be.a(CloudWatchRum.MetricDestination);
    });
