...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchRum.AppMonitorSummary();
  });
  ...
  describe('AppMonitorSummary', function() {
    it('should create an instance of AppMonitorSummary', function() {
      // uncomment below and update the code to test AppMonitorSummary
      //var instance = new CloudWatchRum.AppMonitorSummary();
      //expect(instance).to.be.a(CloudWatchRum.AppMonitorSummary);
    });
