...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchRum.ListAppMonitorsResponse();
  });
  ...
  describe('ListAppMonitorsResponse', function() {
    it('should create an instance of ListAppMonitorsResponse', function() {
      // uncomment below and update the code to test ListAppMonitorsResponse
      //var instance = new CloudWatchRum.ListAppMonitorsResponse();
      //expect(instance).to.be.a(CloudWatchRum.ListAppMonitorsResponse);
    });

    it('should have the property appMonitorSummaries (base name: "AppMonitorSummaries")', function() {
      // uncomment below and update the code to test the property appMonitorSummaries
      //var instance = new CloudWatchRum.ListAppMonitorsResponse();
