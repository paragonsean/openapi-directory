...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchRum.ListRumMetricsDestinationsResponse();
  });
  ...
  describe('ListRumMetricsDestinationsResponse', function() {
    it('should create an instance of ListRumMetricsDestinationsResponse', function() {
      // uncomment below and update the code to test ListRumMetricsDestinationsResponse
      //var instance = new CloudWatchRum.ListRumMetricsDestinationsResponse();
      //expect(instance).to.be.a(CloudWatchRum.ListRumMetricsDestinationsResponse);
    });
