...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchRum.DataStorage();
  });
  ...
  describe('DataStorage', function() {
    it('should create an instance of DataStorage', function() {
      // uncomment below and update the code to test DataStorage
      //var instance = new CloudWatchRum.DataStorage();
      //expect(instance).to.be.a(CloudWatchRum.DataStorage);
    });

    it('should have the property cwLog (base name: "CwLog")', function() {
      // uncomment below and update the code to test the property cwLog
      //var instance = new CloudWatchRum.DataStorage();
