...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchRum.CreateAppMonitorResponse();
  });
  ...
  describe('CreateAppMonitorResponse', function() {
    it('should create an instance of CreateAppMonitorResponse', function() {
      // uncomment below and update the code to test CreateAppMonitorResponse
      //var instance = new CloudWatchRum.CreateAppMonitorResponse();
      //expect(instance).to.be.a(CloudWatchRum.CreateAppMonitorResponse);
    });
