...
(function(root, factory) {
  ...
  describe('CustomEventsStatus', function() {
    it('should create an instance of CustomEventsStatus', function() {
      // uncomment below and update the code to test CustomEventsStatus
      //var instance = new CloudWatchRum.CustomEventsStatus();
      //expect(instance).to.be.a(CloudWatchRum.CustomEventsStatus);
    });
