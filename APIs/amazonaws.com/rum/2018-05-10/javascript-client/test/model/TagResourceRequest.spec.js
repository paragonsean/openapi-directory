...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchRum.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new CloudWatchRum.TagResourceRequest();
      //expect(instance).to.be.a(CloudWatchRum.TagResourceRequest);
    });
