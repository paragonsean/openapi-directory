...
public class ApiClient {
    ...
    private String basePath = "http://rum.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://rum.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "https://rum.{region}.amazonaws.com",
      "The CloudWatch RUM multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://rum.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://rum.{region}.amazonaws.com.cn",
      "The CloudWatch RUM endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://rum.us-east-1.amazonaws.com
