...
/*
 * OAIPutRumEvents_request_UserDetails.h
 *
 * A structure that contains information about the user session that this batch of events was collected from.
 */

#ifndef OAIPutRumEvents_request_UserDetails_H
#define OAIPutRumEvents_request_UserDetails_H
...
class OAIPutRumEvents_request_UserDetails : public OAIObject {
public:
    OAIPutRumEvents_request_UserDetails();
    OAIPutRumEvents_request_UserDetails(QString json);
    ~OAIPutRumEvents_request_UserDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutRumEvents_request_UserDetails)

#endif // OAIPutRumEvents_request_UserDetails_H
