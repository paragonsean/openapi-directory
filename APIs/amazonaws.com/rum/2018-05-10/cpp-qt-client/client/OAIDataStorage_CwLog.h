...
/*
 * OAIDataStorage_CwLog.h
 *
 * 
 */

#ifndef OAIDataStorage_CwLog_H
#define OAIDataStorage_CwLog_H
...
class OAIDataStorage_CwLog : public OAIObject {
public:
    OAIDataStorage_CwLog();
    OAIDataStorage_CwLog(QString json);
    ~OAIDataStorage_CwLog() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataStorage_CwLog)

#endif // OAIDataStorage_CwLog_H
