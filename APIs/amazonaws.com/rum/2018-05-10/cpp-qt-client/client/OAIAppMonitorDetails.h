...
/*
 * OAIAppMonitorDetails.h
 *
 * A structure that contains information about the RUM app monitor.
 */

#ifndef OAIAppMonitorDetails_H
#define OAIAppMonitorDetails_H
...
class OAIAppMonitorDetails : public OAIObject {
public:
    OAIAppMonitorDetails();
    OAIAppMonitorDetails(QString json);
    ~OAIAppMonitorDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppMonitorDetails)

#endif // OAIAppMonitorDetails_H
