...
/*
 * OAIBatchGetRumMetricDefinitionsResponse.h
 *
 * 
 */

#ifndef OAIBatchGetRumMetricDefinitionsResponse_H
#define OAIBatchGetRumMetricDefinitionsResponse_H
...
class OAIBatchGetRumMetricDefinitionsResponse : public OAIObject {
public:
    OAIBatchGetRumMetricDefinitionsResponse();
    OAIBatchGetRumMetricDefinitionsResponse(QString json);
    ~OAIBatchGetRumMetricDefinitionsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchGetRumMetricDefinitionsResponse)

#endif // OAIBatchGetRumMetricDefinitionsResponse_H
