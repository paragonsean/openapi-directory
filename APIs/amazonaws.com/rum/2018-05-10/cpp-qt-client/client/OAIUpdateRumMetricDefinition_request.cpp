...
OAIUpdateRumMetricDefinition_request::OAIUpdateRumMetricDefinition_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateRumMetricDefinition_request::OAIUpdateRumMetricDefinition_request() {
    this->initializeModel();
}

OAIUpdateRumMetricDefinition_request::~OAIUpdateRumMetricDefinition_request() {}

void OAIUpdateRumMetricDefinition_request::initializeModel() {
...
void OAIUpdateRumMetricDefinition_request::fromJson(QString jsonString) {
...
void OAIUpdateRumMetricDefinition_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateRumMetricDefinition_request::asJson() const {
...
QJsonObject OAIUpdateRumMetricDefinition_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateRumMetricDefinition_request::getDestination() const {
    return m_destination;
}
void OAIUpdateRumMetricDefinition_request::setDestination(const QString &destination) {
    m_destination = destination;
    m_destination_isSet = true;
}

bool OAIUpdateRumMetricDefinition_request::is_destination_Set() const{
    return m_destination_isSet;
}

bool OAIUpdateRumMetricDefinition_request::is_destination_Valid() const{
    return m_destination_isValid;
}

QString OAIUpdateRumMetricDefinition_request::getDestinationArn() const {
    return m_destination_arn;
}
void OAIUpdateRumMetricDefinition_request::setDestinationArn(const QString &destination_arn) {
    m_destination_arn = destination_arn;
    m_destination_arn_isSet = true;
}

bool OAIUpdateRumMetricDefinition_request::is_destination_arn_Set() const{
    return m_destination_arn_isSet;
}

bool OAIUpdateRumMetricDefinition_request::is_destination_arn_Valid() const{
    return m_destination_arn_isValid;
}

OAIUpdateRumMetricDefinition_request_MetricDefinition OAIUpdateRumMetricDefinition_request::getMetricDefinition() const {
    return m_metric_definition;
}
void OAIUpdateRumMetricDefinition_request::setMetricDefinition(const OAIUpdateRumMetricDefinition_request_MetricDefinition &metric_definition) {
    m_metric_definition = metric_definition;
    m_metric_definition_isSet = true;
}

bool OAIUpdateRumMetricDefinition_request::is_metric_definition_Set() const{
    return m_metric_definition_isSet;
}

bool OAIUpdateRumMetricDefinition_request::is_metric_definition_Valid() const{
    return m_metric_definition_isValid;
}

QString OAIUpdateRumMetricDefinition_request::getMetricDefinitionId() const {
    return m_metric_definition_id;
}
void OAIUpdateRumMetricDefinition_request::setMetricDefinitionId(const QString &metric_definition_id) {
    m_metric_definition_id = metric_definition_id;
    m_metric_definition_id_isSet = true;
}

bool OAIUpdateRumMetricDefinition_request::is_metric_definition_id_Set() const{
    return m_metric_definition_id_isSet;
}

bool OAIUpdateRumMetricDefinition_request::is_metric_definition_id_Valid() const{
    return m_metric_definition_id_isValid;
}

bool OAIUpdateRumMetricDefinition_request::isSet() const {
...
bool OAIUpdateRumMetricDefinition_request::isValid() const {
