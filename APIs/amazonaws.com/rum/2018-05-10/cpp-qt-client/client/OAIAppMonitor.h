...
#ifndef OAIAppMonitor_H
#define OAIAppMonitor_H
...
class OAIAppMonitor : public OAIObject {
public:
    OAIAppMonitor();
    OAIAppMonitor(QString json);
    ~OAIAppMonitor() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppMonitor)

#endif // OAIAppMonitor_H
