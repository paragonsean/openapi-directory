...
#include "OAIUpdateAppMonitorRequest.h"
...
OAIUpdateAppMonitorRequest::OAIUpdateAppMonitorRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateAppMonitorRequest::OAIUpdateAppMonitorRequest() {
    this->initializeModel();
}

OAIUpdateAppMonitorRequest::~OAIUpdateAppMonitorRequest() {}

void OAIUpdateAppMonitorRequest::initializeModel() {
...
void OAIUpdateAppMonitorRequest::fromJson(QString jsonString) {
...
void OAIUpdateAppMonitorRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateAppMonitorRequest::asJson() const {
...
QJsonObject OAIUpdateAppMonitorRequest::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdateAppMonitorRequest_AppMonitorConfiguration OAIUpdateAppMonitorRequest::getAppMonitorConfiguration() const {
    return m_app_monitor_configuration;
}
void OAIUpdateAppMonitorRequest::setAppMonitorConfiguration(const OAIUpdateAppMonitorRequest_AppMonitorConfiguration &app_monitor_configuration) {
    m_app_monitor_configuration = app_monitor_configuration;
    m_app_monitor_configuration_isSet = true;
}

bool OAIUpdateAppMonitorRequest::is_app_monitor_configuration_Set() const{
    return m_app_monitor_configuration_isSet;
}

bool OAIUpdateAppMonitorRequest::is_app_monitor_configuration_Valid() const{
    return m_app_monitor_configuration_isValid;
}

OAIUpdateAppMonitorRequest_CustomEvents OAIUpdateAppMonitorRequest::getCustomEvents() const {
    return m_custom_events;
}
void OAIUpdateAppMonitorRequest::setCustomEvents(const OAIUpdateAppMonitorRequest_CustomEvents &custom_events) {
    m_custom_events = custom_events;
    m_custom_events_isSet = true;
}

bool OAIUpdateAppMonitorRequest::is_custom_events_Set() const{
    return m_custom_events_isSet;
}

bool OAIUpdateAppMonitorRequest::is_custom_events_Valid() const{
    return m_custom_events_isValid;
}

bool OAIUpdateAppMonitorRequest::getCwLogEnabled() const {
    return m_cw_log_enabled;
}
void OAIUpdateAppMonitorRequest::setCwLogEnabled(const bool &cw_log_enabled) {
    m_cw_log_enabled = cw_log_enabled;
    m_cw_log_enabled_isSet = true;
}

bool OAIUpdateAppMonitorRequest::is_cw_log_enabled_Set() const{
    return m_cw_log_enabled_isSet;
}

bool OAIUpdateAppMonitorRequest::is_cw_log_enabled_Valid() const{
    return m_cw_log_enabled_isValid;
}

QString OAIUpdateAppMonitorRequest::getDomain() const {
    return m_domain;
}
void OAIUpdateAppMonitorRequest::setDomain(const QString &domain) {
    m_domain = domain;
    m_domain_isSet = true;
}

bool OAIUpdateAppMonitorRequest::is_domain_Set() const{
    return m_domain_isSet;
}

bool OAIUpdateAppMonitorRequest::is_domain_Valid() const{
    return m_domain_isValid;
}

bool OAIUpdateAppMonitorRequest::isSet() const {
...
bool OAIUpdateAppMonitorRequest::isValid() const {
