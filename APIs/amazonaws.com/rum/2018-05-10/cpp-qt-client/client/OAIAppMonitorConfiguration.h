...
/*
 * OAIAppMonitorConfiguration.h
 *
 * This structure contains much of the configuration data for the app monitor.
 */

#ifndef OAIAppMonitorConfiguration_H
#define OAIAppMonitorConfiguration_H
...
class OAIAppMonitorConfiguration : public OAIObject {
public:
    OAIAppMonitorConfiguration();
    OAIAppMonitorConfiguration(QString json);
    ~OAIAppMonitorConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppMonitorConfiguration)

#endif // OAIAppMonitorConfiguration_H
