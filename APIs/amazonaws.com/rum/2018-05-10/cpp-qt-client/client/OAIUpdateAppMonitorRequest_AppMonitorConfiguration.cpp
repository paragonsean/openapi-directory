...
#include "OAIUpdateAppMonitorRequest_AppMonitorConfiguration.h"
...
OAIUpdateAppMonitorRequest_AppMonitorConfiguration::OAIUpdateAppMonitorRequest_AppMonitorConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateAppMonitorRequest_AppMonitorConfiguration::OAIUpdateAppMonitorRequest_AppMonitorConfiguration() {
    this->initializeModel();
}

OAIUpdateAppMonitorRequest_AppMonitorConfiguration::~OAIUpdateAppMonitorRequest_AppMonitorConfiguration() {}

void OAIUpdateAppMonitorRequest_AppMonitorConfiguration::initializeModel() {
...
void OAIUpdateAppMonitorRequest_AppMonitorConfiguration::fromJson(QString jsonString) {
...
void OAIUpdateAppMonitorRequest_AppMonitorConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateAppMonitorRequest_AppMonitorConfiguration::asJson() const {
...
QJsonObject OAIUpdateAppMonitorRequest_AppMonitorConfiguration::asJsonObject() const {
    QJsonObject obj;
...
bool OAIUpdateAppMonitorRequest_AppMonitorConfiguration::getAllowCookies() const {
    return m_allow_cookies;
}
void OAIUpdateAppMonitorRequest_AppMonitorConfiguration::setAllowCookies(const bool &allow_cookies) {
    m_allow_cookies = allow_cookies;
    m_allow_cookies_isSet = true;
}

bool OAIUpdateAppMonitorRequest_AppMonitorConfiguration::is_allow_cookies_Set() const{
    return m_allow_cookies_isSet;
}

bool OAIUpdateAppMonitorRequest_AppMonitorConfiguration::is_allow_cookies_Valid() const{
    return m_allow_cookies_isValid;
}

bool OAIUpdateAppMonitorRequest_AppMonitorConfiguration::getEnableXRay() const {
    return m_enable_x_ray;
}
void OAIUpdateAppMonitorRequest_AppMonitorConfiguration::setEnableXRay(const bool &enable_x_ray) {
    m_enable_x_ray = enable_x_ray;
    m_enable_x_ray_isSet = true;
}

bool OAIUpdateAppMonitorRequest_AppMonitorConfiguration::is_enable_x_ray_Set() const{
    return m_enable_x_ray_isSet;
}

bool OAIUpdateAppMonitorRequest_AppMonitorConfiguration::is_enable_x_ray_Valid() const{
    return m_enable_x_ray_isValid;
}

QList OAIUpdateAppMonitorRequest_AppMonitorConfiguration::getExcludedPages() const {
    return m_excluded_pages;
}
void OAIUpdateAppMonitorRequest_AppMonitorConfiguration::setExcludedPages(const QList &excluded_pages) {
    m_excluded_pages = excluded_pages;
    m_excluded_pages_isSet = true;
}

bool OAIUpdateAppMonitorRequest_AppMonitorConfiguration::is_excluded_pages_Set() const{
    return m_excluded_pages_isSet;
}

bool OAIUpdateAppMonitorRequest_AppMonitorConfiguration::is_excluded_pages_Valid() const{
    return m_excluded_pages_isValid;
}

QList OAIUpdateAppMonitorRequest_AppMonitorConfiguration::getFavoritePages() const {
    return m_favorite_pages;
}
void OAIUpdateAppMonitorRequest_AppMonitorConfiguration::setFavoritePages(const QList &favorite_pages) {
    m_favorite_pages = favorite_pages;
    m_favorite_pages_isSet = true;
}

bool OAIUpdateAppMonitorRequest_AppMonitorConfiguration::is_favorite_pages_Set() const{
    return m_favorite_pages_isSet;
}

bool OAIUpdateAppMonitorRequest_AppMonitorConfiguration::is_favorite_pages_Valid() const{
    return m_favorite_pages_isValid;
}

QString OAIUpdateAppMonitorRequest_AppMonitorConfiguration::getGuestRoleArn() const {
    return m_guest_role_arn;
}
void OAIUpdateAppMonitorRequest_AppMonitorConfiguration::setGuestRoleArn(const QString &guest_role_arn) {
    m_guest_role_arn = guest_role_arn;
    m_guest_role_arn_isSet = true;
}

bool OAIUpdateAppMonitorRequest_AppMonitorConfiguration::is_guest_role_arn_Set() const{
    return m_guest_role_arn_isSet;
}

bool OAIUpdateAppMonitorRequest_AppMonitorConfiguration::is_guest_role_arn_Valid() const{
    return m_guest_role_arn_isValid;
}

QString OAIUpdateAppMonitorRequest_AppMonitorConfiguration::getIdentityPoolId() const {
    return m_identity_pool_id;
}
void OAIUpdateAppMonitorRequest_AppMonitorConfiguration::setIdentityPoolId(const QString &identity_pool_id) {
    m_identity_pool_id = identity_pool_id;
    m_identity_pool_id_isSet = true;
}

bool OAIUpdateAppMonitorRequest_AppMonitorConfiguration::is_identity_pool_id_Set() const{
    return m_identity_pool_id_isSet;
}

bool OAIUpdateAppMonitorRequest_AppMonitorConfiguration::is_identity_pool_id_Valid() const{
    return m_identity_pool_id_isValid;
}

QList OAIUpdateAppMonitorRequest_AppMonitorConfiguration::getIncludedPages() const {
    return m_included_pages;
}
void OAIUpdateAppMonitorRequest_AppMonitorConfiguration::setIncludedPages(const QList &included_pages) {
    m_included_pages = included_pages;
    m_included_pages_isSet = true;
}

bool OAIUpdateAppMonitorRequest_AppMonitorConfiguration::is_included_pages_Set() const{
    return m_included_pages_isSet;
}

bool OAIUpdateAppMonitorRequest_AppMonitorConfiguration::is_included_pages_Valid() const{
    return m_included_pages_isValid;
}

double OAIUpdateAppMonitorRequest_AppMonitorConfiguration::getSessionSampleRate() const {
    return m_session_sample_rate;
}
void OAIUpdateAppMonitorRequest_AppMonitorConfiguration::setSessionSampleRate(const double &session_sample_rate) {
    m_session_sample_rate = session_sample_rate;
    m_session_sample_rate_isSet = true;
}

bool OAIUpdateAppMonitorRequest_AppMonitorConfiguration::is_session_sample_rate_Set() const{
    return m_session_sample_rate_isSet;
}

bool OAIUpdateAppMonitorRequest_AppMonitorConfiguration::is_session_sample_rate_Valid() const{
    return m_session_sample_rate_isValid;
}

QList OAIUpdateAppMonitorRequest_AppMonitorConfiguration::getTelemetries() const {
    return m_telemetries;
}
void OAIUpdateAppMonitorRequest_AppMonitorConfiguration::setTelemetries(const QList &telemetries) {
    m_telemetries = telemetries;
    m_telemetries_isSet = true;
}

bool OAIUpdateAppMonitorRequest_AppMonitorConfiguration::is_telemetries_Set() const{
    return m_telemetries_isSet;
}

bool OAIUpdateAppMonitorRequest_AppMonitorConfiguration::is_telemetries_Valid() const{
    return m_telemetries_isValid;
}

bool OAIUpdateAppMonitorRequest_AppMonitorConfiguration::isSet() const {
...
bool OAIUpdateAppMonitorRequest_AppMonitorConfiguration::isValid() const {
