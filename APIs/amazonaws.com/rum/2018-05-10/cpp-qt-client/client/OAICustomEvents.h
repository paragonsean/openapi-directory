...
#ifndef OAICustomEvents_H
#define OAICustomEvents_H
...
class OAICustomEvents : public OAIObject {
public:
    OAICustomEvents();
    OAICustomEvents(QString json);
    ~OAICustomEvents() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomEvents)

#endif // OAICustomEvents_H
