...
#include "OAIPutRumEventsRequest.h"
...
OAIPutRumEventsRequest::OAIPutRumEventsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutRumEventsRequest::OAIPutRumEventsRequest() {
    this->initializeModel();
}

OAIPutRumEventsRequest::~OAIPutRumEventsRequest() {}

void OAIPutRumEventsRequest::initializeModel() {
...
void OAIPutRumEventsRequest::fromJson(QString jsonString) {
...
void OAIPutRumEventsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIPutRumEventsRequest::asJson() const {
...
QJsonObject OAIPutRumEventsRequest::asJsonObject() const {
    QJsonObject obj;
...
OAIPutRumEventsRequest_AppMonitorDetails OAIPutRumEventsRequest::getAppMonitorDetails() const {
    return m_app_monitor_details;
}
void OAIPutRumEventsRequest::setAppMonitorDetails(const OAIPutRumEventsRequest_AppMonitorDetails &app_monitor_details) {
    m_app_monitor_details = app_monitor_details;
    m_app_monitor_details_isSet = true;
}

bool OAIPutRumEventsRequest::is_app_monitor_details_Set() const{
    return m_app_monitor_details_isSet;
}

bool OAIPutRumEventsRequest::is_app_monitor_details_Valid() const{
    return m_app_monitor_details_isValid;
}

QString OAIPutRumEventsRequest::getBatchId() const {
    return m_batch_id;
}
void OAIPutRumEventsRequest::setBatchId(const QString &batch_id) {
    m_batch_id = batch_id;
    m_batch_id_isSet = true;
}

bool OAIPutRumEventsRequest::is_batch_id_Set() const{
    return m_batch_id_isSet;
}

bool OAIPutRumEventsRequest::is_batch_id_Valid() const{
    return m_batch_id_isValid;
}

QList OAIPutRumEventsRequest::getRumEvents() const {
    return m_rum_events;
}
void OAIPutRumEventsRequest::setRumEvents(const QList &rum_events) {
    m_rum_events = rum_events;
    m_rum_events_isSet = true;
}

bool OAIPutRumEventsRequest::is_rum_events_Set() const{
    return m_rum_events_isSet;
}

bool OAIPutRumEventsRequest::is_rum_events_Valid() const{
    return m_rum_events_isValid;
}

OAIPutRumEventsRequest_UserDetails OAIPutRumEventsRequest::getUserDetails() const {
    return m_user_details;
}
void OAIPutRumEventsRequest::setUserDetails(const OAIPutRumEventsRequest_UserDetails &user_details) {
    m_user_details = user_details;
    m_user_details_isSet = true;
}

bool OAIPutRumEventsRequest::is_user_details_Set() const{
    return m_user_details_isSet;
}

bool OAIPutRumEventsRequest::is_user_details_Valid() const{
    return m_user_details_isValid;
}

bool OAIPutRumEventsRequest::isSet() const {
...
bool OAIPutRumEventsRequest::isValid() const {
