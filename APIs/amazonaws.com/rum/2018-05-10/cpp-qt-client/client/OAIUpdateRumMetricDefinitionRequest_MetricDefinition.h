...
/*
 * OAIUpdateRumMetricDefinitionRequest_MetricDefinition.h
 *
 * 
 */

#ifndef OAIUpdateRumMetricDefinitionRequest_MetricDefinition_H
#define OAIUpdateRumMetricDefinitionRequest_MetricDefinition_H
...
class OAIUpdateRumMetricDefinitionRequest_MetricDefinition : public OAIObject {
public:
    OAIUpdateRumMetricDefinitionRequest_MetricDefinition();
    OAIUpdateRumMetricDefinitionRequest_MetricDefinition(QString json);
    ~OAIUpdateRumMetricDefinitionRequest_MetricDefinition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRumMetricDefinitionRequest_MetricDefinition)

#endif // OAIUpdateRumMetricDefinitionRequest_MetricDefinition_H
