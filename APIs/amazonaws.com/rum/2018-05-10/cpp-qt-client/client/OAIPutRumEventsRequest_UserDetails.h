...
/*
 * OAIPutRumEventsRequest_UserDetails.h
 *
 * 
 */

#ifndef OAIPutRumEventsRequest_UserDetails_H
#define OAIPutRumEventsRequest_UserDetails_H
...
class OAIPutRumEventsRequest_UserDetails : public OAIObject {
public:
    OAIPutRumEventsRequest_UserDetails();
    OAIPutRumEventsRequest_UserDetails(QString json);
    ~OAIPutRumEventsRequest_UserDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutRumEventsRequest_UserDetails)

#endif // OAIPutRumEventsRequest_UserDetails_H
