...
/*
 * OAICreateAppMonitorRequest_AppMonitorConfiguration.h
 *
 * 
 */

#ifndef OAICreateAppMonitorRequest_AppMonitorConfiguration_H
#define OAICreateAppMonitorRequest_AppMonitorConfiguration_H
...
class OAICreateAppMonitorRequest_AppMonitorConfiguration : public OAIObject {
public:
    OAICreateAppMonitorRequest_AppMonitorConfiguration();
    OAICreateAppMonitorRequest_AppMonitorConfiguration(QString json);
    ~OAICreateAppMonitorRequest_AppMonitorConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAppMonitorRequest_AppMonitorConfiguration)

#endif // OAICreateAppMonitorRequest_AppMonitorConfiguration_H
