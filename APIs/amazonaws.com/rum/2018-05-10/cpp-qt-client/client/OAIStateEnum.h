...
#ifndef OAIStateEnum_H
#define OAIStateEnum_H
...
class OAIStateEnum : public OAIEnum {
public:
    OAIStateEnum();
    OAIStateEnum(QString json);
    ~OAIStateEnum() override;
    ...
    enum class eOAIStateEnum {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        CREATED, 
        DELETING, 
        ACTIVE
    };
    OAIStateEnum::eOAIStateEnum getValue() const;
    void setValue(const OAIStateEnum::eOAIStateEnum& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIStateEnum)

#endif // OAIStateEnum_H
