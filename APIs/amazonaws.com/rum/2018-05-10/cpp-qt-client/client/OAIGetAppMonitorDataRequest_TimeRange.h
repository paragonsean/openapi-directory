...
/*
 * OAIGetAppMonitorDataRequest_TimeRange.h
 *
 * 
 */

#ifndef OAIGetAppMonitorDataRequest_TimeRange_H
#define OAIGetAppMonitorDataRequest_TimeRange_H
...
class OAIGetAppMonitorDataRequest_TimeRange : public OAIObject {
public:
    OAIGetAppMonitorDataRequest_TimeRange();
    OAIGetAppMonitorDataRequest_TimeRange(QString json);
    ~OAIGetAppMonitorDataRequest_TimeRange() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAppMonitorDataRequest_TimeRange)

#endif // OAIGetAppMonitorDataRequest_TimeRange_H
