...
/*
 * OAIAppMonitor_AppMonitorConfiguration.h
 *
 * 
 */

#ifndef OAIAppMonitor_AppMonitorConfiguration_H
#define OAIAppMonitor_AppMonitorConfiguration_H
...
class OAIAppMonitor_AppMonitorConfiguration : public OAIObject {
public:
    OAIAppMonitor_AppMonitorConfiguration();
    OAIAppMonitor_AppMonitorConfiguration(QString json);
    ~OAIAppMonitor_AppMonitorConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppMonitor_AppMonitorConfiguration)

#endif // OAIAppMonitor_AppMonitorConfiguration_H
