...
OAICreateAppMonitorRequest_AppMonitorConfiguration::OAICreateAppMonitorRequest_AppMonitorConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateAppMonitorRequest_AppMonitorConfiguration::OAICreateAppMonitorRequest_AppMonitorConfiguration() {
    this->initializeModel();
}

OAICreateAppMonitorRequest_AppMonitorConfiguration::~OAICreateAppMonitorRequest_AppMonitorConfiguration() {}

void OAICreateAppMonitorRequest_AppMonitorConfiguration::initializeModel() {
...
void OAICreateAppMonitorRequest_AppMonitorConfiguration::fromJson(QString jsonString) {
...
void OAICreateAppMonitorRequest_AppMonitorConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAICreateAppMonitorRequest_AppMonitorConfiguration::asJson() const {
...
QJsonObject OAICreateAppMonitorRequest_AppMonitorConfiguration::asJsonObject() const {
    QJsonObject obj;
...
bool OAICreateAppMonitorRequest_AppMonitorConfiguration::getAllowCookies() const {
    return m_allow_cookies;
}
void OAICreateAppMonitorRequest_AppMonitorConfiguration::setAllowCookies(const bool &allow_cookies) {
    m_allow_cookies = allow_cookies;
    m_allow_cookies_isSet = true;
}

bool OAICreateAppMonitorRequest_AppMonitorConfiguration::is_allow_cookies_Set() const{
    return m_allow_cookies_isSet;
}

bool OAICreateAppMonitorRequest_AppMonitorConfiguration::is_allow_cookies_Valid() const{
    return m_allow_cookies_isValid;
}

bool OAICreateAppMonitorRequest_AppMonitorConfiguration::getEnableXRay() const {
    return m_enable_x_ray;
}
void OAICreateAppMonitorRequest_AppMonitorConfiguration::setEnableXRay(const bool &enable_x_ray) {
    m_enable_x_ray = enable_x_ray;
    m_enable_x_ray_isSet = true;
}

bool OAICreateAppMonitorRequest_AppMonitorConfiguration::is_enable_x_ray_Set() const{
    return m_enable_x_ray_isSet;
}

bool OAICreateAppMonitorRequest_AppMonitorConfiguration::is_enable_x_ray_Valid() const{
    return m_enable_x_ray_isValid;
}

QList OAICreateAppMonitorRequest_AppMonitorConfiguration::getExcludedPages() const {
    return m_excluded_pages;
}
void OAICreateAppMonitorRequest_AppMonitorConfiguration::setExcludedPages(const QList &excluded_pages) {
    m_excluded_pages = excluded_pages;
    m_excluded_pages_isSet = true;
}

bool OAICreateAppMonitorRequest_AppMonitorConfiguration::is_excluded_pages_Set() const{
    return m_excluded_pages_isSet;
}

bool OAICreateAppMonitorRequest_AppMonitorConfiguration::is_excluded_pages_Valid() const{
    return m_excluded_pages_isValid;
}

QList OAICreateAppMonitorRequest_AppMonitorConfiguration::getFavoritePages() const {
    return m_favorite_pages;
}
void OAICreateAppMonitorRequest_AppMonitorConfiguration::setFavoritePages(const QList &favorite_pages) {
    m_favorite_pages = favorite_pages;
    m_favorite_pages_isSet = true;
}

bool OAICreateAppMonitorRequest_AppMonitorConfiguration::is_favorite_pages_Set() const{
    return m_favorite_pages_isSet;
}

bool OAICreateAppMonitorRequest_AppMonitorConfiguration::is_favorite_pages_Valid() const{
    return m_favorite_pages_isValid;
}

QString OAICreateAppMonitorRequest_AppMonitorConfiguration::getGuestRoleArn() const {
    return m_guest_role_arn;
}
void OAICreateAppMonitorRequest_AppMonitorConfiguration::setGuestRoleArn(const QString &guest_role_arn) {
    m_guest_role_arn = guest_role_arn;
    m_guest_role_arn_isSet = true;
}

bool OAICreateAppMonitorRequest_AppMonitorConfiguration::is_guest_role_arn_Set() const{
    return m_guest_role_arn_isSet;
}

bool OAICreateAppMonitorRequest_AppMonitorConfiguration::is_guest_role_arn_Valid() const{
    return m_guest_role_arn_isValid;
}

QString OAICreateAppMonitorRequest_AppMonitorConfiguration::getIdentityPoolId() const {
    return m_identity_pool_id;
}
void OAICreateAppMonitorRequest_AppMonitorConfiguration::setIdentityPoolId(const QString &identity_pool_id) {
    m_identity_pool_id = identity_pool_id;
    m_identity_pool_id_isSet = true;
}

bool OAICreateAppMonitorRequest_AppMonitorConfiguration::is_identity_pool_id_Set() const{
    return m_identity_pool_id_isSet;
}

bool OAICreateAppMonitorRequest_AppMonitorConfiguration::is_identity_pool_id_Valid() const{
    return m_identity_pool_id_isValid;
}

QList OAICreateAppMonitorRequest_AppMonitorConfiguration::getIncludedPages() const {
    return m_included_pages;
}
void OAICreateAppMonitorRequest_AppMonitorConfiguration::setIncludedPages(const QList &included_pages) {
    m_included_pages = included_pages;
    m_included_pages_isSet = true;
}

bool OAICreateAppMonitorRequest_AppMonitorConfiguration::is_included_pages_Set() const{
    return m_included_pages_isSet;
}

bool OAICreateAppMonitorRequest_AppMonitorConfiguration::is_included_pages_Valid() const{
    return m_included_pages_isValid;
}

double OAICreateAppMonitorRequest_AppMonitorConfiguration::getSessionSampleRate() const {
    return m_session_sample_rate;
}
void OAICreateAppMonitorRequest_AppMonitorConfiguration::setSessionSampleRate(const double &session_sample_rate) {
    m_session_sample_rate = session_sample_rate;
    m_session_sample_rate_isSet = true;
}

bool OAICreateAppMonitorRequest_AppMonitorConfiguration::is_session_sample_rate_Set() const{
    return m_session_sample_rate_isSet;
}

bool OAICreateAppMonitorRequest_AppMonitorConfiguration::is_session_sample_rate_Valid() const{
    return m_session_sample_rate_isValid;
}

QList OAICreateAppMonitorRequest_AppMonitorConfiguration::getTelemetries() const {
    return m_telemetries;
}
void OAICreateAppMonitorRequest_AppMonitorConfiguration::setTelemetries(const QList &telemetries) {
    m_telemetries = telemetries;
    m_telemetries_isSet = true;
}

bool OAICreateAppMonitorRequest_AppMonitorConfiguration::is_telemetries_Set() const{
    return m_telemetries_isSet;
}

bool OAICreateAppMonitorRequest_AppMonitorConfiguration::is_telemetries_Valid() const{
    return m_telemetries_isValid;
}

bool OAICreateAppMonitorRequest_AppMonitorConfiguration::isSet() const {
...
bool OAICreateAppMonitorRequest_AppMonitorConfiguration::isValid() const {
