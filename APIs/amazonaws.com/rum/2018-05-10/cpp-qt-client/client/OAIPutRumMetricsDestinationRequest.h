...
/*
 * OAIPutRumMetricsDestinationRequest.h
 *
 * 
 */

#ifndef OAIPutRumMetricsDestinationRequest_H
#define OAIPutRumMetricsDestinationRequest_H
...
class OAIPutRumMetricsDestinationRequest : public OAIObject {
public:
    OAIPutRumMetricsDestinationRequest();
    OAIPutRumMetricsDestinationRequest(QString json);
    ~OAIPutRumMetricsDestinationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutRumMetricsDestinationRequest)

#endif // OAIPutRumMetricsDestinationRequest_H
