...
/*
 * OAIDescribeLocationFsxOpenZfsResponse.h
 *
 * 
 */

#ifndef OAIDescribeLocationFsxOpenZfsResponse_H
#define OAIDescribeLocationFsxOpenZfsResponse_H
...
class OAIDescribeLocationFsxOpenZfsResponse : public OAIObject {
public:
    OAIDescribeLocationFsxOpenZfsResponse();
    OAIDescribeLocationFsxOpenZfsResponse(QString json);
    ~OAIDescribeLocationFsxOpenZfsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeLocationFsxOpenZfsResponse)

#endif // OAIDescribeLocationFsxOpenZfsResponse_H
