...
qint32 OAICapacity::getProvisioned() const {
    return m_provisioned;
}
void OAICapacity::setProvisioned(const qint32 &provisioned) {
    m_provisioned = provisioned;
    m_provisioned_isSet = true;
}

bool OAICapacity::is_provisioned_Set() const{
    return m_provisioned_isSet;
}

bool OAICapacity::is_provisioned_Valid() const{
    return m_provisioned_isValid;
}

qint32 OAICapacity::getLogicalUsed() const {
    return m_logical_used;
}
void OAICapacity::setLogicalUsed(const qint32 &logical_used) {
    m_logical_used = logical_used;
    m_logical_used_isSet = true;
}

bool OAICapacity::is_logical_used_Set() const{
    return m_logical_used_isSet;
}

bool OAICapacity::is_logical_used_Valid() const{
    return m_logical_used_isValid;
}

qint32 OAICapacity::getClusterCloudStorageUsed() const {
    return m_cluster_cloud_storage_used;
}
void OAICapacity::setClusterCloudStorageUsed(const qint32 &cluster_cloud_storage_used) {
    m_cluster_cloud_storage_used = cluster_cloud_storage_used;
    m_cluster_cloud_storage_used_isSet = true;
}

bool OAICapacity::is_cluster_cloud_storage_used_Set() const{
    return m_cluster_cloud_storage_used_isSet;
}

bool OAICapacity::is_cluster_cloud_storage_used_Valid() const{
