...
OAIDescribeTaskResponse_Options::OAIDescribeTaskResponse_Options(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeTaskResponse_Options::OAIDescribeTaskResponse_Options() {
    this->initializeModel();
}

OAIDescribeTaskResponse_Options::~OAIDescribeTaskResponse_Options() {}

void OAIDescribeTaskResponse_Options::initializeModel() {
...
void OAIDescribeTaskResponse_Options::fromJson(QString jsonString) {
...
void OAIDescribeTaskResponse_Options::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeTaskResponse_Options::asJson() const {
...
QJsonObject OAIDescribeTaskResponse_Options::asJsonObject() const {
    QJsonObject obj;
...
OAIVerifyMode OAIDescribeTaskResponse_Options::getVerifyMode() const {
    return m_verify_mode;
}
void OAIDescribeTaskResponse_Options::setVerifyMode(const OAIVerifyMode &verify_mode) {
    m_verify_mode = verify_mode;
    m_verify_mode_isSet = true;
}

bool OAIDescribeTaskResponse_Options::is_verify_mode_Set() const{
    return m_verify_mode_isSet;
}

bool OAIDescribeTaskResponse_Options::is_verify_mode_Valid() const{
    return m_verify_mode_isValid;
}

OAIOverwriteMode OAIDescribeTaskResponse_Options::getOverwriteMode() const {
    return m_overwrite_mode;
}
void OAIDescribeTaskResponse_Options::setOverwriteMode(const OAIOverwriteMode &overwrite_mode) {
    m_overwrite_mode = overwrite_mode;
    m_overwrite_mode_isSet = true;
}

bool OAIDescribeTaskResponse_Options::is_overwrite_mode_Set() const{
    return m_overwrite_mode_isSet;
}

bool OAIDescribeTaskResponse_Options::is_overwrite_mode_Valid() const{
    return m_overwrite_mode_isValid;
}

OAIAtime OAIDescribeTaskResponse_Options::getAtime() const {
    return m_atime;
}
void OAIDescribeTaskResponse_Options::setAtime(const OAIAtime &atime) {
    m_atime = atime;
    m_atime_isSet = true;
}

bool OAIDescribeTaskResponse_Options::is_atime_Set() const{
    return m_atime_isSet;
}

bool OAIDescribeTaskResponse_Options::is_atime_Valid() const{
    return m_atime_isValid;
}

OAIMtime OAIDescribeTaskResponse_Options::getMtime() const {
    return m_mtime;
}
void OAIDescribeTaskResponse_Options::setMtime(const OAIMtime &mtime) {
    m_mtime = mtime;
    m_mtime_isSet = true;
}

bool OAIDescribeTaskResponse_Options::is_mtime_Set() const{
    return m_mtime_isSet;
}

bool OAIDescribeTaskResponse_Options::is_mtime_Valid() const{
    return m_mtime_isValid;
}

OAIUid OAIDescribeTaskResponse_Options::getUid() const {
    return m_uid;
}
void OAIDescribeTaskResponse_Options::setUid(const OAIUid &uid) {
    m_uid = uid;
    m_uid_isSet = true;
}

bool OAIDescribeTaskResponse_Options::is_uid_Set() const{
    return m_uid_isSet;
}

bool OAIDescribeTaskResponse_Options::is_uid_Valid() const{
    return m_uid_isValid;
}

OAIGid OAIDescribeTaskResponse_Options::getGid() const {
    return m_gid;
}
void OAIDescribeTaskResponse_Options::setGid(const OAIGid &gid) {
    m_gid = gid;
    m_gid_isSet = true;
}

bool OAIDescribeTaskResponse_Options::is_gid_Set() const{
    return m_gid_isSet;
}

bool OAIDescribeTaskResponse_Options::is_gid_Valid() const{
    return m_gid_isValid;
}

OAIPreserveDeletedFiles OAIDescribeTaskResponse_Options::getPreserveDeletedFiles() const {
    return m_preserve_deleted_files;
}
void OAIDescribeTaskResponse_Options::setPreserveDeletedFiles(const OAIPreserveDeletedFiles &preserve_deleted_files) {
    m_preserve_deleted_files = preserve_deleted_files;
    m_preserve_deleted_files_isSet = true;
}

bool OAIDescribeTaskResponse_Options::is_preserve_deleted_files_Set() const{
    return m_preserve_deleted_files_isSet;
}

bool OAIDescribeTaskResponse_Options::is_preserve_deleted_files_Valid() const{
    return m_preserve_deleted_files_isValid;
}

OAIPreserveDevices OAIDescribeTaskResponse_Options::getPreserveDevices() const {
    return m_preserve_devices;
}
void OAIDescribeTaskResponse_Options::setPreserveDevices(const OAIPreserveDevices &preserve_devices) {
    m_preserve_devices = preserve_devices;
    m_preserve_devices_isSet = true;
}

bool OAIDescribeTaskResponse_Options::is_preserve_devices_Set() const{
    return m_preserve_devices_isSet;
}

bool OAIDescribeTaskResponse_Options::is_preserve_devices_Valid() const{
    return m_preserve_devices_isValid;
}

OAIPosixPermissions OAIDescribeTaskResponse_Options::getPosixPermissions() const {
    return m_posix_permissions;
}
void OAIDescribeTaskResponse_Options::setPosixPermissions(const OAIPosixPermissions &posix_permissions) {
    m_posix_permissions = posix_permissions;
    m_posix_permissions_isSet = true;
}

bool OAIDescribeTaskResponse_Options::is_posix_permissions_Set() const{
    return m_posix_permissions_isSet;
}

bool OAIDescribeTaskResponse_Options::is_posix_permissions_Valid() const{
    return m_posix_permissions_isValid;
}

qint32 OAIDescribeTaskResponse_Options::getBytesPerSecond() const {
    return m_bytes_per_second;
}
void OAIDescribeTaskResponse_Options::setBytesPerSecond(const qint32 &bytes_per_second) {
    m_bytes_per_second = bytes_per_second;
    m_bytes_per_second_isSet = true;
}

bool OAIDescribeTaskResponse_Options::is_bytes_per_second_Set() const{
    return m_bytes_per_second_isSet;
}

bool OAIDescribeTaskResponse_Options::is_bytes_per_second_Valid() const{
    return m_bytes_per_second_isValid;
}

OAITaskQueueing OAIDescribeTaskResponse_Options::getTaskQueueing() const {
    return m_task_queueing;
}
void OAIDescribeTaskResponse_Options::setTaskQueueing(const OAITaskQueueing &task_queueing) {
    m_task_queueing = task_queueing;
    m_task_queueing_isSet = true;
}

bool OAIDescribeTaskResponse_Options::is_task_queueing_Set() const{
    return m_task_queueing_isSet;
}

bool OAIDescribeTaskResponse_Options::is_task_queueing_Valid() const{
    return m_task_queueing_isValid;
}

OAILogLevel OAIDescribeTaskResponse_Options::getLogLevel() const {
    return m_log_level;
}
void OAIDescribeTaskResponse_Options::setLogLevel(const OAILogLevel &log_level) {
    m_log_level = log_level;
    m_log_level_isSet = true;
}

bool OAIDescribeTaskResponse_Options::is_log_level_Set() const{
    return m_log_level_isSet;
}

bool OAIDescribeTaskResponse_Options::is_log_level_Valid() const{
    return m_log_level_isValid;
}

OAITransferMode OAIDescribeTaskResponse_Options::getTransferMode() const {
    return m_transfer_mode;
}
void OAIDescribeTaskResponse_Options::setTransferMode(const OAITransferMode &transfer_mode) {
    m_transfer_mode = transfer_mode;
    m_transfer_mode_isSet = true;
}

bool OAIDescribeTaskResponse_Options::is_transfer_mode_Set() const{
    return m_transfer_mode_isSet;
}

bool OAIDescribeTaskResponse_Options::is_transfer_mode_Valid() const{
    return m_transfer_mode_isValid;
}

OAISmbSecurityDescriptorCopyFlags OAIDescribeTaskResponse_Options::getSecurityDescriptorCopyFlags() const {
    return m_security_descriptor_copy_flags;
}
void OAIDescribeTaskResponse_Options::setSecurityDescriptorCopyFlags(const OAISmbSecurityDescriptorCopyFlags &security_descriptor_copy_flags) {
    m_security_descriptor_copy_flags = security_descriptor_copy_flags;
    m_security_descriptor_copy_flags_isSet = true;
}

bool OAIDescribeTaskResponse_Options::is_security_descriptor_copy_flags_Set() const{
    return m_security_descriptor_copy_flags_isSet;
}

bool OAIDescribeTaskResponse_Options::is_security_descriptor_copy_flags_Valid() const{
    return m_security_descriptor_copy_flags_isValid;
}

OAIObjectTags OAIDescribeTaskResponse_Options::getObjectTags() const {
    return m_object_tags;
}
void OAIDescribeTaskResponse_Options::setObjectTags(const OAIObjectTags &object_tags) {
    m_object_tags = object_tags;
    m_object_tags_isSet = true;
}

bool OAIDescribeTaskResponse_Options::is_object_tags_Set() const{
    return m_object_tags_isSet;
}

bool OAIDescribeTaskResponse_Options::is_object_tags_Valid() const{
    return m_object_tags_isValid;
}

bool OAIDescribeTaskResponse_Options::isSet() const {
...
bool OAIDescribeTaskResponse_Options::isValid() const {
