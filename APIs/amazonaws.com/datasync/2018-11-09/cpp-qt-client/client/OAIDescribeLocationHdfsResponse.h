...
/*
 * OAIDescribeLocationHdfsResponse.h
 *
 * 
 */

#ifndef OAIDescribeLocationHdfsResponse_H
#define OAIDescribeLocationHdfsResponse_H
...
namespace OpenAPI {
class OAIDescribeLocationHdfsResponse_QopConfiguration;

class OAIDescribeLocationHdfsResponse : public OAIObject {
public:
    OAIDescribeLocationHdfsResponse();
    OAIDescribeLocationHdfsResponse(QString json);
    ~OAIDescribeLocationHdfsResponse() override;
    ...
    OAIDescribeLocationHdfsResponse_QopConfiguration getQopConfiguration() const;
    void setQopConfiguration(const OAIDescribeLocationHdfsResponse_QopConfiguration &qop_configuration);
...
private:
    ...
    OAIDescribeLocationHdfsResponse_QopConfiguration m_qop_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeLocationHdfsResponse)

#endif // OAIDescribeLocationHdfsResponse_H
