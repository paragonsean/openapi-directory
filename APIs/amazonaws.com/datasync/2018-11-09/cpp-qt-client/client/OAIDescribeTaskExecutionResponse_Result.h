...
/*
 * OAIDescribeTaskExecutionResponse_Result.h
 *
 * 
 */

#ifndef OAIDescribeTaskExecutionResponse_Result_H
#define OAIDescribeTaskExecutionResponse_Result_H
...
class OAIDescribeTaskExecutionResponse_Result : public OAIObject {
public:
    OAIDescribeTaskExecutionResponse_Result();
    OAIDescribeTaskExecutionResponse_Result(QString json);
    ~OAIDescribeTaskExecutionResponse_Result() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeTaskExecutionResponse_Result)

#endif // OAIDescribeTaskExecutionResponse_Result_H
