...
/*
 * OAIDescribeLocationFsxLustreResponse.h
 *
 * 
 */

#ifndef OAIDescribeLocationFsxLustreResponse_H
#define OAIDescribeLocationFsxLustreResponse_H
...
class OAIDescribeLocationFsxLustreResponse : public OAIObject {
public:
    OAIDescribeLocationFsxLustreResponse();
    OAIDescribeLocationFsxLustreResponse(QString json);
    ~OAIDescribeLocationFsxLustreResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeLocationFsxLustreResponse)

#endif // OAIDescribeLocationFsxLustreResponse_H
