...
/*
 * OAIDiscoveryServerConfiguration.h
 *
 * The network settings that DataSync Discovery uses to connect with your on-premises storage system&#39;s management interface.
 */

#ifndef OAIDiscoveryServerConfiguration_H
#define OAIDiscoveryServerConfiguration_H
...
class OAIDiscoveryServerConfiguration : public OAIObject {
public:
    OAIDiscoveryServerConfiguration();
    OAIDiscoveryServerConfiguration(QString json);
    ~OAIDiscoveryServerConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDiscoveryServerConfiguration)

#endif // OAIDiscoveryServerConfiguration_H
