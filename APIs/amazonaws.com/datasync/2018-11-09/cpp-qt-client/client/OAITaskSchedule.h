...
#ifndef OAITaskSchedule_H
#define OAITaskSchedule_H
...
class OAITaskSchedule : public OAIObject {
public:
    OAITaskSchedule();
    OAITaskSchedule(QString json);
    ~OAITaskSchedule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskSchedule)

#endif // OAITaskSchedule_H
