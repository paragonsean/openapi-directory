...
QList OAIListTasksRequest::getFilters() const {
    return m_filters;
}
void OAIListTasksRequest::setFilters(const QList &filters) {
    m_filters = filters;
    m_filters_isSet = true;
}

bool OAIListTasksRequest::is_filters_Set() const{
    return m_filters_isSet;
}

bool OAIListTasksRequest::is_filters_Valid() const{
