...
class OAIMaxP95Performance : public OAIObject {
public:
    OAIMaxP95Performance();
    OAIMaxP95Performance(QString json);
    ~OAIMaxP95Performance() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMaxP95Performance)

#endif // OAIMaxP95Performance_H
