...
/*
 * OAIGenerateRecommendationsRequest.h
 *
 * 
 */

#ifndef OAIGenerateRecommendationsRequest_H
#define OAIGenerateRecommendationsRequest_H
...
class OAIGenerateRecommendationsRequest : public OAIObject {
public:
    OAIGenerateRecommendationsRequest();
    OAIGenerateRecommendationsRequest(QString json);
    ~OAIGenerateRecommendationsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGenerateRecommendationsRequest)

#endif // OAIGenerateRecommendationsRequest_H
