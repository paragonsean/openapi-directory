...
OAIDescribeTaskExecutionResponse_Result::OAIDescribeTaskExecutionResponse_Result(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeTaskExecutionResponse_Result::OAIDescribeTaskExecutionResponse_Result() {
    this->initializeModel();
}

OAIDescribeTaskExecutionResponse_Result::~OAIDescribeTaskExecutionResponse_Result() {}

void OAIDescribeTaskExecutionResponse_Result::initializeModel() {
...
void OAIDescribeTaskExecutionResponse_Result::fromJson(QString jsonString) {
...
void OAIDescribeTaskExecutionResponse_Result::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeTaskExecutionResponse_Result::asJson() const {
...
QJsonObject OAIDescribeTaskExecutionResponse_Result::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIDescribeTaskExecutionResponse_Result::getPrepareDuration() const {
    return m_prepare_duration;
}
void OAIDescribeTaskExecutionResponse_Result::setPrepareDuration(const qint32 &prepare_duration) {
    m_prepare_duration = prepare_duration;
    m_prepare_duration_isSet = true;
}

bool OAIDescribeTaskExecutionResponse_Result::is_prepare_duration_Set() const{
    return m_prepare_duration_isSet;
}

bool OAIDescribeTaskExecutionResponse_Result::is_prepare_duration_Valid() const{
    return m_prepare_duration_isValid;
}

OAIPhaseStatus OAIDescribeTaskExecutionResponse_Result::getPrepareStatus() const {
    return m_prepare_status;
}
void OAIDescribeTaskExecutionResponse_Result::setPrepareStatus(const OAIPhaseStatus &prepare_status) {
    m_prepare_status = prepare_status;
    m_prepare_status_isSet = true;
}

bool OAIDescribeTaskExecutionResponse_Result::is_prepare_status_Set() const{
    return m_prepare_status_isSet;
}

bool OAIDescribeTaskExecutionResponse_Result::is_prepare_status_Valid() const{
    return m_prepare_status_isValid;
}

qint32 OAIDescribeTaskExecutionResponse_Result::getTotalDuration() const {
    return m_total_duration;
}
void OAIDescribeTaskExecutionResponse_Result::setTotalDuration(const qint32 &total_duration) {
    m_total_duration = total_duration;
    m_total_duration_isSet = true;
}

bool OAIDescribeTaskExecutionResponse_Result::is_total_duration_Set() const{
    return m_total_duration_isSet;
}

bool OAIDescribeTaskExecutionResponse_Result::is_total_duration_Valid() const{
    return m_total_duration_isValid;
}

qint32 OAIDescribeTaskExecutionResponse_Result::getTransferDuration() const {
    return m_transfer_duration;
}
void OAIDescribeTaskExecutionResponse_Result::setTransferDuration(const qint32 &transfer_duration) {
    m_transfer_duration = transfer_duration;
    m_transfer_duration_isSet = true;
}

bool OAIDescribeTaskExecutionResponse_Result::is_transfer_duration_Set() const{
    return m_transfer_duration_isSet;
}

bool OAIDescribeTaskExecutionResponse_Result::is_transfer_duration_Valid() const{
    return m_transfer_duration_isValid;
}

OAIPhaseStatus OAIDescribeTaskExecutionResponse_Result::getTransferStatus() const {
    return m_transfer_status;
}
void OAIDescribeTaskExecutionResponse_Result::setTransferStatus(const OAIPhaseStatus &transfer_status) {
    m_transfer_status = transfer_status;
    m_transfer_status_isSet = true;
}

bool OAIDescribeTaskExecutionResponse_Result::is_transfer_status_Set() const{
    return m_transfer_status_isSet;
}

bool OAIDescribeTaskExecutionResponse_Result::is_transfer_status_Valid() const{
    return m_transfer_status_isValid;
}

qint32 OAIDescribeTaskExecutionResponse_Result::getVerifyDuration() const {
    return m_verify_duration;
}
void OAIDescribeTaskExecutionResponse_Result::setVerifyDuration(const qint32 &verify_duration) {
    m_verify_duration = verify_duration;
    m_verify_duration_isSet = true;
}

bool OAIDescribeTaskExecutionResponse_Result::is_verify_duration_Set() const{
    return m_verify_duration_isSet;
}

bool OAIDescribeTaskExecutionResponse_Result::is_verify_duration_Valid() const{
    return m_verify_duration_isValid;
}

OAIPhaseStatus OAIDescribeTaskExecutionResponse_Result::getVerifyStatus() const {
    return m_verify_status;
}
void OAIDescribeTaskExecutionResponse_Result::setVerifyStatus(const OAIPhaseStatus &verify_status) {
    m_verify_status = verify_status;
    m_verify_status_isSet = true;
}

bool OAIDescribeTaskExecutionResponse_Result::is_verify_status_Set() const{
    return m_verify_status_isSet;
}

bool OAIDescribeTaskExecutionResponse_Result::is_verify_status_Valid() const{
    return m_verify_status_isValid;
}

QString OAIDescribeTaskExecutionResponse_Result::getErrorCode() const {
    return m_error_code;
}
void OAIDescribeTaskExecutionResponse_Result::setErrorCode(const QString &error_code) {
    m_error_code = error_code;
    m_error_code_isSet = true;
}

bool OAIDescribeTaskExecutionResponse_Result::is_error_code_Set() const{
    return m_error_code_isSet;
}

bool OAIDescribeTaskExecutionResponse_Result::is_error_code_Valid() const{
    return m_error_code_isValid;
}

QString OAIDescribeTaskExecutionResponse_Result::getErrorDetail() const {
    return m_error_detail;
}
void OAIDescribeTaskExecutionResponse_Result::setErrorDetail(const QString &error_detail) {
    m_error_detail = error_detail;
    m_error_detail_isSet = true;
}

bool OAIDescribeTaskExecutionResponse_Result::is_error_detail_Set() const{
    return m_error_detail_isSet;
}

bool OAIDescribeTaskExecutionResponse_Result::is_error_detail_Valid() const{
    return m_error_detail_isValid;
}

bool OAIDescribeTaskExecutionResponse_Result::isSet() const {
...
bool OAIDescribeTaskExecutionResponse_Result::isValid() const {
