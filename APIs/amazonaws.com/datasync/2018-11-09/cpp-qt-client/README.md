...
class Example : public QObject {
    Q_OBJECT
    QString create();
    OAIAddStorageSystemRequest create();
    QString create();
    QString create();
    QString create();
    QString create();
...
QString Example::create(){
    QString obj;
OAIAddStorageSystemRequest Example::create(){
    OAIAddStorageSystemRequest obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::addStorageSystemSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::addStorageSystemSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAIAddStorageSystemRequest oai_add_storage_system_request = create(); // OAIAddStorageSystemRequest | 
      ...
      apiInstance.addStorageSystem(x_amz_targetoai_add_storage_system_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
