...
public class DeleteTaskRequest {
  ...
  public DeleteTaskRequest taskArn(String taskArn) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.taskArn, deleteTaskRequest.taskArn);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteTaskRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteTaskRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteTaskRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteTaskRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
