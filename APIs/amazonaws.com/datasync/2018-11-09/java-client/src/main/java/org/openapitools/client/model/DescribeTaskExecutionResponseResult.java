...
public class DescribeTaskExecutionResponseResult {
  ...
  public DescribeTaskExecutionResponseResult() {
  }

  public DescribeTaskExecutionResponseResult prepareDuration(Integer prepareDuration) {
  ...
  public DescribeTaskExecutionResponseResult prepareStatus(PhaseStatus prepareStatus) {
  ...
  public DescribeTaskExecutionResponseResult totalDuration(Integer totalDuration) {
  ...
  public DescribeTaskExecutionResponseResult transferDuration(Integer transferDuration) {
  ...
  public DescribeTaskExecutionResponseResult transferStatus(PhaseStatus transferStatus) {
  ...
  public DescribeTaskExecutionResponseResult verifyDuration(Integer verifyDuration) {
  ...
  public DescribeTaskExecutionResponseResult verifyStatus(PhaseStatus verifyStatus) {
  ...
  public DescribeTaskExecutionResponseResult errorCode(String errorCode) {
  ...
  public DescribeTaskExecutionResponseResult errorDetail(String errorDetail) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeTaskExecutionResponseResult describeTaskExecutionResponseResult = (DescribeTaskExecutionResponseResult) o;
    return Objects.equals(this.prepareDuration, describeTaskExecutionResponseResult.prepareDuration) &&
        Objects.equals(this.prepareStatus, describeTaskExecutionResponseResult.prepareStatus) &&
        Objects.equals(this.totalDuration, describeTaskExecutionResponseResult.totalDuration) &&
        Objects.equals(this.transferDuration, describeTaskExecutionResponseResult.transferDuration) &&
        Objects.equals(this.transferStatus, describeTaskExecutionResponseResult.transferStatus) &&
        Objects.equals(this.verifyDuration, describeTaskExecutionResponseResult.verifyDuration) &&
        Objects.equals(this.verifyStatus, describeTaskExecutionResponseResult.verifyStatus) &&
        Objects.equals(this.errorCode, describeTaskExecutionResponseResult.errorCode) &&
        Objects.equals(this.errorDetail, describeTaskExecutionResponseResult.errorDetail);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeTaskExecutionResponseResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeTaskExecutionResponseResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeTaskExecutionResponseResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeTaskExecutionResponseResult is not found in the empty JSON string", DescribeTaskExecutionResponseResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeTaskExecutionResponseResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeTaskExecutionResponseResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeTaskExecutionResponseResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeTaskExecutionResponseResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeTaskExecutionResponseResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeTaskExecutionResponseResult.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeTaskExecutionResponseResult>() {
           @Override
           public void write(JsonWriter out, DescribeTaskExecutionResponseResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeTaskExecutionResponseResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeTaskExecutionResponseResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeTaskExecutionResponseResult
   * @throws IOException if the JSON string is invalid with respect to DescribeTaskExecutionResponseResult
   */
  public static DescribeTaskExecutionResponseResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeTaskExecutionResponseResult.class);
  }

  /**
   * Convert an instance of DescribeTaskExecutionResponseResult to an JSON string
   *
   * @return JSON string
   */
