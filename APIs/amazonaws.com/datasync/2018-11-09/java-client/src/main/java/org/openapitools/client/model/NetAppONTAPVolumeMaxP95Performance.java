...
public class NetAppONTAPVolumeMaxP95Performance {
  ...
  public NetAppONTAPVolumeMaxP95Performance() {
  }

  public NetAppONTAPVolumeMaxP95Performance iopsRead(Double iopsRead) {
  ...
  public NetAppONTAPVolumeMaxP95Performance iopsWrite(Double iopsWrite) {
  ...
  public NetAppONTAPVolumeMaxP95Performance iopsOther(Double iopsOther) {
  ...
  public NetAppONTAPVolumeMaxP95Performance iopsTotal(Double iopsTotal) {
  ...
  public NetAppONTAPVolumeMaxP95Performance throughputRead(Double throughputRead) {
  ...
  public NetAppONTAPVolumeMaxP95Performance throughputWrite(Double throughputWrite) {
  ...
  public NetAppONTAPVolumeMaxP95Performance throughputOther(Double throughputOther) {
  ...
  public NetAppONTAPVolumeMaxP95Performance throughputTotal(Double throughputTotal) {
  ...
  public NetAppONTAPVolumeMaxP95Performance latencyRead(Double latencyRead) {
  ...
  public NetAppONTAPVolumeMaxP95Performance latencyWrite(Double latencyWrite) {
  ...
  public NetAppONTAPVolumeMaxP95Performance latencyOther(Double latencyOther) {
  ...
  public boolean equals(Object o) {
    ...
    NetAppONTAPVolumeMaxP95Performance netAppONTAPVolumeMaxP95Performance = (NetAppONTAPVolumeMaxP95Performance) o;
    return Objects.equals(this.iopsRead, netAppONTAPVolumeMaxP95Performance.iopsRead) &&
        Objects.equals(this.iopsWrite, netAppONTAPVolumeMaxP95Performance.iopsWrite) &&
        Objects.equals(this.iopsOther, netAppONTAPVolumeMaxP95Performance.iopsOther) &&
        Objects.equals(this.iopsTotal, netAppONTAPVolumeMaxP95Performance.iopsTotal) &&
        Objects.equals(this.throughputRead, netAppONTAPVolumeMaxP95Performance.throughputRead) &&
        Objects.equals(this.throughputWrite, netAppONTAPVolumeMaxP95Performance.throughputWrite) &&
        Objects.equals(this.throughputOther, netAppONTAPVolumeMaxP95Performance.throughputOther) &&
        Objects.equals(this.throughputTotal, netAppONTAPVolumeMaxP95Performance.throughputTotal) &&
        Objects.equals(this.latencyRead, netAppONTAPVolumeMaxP95Performance.latencyRead) &&
        Objects.equals(this.latencyWrite, netAppONTAPVolumeMaxP95Performance.latencyWrite) &&
        Objects.equals(this.latencyOther, netAppONTAPVolumeMaxP95Performance.latencyOther);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetAppONTAPVolumeMaxP95Performance {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NetAppONTAPVolumeMaxP95Performance
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NetAppONTAPVolumeMaxP95Performance.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetAppONTAPVolumeMaxP95Performance is not found in the empty JSON string", NetAppONTAPVolumeMaxP95Performance.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NetAppONTAPVolumeMaxP95Performance.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NetAppONTAPVolumeMaxP95Performance` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetAppONTAPVolumeMaxP95Performance.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetAppONTAPVolumeMaxP95Performance' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetAppONTAPVolumeMaxP95Performance> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetAppONTAPVolumeMaxP95Performance.class));

       return (TypeAdapter<T>) new TypeAdapter<NetAppONTAPVolumeMaxP95Performance>() {
           @Override
           public void write(JsonWriter out, NetAppONTAPVolumeMaxP95Performance value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NetAppONTAPVolumeMaxP95Performance read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NetAppONTAPVolumeMaxP95Performance given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NetAppONTAPVolumeMaxP95Performance
   * @throws IOException if the JSON string is invalid with respect to NetAppONTAPVolumeMaxP95Performance
   */
  public static NetAppONTAPVolumeMaxP95Performance fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetAppONTAPVolumeMaxP95Performance.class);
  }

  /**
   * Convert an instance of NetAppONTAPVolumeMaxP95Performance to an JSON string
   *
   * @return JSON string
   */
