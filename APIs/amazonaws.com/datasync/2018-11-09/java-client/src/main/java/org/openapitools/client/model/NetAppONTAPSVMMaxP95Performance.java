...
public class NetAppONTAPSVMMaxP95Performance {
  ...
  public NetAppONTAPSVMMaxP95Performance() {
  }

  public NetAppONTAPSVMMaxP95Performance iopsRead(Double iopsRead) {
  ...
  public NetAppONTAPSVMMaxP95Performance iopsWrite(Double iopsWrite) {
  ...
  public NetAppONTAPSVMMaxP95Performance iopsOther(Double iopsOther) {
  ...
  public NetAppONTAPSVMMaxP95Performance iopsTotal(Double iopsTotal) {
  ...
  public NetAppONTAPSVMMaxP95Performance throughputRead(Double throughputRead) {
  ...
  public NetAppONTAPSVMMaxP95Performance throughputWrite(Double throughputWrite) {
  ...
  public NetAppONTAPSVMMaxP95Performance throughputOther(Double throughputOther) {
  ...
  public NetAppONTAPSVMMaxP95Performance throughputTotal(Double throughputTotal) {
  ...
  public NetAppONTAPSVMMaxP95Performance latencyRead(Double latencyRead) {
  ...
  public NetAppONTAPSVMMaxP95Performance latencyWrite(Double latencyWrite) {
  ...
  public NetAppONTAPSVMMaxP95Performance latencyOther(Double latencyOther) {
  ...
  public boolean equals(Object o) {
    ...
    NetAppONTAPSVMMaxP95Performance netAppONTAPSVMMaxP95Performance = (NetAppONTAPSVMMaxP95Performance) o;
    return Objects.equals(this.iopsRead, netAppONTAPSVMMaxP95Performance.iopsRead) &&
        Objects.equals(this.iopsWrite, netAppONTAPSVMMaxP95Performance.iopsWrite) &&
        Objects.equals(this.iopsOther, netAppONTAPSVMMaxP95Performance.iopsOther) &&
        Objects.equals(this.iopsTotal, netAppONTAPSVMMaxP95Performance.iopsTotal) &&
        Objects.equals(this.throughputRead, netAppONTAPSVMMaxP95Performance.throughputRead) &&
        Objects.equals(this.throughputWrite, netAppONTAPSVMMaxP95Performance.throughputWrite) &&
        Objects.equals(this.throughputOther, netAppONTAPSVMMaxP95Performance.throughputOther) &&
        Objects.equals(this.throughputTotal, netAppONTAPSVMMaxP95Performance.throughputTotal) &&
        Objects.equals(this.latencyRead, netAppONTAPSVMMaxP95Performance.latencyRead) &&
        Objects.equals(this.latencyWrite, netAppONTAPSVMMaxP95Performance.latencyWrite) &&
        Objects.equals(this.latencyOther, netAppONTAPSVMMaxP95Performance.latencyOther);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetAppONTAPSVMMaxP95Performance {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NetAppONTAPSVMMaxP95Performance
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NetAppONTAPSVMMaxP95Performance.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetAppONTAPSVMMaxP95Performance is not found in the empty JSON string", NetAppONTAPSVMMaxP95Performance.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NetAppONTAPSVMMaxP95Performance.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NetAppONTAPSVMMaxP95Performance` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetAppONTAPSVMMaxP95Performance.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetAppONTAPSVMMaxP95Performance' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetAppONTAPSVMMaxP95Performance> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetAppONTAPSVMMaxP95Performance.class));

       return (TypeAdapter<T>) new TypeAdapter<NetAppONTAPSVMMaxP95Performance>() {
           @Override
           public void write(JsonWriter out, NetAppONTAPSVMMaxP95Performance value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NetAppONTAPSVMMaxP95Performance read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NetAppONTAPSVMMaxP95Performance given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NetAppONTAPSVMMaxP95Performance
   * @throws IOException if the JSON string is invalid with respect to NetAppONTAPSVMMaxP95Performance
   */
  public static NetAppONTAPSVMMaxP95Performance fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetAppONTAPSVMMaxP95Performance.class);
  }

  /**
   * Convert an instance of NetAppONTAPSVMMaxP95Performance to an JSON string
   *
   * @return JSON string
   */
