...
public class DescribeTaskResponseOptions {
  ...
  public DescribeTaskResponseOptions() {
  }

  public DescribeTaskResponseOptions verifyMode(VerifyMode verifyMode) {
  ...
  public DescribeTaskResponseOptions overwriteMode(OverwriteMode overwriteMode) {
  ...
  public DescribeTaskResponseOptions atime(Atime atime) {
    this.atime = atime;
    return this;
  }
  ...
  public DescribeTaskResponseOptions mtime(Mtime mtime) {
    this.mtime = mtime;
    return this;
  }
  ...
  public DescribeTaskResponseOptions uid(Uid uid) {
    this.uid = uid;
    return this;
  }
  ...
  public DescribeTaskResponseOptions gid(Gid gid) {
    this.gid = gid;
    return this;
  }
  ...
  public DescribeTaskResponseOptions preserveDeletedFiles(PreserveDeletedFiles preserveDeletedFiles) {
  ...
  public DescribeTaskResponseOptions preserveDevices(PreserveDevices preserveDevices) {
  ...
  public DescribeTaskResponseOptions posixPermissions(PosixPermissions posixPermissions) {
  ...
  public DescribeTaskResponseOptions bytesPerSecond(Integer bytesPerSecond) {
  ...
  public DescribeTaskResponseOptions taskQueueing(TaskQueueing taskQueueing) {
  ...
  public DescribeTaskResponseOptions logLevel(LogLevel logLevel) {
  ...
  public DescribeTaskResponseOptions transferMode(TransferMode transferMode) {
  ...
  public DescribeTaskResponseOptions securityDescriptorCopyFlags(SmbSecurityDescriptorCopyFlags securityDescriptorCopyFlags) {
  ...
  public DescribeTaskResponseOptions objectTags(ObjectTags objectTags) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeTaskResponseOptions describeTaskResponseOptions = (DescribeTaskResponseOptions) o;
    return Objects.equals(this.verifyMode, describeTaskResponseOptions.verifyMode) &&
        Objects.equals(this.overwriteMode, describeTaskResponseOptions.overwriteMode) &&
        Objects.equals(this.atime, describeTaskResponseOptions.atime) &&
        Objects.equals(this.mtime, describeTaskResponseOptions.mtime) &&
        Objects.equals(this.uid, describeTaskResponseOptions.uid) &&
        Objects.equals(this.gid, describeTaskResponseOptions.gid) &&
        Objects.equals(this.preserveDeletedFiles, describeTaskResponseOptions.preserveDeletedFiles) &&
        Objects.equals(this.preserveDevices, describeTaskResponseOptions.preserveDevices) &&
        Objects.equals(this.posixPermissions, describeTaskResponseOptions.posixPermissions) &&
        Objects.equals(this.bytesPerSecond, describeTaskResponseOptions.bytesPerSecond) &&
        Objects.equals(this.taskQueueing, describeTaskResponseOptions.taskQueueing) &&
        Objects.equals(this.logLevel, describeTaskResponseOptions.logLevel) &&
        Objects.equals(this.transferMode, describeTaskResponseOptions.transferMode) &&
        Objects.equals(this.securityDescriptorCopyFlags, describeTaskResponseOptions.securityDescriptorCopyFlags) &&
        Objects.equals(this.objectTags, describeTaskResponseOptions.objectTags);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeTaskResponseOptions {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeTaskResponseOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeTaskResponseOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeTaskResponseOptions is not found in the empty JSON string", DescribeTaskResponseOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeTaskResponseOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeTaskResponseOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeTaskResponseOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeTaskResponseOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeTaskResponseOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeTaskResponseOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeTaskResponseOptions>() {
           @Override
           public void write(JsonWriter out, DescribeTaskResponseOptions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeTaskResponseOptions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeTaskResponseOptions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeTaskResponseOptions
   * @throws IOException if the JSON string is invalid with respect to DescribeTaskResponseOptions
   */
  public static DescribeTaskResponseOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeTaskResponseOptions.class);
  }

  /**
   * Convert an instance of DescribeTaskResponseOptions to an JSON string
   *
   * @return JSON string
   */
