...
public class PrivateLinkConfig {
  ...
  public PrivateLinkConfig vpcEndpointId(String vpcEndpointId) {
  ...
  public PrivateLinkConfig privateLinkEndpoint(String privateLinkEndpoint) {
  ...
  public PrivateLinkConfig subnetArns(List subnetArns) {
  ...
  public PrivateLinkConfig securityGroupArns(List securityGroupArns) {
  ...
  public boolean equals(Object o) {
    ...
    PrivateLinkConfig privateLinkConfig = (PrivateLinkConfig) o;
    return Objects.equals(this.vpcEndpointId, privateLinkConfig.vpcEndpointId) &&
        Objects.equals(this.privateLinkEndpoint, privateLinkConfig.privateLinkEndpoint) &&
        Objects.equals(this.subnetArns, privateLinkConfig.subnetArns) &&
        Objects.equals(this.securityGroupArns, privateLinkConfig.securityGroupArns);
  }
  ...
  public String toString() {
    ...
    sb.append("class PrivateLinkConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PrivateLinkConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PrivateLinkConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrivateLinkConfig is not found in the empty JSON string", PrivateLinkConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PrivateLinkConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PrivateLinkConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrivateLinkConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrivateLinkConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrivateLinkConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrivateLinkConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<PrivateLinkConfig>() {
           @Override
           public void write(JsonWriter out, PrivateLinkConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PrivateLinkConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PrivateLinkConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PrivateLinkConfig
   * @throws IOException if the JSON string is invalid with respect to PrivateLinkConfig
   */
  public static PrivateLinkConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrivateLinkConfig.class);
  }

  /**
   * Convert an instance of PrivateLinkConfig to an JSON string
   *
   * @return JSON string
   */
