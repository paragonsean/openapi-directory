...
public class MaxP95Performance {
  ...
  public MaxP95Performance iopsRead(Double iopsRead) {
  ...
  public MaxP95Performance iopsWrite(Double iopsWrite) {
  ...
  public MaxP95Performance iopsOther(Double iopsOther) {
  ...
  public MaxP95Performance iopsTotal(Double iopsTotal) {
  ...
  public MaxP95Performance throughputRead(Double throughputRead) {
  ...
  public MaxP95Performance throughputWrite(Double throughputWrite) {
  ...
  public MaxP95Performance throughputOther(Double throughputOther) {
  ...
  public MaxP95Performance throughputTotal(Double throughputTotal) {
  ...
  public MaxP95Performance latencyRead(Double latencyRead) {
  ...
  public MaxP95Performance latencyWrite(Double latencyWrite) {
  ...
  public MaxP95Performance latencyOther(Double latencyOther) {
  ...
  public boolean equals(Object o) {
    ...
    MaxP95Performance maxP95Performance = (MaxP95Performance) o;
    return Objects.equals(this.iopsRead, maxP95Performance.iopsRead) &&
        Objects.equals(this.iopsWrite, maxP95Performance.iopsWrite) &&
        Objects.equals(this.iopsOther, maxP95Performance.iopsOther) &&
        Objects.equals(this.iopsTotal, maxP95Performance.iopsTotal) &&
        Objects.equals(this.throughputRead, maxP95Performance.throughputRead) &&
        Objects.equals(this.throughputWrite, maxP95Performance.throughputWrite) &&
        Objects.equals(this.throughputOther, maxP95Performance.throughputOther) &&
        Objects.equals(this.throughputTotal, maxP95Performance.throughputTotal) &&
        Objects.equals(this.latencyRead, maxP95Performance.latencyRead) &&
        Objects.equals(this.latencyWrite, maxP95Performance.latencyWrite) &&
        Objects.equals(this.latencyOther, maxP95Performance.latencyOther);
  }
  ...
  public String toString() {
    ...
    sb.append("class MaxP95Performance {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MaxP95Performance
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MaxP95Performance.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MaxP95Performance is not found in the empty JSON string", MaxP95Performance.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MaxP95Performance.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MaxP95Performance` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MaxP95Performance.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MaxP95Performance' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MaxP95Performance> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MaxP95Performance.class));

       return (TypeAdapter<T>) new TypeAdapter<MaxP95Performance>() {
           @Override
           public void write(JsonWriter out, MaxP95Performance value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MaxP95Performance read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MaxP95Performance given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MaxP95Performance
   * @throws IOException if the JSON string is invalid with respect to MaxP95Performance
   */
  public static MaxP95Performance fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MaxP95Performance.class);
  }

  /**
   * Convert an instance of MaxP95Performance to an JSON string
   *
   * @return JSON string
   */
