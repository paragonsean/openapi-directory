...
/**
 * The CreateTaskRequestOptions model module.
 * @module model/CreateTaskRequestOptions
 * @version 2018-11-09
 */
class CreateTaskRequestOptions {
    /**
     * Constructs a new <code>CreateTaskRequestOptions</code>.
     * @alias module:model/CreateTaskRequestOptions
     * @implements module:model/Options
     */
    constructor() { 
        Options.initialize(this);
        CreateTaskRequestOptions.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateTaskRequestOptions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateTaskRequestOptions} obj Optional instance to populate.
     * @return {module:model/CreateTaskRequestOptions} The populated <code>CreateTaskRequestOptions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateTaskRequestOptions();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateTaskRequestOptions</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateTaskRequestOptions</code>.
     */
 ...
 */
CreateTaskRequestOptions.prototype['VerifyMode'] = undefined;

/**
 * @member {module:model/OverwriteMode} OverwriteMode
 */
CreateTaskRequestOptions.prototype['OverwriteMode'] = undefined;

/**
 * @member {module:model/Atime} Atime
 */
CreateTaskRequestOptions.prototype['Atime'] = undefined;

/**
 * @member {module:model/Mtime} Mtime
 */
CreateTaskRequestOptions.prototype['Mtime'] = undefined;

/**
 * @member {module:model/Uid} Uid
 */
CreateTaskRequestOptions.prototype['Uid'] = undefined;

/**
 * @member {module:model/Gid} Gid
 */
CreateTaskRequestOptions.prototype['Gid'] = undefined;

/**
 * @member {module:model/PreserveDeletedFiles} PreserveDeletedFiles
 */
CreateTaskRequestOptions.prototype['PreserveDeletedFiles'] = undefined;

/**
 * @member {module:model/PreserveDevices} PreserveDevices
 */
CreateTaskRequestOptions.prototype['PreserveDevices'] = undefined;

/**
 * @member {module:model/PosixPermissions} PosixPermissions
 */
CreateTaskRequestOptions.prototype['PosixPermissions'] = undefined;

/**
 * @member {Number} BytesPerSecond
 */
CreateTaskRequestOptions.prototype['BytesPerSecond'] = undefined;

/**
 * @member {module:model/TaskQueueing} TaskQueueing
 */
CreateTaskRequestOptions.prototype['TaskQueueing'] = undefined;

/**
 * @member {module:model/LogLevel} LogLevel
 */
CreateTaskRequestOptions.prototype['LogLevel'] = undefined;

/**
 * @member {module:model/TransferMode} TransferMode
 */
CreateTaskRequestOptions.prototype['TransferMode'] = undefined;

/**
 * @member {module:model/SmbSecurityDescriptorCopyFlags} SecurityDescriptorCopyFlags
 */
CreateTaskRequestOptions.prototype['SecurityDescriptorCopyFlags'] = undefined;

/**
 * @member {module:model/ObjectTags} ObjectTags
 */
CreateTaskRequestOptions.prototype['ObjectTags'] = undefined;
...
export default CreateTaskRequestOptions;
