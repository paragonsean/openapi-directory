...
class TaskSchedule {
    ...
    /**
     * Validates the JSON data with respect to <code>TaskSchedule</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TaskSchedule</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TaskSchedule.RequiredProperties) {
...
TaskSchedule.RequiredProperties = ["ScheduleExpression"];
