...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataSync.CreateLocationSmbRequest();
  });
  ...
  describe('CreateLocationSmbRequest', function() {
    it('should create an instance of CreateLocationSmbRequest', function() {
      // uncomment below and update the code to test CreateLocationSmbRequest
      //var instance = new AwsDataSync.CreateLocationSmbRequest();
      //expect(instance).to.be.a(AwsDataSync.CreateLocationSmbRequest);
    });
