...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataSync.P95MetricsThroughput();
  });
  ...
  describe('P95MetricsThroughput', function() {
    it('should create an instance of P95MetricsThroughput', function() {
      // uncomment below and update the code to test P95MetricsThroughput
      //var instance = new AwsDataSync.P95MetricsThroughput();
      //expect(instance).to.be.a(AwsDataSync.P95MetricsThroughput);
    });
