...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataSync.DescribeLocationS3Response();
  });
  ...
  describe('DescribeLocationS3Response', function() {
    it('should create an instance of DescribeLocationS3Response', function() {
      // uncomment below and update the code to test DescribeLocationS3Response
      //var instance = new AwsDataSync.DescribeLocationS3Response();
      //expect(instance).to.be.a(AwsDataSync.DescribeLocationS3Response);
    });
    ...
    it('should have the property s3StorageClass (base name: "S3StorageClass")', function() {
      // uncomment below and update the code to test the property s3StorageClass
      //var instance = new AwsDataSync.DescribeLocationS3Response();
      //expect(instance).to.be();
    });
