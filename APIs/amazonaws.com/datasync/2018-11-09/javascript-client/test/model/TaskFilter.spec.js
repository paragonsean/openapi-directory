...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataSync.TaskFilter();
  });
  ...
  describe('TaskFilter', function() {
    it('should create an instance of TaskFilter', function() {
      // uncomment below and update the code to test TaskFilter
      //var instance = new AwsDataSync.TaskFilter();
      //expect(instance).to.be.a(AwsDataSync.TaskFilter);
    });
