...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataSync.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new AwsDataSync.ListLocationsResponse();
      //expect(instance).to.be.a(AwsDataSync.ListLocationsResponse);
    });
