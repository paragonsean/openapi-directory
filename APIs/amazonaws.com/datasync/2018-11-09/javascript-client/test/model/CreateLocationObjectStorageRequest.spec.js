...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataSync.CreateLocationObjectStorageRequest();
  });
  ...
  describe('CreateLocationObjectStorageRequest', function() {
    it('should create an instance of CreateLocationObjectStorageRequest', function() {
      // uncomment below and update the code to test CreateLocationObjectStorageRequest
      //var instance = new AwsDataSync.CreateLocationObjectStorageRequest();
      //expect(instance).to.be.a(AwsDataSync.CreateLocationObjectStorageRequest);
    });
