...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataSync.DescribeLocationHdfsResponse();
  });
  ...
  describe('DescribeLocationHdfsResponse', function() {
    it('should create an instance of DescribeLocationHdfsResponse', function() {
      // uncomment below and update the code to test DescribeLocationHdfsResponse
      //var instance = new AwsDataSync.DescribeLocationHdfsResponse();
      //expect(instance).to.be.a(AwsDataSync.DescribeLocationHdfsResponse);
    });
