...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataSync.DescribeLocationAzureBlobResponse();
  });
  ...
  describe('DescribeLocationAzureBlobResponse', function() {
    it('should create an instance of DescribeLocationAzureBlobResponse', function() {
      // uncomment below and update the code to test DescribeLocationAzureBlobResponse
      //var instance = new AwsDataSync.DescribeLocationAzureBlobResponse();
      //expect(instance).to.be.a(AwsDataSync.DescribeLocationAzureBlobResponse);
    });
    ...
    it('should have the property blobType (base name: "BlobType")', function() {
      // uncomment below and update the code to test the property blobType
      //var instance = new AwsDataSync.DescribeLocationAzureBlobResponse();
      //expect(instance).to.be();
    });
