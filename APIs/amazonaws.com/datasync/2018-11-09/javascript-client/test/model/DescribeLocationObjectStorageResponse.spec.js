...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataSync.DescribeLocationObjectStorageResponse();
  });
  ...
  describe('DescribeLocationObjectStorageResponse', function() {
    it('should create an instance of DescribeLocationObjectStorageResponse', function() {
      // uncomment below and update the code to test DescribeLocationObjectStorageResponse
      //var instance = new AwsDataSync.DescribeLocationObjectStorageResponse();
      //expect(instance).to.be.a(AwsDataSync.DescribeLocationObjectStorageResponse);
    });
