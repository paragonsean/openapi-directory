...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataSync.P95Metrics();
  });
  ...
  describe('P95Metrics', function() {
    it('should create an instance of P95Metrics', function() {
      // uncomment below and update the code to test P95Metrics
      //var instance = new AwsDataSync.P95Metrics();
      //expect(instance).to.be.a(AwsDataSync.P95Metrics);
    });
