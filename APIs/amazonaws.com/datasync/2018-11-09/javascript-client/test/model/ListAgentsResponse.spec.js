...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataSync.ListAgentsResponse();
  });
  ...
  describe('ListAgentsResponse', function() {
    it('should create an instance of ListAgentsResponse', function() {
      // uncomment below and update the code to test ListAgentsResponse
      //var instance = new AwsDataSync.ListAgentsResponse();
      //expect(instance).to.be.a(AwsDataSync.ListAgentsResponse);
    });
