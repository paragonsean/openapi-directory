...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataSync.DescribeLocationNfsResponse();
  });
  ...
  describe('DescribeLocationNfsResponse', function() {
    it('should create an instance of DescribeLocationNfsResponse', function() {
      // uncomment below and update the code to test DescribeLocationNfsResponse
      //var instance = new AwsDataSync.DescribeLocationNfsResponse();
      //expect(instance).to.be.a(AwsDataSync.DescribeLocationNfsResponse);
    });
