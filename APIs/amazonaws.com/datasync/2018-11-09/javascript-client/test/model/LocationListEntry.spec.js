...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataSync.LocationListEntry();
  });
  ...
  describe('LocationListEntry', function() {
    it('should create an instance of LocationListEntry', function() {
      // uncomment below and update the code to test LocationListEntry
      //var instance = new AwsDataSync.LocationListEntry();
      //expect(instance).to.be.a(AwsDataSync.LocationListEntry);
    });
