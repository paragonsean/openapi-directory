...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataSync.ListTaskExecutionsRequest();
  });
  ...
  describe('ListTaskExecutionsRequest', function() {
    it('should create an instance of ListTaskExecutionsRequest', function() {
      // uncomment below and update the code to test ListTaskExecutionsRequest
      //var instance = new AwsDataSync.ListTaskExecutionsRequest();
      //expect(instance).to.be.a(AwsDataSync.ListTaskExecutionsRequest);
    });
