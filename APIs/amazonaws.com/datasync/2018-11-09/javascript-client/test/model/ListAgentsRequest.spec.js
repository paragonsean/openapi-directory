...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataSync.ListAgentsRequest();
  });
  ...
  describe('ListAgentsRequest', function() {
    it('should create an instance of ListAgentsRequest', function() {
      // uncomment below and update the code to test ListAgentsRequest
      //var instance = new AwsDataSync.ListAgentsRequest();
      //expect(instance).to.be.a(AwsDataSync.ListAgentsRequest);
    });
