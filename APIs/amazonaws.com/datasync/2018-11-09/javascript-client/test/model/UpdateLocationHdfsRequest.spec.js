...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataSync.UpdateLocationHdfsRequest();
  });
  ...
  describe('UpdateLocationHdfsRequest', function() {
    it('should create an instance of UpdateLocationHdfsRequest', function() {
      // uncomment below and update the code to test UpdateLocationHdfsRequest
      //var instance = new AwsDataSync.UpdateLocationHdfsRequest();
      //expect(instance).to.be.a(AwsDataSync.UpdateLocationHdfsRequest);
    });
