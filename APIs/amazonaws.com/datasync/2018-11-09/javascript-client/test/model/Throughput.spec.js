...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataSync.Throughput();
  });
  ...
  describe('Throughput', function() {
    it('should create an instance of Throughput', function() {
      // uncomment below and update the code to test Throughput
      //var instance = new AwsDataSync.Throughput();
      //expect(instance).to.be.a(AwsDataSync.Throughput);
    });
