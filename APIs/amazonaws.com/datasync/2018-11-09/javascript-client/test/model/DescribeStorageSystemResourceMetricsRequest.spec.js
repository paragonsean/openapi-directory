...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataSync.DescribeStorageSystemResourceMetricsRequest();
  });
  ...
  describe('DescribeStorageSystemResourceMetricsRequest', function() {
    it('should create an instance of DescribeStorageSystemResourceMetricsRequest', function() {
      // uncomment below and update the code to test DescribeStorageSystemResourceMetricsRequest
      //var instance = new AwsDataSync.DescribeStorageSystemResourceMetricsRequest();
      //expect(instance).to.be.a(AwsDataSync.DescribeStorageSystemResourceMetricsRequest);
    });
