...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataSync.UpdateLocationNfsRequest();
  });
  ...
  describe('UpdateLocationNfsRequest', function() {
    it('should create an instance of UpdateLocationNfsRequest', function() {
      // uncomment below and update the code to test UpdateLocationNfsRequest
      //var instance = new AwsDataSync.UpdateLocationNfsRequest();
      //expect(instance).to.be.a(AwsDataSync.UpdateLocationNfsRequest);
    });
    ...
    it('should have the property onPremConfig (base name: "OnPremConfig")', function() {
      // uncomment below and update the code to test the property onPremConfig
      //var instance = new AwsDataSync.UpdateLocationNfsRequest();
      //expect(instance).to.be();
    });
