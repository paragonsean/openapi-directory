...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataSync.P95MetricsLatency();
  });
  ...
  describe('P95MetricsLatency', function() {
    it('should create an instance of P95MetricsLatency', function() {
      // uncomment below and update the code to test P95MetricsLatency
      //var instance = new AwsDataSync.P95MetricsLatency();
      //expect(instance).to.be.a(AwsDataSync.P95MetricsLatency);
    });
