...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataSync.UntagResourceRequest();
  });
  ...
  describe('UntagResourceRequest', function() {
    it('should create an instance of UntagResourceRequest', function() {
      ...
      //var instance = new AwsDataSync.UntagResourceRequest();
      //expect(instance).to.be.a(AwsDataSync.UntagResourceRequest);
    });
