...
(function(root, factory) {
  ...
  describe('IOPS', function() {
    it('should create an instance of IOPS', function() {
      // uncomment below and update the code to test IOPS
      //var instance = new AwsDataSync.IOPS();
      //expect(instance).to.be.a(AwsDataSync.IOPS);
    });
