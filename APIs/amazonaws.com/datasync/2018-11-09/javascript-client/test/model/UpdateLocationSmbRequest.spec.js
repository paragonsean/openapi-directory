...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataSync.UpdateLocationSmbRequest();
  });
  ...
  describe('UpdateLocationSmbRequest', function() {
    it('should create an instance of UpdateLocationSmbRequest', function() {
      // uncomment below and update the code to test UpdateLocationSmbRequest
      //var instance = new AwsDataSync.UpdateLocationSmbRequest();
      //expect(instance).to.be.a(AwsDataSync.UpdateLocationSmbRequest);
    });
