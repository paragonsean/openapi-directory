...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataSync.P95MetricsIOPS();
  });
  ...
  describe('P95MetricsIOPS', function() {
    it('should create an instance of P95MetricsIOPS', function() {
      // uncomment below and update the code to test P95MetricsIOPS
      //var instance = new AwsDataSync.P95MetricsIOPS();
      //expect(instance).to.be.a(AwsDataSync.P95MetricsIOPS);
    });
