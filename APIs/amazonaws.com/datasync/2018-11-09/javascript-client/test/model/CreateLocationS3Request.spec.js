...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataSync.CreateLocationS3Request();
  });
  ...
  describe('CreateLocationS3Request', function() {
    it('should create an instance of CreateLocationS3Request', function() {
      // uncomment below and update the code to test CreateLocationS3Request
      //var instance = new AwsDataSync.CreateLocationS3Request();
      //expect(instance).to.be.a(AwsDataSync.CreateLocationS3Request);
    });
