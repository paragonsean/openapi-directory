...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataSync.ListLocationsRequest();
  });
  ...
  describe('ListLocationsRequest', function() {
    it('should create an instance of ListLocationsRequest', function() {
      ...
      //var instance = new AwsDataSync.ListLocationsRequest();
      //expect(instance).to.be.a(AwsDataSync.ListLocationsRequest);
    });
