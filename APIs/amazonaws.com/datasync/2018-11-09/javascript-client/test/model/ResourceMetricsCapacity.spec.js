...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataSync.ResourceMetricsCapacity();
  });
  ...
  describe('ResourceMetricsCapacity', function() {
    it('should create an instance of ResourceMetricsCapacity', function() {
      // uncomment below and update the code to test ResourceMetricsCapacity
      //var instance = new AwsDataSync.ResourceMetricsCapacity();
      //expect(instance).to.be.a(AwsDataSync.ResourceMetricsCapacity);
    });
