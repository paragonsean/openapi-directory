...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataSync.DescribeLocationSmbResponse();
  });
  ...
  describe('DescribeLocationSmbResponse', function() {
    it('should create an instance of DescribeLocationSmbResponse', function() {
      // uncomment below and update the code to test DescribeLocationSmbResponse
      //var instance = new AwsDataSync.DescribeLocationSmbResponse();
      //expect(instance).to.be.a(AwsDataSync.DescribeLocationSmbResponse);
    });
