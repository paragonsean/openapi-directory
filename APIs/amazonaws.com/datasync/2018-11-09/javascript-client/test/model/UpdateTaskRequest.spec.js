...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataSync.UpdateTaskRequest();
  });
  ...
  describe('UpdateTaskRequest', function() {
    it('should create an instance of UpdateTaskRequest', function() {
      // uncomment below and update the code to test UpdateTaskRequest
      //var instance = new AwsDataSync.UpdateTaskRequest();
      //expect(instance).to.be.a(AwsDataSync.UpdateTaskRequest);
    });
