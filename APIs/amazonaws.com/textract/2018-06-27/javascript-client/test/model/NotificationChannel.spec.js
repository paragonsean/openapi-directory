...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTextract.NotificationChannel();
  });
  ...
  describe('NotificationChannel', function() {
    it('should create an instance of NotificationChannel', function() {
      ...
      //var instance = new AmazonTextract.NotificationChannel();
      //expect(instance).to.be.a(AmazonTextract.NotificationChannel);
    });
