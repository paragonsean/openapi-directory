...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTextract.GetDocumentAnalysisRequest();
  });
  ...
  describe('GetDocumentAnalysisRequest', function() {
    it('should create an instance of GetDocumentAnalysisRequest', function() {
      // uncomment below and update the code to test GetDocumentAnalysisRequest
      //var instance = new AmazonTextract.GetDocumentAnalysisRequest();
      //expect(instance).to.be.a(AmazonTextract.GetDocumentAnalysisRequest);
    });
