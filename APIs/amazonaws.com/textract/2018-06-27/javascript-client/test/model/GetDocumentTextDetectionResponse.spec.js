...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTextract.GetDocumentTextDetectionResponse();
  });
  ...
  describe('GetDocumentTextDetectionResponse', function() {
    it('should create an instance of GetDocumentTextDetectionResponse', function() {
      // uncomment below and update the code to test GetDocumentTextDetectionResponse
      //var instance = new AmazonTextract.GetDocumentTextDetectionResponse();
      //expect(instance).to.be.a(AmazonTextract.GetDocumentTextDetectionResponse);
    });
    ...
    it('should have the property detectDocumentTextModelVersion (base name: "DetectDocumentTextModelVersion")', function() {
      // uncomment below and update the code to test the property detectDocumentTextModelVersion
      //var instance = new AmazonTextract.GetDocumentTextDetectionResponse();
      //expect(instance).to.be();
    });
