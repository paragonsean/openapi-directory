...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTextract.GetLendingAnalysisResponse();
  });
  ...
  describe('GetLendingAnalysisResponse', function() {
    it('should create an instance of GetLendingAnalysisResponse', function() {
      // uncomment below and update the code to test GetLendingAnalysisResponse
      //var instance = new AmazonTextract.GetLendingAnalysisResponse();
      //expect(instance).to.be.a(AmazonTextract.GetLendingAnalysisResponse);
    });
