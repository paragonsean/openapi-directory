...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTextract.GetExpenseAnalysisRequest();
  });
  ...
  describe('GetExpenseAnalysisRequest', function() {
    it('should create an instance of GetExpenseAnalysisRequest', function() {
      // uncomment below and update the code to test GetExpenseAnalysisRequest
      //var instance = new AmazonTextract.GetExpenseAnalysisRequest();
      //expect(instance).to.be.a(AmazonTextract.GetExpenseAnalysisRequest);
    });
