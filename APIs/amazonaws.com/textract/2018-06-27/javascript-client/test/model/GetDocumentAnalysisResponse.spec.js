...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTextract.GetDocumentAnalysisResponse();
  });
  ...
  describe('GetDocumentAnalysisResponse', function() {
    it('should create an instance of GetDocumentAnalysisResponse', function() {
      // uncomment below and update the code to test GetDocumentAnalysisResponse
      //var instance = new AmazonTextract.GetDocumentAnalysisResponse();
      //expect(instance).to.be.a(AmazonTextract.GetDocumentAnalysisResponse);
    });
