...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTextract.LendingDetection();
  });
  ...
  describe('LendingDetection', function() {
    it('should create an instance of LendingDetection', function() {
      // uncomment below and update the code to test LendingDetection
      //var instance = new AmazonTextract.LendingDetection();
      //expect(instance).to.be.a(AmazonTextract.LendingDetection);
    });
