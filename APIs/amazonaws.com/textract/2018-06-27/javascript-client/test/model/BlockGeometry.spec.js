...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTextract.BlockGeometry();
  });
  ...
  describe('BlockGeometry', function() {
    it('should create an instance of BlockGeometry', function() {
      // uncomment below and update the code to test BlockGeometry
      //var instance = new AmazonTextract.BlockGeometry();
      //expect(instance).to.be.a(AmazonTextract.BlockGeometry);
    });
