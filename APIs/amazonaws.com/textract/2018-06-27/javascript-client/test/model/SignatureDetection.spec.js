...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTextract.SignatureDetection();
  });
  ...
  describe('SignatureDetection', function() {
    it('should create an instance of SignatureDetection', function() {
      // uncomment below and update the code to test SignatureDetection
      //var instance = new AmazonTextract.SignatureDetection();
      //expect(instance).to.be.a(AmazonTextract.SignatureDetection);
    });
