...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTextract.GetDocumentTextDetectionRequest();
  });
  ...
  describe('GetDocumentTextDetectionRequest', function() {
    it('should create an instance of GetDocumentTextDetectionRequest', function() {
      // uncomment below and update the code to test GetDocumentTextDetectionRequest
      //var instance = new AmazonTextract.GetDocumentTextDetectionRequest();
      //expect(instance).to.be.a(AmazonTextract.GetDocumentTextDetectionRequest);
    });
