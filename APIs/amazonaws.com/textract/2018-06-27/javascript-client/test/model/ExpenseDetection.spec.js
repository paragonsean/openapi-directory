...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonTextract.ExpenseDetection();
  });
  ...
  describe('ExpenseDetection', function() {
    it('should create an instance of ExpenseDetection', function() {
      // uncomment below and update the code to test ExpenseDetection
      //var instance = new AmazonTextract.ExpenseDetection();
      //expect(instance).to.be.a(AmazonTextract.ExpenseDetection);
    });
