...
class Example : public QObject {
    Q_OBJECT
    QString create();
    OAIAnalyzeDocumentRequest create();
    QString create();
    QString create();
    QString create();
    QString create();
...
QString Example::create(){
    QString obj;
OAIAnalyzeDocumentRequest Example::create(){
    OAIAnalyzeDocumentRequest obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::analyzeDocumentSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::analyzeDocumentSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAIAnalyzeDocumentRequest oai_analyze_document_request = create(); // OAIAnalyzeDocumentRequest | 
      ...
      apiInstance.analyzeDocument(x_amz_targetoai_analyze_document_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
