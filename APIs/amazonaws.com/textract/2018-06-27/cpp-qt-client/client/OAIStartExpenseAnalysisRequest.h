...
/*
 * OAIStartExpenseAnalysisRequest.h
 *
 * 
 */

#ifndef OAIStartExpenseAnalysisRequest_H
#define OAIStartExpenseAnalysisRequest_H
...
class OAIStartExpenseAnalysisRequest_OutputConfig;

class OAIStartExpenseAnalysisRequest : public OAIObject {
public:
    OAIStartExpenseAnalysisRequest();
    OAIStartExpenseAnalysisRequest(QString json);
    ~OAIStartExpenseAnalysisRequest() override;
    ...
    OAIStartExpenseAnalysisRequest_OutputConfig getOutputConfig() const;
    void setOutputConfig(const OAIStartExpenseAnalysisRequest_OutputConfig &output_config);
...
private:
    ...
    OAIStartExpenseAnalysisRequest_OutputConfig m_output_config;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartExpenseAnalysisRequest)

#endif // OAIStartExpenseAnalysisRequest_H
