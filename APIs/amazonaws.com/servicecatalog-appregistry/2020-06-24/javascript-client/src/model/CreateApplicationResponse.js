...
import CreateApplicationResponseApplication from './CreateApplicationResponseApplication';
...
class CreateApplicationResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('application')) {
                obj['application'] = CreateApplicationResponseApplication.constructFromObject(data['application']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['application']) { // data not null
          CreateApplicationResponseApplication.validateJSON(data['application']);
        }
...
/**
 * @member {module:model/CreateApplicationResponseApplication} application
 */
CreateApplicationResponse.prototype['application'] = undefined;
