...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalogAppRegistry.CreateApplicationResponseApplication();
  });
  ...
  describe('CreateApplicationResponseApplication', function() {
    it('should create an instance of CreateApplicationResponseApplication', function() {
      // uncomment below and update the code to test CreateApplicationResponseApplication
      //var instance = new AwsServiceCatalogAppRegistry.CreateApplicationResponseApplication();
      //expect(instance).to.be.a(AwsServiceCatalogAppRegistry.CreateApplicationResponseApplication);
    });
