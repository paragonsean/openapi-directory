...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalogAppRegistry.Resource();
  });
  ...
  describe('Resource', function() {
    it('should create an instance of Resource', function() {
      ...
      //var instance = new AwsServiceCatalogAppRegistry.Resource();
      //expect(instance).to.be.a(AwsServiceCatalogAppRegistry.Resource);
    });
