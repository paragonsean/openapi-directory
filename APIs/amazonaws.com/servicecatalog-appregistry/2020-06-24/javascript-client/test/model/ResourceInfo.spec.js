...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalogAppRegistry.ResourceInfo();
  });
  ...
  describe('ResourceInfo', function() {
    it('should create an instance of ResourceInfo', function() {
      ...
      //var instance = new AwsServiceCatalogAppRegistry.ResourceInfo();
      //expect(instance).to.be.a(AwsServiceCatalogAppRegistry.ResourceInfo);
    });
