...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalogAppRegistry.ListApplicationsResponse();
  });
  ...
  describe('ListApplicationsResponse', function() {
    it('should create an instance of ListApplicationsResponse', function() {
      ...
      //var instance = new AwsServiceCatalogAppRegistry.ListApplicationsResponse();
      //expect(instance).to.be.a(AwsServiceCatalogAppRegistry.ListApplicationsResponse);
    });
