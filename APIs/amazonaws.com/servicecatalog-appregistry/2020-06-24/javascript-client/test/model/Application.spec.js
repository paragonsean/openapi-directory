...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalogAppRegistry.Application();
  });
  ...
  describe('Application', function() {
    it('should create an instance of Application', function() {
      ...
      //var instance = new AwsServiceCatalogAppRegistry.Application();
      //expect(instance).to.be.a(AwsServiceCatalogAppRegistry.Application);
    });
