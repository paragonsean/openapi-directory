...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalogAppRegistry.DisassociateResourceResponse();
  });
  ...
  describe('DisassociateResourceResponse', function() {
    it('should create an instance of DisassociateResourceResponse', function() {
      // uncomment below and update the code to test DisassociateResourceResponse
      //var instance = new AwsServiceCatalogAppRegistry.DisassociateResourceResponse();
      //expect(instance).to.be.a(AwsServiceCatalogAppRegistry.DisassociateResourceResponse);
    });
