...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalogAppRegistry.Integrations();
  });
  ...
  describe('Integrations', function() {
    it('should create an instance of Integrations', function() {
      ...
      //var instance = new AwsServiceCatalogAppRegistry.Integrations();
      //expect(instance).to.be.a(AwsServiceCatalogAppRegistry.Integrations);
    });
