...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalogAppRegistry.DeleteApplicationResponseApplication();
  });
  ...
  describe('DeleteApplicationResponseApplication', function() {
    it('should create an instance of DeleteApplicationResponseApplication', function() {
      // uncomment below and update the code to test DeleteApplicationResponseApplication
      //var instance = new AwsServiceCatalogAppRegistry.DeleteApplicationResponseApplication();
      //expect(instance).to.be.a(AwsServiceCatalogAppRegistry.DeleteApplicationResponseApplication);
    });
