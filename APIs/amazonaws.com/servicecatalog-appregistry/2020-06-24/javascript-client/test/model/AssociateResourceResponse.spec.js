...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalogAppRegistry.AssociateResourceResponse();
  });
  ...
  describe('AssociateResourceResponse', function() {
    it('should create an instance of AssociateResourceResponse', function() {
      // uncomment below and update the code to test AssociateResourceResponse
      //var instance = new AwsServiceCatalogAppRegistry.AssociateResourceResponse();
      //expect(instance).to.be.a(AwsServiceCatalogAppRegistry.AssociateResourceResponse);
    });
