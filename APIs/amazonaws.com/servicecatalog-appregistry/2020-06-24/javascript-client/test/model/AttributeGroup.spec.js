...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalogAppRegistry.AttributeGroup();
  });
  ...
  describe('AttributeGroup', function() {
    it('should create an instance of AttributeGroup', function() {
      ...
      //var instance = new AwsServiceCatalogAppRegistry.AttributeGroup();
      //expect(instance).to.be.a(AwsServiceCatalogAppRegistry.AttributeGroup);
    });
