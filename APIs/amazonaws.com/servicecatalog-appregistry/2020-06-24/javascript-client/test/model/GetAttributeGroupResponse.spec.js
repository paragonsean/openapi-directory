...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalogAppRegistry.GetAttributeGroupResponse();
  });
  ...
  describe('GetAttributeGroupResponse', function() {
    it('should create an instance of GetAttributeGroupResponse', function() {
      // uncomment below and update the code to test GetAttributeGroupResponse
      //var instance = new AwsServiceCatalogAppRegistry.GetAttributeGroupResponse();
      //expect(instance).to.be.a(AwsServiceCatalogAppRegistry.GetAttributeGroupResponse);
    });
