...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalogAppRegistry.GetApplicationResponse();
  });
  ...
  describe('GetApplicationResponse', function() {
    it('should create an instance of GetApplicationResponse', function() {
      ...
      //var instance = new AwsServiceCatalogAppRegistry.GetApplicationResponse();
      //expect(instance).to.be.a(AwsServiceCatalogAppRegistry.GetApplicationResponse);
    });
    ...
    it('should have the property associatedResourceCount (base name: "associatedResourceCount")', function() {
      // uncomment below and update the code to test the property associatedResourceCount
      //var instance = new AwsServiceCatalogAppRegistry.GetApplicationResponse();
      //expect(instance).to.be();
    });
