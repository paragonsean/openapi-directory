...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalogAppRegistry.AttributeGroupSummary();
  });
  ...
  describe('AttributeGroupSummary', function() {
    it('should create an instance of AttributeGroupSummary', function() {
      // uncomment below and update the code to test AttributeGroupSummary
      //var instance = new AwsServiceCatalogAppRegistry.AttributeGroupSummary();
      //expect(instance).to.be.a(AwsServiceCatalogAppRegistry.AttributeGroupSummary);
    });
