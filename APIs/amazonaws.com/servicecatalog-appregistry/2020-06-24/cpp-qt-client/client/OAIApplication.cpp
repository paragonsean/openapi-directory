...
QDateTime OAIApplication::getCreationTime() const {
    return m_creation_time;
}
void OAIApplication::setCreationTime(const QDateTime &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAIApplication::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAIApplication::is_creation_time_Valid() const{
    return m_creation_time_isValid;
}

QDateTime OAIApplication::getLastUpdateTime() const {
    return m_last_update_time;
}
void OAIApplication::setLastUpdateTime(const QDateTime &last_update_time) {
    m_last_update_time = last_update_time;
    m_last_update_time_isSet = true;
}

bool OAIApplication::is_last_update_time_Set() const{
    return m_last_update_time_isSet;
}

bool OAIApplication::is_last_update_time_Valid() const{
