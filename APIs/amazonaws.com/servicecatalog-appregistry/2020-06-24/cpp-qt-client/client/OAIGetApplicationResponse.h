...
namespace OpenAPI {
class OAIGetApplicationResponse_integrations;
...
public:
    ...
    qint32 getAssociatedResourceCount() const;
    void setAssociatedResourceCount(const qint32 &associated_resource_count);
    bool is_associated_resource_count_Set() const;
    bool is_associated_resource_count_Valid() const;
    ...
    OAIGetApplicationResponse_integrations getIntegrations() const;
    void setIntegrations(const OAIGetApplicationResponse_integrations &integrations);
...
private:
    ...
    qint32 m_associated_resource_count;
    bool m_associated_resource_count_isSet;
    bool m_associated_resource_count_isValid;

    QMap m_tags;
    bool m_tags_isSet;
    bool m_tags_isValid;

    OAIGetApplicationResponse_integrations m_integrations;
