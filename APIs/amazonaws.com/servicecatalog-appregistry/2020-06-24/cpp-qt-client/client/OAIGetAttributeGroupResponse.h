...
/*
 * OAIGetAttributeGroupResponse.h
 *
 * 
 */

#ifndef OAIGetAttributeGroupResponse_H
#define OAIGetAttributeGroupResponse_H
...
class OAIGetAttributeGroupResponse : public OAIObject {
public:
    OAIGetAttributeGroupResponse();
    OAIGetAttributeGroupResponse(QString json);
    ~OAIGetAttributeGroupResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAttributeGroupResponse)

#endif // OAIGetAttributeGroupResponse_H
