...
QDateTime OAIResource::getAssociationTime() const {
    return m_association_time;
}
void OAIResource::setAssociationTime(const QDateTime &association_time) {
    m_association_time = association_time;
    m_association_time_isSet = true;
}

bool OAIResource::is_association_time_Set() const{
    return m_association_time_isSet;
}

bool OAIResource::is_association_time_Valid() const{
    return m_association_time_isValid;
}

OAIResource_integrations OAIResource::getIntegrations() const {
    return m_integrations;
}
void OAIResource::setIntegrations(const OAIResource_integrations &integrations) {
    m_integrations = integrations;
    m_integrations_isSet = true;
}

bool OAIResource::is_integrations_Set() const{
    return m_integrations_isSet;
}

bool OAIResource::is_integrations_Valid() const{
