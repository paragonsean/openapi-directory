...
/*
 * OAIAssociateResourceResponse.h
 *
 * 
 */

#ifndef OAIAssociateResourceResponse_H
#define OAIAssociateResourceResponse_H
...
class OAIAssociateResourceResponse : public OAIObject {
public:
    OAIAssociateResourceResponse();
    OAIAssociateResourceResponse(QString json);
    ~OAIAssociateResourceResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateResourceResponse)

#endif // OAIAssociateResourceResponse_H
