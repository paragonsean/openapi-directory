...
/*
 * OAIAttributeGroupSummary.h
 *
 * Summary of a Amazon Web Services Service Catalog AppRegistry attribute group.
 */

#ifndef OAIAttributeGroupSummary_H
#define OAIAttributeGroupSummary_H
...
class OAIAttributeGroupSummary : public OAIObject {
public:
    OAIAttributeGroupSummary();
    OAIAttributeGroupSummary(QString json);
    ~OAIAttributeGroupSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttributeGroupSummary)

#endif // OAIAttributeGroupSummary_H
