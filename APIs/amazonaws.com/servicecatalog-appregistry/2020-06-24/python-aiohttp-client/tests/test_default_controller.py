...
async def test_associate_attribute_group(client):
    """Test case for associate_attribute_group
    ...
    response = await client.request(
        method='PUT',
        path='/applications/{application}/attribute-groups/{attribute_group}'.format(application='application_example', attribute_group='attribute_group_example'),
        headers=headers,
        )
...
async def test_associate_resource(client):
    """Test case for associate_resource
    ...
    response = await client.request(
        method='PUT',
        path='/applications/{application}/resources/{resource_type}/{resource}'.format(application='application_example', resource_type='resource_type_example', resource='resource_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_attribute_group(client):
    """Test case for create_attribute_group

    
    """
    body = {"clientToken":"","name":"","description":"","attributes":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_delete_application(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/applications/{application}'.format(application='application_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_attribute_group(client):
    """Test case for delete_attribute_group
    ...
    response = await client.request(
        method='DELETE',
        path='/attribute-groups/{attribute_group}'.format(attribute_group='attribute_group_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_disassociate_attribute_group(client):
    """Test case for disassociate_attribute_group
...
async def test_disassociate_resource(client):
    """Test case for disassociate_resource
...
async def test_get_associated_resource(client):
    """Test case for get_associated_resource
...
async def test_get_attribute_group(client):
    """Test case for get_attribute_group
...
async def test_list_associated_attribute_groups(client):
    """Test case for list_associated_attribute_groups
    ...
    response = await client.request(
        method='GET',
        path='/applications/{application}/attribute-groups'.format(application='application_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_associated_resources(client):
    """Test case for list_associated_resources
    ...
    response = await client.request(
        method='GET',
        path='/applications/{application}/resources'.format(application='application_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_attribute_groups(client):
    """Test case for list_attribute_groups
...
async def test_list_attribute_groups_for_application(client):
    """Test case for list_attribute_groups_for_application
    ...
    response = await client.request(
        method='GET',
        path='/applications/{application}/attribute-group-details'.format(application='application_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_put_configuration(client):
    """Test case for put_configuration

    
    """
    body = {"configuration":{"tagQueryConfiguration":{"tagKey":""}}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_sync_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/sync/{resource_type}/{resource}'.format(resource_type='resource_type_example', resource='resource_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_attribute_group(client):
    """Test case for update_attribute_group
