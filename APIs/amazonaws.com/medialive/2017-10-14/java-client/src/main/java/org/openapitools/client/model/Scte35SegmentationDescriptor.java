...
public class Scte35SegmentationDescriptor {
  ...
  public Scte35SegmentationDescriptor deliveryRestrictions(Scte35SegmentationDescriptorDeliveryRestrictions deliveryRestrictions) {
  ...
  public Scte35SegmentationDescriptor segmentNum(Integer segmentNum) {
  ...
  public Scte35SegmentationDescriptor segmentationCancelIndicator(Scte35SegmentationCancelIndicator segmentationCancelIndicator) {
  ...
  public Scte35SegmentationDescriptor segmentationDuration(Integer segmentationDuration) {
  ...
  public Scte35SegmentationDescriptor segmentationEventId(Integer segmentationEventId) {
  ...
  public Scte35SegmentationDescriptor segmentationTypeId(Integer segmentationTypeId) {
  ...
  public Scte35SegmentationDescriptor segmentationUpid(String segmentationUpid) {
  ...
  public Scte35SegmentationDescriptor segmentationUpidType(Integer segmentationUpidType) {
  ...
  public Scte35SegmentationDescriptor segmentsExpected(Integer segmentsExpected) {
  ...
  public Scte35SegmentationDescriptor subSegmentNum(Integer subSegmentNum) {
  ...
  public Scte35SegmentationDescriptor subSegmentsExpected(Integer subSegmentsExpected) {
  ...
  public boolean equals(Object o) {
    ...
    Scte35SegmentationDescriptor scte35SegmentationDescriptor = (Scte35SegmentationDescriptor) o;
    return Objects.equals(this.deliveryRestrictions, scte35SegmentationDescriptor.deliveryRestrictions) &&
        Objects.equals(this.segmentNum, scte35SegmentationDescriptor.segmentNum) &&
        Objects.equals(this.segmentationCancelIndicator, scte35SegmentationDescriptor.segmentationCancelIndicator) &&
        Objects.equals(this.segmentationDuration, scte35SegmentationDescriptor.segmentationDuration) &&
        Objects.equals(this.segmentationEventId, scte35SegmentationDescriptor.segmentationEventId) &&
        Objects.equals(this.segmentationTypeId, scte35SegmentationDescriptor.segmentationTypeId) &&
        Objects.equals(this.segmentationUpid, scte35SegmentationDescriptor.segmentationUpid) &&
        Objects.equals(this.segmentationUpidType, scte35SegmentationDescriptor.segmentationUpidType) &&
        Objects.equals(this.segmentsExpected, scte35SegmentationDescriptor.segmentsExpected) &&
        Objects.equals(this.subSegmentNum, scte35SegmentationDescriptor.subSegmentNum) &&
        Objects.equals(this.subSegmentsExpected, scte35SegmentationDescriptor.subSegmentsExpected);
  }
  ...
  public String toString() {
    ...
    sb.append("class Scte35SegmentationDescriptor {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Scte35SegmentationDescriptor
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Scte35SegmentationDescriptor.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Scte35SegmentationDescriptor is not found in the empty JSON string", Scte35SegmentationDescriptor.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Scte35SegmentationDescriptor.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Scte35SegmentationDescriptor` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Scte35SegmentationDescriptor.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Scte35SegmentationDescriptor.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Scte35SegmentationDescriptor' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Scte35SegmentationDescriptor> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Scte35SegmentationDescriptor.class));

       return (TypeAdapter<T>) new TypeAdapter<Scte35SegmentationDescriptor>() {
           @Override
           public void write(JsonWriter out, Scte35SegmentationDescriptor value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Scte35SegmentationDescriptor read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Scte35SegmentationDescriptor given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Scte35SegmentationDescriptor
   * @throws IOException if the JSON string is invalid with respect to Scte35SegmentationDescriptor
   */
  public static Scte35SegmentationDescriptor fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Scte35SegmentationDescriptor.class);
  }

  /**
   * Convert an instance of Scte35SegmentationDescriptor to an JSON string
   *
   * @return JSON string
   */
