...
public class DescribeInputDeviceResponseHdDeviceSettings {
  ...
  public DescribeInputDeviceResponseHdDeviceSettings() {
  }

  public DescribeInputDeviceResponseHdDeviceSettings activeInput(InputDeviceActiveInput activeInput) {
  ...
  public DescribeInputDeviceResponseHdDeviceSettings configuredInput(InputDeviceConfiguredInput configuredInput) {
  ...
  public DescribeInputDeviceResponseHdDeviceSettings deviceState(InputDeviceState deviceState) {
  ...
  public DescribeInputDeviceResponseHdDeviceSettings framerate(Double framerate) {
  ...
  public DescribeInputDeviceResponseHdDeviceSettings height(Integer height) {
    this.height = height;
    return this;
  }
  ...
  public DescribeInputDeviceResponseHdDeviceSettings maxBitrate(Integer maxBitrate) {
  ...
  public DescribeInputDeviceResponseHdDeviceSettings scanType(InputDeviceScanType scanType) {
  ...
  public DescribeInputDeviceResponseHdDeviceSettings width(Integer width) {
    this.width = width;
    return this;
  }
  ...
  public DescribeInputDeviceResponseHdDeviceSettings latencyMs(Integer latencyMs) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeInputDeviceResponseHdDeviceSettings describeInputDeviceResponseHdDeviceSettings = (DescribeInputDeviceResponseHdDeviceSettings) o;
    return Objects.equals(this.activeInput, describeInputDeviceResponseHdDeviceSettings.activeInput) &&
        Objects.equals(this.configuredInput, describeInputDeviceResponseHdDeviceSettings.configuredInput) &&
        Objects.equals(this.deviceState, describeInputDeviceResponseHdDeviceSettings.deviceState) &&
        Objects.equals(this.framerate, describeInputDeviceResponseHdDeviceSettings.framerate) &&
        Objects.equals(this.height, describeInputDeviceResponseHdDeviceSettings.height) &&
        Objects.equals(this.maxBitrate, describeInputDeviceResponseHdDeviceSettings.maxBitrate) &&
        Objects.equals(this.scanType, describeInputDeviceResponseHdDeviceSettings.scanType) &&
        Objects.equals(this.width, describeInputDeviceResponseHdDeviceSettings.width) &&
        Objects.equals(this.latencyMs, describeInputDeviceResponseHdDeviceSettings.latencyMs);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeInputDeviceResponseHdDeviceSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeInputDeviceResponseHdDeviceSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeInputDeviceResponseHdDeviceSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeInputDeviceResponseHdDeviceSettings is not found in the empty JSON string", DescribeInputDeviceResponseHdDeviceSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeInputDeviceResponseHdDeviceSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeInputDeviceResponseHdDeviceSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeInputDeviceResponseHdDeviceSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeInputDeviceResponseHdDeviceSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeInputDeviceResponseHdDeviceSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeInputDeviceResponseHdDeviceSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeInputDeviceResponseHdDeviceSettings>() {
           @Override
           public void write(JsonWriter out, DescribeInputDeviceResponseHdDeviceSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeInputDeviceResponseHdDeviceSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeInputDeviceResponseHdDeviceSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeInputDeviceResponseHdDeviceSettings
   * @throws IOException if the JSON string is invalid with respect to DescribeInputDeviceResponseHdDeviceSettings
   */
  public static DescribeInputDeviceResponseHdDeviceSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeInputDeviceResponseHdDeviceSettings.class);
  }

  /**
   * Convert an instance of DescribeInputDeviceResponseHdDeviceSettings to an JSON string
   *
   * @return JSON string
   */
