...
public class OutputGroupOutputGroupSettings {
  ...
  public OutputGroupOutputGroupSettings() {
  }

  public OutputGroupOutputGroupSettings archiveGroupSettings(OutputGroupSettingsArchiveGroupSettings archiveGroupSettings) {
  ...
  public OutputGroupOutputGroupSettings frameCaptureGroupSettings(OutputGroupSettingsFrameCaptureGroupSettings frameCaptureGroupSettings) {
  ...
  public OutputGroupOutputGroupSettings hlsGroupSettings(OutputGroupSettingsHlsGroupSettings hlsGroupSettings) {
  ...
  public OutputGroupOutputGroupSettings mediaPackageGroupSettings(OutputGroupSettingsMediaPackageGroupSettings mediaPackageGroupSettings) {
  ...
  public OutputGroupOutputGroupSettings msSmoothGroupSettings(OutputGroupSettingsMsSmoothGroupSettings msSmoothGroupSettings) {
  ...
  public OutputGroupOutputGroupSettings multiplexGroupSettings(Object multiplexGroupSettings) {
  ...
  public OutputGroupOutputGroupSettings rtmpGroupSettings(OutputGroupSettingsRtmpGroupSettings rtmpGroupSettings) {
  ...
  public OutputGroupOutputGroupSettings udpGroupSettings(OutputGroupSettingsUdpGroupSettings udpGroupSettings) {
  ...
  public boolean equals(Object o) {
    ...
    OutputGroupOutputGroupSettings outputGroupOutputGroupSettings = (OutputGroupOutputGroupSettings) o;
    return Objects.equals(this.archiveGroupSettings, outputGroupOutputGroupSettings.archiveGroupSettings) &&
        Objects.equals(this.frameCaptureGroupSettings, outputGroupOutputGroupSettings.frameCaptureGroupSettings) &&
        Objects.equals(this.hlsGroupSettings, outputGroupOutputGroupSettings.hlsGroupSettings) &&
        Objects.equals(this.mediaPackageGroupSettings, outputGroupOutputGroupSettings.mediaPackageGroupSettings) &&
        Objects.equals(this.msSmoothGroupSettings, outputGroupOutputGroupSettings.msSmoothGroupSettings) &&
        Objects.equals(this.multiplexGroupSettings, outputGroupOutputGroupSettings.multiplexGroupSettings) &&
        Objects.equals(this.rtmpGroupSettings, outputGroupOutputGroupSettings.rtmpGroupSettings) &&
        Objects.equals(this.udpGroupSettings, outputGroupOutputGroupSettings.udpGroupSettings);
  }
  ...
  public String toString() {
    ...
    sb.append("class OutputGroupOutputGroupSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OutputGroupOutputGroupSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OutputGroupOutputGroupSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OutputGroupOutputGroupSettings is not found in the empty JSON string", OutputGroupOutputGroupSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OutputGroupOutputGroupSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OutputGroupOutputGroupSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OutputGroupOutputGroupSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OutputGroupOutputGroupSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OutputGroupOutputGroupSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OutputGroupOutputGroupSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<OutputGroupOutputGroupSettings>() {
           @Override
           public void write(JsonWriter out, OutputGroupOutputGroupSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OutputGroupOutputGroupSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OutputGroupOutputGroupSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OutputGroupOutputGroupSettings
   * @throws IOException if the JSON string is invalid with respect to OutputGroupOutputGroupSettings
   */
  public static OutputGroupOutputGroupSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OutputGroupOutputGroupSettings.class);
  }

  /**
   * Convert an instance of OutputGroupOutputGroupSettings to an JSON string
   *
   * @return JSON string
   */
