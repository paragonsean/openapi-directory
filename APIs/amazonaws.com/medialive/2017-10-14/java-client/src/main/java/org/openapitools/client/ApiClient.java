...
public class ApiClient {
    ...
    private String basePath = "http://medialive.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://medialive.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "https://medialive.{region}.amazonaws.com",
      "The MediaLive multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://medialive.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://medialive.{region}.amazonaws.com.cn",
      "The MediaLive endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2017-10-14/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://medialive.us-east-1.amazonaws.com
