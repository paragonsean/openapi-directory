...
public class DescribeInputDeviceResponseUhdDeviceSettings {
  ...
  public DescribeInputDeviceResponseUhdDeviceSettings() {
  }

  public DescribeInputDeviceResponseUhdDeviceSettings activeInput(InputDeviceActiveInput activeInput) {
  ...
  public DescribeInputDeviceResponseUhdDeviceSettings configuredInput(InputDeviceConfiguredInput configuredInput) {
  ...
  public DescribeInputDeviceResponseUhdDeviceSettings deviceState(InputDeviceState deviceState) {
  ...
  public DescribeInputDeviceResponseUhdDeviceSettings framerate(Double framerate) {
  ...
  public DescribeInputDeviceResponseUhdDeviceSettings height(Integer height) {
    this.height = height;
    return this;
  }
  ...
  public DescribeInputDeviceResponseUhdDeviceSettings maxBitrate(Integer maxBitrate) {
  ...
  public DescribeInputDeviceResponseUhdDeviceSettings scanType(InputDeviceScanType scanType) {
  ...
  public DescribeInputDeviceResponseUhdDeviceSettings width(Integer width) {
    this.width = width;
    return this;
  }
  ...
  public DescribeInputDeviceResponseUhdDeviceSettings latencyMs(Integer latencyMs) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeInputDeviceResponseUhdDeviceSettings describeInputDeviceResponseUhdDeviceSettings = (DescribeInputDeviceResponseUhdDeviceSettings) o;
    return Objects.equals(this.activeInput, describeInputDeviceResponseUhdDeviceSettings.activeInput) &&
        Objects.equals(this.configuredInput, describeInputDeviceResponseUhdDeviceSettings.configuredInput) &&
        Objects.equals(this.deviceState, describeInputDeviceResponseUhdDeviceSettings.deviceState) &&
        Objects.equals(this.framerate, describeInputDeviceResponseUhdDeviceSettings.framerate) &&
        Objects.equals(this.height, describeInputDeviceResponseUhdDeviceSettings.height) &&
        Objects.equals(this.maxBitrate, describeInputDeviceResponseUhdDeviceSettings.maxBitrate) &&
        Objects.equals(this.scanType, describeInputDeviceResponseUhdDeviceSettings.scanType) &&
        Objects.equals(this.width, describeInputDeviceResponseUhdDeviceSettings.width) &&
        Objects.equals(this.latencyMs, describeInputDeviceResponseUhdDeviceSettings.latencyMs);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeInputDeviceResponseUhdDeviceSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeInputDeviceResponseUhdDeviceSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeInputDeviceResponseUhdDeviceSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeInputDeviceResponseUhdDeviceSettings is not found in the empty JSON string", DescribeInputDeviceResponseUhdDeviceSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeInputDeviceResponseUhdDeviceSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeInputDeviceResponseUhdDeviceSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeInputDeviceResponseUhdDeviceSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeInputDeviceResponseUhdDeviceSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeInputDeviceResponseUhdDeviceSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeInputDeviceResponseUhdDeviceSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeInputDeviceResponseUhdDeviceSettings>() {
           @Override
           public void write(JsonWriter out, DescribeInputDeviceResponseUhdDeviceSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeInputDeviceResponseUhdDeviceSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeInputDeviceResponseUhdDeviceSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeInputDeviceResponseUhdDeviceSettings
   * @throws IOException if the JSON string is invalid with respect to DescribeInputDeviceResponseUhdDeviceSettings
   */
  public static DescribeInputDeviceResponseUhdDeviceSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeInputDeviceResponseUhdDeviceSettings.class);
  }

  /**
   * Convert an instance of DescribeInputDeviceResponseUhdDeviceSettings to an JSON string
   *
   * @return JSON string
   */
