...
public class StopChannelResponse {
  ...
  public StopChannelResponse() {
  }

  public StopChannelResponse arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public StopChannelResponse cdiInputSpecification(DeleteChannelResponseCdiInputSpecification cdiInputSpecification) {
  ...
  public StopChannelResponse channelClass(ChannelClass channelClass) {
  ...
  public StopChannelResponse destinations(List destinations) {
  ...
  public StopChannelResponse egressEndpoints(List egressEndpoints) {
  ...
  public StopChannelResponse encoderSettings(DeleteChannelResponseEncoderSettings encoderSettings) {
  ...
  public StopChannelResponse id(String id) {
    this.id = id;
    return this;
  }
  ...
  public StopChannelResponse inputAttachments(List inputAttachments) {
  ...
  public StopChannelResponse inputSpecification(DeleteChannelResponseInputSpecification inputSpecification) {
  ...
  public StopChannelResponse logLevel(LogLevel logLevel) {
  ...
  public StopChannelResponse maintenance(DeleteChannelResponseMaintenance maintenance) {
  ...
  public StopChannelResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  public StopChannelResponse pipelineDetails(List pipelineDetails) {
  ...
  public StopChannelResponse pipelinesRunningCount(Integer pipelinesRunningCount) {
  ...
  public StopChannelResponse roleArn(String roleArn) {
  ...
  public StopChannelResponse state(ChannelState state) {
    this.state = state;
    return this;
  }
  ...
  public StopChannelResponse tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public StopChannelResponse vpc(DeleteChannelResponseVpc vpc) {
    this.vpc = vpc;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StopChannelResponse stopChannelResponse = (StopChannelResponse) o;
    return Objects.equals(this.arn, stopChannelResponse.arn) &&
        Objects.equals(this.cdiInputSpecification, stopChannelResponse.cdiInputSpecification) &&
        Objects.equals(this.channelClass, stopChannelResponse.channelClass) &&
        Objects.equals(this.destinations, stopChannelResponse.destinations) &&
        Objects.equals(this.egressEndpoints, stopChannelResponse.egressEndpoints) &&
        Objects.equals(this.encoderSettings, stopChannelResponse.encoderSettings) &&
        Objects.equals(this.id, stopChannelResponse.id) &&
        Objects.equals(this.inputAttachments, stopChannelResponse.inputAttachments) &&
        Objects.equals(this.inputSpecification, stopChannelResponse.inputSpecification) &&
        Objects.equals(this.logLevel, stopChannelResponse.logLevel) &&
        Objects.equals(this.maintenance, stopChannelResponse.maintenance) &&
        Objects.equals(this.name, stopChannelResponse.name) &&
        Objects.equals(this.pipelineDetails, stopChannelResponse.pipelineDetails) &&
        Objects.equals(this.pipelinesRunningCount, stopChannelResponse.pipelinesRunningCount) &&
        Objects.equals(this.roleArn, stopChannelResponse.roleArn) &&
        Objects.equals(this.state, stopChannelResponse.state) &&
        Objects.equals(this.tags, stopChannelResponse.tags) &&
        Objects.equals(this.vpc, stopChannelResponse.vpc);
  }
  ...
  public String toString() {
    ...
    sb.append("class StopChannelResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StopChannelResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StopChannelResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StopChannelResponse is not found in the empty JSON string", StopChannelResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StopChannelResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StopChannelResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StopChannelResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StopChannelResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StopChannelResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StopChannelResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<StopChannelResponse>() {
           @Override
           public void write(JsonWriter out, StopChannelResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StopChannelResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StopChannelResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StopChannelResponse
   * @throws IOException if the JSON string is invalid with respect to StopChannelResponse
   */
  public static StopChannelResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StopChannelResponse.class);
  }

  /**
   * Convert an instance of StopChannelResponse to an JSON string
   *
   * @return JSON string
   */
