...
public class CreateChannelRequestEncoderSettingsGlobalConfiguration {
  ...
  public CreateChannelRequestEncoderSettingsGlobalConfiguration() {
  }

  public CreateChannelRequestEncoderSettingsGlobalConfiguration initialAudioGain(Integer initialAudioGain) {
  ...
  public CreateChannelRequestEncoderSettingsGlobalConfiguration inputEndAction(GlobalConfigurationInputEndAction inputEndAction) {
  ...
  public CreateChannelRequestEncoderSettingsGlobalConfiguration inputLossBehavior(GlobalConfigurationInputLossBehavior inputLossBehavior) {
  ...
  public CreateChannelRequestEncoderSettingsGlobalConfiguration outputLockingMode(GlobalConfigurationOutputLockingMode outputLockingMode) {
  ...
  public CreateChannelRequestEncoderSettingsGlobalConfiguration outputTimingSource(GlobalConfigurationOutputTimingSource outputTimingSource) {
  ...
  public CreateChannelRequestEncoderSettingsGlobalConfiguration supportLowFramerateInputs(GlobalConfigurationLowFramerateInputs supportLowFramerateInputs) {
  ...
  public boolean equals(Object o) {
    ...
    CreateChannelRequestEncoderSettingsGlobalConfiguration createChannelRequestEncoderSettingsGlobalConfiguration = (CreateChannelRequestEncoderSettingsGlobalConfiguration) o;
    return Objects.equals(this.initialAudioGain, createChannelRequestEncoderSettingsGlobalConfiguration.initialAudioGain) &&
        Objects.equals(this.inputEndAction, createChannelRequestEncoderSettingsGlobalConfiguration.inputEndAction) &&
        Objects.equals(this.inputLossBehavior, createChannelRequestEncoderSettingsGlobalConfiguration.inputLossBehavior) &&
        Objects.equals(this.outputLockingMode, createChannelRequestEncoderSettingsGlobalConfiguration.outputLockingMode) &&
        Objects.equals(this.outputTimingSource, createChannelRequestEncoderSettingsGlobalConfiguration.outputTimingSource) &&
        Objects.equals(this.supportLowFramerateInputs, createChannelRequestEncoderSettingsGlobalConfiguration.supportLowFramerateInputs);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateChannelRequestEncoderSettingsGlobalConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateChannelRequestEncoderSettingsGlobalConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateChannelRequestEncoderSettingsGlobalConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateChannelRequestEncoderSettingsGlobalConfiguration is not found in the empty JSON string", CreateChannelRequestEncoderSettingsGlobalConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateChannelRequestEncoderSettingsGlobalConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateChannelRequestEncoderSettingsGlobalConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateChannelRequestEncoderSettingsGlobalConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateChannelRequestEncoderSettingsGlobalConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateChannelRequestEncoderSettingsGlobalConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateChannelRequestEncoderSettingsGlobalConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateChannelRequestEncoderSettingsGlobalConfiguration>() {
           @Override
           public void write(JsonWriter out, CreateChannelRequestEncoderSettingsGlobalConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateChannelRequestEncoderSettingsGlobalConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateChannelRequestEncoderSettingsGlobalConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateChannelRequestEncoderSettingsGlobalConfiguration
   * @throws IOException if the JSON string is invalid with respect to CreateChannelRequestEncoderSettingsGlobalConfiguration
   */
  public static CreateChannelRequestEncoderSettingsGlobalConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateChannelRequestEncoderSettingsGlobalConfiguration.class);
  }

  /**
   * Convert an instance of CreateChannelRequestEncoderSettingsGlobalConfiguration to an JSON string
   *
   * @return JSON string
   */
