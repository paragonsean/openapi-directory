...
public class Ac3Settings {
  ...
  public Ac3Settings bitrate(Double bitrate) {
  ...
  public Ac3Settings bitstreamMode(Ac3BitstreamMode bitstreamMode) {
  ...
  public Ac3Settings codingMode(Ac3CodingMode codingMode) {
  ...
  public Ac3Settings dialnorm(Integer dialnorm) {
  ...
  public Ac3Settings drcProfile(Ac3DrcProfile drcProfile) {
  ...
  public Ac3Settings lfeFilter(Ac3LfeFilter lfeFilter) {
  ...
  public Ac3Settings metadataControl(Ac3MetadataControl metadataControl) {
  ...
  public boolean equals(Object o) {
    ...
    Ac3Settings ac3Settings = (Ac3Settings) o;
    return Objects.equals(this.bitrate, ac3Settings.bitrate) &&
        Objects.equals(this.bitstreamMode, ac3Settings.bitstreamMode) &&
        Objects.equals(this.codingMode, ac3Settings.codingMode) &&
        Objects.equals(this.dialnorm, ac3Settings.dialnorm) &&
        Objects.equals(this.drcProfile, ac3Settings.drcProfile) &&
        Objects.equals(this.lfeFilter, ac3Settings.lfeFilter) &&
        Objects.equals(this.metadataControl, ac3Settings.metadataControl);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Ac3Settings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Ac3Settings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Ac3Settings is not found in the empty JSON string", Ac3Settings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Ac3Settings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Ac3Settings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Ac3Settings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Ac3Settings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Ac3Settings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Ac3Settings.class));

       return (TypeAdapter<T>) new TypeAdapter<Ac3Settings>() {
           @Override
           public void write(JsonWriter out, Ac3Settings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Ac3Settings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Ac3Settings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Ac3Settings
   * @throws IOException if the JSON string is invalid with respect to Ac3Settings
   */
  public static Ac3Settings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Ac3Settings.class);
  }

  /**
   * Convert an instance of Ac3Settings to an JSON string
   *
   * @return JSON string
   */
