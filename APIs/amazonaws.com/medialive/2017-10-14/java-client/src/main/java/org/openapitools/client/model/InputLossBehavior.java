...
public class InputLossBehavior {
  ...
  public InputLossBehavior blackFrameMsec(Integer blackFrameMsec) {
  ...
  public InputLossBehavior inputLossImageColor(String inputLossImageColor) {
  ...
  public InputLossBehavior inputLossImageSlate(InputLossBehaviorInputLossImageSlate inputLossImageSlate) {
  ...
  public InputLossBehavior inputLossImageType(InputLossImageType inputLossImageType) {
  ...
  public InputLossBehavior repeatFrameMsec(Integer repeatFrameMsec) {
  ...
  public boolean equals(Object o) {
    ...
    InputLossBehavior inputLossBehavior = (InputLossBehavior) o;
    return Objects.equals(this.blackFrameMsec, inputLossBehavior.blackFrameMsec) &&
        Objects.equals(this.inputLossImageColor, inputLossBehavior.inputLossImageColor) &&
        Objects.equals(this.inputLossImageSlate, inputLossBehavior.inputLossImageSlate) &&
        Objects.equals(this.inputLossImageType, inputLossBehavior.inputLossImageType) &&
        Objects.equals(this.repeatFrameMsec, inputLossBehavior.repeatFrameMsec);
  }
  ...
  public String toString() {
    ...
    sb.append("class InputLossBehavior {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InputLossBehavior
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InputLossBehavior.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InputLossBehavior is not found in the empty JSON string", InputLossBehavior.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InputLossBehavior.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InputLossBehavior` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InputLossBehavior.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InputLossBehavior' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InputLossBehavior> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InputLossBehavior.class));

       return (TypeAdapter<T>) new TypeAdapter<InputLossBehavior>() {
           @Override
           public void write(JsonWriter out, InputLossBehavior value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InputLossBehavior read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InputLossBehavior given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InputLossBehavior
   * @throws IOException if the JSON string is invalid with respect to InputLossBehavior
   */
  public static InputLossBehavior fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InputLossBehavior.class);
  }

  /**
   * Convert an instance of InputLossBehavior to an JSON string
   *
   * @return JSON string
   */
