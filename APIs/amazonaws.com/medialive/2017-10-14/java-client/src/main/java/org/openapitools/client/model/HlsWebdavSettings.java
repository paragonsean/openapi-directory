...
public class HlsWebdavSettings {
  ...
  public HlsWebdavSettings() {
  }

  public HlsWebdavSettings connectionRetryInterval(Integer connectionRetryInterval) {
  ...
  public HlsWebdavSettings filecacheDuration(Integer filecacheDuration) {
  ...
  public HlsWebdavSettings httpTransferMode(HlsWebdavHttpTransferMode httpTransferMode) {
  ...
  public HlsWebdavSettings numRetries(Integer numRetries) {
  ...
  public HlsWebdavSettings restartDelay(Integer restartDelay) {
  ...
  public boolean equals(Object o) {
    ...
    HlsWebdavSettings hlsWebdavSettings = (HlsWebdavSettings) o;
    return Objects.equals(this.connectionRetryInterval, hlsWebdavSettings.connectionRetryInterval) &&
        Objects.equals(this.filecacheDuration, hlsWebdavSettings.filecacheDuration) &&
        Objects.equals(this.httpTransferMode, hlsWebdavSettings.httpTransferMode) &&
        Objects.equals(this.numRetries, hlsWebdavSettings.numRetries) &&
        Objects.equals(this.restartDelay, hlsWebdavSettings.restartDelay);
  }
  ...
  public String toString() {
    ...
    sb.append("class HlsWebdavSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to HlsWebdavSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HlsWebdavSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HlsWebdavSettings is not found in the empty JSON string", HlsWebdavSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HlsWebdavSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HlsWebdavSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HlsWebdavSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HlsWebdavSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HlsWebdavSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HlsWebdavSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<HlsWebdavSettings>() {
           @Override
           public void write(JsonWriter out, HlsWebdavSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HlsWebdavSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of HlsWebdavSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HlsWebdavSettings
   * @throws IOException if the JSON string is invalid with respect to HlsWebdavSettings
   */
  public static HlsWebdavSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HlsWebdavSettings.class);
  }

  /**
   * Convert an instance of HlsWebdavSettings to an JSON string
   *
   * @return JSON string
   */
