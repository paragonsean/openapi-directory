...
public class ScheduleActionScheduleActionSettings {
  ...
  public ScheduleActionScheduleActionSettings() {
  }

  public ScheduleActionScheduleActionSettings hlsId3SegmentTaggingSettings(ScheduleActionSettingsHlsId3SegmentTaggingSettings hlsId3SegmentTaggingSettings) {
  ...
  public ScheduleActionScheduleActionSettings hlsTimedMetadataSettings(ScheduleActionSettingsHlsTimedMetadataSettings hlsTimedMetadataSettings) {
  ...
  public ScheduleActionScheduleActionSettings inputPrepareSettings(ScheduleActionSettingsInputPrepareSettings inputPrepareSettings) {
  ...
  public ScheduleActionScheduleActionSettings inputSwitchSettings(ScheduleActionSettingsInputSwitchSettings inputSwitchSettings) {
  ...
  public ScheduleActionScheduleActionSettings motionGraphicsImageActivateSettings(ScheduleActionSettingsMotionGraphicsImageActivateSettings motionGraphicsImageActivateSettings) {
  ...
  public ScheduleActionScheduleActionSettings motionGraphicsImageDeactivateSettings(Object motionGraphicsImageDeactivateSettings) {
  ...
  public ScheduleActionScheduleActionSettings pauseStateSettings(ScheduleActionSettingsPauseStateSettings pauseStateSettings) {
  ...
  public ScheduleActionScheduleActionSettings scte35InputSettings(ScheduleActionSettingsScte35InputSettings scte35InputSettings) {
  ...
  public ScheduleActionScheduleActionSettings scte35ReturnToNetworkSettings(ScheduleActionSettingsScte35ReturnToNetworkSettings scte35ReturnToNetworkSettings) {
  ...
  public ScheduleActionScheduleActionSettings scte35SpliceInsertSettings(ScheduleActionSettingsScte35SpliceInsertSettings scte35SpliceInsertSettings) {
  ...
  public ScheduleActionScheduleActionSettings scte35TimeSignalSettings(ScheduleActionSettingsScte35TimeSignalSettings scte35TimeSignalSettings) {
  ...
  public ScheduleActionScheduleActionSettings staticImageActivateSettings(ScheduleActionSettingsStaticImageActivateSettings staticImageActivateSettings) {
  ...
  public ScheduleActionScheduleActionSettings staticImageDeactivateSettings(ScheduleActionSettingsStaticImageDeactivateSettings staticImageDeactivateSettings) {
  ...
  public boolean equals(Object o) {
    ...
    ScheduleActionScheduleActionSettings scheduleActionScheduleActionSettings = (ScheduleActionScheduleActionSettings) o;
    return Objects.equals(this.hlsId3SegmentTaggingSettings, scheduleActionScheduleActionSettings.hlsId3SegmentTaggingSettings) &&
        Objects.equals(this.hlsTimedMetadataSettings, scheduleActionScheduleActionSettings.hlsTimedMetadataSettings) &&
        Objects.equals(this.inputPrepareSettings, scheduleActionScheduleActionSettings.inputPrepareSettings) &&
        Objects.equals(this.inputSwitchSettings, scheduleActionScheduleActionSettings.inputSwitchSettings) &&
        Objects.equals(this.motionGraphicsImageActivateSettings, scheduleActionScheduleActionSettings.motionGraphicsImageActivateSettings) &&
        Objects.equals(this.motionGraphicsImageDeactivateSettings, scheduleActionScheduleActionSettings.motionGraphicsImageDeactivateSettings) &&
        Objects.equals(this.pauseStateSettings, scheduleActionScheduleActionSettings.pauseStateSettings) &&
        Objects.equals(this.scte35InputSettings, scheduleActionScheduleActionSettings.scte35InputSettings) &&
        Objects.equals(this.scte35ReturnToNetworkSettings, scheduleActionScheduleActionSettings.scte35ReturnToNetworkSettings) &&
        Objects.equals(this.scte35SpliceInsertSettings, scheduleActionScheduleActionSettings.scte35SpliceInsertSettings) &&
        Objects.equals(this.scte35TimeSignalSettings, scheduleActionScheduleActionSettings.scte35TimeSignalSettings) &&
        Objects.equals(this.staticImageActivateSettings, scheduleActionScheduleActionSettings.staticImageActivateSettings) &&
        Objects.equals(this.staticImageDeactivateSettings, scheduleActionScheduleActionSettings.staticImageDeactivateSettings);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScheduleActionScheduleActionSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScheduleActionScheduleActionSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScheduleActionScheduleActionSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScheduleActionScheduleActionSettings is not found in the empty JSON string", ScheduleActionScheduleActionSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScheduleActionScheduleActionSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScheduleActionScheduleActionSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScheduleActionScheduleActionSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScheduleActionScheduleActionSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScheduleActionScheduleActionSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScheduleActionScheduleActionSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<ScheduleActionScheduleActionSettings>() {
           @Override
           public void write(JsonWriter out, ScheduleActionScheduleActionSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScheduleActionScheduleActionSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ScheduleActionScheduleActionSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScheduleActionScheduleActionSettings
   * @throws IOException if the JSON string is invalid with respect to ScheduleActionScheduleActionSettings
   */
  public static ScheduleActionScheduleActionSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScheduleActionScheduleActionSettings.class);
  }

  /**
   * Convert an instance of ScheduleActionScheduleActionSettings to an JSON string
   *
   * @return JSON string
   */
