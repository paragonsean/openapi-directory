...
public class AutomaticInputFailoverSettings {
  ...
  public AutomaticInputFailoverSettings() {
  }

  public AutomaticInputFailoverSettings errorClearTimeMsec(Integer errorClearTimeMsec) {
  ...
  public AutomaticInputFailoverSettings failoverConditions(List failoverConditions) {
  ...
  public AutomaticInputFailoverSettings inputPreference(InputPreference inputPreference) {
  ...
  public AutomaticInputFailoverSettings secondaryInputId(String secondaryInputId) {
  ...
  public boolean equals(Object o) {
    ...
    AutomaticInputFailoverSettings automaticInputFailoverSettings = (AutomaticInputFailoverSettings) o;
    return Objects.equals(this.errorClearTimeMsec, automaticInputFailoverSettings.errorClearTimeMsec) &&
        Objects.equals(this.failoverConditions, automaticInputFailoverSettings.failoverConditions) &&
        Objects.equals(this.inputPreference, automaticInputFailoverSettings.inputPreference) &&
        Objects.equals(this.secondaryInputId, automaticInputFailoverSettings.secondaryInputId);
  }
  ...
  public String toString() {
    ...
    sb.append("class AutomaticInputFailoverSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AutomaticInputFailoverSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AutomaticInputFailoverSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AutomaticInputFailoverSettings is not found in the empty JSON string", AutomaticInputFailoverSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AutomaticInputFailoverSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AutomaticInputFailoverSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AutomaticInputFailoverSettings.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AutomaticInputFailoverSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AutomaticInputFailoverSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AutomaticInputFailoverSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AutomaticInputFailoverSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<AutomaticInputFailoverSettings>() {
           @Override
           public void write(JsonWriter out, AutomaticInputFailoverSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AutomaticInputFailoverSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AutomaticInputFailoverSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AutomaticInputFailoverSettings
   * @throws IOException if the JSON string is invalid with respect to AutomaticInputFailoverSettings
   */
  public static AutomaticInputFailoverSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AutomaticInputFailoverSettings.class);
  }

  /**
   * Convert an instance of AutomaticInputFailoverSettings to an JSON string
   *
   * @return JSON string
   */
