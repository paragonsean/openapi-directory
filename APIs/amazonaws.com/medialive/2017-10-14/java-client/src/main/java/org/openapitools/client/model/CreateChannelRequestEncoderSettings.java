...
public class CreateChannelRequestEncoderSettings {
  ...
  public CreateChannelRequestEncoderSettings() {
  }

  public CreateChannelRequestEncoderSettings audioDescriptions(List audioDescriptions) {
  ...
  public CreateChannelRequestEncoderSettings availBlanking(CreateChannelRequestEncoderSettingsAvailBlanking availBlanking) {
  ...
  public CreateChannelRequestEncoderSettings availConfiguration(CreateChannelRequestEncoderSettingsAvailConfiguration availConfiguration) {
  ...
  public CreateChannelRequestEncoderSettings blackoutSlate(CreateChannelRequestEncoderSettingsBlackoutSlate blackoutSlate) {
  ...
  public CreateChannelRequestEncoderSettings captionDescriptions(List captionDescriptions) {
  ...
  public CreateChannelRequestEncoderSettings featureActivations(CreateChannelRequestEncoderSettingsFeatureActivations featureActivations) {
  ...
  public CreateChannelRequestEncoderSettings globalConfiguration(CreateChannelRequestEncoderSettingsGlobalConfiguration globalConfiguration) {
  ...
  public CreateChannelRequestEncoderSettings motionGraphicsConfiguration(CreateChannelRequestEncoderSettingsMotionGraphicsConfiguration motionGraphicsConfiguration) {
  ...
  public CreateChannelRequestEncoderSettings nielsenConfiguration(CreateChannelRequestEncoderSettingsNielsenConfiguration nielsenConfiguration) {
  ...
  public CreateChannelRequestEncoderSettings outputGroups(List outputGroups) {
  ...
  public CreateChannelRequestEncoderSettings timecodeConfig(CreateChannelRequestEncoderSettingsTimecodeConfig timecodeConfig) {
  ...
  public CreateChannelRequestEncoderSettings videoDescriptions(List videoDescriptions) {
  ...
  public CreateChannelRequestEncoderSettings thumbnailConfiguration(CreateChannelRequestEncoderSettingsThumbnailConfiguration thumbnailConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    CreateChannelRequestEncoderSettings createChannelRequestEncoderSettings = (CreateChannelRequestEncoderSettings) o;
    return Objects.equals(this.audioDescriptions, createChannelRequestEncoderSettings.audioDescriptions) &&
        Objects.equals(this.availBlanking, createChannelRequestEncoderSettings.availBlanking) &&
        Objects.equals(this.availConfiguration, createChannelRequestEncoderSettings.availConfiguration) &&
        Objects.equals(this.blackoutSlate, createChannelRequestEncoderSettings.blackoutSlate) &&
        Objects.equals(this.captionDescriptions, createChannelRequestEncoderSettings.captionDescriptions) &&
        Objects.equals(this.featureActivations, createChannelRequestEncoderSettings.featureActivations) &&
        Objects.equals(this.globalConfiguration, createChannelRequestEncoderSettings.globalConfiguration) &&
        Objects.equals(this.motionGraphicsConfiguration, createChannelRequestEncoderSettings.motionGraphicsConfiguration) &&
        Objects.equals(this.nielsenConfiguration, createChannelRequestEncoderSettings.nielsenConfiguration) &&
        Objects.equals(this.outputGroups, createChannelRequestEncoderSettings.outputGroups) &&
        Objects.equals(this.timecodeConfig, createChannelRequestEncoderSettings.timecodeConfig) &&
        Objects.equals(this.videoDescriptions, createChannelRequestEncoderSettings.videoDescriptions) &&
        Objects.equals(this.thumbnailConfiguration, createChannelRequestEncoderSettings.thumbnailConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateChannelRequestEncoderSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateChannelRequestEncoderSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateChannelRequestEncoderSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateChannelRequestEncoderSettings is not found in the empty JSON string", CreateChannelRequestEncoderSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateChannelRequestEncoderSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateChannelRequestEncoderSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("VideoDescriptions") != null && !jsonObj.get("VideoDescriptions").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateChannelRequestEncoderSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateChannelRequestEncoderSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateChannelRequestEncoderSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateChannelRequestEncoderSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateChannelRequestEncoderSettings>() {
           @Override
           public void write(JsonWriter out, CreateChannelRequestEncoderSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateChannelRequestEncoderSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateChannelRequestEncoderSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateChannelRequestEncoderSettings
   * @throws IOException if the JSON string is invalid with respect to CreateChannelRequestEncoderSettings
   */
  public static CreateChannelRequestEncoderSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateChannelRequestEncoderSettings.class);
  }

  /**
   * Convert an instance of CreateChannelRequestEncoderSettings to an JSON string
   *
   * @return JSON string
   */
