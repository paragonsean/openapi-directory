...
public class DeleteReservationResponse {
  ...
  public DeleteReservationResponse arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public DeleteReservationResponse count(Integer count) {
    this.count = count;
    return this;
  }
  ...
  public DeleteReservationResponse currencyCode(String currencyCode) {
  ...
  public DeleteReservationResponse duration(Integer duration) {
  ...
  public DeleteReservationResponse durationUnits(OfferingDurationUnits durationUnits) {
  ...
  public DeleteReservationResponse end(String end) {
    this.end = end;
    return this;
  }
  ...
  public DeleteReservationResponse fixedPrice(Double fixedPrice) {
  ...
  public DeleteReservationResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DeleteReservationResponse offeringDescription(String offeringDescription) {
  ...
  public DeleteReservationResponse offeringId(String offeringId) {
  ...
  public DeleteReservationResponse offeringType(OfferingType offeringType) {
  ...
  public DeleteReservationResponse region(String region) {
    this.region = region;
    return this;
  }
  ...
  public DeleteReservationResponse renewalSettings(DeleteReservationResponseRenewalSettings renewalSettings) {
  ...
  public DeleteReservationResponse reservationId(String reservationId) {
  ...
  public DeleteReservationResponse resourceSpecification(DeleteReservationResponseResourceSpecification resourceSpecification) {
  ...
  public DeleteReservationResponse start(String start) {
    this.start = start;
    return this;
  }
  ...
  public DeleteReservationResponse state(ReservationState state) {
    this.state = state;
    return this;
  }
  ...
  public DeleteReservationResponse tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public DeleteReservationResponse usagePrice(Double usagePrice) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteReservationResponse deleteReservationResponse = (DeleteReservationResponse) o;
    return Objects.equals(this.arn, deleteReservationResponse.arn) &&
        Objects.equals(this.count, deleteReservationResponse.count) &&
        Objects.equals(this.currencyCode, deleteReservationResponse.currencyCode) &&
        Objects.equals(this.duration, deleteReservationResponse.duration) &&
        Objects.equals(this.durationUnits, deleteReservationResponse.durationUnits) &&
        Objects.equals(this.end, deleteReservationResponse.end) &&
        Objects.equals(this.fixedPrice, deleteReservationResponse.fixedPrice) &&
        Objects.equals(this.name, deleteReservationResponse.name) &&
        Objects.equals(this.offeringDescription, deleteReservationResponse.offeringDescription) &&
        Objects.equals(this.offeringId, deleteReservationResponse.offeringId) &&
        Objects.equals(this.offeringType, deleteReservationResponse.offeringType) &&
        Objects.equals(this.region, deleteReservationResponse.region) &&
        Objects.equals(this.renewalSettings, deleteReservationResponse.renewalSettings) &&
        Objects.equals(this.reservationId, deleteReservationResponse.reservationId) &&
        Objects.equals(this.resourceSpecification, deleteReservationResponse.resourceSpecification) &&
        Objects.equals(this.start, deleteReservationResponse.start) &&
        Objects.equals(this.state, deleteReservationResponse.state) &&
        Objects.equals(this.tags, deleteReservationResponse.tags) &&
        Objects.equals(this.usagePrice, deleteReservationResponse.usagePrice);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteReservationResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteReservationResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteReservationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteReservationResponse is not found in the empty JSON string", DeleteReservationResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteReservationResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteReservationResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteReservationResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteReservationResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteReservationResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteReservationResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteReservationResponse>() {
           @Override
           public void write(JsonWriter out, DeleteReservationResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteReservationResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteReservationResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteReservationResponse
   * @throws IOException if the JSON string is invalid with respect to DeleteReservationResponse
   */
  public static DeleteReservationResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteReservationResponse.class);
  }

  /**
   * Convert an instance of DeleteReservationResponse to an JSON string
   *
   * @return JSON string
   */
