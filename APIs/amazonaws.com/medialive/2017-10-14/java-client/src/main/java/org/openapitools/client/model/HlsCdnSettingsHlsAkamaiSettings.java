...
public class HlsCdnSettingsHlsAkamaiSettings {
  ...
  public HlsCdnSettingsHlsAkamaiSettings() {
  }

  public HlsCdnSettingsHlsAkamaiSettings connectionRetryInterval(Integer connectionRetryInterval) {
  ...
  public HlsCdnSettingsHlsAkamaiSettings filecacheDuration(Integer filecacheDuration) {
  ...
  public HlsCdnSettingsHlsAkamaiSettings httpTransferMode(HlsAkamaiHttpTransferMode httpTransferMode) {
  ...
  public HlsCdnSettingsHlsAkamaiSettings numRetries(Integer numRetries) {
  ...
  public HlsCdnSettingsHlsAkamaiSettings restartDelay(Integer restartDelay) {
  ...
  public HlsCdnSettingsHlsAkamaiSettings salt(String salt) {
    this.salt = salt;
    return this;
  }
  ...
  public HlsCdnSettingsHlsAkamaiSettings token(String token) {
    this.token = token;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    HlsCdnSettingsHlsAkamaiSettings hlsCdnSettingsHlsAkamaiSettings = (HlsCdnSettingsHlsAkamaiSettings) o;
    return Objects.equals(this.connectionRetryInterval, hlsCdnSettingsHlsAkamaiSettings.connectionRetryInterval) &&
        Objects.equals(this.filecacheDuration, hlsCdnSettingsHlsAkamaiSettings.filecacheDuration) &&
        Objects.equals(this.httpTransferMode, hlsCdnSettingsHlsAkamaiSettings.httpTransferMode) &&
        Objects.equals(this.numRetries, hlsCdnSettingsHlsAkamaiSettings.numRetries) &&
        Objects.equals(this.restartDelay, hlsCdnSettingsHlsAkamaiSettings.restartDelay) &&
        Objects.equals(this.salt, hlsCdnSettingsHlsAkamaiSettings.salt) &&
        Objects.equals(this.token, hlsCdnSettingsHlsAkamaiSettings.token);
  }
  ...
  public String toString() {
    ...
    sb.append("class HlsCdnSettingsHlsAkamaiSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to HlsCdnSettingsHlsAkamaiSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HlsCdnSettingsHlsAkamaiSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HlsCdnSettingsHlsAkamaiSettings is not found in the empty JSON string", HlsCdnSettingsHlsAkamaiSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HlsCdnSettingsHlsAkamaiSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HlsCdnSettingsHlsAkamaiSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HlsCdnSettingsHlsAkamaiSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HlsCdnSettingsHlsAkamaiSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HlsCdnSettingsHlsAkamaiSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HlsCdnSettingsHlsAkamaiSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<HlsCdnSettingsHlsAkamaiSettings>() {
           @Override
           public void write(JsonWriter out, HlsCdnSettingsHlsAkamaiSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HlsCdnSettingsHlsAkamaiSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of HlsCdnSettingsHlsAkamaiSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HlsCdnSettingsHlsAkamaiSettings
   * @throws IOException if the JSON string is invalid with respect to HlsCdnSettingsHlsAkamaiSettings
   */
  public static HlsCdnSettingsHlsAkamaiSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HlsCdnSettingsHlsAkamaiSettings.class);
  }

  /**
   * Convert an instance of HlsCdnSettingsHlsAkamaiSettings to an JSON string
   *
   * @return JSON string
   */
