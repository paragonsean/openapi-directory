...
public class Eac3Settings {
  ...
  public Eac3Settings attenuationControl(Eac3AttenuationControl attenuationControl) {
  ...
  public Eac3Settings bitrate(Double bitrate) {
  ...
  public Eac3Settings bitstreamMode(Eac3BitstreamMode bitstreamMode) {
  ...
  public Eac3Settings codingMode(Eac3CodingMode codingMode) {
  ...
  public Eac3Settings dcFilter(Eac3DcFilter dcFilter) {
  ...
  public Eac3Settings dialnorm(Integer dialnorm) {
  ...
  public Eac3Settings drcLine(Eac3DrcLine drcLine) {
  ...
  public Eac3Settings drcRf(Eac3DrcRf drcRf) {
    this.drcRf = drcRf;
    return this;
  }
  ...
  public Eac3Settings lfeControl(Eac3LfeControl lfeControl) {
  ...
  public Eac3Settings lfeFilter(Eac3LfeFilter lfeFilter) {
  ...
  public Eac3Settings loRoCenterMixLevel(Double loRoCenterMixLevel) {
  ...
  public Eac3Settings loRoSurroundMixLevel(Double loRoSurroundMixLevel) {
  ...
  public Eac3Settings ltRtCenterMixLevel(Double ltRtCenterMixLevel) {
  ...
  public Eac3Settings ltRtSurroundMixLevel(Double ltRtSurroundMixLevel) {
  ...
  public Eac3Settings metadataControl(Eac3MetadataControl metadataControl) {
  ...
  public Eac3Settings passthroughControl(Eac3PassthroughControl passthroughControl) {
  ...
  public Eac3Settings phaseControl(Eac3PhaseControl phaseControl) {
  ...
  public Eac3Settings stereoDownmix(Eac3StereoDownmix stereoDownmix) {
  ...
  public Eac3Settings surroundExMode(Eac3SurroundExMode surroundExMode) {
  ...
  public Eac3Settings surroundMode(Eac3SurroundMode surroundMode) {
  ...
  public boolean equals(Object o) {
    ...
    Eac3Settings eac3Settings = (Eac3Settings) o;
    return Objects.equals(this.attenuationControl, eac3Settings.attenuationControl) &&
        Objects.equals(this.bitrate, eac3Settings.bitrate) &&
        Objects.equals(this.bitstreamMode, eac3Settings.bitstreamMode) &&
        Objects.equals(this.codingMode, eac3Settings.codingMode) &&
        Objects.equals(this.dcFilter, eac3Settings.dcFilter) &&
        Objects.equals(this.dialnorm, eac3Settings.dialnorm) &&
        Objects.equals(this.drcLine, eac3Settings.drcLine) &&
        Objects.equals(this.drcRf, eac3Settings.drcRf) &&
        Objects.equals(this.lfeControl, eac3Settings.lfeControl) &&
        Objects.equals(this.lfeFilter, eac3Settings.lfeFilter) &&
        Objects.equals(this.loRoCenterMixLevel, eac3Settings.loRoCenterMixLevel) &&
        Objects.equals(this.loRoSurroundMixLevel, eac3Settings.loRoSurroundMixLevel) &&
        Objects.equals(this.ltRtCenterMixLevel, eac3Settings.ltRtCenterMixLevel) &&
        Objects.equals(this.ltRtSurroundMixLevel, eac3Settings.ltRtSurroundMixLevel) &&
        Objects.equals(this.metadataControl, eac3Settings.metadataControl) &&
        Objects.equals(this.passthroughControl, eac3Settings.passthroughControl) &&
        Objects.equals(this.phaseControl, eac3Settings.phaseControl) &&
        Objects.equals(this.stereoDownmix, eac3Settings.stereoDownmix) &&
        Objects.equals(this.surroundExMode, eac3Settings.surroundExMode) &&
        Objects.equals(this.surroundMode, eac3Settings.surroundMode);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Eac3Settings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Eac3Settings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Eac3Settings is not found in the empty JSON string", Eac3Settings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Eac3Settings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Eac3Settings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Eac3Settings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Eac3Settings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Eac3Settings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Eac3Settings.class));

       return (TypeAdapter<T>) new TypeAdapter<Eac3Settings>() {
           @Override
           public void write(JsonWriter out, Eac3Settings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Eac3Settings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Eac3Settings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Eac3Settings
   * @throws IOException if the JSON string is invalid with respect to Eac3Settings
   */
  public static Eac3Settings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Eac3Settings.class);
  }

  /**
   * Convert an instance of Eac3Settings to an JSON string
   *
   * @return JSON string
   */
