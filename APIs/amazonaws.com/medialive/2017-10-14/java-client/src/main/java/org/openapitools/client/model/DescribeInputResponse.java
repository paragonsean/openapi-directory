...
public class DescribeInputResponse {
  ...
  public DescribeInputResponse arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public DescribeInputResponse attachedChannels(List attachedChannels) {
  ...
  public DescribeInputResponse destinations(List destinations) {
  ...
  public DescribeInputResponse id(String id) {
    this.id = id;
    return this;
  }
  ...
  public DescribeInputResponse inputClass(InputClass inputClass) {
  ...
  public DescribeInputResponse inputDevices(List inputDevices) {
  ...
  public DescribeInputResponse inputPartnerIds(List inputPartnerIds) {
  ...
  public DescribeInputResponse inputSourceType(InputSourceType inputSourceType) {
  ...
  public DescribeInputResponse mediaConnectFlows(List mediaConnectFlows) {
  ...
  public DescribeInputResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DescribeInputResponse roleArn(String roleArn) {
  ...
  public DescribeInputResponse securityGroups(List securityGroups) {
  ...
  public DescribeInputResponse sources(List sources) {
  ...
  public DescribeInputResponse state(InputState state) {
    this.state = state;
    return this;
  }
  ...
  public DescribeInputResponse tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public DescribeInputResponse type(InputType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeInputResponse describeInputResponse = (DescribeInputResponse) o;
    return Objects.equals(this.arn, describeInputResponse.arn) &&
        Objects.equals(this.attachedChannels, describeInputResponse.attachedChannels) &&
        Objects.equals(this.destinations, describeInputResponse.destinations) &&
        Objects.equals(this.id, describeInputResponse.id) &&
        Objects.equals(this.inputClass, describeInputResponse.inputClass) &&
        Objects.equals(this.inputDevices, describeInputResponse.inputDevices) &&
        Objects.equals(this.inputPartnerIds, describeInputResponse.inputPartnerIds) &&
        Objects.equals(this.inputSourceType, describeInputResponse.inputSourceType) &&
        Objects.equals(this.mediaConnectFlows, describeInputResponse.mediaConnectFlows) &&
        Objects.equals(this.name, describeInputResponse.name) &&
        Objects.equals(this.roleArn, describeInputResponse.roleArn) &&
        Objects.equals(this.securityGroups, describeInputResponse.securityGroups) &&
        Objects.equals(this.sources, describeInputResponse.sources) &&
        Objects.equals(this.state, describeInputResponse.state) &&
        Objects.equals(this.tags, describeInputResponse.tags) &&
        Objects.equals(this.type, describeInputResponse.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeInputResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeInputResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeInputResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeInputResponse is not found in the empty JSON string", DescribeInputResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeInputResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeInputResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeInputResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeInputResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeInputResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeInputResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeInputResponse>() {
           @Override
           public void write(JsonWriter out, DescribeInputResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeInputResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeInputResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeInputResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeInputResponse
   */
  public static DescribeInputResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeInputResponse.class);
  }

  /**
   * Convert an instance of DescribeInputResponse to an JSON string
   *
   * @return JSON string
   */
