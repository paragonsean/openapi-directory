...
public class AudioSelectorSelectorSettings {
  ...
  public AudioSelectorSelectorSettings() {
  }

  public AudioSelectorSelectorSettings audioHlsRenditionSelection(AudioSelectorSettingsAudioHlsRenditionSelection audioHlsRenditionSelection) {
  ...
  public AudioSelectorSelectorSettings audioLanguageSelection(AudioSelectorSettingsAudioLanguageSelection audioLanguageSelection) {
  ...
  public AudioSelectorSelectorSettings audioPidSelection(AudioSelectorSettingsAudioPidSelection audioPidSelection) {
  ...
  public AudioSelectorSelectorSettings audioTrackSelection(AudioSelectorSettingsAudioTrackSelection audioTrackSelection) {
  ...
  public boolean equals(Object o) {
    ...
    AudioSelectorSelectorSettings audioSelectorSelectorSettings = (AudioSelectorSelectorSettings) o;
    return Objects.equals(this.audioHlsRenditionSelection, audioSelectorSelectorSettings.audioHlsRenditionSelection) &&
        Objects.equals(this.audioLanguageSelection, audioSelectorSelectorSettings.audioLanguageSelection) &&
        Objects.equals(this.audioPidSelection, audioSelectorSelectorSettings.audioPidSelection) &&
        Objects.equals(this.audioTrackSelection, audioSelectorSelectorSettings.audioTrackSelection);
  }
  ...
  public String toString() {
    ...
    sb.append("class AudioSelectorSelectorSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AudioSelectorSelectorSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AudioSelectorSelectorSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AudioSelectorSelectorSettings is not found in the empty JSON string", AudioSelectorSelectorSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AudioSelectorSelectorSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AudioSelectorSelectorSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AudioSelectorSelectorSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AudioSelectorSelectorSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AudioSelectorSelectorSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AudioSelectorSelectorSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<AudioSelectorSelectorSettings>() {
           @Override
           public void write(JsonWriter out, AudioSelectorSelectorSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AudioSelectorSelectorSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AudioSelectorSelectorSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AudioSelectorSelectorSettings
   * @throws IOException if the JSON string is invalid with respect to AudioSelectorSelectorSettings
   */
  public static AudioSelectorSelectorSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AudioSelectorSelectorSettings.class);
  }

  /**
   * Convert an instance of AudioSelectorSelectorSettings to an JSON string
   *
   * @return JSON string
   */
