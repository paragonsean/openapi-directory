...
public class RtmpGroupSettings {
  ...
  public RtmpGroupSettings() {
  }

  public RtmpGroupSettings adMarkers(List adMarkers) {
  ...
  public RtmpGroupSettings authenticationScheme(AuthenticationScheme authenticationScheme) {
  ...
  public RtmpGroupSettings cacheFullBehavior(RtmpCacheFullBehavior cacheFullBehavior) {
  ...
  public RtmpGroupSettings cacheLength(Integer cacheLength) {
  ...
  public RtmpGroupSettings captionData(RtmpCaptionData captionData) {
  ...
  public RtmpGroupSettings inputLossAction(InputLossActionForRtmpOut inputLossAction) {
  ...
  public RtmpGroupSettings restartDelay(Integer restartDelay) {
  ...
  public boolean equals(Object o) {
    ...
    RtmpGroupSettings rtmpGroupSettings = (RtmpGroupSettings) o;
    return Objects.equals(this.adMarkers, rtmpGroupSettings.adMarkers) &&
        Objects.equals(this.authenticationScheme, rtmpGroupSettings.authenticationScheme) &&
        Objects.equals(this.cacheFullBehavior, rtmpGroupSettings.cacheFullBehavior) &&
        Objects.equals(this.cacheLength, rtmpGroupSettings.cacheLength) &&
        Objects.equals(this.captionData, rtmpGroupSettings.captionData) &&
        Objects.equals(this.inputLossAction, rtmpGroupSettings.inputLossAction) &&
        Objects.equals(this.restartDelay, rtmpGroupSettings.restartDelay);
  }
  ...
  public String toString() {
    ...
    sb.append("class RtmpGroupSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RtmpGroupSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RtmpGroupSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RtmpGroupSettings is not found in the empty JSON string", RtmpGroupSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RtmpGroupSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RtmpGroupSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RtmpGroupSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RtmpGroupSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RtmpGroupSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RtmpGroupSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<RtmpGroupSettings>() {
           @Override
           public void write(JsonWriter out, RtmpGroupSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RtmpGroupSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RtmpGroupSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RtmpGroupSettings
   * @throws IOException if the JSON string is invalid with respect to RtmpGroupSettings
   */
  public static RtmpGroupSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RtmpGroupSettings.class);
  }

  /**
   * Convert an instance of RtmpGroupSettings to an JSON string
   *
   * @return JSON string
   */
