...
public class CreateInputResponseInput {
  ...
  public CreateInputResponseInput() {
  }

  public CreateInputResponseInput arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public CreateInputResponseInput attachedChannels(List attachedChannels) {
  ...
  public CreateInputResponseInput destinations(List destinations) {
  ...
  public CreateInputResponseInput id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CreateInputResponseInput inputClass(InputClass inputClass) {
  ...
  public CreateInputResponseInput inputDevices(List inputDevices) {
  ...
  public CreateInputResponseInput inputPartnerIds(List inputPartnerIds) {
  ...
  public CreateInputResponseInput inputSourceType(InputSourceType inputSourceType) {
  ...
  public CreateInputResponseInput mediaConnectFlows(List mediaConnectFlows) {
  ...
  public CreateInputResponseInput name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateInputResponseInput roleArn(String roleArn) {
  ...
  public CreateInputResponseInput securityGroups(List securityGroups) {
  ...
  public CreateInputResponseInput sources(List sources) {
  ...
  public CreateInputResponseInput state(InputState state) {
    this.state = state;
    return this;
  }
  ...
  public CreateInputResponseInput tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public CreateInputResponseInput type(InputType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateInputResponseInput createInputResponseInput = (CreateInputResponseInput) o;
    return Objects.equals(this.arn, createInputResponseInput.arn) &&
        Objects.equals(this.attachedChannels, createInputResponseInput.attachedChannels) &&
        Objects.equals(this.destinations, createInputResponseInput.destinations) &&
        Objects.equals(this.id, createInputResponseInput.id) &&
        Objects.equals(this.inputClass, createInputResponseInput.inputClass) &&
        Objects.equals(this.inputDevices, createInputResponseInput.inputDevices) &&
        Objects.equals(this.inputPartnerIds, createInputResponseInput.inputPartnerIds) &&
        Objects.equals(this.inputSourceType, createInputResponseInput.inputSourceType) &&
        Objects.equals(this.mediaConnectFlows, createInputResponseInput.mediaConnectFlows) &&
        Objects.equals(this.name, createInputResponseInput.name) &&
        Objects.equals(this.roleArn, createInputResponseInput.roleArn) &&
        Objects.equals(this.securityGroups, createInputResponseInput.securityGroups) &&
        Objects.equals(this.sources, createInputResponseInput.sources) &&
        Objects.equals(this.state, createInputResponseInput.state) &&
        Objects.equals(this.tags, createInputResponseInput.tags) &&
        Objects.equals(this.type, createInputResponseInput.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateInputResponseInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateInputResponseInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateInputResponseInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateInputResponseInput is not found in the empty JSON string", CreateInputResponseInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateInputResponseInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateInputResponseInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateInputResponseInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateInputResponseInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateInputResponseInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateInputResponseInput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateInputResponseInput>() {
           @Override
           public void write(JsonWriter out, CreateInputResponseInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateInputResponseInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateInputResponseInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateInputResponseInput
   * @throws IOException if the JSON string is invalid with respect to CreateInputResponseInput
   */
  public static CreateInputResponseInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateInputResponseInput.class);
  }

  /**
   * Convert an instance of CreateInputResponseInput to an JSON string
   *
   * @return JSON string
   */
