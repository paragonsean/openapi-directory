...
public class H265Settings {
  ...
  public H265Settings adaptiveQuantization(H265AdaptiveQuantization adaptiveQuantization) {
  ...
  public H265Settings afdSignaling(AfdSignaling afdSignaling) {
  ...
  public H265Settings alternativeTransferFunction(H265AlternativeTransferFunction alternativeTransferFunction) {
  ...
  public H265Settings bitrate(Integer bitrate) {
  ...
  public H265Settings bufSize(Integer bufSize) {
  ...
  public H265Settings colorMetadata(H265ColorMetadata colorMetadata) {
  ...
  public H265Settings colorSpaceSettings(H265SettingsColorSpaceSettings colorSpaceSettings) {
  ...
  public H265Settings filterSettings(H265SettingsFilterSettings filterSettings) {
  ...
  public H265Settings fixedAfd(FixedAfd fixedAfd) {
  ...
  public H265Settings flickerAq(H265FlickerAq flickerAq) {
  ...
  public H265Settings framerateDenominator(Integer framerateDenominator) {
  ...
  public H265Settings framerateNumerator(Integer framerateNumerator) {
  ...
  public H265Settings gopClosedCadence(Integer gopClosedCadence) {
  ...
  public H265Settings gopSize(Double gopSize) {
  ...
  public H265Settings gopSizeUnits(H265GopSizeUnits gopSizeUnits) {
  ...
  public H265Settings level(H265Level level) {
    this.level = level;
    return this;
  }
  ...
  public H265Settings lookAheadRateControl(H265LookAheadRateControl lookAheadRateControl) {
  ...
  public H265Settings maxBitrate(Integer maxBitrate) {
  ...
  public H265Settings minIInterval(Integer minIInterval) {
  ...
  public H265Settings parDenominator(Integer parDenominator) {
  ...
  public H265Settings parNumerator(Integer parNumerator) {
  ...
  public H265Settings profile(H265Profile profile) {
  ...
  public H265Settings qvbrQualityLevel(Integer qvbrQualityLevel) {
  ...
  public H265Settings rateControlMode(H265RateControlMode rateControlMode) {
  ...
  public H265Settings scanType(H265ScanType scanType) {
  ...
  public H265Settings sceneChangeDetect(H265SceneChangeDetect sceneChangeDetect) {
  ...
  public H265Settings slices(Integer slices) {
    this.slices = slices;
    return this;
  }
  ...
  public H265Settings tier(H265Tier tier) {
    this.tier = tier;
    return this;
  }
  ...
  public H265Settings timecodeInsertion(H265TimecodeInsertionBehavior timecodeInsertion) {
  ...
  public H265Settings timecodeBurninSettings(FrameCaptureSettingsTimecodeBurninSettings timecodeBurninSettings) {
  ...
  public boolean equals(Object o) {
    ...
    H265Settings h265Settings = (H265Settings) o;
    return Objects.equals(this.adaptiveQuantization, h265Settings.adaptiveQuantization) &&
        Objects.equals(this.afdSignaling, h265Settings.afdSignaling) &&
        Objects.equals(this.alternativeTransferFunction, h265Settings.alternativeTransferFunction) &&
        Objects.equals(this.bitrate, h265Settings.bitrate) &&
        Objects.equals(this.bufSize, h265Settings.bufSize) &&
        Objects.equals(this.colorMetadata, h265Settings.colorMetadata) &&
        Objects.equals(this.colorSpaceSettings, h265Settings.colorSpaceSettings) &&
        Objects.equals(this.filterSettings, h265Settings.filterSettings) &&
        Objects.equals(this.fixedAfd, h265Settings.fixedAfd) &&
        Objects.equals(this.flickerAq, h265Settings.flickerAq) &&
        Objects.equals(this.framerateDenominator, h265Settings.framerateDenominator) &&
        Objects.equals(this.framerateNumerator, h265Settings.framerateNumerator) &&
        Objects.equals(this.gopClosedCadence, h265Settings.gopClosedCadence) &&
        Objects.equals(this.gopSize, h265Settings.gopSize) &&
        Objects.equals(this.gopSizeUnits, h265Settings.gopSizeUnits) &&
        Objects.equals(this.level, h265Settings.level) &&
        Objects.equals(this.lookAheadRateControl, h265Settings.lookAheadRateControl) &&
        Objects.equals(this.maxBitrate, h265Settings.maxBitrate) &&
        Objects.equals(this.minIInterval, h265Settings.minIInterval) &&
        Objects.equals(this.parDenominator, h265Settings.parDenominator) &&
        Objects.equals(this.parNumerator, h265Settings.parNumerator) &&
        Objects.equals(this.profile, h265Settings.profile) &&
        Objects.equals(this.qvbrQualityLevel, h265Settings.qvbrQualityLevel) &&
        Objects.equals(this.rateControlMode, h265Settings.rateControlMode) &&
        Objects.equals(this.scanType, h265Settings.scanType) &&
        Objects.equals(this.sceneChangeDetect, h265Settings.sceneChangeDetect) &&
        Objects.equals(this.slices, h265Settings.slices) &&
        Objects.equals(this.tier, h265Settings.tier) &&
        Objects.equals(this.timecodeInsertion, h265Settings.timecodeInsertion) &&
        Objects.equals(this.timecodeBurninSettings, h265Settings.timecodeBurninSettings);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to H265Settings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!H265Settings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in H265Settings is not found in the empty JSON string", H265Settings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!H265Settings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `H265Settings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : H265Settings.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!H265Settings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'H265Settings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<H265Settings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(H265Settings.class));

       return (TypeAdapter<T>) new TypeAdapter<H265Settings>() {
           @Override
           public void write(JsonWriter out, H265Settings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public H265Settings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of H265Settings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of H265Settings
   * @throws IOException if the JSON string is invalid with respect to H265Settings
   */
  public static H265Settings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, H265Settings.class);
  }

  /**
   * Convert an instance of H265Settings to an JSON string
   *
   * @return JSON string
   */
