...
public class StartChannelResponse {
  ...
  public StartChannelResponse() {
  }

  public StartChannelResponse arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public StartChannelResponse cdiInputSpecification(DeleteChannelResponseCdiInputSpecification cdiInputSpecification) {
  ...
  public StartChannelResponse channelClass(ChannelClass channelClass) {
  ...
  public StartChannelResponse destinations(List destinations) {
  ...
  public StartChannelResponse egressEndpoints(List egressEndpoints) {
  ...
  public StartChannelResponse encoderSettings(DeleteChannelResponseEncoderSettings encoderSettings) {
  ...
  public StartChannelResponse id(String id) {
    this.id = id;
    return this;
  }
  ...
  public StartChannelResponse inputAttachments(List inputAttachments) {
  ...
  public StartChannelResponse inputSpecification(DeleteChannelResponseInputSpecification inputSpecification) {
  ...
  public StartChannelResponse logLevel(LogLevel logLevel) {
  ...
  public StartChannelResponse maintenance(DeleteChannelResponseMaintenance maintenance) {
  ...
  public StartChannelResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  public StartChannelResponse pipelineDetails(List pipelineDetails) {
  ...
  public StartChannelResponse pipelinesRunningCount(Integer pipelinesRunningCount) {
  ...
  public StartChannelResponse roleArn(String roleArn) {
  ...
  public StartChannelResponse state(ChannelState state) {
    this.state = state;
    return this;
  }
  ...
  public StartChannelResponse tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public StartChannelResponse vpc(DeleteChannelResponseVpc vpc) {
    this.vpc = vpc;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StartChannelResponse startChannelResponse = (StartChannelResponse) o;
    return Objects.equals(this.arn, startChannelResponse.arn) &&
        Objects.equals(this.cdiInputSpecification, startChannelResponse.cdiInputSpecification) &&
        Objects.equals(this.channelClass, startChannelResponse.channelClass) &&
        Objects.equals(this.destinations, startChannelResponse.destinations) &&
        Objects.equals(this.egressEndpoints, startChannelResponse.egressEndpoints) &&
        Objects.equals(this.encoderSettings, startChannelResponse.encoderSettings) &&
        Objects.equals(this.id, startChannelResponse.id) &&
        Objects.equals(this.inputAttachments, startChannelResponse.inputAttachments) &&
        Objects.equals(this.inputSpecification, startChannelResponse.inputSpecification) &&
        Objects.equals(this.logLevel, startChannelResponse.logLevel) &&
        Objects.equals(this.maintenance, startChannelResponse.maintenance) &&
        Objects.equals(this.name, startChannelResponse.name) &&
        Objects.equals(this.pipelineDetails, startChannelResponse.pipelineDetails) &&
        Objects.equals(this.pipelinesRunningCount, startChannelResponse.pipelinesRunningCount) &&
        Objects.equals(this.roleArn, startChannelResponse.roleArn) &&
        Objects.equals(this.state, startChannelResponse.state) &&
        Objects.equals(this.tags, startChannelResponse.tags) &&
        Objects.equals(this.vpc, startChannelResponse.vpc);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartChannelResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartChannelResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartChannelResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartChannelResponse is not found in the empty JSON string", StartChannelResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartChannelResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartChannelResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartChannelResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartChannelResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartChannelResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartChannelResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<StartChannelResponse>() {
           @Override
           public void write(JsonWriter out, StartChannelResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartChannelResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartChannelResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartChannelResponse
   * @throws IOException if the JSON string is invalid with respect to StartChannelResponse
   */
  public static StartChannelResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartChannelResponse.class);
  }

  /**
   * Convert an instance of StartChannelResponse to an JSON string
   *
   * @return JSON string
   */
