...
public class DeleteMultiplexProgramResponsePacketIdentifiersMap {
  ...
  public DeleteMultiplexProgramResponsePacketIdentifiersMap() {
  }

  public DeleteMultiplexProgramResponsePacketIdentifiersMap audioPids(List audioPids) {
  ...
  public DeleteMultiplexProgramResponsePacketIdentifiersMap dvbSubPids(List dvbSubPids) {
  ...
  public DeleteMultiplexProgramResponsePacketIdentifiersMap dvbTeletextPid(Integer dvbTeletextPid) {
  ...
  public DeleteMultiplexProgramResponsePacketIdentifiersMap etvPlatformPid(Integer etvPlatformPid) {
  ...
  public DeleteMultiplexProgramResponsePacketIdentifiersMap etvSignalPid(Integer etvSignalPid) {
  ...
  public DeleteMultiplexProgramResponsePacketIdentifiersMap klvDataPids(List klvDataPids) {
  ...
  public DeleteMultiplexProgramResponsePacketIdentifiersMap pcrPid(Integer pcrPid) {
    this.pcrPid = pcrPid;
    return this;
  }
  ...
  public DeleteMultiplexProgramResponsePacketIdentifiersMap pmtPid(Integer pmtPid) {
    this.pmtPid = pmtPid;
    return this;
  }
  ...
  public DeleteMultiplexProgramResponsePacketIdentifiersMap privateMetadataPid(Integer privateMetadataPid) {
  ...
  public DeleteMultiplexProgramResponsePacketIdentifiersMap scte27Pids(List scte27Pids) {
  ...
  public DeleteMultiplexProgramResponsePacketIdentifiersMap scte35Pid(Integer scte35Pid) {
  ...
  public DeleteMultiplexProgramResponsePacketIdentifiersMap timedMetadataPid(Integer timedMetadataPid) {
  ...
  public DeleteMultiplexProgramResponsePacketIdentifiersMap videoPid(Integer videoPid) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteMultiplexProgramResponsePacketIdentifiersMap deleteMultiplexProgramResponsePacketIdentifiersMap = (DeleteMultiplexProgramResponsePacketIdentifiersMap) o;
    return Objects.equals(this.audioPids, deleteMultiplexProgramResponsePacketIdentifiersMap.audioPids) &&
        Objects.equals(this.dvbSubPids, deleteMultiplexProgramResponsePacketIdentifiersMap.dvbSubPids) &&
        Objects.equals(this.dvbTeletextPid, deleteMultiplexProgramResponsePacketIdentifiersMap.dvbTeletextPid) &&
        Objects.equals(this.etvPlatformPid, deleteMultiplexProgramResponsePacketIdentifiersMap.etvPlatformPid) &&
        Objects.equals(this.etvSignalPid, deleteMultiplexProgramResponsePacketIdentifiersMap.etvSignalPid) &&
        Objects.equals(this.klvDataPids, deleteMultiplexProgramResponsePacketIdentifiersMap.klvDataPids) &&
        Objects.equals(this.pcrPid, deleteMultiplexProgramResponsePacketIdentifiersMap.pcrPid) &&
        Objects.equals(this.pmtPid, deleteMultiplexProgramResponsePacketIdentifiersMap.pmtPid) &&
        Objects.equals(this.privateMetadataPid, deleteMultiplexProgramResponsePacketIdentifiersMap.privateMetadataPid) &&
        Objects.equals(this.scte27Pids, deleteMultiplexProgramResponsePacketIdentifiersMap.scte27Pids) &&
        Objects.equals(this.scte35Pid, deleteMultiplexProgramResponsePacketIdentifiersMap.scte35Pid) &&
        Objects.equals(this.timedMetadataPid, deleteMultiplexProgramResponsePacketIdentifiersMap.timedMetadataPid) &&
        Objects.equals(this.videoPid, deleteMultiplexProgramResponsePacketIdentifiersMap.videoPid);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteMultiplexProgramResponsePacketIdentifiersMap {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteMultiplexProgramResponsePacketIdentifiersMap
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteMultiplexProgramResponsePacketIdentifiersMap.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteMultiplexProgramResponsePacketIdentifiersMap is not found in the empty JSON string", DeleteMultiplexProgramResponsePacketIdentifiersMap.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteMultiplexProgramResponsePacketIdentifiersMap.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteMultiplexProgramResponsePacketIdentifiersMap` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteMultiplexProgramResponsePacketIdentifiersMap.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteMultiplexProgramResponsePacketIdentifiersMap' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteMultiplexProgramResponsePacketIdentifiersMap> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteMultiplexProgramResponsePacketIdentifiersMap.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteMultiplexProgramResponsePacketIdentifiersMap>() {
           @Override
           public void write(JsonWriter out, DeleteMultiplexProgramResponsePacketIdentifiersMap value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteMultiplexProgramResponsePacketIdentifiersMap read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteMultiplexProgramResponsePacketIdentifiersMap given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteMultiplexProgramResponsePacketIdentifiersMap
   * @throws IOException if the JSON string is invalid with respect to DeleteMultiplexProgramResponsePacketIdentifiersMap
   */
  public static DeleteMultiplexProgramResponsePacketIdentifiersMap fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteMultiplexProgramResponsePacketIdentifiersMap.class);
  }

  /**
   * Convert an instance of DeleteMultiplexProgramResponsePacketIdentifiersMap to an JSON string
   *
   * @return JSON string
   */
