...
public class CaptionSelectorSelectorSettings {
  ...
  public CaptionSelectorSelectorSettings() {
  }

  public CaptionSelectorSelectorSettings ancillarySourceSettings(CaptionSelectorSettingsAncillarySourceSettings ancillarySourceSettings) {
  ...
  public CaptionSelectorSelectorSettings aribSourceSettings(Object aribSourceSettings) {
  ...
  public CaptionSelectorSelectorSettings dvbSubSourceSettings(CaptionSelectorSettingsDvbSubSourceSettings dvbSubSourceSettings) {
  ...
  public CaptionSelectorSelectorSettings embeddedSourceSettings(CaptionSelectorSettingsEmbeddedSourceSettings embeddedSourceSettings) {
  ...
  public CaptionSelectorSelectorSettings scte20SourceSettings(CaptionSelectorSettingsScte20SourceSettings scte20SourceSettings) {
  ...
  public CaptionSelectorSelectorSettings scte27SourceSettings(CaptionSelectorSettingsScte27SourceSettings scte27SourceSettings) {
  ...
  public CaptionSelectorSelectorSettings teletextSourceSettings(CaptionSelectorSettingsTeletextSourceSettings teletextSourceSettings) {
  ...
  public boolean equals(Object o) {
    ...
    CaptionSelectorSelectorSettings captionSelectorSelectorSettings = (CaptionSelectorSelectorSettings) o;
    return Objects.equals(this.ancillarySourceSettings, captionSelectorSelectorSettings.ancillarySourceSettings) &&
        Objects.equals(this.aribSourceSettings, captionSelectorSelectorSettings.aribSourceSettings) &&
        Objects.equals(this.dvbSubSourceSettings, captionSelectorSelectorSettings.dvbSubSourceSettings) &&
        Objects.equals(this.embeddedSourceSettings, captionSelectorSelectorSettings.embeddedSourceSettings) &&
        Objects.equals(this.scte20SourceSettings, captionSelectorSelectorSettings.scte20SourceSettings) &&
        Objects.equals(this.scte27SourceSettings, captionSelectorSelectorSettings.scte27SourceSettings) &&
        Objects.equals(this.teletextSourceSettings, captionSelectorSelectorSettings.teletextSourceSettings);
  }
  ...
  public String toString() {
    ...
    sb.append("class CaptionSelectorSelectorSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CaptionSelectorSelectorSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CaptionSelectorSelectorSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CaptionSelectorSelectorSettings is not found in the empty JSON string", CaptionSelectorSelectorSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CaptionSelectorSelectorSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CaptionSelectorSelectorSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CaptionSelectorSelectorSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CaptionSelectorSelectorSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CaptionSelectorSelectorSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CaptionSelectorSelectorSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<CaptionSelectorSelectorSettings>() {
           @Override
           public void write(JsonWriter out, CaptionSelectorSelectorSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CaptionSelectorSelectorSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CaptionSelectorSelectorSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CaptionSelectorSelectorSettings
   * @throws IOException if the JSON string is invalid with respect to CaptionSelectorSelectorSettings
   */
  public static CaptionSelectorSelectorSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CaptionSelectorSelectorSettings.class);
  }

  /**
   * Convert an instance of CaptionSelectorSelectorSettings to an JSON string
   *
   * @return JSON string
   */
