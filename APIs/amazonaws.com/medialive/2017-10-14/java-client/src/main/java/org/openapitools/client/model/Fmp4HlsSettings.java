...
public class Fmp4HlsSettings {
  ...
  public Fmp4HlsSettings() {
  }

  public Fmp4HlsSettings audioRenditionSets(String audioRenditionSets) {
  ...
  public Fmp4HlsSettings nielsenId3Behavior(Fmp4NielsenId3Behavior nielsenId3Behavior) {
  ...
  public Fmp4HlsSettings timedMetadataBehavior(Fmp4TimedMetadataBehavior timedMetadataBehavior) {
  ...
  public boolean equals(Object o) {
    ...
    Fmp4HlsSettings fmp4HlsSettings = (Fmp4HlsSettings) o;
    return Objects.equals(this.audioRenditionSets, fmp4HlsSettings.audioRenditionSets) &&
        Objects.equals(this.nielsenId3Behavior, fmp4HlsSettings.nielsenId3Behavior) &&
        Objects.equals(this.timedMetadataBehavior, fmp4HlsSettings.timedMetadataBehavior);
  }
  ...
  public String toString() {
    ...
    sb.append("class Fmp4HlsSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Fmp4HlsSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Fmp4HlsSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Fmp4HlsSettings is not found in the empty JSON string", Fmp4HlsSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Fmp4HlsSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Fmp4HlsSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Fmp4HlsSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Fmp4HlsSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Fmp4HlsSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Fmp4HlsSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<Fmp4HlsSettings>() {
           @Override
           public void write(JsonWriter out, Fmp4HlsSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Fmp4HlsSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Fmp4HlsSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Fmp4HlsSettings
   * @throws IOException if the JSON string is invalid with respect to Fmp4HlsSettings
   */
  public static Fmp4HlsSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Fmp4HlsSettings.class);
  }

  /**
   * Convert an instance of Fmp4HlsSettings to an JSON string
   *
   * @return JSON string
   */
