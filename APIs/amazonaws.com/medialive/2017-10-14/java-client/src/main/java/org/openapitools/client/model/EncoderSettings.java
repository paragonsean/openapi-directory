...
public class EncoderSettings {
  ...
  public EncoderSettings audioDescriptions(List audioDescriptions) {
  ...
  public EncoderSettings availBlanking(CreateChannelRequestEncoderSettingsAvailBlanking availBlanking) {
  ...
  public EncoderSettings availConfiguration(CreateChannelRequestEncoderSettingsAvailConfiguration availConfiguration) {
  ...
  public EncoderSettings blackoutSlate(CreateChannelRequestEncoderSettingsBlackoutSlate blackoutSlate) {
  ...
  public EncoderSettings captionDescriptions(List captionDescriptions) {
  ...
  public EncoderSettings featureActivations(CreateChannelRequestEncoderSettingsFeatureActivations featureActivations) {
  ...
  public EncoderSettings globalConfiguration(CreateChannelRequestEncoderSettingsGlobalConfiguration globalConfiguration) {
  ...
  public EncoderSettings motionGraphicsConfiguration(CreateChannelRequestEncoderSettingsMotionGraphicsConfiguration motionGraphicsConfiguration) {
  ...
  public EncoderSettings nielsenConfiguration(CreateChannelRequestEncoderSettingsNielsenConfiguration nielsenConfiguration) {
  ...
  public EncoderSettings outputGroups(List outputGroups) {
  ...
  public EncoderSettings timecodeConfig(CreateChannelRequestEncoderSettingsTimecodeConfig timecodeConfig) {
  ...
  public EncoderSettings videoDescriptions(List videoDescriptions) {
  ...
  public EncoderSettings thumbnailConfiguration(CreateChannelRequestEncoderSettingsThumbnailConfiguration thumbnailConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    EncoderSettings encoderSettings = (EncoderSettings) o;
    return Objects.equals(this.audioDescriptions, encoderSettings.audioDescriptions) &&
        Objects.equals(this.availBlanking, encoderSettings.availBlanking) &&
        Objects.equals(this.availConfiguration, encoderSettings.availConfiguration) &&
        Objects.equals(this.blackoutSlate, encoderSettings.blackoutSlate) &&
        Objects.equals(this.captionDescriptions, encoderSettings.captionDescriptions) &&
        Objects.equals(this.featureActivations, encoderSettings.featureActivations) &&
        Objects.equals(this.globalConfiguration, encoderSettings.globalConfiguration) &&
        Objects.equals(this.motionGraphicsConfiguration, encoderSettings.motionGraphicsConfiguration) &&
        Objects.equals(this.nielsenConfiguration, encoderSettings.nielsenConfiguration) &&
        Objects.equals(this.outputGroups, encoderSettings.outputGroups) &&
        Objects.equals(this.timecodeConfig, encoderSettings.timecodeConfig) &&
        Objects.equals(this.videoDescriptions, encoderSettings.videoDescriptions) &&
        Objects.equals(this.thumbnailConfiguration, encoderSettings.thumbnailConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class EncoderSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EncoderSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EncoderSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EncoderSettings is not found in the empty JSON string", EncoderSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EncoderSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EncoderSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EncoderSettings.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EncoderSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EncoderSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EncoderSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EncoderSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<EncoderSettings>() {
           @Override
           public void write(JsonWriter out, EncoderSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EncoderSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EncoderSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EncoderSettings
   * @throws IOException if the JSON string is invalid with respect to EncoderSettings
   */
  public static EncoderSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EncoderSettings.class);
  }

  /**
   * Convert an instance of EncoderSettings to an JSON string
   *
   * @return JSON string
   */
