...
class DeleteMultiplexProgramResponse(Model):
    ...
    def __init__(self, channel_id: str=None, multiplex_program_settings: DeleteMultiplexProgramResponseMultiplexProgramSettings=None, packet_identifiers_map: DeleteMultiplexProgramResponsePacketIdentifiersMap=None, pipeline_details: List=None, program_name: str=None):
        """DeleteMultiplexProgramResponse - a model defined in OpenAPI

        :param channel_id: The channel_id of this DeleteMultiplexProgramResponse.
        :param multiplex_program_settings: The multiplex_program_settings of this DeleteMultiplexProgramResponse.
        :param packet_identifiers_map: The packet_identifiers_map of this DeleteMultiplexProgramResponse.
        :param pipeline_details: The pipeline_details of this DeleteMultiplexProgramResponse.
        :param program_name: The program_name of this DeleteMultiplexProgramResponse.
        """
        self.openapi_types = {
            'channel_id': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DeleteMultiplexProgramResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DeleteMultiplexProgramResponse of this DeleteMultiplexProgramResponse.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def channel_id(self):
        """Gets the channel_id of this DeleteMultiplexProgramResponse.


        :return: The channel_id of this DeleteMultiplexProgramResponse.
        :rtype: str
        """
    ...
    def channel_id(self, channel_id):
        """Sets the channel_id of this DeleteMultiplexProgramResponse.
    ...
    def multiplex_program_settings(self):
        """Gets the multiplex_program_settings of this DeleteMultiplexProgramResponse.


        :return: The multiplex_program_settings of this DeleteMultiplexProgramResponse.
    ...
    def multiplex_program_settings(self, multiplex_program_settings):
        """Sets the multiplex_program_settings of this DeleteMultiplexProgramResponse.
    ...
    def packet_identifiers_map(self):
        """Gets the packet_identifiers_map of this DeleteMultiplexProgramResponse.


        :return: The packet_identifiers_map of this DeleteMultiplexProgramResponse.
    ...
    def packet_identifiers_map(self, packet_identifiers_map):
        """Sets the packet_identifiers_map of this DeleteMultiplexProgramResponse.
    ...
    def pipeline_details(self):
        """Gets the pipeline_details of this DeleteMultiplexProgramResponse.


        :return: The pipeline_details of this DeleteMultiplexProgramResponse.
        :rtype: List
        """
    ...
    def pipeline_details(self, pipeline_details):
        """Sets the pipeline_details of this DeleteMultiplexProgramResponse.
    ...
    def program_name(self):
        """Gets the program_name of this DeleteMultiplexProgramResponse.


        :return: The program_name of this DeleteMultiplexProgramResponse.
        :rtype: str
        """
    ...
    def program_name(self, program_name):
        """Sets the program_name of this DeleteMultiplexProgramResponse.
