...
class MultiplexSettings(Model):
    ...
    def __init__(self, maximum_video_buffer_delay_milliseconds: int=None, transport_stream_bitrate: int=None, transport_stream_id: int=None, transport_stream_reserved_bitrate: int=None):
        """MultiplexSettings - a model defined in OpenAPI

        :param maximum_video_buffer_delay_milliseconds: The maximum_video_buffer_delay_milliseconds of this MultiplexSettings.
        :param transport_stream_bitrate: The transport_stream_bitrate of this MultiplexSettings.
        :param transport_stream_id: The transport_stream_id of this MultiplexSettings.
        :param transport_stream_reserved_bitrate: The transport_stream_reserved_bitrate of this MultiplexSettings.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'MultiplexSettings':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The MultiplexSettings of this MultiplexSettings.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def maximum_video_buffer_delay_milliseconds(self):
        """Gets the maximum_video_buffer_delay_milliseconds of this MultiplexSettings.


        :return: The maximum_video_buffer_delay_milliseconds of this MultiplexSettings.
        :rtype: int
        """
    ...
    def maximum_video_buffer_delay_milliseconds(self, maximum_video_buffer_delay_milliseconds):
        """Sets the maximum_video_buffer_delay_milliseconds of this MultiplexSettings.
    ...
    def transport_stream_bitrate(self):
        """Gets the transport_stream_bitrate of this MultiplexSettings.


        :return: The transport_stream_bitrate of this MultiplexSettings.
        :rtype: int
        """
    ...
    def transport_stream_bitrate(self, transport_stream_bitrate):
        """Sets the transport_stream_bitrate of this MultiplexSettings.
    ...
    def transport_stream_id(self):
        """Gets the transport_stream_id of this MultiplexSettings.


        :return: The transport_stream_id of this MultiplexSettings.
        :rtype: int
        """
    ...
    def transport_stream_id(self, transport_stream_id):
        """Sets the transport_stream_id of this MultiplexSettings.
    ...
    def transport_stream_reserved_bitrate(self):
        """Gets the transport_stream_reserved_bitrate of this MultiplexSettings.


        :return: The transport_stream_reserved_bitrate of this MultiplexSettings.
        :rtype: int
        """
    ...
    def transport_stream_reserved_bitrate(self, transport_stream_reserved_bitrate):
        """Sets the transport_stream_reserved_bitrate of this MultiplexSettings.
