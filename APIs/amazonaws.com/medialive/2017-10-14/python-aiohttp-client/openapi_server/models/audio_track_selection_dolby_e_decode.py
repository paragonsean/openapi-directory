...
class AudioTrackSelectionDolbyEDecode(Model):
    ...
    def __init__(self, program_selection: DolbyEProgramSelection=None):
        """AudioTrackSelectionDolbyEDecode - a model defined in OpenAPI

        :param program_selection: The program_selection of this AudioTrackSelectionDolbyEDecode.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AudioTrackSelectionDolbyEDecode':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The AudioTrackSelection_DolbyEDecode of this AudioTrackSelectionDolbyEDecode.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def program_selection(self):
        """Gets the program_selection of this AudioTrackSelectionDolbyEDecode.


        :return: The program_selection of this AudioTrackSelectionDolbyEDecode.
    ...
    def program_selection(self, program_selection):
        """Sets the program_selection of this AudioTrackSelectionDolbyEDecode.
