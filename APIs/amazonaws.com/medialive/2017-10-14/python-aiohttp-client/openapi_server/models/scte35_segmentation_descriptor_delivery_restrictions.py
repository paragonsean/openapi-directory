...
class Scte35SegmentationDescriptorDeliveryRestrictions(Model):
    ...
    def __init__(self, archive_allowed_flag: Scte35ArchiveAllowedFlag=None, device_restrictions: Scte35DeviceRestrictions=None, no_regional_blackout_flag: Scte35NoRegionalBlackoutFlag=None, web_delivery_allowed_flag: Scte35WebDeliveryAllowedFlag=None):
        """Scte35SegmentationDescriptorDeliveryRestrictions - a model defined in OpenAPI

        :param archive_allowed_flag: The archive_allowed_flag of this Scte35SegmentationDescriptorDeliveryRestrictions.
        :param device_restrictions: The device_restrictions of this Scte35SegmentationDescriptorDeliveryRestrictions.
        :param no_regional_blackout_flag: The no_regional_blackout_flag of this Scte35SegmentationDescriptorDeliveryRestrictions.
        :param web_delivery_allowed_flag: The web_delivery_allowed_flag of this Scte35SegmentationDescriptorDeliveryRestrictions.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'Scte35SegmentationDescriptorDeliveryRestrictions':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Scte35SegmentationDescriptor_DeliveryRestrictions of this Scte35SegmentationDescriptorDeliveryRestrictions.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def archive_allowed_flag(self):
        """Gets the archive_allowed_flag of this Scte35SegmentationDescriptorDeliveryRestrictions.


        :return: The archive_allowed_flag of this Scte35SegmentationDescriptorDeliveryRestrictions.
    ...
    def archive_allowed_flag(self, archive_allowed_flag):
        """Sets the archive_allowed_flag of this Scte35SegmentationDescriptorDeliveryRestrictions.
    ...
    def device_restrictions(self):
        """Gets the device_restrictions of this Scte35SegmentationDescriptorDeliveryRestrictions.


        :return: The device_restrictions of this Scte35SegmentationDescriptorDeliveryRestrictions.
    ...
    def device_restrictions(self, device_restrictions):
        """Sets the device_restrictions of this Scte35SegmentationDescriptorDeliveryRestrictions.
    ...
    def no_regional_blackout_flag(self):
        """Gets the no_regional_blackout_flag of this Scte35SegmentationDescriptorDeliveryRestrictions.


        :return: The no_regional_blackout_flag of this Scte35SegmentationDescriptorDeliveryRestrictions.
    ...
    def no_regional_blackout_flag(self, no_regional_blackout_flag):
        """Sets the no_regional_blackout_flag of this Scte35SegmentationDescriptorDeliveryRestrictions.
    ...
    def web_delivery_allowed_flag(self):
        """Gets the web_delivery_allowed_flag of this Scte35SegmentationDescriptorDeliveryRestrictions.


        :return: The web_delivery_allowed_flag of this Scte35SegmentationDescriptorDeliveryRestrictions.
    ...
    def web_delivery_allowed_flag(self, web_delivery_allowed_flag):
        """Sets the web_delivery_allowed_flag of this Scte35SegmentationDescriptorDeliveryRestrictions.
