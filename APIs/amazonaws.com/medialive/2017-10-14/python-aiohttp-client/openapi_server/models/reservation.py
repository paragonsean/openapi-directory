...
class Reservation(Model):
    ...
    def __init__(self, arn: str=None, count: int=None, currency_code: str=None, duration: int=None, duration_units: OfferingDurationUnits=None, end: str=None, fixed_price: float=None, name: str=None, offering_description: str=None, offering_id: str=None, offering_type: OfferingType=None, region: str=None, renewal_settings: DeleteReservationResponseRenewalSettings=None, reservation_id: str=None, resource_specification: DeleteReservationResponseResourceSpecification=None, start: str=None, state: ReservationState=None, tags: Dict=None, usage_price: float=None):
        ...
        :param arn: The arn of this Reservation.
        :param count: The count of this Reservation.
        ...
        :param fixed_price: The fixed_price of this Reservation.
        :param name: The name of this Reservation.
        :param offering_description: The offering_description of this Reservation.
        :param offering_id: The offering_id of this Reservation.
        :param offering_type: The offering_type of this Reservation.
        :param region: The region of this Reservation.
        :param renewal_settings: The renewal_settings of this Reservation.
        ...
        :param state: The state of this Reservation.
        :param tags: The tags of this Reservation.
        :param usage_price: The usage_price of this Reservation.
        """
        self.openapi_types = {
            'arn': str,
            'count': int,
    ...
    @property
    def arn(self):
        """Gets the arn of this Reservation.


        :return: The arn of this Reservation.
        :rtype: str
        """
        return self._arn
    ...
    @arn.setter
    def arn(self, arn):
        """Sets the arn of this Reservation.
    ...
    @property
    def count(self):
        """Gets the count of this Reservation.


        :return: The count of this Reservation.
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        """Sets the count of this Reservation.
    ...
    def fixed_price(self):
        """Gets the fixed_price of this Reservation.


        :return: The fixed_price of this Reservation.
        :rtype: float
        """
    ...
    def fixed_price(self, fixed_price):
        """Sets the fixed_price of this Reservation.
    ...
    def offering_id(self):
        """Gets the offering_id of this Reservation.


        :return: The offering_id of this Reservation.
        :rtype: str
        """
    ...
    def offering_id(self, offering_id):
        """Sets the offering_id of this Reservation.
    ...
    def offering_type(self):
        """Gets the offering_type of this Reservation.


        :return: The offering_type of this Reservation.
        :rtype: OfferingType
        """
    ...
    def offering_type(self, offering_type):
        """Sets the offering_type of this Reservation.
    ...
    @property
    def region(self):
        """Gets the region of this Reservation.


        :return: The region of this Reservation.
        :rtype: str
        """
        return self._region
    ...
    def region(self, region):
        """Sets the region of this Reservation.
    ...
    def renewal_settings(self):
        """Gets the renewal_settings of this Reservation.


        :return: The renewal_settings of this Reservation.
    ...
    def renewal_settings(self, renewal_settings):
        """Sets the renewal_settings of this Reservation.
    ...
    @property
    def state(self):
        """Gets the state of this Reservation.


        :return: The state of this Reservation.
    ...
    @property
    def tags(self):
        """Gets the tags of this Reservation.


        :return: The tags of this Reservation.
        :rtype: Dict
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this Reservation.
    ...
    def usage_price(self):
        """Gets the usage_price of this Reservation.


        :return: The usage_price of this Reservation.
        :rtype: float
        """
    ...
    def usage_price(self, usage_price):
        """Sets the usage_price of this Reservation.
