...
class StaticKeySettings(Model):
    ...
    def __init__(self, key_provider_server: StaticKeySettingsKeyProviderServer=None, static_key_value: str=None):
        """StaticKeySettings - a model defined in OpenAPI

        :param key_provider_server: The key_provider_server of this StaticKeySettings.
        :param static_key_value: The static_key_value of this StaticKeySettings.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'StaticKeySettings':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The StaticKeySettings of this StaticKeySettings.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def key_provider_server(self):
        """Gets the key_provider_server of this StaticKeySettings.


        :return: The key_provider_server of this StaticKeySettings.
    ...
    def key_provider_server(self, key_provider_server):
        """Sets the key_provider_server of this StaticKeySettings.
    ...
    def static_key_value(self):
        """Gets the static_key_value of this StaticKeySettings.


        :return: The static_key_value of this StaticKeySettings.
        :rtype: str
        """
    ...
    def static_key_value(self, static_key_value):
        """Sets the static_key_value of this StaticKeySettings.
