...
class StandardHlsSettings(Model):
    ...
    def __init__(self, audio_rendition_sets: str=None, m3u8_settings: StandardHlsSettingsM3u8Settings=None):
        """StandardHlsSettings - a model defined in OpenAPI

        :param audio_rendition_sets: The audio_rendition_sets of this StandardHlsSettings.
        :param m3u8_settings: The m3u8_settings of this StandardHlsSettings.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'StandardHlsSettings':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The StandardHlsSettings of this StandardHlsSettings.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def audio_rendition_sets(self):
        """Gets the audio_rendition_sets of this StandardHlsSettings.


        :return: The audio_rendition_sets of this StandardHlsSettings.
        :rtype: str
        """
    ...
    def audio_rendition_sets(self, audio_rendition_sets):
        """Sets the audio_rendition_sets of this StandardHlsSettings.
    ...
    def m3u8_settings(self):
        """Gets the m3u8_settings of this StandardHlsSettings.


        :return: The m3u8_settings of this StandardHlsSettings.
    ...
    def m3u8_settings(self, m3u8_settings):
        """Sets the m3u8_settings of this StandardHlsSettings.
