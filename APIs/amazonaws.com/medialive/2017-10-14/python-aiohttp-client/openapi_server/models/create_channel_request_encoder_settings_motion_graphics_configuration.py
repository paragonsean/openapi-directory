...
class CreateChannelRequestEncoderSettingsMotionGraphicsConfiguration(Model):
    ...
    def __init__(self, motion_graphics_insertion: MotionGraphicsInsertion=None, motion_graphics_settings: MotionGraphicsConfigurationMotionGraphicsSettings=None):
        """CreateChannelRequestEncoderSettingsMotionGraphicsConfiguration - a model defined in OpenAPI

        :param motion_graphics_insertion: The motion_graphics_insertion of this CreateChannelRequestEncoderSettingsMotionGraphicsConfiguration.
        :param motion_graphics_settings: The motion_graphics_settings of this CreateChannelRequestEncoderSettingsMotionGraphicsConfiguration.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateChannelRequestEncoderSettingsMotionGraphicsConfiguration':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateChannel_request_encoderSettings_MotionGraphicsConfiguration of this CreateChannelRequestEncoderSettingsMotionGraphicsConfiguration.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def motion_graphics_insertion(self):
        """Gets the motion_graphics_insertion of this CreateChannelRequestEncoderSettingsMotionGraphicsConfiguration.


        :return: The motion_graphics_insertion of this CreateChannelRequestEncoderSettingsMotionGraphicsConfiguration.
    ...
    def motion_graphics_insertion(self, motion_graphics_insertion):
        """Sets the motion_graphics_insertion of this CreateChannelRequestEncoderSettingsMotionGraphicsConfiguration.
    ...
    def motion_graphics_settings(self):
        """Gets the motion_graphics_settings of this CreateChannelRequestEncoderSettingsMotionGraphicsConfiguration.


        :return: The motion_graphics_settings of this CreateChannelRequestEncoderSettingsMotionGraphicsConfiguration.
    ...
    def motion_graphics_settings(self, motion_graphics_settings):
        """Sets the motion_graphics_settings of this CreateChannelRequestEncoderSettingsMotionGraphicsConfiguration.
