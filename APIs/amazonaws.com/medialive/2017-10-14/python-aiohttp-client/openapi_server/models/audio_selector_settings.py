...
class AudioSelectorSettings(Model):
    ...
    def __init__(self, audio_hls_rendition_selection: AudioSelectorSettingsAudioHlsRenditionSelection=None, audio_language_selection: AudioSelectorSettingsAudioLanguageSelection=None, audio_pid_selection: AudioSelectorSettingsAudioPidSelection=None, audio_track_selection: AudioSelectorSettingsAudioTrackSelection=None):
        """AudioSelectorSettings - a model defined in OpenAPI

        :param audio_hls_rendition_selection: The audio_hls_rendition_selection of this AudioSelectorSettings.
        ...
        :param audio_track_selection: The audio_track_selection of this AudioSelectorSettings.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AudioSelectorSettings':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The AudioSelectorSettings of this AudioSelectorSettings.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def audio_hls_rendition_selection(self):
        """Gets the audio_hls_rendition_selection of this AudioSelectorSettings.


        :return: The audio_hls_rendition_selection of this AudioSelectorSettings.
    ...
    def audio_hls_rendition_selection(self, audio_hls_rendition_selection):
        """Sets the audio_hls_rendition_selection of this AudioSelectorSettings.
    ...
    def audio_track_selection(self):
        """Gets the audio_track_selection of this AudioSelectorSettings.


        :return: The audio_track_selection of this AudioSelectorSettings.
    ...
    def audio_track_selection(self, audio_track_selection):
        """Sets the audio_track_selection of this AudioSelectorSettings.
