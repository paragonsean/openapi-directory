...
class M2tsSettings(Model):
    ...
    def __init__(self, absent_input_audio_behavior: M2tsAbsentInputAudioBehavior=None, arib: M2tsArib=None, arib_captions_pid: str=None, arib_captions_pid_control: M2tsAribCaptionsPidControl=None, audio_buffer_model: M2tsAudioBufferModel=None, audio_frames_per_pes: int=None, audio_pids: str=None, audio_stream_type: M2tsAudioStreamType=None, bitrate: int=None, buffer_model: M2tsBufferModel=None, cc_descriptor: M2tsCcDescriptor=None, dvb_nit_settings: M2tsSettingsDvbNitSettings=None, dvb_sdt_settings: M2tsSettingsDvbSdtSettings=None, dvb_sub_pids: str=None, dvb_tdt_settings: M2tsSettingsDvbTdtSettings=None, dvb_teletext_pid: str=None, ebif: M2tsEbifControl=None, ebp_audio_interval: M2tsAudioInterval=None, ebp_lookahead_ms: int=None, ebp_placement: M2tsEbpPlacement=None, ecm_pid: str=None, es_rate_in_pes: M2tsEsRateInPes=None, etv_platform_pid: str=None, etv_signal_pid: str=None, fragment_time: float=None, klv: M2tsKlv=None, klv_data_pids: str=None, nielsen_id3_behavior: M2tsNielsenId3Behavior=None, null_packet_bitrate: float=None, pat_interval: int=None, pcr_control: M2tsPcrControl=None, pcr_period: int=None, pcr_pid: str=None, pmt_interval: int=None, pmt_pid: str=None, program_num: int=None, rate_mode: M2tsRateMode=None, scte27_pids: str=None, scte35_control: M2tsScte35Control=None, scte35_pid: str=None, segmentation_markers: M2tsSegmentationMarkers=None, segmentation_style: M2tsSegmentationStyle=None, segmentation_time: float=None, timed_metadata_behavior: M2tsTimedMetadataBehavior=None, timed_metadata_pid: str=None, transport_stream_id: int=None, video_pid: str=None, scte35_preroll_pullup_milliseconds: float=None):
        ...
        :param absent_input_audio_behavior: The absent_input_audio_behavior of this M2tsSettings.
        :param arib: The arib of this M2tsSettings.
        :param arib_captions_pid: The arib_captions_pid of this M2tsSettings.
        :param arib_captions_pid_control: The arib_captions_pid_control of this M2tsSettings.
        ...
        :param audio_stream_type: The audio_stream_type of this M2tsSettings.
        :param bitrate: The bitrate of this M2tsSettings.
        :param buffer_model: The buffer_model of this M2tsSettings.
        :param cc_descriptor: The cc_descriptor of this M2tsSettings.
        ...
        :param ebif: The ebif of this M2tsSettings.
        :param ebp_audio_interval: The ebp_audio_interval of this M2tsSettings.
        :param ebp_lookahead_ms: The ebp_lookahead_ms of this M2tsSettings.
        :param ebp_placement: The ebp_placement of this M2tsSettings.
        :param ecm_pid: The ecm_pid of this M2tsSettings.
        :param es_rate_in_pes: The es_rate_in_pes of this M2tsSettings.
        :param etv_platform_pid: The etv_platform_pid of this M2tsSettings.
        :param etv_signal_pid: The etv_signal_pid of this M2tsSettings.
        :param fragment_time: The fragment_time of this M2tsSettings.
        :param klv: The klv of this M2tsSettings.
        :param klv_data_pids: The klv_data_pids of this M2tsSettings.
        :param nielsen_id3_behavior: The nielsen_id3_behavior of this M2tsSettings.
        ...
        :param pcr_period: The pcr_period of this M2tsSettings.
        ...
        :param program_num: The program_num of this M2tsSettings.
        :param rate_mode: The rate_mode of this M2tsSettings.
        :param scte27_pids: The scte27_pids of this M2tsSettings.
        :param scte35_control: The scte35_control of this M2tsSettings.
        ...
        :param timed_metadata_behavior: The timed_metadata_behavior of this M2tsSettings.
        ...
        :param scte35_preroll_pullup_milliseconds: The scte35_preroll_pullup_milliseconds of this M2tsSettings.
        """
        self.openapi_types = {
    ...
    def absent_input_audio_behavior(self):
        """Gets the absent_input_audio_behavior of this M2tsSettings.


        :return: The absent_input_audio_behavior of this M2tsSettings.
    ...
    def absent_input_audio_behavior(self, absent_input_audio_behavior):
        """Sets the absent_input_audio_behavior of this M2tsSettings.
    ...
    @property
    def arib(self):
        """Gets the arib of this M2tsSettings.


        :return: The arib of this M2tsSettings.
        :rtype: M2tsArib
        """
        return self._arib
    ...
    @arib.setter
    def arib(self, arib):
        """Sets the arib of this M2tsSettings.
    ...
    def arib_captions_pid(self):
        """Gets the arib_captions_pid of this M2tsSettings.


        :return: The arib_captions_pid of this M2tsSettings.
        :rtype: str
        """
    ...
    def arib_captions_pid(self, arib_captions_pid):
        """Sets the arib_captions_pid of this M2tsSettings.
    ...
    def arib_captions_pid_control(self):
        """Gets the arib_captions_pid_control of this M2tsSettings.


        :return: The arib_captions_pid_control of this M2tsSettings.
    ...
    def arib_captions_pid_control(self, arib_captions_pid_control):
        """Sets the arib_captions_pid_control of this M2tsSettings.
    ...
    def audio_stream_type(self):
        """Gets the audio_stream_type of this M2tsSettings.


        :return: The audio_stream_type of this M2tsSettings.
    ...
    def audio_stream_type(self, audio_stream_type):
        """Sets the audio_stream_type of this M2tsSettings.
    ...
    def cc_descriptor(self):
        """Gets the cc_descriptor of this M2tsSettings.


        :return: The cc_descriptor of this M2tsSettings.
    ...
    def cc_descriptor(self, cc_descriptor):
        """Sets the cc_descriptor of this M2tsSettings.
    ...
    @property
    def ebif(self):
        """Gets the ebif of this M2tsSettings.


        :return: The ebif of this M2tsSettings.
    ...
    @ebif.setter
    def ebif(self, ebif):
        """Sets the ebif of this M2tsSettings.
    ...
    def ebp_lookahead_ms(self):
        """Gets the ebp_lookahead_ms of this M2tsSettings.


        :return: The ebp_lookahead_ms of this M2tsSettings.
        :rtype: int
        """
    ...
    def ebp_lookahead_ms(self, ebp_lookahead_ms):
        """Sets the ebp_lookahead_ms of this M2tsSettings.
    ...
    @property
    def ecm_pid(self):
        """Gets the ecm_pid of this M2tsSettings.


        :return: The ecm_pid of this M2tsSettings.
        :rtype: str
        """
    ...
    def ecm_pid(self, ecm_pid):
        """Sets the ecm_pid of this M2tsSettings.
    ...
    def etv_platform_pid(self):
        """Gets the etv_platform_pid of this M2tsSettings.


        :return: The etv_platform_pid of this M2tsSettings.
        :rtype: str
        """
    ...
    def etv_platform_pid(self, etv_platform_pid):
        """Sets the etv_platform_pid of this M2tsSettings.
    ...
    def etv_signal_pid(self):
        """Gets the etv_signal_pid of this M2tsSettings.


        :return: The etv_signal_pid of this M2tsSettings.
        :rtype: str
        """
    ...
    def etv_signal_pid(self, etv_signal_pid):
        """Sets the etv_signal_pid of this M2tsSettings.
    ...
    @property
    def klv(self):
        """Gets the klv of this M2tsSettings.


        :return: The klv of this M2tsSettings.
        :rtype: M2tsKlv
        """
        return self._klv
    ...
    @klv.setter
    def klv(self, klv):
        """Sets the klv of this M2tsSettings.
    ...
    def klv_data_pids(self):
        """Gets the klv_data_pids of this M2tsSettings.


        :return: The klv_data_pids of this M2tsSettings.
        :rtype: str
        """
    ...
    def klv_data_pids(self, klv_data_pids):
        """Sets the klv_data_pids of this M2tsSettings.
    ...
    def nielsen_id3_behavior(self):
        """Gets the nielsen_id3_behavior of this M2tsSettings.


        :return: The nielsen_id3_behavior of this M2tsSettings.
    ...
    def nielsen_id3_behavior(self, nielsen_id3_behavior):
        """Sets the nielsen_id3_behavior of this M2tsSettings.
    ...
    @property
    def pcr_period(self):
        """Gets the pcr_period of this M2tsSettings.


        :return: The pcr_period of this M2tsSettings.
        :rtype: int
        """
    ...
    def pcr_period(self, pcr_period):
        """Sets the pcr_period of this M2tsSettings.
    ...
    def program_num(self):
        """Gets the program_num of this M2tsSettings.


        :return: The program_num of this M2tsSettings.
        :rtype: int
        """
    ...
    def program_num(self, program_num):
        """Sets the program_num of this M2tsSettings.
    ...
    def scte27_pids(self):
        """Gets the scte27_pids of this M2tsSettings.


        :return: The scte27_pids of this M2tsSettings.
        :rtype: str
        """
    ...
    def scte27_pids(self, scte27_pids):
        """Sets the scte27_pids of this M2tsSettings.
    ...
    def scte35_control(self):
        """Gets the scte35_control of this M2tsSettings.


        :return: The scte35_control of this M2tsSettings.
    ...
    def scte35_control(self, scte35_control):
        """Sets the scte35_control of this M2tsSettings.
    ...
    def timed_metadata_behavior(self):
        """Gets the timed_metadata_behavior of this M2tsSettings.


        :return: The timed_metadata_behavior of this M2tsSettings.
    ...
    def timed_metadata_behavior(self, timed_metadata_behavior):
        """Sets the timed_metadata_behavior of this M2tsSettings.
    ...
    def scte35_preroll_pullup_milliseconds(self):
        """Gets the scte35_preroll_pullup_milliseconds of this M2tsSettings.


        :return: The scte35_preroll_pullup_milliseconds of this M2tsSettings.
        :rtype: float
        """
    ...
    def scte35_preroll_pullup_milliseconds(self, scte35_preroll_pullup_milliseconds):
        """Sets the scte35_preroll_pullup_milliseconds of this M2tsSettings.
