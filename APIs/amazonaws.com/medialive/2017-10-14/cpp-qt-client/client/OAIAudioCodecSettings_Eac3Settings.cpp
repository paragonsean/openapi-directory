...
double OAIAudioCodecSettings_Eac3Settings::getBitrate() const {
    return m_bitrate;
}
void OAIAudioCodecSettings_Eac3Settings::setBitrate(const double &bitrate) {
    m_bitrate = bitrate;
...
OAIEac3DrcLine OAIAudioCodecSettings_Eac3Settings::getDrcLine() const {
    return m_drc_line;
}
void OAIAudioCodecSettings_Eac3Settings::setDrcLine(const OAIEac3DrcLine &drc_line) {
    m_drc_line = drc_line;
    m_drc_line_isSet = true;
}

bool OAIAudioCodecSettings_Eac3Settings::is_drc_line_Set() const{
    return m_drc_line_isSet;
}

bool OAIAudioCodecSettings_Eac3Settings::is_drc_line_Valid() const{
    return m_drc_line_isValid;
}

OAIEac3DrcRf OAIAudioCodecSettings_Eac3Settings::getDrcRf() const {
    return m_drc_rf;
}
void OAIAudioCodecSettings_Eac3Settings::setDrcRf(const OAIEac3DrcRf &drc_rf) {
    m_drc_rf = drc_rf;
    m_drc_rf_isSet = true;
}

bool OAIAudioCodecSettings_Eac3Settings::is_drc_rf_Set() const{
    return m_drc_rf_isSet;
}

bool OAIAudioCodecSettings_Eac3Settings::is_drc_rf_Valid() const{
