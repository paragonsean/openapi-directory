...
#include "OAIInputDeviceHdSettings.h"
...
OAIInputDeviceHdSettings::OAIInputDeviceHdSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInputDeviceHdSettings::OAIInputDeviceHdSettings() {
    this->initializeModel();
}

OAIInputDeviceHdSettings::~OAIInputDeviceHdSettings() {}

void OAIInputDeviceHdSettings::initializeModel() {
...
void OAIInputDeviceHdSettings::fromJson(QString jsonString) {
...
void OAIInputDeviceHdSettings::fromJsonObject(QJsonObject json) {
...
QString OAIInputDeviceHdSettings::asJson() const {
...
QJsonObject OAIInputDeviceHdSettings::asJsonObject() const {
    QJsonObject obj;
...
OAIInputDeviceActiveInput OAIInputDeviceHdSettings::getActiveInput() const {
    return m_active_input;
}
void OAIInputDeviceHdSettings::setActiveInput(const OAIInputDeviceActiveInput &active_input) {
    m_active_input = active_input;
    m_active_input_isSet = true;
}

bool OAIInputDeviceHdSettings::is_active_input_Set() const{
    return m_active_input_isSet;
}

bool OAIInputDeviceHdSettings::is_active_input_Valid() const{
    return m_active_input_isValid;
}

OAIInputDeviceConfiguredInput OAIInputDeviceHdSettings::getConfiguredInput() const {
    return m_configured_input;
}
void OAIInputDeviceHdSettings::setConfiguredInput(const OAIInputDeviceConfiguredInput &configured_input) {
    m_configured_input = configured_input;
    m_configured_input_isSet = true;
}

bool OAIInputDeviceHdSettings::is_configured_input_Set() const{
    return m_configured_input_isSet;
}

bool OAIInputDeviceHdSettings::is_configured_input_Valid() const{
    return m_configured_input_isValid;
}

OAIInputDeviceState OAIInputDeviceHdSettings::getDeviceState() const {
    return m_device_state;
}
void OAIInputDeviceHdSettings::setDeviceState(const OAIInputDeviceState &device_state) {
    m_device_state = device_state;
    m_device_state_isSet = true;
}

bool OAIInputDeviceHdSettings::is_device_state_Set() const{
    return m_device_state_isSet;
}

bool OAIInputDeviceHdSettings::is_device_state_Valid() const{
    return m_device_state_isValid;
}

double OAIInputDeviceHdSettings::getFramerate() const {
    return m_framerate;
}
void OAIInputDeviceHdSettings::setFramerate(const double &framerate) {
    m_framerate = framerate;
    m_framerate_isSet = true;
}

bool OAIInputDeviceHdSettings::is_framerate_Set() const{
    return m_framerate_isSet;
}

bool OAIInputDeviceHdSettings::is_framerate_Valid() const{
    return m_framerate_isValid;
}

qint32 OAIInputDeviceHdSettings::getHeight() const {
    return m_height;
}
void OAIInputDeviceHdSettings::setHeight(const qint32 &height) {
    m_height = height;
    m_height_isSet = true;
}

bool OAIInputDeviceHdSettings::is_height_Set() const{
    return m_height_isSet;
}

bool OAIInputDeviceHdSettings::is_height_Valid() const{
    return m_height_isValid;
}

qint32 OAIInputDeviceHdSettings::getMaxBitrate() const {
    return m_max_bitrate;
}
void OAIInputDeviceHdSettings::setMaxBitrate(const qint32 &max_bitrate) {
    m_max_bitrate = max_bitrate;
    m_max_bitrate_isSet = true;
}

bool OAIInputDeviceHdSettings::is_max_bitrate_Set() const{
    return m_max_bitrate_isSet;
}

bool OAIInputDeviceHdSettings::is_max_bitrate_Valid() const{
    return m_max_bitrate_isValid;
}

OAIInputDeviceScanType OAIInputDeviceHdSettings::getScanType() const {
    return m_scan_type;
}
void OAIInputDeviceHdSettings::setScanType(const OAIInputDeviceScanType &scan_type) {
    m_scan_type = scan_type;
    m_scan_type_isSet = true;
}

bool OAIInputDeviceHdSettings::is_scan_type_Set() const{
    return m_scan_type_isSet;
}

bool OAIInputDeviceHdSettings::is_scan_type_Valid() const{
    return m_scan_type_isValid;
}

qint32 OAIInputDeviceHdSettings::getWidth() const {
    return m_width;
}
void OAIInputDeviceHdSettings::setWidth(const qint32 &width) {
    m_width = width;
    m_width_isSet = true;
}

bool OAIInputDeviceHdSettings::is_width_Set() const{
    return m_width_isSet;
}

bool OAIInputDeviceHdSettings::is_width_Valid() const{
    return m_width_isValid;
}

qint32 OAIInputDeviceHdSettings::getLatencyMs() const {
    return m_latency_ms;
}
void OAIInputDeviceHdSettings::setLatencyMs(const qint32 &latency_ms) {
    m_latency_ms = latency_ms;
    m_latency_ms_isSet = true;
}

bool OAIInputDeviceHdSettings::is_latency_ms_Set() const{
    return m_latency_ms_isSet;
}

bool OAIInputDeviceHdSettings::is_latency_ms_Valid() const{
    return m_latency_ms_isValid;
}

bool OAIInputDeviceHdSettings::isSet() const {
...
bool OAIInputDeviceHdSettings::isValid() const {
