...
OAIHlsInputSettings::OAIHlsInputSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHlsInputSettings::OAIHlsInputSettings() {
    this->initializeModel();
}

OAIHlsInputSettings::~OAIHlsInputSettings() {}

void OAIHlsInputSettings::initializeModel() {
...
void OAIHlsInputSettings::fromJson(QString jsonString) {
...
void OAIHlsInputSettings::fromJsonObject(QJsonObject json) {
...
QString OAIHlsInputSettings::asJson() const {
...
QJsonObject OAIHlsInputSettings::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIHlsInputSettings::getBandwidth() const {
    return m_bandwidth;
}
void OAIHlsInputSettings::setBandwidth(const qint32 &bandwidth) {
    m_bandwidth = bandwidth;
    m_bandwidth_isSet = true;
}

bool OAIHlsInputSettings::is_bandwidth_Set() const{
    return m_bandwidth_isSet;
}

bool OAIHlsInputSettings::is_bandwidth_Valid() const{
    return m_bandwidth_isValid;
}

qint32 OAIHlsInputSettings::getBufferSegments() const {
    return m_buffer_segments;
}
void OAIHlsInputSettings::setBufferSegments(const qint32 &buffer_segments) {
    m_buffer_segments = buffer_segments;
    m_buffer_segments_isSet = true;
}

bool OAIHlsInputSettings::is_buffer_segments_Set() const{
    return m_buffer_segments_isSet;
}

bool OAIHlsInputSettings::is_buffer_segments_Valid() const{
    return m_buffer_segments_isValid;
}

qint32 OAIHlsInputSettings::getRetries() const {
    return m_retries;
}
void OAIHlsInputSettings::setRetries(const qint32 &retries) {
    m_retries = retries;
    m_retries_isSet = true;
}

bool OAIHlsInputSettings::is_retries_Set() const{
    return m_retries_isSet;
}

bool OAIHlsInputSettings::is_retries_Valid() const{
    return m_retries_isValid;
}

qint32 OAIHlsInputSettings::getRetryInterval() const {
    return m_retry_interval;
}
void OAIHlsInputSettings::setRetryInterval(const qint32 &retry_interval) {
    m_retry_interval = retry_interval;
    m_retry_interval_isSet = true;
}

bool OAIHlsInputSettings::is_retry_interval_Set() const{
    return m_retry_interval_isSet;
}

bool OAIHlsInputSettings::is_retry_interval_Valid() const{
    return m_retry_interval_isValid;
}

OAIHlsScte35SourceType OAIHlsInputSettings::getScte35Source() const {
    return m_scte35_source;
}
void OAIHlsInputSettings::setScte35Source(const OAIHlsScte35SourceType &scte35_source) {
    m_scte35_source = scte35_source;
    m_scte35_source_isSet = true;
}

bool OAIHlsInputSettings::is_scte35_source_Set() const{
    return m_scte35_source_isSet;
}

bool OAIHlsInputSettings::is_scte35_source_Valid() const{
    return m_scte35_source_isValid;
}

bool OAIHlsInputSettings::isSet() const {
...
bool OAIHlsInputSettings::isValid() const {
