...
/*
 * OAIUpdateInputDeviceResponse.h
 *
 * Placeholder documentation for UpdateInputDeviceResponse
 */

#ifndef OAIUpdateInputDeviceResponse_H
#define OAIUpdateInputDeviceResponse_H
...
class OAIDescribeInputDeviceResponse_NetworkSettings;
class OAIDescribeInputDeviceResponse_UhdDeviceSettings;

class OAIUpdateInputDeviceResponse : public OAIObject {
public:
    OAIUpdateInputDeviceResponse();
    OAIUpdateInputDeviceResponse(QString json);
    ~OAIUpdateInputDeviceResponse() override;
    ...
    OAIDescribeInputDeviceResponse_NetworkSettings getNetworkSettings() const;
    void setNetworkSettings(const OAIDescribeInputDeviceResponse_NetworkSettings &network_settings);
...
private:
    ...
    OAIDescribeInputDeviceResponse_NetworkSettings m_network_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateInputDeviceResponse)

#endif // OAIUpdateInputDeviceResponse_H
