...
OAIEncoderSettings::OAIEncoderSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEncoderSettings::OAIEncoderSettings() {
    this->initializeModel();
}

OAIEncoderSettings::~OAIEncoderSettings() {}

void OAIEncoderSettings::initializeModel() {
...
void OAIEncoderSettings::fromJson(QString jsonString) {
...
void OAIEncoderSettings::fromJsonObject(QJsonObject json) {
...
QString OAIEncoderSettings::asJson() const {
...
QJsonObject OAIEncoderSettings::asJsonObject() const {
    QJsonObject obj;
...
QList OAIEncoderSettings::getAudioDescriptions() const {
    return m_audio_descriptions;
}
void OAIEncoderSettings::setAudioDescriptions(const QList &audio_descriptions) {
    m_audio_descriptions = audio_descriptions;
    m_audio_descriptions_isSet = true;
}

bool OAIEncoderSettings::is_audio_descriptions_Set() const{
    return m_audio_descriptions_isSet;
}

bool OAIEncoderSettings::is_audio_descriptions_Valid() const{
    return m_audio_descriptions_isValid;
}

OAICreateChannel_request_encoderSettings_AvailBlanking OAIEncoderSettings::getAvailBlanking() const {
    return m_avail_blanking;
}
void OAIEncoderSettings::setAvailBlanking(const OAICreateChannel_request_encoderSettings_AvailBlanking &avail_blanking) {
    m_avail_blanking = avail_blanking;
    m_avail_blanking_isSet = true;
}

bool OAIEncoderSettings::is_avail_blanking_Set() const{
    return m_avail_blanking_isSet;
}

bool OAIEncoderSettings::is_avail_blanking_Valid() const{
    return m_avail_blanking_isValid;
}

OAICreateChannel_request_encoderSettings_AvailConfiguration OAIEncoderSettings::getAvailConfiguration() const {
    return m_avail_configuration;
}
void OAIEncoderSettings::setAvailConfiguration(const OAICreateChannel_request_encoderSettings_AvailConfiguration &avail_configuration) {
    m_avail_configuration = avail_configuration;
    m_avail_configuration_isSet = true;
}

bool OAIEncoderSettings::is_avail_configuration_Set() const{
    return m_avail_configuration_isSet;
}

bool OAIEncoderSettings::is_avail_configuration_Valid() const{
    return m_avail_configuration_isValid;
}

OAICreateChannel_request_encoderSettings_BlackoutSlate OAIEncoderSettings::getBlackoutSlate() const {
    return m_blackout_slate;
}
void OAIEncoderSettings::setBlackoutSlate(const OAICreateChannel_request_encoderSettings_BlackoutSlate &blackout_slate) {
    m_blackout_slate = blackout_slate;
    m_blackout_slate_isSet = true;
}

bool OAIEncoderSettings::is_blackout_slate_Set() const{
    return m_blackout_slate_isSet;
}

bool OAIEncoderSettings::is_blackout_slate_Valid() const{
    return m_blackout_slate_isValid;
}

QList OAIEncoderSettings::getCaptionDescriptions() const {
    return m_caption_descriptions;
}
void OAIEncoderSettings::setCaptionDescriptions(const QList &caption_descriptions) {
    m_caption_descriptions = caption_descriptions;
    m_caption_descriptions_isSet = true;
}

bool OAIEncoderSettings::is_caption_descriptions_Set() const{
    return m_caption_descriptions_isSet;
}

bool OAIEncoderSettings::is_caption_descriptions_Valid() const{
    return m_caption_descriptions_isValid;
}

OAICreateChannel_request_encoderSettings_FeatureActivations OAIEncoderSettings::getFeatureActivations() const {
    return m_feature_activations;
}
void OAIEncoderSettings::setFeatureActivations(const OAICreateChannel_request_encoderSettings_FeatureActivations &feature_activations) {
    m_feature_activations = feature_activations;
    m_feature_activations_isSet = true;
}

bool OAIEncoderSettings::is_feature_activations_Set() const{
    return m_feature_activations_isSet;
}

bool OAIEncoderSettings::is_feature_activations_Valid() const{
    return m_feature_activations_isValid;
}

OAICreateChannel_request_encoderSettings_GlobalConfiguration OAIEncoderSettings::getGlobalConfiguration() const {
    return m_global_configuration;
}
void OAIEncoderSettings::setGlobalConfiguration(const OAICreateChannel_request_encoderSettings_GlobalConfiguration &global_configuration) {
    m_global_configuration = global_configuration;
    m_global_configuration_isSet = true;
}

bool OAIEncoderSettings::is_global_configuration_Set() const{
    return m_global_configuration_isSet;
}

bool OAIEncoderSettings::is_global_configuration_Valid() const{
    return m_global_configuration_isValid;
}

OAICreateChannel_request_encoderSettings_MotionGraphicsConfiguration OAIEncoderSettings::getMotionGraphicsConfiguration() const {
    return m_motion_graphics_configuration;
}
void OAIEncoderSettings::setMotionGraphicsConfiguration(const OAICreateChannel_request_encoderSettings_MotionGraphicsConfiguration &motion_graphics_configuration) {
    m_motion_graphics_configuration = motion_graphics_configuration;
    m_motion_graphics_configuration_isSet = true;
}

bool OAIEncoderSettings::is_motion_graphics_configuration_Set() const{
    return m_motion_graphics_configuration_isSet;
}

bool OAIEncoderSettings::is_motion_graphics_configuration_Valid() const{
    return m_motion_graphics_configuration_isValid;
}

OAICreateChannel_request_encoderSettings_NielsenConfiguration OAIEncoderSettings::getNielsenConfiguration() const {
    return m_nielsen_configuration;
}
void OAIEncoderSettings::setNielsenConfiguration(const OAICreateChannel_request_encoderSettings_NielsenConfiguration &nielsen_configuration) {
    m_nielsen_configuration = nielsen_configuration;
    m_nielsen_configuration_isSet = true;
}

bool OAIEncoderSettings::is_nielsen_configuration_Set() const{
    return m_nielsen_configuration_isSet;
}

bool OAIEncoderSettings::is_nielsen_configuration_Valid() const{
    return m_nielsen_configuration_isValid;
}

QList OAIEncoderSettings::getOutputGroups() const {
    return m_output_groups;
}
void OAIEncoderSettings::setOutputGroups(const QList &output_groups) {
    m_output_groups = output_groups;
    m_output_groups_isSet = true;
}

bool OAIEncoderSettings::is_output_groups_Set() const{
    return m_output_groups_isSet;
}

bool OAIEncoderSettings::is_output_groups_Valid() const{
    return m_output_groups_isValid;
}

OAICreateChannel_request_encoderSettings_TimecodeConfig OAIEncoderSettings::getTimecodeConfig() const {
    return m_timecode_config;
}
void OAIEncoderSettings::setTimecodeConfig(const OAICreateChannel_request_encoderSettings_TimecodeConfig &timecode_config) {
    m_timecode_config = timecode_config;
    m_timecode_config_isSet = true;
}

bool OAIEncoderSettings::is_timecode_config_Set() const{
    return m_timecode_config_isSet;
}

bool OAIEncoderSettings::is_timecode_config_Valid() const{
    return m_timecode_config_isValid;
}

QList OAIEncoderSettings::getVideoDescriptions() const {
    return m_video_descriptions;
}
void OAIEncoderSettings::setVideoDescriptions(const QList &video_descriptions) {
    m_video_descriptions = video_descriptions;
    m_video_descriptions_isSet = true;
}

bool OAIEncoderSettings::is_video_descriptions_Set() const{
    return m_video_descriptions_isSet;
}

bool OAIEncoderSettings::is_video_descriptions_Valid() const{
    return m_video_descriptions_isValid;
}

OAICreateChannel_request_encoderSettings_ThumbnailConfiguration OAIEncoderSettings::getThumbnailConfiguration() const {
    return m_thumbnail_configuration;
}
void OAIEncoderSettings::setThumbnailConfiguration(const OAICreateChannel_request_encoderSettings_ThumbnailConfiguration &thumbnail_configuration) {
    m_thumbnail_configuration = thumbnail_configuration;
    m_thumbnail_configuration_isSet = true;
}

bool OAIEncoderSettings::is_thumbnail_configuration_Set() const{
    return m_thumbnail_configuration_isSet;
}

bool OAIEncoderSettings::is_thumbnail_configuration_Valid() const{
    return m_thumbnail_configuration_isValid;
}

bool OAIEncoderSettings::isSet() const {
...
bool OAIEncoderSettings::isValid() const {
