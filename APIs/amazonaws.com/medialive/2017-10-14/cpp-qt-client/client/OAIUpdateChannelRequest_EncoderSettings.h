...
/*
 * OAIUpdateChannelRequest_EncoderSettings.h
 *
 * 
 */

#ifndef OAIUpdateChannelRequest_EncoderSettings_H
#define OAIUpdateChannelRequest_EncoderSettings_H
...
class OAIUpdateChannelRequest_EncoderSettings : public OAIObject {
public:
    OAIUpdateChannelRequest_EncoderSettings();
    OAIUpdateChannelRequest_EncoderSettings(QString json);
    ~OAIUpdateChannelRequest_EncoderSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateChannelRequest_EncoderSettings)

#endif // OAIUpdateChannelRequest_EncoderSettings_H
