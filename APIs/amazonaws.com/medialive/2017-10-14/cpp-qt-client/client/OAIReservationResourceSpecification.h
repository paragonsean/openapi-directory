...
/*
 * OAIReservationResourceSpecification.h
 *
 * Resource configuration (codec, resolution, bitrate, ...)
 */

#ifndef OAIReservationResourceSpecification_H
#define OAIReservationResourceSpecification_H
...
class OAIReservationResourceSpecification : public OAIObject {
public:
    OAIReservationResourceSpecification();
    OAIReservationResourceSpecification(QString json);
    ~OAIReservationResourceSpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReservationResourceSpecification)

#endif // OAIReservationResourceSpecification_H
