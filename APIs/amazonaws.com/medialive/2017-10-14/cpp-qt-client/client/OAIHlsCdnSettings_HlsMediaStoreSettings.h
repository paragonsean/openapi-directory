...
/*
 * OAIHlsCdnSettings_HlsMediaStoreSettings.h
 *
 * 
 */

#ifndef OAIHlsCdnSettings_HlsMediaStoreSettings_H
#define OAIHlsCdnSettings_HlsMediaStoreSettings_H
...
class OAIHlsCdnSettings_HlsMediaStoreSettings : public OAIObject {
public:
    OAIHlsCdnSettings_HlsMediaStoreSettings();
    OAIHlsCdnSettings_HlsMediaStoreSettings(QString json);
    ~OAIHlsCdnSettings_HlsMediaStoreSettings() override;
    ...
    OAIHlsMediaStoreStorageClass getMediaStoreStorageClass() const;
    void setMediaStoreStorageClass(const OAIHlsMediaStoreStorageClass &media_store_storage_class);
    bool is_media_store_storage_class_Set() const;
    bool is_media_store_storage_class_Valid() const;
...
private:
    ...
    OAIHlsMediaStoreStorageClass m_media_store_storage_class;
    bool m_media_store_storage_class_isSet;
    bool m_media_store_storage_class_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHlsCdnSettings_HlsMediaStoreSettings)

#endif // OAIHlsCdnSettings_HlsMediaStoreSettings_H
