...
/*
 * OAIDescribeInputDeviceResponse_UhdDeviceSettings.h
 *
 * 
 */

#ifndef OAIDescribeInputDeviceResponse_UhdDeviceSettings_H
#define OAIDescribeInputDeviceResponse_UhdDeviceSettings_H
...
class OAIDescribeInputDeviceResponse_UhdDeviceSettings : public OAIObject {
public:
    OAIDescribeInputDeviceResponse_UhdDeviceSettings();
    OAIDescribeInputDeviceResponse_UhdDeviceSettings(QString json);
    ~OAIDescribeInputDeviceResponse_UhdDeviceSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeInputDeviceResponse_UhdDeviceSettings)

#endif // OAIDescribeInputDeviceResponse_UhdDeviceSettings_H
