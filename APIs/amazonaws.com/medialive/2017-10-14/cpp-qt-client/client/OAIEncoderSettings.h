...
/*
 * OAIEncoderSettings.h
 *
 * Encoder Settings
 */

#ifndef OAIEncoderSettings_H
#define OAIEncoderSettings_H
...
class OAIEncoderSettings : public OAIObject {
public:
    OAIEncoderSettings();
    OAIEncoderSettings(QString json);
    ~OAIEncoderSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEncoderSettings)

#endif // OAIEncoderSettings_H
