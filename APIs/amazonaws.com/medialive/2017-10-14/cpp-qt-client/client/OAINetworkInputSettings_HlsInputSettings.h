...
/*
 * OAINetworkInputSettings_HlsInputSettings.h
 *
 * 
 */

#ifndef OAINetworkInputSettings_HlsInputSettings_H
#define OAINetworkInputSettings_HlsInputSettings_H
...
class OAINetworkInputSettings_HlsInputSettings : public OAIObject {
public:
    OAINetworkInputSettings_HlsInputSettings();
    OAINetworkInputSettings_HlsInputSettings(QString json);
    ~OAINetworkInputSettings_HlsInputSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINetworkInputSettings_HlsInputSettings)

#endif // OAINetworkInputSettings_HlsInputSettings_H
