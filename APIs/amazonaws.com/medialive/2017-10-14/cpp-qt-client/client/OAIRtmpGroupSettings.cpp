...
#include "OAIRtmpGroupSettings.h"
...
OAIRtmpGroupSettings::OAIRtmpGroupSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRtmpGroupSettings::OAIRtmpGroupSettings() {
    this->initializeModel();
}

OAIRtmpGroupSettings::~OAIRtmpGroupSettings() {}

void OAIRtmpGroupSettings::initializeModel() {
...
void OAIRtmpGroupSettings::fromJson(QString jsonString) {
...
void OAIRtmpGroupSettings::fromJsonObject(QJsonObject json) {
...
QString OAIRtmpGroupSettings::asJson() const {
...
QJsonObject OAIRtmpGroupSettings::asJsonObject() const {
    QJsonObject obj;
...
QList OAIRtmpGroupSettings::getAdMarkers() const {
    return m_ad_markers;
}
void OAIRtmpGroupSettings::setAdMarkers(const QList &ad_markers) {
    m_ad_markers = ad_markers;
    m_ad_markers_isSet = true;
}

bool OAIRtmpGroupSettings::is_ad_markers_Set() const{
    return m_ad_markers_isSet;
}

bool OAIRtmpGroupSettings::is_ad_markers_Valid() const{
    return m_ad_markers_isValid;
}

OAIAuthenticationScheme OAIRtmpGroupSettings::getAuthenticationScheme() const {
    return m_authentication_scheme;
}
void OAIRtmpGroupSettings::setAuthenticationScheme(const OAIAuthenticationScheme &authentication_scheme) {
    m_authentication_scheme = authentication_scheme;
    m_authentication_scheme_isSet = true;
}

bool OAIRtmpGroupSettings::is_authentication_scheme_Set() const{
    return m_authentication_scheme_isSet;
}

bool OAIRtmpGroupSettings::is_authentication_scheme_Valid() const{
    return m_authentication_scheme_isValid;
}

OAIRtmpCacheFullBehavior OAIRtmpGroupSettings::getCacheFullBehavior() const {
    return m_cache_full_behavior;
}
void OAIRtmpGroupSettings::setCacheFullBehavior(const OAIRtmpCacheFullBehavior &cache_full_behavior) {
    m_cache_full_behavior = cache_full_behavior;
    m_cache_full_behavior_isSet = true;
}

bool OAIRtmpGroupSettings::is_cache_full_behavior_Set() const{
    return m_cache_full_behavior_isSet;
}

bool OAIRtmpGroupSettings::is_cache_full_behavior_Valid() const{
    return m_cache_full_behavior_isValid;
}

qint32 OAIRtmpGroupSettings::getCacheLength() const {
    return m_cache_length;
}
void OAIRtmpGroupSettings::setCacheLength(const qint32 &cache_length) {
    m_cache_length = cache_length;
    m_cache_length_isSet = true;
}

bool OAIRtmpGroupSettings::is_cache_length_Set() const{
    return m_cache_length_isSet;
}

bool OAIRtmpGroupSettings::is_cache_length_Valid() const{
    return m_cache_length_isValid;
}

OAIRtmpCaptionData OAIRtmpGroupSettings::getCaptionData() const {
    return m_caption_data;
}
void OAIRtmpGroupSettings::setCaptionData(const OAIRtmpCaptionData &caption_data) {
    m_caption_data = caption_data;
    m_caption_data_isSet = true;
}

bool OAIRtmpGroupSettings::is_caption_data_Set() const{
    return m_caption_data_isSet;
}

bool OAIRtmpGroupSettings::is_caption_data_Valid() const{
    return m_caption_data_isValid;
}

OAIInputLossActionForRtmpOut OAIRtmpGroupSettings::getInputLossAction() const {
    return m_input_loss_action;
}
void OAIRtmpGroupSettings::setInputLossAction(const OAIInputLossActionForRtmpOut &input_loss_action) {
    m_input_loss_action = input_loss_action;
    m_input_loss_action_isSet = true;
}

bool OAIRtmpGroupSettings::is_input_loss_action_Set() const{
    return m_input_loss_action_isSet;
}

bool OAIRtmpGroupSettings::is_input_loss_action_Valid() const{
    return m_input_loss_action_isValid;
}

qint32 OAIRtmpGroupSettings::getRestartDelay() const {
    return m_restart_delay;
}
void OAIRtmpGroupSettings::setRestartDelay(const qint32 &restart_delay) {
    m_restart_delay = restart_delay;
    m_restart_delay_isSet = true;
}

bool OAIRtmpGroupSettings::is_restart_delay_Set() const{
    return m_restart_delay_isSet;
}

bool OAIRtmpGroupSettings::is_restart_delay_Valid() const{
    return m_restart_delay_isValid;
}

bool OAIRtmpGroupSettings::isSet() const {
...
bool OAIRtmpGroupSettings::isValid() const {
