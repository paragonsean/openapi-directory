...
/*
 * OAIInputDeviceUhdSettings.h
 *
 * Settings that describe the active source from the input device, and the video characteristics of that source.
 */

#ifndef OAIInputDeviceUhdSettings_H
#define OAIInputDeviceUhdSettings_H
...
class OAIInputDeviceUhdSettings : public OAIObject {
public:
    OAIInputDeviceUhdSettings();
    OAIInputDeviceUhdSettings(QString json);
    ~OAIInputDeviceUhdSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInputDeviceUhdSettings)

#endif // OAIInputDeviceUhdSettings_H
