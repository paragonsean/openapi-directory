...
/*
 * OAIUpdateInputDeviceRequest_HdDeviceSettings.h
 *
 * 
 */

#ifndef OAIUpdateInputDeviceRequest_HdDeviceSettings_H
#define OAIUpdateInputDeviceRequest_HdDeviceSettings_H
...
class OAIUpdateInputDeviceRequest_HdDeviceSettings : public OAIObject {
public:
    OAIUpdateInputDeviceRequest_HdDeviceSettings();
    OAIUpdateInputDeviceRequest_HdDeviceSettings(QString json);
    ~OAIUpdateInputDeviceRequest_HdDeviceSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateInputDeviceRequest_HdDeviceSettings)

#endif // OAIUpdateInputDeviceRequest_HdDeviceSettings_H
