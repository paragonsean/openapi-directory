...
/*
 * OAIStopMultiplexResponse.h
 *
 * Placeholder documentation for StopMultiplexResponse
 */

#ifndef OAIStopMultiplexResponse_H
#define OAIStopMultiplexResponse_H
...
class OAIStopMultiplexResponse : public OAIObject {
public:
    OAIStopMultiplexResponse();
    OAIStopMultiplexResponse(QString json);
    ~OAIStopMultiplexResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopMultiplexResponse)

#endif // OAIStopMultiplexResponse_H
