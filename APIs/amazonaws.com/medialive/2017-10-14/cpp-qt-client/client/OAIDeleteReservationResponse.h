...
/*
 * OAIDeleteReservationResponse.h
 *
 * Placeholder documentation for DeleteReservationResponse
 */

#ifndef OAIDeleteReservationResponse_H
#define OAIDeleteReservationResponse_H
...
class OAIDeleteReservationResponse : public OAIObject {
public:
    OAIDeleteReservationResponse();
    OAIDeleteReservationResponse(QString json);
    ~OAIDeleteReservationResponse() override;
    ...
    OAIReservationState getState() const;
    void setState(const OAIReservationState &state);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteReservationResponse)

#endif // OAIDeleteReservationResponse_H
