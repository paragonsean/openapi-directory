...
OAIMultiplex::OAIMultiplex(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMultiplex::OAIMultiplex() {
    this->initializeModel();
}

OAIMultiplex::~OAIMultiplex() {}

void OAIMultiplex::initializeModel() {
...
void OAIMultiplex::fromJson(QString jsonString) {
...
void OAIMultiplex::fromJsonObject(QJsonObject json) {
...
QString OAIMultiplex::asJson() const {
...
QJsonObject OAIMultiplex::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIMultiplex::getArn() const {
    return m_arn;
}
void OAIMultiplex::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIMultiplex::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIMultiplex::is_arn_Valid() const{
    return m_arn_isValid;
}

QList OAIMultiplex::getAvailabilityZones() const {
    return m_availability_zones;
}
void OAIMultiplex::setAvailabilityZones(const QList &availability_zones) {
    m_availability_zones = availability_zones;
    m_availability_zones_isSet = true;
}

bool OAIMultiplex::is_availability_zones_Set() const{
    return m_availability_zones_isSet;
}

bool OAIMultiplex::is_availability_zones_Valid() const{
    return m_availability_zones_isValid;
}

QList OAIMultiplex::getDestinations() const {
    return m_destinations;
}
void OAIMultiplex::setDestinations(const QList &destinations) {
    m_destinations = destinations;
    m_destinations_isSet = true;
}

bool OAIMultiplex::is_destinations_Set() const{
    return m_destinations_isSet;
}

bool OAIMultiplex::is_destinations_Valid() const{
    return m_destinations_isValid;
}

QString OAIMultiplex::getId() const {
    return m_id;
}
void OAIMultiplex::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIMultiplex::is_id_Set() const{
    return m_id_isSet;
}

bool OAIMultiplex::is_id_Valid() const{
    return m_id_isValid;
}

OAIDeleteMultiplexResponse_MultiplexSettings OAIMultiplex::getMultiplexSettings() const {
    return m_multiplex_settings;
}
void OAIMultiplex::setMultiplexSettings(const OAIDeleteMultiplexResponse_MultiplexSettings &multiplex_settings) {
    m_multiplex_settings = multiplex_settings;
    m_multiplex_settings_isSet = true;
}

bool OAIMultiplex::is_multiplex_settings_Set() const{
    return m_multiplex_settings_isSet;
}

bool OAIMultiplex::is_multiplex_settings_Valid() const{
    return m_multiplex_settings_isValid;
}

QString OAIMultiplex::getName() const {
    return m_name;
}
void OAIMultiplex::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIMultiplex::is_name_Set() const{
    return m_name_isSet;
}

bool OAIMultiplex::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAIMultiplex::getPipelinesRunningCount() const {
    return m_pipelines_running_count;
}
void OAIMultiplex::setPipelinesRunningCount(const qint32 &pipelines_running_count) {
    m_pipelines_running_count = pipelines_running_count;
    m_pipelines_running_count_isSet = true;
}

bool OAIMultiplex::is_pipelines_running_count_Set() const{
    return m_pipelines_running_count_isSet;
}

bool OAIMultiplex::is_pipelines_running_count_Valid() const{
    return m_pipelines_running_count_isValid;
}

qint32 OAIMultiplex::getProgramCount() const {
    return m_program_count;
}
void OAIMultiplex::setProgramCount(const qint32 &program_count) {
    m_program_count = program_count;
    m_program_count_isSet = true;
}

bool OAIMultiplex::is_program_count_Set() const{
    return m_program_count_isSet;
}

bool OAIMultiplex::is_program_count_Valid() const{
    return m_program_count_isValid;
}

OAIMultiplexState OAIMultiplex::getState() const {
    return m_state;
}
void OAIMultiplex::setState(const OAIMultiplexState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIMultiplex::is_state_Set() const{
    return m_state_isSet;
}

bool OAIMultiplex::is_state_Valid() const{
    return m_state_isValid;
}

QMap OAIMultiplex::getTags() const {
    return m_tags;
}
void OAIMultiplex::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIMultiplex::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIMultiplex::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIMultiplex::isSet() const {
...
bool OAIMultiplex::isValid() const {
