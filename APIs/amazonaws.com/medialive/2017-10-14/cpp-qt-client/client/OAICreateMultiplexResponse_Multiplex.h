...
/*
 * OAICreateMultiplexResponse_Multiplex.h
 *
 * 
 */

#ifndef OAICreateMultiplexResponse_Multiplex_H
#define OAICreateMultiplexResponse_Multiplex_H
...
class OAICreateMultiplexResponse_Multiplex : public OAIObject {
public:
    OAICreateMultiplexResponse_Multiplex();
    OAICreateMultiplexResponse_Multiplex(QString json);
    ~OAICreateMultiplexResponse_Multiplex() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMultiplexResponse_Multiplex)

#endif // OAICreateMultiplexResponse_Multiplex_H
