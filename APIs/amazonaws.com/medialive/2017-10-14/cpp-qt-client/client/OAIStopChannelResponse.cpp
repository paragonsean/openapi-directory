...
OAIStopChannelResponse::OAIStopChannelResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStopChannelResponse::OAIStopChannelResponse() {
    this->initializeModel();
}

OAIStopChannelResponse::~OAIStopChannelResponse() {}

void OAIStopChannelResponse::initializeModel() {
...
void OAIStopChannelResponse::fromJson(QString jsonString) {
...
void OAIStopChannelResponse::fromJsonObject(QJsonObject json) {
...
QString OAIStopChannelResponse::asJson() const {
...
QJsonObject OAIStopChannelResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIStopChannelResponse::getArn() const {
    return m_arn;
}
void OAIStopChannelResponse::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIStopChannelResponse::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIStopChannelResponse::is_arn_Valid() const{
    return m_arn_isValid;
}

OAIDeleteChannelResponse_CdiInputSpecification OAIStopChannelResponse::getCdiInputSpecification() const {
    return m_cdi_input_specification;
}
void OAIStopChannelResponse::setCdiInputSpecification(const OAIDeleteChannelResponse_CdiInputSpecification &cdi_input_specification) {
    m_cdi_input_specification = cdi_input_specification;
    m_cdi_input_specification_isSet = true;
}

bool OAIStopChannelResponse::is_cdi_input_specification_Set() const{
    return m_cdi_input_specification_isSet;
}

bool OAIStopChannelResponse::is_cdi_input_specification_Valid() const{
    return m_cdi_input_specification_isValid;
}

OAIChannelClass OAIStopChannelResponse::getChannelClass() const {
    return m_channel_class;
}
void OAIStopChannelResponse::setChannelClass(const OAIChannelClass &channel_class) {
    m_channel_class = channel_class;
    m_channel_class_isSet = true;
}

bool OAIStopChannelResponse::is_channel_class_Set() const{
    return m_channel_class_isSet;
}

bool OAIStopChannelResponse::is_channel_class_Valid() const{
    return m_channel_class_isValid;
}

QList OAIStopChannelResponse::getDestinations() const {
    return m_destinations;
}
void OAIStopChannelResponse::setDestinations(const QList &destinations) {
    m_destinations = destinations;
    m_destinations_isSet = true;
}

bool OAIStopChannelResponse::is_destinations_Set() const{
    return m_destinations_isSet;
}

bool OAIStopChannelResponse::is_destinations_Valid() const{
    return m_destinations_isValid;
}

QList OAIStopChannelResponse::getEgressEndpoints() const {
    return m_egress_endpoints;
}
void OAIStopChannelResponse::setEgressEndpoints(const QList &egress_endpoints) {
    m_egress_endpoints = egress_endpoints;
    m_egress_endpoints_isSet = true;
}

bool OAIStopChannelResponse::is_egress_endpoints_Set() const{
    return m_egress_endpoints_isSet;
}

bool OAIStopChannelResponse::is_egress_endpoints_Valid() const{
    return m_egress_endpoints_isValid;
}

OAIDeleteChannelResponse_EncoderSettings OAIStopChannelResponse::getEncoderSettings() const {
    return m_encoder_settings;
}
void OAIStopChannelResponse::setEncoderSettings(const OAIDeleteChannelResponse_EncoderSettings &encoder_settings) {
    m_encoder_settings = encoder_settings;
    m_encoder_settings_isSet = true;
}

bool OAIStopChannelResponse::is_encoder_settings_Set() const{
    return m_encoder_settings_isSet;
}

bool OAIStopChannelResponse::is_encoder_settings_Valid() const{
    return m_encoder_settings_isValid;
}

QString OAIStopChannelResponse::getId() const {
    return m_id;
}
void OAIStopChannelResponse::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIStopChannelResponse::is_id_Set() const{
    return m_id_isSet;
}

bool OAIStopChannelResponse::is_id_Valid() const{
    return m_id_isValid;
}

QList OAIStopChannelResponse::getInputAttachments() const {
    return m_input_attachments;
}
void OAIStopChannelResponse::setInputAttachments(const QList &input_attachments) {
    m_input_attachments = input_attachments;
    m_input_attachments_isSet = true;
}

bool OAIStopChannelResponse::is_input_attachments_Set() const{
    return m_input_attachments_isSet;
}

bool OAIStopChannelResponse::is_input_attachments_Valid() const{
    return m_input_attachments_isValid;
}

OAIDeleteChannelResponse_InputSpecification OAIStopChannelResponse::getInputSpecification() const {
    return m_input_specification;
}
void OAIStopChannelResponse::setInputSpecification(const OAIDeleteChannelResponse_InputSpecification &input_specification) {
    m_input_specification = input_specification;
    m_input_specification_isSet = true;
}

bool OAIStopChannelResponse::is_input_specification_Set() const{
    return m_input_specification_isSet;
}

bool OAIStopChannelResponse::is_input_specification_Valid() const{
    return m_input_specification_isValid;
}

OAILogLevel OAIStopChannelResponse::getLogLevel() const {
    return m_log_level;
}
void OAIStopChannelResponse::setLogLevel(const OAILogLevel &log_level) {
    m_log_level = log_level;
    m_log_level_isSet = true;
}

bool OAIStopChannelResponse::is_log_level_Set() const{
    return m_log_level_isSet;
}

bool OAIStopChannelResponse::is_log_level_Valid() const{
    return m_log_level_isValid;
}

OAIDeleteChannelResponse_Maintenance OAIStopChannelResponse::getMaintenance() const {
    return m_maintenance;
}
void OAIStopChannelResponse::setMaintenance(const OAIDeleteChannelResponse_Maintenance &maintenance) {
    m_maintenance = maintenance;
    m_maintenance_isSet = true;
}

bool OAIStopChannelResponse::is_maintenance_Set() const{
    return m_maintenance_isSet;
}

bool OAIStopChannelResponse::is_maintenance_Valid() const{
    return m_maintenance_isValid;
}

QString OAIStopChannelResponse::getName() const {
    return m_name;
}
void OAIStopChannelResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIStopChannelResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAIStopChannelResponse::is_name_Valid() const{
    return m_name_isValid;
}

QList OAIStopChannelResponse::getPipelineDetails() const {
    return m_pipeline_details;
}
void OAIStopChannelResponse::setPipelineDetails(const QList &pipeline_details) {
    m_pipeline_details = pipeline_details;
    m_pipeline_details_isSet = true;
}

bool OAIStopChannelResponse::is_pipeline_details_Set() const{
    return m_pipeline_details_isSet;
}

bool OAIStopChannelResponse::is_pipeline_details_Valid() const{
    return m_pipeline_details_isValid;
}

qint32 OAIStopChannelResponse::getPipelinesRunningCount() const {
    return m_pipelines_running_count;
}
void OAIStopChannelResponse::setPipelinesRunningCount(const qint32 &pipelines_running_count) {
    m_pipelines_running_count = pipelines_running_count;
    m_pipelines_running_count_isSet = true;
}

bool OAIStopChannelResponse::is_pipelines_running_count_Set() const{
    return m_pipelines_running_count_isSet;
}

bool OAIStopChannelResponse::is_pipelines_running_count_Valid() const{
    return m_pipelines_running_count_isValid;
}

QString OAIStopChannelResponse::getRoleArn() const {
    return m_role_arn;
}
void OAIStopChannelResponse::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIStopChannelResponse::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIStopChannelResponse::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

OAIChannelState OAIStopChannelResponse::getState() const {
    return m_state;
}
void OAIStopChannelResponse::setState(const OAIChannelState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIStopChannelResponse::is_state_Set() const{
    return m_state_isSet;
}

bool OAIStopChannelResponse::is_state_Valid() const{
    return m_state_isValid;
}

QMap OAIStopChannelResponse::getTags() const {
    return m_tags;
}
void OAIStopChannelResponse::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIStopChannelResponse::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIStopChannelResponse::is_tags_Valid() const{
    return m_tags_isValid;
}

OAIDeleteChannelResponse_Vpc OAIStopChannelResponse::getVpc() const {
    return m_vpc;
}
void OAIStopChannelResponse::setVpc(const OAIDeleteChannelResponse_Vpc &vpc) {
    m_vpc = vpc;
    m_vpc_isSet = true;
}

bool OAIStopChannelResponse::is_vpc_Set() const{
    return m_vpc_isSet;
}

bool OAIStopChannelResponse::is_vpc_Valid() const{
    return m_vpc_isValid;
}

bool OAIStopChannelResponse::isSet() const {
...
bool OAIStopChannelResponse::isValid() const {
