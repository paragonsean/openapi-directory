...
/*
 * OAIChannelSummary_Vpc.h
 *
 * 
 */

#ifndef OAIChannelSummary_Vpc_H
#define OAIChannelSummary_Vpc_H
...
class OAIChannelSummary_Vpc : public OAIObject {
public:
    OAIChannelSummary_Vpc();
    OAIChannelSummary_Vpc(QString json);
    ~OAIChannelSummary_Vpc() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChannelSummary_Vpc)

#endif // OAIChannelSummary_Vpc_H
