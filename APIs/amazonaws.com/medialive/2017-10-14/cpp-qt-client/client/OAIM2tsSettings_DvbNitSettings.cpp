...
qint32 OAIM2tsSettings_DvbNitSettings::getRepInterval() const {
    return m_rep_interval;
}
void OAIM2tsSettings_DvbNitSettings::setRepInterval(const qint32 &rep_interval) {
    m_rep_interval = rep_interval;
    m_rep_interval_isSet = true;
}

bool OAIM2tsSettings_DvbNitSettings::is_rep_interval_Set() const{
    return m_rep_interval_isSet;
}

bool OAIM2tsSettings_DvbNitSettings::is_rep_interval_Valid() const{
...
bool OAIM2tsSettings_DvbNitSettings::isValid() const {
    ...
    return m_network_id_isValid && m_network_name_isValid && true;
}
