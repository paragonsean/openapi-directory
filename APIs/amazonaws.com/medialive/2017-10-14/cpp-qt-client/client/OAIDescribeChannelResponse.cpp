...
OAIDeleteChannelResponse_CdiInputSpecification OAIDescribeChannelResponse::getCdiInputSpecification() const {
    return m_cdi_input_specification;
}
void OAIDescribeChannelResponse::setCdiInputSpecification(const OAIDeleteChannelResponse_CdiInputSpecification &cdi_input_specification) {
    m_cdi_input_specification = cdi_input_specification;
    m_cdi_input_specification_isSet = true;
}

bool OAIDescribeChannelResponse::is_cdi_input_specification_Set() const{
    return m_cdi_input_specification_isSet;
}

bool OAIDescribeChannelResponse::is_cdi_input_specification_Valid() const{
    return m_cdi_input_specification_isValid;
}

OAIChannelClass OAIDescribeChannelResponse::getChannelClass() const {
    return m_channel_class;
}
void OAIDescribeChannelResponse::setChannelClass(const OAIChannelClass &channel_class) {
    m_channel_class = channel_class;
    m_channel_class_isSet = true;
}

bool OAIDescribeChannelResponse::is_channel_class_Set() const{
    return m_channel_class_isSet;
}

bool OAIDescribeChannelResponse::is_channel_class_Valid() const{
    return m_channel_class_isValid;
}

QList OAIDescribeChannelResponse::getDestinations() const {
    return m_destinations;
}
void OAIDescribeChannelResponse::setDestinations(const QList &destinations) {
    m_destinations = destinations;
    m_destinations_isSet = true;
}

bool OAIDescribeChannelResponse::is_destinations_Set() const{
    return m_destinations_isSet;
}

bool OAIDescribeChannelResponse::is_destinations_Valid() const{
    return m_destinations_isValid;
}

QList OAIDescribeChannelResponse::getEgressEndpoints() const {
    return m_egress_endpoints;
}
void OAIDescribeChannelResponse::setEgressEndpoints(const QList &egress_endpoints) {
    m_egress_endpoints = egress_endpoints;
    m_egress_endpoints_isSet = true;
}

bool OAIDescribeChannelResponse::is_egress_endpoints_Set() const{
    return m_egress_endpoints_isSet;
}

bool OAIDescribeChannelResponse::is_egress_endpoints_Valid() const{
    return m_egress_endpoints_isValid;
}

OAIDeleteChannelResponse_EncoderSettings OAIDescribeChannelResponse::getEncoderSettings() const {
    return m_encoder_settings;
}
void OAIDescribeChannelResponse::setEncoderSettings(const OAIDeleteChannelResponse_EncoderSettings &encoder_settings) {
    m_encoder_settings = encoder_settings;
    m_encoder_settings_isSet = true;
}

bool OAIDescribeChannelResponse::is_encoder_settings_Set() const{
    return m_encoder_settings_isSet;
}

bool OAIDescribeChannelResponse::is_encoder_settings_Valid() const{
...
QList OAIDescribeChannelResponse::getInputAttachments() const {
    return m_input_attachments;
}
void OAIDescribeChannelResponse::setInputAttachments(const QList &input_attachments) {
    m_input_attachments = input_attachments;
    m_input_attachments_isSet = true;
}

bool OAIDescribeChannelResponse::is_input_attachments_Set() const{
    return m_input_attachments_isSet;
}

bool OAIDescribeChannelResponse::is_input_attachments_Valid() const{
    return m_input_attachments_isValid;
}

OAIDeleteChannelResponse_InputSpecification OAIDescribeChannelResponse::getInputSpecification() const {
    return m_input_specification;
}
void OAIDescribeChannelResponse::setInputSpecification(const OAIDeleteChannelResponse_InputSpecification &input_specification) {
    m_input_specification = input_specification;
    m_input_specification_isSet = true;
}

bool OAIDescribeChannelResponse::is_input_specification_Set() const{
    return m_input_specification_isSet;
}

bool OAIDescribeChannelResponse::is_input_specification_Valid() const{
    return m_input_specification_isValid;
}

OAILogLevel OAIDescribeChannelResponse::getLogLevel() const {
    return m_log_level;
}
void OAIDescribeChannelResponse::setLogLevel(const OAILogLevel &log_level) {
    m_log_level = log_level;
    m_log_level_isSet = true;
}

bool OAIDescribeChannelResponse::is_log_level_Set() const{
    return m_log_level_isSet;
}

bool OAIDescribeChannelResponse::is_log_level_Valid() const{
    return m_log_level_isValid;
}

OAIDeleteChannelResponse_Maintenance OAIDescribeChannelResponse::getMaintenance() const {
    return m_maintenance;
}
void OAIDescribeChannelResponse::setMaintenance(const OAIDeleteChannelResponse_Maintenance &maintenance) {
    m_maintenance = maintenance;
    m_maintenance_isSet = true;
}

bool OAIDescribeChannelResponse::is_maintenance_Set() const{
    return m_maintenance_isSet;
}

bool OAIDescribeChannelResponse::is_maintenance_Valid() const{
    return m_maintenance_isValid;
}

QString OAIDescribeChannelResponse::getName() const {
    return m_name;
}
void OAIDescribeChannelResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDescribeChannelResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDescribeChannelResponse::is_name_Valid() const{
    return m_name_isValid;
}

QList OAIDescribeChannelResponse::getPipelineDetails() const {
    return m_pipeline_details;
}
void OAIDescribeChannelResponse::setPipelineDetails(const QList &pipeline_details) {
    m_pipeline_details = pipeline_details;
    m_pipeline_details_isSet = true;
}

bool OAIDescribeChannelResponse::is_pipeline_details_Set() const{
    return m_pipeline_details_isSet;
}

bool OAIDescribeChannelResponse::is_pipeline_details_Valid() const{
    return m_pipeline_details_isValid;
}

qint32 OAIDescribeChannelResponse::getPipelinesRunningCount() const {
    return m_pipelines_running_count;
}
void OAIDescribeChannelResponse::setPipelinesRunningCount(const qint32 &pipelines_running_count) {
    m_pipelines_running_count = pipelines_running_count;
    m_pipelines_running_count_isSet = true;
}

bool OAIDescribeChannelResponse::is_pipelines_running_count_Set() const{
    return m_pipelines_running_count_isSet;
}

bool OAIDescribeChannelResponse::is_pipelines_running_count_Valid() const{
    return m_pipelines_running_count_isValid;
}

QString OAIDescribeChannelResponse::getRoleArn() const {
    return m_role_arn;
}
void OAIDescribeChannelResponse::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIDescribeChannelResponse::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIDescribeChannelResponse::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

OAIChannelState OAIDescribeChannelResponse::getState() const {
    return m_state;
}
void OAIDescribeChannelResponse::setState(const OAIChannelState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIDescribeChannelResponse::is_state_Set() const{
    return m_state_isSet;
}

bool OAIDescribeChannelResponse::is_state_Valid() const{
...
OAIDeleteChannelResponse_Vpc OAIDescribeChannelResponse::getVpc() const {
    return m_vpc;
}
void OAIDescribeChannelResponse::setVpc(const OAIDeleteChannelResponse_Vpc &vpc) {
    m_vpc = vpc;
    m_vpc_isSet = true;
}

bool OAIDescribeChannelResponse::is_vpc_Set() const{
    return m_vpc_isSet;
}

bool OAIDescribeChannelResponse::is_vpc_Valid() const{
