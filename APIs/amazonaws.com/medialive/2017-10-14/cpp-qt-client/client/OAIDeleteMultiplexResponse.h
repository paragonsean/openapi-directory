...
/*
 * OAIDeleteMultiplexResponse.h
 *
 * Placeholder documentation for DeleteMultiplexResponse
 */

#ifndef OAIDeleteMultiplexResponse_H
#define OAIDeleteMultiplexResponse_H
...
class OAIDeleteMultiplexResponse : public OAIObject {
public:
    OAIDeleteMultiplexResponse();
    OAIDeleteMultiplexResponse(QString json);
    ~OAIDeleteMultiplexResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteMultiplexResponse)

#endif // OAIDeleteMultiplexResponse_H
