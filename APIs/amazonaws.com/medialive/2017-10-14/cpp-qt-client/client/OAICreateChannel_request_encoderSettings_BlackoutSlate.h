...
/*
 * OAICreateChannel_request_encoderSettings_BlackoutSlate.h
 *
 * 
 */

#ifndef OAICreateChannel_request_encoderSettings_BlackoutSlate_H
#define OAICreateChannel_request_encoderSettings_BlackoutSlate_H
...
class OAICreateChannel_request_encoderSettings_BlackoutSlate : public OAIObject {
public:
    OAICreateChannel_request_encoderSettings_BlackoutSlate();
    OAICreateChannel_request_encoderSettings_BlackoutSlate(QString json);
    ~OAICreateChannel_request_encoderSettings_BlackoutSlate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateChannel_request_encoderSettings_BlackoutSlate)

#endif // OAICreateChannel_request_encoderSettings_BlackoutSlate_H
