...
#ifndef OAIMultiplex_H
#define OAIMultiplex_H
...
class OAIMultiplex : public OAIObject {
public:
    OAIMultiplex();
    OAIMultiplex(QString json);
    ~OAIMultiplex() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMultiplex)

#endif // OAIMultiplex_H
