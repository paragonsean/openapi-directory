...
OAIChannelSummary::OAIChannelSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChannelSummary::OAIChannelSummary() {
    this->initializeModel();
}

OAIChannelSummary::~OAIChannelSummary() {}

void OAIChannelSummary::initializeModel() {
...
void OAIChannelSummary::fromJson(QString jsonString) {
...
void OAIChannelSummary::fromJsonObject(QJsonObject json) {
...
QString OAIChannelSummary::asJson() const {
...
QJsonObject OAIChannelSummary::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIChannelSummary::getArn() const {
    return m_arn;
}
void OAIChannelSummary::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIChannelSummary::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIChannelSummary::is_arn_Valid() const{
    return m_arn_isValid;
}

OAIDeleteChannelResponse_CdiInputSpecification OAIChannelSummary::getCdiInputSpecification() const {
    return m_cdi_input_specification;
}
void OAIChannelSummary::setCdiInputSpecification(const OAIDeleteChannelResponse_CdiInputSpecification &cdi_input_specification) {
    m_cdi_input_specification = cdi_input_specification;
    m_cdi_input_specification_isSet = true;
}

bool OAIChannelSummary::is_cdi_input_specification_Set() const{
    return m_cdi_input_specification_isSet;
}

bool OAIChannelSummary::is_cdi_input_specification_Valid() const{
    return m_cdi_input_specification_isValid;
}

OAIChannelClass OAIChannelSummary::getChannelClass() const {
    return m_channel_class;
}
void OAIChannelSummary::setChannelClass(const OAIChannelClass &channel_class) {
    m_channel_class = channel_class;
    m_channel_class_isSet = true;
}

bool OAIChannelSummary::is_channel_class_Set() const{
    return m_channel_class_isSet;
}

bool OAIChannelSummary::is_channel_class_Valid() const{
    return m_channel_class_isValid;
}

QList OAIChannelSummary::getDestinations() const {
    return m_destinations;
}
void OAIChannelSummary::setDestinations(const QList &destinations) {
    m_destinations = destinations;
    m_destinations_isSet = true;
}

bool OAIChannelSummary::is_destinations_Set() const{
    return m_destinations_isSet;
}

bool OAIChannelSummary::is_destinations_Valid() const{
    return m_destinations_isValid;
}

QList OAIChannelSummary::getEgressEndpoints() const {
    return m_egress_endpoints;
}
void OAIChannelSummary::setEgressEndpoints(const QList &egress_endpoints) {
    m_egress_endpoints = egress_endpoints;
    m_egress_endpoints_isSet = true;
}

bool OAIChannelSummary::is_egress_endpoints_Set() const{
    return m_egress_endpoints_isSet;
}

bool OAIChannelSummary::is_egress_endpoints_Valid() const{
    return m_egress_endpoints_isValid;
}

QString OAIChannelSummary::getId() const {
    return m_id;
}
void OAIChannelSummary::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIChannelSummary::is_id_Set() const{
    return m_id_isSet;
}

bool OAIChannelSummary::is_id_Valid() const{
    return m_id_isValid;
}

QList OAIChannelSummary::getInputAttachments() const {
    return m_input_attachments;
}
void OAIChannelSummary::setInputAttachments(const QList &input_attachments) {
    m_input_attachments = input_attachments;
    m_input_attachments_isSet = true;
}

bool OAIChannelSummary::is_input_attachments_Set() const{
    return m_input_attachments_isSet;
}

bool OAIChannelSummary::is_input_attachments_Valid() const{
    return m_input_attachments_isValid;
}

OAIDeleteChannelResponse_InputSpecification OAIChannelSummary::getInputSpecification() const {
    return m_input_specification;
}
void OAIChannelSummary::setInputSpecification(const OAIDeleteChannelResponse_InputSpecification &input_specification) {
    m_input_specification = input_specification;
    m_input_specification_isSet = true;
}

bool OAIChannelSummary::is_input_specification_Set() const{
    return m_input_specification_isSet;
}

bool OAIChannelSummary::is_input_specification_Valid() const{
    return m_input_specification_isValid;
}

OAILogLevel OAIChannelSummary::getLogLevel() const {
    return m_log_level;
}
void OAIChannelSummary::setLogLevel(const OAILogLevel &log_level) {
    m_log_level = log_level;
    m_log_level_isSet = true;
}

bool OAIChannelSummary::is_log_level_Set() const{
    return m_log_level_isSet;
}

bool OAIChannelSummary::is_log_level_Valid() const{
    return m_log_level_isValid;
}

OAIDeleteChannelResponse_Maintenance OAIChannelSummary::getMaintenance() const {
    return m_maintenance;
}
void OAIChannelSummary::setMaintenance(const OAIDeleteChannelResponse_Maintenance &maintenance) {
    m_maintenance = maintenance;
    m_maintenance_isSet = true;
}

bool OAIChannelSummary::is_maintenance_Set() const{
    return m_maintenance_isSet;
}

bool OAIChannelSummary::is_maintenance_Valid() const{
    return m_maintenance_isValid;
}

QString OAIChannelSummary::getName() const {
    return m_name;
}
void OAIChannelSummary::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIChannelSummary::is_name_Set() const{
    return m_name_isSet;
}

bool OAIChannelSummary::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAIChannelSummary::getPipelinesRunningCount() const {
    return m_pipelines_running_count;
}
void OAIChannelSummary::setPipelinesRunningCount(const qint32 &pipelines_running_count) {
    m_pipelines_running_count = pipelines_running_count;
    m_pipelines_running_count_isSet = true;
}

bool OAIChannelSummary::is_pipelines_running_count_Set() const{
    return m_pipelines_running_count_isSet;
}

bool OAIChannelSummary::is_pipelines_running_count_Valid() const{
    return m_pipelines_running_count_isValid;
}

QString OAIChannelSummary::getRoleArn() const {
    return m_role_arn;
}
void OAIChannelSummary::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIChannelSummary::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIChannelSummary::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

OAIChannelState OAIChannelSummary::getState() const {
    return m_state;
}
void OAIChannelSummary::setState(const OAIChannelState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIChannelSummary::is_state_Set() const{
    return m_state_isSet;
}

bool OAIChannelSummary::is_state_Valid() const{
    return m_state_isValid;
}

QMap OAIChannelSummary::getTags() const {
    return m_tags;
}
void OAIChannelSummary::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIChannelSummary::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIChannelSummary::is_tags_Valid() const{
    return m_tags_isValid;
}

OAIChannelSummary_Vpc OAIChannelSummary::getVpc() const {
    return m_vpc;
}
void OAIChannelSummary::setVpc(const OAIChannelSummary_Vpc &vpc) {
    m_vpc = vpc;
    m_vpc_isSet = true;
}

bool OAIChannelSummary::is_vpc_Set() const{
    return m_vpc_isSet;
}

bool OAIChannelSummary::is_vpc_Valid() const{
    return m_vpc_isValid;
}

bool OAIChannelSummary::isSet() const {
...
bool OAIChannelSummary::isValid() const {
