...
OAIChannelSummary_Vpc::OAIChannelSummary_Vpc(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChannelSummary_Vpc::OAIChannelSummary_Vpc() {
    this->initializeModel();
}

OAIChannelSummary_Vpc::~OAIChannelSummary_Vpc() {}

void OAIChannelSummary_Vpc::initializeModel() {
...
void OAIChannelSummary_Vpc::fromJson(QString jsonString) {
...
void OAIChannelSummary_Vpc::fromJsonObject(QJsonObject json) {
...
QString OAIChannelSummary_Vpc::asJson() const {
...
QJsonObject OAIChannelSummary_Vpc::asJsonObject() const {
    QJsonObject obj;
...
QList OAIChannelSummary_Vpc::getAvailabilityZones() const {
    return m_availability_zones;
}
void OAIChannelSummary_Vpc::setAvailabilityZones(const QList &availability_zones) {
    m_availability_zones = availability_zones;
    m_availability_zones_isSet = true;
}

bool OAIChannelSummary_Vpc::is_availability_zones_Set() const{
    return m_availability_zones_isSet;
}

bool OAIChannelSummary_Vpc::is_availability_zones_Valid() const{
    return m_availability_zones_isValid;
}

QList OAIChannelSummary_Vpc::getNetworkInterfaceIds() const {
    return m_network_interface_ids;
}
void OAIChannelSummary_Vpc::setNetworkInterfaceIds(const QList &network_interface_ids) {
    m_network_interface_ids = network_interface_ids;
    m_network_interface_ids_isSet = true;
}

bool OAIChannelSummary_Vpc::is_network_interface_ids_Set() const{
    return m_network_interface_ids_isSet;
}

bool OAIChannelSummary_Vpc::is_network_interface_ids_Valid() const{
    return m_network_interface_ids_isValid;
}

QList OAIChannelSummary_Vpc::getSecurityGroupIds() const {
    return m_security_group_ids;
}
void OAIChannelSummary_Vpc::setSecurityGroupIds(const QList &security_group_ids) {
    m_security_group_ids = security_group_ids;
    m_security_group_ids_isSet = true;
}

bool OAIChannelSummary_Vpc::is_security_group_ids_Set() const{
    return m_security_group_ids_isSet;
}

bool OAIChannelSummary_Vpc::is_security_group_ids_Valid() const{
    return m_security_group_ids_isValid;
}

QList OAIChannelSummary_Vpc::getSubnetIds() const {
    return m_subnet_ids;
}
void OAIChannelSummary_Vpc::setSubnetIds(const QList &subnet_ids) {
    m_subnet_ids = subnet_ids;
    m_subnet_ids_isSet = true;
}

bool OAIChannelSummary_Vpc::is_subnet_ids_Set() const{
    return m_subnet_ids_isSet;
}

bool OAIChannelSummary_Vpc::is_subnet_ids_Valid() const{
    return m_subnet_ids_isValid;
}

bool OAIChannelSummary_Vpc::isSet() const {
...
bool OAIChannelSummary_Vpc::isValid() const {
