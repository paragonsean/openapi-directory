...
/*
 * OAIArchiveContainerSettings_M2tsSettings.h
 *
 * 
 */

#ifndef OAIArchiveContainerSettings_M2tsSettings_H
#define OAIArchiveContainerSettings_M2tsSettings_H
...
class OAIArchiveContainerSettings_M2tsSettings : public OAIObject {
public:
    OAIArchiveContainerSettings_M2tsSettings();
    OAIArchiveContainerSettings_M2tsSettings(QString json);
    ~OAIArchiveContainerSettings_M2tsSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIArchiveContainerSettings_M2tsSettings)

#endif // OAIArchiveContainerSettings_M2tsSettings_H
