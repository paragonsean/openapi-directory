...
/*
 * OAIVideoBlackFailoverSettings.h
 *
 * Placeholder documentation for VideoBlackFailoverSettings
 */

#ifndef OAIVideoBlackFailoverSettings_H
#define OAIVideoBlackFailoverSettings_H
...
class OAIVideoBlackFailoverSettings : public OAIObject {
public:
    OAIVideoBlackFailoverSettings();
    OAIVideoBlackFailoverSettings(QString json);
    ~OAIVideoBlackFailoverSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVideoBlackFailoverSettings)

#endif // OAIVideoBlackFailoverSettings_H
