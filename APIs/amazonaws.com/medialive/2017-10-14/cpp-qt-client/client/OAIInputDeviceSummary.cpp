...
#include "OAIInputDeviceSummary.h"
...
OAIInputDeviceSummary::OAIInputDeviceSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInputDeviceSummary::OAIInputDeviceSummary() {
    this->initializeModel();
}

OAIInputDeviceSummary::~OAIInputDeviceSummary() {}

void OAIInputDeviceSummary::initializeModel() {
...
void OAIInputDeviceSummary::fromJson(QString jsonString) {
...
void OAIInputDeviceSummary::fromJsonObject(QJsonObject json) {
...
QString OAIInputDeviceSummary::asJson() const {
...
QJsonObject OAIInputDeviceSummary::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIInputDeviceSummary::getArn() const {
    return m_arn;
}
void OAIInputDeviceSummary::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIInputDeviceSummary::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIInputDeviceSummary::is_arn_Valid() const{
    return m_arn_isValid;
}

OAIInputDeviceConnectionState OAIInputDeviceSummary::getConnectionState() const {
    return m_connection_state;
}
void OAIInputDeviceSummary::setConnectionState(const OAIInputDeviceConnectionState &connection_state) {
    m_connection_state = connection_state;
    m_connection_state_isSet = true;
}

bool OAIInputDeviceSummary::is_connection_state_Set() const{
    return m_connection_state_isSet;
}

bool OAIInputDeviceSummary::is_connection_state_Valid() const{
    return m_connection_state_isValid;
}

OAIDeviceSettingsSyncState OAIInputDeviceSummary::getDeviceSettingsSyncState() const {
    return m_device_settings_sync_state;
}
void OAIInputDeviceSummary::setDeviceSettingsSyncState(const OAIDeviceSettingsSyncState &device_settings_sync_state) {
    m_device_settings_sync_state = device_settings_sync_state;
    m_device_settings_sync_state_isSet = true;
}

bool OAIInputDeviceSummary::is_device_settings_sync_state_Set() const{
    return m_device_settings_sync_state_isSet;
}

bool OAIInputDeviceSummary::is_device_settings_sync_state_Valid() const{
    return m_device_settings_sync_state_isValid;
}

OAIDeviceUpdateStatus OAIInputDeviceSummary::getDeviceUpdateStatus() const {
    return m_device_update_status;
}
void OAIInputDeviceSummary::setDeviceUpdateStatus(const OAIDeviceUpdateStatus &device_update_status) {
    m_device_update_status = device_update_status;
    m_device_update_status_isSet = true;
}

bool OAIInputDeviceSummary::is_device_update_status_Set() const{
    return m_device_update_status_isSet;
}

bool OAIInputDeviceSummary::is_device_update_status_Valid() const{
    return m_device_update_status_isValid;
}

OAIDescribeInputDeviceResponse_HdDeviceSettings OAIInputDeviceSummary::getHdDeviceSettings() const {
    return m_hd_device_settings;
}
void OAIInputDeviceSummary::setHdDeviceSettings(const OAIDescribeInputDeviceResponse_HdDeviceSettings &hd_device_settings) {
    m_hd_device_settings = hd_device_settings;
    m_hd_device_settings_isSet = true;
}

bool OAIInputDeviceSummary::is_hd_device_settings_Set() const{
    return m_hd_device_settings_isSet;
}

bool OAIInputDeviceSummary::is_hd_device_settings_Valid() const{
    return m_hd_device_settings_isValid;
}

QString OAIInputDeviceSummary::getId() const {
    return m_id;
}
void OAIInputDeviceSummary::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIInputDeviceSummary::is_id_Set() const{
    return m_id_isSet;
}

bool OAIInputDeviceSummary::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIInputDeviceSummary::getMacAddress() const {
    return m_mac_address;
}
void OAIInputDeviceSummary::setMacAddress(const QString &mac_address) {
    m_mac_address = mac_address;
    m_mac_address_isSet = true;
}

bool OAIInputDeviceSummary::is_mac_address_Set() const{
    return m_mac_address_isSet;
}

bool OAIInputDeviceSummary::is_mac_address_Valid() const{
    return m_mac_address_isValid;
}

QString OAIInputDeviceSummary::getName() const {
    return m_name;
}
void OAIInputDeviceSummary::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIInputDeviceSummary::is_name_Set() const{
    return m_name_isSet;
}

bool OAIInputDeviceSummary::is_name_Valid() const{
    return m_name_isValid;
}

OAIInputDeviceSummary_NetworkSettings OAIInputDeviceSummary::getNetworkSettings() const {
    return m_network_settings;
}
void OAIInputDeviceSummary::setNetworkSettings(const OAIInputDeviceSummary_NetworkSettings &network_settings) {
    m_network_settings = network_settings;
    m_network_settings_isSet = true;
}

bool OAIInputDeviceSummary::is_network_settings_Set() const{
    return m_network_settings_isSet;
}

bool OAIInputDeviceSummary::is_network_settings_Valid() const{
    return m_network_settings_isValid;
}

QString OAIInputDeviceSummary::getSerialNumber() const {
    return m_serial_number;
}
void OAIInputDeviceSummary::setSerialNumber(const QString &serial_number) {
    m_serial_number = serial_number;
    m_serial_number_isSet = true;
}

bool OAIInputDeviceSummary::is_serial_number_Set() const{
    return m_serial_number_isSet;
}

bool OAIInputDeviceSummary::is_serial_number_Valid() const{
    return m_serial_number_isValid;
}

OAIInputDeviceType OAIInputDeviceSummary::getType() const {
    return m_type;
}
void OAIInputDeviceSummary::setType(const OAIInputDeviceType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIInputDeviceSummary::is_type_Set() const{
    return m_type_isSet;
}

bool OAIInputDeviceSummary::is_type_Valid() const{
    return m_type_isValid;
}

OAIDescribeInputDeviceResponse_UhdDeviceSettings OAIInputDeviceSummary::getUhdDeviceSettings() const {
    return m_uhd_device_settings;
}
void OAIInputDeviceSummary::setUhdDeviceSettings(const OAIDescribeInputDeviceResponse_UhdDeviceSettings &uhd_device_settings) {
    m_uhd_device_settings = uhd_device_settings;
    m_uhd_device_settings_isSet = true;
}

bool OAIInputDeviceSummary::is_uhd_device_settings_Set() const{
    return m_uhd_device_settings_isSet;
}

bool OAIInputDeviceSummary::is_uhd_device_settings_Valid() const{
    return m_uhd_device_settings_isValid;
}

QMap OAIInputDeviceSummary::getTags() const {
    return m_tags;
}
void OAIInputDeviceSummary::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIInputDeviceSummary::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIInputDeviceSummary::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAIInputDeviceSummary::getAvailabilityZone() const {
    return m_availability_zone;
}
void OAIInputDeviceSummary::setAvailabilityZone(const QString &availability_zone) {
    m_availability_zone = availability_zone;
    m_availability_zone_isSet = true;
}

bool OAIInputDeviceSummary::is_availability_zone_Set() const{
    return m_availability_zone_isSet;
}

bool OAIInputDeviceSummary::is_availability_zone_Valid() const{
    return m_availability_zone_isValid;
}

bool OAIInputDeviceSummary::isSet() const {
...
bool OAIInputDeviceSummary::isValid() const {
