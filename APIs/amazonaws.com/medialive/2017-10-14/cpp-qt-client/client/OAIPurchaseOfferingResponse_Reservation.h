...
/*
 * OAIPurchaseOfferingResponse_Reservation.h
 *
 * 
 */

#ifndef OAIPurchaseOfferingResponse_Reservation_H
#define OAIPurchaseOfferingResponse_Reservation_H
...
class OAIPurchaseOfferingResponse_Reservation : public OAIObject {
public:
    OAIPurchaseOfferingResponse_Reservation();
    OAIPurchaseOfferingResponse_Reservation(QString json);
    ~OAIPurchaseOfferingResponse_Reservation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPurchaseOfferingResponse_Reservation)

#endif // OAIPurchaseOfferingResponse_Reservation_H
