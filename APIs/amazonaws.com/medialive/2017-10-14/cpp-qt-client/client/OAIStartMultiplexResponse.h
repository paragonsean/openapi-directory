...
/*
 * OAIStartMultiplexResponse.h
 *
 * Placeholder documentation for StartMultiplexResponse
 */

#ifndef OAIStartMultiplexResponse_H
#define OAIStartMultiplexResponse_H
...
class OAIStartMultiplexResponse : public OAIObject {
public:
    OAIStartMultiplexResponse();
    OAIStartMultiplexResponse(QString json);
    ~OAIStartMultiplexResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartMultiplexResponse)

#endif // OAIStartMultiplexResponse_H
