...
QString OAIMsSmoothGroupSettings::getAcquisitionPointId() const {
    return m_acquisition_point_id;
}
void OAIMsSmoothGroupSettings::setAcquisitionPointId(const QString &acquisition_point_id) {
    m_acquisition_point_id = acquisition_point_id;
    m_acquisition_point_id_isSet = true;
}

bool OAIMsSmoothGroupSettings::is_acquisition_point_id_Set() const{
    return m_acquisition_point_id_isSet;
}

bool OAIMsSmoothGroupSettings::is_acquisition_point_id_Valid() const{
    return m_acquisition_point_id_isValid;
}

OAISmoothGroupAudioOnlyTimecodeControl OAIMsSmoothGroupSettings::getAudioOnlyTimecodeControl() const {
    return m_audio_only_timecode_control;
}
void OAIMsSmoothGroupSettings::setAudioOnlyTimecodeControl(const OAISmoothGroupAudioOnlyTimecodeControl &audio_only_timecode_control) {
    m_audio_only_timecode_control = audio_only_timecode_control;
    m_audio_only_timecode_control_isSet = true;
}

bool OAIMsSmoothGroupSettings::is_audio_only_timecode_control_Set() const{
    return m_audio_only_timecode_control_isSet;
}

bool OAIMsSmoothGroupSettings::is_audio_only_timecode_control_Valid() const{
    return m_audio_only_timecode_control_isValid;
}

OAISmoothGroupCertificateMode OAIMsSmoothGroupSettings::getCertificateMode() const {
    return m_certificate_mode;
}
void OAIMsSmoothGroupSettings::setCertificateMode(const OAISmoothGroupCertificateMode &certificate_mode) {
    m_certificate_mode = certificate_mode;
    m_certificate_mode_isSet = true;
}

bool OAIMsSmoothGroupSettings::is_certificate_mode_Set() const{
    return m_certificate_mode_isSet;
}

bool OAIMsSmoothGroupSettings::is_certificate_mode_Valid() const{
    return m_certificate_mode_isValid;
}

qint32 OAIMsSmoothGroupSettings::getConnectionRetryInterval() const {
    return m_connection_retry_interval;
}
void OAIMsSmoothGroupSettings::setConnectionRetryInterval(const qint32 &connection_retry_interval) {
    m_connection_retry_interval = connection_retry_interval;
    m_connection_retry_interval_isSet = true;
}

bool OAIMsSmoothGroupSettings::is_connection_retry_interval_Set() const{
    return m_connection_retry_interval_isSet;
}

bool OAIMsSmoothGroupSettings::is_connection_retry_interval_Valid() const{
    return m_connection_retry_interval_isValid;
}

OAIMsSmoothGroupSettings_Destination OAIMsSmoothGroupSettings::getDestination() const {
    return m_destination;
}
void OAIMsSmoothGroupSettings::setDestination(const OAIMsSmoothGroupSettings_Destination &destination) {
...
QString OAIMsSmoothGroupSettings::getEventId() const {
    return m_event_id;
}
void OAIMsSmoothGroupSettings::setEventId(const QString &event_id) {
    m_event_id = event_id;
    m_event_id_isSet = true;
}

bool OAIMsSmoothGroupSettings::is_event_id_Set() const{
    return m_event_id_isSet;
}

bool OAIMsSmoothGroupSettings::is_event_id_Valid() const{
    return m_event_id_isValid;
}

OAISmoothGroupEventIdMode OAIMsSmoothGroupSettings::getEventIdMode() const {
    return m_event_id_mode;
}
void OAIMsSmoothGroupSettings::setEventIdMode(const OAISmoothGroupEventIdMode &event_id_mode) {
    m_event_id_mode = event_id_mode;
    m_event_id_mode_isSet = true;
}

bool OAIMsSmoothGroupSettings::is_event_id_mode_Set() const{
    return m_event_id_mode_isSet;
}

bool OAIMsSmoothGroupSettings::is_event_id_mode_Valid() const{
    return m_event_id_mode_isValid;
}

OAISmoothGroupEventStopBehavior OAIMsSmoothGroupSettings::getEventStopBehavior() const {
    return m_event_stop_behavior;
}
void OAIMsSmoothGroupSettings::setEventStopBehavior(const OAISmoothGroupEventStopBehavior &event_stop_behavior) {
    m_event_stop_behavior = event_stop_behavior;
    m_event_stop_behavior_isSet = true;
}

bool OAIMsSmoothGroupSettings::is_event_stop_behavior_Set() const{
    return m_event_stop_behavior_isSet;
}

bool OAIMsSmoothGroupSettings::is_event_stop_behavior_Valid() const{
    return m_event_stop_behavior_isValid;
}

qint32 OAIMsSmoothGroupSettings::getFilecacheDuration() const {
    return m_filecache_duration;
}
void OAIMsSmoothGroupSettings::setFilecacheDuration(const qint32 &filecache_duration) {
    m_filecache_duration = filecache_duration;
    m_filecache_duration_isSet = true;
}

bool OAIMsSmoothGroupSettings::is_filecache_duration_Set() const{
    return m_filecache_duration_isSet;
}

bool OAIMsSmoothGroupSettings::is_filecache_duration_Valid() const{
...
OAIInputLossActionForMsSmoothOut OAIMsSmoothGroupSettings::getInputLossAction() const {
    return m_input_loss_action;
}
void OAIMsSmoothGroupSettings::setInputLossAction(const OAIInputLossActionForMsSmoothOut &input_loss_action) {
    m_input_loss_action = input_loss_action;
    m_input_loss_action_isSet = true;
}

bool OAIMsSmoothGroupSettings::is_input_loss_action_Set() const{
    return m_input_loss_action_isSet;
}

bool OAIMsSmoothGroupSettings::is_input_loss_action_Valid() const{
    return m_input_loss_action_isValid;
}

qint32 OAIMsSmoothGroupSettings::getNumRetries() const {
    return m_num_retries;
}
void OAIMsSmoothGroupSettings::setNumRetries(const qint32 &num_retries) {
    m_num_retries = num_retries;
    m_num_retries_isSet = true;
}

bool OAIMsSmoothGroupSettings::is_num_retries_Set() const{
    return m_num_retries_isSet;
}

bool OAIMsSmoothGroupSettings::is_num_retries_Valid() const{
    return m_num_retries_isValid;
}

qint32 OAIMsSmoothGroupSettings::getRestartDelay() const {
    return m_restart_delay;
}
void OAIMsSmoothGroupSettings::setRestartDelay(const qint32 &restart_delay) {
    m_restart_delay = restart_delay;
    m_restart_delay_isSet = true;
}

bool OAIMsSmoothGroupSettings::is_restart_delay_Set() const{
    return m_restart_delay_isSet;
}

bool OAIMsSmoothGroupSettings::is_restart_delay_Valid() const{
    return m_restart_delay_isValid;
}

OAISmoothGroupSegmentationMode OAIMsSmoothGroupSettings::getSegmentationMode() const {
    return m_segmentation_mode;
}
void OAIMsSmoothGroupSettings::setSegmentationMode(const OAISmoothGroupSegmentationMode &segmentation_mode) {
    m_segmentation_mode = segmentation_mode;
    m_segmentation_mode_isSet = true;
}

bool OAIMsSmoothGroupSettings::is_segmentation_mode_Set() const{
    return m_segmentation_mode_isSet;
}

bool OAIMsSmoothGroupSettings::is_segmentation_mode_Valid() const{
    return m_segmentation_mode_isValid;
}

qint32 OAIMsSmoothGroupSettings::getSendDelayMs() const {
    return m_send_delay_ms;
}
void OAIMsSmoothGroupSettings::setSendDelayMs(const qint32 &send_delay_ms) {
    m_send_delay_ms = send_delay_ms;
    m_send_delay_ms_isSet = true;
}

bool OAIMsSmoothGroupSettings::is_send_delay_ms_Set() const{
    return m_send_delay_ms_isSet;
}

bool OAIMsSmoothGroupSettings::is_send_delay_ms_Valid() const{
    return m_send_delay_ms_isValid;
}

OAISmoothGroupSparseTrackType OAIMsSmoothGroupSettings::getSparseTrackType() const {
    return m_sparse_track_type;
}
void OAIMsSmoothGroupSettings::setSparseTrackType(const OAISmoothGroupSparseTrackType &sparse_track_type) {
    m_sparse_track_type = sparse_track_type;
    m_sparse_track_type_isSet = true;
}

bool OAIMsSmoothGroupSettings::is_sparse_track_type_Set() const{
    return m_sparse_track_type_isSet;
}

bool OAIMsSmoothGroupSettings::is_sparse_track_type_Valid() const{
    return m_sparse_track_type_isValid;
}

OAISmoothGroupStreamManifestBehavior OAIMsSmoothGroupSettings::getStreamManifestBehavior() const {
    return m_stream_manifest_behavior;
}
void OAIMsSmoothGroupSettings::setStreamManifestBehavior(const OAISmoothGroupStreamManifestBehavior &stream_manifest_behavior) {
    m_stream_manifest_behavior = stream_manifest_behavior;
    m_stream_manifest_behavior_isSet = true;
}

bool OAIMsSmoothGroupSettings::is_stream_manifest_behavior_Set() const{
    return m_stream_manifest_behavior_isSet;
}

bool OAIMsSmoothGroupSettings::is_stream_manifest_behavior_Valid() const{
    return m_stream_manifest_behavior_isValid;
}

QString OAIMsSmoothGroupSettings::getTimestampOffset() const {
    return m_timestamp_offset;
}
void OAIMsSmoothGroupSettings::setTimestampOffset(const QString &timestamp_offset) {
    m_timestamp_offset = timestamp_offset;
    m_timestamp_offset_isSet = true;
}

bool OAIMsSmoothGroupSettings::is_timestamp_offset_Set() const{
    return m_timestamp_offset_isSet;
}

bool OAIMsSmoothGroupSettings::is_timestamp_offset_Valid() const{
    return m_timestamp_offset_isValid;
}

OAISmoothGroupTimestampOffsetMode OAIMsSmoothGroupSettings::getTimestampOffsetMode() const {
    return m_timestamp_offset_mode;
}
void OAIMsSmoothGroupSettings::setTimestampOffsetMode(const OAISmoothGroupTimestampOffsetMode &timestamp_offset_mode) {
    m_timestamp_offset_mode = timestamp_offset_mode;
    m_timestamp_offset_mode_isSet = true;
}

bool OAIMsSmoothGroupSettings::is_timestamp_offset_mode_Set() const{
    return m_timestamp_offset_mode_isSet;
}

bool OAIMsSmoothGroupSettings::is_timestamp_offset_mode_Valid() const{
