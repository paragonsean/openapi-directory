...
/*
 * OAIOutputGroupSettings_HlsGroupSettings.h
 *
 * 
 */

#ifndef OAIOutputGroupSettings_HlsGroupSettings_H
#define OAIOutputGroupSettings_HlsGroupSettings_H
...
class OAIOutputGroupSettings_HlsGroupSettings : public OAIObject {
public:
    OAIOutputGroupSettings_HlsGroupSettings();
    OAIOutputGroupSettings_HlsGroupSettings(QString json);
    ~OAIOutputGroupSettings_HlsGroupSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOutputGroupSettings_HlsGroupSettings)

#endif // OAIOutputGroupSettings_HlsGroupSettings_H
