...
/*
 * OAICreateInputResponse_Input.h
 *
 * 
 */

#ifndef OAICreateInputResponse_Input_H
#define OAICreateInputResponse_Input_H
...
class OAICreateInputResponse_Input : public OAIObject {
public:
    OAICreateInputResponse_Input();
    OAICreateInputResponse_Input(QString json);
    ~OAICreateInputResponse_Input() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateInputResponse_Input)

#endif // OAICreateInputResponse_Input_H
