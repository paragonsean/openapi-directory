...
/*
 * OAIDeleteChannelResponse_EncoderSettings.h
 *
 * 
 */

#ifndef OAIDeleteChannelResponse_EncoderSettings_H
#define OAIDeleteChannelResponse_EncoderSettings_H
...
class OAIDeleteChannelResponse_EncoderSettings : public OAIObject {
public:
    OAIDeleteChannelResponse_EncoderSettings();
    OAIDeleteChannelResponse_EncoderSettings(QString json);
    ~OAIDeleteChannelResponse_EncoderSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteChannelResponse_EncoderSettings)

#endif // OAIDeleteChannelResponse_EncoderSettings_H
