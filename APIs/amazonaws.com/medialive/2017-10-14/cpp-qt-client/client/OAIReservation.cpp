...
QString OAIReservation::getArn() const {
    return m_arn;
}
void OAIReservation::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIReservation::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIReservation::is_arn_Valid() const{
    return m_arn_isValid;
}

qint32 OAIReservation::getCount() const {
    return m_count;
}
void OAIReservation::setCount(const qint32 &count) {
    m_count = count;
    m_count_isSet = true;
}

bool OAIReservation::is_count_Set() const{
    return m_count_isSet;
}

bool OAIReservation::is_count_Valid() const{
    return m_count_isValid;
}

QString OAIReservation::getCurrencyCode() const {
    return m_currency_code;
}
void OAIReservation::setCurrencyCode(const QString &currency_code) {
    m_currency_code = currency_code;
    m_currency_code_isSet = true;
}

bool OAIReservation::is_currency_code_Set() const{
    return m_currency_code_isSet;
}

bool OAIReservation::is_currency_code_Valid() const{
    return m_currency_code_isValid;
}

qint32 OAIReservation::getDuration() const {
    return m_duration;
}
void OAIReservation::setDuration(const qint32 &duration) {
    m_duration = duration;
    m_duration_isSet = true;
}

bool OAIReservation::is_duration_Set() const{
    return m_duration_isSet;
}

bool OAIReservation::is_duration_Valid() const{
    return m_duration_isValid;
}

OAIOfferingDurationUnits OAIReservation::getDurationUnits() const {
    return m_duration_units;
}
void OAIReservation::setDurationUnits(const OAIOfferingDurationUnits &duration_units) {
    m_duration_units = duration_units;
    m_duration_units_isSet = true;
}

bool OAIReservation::is_duration_units_Set() const{
    return m_duration_units_isSet;
}

bool OAIReservation::is_duration_units_Valid() const{
    return m_duration_units_isValid;
}

QString OAIReservation::getEnd() const {
    return m_end;
}
void OAIReservation::setEnd(const QString &end) {
    m_end = end;
    m_end_isSet = true;
}

bool OAIReservation::is_end_Set() const{
    return m_end_isSet;
}

bool OAIReservation::is_end_Valid() const{
    return m_end_isValid;
}

double OAIReservation::getFixedPrice() const {
    return m_fixed_price;
}
void OAIReservation::setFixedPrice(const double &fixed_price) {
    m_fixed_price = fixed_price;
    m_fixed_price_isSet = true;
}

bool OAIReservation::is_fixed_price_Set() const{
    return m_fixed_price_isSet;
}

bool OAIReservation::is_fixed_price_Valid() const{
...
QString OAIReservation::getOfferingDescription() const {
    return m_offering_description;
}
void OAIReservation::setOfferingDescription(const QString &offering_description) {
    m_offering_description = offering_description;
    m_offering_description_isSet = true;
}

bool OAIReservation::is_offering_description_Set() const{
    return m_offering_description_isSet;
}

bool OAIReservation::is_offering_description_Valid() const{
    return m_offering_description_isValid;
}

QString OAIReservation::getOfferingId() const {
    return m_offering_id;
}
void OAIReservation::setOfferingId(const QString &offering_id) {
    m_offering_id = offering_id;
    m_offering_id_isSet = true;
}

bool OAIReservation::is_offering_id_Set() const{
    return m_offering_id_isSet;
}

bool OAIReservation::is_offering_id_Valid() const{
    return m_offering_id_isValid;
}

OAIOfferingType OAIReservation::getOfferingType() const {
    return m_offering_type;
}
void OAIReservation::setOfferingType(const OAIOfferingType &offering_type) {
    m_offering_type = offering_type;
    m_offering_type_isSet = true;
}

bool OAIReservation::is_offering_type_Set() const{
    return m_offering_type_isSet;
}

bool OAIReservation::is_offering_type_Valid() const{
    return m_offering_type_isValid;
}

QString OAIReservation::getRegion() const {
    return m_region;
}
void OAIReservation::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIReservation::is_region_Set() const{
    return m_region_isSet;
}

bool OAIReservation::is_region_Valid() const{
    return m_region_isValid;
}

OAIDeleteReservationResponse_RenewalSettings OAIReservation::getRenewalSettings() const {
    return m_renewal_settings;
}
void OAIReservation::setRenewalSettings(const OAIDeleteReservationResponse_RenewalSettings &renewal_settings) {
    m_renewal_settings = renewal_settings;
    m_renewal_settings_isSet = true;
}

bool OAIReservation::is_renewal_settings_Set() const{
    return m_renewal_settings_isSet;
}

bool OAIReservation::is_renewal_settings_Valid() const{
    return m_renewal_settings_isValid;
}

QString OAIReservation::getReservationId() const {
    return m_reservation_id;
}
void OAIReservation::setReservationId(const QString &reservation_id) {
    m_reservation_id = reservation_id;
    m_reservation_id_isSet = true;
}

bool OAIReservation::is_reservation_id_Set() const{
    return m_reservation_id_isSet;
}

bool OAIReservation::is_reservation_id_Valid() const{
    return m_reservation_id_isValid;
}

OAIDeleteReservationResponse_ResourceSpecification OAIReservation::getResourceSpecification() const {
    return m_resource_specification;
}
void OAIReservation::setResourceSpecification(const OAIDeleteReservationResponse_ResourceSpecification &resource_specification) {
    m_resource_specification = resource_specification;
    m_resource_specification_isSet = true;
}

bool OAIReservation::is_resource_specification_Set() const{
    return m_resource_specification_isSet;
}

bool OAIReservation::is_resource_specification_Valid() const{
    return m_resource_specification_isValid;
}

QString OAIReservation::getStart() const {
    return m_start;
}
void OAIReservation::setStart(const QString &start) {
    m_start = start;
    m_start_isSet = true;
}

bool OAIReservation::is_start_Set() const{
    return m_start_isSet;
}

bool OAIReservation::is_start_Valid() const{
    return m_start_isValid;
}

OAIReservationState OAIReservation::getState() const {
    return m_state;
}
void OAIReservation::setState(const OAIReservationState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIReservation::is_state_Set() const{
    return m_state_isSet;
}

bool OAIReservation::is_state_Valid() const{
    return m_state_isValid;
}

QMap OAIReservation::getTags() const {
    return m_tags;
}
void OAIReservation::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIReservation::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIReservation::is_tags_Valid() const{
    return m_tags_isValid;
}

double OAIReservation::getUsagePrice() const {
    return m_usage_price;
}
void OAIReservation::setUsagePrice(const double &usage_price) {
    m_usage_price = usage_price;
    m_usage_price_isSet = true;
}

bool OAIReservation::is_usage_price_Set() const{
    return m_usage_price_isSet;
}

bool OAIReservation::is_usage_price_Valid() const{
