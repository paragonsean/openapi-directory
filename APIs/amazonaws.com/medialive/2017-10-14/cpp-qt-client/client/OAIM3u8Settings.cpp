...
QString OAIM3u8Settings::getAudioPids() const {
    return m_audio_pids;
}
void OAIM3u8Settings::setAudioPids(const QString &audio_pids) {
...
QString OAIM3u8Settings::getEcmPid() const {
    return m_ecm_pid;
}
void OAIM3u8Settings::setEcmPid(const QString &ecm_pid) {
    m_ecm_pid = ecm_pid;
    m_ecm_pid_isSet = true;
}

bool OAIM3u8Settings::is_ecm_pid_Set() const{
    return m_ecm_pid_isSet;
}

bool OAIM3u8Settings::is_ecm_pid_Valid() const{
    return m_ecm_pid_isValid;
}

OAIM3u8NielsenId3Behavior OAIM3u8Settings::getNielsenId3Behavior() const {
    return m_nielsen_id3_behavior;
}
void OAIM3u8Settings::setNielsenId3Behavior(const OAIM3u8NielsenId3Behavior &nielsen_id3_behavior) {
    m_nielsen_id3_behavior = nielsen_id3_behavior;
    m_nielsen_id3_behavior_isSet = true;
}

bool OAIM3u8Settings::is_nielsen_id3_behavior_Set() const{
    return m_nielsen_id3_behavior_isSet;
}

bool OAIM3u8Settings::is_nielsen_id3_behavior_Valid() const{
...
qint32 OAIM3u8Settings::getPcrPeriod() const {
    return m_pcr_period;
}
void OAIM3u8Settings::setPcrPeriod(const qint32 &pcr_period) {
    m_pcr_period = pcr_period;
    m_pcr_period_isSet = true;
}

bool OAIM3u8Settings::is_pcr_period_Set() const{
    return m_pcr_period_isSet;
}

bool OAIM3u8Settings::is_pcr_period_Valid() const{
    return m_pcr_period_isValid;
}

QString OAIM3u8Settings::getPcrPid() const {
    return m_pcr_pid;
}
void OAIM3u8Settings::setPcrPid(const QString &pcr_pid) {
    m_pcr_pid = pcr_pid;
...
QString OAIM3u8Settings::getPmtPid() const {
    return m_pmt_pid;
}
void OAIM3u8Settings::setPmtPid(const QString &pmt_pid) {
    m_pmt_pid = pmt_pid;
...
qint32 OAIM3u8Settings::getProgramNum() const {
    return m_program_num;
}
void OAIM3u8Settings::setProgramNum(const qint32 &program_num) {
    m_program_num = program_num;
    m_program_num_isSet = true;
}

bool OAIM3u8Settings::is_program_num_Set() const{
    return m_program_num_isSet;
}

bool OAIM3u8Settings::is_program_num_Valid() const{
    return m_program_num_isValid;
}

OAIM3u8Scte35Behavior OAIM3u8Settings::getScte35Behavior() const {
    return m_scte35_behavior;
}
void OAIM3u8Settings::setScte35Behavior(const OAIM3u8Scte35Behavior &scte35_behavior) {
    m_scte35_behavior = scte35_behavior;
    m_scte35_behavior_isSet = true;
}

bool OAIM3u8Settings::is_scte35_behavior_Set() const{
    return m_scte35_behavior_isSet;
}

bool OAIM3u8Settings::is_scte35_behavior_Valid() const{
    return m_scte35_behavior_isValid;
}

QString OAIM3u8Settings::getScte35Pid() const {
    return m_scte35_pid;
}
void OAIM3u8Settings::setScte35Pid(const QString &scte35_pid) {
...
OAIM3u8TimedMetadataBehavior OAIM3u8Settings::getTimedMetadataBehavior() const {
    return m_timed_metadata_behavior;
}
void OAIM3u8Settings::setTimedMetadataBehavior(const OAIM3u8TimedMetadataBehavior &timed_metadata_behavior) {
    m_timed_metadata_behavior = timed_metadata_behavior;
    m_timed_metadata_behavior_isSet = true;
}

bool OAIM3u8Settings::is_timed_metadata_behavior_Set() const{
    return m_timed_metadata_behavior_isSet;
}

bool OAIM3u8Settings::is_timed_metadata_behavior_Valid() const{
    return m_timed_metadata_behavior_isValid;
}

QString OAIM3u8Settings::getTimedMetadataPid() const {
    return m_timed_metadata_pid;
}
void OAIM3u8Settings::setTimedMetadataPid(const QString &timed_metadata_pid) {
...
QString OAIM3u8Settings::getVideoPid() const {
    return m_video_pid;
}
void OAIM3u8Settings::setVideoPid(const QString &video_pid) {
