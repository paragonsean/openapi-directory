...
#include "OAIUdpOutputSettings.h"
...
OAIUdpOutputSettings::OAIUdpOutputSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUdpOutputSettings::OAIUdpOutputSettings() {
    this->initializeModel();
}

OAIUdpOutputSettings::~OAIUdpOutputSettings() {}

void OAIUdpOutputSettings::initializeModel() {
...
void OAIUdpOutputSettings::fromJson(QString jsonString) {
...
void OAIUdpOutputSettings::fromJsonObject(QJsonObject json) {
...
QString OAIUdpOutputSettings::asJson() const {
...
QJsonObject OAIUdpOutputSettings::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIUdpOutputSettings::getBufferMsec() const {
    return m_buffer_msec;
}
void OAIUdpOutputSettings::setBufferMsec(const qint32 &buffer_msec) {
    m_buffer_msec = buffer_msec;
    m_buffer_msec_isSet = true;
}

bool OAIUdpOutputSettings::is_buffer_msec_Set() const{
    return m_buffer_msec_isSet;
}

bool OAIUdpOutputSettings::is_buffer_msec_Valid() const{
    return m_buffer_msec_isValid;
}

OAIUdpOutputSettings_ContainerSettings OAIUdpOutputSettings::getContainerSettings() const {
    return m_container_settings;
}
void OAIUdpOutputSettings::setContainerSettings(const OAIUdpOutputSettings_ContainerSettings &container_settings) {
    m_container_settings = container_settings;
    m_container_settings_isSet = true;
}

bool OAIUdpOutputSettings::is_container_settings_Set() const{
    return m_container_settings_isSet;
}

bool OAIUdpOutputSettings::is_container_settings_Valid() const{
    return m_container_settings_isValid;
}

OAIUdpOutputSettings_Destination OAIUdpOutputSettings::getDestination() const {
    return m_destination;
}
void OAIUdpOutputSettings::setDestination(const OAIUdpOutputSettings_Destination &destination) {
    m_destination = destination;
    m_destination_isSet = true;
}

bool OAIUdpOutputSettings::is_destination_Set() const{
    return m_destination_isSet;
}

bool OAIUdpOutputSettings::is_destination_Valid() const{
    return m_destination_isValid;
}

OAIUdpOutputSettings_FecOutputSettings OAIUdpOutputSettings::getFecOutputSettings() const {
    return m_fec_output_settings;
}
void OAIUdpOutputSettings::setFecOutputSettings(const OAIUdpOutputSettings_FecOutputSettings &fec_output_settings) {
    m_fec_output_settings = fec_output_settings;
    m_fec_output_settings_isSet = true;
}

bool OAIUdpOutputSettings::is_fec_output_settings_Set() const{
    return m_fec_output_settings_isSet;
}

bool OAIUdpOutputSettings::is_fec_output_settings_Valid() const{
    return m_fec_output_settings_isValid;
}

bool OAIUdpOutputSettings::isSet() const {
...
bool OAIUdpOutputSettings::isValid() const {
