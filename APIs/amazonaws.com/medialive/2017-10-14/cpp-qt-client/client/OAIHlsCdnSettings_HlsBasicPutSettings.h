...
/*
 * OAIHlsCdnSettings_HlsBasicPutSettings.h
 *
 * 
 */

#ifndef OAIHlsCdnSettings_HlsBasicPutSettings_H
#define OAIHlsCdnSettings_HlsBasicPutSettings_H
...
class OAIHlsCdnSettings_HlsBasicPutSettings : public OAIObject {
public:
    OAIHlsCdnSettings_HlsBasicPutSettings();
    OAIHlsCdnSettings_HlsBasicPutSettings(QString json);
    ~OAIHlsCdnSettings_HlsBasicPutSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHlsCdnSettings_HlsBasicPutSettings)

#endif // OAIHlsCdnSettings_HlsBasicPutSettings_H
