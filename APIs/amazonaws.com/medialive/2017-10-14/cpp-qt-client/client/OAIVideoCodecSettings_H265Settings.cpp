...
OAIAfdSignaling OAIVideoCodecSettings_H265Settings::getAfdSignaling() const {
    return m_afd_signaling;
}
void OAIVideoCodecSettings_H265Settings::setAfdSignaling(const OAIAfdSignaling &afd_signaling) {
    m_afd_signaling = afd_signaling;
    m_afd_signaling_isSet = true;
}

bool OAIVideoCodecSettings_H265Settings::is_afd_signaling_Set() const{
    return m_afd_signaling_isSet;
}

bool OAIVideoCodecSettings_H265Settings::is_afd_signaling_Valid() const{
    return m_afd_signaling_isValid;
}

OAIH265AlternativeTransferFunction OAIVideoCodecSettings_H265Settings::getAlternativeTransferFunction() const {
    return m_alternative_transfer_function;
}
void OAIVideoCodecSettings_H265Settings::setAlternativeTransferFunction(const OAIH265AlternativeTransferFunction &alternative_transfer_function) {
    m_alternative_transfer_function = alternative_transfer_function;
    m_alternative_transfer_function_isSet = true;
}

bool OAIVideoCodecSettings_H265Settings::is_alternative_transfer_function_Set() const{
    return m_alternative_transfer_function_isSet;
}

bool OAIVideoCodecSettings_H265Settings::is_alternative_transfer_function_Valid() const{
...
qint32 OAIVideoCodecSettings_H265Settings::getBufSize() const {
    return m_buf_size;
}
void OAIVideoCodecSettings_H265Settings::setBufSize(const qint32 &buf_size) {
    m_buf_size = buf_size;
    m_buf_size_isSet = true;
}

bool OAIVideoCodecSettings_H265Settings::is_buf_size_Set() const{
    return m_buf_size_isSet;
}

bool OAIVideoCodecSettings_H265Settings::is_buf_size_Valid() const{
    return m_buf_size_isValid;
}

OAIH265ColorMetadata OAIVideoCodecSettings_H265Settings::getColorMetadata() const {
    return m_color_metadata;
}
void OAIVideoCodecSettings_H265Settings::setColorMetadata(const OAIH265ColorMetadata &color_metadata) {
    m_color_metadata = color_metadata;
    m_color_metadata_isSet = true;
}

bool OAIVideoCodecSettings_H265Settings::is_color_metadata_Set() const{
    return m_color_metadata_isSet;
}

bool OAIVideoCodecSettings_H265Settings::is_color_metadata_Valid() const{
    return m_color_metadata_isValid;
}

OAIH265Settings_ColorSpaceSettings OAIVideoCodecSettings_H265Settings::getColorSpaceSettings() const {
    return m_color_space_settings;
}
void OAIVideoCodecSettings_H265Settings::setColorSpaceSettings(const OAIH265Settings_ColorSpaceSettings &color_space_settings) {
    m_color_space_settings = color_space_settings;
    m_color_space_settings_isSet = true;
}

bool OAIVideoCodecSettings_H265Settings::is_color_space_settings_Set() const{
    return m_color_space_settings_isSet;
}

bool OAIVideoCodecSettings_H265Settings::is_color_space_settings_Valid() const{
    return m_color_space_settings_isValid;
}

OAIH265Settings_FilterSettings OAIVideoCodecSettings_H265Settings::getFilterSettings() const {
    return m_filter_settings;
}
void OAIVideoCodecSettings_H265Settings::setFilterSettings(const OAIH265Settings_FilterSettings &filter_settings) {
    m_filter_settings = filter_settings;
    m_filter_settings_isSet = true;
}

bool OAIVideoCodecSettings_H265Settings::is_filter_settings_Set() const{
    return m_filter_settings_isSet;
}

bool OAIVideoCodecSettings_H265Settings::is_filter_settings_Valid() const{
    return m_filter_settings_isValid;
}

OAIFixedAfd OAIVideoCodecSettings_H265Settings::getFixedAfd() const {
    return m_fixed_afd;
}
void OAIVideoCodecSettings_H265Settings::setFixedAfd(const OAIFixedAfd &fixed_afd) {
    m_fixed_afd = fixed_afd;
    m_fixed_afd_isSet = true;
}

bool OAIVideoCodecSettings_H265Settings::is_fixed_afd_Set() const{
    return m_fixed_afd_isSet;
}

bool OAIVideoCodecSettings_H265Settings::is_fixed_afd_Valid() const{
    return m_fixed_afd_isValid;
}

OAIH265FlickerAq OAIVideoCodecSettings_H265Settings::getFlickerAq() const {
    return m_flicker_aq;
}
void OAIVideoCodecSettings_H265Settings::setFlickerAq(const OAIH265FlickerAq &flicker_aq) {
    m_flicker_aq = flicker_aq;
    m_flicker_aq_isSet = true;
}

bool OAIVideoCodecSettings_H265Settings::is_flicker_aq_Set() const{
    return m_flicker_aq_isSet;
}

bool OAIVideoCodecSettings_H265Settings::is_flicker_aq_Valid() const{
...
OAIH265Level OAIVideoCodecSettings_H265Settings::getLevel() const {
    return m_level;
}
void OAIVideoCodecSettings_H265Settings::setLevel(const OAIH265Level &level) {
    m_level = level;
    m_level_isSet = true;
}

bool OAIVideoCodecSettings_H265Settings::is_level_Set() const{
    return m_level_isSet;
}

bool OAIVideoCodecSettings_H265Settings::is_level_Valid() const{
    return m_level_isValid;
}

OAIH265LookAheadRateControl OAIVideoCodecSettings_H265Settings::getLookAheadRateControl() const {
    return m_look_ahead_rate_control;
}
void OAIVideoCodecSettings_H265Settings::setLookAheadRateControl(const OAIH265LookAheadRateControl &look_ahead_rate_control) {
    m_look_ahead_rate_control = look_ahead_rate_control;
    m_look_ahead_rate_control_isSet = true;
}

bool OAIVideoCodecSettings_H265Settings::is_look_ahead_rate_control_Set() const{
    return m_look_ahead_rate_control_isSet;
}

bool OAIVideoCodecSettings_H265Settings::is_look_ahead_rate_control_Valid() const{
...
OAIH265Profile OAIVideoCodecSettings_H265Settings::getProfile() const {
    return m_profile;
}
void OAIVideoCodecSettings_H265Settings::setProfile(const OAIH265Profile &profile) {
    m_profile = profile;
    m_profile_isSet = true;
}

bool OAIVideoCodecSettings_H265Settings::is_profile_Set() const{
    return m_profile_isSet;
}

bool OAIVideoCodecSettings_H265Settings::is_profile_Valid() const{
    return m_profile_isValid;
}

qint32 OAIVideoCodecSettings_H265Settings::getQvbrQualityLevel() const {
    return m_qvbr_quality_level;
}
void OAIVideoCodecSettings_H265Settings::setQvbrQualityLevel(const qint32 &qvbr_quality_level) {
    m_qvbr_quality_level = qvbr_quality_level;
    m_qvbr_quality_level_isSet = true;
}

bool OAIVideoCodecSettings_H265Settings::is_qvbr_quality_level_Set() const{
    return m_qvbr_quality_level_isSet;
}

bool OAIVideoCodecSettings_H265Settings::is_qvbr_quality_level_Valid() const{
...
OAIH265ScanType OAIVideoCodecSettings_H265Settings::getScanType() const {
    return m_scan_type;
}
void OAIVideoCodecSettings_H265Settings::setScanType(const OAIH265ScanType &scan_type) {
    m_scan_type = scan_type;
    m_scan_type_isSet = true;
}

bool OAIVideoCodecSettings_H265Settings::is_scan_type_Set() const{
    return m_scan_type_isSet;
}

bool OAIVideoCodecSettings_H265Settings::is_scan_type_Valid() const{
...
OAIH265Tier OAIVideoCodecSettings_H265Settings::getTier() const {
    return m_tier;
}
void OAIVideoCodecSettings_H265Settings::setTier(const OAIH265Tier &tier) {
    m_tier = tier;
    m_tier_isSet = true;
}

bool OAIVideoCodecSettings_H265Settings::is_tier_Set() const{
    return m_tier_isSet;
}

bool OAIVideoCodecSettings_H265Settings::is_tier_Valid() const{
    return m_tier_isValid;
}

OAIH265TimecodeInsertionBehavior OAIVideoCodecSettings_H265Settings::getTimecodeInsertion() const {
    return m_timecode_insertion;
}
void OAIVideoCodecSettings_H265Settings::setTimecodeInsertion(const OAIH265TimecodeInsertionBehavior &timecode_insertion) {
    m_timecode_insertion = timecode_insertion;
    m_timecode_insertion_isSet = true;
}

bool OAIVideoCodecSettings_H265Settings::is_timecode_insertion_Set() const{
    return m_timecode_insertion_isSet;
}

bool OAIVideoCodecSettings_H265Settings::is_timecode_insertion_Valid() const{
    return m_timecode_insertion_isValid;
}

OAIFrameCaptureSettings_TimecodeBurninSettings OAIVideoCodecSettings_H265Settings::getTimecodeBurninSettings() const {
    return m_timecode_burnin_settings;
}
void OAIVideoCodecSettings_H265Settings::setTimecodeBurninSettings(const OAIFrameCaptureSettings_TimecodeBurninSettings &timecode_burnin_settings) {
    m_timecode_burnin_settings = timecode_burnin_settings;
    m_timecode_burnin_settings_isSet = true;
}

bool OAIVideoCodecSettings_H265Settings::is_timecode_burnin_settings_Set() const{
    return m_timecode_burnin_settings_isSet;
}

bool OAIVideoCodecSettings_H265Settings::is_timecode_burnin_settings_Valid() const{
