...
OAIDeleteChannelResponse_CdiInputSpecification OAIChannel::getCdiInputSpecification() const {
    return m_cdi_input_specification;
}
void OAIChannel::setCdiInputSpecification(const OAIDeleteChannelResponse_CdiInputSpecification &cdi_input_specification) {
    m_cdi_input_specification = cdi_input_specification;
    m_cdi_input_specification_isSet = true;
}

bool OAIChannel::is_cdi_input_specification_Set() const{
    return m_cdi_input_specification_isSet;
}

bool OAIChannel::is_cdi_input_specification_Valid() const{
    return m_cdi_input_specification_isValid;
}

OAIChannelClass OAIChannel::getChannelClass() const {
    return m_channel_class;
}
void OAIChannel::setChannelClass(const OAIChannelClass &channel_class) {
    m_channel_class = channel_class;
    m_channel_class_isSet = true;
}

bool OAIChannel::is_channel_class_Set() const{
    return m_channel_class_isSet;
}

bool OAIChannel::is_channel_class_Valid() const{
    return m_channel_class_isValid;
}

QList OAIChannel::getDestinations() const {
    return m_destinations;
}
void OAIChannel::setDestinations(const QList &destinations) {
    m_destinations = destinations;
    m_destinations_isSet = true;
}

bool OAIChannel::is_destinations_Set() const{
    return m_destinations_isSet;
}

bool OAIChannel::is_destinations_Valid() const{
    return m_destinations_isValid;
}

QList OAIChannel::getEgressEndpoints() const {
    return m_egress_endpoints;
}
void OAIChannel::setEgressEndpoints(const QList &egress_endpoints) {
    m_egress_endpoints = egress_endpoints;
    m_egress_endpoints_isSet = true;
}

bool OAIChannel::is_egress_endpoints_Set() const{
    return m_egress_endpoints_isSet;
}

bool OAIChannel::is_egress_endpoints_Valid() const{
    return m_egress_endpoints_isValid;
}

OAIDeleteChannelResponse_EncoderSettings OAIChannel::getEncoderSettings() const {
    return m_encoder_settings;
}
void OAIChannel::setEncoderSettings(const OAIDeleteChannelResponse_EncoderSettings &encoder_settings) {
    m_encoder_settings = encoder_settings;
    m_encoder_settings_isSet = true;
}

bool OAIChannel::is_encoder_settings_Set() const{
    return m_encoder_settings_isSet;
}

bool OAIChannel::is_encoder_settings_Valid() const{
...
QList OAIChannel::getInputAttachments() const {
    return m_input_attachments;
}
void OAIChannel::setInputAttachments(const QList &input_attachments) {
    m_input_attachments = input_attachments;
    m_input_attachments_isSet = true;
}

bool OAIChannel::is_input_attachments_Set() const{
    return m_input_attachments_isSet;
}

bool OAIChannel::is_input_attachments_Valid() const{
    return m_input_attachments_isValid;
}

OAIDeleteChannelResponse_InputSpecification OAIChannel::getInputSpecification() const {
    return m_input_specification;
}
void OAIChannel::setInputSpecification(const OAIDeleteChannelResponse_InputSpecification &input_specification) {
    m_input_specification = input_specification;
    m_input_specification_isSet = true;
}

bool OAIChannel::is_input_specification_Set() const{
    return m_input_specification_isSet;
}

bool OAIChannel::is_input_specification_Valid() const{
    return m_input_specification_isValid;
}

OAILogLevel OAIChannel::getLogLevel() const {
    return m_log_level;
}
void OAIChannel::setLogLevel(const OAILogLevel &log_level) {
    m_log_level = log_level;
    m_log_level_isSet = true;
}

bool OAIChannel::is_log_level_Set() const{
    return m_log_level_isSet;
}

bool OAIChannel::is_log_level_Valid() const{
    return m_log_level_isValid;
}

OAIDeleteChannelResponse_Maintenance OAIChannel::getMaintenance() const {
    return m_maintenance;
}
void OAIChannel::setMaintenance(const OAIDeleteChannelResponse_Maintenance &maintenance) {
    m_maintenance = maintenance;
    m_maintenance_isSet = true;
}

bool OAIChannel::is_maintenance_Set() const{
    return m_maintenance_isSet;
}

bool OAIChannel::is_maintenance_Valid() const{
...
QList OAIChannel::getPipelineDetails() const {
    return m_pipeline_details;
}
void OAIChannel::setPipelineDetails(const QList &pipeline_details) {
    m_pipeline_details = pipeline_details;
    m_pipeline_details_isSet = true;
}

bool OAIChannel::is_pipeline_details_Set() const{
    return m_pipeline_details_isSet;
}

bool OAIChannel::is_pipeline_details_Valid() const{
    return m_pipeline_details_isValid;
}

qint32 OAIChannel::getPipelinesRunningCount() const {
    return m_pipelines_running_count;
}
void OAIChannel::setPipelinesRunningCount(const qint32 &pipelines_running_count) {
    m_pipelines_running_count = pipelines_running_count;
    m_pipelines_running_count_isSet = true;
}

bool OAIChannel::is_pipelines_running_count_Set() const{
    return m_pipelines_running_count_isSet;
}

bool OAIChannel::is_pipelines_running_count_Valid() const{
    return m_pipelines_running_count_isValid;
}

QString OAIChannel::getRoleArn() const {
    return m_role_arn;
}
void OAIChannel::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIChannel::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIChannel::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

OAIChannelState OAIChannel::getState() const {
    return m_state;
}
void OAIChannel::setState(const OAIChannelState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIChannel::is_state_Set() const{
    return m_state_isSet;
}

bool OAIChannel::is_state_Valid() const{
...
OAIDeleteChannelResponse_Vpc OAIChannel::getVpc() const {
    return m_vpc;
}
void OAIChannel::setVpc(const OAIDeleteChannelResponse_Vpc &vpc) {
    m_vpc = vpc;
    m_vpc_isSet = true;
}

bool OAIChannel::is_vpc_Set() const{
    return m_vpc_isSet;
}

bool OAIChannel::is_vpc_Valid() const{
