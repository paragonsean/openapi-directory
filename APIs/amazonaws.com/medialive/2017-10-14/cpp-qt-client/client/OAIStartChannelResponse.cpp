...
OAIStartChannelResponse::OAIStartChannelResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartChannelResponse::OAIStartChannelResponse() {
    this->initializeModel();
}

OAIStartChannelResponse::~OAIStartChannelResponse() {}

void OAIStartChannelResponse::initializeModel() {
...
void OAIStartChannelResponse::fromJson(QString jsonString) {
...
void OAIStartChannelResponse::fromJsonObject(QJsonObject json) {
...
QString OAIStartChannelResponse::asJson() const {
...
QJsonObject OAIStartChannelResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIStartChannelResponse::getArn() const {
    return m_arn;
}
void OAIStartChannelResponse::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIStartChannelResponse::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIStartChannelResponse::is_arn_Valid() const{
    return m_arn_isValid;
}

OAIDeleteChannelResponse_CdiInputSpecification OAIStartChannelResponse::getCdiInputSpecification() const {
    return m_cdi_input_specification;
}
void OAIStartChannelResponse::setCdiInputSpecification(const OAIDeleteChannelResponse_CdiInputSpecification &cdi_input_specification) {
    m_cdi_input_specification = cdi_input_specification;
    m_cdi_input_specification_isSet = true;
}

bool OAIStartChannelResponse::is_cdi_input_specification_Set() const{
    return m_cdi_input_specification_isSet;
}

bool OAIStartChannelResponse::is_cdi_input_specification_Valid() const{
    return m_cdi_input_specification_isValid;
}

OAIChannelClass OAIStartChannelResponse::getChannelClass() const {
    return m_channel_class;
}
void OAIStartChannelResponse::setChannelClass(const OAIChannelClass &channel_class) {
    m_channel_class = channel_class;
    m_channel_class_isSet = true;
}

bool OAIStartChannelResponse::is_channel_class_Set() const{
    return m_channel_class_isSet;
}

bool OAIStartChannelResponse::is_channel_class_Valid() const{
    return m_channel_class_isValid;
}

QList OAIStartChannelResponse::getDestinations() const {
    return m_destinations;
}
void OAIStartChannelResponse::setDestinations(const QList &destinations) {
    m_destinations = destinations;
    m_destinations_isSet = true;
}

bool OAIStartChannelResponse::is_destinations_Set() const{
    return m_destinations_isSet;
}

bool OAIStartChannelResponse::is_destinations_Valid() const{
    return m_destinations_isValid;
}

QList OAIStartChannelResponse::getEgressEndpoints() const {
    return m_egress_endpoints;
}
void OAIStartChannelResponse::setEgressEndpoints(const QList &egress_endpoints) {
    m_egress_endpoints = egress_endpoints;
    m_egress_endpoints_isSet = true;
}

bool OAIStartChannelResponse::is_egress_endpoints_Set() const{
    return m_egress_endpoints_isSet;
}

bool OAIStartChannelResponse::is_egress_endpoints_Valid() const{
    return m_egress_endpoints_isValid;
}

OAIDeleteChannelResponse_EncoderSettings OAIStartChannelResponse::getEncoderSettings() const {
    return m_encoder_settings;
}
void OAIStartChannelResponse::setEncoderSettings(const OAIDeleteChannelResponse_EncoderSettings &encoder_settings) {
    m_encoder_settings = encoder_settings;
    m_encoder_settings_isSet = true;
}

bool OAIStartChannelResponse::is_encoder_settings_Set() const{
    return m_encoder_settings_isSet;
}

bool OAIStartChannelResponse::is_encoder_settings_Valid() const{
    return m_encoder_settings_isValid;
}

QString OAIStartChannelResponse::getId() const {
    return m_id;
}
void OAIStartChannelResponse::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIStartChannelResponse::is_id_Set() const{
    return m_id_isSet;
}

bool OAIStartChannelResponse::is_id_Valid() const{
    return m_id_isValid;
}

QList OAIStartChannelResponse::getInputAttachments() const {
    return m_input_attachments;
}
void OAIStartChannelResponse::setInputAttachments(const QList &input_attachments) {
    m_input_attachments = input_attachments;
    m_input_attachments_isSet = true;
}

bool OAIStartChannelResponse::is_input_attachments_Set() const{
    return m_input_attachments_isSet;
}

bool OAIStartChannelResponse::is_input_attachments_Valid() const{
    return m_input_attachments_isValid;
}

OAIDeleteChannelResponse_InputSpecification OAIStartChannelResponse::getInputSpecification() const {
    return m_input_specification;
}
void OAIStartChannelResponse::setInputSpecification(const OAIDeleteChannelResponse_InputSpecification &input_specification) {
    m_input_specification = input_specification;
    m_input_specification_isSet = true;
}

bool OAIStartChannelResponse::is_input_specification_Set() const{
    return m_input_specification_isSet;
}

bool OAIStartChannelResponse::is_input_specification_Valid() const{
    return m_input_specification_isValid;
}

OAILogLevel OAIStartChannelResponse::getLogLevel() const {
    return m_log_level;
}
void OAIStartChannelResponse::setLogLevel(const OAILogLevel &log_level) {
    m_log_level = log_level;
    m_log_level_isSet = true;
}

bool OAIStartChannelResponse::is_log_level_Set() const{
    return m_log_level_isSet;
}

bool OAIStartChannelResponse::is_log_level_Valid() const{
    return m_log_level_isValid;
}

OAIDeleteChannelResponse_Maintenance OAIStartChannelResponse::getMaintenance() const {
    return m_maintenance;
}
void OAIStartChannelResponse::setMaintenance(const OAIDeleteChannelResponse_Maintenance &maintenance) {
    m_maintenance = maintenance;
    m_maintenance_isSet = true;
}

bool OAIStartChannelResponse::is_maintenance_Set() const{
    return m_maintenance_isSet;
}

bool OAIStartChannelResponse::is_maintenance_Valid() const{
    return m_maintenance_isValid;
}

QString OAIStartChannelResponse::getName() const {
    return m_name;
}
void OAIStartChannelResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIStartChannelResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAIStartChannelResponse::is_name_Valid() const{
    return m_name_isValid;
}

QList OAIStartChannelResponse::getPipelineDetails() const {
    return m_pipeline_details;
}
void OAIStartChannelResponse::setPipelineDetails(const QList &pipeline_details) {
    m_pipeline_details = pipeline_details;
    m_pipeline_details_isSet = true;
}

bool OAIStartChannelResponse::is_pipeline_details_Set() const{
    return m_pipeline_details_isSet;
}

bool OAIStartChannelResponse::is_pipeline_details_Valid() const{
    return m_pipeline_details_isValid;
}

qint32 OAIStartChannelResponse::getPipelinesRunningCount() const {
    return m_pipelines_running_count;
}
void OAIStartChannelResponse::setPipelinesRunningCount(const qint32 &pipelines_running_count) {
    m_pipelines_running_count = pipelines_running_count;
    m_pipelines_running_count_isSet = true;
}

bool OAIStartChannelResponse::is_pipelines_running_count_Set() const{
    return m_pipelines_running_count_isSet;
}

bool OAIStartChannelResponse::is_pipelines_running_count_Valid() const{
    return m_pipelines_running_count_isValid;
}

QString OAIStartChannelResponse::getRoleArn() const {
    return m_role_arn;
}
void OAIStartChannelResponse::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIStartChannelResponse::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIStartChannelResponse::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

OAIChannelState OAIStartChannelResponse::getState() const {
    return m_state;
}
void OAIStartChannelResponse::setState(const OAIChannelState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIStartChannelResponse::is_state_Set() const{
    return m_state_isSet;
}

bool OAIStartChannelResponse::is_state_Valid() const{
    return m_state_isValid;
}

QMap OAIStartChannelResponse::getTags() const {
    return m_tags;
}
void OAIStartChannelResponse::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIStartChannelResponse::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIStartChannelResponse::is_tags_Valid() const{
    return m_tags_isValid;
}

OAIDeleteChannelResponse_Vpc OAIStartChannelResponse::getVpc() const {
    return m_vpc;
}
void OAIStartChannelResponse::setVpc(const OAIDeleteChannelResponse_Vpc &vpc) {
    m_vpc = vpc;
    m_vpc_isSet = true;
}

bool OAIStartChannelResponse::is_vpc_Set() const{
    return m_vpc_isSet;
}

bool OAIStartChannelResponse::is_vpc_Valid() const{
    return m_vpc_isValid;
}

bool OAIStartChannelResponse::isSet() const {
...
bool OAIStartChannelResponse::isValid() const {
