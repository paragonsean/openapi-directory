...
/*
 * OAIHlsCdnSettings_HlsWebdavSettings.h
 *
 * 
 */

#ifndef OAIHlsCdnSettings_HlsWebdavSettings_H
#define OAIHlsCdnSettings_HlsWebdavSettings_H
...
class OAIHlsCdnSettings_HlsWebdavSettings : public OAIObject {
public:
    OAIHlsCdnSettings_HlsWebdavSettings();
    OAIHlsCdnSettings_HlsWebdavSettings(QString json);
    ~OAIHlsCdnSettings_HlsWebdavSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHlsCdnSettings_HlsWebdavSettings)

#endif // OAIHlsCdnSettings_HlsWebdavSettings_H
