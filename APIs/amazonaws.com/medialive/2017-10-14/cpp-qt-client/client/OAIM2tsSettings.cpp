...
OAIM2tsAbsentInputAudioBehavior OAIM2tsSettings::getAbsentInputAudioBehavior() const {
    return m_absent_input_audio_behavior;
}
void OAIM2tsSettings::setAbsentInputAudioBehavior(const OAIM2tsAbsentInputAudioBehavior &absent_input_audio_behavior) {
    m_absent_input_audio_behavior = absent_input_audio_behavior;
    m_absent_input_audio_behavior_isSet = true;
}

bool OAIM2tsSettings::is_absent_input_audio_behavior_Set() const{
    return m_absent_input_audio_behavior_isSet;
}

bool OAIM2tsSettings::is_absent_input_audio_behavior_Valid() const{
    return m_absent_input_audio_behavior_isValid;
}

OAIM2tsArib OAIM2tsSettings::getArib() const {
    return m_arib;
}
void OAIM2tsSettings::setArib(const OAIM2tsArib &arib) {
    m_arib = arib;
    m_arib_isSet = true;
}

bool OAIM2tsSettings::is_arib_Set() const{
    return m_arib_isSet;
}

bool OAIM2tsSettings::is_arib_Valid() const{
    return m_arib_isValid;
}

QString OAIM2tsSettings::getAribCaptionsPid() const {
    return m_arib_captions_pid;
}
void OAIM2tsSettings::setAribCaptionsPid(const QString &arib_captions_pid) {
    m_arib_captions_pid = arib_captions_pid;
    m_arib_captions_pid_isSet = true;
}

bool OAIM2tsSettings::is_arib_captions_pid_Set() const{
    return m_arib_captions_pid_isSet;
}

bool OAIM2tsSettings::is_arib_captions_pid_Valid() const{
    return m_arib_captions_pid_isValid;
}

OAIM2tsAribCaptionsPidControl OAIM2tsSettings::getAribCaptionsPidControl() const {
    return m_arib_captions_pid_control;
}
void OAIM2tsSettings::setAribCaptionsPidControl(const OAIM2tsAribCaptionsPidControl &arib_captions_pid_control) {
    m_arib_captions_pid_control = arib_captions_pid_control;
    m_arib_captions_pid_control_isSet = true;
}

bool OAIM2tsSettings::is_arib_captions_pid_control_Set() const{
    return m_arib_captions_pid_control_isSet;
}

bool OAIM2tsSettings::is_arib_captions_pid_control_Valid() const{
...
QString OAIM2tsSettings::getAudioPids() const {
    return m_audio_pids;
}
void OAIM2tsSettings::setAudioPids(const QString &audio_pids) {
...
OAIM2tsAudioStreamType OAIM2tsSettings::getAudioStreamType() const {
    return m_audio_stream_type;
}
void OAIM2tsSettings::setAudioStreamType(const OAIM2tsAudioStreamType &audio_stream_type) {
    m_audio_stream_type = audio_stream_type;
    m_audio_stream_type_isSet = true;
}

bool OAIM2tsSettings::is_audio_stream_type_Set() const{
    return m_audio_stream_type_isSet;
}

bool OAIM2tsSettings::is_audio_stream_type_Valid() const{
...
OAIM2tsCcDescriptor OAIM2tsSettings::getCcDescriptor() const {
    return m_cc_descriptor;
}
void OAIM2tsSettings::setCcDescriptor(const OAIM2tsCcDescriptor &cc_descriptor) {
    m_cc_descriptor = cc_descriptor;
    m_cc_descriptor_isSet = true;
}

bool OAIM2tsSettings::is_cc_descriptor_Set() const{
    return m_cc_descriptor_isSet;
}

bool OAIM2tsSettings::is_cc_descriptor_Valid() const{
...
QString OAIM2tsSettings::getDvbSubPids() const {
    return m_dvb_sub_pids;
}
void OAIM2tsSettings::setDvbSubPids(const QString &dvb_sub_pids) {
...
QString OAIM2tsSettings::getDvbTeletextPid() const {
    return m_dvb_teletext_pid;
}
void OAIM2tsSettings::setDvbTeletextPid(const QString &dvb_teletext_pid) {
...
OAIM2tsEbifControl OAIM2tsSettings::getEbif() const {
    return m_ebif;
}
void OAIM2tsSettings::setEbif(const OAIM2tsEbifControl &ebif) {
    m_ebif = ebif;
    m_ebif_isSet = true;
}

bool OAIM2tsSettings::is_ebif_Set() const{
    return m_ebif_isSet;
}

bool OAIM2tsSettings::is_ebif_Valid() const{
    return m_ebif_isValid;
}

OAIM2tsAudioInterval OAIM2tsSettings::getEbpAudioInterval() const {
    return m_ebp_audio_interval;
}
void OAIM2tsSettings::setEbpAudioInterval(const OAIM2tsAudioInterval &ebp_audio_interval) {
...
qint32 OAIM2tsSettings::getEbpLookaheadMs() const {
    return m_ebp_lookahead_ms;
}
void OAIM2tsSettings::setEbpLookaheadMs(const qint32 &ebp_lookahead_ms) {
    m_ebp_lookahead_ms = ebp_lookahead_ms;
    m_ebp_lookahead_ms_isSet = true;
}

bool OAIM2tsSettings::is_ebp_lookahead_ms_Set() const{
    return m_ebp_lookahead_ms_isSet;
}

bool OAIM2tsSettings::is_ebp_lookahead_ms_Valid() const{
...
QString OAIM2tsSettings::getEcmPid() const {
    return m_ecm_pid;
}
void OAIM2tsSettings::setEcmPid(const QString &ecm_pid) {
    m_ecm_pid = ecm_pid;
    m_ecm_pid_isSet = true;
}

bool OAIM2tsSettings::is_ecm_pid_Set() const{
    return m_ecm_pid_isSet;
}

bool OAIM2tsSettings::is_ecm_pid_Valid() const{
...
QString OAIM2tsSettings::getEtvPlatformPid() const {
    return m_etv_platform_pid;
}
void OAIM2tsSettings::setEtvPlatformPid(const QString &etv_platform_pid) {
    m_etv_platform_pid = etv_platform_pid;
    m_etv_platform_pid_isSet = true;
}

bool OAIM2tsSettings::is_etv_platform_pid_Set() const{
    return m_etv_platform_pid_isSet;
}

bool OAIM2tsSettings::is_etv_platform_pid_Valid() const{
    return m_etv_platform_pid_isValid;
}

QString OAIM2tsSettings::getEtvSignalPid() const {
    return m_etv_signal_pid;
}
void OAIM2tsSettings::setEtvSignalPid(const QString &etv_signal_pid) {
    m_etv_signal_pid = etv_signal_pid;
    m_etv_signal_pid_isSet = true;
}

bool OAIM2tsSettings::is_etv_signal_pid_Set() const{
    return m_etv_signal_pid_isSet;
}

bool OAIM2tsSettings::is_etv_signal_pid_Valid() const{
...
OAIM2tsKlv OAIM2tsSettings::getKlv() const {
    return m_klv;
}
void OAIM2tsSettings::setKlv(const OAIM2tsKlv &klv) {
    m_klv = klv;
    m_klv_isSet = true;
}

bool OAIM2tsSettings::is_klv_Set() const{
    return m_klv_isSet;
}

bool OAIM2tsSettings::is_klv_Valid() const{
    return m_klv_isValid;
}

QString OAIM2tsSettings::getKlvDataPids() const {
    return m_klv_data_pids;
}
void OAIM2tsSettings::setKlvDataPids(const QString &klv_data_pids) {
    m_klv_data_pids = klv_data_pids;
    m_klv_data_pids_isSet = true;
}

bool OAIM2tsSettings::is_klv_data_pids_Set() const{
    return m_klv_data_pids_isSet;
}

bool OAIM2tsSettings::is_klv_data_pids_Valid() const{
    return m_klv_data_pids_isValid;
}

OAIM2tsNielsenId3Behavior OAIM2tsSettings::getNielsenId3Behavior() const {
    return m_nielsen_id3_behavior;
}
void OAIM2tsSettings::setNielsenId3Behavior(const OAIM2tsNielsenId3Behavior &nielsen_id3_behavior) {
    m_nielsen_id3_behavior = nielsen_id3_behavior;
    m_nielsen_id3_behavior_isSet = true;
}

bool OAIM2tsSettings::is_nielsen_id3_behavior_Set() const{
    return m_nielsen_id3_behavior_isSet;
}

bool OAIM2tsSettings::is_nielsen_id3_behavior_Valid() const{
...
qint32 OAIM2tsSettings::getPcrPeriod() const {
    return m_pcr_period;
}
void OAIM2tsSettings::setPcrPeriod(const qint32 &pcr_period) {
    m_pcr_period = pcr_period;
    m_pcr_period_isSet = true;
}

bool OAIM2tsSettings::is_pcr_period_Set() const{
    return m_pcr_period_isSet;
}

bool OAIM2tsSettings::is_pcr_period_Valid() const{
    return m_pcr_period_isValid;
}

QString OAIM2tsSettings::getPcrPid() const {
    return m_pcr_pid;
}
void OAIM2tsSettings::setPcrPid(const QString &pcr_pid) {
    m_pcr_pid = pcr_pid;
...
QString OAIM2tsSettings::getPmtPid() const {
    return m_pmt_pid;
}
void OAIM2tsSettings::setPmtPid(const QString &pmt_pid) {
    m_pmt_pid = pmt_pid;
...
qint32 OAIM2tsSettings::getProgramNum() const {
    return m_program_num;
}
void OAIM2tsSettings::setProgramNum(const qint32 &program_num) {
    m_program_num = program_num;
    m_program_num_isSet = true;
}

bool OAIM2tsSettings::is_program_num_Set() const{
    return m_program_num_isSet;
}

bool OAIM2tsSettings::is_program_num_Valid() const{
...
QString OAIM2tsSettings::getScte27Pids() const {
    return m_scte27_pids;
}
void OAIM2tsSettings::setScte27Pids(const QString &scte27_pids) {
    m_scte27_pids = scte27_pids;
    m_scte27_pids_isSet = true;
}

bool OAIM2tsSettings::is_scte27_pids_Set() const{
    return m_scte27_pids_isSet;
}

bool OAIM2tsSettings::is_scte27_pids_Valid() const{
    return m_scte27_pids_isValid;
}

OAIM2tsScte35Control OAIM2tsSettings::getScte35Control() const {
    return m_scte35_control;
}
void OAIM2tsSettings::setScte35Control(const OAIM2tsScte35Control &scte35_control) {
    m_scte35_control = scte35_control;
    m_scte35_control_isSet = true;
}

bool OAIM2tsSettings::is_scte35_control_Set() const{
    return m_scte35_control_isSet;
}

bool OAIM2tsSettings::is_scte35_control_Valid() const{
    return m_scte35_control_isValid;
}

QString OAIM2tsSettings::getScte35Pid() const {
    return m_scte35_pid;
}
void OAIM2tsSettings::setScte35Pid(const QString &scte35_pid) {
...
OAIM2tsTimedMetadataBehavior OAIM2tsSettings::getTimedMetadataBehavior() const {
    return m_timed_metadata_behavior;
}
void OAIM2tsSettings::setTimedMetadataBehavior(const OAIM2tsTimedMetadataBehavior &timed_metadata_behavior) {
    m_timed_metadata_behavior = timed_metadata_behavior;
    m_timed_metadata_behavior_isSet = true;
}

bool OAIM2tsSettings::is_timed_metadata_behavior_Set() const{
    return m_timed_metadata_behavior_isSet;
}

bool OAIM2tsSettings::is_timed_metadata_behavior_Valid() const{
    return m_timed_metadata_behavior_isValid;
}

QString OAIM2tsSettings::getTimedMetadataPid() const {
    return m_timed_metadata_pid;
}
void OAIM2tsSettings::setTimedMetadataPid(const QString &timed_metadata_pid) {
...
QString OAIM2tsSettings::getVideoPid() const {
    return m_video_pid;
}
void OAIM2tsSettings::setVideoPid(const QString &video_pid) {
...
double OAIM2tsSettings::getScte35PrerollPullupMilliseconds() const {
    return m_scte35_preroll_pullup_milliseconds;
}
void OAIM2tsSettings::setScte35PrerollPullupMilliseconds(const double &scte35_preroll_pullup_milliseconds) {
    m_scte35_preroll_pullup_milliseconds = scte35_preroll_pullup_milliseconds;
    m_scte35_preroll_pullup_milliseconds_isSet = true;
}

bool OAIM2tsSettings::is_scte35_preroll_pullup_milliseconds_Set() const{
    return m_scte35_preroll_pullup_milliseconds_isSet;
}

bool OAIM2tsSettings::is_scte35_preroll_pullup_milliseconds_Valid() const{
