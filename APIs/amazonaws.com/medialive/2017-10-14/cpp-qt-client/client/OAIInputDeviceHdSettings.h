...
/*
 * OAIInputDeviceHdSettings.h
 *
 * Settings that describe the active source from the input device, and the video characteristics of that source.
 */

#ifndef OAIInputDeviceHdSettings_H
#define OAIInputDeviceHdSettings_H
...
class OAIInputDeviceHdSettings : public OAIObject {
public:
    OAIInputDeviceHdSettings();
    OAIInputDeviceHdSettings(QString json);
    ~OAIInputDeviceHdSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInputDeviceHdSettings)

#endif // OAIInputDeviceHdSettings_H
