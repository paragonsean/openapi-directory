...
/*
 * OAINielsenNaesIiNw.h
 *
 * Nielsen Naes Ii Nw
 */

#ifndef OAINielsenNaesIiNw_H
#define OAINielsenNaesIiNw_H
...
class OAINielsenNaesIiNw : public OAIObject {
public:
    OAINielsenNaesIiNw();
    OAINielsenNaesIiNw(QString json);
    ~OAINielsenNaesIiNw() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINielsenNaesIiNw)

#endif // OAINielsenNaesIiNw_H
