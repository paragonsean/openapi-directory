...
OAIUpdateInputDeviceResponse::OAIUpdateInputDeviceResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateInputDeviceResponse::OAIUpdateInputDeviceResponse() {
    this->initializeModel();
}

OAIUpdateInputDeviceResponse::~OAIUpdateInputDeviceResponse() {}

void OAIUpdateInputDeviceResponse::initializeModel() {
...
void OAIUpdateInputDeviceResponse::fromJson(QString jsonString) {
...
void OAIUpdateInputDeviceResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateInputDeviceResponse::asJson() const {
...
QJsonObject OAIUpdateInputDeviceResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIUpdateInputDeviceResponse::getArn() const {
    return m_arn;
}
void OAIUpdateInputDeviceResponse::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIUpdateInputDeviceResponse::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIUpdateInputDeviceResponse::is_arn_Valid() const{
    return m_arn_isValid;
}

OAIInputDeviceConnectionState OAIUpdateInputDeviceResponse::getConnectionState() const {
    return m_connection_state;
}
void OAIUpdateInputDeviceResponse::setConnectionState(const OAIInputDeviceConnectionState &connection_state) {
    m_connection_state = connection_state;
    m_connection_state_isSet = true;
}

bool OAIUpdateInputDeviceResponse::is_connection_state_Set() const{
    return m_connection_state_isSet;
}

bool OAIUpdateInputDeviceResponse::is_connection_state_Valid() const{
    return m_connection_state_isValid;
}

OAIDeviceSettingsSyncState OAIUpdateInputDeviceResponse::getDeviceSettingsSyncState() const {
    return m_device_settings_sync_state;
}
void OAIUpdateInputDeviceResponse::setDeviceSettingsSyncState(const OAIDeviceSettingsSyncState &device_settings_sync_state) {
    m_device_settings_sync_state = device_settings_sync_state;
    m_device_settings_sync_state_isSet = true;
}

bool OAIUpdateInputDeviceResponse::is_device_settings_sync_state_Set() const{
    return m_device_settings_sync_state_isSet;
}

bool OAIUpdateInputDeviceResponse::is_device_settings_sync_state_Valid() const{
    return m_device_settings_sync_state_isValid;
}

OAIDeviceUpdateStatus OAIUpdateInputDeviceResponse::getDeviceUpdateStatus() const {
    return m_device_update_status;
}
void OAIUpdateInputDeviceResponse::setDeviceUpdateStatus(const OAIDeviceUpdateStatus &device_update_status) {
    m_device_update_status = device_update_status;
    m_device_update_status_isSet = true;
}

bool OAIUpdateInputDeviceResponse::is_device_update_status_Set() const{
    return m_device_update_status_isSet;
}

bool OAIUpdateInputDeviceResponse::is_device_update_status_Valid() const{
    return m_device_update_status_isValid;
}

OAIDescribeInputDeviceResponse_HdDeviceSettings OAIUpdateInputDeviceResponse::getHdDeviceSettings() const {
    return m_hd_device_settings;
}
void OAIUpdateInputDeviceResponse::setHdDeviceSettings(const OAIDescribeInputDeviceResponse_HdDeviceSettings &hd_device_settings) {
    m_hd_device_settings = hd_device_settings;
    m_hd_device_settings_isSet = true;
}

bool OAIUpdateInputDeviceResponse::is_hd_device_settings_Set() const{
    return m_hd_device_settings_isSet;
}

bool OAIUpdateInputDeviceResponse::is_hd_device_settings_Valid() const{
    return m_hd_device_settings_isValid;
}

QString OAIUpdateInputDeviceResponse::getId() const {
    return m_id;
}
void OAIUpdateInputDeviceResponse::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIUpdateInputDeviceResponse::is_id_Set() const{
    return m_id_isSet;
}

bool OAIUpdateInputDeviceResponse::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIUpdateInputDeviceResponse::getMacAddress() const {
    return m_mac_address;
}
void OAIUpdateInputDeviceResponse::setMacAddress(const QString &mac_address) {
    m_mac_address = mac_address;
    m_mac_address_isSet = true;
}

bool OAIUpdateInputDeviceResponse::is_mac_address_Set() const{
    return m_mac_address_isSet;
}

bool OAIUpdateInputDeviceResponse::is_mac_address_Valid() const{
    return m_mac_address_isValid;
}

QString OAIUpdateInputDeviceResponse::getName() const {
    return m_name;
}
void OAIUpdateInputDeviceResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateInputDeviceResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateInputDeviceResponse::is_name_Valid() const{
    return m_name_isValid;
}

OAIDescribeInputDeviceResponse_NetworkSettings OAIUpdateInputDeviceResponse::getNetworkSettings() const {
    return m_network_settings;
}
void OAIUpdateInputDeviceResponse::setNetworkSettings(const OAIDescribeInputDeviceResponse_NetworkSettings &network_settings) {
    m_network_settings = network_settings;
    m_network_settings_isSet = true;
}

bool OAIUpdateInputDeviceResponse::is_network_settings_Set() const{
    return m_network_settings_isSet;
}

bool OAIUpdateInputDeviceResponse::is_network_settings_Valid() const{
    return m_network_settings_isValid;
}

QString OAIUpdateInputDeviceResponse::getSerialNumber() const {
    return m_serial_number;
}
void OAIUpdateInputDeviceResponse::setSerialNumber(const QString &serial_number) {
    m_serial_number = serial_number;
    m_serial_number_isSet = true;
}

bool OAIUpdateInputDeviceResponse::is_serial_number_Set() const{
    return m_serial_number_isSet;
}

bool OAIUpdateInputDeviceResponse::is_serial_number_Valid() const{
    return m_serial_number_isValid;
}

OAIInputDeviceType OAIUpdateInputDeviceResponse::getType() const {
    return m_type;
}
void OAIUpdateInputDeviceResponse::setType(const OAIInputDeviceType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIUpdateInputDeviceResponse::is_type_Set() const{
    return m_type_isSet;
}

bool OAIUpdateInputDeviceResponse::is_type_Valid() const{
    return m_type_isValid;
}

OAIDescribeInputDeviceResponse_UhdDeviceSettings OAIUpdateInputDeviceResponse::getUhdDeviceSettings() const {
    return m_uhd_device_settings;
}
void OAIUpdateInputDeviceResponse::setUhdDeviceSettings(const OAIDescribeInputDeviceResponse_UhdDeviceSettings &uhd_device_settings) {
    m_uhd_device_settings = uhd_device_settings;
    m_uhd_device_settings_isSet = true;
}

bool OAIUpdateInputDeviceResponse::is_uhd_device_settings_Set() const{
    return m_uhd_device_settings_isSet;
}

bool OAIUpdateInputDeviceResponse::is_uhd_device_settings_Valid() const{
    return m_uhd_device_settings_isValid;
}

QMap OAIUpdateInputDeviceResponse::getTags() const {
    return m_tags;
}
void OAIUpdateInputDeviceResponse::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIUpdateInputDeviceResponse::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIUpdateInputDeviceResponse::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAIUpdateInputDeviceResponse::getAvailabilityZone() const {
    return m_availability_zone;
}
void OAIUpdateInputDeviceResponse::setAvailabilityZone(const QString &availability_zone) {
    m_availability_zone = availability_zone;
    m_availability_zone_isSet = true;
}

bool OAIUpdateInputDeviceResponse::is_availability_zone_Set() const{
    return m_availability_zone_isSet;
}

bool OAIUpdateInputDeviceResponse::is_availability_zone_Valid() const{
    return m_availability_zone_isValid;
}

bool OAIUpdateInputDeviceResponse::isSet() const {
...
bool OAIUpdateInputDeviceResponse::isValid() const {
