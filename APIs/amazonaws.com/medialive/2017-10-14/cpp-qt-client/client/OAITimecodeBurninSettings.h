...
/*
 * OAITimecodeBurninSettings.h
 *
 * Timecode Burnin Settings
 */

#ifndef OAITimecodeBurninSettings_H
#define OAITimecodeBurninSettings_H
...
class OAITimecodeBurninSettings : public OAIObject {
public:
    OAITimecodeBurninSettings();
    OAITimecodeBurninSettings(QString json);
    ~OAITimecodeBurninSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITimecodeBurninSettings)

#endif // OAITimecodeBurninSettings_H
