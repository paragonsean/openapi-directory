...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::acceptInputDeviceTransferSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::acceptInputDeviceTransferSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString input_device_id = create(); // QString | The unique ID of the input device to accept. For example, hd-123456789abcdef.
      ...
      apiInstance.acceptInputDeviceTransfer(input_device_idx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
