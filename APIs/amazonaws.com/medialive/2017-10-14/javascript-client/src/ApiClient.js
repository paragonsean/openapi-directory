...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://medialive.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://medialive.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2017-10-14/Javascript'
        };
