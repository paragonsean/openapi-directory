...
/**
 * The UpdateChannelRequestEncoderSettings model module.
 * @module model/UpdateChannelRequestEncoderSettings
 * @version 2017-10-14
 */
class UpdateChannelRequestEncoderSettings {
    /**
     * Constructs a new <code>UpdateChannelRequestEncoderSettings</code>.
     * @alias module:model/UpdateChannelRequestEncoderSettings
    ...
    constructor(audioDescriptions, outputGroups, timecodeConfig, videoDescriptions) { 
        ...
        UpdateChannelRequestEncoderSettings.initialize(this, audioDescriptions, outputGroups, timecodeConfig, videoDescriptions);
    }
    ...
    /**
     * Constructs a <code>UpdateChannelRequestEncoderSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateChannelRequestEncoderSettings} obj Optional instance to populate.
     * @return {module:model/UpdateChannelRequestEncoderSettings} The populated <code>UpdateChannelRequestEncoderSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateChannelRequestEncoderSettings();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateChannelRequestEncoderSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateChannelRequestEncoderSettings</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateChannelRequestEncoderSettings.RequiredProperties) {
...
UpdateChannelRequestEncoderSettings.RequiredProperties = ["AudioDescriptions", "OutputGroups", "TimecodeConfig", "VideoDescriptions"];

/**
 * @member {Array} AudioDescriptions
 */
UpdateChannelRequestEncoderSettings.prototype['AudioDescriptions'] = undefined;

/**
 * @member {module:model/CreateChannelRequestEncoderSettingsAvailBlanking} AvailBlanking
 */
UpdateChannelRequestEncoderSettings.prototype['AvailBlanking'] = undefined;

/**
 * @member {module:model/CreateChannelRequestEncoderSettingsAvailConfiguration} AvailConfiguration
 */
UpdateChannelRequestEncoderSettings.prototype['AvailConfiguration'] = undefined;

/**
 * @member {module:model/CreateChannelRequestEncoderSettingsBlackoutSlate} BlackoutSlate
 */
UpdateChannelRequestEncoderSettings.prototype['BlackoutSlate'] = undefined;

/**
 * @member {Array} CaptionDescriptions
 */
UpdateChannelRequestEncoderSettings.prototype['CaptionDescriptions'] = undefined;

/**
 * @member {module:model/CreateChannelRequestEncoderSettingsFeatureActivations} FeatureActivations
 */
UpdateChannelRequestEncoderSettings.prototype['FeatureActivations'] = undefined;

/**
 * @member {module:model/CreateChannelRequestEncoderSettingsGlobalConfiguration} GlobalConfiguration
 */
UpdateChannelRequestEncoderSettings.prototype['GlobalConfiguration'] = undefined;

/**
 * @member {module:model/CreateChannelRequestEncoderSettingsMotionGraphicsConfiguration} MotionGraphicsConfiguration
 */
UpdateChannelRequestEncoderSettings.prototype['MotionGraphicsConfiguration'] = undefined;

/**
 * @member {module:model/CreateChannelRequestEncoderSettingsNielsenConfiguration} NielsenConfiguration
 */
UpdateChannelRequestEncoderSettings.prototype['NielsenConfiguration'] = undefined;

/**
 * @member {Array} OutputGroups
 */
UpdateChannelRequestEncoderSettings.prototype['OutputGroups'] = undefined;

/**
 * @member {module:model/CreateChannelRequestEncoderSettingsTimecodeConfig} TimecodeConfig
 */
UpdateChannelRequestEncoderSettings.prototype['TimecodeConfig'] = undefined;

/**
 * @member {Array} VideoDescriptions
 */
UpdateChannelRequestEncoderSettings.prototype['VideoDescriptions'] = undefined;

/**
 * @member {module:model/CreateChannelRequestEncoderSettingsThumbnailConfiguration} ThumbnailConfiguration
 */
UpdateChannelRequestEncoderSettings.prototype['ThumbnailConfiguration'] = undefined;
...
export default UpdateChannelRequestEncoderSettings;
