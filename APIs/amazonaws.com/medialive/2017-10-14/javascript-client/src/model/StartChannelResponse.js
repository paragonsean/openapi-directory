...
/**
 * The StartChannelResponse model module.
 * @module model/StartChannelResponse
 * @version 2017-10-14
 */
class StartChannelResponse {
    /**
     * Constructs a new <code>StartChannelResponse</code>.
     * Placeholder documentation for StartChannelResponse
     * @alias module:model/StartChannelResponse
     */
    constructor() { 
        
        StartChannelResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartChannelResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartChannelResponse} obj Optional instance to populate.
     * @return {module:model/StartChannelResponse} The populated <code>StartChannelResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartChannelResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>StartChannelResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartChannelResponse</code>.
     */
 ...
 * @member {String} Arn
 */
StartChannelResponse.prototype['Arn'] = undefined;

/**
 * @member {module:model/DeleteChannelResponseCdiInputSpecification} CdiInputSpecification
 */
StartChannelResponse.prototype['CdiInputSpecification'] = undefined;

/**
 * @member {module:model/ChannelClass} ChannelClass
 */
StartChannelResponse.prototype['ChannelClass'] = undefined;

/**
 * @member {Array} Destinations
 */
StartChannelResponse.prototype['Destinations'] = undefined;

/**
 * @member {Array} EgressEndpoints
 */
StartChannelResponse.prototype['EgressEndpoints'] = undefined;

/**
 * @member {module:model/DeleteChannelResponseEncoderSettings} EncoderSettings
 */
StartChannelResponse.prototype['EncoderSettings'] = undefined;

/**
 * @member {String} Id
 */
StartChannelResponse.prototype['Id'] = undefined;

/**
 * @member {Array} InputAttachments
 */
StartChannelResponse.prototype['InputAttachments'] = undefined;

/**
 * @member {module:model/DeleteChannelResponseInputSpecification} InputSpecification
 */
StartChannelResponse.prototype['InputSpecification'] = undefined;

/**
 * @member {module:model/LogLevel} LogLevel
 */
StartChannelResponse.prototype['LogLevel'] = undefined;

/**
 * @member {module:model/DeleteChannelResponseMaintenance} Maintenance
 */
StartChannelResponse.prototype['Maintenance'] = undefined;

/**
 * @member {String} Name
 */
StartChannelResponse.prototype['Name'] = undefined;

/**
 * @member {Array} PipelineDetails
 */
StartChannelResponse.prototype['PipelineDetails'] = undefined;

/**
 * @member {Number} PipelinesRunningCount
 */
StartChannelResponse.prototype['PipelinesRunningCount'] = undefined;

/**
 * @member {String} RoleArn
 */
StartChannelResponse.prototype['RoleArn'] = undefined;

/**
 * @member {module:model/ChannelState} State
 */
StartChannelResponse.prototype['State'] = undefined;

/**
 * @member {Object} Tags
 */
StartChannelResponse.prototype['Tags'] = undefined;

/**
 * @member {module:model/DeleteChannelResponseVpc} Vpc
 */
StartChannelResponse.prototype['Vpc'] = undefined;
...
export default StartChannelResponse;
