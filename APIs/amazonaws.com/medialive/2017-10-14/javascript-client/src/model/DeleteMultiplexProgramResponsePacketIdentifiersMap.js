...
import MultiplexProgramPacketIdentifiersMap from './MultiplexProgramPacketIdentifiersMap';

/**
 * The DeleteMultiplexProgramResponsePacketIdentifiersMap model module.
 * @module model/DeleteMultiplexProgramResponsePacketIdentifiersMap
 * @version 2017-10-14
 */
class DeleteMultiplexProgramResponsePacketIdentifiersMap {
    /**
     * Constructs a new <code>DeleteMultiplexProgramResponsePacketIdentifiersMap</code>.
     * @alias module:model/DeleteMultiplexProgramResponsePacketIdentifiersMap
     * @implements module:model/MultiplexProgramPacketIdentifiersMap
     */
    constructor() { 
        MultiplexProgramPacketIdentifiersMap.initialize(this);
        DeleteMultiplexProgramResponsePacketIdentifiersMap.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteMultiplexProgramResponsePacketIdentifiersMap</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteMultiplexProgramResponsePacketIdentifiersMap} obj Optional instance to populate.
     * @return {module:model/DeleteMultiplexProgramResponsePacketIdentifiersMap} The populated <code>DeleteMultiplexProgramResponsePacketIdentifiersMap</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteMultiplexProgramResponsePacketIdentifiersMap();
            MultiplexProgramPacketIdentifiersMap.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteMultiplexProgramResponsePacketIdentifiersMap</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteMultiplexProgramResponsePacketIdentifiersMap</code>.
     */
 ...
 */
DeleteMultiplexProgramResponsePacketIdentifiersMap.prototype['AudioPids'] = undefined;

/**
 * @member {Array} DvbSubPids
 */
DeleteMultiplexProgramResponsePacketIdentifiersMap.prototype['DvbSubPids'] = undefined;

/**
 * @member {Number} DvbTeletextPid
 */
DeleteMultiplexProgramResponsePacketIdentifiersMap.prototype['DvbTeletextPid'] = undefined;

/**
 * @member {Number} EtvPlatformPid
 */
DeleteMultiplexProgramResponsePacketIdentifiersMap.prototype['EtvPlatformPid'] = undefined;

/**
 * @member {Number} EtvSignalPid
 */
DeleteMultiplexProgramResponsePacketIdentifiersMap.prototype['EtvSignalPid'] = undefined;

/**
 * @member {Array} KlvDataPids
 */
DeleteMultiplexProgramResponsePacketIdentifiersMap.prototype['KlvDataPids'] = undefined;

/**
 * @member {Number} PcrPid
 */
DeleteMultiplexProgramResponsePacketIdentifiersMap.prototype['PcrPid'] = undefined;

/**
 * @member {Number} PmtPid
 */
DeleteMultiplexProgramResponsePacketIdentifiersMap.prototype['PmtPid'] = undefined;

/**
 * @member {Number} PrivateMetadataPid
 */
DeleteMultiplexProgramResponsePacketIdentifiersMap.prototype['PrivateMetadataPid'] = undefined;

/**
 * @member {Array} Scte27Pids
 */
DeleteMultiplexProgramResponsePacketIdentifiersMap.prototype['Scte27Pids'] = undefined;

/**
 * @member {Number} Scte35Pid
 */
DeleteMultiplexProgramResponsePacketIdentifiersMap.prototype['Scte35Pid'] = undefined;

/**
 * @member {Number} TimedMetadataPid
 */
DeleteMultiplexProgramResponsePacketIdentifiersMap.prototype['TimedMetadataPid'] = undefined;

/**
 * @member {Number} VideoPid
 */
DeleteMultiplexProgramResponsePacketIdentifiersMap.prototype['VideoPid'] = undefined;


// Implement MultiplexProgramPacketIdentifiersMap interface:
/**
 * @member {Array} AudioPids
 */
...
export default DeleteMultiplexProgramResponsePacketIdentifiersMap;
