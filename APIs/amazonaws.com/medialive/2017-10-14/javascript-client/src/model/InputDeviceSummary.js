...
import InputDeviceSummaryNetworkSettings from './InputDeviceSummaryNetworkSettings';
import InputDeviceType from './InputDeviceType';

/**
 * The InputDeviceSummary model module.
 * @module model/InputDeviceSummary
 * @version 2017-10-14
 */
class InputDeviceSummary {
    /**
     * Constructs a new <code>InputDeviceSummary</code>.
     * Details of the input device.
     * @alias module:model/InputDeviceSummary
     */
    constructor() { 
        
        InputDeviceSummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InputDeviceSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InputDeviceSummary} obj Optional instance to populate.
     * @return {module:model/InputDeviceSummary} The populated <code>InputDeviceSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InputDeviceSummary();
            ...
            if (data.hasOwnProperty('NetworkSettings')) {
                obj['NetworkSettings'] = InputDeviceSummaryNetworkSettings.constructFromObject(data['NetworkSettings']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>InputDeviceSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InputDeviceSummary</code>.
     */
    static validateJSON(data) {
        ...
        if (data['NetworkSettings']) { // data not null
          InputDeviceSummaryNetworkSettings.validateJSON(data['NetworkSettings']);
        }
 ...
 * @member {String} Arn
 */
InputDeviceSummary.prototype['Arn'] = undefined;

/**
 * @member {module:model/InputDeviceConnectionState} ConnectionState
 */
InputDeviceSummary.prototype['ConnectionState'] = undefined;

/**
 * @member {module:model/DeviceSettingsSyncState} DeviceSettingsSyncState
 */
InputDeviceSummary.prototype['DeviceSettingsSyncState'] = undefined;

/**
 * @member {module:model/DeviceUpdateStatus} DeviceUpdateStatus
 */
InputDeviceSummary.prototype['DeviceUpdateStatus'] = undefined;

/**
 * @member {module:model/DescribeInputDeviceResponseHdDeviceSettings} HdDeviceSettings
 */
InputDeviceSummary.prototype['HdDeviceSettings'] = undefined;

/**
 * @member {String} Id
 */
InputDeviceSummary.prototype['Id'] = undefined;

/**
 * @member {String} MacAddress
 */
InputDeviceSummary.prototype['MacAddress'] = undefined;

/**
 * @member {String} Name
 */
InputDeviceSummary.prototype['Name'] = undefined;

/**
 * @member {module:model/InputDeviceSummaryNetworkSettings} NetworkSettings
 */
InputDeviceSummary.prototype['NetworkSettings'] = undefined;

/**
 * @member {String} SerialNumber
 */
InputDeviceSummary.prototype['SerialNumber'] = undefined;

/**
 * @member {module:model/InputDeviceType} Type
 */
InputDeviceSummary.prototype['Type'] = undefined;

/**
 * @member {module:model/DescribeInputDeviceResponseUhdDeviceSettings} UhdDeviceSettings
 */
InputDeviceSummary.prototype['UhdDeviceSettings'] = undefined;

/**
 * @member {Object} Tags
 */
InputDeviceSummary.prototype['Tags'] = undefined;

/**
 * @member {String} AvailabilityZone
 */
InputDeviceSummary.prototype['AvailabilityZone'] = undefined;
...
export default InputDeviceSummary;
