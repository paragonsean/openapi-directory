...
/**
 * The MultiplexProgram model module.
 * @module model/MultiplexProgram
 * @version 2017-10-14
 */
class MultiplexProgram {
    /**
     * Constructs a new <code>MultiplexProgram</code>.
     * The multiplex program object.
     * @alias module:model/MultiplexProgram
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>MultiplexProgram</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MultiplexProgram} obj Optional instance to populate.
     * @return {module:model/MultiplexProgram} The populated <code>MultiplexProgram</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MultiplexProgram();
    ...
    /**
     * Validates the JSON data with respect to <code>MultiplexProgram</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MultiplexProgram</code>.
     */
...
export default MultiplexProgram;
