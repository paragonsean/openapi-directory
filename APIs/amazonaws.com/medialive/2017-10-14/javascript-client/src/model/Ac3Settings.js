...
/**
 * The Ac3Settings model module.
 * @module model/Ac3Settings
 * @version 2017-10-14
 */
class Ac3Settings {
    /**
     * Constructs a new <code>Ac3Settings</code>.
     * Ac3 Settings
     * @alias module:model/Ac3Settings
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>Ac3Settings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Ac3Settings} obj Optional instance to populate.
     * @return {module:model/Ac3Settings} The populated <code>Ac3Settings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Ac3Settings();
    ...
    /**
     * Validates the JSON data with respect to <code>Ac3Settings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Ac3Settings</code>.
     */
