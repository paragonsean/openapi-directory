...
/**
 * The InputDeviceUhdSettings model module.
 * @module model/InputDeviceUhdSettings
 * @version 2017-10-14
 */
class InputDeviceUhdSettings {
    /**
     * Constructs a new <code>InputDeviceUhdSettings</code>.
     * Settings that describe the active source from the input device, and the video characteristics of that source.
     * @alias module:model/InputDeviceUhdSettings
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>InputDeviceUhdSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InputDeviceUhdSettings} obj Optional instance to populate.
     * @return {module:model/InputDeviceUhdSettings} The populated <code>InputDeviceUhdSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InputDeviceUhdSettings();
    ...
    /**
     * Validates the JSON data with respect to <code>InputDeviceUhdSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InputDeviceUhdSettings</code>.
     */
...
export default InputDeviceUhdSettings;
