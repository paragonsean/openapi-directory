...
/**
 * The DeleteChannelResponse model module.
 * @module model/DeleteChannelResponse
 * @version 2017-10-14
 */
class DeleteChannelResponse {
    /**
     * Constructs a new <code>DeleteChannelResponse</code>.
     * Placeholder documentation for DeleteChannelResponse
     * @alias module:model/DeleteChannelResponse
     */
    constructor() { 
        
        DeleteChannelResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteChannelResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteChannelResponse} obj Optional instance to populate.
     * @return {module:model/DeleteChannelResponse} The populated <code>DeleteChannelResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteChannelResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteChannelResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteChannelResponse</code>.
     */
 ...
 * @member {String} Arn
 */
DeleteChannelResponse.prototype['Arn'] = undefined;

/**
 * @member {module:model/DeleteChannelResponseCdiInputSpecification} CdiInputSpecification
 */
DeleteChannelResponse.prototype['CdiInputSpecification'] = undefined;

/**
 * @member {module:model/ChannelClass} ChannelClass
 */
DeleteChannelResponse.prototype['ChannelClass'] = undefined;

/**
 * @member {Array} Destinations
 */
DeleteChannelResponse.prototype['Destinations'] = undefined;

/**
 * @member {Array} EgressEndpoints
 */
DeleteChannelResponse.prototype['EgressEndpoints'] = undefined;

/**
 * @member {module:model/DeleteChannelResponseEncoderSettings} EncoderSettings
 */
DeleteChannelResponse.prototype['EncoderSettings'] = undefined;

/**
 * @member {String} Id
 */
DeleteChannelResponse.prototype['Id'] = undefined;

/**
 * @member {Array} InputAttachments
 */
DeleteChannelResponse.prototype['InputAttachments'] = undefined;

/**
 * @member {module:model/DeleteChannelResponseInputSpecification} InputSpecification
 */
DeleteChannelResponse.prototype['InputSpecification'] = undefined;

/**
 * @member {module:model/LogLevel} LogLevel
 */
DeleteChannelResponse.prototype['LogLevel'] = undefined;

/**
 * @member {module:model/DeleteChannelResponseMaintenance} Maintenance
 */
DeleteChannelResponse.prototype['Maintenance'] = undefined;

/**
 * @member {String} Name
 */
DeleteChannelResponse.prototype['Name'] = undefined;

/**
 * @member {Array} PipelineDetails
 */
DeleteChannelResponse.prototype['PipelineDetails'] = undefined;

/**
 * @member {Number} PipelinesRunningCount
 */
DeleteChannelResponse.prototype['PipelinesRunningCount'] = undefined;

/**
 * @member {String} RoleArn
 */
DeleteChannelResponse.prototype['RoleArn'] = undefined;

/**
 * @member {module:model/ChannelState} State
 */
DeleteChannelResponse.prototype['State'] = undefined;

/**
 * @member {Object} Tags
 */
DeleteChannelResponse.prototype['Tags'] = undefined;

/**
 * @member {module:model/DeleteChannelResponseVpc} Vpc
 */
DeleteChannelResponse.prototype['Vpc'] = undefined;
