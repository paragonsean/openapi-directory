...
/**
 * The InputDeviceHdSettings model module.
 * @module model/InputDeviceHdSettings
 * @version 2017-10-14
 */
class InputDeviceHdSettings {
    /**
     * Constructs a new <code>InputDeviceHdSettings</code>.
     * Settings that describe the active source from the input device, and the video characteristics of that source.
     * @alias module:model/InputDeviceHdSettings
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>InputDeviceHdSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InputDeviceHdSettings} obj Optional instance to populate.
     * @return {module:model/InputDeviceHdSettings} The populated <code>InputDeviceHdSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InputDeviceHdSettings();
    ...
    /**
     * Validates the JSON data with respect to <code>InputDeviceHdSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InputDeviceHdSettings</code>.
     */
...
export default InputDeviceHdSettings;
