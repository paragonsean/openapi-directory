...
/**
 * The StopChannelResponse model module.
 * @module model/StopChannelResponse
 * @version 2017-10-14
 */
class StopChannelResponse {
    /**
     * Constructs a new <code>StopChannelResponse</code>.
     * Placeholder documentation for StopChannelResponse
     * @alias module:model/StopChannelResponse
     */
    constructor() { 
        
        StopChannelResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StopChannelResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StopChannelResponse} obj Optional instance to populate.
     * @return {module:model/StopChannelResponse} The populated <code>StopChannelResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StopChannelResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>StopChannelResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StopChannelResponse</code>.
     */
 ...
 * @member {String} Arn
 */
StopChannelResponse.prototype['Arn'] = undefined;

/**
 * @member {module:model/DeleteChannelResponseCdiInputSpecification} CdiInputSpecification
 */
StopChannelResponse.prototype['CdiInputSpecification'] = undefined;

/**
 * @member {module:model/ChannelClass} ChannelClass
 */
StopChannelResponse.prototype['ChannelClass'] = undefined;

/**
 * @member {Array} Destinations
 */
StopChannelResponse.prototype['Destinations'] = undefined;

/**
 * @member {Array} EgressEndpoints
 */
StopChannelResponse.prototype['EgressEndpoints'] = undefined;

/**
 * @member {module:model/DeleteChannelResponseEncoderSettings} EncoderSettings
 */
StopChannelResponse.prototype['EncoderSettings'] = undefined;

/**
 * @member {String} Id
 */
StopChannelResponse.prototype['Id'] = undefined;

/**
 * @member {Array} InputAttachments
 */
StopChannelResponse.prototype['InputAttachments'] = undefined;

/**
 * @member {module:model/DeleteChannelResponseInputSpecification} InputSpecification
 */
StopChannelResponse.prototype['InputSpecification'] = undefined;

/**
 * @member {module:model/LogLevel} LogLevel
 */
StopChannelResponse.prototype['LogLevel'] = undefined;

/**
 * @member {module:model/DeleteChannelResponseMaintenance} Maintenance
 */
StopChannelResponse.prototype['Maintenance'] = undefined;

/**
 * @member {String} Name
 */
StopChannelResponse.prototype['Name'] = undefined;

/**
 * @member {Array} PipelineDetails
 */
StopChannelResponse.prototype['PipelineDetails'] = undefined;

/**
 * @member {Number} PipelinesRunningCount
 */
StopChannelResponse.prototype['PipelinesRunningCount'] = undefined;

/**
 * @member {String} RoleArn
 */
StopChannelResponse.prototype['RoleArn'] = undefined;

/**
 * @member {module:model/ChannelState} State
 */
StopChannelResponse.prototype['State'] = undefined;

/**
 * @member {Object} Tags
 */
StopChannelResponse.prototype['Tags'] = undefined;

/**
 * @member {module:model/DeleteChannelResponseVpc} Vpc
 */
StopChannelResponse.prototype['Vpc'] = undefined;
...
export default StopChannelResponse;
