...
/**
 * The DeleteChannelResponseEncoderSettings model module.
 * @module model/DeleteChannelResponseEncoderSettings
 * @version 2017-10-14
 */
class DeleteChannelResponseEncoderSettings {
    /**
     * Constructs a new <code>DeleteChannelResponseEncoderSettings</code>.
     * @alias module:model/DeleteChannelResponseEncoderSettings
     * @implements module:model/EncoderSettings
    ...
    constructor(audioDescriptions, outputGroups, timecodeConfig, videoDescriptions) { 
        ...
        DeleteChannelResponseEncoderSettings.initialize(this, audioDescriptions, outputGroups, timecodeConfig, videoDescriptions);
    }
    ...
    /**
     * Constructs a <code>DeleteChannelResponseEncoderSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteChannelResponseEncoderSettings} obj Optional instance to populate.
     * @return {module:model/DeleteChannelResponseEncoderSettings} The populated <code>DeleteChannelResponseEncoderSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteChannelResponseEncoderSettings();
            EncoderSettings.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteChannelResponseEncoderSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteChannelResponseEncoderSettings</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteChannelResponseEncoderSettings.RequiredProperties) {
...
DeleteChannelResponseEncoderSettings.RequiredProperties = ["AudioDescriptions", "OutputGroups", "TimecodeConfig", "VideoDescriptions"];

/**
 * @member {Array} AudioDescriptions
 */
DeleteChannelResponseEncoderSettings.prototype['AudioDescriptions'] = undefined;

/**
 * @member {module:model/CreateChannelRequestEncoderSettingsAvailBlanking} AvailBlanking
 */
DeleteChannelResponseEncoderSettings.prototype['AvailBlanking'] = undefined;

/**
 * @member {module:model/CreateChannelRequestEncoderSettingsAvailConfiguration} AvailConfiguration
 */
DeleteChannelResponseEncoderSettings.prototype['AvailConfiguration'] = undefined;

/**
 * @member {module:model/CreateChannelRequestEncoderSettingsBlackoutSlate} BlackoutSlate
 */
DeleteChannelResponseEncoderSettings.prototype['BlackoutSlate'] = undefined;

/**
 * @member {Array} CaptionDescriptions
 */
DeleteChannelResponseEncoderSettings.prototype['CaptionDescriptions'] = undefined;

/**
 * @member {module:model/CreateChannelRequestEncoderSettingsFeatureActivations} FeatureActivations
 */
DeleteChannelResponseEncoderSettings.prototype['FeatureActivations'] = undefined;

/**
 * @member {module:model/CreateChannelRequestEncoderSettingsGlobalConfiguration} GlobalConfiguration
 */
DeleteChannelResponseEncoderSettings.prototype['GlobalConfiguration'] = undefined;

/**
 * @member {module:model/CreateChannelRequestEncoderSettingsMotionGraphicsConfiguration} MotionGraphicsConfiguration
 */
DeleteChannelResponseEncoderSettings.prototype['MotionGraphicsConfiguration'] = undefined;

/**
 * @member {module:model/CreateChannelRequestEncoderSettingsNielsenConfiguration} NielsenConfiguration
 */
DeleteChannelResponseEncoderSettings.prototype['NielsenConfiguration'] = undefined;

/**
 * @member {Array} OutputGroups
 */
DeleteChannelResponseEncoderSettings.prototype['OutputGroups'] = undefined;

/**
 * @member {module:model/CreateChannelRequestEncoderSettingsTimecodeConfig} TimecodeConfig
 */
DeleteChannelResponseEncoderSettings.prototype['TimecodeConfig'] = undefined;

/**
 * @member {Array} VideoDescriptions
 */
DeleteChannelResponseEncoderSettings.prototype['VideoDescriptions'] = undefined;

/**
 * @member {module:model/CreateChannelRequestEncoderSettingsThumbnailConfiguration} ThumbnailConfiguration
 */
DeleteChannelResponseEncoderSettings.prototype['ThumbnailConfiguration'] = undefined;


// Implement EncoderSettings interface:
/**
 * @member {Array} AudioDescriptions
 */
...
export default DeleteChannelResponseEncoderSettings;
