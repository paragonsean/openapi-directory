...
/**
 * The HlsBasicPutSettings model module.
 * @module model/HlsBasicPutSettings
 * @version 2017-10-14
 */
class HlsBasicPutSettings {
    /**
     * Constructs a new <code>HlsBasicPutSettings</code>.
     * Hls Basic Put Settings
     * @alias module:model/HlsBasicPutSettings
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>HlsBasicPutSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HlsBasicPutSettings} obj Optional instance to populate.
     * @return {module:model/HlsBasicPutSettings} The populated <code>HlsBasicPutSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HlsBasicPutSettings();
    ...
    /**
     * Validates the JSON data with respect to <code>HlsBasicPutSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HlsBasicPutSettings</code>.
     */
...
export default HlsBasicPutSettings;
