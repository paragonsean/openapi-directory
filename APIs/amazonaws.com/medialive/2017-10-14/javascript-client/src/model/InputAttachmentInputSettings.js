...
/**
 * The InputAttachmentInputSettings model module.
 * @module model/InputAttachmentInputSettings
 * @version 2017-10-14
 */
class InputAttachmentInputSettings {
    /**
     * Constructs a new <code>InputAttachmentInputSettings</code>.
     * @alias module:model/InputAttachmentInputSettings
     * @implements module:model/InputSettings
     */
    constructor() { 
        InputSettings.initialize(this);
        InputAttachmentInputSettings.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InputAttachmentInputSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InputAttachmentInputSettings} obj Optional instance to populate.
     * @return {module:model/InputAttachmentInputSettings} The populated <code>InputAttachmentInputSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InputAttachmentInputSettings();
            InputSettings.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>InputAttachmentInputSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InputAttachmentInputSettings</code>.
     */
 ...
 */
InputAttachmentInputSettings.prototype['AudioSelectors'] = undefined;

/**
 * @member {Array} CaptionSelectors
 */
InputAttachmentInputSettings.prototype['CaptionSelectors'] = undefined;

/**
 * @member {module:model/InputDeblockFilter} DeblockFilter
 */
InputAttachmentInputSettings.prototype['DeblockFilter'] = undefined;

/**
 * @member {module:model/InputDenoiseFilter} DenoiseFilter
 */
InputAttachmentInputSettings.prototype['DenoiseFilter'] = undefined;

/**
 * @member {Number} FilterStrength
 */
InputAttachmentInputSettings.prototype['FilterStrength'] = undefined;

/**
 * @member {module:model/InputFilter} InputFilter
 */
InputAttachmentInputSettings.prototype['InputFilter'] = undefined;

/**
 * @member {module:model/InputSettingsNetworkInputSettings} NetworkInputSettings
 */
InputAttachmentInputSettings.prototype['NetworkInputSettings'] = undefined;

/**
 * @member {Number} Scte35Pid
 */
InputAttachmentInputSettings.prototype['Scte35Pid'] = undefined;

/**
 * @member {module:model/Smpte2038DataPreference} Smpte2038DataPreference
 */
InputAttachmentInputSettings.prototype['Smpte2038DataPreference'] = undefined;

/**
 * @member {module:model/InputSourceEndBehavior} SourceEndBehavior
 */
InputAttachmentInputSettings.prototype['SourceEndBehavior'] = undefined;

/**
 * @member {module:model/InputSettingsVideoSelector} VideoSelector
 */
InputAttachmentInputSettings.prototype['VideoSelector'] = undefined;


// Implement InputSettings interface:
/**
 * @member {Array} AudioSelectors
 */
...
export default InputAttachmentInputSettings;
