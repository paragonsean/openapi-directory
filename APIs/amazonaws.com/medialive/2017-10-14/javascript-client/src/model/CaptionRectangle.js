...
/**
 * The CaptionRectangle model module.
 * @module model/CaptionRectangle
 * @version 2017-10-14
 */
class CaptionRectangle {
    /**
     * Constructs a new <code>CaptionRectangle</code>.
     * Caption Rectangle
     * @alias module:model/CaptionRectangle
     * @param height {Number} 
    ...
    /**
     * Constructs a <code>CaptionRectangle</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CaptionRectangle} obj Optional instance to populate.
     * @return {module:model/CaptionRectangle} The populated <code>CaptionRectangle</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CaptionRectangle();
    ...
    /**
     * Validates the JSON data with respect to <code>CaptionRectangle</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CaptionRectangle</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CaptionRectangle.RequiredProperties) {
...
CaptionRectangle.RequiredProperties = ["Height", "LeftOffset", "TopOffset", "Width"];
...
export default CaptionRectangle;
