...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.DescribeReservationResponse();
  });
  ...
  describe('DescribeReservationResponse', function() {
    it('should create an instance of DescribeReservationResponse', function() {
      // uncomment below and update the code to test DescribeReservationResponse
      //var instance = new AwsElementalMediaLive.DescribeReservationResponse();
      //expect(instance).to.be.a(AwsElementalMediaLive.DescribeReservationResponse);
    });
