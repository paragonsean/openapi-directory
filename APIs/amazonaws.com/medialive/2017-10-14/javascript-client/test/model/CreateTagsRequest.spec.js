...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.CreateTagsRequest();
  });
  ...
  describe('CreateTagsRequest', function() {
    it('should create an instance of CreateTagsRequest', function() {
      ...
      //var instance = new AwsElementalMediaLive.CreateTagsRequest();
      //expect(instance).to.be.a(AwsElementalMediaLive.CreateTagsRequest);
    });
