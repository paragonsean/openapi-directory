...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.StopMultiplexResponse();
  });
  ...
  describe('StopMultiplexResponse', function() {
    it('should create an instance of StopMultiplexResponse', function() {
      // uncomment below and update the code to test StopMultiplexResponse
      //var instance = new AwsElementalMediaLive.StopMultiplexResponse();
      //expect(instance).to.be.a(AwsElementalMediaLive.StopMultiplexResponse);
    });
