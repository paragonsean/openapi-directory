...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.BatchStartResponse();
  });
  ...
  describe('BatchStartResponse', function() {
    it('should create an instance of BatchStartResponse', function() {
      // uncomment below and update the code to test BatchStartResponse
      //var instance = new AwsElementalMediaLive.BatchStartResponse();
      //expect(instance).to.be.a(AwsElementalMediaLive.BatchStartResponse);
    });
