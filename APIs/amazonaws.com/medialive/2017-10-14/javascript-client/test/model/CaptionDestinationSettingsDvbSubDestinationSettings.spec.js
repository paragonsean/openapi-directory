...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.CaptionDestinationSettingsDvbSubDestinationSettings();
  });
  ...
  describe('CaptionDestinationSettingsDvbSubDestinationSettings', function() {
    it('should create an instance of CaptionDestinationSettingsDvbSubDestinationSettings', function() {
      ...
      //var instance = new AwsElementalMediaLive.CaptionDestinationSettingsDvbSubDestinationSettings();
      //expect(instance).to.be.a(AwsElementalMediaLive.CaptionDestinationSettingsDvbSubDestinationSettings);
    });
