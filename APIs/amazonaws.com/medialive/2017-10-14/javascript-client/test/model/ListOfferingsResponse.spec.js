...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.ListOfferingsResponse();
  });
  ...
  describe('ListOfferingsResponse', function() {
    it('should create an instance of ListOfferingsResponse', function() {
      // uncomment below and update the code to test ListOfferingsResponse
      //var instance = new AwsElementalMediaLive.ListOfferingsResponse();
      //expect(instance).to.be.a(AwsElementalMediaLive.ListOfferingsResponse);
    });
