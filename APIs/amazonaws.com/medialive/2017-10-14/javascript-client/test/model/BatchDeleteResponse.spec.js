...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.BatchDeleteResponse();
  });
  ...
  describe('BatchDeleteResponse', function() {
    it('should create an instance of BatchDeleteResponse', function() {
      ...
      //var instance = new AwsElementalMediaLive.BatchDeleteResponse();
      //expect(instance).to.be.a(AwsElementalMediaLive.BatchDeleteResponse);
    });
