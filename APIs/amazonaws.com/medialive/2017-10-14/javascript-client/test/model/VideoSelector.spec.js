...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.VideoSelector();
  });
  ...
  describe('VideoSelector', function() {
    it('should create an instance of VideoSelector', function() {
      ...
      //var instance = new AwsElementalMediaLive.VideoSelector();
      //expect(instance).to.be.a(AwsElementalMediaLive.VideoSelector);
    });
