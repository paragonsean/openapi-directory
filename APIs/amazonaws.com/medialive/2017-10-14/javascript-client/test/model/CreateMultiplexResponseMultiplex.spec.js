...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.CreateMultiplexResponseMultiplex();
  });
  ...
  describe('CreateMultiplexResponseMultiplex', function() {
    it('should create an instance of CreateMultiplexResponseMultiplex', function() {
      // uncomment below and update the code to test CreateMultiplexResponseMultiplex
      //var instance = new AwsElementalMediaLive.CreateMultiplexResponseMultiplex();
      //expect(instance).to.be.a(AwsElementalMediaLive.CreateMultiplexResponseMultiplex);
    });
