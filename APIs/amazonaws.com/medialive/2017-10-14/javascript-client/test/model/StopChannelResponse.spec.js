...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.StopChannelResponse();
  });
  ...
  describe('StopChannelResponse', function() {
    it('should create an instance of StopChannelResponse', function() {
      // uncomment below and update the code to test StopChannelResponse
      //var instance = new AwsElementalMediaLive.StopChannelResponse();
      //expect(instance).to.be.a(AwsElementalMediaLive.StopChannelResponse);
    });
