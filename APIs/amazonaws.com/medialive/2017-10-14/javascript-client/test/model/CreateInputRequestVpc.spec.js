...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.CreateInputRequestVpc();
  });
  ...
  describe('CreateInputRequestVpc', function() {
    it('should create an instance of CreateInputRequestVpc', function() {
      // uncomment below and update the code to test CreateInputRequestVpc
      //var instance = new AwsElementalMediaLive.CreateInputRequestVpc();
      //expect(instance).to.be.a(AwsElementalMediaLive.CreateInputRequestVpc);
    });
