...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.AudioCodecSettingsMp2Settings();
  });
  ...
  describe('AudioCodecSettingsMp2Settings', function() {
    it('should create an instance of AudioCodecSettingsMp2Settings', function() {
      // uncomment below and update the code to test AudioCodecSettingsMp2Settings
      //var instance = new AwsElementalMediaLive.AudioCodecSettingsMp2Settings();
      //expect(instance).to.be.a(AwsElementalMediaLive.AudioCodecSettingsMp2Settings);
    });
