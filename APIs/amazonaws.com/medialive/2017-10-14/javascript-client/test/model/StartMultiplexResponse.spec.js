...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.StartMultiplexResponse();
  });
  ...
  describe('StartMultiplexResponse', function() {
    it('should create an instance of StartMultiplexResponse', function() {
      // uncomment below and update the code to test StartMultiplexResponse
      //var instance = new AwsElementalMediaLive.StartMultiplexResponse();
      //expect(instance).to.be.a(AwsElementalMediaLive.StartMultiplexResponse);
    });
