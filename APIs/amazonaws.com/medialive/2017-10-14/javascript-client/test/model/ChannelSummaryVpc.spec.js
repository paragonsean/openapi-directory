...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.ChannelSummaryVpc();
  });
  ...
  describe('ChannelSummaryVpc', function() {
    it('should create an instance of ChannelSummaryVpc', function() {
      // uncomment below and update the code to test ChannelSummaryVpc
      //var instance = new AwsElementalMediaLive.ChannelSummaryVpc();
      //expect(instance).to.be.a(AwsElementalMediaLive.ChannelSummaryVpc);
    });
