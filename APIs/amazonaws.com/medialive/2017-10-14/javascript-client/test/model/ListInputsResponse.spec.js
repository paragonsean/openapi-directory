...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.ListInputsResponse();
  });
  ...
  describe('ListInputsResponse', function() {
    it('should create an instance of ListInputsResponse', function() {
      ...
      //var instance = new AwsElementalMediaLive.ListInputsResponse();
      //expect(instance).to.be.a(AwsElementalMediaLive.ListInputsResponse);
    });
