...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.WavSettings();
  });
  ...
  describe('WavSettings', function() {
    it('should create an instance of WavSettings', function() {
      // uncomment below and update the code to test WavSettings
      //var instance = new AwsElementalMediaLive.WavSettings();
      //expect(instance).to.be.a(AwsElementalMediaLive.WavSettings);
    });
