...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.DvbSubDestinationSettings();
  });
  ...
  describe('DvbSubDestinationSettings', function() {
    it('should create an instance of DvbSubDestinationSettings', function() {
      // uncomment below and update the code to test DvbSubDestinationSettings
      //var instance = new AwsElementalMediaLive.DvbSubDestinationSettings();
      //expect(instance).to.be.a(AwsElementalMediaLive.DvbSubDestinationSettings);
    });
