...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.BatchStopResponse();
  });
  ...
  describe('BatchStopResponse', function() {
    it('should create an instance of BatchStopResponse', function() {
      // uncomment below and update the code to test BatchStopResponse
      //var instance = new AwsElementalMediaLive.BatchStopResponse();
      //expect(instance).to.be.a(AwsElementalMediaLive.BatchStopResponse);
    });
