...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.StartChannelResponse();
  });
  ...
  describe('StartChannelResponse', function() {
    it('should create an instance of StartChannelResponse', function() {
      // uncomment below and update the code to test StartChannelResponse
      //var instance = new AwsElementalMediaLive.StartChannelResponse();
      //expect(instance).to.be.a(AwsElementalMediaLive.StartChannelResponse);
    });
