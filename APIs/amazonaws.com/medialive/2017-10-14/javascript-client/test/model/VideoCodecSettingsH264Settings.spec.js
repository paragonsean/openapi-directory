...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.VideoCodecSettingsH264Settings();
  });
  ...
  describe('VideoCodecSettingsH264Settings', function() {
    it('should create an instance of VideoCodecSettingsH264Settings', function() {
      ...
      //var instance = new AwsElementalMediaLive.VideoCodecSettingsH264Settings();
      //expect(instance).to.be.a(AwsElementalMediaLive.VideoCodecSettingsH264Settings);
    });
    ...
    it('should have the property bufFillPct (base name: "BufFillPct")', function() {
      // uncomment below and update the code to test the property bufFillPct
      //var instance = new AwsElementalMediaLive.VideoCodecSettingsH264Settings();
      //expect(instance).to.be();
    });
    ...
    it('should have the property forceFieldPictures (base name: "ForceFieldPictures")', function() {
      // uncomment below and update the code to test the property forceFieldPictures
      //var instance = new AwsElementalMediaLive.VideoCodecSettingsH264Settings();
      //expect(instance).to.be();
    });
    ...
    it('should have the property numRefFrames (base name: "NumRefFrames")', function() {
      // uncomment below and update the code to test the property numRefFrames
      //var instance = new AwsElementalMediaLive.VideoCodecSettingsH264Settings();
      //expect(instance).to.be();
    });
    ...
    it('should have the property spatialAq (base name: "SpatialAq")', function() {
      // uncomment below and update the code to test the property spatialAq
      //var instance = new AwsElementalMediaLive.VideoCodecSettingsH264Settings();
      //expect(instance).to.be();
    });
    ...
    it('should have the property temporalAq (base name: "TemporalAq")', function() {
      // uncomment below and update the code to test the property temporalAq
      //var instance = new AwsElementalMediaLive.VideoCodecSettingsH264Settings();
      //expect(instance).to.be();
    });
