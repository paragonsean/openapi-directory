...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.InputVpcRequest();
  });
  ...
  describe('InputVpcRequest', function() {
    it('should create an instance of InputVpcRequest', function() {
      // uncomment below and update the code to test InputVpcRequest
      //var instance = new AwsElementalMediaLive.InputVpcRequest();
      //expect(instance).to.be.a(AwsElementalMediaLive.InputVpcRequest);
    });
