...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.MultiplexSummary();
  });
  ...
  describe('MultiplexSummary', function() {
    it('should create an instance of MultiplexSummary', function() {
      // uncomment below and update the code to test MultiplexSummary
      //var instance = new AwsElementalMediaLive.MultiplexSummary();
      //expect(instance).to.be.a(AwsElementalMediaLive.MultiplexSummary);
    });
