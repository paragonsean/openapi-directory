...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.Thumbnail();
  });
  ...
  describe('Thumbnail', function() {
    it('should create an instance of Thumbnail', function() {
      ...
      //var instance = new AwsElementalMediaLive.Thumbnail();
      //expect(instance).to.be.a(AwsElementalMediaLive.Thumbnail);
    });
    ...
    it('should have the property thumbnailType (base name: "ThumbnailType")', function() {
      // uncomment below and update the code to test the property thumbnailType
      //var instance = new AwsElementalMediaLive.Thumbnail();
      //expect(instance).to.be();
    });
