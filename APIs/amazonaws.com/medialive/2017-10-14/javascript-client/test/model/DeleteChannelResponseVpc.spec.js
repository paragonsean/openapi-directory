...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.DeleteChannelResponseVpc();
  });
  ...
  describe('DeleteChannelResponseVpc', function() {
    it('should create an instance of DeleteChannelResponseVpc', function() {
      // uncomment below and update the code to test DeleteChannelResponseVpc
      //var instance = new AwsElementalMediaLive.DeleteChannelResponseVpc();
      //expect(instance).to.be.a(AwsElementalMediaLive.DeleteChannelResponseVpc);
    });
