...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.AudioCodecSettingsAacSettings();
  });
  ...
  describe('AudioCodecSettingsAacSettings', function() {
    it('should create an instance of AudioCodecSettingsAacSettings', function() {
      // uncomment below and update the code to test AudioCodecSettingsAacSettings
      //var instance = new AwsElementalMediaLive.AudioCodecSettingsAacSettings();
      //expect(instance).to.be.a(AwsElementalMediaLive.AudioCodecSettingsAacSettings);
    });
