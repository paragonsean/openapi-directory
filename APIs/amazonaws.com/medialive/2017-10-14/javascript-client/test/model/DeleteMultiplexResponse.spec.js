...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.DeleteMultiplexResponse();
  });
  ...
  describe('DeleteMultiplexResponse', function() {
    it('should create an instance of DeleteMultiplexResponse', function() {
      // uncomment below and update the code to test DeleteMultiplexResponse
      //var instance = new AwsElementalMediaLive.DeleteMultiplexResponse();
      //expect(instance).to.be.a(AwsElementalMediaLive.DeleteMultiplexResponse);
    });
