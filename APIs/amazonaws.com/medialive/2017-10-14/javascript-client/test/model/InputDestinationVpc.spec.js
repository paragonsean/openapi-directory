...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.InputDestinationVpc();
  });
  ...
  describe('InputDestinationVpc', function() {
    it('should create an instance of InputDestinationVpc', function() {
      // uncomment below and update the code to test InputDestinationVpc
      //var instance = new AwsElementalMediaLive.InputDestinationVpc();
      //expect(instance).to.be.a(AwsElementalMediaLive.InputDestinationVpc);
    });
