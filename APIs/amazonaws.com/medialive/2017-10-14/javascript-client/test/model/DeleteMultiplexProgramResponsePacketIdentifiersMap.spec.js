...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.DeleteMultiplexProgramResponsePacketIdentifiersMap();
  });
  ...
  describe('DeleteMultiplexProgramResponsePacketIdentifiersMap', function() {
    it('should create an instance of DeleteMultiplexProgramResponsePacketIdentifiersMap', function() {
      // uncomment below and update the code to test DeleteMultiplexProgramResponsePacketIdentifiersMap
      //var instance = new AwsElementalMediaLive.DeleteMultiplexProgramResponsePacketIdentifiersMap();
      //expect(instance).to.be.a(AwsElementalMediaLive.DeleteMultiplexProgramResponsePacketIdentifiersMap);
    });
