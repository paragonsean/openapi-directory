...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.UdpGroupSettings();
  });
  ...
  describe('UdpGroupSettings', function() {
    it('should create an instance of UdpGroupSettings', function() {
      // uncomment below and update the code to test UdpGroupSettings
      //var instance = new AwsElementalMediaLive.UdpGroupSettings();
      //expect(instance).to.be.a(AwsElementalMediaLive.UdpGroupSettings);
    });
