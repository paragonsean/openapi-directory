...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.UpdateMultiplexResponseMultiplex();
  });
  ...
  describe('UpdateMultiplexResponseMultiplex', function() {
    it('should create an instance of UpdateMultiplexResponseMultiplex', function() {
      // uncomment below and update the code to test UpdateMultiplexResponseMultiplex
      //var instance = new AwsElementalMediaLive.UpdateMultiplexResponseMultiplex();
      //expect(instance).to.be.a(AwsElementalMediaLive.UpdateMultiplexResponseMultiplex);
    });
