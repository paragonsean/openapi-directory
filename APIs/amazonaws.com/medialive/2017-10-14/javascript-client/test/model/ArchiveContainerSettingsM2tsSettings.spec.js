...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.ArchiveContainerSettingsM2tsSettings();
  });
  ...
  describe('ArchiveContainerSettingsM2tsSettings', function() {
    it('should create an instance of ArchiveContainerSettingsM2tsSettings', function() {
      // uncomment below and update the code to test ArchiveContainerSettingsM2tsSettings
      //var instance = new AwsElementalMediaLive.ArchiveContainerSettingsM2tsSettings();
      //expect(instance).to.be.a(AwsElementalMediaLive.ArchiveContainerSettingsM2tsSettings);
    });
