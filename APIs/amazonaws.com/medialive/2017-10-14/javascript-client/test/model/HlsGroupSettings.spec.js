...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaLive.HlsGroupSettings();
  });
  ...
  describe('HlsGroupSettings', function() {
    it('should create an instance of HlsGroupSettings', function() {
      ...
      //var instance = new AwsElementalMediaLive.HlsGroupSettings();
      //expect(instance).to.be.a(AwsElementalMediaLive.HlsGroupSettings);
    });
