...
OAIGetLatestConfigurationResponse::OAIGetLatestConfigurationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetLatestConfigurationResponse::OAIGetLatestConfigurationResponse() {
    this->initializeModel();
}

OAIGetLatestConfigurationResponse::~OAIGetLatestConfigurationResponse() {}

void OAIGetLatestConfigurationResponse::initializeModel() {

    m_configuration_isSet = false;
    m_configuration_isValid = false;
}

void OAIGetLatestConfigurationResponse::fromJson(QString jsonString) {
...
void OAIGetLatestConfigurationResponse::fromJsonObject(QJsonObject json) {

    m_configuration_isValid = ::OpenAPI::fromJsonValue(m_configuration, json[QString("Configuration")]);
    m_configuration_isSet = !json[QString("Configuration")].isNull() && m_configuration_isValid;
}

QString OAIGetLatestConfigurationResponse::asJson() const {
...
QJsonObject OAIGetLatestConfigurationResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetLatestConfigurationResponse::getConfiguration() const {
    return m_configuration;
}
void OAIGetLatestConfigurationResponse::setConfiguration(const QString &configuration) {
    m_configuration = configuration;
    m_configuration_isSet = true;
}

bool OAIGetLatestConfigurationResponse::is_configuration_Set() const{
    return m_configuration_isSet;
}

bool OAIGetLatestConfigurationResponse::is_configuration_Valid() const{
    return m_configuration_isValid;
}

bool OAIGetLatestConfigurationResponse::isSet() const {
...
bool OAIGetLatestConfigurationResponse::isValid() const {
