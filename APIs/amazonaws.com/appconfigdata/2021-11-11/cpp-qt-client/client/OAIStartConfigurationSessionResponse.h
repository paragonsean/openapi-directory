...
/*
 * OAIStartConfigurationSessionResponse.h
 *
 * 
 */

#ifndef OAIStartConfigurationSessionResponse_H
#define OAIStartConfigurationSessionResponse_H
...
class OAIStartConfigurationSessionResponse : public OAIObject {
public:
    OAIStartConfigurationSessionResponse();
    OAIStartConfigurationSessionResponse(QString json);
    ~OAIStartConfigurationSessionResponse() override;
    ...
    QString getInitialConfigurationToken() const;
    void setInitialConfigurationToken(const QString &initial_configuration_token);
    bool is_initial_configuration_token_Set() const;
    bool is_initial_configuration_token_Valid() const;
...
private:
    ...
    QString m_initial_configuration_token;
    bool m_initial_configuration_token_isSet;
    bool m_initial_configuration_token_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIStartConfigurationSessionResponse)

#endif // OAIStartConfigurationSessionResponse_H
