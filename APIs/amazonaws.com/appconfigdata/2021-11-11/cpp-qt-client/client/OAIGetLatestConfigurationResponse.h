...
/*
 * OAIGetLatestConfigurationResponse.h
 *
 * 
 */

#ifndef OAIGetLatestConfigurationResponse_H
#define OAIGetLatestConfigurationResponse_H
...
class OAIGetLatestConfigurationResponse : public OAIObject {
public:
    OAIGetLatestConfigurationResponse();
    OAIGetLatestConfigurationResponse(QString json);
    ~OAIGetLatestConfigurationResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLatestConfigurationResponse)

#endif // OAIGetLatestConfigurationResponse_H
