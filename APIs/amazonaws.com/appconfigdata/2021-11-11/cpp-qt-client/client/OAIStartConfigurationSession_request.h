...
/*
 * OAIStartConfigurationSession_request.h
 *
 * 
 */

#ifndef OAIStartConfigurationSession_request_H
#define OAIStartConfigurationSession_request_H
...
class OAIStartConfigurationSession_request : public OAIObject {
public:
    OAIStartConfigurationSession_request();
    OAIStartConfigurationSession_request(QString json);
    ~OAIStartConfigurationSession_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartConfigurationSession_request)

#endif // OAIStartConfigurationSession_request_H
