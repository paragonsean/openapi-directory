...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.AwsAppConfigData);
  }
}(this, function(expect, AwsAppConfigData) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new AwsAppConfigData.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    describe('getLatestConfiguration', function() {
      it('should call getLatestConfiguration successfully', function(done) {
        //uncomment below and update the code to test getLatestConfiguration
        //instance.getLatestConfiguration(function(error) {
    ...
    describe('startConfigurationSession', function() {
      it('should call startConfigurationSession successfully', function(done) {
        //uncomment below and update the code to test startConfigurationSession
        //instance.startConfigurationSession(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
