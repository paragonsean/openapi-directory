...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppConfigData.StartConfigurationSessionResponse();
  });
  ...
  describe('StartConfigurationSessionResponse', function() {
    it('should create an instance of StartConfigurationSessionResponse', function() {
      // uncomment below and update the code to test StartConfigurationSessionResponse
      //var instance = new AwsAppConfigData.StartConfigurationSessionResponse();
      //expect(instance).to.be.a(AwsAppConfigData.StartConfigurationSessionResponse);
    });

    it('should have the property initialConfigurationToken (base name: "InitialConfigurationToken")', function() {
      // uncomment below and update the code to test the property initialConfigurationToken
      //var instance = new AwsAppConfigData.StartConfigurationSessionResponse();
