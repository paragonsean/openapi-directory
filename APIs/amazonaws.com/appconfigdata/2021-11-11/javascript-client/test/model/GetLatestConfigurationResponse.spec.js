...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppConfigData.GetLatestConfigurationResponse();
  });
  ...
  describe('GetLatestConfigurationResponse', function() {
    it('should create an instance of GetLatestConfigurationResponse', function() {
      // uncomment below and update the code to test GetLatestConfigurationResponse
      //var instance = new AwsAppConfigData.GetLatestConfigurationResponse();
      //expect(instance).to.be.a(AwsAppConfigData.GetLatestConfigurationResponse);
    });
