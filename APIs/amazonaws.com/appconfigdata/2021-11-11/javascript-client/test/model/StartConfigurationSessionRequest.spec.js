...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppConfigData.StartConfigurationSessionRequest();
  });
  ...
  describe('StartConfigurationSessionRequest', function() {
    it('should create an instance of StartConfigurationSessionRequest', function() {
      // uncomment below and update the code to test StartConfigurationSessionRequest
      //var instance = new AwsAppConfigData.StartConfigurationSessionRequest();
      //expect(instance).to.be.a(AwsAppConfigData.StartConfigurationSessionRequest);
    });
    ...
    it('should have the property environmentIdentifier (base name: "EnvironmentIdentifier")', function() {
      // uncomment below and update the code to test the property environmentIdentifier
      //var instance = new AwsAppConfigData.StartConfigurationSessionRequest();
      //expect(instance).to.be();
    });

    it('should have the property configurationProfileIdentifier (base name: "ConfigurationProfileIdentifier")', function() {
      // uncomment below and update the code to test the property configurationProfileIdentifier
      //var instance = new AwsAppConfigData.StartConfigurationSessionRequest();
      //expect(instance).to.be();
    });

    it('should have the property requiredMinimumPollIntervalInSeconds (base name: "RequiredMinimumPollIntervalInSeconds")', function() {
      // uncomment below and update the code to test the property requiredMinimumPollIntervalInSeconds
      //var instance = new AwsAppConfigData.StartConfigurationSessionRequest();
      //expect(instance).to.be();
    });
