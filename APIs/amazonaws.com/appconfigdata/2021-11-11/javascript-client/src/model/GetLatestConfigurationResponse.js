...
/**
 * The GetLatestConfigurationResponse model module.
 * @module model/GetLatestConfigurationResponse
 * @version 2021-11-11
 */
class GetLatestConfigurationResponse {
    /**
     * Constructs a new <code>GetLatestConfigurationResponse</code>.
     * @alias module:model/GetLatestConfigurationResponse
     */
    constructor() { 
        
        GetLatestConfigurationResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetLatestConfigurationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetLatestConfigurationResponse} obj Optional instance to populate.
     * @return {module:model/GetLatestConfigurationResponse} The populated <code>GetLatestConfigurationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetLatestConfigurationResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetLatestConfigurationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetLatestConfigurationResponse</code>.
     */
 ...
 */
GetLatestConfigurationResponse.prototype['Configuration'] = undefined;
...
export default GetLatestConfigurationResponse;
