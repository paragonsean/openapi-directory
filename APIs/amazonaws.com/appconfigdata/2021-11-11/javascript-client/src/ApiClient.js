...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://appconfigdata.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://appconfigdata.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2021-11-11/Javascript'
        };
