...
public class DescribeScalableTargetsRequest {
  ...
  public DescribeScalableTargetsRequest serviceNamespace(ServiceNamespace serviceNamespace) {
  ...
  public DescribeScalableTargetsRequest resourceIds(List resourceIds) {
  ...
  public DescribeScalableTargetsRequest scalableDimension(ScalableDimension scalableDimension) {
  ...
  public DescribeScalableTargetsRequest maxResults(Integer maxResults) {
  ...
  public DescribeScalableTargetsRequest nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeScalableTargetsRequest describeScalableTargetsRequest = (DescribeScalableTargetsRequest) o;
    return Objects.equals(this.serviceNamespace, describeScalableTargetsRequest.serviceNamespace) &&
        Objects.equals(this.resourceIds, describeScalableTargetsRequest.resourceIds) &&
        Objects.equals(this.scalableDimension, describeScalableTargetsRequest.scalableDimension) &&
        Objects.equals(this.maxResults, describeScalableTargetsRequest.maxResults) &&
        Objects.equals(this.nextToken, describeScalableTargetsRequest.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(serviceNamespace, resourceIds, scalableDimension, maxResults, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeScalableTargetsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeScalableTargetsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeScalableTargetsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeScalableTargetsRequest is not found in the empty JSON string", DescribeScalableTargetsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeScalableTargetsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeScalableTargetsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeScalableTargetsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeScalableTargetsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeScalableTargetsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeScalableTargetsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeScalableTargetsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeScalableTargetsRequest>() {
           @Override
           public void write(JsonWriter out, DescribeScalableTargetsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeScalableTargetsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeScalableTargetsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeScalableTargetsRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeScalableTargetsRequest
   */
  public static DescribeScalableTargetsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeScalableTargetsRequest.class);
  }

  /**
   * Convert an instance of DescribeScalableTargetsRequest to an JSON string
   *
   * @return JSON string
   */
