...
public class TargetTrackingMetricStatMetric {
  ...
  public TargetTrackingMetricStatMetric() {
  }

  public TargetTrackingMetricStatMetric dimensions(List dimensions) {
  ...
  public TargetTrackingMetricStatMetric metricName(String metricName) {
  ...
  public TargetTrackingMetricStatMetric namespace(String namespace) {
  ...
  public boolean equals(Object o) {
    ...
    TargetTrackingMetricStatMetric targetTrackingMetricStatMetric = (TargetTrackingMetricStatMetric) o;
    return Objects.equals(this.dimensions, targetTrackingMetricStatMetric.dimensions) &&
        Objects.equals(this.metricName, targetTrackingMetricStatMetric.metricName) &&
        Objects.equals(this.namespace, targetTrackingMetricStatMetric.namespace);
  }
  ...
  public String toString() {
    ...
    sb.append("class TargetTrackingMetricStatMetric {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TargetTrackingMetricStatMetric
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetTrackingMetricStatMetric.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TargetTrackingMetricStatMetric is not found in the empty JSON string", TargetTrackingMetricStatMetric.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetTrackingMetricStatMetric.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TargetTrackingMetricStatMetric` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TargetTrackingMetricStatMetric.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TargetTrackingMetricStatMetric' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TargetTrackingMetricStatMetric> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TargetTrackingMetricStatMetric.class));

       return (TypeAdapter<T>) new TypeAdapter<TargetTrackingMetricStatMetric>() {
           @Override
           public void write(JsonWriter out, TargetTrackingMetricStatMetric value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TargetTrackingMetricStatMetric read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TargetTrackingMetricStatMetric given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TargetTrackingMetricStatMetric
   * @throws IOException if the JSON string is invalid with respect to TargetTrackingMetricStatMetric
   */
  public static TargetTrackingMetricStatMetric fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TargetTrackingMetricStatMetric.class);
  }

  /**
   * Convert an instance of TargetTrackingMetricStatMetric to an JSON string
   *
   * @return JSON string
   */
