...
public class ScalingPolicyStepScalingPolicyConfiguration {
  ...
  public ScalingPolicyStepScalingPolicyConfiguration adjustmentType(AdjustmentType adjustmentType) {
  ...
  public ScalingPolicyStepScalingPolicyConfiguration stepAdjustments(List stepAdjustments) {
  ...
  public ScalingPolicyStepScalingPolicyConfiguration minAdjustmentMagnitude(Integer minAdjustmentMagnitude) {
  ...
  public ScalingPolicyStepScalingPolicyConfiguration cooldown(Integer cooldown) {
  ...
  public ScalingPolicyStepScalingPolicyConfiguration metricAggregationType(MetricAggregationType metricAggregationType) {
  ...
  public boolean equals(Object o) {
    ...
    ScalingPolicyStepScalingPolicyConfiguration scalingPolicyStepScalingPolicyConfiguration = (ScalingPolicyStepScalingPolicyConfiguration) o;
    return Objects.equals(this.adjustmentType, scalingPolicyStepScalingPolicyConfiguration.adjustmentType) &&
        Objects.equals(this.stepAdjustments, scalingPolicyStepScalingPolicyConfiguration.stepAdjustments) &&
        Objects.equals(this.minAdjustmentMagnitude, scalingPolicyStepScalingPolicyConfiguration.minAdjustmentMagnitude) &&
        Objects.equals(this.cooldown, scalingPolicyStepScalingPolicyConfiguration.cooldown) &&
        Objects.equals(this.metricAggregationType, scalingPolicyStepScalingPolicyConfiguration.metricAggregationType);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScalingPolicyStepScalingPolicyConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScalingPolicyStepScalingPolicyConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScalingPolicyStepScalingPolicyConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScalingPolicyStepScalingPolicyConfiguration is not found in the empty JSON string", ScalingPolicyStepScalingPolicyConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScalingPolicyStepScalingPolicyConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScalingPolicyStepScalingPolicyConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScalingPolicyStepScalingPolicyConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScalingPolicyStepScalingPolicyConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScalingPolicyStepScalingPolicyConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScalingPolicyStepScalingPolicyConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<ScalingPolicyStepScalingPolicyConfiguration>() {
           @Override
           public void write(JsonWriter out, ScalingPolicyStepScalingPolicyConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScalingPolicyStepScalingPolicyConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ScalingPolicyStepScalingPolicyConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScalingPolicyStepScalingPolicyConfiguration
   * @throws IOException if the JSON string is invalid with respect to ScalingPolicyStepScalingPolicyConfiguration
   */
  public static ScalingPolicyStepScalingPolicyConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScalingPolicyStepScalingPolicyConfiguration.class);
  }

  /**
   * Convert an instance of ScalingPolicyStepScalingPolicyConfiguration to an JSON string
   *
   * @return JSON string
   */
