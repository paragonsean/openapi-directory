...
public class DeleteScheduledActionRequest {
  ...
  public DeleteScheduledActionRequest serviceNamespace(ServiceNamespace serviceNamespace) {
  ...
  public DeleteScheduledActionRequest resourceId(String resourceId) {
  ...
  public DeleteScheduledActionRequest scalableDimension(ScalableDimension scalableDimension) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.serviceNamespace, deleteScheduledActionRequest.serviceNamespace) &&
        Objects.equals(this.scheduledActionName, deleteScheduledActionRequest.scheduledActionName) &&
        Objects.equals(this.resourceId, deleteScheduledActionRequest.resourceId) &&
        Objects.equals(this.scalableDimension, deleteScheduledActionRequest.scalableDimension);
  }

  @Override
  public int hashCode() {
    return Objects.hash(serviceNamespace, scheduledActionName, resourceId, scalableDimension);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteScheduledActionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteScheduledActionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteScheduledActionRequest is not found in the empty JSON string", DeleteScheduledActionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteScheduledActionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteScheduledActionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteScheduledActionRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteScheduledActionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteScheduledActionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteScheduledActionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteScheduledActionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteScheduledActionRequest>() {
           @Override
           public void write(JsonWriter out, DeleteScheduledActionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteScheduledActionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteScheduledActionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteScheduledActionRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteScheduledActionRequest
   */
  public static DeleteScheduledActionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteScheduledActionRequest.class);
  }

  /**
   * Convert an instance of DeleteScheduledActionRequest to an JSON string
   *
   * @return JSON string
   */
