 ...
 */
@JsonAdapter(ServiceNamespace.Adapter.class)
public enum ServiceNamespace {
  ...
  public static ServiceNamespace fromValue(String value) {
    for (ServiceNamespace b : ServiceNamespace.values()) {
  ...
  public static class Adapter extends TypeAdapter<ServiceNamespace> {
    @Override
    public void write(final JsonWriter jsonWriter, final ServiceNamespace enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ServiceNamespace read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ServiceNamespace.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ServiceNamespace.fromValue(value);
  }
}
