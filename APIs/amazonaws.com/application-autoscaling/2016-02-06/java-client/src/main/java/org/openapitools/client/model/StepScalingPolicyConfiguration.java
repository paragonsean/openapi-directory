...
public class StepScalingPolicyConfiguration {
  ...
  public StepScalingPolicyConfiguration adjustmentType(AdjustmentType adjustmentType) {
  ...
  public StepScalingPolicyConfiguration stepAdjustments(List stepAdjustments) {
  ...
  public StepScalingPolicyConfiguration minAdjustmentMagnitude(Integer minAdjustmentMagnitude) {
  ...
  public StepScalingPolicyConfiguration cooldown(Integer cooldown) {
  ...
  public StepScalingPolicyConfiguration metricAggregationType(MetricAggregationType metricAggregationType) {
  ...
  public boolean equals(Object o) {
    ...
    StepScalingPolicyConfiguration stepScalingPolicyConfiguration = (StepScalingPolicyConfiguration) o;
    return Objects.equals(this.adjustmentType, stepScalingPolicyConfiguration.adjustmentType) &&
        Objects.equals(this.stepAdjustments, stepScalingPolicyConfiguration.stepAdjustments) &&
        Objects.equals(this.minAdjustmentMagnitude, stepScalingPolicyConfiguration.minAdjustmentMagnitude) &&
        Objects.equals(this.cooldown, stepScalingPolicyConfiguration.cooldown) &&
        Objects.equals(this.metricAggregationType, stepScalingPolicyConfiguration.metricAggregationType);
  }
  ...
  public String toString() {
    ...
    sb.append("class StepScalingPolicyConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StepScalingPolicyConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StepScalingPolicyConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StepScalingPolicyConfiguration is not found in the empty JSON string", StepScalingPolicyConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StepScalingPolicyConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StepScalingPolicyConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StepScalingPolicyConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StepScalingPolicyConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StepScalingPolicyConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StepScalingPolicyConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<StepScalingPolicyConfiguration>() {
           @Override
           public void write(JsonWriter out, StepScalingPolicyConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StepScalingPolicyConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StepScalingPolicyConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StepScalingPolicyConfiguration
   * @throws IOException if the JSON string is invalid with respect to StepScalingPolicyConfiguration
   */
  public static StepScalingPolicyConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StepScalingPolicyConfiguration.class);
  }

  /**
   * Convert an instance of StepScalingPolicyConfiguration to an JSON string
   *
   * @return JSON string
   */
