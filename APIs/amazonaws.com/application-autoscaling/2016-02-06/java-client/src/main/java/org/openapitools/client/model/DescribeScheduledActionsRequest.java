...
public class DescribeScheduledActionsRequest {
  ...
  public DescribeScheduledActionsRequest scheduledActionNames(List scheduledActionNames) {
  ...
  public DescribeScheduledActionsRequest serviceNamespace(ServiceNamespace serviceNamespace) {
  ...
  public DescribeScheduledActionsRequest resourceId(String resourceId) {
  ...
  public DescribeScheduledActionsRequest scalableDimension(ScalableDimension scalableDimension) {
  ...
  public DescribeScheduledActionsRequest maxResults(Integer maxResults) {
  ...
  public DescribeScheduledActionsRequest nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeScheduledActionsRequest describeScheduledActionsRequest = (DescribeScheduledActionsRequest) o;
    return Objects.equals(this.scheduledActionNames, describeScheduledActionsRequest.scheduledActionNames) &&
        Objects.equals(this.serviceNamespace, describeScheduledActionsRequest.serviceNamespace) &&
        Objects.equals(this.resourceId, describeScheduledActionsRequest.resourceId) &&
        Objects.equals(this.scalableDimension, describeScheduledActionsRequest.scalableDimension) &&
        Objects.equals(this.maxResults, describeScheduledActionsRequest.maxResults) &&
        Objects.equals(this.nextToken, describeScheduledActionsRequest.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(scheduledActionNames, serviceNamespace, resourceId, scalableDimension, maxResults, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeScheduledActionsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeScheduledActionsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeScheduledActionsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeScheduledActionsRequest is not found in the empty JSON string", DescribeScheduledActionsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeScheduledActionsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeScheduledActionsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeScheduledActionsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeScheduledActionsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeScheduledActionsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeScheduledActionsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeScheduledActionsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeScheduledActionsRequest>() {
           @Override
           public void write(JsonWriter out, DescribeScheduledActionsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeScheduledActionsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeScheduledActionsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeScheduledActionsRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeScheduledActionsRequest
   */
  public static DescribeScheduledActionsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeScheduledActionsRequest.class);
  }

  /**
   * Convert an instance of DescribeScheduledActionsRequest to an JSON string
   *
   * @return JSON string
   */
