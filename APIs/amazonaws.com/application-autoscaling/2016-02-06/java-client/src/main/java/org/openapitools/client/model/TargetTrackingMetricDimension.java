...
public class TargetTrackingMetricDimension {
  ...
  public TargetTrackingMetricDimension() {
  }

  public TargetTrackingMetricDimension name(String name) {
    this.name = name;
    return this;
  }
  ...
  public TargetTrackingMetricDimension value(String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TargetTrackingMetricDimension targetTrackingMetricDimension = (TargetTrackingMetricDimension) o;
    return Objects.equals(this.name, targetTrackingMetricDimension.name) &&
        Objects.equals(this.value, targetTrackingMetricDimension.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class TargetTrackingMetricDimension {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TargetTrackingMetricDimension
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetTrackingMetricDimension.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TargetTrackingMetricDimension is not found in the empty JSON string", TargetTrackingMetricDimension.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetTrackingMetricDimension.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TargetTrackingMetricDimension` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TargetTrackingMetricDimension.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TargetTrackingMetricDimension.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TargetTrackingMetricDimension' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TargetTrackingMetricDimension> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TargetTrackingMetricDimension.class));

       return (TypeAdapter<T>) new TypeAdapter<TargetTrackingMetricDimension>() {
           @Override
           public void write(JsonWriter out, TargetTrackingMetricDimension value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TargetTrackingMetricDimension read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TargetTrackingMetricDimension given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TargetTrackingMetricDimension
   * @throws IOException if the JSON string is invalid with respect to TargetTrackingMetricDimension
   */
  public static TargetTrackingMetricDimension fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TargetTrackingMetricDimension.class);
  }

  /**
   * Convert an instance of TargetTrackingMetricDimension to an JSON string
   *
   * @return JSON string
   */
