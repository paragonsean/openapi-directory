...
public class ApiClient {
    ...
    private String basePath = "http://application-autoscaling.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2016-02-06/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://application-autoscaling.us-east-1.amazonaws.com
