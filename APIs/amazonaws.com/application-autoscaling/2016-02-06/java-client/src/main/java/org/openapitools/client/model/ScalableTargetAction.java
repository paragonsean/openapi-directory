...
public class ScalableTargetAction {
  ...
  public ScalableTargetAction minCapacity(Integer minCapacity) {
  ...
  public ScalableTargetAction maxCapacity(Integer maxCapacity) {
  ...
  public boolean equals(Object o) {
    ...
    ScalableTargetAction scalableTargetAction = (ScalableTargetAction) o;
    return Objects.equals(this.minCapacity, scalableTargetAction.minCapacity) &&
        Objects.equals(this.maxCapacity, scalableTargetAction.maxCapacity);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScalableTargetAction {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScalableTargetAction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScalableTargetAction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScalableTargetAction is not found in the empty JSON string", ScalableTargetAction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScalableTargetAction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScalableTargetAction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScalableTargetAction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScalableTargetAction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScalableTargetAction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScalableTargetAction.class));

       return (TypeAdapter<T>) new TypeAdapter<ScalableTargetAction>() {
           @Override
           public void write(JsonWriter out, ScalableTargetAction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScalableTargetAction read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ScalableTargetAction given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScalableTargetAction
   * @throws IOException if the JSON string is invalid with respect to ScalableTargetAction
   */
  public static ScalableTargetAction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScalableTargetAction.class);
  }

  /**
   * Convert an instance of ScalableTargetAction to an JSON string
   *
   * @return JSON string
   */
