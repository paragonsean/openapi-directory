...
public class PutScalingPolicyRequest {
  ...
  private PutScalingPolicyRequestStepScalingPolicyConfiguration stepScalingPolicyConfiguration;
  ...
  private PutScalingPolicyRequestTargetTrackingScalingPolicyConfiguration targetTrackingScalingPolicyConfiguration;
  ...
  public PutScalingPolicyRequest serviceNamespace(ServiceNamespace serviceNamespace) {
  ...
  public PutScalingPolicyRequest resourceId(String resourceId) {
  ...
  public PutScalingPolicyRequest scalableDimension(ScalableDimension scalableDimension) {
  ...
  public PutScalingPolicyRequest policyType(PolicyType policyType) {
  ...
  public PutScalingPolicyRequest stepScalingPolicyConfiguration(PutScalingPolicyRequestStepScalingPolicyConfiguration stepScalingPolicyConfiguration) {
   ...
   */
  @javax.annotation.Nullable
  public PutScalingPolicyRequestStepScalingPolicyConfiguration getStepScalingPolicyConfiguration() {
    return stepScalingPolicyConfiguration;
  }

  public void setStepScalingPolicyConfiguration(PutScalingPolicyRequestStepScalingPolicyConfiguration stepScalingPolicyConfiguration) {
    this.stepScalingPolicyConfiguration = stepScalingPolicyConfiguration;
  }


  public PutScalingPolicyRequest targetTrackingScalingPolicyConfiguration(PutScalingPolicyRequestTargetTrackingScalingPolicyConfiguration targetTrackingScalingPolicyConfiguration) {
   ...
   */
  @javax.annotation.Nullable
  public PutScalingPolicyRequestTargetTrackingScalingPolicyConfiguration getTargetTrackingScalingPolicyConfiguration() {
    return targetTrackingScalingPolicyConfiguration;
  }

  public void setTargetTrackingScalingPolicyConfiguration(PutScalingPolicyRequestTargetTrackingScalingPolicyConfiguration targetTrackingScalingPolicyConfiguration) {
    this.targetTrackingScalingPolicyConfiguration = targetTrackingScalingPolicyConfiguration;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.policyName, putScalingPolicyRequest.policyName) &&
        Objects.equals(this.serviceNamespace, putScalingPolicyRequest.serviceNamespace) &&
        Objects.equals(this.resourceId, putScalingPolicyRequest.resourceId) &&
        Objects.equals(this.scalableDimension, putScalingPolicyRequest.scalableDimension) &&
        Objects.equals(this.policyType, putScalingPolicyRequest.policyType) &&
        Objects.equals(this.stepScalingPolicyConfiguration, putScalingPolicyRequest.stepScalingPolicyConfiguration) &&
        Objects.equals(this.targetTrackingScalingPolicyConfiguration, putScalingPolicyRequest.targetTrackingScalingPolicyConfiguration);
  }

  @Override
  public int hashCode() {
    return Objects.hash(policyName, serviceNamespace, resourceId, scalableDimension, policyType, stepScalingPolicyConfiguration, targetTrackingScalingPolicyConfiguration);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutScalingPolicyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutScalingPolicyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutScalingPolicyRequest is not found in the empty JSON string", PutScalingPolicyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutScalingPolicyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutScalingPolicyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PutScalingPolicyRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("StepScalingPolicyConfiguration") != null && !jsonObj.get("StepScalingPolicyConfiguration").isJsonNull()) {
        PutScalingPolicyRequestStepScalingPolicyConfiguration.validateJsonElement(jsonObj.get("StepScalingPolicyConfiguration"));
      }
      ...
      if (jsonObj.get("TargetTrackingScalingPolicyConfiguration") != null && !jsonObj.get("TargetTrackingScalingPolicyConfiguration").isJsonNull()) {
        PutScalingPolicyRequestTargetTrackingScalingPolicyConfiguration.validateJsonElement(jsonObj.get("TargetTrackingScalingPolicyConfiguration"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutScalingPolicyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutScalingPolicyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutScalingPolicyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutScalingPolicyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PutScalingPolicyRequest>() {
           @Override
           public void write(JsonWriter out, PutScalingPolicyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutScalingPolicyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutScalingPolicyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutScalingPolicyRequest
   * @throws IOException if the JSON string is invalid with respect to PutScalingPolicyRequest
   */
  public static PutScalingPolicyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutScalingPolicyRequest.class);
  }

  /**
   * Convert an instance of PutScalingPolicyRequest to an JSON string
   *
   * @return JSON string
   */
