...
/**
 * Gets or Sets MetricAggregationType
 */
@JsonAdapter(MetricAggregationType.Adapter.class)
public enum MetricAggregationType {
  ...
  public static MetricAggregationType fromValue(String value) {
    for (MetricAggregationType b : MetricAggregationType.values()) {
  ...
  public static class Adapter extends TypeAdapter<MetricAggregationType> {
    @Override
    public void write(final JsonWriter jsonWriter, final MetricAggregationType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public MetricAggregationType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return MetricAggregationType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    MetricAggregationType.fromValue(value);
  }
}
