...
public class TargetTrackingMetricStat {
  ...
  public TargetTrackingMetricStat metric(TargetTrackingMetricStatMetric metric) {
    this.metric = metric;
    return this;
  }
  ...
  public TargetTrackingMetricStat stat(String stat) {
    this.stat = stat;
    return this;
  }
  ...
  public TargetTrackingMetricStat unit(String unit) {
    this.unit = unit;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TargetTrackingMetricStat targetTrackingMetricStat = (TargetTrackingMetricStat) o;
    return Objects.equals(this.metric, targetTrackingMetricStat.metric) &&
        Objects.equals(this.stat, targetTrackingMetricStat.stat) &&
        Objects.equals(this.unit, targetTrackingMetricStat.unit);
  }
  ...
  public String toString() {
    ...
    sb.append("class TargetTrackingMetricStat {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TargetTrackingMetricStat
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetTrackingMetricStat.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TargetTrackingMetricStat is not found in the empty JSON string", TargetTrackingMetricStat.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetTrackingMetricStat.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TargetTrackingMetricStat` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TargetTrackingMetricStat.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TargetTrackingMetricStat.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TargetTrackingMetricStat' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TargetTrackingMetricStat> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TargetTrackingMetricStat.class));

       return (TypeAdapter<T>) new TypeAdapter<TargetTrackingMetricStat>() {
           @Override
           public void write(JsonWriter out, TargetTrackingMetricStat value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TargetTrackingMetricStat read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TargetTrackingMetricStat given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TargetTrackingMetricStat
   * @throws IOException if the JSON string is invalid with respect to TargetTrackingMetricStat
   */
  public static TargetTrackingMetricStat fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TargetTrackingMetricStat.class);
  }

  /**
   * Convert an instance of TargetTrackingMetricStat to an JSON string
   *
   * @return JSON string
   */
