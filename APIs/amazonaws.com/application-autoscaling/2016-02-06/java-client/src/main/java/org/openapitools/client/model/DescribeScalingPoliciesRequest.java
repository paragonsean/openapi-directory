...
public class DescribeScalingPoliciesRequest {
  ...
  public DescribeScalingPoliciesRequest policyNames(List policyNames) {
  ...
  public DescribeScalingPoliciesRequest serviceNamespace(ServiceNamespace serviceNamespace) {
  ...
  public DescribeScalingPoliciesRequest resourceId(String resourceId) {
  ...
  public DescribeScalingPoliciesRequest scalableDimension(ScalableDimension scalableDimension) {
  ...
  public DescribeScalingPoliciesRequest maxResults(Integer maxResults) {
  ...
  public DescribeScalingPoliciesRequest nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.policyNames, describeScalingPoliciesRequest.policyNames) &&
        Objects.equals(this.serviceNamespace, describeScalingPoliciesRequest.serviceNamespace) &&
        Objects.equals(this.resourceId, describeScalingPoliciesRequest.resourceId) &&
        Objects.equals(this.scalableDimension, describeScalingPoliciesRequest.scalableDimension) &&
        Objects.equals(this.maxResults, describeScalingPoliciesRequest.maxResults) &&
        Objects.equals(this.nextToken, describeScalingPoliciesRequest.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(policyNames, serviceNamespace, resourceId, scalableDimension, maxResults, nextToken);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeScalingPoliciesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeScalingPoliciesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeScalingPoliciesRequest is not found in the empty JSON string", DescribeScalingPoliciesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeScalingPoliciesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeScalingPoliciesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeScalingPoliciesRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeScalingPoliciesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeScalingPoliciesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeScalingPoliciesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeScalingPoliciesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeScalingPoliciesRequest>() {
           @Override
           public void write(JsonWriter out, DescribeScalingPoliciesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeScalingPoliciesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeScalingPoliciesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeScalingPoliciesRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeScalingPoliciesRequest
   */
  public static DescribeScalingPoliciesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeScalingPoliciesRequest.class);
  }

  /**
   * Convert an instance of DescribeScalingPoliciesRequest to an JSON string
   *
   * @return JSON string
   */
