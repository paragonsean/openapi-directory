 ...
 */
@JsonAdapter(AdjustmentType.Adapter.class)
public enum AdjustmentType {
  ...
  public static AdjustmentType fromValue(String value) {
    for (AdjustmentType b : AdjustmentType.values()) {
  ...
  public static class Adapter extends TypeAdapter<AdjustmentType> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdjustmentType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AdjustmentType read(final JsonReader jsonReader) throws IOException {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    AdjustmentType.fromValue(value);
  }
}
