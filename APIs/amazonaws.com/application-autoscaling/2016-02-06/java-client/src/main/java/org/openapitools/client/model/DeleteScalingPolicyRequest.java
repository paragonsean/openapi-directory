...
public class DeleteScalingPolicyRequest {
  ...
  public DeleteScalingPolicyRequest policyName(String policyName) {
  ...
  public DeleteScalingPolicyRequest serviceNamespace(ServiceNamespace serviceNamespace) {
  ...
  public DeleteScalingPolicyRequest resourceId(String resourceId) {
  ...
  public DeleteScalingPolicyRequest scalableDimension(ScalableDimension scalableDimension) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.policyName, deleteScalingPolicyRequest.policyName) &&
        Objects.equals(this.serviceNamespace, deleteScalingPolicyRequest.serviceNamespace) &&
        Objects.equals(this.resourceId, deleteScalingPolicyRequest.resourceId) &&
        Objects.equals(this.scalableDimension, deleteScalingPolicyRequest.scalableDimension);
  }

  @Override
  public int hashCode() {
    return Objects.hash(policyName, serviceNamespace, resourceId, scalableDimension);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteScalingPolicyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteScalingPolicyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteScalingPolicyRequest is not found in the empty JSON string", DeleteScalingPolicyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteScalingPolicyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteScalingPolicyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteScalingPolicyRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteScalingPolicyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteScalingPolicyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteScalingPolicyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteScalingPolicyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteScalingPolicyRequest>() {
           @Override
           public void write(JsonWriter out, DeleteScalingPolicyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteScalingPolicyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteScalingPolicyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteScalingPolicyRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteScalingPolicyRequest
   */
  public static DeleteScalingPolicyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteScalingPolicyRequest.class);
  }

  /**
   * Convert an instance of DeleteScalingPolicyRequest to an JSON string
   *
   * @return JSON string
   */
