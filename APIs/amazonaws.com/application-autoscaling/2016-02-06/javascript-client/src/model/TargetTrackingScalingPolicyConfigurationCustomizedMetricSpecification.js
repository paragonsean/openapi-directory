...
/**
 * The TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification model module.
 * @module model/TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification
 * @version 2016-02-06
 */
class TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification {
    /**
     * Constructs a new <code>TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification</code>.
     * @alias module:model/TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification
     * @implements module:model/CustomizedMetricSpecification
     */
    constructor() { 
        CustomizedMetricSpecification.initialize(this);
        TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification} obj Optional instance to populate.
     * @return {module:model/TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification} The populated <code>TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification();
    ...
    /**
     * Validates the JSON data with respect to <code>TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification</code>.
     */
 ...
 */
TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification.prototype['MetricName'] = undefined;

/**
 * @member {String} Namespace
 */
TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification.prototype['Namespace'] = undefined;

/**
 * @member {Array} Dimensions
 */
TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification.prototype['Dimensions'] = undefined;

/**
 * @member {module:model/MetricStatistic} Statistic
 */
TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification.prototype['Statistic'] = undefined;

/**
 * @member {String} Unit
 */
TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification.prototype['Unit'] = undefined;

/**
 * @member {Array} Metrics
 */
TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification.prototype['Metrics'] = undefined;
...
export default TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification;
