...
* @readonly
*/
export default class AdjustmentType {
    ...
    /**
    * Returns a <code>AdjustmentType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AdjustmentType} The enum <code>AdjustmentType</code> value.
    */
