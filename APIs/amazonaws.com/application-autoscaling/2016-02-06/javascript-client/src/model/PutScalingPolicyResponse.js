...
class PutScalingPolicyResponse {
    ...
    constructor(policyARN) { 
        ...
        PutScalingPolicyResponse.initialize(this, policyARN);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutScalingPolicyResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>PutScalingPolicyResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutScalingPolicyResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutScalingPolicyResponse.RequiredProperties) {
...
PutScalingPolicyResponse.RequiredProperties = ["PolicyARN"];

/**
 * @member {String} PolicyARN
 */
PutScalingPolicyResponse.prototype['PolicyARN'] = undefined;

/**
 * @member {Array} Alarms
 */
PutScalingPolicyResponse.prototype['Alarms'] = undefined;
...
export default PutScalingPolicyResponse;
