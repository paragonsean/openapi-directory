...
/**
 * The DeleteScalingPolicyRequest model module.
 * @module model/DeleteScalingPolicyRequest
 * @version 2016-02-06
 */
class DeleteScalingPolicyRequest {
    /**
     * Constructs a new <code>DeleteScalingPolicyRequest</code>.
     * @alias module:model/DeleteScalingPolicyRequest
    ...
    constructor(policyName, serviceNamespace, resourceId, scalableDimension) { 
        ...
        DeleteScalingPolicyRequest.initialize(this, policyName, serviceNamespace, resourceId, scalableDimension);
    }
    ...
    /**
     * Constructs a <code>DeleteScalingPolicyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteScalingPolicyRequest} obj Optional instance to populate.
     * @return {module:model/DeleteScalingPolicyRequest} The populated <code>DeleteScalingPolicyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteScalingPolicyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteScalingPolicyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteScalingPolicyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteScalingPolicyRequest.RequiredProperties) {
...
DeleteScalingPolicyRequest.RequiredProperties = ["PolicyName", "ServiceNamespace", "ResourceId", "ScalableDimension"];

/**
 * @member {String} PolicyName
 */
DeleteScalingPolicyRequest.prototype['PolicyName'] = undefined;

/**
 * @member {module:model/ServiceNamespace} ServiceNamespace
 */
DeleteScalingPolicyRequest.prototype['ServiceNamespace'] = undefined;

/**
 * @member {String} ResourceId
 */
DeleteScalingPolicyRequest.prototype['ResourceId'] = undefined;

/**
 * @member {module:model/ScalableDimension} ScalableDimension
 */
DeleteScalingPolicyRequest.prototype['ScalableDimension'] = undefined;
...
export default DeleteScalingPolicyRequest;
