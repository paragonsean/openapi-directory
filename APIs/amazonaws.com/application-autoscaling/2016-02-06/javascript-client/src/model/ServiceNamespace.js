...
* @readonly
*/
export default class ServiceNamespace {
    ...
    /**
    * Returns a <code>ServiceNamespace</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ServiceNamespace} The enum <code>ServiceNamespace</code> value.
    */
