...
/**
 * The SuspendedState model module.
 * @module model/SuspendedState
 * @version 2016-02-06
 */
class SuspendedState {
    /**
     * Constructs a new <code>SuspendedState</code>.
     * Specifies whether the scaling activities for a scalable target are in a suspended state. 
     * @alias module:model/SuspendedState
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>SuspendedState</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SuspendedState} obj Optional instance to populate.
     * @return {module:model/SuspendedState} The populated <code>SuspendedState</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SuspendedState();
    ...
    /**
     * Validates the JSON data with respect to <code>SuspendedState</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SuspendedState</code>.
     */
