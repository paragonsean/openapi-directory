...
/**
 * The DescribeScalableTargetsResponse model module.
 * @module model/DescribeScalableTargetsResponse
 * @version 2016-02-06
 */
class DescribeScalableTargetsResponse {
    /**
     * Constructs a new <code>DescribeScalableTargetsResponse</code>.
     * @alias module:model/DescribeScalableTargetsResponse
     */
    constructor() { 
        
        DescribeScalableTargetsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeScalableTargetsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeScalableTargetsResponse} obj Optional instance to populate.
     * @return {module:model/DescribeScalableTargetsResponse} The populated <code>DescribeScalableTargetsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeScalableTargetsResponse();

            if (data.hasOwnProperty('ScalableTargets')) {
                obj['ScalableTargets'] = ApiClient.convertToType(data['ScalableTargets'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeScalableTargetsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeScalableTargetsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `ScalableTargets`
        if (data['ScalableTargets']) { // data not null
          Array.validateJSON(data['ScalableTargets']);
        }
...
/**
 * @member {Array} ScalableTargets
 */
DescribeScalableTargetsResponse.prototype['ScalableTargets'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeScalableTargetsResponse.prototype['NextToken'] = undefined;
...
export default DescribeScalableTargetsResponse;
