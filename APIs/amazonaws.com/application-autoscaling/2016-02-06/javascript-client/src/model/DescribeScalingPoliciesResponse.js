...
/**
 * The DescribeScalingPoliciesResponse model module.
 * @module model/DescribeScalingPoliciesResponse
 * @version 2016-02-06
 */
class DescribeScalingPoliciesResponse {
    /**
     * Constructs a new <code>DescribeScalingPoliciesResponse</code>.
     * @alias module:model/DescribeScalingPoliciesResponse
     */
    constructor() { 
        
        DescribeScalingPoliciesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeScalingPoliciesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeScalingPoliciesResponse} obj Optional instance to populate.
     * @return {module:model/DescribeScalingPoliciesResponse} The populated <code>DescribeScalingPoliciesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeScalingPoliciesResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeScalingPoliciesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeScalingPoliciesResponse</code>.
     */
 ...
 */
DescribeScalingPoliciesResponse.prototype['ScalingPolicies'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeScalingPoliciesResponse.prototype['NextToken'] = undefined;
...
export default DescribeScalingPoliciesResponse;
