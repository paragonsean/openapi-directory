...
* @readonly
*/
export default class MetricAggregationType {
    ...
    /**
    * Returns a <code>MetricAggregationType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/MetricAggregationType} The enum <code>MetricAggregationType</code> value.
    */
