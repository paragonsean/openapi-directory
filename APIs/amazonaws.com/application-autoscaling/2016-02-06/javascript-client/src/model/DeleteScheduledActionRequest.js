...
class DeleteScheduledActionRequest {
    ...
    constructor(serviceNamespace, scheduledActionName, resourceId, scalableDimension) { 
        ...
        DeleteScheduledActionRequest.initialize(this, serviceNamespace, scheduledActionName, resourceId, scalableDimension);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteScheduledActionRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteScheduledActionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteScheduledActionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteScheduledActionRequest.RequiredProperties) {
...
DeleteScheduledActionRequest.RequiredProperties = ["ServiceNamespace", "ScheduledActionName", "ResourceId", "ScalableDimension"];

/**
 * @member {module:model/ServiceNamespace} ServiceNamespace
 */
DeleteScheduledActionRequest.prototype['ServiceNamespace'] = undefined;

/**
 * @member {String} ScheduledActionName
 */
DeleteScheduledActionRequest.prototype['ScheduledActionName'] = undefined;

/**
 * @member {String} ResourceId
 */
DeleteScheduledActionRequest.prototype['ResourceId'] = undefined;

/**
 * @member {module:model/ScalableDimension} ScalableDimension
 */
DeleteScheduledActionRequest.prototype['ScalableDimension'] = undefined;
...
export default DeleteScheduledActionRequest;
