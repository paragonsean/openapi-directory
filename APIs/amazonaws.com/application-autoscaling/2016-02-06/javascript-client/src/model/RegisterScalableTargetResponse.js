...
/**
 * The RegisterScalableTargetResponse model module.
 * @module model/RegisterScalableTargetResponse
 * @version 2016-02-06
 */
class RegisterScalableTargetResponse {
    /**
     * Constructs a new <code>RegisterScalableTargetResponse</code>.
     * @alias module:model/RegisterScalableTargetResponse
     */
    constructor() { 
        
        RegisterScalableTargetResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RegisterScalableTargetResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RegisterScalableTargetResponse} obj Optional instance to populate.
     * @return {module:model/RegisterScalableTargetResponse} The populated <code>RegisterScalableTargetResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RegisterScalableTargetResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>RegisterScalableTargetResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RegisterScalableTargetResponse</code>.
     */
 ...
 */
RegisterScalableTargetResponse.prototype['ScalableTargetARN'] = undefined;
...
export default RegisterScalableTargetResponse;
