...
/**
 * The PutScalingPolicyRequestStepScalingPolicyConfiguration model module.
 * @module model/PutScalingPolicyRequestStepScalingPolicyConfiguration
 * @version 2016-02-06
 */
class PutScalingPolicyRequestStepScalingPolicyConfiguration {
    /**
     * Constructs a new <code>PutScalingPolicyRequestStepScalingPolicyConfiguration</code>.
     * @alias module:model/PutScalingPolicyRequestStepScalingPolicyConfiguration
     * @implements module:model/StepScalingPolicyConfiguration
     */
    constructor() { 
        StepScalingPolicyConfiguration.initialize(this);
        PutScalingPolicyRequestStepScalingPolicyConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutScalingPolicyRequestStepScalingPolicyConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutScalingPolicyRequestStepScalingPolicyConfiguration} obj Optional instance to populate.
     * @return {module:model/PutScalingPolicyRequestStepScalingPolicyConfiguration} The populated <code>PutScalingPolicyRequestStepScalingPolicyConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutScalingPolicyRequestStepScalingPolicyConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>PutScalingPolicyRequestStepScalingPolicyConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutScalingPolicyRequestStepScalingPolicyConfiguration</code>.
     */
 ...
 */
PutScalingPolicyRequestStepScalingPolicyConfiguration.prototype['AdjustmentType'] = undefined;

/**
 * @member {Array} StepAdjustments
 */
PutScalingPolicyRequestStepScalingPolicyConfiguration.prototype['StepAdjustments'] = undefined;

/**
 * @member {Number} MinAdjustmentMagnitude
 */
PutScalingPolicyRequestStepScalingPolicyConfiguration.prototype['MinAdjustmentMagnitude'] = undefined;

/**
 * @member {Number} Cooldown
 */
PutScalingPolicyRequestStepScalingPolicyConfiguration.prototype['Cooldown'] = undefined;

/**
 * @member {module:model/MetricAggregationType} MetricAggregationType
 */
PutScalingPolicyRequestStepScalingPolicyConfiguration.prototype['MetricAggregationType'] = undefined;
...
export default PutScalingPolicyRequestStepScalingPolicyConfiguration;
