...
/**
 * The DescribeScheduledActionsResponse model module.
 * @module model/DescribeScheduledActionsResponse
 * @version 2016-02-06
 */
class DescribeScheduledActionsResponse {
    /**
     * Constructs a new <code>DescribeScheduledActionsResponse</code>.
     * @alias module:model/DescribeScheduledActionsResponse
     */
    constructor() { 
        
        DescribeScheduledActionsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeScheduledActionsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeScheduledActionsResponse} obj Optional instance to populate.
     * @return {module:model/DescribeScheduledActionsResponse} The populated <code>DescribeScheduledActionsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeScheduledActionsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeScheduledActionsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeScheduledActionsResponse</code>.
     */
 ...
 */
DescribeScheduledActionsResponse.prototype['ScheduledActions'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeScheduledActionsResponse.prototype['NextToken'] = undefined;
...
export default DescribeScheduledActionsResponse;
