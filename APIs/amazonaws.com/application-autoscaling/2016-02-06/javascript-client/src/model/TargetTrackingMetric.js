...
/**
 * The TargetTrackingMetric model module.
 * @module model/TargetTrackingMetric
 * @version 2016-02-06
 */
class TargetTrackingMetric {
    /**
     * Constructs a new <code>TargetTrackingMetric</code>.
     * &lt;p&gt;Represents a specific metric.&lt;/p&gt; &lt;p&gt;Metric is a property of the &lt;a&gt;TargetTrackingMetricStat&lt;/a&gt; object.&lt;/p&gt;
     * @alias module:model/TargetTrackingMetric
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>TargetTrackingMetric</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TargetTrackingMetric} obj Optional instance to populate.
     * @return {module:model/TargetTrackingMetric} The populated <code>TargetTrackingMetric</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TargetTrackingMetric();
    ...
    /**
     * Validates the JSON data with respect to <code>TargetTrackingMetric</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TargetTrackingMetric</code>.
     */
...
export default TargetTrackingMetric;
