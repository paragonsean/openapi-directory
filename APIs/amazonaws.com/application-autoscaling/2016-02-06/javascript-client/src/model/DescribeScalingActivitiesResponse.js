...
/**
 * The DescribeScalingActivitiesResponse model module.
 * @module model/DescribeScalingActivitiesResponse
 * @version 2016-02-06
 */
class DescribeScalingActivitiesResponse {
    /**
     * Constructs a new <code>DescribeScalingActivitiesResponse</code>.
     * @alias module:model/DescribeScalingActivitiesResponse
     */
    constructor() { 
        
        DescribeScalingActivitiesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeScalingActivitiesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeScalingActivitiesResponse} obj Optional instance to populate.
     * @return {module:model/DescribeScalingActivitiesResponse} The populated <code>DescribeScalingActivitiesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeScalingActivitiesResponse();

            if (data.hasOwnProperty('ScalingActivities')) {
                obj['ScalingActivities'] = ApiClient.convertToType(data['ScalingActivities'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeScalingActivitiesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeScalingActivitiesResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `ScalingActivities`
        if (data['ScalingActivities']) { // data not null
          Array.validateJSON(data['ScalingActivities']);
        }
...
/**
 * @member {Array} ScalingActivities
 */
DescribeScalingActivitiesResponse.prototype['ScalingActivities'] = undefined;

/**
 * @member {String} NextToken
 */
DescribeScalingActivitiesResponse.prototype['NextToken'] = undefined;
...
export default DescribeScalingActivitiesResponse;
