...
/**
 * The ScalableTargetAction model module.
 * @module model/ScalableTargetAction
 * @version 2016-02-06
 */
class ScalableTargetAction {
    /**
     * Constructs a new <code>ScalableTargetAction</code>.
     * Represents the minimum and maximum capacity for a scheduled action.
     * @alias module:model/ScalableTargetAction
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ScalableTargetAction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScalableTargetAction} obj Optional instance to populate.
     * @return {module:model/ScalableTargetAction} The populated <code>ScalableTargetAction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScalableTargetAction();
    ...
    /**
     * Validates the JSON data with respect to <code>ScalableTargetAction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScalableTargetAction</code>.
     */
...
export default ScalableTargetAction;
