...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://application-autoscaling.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://application-autoscaling.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2016-02-06/Javascript'
        };
