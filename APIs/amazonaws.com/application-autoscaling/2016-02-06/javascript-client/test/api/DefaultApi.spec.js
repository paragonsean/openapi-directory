...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    ...
    describe('deregisterScalableTarget', function() {
      it('should call deregisterScalableTarget successfully', function(done) {
        //uncomment below and update the code to test deregisterScalableTarget
        //instance.deregisterScalableTarget(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('describeScalableTargets', function() {
      it('should call describeScalableTargets successfully', function(done) {
        //uncomment below and update the code to test describeScalableTargets
        //instance.describeScalableTargets(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('describeScalingActivities', function() {
      it('should call describeScalingActivities successfully', function(done) {
        //uncomment below and update the code to test describeScalingActivities
        //instance.describeScalingActivities(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('describeScheduledActions', function() {
      it('should call describeScheduledActions successfully', function(done) {
        //uncomment below and update the code to test describeScheduledActions
        //instance.describeScheduledActions(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('putScheduledAction', function() {
      it('should call putScheduledAction successfully', function(done) {
        //uncomment below and update the code to test putScheduledAction
        //instance.putScheduledAction(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('registerScalableTarget', function() {
      it('should call registerScalableTarget successfully', function(done) {
        //uncomment below and update the code to test registerScalableTarget
        //instance.registerScalableTarget(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
