...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.DescribeScalableTargetsResponse();
  });
  ...
  describe('DescribeScalableTargetsResponse', function() {
    it('should create an instance of DescribeScalableTargetsResponse', function() {
      // uncomment below and update the code to test DescribeScalableTargetsResponse
      //var instance = new ApplicationAutoScaling.DescribeScalableTargetsResponse();
      //expect(instance).to.be.a(ApplicationAutoScaling.DescribeScalableTargetsResponse);
    });

    it('should have the property scalableTargets (base name: "ScalableTargets")', function() {
      // uncomment below and update the code to test the property scalableTargets
      //var instance = new ApplicationAutoScaling.DescribeScalableTargetsResponse();
