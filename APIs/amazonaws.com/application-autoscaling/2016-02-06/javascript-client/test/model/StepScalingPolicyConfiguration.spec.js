...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.StepScalingPolicyConfiguration();
  });
  ...
  describe('StepScalingPolicyConfiguration', function() {
    it('should create an instance of StepScalingPolicyConfiguration', function() {
      // uncomment below and update the code to test StepScalingPolicyConfiguration
      //var instance = new ApplicationAutoScaling.StepScalingPolicyConfiguration();
      //expect(instance).to.be.a(ApplicationAutoScaling.StepScalingPolicyConfiguration);
    });
