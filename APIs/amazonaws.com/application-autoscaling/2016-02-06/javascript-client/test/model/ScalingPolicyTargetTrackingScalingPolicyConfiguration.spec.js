...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.ScalingPolicyTargetTrackingScalingPolicyConfiguration();
  });
  ...
  describe('ScalingPolicyTargetTrackingScalingPolicyConfiguration', function() {
    it('should create an instance of ScalingPolicyTargetTrackingScalingPolicyConfiguration', function() {
      // uncomment below and update the code to test ScalingPolicyTargetTrackingScalingPolicyConfiguration
      //var instance = new ApplicationAutoScaling.ScalingPolicyTargetTrackingScalingPolicyConfiguration();
      //expect(instance).to.be.a(ApplicationAutoScaling.ScalingPolicyTargetTrackingScalingPolicyConfiguration);
    });
