...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.ListTagsForResourceRequest();
  });
  ...
  describe('ListTagsForResourceRequest', function() {
    it('should create an instance of ListTagsForResourceRequest', function() {
      ...
      //var instance = new ApplicationAutoScaling.ListTagsForResourceRequest();
      //expect(instance).to.be.a(ApplicationAutoScaling.ListTagsForResourceRequest);
    });
