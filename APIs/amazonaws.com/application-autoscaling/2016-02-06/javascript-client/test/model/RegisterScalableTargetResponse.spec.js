...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.RegisterScalableTargetResponse();
  });
  ...
  describe('RegisterScalableTargetResponse', function() {
    it('should create an instance of RegisterScalableTargetResponse', function() {
      // uncomment below and update the code to test RegisterScalableTargetResponse
      //var instance = new ApplicationAutoScaling.RegisterScalableTargetResponse();
      //expect(instance).to.be.a(ApplicationAutoScaling.RegisterScalableTargetResponse);
    });

    it('should have the property scalableTargetARN (base name: "ScalableTargetARN")', function() {
      // uncomment below and update the code to test the property scalableTargetARN
      //var instance = new ApplicationAutoScaling.RegisterScalableTargetResponse();
