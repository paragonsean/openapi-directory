...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.DescribeScalingPoliciesResponse();
  });
  ...
  describe('DescribeScalingPoliciesResponse', function() {
    it('should create an instance of DescribeScalingPoliciesResponse', function() {
      // uncomment below and update the code to test DescribeScalingPoliciesResponse
      //var instance = new ApplicationAutoScaling.DescribeScalingPoliciesResponse();
      //expect(instance).to.be.a(ApplicationAutoScaling.DescribeScalingPoliciesResponse);
    });
