...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification();
  });
  ...
  describe('TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification', function() {
    it('should create an instance of TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification', function() {
      // uncomment below and update the code to test TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification
      //var instance = new ApplicationAutoScaling.TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification();
      //expect(instance).to.be.a(ApplicationAutoScaling.TargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification);
    });
