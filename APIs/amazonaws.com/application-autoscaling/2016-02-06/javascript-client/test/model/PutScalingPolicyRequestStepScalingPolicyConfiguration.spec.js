...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.PutScalingPolicyRequestStepScalingPolicyConfiguration();
  });
  ...
  describe('PutScalingPolicyRequestStepScalingPolicyConfiguration', function() {
    it('should create an instance of PutScalingPolicyRequestStepScalingPolicyConfiguration', function() {
      // uncomment below and update the code to test PutScalingPolicyRequestStepScalingPolicyConfiguration
      //var instance = new ApplicationAutoScaling.PutScalingPolicyRequestStepScalingPolicyConfiguration();
      //expect(instance).to.be.a(ApplicationAutoScaling.PutScalingPolicyRequestStepScalingPolicyConfiguration);
    });
