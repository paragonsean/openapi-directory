...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.PredefinedMetricSpecification();
  });
  ...
  describe('PredefinedMetricSpecification', function() {
    it('should create an instance of PredefinedMetricSpecification', function() {
      ...
      //var instance = new ApplicationAutoScaling.PredefinedMetricSpecification();
      //expect(instance).to.be.a(ApplicationAutoScaling.PredefinedMetricSpecification);
    });
