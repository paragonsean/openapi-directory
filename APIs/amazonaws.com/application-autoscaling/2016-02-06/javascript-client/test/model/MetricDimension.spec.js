...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.MetricDimension();
  });
  ...
  describe('MetricDimension', function() {
    it('should create an instance of MetricDimension', function() {
      // uncomment below and update the code to test MetricDimension
      //var instance = new ApplicationAutoScaling.MetricDimension();
      //expect(instance).to.be.a(ApplicationAutoScaling.MetricDimension);
    });
