...
(function(root, factory) {
  ...
  describe('ScalingActivityStatusCode', function() {
    it('should create an instance of ScalingActivityStatusCode', function() {
      // uncomment below and update the code to test ScalingActivityStatusCode
      //var instance = new ApplicationAutoScaling.ScalingActivityStatusCode();
      //expect(instance).to.be.a(ApplicationAutoScaling.ScalingActivityStatusCode);
    });
