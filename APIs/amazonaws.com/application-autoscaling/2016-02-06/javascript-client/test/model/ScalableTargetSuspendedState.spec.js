...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.ScalableTargetSuspendedState();
  });
  ...
  describe('ScalableTargetSuspendedState', function() {
    it('should create an instance of ScalableTargetSuspendedState', function() {
      // uncomment below and update the code to test ScalableTargetSuspendedState
      //var instance = new ApplicationAutoScaling.ScalableTargetSuspendedState();
      //expect(instance).to.be.a(ApplicationAutoScaling.ScalableTargetSuspendedState);
    });
