...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.ScalableTargetAction();
  });
  ...
  describe('ScalableTargetAction', function() {
    it('should create an instance of ScalableTargetAction', function() {
      // uncomment below and update the code to test ScalableTargetAction
      //var instance = new ApplicationAutoScaling.ScalableTargetAction();
      //expect(instance).to.be.a(ApplicationAutoScaling.ScalableTargetAction);
    });
