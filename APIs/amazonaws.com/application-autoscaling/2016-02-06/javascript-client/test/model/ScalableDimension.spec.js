...
(function(root, factory) {
  ...
  describe('ScalableDimension', function() {
    it('should create an instance of ScalableDimension', function() {
      // uncomment below and update the code to test ScalableDimension
      //var instance = new ApplicationAutoScaling.ScalableDimension();
      //expect(instance).to.be.a(ApplicationAutoScaling.ScalableDimension);
    });
