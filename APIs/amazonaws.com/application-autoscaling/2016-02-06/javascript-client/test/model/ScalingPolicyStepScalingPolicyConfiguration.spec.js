...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.ScalingPolicyStepScalingPolicyConfiguration();
  });
  ...
  describe('ScalingPolicyStepScalingPolicyConfiguration', function() {
    it('should create an instance of ScalingPolicyStepScalingPolicyConfiguration', function() {
      // uncomment below and update the code to test ScalingPolicyStepScalingPolicyConfiguration
      //var instance = new ApplicationAutoScaling.ScalingPolicyStepScalingPolicyConfiguration();
      //expect(instance).to.be.a(ApplicationAutoScaling.ScalingPolicyStepScalingPolicyConfiguration);
    });
