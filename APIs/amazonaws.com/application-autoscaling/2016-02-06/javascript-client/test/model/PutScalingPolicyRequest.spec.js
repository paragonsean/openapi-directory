...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.PutScalingPolicyRequest();
  });
  ...
  describe('PutScalingPolicyRequest', function() {
    it('should create an instance of PutScalingPolicyRequest', function() {
      // uncomment below and update the code to test PutScalingPolicyRequest
      //var instance = new ApplicationAutoScaling.PutScalingPolicyRequest();
      //expect(instance).to.be.a(ApplicationAutoScaling.PutScalingPolicyRequest);
    });
    ...
    it('should have the property stepScalingPolicyConfiguration (base name: "StepScalingPolicyConfiguration")', function() {
      // uncomment below and update the code to test the property stepScalingPolicyConfiguration
      //var instance = new ApplicationAutoScaling.PutScalingPolicyRequest();
      //expect(instance).to.be();
    });

    it('should have the property targetTrackingScalingPolicyConfiguration (base name: "TargetTrackingScalingPolicyConfiguration")', function() {
      // uncomment below and update the code to test the property targetTrackingScalingPolicyConfiguration
      //var instance = new ApplicationAutoScaling.PutScalingPolicyRequest();
      //expect(instance).to.be();
    });
