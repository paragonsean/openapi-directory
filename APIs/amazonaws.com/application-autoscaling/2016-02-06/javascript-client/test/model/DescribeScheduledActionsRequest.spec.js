...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.DescribeScheduledActionsRequest();
  });
  ...
  describe('DescribeScheduledActionsRequest', function() {
    it('should create an instance of DescribeScheduledActionsRequest', function() {
      // uncomment below and update the code to test DescribeScheduledActionsRequest
      //var instance = new ApplicationAutoScaling.DescribeScheduledActionsRequest();
      //expect(instance).to.be.a(ApplicationAutoScaling.DescribeScheduledActionsRequest);
    });
