...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.TargetTrackingMetric();
  });
  ...
  describe('TargetTrackingMetric', function() {
    it('should create an instance of TargetTrackingMetric', function() {
      // uncomment below and update the code to test TargetTrackingMetric
      //var instance = new ApplicationAutoScaling.TargetTrackingMetric();
      //expect(instance).to.be.a(ApplicationAutoScaling.TargetTrackingMetric);
    });
