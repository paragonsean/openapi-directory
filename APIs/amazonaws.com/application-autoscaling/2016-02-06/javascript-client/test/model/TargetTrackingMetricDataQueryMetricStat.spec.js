...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.TargetTrackingMetricDataQueryMetricStat();
  });
  ...
  describe('TargetTrackingMetricDataQueryMetricStat', function() {
    it('should create an instance of TargetTrackingMetricDataQueryMetricStat', function() {
      // uncomment below and update the code to test TargetTrackingMetricDataQueryMetricStat
      //var instance = new ApplicationAutoScaling.TargetTrackingMetricDataQueryMetricStat();
      //expect(instance).to.be.a(ApplicationAutoScaling.TargetTrackingMetricDataQueryMetricStat);
    });
