...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.TargetTrackingMetricStatMetric();
  });
  ...
  describe('TargetTrackingMetricStatMetric', function() {
    it('should create an instance of TargetTrackingMetricStatMetric', function() {
      ...
      //var instance = new ApplicationAutoScaling.TargetTrackingMetricStatMetric();
      //expect(instance).to.be.a(ApplicationAutoScaling.TargetTrackingMetricStatMetric);
    });
