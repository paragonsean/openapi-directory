...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.ListTagsForResourceResponse();
  });
  ...
  describe('ListTagsForResourceResponse', function() {
    it('should create an instance of ListTagsForResourceResponse', function() {
      ...
      //var instance = new ApplicationAutoScaling.ListTagsForResourceResponse();
      //expect(instance).to.be.a(ApplicationAutoScaling.ListTagsForResourceResponse);
    });
