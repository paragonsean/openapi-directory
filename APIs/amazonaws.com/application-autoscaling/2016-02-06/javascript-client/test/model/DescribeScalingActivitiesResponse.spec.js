...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.DescribeScalingActivitiesResponse();
  });
  ...
  describe('DescribeScalingActivitiesResponse', function() {
    it('should create an instance of DescribeScalingActivitiesResponse', function() {
      // uncomment below and update the code to test DescribeScalingActivitiesResponse
      //var instance = new ApplicationAutoScaling.DescribeScalingActivitiesResponse();
      //expect(instance).to.be.a(ApplicationAutoScaling.DescribeScalingActivitiesResponse);
    });

    it('should have the property scalingActivities (base name: "ScalingActivities")', function() {
      // uncomment below and update the code to test the property scalingActivities
      //var instance = new ApplicationAutoScaling.DescribeScalingActivitiesResponse();
