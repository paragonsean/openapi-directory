...
(function(root, factory) {
  ...
  describe('MetricStatistic', function() {
    it('should create an instance of MetricStatistic', function() {
      // uncomment below and update the code to test MetricStatistic
      //var instance = new ApplicationAutoScaling.MetricStatistic();
      //expect(instance).to.be.a(ApplicationAutoScaling.MetricStatistic);
    });
