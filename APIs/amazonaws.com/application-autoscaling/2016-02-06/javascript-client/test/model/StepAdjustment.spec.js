...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.StepAdjustment();
  });
  ...
  describe('StepAdjustment', function() {
    it('should create an instance of StepAdjustment', function() {
      ...
      //var instance = new ApplicationAutoScaling.StepAdjustment();
      //expect(instance).to.be.a(ApplicationAutoScaling.StepAdjustment);
    });
