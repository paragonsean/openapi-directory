...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.SuspendedState();
  });
  ...
  describe('SuspendedState', function() {
    it('should create an instance of SuspendedState', function() {
      // uncomment below and update the code to test SuspendedState
      //var instance = new ApplicationAutoScaling.SuspendedState();
      //expect(instance).to.be.a(ApplicationAutoScaling.SuspendedState);
    });
