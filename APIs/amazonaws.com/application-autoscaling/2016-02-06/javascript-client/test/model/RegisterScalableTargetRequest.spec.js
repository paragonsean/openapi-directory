...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.RegisterScalableTargetRequest();
  });
  ...
  describe('RegisterScalableTargetRequest', function() {
    it('should create an instance of RegisterScalableTargetRequest', function() {
      // uncomment below and update the code to test RegisterScalableTargetRequest
      //var instance = new ApplicationAutoScaling.RegisterScalableTargetRequest();
      //expect(instance).to.be.a(ApplicationAutoScaling.RegisterScalableTargetRequest);
    });
    ...
    it('should have the property suspendedState (base name: "SuspendedState")', function() {
      // uncomment below and update the code to test the property suspendedState
      //var instance = new ApplicationAutoScaling.RegisterScalableTargetRequest();
      //expect(instance).to.be();
    });
