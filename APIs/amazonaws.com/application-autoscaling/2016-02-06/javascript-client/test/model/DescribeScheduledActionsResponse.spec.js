...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.DescribeScheduledActionsResponse();
  });
  ...
  describe('DescribeScheduledActionsResponse', function() {
    it('should create an instance of DescribeScheduledActionsResponse', function() {
      // uncomment below and update the code to test DescribeScheduledActionsResponse
      //var instance = new ApplicationAutoScaling.DescribeScheduledActionsResponse();
      //expect(instance).to.be.a(ApplicationAutoScaling.DescribeScheduledActionsResponse);
    });
