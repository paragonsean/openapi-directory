...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.TargetTrackingMetricDataQuery();
  });
  ...
  describe('TargetTrackingMetricDataQuery', function() {
    it('should create an instance of TargetTrackingMetricDataQuery', function() {
      // uncomment below and update the code to test TargetTrackingMetricDataQuery
      //var instance = new ApplicationAutoScaling.TargetTrackingMetricDataQuery();
      //expect(instance).to.be.a(ApplicationAutoScaling.TargetTrackingMetricDataQuery);
    });
