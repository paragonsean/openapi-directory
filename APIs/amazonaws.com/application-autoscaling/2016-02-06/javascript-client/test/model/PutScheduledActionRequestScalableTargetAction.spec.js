...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.PutScheduledActionRequestScalableTargetAction();
  });
  ...
  describe('PutScheduledActionRequestScalableTargetAction', function() {
    it('should create an instance of PutScheduledActionRequestScalableTargetAction', function() {
      // uncomment below and update the code to test PutScheduledActionRequestScalableTargetAction
      //var instance = new ApplicationAutoScaling.PutScheduledActionRequestScalableTargetAction();
      //expect(instance).to.be.a(ApplicationAutoScaling.PutScheduledActionRequestScalableTargetAction);
    });
