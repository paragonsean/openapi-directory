...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.ScheduledAction();
  });
  ...
  describe('ScheduledAction', function() {
    it('should create an instance of ScheduledAction', function() {
      ...
      //var instance = new ApplicationAutoScaling.ScheduledAction();
      //expect(instance).to.be.a(ApplicationAutoScaling.ScheduledAction);
    });
    ...
    it('should have the property scheduledActionARN (base name: "ScheduledActionARN")', function() {
      // uncomment below and update the code to test the property scheduledActionARN
      //var instance = new ApplicationAutoScaling.ScheduledAction();
      //expect(instance).to.be();
    });
