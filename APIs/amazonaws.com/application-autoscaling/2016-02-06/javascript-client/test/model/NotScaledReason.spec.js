...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.NotScaledReason();
  });
  ...
  describe('NotScaledReason', function() {
    it('should create an instance of NotScaledReason', function() {
      // uncomment below and update the code to test NotScaledReason
      //var instance = new ApplicationAutoScaling.NotScaledReason();
      //expect(instance).to.be.a(ApplicationAutoScaling.NotScaledReason);
    });
    ...
    it('should have the property currentCapacity (base name: "CurrentCapacity")', function() {
