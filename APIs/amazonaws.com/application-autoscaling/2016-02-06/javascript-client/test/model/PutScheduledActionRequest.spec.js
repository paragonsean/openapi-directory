...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.PutScheduledActionRequest();
  });
  ...
  describe('PutScheduledActionRequest', function() {
    it('should create an instance of PutScheduledActionRequest', function() {
      // uncomment below and update the code to test PutScheduledActionRequest
      //var instance = new ApplicationAutoScaling.PutScheduledActionRequest();
      //expect(instance).to.be.a(ApplicationAutoScaling.PutScheduledActionRequest);
    });
    ...
    it('should have the property scalableTargetAction (base name: "ScalableTargetAction")', function() {
      // uncomment below and update the code to test the property scalableTargetAction
      //var instance = new ApplicationAutoScaling.PutScheduledActionRequest();
      //expect(instance).to.be();
    });
