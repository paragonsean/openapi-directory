...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.ScalingActivity();
  });
  ...
  describe('ScalingActivity', function() {
    it('should create an instance of ScalingActivity', function() {
      // uncomment below and update the code to test ScalingActivity
      //var instance = new ApplicationAutoScaling.ScalingActivity();
      //expect(instance).to.be.a(ApplicationAutoScaling.ScalingActivity);
    });
    ...
    it('should have the property notScaledReasons (base name: "NotScaledReasons")', function() {
      // uncomment below and update the code to test the property notScaledReasons
      //var instance = new ApplicationAutoScaling.ScalingActivity();
      //expect(instance).to.be();
    });
