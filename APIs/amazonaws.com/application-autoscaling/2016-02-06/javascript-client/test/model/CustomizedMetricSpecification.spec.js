...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.CustomizedMetricSpecification();
  });
  ...
  describe('CustomizedMetricSpecification', function() {
    it('should create an instance of CustomizedMetricSpecification', function() {
      ...
      //var instance = new ApplicationAutoScaling.CustomizedMetricSpecification();
      //expect(instance).to.be.a(ApplicationAutoScaling.CustomizedMetricSpecification);
    });
