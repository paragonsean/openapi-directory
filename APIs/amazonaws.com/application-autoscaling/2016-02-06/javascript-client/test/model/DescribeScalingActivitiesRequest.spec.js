...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.DescribeScalingActivitiesRequest();
  });
  ...
  describe('DescribeScalingActivitiesRequest', function() {
    it('should create an instance of DescribeScalingActivitiesRequest', function() {
      // uncomment below and update the code to test DescribeScalingActivitiesRequest
      //var instance = new ApplicationAutoScaling.DescribeScalingActivitiesRequest();
      //expect(instance).to.be.a(ApplicationAutoScaling.DescribeScalingActivitiesRequest);
    });
    ...
    it('should have the property includeNotScaledActivities (base name: "IncludeNotScaledActivities")', function() {
      // uncomment below and update the code to test the property includeNotScaledActivities
      //var instance = new ApplicationAutoScaling.DescribeScalingActivitiesRequest();
      //expect(instance).to.be();
    });
