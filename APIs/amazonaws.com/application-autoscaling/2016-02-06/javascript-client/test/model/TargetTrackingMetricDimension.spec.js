...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.TargetTrackingMetricDimension();
  });
  ...
  describe('TargetTrackingMetricDimension', function() {
    it('should create an instance of TargetTrackingMetricDimension', function() {
      // uncomment below and update the code to test TargetTrackingMetricDimension
      //var instance = new ApplicationAutoScaling.TargetTrackingMetricDimension();
      //expect(instance).to.be.a(ApplicationAutoScaling.TargetTrackingMetricDimension);
    });
