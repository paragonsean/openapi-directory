...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.DescribeScalableTargetsRequest();
  });
  ...
  describe('DescribeScalableTargetsRequest', function() {
    it('should create an instance of DescribeScalableTargetsRequest', function() {
      // uncomment below and update the code to test DescribeScalableTargetsRequest
      //var instance = new ApplicationAutoScaling.DescribeScalableTargetsRequest();
      //expect(instance).to.be.a(ApplicationAutoScaling.DescribeScalableTargetsRequest);
    });
