...
(function(root, factory) {
  ...
  describe('ServiceNamespace', function() {
    it('should create an instance of ServiceNamespace', function() {
      // uncomment below and update the code to test ServiceNamespace
      //var instance = new ApplicationAutoScaling.ServiceNamespace();
      //expect(instance).to.be.a(ApplicationAutoScaling.ServiceNamespace);
    });
