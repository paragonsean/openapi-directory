...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.DeregisterScalableTargetRequest();
  });
  ...
  describe('DeregisterScalableTargetRequest', function() {
    it('should create an instance of DeregisterScalableTargetRequest', function() {
      // uncomment below and update the code to test DeregisterScalableTargetRequest
      //var instance = new ApplicationAutoScaling.DeregisterScalableTargetRequest();
      //expect(instance).to.be.a(ApplicationAutoScaling.DeregisterScalableTargetRequest);
    });
