...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.PutScalingPolicyResponse();
  });
  ...
  describe('PutScalingPolicyResponse', function() {
    it('should create an instance of PutScalingPolicyResponse', function() {
      // uncomment below and update the code to test PutScalingPolicyResponse
      //var instance = new ApplicationAutoScaling.PutScalingPolicyResponse();
      //expect(instance).to.be.a(ApplicationAutoScaling.PutScalingPolicyResponse);
    });
