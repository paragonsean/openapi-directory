...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.ScalableTarget();
  });
  ...
  describe('ScalableTarget', function() {
    it('should create an instance of ScalableTarget', function() {
      // uncomment below and update the code to test ScalableTarget
      //var instance = new ApplicationAutoScaling.ScalableTarget();
      //expect(instance).to.be.a(ApplicationAutoScaling.ScalableTarget);
    });
