...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.TargetTrackingScalingPolicyConfigurationPredefinedMetricSpecification();
  });
  ...
  describe('TargetTrackingScalingPolicyConfigurationPredefinedMetricSpecification', function() {
    it('should create an instance of TargetTrackingScalingPolicyConfigurationPredefinedMetricSpecification', function() {
      // uncomment below and update the code to test TargetTrackingScalingPolicyConfigurationPredefinedMetricSpecification
      //var instance = new ApplicationAutoScaling.TargetTrackingScalingPolicyConfigurationPredefinedMetricSpecification();
      //expect(instance).to.be.a(ApplicationAutoScaling.TargetTrackingScalingPolicyConfigurationPredefinedMetricSpecification);
    });
