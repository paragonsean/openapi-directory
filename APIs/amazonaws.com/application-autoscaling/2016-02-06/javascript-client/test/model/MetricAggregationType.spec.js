...
(function(root, factory) {
  ...
  describe('MetricAggregationType', function() {
    it('should create an instance of MetricAggregationType', function() {
      // uncomment below and update the code to test MetricAggregationType
      //var instance = new ApplicationAutoScaling.MetricAggregationType();
      //expect(instance).to.be.a(ApplicationAutoScaling.MetricAggregationType);
    });
