...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.DescribeScalingPoliciesRequest();
  });
  ...
  describe('DescribeScalingPoliciesRequest', function() {
    it('should create an instance of DescribeScalingPoliciesRequest', function() {
      // uncomment below and update the code to test DescribeScalingPoliciesRequest
      //var instance = new ApplicationAutoScaling.DescribeScalingPoliciesRequest();
      //expect(instance).to.be.a(ApplicationAutoScaling.DescribeScalingPoliciesRequest);
    });
