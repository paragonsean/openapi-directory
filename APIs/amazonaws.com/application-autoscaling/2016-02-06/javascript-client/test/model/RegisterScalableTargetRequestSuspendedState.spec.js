...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.RegisterScalableTargetRequestSuspendedState();
  });
  ...
  describe('RegisterScalableTargetRequestSuspendedState', function() {
    it('should create an instance of RegisterScalableTargetRequestSuspendedState', function() {
      // uncomment below and update the code to test RegisterScalableTargetRequestSuspendedState
      //var instance = new ApplicationAutoScaling.RegisterScalableTargetRequestSuspendedState();
      //expect(instance).to.be.a(ApplicationAutoScaling.RegisterScalableTargetRequestSuspendedState);
    });

    it('should have the property dynamicScalingInSuspended (base name: "DynamicScalingInSuspended")', function() {
      // uncomment below and update the code to test the property dynamicScalingInSuspended
      //var instance = new ApplicationAutoScaling.RegisterScalableTargetRequestSuspendedState();
      //expect(instance).to.be();
    });

    it('should have the property dynamicScalingOutSuspended (base name: "DynamicScalingOutSuspended")', function() {
      // uncomment below and update the code to test the property dynamicScalingOutSuspended
      //var instance = new ApplicationAutoScaling.RegisterScalableTargetRequestSuspendedState();
      //expect(instance).to.be();
    });

    it('should have the property scheduledScalingSuspended (base name: "ScheduledScalingSuspended")', function() {
      // uncomment below and update the code to test the property scheduledScalingSuspended
      //var instance = new ApplicationAutoScaling.RegisterScalableTargetRequestSuspendedState();
      //expect(instance).to.be();
    });
