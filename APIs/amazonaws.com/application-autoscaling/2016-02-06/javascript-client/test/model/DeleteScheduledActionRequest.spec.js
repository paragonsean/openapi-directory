...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationAutoScaling.DeleteScheduledActionRequest();
  });
  ...
  describe('DeleteScheduledActionRequest', function() {
    it('should create an instance of DeleteScheduledActionRequest', function() {
      // uncomment below and update the code to test DeleteScheduledActionRequest
      //var instance = new ApplicationAutoScaling.DeleteScheduledActionRequest();
      //expect(instance).to.be.a(ApplicationAutoScaling.DeleteScheduledActionRequest);
    });
