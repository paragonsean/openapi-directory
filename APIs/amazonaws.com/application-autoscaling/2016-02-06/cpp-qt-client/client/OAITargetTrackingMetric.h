...
class OAITargetTrackingMetric : public OAIObject {
public:
    OAITargetTrackingMetric();
    OAITargetTrackingMetric(QString json);
    ~OAITargetTrackingMetric() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITargetTrackingMetric)

#endif // OAITargetTrackingMetric_H
