...
/*
 * OAIServiceNamespace.h
 *
 * 
 */

#ifndef OAIServiceNamespace_H
#define OAIServiceNamespace_H
...
class OAIServiceNamespace : public OAIEnum {
public:
    OAIServiceNamespace();
    OAIServiceNamespace(QString json);
    ~OAIServiceNamespace() override;
    ...
    enum class eOAIServiceNamespace {
    ...
    OAIServiceNamespace::eOAIServiceNamespace getValue() const;
    void setValue(const OAIServiceNamespace::eOAIServiceNamespace& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIServiceNamespace)

#endif // OAIServiceNamespace_H
