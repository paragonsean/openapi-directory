...
/*
 * OAIPutScheduledActionRequest.h
 *
 * 
 */

#ifndef OAIPutScheduledActionRequest_H
#define OAIPutScheduledActionRequest_H
...
class OAIPutScheduledActionRequest : public OAIObject {
public:
    OAIPutScheduledActionRequest();
    OAIPutScheduledActionRequest(QString json);
    ~OAIPutScheduledActionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutScheduledActionRequest)

#endif // OAIPutScheduledActionRequest_H
