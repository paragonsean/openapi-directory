...
/*
 * OAIDescribeScheduledActionsRequest.h
 *
 * 
 */

#ifndef OAIDescribeScheduledActionsRequest_H
#define OAIDescribeScheduledActionsRequest_H
...
class OAIDescribeScheduledActionsRequest : public OAIObject {
public:
    OAIDescribeScheduledActionsRequest();
    OAIDescribeScheduledActionsRequest(QString json);
    ~OAIDescribeScheduledActionsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeScheduledActionsRequest)

#endif // OAIDescribeScheduledActionsRequest_H
