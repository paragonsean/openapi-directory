...
/*
 * OAIDescribeScalingActivitiesResponse.h
 *
 * 
 */

#ifndef OAIDescribeScalingActivitiesResponse_H
#define OAIDescribeScalingActivitiesResponse_H
...
class OAIDescribeScalingActivitiesResponse : public OAIObject {
public:
    OAIDescribeScalingActivitiesResponse();
    OAIDescribeScalingActivitiesResponse(QString json);
    ~OAIDescribeScalingActivitiesResponse() override;
    ...
    QList getScalingActivities() const;
    void setScalingActivities(const QList &scaling_activities);
    bool is_scaling_activities_Set() const;
    bool is_scaling_activities_Valid() const;
...
private:
    ...
    QList m_scaling_activities;
    bool m_scaling_activities_isSet;
    bool m_scaling_activities_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeScalingActivitiesResponse)

#endif // OAIDescribeScalingActivitiesResponse_H
