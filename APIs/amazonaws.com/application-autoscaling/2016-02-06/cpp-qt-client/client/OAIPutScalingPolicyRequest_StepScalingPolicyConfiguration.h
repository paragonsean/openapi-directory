...
/*
 * OAIPutScalingPolicyRequest_StepScalingPolicyConfiguration.h
 *
 * 
 */

#ifndef OAIPutScalingPolicyRequest_StepScalingPolicyConfiguration_H
#define OAIPutScalingPolicyRequest_StepScalingPolicyConfiguration_H
...
class OAIPutScalingPolicyRequest_StepScalingPolicyConfiguration : public OAIObject {
public:
    OAIPutScalingPolicyRequest_StepScalingPolicyConfiguration();
    OAIPutScalingPolicyRequest_StepScalingPolicyConfiguration(QString json);
    ~OAIPutScalingPolicyRequest_StepScalingPolicyConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutScalingPolicyRequest_StepScalingPolicyConfiguration)

#endif // OAIPutScalingPolicyRequest_StepScalingPolicyConfiguration_H
