...
/*
 * OAIRegisterScalableTargetResponse.h
 *
 * 
 */

#ifndef OAIRegisterScalableTargetResponse_H
#define OAIRegisterScalableTargetResponse_H
...
class OAIRegisterScalableTargetResponse : public OAIObject {
public:
    OAIRegisterScalableTargetResponse();
    OAIRegisterScalableTargetResponse(QString json);
    ~OAIRegisterScalableTargetResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegisterScalableTargetResponse)

#endif // OAIRegisterScalableTargetResponse_H
