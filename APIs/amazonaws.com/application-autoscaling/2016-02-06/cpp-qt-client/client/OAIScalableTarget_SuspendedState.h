...
/*
 * OAIScalableTarget_SuspendedState.h
 *
 * 
 */

#ifndef OAIScalableTarget_SuspendedState_H
#define OAIScalableTarget_SuspendedState_H
...
class OAIScalableTarget_SuspendedState : public OAIObject {
public:
    OAIScalableTarget_SuspendedState();
    OAIScalableTarget_SuspendedState(QString json);
    ~OAIScalableTarget_SuspendedState() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScalableTarget_SuspendedState)

#endif // OAIScalableTarget_SuspendedState_H
