...
OAIDescribeScalableTargetsResponse::OAIDescribeScalableTargetsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeScalableTargetsResponse::OAIDescribeScalableTargetsResponse() {
    this->initializeModel();
}

OAIDescribeScalableTargetsResponse::~OAIDescribeScalableTargetsResponse() {}

void OAIDescribeScalableTargetsResponse::initializeModel() {

    m_scalable_targets_isSet = false;
    m_scalable_targets_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIDescribeScalableTargetsResponse::fromJson(QString jsonString) {
...
void OAIDescribeScalableTargetsResponse::fromJsonObject(QJsonObject json) {

    m_scalable_targets_isValid = ::OpenAPI::fromJsonValue(m_scalable_targets, json[QString("ScalableTargets")]);
    m_scalable_targets_isSet = !json[QString("ScalableTargets")].isNull() && m_scalable_targets_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("NextToken")]);
    m_next_token_isSet = !json[QString("NextToken")].isNull() && m_next_token_isValid;
}

QString OAIDescribeScalableTargetsResponse::asJson() const {
...
QJsonObject OAIDescribeScalableTargetsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_scalable_targets.isSet()) {
        obj.insert(QString("ScalableTargets"), ::OpenAPI::toJsonValue(m_scalable_targets));
    }
...
QList OAIDescribeScalableTargetsResponse::getScalableTargets() const {
    return m_scalable_targets;
}
void OAIDescribeScalableTargetsResponse::setScalableTargets(const QList &scalable_targets) {
    m_scalable_targets = scalable_targets;
    m_scalable_targets_isSet = true;
}

bool OAIDescribeScalableTargetsResponse::is_scalable_targets_Set() const{
    return m_scalable_targets_isSet;
}

bool OAIDescribeScalableTargetsResponse::is_scalable_targets_Valid() const{
    return m_scalable_targets_isValid;
}

QString OAIDescribeScalableTargetsResponse::getNextToken() const {
    return m_next_token;
}
void OAIDescribeScalableTargetsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeScalableTargetsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeScalableTargetsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeScalableTargetsResponse::isSet() const {
...
bool OAIDescribeScalableTargetsResponse::isValid() const {
