...
class OAIAdjustmentType : public OAIEnum {
public:
    OAIAdjustmentType();
    ...
    enum class eOAIAdjustmentType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        CHANGEINCAPACITY, 
        PERCENTCHANGEINCAPACITY, 
        EXACTCAPACITY
    };
    OAIAdjustmentType::eOAIAdjustmentType getValue() const;
    void setValue(const OAIAdjustmentType::eOAIAdjustmentType& value);
