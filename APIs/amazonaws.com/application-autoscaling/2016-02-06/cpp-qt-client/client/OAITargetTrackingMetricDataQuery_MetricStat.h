...
/*
 * OAITargetTrackingMetricDataQuery_MetricStat.h
 *
 * 
 */

#ifndef OAITargetTrackingMetricDataQuery_MetricStat_H
#define OAITargetTrackingMetricDataQuery_MetricStat_H
...
class OAITargetTrackingMetricDataQuery_MetricStat : public OAIObject {
public:
    OAITargetTrackingMetricDataQuery_MetricStat();
    OAITargetTrackingMetricDataQuery_MetricStat(QString json);
    ~OAITargetTrackingMetricDataQuery_MetricStat() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITargetTrackingMetricDataQuery_MetricStat)

#endif // OAITargetTrackingMetricDataQuery_MetricStat_H
