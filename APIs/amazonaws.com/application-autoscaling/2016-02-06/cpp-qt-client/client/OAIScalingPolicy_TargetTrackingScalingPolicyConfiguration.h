...
/*
 * OAIScalingPolicy_TargetTrackingScalingPolicyConfiguration.h
 *
 * 
 */

#ifndef OAIScalingPolicy_TargetTrackingScalingPolicyConfiguration_H
#define OAIScalingPolicy_TargetTrackingScalingPolicyConfiguration_H
...
class OAIScalingPolicy_TargetTrackingScalingPolicyConfiguration : public OAIObject {
public:
    OAIScalingPolicy_TargetTrackingScalingPolicyConfiguration();
    OAIScalingPolicy_TargetTrackingScalingPolicyConfiguration(QString json);
    ~OAIScalingPolicy_TargetTrackingScalingPolicyConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScalingPolicy_TargetTrackingScalingPolicyConfiguration)

#endif // OAIScalingPolicy_TargetTrackingScalingPolicyConfiguration_H
