...
/*
 * OAIDescribeScalingPoliciesResponse.h
 *
 * 
 */

#ifndef OAIDescribeScalingPoliciesResponse_H
#define OAIDescribeScalingPoliciesResponse_H
...
class OAIDescribeScalingPoliciesResponse : public OAIObject {
public:
    OAIDescribeScalingPoliciesResponse();
    OAIDescribeScalingPoliciesResponse(QString json);
    ~OAIDescribeScalingPoliciesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeScalingPoliciesResponse)

#endif // OAIDescribeScalingPoliciesResponse_H
