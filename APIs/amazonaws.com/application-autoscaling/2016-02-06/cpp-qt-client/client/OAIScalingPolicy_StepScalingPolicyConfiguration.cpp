...
OAIScalingPolicy_StepScalingPolicyConfiguration::OAIScalingPolicy_StepScalingPolicyConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIScalingPolicy_StepScalingPolicyConfiguration::OAIScalingPolicy_StepScalingPolicyConfiguration() {
    this->initializeModel();
}

OAIScalingPolicy_StepScalingPolicyConfiguration::~OAIScalingPolicy_StepScalingPolicyConfiguration() {}

void OAIScalingPolicy_StepScalingPolicyConfiguration::initializeModel() {
...
void OAIScalingPolicy_StepScalingPolicyConfiguration::fromJson(QString jsonString) {
...
void OAIScalingPolicy_StepScalingPolicyConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIScalingPolicy_StepScalingPolicyConfiguration::asJson() const {
...
QJsonObject OAIScalingPolicy_StepScalingPolicyConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAIAdjustmentType OAIScalingPolicy_StepScalingPolicyConfiguration::getAdjustmentType() const {
    return m_adjustment_type;
}
void OAIScalingPolicy_StepScalingPolicyConfiguration::setAdjustmentType(const OAIAdjustmentType &adjustment_type) {
    m_adjustment_type = adjustment_type;
    m_adjustment_type_isSet = true;
}

bool OAIScalingPolicy_StepScalingPolicyConfiguration::is_adjustment_type_Set() const{
    return m_adjustment_type_isSet;
}

bool OAIScalingPolicy_StepScalingPolicyConfiguration::is_adjustment_type_Valid() const{
    return m_adjustment_type_isValid;
}

QList OAIScalingPolicy_StepScalingPolicyConfiguration::getStepAdjustments() const {
    return m_step_adjustments;
}
void OAIScalingPolicy_StepScalingPolicyConfiguration::setStepAdjustments(const QList &step_adjustments) {
    m_step_adjustments = step_adjustments;
    m_step_adjustments_isSet = true;
}

bool OAIScalingPolicy_StepScalingPolicyConfiguration::is_step_adjustments_Set() const{
    return m_step_adjustments_isSet;
}

bool OAIScalingPolicy_StepScalingPolicyConfiguration::is_step_adjustments_Valid() const{
    return m_step_adjustments_isValid;
}

qint32 OAIScalingPolicy_StepScalingPolicyConfiguration::getMinAdjustmentMagnitude() const {
    return m_min_adjustment_magnitude;
}
void OAIScalingPolicy_StepScalingPolicyConfiguration::setMinAdjustmentMagnitude(const qint32 &min_adjustment_magnitude) {
    m_min_adjustment_magnitude = min_adjustment_magnitude;
    m_min_adjustment_magnitude_isSet = true;
}

bool OAIScalingPolicy_StepScalingPolicyConfiguration::is_min_adjustment_magnitude_Set() const{
    return m_min_adjustment_magnitude_isSet;
}

bool OAIScalingPolicy_StepScalingPolicyConfiguration::is_min_adjustment_magnitude_Valid() const{
    return m_min_adjustment_magnitude_isValid;
}

qint32 OAIScalingPolicy_StepScalingPolicyConfiguration::getCooldown() const {
    return m_cooldown;
}
void OAIScalingPolicy_StepScalingPolicyConfiguration::setCooldown(const qint32 &cooldown) {
    m_cooldown = cooldown;
    m_cooldown_isSet = true;
}

bool OAIScalingPolicy_StepScalingPolicyConfiguration::is_cooldown_Set() const{
    return m_cooldown_isSet;
}

bool OAIScalingPolicy_StepScalingPolicyConfiguration::is_cooldown_Valid() const{
    return m_cooldown_isValid;
}

OAIMetricAggregationType OAIScalingPolicy_StepScalingPolicyConfiguration::getMetricAggregationType() const {
    return m_metric_aggregation_type;
}
void OAIScalingPolicy_StepScalingPolicyConfiguration::setMetricAggregationType(const OAIMetricAggregationType &metric_aggregation_type) {
    m_metric_aggregation_type = metric_aggregation_type;
    m_metric_aggregation_type_isSet = true;
}

bool OAIScalingPolicy_StepScalingPolicyConfiguration::is_metric_aggregation_type_Set() const{
    return m_metric_aggregation_type_isSet;
}

bool OAIScalingPolicy_StepScalingPolicyConfiguration::is_metric_aggregation_type_Valid() const{
    return m_metric_aggregation_type_isValid;
}

bool OAIScalingPolicy_StepScalingPolicyConfiguration::isSet() const {
...
bool OAIScalingPolicy_StepScalingPolicyConfiguration::isValid() const {
