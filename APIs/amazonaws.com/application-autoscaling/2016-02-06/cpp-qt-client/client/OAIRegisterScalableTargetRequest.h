...
/*
 * OAIRegisterScalableTargetRequest.h
 *
 * 
 */

#ifndef OAIRegisterScalableTargetRequest_H
#define OAIRegisterScalableTargetRequest_H
...
namespace OpenAPI {
class OAIRegisterScalableTargetRequest_SuspendedState;

class OAIRegisterScalableTargetRequest : public OAIObject {
public:
    OAIRegisterScalableTargetRequest();
    OAIRegisterScalableTargetRequest(QString json);
    ~OAIRegisterScalableTargetRequest() override;
    ...
    OAIRegisterScalableTargetRequest_SuspendedState getSuspendedState() const;
    void setSuspendedState(const OAIRegisterScalableTargetRequest_SuspendedState &suspended_state);
...
private:
    ...
    OAIRegisterScalableTargetRequest_SuspendedState m_suspended_state;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegisterScalableTargetRequest)

#endif // OAIRegisterScalableTargetRequest_H
