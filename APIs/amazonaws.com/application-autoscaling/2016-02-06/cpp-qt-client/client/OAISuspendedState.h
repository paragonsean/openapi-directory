...
#ifndef OAISuspendedState_H
#define OAISuspendedState_H
...
class OAISuspendedState : public OAIObject {
public:
    OAISuspendedState();
    OAISuspendedState(QString json);
    ~OAISuspendedState() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISuspendedState)

#endif // OAISuspendedState_H
