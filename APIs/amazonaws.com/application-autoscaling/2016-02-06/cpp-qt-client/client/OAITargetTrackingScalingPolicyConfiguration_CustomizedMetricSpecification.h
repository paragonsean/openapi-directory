...
/*
 * OAITargetTrackingScalingPolicyConfiguration_CustomizedMetricSpecification.h
 *
 * 
 */

#ifndef OAITargetTrackingScalingPolicyConfiguration_CustomizedMetricSpecification_H
#define OAITargetTrackingScalingPolicyConfiguration_CustomizedMetricSpecification_H
...
class OAITargetTrackingScalingPolicyConfiguration_CustomizedMetricSpecification : public OAIObject {
public:
    OAITargetTrackingScalingPolicyConfiguration_CustomizedMetricSpecification();
    OAITargetTrackingScalingPolicyConfiguration_CustomizedMetricSpecification(QString json);
    ~OAITargetTrackingScalingPolicyConfiguration_CustomizedMetricSpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITargetTrackingScalingPolicyConfiguration_CustomizedMetricSpecification)

#endif // OAITargetTrackingScalingPolicyConfiguration_CustomizedMetricSpecification_H
