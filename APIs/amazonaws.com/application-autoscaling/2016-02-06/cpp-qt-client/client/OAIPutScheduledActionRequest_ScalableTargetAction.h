...
/*
 * OAIPutScheduledActionRequest_ScalableTargetAction.h
 *
 * 
 */

#ifndef OAIPutScheduledActionRequest_ScalableTargetAction_H
#define OAIPutScheduledActionRequest_ScalableTargetAction_H
...
class OAIPutScheduledActionRequest_ScalableTargetAction : public OAIObject {
public:
    OAIPutScheduledActionRequest_ScalableTargetAction();
    OAIPutScheduledActionRequest_ScalableTargetAction(QString json);
    ~OAIPutScheduledActionRequest_ScalableTargetAction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutScheduledActionRequest_ScalableTargetAction)

#endif // OAIPutScheduledActionRequest_ScalableTargetAction_H
