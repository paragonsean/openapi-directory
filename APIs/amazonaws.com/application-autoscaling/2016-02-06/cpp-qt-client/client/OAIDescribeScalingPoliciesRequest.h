...
/*
 * OAIDescribeScalingPoliciesRequest.h
 *
 * 
 */

#ifndef OAIDescribeScalingPoliciesRequest_H
#define OAIDescribeScalingPoliciesRequest_H
...
class OAIDescribeScalingPoliciesRequest : public OAIObject {
public:
    OAIDescribeScalingPoliciesRequest();
    OAIDescribeScalingPoliciesRequest(QString json);
    ~OAIDescribeScalingPoliciesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeScalingPoliciesRequest)

#endif // OAIDescribeScalingPoliciesRequest_H
