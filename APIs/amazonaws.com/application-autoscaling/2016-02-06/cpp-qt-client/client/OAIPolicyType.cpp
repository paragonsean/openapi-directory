...
OAIPolicyType::OAIPolicyType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPolicyType::OAIPolicyType() {
    this->initializeModel();
}

OAIPolicyType::~OAIPolicyType() {}

void OAIPolicyType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIPolicyType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIPolicyType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("StepScaling", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPolicyType::STEPSCALING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("TargetTrackingScaling", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPolicyType::TARGETTRACKINGSCALING;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIPolicyType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIPolicyType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIPolicyType::STEPSCALING:
            val = "StepScaling";
            break;
        case eOAIPolicyType::TARGETTRACKINGSCALING:
            val = "TargetTrackingScaling";
            break;
        default:
            break;
    }
...
QJsonValue OAIPolicyType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIPolicyType::eOAIPolicyType OAIPolicyType::getValue() const {
    return m_value;
}

void OAIPolicyType::setValue(const OAIPolicyType::eOAIPolicyType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIPolicyType::isSet() const {
    
    return m_value_isSet;
}

bool OAIPolicyType::isValid() const {
