...
/*
 * OAIDescribeScheduledActionsResponse.h
 *
 * 
 */

#ifndef OAIDescribeScheduledActionsResponse_H
#define OAIDescribeScheduledActionsResponse_H
...
class OAIDescribeScheduledActionsResponse : public OAIObject {
public:
    OAIDescribeScheduledActionsResponse();
    OAIDescribeScheduledActionsResponse(QString json);
    ~OAIDescribeScheduledActionsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeScheduledActionsResponse)

#endif // OAIDescribeScheduledActionsResponse_H
