...
/*
 * OAIRegisterScalableTargetRequest_SuspendedState.h
 *
 * 
 */

#ifndef OAIRegisterScalableTargetRequest_SuspendedState_H
#define OAIRegisterScalableTargetRequest_SuspendedState_H
...
class OAIRegisterScalableTargetRequest_SuspendedState : public OAIObject {
public:
    OAIRegisterScalableTargetRequest_SuspendedState();
    OAIRegisterScalableTargetRequest_SuspendedState(QString json);
    ~OAIRegisterScalableTargetRequest_SuspendedState() override;
    ...
    void setDynamicScalingInSuspended(const bool &dynamic_scaling_in_suspended);
    bool is_dynamic_scaling_in_suspended_Set() const;
    bool is_dynamic_scaling_in_suspended_Valid() const;

    bool getDynamicScalingOutSuspended() const;
    void setDynamicScalingOutSuspended(const bool &dynamic_scaling_out_suspended);
    bool is_dynamic_scaling_out_suspended_Set() const;
    bool is_dynamic_scaling_out_suspended_Valid() const;

    bool getScheduledScalingSuspended() const;
    void setScheduledScalingSuspended(const bool &scheduled_scaling_suspended);
    bool is_scheduled_scaling_suspended_Set() const;
    bool is_scheduled_scaling_suspended_Valid() const;
...
private:
    ...
    bool m_dynamic_scaling_in_suspended;
    bool m_dynamic_scaling_in_suspended_isSet;
    bool m_dynamic_scaling_in_suspended_isValid;

    bool m_dynamic_scaling_out_suspended;
    bool m_dynamic_scaling_out_suspended_isSet;
    bool m_dynamic_scaling_out_suspended_isValid;

    bool m_scheduled_scaling_suspended;
    bool m_scheduled_scaling_suspended_isSet;
    bool m_scheduled_scaling_suspended_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIRegisterScalableTargetRequest_SuspendedState)

#endif // OAIRegisterScalableTargetRequest_SuspendedState_H
