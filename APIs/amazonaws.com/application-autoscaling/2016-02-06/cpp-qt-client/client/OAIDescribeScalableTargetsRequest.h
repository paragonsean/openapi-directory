...
/*
 * OAIDescribeScalableTargetsRequest.h
 *
 * 
 */

#ifndef OAIDescribeScalableTargetsRequest_H
#define OAIDescribeScalableTargetsRequest_H
...
class OAIDescribeScalableTargetsRequest : public OAIObject {
public:
    OAIDescribeScalableTargetsRequest();
    OAIDescribeScalableTargetsRequest(QString json);
    ~OAIDescribeScalableTargetsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeScalableTargetsRequest)

#endif // OAIDescribeScalableTargetsRequest_H
