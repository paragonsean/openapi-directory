...
OAIDeleteScalingPolicyRequest::OAIDeleteScalingPolicyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteScalingPolicyRequest::OAIDeleteScalingPolicyRequest() {
    this->initializeModel();
}

OAIDeleteScalingPolicyRequest::~OAIDeleteScalingPolicyRequest() {}

void OAIDeleteScalingPolicyRequest::initializeModel() {
...
void OAIDeleteScalingPolicyRequest::fromJson(QString jsonString) {
...
void OAIDeleteScalingPolicyRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteScalingPolicyRequest::asJson() const {
...
QJsonObject OAIDeleteScalingPolicyRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteScalingPolicyRequest::getPolicyName() const {
    return m_policy_name;
}
void OAIDeleteScalingPolicyRequest::setPolicyName(const QString &policy_name) {
    m_policy_name = policy_name;
    m_policy_name_isSet = true;
}

bool OAIDeleteScalingPolicyRequest::is_policy_name_Set() const{
    return m_policy_name_isSet;
}

bool OAIDeleteScalingPolicyRequest::is_policy_name_Valid() const{
    return m_policy_name_isValid;
}

OAIServiceNamespace OAIDeleteScalingPolicyRequest::getServiceNamespace() const {
    return m_service_namespace;
}
void OAIDeleteScalingPolicyRequest::setServiceNamespace(const OAIServiceNamespace &service_namespace) {
    m_service_namespace = service_namespace;
    m_service_namespace_isSet = true;
}

bool OAIDeleteScalingPolicyRequest::is_service_namespace_Set() const{
    return m_service_namespace_isSet;
}

bool OAIDeleteScalingPolicyRequest::is_service_namespace_Valid() const{
    return m_service_namespace_isValid;
}

QString OAIDeleteScalingPolicyRequest::getResourceId() const {
    return m_resource_id;
}
void OAIDeleteScalingPolicyRequest::setResourceId(const QString &resource_id) {
    m_resource_id = resource_id;
    m_resource_id_isSet = true;
}

bool OAIDeleteScalingPolicyRequest::is_resource_id_Set() const{
    return m_resource_id_isSet;
}

bool OAIDeleteScalingPolicyRequest::is_resource_id_Valid() const{
    return m_resource_id_isValid;
}

OAIScalableDimension OAIDeleteScalingPolicyRequest::getScalableDimension() const {
    return m_scalable_dimension;
}
void OAIDeleteScalingPolicyRequest::setScalableDimension(const OAIScalableDimension &scalable_dimension) {
    m_scalable_dimension = scalable_dimension;
    m_scalable_dimension_isSet = true;
}

bool OAIDeleteScalingPolicyRequest::is_scalable_dimension_Set() const{
    return m_scalable_dimension_isSet;
}

bool OAIDeleteScalingPolicyRequest::is_scalable_dimension_Valid() const{
    return m_scalable_dimension_isValid;
}

bool OAIDeleteScalingPolicyRequest::isSet() const {
...
bool OAIDeleteScalingPolicyRequest::isValid() const {
