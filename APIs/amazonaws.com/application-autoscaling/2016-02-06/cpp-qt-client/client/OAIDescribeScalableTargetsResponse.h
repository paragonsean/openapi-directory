...
/*
 * OAIDescribeScalableTargetsResponse.h
 *
 * 
 */

#ifndef OAIDescribeScalableTargetsResponse_H
#define OAIDescribeScalableTargetsResponse_H
...
class OAIDescribeScalableTargetsResponse : public OAIObject {
public:
    OAIDescribeScalableTargetsResponse();
    OAIDescribeScalableTargetsResponse(QString json);
    ~OAIDescribeScalableTargetsResponse() override;
    ...
    QList getScalableTargets() const;
    void setScalableTargets(const QList &scalable_targets);
    bool is_scalable_targets_Set() const;
    bool is_scalable_targets_Valid() const;
...
private:
    ...
    QList m_scalable_targets;
    bool m_scalable_targets_isSet;
    bool m_scalable_targets_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeScalableTargetsResponse)

#endif // OAIDescribeScalableTargetsResponse_H
