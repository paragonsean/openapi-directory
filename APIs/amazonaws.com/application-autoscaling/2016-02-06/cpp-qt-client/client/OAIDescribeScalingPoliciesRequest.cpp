...
OAIDescribeScalingPoliciesRequest::OAIDescribeScalingPoliciesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeScalingPoliciesRequest::OAIDescribeScalingPoliciesRequest() {
    this->initializeModel();
}

OAIDescribeScalingPoliciesRequest::~OAIDescribeScalingPoliciesRequest() {}

void OAIDescribeScalingPoliciesRequest::initializeModel() {
...
void OAIDescribeScalingPoliciesRequest::fromJson(QString jsonString) {
...
void OAIDescribeScalingPoliciesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeScalingPoliciesRequest::asJson() const {
...
QJsonObject OAIDescribeScalingPoliciesRequest::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeScalingPoliciesRequest::getPolicyNames() const {
    return m_policy_names;
}
void OAIDescribeScalingPoliciesRequest::setPolicyNames(const QList &policy_names) {
    m_policy_names = policy_names;
    m_policy_names_isSet = true;
}

bool OAIDescribeScalingPoliciesRequest::is_policy_names_Set() const{
    return m_policy_names_isSet;
}

bool OAIDescribeScalingPoliciesRequest::is_policy_names_Valid() const{
    return m_policy_names_isValid;
}

OAIServiceNamespace OAIDescribeScalingPoliciesRequest::getServiceNamespace() const {
    return m_service_namespace;
}
void OAIDescribeScalingPoliciesRequest::setServiceNamespace(const OAIServiceNamespace &service_namespace) {
    m_service_namespace = service_namespace;
    m_service_namespace_isSet = true;
}

bool OAIDescribeScalingPoliciesRequest::is_service_namespace_Set() const{
    return m_service_namespace_isSet;
}

bool OAIDescribeScalingPoliciesRequest::is_service_namespace_Valid() const{
    return m_service_namespace_isValid;
}

QString OAIDescribeScalingPoliciesRequest::getResourceId() const {
    return m_resource_id;
}
void OAIDescribeScalingPoliciesRequest::setResourceId(const QString &resource_id) {
    m_resource_id = resource_id;
    m_resource_id_isSet = true;
}

bool OAIDescribeScalingPoliciesRequest::is_resource_id_Set() const{
    return m_resource_id_isSet;
}

bool OAIDescribeScalingPoliciesRequest::is_resource_id_Valid() const{
    return m_resource_id_isValid;
}

OAIScalableDimension OAIDescribeScalingPoliciesRequest::getScalableDimension() const {
    return m_scalable_dimension;
}
void OAIDescribeScalingPoliciesRequest::setScalableDimension(const OAIScalableDimension &scalable_dimension) {
    m_scalable_dimension = scalable_dimension;
    m_scalable_dimension_isSet = true;
}

bool OAIDescribeScalingPoliciesRequest::is_scalable_dimension_Set() const{
    return m_scalable_dimension_isSet;
}

bool OAIDescribeScalingPoliciesRequest::is_scalable_dimension_Valid() const{
    return m_scalable_dimension_isValid;
}

qint32 OAIDescribeScalingPoliciesRequest::getMaxResults() const {
    return m_max_results;
}
void OAIDescribeScalingPoliciesRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIDescribeScalingPoliciesRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIDescribeScalingPoliciesRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIDescribeScalingPoliciesRequest::getNextToken() const {
    return m_next_token;
}
void OAIDescribeScalingPoliciesRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeScalingPoliciesRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeScalingPoliciesRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeScalingPoliciesRequest::isSet() const {
...
bool OAIDescribeScalingPoliciesRequest::isValid() const {
