...
/*
 * OAIPutScalingPolicyRequest.h
 *
 * 
 */

#ifndef OAIPutScalingPolicyRequest_H
#define OAIPutScalingPolicyRequest_H

#include <QJsonObject>

#include "OAIPolicyType.h"
#include "OAIPutScalingPolicyRequest_StepScalingPolicyConfiguration.h"
#include "OAIPutScalingPolicyRequest_TargetTrackingScalingPolicyConfiguration.h"
...
namespace OpenAPI {
class OAIPutScalingPolicyRequest_StepScalingPolicyConfiguration;
class OAIPutScalingPolicyRequest_TargetTrackingScalingPolicyConfiguration;

class OAIPutScalingPolicyRequest : public OAIObject {
public:
    OAIPutScalingPolicyRequest();
    OAIPutScalingPolicyRequest(QString json);
    ~OAIPutScalingPolicyRequest() override;
    ...
    OAIPutScalingPolicyRequest_StepScalingPolicyConfiguration getStepScalingPolicyConfiguration() const;
    void setStepScalingPolicyConfiguration(const OAIPutScalingPolicyRequest_StepScalingPolicyConfiguration &step_scaling_policy_configuration);
    bool is_step_scaling_policy_configuration_Set() const;
    bool is_step_scaling_policy_configuration_Valid() const;

    OAIPutScalingPolicyRequest_TargetTrackingScalingPolicyConfiguration getTargetTrackingScalingPolicyConfiguration() const;
    void setTargetTrackingScalingPolicyConfiguration(const OAIPutScalingPolicyRequest_TargetTrackingScalingPolicyConfiguration &target_tracking_scaling_policy_configuration);
...
private:
    ...
    OAIPutScalingPolicyRequest_StepScalingPolicyConfiguration m_step_scaling_policy_configuration;
    bool m_step_scaling_policy_configuration_isSet;
    bool m_step_scaling_policy_configuration_isValid;

    OAIPutScalingPolicyRequest_TargetTrackingScalingPolicyConfiguration m_target_tracking_scaling_policy_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutScalingPolicyRequest)

#endif // OAIPutScalingPolicyRequest_H
