...
/*
 * OAIScalingPolicy_StepScalingPolicyConfiguration.h
 *
 * 
 */

#ifndef OAIScalingPolicy_StepScalingPolicyConfiguration_H
#define OAIScalingPolicy_StepScalingPolicyConfiguration_H
...
class OAIScalingPolicy_StepScalingPolicyConfiguration : public OAIObject {
public:
    OAIScalingPolicy_StepScalingPolicyConfiguration();
    OAIScalingPolicy_StepScalingPolicyConfiguration(QString json);
    ~OAIScalingPolicy_StepScalingPolicyConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScalingPolicy_StepScalingPolicyConfiguration)

#endif // OAIScalingPolicy_StepScalingPolicyConfiguration_H
