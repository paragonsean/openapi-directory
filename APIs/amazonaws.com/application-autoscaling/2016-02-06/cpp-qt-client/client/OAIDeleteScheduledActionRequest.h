...
/*
 * OAIDeleteScheduledActionRequest.h
 *
 * 
 */

#ifndef OAIDeleteScheduledActionRequest_H
#define OAIDeleteScheduledActionRequest_H
...
class OAIDeleteScheduledActionRequest : public OAIObject {
public:
    OAIDeleteScheduledActionRequest();
    OAIDeleteScheduledActionRequest(QString json);
    ~OAIDeleteScheduledActionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteScheduledActionRequest)

#endif // OAIDeleteScheduledActionRequest_H
