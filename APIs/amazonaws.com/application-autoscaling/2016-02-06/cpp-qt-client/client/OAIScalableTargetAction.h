...
/*
 * OAIScalableTargetAction.h
 *
 * Represents the minimum and maximum capacity for a scheduled action.
 */

#ifndef OAIScalableTargetAction_H
#define OAIScalableTargetAction_H
...
class OAIScalableTargetAction : public OAIObject {
public:
    OAIScalableTargetAction();
    OAIScalableTargetAction(QString json);
    ~OAIScalableTargetAction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScalableTargetAction)

#endif // OAIScalableTargetAction_H
