...
/*
 * OAIPutScalingPolicyResponse.h
 *
 * 
 */

#ifndef OAIPutScalingPolicyResponse_H
#define OAIPutScalingPolicyResponse_H
...
class OAIPutScalingPolicyResponse : public OAIObject {
public:
    OAIPutScalingPolicyResponse();
    OAIPutScalingPolicyResponse(QString json);
    ~OAIPutScalingPolicyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutScalingPolicyResponse)

#endif // OAIPutScalingPolicyResponse_H
