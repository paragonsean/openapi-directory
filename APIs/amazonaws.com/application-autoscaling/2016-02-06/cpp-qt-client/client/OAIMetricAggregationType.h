...
/*
 * OAIMetricAggregationType.h
 *
 * 
 */

#ifndef OAIMetricAggregationType_H
#define OAIMetricAggregationType_H
...
class OAIMetricAggregationType : public OAIEnum {
public:
    OAIMetricAggregationType();
    OAIMetricAggregationType(QString json);
    ~OAIMetricAggregationType() override;
    ...
    enum class eOAIMetricAggregationType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        AVERAGE, 
        MINIMUM, 
        MAXIMUM
    };
    OAIMetricAggregationType::eOAIMetricAggregationType getValue() const;
    void setValue(const OAIMetricAggregationType::eOAIMetricAggregationType& value);
...
private:
    ...
    eOAIMetricAggregationType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMetricAggregationType)

#endif // OAIMetricAggregationType_H
