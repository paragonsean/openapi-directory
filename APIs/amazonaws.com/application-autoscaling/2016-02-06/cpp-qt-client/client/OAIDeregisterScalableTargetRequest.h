...
/*
 * OAIDeregisterScalableTargetRequest.h
 *
 * 
 */

#ifndef OAIDeregisterScalableTargetRequest_H
#define OAIDeregisterScalableTargetRequest_H
...
class OAIDeregisterScalableTargetRequest : public OAIObject {
public:
    OAIDeregisterScalableTargetRequest();
    OAIDeregisterScalableTargetRequest(QString json);
    ~OAIDeregisterScalableTargetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeregisterScalableTargetRequest)

#endif // OAIDeregisterScalableTargetRequest_H
