...
OAIMetricAggregationType::OAIMetricAggregationType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMetricAggregationType::OAIMetricAggregationType() {
    this->initializeModel();
}

OAIMetricAggregationType::~OAIMetricAggregationType() {}

void OAIMetricAggregationType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIMetricAggregationType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIMetricAggregationType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Average", Qt::CaseInsensitive) == 0) {
        m_value = eOAIMetricAggregationType::AVERAGE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Minimum", Qt::CaseInsensitive) == 0) {
        m_value = eOAIMetricAggregationType::MINIMUM;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Maximum", Qt::CaseInsensitive) == 0) {
        m_value = eOAIMetricAggregationType::MAXIMUM;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIMetricAggregationType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIMetricAggregationType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIMetricAggregationType::AVERAGE:
            val = "Average";
            break;
        case eOAIMetricAggregationType::MINIMUM:
            val = "Minimum";
            break;
        case eOAIMetricAggregationType::MAXIMUM:
            val = "Maximum";
            break;
        default:
            break;
...
QJsonValue OAIMetricAggregationType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIMetricAggregationType::eOAIMetricAggregationType OAIMetricAggregationType::getValue() const {
    return m_value;
}

void OAIMetricAggregationType::setValue(const OAIMetricAggregationType::eOAIMetricAggregationType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIMetricAggregationType::isSet() const {
    
    return m_value_isSet;
}

bool OAIMetricAggregationType::isValid() const {
