...
/*
 * OAIPutScalingPolicyRequest_TargetTrackingScalingPolicyConfiguration.h
 *
 * 
 */

#ifndef OAIPutScalingPolicyRequest_TargetTrackingScalingPolicyConfiguration_H
#define OAIPutScalingPolicyRequest_TargetTrackingScalingPolicyConfiguration_H
...
class OAIPutScalingPolicyRequest_TargetTrackingScalingPolicyConfiguration : public OAIObject {
public:
    OAIPutScalingPolicyRequest_TargetTrackingScalingPolicyConfiguration();
    OAIPutScalingPolicyRequest_TargetTrackingScalingPolicyConfiguration(QString json);
    ~OAIPutScalingPolicyRequest_TargetTrackingScalingPolicyConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutScalingPolicyRequest_TargetTrackingScalingPolicyConfiguration)

#endif // OAIPutScalingPolicyRequest_TargetTrackingScalingPolicyConfiguration_H
