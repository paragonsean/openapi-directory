...
/*
 * OAICreateServiceRequest_deploymentConfiguration.h
 *
 * 
 */

#ifndef OAICreateServiceRequest_deploymentConfiguration_H
#define OAICreateServiceRequest_deploymentConfiguration_H
...
class OAICreateServiceRequest_deploymentConfiguration : public OAIObject {
public:
    OAICreateServiceRequest_deploymentConfiguration();
    OAICreateServiceRequest_deploymentConfiguration(QString json);
    ~OAICreateServiceRequest_deploymentConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateServiceRequest_deploymentConfiguration)

#endif // OAICreateServiceRequest_deploymentConfiguration_H
