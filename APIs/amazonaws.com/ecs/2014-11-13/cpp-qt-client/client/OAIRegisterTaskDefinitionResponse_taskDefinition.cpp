...
OAIRegisterTaskDefinitionResponse_taskDefinition::OAIRegisterTaskDefinitionResponse_taskDefinition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRegisterTaskDefinitionResponse_taskDefinition::OAIRegisterTaskDefinitionResponse_taskDefinition() {
    this->initializeModel();
}

OAIRegisterTaskDefinitionResponse_taskDefinition::~OAIRegisterTaskDefinitionResponse_taskDefinition() {}

void OAIRegisterTaskDefinitionResponse_taskDefinition::initializeModel() {
...
void OAIRegisterTaskDefinitionResponse_taskDefinition::fromJson(QString jsonString) {
...
void OAIRegisterTaskDefinitionResponse_taskDefinition::fromJsonObject(QJsonObject json) {
...
QString OAIRegisterTaskDefinitionResponse_taskDefinition::asJson() const {
...
QJsonObject OAIRegisterTaskDefinitionResponse_taskDefinition::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRegisterTaskDefinitionResponse_taskDefinition::getTaskDefinitionArn() const {
    return m_task_definition_arn;
}
void OAIRegisterTaskDefinitionResponse_taskDefinition::setTaskDefinitionArn(const QString &task_definition_arn) {
    m_task_definition_arn = task_definition_arn;
    m_task_definition_arn_isSet = true;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_task_definition_arn_Set() const{
    return m_task_definition_arn_isSet;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_task_definition_arn_Valid() const{
    return m_task_definition_arn_isValid;
}

QList OAIRegisterTaskDefinitionResponse_taskDefinition::getContainerDefinitions() const {
    return m_container_definitions;
}
void OAIRegisterTaskDefinitionResponse_taskDefinition::setContainerDefinitions(const QList &container_definitions) {
    m_container_definitions = container_definitions;
    m_container_definitions_isSet = true;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_container_definitions_Set() const{
    return m_container_definitions_isSet;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_container_definitions_Valid() const{
    return m_container_definitions_isValid;
}

QString OAIRegisterTaskDefinitionResponse_taskDefinition::getFamily() const {
    return m_family;
}
void OAIRegisterTaskDefinitionResponse_taskDefinition::setFamily(const QString &family) {
    m_family = family;
    m_family_isSet = true;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_family_Set() const{
    return m_family_isSet;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_family_Valid() const{
    return m_family_isValid;
}

QString OAIRegisterTaskDefinitionResponse_taskDefinition::getTaskRoleArn() const {
    return m_task_role_arn;
}
void OAIRegisterTaskDefinitionResponse_taskDefinition::setTaskRoleArn(const QString &task_role_arn) {
    m_task_role_arn = task_role_arn;
    m_task_role_arn_isSet = true;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_task_role_arn_Set() const{
    return m_task_role_arn_isSet;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_task_role_arn_Valid() const{
    return m_task_role_arn_isValid;
}

QString OAIRegisterTaskDefinitionResponse_taskDefinition::getExecutionRoleArn() const {
    return m_execution_role_arn;
}
void OAIRegisterTaskDefinitionResponse_taskDefinition::setExecutionRoleArn(const QString &execution_role_arn) {
    m_execution_role_arn = execution_role_arn;
    m_execution_role_arn_isSet = true;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_execution_role_arn_Set() const{
    return m_execution_role_arn_isSet;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_execution_role_arn_Valid() const{
    return m_execution_role_arn_isValid;
}

OAINetworkMode OAIRegisterTaskDefinitionResponse_taskDefinition::getNetworkMode() const {
    return m_network_mode;
}
void OAIRegisterTaskDefinitionResponse_taskDefinition::setNetworkMode(const OAINetworkMode &network_mode) {
    m_network_mode = network_mode;
    m_network_mode_isSet = true;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_network_mode_Set() const{
    return m_network_mode_isSet;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_network_mode_Valid() const{
    return m_network_mode_isValid;
}

qint32 OAIRegisterTaskDefinitionResponse_taskDefinition::getRevision() const {
    return m_revision;
}
void OAIRegisterTaskDefinitionResponse_taskDefinition::setRevision(const qint32 &revision) {
    m_revision = revision;
    m_revision_isSet = true;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_revision_Set() const{
    return m_revision_isSet;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_revision_Valid() const{
    return m_revision_isValid;
}

QList OAIRegisterTaskDefinitionResponse_taskDefinition::getVolumes() const {
    return m_volumes;
}
void OAIRegisterTaskDefinitionResponse_taskDefinition::setVolumes(const QList &volumes) {
    m_volumes = volumes;
    m_volumes_isSet = true;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_volumes_Set() const{
    return m_volumes_isSet;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_volumes_Valid() const{
    return m_volumes_isValid;
}

OAITaskDefinitionStatus OAIRegisterTaskDefinitionResponse_taskDefinition::getStatus() const {
    return m_status;
}
void OAIRegisterTaskDefinitionResponse_taskDefinition::setStatus(const OAITaskDefinitionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_status_Set() const{
    return m_status_isSet;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_status_Valid() const{
    return m_status_isValid;
}

QList OAIRegisterTaskDefinitionResponse_taskDefinition::getRequiresAttributes() const {
    return m_requires_attributes;
}
void OAIRegisterTaskDefinitionResponse_taskDefinition::setRequiresAttributes(const QList &requires_attributes) {
    m_requires_attributes = requires_attributes;
    m_requires_attributes_isSet = true;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_requires_attributes_Set() const{
    return m_requires_attributes_isSet;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_requires_attributes_Valid() const{
    return m_requires_attributes_isValid;
}

QList OAIRegisterTaskDefinitionResponse_taskDefinition::getPlacementConstraints() const {
    return m_placement_constraints;
}
void OAIRegisterTaskDefinitionResponse_taskDefinition::setPlacementConstraints(const QList &placement_constraints) {
    m_placement_constraints = placement_constraints;
    m_placement_constraints_isSet = true;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_placement_constraints_Set() const{
    return m_placement_constraints_isSet;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_placement_constraints_Valid() const{
    return m_placement_constraints_isValid;
}

QList OAIRegisterTaskDefinitionResponse_taskDefinition::getCompatibilities() const {
    return m_compatibilities;
}
void OAIRegisterTaskDefinitionResponse_taskDefinition::setCompatibilities(const QList &compatibilities) {
    m_compatibilities = compatibilities;
    m_compatibilities_isSet = true;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_compatibilities_Set() const{
    return m_compatibilities_isSet;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_compatibilities_Valid() const{
    return m_compatibilities_isValid;
}

OAITaskDefinition_runtimePlatform OAIRegisterTaskDefinitionResponse_taskDefinition::getRuntimePlatform() const {
    return m_runtime_platform;
}
void OAIRegisterTaskDefinitionResponse_taskDefinition::setRuntimePlatform(const OAITaskDefinition_runtimePlatform &runtime_platform) {
    m_runtime_platform = runtime_platform;
    m_runtime_platform_isSet = true;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_runtime_platform_Set() const{
    return m_runtime_platform_isSet;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_runtime_platform_Valid() const{
    return m_runtime_platform_isValid;
}

QList OAIRegisterTaskDefinitionResponse_taskDefinition::getRequiresCompatibilities() const {
    return m_requires_compatibilities;
}
void OAIRegisterTaskDefinitionResponse_taskDefinition::setRequiresCompatibilities(const QList &requires_compatibilities) {
    m_requires_compatibilities = requires_compatibilities;
    m_requires_compatibilities_isSet = true;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_requires_compatibilities_Set() const{
    return m_requires_compatibilities_isSet;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_requires_compatibilities_Valid() const{
    return m_requires_compatibilities_isValid;
}

QString OAIRegisterTaskDefinitionResponse_taskDefinition::getCpu() const {
    return m_cpu;
}
void OAIRegisterTaskDefinitionResponse_taskDefinition::setCpu(const QString &cpu) {
    m_cpu = cpu;
    m_cpu_isSet = true;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_cpu_Set() const{
    return m_cpu_isSet;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_cpu_Valid() const{
    return m_cpu_isValid;
}

QString OAIRegisterTaskDefinitionResponse_taskDefinition::getMemory() const {
    return m_memory;
}
void OAIRegisterTaskDefinitionResponse_taskDefinition::setMemory(const QString &memory) {
    m_memory = memory;
    m_memory_isSet = true;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_memory_Set() const{
    return m_memory_isSet;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_memory_Valid() const{
    return m_memory_isValid;
}

QList OAIRegisterTaskDefinitionResponse_taskDefinition::getInferenceAccelerators() const {
    return m_inference_accelerators;
}
void OAIRegisterTaskDefinitionResponse_taskDefinition::setInferenceAccelerators(const QList &inference_accelerators) {
    m_inference_accelerators = inference_accelerators;
    m_inference_accelerators_isSet = true;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_inference_accelerators_Set() const{
    return m_inference_accelerators_isSet;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_inference_accelerators_Valid() const{
    return m_inference_accelerators_isValid;
}

OAIPidMode OAIRegisterTaskDefinitionResponse_taskDefinition::getPidMode() const {
    return m_pid_mode;
}
void OAIRegisterTaskDefinitionResponse_taskDefinition::setPidMode(const OAIPidMode &pid_mode) {
    m_pid_mode = pid_mode;
    m_pid_mode_isSet = true;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_pid_mode_Set() const{
    return m_pid_mode_isSet;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_pid_mode_Valid() const{
    return m_pid_mode_isValid;
}

OAIIpcMode OAIRegisterTaskDefinitionResponse_taskDefinition::getIpcMode() const {
    return m_ipc_mode;
}
void OAIRegisterTaskDefinitionResponse_taskDefinition::setIpcMode(const OAIIpcMode &ipc_mode) {
    m_ipc_mode = ipc_mode;
    m_ipc_mode_isSet = true;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_ipc_mode_Set() const{
    return m_ipc_mode_isSet;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_ipc_mode_Valid() const{
    return m_ipc_mode_isValid;
}

OAITaskDefinition_proxyConfiguration OAIRegisterTaskDefinitionResponse_taskDefinition::getProxyConfiguration() const {
    return m_proxy_configuration;
}
void OAIRegisterTaskDefinitionResponse_taskDefinition::setProxyConfiguration(const OAITaskDefinition_proxyConfiguration &proxy_configuration) {
    m_proxy_configuration = proxy_configuration;
    m_proxy_configuration_isSet = true;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_proxy_configuration_Set() const{
    return m_proxy_configuration_isSet;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_proxy_configuration_Valid() const{
    return m_proxy_configuration_isValid;
}

QDateTime OAIRegisterTaskDefinitionResponse_taskDefinition::getRegisteredAt() const {
    return m_registered_at;
}
void OAIRegisterTaskDefinitionResponse_taskDefinition::setRegisteredAt(const QDateTime &registered_at) {
    m_registered_at = registered_at;
    m_registered_at_isSet = true;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_registered_at_Set() const{
    return m_registered_at_isSet;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_registered_at_Valid() const{
    return m_registered_at_isValid;
}

QDateTime OAIRegisterTaskDefinitionResponse_taskDefinition::getDeregisteredAt() const {
    return m_deregistered_at;
}
void OAIRegisterTaskDefinitionResponse_taskDefinition::setDeregisteredAt(const QDateTime &deregistered_at) {
    m_deregistered_at = deregistered_at;
    m_deregistered_at_isSet = true;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_deregistered_at_Set() const{
    return m_deregistered_at_isSet;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_deregistered_at_Valid() const{
    return m_deregistered_at_isValid;
}

QString OAIRegisterTaskDefinitionResponse_taskDefinition::getRegisteredBy() const {
    return m_registered_by;
}
void OAIRegisterTaskDefinitionResponse_taskDefinition::setRegisteredBy(const QString &registered_by) {
    m_registered_by = registered_by;
    m_registered_by_isSet = true;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_registered_by_Set() const{
    return m_registered_by_isSet;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_registered_by_Valid() const{
    return m_registered_by_isValid;
}

OAITaskDefinition_ephemeralStorage OAIRegisterTaskDefinitionResponse_taskDefinition::getEphemeralStorage() const {
    return m_ephemeral_storage;
}
void OAIRegisterTaskDefinitionResponse_taskDefinition::setEphemeralStorage(const OAITaskDefinition_ephemeralStorage &ephemeral_storage) {
    m_ephemeral_storage = ephemeral_storage;
    m_ephemeral_storage_isSet = true;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_ephemeral_storage_Set() const{
    return m_ephemeral_storage_isSet;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::is_ephemeral_storage_Valid() const{
    return m_ephemeral_storage_isValid;
}

bool OAIRegisterTaskDefinitionResponse_taskDefinition::isSet() const {
...
bool OAIRegisterTaskDefinitionResponse_taskDefinition::isValid() const {
