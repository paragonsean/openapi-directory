...
/*
 * OAIStartTaskRequest_overrides.h
 *
 * 
 */

#ifndef OAIStartTaskRequest_overrides_H
#define OAIStartTaskRequest_overrides_H
...
class OAIStartTaskRequest_overrides : public OAIObject {
public:
    OAIStartTaskRequest_overrides();
    OAIStartTaskRequest_overrides(QString json);
    ~OAIStartTaskRequest_overrides() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartTaskRequest_overrides)

#endif // OAIStartTaskRequest_overrides_H
