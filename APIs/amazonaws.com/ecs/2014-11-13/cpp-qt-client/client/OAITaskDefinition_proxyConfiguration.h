...
/*
 * OAITaskDefinition_proxyConfiguration.h
 *
 * 
 */

#ifndef OAITaskDefinition_proxyConfiguration_H
#define OAITaskDefinition_proxyConfiguration_H
...
class OAITaskDefinition_proxyConfiguration : public OAIObject {
public:
    OAITaskDefinition_proxyConfiguration();
    OAITaskDefinition_proxyConfiguration(QString json);
    ~OAITaskDefinition_proxyConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskDefinition_proxyConfiguration)

#endif // OAITaskDefinition_proxyConfiguration_H
