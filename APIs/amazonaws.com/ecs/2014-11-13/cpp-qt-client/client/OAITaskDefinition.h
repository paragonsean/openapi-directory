...
#ifndef OAITaskDefinition_H
#define OAITaskDefinition_H
...
class OAITaskDefinition : public OAIObject {
public:
    OAITaskDefinition();
    OAITaskDefinition(QString json);
    ~OAITaskDefinition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskDefinition)

#endif // OAITaskDefinition_H
