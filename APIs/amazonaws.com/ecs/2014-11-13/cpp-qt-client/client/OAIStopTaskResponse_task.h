...
/*
 * OAIStopTaskResponse_task.h
 *
 * 
 */

#ifndef OAIStopTaskResponse_task_H
#define OAIStopTaskResponse_task_H
...
class OAIStopTaskResponse_task : public OAIObject {
public:
    OAIStopTaskResponse_task();
    OAIStopTaskResponse_task(QString json);
    ~OAIStopTaskResponse_task() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopTaskResponse_task)

#endif // OAIStopTaskResponse_task_H
