...
/*
 * OAIUpdateClusterSettingsResponse_cluster.h
 *
 * 
 */

#ifndef OAIUpdateClusterSettingsResponse_cluster_H
#define OAIUpdateClusterSettingsResponse_cluster_H
...
class OAIUpdateClusterSettingsResponse_cluster : public OAIObject {
public:
    OAIUpdateClusterSettingsResponse_cluster();
    OAIUpdateClusterSettingsResponse_cluster(QString json);
    ~OAIUpdateClusterSettingsResponse_cluster() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateClusterSettingsResponse_cluster)

#endif // OAIUpdateClusterSettingsResponse_cluster_H
