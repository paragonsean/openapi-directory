...
/*
 * OAIDeleteTaskSetResponse_taskSet.h
 *
 * 
 */

#ifndef OAIDeleteTaskSetResponse_taskSet_H
#define OAIDeleteTaskSetResponse_taskSet_H
...
class OAIDeleteTaskSetResponse_taskSet : public OAIObject {
public:
    OAIDeleteTaskSetResponse_taskSet();
    OAIDeleteTaskSetResponse_taskSet(QString json);
    ~OAIDeleteTaskSetResponse_taskSet() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteTaskSetResponse_taskSet)

#endif // OAIDeleteTaskSetResponse_taskSet_H
