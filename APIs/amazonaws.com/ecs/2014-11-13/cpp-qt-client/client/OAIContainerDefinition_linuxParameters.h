...
/*
 * OAIContainerDefinition_linuxParameters.h
 *
 * 
 */

#ifndef OAIContainerDefinition_linuxParameters_H
#define OAIContainerDefinition_linuxParameters_H
...
class OAIContainerDefinition_linuxParameters : public OAIObject {
public:
    OAIContainerDefinition_linuxParameters();
    OAIContainerDefinition_linuxParameters(QString json);
    ~OAIContainerDefinition_linuxParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContainerDefinition_linuxParameters)

#endif // OAIContainerDefinition_linuxParameters_H
