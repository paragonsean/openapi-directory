...
/*
 * OAIExecuteCommandLogConfiguration.h
 *
 * The log configuration for the results of the execute command actions. The logs can be sent to CloudWatch Logs or an Amazon S3 bucket.
 */

#ifndef OAIExecuteCommandLogConfiguration_H
#define OAIExecuteCommandLogConfiguration_H
...
class OAIExecuteCommandLogConfiguration : public OAIObject {
public:
    OAIExecuteCommandLogConfiguration();
    OAIExecuteCommandLogConfiguration(QString json);
    ~OAIExecuteCommandLogConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExecuteCommandLogConfiguration)

#endif // OAIExecuteCommandLogConfiguration_H
