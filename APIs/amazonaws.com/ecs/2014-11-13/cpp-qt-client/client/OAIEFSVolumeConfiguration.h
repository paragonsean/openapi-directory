...
#ifndef OAIEFSVolumeConfiguration_H
#define OAIEFSVolumeConfiguration_H
...
class OAIEFSVolumeConfiguration : public OAIObject {
public:
    OAIEFSVolumeConfiguration();
    OAIEFSVolumeConfiguration(QString json);
    ~OAIEFSVolumeConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEFSVolumeConfiguration)

#endif // OAIEFSVolumeConfiguration_H
