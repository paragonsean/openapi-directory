...
QString OAIService::getClusterArn() const {
    return m_cluster_arn;
}
void OAIService::setClusterArn(const QString &cluster_arn) {
    m_cluster_arn = cluster_arn;
    m_cluster_arn_isSet = true;
}

bool OAIService::is_cluster_arn_Set() const{
    return m_cluster_arn_isSet;
}

bool OAIService::is_cluster_arn_Valid() const{
    return m_cluster_arn_isValid;
}

QList OAIService::getLoadBalancers() const {
    return m_load_balancers;
}
void OAIService::setLoadBalancers(const QList &load_balancers) {
    m_load_balancers = load_balancers;
    m_load_balancers_isSet = true;
}

bool OAIService::is_load_balancers_Set() const{
    return m_load_balancers_isSet;
}

bool OAIService::is_load_balancers_Valid() const{
    return m_load_balancers_isValid;
}

QList OAIService::getServiceRegistries() const {
    return m_service_registries;
}
void OAIService::setServiceRegistries(const QList &service_registries) {
    m_service_registries = service_registries;
    m_service_registries_isSet = true;
}

bool OAIService::is_service_registries_Set() const{
    return m_service_registries_isSet;
}

bool OAIService::is_service_registries_Valid() const{
    return m_service_registries_isValid;
}

QString OAIService::getStatus() const {
    return m_status;
}
void OAIService::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}
...
qint32 OAIService::getDesiredCount() const {
    return m_desired_count;
}
void OAIService::setDesiredCount(const qint32 &desired_count) {
    m_desired_count = desired_count;
    m_desired_count_isSet = true;
}

bool OAIService::is_desired_count_Set() const{
    return m_desired_count_isSet;
}

bool OAIService::is_desired_count_Valid() const{
    return m_desired_count_isValid;
}

qint32 OAIService::getRunningCount() const {
    return m_running_count;
}
void OAIService::setRunningCount(const qint32 &running_count) {
    m_running_count = running_count;
    m_running_count_isSet = true;
}

bool OAIService::is_running_count_Set() const{
    return m_running_count_isSet;
}

bool OAIService::is_running_count_Valid() const{
    return m_running_count_isValid;
}

qint32 OAIService::getPendingCount() const {
    return m_pending_count;
}
void OAIService::setPendingCount(const qint32 &pending_count) {
    m_pending_count = pending_count;
    m_pending_count_isSet = true;
}

bool OAIService::is_pending_count_Set() const{
    return m_pending_count_isSet;
}

bool OAIService::is_pending_count_Valid() const{
    return m_pending_count_isValid;
}

OAILaunchType OAIService::getLaunchType() const {
    return m_launch_type;
}
void OAIService::setLaunchType(const OAILaunchType &launch_type) {
    m_launch_type = launch_type;
    m_launch_type_isSet = true;
}

bool OAIService::is_launch_type_Set() const{
    return m_launch_type_isSet;
}

bool OAIService::is_launch_type_Valid() const{
    return m_launch_type_isValid;
}

QList OAIService::getCapacityProviderStrategy() const {
    return m_capacity_provider_strategy;
}
void OAIService::setCapacityProviderStrategy(const QList &capacity_provider_strategy) {
    m_capacity_provider_strategy = capacity_provider_strategy;
    m_capacity_provider_strategy_isSet = true;
}

bool OAIService::is_capacity_provider_strategy_Set() const{
    return m_capacity_provider_strategy_isSet;
}

bool OAIService::is_capacity_provider_strategy_Valid() const{
    return m_capacity_provider_strategy_isValid;
}

QString OAIService::getPlatformVersion() const {
    return m_platform_version;
}
void OAIService::setPlatformVersion(const QString &platform_version) {
    m_platform_version = platform_version;
    m_platform_version_isSet = true;
}

bool OAIService::is_platform_version_Set() const{
    return m_platform_version_isSet;
}

bool OAIService::is_platform_version_Valid() const{
    return m_platform_version_isValid;
}

QString OAIService::getPlatformFamily() const {
    return m_platform_family;
}
void OAIService::setPlatformFamily(const QString &platform_family) {
    m_platform_family = platform_family;
    m_platform_family_isSet = true;
}

bool OAIService::is_platform_family_Set() const{
    return m_platform_family_isSet;
}

bool OAIService::is_platform_family_Valid() const{
    return m_platform_family_isValid;
}

QString OAIService::getTaskDefinition() const {
    return m_task_definition;
}
void OAIService::setTaskDefinition(const QString &task_definition) {
    m_task_definition = task_definition;
    m_task_definition_isSet = true;
}

bool OAIService::is_task_definition_Set() const{
    return m_task_definition_isSet;
}

bool OAIService::is_task_definition_Valid() const{
    return m_task_definition_isValid;
}

OAICreateServiceRequest_deploymentConfiguration OAIService::getDeploymentConfiguration() const {
    return m_deployment_configuration;
}
void OAIService::setDeploymentConfiguration(const OAICreateServiceRequest_deploymentConfiguration &deployment_configuration) {
    m_deployment_configuration = deployment_configuration;
    m_deployment_configuration_isSet = true;
}

bool OAIService::is_deployment_configuration_Set() const{
    return m_deployment_configuration_isSet;
}

bool OAIService::is_deployment_configuration_Valid() const{
    return m_deployment_configuration_isValid;
}

QList OAIService::getTaskSets() const {
    return m_task_sets;
}
void OAIService::setTaskSets(const QList &task_sets) {
    m_task_sets = task_sets;
    m_task_sets_isSet = true;
}

bool OAIService::is_task_sets_Set() const{
    return m_task_sets_isSet;
}

bool OAIService::is_task_sets_Valid() const{
    return m_task_sets_isValid;
}

QList OAIService::getDeployments() const {
    return m_deployments;
}
void OAIService::setDeployments(const QList &deployments) {
    m_deployments = deployments;
    m_deployments_isSet = true;
}

bool OAIService::is_deployments_Set() const{
    return m_deployments_isSet;
}

bool OAIService::is_deployments_Valid() const{
    return m_deployments_isValid;
}

QString OAIService::getRoleArn() const {
    return m_role_arn;
}
void OAIService::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIService::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIService::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

QList OAIService::getEvents() const {
    return m_events;
}
void OAIService::setEvents(const QList &events) {
    m_events = events;
    m_events_isSet = true;
}
...
QList OAIService::getPlacementConstraints() const {
    return m_placement_constraints;
}
void OAIService::setPlacementConstraints(const QList &placement_constraints) {
    m_placement_constraints = placement_constraints;
    m_placement_constraints_isSet = true;
}

bool OAIService::is_placement_constraints_Set() const{
    return m_placement_constraints_isSet;
}

bool OAIService::is_placement_constraints_Valid() const{
    return m_placement_constraints_isValid;
}

QList OAIService::getPlacementStrategy() const {
    return m_placement_strategy;
}
void OAIService::setPlacementStrategy(const QList &placement_strategy) {
    m_placement_strategy = placement_strategy;
    m_placement_strategy_isSet = true;
}

bool OAIService::is_placement_strategy_Set() const{
    return m_placement_strategy_isSet;
}

bool OAIService::is_placement_strategy_Valid() const{
    return m_placement_strategy_isValid;
}

OAIStartTaskRequest_networkConfiguration OAIService::getNetworkConfiguration() const {
    return m_network_configuration;
}
void OAIService::setNetworkConfiguration(const OAIStartTaskRequest_networkConfiguration &network_configuration) {
...
qint32 OAIService::getHealthCheckGracePeriodSeconds() const {
    return m_health_check_grace_period_seconds;
}
void OAIService::setHealthCheckGracePeriodSeconds(const qint32 &health_check_grace_period_seconds) {
    m_health_check_grace_period_seconds = health_check_grace_period_seconds;
    m_health_check_grace_period_seconds_isSet = true;
}

bool OAIService::is_health_check_grace_period_seconds_Set() const{
    return m_health_check_grace_period_seconds_isSet;
}

bool OAIService::is_health_check_grace_period_seconds_Valid() const{
    return m_health_check_grace_period_seconds_isValid;
}

OAISchedulingStrategy OAIService::getSchedulingStrategy() const {
    return m_scheduling_strategy;
}
void OAIService::setSchedulingStrategy(const OAISchedulingStrategy &scheduling_strategy) {
    m_scheduling_strategy = scheduling_strategy;
    m_scheduling_strategy_isSet = true;
}

bool OAIService::is_scheduling_strategy_Set() const{
    return m_scheduling_strategy_isSet;
}

bool OAIService::is_scheduling_strategy_Valid() const{
    return m_scheduling_strategy_isValid;
}

OAIService_deploymentController OAIService::getDeploymentController() const {
    return m_deployment_controller;
}
void OAIService::setDeploymentController(const OAIService_deploymentController &deployment_controller) {
    m_deployment_controller = deployment_controller;
    m_deployment_controller_isSet = true;
}

bool OAIService::is_deployment_controller_Set() const{
    return m_deployment_controller_isSet;
}

bool OAIService::is_deployment_controller_Valid() const{
    return m_deployment_controller_isValid;
}

QList OAIService::getTags() const {
    return m_tags;
}
void OAIService::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
...
QString OAIService::getCreatedBy() const {
    return m_created_by;
}
void OAIService::setCreatedBy(const QString &created_by) {
    m_created_by = created_by;
    m_created_by_isSet = true;
}

bool OAIService::is_created_by_Set() const{
    return m_created_by_isSet;
}

bool OAIService::is_created_by_Valid() const{
    return m_created_by_isValid;
}

bool OAIService::getEnableEcsManagedTags() const {
    return m_enable_ecs_managed_tags;
}
void OAIService::setEnableEcsManagedTags(const bool &enable_ecs_managed_tags) {
    m_enable_ecs_managed_tags = enable_ecs_managed_tags;
    m_enable_ecs_managed_tags_isSet = true;
}

bool OAIService::is_enable_ecs_managed_tags_Set() const{
    return m_enable_ecs_managed_tags_isSet;
}

bool OAIService::is_enable_ecs_managed_tags_Valid() const{
    return m_enable_ecs_managed_tags_isValid;
}

OAIPropagateTags OAIService::getPropagateTags() const {
    return m_propagate_tags;
}
void OAIService::setPropagateTags(const OAIPropagateTags &propagate_tags) {
    m_propagate_tags = propagate_tags;
    m_propagate_tags_isSet = true;
}

bool OAIService::is_propagate_tags_Set() const{
    return m_propagate_tags_isSet;
}

bool OAIService::is_propagate_tags_Valid() const{
    return m_propagate_tags_isValid;
}

bool OAIService::getEnableExecuteCommand() const {
    return m_enable_execute_command;
}
void OAIService::setEnableExecuteCommand(const bool &enable_execute_command) {
    m_enable_execute_command = enable_execute_command;
    m_enable_execute_command_isSet = true;
}

bool OAIService::is_enable_execute_command_Set() const{
    return m_enable_execute_command_isSet;
}

bool OAIService::is_enable_execute_command_Valid() const{
