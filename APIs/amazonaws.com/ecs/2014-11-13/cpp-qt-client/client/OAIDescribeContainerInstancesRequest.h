...
/*
 * OAIDescribeContainerInstancesRequest.h
 *
 * 
 */

#ifndef OAIDescribeContainerInstancesRequest_H
#define OAIDescribeContainerInstancesRequest_H
...
class OAIDescribeContainerInstancesRequest : public OAIObject {
public:
    OAIDescribeContainerInstancesRequest();
    OAIDescribeContainerInstancesRequest(QString json);
    ~OAIDescribeContainerInstancesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeContainerInstancesRequest)

#endif // OAIDescribeContainerInstancesRequest_H
