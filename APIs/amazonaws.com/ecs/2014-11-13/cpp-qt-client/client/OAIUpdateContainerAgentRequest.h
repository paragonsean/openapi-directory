...
/*
 * OAIUpdateContainerAgentRequest.h
 *
 * 
 */

#ifndef OAIUpdateContainerAgentRequest_H
#define OAIUpdateContainerAgentRequest_H
...
class OAIUpdateContainerAgentRequest : public OAIObject {
public:
    OAIUpdateContainerAgentRequest();
    OAIUpdateContainerAgentRequest(QString json);
    ~OAIUpdateContainerAgentRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateContainerAgentRequest)

#endif // OAIUpdateContainerAgentRequest_H
