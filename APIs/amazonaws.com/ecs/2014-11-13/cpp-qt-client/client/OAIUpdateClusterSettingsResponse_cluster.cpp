...
#include "OAIUpdateClusterSettingsResponse_cluster.h"
...
OAIUpdateClusterSettingsResponse_cluster::OAIUpdateClusterSettingsResponse_cluster(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateClusterSettingsResponse_cluster::OAIUpdateClusterSettingsResponse_cluster() {
    this->initializeModel();
}

OAIUpdateClusterSettingsResponse_cluster::~OAIUpdateClusterSettingsResponse_cluster() {}

void OAIUpdateClusterSettingsResponse_cluster::initializeModel() {
...
void OAIUpdateClusterSettingsResponse_cluster::fromJson(QString jsonString) {
...
void OAIUpdateClusterSettingsResponse_cluster::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateClusterSettingsResponse_cluster::asJson() const {
...
QJsonObject OAIUpdateClusterSettingsResponse_cluster::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateClusterSettingsResponse_cluster::getClusterArn() const {
    return m_cluster_arn;
}
void OAIUpdateClusterSettingsResponse_cluster::setClusterArn(const QString &cluster_arn) {
    m_cluster_arn = cluster_arn;
    m_cluster_arn_isSet = true;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_cluster_arn_Set() const{
    return m_cluster_arn_isSet;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_cluster_arn_Valid() const{
    return m_cluster_arn_isValid;
}

QString OAIUpdateClusterSettingsResponse_cluster::getClusterName() const {
    return m_cluster_name;
}
void OAIUpdateClusterSettingsResponse_cluster::setClusterName(const QString &cluster_name) {
    m_cluster_name = cluster_name;
    m_cluster_name_isSet = true;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_cluster_name_Set() const{
    return m_cluster_name_isSet;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_cluster_name_Valid() const{
    return m_cluster_name_isValid;
}

OAIUpdateClusterRequest_configuration OAIUpdateClusterSettingsResponse_cluster::getConfiguration() const {
    return m_configuration;
}
void OAIUpdateClusterSettingsResponse_cluster::setConfiguration(const OAIUpdateClusterRequest_configuration &configuration) {
    m_configuration = configuration;
    m_configuration_isSet = true;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_configuration_Set() const{
    return m_configuration_isSet;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_configuration_Valid() const{
    return m_configuration_isValid;
}

QString OAIUpdateClusterSettingsResponse_cluster::getStatus() const {
    return m_status;
}
void OAIUpdateClusterSettingsResponse_cluster::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_status_Set() const{
    return m_status_isSet;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_status_Valid() const{
    return m_status_isValid;
}

qint32 OAIUpdateClusterSettingsResponse_cluster::getRegisteredContainerInstancesCount() const {
    return m_registered_container_instances_count;
}
void OAIUpdateClusterSettingsResponse_cluster::setRegisteredContainerInstancesCount(const qint32 &registered_container_instances_count) {
...
bool OAIUpdateClusterSettingsResponse_cluster::is_registered_container_instances_count_Set() const{
    return m_registered_container_instances_count_isSet;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_registered_container_instances_count_Valid() const{
    return m_registered_container_instances_count_isValid;
}

qint32 OAIUpdateClusterSettingsResponse_cluster::getRunningTasksCount() const {
    return m_running_tasks_count;
}
void OAIUpdateClusterSettingsResponse_cluster::setRunningTasksCount(const qint32 &running_tasks_count) {
    m_running_tasks_count = running_tasks_count;
    m_running_tasks_count_isSet = true;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_running_tasks_count_Set() const{
    return m_running_tasks_count_isSet;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_running_tasks_count_Valid() const{
    return m_running_tasks_count_isValid;
}

qint32 OAIUpdateClusterSettingsResponse_cluster::getPendingTasksCount() const {
    return m_pending_tasks_count;
}
void OAIUpdateClusterSettingsResponse_cluster::setPendingTasksCount(const qint32 &pending_tasks_count) {
    m_pending_tasks_count = pending_tasks_count;
    m_pending_tasks_count_isSet = true;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_pending_tasks_count_Set() const{
    return m_pending_tasks_count_isSet;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_pending_tasks_count_Valid() const{
    return m_pending_tasks_count_isValid;
}

qint32 OAIUpdateClusterSettingsResponse_cluster::getActiveServicesCount() const {
    return m_active_services_count;
}
void OAIUpdateClusterSettingsResponse_cluster::setActiveServicesCount(const qint32 &active_services_count) {
    m_active_services_count = active_services_count;
    m_active_services_count_isSet = true;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_active_services_count_Set() const{
    return m_active_services_count_isSet;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_active_services_count_Valid() const{
    return m_active_services_count_isValid;
}

QList OAIUpdateClusterSettingsResponse_cluster::getStatistics() const {
    return m_statistics;
}
void OAIUpdateClusterSettingsResponse_cluster::setStatistics(const QList &statistics) {
    m_statistics = statistics;
    m_statistics_isSet = true;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_statistics_Set() const{
    return m_statistics_isSet;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_statistics_Valid() const{
    return m_statistics_isValid;
}

QList OAIUpdateClusterSettingsResponse_cluster::getTags() const {
    return m_tags;
}
void OAIUpdateClusterSettingsResponse_cluster::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_tags_Valid() const{
    return m_tags_isValid;
}

QList OAIUpdateClusterSettingsResponse_cluster::getSettings() const {
    return m_settings;
}
void OAIUpdateClusterSettingsResponse_cluster::setSettings(const QList &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_settings_Valid() const{
    return m_settings_isValid;
}

QList OAIUpdateClusterSettingsResponse_cluster::getCapacityProviders() const {
    return m_capacity_providers;
}
void OAIUpdateClusterSettingsResponse_cluster::setCapacityProviders(const QList &capacity_providers) {
    m_capacity_providers = capacity_providers;
    m_capacity_providers_isSet = true;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_capacity_providers_Set() const{
    return m_capacity_providers_isSet;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_capacity_providers_Valid() const{
    return m_capacity_providers_isValid;
}

QList OAIUpdateClusterSettingsResponse_cluster::getDefaultCapacityProviderStrategy() const {
    return m_default_capacity_provider_strategy;
}
void OAIUpdateClusterSettingsResponse_cluster::setDefaultCapacityProviderStrategy(const QList &default_capacity_provider_strategy) {
    m_default_capacity_provider_strategy = default_capacity_provider_strategy;
    m_default_capacity_provider_strategy_isSet = true;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_default_capacity_provider_strategy_Set() const{
    return m_default_capacity_provider_strategy_isSet;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_default_capacity_provider_strategy_Valid() const{
    return m_default_capacity_provider_strategy_isValid;
}

QList OAIUpdateClusterSettingsResponse_cluster::getAttachments() const {
    return m_attachments;
}
void OAIUpdateClusterSettingsResponse_cluster::setAttachments(const QList &attachments) {
    m_attachments = attachments;
    m_attachments_isSet = true;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_attachments_Set() const{
    return m_attachments_isSet;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_attachments_Valid() const{
    return m_attachments_isValid;
}

QString OAIUpdateClusterSettingsResponse_cluster::getAttachmentsStatus() const {
    return m_attachments_status;
}
void OAIUpdateClusterSettingsResponse_cluster::setAttachmentsStatus(const QString &attachments_status) {
    m_attachments_status = attachments_status;
    m_attachments_status_isSet = true;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_attachments_status_Set() const{
    return m_attachments_status_isSet;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_attachments_status_Valid() const{
    return m_attachments_status_isValid;
}

OAICluster_serviceConnectDefaults OAIUpdateClusterSettingsResponse_cluster::getServiceConnectDefaults() const {
    return m_service_connect_defaults;
}
void OAIUpdateClusterSettingsResponse_cluster::setServiceConnectDefaults(const OAICluster_serviceConnectDefaults &service_connect_defaults) {
    m_service_connect_defaults = service_connect_defaults;
    m_service_connect_defaults_isSet = true;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_service_connect_defaults_Set() const{
    return m_service_connect_defaults_isSet;
}

bool OAIUpdateClusterSettingsResponse_cluster::is_service_connect_defaults_Valid() const{
    return m_service_connect_defaults_isValid;
}

bool OAIUpdateClusterSettingsResponse_cluster::isSet() const {
...
bool OAIUpdateClusterSettingsResponse_cluster::isValid() const {
