...
/*
 * OAIDescribeCapacityProvidersRequest.h
 *
 * 
 */

#ifndef OAIDescribeCapacityProvidersRequest_H
#define OAIDescribeCapacityProvidersRequest_H
...
class OAIDescribeCapacityProvidersRequest : public OAIObject {
public:
    OAIDescribeCapacityProvidersRequest();
    OAIDescribeCapacityProvidersRequest(QString json);
    ~OAIDescribeCapacityProvidersRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCapacityProvidersRequest)

#endif // OAIDescribeCapacityProvidersRequest_H
