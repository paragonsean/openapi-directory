...
OAIStartTaskRequest_overrides::OAIStartTaskRequest_overrides(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartTaskRequest_overrides::OAIStartTaskRequest_overrides() {
    this->initializeModel();
}

OAIStartTaskRequest_overrides::~OAIStartTaskRequest_overrides() {}

void OAIStartTaskRequest_overrides::initializeModel() {
...
void OAIStartTaskRequest_overrides::fromJson(QString jsonString) {
...
void OAIStartTaskRequest_overrides::fromJsonObject(QJsonObject json) {
...
QString OAIStartTaskRequest_overrides::asJson() const {
...
QJsonObject OAIStartTaskRequest_overrides::asJsonObject() const {
    QJsonObject obj;
...
QList OAIStartTaskRequest_overrides::getContainerOverrides() const {
    return m_container_overrides;
}
void OAIStartTaskRequest_overrides::setContainerOverrides(const QList &container_overrides) {
    m_container_overrides = container_overrides;
    m_container_overrides_isSet = true;
}

bool OAIStartTaskRequest_overrides::is_container_overrides_Set() const{
    return m_container_overrides_isSet;
}

bool OAIStartTaskRequest_overrides::is_container_overrides_Valid() const{
    return m_container_overrides_isValid;
}

QString OAIStartTaskRequest_overrides::getCpu() const {
    return m_cpu;
}
void OAIStartTaskRequest_overrides::setCpu(const QString &cpu) {
    m_cpu = cpu;
    m_cpu_isSet = true;
}

bool OAIStartTaskRequest_overrides::is_cpu_Set() const{
    return m_cpu_isSet;
}

bool OAIStartTaskRequest_overrides::is_cpu_Valid() const{
    return m_cpu_isValid;
}

QList OAIStartTaskRequest_overrides::getInferenceAcceleratorOverrides() const {
    return m_inference_accelerator_overrides;
}
void OAIStartTaskRequest_overrides::setInferenceAcceleratorOverrides(const QList &inference_accelerator_overrides) {
    m_inference_accelerator_overrides = inference_accelerator_overrides;
    m_inference_accelerator_overrides_isSet = true;
}

bool OAIStartTaskRequest_overrides::is_inference_accelerator_overrides_Set() const{
    return m_inference_accelerator_overrides_isSet;
}

bool OAIStartTaskRequest_overrides::is_inference_accelerator_overrides_Valid() const{
    return m_inference_accelerator_overrides_isValid;
}

QString OAIStartTaskRequest_overrides::getExecutionRoleArn() const {
    return m_execution_role_arn;
}
void OAIStartTaskRequest_overrides::setExecutionRoleArn(const QString &execution_role_arn) {
    m_execution_role_arn = execution_role_arn;
    m_execution_role_arn_isSet = true;
}

bool OAIStartTaskRequest_overrides::is_execution_role_arn_Set() const{
    return m_execution_role_arn_isSet;
}

bool OAIStartTaskRequest_overrides::is_execution_role_arn_Valid() const{
    return m_execution_role_arn_isValid;
}

QString OAIStartTaskRequest_overrides::getMemory() const {
    return m_memory;
}
void OAIStartTaskRequest_overrides::setMemory(const QString &memory) {
    m_memory = memory;
    m_memory_isSet = true;
}

bool OAIStartTaskRequest_overrides::is_memory_Set() const{
    return m_memory_isSet;
}

bool OAIStartTaskRequest_overrides::is_memory_Valid() const{
    return m_memory_isValid;
}

QString OAIStartTaskRequest_overrides::getTaskRoleArn() const {
    return m_task_role_arn;
}
void OAIStartTaskRequest_overrides::setTaskRoleArn(const QString &task_role_arn) {
    m_task_role_arn = task_role_arn;
    m_task_role_arn_isSet = true;
}

bool OAIStartTaskRequest_overrides::is_task_role_arn_Set() const{
    return m_task_role_arn_isSet;
}

bool OAIStartTaskRequest_overrides::is_task_role_arn_Valid() const{
    return m_task_role_arn_isValid;
}

OAITaskOverride_ephemeralStorage OAIStartTaskRequest_overrides::getEphemeralStorage() const {
    return m_ephemeral_storage;
}
void OAIStartTaskRequest_overrides::setEphemeralStorage(const OAITaskOverride_ephemeralStorage &ephemeral_storage) {
    m_ephemeral_storage = ephemeral_storage;
    m_ephemeral_storage_isSet = true;
}

bool OAIStartTaskRequest_overrides::is_ephemeral_storage_Set() const{
    return m_ephemeral_storage_isSet;
}

bool OAIStartTaskRequest_overrides::is_ephemeral_storage_Valid() const{
    return m_ephemeral_storage_isValid;
}

bool OAIStartTaskRequest_overrides::isSet() const {
...
bool OAIStartTaskRequest_overrides::isValid() const {
