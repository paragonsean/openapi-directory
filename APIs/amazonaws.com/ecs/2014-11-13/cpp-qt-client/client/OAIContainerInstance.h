...
class OAIContainerInstance : public OAIObject {
public:
    OAIContainerInstance();
    OAIContainerInstance(QString json);
    ~OAIContainerInstance() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContainerInstance)

#endif // OAIContainerInstance_H
