...
#ifndef OAIVolume_host_H
#define OAIVolume_host_H
...
class OAIVolume_host : public OAIObject {
public:
    OAIVolume_host();
    OAIVolume_host(QString json);
    ~OAIVolume_host() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVolume_host)

#endif // OAIVolume_host_H
