...
QString OAICompatibility::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAICompatibility::EC2:
            val = "EC2";
            break;
        case eOAICompatibility::FARGATE:
            val = "FARGATE";
            break;
        case eOAICompatibility::EXTERNAL:
            val = "EXTERNAL";
            break;
        default:
            break;
