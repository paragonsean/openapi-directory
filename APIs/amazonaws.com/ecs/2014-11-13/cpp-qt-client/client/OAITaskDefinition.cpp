...
OAITaskDefinition::OAITaskDefinition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITaskDefinition::OAITaskDefinition() {
    this->initializeModel();
}

OAITaskDefinition::~OAITaskDefinition() {}

void OAITaskDefinition::initializeModel() {
...
void OAITaskDefinition::fromJson(QString jsonString) {
...
void OAITaskDefinition::fromJsonObject(QJsonObject json) {
...
QString OAITaskDefinition::asJson() const {
...
QJsonObject OAITaskDefinition::asJsonObject() const {
    QJsonObject obj;
...
QString OAITaskDefinition::getTaskDefinitionArn() const {
    return m_task_definition_arn;
}
void OAITaskDefinition::setTaskDefinitionArn(const QString &task_definition_arn) {
    m_task_definition_arn = task_definition_arn;
    m_task_definition_arn_isSet = true;
}

bool OAITaskDefinition::is_task_definition_arn_Set() const{
    return m_task_definition_arn_isSet;
}

bool OAITaskDefinition::is_task_definition_arn_Valid() const{
    return m_task_definition_arn_isValid;
}

QList OAITaskDefinition::getContainerDefinitions() const {
    return m_container_definitions;
}
void OAITaskDefinition::setContainerDefinitions(const QList &container_definitions) {
    m_container_definitions = container_definitions;
    m_container_definitions_isSet = true;
}

bool OAITaskDefinition::is_container_definitions_Set() const{
    return m_container_definitions_isSet;
}

bool OAITaskDefinition::is_container_definitions_Valid() const{
    return m_container_definitions_isValid;
}

QString OAITaskDefinition::getFamily() const {
    return m_family;
}
void OAITaskDefinition::setFamily(const QString &family) {
    m_family = family;
    m_family_isSet = true;
}

bool OAITaskDefinition::is_family_Set() const{
    return m_family_isSet;
}

bool OAITaskDefinition::is_family_Valid() const{
    return m_family_isValid;
}

QString OAITaskDefinition::getTaskRoleArn() const {
    return m_task_role_arn;
}
void OAITaskDefinition::setTaskRoleArn(const QString &task_role_arn) {
    m_task_role_arn = task_role_arn;
    m_task_role_arn_isSet = true;
}

bool OAITaskDefinition::is_task_role_arn_Set() const{
    return m_task_role_arn_isSet;
}

bool OAITaskDefinition::is_task_role_arn_Valid() const{
    return m_task_role_arn_isValid;
}

QString OAITaskDefinition::getExecutionRoleArn() const {
    return m_execution_role_arn;
}
void OAITaskDefinition::setExecutionRoleArn(const QString &execution_role_arn) {
    m_execution_role_arn = execution_role_arn;
    m_execution_role_arn_isSet = true;
}

bool OAITaskDefinition::is_execution_role_arn_Set() const{
    return m_execution_role_arn_isSet;
}

bool OAITaskDefinition::is_execution_role_arn_Valid() const{
    return m_execution_role_arn_isValid;
}

OAINetworkMode OAITaskDefinition::getNetworkMode() const {
    return m_network_mode;
}
void OAITaskDefinition::setNetworkMode(const OAINetworkMode &network_mode) {
    m_network_mode = network_mode;
    m_network_mode_isSet = true;
}

bool OAITaskDefinition::is_network_mode_Set() const{
    return m_network_mode_isSet;
}

bool OAITaskDefinition::is_network_mode_Valid() const{
    return m_network_mode_isValid;
}

qint32 OAITaskDefinition::getRevision() const {
    return m_revision;
}
void OAITaskDefinition::setRevision(const qint32 &revision) {
    m_revision = revision;
    m_revision_isSet = true;
}

bool OAITaskDefinition::is_revision_Set() const{
    return m_revision_isSet;
}

bool OAITaskDefinition::is_revision_Valid() const{
    return m_revision_isValid;
}

QList OAITaskDefinition::getVolumes() const {
    return m_volumes;
}
void OAITaskDefinition::setVolumes(const QList &volumes) {
    m_volumes = volumes;
    m_volumes_isSet = true;
}

bool OAITaskDefinition::is_volumes_Set() const{
    return m_volumes_isSet;
}

bool OAITaskDefinition::is_volumes_Valid() const{
    return m_volumes_isValid;
}

OAITaskDefinitionStatus OAITaskDefinition::getStatus() const {
    return m_status;
}
void OAITaskDefinition::setStatus(const OAITaskDefinitionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAITaskDefinition::is_status_Set() const{
    return m_status_isSet;
}

bool OAITaskDefinition::is_status_Valid() const{
    return m_status_isValid;
}

QList OAITaskDefinition::getRequiresAttributes() const {
    return m_requires_attributes;
}
void OAITaskDefinition::setRequiresAttributes(const QList &requires_attributes) {
    m_requires_attributes = requires_attributes;
    m_requires_attributes_isSet = true;
}

bool OAITaskDefinition::is_requires_attributes_Set() const{
    return m_requires_attributes_isSet;
}

bool OAITaskDefinition::is_requires_attributes_Valid() const{
    return m_requires_attributes_isValid;
}

QList OAITaskDefinition::getPlacementConstraints() const {
    return m_placement_constraints;
}
void OAITaskDefinition::setPlacementConstraints(const QList &placement_constraints) {
    m_placement_constraints = placement_constraints;
    m_placement_constraints_isSet = true;
}

bool OAITaskDefinition::is_placement_constraints_Set() const{
    return m_placement_constraints_isSet;
}

bool OAITaskDefinition::is_placement_constraints_Valid() const{
    return m_placement_constraints_isValid;
}

QList OAITaskDefinition::getCompatibilities() const {
    return m_compatibilities;
}
void OAITaskDefinition::setCompatibilities(const QList &compatibilities) {
    m_compatibilities = compatibilities;
    m_compatibilities_isSet = true;
}

bool OAITaskDefinition::is_compatibilities_Set() const{
    return m_compatibilities_isSet;
}

bool OAITaskDefinition::is_compatibilities_Valid() const{
    return m_compatibilities_isValid;
}

OAITaskDefinition_runtimePlatform OAITaskDefinition::getRuntimePlatform() const {
    return m_runtime_platform;
}
void OAITaskDefinition::setRuntimePlatform(const OAITaskDefinition_runtimePlatform &runtime_platform) {
    m_runtime_platform = runtime_platform;
    m_runtime_platform_isSet = true;
}

bool OAITaskDefinition::is_runtime_platform_Set() const{
    return m_runtime_platform_isSet;
}

bool OAITaskDefinition::is_runtime_platform_Valid() const{
    return m_runtime_platform_isValid;
}

QList OAITaskDefinition::getRequiresCompatibilities() const {
    return m_requires_compatibilities;
}
void OAITaskDefinition::setRequiresCompatibilities(const QList &requires_compatibilities) {
    m_requires_compatibilities = requires_compatibilities;
    m_requires_compatibilities_isSet = true;
}

bool OAITaskDefinition::is_requires_compatibilities_Set() const{
    return m_requires_compatibilities_isSet;
}

bool OAITaskDefinition::is_requires_compatibilities_Valid() const{
    return m_requires_compatibilities_isValid;
}

QString OAITaskDefinition::getCpu() const {
    return m_cpu;
}
void OAITaskDefinition::setCpu(const QString &cpu) {
    m_cpu = cpu;
    m_cpu_isSet = true;
}

bool OAITaskDefinition::is_cpu_Set() const{
    return m_cpu_isSet;
}

bool OAITaskDefinition::is_cpu_Valid() const{
    return m_cpu_isValid;
}

QString OAITaskDefinition::getMemory() const {
    return m_memory;
}
void OAITaskDefinition::setMemory(const QString &memory) {
    m_memory = memory;
    m_memory_isSet = true;
}

bool OAITaskDefinition::is_memory_Set() const{
    return m_memory_isSet;
}

bool OAITaskDefinition::is_memory_Valid() const{
    return m_memory_isValid;
}

QList OAITaskDefinition::getInferenceAccelerators() const {
    return m_inference_accelerators;
}
void OAITaskDefinition::setInferenceAccelerators(const QList &inference_accelerators) {
    m_inference_accelerators = inference_accelerators;
    m_inference_accelerators_isSet = true;
}

bool OAITaskDefinition::is_inference_accelerators_Set() const{
    return m_inference_accelerators_isSet;
}

bool OAITaskDefinition::is_inference_accelerators_Valid() const{
    return m_inference_accelerators_isValid;
}

OAIPidMode OAITaskDefinition::getPidMode() const {
    return m_pid_mode;
}
void OAITaskDefinition::setPidMode(const OAIPidMode &pid_mode) {
    m_pid_mode = pid_mode;
    m_pid_mode_isSet = true;
}

bool OAITaskDefinition::is_pid_mode_Set() const{
    return m_pid_mode_isSet;
}

bool OAITaskDefinition::is_pid_mode_Valid() const{
    return m_pid_mode_isValid;
}

OAIIpcMode OAITaskDefinition::getIpcMode() const {
    return m_ipc_mode;
}
void OAITaskDefinition::setIpcMode(const OAIIpcMode &ipc_mode) {
    m_ipc_mode = ipc_mode;
    m_ipc_mode_isSet = true;
}

bool OAITaskDefinition::is_ipc_mode_Set() const{
    return m_ipc_mode_isSet;
}

bool OAITaskDefinition::is_ipc_mode_Valid() const{
    return m_ipc_mode_isValid;
}

OAITaskDefinition_proxyConfiguration OAITaskDefinition::getProxyConfiguration() const {
    return m_proxy_configuration;
}
void OAITaskDefinition::setProxyConfiguration(const OAITaskDefinition_proxyConfiguration &proxy_configuration) {
    m_proxy_configuration = proxy_configuration;
    m_proxy_configuration_isSet = true;
}

bool OAITaskDefinition::is_proxy_configuration_Set() const{
    return m_proxy_configuration_isSet;
}

bool OAITaskDefinition::is_proxy_configuration_Valid() const{
    return m_proxy_configuration_isValid;
}

QDateTime OAITaskDefinition::getRegisteredAt() const {
    return m_registered_at;
}
void OAITaskDefinition::setRegisteredAt(const QDateTime &registered_at) {
    m_registered_at = registered_at;
    m_registered_at_isSet = true;
}

bool OAITaskDefinition::is_registered_at_Set() const{
    return m_registered_at_isSet;
}

bool OAITaskDefinition::is_registered_at_Valid() const{
    return m_registered_at_isValid;
}

QDateTime OAITaskDefinition::getDeregisteredAt() const {
    return m_deregistered_at;
}
void OAITaskDefinition::setDeregisteredAt(const QDateTime &deregistered_at) {
    m_deregistered_at = deregistered_at;
    m_deregistered_at_isSet = true;
}

bool OAITaskDefinition::is_deregistered_at_Set() const{
    return m_deregistered_at_isSet;
}

bool OAITaskDefinition::is_deregistered_at_Valid() const{
    return m_deregistered_at_isValid;
}

QString OAITaskDefinition::getRegisteredBy() const {
    return m_registered_by;
}
void OAITaskDefinition::setRegisteredBy(const QString &registered_by) {
    m_registered_by = registered_by;
    m_registered_by_isSet = true;
}

bool OAITaskDefinition::is_registered_by_Set() const{
    return m_registered_by_isSet;
}

bool OAITaskDefinition::is_registered_by_Valid() const{
    return m_registered_by_isValid;
}

OAITaskDefinition_ephemeralStorage OAITaskDefinition::getEphemeralStorage() const {
    return m_ephemeral_storage;
}
void OAITaskDefinition::setEphemeralStorage(const OAITaskDefinition_ephemeralStorage &ephemeral_storage) {
    m_ephemeral_storage = ephemeral_storage;
    m_ephemeral_storage_isSet = true;
}

bool OAITaskDefinition::is_ephemeral_storage_Set() const{
    return m_ephemeral_storage_isSet;
}

bool OAITaskDefinition::is_ephemeral_storage_Valid() const{
    return m_ephemeral_storage_isValid;
}

bool OAITaskDefinition::isSet() const {
...
bool OAITaskDefinition::isValid() const {
