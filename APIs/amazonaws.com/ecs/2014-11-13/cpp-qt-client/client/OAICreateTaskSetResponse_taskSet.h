...
/*
 * OAICreateTaskSetResponse_taskSet.h
 *
 * 
 */

#ifndef OAICreateTaskSetResponse_taskSet_H
#define OAICreateTaskSetResponse_taskSet_H
...
class OAICreateTaskSetResponse_taskSet : public OAIObject {
public:
    OAICreateTaskSetResponse_taskSet();
    OAICreateTaskSetResponse_taskSet(QString json);
    ~OAICreateTaskSetResponse_taskSet() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTaskSetResponse_taskSet)

#endif // OAICreateTaskSetResponse_taskSet_H
