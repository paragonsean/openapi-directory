...
/*
 * OAIDockerVolumeConfiguration.h
 *
...
#ifndef OAIDockerVolumeConfiguration_H
#define OAIDockerVolumeConfiguration_H
...
class OAIDockerVolumeConfiguration : public OAIObject {
public:
    OAIDockerVolumeConfiguration();
    OAIDockerVolumeConfiguration(QString json);
    ~OAIDockerVolumeConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDockerVolumeConfiguration)

#endif // OAIDockerVolumeConfiguration_H
