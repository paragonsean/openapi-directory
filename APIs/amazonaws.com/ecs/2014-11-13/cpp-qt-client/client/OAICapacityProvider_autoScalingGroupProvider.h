...
/*
 * OAICapacityProvider_autoScalingGroupProvider.h
 *
 * 
 */

#ifndef OAICapacityProvider_autoScalingGroupProvider_H
#define OAICapacityProvider_autoScalingGroupProvider_H
...
class OAICapacityProvider_autoScalingGroupProvider : public OAIObject {
public:
    OAICapacityProvider_autoScalingGroupProvider();
    OAICapacityProvider_autoScalingGroupProvider(QString json);
    ~OAICapacityProvider_autoScalingGroupProvider() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICapacityProvider_autoScalingGroupProvider)

#endif // OAICapacityProvider_autoScalingGroupProvider_H
