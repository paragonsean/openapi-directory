...
#include "OAIContainerInstance.h"
...
OAIContainerInstance::OAIContainerInstance(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIContainerInstance::OAIContainerInstance() {
    this->initializeModel();
}

OAIContainerInstance::~OAIContainerInstance() {}

void OAIContainerInstance::initializeModel() {
...
void OAIContainerInstance::fromJson(QString jsonString) {
...
void OAIContainerInstance::fromJsonObject(QJsonObject json) {
...
QString OAIContainerInstance::asJson() const {
...
QJsonObject OAIContainerInstance::asJsonObject() const {
    QJsonObject obj;
...
QString OAIContainerInstance::getContainerInstanceArn() const {
    return m_container_instance_arn;
}
void OAIContainerInstance::setContainerInstanceArn(const QString &container_instance_arn) {
    m_container_instance_arn = container_instance_arn;
    m_container_instance_arn_isSet = true;
}

bool OAIContainerInstance::is_container_instance_arn_Set() const{
    return m_container_instance_arn_isSet;
}

bool OAIContainerInstance::is_container_instance_arn_Valid() const{
    return m_container_instance_arn_isValid;
}

QString OAIContainerInstance::getEc2InstanceId() const {
    return m_ec2_instance_id;
}
void OAIContainerInstance::setEc2InstanceId(const QString &ec2_instance_id) {
    m_ec2_instance_id = ec2_instance_id;
    m_ec2_instance_id_isSet = true;
}

bool OAIContainerInstance::is_ec2_instance_id_Set() const{
    return m_ec2_instance_id_isSet;
}

bool OAIContainerInstance::is_ec2_instance_id_Valid() const{
    return m_ec2_instance_id_isValid;
}

QString OAIContainerInstance::getCapacityProviderName() const {
    return m_capacity_provider_name;
}
void OAIContainerInstance::setCapacityProviderName(const QString &capacity_provider_name) {
    m_capacity_provider_name = capacity_provider_name;
    m_capacity_provider_name_isSet = true;
}

bool OAIContainerInstance::is_capacity_provider_name_Set() const{
    return m_capacity_provider_name_isSet;
}

bool OAIContainerInstance::is_capacity_provider_name_Valid() const{
    return m_capacity_provider_name_isValid;
}

qint32 OAIContainerInstance::getVersion() const {
    return m_version;
}
void OAIContainerInstance::setVersion(const qint32 &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIContainerInstance::is_version_Set() const{
    return m_version_isSet;
}

bool OAIContainerInstance::is_version_Valid() const{
    return m_version_isValid;
}

OAIContainerInstance_versionInfo OAIContainerInstance::getVersionInfo() const {
    return m_version_info;
}
void OAIContainerInstance::setVersionInfo(const OAIContainerInstance_versionInfo &version_info) {
    m_version_info = version_info;
    m_version_info_isSet = true;
}

bool OAIContainerInstance::is_version_info_Set() const{
    return m_version_info_isSet;
}

bool OAIContainerInstance::is_version_info_Valid() const{
    return m_version_info_isValid;
}

QList OAIContainerInstance::getRemainingResources() const {
    return m_remaining_resources;
}
void OAIContainerInstance::setRemainingResources(const QList &remaining_resources) {
    m_remaining_resources = remaining_resources;
    m_remaining_resources_isSet = true;
}

bool OAIContainerInstance::is_remaining_resources_Set() const{
    return m_remaining_resources_isSet;
}

bool OAIContainerInstance::is_remaining_resources_Valid() const{
    return m_remaining_resources_isValid;
}

QList OAIContainerInstance::getRegisteredResources() const {
    return m_registered_resources;
}
void OAIContainerInstance::setRegisteredResources(const QList &registered_resources) {
    m_registered_resources = registered_resources;
    m_registered_resources_isSet = true;
}

bool OAIContainerInstance::is_registered_resources_Set() const{
    return m_registered_resources_isSet;
}

bool OAIContainerInstance::is_registered_resources_Valid() const{
    return m_registered_resources_isValid;
}

QString OAIContainerInstance::getStatus() const {
    return m_status;
}
void OAIContainerInstance::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIContainerInstance::is_status_Set() const{
    return m_status_isSet;
}

bool OAIContainerInstance::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIContainerInstance::getStatusReason() const {
    return m_status_reason;
}
void OAIContainerInstance::setStatusReason(const QString &status_reason) {
    m_status_reason = status_reason;
    m_status_reason_isSet = true;
}

bool OAIContainerInstance::is_status_reason_Set() const{
    return m_status_reason_isSet;
}

bool OAIContainerInstance::is_status_reason_Valid() const{
    return m_status_reason_isValid;
}

bool OAIContainerInstance::getAgentConnected() const {
    return m_agent_connected;
}
void OAIContainerInstance::setAgentConnected(const bool &agent_connected) {
    m_agent_connected = agent_connected;
    m_agent_connected_isSet = true;
}

bool OAIContainerInstance::is_agent_connected_Set() const{
    return m_agent_connected_isSet;
}

bool OAIContainerInstance::is_agent_connected_Valid() const{
    return m_agent_connected_isValid;
}

qint32 OAIContainerInstance::getRunningTasksCount() const {
    return m_running_tasks_count;
}
void OAIContainerInstance::setRunningTasksCount(const qint32 &running_tasks_count) {
    m_running_tasks_count = running_tasks_count;
    m_running_tasks_count_isSet = true;
}

bool OAIContainerInstance::is_running_tasks_count_Set() const{
    return m_running_tasks_count_isSet;
}

bool OAIContainerInstance::is_running_tasks_count_Valid() const{
    return m_running_tasks_count_isValid;
}

qint32 OAIContainerInstance::getPendingTasksCount() const {
    return m_pending_tasks_count;
}
void OAIContainerInstance::setPendingTasksCount(const qint32 &pending_tasks_count) {
    m_pending_tasks_count = pending_tasks_count;
    m_pending_tasks_count_isSet = true;
}

bool OAIContainerInstance::is_pending_tasks_count_Set() const{
    return m_pending_tasks_count_isSet;
}

bool OAIContainerInstance::is_pending_tasks_count_Valid() const{
    return m_pending_tasks_count_isValid;
}

OAIAgentUpdateStatus OAIContainerInstance::getAgentUpdateStatus() const {
    return m_agent_update_status;
}
void OAIContainerInstance::setAgentUpdateStatus(const OAIAgentUpdateStatus &agent_update_status) {
    m_agent_update_status = agent_update_status;
    m_agent_update_status_isSet = true;
}

bool OAIContainerInstance::is_agent_update_status_Set() const{
    return m_agent_update_status_isSet;
}

bool OAIContainerInstance::is_agent_update_status_Valid() const{
    return m_agent_update_status_isValid;
}

QList OAIContainerInstance::getAttributes() const {
    return m_attributes;
}
void OAIContainerInstance::setAttributes(const QList &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIContainerInstance::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIContainerInstance::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QDateTime OAIContainerInstance::getRegisteredAt() const {
    return m_registered_at;
}
void OAIContainerInstance::setRegisteredAt(const QDateTime &registered_at) {
    m_registered_at = registered_at;
    m_registered_at_isSet = true;
}

bool OAIContainerInstance::is_registered_at_Set() const{
    return m_registered_at_isSet;
}

bool OAIContainerInstance::is_registered_at_Valid() const{
    return m_registered_at_isValid;
}

QList OAIContainerInstance::getAttachments() const {
    return m_attachments;
}
void OAIContainerInstance::setAttachments(const QList &attachments) {
    m_attachments = attachments;
    m_attachments_isSet = true;
}

bool OAIContainerInstance::is_attachments_Set() const{
    return m_attachments_isSet;
}

bool OAIContainerInstance::is_attachments_Valid() const{
    return m_attachments_isValid;
}

QList OAIContainerInstance::getTags() const {
    return m_tags;
}
void OAIContainerInstance::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIContainerInstance::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIContainerInstance::is_tags_Valid() const{
    return m_tags_isValid;
}

OAIContainerInstance_healthStatus OAIContainerInstance::getHealthStatus() const {
    return m_health_status;
}
void OAIContainerInstance::setHealthStatus(const OAIContainerInstance_healthStatus &health_status) {
    m_health_status = health_status;
    m_health_status_isSet = true;
}

bool OAIContainerInstance::is_health_status_Set() const{
    return m_health_status_isSet;
}

bool OAIContainerInstance::is_health_status_Valid() const{
    return m_health_status_isValid;
}

bool OAIContainerInstance::isSet() const {
...
bool OAIContainerInstance::isValid() const {
