...
/*
 * OAIDeregisterContainerInstanceRequest.h
 *
 * 
 */

#ifndef OAIDeregisterContainerInstanceRequest_H
#define OAIDeregisterContainerInstanceRequest_H
...
class OAIDeregisterContainerInstanceRequest : public OAIObject {
public:
    OAIDeregisterContainerInstanceRequest();
    OAIDeregisterContainerInstanceRequest(QString json);
    ~OAIDeregisterContainerInstanceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeregisterContainerInstanceRequest)

#endif // OAIDeregisterContainerInstanceRequest_H
