...
QString OAICreateClusterResponse_cluster::getClusterName() const {
    return m_cluster_name;
}
void OAICreateClusterResponse_cluster::setClusterName(const QString &cluster_name) {
    m_cluster_name = cluster_name;
    m_cluster_name_isSet = true;
}

bool OAICreateClusterResponse_cluster::is_cluster_name_Set() const{
    return m_cluster_name_isSet;
}

bool OAICreateClusterResponse_cluster::is_cluster_name_Valid() const{
    return m_cluster_name_isValid;
}

OAIUpdateClusterRequest_configuration OAICreateClusterResponse_cluster::getConfiguration() const {
    return m_configuration;
}
void OAICreateClusterResponse_cluster::setConfiguration(const OAIUpdateClusterRequest_configuration &configuration) {
    m_configuration = configuration;
    m_configuration_isSet = true;
}

bool OAICreateClusterResponse_cluster::is_configuration_Set() const{
    return m_configuration_isSet;
}

bool OAICreateClusterResponse_cluster::is_configuration_Valid() const{
...
qint32 OAICreateClusterResponse_cluster::getRegisteredContainerInstancesCount() const {
    return m_registered_container_instances_count;
}
void OAICreateClusterResponse_cluster::setRegisteredContainerInstancesCount(const qint32 &registered_container_instances_count) {
...
bool OAICreateClusterResponse_cluster::is_registered_container_instances_count_Set() const{
    return m_registered_container_instances_count_isSet;
}

bool OAICreateClusterResponse_cluster::is_registered_container_instances_count_Valid() const{
    return m_registered_container_instances_count_isValid;
}

qint32 OAICreateClusterResponse_cluster::getRunningTasksCount() const {
    return m_running_tasks_count;
}
void OAICreateClusterResponse_cluster::setRunningTasksCount(const qint32 &running_tasks_count) {
    m_running_tasks_count = running_tasks_count;
    m_running_tasks_count_isSet = true;
}

bool OAICreateClusterResponse_cluster::is_running_tasks_count_Set() const{
    return m_running_tasks_count_isSet;
}

bool OAICreateClusterResponse_cluster::is_running_tasks_count_Valid() const{
    return m_running_tasks_count_isValid;
}

qint32 OAICreateClusterResponse_cluster::getPendingTasksCount() const {
    return m_pending_tasks_count;
}
void OAICreateClusterResponse_cluster::setPendingTasksCount(const qint32 &pending_tasks_count) {
    m_pending_tasks_count = pending_tasks_count;
    m_pending_tasks_count_isSet = true;
}

bool OAICreateClusterResponse_cluster::is_pending_tasks_count_Set() const{
    return m_pending_tasks_count_isSet;
}

bool OAICreateClusterResponse_cluster::is_pending_tasks_count_Valid() const{
    return m_pending_tasks_count_isValid;
}

qint32 OAICreateClusterResponse_cluster::getActiveServicesCount() const {
    return m_active_services_count;
}
void OAICreateClusterResponse_cluster::setActiveServicesCount(const qint32 &active_services_count) {
    m_active_services_count = active_services_count;
    m_active_services_count_isSet = true;
}

bool OAICreateClusterResponse_cluster::is_active_services_count_Set() const{
    return m_active_services_count_isSet;
}

bool OAICreateClusterResponse_cluster::is_active_services_count_Valid() const{
    return m_active_services_count_isValid;
}

QList OAICreateClusterResponse_cluster::getStatistics() const {
    return m_statistics;
}
void OAICreateClusterResponse_cluster::setStatistics(const QList &statistics) {
    m_statistics = statistics;
    m_statistics_isSet = true;
}

bool OAICreateClusterResponse_cluster::is_statistics_Set() const{
    return m_statistics_isSet;
}

bool OAICreateClusterResponse_cluster::is_statistics_Valid() const{
    return m_statistics_isValid;
}

QList OAICreateClusterResponse_cluster::getTags() const {
    return m_tags;
}
void OAICreateClusterResponse_cluster::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
...
QList OAICreateClusterResponse_cluster::getSettings() const {
    return m_settings;
}
void OAICreateClusterResponse_cluster::setSettings(const QList &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAICreateClusterResponse_cluster::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAICreateClusterResponse_cluster::is_settings_Valid() const{
    return m_settings_isValid;
}

QList OAICreateClusterResponse_cluster::getCapacityProviders() const {
    return m_capacity_providers;
}
void OAICreateClusterResponse_cluster::setCapacityProviders(const QList &capacity_providers) {
    m_capacity_providers = capacity_providers;
    m_capacity_providers_isSet = true;
}

bool OAICreateClusterResponse_cluster::is_capacity_providers_Set() const{
    return m_capacity_providers_isSet;
}

bool OAICreateClusterResponse_cluster::is_capacity_providers_Valid() const{
    return m_capacity_providers_isValid;
}

QList OAICreateClusterResponse_cluster::getDefaultCapacityProviderStrategy() const {
    return m_default_capacity_provider_strategy;
}
void OAICreateClusterResponse_cluster::setDefaultCapacityProviderStrategy(const QList &default_capacity_provider_strategy) {
    m_default_capacity_provider_strategy = default_capacity_provider_strategy;
    m_default_capacity_provider_strategy_isSet = true;
}

bool OAICreateClusterResponse_cluster::is_default_capacity_provider_strategy_Set() const{
    return m_default_capacity_provider_strategy_isSet;
}

bool OAICreateClusterResponse_cluster::is_default_capacity_provider_strategy_Valid() const{
    return m_default_capacity_provider_strategy_isValid;
}

QList OAICreateClusterResponse_cluster::getAttachments() const {
    return m_attachments;
}
void OAICreateClusterResponse_cluster::setAttachments(const QList &attachments) {
    m_attachments = attachments;
    m_attachments_isSet = true;
}

bool OAICreateClusterResponse_cluster::is_attachments_Set() const{
    return m_attachments_isSet;
}

bool OAICreateClusterResponse_cluster::is_attachments_Valid() const{
    return m_attachments_isValid;
}

QString OAICreateClusterResponse_cluster::getAttachmentsStatus() const {
    return m_attachments_status;
}
void OAICreateClusterResponse_cluster::setAttachmentsStatus(const QString &attachments_status) {
    m_attachments_status = attachments_status;
    m_attachments_status_isSet = true;
}

bool OAICreateClusterResponse_cluster::is_attachments_status_Set() const{
    return m_attachments_status_isSet;
}

bool OAICreateClusterResponse_cluster::is_attachments_status_Valid() const{
    return m_attachments_status_isValid;
}

OAICluster_serviceConnectDefaults OAICreateClusterResponse_cluster::getServiceConnectDefaults() const {
    return m_service_connect_defaults;
}
void OAICreateClusterResponse_cluster::setServiceConnectDefaults(const OAICluster_serviceConnectDefaults &service_connect_defaults) {
    m_service_connect_defaults = service_connect_defaults;
    m_service_connect_defaults_isSet = true;
}

bool OAICreateClusterResponse_cluster::is_service_connect_defaults_Set() const{
    return m_service_connect_defaults_isSet;
}

bool OAICreateClusterResponse_cluster::is_service_connect_defaults_Valid() const{
