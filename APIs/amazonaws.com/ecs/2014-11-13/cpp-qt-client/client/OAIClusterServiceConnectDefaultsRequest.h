...
/*
 * OAIClusterServiceConnectDefaultsRequest.h
 *
...
#ifndef OAIClusterServiceConnectDefaultsRequest_H
#define OAIClusterServiceConnectDefaultsRequest_H
...
class OAIClusterServiceConnectDefaultsRequest : public OAIObject {
public:
    OAIClusterServiceConnectDefaultsRequest();
    OAIClusterServiceConnectDefaultsRequest(QString json);
    ~OAIClusterServiceConnectDefaultsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClusterServiceConnectDefaultsRequest)

#endif // OAIClusterServiceConnectDefaultsRequest_H
