...
/*
 * OAIAutoScalingGroupProviderUpdate.h
 *
 * The details of the Auto Scaling group capacity provider to update.
 */

#ifndef OAIAutoScalingGroupProviderUpdate_H
#define OAIAutoScalingGroupProviderUpdate_H
...
class OAIAutoScalingGroupProviderUpdate : public OAIObject {
public:
    OAIAutoScalingGroupProviderUpdate();
    OAIAutoScalingGroupProviderUpdate(QString json);
    ~OAIAutoScalingGroupProviderUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutoScalingGroupProviderUpdate)

#endif // OAIAutoScalingGroupProviderUpdate_H
