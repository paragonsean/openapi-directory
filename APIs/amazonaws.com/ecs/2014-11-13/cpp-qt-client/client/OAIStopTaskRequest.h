...
/*
 * OAIStopTaskRequest.h
 *
 * 
 */

#ifndef OAIStopTaskRequest_H
#define OAIStopTaskRequest_H
...
class OAIStopTaskRequest : public OAIObject {
public:
    OAIStopTaskRequest();
    OAIStopTaskRequest(QString json);
    ~OAIStopTaskRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopTaskRequest)

#endif // OAIStopTaskRequest_H
