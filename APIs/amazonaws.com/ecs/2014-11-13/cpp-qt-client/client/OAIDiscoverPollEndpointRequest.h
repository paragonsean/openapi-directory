...
/*
 * OAIDiscoverPollEndpointRequest.h
 *
 * 
 */

#ifndef OAIDiscoverPollEndpointRequest_H
#define OAIDiscoverPollEndpointRequest_H
...
class OAIDiscoverPollEndpointRequest : public OAIObject {
public:
    OAIDiscoverPollEndpointRequest();
    OAIDiscoverPollEndpointRequest(QString json);
    ~OAIDiscoverPollEndpointRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDiscoverPollEndpointRequest)

#endif // OAIDiscoverPollEndpointRequest_H
