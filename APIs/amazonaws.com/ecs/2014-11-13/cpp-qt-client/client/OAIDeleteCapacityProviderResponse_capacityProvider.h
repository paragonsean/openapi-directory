...
/*
 * OAIDeleteCapacityProviderResponse_capacityProvider.h
 *
 * 
 */

#ifndef OAIDeleteCapacityProviderResponse_capacityProvider_H
#define OAIDeleteCapacityProviderResponse_capacityProvider_H
...
class OAIDeleteCapacityProviderResponse_capacityProvider : public OAIObject {
public:
    OAIDeleteCapacityProviderResponse_capacityProvider();
    OAIDeleteCapacityProviderResponse_capacityProvider(QString json);
    ~OAIDeleteCapacityProviderResponse_capacityProvider() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteCapacityProviderResponse_capacityProvider)

#endif // OAIDeleteCapacityProviderResponse_capacityProvider_H
