...
OAIDeleteTaskSetResponse_taskSet::OAIDeleteTaskSetResponse_taskSet(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteTaskSetResponse_taskSet::OAIDeleteTaskSetResponse_taskSet() {
    this->initializeModel();
}

OAIDeleteTaskSetResponse_taskSet::~OAIDeleteTaskSetResponse_taskSet() {}

void OAIDeleteTaskSetResponse_taskSet::initializeModel() {
...
void OAIDeleteTaskSetResponse_taskSet::fromJson(QString jsonString) {
...
void OAIDeleteTaskSetResponse_taskSet::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteTaskSetResponse_taskSet::asJson() const {
...
QJsonObject OAIDeleteTaskSetResponse_taskSet::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIDeleteTaskSetResponse_taskSet::getId() const {
    return m_id;
}
void OAIDeleteTaskSetResponse_taskSet::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDeleteTaskSetResponse_taskSet::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDeleteTaskSetResponse_taskSet::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIDeleteTaskSetResponse_taskSet::getTaskSetArn() const {
    return m_task_set_arn;
}
void OAIDeleteTaskSetResponse_taskSet::setTaskSetArn(const QString &task_set_arn) {
    m_task_set_arn = task_set_arn;
    m_task_set_arn_isSet = true;
}

bool OAIDeleteTaskSetResponse_taskSet::is_task_set_arn_Set() const{
    return m_task_set_arn_isSet;
}

bool OAIDeleteTaskSetResponse_taskSet::is_task_set_arn_Valid() const{
    return m_task_set_arn_isValid;
}

QString OAIDeleteTaskSetResponse_taskSet::getServiceArn() const {
    return m_service_arn;
}
void OAIDeleteTaskSetResponse_taskSet::setServiceArn(const QString &service_arn) {
    m_service_arn = service_arn;
    m_service_arn_isSet = true;
}

bool OAIDeleteTaskSetResponse_taskSet::is_service_arn_Set() const{
    return m_service_arn_isSet;
}

bool OAIDeleteTaskSetResponse_taskSet::is_service_arn_Valid() const{
    return m_service_arn_isValid;
}

QString OAIDeleteTaskSetResponse_taskSet::getClusterArn() const {
    return m_cluster_arn;
}
void OAIDeleteTaskSetResponse_taskSet::setClusterArn(const QString &cluster_arn) {
    m_cluster_arn = cluster_arn;
    m_cluster_arn_isSet = true;
}

bool OAIDeleteTaskSetResponse_taskSet::is_cluster_arn_Set() const{
    return m_cluster_arn_isSet;
}

bool OAIDeleteTaskSetResponse_taskSet::is_cluster_arn_Valid() const{
    return m_cluster_arn_isValid;
}

QString OAIDeleteTaskSetResponse_taskSet::getStartedBy() const {
    return m_started_by;
}
void OAIDeleteTaskSetResponse_taskSet::setStartedBy(const QString &started_by) {
    m_started_by = started_by;
    m_started_by_isSet = true;
}

bool OAIDeleteTaskSetResponse_taskSet::is_started_by_Set() const{
    return m_started_by_isSet;
}

bool OAIDeleteTaskSetResponse_taskSet::is_started_by_Valid() const{
    return m_started_by_isValid;
}

QString OAIDeleteTaskSetResponse_taskSet::getExternalId() const {
    return m_external_id;
}
void OAIDeleteTaskSetResponse_taskSet::setExternalId(const QString &external_id) {
    m_external_id = external_id;
    m_external_id_isSet = true;
}

bool OAIDeleteTaskSetResponse_taskSet::is_external_id_Set() const{
    return m_external_id_isSet;
}

bool OAIDeleteTaskSetResponse_taskSet::is_external_id_Valid() const{
    return m_external_id_isValid;
}

QString OAIDeleteTaskSetResponse_taskSet::getStatus() const {
    return m_status;
}
void OAIDeleteTaskSetResponse_taskSet::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDeleteTaskSetResponse_taskSet::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDeleteTaskSetResponse_taskSet::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIDeleteTaskSetResponse_taskSet::getTaskDefinition() const {
    return m_task_definition;
}
void OAIDeleteTaskSetResponse_taskSet::setTaskDefinition(const QString &task_definition) {
    m_task_definition = task_definition;
    m_task_definition_isSet = true;
}

bool OAIDeleteTaskSetResponse_taskSet::is_task_definition_Set() const{
    return m_task_definition_isSet;
}

bool OAIDeleteTaskSetResponse_taskSet::is_task_definition_Valid() const{
    return m_task_definition_isValid;
}

qint32 OAIDeleteTaskSetResponse_taskSet::getComputedDesiredCount() const {
    return m_computed_desired_count;
}
void OAIDeleteTaskSetResponse_taskSet::setComputedDesiredCount(const qint32 &computed_desired_count) {
    m_computed_desired_count = computed_desired_count;
    m_computed_desired_count_isSet = true;
}

bool OAIDeleteTaskSetResponse_taskSet::is_computed_desired_count_Set() const{
    return m_computed_desired_count_isSet;
}

bool OAIDeleteTaskSetResponse_taskSet::is_computed_desired_count_Valid() const{
    return m_computed_desired_count_isValid;
}

qint32 OAIDeleteTaskSetResponse_taskSet::getPendingCount() const {
    return m_pending_count;
}
void OAIDeleteTaskSetResponse_taskSet::setPendingCount(const qint32 &pending_count) {
    m_pending_count = pending_count;
    m_pending_count_isSet = true;
}

bool OAIDeleteTaskSetResponse_taskSet::is_pending_count_Set() const{
    return m_pending_count_isSet;
}

bool OAIDeleteTaskSetResponse_taskSet::is_pending_count_Valid() const{
    return m_pending_count_isValid;
}

qint32 OAIDeleteTaskSetResponse_taskSet::getRunningCount() const {
    return m_running_count;
}
void OAIDeleteTaskSetResponse_taskSet::setRunningCount(const qint32 &running_count) {
    m_running_count = running_count;
    m_running_count_isSet = true;
}

bool OAIDeleteTaskSetResponse_taskSet::is_running_count_Set() const{
    return m_running_count_isSet;
}

bool OAIDeleteTaskSetResponse_taskSet::is_running_count_Valid() const{
    return m_running_count_isValid;
}

QDateTime OAIDeleteTaskSetResponse_taskSet::getCreatedAt() const {
    return m_created_at;
}
void OAIDeleteTaskSetResponse_taskSet::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIDeleteTaskSetResponse_taskSet::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIDeleteTaskSetResponse_taskSet::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QDateTime OAIDeleteTaskSetResponse_taskSet::getUpdatedAt() const {
    return m_updated_at;
}
void OAIDeleteTaskSetResponse_taskSet::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIDeleteTaskSetResponse_taskSet::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIDeleteTaskSetResponse_taskSet::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

OAILaunchType OAIDeleteTaskSetResponse_taskSet::getLaunchType() const {
    return m_launch_type;
}
void OAIDeleteTaskSetResponse_taskSet::setLaunchType(const OAILaunchType &launch_type) {
    m_launch_type = launch_type;
    m_launch_type_isSet = true;
}

bool OAIDeleteTaskSetResponse_taskSet::is_launch_type_Set() const{
    return m_launch_type_isSet;
}

bool OAIDeleteTaskSetResponse_taskSet::is_launch_type_Valid() const{
    return m_launch_type_isValid;
}

QList OAIDeleteTaskSetResponse_taskSet::getCapacityProviderStrategy() const {
    return m_capacity_provider_strategy;
}
void OAIDeleteTaskSetResponse_taskSet::setCapacityProviderStrategy(const QList &capacity_provider_strategy) {
    m_capacity_provider_strategy = capacity_provider_strategy;
    m_capacity_provider_strategy_isSet = true;
}

bool OAIDeleteTaskSetResponse_taskSet::is_capacity_provider_strategy_Set() const{
    return m_capacity_provider_strategy_isSet;
}

bool OAIDeleteTaskSetResponse_taskSet::is_capacity_provider_strategy_Valid() const{
    return m_capacity_provider_strategy_isValid;
}

QString OAIDeleteTaskSetResponse_taskSet::getPlatformVersion() const {
    return m_platform_version;
}
void OAIDeleteTaskSetResponse_taskSet::setPlatformVersion(const QString &platform_version) {
    m_platform_version = platform_version;
    m_platform_version_isSet = true;
}

bool OAIDeleteTaskSetResponse_taskSet::is_platform_version_Set() const{
    return m_platform_version_isSet;
}

bool OAIDeleteTaskSetResponse_taskSet::is_platform_version_Valid() const{
    return m_platform_version_isValid;
}

QString OAIDeleteTaskSetResponse_taskSet::getPlatformFamily() const {
    return m_platform_family;
}
void OAIDeleteTaskSetResponse_taskSet::setPlatformFamily(const QString &platform_family) {
    m_platform_family = platform_family;
    m_platform_family_isSet = true;
}

bool OAIDeleteTaskSetResponse_taskSet::is_platform_family_Set() const{
    return m_platform_family_isSet;
}

bool OAIDeleteTaskSetResponse_taskSet::is_platform_family_Valid() const{
    return m_platform_family_isValid;
}

OAITaskSet_networkConfiguration OAIDeleteTaskSetResponse_taskSet::getNetworkConfiguration() const {
    return m_network_configuration;
}
void OAIDeleteTaskSetResponse_taskSet::setNetworkConfiguration(const OAITaskSet_networkConfiguration &network_configuration) {
    m_network_configuration = network_configuration;
    m_network_configuration_isSet = true;
}

bool OAIDeleteTaskSetResponse_taskSet::is_network_configuration_Set() const{
    return m_network_configuration_isSet;
}

bool OAIDeleteTaskSetResponse_taskSet::is_network_configuration_Valid() const{
    return m_network_configuration_isValid;
}

QList OAIDeleteTaskSetResponse_taskSet::getLoadBalancers() const {
    return m_load_balancers;
}
void OAIDeleteTaskSetResponse_taskSet::setLoadBalancers(const QList &load_balancers) {
    m_load_balancers = load_balancers;
    m_load_balancers_isSet = true;
}

bool OAIDeleteTaskSetResponse_taskSet::is_load_balancers_Set() const{
    return m_load_balancers_isSet;
}

bool OAIDeleteTaskSetResponse_taskSet::is_load_balancers_Valid() const{
    return m_load_balancers_isValid;
}

QList OAIDeleteTaskSetResponse_taskSet::getServiceRegistries() const {
    return m_service_registries;
}
void OAIDeleteTaskSetResponse_taskSet::setServiceRegistries(const QList &service_registries) {
    m_service_registries = service_registries;
    m_service_registries_isSet = true;
}

bool OAIDeleteTaskSetResponse_taskSet::is_service_registries_Set() const{
    return m_service_registries_isSet;
}

bool OAIDeleteTaskSetResponse_taskSet::is_service_registries_Valid() const{
    return m_service_registries_isValid;
}

OAITaskSet_scale OAIDeleteTaskSetResponse_taskSet::getScale() const {
    return m_scale;
}
void OAIDeleteTaskSetResponse_taskSet::setScale(const OAITaskSet_scale &scale) {
    m_scale = scale;
    m_scale_isSet = true;
}

bool OAIDeleteTaskSetResponse_taskSet::is_scale_Set() const{
    return m_scale_isSet;
}

bool OAIDeleteTaskSetResponse_taskSet::is_scale_Valid() const{
    return m_scale_isValid;
}

OAIStabilityStatus OAIDeleteTaskSetResponse_taskSet::getStabilityStatus() const {
    return m_stability_status;
}
void OAIDeleteTaskSetResponse_taskSet::setStabilityStatus(const OAIStabilityStatus &stability_status) {
    m_stability_status = stability_status;
    m_stability_status_isSet = true;
}

bool OAIDeleteTaskSetResponse_taskSet::is_stability_status_Set() const{
    return m_stability_status_isSet;
}

bool OAIDeleteTaskSetResponse_taskSet::is_stability_status_Valid() const{
    return m_stability_status_isValid;
}

QDateTime OAIDeleteTaskSetResponse_taskSet::getStabilityStatusAt() const {
    return m_stability_status_at;
}
void OAIDeleteTaskSetResponse_taskSet::setStabilityStatusAt(const QDateTime &stability_status_at) {
    m_stability_status_at = stability_status_at;
    m_stability_status_at_isSet = true;
}

bool OAIDeleteTaskSetResponse_taskSet::is_stability_status_at_Set() const{
    return m_stability_status_at_isSet;
}

bool OAIDeleteTaskSetResponse_taskSet::is_stability_status_at_Valid() const{
    return m_stability_status_at_isValid;
}

QList OAIDeleteTaskSetResponse_taskSet::getTags() const {
    return m_tags;
}
void OAIDeleteTaskSetResponse_taskSet::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIDeleteTaskSetResponse_taskSet::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIDeleteTaskSetResponse_taskSet::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIDeleteTaskSetResponse_taskSet::isSet() const {
...
bool OAIDeleteTaskSetResponse_taskSet::isValid() const {
