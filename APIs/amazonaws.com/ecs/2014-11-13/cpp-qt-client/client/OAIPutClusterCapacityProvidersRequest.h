...
/*
 * OAIPutClusterCapacityProvidersRequest.h
 *
 * 
 */

#ifndef OAIPutClusterCapacityProvidersRequest_H
#define OAIPutClusterCapacityProvidersRequest_H
...
class OAIPutClusterCapacityProvidersRequest : public OAIObject {
public:
    OAIPutClusterCapacityProvidersRequest();
    OAIPutClusterCapacityProvidersRequest(QString json);
    ~OAIPutClusterCapacityProvidersRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutClusterCapacityProvidersRequest)

#endif // OAIPutClusterCapacityProvidersRequest_H
