...
/*
 * OAIDescribeTasksRequest.h
 *
 * 
 */

#ifndef OAIDescribeTasksRequest_H
#define OAIDescribeTasksRequest_H
...
class OAIDescribeTasksRequest : public OAIObject {
public:
    OAIDescribeTasksRequest();
    OAIDescribeTasksRequest(QString json);
    ~OAIDescribeTasksRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeTasksRequest)

#endif // OAIDescribeTasksRequest_H
