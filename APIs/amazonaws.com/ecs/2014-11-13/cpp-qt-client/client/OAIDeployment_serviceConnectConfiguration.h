...
/*
 * OAIDeployment_serviceConnectConfiguration.h
 *
 * 
 */

#ifndef OAIDeployment_serviceConnectConfiguration_H
#define OAIDeployment_serviceConnectConfiguration_H
...
class OAIDeployment_serviceConnectConfiguration : public OAIObject {
public:
    OAIDeployment_serviceConnectConfiguration();
    OAIDeployment_serviceConnectConfiguration(QString json);
    ~OAIDeployment_serviceConnectConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeployment_serviceConnectConfiguration)

#endif // OAIDeployment_serviceConnectConfiguration_H
