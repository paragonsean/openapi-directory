...
/*
 * OAIVolume_fsxWindowsFileServerVolumeConfiguration.h
 *
 * 
 */

#ifndef OAIVolume_fsxWindowsFileServerVolumeConfiguration_H
#define OAIVolume_fsxWindowsFileServerVolumeConfiguration_H
...
class OAIVolume_fsxWindowsFileServerVolumeConfiguration : public OAIObject {
public:
    OAIVolume_fsxWindowsFileServerVolumeConfiguration();
    OAIVolume_fsxWindowsFileServerVolumeConfiguration(QString json);
    ~OAIVolume_fsxWindowsFileServerVolumeConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVolume_fsxWindowsFileServerVolumeConfiguration)

#endif // OAIVolume_fsxWindowsFileServerVolumeConfiguration_H
