...
/*
 * OAIAutoScalingGroupProvider_managedScaling.h
 *
 * 
 */

#ifndef OAIAutoScalingGroupProvider_managedScaling_H
#define OAIAutoScalingGroupProvider_managedScaling_H
...
class OAIAutoScalingGroupProvider_managedScaling : public OAIObject {
public:
    OAIAutoScalingGroupProvider_managedScaling();
    OAIAutoScalingGroupProvider_managedScaling(QString json);
    ~OAIAutoScalingGroupProvider_managedScaling() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutoScalingGroupProvider_managedScaling)

#endif // OAIAutoScalingGroupProvider_managedScaling_H
