...
OAITaskSet::OAITaskSet(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITaskSet::OAITaskSet() {
    this->initializeModel();
}

OAITaskSet::~OAITaskSet() {}

void OAITaskSet::initializeModel() {
...
void OAITaskSet::fromJson(QString jsonString) {
...
void OAITaskSet::fromJsonObject(QJsonObject json) {
...
QString OAITaskSet::asJson() const {
...
QJsonObject OAITaskSet::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAITaskSet::getId() const {
    return m_id;
}
void OAITaskSet::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAITaskSet::is_id_Set() const{
    return m_id_isSet;
}

bool OAITaskSet::is_id_Valid() const{
    return m_id_isValid;
}

QString OAITaskSet::getTaskSetArn() const {
    return m_task_set_arn;
}
void OAITaskSet::setTaskSetArn(const QString &task_set_arn) {
    m_task_set_arn = task_set_arn;
    m_task_set_arn_isSet = true;
}

bool OAITaskSet::is_task_set_arn_Set() const{
    return m_task_set_arn_isSet;
}

bool OAITaskSet::is_task_set_arn_Valid() const{
    return m_task_set_arn_isValid;
}

QString OAITaskSet::getServiceArn() const {
    return m_service_arn;
}
void OAITaskSet::setServiceArn(const QString &service_arn) {
    m_service_arn = service_arn;
    m_service_arn_isSet = true;
}

bool OAITaskSet::is_service_arn_Set() const{
    return m_service_arn_isSet;
}

bool OAITaskSet::is_service_arn_Valid() const{
    return m_service_arn_isValid;
}

QString OAITaskSet::getClusterArn() const {
    return m_cluster_arn;
}
void OAITaskSet::setClusterArn(const QString &cluster_arn) {
    m_cluster_arn = cluster_arn;
    m_cluster_arn_isSet = true;
}

bool OAITaskSet::is_cluster_arn_Set() const{
    return m_cluster_arn_isSet;
}

bool OAITaskSet::is_cluster_arn_Valid() const{
    return m_cluster_arn_isValid;
}

QString OAITaskSet::getStartedBy() const {
    return m_started_by;
}
void OAITaskSet::setStartedBy(const QString &started_by) {
    m_started_by = started_by;
    m_started_by_isSet = true;
}

bool OAITaskSet::is_started_by_Set() const{
    return m_started_by_isSet;
}

bool OAITaskSet::is_started_by_Valid() const{
    return m_started_by_isValid;
}

QString OAITaskSet::getExternalId() const {
    return m_external_id;
}
void OAITaskSet::setExternalId(const QString &external_id) {
    m_external_id = external_id;
    m_external_id_isSet = true;
}

bool OAITaskSet::is_external_id_Set() const{
    return m_external_id_isSet;
}

bool OAITaskSet::is_external_id_Valid() const{
    return m_external_id_isValid;
}

QString OAITaskSet::getStatus() const {
    return m_status;
}
void OAITaskSet::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAITaskSet::is_status_Set() const{
    return m_status_isSet;
}

bool OAITaskSet::is_status_Valid() const{
    return m_status_isValid;
}

QString OAITaskSet::getTaskDefinition() const {
    return m_task_definition;
}
void OAITaskSet::setTaskDefinition(const QString &task_definition) {
    m_task_definition = task_definition;
    m_task_definition_isSet = true;
}

bool OAITaskSet::is_task_definition_Set() const{
    return m_task_definition_isSet;
}

bool OAITaskSet::is_task_definition_Valid() const{
    return m_task_definition_isValid;
}

qint32 OAITaskSet::getComputedDesiredCount() const {
    return m_computed_desired_count;
}
void OAITaskSet::setComputedDesiredCount(const qint32 &computed_desired_count) {
    m_computed_desired_count = computed_desired_count;
    m_computed_desired_count_isSet = true;
}

bool OAITaskSet::is_computed_desired_count_Set() const{
    return m_computed_desired_count_isSet;
}

bool OAITaskSet::is_computed_desired_count_Valid() const{
    return m_computed_desired_count_isValid;
}

qint32 OAITaskSet::getPendingCount() const {
    return m_pending_count;
}
void OAITaskSet::setPendingCount(const qint32 &pending_count) {
    m_pending_count = pending_count;
    m_pending_count_isSet = true;
}

bool OAITaskSet::is_pending_count_Set() const{
    return m_pending_count_isSet;
}

bool OAITaskSet::is_pending_count_Valid() const{
    return m_pending_count_isValid;
}

qint32 OAITaskSet::getRunningCount() const {
    return m_running_count;
}
void OAITaskSet::setRunningCount(const qint32 &running_count) {
    m_running_count = running_count;
    m_running_count_isSet = true;
}

bool OAITaskSet::is_running_count_Set() const{
    return m_running_count_isSet;
}

bool OAITaskSet::is_running_count_Valid() const{
    return m_running_count_isValid;
}

QDateTime OAITaskSet::getCreatedAt() const {
    return m_created_at;
}
void OAITaskSet::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAITaskSet::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAITaskSet::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QDateTime OAITaskSet::getUpdatedAt() const {
    return m_updated_at;
}
void OAITaskSet::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAITaskSet::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAITaskSet::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

OAILaunchType OAITaskSet::getLaunchType() const {
    return m_launch_type;
}
void OAITaskSet::setLaunchType(const OAILaunchType &launch_type) {
    m_launch_type = launch_type;
    m_launch_type_isSet = true;
}

bool OAITaskSet::is_launch_type_Set() const{
    return m_launch_type_isSet;
}

bool OAITaskSet::is_launch_type_Valid() const{
    return m_launch_type_isValid;
}

QList OAITaskSet::getCapacityProviderStrategy() const {
    return m_capacity_provider_strategy;
}
void OAITaskSet::setCapacityProviderStrategy(const QList &capacity_provider_strategy) {
    m_capacity_provider_strategy = capacity_provider_strategy;
    m_capacity_provider_strategy_isSet = true;
}

bool OAITaskSet::is_capacity_provider_strategy_Set() const{
    return m_capacity_provider_strategy_isSet;
}

bool OAITaskSet::is_capacity_provider_strategy_Valid() const{
    return m_capacity_provider_strategy_isValid;
}

QString OAITaskSet::getPlatformVersion() const {
    return m_platform_version;
}
void OAITaskSet::setPlatformVersion(const QString &platform_version) {
    m_platform_version = platform_version;
    m_platform_version_isSet = true;
}

bool OAITaskSet::is_platform_version_Set() const{
    return m_platform_version_isSet;
}

bool OAITaskSet::is_platform_version_Valid() const{
    return m_platform_version_isValid;
}

QString OAITaskSet::getPlatformFamily() const {
    return m_platform_family;
}
void OAITaskSet::setPlatformFamily(const QString &platform_family) {
    m_platform_family = platform_family;
    m_platform_family_isSet = true;
}

bool OAITaskSet::is_platform_family_Set() const{
    return m_platform_family_isSet;
}

bool OAITaskSet::is_platform_family_Valid() const{
    return m_platform_family_isValid;
}

OAITaskSet_networkConfiguration OAITaskSet::getNetworkConfiguration() const {
    return m_network_configuration;
}
void OAITaskSet::setNetworkConfiguration(const OAITaskSet_networkConfiguration &network_configuration) {
    m_network_configuration = network_configuration;
    m_network_configuration_isSet = true;
}

bool OAITaskSet::is_network_configuration_Set() const{
    return m_network_configuration_isSet;
}

bool OAITaskSet::is_network_configuration_Valid() const{
    return m_network_configuration_isValid;
}

QList OAITaskSet::getLoadBalancers() const {
    return m_load_balancers;
}
void OAITaskSet::setLoadBalancers(const QList &load_balancers) {
    m_load_balancers = load_balancers;
    m_load_balancers_isSet = true;
}

bool OAITaskSet::is_load_balancers_Set() const{
    return m_load_balancers_isSet;
}

bool OAITaskSet::is_load_balancers_Valid() const{
    return m_load_balancers_isValid;
}

QList OAITaskSet::getServiceRegistries() const {
    return m_service_registries;
}
void OAITaskSet::setServiceRegistries(const QList &service_registries) {
    m_service_registries = service_registries;
    m_service_registries_isSet = true;
}

bool OAITaskSet::is_service_registries_Set() const{
    return m_service_registries_isSet;
}

bool OAITaskSet::is_service_registries_Valid() const{
    return m_service_registries_isValid;
}

OAITaskSet_scale OAITaskSet::getScale() const {
    return m_scale;
}
void OAITaskSet::setScale(const OAITaskSet_scale &scale) {
    m_scale = scale;
    m_scale_isSet = true;
}

bool OAITaskSet::is_scale_Set() const{
    return m_scale_isSet;
}

bool OAITaskSet::is_scale_Valid() const{
    return m_scale_isValid;
}

OAIStabilityStatus OAITaskSet::getStabilityStatus() const {
    return m_stability_status;
}
void OAITaskSet::setStabilityStatus(const OAIStabilityStatus &stability_status) {
    m_stability_status = stability_status;
    m_stability_status_isSet = true;
}

bool OAITaskSet::is_stability_status_Set() const{
    return m_stability_status_isSet;
}

bool OAITaskSet::is_stability_status_Valid() const{
    return m_stability_status_isValid;
}

QDateTime OAITaskSet::getStabilityStatusAt() const {
    return m_stability_status_at;
}
void OAITaskSet::setStabilityStatusAt(const QDateTime &stability_status_at) {
    m_stability_status_at = stability_status_at;
    m_stability_status_at_isSet = true;
}

bool OAITaskSet::is_stability_status_at_Set() const{
    return m_stability_status_at_isSet;
}

bool OAITaskSet::is_stability_status_at_Valid() const{
    return m_stability_status_at_isValid;
}

QList OAITaskSet::getTags() const {
    return m_tags;
}
void OAITaskSet::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAITaskSet::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAITaskSet::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAITaskSet::isSet() const {
