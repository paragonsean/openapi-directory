...
/*
 * OAIDeregisterContainerInstanceResponse_containerInstance.h
 *
 * 
 */

#ifndef OAIDeregisterContainerInstanceResponse_containerInstance_H
#define OAIDeregisterContainerInstanceResponse_containerInstance_H
...
class OAIDeregisterContainerInstanceResponse_containerInstance : public OAIObject {
public:
    OAIDeregisterContainerInstanceResponse_containerInstance();
    OAIDeregisterContainerInstanceResponse_containerInstance(QString json);
    ~OAIDeregisterContainerInstanceResponse_containerInstance() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeregisterContainerInstanceResponse_containerInstance)

#endif // OAIDeregisterContainerInstanceResponse_containerInstance_H
