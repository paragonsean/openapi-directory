...
#include "OAICreateTaskSetResponse_taskSet.h"
...
OAICreateTaskSetResponse_taskSet::OAICreateTaskSetResponse_taskSet(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateTaskSetResponse_taskSet::OAICreateTaskSetResponse_taskSet() {
    this->initializeModel();
}

OAICreateTaskSetResponse_taskSet::~OAICreateTaskSetResponse_taskSet() {}

void OAICreateTaskSetResponse_taskSet::initializeModel() {
...
void OAICreateTaskSetResponse_taskSet::fromJson(QString jsonString) {
...
void OAICreateTaskSetResponse_taskSet::fromJsonObject(QJsonObject json) {
...
QString OAICreateTaskSetResponse_taskSet::asJson() const {
...
QJsonObject OAICreateTaskSetResponse_taskSet::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAICreateTaskSetResponse_taskSet::getId() const {
    return m_id;
}
void OAICreateTaskSetResponse_taskSet::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICreateTaskSetResponse_taskSet::is_id_Set() const{
    return m_id_isSet;
}

bool OAICreateTaskSetResponse_taskSet::is_id_Valid() const{
    return m_id_isValid;
}

QString OAICreateTaskSetResponse_taskSet::getTaskSetArn() const {
    return m_task_set_arn;
}
void OAICreateTaskSetResponse_taskSet::setTaskSetArn(const QString &task_set_arn) {
    m_task_set_arn = task_set_arn;
    m_task_set_arn_isSet = true;
}

bool OAICreateTaskSetResponse_taskSet::is_task_set_arn_Set() const{
    return m_task_set_arn_isSet;
}

bool OAICreateTaskSetResponse_taskSet::is_task_set_arn_Valid() const{
    return m_task_set_arn_isValid;
}

QString OAICreateTaskSetResponse_taskSet::getServiceArn() const {
    return m_service_arn;
}
void OAICreateTaskSetResponse_taskSet::setServiceArn(const QString &service_arn) {
    m_service_arn = service_arn;
    m_service_arn_isSet = true;
}

bool OAICreateTaskSetResponse_taskSet::is_service_arn_Set() const{
    return m_service_arn_isSet;
}

bool OAICreateTaskSetResponse_taskSet::is_service_arn_Valid() const{
    return m_service_arn_isValid;
}

QString OAICreateTaskSetResponse_taskSet::getClusterArn() const {
    return m_cluster_arn;
}
void OAICreateTaskSetResponse_taskSet::setClusterArn(const QString &cluster_arn) {
    m_cluster_arn = cluster_arn;
    m_cluster_arn_isSet = true;
}

bool OAICreateTaskSetResponse_taskSet::is_cluster_arn_Set() const{
    return m_cluster_arn_isSet;
}

bool OAICreateTaskSetResponse_taskSet::is_cluster_arn_Valid() const{
    return m_cluster_arn_isValid;
}

QString OAICreateTaskSetResponse_taskSet::getStartedBy() const {
    return m_started_by;
}
void OAICreateTaskSetResponse_taskSet::setStartedBy(const QString &started_by) {
    m_started_by = started_by;
    m_started_by_isSet = true;
}

bool OAICreateTaskSetResponse_taskSet::is_started_by_Set() const{
    return m_started_by_isSet;
}

bool OAICreateTaskSetResponse_taskSet::is_started_by_Valid() const{
    return m_started_by_isValid;
}

QString OAICreateTaskSetResponse_taskSet::getExternalId() const {
    return m_external_id;
}
void OAICreateTaskSetResponse_taskSet::setExternalId(const QString &external_id) {
    m_external_id = external_id;
    m_external_id_isSet = true;
}

bool OAICreateTaskSetResponse_taskSet::is_external_id_Set() const{
    return m_external_id_isSet;
}

bool OAICreateTaskSetResponse_taskSet::is_external_id_Valid() const{
    return m_external_id_isValid;
}

QString OAICreateTaskSetResponse_taskSet::getStatus() const {
    return m_status;
}
void OAICreateTaskSetResponse_taskSet::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICreateTaskSetResponse_taskSet::is_status_Set() const{
    return m_status_isSet;
}

bool OAICreateTaskSetResponse_taskSet::is_status_Valid() const{
    return m_status_isValid;
}

QString OAICreateTaskSetResponse_taskSet::getTaskDefinition() const {
    return m_task_definition;
}
void OAICreateTaskSetResponse_taskSet::setTaskDefinition(const QString &task_definition) {
    m_task_definition = task_definition;
    m_task_definition_isSet = true;
}

bool OAICreateTaskSetResponse_taskSet::is_task_definition_Set() const{
    return m_task_definition_isSet;
}

bool OAICreateTaskSetResponse_taskSet::is_task_definition_Valid() const{
    return m_task_definition_isValid;
}

qint32 OAICreateTaskSetResponse_taskSet::getComputedDesiredCount() const {
    return m_computed_desired_count;
}
void OAICreateTaskSetResponse_taskSet::setComputedDesiredCount(const qint32 &computed_desired_count) {
    m_computed_desired_count = computed_desired_count;
    m_computed_desired_count_isSet = true;
}

bool OAICreateTaskSetResponse_taskSet::is_computed_desired_count_Set() const{
    return m_computed_desired_count_isSet;
}

bool OAICreateTaskSetResponse_taskSet::is_computed_desired_count_Valid() const{
    return m_computed_desired_count_isValid;
}

qint32 OAICreateTaskSetResponse_taskSet::getPendingCount() const {
    return m_pending_count;
}
void OAICreateTaskSetResponse_taskSet::setPendingCount(const qint32 &pending_count) {
    m_pending_count = pending_count;
    m_pending_count_isSet = true;
}

bool OAICreateTaskSetResponse_taskSet::is_pending_count_Set() const{
    return m_pending_count_isSet;
}

bool OAICreateTaskSetResponse_taskSet::is_pending_count_Valid() const{
    return m_pending_count_isValid;
}

qint32 OAICreateTaskSetResponse_taskSet::getRunningCount() const {
    return m_running_count;
}
void OAICreateTaskSetResponse_taskSet::setRunningCount(const qint32 &running_count) {
    m_running_count = running_count;
    m_running_count_isSet = true;
}

bool OAICreateTaskSetResponse_taskSet::is_running_count_Set() const{
    return m_running_count_isSet;
}

bool OAICreateTaskSetResponse_taskSet::is_running_count_Valid() const{
    return m_running_count_isValid;
}

QDateTime OAICreateTaskSetResponse_taskSet::getCreatedAt() const {
    return m_created_at;
}
void OAICreateTaskSetResponse_taskSet::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAICreateTaskSetResponse_taskSet::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAICreateTaskSetResponse_taskSet::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QDateTime OAICreateTaskSetResponse_taskSet::getUpdatedAt() const {
    return m_updated_at;
}
void OAICreateTaskSetResponse_taskSet::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAICreateTaskSetResponse_taskSet::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAICreateTaskSetResponse_taskSet::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

OAILaunchType OAICreateTaskSetResponse_taskSet::getLaunchType() const {
    return m_launch_type;
}
void OAICreateTaskSetResponse_taskSet::setLaunchType(const OAILaunchType &launch_type) {
    m_launch_type = launch_type;
    m_launch_type_isSet = true;
}

bool OAICreateTaskSetResponse_taskSet::is_launch_type_Set() const{
    return m_launch_type_isSet;
}

bool OAICreateTaskSetResponse_taskSet::is_launch_type_Valid() const{
    return m_launch_type_isValid;
}

QList OAICreateTaskSetResponse_taskSet::getCapacityProviderStrategy() const {
    return m_capacity_provider_strategy;
}
void OAICreateTaskSetResponse_taskSet::setCapacityProviderStrategy(const QList &capacity_provider_strategy) {
    m_capacity_provider_strategy = capacity_provider_strategy;
    m_capacity_provider_strategy_isSet = true;
}

bool OAICreateTaskSetResponse_taskSet::is_capacity_provider_strategy_Set() const{
    return m_capacity_provider_strategy_isSet;
}

bool OAICreateTaskSetResponse_taskSet::is_capacity_provider_strategy_Valid() const{
    return m_capacity_provider_strategy_isValid;
}

QString OAICreateTaskSetResponse_taskSet::getPlatformVersion() const {
    return m_platform_version;
}
void OAICreateTaskSetResponse_taskSet::setPlatformVersion(const QString &platform_version) {
    m_platform_version = platform_version;
    m_platform_version_isSet = true;
}

bool OAICreateTaskSetResponse_taskSet::is_platform_version_Set() const{
    return m_platform_version_isSet;
}

bool OAICreateTaskSetResponse_taskSet::is_platform_version_Valid() const{
    return m_platform_version_isValid;
}

QString OAICreateTaskSetResponse_taskSet::getPlatformFamily() const {
    return m_platform_family;
}
void OAICreateTaskSetResponse_taskSet::setPlatformFamily(const QString &platform_family) {
    m_platform_family = platform_family;
    m_platform_family_isSet = true;
}

bool OAICreateTaskSetResponse_taskSet::is_platform_family_Set() const{
    return m_platform_family_isSet;
}

bool OAICreateTaskSetResponse_taskSet::is_platform_family_Valid() const{
    return m_platform_family_isValid;
}

OAITaskSet_networkConfiguration OAICreateTaskSetResponse_taskSet::getNetworkConfiguration() const {
    return m_network_configuration;
}
void OAICreateTaskSetResponse_taskSet::setNetworkConfiguration(const OAITaskSet_networkConfiguration &network_configuration) {
    m_network_configuration = network_configuration;
    m_network_configuration_isSet = true;
}

bool OAICreateTaskSetResponse_taskSet::is_network_configuration_Set() const{
    return m_network_configuration_isSet;
}

bool OAICreateTaskSetResponse_taskSet::is_network_configuration_Valid() const{
    return m_network_configuration_isValid;
}

QList OAICreateTaskSetResponse_taskSet::getLoadBalancers() const {
    return m_load_balancers;
}
void OAICreateTaskSetResponse_taskSet::setLoadBalancers(const QList &load_balancers) {
    m_load_balancers = load_balancers;
    m_load_balancers_isSet = true;
}

bool OAICreateTaskSetResponse_taskSet::is_load_balancers_Set() const{
    return m_load_balancers_isSet;
}

bool OAICreateTaskSetResponse_taskSet::is_load_balancers_Valid() const{
    return m_load_balancers_isValid;
}

QList OAICreateTaskSetResponse_taskSet::getServiceRegistries() const {
    return m_service_registries;
}
void OAICreateTaskSetResponse_taskSet::setServiceRegistries(const QList &service_registries) {
    m_service_registries = service_registries;
    m_service_registries_isSet = true;
}

bool OAICreateTaskSetResponse_taskSet::is_service_registries_Set() const{
    return m_service_registries_isSet;
}

bool OAICreateTaskSetResponse_taskSet::is_service_registries_Valid() const{
    return m_service_registries_isValid;
}

OAITaskSet_scale OAICreateTaskSetResponse_taskSet::getScale() const {
    return m_scale;
}
void OAICreateTaskSetResponse_taskSet::setScale(const OAITaskSet_scale &scale) {
    m_scale = scale;
    m_scale_isSet = true;
}

bool OAICreateTaskSetResponse_taskSet::is_scale_Set() const{
    return m_scale_isSet;
}

bool OAICreateTaskSetResponse_taskSet::is_scale_Valid() const{
    return m_scale_isValid;
}

OAIStabilityStatus OAICreateTaskSetResponse_taskSet::getStabilityStatus() const {
    return m_stability_status;
}
void OAICreateTaskSetResponse_taskSet::setStabilityStatus(const OAIStabilityStatus &stability_status) {
    m_stability_status = stability_status;
    m_stability_status_isSet = true;
}

bool OAICreateTaskSetResponse_taskSet::is_stability_status_Set() const{
    return m_stability_status_isSet;
}

bool OAICreateTaskSetResponse_taskSet::is_stability_status_Valid() const{
    return m_stability_status_isValid;
}

QDateTime OAICreateTaskSetResponse_taskSet::getStabilityStatusAt() const {
    return m_stability_status_at;
}
void OAICreateTaskSetResponse_taskSet::setStabilityStatusAt(const QDateTime &stability_status_at) {
    m_stability_status_at = stability_status_at;
    m_stability_status_at_isSet = true;
}

bool OAICreateTaskSetResponse_taskSet::is_stability_status_at_Set() const{
    return m_stability_status_at_isSet;
}

bool OAICreateTaskSetResponse_taskSet::is_stability_status_at_Valid() const{
    return m_stability_status_at_isValid;
}

QList OAICreateTaskSetResponse_taskSet::getTags() const {
    return m_tags;
}
void OAICreateTaskSetResponse_taskSet::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateTaskSetResponse_taskSet::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateTaskSetResponse_taskSet::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAICreateTaskSetResponse_taskSet::isSet() const {
...
bool OAICreateTaskSetResponse_taskSet::isValid() const {
