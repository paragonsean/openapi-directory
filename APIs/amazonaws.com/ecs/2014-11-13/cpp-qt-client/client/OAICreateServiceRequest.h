...
class OAICreateServiceRequest_deploymentController;
...
public:
    ...
    OAICreateServiceRequest_deploymentController getDeploymentController() const;
    void setDeploymentController(const OAICreateServiceRequest_deploymentController &deployment_controller);
...
private:
    ...
    OAICreateServiceRequest_deploymentController m_deployment_controller;
