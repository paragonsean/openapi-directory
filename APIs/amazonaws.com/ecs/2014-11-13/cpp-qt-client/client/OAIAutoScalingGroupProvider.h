...
/*
 * OAIAutoScalingGroupProvider.h
 *
 * The details of the Auto Scaling group for the capacity provider.
 */

#ifndef OAIAutoScalingGroupProvider_H
#define OAIAutoScalingGroupProvider_H

#include <QJsonObject>

#include "OAIAutoScalingGroupProvider_managedScaling.h"
...
namespace OpenAPI {
class OAIAutoScalingGroupProvider_managedScaling;

class OAIAutoScalingGroupProvider : public OAIObject {
public:
    OAIAutoScalingGroupProvider();
    OAIAutoScalingGroupProvider(QString json);
    ~OAIAutoScalingGroupProvider() override;
    ...
    OAIAutoScalingGroupProvider_managedScaling getManagedScaling() const;
    void setManagedScaling(const OAIAutoScalingGroupProvider_managedScaling &managed_scaling);
...
private:
    ...
    OAIAutoScalingGroupProvider_managedScaling m_managed_scaling;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutoScalingGroupProvider)

#endif // OAIAutoScalingGroupProvider_H
