...
QList OAIHealthCheck::getCommand() const {
    return m_command;
}
void OAIHealthCheck::setCommand(const QList &command) {
    m_command = command;
    m_command_isSet = true;
}

bool OAIHealthCheck::is_command_Set() const{
    return m_command_isSet;
}

bool OAIHealthCheck::is_command_Valid() const{
...
qint32 OAIHealthCheck::getRetries() const {
    return m_retries;
}
void OAIHealthCheck::setRetries(const qint32 &retries) {
    m_retries = retries;
    m_retries_isSet = true;
}

bool OAIHealthCheck::is_retries_Set() const{
    return m_retries_isSet;
}

bool OAIHealthCheck::is_retries_Valid() const{
    return m_retries_isValid;
}

qint32 OAIHealthCheck::getStartPeriod() const {
    return m_start_period;
}
void OAIHealthCheck::setStartPeriod(const qint32 &start_period) {
    m_start_period = start_period;
    m_start_period_isSet = true;
}

bool OAIHealthCheck::is_start_period_Set() const{
    return m_start_period_isSet;
}

bool OAIHealthCheck::is_start_period_Valid() const{
