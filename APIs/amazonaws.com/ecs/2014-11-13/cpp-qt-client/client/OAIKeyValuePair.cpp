...
QString OAIKeyValuePair::getName() const {
    return m_name;
}
void OAIKeyValuePair::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIKeyValuePair::is_name_Set() const{
    return m_name_isSet;
}

bool OAIKeyValuePair::is_name_Valid() const{
