...
#ifndef OAITaskOverride_H
#define OAITaskOverride_H
...
class OAITaskOverride : public OAIObject {
public:
    OAITaskOverride();
    OAITaskOverride(QString json);
    ~OAITaskOverride() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskOverride)

#endif // OAITaskOverride_H
