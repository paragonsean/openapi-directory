...
QString OAISession::getStreamUrl() const {
    return m_stream_url;
}
void OAISession::setStreamUrl(const QString &stream_url) {
    m_stream_url = stream_url;
    m_stream_url_isSet = true;
}

bool OAISession::is_stream_url_Set() const{
    return m_stream_url_isSet;
}

bool OAISession::is_stream_url_Valid() const{
    return m_stream_url_isValid;
}

QString OAISession::getTokenValue() const {
    return m_token_value;
}
void OAISession::setTokenValue(const QString &token_value) {
    m_token_value = token_value;
    m_token_value_isSet = true;
}

bool OAISession::is_token_value_Set() const{
    return m_token_value_isSet;
}

bool OAISession::is_token_value_Valid() const{
