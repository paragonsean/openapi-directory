...
OAIDeploymentConfiguration_deploymentCircuitBreaker OAIDeploymentConfiguration::getDeploymentCircuitBreaker() const {
    return m_deployment_circuit_breaker;
}
void OAIDeploymentConfiguration::setDeploymentCircuitBreaker(const OAIDeploymentConfiguration_deploymentCircuitBreaker &deployment_circuit_breaker) {
    m_deployment_circuit_breaker = deployment_circuit_breaker;
    m_deployment_circuit_breaker_isSet = true;
}

bool OAIDeploymentConfiguration::is_deployment_circuit_breaker_Set() const{
    return m_deployment_circuit_breaker_isSet;
}

bool OAIDeploymentConfiguration::is_deployment_circuit_breaker_Valid() const{
    return m_deployment_circuit_breaker_isValid;
}

qint32 OAIDeploymentConfiguration::getMaximumPercent() const {
    return m_maximum_percent;
}
void OAIDeploymentConfiguration::setMaximumPercent(const qint32 &maximum_percent) {
    m_maximum_percent = maximum_percent;
    m_maximum_percent_isSet = true;
}

bool OAIDeploymentConfiguration::is_maximum_percent_Set() const{
    return m_maximum_percent_isSet;
}

bool OAIDeploymentConfiguration::is_maximum_percent_Valid() const{
    return m_maximum_percent_isValid;
}

qint32 OAIDeploymentConfiguration::getMinimumHealthyPercent() const {
    return m_minimum_healthy_percent;
}
void OAIDeploymentConfiguration::setMinimumHealthyPercent(const qint32 &minimum_healthy_percent) {
    m_minimum_healthy_percent = minimum_healthy_percent;
    m_minimum_healthy_percent_isSet = true;
}

bool OAIDeploymentConfiguration::is_minimum_healthy_percent_Set() const{
    return m_minimum_healthy_percent_isSet;
}

bool OAIDeploymentConfiguration::is_minimum_healthy_percent_Valid() const{
    return m_minimum_healthy_percent_isValid;
}

OAIDeploymentConfiguration_alarms OAIDeploymentConfiguration::getAlarms() const {
    return m_alarms;
}
void OAIDeploymentConfiguration::setAlarms(const OAIDeploymentConfiguration_alarms &alarms) {
    m_alarms = alarms;
    m_alarms_isSet = true;
}

bool OAIDeploymentConfiguration::is_alarms_Set() const{
    return m_alarms_isSet;
}

bool OAIDeploymentConfiguration::is_alarms_Valid() const{
