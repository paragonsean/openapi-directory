...
#include "OAIEFSVolumeConfiguration.h"
...
OAIEFSVolumeConfiguration::OAIEFSVolumeConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEFSVolumeConfiguration::OAIEFSVolumeConfiguration() {
    this->initializeModel();
}

OAIEFSVolumeConfiguration::~OAIEFSVolumeConfiguration() {}

void OAIEFSVolumeConfiguration::initializeModel() {
...
void OAIEFSVolumeConfiguration::fromJson(QString jsonString) {
...
void OAIEFSVolumeConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIEFSVolumeConfiguration::asJson() const {
...
QJsonObject OAIEFSVolumeConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAIEFSVolumeConfiguration::getFileSystemId() const {
    return m_file_system_id;
}
void OAIEFSVolumeConfiguration::setFileSystemId(const QString &file_system_id) {
    m_file_system_id = file_system_id;
    m_file_system_id_isSet = true;
}

bool OAIEFSVolumeConfiguration::is_file_system_id_Set() const{
    return m_file_system_id_isSet;
}

bool OAIEFSVolumeConfiguration::is_file_system_id_Valid() const{
    return m_file_system_id_isValid;
}

QString OAIEFSVolumeConfiguration::getRootDirectory() const {
    return m_root_directory;
}
void OAIEFSVolumeConfiguration::setRootDirectory(const QString &root_directory) {
    m_root_directory = root_directory;
    m_root_directory_isSet = true;
}

bool OAIEFSVolumeConfiguration::is_root_directory_Set() const{
    return m_root_directory_isSet;
}

bool OAIEFSVolumeConfiguration::is_root_directory_Valid() const{
    return m_root_directory_isValid;
}

OAIEFSTransitEncryption OAIEFSVolumeConfiguration::getTransitEncryption() const {
    return m_transit_encryption;
}
void OAIEFSVolumeConfiguration::setTransitEncryption(const OAIEFSTransitEncryption &transit_encryption) {
    m_transit_encryption = transit_encryption;
    m_transit_encryption_isSet = true;
}

bool OAIEFSVolumeConfiguration::is_transit_encryption_Set() const{
    return m_transit_encryption_isSet;
}

bool OAIEFSVolumeConfiguration::is_transit_encryption_Valid() const{
    return m_transit_encryption_isValid;
}

qint32 OAIEFSVolumeConfiguration::getTransitEncryptionPort() const {
    return m_transit_encryption_port;
}
void OAIEFSVolumeConfiguration::setTransitEncryptionPort(const qint32 &transit_encryption_port) {
    m_transit_encryption_port = transit_encryption_port;
    m_transit_encryption_port_isSet = true;
}

bool OAIEFSVolumeConfiguration::is_transit_encryption_port_Set() const{
    return m_transit_encryption_port_isSet;
}

bool OAIEFSVolumeConfiguration::is_transit_encryption_port_Valid() const{
    return m_transit_encryption_port_isValid;
}

OAIEFSVolumeConfiguration_authorizationConfig OAIEFSVolumeConfiguration::getAuthorizationConfig() const {
    return m_authorization_config;
}
void OAIEFSVolumeConfiguration::setAuthorizationConfig(const OAIEFSVolumeConfiguration_authorizationConfig &authorization_config) {
    m_authorization_config = authorization_config;
    m_authorization_config_isSet = true;
}

bool OAIEFSVolumeConfiguration::is_authorization_config_Set() const{
    return m_authorization_config_isSet;
}

bool OAIEFSVolumeConfiguration::is_authorization_config_Valid() const{
    return m_authorization_config_isValid;
}

bool OAIEFSVolumeConfiguration::isSet() const {
...
bool OAIEFSVolumeConfiguration::isValid() const {
