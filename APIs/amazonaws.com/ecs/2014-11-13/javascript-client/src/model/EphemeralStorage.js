...
/**
 * The EphemeralStorage model module.
 * @module model/EphemeralStorage
 * @version 2014-11-13
 */
class EphemeralStorage {
    /**
     * Constructs a new <code>EphemeralStorage</code>.
     ...
     * @alias module:model/EphemeralStorage
    ...
    /**
     * Constructs a <code>EphemeralStorage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EphemeralStorage} obj Optional instance to populate.
     * @return {module:model/EphemeralStorage} The populated <code>EphemeralStorage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EphemeralStorage();
    ...
    /**
     * Validates the JSON data with respect to <code>EphemeralStorage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EphemeralStorage</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EphemeralStorage.RequiredProperties) {
...
EphemeralStorage.RequiredProperties = ["sizeInGiB"];
