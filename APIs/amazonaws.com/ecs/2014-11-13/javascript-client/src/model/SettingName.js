...
* @readonly
*/
export default class SettingName {
        ...
        /**
         * value: "tagResourceAuthorization"
         * @const
         */
    ...
    /**
    * Returns a <code>SettingName</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SettingName} The enum <code>SettingName</code> value.
    */
