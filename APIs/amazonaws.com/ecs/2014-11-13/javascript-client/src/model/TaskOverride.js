...
/**
 * The TaskOverride model module.
 * @module model/TaskOverride
 * @version 2014-11-13
 */
class TaskOverride {
    /**
     * Constructs a new <code>TaskOverride</code>.
     * The overrides that are associated with a task.
     * @alias module:model/TaskOverride
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>TaskOverride</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TaskOverride} obj Optional instance to populate.
     * @return {module:model/TaskOverride} The populated <code>TaskOverride</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TaskOverride();
    ...
    /**
     * Validates the JSON data with respect to <code>TaskOverride</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TaskOverride</code>.
     */
