...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.ListTasksRequest();
  });
  ...
  describe('ListTasksRequest', function() {
    it('should create an instance of ListTasksRequest', function() {
      // uncomment below and update the code to test ListTasksRequest
      //var instance = new AmazonEc2ContainerService.ListTasksRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerService.ListTasksRequest);
    });
