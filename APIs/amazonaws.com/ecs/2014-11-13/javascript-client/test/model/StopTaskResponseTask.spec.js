...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.StopTaskResponseTask();
  });
  ...
  describe('StopTaskResponseTask', function() {
    it('should create an instance of StopTaskResponseTask', function() {
      // uncomment below and update the code to test StopTaskResponseTask
      //var instance = new AmazonEc2ContainerService.StopTaskResponseTask();
      //expect(instance).to.be.a(AmazonEc2ContainerService.StopTaskResponseTask);
    });
