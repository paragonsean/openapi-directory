...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.DescribeTaskSetsRequest();
  });
  ...
  describe('DescribeTaskSetsRequest', function() {
    it('should create an instance of DescribeTaskSetsRequest', function() {
      // uncomment below and update the code to test DescribeTaskSetsRequest
      //var instance = new AmazonEc2ContainerService.DescribeTaskSetsRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerService.DescribeTaskSetsRequest);
    });
