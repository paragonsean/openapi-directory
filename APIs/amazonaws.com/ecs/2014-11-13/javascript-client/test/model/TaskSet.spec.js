...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.TaskSet();
  });
  ...
  describe('TaskSet', function() {
    it('should create an instance of TaskSet', function() {
      // uncomment below and update the code to test TaskSet
      //var instance = new AmazonEc2ContainerService.TaskSet();
      //expect(instance).to.be.a(AmazonEc2ContainerService.TaskSet);
    });
