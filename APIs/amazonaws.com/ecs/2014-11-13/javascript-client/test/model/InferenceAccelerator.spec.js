...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.InferenceAccelerator();
  });
  ...
  describe('InferenceAccelerator', function() {
    it('should create an instance of InferenceAccelerator', function() {
      // uncomment below and update the code to test InferenceAccelerator
      //var instance = new AmazonEc2ContainerService.InferenceAccelerator();
      //expect(instance).to.be.a(AmazonEc2ContainerService.InferenceAccelerator);
    });
