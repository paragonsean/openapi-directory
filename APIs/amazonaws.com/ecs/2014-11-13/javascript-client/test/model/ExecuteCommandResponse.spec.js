...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.ExecuteCommandResponse();
  });
  ...
  describe('ExecuteCommandResponse', function() {
    it('should create an instance of ExecuteCommandResponse', function() {
      // uncomment below and update the code to test ExecuteCommandResponse
      //var instance = new AmazonEc2ContainerService.ExecuteCommandResponse();
      //expect(instance).to.be.a(AmazonEc2ContainerService.ExecuteCommandResponse);
    });
