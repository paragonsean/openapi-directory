...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.RegisterTaskDefinitionRequest();
  });
  ...
  describe('RegisterTaskDefinitionRequest', function() {
    it('should create an instance of RegisterTaskDefinitionRequest', function() {
      // uncomment below and update the code to test RegisterTaskDefinitionRequest
      //var instance = new AmazonEc2ContainerService.RegisterTaskDefinitionRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerService.RegisterTaskDefinitionRequest);
    });
