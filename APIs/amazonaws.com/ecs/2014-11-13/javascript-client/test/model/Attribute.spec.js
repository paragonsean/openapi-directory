...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.Attribute();
  });
  ...
  describe('Attribute', function() {
    it('should create an instance of Attribute', function() {
      ...
      //var instance = new AmazonEc2ContainerService.Attribute();
      //expect(instance).to.be.a(AmazonEc2ContainerService.Attribute);
    });
