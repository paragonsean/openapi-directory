...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.UpdateServiceResponseService();
  });
  ...
  describe('UpdateServiceResponseService', function() {
    it('should create an instance of UpdateServiceResponseService', function() {
      // uncomment below and update the code to test UpdateServiceResponseService
      //var instance = new AmazonEc2ContainerService.UpdateServiceResponseService();
      //expect(instance).to.be.a(AmazonEc2ContainerService.UpdateServiceResponseService);
    });
