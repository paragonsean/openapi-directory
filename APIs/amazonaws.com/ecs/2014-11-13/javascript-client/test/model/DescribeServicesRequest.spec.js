...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.DescribeServicesRequest();
  });
  ...
  describe('DescribeServicesRequest', function() {
    it('should create an instance of DescribeServicesRequest', function() {
      ...
      //var instance = new AmazonEc2ContainerService.DescribeServicesRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerService.DescribeServicesRequest);
    });
