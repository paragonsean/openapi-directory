...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.CreateServiceResponse();
  });
  ...
  describe('CreateServiceResponse', function() {
    it('should create an instance of CreateServiceResponse', function() {
      ...
      //var instance = new AmazonEc2ContainerService.CreateServiceResponse();
      //expect(instance).to.be.a(AmazonEc2ContainerService.CreateServiceResponse);
    });
