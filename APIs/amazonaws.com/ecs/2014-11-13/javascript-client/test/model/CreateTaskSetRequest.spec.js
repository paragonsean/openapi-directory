...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.CreateTaskSetRequest();
  });
  ...
  describe('CreateTaskSetRequest', function() {
    it('should create an instance of CreateTaskSetRequest', function() {
      // uncomment below and update the code to test CreateTaskSetRequest
      //var instance = new AmazonEc2ContainerService.CreateTaskSetRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerService.CreateTaskSetRequest);
    });
