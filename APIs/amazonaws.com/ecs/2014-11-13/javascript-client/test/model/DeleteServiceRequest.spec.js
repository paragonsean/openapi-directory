...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.DeleteServiceRequest();
  });
  ...
  describe('DeleteServiceRequest', function() {
    it('should create an instance of DeleteServiceRequest', function() {
      ...
      //var instance = new AmazonEc2ContainerService.DeleteServiceRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerService.DeleteServiceRequest);
    });
