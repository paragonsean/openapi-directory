...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.DescribeTasksRequest();
  });
  ...
  describe('DescribeTasksRequest', function() {
    it('should create an instance of DescribeTasksRequest', function() {
      // uncomment below and update the code to test DescribeTasksRequest
      //var instance = new AmazonEc2ContainerService.DescribeTasksRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerService.DescribeTasksRequest);
    });
