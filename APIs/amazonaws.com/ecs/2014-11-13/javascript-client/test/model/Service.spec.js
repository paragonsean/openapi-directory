...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.Service();
  });
  ...
  describe('Service', function() {
    it('should create an instance of Service', function() {
      ...
      //var instance = new AmazonEc2ContainerService.Service();
      //expect(instance).to.be.a(AmazonEc2ContainerService.Service);
    });
