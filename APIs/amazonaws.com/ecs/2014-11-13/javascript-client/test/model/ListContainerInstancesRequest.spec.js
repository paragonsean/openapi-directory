...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.ListContainerInstancesRequest();
  });
  ...
  describe('ListContainerInstancesRequest', function() {
    it('should create an instance of ListContainerInstancesRequest', function() {
      // uncomment below and update the code to test ListContainerInstancesRequest
      //var instance = new AmazonEc2ContainerService.ListContainerInstancesRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerService.ListContainerInstancesRequest);
    });
