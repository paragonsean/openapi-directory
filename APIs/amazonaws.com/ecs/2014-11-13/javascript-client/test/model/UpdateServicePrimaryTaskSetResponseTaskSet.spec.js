...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.UpdateServicePrimaryTaskSetResponseTaskSet();
  });
  ...
  describe('UpdateServicePrimaryTaskSetResponseTaskSet', function() {
    it('should create an instance of UpdateServicePrimaryTaskSetResponseTaskSet', function() {
      // uncomment below and update the code to test UpdateServicePrimaryTaskSetResponseTaskSet
      //var instance = new AmazonEc2ContainerService.UpdateServicePrimaryTaskSetResponseTaskSet();
      //expect(instance).to.be.a(AmazonEc2ContainerService.UpdateServicePrimaryTaskSetResponseTaskSet);
    });
