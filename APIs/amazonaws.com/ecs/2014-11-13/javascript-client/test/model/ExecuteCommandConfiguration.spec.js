...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.ExecuteCommandConfiguration();
  });
  ...
  describe('ExecuteCommandConfiguration', function() {
    it('should create an instance of ExecuteCommandConfiguration', function() {
      // uncomment below and update the code to test ExecuteCommandConfiguration
      //var instance = new AmazonEc2ContainerService.ExecuteCommandConfiguration();
      //expect(instance).to.be.a(AmazonEc2ContainerService.ExecuteCommandConfiguration);
    });
