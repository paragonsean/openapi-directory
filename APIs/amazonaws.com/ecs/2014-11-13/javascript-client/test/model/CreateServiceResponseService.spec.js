...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.CreateServiceResponseService();
  });
  ...
  describe('CreateServiceResponseService', function() {
    it('should create an instance of CreateServiceResponseService', function() {
      ...
      //var instance = new AmazonEc2ContainerService.CreateServiceResponseService();
      //expect(instance).to.be.a(AmazonEc2ContainerService.CreateServiceResponseService);
    });
