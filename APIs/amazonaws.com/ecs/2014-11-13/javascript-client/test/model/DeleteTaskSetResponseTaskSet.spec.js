...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.DeleteTaskSetResponseTaskSet();
  });
  ...
  describe('DeleteTaskSetResponseTaskSet', function() {
    it('should create an instance of DeleteTaskSetResponseTaskSet', function() {
      // uncomment below and update the code to test DeleteTaskSetResponseTaskSet
      //var instance = new AmazonEc2ContainerService.DeleteTaskSetResponseTaskSet();
      //expect(instance).to.be.a(AmazonEc2ContainerService.DeleteTaskSetResponseTaskSet);
    });
