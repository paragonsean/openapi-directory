...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.RunTaskResponse();
  });
  ...
  describe('RunTaskResponse', function() {
    it('should create an instance of RunTaskResponse', function() {
      // uncomment below and update the code to test RunTaskResponse
      //var instance = new AmazonEc2ContainerService.RunTaskResponse();
      //expect(instance).to.be.a(AmazonEc2ContainerService.RunTaskResponse);
    });
