...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.Device();
  });
  ...
  describe('Device', function() {
    it('should create an instance of Device', function() {
      ...
      //var instance = new AmazonEc2ContainerService.Device();
      //expect(instance).to.be.a(AmazonEc2ContainerService.Device);
    });
