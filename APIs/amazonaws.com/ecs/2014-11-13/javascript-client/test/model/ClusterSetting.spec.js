...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.ClusterSetting();
  });
  ...
  describe('ClusterSetting', function() {
    it('should create an instance of ClusterSetting', function() {
      ...
      //var instance = new AmazonEc2ContainerService.ClusterSetting();
      //expect(instance).to.be.a(AmazonEc2ContainerService.ClusterSetting);
    });
