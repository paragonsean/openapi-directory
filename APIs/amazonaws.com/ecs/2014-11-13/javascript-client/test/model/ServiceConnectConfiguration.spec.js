...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.ServiceConnectConfiguration();
  });
  ...
  describe('ServiceConnectConfiguration', function() {
    it('should create an instance of ServiceConnectConfiguration', function() {
      // uncomment below and update the code to test ServiceConnectConfiguration
      //var instance = new AmazonEc2ContainerService.ServiceConnectConfiguration();
      //expect(instance).to.be.a(AmazonEc2ContainerService.ServiceConnectConfiguration);
    });
