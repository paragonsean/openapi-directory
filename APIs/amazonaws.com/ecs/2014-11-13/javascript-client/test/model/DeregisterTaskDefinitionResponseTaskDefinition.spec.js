...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.DeregisterTaskDefinitionResponseTaskDefinition();
  });
  ...
  describe('DeregisterTaskDefinitionResponseTaskDefinition', function() {
    it('should create an instance of DeregisterTaskDefinitionResponseTaskDefinition', function() {
      // uncomment below and update the code to test DeregisterTaskDefinitionResponseTaskDefinition
      //var instance = new AmazonEc2ContainerService.DeregisterTaskDefinitionResponseTaskDefinition();
      //expect(instance).to.be.a(AmazonEc2ContainerService.DeregisterTaskDefinitionResponseTaskDefinition);
    });
