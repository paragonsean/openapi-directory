...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.RegisterTaskDefinitionResponseTaskDefinition();
  });
  ...
  describe('RegisterTaskDefinitionResponseTaskDefinition', function() {
    it('should create an instance of RegisterTaskDefinitionResponseTaskDefinition', function() {
      // uncomment below and update the code to test RegisterTaskDefinitionResponseTaskDefinition
      //var instance = new AmazonEc2ContainerService.RegisterTaskDefinitionResponseTaskDefinition();
      //expect(instance).to.be.a(AmazonEc2ContainerService.RegisterTaskDefinitionResponseTaskDefinition);
    });
    ...
    it('should have the property containerDefinitions (base name: "containerDefinitions")', function() {
      // uncomment below and update the code to test the property containerDefinitions
      //var instance = new AmazonEc2ContainerService.RegisterTaskDefinitionResponseTaskDefinition();
      //expect(instance).to.be();
    });
    ...
    it('should have the property taskRoleArn (base name: "taskRoleArn")', function() {
      // uncomment below and update the code to test the property taskRoleArn
      //var instance = new AmazonEc2ContainerService.RegisterTaskDefinitionResponseTaskDefinition();
      //expect(instance).to.be();
    });
    ...
    it('should have the property requiresAttributes (base name: "requiresAttributes")', function() {
      // uncomment below and update the code to test the property requiresAttributes
      //var instance = new AmazonEc2ContainerService.RegisterTaskDefinitionResponseTaskDefinition();
      //expect(instance).to.be();
    });
    ...
    it('should have the property runtimePlatform (base name: "runtimePlatform")', function() {
      // uncomment below and update the code to test the property runtimePlatform
      //var instance = new AmazonEc2ContainerService.RegisterTaskDefinitionResponseTaskDefinition();
      //expect(instance).to.be();
    });

    it('should have the property requiresCompatibilities (base name: "requiresCompatibilities")', function() {
      // uncomment below and update the code to test the property requiresCompatibilities
      //var instance = new AmazonEc2ContainerService.RegisterTaskDefinitionResponseTaskDefinition();
      //expect(instance).to.be();
    });
    ...
    it('should have the property deregisteredAt (base name: "deregisteredAt")', function() {
      // uncomment below and update the code to test the property deregisteredAt
      //var instance = new AmazonEc2ContainerService.RegisterTaskDefinitionResponseTaskDefinition();
      //expect(instance).to.be();
    });
