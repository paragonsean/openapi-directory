...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.StartTaskRequest();
  });
  ...
  describe('StartTaskRequest', function() {
    it('should create an instance of StartTaskRequest', function() {
      // uncomment below and update the code to test StartTaskRequest
      //var instance = new AmazonEc2ContainerService.StartTaskRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerService.StartTaskRequest);
    });
