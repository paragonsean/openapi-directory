...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.DescribeTaskDefinitionResponseTaskDefinition();
  });
  ...
  describe('DescribeTaskDefinitionResponseTaskDefinition', function() {
    it('should create an instance of DescribeTaskDefinitionResponseTaskDefinition', function() {
      // uncomment below and update the code to test DescribeTaskDefinitionResponseTaskDefinition
      //var instance = new AmazonEc2ContainerService.DescribeTaskDefinitionResponseTaskDefinition();
      //expect(instance).to.be.a(AmazonEc2ContainerService.DescribeTaskDefinitionResponseTaskDefinition);
    });
