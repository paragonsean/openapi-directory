...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.StopTaskRequest();
  });
  ...
  describe('StopTaskRequest', function() {
    it('should create an instance of StopTaskRequest', function() {
      // uncomment below and update the code to test StopTaskRequest
      //var instance = new AmazonEc2ContainerService.StopTaskRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerService.StopTaskRequest);
    });
