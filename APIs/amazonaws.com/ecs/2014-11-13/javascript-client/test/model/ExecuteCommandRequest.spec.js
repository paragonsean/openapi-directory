...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.ExecuteCommandRequest();
  });
  ...
  describe('ExecuteCommandRequest', function() {
    it('should create an instance of ExecuteCommandRequest', function() {
      // uncomment below and update the code to test ExecuteCommandRequest
      //var instance = new AmazonEc2ContainerService.ExecuteCommandRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerService.ExecuteCommandRequest);
    });
