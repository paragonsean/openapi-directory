...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.StartTaskRequestOverrides();
  });
  ...
  describe('StartTaskRequestOverrides', function() {
    it('should create an instance of StartTaskRequestOverrides', function() {
      // uncomment below and update the code to test StartTaskRequestOverrides
      //var instance = new AmazonEc2ContainerService.StartTaskRequestOverrides();
      //expect(instance).to.be.a(AmazonEc2ContainerService.StartTaskRequestOverrides);
    });
    ...
    it('should have the property inferenceAcceleratorOverrides (base name: "inferenceAcceleratorOverrides")', function() {
      // uncomment below and update the code to test the property inferenceAcceleratorOverrides
      //var instance = new AmazonEc2ContainerService.StartTaskRequestOverrides();
      //expect(instance).to.be();
    });
