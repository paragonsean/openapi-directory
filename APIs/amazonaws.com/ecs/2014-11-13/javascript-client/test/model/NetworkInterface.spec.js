...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.NetworkInterface();
  });
  ...
  describe('NetworkInterface', function() {
    it('should create an instance of NetworkInterface', function() {
      ...
      //var instance = new AmazonEc2ContainerService.NetworkInterface();
      //expect(instance).to.be.a(AmazonEc2ContainerService.NetworkInterface);
    });
