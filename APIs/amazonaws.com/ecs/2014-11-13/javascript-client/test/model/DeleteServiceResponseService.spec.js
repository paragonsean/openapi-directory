...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.DeleteServiceResponseService();
  });
  ...
  describe('DeleteServiceResponseService', function() {
    it('should create an instance of DeleteServiceResponseService', function() {
      ...
      //var instance = new AmazonEc2ContainerService.DeleteServiceResponseService();
      //expect(instance).to.be.a(AmazonEc2ContainerService.DeleteServiceResponseService);
    });
