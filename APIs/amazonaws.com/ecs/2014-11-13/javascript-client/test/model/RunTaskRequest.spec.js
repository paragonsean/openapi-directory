...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.RunTaskRequest();
  });
  ...
  describe('RunTaskRequest', function() {
    it('should create an instance of RunTaskRequest', function() {
      // uncomment below and update the code to test RunTaskRequest
      //var instance = new AmazonEc2ContainerService.RunTaskRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerService.RunTaskRequest);
    });
