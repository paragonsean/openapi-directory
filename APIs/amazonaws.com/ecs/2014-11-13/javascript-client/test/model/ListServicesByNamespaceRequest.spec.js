...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.ListServicesByNamespaceRequest();
  });
  ...
  describe('ListServicesByNamespaceRequest', function() {
    it('should create an instance of ListServicesByNamespaceRequest', function() {
      // uncomment below and update the code to test ListServicesByNamespaceRequest
      //var instance = new AmazonEc2ContainerService.ListServicesByNamespaceRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerService.ListServicesByNamespaceRequest);
    });
