...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.DeploymentServiceConnectConfiguration();
  });
  ...
  describe('DeploymentServiceConnectConfiguration', function() {
    it('should create an instance of DeploymentServiceConnectConfiguration', function() {
      // uncomment below and update the code to test DeploymentServiceConnectConfiguration
      //var instance = new AmazonEc2ContainerService.DeploymentServiceConnectConfiguration();
      //expect(instance).to.be.a(AmazonEc2ContainerService.DeploymentServiceConnectConfiguration);
    });
