...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.ContainerDependency();
  });
  ...
  describe('ContainerDependency', function() {
    it('should create an instance of ContainerDependency', function() {
      // uncomment below and update the code to test ContainerDependency
      //var instance = new AmazonEc2ContainerService.ContainerDependency();
      //expect(instance).to.be.a(AmazonEc2ContainerService.ContainerDependency);
    });
