...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.StartTaskResponse();
  });
  ...
  describe('StartTaskResponse', function() {
    it('should create an instance of StartTaskResponse', function() {
      // uncomment below and update the code to test StartTaskResponse
      //var instance = new AmazonEc2ContainerService.StartTaskResponse();
      //expect(instance).to.be.a(AmazonEc2ContainerService.StartTaskResponse);
    });
