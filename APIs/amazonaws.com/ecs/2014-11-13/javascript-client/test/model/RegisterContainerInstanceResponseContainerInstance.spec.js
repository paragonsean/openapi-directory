...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.RegisterContainerInstanceResponseContainerInstance();
  });
  ...
  describe('RegisterContainerInstanceResponseContainerInstance', function() {
    it('should create an instance of RegisterContainerInstanceResponseContainerInstance', function() {
      // uncomment below and update the code to test RegisterContainerInstanceResponseContainerInstance
      //var instance = new AmazonEc2ContainerService.RegisterContainerInstanceResponseContainerInstance();
      //expect(instance).to.be.a(AmazonEc2ContainerService.RegisterContainerInstanceResponseContainerInstance);
    });
