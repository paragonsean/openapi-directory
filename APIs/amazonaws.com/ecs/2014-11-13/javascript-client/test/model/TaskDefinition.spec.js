...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.TaskDefinition();
  });
  ...
  describe('TaskDefinition', function() {
    it('should create an instance of TaskDefinition', function() {
      // uncomment below and update the code to test TaskDefinition
      //var instance = new AmazonEc2ContainerService.TaskDefinition();
      //expect(instance).to.be.a(AmazonEc2ContainerService.TaskDefinition);
    });
