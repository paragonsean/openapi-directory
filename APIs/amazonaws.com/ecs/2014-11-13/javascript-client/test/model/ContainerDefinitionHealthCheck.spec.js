...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.ContainerDefinitionHealthCheck();
  });
  ...
  describe('ContainerDefinitionHealthCheck', function() {
    it('should create an instance of ContainerDefinitionHealthCheck', function() {
      // uncomment below and update the code to test ContainerDefinitionHealthCheck
      //var instance = new AmazonEc2ContainerService.ContainerDefinitionHealthCheck();
      //expect(instance).to.be.a(AmazonEc2ContainerService.ContainerDefinitionHealthCheck);
    });
