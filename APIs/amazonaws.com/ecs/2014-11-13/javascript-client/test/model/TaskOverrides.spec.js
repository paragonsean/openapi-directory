...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.TaskOverrides();
  });
  ...
  describe('TaskOverrides', function() {
    it('should create an instance of TaskOverrides', function() {
      // uncomment below and update the code to test TaskOverrides
      //var instance = new AmazonEc2ContainerService.TaskOverrides();
      //expect(instance).to.be.a(AmazonEc2ContainerService.TaskOverrides);
    });
