...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.AwsVpcConfiguration();
  });
  ...
  describe('AwsVpcConfiguration', function() {
    it('should create an instance of AwsVpcConfiguration', function() {
      ...
      //var instance = new AmazonEc2ContainerService.AwsVpcConfiguration();
      //expect(instance).to.be.a(AmazonEc2ContainerService.AwsVpcConfiguration);
    });
