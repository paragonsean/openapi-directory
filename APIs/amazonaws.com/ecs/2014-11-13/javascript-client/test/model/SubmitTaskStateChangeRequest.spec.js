...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.SubmitTaskStateChangeRequest();
  });
  ...
  describe('SubmitTaskStateChangeRequest', function() {
    it('should create an instance of SubmitTaskStateChangeRequest', function() {
      // uncomment below and update the code to test SubmitTaskStateChangeRequest
      //var instance = new AmazonEc2ContainerService.SubmitTaskStateChangeRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerService.SubmitTaskStateChangeRequest);
    });
