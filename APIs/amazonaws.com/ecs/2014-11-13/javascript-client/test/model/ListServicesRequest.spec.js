...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.ListServicesRequest();
  });
  ...
  describe('ListServicesRequest', function() {
    it('should create an instance of ListServicesRequest', function() {
      // uncomment below and update the code to test ListServicesRequest
      //var instance = new AmazonEc2ContainerService.ListServicesRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerService.ListServicesRequest);
    });
