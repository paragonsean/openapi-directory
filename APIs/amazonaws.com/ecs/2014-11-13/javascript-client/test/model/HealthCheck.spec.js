...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.HealthCheck();
  });
  ...
  describe('HealthCheck', function() {
    it('should create an instance of HealthCheck', function() {
      ...
      //var instance = new AmazonEc2ContainerService.HealthCheck();
      //expect(instance).to.be.a(AmazonEc2ContainerService.HealthCheck);
    });
