...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.ContainerInstance();
  });
  ...
  describe('ContainerInstance', function() {
    it('should create an instance of ContainerInstance', function() {
      // uncomment below and update the code to test ContainerInstance
      //var instance = new AmazonEc2ContainerService.ContainerInstance();
      //expect(instance).to.be.a(AmazonEc2ContainerService.ContainerInstance);
    });
