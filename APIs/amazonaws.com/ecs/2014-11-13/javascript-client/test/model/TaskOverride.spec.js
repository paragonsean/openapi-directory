...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.TaskOverride();
  });
  ...
  describe('TaskOverride', function() {
    it('should create an instance of TaskOverride', function() {
      // uncomment below and update the code to test TaskOverride
      //var instance = new AmazonEc2ContainerService.TaskOverride();
      //expect(instance).to.be.a(AmazonEc2ContainerService.TaskOverride);
    });
