...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.ListClustersRequest();
  });
  ...
  describe('ListClustersRequest', function() {
    it('should create an instance of ListClustersRequest', function() {
      ...
      //var instance = new AmazonEc2ContainerService.ListClustersRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerService.ListClustersRequest);
    });
