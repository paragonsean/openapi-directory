...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.RunTaskRequestOverrides();
  });
  ...
  describe('RunTaskRequestOverrides', function() {
    it('should create an instance of RunTaskRequestOverrides', function() {
      // uncomment below and update the code to test RunTaskRequestOverrides
      //var instance = new AmazonEc2ContainerService.RunTaskRequestOverrides();
      //expect(instance).to.be.a(AmazonEc2ContainerService.RunTaskRequestOverrides);
    });
