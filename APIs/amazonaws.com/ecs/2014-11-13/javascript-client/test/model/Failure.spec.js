...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.Failure();
  });
  ...
  describe('Failure', function() {
    it('should create an instance of Failure', function() {
      ...
      //var instance = new AmazonEc2ContainerService.Failure();
      //expect(instance).to.be.a(AmazonEc2ContainerService.Failure);
    });
