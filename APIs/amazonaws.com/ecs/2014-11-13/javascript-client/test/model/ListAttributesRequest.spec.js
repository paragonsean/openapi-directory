...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.ListAttributesRequest();
  });
  ...
  describe('ListAttributesRequest', function() {
    it('should create an instance of ListAttributesRequest', function() {
      // uncomment below and update the code to test ListAttributesRequest
      //var instance = new AmazonEc2ContainerService.ListAttributesRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerService.ListAttributesRequest);
    });
