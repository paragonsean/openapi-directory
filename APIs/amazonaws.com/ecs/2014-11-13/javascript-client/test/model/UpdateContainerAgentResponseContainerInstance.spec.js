...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.UpdateContainerAgentResponseContainerInstance();
  });
  ...
  describe('UpdateContainerAgentResponseContainerInstance', function() {
    it('should create an instance of UpdateContainerAgentResponseContainerInstance', function() {
      // uncomment below and update the code to test UpdateContainerAgentResponseContainerInstance
      //var instance = new AmazonEc2ContainerService.UpdateContainerAgentResponseContainerInstance();
      //expect(instance).to.be.a(AmazonEc2ContainerService.UpdateContainerAgentResponseContainerInstance);
    });
