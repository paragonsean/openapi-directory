...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerService.UpdateServiceRequest();
  });
  ...
  describe('UpdateServiceRequest', function() {
    it('should create an instance of UpdateServiceRequest', function() {
      ...
      //var instance = new AmazonEc2ContainerService.UpdateServiceRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerService.UpdateServiceRequest);
    });
    ...
    it('should have the property forceNewDeployment (base name: "forceNewDeployment")', function() {
      // uncomment below and update the code to test the property forceNewDeployment
      //var instance = new AmazonEc2ContainerService.UpdateServiceRequest();
      //expect(instance).to.be();
    });
