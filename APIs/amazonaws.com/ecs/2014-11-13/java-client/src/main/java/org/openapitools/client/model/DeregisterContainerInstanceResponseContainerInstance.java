...
public class DeregisterContainerInstanceResponseContainerInstance {
  ...
  public DeregisterContainerInstanceResponseContainerInstance() {
  }

  public DeregisterContainerInstanceResponseContainerInstance containerInstanceArn(String containerInstanceArn) {
  ...
  public DeregisterContainerInstanceResponseContainerInstance ec2InstanceId(String ec2InstanceId) {
  ...
  public DeregisterContainerInstanceResponseContainerInstance capacityProviderName(String capacityProviderName) {
  ...
  public DeregisterContainerInstanceResponseContainerInstance version(Integer version) {
  ...
  public DeregisterContainerInstanceResponseContainerInstance versionInfo(ContainerInstanceVersionInfo versionInfo) {
  ...
  public DeregisterContainerInstanceResponseContainerInstance remainingResources(List remainingResources) {
  ...
  public DeregisterContainerInstanceResponseContainerInstance registeredResources(List registeredResources) {
  ...
  public DeregisterContainerInstanceResponseContainerInstance status(String status) {
    this.status = status;
    return this;
  }
  ...
  public DeregisterContainerInstanceResponseContainerInstance statusReason(String statusReason) {
  ...
  public DeregisterContainerInstanceResponseContainerInstance agentConnected(Boolean agentConnected) {
  ...
  public DeregisterContainerInstanceResponseContainerInstance runningTasksCount(Integer runningTasksCount) {
  ...
  public DeregisterContainerInstanceResponseContainerInstance pendingTasksCount(Integer pendingTasksCount) {
  ...
  public DeregisterContainerInstanceResponseContainerInstance agentUpdateStatus(AgentUpdateStatus agentUpdateStatus) {
  ...
  public DeregisterContainerInstanceResponseContainerInstance attributes(List attributes) {
  ...
  public DeregisterContainerInstanceResponseContainerInstance registeredAt(OffsetDateTime registeredAt) {
  ...
  public DeregisterContainerInstanceResponseContainerInstance attachments(List attachments) {
  ...
  public DeregisterContainerInstanceResponseContainerInstance tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public DeregisterContainerInstanceResponseContainerInstance healthStatus(ContainerInstanceHealthStatus healthStatus) {
  ...
  public boolean equals(Object o) {
    ...
    DeregisterContainerInstanceResponseContainerInstance deregisterContainerInstanceResponseContainerInstance = (DeregisterContainerInstanceResponseContainerInstance) o;
    return Objects.equals(this.containerInstanceArn, deregisterContainerInstanceResponseContainerInstance.containerInstanceArn) &&
        Objects.equals(this.ec2InstanceId, deregisterContainerInstanceResponseContainerInstance.ec2InstanceId) &&
        Objects.equals(this.capacityProviderName, deregisterContainerInstanceResponseContainerInstance.capacityProviderName) &&
        Objects.equals(this.version, deregisterContainerInstanceResponseContainerInstance.version) &&
        Objects.equals(this.versionInfo, deregisterContainerInstanceResponseContainerInstance.versionInfo) &&
        Objects.equals(this.remainingResources, deregisterContainerInstanceResponseContainerInstance.remainingResources) &&
        Objects.equals(this.registeredResources, deregisterContainerInstanceResponseContainerInstance.registeredResources) &&
        Objects.equals(this.status, deregisterContainerInstanceResponseContainerInstance.status) &&
        Objects.equals(this.statusReason, deregisterContainerInstanceResponseContainerInstance.statusReason) &&
        Objects.equals(this.agentConnected, deregisterContainerInstanceResponseContainerInstance.agentConnected) &&
        Objects.equals(this.runningTasksCount, deregisterContainerInstanceResponseContainerInstance.runningTasksCount) &&
        Objects.equals(this.pendingTasksCount, deregisterContainerInstanceResponseContainerInstance.pendingTasksCount) &&
        Objects.equals(this.agentUpdateStatus, deregisterContainerInstanceResponseContainerInstance.agentUpdateStatus) &&
        Objects.equals(this.attributes, deregisterContainerInstanceResponseContainerInstance.attributes) &&
        Objects.equals(this.registeredAt, deregisterContainerInstanceResponseContainerInstance.registeredAt) &&
        Objects.equals(this.attachments, deregisterContainerInstanceResponseContainerInstance.attachments) &&
        Objects.equals(this.tags, deregisterContainerInstanceResponseContainerInstance.tags) &&
        Objects.equals(this.healthStatus, deregisterContainerInstanceResponseContainerInstance.healthStatus);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeregisterContainerInstanceResponseContainerInstance {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeregisterContainerInstanceResponseContainerInstance
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeregisterContainerInstanceResponseContainerInstance.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeregisterContainerInstanceResponseContainerInstance is not found in the empty JSON string", DeregisterContainerInstanceResponseContainerInstance.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeregisterContainerInstanceResponseContainerInstance.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeregisterContainerInstanceResponseContainerInstance` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeregisterContainerInstanceResponseContainerInstance.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeregisterContainerInstanceResponseContainerInstance' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeregisterContainerInstanceResponseContainerInstance> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeregisterContainerInstanceResponseContainerInstance.class));

       return (TypeAdapter<T>) new TypeAdapter<DeregisterContainerInstanceResponseContainerInstance>() {
           @Override
           public void write(JsonWriter out, DeregisterContainerInstanceResponseContainerInstance value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeregisterContainerInstanceResponseContainerInstance read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeregisterContainerInstanceResponseContainerInstance given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeregisterContainerInstanceResponseContainerInstance
   * @throws IOException if the JSON string is invalid with respect to DeregisterContainerInstanceResponseContainerInstance
   */
  public static DeregisterContainerInstanceResponseContainerInstance fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeregisterContainerInstanceResponseContainerInstance.class);
  }

  /**
   * Convert an instance of DeregisterContainerInstanceResponseContainerInstance to an JSON string
   *
   * @return JSON string
   */
