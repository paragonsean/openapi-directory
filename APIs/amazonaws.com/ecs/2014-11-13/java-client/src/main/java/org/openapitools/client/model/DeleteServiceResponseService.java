...
public class DeleteServiceResponseService {
  ...
  public DeleteServiceResponseService() {
  }

  public DeleteServiceResponseService serviceArn(String serviceArn) {
  ...
  public DeleteServiceResponseService serviceName(String serviceName) {
  ...
  public DeleteServiceResponseService clusterArn(String clusterArn) {
  ...
  public DeleteServiceResponseService loadBalancers(List loadBalancers) {
  ...
  public DeleteServiceResponseService serviceRegistries(List serviceRegistries) {
  ...
  public DeleteServiceResponseService status(String status) {
    this.status = status;
    return this;
  }
  ...
  public DeleteServiceResponseService desiredCount(Integer desiredCount) {
  ...
  public DeleteServiceResponseService runningCount(Integer runningCount) {
  ...
  public DeleteServiceResponseService pendingCount(Integer pendingCount) {
  ...
  public DeleteServiceResponseService launchType(LaunchType launchType) {
  ...
  public DeleteServiceResponseService capacityProviderStrategy(List capacityProviderStrategy) {
  ...
  public DeleteServiceResponseService platformVersion(String platformVersion) {
  ...
  public DeleteServiceResponseService platformFamily(String platformFamily) {
  ...
  public DeleteServiceResponseService taskDefinition(String taskDefinition) {
  ...
  public DeleteServiceResponseService deploymentConfiguration(CreateServiceRequestDeploymentConfiguration deploymentConfiguration) {
  ...
  public DeleteServiceResponseService taskSets(List taskSets) {
  ...
  public DeleteServiceResponseService deployments(List deployments) {
  ...
  public DeleteServiceResponseService roleArn(String roleArn) {
  ...
  public DeleteServiceResponseService events(List events) {
    this.events = events;
    return this;
  }
  ...
  public DeleteServiceResponseService createdAt(OffsetDateTime createdAt) {
  ...
  public DeleteServiceResponseService placementConstraints(List placementConstraints) {
  ...
  public DeleteServiceResponseService placementStrategy(List placementStrategy) {
  ...
  public DeleteServiceResponseService networkConfiguration(StartTaskRequestNetworkConfiguration networkConfiguration) {
  ...
  public DeleteServiceResponseService healthCheckGracePeriodSeconds(Integer healthCheckGracePeriodSeconds) {
  ...
  public DeleteServiceResponseService schedulingStrategy(SchedulingStrategy schedulingStrategy) {
  ...
  public DeleteServiceResponseService deploymentController(ServiceDeploymentController deploymentController) {
  ...
  public DeleteServiceResponseService tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public DeleteServiceResponseService createdBy(String createdBy) {
  ...
  public DeleteServiceResponseService enableECSManagedTags(Boolean enableECSManagedTags) {
  ...
  public DeleteServiceResponseService propagateTags(PropagateTags propagateTags) {
  ...
  public DeleteServiceResponseService enableExecuteCommand(Boolean enableExecuteCommand) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteServiceResponseService deleteServiceResponseService = (DeleteServiceResponseService) o;
    return Objects.equals(this.serviceArn, deleteServiceResponseService.serviceArn) &&
        Objects.equals(this.serviceName, deleteServiceResponseService.serviceName) &&
        Objects.equals(this.clusterArn, deleteServiceResponseService.clusterArn) &&
        Objects.equals(this.loadBalancers, deleteServiceResponseService.loadBalancers) &&
        Objects.equals(this.serviceRegistries, deleteServiceResponseService.serviceRegistries) &&
        Objects.equals(this.status, deleteServiceResponseService.status) &&
        Objects.equals(this.desiredCount, deleteServiceResponseService.desiredCount) &&
        Objects.equals(this.runningCount, deleteServiceResponseService.runningCount) &&
        Objects.equals(this.pendingCount, deleteServiceResponseService.pendingCount) &&
        Objects.equals(this.launchType, deleteServiceResponseService.launchType) &&
        Objects.equals(this.capacityProviderStrategy, deleteServiceResponseService.capacityProviderStrategy) &&
        Objects.equals(this.platformVersion, deleteServiceResponseService.platformVersion) &&
        Objects.equals(this.platformFamily, deleteServiceResponseService.platformFamily) &&
        Objects.equals(this.taskDefinition, deleteServiceResponseService.taskDefinition) &&
        Objects.equals(this.deploymentConfiguration, deleteServiceResponseService.deploymentConfiguration) &&
        Objects.equals(this.taskSets, deleteServiceResponseService.taskSets) &&
        Objects.equals(this.deployments, deleteServiceResponseService.deployments) &&
        Objects.equals(this.roleArn, deleteServiceResponseService.roleArn) &&
        Objects.equals(this.events, deleteServiceResponseService.events) &&
        Objects.equals(this.createdAt, deleteServiceResponseService.createdAt) &&
        Objects.equals(this.placementConstraints, deleteServiceResponseService.placementConstraints) &&
        Objects.equals(this.placementStrategy, deleteServiceResponseService.placementStrategy) &&
        Objects.equals(this.networkConfiguration, deleteServiceResponseService.networkConfiguration) &&
        Objects.equals(this.healthCheckGracePeriodSeconds, deleteServiceResponseService.healthCheckGracePeriodSeconds) &&
        Objects.equals(this.schedulingStrategy, deleteServiceResponseService.schedulingStrategy) &&
        Objects.equals(this.deploymentController, deleteServiceResponseService.deploymentController) &&
        Objects.equals(this.tags, deleteServiceResponseService.tags) &&
        Objects.equals(this.createdBy, deleteServiceResponseService.createdBy) &&
        Objects.equals(this.enableECSManagedTags, deleteServiceResponseService.enableECSManagedTags) &&
        Objects.equals(this.propagateTags, deleteServiceResponseService.propagateTags) &&
        Objects.equals(this.enableExecuteCommand, deleteServiceResponseService.enableExecuteCommand);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteServiceResponseService {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteServiceResponseService
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteServiceResponseService.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteServiceResponseService is not found in the empty JSON string", DeleteServiceResponseService.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteServiceResponseService.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteServiceResponseService` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteServiceResponseService.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteServiceResponseService' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteServiceResponseService> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteServiceResponseService.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteServiceResponseService>() {
           @Override
           public void write(JsonWriter out, DeleteServiceResponseService value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteServiceResponseService read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteServiceResponseService given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteServiceResponseService
   * @throws IOException if the JSON string is invalid with respect to DeleteServiceResponseService
   */
  public static DeleteServiceResponseService fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteServiceResponseService.class);
  }

  /**
   * Convert an instance of DeleteServiceResponseService to an JSON string
   *
   * @return JSON string
   */
