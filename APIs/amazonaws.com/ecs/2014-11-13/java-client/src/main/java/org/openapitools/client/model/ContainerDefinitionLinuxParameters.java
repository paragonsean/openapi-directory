...
public class ContainerDefinitionLinuxParameters {
  ...
  public ContainerDefinitionLinuxParameters() {
  }

  public ContainerDefinitionLinuxParameters capabilities(LinuxParametersCapabilities capabilities) {
  ...
  public ContainerDefinitionLinuxParameters devices(List devices) {
  ...
  public ContainerDefinitionLinuxParameters initProcessEnabled(Boolean initProcessEnabled) {
  ...
  public ContainerDefinitionLinuxParameters sharedMemorySize(Integer sharedMemorySize) {
  ...
  public ContainerDefinitionLinuxParameters tmpfs(List tmpfs) {
    this.tmpfs = tmpfs;
    return this;
  }
  ...
  public ContainerDefinitionLinuxParameters maxSwap(Integer maxSwap) {
  ...
  public ContainerDefinitionLinuxParameters swappiness(Integer swappiness) {
  ...
  public boolean equals(Object o) {
    ...
    ContainerDefinitionLinuxParameters containerDefinitionLinuxParameters = (ContainerDefinitionLinuxParameters) o;
    return Objects.equals(this.capabilities, containerDefinitionLinuxParameters.capabilities) &&
        Objects.equals(this.devices, containerDefinitionLinuxParameters.devices) &&
        Objects.equals(this.initProcessEnabled, containerDefinitionLinuxParameters.initProcessEnabled) &&
        Objects.equals(this.sharedMemorySize, containerDefinitionLinuxParameters.sharedMemorySize) &&
        Objects.equals(this.tmpfs, containerDefinitionLinuxParameters.tmpfs) &&
        Objects.equals(this.maxSwap, containerDefinitionLinuxParameters.maxSwap) &&
        Objects.equals(this.swappiness, containerDefinitionLinuxParameters.swappiness);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContainerDefinitionLinuxParameters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContainerDefinitionLinuxParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContainerDefinitionLinuxParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContainerDefinitionLinuxParameters is not found in the empty JSON string", ContainerDefinitionLinuxParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContainerDefinitionLinuxParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContainerDefinitionLinuxParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContainerDefinitionLinuxParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContainerDefinitionLinuxParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContainerDefinitionLinuxParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContainerDefinitionLinuxParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<ContainerDefinitionLinuxParameters>() {
           @Override
           public void write(JsonWriter out, ContainerDefinitionLinuxParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContainerDefinitionLinuxParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ContainerDefinitionLinuxParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ContainerDefinitionLinuxParameters
   * @throws IOException if the JSON string is invalid with respect to ContainerDefinitionLinuxParameters
   */
  public static ContainerDefinitionLinuxParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContainerDefinitionLinuxParameters.class);
  }

  /**
   * Convert an instance of ContainerDefinitionLinuxParameters to an JSON string
   *
   * @return JSON string
   */
