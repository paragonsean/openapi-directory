...
public class UpdateContainerAgentResponseContainerInstance {
  ...
  public UpdateContainerAgentResponseContainerInstance() {
  }

  public UpdateContainerAgentResponseContainerInstance containerInstanceArn(String containerInstanceArn) {
  ...
  public UpdateContainerAgentResponseContainerInstance ec2InstanceId(String ec2InstanceId) {
  ...
  public UpdateContainerAgentResponseContainerInstance capacityProviderName(String capacityProviderName) {
  ...
  public UpdateContainerAgentResponseContainerInstance version(Integer version) {
  ...
  public UpdateContainerAgentResponseContainerInstance versionInfo(ContainerInstanceVersionInfo versionInfo) {
  ...
  public UpdateContainerAgentResponseContainerInstance remainingResources(List remainingResources) {
  ...
  public UpdateContainerAgentResponseContainerInstance registeredResources(List registeredResources) {
  ...
  public UpdateContainerAgentResponseContainerInstance status(String status) {
    this.status = status;
    return this;
  }
  ...
  public UpdateContainerAgentResponseContainerInstance statusReason(String statusReason) {
  ...
  public UpdateContainerAgentResponseContainerInstance agentConnected(Boolean agentConnected) {
  ...
  public UpdateContainerAgentResponseContainerInstance runningTasksCount(Integer runningTasksCount) {
  ...
  public UpdateContainerAgentResponseContainerInstance pendingTasksCount(Integer pendingTasksCount) {
  ...
  public UpdateContainerAgentResponseContainerInstance agentUpdateStatus(AgentUpdateStatus agentUpdateStatus) {
  ...
  public UpdateContainerAgentResponseContainerInstance attributes(List attributes) {
  ...
  public UpdateContainerAgentResponseContainerInstance registeredAt(OffsetDateTime registeredAt) {
  ...
  public UpdateContainerAgentResponseContainerInstance attachments(List attachments) {
  ...
  public UpdateContainerAgentResponseContainerInstance tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public UpdateContainerAgentResponseContainerInstance healthStatus(ContainerInstanceHealthStatus healthStatus) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateContainerAgentResponseContainerInstance updateContainerAgentResponseContainerInstance = (UpdateContainerAgentResponseContainerInstance) o;
    return Objects.equals(this.containerInstanceArn, updateContainerAgentResponseContainerInstance.containerInstanceArn) &&
        Objects.equals(this.ec2InstanceId, updateContainerAgentResponseContainerInstance.ec2InstanceId) &&
        Objects.equals(this.capacityProviderName, updateContainerAgentResponseContainerInstance.capacityProviderName) &&
        Objects.equals(this.version, updateContainerAgentResponseContainerInstance.version) &&
        Objects.equals(this.versionInfo, updateContainerAgentResponseContainerInstance.versionInfo) &&
        Objects.equals(this.remainingResources, updateContainerAgentResponseContainerInstance.remainingResources) &&
        Objects.equals(this.registeredResources, updateContainerAgentResponseContainerInstance.registeredResources) &&
        Objects.equals(this.status, updateContainerAgentResponseContainerInstance.status) &&
        Objects.equals(this.statusReason, updateContainerAgentResponseContainerInstance.statusReason) &&
        Objects.equals(this.agentConnected, updateContainerAgentResponseContainerInstance.agentConnected) &&
        Objects.equals(this.runningTasksCount, updateContainerAgentResponseContainerInstance.runningTasksCount) &&
        Objects.equals(this.pendingTasksCount, updateContainerAgentResponseContainerInstance.pendingTasksCount) &&
        Objects.equals(this.agentUpdateStatus, updateContainerAgentResponseContainerInstance.agentUpdateStatus) &&
        Objects.equals(this.attributes, updateContainerAgentResponseContainerInstance.attributes) &&
        Objects.equals(this.registeredAt, updateContainerAgentResponseContainerInstance.registeredAt) &&
        Objects.equals(this.attachments, updateContainerAgentResponseContainerInstance.attachments) &&
        Objects.equals(this.tags, updateContainerAgentResponseContainerInstance.tags) &&
        Objects.equals(this.healthStatus, updateContainerAgentResponseContainerInstance.healthStatus);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateContainerAgentResponseContainerInstance {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateContainerAgentResponseContainerInstance
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateContainerAgentResponseContainerInstance.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateContainerAgentResponseContainerInstance is not found in the empty JSON string", UpdateContainerAgentResponseContainerInstance.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateContainerAgentResponseContainerInstance.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateContainerAgentResponseContainerInstance` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateContainerAgentResponseContainerInstance.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateContainerAgentResponseContainerInstance' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateContainerAgentResponseContainerInstance> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateContainerAgentResponseContainerInstance.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateContainerAgentResponseContainerInstance>() {
           @Override
           public void write(JsonWriter out, UpdateContainerAgentResponseContainerInstance value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateContainerAgentResponseContainerInstance read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateContainerAgentResponseContainerInstance given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateContainerAgentResponseContainerInstance
   * @throws IOException if the JSON string is invalid with respect to UpdateContainerAgentResponseContainerInstance
   */
  public static UpdateContainerAgentResponseContainerInstance fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateContainerAgentResponseContainerInstance.class);
  }

  /**
   * Convert an instance of UpdateContainerAgentResponseContainerInstance to an JSON string
   *
   * @return JSON string
   */
