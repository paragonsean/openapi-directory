...
public class UpdateServiceResponseService {
  ...
  public UpdateServiceResponseService() {
  }

  public UpdateServiceResponseService serviceArn(String serviceArn) {
  ...
  public UpdateServiceResponseService serviceName(String serviceName) {
  ...
  public UpdateServiceResponseService clusterArn(String clusterArn) {
  ...
  public UpdateServiceResponseService loadBalancers(List loadBalancers) {
  ...
  public UpdateServiceResponseService serviceRegistries(List serviceRegistries) {
  ...
  public UpdateServiceResponseService status(String status) {
    this.status = status;
    return this;
  }
  ...
  public UpdateServiceResponseService desiredCount(Integer desiredCount) {
  ...
  public UpdateServiceResponseService runningCount(Integer runningCount) {
  ...
  public UpdateServiceResponseService pendingCount(Integer pendingCount) {
  ...
  public UpdateServiceResponseService launchType(LaunchType launchType) {
  ...
  public UpdateServiceResponseService capacityProviderStrategy(List capacityProviderStrategy) {
  ...
  public UpdateServiceResponseService platformVersion(String platformVersion) {
  ...
  public UpdateServiceResponseService platformFamily(String platformFamily) {
  ...
  public UpdateServiceResponseService taskDefinition(String taskDefinition) {
  ...
  public UpdateServiceResponseService deploymentConfiguration(CreateServiceRequestDeploymentConfiguration deploymentConfiguration) {
  ...
  public UpdateServiceResponseService taskSets(List taskSets) {
  ...
  public UpdateServiceResponseService deployments(List deployments) {
  ...
  public UpdateServiceResponseService roleArn(String roleArn) {
  ...
  public UpdateServiceResponseService events(List events) {
    this.events = events;
    return this;
  }
  ...
  public UpdateServiceResponseService createdAt(OffsetDateTime createdAt) {
  ...
  public UpdateServiceResponseService placementConstraints(List placementConstraints) {
  ...
  public UpdateServiceResponseService placementStrategy(List placementStrategy) {
  ...
  public UpdateServiceResponseService networkConfiguration(StartTaskRequestNetworkConfiguration networkConfiguration) {
  ...
  public UpdateServiceResponseService healthCheckGracePeriodSeconds(Integer healthCheckGracePeriodSeconds) {
  ...
  public UpdateServiceResponseService schedulingStrategy(SchedulingStrategy schedulingStrategy) {
  ...
  public UpdateServiceResponseService deploymentController(ServiceDeploymentController deploymentController) {
  ...
  public UpdateServiceResponseService tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public UpdateServiceResponseService createdBy(String createdBy) {
  ...
  public UpdateServiceResponseService enableECSManagedTags(Boolean enableECSManagedTags) {
  ...
  public UpdateServiceResponseService propagateTags(PropagateTags propagateTags) {
  ...
  public UpdateServiceResponseService enableExecuteCommand(Boolean enableExecuteCommand) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateServiceResponseService updateServiceResponseService = (UpdateServiceResponseService) o;
    return Objects.equals(this.serviceArn, updateServiceResponseService.serviceArn) &&
        Objects.equals(this.serviceName, updateServiceResponseService.serviceName) &&
        Objects.equals(this.clusterArn, updateServiceResponseService.clusterArn) &&
        Objects.equals(this.loadBalancers, updateServiceResponseService.loadBalancers) &&
        Objects.equals(this.serviceRegistries, updateServiceResponseService.serviceRegistries) &&
        Objects.equals(this.status, updateServiceResponseService.status) &&
        Objects.equals(this.desiredCount, updateServiceResponseService.desiredCount) &&
        Objects.equals(this.runningCount, updateServiceResponseService.runningCount) &&
        Objects.equals(this.pendingCount, updateServiceResponseService.pendingCount) &&
        Objects.equals(this.launchType, updateServiceResponseService.launchType) &&
        Objects.equals(this.capacityProviderStrategy, updateServiceResponseService.capacityProviderStrategy) &&
        Objects.equals(this.platformVersion, updateServiceResponseService.platformVersion) &&
        Objects.equals(this.platformFamily, updateServiceResponseService.platformFamily) &&
        Objects.equals(this.taskDefinition, updateServiceResponseService.taskDefinition) &&
        Objects.equals(this.deploymentConfiguration, updateServiceResponseService.deploymentConfiguration) &&
        Objects.equals(this.taskSets, updateServiceResponseService.taskSets) &&
        Objects.equals(this.deployments, updateServiceResponseService.deployments) &&
        Objects.equals(this.roleArn, updateServiceResponseService.roleArn) &&
        Objects.equals(this.events, updateServiceResponseService.events) &&
        Objects.equals(this.createdAt, updateServiceResponseService.createdAt) &&
        Objects.equals(this.placementConstraints, updateServiceResponseService.placementConstraints) &&
        Objects.equals(this.placementStrategy, updateServiceResponseService.placementStrategy) &&
        Objects.equals(this.networkConfiguration, updateServiceResponseService.networkConfiguration) &&
        Objects.equals(this.healthCheckGracePeriodSeconds, updateServiceResponseService.healthCheckGracePeriodSeconds) &&
        Objects.equals(this.schedulingStrategy, updateServiceResponseService.schedulingStrategy) &&
        Objects.equals(this.deploymentController, updateServiceResponseService.deploymentController) &&
        Objects.equals(this.tags, updateServiceResponseService.tags) &&
        Objects.equals(this.createdBy, updateServiceResponseService.createdBy) &&
        Objects.equals(this.enableECSManagedTags, updateServiceResponseService.enableECSManagedTags) &&
        Objects.equals(this.propagateTags, updateServiceResponseService.propagateTags) &&
        Objects.equals(this.enableExecuteCommand, updateServiceResponseService.enableExecuteCommand);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateServiceResponseService {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateServiceResponseService
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateServiceResponseService.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateServiceResponseService is not found in the empty JSON string", UpdateServiceResponseService.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateServiceResponseService.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateServiceResponseService` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateServiceResponseService.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateServiceResponseService' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateServiceResponseService> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateServiceResponseService.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateServiceResponseService>() {
           @Override
           public void write(JsonWriter out, UpdateServiceResponseService value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateServiceResponseService read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateServiceResponseService given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateServiceResponseService
   * @throws IOException if the JSON string is invalid with respect to UpdateServiceResponseService
   */
  public static UpdateServiceResponseService fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateServiceResponseService.class);
  }

  /**
   * Convert an instance of UpdateServiceResponseService to an JSON string
   *
   * @return JSON string
   */
