...
public class TaskSet {
  ...
  public TaskSet taskSetArn(String taskSetArn) {
  ...
  public TaskSet serviceArn(String serviceArn) {
  ...
  public TaskSet clusterArn(String clusterArn) {
  ...
  public TaskSet startedBy(String startedBy) {
  ...
  public TaskSet externalId(String externalId) {
  ...
  public TaskSet status(String status) {
    this.status = status;
    return this;
  }
  ...
  public TaskSet taskDefinition(String taskDefinition) {
  ...
  public TaskSet computedDesiredCount(Integer computedDesiredCount) {
  ...
  public TaskSet pendingCount(Integer pendingCount) {
  ...
  public TaskSet runningCount(Integer runningCount) {
  ...
  public TaskSet createdAt(OffsetDateTime createdAt) {
  ...
  public TaskSet updatedAt(OffsetDateTime updatedAt) {
  ...
  public TaskSet launchType(LaunchType launchType) {
  ...
  public TaskSet capacityProviderStrategy(List capacityProviderStrategy) {
  ...
  public TaskSet platformVersion(String platformVersion) {
  ...
  public TaskSet platformFamily(String platformFamily) {
  ...
  public TaskSet networkConfiguration(TaskSetNetworkConfiguration networkConfiguration) {
  ...
  public TaskSet loadBalancers(List loadBalancers) {
  ...
  public TaskSet serviceRegistries(List serviceRegistries) {
  ...
  public TaskSet scale(TaskSetScale scale) {
    this.scale = scale;
    return this;
  }
  ...
  public TaskSet stabilityStatus(StabilityStatus stabilityStatus) {
  ...
  public TaskSet stabilityStatusAt(OffsetDateTime stabilityStatusAt) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, taskSet.id) &&
        Objects.equals(this.taskSetArn, taskSet.taskSetArn) &&
        Objects.equals(this.serviceArn, taskSet.serviceArn) &&
        Objects.equals(this.clusterArn, taskSet.clusterArn) &&
        Objects.equals(this.startedBy, taskSet.startedBy) &&
        Objects.equals(this.externalId, taskSet.externalId) &&
        Objects.equals(this.status, taskSet.status) &&
        Objects.equals(this.taskDefinition, taskSet.taskDefinition) &&
        Objects.equals(this.computedDesiredCount, taskSet.computedDesiredCount) &&
        Objects.equals(this.pendingCount, taskSet.pendingCount) &&
        Objects.equals(this.runningCount, taskSet.runningCount) &&
        Objects.equals(this.createdAt, taskSet.createdAt) &&
        Objects.equals(this.updatedAt, taskSet.updatedAt) &&
        Objects.equals(this.launchType, taskSet.launchType) &&
        Objects.equals(this.capacityProviderStrategy, taskSet.capacityProviderStrategy) &&
        Objects.equals(this.platformVersion, taskSet.platformVersion) &&
        Objects.equals(this.platformFamily, taskSet.platformFamily) &&
        Objects.equals(this.networkConfiguration, taskSet.networkConfiguration) &&
        Objects.equals(this.loadBalancers, taskSet.loadBalancers) &&
        Objects.equals(this.serviceRegistries, taskSet.serviceRegistries) &&
        Objects.equals(this.scale, taskSet.scale) &&
        Objects.equals(this.stabilityStatus, taskSet.stabilityStatus) &&
        Objects.equals(this.stabilityStatusAt, taskSet.stabilityStatusAt) &&
        Objects.equals(this.tags, taskSet.tags);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TaskSet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TaskSet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TaskSet is not found in the empty JSON string", TaskSet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TaskSet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TaskSet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TaskSet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TaskSet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TaskSet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TaskSet.class));

       return (TypeAdapter<T>) new TypeAdapter<TaskSet>() {
           @Override
           public void write(JsonWriter out, TaskSet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TaskSet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TaskSet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TaskSet
   * @throws IOException if the JSON string is invalid with respect to TaskSet
   */
  public static TaskSet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TaskSet.class);
  }

  /**
   * Convert an instance of TaskSet to an JSON string
   *
   * @return JSON string
   */
