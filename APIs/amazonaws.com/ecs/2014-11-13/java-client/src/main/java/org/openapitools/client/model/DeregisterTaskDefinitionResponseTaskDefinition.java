...
public class DeregisterTaskDefinitionResponseTaskDefinition {
  ...
  public DeregisterTaskDefinitionResponseTaskDefinition() {
  }

  public DeregisterTaskDefinitionResponseTaskDefinition taskDefinitionArn(String taskDefinitionArn) {
  ...
  public DeregisterTaskDefinitionResponseTaskDefinition containerDefinitions(List containerDefinitions) {
  ...
  public DeregisterTaskDefinitionResponseTaskDefinition family(String family) {
    this.family = family;
    return this;
  }
  ...
  public DeregisterTaskDefinitionResponseTaskDefinition taskRoleArn(String taskRoleArn) {
  ...
  public DeregisterTaskDefinitionResponseTaskDefinition executionRoleArn(String executionRoleArn) {
  ...
  public DeregisterTaskDefinitionResponseTaskDefinition networkMode(NetworkMode networkMode) {
  ...
  public DeregisterTaskDefinitionResponseTaskDefinition revision(Integer revision) {
  ...
  public DeregisterTaskDefinitionResponseTaskDefinition volumes(List volumes) {
  ...
  public DeregisterTaskDefinitionResponseTaskDefinition status(TaskDefinitionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public DeregisterTaskDefinitionResponseTaskDefinition requiresAttributes(List requiresAttributes) {
  ...
  public DeregisterTaskDefinitionResponseTaskDefinition placementConstraints(List placementConstraints) {
  ...
  public DeregisterTaskDefinitionResponseTaskDefinition compatibilities(List compatibilities) {
  ...
  public DeregisterTaskDefinitionResponseTaskDefinition runtimePlatform(TaskDefinitionRuntimePlatform runtimePlatform) {
  ...
  public DeregisterTaskDefinitionResponseTaskDefinition requiresCompatibilities(List requiresCompatibilities) {
  ...
  public DeregisterTaskDefinitionResponseTaskDefinition cpu(String cpu) {
    this.cpu = cpu;
    return this;
  }
  ...
  public DeregisterTaskDefinitionResponseTaskDefinition memory(String memory) {
    this.memory = memory;
    return this;
  }
  ...
  public DeregisterTaskDefinitionResponseTaskDefinition inferenceAccelerators(List inferenceAccelerators) {
  ...
  public DeregisterTaskDefinitionResponseTaskDefinition pidMode(PidMode pidMode) {
  ...
  public DeregisterTaskDefinitionResponseTaskDefinition ipcMode(IpcMode ipcMode) {
  ...
  public DeregisterTaskDefinitionResponseTaskDefinition proxyConfiguration(TaskDefinitionProxyConfiguration proxyConfiguration) {
  ...
  public DeregisterTaskDefinitionResponseTaskDefinition registeredAt(OffsetDateTime registeredAt) {
  ...
  public DeregisterTaskDefinitionResponseTaskDefinition deregisteredAt(OffsetDateTime deregisteredAt) {
  ...
  public DeregisterTaskDefinitionResponseTaskDefinition registeredBy(String registeredBy) {
  ...
  public DeregisterTaskDefinitionResponseTaskDefinition ephemeralStorage(TaskDefinitionEphemeralStorage ephemeralStorage) {
  ...
  public boolean equals(Object o) {
    ...
    DeregisterTaskDefinitionResponseTaskDefinition deregisterTaskDefinitionResponseTaskDefinition = (DeregisterTaskDefinitionResponseTaskDefinition) o;
    return Objects.equals(this.taskDefinitionArn, deregisterTaskDefinitionResponseTaskDefinition.taskDefinitionArn) &&
        Objects.equals(this.containerDefinitions, deregisterTaskDefinitionResponseTaskDefinition.containerDefinitions) &&
        Objects.equals(this.family, deregisterTaskDefinitionResponseTaskDefinition.family) &&
        Objects.equals(this.taskRoleArn, deregisterTaskDefinitionResponseTaskDefinition.taskRoleArn) &&
        Objects.equals(this.executionRoleArn, deregisterTaskDefinitionResponseTaskDefinition.executionRoleArn) &&
        Objects.equals(this.networkMode, deregisterTaskDefinitionResponseTaskDefinition.networkMode) &&
        Objects.equals(this.revision, deregisterTaskDefinitionResponseTaskDefinition.revision) &&
        Objects.equals(this.volumes, deregisterTaskDefinitionResponseTaskDefinition.volumes) &&
        Objects.equals(this.status, deregisterTaskDefinitionResponseTaskDefinition.status) &&
        Objects.equals(this.requiresAttributes, deregisterTaskDefinitionResponseTaskDefinition.requiresAttributes) &&
        Objects.equals(this.placementConstraints, deregisterTaskDefinitionResponseTaskDefinition.placementConstraints) &&
        Objects.equals(this.compatibilities, deregisterTaskDefinitionResponseTaskDefinition.compatibilities) &&
        Objects.equals(this.runtimePlatform, deregisterTaskDefinitionResponseTaskDefinition.runtimePlatform) &&
        Objects.equals(this.requiresCompatibilities, deregisterTaskDefinitionResponseTaskDefinition.requiresCompatibilities) &&
        Objects.equals(this.cpu, deregisterTaskDefinitionResponseTaskDefinition.cpu) &&
        Objects.equals(this.memory, deregisterTaskDefinitionResponseTaskDefinition.memory) &&
        Objects.equals(this.inferenceAccelerators, deregisterTaskDefinitionResponseTaskDefinition.inferenceAccelerators) &&
        Objects.equals(this.pidMode, deregisterTaskDefinitionResponseTaskDefinition.pidMode) &&
        Objects.equals(this.ipcMode, deregisterTaskDefinitionResponseTaskDefinition.ipcMode) &&
        Objects.equals(this.proxyConfiguration, deregisterTaskDefinitionResponseTaskDefinition.proxyConfiguration) &&
        Objects.equals(this.registeredAt, deregisterTaskDefinitionResponseTaskDefinition.registeredAt) &&
        Objects.equals(this.deregisteredAt, deregisterTaskDefinitionResponseTaskDefinition.deregisteredAt) &&
        Objects.equals(this.registeredBy, deregisterTaskDefinitionResponseTaskDefinition.registeredBy) &&
        Objects.equals(this.ephemeralStorage, deregisterTaskDefinitionResponseTaskDefinition.ephemeralStorage);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeregisterTaskDefinitionResponseTaskDefinition {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeregisterTaskDefinitionResponseTaskDefinition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeregisterTaskDefinitionResponseTaskDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeregisterTaskDefinitionResponseTaskDefinition is not found in the empty JSON string", DeregisterTaskDefinitionResponseTaskDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeregisterTaskDefinitionResponseTaskDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeregisterTaskDefinitionResponseTaskDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeregisterTaskDefinitionResponseTaskDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeregisterTaskDefinitionResponseTaskDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeregisterTaskDefinitionResponseTaskDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeregisterTaskDefinitionResponseTaskDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<DeregisterTaskDefinitionResponseTaskDefinition>() {
           @Override
           public void write(JsonWriter out, DeregisterTaskDefinitionResponseTaskDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeregisterTaskDefinitionResponseTaskDefinition read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeregisterTaskDefinitionResponseTaskDefinition given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeregisterTaskDefinitionResponseTaskDefinition
   * @throws IOException if the JSON string is invalid with respect to DeregisterTaskDefinitionResponseTaskDefinition
   */
  public static DeregisterTaskDefinitionResponseTaskDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeregisterTaskDefinitionResponseTaskDefinition.class);
  }

  /**
   * Convert an instance of DeregisterTaskDefinitionResponseTaskDefinition to an JSON string
   *
   * @return JSON string
   */
