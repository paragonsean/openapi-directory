...
public class UpdateServicePrimaryTaskSetResponseTaskSet {
  ...
  public UpdateServicePrimaryTaskSetResponseTaskSet() {
  }

  public UpdateServicePrimaryTaskSetResponseTaskSet id(String id) {
    this.id = id;
    return this;
  }
  ...
  public UpdateServicePrimaryTaskSetResponseTaskSet taskSetArn(String taskSetArn) {
  ...
  public UpdateServicePrimaryTaskSetResponseTaskSet serviceArn(String serviceArn) {
  ...
  public UpdateServicePrimaryTaskSetResponseTaskSet clusterArn(String clusterArn) {
  ...
  public UpdateServicePrimaryTaskSetResponseTaskSet startedBy(String startedBy) {
  ...
  public UpdateServicePrimaryTaskSetResponseTaskSet externalId(String externalId) {
  ...
  public UpdateServicePrimaryTaskSetResponseTaskSet status(String status) {
    this.status = status;
    return this;
  }
  ...
  public UpdateServicePrimaryTaskSetResponseTaskSet taskDefinition(String taskDefinition) {
  ...
  public UpdateServicePrimaryTaskSetResponseTaskSet computedDesiredCount(Integer computedDesiredCount) {
  ...
  public UpdateServicePrimaryTaskSetResponseTaskSet pendingCount(Integer pendingCount) {
  ...
  public UpdateServicePrimaryTaskSetResponseTaskSet runningCount(Integer runningCount) {
  ...
  public UpdateServicePrimaryTaskSetResponseTaskSet createdAt(OffsetDateTime createdAt) {
  ...
  public UpdateServicePrimaryTaskSetResponseTaskSet updatedAt(OffsetDateTime updatedAt) {
  ...
  public UpdateServicePrimaryTaskSetResponseTaskSet launchType(LaunchType launchType) {
  ...
  public UpdateServicePrimaryTaskSetResponseTaskSet capacityProviderStrategy(List capacityProviderStrategy) {
  ...
  public UpdateServicePrimaryTaskSetResponseTaskSet platformVersion(String platformVersion) {
  ...
  public UpdateServicePrimaryTaskSetResponseTaskSet platformFamily(String platformFamily) {
  ...
  public UpdateServicePrimaryTaskSetResponseTaskSet networkConfiguration(TaskSetNetworkConfiguration networkConfiguration) {
  ...
  public UpdateServicePrimaryTaskSetResponseTaskSet loadBalancers(List loadBalancers) {
  ...
  public UpdateServicePrimaryTaskSetResponseTaskSet serviceRegistries(List serviceRegistries) {
  ...
  public UpdateServicePrimaryTaskSetResponseTaskSet scale(TaskSetScale scale) {
    this.scale = scale;
    return this;
  }
  ...
  public UpdateServicePrimaryTaskSetResponseTaskSet stabilityStatus(StabilityStatus stabilityStatus) {
  ...
  public UpdateServicePrimaryTaskSetResponseTaskSet stabilityStatusAt(OffsetDateTime stabilityStatusAt) {
  ...
  public UpdateServicePrimaryTaskSetResponseTaskSet tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateServicePrimaryTaskSetResponseTaskSet updateServicePrimaryTaskSetResponseTaskSet = (UpdateServicePrimaryTaskSetResponseTaskSet) o;
    return Objects.equals(this.id, updateServicePrimaryTaskSetResponseTaskSet.id) &&
        Objects.equals(this.taskSetArn, updateServicePrimaryTaskSetResponseTaskSet.taskSetArn) &&
        Objects.equals(this.serviceArn, updateServicePrimaryTaskSetResponseTaskSet.serviceArn) &&
        Objects.equals(this.clusterArn, updateServicePrimaryTaskSetResponseTaskSet.clusterArn) &&
        Objects.equals(this.startedBy, updateServicePrimaryTaskSetResponseTaskSet.startedBy) &&
        Objects.equals(this.externalId, updateServicePrimaryTaskSetResponseTaskSet.externalId) &&
        Objects.equals(this.status, updateServicePrimaryTaskSetResponseTaskSet.status) &&
        Objects.equals(this.taskDefinition, updateServicePrimaryTaskSetResponseTaskSet.taskDefinition) &&
        Objects.equals(this.computedDesiredCount, updateServicePrimaryTaskSetResponseTaskSet.computedDesiredCount) &&
        Objects.equals(this.pendingCount, updateServicePrimaryTaskSetResponseTaskSet.pendingCount) &&
        Objects.equals(this.runningCount, updateServicePrimaryTaskSetResponseTaskSet.runningCount) &&
        Objects.equals(this.createdAt, updateServicePrimaryTaskSetResponseTaskSet.createdAt) &&
        Objects.equals(this.updatedAt, updateServicePrimaryTaskSetResponseTaskSet.updatedAt) &&
        Objects.equals(this.launchType, updateServicePrimaryTaskSetResponseTaskSet.launchType) &&
        Objects.equals(this.capacityProviderStrategy, updateServicePrimaryTaskSetResponseTaskSet.capacityProviderStrategy) &&
        Objects.equals(this.platformVersion, updateServicePrimaryTaskSetResponseTaskSet.platformVersion) &&
        Objects.equals(this.platformFamily, updateServicePrimaryTaskSetResponseTaskSet.platformFamily) &&
        Objects.equals(this.networkConfiguration, updateServicePrimaryTaskSetResponseTaskSet.networkConfiguration) &&
        Objects.equals(this.loadBalancers, updateServicePrimaryTaskSetResponseTaskSet.loadBalancers) &&
        Objects.equals(this.serviceRegistries, updateServicePrimaryTaskSetResponseTaskSet.serviceRegistries) &&
        Objects.equals(this.scale, updateServicePrimaryTaskSetResponseTaskSet.scale) &&
        Objects.equals(this.stabilityStatus, updateServicePrimaryTaskSetResponseTaskSet.stabilityStatus) &&
        Objects.equals(this.stabilityStatusAt, updateServicePrimaryTaskSetResponseTaskSet.stabilityStatusAt) &&
        Objects.equals(this.tags, updateServicePrimaryTaskSetResponseTaskSet.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateServicePrimaryTaskSetResponseTaskSet {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateServicePrimaryTaskSetResponseTaskSet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateServicePrimaryTaskSetResponseTaskSet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateServicePrimaryTaskSetResponseTaskSet is not found in the empty JSON string", UpdateServicePrimaryTaskSetResponseTaskSet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateServicePrimaryTaskSetResponseTaskSet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateServicePrimaryTaskSetResponseTaskSet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateServicePrimaryTaskSetResponseTaskSet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateServicePrimaryTaskSetResponseTaskSet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateServicePrimaryTaskSetResponseTaskSet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateServicePrimaryTaskSetResponseTaskSet.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateServicePrimaryTaskSetResponseTaskSet>() {
           @Override
           public void write(JsonWriter out, UpdateServicePrimaryTaskSetResponseTaskSet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateServicePrimaryTaskSetResponseTaskSet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateServicePrimaryTaskSetResponseTaskSet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateServicePrimaryTaskSetResponseTaskSet
   * @throws IOException if the JSON string is invalid with respect to UpdateServicePrimaryTaskSetResponseTaskSet
   */
  public static UpdateServicePrimaryTaskSetResponseTaskSet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateServicePrimaryTaskSetResponseTaskSet.class);
  }

  /**
   * Convert an instance of UpdateServicePrimaryTaskSetResponseTaskSet to an JSON string
   *
   * @return JSON string
   */
