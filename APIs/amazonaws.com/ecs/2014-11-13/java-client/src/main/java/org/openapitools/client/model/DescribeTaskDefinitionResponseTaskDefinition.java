...
public class DescribeTaskDefinitionResponseTaskDefinition {
  ...
  public DescribeTaskDefinitionResponseTaskDefinition() {
  }

  public DescribeTaskDefinitionResponseTaskDefinition taskDefinitionArn(String taskDefinitionArn) {
  ...
  public DescribeTaskDefinitionResponseTaskDefinition containerDefinitions(List containerDefinitions) {
  ...
  public DescribeTaskDefinitionResponseTaskDefinition family(String family) {
    this.family = family;
    return this;
  }
  ...
  public DescribeTaskDefinitionResponseTaskDefinition taskRoleArn(String taskRoleArn) {
  ...
  public DescribeTaskDefinitionResponseTaskDefinition executionRoleArn(String executionRoleArn) {
  ...
  public DescribeTaskDefinitionResponseTaskDefinition networkMode(NetworkMode networkMode) {
  ...
  public DescribeTaskDefinitionResponseTaskDefinition revision(Integer revision) {
  ...
  public DescribeTaskDefinitionResponseTaskDefinition volumes(List volumes) {
  ...
  public DescribeTaskDefinitionResponseTaskDefinition status(TaskDefinitionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public DescribeTaskDefinitionResponseTaskDefinition requiresAttributes(List requiresAttributes) {
  ...
  public DescribeTaskDefinitionResponseTaskDefinition placementConstraints(List placementConstraints) {
  ...
  public DescribeTaskDefinitionResponseTaskDefinition compatibilities(List compatibilities) {
  ...
  public DescribeTaskDefinitionResponseTaskDefinition runtimePlatform(TaskDefinitionRuntimePlatform runtimePlatform) {
  ...
  public DescribeTaskDefinitionResponseTaskDefinition requiresCompatibilities(List requiresCompatibilities) {
  ...
  public DescribeTaskDefinitionResponseTaskDefinition cpu(String cpu) {
    this.cpu = cpu;
    return this;
  }
  ...
  public DescribeTaskDefinitionResponseTaskDefinition memory(String memory) {
    this.memory = memory;
    return this;
  }
  ...
  public DescribeTaskDefinitionResponseTaskDefinition inferenceAccelerators(List inferenceAccelerators) {
  ...
  public DescribeTaskDefinitionResponseTaskDefinition pidMode(PidMode pidMode) {
  ...
  public DescribeTaskDefinitionResponseTaskDefinition ipcMode(IpcMode ipcMode) {
  ...
  public DescribeTaskDefinitionResponseTaskDefinition proxyConfiguration(TaskDefinitionProxyConfiguration proxyConfiguration) {
  ...
  public DescribeTaskDefinitionResponseTaskDefinition registeredAt(OffsetDateTime registeredAt) {
  ...
  public DescribeTaskDefinitionResponseTaskDefinition deregisteredAt(OffsetDateTime deregisteredAt) {
  ...
  public DescribeTaskDefinitionResponseTaskDefinition registeredBy(String registeredBy) {
  ...
  public DescribeTaskDefinitionResponseTaskDefinition ephemeralStorage(TaskDefinitionEphemeralStorage ephemeralStorage) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeTaskDefinitionResponseTaskDefinition describeTaskDefinitionResponseTaskDefinition = (DescribeTaskDefinitionResponseTaskDefinition) o;
    return Objects.equals(this.taskDefinitionArn, describeTaskDefinitionResponseTaskDefinition.taskDefinitionArn) &&
        Objects.equals(this.containerDefinitions, describeTaskDefinitionResponseTaskDefinition.containerDefinitions) &&
        Objects.equals(this.family, describeTaskDefinitionResponseTaskDefinition.family) &&
        Objects.equals(this.taskRoleArn, describeTaskDefinitionResponseTaskDefinition.taskRoleArn) &&
        Objects.equals(this.executionRoleArn, describeTaskDefinitionResponseTaskDefinition.executionRoleArn) &&
        Objects.equals(this.networkMode, describeTaskDefinitionResponseTaskDefinition.networkMode) &&
        Objects.equals(this.revision, describeTaskDefinitionResponseTaskDefinition.revision) &&
        Objects.equals(this.volumes, describeTaskDefinitionResponseTaskDefinition.volumes) &&
        Objects.equals(this.status, describeTaskDefinitionResponseTaskDefinition.status) &&
        Objects.equals(this.requiresAttributes, describeTaskDefinitionResponseTaskDefinition.requiresAttributes) &&
        Objects.equals(this.placementConstraints, describeTaskDefinitionResponseTaskDefinition.placementConstraints) &&
        Objects.equals(this.compatibilities, describeTaskDefinitionResponseTaskDefinition.compatibilities) &&
        Objects.equals(this.runtimePlatform, describeTaskDefinitionResponseTaskDefinition.runtimePlatform) &&
        Objects.equals(this.requiresCompatibilities, describeTaskDefinitionResponseTaskDefinition.requiresCompatibilities) &&
        Objects.equals(this.cpu, describeTaskDefinitionResponseTaskDefinition.cpu) &&
        Objects.equals(this.memory, describeTaskDefinitionResponseTaskDefinition.memory) &&
        Objects.equals(this.inferenceAccelerators, describeTaskDefinitionResponseTaskDefinition.inferenceAccelerators) &&
        Objects.equals(this.pidMode, describeTaskDefinitionResponseTaskDefinition.pidMode) &&
        Objects.equals(this.ipcMode, describeTaskDefinitionResponseTaskDefinition.ipcMode) &&
        Objects.equals(this.proxyConfiguration, describeTaskDefinitionResponseTaskDefinition.proxyConfiguration) &&
        Objects.equals(this.registeredAt, describeTaskDefinitionResponseTaskDefinition.registeredAt) &&
        Objects.equals(this.deregisteredAt, describeTaskDefinitionResponseTaskDefinition.deregisteredAt) &&
        Objects.equals(this.registeredBy, describeTaskDefinitionResponseTaskDefinition.registeredBy) &&
        Objects.equals(this.ephemeralStorage, describeTaskDefinitionResponseTaskDefinition.ephemeralStorage);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeTaskDefinitionResponseTaskDefinition {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeTaskDefinitionResponseTaskDefinition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeTaskDefinitionResponseTaskDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeTaskDefinitionResponseTaskDefinition is not found in the empty JSON string", DescribeTaskDefinitionResponseTaskDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeTaskDefinitionResponseTaskDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeTaskDefinitionResponseTaskDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeTaskDefinitionResponseTaskDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeTaskDefinitionResponseTaskDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeTaskDefinitionResponseTaskDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeTaskDefinitionResponseTaskDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeTaskDefinitionResponseTaskDefinition>() {
           @Override
           public void write(JsonWriter out, DescribeTaskDefinitionResponseTaskDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeTaskDefinitionResponseTaskDefinition read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeTaskDefinitionResponseTaskDefinition given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeTaskDefinitionResponseTaskDefinition
   * @throws IOException if the JSON string is invalid with respect to DescribeTaskDefinitionResponseTaskDefinition
   */
  public static DescribeTaskDefinitionResponseTaskDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeTaskDefinitionResponseTaskDefinition.class);
  }

  /**
   * Convert an instance of DescribeTaskDefinitionResponseTaskDefinition to an JSON string
   *
   * @return JSON string
   */
