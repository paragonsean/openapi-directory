...
public class PutClusterCapacityProvidersResponseCluster {
  ...
  public PutClusterCapacityProvidersResponseCluster() {
  }

  public PutClusterCapacityProvidersResponseCluster clusterArn(String clusterArn) {
  ...
  public PutClusterCapacityProvidersResponseCluster clusterName(String clusterName) {
  ...
  public PutClusterCapacityProvidersResponseCluster _configuration(UpdateClusterRequestConfiguration _configuration) {
  ...
  public PutClusterCapacityProvidersResponseCluster status(String status) {
    this.status = status;
    return this;
  }
  ...
  public PutClusterCapacityProvidersResponseCluster registeredContainerInstancesCount(Integer registeredContainerInstancesCount) {
  ...
  public PutClusterCapacityProvidersResponseCluster runningTasksCount(Integer runningTasksCount) {
  ...
  public PutClusterCapacityProvidersResponseCluster pendingTasksCount(Integer pendingTasksCount) {
  ...
  public PutClusterCapacityProvidersResponseCluster activeServicesCount(Integer activeServicesCount) {
  ...
  public PutClusterCapacityProvidersResponseCluster statistics(List statistics) {
  ...
  public PutClusterCapacityProvidersResponseCluster tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public PutClusterCapacityProvidersResponseCluster settings(List settings) {
  ...
  public PutClusterCapacityProvidersResponseCluster capacityProviders(List capacityProviders) {
  ...
  public PutClusterCapacityProvidersResponseCluster defaultCapacityProviderStrategy(List defaultCapacityProviderStrategy) {
  ...
  public PutClusterCapacityProvidersResponseCluster attachments(List attachments) {
  ...
  public PutClusterCapacityProvidersResponseCluster attachmentsStatus(String attachmentsStatus) {
  ...
  public PutClusterCapacityProvidersResponseCluster serviceConnectDefaults(ClusterServiceConnectDefaults serviceConnectDefaults) {
  ...
  public boolean equals(Object o) {
    ...
    PutClusterCapacityProvidersResponseCluster putClusterCapacityProvidersResponseCluster = (PutClusterCapacityProvidersResponseCluster) o;
    return Objects.equals(this.clusterArn, putClusterCapacityProvidersResponseCluster.clusterArn) &&
        Objects.equals(this.clusterName, putClusterCapacityProvidersResponseCluster.clusterName) &&
        Objects.equals(this._configuration, putClusterCapacityProvidersResponseCluster._configuration) &&
        Objects.equals(this.status, putClusterCapacityProvidersResponseCluster.status) &&
        Objects.equals(this.registeredContainerInstancesCount, putClusterCapacityProvidersResponseCluster.registeredContainerInstancesCount) &&
        Objects.equals(this.runningTasksCount, putClusterCapacityProvidersResponseCluster.runningTasksCount) &&
        Objects.equals(this.pendingTasksCount, putClusterCapacityProvidersResponseCluster.pendingTasksCount) &&
        Objects.equals(this.activeServicesCount, putClusterCapacityProvidersResponseCluster.activeServicesCount) &&
        Objects.equals(this.statistics, putClusterCapacityProvidersResponseCluster.statistics) &&
        Objects.equals(this.tags, putClusterCapacityProvidersResponseCluster.tags) &&
        Objects.equals(this.settings, putClusterCapacityProvidersResponseCluster.settings) &&
        Objects.equals(this.capacityProviders, putClusterCapacityProvidersResponseCluster.capacityProviders) &&
        Objects.equals(this.defaultCapacityProviderStrategy, putClusterCapacityProvidersResponseCluster.defaultCapacityProviderStrategy) &&
        Objects.equals(this.attachments, putClusterCapacityProvidersResponseCluster.attachments) &&
        Objects.equals(this.attachmentsStatus, putClusterCapacityProvidersResponseCluster.attachmentsStatus) &&
        Objects.equals(this.serviceConnectDefaults, putClusterCapacityProvidersResponseCluster.serviceConnectDefaults);
  }
  ...
  public String toString() {
    ...
    sb.append("class PutClusterCapacityProvidersResponseCluster {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutClusterCapacityProvidersResponseCluster
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutClusterCapacityProvidersResponseCluster.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutClusterCapacityProvidersResponseCluster is not found in the empty JSON string", PutClusterCapacityProvidersResponseCluster.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutClusterCapacityProvidersResponseCluster.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutClusterCapacityProvidersResponseCluster` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutClusterCapacityProvidersResponseCluster.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutClusterCapacityProvidersResponseCluster' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutClusterCapacityProvidersResponseCluster> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutClusterCapacityProvidersResponseCluster.class));

       return (TypeAdapter<T>) new TypeAdapter<PutClusterCapacityProvidersResponseCluster>() {
           @Override
           public void write(JsonWriter out, PutClusterCapacityProvidersResponseCluster value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutClusterCapacityProvidersResponseCluster read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutClusterCapacityProvidersResponseCluster given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutClusterCapacityProvidersResponseCluster
   * @throws IOException if the JSON string is invalid with respect to PutClusterCapacityProvidersResponseCluster
   */
  public static PutClusterCapacityProvidersResponseCluster fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutClusterCapacityProvidersResponseCluster.class);
  }

  /**
   * Convert an instance of PutClusterCapacityProvidersResponseCluster to an JSON string
   *
   * @return JSON string
   */
