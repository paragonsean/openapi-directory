...
public class StartTaskRequestOverrides {
  ...
  public StartTaskRequestOverrides() {
  }

  public StartTaskRequestOverrides containerOverrides(List containerOverrides) {
  ...
  public StartTaskRequestOverrides cpu(String cpu) {
    this.cpu = cpu;
    return this;
  }
  ...
  public StartTaskRequestOverrides inferenceAcceleratorOverrides(List inferenceAcceleratorOverrides) {
  ...
  public StartTaskRequestOverrides executionRoleArn(String executionRoleArn) {
  ...
  public StartTaskRequestOverrides memory(String memory) {
    this.memory = memory;
    return this;
  }
  ...
  public StartTaskRequestOverrides taskRoleArn(String taskRoleArn) {
  ...
  public StartTaskRequestOverrides ephemeralStorage(TaskOverrideEphemeralStorage ephemeralStorage) {
  ...
  public boolean equals(Object o) {
    ...
    StartTaskRequestOverrides startTaskRequestOverrides = (StartTaskRequestOverrides) o;
    return Objects.equals(this.containerOverrides, startTaskRequestOverrides.containerOverrides) &&
        Objects.equals(this.cpu, startTaskRequestOverrides.cpu) &&
        Objects.equals(this.inferenceAcceleratorOverrides, startTaskRequestOverrides.inferenceAcceleratorOverrides) &&
        Objects.equals(this.executionRoleArn, startTaskRequestOverrides.executionRoleArn) &&
        Objects.equals(this.memory, startTaskRequestOverrides.memory) &&
        Objects.equals(this.taskRoleArn, startTaskRequestOverrides.taskRoleArn) &&
        Objects.equals(this.ephemeralStorage, startTaskRequestOverrides.ephemeralStorage);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartTaskRequestOverrides {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartTaskRequestOverrides
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartTaskRequestOverrides.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartTaskRequestOverrides is not found in the empty JSON string", StartTaskRequestOverrides.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartTaskRequestOverrides.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartTaskRequestOverrides` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartTaskRequestOverrides.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartTaskRequestOverrides' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartTaskRequestOverrides> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartTaskRequestOverrides.class));

       return (TypeAdapter<T>) new TypeAdapter<StartTaskRequestOverrides>() {
           @Override
           public void write(JsonWriter out, StartTaskRequestOverrides value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartTaskRequestOverrides read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartTaskRequestOverrides given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartTaskRequestOverrides
   * @throws IOException if the JSON string is invalid with respect to StartTaskRequestOverrides
   */
  public static StartTaskRequestOverrides fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartTaskRequestOverrides.class);
  }

  /**
   * Convert an instance of StartTaskRequestOverrides to an JSON string
   *
   * @return JSON string
   */
