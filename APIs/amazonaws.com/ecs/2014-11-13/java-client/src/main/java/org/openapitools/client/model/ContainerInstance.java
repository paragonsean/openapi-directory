...
public class ContainerInstance {
  ...
  public ContainerInstance containerInstanceArn(String containerInstanceArn) {
  ...
  public ContainerInstance ec2InstanceId(String ec2InstanceId) {
  ...
  public ContainerInstance capacityProviderName(String capacityProviderName) {
  ...
  public ContainerInstance version(Integer version) {
  ...
  public ContainerInstance versionInfo(ContainerInstanceVersionInfo versionInfo) {
  ...
  public ContainerInstance remainingResources(List remainingResources) {
  ...
  public ContainerInstance registeredResources(List registeredResources) {
  ...
  public ContainerInstance status(String status) {
    this.status = status;
    return this;
  }
  ...
  public ContainerInstance statusReason(String statusReason) {
  ...
  public ContainerInstance agentConnected(Boolean agentConnected) {
  ...
  public ContainerInstance runningTasksCount(Integer runningTasksCount) {
  ...
  public ContainerInstance pendingTasksCount(Integer pendingTasksCount) {
  ...
  public ContainerInstance agentUpdateStatus(AgentUpdateStatus agentUpdateStatus) {
  ...
  public ContainerInstance attributes(List attributes) {
  ...
  public ContainerInstance registeredAt(OffsetDateTime registeredAt) {
  ...
  public ContainerInstance attachments(List attachments) {
  ...
  public ContainerInstance tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public ContainerInstance healthStatus(ContainerInstanceHealthStatus healthStatus) {
  ...
  public boolean equals(Object o) {
    ...
    ContainerInstance containerInstance = (ContainerInstance) o;
    return Objects.equals(this.containerInstanceArn, containerInstance.containerInstanceArn) &&
        Objects.equals(this.ec2InstanceId, containerInstance.ec2InstanceId) &&
        Objects.equals(this.capacityProviderName, containerInstance.capacityProviderName) &&
        Objects.equals(this.version, containerInstance.version) &&
        Objects.equals(this.versionInfo, containerInstance.versionInfo) &&
        Objects.equals(this.remainingResources, containerInstance.remainingResources) &&
        Objects.equals(this.registeredResources, containerInstance.registeredResources) &&
        Objects.equals(this.status, containerInstance.status) &&
        Objects.equals(this.statusReason, containerInstance.statusReason) &&
        Objects.equals(this.agentConnected, containerInstance.agentConnected) &&
        Objects.equals(this.runningTasksCount, containerInstance.runningTasksCount) &&
        Objects.equals(this.pendingTasksCount, containerInstance.pendingTasksCount) &&
        Objects.equals(this.agentUpdateStatus, containerInstance.agentUpdateStatus) &&
        Objects.equals(this.attributes, containerInstance.attributes) &&
        Objects.equals(this.registeredAt, containerInstance.registeredAt) &&
        Objects.equals(this.attachments, containerInstance.attachments) &&
        Objects.equals(this.tags, containerInstance.tags) &&
        Objects.equals(this.healthStatus, containerInstance.healthStatus);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContainerInstance {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContainerInstance
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContainerInstance.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContainerInstance is not found in the empty JSON string", ContainerInstance.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContainerInstance.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContainerInstance` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContainerInstance.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContainerInstance' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContainerInstance> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContainerInstance.class));

       return (TypeAdapter<T>) new TypeAdapter<ContainerInstance>() {
           @Override
           public void write(JsonWriter out, ContainerInstance value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContainerInstance read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ContainerInstance given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ContainerInstance
   * @throws IOException if the JSON string is invalid with respect to ContainerInstance
   */
  public static ContainerInstance fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContainerInstance.class);
  }

  /**
   * Convert an instance of ContainerInstance to an JSON string
   *
   * @return JSON string
   */
