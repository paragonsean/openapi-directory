...
public class ListClustersResponse {
  public static final String SERIALIZED_NAME_CLUSTER_ARNS = "clusterArns";
  @SerializedName(SERIALIZED_NAME_CLUSTER_ARNS)
  private List clusterArns;
  ...
  public ListClustersResponse clusterArns(List clusterArns) {
  ...
  public List getClusterArns() {
    return clusterArns;
  }

  public void setClusterArns(List clusterArns) {
    this.clusterArns = clusterArns;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.clusterArns, listClustersResponse.clusterArns) &&
        Objects.equals(this.nextToken, listClustersResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clusterArns, nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("    clusterArns: ").append(toIndentedString(clusterArns)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `clusterArns`
      if (jsonObj.get("clusterArns") != null && !jsonObj.get("clusterArns").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("clusterArns"));
      }
