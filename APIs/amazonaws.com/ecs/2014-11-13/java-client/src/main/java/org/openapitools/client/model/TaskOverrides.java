...
public class TaskOverrides {
  ...
  public TaskOverrides() {
  }

  public TaskOverrides containerOverrides(List containerOverrides) {
  ...
  public TaskOverrides cpu(String cpu) {
    this.cpu = cpu;
    return this;
  }
  ...
  public TaskOverrides inferenceAcceleratorOverrides(List inferenceAcceleratorOverrides) {
  ...
  public TaskOverrides executionRoleArn(String executionRoleArn) {
  ...
  public TaskOverrides memory(String memory) {
    this.memory = memory;
    return this;
  }
  ...
  public TaskOverrides taskRoleArn(String taskRoleArn) {
  ...
  public TaskOverrides ephemeralStorage(TaskOverrideEphemeralStorage ephemeralStorage) {
  ...
  public boolean equals(Object o) {
    ...
    TaskOverrides taskOverrides = (TaskOverrides) o;
    return Objects.equals(this.containerOverrides, taskOverrides.containerOverrides) &&
        Objects.equals(this.cpu, taskOverrides.cpu) &&
        Objects.equals(this.inferenceAcceleratorOverrides, taskOverrides.inferenceAcceleratorOverrides) &&
        Objects.equals(this.executionRoleArn, taskOverrides.executionRoleArn) &&
        Objects.equals(this.memory, taskOverrides.memory) &&
        Objects.equals(this.taskRoleArn, taskOverrides.taskRoleArn) &&
        Objects.equals(this.ephemeralStorage, taskOverrides.ephemeralStorage);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TaskOverrides
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TaskOverrides.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TaskOverrides is not found in the empty JSON string", TaskOverrides.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TaskOverrides.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TaskOverrides` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TaskOverrides.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TaskOverrides' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TaskOverrides> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TaskOverrides.class));

       return (TypeAdapter<T>) new TypeAdapter<TaskOverrides>() {
           @Override
           public void write(JsonWriter out, TaskOverrides value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TaskOverrides read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TaskOverrides given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TaskOverrides
   * @throws IOException if the JSON string is invalid with respect to TaskOverrides
   */
  public static TaskOverrides fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TaskOverrides.class);
  }

  /**
   * Convert an instance of TaskOverrides to an JSON string
   *
   * @return JSON string
   */
