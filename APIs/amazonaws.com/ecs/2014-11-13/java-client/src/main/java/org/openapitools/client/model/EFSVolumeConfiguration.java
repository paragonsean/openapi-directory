...
public class EFSVolumeConfiguration {
  ...
  public EFSVolumeConfiguration fileSystemId(String fileSystemId) {
  ...
  public EFSVolumeConfiguration rootDirectory(String rootDirectory) {
  ...
  public EFSVolumeConfiguration transitEncryption(EFSTransitEncryption transitEncryption) {
  ...
  public EFSVolumeConfiguration transitEncryptionPort(Integer transitEncryptionPort) {
  ...
  public EFSVolumeConfiguration authorizationConfig(EFSVolumeConfigurationAuthorizationConfig authorizationConfig) {
  ...
  public boolean equals(Object o) {
    ...
    EFSVolumeConfiguration efSVolumeConfiguration = (EFSVolumeConfiguration) o;
    return Objects.equals(this.fileSystemId, efSVolumeConfiguration.fileSystemId) &&
        Objects.equals(this.rootDirectory, efSVolumeConfiguration.rootDirectory) &&
        Objects.equals(this.transitEncryption, efSVolumeConfiguration.transitEncryption) &&
        Objects.equals(this.transitEncryptionPort, efSVolumeConfiguration.transitEncryptionPort) &&
        Objects.equals(this.authorizationConfig, efSVolumeConfiguration.authorizationConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class EFSVolumeConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EFSVolumeConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EFSVolumeConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EFSVolumeConfiguration is not found in the empty JSON string", EFSVolumeConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EFSVolumeConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EFSVolumeConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EFSVolumeConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EFSVolumeConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EFSVolumeConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EFSVolumeConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EFSVolumeConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<EFSVolumeConfiguration>() {
           @Override
           public void write(JsonWriter out, EFSVolumeConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EFSVolumeConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EFSVolumeConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EFSVolumeConfiguration
   * @throws IOException if the JSON string is invalid with respect to EFSVolumeConfiguration
   */
  public static EFSVolumeConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EFSVolumeConfiguration.class);
  }

  /**
   * Convert an instance of EFSVolumeConfiguration to an JSON string
   *
   * @return JSON string
   */
