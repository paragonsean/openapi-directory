...
class CapacityProviderAutoScalingGroupProvider(Model):
    ...
    def __init__(self, auto_scaling_group_arn: str=None, managed_scaling: AutoScalingGroupProviderManagedScaling=None, managed_termination_protection: ManagedTerminationProtection=None):
        """CapacityProviderAutoScalingGroupProvider - a model defined in OpenAPI

        :param auto_scaling_group_arn: The auto_scaling_group_arn of this CapacityProviderAutoScalingGroupProvider.
        :param managed_scaling: The managed_scaling of this CapacityProviderAutoScalingGroupProvider.
        :param managed_termination_protection: The managed_termination_protection of this CapacityProviderAutoScalingGroupProvider.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CapacityProviderAutoScalingGroupProvider':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CapacityProvider_autoScalingGroupProvider of this CapacityProviderAutoScalingGroupProvider.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def auto_scaling_group_arn(self):
        """Gets the auto_scaling_group_arn of this CapacityProviderAutoScalingGroupProvider.


        :return: The auto_scaling_group_arn of this CapacityProviderAutoScalingGroupProvider.
        :rtype: str
        """
    ...
    def auto_scaling_group_arn(self, auto_scaling_group_arn):
        """Sets the auto_scaling_group_arn of this CapacityProviderAutoScalingGroupProvider.
    ...
    def managed_scaling(self):
        """Gets the managed_scaling of this CapacityProviderAutoScalingGroupProvider.


        :return: The managed_scaling of this CapacityProviderAutoScalingGroupProvider.
    ...
    def managed_scaling(self, managed_scaling):
        """Sets the managed_scaling of this CapacityProviderAutoScalingGroupProvider.
    ...
    def managed_termination_protection(self):
        """Gets the managed_termination_protection of this CapacityProviderAutoScalingGroupProvider.


        :return: The managed_termination_protection of this CapacityProviderAutoScalingGroupProvider.
    ...
    def managed_termination_protection(self, managed_termination_protection):
        """Sets the managed_termination_protection of this CapacityProviderAutoScalingGroupProvider.
