...
async def test_create_capacity_provider(client):
    """Test case for create_capacity_provider

    
    """
    body = {"autoScalingGroupProvider":{"managedTerminationProtection":"","autoScalingGroupArn":"","managedScaling":{"instanceWarmupPeriod":"","targetCapacity":"","maximumScalingStepSize":"","minimumScalingStepSize":"","status":""}},"name":"","tags":""}
    headers = { 
...
async def test_create_cluster(client):
    ...
    """
    body = {"serviceConnectDefaults":{"namespace":""},"settings":"","capacityProviders":"","configuration":{"executeCommandConfiguration":{"logging":"","logConfiguration":{"cloudWatchEncryptionEnabled":"","s3EncryptionEnabled":"","s3BucketName":"","s3KeyPrefix":"","cloudWatchLogGroupName":""},"kmsKeyId":""}},"clusterName":"","defaultCapacityProviderStrategy":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_service(client):
    ...
    """
    body = {"enableExecuteCommand":"","cluster":"","placementConstraints":"","role":"","propagateTags":"","networkConfiguration":{"awsvpcConfiguration":{"assignPublicIp":"","subnets":"","securityGroups":""}},"clientToken":"","desiredCount":"","loadBalancers":"","serviceRegistries":"","deploymentController":{"type":""},"serviceConnectConfiguration":{"namespace":"","logConfiguration":{"secretOptions":"","logDriver":"","options":""},"services":"","enabled":""},"serviceName":"","tags":"","deploymentConfiguration":{"maximumPercent":"","alarms":{"rollback":"","alarmNames":"","enable":""},"minimumHealthyPercent":"","deploymentCircuitBreaker":{"rollback":"","enable":""}},"placementStrategy":"","schedulingStrategy":"","platformVersion":"","taskDefinition":"","enableECSManagedTags":"","capacityProviderStrategy":"","launchType":"","healthCheckGracePeriodSeconds":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_task_set(client):
    """Test case for create_task_set

    
    """
    body = {"cluster":"","networkConfiguration":{"awsvpcConfiguration":{"assignPublicIp":"","subnets":"","securityGroups":""}},"clientToken":"","loadBalancers":"","externalId":"","serviceRegistries":"","scale":{"unit":"","value":""},"tags":"","service":"","platformVersion":"","taskDefinition":"","capacityProviderStrategy":"","launchType":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.CreateTaskSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_account_setting(client):
    """Test case for delete_account_setting
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DeleteAccountSetting',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_attributes(client):
    """Test case for delete_attributes
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DeleteAttributes',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_capacity_provider(client):
    """Test case for delete_capacity_provider
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DeleteCapacityProvider',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_task_definitions(client):
    """Test case for delete_task_definitions
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DeleteTaskDefinitions',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_task_set(client):
    """Test case for delete_task_set

    
    """
    body = {"cluster":"","taskSet":"","service":"","force":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DeleteTaskSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_deregister_container_instance(client):
    """Test case for deregister_container_instance
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DeregisterContainerInstance',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_deregister_task_definition(client):
    """Test case for deregister_task_definition
...
async def test_describe_capacity_providers(client):
    """Test case for describe_capacity_providers

    
    """
    body = {"include":"","capacityProviders":"","maxResults":"","nextToken":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_describe_clusters(client):
    """Test case for describe_clusters

    
    """
    body = {"include":"","clusters":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_describe_container_instances(client):
    """Test case for describe_container_instances

    
    """
    body = {"cluster":"","include":"","containerInstances":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_describe_services(client):
    """Test case for describe_services

    
    """
    body = {"cluster":"","include":"","services":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_describe_task_definition(client):
    """Test case for describe_task_definition

    
    """
    body = {"include":"","taskDefinition":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_describe_task_sets(client):
    """Test case for describe_task_sets

    
    """
    body = {"cluster":"","include":"","service":"","taskSets":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DescribeTaskSets',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_tasks(client):
    """Test case for describe_tasks

    
    """
    body = {"cluster":"","include":"","tasks":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_discover_poll_endpoint(client):
    """Test case for discover_poll_endpoint
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DiscoverPollEndpoint',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_execute_command(client):
    ...
    """
    body = {"container":"","cluster":"","task":"","interactive":"","command":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_get_task_protection(client):
    """Test case for get_task_protection
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.GetTaskProtection',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_account_settings(client):
    ...
    """
    body = {"effectiveSettings":"","nextToken":"","maxResults":"","name":"","value":"","principalArn":""}
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.ListAccountSettings',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_attributes(client):
    """Test case for list_attributes

    
    """
    body = {"cluster":"","attributeValue":"","nextToken":"","maxResults":"","targetType":"","attributeName":""}
    params = [('maxResults', 'max_results_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.ListAttributes',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_container_instances(client):
    """Test case for list_container_instances

    
    """
    body = {"filter":"","cluster":"","nextToken":"","maxResults":"","status":""}
    params = [('maxResults', 'max_results_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_services(client):
    ...
    """
    body = {"cluster":"","nextToken":"","maxResults":"","schedulingStrategy":"","launchType":""}
    params = [('maxResults', 'max_results_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_services_by_namespace(client):
    """Test case for list_services_by_namespace

    
    """
    body = {"nextToken":"","maxResults":"","namespace":""}
    params = [('maxResults', 'max_results_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.ListServicesByNamespace',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_task_definition_families(client):
    """Test case for list_task_definition_families

    
    """
    body = {"familyPrefix":"","nextToken":"","maxResults":"","status":""}
    params = [('maxResults', 'max_results_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_task_definitions(client):
    """Test case for list_task_definitions

    
    """
    body = {"familyPrefix":"","nextToken":"","maxResults":"","sort":"","status":""}
    params = [('maxResults', 'max_results_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_tasks(client):
    ...
    """
    body = {"cluster":"","containerInstance":"","startedBy":"","nextToken":"","maxResults":"","family":"","serviceName":"","desiredStatus":"","launchType":""}
    params = [('maxResults', 'max_results_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_put_account_setting(client):
    """Test case for put_account_setting
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.PutAccountSetting',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_put_account_setting_default(client):
    """Test case for put_account_setting_default
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.PutAccountSettingDefault',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_put_attributes(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.PutAttributes',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_put_cluster_capacity_providers(client):
    """Test case for put_cluster_capacity_providers
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.PutClusterCapacityProviders',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_register_container_instance(client):
    """Test case for register_container_instance

    
    """
    body = {"cluster":"","totalResources":"","instanceIdentityDocumentSignature":"","instanceIdentityDocument":"","attributes":"","versionInfo":{"dockerVersion":"","agentHash":"","agentVersion":""},"platformDevices":"","containerInstanceArn":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.RegisterContainerInstance',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_register_task_definition(client):
    """Test case for register_task_definition

    
    """
    body = {"networkMode":"","ephemeralStorage":{"sizeInGiB":""},"placementConstraints":"","pidMode":"","memory":"","runtimePlatform":{"operatingSystemFamily":"","cpuArchitecture":""},"inferenceAccelerators":"","volumes":"","cpu":"","tags":"","executionRoleArn":"","taskRoleArn":"","ipcMode":"","family":"","requiresCompatibilities":"","containerDefinitions":"","proxyConfiguration":{"containerName":"","type":"","properties":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_run_task(client):
    ...
    """
    body = {"enableExecuteCommand":"","cluster":"","placementConstraints":"","propagateTags":"","networkConfiguration":{"awsvpcConfiguration":{"assignPublicIp":"","subnets":"","securityGroups":""}},"startedBy":"","count":"","overrides":{"ephemeralStorage":{"sizeInGiB":""},"containerOverrides":"","memory":"","executionRoleArn":"","taskRoleArn":"","cpu":"","inferenceAcceleratorOverrides":""},"referenceId":"","tags":"","placementStrategy":"","platformVersion":"","enableECSManagedTags":"","taskDefinition":"","capacityProviderStrategy":"","group":"","launchType":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_start_task(client):
    ...
    """
    body = {"enableExecuteCommand":"","cluster":"","propagateTags":"","networkConfiguration":{"awsvpcConfiguration":{"assignPublicIp":"","subnets":"","securityGroups":""}},"startedBy":"","containerInstances":"","enableECSManagedTags":"","overrides":{"ephemeralStorage":{"sizeInGiB":""},"containerOverrides":"","memory":"","executionRoleArn":"","taskRoleArn":"","cpu":"","inferenceAcceleratorOverrides":""},"taskDefinition":"","referenceId":"","group":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_submit_attachment_state_changes(client):
    """Test case for submit_attachment_state_changes
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.SubmitAttachmentStateChanges',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_submit_container_state_change(client):
    """Test case for submit_container_state_change

    
    """
    body = {"cluster":"","reason":"","task":"","containerName":"","exitCode":"","networkBindings":"","runtimeId":"","status":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.SubmitContainerStateChange',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_submit_task_state_change(client):
    """Test case for submit_task_state_change

    
    """
    body = {"cluster":"","reason":"","executionStoppedAt":"","task":"","attachments":"","pullStoppedAt":"","pullStartedAt":"","containers":"","managedAgents":"","status":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.SubmitTaskStateChange',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_capacity_provider(client):
    """Test case for update_capacity_provider

    
    """
    body = {"autoScalingGroupProvider":{"managedTerminationProtection":"","managedScaling":{"instanceWarmupPeriod":"","targetCapacity":"","maximumScalingStepSize":"","minimumScalingStepSize":"","status":""}},"name":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.UpdateCapacityProvider',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_cluster(client):
    ...
    """
    body = {"serviceConnectDefaults":{"namespace":""},"cluster":"","settings":"","configuration":{"executeCommandConfiguration":{"logging":"","logConfiguration":{"cloudWatchEncryptionEnabled":"","s3EncryptionEnabled":"","s3BucketName":"","s3KeyPrefix":"","cloudWatchLogGroupName":""},"kmsKeyId":""}}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_cluster_settings(client):
    """Test case for update_cluster_settings
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.UpdateClusterSettings',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_container_agent(client):
    """Test case for update_container_agent
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.UpdateContainerAgent',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_container_instances_state(client):
    """Test case for update_container_instances_state
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.UpdateContainerInstancesState',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_service(client):
    ...
    """
    body = {"enableExecuteCommand":"","cluster":"","placementConstraints":"","propagateTags":"","networkConfiguration":{"awsvpcConfiguration":{"assignPublicIp":"","subnets":"","securityGroups":""}},"desiredCount":"","loadBalancers":"","serviceRegistries":"","serviceConnectConfiguration":{"namespace":"","logConfiguration":{"secretOptions":"","logDriver":"","options":""},"services":"","enabled":""},"forceNewDeployment":"","deploymentConfiguration":{"maximumPercent":"","alarms":{"rollback":"","alarmNames":"","enable":""},"minimumHealthyPercent":"","deploymentCircuitBreaker":{"rollback":"","enable":""}},"placementStrategy":"","service":"","platformVersion":"","taskDefinition":"","enableECSManagedTags":"","capacityProviderStrategy":"","healthCheckGracePeriodSeconds":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_service_primary_task_set(client):
    """Test case for update_service_primary_task_set
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.UpdateServicePrimaryTaskSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_task_protection(client):
    """Test case for update_task_protection

    
    """
    body = {"expiresInMinutes":"","cluster":"","protectionEnabled":"","tasks":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.UpdateTaskProtection',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_task_set(client):
    """Test case for update_task_set

    
    """
    body = {"cluster":"","taskSet":"","service":"","scale":{"unit":"","value":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.UpdateTaskSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
