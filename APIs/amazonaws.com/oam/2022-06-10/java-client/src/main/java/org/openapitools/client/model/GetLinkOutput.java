...
public class GetLinkOutput {
  ...
  public GetLinkOutput arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public GetLinkOutput id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetLinkOutput label(String label) {
    this.label = label;
    return this;
  }
  ...
  public GetLinkOutput labelTemplate(String labelTemplate) {
  ...
  public GetLinkOutput resourceTypes(List resourceTypes) {
  ...
  public GetLinkOutput sinkArn(String sinkArn) {
  ...
  public GetLinkOutput tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetLinkOutput getLinkOutput = (GetLinkOutput) o;
    return Objects.equals(this.arn, getLinkOutput.arn) &&
        Objects.equals(this.id, getLinkOutput.id) &&
        Objects.equals(this.label, getLinkOutput.label) &&
        Objects.equals(this.labelTemplate, getLinkOutput.labelTemplate) &&
        Objects.equals(this.resourceTypes, getLinkOutput.resourceTypes) &&
        Objects.equals(this.sinkArn, getLinkOutput.sinkArn) &&
        Objects.equals(this.tags, getLinkOutput.tags);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLinkOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLinkOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLinkOutput is not found in the empty JSON string", GetLinkOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLinkOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLinkOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLinkOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLinkOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLinkOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLinkOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLinkOutput>() {
           @Override
           public void write(JsonWriter out, GetLinkOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLinkOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLinkOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLinkOutput
   * @throws IOException if the JSON string is invalid with respect to GetLinkOutput
   */
  public static GetLinkOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLinkOutput.class);
  }

  /**
   * Convert an instance of GetLinkOutput to an JSON string
   *
   * @return JSON string
   */
