...
|**resourceTypes** | **List&lt;ResourceType&gt;** | An array of strings that define which types of data that the source account shares with the monitoring account. |  |
