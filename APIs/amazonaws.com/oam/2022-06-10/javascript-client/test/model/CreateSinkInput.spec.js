...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.CreateSinkInput();
  });
  ...
  describe('CreateSinkInput', function() {
    it('should create an instance of CreateSinkInput', function() {
      // uncomment below and update the code to test CreateSinkInput
      //var instance = new CloudWatchObservabilityAccessManager.CreateSinkInput();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.CreateSinkInput);
    });
