...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.GetLinkOutput();
  });
  ...
  describe('GetLinkOutput', function() {
    it('should create an instance of GetLinkOutput', function() {
      // uncomment below and update the code to test GetLinkOutput
      //var instance = new CloudWatchObservabilityAccessManager.GetLinkOutput();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.GetLinkOutput);
    });
