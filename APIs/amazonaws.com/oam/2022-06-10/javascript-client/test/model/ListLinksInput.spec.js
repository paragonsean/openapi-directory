...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.ListLinksInput();
  });
  ...
  describe('ListLinksInput', function() {
    it('should create an instance of ListLinksInput', function() {
      // uncomment below and update the code to test ListLinksInput
      //var instance = new CloudWatchObservabilityAccessManager.ListLinksInput();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.ListLinksInput);
    });
