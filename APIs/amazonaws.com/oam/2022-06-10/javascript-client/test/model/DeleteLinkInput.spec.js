...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.DeleteLinkInput();
  });
  ...
  describe('DeleteLinkInput', function() {
    it('should create an instance of DeleteLinkInput', function() {
      // uncomment below and update the code to test DeleteLinkInput
      //var instance = new CloudWatchObservabilityAccessManager.DeleteLinkInput();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.DeleteLinkInput);
    });
