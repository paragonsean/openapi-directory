...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.UpdateLinkInput();
  });
  ...
  describe('UpdateLinkInput', function() {
    it('should create an instance of UpdateLinkInput', function() {
      // uncomment below and update the code to test UpdateLinkInput
      //var instance = new CloudWatchObservabilityAccessManager.UpdateLinkInput();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.UpdateLinkInput);
    });
