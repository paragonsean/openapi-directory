...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.CreateSinkRequest();
  });
  ...
  describe('CreateSinkRequest', function() {
    it('should create an instance of CreateSinkRequest', function() {
      // uncomment below and update the code to test CreateSinkRequest
      //var instance = new CloudWatchObservabilityAccessManager.CreateSinkRequest();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.CreateSinkRequest);
    });
