...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.PutSinkPolicyRequest();
  });
  ...
  describe('PutSinkPolicyRequest', function() {
    it('should create an instance of PutSinkPolicyRequest', function() {
      // uncomment below and update the code to test PutSinkPolicyRequest
      //var instance = new CloudWatchObservabilityAccessManager.PutSinkPolicyRequest();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.PutSinkPolicyRequest);
    });
