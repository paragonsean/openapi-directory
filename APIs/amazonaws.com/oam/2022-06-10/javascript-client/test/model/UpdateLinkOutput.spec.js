...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.UpdateLinkOutput();
  });
  ...
  describe('UpdateLinkOutput', function() {
    it('should create an instance of UpdateLinkOutput', function() {
      // uncomment below and update the code to test UpdateLinkOutput
      //var instance = new CloudWatchObservabilityAccessManager.UpdateLinkOutput();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.UpdateLinkOutput);
    });
