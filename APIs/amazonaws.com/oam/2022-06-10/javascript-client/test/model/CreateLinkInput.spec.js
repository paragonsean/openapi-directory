...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.CreateLinkInput();
  });
  ...
  describe('CreateLinkInput', function() {
    it('should create an instance of CreateLinkInput', function() {
      // uncomment below and update the code to test CreateLinkInput
      //var instance = new CloudWatchObservabilityAccessManager.CreateLinkInput();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.CreateLinkInput);
    });
