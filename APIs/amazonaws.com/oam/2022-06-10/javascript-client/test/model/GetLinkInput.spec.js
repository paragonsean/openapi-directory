...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.GetLinkInput();
  });
  ...
  describe('GetLinkInput', function() {
    it('should create an instance of GetLinkInput', function() {
      // uncomment below and update the code to test GetLinkInput
      //var instance = new CloudWatchObservabilityAccessManager.GetLinkInput();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.GetLinkInput);
    });
