...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.ListAttachedLinksInput();
  });
  ...
  describe('ListAttachedLinksInput', function() {
    it('should create an instance of ListAttachedLinksInput', function() {
      // uncomment below and update the code to test ListAttachedLinksInput
      //var instance = new CloudWatchObservabilityAccessManager.ListAttachedLinksInput();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.ListAttachedLinksInput);
    });
