...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.DeleteSinkInput();
  });
  ...
  describe('DeleteSinkInput', function() {
    it('should create an instance of DeleteSinkInput', function() {
      // uncomment below and update the code to test DeleteSinkInput
      //var instance = new CloudWatchObservabilityAccessManager.DeleteSinkInput();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.DeleteSinkInput);
    });
