...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.ListSinksItem();
  });
  ...
  describe('ListSinksItem', function() {
    it('should create an instance of ListSinksItem', function() {
      // uncomment below and update the code to test ListSinksItem
      //var instance = new CloudWatchObservabilityAccessManager.ListSinksItem();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.ListSinksItem);
    });
