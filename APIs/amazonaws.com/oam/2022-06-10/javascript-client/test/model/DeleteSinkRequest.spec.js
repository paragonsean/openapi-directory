...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.DeleteSinkRequest();
  });
  ...
  describe('DeleteSinkRequest', function() {
    it('should create an instance of DeleteSinkRequest', function() {
      // uncomment below and update the code to test DeleteSinkRequest
      //var instance = new CloudWatchObservabilityAccessManager.DeleteSinkRequest();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.DeleteSinkRequest);
    });
