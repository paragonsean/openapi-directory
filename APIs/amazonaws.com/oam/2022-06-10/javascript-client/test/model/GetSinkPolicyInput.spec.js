...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.GetSinkPolicyInput();
  });
  ...
  describe('GetSinkPolicyInput', function() {
    it('should create an instance of GetSinkPolicyInput', function() {
      // uncomment below and update the code to test GetSinkPolicyInput
      //var instance = new CloudWatchObservabilityAccessManager.GetSinkPolicyInput();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.GetSinkPolicyInput);
    });
