...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.ListLinksOutput();
  });
  ...
  describe('ListLinksOutput', function() {
    it('should create an instance of ListLinksOutput', function() {
      // uncomment below and update the code to test ListLinksOutput
      //var instance = new CloudWatchObservabilityAccessManager.ListLinksOutput();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.ListLinksOutput);
    });
