...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.CreateSinkOutput();
  });
  ...
  describe('CreateSinkOutput', function() {
    it('should create an instance of CreateSinkOutput', function() {
      // uncomment below and update the code to test CreateSinkOutput
      //var instance = new CloudWatchObservabilityAccessManager.CreateSinkOutput();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.CreateSinkOutput);
    });
