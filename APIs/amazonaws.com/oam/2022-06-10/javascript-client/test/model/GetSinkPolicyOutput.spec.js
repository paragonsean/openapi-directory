...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.GetSinkPolicyOutput();
  });
  ...
  describe('GetSinkPolicyOutput', function() {
    it('should create an instance of GetSinkPolicyOutput', function() {
      // uncomment below and update the code to test GetSinkPolicyOutput
      //var instance = new CloudWatchObservabilityAccessManager.GetSinkPolicyOutput();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.GetSinkPolicyOutput);
    });
    ...
    it('should have the property sinkId (base name: "SinkId")', function() {
      // uncomment below and update the code to test the property sinkId
      //var instance = new CloudWatchObservabilityAccessManager.GetSinkPolicyOutput();
      //expect(instance).to.be();
    });
