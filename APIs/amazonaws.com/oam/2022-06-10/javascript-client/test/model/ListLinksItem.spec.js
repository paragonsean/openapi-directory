...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.ListLinksItem();
  });
  ...
  describe('ListLinksItem', function() {
    it('should create an instance of ListLinksItem', function() {
      // uncomment below and update the code to test ListLinksItem
      //var instance = new CloudWatchObservabilityAccessManager.ListLinksItem();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.ListLinksItem);
    });
