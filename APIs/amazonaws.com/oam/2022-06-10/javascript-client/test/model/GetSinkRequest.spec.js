...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.GetSinkRequest();
  });
  ...
  describe('GetSinkRequest', function() {
    it('should create an instance of GetSinkRequest', function() {
      // uncomment below and update the code to test GetSinkRequest
      //var instance = new CloudWatchObservabilityAccessManager.GetSinkRequest();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.GetSinkRequest);
    });
