...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.GetSinkOutput();
  });
  ...
  describe('GetSinkOutput', function() {
    it('should create an instance of GetSinkOutput', function() {
      // uncomment below and update the code to test GetSinkOutput
      //var instance = new CloudWatchObservabilityAccessManager.GetSinkOutput();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.GetSinkOutput);
    });
