...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.TagResourceInput();
  });
  ...
  describe('TagResourceInput', function() {
    it('should create an instance of TagResourceInput', function() {
      ...
      //var instance = new CloudWatchObservabilityAccessManager.TagResourceInput();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.TagResourceInput);
    });
