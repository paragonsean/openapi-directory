...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.ListSinksOutput();
  });
  ...
  describe('ListSinksOutput', function() {
    it('should create an instance of ListSinksOutput', function() {
      // uncomment below and update the code to test ListSinksOutput
      //var instance = new CloudWatchObservabilityAccessManager.ListSinksOutput();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.ListSinksOutput);
    });
