...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.GetSinkPolicyRequest();
  });
  ...
  describe('GetSinkPolicyRequest', function() {
    it('should create an instance of GetSinkPolicyRequest', function() {
      // uncomment below and update the code to test GetSinkPolicyRequest
      //var instance = new CloudWatchObservabilityAccessManager.GetSinkPolicyRequest();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.GetSinkPolicyRequest);
    });
