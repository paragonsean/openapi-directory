...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.ListAttachedLinksOutput();
  });
  ...
  describe('ListAttachedLinksOutput', function() {
    it('should create an instance of ListAttachedLinksOutput', function() {
      // uncomment below and update the code to test ListAttachedLinksOutput
      //var instance = new CloudWatchObservabilityAccessManager.ListAttachedLinksOutput();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.ListAttachedLinksOutput);
    });
