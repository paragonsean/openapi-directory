...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new CloudWatchObservabilityAccessManager.TagResourceRequest();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.TagResourceRequest);
    });
