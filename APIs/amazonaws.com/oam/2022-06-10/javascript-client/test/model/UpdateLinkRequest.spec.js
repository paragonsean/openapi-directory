...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.UpdateLinkRequest();
  });
  ...
  describe('UpdateLinkRequest', function() {
    it('should create an instance of UpdateLinkRequest', function() {
      // uncomment below and update the code to test UpdateLinkRequest
      //var instance = new CloudWatchObservabilityAccessManager.UpdateLinkRequest();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.UpdateLinkRequest);
    });
