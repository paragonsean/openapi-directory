...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.CreateLinkOutput();
  });
  ...
  describe('CreateLinkOutput', function() {
    it('should create an instance of CreateLinkOutput', function() {
      // uncomment below and update the code to test CreateLinkOutput
      //var instance = new CloudWatchObservabilityAccessManager.CreateLinkOutput();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.CreateLinkOutput);
    });
