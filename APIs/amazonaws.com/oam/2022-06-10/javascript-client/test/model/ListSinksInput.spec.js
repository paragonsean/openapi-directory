...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.ListSinksInput();
  });
  ...
  describe('ListSinksInput', function() {
    it('should create an instance of ListSinksInput', function() {
      // uncomment below and update the code to test ListSinksInput
      //var instance = new CloudWatchObservabilityAccessManager.ListSinksInput();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.ListSinksInput);
    });
