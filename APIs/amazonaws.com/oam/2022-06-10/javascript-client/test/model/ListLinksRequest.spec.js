...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.ListLinksRequest();
  });
  ...
  describe('ListLinksRequest', function() {
    it('should create an instance of ListLinksRequest', function() {
      // uncomment below and update the code to test ListLinksRequest
      //var instance = new CloudWatchObservabilityAccessManager.ListLinksRequest();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.ListLinksRequest);
    });
