...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.ListAttachedLinksItem();
  });
  ...
  describe('ListAttachedLinksItem', function() {
    it('should create an instance of ListAttachedLinksItem', function() {
      // uncomment below and update the code to test ListAttachedLinksItem
      //var instance = new CloudWatchObservabilityAccessManager.ListAttachedLinksItem();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.ListAttachedLinksItem);
    });
    ...
    it('should have the property linkArn (base name: "LinkArn")', function() {
      // uncomment below and update the code to test the property linkArn
      //var instance = new CloudWatchObservabilityAccessManager.ListAttachedLinksItem();
      //expect(instance).to.be();
    });
