...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.GetLinkRequest();
  });
  ...
  describe('GetLinkRequest', function() {
    it('should create an instance of GetLinkRequest', function() {
      // uncomment below and update the code to test GetLinkRequest
      //var instance = new CloudWatchObservabilityAccessManager.GetLinkRequest();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.GetLinkRequest);
    });
