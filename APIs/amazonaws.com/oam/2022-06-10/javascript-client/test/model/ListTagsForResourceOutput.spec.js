...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.ListTagsForResourceOutput();
  });
  ...
  describe('ListTagsForResourceOutput', function() {
    it('should create an instance of ListTagsForResourceOutput', function() {
      ...
      //var instance = new CloudWatchObservabilityAccessManager.ListTagsForResourceOutput();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.ListTagsForResourceOutput);
    });
