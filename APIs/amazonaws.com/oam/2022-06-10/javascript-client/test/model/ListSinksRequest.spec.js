...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.ListSinksRequest();
  });
  ...
  describe('ListSinksRequest', function() {
    it('should create an instance of ListSinksRequest', function() {
      // uncomment below and update the code to test ListSinksRequest
      //var instance = new CloudWatchObservabilityAccessManager.ListSinksRequest();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.ListSinksRequest);
    });
