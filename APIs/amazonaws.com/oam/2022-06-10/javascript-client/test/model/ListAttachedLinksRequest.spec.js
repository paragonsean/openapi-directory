...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.ListAttachedLinksRequest();
  });
  ...
  describe('ListAttachedLinksRequest', function() {
    it('should create an instance of ListAttachedLinksRequest', function() {
      // uncomment below and update the code to test ListAttachedLinksRequest
      //var instance = new CloudWatchObservabilityAccessManager.ListAttachedLinksRequest();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.ListAttachedLinksRequest);
    });
