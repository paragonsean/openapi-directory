...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.GetSinkInput();
  });
  ...
  describe('GetSinkInput', function() {
    it('should create an instance of GetSinkInput', function() {
      // uncomment below and update the code to test GetSinkInput
      //var instance = new CloudWatchObservabilityAccessManager.GetSinkInput();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.GetSinkInput);
    });
