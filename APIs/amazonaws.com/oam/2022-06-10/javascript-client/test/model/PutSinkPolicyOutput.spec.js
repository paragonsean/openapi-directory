...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWatchObservabilityAccessManager.PutSinkPolicyOutput();
  });
  ...
  describe('PutSinkPolicyOutput', function() {
    it('should create an instance of PutSinkPolicyOutput', function() {
      // uncomment below and update the code to test PutSinkPolicyOutput
      //var instance = new CloudWatchObservabilityAccessManager.PutSinkPolicyOutput();
      //expect(instance).to.be.a(CloudWatchObservabilityAccessManager.PutSinkPolicyOutput);
    });
