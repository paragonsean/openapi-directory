...
/**
 * The DeleteLinkInput model module.
 * @module model/DeleteLinkInput
 * @version 2022-06-10
 */
class DeleteLinkInput {
    /**
     * Constructs a new <code>DeleteLinkInput</code>.
     * @alias module:model/DeleteLinkInput
     * @param identifier {String} 
     */
    constructor(identifier) { 
        
        DeleteLinkInput.initialize(this, identifier);
    }
    ...
    /**
     * Constructs a <code>DeleteLinkInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteLinkInput} obj Optional instance to populate.
     * @return {module:model/DeleteLinkInput} The populated <code>DeleteLinkInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteLinkInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteLinkInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteLinkInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteLinkInput.RequiredProperties) {
...
DeleteLinkInput.RequiredProperties = ["Identifier"];

/**
 * @member {String} Identifier
 */
DeleteLinkInput.prototype['Identifier'] = undefined;
...
export default DeleteLinkInput;
