...
/**
 * The PutSinkPolicyOutput model module.
 * @module model/PutSinkPolicyOutput
 * @version 2022-06-10
 */
class PutSinkPolicyOutput {
    /**
     * Constructs a new <code>PutSinkPolicyOutput</code>.
     * @alias module:model/PutSinkPolicyOutput
     */
    constructor() { 
        
        PutSinkPolicyOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutSinkPolicyOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutSinkPolicyOutput} obj Optional instance to populate.
     * @return {module:model/PutSinkPolicyOutput} The populated <code>PutSinkPolicyOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutSinkPolicyOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>PutSinkPolicyOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutSinkPolicyOutput</code>.
     */
 ...
 */
PutSinkPolicyOutput.prototype['SinkArn'] = undefined;

/**
 * @member {String} SinkId
 */
PutSinkPolicyOutput.prototype['SinkId'] = undefined;

/**
 * @member {String} Policy
 */
PutSinkPolicyOutput.prototype['Policy'] = undefined;
...
export default PutSinkPolicyOutput;
