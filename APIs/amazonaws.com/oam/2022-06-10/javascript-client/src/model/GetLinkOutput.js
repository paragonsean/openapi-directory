...
/**
 * The GetLinkOutput model module.
 * @module model/GetLinkOutput
 * @version 2022-06-10
 */
class GetLinkOutput {
    /**
     * Constructs a new <code>GetLinkOutput</code>.
     * @alias module:model/GetLinkOutput
     */
    constructor() { 
        
        GetLinkOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetLinkOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetLinkOutput} obj Optional instance to populate.
     * @return {module:model/GetLinkOutput} The populated <code>GetLinkOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetLinkOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetLinkOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetLinkOutput</code>.
     */
 ...
 * @member {String} Arn
 */
GetLinkOutput.prototype['Arn'] = undefined;

/**
 * @member {String} Id
 */
GetLinkOutput.prototype['Id'] = undefined;

/**
 * @member {String} Label
 */
GetLinkOutput.prototype['Label'] = undefined;

/**
 * @member {String} LabelTemplate
 */
GetLinkOutput.prototype['LabelTemplate'] = undefined;

/**
 * @member {Array} ResourceTypes
 */
GetLinkOutput.prototype['ResourceTypes'] = undefined;

/**
 * @member {String} SinkArn
 */
GetLinkOutput.prototype['SinkArn'] = undefined;

/**
 * @member {Object} Tags
 */
GetLinkOutput.prototype['Tags'] = undefined;
