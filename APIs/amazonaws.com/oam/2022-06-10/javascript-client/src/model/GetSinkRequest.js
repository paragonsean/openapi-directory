...
/**
 * The GetSinkRequest model module.
 * @module model/GetSinkRequest
 * @version 2022-06-10
 */
class GetSinkRequest {
    /**
     * Constructs a new <code>GetSinkRequest</code>.
     * @alias module:model/GetSinkRequest
     * @param identifier {String} The ARN of the sink to retrieve information for.
     */
    constructor(identifier) { 
        
        GetSinkRequest.initialize(this, identifier);
    }
    ...
    /**
     * Constructs a <code>GetSinkRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetSinkRequest} obj Optional instance to populate.
     * @return {module:model/GetSinkRequest} The populated <code>GetSinkRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetSinkRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetSinkRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetSinkRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetSinkRequest.RequiredProperties) {
...
GetSinkRequest.RequiredProperties = ["Identifier"];

/**
 * The ARN of the sink to retrieve information for.
 * @member {String} Identifier
 */
GetSinkRequest.prototype['Identifier'] = undefined;
