...
/**
 * The ListSinksInput model module.
 * @module model/ListSinksInput
 * @version 2022-06-10
 */
class ListSinksInput {
    /**
     * Constructs a new <code>ListSinksInput</code>.
     * @alias module:model/ListSinksInput
     */
    constructor() { 
        
        ListSinksInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListSinksInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListSinksInput} obj Optional instance to populate.
     * @return {module:model/ListSinksInput} The populated <code>ListSinksInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListSinksInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListSinksInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListSinksInput</code>.
     */
 ...
 */
ListSinksInput.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
ListSinksInput.prototype['NextToken'] = undefined;
