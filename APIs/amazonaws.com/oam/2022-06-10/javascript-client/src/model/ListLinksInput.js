...
/**
 * The ListLinksInput model module.
 * @module model/ListLinksInput
 * @version 2022-06-10
 */
class ListLinksInput {
    /**
     * Constructs a new <code>ListLinksInput</code>.
     * @alias module:model/ListLinksInput
     */
    constructor() { 
        
        ListLinksInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListLinksInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListLinksInput} obj Optional instance to populate.
     * @return {module:model/ListLinksInput} The populated <code>ListLinksInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListLinksInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListLinksInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListLinksInput</code>.
     */
 ...
 */
ListLinksInput.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
ListLinksInput.prototype['NextToken'] = undefined;
