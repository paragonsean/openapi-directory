...
/**
 * The ListLinksOutput model module.
 * @module model/ListLinksOutput
 * @version 2022-06-10
 */
class ListLinksOutput {
    /**
     * Constructs a new <code>ListLinksOutput</code>.
     * @alias module:model/ListLinksOutput
     * @param items {Array} 
     */
    constructor(items) { 
        
        ListLinksOutput.initialize(this, items);
    }
    ...
    /**
     * Constructs a <code>ListLinksOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListLinksOutput} obj Optional instance to populate.
     * @return {module:model/ListLinksOutput} The populated <code>ListLinksOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListLinksOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListLinksOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListLinksOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListLinksOutput.RequiredProperties) {
...
ListLinksOutput.RequiredProperties = ["Items"];

/**
 * @member {Array} Items
 */
ListLinksOutput.prototype['Items'] = undefined;

/**
 * @member {String} NextToken
 */
ListLinksOutput.prototype['NextToken'] = undefined;
...
export default ListLinksOutput;
