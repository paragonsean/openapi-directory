...
/**
 * The DeleteSinkRequest model module.
 * @module model/DeleteSinkRequest
 * @version 2022-06-10
 */
class DeleteSinkRequest {
    /**
     * Constructs a new <code>DeleteSinkRequest</code>.
     * @alias module:model/DeleteSinkRequest
     * @param identifier {String} The ARN of the sink to delete.
     */
    constructor(identifier) { 
        
        DeleteSinkRequest.initialize(this, identifier);
    }
    ...
    /**
     * Constructs a <code>DeleteSinkRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteSinkRequest} obj Optional instance to populate.
     * @return {module:model/DeleteSinkRequest} The populated <code>DeleteSinkRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteSinkRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteSinkRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteSinkRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteSinkRequest.RequiredProperties) {
...
DeleteSinkRequest.RequiredProperties = ["Identifier"];

/**
 * The ARN of the sink to delete.
 * @member {String} Identifier
 */
DeleteSinkRequest.prototype['Identifier'] = undefined;
...
export default DeleteSinkRequest;
