...
/**
 * The ListSinksRequest model module.
 * @module model/ListSinksRequest
 * @version 2022-06-10
 */
class ListSinksRequest {
    /**
     * Constructs a new <code>ListSinksRequest</code>.
     * @alias module:model/ListSinksRequest
     */
    constructor() { 
        
        ListSinksRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListSinksRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListSinksRequest} obj Optional instance to populate.
     * @return {module:model/ListSinksRequest} The populated <code>ListSinksRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListSinksRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListSinksRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListSinksRequest</code>.
     */
 ...
 */
ListSinksRequest.prototype['MaxResults'] = undefined;

/**
 * The token for the next set of items to return. You received this token from a previous call.
 * @member {String} NextToken
 */
ListSinksRequest.prototype['NextToken'] = undefined;
...
export default ListSinksRequest;
