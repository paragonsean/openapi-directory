...
class DeleteLinkRequest {
     ...
     * @param identifier {String} The ARN of the link to delete.
     */
    constructor(identifier) { 
        
        DeleteLinkRequest.initialize(this, identifier);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of DeleteLinkRequest.RequiredProperties) {
...
DeleteLinkRequest.RequiredProperties = ["Identifier"];

/**
 * The ARN of the link to delete.
 * @member {String} Identifier
 */
DeleteLinkRequest.prototype['Identifier'] = undefined;
