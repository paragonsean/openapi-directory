...
/**
 * The GetSinkInput model module.
 * @module model/GetSinkInput
 * @version 2022-06-10
 */
class GetSinkInput {
    /**
     * Constructs a new <code>GetSinkInput</code>.
     * @alias module:model/GetSinkInput
     * @param identifier {String} 
     */
    constructor(identifier) { 
        
        GetSinkInput.initialize(this, identifier);
    }
    ...
    /**
     * Constructs a <code>GetSinkInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetSinkInput} obj Optional instance to populate.
     * @return {module:model/GetSinkInput} The populated <code>GetSinkInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetSinkInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetSinkInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetSinkInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetSinkInput.RequiredProperties) {
...
GetSinkInput.RequiredProperties = ["Identifier"];

/**
 * @member {String} Identifier
 */
GetSinkInput.prototype['Identifier'] = undefined;
