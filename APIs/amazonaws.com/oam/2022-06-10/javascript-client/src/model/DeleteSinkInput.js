...
/**
 * The DeleteSinkInput model module.
 * @module model/DeleteSinkInput
 * @version 2022-06-10
 */
class DeleteSinkInput {
    /**
     * Constructs a new <code>DeleteSinkInput</code>.
     * @alias module:model/DeleteSinkInput
     * @param identifier {String} 
     */
    constructor(identifier) { 
        
        DeleteSinkInput.initialize(this, identifier);
    }
    ...
    /**
     * Constructs a <code>DeleteSinkInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteSinkInput} obj Optional instance to populate.
     * @return {module:model/DeleteSinkInput} The populated <code>DeleteSinkInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteSinkInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteSinkInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteSinkInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteSinkInput.RequiredProperties) {
...
DeleteSinkInput.RequiredProperties = ["Identifier"];

/**
 * @member {String} Identifier
 */
DeleteSinkInput.prototype['Identifier'] = undefined;
...
export default DeleteSinkInput;
