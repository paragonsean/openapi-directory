...
/**
 * The UpdateLinkOutput model module.
 * @module model/UpdateLinkOutput
 * @version 2022-06-10
 */
class UpdateLinkOutput {
    /**
     * Constructs a new <code>UpdateLinkOutput</code>.
     * @alias module:model/UpdateLinkOutput
     */
    constructor() { 
        
        UpdateLinkOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateLinkOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateLinkOutput} obj Optional instance to populate.
     * @return {module:model/UpdateLinkOutput} The populated <code>UpdateLinkOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateLinkOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateLinkOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateLinkOutput</code>.
     */
 ...
 * @member {String} Arn
 */
UpdateLinkOutput.prototype['Arn'] = undefined;

/**
 * @member {String} Id
 */
UpdateLinkOutput.prototype['Id'] = undefined;

/**
 * @member {String} Label
 */
UpdateLinkOutput.prototype['Label'] = undefined;

/**
 * @member {String} LabelTemplate
 */
UpdateLinkOutput.prototype['LabelTemplate'] = undefined;

/**
 * @member {Array} ResourceTypes
 */
UpdateLinkOutput.prototype['ResourceTypes'] = undefined;

/**
 * @member {String} SinkArn
 */
UpdateLinkOutput.prototype['SinkArn'] = undefined;

/**
 * @member {Object} Tags
 */
UpdateLinkOutput.prototype['Tags'] = undefined;
...
export default UpdateLinkOutput;
