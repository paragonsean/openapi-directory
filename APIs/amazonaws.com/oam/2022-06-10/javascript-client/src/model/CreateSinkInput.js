...
/**
 * The CreateSinkInput model module.
 * @module model/CreateSinkInput
 * @version 2022-06-10
 */
class CreateSinkInput {
    /**
     * Constructs a new <code>CreateSinkInput</code>.
     * @alias module:model/CreateSinkInput
     * @param name {String} 
     */
    constructor(name) { 
        
        CreateSinkInput.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>CreateSinkInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateSinkInput} obj Optional instance to populate.
     * @return {module:model/CreateSinkInput} The populated <code>CreateSinkInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateSinkInput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateSinkInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateSinkInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateSinkInput.RequiredProperties) {
...
CreateSinkInput.RequiredProperties = ["Name"];

/**
 * @member {String} Name
 */
CreateSinkInput.prototype['Name'] = undefined;

/**
 * @member {Object} Tags
 */
CreateSinkInput.prototype['Tags'] = undefined;
...
export default CreateSinkInput;
