...
/**
 * The ListSinksOutput model module.
 * @module model/ListSinksOutput
 * @version 2022-06-10
 */
class ListSinksOutput {
    /**
     * Constructs a new <code>ListSinksOutput</code>.
     * @alias module:model/ListSinksOutput
     * @param items {Array} 
     */
    constructor(items) { 
        
        ListSinksOutput.initialize(this, items);
    }
    ...
    /**
     * Constructs a <code>ListSinksOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListSinksOutput} obj Optional instance to populate.
     * @return {module:model/ListSinksOutput} The populated <code>ListSinksOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListSinksOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListSinksOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListSinksOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListSinksOutput.RequiredProperties) {
...
ListSinksOutput.RequiredProperties = ["Items"];

/**
 * @member {Array} Items
 */
ListSinksOutput.prototype['Items'] = undefined;

/**
 * @member {String} NextToken
 */
ListSinksOutput.prototype['NextToken'] = undefined;
...
export default ListSinksOutput;
