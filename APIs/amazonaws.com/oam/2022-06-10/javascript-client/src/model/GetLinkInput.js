...
/**
 * The GetLinkInput model module.
 * @module model/GetLinkInput
 * @version 2022-06-10
 */
class GetLinkInput {
    /**
     * Constructs a new <code>GetLinkInput</code>.
     * @alias module:model/GetLinkInput
     * @param identifier {String} 
     */
    constructor(identifier) { 
        
        GetLinkInput.initialize(this, identifier);
    }
    ...
    /**
     * Constructs a <code>GetLinkInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetLinkInput} obj Optional instance to populate.
     * @return {module:model/GetLinkInput} The populated <code>GetLinkInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetLinkInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetLinkInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetLinkInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetLinkInput.RequiredProperties) {
...
GetLinkInput.RequiredProperties = ["Identifier"];

/**
 * @member {String} Identifier
 */
GetLinkInput.prototype['Identifier'] = undefined;
