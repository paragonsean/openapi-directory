...
/**
 * The CreateSinkOutput model module.
 * @module model/CreateSinkOutput
 * @version 2022-06-10
 */
class CreateSinkOutput {
    /**
     * Constructs a new <code>CreateSinkOutput</code>.
     * @alias module:model/CreateSinkOutput
     */
    constructor() { 
        
        CreateSinkOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateSinkOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateSinkOutput} obj Optional instance to populate.
     * @return {module:model/CreateSinkOutput} The populated <code>CreateSinkOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateSinkOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateSinkOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateSinkOutput</code>.
     */
 ...
 * @member {String} Arn
 */
CreateSinkOutput.prototype['Arn'] = undefined;

/**
 * @member {String} Id
 */
CreateSinkOutput.prototype['Id'] = undefined;

/**
 * @member {String} Name
 */
CreateSinkOutput.prototype['Name'] = undefined;

/**
 * @member {Object} Tags
 */
CreateSinkOutput.prototype['Tags'] = undefined;
...
export default CreateSinkOutput;
