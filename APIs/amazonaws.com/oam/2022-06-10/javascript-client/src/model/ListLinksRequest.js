...
/**
 * The ListLinksRequest model module.
 * @module model/ListLinksRequest
 * @version 2022-06-10
 */
class ListLinksRequest {
    /**
     * Constructs a new <code>ListLinksRequest</code>.
     * @alias module:model/ListLinksRequest
     */
    constructor() { 
        
        ListLinksRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListLinksRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListLinksRequest} obj Optional instance to populate.
     * @return {module:model/ListLinksRequest} The populated <code>ListLinksRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListLinksRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListLinksRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListLinksRequest</code>.
     */
 ...
 */
ListLinksRequest.prototype['MaxResults'] = undefined;

/**
 * The token for the next set of items to return. You received this token from a previous call.
 * @member {String} NextToken
 */
ListLinksRequest.prototype['NextToken'] = undefined;
...
export default ListLinksRequest;
