...
OAICreateLink_request Example::create(){
    OAICreateLink_request obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::createLinkSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::createLinkSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAICreateLink_request oai_create_link_request = create(); // OAICreateLink_request | 
      ...
      apiInstance.createLink(oai_create_link_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
