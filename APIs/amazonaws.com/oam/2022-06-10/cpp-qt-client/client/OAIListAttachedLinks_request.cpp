...
OAIListAttachedLinks_request::OAIListAttachedLinks_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListAttachedLinks_request::OAIListAttachedLinks_request() {
    this->initializeModel();
}

OAIListAttachedLinks_request::~OAIListAttachedLinks_request() {}

void OAIListAttachedLinks_request::initializeModel() {
...
void OAIListAttachedLinks_request::fromJson(QString jsonString) {
...
void OAIListAttachedLinks_request::fromJsonObject(QJsonObject json) {
...
QString OAIListAttachedLinks_request::asJson() const {
...
QJsonObject OAIListAttachedLinks_request::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIListAttachedLinks_request::getMaxResults() const {
    return m_max_results;
}
void OAIListAttachedLinks_request::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListAttachedLinks_request::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListAttachedLinks_request::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListAttachedLinks_request::getNextToken() const {
    return m_next_token;
}
void OAIListAttachedLinks_request::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListAttachedLinks_request::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListAttachedLinks_request::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QString OAIListAttachedLinks_request::getSinkIdentifier() const {
    return m_sink_identifier;
}
void OAIListAttachedLinks_request::setSinkIdentifier(const QString &sink_identifier) {
    m_sink_identifier = sink_identifier;
    m_sink_identifier_isSet = true;
}

bool OAIListAttachedLinks_request::is_sink_identifier_Set() const{
    return m_sink_identifier_isSet;
}

bool OAIListAttachedLinks_request::is_sink_identifier_Valid() const{
    return m_sink_identifier_isValid;
}

bool OAIListAttachedLinks_request::isSet() const {
...
bool OAIListAttachedLinks_request::isValid() const {
