...
/*
 * OAIListSinks_request.h
 *
 * 
 */

#ifndef OAIListSinks_request_H
#define OAIListSinks_request_H
...
class OAIListSinks_request : public OAIObject {
public:
    OAIListSinks_request();
    OAIListSinks_request(QString json);
    ~OAIListSinks_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListSinks_request)

#endif // OAIListSinks_request_H
