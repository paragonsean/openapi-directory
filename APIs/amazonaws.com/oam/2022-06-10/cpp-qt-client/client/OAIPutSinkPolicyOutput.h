...
/*
 * OAIPutSinkPolicyOutput.h
 *
 * 
 */

#ifndef OAIPutSinkPolicyOutput_H
#define OAIPutSinkPolicyOutput_H
...
class OAIPutSinkPolicyOutput : public OAIObject {
public:
    OAIPutSinkPolicyOutput();
    OAIPutSinkPolicyOutput(QString json);
    ~OAIPutSinkPolicyOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutSinkPolicyOutput)

#endif // OAIPutSinkPolicyOutput_H
