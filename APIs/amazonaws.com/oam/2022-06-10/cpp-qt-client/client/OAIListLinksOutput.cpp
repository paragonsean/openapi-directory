...
OAIListLinksOutput::OAIListLinksOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListLinksOutput::OAIListLinksOutput() {
    this->initializeModel();
}

OAIListLinksOutput::~OAIListLinksOutput() {}

void OAIListLinksOutput::initializeModel() {
...
void OAIListLinksOutput::fromJson(QString jsonString) {
...
void OAIListLinksOutput::fromJsonObject(QJsonObject json) {
...
QString OAIListLinksOutput::asJson() const {
...
QJsonObject OAIListLinksOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_items.isSet()) {
...
QList OAIListLinksOutput::getItems() const {
    return m_items;
}
void OAIListLinksOutput::setItems(const QList &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIListLinksOutput::is_items_Set() const{
    return m_items_isSet;
}

bool OAIListLinksOutput::is_items_Valid() const{
    return m_items_isValid;
}

QString OAIListLinksOutput::getNextToken() const {
    return m_next_token;
}
void OAIListLinksOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListLinksOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListLinksOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListLinksOutput::isSet() const {
...
bool OAIListLinksOutput::isValid() const {
