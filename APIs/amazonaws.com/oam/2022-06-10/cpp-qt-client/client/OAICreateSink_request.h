...
/*
 * OAICreateSink_request.h
 *
 * 
 */

#ifndef OAICreateSink_request_H
#define OAICreateSink_request_H
...
class OAICreateSink_request : public OAIObject {
public:
    OAICreateSink_request();
    OAICreateSink_request(QString json);
    ~OAICreateSink_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSink_request)

#endif // OAICreateSink_request_H
