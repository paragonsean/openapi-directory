...
#ifndef OAIGetLinkInput_H
#define OAIGetLinkInput_H
...
class OAIGetLinkInput : public OAIObject {
public:
    OAIGetLinkInput();
    OAIGetLinkInput(QString json);
    ~OAIGetLinkInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLinkInput)

#endif // OAIGetLinkInput_H
