...
#include "OAIGetSinkPolicyInput.h"
...
OAIGetSinkPolicyInput::OAIGetSinkPolicyInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetSinkPolicyInput::OAIGetSinkPolicyInput() {
    this->initializeModel();
}

OAIGetSinkPolicyInput::~OAIGetSinkPolicyInput() {}

void OAIGetSinkPolicyInput::initializeModel() {

    m_sink_identifier_isSet = false;
    m_sink_identifier_isValid = false;
}

void OAIGetSinkPolicyInput::fromJson(QString jsonString) {
...
void OAIGetSinkPolicyInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetSinkPolicyInput::asJson() const {
...
QJsonObject OAIGetSinkPolicyInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetSinkPolicyInput::getSinkIdentifier() const {
    return m_sink_identifier;
}
void OAIGetSinkPolicyInput::setSinkIdentifier(const QString &sink_identifier) {
    m_sink_identifier = sink_identifier;
    m_sink_identifier_isSet = true;
}

bool OAIGetSinkPolicyInput::is_sink_identifier_Set() const{
    return m_sink_identifier_isSet;
}

bool OAIGetSinkPolicyInput::is_sink_identifier_Valid() const{
    return m_sink_identifier_isValid;
}

bool OAIGetSinkPolicyInput::isSet() const {
...
bool OAIGetSinkPolicyInput::isValid() const {
