...
/*
 * OAICreateSinkOutput.h
 *
 * 
 */

#ifndef OAICreateSinkOutput_H
#define OAICreateSinkOutput_H
...
class OAICreateSinkOutput : public OAIObject {
public:
    OAICreateSinkOutput();
    OAICreateSinkOutput(QString json);
    ~OAICreateSinkOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSinkOutput)

#endif // OAICreateSinkOutput_H
