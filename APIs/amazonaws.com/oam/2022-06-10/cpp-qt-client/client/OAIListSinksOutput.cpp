...
OAIListSinksOutput::OAIListSinksOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListSinksOutput::OAIListSinksOutput() {
    this->initializeModel();
}

OAIListSinksOutput::~OAIListSinksOutput() {}

void OAIListSinksOutput::initializeModel() {
...
void OAIListSinksOutput::fromJson(QString jsonString) {
...
void OAIListSinksOutput::fromJsonObject(QJsonObject json) {
...
QString OAIListSinksOutput::asJson() const {
...
QJsonObject OAIListSinksOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_items.isSet()) {
...
QList OAIListSinksOutput::getItems() const {
    return m_items;
}
void OAIListSinksOutput::setItems(const QList &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIListSinksOutput::is_items_Set() const{
    return m_items_isSet;
}

bool OAIListSinksOutput::is_items_Valid() const{
    return m_items_isValid;
}

QString OAIListSinksOutput::getNextToken() const {
    return m_next_token;
}
void OAIListSinksOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListSinksOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListSinksOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListSinksOutput::isSet() const {
...
bool OAIListSinksOutput::isValid() const {
