...
OAIGetLinkInput::OAIGetLinkInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetLinkInput::OAIGetLinkInput() {
    this->initializeModel();
}

OAIGetLinkInput::~OAIGetLinkInput() {}

void OAIGetLinkInput::initializeModel() {

    m_identifier_isSet = false;
    m_identifier_isValid = false;
}

void OAIGetLinkInput::fromJson(QString jsonString) {
...
void OAIGetLinkInput::fromJsonObject(QJsonObject json) {

    m_identifier_isValid = ::OpenAPI::fromJsonValue(m_identifier, json[QString("Identifier")]);
    m_identifier_isSet = !json[QString("Identifier")].isNull() && m_identifier_isValid;
}

QString OAIGetLinkInput::asJson() const {
...
QJsonObject OAIGetLinkInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetLinkInput::getIdentifier() const {
    return m_identifier;
}
void OAIGetLinkInput::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIGetLinkInput::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIGetLinkInput::is_identifier_Valid() const{
    return m_identifier_isValid;
}

bool OAIGetLinkInput::isSet() const {
...
bool OAIGetLinkInput::isValid() const {
