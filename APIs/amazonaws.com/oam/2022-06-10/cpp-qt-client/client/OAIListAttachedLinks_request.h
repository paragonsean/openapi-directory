...
/*
 * OAIListAttachedLinks_request.h
 *
 * 
 */

#ifndef OAIListAttachedLinks_request_H
#define OAIListAttachedLinks_request_H
...
class OAIListAttachedLinks_request : public OAIObject {
public:
    OAIListAttachedLinks_request();
    OAIListAttachedLinks_request(QString json);
    ~OAIListAttachedLinks_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAttachedLinks_request)

#endif // OAIListAttachedLinks_request_H
