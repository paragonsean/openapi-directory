...
/*
 * OAIGetSinkPolicyInput.h
 *
 * 
 */

#ifndef OAIGetSinkPolicyInput_H
#define OAIGetSinkPolicyInput_H
...
class OAIGetSinkPolicyInput : public OAIObject {
public:
    OAIGetSinkPolicyInput();
    OAIGetSinkPolicyInput(QString json);
    ~OAIGetSinkPolicyInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSinkPolicyInput)

#endif // OAIGetSinkPolicyInput_H
