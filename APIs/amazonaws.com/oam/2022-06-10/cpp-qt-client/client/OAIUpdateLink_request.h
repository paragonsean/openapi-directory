...
/*
 * OAIUpdateLink_request.h
 *
 * 
 */

#ifndef OAIUpdateLink_request_H
#define OAIUpdateLink_request_H
...
class OAIUpdateLink_request : public OAIObject {
public:
    OAIUpdateLink_request();
    OAIUpdateLink_request(QString json);
    ~OAIUpdateLink_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateLink_request)

#endif // OAIUpdateLink_request_H
