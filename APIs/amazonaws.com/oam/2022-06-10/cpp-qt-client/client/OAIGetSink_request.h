...
/*
 * OAIGetSink_request.h
 *
 * 
 */

#ifndef OAIGetSink_request_H
#define OAIGetSink_request_H
...
class OAIGetSink_request : public OAIObject {
public:
    OAIGetSink_request();
    OAIGetSink_request(QString json);
    ~OAIGetSink_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSink_request)

#endif // OAIGetSink_request_H
