...
/*
 * OAIDeleteSink_request.h
 *
 * 
 */

#ifndef OAIDeleteSink_request_H
#define OAIDeleteSink_request_H
...
class OAIDeleteSink_request : public OAIObject {
public:
    OAIDeleteSink_request();
    OAIDeleteSink_request(QString json);
    ~OAIDeleteSink_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteSink_request)

#endif // OAIDeleteSink_request_H
