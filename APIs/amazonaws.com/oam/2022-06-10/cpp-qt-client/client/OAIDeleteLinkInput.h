...
/*
 * OAIDeleteLinkInput.h
 *
 * 
 */

#ifndef OAIDeleteLinkInput_H
#define OAIDeleteLinkInput_H
...
class OAIDeleteLinkInput : public OAIObject {
public:
    OAIDeleteLinkInput();
    OAIDeleteLinkInput(QString json);
    ~OAIDeleteLinkInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteLinkInput)

#endif // OAIDeleteLinkInput_H
