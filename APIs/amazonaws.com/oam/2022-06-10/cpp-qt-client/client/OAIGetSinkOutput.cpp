...
OAIGetSinkOutput::OAIGetSinkOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetSinkOutput::OAIGetSinkOutput() {
    this->initializeModel();
}

OAIGetSinkOutput::~OAIGetSinkOutput() {}

void OAIGetSinkOutput::initializeModel() {
...
void OAIGetSinkOutput::fromJson(QString jsonString) {
...
void OAIGetSinkOutput::fromJsonObject(QJsonObject json) {
...
QString OAIGetSinkOutput::asJson() const {
...
QJsonObject OAIGetSinkOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIGetSinkOutput::getArn() const {
    return m_arn;
}
void OAIGetSinkOutput::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIGetSinkOutput::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIGetSinkOutput::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIGetSinkOutput::getId() const {
    return m_id;
}
void OAIGetSinkOutput::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGetSinkOutput::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGetSinkOutput::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIGetSinkOutput::getName() const {
    return m_name;
}
void OAIGetSinkOutput::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIGetSinkOutput::is_name_Set() const{
    return m_name_isSet;
}

bool OAIGetSinkOutput::is_name_Valid() const{
    return m_name_isValid;
}

QMap OAIGetSinkOutput::getTags() const {
    return m_tags;
}
void OAIGetSinkOutput::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIGetSinkOutput::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIGetSinkOutput::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIGetSinkOutput::isSet() const {
...
bool OAIGetSinkOutput::isValid() const {
