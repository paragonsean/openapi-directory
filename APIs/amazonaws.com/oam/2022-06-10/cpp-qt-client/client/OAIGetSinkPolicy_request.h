...
/*
 * OAIGetSinkPolicy_request.h
 *
 * 
 */

#ifndef OAIGetSinkPolicy_request_H
#define OAIGetSinkPolicy_request_H
...
class OAIGetSinkPolicy_request : public OAIObject {
public:
    OAIGetSinkPolicy_request();
    OAIGetSinkPolicy_request(QString json);
    ~OAIGetSinkPolicy_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSinkPolicy_request)

#endif // OAIGetSinkPolicy_request_H
