...
OAIUpdateLinkOutput::OAIUpdateLinkOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateLinkOutput::OAIUpdateLinkOutput() {
    this->initializeModel();
}

OAIUpdateLinkOutput::~OAIUpdateLinkOutput() {}

void OAIUpdateLinkOutput::initializeModel() {
...
void OAIUpdateLinkOutput::fromJson(QString jsonString) {
...
void OAIUpdateLinkOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateLinkOutput::asJson() const {
...
QJsonObject OAIUpdateLinkOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIUpdateLinkOutput::getArn() const {
    return m_arn;
}
void OAIUpdateLinkOutput::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIUpdateLinkOutput::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIUpdateLinkOutput::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIUpdateLinkOutput::getId() const {
    return m_id;
}
void OAIUpdateLinkOutput::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIUpdateLinkOutput::is_id_Set() const{
    return m_id_isSet;
}

bool OAIUpdateLinkOutput::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIUpdateLinkOutput::getLabel() const {
    return m_label;
}
void OAIUpdateLinkOutput::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIUpdateLinkOutput::is_label_Set() const{
    return m_label_isSet;
}

bool OAIUpdateLinkOutput::is_label_Valid() const{
    return m_label_isValid;
}

QString OAIUpdateLinkOutput::getLabelTemplate() const {
    return m_label_template;
}
void OAIUpdateLinkOutput::setLabelTemplate(const QString &label_template) {
    m_label_template = label_template;
    m_label_template_isSet = true;
}

bool OAIUpdateLinkOutput::is_label_template_Set() const{
    return m_label_template_isSet;
}

bool OAIUpdateLinkOutput::is_label_template_Valid() const{
    return m_label_template_isValid;
}

QList OAIUpdateLinkOutput::getResourceTypes() const {
    return m_resource_types;
}
void OAIUpdateLinkOutput::setResourceTypes(const QList &resource_types) {
    m_resource_types = resource_types;
    m_resource_types_isSet = true;
}

bool OAIUpdateLinkOutput::is_resource_types_Set() const{
    return m_resource_types_isSet;
}

bool OAIUpdateLinkOutput::is_resource_types_Valid() const{
    return m_resource_types_isValid;
}

QString OAIUpdateLinkOutput::getSinkArn() const {
    return m_sink_arn;
}
void OAIUpdateLinkOutput::setSinkArn(const QString &sink_arn) {
    m_sink_arn = sink_arn;
    m_sink_arn_isSet = true;
}

bool OAIUpdateLinkOutput::is_sink_arn_Set() const{
    return m_sink_arn_isSet;
}

bool OAIUpdateLinkOutput::is_sink_arn_Valid() const{
    return m_sink_arn_isValid;
}

QMap OAIUpdateLinkOutput::getTags() const {
    return m_tags;
}
void OAIUpdateLinkOutput::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIUpdateLinkOutput::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIUpdateLinkOutput::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIUpdateLinkOutput::isSet() const {
...
bool OAIUpdateLinkOutput::isValid() const {
