...
OAIGetSinkInput::OAIGetSinkInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetSinkInput::OAIGetSinkInput() {
    this->initializeModel();
}

OAIGetSinkInput::~OAIGetSinkInput() {}

void OAIGetSinkInput::initializeModel() {

    m_identifier_isSet = false;
    m_identifier_isValid = false;
}

void OAIGetSinkInput::fromJson(QString jsonString) {
...
void OAIGetSinkInput::fromJsonObject(QJsonObject json) {

    m_identifier_isValid = ::OpenAPI::fromJsonValue(m_identifier, json[QString("Identifier")]);
    m_identifier_isSet = !json[QString("Identifier")].isNull() && m_identifier_isValid;
}

QString OAIGetSinkInput::asJson() const {
...
QJsonObject OAIGetSinkInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetSinkInput::getIdentifier() const {
    return m_identifier;
}
void OAIGetSinkInput::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIGetSinkInput::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIGetSinkInput::is_identifier_Valid() const{
    return m_identifier_isValid;
}

bool OAIGetSinkInput::isSet() const {
...
bool OAIGetSinkInput::isValid() const {
