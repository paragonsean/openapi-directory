...
#ifndef OAIListLinksItem_H
#define OAIListLinksItem_H
...
class OAIListLinksItem : public OAIObject {
public:
    OAIListLinksItem();
    OAIListLinksItem(QString json);
    ~OAIListLinksItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListLinksItem)

#endif // OAIListLinksItem_H
