...
OAIGetSink_request::OAIGetSink_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetSink_request::OAIGetSink_request() {
    this->initializeModel();
}

OAIGetSink_request::~OAIGetSink_request() {}

void OAIGetSink_request::initializeModel() {

    m_identifier_isSet = false;
    m_identifier_isValid = false;
}

void OAIGetSink_request::fromJson(QString jsonString) {
...
void OAIGetSink_request::fromJsonObject(QJsonObject json) {

    m_identifier_isValid = ::OpenAPI::fromJsonValue(m_identifier, json[QString("Identifier")]);
    m_identifier_isSet = !json[QString("Identifier")].isNull() && m_identifier_isValid;
}

QString OAIGetSink_request::asJson() const {
...
QJsonObject OAIGetSink_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetSink_request::getIdentifier() const {
    return m_identifier;
}
void OAIGetSink_request::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIGetSink_request::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIGetSink_request::is_identifier_Valid() const{
    return m_identifier_isValid;
}

bool OAIGetSink_request::isSet() const {
...
bool OAIGetSink_request::isValid() const {
