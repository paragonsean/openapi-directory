...
/*
 * OAIDeleteSinkInput.h
 *
 * 
 */

#ifndef OAIDeleteSinkInput_H
#define OAIDeleteSinkInput_H
...
class OAIDeleteSinkInput : public OAIObject {
public:
    OAIDeleteSinkInput();
    OAIDeleteSinkInput(QString json);
    ~OAIDeleteSinkInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteSinkInput)

#endif // OAIDeleteSinkInput_H
