...
OAIGetLink_request::OAIGetLink_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetLink_request::OAIGetLink_request() {
    this->initializeModel();
}

OAIGetLink_request::~OAIGetLink_request() {}

void OAIGetLink_request::initializeModel() {

    m_identifier_isSet = false;
    m_identifier_isValid = false;
}

void OAIGetLink_request::fromJson(QString jsonString) {
...
void OAIGetLink_request::fromJsonObject(QJsonObject json) {

    m_identifier_isValid = ::OpenAPI::fromJsonValue(m_identifier, json[QString("Identifier")]);
    m_identifier_isSet = !json[QString("Identifier")].isNull() && m_identifier_isValid;
}

QString OAIGetLink_request::asJson() const {
...
QJsonObject OAIGetLink_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetLink_request::getIdentifier() const {
    return m_identifier;
}
void OAIGetLink_request::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIGetLink_request::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIGetLink_request::is_identifier_Valid() const{
    return m_identifier_isValid;
}

bool OAIGetLink_request::isSet() const {
...
bool OAIGetLink_request::isValid() const {
