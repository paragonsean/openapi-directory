...
/*
 * OAIListSinksOutput.h
 *
 * 
 */

#ifndef OAIListSinksOutput_H
#define OAIListSinksOutput_H
...
class OAIListSinksOutput : public OAIObject {
public:
    OAIListSinksOutput();
    OAIListSinksOutput(QString json);
    ~OAIListSinksOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListSinksOutput)

#endif // OAIListSinksOutput_H
