...
OAIPutSinkPolicy_request::OAIPutSinkPolicy_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutSinkPolicy_request::OAIPutSinkPolicy_request() {
    this->initializeModel();
}

OAIPutSinkPolicy_request::~OAIPutSinkPolicy_request() {}

void OAIPutSinkPolicy_request::initializeModel() {
...
void OAIPutSinkPolicy_request::fromJson(QString jsonString) {
...
void OAIPutSinkPolicy_request::fromJsonObject(QJsonObject json) {
...
QString OAIPutSinkPolicy_request::asJson() const {
...
QJsonObject OAIPutSinkPolicy_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPutSinkPolicy_request::getSinkIdentifier() const {
    return m_sink_identifier;
}
void OAIPutSinkPolicy_request::setSinkIdentifier(const QString &sink_identifier) {
    m_sink_identifier = sink_identifier;
    m_sink_identifier_isSet = true;
}

bool OAIPutSinkPolicy_request::is_sink_identifier_Set() const{
    return m_sink_identifier_isSet;
}

bool OAIPutSinkPolicy_request::is_sink_identifier_Valid() const{
    return m_sink_identifier_isValid;
}

QString OAIPutSinkPolicy_request::getPolicy() const {
    return m_policy;
}
void OAIPutSinkPolicy_request::setPolicy(const QString &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAIPutSinkPolicy_request::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAIPutSinkPolicy_request::is_policy_Valid() const{
    return m_policy_isValid;
}

bool OAIPutSinkPolicy_request::isSet() const {
...
bool OAIPutSinkPolicy_request::isValid() const {
