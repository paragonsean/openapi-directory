...
/*
 * OAIListLinksOutput.h
 *
 * 
 */

#ifndef OAIListLinksOutput_H
#define OAIListLinksOutput_H
...
class OAIListLinksOutput : public OAIObject {
public:
    OAIListLinksOutput();
    OAIListLinksOutput(QString json);
    ~OAIListLinksOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListLinksOutput)

#endif // OAIListLinksOutput_H
