...
/*
 * OAICreateSinkInput.h
 *
 * 
 */

#ifndef OAICreateSinkInput_H
#define OAICreateSinkInput_H
...
class OAICreateSinkInput : public OAIObject {
public:
    OAICreateSinkInput();
    OAICreateSinkInput(QString json);
    ~OAICreateSinkInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSinkInput)

#endif // OAICreateSinkInput_H
