...
/*
 * OAIListLinks_request.h
 *
 * 
 */

#ifndef OAIListLinks_request_H
#define OAIListLinks_request_H
...
class OAIListLinks_request : public OAIObject {
public:
    OAIListLinks_request();
    OAIListLinks_request(QString json);
    ~OAIListLinks_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListLinks_request)

#endif // OAIListLinks_request_H
