...
#ifndef OAIGetLinkOutput_H
#define OAIGetLinkOutput_H
...
class OAIGetLinkOutput : public OAIObject {
public:
    OAIGetLinkOutput();
    OAIGetLinkOutput(QString json);
    ~OAIGetLinkOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLinkOutput)

#endif // OAIGetLinkOutput_H
