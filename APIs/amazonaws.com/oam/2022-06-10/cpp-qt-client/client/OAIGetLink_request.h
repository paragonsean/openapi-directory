...
/*
 * OAIGetLink_request.h
 *
 * 
 */

#ifndef OAIGetLink_request_H
#define OAIGetLink_request_H
...
class OAIGetLink_request : public OAIObject {
public:
    OAIGetLink_request();
    OAIGetLink_request(QString json);
    ~OAIGetLink_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLink_request)

#endif // OAIGetLink_request_H
