...
/*
 * OAIUpdateLinkOutput.h
 *
 * 
 */

#ifndef OAIUpdateLinkOutput_H
#define OAIUpdateLinkOutput_H
...
class OAIUpdateLinkOutput : public OAIObject {
public:
    OAIUpdateLinkOutput();
    OAIUpdateLinkOutput(QString json);
    ~OAIUpdateLinkOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateLinkOutput)

#endif // OAIUpdateLinkOutput_H
