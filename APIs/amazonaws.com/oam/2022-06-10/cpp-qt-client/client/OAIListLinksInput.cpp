...
OAIListLinksInput::OAIListLinksInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListLinksInput::OAIListLinksInput() {
    this->initializeModel();
}

OAIListLinksInput::~OAIListLinksInput() {}

void OAIListLinksInput::initializeModel() {
...
void OAIListLinksInput::fromJson(QString jsonString) {
...
void OAIListLinksInput::fromJsonObject(QJsonObject json) {
...
QString OAIListLinksInput::asJson() const {
...
QJsonObject OAIListLinksInput::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIListLinksInput::getMaxResults() const {
    return m_max_results;
}
void OAIListLinksInput::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListLinksInput::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListLinksInput::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListLinksInput::getNextToken() const {
    return m_next_token;
}
void OAIListLinksInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListLinksInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListLinksInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListLinksInput::isSet() const {
...
bool OAIListLinksInput::isValid() const {
