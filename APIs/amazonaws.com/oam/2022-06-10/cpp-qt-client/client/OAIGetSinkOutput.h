...
#ifndef OAIGetSinkOutput_H
#define OAIGetSinkOutput_H
...
class OAIGetSinkOutput : public OAIObject {
public:
    OAIGetSinkOutput();
    OAIGetSinkOutput(QString json);
    ~OAIGetSinkOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSinkOutput)

#endif // OAIGetSinkOutput_H
