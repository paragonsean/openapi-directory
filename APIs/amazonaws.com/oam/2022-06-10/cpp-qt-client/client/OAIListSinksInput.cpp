...
OAIListSinksInput::OAIListSinksInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListSinksInput::OAIListSinksInput() {
    this->initializeModel();
}

OAIListSinksInput::~OAIListSinksInput() {}

void OAIListSinksInput::initializeModel() {
...
void OAIListSinksInput::fromJson(QString jsonString) {
...
void OAIListSinksInput::fromJsonObject(QJsonObject json) {
...
QString OAIListSinksInput::asJson() const {
...
QJsonObject OAIListSinksInput::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIListSinksInput::getMaxResults() const {
    return m_max_results;
}
void OAIListSinksInput::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListSinksInput::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListSinksInput::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListSinksInput::getNextToken() const {
    return m_next_token;
}
void OAIListSinksInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListSinksInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListSinksInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListSinksInput::isSet() const {
...
bool OAIListSinksInput::isValid() const {
