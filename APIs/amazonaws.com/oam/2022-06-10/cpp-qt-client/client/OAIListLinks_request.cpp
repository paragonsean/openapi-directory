...
OAIListLinks_request::OAIListLinks_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListLinks_request::OAIListLinks_request() {
    this->initializeModel();
}

OAIListLinks_request::~OAIListLinks_request() {}

void OAIListLinks_request::initializeModel() {
...
void OAIListLinks_request::fromJson(QString jsonString) {
...
void OAIListLinks_request::fromJsonObject(QJsonObject json) {
...
QString OAIListLinks_request::asJson() const {
...
QJsonObject OAIListLinks_request::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIListLinks_request::getMaxResults() const {
    return m_max_results;
}
void OAIListLinks_request::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListLinks_request::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListLinks_request::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListLinks_request::getNextToken() const {
    return m_next_token;
}
void OAIListLinks_request::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListLinks_request::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListLinks_request::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListLinks_request::isSet() const {
...
bool OAIListLinks_request::isValid() const {
