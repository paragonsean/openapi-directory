...
/*
 * OAIPutSinkPolicy_request.h
 *
 * 
 */

#ifndef OAIPutSinkPolicy_request_H
#define OAIPutSinkPolicy_request_H
...
class OAIPutSinkPolicy_request : public OAIObject {
public:
    OAIPutSinkPolicy_request();
    OAIPutSinkPolicy_request(QString json);
    ~OAIPutSinkPolicy_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutSinkPolicy_request)

#endif // OAIPutSinkPolicy_request_H
