...
OAIDeleteSink_request::OAIDeleteSink_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteSink_request::OAIDeleteSink_request() {
    this->initializeModel();
}

OAIDeleteSink_request::~OAIDeleteSink_request() {}

void OAIDeleteSink_request::initializeModel() {

    m_identifier_isSet = false;
    m_identifier_isValid = false;
}

void OAIDeleteSink_request::fromJson(QString jsonString) {
...
void OAIDeleteSink_request::fromJsonObject(QJsonObject json) {

    m_identifier_isValid = ::OpenAPI::fromJsonValue(m_identifier, json[QString("Identifier")]);
    m_identifier_isSet = !json[QString("Identifier")].isNull() && m_identifier_isValid;
}

QString OAIDeleteSink_request::asJson() const {
...
QJsonObject OAIDeleteSink_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteSink_request::getIdentifier() const {
    return m_identifier;
}
void OAIDeleteSink_request::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIDeleteSink_request::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIDeleteSink_request::is_identifier_Valid() const{
    return m_identifier_isValid;
}

bool OAIDeleteSink_request::isSet() const {
...
bool OAIDeleteSink_request::isValid() const {
