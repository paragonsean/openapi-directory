...
/*
 * OAIDeleteLink_request.h
 *
 * 
 */

#ifndef OAIDeleteLink_request_H
#define OAIDeleteLink_request_H
...
class OAIDeleteLink_request : public OAIObject {
public:
    OAIDeleteLink_request();
    OAIDeleteLink_request(QString json);
    ~OAIDeleteLink_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteLink_request)

#endif // OAIDeleteLink_request_H
