...
#ifndef OAIListLinksInput_H
#define OAIListLinksInput_H
...
class OAIListLinksInput : public OAIObject {
public:
    OAIListLinksInput();
    OAIListLinksInput(QString json);
    ~OAIListLinksInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListLinksInput)

#endif // OAIListLinksInput_H
