...
OAIDeleteLink_request::OAIDeleteLink_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteLink_request::OAIDeleteLink_request() {
    this->initializeModel();
}

OAIDeleteLink_request::~OAIDeleteLink_request() {}

void OAIDeleteLink_request::initializeModel() {

    m_identifier_isSet = false;
    m_identifier_isValid = false;
}

void OAIDeleteLink_request::fromJson(QString jsonString) {
...
void OAIDeleteLink_request::fromJsonObject(QJsonObject json) {

    m_identifier_isValid = ::OpenAPI::fromJsonValue(m_identifier, json[QString("Identifier")]);
    m_identifier_isSet = !json[QString("Identifier")].isNull() && m_identifier_isValid;
}

QString OAIDeleteLink_request::asJson() const {
...
QJsonObject OAIDeleteLink_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteLink_request::getIdentifier() const {
    return m_identifier;
}
void OAIDeleteLink_request::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIDeleteLink_request::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIDeleteLink_request::is_identifier_Valid() const{
    return m_identifier_isValid;
}

bool OAIDeleteLink_request::isSet() const {
...
bool OAIDeleteLink_request::isValid() const {
