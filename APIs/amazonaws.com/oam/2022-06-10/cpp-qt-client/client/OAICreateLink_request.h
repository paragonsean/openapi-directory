...
/*
 * OAICreateLink_request.h
 *
 * 
 */

#ifndef OAICreateLink_request_H
#define OAICreateLink_request_H
...
class OAICreateLink_request : public OAIObject {
public:
    OAICreateLink_request();
    OAICreateLink_request(QString json);
    ~OAICreateLink_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLink_request)

#endif // OAICreateLink_request_H
