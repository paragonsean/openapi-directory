...
async def test_create_link(client):
    ...
    """
    body = openapi_server.CreateLinkRequest()
    headers = { 
...
async def test_create_sink(client):
    ...
    """
    body = openapi_server.CreateSinkRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_delete_link(client):
    ...
    """
    body = openapi_server.DeleteLinkRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_delete_sink(client):
    ...
    """
    body = openapi_server.DeleteSinkRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_get_link(client):
    """Test case for get_link

    
    """
    body = openapi_server.GetLinkRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_get_sink(client):
    """Test case for get_sink

    
    """
    body = openapi_server.GetSinkRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_get_sink_policy(client):
    """Test case for get_sink_policy

    
    """
    body = openapi_server.GetSinkPolicyRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_list_attached_links(client):
    """Test case for list_attached_links

    
    """
    body = openapi_server.ListAttachedLinksRequest()
...
async def test_list_links(client):
    ...
    """
    body = openapi_server.ListLinksRequest()
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_sinks(client):
    """Test case for list_sinks

    
    """
    body = openapi_server.ListSinksRequest()
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_put_sink_policy(client):
    """Test case for put_sink_policy

    
    """
    body = openapi_server.PutSinkPolicyRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_link(client):
    ...
    """
    body = openapi_server.UpdateLinkRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
