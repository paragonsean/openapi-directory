...
class InputInputProcessingConfiguration(Model):
    ...
    def __init__(self, input_lambda_processor: InputProcessingConfigurationInputLambdaProcessor=None):
        """InputInputProcessingConfiguration - a model defined in OpenAPI

        :param input_lambda_processor: The input_lambda_processor of this InputInputProcessingConfiguration.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'InputInputProcessingConfiguration':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Input_InputProcessingConfiguration of this InputInputProcessingConfiguration.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def input_lambda_processor(self):
        """Gets the input_lambda_processor of this InputInputProcessingConfiguration.


        :return: The input_lambda_processor of this InputInputProcessingConfiguration.
    ...
    def input_lambda_processor(self, input_lambda_processor):
        """Sets the input_lambda_processor of this InputInputProcessingConfiguration.
