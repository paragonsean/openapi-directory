...
class InputProcessingConfiguration(Model):
    ...
    def __init__(self, input_lambda_processor: InputProcessingConfigurationInputLambdaProcessor=None):
        """InputProcessingConfiguration - a model defined in OpenAPI

        :param input_lambda_processor: The input_lambda_processor of this InputProcessingConfiguration.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'InputProcessingConfiguration':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The InputProcessingConfiguration of this InputProcessingConfiguration.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def input_lambda_processor(self):
        """Gets the input_lambda_processor of this InputProcessingConfiguration.


        :return: The input_lambda_processor of this InputProcessingConfiguration.
    ...
    def input_lambda_processor(self, input_lambda_processor):
        """Sets the input_lambda_processor of this InputProcessingConfiguration.
