...
class AddApplicationInputRequestInput(Model):
    ...
    def __init__(self, name_prefix: str=None, input_processing_configuration: InputInputProcessingConfiguration=None, kinesis_streams_input: InputKinesisStreamsInput=None, kinesis_firehose_input: InputKinesisFirehoseInput=None, input_parallelism: InputInputParallelism=None, input_schema: InputInputSchema=None):
        """AddApplicationInputRequestInput - a model defined in OpenAPI

        :param name_prefix: The name_prefix of this AddApplicationInputRequestInput.
        :param input_processing_configuration: The input_processing_configuration of this AddApplicationInputRequestInput.
        :param kinesis_streams_input: The kinesis_streams_input of this AddApplicationInputRequestInput.
        :param kinesis_firehose_input: The kinesis_firehose_input of this AddApplicationInputRequestInput.
        :param input_parallelism: The input_parallelism of this AddApplicationInputRequestInput.
        :param input_schema: The input_schema of this AddApplicationInputRequestInput.
        """
        self.openapi_types = {
            'name_prefix': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AddApplicationInputRequestInput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The AddApplicationInputRequest_Input of this AddApplicationInputRequestInput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def name_prefix(self):
        """Gets the name_prefix of this AddApplicationInputRequestInput.


        :return: The name_prefix of this AddApplicationInputRequestInput.
        :rtype: str
        """
    ...
    def name_prefix(self, name_prefix):
        """Sets the name_prefix of this AddApplicationInputRequestInput.
    ...
    def input_processing_configuration(self):
        """Gets the input_processing_configuration of this AddApplicationInputRequestInput.


        :return: The input_processing_configuration of this AddApplicationInputRequestInput.
    ...
    def input_processing_configuration(self, input_processing_configuration):
        """Sets the input_processing_configuration of this AddApplicationInputRequestInput.
    ...
    def kinesis_streams_input(self):
        """Gets the kinesis_streams_input of this AddApplicationInputRequestInput.


        :return: The kinesis_streams_input of this AddApplicationInputRequestInput.
    ...
    def kinesis_streams_input(self, kinesis_streams_input):
        """Sets the kinesis_streams_input of this AddApplicationInputRequestInput.
    ...
    def kinesis_firehose_input(self):
        """Gets the kinesis_firehose_input of this AddApplicationInputRequestInput.


        :return: The kinesis_firehose_input of this AddApplicationInputRequestInput.
    ...
    def kinesis_firehose_input(self, kinesis_firehose_input):
        """Sets the kinesis_firehose_input of this AddApplicationInputRequestInput.
    ...
    def input_parallelism(self):
        """Gets the input_parallelism of this AddApplicationInputRequestInput.


        :return: The input_parallelism of this AddApplicationInputRequestInput.
    ...
    def input_parallelism(self, input_parallelism):
        """Sets the input_parallelism of this AddApplicationInputRequestInput.
    ...
    def input_schema(self):
        """Gets the input_schema of this AddApplicationInputRequestInput.


        :return: The input_schema of this AddApplicationInputRequestInput.
    ...
    def input_schema(self, input_schema):
        """Sets the input_schema of this AddApplicationInputRequestInput.
