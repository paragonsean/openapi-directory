...
class CloudWatchLoggingOption(Model):
    ...
    def __init__(self, log_stream_arn: str=None, role_arn: str=None):
        ...
        :param role_arn: The role_arn of this CloudWatchLoggingOption.
        """
        self.openapi_types = {
            'log_stream_arn': str,
            'role_arn': str
    ...
    @property
    def role_arn(self):
        """Gets the role_arn of this CloudWatchLoggingOption.


        :return: The role_arn of this CloudWatchLoggingOption.
        :rtype: str
        """
    ...
    def role_arn(self, role_arn):
        """Sets the role_arn of this CloudWatchLoggingOption.
