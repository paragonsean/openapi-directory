...
class InputUpdateInputSchemaUpdate(Model):
    ...
    def __init__(self, record_format_update: SourceSchemaRecordFormat=None, record_encoding_update: str=None, record_column_updates: List=None):
        """InputUpdateInputSchemaUpdate - a model defined in OpenAPI

        :param record_format_update: The record_format_update of this InputUpdateInputSchemaUpdate.
        :param record_encoding_update: The record_encoding_update of this InputUpdateInputSchemaUpdate.
        :param record_column_updates: The record_column_updates of this InputUpdateInputSchemaUpdate.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'InputUpdateInputSchemaUpdate':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The InputUpdate_InputSchemaUpdate of this InputUpdateInputSchemaUpdate.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def record_format_update(self):
        """Gets the record_format_update of this InputUpdateInputSchemaUpdate.


        :return: The record_format_update of this InputUpdateInputSchemaUpdate.
    ...
    def record_format_update(self, record_format_update):
        """Sets the record_format_update of this InputUpdateInputSchemaUpdate.
    ...
    def record_encoding_update(self):
        """Gets the record_encoding_update of this InputUpdateInputSchemaUpdate.


        :return: The record_encoding_update of this InputUpdateInputSchemaUpdate.
        :rtype: str
        """
    ...
    def record_encoding_update(self, record_encoding_update):
        """Sets the record_encoding_update of this InputUpdateInputSchemaUpdate.
    ...
    def record_column_updates(self):
        """Gets the record_column_updates of this InputUpdateInputSchemaUpdate.


        :return: The record_column_updates of this InputUpdateInputSchemaUpdate.
        :rtype: List
        """
    ...
    def record_column_updates(self, record_column_updates):
        """Sets the record_column_updates of this InputUpdateInputSchemaUpdate.
