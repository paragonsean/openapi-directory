...
QString OAIOutput_KinesisFirehoseOutput::getRoleArn() const {
    return m_role_arn;
}
void OAIOutput_KinesisFirehoseOutput::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIOutput_KinesisFirehoseOutput::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIOutput_KinesisFirehoseOutput::is_role_arn_Valid() const{
