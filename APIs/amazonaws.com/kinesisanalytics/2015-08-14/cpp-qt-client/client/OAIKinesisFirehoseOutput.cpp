...
QString OAIKinesisFirehoseOutput::getRoleArn() const {
    return m_role_arn;
}
void OAIKinesisFirehoseOutput::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIKinesisFirehoseOutput::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIKinesisFirehoseOutput::is_role_arn_Valid() const{
