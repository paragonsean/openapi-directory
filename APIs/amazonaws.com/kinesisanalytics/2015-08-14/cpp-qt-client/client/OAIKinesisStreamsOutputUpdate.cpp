...
QString OAIKinesisStreamsOutputUpdate::getRoleArnUpdate() const {
    return m_role_arn_update;
}
void OAIKinesisStreamsOutputUpdate::setRoleArnUpdate(const QString &role_arn_update) {
    m_role_arn_update = role_arn_update;
    m_role_arn_update_isSet = true;
}

bool OAIKinesisStreamsOutputUpdate::is_role_arn_update_Set() const{
    return m_role_arn_update_isSet;
}

bool OAIKinesisStreamsOutputUpdate::is_role_arn_update_Valid() const{
