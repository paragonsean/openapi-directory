...
/*
 * OAIDeleteApplicationOutputRequest.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIDeleteApplicationOutputRequest_H
#define OAIDeleteApplicationOutputRequest_H
...
class OAIDeleteApplicationOutputRequest : public OAIObject {
public:
    OAIDeleteApplicationOutputRequest();
    OAIDeleteApplicationOutputRequest(QString json);
    ~OAIDeleteApplicationOutputRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteApplicationOutputRequest)

#endif // OAIDeleteApplicationOutputRequest_H
