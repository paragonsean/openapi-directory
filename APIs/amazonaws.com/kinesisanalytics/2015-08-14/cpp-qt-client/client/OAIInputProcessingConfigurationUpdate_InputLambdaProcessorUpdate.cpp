...
QString OAIInputProcessingConfigurationUpdate_InputLambdaProcessorUpdate::getRoleArnUpdate() const {
    return m_role_arn_update;
}
void OAIInputProcessingConfigurationUpdate_InputLambdaProcessorUpdate::setRoleArnUpdate(const QString &role_arn_update) {
    m_role_arn_update = role_arn_update;
    m_role_arn_update_isSet = true;
}

bool OAIInputProcessingConfigurationUpdate_InputLambdaProcessorUpdate::is_role_arn_update_Set() const{
    return m_role_arn_update_isSet;
}

bool OAIInputProcessingConfigurationUpdate_InputLambdaProcessorUpdate::is_role_arn_update_Valid() const{
