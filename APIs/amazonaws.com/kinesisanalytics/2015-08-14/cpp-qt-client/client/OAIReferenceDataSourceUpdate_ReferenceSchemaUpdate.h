...
/*
 * OAIReferenceDataSourceUpdate_ReferenceSchemaUpdate.h
 *
 * 
 */

#ifndef OAIReferenceDataSourceUpdate_ReferenceSchemaUpdate_H
#define OAIReferenceDataSourceUpdate_ReferenceSchemaUpdate_H
...
class OAIReferenceDataSourceUpdate_ReferenceSchemaUpdate : public OAIObject {
public:
    OAIReferenceDataSourceUpdate_ReferenceSchemaUpdate();
    OAIReferenceDataSourceUpdate_ReferenceSchemaUpdate(QString json);
    ~OAIReferenceDataSourceUpdate_ReferenceSchemaUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReferenceDataSourceUpdate_ReferenceSchemaUpdate)

#endif // OAIReferenceDataSourceUpdate_ReferenceSchemaUpdate_H
