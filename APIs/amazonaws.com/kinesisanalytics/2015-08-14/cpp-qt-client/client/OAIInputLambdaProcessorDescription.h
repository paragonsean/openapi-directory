...
/*
 * OAIInputLambdaProcessorDescription.h
 *
...
#ifndef OAIInputLambdaProcessorDescription_H
#define OAIInputLambdaProcessorDescription_H
...
class OAIInputLambdaProcessorDescription : public OAIObject {
public:
    OAIInputLambdaProcessorDescription();
    OAIInputLambdaProcessorDescription(QString json);
    ~OAIInputLambdaProcessorDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInputLambdaProcessorDescription)

#endif // OAIInputLambdaProcessorDescription_H
