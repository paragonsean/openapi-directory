...
QString OAIOutputUpdate_KinesisStreamsOutputUpdate::getRoleArnUpdate() const {
    return m_role_arn_update;
}
void OAIOutputUpdate_KinesisStreamsOutputUpdate::setRoleArnUpdate(const QString &role_arn_update) {
    m_role_arn_update = role_arn_update;
    m_role_arn_update_isSet = true;
}

bool OAIOutputUpdate_KinesisStreamsOutputUpdate::is_role_arn_update_Set() const{
    return m_role_arn_update_isSet;
}

bool OAIOutputUpdate_KinesisStreamsOutputUpdate::is_role_arn_update_Valid() const{
