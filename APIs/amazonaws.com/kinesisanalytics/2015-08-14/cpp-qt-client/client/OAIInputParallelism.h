...
#ifndef OAIInputParallelism_H
#define OAIInputParallelism_H
...
class OAIInputParallelism : public OAIObject {
public:
    OAIInputParallelism();
    OAIInputParallelism(QString json);
    ~OAIInputParallelism() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInputParallelism)

#endif // OAIInputParallelism_H
