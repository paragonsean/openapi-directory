...
QString OAIOutput_KinesisStreamsOutput::getRoleArn() const {
    return m_role_arn;
}
void OAIOutput_KinesisStreamsOutput::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIOutput_KinesisStreamsOutput::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIOutput_KinesisStreamsOutput::is_role_arn_Valid() const{
