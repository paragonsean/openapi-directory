...
/*
 * OAIInputSchemaUpdate.h
 *
 * Describes updates for the application&#39;s input schema.
 */

#ifndef OAIInputSchemaUpdate_H
#define OAIInputSchemaUpdate_H
...
class OAIInputSchemaUpdate : public OAIObject {
public:
    OAIInputSchemaUpdate();
    OAIInputSchemaUpdate(QString json);
    ~OAIInputSchemaUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInputSchemaUpdate)

#endif // OAIInputSchemaUpdate_H
