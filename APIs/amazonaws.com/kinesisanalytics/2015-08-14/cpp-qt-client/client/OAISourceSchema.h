...
#ifndef OAISourceSchema_H
#define OAISourceSchema_H
...
class OAISourceSchema : public OAIObject {
public:
    OAISourceSchema();
    OAISourceSchema(QString json);
    ~OAISourceSchema() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISourceSchema)

#endif // OAISourceSchema_H
