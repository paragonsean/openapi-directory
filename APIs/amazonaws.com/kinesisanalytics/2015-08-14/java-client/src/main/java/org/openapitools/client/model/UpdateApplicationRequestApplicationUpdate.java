...
public class UpdateApplicationRequestApplicationUpdate {
  ...
  public UpdateApplicationRequestApplicationUpdate() {
  }

  public UpdateApplicationRequestApplicationUpdate inputUpdates(List inputUpdates) {
  ...
  public UpdateApplicationRequestApplicationUpdate applicationCodeUpdate(String applicationCodeUpdate) {
  ...
  public UpdateApplicationRequestApplicationUpdate outputUpdates(List outputUpdates) {
  ...
  public UpdateApplicationRequestApplicationUpdate referenceDataSourceUpdates(List referenceDataSourceUpdates) {
  ...
  public UpdateApplicationRequestApplicationUpdate cloudWatchLoggingOptionUpdates(List cloudWatchLoggingOptionUpdates) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateApplicationRequestApplicationUpdate updateApplicationRequestApplicationUpdate = (UpdateApplicationRequestApplicationUpdate) o;
    return Objects.equals(this.inputUpdates, updateApplicationRequestApplicationUpdate.inputUpdates) &&
        Objects.equals(this.applicationCodeUpdate, updateApplicationRequestApplicationUpdate.applicationCodeUpdate) &&
        Objects.equals(this.outputUpdates, updateApplicationRequestApplicationUpdate.outputUpdates) &&
        Objects.equals(this.referenceDataSourceUpdates, updateApplicationRequestApplicationUpdate.referenceDataSourceUpdates) &&
        Objects.equals(this.cloudWatchLoggingOptionUpdates, updateApplicationRequestApplicationUpdate.cloudWatchLoggingOptionUpdates);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateApplicationRequestApplicationUpdate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateApplicationRequestApplicationUpdate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateApplicationRequestApplicationUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateApplicationRequestApplicationUpdate is not found in the empty JSON string", UpdateApplicationRequestApplicationUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateApplicationRequestApplicationUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateApplicationRequestApplicationUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateApplicationRequestApplicationUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateApplicationRequestApplicationUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateApplicationRequestApplicationUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateApplicationRequestApplicationUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateApplicationRequestApplicationUpdate>() {
           @Override
           public void write(JsonWriter out, UpdateApplicationRequestApplicationUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateApplicationRequestApplicationUpdate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateApplicationRequestApplicationUpdate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateApplicationRequestApplicationUpdate
   * @throws IOException if the JSON string is invalid with respect to UpdateApplicationRequestApplicationUpdate
   */
  public static UpdateApplicationRequestApplicationUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateApplicationRequestApplicationUpdate.class);
  }

  /**
   * Convert an instance of UpdateApplicationRequestApplicationUpdate to an JSON string
   *
   * @return JSON string
   */
