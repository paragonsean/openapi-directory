...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKinesisAnalytics.OutputKinesisFirehoseOutput();
  });
  ...
  describe('OutputKinesisFirehoseOutput', function() {
    it('should create an instance of OutputKinesisFirehoseOutput', function() {
      // uncomment below and update the code to test OutputKinesisFirehoseOutput
      //var instance = new AmazonKinesisAnalytics.OutputKinesisFirehoseOutput();
      //expect(instance).to.be.a(AmazonKinesisAnalytics.OutputKinesisFirehoseOutput);
    });
