...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKinesisAnalytics.InputKinesisFirehoseInput();
  });
  ...
  describe('InputKinesisFirehoseInput', function() {
    it('should create an instance of InputKinesisFirehoseInput', function() {
      // uncomment below and update the code to test InputKinesisFirehoseInput
      //var instance = new AmazonKinesisAnalytics.InputKinesisFirehoseInput();
      //expect(instance).to.be.a(AmazonKinesisAnalytics.InputKinesisFirehoseInput);
    });
