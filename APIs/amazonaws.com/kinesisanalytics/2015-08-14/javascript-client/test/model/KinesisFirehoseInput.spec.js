...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKinesisAnalytics.KinesisFirehoseInput();
  });
  ...
  describe('KinesisFirehoseInput', function() {
    it('should create an instance of KinesisFirehoseInput', function() {
      // uncomment below and update the code to test KinesisFirehoseInput
      //var instance = new AmazonKinesisAnalytics.KinesisFirehoseInput();
      //expect(instance).to.be.a(AmazonKinesisAnalytics.KinesisFirehoseInput);
    });
