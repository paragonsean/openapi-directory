...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKinesisAnalytics.KinesisFirehoseOutput();
  });
  ...
  describe('KinesisFirehoseOutput', function() {
    it('should create an instance of KinesisFirehoseOutput', function() {
      // uncomment below and update the code to test KinesisFirehoseOutput
      //var instance = new AmazonKinesisAnalytics.KinesisFirehoseOutput();
      //expect(instance).to.be.a(AmazonKinesisAnalytics.KinesisFirehoseOutput);
    });
