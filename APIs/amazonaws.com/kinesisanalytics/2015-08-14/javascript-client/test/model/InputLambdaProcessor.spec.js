...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKinesisAnalytics.InputLambdaProcessor();
  });
  ...
  describe('InputLambdaProcessor', function() {
    it('should create an instance of InputLambdaProcessor', function() {
      // uncomment below and update the code to test InputLambdaProcessor
      //var instance = new AmazonKinesisAnalytics.InputLambdaProcessor();
      //expect(instance).to.be.a(AmazonKinesisAnalytics.InputLambdaProcessor);
    });
