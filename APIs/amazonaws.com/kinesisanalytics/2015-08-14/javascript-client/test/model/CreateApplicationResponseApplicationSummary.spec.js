...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKinesisAnalytics.CreateApplicationResponseApplicationSummary();
  });
  ...
  describe('CreateApplicationResponseApplicationSummary', function() {
    it('should create an instance of CreateApplicationResponseApplicationSummary', function() {
      // uncomment below and update the code to test CreateApplicationResponseApplicationSummary
      //var instance = new AmazonKinesisAnalytics.CreateApplicationResponseApplicationSummary();
      //expect(instance).to.be.a(AmazonKinesisAnalytics.CreateApplicationResponseApplicationSummary);
    });
