...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKinesisAnalytics.KinesisStreamsInput();
  });
  ...
  describe('KinesisStreamsInput', function() {
    it('should create an instance of KinesisStreamsInput', function() {
      // uncomment below and update the code to test KinesisStreamsInput
      //var instance = new AmazonKinesisAnalytics.KinesisStreamsInput();
      //expect(instance).to.be.a(AmazonKinesisAnalytics.KinesisStreamsInput);
    });
