...
import UpdateApplicationRequestApplicationUpdate from './UpdateApplicationRequestApplicationUpdate';
...
class UpdateApplicationRequest {
     ...
     * @param applicationUpdate {module:model/UpdateApplicationRequestApplicationUpdate} 
     */
    constructor(applicationName, currentApplicationVersionId, applicationUpdate) { 
        
        UpdateApplicationRequest.initialize(this, applicationName, currentApplicationVersionId, applicationUpdate);
    }
     ...
     */
    static initialize(obj, applicationName, currentApplicationVersionId, applicationUpdate) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ApplicationUpdate')) {
                obj['ApplicationUpdate'] = UpdateApplicationRequestApplicationUpdate.constructFromObject(data['ApplicationUpdate']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `ApplicationUpdate`
        if (data['ApplicationUpdate']) { // data not null
          UpdateApplicationRequestApplicationUpdate.validateJSON(data['ApplicationUpdate']);
        }
...
UpdateApplicationRequest.RequiredProperties = ["ApplicationName", "CurrentApplicationVersionId", "ApplicationUpdate"];
...
/**
 * @member {module:model/UpdateApplicationRequestApplicationUpdate} ApplicationUpdate
 */
UpdateApplicationRequest.prototype['ApplicationUpdate'] = undefined;
