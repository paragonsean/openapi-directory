...
class ApiClient {
    ...
    constructor(basePath = 'http://kinesisanalytics.us-east-1.amazonaws.com') {
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2015-08-14/Javascript'
        };
        ...
        return [
            {
              ...
              'description': "The Kinesis Analytics multi-region endpoint",
              'variables': {
                region: {
            ...
            },
            {
              ...
              'description': "The Kinesis Analytics endpoint for China (Beijing) and China (Ningxia)",
              'variables': {
                region: {
                    'description': "The AWS region",
