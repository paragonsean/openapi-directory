...
class HostedZone(Model):
    ...
    def __init__(self, id: str=None, name: str=None, caller_reference: str=None, config: HostedZoneConfig=None, resource_record_set_count: int=None, linked_service: HostedZoneLinkedService=None):
        """HostedZone - a model defined in OpenAPI

        :param id: The id of this HostedZone.
        :param name: The name of this HostedZone.
        :param caller_reference: The caller_reference of this HostedZone.
        :param config: The config of this HostedZone.
        :param resource_record_set_count: The resource_record_set_count of this HostedZone.
        :param linked_service: The linked_service of this HostedZone.
        """
        self.openapi_types = {
            'id': str,
            'name': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'HostedZone':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The HostedZone of this HostedZone.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def id(self):
        """Gets the id of this HostedZone.


        :return: The id of this HostedZone.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this HostedZone.
    ...
    @property
    def name(self):
        """Gets the name of this HostedZone.


        :return: The name of this HostedZone.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this HostedZone.
    ...
    def caller_reference(self):
        """Gets the caller_reference of this HostedZone.


        :return: The caller_reference of this HostedZone.
        :rtype: str
        """
    ...
    def caller_reference(self, caller_reference):
        """Sets the caller_reference of this HostedZone.
    ...
    @property
    def config(self):
        """Gets the config of this HostedZone.


        :return: The config of this HostedZone.
    ...
    def config(self, config):
        """Sets the config of this HostedZone.
    ...
    def resource_record_set_count(self):
        """Gets the resource_record_set_count of this HostedZone.


        :return: The resource_record_set_count of this HostedZone.
        :rtype: int
        """
    ...
    def resource_record_set_count(self, resource_record_set_count):
        """Sets the resource_record_set_count of this HostedZone.
    ...
    def linked_service(self):
        """Gets the linked_service of this HostedZone.


        :return: The linked_service of this HostedZone.
    ...
    def linked_service(self, linked_service):
        """Sets the linked_service of this HostedZone.
