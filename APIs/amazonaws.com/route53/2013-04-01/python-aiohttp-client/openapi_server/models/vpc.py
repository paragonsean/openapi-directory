...
class VPC(Model):
    ...
    def __init__(self, vpc_region: VPCRegion=None, vpcid: str=None):
        ...
        :param vpcid: The vpcid of this VPC.
        """
        self.openapi_types = {
    ...
    @property
    def vpc_region(self):
        """Gets the vpc_region of this VPC.
    ...
    def vpc_region(self, vpc_region):
        """Sets the vpc_region of this VPC.
    ...
    @property
    def vpcid(self):
        """Gets the vpcid of this VPC.

        (Private hosted zones only) The ID of an Amazon VPC. 

        :return: The vpcid of this VPC.
        :rtype: str
        """
        return self._vpcid
