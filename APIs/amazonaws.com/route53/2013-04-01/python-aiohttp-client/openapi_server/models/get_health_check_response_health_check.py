...
class GetHealthCheckResponseHealthCheck(Model):
    ...
    def __init__(self, id: str=None, caller_reference: str=None, linked_service: HealthCheckLinkedService=None, health_check_config: HealthCheckHealthCheckConfig=None, health_check_version: int=None, cloud_watch_alarm_configuration: HealthCheckCloudWatchAlarmConfiguration=None):
        """GetHealthCheckResponseHealthCheck - a model defined in OpenAPI

        :param id: The id of this GetHealthCheckResponseHealthCheck.
        :param caller_reference: The caller_reference of this GetHealthCheckResponseHealthCheck.
        :param linked_service: The linked_service of this GetHealthCheckResponseHealthCheck.
        :param health_check_config: The health_check_config of this GetHealthCheckResponseHealthCheck.
        :param health_check_version: The health_check_version of this GetHealthCheckResponseHealthCheck.
        :param cloud_watch_alarm_configuration: The cloud_watch_alarm_configuration of this GetHealthCheckResponseHealthCheck.
        """
        self.openapi_types = {
            'id': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetHealthCheckResponseHealthCheck':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GetHealthCheckResponse_HealthCheck of this GetHealthCheckResponseHealthCheck.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def id(self):
        """Gets the id of this GetHealthCheckResponseHealthCheck.


        :return: The id of this GetHealthCheckResponseHealthCheck.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this GetHealthCheckResponseHealthCheck.
    ...
    def caller_reference(self):
        """Gets the caller_reference of this GetHealthCheckResponseHealthCheck.


        :return: The caller_reference of this GetHealthCheckResponseHealthCheck.
        :rtype: str
        """
    ...
    def caller_reference(self, caller_reference):
        """Sets the caller_reference of this GetHealthCheckResponseHealthCheck.
    ...
    def linked_service(self):
        """Gets the linked_service of this GetHealthCheckResponseHealthCheck.


        :return: The linked_service of this GetHealthCheckResponseHealthCheck.
    ...
    def linked_service(self, linked_service):
        """Sets the linked_service of this GetHealthCheckResponseHealthCheck.
    ...
    def health_check_config(self):
        """Gets the health_check_config of this GetHealthCheckResponseHealthCheck.


        :return: The health_check_config of this GetHealthCheckResponseHealthCheck.
    ...
    def health_check_config(self, health_check_config):
        """Sets the health_check_config of this GetHealthCheckResponseHealthCheck.
    ...
    def health_check_version(self):
        """Gets the health_check_version of this GetHealthCheckResponseHealthCheck.


        :return: The health_check_version of this GetHealthCheckResponseHealthCheck.
        :rtype: int
        """
    ...
    def health_check_version(self, health_check_version):
        """Sets the health_check_version of this GetHealthCheckResponseHealthCheck.
    ...
    def cloud_watch_alarm_configuration(self):
        """Gets the cloud_watch_alarm_configuration of this GetHealthCheckResponseHealthCheck.


        :return: The cloud_watch_alarm_configuration of this GetHealthCheckResponseHealthCheck.
    ...
    def cloud_watch_alarm_configuration(self, cloud_watch_alarm_configuration):
        """Sets the cloud_watch_alarm_configuration of this GetHealthCheckResponseHealthCheck.
