...
/*
 * OAITrafficPolicyInstances_inner.h
 *
 * 
 */

#ifndef OAITrafficPolicyInstances_inner_H
#define OAITrafficPolicyInstances_inner_H
...
class OAITrafficPolicyInstances_inner : public OAIObject {
public:
    OAITrafficPolicyInstances_inner();
    OAITrafficPolicyInstances_inner(QString json);
    ~OAITrafficPolicyInstances_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrafficPolicyInstances_inner)

#endif // OAITrafficPolicyInstances_inner_H
