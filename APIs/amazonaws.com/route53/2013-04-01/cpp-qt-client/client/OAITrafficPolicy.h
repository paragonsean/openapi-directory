...
#ifndef OAITrafficPolicy_H
#define OAITrafficPolicy_H
...
class OAITrafficPolicy : public OAIObject {
public:
    OAITrafficPolicy();
    OAITrafficPolicy(QString json);
    ~OAITrafficPolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrafficPolicy)

#endif // OAITrafficPolicy_H
