...
/*
 * OAIResourceRecordSet_GeoLocation.h
 *
 * 
 */

#ifndef OAIResourceRecordSet_GeoLocation_H
#define OAIResourceRecordSet_GeoLocation_H
...
class OAIResourceRecordSet_GeoLocation : public OAIObject {
public:
    OAIResourceRecordSet_GeoLocation();
    OAIResourceRecordSet_GeoLocation(QString json);
    ~OAIResourceRecordSet_GeoLocation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceRecordSet_GeoLocation)

#endif // OAIResourceRecordSet_GeoLocation_H
