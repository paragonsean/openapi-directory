...
/*
 * OAICreateTrafficPolicyInstance_request.h
 *
 * 
 */

#ifndef OAICreateTrafficPolicyInstance_request_H
#define OAICreateTrafficPolicyInstance_request_H
...
class OAICreateTrafficPolicyInstance_request : public OAIObject {
public:
    OAICreateTrafficPolicyInstance_request();
    OAICreateTrafficPolicyInstance_request(QString json);
    ~OAICreateTrafficPolicyInstance_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTrafficPolicyInstance_request)

#endif // OAICreateTrafficPolicyInstance_request_H
