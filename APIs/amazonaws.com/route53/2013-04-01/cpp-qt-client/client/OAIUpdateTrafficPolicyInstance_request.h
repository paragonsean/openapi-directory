...
/*
 * OAIUpdateTrafficPolicyInstance_request.h
 *
 * 
 */

#ifndef OAIUpdateTrafficPolicyInstance_request_H
#define OAIUpdateTrafficPolicyInstance_request_H
...
class OAIUpdateTrafficPolicyInstance_request : public OAIObject {
public:
    OAIUpdateTrafficPolicyInstance_request();
    OAIUpdateTrafficPolicyInstance_request(QString json);
    ~OAIUpdateTrafficPolicyInstance_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateTrafficPolicyInstance_request)

#endif // OAIUpdateTrafficPolicyInstance_request_H
