...
/*
 * OAIHealthCheck_HealthCheckConfig.h
 *
 * 
 */

#ifndef OAIHealthCheck_HealthCheckConfig_H
#define OAIHealthCheck_HealthCheckConfig_H
...
class OAIHealthCheck_HealthCheckConfig : public OAIObject {
public:
    OAIHealthCheck_HealthCheckConfig();
    OAIHealthCheck_HealthCheckConfig(QString json);
    ~OAIHealthCheck_HealthCheckConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHealthCheck_HealthCheckConfig)

#endif // OAIHealthCheck_HealthCheckConfig_H
