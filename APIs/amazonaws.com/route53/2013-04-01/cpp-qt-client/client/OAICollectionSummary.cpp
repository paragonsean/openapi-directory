...
qint32 OAICollectionSummary::getVersion() const {
    return m_version;
}
void OAICollectionSummary::setVersion(const qint32 &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAICollectionSummary::is_version_Set() const{
    return m_version_isSet;
}

bool OAICollectionSummary::is_version_Valid() const{
