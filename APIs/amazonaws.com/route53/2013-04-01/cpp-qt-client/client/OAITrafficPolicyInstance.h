...
/*
 * OAITrafficPolicyInstance.h
 *
 * A complex type that contains settings for the new traffic policy instance.
 */

#ifndef OAITrafficPolicyInstance_H
#define OAITrafficPolicyInstance_H
...
class OAITrafficPolicyInstance : public OAIObject {
public:
    OAITrafficPolicyInstance();
    OAITrafficPolicyInstance(QString json);
    ~OAITrafficPolicyInstance() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrafficPolicyInstance)

#endif // OAITrafficPolicyInstance_H
