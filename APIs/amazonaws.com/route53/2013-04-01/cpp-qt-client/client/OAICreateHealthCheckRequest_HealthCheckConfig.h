...
/*
 * OAICreateHealthCheckRequest_HealthCheckConfig.h
 *
 * 
 */

#ifndef OAICreateHealthCheckRequest_HealthCheckConfig_H
#define OAICreateHealthCheckRequest_HealthCheckConfig_H
...
class OAICreateHealthCheckRequest_HealthCheckConfig : public OAIObject {
public:
    OAICreateHealthCheckRequest_HealthCheckConfig();
    OAICreateHealthCheckRequest_HealthCheckConfig(QString json);
    ~OAICreateHealthCheckRequest_HealthCheckConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateHealthCheckRequest_HealthCheckConfig)

#endif // OAICreateHealthCheckRequest_HealthCheckConfig_H
