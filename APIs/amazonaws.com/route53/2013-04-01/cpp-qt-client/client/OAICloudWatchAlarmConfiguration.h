...
/*
 * OAICloudWatchAlarmConfiguration.h
 *
 * A complex type that contains information about the CloudWatch alarm that Amazon Route 53 is monitoring for this health check.
 */

#ifndef OAICloudWatchAlarmConfiguration_H
#define OAICloudWatchAlarmConfiguration_H
...
class OAICloudWatchAlarmConfiguration : public OAIObject {
public:
    OAICloudWatchAlarmConfiguration();
    OAICloudWatchAlarmConfiguration(QString json);
    ~OAICloudWatchAlarmConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICloudWatchAlarmConfiguration)

#endif // OAICloudWatchAlarmConfiguration_H
