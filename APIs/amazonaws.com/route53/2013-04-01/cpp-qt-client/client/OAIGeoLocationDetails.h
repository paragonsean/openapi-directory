...
#ifndef OAIGeoLocationDetails_H
#define OAIGeoLocationDetails_H
...
class OAIGeoLocationDetails : public OAIObject {
public:
    OAIGeoLocationDetails();
    OAIGeoLocationDetails(QString json);
    ~OAIGeoLocationDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGeoLocationDetails)

#endif // OAIGeoLocationDetails_H
