...
#ifndef OAICidrRoutingConfig_H
#define OAICidrRoutingConfig_H
...
class OAICidrRoutingConfig : public OAIObject {
public:
    OAICidrRoutingConfig();
    OAICidrRoutingConfig(QString json);
    ~OAICidrRoutingConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICidrRoutingConfig)

#endif // OAICidrRoutingConfig_H
