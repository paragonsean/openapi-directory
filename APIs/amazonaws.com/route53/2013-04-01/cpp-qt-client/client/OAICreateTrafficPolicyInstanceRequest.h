...
/*
 * OAICreateTrafficPolicyInstanceRequest.h
 *
 * A complex type that contains information about the resource record sets that you want to create based on a specified traffic policy.
 */

#ifndef OAICreateTrafficPolicyInstanceRequest_H
#define OAICreateTrafficPolicyInstanceRequest_H
...
class OAICreateTrafficPolicyInstanceRequest : public OAIObject {
public:
    OAICreateTrafficPolicyInstanceRequest();
    OAICreateTrafficPolicyInstanceRequest(QString json);
    ~OAICreateTrafficPolicyInstanceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTrafficPolicyInstanceRequest)

#endif // OAICreateTrafficPolicyInstanceRequest_H
