...
#ifndef OAIChangeInfo_H
#define OAIChangeInfo_H
...
class OAIChangeInfo : public OAIObject {
public:
    OAIChangeInfo();
    OAIChangeInfo(QString json);
    ~OAIChangeInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChangeInfo)

#endif // OAIChangeInfo_H
