...
/*
 * OAIChange_ResourceRecordSet.h
 *
 * 
 */

#ifndef OAIChange_ResourceRecordSet_H
#define OAIChange_ResourceRecordSet_H
...
class OAIChange_ResourceRecordSet : public OAIObject {
public:
    OAIChange_ResourceRecordSet();
    OAIChange_ResourceRecordSet(QString json);
    ~OAIChange_ResourceRecordSet() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChange_ResourceRecordSet)

#endif // OAIChange_ResourceRecordSet_H
