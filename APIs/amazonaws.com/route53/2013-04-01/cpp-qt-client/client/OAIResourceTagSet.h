...
#ifndef OAIResourceTagSet_H
#define OAIResourceTagSet_H
...
class OAIResourceTagSet : public OAIObject {
public:
    OAIResourceTagSet();
    OAIResourceTagSet(QString json);
    ~OAIResourceTagSet() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceTagSet)

#endif // OAIResourceTagSet_H
