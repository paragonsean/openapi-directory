...
OAIKeySigningKey::OAIKeySigningKey(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIKeySigningKey::OAIKeySigningKey() {
    this->initializeModel();
}

OAIKeySigningKey::~OAIKeySigningKey() {}

void OAIKeySigningKey::initializeModel() {
...
void OAIKeySigningKey::fromJson(QString jsonString) {
...
void OAIKeySigningKey::fromJsonObject(QJsonObject json) {
...
QString OAIKeySigningKey::asJson() const {
...
QJsonObject OAIKeySigningKey::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIKeySigningKey::getName() const {
    return m_name;
}
void OAIKeySigningKey::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIKeySigningKey::is_name_Set() const{
    return m_name_isSet;
}

bool OAIKeySigningKey::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIKeySigningKey::getKmsArn() const {
    return m_kms_arn;
}
void OAIKeySigningKey::setKmsArn(const QString &kms_arn) {
    m_kms_arn = kms_arn;
    m_kms_arn_isSet = true;
}

bool OAIKeySigningKey::is_kms_arn_Set() const{
    return m_kms_arn_isSet;
}

bool OAIKeySigningKey::is_kms_arn_Valid() const{
    return m_kms_arn_isValid;
}

qint32 OAIKeySigningKey::getFlag() const {
    return m_flag;
}
void OAIKeySigningKey::setFlag(const qint32 &flag) {
    m_flag = flag;
    m_flag_isSet = true;
}

bool OAIKeySigningKey::is_flag_Set() const{
    return m_flag_isSet;
}

bool OAIKeySigningKey::is_flag_Valid() const{
    return m_flag_isValid;
}

QString OAIKeySigningKey::getSigningAlgorithmMnemonic() const {
    return m_signing_algorithm_mnemonic;
}
void OAIKeySigningKey::setSigningAlgorithmMnemonic(const QString &signing_algorithm_mnemonic) {
    m_signing_algorithm_mnemonic = signing_algorithm_mnemonic;
    m_signing_algorithm_mnemonic_isSet = true;
}

bool OAIKeySigningKey::is_signing_algorithm_mnemonic_Set() const{
    return m_signing_algorithm_mnemonic_isSet;
}

bool OAIKeySigningKey::is_signing_algorithm_mnemonic_Valid() const{
    return m_signing_algorithm_mnemonic_isValid;
}

qint32 OAIKeySigningKey::getSigningAlgorithmType() const {
    return m_signing_algorithm_type;
}
void OAIKeySigningKey::setSigningAlgorithmType(const qint32 &signing_algorithm_type) {
    m_signing_algorithm_type = signing_algorithm_type;
    m_signing_algorithm_type_isSet = true;
}

bool OAIKeySigningKey::is_signing_algorithm_type_Set() const{
    return m_signing_algorithm_type_isSet;
}

bool OAIKeySigningKey::is_signing_algorithm_type_Valid() const{
    return m_signing_algorithm_type_isValid;
}

QString OAIKeySigningKey::getDigestAlgorithmMnemonic() const {
    return m_digest_algorithm_mnemonic;
}
void OAIKeySigningKey::setDigestAlgorithmMnemonic(const QString &digest_algorithm_mnemonic) {
    m_digest_algorithm_mnemonic = digest_algorithm_mnemonic;
    m_digest_algorithm_mnemonic_isSet = true;
}

bool OAIKeySigningKey::is_digest_algorithm_mnemonic_Set() const{
    return m_digest_algorithm_mnemonic_isSet;
}

bool OAIKeySigningKey::is_digest_algorithm_mnemonic_Valid() const{
    return m_digest_algorithm_mnemonic_isValid;
}

qint32 OAIKeySigningKey::getDigestAlgorithmType() const {
    return m_digest_algorithm_type;
}
void OAIKeySigningKey::setDigestAlgorithmType(const qint32 &digest_algorithm_type) {
    m_digest_algorithm_type = digest_algorithm_type;
    m_digest_algorithm_type_isSet = true;
}

bool OAIKeySigningKey::is_digest_algorithm_type_Set() const{
    return m_digest_algorithm_type_isSet;
}

bool OAIKeySigningKey::is_digest_algorithm_type_Valid() const{
    return m_digest_algorithm_type_isValid;
}

qint32 OAIKeySigningKey::getKeyTag() const {
    return m_key_tag;
}
void OAIKeySigningKey::setKeyTag(const qint32 &key_tag) {
    m_key_tag = key_tag;
    m_key_tag_isSet = true;
}

bool OAIKeySigningKey::is_key_tag_Set() const{
    return m_key_tag_isSet;
}

bool OAIKeySigningKey::is_key_tag_Valid() const{
    return m_key_tag_isValid;
}

QString OAIKeySigningKey::getDigestValue() const {
    return m_digest_value;
}
void OAIKeySigningKey::setDigestValue(const QString &digest_value) {
    m_digest_value = digest_value;
    m_digest_value_isSet = true;
}

bool OAIKeySigningKey::is_digest_value_Set() const{
    return m_digest_value_isSet;
}

bool OAIKeySigningKey::is_digest_value_Valid() const{
    return m_digest_value_isValid;
}

QString OAIKeySigningKey::getPublicKey() const {
    return m_public_key;
}
void OAIKeySigningKey::setPublicKey(const QString &public_key) {
    m_public_key = public_key;
    m_public_key_isSet = true;
}

bool OAIKeySigningKey::is_public_key_Set() const{
    return m_public_key_isSet;
}

bool OAIKeySigningKey::is_public_key_Valid() const{
    return m_public_key_isValid;
}

QString OAIKeySigningKey::getDsRecord() const {
    return m_ds_record;
}
void OAIKeySigningKey::setDsRecord(const QString &ds_record) {
    m_ds_record = ds_record;
    m_ds_record_isSet = true;
}

bool OAIKeySigningKey::is_ds_record_Set() const{
    return m_ds_record_isSet;
}

bool OAIKeySigningKey::is_ds_record_Valid() const{
    return m_ds_record_isValid;
}

QString OAIKeySigningKey::getDnskeyRecord() const {
    return m_dnskey_record;
}
void OAIKeySigningKey::setDnskeyRecord(const QString &dnskey_record) {
    m_dnskey_record = dnskey_record;
    m_dnskey_record_isSet = true;
}

bool OAIKeySigningKey::is_dnskey_record_Set() const{
    return m_dnskey_record_isSet;
}

bool OAIKeySigningKey::is_dnskey_record_Valid() const{
    return m_dnskey_record_isValid;
}

QString OAIKeySigningKey::getStatus() const {
    return m_status;
}
void OAIKeySigningKey::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIKeySigningKey::is_status_Set() const{
    return m_status_isSet;
}

bool OAIKeySigningKey::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIKeySigningKey::getStatusMessage() const {
    return m_status_message;
}
void OAIKeySigningKey::setStatusMessage(const QString &status_message) {
    m_status_message = status_message;
    m_status_message_isSet = true;
}

bool OAIKeySigningKey::is_status_message_Set() const{
    return m_status_message_isSet;
}

bool OAIKeySigningKey::is_status_message_Valid() const{
    return m_status_message_isValid;
}

QDateTime OAIKeySigningKey::getCreatedDate() const {
    return m_created_date;
}
void OAIKeySigningKey::setCreatedDate(const QDateTime &created_date) {
    m_created_date = created_date;
    m_created_date_isSet = true;
}

bool OAIKeySigningKey::is_created_date_Set() const{
    return m_created_date_isSet;
}

bool OAIKeySigningKey::is_created_date_Valid() const{
    return m_created_date_isValid;
}

QDateTime OAIKeySigningKey::getLastModifiedDate() const {
    return m_last_modified_date;
}
void OAIKeySigningKey::setLastModifiedDate(const QDateTime &last_modified_date) {
    m_last_modified_date = last_modified_date;
    m_last_modified_date_isSet = true;
}

bool OAIKeySigningKey::is_last_modified_date_Set() const{
    return m_last_modified_date_isSet;
}

bool OAIKeySigningKey::is_last_modified_date_Valid() const{
    return m_last_modified_date_isValid;
}

bool OAIKeySigningKey::isSet() const {
...
bool OAIKeySigningKey::isValid() const {
