...
public class ResourceRecordSetsInner {
  ...
  public ResourceRecordSetsInner() {
  }

  public ResourceRecordSetsInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ResourceRecordSetsInner type(RRType type) {
    this.type = type;
    return this;
  }
  ...
  public ResourceRecordSetsInner setIdentifier(String setIdentifier) {
  ...
  public ResourceRecordSetsInner weight(Integer weight) {
    this.weight = weight;
    return this;
  }
  ...
  public ResourceRecordSetsInner region(ResourceRecordSetRegion region) {
    this.region = region;
    return this;
  }
  ...
  public ResourceRecordSetsInner geoLocation(ResourceRecordSetGeoLocation geoLocation) {
  ...
  public ResourceRecordSetsInner failover(ResourceRecordSetFailover failover) {
  ...
  public ResourceRecordSetsInner multiValueAnswer(Boolean multiValueAnswer) {
  ...
  public ResourceRecordSetsInner TTL(Integer TTL) {
    this.TTL = TTL;
    return this;
  }
  ...
  public ResourceRecordSetsInner resourceRecords(List resourceRecords) {
  ...
  public ResourceRecordSetsInner aliasTarget(ResourceRecordSetAliasTarget aliasTarget) {
  ...
  public ResourceRecordSetsInner healthCheckId(String healthCheckId) {
  ...
  public ResourceRecordSetsInner trafficPolicyInstanceId(String trafficPolicyInstanceId) {
  ...
  public ResourceRecordSetsInner cidrRoutingConfig(CidrRoutingConfig cidrRoutingConfig) {
  ...
  public boolean equals(Object o) {
    ...
    ResourceRecordSetsInner resourceRecordSetsInner = (ResourceRecordSetsInner) o;
    return Objects.equals(this.name, resourceRecordSetsInner.name) &&
        Objects.equals(this.type, resourceRecordSetsInner.type) &&
        Objects.equals(this.setIdentifier, resourceRecordSetsInner.setIdentifier) &&
        Objects.equals(this.weight, resourceRecordSetsInner.weight) &&
        Objects.equals(this.region, resourceRecordSetsInner.region) &&
        Objects.equals(this.geoLocation, resourceRecordSetsInner.geoLocation) &&
        Objects.equals(this.failover, resourceRecordSetsInner.failover) &&
        Objects.equals(this.multiValueAnswer, resourceRecordSetsInner.multiValueAnswer) &&
        Objects.equals(this.TTL, resourceRecordSetsInner.TTL) &&
        Objects.equals(this.resourceRecords, resourceRecordSetsInner.resourceRecords) &&
        Objects.equals(this.aliasTarget, resourceRecordSetsInner.aliasTarget) &&
        Objects.equals(this.healthCheckId, resourceRecordSetsInner.healthCheckId) &&
        Objects.equals(this.trafficPolicyInstanceId, resourceRecordSetsInner.trafficPolicyInstanceId) &&
        Objects.equals(this.cidrRoutingConfig, resourceRecordSetsInner.cidrRoutingConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResourceRecordSetsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResourceRecordSetsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceRecordSetsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceRecordSetsInner is not found in the empty JSON string", ResourceRecordSetsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResourceRecordSetsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceRecordSetsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResourceRecordSetsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceRecordSetsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceRecordSetsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceRecordSetsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceRecordSetsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceRecordSetsInner>() {
           @Override
           public void write(JsonWriter out, ResourceRecordSetsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceRecordSetsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResourceRecordSetsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResourceRecordSetsInner
   * @throws IOException if the JSON string is invalid with respect to ResourceRecordSetsInner
   */
  public static ResourceRecordSetsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceRecordSetsInner.class);
  }

  /**
   * Convert an instance of ResourceRecordSetsInner to an JSON string
   *
   * @return JSON string
   */
