...
public class CreateKeySigningKeyResponseKeySigningKey {
  ...
  public CreateKeySigningKeyResponseKeySigningKey() {
  }

  public CreateKeySigningKeyResponseKeySigningKey name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateKeySigningKeyResponseKeySigningKey kmsArn(String kmsArn) {
    this.kmsArn = kmsArn;
    return this;
  }
  ...
  public CreateKeySigningKeyResponseKeySigningKey flag(Integer flag) {
    this.flag = flag;
    return this;
  }
  ...
  public CreateKeySigningKeyResponseKeySigningKey signingAlgorithmMnemonic(String signingAlgorithmMnemonic) {
  ...
  public CreateKeySigningKeyResponseKeySigningKey signingAlgorithmType(Integer signingAlgorithmType) {
  ...
  public CreateKeySigningKeyResponseKeySigningKey digestAlgorithmMnemonic(String digestAlgorithmMnemonic) {
  ...
  public CreateKeySigningKeyResponseKeySigningKey digestAlgorithmType(Integer digestAlgorithmType) {
  ...
  public CreateKeySigningKeyResponseKeySigningKey keyTag(Integer keyTag) {
    this.keyTag = keyTag;
    return this;
  }
  ...
  public CreateKeySigningKeyResponseKeySigningKey digestValue(String digestValue) {
  ...
  public CreateKeySigningKeyResponseKeySigningKey publicKey(String publicKey) {
  ...
  public CreateKeySigningKeyResponseKeySigningKey dsRecord(String dsRecord) {
  ...
  public CreateKeySigningKeyResponseKeySigningKey dnSKEYRecord(String dnSKEYRecord) {
  ...
  public CreateKeySigningKeyResponseKeySigningKey status(String status) {
    this.status = status;
    return this;
  }
  ...
  public CreateKeySigningKeyResponseKeySigningKey statusMessage(String statusMessage) {
  ...
  public CreateKeySigningKeyResponseKeySigningKey createdDate(OffsetDateTime createdDate) {
  ...
  public CreateKeySigningKeyResponseKeySigningKey lastModifiedDate(OffsetDateTime lastModifiedDate) {
  ...
  public boolean equals(Object o) {
    ...
    CreateKeySigningKeyResponseKeySigningKey createKeySigningKeyResponseKeySigningKey = (CreateKeySigningKeyResponseKeySigningKey) o;
    return Objects.equals(this.name, createKeySigningKeyResponseKeySigningKey.name) &&
        Objects.equals(this.kmsArn, createKeySigningKeyResponseKeySigningKey.kmsArn) &&
        Objects.equals(this.flag, createKeySigningKeyResponseKeySigningKey.flag) &&
        Objects.equals(this.signingAlgorithmMnemonic, createKeySigningKeyResponseKeySigningKey.signingAlgorithmMnemonic) &&
        Objects.equals(this.signingAlgorithmType, createKeySigningKeyResponseKeySigningKey.signingAlgorithmType) &&
        Objects.equals(this.digestAlgorithmMnemonic, createKeySigningKeyResponseKeySigningKey.digestAlgorithmMnemonic) &&
        Objects.equals(this.digestAlgorithmType, createKeySigningKeyResponseKeySigningKey.digestAlgorithmType) &&
        Objects.equals(this.keyTag, createKeySigningKeyResponseKeySigningKey.keyTag) &&
        Objects.equals(this.digestValue, createKeySigningKeyResponseKeySigningKey.digestValue) &&
        Objects.equals(this.publicKey, createKeySigningKeyResponseKeySigningKey.publicKey) &&
        Objects.equals(this.dsRecord, createKeySigningKeyResponseKeySigningKey.dsRecord) &&
        Objects.equals(this.dnSKEYRecord, createKeySigningKeyResponseKeySigningKey.dnSKEYRecord) &&
        Objects.equals(this.status, createKeySigningKeyResponseKeySigningKey.status) &&
        Objects.equals(this.statusMessage, createKeySigningKeyResponseKeySigningKey.statusMessage) &&
        Objects.equals(this.createdDate, createKeySigningKeyResponseKeySigningKey.createdDate) &&
        Objects.equals(this.lastModifiedDate, createKeySigningKeyResponseKeySigningKey.lastModifiedDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateKeySigningKeyResponseKeySigningKey {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateKeySigningKeyResponseKeySigningKey
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateKeySigningKeyResponseKeySigningKey.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateKeySigningKeyResponseKeySigningKey is not found in the empty JSON string", CreateKeySigningKeyResponseKeySigningKey.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateKeySigningKeyResponseKeySigningKey.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateKeySigningKeyResponseKeySigningKey` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateKeySigningKeyResponseKeySigningKey.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateKeySigningKeyResponseKeySigningKey' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateKeySigningKeyResponseKeySigningKey> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateKeySigningKeyResponseKeySigningKey.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateKeySigningKeyResponseKeySigningKey>() {
           @Override
           public void write(JsonWriter out, CreateKeySigningKeyResponseKeySigningKey value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateKeySigningKeyResponseKeySigningKey read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateKeySigningKeyResponseKeySigningKey given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateKeySigningKeyResponseKeySigningKey
   * @throws IOException if the JSON string is invalid with respect to CreateKeySigningKeyResponseKeySigningKey
   */
  public static CreateKeySigningKeyResponseKeySigningKey fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateKeySigningKeyResponseKeySigningKey.class);
  }

  /**
   * Convert an instance of CreateKeySigningKeyResponseKeySigningKey to an JSON string
   *
   * @return JSON string
   */
