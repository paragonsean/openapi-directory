...
public class ListTrafficPolicyInstancesByPolicyResponse {
  ...
  public ListTrafficPolicyInstancesByPolicyResponse() {
  }

  public ListTrafficPolicyInstancesByPolicyResponse trafficPolicyInstances(List trafficPolicyInstances) {
  ...
  public ListTrafficPolicyInstancesByPolicyResponse hostedZoneIdMarker(String hostedZoneIdMarker) {
  ...
  public ListTrafficPolicyInstancesByPolicyResponse trafficPolicyInstanceNameMarker(String trafficPolicyInstanceNameMarker) {
  ...
  public ListTrafficPolicyInstancesByPolicyResponse trafficPolicyInstanceTypeMarker(RRType trafficPolicyInstanceTypeMarker) {
  ...
  public ListTrafficPolicyInstancesByPolicyResponse isTruncated(Boolean isTruncated) {
  ...
  public ListTrafficPolicyInstancesByPolicyResponse maxItems(String maxItems) {
  ...
  public boolean equals(Object o) {
    ...
    ListTrafficPolicyInstancesByPolicyResponse listTrafficPolicyInstancesByPolicyResponse = (ListTrafficPolicyInstancesByPolicyResponse) o;
    return Objects.equals(this.trafficPolicyInstances, listTrafficPolicyInstancesByPolicyResponse.trafficPolicyInstances) &&
        Objects.equals(this.hostedZoneIdMarker, listTrafficPolicyInstancesByPolicyResponse.hostedZoneIdMarker) &&
        Objects.equals(this.trafficPolicyInstanceNameMarker, listTrafficPolicyInstancesByPolicyResponse.trafficPolicyInstanceNameMarker) &&
        Objects.equals(this.trafficPolicyInstanceTypeMarker, listTrafficPolicyInstancesByPolicyResponse.trafficPolicyInstanceTypeMarker) &&
        Objects.equals(this.isTruncated, listTrafficPolicyInstancesByPolicyResponse.isTruncated) &&
        Objects.equals(this.maxItems, listTrafficPolicyInstancesByPolicyResponse.maxItems);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListTrafficPolicyInstancesByPolicyResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListTrafficPolicyInstancesByPolicyResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListTrafficPolicyInstancesByPolicyResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListTrafficPolicyInstancesByPolicyResponse is not found in the empty JSON string", ListTrafficPolicyInstancesByPolicyResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListTrafficPolicyInstancesByPolicyResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListTrafficPolicyInstancesByPolicyResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListTrafficPolicyInstancesByPolicyResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListTrafficPolicyInstancesByPolicyResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListTrafficPolicyInstancesByPolicyResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListTrafficPolicyInstancesByPolicyResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListTrafficPolicyInstancesByPolicyResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListTrafficPolicyInstancesByPolicyResponse>() {
           @Override
           public void write(JsonWriter out, ListTrafficPolicyInstancesByPolicyResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListTrafficPolicyInstancesByPolicyResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListTrafficPolicyInstancesByPolicyResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListTrafficPolicyInstancesByPolicyResponse
   * @throws IOException if the JSON string is invalid with respect to ListTrafficPolicyInstancesByPolicyResponse
   */
  public static ListTrafficPolicyInstancesByPolicyResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListTrafficPolicyInstancesByPolicyResponse.class);
  }

  /**
   * Convert an instance of ListTrafficPolicyInstancesByPolicyResponse to an JSON string
   *
   * @return JSON string
   */
