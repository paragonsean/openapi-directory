...
public class LocationSummary {
  ...
  public LocationSummary locationName(String locationName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.locationName, locationSummary.locationName);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LocationSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LocationSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
