...
/**
 * The ResourceRecordSetsInner model module.
 * @module model/ResourceRecordSetsInner
 * @version 2013-04-01
 */
class ResourceRecordSetsInner {
    /**
     * Constructs a new <code>ResourceRecordSetsInner</code>.
     * @alias module:model/ResourceRecordSetsInner
     * @implements module:model/ResourceRecordSet
     * @param name {String} 
     * @param type {module:model/RRType} 
     */
    constructor(name, type) { 
        ResourceRecordSet.initialize(this, name, type);
        ResourceRecordSetsInner.initialize(this, name, type);
    }
    ...
    /**
     * Constructs a <code>ResourceRecordSetsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResourceRecordSetsInner} obj Optional instance to populate.
     * @return {module:model/ResourceRecordSetsInner} The populated <code>ResourceRecordSetsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResourceRecordSetsInner();
            ResourceRecordSet.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ResourceRecordSetsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResourceRecordSetsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ResourceRecordSetsInner.RequiredProperties) {
...
ResourceRecordSetsInner.RequiredProperties = ["Name", "Type"];

/**
 * @member {String} Name
 */
ResourceRecordSetsInner.prototype['Name'] = undefined;

/**
 * @member {module:model/RRType} Type
 */
ResourceRecordSetsInner.prototype['Type'] = undefined;

/**
 * @member {String} SetIdentifier
 */
ResourceRecordSetsInner.prototype['SetIdentifier'] = undefined;

/**
 * @member {Number} Weight
 */
ResourceRecordSetsInner.prototype['Weight'] = undefined;

/**
 * @member {module:model/ResourceRecordSetRegion} Region
 */
ResourceRecordSetsInner.prototype['Region'] = undefined;

/**
 * @member {module:model/ResourceRecordSetGeoLocation} GeoLocation
 */
ResourceRecordSetsInner.prototype['GeoLocation'] = undefined;

/**
 * @member {module:model/ResourceRecordSetFailover} Failover
 */
ResourceRecordSetsInner.prototype['Failover'] = undefined;

/**
 * @member {Boolean} MultiValueAnswer
 */
ResourceRecordSetsInner.prototype['MultiValueAnswer'] = undefined;

/**
 * @member {Number} TTL
 */
ResourceRecordSetsInner.prototype['TTL'] = undefined;

/**
 * @member {Array} ResourceRecords
 */
ResourceRecordSetsInner.prototype['ResourceRecords'] = undefined;

/**
 * @member {module:model/ResourceRecordSetAliasTarget} AliasTarget
 */
ResourceRecordSetsInner.prototype['AliasTarget'] = undefined;

/**
 * @member {String} HealthCheckId
 */
ResourceRecordSetsInner.prototype['HealthCheckId'] = undefined;

/**
 * @member {String} TrafficPolicyInstanceId
 */
ResourceRecordSetsInner.prototype['TrafficPolicyInstanceId'] = undefined;

/**
 * @member {module:model/CidrRoutingConfig} CidrRoutingConfig
 */
ResourceRecordSetsInner.prototype['CidrRoutingConfig'] = undefined;


// Implement ResourceRecordSet interface:
/**
 * @member {String} Name
 */
...
export default ResourceRecordSetsInner;
