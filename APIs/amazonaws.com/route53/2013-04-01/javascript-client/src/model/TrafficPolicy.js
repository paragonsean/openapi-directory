...
/**
 * The TrafficPolicy model module.
 * @module model/TrafficPolicy
 * @version 2013-04-01
 */
class TrafficPolicy {
    /**
     * Constructs a new <code>TrafficPolicy</code>.
     * A complex type that contains settings for a traffic policy.
     * @alias module:model/TrafficPolicy
     * @param id {String} 
    ...
    /**
     * Constructs a <code>TrafficPolicy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TrafficPolicy} obj Optional instance to populate.
     * @return {module:model/TrafficPolicy} The populated <code>TrafficPolicy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TrafficPolicy();
    ...
    /**
     * Validates the JSON data with respect to <code>TrafficPolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TrafficPolicy</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TrafficPolicy.RequiredProperties) {
...
TrafficPolicy.RequiredProperties = ["Id", "Version", "Name", "Type", "Document"];
