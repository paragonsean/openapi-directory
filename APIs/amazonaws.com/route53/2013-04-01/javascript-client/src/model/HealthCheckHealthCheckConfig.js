...
/**
 * The HealthCheckHealthCheckConfig model module.
 * @module model/HealthCheckHealthCheckConfig
 * @version 2013-04-01
 */
class HealthCheckHealthCheckConfig {
    /**
     * Constructs a new <code>HealthCheckHealthCheckConfig</code>.
     * @alias module:model/HealthCheckHealthCheckConfig
     * @implements module:model/HealthCheckConfig
     * @param type {module:model/HealthCheckType} 
     */
    constructor(type) { 
        HealthCheckConfig.initialize(this, type);
        HealthCheckHealthCheckConfig.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>HealthCheckHealthCheckConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HealthCheckHealthCheckConfig} obj Optional instance to populate.
     * @return {module:model/HealthCheckHealthCheckConfig} The populated <code>HealthCheckHealthCheckConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HealthCheckHealthCheckConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>HealthCheckHealthCheckConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HealthCheckHealthCheckConfig</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of HealthCheckHealthCheckConfig.RequiredProperties) {
...
HealthCheckHealthCheckConfig.RequiredProperties = ["Type"];

/**
 * @member {String} IPAddress
 */
HealthCheckHealthCheckConfig.prototype['IPAddress'] = undefined;

/**
 * @member {Number} Port
 */
HealthCheckHealthCheckConfig.prototype['Port'] = undefined;

/**
 * @member {module:model/HealthCheckType} Type
 */
HealthCheckHealthCheckConfig.prototype['Type'] = undefined;

/**
 * @member {String} ResourcePath
 */
HealthCheckHealthCheckConfig.prototype['ResourcePath'] = undefined;

/**
 * @member {String} FullyQualifiedDomainName
 */
HealthCheckHealthCheckConfig.prototype['FullyQualifiedDomainName'] = undefined;

/**
 * @member {String} SearchString
 */
HealthCheckHealthCheckConfig.prototype['SearchString'] = undefined;

/**
 * @member {Number} RequestInterval
 */
HealthCheckHealthCheckConfig.prototype['RequestInterval'] = undefined;

/**
 * @member {Number} FailureThreshold
 */
HealthCheckHealthCheckConfig.prototype['FailureThreshold'] = undefined;

/**
 * @member {Boolean} MeasureLatency
 */
HealthCheckHealthCheckConfig.prototype['MeasureLatency'] = undefined;

/**
 * @member {Boolean} Inverted
 */
HealthCheckHealthCheckConfig.prototype['Inverted'] = undefined;

/**
 * @member {Boolean} Disabled
 */
HealthCheckHealthCheckConfig.prototype['Disabled'] = undefined;

/**
 * @member {Number} HealthThreshold
 */
HealthCheckHealthCheckConfig.prototype['HealthThreshold'] = undefined;

/**
 * @member {Array} ChildHealthChecks
 */
HealthCheckHealthCheckConfig.prototype['ChildHealthChecks'] = undefined;

/**
 * @member {Boolean} EnableSNI
 */
HealthCheckHealthCheckConfig.prototype['EnableSNI'] = undefined;

/**
 * @member {Array} Regions
 */
HealthCheckHealthCheckConfig.prototype['Regions'] = undefined;

/**
 * @member {module:model/CreateHealthCheckRequestHealthCheckConfigAlarmIdentifier} AlarmIdentifier
 */
HealthCheckHealthCheckConfig.prototype['AlarmIdentifier'] = undefined;

/**
 * @member {module:model/InsufficientDataHealthStatus} InsufficientDataHealthStatus
 */
HealthCheckHealthCheckConfig.prototype['InsufficientDataHealthStatus'] = undefined;

/**
 * @member {String} RoutingControlArn
 */
HealthCheckHealthCheckConfig.prototype['RoutingControlArn'] = undefined;
...
export default HealthCheckHealthCheckConfig;
