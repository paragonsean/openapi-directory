...
/**
 * The ChangeResourceRecordSet model module.
 * @module model/ChangeResourceRecordSet
 * @version 2013-04-01
 */
class ChangeResourceRecordSet {
    /**
     * Constructs a new <code>ChangeResourceRecordSet</code>.
     * @alias module:model/ChangeResourceRecordSet
    ...
    constructor(name, type) { 
        ...
        ChangeResourceRecordSet.initialize(this, name, type);
    }
    ...
    /**
     * Constructs a <code>ChangeResourceRecordSet</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChangeResourceRecordSet} obj Optional instance to populate.
     * @return {module:model/ChangeResourceRecordSet} The populated <code>ChangeResourceRecordSet</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChangeResourceRecordSet();
    ...
    /**
     * Validates the JSON data with respect to <code>ChangeResourceRecordSet</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChangeResourceRecordSet</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ChangeResourceRecordSet.RequiredProperties) {
...
ChangeResourceRecordSet.RequiredProperties = ["Name", "Type"];

/**
 * @member {String} Name
 */
ChangeResourceRecordSet.prototype['Name'] = undefined;

/**
 * @member {module:model/RRType} Type
 */
ChangeResourceRecordSet.prototype['Type'] = undefined;

/**
 * @member {String} SetIdentifier
 */
ChangeResourceRecordSet.prototype['SetIdentifier'] = undefined;

/**
 * @member {Number} Weight
 */
ChangeResourceRecordSet.prototype['Weight'] = undefined;

/**
 * @member {module:model/ResourceRecordSetRegion} Region
 */
ChangeResourceRecordSet.prototype['Region'] = undefined;

/**
 * @member {module:model/ResourceRecordSetGeoLocation} GeoLocation
 */
ChangeResourceRecordSet.prototype['GeoLocation'] = undefined;

/**
 * @member {module:model/ResourceRecordSetFailover} Failover
 */
ChangeResourceRecordSet.prototype['Failover'] = undefined;

/**
 * @member {Boolean} MultiValueAnswer
 */
ChangeResourceRecordSet.prototype['MultiValueAnswer'] = undefined;

/**
 * @member {Number} TTL
 */
ChangeResourceRecordSet.prototype['TTL'] = undefined;

/**
 * @member {Array} ResourceRecords
 */
ChangeResourceRecordSet.prototype['ResourceRecords'] = undefined;

/**
 * @member {module:model/ResourceRecordSetAliasTarget} AliasTarget
 */
ChangeResourceRecordSet.prototype['AliasTarget'] = undefined;

/**
 * @member {String} HealthCheckId
 */
ChangeResourceRecordSet.prototype['HealthCheckId'] = undefined;

/**
 * @member {String} TrafficPolicyInstanceId
 */
ChangeResourceRecordSet.prototype['TrafficPolicyInstanceId'] = undefined;

/**
 * @member {module:model/CidrRoutingConfig} CidrRoutingConfig
 */
ChangeResourceRecordSet.prototype['CidrRoutingConfig'] = undefined;
...
export default ChangeResourceRecordSet;
