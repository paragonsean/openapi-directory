...
* @readonly
*/
export default class VPCRegion {
    ...
    /**
    * Returns a <code>VPCRegion</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/VPCRegion} The enum <code>VPCRegion</code> value.
    */
