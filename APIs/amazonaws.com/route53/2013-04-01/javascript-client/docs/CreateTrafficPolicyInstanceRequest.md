# AmazonRoute53.CreateTrafficPolicyInstanceRequest
...
**TTL** | **Number** | (Optional) The TTL that you want Amazon Route 53 to assign to all of the resource record sets that it creates in the specified hosted zone. | 
...
**trafficPolicyVersion** | **Number** | The version of the traffic policy that you want to use to create resource record sets in the specified hosted zone. | 
