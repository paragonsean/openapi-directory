...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53.ResourceTagSetListInner();
  });
  ...
  describe('ResourceTagSetListInner', function() {
    it('should create an instance of ResourceTagSetListInner', function() {
      // uncomment below and update the code to test ResourceTagSetListInner
      //var instance = new AmazonRoute53.ResourceTagSetListInner();
      //expect(instance).to.be.a(AmazonRoute53.ResourceTagSetListInner);
    });
