...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53.LocationSummary();
  });
  ...
  describe('LocationSummary', function() {
    it('should create an instance of LocationSummary', function() {
      // uncomment below and update the code to test LocationSummary
      //var instance = new AmazonRoute53.LocationSummary();
      //expect(instance).to.be.a(AmazonRoute53.LocationSummary);
    });
