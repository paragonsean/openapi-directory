...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53.ChangeInfo();
  });
  ...
  describe('ChangeInfo', function() {
    it('should create an instance of ChangeInfo', function() {
      // uncomment below and update the code to test ChangeInfo
      //var instance = new AmazonRoute53.ChangeInfo();
      //expect(instance).to.be.a(AmazonRoute53.ChangeInfo);
    });
