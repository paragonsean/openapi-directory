...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53.ResourceTagSet();
  });
  ...
  describe('ResourceTagSet', function() {
    it('should create an instance of ResourceTagSet', function() {
      // uncomment below and update the code to test ResourceTagSet
      //var instance = new AmazonRoute53.ResourceTagSet();
      //expect(instance).to.be.a(AmazonRoute53.ResourceTagSet);
    });
