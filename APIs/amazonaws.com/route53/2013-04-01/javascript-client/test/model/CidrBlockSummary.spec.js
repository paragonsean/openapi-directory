...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53.CidrBlockSummary();
  });
  ...
  describe('CidrBlockSummary', function() {
    it('should create an instance of CidrBlockSummary', function() {
      // uncomment below and update the code to test CidrBlockSummary
      //var instance = new AmazonRoute53.CidrBlockSummary();
      //expect(instance).to.be.a(AmazonRoute53.CidrBlockSummary);
    });
