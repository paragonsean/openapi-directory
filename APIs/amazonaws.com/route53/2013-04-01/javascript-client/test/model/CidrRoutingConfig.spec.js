...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53.CidrRoutingConfig();
  });
  ...
  describe('CidrRoutingConfig', function() {
    it('should create an instance of CidrRoutingConfig', function() {
      // uncomment below and update the code to test CidrRoutingConfig
      //var instance = new AmazonRoute53.CidrRoutingConfig();
      //expect(instance).to.be.a(AmazonRoute53.CidrRoutingConfig);
    });
