...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53.HealthCheckCloudWatchAlarmConfiguration();
  });
  ...
  describe('HealthCheckCloudWatchAlarmConfiguration', function() {
    it('should create an instance of HealthCheckCloudWatchAlarmConfiguration', function() {
      // uncomment below and update the code to test HealthCheckCloudWatchAlarmConfiguration
      //var instance = new AmazonRoute53.HealthCheckCloudWatchAlarmConfiguration();
      //expect(instance).to.be.a(AmazonRoute53.HealthCheckCloudWatchAlarmConfiguration);
    });
