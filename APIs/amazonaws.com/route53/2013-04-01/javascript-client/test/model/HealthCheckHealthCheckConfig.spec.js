...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53.HealthCheckHealthCheckConfig();
  });
  ...
  describe('HealthCheckHealthCheckConfig', function() {
    it('should create an instance of HealthCheckHealthCheckConfig', function() {
      // uncomment below and update the code to test HealthCheckHealthCheckConfig
      //var instance = new AmazonRoute53.HealthCheckHealthCheckConfig();
      //expect(instance).to.be.a(AmazonRoute53.HealthCheckHealthCheckConfig);
    });
