...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53.CloudWatchAlarmConfiguration();
  });
  ...
  describe('CloudWatchAlarmConfiguration', function() {
    it('should create an instance of CloudWatchAlarmConfiguration', function() {
      // uncomment below and update the code to test CloudWatchAlarmConfiguration
      //var instance = new AmazonRoute53.CloudWatchAlarmConfiguration();
      //expect(instance).to.be.a(AmazonRoute53.CloudWatchAlarmConfiguration);
    });
