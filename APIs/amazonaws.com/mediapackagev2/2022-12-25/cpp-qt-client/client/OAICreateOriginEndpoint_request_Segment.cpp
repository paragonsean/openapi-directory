...
OAICreateOriginEndpoint_request_Segment::OAICreateOriginEndpoint_request_Segment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateOriginEndpoint_request_Segment::OAICreateOriginEndpoint_request_Segment() {
    this->initializeModel();
}

OAICreateOriginEndpoint_request_Segment::~OAICreateOriginEndpoint_request_Segment() {}

void OAICreateOriginEndpoint_request_Segment::initializeModel() {
...
void OAICreateOriginEndpoint_request_Segment::fromJson(QString jsonString) {
...
void OAICreateOriginEndpoint_request_Segment::fromJsonObject(QJsonObject json) {
...
QString OAICreateOriginEndpoint_request_Segment::asJson() const {
...
QJsonObject OAICreateOriginEndpoint_request_Segment::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAICreateOriginEndpoint_request_Segment::getSegmentDurationSeconds() const {
    return m_segment_duration_seconds;
}
void OAICreateOriginEndpoint_request_Segment::setSegmentDurationSeconds(const qint32 &segment_duration_seconds) {
    m_segment_duration_seconds = segment_duration_seconds;
    m_segment_duration_seconds_isSet = true;
}

bool OAICreateOriginEndpoint_request_Segment::is_segment_duration_seconds_Set() const{
    return m_segment_duration_seconds_isSet;
}

bool OAICreateOriginEndpoint_request_Segment::is_segment_duration_seconds_Valid() const{
    return m_segment_duration_seconds_isValid;
}

QString OAICreateOriginEndpoint_request_Segment::getSegmentName() const {
    return m_segment_name;
}
void OAICreateOriginEndpoint_request_Segment::setSegmentName(const QString &segment_name) {
    m_segment_name = segment_name;
    m_segment_name_isSet = true;
}

bool OAICreateOriginEndpoint_request_Segment::is_segment_name_Set() const{
    return m_segment_name_isSet;
}

bool OAICreateOriginEndpoint_request_Segment::is_segment_name_Valid() const{
    return m_segment_name_isValid;
}

bool OAICreateOriginEndpoint_request_Segment::getTsUseAudioRenditionGroup() const {
    return m_ts_use_audio_rendition_group;
}
void OAICreateOriginEndpoint_request_Segment::setTsUseAudioRenditionGroup(const bool &ts_use_audio_rendition_group) {
    m_ts_use_audio_rendition_group = ts_use_audio_rendition_group;
    m_ts_use_audio_rendition_group_isSet = true;
}

bool OAICreateOriginEndpoint_request_Segment::is_ts_use_audio_rendition_group_Set() const{
    return m_ts_use_audio_rendition_group_isSet;
}

bool OAICreateOriginEndpoint_request_Segment::is_ts_use_audio_rendition_group_Valid() const{
    return m_ts_use_audio_rendition_group_isValid;
}

bool OAICreateOriginEndpoint_request_Segment::getIncludeIframeOnlyStreams() const {
    return m_include_iframe_only_streams;
}
void OAICreateOriginEndpoint_request_Segment::setIncludeIframeOnlyStreams(const bool &include_iframe_only_streams) {
    m_include_iframe_only_streams = include_iframe_only_streams;
    m_include_iframe_only_streams_isSet = true;
}

bool OAICreateOriginEndpoint_request_Segment::is_include_iframe_only_streams_Set() const{
    return m_include_iframe_only_streams_isSet;
}

bool OAICreateOriginEndpoint_request_Segment::is_include_iframe_only_streams_Valid() const{
    return m_include_iframe_only_streams_isValid;
}

bool OAICreateOriginEndpoint_request_Segment::getTsIncludeDvbSubtitles() const {
    return m_ts_include_dvb_subtitles;
}
void OAICreateOriginEndpoint_request_Segment::setTsIncludeDvbSubtitles(const bool &ts_include_dvb_subtitles) {
    m_ts_include_dvb_subtitles = ts_include_dvb_subtitles;
    m_ts_include_dvb_subtitles_isSet = true;
}

bool OAICreateOriginEndpoint_request_Segment::is_ts_include_dvb_subtitles_Set() const{
    return m_ts_include_dvb_subtitles_isSet;
}

bool OAICreateOriginEndpoint_request_Segment::is_ts_include_dvb_subtitles_Valid() const{
    return m_ts_include_dvb_subtitles_isValid;
}

OAICreateOriginEndpoint_request_Segment_Scte OAICreateOriginEndpoint_request_Segment::getScte() const {
    return m_scte;
}
void OAICreateOriginEndpoint_request_Segment::setScte(const OAICreateOriginEndpoint_request_Segment_Scte &scte) {
    m_scte = scte;
    m_scte_isSet = true;
}

bool OAICreateOriginEndpoint_request_Segment::is_scte_Set() const{
    return m_scte_isSet;
}

bool OAICreateOriginEndpoint_request_Segment::is_scte_Valid() const{
    return m_scte_isValid;
}

OAIEncryption OAICreateOriginEndpoint_request_Segment::getEncryption() const {
    return m_encryption;
}
void OAICreateOriginEndpoint_request_Segment::setEncryption(const OAIEncryption &encryption) {
    m_encryption = encryption;
    m_encryption_isSet = true;
}

bool OAICreateOriginEndpoint_request_Segment::is_encryption_Set() const{
    return m_encryption_isSet;
}

bool OAICreateOriginEndpoint_request_Segment::is_encryption_Valid() const{
    return m_encryption_isValid;
}

bool OAICreateOriginEndpoint_request_Segment::isSet() const {
...
bool OAICreateOriginEndpoint_request_Segment::isValid() const {
