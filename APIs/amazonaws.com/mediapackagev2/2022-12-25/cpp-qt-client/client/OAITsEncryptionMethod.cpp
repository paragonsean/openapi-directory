...
OAITsEncryptionMethod::OAITsEncryptionMethod(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITsEncryptionMethod::OAITsEncryptionMethod() {
    this->initializeModel();
}

OAITsEncryptionMethod::~OAITsEncryptionMethod() {}

void OAITsEncryptionMethod::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAITsEncryptionMethod::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAITsEncryptionMethod::fromJson(QString jsonString) {
    
    if ( jsonString.compare("AES_128", Qt::CaseInsensitive) == 0) {
        m_value = eOAITsEncryptionMethod::AES_128;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SAMPLE_AES", Qt::CaseInsensitive) == 0) {
        m_value = eOAITsEncryptionMethod::SAMPLE_AES;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAITsEncryptionMethod::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAITsEncryptionMethod::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAITsEncryptionMethod::AES_128:
            val = "AES_128";
            break;
        case eOAITsEncryptionMethod::SAMPLE_AES:
            val = "SAMPLE_AES";
            break;
        default:
            break;
...
QJsonValue OAITsEncryptionMethod::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAITsEncryptionMethod::eOAITsEncryptionMethod OAITsEncryptionMethod::getValue() const {
    return m_value;
}

void OAITsEncryptionMethod::setValue(const OAITsEncryptionMethod::eOAITsEncryptionMethod& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAITsEncryptionMethod::isSet() const {
    
    return m_value_isSet;
}

bool OAITsEncryptionMethod::isValid() const {
