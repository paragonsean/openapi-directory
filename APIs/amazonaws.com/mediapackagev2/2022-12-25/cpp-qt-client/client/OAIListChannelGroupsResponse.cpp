...
OAIListChannelGroupsResponse::OAIListChannelGroupsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListChannelGroupsResponse::OAIListChannelGroupsResponse() {
    this->initializeModel();
}

OAIListChannelGroupsResponse::~OAIListChannelGroupsResponse() {}

void OAIListChannelGroupsResponse::initializeModel() {
...
void OAIListChannelGroupsResponse::fromJson(QString jsonString) {
...
void OAIListChannelGroupsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListChannelGroupsResponse::asJson() const {
...
QJsonObject OAIListChannelGroupsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_items.isSet()) {
...
QList OAIListChannelGroupsResponse::getItems() const {
    return m_items;
}
void OAIListChannelGroupsResponse::setItems(const QList &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIListChannelGroupsResponse::is_items_Set() const{
    return m_items_isSet;
}

bool OAIListChannelGroupsResponse::is_items_Valid() const{
    return m_items_isValid;
}

QString OAIListChannelGroupsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListChannelGroupsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListChannelGroupsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListChannelGroupsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListChannelGroupsResponse::isSet() const {
...
bool OAIListChannelGroupsResponse::isValid() const {
