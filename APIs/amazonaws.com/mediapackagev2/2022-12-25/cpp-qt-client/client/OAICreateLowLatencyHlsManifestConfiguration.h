...
/*
 * OAICreateLowLatencyHlsManifestConfiguration.h
 *
 * Create a low-latency HTTP live streaming (HLS) manifest configuration.
 */

#ifndef OAICreateLowLatencyHlsManifestConfiguration_H
#define OAICreateLowLatencyHlsManifestConfiguration_H
...
class OAICreateLowLatencyHlsManifestConfiguration : public OAIObject {
public:
    OAICreateLowLatencyHlsManifestConfiguration();
    OAICreateLowLatencyHlsManifestConfiguration(QString json);
    ~OAICreateLowLatencyHlsManifestConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLowLatencyHlsManifestConfiguration)

#endif // OAICreateLowLatencyHlsManifestConfiguration_H
