...
#include "OAIUpdateChannelGroupRequest.h"
...
OAIUpdateChannelGroupRequest::OAIUpdateChannelGroupRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateChannelGroupRequest::OAIUpdateChannelGroupRequest() {
    this->initializeModel();
}

OAIUpdateChannelGroupRequest::~OAIUpdateChannelGroupRequest() {}

void OAIUpdateChannelGroupRequest::initializeModel() {

    m_description_isSet = false;
    m_description_isValid = false;
}

void OAIUpdateChannelGroupRequest::fromJson(QString jsonString) {
...
void OAIUpdateChannelGroupRequest::fromJsonObject(QJsonObject json) {

    m_description_isValid = ::OpenAPI::fromJsonValue(m_description, json[QString("Description")]);
    m_description_isSet = !json[QString("Description")].isNull() && m_description_isValid;
}

QString OAIUpdateChannelGroupRequest::asJson() const {
...
QJsonObject OAIUpdateChannelGroupRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateChannelGroupRequest::getDescription() const {
    return m_description;
}
void OAIUpdateChannelGroupRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateChannelGroupRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateChannelGroupRequest::is_description_Valid() const{
    return m_description_isValid;
}

bool OAIUpdateChannelGroupRequest::isSet() const {
...
bool OAIUpdateChannelGroupRequest::isValid() const {
