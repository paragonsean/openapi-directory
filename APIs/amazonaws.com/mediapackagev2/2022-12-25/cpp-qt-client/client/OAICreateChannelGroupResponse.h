...
/*
 * OAICreateChannelGroupResponse.h
 *
 * 
 */

#ifndef OAICreateChannelGroupResponse_H
#define OAICreateChannelGroupResponse_H
...
class OAICreateChannelGroupResponse : public OAIObject {
public:
    OAICreateChannelGroupResponse();
    OAICreateChannelGroupResponse(QString json);
    ~OAICreateChannelGroupResponse() override;
    ...
    QString getEgressDomain() const;
    void setEgressDomain(const QString &egress_domain);
    bool is_egress_domain_Set() const;
    bool is_egress_domain_Valid() const;
...
private:
    ...
    QString m_egress_domain;
    bool m_egress_domain_isSet;
    bool m_egress_domain_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateChannelGroupResponse)

#endif // OAICreateChannelGroupResponse_H
