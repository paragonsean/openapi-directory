...
/*
 * OAICreateChannelGroupRequest.h
 *
 * 
 */

#ifndef OAICreateChannelGroupRequest_H
#define OAICreateChannelGroupRequest_H
...
class OAICreateChannelGroupRequest : public OAIObject {
public:
    OAICreateChannelGroupRequest();
    OAICreateChannelGroupRequest(QString json);
    ~OAICreateChannelGroupRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateChannelGroupRequest)

#endif // OAICreateChannelGroupRequest_H
