...
/*
 * OAICreateChannelGroup_request.h
 *
 * 
 */

#ifndef OAICreateChannelGroup_request_H
#define OAICreateChannelGroup_request_H
...
class OAICreateChannelGroup_request : public OAIObject {
public:
    OAICreateChannelGroup_request();
    OAICreateChannelGroup_request(QString json);
    ~OAICreateChannelGroup_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateChannelGroup_request)

#endif // OAICreateChannelGroup_request_H
