...
OAIPutOriginEndpointPolicy_request::OAIPutOriginEndpointPolicy_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutOriginEndpointPolicy_request::OAIPutOriginEndpointPolicy_request() {
    this->initializeModel();
}

OAIPutOriginEndpointPolicy_request::~OAIPutOriginEndpointPolicy_request() {}

void OAIPutOriginEndpointPolicy_request::initializeModel() {

    m_policy_isSet = false;
    m_policy_isValid = false;
}

void OAIPutOriginEndpointPolicy_request::fromJson(QString jsonString) {
...
void OAIPutOriginEndpointPolicy_request::fromJsonObject(QJsonObject json) {

    m_policy_isValid = ::OpenAPI::fromJsonValue(m_policy, json[QString("Policy")]);
    m_policy_isSet = !json[QString("Policy")].isNull() && m_policy_isValid;
}

QString OAIPutOriginEndpointPolicy_request::asJson() const {
...
QJsonObject OAIPutOriginEndpointPolicy_request::asJsonObject() const {
    QJsonObject obj;
    if (m_policy_isSet) {
...
QString OAIPutOriginEndpointPolicy_request::getPolicy() const {
    return m_policy;
}
void OAIPutOriginEndpointPolicy_request::setPolicy(const QString &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAIPutOriginEndpointPolicy_request::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAIPutOriginEndpointPolicy_request::is_policy_Valid() const{
    return m_policy_isValid;
}

bool OAIPutOriginEndpointPolicy_request::isSet() const {
...
bool OAIPutOriginEndpointPolicy_request::isValid() const {
