...
/*
 * OAIUpdateChannelGroupResponse.h
 *
 * 
 */

#ifndef OAIUpdateChannelGroupResponse_H
#define OAIUpdateChannelGroupResponse_H
...
class OAIUpdateChannelGroupResponse : public OAIObject {
public:
    OAIUpdateChannelGroupResponse();
    OAIUpdateChannelGroupResponse(QString json);
    ~OAIUpdateChannelGroupResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateChannelGroupResponse)

#endif // OAIUpdateChannelGroupResponse_H
