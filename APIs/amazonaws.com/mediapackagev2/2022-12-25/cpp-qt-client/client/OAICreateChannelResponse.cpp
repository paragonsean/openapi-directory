...
QString OAICreateChannelResponse::getChannelGroupName() const {
    return m_channel_group_name;
}
void OAICreateChannelResponse::setChannelGroupName(const QString &channel_group_name) {
    m_channel_group_name = channel_group_name;
    m_channel_group_name_isSet = true;
}

bool OAICreateChannelResponse::is_channel_group_name_Set() const{
    return m_channel_group_name_isSet;
}

bool OAICreateChannelResponse::is_channel_group_name_Valid() const{
    return m_channel_group_name_isValid;
}

QDateTime OAICreateChannelResponse::getCreatedAt() const {
    return m_created_at;
}
void OAICreateChannelResponse::setCreatedAt(const QDateTime &created_at) {
...
QDateTime OAICreateChannelResponse::getModifiedAt() const {
    return m_modified_at;
}
void OAICreateChannelResponse::setModifiedAt(const QDateTime &modified_at) {
    m_modified_at = modified_at;
    m_modified_at_isSet = true;
}

bool OAICreateChannelResponse::is_modified_at_Set() const{
    return m_modified_at_isSet;
}

bool OAICreateChannelResponse::is_modified_at_Valid() const{
...
QList<OAIIngestEndpoint> OAICreateChannelResponse::getIngestEndpoints() const {
    return m_ingest_endpoints;
}
void OAICreateChannelResponse::setIngestEndpoints(const QList<OAIIngestEndpoint> &ingest_endpoints) {
    m_ingest_endpoints = ingest_endpoints;
    m_ingest_endpoints_isSet = true;
}

bool OAICreateChannelResponse::is_ingest_endpoints_Set() const{
    return m_ingest_endpoints_isSet;
}

bool OAICreateChannelResponse::is_ingest_endpoints_Valid() const{
