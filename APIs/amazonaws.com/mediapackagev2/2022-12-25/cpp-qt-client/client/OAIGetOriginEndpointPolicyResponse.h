...
/*
 * OAIGetOriginEndpointPolicyResponse.h
 *
 * 
 */

#ifndef OAIGetOriginEndpointPolicyResponse_H
#define OAIGetOriginEndpointPolicyResponse_H
...
class OAIGetOriginEndpointPolicyResponse : public OAIObject {
public:
    OAIGetOriginEndpointPolicyResponse();
    OAIGetOriginEndpointPolicyResponse(QString json);
    ~OAIGetOriginEndpointPolicyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetOriginEndpointPolicyResponse)

#endif // OAIGetOriginEndpointPolicyResponse_H
