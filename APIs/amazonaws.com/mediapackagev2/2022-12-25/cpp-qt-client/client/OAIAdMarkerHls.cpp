...
OAIAdMarkerHls::OAIAdMarkerHls(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdMarkerHls::OAIAdMarkerHls() {
    this->initializeModel();
}

OAIAdMarkerHls::~OAIAdMarkerHls() {}

void OAIAdMarkerHls::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIAdMarkerHls::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIAdMarkerHls::fromJson(QString jsonString) {
    
    if ( jsonString.compare("DATERANGE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAdMarkerHls::DATERANGE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIAdMarkerHls::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIAdMarkerHls::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIAdMarkerHls::DATERANGE:
            val = "DATERANGE";
            break;
        default:
            break;
...
QJsonValue OAIAdMarkerHls::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIAdMarkerHls::eOAIAdMarkerHls OAIAdMarkerHls::getValue() const {
    return m_value;
}

void OAIAdMarkerHls::setValue(const OAIAdMarkerHls::eOAIAdMarkerHls& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIAdMarkerHls::isSet() const {
    
    return m_value_isSet;
}

bool OAIAdMarkerHls::isValid() const {
