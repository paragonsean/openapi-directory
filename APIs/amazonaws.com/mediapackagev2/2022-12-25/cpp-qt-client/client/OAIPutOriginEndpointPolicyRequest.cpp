...
#include "OAIPutOriginEndpointPolicyRequest.h"
...
OAIPutOriginEndpointPolicyRequest::OAIPutOriginEndpointPolicyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutOriginEndpointPolicyRequest::OAIPutOriginEndpointPolicyRequest() {
    this->initializeModel();
}

OAIPutOriginEndpointPolicyRequest::~OAIPutOriginEndpointPolicyRequest() {}

void OAIPutOriginEndpointPolicyRequest::initializeModel() {

    m_policy_isSet = false;
    m_policy_isValid = false;
}

void OAIPutOriginEndpointPolicyRequest::fromJson(QString jsonString) {
...
void OAIPutOriginEndpointPolicyRequest::fromJsonObject(QJsonObject json) {

    m_policy_isValid = ::OpenAPI::fromJsonValue(m_policy, json[QString("Policy")]);
    m_policy_isSet = !json[QString("Policy")].isNull() && m_policy_isValid;
}

QString OAIPutOriginEndpointPolicyRequest::asJson() const {
...
QJsonObject OAIPutOriginEndpointPolicyRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_policy_isSet) {
...
QString OAIPutOriginEndpointPolicyRequest::getPolicy() const {
    return m_policy;
}
void OAIPutOriginEndpointPolicyRequest::setPolicy(const QString &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAIPutOriginEndpointPolicyRequest::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAIPutOriginEndpointPolicyRequest::is_policy_Valid() const{
    return m_policy_isValid;
}

bool OAIPutOriginEndpointPolicyRequest::isSet() const {
...
bool OAIPutOriginEndpointPolicyRequest::isValid() const {
