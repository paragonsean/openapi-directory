...
/*
 * OAIPutOriginEndpointPolicy_request.h
 *
 * 
 */

#ifndef OAIPutOriginEndpointPolicy_request_H
#define OAIPutOriginEndpointPolicy_request_H
...
class OAIPutOriginEndpointPolicy_request : public OAIObject {
public:
    OAIPutOriginEndpointPolicy_request();
    OAIPutOriginEndpointPolicy_request(QString json);
    ~OAIPutOriginEndpointPolicy_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutOriginEndpointPolicy_request)

#endif // OAIPutOriginEndpointPolicy_request_H
