...
/*
 * OAIListChannelGroupsResponse.h
 *
 * 
 */

#ifndef OAIListChannelGroupsResponse_H
#define OAIListChannelGroupsResponse_H
...
class OAIListChannelGroupsResponse : public OAIObject {
public:
    OAIListChannelGroupsResponse();
    OAIListChannelGroupsResponse(QString json);
    ~OAIListChannelGroupsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListChannelGroupsResponse)

#endif // OAIListChannelGroupsResponse_H
