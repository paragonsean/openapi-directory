...
/*
 * OAIListHlsManifestConfiguration.h
 *
 * List the HTTP live streaming (HLS) manifest configuration.
 */

#ifndef OAIListHlsManifestConfiguration_H
#define OAIListHlsManifestConfiguration_H
...
class OAIListHlsManifestConfiguration : public OAIObject {
public:
    OAIListHlsManifestConfiguration();
    OAIListHlsManifestConfiguration(QString json);
    ~OAIListHlsManifestConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListHlsManifestConfiguration)

#endif // OAIListHlsManifestConfiguration_H
