...
#ifndef OAIAdMarkerHls_H
#define OAIAdMarkerHls_H
...
class OAIAdMarkerHls : public OAIEnum {
public:
    OAIAdMarkerHls();
    OAIAdMarkerHls(QString json);
    ~OAIAdMarkerHls() override;
    ...
    enum class eOAIAdMarkerHls {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        DATERANGE
    };
    OAIAdMarkerHls::eOAIAdMarkerHls getValue() const;
    void setValue(const OAIAdMarkerHls::eOAIAdMarkerHls& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdMarkerHls)

#endif // OAIAdMarkerHls_H
