...
/*
 * OAIGetHlsManifestConfiguration.h
 *
 * Retrieve the HTTP live streaming (HLS) manifest configuration.
 */

#ifndef OAIGetHlsManifestConfiguration_H
#define OAIGetHlsManifestConfiguration_H
...
class OAIGetHlsManifestConfiguration : public OAIObject {
public:
    OAIGetHlsManifestConfiguration();
    OAIGetHlsManifestConfiguration(QString json);
    ~OAIGetHlsManifestConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetHlsManifestConfiguration)

#endif // OAIGetHlsManifestConfiguration_H
