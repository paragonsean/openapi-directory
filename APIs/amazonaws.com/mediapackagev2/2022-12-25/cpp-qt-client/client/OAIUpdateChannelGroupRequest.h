...
/*
 * OAIUpdateChannelGroupRequest.h
 *
 * 
 */

#ifndef OAIUpdateChannelGroupRequest_H
#define OAIUpdateChannelGroupRequest_H
...
class OAIUpdateChannelGroupRequest : public OAIObject {
public:
    OAIUpdateChannelGroupRequest();
    OAIUpdateChannelGroupRequest(QString json);
    ~OAIUpdateChannelGroupRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateChannelGroupRequest)

#endif // OAIUpdateChannelGroupRequest_H
