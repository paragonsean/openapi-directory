...
/*
 * OAIPutOriginEndpointPolicyRequest.h
 *
 * 
 */

#ifndef OAIPutOriginEndpointPolicyRequest_H
#define OAIPutOriginEndpointPolicyRequest_H
...
class OAIPutOriginEndpointPolicyRequest : public OAIObject {
public:
    OAIPutOriginEndpointPolicyRequest();
    OAIPutOriginEndpointPolicyRequest(QString json);
    ~OAIPutOriginEndpointPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutOriginEndpointPolicyRequest)

#endif // OAIPutOriginEndpointPolicyRequest_H
