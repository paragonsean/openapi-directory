...
#ifndef OAIDrmSystem_H
#define OAIDrmSystem_H
...
class OAIDrmSystem : public OAIEnum {
public:
    OAIDrmSystem();
    OAIDrmSystem(QString json);
    ~OAIDrmSystem() override;
    ...
    OAIDrmSystem::eOAIDrmSystem getValue() const;
    void setValue(const OAIDrmSystem::eOAIDrmSystem& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDrmSystem)

#endif // OAIDrmSystem_H
