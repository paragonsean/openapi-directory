...
/*
 * OAIGetChannelGroupResponse.h
 *
 * 
 */

#ifndef OAIGetChannelGroupResponse_H
#define OAIGetChannelGroupResponse_H
...
class OAIGetChannelGroupResponse : public OAIObject {
public:
    OAIGetChannelGroupResponse();
    OAIGetChannelGroupResponse(QString json);
    ~OAIGetChannelGroupResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetChannelGroupResponse)

#endif // OAIGetChannelGroupResponse_H
