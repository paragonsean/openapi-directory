...
/*
 * OAIUpdateChannelGroup_request.h
 *
 * 
 */

#ifndef OAIUpdateChannelGroup_request_H
#define OAIUpdateChannelGroup_request_H
...
class OAIUpdateChannelGroup_request : public OAIObject {
public:
    OAIUpdateChannelGroup_request();
    OAIUpdateChannelGroup_request(QString json);
    ~OAIUpdateChannelGroup_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateChannelGroup_request)

#endif // OAIUpdateChannelGroup_request_H
