...
qint32 OAISegment::getSegmentDurationSeconds() const {
    return m_segment_duration_seconds;
}
void OAISegment::setSegmentDurationSeconds(const qint32 &segment_duration_seconds) {
    m_segment_duration_seconds = segment_duration_seconds;
    m_segment_duration_seconds_isSet = true;
}

bool OAISegment::is_segment_duration_seconds_Set() const{
    return m_segment_duration_seconds_isSet;
}

bool OAISegment::is_segment_duration_seconds_Valid() const{
    return m_segment_duration_seconds_isValid;
}

QString OAISegment::getSegmentName() const {
    return m_segment_name;
}
void OAISegment::setSegmentName(const QString &segment_name) {
    m_segment_name = segment_name;
    m_segment_name_isSet = true;
}

bool OAISegment::is_segment_name_Set() const{
    return m_segment_name_isSet;
}

bool OAISegment::is_segment_name_Valid() const{
    return m_segment_name_isValid;
}

bool OAISegment::getTsUseAudioRenditionGroup() const {
    return m_ts_use_audio_rendition_group;
}
void OAISegment::setTsUseAudioRenditionGroup(const bool &ts_use_audio_rendition_group) {
    m_ts_use_audio_rendition_group = ts_use_audio_rendition_group;
    m_ts_use_audio_rendition_group_isSet = true;
}

bool OAISegment::is_ts_use_audio_rendition_group_Set() const{
    return m_ts_use_audio_rendition_group_isSet;
}

bool OAISegment::is_ts_use_audio_rendition_group_Valid() const{
    return m_ts_use_audio_rendition_group_isValid;
}

bool OAISegment::getIncludeIframeOnlyStreams() const {
    return m_include_iframe_only_streams;
}
void OAISegment::setIncludeIframeOnlyStreams(const bool &include_iframe_only_streams) {
    m_include_iframe_only_streams = include_iframe_only_streams;
    m_include_iframe_only_streams_isSet = true;
}

bool OAISegment::is_include_iframe_only_streams_Set() const{
    return m_include_iframe_only_streams_isSet;
}

bool OAISegment::is_include_iframe_only_streams_Valid() const{
    return m_include_iframe_only_streams_isValid;
}

bool OAISegment::getTsIncludeDvbSubtitles() const {
    return m_ts_include_dvb_subtitles;
}
void OAISegment::setTsIncludeDvbSubtitles(const bool &ts_include_dvb_subtitles) {
    m_ts_include_dvb_subtitles = ts_include_dvb_subtitles;
    m_ts_include_dvb_subtitles_isSet = true;
}

bool OAISegment::is_ts_include_dvb_subtitles_Set() const{
    return m_ts_include_dvb_subtitles_isSet;
}

bool OAISegment::is_ts_include_dvb_subtitles_Valid() const{
    return m_ts_include_dvb_subtitles_isValid;
}

OAICreateOriginEndpoint_request_Segment_Scte OAISegment::getScte() const {
    return m_scte;
}
void OAISegment::setScte(const OAICreateOriginEndpoint_request_Segment_Scte &scte) {
    m_scte = scte;
    m_scte_isSet = true;
}

bool OAISegment::is_scte_Set() const{
    return m_scte_isSet;
}

bool OAISegment::is_scte_Valid() const{
    return m_scte_isValid;
}

OAIEncryption OAISegment::getEncryption() const {
    return m_encryption;
}
void OAISegment::setEncryption(const OAIEncryption &encryption) {
    m_encryption = encryption;
    m_encryption_isSet = true;
}

bool OAISegment::is_encryption_Set() const{
    return m_encryption_isSet;
}

bool OAISegment::is_encryption_Valid() const{
