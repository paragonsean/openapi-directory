...
/*
 * OAICreateHlsManifestConfiguration.h
 *
 * Create an HTTP live streaming (HLS) manifest configuration.
 */

#ifndef OAICreateHlsManifestConfiguration_H
#define OAICreateHlsManifestConfiguration_H
...
class OAICreateHlsManifestConfiguration : public OAIObject {
public:
    OAICreateHlsManifestConfiguration();
    OAICreateHlsManifestConfiguration(QString json);
    ~OAICreateHlsManifestConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateHlsManifestConfiguration)

#endif // OAICreateHlsManifestConfiguration_H
