...
OAIGetOriginEndpointResponse::OAIGetOriginEndpointResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetOriginEndpointResponse::OAIGetOriginEndpointResponse() {
    this->initializeModel();
}

OAIGetOriginEndpointResponse::~OAIGetOriginEndpointResponse() {}

void OAIGetOriginEndpointResponse::initializeModel() {
...
void OAIGetOriginEndpointResponse::fromJson(QString jsonString) {
...
void OAIGetOriginEndpointResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetOriginEndpointResponse::asJson() const {
...
QJsonObject OAIGetOriginEndpointResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIGetOriginEndpointResponse::getArn() const {
    return m_arn;
}
void OAIGetOriginEndpointResponse::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIGetOriginEndpointResponse::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIGetOriginEndpointResponse::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIGetOriginEndpointResponse::getChannelGroupName() const {
    return m_channel_group_name;
}
void OAIGetOriginEndpointResponse::setChannelGroupName(const QString &channel_group_name) {
    m_channel_group_name = channel_group_name;
    m_channel_group_name_isSet = true;
}

bool OAIGetOriginEndpointResponse::is_channel_group_name_Set() const{
    return m_channel_group_name_isSet;
}

bool OAIGetOriginEndpointResponse::is_channel_group_name_Valid() const{
    return m_channel_group_name_isValid;
}

QString OAIGetOriginEndpointResponse::getChannelName() const {
    return m_channel_name;
}
void OAIGetOriginEndpointResponse::setChannelName(const QString &channel_name) {
    m_channel_name = channel_name;
    m_channel_name_isSet = true;
}

bool OAIGetOriginEndpointResponse::is_channel_name_Set() const{
    return m_channel_name_isSet;
}

bool OAIGetOriginEndpointResponse::is_channel_name_Valid() const{
    return m_channel_name_isValid;
}

QString OAIGetOriginEndpointResponse::getOriginEndpointName() const {
    return m_origin_endpoint_name;
}
void OAIGetOriginEndpointResponse::setOriginEndpointName(const QString &origin_endpoint_name) {
    m_origin_endpoint_name = origin_endpoint_name;
    m_origin_endpoint_name_isSet = true;
}

bool OAIGetOriginEndpointResponse::is_origin_endpoint_name_Set() const{
    return m_origin_endpoint_name_isSet;
}

bool OAIGetOriginEndpointResponse::is_origin_endpoint_name_Valid() const{
    return m_origin_endpoint_name_isValid;
}

OAIContainerType OAIGetOriginEndpointResponse::getContainerType() const {
    return m_container_type;
}
void OAIGetOriginEndpointResponse::setContainerType(const OAIContainerType &container_type) {
    m_container_type = container_type;
    m_container_type_isSet = true;
}

bool OAIGetOriginEndpointResponse::is_container_type_Set() const{
    return m_container_type_isSet;
}

bool OAIGetOriginEndpointResponse::is_container_type_Valid() const{
    return m_container_type_isValid;
}

OAISegment OAIGetOriginEndpointResponse::getSegment() const {
    return m_segment;
}
void OAIGetOriginEndpointResponse::setSegment(const OAISegment &segment) {
    m_segment = segment;
    m_segment_isSet = true;
}

bool OAIGetOriginEndpointResponse::is_segment_Set() const{
    return m_segment_isSet;
}

bool OAIGetOriginEndpointResponse::is_segment_Valid() const{
    return m_segment_isValid;
}

QDateTime OAIGetOriginEndpointResponse::getCreatedAt() const {
    return m_created_at;
}
void OAIGetOriginEndpointResponse::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIGetOriginEndpointResponse::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIGetOriginEndpointResponse::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QDateTime OAIGetOriginEndpointResponse::getModifiedAt() const {
    return m_modified_at;
}
void OAIGetOriginEndpointResponse::setModifiedAt(const QDateTime &modified_at) {
    m_modified_at = modified_at;
    m_modified_at_isSet = true;
}

bool OAIGetOriginEndpointResponse::is_modified_at_Set() const{
    return m_modified_at_isSet;
}

bool OAIGetOriginEndpointResponse::is_modified_at_Valid() const{
    return m_modified_at_isValid;
}

QString OAIGetOriginEndpointResponse::getDescription() const {
    return m_description;
}
void OAIGetOriginEndpointResponse::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIGetOriginEndpointResponse::is_description_Set() const{
    return m_description_isSet;
}

bool OAIGetOriginEndpointResponse::is_description_Valid() const{
    return m_description_isValid;
}

qint32 OAIGetOriginEndpointResponse::getStartoverWindowSeconds() const {
    return m_startover_window_seconds;
}
void OAIGetOriginEndpointResponse::setStartoverWindowSeconds(const qint32 &startover_window_seconds) {
    m_startover_window_seconds = startover_window_seconds;
    m_startover_window_seconds_isSet = true;
}

bool OAIGetOriginEndpointResponse::is_startover_window_seconds_Set() const{
    return m_startover_window_seconds_isSet;
}

bool OAIGetOriginEndpointResponse::is_startover_window_seconds_Valid() const{
    return m_startover_window_seconds_isValid;
}

QList OAIGetOriginEndpointResponse::getHlsManifests() const {
    return m_hls_manifests;
}
void OAIGetOriginEndpointResponse::setHlsManifests(const QList &hls_manifests) {
    m_hls_manifests = hls_manifests;
    m_hls_manifests_isSet = true;
}

bool OAIGetOriginEndpointResponse::is_hls_manifests_Set() const{
    return m_hls_manifests_isSet;
}

bool OAIGetOriginEndpointResponse::is_hls_manifests_Valid() const{
    return m_hls_manifests_isValid;
}

QList OAIGetOriginEndpointResponse::getLowLatencyHlsManifests() const {
    return m_low_latency_hls_manifests;
}
void OAIGetOriginEndpointResponse::setLowLatencyHlsManifests(const QList &low_latency_hls_manifests) {
    m_low_latency_hls_manifests = low_latency_hls_manifests;
    m_low_latency_hls_manifests_isSet = true;
}

bool OAIGetOriginEndpointResponse::is_low_latency_hls_manifests_Set() const{
    return m_low_latency_hls_manifests_isSet;
}

bool OAIGetOriginEndpointResponse::is_low_latency_hls_manifests_Valid() const{
    return m_low_latency_hls_manifests_isValid;
}

QMap OAIGetOriginEndpointResponse::getTags() const {
    return m_tags;
}
void OAIGetOriginEndpointResponse::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIGetOriginEndpointResponse::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIGetOriginEndpointResponse::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIGetOriginEndpointResponse::isSet() const {
...
bool OAIGetOriginEndpointResponse::isValid() const {
