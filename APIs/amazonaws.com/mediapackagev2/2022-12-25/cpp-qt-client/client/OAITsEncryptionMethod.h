...
/*
 * OAITsEncryptionMethod.h
 *
 * 
 */

#ifndef OAITsEncryptionMethod_H
#define OAITsEncryptionMethod_H
...
class OAITsEncryptionMethod : public OAIEnum {
public:
    OAITsEncryptionMethod();
    OAITsEncryptionMethod(QString json);
    ~OAITsEncryptionMethod() override;
    ...
    enum class eOAITsEncryptionMethod {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        AES_128, 
        SAMPLE_AES
    };
    OAITsEncryptionMethod::eOAITsEncryptionMethod getValue() const;
    void setValue(const OAITsEncryptionMethod::eOAITsEncryptionMethod& value);
...
private:
    ...
    eOAITsEncryptionMethod m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAITsEncryptionMethod)

#endif // OAITsEncryptionMethod_H
