...
async def test_create_channel(client):
    ...
    """
    body = {"ChannelName":"","Description":"","Tags":""}
    headers = { 
    ...
    response = await client.request(
        method='POST',
        path='/channelGroup/{channel_group_name}/channel'.format(channel_group_name='channel_group_name_example'),
        headers=headers,
        json=body,
        )
...
async def test_create_channel_group(client):
    """Test case for create_channel_group

    
    """
    body = {"Description":"","ChannelGroupName":"","Tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_origin_endpoint(client):
    ...
    """
    body = {"Description":"","LowLatencyHlsManifests":"","ContainerType":"","OriginEndpointName":"","HlsManifests":"","Segment":{"SegmentName":"","TsUseAudioRenditionGroup":"","IncludeIframeOnlyStreams":"","Scte":{"ScteFilter":""},"TsIncludeDvbSubtitles":"","SegmentDurationSeconds":"","Encryption":{"KeyRotationIntervalSeconds":"","ConstantInitializationVector":"","SpekeKeyProvider":{"DrmSystems":"","ResourceId":"","EncryptionContractConfiguration":{"PresetSpeke20Audio":"","PresetSpeke20Video":""},"RoleArn":"","Url":""},"EncryptionMethod":{"CmafEncryptionMethod":"","TsEncryptionMethod":""}}},"Tags":"","StartoverWindowSeconds":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/channelGroup/{channel_group_name}/channel/{channel_name}/originEndpoint'.format(channel_group_name='channel_group_name_example', channel_name='channel_name_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_channel(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/channelGroup/{channel_group_name}/channel/{channel_name}'.format(channel_group_name='channel_group_name_example', channel_name='channel_name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_channel_group(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/channelGroup/{channel_group_name}'.format(channel_group_name='channel_group_name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_channel_policy(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/channelGroup/{channel_group_name}/channel/{channel_name}/policy'.format(channel_group_name='channel_group_name_example', channel_name='channel_name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_origin_endpoint(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/channelGroup/{channel_group_name}/channel/{channel_name}/originEndpoint/{origin_endpoint_name}'.format(channel_group_name='channel_group_name_example', channel_name='channel_name_example', origin_endpoint_name='origin_endpoint_name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_origin_endpoint_policy(client):
    """Test case for delete_origin_endpoint_policy
    ...
    response = await client.request(
        method='DELETE',
        path='/channelGroup/{channel_group_name}/channel/{channel_name}/originEndpoint/{origin_endpoint_name}/policy'.format(channel_group_name='channel_group_name_example', channel_name='channel_name_example', origin_endpoint_name='origin_endpoint_name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_channel_group(client):
...
async def test_get_origin_endpoint(client):
    """Test case for get_origin_endpoint
...
async def test_get_origin_endpoint_policy(client):
    """Test case for get_origin_endpoint_policy
...
async def test_list_channel_groups(client):
    """Test case for list_channel_groups
...
async def test_put_origin_endpoint_policy(client):
    """Test case for put_origin_endpoint_policy
...
async def test_update_channel_group(client):
...
async def test_update_origin_endpoint(client):
    ...
    """
    body = {"Description":"","LowLatencyHlsManifests":"","ContainerType":"","HlsManifests":"","Segment":{"SegmentName":"","TsUseAudioRenditionGroup":"","IncludeIframeOnlyStreams":"","Scte":{"ScteFilter":""},"TsIncludeDvbSubtitles":"","SegmentDurationSeconds":"","Encryption":{"KeyRotationIntervalSeconds":"","ConstantInitializationVector":"","SpekeKeyProvider":{"DrmSystems":"","ResourceId":"","EncryptionContractConfiguration":{"PresetSpeke20Audio":"","PresetSpeke20Video":""},"RoleArn":"","Url":""},"EncryptionMethod":{"CmafEncryptionMethod":"","TsEncryptionMethod":""}}},"StartoverWindowSeconds":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
