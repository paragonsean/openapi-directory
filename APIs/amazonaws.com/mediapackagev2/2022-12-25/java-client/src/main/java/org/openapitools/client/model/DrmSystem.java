...
/**
 * Gets or Sets DrmSystem
 */
@JsonAdapter(DrmSystem.Adapter.class)
public enum DrmSystem {
  ...
  public static DrmSystem fromValue(String value) {
    for (DrmSystem b : DrmSystem.values()) {
  ...
  public static class Adapter extends TypeAdapter<DrmSystem> {
    @Override
    public void write(final JsonWriter jsonWriter, final DrmSystem enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DrmSystem read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DrmSystem.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    DrmSystem.fromValue(value);
  }
}
