...
public class ApiClient {
    ...
    private String basePath = "http://mediapackagev2.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://mediapackagev2.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "http://mediapackagev2.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://mediapackagev2.{region}.amazonaws.com.cn",
      "The mediapackagev2 endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2022-12-25/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://mediapackagev2.us-east-1.amazonaws.com
