...
public class CreateOriginEndpointResponseSegment {
  ...
  public CreateOriginEndpointResponseSegment() {
  }

  public CreateOriginEndpointResponseSegment segmentDurationSeconds(Integer segmentDurationSeconds) {
  ...
  public CreateOriginEndpointResponseSegment segmentName(String segmentName) {
  ...
  public CreateOriginEndpointResponseSegment tsUseAudioRenditionGroup(Boolean tsUseAudioRenditionGroup) {
  ...
  public CreateOriginEndpointResponseSegment includeIframeOnlyStreams(Boolean includeIframeOnlyStreams) {
  ...
  public CreateOriginEndpointResponseSegment tsIncludeDvbSubtitles(Boolean tsIncludeDvbSubtitles) {
  ...
  public CreateOriginEndpointResponseSegment scte(CreateOriginEndpointRequestSegmentScte scte) {
    this.scte = scte;
    return this;
  }
  ...
  public CreateOriginEndpointResponseSegment encryption(Encryption encryption) {
  ...
  public boolean equals(Object o) {
    ...
    CreateOriginEndpointResponseSegment createOriginEndpointResponseSegment = (CreateOriginEndpointResponseSegment) o;
    return Objects.equals(this.segmentDurationSeconds, createOriginEndpointResponseSegment.segmentDurationSeconds) &&
        Objects.equals(this.segmentName, createOriginEndpointResponseSegment.segmentName) &&
        Objects.equals(this.tsUseAudioRenditionGroup, createOriginEndpointResponseSegment.tsUseAudioRenditionGroup) &&
        Objects.equals(this.includeIframeOnlyStreams, createOriginEndpointResponseSegment.includeIframeOnlyStreams) &&
        Objects.equals(this.tsIncludeDvbSubtitles, createOriginEndpointResponseSegment.tsIncludeDvbSubtitles) &&
        Objects.equals(this.scte, createOriginEndpointResponseSegment.scte) &&
        Objects.equals(this.encryption, createOriginEndpointResponseSegment.encryption);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateOriginEndpointResponseSegment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateOriginEndpointResponseSegment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateOriginEndpointResponseSegment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateOriginEndpointResponseSegment is not found in the empty JSON string", CreateOriginEndpointResponseSegment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateOriginEndpointResponseSegment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateOriginEndpointResponseSegment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateOriginEndpointResponseSegment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateOriginEndpointResponseSegment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateOriginEndpointResponseSegment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateOriginEndpointResponseSegment.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateOriginEndpointResponseSegment>() {
           @Override
           public void write(JsonWriter out, CreateOriginEndpointResponseSegment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateOriginEndpointResponseSegment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateOriginEndpointResponseSegment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateOriginEndpointResponseSegment
   * @throws IOException if the JSON string is invalid with respect to CreateOriginEndpointResponseSegment
   */
  public static CreateOriginEndpointResponseSegment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateOriginEndpointResponseSegment.class);
  }

  /**
   * Convert an instance of CreateOriginEndpointResponseSegment to an JSON string
   *
   * @return JSON string
   */
