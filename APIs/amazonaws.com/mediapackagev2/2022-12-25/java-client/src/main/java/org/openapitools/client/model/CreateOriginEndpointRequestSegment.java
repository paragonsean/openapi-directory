...
public class CreateOriginEndpointRequestSegment {
  ...
  public CreateOriginEndpointRequestSegment() {
  }

  public CreateOriginEndpointRequestSegment segmentDurationSeconds(Integer segmentDurationSeconds) {
  ...
  public CreateOriginEndpointRequestSegment segmentName(String segmentName) {
  ...
  public CreateOriginEndpointRequestSegment tsUseAudioRenditionGroup(Boolean tsUseAudioRenditionGroup) {
  ...
  public CreateOriginEndpointRequestSegment includeIframeOnlyStreams(Boolean includeIframeOnlyStreams) {
  ...
  public CreateOriginEndpointRequestSegment tsIncludeDvbSubtitles(Boolean tsIncludeDvbSubtitles) {
  ...
  public CreateOriginEndpointRequestSegment scte(CreateOriginEndpointRequestSegmentScte scte) {
    this.scte = scte;
    return this;
  }
  ...
  public CreateOriginEndpointRequestSegment encryption(Encryption encryption) {
  ...
  public boolean equals(Object o) {
    ...
    CreateOriginEndpointRequestSegment createOriginEndpointRequestSegment = (CreateOriginEndpointRequestSegment) o;
    return Objects.equals(this.segmentDurationSeconds, createOriginEndpointRequestSegment.segmentDurationSeconds) &&
        Objects.equals(this.segmentName, createOriginEndpointRequestSegment.segmentName) &&
        Objects.equals(this.tsUseAudioRenditionGroup, createOriginEndpointRequestSegment.tsUseAudioRenditionGroup) &&
        Objects.equals(this.includeIframeOnlyStreams, createOriginEndpointRequestSegment.includeIframeOnlyStreams) &&
        Objects.equals(this.tsIncludeDvbSubtitles, createOriginEndpointRequestSegment.tsIncludeDvbSubtitles) &&
        Objects.equals(this.scte, createOriginEndpointRequestSegment.scte) &&
        Objects.equals(this.encryption, createOriginEndpointRequestSegment.encryption);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateOriginEndpointRequestSegment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateOriginEndpointRequestSegment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateOriginEndpointRequestSegment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateOriginEndpointRequestSegment is not found in the empty JSON string", CreateOriginEndpointRequestSegment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateOriginEndpointRequestSegment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateOriginEndpointRequestSegment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateOriginEndpointRequestSegment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateOriginEndpointRequestSegment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateOriginEndpointRequestSegment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateOriginEndpointRequestSegment.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateOriginEndpointRequestSegment>() {
           @Override
           public void write(JsonWriter out, CreateOriginEndpointRequestSegment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateOriginEndpointRequestSegment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateOriginEndpointRequestSegment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateOriginEndpointRequestSegment
   * @throws IOException if the JSON string is invalid with respect to CreateOriginEndpointRequestSegment
   */
  public static CreateOriginEndpointRequestSegment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateOriginEndpointRequestSegment.class);
  }

  /**
   * Convert an instance of CreateOriginEndpointRequestSegment to an JSON string
   *
   * @return JSON string
   */
