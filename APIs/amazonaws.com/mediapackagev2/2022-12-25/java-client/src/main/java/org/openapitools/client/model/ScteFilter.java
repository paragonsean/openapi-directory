...
/**
 * Gets or Sets ScteFilter
 */
@JsonAdapter(ScteFilter.Adapter.class)
public enum ScteFilter {
  ...
  public static ScteFilter fromValue(String value) {
    for (ScteFilter b : ScteFilter.values()) {
  ...
  public static class Adapter extends TypeAdapter<ScteFilter> {
    @Override
    public void write(final JsonWriter jsonWriter, final ScteFilter enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ScteFilter read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ScteFilter.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ScteFilter.fromValue(value);
  }
}
