...
/**
 * Gets or Sets TsEncryptionMethod
 */
@JsonAdapter(TsEncryptionMethod.Adapter.class)
public enum TsEncryptionMethod {
  ...
  TsEncryptionMethod(String value) {
    this.value = value;
  }
  ...
  public static TsEncryptionMethod fromValue(String value) {
    for (TsEncryptionMethod b : TsEncryptionMethod.values()) {
  ...
  public static class Adapter extends TypeAdapter<TsEncryptionMethod> {
    @Override
    public void write(final JsonWriter jsonWriter, final TsEncryptionMethod enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TsEncryptionMethod read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TsEncryptionMethod.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TsEncryptionMethod.fromValue(value);
  }
}
