...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.UpdateChannelGroupRequest();
  });
  ...
  describe('UpdateChannelGroupRequest', function() {
    it('should create an instance of UpdateChannelGroupRequest', function() {
      // uncomment below and update the code to test UpdateChannelGroupRequest
      //var instance = new AwsElementalMediaPackageV2.UpdateChannelGroupRequest();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.UpdateChannelGroupRequest);
    });
