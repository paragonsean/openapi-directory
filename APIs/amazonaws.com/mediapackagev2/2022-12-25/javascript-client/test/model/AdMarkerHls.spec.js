...
(function(root, factory) {
  ...
  describe('AdMarkerHls', function() {
    it('should create an instance of AdMarkerHls', function() {
      // uncomment below and update the code to test AdMarkerHls
      //var instance = new AwsElementalMediaPackageV2.AdMarkerHls();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.AdMarkerHls);
    });
