...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.GetChannelGroupResponse();
  });
  ...
  describe('GetChannelGroupResponse', function() {
    it('should create an instance of GetChannelGroupResponse', function() {
      // uncomment below and update the code to test GetChannelGroupResponse
      //var instance = new AwsElementalMediaPackageV2.GetChannelGroupResponse();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.GetChannelGroupResponse);
    });
