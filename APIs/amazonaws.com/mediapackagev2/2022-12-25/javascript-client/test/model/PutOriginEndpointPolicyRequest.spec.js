...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.PutOriginEndpointPolicyRequest();
  });
  ...
  describe('PutOriginEndpointPolicyRequest', function() {
    it('should create an instance of PutOriginEndpointPolicyRequest', function() {
      // uncomment below and update the code to test PutOriginEndpointPolicyRequest
      //var instance = new AwsElementalMediaPackageV2.PutOriginEndpointPolicyRequest();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.PutOriginEndpointPolicyRequest);
    });
