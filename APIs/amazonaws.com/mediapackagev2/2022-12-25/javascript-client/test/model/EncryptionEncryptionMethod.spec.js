...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.EncryptionEncryptionMethod();
  });
  ...
  describe('EncryptionEncryptionMethod', function() {
    it('should create an instance of EncryptionEncryptionMethod', function() {
      // uncomment below and update the code to test EncryptionEncryptionMethod
      //var instance = new AwsElementalMediaPackageV2.EncryptionEncryptionMethod();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.EncryptionEncryptionMethod);
    });
