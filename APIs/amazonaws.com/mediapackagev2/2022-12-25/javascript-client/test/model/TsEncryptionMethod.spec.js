...
(function(root, factory) {
  ...
  describe('TsEncryptionMethod', function() {
    it('should create an instance of TsEncryptionMethod', function() {
      // uncomment below and update the code to test TsEncryptionMethod
      //var instance = new AwsElementalMediaPackageV2.TsEncryptionMethod();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.TsEncryptionMethod);
    });
