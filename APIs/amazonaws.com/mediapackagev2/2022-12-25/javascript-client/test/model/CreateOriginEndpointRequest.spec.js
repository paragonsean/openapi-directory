...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.CreateOriginEndpointRequest();
  });
  ...
  describe('CreateOriginEndpointRequest', function() {
    it('should create an instance of CreateOriginEndpointRequest', function() {
      // uncomment below and update the code to test CreateOriginEndpointRequest
      //var instance = new AwsElementalMediaPackageV2.CreateOriginEndpointRequest();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.CreateOriginEndpointRequest);
    });
