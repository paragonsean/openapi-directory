...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.UpdateOriginEndpointResponse();
  });
  ...
  describe('UpdateOriginEndpointResponse', function() {
    it('should create an instance of UpdateOriginEndpointResponse', function() {
      ...
      //var instance = new AwsElementalMediaPackageV2.UpdateOriginEndpointResponse();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.UpdateOriginEndpointResponse);
    });
