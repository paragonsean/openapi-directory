...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.PutChannelPolicyRequest();
  });
  ...
  describe('PutChannelPolicyRequest', function() {
    it('should create an instance of PutChannelPolicyRequest', function() {
      // uncomment below and update the code to test PutChannelPolicyRequest
      //var instance = new AwsElementalMediaPackageV2.PutChannelPolicyRequest();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.PutChannelPolicyRequest);
    });
