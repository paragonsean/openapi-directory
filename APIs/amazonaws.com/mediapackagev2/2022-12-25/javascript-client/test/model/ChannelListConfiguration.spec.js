...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.ChannelListConfiguration();
  });
  ...
  describe('ChannelListConfiguration', function() {
    it('should create an instance of ChannelListConfiguration', function() {
      // uncomment below and update the code to test ChannelListConfiguration
      //var instance = new AwsElementalMediaPackageV2.ChannelListConfiguration();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.ChannelListConfiguration);
    });
