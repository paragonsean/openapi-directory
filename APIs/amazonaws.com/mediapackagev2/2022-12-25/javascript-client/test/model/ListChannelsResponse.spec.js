...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.ListChannelsResponse();
  });
  ...
  describe('ListChannelsResponse', function() {
    it('should create an instance of ListChannelsResponse', function() {
      ...
      //var instance = new AwsElementalMediaPackageV2.ListChannelsResponse();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.ListChannelsResponse);
    });
