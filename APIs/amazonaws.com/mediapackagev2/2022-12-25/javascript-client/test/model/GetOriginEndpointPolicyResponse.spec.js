...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.GetOriginEndpointPolicyResponse();
  });
  ...
  describe('GetOriginEndpointPolicyResponse', function() {
    it('should create an instance of GetOriginEndpointPolicyResponse', function() {
      // uncomment below and update the code to test GetOriginEndpointPolicyResponse
      //var instance = new AwsElementalMediaPackageV2.GetOriginEndpointPolicyResponse();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.GetOriginEndpointPolicyResponse);
    });
