...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.SpekeKeyProvider();
  });
  ...
  describe('SpekeKeyProvider', function() {
    it('should create an instance of SpekeKeyProvider', function() {
      // uncomment below and update the code to test SpekeKeyProvider
      //var instance = new AwsElementalMediaPackageV2.SpekeKeyProvider();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.SpekeKeyProvider);
    });
    ...
    it('should have the property drmSystems (base name: "DrmSystems")', function() {
      // uncomment below and update the code to test the property drmSystems
      //var instance = new AwsElementalMediaPackageV2.SpekeKeyProvider();
      //expect(instance).to.be();
    });
