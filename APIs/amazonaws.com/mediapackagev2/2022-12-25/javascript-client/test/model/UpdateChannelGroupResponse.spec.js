...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.UpdateChannelGroupResponse();
  });
  ...
  describe('UpdateChannelGroupResponse', function() {
    it('should create an instance of UpdateChannelGroupResponse', function() {
      // uncomment below and update the code to test UpdateChannelGroupResponse
      //var instance = new AwsElementalMediaPackageV2.UpdateChannelGroupResponse();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.UpdateChannelGroupResponse);
    });
