...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.EncryptionMethod();
  });
  ...
  describe('EncryptionMethod', function() {
    it('should create an instance of EncryptionMethod', function() {
      ...
      //var instance = new AwsElementalMediaPackageV2.EncryptionMethod();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.EncryptionMethod);
    });

    it('should have the property tsEncryptionMethod (base name: "TsEncryptionMethod")', function() {
      // uncomment below and update the code to test the property tsEncryptionMethod
      //var instance = new AwsElementalMediaPackageV2.EncryptionMethod();
      //expect(instance).to.be();
    });

    it('should have the property cmafEncryptionMethod (base name: "CmafEncryptionMethod")', function() {
      // uncomment below and update the code to test the property cmafEncryptionMethod
      //var instance = new AwsElementalMediaPackageV2.EncryptionMethod();
      //expect(instance).to.be();
    });
