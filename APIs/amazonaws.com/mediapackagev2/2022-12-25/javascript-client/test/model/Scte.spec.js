...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.Scte();
  });
  ...
  describe('Scte', function() {
    it('should create an instance of Scte', function() {
      // uncomment below and update the code to test Scte
      //var instance = new AwsElementalMediaPackageV2.Scte();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.Scte);
    });
