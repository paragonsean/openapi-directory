...
(function(root, factory) {
  ...
  describe('ScteFilter', function() {
    it('should create an instance of ScteFilter', function() {
      // uncomment below and update the code to test ScteFilter
      //var instance = new AwsElementalMediaPackageV2.ScteFilter();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.ScteFilter);
    });
