...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.CreateChannelResponse();
  });
  ...
  describe('CreateChannelResponse', function() {
    it('should create an instance of CreateChannelResponse', function() {
      ...
      //var instance = new AwsElementalMediaPackageV2.CreateChannelResponse();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.CreateChannelResponse);
    });
