...
(function(root, factory) {
  ...
  describe('CmafEncryptionMethod', function() {
    it('should create an instance of CmafEncryptionMethod', function() {
      // uncomment below and update the code to test CmafEncryptionMethod
      //var instance = new AwsElementalMediaPackageV2.CmafEncryptionMethod();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.CmafEncryptionMethod);
    });
