...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.GetChannelResponse();
  });
  ...
  describe('GetChannelResponse', function() {
    it('should create an instance of GetChannelResponse', function() {
      // uncomment below and update the code to test GetChannelResponse
      //var instance = new AwsElementalMediaPackageV2.GetChannelResponse();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.GetChannelResponse);
    });
