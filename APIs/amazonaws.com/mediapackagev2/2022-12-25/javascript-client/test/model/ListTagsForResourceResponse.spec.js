...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.ListTagsForResourceResponse();
  });
  ...
  describe('ListTagsForResourceResponse', function() {
    it('should create an instance of ListTagsForResourceResponse', function() {
      ...
      //var instance = new AwsElementalMediaPackageV2.ListTagsForResourceResponse();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.ListTagsForResourceResponse);
    });
