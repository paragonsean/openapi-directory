...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.UpdateChannelRequest();
  });
  ...
  describe('UpdateChannelRequest', function() {
    it('should create an instance of UpdateChannelRequest', function() {
      ...
      //var instance = new AwsElementalMediaPackageV2.UpdateChannelRequest();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.UpdateChannelRequest);
    });
