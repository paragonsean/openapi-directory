...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.ListChannelGroupsResponse();
  });
  ...
  describe('ListChannelGroupsResponse', function() {
    it('should create an instance of ListChannelGroupsResponse', function() {
      // uncomment below and update the code to test ListChannelGroupsResponse
      //var instance = new AwsElementalMediaPackageV2.ListChannelGroupsResponse();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.ListChannelGroupsResponse);
    });
