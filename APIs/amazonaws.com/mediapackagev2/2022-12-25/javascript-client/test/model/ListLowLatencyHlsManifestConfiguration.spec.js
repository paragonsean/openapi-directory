...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.ListLowLatencyHlsManifestConfiguration();
  });
  ...
  describe('ListLowLatencyHlsManifestConfiguration', function() {
    it('should create an instance of ListLowLatencyHlsManifestConfiguration', function() {
      // uncomment below and update the code to test ListLowLatencyHlsManifestConfiguration
      //var instance = new AwsElementalMediaPackageV2.ListLowLatencyHlsManifestConfiguration();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.ListLowLatencyHlsManifestConfiguration);
    });
