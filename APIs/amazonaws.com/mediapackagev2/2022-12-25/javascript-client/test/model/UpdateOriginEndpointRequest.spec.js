...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.UpdateOriginEndpointRequest();
  });
  ...
  describe('UpdateOriginEndpointRequest', function() {
    it('should create an instance of UpdateOriginEndpointRequest', function() {
      ...
      //var instance = new AwsElementalMediaPackageV2.UpdateOriginEndpointRequest();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.UpdateOriginEndpointRequest);
    });
