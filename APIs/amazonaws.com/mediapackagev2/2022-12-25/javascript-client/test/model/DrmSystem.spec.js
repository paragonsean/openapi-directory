...
(function(root, factory) {
  ...
  describe('DrmSystem', function() {
    it('should create an instance of DrmSystem', function() {
      // uncomment below and update the code to test DrmSystem
      //var instance = new AwsElementalMediaPackageV2.DrmSystem();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.DrmSystem);
    });
