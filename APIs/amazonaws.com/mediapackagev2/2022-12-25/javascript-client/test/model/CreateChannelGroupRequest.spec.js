...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.CreateChannelGroupRequest();
  });
  ...
  describe('CreateChannelGroupRequest', function() {
    it('should create an instance of CreateChannelGroupRequest', function() {
      // uncomment below and update the code to test CreateChannelGroupRequest
      //var instance = new AwsElementalMediaPackageV2.CreateChannelGroupRequest();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.CreateChannelGroupRequest);
    });
