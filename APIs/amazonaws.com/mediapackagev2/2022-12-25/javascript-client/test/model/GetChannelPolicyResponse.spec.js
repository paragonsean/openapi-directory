...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.GetChannelPolicyResponse();
  });
  ...
  describe('GetChannelPolicyResponse', function() {
    it('should create an instance of GetChannelPolicyResponse', function() {
      // uncomment below and update the code to test GetChannelPolicyResponse
      //var instance = new AwsElementalMediaPackageV2.GetChannelPolicyResponse();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.GetChannelPolicyResponse);
    });
