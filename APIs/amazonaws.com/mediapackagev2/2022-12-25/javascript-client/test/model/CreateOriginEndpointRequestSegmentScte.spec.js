...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.CreateOriginEndpointRequestSegmentScte();
  });
  ...
  describe('CreateOriginEndpointRequestSegmentScte', function() {
    it('should create an instance of CreateOriginEndpointRequestSegmentScte', function() {
      // uncomment below and update the code to test CreateOriginEndpointRequestSegmentScte
      //var instance = new AwsElementalMediaPackageV2.CreateOriginEndpointRequestSegmentScte();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.CreateOriginEndpointRequestSegmentScte);
    });

    it('should have the property scteFilter (base name: "ScteFilter")', function() {
      // uncomment below and update the code to test the property scteFilter
      //var instance = new AwsElementalMediaPackageV2.CreateOriginEndpointRequestSegmentScte();
