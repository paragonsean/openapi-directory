...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.IngestEndpoint();
  });
  ...
  describe('IngestEndpoint', function() {
    it('should create an instance of IngestEndpoint', function() {
      // uncomment below and update the code to test IngestEndpoint
      //var instance = new AwsElementalMediaPackageV2.IngestEndpoint();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.IngestEndpoint);
    });
