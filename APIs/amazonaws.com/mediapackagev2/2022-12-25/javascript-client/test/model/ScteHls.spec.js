...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.ScteHls();
  });
  ...
  describe('ScteHls', function() {
    it('should create an instance of ScteHls', function() {
      // uncomment below and update the code to test ScteHls
      //var instance = new AwsElementalMediaPackageV2.ScteHls();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.ScteHls);
    });

    it('should have the property adMarkerHls (base name: "AdMarkerHls")', function() {
      // uncomment below and update the code to test the property adMarkerHls
      //var instance = new AwsElementalMediaPackageV2.ScteHls();
