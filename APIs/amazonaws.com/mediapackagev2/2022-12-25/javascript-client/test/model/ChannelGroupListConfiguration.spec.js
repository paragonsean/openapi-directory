...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.ChannelGroupListConfiguration();
  });
  ...
  describe('ChannelGroupListConfiguration', function() {
    it('should create an instance of ChannelGroupListConfiguration', function() {
      // uncomment below and update the code to test ChannelGroupListConfiguration
      //var instance = new AwsElementalMediaPackageV2.ChannelGroupListConfiguration();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.ChannelGroupListConfiguration);
    });
