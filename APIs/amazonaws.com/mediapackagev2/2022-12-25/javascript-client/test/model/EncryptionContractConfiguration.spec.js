...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.EncryptionContractConfiguration();
  });
  ...
  describe('EncryptionContractConfiguration', function() {
    it('should create an instance of EncryptionContractConfiguration', function() {
      // uncomment below and update the code to test EncryptionContractConfiguration
      //var instance = new AwsElementalMediaPackageV2.EncryptionContractConfiguration();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.EncryptionContractConfiguration);
    });
