...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.CreateChannelRequest();
  });
  ...
  describe('CreateChannelRequest', function() {
    it('should create an instance of CreateChannelRequest', function() {
      ...
      //var instance = new AwsElementalMediaPackageV2.CreateChannelRequest();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.CreateChannelRequest);
    });
