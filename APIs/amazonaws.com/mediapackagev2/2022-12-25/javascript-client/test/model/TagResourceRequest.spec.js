...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AwsElementalMediaPackageV2.TagResourceRequest();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.TagResourceRequest);
    });
