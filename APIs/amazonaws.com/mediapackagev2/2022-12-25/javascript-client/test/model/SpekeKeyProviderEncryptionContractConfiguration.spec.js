...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.SpekeKeyProviderEncryptionContractConfiguration();
  });
  ...
  describe('SpekeKeyProviderEncryptionContractConfiguration', function() {
    it('should create an instance of SpekeKeyProviderEncryptionContractConfiguration', function() {
      ...
      //var instance = new AwsElementalMediaPackageV2.SpekeKeyProviderEncryptionContractConfiguration();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.SpekeKeyProviderEncryptionContractConfiguration);
    });
