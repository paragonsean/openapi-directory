...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.GetHlsManifestConfiguration();
  });
  ...
  describe('GetHlsManifestConfiguration', function() {
    it('should create an instance of GetHlsManifestConfiguration', function() {
      // uncomment below and update the code to test GetHlsManifestConfiguration
      //var instance = new AwsElementalMediaPackageV2.GetHlsManifestConfiguration();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.GetHlsManifestConfiguration);
    });
    ...
    it('should have the property childManifestName (base name: "ChildManifestName")', function() {
      // uncomment below and update the code to test the property childManifestName
      //var instance = new AwsElementalMediaPackageV2.GetHlsManifestConfiguration();
      //expect(instance).to.be();
    });
    ...
    it('should have the property scteHls (base name: "ScteHls")', function() {
      // uncomment below and update the code to test the property scteHls
      //var instance = new AwsElementalMediaPackageV2.GetHlsManifestConfiguration();
      //expect(instance).to.be();
    });
