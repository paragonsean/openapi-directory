...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.CreateChannelGroupResponse();
  });
  ...
  describe('CreateChannelGroupResponse', function() {
    it('should create an instance of CreateChannelGroupResponse', function() {
      // uncomment below and update the code to test CreateChannelGroupResponse
      //var instance = new AwsElementalMediaPackageV2.CreateChannelGroupResponse();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.CreateChannelGroupResponse);
    });
    ...
    it('should have the property egressDomain (base name: "EgressDomain")', function() {
      // uncomment below and update the code to test the property egressDomain
      //var instance = new AwsElementalMediaPackageV2.CreateChannelGroupResponse();
      //expect(instance).to.be();
    });
