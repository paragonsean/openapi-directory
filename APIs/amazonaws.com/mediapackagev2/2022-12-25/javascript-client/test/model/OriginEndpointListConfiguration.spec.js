...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.OriginEndpointListConfiguration();
  });
  ...
  describe('OriginEndpointListConfiguration', function() {
    it('should create an instance of OriginEndpointListConfiguration', function() {
      // uncomment below and update the code to test OriginEndpointListConfiguration
      //var instance = new AwsElementalMediaPackageV2.OriginEndpointListConfiguration();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.OriginEndpointListConfiguration);
    });
