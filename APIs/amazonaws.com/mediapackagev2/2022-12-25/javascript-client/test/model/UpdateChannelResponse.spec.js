...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.UpdateChannelResponse();
  });
  ...
  describe('UpdateChannelResponse', function() {
    it('should create an instance of UpdateChannelResponse', function() {
      ...
      //var instance = new AwsElementalMediaPackageV2.UpdateChannelResponse();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.UpdateChannelResponse);
    });
    ...
    it('should have the property ingestEndpoints (base name: "IngestEndpoints")', function() {
      // uncomment below and update the code to test the property ingestEndpoints
      //var instance = new AwsElementalMediaPackageV2.UpdateChannelResponse();
      //expect(instance).to.be();
    });
