...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.CreateOriginEndpointResponse();
  });
  ...
  describe('CreateOriginEndpointResponse', function() {
    it('should create an instance of CreateOriginEndpointResponse', function() {
      // uncomment below and update the code to test CreateOriginEndpointResponse
      //var instance = new AwsElementalMediaPackageV2.CreateOriginEndpointResponse();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.CreateOriginEndpointResponse);
    });
