...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.CreateHlsManifestConfiguration();
  });
  ...
  describe('CreateHlsManifestConfiguration', function() {
    it('should create an instance of CreateHlsManifestConfiguration', function() {
      // uncomment below and update the code to test CreateHlsManifestConfiguration
      //var instance = new AwsElementalMediaPackageV2.CreateHlsManifestConfiguration();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.CreateHlsManifestConfiguration);
    });
