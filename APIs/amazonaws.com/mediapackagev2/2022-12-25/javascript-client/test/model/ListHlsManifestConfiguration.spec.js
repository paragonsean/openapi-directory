...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.ListHlsManifestConfiguration();
  });
  ...
  describe('ListHlsManifestConfiguration', function() {
    it('should create an instance of ListHlsManifestConfiguration', function() {
      // uncomment below and update the code to test ListHlsManifestConfiguration
      //var instance = new AwsElementalMediaPackageV2.ListHlsManifestConfiguration();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.ListHlsManifestConfiguration);
    });
