...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageV2.EncryptionSpekeKeyProvider();
  });
  ...
  describe('EncryptionSpekeKeyProvider', function() {
    it('should create an instance of EncryptionSpekeKeyProvider', function() {
      // uncomment below and update the code to test EncryptionSpekeKeyProvider
      //var instance = new AwsElementalMediaPackageV2.EncryptionSpekeKeyProvider();
      //expect(instance).to.be.a(AwsElementalMediaPackageV2.EncryptionSpekeKeyProvider);
    });
