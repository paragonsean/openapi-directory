...
class SpekeKeyProvider {
     ...
     * @param encryptionContractConfiguration {module:model/SpekeKeyProviderEncryptionContractConfiguration} 
     * @param resourceId {String} 
     * @param drmSystems {Array} 
     * @param roleArn {String} 
     * @param url {String} 
     */
    constructor(encryptionContractConfiguration, resourceId, drmSystems, roleArn, url) { 
        
        SpekeKeyProvider.initialize(this, encryptionContractConfiguration, resourceId, drmSystems, roleArn, url);
    }
     ...
     */
    static initialize(obj, encryptionContractConfiguration, resourceId, drmSystems, roleArn, url) { 
        obj['EncryptionContractConfiguration'] = encryptionContractConfiguration;
        obj['ResourceId'] = resourceId;
        obj['DrmSystems'] = drmSystems;
        obj['RoleArn'] = roleArn;
        obj['Url'] = url;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('DrmSystems')) {
                obj['DrmSystems'] = ApiClient.convertToType(data['DrmSystems'], Array);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['DrmSystems']) { // data not null
          Array.validateJSON(data['DrmSystems']);
        }
...
SpekeKeyProvider.RequiredProperties = ["EncryptionContractConfiguration", "ResourceId", "DrmSystems", "RoleArn", "Url"];
...
/**
 * @member {Array} DrmSystems
 */
SpekeKeyProvider.prototype['DrmSystems'] = undefined;
