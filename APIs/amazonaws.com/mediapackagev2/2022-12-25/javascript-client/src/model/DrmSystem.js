...
* @readonly
*/
export default class DrmSystem {
    
        /**
         * value: "CLEAR_KEY_AES_128"
         * @const
         */
    ...
    /**
    * Returns a <code>DrmSystem</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DrmSystem} The enum <code>DrmSystem</code> value.
    */
