...
import AdMarkerHls from './AdMarkerHls';

/**
 * The ScteHls model module.
 * @module model/ScteHls
 * @version 2022-12-25
 */
class ScteHls {
    /**
     * Constructs a new <code>ScteHls</code>.
     * The SCTE configuration.
     * @alias module:model/ScteHls
     */
    constructor() { 
        
        ScteHls.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ScteHls</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScteHls} obj Optional instance to populate.
     * @return {module:model/ScteHls} The populated <code>ScteHls</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScteHls();

            if (data.hasOwnProperty('AdMarkerHls')) {
                obj['AdMarkerHls'] = ApiClient.convertToType(data['AdMarkerHls'], AdMarkerHls);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ScteHls</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScteHls</code>.
     */
    static validateJSON(data) {
        // validate the optional field `AdMarkerHls`
        if (data['AdMarkerHls']) { // data not null
          AdMarkerHls.validateJSON(data['AdMarkerHls']);
        }
...
/**
 * @member {module:model/AdMarkerHls} AdMarkerHls
 */
ScteHls.prototype['AdMarkerHls'] = undefined;
