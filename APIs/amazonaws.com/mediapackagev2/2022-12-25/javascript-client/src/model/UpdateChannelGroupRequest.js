...
/**
 * The UpdateChannelGroupRequest model module.
 * @module model/UpdateChannelGroupRequest
 * @version 2022-12-25
 */
class UpdateChannelGroupRequest {
    /**
     * Constructs a new <code>UpdateChannelGroupRequest</code>.
     * @alias module:model/UpdateChannelGroupRequest
     */
    constructor() { 
        
        UpdateChannelGroupRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateChannelGroupRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateChannelGroupRequest} obj Optional instance to populate.
     * @return {module:model/UpdateChannelGroupRequest} The populated <code>UpdateChannelGroupRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateChannelGroupRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateChannelGroupRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateChannelGroupRequest</code>.
     */
 ...
 */
UpdateChannelGroupRequest.prototype['Description'] = undefined;
...
export default UpdateChannelGroupRequest;
