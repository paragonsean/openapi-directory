...
/**
 * The ListLowLatencyHlsManifestConfiguration model module.
 * @module model/ListLowLatencyHlsManifestConfiguration
 * @version 2022-12-25
 */
class ListLowLatencyHlsManifestConfiguration {
    /**
     * Constructs a new <code>ListLowLatencyHlsManifestConfiguration</code>.
     * List the low-latency HTTP live streaming (HLS) manifest configuration.
     * @alias module:model/ListLowLatencyHlsManifestConfiguration
     * @param manifestName {String} 
     */
    constructor(manifestName) { 
        
        ListLowLatencyHlsManifestConfiguration.initialize(this, manifestName);
    }
    ...
    /**
     * Constructs a <code>ListLowLatencyHlsManifestConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListLowLatencyHlsManifestConfiguration} obj Optional instance to populate.
     * @return {module:model/ListLowLatencyHlsManifestConfiguration} The populated <code>ListLowLatencyHlsManifestConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListLowLatencyHlsManifestConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>ListLowLatencyHlsManifestConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListLowLatencyHlsManifestConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListLowLatencyHlsManifestConfiguration.RequiredProperties) {
...
ListLowLatencyHlsManifestConfiguration.RequiredProperties = ["ManifestName"];

/**
 * @member {String} ManifestName
 */
ListLowLatencyHlsManifestConfiguration.prototype['ManifestName'] = undefined;

/**
 * @member {String} ChildManifestName
 */
ListLowLatencyHlsManifestConfiguration.prototype['ChildManifestName'] = undefined;

/**
 * @member {String} Url
 */
ListLowLatencyHlsManifestConfiguration.prototype['Url'] = undefined;
...
export default ListLowLatencyHlsManifestConfiguration;
