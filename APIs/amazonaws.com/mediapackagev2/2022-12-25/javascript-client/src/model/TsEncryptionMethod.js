...
* @readonly
*/
export default class TsEncryptionMethod {
    ...
    /**
    * Returns a <code>TsEncryptionMethod</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/TsEncryptionMethod} The enum <code>TsEncryptionMethod</code> value.
    */
