...
/**
 * The Scte model module.
 * @module model/Scte
 * @version 2022-12-25
 */
class Scte {
    /**
     * Constructs a new <code>Scte</code>.
     * The SCTE configuration.
     * @alias module:model/Scte
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>Scte</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Scte} obj Optional instance to populate.
     * @return {module:model/Scte} The populated <code>Scte</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Scte</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Scte</code>.
     */
