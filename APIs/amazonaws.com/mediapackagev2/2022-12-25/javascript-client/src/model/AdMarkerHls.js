...
* @readonly
*/
export default class AdMarkerHls {
    ...
    /**
    * Returns a <code>AdMarkerHls</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AdMarkerHls} The enum <code>AdMarkerHls</code> value.
    */
