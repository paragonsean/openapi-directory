...
/**
 * The PutOriginEndpointPolicyRequest model module.
 * @module model/PutOriginEndpointPolicyRequest
 * @version 2022-12-25
 */
class PutOriginEndpointPolicyRequest {
    /**
     * Constructs a new <code>PutOriginEndpointPolicyRequest</code>.
     * @alias module:model/PutOriginEndpointPolicyRequest
     * @param policy {String} The policy to attach to the specified origin endpoint.
     */
    constructor(policy) { 
        
        PutOriginEndpointPolicyRequest.initialize(this, policy);
    }
    ...
    /**
     * Constructs a <code>PutOriginEndpointPolicyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutOriginEndpointPolicyRequest} obj Optional instance to populate.
     * @return {module:model/PutOriginEndpointPolicyRequest} The populated <code>PutOriginEndpointPolicyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutOriginEndpointPolicyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PutOriginEndpointPolicyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutOriginEndpointPolicyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutOriginEndpointPolicyRequest.RequiredProperties) {
...
PutOriginEndpointPolicyRequest.RequiredProperties = ["Policy"];

/**
 * The policy to attach to the specified origin endpoint.
 * @member {String} Policy
 */
PutOriginEndpointPolicyRequest.prototype['Policy'] = undefined;
...
export default PutOriginEndpointPolicyRequest;
