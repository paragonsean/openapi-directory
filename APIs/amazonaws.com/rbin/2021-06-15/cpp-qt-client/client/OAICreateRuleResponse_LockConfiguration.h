...
/*
 * OAICreateRuleResponse_LockConfiguration.h
 *
 * 
 */

#ifndef OAICreateRuleResponse_LockConfiguration_H
#define OAICreateRuleResponse_LockConfiguration_H
...
class OAICreateRuleResponse_LockConfiguration : public OAIObject {
public:
    OAICreateRuleResponse_LockConfiguration();
    OAICreateRuleResponse_LockConfiguration(QString json);
    ~OAICreateRuleResponse_LockConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRuleResponse_LockConfiguration)

#endif // OAICreateRuleResponse_LockConfiguration_H
