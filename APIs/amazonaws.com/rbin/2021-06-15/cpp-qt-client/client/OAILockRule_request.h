...
/*
 * OAILockRule_request.h
 *
 * 
 */

#ifndef OAILockRule_request_H
#define OAILockRule_request_H
...
class OAILockRule_request : public OAIObject {
public:
    OAILockRule_request();
    OAILockRule_request(QString json);
    ~OAILockRule_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILockRule_request)

#endif // OAILockRule_request_H
