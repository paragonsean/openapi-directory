...
/*
 * OAIRetentionPeriodUnit.h
 *
 * 
 */

#ifndef OAIRetentionPeriodUnit_H
#define OAIRetentionPeriodUnit_H
...
class OAIRetentionPeriodUnit : public OAIEnum {
public:
    OAIRetentionPeriodUnit();
    OAIRetentionPeriodUnit(QString json);
    ~OAIRetentionPeriodUnit() override;
    ...
    enum class eOAIRetentionPeriodUnit {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        DAYS
    };
    OAIRetentionPeriodUnit::eOAIRetentionPeriodUnit getValue() const;
    void setValue(const OAIRetentionPeriodUnit::eOAIRetentionPeriodUnit& value);
...
private:
    ...
    eOAIRetentionPeriodUnit m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRetentionPeriodUnit)

#endif // OAIRetentionPeriodUnit_H
