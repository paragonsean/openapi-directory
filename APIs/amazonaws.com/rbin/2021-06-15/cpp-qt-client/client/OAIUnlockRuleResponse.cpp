...
OAIUnlockRuleResponse::OAIUnlockRuleResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUnlockRuleResponse::OAIUnlockRuleResponse() {
    this->initializeModel();
}

OAIUnlockRuleResponse::~OAIUnlockRuleResponse() {}

void OAIUnlockRuleResponse::initializeModel() {
...
void OAIUnlockRuleResponse::fromJson(QString jsonString) {
...
void OAIUnlockRuleResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUnlockRuleResponse::asJson() const {
...
QJsonObject OAIUnlockRuleResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUnlockRuleResponse::getIdentifier() const {
    return m_identifier;
}
void OAIUnlockRuleResponse::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIUnlockRuleResponse::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIUnlockRuleResponse::is_identifier_Valid() const{
    return m_identifier_isValid;
}

QString OAIUnlockRuleResponse::getDescription() const {
    return m_description;
}
void OAIUnlockRuleResponse::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUnlockRuleResponse::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUnlockRuleResponse::is_description_Valid() const{
    return m_description_isValid;
}

OAIResourceType OAIUnlockRuleResponse::getResourceType() const {
    return m_resource_type;
}
void OAIUnlockRuleResponse::setResourceType(const OAIResourceType &resource_type) {
    m_resource_type = resource_type;
    m_resource_type_isSet = true;
}

bool OAIUnlockRuleResponse::is_resource_type_Set() const{
    return m_resource_type_isSet;
}

bool OAIUnlockRuleResponse::is_resource_type_Valid() const{
    return m_resource_type_isValid;
}

OAIRetentionPeriod OAIUnlockRuleResponse::getRetentionPeriod() const {
    return m_retention_period;
}
void OAIUnlockRuleResponse::setRetentionPeriod(const OAIRetentionPeriod &retention_period) {
    m_retention_period = retention_period;
    m_retention_period_isSet = true;
}

bool OAIUnlockRuleResponse::is_retention_period_Set() const{
    return m_retention_period_isSet;
}

bool OAIUnlockRuleResponse::is_retention_period_Valid() const{
    return m_retention_period_isValid;
}

QList OAIUnlockRuleResponse::getResourceTags() const {
    return m_resource_tags;
}
void OAIUnlockRuleResponse::setResourceTags(const QList &resource_tags) {
    m_resource_tags = resource_tags;
    m_resource_tags_isSet = true;
}

bool OAIUnlockRuleResponse::is_resource_tags_Set() const{
    return m_resource_tags_isSet;
}

bool OAIUnlockRuleResponse::is_resource_tags_Valid() const{
    return m_resource_tags_isValid;
}

OAIRuleStatus OAIUnlockRuleResponse::getStatus() const {
    return m_status;
}
void OAIUnlockRuleResponse::setStatus(const OAIRuleStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIUnlockRuleResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAIUnlockRuleResponse::is_status_Valid() const{
    return m_status_isValid;
}

OAICreateRuleResponse_LockConfiguration OAIUnlockRuleResponse::getLockConfiguration() const {
    return m_lock_configuration;
}
void OAIUnlockRuleResponse::setLockConfiguration(const OAICreateRuleResponse_LockConfiguration &lock_configuration) {
    m_lock_configuration = lock_configuration;
    m_lock_configuration_isSet = true;
}

bool OAIUnlockRuleResponse::is_lock_configuration_Set() const{
    return m_lock_configuration_isSet;
}

bool OAIUnlockRuleResponse::is_lock_configuration_Valid() const{
    return m_lock_configuration_isValid;
}

OAILockState OAIUnlockRuleResponse::getLockState() const {
    return m_lock_state;
}
void OAIUnlockRuleResponse::setLockState(const OAILockState &lock_state) {
    m_lock_state = lock_state;
    m_lock_state_isSet = true;
}

bool OAIUnlockRuleResponse::is_lock_state_Set() const{
    return m_lock_state_isSet;
}

bool OAIUnlockRuleResponse::is_lock_state_Valid() const{
    return m_lock_state_isValid;
}

QDateTime OAIUnlockRuleResponse::getLockEndTime() const {
    return m_lock_end_time;
}
void OAIUnlockRuleResponse::setLockEndTime(const QDateTime &lock_end_time) {
    m_lock_end_time = lock_end_time;
    m_lock_end_time_isSet = true;
}

bool OAIUnlockRuleResponse::is_lock_end_time_Set() const{
    return m_lock_end_time_isSet;
}

bool OAIUnlockRuleResponse::is_lock_end_time_Valid() const{
    return m_lock_end_time_isValid;
}

bool OAIUnlockRuleResponse::isSet() const {
...
bool OAIUnlockRuleResponse::isValid() const {
