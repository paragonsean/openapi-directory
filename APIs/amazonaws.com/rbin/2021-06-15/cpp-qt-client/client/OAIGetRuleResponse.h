...
namespace OpenAPI {
class OAIGetRuleResponse_RetentionPeriod;
...
public:
    ...
    OAIGetRuleResponse_RetentionPeriod getRetentionPeriod() const;
    void setRetentionPeriod(const OAIGetRuleResponse_RetentionPeriod &retention_period);
...
private:
    ...
    OAIGetRuleResponse_RetentionPeriod m_retention_period;
