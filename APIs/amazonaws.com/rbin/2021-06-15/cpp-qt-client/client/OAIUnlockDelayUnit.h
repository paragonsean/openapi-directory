...
/*
 * OAIUnlockDelayUnit.h
 *
 * 
 */

#ifndef OAIUnlockDelayUnit_H
#define OAIUnlockDelayUnit_H
...
class OAIUnlockDelayUnit : public OAIEnum {
public:
    OAIUnlockDelayUnit();
    OAIUnlockDelayUnit(QString json);
    ~OAIUnlockDelayUnit() override;
    ...
    enum class eOAIUnlockDelayUnit {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        DAYS
    };
    OAIUnlockDelayUnit::eOAIUnlockDelayUnit getValue() const;
    void setValue(const OAIUnlockDelayUnit::eOAIUnlockDelayUnit& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnlockDelayUnit)

#endif // OAIUnlockDelayUnit_H
