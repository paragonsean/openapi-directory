...
/*
 * OAILockRuleRequest.h
 *
 * 
 */

#ifndef OAILockRuleRequest_H
#define OAILockRuleRequest_H
...
class OAILockRuleRequest : public OAIObject {
public:
    OAILockRuleRequest();
    OAILockRuleRequest(QString json);
    ~OAILockRuleRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILockRuleRequest)

#endif // OAILockRuleRequest_H
