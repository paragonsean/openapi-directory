...
#ifndef OAIRuleStatus_H
#define OAIRuleStatus_H
...
class OAIRuleStatus : public OAIEnum {
public:
    OAIRuleStatus();
    OAIRuleStatus(QString json);
    ~OAIRuleStatus() override;
    ...
    enum class eOAIRuleStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        PENDING, 
        AVAILABLE
    };
    OAIRuleStatus::eOAIRuleStatus getValue() const;
    void setValue(const OAIRuleStatus::eOAIRuleStatus& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIRuleStatus)

#endif // OAIRuleStatus_H
