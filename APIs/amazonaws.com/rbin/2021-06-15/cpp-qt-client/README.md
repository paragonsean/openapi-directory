...
OAICreateRule_request Example::create(){
    OAICreateRule_request obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::createRuleSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::createRuleSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAICreateRule_request oai_create_rule_request = create(); // OAICreateRule_request | 
      ...
      apiInstance.createRule(oai_create_rule_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
