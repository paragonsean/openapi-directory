...
class GetRuleResponseRetentionPeriod(Model):
    ...
    def __init__(self, retention_period_value: int=None, retention_period_unit: RetentionPeriodUnit=None):
        """GetRuleResponseRetentionPeriod - a model defined in OpenAPI

        :param retention_period_value: The retention_period_value of this GetRuleResponseRetentionPeriod.
        :param retention_period_unit: The retention_period_unit of this GetRuleResponseRetentionPeriod.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetRuleResponseRetentionPeriod':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GetRuleResponse_RetentionPeriod of this GetRuleResponseRetentionPeriod.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def retention_period_value(self):
        """Gets the retention_period_value of this GetRuleResponseRetentionPeriod.


        :return: The retention_period_value of this GetRuleResponseRetentionPeriod.
        :rtype: int
        """
    ...
    def retention_period_value(self, retention_period_value):
        """Sets the retention_period_value of this GetRuleResponseRetentionPeriod.
    ...
    def retention_period_unit(self):
        """Gets the retention_period_unit of this GetRuleResponseRetentionPeriod.


        :return: The retention_period_unit of this GetRuleResponseRetentionPeriod.
    ...
    def retention_period_unit(self, retention_period_unit):
        """Sets the retention_period_unit of this GetRuleResponseRetentionPeriod.
