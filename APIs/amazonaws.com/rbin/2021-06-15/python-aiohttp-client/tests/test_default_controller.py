...
async def test_create_rule(client):
    ...
    """
    body = {"Description":"","ResourceTags":"","LockConfiguration":{"UnlockDelay":{"UnlockDelayValue":"","UnlockDelayUnit":""}},"ResourceType":"","RetentionPeriod":{"RetentionPeriodUnit":"","RetentionPeriodValue":""},"Tags":""}
    headers = { 
...
async def test_delete_rule(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/rules/{identifier}'.format(identifier='identifier_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_rules(client):
    ...
    """
    body = {"NextToken":"","ResourceTags":"","MaxResults":"","ResourceType":"","LockState":""}
...
async def test_lock_rule(client):
    """Test case for lock_rule

    
    """
    body = {"LockConfiguration":{"UnlockDelay":{"UnlockDelayValue":"","UnlockDelayUnit":""}}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='PATCH',
        path='/rules/{identifier}/lock'.format(identifier='identifier_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_unlock_rule(client):
    """Test case for unlock_rule
    ...
    response = await client.request(
        method='PATCH',
        path='/rules/{identifier}/unlock'.format(identifier='identifier_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_rule(client):
    ...
    """
    body = {"Description":"","ResourceTags":"","ResourceType":"","RetentionPeriod":{"RetentionPeriodUnit":"","RetentionPeriodValue":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
