...
* @readonly
*/
export default class RuleStatus {
    ...
    /**
    * Returns a <code>RuleStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/RuleStatus} The enum <code>RuleStatus</code> value.
    */
