...
* @readonly
*/
export default class UnlockDelayUnit {
    ...
    /**
    * Returns a <code>UnlockDelayUnit</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/UnlockDelayUnit} The enum <code>UnlockDelayUnit</code> value.
    */
