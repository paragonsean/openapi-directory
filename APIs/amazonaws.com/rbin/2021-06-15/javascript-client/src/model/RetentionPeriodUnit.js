...
* @readonly
*/
export default class RetentionPeriodUnit {
    ...
    /**
    * Returns a <code>RetentionPeriodUnit</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/RetentionPeriodUnit} The enum <code>RetentionPeriodUnit</code> value.
    */
