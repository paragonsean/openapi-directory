# AmazonRecycleBin.CreateRuleRequest
...
**tags** | [**[Tag]**](Tag.md) | Information about the tags to assign to the retention rule. | [optional] 
**resourceType** | **String** | The resource type to be retained by the retention rule. Currently, only Amazon EBS snapshots and EBS-backed AMIs are supported. To retain snapshots, specify &lt;code&gt;EBS_SNAPSHOT&lt;/code&gt;. To retain EBS-backed AMIs, specify &lt;code&gt;EC2_IMAGE&lt;/code&gt;. | 
