...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRecycleBin.CreateRuleRequestLockConfigurationUnlockDelay();
  });
  ...
  describe('CreateRuleRequestLockConfigurationUnlockDelay', function() {
    it('should create an instance of CreateRuleRequestLockConfigurationUnlockDelay', function() {
      // uncomment below and update the code to test CreateRuleRequestLockConfigurationUnlockDelay
      //var instance = new AmazonRecycleBin.CreateRuleRequestLockConfigurationUnlockDelay();
      //expect(instance).to.be.a(AmazonRecycleBin.CreateRuleRequestLockConfigurationUnlockDelay);
    });

    it('should have the property unlockDelayValue (base name: "UnlockDelayValue")', function() {
      // uncomment below and update the code to test the property unlockDelayValue
      //var instance = new AmazonRecycleBin.CreateRuleRequestLockConfigurationUnlockDelay();
      //expect(instance).to.be();
    });

    it('should have the property unlockDelayUnit (base name: "UnlockDelayUnit")', function() {
      // uncomment below and update the code to test the property unlockDelayUnit
      //var instance = new AmazonRecycleBin.CreateRuleRequestLockConfigurationUnlockDelay();
      //expect(instance).to.be();
    });
