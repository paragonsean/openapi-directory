...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRecycleBin.UnlockDelay();
  });
  ...
  describe('UnlockDelay', function() {
    it('should create an instance of UnlockDelay', function() {
      // uncomment below and update the code to test UnlockDelay
      //var instance = new AmazonRecycleBin.UnlockDelay();
      //expect(instance).to.be.a(AmazonRecycleBin.UnlockDelay);
    });
