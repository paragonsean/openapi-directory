...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRecycleBin.RetentionPeriod();
  });
  ...
  describe('RetentionPeriod', function() {
    it('should create an instance of RetentionPeriod', function() {
      ...
      //var instance = new AmazonRecycleBin.RetentionPeriod();
      //expect(instance).to.be.a(AmazonRecycleBin.RetentionPeriod);
    });

    it('should have the property retentionPeriodValue (base name: "RetentionPeriodValue")', function() {
      // uncomment below and update the code to test the property retentionPeriodValue
      //var instance = new AmazonRecycleBin.RetentionPeriod();
      //expect(instance).to.be();
    });

    it('should have the property retentionPeriodUnit (base name: "RetentionPeriodUnit")', function() {
      // uncomment below and update the code to test the property retentionPeriodUnit
      //var instance = new AmazonRecycleBin.RetentionPeriod();
      //expect(instance).to.be();
    });
