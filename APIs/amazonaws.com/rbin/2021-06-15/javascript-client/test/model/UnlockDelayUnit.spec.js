...
(function(root, factory) {
  ...
  describe('UnlockDelayUnit', function() {
    it('should create an instance of UnlockDelayUnit', function() {
      // uncomment below and update the code to test UnlockDelayUnit
      //var instance = new AmazonRecycleBin.UnlockDelayUnit();
      //expect(instance).to.be.a(AmazonRecycleBin.UnlockDelayUnit);
    });
