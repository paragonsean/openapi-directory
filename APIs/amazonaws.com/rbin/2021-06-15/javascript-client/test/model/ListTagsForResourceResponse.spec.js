...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRecycleBin.ListTagsForResourceResponse();
  });
  ...
  describe('ListTagsForResourceResponse', function() {
    it('should create an instance of ListTagsForResourceResponse', function() {
      ...
      //var instance = new AmazonRecycleBin.ListTagsForResourceResponse();
      //expect(instance).to.be.a(AmazonRecycleBin.ListTagsForResourceResponse);
    });
