...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRecycleBin.LockRuleResponse();
  });
  ...
  describe('LockRuleResponse', function() {
    it('should create an instance of LockRuleResponse', function() {
      // uncomment below and update the code to test LockRuleResponse
      //var instance = new AmazonRecycleBin.LockRuleResponse();
      //expect(instance).to.be.a(AmazonRecycleBin.LockRuleResponse);
    });
