...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRecycleBin.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AmazonRecycleBin.TagResourceRequest();
      //expect(instance).to.be.a(AmazonRecycleBin.TagResourceRequest);
    });
