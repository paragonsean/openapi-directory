...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRecycleBin.GetRuleResponse();
  });
  ...
  describe('GetRuleResponse', function() {
    it('should create an instance of GetRuleResponse', function() {
      // uncomment below and update the code to test GetRuleResponse
      //var instance = new AmazonRecycleBin.GetRuleResponse();
      //expect(instance).to.be.a(AmazonRecycleBin.GetRuleResponse);
    });
