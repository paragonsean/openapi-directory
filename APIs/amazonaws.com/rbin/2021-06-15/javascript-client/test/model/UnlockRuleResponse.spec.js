...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRecycleBin.UnlockRuleResponse();
  });
  ...
  describe('UnlockRuleResponse', function() {
    it('should create an instance of UnlockRuleResponse', function() {
      // uncomment below and update the code to test UnlockRuleResponse
      //var instance = new AmazonRecycleBin.UnlockRuleResponse();
      //expect(instance).to.be.a(AmazonRecycleBin.UnlockRuleResponse);
    });
    ...
    it('should have the property lockConfiguration (base name: "LockConfiguration")', function() {
      // uncomment below and update the code to test the property lockConfiguration
      //var instance = new AmazonRecycleBin.UnlockRuleResponse();
      //expect(instance).to.be();
    });
