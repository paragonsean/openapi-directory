...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRecycleBin.LockRuleRequest();
  });
  ...
  describe('LockRuleRequest', function() {
    it('should create an instance of LockRuleRequest', function() {
      // uncomment below and update the code to test LockRuleRequest
      //var instance = new AmazonRecycleBin.LockRuleRequest();
      //expect(instance).to.be.a(AmazonRecycleBin.LockRuleRequest);
    });
