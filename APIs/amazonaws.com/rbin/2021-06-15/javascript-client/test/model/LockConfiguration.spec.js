...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRecycleBin.LockConfiguration();
  });
  ...
  describe('LockConfiguration', function() {
    it('should create an instance of LockConfiguration', function() {
      // uncomment below and update the code to test LockConfiguration
      //var instance = new AmazonRecycleBin.LockConfiguration();
      //expect(instance).to.be.a(AmazonRecycleBin.LockConfiguration);
    });
