...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRecycleBin.ListRulesRequest();
  });
  ...
  describe('ListRulesRequest', function() {
    it('should create an instance of ListRulesRequest', function() {
      // uncomment below and update the code to test ListRulesRequest
      //var instance = new AmazonRecycleBin.ListRulesRequest();
      //expect(instance).to.be.a(AmazonRecycleBin.ListRulesRequest);
    });
