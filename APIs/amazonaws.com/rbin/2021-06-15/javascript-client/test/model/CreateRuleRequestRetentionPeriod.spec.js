...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRecycleBin.CreateRuleRequestRetentionPeriod();
  });
  ...
  describe('CreateRuleRequestRetentionPeriod', function() {
    it('should create an instance of CreateRuleRequestRetentionPeriod', function() {
      // uncomment below and update the code to test CreateRuleRequestRetentionPeriod
      //var instance = new AmazonRecycleBin.CreateRuleRequestRetentionPeriod();
      //expect(instance).to.be.a(AmazonRecycleBin.CreateRuleRequestRetentionPeriod);
    });
