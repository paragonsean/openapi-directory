...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRecycleBin.CreateRuleResponseLockConfiguration();
  });
  ...
  describe('CreateRuleResponseLockConfiguration', function() {
    it('should create an instance of CreateRuleResponseLockConfiguration', function() {
      // uncomment below and update the code to test CreateRuleResponseLockConfiguration
      //var instance = new AmazonRecycleBin.CreateRuleResponseLockConfiguration();
      //expect(instance).to.be.a(AmazonRecycleBin.CreateRuleResponseLockConfiguration);
    });
