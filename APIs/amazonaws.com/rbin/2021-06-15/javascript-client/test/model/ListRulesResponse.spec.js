...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRecycleBin.ListRulesResponse();
  });
  ...
  describe('ListRulesResponse', function() {
    it('should create an instance of ListRulesResponse', function() {
      ...
      //var instance = new AmazonRecycleBin.ListRulesResponse();
      //expect(instance).to.be.a(AmazonRecycleBin.ListRulesResponse);
    });
