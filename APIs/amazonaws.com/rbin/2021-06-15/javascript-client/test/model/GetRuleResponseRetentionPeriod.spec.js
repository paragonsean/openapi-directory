...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRecycleBin.GetRuleResponseRetentionPeriod();
  });
  ...
  describe('GetRuleResponseRetentionPeriod', function() {
    it('should create an instance of GetRuleResponseRetentionPeriod', function() {
      // uncomment below and update the code to test GetRuleResponseRetentionPeriod
      //var instance = new AmazonRecycleBin.GetRuleResponseRetentionPeriod();
      //expect(instance).to.be.a(AmazonRecycleBin.GetRuleResponseRetentionPeriod);
    });
