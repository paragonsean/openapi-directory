...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRecycleBin.UpdateRuleRequest();
  });
  ...
  describe('UpdateRuleRequest', function() {
    it('should create an instance of UpdateRuleRequest', function() {
      ...
      //var instance = new AmazonRecycleBin.UpdateRuleRequest();
      //expect(instance).to.be.a(AmazonRecycleBin.UpdateRuleRequest);
    });
