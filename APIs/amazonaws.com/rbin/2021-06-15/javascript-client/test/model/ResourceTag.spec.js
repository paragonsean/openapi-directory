...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRecycleBin.ResourceTag();
  });
  ...
  describe('ResourceTag', function() {
    it('should create an instance of ResourceTag', function() {
      ...
      //var instance = new AmazonRecycleBin.ResourceTag();
      //expect(instance).to.be.a(AmazonRecycleBin.ResourceTag);
    });

    it('should have the property resourceTagKey (base name: "ResourceTagKey")', function() {
      // uncomment below and update the code to test the property resourceTagKey
      //var instance = new AmazonRecycleBin.ResourceTag();
      //expect(instance).to.be();
    });

    it('should have the property resourceTagValue (base name: "ResourceTagValue")', function() {
      // uncomment below and update the code to test the property resourceTagValue
      //var instance = new AmazonRecycleBin.ResourceTag();
      //expect(instance).to.be();
    });
