...
(function(root, factory) {
  ...
  describe('RetentionPeriodUnit', function() {
    it('should create an instance of RetentionPeriodUnit', function() {
      // uncomment below and update the code to test RetentionPeriodUnit
      //var instance = new AmazonRecycleBin.RetentionPeriodUnit();
      //expect(instance).to.be.a(AmazonRecycleBin.RetentionPeriodUnit);
    });
