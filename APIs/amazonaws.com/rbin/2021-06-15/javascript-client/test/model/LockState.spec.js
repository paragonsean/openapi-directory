...
(function(root, factory) {
  ...
  describe('LockState', function() {
    it('should create an instance of LockState', function() {
      // uncomment below and update the code to test LockState
      //var instance = new AmazonRecycleBin.LockState();
      //expect(instance).to.be.a(AmazonRecycleBin.LockState);
    });
