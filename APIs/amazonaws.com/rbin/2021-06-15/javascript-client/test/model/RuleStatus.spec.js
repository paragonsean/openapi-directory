...
(function(root, factory) {
  ...
  describe('RuleStatus', function() {
    it('should create an instance of RuleStatus', function() {
      // uncomment below and update the code to test RuleStatus
      //var instance = new AmazonRecycleBin.RuleStatus();
      //expect(instance).to.be.a(AmazonRecycleBin.RuleStatus);
    });
