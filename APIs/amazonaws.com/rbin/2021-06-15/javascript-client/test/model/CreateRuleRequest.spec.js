...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRecycleBin.CreateRuleRequest();
  });
  ...
  describe('CreateRuleRequest', function() {
    it('should create an instance of CreateRuleRequest', function() {
      ...
      //var instance = new AmazonRecycleBin.CreateRuleRequest();
      //expect(instance).to.be.a(AmazonRecycleBin.CreateRuleRequest);
    });
