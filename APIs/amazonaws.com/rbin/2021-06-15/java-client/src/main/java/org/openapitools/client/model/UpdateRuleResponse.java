...
public class UpdateRuleResponse {
  ...
  public UpdateRuleResponse identifier(String identifier) {
  ...
  public UpdateRuleResponse retentionPeriod(RetentionPeriod retentionPeriod) {
  ...
  public UpdateRuleResponse description(String description) {
  ...
  public UpdateRuleResponse resourceType(ResourceType resourceType) {
  ...
  public UpdateRuleResponse resourceTags(List resourceTags) {
  ...
  public UpdateRuleResponse status(RuleStatus status) {
    this.status = status;
    return this;
  }
  ...
  public UpdateRuleResponse lockState(LockState lockState) {
  ...
  public UpdateRuleResponse lockEndTime(OffsetDateTime lockEndTime) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identifier, updateRuleResponse.identifier) &&
        Objects.equals(this.retentionPeriod, updateRuleResponse.retentionPeriod) &&
        Objects.equals(this.description, updateRuleResponse.description) &&
        Objects.equals(this.resourceType, updateRuleResponse.resourceType) &&
        Objects.equals(this.resourceTags, updateRuleResponse.resourceTags) &&
        Objects.equals(this.status, updateRuleResponse.status) &&
        Objects.equals(this.lockState, updateRuleResponse.lockState) &&
        Objects.equals(this.lockEndTime, updateRuleResponse.lockEndTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(identifier, retentionPeriod, description, resourceType, resourceTags, status, lockState, lockEndTime);
  }
