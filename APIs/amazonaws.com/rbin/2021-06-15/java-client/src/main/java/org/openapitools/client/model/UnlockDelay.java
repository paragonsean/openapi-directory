...
public class UnlockDelay {
  ...
  public UnlockDelay unlockDelayValue(Integer unlockDelayValue) {
  ...
  public UnlockDelay unlockDelayUnit(UnlockDelayUnit unlockDelayUnit) {
  ...
  public boolean equals(Object o) {
    ...
    UnlockDelay unlockDelay = (UnlockDelay) o;
    return Objects.equals(this.unlockDelayValue, unlockDelay.unlockDelayValue) &&
        Objects.equals(this.unlockDelayUnit, unlockDelay.unlockDelayUnit);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UnlockDelay
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UnlockDelay.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UnlockDelay is not found in the empty JSON string", UnlockDelay.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UnlockDelay.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UnlockDelay` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UnlockDelay.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UnlockDelay.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UnlockDelay' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UnlockDelay> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UnlockDelay.class));

       return (TypeAdapter<T>) new TypeAdapter<UnlockDelay>() {
           @Override
           public void write(JsonWriter out, UnlockDelay value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UnlockDelay read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UnlockDelay given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UnlockDelay
   * @throws IOException if the JSON string is invalid with respect to UnlockDelay
   */
  public static UnlockDelay fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UnlockDelay.class);
  }

  /**
   * Convert an instance of UnlockDelay to an JSON string
   *
   * @return JSON string
   */
