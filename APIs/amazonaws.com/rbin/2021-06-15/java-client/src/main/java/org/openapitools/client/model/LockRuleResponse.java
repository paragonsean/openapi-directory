...
public class LockRuleResponse {
  ...
  public LockRuleResponse identifier(String identifier) {
  ...
  public LockRuleResponse description(String description) {
  ...
  public LockRuleResponse resourceType(ResourceType resourceType) {
  ...
  public LockRuleResponse retentionPeriod(RetentionPeriod retentionPeriod) {
  ...
  public LockRuleResponse resourceTags(List resourceTags) {
  ...
  public LockRuleResponse status(RuleStatus status) {
    this.status = status;
    return this;
  }
  ...
  public LockRuleResponse lockConfiguration(CreateRuleResponseLockConfiguration lockConfiguration) {
  ...
  public LockRuleResponse lockState(LockState lockState) {
  ...
  public boolean equals(Object o) {
    ...
    LockRuleResponse lockRuleResponse = (LockRuleResponse) o;
    return Objects.equals(this.identifier, lockRuleResponse.identifier) &&
        Objects.equals(this.description, lockRuleResponse.description) &&
        Objects.equals(this.resourceType, lockRuleResponse.resourceType) &&
        Objects.equals(this.retentionPeriod, lockRuleResponse.retentionPeriod) &&
        Objects.equals(this.resourceTags, lockRuleResponse.resourceTags) &&
        Objects.equals(this.status, lockRuleResponse.status) &&
        Objects.equals(this.lockConfiguration, lockRuleResponse.lockConfiguration) &&
        Objects.equals(this.lockState, lockRuleResponse.lockState);
  }

  @Override
  public int hashCode() {
    return Objects.hash(identifier, description, resourceType, retentionPeriod, resourceTags, status, lockConfiguration, lockState);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LockRuleResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LockRuleResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LockRuleResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LockRuleResponse is not found in the empty JSON string", LockRuleResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LockRuleResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LockRuleResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LockRuleResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LockRuleResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LockRuleResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LockRuleResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LockRuleResponse>() {
           @Override
           public void write(JsonWriter out, LockRuleResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LockRuleResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LockRuleResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LockRuleResponse
   * @throws IOException if the JSON string is invalid with respect to LockRuleResponse
   */
  public static LockRuleResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LockRuleResponse.class);
  }

  /**
   * Convert an instance of LockRuleResponse to an JSON string
   *
   * @return JSON string
   */
