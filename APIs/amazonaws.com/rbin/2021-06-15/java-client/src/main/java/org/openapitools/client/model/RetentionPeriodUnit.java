...
/**
 * Gets or Sets RetentionPeriodUnit
 */
@JsonAdapter(RetentionPeriodUnit.Adapter.class)
public enum RetentionPeriodUnit {
  ...
  RetentionPeriodUnit(String value) {
    this.value = value;
  }
  ...
  public static RetentionPeriodUnit fromValue(String value) {
    for (RetentionPeriodUnit b : RetentionPeriodUnit.values()) {
  ...
  public static class Adapter extends TypeAdapter<RetentionPeriodUnit> {
    @Override
    public void write(final JsonWriter jsonWriter, final RetentionPeriodUnit enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RetentionPeriodUnit read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RetentionPeriodUnit.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    RetentionPeriodUnit.fromValue(value);
  }
}
