 ...
 */
@JsonAdapter(LockState.Adapter.class)
public enum LockState {
  ...
  public static LockState fromValue(String value) {
    for (LockState b : LockState.values()) {
  ...
  public static class Adapter extends TypeAdapter<LockState> {
    @Override
    public void write(final JsonWriter jsonWriter, final LockState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public LockState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return LockState.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    LockState.fromValue(value);
  }
}
