...
/**
 * Gets or Sets UnlockDelayUnit
 */
@JsonAdapter(UnlockDelayUnit.Adapter.class)
public enum UnlockDelayUnit {
  ...
  public static UnlockDelayUnit fromValue(String value) {
    for (UnlockDelayUnit b : UnlockDelayUnit.values()) {
  ...
  public static class Adapter extends TypeAdapter<UnlockDelayUnit> {
    @Override
    public void write(final JsonWriter jsonWriter, final UnlockDelayUnit enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public UnlockDelayUnit read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return UnlockDelayUnit.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    UnlockDelayUnit.fromValue(value);
  }
}
