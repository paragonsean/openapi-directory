...
#ifndef OAIEmailRecipients_H
#define OAIEmailRecipients_H
...
class OAIEmailRecipients : public OAIObject {
public:
    OAIEmailRecipients();
    OAIEmailRecipients(QString json);
    ~OAIEmailRecipients() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmailRecipients)

#endif // OAIEmailRecipients_H
