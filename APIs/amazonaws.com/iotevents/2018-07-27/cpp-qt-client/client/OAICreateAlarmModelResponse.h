...
/*
 * OAICreateAlarmModelResponse.h
 *
 * 
 */

#ifndef OAICreateAlarmModelResponse_H
#define OAICreateAlarmModelResponse_H
...
class OAICreateAlarmModelResponse : public OAIObject {
public:
    OAICreateAlarmModelResponse();
    OAICreateAlarmModelResponse(QString json);
    ~OAICreateAlarmModelResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAlarmModelResponse)

#endif // OAICreateAlarmModelResponse_H
