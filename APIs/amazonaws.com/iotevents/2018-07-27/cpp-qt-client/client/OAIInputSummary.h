...
#ifndef OAIInputSummary_H
#define OAIInputSummary_H
...
class OAIInputSummary : public OAIObject {
public:
    OAIInputSummary();
    OAIInputSummary(QString json);
    ~OAIInputSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInputSummary)

#endif // OAIInputSummary_H
