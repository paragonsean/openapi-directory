...
OAIInputSummary::OAIInputSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInputSummary::OAIInputSummary() {
    this->initializeModel();
}

OAIInputSummary::~OAIInputSummary() {}

void OAIInputSummary::initializeModel() {
...
void OAIInputSummary::fromJson(QString jsonString) {
...
void OAIInputSummary::fromJsonObject(QJsonObject json) {
...
QString OAIInputSummary::asJson() const {
...
QJsonObject OAIInputSummary::asJsonObject() const {
    QJsonObject obj;
...
QString OAIInputSummary::getInputName() const {
    return m_input_name;
}
void OAIInputSummary::setInputName(const QString &input_name) {
    m_input_name = input_name;
    m_input_name_isSet = true;
}

bool OAIInputSummary::is_input_name_Set() const{
    return m_input_name_isSet;
}

bool OAIInputSummary::is_input_name_Valid() const{
    return m_input_name_isValid;
}

QString OAIInputSummary::getInputDescription() const {
    return m_input_description;
}
void OAIInputSummary::setInputDescription(const QString &input_description) {
    m_input_description = input_description;
    m_input_description_isSet = true;
}

bool OAIInputSummary::is_input_description_Set() const{
    return m_input_description_isSet;
}

bool OAIInputSummary::is_input_description_Valid() const{
    return m_input_description_isValid;
}

QString OAIInputSummary::getInputArn() const {
    return m_input_arn;
}
void OAIInputSummary::setInputArn(const QString &input_arn) {
    m_input_arn = input_arn;
    m_input_arn_isSet = true;
}

bool OAIInputSummary::is_input_arn_Set() const{
    return m_input_arn_isSet;
}

bool OAIInputSummary::is_input_arn_Valid() const{
    return m_input_arn_isValid;
}

QDateTime OAIInputSummary::getCreationTime() const {
    return m_creation_time;
}
void OAIInputSummary::setCreationTime(const QDateTime &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAIInputSummary::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAIInputSummary::is_creation_time_Valid() const{
    return m_creation_time_isValid;
}

QDateTime OAIInputSummary::getLastUpdateTime() const {
    return m_last_update_time;
}
void OAIInputSummary::setLastUpdateTime(const QDateTime &last_update_time) {
    m_last_update_time = last_update_time;
    m_last_update_time_isSet = true;
}

bool OAIInputSummary::is_last_update_time_Set() const{
    return m_last_update_time_isSet;
}

bool OAIInputSummary::is_last_update_time_Valid() const{
    return m_last_update_time_isValid;
}

OAIInputStatus OAIInputSummary::getStatus() const {
    return m_status;
}
void OAIInputSummary::setStatus(const OAIInputStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIInputSummary::is_status_Set() const{
    return m_status_isSet;
}

bool OAIInputSummary::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIInputSummary::isSet() const {
...
bool OAIInputSummary::isValid() const {
