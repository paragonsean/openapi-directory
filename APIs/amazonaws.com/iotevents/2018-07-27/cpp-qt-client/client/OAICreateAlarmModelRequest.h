...
/*
 * OAICreateAlarmModelRequest.h
 *
 * 
 */

#ifndef OAICreateAlarmModelRequest_H
#define OAICreateAlarmModelRequest_H
...
class OAICreateAlarmModelRequest : public OAIObject {
public:
    OAICreateAlarmModelRequest();
    OAICreateAlarmModelRequest(QString json);
    ~OAICreateAlarmModelRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAlarmModelRequest)

#endif // OAICreateAlarmModelRequest_H
