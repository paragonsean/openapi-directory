...
/*
 * OAIInput_inputConfiguration.h
 *
 * 
 */

#ifndef OAIInput_inputConfiguration_H
#define OAIInput_inputConfiguration_H
...
class OAIInput_inputConfiguration : public OAIObject {
public:
    OAIInput_inputConfiguration();
    OAIInput_inputConfiguration(QString json);
    ~OAIInput_inputConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInput_inputConfiguration)

#endif // OAIInput_inputConfiguration_H
