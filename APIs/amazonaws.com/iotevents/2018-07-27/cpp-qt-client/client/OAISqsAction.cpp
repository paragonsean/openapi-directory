...
OAISqsAction::OAISqsAction(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISqsAction::OAISqsAction() {
    this->initializeModel();
}

OAISqsAction::~OAISqsAction() {}

void OAISqsAction::initializeModel() {
...
void OAISqsAction::fromJson(QString jsonString) {
...
void OAISqsAction::fromJsonObject(QJsonObject json) {
...
QString OAISqsAction::asJson() const {
...
QJsonObject OAISqsAction::asJsonObject() const {
    QJsonObject obj;
...
QString OAISqsAction::getQueueUrl() const {
    return m_queue_url;
}
void OAISqsAction::setQueueUrl(const QString &queue_url) {
    m_queue_url = queue_url;
    m_queue_url_isSet = true;
}

bool OAISqsAction::is_queue_url_Set() const{
    return m_queue_url_isSet;
}

bool OAISqsAction::is_queue_url_Valid() const{
    return m_queue_url_isValid;
}

bool OAISqsAction::getUseBase64() const {
    return m_use_base64;
}
void OAISqsAction::setUseBase64(const bool &use_base64) {
    m_use_base64 = use_base64;
    m_use_base64_isSet = true;
}

bool OAISqsAction::is_use_base64_Set() const{
    return m_use_base64_isSet;
}

bool OAISqsAction::is_use_base64_Valid() const{
    return m_use_base64_isValid;
}

OAISqsAction_payload OAISqsAction::getPayload() const {
    return m_payload;
}
void OAISqsAction::setPayload(const OAISqsAction_payload &payload) {
    m_payload = payload;
    m_payload_isSet = true;
}

bool OAISqsAction::is_payload_Set() const{
    return m_payload_isSet;
}

bool OAISqsAction::is_payload_Valid() const{
    return m_payload_isValid;
}

bool OAISqsAction::isSet() const {
...
bool OAISqsAction::isValid() const {
