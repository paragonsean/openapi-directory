...
/*
 * OAIUpdateAlarmModelRequest.h
 *
 * 
 */

#ifndef OAIUpdateAlarmModelRequest_H
#define OAIUpdateAlarmModelRequest_H
...
class OAIUpdateAlarmModelRequest : public OAIObject {
public:
    OAIUpdateAlarmModelRequest();
    OAIUpdateAlarmModelRequest(QString json);
    ~OAIUpdateAlarmModelRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAlarmModelRequest)

#endif // OAIUpdateAlarmModelRequest_H
