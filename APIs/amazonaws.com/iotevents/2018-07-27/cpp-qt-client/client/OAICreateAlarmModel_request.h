...
/*
 * OAICreateAlarmModel_request.h
 *
 * 
 */

#ifndef OAICreateAlarmModel_request_H
#define OAICreateAlarmModel_request_H
...
class OAICreateAlarmModel_request : public OAIObject {
public:
    OAICreateAlarmModel_request();
    OAICreateAlarmModel_request(QString json);
    ~OAICreateAlarmModel_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAlarmModel_request)

#endif // OAICreateAlarmModel_request_H
