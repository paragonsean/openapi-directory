...
#ifndef OAIFirehoseAction_H
#define OAIFirehoseAction_H
...
class OAIFirehoseAction : public OAIObject {
public:
    OAIFirehoseAction();
    OAIFirehoseAction(QString json);
    ~OAIFirehoseAction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFirehoseAction)

#endif // OAIFirehoseAction_H
