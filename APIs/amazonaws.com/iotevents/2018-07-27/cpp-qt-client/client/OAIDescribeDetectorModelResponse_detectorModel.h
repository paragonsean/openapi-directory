...
/*
 * OAIDescribeDetectorModelResponse_detectorModel.h
 *
 * 
 */

#ifndef OAIDescribeDetectorModelResponse_detectorModel_H
#define OAIDescribeDetectorModelResponse_detectorModel_H
...
class OAIDescribeDetectorModelResponse_detectorModel : public OAIObject {
public:
    OAIDescribeDetectorModelResponse_detectorModel();
    OAIDescribeDetectorModelResponse_detectorModel(QString json);
    ~OAIDescribeDetectorModelResponse_detectorModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeDetectorModelResponse_detectorModel)

#endif // OAIDescribeDetectorModelResponse_detectorModel_H
