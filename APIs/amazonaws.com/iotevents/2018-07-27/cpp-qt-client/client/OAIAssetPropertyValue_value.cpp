...
QString OAIAssetPropertyValue_value::getIntegerValue() const {
    return m_integer_value;
}
void OAIAssetPropertyValue_value::setIntegerValue(const QString &integer_value) {
...
QString OAIAssetPropertyValue_value::getDoubleValue() const {
    return m_double_value;
}
void OAIAssetPropertyValue_value::setDoubleValue(const QString &double_value) {
...
QString OAIAssetPropertyValue_value::getBooleanValue() const {
    return m_boolean_value;
}
void OAIAssetPropertyValue_value::setBooleanValue(const QString &boolean_value) {
