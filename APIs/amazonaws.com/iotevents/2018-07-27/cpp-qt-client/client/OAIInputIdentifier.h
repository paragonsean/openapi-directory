...
/*
 * OAIInputIdentifier.h
 *
 *  The identifer of the input. 
 */

#ifndef OAIInputIdentifier_H
#define OAIInputIdentifier_H
...
class OAIInputIdentifier : public OAIObject {
public:
    OAIInputIdentifier();
    OAIInputIdentifier(QString json);
    ~OAIInputIdentifier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInputIdentifier)

#endif // OAIInputIdentifier_H
