...
/*
 * OAIDetectorModelConfiguration.h
 *
 * Information about how the detector model is configured.
 */

#ifndef OAIDetectorModelConfiguration_H
#define OAIDetectorModelConfiguration_H
...
class OAIDetectorModelConfiguration : public OAIObject {
public:
    OAIDetectorModelConfiguration();
    OAIDetectorModelConfiguration(QString json);
    ~OAIDetectorModelConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectorModelConfiguration)

#endif // OAIDetectorModelConfiguration_H
