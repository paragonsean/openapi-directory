...
/*
 * OAICreateAlarmModel_request_alarmRule_simpleRule.h
 *
 * 
 */

#ifndef OAICreateAlarmModel_request_alarmRule_simpleRule_H
#define OAICreateAlarmModel_request_alarmRule_simpleRule_H
...
class OAICreateAlarmModel_request_alarmRule_simpleRule : public OAIObject {
public:
    OAICreateAlarmModel_request_alarmRule_simpleRule();
    OAICreateAlarmModel_request_alarmRule_simpleRule(QString json);
    ~OAICreateAlarmModel_request_alarmRule_simpleRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAlarmModel_request_alarmRule_simpleRule)

#endif // OAICreateAlarmModel_request_alarmRule_simpleRule_H
