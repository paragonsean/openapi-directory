...
/*
 * OAIListInputRoutingsRequest_inputIdentifier.h
 *
 * 
 */

#ifndef OAIListInputRoutingsRequest_inputIdentifier_H
#define OAIListInputRoutingsRequest_inputIdentifier_H
...
class OAIListInputRoutingsRequest_inputIdentifier : public OAIObject {
public:
    OAIListInputRoutingsRequest_inputIdentifier();
    OAIListInputRoutingsRequest_inputIdentifier(QString json);
    ~OAIListInputRoutingsRequest_inputIdentifier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListInputRoutingsRequest_inputIdentifier)

#endif // OAIListInputRoutingsRequest_inputIdentifier_H
