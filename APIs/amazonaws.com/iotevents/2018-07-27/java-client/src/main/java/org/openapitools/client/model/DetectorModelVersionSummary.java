...
public class DetectorModelVersionSummary {
  ...
  public DetectorModelVersionSummary() {
  }

  public DetectorModelVersionSummary detectorModelName(String detectorModelName) {
  ...
  public DetectorModelVersionSummary detectorModelVersion(String detectorModelVersion) {
  ...
  public DetectorModelVersionSummary detectorModelArn(String detectorModelArn) {
  ...
  public DetectorModelVersionSummary roleArn(String roleArn) {
  ...
  public DetectorModelVersionSummary creationTime(OffsetDateTime creationTime) {
  ...
  public DetectorModelVersionSummary lastUpdateTime(OffsetDateTime lastUpdateTime) {
  ...
  public DetectorModelVersionSummary status(DetectorModelVersionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public DetectorModelVersionSummary evaluationMethod(EvaluationMethod evaluationMethod) {
  ...
  public boolean equals(Object o) {
    ...
    DetectorModelVersionSummary detectorModelVersionSummary = (DetectorModelVersionSummary) o;
    return Objects.equals(this.detectorModelName, detectorModelVersionSummary.detectorModelName) &&
        Objects.equals(this.detectorModelVersion, detectorModelVersionSummary.detectorModelVersion) &&
        Objects.equals(this.detectorModelArn, detectorModelVersionSummary.detectorModelArn) &&
        Objects.equals(this.roleArn, detectorModelVersionSummary.roleArn) &&
        Objects.equals(this.creationTime, detectorModelVersionSummary.creationTime) &&
        Objects.equals(this.lastUpdateTime, detectorModelVersionSummary.lastUpdateTime) &&
        Objects.equals(this.status, detectorModelVersionSummary.status) &&
        Objects.equals(this.evaluationMethod, detectorModelVersionSummary.evaluationMethod);
  }

  @Override
  public int hashCode() {
    return Objects.hash(detectorModelName, detectorModelVersion, detectorModelArn, roleArn, creationTime, lastUpdateTime, status, evaluationMethod);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DetectorModelVersionSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectorModelVersionSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectorModelVersionSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectorModelVersionSummary is not found in the empty JSON string", DetectorModelVersionSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectorModelVersionSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectorModelVersionSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectorModelVersionSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectorModelVersionSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectorModelVersionSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectorModelVersionSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectorModelVersionSummary>() {
           @Override
           public void write(JsonWriter out, DetectorModelVersionSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectorModelVersionSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectorModelVersionSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectorModelVersionSummary
   * @throws IOException if the JSON string is invalid with respect to DetectorModelVersionSummary
   */
  public static DetectorModelVersionSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectorModelVersionSummary.class);
  }

  /**
   * Convert an instance of DetectorModelVersionSummary to an JSON string
   *
   * @return JSON string
   */
