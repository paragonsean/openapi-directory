...
public class DetectorModelDetectorModelConfiguration {
  ...
  public DetectorModelDetectorModelConfiguration() {
  }

  public DetectorModelDetectorModelConfiguration detectorModelName(String detectorModelName) {
  ...
  public DetectorModelDetectorModelConfiguration detectorModelVersion(String detectorModelVersion) {
  ...
  public DetectorModelDetectorModelConfiguration detectorModelDescription(String detectorModelDescription) {
  ...
  public DetectorModelDetectorModelConfiguration detectorModelArn(String detectorModelArn) {
  ...
  public DetectorModelDetectorModelConfiguration roleArn(String roleArn) {
  ...
  public DetectorModelDetectorModelConfiguration creationTime(OffsetDateTime creationTime) {
  ...
  public DetectorModelDetectorModelConfiguration lastUpdateTime(OffsetDateTime lastUpdateTime) {
  ...
  public DetectorModelDetectorModelConfiguration status(DetectorModelVersionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public DetectorModelDetectorModelConfiguration key(String key) {
    this.key = key;
    return this;
  }
  ...
  public DetectorModelDetectorModelConfiguration evaluationMethod(EvaluationMethod evaluationMethod) {
  ...
  public boolean equals(Object o) {
    ...
    DetectorModelDetectorModelConfiguration detectorModelDetectorModelConfiguration = (DetectorModelDetectorModelConfiguration) o;
    return Objects.equals(this.detectorModelName, detectorModelDetectorModelConfiguration.detectorModelName) &&
        Objects.equals(this.detectorModelVersion, detectorModelDetectorModelConfiguration.detectorModelVersion) &&
        Objects.equals(this.detectorModelDescription, detectorModelDetectorModelConfiguration.detectorModelDescription) &&
        Objects.equals(this.detectorModelArn, detectorModelDetectorModelConfiguration.detectorModelArn) &&
        Objects.equals(this.roleArn, detectorModelDetectorModelConfiguration.roleArn) &&
        Objects.equals(this.creationTime, detectorModelDetectorModelConfiguration.creationTime) &&
        Objects.equals(this.lastUpdateTime, detectorModelDetectorModelConfiguration.lastUpdateTime) &&
        Objects.equals(this.status, detectorModelDetectorModelConfiguration.status) &&
        Objects.equals(this.key, detectorModelDetectorModelConfiguration.key) &&
        Objects.equals(this.evaluationMethod, detectorModelDetectorModelConfiguration.evaluationMethod);
  }
  ...
  public String toString() {
    ...
    sb.append("class DetectorModelDetectorModelConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DetectorModelDetectorModelConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DetectorModelDetectorModelConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DetectorModelDetectorModelConfiguration is not found in the empty JSON string", DetectorModelDetectorModelConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DetectorModelDetectorModelConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DetectorModelDetectorModelConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DetectorModelDetectorModelConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DetectorModelDetectorModelConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DetectorModelDetectorModelConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DetectorModelDetectorModelConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<DetectorModelDetectorModelConfiguration>() {
           @Override
           public void write(JsonWriter out, DetectorModelDetectorModelConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DetectorModelDetectorModelConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DetectorModelDetectorModelConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DetectorModelDetectorModelConfiguration
   * @throws IOException if the JSON string is invalid with respect to DetectorModelDetectorModelConfiguration
   */
  public static DetectorModelDetectorModelConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DetectorModelDetectorModelConfiguration.class);
  }

  /**
   * Convert an instance of DetectorModelDetectorModelConfiguration to an JSON string
   *
   * @return JSON string
   */
