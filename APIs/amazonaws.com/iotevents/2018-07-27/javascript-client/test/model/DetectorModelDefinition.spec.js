...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTEvents.DetectorModelDefinition();
  });
  ...
  describe('DetectorModelDefinition', function() {
    it('should create an instance of DetectorModelDefinition', function() {
      // uncomment below and update the code to test DetectorModelDefinition
      //var instance = new AwsIoTEvents.DetectorModelDefinition();
      //expect(instance).to.be.a(AwsIoTEvents.DetectorModelDefinition);
    });
