...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTEvents.SMSConfiguration();
  });
  ...
  describe('SMSConfiguration', function() {
    it('should create an instance of SMSConfiguration', function() {
      // uncomment below and update the code to test SMSConfiguration
      //var instance = new AwsIoTEvents.SMSConfiguration();
      //expect(instance).to.be.a(AwsIoTEvents.SMSConfiguration);
    });
