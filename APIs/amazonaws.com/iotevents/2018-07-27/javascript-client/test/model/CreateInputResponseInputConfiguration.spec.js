...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTEvents.CreateInputResponseInputConfiguration();
  });
  ...
  describe('CreateInputResponseInputConfiguration', function() {
    it('should create an instance of CreateInputResponseInputConfiguration', function() {
      // uncomment below and update the code to test CreateInputResponseInputConfiguration
      //var instance = new AwsIoTEvents.CreateInputResponseInputConfiguration();
      //expect(instance).to.be.a(AwsIoTEvents.CreateInputResponseInputConfiguration);
    });
