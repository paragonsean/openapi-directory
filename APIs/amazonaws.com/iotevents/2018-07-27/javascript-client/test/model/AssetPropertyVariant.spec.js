...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTEvents.AssetPropertyVariant();
  });
  ...
  describe('AssetPropertyVariant', function() {
    it('should create an instance of AssetPropertyVariant', function() {
      // uncomment below and update the code to test AssetPropertyVariant
      //var instance = new AwsIoTEvents.AssetPropertyVariant();
      //expect(instance).to.be.a(AwsIoTEvents.AssetPropertyVariant);
    });
