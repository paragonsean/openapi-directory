...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTEvents.InputSummary();
  });
  ...
  describe('InputSummary', function() {
    it('should create an instance of InputSummary', function() {
      // uncomment below and update the code to test InputSummary
      //var instance = new AwsIoTEvents.InputSummary();
      //expect(instance).to.be.a(AwsIoTEvents.InputSummary);
    });
