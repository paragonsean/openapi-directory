...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTEvents.IotSiteWiseAction();
  });
  ...
  describe('IotSiteWiseAction', function() {
    it('should create an instance of IotSiteWiseAction', function() {
      // uncomment below and update the code to test IotSiteWiseAction
      //var instance = new AwsIoTEvents.IotSiteWiseAction();
      //expect(instance).to.be.a(AwsIoTEvents.IotSiteWiseAction);
    });
