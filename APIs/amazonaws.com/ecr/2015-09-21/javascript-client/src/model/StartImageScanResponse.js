...
/**
 * The StartImageScanResponse model module.
 * @module model/StartImageScanResponse
 * @version 2015-09-21
 */
class StartImageScanResponse {
    /**
     * Constructs a new <code>StartImageScanResponse</code>.
     * @alias module:model/StartImageScanResponse
     */
    constructor() { 
        
        StartImageScanResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartImageScanResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartImageScanResponse} obj Optional instance to populate.
     * @return {module:model/StartImageScanResponse} The populated <code>StartImageScanResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartImageScanResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>StartImageScanResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartImageScanResponse</code>.
     */
 ...
 */
StartImageScanResponse.prototype['registryId'] = undefined;

/**
 * @member {String} repositoryName
 */
StartImageScanResponse.prototype['repositoryName'] = undefined;

/**
 * @member {module:model/ImageIdentifier} imageId
 */
StartImageScanResponse.prototype['imageId'] = undefined;

/**
 * @member {module:model/DescribeImageScanFindingsResponseImageScanStatus} imageScanStatus
 */
StartImageScanResponse.prototype['imageScanStatus'] = undefined;
...
export default StartImageScanResponse;
