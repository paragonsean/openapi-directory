...
/**
 * The ScoreDetailsCvss model module.
 * @module model/ScoreDetailsCvss
 * @version 2015-09-21
 */
class ScoreDetailsCvss {
    /**
     * Constructs a new <code>ScoreDetailsCvss</code>.
     * @alias module:model/ScoreDetailsCvss
     * @implements module:model/CvssScoreDetails
     */
    constructor() { 
        CvssScoreDetails.initialize(this);
        ScoreDetailsCvss.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ScoreDetailsCvss</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScoreDetailsCvss} obj Optional instance to populate.
     * @return {module:model/ScoreDetailsCvss} The populated <code>ScoreDetailsCvss</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScoreDetailsCvss();
    ...
    /**
     * Validates the JSON data with respect to <code>ScoreDetailsCvss</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScoreDetailsCvss</code>.
     */
 ...
 */
ScoreDetailsCvss.prototype['adjustments'] = undefined;

/**
 * @member {Number} score
 */
ScoreDetailsCvss.prototype['score'] = undefined;

/**
 * @member {String} scoreSource
 */
ScoreDetailsCvss.prototype['scoreSource'] = undefined;

/**
 * @member {String} scoringVector
 */
ScoreDetailsCvss.prototype['scoringVector'] = undefined;

/**
 * @member {String} version
 */
ScoreDetailsCvss.prototype['version'] = undefined;
...
export default ScoreDetailsCvss;
