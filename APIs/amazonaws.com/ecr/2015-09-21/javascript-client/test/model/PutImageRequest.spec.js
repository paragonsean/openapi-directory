...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.PutImageRequest();
  });
  ...
  describe('PutImageRequest', function() {
    it('should create an instance of PutImageRequest', function() {
      ...
      //var instance = new AmazonEc2ContainerRegistry.PutImageRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.PutImageRequest);
    });
