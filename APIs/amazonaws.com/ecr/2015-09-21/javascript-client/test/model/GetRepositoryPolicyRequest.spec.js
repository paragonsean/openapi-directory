...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.GetRepositoryPolicyRequest();
  });
  ...
  describe('GetRepositoryPolicyRequest', function() {
    it('should create an instance of GetRepositoryPolicyRequest', function() {
      ...
      //var instance = new AmazonEc2ContainerRegistry.GetRepositoryPolicyRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.GetRepositoryPolicyRequest);
    });
