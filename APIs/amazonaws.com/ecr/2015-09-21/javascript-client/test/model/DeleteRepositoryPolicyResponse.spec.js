...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.DeleteRepositoryPolicyResponse();
  });
  ...
  describe('DeleteRepositoryPolicyResponse', function() {
    it('should create an instance of DeleteRepositoryPolicyResponse', function() {
      // uncomment below and update the code to test DeleteRepositoryPolicyResponse
      //var instance = new AmazonEc2ContainerRegistry.DeleteRepositoryPolicyResponse();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.DeleteRepositoryPolicyResponse);
    });
    ...
    it('should have the property policyText (base name: "policyText")', function() {
