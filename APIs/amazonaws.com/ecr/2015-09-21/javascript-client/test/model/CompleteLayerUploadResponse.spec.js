...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.CompleteLayerUploadResponse();
  });
  ...
  describe('CompleteLayerUploadResponse', function() {
    it('should create an instance of CompleteLayerUploadResponse', function() {
      ...
      //var instance = new AmazonEc2ContainerRegistry.CompleteLayerUploadResponse();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.CompleteLayerUploadResponse);
    });
