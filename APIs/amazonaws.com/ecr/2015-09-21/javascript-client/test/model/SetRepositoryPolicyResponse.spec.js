...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.SetRepositoryPolicyResponse();
  });
  ...
  describe('SetRepositoryPolicyResponse', function() {
    it('should create an instance of SetRepositoryPolicyResponse', function() {
      ...
      //var instance = new AmazonEc2ContainerRegistry.SetRepositoryPolicyResponse();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.SetRepositoryPolicyResponse);
    });
