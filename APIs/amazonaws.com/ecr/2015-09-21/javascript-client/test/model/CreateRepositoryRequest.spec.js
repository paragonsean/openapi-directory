...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.CreateRepositoryRequest();
  });
  ...
  describe('CreateRepositoryRequest', function() {
    it('should create an instance of CreateRepositoryRequest', function() {
      ...
      //var instance = new AmazonEc2ContainerRegistry.CreateRepositoryRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.CreateRepositoryRequest);
    });
