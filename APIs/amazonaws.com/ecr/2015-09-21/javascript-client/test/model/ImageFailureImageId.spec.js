...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.ImageFailureImageId();
  });
  ...
  describe('ImageFailureImageId', function() {
    it('should create an instance of ImageFailureImageId', function() {
      ...
      //var instance = new AmazonEc2ContainerRegistry.ImageFailureImageId();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.ImageFailureImageId);
    });
