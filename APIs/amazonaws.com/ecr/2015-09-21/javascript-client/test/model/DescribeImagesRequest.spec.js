...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.DescribeImagesRequest();
  });
  ...
  describe('DescribeImagesRequest', function() {
    it('should create an instance of DescribeImagesRequest', function() {
      ...
      //var instance = new AmazonEc2ContainerRegistry.DescribeImagesRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.DescribeImagesRequest);
    });
