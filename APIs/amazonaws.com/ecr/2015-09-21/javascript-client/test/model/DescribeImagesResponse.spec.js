...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.DescribeImagesResponse();
  });
  ...
  describe('DescribeImagesResponse', function() {
    it('should create an instance of DescribeImagesResponse', function() {
      ...
      //var instance = new AmazonEc2ContainerRegistry.DescribeImagesResponse();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.DescribeImagesResponse);
    });
