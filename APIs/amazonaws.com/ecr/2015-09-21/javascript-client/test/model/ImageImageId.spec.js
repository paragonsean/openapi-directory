...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.ImageImageId();
  });
  ...
  describe('ImageImageId', function() {
    it('should create an instance of ImageImageId', function() {
      ...
      //var instance = new AmazonEc2ContainerRegistry.ImageImageId();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.ImageImageId);
    });
