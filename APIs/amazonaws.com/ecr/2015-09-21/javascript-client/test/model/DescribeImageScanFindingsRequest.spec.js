...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.DescribeImageScanFindingsRequest();
  });
  ...
  describe('DescribeImageScanFindingsRequest', function() {
    it('should create an instance of DescribeImageScanFindingsRequest', function() {
      // uncomment below and update the code to test DescribeImageScanFindingsRequest
      //var instance = new AmazonEc2ContainerRegistry.DescribeImageScanFindingsRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.DescribeImageScanFindingsRequest);
    });
