...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.RepositoryFilter();
  });
  ...
  describe('RepositoryFilter', function() {
    it('should create an instance of RepositoryFilter', function() {
      // uncomment below and update the code to test RepositoryFilter
      //var instance = new AmazonEc2ContainerRegistry.RepositoryFilter();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.RepositoryFilter);
    });
