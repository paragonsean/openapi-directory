...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.ReplicationConfiguration();
  });
  ...
  describe('ReplicationConfiguration', function() {
    it('should create an instance of ReplicationConfiguration', function() {
      ...
      //var instance = new AmazonEc2ContainerRegistry.ReplicationConfiguration();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.ReplicationConfiguration);
    });
