...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.ImageIdentifier();
  });
  ...
  describe('ImageIdentifier', function() {
    it('should create an instance of ImageIdentifier', function() {
      // uncomment below and update the code to test ImageIdentifier
      //var instance = new AmazonEc2ContainerRegistry.ImageIdentifier();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.ImageIdentifier);
    });
