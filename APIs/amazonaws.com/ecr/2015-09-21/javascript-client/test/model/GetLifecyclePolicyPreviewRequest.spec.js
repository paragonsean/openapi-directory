...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.GetLifecyclePolicyPreviewRequest();
  });
  ...
  describe('GetLifecyclePolicyPreviewRequest', function() {
    it('should create an instance of GetLifecyclePolicyPreviewRequest', function() {
      // uncomment below and update the code to test GetLifecyclePolicyPreviewRequest
      //var instance = new AmazonEc2ContainerRegistry.GetLifecyclePolicyPreviewRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.GetLifecyclePolicyPreviewRequest);
    });
