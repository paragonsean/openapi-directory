...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.StartImageScanRequest();
  });
  ...
  describe('StartImageScanRequest', function() {
    it('should create an instance of StartImageScanRequest', function() {
      // uncomment below and update the code to test StartImageScanRequest
      //var instance = new AmazonEc2ContainerRegistry.StartImageScanRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.StartImageScanRequest);
    });
