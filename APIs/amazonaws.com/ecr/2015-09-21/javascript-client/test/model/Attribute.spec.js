...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.Attribute();
  });
  ...
  describe('Attribute', function() {
    it('should create an instance of Attribute', function() {
      ...
      //var instance = new AmazonEc2ContainerRegistry.Attribute();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.Attribute);
    });
