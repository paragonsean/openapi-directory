...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.AuthorizationData();
  });
  ...
  describe('AuthorizationData', function() {
    it('should create an instance of AuthorizationData', function() {
      // uncomment below and update the code to test AuthorizationData
      //var instance = new AmazonEc2ContainerRegistry.AuthorizationData();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.AuthorizationData);
    });
    ...
    it('should have the property proxyEndpoint (base name: "proxyEndpoint")', function() {
      // uncomment below and update the code to test the property proxyEndpoint
      //var instance = new AmazonEc2ContainerRegistry.AuthorizationData();
      //expect(instance).to.be();
    });
