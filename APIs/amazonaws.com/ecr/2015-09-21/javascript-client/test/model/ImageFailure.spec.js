...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.ImageFailure();
  });
  ...
  describe('ImageFailure', function() {
    it('should create an instance of ImageFailure', function() {
      ...
      //var instance = new AmazonEc2ContainerRegistry.ImageFailure();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.ImageFailure);
    });
