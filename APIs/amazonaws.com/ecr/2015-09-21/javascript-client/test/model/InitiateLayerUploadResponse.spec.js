...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.InitiateLayerUploadResponse();
  });
  ...
  describe('InitiateLayerUploadResponse', function() {
    it('should create an instance of InitiateLayerUploadResponse', function() {
      ...
      //var instance = new AmazonEc2ContainerRegistry.InitiateLayerUploadResponse();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.InitiateLayerUploadResponse);
    });
