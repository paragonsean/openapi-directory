...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.DeleteRepositoryPolicyRequest();
  });
  ...
  describe('DeleteRepositoryPolicyRequest', function() {
    it('should create an instance of DeleteRepositoryPolicyRequest', function() {
      ...
      //var instance = new AmazonEc2ContainerRegistry.DeleteRepositoryPolicyRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.DeleteRepositoryPolicyRequest);
    });
