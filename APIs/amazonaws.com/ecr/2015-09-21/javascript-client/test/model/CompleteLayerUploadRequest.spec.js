...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.CompleteLayerUploadRequest();
  });
  ...
  describe('CompleteLayerUploadRequest', function() {
    it('should create an instance of CompleteLayerUploadRequest', function() {
      ...
      //var instance = new AmazonEc2ContainerRegistry.CompleteLayerUploadRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.CompleteLayerUploadRequest);
    });
