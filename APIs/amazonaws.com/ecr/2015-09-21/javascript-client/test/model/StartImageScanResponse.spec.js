...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.StartImageScanResponse();
  });
  ...
  describe('StartImageScanResponse', function() {
    it('should create an instance of StartImageScanResponse', function() {
      // uncomment below and update the code to test StartImageScanResponse
      //var instance = new AmazonEc2ContainerRegistry.StartImageScanResponse();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.StartImageScanResponse);
    });
