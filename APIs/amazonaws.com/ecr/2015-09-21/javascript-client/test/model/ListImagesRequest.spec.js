...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.ListImagesRequest();
  });
  ...
  describe('ListImagesRequest', function() {
    it('should create an instance of ListImagesRequest', function() {
      ...
      //var instance = new AmazonEc2ContainerRegistry.ListImagesRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.ListImagesRequest);
    });
