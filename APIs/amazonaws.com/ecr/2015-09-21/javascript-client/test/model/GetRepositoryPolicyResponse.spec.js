...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.GetRepositoryPolicyResponse();
  });
  ...
  describe('GetRepositoryPolicyResponse', function() {
    it('should create an instance of GetRepositoryPolicyResponse', function() {
      ...
      //var instance = new AmazonEc2ContainerRegistry.GetRepositoryPolicyResponse();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.GetRepositoryPolicyResponse);
    });
