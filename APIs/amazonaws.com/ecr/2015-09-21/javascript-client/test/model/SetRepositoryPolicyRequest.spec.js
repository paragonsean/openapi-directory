...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.SetRepositoryPolicyRequest();
  });
  ...
  describe('SetRepositoryPolicyRequest', function() {
    it('should create an instance of SetRepositoryPolicyRequest', function() {
      ...
      //var instance = new AmazonEc2ContainerRegistry.SetRepositoryPolicyRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.SetRepositoryPolicyRequest);
    });
