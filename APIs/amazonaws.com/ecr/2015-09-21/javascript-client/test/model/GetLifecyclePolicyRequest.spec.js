...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.GetLifecyclePolicyRequest();
  });
  ...
  describe('GetLifecyclePolicyRequest', function() {
    it('should create an instance of GetLifecyclePolicyRequest', function() {
      // uncomment below and update the code to test GetLifecyclePolicyRequest
      //var instance = new AmazonEc2ContainerRegistry.GetLifecyclePolicyRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.GetLifecyclePolicyRequest);
    });
