...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.Recommendation();
  });
  ...
  describe('Recommendation', function() {
    it('should create an instance of Recommendation', function() {
      ...
      //var instance = new AmazonEc2ContainerRegistry.Recommendation();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.Recommendation);
    });
