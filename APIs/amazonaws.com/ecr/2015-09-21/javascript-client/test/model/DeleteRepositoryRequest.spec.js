...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.DeleteRepositoryRequest();
  });
  ...
  describe('DeleteRepositoryRequest', function() {
    it('should create an instance of DeleteRepositoryRequest', function() {
      ...
      //var instance = new AmazonEc2ContainerRegistry.DeleteRepositoryRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.DeleteRepositoryRequest);
    });
