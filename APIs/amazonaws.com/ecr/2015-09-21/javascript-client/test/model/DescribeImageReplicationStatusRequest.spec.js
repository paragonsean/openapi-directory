...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.DescribeImageReplicationStatusRequest();
  });
  ...
  describe('DescribeImageReplicationStatusRequest', function() {
    it('should create an instance of DescribeImageReplicationStatusRequest', function() {
      // uncomment below and update the code to test DescribeImageReplicationStatusRequest
      //var instance = new AmazonEc2ContainerRegistry.DescribeImageReplicationStatusRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.DescribeImageReplicationStatusRequest);
    });
