...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.DeleteLifecyclePolicyRequest();
  });
  ...
  describe('DeleteLifecyclePolicyRequest', function() {
    it('should create an instance of DeleteLifecyclePolicyRequest', function() {
      // uncomment below and update the code to test DeleteLifecyclePolicyRequest
      //var instance = new AmazonEc2ContainerRegistry.DeleteLifecyclePolicyRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.DeleteLifecyclePolicyRequest);
    });
