...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.ImageReplicationStatus();
  });
  ...
  describe('ImageReplicationStatus', function() {
    it('should create an instance of ImageReplicationStatus', function() {
      // uncomment below and update the code to test ImageReplicationStatus
      //var instance = new AmazonEc2ContainerRegistry.ImageReplicationStatus();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.ImageReplicationStatus);
    });
