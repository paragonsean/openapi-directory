...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.DescribeRepositoriesResponse();
  });
  ...
  describe('DescribeRepositoriesResponse', function() {
    it('should create an instance of DescribeRepositoriesResponse', function() {
      // uncomment below and update the code to test DescribeRepositoriesResponse
      //var instance = new AmazonEc2ContainerRegistry.DescribeRepositoriesResponse();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.DescribeRepositoriesResponse);
    });
