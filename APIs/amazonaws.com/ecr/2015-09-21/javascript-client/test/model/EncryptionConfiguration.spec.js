...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.EncryptionConfiguration();
  });
  ...
  describe('EncryptionConfiguration', function() {
    it('should create an instance of EncryptionConfiguration', function() {
      ...
      //var instance = new AmazonEc2ContainerRegistry.EncryptionConfiguration();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.EncryptionConfiguration);
    });
