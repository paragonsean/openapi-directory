...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.Remediation();
  });
  ...
  describe('Remediation', function() {
    it('should create an instance of Remediation', function() {
      ...
      //var instance = new AmazonEc2ContainerRegistry.Remediation();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.Remediation);
    });
