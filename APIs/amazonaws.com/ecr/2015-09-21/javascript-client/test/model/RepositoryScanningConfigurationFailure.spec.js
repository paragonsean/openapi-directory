...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.RepositoryScanningConfigurationFailure();
  });
  ...
  describe('RepositoryScanningConfigurationFailure', function() {
    it('should create an instance of RepositoryScanningConfigurationFailure', function() {
      // uncomment below and update the code to test RepositoryScanningConfigurationFailure
      //var instance = new AmazonEc2ContainerRegistry.RepositoryScanningConfigurationFailure();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.RepositoryScanningConfigurationFailure);
    });
