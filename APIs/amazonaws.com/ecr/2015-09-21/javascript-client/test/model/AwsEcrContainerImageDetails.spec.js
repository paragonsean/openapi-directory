...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.AwsEcrContainerImageDetails();
  });
  ...
  describe('AwsEcrContainerImageDetails', function() {
    it('should create an instance of AwsEcrContainerImageDetails', function() {
      // uncomment below and update the code to test AwsEcrContainerImageDetails
      //var instance = new AmazonEc2ContainerRegistry.AwsEcrContainerImageDetails();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.AwsEcrContainerImageDetails);
    });
