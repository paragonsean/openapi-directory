...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.PutImageScanningConfigurationRequest();
  });
  ...
  describe('PutImageScanningConfigurationRequest', function() {
    it('should create an instance of PutImageScanningConfigurationRequest', function() {
      // uncomment below and update the code to test PutImageScanningConfigurationRequest
      //var instance = new AmazonEc2ContainerRegistry.PutImageScanningConfigurationRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.PutImageScanningConfigurationRequest);
    });
