...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.UploadLayerPartResponse();
  });
  ...
  describe('UploadLayerPartResponse', function() {
    it('should create an instance of UploadLayerPartResponse', function() {
      ...
      //var instance = new AmazonEc2ContainerRegistry.UploadLayerPartResponse();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.UploadLayerPartResponse);
    });
