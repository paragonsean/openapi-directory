...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonEc2ContainerRegistry.InitiateLayerUploadRequest();
  });
  ...
  describe('InitiateLayerUploadRequest', function() {
    it('should create an instance of InitiateLayerUploadRequest', function() {
      ...
      //var instance = new AmazonEc2ContainerRegistry.InitiateLayerUploadRequest();
      //expect(instance).to.be.a(AmazonEc2ContainerRegistry.InitiateLayerUploadRequest);
    });
