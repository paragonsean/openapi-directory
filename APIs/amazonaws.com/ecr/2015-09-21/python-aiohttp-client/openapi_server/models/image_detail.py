...
class ImageDetail(Model):
    ...
    def __init__(self, registry_id: str=None, repository_name: str=None, image_digest: str=None, image_tags: List=None, image_size_in_bytes: int=None, image_pushed_at: datetime=None, image_scan_status: DescribeImageScanFindingsResponseImageScanStatus=None, image_scan_findings_summary: ImageDetailImageScanFindingsSummary=None, image_manifest_media_type: str=None, artifact_media_type: str=None, last_recorded_pull_time: datetime=None):
        ...
        :param image_scan_status: The image_scan_status of this ImageDetail.
        :param image_scan_findings_summary: The image_scan_findings_summary of this ImageDetail.
        ...
        :param last_recorded_pull_time: The last_recorded_pull_time of this ImageDetail.
        """
        self.openapi_types = {
            'registry_id': str,
            'repository_name': str,
            ...
            'image_scan_findings_summary': ImageDetailImageScanFindingsSummary,
            'image_manifest_media_type': str,
            'artifact_media_type': str,
            'last_recorded_pull_time': datetime
        }
        ...
        self._image_scan_findings_summary = image_scan_findings_summary
        self._image_manifest_media_type = image_manifest_media_type
        self._artifact_media_type = artifact_media_type
        self._last_recorded_pull_time = last_recorded_pull_time
    ...
    def image_scan_status(self):
        """Gets the image_scan_status of this ImageDetail.


        :return: The image_scan_status of this ImageDetail.
    ...
    def image_scan_status(self, image_scan_status):
        """Sets the image_scan_status of this ImageDetail.
    ...
    @property
    def image_scan_findings_summary(self):
        """Gets the image_scan_findings_summary of this ImageDetail.


        :return: The image_scan_findings_summary of this ImageDetail.
        :rtype: ImageDetailImageScanFindingsSummary
        """
        return self._image_scan_findings_summary

    @image_scan_findings_summary.setter
    def image_scan_findings_summary(self, image_scan_findings_summary):
        """Sets the image_scan_findings_summary of this ImageDetail.


        :param image_scan_findings_summary: The image_scan_findings_summary of this ImageDetail.
        :type image_scan_findings_summary: ImageDetailImageScanFindingsSummary
        """
    ...
    @property
    def last_recorded_pull_time(self):
        """Gets the last_recorded_pull_time of this ImageDetail.


        :return: The last_recorded_pull_time of this ImageDetail.
        :rtype: datetime
        """
        return self._last_recorded_pull_time

    @last_recorded_pull_time.setter
    def last_recorded_pull_time(self, last_recorded_pull_time):
        """Sets the last_recorded_pull_time of this ImageDetail.


        :param last_recorded_pull_time: The last_recorded_pull_time of this ImageDetail.
        :type last_recorded_pull_time: datetime
        """
