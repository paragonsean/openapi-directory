...
async def test_batch_delete_image(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.BatchDeleteImage',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_batch_get_image(client):
    """Test case for batch_get_image

    
    """
    body = {"acceptedMediaTypes":"","registryId":"","repositoryName":"","imageIds":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.BatchGetImage',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_batch_get_repository_scanning_configuration(client):
    """Test case for batch_get_repository_scanning_configuration
...
async def test_complete_layer_upload(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.CompleteLayerUpload',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_pull_through_cache_rule(client):
    """Test case for create_pull_through_cache_rule

    
    """
    body = {"upstreamRegistryUrl":"","ecrRepositoryPrefix":"","registryId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_repository(client):
    ...
    """
    body = {"registryId":"","encryptionConfiguration":{"kmsKey":"","encryptionType":""},"repositoryName":"","imageTagMutability":"","tags":"","imageScanningConfiguration":{"scanOnPush":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.CreateRepository',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_lifecycle_policy(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.DeleteLifecyclePolicy',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_pull_through_cache_rule(client):
    """Test case for delete_pull_through_cache_rule
...
async def test_delete_registry_policy(client):
    """Test case for delete_registry_policy
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.DeleteRegistryPolicy',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_repository(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.DeleteRepository',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_repository_policy(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.DeleteRepositoryPolicy',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_image_replication_status(client):
    """Test case for describe_image_replication_status

    
    """
    body = {"imageId":{"imageTag":"","imageDigest":""},"registryId":"","repositoryName":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.DescribeImageReplicationStatus',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_image_scan_findings(client):
    """Test case for describe_image_scan_findings

    
    """
    body = {"imageId":{"imageTag":"","imageDigest":""},"nextToken":"","maxResults":"","registryId":"","repositoryName":""}
...
async def test_describe_images(client):
    ...
    """
    body = {"filter":{"tagStatus":""},"nextToken":"","maxResults":"","registryId":"","repositoryName":"","imageIds":""}
    params = [('maxResults', 'max_results_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.DescribeImages',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_describe_pull_through_cache_rules(client):
    """Test case for describe_pull_through_cache_rules

    
    """
    body = {"nextToken":"","maxResults":"","registryId":"","ecrRepositoryPrefixes":""}
    params = [('maxResults', 'max_results_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_describe_registry(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.DescribeRegistry',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_authorization_token(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.GetAuthorizationToken',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_download_url_for_layer(client):
    """Test case for get_download_url_for_layer

    
    """
    body = {"layerDigest":"","registryId":"","repositoryName":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.GetDownloadUrlForLayer',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_lifecycle_policy(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.GetLifecyclePolicy',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_lifecycle_policy_preview(client):
    """Test case for get_lifecycle_policy_preview
...
async def test_get_registry_policy(client):
    """Test case for get_registry_policy
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.GetRegistryPolicy',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_registry_scanning_configuration(client):
    """Test case for get_registry_scanning_configuration
...
async def test_initiate_layer_upload(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.InitiateLayerUpload',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_images(client):
    ...
    """
    body = {"filter":{"tagStatus":""},"nextToken":"","maxResults":"","registryId":"","repositoryName":""}
    params = [('maxResults', 'max_results_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.ListImages',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_tags_for_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.ListTagsForResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_put_image(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.PutImage',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_put_image_scanning_configuration(client):
    """Test case for put_image_scanning_configuration

    
    """
    body = {"registryId":"","repositoryName":"","imageScanningConfiguration":{"scanOnPush":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_put_image_tag_mutability(client):
    """Test case for put_image_tag_mutability
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.PutImageTagMutability',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_put_registry_policy(client):
    """Test case for put_registry_policy
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.PutRegistryPolicy',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_put_registry_scanning_configuration(client):
    """Test case for put_registry_scanning_configuration
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.PutRegistryScanningConfiguration',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_put_replication_configuration(client):
    """Test case for put_replication_configuration

    
    """
    body = {"replicationConfiguration":{"rules":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.PutReplicationConfiguration',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_set_repository_policy(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.SetRepositoryPolicy',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_start_image_scan(client):
    """Test case for start_image_scan
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.StartImageScan',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_start_lifecycle_policy_preview(client):
    """Test case for start_lifecycle_policy_preview
...
async def test_tag_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.TagResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_untag_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.UntagResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_upload_layer_part(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.UploadLayerPart',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
