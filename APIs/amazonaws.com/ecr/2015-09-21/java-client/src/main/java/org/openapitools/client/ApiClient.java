...
public class ApiClient {
    ...
    private String basePath = "http://api.ecr.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2015-09-21/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://api.ecr.us-east-1.amazonaws.com
