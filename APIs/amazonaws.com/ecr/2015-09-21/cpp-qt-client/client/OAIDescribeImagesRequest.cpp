...
OAIDescribeImagesRequest_filter OAIDescribeImagesRequest::getFilter() const {
    return m_filter;
}
void OAIDescribeImagesRequest::setFilter(const OAIDescribeImagesRequest_filter &filter) {
    m_filter = filter;
    m_filter_isSet = true;
}

bool OAIDescribeImagesRequest::is_filter_Set() const{
    return m_filter_isSet;
}

bool OAIDescribeImagesRequest::is_filter_Valid() const{
