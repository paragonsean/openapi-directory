...
/*
 * OAIGetLifecyclePolicyRequest.h
 *
 * 
 */

#ifndef OAIGetLifecyclePolicyRequest_H
#define OAIGetLifecyclePolicyRequest_H
...
class OAIGetLifecyclePolicyRequest : public OAIObject {
public:
    OAIGetLifecyclePolicyRequest();
    OAIGetLifecyclePolicyRequest(QString json);
    ~OAIGetLifecyclePolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLifecyclePolicyRequest)

#endif // OAIGetLifecyclePolicyRequest_H
