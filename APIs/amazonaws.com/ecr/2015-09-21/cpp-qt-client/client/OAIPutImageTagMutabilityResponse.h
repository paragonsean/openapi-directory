...
/*
 * OAIPutImageTagMutabilityResponse.h
 *
 * 
 */

#ifndef OAIPutImageTagMutabilityResponse_H
#define OAIPutImageTagMutabilityResponse_H
...
class OAIPutImageTagMutabilityResponse : public OAIObject {
public:
    OAIPutImageTagMutabilityResponse();
    OAIPutImageTagMutabilityResponse(QString json);
    ~OAIPutImageTagMutabilityResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutImageTagMutabilityResponse)

#endif // OAIPutImageTagMutabilityResponse_H
