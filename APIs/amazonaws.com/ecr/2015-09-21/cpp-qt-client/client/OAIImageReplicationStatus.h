...
/*
 * OAIImageReplicationStatus.h
 *
 * The status of the replication process for an image.
 */

#ifndef OAIImageReplicationStatus_H
#define OAIImageReplicationStatus_H
...
class OAIImageReplicationStatus : public OAIObject {
public:
    OAIImageReplicationStatus();
    OAIImageReplicationStatus(QString json);
    ~OAIImageReplicationStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageReplicationStatus)

#endif // OAIImageReplicationStatus_H
