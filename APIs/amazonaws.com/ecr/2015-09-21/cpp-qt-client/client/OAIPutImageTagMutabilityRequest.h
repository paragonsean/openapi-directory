...
/*
 * OAIPutImageTagMutabilityRequest.h
 *
 * 
 */

#ifndef OAIPutImageTagMutabilityRequest_H
#define OAIPutImageTagMutabilityRequest_H
...
class OAIPutImageTagMutabilityRequest : public OAIObject {
public:
    OAIPutImageTagMutabilityRequest();
    OAIPutImageTagMutabilityRequest(QString json);
    ~OAIPutImageTagMutabilityRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutImageTagMutabilityRequest)

#endif // OAIPutImageTagMutabilityRequest_H
