...
/*
 * OAIScoreDetails_cvss.h
 *
 * 
 */

#ifndef OAIScoreDetails_cvss_H
#define OAIScoreDetails_cvss_H
...
class OAIScoreDetails_cvss : public OAIObject {
public:
    OAIScoreDetails_cvss();
    OAIScoreDetails_cvss(QString json);
    ~OAIScoreDetails_cvss() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScoreDetails_cvss)

#endif // OAIScoreDetails_cvss_H
