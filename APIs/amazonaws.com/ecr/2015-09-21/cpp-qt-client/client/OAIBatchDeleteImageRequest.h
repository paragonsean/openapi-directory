...
#ifndef OAIBatchDeleteImageRequest_H
#define OAIBatchDeleteImageRequest_H
...
class OAIBatchDeleteImageRequest : public OAIObject {
public:
    OAIBatchDeleteImageRequest();
    OAIBatchDeleteImageRequest(QString json);
    ~OAIBatchDeleteImageRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchDeleteImageRequest)

#endif // OAIBatchDeleteImageRequest_H
