...
OAIScoreDetails_cvss OAIScoreDetails::getCvss() const {
    return m_cvss;
}
void OAIScoreDetails::setCvss(const OAIScoreDetails_cvss &cvss) {
    m_cvss = cvss;
    m_cvss_isSet = true;
}

bool OAIScoreDetails::is_cvss_Set() const{
    return m_cvss_isSet;
}

bool OAIScoreDetails::is_cvss_Valid() const{
