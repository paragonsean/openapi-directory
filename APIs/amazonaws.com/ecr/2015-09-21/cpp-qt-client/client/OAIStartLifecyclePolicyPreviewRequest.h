...
/*
 * OAIStartLifecyclePolicyPreviewRequest.h
 *
 * 
 */

#ifndef OAIStartLifecyclePolicyPreviewRequest_H
#define OAIStartLifecyclePolicyPreviewRequest_H
...
class OAIStartLifecyclePolicyPreviewRequest : public OAIObject {
public:
    OAIStartLifecyclePolicyPreviewRequest();
    OAIStartLifecyclePolicyPreviewRequest(QString json);
    ~OAIStartLifecyclePolicyPreviewRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartLifecyclePolicyPreviewRequest)

#endif // OAIStartLifecyclePolicyPreviewRequest_H
