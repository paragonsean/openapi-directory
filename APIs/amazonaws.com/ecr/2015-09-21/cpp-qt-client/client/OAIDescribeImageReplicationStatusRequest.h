...
/*
 * OAIDescribeImageReplicationStatusRequest.h
 *
 * 
 */

#ifndef OAIDescribeImageReplicationStatusRequest_H
#define OAIDescribeImageReplicationStatusRequest_H
...
class OAIDescribeImageReplicationStatusRequest : public OAIObject {
public:
    OAIDescribeImageReplicationStatusRequest();
    OAIDescribeImageReplicationStatusRequest(QString json);
    ~OAIDescribeImageReplicationStatusRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeImageReplicationStatusRequest)

#endif // OAIDescribeImageReplicationStatusRequest_H
