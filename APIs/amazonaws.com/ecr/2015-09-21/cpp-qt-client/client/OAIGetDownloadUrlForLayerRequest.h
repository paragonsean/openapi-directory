...
/*
 * OAIGetDownloadUrlForLayerRequest.h
 *
 * 
 */

#ifndef OAIGetDownloadUrlForLayerRequest_H
#define OAIGetDownloadUrlForLayerRequest_H
...
class OAIGetDownloadUrlForLayerRequest : public OAIObject {
public:
    OAIGetDownloadUrlForLayerRequest();
    OAIGetDownloadUrlForLayerRequest(QString json);
    ~OAIGetDownloadUrlForLayerRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDownloadUrlForLayerRequest)

#endif // OAIGetDownloadUrlForLayerRequest_H
