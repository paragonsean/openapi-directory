...
/*
 * OAIDeleteRepositoryPolicyRequest.h
 *
 * 
 */

#ifndef OAIDeleteRepositoryPolicyRequest_H
#define OAIDeleteRepositoryPolicyRequest_H
...
class OAIDeleteRepositoryPolicyRequest : public OAIObject {
public:
    OAIDeleteRepositoryPolicyRequest();
    OAIDeleteRepositoryPolicyRequest(QString json);
    ~OAIDeleteRepositoryPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteRepositoryPolicyRequest)

#endif // OAIDeleteRepositoryPolicyRequest_H
