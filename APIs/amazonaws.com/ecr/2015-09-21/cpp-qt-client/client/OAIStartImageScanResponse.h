...
/*
 * OAIStartImageScanResponse.h
 *
 * 
 */

#ifndef OAIStartImageScanResponse_H
#define OAIStartImageScanResponse_H
...
class OAIStartImageScanResponse : public OAIObject {
public:
    OAIStartImageScanResponse();
    OAIStartImageScanResponse(QString json);
    ~OAIStartImageScanResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartImageScanResponse)

#endif // OAIStartImageScanResponse_H
