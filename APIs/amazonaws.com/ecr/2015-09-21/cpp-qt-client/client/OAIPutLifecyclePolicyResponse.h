...
/*
 * OAIPutLifecyclePolicyResponse.h
 *
 * 
 */

#ifndef OAIPutLifecyclePolicyResponse_H
#define OAIPutLifecyclePolicyResponse_H
...
class OAIPutLifecyclePolicyResponse : public OAIObject {
public:
    OAIPutLifecyclePolicyResponse();
    OAIPutLifecyclePolicyResponse(QString json);
    ~OAIPutLifecyclePolicyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutLifecyclePolicyResponse)

#endif // OAIPutLifecyclePolicyResponse_H
