...
namespace OpenAPI {
class OAIListImagesRequest_filter;
...
public:
    ...
    OAIListImagesRequest_filter getFilter() const;
    void setFilter(const OAIListImagesRequest_filter &filter);
...
private:
    ...
    OAIListImagesRequest_filter m_filter;
    bool m_filter_isSet;
