...
/*
 * OAIDescribeImageScanFindingsRequest.h
 *
 * 
 */

#ifndef OAIDescribeImageScanFindingsRequest_H
#define OAIDescribeImageScanFindingsRequest_H
...
class OAIDescribeImageScanFindingsRequest : public OAIObject {
public:
    OAIDescribeImageScanFindingsRequest();
    OAIDescribeImageScanFindingsRequest(QString json);
    ~OAIDescribeImageScanFindingsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeImageScanFindingsRequest)

#endif // OAIDescribeImageScanFindingsRequest_H
