...
/*
 * OAIGetDownloadUrlForLayerResponse.h
 *
 * 
 */

#ifndef OAIGetDownloadUrlForLayerResponse_H
#define OAIGetDownloadUrlForLayerResponse_H
...
class OAIGetDownloadUrlForLayerResponse : public OAIObject {
public:
    OAIGetDownloadUrlForLayerResponse();
    OAIGetDownloadUrlForLayerResponse(QString json);
    ~OAIGetDownloadUrlForLayerResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDownloadUrlForLayerResponse)

#endif // OAIGetDownloadUrlForLayerResponse_H
