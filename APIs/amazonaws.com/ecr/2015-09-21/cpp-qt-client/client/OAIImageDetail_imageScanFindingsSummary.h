...
/*
 * OAIImageDetail_imageScanFindingsSummary.h
 *
 * 
 */

#ifndef OAIImageDetail_imageScanFindingsSummary_H
#define OAIImageDetail_imageScanFindingsSummary_H
...
class OAIImageDetail_imageScanFindingsSummary : public OAIObject {
public:
    OAIImageDetail_imageScanFindingsSummary();
    OAIImageDetail_imageScanFindingsSummary(QString json);
    ~OAIImageDetail_imageScanFindingsSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageDetail_imageScanFindingsSummary)

#endif // OAIImageDetail_imageScanFindingsSummary_H
