...
/*
 * OAIDescribeImageScanFindingsResponse_imageScanFindings.h
 *
 * 
 */

#ifndef OAIDescribeImageScanFindingsResponse_imageScanFindings_H
#define OAIDescribeImageScanFindingsResponse_imageScanFindings_H
...
class OAIDescribeImageScanFindingsResponse_imageScanFindings : public OAIObject {
public:
    OAIDescribeImageScanFindingsResponse_imageScanFindings();
    OAIDescribeImageScanFindingsResponse_imageScanFindings(QString json);
    ~OAIDescribeImageScanFindingsResponse_imageScanFindings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeImageScanFindingsResponse_imageScanFindings)

#endif // OAIDescribeImageScanFindingsResponse_imageScanFindings_H
