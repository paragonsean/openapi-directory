...
/*
 * OAICreateRepositoryResponse_repository.h
 *
 * 
 */

#ifndef OAICreateRepositoryResponse_repository_H
#define OAICreateRepositoryResponse_repository_H
...
class OAICreateRepositoryResponse_repository : public OAIObject {
public:
    OAICreateRepositoryResponse_repository();
    OAICreateRepositoryResponse_repository(QString json);
    ~OAICreateRepositoryResponse_repository() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRepositoryResponse_repository)

#endif // OAICreateRepositoryResponse_repository_H
