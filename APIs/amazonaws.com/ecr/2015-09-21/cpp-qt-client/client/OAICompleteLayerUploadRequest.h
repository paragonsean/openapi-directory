...
/*
 * OAICompleteLayerUploadRequest.h
 *
 * 
 */

#ifndef OAICompleteLayerUploadRequest_H
#define OAICompleteLayerUploadRequest_H
...
class OAICompleteLayerUploadRequest : public OAIObject {
public:
    OAICompleteLayerUploadRequest();
    OAICompleteLayerUploadRequest(QString json);
    ~OAICompleteLayerUploadRequest() override;
    ...
    QList getLayerDigests() const;
    void setLayerDigests(const QList &layer_digests);
    bool is_layer_digests_Set() const;
    bool is_layer_digests_Valid() const;
...
private:
    ...
    QList m_layer_digests;
    bool m_layer_digests_isSet;
    bool m_layer_digests_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICompleteLayerUploadRequest)

#endif // OAICompleteLayerUploadRequest_H
