...
OAISetRepositoryPolicyResponse::OAISetRepositoryPolicyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetRepositoryPolicyResponse::OAISetRepositoryPolicyResponse() {
    this->initializeModel();
}

OAISetRepositoryPolicyResponse::~OAISetRepositoryPolicyResponse() {}

void OAISetRepositoryPolicyResponse::initializeModel() {
...
void OAISetRepositoryPolicyResponse::fromJson(QString jsonString) {
...
void OAISetRepositoryPolicyResponse::fromJsonObject(QJsonObject json) {
...
QString OAISetRepositoryPolicyResponse::asJson() const {
...
QJsonObject OAISetRepositoryPolicyResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAISetRepositoryPolicyResponse::getRegistryId() const {
    return m_registry_id;
}
void OAISetRepositoryPolicyResponse::setRegistryId(const QString &registry_id) {
    m_registry_id = registry_id;
    m_registry_id_isSet = true;
}

bool OAISetRepositoryPolicyResponse::is_registry_id_Set() const{
    return m_registry_id_isSet;
}

bool OAISetRepositoryPolicyResponse::is_registry_id_Valid() const{
    return m_registry_id_isValid;
}

QString OAISetRepositoryPolicyResponse::getRepositoryName() const {
    return m_repository_name;
}
void OAISetRepositoryPolicyResponse::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAISetRepositoryPolicyResponse::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAISetRepositoryPolicyResponse::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAISetRepositoryPolicyResponse::getPolicyText() const {
    return m_policy_text;
}
void OAISetRepositoryPolicyResponse::setPolicyText(const QString &policy_text) {
    m_policy_text = policy_text;
    m_policy_text_isSet = true;
}

bool OAISetRepositoryPolicyResponse::is_policy_text_Set() const{
    return m_policy_text_isSet;
}

bool OAISetRepositoryPolicyResponse::is_policy_text_Valid() const{
    return m_policy_text_isValid;
}

bool OAISetRepositoryPolicyResponse::isSet() const {
...
bool OAISetRepositoryPolicyResponse::isValid() const {
