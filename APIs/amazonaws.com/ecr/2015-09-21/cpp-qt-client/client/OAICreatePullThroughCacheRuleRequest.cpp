...
OAICreatePullThroughCacheRuleRequest::OAICreatePullThroughCacheRuleRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreatePullThroughCacheRuleRequest::OAICreatePullThroughCacheRuleRequest() {
    this->initializeModel();
}

OAICreatePullThroughCacheRuleRequest::~OAICreatePullThroughCacheRuleRequest() {}

void OAICreatePullThroughCacheRuleRequest::initializeModel() {
...
void OAICreatePullThroughCacheRuleRequest::fromJson(QString jsonString) {
...
void OAICreatePullThroughCacheRuleRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreatePullThroughCacheRuleRequest::asJson() const {
...
QJsonObject OAICreatePullThroughCacheRuleRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreatePullThroughCacheRuleRequest::getEcrRepositoryPrefix() const {
    return m_ecr_repository_prefix;
}
void OAICreatePullThroughCacheRuleRequest::setEcrRepositoryPrefix(const QString &ecr_repository_prefix) {
    m_ecr_repository_prefix = ecr_repository_prefix;
    m_ecr_repository_prefix_isSet = true;
}

bool OAICreatePullThroughCacheRuleRequest::is_ecr_repository_prefix_Set() const{
    return m_ecr_repository_prefix_isSet;
}

bool OAICreatePullThroughCacheRuleRequest::is_ecr_repository_prefix_Valid() const{
    return m_ecr_repository_prefix_isValid;
}

QString OAICreatePullThroughCacheRuleRequest::getUpstreamRegistryUrl() const {
    return m_upstream_registry_url;
}
void OAICreatePullThroughCacheRuleRequest::setUpstreamRegistryUrl(const QString &upstream_registry_url) {
    m_upstream_registry_url = upstream_registry_url;
    m_upstream_registry_url_isSet = true;
}

bool OAICreatePullThroughCacheRuleRequest::is_upstream_registry_url_Set() const{
    return m_upstream_registry_url_isSet;
}

bool OAICreatePullThroughCacheRuleRequest::is_upstream_registry_url_Valid() const{
    return m_upstream_registry_url_isValid;
}

QString OAICreatePullThroughCacheRuleRequest::getRegistryId() const {
    return m_registry_id;
}
void OAICreatePullThroughCacheRuleRequest::setRegistryId(const QString &registry_id) {
    m_registry_id = registry_id;
    m_registry_id_isSet = true;
}

bool OAICreatePullThroughCacheRuleRequest::is_registry_id_Set() const{
    return m_registry_id_isSet;
}

bool OAICreatePullThroughCacheRuleRequest::is_registry_id_Valid() const{
    return m_registry_id_isValid;
}

bool OAICreatePullThroughCacheRuleRequest::isSet() const {
...
bool OAICreatePullThroughCacheRuleRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_ecr_repository_prefix_isValid && m_upstream_registry_url_isValid && true;
}
