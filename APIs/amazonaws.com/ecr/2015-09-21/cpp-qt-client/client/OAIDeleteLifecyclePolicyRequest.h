...
/*
 * OAIDeleteLifecyclePolicyRequest.h
 *
 * 
 */

#ifndef OAIDeleteLifecyclePolicyRequest_H
#define OAIDeleteLifecyclePolicyRequest_H
...
class OAIDeleteLifecyclePolicyRequest : public OAIObject {
public:
    OAIDeleteLifecyclePolicyRequest();
    OAIDeleteLifecyclePolicyRequest(QString json);
    ~OAIDeleteLifecyclePolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteLifecyclePolicyRequest)

#endif // OAIDeleteLifecyclePolicyRequest_H
