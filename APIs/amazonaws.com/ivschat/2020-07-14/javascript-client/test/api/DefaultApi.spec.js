...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    describe('createChatToken', function() {
      it('should call createChatToken successfully', function(done) {
        //uncomment below and update the code to test createChatToken
        //instance.createChatToken(function(error) {
