...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.UpdateRoomRequest();
  });
  ...
  describe('UpdateRoomRequest', function() {
    it('should create an instance of UpdateRoomRequest', function() {
      ...
      //var instance = new AmazonInteractiveVideoServiceChat.UpdateRoomRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.UpdateRoomRequest);
    });
