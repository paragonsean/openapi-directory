...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.CreateRoomResponse();
  });
  ...
  describe('CreateRoomResponse', function() {
    it('should create an instance of CreateRoomResponse', function() {
      // uncomment below and update the code to test CreateRoomResponse
      //var instance = new AmazonInteractiveVideoServiceChat.CreateRoomResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.CreateRoomResponse);
    });
