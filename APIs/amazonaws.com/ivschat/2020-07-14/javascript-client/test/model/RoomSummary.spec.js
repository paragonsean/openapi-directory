...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.RoomSummary();
  });
  ...
  describe('RoomSummary', function() {
    it('should create an instance of RoomSummary', function() {
      // uncomment below and update the code to test RoomSummary
      //var instance = new AmazonInteractiveVideoServiceChat.RoomSummary();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.RoomSummary);
    });
    ...
    it('should have the property loggingConfigurationIdentifiers (base name: "loggingConfigurationIdentifiers")', function() {
      // uncomment below and update the code to test the property loggingConfigurationIdentifiers
      //var instance = new AmazonInteractiveVideoServiceChat.RoomSummary();
      //expect(instance).to.be();
    });

    it('should have the property messageReviewHandler (base name: "messageReviewHandler")', function() {
      // uncomment below and update the code to test the property messageReviewHandler
      //var instance = new AmazonInteractiveVideoServiceChat.RoomSummary();
      //expect(instance).to.be();
    });
