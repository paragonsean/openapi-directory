...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.CreateLoggingConfigurationRequestDestinationConfigurationS3();
  });
  ...
  describe('CreateLoggingConfigurationRequestDestinationConfigurationS3', function() {
    it('should create an instance of CreateLoggingConfigurationRequestDestinationConfigurationS3', function() {
      // uncomment below and update the code to test CreateLoggingConfigurationRequestDestinationConfigurationS3
      //var instance = new AmazonInteractiveVideoServiceChat.CreateLoggingConfigurationRequestDestinationConfigurationS3();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.CreateLoggingConfigurationRequestDestinationConfigurationS3);
    });
