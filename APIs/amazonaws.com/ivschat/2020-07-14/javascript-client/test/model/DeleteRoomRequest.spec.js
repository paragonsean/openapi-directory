...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.DeleteRoomRequest();
  });
  ...
  describe('DeleteRoomRequest', function() {
    it('should create an instance of DeleteRoomRequest', function() {
      ...
      //var instance = new AmazonInteractiveVideoServiceChat.DeleteRoomRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.DeleteRoomRequest);
    });
