...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.DeleteMessageResponse();
  });
  ...
  describe('DeleteMessageResponse', function() {
    it('should create an instance of DeleteMessageResponse', function() {
      ...
      //var instance = new AmazonInteractiveVideoServiceChat.DeleteMessageResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.DeleteMessageResponse);
    });
