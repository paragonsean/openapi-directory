...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.GetRoomResponse();
  });
  ...
  describe('GetRoomResponse', function() {
    it('should create an instance of GetRoomResponse', function() {
      ...
      //var instance = new AmazonInteractiveVideoServiceChat.GetRoomResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.GetRoomResponse);
    });
    ...
    it('should have the property maximumMessageLength (base name: "maximumMessageLength")', function() {
      // uncomment below and update the code to test the property maximumMessageLength
      //var instance = new AmazonInteractiveVideoServiceChat.GetRoomResponse();
      //expect(instance).to.be();
    });

    it('should have the property maximumMessageRatePerSecond (base name: "maximumMessageRatePerSecond")', function() {
      // uncomment below and update the code to test the property maximumMessageRatePerSecond
      //var instance = new AmazonInteractiveVideoServiceChat.GetRoomResponse();
      //expect(instance).to.be();
    });
