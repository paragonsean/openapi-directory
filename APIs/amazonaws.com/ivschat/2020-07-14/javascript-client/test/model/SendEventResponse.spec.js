...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.SendEventResponse();
  });
  ...
  describe('SendEventResponse', function() {
    it('should create an instance of SendEventResponse', function() {
      ...
      //var instance = new AmazonInteractiveVideoServiceChat.SendEventResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.SendEventResponse);
    });
