...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.UpdateRoomResponse();
  });
  ...
  describe('UpdateRoomResponse', function() {
    it('should create an instance of UpdateRoomResponse', function() {
      // uncomment below and update the code to test UpdateRoomResponse
      //var instance = new AmazonInteractiveVideoServiceChat.UpdateRoomResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.UpdateRoomResponse);
    });
