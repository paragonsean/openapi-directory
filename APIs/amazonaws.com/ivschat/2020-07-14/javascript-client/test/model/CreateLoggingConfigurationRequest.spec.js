...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.CreateLoggingConfigurationRequest();
  });
  ...
  describe('CreateLoggingConfigurationRequest', function() {
    it('should create an instance of CreateLoggingConfigurationRequest', function() {
      ...
      //var instance = new AmazonInteractiveVideoServiceChat.CreateLoggingConfigurationRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.CreateLoggingConfigurationRequest);
    });
