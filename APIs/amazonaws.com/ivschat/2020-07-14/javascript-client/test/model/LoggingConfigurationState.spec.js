...
(function(root, factory) {
  ...
  describe('LoggingConfigurationState', function() {
    it('should create an instance of LoggingConfigurationState', function() {
      // uncomment below and update the code to test LoggingConfigurationState
      //var instance = new AmazonInteractiveVideoServiceChat.LoggingConfigurationState();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.LoggingConfigurationState);
    });
