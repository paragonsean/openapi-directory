...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.CreateLoggingConfigurationRequestDestinationConfiguration();
  });
  ...
  describe('CreateLoggingConfigurationRequestDestinationConfiguration', function() {
    it('should create an instance of CreateLoggingConfigurationRequestDestinationConfiguration', function() {
      // uncomment below and update the code to test CreateLoggingConfigurationRequestDestinationConfiguration
      //var instance = new AmazonInteractiveVideoServiceChat.CreateLoggingConfigurationRequestDestinationConfiguration();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.CreateLoggingConfigurationRequestDestinationConfiguration);
    });

    it('should have the property cloudWatchLogs (base name: "cloudWatchLogs")', function() {
      // uncomment below and update the code to test the property cloudWatchLogs
      //var instance = new AmazonInteractiveVideoServiceChat.CreateLoggingConfigurationRequestDestinationConfiguration();
