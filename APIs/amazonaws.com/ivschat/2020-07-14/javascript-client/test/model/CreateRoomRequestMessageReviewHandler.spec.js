...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.CreateRoomRequestMessageReviewHandler();
  });
  ...
  describe('CreateRoomRequestMessageReviewHandler', function() {
    it('should create an instance of CreateRoomRequestMessageReviewHandler', function() {
      // uncomment below and update the code to test CreateRoomRequestMessageReviewHandler
      //var instance = new AmazonInteractiveVideoServiceChat.CreateRoomRequestMessageReviewHandler();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.CreateRoomRequestMessageReviewHandler);
    });
