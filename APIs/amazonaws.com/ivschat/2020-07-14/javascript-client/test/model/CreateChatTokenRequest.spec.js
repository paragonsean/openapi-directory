...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.CreateChatTokenRequest();
  });
  ...
  describe('CreateChatTokenRequest', function() {
    it('should create an instance of CreateChatTokenRequest', function() {
      // uncomment below and update the code to test CreateChatTokenRequest
      //var instance = new AmazonInteractiveVideoServiceChat.CreateChatTokenRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.CreateChatTokenRequest);
    });
    ...
    it('should have the property sessionDurationInMinutes (base name: "sessionDurationInMinutes")', function() {
      // uncomment below and update the code to test the property sessionDurationInMinutes
      //var instance = new AmazonInteractiveVideoServiceChat.CreateChatTokenRequest();
      //expect(instance).to.be();
    });
