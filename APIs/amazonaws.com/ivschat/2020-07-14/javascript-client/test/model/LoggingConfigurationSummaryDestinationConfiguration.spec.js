...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.LoggingConfigurationSummaryDestinationConfiguration();
  });
  ...
  describe('LoggingConfigurationSummaryDestinationConfiguration', function() {
    it('should create an instance of LoggingConfigurationSummaryDestinationConfiguration', function() {
      // uncomment below and update the code to test LoggingConfigurationSummaryDestinationConfiguration
      //var instance = new AmazonInteractiveVideoServiceChat.LoggingConfigurationSummaryDestinationConfiguration();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.LoggingConfigurationSummaryDestinationConfiguration);
    });
