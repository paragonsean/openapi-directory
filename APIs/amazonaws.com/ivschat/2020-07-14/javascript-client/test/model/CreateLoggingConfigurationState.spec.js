...
(function(root, factory) {
  ...
  describe('CreateLoggingConfigurationState', function() {
    it('should create an instance of CreateLoggingConfigurationState', function() {
      // uncomment below and update the code to test CreateLoggingConfigurationState
      //var instance = new AmazonInteractiveVideoServiceChat.CreateLoggingConfigurationState();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.CreateLoggingConfigurationState);
    });
