...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.UpdateLoggingConfigurationResponse();
  });
  ...
  describe('UpdateLoggingConfigurationResponse', function() {
    it('should create an instance of UpdateLoggingConfigurationResponse', function() {
      ...
      //var instance = new AmazonInteractiveVideoServiceChat.UpdateLoggingConfigurationResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.UpdateLoggingConfigurationResponse);
    });
