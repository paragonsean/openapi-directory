...
(function(root, factory) {
  ...
  describe('ChatTokenCapability', function() {
    it('should create an instance of ChatTokenCapability', function() {
      // uncomment below and update the code to test ChatTokenCapability
      //var instance = new AmazonInteractiveVideoServiceChat.ChatTokenCapability();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.ChatTokenCapability);
    });
