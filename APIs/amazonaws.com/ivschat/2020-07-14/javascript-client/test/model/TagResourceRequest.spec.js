...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AmazonInteractiveVideoServiceChat.TagResourceRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.TagResourceRequest);
    });
