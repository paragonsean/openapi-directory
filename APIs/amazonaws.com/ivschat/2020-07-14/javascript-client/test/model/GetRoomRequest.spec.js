...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.GetRoomRequest();
  });
  ...
  describe('GetRoomRequest', function() {
    it('should create an instance of GetRoomRequest', function() {
      // uncomment below and update the code to test GetRoomRequest
      //var instance = new AmazonInteractiveVideoServiceChat.GetRoomRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.GetRoomRequest);
    });
