...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.CloudWatchLogsDestinationConfiguration();
  });
  ...
  describe('CloudWatchLogsDestinationConfiguration', function() {
    it('should create an instance of CloudWatchLogsDestinationConfiguration', function() {
      // uncomment below and update the code to test CloudWatchLogsDestinationConfiguration
      //var instance = new AmazonInteractiveVideoServiceChat.CloudWatchLogsDestinationConfiguration();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.CloudWatchLogsDestinationConfiguration);
    });
