...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceChat.FirehoseDestinationConfiguration();
  });
  ...
  describe('FirehoseDestinationConfiguration', function() {
    it('should create an instance of FirehoseDestinationConfiguration', function() {
      // uncomment below and update the code to test FirehoseDestinationConfiguration
      //var instance = new AmazonInteractiveVideoServiceChat.FirehoseDestinationConfiguration();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceChat.FirehoseDestinationConfiguration);
    });
